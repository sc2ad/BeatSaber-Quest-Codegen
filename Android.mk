...
include $(CLEAR_VARS)
LOCAL_MODULE := codegen_0_2_0
LOCAL_SRC_FILES := $(call rwildcard,./src,*.cpp)
LOCAL_SHARED_LIBRARIES += modloader
LOCAL_SHARED_LIBRARIES += beatsaber-hook_0_4_7
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DMOD_ID='"il2cpp_codegen"' -DVERSION='"0.2.0"' -Wall -Wextra -Werror -Wno-unused-function -DNEED_UNSAFE_CSHARP -DNO_CODEGEN_USE -isystem'extern/libil2cpp/il2cpp/libil2cpp' -isystem'extern'
