...
include $(CLEAR_VARS)
LOCAL_MODULE := codegen_0_12_1
LOCAL_SRC_FILES := $(call rwildcard,./src,*.cpp)
LOCAL_SHARED_LIBRARIES += beatsaber-hook_2_2_1
LOCAL_SHARED_LIBRARIES += modloader
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DMOD_ID='"il2cpp_codegen"' -DVERSION='"0.12.1"' -DNEED_UNSAFE_CSHARP -DNO_CODEGEN_USE -isystem'./extern' -Wall -Wextra -Werror -Wno-unused-private-field -Wno-unused-function -isystem'extern/libil2cpp/il2cpp/libil2cpp' -Os -O3
