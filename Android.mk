...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DMOD_ID='"il2cpp_codegen"' -DVERSION='"0.1.6"' -DNEED_UNSAFE_CSHARP -I'extern/libil2cpp/il2cpp/libil2cpp' -I'include' -Wno-inaccessible-base -DNO_CODEGEN_USE -isystem 'extern'
