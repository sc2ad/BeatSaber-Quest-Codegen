...
include $(CLEAR_VARS)
LOCAL_MODULE := codegen_0_2_5
LOCAL_SRC_FILES := $(call rwildcard,./src,*.cpp)
LOCAL_SHARED_LIBRARIES += beatsaber-hook_0_7_1
LOCAL_SHARED_LIBRARIES += modloader
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DMOD_ID='"il2cpp_codegen"' -DVERSION='"0.2.5"' -DNEED_UNSAFE_CSHARP -DNO_CODEGEN_USE -Wall -Wextra -Werror -Wno-unused-function -isystem'extern/libil2cpp/il2cpp/libil2cpp'
