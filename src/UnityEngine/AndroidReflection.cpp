...
System::IntPtr UnityEngine::AndroidReflection::GetStaticMethodID(::CsString* clazz, ::CsString* methodName, ::CsString* signature) {
...
System::IntPtr UnityEngine::AndroidReflection::GetMethodID(::CsString* clazz, ::CsString* methodName, ::CsString* signature) {
...
System::IntPtr UnityEngine::AndroidReflection::GetConstructorMember(System::IntPtr jclass, ::CsString* signature) {
...
System::IntPtr UnityEngine::AndroidReflection::GetMethodMember(System::IntPtr jclass, ::CsString* methodName, ::CsString* signature, bool isStatic) {
...
System::IntPtr UnityEngine::AndroidReflection::GetFieldMember(System::IntPtr jclass, ::CsString* fieldName, ::CsString* signature, bool isStatic) {
...
::CsString* UnityEngine::AndroidReflection::GetFieldSignature(System::IntPtr field) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine", "AndroidReflection", "GetFieldSignature", field));
}
