...
::Il2CppString* UnityEngine::GUIUtility::get_systemCopyBuffer() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine", "GUIUtility", "get_systemCopyBuffer"));
}
...
UnityEngine::Rect UnityEngine::GUIUtility::AlignRectToDevice(UnityEngine::Rect rect, int& widthInPixels, int& heightInPixels) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::Rect>("UnityEngine", "GUIUtility", "AlignRectToDevice", rect, widthInPixels, heightInPixels));
}
...
::Il2CppString* UnityEngine::GUIUtility::get_compositionString() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine", "GUIUtility", "get_compositionString"));
}
...
::Il2CppObject* UnityEngine::GUIUtility::Internal_GetDefaultSkin(int skinMode) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppObject*>("UnityEngine", "GUIUtility", "Internal_GetDefaultSkin", skinMode));
}
...
::Il2CppObject* UnityEngine::GUIUtility::GetStateObject(System::Type* t, int controlID) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppObject*>("UnityEngine", "GUIUtility", "GetStateObject", t, controlID));
}
...
UnityEngine::Rect UnityEngine::GUIUtility::AlignRectToDevice(UnityEngine::Rect rect) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::Rect>("UnityEngine", "GUIUtility", "AlignRectToDevice", rect));
}
...
void UnityEngine::GUIUtility::AlignRectToDevice_Injected(UnityEngine::Rect& rect, int& widthInPixels, int& heightInPixels, UnityEngine::Rect& ret) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "GUIUtility", "AlignRectToDevice_Injected", rect, widthInPixels, heightInPixels, ret));
}
