...
void UnityEngine::CullingGroup::SendEvents(UnityEngine::CullingGroup* cullingGroup, System::IntPtr eventsPtr, int count) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "CullingGroup", il2cpp_utils::NoArgClass<void>(), "SendEvents", {}, ::il2cpp_utils::ExtractTypes(cullingGroup, eventsPtr, count)));
