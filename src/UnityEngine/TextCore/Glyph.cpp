...
UnityEngine::TextCore::Glyph* UnityEngine::TextCore::Glyph::New_ctor(UnityEngine::TextCore::LowLevel::GlyphMarshallingStruct glyphStruct) {
  return (Glyph*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TextCore", "Glyph", glyphStruct));
}
// Autogenerated method: UnityEngine.TextCore.Glyph..ctor
UnityEngine::TextCore::Glyph* UnityEngine::TextCore::Glyph::New_ctor(uint index, UnityEngine::TextCore::GlyphMetrics metrics, UnityEngine::TextCore::GlyphRect glyphRect, float scale, int atlasIndex) {
  return (Glyph*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TextCore", "Glyph", index, metrics, glyphRect, scale, atlasIndex));
}
// Autogenerated method: UnityEngine.TextCore.Glyph..ctor
UnityEngine::TextCore::Glyph* UnityEngine::TextCore::Glyph::New_ctor() {
  return (Glyph*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TextCore", "Glyph"));
}
