...
UnityEngine::TextCore::GlyphRect UnityEngine::TextCore::GlyphRect::get_zero() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TextCore", "GlyphRect", il2cpp_utils::NoArgClass<UnityEngine::TextCore::GlyphRect>(), "get_zero", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::TextCore::GlyphRect::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TextCore", "GlyphRect", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
