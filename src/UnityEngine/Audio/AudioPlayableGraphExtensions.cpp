...
bool UnityEngine::Audio::AudioPlayableGraphExtensions::InternalCreateAudioOutput(UnityEngine::Playables::PlayableGraph& graph, ::CsString* name, UnityEngine::Playables::PlayableOutputHandle& handle) {
