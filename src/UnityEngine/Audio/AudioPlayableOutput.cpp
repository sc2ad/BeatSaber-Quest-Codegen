...
UnityEngine::Audio::AudioPlayableOutput UnityEngine::Audio::AudioPlayableOutput::Create(UnityEngine::Playables::PlayableGraph graph, ::Il2CppString* name, UnityEngine::AudioSource* target) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Audio", "AudioPlayableOutput", il2cpp_utils::NoArgClass<UnityEngine::Audio::AudioPlayableOutput>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, name, target)));
...
UnityEngine::Audio::AudioPlayableOutput UnityEngine::Audio::AudioPlayableOutput::get_Null() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Audio", "AudioPlayableOutput", il2cpp_utils::NoArgClass<UnityEngine::Audio::AudioPlayableOutput>(), "get_Null", {}, ::il2cpp_utils::ExtractTypes()));
...
UnityEngine::Audio::AudioPlayableOutput::AudioPlayableOutput(UnityEngine::Playables::PlayableOutput& output) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Audio", "AudioPlayableOutput", il2cpp_utils::NoArgClass<UnityEngine::Audio::AudioPlayableOutput>(), "op_Explicit", {}, ::il2cpp_utils::ExtractTypes(output)));
...
void UnityEngine::Audio::AudioPlayableOutput::SetEvaluateOnSeek(bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "SetEvaluateOnSeek", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(*this, ___internal__method, value);
}
...
void UnityEngine::Audio::AudioPlayableOutput::InternalSetTarget(UnityEngine::Playables::PlayableOutputHandle& output, UnityEngine::AudioSource* target) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Audio", "AudioPlayableOutput", il2cpp_utils::NoArgClass<void>(), "InternalSetTarget", {}, ::il2cpp_utils::ExtractTypes(output, target)));
...
void UnityEngine::Audio::AudioPlayableOutput::InternalSetEvaluateOnSeek(UnityEngine::Playables::PlayableOutputHandle& output, bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Audio", "AudioPlayableOutput", il2cpp_utils::NoArgClass<void>(), "InternalSetEvaluateOnSeek", {}, ::il2cpp_utils::ExtractTypes(output, value)));
