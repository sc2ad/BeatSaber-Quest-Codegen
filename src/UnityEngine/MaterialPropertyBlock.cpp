...
void UnityEngine::MaterialPropertyBlock::SetFloat(::CsString* name, float value) {
...
void UnityEngine::MaterialPropertyBlock::SetVector(::CsString* name, UnityEngine::Vector4 value) {
...
void UnityEngine::MaterialPropertyBlock::SetColor(::CsString* name, UnityEngine::Color value) {
...
UnityEngine::MaterialPropertyBlock* UnityEngine::MaterialPropertyBlock::New_ctor() {
  return (MaterialPropertyBlock*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "MaterialPropertyBlock"));
}
