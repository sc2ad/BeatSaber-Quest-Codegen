...
void UnityEngine::MaterialPropertyBlock::SetFloat(::Il2CppString* name, float value) {
...
void UnityEngine::MaterialPropertyBlock::SetVector(::Il2CppString* name, UnityEngine::Vector4 value) {
