...
void UnityEngine::UnitySynchronizationContext::Send(System::Threading::SendOrPostCallback* callback, ::CsObject* state) {
...
void UnityEngine::UnitySynchronizationContext::Post(System::Threading::SendOrPostCallback* callback, ::CsObject* state) {
