...
UnityEngine::SendMessageOptions UnityEngine::SendMessageOptions::_get_RequireReceiver() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("SendMessageOptions").WithContext("_get_RequireReceiver");
...
void UnityEngine::SendMessageOptions::_set_RequireReceiver(UnityEngine::SendMessageOptions value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("SendMessageOptions").WithContext("_set_RequireReceiver");
...
UnityEngine::SendMessageOptions UnityEngine::SendMessageOptions::_get_DontRequireReceiver() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("SendMessageOptions").WithContext("_get_DontRequireReceiver");
...
void UnityEngine::SendMessageOptions::_set_DontRequireReceiver(UnityEngine::SendMessageOptions value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("SendMessageOptions").WithContext("_set_DontRequireReceiver");
