...
::Il2CppString* UnityEngine::WWWTranscoder::DataEncode(::Il2CppString* toEncode, System::Text::Encoding* e) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine", "WWWTranscoder", "DataEncode", toEncode, e));
}
