...
UnityEngine::GUI::WindowFunction* UnityEngine::GUI::WindowFunction::New_ctor(::CsObject* object, System::IntPtr method) {
  return (GUI::WindowFunction*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "GUI/WindowFunction", object, method));
}
...
System::IAsyncResult* UnityEngine::GUI::WindowFunction::BeginInvoke(int id, System::AsyncCallback* callback, ::CsObject* object) {
