...
UnityEngine::GUI::WindowFunction* UnityEngine::GUI::WindowFunction::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("WindowFunction").WithContext(".ctor");
...
void UnityEngine::GUI::WindowFunction::Invoke(int id) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(id)));
...
System::IAsyncResult* UnityEngine::GUI::WindowFunction::BeginInvoke(int id, System::AsyncCallback* callback, ::Il2CppObject* object) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::IAsyncResult*>(), "BeginInvoke", {}, ::il2cpp_utils::ExtractTypes(id, callback, object)));
