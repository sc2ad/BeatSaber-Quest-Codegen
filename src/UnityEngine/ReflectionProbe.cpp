...
void UnityEngine::ReflectionProbe::CallReflectionProbeEvent(UnityEngine::ReflectionProbe* probe, UnityEngine::ReflectionProbe::ReflectionProbeEvent probeEvent) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "ReflectionProbe", "CallReflectionProbeEvent", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(probe, probeEvent)));
...
void UnityEngine::ReflectionProbe::CallSetDefaultReflection(UnityEngine::Cubemap* defaultReflectionCubemap) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "ReflectionProbe", "CallSetDefaultReflection", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(defaultReflectionCubemap)));
