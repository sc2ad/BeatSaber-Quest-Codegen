...
// Autogenerated method: UnityEngine.Material..ctor
UnityEngine::Material* UnityEngine::Material::New_ctor(::CsString* contents) {
...
// Autogenerated method: UnityEngine.Material.HasProperty
bool UnityEngine::Material::HasProperty(::CsString* name) {
...
::Array<::CsString*>* UnityEngine::Material::GetShaderKeywords() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<::CsString*>*>(this, "GetShaderKeywords"));
}
// Autogenerated method: UnityEngine.Material.SetShaderKeywords
void UnityEngine::Material::SetShaderKeywords(::Array<::CsString*>* names) {
...
::Array<::CsString*>* UnityEngine::Material::get_shaderKeywords() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<::CsString*>*>(this, "get_shaderKeywords"));
}
// Autogenerated method: UnityEngine.Material.set_shaderKeywords
void UnityEngine::Material::set_shaderKeywords(::Array<::CsString*>* value) {
...
void UnityEngine::Material::SetFloat(::CsString* name, float value) {
...
void UnityEngine::Material::SetInt(::CsString* name, int value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SetInt", name, value));
}
// Autogenerated method: UnityEngine.Material.SetColor
void UnityEngine::Material::SetColor(::CsString* name, UnityEngine::Color value) {
...
void UnityEngine::Material::SetVector(::CsString* name, UnityEngine::Vector4 value) {
...
void UnityEngine::Material::SetTexture(::CsString* name, UnityEngine::Texture* value) {
...
UnityEngine::Color UnityEngine::Material::GetColor(::CsString* name) {
...
UnityEngine::Texture* UnityEngine::Material::GetTexture(::CsString* name) {
