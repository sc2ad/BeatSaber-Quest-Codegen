...
::Il2CppString* UnityEngine::SystemInfo::get_deviceUniqueIdentifier() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine", "SystemInfo", "get_deviceUniqueIdentifier"));
}
...
::Il2CppString* UnityEngine::SystemInfo::GetDeviceUniqueIdentifier() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine", "SystemInfo", "GetDeviceUniqueIdentifier"));
}
