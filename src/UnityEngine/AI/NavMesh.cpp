...
void UnityEngine::AI::NavMesh::Internal_CallOnNavMeshPreUpdate() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<void>(), "Internal_CallOnNavMeshPreUpdate", {}, ::il2cpp_utils::ExtractTypes()));
...
bool UnityEngine::AI::NavMesh::CalculatePath(UnityEngine::Vector3 sourcePosition, UnityEngine::Vector3 targetPosition, int areaMask, UnityEngine::AI::NavMeshPath* path) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<bool>(), "CalculatePath", {}, ::il2cpp_utils::ExtractTypes(sourcePosition, targetPosition, areaMask, path)));
...
bool UnityEngine::AI::NavMesh::CalculatePathInternal(UnityEngine::Vector3 sourcePosition, UnityEngine::Vector3 targetPosition, int areaMask, UnityEngine::AI::NavMeshPath* path) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<bool>(), "CalculatePathInternal", {}, ::il2cpp_utils::ExtractTypes(sourcePosition, targetPosition, areaMask, path)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, sourcePosition, targetPosition, areaMask, path);
}
...
bool UnityEngine::AI::NavMesh::SamplePosition(UnityEngine::Vector3 sourcePosition, UnityEngine::AI::NavMeshHit& hit, float maxDistance, int areaMask) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<bool>(), "SamplePosition", {}, ::il2cpp_utils::ExtractTypes(sourcePosition, hit, maxDistance, areaMask)));
...
bool UnityEngine::AI::NavMesh::CalculatePathInternal_Injected(UnityEngine::Vector3& sourcePosition, UnityEngine::Vector3& targetPosition, int areaMask, UnityEngine::AI::NavMeshPath* path) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<bool>(), "CalculatePathInternal_Injected", {}, ::il2cpp_utils::ExtractTypes(sourcePosition, targetPosition, areaMask, path)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, sourcePosition, targetPosition, areaMask, path);
}
...
bool UnityEngine::AI::NavMesh::SamplePosition_Injected(UnityEngine::Vector3& sourcePosition, UnityEngine::AI::NavMeshHit& hit, float maxDistance, int areaMask) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.AI", "NavMesh", il2cpp_utils::NoArgClass<bool>(), "SamplePosition_Injected", {}, ::il2cpp_utils::ExtractTypes(sourcePosition, hit, maxDistance, areaMask)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, sourcePosition, hit, maxDistance, areaMask);
}
