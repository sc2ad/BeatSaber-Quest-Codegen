...
void UnityEngine::TestTools::Logging::LogScope::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.TestTools.Logging", "LogScope/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
bool UnityEngine::TestTools::Logging::LogScope::$$c::$NoUnexpectedReceived$b__53_0(UnityEngine::TestTools::Logging::LogEvent* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<NoUnexpectedReceived>b__53_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
UnityEngine::TestTools::Logging::LogScope::$$c* UnityEngine::TestTools::Logging::LogScope::$$c::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools::Logging").WithContext("$$c").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<LogScope::$$c*>());
}
