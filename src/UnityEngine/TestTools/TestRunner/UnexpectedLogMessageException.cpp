...
::CsString* UnityEngine::TestTools::TestRunner::UnexpectedLogMessageException::BuildMessage(UnityEngine::TestTools::Logging::LogMatch* log) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.TestTools.TestRunner", "UnexpectedLogMessageException", "BuildMessage", log));
}
...
::CsString* UnityEngine::TestTools::TestRunner::UnexpectedLogMessageException::get_StackTrace() {
