...
::CsString* UnityEngine::TestTools::TestRunner::UnhandledLogMessageException::BuildMessage(UnityEngine::TestTools::Logging::LogEvent* log) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.TestTools.TestRunner", "UnhandledLogMessageException", "BuildMessage", log));
}
...
::CsString* UnityEngine::TestTools::TestRunner::UnhandledLogMessageException::get_StackTrace() {
