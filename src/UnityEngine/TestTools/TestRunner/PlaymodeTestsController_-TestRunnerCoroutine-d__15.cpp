...
UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$TestRunnerCoroutine$d__15* UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$TestRunnerCoroutine$d__15::New_ctor(int $$1__state) {
  return (PlaymodeTestsController::$TestRunnerCoroutine$d__15*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestTools.TestRunner", "PlaymodeTestsController/<TestRunnerCoroutine>d__15", $$1__state));
}
...
::CsObject* UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$TestRunnerCoroutine$d__15::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$TestRunnerCoroutine$d__15::System_Collections_IEnumerator_get_Current() {
