...
UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$Run$d__16* UnityEngine::TestTools::TestRunner::PlaymodeTestsController::$Run$d__16::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools::TestRunner").WithContext("$Run$d__16").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlaymodeTestsController::$Run$d__16*>($$1__state));
}
