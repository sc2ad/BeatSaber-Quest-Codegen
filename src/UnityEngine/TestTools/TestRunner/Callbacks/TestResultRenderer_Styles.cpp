...
void UnityEngine::TestTools::TestRunner::Callbacks::TestResultRenderer::Styles::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestTools.TestRunner.Callbacks", "TestResultRenderer/Styles", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
