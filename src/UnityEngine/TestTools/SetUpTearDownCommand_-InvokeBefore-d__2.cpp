...
// Completed includes
// Autogenerated method: UnityEngine.TestTools.SetUpTearDownCommand/<InvokeBefore>d__2..ctor
UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SetUpTearDownCommand::$InvokeBefore$d__2*>($$1__state));
}
