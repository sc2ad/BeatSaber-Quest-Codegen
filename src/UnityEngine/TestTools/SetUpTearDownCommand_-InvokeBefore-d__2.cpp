...
UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2::New_ctor(int $$1__state) {
  return (SetUpTearDownCommand::$InvokeBefore$d__2*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestTools", "SetUpTearDownCommand/<InvokeBefore>d__2", $$1__state));
}
...
::CsObject* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeBefore$d__2::System_Collections_IEnumerator_get_Current() {
