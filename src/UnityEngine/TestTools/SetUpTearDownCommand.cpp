...
::Array<System::Reflection::MethodInfo*>* UnityEngine::TestTools::SetUpTearDownCommand::GetMethodsWithAttributeFromFixture(System::Type* fixtureType, System::Type* setUpType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestTools", "SetUpTearDownCommand", il2cpp_utils::NoArgClass<::Array<System::Reflection::MethodInfo*>*>(), "GetMethodsWithAttributeFromFixture", {}, ::il2cpp_utils::ExtractTypes(fixtureType, setUpType)));
...
UnityEngine::TestTools::SetUpTearDownCommand* UnityEngine::TestTools::SetUpTearDownCommand::New_ctor(NUnit::Framework::Internal::Commands::TestCommand* innerCommand) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SetUpTearDownCommand*>(innerCommand));
}
