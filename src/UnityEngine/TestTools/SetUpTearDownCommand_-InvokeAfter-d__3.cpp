...
// Completed includes
// Autogenerated method: UnityEngine.TestTools.SetUpTearDownCommand/<InvokeAfter>d__3..ctor
UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SetUpTearDownCommand::$InvokeAfter$d__3*>($$1__state));
}
...
void UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext("System.IDisposable.Dispose");
...
bool UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext("MoveNext");
...
::Il2CppObject* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* UnityEngine::TestTools::SetUpTearDownCommand::$InvokeAfter$d__3::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$InvokeAfter$d__3").WithContext("System.Collections.IEnumerator.get_Current");
