...
UnityEngine::TestTools::TestActionCommand::$InvokeAfter$d__3* UnityEngine::TestTools::TestActionCommand::$InvokeAfter$d__3::New_ctor(int $$1__state) {
  return (TestActionCommand::$InvokeAfter$d__3*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestTools", "TestActionCommand/<InvokeAfter>d__3", $$1__state));
}
...
::CsObject* UnityEngine::TestTools::TestActionCommand::$InvokeAfter$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::TestTools::TestActionCommand::$InvokeAfter$d__3::System_Collections_IEnumerator_get_Current() {
