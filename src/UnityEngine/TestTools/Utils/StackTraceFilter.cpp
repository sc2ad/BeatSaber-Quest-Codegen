...
::Il2CppString* UnityEngine::TestTools::Utils::StackTraceFilter::Filter(::Il2CppString* inputStackTrace) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestTools.Utils", "StackTraceFilter", il2cpp_utils::NoArgClass<::Il2CppString*>(), "Filter", {}, ::il2cpp_utils::ExtractTypes(inputStackTrace)));
...
void UnityEngine::TestTools::Utils::StackTraceFilter::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestTools.Utils", "StackTraceFilter", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
