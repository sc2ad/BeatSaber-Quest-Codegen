...
UnityEngine::TestTools::Utils::PlayerTestAssemblyProvider* UnityEngine::TestTools::Utils::PlayerTestAssemblyProvider::New_ctor(UnityEngine::TestTools::Utils::IAssemblyLoadProxy* assemblyLoadProxy, System::Collections::Generic::List_1<::CsString*>* assembliesToLoad) {
