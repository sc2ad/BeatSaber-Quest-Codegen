...
UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3* UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3*>($$1__state));
}
...
void UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext("System.IDisposable.Dispose");
...
bool UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext("MoveNext");
...
::Il2CppObject* UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* UnityEngine::TestTools::EnumerableTestMethodCommand::$ExecuteEnumerableAndRecordExceptions$d__3::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestTools").WithContext("$ExecuteEnumerableAndRecordExceptions$d__3").WithContext("System.Collections.IEnumerator.get_Current");
