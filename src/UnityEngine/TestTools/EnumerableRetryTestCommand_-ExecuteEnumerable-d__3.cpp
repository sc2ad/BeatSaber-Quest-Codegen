...
// Completed includes
// Autogenerated method: UnityEngine.TestTools.EnumerableRetryTestCommand/<ExecuteEnumerable>d__3..ctor
UnityEngine::TestTools::EnumerableRetryTestCommand::$ExecuteEnumerable$d__3* UnityEngine::TestTools::EnumerableRetryTestCommand::$ExecuteEnumerable$d__3::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<EnumerableRetryTestCommand::$ExecuteEnumerable$d__3*>($$1__state));
}
