...
UnityEngine::Networking::PlayerConnection::PlayerConnection::$$c__DisplayClass13_0* UnityEngine::Networking::PlayerConnection::PlayerConnection::$$c__DisplayClass13_0::New_ctor() {
  return (PlayerConnection::$$c__DisplayClass13_0*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Networking.PlayerConnection", "PlayerConnection/<>c__DisplayClass13_0"));
}
