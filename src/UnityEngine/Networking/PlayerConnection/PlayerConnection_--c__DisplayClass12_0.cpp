...
bool UnityEngine::Networking::PlayerConnection::PlayerConnection::$$c__DisplayClass12_0::$Register$b__0(UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents::MessageTypeSubscribers* x) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<bool>(this, "<Register>b__0", x)));
}
...
UnityEngine::Networking::PlayerConnection::PlayerConnection::$$c__DisplayClass12_0* UnityEngine::Networking::PlayerConnection::PlayerConnection::$$c__DisplayClass12_0::New_ctor() {
  return (PlayerConnection::$$c__DisplayClass12_0*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Networking.PlayerConnection", "PlayerConnection/<>c__DisplayClass12_0"));
}
