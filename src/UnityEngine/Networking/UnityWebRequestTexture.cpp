...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequestTexture::GetTexture(::Il2CppString* uri) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Networking", "UnityWebRequestTexture", il2cpp_utils::NoArgClass<UnityEngine::Networking::UnityWebRequest*>(), "GetTexture", {}, ::il2cpp_utils::ExtractTypes(uri)));
...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequestTexture::GetTexture(::Il2CppString* uri, bool nonReadable) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Networking").WithContext("UnityWebRequestTexture").WithContext("GetTexture");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Networking", "UnityWebRequestTexture", il2cpp_utils::NoArgClass<UnityEngine::Networking::UnityWebRequest*>(), "GetTexture", {}, ::il2cpp_utils::ExtractTypes(uri, nonReadable)));
