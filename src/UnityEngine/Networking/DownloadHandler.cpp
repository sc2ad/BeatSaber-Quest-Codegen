...
::CsString* UnityEngine::Networking::DownloadHandler::get_text() {
...
::CsString* UnityEngine::Networking::DownloadHandler::GetText() {
...
::CsString* UnityEngine::Networking::DownloadHandler::GetContentType() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetContentType"));
}
