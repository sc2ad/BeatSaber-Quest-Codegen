...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequestMultimedia::GetAudioClip(::Il2CppString* uri, UnityEngine::AudioType audioType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Networking", "UnityWebRequestMultimedia", "GetAudioClip", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(uri, audioType)));
