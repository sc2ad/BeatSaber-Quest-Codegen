...
void UnityEngine::Networking::UploadHandler::set_contentType(::CsString* value) {
...
void UnityEngine::Networking::UploadHandler::SetContentType(::CsString* newContentType) {
...
void UnityEngine::Networking::UploadHandler::InternalSetContentType(::CsString* newContentType) {
