...
::CsString* UnityEngine::Networking::UnityWebRequest::GetWebErrorString(UnityEngine::Networking::UnityWebRequest::UnityWebRequestError err) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Networking", "UnityWebRequest", "GetWebErrorString", err));
}
// Autogenerated method: UnityEngine.Networking.UnityWebRequest.GetHTTPStatusString
::CsString* UnityEngine::Networking::UnityWebRequest::GetHTTPStatusString(int64_t responseCode) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Networking", "UnityWebRequest", "GetHTTPStatusString", responseCode));
}
...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequest::New_ctor(::CsString* url, ::CsString* method) {
  return (UnityWebRequest*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Networking", "UnityWebRequest", url, method));
}
// Autogenerated method: UnityEngine.Networking.UnityWebRequest..ctor
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequest::New_ctor(::CsString* url, ::CsString* method, UnityEngine::Networking::DownloadHandler* downloadHandler, UnityEngine::Networking::UploadHandler* uploadHandler) {
...
UnityEngine::Networking::UnityWebRequest::UnityWebRequestError UnityEngine::Networking::UnityWebRequest::SetCustomMethod(::CsString* customMethodName) {
...
void UnityEngine::Networking::UnityWebRequest::InternalSetCustomMethod(::CsString* customMethodName) {
...
void UnityEngine::Networking::UnityWebRequest::set_method(::CsString* value) {
...
::CsString* UnityEngine::Networking::UnityWebRequest::get_error() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_error"));
}
// Autogenerated method: UnityEngine.Networking.UnityWebRequest.set_url
void UnityEngine::Networking::UnityWebRequest::set_url(::CsString* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_url", value));
}
// Autogenerated method: UnityEngine.Networking.UnityWebRequest.SetUrl
UnityEngine::Networking::UnityWebRequest::UnityWebRequestError UnityEngine::Networking::UnityWebRequest::SetUrl(::CsString* url) {
...
void UnityEngine::Networking::UnityWebRequest::InternalSetUrl(::CsString* url) {
...
UnityEngine::Networking::UnityWebRequest::UnityWebRequestError UnityEngine::Networking::UnityWebRequest::InternalSetRequestHeader(::CsString* name, ::CsString* value) {
...
void UnityEngine::Networking::UnityWebRequest::SetRequestHeader(::CsString* name, ::CsString* value) {
...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequest::Get(::CsString* uri) {
...
UnityEngine::Networking::UnityWebRequest* UnityEngine::Networking::UnityWebRequest::Post(::CsString* uri, ::CsString* postData) {
...
void UnityEngine::Networking::UnityWebRequest::SetupPost(UnityEngine::Networking::UnityWebRequest* request, ::CsString* postData) {
...
::CsString* UnityEngine::Networking::UnityWebRequest::EscapeURL(::CsString* s) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Networking", "UnityWebRequest", "EscapeURL", s));
}
// Autogenerated method: UnityEngine.Networking.UnityWebRequest.EscapeURL
::CsString* UnityEngine::Networking::UnityWebRequest::EscapeURL(::CsString* s, System::Text::Encoding* e) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Networking", "UnityWebRequest", "EscapeURL", s, e));
}
