...
UnityEngine::Animations::AnimationMixerPlayable UnityEngine::Animations::AnimationMixerPlayable::Create(UnityEngine::Playables::PlayableGraph graph, int inputCount, bool normalizeWeights) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationMixerPlayable", il2cpp_utils::NoArgClass<UnityEngine::Animations::AnimationMixerPlayable>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, inputCount, normalizeWeights)));
...
UnityEngine::Playables::PlayableHandle UnityEngine::Animations::AnimationMixerPlayable::CreateHandle(UnityEngine::Playables::PlayableGraph graph, int inputCount, bool normalizeWeights) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationMixerPlayable", il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableHandle>(), "CreateHandle", {}, ::il2cpp_utils::ExtractTypes(graph, inputCount, normalizeWeights)));
...
bool UnityEngine::Animations::AnimationMixerPlayable::CreateHandleInternal(UnityEngine::Playables::PlayableGraph graph, bool normalizeWeights, UnityEngine::Playables::PlayableHandle& handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationMixerPlayable", il2cpp_utils::NoArgClass<bool>(), "CreateHandleInternal", {}, ::il2cpp_utils::ExtractTypes(graph, normalizeWeights, handle)));
...
void UnityEngine::Animations::AnimationMixerPlayable::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationMixerPlayable", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
bool UnityEngine::Animations::AnimationMixerPlayable::CreateHandleInternal_Injected(UnityEngine::Playables::PlayableGraph& graph, bool normalizeWeights, UnityEngine::Playables::PlayableHandle& handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationMixerPlayable", il2cpp_utils::NoArgClass<bool>(), "CreateHandleInternal_Injected", {}, ::il2cpp_utils::ExtractTypes(graph, normalizeWeights, handle)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, graph, normalizeWeights, handle);
}
