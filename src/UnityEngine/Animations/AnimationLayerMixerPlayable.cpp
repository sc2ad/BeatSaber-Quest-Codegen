...
UnityEngine::Animations::AnimationLayerMixerPlayable UnityEngine::Animations::AnimationLayerMixerPlayable::Create(UnityEngine::Playables::PlayableGraph graph, int inputCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<UnityEngine::Animations::AnimationLayerMixerPlayable>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, inputCount)));
...
UnityEngine::Playables::PlayableHandle UnityEngine::Animations::AnimationLayerMixerPlayable::CreateHandle(UnityEngine::Playables::PlayableGraph graph, int inputCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableHandle>(), "CreateHandle", {}, ::il2cpp_utils::ExtractTypes(graph, inputCount)));
...
void UnityEngine::Animations::AnimationLayerMixerPlayable::SetLayerMaskFromAvatarMask(uint layerIndex, UnityEngine::AvatarMask* mask) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "SetLayerMaskFromAvatarMask", {}, ::il2cpp_utils::ExtractTypes(layerIndex, mask)));
...
bool UnityEngine::Animations::AnimationLayerMixerPlayable::CreateHandleInternal(UnityEngine::Playables::PlayableGraph graph, UnityEngine::Playables::PlayableHandle& handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<bool>(), "CreateHandleInternal", {}, ::il2cpp_utils::ExtractTypes(graph, handle)));
...
void UnityEngine::Animations::AnimationLayerMixerPlayable::SetLayerMaskFromAvatarMaskInternal(UnityEngine::Playables::PlayableHandle& handle, uint layerIndex, UnityEngine::AvatarMask* mask) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<void>(), "SetLayerMaskFromAvatarMaskInternal", {}, ::il2cpp_utils::ExtractTypes(handle, layerIndex, mask)));
...
void UnityEngine::Animations::AnimationLayerMixerPlayable::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
bool UnityEngine::Animations::AnimationLayerMixerPlayable::CreateHandleInternal_Injected(UnityEngine::Playables::PlayableGraph& graph, UnityEngine::Playables::PlayableHandle& handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationLayerMixerPlayable", il2cpp_utils::NoArgClass<bool>(), "CreateHandleInternal_Injected", {}, ::il2cpp_utils::ExtractTypes(graph, handle)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, graph, handle);
}
