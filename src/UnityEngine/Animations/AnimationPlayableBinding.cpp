...
UnityEngine::Playables::PlayableBinding UnityEngine::Animations::AnimationPlayableBinding::Create(::Il2CppString* name, UnityEngine::Object* key) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationPlayableBinding", il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableBinding>(), "Create", {}, ::il2cpp_utils::ExtractTypes(name, key)));
...
UnityEngine::Playables::PlayableOutput UnityEngine::Animations::AnimationPlayableBinding::CreateAnimationOutput(UnityEngine::Playables::PlayableGraph graph, ::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Animations", "AnimationPlayableBinding", il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableOutput>(), "CreateAnimationOutput", {}, ::il2cpp_utils::ExtractTypes(graph, name)));
