...
bool UnityEngine::Animations::AnimationPlayableGraphExtensions::InternalCreateAnimationOutput(UnityEngine::Playables::PlayableGraph& graph, ::CsString* name, UnityEngine::Playables::PlayableOutputHandle& handle) {
