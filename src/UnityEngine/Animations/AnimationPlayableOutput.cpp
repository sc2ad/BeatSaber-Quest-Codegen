...
UnityEngine::Animations::AnimationPlayableOutput::AnimationPlayableOutput(UnityEngine::Playables::PlayableOutput& output) {
  *this = THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::Animations::AnimationPlayableOutput>("UnityEngine.Animations", "AnimationPlayableOutput", "op_Explicit", output));
}
