...
UnityEngine::Animations::AnimationPlayableOutput UnityEngine::Animations::AnimationPlayableOutput::Create(UnityEngine::Playables::PlayableGraph graph, ::CsString* name, UnityEngine::Animator* target) {
