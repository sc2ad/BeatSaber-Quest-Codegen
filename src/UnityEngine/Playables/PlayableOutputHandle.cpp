...
void UnityEngine::Playables::PlayableOutputHandle::PushNotification(UnityEngine::Playables::PlayableHandle origin, UnityEngine::Playables::INotification* notification, ::CsObject* context) {
...
void UnityEngine::Playables::PlayableOutputHandle::PushNotification_Injected(UnityEngine::Playables::PlayableOutputHandle& _unity_self, UnityEngine::Playables::PlayableHandle& origin, UnityEngine::Playables::INotification* notification, ::CsObject* context) {
...
bool UnityEngine::Playables::PlayableOutputHandle::Equals(::CsObject* p) {
