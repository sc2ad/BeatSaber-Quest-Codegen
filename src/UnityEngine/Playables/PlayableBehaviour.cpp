...
UnityEngine::Playables::PlayableBehaviour* UnityEngine::Playables::PlayableBehaviour::New_ctor() {
  return (PlayableBehaviour*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Playables", "PlayableBehaviour"));
}
...
void UnityEngine::Playables::PlayableBehaviour::ProcessFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info, ::CsObject* playerData) {
...
::CsObject* UnityEngine::Playables::PlayableBehaviour::Clone() {
