...
UnityEngine::Playables::PlayableOutput UnityEngine::Playables::PlayableOutput::get_Null() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableOutput", il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableOutput>(), "get_Null", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::Playables::PlayableOutput::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableOutput", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
