...
UnityEngine::Scripting::RequiredByNativeCodeAttribute* UnityEngine::Scripting::RequiredByNativeCodeAttribute::New_ctor(::CsString* name) {
...
void UnityEngine::Scripting::RequiredByNativeCodeAttribute::set_Name(::CsString* value) {
