...
UnityEngine::TrackedReference* UnityEngine::TrackedReference::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("TrackedReference").WithContext(".ctor");
...
bool UnityEngine::operator ==(UnityEngine::TrackedReference* x, UnityEngine::TrackedReference& y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "TrackedReference", il2cpp_utils::NoArgClass<bool>(), "op_Equality", {}, ::il2cpp_utils::ExtractTypes(x, &y)));
