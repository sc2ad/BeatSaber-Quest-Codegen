...
UnityEngine::LogOption UnityEngine::LogOption::_get_None() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("LogOption").WithContext("_get_None");
...
void UnityEngine::LogOption::_set_None(UnityEngine::LogOption value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("LogOption").WithContext("_set_None");
...
UnityEngine::LogOption UnityEngine::LogOption::_get_NoStacktrace() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("LogOption").WithContext("_get_NoStacktrace");
...
void UnityEngine::LogOption::_set_NoStacktrace(UnityEngine::LogOption value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine").WithContext("LogOption").WithContext("_set_NoStacktrace");
