...
System::Reflection::MethodInfo* UnityEngine::Events::UnityEvent::FindMethod_Impl(::CsString* name, ::CsObject* targetObj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Reflection::MethodInfo*>(this, "FindMethod_Impl", name, targetObj));
}
// Autogenerated method: UnityEngine.Events.UnityEvent.GetDelegate
UnityEngine::Events::BaseInvokableCall* UnityEngine::Events::UnityEvent::GetDelegate(::CsObject* target, System::Reflection::MethodInfo* theFunction) {
