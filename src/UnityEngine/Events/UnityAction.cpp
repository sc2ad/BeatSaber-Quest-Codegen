...
UnityEngine::Events::UnityAction* UnityEngine::Events::UnityAction::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* UnityEngine::Events::UnityAction::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
