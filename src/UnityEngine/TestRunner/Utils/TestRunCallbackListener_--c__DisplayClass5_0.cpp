...
UnityEngine::TestRunner::Utils::TestRunCallbackListener::$$c__DisplayClass5_0* UnityEngine::TestRunner::Utils::TestRunCallbackListener::$$c__DisplayClass5_0::New_ctor() {
  return (TestRunCallbackListener::$$c__DisplayClass5_0*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestRunner.Utils", "TestRunCallbackListener/<>c__DisplayClass5_0"));
}
