...
void UnityEngine::TestRunner::Utils::TestRunCallbackListener::$$c__DisplayClass6_0::$TestFinished$b__0(UnityEngine::TestRunner::ITestRunCallback* callback) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<TestFinished>b__0", callback));
}
...
UnityEngine::TestRunner::Utils::TestRunCallbackListener::$$c__DisplayClass6_0* UnityEngine::TestRunner::Utils::TestRunCallbackListener::$$c__DisplayClass6_0::New_ctor() {
  return (TestRunCallbackListener::$$c__DisplayClass6_0*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestRunner.Utils", "TestRunCallbackListener/<>c__DisplayClass6_0"));
}
