...
void UnityEngine::TestRunner::TestLaunchers::RemoteTestResultData::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.TestRunner.TestLaunchers", "RemoteTestResultData/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* UnityEngine::TestRunner::TestLaunchers::RemoteTestResultData::$$c::$_ctor$b__19_0(NUnit::Framework::Interfaces::ITestResult* child) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<.ctor>b__19_0", {}, ::il2cpp_utils::ExtractTypes(child))));
