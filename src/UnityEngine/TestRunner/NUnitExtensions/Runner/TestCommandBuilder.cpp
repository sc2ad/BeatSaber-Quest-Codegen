...
::Il2CppString* UnityEngine::TestRunner::NUnitExtensions::Runner::TestCommandBuilder::GetTestBuilderName(NUnit::Framework::Internal::TestMethod* testMethod) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine.TestRunner.NUnitExtensions.Runner", "TestCommandBuilder", "GetTestBuilderName", testMethod));
}
