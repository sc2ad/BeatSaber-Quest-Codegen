...
NUnit::Framework::Internal::Commands::TestCommand* UnityEngine::TestRunner::NUnitExtensions::Runner::TestCommandBuilder::BuildTestCommand(NUnit::Framework::Internal::TestMethod* test, NUnit::Framework::Interfaces::ITestFilter* filter) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestRunner.NUnitExtensions.Runner", "TestCommandBuilder", il2cpp_utils::NoArgClass<NUnit::Framework::Internal::Commands::TestCommand*>(), "BuildTestCommand", {}, ::il2cpp_utils::ExtractTypes(test, filter)));
...
::Il2CppString* UnityEngine::TestRunner::NUnitExtensions::Runner::TestCommandBuilder::GetTestBuilderName(NUnit::Framework::Internal::TestMethod* testMethod) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestRunner.NUnitExtensions.Runner", "TestCommandBuilder", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetTestBuilderName", {}, ::il2cpp_utils::ExtractTypes(testMethod)));
...
NUnit::Framework::Internal::Commands::TestCommand* UnityEngine::TestRunner::NUnitExtensions::Runner::TestCommandBuilder::TryReplaceWithEnumerableCommand(NUnit::Framework::Internal::Commands::TestCommand* command) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestRunner.NUnitExtensions.Runner", "TestCommandBuilder", il2cpp_utils::NoArgClass<NUnit::Framework::Internal::Commands::TestCommand*>(), "TryReplaceWithEnumerableCommand", {}, ::il2cpp_utils::ExtractTypes(command)));
