...
void UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::SkipFixture(NUnit::Framework::Interfaces::ResultState* resultState, ::CsString* message, ::CsString* stackTrace) {
...
void UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::SkipChildren(NUnit::Framework::Internal::TestSuite* suite, NUnit::Framework::Interfaces::ResultState* resultState, ::CsString* message) {
...
::CsString* UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::GetSkipReason() {
...
::CsString* UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::GetProviderStackTrace() {
