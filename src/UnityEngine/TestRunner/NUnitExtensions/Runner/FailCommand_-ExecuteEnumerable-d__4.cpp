...
UnityEngine::TestRunner::NUnitExtensions::Runner::FailCommand::$ExecuteEnumerable$d__4* UnityEngine::TestRunner::NUnitExtensions::Runner::FailCommand::$ExecuteEnumerable$d__4::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestRunner::NUnitExtensions::Runner").WithContext("$ExecuteEnumerable$d__4").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<FailCommand::$ExecuteEnumerable$d__4*>($$1__state));
}
