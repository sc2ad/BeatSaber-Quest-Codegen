...
// Completed includes
// Autogenerated method: UnityEngine.TestRunner.NUnitExtensions.Runner.CompositeWorkItem/<PerformWork>d__12..ctor
UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::$PerformWork$d__12* UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::$PerformWork$d__12::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<CompositeWorkItem::$PerformWork$d__12*>($$1__state));
}
