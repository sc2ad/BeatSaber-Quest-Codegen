...
UnityEngine::TestRunner::NUnitExtensions::Runner::PlaymodeWorkItemFactory* UnityEngine::TestRunner::NUnitExtensions::Runner::PlaymodeWorkItemFactory::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestRunner::NUnitExtensions::Runner").WithContext("PlaymodeWorkItemFactory").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlaymodeWorkItemFactory*>());
}
