...
UnityEngine::TestRunner::NUnitExtensions::Runner::CoroutineTestWorkItem::$PerformWork$d__6* UnityEngine::TestRunner::NUnitExtensions::Runner::CoroutineTestWorkItem::$PerformWork$d__6::New_ctor(int $$1__state) {
  return (CoroutineTestWorkItem::$PerformWork$d__6*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.TestRunner.NUnitExtensions.Runner", "CoroutineTestWorkItem/<PerformWork>d__6", $$1__state));
}
...
::CsObject* UnityEngine::TestRunner::NUnitExtensions::Runner::CoroutineTestWorkItem::$PerformWork$d__6::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::TestRunner::NUnitExtensions::Runner::CoroutineTestWorkItem::$PerformWork$d__6::System_Collections_IEnumerator_get_Current() {
...
System::Collections::Generic::IEnumerator_1<::CsObject*>* UnityEngine::TestRunner::NUnitExtensions::Runner::CoroutineTestWorkItem::$PerformWork$d__6::System_Collections_Generic_IEnumerable_1_GetEnumerator() {
