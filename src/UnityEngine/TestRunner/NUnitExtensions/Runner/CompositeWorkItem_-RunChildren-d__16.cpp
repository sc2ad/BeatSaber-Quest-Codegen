...
UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::$RunChildren$d__16* UnityEngine::TestRunner::NUnitExtensions::Runner::CompositeWorkItem::$RunChildren$d__16::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::TestRunner::NUnitExtensions::Runner").WithContext("$RunChildren$d__16").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CompositeWorkItem::$RunChildren$d__16*>($$1__state));
}
