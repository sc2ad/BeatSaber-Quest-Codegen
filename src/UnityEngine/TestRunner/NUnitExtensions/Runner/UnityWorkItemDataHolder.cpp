...
void UnityEngine::TestRunner::NUnitExtensions::Runner::UnityWorkItemDataHolder::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestRunner.NUnitExtensions.Runner", "UnityWorkItemDataHolder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
