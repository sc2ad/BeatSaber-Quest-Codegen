...
System::Action* UnityEngine::TestRunner::NUnitExtensions::Runner::EditModeTestCallbacks::get_RestoringTestContext() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TestRunner.NUnitExtensions.Runner", "EditModeTestCallbacks", il2cpp_utils::NoArgClass<System::Action*>(), "get_RestoringTestContext", {}, ::il2cpp_utils::ExtractTypes()));
