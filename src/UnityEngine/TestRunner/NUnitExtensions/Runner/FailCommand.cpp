...
UnityEngine::TestRunner::NUnitExtensions::Runner::FailCommand* UnityEngine::TestRunner::NUnitExtensions::Runner::FailCommand::New_ctor(NUnit::Framework::Internal::Test* test, NUnit::Framework::Interfaces::ResultState* resultState, ::CsString* message) {
