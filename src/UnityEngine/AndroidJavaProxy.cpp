...
UnityEngine::AndroidJavaProxy* UnityEngine::AndroidJavaProxy::New_ctor(::CsString* javaInterface) {
...
UnityEngine::AndroidJavaObject* UnityEngine::AndroidJavaProxy::Invoke(::CsString* methodName, ::Array<::CsObject*>* args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::AndroidJavaObject*>(this, "Invoke", methodName, args));
}
// Autogenerated method: UnityEngine.AndroidJavaProxy.Invoke
UnityEngine::AndroidJavaObject* UnityEngine::AndroidJavaProxy::Invoke(::CsString* methodName, ::Array<UnityEngine::AndroidJavaObject*>* javaArgs) {
...
::CsString* UnityEngine::AndroidJavaProxy::toString() {
