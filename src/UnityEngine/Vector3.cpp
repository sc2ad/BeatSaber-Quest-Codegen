...
UnityEngine::Vector3* UnityEngine::Vector3::New_ctor(float x, float y, float z) {
  return (Vector3*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "Vector3", x, y, z));
}
// Autogenerated method: UnityEngine.Vector3..ctor
UnityEngine::Vector3* UnityEngine::Vector3::New_ctor(float x, float y) {
  return (Vector3*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "Vector3", x, y));
}
...
::CsString* UnityEngine::Vector3::ToString(::CsString* format) {
...
bool UnityEngine::Vector3::Equals(::CsObject* other) {
...
// Autogenerated method: UnityEngine.Vector3.ToString
::CsString* UnityEngine::Vector3::ToString() {
