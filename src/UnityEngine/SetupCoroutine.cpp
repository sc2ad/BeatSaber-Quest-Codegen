...
void UnityEngine::SetupCoroutine::InvokeMoveNext(System::Collections::IEnumerator* enumerator, System::IntPtr returnValueAddress) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "SetupCoroutine", il2cpp_utils::NoArgClass<void>(), "InvokeMoveNext", {}, ::il2cpp_utils::ExtractTypes(enumerator, returnValueAddress)));
...
::Il2CppObject* UnityEngine::SetupCoroutine::InvokeMember(::Il2CppObject* behaviour, ::Il2CppString* name, ::Il2CppObject* variable) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "SetupCoroutine", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "InvokeMember", {}, ::il2cpp_utils::ExtractTypes(behaviour, name, variable)));
