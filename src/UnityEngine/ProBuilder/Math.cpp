...
UnityEngine::Vector3 UnityEngine::ProBuilder::Math::Clamp(UnityEngine::Vector3 value, UnityEngine::Vector3 lowerBound, UnityEngine::Vector3 upperBound) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::Vector3>("UnityEngine.ProBuilder", "Math", "Clamp", value, lowerBound, upperBound));
}
...
float UnityEngine::ProBuilder::Math::Sum(UnityEngine::Vector3 v) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<float>("UnityEngine.ProBuilder", "Math", "Sum", v));
}
