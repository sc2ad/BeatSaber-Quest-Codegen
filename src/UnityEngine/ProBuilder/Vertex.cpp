...
::CsString* UnityEngine::ProBuilder::Vertex::ToString(::CsString* args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ToString", args));
}
...
// Autogenerated method: UnityEngine.ProBuilder.Vertex.Equals
bool UnityEngine::ProBuilder::Vertex::Equals(::CsObject* obj) {
