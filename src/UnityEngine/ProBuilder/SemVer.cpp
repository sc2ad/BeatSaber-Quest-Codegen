...
::CsString* UnityEngine::ProBuilder::SemVer::_get_DefaultStringFormat() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("UnityEngine.ProBuilder", "SemVer", "DefaultStringFormat"));
}
// Autogenerated static field setter
// Set static field: static public System.String DefaultStringFormat
void UnityEngine::ProBuilder::SemVer::_set_DefaultStringFormat(::CsString* value) {
...
::CsString* UnityEngine::ProBuilder::SemVer::get_type() {
...
::CsString* UnityEngine::ProBuilder::SemVer::get_metadata() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_metadata"));
}
// Autogenerated method: UnityEngine.ProBuilder.SemVer.get_date
::CsString* UnityEngine::ProBuilder::SemVer::get_date() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_date"));
}
...
UnityEngine::ProBuilder::SemVer* UnityEngine::ProBuilder::SemVer::New_ctor(::CsString* formatted, ::CsString* date) {
  return (SemVer*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.ProBuilder", "SemVer", formatted, date));
}
// Autogenerated method: UnityEngine.ProBuilder.SemVer..ctor
UnityEngine::ProBuilder::SemVer* UnityEngine::ProBuilder::SemVer::New_ctor(int major, int minor, int patch, int build, ::CsString* type, ::CsString* date, ::CsString* metadata) {
...
::CsString* UnityEngine::ProBuilder::SemVer::ToString(::CsString* format) {
...
bool UnityEngine::ProBuilder::SemVer::TryGetVersionInfo(::CsString* input, UnityEngine::ProBuilder::SemVer*& version) {
...
int UnityEngine::ProBuilder::SemVer::GetBuildNumber(::CsString* input) {
...
bool UnityEngine::ProBuilder::SemVer::Equals(::CsObject* o) {
...
int UnityEngine::ProBuilder::SemVer::CompareTo(::CsObject* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "CompareTo", obj));
}
int UnityEngine::ProBuilder::SemVer::System_IComparable_CompareTo(::CsObject* obj) {
...
// Autogenerated method: UnityEngine.ProBuilder.SemVer.ToString
::CsString* UnityEngine::ProBuilder::SemVer::ToString() {
