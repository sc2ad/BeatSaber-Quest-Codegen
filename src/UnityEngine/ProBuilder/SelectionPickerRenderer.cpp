...
::CsString* UnityEngine::ProBuilder::SelectionPickerRenderer::_get_k_FacePickerOcclusionTintUniform() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("UnityEngine.ProBuilder", "SelectionPickerRenderer", "k_FacePickerOcclusionTintUniform"));
}
// Autogenerated static field setter
// Set static field: static private System.String k_FacePickerOcclusionTintUniform
void UnityEngine::ProBuilder::SelectionPickerRenderer::_set_k_FacePickerOcclusionTintUniform(::CsString* value) {
...
UnityEngine::Texture2D* UnityEngine::ProBuilder::SelectionPickerRenderer::RenderWithReplacementShader(UnityEngine::Camera* camera, UnityEngine::Shader* shader, ::CsString* tag, int width, int height) {
