...
void UnityEngine::ProBuilder::Smoothing::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "Smoothing/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int UnityEngine::ProBuilder::Smoothing::$$c::$GetUnusedSmoothingGroup$b__5_0(UnityEngine::ProBuilder::Face* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<GetUnusedSmoothingGroup>b__5_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
int UnityEngine::ProBuilder::Smoothing::$$c::$ApplySmoothingGroups$b__9_0(UnityEngine::ProBuilder::Face* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<ApplySmoothingGroups>b__9_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
UnityEngine::ProBuilder::Smoothing::$$c* UnityEngine::ProBuilder::Smoothing::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Smoothing::$$c*>());
}
