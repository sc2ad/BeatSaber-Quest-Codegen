...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::CreateShape(UnityEngine::ProBuilder::ShapeType shape, UnityEngine::ProBuilder::PivotLocation pivotType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "CreateShape", {}, ::il2cpp_utils::ExtractTypes(shape, pivotType)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateStair(UnityEngine::ProBuilder::PivotLocation pivotType, UnityEngine::Vector3 size, int steps, bool buildSides) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateStair", {}, ::il2cpp_utils::ExtractTypes(pivotType, size, steps, buildSides)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateCurvedStair(UnityEngine::ProBuilder::PivotLocation pivotType, float stairWidth, float height, float innerRadius, float circumference, int steps, bool buildSides) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateCurvedStair", {}, ::il2cpp_utils::ExtractTypes(pivotType, stairWidth, height, innerRadius, circumference, steps, buildSides)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateStair(UnityEngine::ProBuilder::PivotLocation pivotType, int steps, float width, float height, float depth, bool sidesGoToFloor, bool generateBack, bool platformsOnly) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::ProBuilder").WithContext("ShapeGenerator").WithContext("GenerateStair");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateStair", {}, ::il2cpp_utils::ExtractTypes(pivotType, steps, width, height, depth, sidesGoToFloor, generateBack, platformsOnly)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateCube(UnityEngine::ProBuilder::PivotLocation pivotType, UnityEngine::Vector3 size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateCube", {}, ::il2cpp_utils::ExtractTypes(pivotType, size)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateCylinder(UnityEngine::ProBuilder::PivotLocation pivotType, int axisDivisions, float radius, float height, int heightCuts, int smoothing) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateCylinder", {}, ::il2cpp_utils::ExtractTypes(pivotType, axisDivisions, radius, height, heightCuts, smoothing)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GeneratePrism(UnityEngine::ProBuilder::PivotLocation pivotType, UnityEngine::Vector3 size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GeneratePrism", {}, ::il2cpp_utils::ExtractTypes(pivotType, size)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::ProBuilder::ProBuilderMesh*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, pivotType, size);
}
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateDoor(UnityEngine::ProBuilder::PivotLocation pivotType, float totalWidth, float totalHeight, float ledgeHeight, float legWidth, float depth) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateDoor", {}, ::il2cpp_utils::ExtractTypes(pivotType, totalWidth, totalHeight, ledgeHeight, legWidth, depth)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GeneratePlane(UnityEngine::ProBuilder::PivotLocation pivotType, float width, float height, int widthCuts, int heightCuts, UnityEngine::ProBuilder::Axis axis) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GeneratePlane", {}, ::il2cpp_utils::ExtractTypes(pivotType, width, height, widthCuts, heightCuts, axis)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GeneratePipe(UnityEngine::ProBuilder::PivotLocation pivotType, float radius, float height, float thickness, int subdivAxis, int subdivHeight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GeneratePipe", {}, ::il2cpp_utils::ExtractTypes(pivotType, radius, height, thickness, subdivAxis, subdivHeight)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateCone(UnityEngine::ProBuilder::PivotLocation pivotType, float radius, float height, int subdivAxis) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateCone", {}, ::il2cpp_utils::ExtractTypes(pivotType, radius, height, subdivAxis)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateArch(UnityEngine::ProBuilder::PivotLocation pivotType, float angle, float radius, float width, float depth, int radialCuts, bool insideFaces, bool outsideFaces, bool frontFaces, bool backFaces, bool endCaps) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateArch", {}, ::il2cpp_utils::ExtractTypes(pivotType, angle, radius, width, depth, radialCuts, insideFaces, outsideFaces, frontFaces, backFaces, endCaps)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateIcosahedron(UnityEngine::ProBuilder::PivotLocation pivotType, float radius, int subdivisions, bool weldVertices, bool manualUvs) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateIcosahedron", {}, ::il2cpp_utils::ExtractTypes(pivotType, radius, subdivisions, weldVertices, manualUvs)));
...
::Array<UnityEngine::Vector3>* UnityEngine::ProBuilder::ShapeGenerator::SubdivideIcosahedron(::Array<UnityEngine::Vector3>* vertices, float radius) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<::Array<UnityEngine::Vector3>*>(), "SubdivideIcosahedron", {}, ::il2cpp_utils::ExtractTypes(vertices, radius)));
...
::Array<UnityEngine::Vector3>* UnityEngine::ProBuilder::ShapeGenerator::GetCirclePoints(int segments, float radius, float circumference, UnityEngine::Quaternion rotation, float offset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<::Array<UnityEngine::Vector3>*>(), "GetCirclePoints", {}, ::il2cpp_utils::ExtractTypes(segments, radius, circumference, rotation, offset)));
...
UnityEngine::ProBuilder::ProBuilderMesh* UnityEngine::ProBuilder::ShapeGenerator::GenerateTorus(UnityEngine::ProBuilder::PivotLocation pivotType, int rows, int columns, float innerRadius, float outerRadius, bool smooth, float horizontalCircumference, float verticalCircumference, bool manualUvs) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::ProBuilderMesh*>(), "GenerateTorus", {}, ::il2cpp_utils::ExtractTypes(pivotType, rows, columns, innerRadius, outerRadius, smooth, horizontalCircumference, verticalCircumference, manualUvs)));
...
void UnityEngine::ProBuilder::ShapeGenerator::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "ShapeGenerator", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
