...
UnityEngine::ProBuilder::Clipping::OutCode UnityEngine::ProBuilder::Clipping::ComputeOutCode(UnityEngine::Rect rect, float x, float y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "Clipping", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::Clipping::OutCode>(), "ComputeOutCode", {}, ::il2cpp_utils::ExtractTypes(rect, x, y)));
...
bool UnityEngine::ProBuilder::Clipping::RectContainsLineSegment(UnityEngine::Rect rect, float x0, float y0, float x1, float y1) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "Clipping", il2cpp_utils::NoArgClass<bool>(), "RectContainsLineSegment", {}, ::il2cpp_utils::ExtractTypes(rect, x0, y0, x1, y1)));
