...
System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::Edge>* UnityEngine::ProBuilder::EdgeUtility::GetSharedVertexHandleEdges(UnityEngine::ProBuilder::ProBuilderMesh* mesh, System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::Edge>* edges) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::Edge>*>(), "GetSharedVertexHandleEdges", {}, ::il2cpp_utils::ExtractTypes(mesh, edges)));
...
UnityEngine::ProBuilder::Edge UnityEngine::ProBuilder::EdgeUtility::GetSharedVertexHandleEdge(UnityEngine::ProBuilder::ProBuilderMesh* mesh, UnityEngine::ProBuilder::Edge edge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::Edge>(), "GetSharedVertexHandleEdge", {}, ::il2cpp_utils::ExtractTypes(mesh, edge)));
...
UnityEngine::ProBuilder::Edge UnityEngine::ProBuilder::EdgeUtility::GetEdgeWithSharedVertexHandles(UnityEngine::ProBuilder::ProBuilderMesh* mesh, UnityEngine::ProBuilder::Edge edge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::Edge>(), "GetEdgeWithSharedVertexHandles", {}, ::il2cpp_utils::ExtractTypes(mesh, edge)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::ProBuilder::Edge, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, mesh, edge);
}
...
bool UnityEngine::ProBuilder::EdgeUtility::ValidateEdge(UnityEngine::ProBuilder::ProBuilderMesh* mesh, UnityEngine::ProBuilder::Edge edge, UnityEngine::ProBuilder::SimpleTuple_2<UnityEngine::ProBuilder::Face*, UnityEngine::ProBuilder::Edge>& validEdge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<bool>(), "ValidateEdge", {}, ::il2cpp_utils::ExtractTypes(mesh, edge, validEdge)));
...
bool UnityEngine::ProBuilder::EdgeUtility::Contains(::Array<UnityEngine::ProBuilder::Edge>* edges, UnityEngine::ProBuilder::Edge edge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<bool>(), "Contains", {}, ::il2cpp_utils::ExtractTypes(edges, edge)));
...
bool UnityEngine::ProBuilder::EdgeUtility::Contains(::Array<UnityEngine::ProBuilder::Edge>* edges, int x, int y) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::ProBuilder").WithContext("EdgeUtility").WithContext("Contains");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<bool>(), "Contains", {}, ::il2cpp_utils::ExtractTypes(edges, x, y)));
...
int UnityEngine::ProBuilder::EdgeUtility::IndexOf(UnityEngine::ProBuilder::ProBuilderMesh* mesh, System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Edge>* edges, UnityEngine::ProBuilder::Edge edge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<int>(), "IndexOf", {}, ::il2cpp_utils::ExtractTypes(mesh, edges, edge)));
...
::Array<int>* UnityEngine::ProBuilder::EdgeUtility::AllTriangles(::Array<UnityEngine::ProBuilder::Edge>* edges) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<::Array<int>*>(), "AllTriangles", {}, ::il2cpp_utils::ExtractTypes(edges)));
...
UnityEngine::ProBuilder::Face* UnityEngine::ProBuilder::EdgeUtility::GetFace(UnityEngine::ProBuilder::ProBuilderMesh* mesh, UnityEngine::ProBuilder::Edge edge) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder", "EdgeUtility", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::Face*>(), "GetFace", {}, ::il2cpp_utils::ExtractTypes(mesh, edge)));
