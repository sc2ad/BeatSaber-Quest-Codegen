...
System::Collections::Generic::List_1<UnityEngine::ProBuilder::Face*>* UnityEngine::ProBuilder::MeshOperations::Bevel::BevelEdges(UnityEngine::ProBuilder::ProBuilderMesh* mesh, System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Edge>* edges, float amount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "Bevel", il2cpp_utils::NoArgClass<System::Collections::Generic::List_1<UnityEngine::ProBuilder::Face*>*>(), "BevelEdges", {}, ::il2cpp_utils::ExtractTypes(mesh, edges, amount)));
...
System::Collections::Generic::List_1<UnityEngine::ProBuilder::FaceRebuildData*>* UnityEngine::ProBuilder::MeshOperations::Bevel::GetBridgeFaces(System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Vertex*>* vertices, UnityEngine::ProBuilder::WingedEdge* left, UnityEngine::ProBuilder::WingedEdge* right, System::Collections::Generic::Dictionary_2<int, System::Collections::Generic::List_1<UnityEngine::ProBuilder::SimpleTuple_2<UnityEngine::ProBuilder::FaceRebuildData*, System::Collections::Generic::List_1<int>*>>*>* holes) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "Bevel", il2cpp_utils::NoArgClass<System::Collections::Generic::List_1<UnityEngine::ProBuilder::FaceRebuildData*>*>(), "GetBridgeFaces", {}, ::il2cpp_utils::ExtractTypes(vertices, left, right, holes)));
...
void UnityEngine::ProBuilder::MeshOperations::Bevel::SlideEdge(System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Vertex*>* vertices, UnityEngine::ProBuilder::WingedEdge* we, float amount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "Bevel", il2cpp_utils::NoArgClass<void>(), "SlideEdge", {}, ::il2cpp_utils::ExtractTypes(vertices, we, amount)));
...
UnityEngine::ProBuilder::Edge UnityEngine::ProBuilder::MeshOperations::Bevel::GetLeadingEdge(UnityEngine::ProBuilder::WingedEdge* wing, int common) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "Bevel", il2cpp_utils::NoArgClass<UnityEngine::ProBuilder::Edge>(), "GetLeadingEdge", {}, ::il2cpp_utils::ExtractTypes(wing, common)));
...
void UnityEngine::ProBuilder::MeshOperations::Bevel::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "Bevel", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
