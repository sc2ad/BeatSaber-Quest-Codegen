...
void UnityEngine::ProBuilder::MeshOperations::CombineMeshes::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.ProBuilder.MeshOperations", "CombineMeshes/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int UnityEngine::ProBuilder::MeshOperations::CombineMeshes::$$c::$SplitByMaxVertexCount$b__5_0(UnityEngine::ProBuilder::Face* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<SplitByMaxVertexCount>b__5_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
UnityEngine::ProBuilder::MeshOperations::CombineMeshes::$$c* UnityEngine::ProBuilder::MeshOperations::CombineMeshes::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<CombineMeshes::$$c*>());
}
