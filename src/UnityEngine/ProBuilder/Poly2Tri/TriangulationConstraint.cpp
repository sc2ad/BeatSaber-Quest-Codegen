...
UnityEngine::ProBuilder::Poly2Tri::TriangulationConstraint* UnityEngine::ProBuilder::Poly2Tri::TriangulationConstraint::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::ProBuilder::Poly2Tri").WithContext("TriangulationConstraint").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TriangulationConstraint*>());
}
