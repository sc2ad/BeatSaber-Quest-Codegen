...
::CsString* UnityEngine::EventSystems::OVRInputModule::get_horizontalAxis() {
...
void UnityEngine::EventSystems::OVRInputModule::set_horizontalAxis(::CsString* value) {
...
::CsString* UnityEngine::EventSystems::OVRInputModule::get_verticalAxis() {
...
void UnityEngine::EventSystems::OVRInputModule::set_verticalAxis(::CsString* value) {
...
::CsString* UnityEngine::EventSystems::OVRInputModule::get_submitButton() {
...
void UnityEngine::EventSystems::OVRInputModule::set_submitButton(::CsString* value) {
...
::CsString* UnityEngine::EventSystems::OVRInputModule::get_cancelButton() {
...
void UnityEngine::EventSystems::OVRInputModule::set_cancelButton(::CsString* value) {
