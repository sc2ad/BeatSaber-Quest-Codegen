...
void UnityEngine::EventSystems::PointerInputModule::RemovePointerData(UnityEngine::EventSystems::PointerEventData* data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RemovePointerData", {}, ::il2cpp_utils::ExtractTypes(data)));
...
UnityEngine::EventSystems::PointerEventData* UnityEngine::EventSystems::PointerInputModule::GetTouchPointerEventData(UnityEngine::Touch input, bool& pressed, bool& released) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::PointerEventData*>(), "GetTouchPointerEventData", {}, ::il2cpp_utils::ExtractTypes(input, pressed, released)));
...
UnityEngine::EventSystems::PointerEventData::FramePressState UnityEngine::EventSystems::PointerInputModule::StateForMouseButton(int buttonId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::PointerEventData::FramePressState>(), "StateForMouseButton", {}, ::il2cpp_utils::ExtractTypes(buttonId)));
...
UnityEngine::EventSystems::PointerInputModule::MouseState* UnityEngine::EventSystems::PointerInputModule::GetMousePointerEventData() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::PointerInputModule::MouseState*>(), "GetMousePointerEventData", {}, ::il2cpp_utils::ExtractTypes()));
...
UnityEngine::EventSystems::PointerInputModule::MouseState* UnityEngine::EventSystems::PointerInputModule::GetMousePointerEventData(int id) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::EventSystems").WithContext("PointerInputModule").WithContext("GetMousePointerEventData");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::PointerInputModule::MouseState*>(), "GetMousePointerEventData", {}, ::il2cpp_utils::ExtractTypes(id)));
...
bool UnityEngine::EventSystems::PointerInputModule::ShouldStartDrag(UnityEngine::Vector2 pressPos, UnityEngine::Vector2 currentPos, float threshold, bool useDragThreshold) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.EventSystems", "PointerInputModule", il2cpp_utils::NoArgClass<bool>(), "ShouldStartDrag", {}, ::il2cpp_utils::ExtractTypes(pressPos, currentPos, threshold, useDragThreshold)));
...
UnityEngine::EventSystems::PointerInputModule* UnityEngine::EventSystems::PointerInputModule::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<PointerInputModule*>());
}
