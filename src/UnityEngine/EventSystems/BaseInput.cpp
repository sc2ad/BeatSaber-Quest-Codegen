...
::CsString* UnityEngine::EventSystems::BaseInput::get_compositionString() {
...
float UnityEngine::EventSystems::BaseInput::GetAxisRaw(::CsString* axisName) {
...
bool UnityEngine::EventSystems::BaseInput::GetButtonDown(::CsString* buttonName) {
