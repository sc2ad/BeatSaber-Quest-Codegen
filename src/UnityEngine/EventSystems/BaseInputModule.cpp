...
UnityEngine::EventSystems::BaseInput* UnityEngine::EventSystems::BaseInputModule::get_inputOverride() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::BaseInput*>(), "get_inputOverride", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::EventSystems::BaseInput*, false>(this, ___internal__method);
}
...
void UnityEngine::EventSystems::BaseInputModule::set_inputOverride(UnityEngine::EventSystems::BaseInput* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_inputOverride", {}, ::il2cpp_utils::ExtractTypes(value)));
...
UnityEngine::EventSystems::EventSystem* UnityEngine::EventSystems::BaseInputModule::get_eventSystem() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::EventSystem*>(), "get_eventSystem", {}, ::il2cpp_utils::ExtractTypes()));
...
UnityEngine::EventSystems::RaycastResult UnityEngine::EventSystems::BaseInputModule::FindFirstRaycast(System::Collections::Generic::List_1<UnityEngine::EventSystems::RaycastResult>* candidates) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.EventSystems", "BaseInputModule", il2cpp_utils::NoArgClass<UnityEngine::EventSystems::RaycastResult>(), "FindFirstRaycast", {}, ::il2cpp_utils::ExtractTypes(candidates)));
...
UnityEngine::EventSystems::MoveDirection UnityEngine::EventSystems::BaseInputModule::DetermineMoveDirection(float x, float y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.EventSystems", "BaseInputModule", il2cpp_utils::NoArgClass<UnityEngine::EventSystems::MoveDirection>(), "DetermineMoveDirection", {}, ::il2cpp_utils::ExtractTypes(x, y)));
...
UnityEngine::EventSystems::MoveDirection UnityEngine::EventSystems::BaseInputModule::DetermineMoveDirection(float x, float y, float deadZone) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::EventSystems").WithContext("BaseInputModule").WithContext("DetermineMoveDirection");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.EventSystems", "BaseInputModule", il2cpp_utils::NoArgClass<UnityEngine::EventSystems::MoveDirection>(), "DetermineMoveDirection", {}, ::il2cpp_utils::ExtractTypes(x, y, deadZone)));
...
UnityEngine::GameObject* UnityEngine::EventSystems::BaseInputModule::FindCommonRoot(UnityEngine::GameObject* g1, UnityEngine::GameObject* g2) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.EventSystems", "BaseInputModule", il2cpp_utils::NoArgClass<UnityEngine::GameObject*>(), "FindCommonRoot", {}, ::il2cpp_utils::ExtractTypes(g1, g2)));
...
UnityEngine::EventSystems::AxisEventData* UnityEngine::EventSystems::BaseInputModule::GetAxisEventData(float x, float y, float moveDeadZone) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::AxisEventData*>(), "GetAxisEventData", {}, ::il2cpp_utils::ExtractTypes(x, y, moveDeadZone)));
...
UnityEngine::EventSystems::BaseEventData* UnityEngine::EventSystems::BaseInputModule::GetBaseEventData() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::EventSystems::BaseEventData*>(), "GetBaseEventData", {}, ::il2cpp_utils::ExtractTypes()));
