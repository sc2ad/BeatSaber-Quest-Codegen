...
UnityEngine::RenderTextureDescriptor* UnityEngine::RenderTextureDescriptor::New_ctor(int width, int height, UnityEngine::RenderTextureFormat colorFormat, int depthBufferBits) {
  return (RenderTextureDescriptor*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "RenderTextureDescriptor", width, height, colorFormat, depthBufferBits));
}
// Autogenerated method: UnityEngine.RenderTextureDescriptor..ctor
UnityEngine::RenderTextureDescriptor* UnityEngine::RenderTextureDescriptor::New_ctor(int width, int height, UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, int depthBufferBits) {
  return (RenderTextureDescriptor*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "RenderTextureDescriptor", width, height, colorFormat, depthBufferBits));
}
// Autogenerated method: UnityEngine.RenderTextureDescriptor..ctor
UnityEngine::RenderTextureDescriptor* UnityEngine::RenderTextureDescriptor::New_ctor(int width, int height, UnityEngine::Experimental::Rendering::GraphicsFormat colorFormat, int depthBufferBits, int mipCount) {
  return (RenderTextureDescriptor*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "RenderTextureDescriptor", width, height, colorFormat, depthBufferBits, mipCount));
}
