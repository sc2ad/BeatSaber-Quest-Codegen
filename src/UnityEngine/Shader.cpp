...
UnityEngine::Shader* UnityEngine::Shader::Find(::CsString* name) {
...
void UnityEngine::Shader::EnableKeyword(::CsString* keyword) {
...
void UnityEngine::Shader::DisableKeyword(::CsString* keyword) {
...
int UnityEngine::Shader::PropertyToID(::CsString* name) {
...
void UnityEngine::Shader::SetGlobalColor(int nameID, UnityEngine::Color value) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Shader", "SetGlobalColor", nameID, value));
}
...
void UnityEngine::Shader::SetGlobalTexture(::CsString* name, UnityEngine::Texture* value) {
...
UnityEngine::Shader* UnityEngine::Shader::New_ctor() {
  return (Shader*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "Shader"));
}
