...
UnityEngine::HumanDescription UnityEngine::Avatar::get_humanDescription() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::HumanDescription>(this, "get_humanDescription"));
}
...
void UnityEngine::Avatar::get_humanDescription_Injected(UnityEngine::HumanDescription& ret) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "get_humanDescription_Injected", ret));
}
