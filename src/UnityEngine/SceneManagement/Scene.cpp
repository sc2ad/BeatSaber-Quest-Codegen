...
::CsString* UnityEngine::SceneManagement::Scene::GetNameInternal(int sceneHandle) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.SceneManagement", "Scene", "GetNameInternal", sceneHandle));
}
...
void UnityEngine::SceneManagement::Scene::GetRootGameObjectsInternal(int sceneHandle, ::CsObject* resultRootList) {
...
::CsString* UnityEngine::SceneManagement::Scene::get_name() {
...
bool UnityEngine::SceneManagement::Scene::Equals(::CsObject* other) {
