...
UnityEngine::SceneManagement::Scene UnityEngine::SceneManagement::SceneManager::GetSceneByName(::CsString* name) {
...
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::LoadSceneAsyncNameIndexInternal(::CsString* sceneName, int sceneBuildIndex, UnityEngine::SceneManagement::LoadSceneParameters parameters, bool mustCompleteNextFrame) {
...
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::UnloadSceneNameIndexInternal(::CsString* sceneName, int sceneBuildIndex, bool immediately, UnityEngine::SceneManagement::UnloadSceneOptions options, bool& outSuccess) {
...
void UnityEngine::SceneManagement::SceneManager::LoadScene(::CsString* sceneName, UnityEngine::SceneManagement::LoadSceneMode mode) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine.SceneManagement", "SceneManager", "LoadScene", sceneName, mode));
}
// Autogenerated method: UnityEngine.SceneManagement.SceneManager.LoadScene
void UnityEngine::SceneManagement::SceneManager::LoadScene(::CsString* sceneName) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine.SceneManagement", "SceneManager", "LoadScene", sceneName));
}
// Autogenerated method: UnityEngine.SceneManagement.SceneManager.LoadScene
UnityEngine::SceneManagement::Scene UnityEngine::SceneManagement::SceneManager::LoadScene(::CsString* sceneName, UnityEngine::SceneManagement::LoadSceneParameters parameters) {
...
// Autogenerated method: UnityEngine.SceneManagement.SceneManager.LoadSceneAsync
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::LoadSceneAsync(::CsString* sceneName, UnityEngine::SceneManagement::LoadSceneMode mode) {
...
// Autogenerated method: UnityEngine.SceneManagement.SceneManager.LoadSceneAsync
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::LoadSceneAsync(::CsString* sceneName) {
...
// Autogenerated method: UnityEngine.SceneManagement.SceneManager.LoadSceneAsync
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::LoadSceneAsync(::CsString* sceneName, UnityEngine::SceneManagement::LoadSceneParameters parameters) {
...
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::UnloadSceneAsync(::CsString* sceneName) {
...
void UnityEngine::SceneManagement::SceneManager::GetSceneByName_Injected(::CsString* name, UnityEngine::SceneManagement::Scene& ret) {
...
UnityEngine::AsyncOperation* UnityEngine::SceneManagement::SceneManager::LoadSceneAsyncNameIndexInternal_Injected(::CsString* sceneName, int sceneBuildIndex, UnityEngine::SceneManagement::LoadSceneParameters& parameters, bool mustCompleteNextFrame) {
