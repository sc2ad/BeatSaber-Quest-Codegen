...
UnityEngine::PropertyName UnityEngine::PropertyNameUtils::PropertyNameFromString(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "PropertyNameUtils", il2cpp_utils::NoArgClass<UnityEngine::PropertyName>(), "PropertyNameFromString", {}, ::il2cpp_utils::ExtractTypes(name)));
...
void UnityEngine::PropertyNameUtils::PropertyNameFromString_Injected(::Il2CppString* name, UnityEngine::PropertyName& ret) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "PropertyNameUtils", il2cpp_utils::NoArgClass<void>(), "PropertyNameFromString_Injected", {}, ::il2cpp_utils::ExtractTypes(name, ret)));
