...
UnityEngine::AnimatorOverrideController::OnOverrideControllerDirtyCallback* UnityEngine::AnimatorOverrideController::OnOverrideControllerDirtyCallback::New_ctor(::CsObject* object, System::IntPtr method) {
  return (AnimatorOverrideController::OnOverrideControllerDirtyCallback*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "AnimatorOverrideController/OnOverrideControllerDirtyCallback", object, method));
}
...
System::IAsyncResult* UnityEngine::AnimatorOverrideController::OnOverrideControllerDirtyCallback::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
