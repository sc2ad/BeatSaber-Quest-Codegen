...
UnityEngine::Transform* UnityEngine::Transform::FindRelativeTransformWithPath(UnityEngine::Transform* transform, ::CsString* path, bool isActiveOnly) {
...
UnityEngine::Transform* UnityEngine::Transform::Find(::CsString* n) {
...
UnityEngine::Transform* UnityEngine::Transform::New_ctor() {
  return (Transform*)THROW_UNLESS(il2cpp_utils::New("UnityEngine", "Transform"));
}
