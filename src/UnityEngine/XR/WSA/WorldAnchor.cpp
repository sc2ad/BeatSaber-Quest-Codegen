...
void UnityEngine::XR::WSA::WorldAnchor::Internal_TriggerEventOnTrackingLost(UnityEngine::XR::WSA::WorldAnchor* worldAnchor, bool located) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.XR.WSA", "WorldAnchor", il2cpp_utils::NoArgClass<void>(), "Internal_TriggerEventOnTrackingLost", {}, ::il2cpp_utils::ExtractTypes(worldAnchor, located)));
