...
void UnityEngine::XR::XRDisplaySubsystem::InvokeDisplayFocusChanged(bool focus) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.XR", "XRDisplaySubsystem", il2cpp_utils::NoArgClass<void>(), "InvokeDisplayFocusChanged", {}, ::il2cpp_utils::ExtractTypes(focus)));
...
UnityEngine::XR::XRDisplaySubsystem* UnityEngine::XR::XRDisplaySubsystem::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<XRDisplaySubsystem*>());
}
