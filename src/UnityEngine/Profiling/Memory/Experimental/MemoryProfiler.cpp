...
::Array<uint8_t>* UnityEngine::Profiling::Memory::Experimental::MemoryProfiler::PrepareMetadata() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Profiling.Memory.Experimental", "MemoryProfiler", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "PrepareMetadata", {}, ::il2cpp_utils::ExtractTypes()));
...
int UnityEngine::Profiling::Memory::Experimental::MemoryProfiler::WriteIntToByteArray(::Array<uint8_t>* array, int offset, int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Profiling.Memory.Experimental", "MemoryProfiler", il2cpp_utils::NoArgClass<int>(), "WriteIntToByteArray", {}, ::il2cpp_utils::ExtractTypes(array, offset, value)));
...
int UnityEngine::Profiling::Memory::Experimental::MemoryProfiler::WriteStringToByteArray(::Array<uint8_t>* array, int offset, ::Il2CppString* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Profiling.Memory.Experimental", "MemoryProfiler", il2cpp_utils::NoArgClass<int>(), "WriteStringToByteArray", {}, ::il2cpp_utils::ExtractTypes(array, offset, value)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, array, offset, value);
}
...
void UnityEngine::Profiling::Memory::Experimental::MemoryProfiler::FinalizeSnapshot(::Il2CppString* path, bool result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Profiling.Memory.Experimental", "MemoryProfiler", il2cpp_utils::NoArgClass<void>(), "FinalizeSnapshot", {}, ::il2cpp_utils::ExtractTypes(path, result)));
...
void UnityEngine::Profiling::Memory::Experimental::MemoryProfiler::SaveScreenshotToDisk(::Il2CppString* path, bool result, System::IntPtr pixelsPtr, int pixelsCount, UnityEngine::TextureFormat format, int width, int height) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Profiling.Memory.Experimental", "MemoryProfiler", il2cpp_utils::NoArgClass<void>(), "SaveScreenshotToDisk", {}, ::il2cpp_utils::ExtractTypes(path, result, pixelsPtr, pixelsCount, format, width, height)));
