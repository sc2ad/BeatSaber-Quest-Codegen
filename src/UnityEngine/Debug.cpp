...
void UnityEngine::Debug::Log(::CsObject* message) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Debug", "Log", message));
}
// Autogenerated method: UnityEngine.Debug.Log
void UnityEngine::Debug::Log(::CsObject* message, UnityEngine::Object* context) {
...
void UnityEngine::Debug::LogFormat(::CsString* format, ::Array<::CsObject*>* args) {
...
void UnityEngine::Debug::LogError(::CsObject* message) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Debug", "LogError", message));
}
// Autogenerated method: UnityEngine.Debug.LogError
void UnityEngine::Debug::LogError(::CsObject* message, UnityEngine::Object* context) {
...
void UnityEngine::Debug::LogErrorFormat(::CsString* format, ::Array<::CsObject*>* args) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Debug", "LogErrorFormat", format, args));
}
// Autogenerated method: UnityEngine.Debug.LogErrorFormat
void UnityEngine::Debug::LogErrorFormat(UnityEngine::Object* context, ::CsString* format, ::Array<::CsObject*>* args) {
...
void UnityEngine::Debug::LogWarning(::CsObject* message) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Debug", "LogWarning", message));
}
// Autogenerated method: UnityEngine.Debug.LogWarning
void UnityEngine::Debug::LogWarning(::CsObject* message, UnityEngine::Object* context) {
...
void UnityEngine::Debug::LogWarningFormat(::CsString* format, ::Array<::CsObject*>* args) {
  THROW_UNLESS(il2cpp_utils::RunMethod("UnityEngine", "Debug", "LogWarningFormat", format, args));
}
// Autogenerated method: UnityEngine.Debug.LogWarningFormat
void UnityEngine::Debug::LogWarningFormat(UnityEngine::Object* context, ::CsString* format, ::Array<::CsObject*>* args) {
...
void UnityEngine::Debug::LogAssertion(::CsObject* message) {
