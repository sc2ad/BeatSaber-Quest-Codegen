...
UnityEngine::Rendering::ScriptableRenderContext* UnityEngine::Rendering::ScriptableRenderContext::New_ctor(System::IntPtr ptr) {
  return (ScriptableRenderContext*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Rendering", "ScriptableRenderContext", ptr));
}
...
// Autogenerated method: UnityEngine.Rendering.ScriptableRenderContext.Equals
bool UnityEngine::Rendering::ScriptableRenderContext::Equals(::CsObject* obj) {
