...
UnityEngine::AnimationState* UnityEngine::Animation::get_Item(::CsString* name) {
...
void UnityEngine::Animation::CrossFade(::CsString* animation, float fadeLength, UnityEngine::PlayMode mode) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "CrossFade", animation, fadeLength, mode));
}
// Autogenerated method: UnityEngine.Animation.CrossFade
void UnityEngine::Animation::CrossFade(::CsString* animation, float fadeLength) {
...
UnityEngine::AnimationState* UnityEngine::Animation::GetState(::CsString* name) {
