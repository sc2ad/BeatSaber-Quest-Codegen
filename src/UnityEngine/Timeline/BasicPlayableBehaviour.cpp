...
UnityEngine::Timeline::BasicPlayableBehaviour* UnityEngine::Timeline::BasicPlayableBehaviour::New_ctor() {
  return (BasicPlayableBehaviour*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "BasicPlayableBehaviour"));
}
...
void UnityEngine::Timeline::BasicPlayableBehaviour::ProcessFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info, ::CsObject* playerData) {
