...
UnityEngine::Timeline::AnimationPlayableAsset::$get_outputs$d__45* UnityEngine::Timeline::AnimationPlayableAsset::$get_outputs$d__45::New_ctor(int $$1__state) {
  return (AnimationPlayableAsset::$get_outputs$d__45*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "AnimationPlayableAsset/<get_outputs>d__45", $$1__state));
}
...
::CsObject* UnityEngine::Timeline::AnimationPlayableAsset::$get_outputs$d__45::System_Collections_IEnumerator_get_Current() {
