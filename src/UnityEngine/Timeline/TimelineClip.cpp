...
::CsString* UnityEngine::Timeline::TimelineClip::_get_kDefaultCurvesName() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("UnityEngine.Timeline", "TimelineClip", "kDefaultCurvesName"));
}
// Autogenerated static field setter
// Set static field: static readonly System.String kDefaultCurvesName
void UnityEngine::Timeline::TimelineClip::_set_kDefaultCurvesName(::CsString* value) {
...
::CsString* UnityEngine::Timeline::TimelineClip::get_displayName() {
...
void UnityEngine::Timeline::TimelineClip::set_displayName(::CsString* value) {
...
System::Collections::Generic::List_1<::CsString*>* UnityEngine::Timeline::TimelineClip::get_exposedParameters() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>(this, "get_exposedParameters"));
}
...
::CsString* UnityEngine::Timeline::TimelineClip::UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName() {
...
void UnityEngine::Timeline::TimelineClip::CreateCurves(::CsString* curvesClipName) {
...
::CsString* UnityEngine::Timeline::TimelineClip::ToString() {
