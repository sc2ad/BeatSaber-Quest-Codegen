...
void UnityEngine::Timeline::TimelineClip::ConformEaseValues() {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "ConformEaseValues"));
}
...
double UnityEngine::Timeline::TimelineClip::CalculateEasingRatio(double easeIn, double easeOut) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<double>("UnityEngine.Timeline", "TimelineClip", "CalculateEasingRatio", easeIn, easeOut));
}
