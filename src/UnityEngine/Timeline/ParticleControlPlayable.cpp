...
UnityEngine::Playables::ScriptPlayable_1<UnityEngine::Timeline::ParticleControlPlayable*> UnityEngine::Timeline::ParticleControlPlayable::Create(UnityEngine::Playables::PlayableGraph graph, UnityEngine::ParticleSystem* component, uint randomSeed) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "ParticleControlPlayable", il2cpp_utils::NoArgClass<UnityEngine::Playables::ScriptPlayable_1<UnityEngine::Timeline::ParticleControlPlayable*>>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, component, randomSeed)));
...
UnityEngine::ParticleSystem* UnityEngine::Timeline::ParticleControlPlayable::get_particleSystem() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::ParticleSystem*>(), "get_particleSystem", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::Timeline::ParticleControlPlayable::set_particleSystem(UnityEngine::ParticleSystem* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_particleSystem", {}, ::il2cpp_utils::ExtractTypes(value)));
...
void UnityEngine::Timeline::ParticleControlPlayable::Initialize(UnityEngine::ParticleSystem* ps, uint randomSeed) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Initialize", {}, ::il2cpp_utils::ExtractTypes(ps, randomSeed)));
...
void UnityEngine::Timeline::ParticleControlPlayable::SetRandomSeed() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetRandomSeed", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::Timeline::ParticleControlPlayable::PrepareFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "PrepareFrame", {}, ::il2cpp_utils::ExtractTypes(playable, data)));
...
UnityEngine::Timeline::ParticleControlPlayable* UnityEngine::Timeline::ParticleControlPlayable::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ParticleControlPlayable*>());
}
