...
::CsString* UnityEngine::Timeline::TrackAsset::_get_kDefaultCurvesName() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("UnityEngine.Timeline", "TrackAsset", "kDefaultCurvesName"));
}
// Autogenerated static field setter
// Set static field: static System.String kDefaultCurvesName
void UnityEngine::Timeline::TrackAsset::_set_kDefaultCurvesName(::CsString* value) {
...
::CsString* UnityEngine::Timeline::TrackAsset::get_customPlayableTypename() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_customPlayableTypename"));
}
// Autogenerated method: UnityEngine.Timeline.TrackAsset.set_customPlayableTypename
void UnityEngine::Timeline::TrackAsset::set_customPlayableTypename(::CsString* value) {
...
::CsString* UnityEngine::Timeline::TrackAsset::UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "UnityEngine.Timeline.ICurvesOwner.get_defaultCurvesName"));
}
...
void UnityEngine::Timeline::TrackAsset::CreateCurves(::CsString* curvesClipName) {
...
UnityEngine::Timeline::TrackAsset* UnityEngine::Timeline::TrackAsset::New_ctor() {
  return (TrackAsset*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "TrackAsset"));
}
