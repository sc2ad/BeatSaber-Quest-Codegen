...
UnityEngine::Timeline::InfiniteRuntimeClip* UnityEngine::Timeline::InfiniteRuntimeClip::New_ctor(UnityEngine::Playables::Playable playable) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Timeline").WithContext("InfiniteRuntimeClip").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<InfiniteRuntimeClip*>(playable));
}
...
void UnityEngine::Timeline::InfiniteRuntimeClip::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "InfiniteRuntimeClip", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
