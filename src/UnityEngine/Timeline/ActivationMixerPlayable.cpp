...
void UnityEngine::Timeline::ActivationMixerPlayable::ProcessFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info, ::CsObject* playerData) {
...
UnityEngine::Timeline::ActivationMixerPlayable* UnityEngine::Timeline::ActivationMixerPlayable::New_ctor() {
  return (ActivationMixerPlayable*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "ActivationMixerPlayable"));
}
