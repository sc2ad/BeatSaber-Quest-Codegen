...
void UnityEngine::Timeline::TimeNotificationBehaviour::set_timeSource(UnityEngine::Playables::Playable value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_timeSource", {}, ::il2cpp_utils::ExtractTypes(value)));
...
UnityEngine::Playables::ScriptPlayable_1<UnityEngine::Timeline::TimeNotificationBehaviour*> UnityEngine::Timeline::TimeNotificationBehaviour::Create(UnityEngine::Playables::PlayableGraph graph, double duration, UnityEngine::Playables::DirectorWrapMode loopMode) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeNotificationBehaviour", il2cpp_utils::NoArgClass<UnityEngine::Playables::ScriptPlayable_1<UnityEngine::Timeline::TimeNotificationBehaviour*>>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, duration, loopMode)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::AddNotification(double time, UnityEngine::Playables::INotification* payload, UnityEngine::Timeline::NotificationFlags flags) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "AddNotification", {}, ::il2cpp_utils::ExtractTypes(time, payload, flags)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::SortNotifications() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SortNotifications", {}, ::il2cpp_utils::ExtractTypes()));
...
bool UnityEngine::Timeline::TimeNotificationBehaviour::CanRestoreNotification(UnityEngine::Timeline::TimeNotificationBehaviour::NotificationEntry e, UnityEngine::Playables::FrameData info, double currentTime, double previousTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeNotificationBehaviour", il2cpp_utils::NoArgClass<bool>(), "CanRestoreNotification", {}, ::il2cpp_utils::ExtractTypes(e, info, currentTime, previousTime)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::TriggerNotificationsInRange(double start, double end, UnityEngine::Playables::FrameData info, UnityEngine::Playables::Playable playable, bool checkState) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "TriggerNotificationsInRange", {}, ::il2cpp_utils::ExtractTypes(start, end, info, playable, checkState)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::SyncDurationWithExternalSource(UnityEngine::Playables::Playable playable) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SyncDurationWithExternalSource", {}, ::il2cpp_utils::ExtractTypes(playable)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::Trigger_internal(UnityEngine::Playables::Playable playable, UnityEngine::Playables::PlayableOutput output, UnityEngine::Timeline::TimeNotificationBehaviour::NotificationEntry& e) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeNotificationBehaviour", il2cpp_utils::NoArgClass<void>(), "Trigger_internal", {}, ::il2cpp_utils::ExtractTypes(playable, output, e)));
...
void UnityEngine::Timeline::TimeNotificationBehaviour::Restore_internal(UnityEngine::Timeline::TimeNotificationBehaviour::NotificationEntry& e) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeNotificationBehaviour", il2cpp_utils::NoArgClass<void>(), "Restore_internal", {}, ::il2cpp_utils::ExtractTypes(e)));
...
UnityEngine::Timeline::TimeNotificationBehaviour* UnityEngine::Timeline::TimeNotificationBehaviour::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<TimeNotificationBehaviour*>());
}
