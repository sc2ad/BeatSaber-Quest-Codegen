...
void UnityEngine::Timeline::ICurvesOwner::CreateCurves(::CsString* curvesClipName) {
...
::CsString* UnityEngine::Timeline::ICurvesOwner::UnityEngine_Timeline_ICurvesOwner_get_defaultCurvesName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_defaultCurvesName"));
}
