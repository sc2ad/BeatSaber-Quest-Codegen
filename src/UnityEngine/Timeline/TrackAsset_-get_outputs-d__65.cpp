...
UnityEngine::Timeline::TrackAsset::$get_outputs$d__65* UnityEngine::Timeline::TrackAsset::$get_outputs$d__65::New_ctor(int $$1__state) {
  return (TrackAsset::$get_outputs$d__65*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "TrackAsset/<get_outputs>d__65", $$1__state));
}
...
::CsObject* UnityEngine::Timeline::TrackAsset::$get_outputs$d__65::System_Collections_IEnumerator_get_Current() {
