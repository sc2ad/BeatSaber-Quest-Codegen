...
float UnityEngine::Timeline::TimelineAsset::EditorSettings::get_fps() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "get_fps", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::Timeline::TimelineAsset::EditorSettings::set_fps(float value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_fps", {}, ::il2cpp_utils::ExtractTypes(value)));
...
bool UnityEngine::Timeline::TimelineAsset::EditorSettings::get_scenePreview() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_scenePreview", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::Timeline::TimelineAsset::EditorSettings::set_scenePreview(bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_scenePreview", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
void UnityEngine::Timeline::TimelineAsset::EditorSettings::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimelineAsset/EditorSettings", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
UnityEngine::Timeline::TimelineAsset::EditorSettings* UnityEngine::Timeline::TimelineAsset::EditorSettings::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Timeline").WithContext("EditorSettings").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TimelineAsset::EditorSettings*>());
}
