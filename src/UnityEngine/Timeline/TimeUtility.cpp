...
void UnityEngine::Timeline::TimeUtility::ValidateFrameRate(double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<void>(), "ValidateFrameRate", {}, ::il2cpp_utils::ExtractTypes(frameRate)));
...
int UnityEngine::Timeline::TimeUtility::ToFrames(double time, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<int>(), "ToFrames", {}, ::il2cpp_utils::ExtractTypes(time, frameRate)));
...
double UnityEngine::Timeline::TimeUtility::ToExactFrames(double time, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "ToExactFrames", {}, ::il2cpp_utils::ExtractTypes(time, frameRate)));
...
double UnityEngine::Timeline::TimeUtility::FromFrames(int frames, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "FromFrames", {}, ::il2cpp_utils::ExtractTypes(frames, frameRate)));
...
bool UnityEngine::Timeline::TimeUtility::OnFrameBoundary(double time, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<bool>(), "OnFrameBoundary", {}, ::il2cpp_utils::ExtractTypes(time, frameRate)));
...
double UnityEngine::Timeline::TimeUtility::GetEpsilon(double time, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "GetEpsilon", {}, ::il2cpp_utils::ExtractTypes(time, frameRate)));
  return ::il2cpp_utils::RunMethodThrow<double, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, time, frameRate);
}
// Autogenerated method: UnityEngine.Timeline.TimeUtility.OnFrameBoundary
bool UnityEngine::Timeline::TimeUtility::OnFrameBoundary(double time, double frameRate, double epsilon) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Timeline").WithContext("TimeUtility").WithContext("OnFrameBoundary");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<bool>(), "OnFrameBoundary", {}, ::il2cpp_utils::ExtractTypes(time, frameRate, epsilon)));
...
double UnityEngine::Timeline::TimeUtility::RoundToFrame(double time, double frameRate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "RoundToFrame", {}, ::il2cpp_utils::ExtractTypes(time, frameRate)));
  return ::il2cpp_utils::RunMethodThrow<double, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, time, frameRate);
}
...
::Il2CppString* UnityEngine::Timeline::TimeUtility::TimeAsFrames(double timeValue, double frameRate, ::Il2CppString* format) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<::Il2CppString*>(), "TimeAsFrames", {}, ::il2cpp_utils::ExtractTypes(timeValue, frameRate, format)));
...
::Il2CppString* UnityEngine::Timeline::TimeUtility::TimeAsTimeCode(double timeValue, double frameRate, ::Il2CppString* format) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<::Il2CppString*>(), "TimeAsTimeCode", {}, ::il2cpp_utils::ExtractTypes(timeValue, frameRate, format)));
  return ::il2cpp_utils::RunMethodThrow<::Il2CppString*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, timeValue, frameRate, format);
}
...
double UnityEngine::Timeline::TimeUtility::ParseTimeCode(::Il2CppString* timeCode, double frameRate, double defaultValue) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "ParseTimeCode", {}, ::il2cpp_utils::ExtractTypes(timeCode, frameRate, defaultValue)));
...
double UnityEngine::Timeline::TimeUtility::GetAnimationClipLength(UnityEngine::AnimationClip* clip) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<double>(), "GetAnimationClipLength", {}, ::il2cpp_utils::ExtractTypes(clip)));
...
::Il2CppString* UnityEngine::Timeline::TimeUtility::RemoveChar(::Il2CppString* str, System::Func_2<::Il2CppChar, bool>* charToRemoveFunc) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<::Il2CppString*>(), "RemoveChar", {}, ::il2cpp_utils::ExtractTypes(str, charToRemoveFunc)));
...
void UnityEngine::Timeline::TimeUtility::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TimeUtility", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
