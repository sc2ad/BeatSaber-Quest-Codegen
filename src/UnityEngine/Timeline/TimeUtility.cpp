...
::CsString* UnityEngine::Timeline::TimeUtility::TimeAsFrames(double timeValue, double frameRate, ::CsString* format) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Timeline", "TimeUtility", "TimeAsFrames", timeValue, frameRate, format));
}
// Autogenerated method: UnityEngine.Timeline.TimeUtility.TimeAsTimeCode
::CsString* UnityEngine::Timeline::TimeUtility::TimeAsTimeCode(double timeValue, double frameRate, ::CsString* format) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Timeline", "TimeUtility", "TimeAsTimeCode", timeValue, frameRate, format));
}
// Autogenerated method: UnityEngine.Timeline.TimeUtility.ParseTimeCode
double UnityEngine::Timeline::TimeUtility::ParseTimeCode(::CsString* timeCode, double frameRate, double defaultValue) {
...
::CsString* UnityEngine::Timeline::TimeUtility::RemoveChar(::CsString* str, System::Func_2<::Il2CppChar, bool>* charToRemoveFunc) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Timeline", "TimeUtility", "RemoveChar", str, charToRemoveFunc));
}
