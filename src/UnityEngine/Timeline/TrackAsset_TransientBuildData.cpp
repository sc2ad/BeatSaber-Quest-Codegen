...
UnityEngine::Timeline::TrackAsset::TransientBuildData UnityEngine::Timeline::TrackAsset::TransientBuildData::Create() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TrackAsset/TransientBuildData", il2cpp_utils::NoArgClass<UnityEngine::Timeline::TrackAsset::TransientBuildData>(), "Create", {}, ::il2cpp_utils::ExtractTypes()));
