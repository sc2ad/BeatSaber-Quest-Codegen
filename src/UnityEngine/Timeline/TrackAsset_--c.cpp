...
int UnityEngine::Timeline::TrackAsset::$$c::$SortClips$b__120_0(UnityEngine::Timeline::TimelineClip* clip1, UnityEngine::Timeline::TimelineClip* clip2) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<int>(this, "<SortClips>b__120_0", clip1, clip2)));
}
...
UnityEngine::Timeline::TrackAsset::$$c* UnityEngine::Timeline::TrackAsset::$$c::New_ctor() {
  return (TrackAsset::$$c*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "TrackAsset/<>c"));
}
