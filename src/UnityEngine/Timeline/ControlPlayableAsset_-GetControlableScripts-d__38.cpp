...
UnityEngine::Timeline::ControlPlayableAsset::$GetControlableScripts$d__38* UnityEngine::Timeline::ControlPlayableAsset::$GetControlableScripts$d__38::New_ctor(int $$1__state) {
  return (ControlPlayableAsset::$GetControlableScripts$d__38*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.Timeline", "ControlPlayableAsset/<GetControlableScripts>d__38", $$1__state));
}
...
::CsObject* UnityEngine::Timeline::ControlPlayableAsset::$GetControlableScripts$d__38::System_Collections_IEnumerator_get_Current() {
