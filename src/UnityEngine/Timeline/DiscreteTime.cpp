...
int UnityEngine::Timeline::DiscreteTime::CompareTo(::CsObject* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(*this, "CompareTo", obj));
}
int UnityEngine::Timeline::DiscreteTime::System_IComparable_CompareTo(::CsObject* obj) {
  return CompareTo(obj);
}
// Autogenerated method: UnityEngine.Timeline.DiscreteTime.Equals
bool UnityEngine::Timeline::DiscreteTime::Equals(::CsObject* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(*this, "Equals", obj));
}
// Autogenerated method: UnityEngine.Timeline.DiscreteTime.ToString
::CsString* UnityEngine::Timeline::DiscreteTime::ToString() {
