...
UnityEngine::Timeline::GroupTrack* UnityEngine::Timeline::TrackAssetExtensions::GetGroup(UnityEngine::Timeline::TrackAsset* asset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TrackAssetExtensions", il2cpp_utils::NoArgClass<UnityEngine::Timeline::GroupTrack*>(), "GetGroup", {}, ::il2cpp_utils::ExtractTypes(asset)));
...
void UnityEngine::Timeline::TrackAssetExtensions::SetGroup(UnityEngine::Timeline::TrackAsset* asset, UnityEngine::Timeline::GroupTrack* group) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "TrackAssetExtensions", il2cpp_utils::NoArgClass<void>(), "SetGroup", {}, ::il2cpp_utils::ExtractTypes(asset, group)));
