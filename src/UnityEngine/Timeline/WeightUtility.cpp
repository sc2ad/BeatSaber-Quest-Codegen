...
float UnityEngine::Timeline::WeightUtility::NormalizeMixer(UnityEngine::Playables::Playable mixer) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.Timeline", "WeightUtility", il2cpp_utils::NoArgClass<float>(), "NormalizeMixer", {}, ::il2cpp_utils::ExtractTypes(mixer)));
