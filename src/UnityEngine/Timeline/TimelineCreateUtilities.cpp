...
::CsString* UnityEngine::Timeline::TimelineCreateUtilities::GenerateUniqueActorName(System::Collections::Generic::List_1<UnityEngine::ScriptableObject*>* tracks, ::CsString* name) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Timeline", "TimelineCreateUtilities", "GenerateUniqueActorName", tracks, name));
}
...
UnityEngine::AnimationClip* UnityEngine::Timeline::TimelineCreateUtilities::CreateAnimationClipForTrack(::CsString* name, UnityEngine::Timeline::TrackAsset* track, bool isLegacy) {
