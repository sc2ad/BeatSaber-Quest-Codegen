...
::CsString* UnityEngine::AudioClip::GetName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetName"));
}
// Autogenerated method: UnityEngine.AudioClip.CreateUserSound
void UnityEngine::AudioClip::CreateUserSound(::CsString* name, int lengthSamples, int channels, int frequency, bool stream) {
...
UnityEngine::AudioClip* UnityEngine::AudioClip::Create(::CsString* name, int lengthSamples, int channels, int frequency, bool stream) {
...
// Autogenerated method: UnityEngine.AudioClip.Create
UnityEngine::AudioClip* UnityEngine::AudioClip::Create(::CsString* name, int lengthSamples, int channels, int frequency, bool stream, UnityEngine::AudioClip::PCMReaderCallback* pcmreadercallback, UnityEngine::AudioClip::PCMSetPositionCallback* pcmsetpositioncallback) {
