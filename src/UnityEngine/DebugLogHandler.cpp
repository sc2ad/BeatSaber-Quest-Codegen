...
void UnityEngine::DebugLogHandler::Internal_Log(UnityEngine::LogType level, UnityEngine::LogOption options, ::Il2CppString* msg, UnityEngine::Object* obj) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "DebugLogHandler", "Internal_Log", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(level, options, msg, obj)));
...
void UnityEngine::DebugLogHandler::Internal_LogException(System::Exception* exception, UnityEngine::Object* obj) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine", "DebugLogHandler", "Internal_LogException", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(exception, obj)));
