...
void UnityEngine::UI::GraphicRaycaster::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.UI", "GraphicRaycaster/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int UnityEngine::UI::GraphicRaycaster::$$c::$Raycast$b__24_0(UnityEngine::UI::Graphic* g1, UnityEngine::UI::Graphic* g2) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<Raycast>b__24_0", {}, ::il2cpp_utils::ExtractTypes(g1, g2))));
