...
UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74* UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Dropdown::$DelayedDestroyDropdownList$d__74*>($$1__state));
}
...
void UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$DelayedDestroyDropdownList$d__74").WithContext("System.IDisposable.Dispose");
...
bool UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$DelayedDestroyDropdownList$d__74").WithContext("MoveNext");
...
::Il2CppObject* UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$DelayedDestroyDropdownList$d__74").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$DelayedDestroyDropdownList$d__74").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$DelayedDestroyDropdownList$d__74").WithContext("System.Collections.IEnumerator.get_Current");
