...
bool UnityEngine::UI::MultipleDisplayUtilities::GetRelativeMousePositionForDrag(UnityEngine::EventSystems::PointerEventData* eventData, UnityEngine::Vector2& position) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "MultipleDisplayUtilities", il2cpp_utils::NoArgClass<bool>(), "GetRelativeMousePositionForDrag", {}, ::il2cpp_utils::ExtractTypes(eventData, position)));
...
UnityEngine::Vector2 UnityEngine::UI::MultipleDisplayUtilities::GetMousePositionRelativeToMainDisplayResolution() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "MultipleDisplayUtilities", il2cpp_utils::NoArgClass<UnityEngine::Vector2>(), "GetMousePositionRelativeToMainDisplayResolution", {}, ::il2cpp_utils::ExtractTypes()));
