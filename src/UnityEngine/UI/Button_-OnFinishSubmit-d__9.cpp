...
// Completed includes
// Autogenerated method: UnityEngine.UI.Button/<OnFinishSubmit>d__9..ctor
UnityEngine::UI::Button::$OnFinishSubmit$d__9* UnityEngine::UI::Button::$OnFinishSubmit$d__9::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Button::$OnFinishSubmit$d__9*>($$1__state));
}
