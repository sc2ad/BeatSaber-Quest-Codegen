...
UnityEngine::UI::Button::$OnFinishSubmit$d__9* UnityEngine::UI::Button::$OnFinishSubmit$d__9::New_ctor(int $$1__state) {
  return (Button::$OnFinishSubmit$d__9*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.UI", "Button/<OnFinishSubmit>d__9", $$1__state));
}
...
::CsObject* UnityEngine::UI::Button::$OnFinishSubmit$d__9::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::UI::Button::$OnFinishSubmit$d__9::System_Collections_IEnumerator_get_Current() {
