...
UnityEngine::UI::ReflectionMethodsCache* UnityEngine::UI::ReflectionMethodsCache::get_Singleton() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "ReflectionMethodsCache", il2cpp_utils::NoArgClass<UnityEngine::UI::ReflectionMethodsCache*>(), "get_Singleton", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::UI::ReflectionMethodsCache::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "ReflectionMethodsCache", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
UnityEngine::UI::ReflectionMethodsCache* UnityEngine::UI::ReflectionMethodsCache::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("ReflectionMethodsCache").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ReflectionMethodsCache*>());
}
