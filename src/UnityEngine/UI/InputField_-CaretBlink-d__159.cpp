...
// Completed includes
// Autogenerated method: UnityEngine.UI.InputField/<CaretBlink>d__159..ctor
UnityEngine::UI::InputField::$CaretBlink$d__159* UnityEngine::UI::InputField::$CaretBlink$d__159::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<InputField::$CaretBlink$d__159*>($$1__state));
}
...
void UnityEngine::UI::InputField::$CaretBlink$d__159::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext("System.IDisposable.Dispose");
...
bool UnityEngine::UI::InputField::$CaretBlink$d__159::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext("MoveNext");
...
::Il2CppObject* UnityEngine::UI::InputField::$CaretBlink$d__159::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void UnityEngine::UI::InputField::$CaretBlink$d__159::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* UnityEngine::UI::InputField::$CaretBlink$d__159::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("$CaretBlink$d__159").WithContext("System.Collections.IEnumerator.get_Current");
