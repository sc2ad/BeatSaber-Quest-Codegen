...
UnityEngine::UI::InputField::$CaretBlink$d__159* UnityEngine::UI::InputField::$CaretBlink$d__159::New_ctor(int $$1__state) {
  return (InputField::$CaretBlink$d__159*)THROW_UNLESS(il2cpp_utils::New("UnityEngine.UI", "InputField/<CaretBlink>d__159", $$1__state));
}
...
::CsObject* UnityEngine::UI::InputField::$CaretBlink$d__159::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* UnityEngine::UI::InputField::$CaretBlink$d__159::System_Collections_IEnumerator_get_Current() {
