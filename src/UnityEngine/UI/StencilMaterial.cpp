...
UnityEngine::Material* UnityEngine::UI::StencilMaterial::Add(UnityEngine::Material* baseMat, int stencilID) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<UnityEngine::Material*>(), "Add", {}, ::il2cpp_utils::ExtractTypes(baseMat, stencilID)));
...
UnityEngine::Material* UnityEngine::UI::StencilMaterial::Add(UnityEngine::Material* baseMat, int stencilID, UnityEngine::Rendering::StencilOp operation, UnityEngine::Rendering::CompareFunction compareFunction, UnityEngine::Rendering::ColorWriteMask colorWriteMask) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("StencilMaterial").WithContext("Add");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<UnityEngine::Material*>(), "Add", {}, ::il2cpp_utils::ExtractTypes(baseMat, stencilID, operation, compareFunction, colorWriteMask)));
...
UnityEngine::Material* UnityEngine::UI::StencilMaterial::Add(UnityEngine::Material* baseMat, int stencilID, UnityEngine::Rendering::StencilOp operation, UnityEngine::Rendering::CompareFunction compareFunction, UnityEngine::Rendering::ColorWriteMask colorWriteMask, int readMask, int writeMask) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("StencilMaterial").WithContext("Add");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<UnityEngine::Material*>(), "Add", {}, ::il2cpp_utils::ExtractTypes(baseMat, stencilID, operation, compareFunction, colorWriteMask, readMask, writeMask)));
...
void UnityEngine::UI::StencilMaterial::Remove(UnityEngine::Material* customMat) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<void>(), "Remove", {}, ::il2cpp_utils::ExtractTypes(customMat)));
...
void UnityEngine::UI::StencilMaterial::ClearAll() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<void>(), "ClearAll", {}, ::il2cpp_utils::ExtractTypes()));
...
void UnityEngine::UI::StencilMaterial::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.UI", "StencilMaterial", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
