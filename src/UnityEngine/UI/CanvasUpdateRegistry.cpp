...
::CsString* UnityEngine::UI::CanvasUpdateRegistry::_get_m_CullingUpdateProfilerString() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("UnityEngine.UI", "CanvasUpdateRegistry", "m_CullingUpdateProfilerString"));
}
// Autogenerated static field setter
// Set static field: static private System.String m_CullingUpdateProfilerString
void UnityEngine::UI::CanvasUpdateRegistry::_set_m_CullingUpdateProfilerString(::CsString* value) {
