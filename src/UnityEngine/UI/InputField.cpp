...
::Il2CppString* UnityEngine::UI::InputField::get_clipboard() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine.UI", "InputField", "get_clipboard"));
}
...
::Il2CppString* UnityEngine::UI::InputField::GetSelectedString() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "GetSelectedString"));
}
