...
UnityEngine::GameObject* UnityEngine::UI::DefaultControls::CreateUIElementRoot(::CsString* name, UnityEngine::Vector2 size, ::Array<System::Type*>* components) {
...
UnityEngine::GameObject* UnityEngine::UI::DefaultControls::CreateUIObject(::CsString* name, UnityEngine::GameObject* parent, ::Array<System::Type*>* components) {
