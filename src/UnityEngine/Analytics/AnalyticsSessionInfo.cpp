...
::CsString* UnityEngine::Analytics::AnalyticsSessionInfo::get_userId() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("UnityEngine.Analytics", "AnalyticsSessionInfo", "get_userId"));
}
// Autogenerated method: UnityEngine.Analytics.AnalyticsSessionInfo.CallIdentityTokenChanged
void UnityEngine::Analytics::AnalyticsSessionInfo::CallIdentityTokenChanged(::CsString* token) {
