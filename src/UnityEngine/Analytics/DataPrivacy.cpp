...
::Il2CppString* UnityEngine::Analytics::DataPrivacy::GetUserAgent() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine.Analytics", "DataPrivacy", "GetUserAgent"));
}
// Autogenerated method: UnityEngine.Analytics.DataPrivacy.getErrorString
::Il2CppString* UnityEngine::Analytics::DataPrivacy::getErrorString(UnityEngine::Networking::UnityWebRequest* www) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("UnityEngine.Analytics", "DataPrivacy", "getErrorString", www));
}
// Autogenerated method: UnityEngine.Analytics.DataPrivacy.FetchPrivacyUrl
void UnityEngine::Analytics::DataPrivacy::FetchPrivacyUrl(System::Action_1<::Il2CppString*>* success, System::Action_1<::Il2CppString*>* failure) {
