...
::ArrayW<UnityEngine::Renderer*> GlobalNamespace::MaterialPropertyBlockController::get_renderers() {
  ...
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<UnityEngine::Renderer*>, false>(___instance_arg, ___internal__method);
}
...
::ArrayW<float> HMUI::ContainerViewController::GetNewXPositionsForViewControllers(System::Collections::Generic::List_1<HMUI::ViewController*>* viewControllers, int exludeFromEndCount) {
  ...
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<float>, false>(___instance_arg, ___internal__method, viewControllers, exludeFromEndCount);
}
...
::ArrayW<float> HMUI::NavigationController::GetNewPositionsForViewControllers(System::Collections::Generic::List_1<HMUI::ViewController*>* viewControllers, System::Collections::Generic::HashSet_1<HMUI::ViewController*>* fixedViewControllers, float fixedEndPos) {
  ...
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<float>, false>(___instance_arg, ___internal__method, viewControllers, fixedViewControllers, fixedEndPos);
}
