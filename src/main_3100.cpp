...
::GlobalNamespace::IndexFilter* GlobalNamespace::BeatmapEventDataBoxGroupFactory::$CreateSingleLightBeatmapEventDataBoxGroup$g__CreateIndexFilter_2_0(::GlobalNamespace::DefaultEnvironmentEvents::LightGroupFiltering* filtering, ByRef<::GlobalNamespace::BeatmapEventDataBoxGroupFactory::$$c__DisplayClass2_0> param_00011cea) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "BeatmapEventDataBoxGroupFactory", "<CreateSingleLightBeatmapEventDataBoxGroup>g__CreateIndexFilter|2_0", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(filtering), ::il2cpp_utils::ExtractType(param_00011cea)})));
  return ::il2cpp_utils::RunMethodRethrow<::GlobalNamespace::IndexFilter*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, filtering, byref(param_00011cea));
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
