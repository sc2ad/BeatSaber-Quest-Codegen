...
Zenject::SubContainerBinder* Zenject::SubContainerBinder::New_ctor(Zenject::BindInfo* bindInfo, Zenject::BindStatement* bindStatement, ::CsObject* subIdentifier, bool resolveAll) {
...
Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* Zenject::SubContainerBinder::ByNewPrefabResourceMethod(::CsString* resourcePath, System::Action_1<Zenject::DiContainer*>* installerMethod) {
...
Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* Zenject::SubContainerBinder::ByNewPrefabResourceInstaller(::CsString* resourcePath, System::Type* installerType) {
...
Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* Zenject::SubContainerBinder::ByNewPrefabResource(::CsString* resourcePath) {
...
Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* Zenject::SubContainerBinder::ByNewContextPrefabResource(::CsString* resourcePath) {
