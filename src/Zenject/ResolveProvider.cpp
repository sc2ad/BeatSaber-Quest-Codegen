...
Zenject::ResolveProvider* Zenject::ResolveProvider::New_ctor(System::Type* contractType, Zenject::DiContainer* container, ::CsObject* identifier, bool isOptional, Zenject::InjectSources source, bool matchAll) {
...
void Zenject::ResolveProvider::GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::CsObject*>* buffer) {
