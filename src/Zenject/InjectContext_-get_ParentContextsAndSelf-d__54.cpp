...
Zenject::InjectContext::$get_ParentContextsAndSelf$d__54* Zenject::InjectContext::$get_ParentContextsAndSelf$d__54::New_ctor(int $$1__state) {
  return (InjectContext::$get_ParentContextsAndSelf$d__54*)THROW_UNLESS(il2cpp_utils::New("Zenject", "InjectContext/<get_ParentContextsAndSelf>d__54", $$1__state));
}
...
::CsObject* Zenject::InjectContext::$get_ParentContextsAndSelf$d__54::System_Collections_IEnumerator_get_Current() {
