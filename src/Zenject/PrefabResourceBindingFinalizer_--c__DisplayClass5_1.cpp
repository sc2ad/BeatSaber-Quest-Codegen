...
// Autogenerated method: Zenject.PrefabResourceBindingFinalizer/<>c__DisplayClass5_1..ctor
Zenject::PrefabResourceBindingFinalizer::$$c__DisplayClass5_1* Zenject::PrefabResourceBindingFinalizer::$$c__DisplayClass5_1::New_ctor() {
  return (PrefabResourceBindingFinalizer::$$c__DisplayClass5_1*)THROW_UNLESS(il2cpp_utils::New("Zenject", "PrefabResourceBindingFinalizer/<>c__DisplayClass5_1"));
}
