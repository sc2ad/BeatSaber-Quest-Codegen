...
Zenject::AddToGameObjectComponentProviderBase* Zenject::AddToGameObjectComponentProviderBase::New_ctor(Zenject::DiContainer* container, System::Type* componentType, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, ::CsObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback) {
  return (AddToGameObjectComponentProviderBase*)THROW_UNLESS(il2cpp_utils::New("Zenject", "AddToGameObjectComponentProviderBase", container, componentType, extraArguments, concreteIdentifier, instantiateCallback));
}
...
void Zenject::AddToGameObjectComponentProviderBase::GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::CsObject*>* buffer) {
