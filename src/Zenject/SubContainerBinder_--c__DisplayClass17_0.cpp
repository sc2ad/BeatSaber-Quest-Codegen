...
Zenject::ISubContainerCreator* Zenject::SubContainerBinder::$$c__DisplayClass17_0::$ByNewPrefabInstaller$b__0(Zenject::DiContainer* container) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::ISubContainerCreator*>(), "<ByNewPrefabInstaller>b__0", {}, ::il2cpp_utils::ExtractTypes(container))));
  return ::il2cpp_utils::RunMethodThrow<Zenject::ISubContainerCreator*, false>(this, ___internal__method, container);
}
// Autogenerated method: Zenject.SubContainerBinder/<>c__DisplayClass17_0..ctor
Zenject::SubContainerBinder::$$c__DisplayClass17_0* Zenject::SubContainerBinder::$$c__DisplayClass17_0::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SubContainerBinder::$$c__DisplayClass17_0*>());
}
