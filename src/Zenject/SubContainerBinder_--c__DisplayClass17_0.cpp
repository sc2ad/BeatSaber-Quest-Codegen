...
Zenject::ISubContainerCreator* Zenject::SubContainerBinder::$$c__DisplayClass17_0::$ByNewPrefabInstaller$b__0(Zenject::DiContainer* container) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<Zenject::ISubContainerCreator*>(this, "<ByNewPrefabInstaller>b__0", container)));
}
...
Zenject::SubContainerBinder::$$c__DisplayClass17_0* Zenject::SubContainerBinder::$$c__DisplayClass17_0::New_ctor() {
  return (SubContainerBinder::$$c__DisplayClass17_0*)THROW_UNLESS(il2cpp_utils::New("Zenject", "SubContainerBinder/<>c__DisplayClass17_0"));
}
