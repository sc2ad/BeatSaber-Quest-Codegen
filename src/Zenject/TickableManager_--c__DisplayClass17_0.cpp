...
bool Zenject::TickableManager::$$c__DisplayClass17_0::$InitFixedTickables$b__1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<InitFixedTickables>b__1", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::TickableManager::$$c__DisplayClass17_0* Zenject::TickableManager::$$c__DisplayClass17_0::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<TickableManager::$$c__DisplayClass17_0*>());
}
