...
Zenject::PoolableManager* Zenject::PoolableManager::New_ctor(System::Collections::Generic::List_1<Zenject::IPoolable*>* poolables, System::Collections::Generic::List_1<ModestTree::Util::ValuePair_2<System::Type*, int>*>* priorities) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PoolableManager").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PoolableManager*>(poolables, priorities));
}
...
Zenject::PoolableManager::PoolableInfo Zenject::PoolableManager::CreatePoolableInfo(Zenject::IPoolable* poolable, System::Collections::Generic::List_1<ModestTree::Util::ValuePair_2<System::Type*, int>*>* priorities) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::PoolableManager::PoolableInfo>(), "CreatePoolableInfo", {}, ::il2cpp_utils::ExtractTypes(poolable, priorities)));
...
void Zenject::PoolableManager::TriggerOnSpawned() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "TriggerOnSpawned", {}, ::il2cpp_utils::ExtractTypes()));
...
void Zenject::PoolableManager::TriggerOnDespawned() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "TriggerOnDespawned", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
