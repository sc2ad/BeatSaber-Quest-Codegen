...
bool Zenject::DisposableManager::$$c__DisplayClass4_1::$_ctor$b__2(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<.ctor>b__2", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::DisposableManager::$$c__DisplayClass4_1* Zenject::DisposableManager::$$c__DisplayClass4_1::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<DisposableManager::$$c__DisplayClass4_1*>());
}
