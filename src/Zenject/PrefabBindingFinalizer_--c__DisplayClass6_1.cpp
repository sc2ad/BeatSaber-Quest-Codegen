...
// Autogenerated method: Zenject.PrefabBindingFinalizer/<>c__DisplayClass6_1..ctor
Zenject::PrefabBindingFinalizer::$$c__DisplayClass6_1* Zenject::PrefabBindingFinalizer::$$c__DisplayClass6_1::New_ctor() {
  return (PrefabBindingFinalizer::$$c__DisplayClass6_1*)THROW_UNLESS(il2cpp_utils::New("Zenject", "PrefabBindingFinalizer/<>c__DisplayClass6_1"));
}
