...
void Zenject::DisposeBlock::OnSpawned(Zenject::DisposeBlock* that) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject", "DisposeBlock", il2cpp_utils::NoArgClass<void>(), "OnSpawned", {}, ::il2cpp_utils::ExtractTypes(that)));
...
void Zenject::DisposeBlock::OnDespawned(Zenject::DisposeBlock* that) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject", "DisposeBlock", il2cpp_utils::NoArgClass<void>(), "OnDespawned", {}, ::il2cpp_utils::ExtractTypes(that)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, that);
}
...
void Zenject::DisposeBlock::LazyInitializeDisposableList() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "LazyInitializeDisposableList", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::DisposeBlock* Zenject::DisposeBlock::Spawn() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject", "DisposeBlock", il2cpp_utils::NoArgClass<Zenject::DisposeBlock*>(), "Spawn", {}, ::il2cpp_utils::ExtractTypes()));
...
void Zenject::DisposeBlock::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject", "DisposeBlock", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::DisposeBlock* Zenject::DisposeBlock::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<DisposeBlock*>());
}
