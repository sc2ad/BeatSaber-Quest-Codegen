...
bool Zenject::TickableManager::$$c__DisplayClass19_0::$InitLateTickables$b__1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<bool>(this, "<InitLateTickables>b__1", x)));
}
...
Zenject::TickableManager::$$c__DisplayClass19_0* Zenject::TickableManager::$$c__DisplayClass19_0::New_ctor() {
  return (TickableManager::$$c__DisplayClass19_0*)THROW_UNLESS(il2cpp_utils::New("Zenject", "TickableManager/<>c__DisplayClass19_0"));
}
