...
void Zenject::InjectUtil::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "InjectUtil/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
Zenject::TypeValuePair Zenject::InjectUtil::$$c::$CreateArgList$b__0_0(::Il2CppObject* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::TypeValuePair>(), "<CreateArgList>b__0_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::InjectUtil::$$c* Zenject::InjectUtil::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<InjectUtil::$$c*>());
}
