...
void Zenject::AnimatorIkHandlerManager::OnAnimatorIk() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnAnimatorIk", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::AnimatorIkHandlerManager* Zenject::AnimatorIkHandlerManager::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<AnimatorIkHandlerManager*>());
}
