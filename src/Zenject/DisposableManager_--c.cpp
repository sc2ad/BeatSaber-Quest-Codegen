...
void Zenject::DisposableManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "DisposableManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
System::Nullable_1<int> Zenject::DisposableManager::$$c::$_ctor$b__4_1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Nullable_1<int>>(), "<.ctor>b__4_1", {}, ::il2cpp_utils::ExtractTypes(x))));
...
System::Nullable_1<int> Zenject::DisposableManager::$$c::$_ctor$b__4_3(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Nullable_1<int>>(), "<.ctor>b__4_3", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<System::Nullable_1<int>, false>(this, ___internal__method, x);
}
...
int Zenject::DisposableManager::$$c::$LateDispose$b__10_0(Zenject::DisposableManager::LateDisposableInfo* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<LateDispose>b__10_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
int Zenject::DisposableManager::$$c::$Dispose$b__11_0(Zenject::DisposableManager::DisposableInfo x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<Dispose>b__11_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
Zenject::DisposableManager::$$c* Zenject::DisposableManager::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<DisposableManager::$$c*>());
}
