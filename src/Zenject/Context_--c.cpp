...
void Zenject::Context::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "Context/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
bool Zenject::Context::$$c::$set_NormalInstallerTypes$b__16_0(System::Type* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<set_NormalInstallerTypes>b__16_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::Context::$$c* Zenject::Context::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Context::$$c*>());
}
