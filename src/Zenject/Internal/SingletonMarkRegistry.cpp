...
void Zenject::Internal::SingletonMarkRegistry::MarkNonSingleton(System::Type* type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "MarkNonSingleton", {}, ::il2cpp_utils::ExtractTypes(type)));
...
void Zenject::Internal::SingletonMarkRegistry::MarkSingleton(System::Type* type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "MarkSingleton", {}, ::il2cpp_utils::ExtractTypes(type)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, type);
}
