...
Zenject::BindStatement* Zenject::Internal::ZenPools::SpawnStatement() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<Zenject::BindStatement*>(), "SpawnStatement", {}, ::il2cpp_utils::ExtractTypes()));
...
void Zenject::Internal::ZenPools::DespawnStatement(Zenject::BindStatement* statement) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<void>(), "DespawnStatement", {}, ::il2cpp_utils::ExtractTypes(statement)));
...
Zenject::BindInfo* Zenject::Internal::ZenPools::SpawnBindInfo() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<Zenject::BindInfo*>(), "SpawnBindInfo", {}, ::il2cpp_utils::ExtractTypes()));
...
void Zenject::Internal::ZenPools::DespawnBindInfo(Zenject::BindInfo* bindInfo) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<void>(), "DespawnBindInfo", {}, ::il2cpp_utils::ExtractTypes(bindInfo)));
...
Zenject::Internal::LookupId* Zenject::Internal::ZenPools::SpawnLookupId(Zenject::IProvider* provider, Zenject::BindingId bindingId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<Zenject::Internal::LookupId*>(), "SpawnLookupId", {}, ::il2cpp_utils::ExtractTypes(provider, bindingId)));
...
void Zenject::Internal::ZenPools::DespawnLookupId(Zenject::Internal::LookupId* lookupId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<void>(), "DespawnLookupId", {}, ::il2cpp_utils::ExtractTypes(lookupId)));
...
Zenject::InjectContext* Zenject::Internal::ZenPools::SpawnInjectContext(Zenject::DiContainer* container, System::Type* memberType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<Zenject::InjectContext*>(), "SpawnInjectContext", {}, ::il2cpp_utils::ExtractTypes(container, memberType)));
...
void Zenject::Internal::ZenPools::DespawnInjectContext(Zenject::InjectContext* context) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<void>(), "DespawnInjectContext", {}, ::il2cpp_utils::ExtractTypes(context)));
...
Zenject::InjectContext* Zenject::Internal::ZenPools::SpawnInjectContext(Zenject::DiContainer* container, Zenject::InjectableInfo* injectableInfo, Zenject::InjectContext* currentContext, ::Il2CppObject* targetInstance, System::Type* targetType, ::Il2CppObject* concreteIdentifier) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject::Internal").WithContext("ZenPools").WithContext("SpawnInjectContext");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<Zenject::InjectContext*>(), "SpawnInjectContext", {}, ::il2cpp_utils::ExtractTypes(container, injectableInfo, currentContext, targetInstance, targetType, concreteIdentifier)));
...
void Zenject::Internal::ZenPools::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject.Internal", "ZenPools", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
