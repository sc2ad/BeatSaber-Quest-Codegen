...
Zenject::MethodMultipleProviderUntyped* Zenject::MethodMultipleProviderUntyped::New_ctor(System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<::CsObject*>*>* method, Zenject::DiContainer* container) {
  return (MethodMultipleProviderUntyped*)THROW_UNLESS(il2cpp_utils::New("Zenject", "MethodMultipleProviderUntyped", method, container));
}
...
void Zenject::MethodMultipleProviderUntyped::GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::CsObject*>* buffer) {
