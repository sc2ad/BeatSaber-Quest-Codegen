...
void Zenject::TickableManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "TickableManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
System::Type* Zenject::TickableManager::$$c::$InitFixedTickables$b__17_0(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Type*>(), "<InitFixedTickables>b__17_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
int Zenject::TickableManager::$$c::$InitFixedTickables$b__17_2(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<InitFixedTickables>b__17_2", {}, ::il2cpp_utils::ExtractTypes(x))));
...
System::Type* Zenject::TickableManager::$$c::$InitTickables$b__18_0(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Type*>(), "<InitTickables>b__18_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<System::Type*, false>(this, ___internal__method, x);
}
...
int Zenject::TickableManager::$$c::$InitTickables$b__18_2(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<InitTickables>b__18_2", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
System::Type* Zenject::TickableManager::$$c::$InitLateTickables$b__19_0(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Type*>(), "<InitLateTickables>b__19_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<System::Type*, false>(this, ___internal__method, x);
}
...
int Zenject::TickableManager::$$c::$InitLateTickables$b__19_2(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<InitLateTickables>b__19_2", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
Zenject::TickableManager::$$c* Zenject::TickableManager::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<TickableManager::$$c*>());
}
