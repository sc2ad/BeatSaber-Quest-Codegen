...
Zenject::ConditionCopyNonLazyBinder* Zenject::InstantiateCallbackConditionCopyNonLazyBinder::OnInstantiated(System::Action_2<Zenject::InjectContext*, ::Il2CppObject*>* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::ConditionCopyNonLazyBinder*>(), "OnInstantiated", {}, ::il2cpp_utils::ExtractTypes(callback)));
...
Zenject::InstantiateCallbackConditionCopyNonLazyBinder* Zenject::InstantiateCallbackConditionCopyNonLazyBinder::New_ctor(Zenject::BindInfo* bindInfo) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("InstantiateCallbackConditionCopyNonLazyBinder").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<InstantiateCallbackConditionCopyNonLazyBinder*>(bindInfo));
}
