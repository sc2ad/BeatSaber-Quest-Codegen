...
Zenject::AddToNewGameObjectComponentProvider* Zenject::AddToNewGameObjectComponentProvider::New_ctor(Zenject::DiContainer* container, System::Type* componentType, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, Zenject::GameObjectCreationParameters* gameObjectBindInfo, ::Il2CppObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::Il2CppObject*>* instantiateCallback) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<AddToNewGameObjectComponentProvider*>(container, componentType, extraArguments, gameObjectBindInfo, concreteIdentifier, instantiateCallback));
}
