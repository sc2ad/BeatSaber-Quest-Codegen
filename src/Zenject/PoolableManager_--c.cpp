...
void Zenject::PoolableManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "PoolableManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
Zenject::IPoolable* Zenject::PoolableManager::$$c::$_ctor$b__2_2(Zenject::PoolableManager::PoolableInfo x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::IPoolable*>(), "<.ctor>b__2_2", {}, ::il2cpp_utils::ExtractTypes(x))));
...
System::Nullable_1<int> Zenject::PoolableManager::$$c::$CreatePoolableInfo$b__3_1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Nullable_1<int>>(), "<CreatePoolableInfo>b__3_1", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::PoolableManager::$$c* Zenject::PoolableManager::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<PoolableManager::$$c*>());
}
