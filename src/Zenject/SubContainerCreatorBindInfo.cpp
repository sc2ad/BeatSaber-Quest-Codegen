...
::CsString* Zenject::SubContainerCreatorBindInfo::get_DefaultParentName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_DefaultParentName"));
}
// Autogenerated method: Zenject.SubContainerCreatorBindInfo.set_DefaultParentName
void Zenject::SubContainerCreatorBindInfo::set_DefaultParentName(::CsString* value) {
