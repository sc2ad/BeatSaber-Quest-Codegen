...
Zenject::InstanceProvider* Zenject::InstanceProvider::New_ctor(System::Type* instanceType, ::Il2CppObject* instance, Zenject::DiContainer* container) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<InstanceProvider*>(instanceType, instance, container));
}
...
void Zenject::InstanceProvider::$GetAllInstancesWithInjectSplit$b__9_0() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "<GetAllInstancesWithInjectSplit>b__9_0", {}, ::il2cpp_utils::ExtractTypes())));
