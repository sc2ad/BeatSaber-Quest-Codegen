...
Zenject::SubContainerDependencyProvider* Zenject::SubContainerDependencyProvider::New_ctor(System::Type* dependencyType, ::Il2CppObject* identifier, Zenject::ISubContainerCreator* subContainerCreator, bool resolveAll) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SubContainerDependencyProvider*>(dependencyType, identifier, subContainerCreator, resolveAll));
}
...
Zenject::InjectContext* Zenject::SubContainerDependencyProvider::CreateSubContext(Zenject::InjectContext* parent, Zenject::DiContainer* subContainer) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::InjectContext*>(), "CreateSubContext", {}, ::il2cpp_utils::ExtractTypes(parent, subContainer)));
