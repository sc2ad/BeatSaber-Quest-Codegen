...
Zenject::ProfileBlock* Zenject::ProfileBlock::New_ctor(::CsString* sampleName, bool rootBlock) {
  return (ProfileBlock*)THROW_UNLESS(il2cpp_utils::New("Zenject", "ProfileBlock", sampleName, rootBlock));
}
// Autogenerated method: Zenject.ProfileBlock..ctor
Zenject::ProfileBlock* Zenject::ProfileBlock::New_ctor(::CsString* sampleName) {
...
// Autogenerated method: Zenject.ProfileBlock.Start
Zenject::ProfileBlock* Zenject::ProfileBlock::Start(::CsString* sampleNameFormat, ::CsObject* obj1, ::CsObject* obj2) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<Zenject::ProfileBlock*>("Zenject", "ProfileBlock", "Start", sampleNameFormat, obj1, obj2));
}
// Autogenerated method: Zenject.ProfileBlock.Start
Zenject::ProfileBlock* Zenject::ProfileBlock::Start(::CsString* sampleNameFormat, ::CsObject* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<Zenject::ProfileBlock*>("Zenject", "ProfileBlock", "Start", sampleNameFormat, obj));
}
// Autogenerated method: Zenject.ProfileBlock.Start
Zenject::ProfileBlock* Zenject::ProfileBlock::Start(::CsString* sampleName) {
