...
Zenject::ZenjectSettings::SignalSettings* Zenject::ZenjectSettings::SignalSettings::New_ctor(Zenject::SignalDefaultSyncModes defaultSyncMode, Zenject::SignalMissingHandlerResponses missingHandlerDefaultResponse, bool requireStrictUnsubscribe, int defaultAsyncTickPriority) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SignalSettings").WithContext(".ctor");
...
int Zenject::ZenjectSettings::SignalSettings::get_DefaultAsyncTickPriority() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "get_DefaultAsyncTickPriority", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::SignalDefaultSyncModes Zenject::ZenjectSettings::SignalSettings::get_DefaultSyncMode() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::SignalDefaultSyncModes>(), "get_DefaultSyncMode", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::SignalMissingHandlerResponses Zenject::ZenjectSettings::SignalSettings::get_MissingHandlerDefaultResponse() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::SignalMissingHandlerResponses>(), "get_MissingHandlerDefaultResponse", {}, ::il2cpp_utils::ExtractTypes()));
...
bool Zenject::ZenjectSettings::SignalSettings::get_RequireStrictUnsubscribe() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_RequireStrictUnsubscribe", {}, ::il2cpp_utils::ExtractTypes()));
...
void Zenject::ZenjectSettings::SignalSettings::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Zenject", "ZenjectSettings/SignalSettings", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
