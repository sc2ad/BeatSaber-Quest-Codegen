...
Zenject::DiContainer::$GetDependencyContracts$d__96* Zenject::DiContainer::$GetDependencyContracts$d__96::New_ctor(int $$1__state) {
  return (DiContainer::$GetDependencyContracts$d__96*)THROW_UNLESS(il2cpp_utils::New("Zenject", "DiContainer/<GetDependencyContracts>d__96", $$1__state));
}
...
::CsObject* Zenject::DiContainer::$GetDependencyContracts$d__96::System_Collections_IEnumerator_get_Current() {
