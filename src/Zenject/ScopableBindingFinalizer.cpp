...
Zenject::ScopableBindingFinalizer* Zenject::ScopableBindingFinalizer::New_ctor(Zenject::BindInfo* bindInfo, System::Func_3<Zenject::DiContainer*, System::Type*, Zenject::IProvider*>* providerFactory) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("ScopableBindingFinalizer").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ScopableBindingFinalizer*>(bindInfo, providerFactory));
}
