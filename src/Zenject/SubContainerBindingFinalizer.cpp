...
Zenject::SubContainerBindingFinalizer* Zenject::SubContainerBindingFinalizer::New_ctor(Zenject::BindInfo* bindInfo, ::CsObject* subIdentifier, bool resolveAll, System::Func_2<Zenject::DiContainer*, Zenject::ISubContainerCreator*>* creatorFactory) {
