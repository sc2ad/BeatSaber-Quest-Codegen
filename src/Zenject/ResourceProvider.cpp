...
Zenject::ResourceProvider* Zenject::ResourceProvider::New_ctor(::Il2CppString* resourcePath, System::Type* resourceType, bool matchSingle) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ResourceProvider*>(resourcePath, resourceType, matchSingle));
}
