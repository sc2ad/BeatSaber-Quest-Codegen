...
bool Zenject::TickableManager::$$c__DisplayClass18_0::$InitTickables$b__1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<bool>(this, "<InitTickables>b__1", x)));
}
...
Zenject::TickableManager::$$c__DisplayClass18_0* Zenject::TickableManager::$$c__DisplayClass18_0::New_ctor() {
  return (TickableManager::$$c__DisplayClass18_0*)THROW_UNLESS(il2cpp_utils::New("Zenject", "TickableManager/<>c__DisplayClass18_0"));
}
