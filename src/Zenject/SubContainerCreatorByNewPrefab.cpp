...
Zenject::SubContainerCreatorByNewPrefab* Zenject::SubContainerCreatorByNewPrefab::New_ctor(Zenject::DiContainer* container, Zenject::IPrefabProvider* prefabProvider, Zenject::GameObjectCreationParameters* gameObjectBindInfo) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByNewPrefab").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SubContainerCreatorByNewPrefab*>(container, prefabProvider, gameObjectBindInfo));
}
