...
Zenject::GetFromGameObjectGetterComponentProvider* Zenject::GetFromGameObjectGetterComponentProvider::New_ctor(System::Type* componentType, System::Func_2<Zenject::InjectContext*, UnityEngine::GameObject*>* gameObjectGetter, bool matchSingle) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("GetFromGameObjectGetterComponentProvider").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<GetFromGameObjectGetterComponentProvider*>(componentType, gameObjectGetter, matchSingle));
}
