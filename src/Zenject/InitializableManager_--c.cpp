...
void Zenject::InitializableManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "InitializableManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int Zenject::InitializableManager::$$c::$_ctor$b__2_1(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<.ctor>b__2_1", {}, ::il2cpp_utils::ExtractTypes(x))));
...
int Zenject::InitializableManager::$$c::$Initialize$b__5_0(Zenject::InitializableManager::InitializableInfo* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<Initialize>b__5_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
// Autogenerated method: Zenject.InitializableManager/<>c..ctor
Zenject::InitializableManager::$$c* Zenject::InitializableManager::$$c::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<InitializableManager::$$c*>());
}
