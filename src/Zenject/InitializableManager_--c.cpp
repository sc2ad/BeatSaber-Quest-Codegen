...
void Zenject::InitializableManager::$$c::_cctor() {
  THROW_UNLESS(il2cpp_utils::RunMethod("Zenject", "InitializableManager/<>c", ".cctor"));
}
...
int Zenject::InitializableManager::$$c::$Initialize$b__5_0(Zenject::InitializableManager::InitializableInfo* x) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<int>(this, "<Initialize>b__5_0", x)));
}
...
Zenject::InitializableManager::$$c* Zenject::InitializableManager::$$c::New_ctor() {
  return (InitializableManager::$$c*)THROW_UNLESS(il2cpp_utils::New("Zenject", "InitializableManager/<>c"));
}
