...
bool Zenject::MonoKernel::get_IsDestroyed() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_IsDestroyed", {}, ::il2cpp_utils::ExtractTypes()));
...
Zenject::MonoKernel* Zenject::MonoKernel::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoKernel").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MonoKernel*>());
}
