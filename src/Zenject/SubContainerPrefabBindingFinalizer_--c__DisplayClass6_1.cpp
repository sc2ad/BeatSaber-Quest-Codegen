...
// Autogenerated method: Zenject.SubContainerPrefabBindingFinalizer/<>c__DisplayClass6_1..ctor
Zenject::SubContainerPrefabBindingFinalizer::$$c__DisplayClass6_1* Zenject::SubContainerPrefabBindingFinalizer::$$c__DisplayClass6_1::New_ctor() {
  return (SubContainerPrefabBindingFinalizer::$$c__DisplayClass6_1*)THROW_UNLESS(il2cpp_utils::New("Zenject", "SubContainerPrefabBindingFinalizer/<>c__DisplayClass6_1"));
}
