...
Zenject::BindingId* Zenject::BindingId::New_ctor(System::Type* type, ::CsObject* identifier) {
...
::CsObject* Zenject::BindingId::get_Identifier() {
...
bool Zenject::BindingId::Equals(::CsObject* other) {
