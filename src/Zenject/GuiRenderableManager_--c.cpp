...
void Zenject::GuiRenderableManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "GuiRenderableManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int Zenject::GuiRenderableManager::$$c::$_ctor$b__1_2(ModestTree::Util::ValuePair_2<System::Type*, int>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<.ctor>b__1_2", {}, ::il2cpp_utils::ExtractTypes(x))));
...
int Zenject::GuiRenderableManager::$$c::$_ctor$b__1_0(Zenject::GuiRenderableManager::RenderableInfo* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<.ctor>b__1_0", {}, ::il2cpp_utils::ExtractTypes(x))));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
Zenject::GuiRenderableManager::$$c* Zenject::GuiRenderableManager::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<GuiRenderableManager::$$c*>());
}
