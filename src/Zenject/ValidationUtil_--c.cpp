...
void Zenject::ValidationUtil::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("Zenject", "ValidationUtil/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
Zenject::TypeValuePair Zenject::ValidationUtil::$$c::$CreateDefaultArgs$b__0_0(System::Type* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::TypeValuePair>(), "<CreateDefaultArgs>b__0_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
Zenject::ValidationUtil::$$c* Zenject::ValidationUtil::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ValidationUtil::$$c*>());
}
