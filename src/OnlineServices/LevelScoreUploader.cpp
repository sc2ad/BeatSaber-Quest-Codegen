...
void OnlineServices::LevelScoreUploader::add_scoreForLeaderboardDidUploadEvent(System::Action_1<::CsString*>* value) {
...
void OnlineServices::LevelScoreUploader::remove_scoreForLeaderboardDidUploadEvent(System::Action_1<::CsString*>* value) {
