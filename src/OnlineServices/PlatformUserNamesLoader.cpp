...
System::Threading::Tasks::Task_1<::Array<::CsString*>*>* OnlineServices::PlatformUserNamesLoader::GetUserNamesForUserIds(::Array<::CsString*>* userPlatfromIds, System::Threading::CancellationToken cancellationToken) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Threading::Tasks::Task_1<::Array<::CsString*>*>*>(this, "GetUserNamesForUserIds", userPlatfromIds, cancellationToken));
}
