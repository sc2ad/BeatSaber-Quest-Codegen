...
OnlineServices::API::HTTPAdminLeaderboardsHelper* OnlineServices::API::HTTPAdminLeaderboardsHelper::New_ctor(::CsString* uri, ::CsString* secret) {
...
System::Threading::Tasks::Task_1<OnlineServices::API::HTTPAdminLeaderboardsHelper::LeaderboardsInfoResultDto*>* OnlineServices::API::HTTPAdminLeaderboardsHelper::LeaderboardsExist(::Array<::CsString*>* leaderboardIds, System::Threading::CancellationToken cancellationToken) {
...
System::Threading::Tasks::Task_1<bool>* OnlineServices::API::HTTPAdminLeaderboardsHelper::CreateOrUpdateLeaderboards(::Array<::CsString*>* leaderboardIds, System::Threading::CancellationToken cancellationToken) {
...
System::Threading::Tasks::Task_1<::CsString*>* OnlineServices::API::HTTPAdminLeaderboardsHelper::SendWebRequestAsync(::CsString* uri, ::CsString* method, ::CsString* bodyData, System::Threading::CancellationToken cancellationToken) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Threading::Tasks::Task_1<::CsString*>*>(this, "SendWebRequestAsync", uri, method, bodyData, cancellationToken));
}
