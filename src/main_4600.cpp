...
// ABORTED elsewhere.  System::Array::SorterObjectArray::SorterObjectArray(::ArrayWrapper<::Il2CppObject*> keys, ::ArrayWrapper<::Il2CppObject*> items, System::Collections::IComparer* comparer)
