...
void Org::BouncyCastle::Pkcs::Pkcs10CertificationRequest::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Pkcs", "Pkcs10CertificationRequest", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Asn1::Pkcs::RsassaPssParameters* Org::BouncyCastle::Pkcs::Pkcs10CertificationRequest::CreatePssParams(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* hashAlgId, int saltSize) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Pkcs", "Pkcs10CertificationRequest", il2cpp_utils::NoArgClass<Org::BouncyCastle::Asn1::Pkcs::RsassaPssParameters*>(), "CreatePssParams", {}, ::il2cpp_utils::ExtractTypes(hashAlgId, saltSize)));
