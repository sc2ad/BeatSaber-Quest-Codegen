...
Org::BouncyCastle::Math::Field::IFiniteField* Org::BouncyCastle::Math::EC::AbstractF2mCurve::BuildField(int m, int k1, int k2, int k3) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC", "AbstractF2mCurve", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::Field::IFiniteField*>(), "BuildField", {}, ::il2cpp_utils::ExtractTypes(m, k1, k2, k3)));
...
Org::BouncyCastle::Math::EC::AbstractF2mCurve* Org::BouncyCastle::Math::EC::AbstractF2mCurve::New_ctor(int m, int k1, int k2, int k3) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC").WithContext("AbstractF2mCurve").WithContext(".ctor");
...
Org::BouncyCastle::Math::EC::ECFieldElement* Org::BouncyCastle::Math::EC::AbstractF2mCurve::SolveQuadraticEquation(Org::BouncyCastle::Math::EC::ECFieldElement* beta) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::EC::ECFieldElement*>(), "SolveQuadraticEquation", {}, ::il2cpp_utils::ExtractTypes(beta)));
...
::Array<Org::BouncyCastle::Math::BigInteger*>* Org::BouncyCastle::Math::EC::AbstractF2mCurve::GetSi() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<Org::BouncyCastle::Math::BigInteger*>*>(), "GetSi", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Math::EC::AbstractF2mCurve::ImplRandomFieldElementMult(Org::BouncyCastle::Security::SecureRandom* r, int m) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC", "AbstractF2mCurve", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "ImplRandomFieldElementMult", {}, ::il2cpp_utils::ExtractTypes(r, m)));
