...
::Array<Org::BouncyCastle::Math::BigInteger*>* Org::BouncyCastle::Math::EC::Endo::EndoUtilities::DecomposeScalar(Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters* p, Org::BouncyCastle::Math::BigInteger* k) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Endo", "EndoUtilities", il2cpp_utils::NoArgClass<::Array<Org::BouncyCastle::Math::BigInteger*>*>(), "DecomposeScalar", {}, ::il2cpp_utils::ExtractTypes(p, k)));
...
Org::BouncyCastle::Math::EC::ECPoint* Org::BouncyCastle::Math::EC::Endo::EndoUtilities::MapPoint(Org::BouncyCastle::Math::EC::Endo::ECEndomorphism* endomorphism, Org::BouncyCastle::Math::EC::ECPoint* p) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Endo", "EndoUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::EC::ECPoint*>(), "MapPoint", {}, ::il2cpp_utils::ExtractTypes(endomorphism, p)));
...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Math::EC::Endo::EndoUtilities::CalculateB(Org::BouncyCastle::Math::BigInteger* k, Org::BouncyCastle::Math::BigInteger* g, int t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Endo", "EndoUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "CalculateB", {}, ::il2cpp_utils::ExtractTypes(k, g, t)));
...
void Org::BouncyCastle::Math::EC::Endo::EndoUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Endo", "EndoUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
