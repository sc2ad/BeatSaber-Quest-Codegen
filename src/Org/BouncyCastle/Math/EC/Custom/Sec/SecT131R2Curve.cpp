...
void Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Custom.Sec", "SecT131R2Curve", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT131R2Curve..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve* Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT131R2Curve").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecT131R2Curve*>());
}
