...
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecP160R2FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement::New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP160R2FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecP160R2FieldElement*>(x));
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecP160R2FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement::New_ctor(::Array<uint>* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP160R2FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecP160R2FieldElement*>(x));
}
...
void Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2FieldElement::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Custom.Sec", "SecP160R2FieldElement", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
