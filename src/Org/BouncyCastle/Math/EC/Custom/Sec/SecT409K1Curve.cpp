...
void Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Custom.Sec", "SecT409K1Curve", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT409K1Curve..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve* Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SecT409K1Curve*>());
}
