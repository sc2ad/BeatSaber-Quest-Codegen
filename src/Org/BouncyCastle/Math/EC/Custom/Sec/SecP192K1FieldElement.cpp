...
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecP192K1FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement::New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP192K1FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecP192K1FieldElement*>(x));
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecP192K1FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement::New_ctor(::Array<uint>* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP192K1FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecP192K1FieldElement*>(x));
}
...
void Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1FieldElement::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Custom.Sec", "SecP192K1FieldElement", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
