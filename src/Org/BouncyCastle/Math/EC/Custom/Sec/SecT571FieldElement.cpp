...
// Completed includes
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT571FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT571FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecT571FieldElement::New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT571FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecT571FieldElement*>(x));
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT571FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT571FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecT571FieldElement::New_ctor(::Array<uint64_t>* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT571FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecT571FieldElement*>(x));
}
