...
// Completed includes
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT233FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT233FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecT233FieldElement::New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SecT233FieldElement*>(x));
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.Sec.SecT233FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::Sec::SecT233FieldElement* Org::BouncyCastle::Math::EC::Custom::Sec::SecT233FieldElement::New_ctor(::Array<uint64_t>* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT233FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecT233FieldElement*>(x));
}
