...
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1FieldElement* Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1FieldElement::New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::GM").WithContext("SM2P256V1FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SM2P256V1FieldElement*>(x));
}
// Autogenerated method: Org.BouncyCastle.Math.EC.Custom.GM.SM2P256V1FieldElement..ctor
Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1FieldElement* Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1FieldElement::New_ctor(::Array<uint>* x) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::GM").WithContext("SM2P256V1FieldElement").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SM2P256V1FieldElement*>(x));
}
...
void Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1FieldElement::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Custom.GM", "SM2P256V1FieldElement", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
