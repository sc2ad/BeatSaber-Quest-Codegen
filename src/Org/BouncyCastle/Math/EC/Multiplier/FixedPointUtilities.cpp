...
int Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::GetCombSize(Org::BouncyCastle::Math::EC::ECCurve* c) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Multiplier", "FixedPointUtilities", il2cpp_utils::NoArgClass<int>(), "GetCombSize", {}, ::il2cpp_utils::ExtractTypes(c)));
...
Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::Precompute(Org::BouncyCastle::Math::EC::ECPoint* p) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Multiplier", "FixedPointUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo*>(), "Precompute", {}, ::il2cpp_utils::ExtractTypes(p)));
...
void Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC.Multiplier", "FixedPointUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
