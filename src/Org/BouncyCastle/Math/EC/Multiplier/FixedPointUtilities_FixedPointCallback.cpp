...
Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::FixedPointCallback* Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::FixedPointCallback::New_ctor(Org::BouncyCastle::Math::EC::ECPoint* p) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Multiplier").WithContext("FixedPointCallback").WithContext(".ctor");
...
bool Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::FixedPointCallback::CheckExisting(Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo* existingFP, int n) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "CheckExisting", {}, ::il2cpp_utils::ExtractTypes(existingFP, n)));
...
bool Org::BouncyCastle::Math::EC::Multiplier::FixedPointUtilities::FixedPointCallback::CheckTable(Org::BouncyCastle::Math::EC::ECLookupTable* table, int n) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "CheckTable", {}, ::il2cpp_utils::ExtractTypes(table, n)));
