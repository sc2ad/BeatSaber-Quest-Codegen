...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Math::EC::AbstractFpCurve::ImplRandomFieldElementMult(Org::BouncyCastle::Security::SecureRandom* r, Org::BouncyCastle::Math::BigInteger* p) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Math.EC", "AbstractFpCurve", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "ImplRandomFieldElementMult", {}, ::il2cpp_utils::ExtractTypes(r, p)));
