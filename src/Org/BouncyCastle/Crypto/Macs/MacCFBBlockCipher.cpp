...
Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher* Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher::New_ctor(Org::BouncyCastle::Crypto::IBlockCipher* cipher, int bitBlockSize) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Macs").WithContext("MacCFBBlockCipher").WithContext(".ctor");
...
void Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher::GetMacBlock(::Array<uint8_t>* mac) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "GetMacBlock", {}, ::il2cpp_utils::ExtractTypes(mac)));
...
int Org::BouncyCastle::Crypto::Macs::MacCFBBlockCipher::ProcessBlock(::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "ProcessBlock", {}, ::il2cpp_utils::ExtractTypes(input, inOff, outBytes, outOff)));
