...
void Org::BouncyCastle::Crypto::Macs::HMac::XorPad(::Array<uint8_t>* pad, int len, uint8_t n) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Macs", "HMac", il2cpp_utils::NoArgClass<void>(), "XorPad", {}, ::il2cpp_utils::ExtractTypes(pad, len, n)));
