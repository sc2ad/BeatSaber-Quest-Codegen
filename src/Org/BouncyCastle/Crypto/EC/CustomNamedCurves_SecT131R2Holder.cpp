...
Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder::_get_Instance() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT131R2Holder").WithContext("_get_Instance");
...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder::_set_Instance(Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT131R2Holder").WithContext("_set_Instance");
...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder::_cctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT131R2Holder").WithContext(".cctor");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SecT131R2Holder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT131R2Holder").WithContext(".ctor");
...
Org::BouncyCastle::Asn1::X9::X9ECParameters* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT131R2Holder::CreateParameters() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT131R2Holder").WithContext("CreateParameters");
