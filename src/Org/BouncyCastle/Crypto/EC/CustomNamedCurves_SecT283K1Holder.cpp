...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283K1Holder::_cctor() {
  THROW_UNLESS(il2cpp_utils::RunMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SecT283K1Holder", ".cctor"));
}
// Autogenerated method: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/SecT283K1Holder..ctor
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283K1Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283K1Holder::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<CustomNamedCurves::SecT283K1Holder*>());
}
