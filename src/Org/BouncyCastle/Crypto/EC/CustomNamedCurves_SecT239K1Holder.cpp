...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT239K1Holder::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SecT239K1Holder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/SecT239K1Holder..ctor
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT239K1Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT239K1Holder::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecT239K1Holder").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CustomNamedCurves::SecT239K1Holder*>());
}
