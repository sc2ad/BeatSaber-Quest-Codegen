...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SM2P256V1Holder::_cctor() {
  THROW_UNLESS(il2cpp_utils::RunMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SM2P256V1Holder", ".cctor"));
}
// Autogenerated method: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/SM2P256V1Holder..ctor
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SM2P256V1Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SM2P256V1Holder::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<CustomNamedCurves::SM2P256V1Holder*>());
}
