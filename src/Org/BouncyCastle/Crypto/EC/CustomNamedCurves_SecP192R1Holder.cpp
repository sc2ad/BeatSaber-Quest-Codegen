...
Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder::_get_Instance() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecP192R1Holder").WithContext("_get_Instance");
...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder::_set_Instance(Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecP192R1Holder").WithContext("_set_Instance");
...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder::_cctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecP192R1Holder").WithContext(".cctor");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SecP192R1Holder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/SecP192R1Holder..ctor
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecP192R1Holder").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CustomNamedCurves::SecP192R1Holder*>());
}
...
Org::BouncyCastle::Asn1::X9::X9ECParameters* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecP192R1Holder::CreateParameters() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::EC").WithContext("SecP192R1Holder").WithContext("CreateParameters");
