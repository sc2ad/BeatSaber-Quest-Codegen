...
void Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283R1Holder::_cctor() {
  THROW_UNLESS(il2cpp_utils::RunMethod("Org.BouncyCastle.Crypto.EC", "CustomNamedCurves/SecT283R1Holder", ".cctor"));
}
// Autogenerated method: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/SecT283R1Holder..ctor
Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283R1Holder* Org::BouncyCastle::Crypto::EC::CustomNamedCurves::SecT283R1Holder::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<CustomNamedCurves::SecT283R1Holder*>());
}
