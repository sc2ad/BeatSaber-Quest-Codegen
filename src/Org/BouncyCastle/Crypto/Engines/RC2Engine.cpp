...
::Array<int>* Org::BouncyCastle::Crypto::Engines::RC2Engine::GenerateWorkingKey(::Array<uint8_t>* key, int bits) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<int>*>(), "GenerateWorkingKey", {}, ::il2cpp_utils::ExtractTypes(key, bits)));
...
int Org::BouncyCastle::Crypto::Engines::RC2Engine::RotateWordLeft(int x, int y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "RotateWordLeft", {}, ::il2cpp_utils::ExtractTypes(x, y)));
...
void Org::BouncyCastle::Crypto::Engines::RC2Engine::EncryptBlock(::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "EncryptBlock", {}, ::il2cpp_utils::ExtractTypes(input, inOff, outBytes, outOff)));
...
void Org::BouncyCastle::Crypto::Engines::RC2Engine::DecryptBlock(::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "DecryptBlock", {}, ::il2cpp_utils::ExtractTypes(input, inOff, outBytes, outOff)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, input, inOff, outBytes, outOff);
}
...
void Org::BouncyCastle::Crypto::Engines::RC2Engine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "RC2Engine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
