...
int Org::BouncyCastle::Crypto::Engines::NoekeonEngine::EncryptBlock(::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* output, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "EncryptBlock", {}, ::il2cpp_utils::ExtractTypes(input, inOff, output, outOff)));
...
int Org::BouncyCastle::Crypto::Engines::NoekeonEngine::DecryptBlock(::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* output, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "DecryptBlock", {}, ::il2cpp_utils::ExtractTypes(input, inOff, output, outOff)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, input, inOff, output, outOff);
}
...
void Org::BouncyCastle::Crypto::Engines::NoekeonEngine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "NoekeonEngine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
