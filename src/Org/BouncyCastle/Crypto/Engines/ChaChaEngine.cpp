...
void Org::BouncyCastle::Crypto::Engines::ChaChaEngine::ChachaCore(int rounds, ::Array<uint>* input, ::Array<uint>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "ChaChaEngine", il2cpp_utils::NoArgClass<void>(), "ChachaCore", {}, ::il2cpp_utils::ExtractTypes(rounds, input, x)));
...
Org::BouncyCastle::Crypto::Engines::ChaChaEngine* Org::BouncyCastle::Crypto::Engines::ChaChaEngine::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Engines").WithContext("ChaChaEngine").WithContext(".ctor");
