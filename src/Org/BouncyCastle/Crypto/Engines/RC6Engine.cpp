...
void Org::BouncyCastle::Crypto::Engines::RC6Engine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "RC6Engine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Crypto::Engines::RC6Engine* Org::BouncyCastle::Crypto::Engines::RC6Engine::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Engines").WithContext("RC6Engine").WithContext(".ctor");
