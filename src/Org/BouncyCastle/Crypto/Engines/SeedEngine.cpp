...
::Array<int>* Org::BouncyCastle::Crypto::Engines::SeedEngine::createWorkingKey(::Array<uint8_t>* inKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<int>*>(), "createWorkingKey", {}, ::il2cpp_utils::ExtractTypes(inKey)));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::extractW1(int64_t lVal) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "extractW1", {}, ::il2cpp_utils::ExtractTypes(lVal)));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::extractW0(int64_t lVal) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "extractW0", {}, ::il2cpp_utils::ExtractTypes(lVal)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, lVal);
}
...
int64_t Org::BouncyCastle::Crypto::Engines::SeedEngine::rotateLeft8(int64_t x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int64_t>(), "rotateLeft8", {}, ::il2cpp_utils::ExtractTypes(x)));
...
int64_t Org::BouncyCastle::Crypto::Engines::SeedEngine::rotateRight8(int64_t x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int64_t>(), "rotateRight8", {}, ::il2cpp_utils::ExtractTypes(x)));
  return ::il2cpp_utils::RunMethodThrow<int64_t, false>(this, ___internal__method, x);
}
...
int64_t Org::BouncyCastle::Crypto::Engines::SeedEngine::bytesToLong(::Array<uint8_t>* src, int srcOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int64_t>(), "bytesToLong", {}, ::il2cpp_utils::ExtractTypes(src, srcOff)));
...
void Org::BouncyCastle::Crypto::Engines::SeedEngine::longToBytes(::Array<uint8_t>* dest, int destOff, int64_t value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "longToBytes", {}, ::il2cpp_utils::ExtractTypes(dest, destOff, value)));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::G(int x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "G", {}, ::il2cpp_utils::ExtractTypes(x)));
...
int64_t Org::BouncyCastle::Crypto::Engines::SeedEngine::F(int ki0, int ki1, int64_t r) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int64_t>(), "F", {}, ::il2cpp_utils::ExtractTypes(ki0, ki1, r)));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::phaseCalc1(int r0, int ki0, int r1, int ki1) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "phaseCalc1", {}, ::il2cpp_utils::ExtractTypes(r0, ki0, r1, ki1)));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::phaseCalc2(int r0, int ki0, int r1, int ki1) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "phaseCalc2", {}, ::il2cpp_utils::ExtractTypes(r0, ki0, r1, ki1)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, r0, ki0, r1, ki1);
}
...
void Org::BouncyCastle::Crypto::Engines::SeedEngine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "SeedEngine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
int Org::BouncyCastle::Crypto::Engines::SeedEngine::ProcessBlock(::Array<uint8_t>* inBuf, int inOff, ::Array<uint8_t>* outBuf, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "ProcessBlock", {}, ::il2cpp_utils::ExtractTypes(inBuf, inOff, outBuf, outOff)));
