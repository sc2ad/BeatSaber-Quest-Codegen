...
int Org::BouncyCastle::Crypto::Engines::IdeaEngine::BytesToWord(::Array<uint8_t>* input, int inOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "BytesToWord", {}, ::il2cpp_utils::ExtractTypes(input, inOff)));
...
void Org::BouncyCastle::Crypto::Engines::IdeaEngine::WordToBytes(int word, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "WordToBytes", {}, ::il2cpp_utils::ExtractTypes(word, outBytes, outOff)));
...
int Org::BouncyCastle::Crypto::Engines::IdeaEngine::Mul(int x, int y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "Mul", {}, ::il2cpp_utils::ExtractTypes(x, y)));
...
void Org::BouncyCastle::Crypto::Engines::IdeaEngine::IdeaFunc(::Array<int>* workingKey, ::Array<uint8_t>* input, int inOff, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "IdeaFunc", {}, ::il2cpp_utils::ExtractTypes(workingKey, input, inOff, outBytes, outOff)));
...
::Array<int>* Org::BouncyCastle::Crypto::Engines::IdeaEngine::ExpandKey(::Array<uint8_t>* uKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<int>*>(), "ExpandKey", {}, ::il2cpp_utils::ExtractTypes(uKey)));
...
int Org::BouncyCastle::Crypto::Engines::IdeaEngine::MulInv(int x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "MulInv", {}, ::il2cpp_utils::ExtractTypes(x)));
...
int Org::BouncyCastle::Crypto::Engines::IdeaEngine::AddInv(int x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "AddInv", {}, ::il2cpp_utils::ExtractTypes(x)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x);
}
...
::Array<int>* Org::BouncyCastle::Crypto::Engines::IdeaEngine::InvertKey(::Array<int>* inKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<int>*>(), "InvertKey", {}, ::il2cpp_utils::ExtractTypes(inKey)));
...
void Org::BouncyCastle::Crypto::Engines::IdeaEngine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "IdeaEngine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
