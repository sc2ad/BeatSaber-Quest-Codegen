...
void Org::BouncyCastle::Crypto::Engines::RC4Engine::SetKey(::Array<uint8_t>* keyBytes) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetKey", {}, ::il2cpp_utils::ExtractTypes(keyBytes)));
...
void Org::BouncyCastle::Crypto::Engines::RC4Engine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "RC4Engine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
