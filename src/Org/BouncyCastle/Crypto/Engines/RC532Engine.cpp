...
int Org::BouncyCastle::Crypto::Engines::RC532Engine::RotateLeft(int x, int y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "RotateLeft", {}, ::il2cpp_utils::ExtractTypes(x, y)));
...
int Org::BouncyCastle::Crypto::Engines::RC532Engine::RotateRight(int x, int y) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "RotateRight", {}, ::il2cpp_utils::ExtractTypes(x, y)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x, y);
}
...
int Org::BouncyCastle::Crypto::Engines::RC532Engine::BytesToWord(::Array<uint8_t>* src, int srcOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "BytesToWord", {}, ::il2cpp_utils::ExtractTypes(src, srcOff)));
...
void Org::BouncyCastle::Crypto::Engines::RC532Engine::WordToBytes(int word, ::Array<uint8_t>* dst, int dstOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "WordToBytes", {}, ::il2cpp_utils::ExtractTypes(word, dst, dstOff)));
...
void Org::BouncyCastle::Crypto::Engines::RC532Engine::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Engines", "RC532Engine", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
