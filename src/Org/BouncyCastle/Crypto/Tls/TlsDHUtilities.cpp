...
// Autogenerated method: Org.BouncyCastle.Crypto.Tls.TlsDHUtilities.CalculateDHBasicAgreement
::Array<uint8_t>* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::CalculateDHBasicAgreement(Org::BouncyCastle::Crypto::Parameters::DHPublicKeyParameters* publicKey, Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* privateKey) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<uint8_t>*>("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", "CalculateDHBasicAgreement", publicKey, privateKey));
}
