...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::FromHex(::Il2CppString* hex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "FromHex", {}, ::il2cpp_utils::ExtractTypes(hex)));
...
Org::BouncyCastle::Crypto::Parameters::DHParameters* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::FromSafeP(::Il2CppString* hexP) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::Parameters::DHParameters*>(), "FromSafeP", {}, ::il2cpp_utils::ExtractTypes(hexP)));
...
Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::GenerateDHKeyPair(Org::BouncyCastle::Security::SecureRandom* random, Org::BouncyCastle::Crypto::Parameters::DHParameters* dhParams) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair*>(), "GenerateDHKeyPair", {}, ::il2cpp_utils::ExtractTypes(random, dhParams)));
...
Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::GenerateEphemeralClientKeyExchange(Org::BouncyCastle::Security::SecureRandom* random, Org::BouncyCastle::Crypto::Parameters::DHParameters* dhParams, System::IO::Stream* output) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::Parameters::DHPrivateKeyParameters*>(), "GenerateEphemeralClientKeyExchange", {}, ::il2cpp_utils::ExtractTypes(random, dhParams, output)));
...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::ReadDHParameter(System::IO::Stream* input) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "ReadDHParameter", {}, ::il2cpp_utils::ExtractTypes(input)));
...
void Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::WriteDHParameter(Org::BouncyCastle::Math::BigInteger* x, System::IO::Stream* output) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<void>(), "WriteDHParameter", {}, ::il2cpp_utils::ExtractTypes(x, output)));
...
void Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Tls", "TlsDHUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
