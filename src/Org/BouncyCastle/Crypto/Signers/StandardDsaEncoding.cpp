...
Org::BouncyCastle::Asn1::DerInteger* Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding::EncodeValue(Org::BouncyCastle::Math::BigInteger* n, Org::BouncyCastle::Math::BigInteger* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Org::BouncyCastle::Asn1::DerInteger*>(), "EncodeValue", {}, ::il2cpp_utils::ExtractTypes(n, x)));
...
void Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Signers", "StandardDsaEncoding", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
