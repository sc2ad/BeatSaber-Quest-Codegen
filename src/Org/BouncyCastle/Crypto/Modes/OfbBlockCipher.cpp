...
// Completed includes
// Autogenerated method: Org.BouncyCastle.Crypto.Modes.OfbBlockCipher..ctor
Org::BouncyCastle::Crypto::Modes::OfbBlockCipher* Org::BouncyCastle::Crypto::Modes::OfbBlockCipher::New_ctor(Org::BouncyCastle::Crypto::IBlockCipher* cipher, int blockSize) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Modes").WithContext("OfbBlockCipher").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OfbBlockCipher*>(cipher, blockSize));
}
