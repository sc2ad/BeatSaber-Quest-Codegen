...
int Org::BouncyCastle::Crypto::Modes::GOfbBlockCipher::bytesToint(::Array<uint8_t>* inBytes, int inOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "bytesToint", {}, ::il2cpp_utils::ExtractTypes(inBytes, inOff)));
...
void Org::BouncyCastle::Crypto::Modes::GOfbBlockCipher::intTobytes(int num, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "intTobytes", {}, ::il2cpp_utils::ExtractTypes(num, outBytes, outOff)));
