...
Org::BouncyCastle::Crypto::Modes::CbcBlockCipher* Org::BouncyCastle::Crypto::Modes::CbcBlockCipher::New_ctor(Org::BouncyCastle::Crypto::IBlockCipher* cipher) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Modes").WithContext("CbcBlockCipher").WithContext(".ctor");
...
Org::BouncyCastle::Crypto::IBlockCipher* Org::BouncyCastle::Crypto::Modes::CbcBlockCipher::GetUnderlyingCipher() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::IBlockCipher*>(), "GetUnderlyingCipher", {}, ::il2cpp_utils::ExtractTypes()));
