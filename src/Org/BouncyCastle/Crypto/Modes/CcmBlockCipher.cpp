...
int Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::ProcessPacket(::Array<uint8_t>* input, int inOff, int inLen, ::Array<uint8_t>* output, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "ProcessPacket", {}, ::il2cpp_utils::ExtractTypes(input, inOff, inLen, output, outOff)));
...
int Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::CalculateMac(::Array<uint8_t>* data, int dataOff, int dataLen, ::Array<uint8_t>* macBlock) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "CalculateMac", {}, ::il2cpp_utils::ExtractTypes(data, dataOff, dataLen, macBlock)));
...
int Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::GetMacSize(bool forEncryption, int requestedMacBits) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetMacSize", {}, ::il2cpp_utils::ExtractTypes(forEncryption, requestedMacBits)));
...
int Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::GetAssociatedTextLength() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetAssociatedTextLength", {}, ::il2cpp_utils::ExtractTypes()));
...
bool Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::HasAssociatedText() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "HasAssociatedText", {}, ::il2cpp_utils::ExtractTypes()));
...
void Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Modes", "CcmBlockCipher", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
int Org::BouncyCastle::Crypto::Modes::CcmBlockCipher::ProcessBytes(::Array<uint8_t>* inBytes, int inOff, int inLen, ::Array<uint8_t>* outBytes, int outOff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "ProcessBytes", {}, ::il2cpp_utils::ExtractTypes(inBytes, inOff, inLen, outBytes, outOff)));
