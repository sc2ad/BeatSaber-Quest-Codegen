...
Org::BouncyCastle::Crypto::Digests::KeccakDigest* Org::BouncyCastle::Crypto::Digests::KeccakDigest::New_ctor(int bitLength) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Digests").WithContext("KeccakDigest").WithContext(".ctor");
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::CopyIn(Org::BouncyCastle::Crypto::Digests::KeccakDigest* source) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "CopyIn", {}, ::il2cpp_utils::ExtractTypes(source)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::Init(int bitLength) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(bitLength)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::InitSponge(int rate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "InitSponge", {}, ::il2cpp_utils::ExtractTypes(rate)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::Absorb(uint8_t data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Absorb", {}, ::il2cpp_utils::ExtractTypes(data)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::Absorb(::Array<uint8_t>* data, int off, int len) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Digests").WithContext("KeccakDigest").WithContext("Absorb");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Absorb", {}, ::il2cpp_utils::ExtractTypes(data, off, len)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::AbsorbBits(int data, int bits) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "AbsorbBits", {}, ::il2cpp_utils::ExtractTypes(data, bits)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::PadAndSwitchToSqueezingPhase() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "PadAndSwitchToSqueezingPhase", {}, ::il2cpp_utils::ExtractTypes()));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::Squeeze(::Array<uint8_t>* output, int offset, int64_t outputLength) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Squeeze", {}, ::il2cpp_utils::ExtractTypes(output, offset, outputLength)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::KeccakAbsorb(::Array<uint8_t>* data, int off) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "KeccakAbsorb", {}, ::il2cpp_utils::ExtractTypes(data, off)));
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::KeccakExtract() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "KeccakExtract", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::KeccakPermutation() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "KeccakPermutation", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
void Org::BouncyCastle::Crypto::Digests::KeccakDigest::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Crypto.Digests", "KeccakDigest", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
