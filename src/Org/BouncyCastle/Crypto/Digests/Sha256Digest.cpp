...
void Org::BouncyCastle::Crypto::Digests::Sha256Digest::initHs() {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "initHs"));
}
...
uint Org::BouncyCastle::Crypto::Digests::Sha256Digest::Sum1Ch(uint x, uint y, uint z) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<uint>("Org.BouncyCastle.Crypto.Digests", "Sha256Digest", "Sum1Ch", x, y, z));
}
...
uint Org::BouncyCastle::Crypto::Digests::Sha256Digest::Sum0Maj(uint x, uint y, uint z) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<uint>("Org.BouncyCastle.Crypto.Digests", "Sha256Digest", "Sum0Maj", x, y, z));
}
...
uint Org::BouncyCastle::Crypto::Digests::Sha256Digest::Theta0(uint x) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<uint>("Org.BouncyCastle.Crypto.Digests", "Sha256Digest", "Theta0", x));
}
...
uint Org::BouncyCastle::Crypto::Digests::Sha256Digest::Theta1(uint x) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<uint>("Org.BouncyCastle.Crypto.Digests", "Sha256Digest", "Theta1", x));
}
...
void Org::BouncyCastle::Crypto::Digests::Sha256Digest::_cctor() {
  THROW_UNLESS(il2cpp_utils::RunMethod("Org.BouncyCastle.Crypto.Digests", "Sha256Digest", ".cctor"));
}
// Autogenerated method: Org.BouncyCastle.Crypto.Digests.Sha256Digest..ctor
