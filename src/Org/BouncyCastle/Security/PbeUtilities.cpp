...
void Org::BouncyCastle::Security::PbeUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Crypto::PbeParametersGenerator* Org::BouncyCastle::Security::PbeUtilities::MakePbeGenerator(::Il2CppString* type, Org::BouncyCastle::Crypto::IDigest* digest, ::Array<uint8_t>* key, ::Array<uint8_t>* salt, int iterationCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::PbeParametersGenerator*>(), "MakePbeGenerator", {}, ::il2cpp_utils::ExtractTypes(type, digest, key, salt, iterationCount)));
...
bool Org::BouncyCastle::Security::PbeUtilities::IsPkcs12(::Il2CppString* algorithm) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<bool>(), "IsPkcs12", {}, ::il2cpp_utils::ExtractTypes(algorithm)));
...
bool Org::BouncyCastle::Security::PbeUtilities::IsPkcs5Scheme2(::Il2CppString* algorithm) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<bool>(), "IsPkcs5Scheme2", {}, ::il2cpp_utils::ExtractTypes(algorithm)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, algorithm);
}
...
Org::BouncyCastle::Crypto::ICipherParameters* Org::BouncyCastle::Security::PbeUtilities::GenerateCipherParameters(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID, ::Array<::Il2CppChar>* password, bool wrongPkcs12Zero) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::ICipherParameters*>(), "GenerateCipherParameters", {}, ::il2cpp_utils::ExtractTypes(algID, password, wrongPkcs12Zero)));
...
Org::BouncyCastle::Crypto::ICipherParameters* Org::BouncyCastle::Security::PbeUtilities::GenerateCipherParameters(::Il2CppString* algorithm, ::Array<::Il2CppChar>* password, bool wrongPkcs12Zero, Org::BouncyCastle::Asn1::Asn1Encodable* pbeParameters) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Security").WithContext("PbeUtilities").WithContext("GenerateCipherParameters");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::ICipherParameters*>(), "GenerateCipherParameters", {}, ::il2cpp_utils::ExtractTypes(algorithm, password, wrongPkcs12Zero, pbeParameters)));
...
::Il2CppObject* Org::BouncyCastle::Security::PbeUtilities::CreateEngine(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* algID) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CreateEngine", {}, ::il2cpp_utils::ExtractTypes(algID)));
...
::Il2CppObject* Org::BouncyCastle::Security::PbeUtilities::CreateEngine(::Il2CppString* algorithm) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Security").WithContext("PbeUtilities").WithContext("CreateEngine");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CreateEngine", {}, ::il2cpp_utils::ExtractTypes(algorithm)));
...
Org::BouncyCastle::Crypto::ICipherParameters* Org::BouncyCastle::Security::PbeUtilities::FixDesParity(::Il2CppString* mechanism, Org::BouncyCastle::Crypto::ICipherParameters* parameters) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "PbeUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::ICipherParameters*>(), "FixDesParity", {}, ::il2cpp_utils::ExtractTypes(mechanism, parameters)));
