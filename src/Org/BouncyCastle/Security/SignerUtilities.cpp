...
void Org::BouncyCastle::Security::SignerUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "SignerUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Crypto::ISigner* Org::BouncyCastle::Security::SignerUtilities::GetSigner(::Il2CppString* algorithm) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "SignerUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::ISigner*>(), "GetSigner", {}, ::il2cpp_utils::ExtractTypes(algorithm)));
...
::Il2CppString* Org::BouncyCastle::Security::SignerUtilities::GetEncodingName(Org::BouncyCastle::Asn1::DerObjectIdentifier* oid) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "SignerUtilities", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetEncodingName", {}, ::il2cpp_utils::ExtractTypes(oid)));
