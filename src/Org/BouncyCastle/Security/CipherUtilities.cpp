...
void Org::BouncyCastle::Security::CipherUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "CipherUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Org::BouncyCastle::Crypto::IBufferedCipher* Org::BouncyCastle::Security::CipherUtilities::GetCipher(Org::BouncyCastle::Asn1::DerObjectIdentifier* oid) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "CipherUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::IBufferedCipher*>(), "GetCipher", {}, ::il2cpp_utils::ExtractTypes(oid)));
...
Org::BouncyCastle::Crypto::IBufferedCipher* Org::BouncyCastle::Security::CipherUtilities::GetCipher(::Il2CppString* algorithm) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Security").WithContext("CipherUtilities").WithContext("GetCipher");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "CipherUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::IBufferedCipher*>(), "GetCipher", {}, ::il2cpp_utils::ExtractTypes(algorithm)));
...
int Org::BouncyCastle::Security::CipherUtilities::GetDigitIndex(::Il2CppString* s) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "CipherUtilities", il2cpp_utils::NoArgClass<int>(), "GetDigitIndex", {}, ::il2cpp_utils::ExtractTypes(s)));
...
Org::BouncyCastle::Crypto::IBlockCipher* Org::BouncyCastle::Security::CipherUtilities::CreateBlockCipher(Org::BouncyCastle::Security::CipherUtilities::CipherAlgorithm cipherAlgorithm) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Security", "CipherUtilities", il2cpp_utils::NoArgClass<Org::BouncyCastle::Crypto::IBlockCipher*>(), "CreateBlockCipher", {}, ::il2cpp_utils::ExtractTypes(cipherAlgorithm)));
