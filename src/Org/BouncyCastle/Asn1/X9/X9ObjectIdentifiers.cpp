...
void Org::BouncyCastle::Asn1::X9::X9ObjectIdentifiers::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Asn1.X9", "X9ObjectIdentifiers", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
