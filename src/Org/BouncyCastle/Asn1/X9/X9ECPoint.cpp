...
Org::BouncyCastle::Asn1::X9::X9ECPoint* Org::BouncyCastle::Asn1::X9::X9ECPoint::New_ctor(Org::BouncyCastle::Math::EC::ECPoint* p, bool compressed) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::X9").WithContext("X9ECPoint").WithContext(".ctor");
...
Org::BouncyCastle::Math::EC::ECPoint* Org::BouncyCastle::Asn1::X9::X9ECPoint::get_Point() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::EC::ECPoint*>(), "get_Point", {}, ::il2cpp_utils::ExtractTypes()));
