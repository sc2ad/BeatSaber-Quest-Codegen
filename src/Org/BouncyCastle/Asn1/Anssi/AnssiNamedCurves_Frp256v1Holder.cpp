...
Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder::_get_Instance() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Anssi").WithContext("Frp256v1Holder").WithContext("_get_Instance");
...
void Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder::_set_Instance(Org::BouncyCastle::Asn1::X9::X9ECParametersHolder* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Anssi").WithContext("Frp256v1Holder").WithContext("_set_Instance");
...
void Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder::_cctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Anssi").WithContext("Frp256v1Holder").WithContext(".cctor");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Asn1.Anssi", "AnssiNamedCurves/Frp256v1Holder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Asn1.Anssi.AnssiNamedCurves/Frp256v1Holder..ctor
Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder* Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<AnssiNamedCurves::Frp256v1Holder*>());
}
...
Org::BouncyCastle::Asn1::X9::X9ECParameters* Org::BouncyCastle::Asn1::Anssi::AnssiNamedCurves::Frp256v1Holder::CreateParameters() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Anssi").WithContext("Frp256v1Holder").WithContext("CreateParameters");
