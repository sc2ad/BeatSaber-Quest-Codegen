...
void Org::BouncyCastle::Asn1::Sec::SecNamedCurves::Sect283r1Holder::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Asn1.Sec", "SecNamedCurves/Sect283r1Holder", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Org.BouncyCastle.Asn1.Sec.SecNamedCurves/Sect283r1Holder..ctor
Org::BouncyCastle::Asn1::Sec::SecNamedCurves::Sect283r1Holder* Org::BouncyCastle::Asn1::Sec::SecNamedCurves::Sect283r1Holder::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Sec").WithContext("Sect283r1Holder").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SecNamedCurves::Sect283r1Holder*>());
}
