...
Org::BouncyCastle::Asn1::Cms::ContentInfo* Org::BouncyCastle::Asn1::Cms::ContentInfo::GetInstance(::Il2CppObject* obj) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Cms").WithContext("ContentInfo").WithContext("GetInstance");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Asn1.Cms", "ContentInfo", il2cpp_utils::NoArgClass<Org::BouncyCastle::Asn1::Cms::ContentInfo*>(), "GetInstance", {}, ::il2cpp_utils::ExtractTypes(obj)));
...
Org::BouncyCastle::Asn1::Cms::ContentInfo* Org::BouncyCastle::Asn1::Cms::ContentInfo::New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence* seq) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Cms").WithContext("ContentInfo").WithContext(".ctor");
...
Org::BouncyCastle::Asn1::Asn1Object* Org::BouncyCastle::Asn1::Cms::ContentInfo::ToAsn1Object() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1::Cms").WithContext("ContentInfo").WithContext("ToAsn1Object");
