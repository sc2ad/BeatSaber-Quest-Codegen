...
Org::BouncyCastle::Asn1::ConstructedOctetStream* Org::BouncyCastle::Asn1::ConstructedOctetStream::New_ctor(Org::BouncyCastle::Asn1::Asn1StreamParser* parser) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("ConstructedOctetStream").WithContext(".ctor");
...
Org::BouncyCastle::Asn1::Asn1OctetStringParser* Org::BouncyCastle::Asn1::ConstructedOctetStream::GetNextParser() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Org::BouncyCastle::Asn1::Asn1OctetStringParser*>(), "GetNextParser", {}, ::il2cpp_utils::ExtractTypes()));
