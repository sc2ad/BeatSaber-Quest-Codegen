...
Org::BouncyCastle::Asn1::DerVisibleString* Org::BouncyCastle::Asn1::DerVisibleString::New_ctor(::Array<uint8_t>* str) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext(".ctor");
...
::Array<uint8_t>* Org::BouncyCastle::Asn1::DerVisibleString::GetOctets() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext("GetOctets");
...
::Il2CppString* Org::BouncyCastle::Asn1::DerVisibleString::GetString() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext("GetString");
...
void Org::BouncyCastle::Asn1::DerVisibleString::Encode(Org::BouncyCastle::Asn1::DerOutputStream* derOut) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext("Encode");
...
bool Org::BouncyCastle::Asn1::DerVisibleString::Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object* asn1Object) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext("Asn1Equals");
...
int Org::BouncyCastle::Asn1::DerVisibleString::Asn1GetHashCode() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Asn1").WithContext("DerVisibleString").WithContext("Asn1GetHashCode");
