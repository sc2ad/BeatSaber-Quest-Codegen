...
Org::BouncyCastle::Asn1::Asn1Object* Org::BouncyCastle::X509::Extension::X509ExtensionUtilities::FromExtensionValue(Org::BouncyCastle::Asn1::Asn1OctetString* extensionValue) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<Org::BouncyCastle::Asn1::Asn1Object*>("Org.BouncyCastle.X509.Extension", "X509ExtensionUtilities", "FromExtensionValue", extensionValue));
}
