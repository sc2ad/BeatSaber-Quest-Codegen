...
::Array<uint8_t>* Org::BouncyCastle::Utilities::Encoders::Base64::Decode(::Il2CppString* data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.Encoders", "Base64", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "Decode", {}, ::il2cpp_utils::ExtractTypes(data)));
