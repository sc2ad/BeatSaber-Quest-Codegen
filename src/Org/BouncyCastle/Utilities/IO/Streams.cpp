...
::Array<uint8_t>* Org::BouncyCastle::Utilities::IO::Streams::ReadAll(System::IO::Stream* inStr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.IO", "Streams", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "ReadAll", {}, ::il2cpp_utils::ExtractTypes(inStr)));
...
int Org::BouncyCastle::Utilities::IO::Streams::ReadFully(System::IO::Stream* inStr, ::Array<uint8_t>* buf) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.IO", "Streams", il2cpp_utils::NoArgClass<int>(), "ReadFully", {}, ::il2cpp_utils::ExtractTypes(inStr, buf)));
...
int Org::BouncyCastle::Utilities::IO::Streams::ReadFully(System::IO::Stream* inStr, ::Array<uint8_t>* buf, int off, int len) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Utilities::IO").WithContext("Streams").WithContext("ReadFully");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.IO", "Streams", il2cpp_utils::NoArgClass<int>(), "ReadFully", {}, ::il2cpp_utils::ExtractTypes(inStr, buf, off, len)));
...
void Org::BouncyCastle::Utilities::IO::Streams::PipeAll(System::IO::Stream* inStr, System::IO::Stream* outStr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.IO", "Streams", il2cpp_utils::NoArgClass<void>(), "PipeAll", {}, ::il2cpp_utils::ExtractTypes(inStr, outStr)));
...
int Org::BouncyCastle::Utilities::IO::Streams::WriteBufTo(System::IO::MemoryStream* buf, ::Array<uint8_t>* output, int offset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities.IO", "Streams", il2cpp_utils::NoArgClass<int>(), "WriteBufTo", {}, ::il2cpp_utils::ExtractTypes(buf, output, offset)));
