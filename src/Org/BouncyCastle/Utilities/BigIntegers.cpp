...
::Array<uint8_t>* Org::BouncyCastle::Utilities::BigIntegers::AsUnsignedByteArray(Org::BouncyCastle::Math::BigInteger* n) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities", "BigIntegers", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "AsUnsignedByteArray", {}, ::il2cpp_utils::ExtractTypes(n)));
...
::Array<uint8_t>* Org::BouncyCastle::Utilities::BigIntegers::AsUnsignedByteArray(int length, Org::BouncyCastle::Math::BigInteger* n) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Utilities").WithContext("BigIntegers").WithContext("AsUnsignedByteArray");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities", "BigIntegers", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "AsUnsignedByteArray", {}, ::il2cpp_utils::ExtractTypes(length, n)));
...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Utilities::BigIntegers::CreateRandomBigInteger(int bitLength, Org::BouncyCastle::Security::SecureRandom* secureRandom) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities", "BigIntegers", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "CreateRandomBigInteger", {}, ::il2cpp_utils::ExtractTypes(bitLength, secureRandom)));
...
Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Utilities::BigIntegers::CreateRandomInRange(Org::BouncyCastle::Math::BigInteger* min, Org::BouncyCastle::Math::BigInteger* max, Org::BouncyCastle::Security::SecureRandom* random) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities", "BigIntegers", il2cpp_utils::NoArgClass<Org::BouncyCastle::Math::BigInteger*>(), "CreateRandomInRange", {}, ::il2cpp_utils::ExtractTypes(min, max, random)));
...
int Org::BouncyCastle::Utilities::BigIntegers::GetUnsignedByteLength(Org::BouncyCastle::Math::BigInteger* n) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Org.BouncyCastle.Utilities", "BigIntegers", il2cpp_utils::NoArgClass<int>(), "GetUnsignedByteLength", {}, ::il2cpp_utils::ExtractTypes(n)));
