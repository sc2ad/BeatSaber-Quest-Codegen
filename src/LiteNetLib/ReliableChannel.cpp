...
LiteNetLib::ReliableChannel* LiteNetLib::ReliableChannel::New_ctor(LiteNetLib::NetPeer* peer, bool ordered, uint8_t id) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("ReliableChannel").WithContext(".ctor");
...
void LiteNetLib::ReliableChannel::ProcessAck(LiteNetLib::NetPacket* packet) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ProcessAck", {}, ::il2cpp_utils::ExtractTypes(packet)));
