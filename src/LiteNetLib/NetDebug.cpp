...
void LiteNetLib::NetDebug::WriteLogic(LiteNetLib::NetLogLevel logLevel, ::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "WriteLogic", {}, ::il2cpp_utils::ExtractTypes(logLevel, str, args)));
...
void LiteNetLib::NetDebug::Write(::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "Write", {}, ::il2cpp_utils::ExtractTypes(str, args)));
...
void LiteNetLib::NetDebug::Write(LiteNetLib::NetLogLevel level, ::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NetDebug").WithContext("Write");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "Write", {}, ::il2cpp_utils::ExtractTypes(level, str, args)));
...
void LiteNetLib::NetDebug::WriteForce(::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "WriteForce", {}, ::il2cpp_utils::ExtractTypes(str, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, str, args);
}
...
void LiteNetLib::NetDebug::WriteForce(LiteNetLib::NetLogLevel level, ::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NetDebug").WithContext("WriteForce");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "WriteForce", {}, ::il2cpp_utils::ExtractTypes(level, str, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, level, str, args);
}
...
void LiteNetLib::NetDebug::WriteError(::Il2CppString* str, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), "WriteError", {}, ::il2cpp_utils::ExtractTypes(str, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, str, args);
}
...
void LiteNetLib::NetDebug::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetDebug", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
