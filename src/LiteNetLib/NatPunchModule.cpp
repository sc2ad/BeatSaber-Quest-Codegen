...
void LiteNetLib::NatPunchModule::ProcessMessage(System::Net::IPEndPoint* senderEndPoint, LiteNetLib::NetPacket* packet) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ProcessMessage", {}, ::il2cpp_utils::ExtractTypes(senderEndPoint, packet)));
...
void LiteNetLib::NatPunchModule::Init(LiteNetLib::INatPunchListener* listener) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(listener)));
...
void LiteNetLib::NatPunchModule::NatIntroduce(System::Net::IPEndPoint* hostInternal, System::Net::IPEndPoint* hostExternal, System::Net::IPEndPoint* clientInternal, System::Net::IPEndPoint* clientExternal, ::Il2CppString* additionalInfo) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "NatIntroduce", {}, ::il2cpp_utils::ExtractTypes(hostInternal, hostExternal, clientInternal, clientExternal, additionalInfo)));
...
void LiteNetLib::NatPunchModule::SendNatIntroduceRequest(::Il2CppString* host, int port, ::Il2CppString* additionalInfo) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SendNatIntroduceRequest", {}, ::il2cpp_utils::ExtractTypes(host, port, additionalInfo)));
...
void LiteNetLib::NatPunchModule::SendNatIntroduceRequest(System::Net::IPEndPoint* masterServerEndPoint, ::Il2CppString* additionalInfo) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatPunchModule").WithContext("SendNatIntroduceRequest");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SendNatIntroduceRequest", {}, ::il2cpp_utils::ExtractTypes(masterServerEndPoint, additionalInfo)));
...
void LiteNetLib::NatPunchModule::OnNatIntroductionRequest(LiteNetLib::NatPunchModule::NatIntroduceRequestPacket* req, System::Net::IPEndPoint* senderEndPoint) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnNatIntroductionRequest", {}, ::il2cpp_utils::ExtractTypes(req, senderEndPoint)));
...
void LiteNetLib::NatPunchModule::OnNatIntroductionResponse(LiteNetLib::NatPunchModule::NatIntroduceResponsePacket* req) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnNatIntroductionResponse", {}, ::il2cpp_utils::ExtractTypes(req)));
...
void LiteNetLib::NatPunchModule::OnNatPunch(LiteNetLib::NatPunchModule::NatPunchPacket* req, System::Net::IPEndPoint* senderEndPoint) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnNatPunch", {}, ::il2cpp_utils::ExtractTypes(req, senderEndPoint)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, req, senderEndPoint);
}
