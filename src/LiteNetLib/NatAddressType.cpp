...
LiteNetLib::NatAddressType LiteNetLib::NatAddressType::_get_Internal() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatAddressType").WithContext("_get_Internal");
...
void LiteNetLib::NatAddressType::_set_Internal(LiteNetLib::NatAddressType value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatAddressType").WithContext("_set_Internal");
...
LiteNetLib::NatAddressType LiteNetLib::NatAddressType::_get_External() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatAddressType").WithContext("_get_External");
...
void LiteNetLib::NatAddressType::_set_External(LiteNetLib::NatAddressType value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatAddressType").WithContext("_set_External");
