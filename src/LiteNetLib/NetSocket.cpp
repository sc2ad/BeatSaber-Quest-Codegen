...
bool LiteNetLib::NetSocket::Bind(System::Net::IPAddress* addressIPv4, System::Net::IPAddress* addressIPv6, int port, bool reuseAddress, bool ipv6) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Bind", addressIPv4, addressIPv6, port, reuseAddress, ipv6));
}
