...
System::Net::IPEndPoint* LiteNetLib::NetUtils::MakeEndPoint(::Il2CppString* hostStr, int port) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<System::Net::IPEndPoint*>(), "MakeEndPoint", {}, ::il2cpp_utils::ExtractTypes(hostStr, port)));
...
System::Net::IPAddress* LiteNetLib::NetUtils::ResolveAddress(::Il2CppString* hostStr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<System::Net::IPAddress*>(), "ResolveAddress", {}, ::il2cpp_utils::ExtractTypes(hostStr)));
...
System::Net::IPAddress* LiteNetLib::NetUtils::ResolveAddress(::Il2CppString* hostStr, System::Net::Sockets::AddressFamily addressFamily) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NetUtils").WithContext("ResolveAddress");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<System::Net::IPAddress*>(), "ResolveAddress", {}, ::il2cpp_utils::ExtractTypes(hostStr, addressFamily)));
...
::Array<System::Net::IPAddress*>* LiteNetLib::NetUtils::ResolveAddresses(::Il2CppString* hostStr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<::Array<System::Net::IPAddress*>*>(), "ResolveAddresses", {}, ::il2cpp_utils::ExtractTypes(hostStr)));
...
System::Collections::Generic::List_1<::Il2CppString*>* LiteNetLib::NetUtils::GetLocalIpList(LiteNetLib::LocalAddrType addrType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<System::Collections::Generic::List_1<::Il2CppString*>*>(), "GetLocalIpList", {}, ::il2cpp_utils::ExtractTypes(addrType)));
...
void LiteNetLib::NetUtils::GetLocalIpList(System::Collections::Generic::IList_1<::Il2CppString*>* targetList, LiteNetLib::LocalAddrType addrType) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NetUtils").WithContext("GetLocalIpList");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<void>(), "GetLocalIpList", {}, ::il2cpp_utils::ExtractTypes(targetList, addrType)));
...
::Il2CppString* LiteNetLib::NetUtils::GetLocalIp(LiteNetLib::LocalAddrType addrType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetLocalIp", {}, ::il2cpp_utils::ExtractTypes(addrType)));
...
void LiteNetLib::NetUtils::PrintInterfaceInfos() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<void>(), "PrintInterfaceInfos", {}, ::il2cpp_utils::ExtractTypes()));
...
int LiteNetLib::NetUtils::RelativeSequenceNumber(int number, int expected) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<int>(), "RelativeSequenceNumber", {}, ::il2cpp_utils::ExtractTypes(number, expected)));
...
void LiteNetLib::NetUtils::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib", "NetUtils", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
