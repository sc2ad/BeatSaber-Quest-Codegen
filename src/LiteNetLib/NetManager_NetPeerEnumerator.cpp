...
LiteNetLib::NetManager::NetPeerEnumerator::NetPeerEnumerator(LiteNetLib::NetPeer* p) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NetPeerEnumerator").WithContext(".ctor");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<NetManager::NetPeerEnumerator>(), ".ctor", {}, ::il2cpp_utils::ExtractTypes(p)));
...
LiteNetLib::NetPeer* LiteNetLib::NetManager::NetPeerEnumerator::get_Current() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<LiteNetLib::NetPeer*>(), "get_Current", {}, ::il2cpp_utils::ExtractTypes()));
