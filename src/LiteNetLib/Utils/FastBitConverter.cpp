...
void LiteNetLib::Utils::FastBitConverter::WriteLittleEndian(::Array<uint8_t>* buffer, int offset, uint64_t data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib.Utils", "FastBitConverter", il2cpp_utils::NoArgClass<void>(), "WriteLittleEndian", {}, ::il2cpp_utils::ExtractTypes(buffer, offset, data)));
...
void LiteNetLib::Utils::FastBitConverter::GetBytes(::Array<uint8_t>* bytes, int startIndex, double value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("LiteNetLib.Utils", "FastBitConverter", il2cpp_utils::NoArgClass<void>(), "GetBytes", {}, ::il2cpp_utils::ExtractTypes(bytes, startIndex, value)));
