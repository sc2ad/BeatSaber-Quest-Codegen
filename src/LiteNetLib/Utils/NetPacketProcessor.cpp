...
LiteNetLib::Utils::NetPacketProcessor::SubscribeDelegate* LiteNetLib::Utils::NetPacketProcessor::GetCallbackFromData(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<LiteNetLib::Utils::NetPacketProcessor::SubscribeDelegate*>(), "GetCallbackFromData", {}, ::il2cpp_utils::ExtractTypes(reader)));
...
void LiteNetLib::Utils::NetPacketProcessor::ReadAllPackets(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ReadAllPackets", {}, ::il2cpp_utils::ExtractTypes(reader)));
...
void LiteNetLib::Utils::NetPacketProcessor::ReadAllPackets(LiteNetLib::Utils::NetDataReader* reader, ::Il2CppObject* userData) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("NetPacketProcessor").WithContext("ReadAllPackets");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ReadAllPackets", {}, ::il2cpp_utils::ExtractTypes(reader, userData)));
...
void LiteNetLib::Utils::NetPacketProcessor::ReadPacket(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ReadPacket", {}, ::il2cpp_utils::ExtractTypes(reader)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, reader);
}
// Autogenerated method: LiteNetLib.Utils.NetPacketProcessor.ReadPacket
void LiteNetLib::Utils::NetPacketProcessor::ReadPacket(LiteNetLib::Utils::NetDataReader* reader, ::Il2CppObject* userData) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("NetPacketProcessor").WithContext("ReadPacket");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ReadPacket", {}, ::il2cpp_utils::ExtractTypes(reader, userData)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, reader, userData);
}
// Autogenerated method: LiteNetLib.Utils.NetPacketProcessor..ctor
