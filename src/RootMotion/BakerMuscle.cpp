...
RootMotion::BakerMuscle* RootMotion::BakerMuscle::New_ctor(int muscleIndex) {
  return (BakerMuscle*)THROW_UNLESS(il2cpp_utils::New("RootMotion", "BakerMuscle", muscleIndex));
}
// Autogenerated method: RootMotion.BakerMuscle.MuscleNameToPropertyName
::CsString* RootMotion::BakerMuscle::MuscleNameToPropertyName(::CsString* n) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "MuscleNameToPropertyName", n));
}
