...
void RootMotion::Warning::Log(::CsString* message, RootMotion::Warning::Logger* logger, bool logInEditMode) {
  THROW_UNLESS(il2cpp_utils::RunMethod("RootMotion", "Warning", "Log", message, logger, logInEditMode));
}
// Autogenerated method: RootMotion.Warning.Log
void RootMotion::Warning::Log(::CsString* message, UnityEngine::Transform* context, bool logInEditMode) {
