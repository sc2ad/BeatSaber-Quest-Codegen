...
void RootMotion::Warning::Log(::Il2CppString* message, RootMotion::Warning::Logger* logger, bool logInEditMode) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "Warning", il2cpp_utils::NoArgClass<void>(), "Log", {}, ::il2cpp_utils::ExtractTypes(message, logger, logInEditMode)));
...
void RootMotion::Warning::Log(::Il2CppString* message, UnityEngine::Transform* context, bool logInEditMode) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion").WithContext("Warning").WithContext("Log");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "Warning", il2cpp_utils::NoArgClass<void>(), "Log", {}, ::il2cpp_utils::ExtractTypes(message, context, logInEditMode)));
