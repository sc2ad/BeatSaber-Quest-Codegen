...
UnityEngine::LayerMask RootMotion::LayerMaskExtensions::Create(::Array<::CsString*>* layerNames) {
...
UnityEngine::LayerMask RootMotion::LayerMaskExtensions::NamesToMask(::Array<::CsString*>* layerNames) {
...
UnityEngine::LayerMask RootMotion::LayerMaskExtensions::AddToMask(UnityEngine::LayerMask original, ::Array<::CsString*>* layerNames) {
...
UnityEngine::LayerMask RootMotion::LayerMaskExtensions::RemoveFromMask(UnityEngine::LayerMask original, ::Array<::CsString*>* layerNames) {
...
::Array<::CsString*>* RootMotion::LayerMaskExtensions::MaskToNames(UnityEngine::LayerMask original) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<::CsString*>*>("RootMotion", "LayerMaskExtensions", "MaskToNames", original));
}
...
::CsString* RootMotion::LayerMaskExtensions::MaskToString(UnityEngine::LayerMask original) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("RootMotion", "LayerMaskExtensions", "MaskToString", original));
}
// Autogenerated method: RootMotion.LayerMaskExtensions.MaskToString
::CsString* RootMotion::LayerMaskExtensions::MaskToString(UnityEngine::LayerMask original, ::CsString* delimiter) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("RootMotion", "LayerMaskExtensions", "MaskToString", original, delimiter));
}
