...
UnityEngine::Quaternion RootMotion::QuaTools::Lerp(UnityEngine::Quaternion fromRotation, UnityEngine::Quaternion toRotation, float weight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "Lerp", {}, ::il2cpp_utils::ExtractTypes(fromRotation, toRotation, weight)));
...
UnityEngine::Quaternion RootMotion::QuaTools::Slerp(UnityEngine::Quaternion fromRotation, UnityEngine::Quaternion toRotation, float weight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "Slerp", {}, ::il2cpp_utils::ExtractTypes(fromRotation, toRotation, weight)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::Quaternion, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, fromRotation, toRotation, weight);
}
...
UnityEngine::Quaternion RootMotion::QuaTools::LinearBlend(UnityEngine::Quaternion q, float weight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "LinearBlend", {}, ::il2cpp_utils::ExtractTypes(q, weight)));
...
UnityEngine::Quaternion RootMotion::QuaTools::SphericalBlend(UnityEngine::Quaternion q, float weight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "SphericalBlend", {}, ::il2cpp_utils::ExtractTypes(q, weight)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::Quaternion, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, q, weight);
}
...
UnityEngine::Quaternion RootMotion::QuaTools::FromToAroundAxis(UnityEngine::Vector3 fromDirection, UnityEngine::Vector3 toDirection, UnityEngine::Vector3 axis) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "FromToAroundAxis", {}, ::il2cpp_utils::ExtractTypes(fromDirection, toDirection, axis)));
...
UnityEngine::Quaternion RootMotion::QuaTools::RotationToLocalSpace(UnityEngine::Quaternion space, UnityEngine::Quaternion rotation) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "RotationToLocalSpace", {}, ::il2cpp_utils::ExtractTypes(space, rotation)));
...
UnityEngine::Quaternion RootMotion::QuaTools::FromToRotation(UnityEngine::Quaternion from, UnityEngine::Quaternion to) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "FromToRotation", {}, ::il2cpp_utils::ExtractTypes(from, to)));
...
UnityEngine::Vector3 RootMotion::QuaTools::GetAxis(UnityEngine::Vector3 v) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "GetAxis", {}, ::il2cpp_utils::ExtractTypes(v)));
...
UnityEngine::Quaternion RootMotion::QuaTools::ClampRotation(UnityEngine::Quaternion rotation, float clampWeight, int clampSmoothing) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "ClampRotation", {}, ::il2cpp_utils::ExtractTypes(rotation, clampWeight, clampSmoothing)));
...
float RootMotion::QuaTools::ClampAngle(float angle, float clampWeight, int clampSmoothing) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<float>(), "ClampAngle", {}, ::il2cpp_utils::ExtractTypes(angle, clampWeight, clampSmoothing)));
...
UnityEngine::Quaternion RootMotion::QuaTools::MatchRotation(UnityEngine::Quaternion targetRotation, UnityEngine::Vector3 targetforwardAxis, UnityEngine::Vector3 targetUpAxis, UnityEngine::Vector3 forwardAxis, UnityEngine::Vector3 upAxis) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Quaternion>(), "MatchRotation", {}, ::il2cpp_utils::ExtractTypes(targetRotation, targetforwardAxis, targetUpAxis, forwardAxis, upAxis)));
...
UnityEngine::Vector3 RootMotion::QuaTools::ToBiPolar(UnityEngine::Vector3 euler) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "ToBiPolar", {}, ::il2cpp_utils::ExtractTypes(euler)));
...
float RootMotion::QuaTools::ToBiPolar(float angle) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion").WithContext("QuaTools").WithContext("ToBiPolar");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("RootMotion", "QuaTools", il2cpp_utils::NoArgClass<float>(), "ToBiPolar", {}, ::il2cpp_utils::ExtractTypes(angle)));
