...
RootMotion::FinalIK::IKMapping::BoneMap* RootMotion::FinalIK::IKMappingLimb::GetBoneMap(RootMotion::FinalIK::IKMappingLimb::BoneMapType boneMap) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<RootMotion::FinalIK::IKMapping::BoneMap*>(), "GetBoneMap", {}, ::il2cpp_utils::ExtractTypes(boneMap)));
...
void RootMotion::FinalIK::IKMappingLimb::SetLimbOrientation(UnityEngine::Vector3 upper, UnityEngine::Vector3 lower) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetLimbOrientation", {}, ::il2cpp_utils::ExtractTypes(upper, lower)));
...
RootMotion::FinalIK::IKMappingLimb* RootMotion::FinalIK::IKMappingLimb::New_ctor(UnityEngine::Transform* bone1, UnityEngine::Transform* bone2, UnityEngine::Transform* bone3, UnityEngine::Transform* parentBone) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IKMappingLimb*>(bone1, bone2, bone3, parentBone));
}
...
void RootMotion::FinalIK::IKMappingLimb::SetBones(UnityEngine::Transform* bone1, UnityEngine::Transform* bone2, UnityEngine::Transform* bone3, UnityEngine::Transform* parentBone) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetBones", {}, ::il2cpp_utils::ExtractTypes(bone1, bone2, bone3, parentBone)));
...
void RootMotion::FinalIK::IKMappingLimb::WritePose(RootMotion::FinalIK::IKSolverFullBody* solver, bool fullBody) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "WritePose", {}, ::il2cpp_utils::ExtractTypes(solver, fullBody)));
...
RootMotion::FinalIK::IKMappingLimb* RootMotion::FinalIK::IKMappingLimb::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("IKMappingLimb").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IKMappingLimb*>());
}
