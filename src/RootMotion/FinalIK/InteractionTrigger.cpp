...
int RootMotion::FinalIK::InteractionTrigger::GetBestRangeIndex(UnityEngine::Transform* character, UnityEngine::Transform* raycastFrom, UnityEngine::RaycastHit raycastHit) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetBestRangeIndex", {}, ::il2cpp_utils::ExtractTypes(character, raycastFrom, raycastHit)));
...
RootMotion::FinalIK::InteractionTrigger* RootMotion::FinalIK::InteractionTrigger::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<InteractionTrigger*>());
}
