...
void RootMotion::FinalIK::ShoulderRotator::RotateShoulders() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RotateShoulders", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
void RootMotion::FinalIK::ShoulderRotator::RotateShoulder(RootMotion::FinalIK::FullBodyBipedChain chain, float weight, float offset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RotateShoulder", {}, ::il2cpp_utils::ExtractTypes(chain, weight, offset)));
...
RootMotion::FinalIK::IKMapping::BoneMap* RootMotion::FinalIK::ShoulderRotator::GetParentBoneMap(RootMotion::FinalIK::FullBodyBipedChain chain) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<RootMotion::FinalIK::IKMapping::BoneMap*>(), "GetParentBoneMap", {}, ::il2cpp_utils::ExtractTypes(chain)));
...
RootMotion::FinalIK::ShoulderRotator* RootMotion::FinalIK::ShoulderRotator::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ShoulderRotator*>());
}
