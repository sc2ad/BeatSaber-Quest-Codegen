...
RootMotion::FinalIK::HitReactionVRIK::PositionOffset::PositionOffsetLink* RootMotion::FinalIK::HitReactionVRIK::PositionOffset::PositionOffsetLink::New_ctor() {
  return (HitReactionVRIK::PositionOffset::PositionOffsetLink*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "HitReactionVRIK/PositionOffset/PositionOffsetLink"));
}
