...
RootMotion::FinalIK::IKMappingBone* RootMotion::FinalIK::IKMappingBone::New_ctor(UnityEngine::Transform* bone) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("IKMappingBone").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IKMappingBone*>(bone));
}
...
void RootMotion::FinalIK::IKMappingBone::WritePose(float solverWeight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "WritePose", {}, ::il2cpp_utils::ExtractTypes(solverWeight)));
...
RootMotion::FinalIK::IKMappingBone* RootMotion::FinalIK::IKMappingBone::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("IKMappingBone").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IKMappingBone*>());
}
