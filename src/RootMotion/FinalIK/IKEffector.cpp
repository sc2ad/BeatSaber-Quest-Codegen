...
RootMotion::FinalIK::IKEffector* RootMotion::FinalIK::IKEffector::New_ctor(UnityEngine::Transform* bone, ::Array<UnityEngine::Transform*>* childBones) {
  return (IKEffector*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "IKEffector", bone, childBones));
}
// Autogenerated method: RootMotion.FinalIK.IKEffector.IsValid
bool RootMotion::FinalIK::IKEffector::IsValid(RootMotion::FinalIK::IKSolver* solver, ::CsString*& message) {
...
RootMotion::FinalIK::IKEffector* RootMotion::FinalIK::IKEffector::New_ctor() {
  return (IKEffector*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "IKEffector"));
}
