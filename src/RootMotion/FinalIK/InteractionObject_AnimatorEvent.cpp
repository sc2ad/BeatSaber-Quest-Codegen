...
void RootMotion::FinalIK::InteractionObject::AnimatorEvent::Activate(bool pickUp) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Activate", {}, ::il2cpp_utils::ExtractTypes(pickUp)));
...
void RootMotion::FinalIK::InteractionObject::AnimatorEvent::Activate(UnityEngine::Animator* animator) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("AnimatorEvent").WithContext("Activate");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Activate", {}, ::il2cpp_utils::ExtractTypes(animator)));
...
void RootMotion::FinalIK::InteractionObject::AnimatorEvent::Activate(UnityEngine::Animation* animation) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("AnimatorEvent").WithContext("Activate");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Activate", {}, ::il2cpp_utils::ExtractTypes(animation)));
...
RootMotion::FinalIK::InteractionObject::AnimatorEvent* RootMotion::FinalIK::InteractionObject::AnimatorEvent::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<InteractionObject::AnimatorEvent*>());
}
