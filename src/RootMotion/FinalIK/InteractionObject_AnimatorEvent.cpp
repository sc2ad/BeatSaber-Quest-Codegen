...
::CsString* RootMotion::FinalIK::InteractionObject::AnimatorEvent::_get_empty() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("RootMotion.FinalIK", "InteractionObject/AnimatorEvent", "empty"));
}
// Autogenerated static field setter
// Set static field: static private System.String empty
void RootMotion::FinalIK::InteractionObject::AnimatorEvent::_set_empty(::CsString* value) {
