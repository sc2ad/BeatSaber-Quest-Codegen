...
RootMotion::FinalIK::OffsetModifier::$Initiate$d__8* RootMotion::FinalIK::OffsetModifier::$Initiate$d__8::New_ctor(int $$1__state) {
  return (OffsetModifier::$Initiate$d__8*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "OffsetModifier/<Initiate>d__8", $$1__state));
}
...
::CsObject* RootMotion::FinalIK::OffsetModifier::$Initiate$d__8::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* RootMotion::FinalIK::OffsetModifier::$Initiate$d__8::System_Collections_IEnumerator_get_Current() {
