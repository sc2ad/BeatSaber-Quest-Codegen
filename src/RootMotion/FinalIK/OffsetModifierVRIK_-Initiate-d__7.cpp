...
RootMotion::FinalIK::OffsetModifierVRIK::$Initiate$d__7* RootMotion::FinalIK::OffsetModifierVRIK::$Initiate$d__7::New_ctor(int $$1__state) {
  return (OffsetModifierVRIK::$Initiate$d__7*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "OffsetModifierVRIK/<Initiate>d__7", $$1__state));
}
...
::CsObject* RootMotion::FinalIK::OffsetModifierVRIK::$Initiate$d__7::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* RootMotion::FinalIK::OffsetModifierVRIK::$Initiate$d__7::System_Collections_IEnumerator_get_Current() {
