...
float RootMotion::FinalIK::IKSolverVR::BodyPart::get_sqrMag() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "get_sqrMag", {}, ::il2cpp_utils::ExtractTypes()));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::set_sqrMag(float value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_sqrMag", {}, ::il2cpp_utils::ExtractTypes(value)));
...
float RootMotion::FinalIK::IKSolverVR::BodyPart::get_mag() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "get_mag", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<float, false>(this, ___internal__method);
}
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::set_mag(float value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_mag", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::SetLOD(int LOD) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetLOD", {}, ::il2cpp_utils::ExtractTypes(LOD)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::Read(::Array<UnityEngine::Vector3>* positions, ::Array<UnityEngine::Quaternion>* rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes, bool hasLegs, int rootIndex, int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Read", {}, ::il2cpp_utils::ExtractTypes(positions, rotations, hasChest, hasNeck, hasShoulders, hasToes, hasLegs, rootIndex, index)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, positions, rotations, hasChest, hasNeck, hasShoulders, hasToes, hasLegs, rootIndex, index);
}
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::MoveRotation(UnityEngine::Quaternion rotation) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "MoveRotation", {}, ::il2cpp_utils::ExtractTypes(rotation)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::Translate(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Translate", {}, ::il2cpp_utils::ExtractTypes(position, rotation)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::TranslateRoot(UnityEngine::Vector3 newRootPos, UnityEngine::Quaternion newRootRot) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "TranslateRoot", {}, ::il2cpp_utils::ExtractTypes(newRootPos, newRootRot)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::RotateTo(RootMotion::FinalIK::IKSolverVR::VirtualBone* bone, UnityEngine::Quaternion rotation, float weight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RotateTo", {}, ::il2cpp_utils::ExtractTypes(bone, rotation, weight)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::Visualize(UnityEngine::Color color) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Visualize", {}, ::il2cpp_utils::ExtractTypes(color)));
...
void RootMotion::FinalIK::IKSolverVR::BodyPart::Visualize() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("BodyPart").WithContext("Visualize");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Visualize", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
RootMotion::FinalIK::IKSolverVR::BodyPart* RootMotion::FinalIK::IKSolverVR::BodyPart::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IKSolverVR::BodyPart*>());
}
