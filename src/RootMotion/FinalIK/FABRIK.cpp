...
RootMotion::FinalIK::FABRIK* RootMotion::FinalIK::FABRIK::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("FABRIK").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<FABRIK*>());
}
