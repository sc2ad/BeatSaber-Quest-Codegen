...
bool RootMotion::FinalIK::IKMapping::BoneIsValid(UnityEngine::Transform* bone, RootMotion::FinalIK::IKSolver* solver, ::Il2CppString*& message, RootMotion::Warning::Logger* logger) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "BoneIsValid", {}, ::il2cpp_utils::ExtractTypes(bone, solver, message, logger)));
...
RootMotion::FinalIK::IKMapping* RootMotion::FinalIK::IKMapping::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IKMapping*>());
}
