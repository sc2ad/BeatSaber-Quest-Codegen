...
void RootMotion::FinalIK::Constraints::Initiate(UnityEngine::Transform* transform) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Initiate", {}, ::il2cpp_utils::ExtractTypes(transform)));
...
RootMotion::FinalIK::Constraints* RootMotion::FinalIK::Constraints::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Constraints*>());
}
