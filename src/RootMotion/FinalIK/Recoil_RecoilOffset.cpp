...
void RootMotion::FinalIK::Recoil::RecoilOffset::Apply(RootMotion::FinalIK::IKSolverFullBodyBiped* solver, UnityEngine::Quaternion rotation, float masterWeight, float length, float timeLeft) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Apply", {}, ::il2cpp_utils::ExtractTypes(solver, rotation, masterWeight, length, timeLeft)));
...
RootMotion::FinalIK::Recoil::RecoilOffset* RootMotion::FinalIK::Recoil::RecoilOffset::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Recoil::RecoilOffset*>());
}
