...
RootMotion::FinalIK::IKSolver::UpdateDelegate* RootMotion::FinalIK::IKSolver::UpdateDelegate::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IKSolver::UpdateDelegate*>(object, method));
}
