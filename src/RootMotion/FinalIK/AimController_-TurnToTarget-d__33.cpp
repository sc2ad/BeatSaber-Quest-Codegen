...
RootMotion::FinalIK::AimController::$TurnToTarget$d__33* RootMotion::FinalIK::AimController::$TurnToTarget$d__33::New_ctor(int $$1__state) {
  return (AimController::$TurnToTarget$d__33*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "AimController/<TurnToTarget>d__33", $$1__state));
}
...
::CsObject* RootMotion::FinalIK::AimController::$TurnToTarget$d__33::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* RootMotion::FinalIK::AimController::$TurnToTarget$d__33::System_Collections_IEnumerator_get_Current() {
