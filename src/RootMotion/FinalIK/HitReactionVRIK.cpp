...
void RootMotion::FinalIK::HitReactionVRIK::Hit(UnityEngine::Collider* collider, UnityEngine::Vector3 force, UnityEngine::Vector3 point) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Hit", {}, ::il2cpp_utils::ExtractTypes(collider, force, point)));
...
RootMotion::FinalIK::HitReactionVRIK* RootMotion::FinalIK::HitReactionVRIK::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<HitReactionVRIK*>());
}
