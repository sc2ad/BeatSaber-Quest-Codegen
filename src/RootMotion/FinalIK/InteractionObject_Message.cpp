...
void RootMotion::FinalIK::InteractionObject::Message::Send(UnityEngine::Transform* t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Send", {}, ::il2cpp_utils::ExtractTypes(t)));
...
RootMotion::FinalIK::InteractionObject::Message* RootMotion::FinalIK::InteractionObject::Message::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("Message").WithContext(".ctor");
