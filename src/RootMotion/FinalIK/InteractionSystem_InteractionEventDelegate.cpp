...
RootMotion::FinalIK::InteractionSystem::InteractionEventDelegate* RootMotion::FinalIK::InteractionSystem::InteractionEventDelegate::New_ctor(::CsObject* object, System::IntPtr method) {
  return (InteractionSystem::InteractionEventDelegate*)THROW_UNLESS(il2cpp_utils::New("RootMotion.FinalIK", "InteractionSystem/InteractionEventDelegate", object, method));
}
