...
RootMotion::BakerHumanoidQT* RootMotion::BakerHumanoidQT::New_ctor(::CsString* name) {
  return (BakerHumanoidQT*)THROW_UNLESS(il2cpp_utils::New("RootMotion", "BakerHumanoidQT", name));
}
// Autogenerated method: RootMotion.BakerHumanoidQT..ctor
RootMotion::BakerHumanoidQT* RootMotion::BakerHumanoidQT::New_ctor(UnityEngine::Transform* transform, UnityEngine::AvatarIKGoal goal, ::CsString* name) {
