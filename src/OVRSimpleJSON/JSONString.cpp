...
OVRSimpleJSON::JSONString* OVRSimpleJSON::JSONString::New_ctor(::CsString* aData) {
...
::CsString* OVRSimpleJSON::JSONString::get_Value() {
...
void OVRSimpleJSON::JSONString::set_Value(::CsString* value) {
...
bool OVRSimpleJSON::JSONString::Equals(::CsObject* obj) {
