...
::Il2CppString* OVRSimpleJSON::JSONNode::ToString(int aIndent) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "ToString", aIndent));
}
...
System::Collections::Generic::IEnumerable_1<System::Collections::Generic::KeyValuePair_2<::Il2CppString*, OVRSimpleJSON::JSONNode*>>* OVRSimpleJSON::JSONNode::get_Linq() {
  return THROW_UNLESS((il2cpp_utils::RunMethod<System::Collections::Generic::IEnumerable_1<System::Collections::Generic::KeyValuePair_2<::Il2CppString*, OVRSimpleJSON::JSONNode*>>*>(this, "get_Linq")));
}
...
::Il2CppString* OVRSimpleJSON::JSONNode::Escape(::Il2CppString* aText) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("OVRSimpleJSON", "JSONNode", "Escape", aText));
}
