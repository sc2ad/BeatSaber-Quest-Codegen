...
// Autogenerated method: OVRSimpleJSON.JSONBool..ctor
OVRSimpleJSON::JSONBool* OVRSimpleJSON::JSONBool::New_ctor(::CsString* aData) {
  return (JSONBool*)THROW_UNLESS(il2cpp_utils::New("OVRSimpleJSON", "JSONBool", aData));
}
...
bool OVRSimpleJSON::JSONBool::Equals(::CsObject* obj) {
