...
OVRSimpleJSON::JSONNode* OVRSimpleJSON::JSONObject::get_Item(::CsString* aKey) {
...
void OVRSimpleJSON::JSONObject::set_Item(::CsString* aKey, OVRSimpleJSON::JSONNode* value) {
...
void OVRSimpleJSON::JSONObject::Add(::CsString* aKey, OVRSimpleJSON::JSONNode* aItem) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Add", aKey, aItem));
}
// Autogenerated method: OVRSimpleJSON.JSONObject.Remove
OVRSimpleJSON::JSONNode* OVRSimpleJSON::JSONObject::Remove(::CsString* aKey) {
