...
// Autogenerated method: OVRSimpleJSON.JSONNode/Enumerator..ctor
OVRSimpleJSON::JSONNode::Enumerator* OVRSimpleJSON::JSONNode::Enumerator::New_ctor(typename System::Collections::Generic::Dictionary_2<::Il2CppString*, OVRSimpleJSON::JSONNode*>::Enumerator aDictEnum) {
