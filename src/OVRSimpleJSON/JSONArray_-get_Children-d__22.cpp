...
OVRSimpleJSON::JSONArray::$get_Children$d__22* OVRSimpleJSON::JSONArray::$get_Children$d__22::New_ctor(int $$1__state) {
  return (JSONArray::$get_Children$d__22*)THROW_UNLESS(il2cpp_utils::New("OVRSimpleJSON", "JSONArray/<get_Children>d__22", $$1__state));
}
...
::CsObject* OVRSimpleJSON::JSONArray::$get_Children$d__22::System_Collections_IEnumerator_get_Current() {
