...
OVRSimpleJSON::JSONNode* OVRSimpleJSON::JSON::Parse(::Il2CppString* aJSON) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("OVRSimpleJSON", "JSON", il2cpp_utils::NoArgClass<OVRSimpleJSON::JSONNode*>(), "Parse", {}, ::il2cpp_utils::ExtractTypes(aJSON)));
