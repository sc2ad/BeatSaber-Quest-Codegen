...
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator..ctor
OVRSimpleJSON::JSONLazyCreator* OVRSimpleJSON::JSONLazyCreator::New_ctor(OVRSimpleJSON::JSONNode* aNode, ::CsString* aKey) {
...
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator.get_Item
OVRSimpleJSON::JSONNode* OVRSimpleJSON::JSONLazyCreator::get_Item(::CsString* aKey) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<OVRSimpleJSON::JSONNode*>(this, "get_Item", aKey));
}
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator.set_Item
void OVRSimpleJSON::JSONLazyCreator::set_Item(::CsString* aKey, OVRSimpleJSON::JSONNode* value) {
...
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator.Add
void OVRSimpleJSON::JSONLazyCreator::Add(::CsString* aKey, OVRSimpleJSON::JSONNode* aItem) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Add", aKey, aItem));
}
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator.Equals
bool OVRSimpleJSON::JSONLazyCreator::Equals(::CsObject* obj) {
...
bool OVRSimpleJSON::operator ==(OVRSimpleJSON::JSONLazyCreator* a, ::CsObject& b) {
