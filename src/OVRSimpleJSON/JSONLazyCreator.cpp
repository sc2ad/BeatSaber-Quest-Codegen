...
OVRSimpleJSON::JSONLazyCreator* OVRSimpleJSON::JSONLazyCreator::New_ctor(OVRSimpleJSON::JSONNode* aNode) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<JSONLazyCreator*>(aNode));
}
// Autogenerated method: OVRSimpleJSON.JSONLazyCreator..ctor
OVRSimpleJSON::JSONLazyCreator* OVRSimpleJSON::JSONLazyCreator::New_ctor(OVRSimpleJSON::JSONNode* aNode, ::Il2CppString* aKey) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVRSimpleJSON").WithContext("JSONLazyCreator").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<JSONLazyCreator*>(aNode, aKey));
}
...
bool OVRSimpleJSON::operator ==(OVRSimpleJSON::JSONLazyCreator* a, ::Il2CppObject& b) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("OVRSimpleJSON", "JSONLazyCreator", il2cpp_utils::NoArgClass<bool>(), "op_Equality", {}, ::il2cpp_utils::ExtractTypes(a, &b)));
...
bool OVRSimpleJSON::operator !=(OVRSimpleJSON::JSONLazyCreator* a, ::Il2CppObject& b) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("OVRSimpleJSON", "JSONLazyCreator", il2cpp_utils::NoArgClass<bool>(), "op_Inequality", {}, ::il2cpp_utils::ExtractTypes(a, &b)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, a, &b);
}
