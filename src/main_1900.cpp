...
void GlobalNamespace::BloomFogSO::SetParams(float attenuation, float offset, float heightFogStartY, float heightFogHeight, float brightness, float autoExposureIntensity, float noteSpawnIntensity) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::SetParams");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "SetParams", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(attenuation), ::il2cpp_utils::ExtractType(offset), ::il2cpp_utils::ExtractType(heightFogStartY), ::il2cpp_utils::ExtractType(heightFogHeight), ::il2cpp_utils::ExtractType(brightness), ::il2cpp_utils::ExtractType(autoExposureIntensity), ::il2cpp_utils::ExtractType(noteSpawnIntensity)})));
  ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, attenuation, offset, heightFogStartY, heightFogHeight, brightness, autoExposureIntensity, noteSpawnIntensity);
}
