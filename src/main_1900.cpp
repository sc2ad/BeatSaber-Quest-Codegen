...
int GlobalNamespace::PyramidBloomRendererSO::_get__brightnessID() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::PyramidBloomRendererSO::_get__brightnessID");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<int>("", "PyramidBloomRendererSO", "_brightnessID"));
}
// Autogenerated static field setter
// Set static field: static private readonly System.Int32 _brightnessID
void GlobalNamespace::PyramidBloomRendererSO::_set__brightnessID(int value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::PyramidBloomRendererSO::_set__brightnessID");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "PyramidBloomRendererSO", "_brightnessID", value));
}
...
int GlobalNamespace::PyramidBloomRendererSO::_get__autoExposureIntensityID() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::PyramidBloomRendererSO::_get__autoExposureIntensityID");
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<int>("", "PyramidBloomRendererSO", "_autoExposureIntensityID"));
}
// Autogenerated static field setter
// Set static field: static private readonly System.Int32 _autoExposureIntensityID
void GlobalNamespace::PyramidBloomRendererSO::_set__autoExposureIntensityID(int value) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::PyramidBloomRendererSO::_set__autoExposureIntensityID");
  THROW_UNLESS(il2cpp_utils::SetFieldValue("", "PyramidBloomRendererSO", "_autoExposureIntensityID", value));
}
...
// Autogenerated method: PyramidBloomRendererSO.RenderBloom
void GlobalNamespace::PyramidBloomRendererSO::RenderBloom(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest, float radius, float intensity, float fogBrightness, float autoExposureIntensity, float downIntensityOffset, bool uniformPyramidWeights, bool downsampleOnFirstPass, float pyramidWeightsParam, float alphaWeights, float firstUpsampleBrightness, float finalUpsampleBrightness, ::GlobalNamespace::PyramidBloomRendererSO::Pass preFilterPass, ::GlobalNamespace::PyramidBloomRendererSO::Pass downsamplePass, ::GlobalNamespace::PyramidBloomRendererSO::Pass upsamplePass, ::GlobalNamespace::PyramidBloomRendererSO::Pass finalUpsamplePass) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::PyramidBloomRendererSO::RenderBloom");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "RenderBloom", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(src), ::il2cpp_utils::ExtractType(dest), ::il2cpp_utils::ExtractType(radius), ::il2cpp_utils::ExtractType(intensity), ::il2cpp_utils::ExtractType(fogBrightness), ::il2cpp_utils::ExtractType(autoExposureIntensity), ::il2cpp_utils::ExtractType(downIntensityOffset), ::il2cpp_utils::ExtractType(uniformPyramidWeights), ::il2cpp_utils::ExtractType(downsampleOnFirstPass), ::il2cpp_utils::ExtractType(pyramidWeightsParam), ::il2cpp_utils::ExtractType(alphaWeights), ::il2cpp_utils::ExtractType(firstUpsampleBrightness), ::il2cpp_utils::ExtractType(finalUpsampleBrightness), ::il2cpp_utils::ExtractType(preFilterPass), ::il2cpp_utils::ExtractType(downsamplePass), ::il2cpp_utils::ExtractType(upsamplePass), ::il2cpp_utils::ExtractType(finalUpsamplePass)})));
  ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, src, dest, radius, intensity, fogBrightness, autoExposureIntensity, downIntensityOffset, uniformPyramidWeights, downsampleOnFirstPass, pyramidWeightsParam, alphaWeights, firstUpsampleBrightness, finalUpsampleBrightness, preFilterPass, downsamplePass, upsamplePass, finalUpsamplePass);
}
...
[[deprecated("Use field access instead!")]] float& GlobalNamespace::BloomFogEnvironmentParams::dyn_brightness() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogEnvironmentParams::dyn_brightness");
  auto ___internal__instance = this;
  static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "brightness"))->offset;
  return *reinterpret_cast<float*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
}
// Autogenerated instance field getter
// Get instance field: public System.Single autoExposureIntensity
[[deprecated("Use field access instead!")]] float& GlobalNamespace::BloomFogEnvironmentParams::dyn_autoExposureIntensity() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogEnvironmentParams::dyn_autoExposureIntensity");
  auto ___internal__instance = this;
  static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "autoExposureIntensity"))->offset;
  return *reinterpret_cast<float*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
...
[[deprecated("Use field access instead!")]] float& GlobalNamespace::BloomFogSO::dyn__brightness() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::dyn__brightness");
  auto ___internal__instance = this;
  static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_brightness"))->offset;
  return *reinterpret_cast<float*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
}
// Autogenerated instance field getter
// Get instance field: private System.Single _autoExposureIntensity
[[deprecated("Use field access instead!")]] float& GlobalNamespace::BloomFogSO::dyn__autoExposureIntensity() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::dyn__autoExposureIntensity");
  auto ___internal__instance = this;
  static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_autoExposureIntensity"))->offset;
  return *reinterpret_cast<float*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
}
// Autogenerated instance field getter
...
// Autogenerated method: BloomFogSO.get_brightness
float GlobalNamespace::BloomFogSO::get_brightness() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::get_brightness");
...
// Autogenerated method: BloomFogSO.get_autoExposureIntensity
float GlobalNamespace::BloomFogSO::get_autoExposureIntensity() {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::get_autoExposureIntensity");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "get_autoExposureIntensity", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
  return ::il2cpp_utils::RunMethodRethrow<float, false>(this, ___internal__method);
}
...
void GlobalNamespace::BloomFogSO::SetParams(float attenuation, float offset, float heightFogStartY, float heightFogHeight, float brightness, float autoExposureIntensity) {
  static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BloomFogSO::SetParams");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "SetParams", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(attenuation), ::il2cpp_utils::ExtractType(offset), ::il2cpp_utils::ExtractType(heightFogStartY), ::il2cpp_utils::ExtractType(heightFogHeight), ::il2cpp_utils::ExtractType(brightness), ::il2cpp_utils::ExtractType(autoExposureIntensity)})));
  ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, attenuation, offset, heightFogStartY, heightFogHeight, brightness, autoExposureIntensity);
}
...
#include "beatsaber-hook/shared/utils/utils.h"
// Completed includes
// [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10E52E4
// Autogenerated static field getter
// Get static field: static private readonly System.Int32 _worldSpaceCameraPosID
...
#include "beatsaber-hook/shared/utils/utils.h"
// Completed includes
// [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10E5C94
// Autogenerated static field getter
