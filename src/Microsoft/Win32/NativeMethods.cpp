...
bool Microsoft::Win32::NativeMethods::DuplicateHandle(System::Runtime::InteropServices::HandleRef hSourceProcessHandle, System::Runtime::InteropServices::SafeHandle* hSourceHandle, System::Runtime::InteropServices::HandleRef hTargetProcess, Microsoft::Win32::SafeHandles::SafeWaitHandle*& targetHandle, int dwDesiredAccess, bool bInheritHandle, int dwOptions) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<bool>(), "DuplicateHandle", {}, ::il2cpp_utils::ExtractTypes(hSourceProcessHandle, hSourceHandle, hTargetProcess, targetHandle, dwDesiredAccess, bInheritHandle, dwOptions)));
...
System::IntPtr Microsoft::Win32::NativeMethods::GetCurrentProcess() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<System::IntPtr>(), "GetCurrentProcess", {}, ::il2cpp_utils::ExtractTypes()));
...
bool Microsoft::Win32::NativeMethods::GetExitCodeProcess(System::IntPtr processHandle, int& exitCode) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<bool>(), "GetExitCodeProcess", {}, ::il2cpp_utils::ExtractTypes(processHandle, exitCode)));
...
bool Microsoft::Win32::NativeMethods::TerminateProcess(System::IntPtr processHandle, int exitCode) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<bool>(), "TerminateProcess", {}, ::il2cpp_utils::ExtractTypes(processHandle, exitCode)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, processHandle, exitCode);
}
// Autogenerated method: Microsoft.Win32.NativeMethods.TerminateProcess
...
bool Microsoft::Win32::NativeMethods::GetProcessTimes(System::IntPtr handle, int64_t& creation, int64_t& exit, int64_t& kernel, int64_t& user) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<bool>(), "GetProcessTimes", {}, ::il2cpp_utils::ExtractTypes(handle, creation, exit, kernel, user)));
...
int Microsoft::Win32::NativeMethods::GetCurrentProcessId() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<int>(), "GetCurrentProcessId", {}, ::il2cpp_utils::ExtractTypes()));
...
bool Microsoft::Win32::NativeMethods::CloseProcess(System::IntPtr handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "NativeMethods", il2cpp_utils::NoArgClass<bool>(), "CloseProcess", {}, ::il2cpp_utils::ExtractTypes(handle)));
