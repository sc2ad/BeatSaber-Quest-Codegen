...
Microsoft::Win32::RegistryValueOptions Microsoft::Win32::RegistryValueOptions::_get_None() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32").WithContext("RegistryValueOptions").WithContext("_get_None");
...
void Microsoft::Win32::RegistryValueOptions::_set_None(Microsoft::Win32::RegistryValueOptions value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32").WithContext("RegistryValueOptions").WithContext("_set_None");
...
Microsoft::Win32::RegistryValueOptions Microsoft::Win32::RegistryValueOptions::_get_DoNotExpandEnvironmentNames() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32").WithContext("RegistryValueOptions").WithContext("_get_DoNotExpandEnvironmentNames");
...
void Microsoft::Win32::RegistryValueOptions::_set_DoNotExpandEnvironmentNames(Microsoft::Win32::RegistryValueOptions value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32").WithContext("RegistryValueOptions").WithContext("_set_DoNotExpandEnvironmentNames");
