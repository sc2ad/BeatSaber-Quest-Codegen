...
int Microsoft::Win32::Win32RegistryApi::RegCloseKey(System::IntPtr keyHandle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegCloseKey", {}, ::il2cpp_utils::ExtractTypes(keyHandle)));
...
int Microsoft::Win32::Win32RegistryApi::RegFlushKey(System::IntPtr keyHandle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegFlushKey", {}, ::il2cpp_utils::ExtractTypes(keyHandle)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, keyHandle);
}
...
int Microsoft::Win32::Win32RegistryApi::RegOpenKeyEx(System::IntPtr keyBase, ::Il2CppString* keyName, System::IntPtr reserved, int access, System::IntPtr& keyHandle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegOpenKeyEx", {}, ::il2cpp_utils::ExtractTypes(keyBase, keyName, reserved, access, keyHandle)));
...
int Microsoft::Win32::Win32RegistryApi::RegEnumKeyEx(System::IntPtr keyHandle, int dwIndex, ::Il2CppChar* lpName, int& lpcbName, ::Array<int>* lpReserved, System::Text::StringBuilder*& lpClass, ::Array<int>* lpcbClass, ::Array<int64_t>* lpftLastWriteTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegEnumKeyEx", {}, ::il2cpp_utils::ExtractTypes(keyHandle, dwIndex, lpName, lpcbName, lpReserved, lpClass, lpcbClass, lpftLastWriteTime)));
...
int Microsoft::Win32::Win32RegistryApi::RegQueryValueEx(System::IntPtr keyBase, ::Il2CppString* valueName, System::IntPtr reserved, Microsoft::Win32::RegistryValueKind& type, System::IntPtr zero, int& dataSize) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegQueryValueEx", {}, ::il2cpp_utils::ExtractTypes(keyBase, valueName, reserved, type, zero, dataSize)));
...
int Microsoft::Win32::Win32RegistryApi::RegQueryValueEx(System::IntPtr keyBase, ::Il2CppString* valueName, System::IntPtr reserved, Microsoft::Win32::RegistryValueKind& type, ::Array<uint8_t>*& data, int& dataSize) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32").WithContext("Win32RegistryApi").WithContext("RegQueryValueEx");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegQueryValueEx", {}, ::il2cpp_utils::ExtractTypes(keyBase, valueName, reserved, type, data, dataSize)));
...
int Microsoft::Win32::Win32RegistryApi::RegQueryInfoKey(System::IntPtr hKey, System::Text::StringBuilder*& lpClass, ::Array<int>* lpcbClass, System::IntPtr lpReserved_MustBeZero, int& lpcSubKeys, ::Array<int>* lpcbMaxSubKeyLen, ::Array<int>* lpcbMaxClassLen, int& lpcValues, ::Array<int>* lpcbMaxValueNameLen, ::Array<int>* lpcbMaxValueLen, ::Array<int>* lpcbSecurityDescriptor, ::Array<int>* lpftLastWriteTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<int>(), "RegQueryInfoKey", {}, ::il2cpp_utils::ExtractTypes(hKey, lpClass, lpcbClass, lpReserved_MustBeZero, lpcSubKeys, lpcbMaxSubKeyLen, lpcbMaxClassLen, lpcValues, lpcbMaxValueNameLen, lpcbMaxValueLen, lpcbSecurityDescriptor, lpftLastWriteTime)));
...
bool Microsoft::Win32::Win32RegistryApi::IsHandleValid(Microsoft::Win32::RegistryKey* key) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<bool>(), "IsHandleValid", {}, ::il2cpp_utils::ExtractTypes(key)));
...
int Microsoft::Win32::Win32RegistryApi::GetBinaryValue(Microsoft::Win32::RegistryKey* rkey, ::Il2CppString* name, Microsoft::Win32::RegistryValueKind type, ::Array<uint8_t>*& data, int size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetBinaryValue", {}, ::il2cpp_utils::ExtractTypes(rkey, name, type, data, size)));
...
int Microsoft::Win32::Win32RegistryApi::SubKeyCount(Microsoft::Win32::RegistryKey* rkey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "SubKeyCount", {}, ::il2cpp_utils::ExtractTypes(rkey)));
...
void Microsoft::Win32::Win32RegistryApi::GenerateException(int errorCode) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "GenerateException", {}, ::il2cpp_utils::ExtractTypes(errorCode)));
...
::Il2CppString* Microsoft::Win32::Win32RegistryApi::CombineName(Microsoft::Win32::RegistryKey* rkey, ::Il2CppString* localName) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32", "Win32RegistryApi", il2cpp_utils::NoArgClass<::Il2CppString*>(), "CombineName", {}, ::il2cpp_utils::ExtractTypes(rkey, localName)));
...
::Il2CppObject* Microsoft::Win32::Win32RegistryApi::GetValue(Microsoft::Win32::RegistryKey* rkey, ::Il2CppString* name, ::Il2CppObject* defaultValue, Microsoft::Win32::RegistryValueOptions options) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppObject*>(), "GetValue", {}, ::il2cpp_utils::ExtractTypes(rkey, name, defaultValue, options)));
...
Microsoft::Win32::Win32RegistryApi* Microsoft::Win32::Win32RegistryApi::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Win32RegistryApi*>());
}
