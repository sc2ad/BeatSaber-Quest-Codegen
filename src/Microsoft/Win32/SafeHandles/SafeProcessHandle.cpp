...
Microsoft::Win32::SafeHandles::SafeProcessHandle* Microsoft::Win32::SafeHandles::SafeProcessHandle::New_ctor(System::IntPtr handle) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SafeProcessHandle*>(handle));
}
...
void Microsoft::Win32::SafeHandles::SafeProcessHandle::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Microsoft.Win32.SafeHandles", "SafeProcessHandle", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
Microsoft::Win32::SafeHandles::SafeProcessHandle* Microsoft::Win32::SafeHandles::SafeProcessHandle::New_ctor(System::IntPtr existingHandle, bool ownsHandle) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Microsoft::Win32::SafeHandles").WithContext("SafeProcessHandle").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SafeProcessHandle*>(existingHandle, ownsHandle));
}
