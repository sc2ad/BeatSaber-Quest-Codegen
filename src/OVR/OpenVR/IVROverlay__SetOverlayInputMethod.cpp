...
OVR::OpenVR::IVROverlay::_SetOverlayInputMethod* OVR::OpenVR::IVROverlay::_SetOverlayInputMethod::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_SetOverlayInputMethod*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_SetOverlayInputMethod", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayInputMethod::BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayInputMethod eInputMethod, System::AsyncCallback* callback, ::CsObject* object) {
