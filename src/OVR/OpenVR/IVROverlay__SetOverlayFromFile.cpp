...
OVR::OpenVR::IVROverlay::_SetOverlayFromFile* OVR::OpenVR::IVROverlay::_SetOverlayFromFile::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_SetOverlayFromFile*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_SetOverlayFromFile", object, method));
}
// Autogenerated method: OVR.OpenVR.IVROverlay/_SetOverlayFromFile.Invoke
OVR::OpenVR::EVROverlayError OVR::OpenVR::IVROverlay::_SetOverlayFromFile::Invoke(uint64_t ulOverlayHandle, ::CsString* pchFilePath) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayFromFile::BeginInvoke(uint64_t ulOverlayHandle, ::CsString* pchFilePath, System::AsyncCallback* callback, ::CsObject* object) {
