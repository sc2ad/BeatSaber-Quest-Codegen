...
OVR::OpenVR::IVRApplications::_LaunchDashboardOverlay* OVR::OpenVR::IVRApplications::_LaunchDashboardOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRApplications::_LaunchDashboardOverlay*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRApplications/_LaunchDashboardOverlay", object, method));
}
// Autogenerated method: OVR.OpenVR.IVRApplications/_LaunchDashboardOverlay.Invoke
OVR::OpenVR::EVRApplicationError OVR::OpenVR::IVRApplications::_LaunchDashboardOverlay::Invoke(::CsString* pchAppKey) {
...
System::IAsyncResult* OVR::OpenVR::IVRApplications::_LaunchDashboardOverlay::BeginInvoke(::CsString* pchAppKey, System::AsyncCallback* callback, ::CsObject* object) {
