...
OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyFilename* OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyFilename::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetScreenshotPropertyFilename").WithContext(".ctor");
