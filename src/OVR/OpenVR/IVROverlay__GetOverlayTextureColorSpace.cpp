...
OVR::OpenVR::IVROverlay::_GetOverlayTextureColorSpace* OVR::OpenVR::IVROverlay::_GetOverlayTextureColorSpace::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_GetOverlayTextureColorSpace::BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace& peTextureColorSpace, System::AsyncCallback* callback, ::CsObject* object) {
