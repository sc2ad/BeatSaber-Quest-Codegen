...
OVR::OpenVR::IVRSystem::_ShouldApplicationPause* OVR::OpenVR::IVRSystem::_ShouldApplicationPause::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_ShouldApplicationPause*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_ShouldApplicationPause", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_ShouldApplicationPause::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
