...
OVR::OpenVR::IVRCompositor::_GetMirrorTextureD3D11* OVR::OpenVR::IVRCompositor::_GetMirrorTextureD3D11::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_GetMirrorTextureD3D11*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_GetMirrorTextureD3D11", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_GetMirrorTextureD3D11::BeginInvoke(OVR::OpenVR::EVREye eEye, System::IntPtr pD3D11DeviceOrResource, System::IntPtr& ppD3D11ShaderResourceView, System::AsyncCallback* callback, ::CsObject* object) {
