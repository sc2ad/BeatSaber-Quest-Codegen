...
OVR::OpenVR::IVRCompositor::_CompositorGoToBack* OVR::OpenVR::IVRCompositor::_CompositorGoToBack::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_CompositorGoToBack*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_CompositorGoToBack", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_CompositorGoToBack::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
