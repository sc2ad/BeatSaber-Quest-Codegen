...
OVR::OpenVR::IVROverlay::_SetOverlayAlpha* OVR::OpenVR::IVROverlay::_SetOverlayAlpha::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayAlpha::BeginInvoke(uint64_t ulOverlayHandle, float fAlpha, System::AsyncCallback* callback, ::CsObject* object) {
