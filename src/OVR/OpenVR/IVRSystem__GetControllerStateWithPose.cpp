...
OVR::OpenVR::IVRSystem::_GetControllerStateWithPose* OVR::OpenVR::IVRSystem::_GetControllerStateWithPose::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetControllerStateWithPose").WithContext(".ctor");
