...
OVR::OpenVR::IVRCompositor::_ShowMirrorWindow* OVR::OpenVR::IVRCompositor::_ShowMirrorWindow::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_ShowMirrorWindow*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_ShowMirrorWindow", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_ShowMirrorWindow::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
