...
OVR::OpenVR::IVROverlay::_DestroyOverlay* OVR::OpenVR::IVROverlay::_DestroyOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_DestroyOverlay::BeginInvoke(uint64_t ulOverlayHandle, System::AsyncCallback* callback, ::CsObject* object) {
