...
OVR::OpenVR::IVRSystem::_ResetSeatedZeroPose* OVR::OpenVR::IVRSystem::_ResetSeatedZeroPose::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_ResetSeatedZeroPose*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_ResetSeatedZeroPose", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_ResetSeatedZeroPose::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
