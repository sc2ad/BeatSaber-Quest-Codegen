...
OVR::OpenVR::IVROverlay::_GetOverlayAlpha* OVR::OpenVR::IVROverlay::_GetOverlayAlpha::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_GetOverlayAlpha*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_GetOverlayAlpha", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_GetOverlayAlpha::BeginInvoke(uint64_t ulOverlayHandle, float& pfAlpha, System::AsyncCallback* callback, ::CsObject* object) {
