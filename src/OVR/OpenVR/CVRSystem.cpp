...
OVR::OpenVR::CVRSystem* OVR::OpenVR::CVRSystem::New_ctor(System::IntPtr pInterface) {
  return (CVRSystem*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "CVRSystem", pInterface));
}
...
::CsString* OVR::OpenVR::CVRSystem::GetPropErrorNameFromEnum(OVR::OpenVR::ETrackedPropertyError error) {
...
::CsString* OVR::OpenVR::CVRSystem::GetEventTypeNameFromEnum(OVR::OpenVR::EVREventType eType) {
...
::CsString* OVR::OpenVR::CVRSystem::GetButtonIdNameFromEnum(OVR::OpenVR::EVRButtonId eButtonId) {
...
::CsString* OVR::OpenVR::CVRSystem::GetControllerAxisTypeNameFromEnum(OVR::OpenVR::EVRControllerAxisType eAxisType) {
...
uint OVR::OpenVR::CVRSystem::DriverDebugRequest(uint unDeviceIndex, ::CsString* pchRequest, System::Text::StringBuilder* pchResponseBuffer, uint unResponseBufferSize) {
