...
OVR::OpenVR::IVRSpatialAnchors::_GetSpatialAnchorPose* OVR::OpenVR::IVRSpatialAnchors::_GetSpatialAnchorPose::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVRSpatialAnchors::_GetSpatialAnchorPose::BeginInvoke(uint unHandle, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, OVR::OpenVR::SpatialAnchorPose_t& pPoseOut, System::AsyncCallback* callback, ::CsObject* object) {
