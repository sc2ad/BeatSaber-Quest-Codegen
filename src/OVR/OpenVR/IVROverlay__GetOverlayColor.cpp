...
OVR::OpenVR::IVROverlay::_GetOverlayColor* OVR::OpenVR::IVROverlay::_GetOverlayColor::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_GetOverlayColor::BeginInvoke(uint64_t ulOverlayHandle, float& pfRed, float& pfGreen, float& pfBlue, System::AsyncCallback* callback, ::CsObject* object) {
