...
OVR::OpenVR::IVRSettings::_GetBool* OVR::OpenVR::IVRSettings::_GetBool::New_ctor(::CsObject* object, System::IntPtr method) {
...
bool OVR::OpenVR::IVRSettings::_GetBool::Invoke(::CsString* pchSection, ::CsString* pchSettingsKey, OVR::OpenVR::EVRSettingsError& peError) {
...
System::IAsyncResult* OVR::OpenVR::IVRSettings::_GetBool::BeginInvoke(::CsString* pchSection, ::CsString* pchSettingsKey, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::CsObject* object) {
