...
OVR::OpenVR::IVROverlay::_SetOverlayNeighbor* OVR::OpenVR::IVROverlay::_SetOverlayNeighbor::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayNeighbor::BeginInvoke(OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom, uint64_t ulTo, System::AsyncCallback* callback, ::CsObject* object) {
