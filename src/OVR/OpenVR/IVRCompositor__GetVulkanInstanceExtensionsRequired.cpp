...
OVR::OpenVR::IVRCompositor::_GetVulkanInstanceExtensionsRequired* OVR::OpenVR::IVRCompositor::_GetVulkanInstanceExtensionsRequired::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_GetVulkanInstanceExtensionsRequired*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_GetVulkanInstanceExtensionsRequired", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_GetVulkanInstanceExtensionsRequired::BeginInvoke(System::Text::StringBuilder* pchValue, uint unBufferSize, System::AsyncCallback* callback, ::CsObject* object) {
