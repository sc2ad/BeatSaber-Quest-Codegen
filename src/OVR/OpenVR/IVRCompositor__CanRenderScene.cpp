...
OVR::OpenVR::IVRCompositor::_CanRenderScene* OVR::OpenVR::IVRCompositor::_CanRenderScene::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_CanRenderScene*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_CanRenderScene", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_CanRenderScene::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
