...
OVR::OpenVR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative* OVR::OpenVR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative::BeginInvoke(uint64_t ulOverlayHandle, uint unTrackedDevice, OVR::OpenVR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::AsyncCallback* callback, ::CsObject* object) {
