...
OVR::OpenVR::IVRSystem::_GetMatrix34TrackedDeviceProperty* OVR::OpenVR::IVRSystem::_GetMatrix34TrackedDeviceProperty::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_GetMatrix34TrackedDeviceProperty*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_GetMatrix34TrackedDeviceProperty", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_GetMatrix34TrackedDeviceProperty::BeginInvoke(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError, System::AsyncCallback* callback, ::CsObject* object) {
