...
OVR::OpenVR::IVRRenderModels::_GetComponentRenderModelName* OVR::OpenVR::IVRRenderModels::_GetComponentRenderModelName::New_ctor(::CsObject* object, System::IntPtr method) {
...
uint OVR::OpenVR::IVRRenderModels::_GetComponentRenderModelName::Invoke(::CsString* pchRenderModelName, ::CsString* pchComponentName, System::Text::StringBuilder* pchComponentRenderModelName, uint unComponentRenderModelNameLen) {
...
System::IAsyncResult* OVR::OpenVR::IVRRenderModels::_GetComponentRenderModelName::BeginInvoke(::CsString* pchRenderModelName, ::CsString* pchComponentName, System::Text::StringBuilder* pchComponentRenderModelName, uint unComponentRenderModelNameLen, System::AsyncCallback* callback, ::CsObject* object) {
