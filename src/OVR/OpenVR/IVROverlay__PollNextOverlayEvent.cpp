...
OVR::OpenVR::IVROverlay::_PollNextOverlayEvent* OVR::OpenVR::IVROverlay::_PollNextOverlayEvent::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_PollNextOverlayEvent").WithContext(".ctor");
