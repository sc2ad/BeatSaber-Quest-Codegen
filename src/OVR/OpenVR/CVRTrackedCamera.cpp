...
OVR::OpenVR::CVRTrackedCamera* OVR::OpenVR::CVRTrackedCamera::New_ctor(System::IntPtr pInterface) {
  return (CVRTrackedCamera*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "CVRTrackedCamera", pInterface));
}
// Autogenerated method: OVR.OpenVR.CVRTrackedCamera.GetCameraErrorNameFromEnum
::CsString* OVR::OpenVR::CVRTrackedCamera::GetCameraErrorNameFromEnum(OVR::OpenVR::EVRTrackedCameraError eCameraError) {
