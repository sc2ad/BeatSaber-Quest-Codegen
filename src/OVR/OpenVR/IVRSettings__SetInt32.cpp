...
OVR::OpenVR::IVRSettings::_SetInt32* OVR::OpenVR::IVRSettings::_SetInt32::New_ctor(::CsObject* object, System::IntPtr method) {
...
void OVR::OpenVR::IVRSettings::_SetInt32::Invoke(::CsString* pchSection, ::CsString* pchSettingsKey, int nValue, OVR::OpenVR::EVRSettingsError& peError) {
...
System::IAsyncResult* OVR::OpenVR::IVRSettings::_SetInt32::BeginInvoke(::CsString* pchSection, ::CsString* pchSettingsKey, int nValue, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::CsObject* object) {
