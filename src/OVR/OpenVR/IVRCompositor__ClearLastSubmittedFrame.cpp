...
OVR::OpenVR::IVRCompositor::_ClearLastSubmittedFrame* OVR::OpenVR::IVRCompositor::_ClearLastSubmittedFrame::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_ClearLastSubmittedFrame*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_ClearLastSubmittedFrame", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_ClearLastSubmittedFrame::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
