...
OVR::OpenVR::IVROverlay::_SetOverlayTextureColorSpace* OVR::OpenVR::IVROverlay::_SetOverlayTextureColorSpace::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayTextureColorSpace::BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace eTextureColorSpace, System::AsyncCallback* callback, ::CsObject* object) {
