...
OVR::OpenVR::IVRRenderModels::_GetComponentState* OVR::OpenVR::IVRRenderModels::_GetComponentState::New_ctor(::CsObject* object, System::IntPtr method) {
...
bool OVR::OpenVR::IVRRenderModels::_GetComponentState::Invoke(::CsString* pchRenderModelName, ::CsString* pchComponentName, OVR::OpenVR::VRControllerState_t& pControllerState, OVR::OpenVR::RenderModel_ControllerMode_State_t& pState, OVR::OpenVR::RenderModel_ComponentState_t& pComponentState) {
...
System::IAsyncResult* OVR::OpenVR::IVRRenderModels::_GetComponentState::BeginInvoke(::CsString* pchRenderModelName, ::CsString* pchComponentName, OVR::OpenVR::VRControllerState_t& pControllerState, OVR::OpenVR::RenderModel_ControllerMode_State_t& pState, OVR::OpenVR::RenderModel_ComponentState_t& pComponentState, System::AsyncCallback* callback, ::CsObject* object) {
