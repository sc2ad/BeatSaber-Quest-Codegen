...
OVR::OpenVR::IVROverlay::_SetOverlayTransformAbsolute* OVR::OpenVR::IVROverlay::_SetOverlayTransformAbsolute::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayTransformAbsolute::BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::ETrackingUniverseOrigin eTrackingOrigin, OVR::OpenVR::HmdMatrix34_t& pmatTrackingOriginToOverlayTransform, System::AsyncCallback* callback, ::CsObject* object) {
