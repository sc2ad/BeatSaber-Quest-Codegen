...
OVR::OpenVR::IVRChaperone::_GetCalibrationState* OVR::OpenVR::IVRChaperone::_GetCalibrationState::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVRChaperone::_GetCalibrationState::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
