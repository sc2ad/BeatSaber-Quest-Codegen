...
OVR::OpenVR::IVRRenderModels::_GetComponentName* OVR::OpenVR::IVRRenderModels::_GetComponentName::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetComponentName").WithContext(".ctor");
