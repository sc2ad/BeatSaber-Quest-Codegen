...
OVR::OpenVR::IVRSystem::_GetControllerState* OVR::OpenVR::IVRSystem::_GetControllerState::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_GetControllerState*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_GetControllerState", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_GetControllerState::BeginInvoke(uint unControllerDeviceIndex, OVR::OpenVR::VRControllerState_t& pControllerState, uint unControllerStateSize, System::AsyncCallback* callback, ::CsObject* object) {
