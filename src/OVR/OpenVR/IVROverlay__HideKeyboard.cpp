...
OVR::OpenVR::IVROverlay::_HideKeyboard* OVR::OpenVR::IVROverlay::_HideKeyboard::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_HideKeyboard*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_HideKeyboard", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_HideKeyboard::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
