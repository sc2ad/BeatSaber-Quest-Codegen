...
OVR::OpenVR::IVROverlay::_GetOverlayFlag* OVR::OpenVR::IVROverlay::_GetOverlayFlag::New_ctor(::Il2CppObject* object, System::IntPtr method) {
...
OVR::OpenVR::EVROverlayError OVR::OpenVR::IVROverlay::_GetOverlayFlag::Invoke(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayFlags eOverlayFlag, bool& pbEnabled) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVROverlayError>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandle, eOverlayFlag, pbEnabled)));
...
OVR::OpenVR::EVROverlayError OVR::OpenVR::IVROverlay::_GetOverlayFlag::EndInvoke(bool& pbEnabled, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVROverlayError>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(pbEnabled, result)));
