...
OVR::OpenVR::IVRSystem::_IsTrackedDeviceConnected* OVR::OpenVR::IVRSystem::_IsTrackedDeviceConnected::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_IsTrackedDeviceConnected*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_IsTrackedDeviceConnected", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_IsTrackedDeviceConnected::BeginInvoke(uint unDeviceIndex, System::AsyncCallback* callback, ::CsObject* object) {
