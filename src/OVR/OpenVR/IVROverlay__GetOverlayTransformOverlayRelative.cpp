...
OVR::OpenVR::IVROverlay::_GetOverlayTransformOverlayRelative* OVR::OpenVR::IVROverlay::_GetOverlayTransformOverlayRelative::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetOverlayTransformOverlayRelative").WithContext(".ctor");
...
OVR::OpenVR::EVROverlayError OVR::OpenVR::IVROverlay::_GetOverlayTransformOverlayRelative::EndInvoke(uint64_t& ulOverlayHandleParent, OVR::OpenVR::HmdMatrix34_t& pmatParentOverlayToOverlayTransform, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVROverlayError>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandleParent, pmatParentOverlayToOverlayTransform, result)));
