...
OVR::OpenVR::IVROverlay::_GetOverlayTextureSize* OVR::OpenVR::IVROverlay::_GetOverlayTextureSize::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_GetOverlayTextureSize::BeginInvoke(uint64_t ulOverlayHandle, uint& pWidth, uint& pHeight, System::AsyncCallback* callback, ::CsObject* object) {
