...
OVR::OpenVR::IVROverlay::_GetOverlayRenderModel* OVR::OpenVR::IVROverlay::_GetOverlayRenderModel::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetOverlayRenderModel").WithContext(".ctor");
