...
OVR::OpenVR::IVRInput::_GetSkeletalActionData* OVR::OpenVR::IVRInput::_GetSkeletalActionData::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetSkeletalActionData").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IVRInput::_GetSkeletalActionData*>(object, method));
}
