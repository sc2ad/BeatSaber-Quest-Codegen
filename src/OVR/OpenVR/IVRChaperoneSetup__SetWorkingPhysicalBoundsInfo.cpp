...
OVR::OpenVR::IVRChaperoneSetup::_SetWorkingPhysicalBoundsInfo* OVR::OpenVR::IVRChaperoneSetup::_SetWorkingPhysicalBoundsInfo::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRChaperoneSetup::_SetWorkingPhysicalBoundsInfo*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRChaperoneSetup/_SetWorkingPhysicalBoundsInfo", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRChaperoneSetup::_SetWorkingPhysicalBoundsInfo::BeginInvoke(::Array<OVR::OpenVR::HmdQuad_t>*& pQuadsBuffer, uint unQuadsCount, System::AsyncCallback* callback, ::CsObject* object) {
