...
OVR::OpenVR::IVROverlay::_SetGamepadFocusOverlay* OVR::OpenVR::IVROverlay::_SetGamepadFocusOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetGamepadFocusOverlay::BeginInvoke(uint64_t ulNewFocusOverlay, System::AsyncCallback* callback, ::CsObject* object) {
