...
OVR::OpenVR::IVROverlay::_IsActiveDashboardOverlay* OVR::OpenVR::IVROverlay::_IsActiveDashboardOverlay::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_IsActiveDashboardOverlay").WithContext(".ctor");
