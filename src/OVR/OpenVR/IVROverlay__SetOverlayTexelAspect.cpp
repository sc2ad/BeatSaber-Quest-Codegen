...
OVR::OpenVR::IVROverlay::_SetOverlayTexelAspect* OVR::OpenVR::IVROverlay::_SetOverlayTexelAspect::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_SetOverlayTexelAspect*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_SetOverlayTexelAspect", object, method));
}
...
OVR::OpenVR::EVROverlayError OVR::OpenVR::IVROverlay::_SetOverlayTexelAspect::Invoke(uint64_t ulOverlayHandle, float fTexelAspect) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<OVR::OpenVR::EVROverlayError>(this, "Invoke", ulOverlayHandle, fTexelAspect));
}
// Autogenerated method: OVR.OpenVR.IVROverlay/_SetOverlayTexelAspect.BeginInvoke
System::IAsyncResult* OVR::OpenVR::IVROverlay::_SetOverlayTexelAspect::BeginInvoke(uint64_t ulOverlayHandle, float fTexelAspect, System::AsyncCallback* callback, ::CsObject* object) {
