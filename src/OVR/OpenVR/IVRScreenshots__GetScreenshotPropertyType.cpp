...
OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyType* OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyType::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRScreenshots::_GetScreenshotPropertyType*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRScreenshots/_GetScreenshotPropertyType", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRScreenshots::_GetScreenshotPropertyType::BeginInvoke(uint screenshotHandle, OVR::OpenVR::EVRScreenshotError& pError, System::AsyncCallback* callback, ::CsObject* object) {
