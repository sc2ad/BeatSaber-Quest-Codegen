...
OVR::OpenVR::IVROverlay::_HideOverlay* OVR::OpenVR::IVROverlay::_HideOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_HideOverlay*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVROverlay/_HideOverlay", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVROverlay::_HideOverlay::BeginInvoke(uint64_t ulOverlayHandle, System::AsyncCallback* callback, ::CsObject* object) {
