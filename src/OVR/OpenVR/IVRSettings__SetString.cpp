...
OVR::OpenVR::IVRSettings::_SetString* OVR::OpenVR::IVRSettings::_SetString::New_ctor(::CsObject* object, System::IntPtr method) {
...
void OVR::OpenVR::IVRSettings::_SetString::Invoke(::CsString* pchSection, ::CsString* pchSettingsKey, ::CsString* pchValue, OVR::OpenVR::EVRSettingsError& peError) {
...
System::IAsyncResult* OVR::OpenVR::IVRSettings::_SetString::BeginInvoke(::CsString* pchSection, ::CsString* pchSettingsKey, ::CsString* pchValue, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::CsObject* object) {
