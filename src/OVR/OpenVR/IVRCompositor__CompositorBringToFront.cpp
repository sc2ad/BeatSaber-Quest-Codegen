...
OVR::OpenVR::IVRCompositor::_CompositorBringToFront* OVR::OpenVR::IVRCompositor::_CompositorBringToFront::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_CompositorBringToFront*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRCompositor/_CompositorBringToFront", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRCompositor::_CompositorBringToFront::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
