...
OVR::OpenVR::CVRSpatialAnchors* OVR::OpenVR::CVRSpatialAnchors::New_ctor(System::IntPtr pInterface) {
  return (CVRSpatialAnchors*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "CVRSpatialAnchors", pInterface));
}
// Autogenerated method: OVR.OpenVR.CVRSpatialAnchors.CreateSpatialAnchorFromDescriptor
OVR::OpenVR::EVRSpatialAnchorError OVR::OpenVR::CVRSpatialAnchors::CreateSpatialAnchorFromDescriptor(::CsString* pchDescriptor, uint& pHandleOut) {
