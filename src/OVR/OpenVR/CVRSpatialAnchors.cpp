...
OVR::OpenVR::CVRSpatialAnchors* OVR::OpenVR::CVRSpatialAnchors::New_ctor(System::IntPtr pInterface) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("CVRSpatialAnchors").WithContext(".ctor");
...
OVR::OpenVR::EVRSpatialAnchorError OVR::OpenVR::CVRSpatialAnchors::CreateSpatialAnchorFromDescriptor(::Il2CppString* pchDescriptor, uint& pHandleOut) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVRSpatialAnchorError>(), "CreateSpatialAnchorFromDescriptor", {}, ::il2cpp_utils::ExtractTypes(pchDescriptor, pHandleOut)));
...
OVR::OpenVR::EVRSpatialAnchorError OVR::OpenVR::CVRSpatialAnchors::CreateSpatialAnchorFromPose(uint unDeviceIndex, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, OVR::OpenVR::SpatialAnchorPose_t& pPose, uint& pHandleOut) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVRSpatialAnchorError>(), "CreateSpatialAnchorFromPose", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex, eOrigin, pPose, pHandleOut)));
...
OVR::OpenVR::EVRSpatialAnchorError OVR::OpenVR::CVRSpatialAnchors::GetSpatialAnchorPose(uint unHandle, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, OVR::OpenVR::SpatialAnchorPose_t& pPoseOut) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVRSpatialAnchorError>(), "GetSpatialAnchorPose", {}, ::il2cpp_utils::ExtractTypes(unHandle, eOrigin, pPoseOut)));
...
OVR::OpenVR::EVRSpatialAnchorError OVR::OpenVR::CVRSpatialAnchors::GetSpatialAnchorDescriptor(uint unHandle, System::Text::StringBuilder* pchDescriptorOut, uint& punDescriptorBufferLenInOut) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<OVR::OpenVR::EVRSpatialAnchorError>(), "GetSpatialAnchorDescriptor", {}, ::il2cpp_utils::ExtractTypes(unHandle, pchDescriptorOut, punDescriptorBufferLenInOut)));
