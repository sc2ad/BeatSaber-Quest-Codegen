...
OVR::OpenVR::IVRSystem::_GetBoolTrackedDeviceProperty* OVR::OpenVR::IVRSystem::_GetBoolTrackedDeviceProperty::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_GetBoolTrackedDeviceProperty*)THROW_UNLESS(il2cpp_utils::New("OVR.OpenVR", "IVRSystem/_GetBoolTrackedDeviceProperty", object, method));
}
...
System::IAsyncResult* OVR::OpenVR::IVRSystem::_GetBoolTrackedDeviceProperty::BeginInvoke(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError, System::AsyncCallback* callback, ::CsObject* object) {
