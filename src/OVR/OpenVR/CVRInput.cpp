...
OVR::OpenVR::EVRInputError OVR::OpenVR::CVRInput::SetActionManifestPath(::CsString* pchActionManifestPath) {
...
OVR::OpenVR::EVRInputError OVR::OpenVR::CVRInput::GetActionSetHandle(::CsString* pchActionSetName, uint64_t& pHandle) {
...
OVR::OpenVR::EVRInputError OVR::OpenVR::CVRInput::GetActionHandle(::CsString* pchActionName, uint64_t& pHandle) {
...
OVR::OpenVR::EVRInputError OVR::OpenVR::CVRInput::GetInputSourceHandle(::CsString* pchInputSourcePath, uint64_t& pHandle) {
