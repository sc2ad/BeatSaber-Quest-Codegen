...
OVR::OpenVR::IVRInput::_GetActionHandle* OVR::OpenVR::IVRInput::_GetActionHandle::New_ctor(::CsObject* object, System::IntPtr method) {
...
OVR::OpenVR::EVRInputError OVR::OpenVR::IVRInput::_GetActionHandle::Invoke(::CsString* pchActionName, uint64_t& pHandle) {
...
System::IAsyncResult* OVR::OpenVR::IVRInput::_GetActionHandle::BeginInvoke(::CsString* pchActionName, uint64_t& pHandle, System::AsyncCallback* callback, ::CsObject* object) {
