...
OVR::OpenVR::IVRTrackedCamera::_ReleaseVideoStreamTextureGL* OVR::OpenVR::IVRTrackedCamera::_ReleaseVideoStreamTextureGL::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* OVR::OpenVR::IVRTrackedCamera::_ReleaseVideoStreamTextureGL::BeginInvoke(uint64_t hTrackedCamera, uint glTextureId, System::AsyncCallback* callback, ::CsObject* object) {
