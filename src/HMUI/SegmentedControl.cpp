...
void HMUI::SegmentedControl::add_didSelectCellEvent(System::Action_2<HMUI::SegmentedControl*, int>* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "add_didSelectCellEvent", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(value)));
...
void HMUI::SegmentedControl::remove_didSelectCellEvent(System::Action_2<HMUI::SegmentedControl*, int>* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "remove_didSelectCellEvent", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
void HMUI::SegmentedControl::CreateCells() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "CreateCells", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
...
void HMUI::SegmentedControl::SetCallbackForCell(int cellNumber, System::Action_1<int>* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "SetCallbackForCell", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(cellNumber, callback)));
...
void HMUI::SegmentedControl::SelectCellWithNumber(int selectCellNumber) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "SelectCellWithNumber", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(selectCellNumber)));
