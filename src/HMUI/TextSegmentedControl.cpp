...
void HMUI::TextSegmentedControl::SetTexts(System::Collections::Generic::IReadOnlyList_1<::Il2CppString*>* texts) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetTexts", {}, ::il2cpp_utils::ExtractTypes(texts)));
...
HMUI::TextSegmentedControlCell* HMUI::TextSegmentedControl::InstantiateCell(UnityEngine::Object* prefab) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<HMUI::TextSegmentedControlCell*>(), "InstantiateCell", {}, ::il2cpp_utils::ExtractTypes(prefab)));
...
HMUI::TextSegmentedControl* HMUI::TextSegmentedControl::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("TextSegmentedControl").WithContext(".ctor");
