...
::CsString* HMUI::TableCell::get_reuseIdentifier() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_reuseIdentifier"));
}
// Autogenerated method: HMUI.TableCell.set_reuseIdentifier
void HMUI::TableCell::set_reuseIdentifier(::CsString* value) {
