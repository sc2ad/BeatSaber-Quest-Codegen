...
void HMUI::ScrollViewItemsVisibilityController::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("HMUI", "ScrollViewItemsVisibilityController/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
float HMUI::ScrollViewItemsVisibilityController::$$c::$Start$b__11_0(System::Tuple_2<HMUI::ScrollViewItemForVisibilityController*, float>* item) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "<Start>b__11_0", {}, ::il2cpp_utils::ExtractTypes(item))));
...
float HMUI::ScrollViewItemsVisibilityController::$$c::$Start$b__11_1(System::Tuple_2<HMUI::ScrollViewItemForVisibilityController*, float>* item) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "<Start>b__11_1", {}, ::il2cpp_utils::ExtractTypes(item))));
  return ::il2cpp_utils::RunMethodThrow<float, false>(this, ___internal__method, item);
}
...
HMUI::ScrollViewItemsVisibilityController::$$c* HMUI::ScrollViewItemsVisibilityController::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ScrollViewItemsVisibilityController::$$c*>());
}
