...
UnityEngine::Vector3 HMUI::NavigationController::PositionVector(float pos) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "PositionVector", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(pos)));
...
void HMUI::NavigationController::SetupViewControllerRect(HMUI::ViewController* viewController) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "SetupViewControllerRect", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(viewController)));
...
::Array<float>* HMUI::NavigationController::GetNewPositionsForViewControllers(System::Collections::Generic::List_1<HMUI::ViewController*>* viewControllers, System::Collections::Generic::HashSet_1<HMUI::ViewController*>* fixedViewControllers, float fixedEndPos) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "GetNewPositionsForViewControllers", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(viewControllers, fixedViewControllers, fixedEndPos)));
