...
void HMUI::CircleTouchable::DrawGizmoCircle(UnityEngine::Vector3 center, float radius, int steps) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "DrawGizmoCircle", {}, ::il2cpp_utils::ExtractTypes(center, radius, steps)));
...
bool HMUI::CircleTouchable::Raycast(UnityEngine::Vector2 sp, UnityEngine::Camera* eventCamera) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "Raycast", {}, ::il2cpp_utils::ExtractTypes(sp, eventCamera)));
...
HMUI::CircleTouchable* HMUI::CircleTouchable::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("CircleTouchable").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CircleTouchable*>());
}
