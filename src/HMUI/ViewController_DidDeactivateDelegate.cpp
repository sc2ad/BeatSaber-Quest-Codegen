...
HMUI::ViewController::DidDeactivateDelegate* HMUI::ViewController::DidDeactivateDelegate::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* HMUI::ViewController::DidDeactivateDelegate::BeginInvoke(HMUI::ViewController::DeactivationType deactivationType, System::AsyncCallback* callback, ::CsObject* object) {
