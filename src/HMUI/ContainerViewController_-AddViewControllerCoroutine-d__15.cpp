...
HMUI::ContainerViewController::$AddViewControllerCoroutine$d__15* HMUI::ContainerViewController::$AddViewControllerCoroutine$d__15::New_ctor(int $$1__state) {
  return (ContainerViewController::$AddViewControllerCoroutine$d__15*)THROW_UNLESS(il2cpp_utils::New("HMUI", "ContainerViewController/<AddViewControllerCoroutine>d__15", $$1__state));
}
...
::CsObject* HMUI::ContainerViewController::$AddViewControllerCoroutine$d__15::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* HMUI::ContainerViewController::$AddViewControllerCoroutine$d__15::System_Collections_IEnumerator_get_Current() {
