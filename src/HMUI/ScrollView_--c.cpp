...
System::Func_2<float, float>* HMUI::ScrollView::$$c::_get_$$9__25_1() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c").WithContext("_get_$$9__25_1");
...
void HMUI::ScrollView::$$c::_set_$$9__25_1(System::Func_2<float, float>* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c").WithContext("_set_$$9__25_1");
...
void HMUI::ScrollView::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("HMUI", "ScrollView/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: HMUI.ScrollView/<>c.<Awake>b__25_1
float HMUI::ScrollView::$$c::$Awake$b__25_1(float i) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c").WithContext("<Awake>b__25_1");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "<Awake>b__25_1", {}, ::il2cpp_utils::ExtractTypes(i))));
