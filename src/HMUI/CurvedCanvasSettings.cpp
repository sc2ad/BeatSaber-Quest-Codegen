...
void HMUI::CurvedCanvasSettings::SetRadius(float value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetRadius", {}, ::il2cpp_utils::ExtractTypes(value)));
...
UnityEngine::Vector3 HMUI::CurvedCanvasSettings::TransformPointFromCanvasTo3D(UnityEngine::Vector2 point) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "TransformPointFromCanvasTo3D", {}, ::il2cpp_utils::ExtractTypes(point)));
...
void HMUI::CurvedCanvasSettings::RebuildAndSetup(UnityEngine::Transform* t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("HMUI", "CurvedCanvasSettings", il2cpp_utils::NoArgClass<void>(), "RebuildAndSetup", {}, ::il2cpp_utils::ExtractTypes(t)));
