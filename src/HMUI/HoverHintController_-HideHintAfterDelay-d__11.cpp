...
HMUI::HoverHintController::$HideHintAfterDelay$d__11* HMUI::HoverHintController::$HideHintAfterDelay$d__11::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$HideHintAfterDelay$d__11").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<HoverHintController::$HideHintAfterDelay$d__11*>($$1__state));
}
