...
HMUI::Screen::$TransitionCoroutine$d__5* HMUI::Screen::$TransitionCoroutine$d__5::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext(".ctor");
...
void HMUI::Screen::$TransitionCoroutine$d__5::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext("System.IDisposable.Dispose");
...
bool HMUI::Screen::$TransitionCoroutine$d__5::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext("MoveNext");
...
::Il2CppObject* HMUI::Screen::$TransitionCoroutine$d__5::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void HMUI::Screen::$TransitionCoroutine$d__5::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* HMUI::Screen::$TransitionCoroutine$d__5::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$TransitionCoroutine$d__5").WithContext("System.Collections.IEnumerator.get_Current");
