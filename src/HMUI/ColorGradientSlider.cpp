...
void HMUI::ColorGradientSlider::SetColors(UnityEngine::Color color0, UnityEngine::Color color1) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetColors", {}, ::il2cpp_utils::ExtractTypes(color0, color1)));
...
void HMUI::ColorGradientSlider::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("HMUI", "ColorGradientSlider", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
