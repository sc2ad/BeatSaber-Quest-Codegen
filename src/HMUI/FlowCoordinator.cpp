...
void HMUI::FlowCoordinator::set_title(::CsString* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_title", value));
}
// Autogenerated method: HMUI.FlowCoordinator.get_title
::CsString* HMUI::FlowCoordinator::get_title() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_title"));
}
...
void HMUI::FlowCoordinator::PresentTitle(::CsString* title, bool immediately) {
...
void HMUI::FlowCoordinator::Log(::CsString* message) {
