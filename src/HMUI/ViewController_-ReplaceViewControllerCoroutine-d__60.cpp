...
// Completed includes
// Autogenerated method: HMUI.ViewController/<ReplaceViewControllerCoroutine>d__60..ctor
HMUI::ViewController::$ReplaceViewControllerCoroutine$d__60* HMUI::ViewController::$ReplaceViewControllerCoroutine$d__60::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$ReplaceViewControllerCoroutine$d__60").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ViewController::$ReplaceViewControllerCoroutine$d__60*>($$1__state));
}
