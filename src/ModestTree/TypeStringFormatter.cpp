...
::Il2CppString* ModestTree::TypeStringFormatter::PrettyName(System::Type* type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "TypeStringFormatter", il2cpp_utils::NoArgClass<::Il2CppString*>(), "PrettyName", {}, ::il2cpp_utils::ExtractTypes(type)));
...
::Il2CppString* ModestTree::TypeStringFormatter::PrettyNameInternal(System::Type* type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "TypeStringFormatter", il2cpp_utils::NoArgClass<::Il2CppString*>(), "PrettyNameInternal", {}, ::il2cpp_utils::ExtractTypes(type)));
  return ::il2cpp_utils::RunMethodThrow<::Il2CppString*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, type);
}
...
::Il2CppString* ModestTree::TypeStringFormatter::GetCSharpTypeName(::Il2CppString* typeName) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "TypeStringFormatter", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetCSharpTypeName", {}, ::il2cpp_utils::ExtractTypes(typeName)));
...
void ModestTree::TypeStringFormatter::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "TypeStringFormatter", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
