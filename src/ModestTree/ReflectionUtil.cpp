...
System::Array* ModestTree::ReflectionUtil::CreateArray(System::Type* elementType, System::Collections::Generic::List_1<::Il2CppObject*>* instances) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "ReflectionUtil", il2cpp_utils::NoArgClass<System::Array*>(), "CreateArray", {}, ::il2cpp_utils::ExtractTypes(elementType, instances)));
...
System::Collections::IList* ModestTree::ReflectionUtil::CreateGenericList(System::Type* elementType, System::Collections::Generic::List_1<::Il2CppObject*>* instances) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "ReflectionUtil", il2cpp_utils::NoArgClass<System::Collections::IList*>(), "CreateGenericList", {}, ::il2cpp_utils::ExtractTypes(elementType, instances)));
...
::Il2CppString* ModestTree::ReflectionUtil::ToDebugString(System::Reflection::MethodInfo* method) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "ReflectionUtil", il2cpp_utils::NoArgClass<::Il2CppString*>(), "ToDebugString", {}, ::il2cpp_utils::ExtractTypes(method)));
...
::Il2CppString* ModestTree::ReflectionUtil::ToDebugString(System::Action* action) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("ReflectionUtil").WithContext("ToDebugString");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "ReflectionUtil", il2cpp_utils::NoArgClass<::Il2CppString*>(), "ToDebugString", {}, ::il2cpp_utils::ExtractTypes(action)));
