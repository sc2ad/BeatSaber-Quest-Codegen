...
::Il2CppString* ModestTree::MiscExtensions::Fmt(::Il2CppString* s, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "MiscExtensions", il2cpp_utils::NoArgClass<::Il2CppString*>(), "Fmt", {}, ::il2cpp_utils::ExtractTypes(s, args)));
...
::Il2CppString* ModestTree::MiscExtensions::Join(System::Collections::Generic::IEnumerable_1<::Il2CppString*>* values, ::Il2CppString* separator) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "MiscExtensions", il2cpp_utils::NoArgClass<::Il2CppString*>(), "Join", {}, ::il2cpp_utils::ExtractTypes(values, separator)));
