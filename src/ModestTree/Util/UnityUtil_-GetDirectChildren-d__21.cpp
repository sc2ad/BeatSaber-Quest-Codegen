...
ModestTree::Util::UnityUtil::$GetDirectChildren$d__21* ModestTree::Util::UnityUtil::$GetDirectChildren$d__21::New_ctor(int $$1__state) {
  return (UnityUtil::$GetDirectChildren$d__21*)THROW_UNLESS(il2cpp_utils::New("ModestTree.Util", "UnityUtil/<GetDirectChildren>d__21", $$1__state));
}
...
::CsObject* ModestTree::Util::UnityUtil::$GetDirectChildren$d__21::System_Collections_IEnumerator_get_Current() {
