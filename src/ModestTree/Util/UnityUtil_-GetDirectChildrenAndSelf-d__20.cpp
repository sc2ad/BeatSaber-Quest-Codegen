...
ModestTree::Util::UnityUtil::$GetDirectChildrenAndSelf$d__20* ModestTree::Util::UnityUtil::$GetDirectChildrenAndSelf$d__20::New_ctor(int $$1__state) {
  return (UnityUtil::$GetDirectChildrenAndSelf$d__20*)THROW_UNLESS(il2cpp_utils::New("ModestTree.Util", "UnityUtil/<GetDirectChildrenAndSelf>d__20", $$1__state));
}
...
::CsObject* ModestTree::Util::UnityUtil::$GetDirectChildrenAndSelf$d__20::System_Collections_IEnumerator_get_Current() {
