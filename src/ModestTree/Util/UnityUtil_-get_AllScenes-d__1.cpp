...
ModestTree::Util::UnityUtil::$get_AllScenes$d__1* ModestTree::Util::UnityUtil::$get_AllScenes$d__1::New_ctor(int $$1__state) {
  return (UnityUtil::$get_AllScenes$d__1*)THROW_UNLESS(il2cpp_utils::New("ModestTree.Util", "UnityUtil/<get_AllScenes>d__1", $$1__state));
}
...
::CsObject* ModestTree::Util::UnityUtil::$get_AllScenes$d__1::System_Collections_IEnumerator_get_Current() {
