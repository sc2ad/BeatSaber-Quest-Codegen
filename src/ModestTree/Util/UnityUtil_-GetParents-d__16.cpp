...
ModestTree::Util::UnityUtil::$GetParents$d__16* ModestTree::Util::UnityUtil::$GetParents$d__16::New_ctor(int $$1__state) {
  return (UnityUtil::$GetParents$d__16*)THROW_UNLESS(il2cpp_utils::New("ModestTree.Util", "UnityUtil/<GetParents>d__16", $$1__state));
}
...
::CsObject* ModestTree::Util::UnityUtil::$GetParents$d__16::System_Collections_IEnumerator_get_Current() {
