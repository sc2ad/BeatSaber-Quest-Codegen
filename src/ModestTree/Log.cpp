...
void ModestTree::Log::Debug(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "Debug", {}, ::il2cpp_utils::ExtractTypes(message, args)));
...
void ModestTree::Log::Info(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "Info", {}, ::il2cpp_utils::ExtractTypes(message, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, message, args);
}
...
void ModestTree::Log::Warn(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "Warn", {}, ::il2cpp_utils::ExtractTypes(message, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, message, args);
}
...
void ModestTree::Log::Trace(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "Trace", {}, ::il2cpp_utils::ExtractTypes(message, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, message, args);
}
...
void ModestTree::Log::ErrorException(System::Exception* e) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "ErrorException", {}, ::il2cpp_utils::ExtractTypes(e)));
...
void ModestTree::Log::ErrorException(::Il2CppString* message, System::Exception* e) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("Log").WithContext("ErrorException");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "ErrorException", {}, ::il2cpp_utils::ExtractTypes(message, e)));
...
void ModestTree::Log::Error(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("ModestTree", "Log", il2cpp_utils::NoArgClass<void>(), "Error", {}, ::il2cpp_utils::ExtractTypes(message, args)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, message, args);
}
