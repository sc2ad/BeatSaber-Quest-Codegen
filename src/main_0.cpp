...
bool GlobalNamespace::ConnectedPlayerHelpers::IsLeftHanded(GlobalNamespace::IConnectedPlayer* connectedPlayer) {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ConnectedPlayerHelpers::IsLeftHanded");
...
void GlobalNamespace::DiffieHellmanUtility::NoDomainReloadInit() {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::DiffieHellmanUtility::NoDomainReloadInit");
