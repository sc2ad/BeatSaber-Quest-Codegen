...
::StringW& System::Security::Cryptography::RSAPKCS1SignatureDeformatter::dyn_hashName() {
...
::StringW& System::Security::Cryptography::X509Certificates::X509Certificate::dyn_issuer_name() {
...
::StringW& System::Security::Cryptography::X509Certificates::X509Certificate::dyn_subject_name() {
...
Mono::Security::X509::X509Certificate* System::Security::Cryptography::X509Certificates::X509Helper::ImportPkcs12(::ArrayW<uint8_t> rawData, ::StringW password) {
  ...
  return ::il2cpp_utils::RunMethodRethrow<Mono::Security::X509::X509Certificate*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, rawData, password);
}
