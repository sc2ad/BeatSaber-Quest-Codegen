...
::ArrayW<UnityEngine::Timeline::TrackAsset*>& UnityEngine::Timeline::TimelineAsset::dyn_m_CacheOutputTracks() {
...
::ArrayW<UnityEngine::Timeline::TimelineClip*> UnityEngine::Timeline::TrackAsset::get_clips() {
  ...
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<UnityEngine::Timeline::TimelineClip*>, false>(___instance_arg, ___internal__method);
}
