...
void Unity::Collections::LowLevel::Unsafe::UnsafeUtility::Free(void* memory, Unity::Collections::Allocator allocator) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Unity.Collections.LowLevel.Unsafe", "UnsafeUtility", il2cpp_utils::NoArgClass<void>(), "Free", {}, ::il2cpp_utils::ExtractTypes(memory, allocator)));
