...
void Unity::Collections::NativeLeakDetection::Initialize() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Unity.Collections", "NativeLeakDetection", il2cpp_utils::NoArgClass<void>(), "Initialize", {}, ::il2cpp_utils::ExtractTypes()));
