...
::Il2CppString* System::DomainNameHelper::ParseCanonicalName(::Il2CppString* str, int start, int end, bool& loopback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<::Il2CppString*>(), "ParseCanonicalName", {}, ::il2cpp_utils::ExtractTypes(str, start, end, loopback)));
...
bool System::DomainNameHelper::IsValid(::Il2CppChar* name, uint16_t pos, int& returnedEnd, bool& notCanonical, bool notImplicitFile) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<bool>(), "IsValid", {}, ::il2cpp_utils::ExtractTypes(name, pos, returnedEnd, notCanonical, notImplicitFile)));
...
bool System::DomainNameHelper::IsValidByIri(::Il2CppChar* name, uint16_t pos, int& returnedEnd, bool& notCanonical, bool notImplicitFile) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<bool>(), "IsValidByIri", {}, ::il2cpp_utils::ExtractTypes(name, pos, returnedEnd, notCanonical, notImplicitFile)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, name, pos, returnedEnd, notCanonical, notImplicitFile);
}
...
::Il2CppString* System::DomainNameHelper::IdnEquivalent(::Il2CppChar* hostname, int start, int end, bool& allAscii, bool& atLeastOneValidIdn) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<::Il2CppString*>(), "IdnEquivalent", {}, ::il2cpp_utils::ExtractTypes(hostname, start, end, allAscii, atLeastOneValidIdn)));
...
::Il2CppString* System::DomainNameHelper::IdnEquivalent(::Il2CppChar* hostname, int start, int end, bool& allAscii, ::Il2CppString*& bidiStrippedHost) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("DomainNameHelper").WithContext("IdnEquivalent");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<::Il2CppString*>(), "IdnEquivalent", {}, ::il2cpp_utils::ExtractTypes(hostname, start, end, allAscii, bidiStrippedHost)));
...
bool System::DomainNameHelper::IsIdnAce(::Il2CppString* input, int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<bool>(), "IsIdnAce", {}, ::il2cpp_utils::ExtractTypes(input, index)));
...
::Il2CppString* System::DomainNameHelper::UnicodeEquivalent(::Il2CppString* idnHost, ::Il2CppChar* hostname, int start, int end) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<::Il2CppString*>(), "UnicodeEquivalent", {}, ::il2cpp_utils::ExtractTypes(idnHost, hostname, start, end)));
...
::Il2CppString* System::DomainNameHelper::UnicodeEquivalent(::Il2CppChar* hostname, int start, int end, bool& allAscii, bool& atLeastOneValidIdn) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("DomainNameHelper").WithContext("UnicodeEquivalent");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<::Il2CppString*>(), "UnicodeEquivalent", {}, ::il2cpp_utils::ExtractTypes(hostname, start, end, allAscii, atLeastOneValidIdn)));
  return ::il2cpp_utils::RunMethodThrow<::Il2CppString*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, hostname, start, end, allAscii, atLeastOneValidIdn);
}
...
bool System::DomainNameHelper::IsASCIILetterOrDigit(::Il2CppChar character, bool& notCanonical) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<bool>(), "IsASCIILetterOrDigit", {}, ::il2cpp_utils::ExtractTypes(character, notCanonical)));
...
bool System::DomainNameHelper::IsValidDomainLabelCharacter(::Il2CppChar character, bool& notCanonical) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "DomainNameHelper", il2cpp_utils::NoArgClass<bool>(), "IsValidDomainLabelCharacter", {}, ::il2cpp_utils::ExtractTypes(character, notCanonical)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, character, notCanonical);
}
