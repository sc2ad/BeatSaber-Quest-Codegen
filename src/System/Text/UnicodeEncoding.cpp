...
// Autogenerated method: System.Text.UnicodeEncoding.GetByteCount
int System::Text::UnicodeEncoding::GetByteCount(::CsString* s) {
...
int System::Text::UnicodeEncoding::GetBytes(::CsString* s, int charIndex, int charCount, ::Array<uint8_t>* bytes, int byteIndex) {
...
::CsString* System::Text::UnicodeEncoding::GetString(::Array<uint8_t>* bytes, int index, int count) {
...
bool System::Text::UnicodeEncoding::Equals(::CsObject* value) {
