...
System::Text::DecoderReplacementFallback* System::Text::DecoderReplacementFallback::New_ctor(::CsString* replacement) {
...
::CsString* System::Text::DecoderReplacementFallback::get_DefaultString() {
...
bool System::Text::DecoderReplacementFallback::Equals(::CsObject* value) {
