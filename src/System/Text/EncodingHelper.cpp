...
::Il2CppString* System::Text::EncodingHelper::InternalCodePage(int& code_page) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("System.Text", "EncodingHelper", "InternalCodePage", code_page));
}
...
::Il2CppObject* System::Text::EncodingHelper::InvokeI18N(::Il2CppString* name, ::Array<::Il2CppObject*>* args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppObject*>("System.Text", "EncodingHelper", "InvokeI18N", name, args));
}
