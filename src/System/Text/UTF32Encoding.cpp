...
// Autogenerated method: System.Text.UTF32Encoding.GetByteCount
int System::Text::UTF32Encoding::GetByteCount(::CsString* s) {
...
int System::Text::UTF32Encoding::GetBytes(::CsString* s, int charIndex, int charCount, ::Array<uint8_t>* bytes, int byteIndex) {
...
::CsString* System::Text::UTF32Encoding::GetString(::Array<uint8_t>* bytes, int index, int count) {
...
bool System::Text::UTF32Encoding::Equals(::CsObject* value) {
