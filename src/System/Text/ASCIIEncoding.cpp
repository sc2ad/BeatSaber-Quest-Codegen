...
// Autogenerated method: System.Text.ASCIIEncoding.GetByteCount
int System::Text::ASCIIEncoding::GetByteCount(::CsString* chars) {
...
int System::Text::ASCIIEncoding::GetBytes(::CsString* chars, int charIndex, int charCount, ::Array<uint8_t>* bytes, int byteIndex) {
...
::CsString* System::Text::ASCIIEncoding::GetString(::Array<uint8_t>* bytes, int byteIndex, int byteCount) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetString", bytes, byteIndex, byteCount));
}
// Autogenerated method: System.Text.ASCIIEncoding.GetByteCount
