...
::CsString* System::Text::StringBuilderCache::GetStringAndRelease(System::Text::StringBuilder* sb) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Text", "StringBuilderCache", "GetStringAndRelease", sb));
}
