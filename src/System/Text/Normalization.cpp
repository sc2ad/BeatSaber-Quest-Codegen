...
::CsObject* System::Text::Normalization::_get_forLock() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsObject*>("System.Text", "Normalization", "forLock"));
}
// Autogenerated static field setter
// Set static field: static private System.Object forLock
void System::Text::Normalization::_set_forLock(::CsObject* value) {
...
::CsString* System::Text::Normalization::Compose(::CsString* source, int checkType) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Text", "Normalization", "Compose", source, checkType));
}
// Autogenerated method: System.Text.Normalization.Combine
System::Text::StringBuilder* System::Text::Normalization::Combine(::CsString* source, int start, int checkType) {
...
int System::Text::Normalization::CombineHangul(System::Text::StringBuilder* sb, ::CsString* s, int current) {
...
int System::Text::Normalization::Fetch(System::Text::StringBuilder* sb, ::CsString* s, int i) {
...
int System::Text::Normalization::TryComposeWithPreviousStarter(System::Text::StringBuilder* sb, ::CsString* s, int current) {
...
::CsString* System::Text::Normalization::Decompose(::CsString* source, int checkType) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Text", "Normalization", "Decompose", source, checkType));
}
// Autogenerated method: System.Text.Normalization.Decompose
void System::Text::Normalization::Decompose(::CsString* source, System::Text::StringBuilder*& sb, int checkType) {
...
void System::Text::Normalization::ReorderCanonical(::CsString* src, System::Text::StringBuilder*& sb, int start) {
...
void System::Text::Normalization::DecomposeChar(System::Text::StringBuilder*& sb, ::Array<int>*& buf, ::CsString* s, int i, int checkType, int& start) {
...
::CsString* System::Text::Normalization::Normalize(::CsString* source, System::Text::NormalizationForm normalizationForm) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Text", "Normalization", "Normalize", source, normalizationForm));
}
// Autogenerated method: System.Text.Normalization.Normalize
::CsString* System::Text::Normalization::Normalize(::CsString* source, int type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Text", "Normalization", "Normalize", source, type));
}
