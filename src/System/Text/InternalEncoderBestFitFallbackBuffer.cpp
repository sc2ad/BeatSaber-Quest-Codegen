...
::Il2CppObject* System::Text::InternalEncoderBestFitFallbackBuffer::get_InternalSyncObject() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Text", "InternalEncoderBestFitFallbackBuffer", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "get_InternalSyncObject", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Text::InternalEncoderBestFitFallbackBuffer* System::Text::InternalEncoderBestFitFallbackBuffer::New_ctor(System::Text::InternalEncoderBestFitFallback* fallback) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Text").WithContext("InternalEncoderBestFitFallbackBuffer").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<InternalEncoderBestFitFallbackBuffer*>(fallback));
}
...
::Il2CppChar System::Text::InternalEncoderBestFitFallbackBuffer::TryBestFit(::Il2CppChar cUnknown) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppChar>(), "TryBestFit", {}, ::il2cpp_utils::ExtractTypes(cUnknown)));
