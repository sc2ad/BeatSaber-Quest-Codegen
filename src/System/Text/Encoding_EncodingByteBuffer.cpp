...
System::Text::Encoding::EncodingByteBuffer* System::Text::Encoding::EncodingByteBuffer::New_ctor(System::Text::Encoding* inEncoding, System::Text::EncoderNLS* inEncoder, uint8_t* inByteStart, int inByteCount, ::Il2CppChar* inCharStart, int inCharCount) {
  return (Encoding::EncodingByteBuffer*)THROW_UNLESS(il2cpp_utils::New("System.Text", "Encoding/EncodingByteBuffer", inEncoding, inEncoder, inByteStart, inByteCount, inCharStart, inCharCount));
}
