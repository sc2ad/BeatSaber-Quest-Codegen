...
::CsObject* System::Text::RegularExpressions::GroupEnumerator::get_Current() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Current"));
}
::CsObject* System::Text::RegularExpressions::GroupEnumerator::System_Collections_IEnumerator_get_Current() {
  return get_Current();
}
