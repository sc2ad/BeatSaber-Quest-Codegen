...
System::Text::RegularExpressions::RegexTree* System::Text::RegularExpressions::RegexParser::Parse(::CsString* re, System::Text::RegularExpressions::RegexOptions op) {
...
void System::Text::RegularExpressions::RegexParser::SetPattern(::CsString* Re) {
...
::CsString* System::Text::RegularExpressions::RegexParser::ScanCapname() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ScanCapname"));
}
...
::CsString* System::Text::RegularExpressions::RegexParser::ParseProperty() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ParseProperty"));
}
...
void System::Text::RegularExpressions::RegexParser::NoteCaptureName(::CsString* name, int pos) {
...
int System::Text::RegularExpressions::RegexParser::CaptureSlotFromName(::CsString* capname) {
...
bool System::Text::RegularExpressions::RegexParser::IsCaptureName(::CsString* capname) {
...
void System::Text::RegularExpressions::RegexParser::AddUnitSet(::CsString* cc) {
...
System::ArgumentException* System::Text::RegularExpressions::RegexParser::MakeException(::CsString* message) {
