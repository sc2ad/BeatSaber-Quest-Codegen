...
System::Text::RegularExpressions::Match* System::Text::RegularExpressions::Match::New_ctor(System::Text::RegularExpressions::Regex* regex, int capcount, ::CsString* text, int begpos, int len, int startpos) {
...
void System::Text::RegularExpressions::Match::Reset(System::Text::RegularExpressions::Regex* regex, ::CsString* text, int textbeg, int textend, int textstart) {
