...
System::Text::RegularExpressions::Group* System::Text::RegularExpressions::Group::New_ctor(::CsString* text, ::Array<int>* caps, int capcount, ::CsString* name) {
  return (Group*)THROW_UNLESS(il2cpp_utils::New("System.Text.RegularExpressions", "Group", text, caps, capcount, name));
}
...
System::Text::RegularExpressions::Group* System::Text::RegularExpressions::Group::New_ctor() {
  return (Group*)THROW_UNLESS(il2cpp_utils::New("System.Text.RegularExpressions", "Group"));
}
