...
System::Text::RegularExpressions::RegexCode* System::Text::RegularExpressions::RegexWriter::Write(System::Text::RegularExpressions::RegexTree* t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Text.RegularExpressions", "RegexWriter", il2cpp_utils::NoArgClass<System::Text::RegularExpressions::RegexCode*>(), "Write", {}, ::il2cpp_utils::ExtractTypes(t)));
...
int System::Text::RegularExpressions::RegexWriter::CurPos() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "CurPos", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method);
}
...
void System::Text::RegularExpressions::RegexWriter::PatchJump(int Offset, int jumpDest) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "PatchJump", {}, ::il2cpp_utils::ExtractTypes(Offset, jumpDest)));
...
void System::Text::RegularExpressions::RegexWriter::Emit(int op) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Emit", {}, ::il2cpp_utils::ExtractTypes(op)));
...
void System::Text::RegularExpressions::RegexWriter::Emit(int op, int opd1) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Text::RegularExpressions").WithContext("RegexWriter").WithContext("Emit");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Emit", {}, ::il2cpp_utils::ExtractTypes(op, opd1)));
...
void System::Text::RegularExpressions::RegexWriter::Emit(int op, int opd1, int opd2) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Text::RegularExpressions").WithContext("RegexWriter").WithContext("Emit");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Emit", {}, ::il2cpp_utils::ExtractTypes(op, opd1, opd2)));
...
int System::Text::RegularExpressions::RegexWriter::StringCode(::Il2CppString* str) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "StringCode", {}, ::il2cpp_utils::ExtractTypes(str)));
...
int System::Text::RegularExpressions::RegexWriter::MapCapnum(int capnum) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "MapCapnum", {}, ::il2cpp_utils::ExtractTypes(capnum)));
...
System::Text::RegularExpressions::RegexCode* System::Text::RegularExpressions::RegexWriter::RegexCodeFromRegexTree(System::Text::RegularExpressions::RegexTree* tree) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Text::RegularExpressions::RegexCode*>(), "RegexCodeFromRegexTree", {}, ::il2cpp_utils::ExtractTypes(tree)));
...
void System::Text::RegularExpressions::RegexWriter::EmitFragment(int nodetype, System::Text::RegularExpressions::RegexNode* node, int CurIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "EmitFragment", {}, ::il2cpp_utils::ExtractTypes(nodetype, node, CurIndex)));
...
System::Text::RegularExpressions::RegexWriter* System::Text::RegularExpressions::RegexWriter::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<RegexWriter*>());
}
