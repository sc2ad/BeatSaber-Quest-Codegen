...
System::Text::RegularExpressions::RegexPrefix* System::Text::RegularExpressions::RegexPrefix::New_ctor(::CsString* prefix, bool ci) {
  return (RegexPrefix*)THROW_UNLESS(il2cpp_utils::New("System.Text.RegularExpressions", "RegexPrefix", prefix, ci));
}
// Autogenerated method: System.Text.RegularExpressions.RegexPrefix.get_Prefix
::CsString* System::Text::RegularExpressions::RegexPrefix::get_Prefix() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_Prefix"));
}
