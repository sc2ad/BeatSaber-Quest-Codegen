...
System::Text::RegularExpressions::RegexMatchTimeoutException* System::Text::RegularExpressions::RegexMatchTimeoutException::New_ctor(::CsString* regexInput, ::CsString* regexPattern, System::TimeSpan matchTimeout) {
...
void System::Text::RegularExpressions::RegexMatchTimeoutException::Init(::CsString* input, ::CsString* pattern, System::TimeSpan timeout) {
