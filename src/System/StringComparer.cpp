...
int System::StringComparer::Compare(::CsObject* x, ::CsObject* y) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "Compare", x, y));
}
int System::StringComparer::System_Collections_IComparer_Compare(::CsObject* x, ::CsObject* y) {
  return Compare(x, y);
}
// Autogenerated method: System.StringComparer.Equals
bool System::StringComparer::Equals(::CsObject* x, ::CsObject* y) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Equals", x, y));
}
bool System::StringComparer::System_Collections_IEqualityComparer_Equals(::CsObject* x, ::CsObject* y) {
  return Equals(x, y);
}
// Autogenerated method: System.StringComparer.GetHashCode
int System::StringComparer::GetHashCode(::CsObject* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "GetHashCode", obj));
}
int System::StringComparer::System_Collections_IEqualityComparer_GetHashCode(::CsObject* obj) {
  return GetHashCode(obj);
}
// Autogenerated method: System.StringComparer.Compare
int System::StringComparer::Compare(::CsString* x, ::CsString* y) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "Compare", x, y));
}
// Autogenerated method: System.StringComparer.Equals
bool System::StringComparer::Equals(::CsString* x, ::CsString* y) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Equals", x, y));
}
// Autogenerated method: System.StringComparer.GetHashCode
int System::StringComparer::GetHashCode(::CsString* obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "GetHashCode", obj));
}
