...
::CsObject* System::DelegateSerializationHolder::GetRealObject(System::Runtime::Serialization::StreamingContext context) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "GetRealObject", context));
}
::CsObject* System::DelegateSerializationHolder::System_Runtime_Serialization_IObjectReference_GetRealObject(System::Runtime::Serialization::StreamingContext context) {
