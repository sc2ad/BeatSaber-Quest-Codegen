...
int System::Collections::CaseInsensitiveComparer::Compare(::CsObject* a, ::CsObject* b) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "Compare", a, b));
}
int System::Collections::CaseInsensitiveComparer::System_Collections_IComparer_Compare(::CsObject* a, ::CsObject* b) {
  return Compare(a, b);
}
