...
::CsObject* System::Collections::Queue::QueueEnumerator::Clone() {
...
::CsObject* System::Collections::Queue::QueueEnumerator::get_Current() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Current"));
}
::CsObject* System::Collections::Queue::QueueEnumerator::System_Collections_IEnumerator_get_Current() {
  return get_Current();
}
