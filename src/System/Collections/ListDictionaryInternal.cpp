...
System::Collections::ListDictionaryInternal* System::Collections::ListDictionaryInternal::New_ctor() {
  return (ListDictionaryInternal*)THROW_UNLESS(il2cpp_utils::New("System.Collections", "ListDictionaryInternal"));
}
// Autogenerated method: System.Collections.ListDictionaryInternal.get_Item
::CsObject* System::Collections::ListDictionaryInternal::get_Item(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Item", key));
}
::CsObject* System::Collections::ListDictionaryInternal::System_Collections_IDictionary_get_Item(::CsObject* key) {
  return get_Item(key);
}
// Autogenerated method: System.Collections.ListDictionaryInternal.set_Item
void System::Collections::ListDictionaryInternal::set_Item(::CsObject* key, ::CsObject* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_Item", key, value));
}
void System::Collections::ListDictionaryInternal::System_Collections_IDictionary_set_Item(::CsObject* key, ::CsObject* value) {
  set_Item(key, value);
}
...
bool System::Collections::ListDictionaryInternal::Contains(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Contains", key));
}
bool System::Collections::ListDictionaryInternal::System_Collections_IDictionary_Contains(::CsObject* key) {
  return Contains(key);
}
