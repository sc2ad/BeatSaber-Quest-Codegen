...
System::Collections::ListDictionaryInternal::NodeKeyValueCollection* System::Collections::ListDictionaryInternal::NodeKeyValueCollection::New_ctor(System::Collections::ListDictionaryInternal* list, bool isKeys) {
  return (ListDictionaryInternal::NodeKeyValueCollection*)THROW_UNLESS(il2cpp_utils::New("System.Collections", "ListDictionaryInternal/NodeKeyValueCollection", list, isKeys));
}
