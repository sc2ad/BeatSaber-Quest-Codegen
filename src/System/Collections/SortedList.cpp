...
::Array<::CsObject*>* System::Collections::SortedList::_get_emptyArray() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<::CsObject*>*>("System.Collections", "SortedList", "emptyArray"));
}
// Autogenerated static field setter
// Set static field: static private System.Object[] emptyArray
void System::Collections::SortedList::_set_emptyArray(::Array<::CsObject*>* value) {
...
void System::Collections::SortedList::Add(::CsObject* key, ::CsObject* value) {
...
::CsObject* System::Collections::SortedList::GetByIndex(int index) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "GetByIndex", index));
}
// Autogenerated method: System.Collections.SortedList.GetKey
::CsObject* System::Collections::SortedList::GetKey(int index) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "GetKey", index));
}
...
int System::Collections::SortedList::IndexOfKey(::CsObject* key) {
...
void System::Collections::SortedList::Insert(int index, ::CsObject* key, ::CsObject* value) {
...
::CsObject* System::Collections::SortedList::Clone() {
...
bool System::Collections::SortedList::Contains(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Contains", key));
}
bool System::Collections::SortedList::System_Collections_IDictionary_Contains(::CsObject* key) {
  return Contains(key);
}
...
::CsObject* System::Collections::SortedList::get_Item(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Item", key));
}
::CsObject* System::Collections::SortedList::System_Collections_IDictionary_get_Item(::CsObject* key) {
  return get_Item(key);
}
// Autogenerated method: System.Collections.SortedList.set_Item
void System::Collections::SortedList::set_Item(::CsObject* key, ::CsObject* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_Item", key, value));
}
void System::Collections::SortedList::System_Collections_IDictionary_set_Item(::CsObject* key, ::CsObject* value) {
  set_Item(key, value);
}
