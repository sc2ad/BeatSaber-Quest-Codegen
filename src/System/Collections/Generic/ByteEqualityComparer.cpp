...
int System::Collections::Generic::ByteEqualityComparer::GetHashCode(uint8_t b) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetHashCode", {}, ::il2cpp_utils::ExtractTypes(b)));
...
System::Collections::Generic::ByteEqualityComparer* System::Collections::Generic::ByteEqualityComparer::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ByteEqualityComparer*>());
}
