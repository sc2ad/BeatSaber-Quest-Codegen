...
bool System::Collections::IEqualityComparer::System_Collections_IEqualityComparer_Equals(::CsObject* x, ::CsObject* y) {
...
int System::Collections::IEqualityComparer::System_Collections_IEqualityComparer_GetHashCode(::CsObject* obj) {
