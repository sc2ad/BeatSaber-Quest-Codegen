...
int System::Collections::LowLevelComparer::Compare(::CsObject* a, ::CsObject* b) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "Compare", a, b));
}
int System::Collections::LowLevelComparer::System_Collections_IComparer_Compare(::CsObject* a, ::CsObject* b) {
  return Compare(a, b);
}
