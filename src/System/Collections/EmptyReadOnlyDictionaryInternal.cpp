...
::CsObject* System::Collections::EmptyReadOnlyDictionaryInternal::get_Item(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Item", key));
}
::CsObject* System::Collections::EmptyReadOnlyDictionaryInternal::System_Collections_IDictionary_get_Item(::CsObject* key) {
  return get_Item(key);
}
// Autogenerated method: System.Collections.EmptyReadOnlyDictionaryInternal.set_Item
void System::Collections::EmptyReadOnlyDictionaryInternal::set_Item(::CsObject* key, ::CsObject* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_Item", key, value));
}
void System::Collections::EmptyReadOnlyDictionaryInternal::System_Collections_IDictionary_set_Item(::CsObject* key, ::CsObject* value) {
  set_Item(key, value);
}
...
bool System::Collections::EmptyReadOnlyDictionaryInternal::Contains(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Contains", key));
}
bool System::Collections::EmptyReadOnlyDictionaryInternal::System_Collections_IDictionary_Contains(::CsObject* key) {
  return Contains(key);
}
