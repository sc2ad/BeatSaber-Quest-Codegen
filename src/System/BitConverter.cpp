...
::Il2CppChar System::BitConverter::ToChar(::Array<uint8_t>* value, int startIndex) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppChar>("System", "BitConverter", "ToChar", value, startIndex));
}
...
float System::BitConverter::ToSingle(::Array<uint8_t>* value, int startIndex) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<float>("System", "BitConverter", "ToSingle", value, startIndex));
}
// Autogenerated method: System.BitConverter.ToDouble
double System::BitConverter::ToDouble(::Array<uint8_t>* value, int startIndex) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<double>("System", "BitConverter", "ToDouble", value, startIndex));
}
