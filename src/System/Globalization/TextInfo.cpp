...
int System::Globalization::TextInfo::GetHashCodeOrdinalIgnoreCase(::CsString* s) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>("System.Globalization", "TextInfo", "GetHashCodeOrdinalIgnoreCase", s));
}
// Autogenerated method: System.Globalization.TextInfo.GetHashCodeOrdinalIgnoreCase
int System::Globalization::TextInfo::GetHashCodeOrdinalIgnoreCase(::CsString* s, bool forceRandomizedHashing, int64_t additionalEntropy) {
...
int System::Globalization::TextInfo::CompareOrdinalIgnoreCase(::CsString* str1, ::CsString* str2) {
...
int System::Globalization::TextInfo::CompareOrdinalIgnoreCaseEx(::CsString* strA, int indexA, ::CsString* strB, int indexB, int lengthA, int lengthB) {
...
int System::Globalization::TextInfo::IndexOfStringOrdinalIgnoreCase(::CsString* source, ::CsString* value, int startIndex, int count) {
...
int System::Globalization::TextInfo::LastIndexOfStringOrdinalIgnoreCase(::CsString* source, ::CsString* value, int startIndex, int count) {
...
::CsString* System::Globalization::TextInfo::get_CultureName() {
...
// Autogenerated method: System.Globalization.TextInfo.ToLower
::CsString* System::Globalization::TextInfo::ToLower(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ToLower", str));
}
...
// Autogenerated method: System.Globalization.TextInfo.ToUpper
::CsString* System::Globalization::TextInfo::ToUpper(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ToUpper", str));
}
...
int System::Globalization::TextInfo::GetCaseInsensitiveHashCode(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "GetCaseInsensitiveHashCode", str));
}
// Autogenerated method: System.Globalization.TextInfo.GetCaseInsensitiveHashCode
int System::Globalization::TextInfo::GetCaseInsensitiveHashCode(::CsString* str, bool forceRandomizedHashing, int64_t additionalEntropy) {
...
int System::Globalization::TextInfo::GetInvariantCaseInsensitiveHashCode(::CsString* str) {
...
::CsString* System::Globalization::TextInfo::ToUpperInternal(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ToUpperInternal", str));
}
// Autogenerated method: System.Globalization.TextInfo.ToLowerInternal
::CsString* System::Globalization::TextInfo::ToLowerInternal(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ToLowerInternal", str));
}
// Autogenerated method: System.Globalization.TextInfo.ToUpperInternal
...
int System::Globalization::TextInfo::InternalCompareStringOrdinalIgnoreCase(::CsString* strA, int indexA, ::CsString* strB, int indexB, int lenA, int lenB) {
...
::CsString* System::Globalization::TextInfo::ToString() {
...
void System::Globalization::TextInfo::System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::CsObject* sender) {
