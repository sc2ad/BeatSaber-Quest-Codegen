...
::CsString* System::Globalization::HebrewNumber::ToString(int Number) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Globalization", "HebrewNumber", "ToString", Number));
}
