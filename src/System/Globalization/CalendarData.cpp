...
System::Globalization::CalendarData* System::Globalization::CalendarData::New_ctor(::CsString* localeName, int calendarId, bool bUseUserOverrides) {
...
void System::Globalization::CalendarData::InitializeEraNames(::CsString* localeName, int calendarId) {
...
void System::Globalization::CalendarData::InitializeAbbreviatedEraNames(::CsString* localeName, int calendarId) {
...
::CsString* System::Globalization::CalendarData::CalendarIdToCultureName(int calendarId) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Globalization", "CalendarData", "CalendarIdToCultureName", calendarId));
}
...
bool System::Globalization::CalendarData::nativeGetCalendarData(System::Globalization::CalendarData* data, ::CsString* localeName, int calendarId) {
...
bool System::Globalization::CalendarData::fill_calendar_data(::CsString* localeName, int datetimeIndex) {
