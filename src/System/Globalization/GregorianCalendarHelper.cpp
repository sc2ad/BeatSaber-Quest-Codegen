...
int System::Globalization::GregorianCalendarHelper::get_MaxYear() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "get_MaxYear", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Globalization::GregorianCalendarHelper* System::Globalization::GregorianCalendarHelper::New_ctor(System::Globalization::Calendar* cal, ::Array<System::Globalization::EraInfo*>* eraInfo) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<GregorianCalendarHelper*>(cal, eraInfo));
}
...
int System::Globalization::GregorianCalendarHelper::GetGregorianYear(int year, int era) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetGregorianYear", {}, ::il2cpp_utils::ExtractTypes(year, era)));
...
int64_t System::Globalization::GregorianCalendarHelper::GetAbsoluteDate(int year, int month, int day) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Globalization", "GregorianCalendarHelper", il2cpp_utils::NoArgClass<int64_t>(), "GetAbsoluteDate", {}, ::il2cpp_utils::ExtractTypes(year, month, day)));
...
int64_t System::Globalization::GregorianCalendarHelper::DateToTicks(int year, int month, int day) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Globalization", "GregorianCalendarHelper", il2cpp_utils::NoArgClass<int64_t>(), "DateToTicks", {}, ::il2cpp_utils::ExtractTypes(year, month, day)));
  return ::il2cpp_utils::RunMethodThrow<int64_t, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, year, month, day);
}
...
int64_t System::Globalization::GregorianCalendarHelper::TimeToTicks(int hour, int minute, int second, int millisecond) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Globalization", "GregorianCalendarHelper", il2cpp_utils::NoArgClass<int64_t>(), "TimeToTicks", {}, ::il2cpp_utils::ExtractTypes(hour, minute, second, millisecond)));
...
void System::Globalization::GregorianCalendarHelper::CheckTicksRange(int64_t ticks) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "CheckTicksRange", {}, ::il2cpp_utils::ExtractTypes(ticks)));
...
void System::Globalization::GregorianCalendarHelper::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Globalization", "GregorianCalendarHelper", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
