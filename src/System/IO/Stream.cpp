...
System::IAsyncResult* System::IO::Stream::BeginRead(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state) {
...
System::IAsyncResult* System::IO::Stream::BeginReadInternal(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state, bool serializeAsynchronously) {
...
System::IAsyncResult* System::IO::Stream::BeginWrite(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state) {
...
System::IAsyncResult* System::IO::Stream::BeginWriteInternal(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state, bool serializeAsynchronously) {
...
System::IAsyncResult* System::IO::Stream::BlockingBeginRead(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state) {
...
System::IAsyncResult* System::IO::Stream::BlockingBeginWrite(::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback, ::CsObject* state) {
