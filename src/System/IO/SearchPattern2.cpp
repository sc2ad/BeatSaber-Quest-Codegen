...
System::IO::SearchPattern2* System::IO::SearchPattern2::New_ctor(::CsString* pattern) {
  return (SearchPattern2*)THROW_UNLESS(il2cpp_utils::New("System.IO", "SearchPattern2", pattern));
}
// Autogenerated method: System.IO.SearchPattern2..ctor
System::IO::SearchPattern2* System::IO::SearchPattern2::New_ctor(::CsString* pattern, bool ignore) {
...
void System::IO::SearchPattern2::Compile(::CsString* pattern) {
