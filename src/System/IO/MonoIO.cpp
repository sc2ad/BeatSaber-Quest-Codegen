...
// Autogenerated method: System.IO.MonoIO.GetException
System::Exception* System::IO::MonoIO::GetException(::CsString* path, System::IO::MonoIOError error) {
...
// Autogenerated method: System.IO.MonoIO.CreateDirectory
bool System::IO::MonoIO::CreateDirectory(::CsString* path, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System.IO", "MonoIO", "CreateDirectory", path, error));
}
...
// Autogenerated method: System.IO.MonoIO.RemoveDirectory
bool System::IO::MonoIO::RemoveDirectory(::CsString* path, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System.IO", "MonoIO", "RemoveDirectory", path, error));
}
// Autogenerated method: System.IO.MonoIO.GetCurrentDirectory
::CsString* System::IO::MonoIO::GetCurrentDirectory(System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.IO", "MonoIO", "GetCurrentDirectory", error));
}
...
// Autogenerated method: System.IO.MonoIO.DeleteFile
bool System::IO::MonoIO::DeleteFile(::CsString* path, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System.IO", "MonoIO", "DeleteFile", path, error));
}
...
// Autogenerated method: System.IO.MonoIO.ReplaceFile
bool System::IO::MonoIO::ReplaceFile(::CsString* sourceFileName, ::CsString* destinationFileName, ::CsString* destinationBackupFileName, bool ignoreMetadataErrors, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System.IO", "MonoIO", "ReplaceFile", sourceFileName, destinationFileName, destinationBackupFileName, ignoreMetadataErrors, error));
}
...
// Autogenerated method: System.IO.MonoIO.GetFileAttributes
System::IO::FileAttributes System::IO::MonoIO::GetFileAttributes(::CsString* path, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::IO::FileAttributes>("System.IO", "MonoIO", "GetFileAttributes", path, error));
}
...
System::IntPtr System::IO::MonoIO::FindFirstFile(::Il2CppChar* pathWithPattern, ::CsString*& fileName, int& fileAttr, int& error) {
...
// Autogenerated method: System.IO.MonoIO.FindFirstFile
System::IntPtr System::IO::MonoIO::FindFirstFile(::CsString* pathWithPattern, ::CsString*& fileName, int& fileAttr, int& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::IntPtr>("System.IO", "MonoIO", "FindFirstFile", pathWithPattern, fileName, fileAttr, error));
}
// Autogenerated method: System.IO.MonoIO.FindNextFile
bool System::IO::MonoIO::FindNextFile(System::IntPtr hnd, ::CsString*& fileName, int& fileAttr, int& error) {
...
bool System::IO::MonoIO::ExistsFile(::CsString* path, System::IO::MonoIOError& error) {
...
bool System::IO::MonoIO::ExistsDirectory(::CsString* path, System::IO::MonoIOError& error) {
...
bool System::IO::MonoIO::ExistsSymlink(::CsString* path, System::IO::MonoIOError& error) {
...
// Autogenerated method: System.IO.MonoIO.GetFileStat
bool System::IO::MonoIO::GetFileStat(::CsString* path, System::IO::MonoIOStat& stat, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System.IO", "MonoIO", "GetFileStat", path, stat, error));
}
...
// Autogenerated method: System.IO.MonoIO.Open
System::IntPtr System::IO::MonoIO::Open(::CsString* filename, System::IO::FileMode mode, System::IO::FileAccess access, System::IO::FileShare share, System::IO::FileOptions options, System::IO::MonoIOError& error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::IntPtr>("System.IO", "MonoIO", "Open", filename, mode, access, share, options, error));
}
...
bool System::IO::MonoIO::RemapPath(::CsString* path, ::CsString*& newPath) {
