...
::Il2CppString* System::IO::FileSystemWatcher::get_MangledFilter() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "get_MangledFilter"));
}
...
::Il2CppString* System::IO::FileSystemWatcher::get_FullPath() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "get_FullPath"));
}
