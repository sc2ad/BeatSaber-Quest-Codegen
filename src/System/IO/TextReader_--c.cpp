...
::CsString* System::IO::TextReader::$$c::$_cctor$b__22_0(::CsObject* state) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<::CsString*>(this, "<.cctor>b__22_0", state)));
}
// Autogenerated method: System.IO.TextReader/<>c.<.cctor>b__22_1
int System::IO::TextReader::$$c::$_cctor$b__22_1(::CsObject* state) {
