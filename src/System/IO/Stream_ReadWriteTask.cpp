...
System::IO::Stream::ReadWriteTask* System::IO::Stream::ReadWriteTask::New_ctor(bool isRead, System::Func_2<::CsObject*, int>* function, ::CsObject* state, System::IO::Stream* stream, ::Array<uint8_t>* buffer, int offset, int count, System::AsyncCallback* callback) {
...
void System::IO::Stream::ReadWriteTask::InvokeAsyncCallback(::CsObject* completedTask) {
