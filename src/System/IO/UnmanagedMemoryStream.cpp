...
System::IO::UnmanagedMemoryStream* System::IO::UnmanagedMemoryStream::New_ctor(uint8_t* pointer, int64_t length) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::IO").WithContext("UnmanagedMemoryStream").WithContext(".ctor");
...
void System::IO::UnmanagedMemoryStream::Initialize(uint8_t* pointer, int64_t length, int64_t capacity, System::IO::FileAccess access, bool skipSecurityCheck) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Initialize", {}, ::il2cpp_utils::ExtractTypes(pointer, length, capacity, access, skipSecurityCheck)));
...
uint8_t* System::IO::UnmanagedMemoryStream::get_PositionPointer() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<uint8_t*>(), "get_PositionPointer", {}, ::il2cpp_utils::ExtractTypes()));
