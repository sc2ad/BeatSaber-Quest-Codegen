...
System::IO::UnmanagedMemoryStream* System::IO::UnmanagedMemoryStream::New_ctor(uint8_t* pointer, int64_t length) {
  return (UnmanagedMemoryStream*)THROW_UNLESS(il2cpp_utils::New("System.IO", "UnmanagedMemoryStream", pointer, length));
}
// Autogenerated method: System.IO.UnmanagedMemoryStream..ctor
System::IO::UnmanagedMemoryStream* System::IO::UnmanagedMemoryStream::New_ctor(uint8_t* pointer, int64_t length, int64_t capacity, System::IO::FileAccess access, bool skipSecurityCheck) {
  return (UnmanagedMemoryStream*)THROW_UNLESS(il2cpp_utils::New("System.IO", "UnmanagedMemoryStream", pointer, length, capacity, access, skipSecurityCheck));
}
...
System::IO::UnmanagedMemoryStream* System::IO::UnmanagedMemoryStream::New_ctor() {
  return (UnmanagedMemoryStream*)THROW_UNLESS(il2cpp_utils::New("System.IO", "UnmanagedMemoryStream"));
}
