...
System::Net::HttpConnection::InputState System::Net::HttpConnection::InputState::_get_RequestLine() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net").WithContext("InputState").WithContext("_get_RequestLine");
...
void System::Net::HttpConnection::InputState::_set_RequestLine(System::Net::HttpConnection::InputState value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net").WithContext("InputState").WithContext("_set_RequestLine");
...
System::Net::HttpConnection::InputState System::Net::HttpConnection::InputState::_get_Headers() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net").WithContext("InputState").WithContext("_get_Headers");
...
void System::Net::HttpConnection::InputState::_set_Headers(System::Net::HttpConnection::InputState value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net").WithContext("InputState").WithContext("_set_Headers");
