...
bool System::Net::Http::Headers::Parser::TimeSpanSeconds::TryParse(::Il2CppString* input, System::TimeSpan& result) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net::Http::Headers").WithContext("TimeSpanSeconds").WithContext("TryParse");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Net.Http.Headers", "Parser/TimeSpanSeconds", il2cpp_utils::NoArgClass<bool>(), "TryParse", {}, ::il2cpp_utils::ExtractTypes(input, result)));
