...
bool System::Net::Http::Headers::Parser::EmailAddress::TryParse(::Il2CppString* input, ::Il2CppString*& result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Net.Http.Headers", "Parser/EmailAddress", il2cpp_utils::NoArgClass<bool>(), "TryParse", {}, ::il2cpp_utils::ExtractTypes(input, result)));
