...
void System::Net::Http::HttpContent::$LoadIntoBufferAsync$d__17::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net::Http").WithContext("$LoadIntoBufferAsync$d__17").WithContext("MoveNext");
...
void System::Net::Http::HttpContent::$LoadIntoBufferAsync$d__17::SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net::Http").WithContext("$LoadIntoBufferAsync$d__17").WithContext("SetStateMachine");
