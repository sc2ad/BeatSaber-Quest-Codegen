...
System::IAsyncResult* System::Net::Sockets::NetworkStream::BeginRead(::Array<uint8_t>* buffer, int offset, int size, System::AsyncCallback* callback, ::CsObject* state) {
...
System::IAsyncResult* System::Net::Sockets::NetworkStream::BeginWrite(::Array<uint8_t>* buffer, int offset, int size, System::AsyncCallback* callback, ::CsObject* state) {
