...
System::Security::SecurityElement* System::Security::SecurityElement::New_ctor(::CsString* tag) {
  return (SecurityElement*)THROW_UNLESS(il2cpp_utils::New("System.Security", "SecurityElement", tag));
}
// Autogenerated method: System.Security.SecurityElement..ctor
System::Security::SecurityElement* System::Security::SecurityElement::New_ctor(::CsString* tag, ::CsString* text) {
...
::CsString* System::Security::SecurityElement::get_Tag() {
...
::CsString* System::Security::SecurityElement::get_Text() {
...
void System::Security::SecurityElement::set_Text(::CsString* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_Text", value));
}
// Autogenerated method: System.Security.SecurityElement.AddAttribute
void System::Security::SecurityElement::AddAttribute(::CsString* name, ::CsString* value) {
...
::CsString* System::Security::SecurityElement::Escape(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Security", "SecurityElement", "Escape", str));
}
// Autogenerated method: System.Security.SecurityElement.Unescape
::CsString* System::Security::SecurityElement::Unescape(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Security", "SecurityElement", "Unescape", str));
}
// Autogenerated method: System.Security.SecurityElement.FromString
System::Security::SecurityElement* System::Security::SecurityElement::FromString(::CsString* xml) {
...
bool System::Security::SecurityElement::IsValidAttributeName(::CsString* name) {
...
bool System::Security::SecurityElement::IsValidAttributeValue(::CsString* value) {
...
bool System::Security::SecurityElement::IsValidTag(::CsString* tag) {
...
bool System::Security::SecurityElement::IsValidText(::CsString* text) {
...
System::Security::SecurityElement::SecurityAttribute* System::Security::SecurityElement::GetAttribute(::CsString* name) {
...
::CsString* System::Security::SecurityElement::ToString() {
