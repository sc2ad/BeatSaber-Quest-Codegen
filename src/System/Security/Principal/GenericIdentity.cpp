...
System::Security::Principal::GenericIdentity* System::Security::Principal::GenericIdentity::New_ctor(::CsString* name, ::CsString* type) {
...
::CsString* System::Security::Principal::GenericIdentity::get_Name() {
...
::CsString* System::Security::Principal::GenericIdentity::get_AuthenticationType() {
