...
int System::Security::Cryptography::OidCollection::Add(System::Security::Cryptography::Oid* oid) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "Add", {}, ::il2cpp_utils::ExtractTypes(oid)));
...
System::Security::Cryptography::Oid* System::Security::Cryptography::OidCollection::get_Item(int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Security::Cryptography::Oid*>(), "get_Item", {}, ::il2cpp_utils::ExtractTypes(index)));
...
System::Security::Cryptography::OidCollection* System::Security::Cryptography::OidCollection::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<OidCollection*>());
}
