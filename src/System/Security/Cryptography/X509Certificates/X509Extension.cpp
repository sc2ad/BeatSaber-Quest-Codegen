...
::CsString* System::Security::Cryptography::X509Certificates::X509Extension::FormatUnkownData(::Array<uint8_t>* data) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "FormatUnkownData", data));
}
