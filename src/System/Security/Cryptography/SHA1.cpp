...
System::Security::Cryptography::SHA1* System::Security::Cryptography::SHA1::Create() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Security.Cryptography", "SHA1", il2cpp_utils::NoArgClass<System::Security::Cryptography::SHA1*>(), "Create", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Security::Cryptography::SHA1* System::Security::Cryptography::SHA1::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SHA1*>());
}
