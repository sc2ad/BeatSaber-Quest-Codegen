...
int System::Security::Cryptography::KeySizes::get_SkipSize() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "get_SkipSize", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method);
}
...
bool System::Security::Cryptography::KeySizes::IsLegal(int keySize) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "IsLegal", {}, ::il2cpp_utils::ExtractTypes(keySize)));
...
bool System::Security::Cryptography::KeySizes::IsLegalKeySize(::Array<System::Security::Cryptography::KeySizes*>* legalKeys, int size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Security.Cryptography", "KeySizes", il2cpp_utils::NoArgClass<bool>(), "IsLegalKeySize", {}, ::il2cpp_utils::ExtractTypes(legalKeys, size)));
