...
::CsObject* System::Runtime::Serialization::FormatterServices::GetUninitializedObject(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Serialization", "FormatterServices", "GetUninitializedObject", type));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.nativeGetUninitializedObject
::CsObject* System::Runtime::Serialization::FormatterServices::nativeGetUninitializedObject(System::RuntimeType* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Serialization", "FormatterServices", "nativeGetUninitializedObject", type));
}
...
void System::Runtime::Serialization::FormatterServices::SerializationSetValue(System::Reflection::MemberInfo* fi, ::CsObject* target, ::CsObject* value) {
...
::CsObject* System::Runtime::Serialization::FormatterServices::PopulateObjectMembers(::CsObject* obj, ::Array<System::Reflection::MemberInfo*>* members, ::Array<::CsObject*>* data) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Serialization", "FormatterServices", "PopulateObjectMembers", obj, members, data));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.GetObjectData
::Array<::CsObject*>* System::Runtime::Serialization::FormatterServices::GetObjectData(::CsObject* obj, ::Array<System::Reflection::MemberInfo*>* members) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<::CsObject*>*>("System.Runtime.Serialization", "FormatterServices", "GetObjectData", obj, members));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.GetTypeFromAssembly
System::Type* System::Runtime::Serialization::FormatterServices::GetTypeFromAssembly(System::Reflection::Assembly* assem, ::CsString* name) {
...
System::Reflection::Assembly* System::Runtime::Serialization::FormatterServices::LoadAssemblyFromString(::CsString* assemblyName) {
...
System::Reflection::Assembly* System::Runtime::Serialization::FormatterServices::LoadAssemblyFromStringNoThrow(::CsString* assemblyName) {
...
::CsString* System::Runtime::Serialization::FormatterServices::GetClrAssemblyName(System::Type* type, bool& hasTypeForwardedFrom) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Serialization", "FormatterServices", "GetClrAssemblyName", type, hasTypeForwardedFrom));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.GetClrTypeFullName
::CsString* System::Runtime::Serialization::FormatterServices::GetClrTypeFullName(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Serialization", "FormatterServices", "GetClrTypeFullName", type));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.GetClrTypeFullNameForArray
::CsString* System::Runtime::Serialization::FormatterServices::GetClrTypeFullNameForArray(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Serialization", "FormatterServices", "GetClrTypeFullNameForArray", type));
}
// Autogenerated method: System.Runtime.Serialization.FormatterServices.GetClrTypeFullNameForNonArrayTypes
::CsString* System::Runtime::Serialization::FormatterServices::GetClrTypeFullNameForNonArrayTypes(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Serialization", "FormatterServices", "GetClrTypeFullNameForNonArrayTypes", type));
}
