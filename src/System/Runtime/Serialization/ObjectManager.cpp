...
bool System::Runtime::Serialization::ObjectManager::CanCallGetType(::CsObject* obj) {
...
void System::Runtime::Serialization::ObjectManager::set_TopObject(::CsObject* value) {
...
::CsObject* System::Runtime::Serialization::ObjectManager::get_TopObject() {
...
bool System::Runtime::Serialization::ObjectManager::GetCompletionInfo(System::Runtime::Serialization::FixupHolder* fixup, System::Runtime::Serialization::ObjectHolder*& holder, ::CsObject*& member, bool bThrowIfMissing) {
...
bool System::Runtime::Serialization::ObjectManager::DoValueTypeFixup(System::Reflection::FieldInfo* memberToFix, System::Runtime::Serialization::ObjectHolder* holder, ::CsObject* value) {
...
::CsObject* System::Runtime::Serialization::ObjectManager::GetObject(int64_t objectID) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "GetObject", objectID));
}
// Autogenerated method: System.Runtime.Serialization.ObjectManager.RegisterString
void System::Runtime::Serialization::ObjectManager::RegisterString(::CsString* obj, int64_t objectID, System::Runtime::Serialization::SerializationInfo* info, int64_t idOfContainingObj, System::Reflection::MemberInfo* member) {
...
void System::Runtime::Serialization::ObjectManager::RegisterObject(::CsObject* obj, int64_t objectID, System::Runtime::Serialization::SerializationInfo* info, int64_t idOfContainingObj, System::Reflection::MemberInfo* member, ::Array<int>* arrayIndex) {
...
void System::Runtime::Serialization::ObjectManager::CompleteISerializableObject(::CsObject* obj, System::Runtime::Serialization::SerializationInfo* info, System::Runtime::Serialization::StreamingContext context) {
...
void System::Runtime::Serialization::ObjectManager::RecordDelayedFixup(int64_t objectToBeFixed, ::CsString* memberName, int64_t objectRequired) {
...
void System::Runtime::Serialization::ObjectManager::AddOnDeserialized(::CsObject* obj) {
...
void System::Runtime::Serialization::ObjectManager::RaiseOnDeserializedEvent(::CsObject* obj) {
...
void System::Runtime::Serialization::ObjectManager::RaiseOnDeserializingEvent(::CsObject* obj) {
