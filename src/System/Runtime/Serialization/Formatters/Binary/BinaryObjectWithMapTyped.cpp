...
System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped* System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped::New_ctor(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("BinaryObjectWithMapTyped").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<BinaryObjectWithMapTyped*>(binaryHeaderEnum));
}
...
void System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped::Set(int objectId, ::Il2CppString* name, int numMembers, ::Array<::Il2CppString*>* memberNames, ::Array<System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum>* binaryTypeEnumA, ::Array<::Il2CppObject*>* typeInformationA, ::Array<int>* memberAssemIds, int assemId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Set", {}, ::il2cpp_utils::ExtractTypes(objectId, name, numMembers, memberNames, binaryTypeEnumA, typeInformationA, memberAssemIds, assemId)));
...
System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped* System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("BinaryObjectWithMapTyped").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<BinaryObjectWithMapTyped*>());
}
