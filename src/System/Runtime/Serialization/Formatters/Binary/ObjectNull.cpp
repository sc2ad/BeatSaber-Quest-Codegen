...
void System::Runtime::Serialization::Formatters::Binary::ObjectNull::SetNullCount(int nullCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetNullCount", {}, ::il2cpp_utils::ExtractTypes(nullCount)));
...
void System::Runtime::Serialization::Formatters::Binary::ObjectNull::Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input, System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Read", {}, ::il2cpp_utils::ExtractTypes(input, binaryHeaderEnum)));
...
System::Runtime::Serialization::Formatters::Binary::ObjectNull* System::Runtime::Serialization::Formatters::Binary::ObjectNull::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("ObjectNull").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ObjectNull*>());
}
