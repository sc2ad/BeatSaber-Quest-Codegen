...
::CsObject* System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Deserialize(System::IO::Stream* serializationStream) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "Deserialize", serializationStream));
}
// Autogenerated method: System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Deserialize
::CsObject* System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Deserialize(System::IO::Stream* serializationStream, System::Runtime::Remoting::Messaging::HeaderHandler* handler, bool fCheck) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "Deserialize", serializationStream, handler, fCheck));
}
// Autogenerated method: System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Deserialize
::CsObject* System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Deserialize(System::IO::Stream* serializationStream, System::Runtime::Remoting::Messaging::HeaderHandler* handler) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "Deserialize", serializationStream, handler));
}
// Autogenerated method: System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Serialize
void System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Serialize(System::IO::Stream* serializationStream, ::CsObject* graph) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Serialize", serializationStream, graph));
}
// Autogenerated method: System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Serialize
void System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Serialize(System::IO::Stream* serializationStream, ::CsObject* graph, ::Array<System::Runtime::Remoting::Messaging::Header*>* headers) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Serialize", serializationStream, graph, headers));
}
// Autogenerated method: System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Serialize
void System::Runtime::Serialization::Formatters::Binary::BinaryFormatter::Serialize(System::IO::Stream* serializationStream, ::CsObject* graph, ::Array<System::Runtime::Remoting::Messaging::Header*>* headers, bool fCheck) {
