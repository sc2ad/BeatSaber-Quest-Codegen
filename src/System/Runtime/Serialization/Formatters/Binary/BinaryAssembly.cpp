...
void System::Runtime::Serialization::Formatters::Binary::BinaryAssembly::Set(int assemId, ::CsString* assemblyString) {
...
System::Runtime::Serialization::Formatters::Binary::BinaryAssembly* System::Runtime::Serialization::Formatters::Binary::BinaryAssembly::New_ctor() {
  return (BinaryAssembly*)THROW_UNLESS(il2cpp_utils::New("System.Runtime.Serialization.Formatters.Binary", "BinaryAssembly"));
}
