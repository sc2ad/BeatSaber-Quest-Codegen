...
int System::Runtime::Serialization::Formatters::Binary::SerializationHeaderRecord::GetInt32(::Array<uint8_t>* buffer, int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Runtime.Serialization.Formatters.Binary", "SerializationHeaderRecord", il2cpp_utils::NoArgClass<int>(), "GetInt32", {}, ::il2cpp_utils::ExtractTypes(buffer, index)));
