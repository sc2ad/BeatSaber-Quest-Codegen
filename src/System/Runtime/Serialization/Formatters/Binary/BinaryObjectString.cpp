...
void System::Runtime::Serialization::Formatters::Binary::BinaryObjectString::Set(int objectId, ::Il2CppString* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Set", {}, ::il2cpp_utils::ExtractTypes(objectId, value)));
...
System::Runtime::Serialization::Formatters::Binary::BinaryObjectString* System::Runtime::Serialization::Formatters::Binary::BinaryObjectString::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BinaryObjectString*>());
}
