...
System::Runtime::CompilerServices::AsyncMethodBuilderCore::MoveNextRunner* System::Runtime::CompilerServices::AsyncMethodBuilderCore::MoveNextRunner::New_ctor(System::Threading::ExecutionContext* context, System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::CompilerServices").WithContext("MoveNextRunner").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<AsyncMethodBuilderCore::MoveNextRunner*>(context, stateMachine));
}
...
void System::Runtime::CompilerServices::AsyncMethodBuilderCore::MoveNextRunner::InvokeMoveNext(::Il2CppObject* stateMachine) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Runtime.CompilerServices", "AsyncMethodBuilderCore/MoveNextRunner", il2cpp_utils::NoArgClass<void>(), "InvokeMoveNext", {}, ::il2cpp_utils::ExtractTypes(stateMachine)));
