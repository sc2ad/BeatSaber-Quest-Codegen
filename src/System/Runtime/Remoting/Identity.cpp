...
System::Runtime::Remoting::Identity* System::Runtime::Remoting::Identity::New_ctor(::CsString* objectUri) {
...
::CsString* System::Runtime::Remoting::Identity::get_ObjectUri() {
...
void System::Runtime::Remoting::Identity::set_ObjectUri(::CsString* value) {
