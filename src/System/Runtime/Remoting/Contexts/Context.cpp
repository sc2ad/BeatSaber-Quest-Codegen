...
::Array<::CsObject*>* System::Runtime::Remoting::Contexts::Context::_get_local_slots() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<::CsObject*>*>("System.Runtime.Remoting.Contexts", "Context", "local_slots"));
}
// Autogenerated static field setter
// Set static field: static private System.Object[] local_slots
void System::Runtime::Remoting::Contexts::Context::_set_local_slots(::Array<::CsObject*>* value) {
...
bool System::Runtime::Remoting::Contexts::Context::UnregisterDynamicProperty(::CsString* name, System::ContextBoundObject* obj, System::Runtime::Remoting::Contexts::Context* ctx) {
...
System::Runtime::Remoting::Contexts::IContextProperty* System::Runtime::Remoting::Contexts::Context::GetProperty(::CsString* name) {
...
System::LocalDataStoreSlot* System::Runtime::Remoting::Contexts::Context::AllocateNamedDataSlot(::CsString* name) {
...
void System::Runtime::Remoting::Contexts::Context::FreeNamedDataSlot(::CsString* name) {
...
System::LocalDataStoreSlot* System::Runtime::Remoting::Contexts::Context::GetNamedDataSlot(::CsString* name) {
...
::CsObject* System::Runtime::Remoting::Contexts::Context::GetData(System::LocalDataStoreSlot* slot) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Contexts", "Context", "GetData", slot));
}
// Autogenerated method: System.Runtime.Remoting.Contexts.Context.SetData
void System::Runtime::Remoting::Contexts::Context::SetData(System::LocalDataStoreSlot* slot, ::CsObject* data) {
...
::CsString* System::Runtime::Remoting::Contexts::Context::ToString() {
