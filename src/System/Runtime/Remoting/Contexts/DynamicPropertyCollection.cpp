...
bool System::Runtime::Remoting::Contexts::DynamicPropertyCollection::UnregisterDynamicProperty(::CsString* name) {
...
int System::Runtime::Remoting::Contexts::DynamicPropertyCollection::FindProperty(::CsString* name) {
