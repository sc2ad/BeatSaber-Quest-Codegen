...
::CsString* System::Runtime::Remoting::RemotingServices::_get_app_id() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("System.Runtime.Remoting", "RemotingServices", "app_id"));
}
// Autogenerated static field setter
// Set static field: static private System.String app_id
void System::Runtime::Remoting::RemotingServices::_set_app_id(::CsString* value) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::_get_app_id_lock() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "app_id_lock"));
}
// Autogenerated static field setter
// Set static field: static private readonly System.Object app_id_lock
void System::Runtime::Remoting::RemotingServices::_set_app_id_lock(::CsObject* value) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::InternalExecute(System::Reflection::MethodBase* method, ::CsObject* obj, ::Array<::CsObject*>* parameters, ::Array<::CsObject*>*& out_args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "InternalExecute", method, obj, parameters, out_args));
}
...
bool System::Runtime::Remoting::RemotingServices::IsTransparentProxy(::CsObject* proxy) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::Connect(System::Type* classToProxy, ::CsString* url) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "Connect", classToProxy, url));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.Connect
::CsObject* System::Runtime::Remoting::RemotingServices::Connect(System::Type* classToProxy, ::CsString* url, ::CsObject* data) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "Connect", classToProxy, url, data));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.GetServerTypeForUri
System::Type* System::Runtime::Remoting::RemotingServices::GetServerTypeForUri(::CsString* URI) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::Unmarshal(System::Runtime::Remoting::ObjRef* objectRef) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "Unmarshal", objectRef));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.Unmarshal
::CsObject* System::Runtime::Remoting::RemotingServices::Unmarshal(System::Runtime::Remoting::ObjRef* objectRef, bool fRefine) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "Unmarshal", objectRef, fRefine));
}
...
// Autogenerated method: System.Runtime.Remoting.RemotingServices.Marshal
System::Runtime::Remoting::ObjRef* System::Runtime::Remoting::RemotingServices::Marshal(System::MarshalByRefObject* Obj, ::CsString* ObjURI, System::Type* RequestedType) {
...
::CsString* System::Runtime::Remoting::RemotingServices::NewUri() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Remoting", "RemotingServices", "NewUri"));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.GetRealProxy
System::Runtime::Remoting::Proxies::RealProxy* System::Runtime::Remoting::RemotingServices::GetRealProxy(::CsObject* proxy) {
...
System::Reflection::MethodBase* System::Runtime::Remoting::RemotingServices::GetMethodBaseFromName(System::Type* type, ::CsString* methodName, ::Array<System::Type*>* signature) {
...
System::Reflection::MethodBase* System::Runtime::Remoting::RemotingServices::FindInterfaceMethod(System::Type* type, ::CsString* methodName, ::Array<System::Type*>* signature) {
...
void System::Runtime::Remoting::RemotingServices::GetObjectData(::CsObject* obj, System::Runtime::Serialization::SerializationInfo* info, System::Runtime::Serialization::StreamingContext context) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::CreateClientProxy(System::Runtime::Remoting::ActivatedClientTypeEntry* entry, ::Array<::CsObject*>* activationAttributes) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "CreateClientProxy", entry, activationAttributes));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.CreateClientProxy
::CsObject* System::Runtime::Remoting::RemotingServices::CreateClientProxy(System::Type* objectType, ::CsString* url, ::Array<::CsObject*>* activationAttributes) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "CreateClientProxy", objectType, url, activationAttributes));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.CreateClientProxy
::CsObject* System::Runtime::Remoting::RemotingServices::CreateClientProxy(System::Runtime::Remoting::WellKnownClientTypeEntry* entry) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "CreateClientProxy", entry));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.CreateClientProxyForContextBound
::CsObject* System::Runtime::Remoting::RemotingServices::CreateClientProxyForContextBound(System::Type* type, ::Array<::CsObject*>* activationAttributes) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "CreateClientProxyForContextBound", type, activationAttributes));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.GetIdentityForUri
System::Runtime::Remoting::Identity* System::Runtime::Remoting::RemotingServices::GetIdentityForUri(::CsString* uri) {
...
::CsString* System::Runtime::Remoting::RemotingServices::RemoveAppNameFromUri(::CsString* uri) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Remoting", "RemotingServices", "RemoveAppNameFromUri", uri));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.GetOrCreateClientIdentity
System::Runtime::Remoting::ClientIdentity* System::Runtime::Remoting::RemotingServices::GetOrCreateClientIdentity(System::Runtime::Remoting::ObjRef* objRef, System::Type* proxyType, ::CsObject*& clientProxy) {
...
System::Runtime::Remoting::Messaging::IMessageSink* System::Runtime::Remoting::RemotingServices::GetClientChannelSinkChain(::CsString* url, ::CsObject* channelData, ::CsString*& objectUri) {
...
System::Runtime::Remoting::ClientActivatedIdentity* System::Runtime::Remoting::RemotingServices::CreateClientActivatedServerIdentity(System::MarshalByRefObject* realObject, System::Type* objectType, ::CsString* objectUri) {
...
System::Runtime::Remoting::ServerIdentity* System::Runtime::Remoting::RemotingServices::CreateWellKnownServerIdentity(System::Type* objectType, ::CsString* objectUri, System::Runtime::Remoting::WellKnownObjectMode mode) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::GetProxyForRemoteObject(System::Runtime::Remoting::ObjRef* objref, System::Type* classToProxy) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "GetProxyForRemoteObject", objref, classToProxy));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.GetRemoteObject
::CsObject* System::Runtime::Remoting::RemotingServices::GetRemoteObject(System::Runtime::Remoting::ObjRef* objRef, System::Type* proxyType) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "GetRemoteObject", objRef, proxyType));
}
// Autogenerated method: System.Runtime.Remoting.RemotingServices.SerializeCallData
::Array<uint8_t>* System::Runtime::Remoting::RemotingServices::SerializeCallData(::CsObject* obj) {
...
::CsObject* System::Runtime::Remoting::RemotingServices::DeserializeCallData(::Array<uint8_t>* array) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting", "RemotingServices", "DeserializeCallData", array));
}
...
bool System::Runtime::Remoting::RemotingServices::UpdateOutArgObject(System::Reflection::ParameterInfo* pi, ::CsObject* local, ::CsObject* remote) {
...
::CsString* System::Runtime::Remoting::RemotingServices::GetNormalizedUri(::CsString* uri) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Runtime.Remoting", "RemotingServices", "GetNormalizedUri", uri));
}
