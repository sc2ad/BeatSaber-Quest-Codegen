...
System::Runtime::Remoting::Activation::IActivator* System::Runtime::Remoting::Activation::ConstructionLevelActivator::get_NextActivator() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Remoting::Activation").WithContext("ConstructionLevelActivator").WithContext("get_NextActivator");
...
System::Runtime::Remoting::Activation::IConstructionReturnMessage* System::Runtime::Remoting::Activation::ConstructionLevelActivator::Activate(System::Runtime::Remoting::Activation::IConstructionCallMessage* msg) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Remoting::Activation").WithContext("ConstructionLevelActivator").WithContext("Activate");
...
System::Runtime::Remoting::Activation::ConstructionLevelActivator* System::Runtime::Remoting::Activation::ConstructionLevelActivator::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ConstructionLevelActivator*>());
}
