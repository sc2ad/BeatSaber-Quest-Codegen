...
System::Runtime::Remoting::Messaging::ConstructionCall* System::Runtime::Remoting::Activation::ActivationServices::CreateConstructionCall(System::Type* type, ::CsString* activationUrl, ::Array<::CsObject*>* activationAttributes) {
...
::CsObject* System::Runtime::Remoting::Activation::ActivationServices::CreateProxyForType(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Activation", "ActivationServices", "CreateProxyForType", type));
}
// Autogenerated method: System.Runtime.Remoting.Activation.ActivationServices.AllocateUninitializedClassInstance
::CsObject* System::Runtime::Remoting::Activation::ActivationServices::AllocateUninitializedClassInstance(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Activation", "ActivationServices", "AllocateUninitializedClassInstance", type));
}
