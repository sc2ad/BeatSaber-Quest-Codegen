...
System::Runtime::Remoting::Activation::IActivator* System::Runtime::Remoting::Activation::ContextLevelActivator::get_NextActivator() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Remoting::Activation").WithContext("ContextLevelActivator").WithContext("get_NextActivator");
...
System::Runtime::Remoting::Activation::IConstructionReturnMessage* System::Runtime::Remoting::Activation::ContextLevelActivator::Activate(System::Runtime::Remoting::Activation::IConstructionCallMessage* ctorCall) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Remoting::Activation").WithContext("ContextLevelActivator").WithContext("Activate");
