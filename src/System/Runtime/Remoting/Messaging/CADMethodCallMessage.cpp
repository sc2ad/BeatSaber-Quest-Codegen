...
::CsString* System::Runtime::Remoting::Messaging::CADMethodCallMessage::get_Uri() {
...
::Array<::CsObject*>* System::Runtime::Remoting::Messaging::CADMethodCallMessage::GetArgs(System::Collections::ArrayList* args) {
