...
System::Runtime::Remoting::Messaging::AsyncResult* System::Runtime::Remoting::Messaging::AsyncResult::New_ctor(System::Threading::WaitCallback* cb, ::CsObject* state, bool capture_context) {
...
void System::Runtime::Remoting::Messaging::AsyncResult::WaitCallback_Context(::CsObject* state) {
...
::CsObject* System::Runtime::Remoting::Messaging::AsyncResult::get_AsyncDelegate() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_AsyncDelegate"));
}
...
::CsObject* System::Runtime::Remoting::Messaging::AsyncResult::Invoke() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "Invoke"));
}
...
void System::Runtime::Remoting::Messaging::AsyncResult::$_ctor$b__17_0(::CsObject* $p0$) {
...
::CsObject* System::Runtime::Remoting::Messaging::AsyncResult::get_AsyncState() {
