...
void System::Runtime::Remoting::Messaging::StackBuilderSink::ExecuteAsyncMessage(::CsObject* ob) {
...
void System::Runtime::Remoting::Messaging::StackBuilderSink::$AsyncProcessMessage$b__4_0(::CsObject* data) {
