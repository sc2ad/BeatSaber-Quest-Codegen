...
void System::Runtime::Remoting::Messaging::MessageDictionary::set_MethodKeys(::Array<::CsString*>* value) {
...
bool System::Runtime::Remoting::Messaging::MessageDictionary::IsOverridenKey(::CsString* key) {
...
::CsObject* System::Runtime::Remoting::Messaging::MessageDictionary::GetMethodProperty(::CsString* key) {
...
void System::Runtime::Remoting::Messaging::MessageDictionary::SetMethodProperty(::CsString* key, ::CsObject* value) {
...
void System::Runtime::Remoting::Messaging::MessageDictionary::Add(::CsObject* key, ::CsObject* value) {
...
::CsObject* System::Runtime::Remoting::Messaging::MessageDictionary::get_Item(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_Item", key));
}
::CsObject* System::Runtime::Remoting::Messaging::MessageDictionary::System_Collections_IDictionary_get_Item(::CsObject* key) {
  return get_Item(key);
}
// Autogenerated method: System.Runtime.Remoting.Messaging.MessageDictionary.set_Item
void System::Runtime::Remoting::Messaging::MessageDictionary::set_Item(::CsObject* key, ::CsObject* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_Item", key, value));
}
void System::Runtime::Remoting::Messaging::MessageDictionary::System_Collections_IDictionary_set_Item(::CsObject* key, ::CsObject* value) {
  set_Item(key, value);
}
...
bool System::Runtime::Remoting::Messaging::MessageDictionary::Contains(::CsObject* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Contains", key));
}
bool System::Runtime::Remoting::Messaging::MessageDictionary::System_Collections_IDictionary_Contains(::CsObject* key) {
  return Contains(key);
}
