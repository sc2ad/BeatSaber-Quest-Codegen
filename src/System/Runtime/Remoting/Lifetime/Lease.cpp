...
void System::Runtime::Remoting::Lifetime::Lease::ProcessSponsorResponse(::CsObject* state, bool timedOut) {
...
System::Runtime::Remoting::Lifetime::Lease* System::Runtime::Remoting::Lifetime::Lease::New_ctor() {
  return (Lease*)THROW_UNLESS(il2cpp_utils::New("System.Runtime.Remoting.Lifetime", "Lease"));
}
