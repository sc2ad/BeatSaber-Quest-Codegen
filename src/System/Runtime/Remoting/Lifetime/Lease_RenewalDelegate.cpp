...
System::Runtime::Remoting::Lifetime::Lease::RenewalDelegate* System::Runtime::Remoting::Lifetime::Lease::RenewalDelegate::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Remoting::Lifetime").WithContext("RenewalDelegate").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<Lease::RenewalDelegate*>(object, method));
}
...
System::TimeSpan System::Runtime::Remoting::Lifetime::Lease::RenewalDelegate::Invoke(System::Runtime::Remoting::Lifetime::ILease* lease) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::TimeSpan>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(lease)));
...
System::IAsyncResult* System::Runtime::Remoting::Lifetime::Lease::RenewalDelegate::BeginInvoke(System::Runtime::Remoting::Lifetime::ILease* lease, System::AsyncCallback* callback, ::Il2CppObject* object) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::IAsyncResult*>(), "BeginInvoke", {}, ::il2cpp_utils::ExtractTypes(lease, callback, object)));
...
System::TimeSpan System::Runtime::Remoting::Lifetime::Lease::RenewalDelegate::EndInvoke(System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::TimeSpan>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(result)));
