...
System::Runtime::Remoting::ConfigHandler* System::Runtime::Remoting::ConfigHandler::New_ctor(bool onlyDelayedChannels) {
  return (ConfigHandler*)THROW_UNLESS(il2cpp_utils::New("System.Runtime.Remoting", "ConfigHandler", onlyDelayedChannels));
}
// Autogenerated method: System.Runtime.Remoting.ConfigHandler.ValidatePath
void System::Runtime::Remoting::ConfigHandler::ValidatePath(::CsString* element, ::Array<::CsString*>* paths) {
...
bool System::Runtime::Remoting::ConfigHandler::CheckPath(::CsString* path) {
...
void System::Runtime::Remoting::ConfigHandler::ParseElement(::CsString* name, Mono::Xml::SmallXmlParser::IAttrList* attrs) {
...
void System::Runtime::Remoting::ConfigHandler::ReadCustomProviderData(::CsString* name, Mono::Xml::SmallXmlParser::IAttrList* attrs) {
...
System::TimeSpan System::Runtime::Remoting::ConfigHandler::ParseTime(::CsString* s) {
...
System::Runtime::Remoting::ProviderData* System::Runtime::Remoting::ConfigHandler::ReadProvider(::CsString* name, Mono::Xml::SmallXmlParser::IAttrList* attrs, bool isTemplate) {
...
::CsString* System::Runtime::Remoting::ConfigHandler::GetNotNull(Mono::Xml::SmallXmlParser::IAttrList* attrs, ::CsString* name) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetNotNull", attrs, name));
}
// Autogenerated method: System.Runtime.Remoting.ConfigHandler.ExtractAssembly
::CsString* System::Runtime::Remoting::ConfigHandler::ExtractAssembly(::CsString*& type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "ExtractAssembly", type));
}
...
void System::Runtime::Remoting::ConfigHandler::OnProcessingInstruction(::CsString* name, ::CsString* text) {
...
void System::Runtime::Remoting::ConfigHandler::OnIgnorableWhitespace(::CsString* s) {
...
void System::Runtime::Remoting::ConfigHandler::OnStartElement(::CsString* name, Mono::Xml::SmallXmlParser::IAttrList* attrs) {
...
void System::Runtime::Remoting::ConfigHandler::OnEndElement(::CsString* name) {
...
void System::Runtime::Remoting::ConfigHandler::OnChars(::CsString* ch) {
