...
void System::Runtime::Remoting::Channels::CrossAppDomainSink::SendAsyncMessage(::CsObject* data) {
...
void System::Runtime::Remoting::Channels::CrossAppDomainSink::$AsyncProcessMessage$b__10_0(::CsObject* data) {
