...
::CsObject* System::Runtime::Remoting::Channels::CADSerializer::DeserializeObjectSafe(::Array<uint8_t>* mem) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Channels", "CADSerializer", "DeserializeObjectSafe", mem));
}
// Autogenerated method: System.Runtime.Remoting.Channels.CADSerializer.SerializeObject
System::IO::MemoryStream* System::Runtime::Remoting::Channels::CADSerializer::SerializeObject(::CsObject* obj) {
...
::CsObject* System::Runtime::Remoting::Channels::CADSerializer::DeserializeObject(System::IO::MemoryStream* mem) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Channels", "CADSerializer", "DeserializeObject", mem));
}
