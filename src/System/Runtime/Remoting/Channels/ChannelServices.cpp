...
::CsString* System::Runtime::Remoting::Channels::ChannelServices::_get_CrossContextUrl() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("System.Runtime.Remoting.Channels", "ChannelServices", "CrossContextUrl"));
}
// Autogenerated static field setter
// Set static field: static System.String CrossContextUrl
void System::Runtime::Remoting::Channels::ChannelServices::_set_CrossContextUrl(::CsString* value) {
...
System::Runtime::Remoting::Messaging::IMessageSink* System::Runtime::Remoting::Channels::ChannelServices::CreateClientChannelSinkChain(::CsString* url, ::CsObject* remoteChannelData, ::CsString*& objectUri) {
...
// Autogenerated method: System.Runtime.Remoting.Channels.ChannelServices.CreateClientChannelSinkChain
System::Runtime::Remoting::Messaging::IMessageSink* System::Runtime::Remoting::Channels::ChannelServices::CreateClientChannelSinkChain(System::Runtime::Remoting::Channels::IChannelSender* sender, ::CsString* url, ::Array<::CsObject*>* channelDataArray, ::CsString*& objectUri) {
...
::CsObject* System::Runtime::Remoting::Channels::ChannelServices::CreateProvider(System::Runtime::Remoting::ProviderData* prov) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Runtime.Remoting.Channels", "ChannelServices", "CreateProvider", prov));
}
...
::Array<::CsObject*>* System::Runtime::Remoting::Channels::ChannelServices::GetCurrentChannelInfo() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Array<::CsObject*>*>("System.Runtime.Remoting.Channels", "ChannelServices", "GetCurrentChannelInfo"));
}
