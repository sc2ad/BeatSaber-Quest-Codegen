...
void System::WeakReference::AllocateHandle(::CsObject* target) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "AllocateHandle", target));
}
// Autogenerated method: System.WeakReference..ctor
System::WeakReference* System::WeakReference::New_ctor(::CsObject* target) {
  return (WeakReference*)THROW_UNLESS(il2cpp_utils::New("System", "WeakReference", target));
}
// Autogenerated method: System.WeakReference..ctor
System::WeakReference* System::WeakReference::New_ctor(::CsObject* target, bool trackResurrection) {
