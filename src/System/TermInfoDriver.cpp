...
::Il2CppString* System::TermInfoDriver::TryTermInfoDir(::Il2CppString* dir, ::Il2CppString* term) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("System", "TermInfoDriver", "TryTermInfoDir", dir, term));
}
...
::Il2CppString* System::TermInfoDriver::SearchTerminfo(::Il2CppString* term) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("System", "TermInfoDriver", "SearchTerminfo", term));
}
...
::Il2CppObject* System::TermInfoDriver::GetKeyFromBuffer(bool cooked) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppObject*>(this, "GetKeyFromBuffer", cooked));
}
...
::Il2CppString* System::TermInfoDriver::ReadUntilConditionInternal(bool haltOnNewLine) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "ReadUntilConditionInternal", haltOnNewLine));
}
