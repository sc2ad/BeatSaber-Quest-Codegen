...
System::LocalDataStoreElement* System::LocalDataStoreElement::New_ctor(int64_t cookie) {
  return (LocalDataStoreElement*)THROW_UNLESS(il2cpp_utils::New("System", "LocalDataStoreElement", cookie));
}
// Autogenerated method: System.LocalDataStoreElement.get_Value
::CsObject* System::LocalDataStoreElement::get_Value() {
...
void System::LocalDataStoreElement::set_Value(::CsObject* value) {
