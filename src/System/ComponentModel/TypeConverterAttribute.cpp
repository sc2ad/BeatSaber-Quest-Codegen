...
::CsString* System::ComponentModel::TypeConverterAttribute::get_ConverterTypeName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_ConverterTypeName"));
}
...
bool System::ComponentModel::TypeConverterAttribute::Equals(::CsObject* obj) {
