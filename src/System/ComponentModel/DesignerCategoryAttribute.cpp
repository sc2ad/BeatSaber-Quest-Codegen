...
System::ComponentModel::DesignerCategoryAttribute* System::ComponentModel::DesignerCategoryAttribute::New_ctor(::Il2CppString* category) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<DesignerCategoryAttribute*>(category));
}
...
void System::ComponentModel::DesignerCategoryAttribute::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.ComponentModel", "DesignerCategoryAttribute", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
System::ComponentModel::DesignerCategoryAttribute* System::ComponentModel::DesignerCategoryAttribute::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::ComponentModel").WithContext("DesignerCategoryAttribute").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<DesignerCategoryAttribute*>());
}
