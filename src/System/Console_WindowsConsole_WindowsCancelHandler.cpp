...
System::Console::WindowsConsole::WindowsCancelHandler* System::Console::WindowsConsole::WindowsCancelHandler::New_ctor(::CsObject* object, System::IntPtr method) {
  return (Console::WindowsConsole::WindowsCancelHandler*)THROW_UNLESS(il2cpp_utils::New("System", "Console/WindowsConsole/WindowsCancelHandler", object, method));
}
...
System::IAsyncResult* System::Console::WindowsConsole::WindowsCancelHandler::BeginInvoke(int keyCode, System::AsyncCallback* callback, ::CsObject* object) {
