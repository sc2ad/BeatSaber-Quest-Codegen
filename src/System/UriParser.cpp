...
bool System::UriParser::IsWellFormedOriginalString(System::Uri* uri) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "IsWellFormedOriginalString", uri));
}
...
bool System::UriParser::InternalIsWellFormedOriginalString(System::Uri* thisUri) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "InternalIsWellFormedOriginalString", thisUri));
}
