...
::CsString* System::Configuration::ConfigurationSection::SerializeSection(System::Configuration::ConfigurationElement* parentElement, ::CsString* name, System::Configuration::ConfigurationSaveMode saveMode) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "SerializeSection", parentElement, name, saveMode));
}
