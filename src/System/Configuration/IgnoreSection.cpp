...
::CsString* System::Configuration::IgnoreSection::SerializeSection(System::Configuration::ConfigurationElement* parentSection, ::CsString* name, System::Configuration::ConfigurationSaveMode saveMode) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "SerializeSection", parentSection, name, saveMode));
}
