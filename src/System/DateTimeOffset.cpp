...
System::DateTimeOffset* System::DateTimeOffset::New_ctor(int64_t ticks, System::TimeSpan offset) {
  return (DateTimeOffset*)THROW_UNLESS(il2cpp_utils::New("System", "DateTimeOffset", ticks, offset));
}
...
// Autogenerated method: System.DateTimeOffset..ctor
System::DateTimeOffset* System::DateTimeOffset::New_ctor(System::Runtime::Serialization::SerializationInfo* info, System::Runtime::Serialization::StreamingContext context) {
  return (DateTimeOffset*)THROW_UNLESS(il2cpp_utils::New("System", "DateTimeOffset", info, context));
}
...
int System::DateTimeOffset::System_IComparable_CompareTo(::CsObject* obj) {
...
bool System::DateTimeOffset::Equals(::CsObject* obj) {
...
void System::DateTimeOffset::System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::CsObject* sender) {
...
::CsString* System::DateTimeOffset::ToString() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(*this, "ToString"));
}
// Autogenerated method: System.DateTimeOffset.ToString
::CsString* System::DateTimeOffset::ToString(::CsString* format, System::IFormatProvider* formatProvider) {
