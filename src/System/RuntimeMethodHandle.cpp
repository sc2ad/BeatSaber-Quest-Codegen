...
::CsString* System::RuntimeMethodHandle::ConstructInstantiation(System::Reflection::RuntimeMethodInfo* method, System::TypeNameFormatFlags format) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System", "RuntimeMethodHandle", "ConstructInstantiation", method, format));
}
...
bool System::RuntimeMethodHandle::Equals(::CsObject* obj) {
