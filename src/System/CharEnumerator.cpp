...
System::CharEnumerator* System::CharEnumerator::New_ctor(::CsString* str) {
...
::CsObject* System::CharEnumerator::Clone() {
...
::CsObject* System::CharEnumerator::System_Collections_IEnumerator_get_Current() {
