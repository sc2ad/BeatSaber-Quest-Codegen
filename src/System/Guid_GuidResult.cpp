...
void System::Guid::GuidResult::Init(System::Guid::GuidParseThrowStyle canThrow) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(canThrow)));
...
void System::Guid::GuidResult::SetFailure(System::Exception* nativeException) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "SetFailure", {}, ::il2cpp_utils::ExtractTypes(nativeException)));
...
void System::Guid::GuidResult::SetFailure(System::Guid::ParseFailureKind failure, ::Il2CppString* failureMessageID) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("GuidResult").WithContext("SetFailure");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "SetFailure", {}, ::il2cpp_utils::ExtractTypes(failure, failureMessageID)));
...
void System::Guid::GuidResult::SetFailure(System::Guid::ParseFailureKind failure, ::Il2CppString* failureMessageID, ::Il2CppObject* failureMessageFormatArgument, ::Il2CppString* failureArgumentName, System::Exception* innerException) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("GuidResult").WithContext("SetFailure");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<void>(), "SetFailure", {}, ::il2cpp_utils::ExtractTypes(failure, failureMessageID, failureMessageFormatArgument, failureArgumentName, innerException)));
...
System::Exception* System::Guid::GuidResult::GetGuidParseException() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<System::Exception*>(), "GetGuidParseException", {}, ::il2cpp_utils::ExtractTypes()));
