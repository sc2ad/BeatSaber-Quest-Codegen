...
// Autogenerated method: System.Xml.QueryOutputWriter.WriteXmlDeclaration
void System::Xml::QueryOutputWriter::WriteXmlDeclaration(::CsString* xmldecl) {
...
void System::Xml::QueryOutputWriter::WriteDocType(::CsString* name, ::CsString* pubid, ::CsString* sysid, ::CsString* subset) {
...
void System::Xml::QueryOutputWriter::WriteStartElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::QueryOutputWriter::WriteEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::QueryOutputWriter::WriteFullEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::QueryOutputWriter::WriteStartAttribute(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::QueryOutputWriter::WriteNamespaceDeclaration(::CsString* prefix, ::CsString* ns) {
...
void System::Xml::QueryOutputWriter::WriteStartNamespaceDeclaration(::CsString* prefix) {
...
void System::Xml::QueryOutputWriter::WriteCData(::CsString* text) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteCData", text));
}
// Autogenerated method: System.Xml.QueryOutputWriter.WriteComment
void System::Xml::QueryOutputWriter::WriteComment(::CsString* text) {
...
void System::Xml::QueryOutputWriter::WriteProcessingInstruction(::CsString* name, ::CsString* text) {
...
void System::Xml::QueryOutputWriter::WriteWhitespace(::CsString* ws) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteWhitespace", ws));
}
// Autogenerated method: System.Xml.QueryOutputWriter.WriteString
void System::Xml::QueryOutputWriter::WriteString(::CsString* text) {
...
void System::Xml::QueryOutputWriter::WriteEntityRef(::CsString* name) {
...
// Autogenerated method: System.Xml.QueryOutputWriter.WriteRaw
void System::Xml::QueryOutputWriter::WriteRaw(::CsString* data) {
