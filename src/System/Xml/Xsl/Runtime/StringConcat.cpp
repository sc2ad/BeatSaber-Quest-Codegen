...
::CsString* System::Xml::Xsl::Runtime::StringConcat::GetResult() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(*this, "GetResult"));
}
// Autogenerated method: System.Xml.Xsl.Runtime.StringConcat.ConcatNoDelimiter
void System::Xml::Xsl::Runtime::StringConcat::ConcatNoDelimiter(::CsString* s) {
