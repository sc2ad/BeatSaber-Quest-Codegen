...
// Autogenerated method: System.Xml.HtmlUtf8RawTextWriter.WriteXmlDeclaration
void System::Xml::HtmlUtf8RawTextWriter::WriteXmlDeclaration(::CsString* xmldecl) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteDocType(::CsString* name, ::CsString* pubid, ::CsString* sysid, ::CsString* subset) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteStartElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteFullEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteStartAttribute(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteProcessingInstruction(::CsString* target, ::CsString* text) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteString(::CsString* text) {
...
void System::Xml::HtmlUtf8RawTextWriter::WriteEntityRef(::CsString* name) {
