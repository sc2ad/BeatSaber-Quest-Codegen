...
int System::Xml::SecureStringHasher::GetHashCodeOfString(::Il2CppString* key, int sLen, int64_t additionalEntropy) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Xml", "SecureStringHasher", il2cpp_utils::NoArgClass<int>(), "GetHashCodeOfString", {}, ::il2cpp_utils::ExtractTypes(key, sLen, additionalEntropy)));
...
System::Xml::SecureStringHasher::HashCodeOfStringDelegate* System::Xml::SecureStringHasher::GetHashCodeDelegate() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Xml", "SecureStringHasher", il2cpp_utils::NoArgClass<System::Xml::SecureStringHasher::HashCodeOfStringDelegate*>(), "GetHashCodeDelegate", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Xml::SecureStringHasher* System::Xml::SecureStringHasher::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Xml").WithContext("SecureStringHasher").WithContext(".ctor");
