...
int System::Xml::SecureStringHasher::GetHashCodeOfString(::CsString* key, int sLen, int64_t additionalEntropy) {
...
bool System::Xml::SecureStringHasher::Equals(::CsString* x, ::CsString* y) {
...
int System::Xml::SecureStringHasher::GetHashCode(::CsString* key) {
