...
void System::Xml::HtmlUtf8RawTextWriterIndent::WriteDocType(::CsString* name, ::CsString* pubid, ::CsString* sysid, ::CsString* subset) {
...
void System::Xml::HtmlUtf8RawTextWriterIndent::WriteStartElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriterIndent::WriteEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::HtmlUtf8RawTextWriterIndent::WriteStartAttribute(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
