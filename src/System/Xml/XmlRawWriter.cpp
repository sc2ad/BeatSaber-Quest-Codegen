...
// Autogenerated method: System.Xml.XmlRawWriter.WriteXmlDeclaration
void System::Xml::XmlRawWriter::WriteXmlDeclaration(::CsString* xmldecl) {
...
void System::Xml::XmlRawWriter::WriteEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::XmlRawWriter::WriteFullEndElement(::CsString* prefix, ::CsString* localName, ::CsString* ns) {
...
void System::Xml::XmlRawWriter::WriteNamespaceDeclaration(::CsString* prefix, ::CsString* ns) {
...
void System::Xml::XmlRawWriter::WriteStartNamespaceDeclaration(::CsString* prefix) {
...
void System::Xml::XmlRawWriter::WriteDocType(::CsString* name, ::CsString* pubid, ::CsString* sysid, ::CsString* subset) {
...
::CsString* System::Xml::XmlRawWriter::LookupPrefix(::CsString* ns) {
...
void System::Xml::XmlRawWriter::WriteCData(::CsString* text) {
...
void System::Xml::XmlRawWriter::WriteWhitespace(::CsString* ws) {
