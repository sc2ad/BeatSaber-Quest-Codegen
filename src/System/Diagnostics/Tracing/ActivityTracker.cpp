...
void System::Diagnostics::Tracing::ActivityTracker::OnStart(::CsString* providerName, ::CsString* activityName, int task, System::Guid& activityId, System::Guid& relatedActivityId, System::Diagnostics::Tracing::EventActivityOptions options) {
...
void System::Diagnostics::Tracing::ActivityTracker::OnStop(::CsString* providerName, ::CsString* activityName, int task, System::Guid& activityId) {
...
System::Diagnostics::Tracing::ActivityTracker::ActivityInfo* System::Diagnostics::Tracing::ActivityTracker::FindActiveActivity(::CsString* name, System::Diagnostics::Tracing::ActivityTracker::ActivityInfo* startLocation) {
...
::CsString* System::Diagnostics::Tracing::ActivityTracker::NormalizeActivityName(::CsString* providerName, ::CsString* activityName, int task) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "NormalizeActivityName", providerName, activityName, task));
}
