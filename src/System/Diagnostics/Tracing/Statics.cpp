...
::Array<uint8_t>* System::Diagnostics::Tracing::Statics::MetadataForString(::CsString* name, int prefixSize, int suffixSize, int additionalSize) {
...
void System::Diagnostics::Tracing::Statics::CheckName(::CsString* name) {
...
bool System::Diagnostics::Tracing::Statics::ShouldOverrideFieldName(::CsString* fieldName) {
...
::CsObject* System::Diagnostics::Tracing::Statics::CreateInstance(System::Type* type, ::Array<::CsObject*>* parameters) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Diagnostics.Tracing", "Statics", "CreateInstance", type, parameters));
}
...
System::Reflection::MethodInfo* System::Diagnostics::Tracing::Statics::GetDeclaredStaticMethod(System::Type* declaringType, ::CsString* name) {
...
bool System::Diagnostics::Tracing::Statics::IsGenericMatch(System::Type* type, ::CsObject* openType) {
