...
void System::Diagnostics::Tracing::UInt16TypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::UInt16TypeInfo* System::Diagnostics::Tracing::UInt16TypeInfo::New_ctor() {
  return (UInt16TypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "UInt16TypeInfo"));
}
