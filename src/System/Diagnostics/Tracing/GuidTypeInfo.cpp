...
void System::Diagnostics::Tracing::GuidTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::GuidTypeInfo* System::Diagnostics::Tracing::GuidTypeInfo::New_ctor() {
  return (GuidTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "GuidTypeInfo"));
}
