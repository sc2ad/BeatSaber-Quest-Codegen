...
void System::Diagnostics::Tracing::SingleTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::SingleTypeInfo* System::Diagnostics::Tracing::SingleTypeInfo::New_ctor() {
  return (SingleTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "SingleTypeInfo"));
}
