...
System::Diagnostics::Tracing::UInt32TypeInfo* System::Diagnostics::Tracing::UInt32TypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("UInt32TypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<UInt32TypeInfo*>());
}
