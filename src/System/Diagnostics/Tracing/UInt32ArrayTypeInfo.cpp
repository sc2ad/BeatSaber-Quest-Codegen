...
void System::Diagnostics::Tracing::UInt32ArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::UInt32ArrayTypeInfo* System::Diagnostics::Tracing::UInt32ArrayTypeInfo::New_ctor() {
  return (UInt32ArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "UInt32ArrayTypeInfo"));
}
