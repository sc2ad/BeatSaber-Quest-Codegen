...
void System::Diagnostics::Tracing::BooleanArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::BooleanArrayTypeInfo* System::Diagnostics::Tracing::BooleanArrayTypeInfo::New_ctor() {
  return (BooleanArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "BooleanArrayTypeInfo"));
}
