...
void System::Diagnostics::Tracing::DoubleArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.DoubleArrayTypeInfo..ctor
System::Diagnostics::Tracing::DoubleArrayTypeInfo* System::Diagnostics::Tracing::DoubleArrayTypeInfo::New_ctor() {
  return (DoubleArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "DoubleArrayTypeInfo"));
}
