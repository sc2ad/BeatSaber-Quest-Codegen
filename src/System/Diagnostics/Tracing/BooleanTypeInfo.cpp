...
void System::Diagnostics::Tracing::BooleanTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::BooleanTypeInfo* System::Diagnostics::Tracing::BooleanTypeInfo::New_ctor() {
  return (BooleanTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "BooleanTypeInfo"));
}
