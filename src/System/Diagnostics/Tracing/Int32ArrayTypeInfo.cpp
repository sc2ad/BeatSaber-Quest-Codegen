...
System::Diagnostics::Tracing::Int32ArrayTypeInfo* System::Diagnostics::Tracing::Int32ArrayTypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("Int32ArrayTypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<Int32ArrayTypeInfo*>());
}
