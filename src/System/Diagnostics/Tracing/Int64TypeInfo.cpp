...
System::Diagnostics::Tracing::Int64TypeInfo* System::Diagnostics::Tracing::Int64TypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("Int64TypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<Int64TypeInfo*>());
}
