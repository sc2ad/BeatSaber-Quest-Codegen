...
void System::Diagnostics::Tracing::TplEtwProvider::DebugFacilityMessage(::CsString* Facility, ::CsString* Message) {
...
void System::Diagnostics::Tracing::TplEtwProvider::DebugFacilityMessage1(::CsString* Facility, ::CsString* Message, ::CsString* Arg) {
