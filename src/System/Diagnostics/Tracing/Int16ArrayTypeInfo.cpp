...
void System::Diagnostics::Tracing::Int16ArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.Int16ArrayTypeInfo..ctor
System::Diagnostics::Tracing::Int16ArrayTypeInfo* System::Diagnostics::Tracing::Int16ArrayTypeInfo::New_ctor() {
  return (Int16ArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "Int16ArrayTypeInfo"));
}
