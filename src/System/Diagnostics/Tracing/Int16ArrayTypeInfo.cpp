...
System::Diagnostics::Tracing::Int16ArrayTypeInfo* System::Diagnostics::Tracing::Int16ArrayTypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("Int16ArrayTypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<Int16ArrayTypeInfo*>());
}
