...
void System::Diagnostics::Tracing::CharTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.CharTypeInfo..ctor
System::Diagnostics::Tracing::CharTypeInfo* System::Diagnostics::Tracing::CharTypeInfo::New_ctor() {
  return (CharTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "CharTypeInfo"));
}
