...
void System::Diagnostics::Tracing::DateTimeTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.DateTimeTypeInfo..ctor
System::Diagnostics::Tracing::DateTimeTypeInfo* System::Diagnostics::Tracing::DateTimeTypeInfo::New_ctor() {
  return (DateTimeTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "DateTimeTypeInfo"));
}
