...
System::Diagnostics::Tracing::DateTimeTypeInfo* System::Diagnostics::Tracing::DateTimeTypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("DateTimeTypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<DateTimeTypeInfo*>());
}
