...
System::Diagnostics::Tracing::DateTimeOffsetTypeInfo* System::Diagnostics::Tracing::DateTimeOffsetTypeInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("DateTimeOffsetTypeInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<DateTimeOffsetTypeInfo*>());
}
