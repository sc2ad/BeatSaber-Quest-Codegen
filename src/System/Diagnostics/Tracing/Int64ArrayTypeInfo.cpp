...
void System::Diagnostics::Tracing::Int64ArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.Int64ArrayTypeInfo..ctor
System::Diagnostics::Tracing::Int64ArrayTypeInfo* System::Diagnostics::Tracing::Int64ArrayTypeInfo::New_ctor() {
  return (Int64ArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "Int64ArrayTypeInfo"));
}
