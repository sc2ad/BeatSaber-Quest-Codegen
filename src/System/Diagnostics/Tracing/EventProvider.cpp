...
void System::Diagnostics::Tracing::EventProvider::OnControllerCommand(System::Diagnostics::Tracing::ControllerCommand command, System::Collections::Generic::IDictionary_2<::CsString*, ::CsString*>* arguments, int sessionId, int etwSessionId) {
...
::CsObject* System::Diagnostics::Tracing::EventProvider::EncodeObject(::CsObject*& data, System::Diagnostics::Tracing::EventProvider::EventData*& dataDescriptor, uint8_t*& dataBuffer, uint& totalEventSize) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>("System.Diagnostics.Tracing", "EventProvider", "EncodeObject", data, dataDescriptor, dataBuffer, totalEventSize));
}
// Autogenerated method: System.Diagnostics.Tracing.EventProvider.WriteEvent
bool System::Diagnostics::Tracing::EventProvider::WriteEvent(System::Diagnostics::Tracing::EventDescriptor& eventDescriptor, System::Guid* activityID, System::Guid* childActivityID, ::Array<::CsObject*>* eventPayload) {
