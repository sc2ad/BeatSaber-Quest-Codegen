...
void System::Diagnostics::Tracing::Int32TypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.Int32TypeInfo..ctor
System::Diagnostics::Tracing::Int32TypeInfo* System::Diagnostics::Tracing::Int32TypeInfo::New_ctor() {
  return (Int32TypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "Int32TypeInfo"));
}
