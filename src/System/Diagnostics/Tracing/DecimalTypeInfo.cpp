...
void System::Diagnostics::Tracing::DecimalTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.DecimalTypeInfo..ctor
System::Diagnostics::Tracing::DecimalTypeInfo* System::Diagnostics::Tracing::DecimalTypeInfo::New_ctor() {
  return (DecimalTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "DecimalTypeInfo"));
}
