...
void System::Diagnostics::Tracing::SingleArrayTypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
...
System::Diagnostics::Tracing::SingleArrayTypeInfo* System::Diagnostics::Tracing::SingleArrayTypeInfo::New_ctor() {
  return (SingleArrayTypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "SingleArrayTypeInfo"));
}
