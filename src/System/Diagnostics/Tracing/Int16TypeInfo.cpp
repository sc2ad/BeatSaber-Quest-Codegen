...
void System::Diagnostics::Tracing::Int16TypeInfo::WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::CsString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteMetadata", collector, name, format));
}
// Autogenerated method: System.Diagnostics.Tracing.Int16TypeInfo..ctor
System::Diagnostics::Tracing::Int16TypeInfo* System::Diagnostics::Tracing::Int16TypeInfo::New_ctor() {
  return (Int16TypeInfo*)THROW_UNLESS(il2cpp_utils::New("System.Diagnostics.Tracing", "Int16TypeInfo"));
}
