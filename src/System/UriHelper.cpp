...
::Array<::Il2CppChar>* System::UriHelper::EscapeString(::Il2CppString* input, int start, int end, ::Array<::Il2CppChar>* dest, int& destPos, bool isUriString, ::Il2CppChar force1, ::Il2CppChar force2, ::Il2CppChar rsvd) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<::Array<::Il2CppChar>*>(), "EscapeString", {}, ::il2cpp_utils::ExtractTypes(input, start, end, dest, destPos, isUriString, force1, force2, rsvd)));
...
::Array<::Il2CppChar>* System::UriHelper::EnsureDestinationSize(::Il2CppChar* pStr, ::Array<::Il2CppChar>* dest, int currentInputPos, int16_t charsToAdd, int16_t minReallocateChars, int& destPos, int prevInputPos) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<::Array<::Il2CppChar>*>(), "EnsureDestinationSize", {}, ::il2cpp_utils::ExtractTypes(pStr, dest, currentInputPos, charsToAdd, minReallocateChars, destPos, prevInputPos)));
...
::Array<::Il2CppChar>* System::UriHelper::UnescapeString(::Il2CppString* input, int start, int end, ::Array<::Il2CppChar>* dest, int& destPosition, ::Il2CppChar rsvd1, ::Il2CppChar rsvd2, ::Il2CppChar rsvd3, System::UnescapeMode unescapeMode, System::UriParser* syntax, bool isQuery) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<::Array<::Il2CppChar>*>(), "UnescapeString", {}, ::il2cpp_utils::ExtractTypes(input, start, end, dest, destPosition, rsvd1, rsvd2, rsvd3, unescapeMode, syntax, isQuery)));
...
::Array<::Il2CppChar>* System::UriHelper::UnescapeString(::Il2CppChar* pStr, int start, int end, ::Array<::Il2CppChar>* dest, int& destPosition, ::Il2CppChar rsvd1, ::Il2CppChar rsvd2, ::Il2CppChar rsvd3, System::UnescapeMode unescapeMode, System::UriParser* syntax, bool isQuery) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("UriHelper").WithContext("UnescapeString");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<::Array<::Il2CppChar>*>(), "UnescapeString", {}, ::il2cpp_utils::ExtractTypes(pStr, start, end, dest, destPosition, rsvd1, rsvd2, rsvd3, unescapeMode, syntax, isQuery)));
...
void System::UriHelper::MatchUTF8Sequence(::Il2CppChar* pDest, ::Array<::Il2CppChar>* dest, int& destOffset, ::Array<::Il2CppChar>* unescapedChars, int charCount, ::Array<uint8_t>* bytes, int byteCount, bool isQuery, bool iriParsing) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<void>(), "MatchUTF8Sequence", {}, ::il2cpp_utils::ExtractTypes(pDest, dest, destOffset, unescapedChars, charCount, bytes, byteCount, isQuery, iriParsing)));
...
void System::UriHelper::EscapeAsciiChar(::Il2CppChar ch, ::Array<::Il2CppChar>* to, int& pos) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<void>(), "EscapeAsciiChar", {}, ::il2cpp_utils::ExtractTypes(ch, to, pos)));
...
::Il2CppChar System::UriHelper::EscapedAscii(::Il2CppChar digit, ::Il2CppChar next) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<::Il2CppChar>(), "EscapedAscii", {}, ::il2cpp_utils::ExtractTypes(digit, next)));
...
bool System::UriHelper::IsNotSafeForUnescape(::Il2CppChar ch) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<bool>(), "IsNotSafeForUnescape", {}, ::il2cpp_utils::ExtractTypes(ch)));
...
bool System::UriHelper::IsReservedUnreservedOrHash(::Il2CppChar c) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<bool>(), "IsReservedUnreservedOrHash", {}, ::il2cpp_utils::ExtractTypes(c)));
...
bool System::UriHelper::IsUnreserved(::Il2CppChar c) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<bool>(), "IsUnreserved", {}, ::il2cpp_utils::ExtractTypes(c)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, c);
}
...
bool System::UriHelper::Is3986Unreserved(::Il2CppChar c) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<bool>(), "Is3986Unreserved", {}, ::il2cpp_utils::ExtractTypes(c)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, c);
}
...
void System::UriHelper::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "UriHelper", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
