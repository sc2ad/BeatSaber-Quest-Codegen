...
System::DateTimeKind System::DateTimeKind::_get_Unspecified() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_get_Unspecified");
...
void System::DateTimeKind::_set_Unspecified(System::DateTimeKind value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_set_Unspecified");
...
System::DateTimeKind System::DateTimeKind::_get_Utc() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_get_Utc");
...
void System::DateTimeKind::_set_Utc(System::DateTimeKind value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_set_Utc");
...
System::DateTimeKind System::DateTimeKind::_get_Local() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_get_Local");
...
void System::DateTimeKind::_set_Local(System::DateTimeKind value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System").WithContext("DateTimeKind").WithContext("_set_Local");
