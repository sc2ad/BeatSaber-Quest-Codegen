...
::Il2CppString* System::Char::ToString(::Il2CppChar c) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("System", "Char", "ToString", c));
}
...
bool System::Char::IsNumber(::Il2CppString* s, int index) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System", "Char", "IsNumber", s, index));
}
...
::Il2CppString* System::Char::ConvertFromUtf32(int utf32) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("System", "Char", "ConvertFromUtf32", utf32));
}
