...
void System::ThrowHelper::ThrowWrongValueTypeArgumentException(::CsObject* value, System::Type* targetType) {
...
::CsString* System::ThrowHelper::GetArgumentName(System::ExceptionArgument argument) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System", "ThrowHelper", "GetArgumentName", argument));
}
// Autogenerated method: System.ThrowHelper.GetResourceName
::CsString* System::ThrowHelper::GetResourceName(System::ExceptionResource resource) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System", "ThrowHelper", "GetResourceName", resource));
}
