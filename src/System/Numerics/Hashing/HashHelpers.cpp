...
int System::Numerics::Hashing::HashHelpers::Combine(int h1, int h2) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Numerics.Hashing", "HashHelpers", il2cpp_utils::NoArgClass<int>(), "Combine", {}, ::il2cpp_utils::ExtractTypes(h1, h2)));
...
void System::Numerics::Hashing::HashHelpers::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Numerics.Hashing", "HashHelpers", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
