...
int System::Linq::Enumerable::Sum(System::Collections::Generic::IEnumerable_1<int>* source) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Linq", "Enumerable", il2cpp_utils::NoArgClass<int>(), "Sum", {}, ::il2cpp_utils::ExtractTypes(source)));
...
float System::Linq::Enumerable::Min(System::Collections::Generic::IEnumerable_1<float>* source) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Linq", "Enumerable", il2cpp_utils::NoArgClass<float>(), "Min", {}, ::il2cpp_utils::ExtractTypes(source)));
...
int System::Linq::Enumerable::Max(System::Collections::Generic::IEnumerable_1<int>* source) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Linq", "Enumerable", il2cpp_utils::NoArgClass<int>(), "Max", {}, ::il2cpp_utils::ExtractTypes(source)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, source);
}
// Autogenerated method: System.Linq.Enumerable.Max
float System::Linq::Enumerable::Max(System::Collections::Generic::IEnumerable_1<float>* source) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("Enumerable").WithContext("Max");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Linq", "Enumerable", il2cpp_utils::NoArgClass<float>(), "Max", {}, ::il2cpp_utils::ExtractTypes(source)));
  return ::il2cpp_utils::RunMethodThrow<float, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, source);
}
