...
System::LocalDataStoreHolder* System::LocalDataStoreMgr::CreateLocalDataStore() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::LocalDataStoreHolder*>(), "CreateLocalDataStore", {}, ::il2cpp_utils::ExtractTypes()));
...
void System::LocalDataStoreMgr::DeleteLocalDataStore(System::LocalDataStore* store) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "DeleteLocalDataStore", {}, ::il2cpp_utils::ExtractTypes(store)));
...
System::LocalDataStoreSlot* System::LocalDataStoreMgr::AllocateDataSlot() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::LocalDataStoreSlot*>(), "AllocateDataSlot", {}, ::il2cpp_utils::ExtractTypes()));
...
System::LocalDataStoreSlot* System::LocalDataStoreMgr::AllocateNamedDataSlot(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::LocalDataStoreSlot*>(), "AllocateNamedDataSlot", {}, ::il2cpp_utils::ExtractTypes(name)));
...
System::LocalDataStoreSlot* System::LocalDataStoreMgr::GetNamedDataSlot(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::LocalDataStoreSlot*>(), "GetNamedDataSlot", {}, ::il2cpp_utils::ExtractTypes(name)));
  return ::il2cpp_utils::RunMethodThrow<System::LocalDataStoreSlot*, false>(this, ___internal__method, name);
}
...
void System::LocalDataStoreMgr::FreeDataSlot(int slot, int64_t cookie) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "FreeDataSlot", {}, ::il2cpp_utils::ExtractTypes(slot, cookie)));
...
void System::LocalDataStoreMgr::ValidateSlot(System::LocalDataStoreSlot* slot) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ValidateSlot", {}, ::il2cpp_utils::ExtractTypes(slot)));
...
int System::LocalDataStoreMgr::GetSlotTableLength() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetSlotTableLength", {}, ::il2cpp_utils::ExtractTypes()));
...
System::LocalDataStoreMgr* System::LocalDataStoreMgr::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<LocalDataStoreMgr*>());
}
