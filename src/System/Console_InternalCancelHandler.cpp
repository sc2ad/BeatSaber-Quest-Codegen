...
System::Console::InternalCancelHandler* System::Console::InternalCancelHandler::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("InternalCancelHandler").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<Console::InternalCancelHandler*>(object, method));
}
