...
System::Threading::ParameterizedThreadStart* System::Threading::ParameterizedThreadStart::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("ParameterizedThreadStart").WithContext(".ctor");
...
void System::Threading::ParameterizedThreadStart::Invoke(::Il2CppObject* obj) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(obj)));
