...
void System::Threading::QueueUserWorkItemCallback::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Threading", "QueueUserWorkItemCallback", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Threading::QueueUserWorkItemCallback* System::Threading::QueueUserWorkItemCallback::New_ctor(System::Threading::WaitCallback* waitCallback, ::Il2CppObject* stateObj, bool compressStack, System::Threading::StackCrawlMark& stackMark) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<QueueUserWorkItemCallback*>(waitCallback, stateObj, compressStack, stackMark));
}
...
void System::Threading::QueueUserWorkItemCallback::WaitCallback_Context(::Il2CppObject* state) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Threading", "QueueUserWorkItemCallback", il2cpp_utils::NoArgClass<void>(), "WaitCallback_Context", {}, ::il2cpp_utils::ExtractTypes(state)));
