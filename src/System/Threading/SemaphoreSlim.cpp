...
System::Threading::SemaphoreSlim* System::Threading::SemaphoreSlim::New_ctor(int initialCount) {
  return THROW_UNLESS(il2cpp_utils::New<SemaphoreSlim*>(initialCount));
}
// Autogenerated method: System.Threading.SemaphoreSlim..ctor
...
bool System::Threading::SemaphoreSlim::Wait(int millisecondsTimeout) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Wait", millisecondsTimeout));
}
// Autogenerated method: System.Threading.SemaphoreSlim.Wait
