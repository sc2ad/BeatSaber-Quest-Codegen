...
System::Action_1<::CsObject*>* System::Threading::SemaphoreSlim::_get_s_cancellationTokenCanceledEventHandler() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<System::Action_1<::CsObject*>*>("System.Threading", "SemaphoreSlim", "s_cancellationTokenCanceledEventHandler"));
}
// Autogenerated static field setter
// Set static field: static private System.Action`1<System.Object> s_cancellationTokenCanceledEventHandler
void System::Threading::SemaphoreSlim::_set_s_cancellationTokenCanceledEventHandler(System::Action_1<::CsObject*>* value) {
...
System::Threading::SemaphoreSlim* System::Threading::SemaphoreSlim::New_ctor(int initialCount, int maxCount) {
  return (SemaphoreSlim*)THROW_UNLESS(il2cpp_utils::New("System.Threading", "SemaphoreSlim", initialCount, maxCount));
}
...
void System::Threading::SemaphoreSlim::CancellationTokenCanceledEventHandler(::CsObject* obj) {
...
::CsString* System::Threading::SemaphoreSlim::GetResourceString(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("System.Threading", "SemaphoreSlim", "GetResourceString", str));
}
