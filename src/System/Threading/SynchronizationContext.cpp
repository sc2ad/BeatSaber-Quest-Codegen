...
void System::Threading::SynchronizationContext::Send(System::Threading::SendOrPostCallback* d, ::CsObject* state) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Send", d, state));
}
// Autogenerated method: System.Threading.SynchronizationContext.Post
void System::Threading::SynchronizationContext::Post(System::Threading::SendOrPostCallback* d, ::CsObject* state) {
