...
System::Threading::WaitOrTimerCallback* System::Threading::WaitOrTimerCallback::New_ctor(::CsObject* object, System::IntPtr method) {
  return (WaitOrTimerCallback*)THROW_UNLESS(il2cpp_utils::New("System.Threading", "WaitOrTimerCallback", object, method));
}
// Autogenerated method: System.Threading.WaitOrTimerCallback.Invoke
void System::Threading::WaitOrTimerCallback::Invoke(::CsObject* state, bool timedOut) {
...
System::IAsyncResult* System::Threading::WaitOrTimerCallback::BeginInvoke(::CsObject* state, bool timedOut, System::AsyncCallback* callback, ::CsObject* object) {
