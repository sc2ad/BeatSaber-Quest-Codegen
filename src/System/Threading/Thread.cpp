...
void System::Threading::Thread::SetPriorityNative(int priority) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SetPriorityNative", priority));
}
...
bool System::Threading::Thread::JoinInternal(int millisecondsTimeout) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>(this, "JoinInternal", millisecondsTimeout));
}
...
void System::Threading::Thread::Abort_internal(System::Threading::InternalThread* thread, ::Il2CppObject* stateInfo) {
  THROW_UNLESS(il2cpp_utils::RunMethod("System.Threading", "Thread", "Abort_internal", thread, stateInfo));
}
