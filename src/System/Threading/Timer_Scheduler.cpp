...
void System::Threading::Timer::Scheduler::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Threading", "Timer/Scheduler", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
System::Threading::Timer::Scheduler* System::Threading::Timer::Scheduler::get_Instance() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Threading", "Timer/Scheduler", il2cpp_utils::NoArgClass<System::Threading::Timer::Scheduler*>(), "get_Instance", {}, ::il2cpp_utils::ExtractTypes()));
...
void System::Threading::Timer::Scheduler::Remove(System::Threading::Timer* timer) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Remove", {}, ::il2cpp_utils::ExtractTypes(timer)));
...
void System::Threading::Timer::Scheduler::Change(System::Threading::Timer* timer, int64_t new_next_run) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Change", {}, ::il2cpp_utils::ExtractTypes(timer, new_next_run)));
...
int System::Threading::Timer::Scheduler::FindByDueTime(int64_t nr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "FindByDueTime", {}, ::il2cpp_utils::ExtractTypes(nr)));
...
void System::Threading::Timer::Scheduler::Add(System::Threading::Timer* timer) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Add", {}, ::il2cpp_utils::ExtractTypes(timer)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, timer);
}
...
int System::Threading::Timer::Scheduler::InternalRemove(System::Threading::Timer* timer) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "InternalRemove", {}, ::il2cpp_utils::ExtractTypes(timer)));
...
void System::Threading::Timer::Scheduler::TimerCB(::Il2CppObject* o) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System.Threading", "Timer/Scheduler", il2cpp_utils::NoArgClass<void>(), "TimerCB", {}, ::il2cpp_utils::ExtractTypes(o)));
...
void System::Threading::Timer::Scheduler::SchedulerThread() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SchedulerThread", {}, ::il2cpp_utils::ExtractTypes()));
...
void System::Threading::Timer::Scheduler::ShrinkIfNeeded(System::Collections::Generic::List_1<System::Threading::Timer*>* list, int initial) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ShrinkIfNeeded", {}, ::il2cpp_utils::ExtractTypes(list, initial)));
...
System::Threading::Timer::Scheduler* System::Threading::Timer::Scheduler::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Timer::Scheduler*>());
}
