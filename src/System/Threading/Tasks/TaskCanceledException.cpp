...
// Autogenerated method: System.Threading.Tasks.TaskCanceledException..ctor
System::Threading::Tasks::TaskCanceledException* System::Threading::Tasks::TaskCanceledException::New_ctor(::Il2CppString* message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Threading::Tasks").WithContext("TaskCanceledException").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TaskCanceledException*>(message));
}
// Autogenerated method: System.Threading.Tasks.TaskCanceledException..ctor
