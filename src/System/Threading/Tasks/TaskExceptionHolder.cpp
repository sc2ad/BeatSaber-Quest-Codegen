...
System::Threading::Tasks::TaskExceptionHolder* System::Threading::Tasks::TaskExceptionHolder::New_ctor(System::Threading::Tasks::Task* task) {
  return (TaskExceptionHolder*)THROW_UNLESS(il2cpp_utils::New("System.Threading.Tasks", "TaskExceptionHolder", task));
}
...
void System::Threading::Tasks::TaskExceptionHolder::AppDomainUnloadCallback(::CsObject* sender, System::EventArgs* e) {
...
void System::Threading::Tasks::TaskExceptionHolder::Add(::CsObject* exceptionObject, bool representsCancellation) {
...
void System::Threading::Tasks::TaskExceptionHolder::SetCancellationException(::CsObject* exceptionObject) {
...
void System::Threading::Tasks::TaskExceptionHolder::AddFaultException(::CsObject* exceptionObject) {
