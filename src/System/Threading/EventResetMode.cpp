...
System::Threading::EventResetMode System::Threading::EventResetMode::_get_AutoReset() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("EventResetMode").WithContext("_get_AutoReset");
...
void System::Threading::EventResetMode::_set_AutoReset(System::Threading::EventResetMode value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("EventResetMode").WithContext("_set_AutoReset");
...
System::Threading::EventResetMode System::Threading::EventResetMode::_get_ManualReset() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("EventResetMode").WithContext("_get_ManualReset");
...
void System::Threading::EventResetMode::_set_ManualReset(System::Threading::EventResetMode value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("EventResetMode").WithContext("_set_ManualReset");
