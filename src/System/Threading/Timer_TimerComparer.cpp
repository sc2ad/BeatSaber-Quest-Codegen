...
int System::Threading::Timer::TimerComparer::Compare(::CsObject* x, ::CsObject* y) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<int>(this, "Compare", x, y));
}
int System::Threading::Timer::TimerComparer::System_Collections_IComparer_Compare(::CsObject* x, ::CsObject* y) {
  return Compare(x, y);
}
