...
System::ParseFailureKind System::ParseFailureKind::_get_FormatBadDateTimeCalendar() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("ParseFailureKind").WithContext("_get_FormatBadDateTimeCalendar");
...
void System::ParseFailureKind::_set_FormatBadDateTimeCalendar(System::ParseFailureKind value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("ParseFailureKind").WithContext("_set_FormatBadDateTimeCalendar");
