...
System::IOAsyncResult* System::IOAsyncResult::New_ctor(System::AsyncCallback* async_callback, ::CsObject* async_state) {
  return (IOAsyncResult*)THROW_UNLESS(il2cpp_utils::New("System", "IOAsyncResult", async_callback, async_state));
}
...
::CsObject* System::IOAsyncResult::get_AsyncState() {
