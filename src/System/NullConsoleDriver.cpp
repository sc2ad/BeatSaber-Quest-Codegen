...
void System::NullConsoleDriver::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("System", "NullConsoleDriver", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
System::NullConsoleDriver* System::NullConsoleDriver::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<NullConsoleDriver*>());
}
