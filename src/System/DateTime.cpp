...
System::DateTime::DateTime(int64_t ticks) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", ticks));
}
// Autogenerated method: System.DateTime..ctor
...
System::DateTime::DateTime(int64_t ticks, System::DateTimeKind kind) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", ticks, kind));
}
// Autogenerated method: System.DateTime..ctor
System::DateTime::DateTime(int64_t ticks, System::DateTimeKind kind, bool isAmbiguousDst) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", ticks, kind, isAmbiguousDst));
}
// Autogenerated method: System.DateTime..ctor
System::DateTime::DateTime(int year, int month, int day) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", year, month, day));
}
// Autogenerated method: System.DateTime..ctor
System::DateTime::DateTime(int year, int month, int day, int hour, int minute, int second, System::DateTimeKind kind) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", year, month, day, hour, minute, second, kind));
}
// Autogenerated method: System.DateTime..ctor
System::DateTime::DateTime(int year, int month, int day, int hour, int minute, int second, int millisecond) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", year, month, day, hour, minute, second, millisecond));
}
// Autogenerated method: System.DateTime..ctor
System::DateTime::DateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, System::DateTimeKind kind) {
  THROW_UNLESS(il2cpp_utils::RunMethod(*this, ".ctor", year, month, day, hour, minute, second, millisecond, kind));
}
// Autogenerated method: System.DateTime..ctor
...
System::DateTime System::DateTime::ParseExact(::Il2CppString* s, ::Il2CppString* format, System::IFormatProvider* provider) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::DateTime>("System", "DateTime", "ParseExact", s, format, provider));
}
// Autogenerated method: System.DateTime.ParseExact
System::DateTime System::DateTime::ParseExact(::Il2CppString* s, ::Il2CppString* format, System::IFormatProvider* provider, System::Globalization::DateTimeStyles style) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::DateTime>("System", "DateTime", "ParseExact", s, format, provider, style));
}
...
bool System::DateTime::TryParse(::Il2CppString* s, System::IFormatProvider* provider, System::Globalization::DateTimeStyles styles, System::DateTime& result) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<bool>("System", "DateTime", "TryParse", s, provider, styles, result));
}
