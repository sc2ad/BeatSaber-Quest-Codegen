...
Valve::VR::IVRSystem::_GetProjectionMatrix* Valve::VR::IVRSystem::_GetProjectionMatrix::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVRSystem::_GetProjectionMatrix::BeginInvoke(Valve::VR::EVREye eEye, float fNearZ, float fFarZ, System::AsyncCallback* callback, ::CsObject* object) {
