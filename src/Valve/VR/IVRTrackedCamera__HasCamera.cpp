...
Valve::VR::IVRTrackedCamera::_HasCamera* Valve::VR::IVRTrackedCamera::_HasCamera::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVRTrackedCamera::_HasCamera::BeginInvoke(uint nDeviceIndex, bool& pHasCamera, System::AsyncCallback* callback, ::CsObject* object) {
