...
Valve::VR::CVRSystem::_PollNextEventPacked* Valve::VR::CVRSystem::_PollNextEventPacked::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::CVRSystem::_PollNextEventPacked::BeginInvoke(Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::CsObject* object) {
