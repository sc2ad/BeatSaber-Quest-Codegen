...
Valve::VR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative* Valve::VR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayTransformTrackedDeviceRelative::BeginInvoke(uint64_t ulOverlayHandle, uint unTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::AsyncCallback* callback, ::CsObject* object) {
