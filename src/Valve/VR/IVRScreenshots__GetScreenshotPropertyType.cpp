...
Valve::VR::IVRScreenshots::_GetScreenshotPropertyType* Valve::VR::IVRScreenshots::_GetScreenshotPropertyType::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVRScreenshots::_GetScreenshotPropertyType::BeginInvoke(uint screenshotHandle, Valve::VR::EVRScreenshotError& pError, System::AsyncCallback* callback, ::CsObject* object) {
