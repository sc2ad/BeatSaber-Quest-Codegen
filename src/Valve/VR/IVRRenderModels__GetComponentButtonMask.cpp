...
Valve::VR::IVRRenderModels::_GetComponentButtonMask* Valve::VR::IVRRenderModels::_GetComponentButtonMask::New_ctor(::CsObject* object, System::IntPtr method) {
...
uint64_t Valve::VR::IVRRenderModels::_GetComponentButtonMask::Invoke(::CsString* pchRenderModelName, ::CsString* pchComponentName) {
...
System::IAsyncResult* Valve::VR::IVRRenderModels::_GetComponentButtonMask::BeginInvoke(::CsString* pchRenderModelName, ::CsString* pchComponentName, System::AsyncCallback* callback, ::CsObject* object) {
