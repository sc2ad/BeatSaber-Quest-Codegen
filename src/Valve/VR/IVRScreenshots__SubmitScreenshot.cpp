...
Valve::VR::IVRScreenshots::_SubmitScreenshot* Valve::VR::IVRScreenshots::_SubmitScreenshot::New_ctor(::CsObject* object, System::IntPtr method) {
...
Valve::VR::EVRScreenshotError Valve::VR::IVRScreenshots::_SubmitScreenshot::Invoke(uint screenshotHandle, Valve::VR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename) {
...
System::IAsyncResult* Valve::VR::IVRScreenshots::_SubmitScreenshot::BeginInvoke(uint screenshotHandle, Valve::VR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename, System::AsyncCallback* callback, ::CsObject* object) {
