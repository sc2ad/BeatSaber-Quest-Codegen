...
Valve::VR::IVROverlay::_SetGamepadFocusOverlay* Valve::VR::IVROverlay::_SetGamepadFocusOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetGamepadFocusOverlay::BeginInvoke(uint64_t ulNewFocusOverlay, System::AsyncCallback* callback, ::CsObject* object) {
