...
Valve::VR::IVRApplications::_LaunchApplicationFromMimeType* Valve::VR::IVRApplications::_LaunchApplicationFromMimeType::New_ctor(::CsObject* object, System::IntPtr method) {
...
Valve::VR::EVRApplicationError Valve::VR::IVRApplications::_LaunchApplicationFromMimeType::Invoke(::CsString* pchMimeType, ::CsString* pchArgs) {
...
System::IAsyncResult* Valve::VR::IVRApplications::_LaunchApplicationFromMimeType::BeginInvoke(::CsString* pchMimeType, ::CsString* pchArgs, System::AsyncCallback* callback, ::CsObject* object) {
