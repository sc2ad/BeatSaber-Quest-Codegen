...
Valve::VR::IVRSettings::_SetString* Valve::VR::IVRSettings::_SetString::New_ctor(::CsObject* object, System::IntPtr method) {
...
void Valve::VR::IVRSettings::_SetString::Invoke(::CsString* pchSection, ::CsString* pchSettingsKey, ::CsString* pchValue, Valve::VR::EVRSettingsError& peError) {
...
System::IAsyncResult* Valve::VR::IVRSettings::_SetString::BeginInvoke(::CsString* pchSection, ::CsString* pchSettingsKey, ::CsString* pchValue, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::CsObject* object) {
