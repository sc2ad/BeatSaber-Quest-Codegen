...
Valve::VR::EVRRenderModelError Valve::VR::CVRRenderModels::LoadRenderModel_Async(::CsString* pchRenderModelName, System::IntPtr& ppRenderModel) {
...
uint Valve::VR::CVRRenderModels::GetComponentCount(::CsString* pchRenderModelName) {
...
uint Valve::VR::CVRRenderModels::GetComponentName(::CsString* pchRenderModelName, uint unComponentIndex, System::Text::StringBuilder* pchComponentName, uint unComponentNameLen) {
...
uint64_t Valve::VR::CVRRenderModels::GetComponentButtonMask(::CsString* pchRenderModelName, ::CsString* pchComponentName) {
...
uint Valve::VR::CVRRenderModels::GetComponentRenderModelName(::CsString* pchRenderModelName, ::CsString* pchComponentName, System::Text::StringBuilder* pchComponentRenderModelName, uint unComponentRenderModelNameLen) {
...
bool Valve::VR::CVRRenderModels::GetComponentState(::CsString* pchRenderModelName, ::CsString* pchComponentName, Valve::VR::VRControllerState_t& pControllerState, Valve::VR::RenderModel_ControllerMode_State_t& pState, Valve::VR::RenderModel_ComponentState_t& pComponentState) {
...
bool Valve::VR::CVRRenderModels::RenderModelHasComponent(::CsString* pchRenderModelName, ::CsString* pchComponentName) {
...
uint Valve::VR::CVRRenderModels::GetRenderModelThumbnailURL(::CsString* pchRenderModelName, System::Text::StringBuilder* pchThumbnailURL, uint unThumbnailURLLen, Valve::VR::EVRRenderModelError& peError) {
...
uint Valve::VR::CVRRenderModels::GetRenderModelOriginalPath(::CsString* pchRenderModelName, System::Text::StringBuilder* pchOriginalPath, uint unOriginalPathLen, Valve::VR::EVRRenderModelError& peError) {
...
::CsString* Valve::VR::CVRRenderModels::GetRenderModelErrorNameFromEnum(Valve::VR::EVRRenderModelError error) {
