...
Valve::VR::CVRRenderModels::_GetComponentStatePacked* Valve::VR::CVRRenderModels::_GetComponentStatePacked::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetComponentStatePacked").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CVRRenderModels::_GetComponentStatePacked*>(object, method));
}
