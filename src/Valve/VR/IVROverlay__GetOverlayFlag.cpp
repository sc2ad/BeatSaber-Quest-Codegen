...
Valve::VR::IVROverlay::_GetOverlayFlag* Valve::VR::IVROverlay::_GetOverlayFlag::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_GetOverlayFlag::BeginInvoke(uint64_t ulOverlayHandle, Valve::VR::VROverlayFlags eOverlayFlag, bool& pbEnabled, System::AsyncCallback* callback, ::CsObject* object) {
