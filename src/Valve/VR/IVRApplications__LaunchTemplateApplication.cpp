...
Valve::VR::IVRApplications::_LaunchTemplateApplication* Valve::VR::IVRApplications::_LaunchTemplateApplication::New_ctor(::CsObject* object, System::IntPtr method) {
...
Valve::VR::EVRApplicationError Valve::VR::IVRApplications::_LaunchTemplateApplication::Invoke(::CsString* pchTemplateAppKey, ::CsString* pchNewAppKey, ::Array<Valve::VR::AppOverrideKeys_t>*& pKeys, uint unKeys) {
...
System::IAsyncResult* Valve::VR::IVRApplications::_LaunchTemplateApplication::BeginInvoke(::CsString* pchTemplateAppKey, ::CsString* pchNewAppKey, ::Array<Valve::VR::AppOverrideKeys_t>*& pKeys, uint unKeys, System::AsyncCallback* callback, ::CsObject* object) {
