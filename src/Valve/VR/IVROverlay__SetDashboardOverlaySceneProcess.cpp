...
Valve::VR::IVROverlay::_SetDashboardOverlaySceneProcess* Valve::VR::IVROverlay::_SetDashboardOverlaySceneProcess::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_SetDashboardOverlaySceneProcess*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_SetDashboardOverlaySceneProcess", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetDashboardOverlaySceneProcess::BeginInvoke(uint64_t ulOverlayHandle, uint unProcessId, System::AsyncCallback* callback, ::CsObject* object) {
