...
Valve::VR::IVRApplications::_GetApplicationPropertyString* Valve::VR::IVRApplications::_GetApplicationPropertyString::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetApplicationPropertyString").WithContext(".ctor");
