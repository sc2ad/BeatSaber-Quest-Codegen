...
Valve::VR::IVROverlay::_GetTransformForOverlayCoordinates* Valve::VR::IVROverlay::_GetTransformForOverlayCoordinates::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_GetTransformForOverlayCoordinates*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_GetTransformForOverlayCoordinates", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_GetTransformForOverlayCoordinates::BeginInvoke(uint64_t ulOverlayHandle, Valve::VR::ETrackingUniverseOrigin eTrackingOrigin, Valve::VR::HmdVector2_t coordinatesInOverlay, Valve::VR::HmdMatrix34_t& pmatTransform, System::AsyncCallback* callback, ::CsObject* object) {
