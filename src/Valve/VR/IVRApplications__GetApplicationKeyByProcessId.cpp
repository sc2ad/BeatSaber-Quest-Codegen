...
Valve::VR::IVRApplications::_GetApplicationKeyByProcessId* Valve::VR::IVRApplications::_GetApplicationKeyByProcessId::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRApplications::_GetApplicationKeyByProcessId*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVRApplications/_GetApplicationKeyByProcessId", object, method));
}
...
System::IAsyncResult* Valve::VR::IVRApplications::_GetApplicationKeyByProcessId::BeginInvoke(uint unProcessId, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen, System::AsyncCallback* callback, ::CsObject* object) {
