...
void Valve::VR::IVRCompositor::_HideMirrorWindow::Invoke() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_HideMirrorWindow").WithContext("Invoke");
...
System::IAsyncResult* Valve::VR::IVRCompositor::_HideMirrorWindow::BeginInvoke(System::AsyncCallback* callback, ::Il2CppObject* object) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_HideMirrorWindow").WithContext("BeginInvoke");
...
void Valve::VR::IVRCompositor::_HideMirrorWindow::EndInvoke(System::IAsyncResult* result) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_HideMirrorWindow").WithContext("EndInvoke");
