...
Valve::VR::IVROverlay::_PollNextOverlayEvent* Valve::VR::IVROverlay::_PollNextOverlayEvent::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_PollNextOverlayEvent::BeginInvoke(uint64_t ulOverlayHandle, Valve::VR::VREvent_t& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::CsObject* object) {
