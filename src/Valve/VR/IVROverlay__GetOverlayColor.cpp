...
Valve::VR::IVROverlay::_GetOverlayColor* Valve::VR::IVROverlay::_GetOverlayColor::New_ctor(::Il2CppObject* object, System::IntPtr method) {
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_GetOverlayColor::Invoke(uint64_t ulOverlayHandle, float& pfRed, float& pfGreen, float& pfBlue) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandle, pfRed, pfGreen, pfBlue)));
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_GetOverlayColor::EndInvoke(float& pfRed, float& pfGreen, float& pfBlue, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(pfRed, pfGreen, pfBlue, result)));
