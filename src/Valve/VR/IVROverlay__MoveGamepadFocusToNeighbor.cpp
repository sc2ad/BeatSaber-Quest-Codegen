...
Valve::VR::IVROverlay::_MoveGamepadFocusToNeighbor* Valve::VR::IVROverlay::_MoveGamepadFocusToNeighbor::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_MoveGamepadFocusToNeighbor*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_MoveGamepadFocusToNeighbor", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_MoveGamepadFocusToNeighbor::BeginInvoke(Valve::VR::EOverlayDirection eDirection, uint64_t ulFrom, System::AsyncCallback* callback, ::CsObject* object) {
