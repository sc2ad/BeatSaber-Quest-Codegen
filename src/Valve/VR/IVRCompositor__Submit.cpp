...
Valve::VR::IVRCompositor::_Submit* Valve::VR::IVRCompositor::_Submit::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRCompositor::_Submit*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVRCompositor/_Submit", object, method));
}
...
System::IAsyncResult* Valve::VR::IVRCompositor::_Submit::BeginInvoke(Valve::VR::EVREye eEye, Valve::VR::Texture_t& pTexture, Valve::VR::VRTextureBounds_t& pBounds, Valve::VR::EVRSubmitFlags nSubmitFlags, System::AsyncCallback* callback, ::CsObject* object) {
