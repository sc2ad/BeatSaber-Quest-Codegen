...
Valve::VR::HiddenAreaMesh_t Valve::VR::IVRSystem::_GetHiddenAreaMesh::Invoke(Valve::VR::EVREye eEye, Valve::VR::EHiddenAreaMeshType type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HiddenAreaMesh_t>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(eEye, type)));
...
Valve::VR::HiddenAreaMesh_t Valve::VR::IVRSystem::_GetHiddenAreaMesh::EndInvoke(System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HiddenAreaMesh_t>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(result)));
