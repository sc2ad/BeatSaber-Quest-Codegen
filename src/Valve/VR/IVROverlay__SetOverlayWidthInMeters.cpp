...
Valve::VR::IVROverlay::_SetOverlayWidthInMeters* Valve::VR::IVROverlay::_SetOverlayWidthInMeters::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IVROverlay::_SetOverlayWidthInMeters*>(object, method));
}
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_SetOverlayWidthInMeters::Invoke(uint64_t ulOverlayHandle, float fWidthInMeters) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandle, fWidthInMeters)));
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayWidthInMeters::BeginInvoke(uint64_t ulOverlayHandle, float fWidthInMeters, System::AsyncCallback* callback, ::Il2CppObject* object) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::IAsyncResult*>(), "BeginInvoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandle, fWidthInMeters, callback, object)));
