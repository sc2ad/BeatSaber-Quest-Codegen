...
Valve::VR::IVROverlay::_GetOverlayTransformOverlayRelative* Valve::VR::IVROverlay::_GetOverlayTransformOverlayRelative::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IVROverlay::_GetOverlayTransformOverlayRelative*>(object, method));
}
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_GetOverlayTransformOverlayRelative::EndInvoke(uint64_t& ulOverlayHandleParent, Valve::VR::HmdMatrix34_t& pmatParentOverlayToOverlayTransform, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandleParent, pmatParentOverlayToOverlayTransform, result)));
