...
Valve::VR::IVROverlay::_GetKeyboardText* Valve::VR::IVROverlay::_GetKeyboardText::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_GetKeyboardText*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_GetKeyboardText", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_GetKeyboardText::BeginInvoke(System::Text::StringBuilder* pchText, uint cchText, System::AsyncCallback* callback, ::CsObject* object) {
