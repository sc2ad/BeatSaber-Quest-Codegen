...
Valve::VR::IVRRenderModels::_GetRenderModelOriginalPath* Valve::VR::IVRRenderModels::_GetRenderModelOriginalPath::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetRenderModelOriginalPath").WithContext(".ctor");
