...
Valve::VR::IVROverlay::_SetOverlayDualAnalogTransform* Valve::VR::IVROverlay::_SetOverlayDualAnalogTransform::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayDualAnalogTransform::BeginInvoke(uint64_t ulOverlay, Valve::VR::EDualAnalogWhich eWhich, System::IntPtr vCenter, float fRadius, System::AsyncCallback* callback, ::CsObject* object) {
