...
Valve::VR::IVRSystem::_GetControllerStateWithPose* Valve::VR::IVRSystem::_GetControllerStateWithPose::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetControllerStateWithPose").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IVRSystem::_GetControllerStateWithPose*>(object, method));
}
