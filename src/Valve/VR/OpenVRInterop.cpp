...
System::IntPtr Valve::VR::OpenVRInterop::GetGenericInterface(::CsString*& pchInterfaceVersion, Valve::VR::EVRInitError& peError) {
...
bool Valve::VR::OpenVRInterop::IsInterfaceVersionValid(::CsString*& pchInterfaceVersion) {
