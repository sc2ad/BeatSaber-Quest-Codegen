...
Valve::VR::IVRApplications::_GetApplicationsTransitionStateNameFromEnum* Valve::VR::IVRApplications::_GetApplicationsTransitionStateNameFromEnum::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRApplications::_GetApplicationsTransitionStateNameFromEnum*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVRApplications/_GetApplicationsTransitionStateNameFromEnum", object, method));
}
...
System::IAsyncResult* Valve::VR::IVRApplications::_GetApplicationsTransitionStateNameFromEnum::BeginInvoke(Valve::VR::EVRApplicationTransitionState state, System::AsyncCallback* callback, ::CsObject* object) {
