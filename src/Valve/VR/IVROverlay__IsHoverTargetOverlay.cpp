...
Valve::VR::IVROverlay::_IsHoverTargetOverlay* Valve::VR::IVROverlay::_IsHoverTargetOverlay::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_IsHoverTargetOverlay*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_IsHoverTargetOverlay", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_IsHoverTargetOverlay::BeginInvoke(uint64_t ulOverlayHandle, System::AsyncCallback* callback, ::CsObject* object) {
