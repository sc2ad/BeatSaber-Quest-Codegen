...
Valve::VR::CVROverlay::_PollNextOverlayEventPacked* Valve::VR::CVROverlay::_PollNextOverlayEventPacked::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::CVROverlay::_PollNextOverlayEventPacked::BeginInvoke(uint64_t ulOverlayHandle, Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::CsObject* object) {
