...
Valve::VR::IVROverlay::_GetOverlayDualAnalogTransform* Valve::VR::IVROverlay::_GetOverlayDualAnalogTransform::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_GetOverlayDualAnalogTransform::BeginInvoke(uint64_t ulOverlay, Valve::VR::EDualAnalogWhich eWhich, Valve::VR::HmdVector2_t& pvCenter, float& pfRadius, System::AsyncCallback* callback, ::CsObject* object) {
