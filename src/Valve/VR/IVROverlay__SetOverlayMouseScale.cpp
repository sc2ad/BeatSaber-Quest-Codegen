...
Valve::VR::IVROverlay::_SetOverlayMouseScale* Valve::VR::IVROverlay::_SetOverlayMouseScale::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayMouseScale::BeginInvoke(uint64_t ulOverlayHandle, Valve::VR::HmdVector2_t& pvecMouseScale, System::AsyncCallback* callback, ::CsObject* object) {
