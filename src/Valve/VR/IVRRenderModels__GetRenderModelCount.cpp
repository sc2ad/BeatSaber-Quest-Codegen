...
Valve::VR::IVRRenderModels::_GetRenderModelCount* Valve::VR::IVRRenderModels::_GetRenderModelCount::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetRenderModelCount").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IVRRenderModels::_GetRenderModelCount*>(object, method));
}
