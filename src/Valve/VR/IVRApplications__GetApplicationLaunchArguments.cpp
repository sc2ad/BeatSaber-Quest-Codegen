...
Valve::VR::IVRApplications::_GetApplicationLaunchArguments* Valve::VR::IVRApplications::_GetApplicationLaunchArguments::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVRApplications::_GetApplicationLaunchArguments::BeginInvoke(uint unHandle, System::Text::StringBuilder* pchArgs, uint unArgs, System::AsyncCallback* callback, ::CsObject* object) {
