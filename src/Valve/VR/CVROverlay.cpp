...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::FindOverlay(::CsString* pchOverlayKey, uint64_t& pOverlayHandle) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::CreateOverlay(::CsString* pchOverlayKey, ::CsString* pchOverlayName, uint64_t& pOverlayHandle) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::SetOverlayName(uint64_t ulOverlayHandle, ::CsString* pchName) {
...
::CsString* Valve::VR::CVROverlay::GetOverlayErrorNameFromEnum(Valve::VR::EVROverlayError error) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::SetOverlayRenderModel(uint64_t ulOverlayHandle, ::CsString* pchRenderModel, Valve::VR::HmdColor_t& pColor) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::SetOverlayTransformTrackedDeviceComponent(uint64_t ulOverlayHandle, uint unDeviceIndex, ::CsString* pchComponentName) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::SetOverlayFromFile(uint64_t ulOverlayHandle, ::CsString* pchFilePath) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::CreateDashboardOverlay(::CsString* pchOverlayKey, ::CsString* pchOverlayFriendlyName, uint64_t& pMainHandle, uint64_t& pThumbnailHandle) {
...
void Valve::VR::CVROverlay::ShowDashboard(::CsString* pchOverlayToShow) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::ShowKeyboard(int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue) {
...
Valve::VR::EVROverlayError Valve::VR::CVROverlay::ShowKeyboardForOverlay(uint64_t ulOverlayHandle, int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue) {
...
Valve::VR::VRMessageOverlayResponse Valve::VR::CVROverlay::ShowMessageOverlay(::CsString* pchText, ::CsString* pchCaption, ::CsString* pchButton0Text, ::CsString* pchButton1Text, ::CsString* pchButton2Text, ::CsString* pchButton3Text) {
