...
Valve::VR::RenderModel_t_Packed* Valve::VR::RenderModel_t_Packed::New_ctor(Valve::VR::RenderModel_t unpacked) {
  return (RenderModel_t_Packed*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "RenderModel_t_Packed", unpacked));
}
