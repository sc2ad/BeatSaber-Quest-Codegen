...
Valve::VR::IVROverlay::_SetOverlayNeighbor* Valve::VR::IVROverlay::_SetOverlayNeighbor::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVROverlay::_SetOverlayNeighbor*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVROverlay/_SetOverlayNeighbor", object, method));
}
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayNeighbor::BeginInvoke(Valve::VR::EOverlayDirection eDirection, uint64_t ulFrom, uint64_t ulTo, System::AsyncCallback* callback, ::CsObject* object) {
