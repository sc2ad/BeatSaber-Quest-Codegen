...
bool Valve::VR::IVRCompositor::_IsMirrorWindowVisible::Invoke() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_IsMirrorWindowVisible").WithContext("Invoke");
...
System::IAsyncResult* Valve::VR::IVRCompositor::_IsMirrorWindowVisible::BeginInvoke(System::AsyncCallback* callback, ::Il2CppObject* object) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_IsMirrorWindowVisible").WithContext("BeginInvoke");
...
bool Valve::VR::IVRCompositor::_IsMirrorWindowVisible::EndInvoke(System::IAsyncResult* result) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_IsMirrorWindowVisible").WithContext("EndInvoke");
