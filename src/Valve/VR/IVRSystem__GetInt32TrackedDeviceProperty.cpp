...
Valve::VR::IVRSystem::_GetInt32TrackedDeviceProperty* Valve::VR::IVRSystem::_GetInt32TrackedDeviceProperty::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetInt32TrackedDeviceProperty").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<IVRSystem::_GetInt32TrackedDeviceProperty*>(object, method));
}
...
int Valve::VR::IVRSystem::_GetInt32TrackedDeviceProperty::Invoke(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex, prop, pError)));
...
int Valve::VR::IVRSystem::_GetInt32TrackedDeviceProperty::EndInvoke(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(pError, result)));
