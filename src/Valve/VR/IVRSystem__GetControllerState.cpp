...
Valve::VR::IVRSystem::_GetControllerState* Valve::VR::IVRSystem::_GetControllerState::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSystem::_GetControllerState*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVRSystem/_GetControllerState", object, method));
}
...
System::IAsyncResult* Valve::VR::IVRSystem::_GetControllerState::BeginInvoke(uint unControllerDeviceIndex, Valve::VR::VRControllerState_t& pControllerState, uint unControllerStateSize, System::AsyncCallback* callback, ::CsObject* object) {
