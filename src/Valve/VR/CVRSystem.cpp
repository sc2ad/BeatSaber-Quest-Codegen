...
Valve::VR::CVRSystem* Valve::VR::CVRSystem::New_ctor(System::IntPtr pInterface) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("CVRSystem").WithContext(".ctor");
...
Valve::VR::HmdMatrix44_t Valve::VR::CVRSystem::GetProjectionMatrix(Valve::VR::EVREye eEye, float fNearZ, float fFarZ) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HmdMatrix44_t>(), "GetProjectionMatrix", {}, ::il2cpp_utils::ExtractTypes(eEye, fNearZ, fFarZ)));
...
Valve::VR::HmdMatrix34_t Valve::VR::CVRSystem::GetEyeToHeadTransform(Valve::VR::EVREye eEye) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HmdMatrix34_t>(), "GetEyeToHeadTransform", {}, ::il2cpp_utils::ExtractTypes(eEye)));
...
Valve::VR::HmdMatrix34_t Valve::VR::CVRSystem::GetSeatedZeroPoseToStandingAbsoluteTrackingPose() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HmdMatrix34_t>(), "GetSeatedZeroPoseToStandingAbsoluteTrackingPose", {}, ::il2cpp_utils::ExtractTypes()));
...
Valve::VR::HmdMatrix34_t Valve::VR::CVRSystem::GetRawZeroPoseToStandingAbsoluteTrackingPose() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HmdMatrix34_t>(), "GetRawZeroPoseToStandingAbsoluteTrackingPose", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<Valve::VR::HmdMatrix34_t, false>(this, ___internal__method);
}
...
Valve::VR::EDeviceActivityLevel Valve::VR::CVRSystem::GetTrackedDeviceActivityLevel(uint unDeviceId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EDeviceActivityLevel>(), "GetTrackedDeviceActivityLevel", {}, ::il2cpp_utils::ExtractTypes(unDeviceId)));
...
Valve::VR::ETrackedControllerRole Valve::VR::CVRSystem::GetControllerRoleForTrackedDeviceIndex(uint unDeviceIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::ETrackedControllerRole>(), "GetControllerRoleForTrackedDeviceIndex", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex)));
...
Valve::VR::ETrackedDeviceClass Valve::VR::CVRSystem::GetTrackedDeviceClass(uint unDeviceIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::ETrackedDeviceClass>(), "GetTrackedDeviceClass", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex)));
...
Valve::VR::HmdMatrix34_t Valve::VR::CVRSystem::GetMatrix34TrackedDeviceProperty(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HmdMatrix34_t>(), "GetMatrix34TrackedDeviceProperty", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex, prop, pError)));
...
Valve::VR::HiddenAreaMesh_t Valve::VR::CVRSystem::GetHiddenAreaMesh(Valve::VR::EVREye eEye, Valve::VR::EHiddenAreaMeshType type) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::HiddenAreaMesh_t>(), "GetHiddenAreaMesh", {}, ::il2cpp_utils::ExtractTypes(eEye, type)));
...
Valve::VR::EVRFirmwareError Valve::VR::CVRSystem::PerformFirmwareUpdate(uint unDeviceIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVRFirmwareError>(), "PerformFirmwareUpdate", {}, ::il2cpp_utils::ExtractTypes(unDeviceIndex)));
