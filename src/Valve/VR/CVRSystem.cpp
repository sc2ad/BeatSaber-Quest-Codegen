...
::CsString* Valve::VR::CVRSystem::GetPropErrorNameFromEnum(Valve::VR::ETrackedPropertyError error) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetPropErrorNameFromEnum", error));
}
...
::CsString* Valve::VR::CVRSystem::GetEventTypeNameFromEnum(Valve::VR::EVREventType eType) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetEventTypeNameFromEnum", eType));
}
...
::CsString* Valve::VR::CVRSystem::GetButtonIdNameFromEnum(Valve::VR::EVRButtonId eButtonId) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetButtonIdNameFromEnum", eButtonId));
}
// Autogenerated method: Valve.VR.CVRSystem.GetControllerAxisTypeNameFromEnum
::CsString* Valve::VR::CVRSystem::GetControllerAxisTypeNameFromEnum(Valve::VR::EVRControllerAxisType eAxisType) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetControllerAxisTypeNameFromEnum", eAxisType));
}
...
uint Valve::VR::CVRSystem::DriverDebugRequest(uint unDeviceIndex, ::CsString* pchRequest, System::Text::StringBuilder* pchResponseBuffer, uint unResponseBufferSize) {
