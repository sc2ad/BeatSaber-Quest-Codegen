...
Valve::VR::CVRChaperoneSetup* Valve::VR::CVRChaperoneSetup::New_ctor(System::IntPtr pInterface) {
  return (CVRChaperoneSetup*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "CVRChaperoneSetup", pInterface));
}
...
bool Valve::VR::CVRChaperoneSetup::ImportFromBufferToWorking(::CsString* pBuffer, uint nImportFlags) {
