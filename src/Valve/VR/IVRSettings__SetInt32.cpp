...
Valve::VR::IVRSettings::_SetInt32* Valve::VR::IVRSettings::_SetInt32::New_ctor(::CsObject* object, System::IntPtr method) {
  return (IVRSettings::_SetInt32*)THROW_UNLESS(il2cpp_utils::New("Valve.VR", "IVRSettings/_SetInt32", object, method));
}
// Autogenerated method: Valve.VR.IVRSettings/_SetInt32.Invoke
void Valve::VR::IVRSettings::_SetInt32::Invoke(::CsString* pchSection, ::CsString* pchSettingsKey, int nValue, Valve::VR::EVRSettingsError& peError) {
...
System::IAsyncResult* Valve::VR::IVRSettings::_SetInt32::BeginInvoke(::CsString* pchSection, ::CsString* pchSettingsKey, int nValue, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::CsObject* object) {
