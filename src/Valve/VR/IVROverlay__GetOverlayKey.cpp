...
Valve::VR::IVROverlay::_GetOverlayKey* Valve::VR::IVROverlay::_GetOverlayKey::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_GetOverlayKey::BeginInvoke(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::EVROverlayError& pError, System::AsyncCallback* callback, ::CsObject* object) {
