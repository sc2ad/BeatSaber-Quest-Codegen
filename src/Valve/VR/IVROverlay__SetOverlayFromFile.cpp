...
Valve::VR::IVROverlay::_SetOverlayFromFile* Valve::VR::IVROverlay::_SetOverlayFromFile::New_ctor(::CsObject* object, System::IntPtr method) {
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_SetOverlayFromFile::Invoke(uint64_t ulOverlayHandle, ::CsString* pchFilePath) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_SetOverlayFromFile::BeginInvoke(uint64_t ulOverlayHandle, ::CsString* pchFilePath, System::AsyncCallback* callback, ::CsObject* object) {
