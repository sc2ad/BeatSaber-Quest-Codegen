...
Valve::VR::IVROverlay::_GetOverlayTextureColorSpace* Valve::VR::IVROverlay::_GetOverlayTextureColorSpace::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_GetOverlayTextureColorSpace").WithContext(".ctor");
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_GetOverlayTextureColorSpace::Invoke(uint64_t ulOverlayHandle, Valve::VR::EColorSpace& peTextureColorSpace) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(ulOverlayHandle, peTextureColorSpace)));
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_GetOverlayTextureColorSpace::EndInvoke(Valve::VR::EColorSpace& peTextureColorSpace, System::IAsyncResult* result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Valve::VR::EVROverlayError>(), "EndInvoke", {}, ::il2cpp_utils::ExtractTypes(peTextureColorSpace, result)));
