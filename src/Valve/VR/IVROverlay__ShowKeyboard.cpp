...
Valve::VR::IVROverlay::_ShowKeyboard* Valve::VR::IVROverlay::_ShowKeyboard::New_ctor(::CsObject* object, System::IntPtr method) {
...
Valve::VR::EVROverlayError Valve::VR::IVROverlay::_ShowKeyboard::Invoke(int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue) {
...
System::IAsyncResult* Valve::VR::IVROverlay::_ShowKeyboard::BeginInvoke(int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue, System::AsyncCallback* callback, ::CsObject* object) {
