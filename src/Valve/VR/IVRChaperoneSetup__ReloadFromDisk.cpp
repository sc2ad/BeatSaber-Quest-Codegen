...
Valve::VR::IVRChaperoneSetup::_ReloadFromDisk* Valve::VR::IVRChaperoneSetup::_ReloadFromDisk::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<IVRChaperoneSetup::_ReloadFromDisk*>(object, method));
}
...
void Valve::VR::IVRChaperoneSetup::_ReloadFromDisk::Invoke(Valve::VR::EChaperoneConfigFile configFile) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(configFile)));
