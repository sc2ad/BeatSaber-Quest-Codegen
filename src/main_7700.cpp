...
Valve::VR::EVRScreenshotError Valve::VR::IVRScreenshots::_HookScreenshot::Invoke(ByRef<::ArrayWrapper<Valve::VR::EVRScreenshotType>> pSupportedTypes, int numTypes) {
...
System::IAsyncResult* Valve::VR::IVRScreenshots::_HookScreenshot::BeginInvoke(ByRef<::ArrayWrapper<Valve::VR::EVRScreenshotType>> pSupportedTypes, int numTypes, System::AsyncCallback* callback, ::Il2CppObject* object) {
...
void Valve::VR::CVRSystem::GetDeviceToAbsoluteTrackingPose(Valve::VR::ETrackingUniverseOrigin eOrigin, float fPredictedSecondsToPhotonsFromNow, ::ArrayWrapper<Valve::VR::TrackedDevicePose_t> pTrackedDevicePoseArray) {
...
uint Valve::VR::CVRSystem::GetSortedTrackedDeviceIndicesOfClass(Valve::VR::ETrackedDeviceClass eTrackedDeviceClass, ::ArrayWrapper<uint> punTrackedDeviceIndexArray, uint unRelativeToTrackedDeviceIndex) {
...
Valve::VR::EVRApplicationError Valve::VR::CVRApplications::LaunchTemplateApplication(::Il2CppString* pchTemplateAppKey, ::Il2CppString* pchNewAppKey, ::ArrayWrapper<Valve::VR::AppOverrideKeys_t> pKeys) {
...
bool Valve::VR::CVRChaperoneSetup::GetWorkingCollisionBoundsInfo(ByRef<::ArrayWrapper<Valve::VR::HmdQuad_t>> pQuadsBuffer) {
  static auto ___internal__logger = ::Logger::get().WithContext("Valve::VR::CVRChaperoneSetup::GetWorkingCollisionBoundsInfo");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "GetWorkingCollisionBoundsInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<::ArrayWrapper<Valve::VR::HmdQuad_t>&>()})));
  auto ___instance_arg = this;
...
bool Valve::VR::CVRChaperoneSetup::GetLiveCollisionBoundsInfo(ByRef<::ArrayWrapper<Valve::VR::HmdQuad_t>> pQuadsBuffer) {
  static auto ___internal__logger = ::Logger::get().WithContext("Valve::VR::CVRChaperoneSetup::GetLiveCollisionBoundsInfo");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "GetLiveCollisionBoundsInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<::ArrayWrapper<Valve::VR::HmdQuad_t>&>()})));
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, byref(pQuadsBuffer));
}
...
void Valve::VR::CVRChaperoneSetup::SetWorkingCollisionBoundsInfo(::ArrayWrapper<Valve::VR::HmdQuad_t> pQuadsBuffer) {
...
void Valve::VR::CVRChaperoneSetup::SetWorkingCollisionBoundsTagsInfo(::ArrayWrapper<uint8_t> pTagsBuffer) {
...
bool Valve::VR::CVRChaperoneSetup::GetLiveCollisionBoundsTagsInfo(ByRef<::ArrayWrapper<uint8_t>> pTagsBuffer) {
...
bool Valve::VR::CVRChaperoneSetup::SetWorkingPhysicalBoundsInfo(::ArrayWrapper<Valve::VR::HmdQuad_t> pQuadsBuffer) {
...
bool Valve::VR::CVRChaperoneSetup::GetLivePhysicalBoundsInfo(ByRef<::ArrayWrapper<Valve::VR::HmdQuad_t>> pQuadsBuffer) {
  static auto ___internal__logger = ::Logger::get().WithContext("Valve::VR::CVRChaperoneSetup::GetLivePhysicalBoundsInfo");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "GetLivePhysicalBoundsInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<::ArrayWrapper<Valve::VR::HmdQuad_t>&>()})));
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, byref(pQuadsBuffer));
}
...
Valve::VR::EVRCompositorError Valve::VR::CVRCompositor::WaitGetPoses(::ArrayWrapper<Valve::VR::TrackedDevicePose_t> pRenderPoseArray, ::ArrayWrapper<Valve::VR::TrackedDevicePose_t> pGamePoseArray) {
...
Valve::VR::EVRCompositorError Valve::VR::CVRCompositor::GetLastPoses(::ArrayWrapper<Valve::VR::TrackedDevicePose_t> pRenderPoseArray, ::ArrayWrapper<Valve::VR::TrackedDevicePose_t> pGamePoseArray) {
...
Valve::VR::EVRCompositorError Valve::VR::CVRCompositor::SetSkyboxOverride(::ArrayWrapper<Valve::VR::Texture_t> pTextures) {
