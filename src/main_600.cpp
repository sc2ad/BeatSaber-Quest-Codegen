...
::Il2CppString* Org::BouncyCastle::Asn1::DerGeneralizedTime::Convert(int time) {
  ...
  return ::il2cpp_utils::RunMethodRethrow<::Il2CppString*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, time);
}
...
::Il2CppString* Org::BouncyCastle::Asn1::DerGeneralizedTime::FString(int count) {
  ...
  return ::il2cpp_utils::RunMethodRethrow<::Il2CppString*, false>(this, ___internal__method, count);
}
