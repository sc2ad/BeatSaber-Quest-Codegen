...
void GlobalNamespace::MultiplayerConnectedPlayerNoteEventManager::HandleNoteWasCut(::StringW userId, float syncTime, float songTime, GlobalNamespace::NoteCutInfoNetSerializable* noteCutInfo) {
...
void GlobalNamespace::MultiplayerConnectedPlayerNoteEventManager::HandleNoteWasMissed(::StringW userId, float syncTime, float songTime, GlobalNamespace::NoteMissInfoNetSerializable* noteMissInfo) {
