...
NUnit::Framework::Constraints::IConstraint* NUnit::Framework::Constraints::ConstraintBuilder::Resolve() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<NUnit::Framework::Constraints::IConstraint*>(), "Resolve", {}, ::il2cpp_utils::ExtractTypes()));
...
bool NUnit::Framework::Constraints::ConstraintBuilder::get_IsResolvable() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_IsResolvable", {}, ::il2cpp_utils::ExtractTypes()));
