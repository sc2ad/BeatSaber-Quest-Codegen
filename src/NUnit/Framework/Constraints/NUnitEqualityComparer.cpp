...
bool NUnit::Framework::Constraints::NUnitEqualityComparer::AreEqual(::CsObject* x, ::CsObject* y, NUnit::Framework::Constraints::Tolerance*& tolerance) {
...
bool NUnit::Framework::Constraints::NUnitEqualityComparer::InvokeFirstIEquatableEqualsSecond(::CsObject* first, ::CsObject* second, System::Reflection::MethodInfo* equals) {
...
NUnit::Framework::Constraints::EqualityAdapter* NUnit::Framework::Constraints::NUnitEqualityComparer::GetExternalComparer(::CsObject* x, ::CsObject* y) {
...
bool NUnit::Framework::Constraints::NUnitEqualityComparer::StringsEqual(::CsString* x, ::CsString* y) {
