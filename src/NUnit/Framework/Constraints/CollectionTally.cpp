...
NUnit::Framework::Constraints::CollectionTally* NUnit::Framework::Constraints::CollectionTally::New_ctor(NUnit::Framework::Constraints::NUnitEqualityComparer* comparer, System::Collections::IEnumerable* c) {
  return (CollectionTally*)THROW_UNLESS(il2cpp_utils::New("NUnit.Framework.Constraints", "CollectionTally", comparer, c));
}
...
bool NUnit::Framework::Constraints::CollectionTally::ItemsEqual(::CsObject* expected, ::CsObject* actual) {
...
bool NUnit::Framework::Constraints::CollectionTally::TryRemove(::CsObject* o) {
