...
NUnit::Framework::Interfaces::ITest* NUnit::Framework::Api::DefaultTestAssemblyBuilder::Build(System::Reflection::Assembly* assembly, System::Collections::Generic::IDictionary_2<::CsString*, ::CsObject*>* options) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<NUnit::Framework::Interfaces::ITest*>(this, "Build", assembly, options));
}
// Autogenerated method: NUnit.Framework.Api.DefaultTestAssemblyBuilder.Build
NUnit::Framework::Internal::TestSuite* NUnit::Framework::Api::DefaultTestAssemblyBuilder::Build(System::Reflection::Assembly* assembly, ::CsString* assemblyPath, System::Collections::Generic::IDictionary_2<::CsString*, ::CsObject*>* options) {
...
NUnit::Framework::Internal::TestSuite* NUnit::Framework::Api::DefaultTestAssemblyBuilder::BuildTestAssembly(System::Reflection::Assembly* assembly, ::CsString* assemblyName, System::Collections::Generic::IList_1<NUnit::Framework::Internal::Test*>* fixtures) {
