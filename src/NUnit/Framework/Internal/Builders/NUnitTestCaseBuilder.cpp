...
NUnit::Framework::Internal::TestMethod* NUnit::Framework::Internal::Builders::NUnitTestCaseBuilder::BuildTestMethod(NUnit::Framework::Interfaces::IMethodInfo* method, NUnit::Framework::Internal::Test* parentSuite, NUnit::Framework::Internal::TestCaseParameters* parms) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<NUnit::Framework::Internal::TestMethod*>(), "BuildTestMethod", {}, ::il2cpp_utils::ExtractTypes(method, parentSuite, parms)));
...
bool NUnit::Framework::Internal::Builders::NUnitTestCaseBuilder::CheckTestMethodSignature(NUnit::Framework::Internal::TestMethod* testMethod, NUnit::Framework::Internal::TestCaseParameters* parms) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Internal.Builders", "NUnitTestCaseBuilder", il2cpp_utils::NoArgClass<bool>(), "CheckTestMethodSignature", {}, ::il2cpp_utils::ExtractTypes(testMethod, parms)));
...
bool NUnit::Framework::Internal::Builders::NUnitTestCaseBuilder::MarkAsNotRunnable(NUnit::Framework::Internal::TestMethod* testMethod, ::Il2CppString* reason) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Internal.Builders", "NUnitTestCaseBuilder", il2cpp_utils::NoArgClass<bool>(), "MarkAsNotRunnable", {}, ::il2cpp_utils::ExtractTypes(testMethod, reason)));
...
NUnit::Framework::Internal::Builders::NUnitTestCaseBuilder* NUnit::Framework::Internal::Builders::NUnitTestCaseBuilder::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Internal::Builders").WithContext("NUnitTestCaseBuilder").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<NUnitTestCaseBuilder*>());
}
