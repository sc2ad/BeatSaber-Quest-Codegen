...
::CsString* NUnit::Framework::Internal::MethodWrapper::get_Name() {
...
::CsObject* NUnit::Framework::Internal::MethodWrapper::Invoke(::CsObject* fixture, ::Array<::CsObject*>* args) {
...
::CsString* NUnit::Framework::Internal::MethodWrapper::ToString() {
