...
::CsString* NUnit::Framework::Internal::TextMessageWriter::_get_Pfx_Expected() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("NUnit.Framework.Internal", "TextMessageWriter", "Pfx_Expected"));
}
// Autogenerated static field setter
// Set static field: static public readonly System.String Pfx_Expected
void NUnit::Framework::Internal::TextMessageWriter::_set_Pfx_Expected(::CsString* value) {
...
::CsString* NUnit::Framework::Internal::TextMessageWriter::_get_Pfx_Actual() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("NUnit.Framework.Internal", "TextMessageWriter", "Pfx_Actual"));
}
// Autogenerated static field setter
// Set static field: static public readonly System.String Pfx_Actual
void NUnit::Framework::Internal::TextMessageWriter::_set_Pfx_Actual(::CsString* value) {
...
NUnit::Framework::Internal::TextMessageWriter* NUnit::Framework::Internal::TextMessageWriter::New_ctor(::CsString* userMessage, ::Array<::CsObject*>* args) {
...
// Autogenerated method: NUnit.Framework.Internal.TextMessageWriter.WriteExpectedLine
void NUnit::Framework::Internal::TextMessageWriter::WriteExpectedLine(::CsObject* expected) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "WriteExpectedLine", expected));
}
// Autogenerated method: NUnit.Framework.Internal.TextMessageWriter.WriteExpectedLine
void NUnit::Framework::Internal::TextMessageWriter::WriteExpectedLine(::CsObject* expected, NUnit::Framework::Constraints::Tolerance* tolerance) {
...
// Autogenerated method: NUnit.Framework.Internal.TextMessageWriter.WriteActualLine
void NUnit::Framework::Internal::TextMessageWriter::WriteActualLine(::CsObject* actual) {
...
void NUnit::Framework::Internal::TextMessageWriter::WriteMessageLine(int level, ::CsString* message, ::Array<::CsObject*>* args) {
...
// Autogenerated method: NUnit.Framework.Internal.TextMessageWriter.DisplayDifferences
void NUnit::Framework::Internal::TextMessageWriter::DisplayDifferences(::CsObject* expected, ::CsObject* actual) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "DisplayDifferences", expected, actual));
}
// Autogenerated method: NUnit.Framework.Internal.TextMessageWriter.DisplayDifferences
void NUnit::Framework::Internal::TextMessageWriter::DisplayDifferences(::CsObject* expected, ::CsObject* actual, NUnit::Framework::Constraints::Tolerance* tolerance) {
...
void NUnit::Framework::Internal::TextMessageWriter::DisplayStringDifferences(::CsString* expected, ::CsString* actual, int mismatch, bool ignoreCase, bool clipping) {
...
void NUnit::Framework::Internal::TextMessageWriter::WriteActualValue(::CsObject* actual) {
...
void NUnit::Framework::Internal::TextMessageWriter::WriteValue(::CsObject* val) {
