...
::CsString* NUnit::Framework::Internal::TestExecutionContext::_get_CONTEXT_KEY() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("NUnit.Framework.Internal", "TestExecutionContext", "CONTEXT_KEY"));
}
// Autogenerated static field setter
// Set static field: static private readonly System.String CONTEXT_KEY
void NUnit::Framework::Internal::TestExecutionContext::_set_CONTEXT_KEY(::CsString* value) {
...
::CsString* NUnit::Framework::Internal::TestExecutionContext::$_ctor$b__0(::CsObject* val) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Internal", "TestExecutionContext", "<.ctor>b__0", val)));
}
...
NUnit::Framework::Internal::TestExecutionContext* NUnit::Framework::Internal::TestExecutionContext::New_ctor() {
  return (TestExecutionContext*)THROW_UNLESS(il2cpp_utils::New("NUnit.Framework.Internal", "TestExecutionContext"));
}
...
::CsObject* NUnit::Framework::Internal::TestExecutionContext::get_TestObject() {
...
void NUnit::Framework::Internal::TestExecutionContext::set_TestObject(::CsObject* value) {
...
::CsObject* NUnit::Framework::Internal::TestExecutionContext::InitializeLifetimeService() {
