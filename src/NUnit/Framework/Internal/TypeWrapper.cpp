...
::CsString* NUnit::Framework::Internal::TypeWrapper::get_FullName() {
...
::CsString* NUnit::Framework::Internal::TypeWrapper::get_Namespace() {
...
::CsString* NUnit::Framework::Internal::TypeWrapper::GetDisplayName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetDisplayName"));
}
// Autogenerated method: NUnit.Framework.Internal.TypeWrapper.GetDisplayName
::CsString* NUnit::Framework::Internal::TypeWrapper::GetDisplayName(::Array<::CsObject*>* args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetDisplayName", args));
}
...
::CsObject* NUnit::Framework::Internal::TypeWrapper::Construct(::Array<::CsObject*>* args) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "Construct", args));
}
// Autogenerated method: NUnit.Framework.Internal.TypeWrapper.ToString
::CsString* NUnit::Framework::Internal::TypeWrapper::ToString() {
