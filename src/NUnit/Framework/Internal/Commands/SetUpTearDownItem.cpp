...
::CsObject* NUnit::Framework::Internal::Commands::SetUpTearDownItem::RunNonAsyncMethod(System::Reflection::MethodInfo* method, NUnit::Framework::Internal::ITestExecutionContext* context) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "RunNonAsyncMethod", method, context));
}
