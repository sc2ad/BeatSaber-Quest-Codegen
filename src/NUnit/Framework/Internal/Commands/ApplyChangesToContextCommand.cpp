...
NUnit::Framework::Internal::Commands::ApplyChangesToContextCommand* NUnit::Framework::Internal::Commands::ApplyChangesToContextCommand::New_ctor(NUnit::Framework::Internal::Commands::TestCommand* innerCommand, System::Collections::Generic::IEnumerable_1<NUnit::Framework::Interfaces::IApplyToContext*>* changes) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ApplyChangesToContextCommand*>(innerCommand, changes));
}
...
void NUnit::Framework::Internal::Commands::ApplyChangesToContextCommand::ApplyChanges(NUnit::Framework::Internal::ITestExecutionContext* context) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ApplyChanges", {}, ::il2cpp_utils::ExtractTypes(context)));
