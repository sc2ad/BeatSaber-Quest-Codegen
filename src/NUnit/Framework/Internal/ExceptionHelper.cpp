...
::CsString* NUnit::Framework::Internal::ExceptionHelper::BuildMessage(System::Exception* exception) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Internal", "ExceptionHelper", "BuildMessage", exception));
}
// Autogenerated method: NUnit.Framework.Internal.ExceptionHelper.BuildStackTrace
::CsString* NUnit::Framework::Internal::ExceptionHelper::BuildStackTrace(System::Exception* exception) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Internal", "ExceptionHelper", "BuildStackTrace", exception));
}
// Autogenerated method: NUnit.Framework.Internal.ExceptionHelper.GetStackTrace
::CsString* NUnit::Framework::Internal::ExceptionHelper::GetStackTrace(System::Exception* exception) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Internal", "ExceptionHelper", "GetStackTrace", exception));
}
