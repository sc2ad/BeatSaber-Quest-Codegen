...
::Il2CppString* NUnit::Framework::Internal::TypeHelper::GetDisplayName(System::Type* type) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("NUnit.Framework.Internal", "TypeHelper", "GetDisplayName", type));
}
// Autogenerated method: NUnit.Framework.Internal.TypeHelper.GetDisplayName
::Il2CppString* NUnit::Framework::Internal::TypeHelper::GetDisplayName(System::Type* type, ::Array<::Il2CppObject*>* arglist) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("NUnit.Framework.Internal", "TypeHelper", "GetDisplayName", type, arglist));
}
