...
NUnit::Framework::Internal::Logger* NUnit::Framework::Internal::InternalTrace::GetLogger(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Internal", "InternalTrace", il2cpp_utils::NoArgClass<NUnit::Framework::Internal::Logger*>(), "GetLogger", {}, ::il2cpp_utils::ExtractTypes(name)));
...
NUnit::Framework::Internal::Logger* NUnit::Framework::Internal::InternalTrace::GetLogger(System::Type* type) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Internal").WithContext("InternalTrace").WithContext("GetLogger");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Internal", "InternalTrace", il2cpp_utils::NoArgClass<NUnit::Framework::Internal::Logger*>(), "GetLogger", {}, ::il2cpp_utils::ExtractTypes(type)));
