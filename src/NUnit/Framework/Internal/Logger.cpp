...
NUnit::Framework::Internal::Logger* NUnit::Framework::Internal::Logger::New_ctor(::Il2CppString* name, NUnit::Framework::Internal::InternalTraceLevel level, System::IO::TextWriter* writer) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Logger*>(name, level, writer));
}
...
void NUnit::Framework::Internal::Logger::Error(::Il2CppString* message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Error", {}, ::il2cpp_utils::ExtractTypes(message)));
...
void NUnit::Framework::Internal::Logger::Debug(::Il2CppString* message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Debug", {}, ::il2cpp_utils::ExtractTypes(message)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, message);
}
// Autogenerated method: NUnit.Framework.Internal.Logger.Debug
void NUnit::Framework::Internal::Logger::Debug(::Il2CppString* message, ::Array<::Il2CppObject*>* args) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Internal").WithContext("Logger").WithContext("Debug");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Debug", {}, ::il2cpp_utils::ExtractTypes(message, args)));
...
void NUnit::Framework::Internal::Logger::Log(NUnit::Framework::Internal::InternalTraceLevel level, ::Il2CppString* message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Log", {}, ::il2cpp_utils::ExtractTypes(level, message)));
...
void NUnit::Framework::Internal::Logger::Log(NUnit::Framework::Internal::InternalTraceLevel level, ::Il2CppString* format, ::Array<::Il2CppObject*>* args) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Internal").WithContext("Logger").WithContext("Log");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Log", {}, ::il2cpp_utils::ExtractTypes(level, format, args)));
...
void NUnit::Framework::Internal::Logger::WriteLog(NUnit::Framework::Internal::InternalTraceLevel level, ::Il2CppString* message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "WriteLog", {}, ::il2cpp_utils::ExtractTypes(level, message)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, level, message);
}
...
void NUnit::Framework::Internal::Logger::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Internal", "Logger", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
