...
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::New_ctor(::CsString* name) {
  return (TNode*)THROW_UNLESS(il2cpp_utils::New("NUnit.Framework.Interfaces", "TNode", name));
}
// Autogenerated method: NUnit.Framework.Interfaces.TNode..ctor
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::New_ctor(::CsString* name, ::CsString* value) {
  return (TNode*)THROW_UNLESS(il2cpp_utils::New("NUnit.Framework.Interfaces", "TNode", name, value));
}
// Autogenerated method: NUnit.Framework.Interfaces.TNode..ctor
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::New_ctor(::CsString* name, ::CsString* value, bool valueIsCDATA) {
...
::CsString* NUnit::Framework::Interfaces::TNode::get_Name() {
...
void NUnit::Framework::Interfaces::TNode::set_Value(::CsString* value) {
...
::CsString* NUnit::Framework::Interfaces::TNode::get_OuterXml() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_OuterXml"));
}
// Autogenerated method: NUnit.Framework.Interfaces.TNode.AddElement
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::AddElement(::CsString* name) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<NUnit::Framework::Interfaces::TNode*>(this, "AddElement", name));
}
// Autogenerated method: NUnit.Framework.Interfaces.TNode.AddElement
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::AddElement(::CsString* name, ::CsString* value) {
...
NUnit::Framework::Interfaces::TNode* NUnit::Framework::Interfaces::TNode::AddElementWithCDATA(::CsString* name, ::CsString* value) {
...
void NUnit::Framework::Interfaces::TNode::AddAttribute(::CsString* name, ::CsString* value) {
...
::CsString* NUnit::Framework::Interfaces::TNode::EscapeInvalidXmlCharacters(::CsString* str) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Interfaces", "TNode", "EscapeInvalidXmlCharacters", str));
}
// Autogenerated method: NUnit.Framework.Interfaces.TNode.CharToUnicodeSequence
::CsString* NUnit::Framework::Interfaces::TNode::CharToUnicodeSequence(::Il2CppChar symbol) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Interfaces", "TNode", "CharToUnicodeSequence", symbol));
}
...
::CsString* NUnit::Framework::Interfaces::TNode::$EscapeInvalidXmlCharacters$b__0(System::Text::RegularExpressions::Match* match) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<::CsString*>("NUnit.Framework.Interfaces", "TNode", "<EscapeInvalidXmlCharacters>b__0", match)));
}
