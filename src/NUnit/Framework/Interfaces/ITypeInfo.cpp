...
::CsString* NUnit::Framework::Interfaces::ITypeInfo::get_FullName() {
...
::CsString* NUnit::Framework::Interfaces::ITypeInfo::get_Namespace() {
...
::CsString* NUnit::Framework::Interfaces::ITypeInfo::GetDisplayName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetDisplayName"));
}
// Autogenerated method: NUnit.Framework.Interfaces.ITypeInfo.GetDisplayName
::CsString* NUnit::Framework::Interfaces::ITypeInfo::GetDisplayName(::Array<::CsObject*>* args) {
...
::CsObject* NUnit::Framework::Interfaces::ITypeInfo::Construct(::Array<::CsObject*>* args) {
