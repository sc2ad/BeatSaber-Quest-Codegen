...
NUnit::Framework::Interfaces::ResultState* NUnit::Framework::Interfaces::ResultState::New_ctor(NUnit::Framework::Interfaces::TestStatus status) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ResultState*>(status));
}
// Autogenerated method: NUnit.Framework.Interfaces.ResultState..ctor
NUnit::Framework::Interfaces::ResultState* NUnit::Framework::Interfaces::ResultState::New_ctor(NUnit::Framework::Interfaces::TestStatus status, ::Il2CppString* label) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Interfaces").WithContext("ResultState").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ResultState*>(status, label));
}
// Autogenerated method: NUnit.Framework.Interfaces.ResultState..ctor
NUnit::Framework::Interfaces::ResultState* NUnit::Framework::Interfaces::ResultState::New_ctor(NUnit::Framework::Interfaces::TestStatus status, ::Il2CppString* label, NUnit::Framework::Interfaces::FailureSite site) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework::Interfaces").WithContext("ResultState").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<ResultState*>(status, label, site));
}
...
NUnit::Framework::Interfaces::TestStatus NUnit::Framework::Interfaces::ResultState::get_Status() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<NUnit::Framework::Interfaces::TestStatus>(), "get_Status", {}, ::il2cpp_utils::ExtractTypes()));
...
::Il2CppString* NUnit::Framework::Interfaces::ResultState::get_Label() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "get_Label", {}, ::il2cpp_utils::ExtractTypes()));
...
NUnit::Framework::Interfaces::FailureSite NUnit::Framework::Interfaces::ResultState::get_Site() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<NUnit::Framework::Interfaces::FailureSite>(), "get_Site", {}, ::il2cpp_utils::ExtractTypes()));
...
void NUnit::Framework::Interfaces::ResultState::set_Site(NUnit::Framework::Interfaces::FailureSite value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_Site", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
NUnit::Framework::Interfaces::ResultState* NUnit::Framework::Interfaces::ResultState::WithSite(NUnit::Framework::Interfaces::FailureSite site) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<NUnit::Framework::Interfaces::ResultState*>(), "WithSite", {}, ::il2cpp_utils::ExtractTypes(site)));
...
void NUnit::Framework::Interfaces::ResultState::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Framework.Interfaces", "ResultState", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
