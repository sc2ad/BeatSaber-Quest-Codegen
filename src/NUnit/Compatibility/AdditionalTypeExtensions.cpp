...
bool NUnit::Compatibility::AdditionalTypeExtensions::ParametersMatch(::Array<System::Reflection::ParameterInfo*>* pinfos, ::Array<System::Type*>* ptypes) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Compatibility", "AdditionalTypeExtensions", il2cpp_utils::NoArgClass<bool>(), "ParametersMatch", {}, ::il2cpp_utils::ExtractTypes(pinfos, ptypes)));
...
bool NUnit::Compatibility::AdditionalTypeExtensions::IsCastableFrom(System::Type* to, System::Type* from) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Compatibility", "AdditionalTypeExtensions", il2cpp_utils::NoArgClass<bool>(), "IsCastableFrom", {}, ::il2cpp_utils::ExtractTypes(to, from)));
...
void NUnit::Compatibility::AdditionalTypeExtensions::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("NUnit.Compatibility", "AdditionalTypeExtensions", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
