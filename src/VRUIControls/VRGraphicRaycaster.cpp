...
void VRUIControls::VRGraphicRaycaster::RaycastCanvas(UnityEngine::Canvas* canvas, UnityEngine::Ray ray, float hitDistance, float curvedUIRadius, System::Collections::Generic::List_1<VRUIControls::VRGraphicRaycaster::VRGraphicRaycastResult>* results) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("VRUIControls", "VRGraphicRaycaster", il2cpp_utils::NoArgClass<void>(), "RaycastCanvas", {}, ::il2cpp_utils::ExtractTypes(canvas, ray, hitDistance, curvedUIRadius, results)));
...
VRUIControls::VRGraphicRaycaster* VRUIControls::VRGraphicRaycaster::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("VRUIControls").WithContext("VRGraphicRaycaster").WithContext(".ctor");
...
void VRUIControls::VRGraphicRaycaster::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("VRUIControls", "VRGraphicRaycaster", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
