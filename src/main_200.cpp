...
::ArrayW<GlobalNamespace::EncryptionUtility::IEncryptionState*> GlobalNamespace::PacketEncryptionLayer::PendingEncryptionStateList::GetSortedEncryptionStates(int port) {
  ...
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<GlobalNamespace::EncryptionUtility::IEncryptionState*>, false>(___instance_arg, ___internal__method, port);
}
...
::ArrayW<uint8_t> GlobalNamespace::SecureRandomProvider::GetBytes(int length) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<uint8_t>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, length);
}
