...
bool Oculus::Platform::AndroidPlatform::Initialize(::CsString* appId) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* Oculus::Platform::AndroidPlatform::AsyncInitialize(::CsString* appId) {
