...
Oculus::Platform::Request* Oculus::Platform::Entitlements::IsUserEntitledToApplication() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Entitlements", il2cpp_utils::NoArgClass<Oculus::Platform::Request*>(), "IsUserEntitledToApplication", {}, ::il2cpp_utils::ExtractTypes()));
