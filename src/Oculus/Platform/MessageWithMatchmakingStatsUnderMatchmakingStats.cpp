...
Oculus::Platform::Models::MatchmakingStats* Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats::GetDataFromMessage(System::IntPtr c_message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Oculus::Platform::Models::MatchmakingStats*>(), "GetDataFromMessage", {}, ::il2cpp_utils::ExtractTypes(c_message)));
...
Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats* Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats::New_ctor(System::IntPtr c_message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("MessageWithMatchmakingStatsUnderMatchmakingStats").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MessageWithMatchmakingStatsUnderMatchmakingStats*>(c_message));
}
