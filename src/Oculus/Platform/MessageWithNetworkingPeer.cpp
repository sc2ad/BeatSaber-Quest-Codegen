...
Oculus::Platform::Models::NetworkingPeer* Oculus::Platform::MessageWithNetworkingPeer::GetDataFromMessage(System::IntPtr c_message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Oculus::Platform::Models::NetworkingPeer*>(), "GetDataFromMessage", {}, ::il2cpp_utils::ExtractTypes(c_message)));
...
Oculus::Platform::MessageWithNetworkingPeer* Oculus::Platform::MessageWithNetworkingPeer::New_ctor(System::IntPtr c_message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("MessageWithNetworkingPeer").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MessageWithNetworkingPeer*>(c_message));
}
