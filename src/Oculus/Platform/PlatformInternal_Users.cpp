...
Oculus::Platform::Request_1<Oculus::Platform::Models::LinkedAccountList*>* Oculus::Platform::PlatformInternal::Users::GetLinkedAccounts(::Array<Oculus::Platform::ServiceProvider>* providers) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "PlatformInternal/Users", il2cpp_utils::NoArgClass<Oculus::Platform::Request_1<Oculus::Platform::Models::LinkedAccountList*>*>(), "GetLinkedAccounts", {}, ::il2cpp_utils::ExtractTypes(providers)));
