...
::Il2CppString* Oculus::Platform::MessageWithString::GetDataFromMessage(System::IntPtr c_message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetDataFromMessage", {}, ::il2cpp_utils::ExtractTypes(c_message)));
...
Oculus::Platform::MessageWithString* Oculus::Platform::MessageWithString::New_ctor(System::IntPtr c_message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("MessageWithString").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MessageWithString*>(c_message));
}
