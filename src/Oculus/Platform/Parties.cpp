...
Oculus::Platform::Request_1<Oculus::Platform::Models::Party*>* Oculus::Platform::Parties::GetCurrent() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Parties", il2cpp_utils::NoArgClass<Oculus::Platform::Request_1<Oculus::Platform::Models::Party*>*>(), "GetCurrent", {}, ::il2cpp_utils::ExtractTypes()));
...
void Oculus::Platform::Parties::SetPartyUpdateNotificationCallback(typename Oculus::Platform::Message_1<Oculus::Platform::Models::PartyUpdateNotification*>::Callback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Parties", il2cpp_utils::NoArgClass<void>(), "SetPartyUpdateNotificationCallback", {}, ::il2cpp_utils::ExtractTypes(callback)));
