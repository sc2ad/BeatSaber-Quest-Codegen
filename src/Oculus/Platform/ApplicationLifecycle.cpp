...
Oculus::Platform::Models::LaunchDetails* Oculus::Platform::ApplicationLifecycle::GetLaunchDetails() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "ApplicationLifecycle", il2cpp_utils::NoArgClass<Oculus::Platform::Models::LaunchDetails*>(), "GetLaunchDetails", {}, ::il2cpp_utils::ExtractTypes()));
...
void Oculus::Platform::ApplicationLifecycle::SetLaunchIntentChangedNotificationCallback(typename Oculus::Platform::Message_1<::Il2CppString*>::Callback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "ApplicationLifecycle", il2cpp_utils::NoArgClass<void>(), "SetLaunchIntentChangedNotificationCallback", {}, ::il2cpp_utils::ExtractTypes(callback)));
