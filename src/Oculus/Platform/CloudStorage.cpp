...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageUpdateResponse*>* Oculus::Platform::CloudStorage::Delete(::CsString* bucket, ::CsString* key) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageData*>* Oculus::Platform::CloudStorage::Load(::CsString* bucket, ::CsString* key) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageMetadataList*>* Oculus::Platform::CloudStorage::LoadBucketMetadata(::CsString* bucket) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageConflictMetadata*>* Oculus::Platform::CloudStorage::LoadConflictMetadata(::CsString* bucket, ::CsString* key) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageData*>* Oculus::Platform::CloudStorage::LoadHandle(::CsString* handle) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageMetadata*>* Oculus::Platform::CloudStorage::LoadMetadata(::CsString* bucket, ::CsString* key) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageUpdateResponse*>* Oculus::Platform::CloudStorage::ResolveKeepLocal(::CsString* bucket, ::CsString* key, ::CsString* remoteHandle) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageUpdateResponse*>* Oculus::Platform::CloudStorage::ResolveKeepRemote(::CsString* bucket, ::CsString* key, ::CsString* remoteHandle) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::CloudStorageUpdateResponse*>* Oculus::Platform::CloudStorage::Save(::CsString* bucket, ::CsString* key, ::Array<uint8_t>* data, int64_t counter, ::CsString* extraData) {
