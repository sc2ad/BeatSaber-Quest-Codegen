...
Oculus::Platform::Models::AchievementProgressList* Oculus::Platform::MessageWithAchievementProgressList::GetDataFromMessage(System::IntPtr c_message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Oculus::Platform::Models::AchievementProgressList*>(), "GetDataFromMessage", {}, ::il2cpp_utils::ExtractTypes(c_message)));
...
Oculus::Platform::MessageWithAchievementProgressList* Oculus::Platform::MessageWithAchievementProgressList::New_ctor(System::IntPtr c_message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("MessageWithAchievementProgressList").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MessageWithAchievementProgressList*>(c_message));
}
