...
::CsString* Oculus::Platform::PlatformSettings::get_AppID() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "PlatformSettings", "get_AppID"));
}
// Autogenerated method: Oculus.Platform.PlatformSettings.set_AppID
void Oculus::Platform::PlatformSettings::set_AppID(::CsString* value) {
...
::CsString* Oculus::Platform::PlatformSettings::get_MobileAppID() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "PlatformSettings", "get_MobileAppID"));
}
// Autogenerated method: Oculus.Platform.PlatformSettings.set_MobileAppID
void Oculus::Platform::PlatformSettings::set_MobileAppID(::CsString* value) {
