...
::CsString* Oculus::Platform::CAPI::_get_DLL_NAME() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("Oculus.Platform", "CAPI", "DLL_NAME"));
}
// Autogenerated static field setter
// Set static field: static public System.String DLL_NAME
void Oculus::Platform::CAPI::_set_DLL_NAME(::CsString* value) {
...
::Array<Oculus::Platform::CAPI::ovrKeyValuePair>* Oculus::Platform::CAPI::DictionaryToOVRKeyValuePairs(System::Collections::Generic::Dictionary_2<::CsString*, ::CsObject*>* dict) {
...
System::Collections::Generic::Dictionary_2<::CsString*, ::CsString*>* Oculus::Platform::CAPI::DataStoreFromNative(System::IntPtr pointer) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<System::Collections::Generic::Dictionary_2<::CsString*, ::CsString*>*>("Oculus.Platform", "CAPI", "DataStoreFromNative", pointer)));
}
// Autogenerated method: Oculus.Platform.CAPI.StringFromNative
::CsString* Oculus::Platform::CAPI::StringFromNative(System::IntPtr pointer) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "StringFromNative", pointer));
}
...
System::IntPtr Oculus::Platform::CAPI::StringToNative(::CsString* s) {
...
bool Oculus::Platform::CAPI::ovr_UnityInitWrapper(::CsString* appId) {
...
uint64_t Oculus::Platform::CAPI::ovr_UnityInitWrapperAsynchronous(::CsString* appId) {
...
bool Oculus::Platform::CAPI::ovr_UnityInitWrapperStandalone(::CsString* accessToken, System::IntPtr loggingCB) {
...
uint64_t Oculus::Platform::CAPI::ovr_PlatformInitializeWithAccessToken(uint64_t appId, ::CsString* accessToken) {
...
bool Oculus::Platform::CAPI::ovr_UnityInitWrapperWindows(::CsString* appId, System::IntPtr loggingCB) {
...
uint64_t Oculus::Platform::CAPI::ovr_UnityInitWrapperWindowsAsynchronous(::CsString* appId, System::IntPtr loggingCB) {
...
bool Oculus::Platform::CAPI::ovr_SetDeveloperAccessToken(::CsString* accessToken) {
...
::CsString* Oculus::Platform::CAPI::ovr_GetLoggedInUserLocale() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_GetLoggedInUserLocale"));
}
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_GetWithMessageType(::CsString* url, int messageType) {
...
void Oculus::Platform::CAPI::LogNewEvent(::CsString* eventName, System::Collections::Generic::Dictionary_2<::CsString*, ::CsString*>* values) {
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_StartTransfer(::CsString* url, ::Array<Oculus::Platform::CAPI::ovrKeyValuePair>* headers) {
...
::CsString* Oculus::Platform::CAPI::ovr_Message_GetStringForJavascript(System::IntPtr message) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Message_GetStringForJavascript", message));
}
...
uint64_t Oculus::Platform::CAPI::ovr_Achievements_AddCount(::CsString* name, uint64_t count) {
...
uint64_t Oculus::Platform::CAPI::ovr_Achievements_AddFields(::CsString* name, ::CsString* fields) {
...
uint64_t Oculus::Platform::CAPI::ovr_Achievements_GetDefinitionsByName(::Array<::CsString*>* names, int count) {
...
uint64_t Oculus::Platform::CAPI::ovr_Achievements_GetProgressByName(::Array<::CsString*>* names, int count) {
...
uint64_t Oculus::Platform::CAPI::ovr_Achievements_Unlock(::CsString* name) {
...
uint64_t Oculus::Platform::CAPI::ovr_ApplicationLifecycle_RegisterSessionKey(::CsString* sessionKey) {
...
uint64_t Oculus::Platform::CAPI::ovr_AssetFile_DeleteByName(::CsString* assetFileName) {
...
uint64_t Oculus::Platform::CAPI::ovr_AssetFile_DownloadByName(::CsString* assetFileName) {
...
uint64_t Oculus::Platform::CAPI::ovr_AssetFile_DownloadCancelByName(::CsString* assetFileName) {
...
uint64_t Oculus::Platform::CAPI::ovr_AssetFile_StatusByName(::CsString* assetFileName) {
...
uint64_t Oculus::Platform::CAPI::ovr_Avatar_UpdateMetaData(::CsString* avatarMetaData, ::CsString* imageFilePath) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_Delete(::CsString* bucket, ::CsString* key) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_Load(::CsString* bucket, ::CsString* key) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_LoadBucketMetadata(::CsString* bucket) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_LoadConflictMetadata(::CsString* bucket, ::CsString* key) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_LoadHandle(::CsString* handle) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_LoadMetadata(::CsString* bucket, ::CsString* key) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_ResolveKeepLocal(::CsString* bucket, ::CsString* key, ::CsString* remoteHandle) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_ResolveKeepRemote(::CsString* bucket, ::CsString* key, ::CsString* remoteHandle) {
...
uint64_t Oculus::Platform::CAPI::ovr_CloudStorage_Save(::CsString* bucket, ::CsString* key, ::Array<uint8_t>* data, uint dataSize, int64_t counter, ::CsString* extraData) {
...
uint64_t Oculus::Platform::CAPI::ovr_Colocation_RequestMap(::CsString* uuid) {
...
uint64_t Oculus::Platform::CAPI::ovr_Colocation_ShareMap(::CsString* uuid) {
...
uint64_t Oculus::Platform::CAPI::ovr_GraphAPI_Get(::CsString* url) {
...
uint64_t Oculus::Platform::CAPI::ovr_GraphAPI_Post(::CsString* url) {
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_Get(::CsString* url) {
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_GetToFile(::CsString* url, ::CsString* diskFile) {
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_MultiPartPost(::CsString* url, ::CsString* filepath_param_name, ::CsString* filepath, ::CsString* access_token, ::Array<Oculus::Platform::CAPI::ovrKeyValuePair>* post_params) {
...
uint64_t Oculus::Platform::CAPI::ovr_HTTP_Post(::CsString* url) {
...
uint64_t Oculus::Platform::CAPI::ovr_IAP_ConsumePurchase(::CsString* sku) {
...
uint64_t Oculus::Platform::CAPI::ovr_IAP_GetProductsBySKU(::Array<::CsString*>* skus, int count) {
...
uint64_t Oculus::Platform::CAPI::ovr_IAP_LaunchCheckoutFlow(::CsString* sku) {
...
uint64_t Oculus::Platform::CAPI::ovr_LanguagePack_SetCurrent(::CsString* tag) {
...
uint64_t Oculus::Platform::CAPI::ovr_Leaderboard_GetEntries(::CsString* leaderboardName, int limit, Oculus::Platform::LeaderboardFilterType filter, Oculus::Platform::LeaderboardStartAt startAt) {
...
uint64_t Oculus::Platform::CAPI::ovr_Leaderboard_GetEntriesAfterRank(::CsString* leaderboardName, int limit, uint64_t afterRank) {
...
uint64_t Oculus::Platform::CAPI::ovr_Leaderboard_WriteEntry(::CsString* leaderboardName, int64_t score, ::Array<uint8_t>* extraData, uint extraDataLength, bool forceUpdate) {
...
uint64_t Oculus::Platform::CAPI::ovr_Livestreaming_IsAllowedForApplication(::CsString* packageName) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_Browse(::CsString* pool, System::IntPtr customQueryData) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_Browse2(::CsString* pool, System::IntPtr matchmakingOptions) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_Cancel(::CsString* pool, ::CsString* requestHash) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_CreateAndEnqueueRoom(::CsString* pool, uint maxUsers, bool subscribeToUpdates, System::IntPtr customQueryData) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_CreateAndEnqueueRoom2(::CsString* pool, System::IntPtr matchmakingOptions) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_CreateRoom(::CsString* pool, uint maxUsers, bool subscribeToUpdates) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_CreateRoom2(::CsString* pool, System::IntPtr matchmakingOptions) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_Enqueue(::CsString* pool, System::IntPtr customQueryData) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_Enqueue2(::CsString* pool, System::IntPtr matchmakingOptions) {
...
uint64_t Oculus::Platform::CAPI::ovr_Matchmaking_GetStats(::CsString* pool, uint maxLevel, Oculus::Platform::MatchmakingStatApproach approach) {
...
uint64_t Oculus::Platform::CAPI::ovr_Media_ShareToFacebook(::CsString* postTextSuggestion, ::CsString* filePath, Oculus::Platform::MediaContentType contentType) {
...
uint64_t Oculus::Platform::CAPI::ovr_NetSync_SetVoipGroup(int64_t connection_id, ::CsString* group_id) {
...
uint64_t Oculus::Platform::CAPI::ovr_Room_InviteUser(uint64_t roomID, ::CsString* inviteToken) {
...
uint64_t Oculus::Platform::CAPI::ovr_Room_SetDescription(uint64_t roomID, ::CsString* description) {
...
uint64_t Oculus::Platform::CAPI::ovr_User_CancelRecordingForReportFlow(::CsString* recordingUUID) {
...
uint64_t Oculus::Platform::CAPI::ovr_User_StopRecordingAndLaunchReportFlow(uint64_t optionalUserID, ::CsString* optionalRecordingUUID) {
...
uint64_t Oculus::Platform::CAPI::ovr_User_StopRecordingAndLaunchReportFlow2(uint64_t optionalUserID, ::CsString* optionalRecordingUUID, System::IntPtr abuseReportOptions) {
...
uint64_t Oculus::Platform::CAPI::ovr_User_TestUserCreateDeviceManifest(::CsString* deviceID, ::Array<uint64_t>* appIDs, int numAppIDs) {
...
::CsString* Oculus::Platform::CAPI::ovr_AbuseReportRecording_GetRecordingUuid(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AbuseReportRecording_GetRecordingUuid", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementDefinition_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementDefinition_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementDefinitionArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementDefinitionArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementProgress_GetBitfield(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementProgress_GetBitfield", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementProgress_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementProgress_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementProgressArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementProgressArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AchievementUpdate_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AchievementUpdate_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_ApplicationVersion_GetCurrentName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_ApplicationVersion_GetCurrentName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_ApplicationVersion_GetLatestName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_ApplicationVersion_GetLatestName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetDetails_GetAssetType(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetDetails_GetAssetType", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetDetails_GetDownloadStatus(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetDetails_GetDownloadStatus", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetDetails_GetFilepath(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetDetails_GetFilepath", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetDetails_GetIapStatus(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetDetails_GetIapStatus", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetDetails_GetMetadata(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetDetails_GetMetadata", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetFileDeleteResult_GetFilepath(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetFileDeleteResult_GetFilepath", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetFileDownloadCancelResult_GetFilepath(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetFileDownloadCancelResult_GetFilepath", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_AssetFileDownloadResult_GetFilepath(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_AssetFileDownloadResult_GetFilepath", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CalApplicationFinalized_GetLaunchDetails(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CalApplicationFinalized_GetLaunchDetails", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CalApplicationSuggestion_GetSocialContext(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CalApplicationSuggestion_GetSocialContext", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorage2UserDirectoryPathResponse_GetPath(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorage2UserDirectoryPathResponse_GetPath", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageData_GetBucket(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageData_GetBucket", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageData_GetKey(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageData_GetKey", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageMetadata_GetBucket(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageMetadata_GetBucket", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageMetadata_GetExtraData(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageMetadata_GetExtraData", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageMetadata_GetKey(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageMetadata_GetKey", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageMetadata_GetVersionHandle(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageMetadata_GetVersionHandle", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageMetadataArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageMetadataArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageUpdateResponse_GetBucket(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageUpdateResponse_GetBucket", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageUpdateResponse_GetKey(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageUpdateResponse_GetKey", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_CloudStorageUpdateResponse_GetVersionHandle(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_CloudStorageUpdateResponse_GetVersionHandle", obj));
}
...
uint Oculus::Platform::CAPI::ovr_DataStore_Contains(System::IntPtr obj, ::CsString* key) {
...
::CsString* Oculus::Platform::CAPI::ovr_DataStore_GetKey(System::IntPtr obj, int index) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_DataStore_GetKey", obj, index));
}
...
::CsString* Oculus::Platform::CAPI::ovr_DataStore_GetValue(System::IntPtr obj, ::CsString* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_DataStore_GetValue", obj, key));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Destination_GetApiName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Destination_GetApiName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Destination_GetDeeplinkMessage(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Destination_GetDeeplinkMessage", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Destination_GetDisplayName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Destination_GetDisplayName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_DestinationArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_DestinationArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Error_GetDisplayableMessage(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Error_GetDisplayableMessage", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Error_GetMessage(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Error_GetMessage", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_InstalledApplication_GetApplicationId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_InstalledApplication_GetApplicationId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_InstalledApplication_GetPackageName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_InstalledApplication_GetPackageName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_InstalledApplication_GetStatus(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_InstalledApplication_GetStatus", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_InstalledApplication_GetVersionName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_InstalledApplication_GetVersionName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LanguagePackInfo_GetEnglishName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LanguagePackInfo_GetEnglishName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LanguagePackInfo_GetNativeName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LanguagePackInfo_GetNativeName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LanguagePackInfo_GetTag(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LanguagePackInfo_GetTag", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LaunchDetails_GetDeeplinkMessage(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LaunchDetails_GetDeeplinkMessage", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LaunchDetails_GetDestinationApiName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LaunchDetails_GetDestinationApiName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LaunchDetails_GetLaunchSource(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LaunchDetails_GetLaunchSource", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LeaderboardEntryArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LeaderboardEntryArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LeaderboardEntryArray_GetPreviousUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LeaderboardEntryArray_GetPreviousUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LinkedAccount_GetAccessToken(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LinkedAccount_GetAccessToken", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LinkedAccount_GetUserId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LinkedAccount_GetUserId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_LivestreamingVideoStats_GetTotalViews(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_LivestreamingVideoStats_GetTotalViews", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingAdminSnapshotCandidate_GetTraceId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingAdminSnapshotCandidate_GetTraceId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingCandidate_GetEntryHash(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingCandidate_GetEntryHash", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingCandidateArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingCandidateArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingEnqueueResult_GetPool(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingEnqueueResult_GetPool", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingEnqueueResult_GetRequestHash(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingEnqueueResult_GetRequestHash", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_MatchmakingNotification_GetTraceId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_MatchmakingNotification_GetTraceId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Message_GetString(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Message_GetString", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_NetSyncConnection_GetZoneId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_NetSyncConnection_GetZoneId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_NetSyncSession_GetVoipGroup(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_NetSyncSession_GetVoipGroup", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_PartyUpdateNotification_GetUpdateTimestamp(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_PartyUpdateNotification_GetUpdateTimestamp", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_PartyUpdateNotification_GetUserAlias(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_PartyUpdateNotification_GetUserAlias", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_PartyUpdateNotification_GetUserName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_PartyUpdateNotification_GetUserName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Pid_GetId(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Pid_GetId", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Price_GetCurrency(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Price_GetCurrency", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Price_GetFormatted(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Price_GetFormatted", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Product_GetDescription(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Product_GetDescription", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Product_GetFormattedPrice(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Product_GetFormattedPrice", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Product_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Product_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Product_GetSKU(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Product_GetSKU", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_ProductArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_ProductArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Purchase_GetSKU(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Purchase_GetSKU", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_PurchaseArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_PurchaseArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Room_GetDescription(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Room_GetDescription", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Room_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Room_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_RoomArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_RoomArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_RoomInviteNotificationArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_RoomInviteNotificationArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_Team_GetName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_Team_GetName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_TestUser_GetAccessToken(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_TestUser_GetAccessToken", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_TestUser_GetFriendAccessToken(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_TestUser_GetFriendAccessToken", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_TestUser_GetUserAlias(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_TestUser_GetUserAlias", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_TestUserAppAccess_GetAccessToken(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_TestUserAppAccess_GetAccessToken", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetImageUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetImageUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetInviteToken(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetInviteToken", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetOculusID(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetOculusID", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetPresence(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetPresence", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetPresenceDeeplinkMessage(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetPresenceDeeplinkMessage", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetPresenceDestinationApiName(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetPresenceDestinationApiName", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_User_GetSmallImageUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_User_GetSmallImageUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_UserAndRoomArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_UserAndRoomArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_UserArray_GetNextUrl(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_UserArray_GetNextUrl", obj));
}
...
::CsString* Oculus::Platform::CAPI::ovr_UserProof_GetNonce(System::IntPtr obj) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "CAPI", "ovr_UserProof_GetNonce", obj));
}
...
void Oculus::Platform::CAPI::ovr_ApplicationOptions_SetDeeplinkMessage(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_MatchmakingOptions_SetCreateRoomDataStoreString(System::IntPtr handle, ::CsString* key, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_MatchmakingOptions_SetEnqueueDataSettingsInt(System::IntPtr handle, ::CsString* key, int value) {
...
void Oculus::Platform::CAPI::ovr_MatchmakingOptions_SetEnqueueDataSettingsDouble(System::IntPtr handle, ::CsString* key, double value) {
...
void Oculus::Platform::CAPI::ovr_MatchmakingOptions_SetEnqueueDataSettingsString(System::IntPtr handle, ::CsString* key, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_MatchmakingOptions_SetEnqueueQueryKey(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_NetSyncOptions_SetVoipGroup(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_NetSyncOptions_SetZoneId(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_RichPresenceOptions_SetApiName(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_RichPresenceOptions_SetArgsString(System::IntPtr handle, ::CsString* key, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_RichPresenceOptions_SetDeeplinkMessageOverride(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_RichPresenceOptions_SetJoinableId(System::IntPtr handle, ::CsString* value) {
...
void Oculus::Platform::CAPI::ovr_RoomOptions_SetDataStoreString(System::IntPtr handle, ::CsString* key, ::CsString* value) {
...
Oculus::Platform::CAPI* Oculus::Platform::CAPI::New_ctor() {
  return (CAPI*)THROW_UNLESS(il2cpp_utils::New("Oculus.Platform", "CAPI"));
}
