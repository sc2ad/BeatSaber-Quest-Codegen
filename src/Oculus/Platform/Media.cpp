...
Oculus::Platform::Request_1<Oculus::Platform::Models::ShareMediaResult*>* Oculus::Platform::Media::ShareToFacebook(::Il2CppString* postTextSuggestion, ::Il2CppString* filePath, Oculus::Platform::MediaContentType contentType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Media", il2cpp_utils::NoArgClass<Oculus::Platform::Request_1<Oculus::Platform::Models::ShareMediaResult*>*>(), "ShareToFacebook", {}, ::il2cpp_utils::ExtractTypes(postTextSuggestion, filePath, contentType)));
