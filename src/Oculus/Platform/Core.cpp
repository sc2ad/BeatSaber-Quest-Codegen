...
bool Oculus::Platform::Core::IsInitialized() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<bool>(), "IsInitialized", {}, ::il2cpp_utils::ExtractTypes()));
...
void Oculus::Platform::Core::ForceInitialized() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<void>(), "ForceInitialized", {}, ::il2cpp_utils::ExtractTypes()));
...
::Il2CppString* Oculus::Platform::Core::getAppID(::Il2CppString* appId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<::Il2CppString*>(), "getAppID", {}, ::il2cpp_utils::ExtractTypes(appId)));
...
Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* Oculus::Platform::Core::AsyncInitialize(::Il2CppString* appId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>*>(), "AsyncInitialize", {}, ::il2cpp_utils::ExtractTypes(appId)));
...
void Oculus::Platform::Core::Initialize(::Il2CppString* appId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<void>(), "Initialize", {}, ::il2cpp_utils::ExtractTypes(appId)));
...
::Il2CppString* Oculus::Platform::Core::GetAppIDFromConfig() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetAppIDFromConfig", {}, ::il2cpp_utils::ExtractTypes()));
...
void Oculus::Platform::Core::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Core", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
// Autogenerated method: Oculus.Platform.Core..ctor
Oculus::Platform::Core* Oculus::Platform::Core::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("Core").WithContext(".ctor");
