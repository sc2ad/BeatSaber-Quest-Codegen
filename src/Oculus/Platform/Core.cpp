...
::CsString* Oculus::Platform::Core::getAppID(::CsString* appId) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "Core", "getAppID", appId));
}
// Autogenerated method: Oculus.Platform.Core.AsyncInitialize
Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* Oculus::Platform::Core::AsyncInitialize(::CsString* appId) {
...
void Oculus::Platform::Core::Initialize(::CsString* appId) {
...
::CsString* Oculus::Platform::Core::GetAppIDFromConfig() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Oculus.Platform", "Core", "GetAppIDFromConfig"));
}
