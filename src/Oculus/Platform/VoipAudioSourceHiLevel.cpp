...
void Oculus::Platform::VoipAudioSourceHiLevel::set_senderID(uint64_t value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_senderID", {}, ::il2cpp_utils::ExtractTypes(value)));
...
Oculus::Platform::VoipSampleRate Oculus::Platform::VoipAudioSourceHiLevel::SampleRateToEnum(int rate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Oculus::Platform::VoipSampleRate>(), "SampleRateToEnum", {}, ::il2cpp_utils::ExtractTypes(rate)));
...
void Oculus::Platform::VoipAudioSourceHiLevel::CreatePCMSource() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "CreatePCMSource", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
int Oculus::Platform::VoipAudioSourceHiLevel::MSToElements(int ms) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "VoipAudioSourceHiLevel", il2cpp_utils::NoArgClass<int>(), "MSToElements", {}, ::il2cpp_utils::ExtractTypes(ms)));
...
void Oculus::Platform::VoipAudioSourceHiLevel::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "VoipAudioSourceHiLevel", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
