...
void Oculus::Platform::Callback::SetNotificationCallback(Oculus::Platform::Message::MessageType type, Oculus::Platform::Message::Callback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "SetNotificationCallback", {}, ::il2cpp_utils::ExtractTypes(type, callback)));
...
void Oculus::Platform::Callback::AddRequest(Oculus::Platform::Request* request) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "AddRequest", {}, ::il2cpp_utils::ExtractTypes(request)));
...
void Oculus::Platform::Callback::RunCallbacks() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "RunCallbacks", {}, ::il2cpp_utils::ExtractTypes()));
...
void Oculus::Platform::Callback::RunLimitedCallbacks(uint limit) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "RunLimitedCallbacks", {}, ::il2cpp_utils::ExtractTypes(limit)));
...
void Oculus::Platform::Callback::OnApplicationQuit() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "OnApplicationQuit", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
...
void Oculus::Platform::Callback::FlushRoomInviteNotificationQueue() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "FlushRoomInviteNotificationQueue", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
...
void Oculus::Platform::Callback::HandleMessage(Oculus::Platform::Message* msg) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), "HandleMessage", {}, ::il2cpp_utils::ExtractTypes(msg)));
...
void Oculus::Platform::Callback::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Oculus.Platform", "Callback", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
