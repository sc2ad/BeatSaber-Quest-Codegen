...
void Oculus::Platform::MatchmakingOptions::SetCreateRoomDataStore(::CsString* key, ::CsString* value) {
...
void Oculus::Platform::MatchmakingOptions::SetEnqueueDataSettings(::CsString* key, int value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SetEnqueueDataSettings", key, value));
}
// Autogenerated method: Oculus.Platform.MatchmakingOptions.SetEnqueueDataSettings
void Oculus::Platform::MatchmakingOptions::SetEnqueueDataSettings(::CsString* key, double value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SetEnqueueDataSettings", key, value));
}
// Autogenerated method: Oculus.Platform.MatchmakingOptions.SetEnqueueDataSettings
void Oculus::Platform::MatchmakingOptions::SetEnqueueDataSettings(::CsString* key, ::CsString* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SetEnqueueDataSettings", key, value));
}
...
void Oculus::Platform::MatchmakingOptions::SetEnqueueQueryKey(::CsString* value) {
