...
Oculus::Platform::Models::LivestreamingVideoStats* Oculus::Platform::MessageWithLivestreamingVideoStats::GetDataFromMessage(System::IntPtr c_message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Oculus::Platform::Models::LivestreamingVideoStats*>(), "GetDataFromMessage", {}, ::il2cpp_utils::ExtractTypes(c_message)));
...
Oculus::Platform::MessageWithLivestreamingVideoStats* Oculus::Platform::MessageWithLivestreamingVideoStats::New_ctor(System::IntPtr c_message) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform").WithContext("MessageWithLivestreamingVideoStats").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MessageWithLivestreamingVideoStats*>(c_message));
}
