...
void Oculus::Platform::ApplicationOptions::SetDeeplinkMessage(::Il2CppString* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetDeeplinkMessage", {}, ::il2cpp_utils::ExtractTypes(value)));
...
Oculus::Platform::ApplicationOptions* Oculus::Platform::ApplicationOptions::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ApplicationOptions*>());
}
