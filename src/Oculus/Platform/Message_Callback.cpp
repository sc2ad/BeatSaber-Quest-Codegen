...
Oculus::Platform::Message::Callback* Oculus::Platform::Message::Callback::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<Message::Callback*>(object, method));
}
