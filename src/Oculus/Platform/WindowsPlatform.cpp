...
bool Oculus::Platform::WindowsPlatform::Initialize(::CsString* appId) {
...
Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* Oculus::Platform::WindowsPlatform::AsyncInitialize(::CsString* appId) {
...
Oculus::Platform::WindowsPlatform* Oculus::Platform::WindowsPlatform::New_ctor() {
  return (WindowsPlatform*)THROW_UNLESS(il2cpp_utils::New("Oculus.Platform", "WindowsPlatform"));
}
