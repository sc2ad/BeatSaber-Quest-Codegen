...
void GlobalNamespace::CommandBufferBlurryScreenGrab::NoDomainReloadInit() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "CommandBufferBlurryScreenGrab", il2cpp_utils::NoArgClass<void>(), "NoDomainReloadInit", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::CommandBufferBlurryScreenGrab* GlobalNamespace::CommandBufferBlurryScreenGrab::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CommandBufferBlurryScreenGrab").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<CommandBufferBlurryScreenGrab*>());
}
...
void GlobalNamespace::CommandBufferBlurryScreenGrab::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "CommandBufferBlurryScreenGrab", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
