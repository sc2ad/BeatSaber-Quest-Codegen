...
GlobalNamespace::AlphabetScrollInfo* GlobalNamespace::AlphabetScrollInfo::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("AlphabetScrollInfo").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<AlphabetScrollInfo*>());
}
