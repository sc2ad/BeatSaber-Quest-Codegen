...
GlobalNamespace::PlatformAchievementsHandler* GlobalNamespace::PlatformAchievementsModelSO::get_platformAchievementsHandler() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::PlatformAchievementsHandler*>(), "get_platformAchievementsHandler", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::PlatformAchievementsModelSO::CreatePlatformAchievementsHandler() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "CreatePlatformAchievementsHandler", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
GlobalNamespace::PlatformAchievementsModelSO* GlobalNamespace::PlatformAchievementsModelSO::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PlatformAchievementsModelSO").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlatformAchievementsModelSO*>());
}
