...
void GlobalNamespace::VRControllersRecorder::set_recordingFileName(::CsString* value) {
...
::CsString* GlobalNamespace::VRControllersRecorder::get_recordingFileName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_recordingFileName"));
}
...
UnityEngine::AnimationClip* GlobalNamespace::VRControllersRecorder::CreateAnimationClipFromRecording(::CsString* recordingfilePath) {
