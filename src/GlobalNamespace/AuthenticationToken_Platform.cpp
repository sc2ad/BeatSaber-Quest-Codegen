...
GlobalNamespace::AuthenticationToken::Platform GlobalNamespace::AuthenticationToken::Platform::_get_OculusRift() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Platform").WithContext("_get_OculusRift");
...
void GlobalNamespace::AuthenticationToken::Platform::_set_OculusRift(GlobalNamespace::AuthenticationToken::Platform value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Platform").WithContext("_set_OculusRift");
...
GlobalNamespace::AuthenticationToken::Platform GlobalNamespace::AuthenticationToken::Platform::_get_OculusQuest() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Platform").WithContext("_get_OculusQuest");
...
void GlobalNamespace::AuthenticationToken::Platform::_set_OculusQuest(GlobalNamespace::AuthenticationToken::Platform value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Platform").WithContext("_set_OculusQuest");
