...
GlobalNamespace::OVRPlugin::Result GlobalNamespace::OVRPlugin::OVRP_1_42_0::ovrp_GetAdaptiveGpuPerformanceScale2(float& adaptiveGpuPerformanceScale) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_42_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Result>(), "ovrp_GetAdaptiveGpuPerformanceScale2", {}, ::il2cpp_utils::ExtractTypes(adaptiveGpuPerformanceScale)));
...
void GlobalNamespace::OVRPlugin::OVRP_1_42_0::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_42_0", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
