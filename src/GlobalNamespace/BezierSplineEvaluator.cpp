...
UnityEngine::Vector3 GlobalNamespace::BezierSplineEvaluator::EvaluatePosition(float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "EvaluatePosition", {}, ::il2cpp_utils::ExtractTypes(time)));
...
UnityEngine::Vector3 GlobalNamespace::BezierSplineEvaluator::Evaluate(float t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "Evaluate", {}, ::il2cpp_utils::ExtractTypes(t)));
...
UnityEngine::Vector3 GlobalNamespace::BezierSplineEvaluator::EvaluateFirstDerivation(float t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "EvaluateFirstDerivation", {}, ::il2cpp_utils::ExtractTypes(t)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::Vector3, false>(this, ___internal__method, t);
}
...
UnityEngine::Vector3 GlobalNamespace::BezierSplineEvaluator::EvaluateSecondDerivation(float t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector3>(), "EvaluateSecondDerivation", {}, ::il2cpp_utils::ExtractTypes(t)));
  return ::il2cpp_utils::RunMethodThrow<UnityEngine::Vector3, false>(this, ___internal__method, t);
}
...
float GlobalNamespace::BezierSplineEvaluator::OffsetSegmentAndGetT(float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "OffsetSegmentAndGetT", {}, ::il2cpp_utils::ExtractTypes(time)));
...
float GlobalNamespace::BezierSplineEvaluator::GetTForSegment(int segmentIndex, float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "GetTForSegment", {}, ::il2cpp_utils::ExtractTypes(segmentIndex, time)));
...
void GlobalNamespace::BezierSplineEvaluator::GetTimeValuesForSegment(int segmentIndex, float& t0Value, float& t1Value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "GetTimeValuesForSegment", {}, ::il2cpp_utils::ExtractTypes(segmentIndex, t0Value, t1Value)));
...
void GlobalNamespace::BezierSplineEvaluator::OffsetStartIndexToDistance(float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OffsetStartIndexToDistance", {}, ::il2cpp_utils::ExtractTypes(time)));
...
float GlobalNamespace::BezierSplineEvaluator::CubeRoot(float x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BezierSplineEvaluator", il2cpp_utils::NoArgClass<float>(), "CubeRoot", {}, ::il2cpp_utils::ExtractTypes(x)));
...
GlobalNamespace::BezierSplineEvaluator::CubicSolveResult GlobalNamespace::BezierSplineEvaluator::SolveCubic(float a, float b, float c, float d) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BezierSplineEvaluator", il2cpp_utils::NoArgClass<GlobalNamespace::BezierSplineEvaluator::CubicSolveResult>(), "SolveCubic", {}, ::il2cpp_utils::ExtractTypes(a, b, c, d)));
