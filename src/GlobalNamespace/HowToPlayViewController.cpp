...
void GlobalNamespace::HowToPlayViewController::Setup(bool showTutorialButton) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Setup", {}, ::il2cpp_utils::ExtractTypes(showTutorialButton)));
...
GlobalNamespace::HowToPlayViewController* GlobalNamespace::HowToPlayViewController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("HowToPlayViewController").WithContext(".ctor");
