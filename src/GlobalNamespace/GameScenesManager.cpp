...
::CsString* GlobalNamespace::GameScenesManager::_get_kRootContainerGOName() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "GameScenesManager", "kRootContainerGOName"));
}
// Autogenerated static field setter
// Set static field: static private System.String kRootContainerGOName
void GlobalNamespace::GameScenesManager::_set_kRootContainerGOName(::CsString* value) {
...
void GlobalNamespace::GameScenesManager::MarkSceneAsPersistent(::CsString* sceneName) {
...
System::Collections::Generic::List_1<::CsString*>* GlobalNamespace::GameScenesManager::GetCurrentlyLoadedSceneNames() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>(this, "GetCurrentlyLoadedSceneNames"));
}
...
System::Collections::IEnumerator* GlobalNamespace::GameScenesManager::ScenesTransitionCoroutine(System::Collections::Generic::List_1<::CsString*>* scenesToPresent, GlobalNamespace::GameScenesManager::ScenePresentType presentType, System::Collections::Generic::List_1<::CsString*>* scenesToDismiss, GlobalNamespace::GameScenesManager::SceneDismissType dismissType, float minDuration, System::Action* afterMinDurationCallback, System::Action_1<Zenject::DiContainer*>* extraBindingsCallback, System::Action* finishCallback) {
...
bool GlobalNamespace::GameScenesManager::IsAnySceneInStack(System::Collections::Generic::List_1<::CsString*>* sceneNames) {
...
bool GlobalNamespace::GameScenesManager::IsSceneInStack(::CsString* searchSceneName) {
...
System::Collections::Generic::List_1<::CsString*>* GlobalNamespace::GameScenesManager::SceneNamesFromSceneInfoArray(::Array<GlobalNamespace::SceneInfo*>* sceneInfos) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>(this, "SceneNamesFromSceneInfoArray", sceneInfos));
}
// Autogenerated method: GameScenesManager.SetActiveRootObjectsInScenes
void GlobalNamespace::GameScenesManager::SetActiveRootObjectsInScenes(System::Collections::Generic::List_1<::CsString*>* sceneNames, bool value) {
...
void GlobalNamespace::GameScenesManager::ReparentRootGameObjectsToDisabledGameObject(::CsString* sceneName) {
...
void GlobalNamespace::GameScenesManager::MoveGameObjectsFromContainerToSceneRoot(::CsString* sceneName) {
...
void GlobalNamespace::GameScenesManager::Log(::CsString* message) {
