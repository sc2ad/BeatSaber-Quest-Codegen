...
GlobalNamespace::RankModel::Rank GlobalNamespace::RankModelHelper::MaxRankForGameplayModifiers(GlobalNamespace::GameplayModifiers* gameplayModifiers, GlobalNamespace::GameplayModifiersModelSO* gameplayModifiersModel) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "RankModelHelper", il2cpp_utils::NoArgClass<GlobalNamespace::RankModel::Rank>(), "MaxRankForGameplayModifiers", {}, ::il2cpp_utils::ExtractTypes(gameplayModifiers, gameplayModifiersModel)));
