...
bool GlobalNamespace::MockPlayer::get_isLeftHanded() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "get_isLeftHanded", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method);
}
...
void GlobalNamespace::MockPlayer::set_isLeftHanded(bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "set_isLeftHanded", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
void GlobalNamespace::MockPlayer::HandleSetGameplaySceneReady(::Il2CppString* user) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "HandleSetGameplaySceneReady", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(user)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, user);
}
