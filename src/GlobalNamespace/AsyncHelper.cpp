...
void GlobalNamespace::AsyncHelper::RunSync(System::Func_1<System::Threading::Tasks::Task*>* asyncTask) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "AsyncHelper", il2cpp_utils::NoArgClass<void>(), "RunSync", {}, ::il2cpp_utils::ExtractTypes(asyncTask)));
