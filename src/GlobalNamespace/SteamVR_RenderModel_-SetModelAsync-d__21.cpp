...
GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21* GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21::New_ctor(int $$1__state) {
  return (SteamVR_RenderModel::$SetModelAsync$d__21*)THROW_UNLESS(il2cpp_utils::New("", "SteamVR_RenderModel/<SetModelAsync>d__21", $$1__state));
}
...
::CsObject* GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21::System_Collections_IEnumerator_get_Current() {
