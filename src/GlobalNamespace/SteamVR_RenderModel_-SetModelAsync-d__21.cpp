...
// Completed includes
// Autogenerated method: SteamVR_RenderModel/<SetModelAsync>d__21..ctor
GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21* GlobalNamespace::SteamVR_RenderModel::$SetModelAsync$d__21::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_RenderModel::$SetModelAsync$d__21*>($$1__state));
}
