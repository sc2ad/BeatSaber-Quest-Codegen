...
bool GlobalNamespace::WindowResolutionSettingsController::GetInitValues(int& idx, int& numberOfElements) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("WindowResolutionSettingsController").WithContext("GetInitValues");
...
void GlobalNamespace::WindowResolutionSettingsController::ApplyValue(int idx) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("WindowResolutionSettingsController").WithContext("ApplyValue");
...
::Il2CppString* GlobalNamespace::WindowResolutionSettingsController::TextForValue(int idx) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("WindowResolutionSettingsController").WithContext("TextForValue");
...
GlobalNamespace::WindowResolutionSettingsController* GlobalNamespace::WindowResolutionSettingsController::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<WindowResolutionSettingsController*>());
}
