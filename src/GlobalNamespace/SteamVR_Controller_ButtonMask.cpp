...
// Autogenerated method: SteamVR_Controller/ButtonMask..ctor
GlobalNamespace::SteamVR_Controller::ButtonMask* GlobalNamespace::SteamVR_Controller::ButtonMask::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ButtonMask").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_Controller::ButtonMask*>());
}
