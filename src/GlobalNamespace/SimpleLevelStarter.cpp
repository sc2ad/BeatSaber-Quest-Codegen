...
void GlobalNamespace::SimpleLevelStarter::$StartLevel$g__AfterSceneSwitchCallback|14_0(Zenject::DiContainer* container) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<StartLevel>g__AfterSceneSwitchCallback|14_0", container));
}
