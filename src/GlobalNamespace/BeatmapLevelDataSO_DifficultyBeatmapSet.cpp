...
::CsString* GlobalNamespace::BeatmapLevelDataSO::DifficultyBeatmapSet::get_beatmapCharacteristicSerializedName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_beatmapCharacteristicSerializedName"));
}
...
GlobalNamespace::BeatmapLevelDataSO::DifficultyBeatmapSet* GlobalNamespace::BeatmapLevelDataSO::DifficultyBeatmapSet::New_ctor(::CsString* beatmapCharacteristicSerializedName, ::Array<GlobalNamespace::BeatmapLevelSO::DifficultyBeatmap*>* difficultyBeatmaps) {
