...
void GlobalNamespace::SettingsFlowCoordinator::DidActivate(bool firstActivation, HMUI::FlowCoordinator::ActivationType activationType) {
...
void GlobalNamespace::SettingsFlowCoordinator::DidDeactivate(HMUI::FlowCoordinator::DeactivationType deactivationType) {
...
GlobalNamespace::SettingsFlowCoordinator* GlobalNamespace::SettingsFlowCoordinator::New_ctor() {
  return (SettingsFlowCoordinator*)THROW_UNLESS(il2cpp_utils::New("", "SettingsFlowCoordinator"));
}
