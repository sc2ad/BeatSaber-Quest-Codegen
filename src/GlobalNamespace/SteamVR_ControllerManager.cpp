...
void GlobalNamespace::SteamVR_ControllerManager::SetUniqueObject(UnityEngine::GameObject* o, int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetUniqueObject", {}, ::il2cpp_utils::ExtractTypes(o, index)));
...
void GlobalNamespace::SteamVR_ControllerManager::UpdateTargets() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "UpdateTargets", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::SteamVR_ControllerManager::HideObject(UnityEngine::Transform* t, ::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HideObject", {}, ::il2cpp_utils::ExtractTypes(t, name)));
...
void GlobalNamespace::SteamVR_ControllerManager::ShowObject(UnityEngine::Transform* t, ::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ShowObject", {}, ::il2cpp_utils::ExtractTypes(t, name)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, t, name);
}
...
void GlobalNamespace::SteamVR_ControllerManager::SetTrackedDeviceIndex(int objectIndex, uint trackedDeviceIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetTrackedDeviceIndex", {}, ::il2cpp_utils::ExtractTypes(objectIndex, trackedDeviceIndex)));
...
void GlobalNamespace::SteamVR_ControllerManager::OnTrackedDeviceRoleChanged(Valve::VR::VREvent_t vrEvent) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnTrackedDeviceRoleChanged", {}, ::il2cpp_utils::ExtractTypes(vrEvent)));
...
GlobalNamespace::SteamVR_ControllerManager* GlobalNamespace::SteamVR_ControllerManager::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_ControllerManager*>());
}
...
void GlobalNamespace::SteamVR_ControllerManager::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_ControllerManager", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
