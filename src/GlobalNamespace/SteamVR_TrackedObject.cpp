...
void GlobalNamespace::SteamVR_TrackedObject::set_isValid(bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_isValid", {}, ::il2cpp_utils::ExtractTypes(value)));
...
GlobalNamespace::SteamVR_TrackedObject* GlobalNamespace::SteamVR_TrackedObject::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SteamVR_TrackedObject").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_TrackedObject*>());
}
