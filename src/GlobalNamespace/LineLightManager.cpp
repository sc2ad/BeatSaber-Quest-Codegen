...
GlobalNamespace::LineLightManager* GlobalNamespace::LineLightManager::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<LineLightManager*>());
}
...
void GlobalNamespace::LineLightManager::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "LineLightManager", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
