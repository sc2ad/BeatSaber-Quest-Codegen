...
::CsString* GlobalNamespace::StandardLevelInfoSaveData::DifficultyBeatmap::get_difficulty() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_difficulty"));
}
...
::CsString* GlobalNamespace::StandardLevelInfoSaveData::DifficultyBeatmap::get_beatmapFilename() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_beatmapFilename"));
}
...
GlobalNamespace::StandardLevelInfoSaveData::DifficultyBeatmap* GlobalNamespace::StandardLevelInfoSaveData::DifficultyBeatmap::New_ctor(::CsString* difficultyName, int difficultyRank, ::CsString* beatmapFilename, float noteJumpMovementSpeed, float noteJumpStartBeatOffset) {
