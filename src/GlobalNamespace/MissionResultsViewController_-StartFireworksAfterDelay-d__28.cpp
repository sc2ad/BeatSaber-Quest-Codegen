...
// Completed includes
// Autogenerated method: MissionResultsViewController/<StartFireworksAfterDelay>d__28..ctor
GlobalNamespace::MissionResultsViewController::$StartFireworksAfterDelay$d__28* GlobalNamespace::MissionResultsViewController::$StartFireworksAfterDelay$d__28::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$StartFireworksAfterDelay$d__28").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MissionResultsViewController::$StartFireworksAfterDelay$d__28*>($$1__state));
}
