...
GlobalNamespace::SteamVR_TrackedCamera::VideoStream* GlobalNamespace::SteamVR_TrackedCamera::VideoStream::New_ctor(uint deviceIndex) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("VideoStream").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_TrackedCamera::VideoStream*>(deviceIndex));
}
...
void GlobalNamespace::SteamVR_TrackedCamera::VideoStream::set_deviceIndex(uint value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_deviceIndex", {}, ::il2cpp_utils::ExtractTypes(value)));
...
uint64_t GlobalNamespace::SteamVR_TrackedCamera::VideoStream::get_handle() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<uint64_t>(), "get_handle", {}, ::il2cpp_utils::ExtractTypes()));
