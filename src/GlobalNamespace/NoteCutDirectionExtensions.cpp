...
UnityEngine::Vector2 GlobalNamespace::NoteCutDirectionExtensions::Direction(GlobalNamespace::NoteCutDirection cutDirection) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "NoteCutDirectionExtensions", "Direction", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(cutDirection)));
...
float GlobalNamespace::NoteCutDirectionExtensions::RotationAngle(GlobalNamespace::NoteCutDirection cutDirection) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "NoteCutDirectionExtensions", "RotationAngle", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(cutDirection)));
...
UnityEngine::Quaternion GlobalNamespace::NoteCutDirectionExtensions::Rotation(GlobalNamespace::NoteCutDirection cutDirection, float offset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "NoteCutDirectionExtensions", "Rotation", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(cutDirection, offset)));
...
bool GlobalNamespace::NoteCutDirectionExtensions::IsMainDirection(GlobalNamespace::NoteCutDirection cutDirection) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "NoteCutDirectionExtensions", "IsMainDirection", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(cutDirection)));
...
GlobalNamespace::NoteCutDirection GlobalNamespace::NoteCutDirectionExtensions::MainNoteCutDirectionFromCutDirAngle(float angle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "NoteCutDirectionExtensions", "MainNoteCutDirectionFromCutDirAngle", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(angle)));
