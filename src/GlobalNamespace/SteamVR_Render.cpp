...
::CsString* GlobalNamespace::SteamVR_Render::GetScreenshotFilename(uint screenshotHandle, Valve::VR::EVRScreenshotPropertyFilenames screenshotPropertyFilename) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetScreenshotFilename", screenshotHandle, screenshotPropertyFilename));
}
