...
::CsString* GlobalNamespace::TestBeatmapDataAssetFileModel::_get_kAssetsDir() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "TestBeatmapDataAssetFileModel", "kAssetsDir"));
}
// Autogenerated static field setter
// Set static field: static private System.String kAssetsDir
void GlobalNamespace::TestBeatmapDataAssetFileModel::_set_kAssetsDir(::CsString* value) {
