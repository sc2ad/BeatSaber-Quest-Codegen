...
::CsString* GlobalNamespace::AnnotatedBeatmapLevelCollectionTableCell::GetInfoText(::CsString* name, int songs, int purchased) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetInfoText", name, songs, purchased));
}
...
GlobalNamespace::AnnotatedBeatmapLevelCollectionTableCell* GlobalNamespace::AnnotatedBeatmapLevelCollectionTableCell::New_ctor() {
  return (AnnotatedBeatmapLevelCollectionTableCell*)THROW_UNLESS(il2cpp_utils::New("", "AnnotatedBeatmapLevelCollectionTableCell"));
}
