...
::CsObject* GlobalNamespace::EnableAfterDelay::$Start$d__1::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::EnableAfterDelay::$Start$d__1::System_Collections_IEnumerator_get_Current() {
