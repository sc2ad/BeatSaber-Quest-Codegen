...
GlobalNamespace::BloomFilter GlobalNamespace::BloomFilterUtils::ToBloomFilter(System::Collections::Generic::IEnumerable_1<::Il2CppString*>* strings) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BloomFilterUtils", il2cpp_utils::NoArgClass<GlobalNamespace::BloomFilter>(), "ToBloomFilter", {}, ::il2cpp_utils::ExtractTypes(strings)));
