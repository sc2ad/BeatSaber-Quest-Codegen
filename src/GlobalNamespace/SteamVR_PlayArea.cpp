...
bool GlobalNamespace::SteamVR_PlayArea::GetBounds(GlobalNamespace::SteamVR_PlayArea::Size size, Valve::VR::HmdQuad_t& pRect) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_PlayArea", il2cpp_utils::NoArgClass<bool>(), "GetBounds", {}, ::il2cpp_utils::ExtractTypes(size, pRect)));
...
void GlobalNamespace::SteamVR_PlayArea::BuildMesh() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "BuildMesh", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::SteamVR_PlayArea::DrawWireframe() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "DrawWireframe", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
System::Collections::IEnumerator* GlobalNamespace::SteamVR_PlayArea::UpdateBounds() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Collections::IEnumerator*>(), "UpdateBounds", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::SteamVR_PlayArea* GlobalNamespace::SteamVR_PlayArea::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SteamVR_PlayArea").WithContext(".ctor");
