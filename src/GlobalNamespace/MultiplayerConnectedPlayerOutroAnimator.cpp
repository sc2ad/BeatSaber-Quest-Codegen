...
void GlobalNamespace::MultiplayerConnectedPlayerOutroAnimator::$Animate$b__7_0(UnityEngine::Color color) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "<Animate>b__7_0", {}, ::il2cpp_utils::ExtractTypes(color))));
...
void GlobalNamespace::MultiplayerConnectedPlayerOutroAnimator::Animate(float duration) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Animate", {}, ::il2cpp_utils::ExtractTypes(duration)));
...
GlobalNamespace::MultiplayerConnectedPlayerOutroAnimator* GlobalNamespace::MultiplayerConnectedPlayerOutroAnimator::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerConnectedPlayerOutroAnimator").WithContext(".ctor");
