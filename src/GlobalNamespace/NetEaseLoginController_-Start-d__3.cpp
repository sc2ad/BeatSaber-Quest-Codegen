...
GlobalNamespace::NetEaseLoginController::$Start$d__3* GlobalNamespace::NetEaseLoginController::$Start$d__3::New_ctor(int $$1__state) {
  return (NetEaseLoginController::$Start$d__3*)THROW_UNLESS(il2cpp_utils::New("", "NetEaseLoginController/<Start>d__3", $$1__state));
}
...
::CsObject* GlobalNamespace::NetEaseLoginController::$Start$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::NetEaseLoginController::$Start$d__3::System_Collections_IEnumerator_get_Current() {
