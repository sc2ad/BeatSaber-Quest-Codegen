...
GlobalNamespace::PlayerAllOverallStatsData* GlobalNamespace::PlayerAllOverallStatsData::New_ctor(GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData* campaignOverallStatsData, GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData* soloFreePlayOverallStatsData, GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData* partyFreePlayOverallStatsData) {
  return (PlayerAllOverallStatsData*)THROW_UNLESS(il2cpp_utils::New("", "PlayerAllOverallStatsData", campaignOverallStatsData, soloFreePlayOverallStatsData, partyFreePlayOverallStatsData));
}
...
GlobalNamespace::PlayerAllOverallStatsData* GlobalNamespace::PlayerAllOverallStatsData::New_ctor() {
  return (PlayerAllOverallStatsData*)THROW_UNLESS(il2cpp_utils::New("", "PlayerAllOverallStatsData"));
}
