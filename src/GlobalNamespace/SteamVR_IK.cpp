...
bool GlobalNamespace::SteamVR_IK::Solve(UnityEngine::Vector3 start, UnityEngine::Vector3 end, UnityEngine::Vector3 poleVector, float jointDist, float targetDist, UnityEngine::Vector3& result, UnityEngine::Vector3& forward, UnityEngine::Vector3& up) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_IK", il2cpp_utils::NoArgClass<bool>(), "Solve", {}, ::il2cpp_utils::ExtractTypes(start, end, poleVector, jointDist, targetDist, result, forward, up)));
...
GlobalNamespace::SteamVR_IK* GlobalNamespace::SteamVR_IK::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_IK*>());
}
