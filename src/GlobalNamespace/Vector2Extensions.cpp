...
float GlobalNamespace::Vector2Extensions::SignedAngleToLine(UnityEngine::Vector2 vec, UnityEngine::Vector2 line) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "Vector2Extensions", il2cpp_utils::NoArgClass<float>(), "SignedAngleToLine", {}, ::il2cpp_utils::ExtractTypes(vec, line)));
