...
void GlobalNamespace::MainEffectCore::SetGlobalShaderValues(float baseColorBoost, float baseColorBoostThreshold) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "MainEffectCore", il2cpp_utils::NoArgClass<void>(), "SetGlobalShaderValues", {}, ::il2cpp_utils::ExtractTypes(baseColorBoost, baseColorBoostThreshold)));
...
void GlobalNamespace::MainEffectCore::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "MainEffectCore", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::MainEffectCore* GlobalNamespace::MainEffectCore::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MainEffectCore").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MainEffectCore*>());
}
