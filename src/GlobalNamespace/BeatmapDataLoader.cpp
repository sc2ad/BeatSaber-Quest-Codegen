...
// Autogenerated method: BeatmapDataLoader.<GetBeatmapDataFromBeatmapSaveData>g__ProcessTime|2_2
float GlobalNamespace::BeatmapDataLoader::$GetBeatmapDataFromBeatmapSaveData$g__ProcessTime_2_2(float bpmTime, GlobalNamespace::BeatmapDataLoader::$$c__DisplayClass2_0& param_1) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<float>(this, "<GetBeatmapDataFromBeatmapSaveData>g__ProcessTime|2_2", bpmTime, param_1)));
}
