...
GlobalNamespace::OVROverlay::ExternalSurfaceObjectCreated* GlobalNamespace::OVROverlay::ExternalSurfaceObjectCreated::New_ctor(::CsObject* object, System::IntPtr method) {
  return (OVROverlay::ExternalSurfaceObjectCreated*)THROW_UNLESS(il2cpp_utils::New("", "OVROverlay/ExternalSurfaceObjectCreated", object, method));
}
...
System::IAsyncResult* GlobalNamespace::OVROverlay::ExternalSurfaceObjectCreated::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
