...
GlobalNamespace::PlayerAllOverallStatsData* GlobalNamespace::PlayerDataModelHelper::ToPlayerAllOverallStatsData(GlobalNamespace::PlayerSaveData::PlayerAllOverallStatsData* playerAllOverallStatsData) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PlayerDataModelHelper", il2cpp_utils::NoArgClass<GlobalNamespace::PlayerAllOverallStatsData*>(), "ToPlayerAllOverallStatsData", {}, ::il2cpp_utils::ExtractTypes(playerAllOverallStatsData)));
...
GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData* GlobalNamespace::PlayerDataModelHelper::ToPlayerOverallStats(GlobalNamespace::PlayerSaveData::PlayerOverallStatsData* playerAllOverallStatsData) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PlayerDataModelHelper", il2cpp_utils::NoArgClass<GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData*>(), "ToPlayerOverallStats", {}, ::il2cpp_utils::ExtractTypes(playerAllOverallStatsData)));
...
GlobalNamespace::PlayerSaveData::PlayerAllOverallStatsData* GlobalNamespace::PlayerDataModelHelper::ToPlayerAllOverallStatsData(GlobalNamespace::PlayerAllOverallStatsData* playerAllOverallStatsData) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PlayerDataModelHelper").WithContext("ToPlayerAllOverallStatsData");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PlayerDataModelHelper", il2cpp_utils::NoArgClass<GlobalNamespace::PlayerSaveData::PlayerAllOverallStatsData*>(), "ToPlayerAllOverallStatsData", {}, ::il2cpp_utils::ExtractTypes(playerAllOverallStatsData)));
...
GlobalNamespace::PlayerSaveData::PlayerOverallStatsData* GlobalNamespace::PlayerDataModelHelper::ToPlayerOverallStatsData(GlobalNamespace::PlayerAllOverallStatsData::PlayerOverallStatsData* playerOverallStatsData) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PlayerDataModelHelper", il2cpp_utils::NoArgClass<GlobalNamespace::PlayerSaveData::PlayerOverallStatsData*>(), "ToPlayerOverallStatsData", {}, ::il2cpp_utils::ExtractTypes(playerOverallStatsData)));
