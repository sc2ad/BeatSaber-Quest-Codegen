...
::CsString* GlobalNamespace::OVRGearVrControllerTest::_get_prevConnected() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "OVRGearVrControllerTest", "prevConnected"));
}
// Autogenerated static field setter
// Set static field: static private System.String prevConnected
void GlobalNamespace::OVRGearVrControllerTest::_set_prevConnected(::CsString* value) {
