...
::CsString* GlobalNamespace::PlayerSaveData::_get_kCurrentVersion() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "PlayerSaveData", "kCurrentVersion"));
}
// Autogenerated static field setter
// Set static field: static public System.String kCurrentVersion
void GlobalNamespace::PlayerSaveData::_set_kCurrentVersion(::CsString* value) {
