...
int GlobalNamespace::BTSStarTextEffectValueParser::GetTextId(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSStarTextEffectValueParser", il2cpp_utils::NoArgClass<int>(), "GetTextId", {}, ::il2cpp_utils::ExtractTypes(value)));
...
int GlobalNamespace::BTSStarTextEffectValueParser::GetPositionId(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSStarTextEffectValueParser", il2cpp_utils::NoArgClass<int>(), "GetPositionId", {}, ::il2cpp_utils::ExtractTypes(value)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, value);
}
...
int GlobalNamespace::BTSStarTextEffectValueParser::MergeValuesIntoOneInt(int textId, int positionId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSStarTextEffectValueParser", il2cpp_utils::NoArgClass<int>(), "MergeValuesIntoOneInt", {}, ::il2cpp_utils::ExtractTypes(textId, positionId)));
