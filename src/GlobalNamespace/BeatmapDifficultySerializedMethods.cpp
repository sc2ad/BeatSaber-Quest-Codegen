...
::Il2CppString* GlobalNamespace::BeatmapDifficultySerializedMethods::SerializedName(GlobalNamespace::BeatmapDifficulty difficulty) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapDifficultySerializedMethods", il2cpp_utils::NoArgClass<::Il2CppString*>(), "SerializedName", {}, ::il2cpp_utils::ExtractTypes(difficulty)));
...
bool GlobalNamespace::BeatmapDifficultySerializedMethods::BeatmapDifficultyFromSerializedName(::Il2CppString* name, GlobalNamespace::BeatmapDifficulty& difficulty) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapDifficultySerializedMethods", il2cpp_utils::NoArgClass<bool>(), "BeatmapDifficultyFromSerializedName", {}, ::il2cpp_utils::ExtractTypes(name, difficulty)));
