...
GlobalNamespace::BeatmapLevelsModel::LevelDownloadingUpdate* GlobalNamespace::BeatmapLevelsModel::LevelDownloadingUpdate::New_ctor(::Il2CppString* levelID, uint bytesTotal, uint bytesTransferred, GlobalNamespace::BeatmapLevelsModel::LevelDownloadingUpdate::DownloadingState downloadingState) {
