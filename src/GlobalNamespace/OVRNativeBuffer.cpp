...
GlobalNamespace::OVRNativeBuffer* GlobalNamespace::OVRNativeBuffer::New_ctor(int numBytes) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<OVRNativeBuffer*>(numBytes));
}
...
void GlobalNamespace::OVRNativeBuffer::Reset(int numBytes) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Reset", {}, ::il2cpp_utils::ExtractTypes(numBytes)));
...
int GlobalNamespace::OVRNativeBuffer::GetCapacity() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "GetCapacity", {}, ::il2cpp_utils::ExtractTypes()));
...
System::IntPtr GlobalNamespace::OVRNativeBuffer::GetPointer(int byteOffset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::IntPtr>(), "GetPointer", {}, ::il2cpp_utils::ExtractTypes(byteOffset)));
...
void GlobalNamespace::OVRNativeBuffer::Reallocate(int numBytes) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Reallocate", {}, ::il2cpp_utils::ExtractTypes(numBytes)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, numBytes);
}
