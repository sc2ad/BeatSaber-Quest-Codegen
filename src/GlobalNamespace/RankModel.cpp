...
::Il2CppString* GlobalNamespace::RankModel::GetRankName(GlobalNamespace::RankModel::Rank rank) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "RankModel", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetRankName", {}, ::il2cpp_utils::ExtractTypes(rank)));
...
GlobalNamespace::RankModel::Rank GlobalNamespace::RankModel::GetRankForScore(int rawScore, int modifiedScore, int maxRawScore, int maxModifiedScore) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "RankModel", il2cpp_utils::NoArgClass<GlobalNamespace::RankModel::Rank>(), "GetRankForScore", {}, ::il2cpp_utils::ExtractTypes(rawScore, modifiedScore, maxRawScore, maxModifiedScore)));
