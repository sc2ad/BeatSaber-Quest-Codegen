...
GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams* GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams::New_ctor(System::Collections::Generic::HashSet_1<::Il2CppString*>* beatmapLevelIds) {
  return THROW_UNLESS(il2cpp_utils::New<BeatmapLevelFilterModel::LevelFilterParams*>(beatmapLevelIds));
}
// Autogenerated method: BeatmapLevelFilterModel/LevelFilterParams..ctor
GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams* GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams::New_ctor(GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic) {
  return THROW_UNLESS(il2cpp_utils::New<BeatmapLevelFilterModel::LevelFilterParams*>(beatmapCharacteristic));
}
...
GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams* GlobalNamespace::BeatmapLevelFilterModel::LevelFilterParams::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<BeatmapLevelFilterModel::LevelFilterParams*>());
}
