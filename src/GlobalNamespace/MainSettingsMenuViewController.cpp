...
// Autogenerated method: MainSettingsMenuViewController.HandleMainSettingsTableViewDidSelectRow
void GlobalNamespace::MainSettingsMenuViewController::HandleMainSettingsTableViewDidSelectRow(GlobalNamespace::MainSettingsTableView* tableView, int row) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "HandleMainSettingsTableViewDidSelectRow", tableView, row));
}
// Autogenerated method: MainSettingsMenuViewController.DidActivate
void GlobalNamespace::MainSettingsMenuViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
GlobalNamespace::MainSettingsMenuViewController* GlobalNamespace::MainSettingsMenuViewController::New_ctor() {
  return (MainSettingsMenuViewController*)THROW_UNLESS(il2cpp_utils::New("", "MainSettingsMenuViewController"));
}
