...
void GlobalNamespace::ObstacleSaberSoundEffect::HandleSparkleEffectDidStart(GlobalNamespace::SaberType saberType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleSparkleEffectDidStart", {}, ::il2cpp_utils::ExtractTypes(saberType)));
...
void GlobalNamespace::ObstacleSaberSoundEffect::HandleSparkleEffecDidEnd(GlobalNamespace::SaberType saberType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleSparkleEffecDidEnd", {}, ::il2cpp_utils::ExtractTypes(saberType)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, saberType);
}
...
GlobalNamespace::ObstacleSaberSoundEffect* GlobalNamespace::ObstacleSaberSoundEffect::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ObstacleSaberSoundEffect*>());
}
