...
UnityEngine::GameObject* GlobalNamespace::OVRDebugInfo::VariableObjectManager(UnityEngine::GameObject* gameObject, ::CsString* name, float posY, ::CsString* str, int fontSize) {
