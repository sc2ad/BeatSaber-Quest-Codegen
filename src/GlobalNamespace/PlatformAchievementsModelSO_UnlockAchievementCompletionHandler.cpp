...
GlobalNamespace::PlatformAchievementsModelSO::UnlockAchievementCompletionHandler* GlobalNamespace::PlatformAchievementsModelSO::UnlockAchievementCompletionHandler::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("UnlockAchievementCompletionHandler").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlatformAchievementsModelSO::UnlockAchievementCompletionHandler*>(object, method));
}
