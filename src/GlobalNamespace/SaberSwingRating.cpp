...
float GlobalNamespace::SaberSwingRating::NormalRating(float normalDiff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SaberSwingRating", il2cpp_utils::NoArgClass<float>(), "NormalRating", {}, ::il2cpp_utils::ExtractTypes(normalDiff)));
...
float GlobalNamespace::SaberSwingRating::BeforeCutStepRating(float angleDiff, float normalDiff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SaberSwingRating", il2cpp_utils::NoArgClass<float>(), "BeforeCutStepRating", {}, ::il2cpp_utils::ExtractTypes(angleDiff, normalDiff)));
...
float GlobalNamespace::SaberSwingRating::AfterCutStepRating(float angleDiff, float normalDiff) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SaberSwingRating", il2cpp_utils::NoArgClass<float>(), "AfterCutStepRating", {}, ::il2cpp_utils::ExtractTypes(angleDiff, normalDiff)));
  return ::il2cpp_utils::RunMethodThrow<float, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, angleDiff, normalDiff);
}
