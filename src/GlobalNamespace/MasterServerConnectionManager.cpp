...
void GlobalNamespace::MasterServerConnectionManager::HandleConnectionDisconnected(GlobalNamespace::IConnection* connection) {
...
// Autogenerated method: MasterServerConnectionManager.<StartBroadcastingServer>b__108_0
void GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__108_0(System::Net::IPEndPoint* remoteEndPoint, ::Il2CppString* code) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<StartBroadcastingServer>b__108_0", remoteEndPoint, code));
}
// Autogenerated method: MasterServerConnectionManager.<StartBroadcastingServer>b__108_1
void GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__108_1(GlobalNamespace::ConnectionFailedReason reason) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<StartBroadcastingServer>b__108_1", reason));
}
...
void GlobalNamespace::MasterServerConnectionManager::add_onConnectionDisconnectedEvent(System::Action_1<GlobalNamespace::IConnection*>* value) {
...
void GlobalNamespace::MasterServerConnectionManager::remove_onConnectionDisconnectedEvent(System::Action_1<GlobalNamespace::IConnection*>* value) {
