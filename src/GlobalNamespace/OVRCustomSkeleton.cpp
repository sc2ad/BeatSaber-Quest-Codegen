...
System::Collections::Generic::List_1<UnityEngine::Transform*>* GlobalNamespace::OVRCustomSkeleton::get_CustomBones() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Collections::Generic::List_1<UnityEngine::Transform*>*>(), "get_CustomBones", {}, ::il2cpp_utils::ExtractTypes()));
