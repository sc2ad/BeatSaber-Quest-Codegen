...
::Array<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers>* GlobalNamespace::GameplayModifiersHelper::ToDTO(GlobalNamespace::GameplayModifiers* gameplayModifiers) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayModifiersHelper", il2cpp_utils::NoArgClass<::Array<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers>*>(), "ToDTO", {}, ::il2cpp_utils::ExtractTypes(gameplayModifiers)));
...
GlobalNamespace::GameplayModifiers* GlobalNamespace::GameplayModifiersHelper::FromDTO(::Array<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers>* gameplayModifiersDTOs) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayModifiersHelper", il2cpp_utils::NoArgClass<GlobalNamespace::GameplayModifiers*>(), "FromDTO", {}, ::il2cpp_utils::ExtractTypes(gameplayModifiersDTOs)));
