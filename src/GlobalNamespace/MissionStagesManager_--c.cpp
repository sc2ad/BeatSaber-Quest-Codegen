...
void GlobalNamespace::MissionStagesManager::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "MissionStagesManager/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int GlobalNamespace::MissionStagesManager::$$c::$InitStages$b__6_0(GlobalNamespace::MissionStage* stage) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<InitStages>b__6_0", {}, ::il2cpp_utils::ExtractTypes(stage))));
...
GlobalNamespace::MissionStagesManager::$$c* GlobalNamespace::MissionStagesManager::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<MissionStagesManager::$$c*>());
}
