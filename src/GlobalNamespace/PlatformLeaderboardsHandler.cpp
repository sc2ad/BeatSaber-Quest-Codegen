...
GlobalNamespace::PlatformLeaderboardsHandler* GlobalNamespace::PlatformLeaderboardsHandler::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PlatformLeaderboardsHandler").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlatformLeaderboardsHandler*>());
}
