...
GlobalNamespace::OVRManager::XRDevice GlobalNamespace::OVRManager::XRDevice::_get_Unknown() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_get_Unknown");
...
void GlobalNamespace::OVRManager::XRDevice::_set_Unknown(GlobalNamespace::OVRManager::XRDevice value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_set_Unknown");
...
GlobalNamespace::OVRManager::XRDevice GlobalNamespace::OVRManager::XRDevice::_get_Oculus() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_get_Oculus");
...
void GlobalNamespace::OVRManager::XRDevice::_set_Oculus(GlobalNamespace::OVRManager::XRDevice value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_set_Oculus");
...
GlobalNamespace::OVRManager::XRDevice GlobalNamespace::OVRManager::XRDevice::_get_OpenVR() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_get_OpenVR");
...
void GlobalNamespace::OVRManager::XRDevice::_set_OpenVR(GlobalNamespace::OVRManager::XRDevice value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("XRDevice").WithContext("_set_OpenVR");
