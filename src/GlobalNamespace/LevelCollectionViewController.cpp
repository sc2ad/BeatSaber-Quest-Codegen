...
void GlobalNamespace::LevelCollectionViewController::SetData(GlobalNamespace::IBeatmapLevelCollection* beatmapLevelCollection, ::Il2CppString* headerText, UnityEngine::Sprite* headerSprite, bool sortLevels, UnityEngine::GameObject* noDataInfoPrefab) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetData", {}, ::il2cpp_utils::ExtractTypes(beatmapLevelCollection, headerText, headerSprite, sortLevels, noDataInfoPrefab)));
...
void GlobalNamespace::LevelCollectionViewController::RefreshFavorites() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RefreshFavorites", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::LevelCollectionViewController::HandleLevelCollectionTableViewDidSelectLevel(GlobalNamespace::LevelCollectionTableView* tableView, GlobalNamespace::IPreviewBeatmapLevel* level) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleLevelCollectionTableViewDidSelectLevel", {}, ::il2cpp_utils::ExtractTypes(tableView, level)));
...
void GlobalNamespace::LevelCollectionViewController::SongPlayerCrossfadeToLevelAsync(GlobalNamespace::IPreviewBeatmapLevel* level) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SongPlayerCrossfadeToLevelAsync", {}, ::il2cpp_utils::ExtractTypes(level)));
...
void GlobalNamespace::LevelCollectionViewController::HandleLevelCollectionTableViewDidSelectPack(GlobalNamespace::LevelCollectionTableView* tableView) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleLevelCollectionTableViewDidSelectPack", {}, ::il2cpp_utils::ExtractTypes(tableView)));
