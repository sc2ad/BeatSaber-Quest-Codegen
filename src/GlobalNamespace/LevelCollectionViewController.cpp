...
void GlobalNamespace::LevelCollectionViewController::SetData(GlobalNamespace::IBeatmapLevelCollection* beatmapLevelCollection, ::CsString* headerText, UnityEngine::Sprite* headerSprite, bool sortLevels, UnityEngine::GameObject* noDataInfoPrefab) {
...
void GlobalNamespace::LevelCollectionViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
void GlobalNamespace::LevelCollectionViewController::DidDeactivate(HMUI::ViewController::DeactivationType deactivationType) {
...
GlobalNamespace::LevelCollectionViewController* GlobalNamespace::LevelCollectionViewController::New_ctor() {
  return (LevelCollectionViewController*)THROW_UNLESS(il2cpp_utils::New("", "LevelCollectionViewController"));
}
