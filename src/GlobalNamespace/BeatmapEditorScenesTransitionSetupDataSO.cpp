...
GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO* GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BeatmapEditorScenesTransitionSetupDataSO").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<BeatmapEditorScenesTransitionSetupDataSO*>());
}
