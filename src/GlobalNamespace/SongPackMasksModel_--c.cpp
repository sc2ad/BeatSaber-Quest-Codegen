...
void GlobalNamespace::SongPackMasksModel::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "SongPackMasksModel/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::SongPackMasksModel::$$c::$_ctor$b__3_0(GlobalNamespace::IBeatmapLevelPack* pack) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<.ctor>b__3_0", {}, ::il2cpp_utils::ExtractTypes(pack))));
