...
System::Threading::Tasks::Task_1<OnlineServices::SendLeaderboardEntryResult>* GlobalNamespace::HTTPLeaderboardsModel::SendLevelScoreResultAsync(OnlineServices::LevelScoreResultsData levelResultsData, System::Threading::CancellationToken cancellationToken) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Threading::Tasks::Task_1<OnlineServices::SendLeaderboardEntryResult>*>(), "SendLevelScoreResultAsync", {}, ::il2cpp_utils::ExtractTypes(levelResultsData, cancellationToken)));
...
GlobalNamespace::HTTPLeaderboardsModel* GlobalNamespace::HTTPLeaderboardsModel::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("HTTPLeaderboardsModel").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<HTTPLeaderboardsModel*>());
}
