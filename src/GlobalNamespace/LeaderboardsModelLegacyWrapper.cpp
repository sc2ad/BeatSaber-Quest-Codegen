...
GlobalNamespace::LeaderboardsModelLegacyWrapper* GlobalNamespace::LeaderboardsModelLegacyWrapper::New_ctor(OnlineServices::ILeaderboardsModel* leaderboardsModel) {
  return (LeaderboardsModelLegacyWrapper*)THROW_UNLESS(il2cpp_utils::New("", "LeaderboardsModelLegacyWrapper", leaderboardsModel));
}
...
GlobalNamespace::HMAsyncRequest* GlobalNamespace::LeaderboardsModelLegacyWrapper::GetScores(GlobalNamespace::IDifficultyBeatmap* beatmap, int count, int fromRank, GlobalNamespace::PlatformLeaderboardsModel::ScoresScope scope, ::CsString* referencePlayerId, GlobalNamespace::PlatformLeaderboardsModel::GetScoresCompletionHandler* completionHandler) {
