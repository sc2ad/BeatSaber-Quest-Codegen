...
::CsString* GlobalNamespace::DifficultyTableView::_get_kCellIdentifier() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "DifficultyTableView", "kCellIdentifier"));
}
// Autogenerated static field setter
// Set static field: static private System.String kCellIdentifier
void GlobalNamespace::DifficultyTableView::_set_kCellIdentifier(::CsString* value) {
...
::CsString* GlobalNamespace::DifficultyTableView::_get_kNonSelectableCellIdentifier() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "DifficultyTableView", "kNonSelectableCellIdentifier"));
}
// Autogenerated static field setter
// Set static field: static private System.String kNonSelectableCellIdentifier
void GlobalNamespace::DifficultyTableView::_set_kNonSelectableCellIdentifier(::CsString* value) {
