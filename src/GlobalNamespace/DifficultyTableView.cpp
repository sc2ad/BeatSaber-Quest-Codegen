...
void GlobalNamespace::DifficultyTableView::add_didSelectRow(System::Action_2<GlobalNamespace::DifficultyTableView*, int>* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "add_didSelectRow", {}, ::il2cpp_utils::ExtractTypes(value)));
...
void GlobalNamespace::DifficultyTableView::remove_didSelectRow(System::Action_2<GlobalNamespace::DifficultyTableView*, int>* value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "remove_didSelectRow", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
void GlobalNamespace::DifficultyTableView::Init(::Array<GlobalNamespace::IDifficultyBeatmap*>* difficultyBeatmaps) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(difficultyBeatmaps)));
...
void GlobalNamespace::DifficultyTableView::SetDifficultyBeatmaps(::Array<GlobalNamespace::IDifficultyBeatmap*>* difficultyBeatmaps) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetDifficultyBeatmaps", {}, ::il2cpp_utils::ExtractTypes(difficultyBeatmaps)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, difficultyBeatmaps);
}
...
void GlobalNamespace::DifficultyTableView::SelectRow(int row, bool callbackTable) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SelectRow", {}, ::il2cpp_utils::ExtractTypes(row, callbackTable)));
...
void GlobalNamespace::DifficultyTableView::SelectRow(GlobalNamespace::IDifficultyBeatmap* difficultyBeatmap, bool callbackTable) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("DifficultyTableView").WithContext("SelectRow");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SelectRow", {}, ::il2cpp_utils::ExtractTypes(difficultyBeatmap, callbackTable)));
...
GlobalNamespace::DifficultyTableView* GlobalNamespace::DifficultyTableView::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("DifficultyTableView").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<DifficultyTableView*>());
}
