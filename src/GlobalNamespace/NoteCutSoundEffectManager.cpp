...
bool GlobalNamespace::NoteCutSoundEffectManager::get_handleWrongSaberTypeAsGood() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_handleWrongSaberTypeAsGood", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::NoteCutSoundEffectManager::set_handleWrongSaberTypeAsGood(bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_handleWrongSaberTypeAsGood", {}, ::il2cpp_utils::ExtractTypes(value)));
...
void GlobalNamespace::NoteCutSoundEffectManager::HandleCutSoundEffectDidFinish(GlobalNamespace::NoteCutSoundEffect* cutSoundEffect) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleCutSoundEffectDidFinish", {}, ::il2cpp_utils::ExtractTypes(cutSoundEffect)));
...
GlobalNamespace::NoteCutSoundEffectManager* GlobalNamespace::NoteCutSoundEffectManager::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<NoteCutSoundEffectManager*>());
}
