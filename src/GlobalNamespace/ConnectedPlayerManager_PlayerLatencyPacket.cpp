...
GlobalNamespace::PacketPool_1<GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket*>* GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ConnectedPlayerManager/PlayerLatencyPacket", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket* GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket::Init(float latency) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::ConnectedPlayerManager::PlayerLatencyPacket*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(latency)));
