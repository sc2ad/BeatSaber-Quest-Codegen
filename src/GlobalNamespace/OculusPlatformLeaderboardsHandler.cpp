...
void GlobalNamespace::OculusPlatformLeaderboardsHandler::AddOculusRequest(Oculus::Platform::Request* oculusRequest, GlobalNamespace::HMAsyncRequest* asyncRequest) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "AddOculusRequest", {}, ::il2cpp_utils::ExtractTypes(oculusRequest, asyncRequest)));
...
bool GlobalNamespace::OculusPlatformLeaderboardsHandler::CheckMessageForValidRequest(Oculus::Platform::Message* message) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "CheckMessageForValidRequest", {}, ::il2cpp_utils::ExtractTypes(message)));
...
GlobalNamespace::OculusPlatformLeaderboardsHandler* GlobalNamespace::OculusPlatformLeaderboardsHandler::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("OculusPlatformLeaderboardsHandler").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OculusPlatformLeaderboardsHandler*>());
}
