...
// Including type: OculusConnectionManager/<HandlePeerConnectionRequest>d__58
#include "GlobalNamespace/OculusConnectionManager_-HandlePeerConnectionRequest-d__58.hpp"
...
void GlobalNamespace::OculusConnectionManager::RemoveConnection(uint64_t id) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "RemoveConnection", id));
}
...
// Autogenerated method: OculusConnectionManager.<PollUpdate>b__52_0
void GlobalNamespace::OculusConnectionManager::$PollUpdate$b__52_0(GlobalNamespace::OculusConnectionManager::OculusConnection* connection, float latency) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<PollUpdate>b__52_0", connection, latency));
}
...
void GlobalNamespace::OculusConnectionManager::add_onConnectionDisconnectedEvent(System::Action_1<GlobalNamespace::IConnection*>* value) {
...
void GlobalNamespace::OculusConnectionManager::remove_onConnectionDisconnectedEvent(System::Action_1<GlobalNamespace::IConnection*>* value) {
