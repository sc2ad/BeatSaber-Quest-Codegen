...
void GlobalNamespace::LightPairRotationEventEffect::UpdateRotationData(int beatmapEventDataValue, GlobalNamespace::LightPairRotationEventEffect::RotationData* rotationData, float startRotationOffset, float direction) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "UpdateRotationData", {}, ::il2cpp_utils::ExtractTypes(beatmapEventDataValue, rotationData, startRotationOffset, direction)));
...
GlobalNamespace::LightPairRotationEventEffect* GlobalNamespace::LightPairRotationEventEffect::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<LightPairRotationEventEffect*>());
}
