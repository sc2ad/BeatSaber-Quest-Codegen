...
GlobalNamespace::VRControllersRecorderSaveData* GlobalNamespace::VRControllersRecorderSaveAndLoad::LoadSaveDataFromFile(::Il2CppString* filePath) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "VRControllersRecorderSaveAndLoad", il2cpp_utils::NoArgClass<GlobalNamespace::VRControllersRecorderSaveData*>(), "LoadSaveDataFromFile", {}, ::il2cpp_utils::ExtractTypes(filePath)));
...
GlobalNamespace::VRControllersRecorderSaveData* GlobalNamespace::VRControllersRecorderSaveAndLoad::LoadSaveDataFromTextAsset(UnityEngine::TextAsset* textAsset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "VRControllersRecorderSaveAndLoad", il2cpp_utils::NoArgClass<GlobalNamespace::VRControllersRecorderSaveData*>(), "LoadSaveDataFromTextAsset", {}, ::il2cpp_utils::ExtractTypes(textAsset)));
...
void GlobalNamespace::VRControllersRecorderSaveAndLoad::LoadFromFile(::Il2CppString* filePath, GlobalNamespace::VRControllersRecorderData* data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "VRControllersRecorderSaveAndLoad", il2cpp_utils::NoArgClass<void>(), "LoadFromFile", {}, ::il2cpp_utils::ExtractTypes(filePath, data)));
...
void GlobalNamespace::VRControllersRecorderSaveAndLoad::SaveToFile(::Il2CppString* filePath, GlobalNamespace::VRControllersRecorderData* data) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "VRControllersRecorderSaveAndLoad", il2cpp_utils::NoArgClass<void>(), "SaveToFile", {}, ::il2cpp_utils::ExtractTypes(filePath, data)));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, filePath, data);
}
