...
// Completed includes
// Autogenerated method: BaseNetworkPlayerModel/<GetOtherPlayers>d__56..ctor
GlobalNamespace::BaseNetworkPlayerModel::$GetOtherPlayers$d__56* GlobalNamespace::BaseNetworkPlayerModel::$GetOtherPlayers$d__56::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BaseNetworkPlayerModel::$GetOtherPlayers$d__56*>($$1__state));
}
