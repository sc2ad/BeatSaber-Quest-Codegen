...
GlobalNamespace::OnWillRenderObjectTrigger* GlobalNamespace::OnWillRenderObjectTrigger::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("OnWillRenderObjectTrigger").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OnWillRenderObjectTrigger*>());
}
