...
// Completed includes
// Autogenerated method: ClickButtonWithCommandArgument/<Start>d__2..ctor
GlobalNamespace::ClickButtonWithCommandArgument::$Start$d__2* GlobalNamespace::ClickButtonWithCommandArgument::$Start$d__2::New_ctor(int $$1__state) {
  return (ClickButtonWithCommandArgument::$Start$d__2*)THROW_UNLESS(il2cpp_utils::New("", "ClickButtonWithCommandArgument/<Start>d__2", $$1__state));
}
...
::CsObject* GlobalNamespace::ClickButtonWithCommandArgument::$Start$d__2::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::ClickButtonWithCommandArgument::$Start$d__2::System_Collections_IEnumerator_get_Current() {
