...
GlobalNamespace::TutorialController::$OutroCoroutine$d__13* GlobalNamespace::TutorialController::$OutroCoroutine$d__13::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$OutroCoroutine$d__13").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TutorialController::$OutroCoroutine$d__13*>($$1__state));
}
