...
void GlobalNamespace::BombCutSoundEffect::Init(UnityEngine::AudioClip* audioClip, GlobalNamespace::Saber* saber, float volume) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(audioClip, saber, volume)));
...
GlobalNamespace::BombCutSoundEffect* GlobalNamespace::BombCutSoundEffect::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BombCutSoundEffect").WithContext(".ctor");
