...
GlobalNamespace::SteamVR_Render::$RenderLoop$d__29* GlobalNamespace::SteamVR_Render::$RenderLoop$d__29::New_ctor(int $$1__state) {
  return (SteamVR_Render::$RenderLoop$d__29*)THROW_UNLESS(il2cpp_utils::New("", "SteamVR_Render/<RenderLoop>d__29", $$1__state));
}
...
::CsObject* GlobalNamespace::SteamVR_Render::$RenderLoop$d__29::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::SteamVR_Render::$RenderLoop$d__29::System_Collections_IEnumerator_get_Current() {
