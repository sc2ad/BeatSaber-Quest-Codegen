...
void GlobalNamespace::NoteCutter::Cut(GlobalNamespace::Saber* saber) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Cut", {}, ::il2cpp_utils::ExtractTypes(saber)));
...
GlobalNamespace::NoteCutter* GlobalNamespace::NoteCutter::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("NoteCutter").WithContext(".ctor");
