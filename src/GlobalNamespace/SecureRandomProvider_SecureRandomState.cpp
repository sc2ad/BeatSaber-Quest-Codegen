...
void GlobalNamespace::SecureRandomProvider::SecureRandomState::GetBytes(::Array<uint8_t>* buffer, int offset, int length) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "GetBytes", {}, ::il2cpp_utils::ExtractTypes(buffer, offset, length)));
...
void GlobalNamespace::SecureRandomProvider::SecureRandomState::FillBuffer() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "FillBuffer", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::SecureRandomProvider::SecureRandomState* GlobalNamespace::SecureRandomProvider::SecureRandomState::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SecureRandomState").WithContext(".ctor");
