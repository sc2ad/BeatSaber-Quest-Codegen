...
GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator* GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::New_ctor(GlobalNamespace::IAudioTimeSource* audioTimeSource, GlobalNamespace::BeatmapObjectSpawnController* beatmapObjectSpawnController, float moveToPlayerHeadTParam, GlobalNamespace::BeatmapObjectSpawnMovementData::NoteSpawnData noteSpawnData) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BeatmapObjectAvoidanceYOffsetEvaluator").WithContext(".ctor");
...
float GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::GetJumpOffsetYAtJumpStartSongTime(float lastDeltaTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "GetJumpOffsetYAtJumpStartSongTime", {}, ::il2cpp_utils::ExtractTypes(lastDeltaTime)));
