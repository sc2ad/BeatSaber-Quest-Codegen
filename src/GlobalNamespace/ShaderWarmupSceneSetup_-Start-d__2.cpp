...
::CsObject* GlobalNamespace::ShaderWarmupSceneSetup::$Start$d__2::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::ShaderWarmupSceneSetup::$Start$d__2::System_Collections_IEnumerator_get_Current() {
