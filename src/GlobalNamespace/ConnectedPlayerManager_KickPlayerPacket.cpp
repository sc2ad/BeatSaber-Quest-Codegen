...
GlobalNamespace::PacketPool_1<GlobalNamespace::ConnectedPlayerManager::KickPlayerPacket*>* GlobalNamespace::ConnectedPlayerManager::KickPlayerPacket::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ConnectedPlayerManager/KickPlayerPacket", "get_pool", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
