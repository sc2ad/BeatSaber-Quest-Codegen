...
::CsString* GlobalNamespace::PreviewBeatmapLevelSO::get_levelID() {
...
::CsString* GlobalNamespace::PreviewBeatmapLevelSO::get_songName() {
...
::CsString* GlobalNamespace::PreviewBeatmapLevelSO::get_songSubName() {
...
::CsString* GlobalNamespace::PreviewBeatmapLevelSO::get_songAuthorName() {
...
::CsString* GlobalNamespace::PreviewBeatmapLevelSO::get_levelAuthorName() {
...
GlobalNamespace::PreviewBeatmapLevelSO* GlobalNamespace::PreviewBeatmapLevelSO::New_ctor() {
  return (PreviewBeatmapLevelSO*)THROW_UNLESS(il2cpp_utils::New("", "PreviewBeatmapLevelSO"));
}
