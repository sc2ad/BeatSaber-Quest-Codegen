...
void GlobalNamespace::ResultObjectiveListItem::set_title(::CsString* value) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "set_title", value));
}
// Autogenerated method: ResultObjectiveListItem.set_conditionText
void GlobalNamespace::ResultObjectiveListItem::set_conditionText(::CsString* value) {
...
void GlobalNamespace::ResultObjectiveListItem::set_valueText(::CsString* value) {
