...
void GlobalNamespace::NoteJumpStartBeatOffsetDropdown::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "NoteJumpStartBeatOffsetDropdown/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
