...
GlobalNamespace::SmoothCameraSmoothnessSettingsController* GlobalNamespace::SmoothCameraSmoothnessSettingsController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SmoothCameraSmoothnessSettingsController").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SmoothCameraSmoothnessSettingsController*>());
}
