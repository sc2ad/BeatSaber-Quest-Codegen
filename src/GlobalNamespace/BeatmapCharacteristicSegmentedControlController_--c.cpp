...
void GlobalNamespace::BeatmapCharacteristicSegmentedControlController::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "BeatmapCharacteristicSegmentedControlController/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
int GlobalNamespace::BeatmapCharacteristicSegmentedControlController::$$c::$SetData$b__10_0(GlobalNamespace::IDifficultyBeatmapSet* a, GlobalNamespace::IDifficultyBeatmapSet* b) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "<SetData>b__10_0", {}, ::il2cpp_utils::ExtractTypes(a, b))));
...
GlobalNamespace::BeatmapCharacteristicSegmentedControlController::$$c* GlobalNamespace::BeatmapCharacteristicSegmentedControlController::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BeatmapCharacteristicSegmentedControlController::$$c*>());
}
