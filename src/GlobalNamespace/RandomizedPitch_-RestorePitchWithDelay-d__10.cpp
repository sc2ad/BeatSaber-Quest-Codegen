...
// Completed includes
// Autogenerated method: RandomizedPitch/<RestorePitchWithDelay>d__10..ctor
GlobalNamespace::RandomizedPitch::$RestorePitchWithDelay$d__10* GlobalNamespace::RandomizedPitch::$RestorePitchWithDelay$d__10::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$RestorePitchWithDelay$d__10").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<RandomizedPitch::$RestorePitchWithDelay$d__10*>($$1__state));
}
