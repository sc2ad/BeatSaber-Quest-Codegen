...
void GlobalNamespace::AutomaticSFXVolume::RecalculateParams() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RecalculateParams", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
GlobalNamespace::AutomaticSFXVolume* GlobalNamespace::AutomaticSFXVolume::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("AutomaticSFXVolume").WithContext(".ctor");
