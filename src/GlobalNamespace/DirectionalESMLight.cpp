...
GlobalNamespace::DirectionalESMLight* GlobalNamespace::DirectionalESMLight::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("DirectionalESMLight").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<DirectionalESMLight*>());
}
