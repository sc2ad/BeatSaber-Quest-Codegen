...
void GlobalNamespace::MainSettingsDefaultValues::SetFixedDefaultValues(GlobalNamespace::MainSettingsModelSO* mainSettingsModel) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "MainSettingsDefaultValues", il2cpp_utils::NoArgClass<void>(), "SetFixedDefaultValues", {}, ::il2cpp_utils::ExtractTypes(mainSettingsModel)));
...
GlobalNamespace::MainSettingsDefaultValues* GlobalNamespace::MainSettingsDefaultValues::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MainSettingsDefaultValues").WithContext(".ctor");
