...
void GlobalNamespace::ColorSchemesSettings::set_selectedColorSchemeId(::CsString* value) {
...
::CsString* GlobalNamespace::ColorSchemesSettings::get_selectedColorSchemeId() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_selectedColorSchemeId"));
}
...
GlobalNamespace::ColorScheme* GlobalNamespace::ColorSchemesSettings::GetColorSchemeForId(::CsString* id) {
