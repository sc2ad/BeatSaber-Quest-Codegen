...
::Il2CppString* GlobalNamespace::DifficultyBeatmapSerializedMethods::SerializedName(GlobalNamespace::IDifficultyBeatmap* difficultyBeatmap) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DifficultyBeatmapSerializedMethods", il2cpp_utils::NoArgClass<::Il2CppString*>(), "SerializedName", {}, ::il2cpp_utils::ExtractTypes(difficultyBeatmap)));
