...
GlobalNamespace::OVRPlugin::Result GlobalNamespace::OVRPlugin::OVRP_1_45_0::ovrp_GetSystemHmd3DofModeEnabled(GlobalNamespace::OVRPlugin::Bool& enabled) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_45_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Result>(), "ovrp_GetSystemHmd3DofModeEnabled", {}, ::il2cpp_utils::ExtractTypes(enabled)));
...
void GlobalNamespace::OVRPlugin::OVRP_1_45_0::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_45_0", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
