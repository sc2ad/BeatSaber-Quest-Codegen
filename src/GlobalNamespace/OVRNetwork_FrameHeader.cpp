...
GlobalNamespace::OVRNetwork::FrameHeader GlobalNamespace::OVRNetwork::FrameHeader::FromBytes(::Array<uint8_t>* arr) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRNetwork/FrameHeader", il2cpp_utils::NoArgClass<GlobalNamespace::OVRNetwork::FrameHeader>(), "FromBytes", {}, ::il2cpp_utils::ExtractTypes(arr)));
