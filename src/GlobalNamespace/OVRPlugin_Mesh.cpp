...
GlobalNamespace::OVRPlugin::Mesh* GlobalNamespace::OVRPlugin::Mesh::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Mesh").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OVRPlugin::Mesh*>());
}
