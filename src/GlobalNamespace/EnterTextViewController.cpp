...
void GlobalNamespace::EnterTextViewController::Init(::Il2CppString* titleText) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Init", {}, ::il2cpp_utils::ExtractTypes(titleText)));
...
GlobalNamespace::EnterTextViewController* GlobalNamespace::EnterTextViewController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("EnterTextViewController").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<EnterTextViewController*>());
}
