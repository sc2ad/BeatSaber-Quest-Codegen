...
::CsString* GlobalNamespace::MainEffectController::_get_kMainEffectEnabledKeyword() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "MainEffectController", "kMainEffectEnabledKeyword"));
}
// Autogenerated static field setter
// Set static field: static private System.String kMainEffectEnabledKeyword
void GlobalNamespace::MainEffectController::_set_kMainEffectEnabledKeyword(::CsString* value) {
...
GlobalNamespace::MainEffectController* GlobalNamespace::MainEffectController::New_ctor() {
  return (MainEffectController*)THROW_UNLESS(il2cpp_utils::New("", "MainEffectController"));
}
