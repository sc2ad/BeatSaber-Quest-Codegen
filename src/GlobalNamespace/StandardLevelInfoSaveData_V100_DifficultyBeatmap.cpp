...
::CsString* GlobalNamespace::StandardLevelInfoSaveData_V100::DifficultyBeatmap::get_difficulty() {
...
::CsString* GlobalNamespace::StandardLevelInfoSaveData_V100::DifficultyBeatmap::get_beatmapFilename() {
...
GlobalNamespace::StandardLevelInfoSaveData_V100::DifficultyBeatmap* GlobalNamespace::StandardLevelInfoSaveData_V100::DifficultyBeatmap::New_ctor(::CsString* difficultyName, int difficultyRank, ::CsString* beatmapFilename, float noteJumpMovementSpeed, int noteJumpStartBeatOffset) {
