...
GlobalNamespace::DiffieHellmanUtility::OperationTimer* GlobalNamespace::DiffieHellmanUtility::OperationTimer::Time(::Il2CppString* operation) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility/OperationTimer", "Time", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(operation)));
