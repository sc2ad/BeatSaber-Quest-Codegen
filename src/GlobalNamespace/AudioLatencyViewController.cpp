...
void GlobalNamespace::AudioLatencyViewController::SliderValueDidChange(HMUI::RangeValuesTextSlider* slider, float value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SliderValueDidChange", {}, ::il2cpp_utils::ExtractTypes(slider, value)));
...
void GlobalNamespace::AudioLatencyViewController::HandleOverrideAudioLatencyToggleValueChanged(bool isOn) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleOverrideAudioLatencyToggleValueChanged", {}, ::il2cpp_utils::ExtractTypes(isOn)));
...
void GlobalNamespace::AudioLatencyViewController::RefreshVisuals(bool overrideAudioLatencyIsEnabled) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "RefreshVisuals", {}, ::il2cpp_utils::ExtractTypes(overrideAudioLatencyIsEnabled)));
