...
::Array<float>* GlobalNamespace::BasicSpectrogramData::get_Samples() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Array<float>*>(), "get_Samples", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::BasicSpectrogramData::ProcessSamples(::Array<float>* sourceSamples, System::Collections::Generic::List_1<float>* processedSamples) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ProcessSamples", {}, ::il2cpp_utils::ExtractTypes(sourceSamples, processedSamples)));
...
GlobalNamespace::BasicSpectrogramData* GlobalNamespace::BasicSpectrogramData::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BasicSpectrogramData*>());
}
