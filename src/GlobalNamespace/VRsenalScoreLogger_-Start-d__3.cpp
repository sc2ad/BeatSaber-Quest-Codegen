...
GlobalNamespace::VRsenalScoreLogger::$Start$d__3* GlobalNamespace::VRsenalScoreLogger::$Start$d__3::New_ctor(int $$1__state) {
  return (VRsenalScoreLogger::$Start$d__3*)THROW_UNLESS(il2cpp_utils::New("", "VRsenalScoreLogger/<Start>d__3", $$1__state));
}
...
::CsObject* GlobalNamespace::VRsenalScoreLogger::$Start$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::VRsenalScoreLogger::$Start$d__3::System_Collections_IEnumerator_get_Current() {
