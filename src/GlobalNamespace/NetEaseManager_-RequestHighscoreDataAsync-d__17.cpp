...
void GlobalNamespace::NetEaseManager::$RequestHighscoreDataAsync$d__17::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$RequestHighscoreDataAsync$d__17").WithContext("MoveNext");
...
void GlobalNamespace::NetEaseManager::$RequestHighscoreDataAsync$d__17::SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$RequestHighscoreDataAsync$d__17").WithContext("SetStateMachine");
