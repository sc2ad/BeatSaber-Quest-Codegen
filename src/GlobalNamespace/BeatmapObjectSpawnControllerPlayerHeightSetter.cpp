...
void GlobalNamespace::BeatmapObjectSpawnControllerPlayerHeightSetter::HandlePlayerHeightDidChange(float playerHeight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandlePlayerHeightDidChange", {}, ::il2cpp_utils::ExtractTypes(playerHeight)));
...
float GlobalNamespace::BeatmapObjectSpawnControllerPlayerHeightSetter::JumpOffsetYForPlayerHeight(float playerHeight) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapObjectSpawnControllerPlayerHeightSetter", il2cpp_utils::NoArgClass<float>(), "JumpOffsetYForPlayerHeight", {}, ::il2cpp_utils::ExtractTypes(playerHeight)));
...
GlobalNamespace::BeatmapObjectSpawnControllerPlayerHeightSetter* GlobalNamespace::BeatmapObjectSpawnControllerPlayerHeightSetter::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BeatmapObjectSpawnControllerPlayerHeightSetter*>());
}
