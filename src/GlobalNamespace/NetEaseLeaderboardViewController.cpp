...
void GlobalNamespace::NetEaseLeaderboardViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
void GlobalNamespace::NetEaseLeaderboardViewController::DidDeactivate(HMUI::ViewController::DeactivationType deactivationType) {
...
GlobalNamespace::NetEaseLeaderboardViewController* GlobalNamespace::NetEaseLeaderboardViewController::New_ctor() {
  return (NetEaseLeaderboardViewController*)THROW_UNLESS(il2cpp_utils::New("", "NetEaseLeaderboardViewController"));
}
