...
GlobalNamespace::QuaternionSerializable GlobalNamespace::QuaternionSerializable::get_identity() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "QuaternionSerializable", il2cpp_utils::NoArgClass<GlobalNamespace::QuaternionSerializable>(), "get_identity", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::QuaternionSerializable::QuaternionSerializable(LiteNetLib::Utils::NetDataReader* reader) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("QuaternionSerializable").WithContext(".ctor");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<QuaternionSerializable>(), ".ctor", {}, ::il2cpp_utils::ExtractTypes(reader)));
