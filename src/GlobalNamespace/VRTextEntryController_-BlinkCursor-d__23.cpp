...
GlobalNamespace::VRTextEntryController::$BlinkCursor$d__23* GlobalNamespace::VRTextEntryController::$BlinkCursor$d__23::New_ctor(int $$1__state) {
  return (VRTextEntryController::$BlinkCursor$d__23*)THROW_UNLESS(il2cpp_utils::New("", "VRTextEntryController/<BlinkCursor>d__23", $$1__state));
}
...
::CsObject* GlobalNamespace::VRTextEntryController::$BlinkCursor$d__23::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::VRTextEntryController::$BlinkCursor$d__23::System_Collections_IEnumerator_get_Current() {
