...
GlobalNamespace::HealthWarningNoTransitionInstaller* GlobalNamespace::HealthWarningNoTransitionInstaller::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("HealthWarningNoTransitionInstaller").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<HealthWarningNoTransitionInstaller*>());
}
