...
void GlobalNamespace::AlphabetScrollbarInfoBeatmapLevelHelper::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "AlphabetScrollbarInfoBeatmapLevelHelper/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::AlphabetScrollbarInfoBeatmapLevelHelper::$$c::$CreateData$b__3_0(GlobalNamespace::IPreviewBeatmapLevel* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<CreateData>b__3_0", {}, ::il2cpp_utils::ExtractTypes(x))));
...
GlobalNamespace::AlphabetScrollbarInfoBeatmapLevelHelper::$$c* GlobalNamespace::AlphabetScrollbarInfoBeatmapLevelHelper::$$c::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<AlphabetScrollbarInfoBeatmapLevelHelper::$$c*>());
}
