...
// Autogenerated method: BeatmapObjectSpawnController.SpawnLongNote
void GlobalNamespace::BeatmapObjectSpawnController::SpawnLongNote(GlobalNamespace::NoteData* noteData, float cutDirectionAngleOffset) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "SpawnLongNote", noteData, cutDirectionAngleOffset));
}
