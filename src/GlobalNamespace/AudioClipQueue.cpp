...
void GlobalNamespace::AudioClipQueue::PlayAudioClipWithDelay(UnityEngine::AudioClip* audioClip, float delay) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "PlayAudioClipWithDelay", {}, ::il2cpp_utils::ExtractTypes(audioClip, delay)));
...
GlobalNamespace::AudioClipQueue* GlobalNamespace::AudioClipQueue::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("AudioClipQueue").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<AudioClipQueue*>());
}
