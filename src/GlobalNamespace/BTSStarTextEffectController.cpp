...
float GlobalNamespace::BTSStarTextEffectController::get_animationDuration() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "get_animationDuration", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::BTSStarTextEffectController::Reinitialize(UnityEngine::Sprite* sprite, UnityEngine::Transform* parentTransform, float desiredAnimationLength) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Reinitialize", {}, ::il2cpp_utils::ExtractTypes(sprite, parentTransform, desiredAnimationLength)));
...
GlobalNamespace::BTSStarTextEffectController* GlobalNamespace::BTSStarTextEffectController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BTSStarTextEffectController").WithContext(".ctor");
