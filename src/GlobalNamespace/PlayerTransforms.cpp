...
// Autogenerated method: PlayerTransforms.get_worldToLocalRot
UnityEngine::Quaternion GlobalNamespace::PlayerTransforms::get_worldToLocalRot() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<UnityEngine::Quaternion>(this, "get_worldToLocalRot"));
}
...
// Autogenerated method: PlayerTransforms.Start
void GlobalNamespace::PlayerTransforms::Start() {
