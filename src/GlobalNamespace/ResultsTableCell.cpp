...
void GlobalNamespace::ResultsTableCell::SetData(int order, GlobalNamespace::IConnectedPlayer* connectedPlayer, GlobalNamespace::LevelCompletionResults* levelCompletionResults) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetData", {}, ::il2cpp_utils::ExtractTypes(order, connectedPlayer, levelCompletionResults)));
...
GlobalNamespace::ResultsTableCell* GlobalNamespace::ResultsTableCell::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ResultsTableCell").WithContext(".ctor");
