...
GlobalNamespace::StandardLevelInfoSaveData* GlobalNamespace::StandardLevelLoader::LoadStandardLevelSaveData(::Il2CppString* levelInfoFilenamePath) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "StandardLevelLoader", il2cpp_utils::NoArgClass<GlobalNamespace::StandardLevelInfoSaveData*>(), "LoadStandardLevelSaveData", {}, ::il2cpp_utils::ExtractTypes(levelInfoFilenamePath)));
