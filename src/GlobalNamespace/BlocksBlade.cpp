...
void GlobalNamespace::BlocksBlade::SetUpElement(GlobalNamespace::BlocksBlade::Element* element, float velocity, UnityEngine::Color color) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetUpElement", {}, ::il2cpp_utils::ExtractTypes(element, velocity, color)));
...
UnityEngine::Vector2 GlobalNamespace::BlocksBlade::RandomPointOnCircle(float radius) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<UnityEngine::Vector2>(), "RandomPointOnCircle", {}, ::il2cpp_utils::ExtractTypes(radius)));
...
GlobalNamespace::BlocksBlade* GlobalNamespace::BlocksBlade::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<BlocksBlade*>());
}
...
void GlobalNamespace::BlocksBlade::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BlocksBlade", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
