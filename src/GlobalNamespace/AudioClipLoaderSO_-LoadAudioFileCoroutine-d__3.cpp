...
GlobalNamespace::AudioClipLoaderSO::$LoadAudioFileCoroutine$d__3* GlobalNamespace::AudioClipLoaderSO::$LoadAudioFileCoroutine$d__3::New_ctor(int $$1__state) {
  return (AudioClipLoaderSO::$LoadAudioFileCoroutine$d__3*)THROW_UNLESS(il2cpp_utils::New("", "AudioClipLoaderSO/<LoadAudioFileCoroutine>d__3", $$1__state));
}
...
::CsObject* GlobalNamespace::AudioClipLoaderSO::$LoadAudioFileCoroutine$d__3::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::AudioClipLoaderSO::$LoadAudioFileCoroutine$d__3::System_Collections_IEnumerator_get_Current() {
