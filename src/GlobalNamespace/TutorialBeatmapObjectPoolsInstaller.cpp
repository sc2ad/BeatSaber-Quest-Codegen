...
GlobalNamespace::TutorialBeatmapObjectPoolsInstaller* GlobalNamespace::TutorialBeatmapObjectPoolsInstaller::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("TutorialBeatmapObjectPoolsInstaller").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TutorialBeatmapObjectPoolsInstaller*>());
}
