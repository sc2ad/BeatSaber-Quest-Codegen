...
GlobalNamespace::SceneLoadedCallbacksOrderDebug* GlobalNamespace::SceneLoadedCallbacksOrderDebug::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SceneLoadedCallbacksOrderDebug").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SceneLoadedCallbacksOrderDebug*>());
}
