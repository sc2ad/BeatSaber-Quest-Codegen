...
GlobalNamespace::SaberSwingRatingCounter::DidFinishDelegate* GlobalNamespace::SaberSwingRatingCounter::DidFinishDelegate::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  return THROW_UNLESS(il2cpp_utils::New<SaberSwingRatingCounter::DidFinishDelegate*>(object, method));
}
...
System::IAsyncResult* GlobalNamespace::SaberSwingRatingCounter::DidFinishDelegate::BeginInvoke(GlobalNamespace::SaberSwingRatingCounter* afterCutRating, System::AsyncCallback* callback, ::Il2CppObject* object) {
