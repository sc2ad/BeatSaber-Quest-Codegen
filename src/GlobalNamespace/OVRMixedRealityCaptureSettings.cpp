...
void GlobalNamespace::OVRMixedRealityCaptureSettings::ReadFrom(GlobalNamespace::OVRManager* manager) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ReadFrom", {}, ::il2cpp_utils::ExtractTypes(manager)));
...
void GlobalNamespace::OVRMixedRealityCaptureSettings::ApplyTo(GlobalNamespace::OVRManager* manager) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "ApplyTo", {}, ::il2cpp_utils::ExtractTypes(manager)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, manager);
}
...
GlobalNamespace::OVRMixedRealityCaptureSettings* GlobalNamespace::OVRMixedRealityCaptureSettings::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<OVRMixedRealityCaptureSettings*>());
}
