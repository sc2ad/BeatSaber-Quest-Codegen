...
GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode::_get_Standard() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDeviceDepthSensingMode").WithContext("_get_Standard");
...
void GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode::_set_Standard(GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDeviceDepthSensingMode").WithContext("_set_Standard");
...
GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode::_get_Fill() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDeviceDepthSensingMode").WithContext("_get_Fill");
...
void GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode::_set_Fill(GlobalNamespace::OVRPlugin::CameraDeviceDepthSensingMode value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDeviceDepthSensingMode").WithContext("_set_Fill");
