...
GlobalNamespace::FormattedFloatListSettingsValueController* GlobalNamespace::FormattedFloatListSettingsValueController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("FormattedFloatListSettingsValueController").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<FormattedFloatListSettingsValueController*>());
}
