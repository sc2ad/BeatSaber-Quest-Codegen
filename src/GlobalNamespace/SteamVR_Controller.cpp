...
GlobalNamespace::SteamVR_Controller::Device* GlobalNamespace::SteamVR_Controller::Input(int deviceIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_Controller", il2cpp_utils::NoArgClass<GlobalNamespace::SteamVR_Controller::Device*>(), "Input", {}, ::il2cpp_utils::ExtractTypes(deviceIndex)));
...
void GlobalNamespace::SteamVR_Controller::Update() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_Controller", il2cpp_utils::NoArgClass<void>(), "Update", {}, ::il2cpp_utils::ExtractTypes()));
...
int GlobalNamespace::SteamVR_Controller::GetDeviceIndex(GlobalNamespace::SteamVR_Controller::DeviceRelation relation, Valve::VR::ETrackedDeviceClass deviceClass, int relativeTo) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "SteamVR_Controller", il2cpp_utils::NoArgClass<int>(), "GetDeviceIndex", {}, ::il2cpp_utils::ExtractTypes(relation, deviceClass, relativeTo)));
