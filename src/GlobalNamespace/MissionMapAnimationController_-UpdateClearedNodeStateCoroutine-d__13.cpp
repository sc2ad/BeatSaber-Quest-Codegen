...
// Completed includes
// Autogenerated method: MissionMapAnimationController/<UpdateClearedNodeStateCoroutine>d__13..ctor
GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13* GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13*>($$1__state));
}
