...
GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13* GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13::New_ctor(int $$1__state) {
  return (MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13*)THROW_UNLESS(il2cpp_utils::New("", "MissionMapAnimationController/<UpdateClearedNodeStateCoroutine>d__13", $$1__state));
}
...
::CsObject* GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13::System_Collections_IEnumerator_get_Current() {
