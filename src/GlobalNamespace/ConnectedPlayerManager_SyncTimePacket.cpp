...
GlobalNamespace::PacketPool_1<GlobalNamespace::ConnectedPlayerManager::SyncTimePacket*>* GlobalNamespace::ConnectedPlayerManager::SyncTimePacket::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ConnectedPlayerManager/SyncTimePacket", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<GlobalNamespace::ConnectedPlayerManager::SyncTimePacket*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::ConnectedPlayerManager::SyncTimePacket* GlobalNamespace::ConnectedPlayerManager::SyncTimePacket::Init(float syncTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::ConnectedPlayerManager::SyncTimePacket*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(syncTime)));
