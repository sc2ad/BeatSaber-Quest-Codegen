...
void GlobalNamespace::DiffieHellmanUtility::NoDomainReloadInit() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "NoDomainReloadInit", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
...
System::Threading::Tasks::Task_1<GlobalNamespace::IDiffieHellmanKeyPair*>* GlobalNamespace::DiffieHellmanUtility::GenerateKeysAsync(GlobalNamespace::DiffieHellmanUtility::KeyType keyType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GenerateKeysAsync", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(keyType)));
...
GlobalNamespace::IDiffieHellmanKeyPair* GlobalNamespace::DiffieHellmanUtility::GenerateKeys(GlobalNamespace::DiffieHellmanUtility::KeyType keyType) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GenerateKeys", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(keyType)));
...
GlobalNamespace::DiffieHellmanUtility::DiffieHellmanKeyPair* GlobalNamespace::DiffieHellmanUtility::GenerateDiffieHellmanKeys() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GenerateDiffieHellmanKeys", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::DiffieHellmanUtility::ElipticalCurveKeyPair* GlobalNamespace::DiffieHellmanUtility::GenerateElipticalCurveKeys() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GenerateElipticalCurveKeys", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
...
::Array<uint8_t>* GlobalNamespace::DiffieHellmanUtility::GetPreMasterSecret(Org::BouncyCastle::Crypto::Agreement::DHBasicAgreement* dhBasicAgreement, ::Array<uint8_t>* clientPublicKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GetPreMasterSecret", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(dhBasicAgreement, clientPublicKey)));
...
::Array<uint8_t>* GlobalNamespace::DiffieHellmanUtility::GetPreMasterSecret(Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement* ecdhBasicAgreement, ::Array<uint8_t>* clientPublicKey) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("DiffieHellmanUtility").WithContext("GetPreMasterSecret");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", "GetPreMasterSecret", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(ecdhBasicAgreement, clientPublicKey)));
...
void GlobalNamespace::DiffieHellmanUtility::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DiffieHellmanUtility", ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
}
