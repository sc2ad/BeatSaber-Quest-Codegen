...
void GlobalNamespace::RpcPool::NoDomainReloadInit() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "RpcPool", il2cpp_utils::NoArgClass<void>(), "NoDomainReloadInit", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::RpcPool::Release(GlobalNamespace::IRemoteProcedureCall* t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "RpcPool", il2cpp_utils::NoArgClass<void>(), "Release", {}, ::il2cpp_utils::ExtractTypes(t)));
