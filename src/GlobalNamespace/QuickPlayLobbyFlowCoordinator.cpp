...
// Autogenerated method: QuickPlayLobbyFlowCoordinator.PresentAndStartCountdown
void GlobalNamespace::QuickPlayLobbyFlowCoordinator::PresentAndStartCountdown() {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "PresentAndStartCountdown"));
}
...
// Autogenerated method: QuickPlayLobbyFlowCoordinator.<PresentBackButtonConfirmationDialog>b__53_0
void GlobalNamespace::QuickPlayLobbyFlowCoordinator::$PresentBackButtonConfirmationDialog$b__53_0(int btnIndex) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<PresentBackButtonConfirmationDialog>b__53_0", btnIndex));
}
// Autogenerated method: QuickPlayLobbyFlowCoordinator.<ShowDisconnectDialogAndFinish>b__56_0
void GlobalNamespace::QuickPlayLobbyFlowCoordinator::$ShowDisconnectDialogAndFinish$b__56_0() {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "<ShowDisconnectDialogAndFinish>b__56_0"));
}
