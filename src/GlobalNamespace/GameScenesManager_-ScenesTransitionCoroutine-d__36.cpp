...
GlobalNamespace::GameScenesManager::$ScenesTransitionCoroutine$d__36* GlobalNamespace::GameScenesManager::$ScenesTransitionCoroutine$d__36::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$ScenesTransitionCoroutine$d__36").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<GameScenesManager::$ScenesTransitionCoroutine$d__36*>($$1__state));
}
