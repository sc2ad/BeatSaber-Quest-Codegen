...
void GlobalNamespace::StretchableObstacle::SetSizeAndColor(float width, float height, float length, UnityEngine::Color color) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetSizeAndColor", {}, ::il2cpp_utils::ExtractTypes(width, height, length, color)));
...
void GlobalNamespace::StretchableObstacle::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "StretchableObstacle", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
