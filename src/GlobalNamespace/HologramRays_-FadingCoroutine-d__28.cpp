...
// Completed includes
// Autogenerated method: HologramRays/<FadingCoroutine>d__28..ctor
GlobalNamespace::HologramRays::$FadingCoroutine$d__28* GlobalNamespace::HologramRays::$FadingCoroutine$d__28::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$FadingCoroutine$d__28").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<HologramRays::$FadingCoroutine$d__28*>($$1__state));
}
