...
GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24* GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$FreeRenderModel$d__24").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_RenderModel::$FreeRenderModel$d__24*>($$1__state));
}
