...
// Completed includes
// Autogenerated method: SteamVR_RenderModel/<FreeRenderModel>d__24..ctor
GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24* GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24::New_ctor(int $$1__state) {
  return (SteamVR_RenderModel::$FreeRenderModel$d__24*)THROW_UNLESS(il2cpp_utils::New("", "SteamVR_RenderModel/<FreeRenderModel>d__24", $$1__state));
}
...
::CsObject* GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::SteamVR_RenderModel::$FreeRenderModel$d__24::System_Collections_IEnumerator_get_Current() {
