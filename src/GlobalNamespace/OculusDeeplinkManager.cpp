...
void GlobalNamespace::OculusDeeplinkManager::SetLaunchIntentChangedNotificationCallback(Oculus::Platform::Message_1<::CsString*>* message) {
...
void GlobalNamespace::OculusDeeplinkManager::UpdateDeeplinkMessage(::CsString* deeplinkMessage) {
...
void GlobalNamespace::OculusDeeplinkManager::Log(::CsString* message) {
