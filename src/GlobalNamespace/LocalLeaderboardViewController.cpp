...
void GlobalNamespace::LocalLeaderboardViewController::SetContent(::CsString* leaderboardID, GlobalNamespace::LocalLeaderboardsModel::LeaderboardType leaderboardType) {
...
void GlobalNamespace::LocalLeaderboardViewController::HandleNewScoreWasAddedToLeaderboard(::CsString* leaderboardID, GlobalNamespace::LocalLeaderboardsModel::LeaderboardType leaderboardType) {
...
void GlobalNamespace::LocalLeaderboardViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
void GlobalNamespace::LocalLeaderboardViewController::DidDeactivate(HMUI::ViewController::DeactivationType deactivationType) {
...
GlobalNamespace::LocalLeaderboardViewController* GlobalNamespace::LocalLeaderboardViewController::New_ctor() {
  return (LocalLeaderboardViewController*)THROW_UNLESS(il2cpp_utils::New("", "LocalLeaderboardViewController"));
}
