...
// Autogenerated method: NoteCutSoundEffect.get_noteData
GlobalNamespace::NoteData* GlobalNamespace::NoteCutSoundEffect::get_noteData() {
...
void GlobalNamespace::NoteCutSoundEffect::Init(UnityEngine::AudioClip* audioClip, double noteDSPTime, float aheadTime, float missedTimeOffset, float timeToPrevNote, float timeToNextNote, GlobalNamespace::Saber* saber, GlobalNamespace::NoteData* noteData, bool handleWrongSaberTypeAsGood, float volumeMultiplier, bool ignoreSaberSpeed, bool ignoreBadCuts) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "Init", audioClip, noteDSPTime, aheadTime, missedTimeOffset, timeToPrevNote, timeToNextNote, saber, noteData, handleWrongSaberTypeAsGood, volumeMultiplier, ignoreSaberSpeed, ignoreBadCuts));
}
...
void GlobalNamespace::NoteCutSoundEffect::NoteWasCut(GlobalNamespace::INoteController* noteController, GlobalNamespace::NoteCutInfo* noteCutInfo) {
...
GlobalNamespace::NoteCutSoundEffect* GlobalNamespace::NoteCutSoundEffect::New_ctor() {
  return (NoteCutSoundEffect*)THROW_UNLESS(il2cpp_utils::New("", "NoteCutSoundEffect"));
}
