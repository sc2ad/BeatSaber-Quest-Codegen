...
int GlobalNamespace::BTSCharacterSpawnEventValueParser::GetPrefabId(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSCharacterSpawnEventValueParser", il2cpp_utils::NoArgClass<int>(), "GetPrefabId", {}, ::il2cpp_utils::ExtractTypes(value)));
...
int GlobalNamespace::BTSCharacterSpawnEventValueParser::GetAnimationId(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSCharacterSpawnEventValueParser", il2cpp_utils::NoArgClass<int>(), "GetAnimationId", {}, ::il2cpp_utils::ExtractTypes(value)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, value);
}
...
bool GlobalNamespace::BTSCharacterSpawnEventValueParser::GetIsAlternativeMaterial(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSCharacterSpawnEventValueParser", il2cpp_utils::NoArgClass<bool>(), "GetIsAlternativeMaterial", {}, ::il2cpp_utils::ExtractTypes(value)));
...
int GlobalNamespace::BTSCharacterSpawnEventValueParser::MergeValuesIntoOneInt(int prefabId, int animationId, bool isAlternativeMaterial) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BTSCharacterSpawnEventValueParser", il2cpp_utils::NoArgClass<int>(), "MergeValuesIntoOneInt", {}, ::il2cpp_utils::ExtractTypes(prefabId, animationId, isAlternativeMaterial)));
