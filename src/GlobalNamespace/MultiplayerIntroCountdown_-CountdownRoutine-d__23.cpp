...
// Completed includes
// Autogenerated method: MultiplayerIntroCountdown/<CountdownRoutine>d__23..ctor
GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23* GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<MultiplayerIntroCountdown::$CountdownRoutine$d__23*>($$1__state));
}
...
void GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$CountdownRoutine$d__23").WithContext("System.IDisposable.Dispose");
...
bool GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$CountdownRoutine$d__23").WithContext("MoveNext");
...
bool GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::System_Collections_IEnumerator_MoveNext() {
  return GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::MoveNext();
}
...
::Il2CppObject* GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$CountdownRoutine$d__23").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$CountdownRoutine$d__23").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__23::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$CountdownRoutine$d__23").WithContext("System.Collections.IEnumerator.get_Current");
