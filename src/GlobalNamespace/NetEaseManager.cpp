...
::CsString* GlobalNamespace::NetEaseManager::get_userName() {
...
System::Threading::Tasks::Task_1<NetEase::Docker::ReceivedHighscoreData>* GlobalNamespace::NetEaseManager::RequestHighscoreDataAsync(::CsString* leaderboardId) {
...
void GlobalNamespace::NetEaseManager::UploadHighscore(::CsString* leaderboardId, int score) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "UploadHighscore", leaderboardId, score));
}
// Autogenerated method: NetEaseManager.Log
void GlobalNamespace::NetEaseManager::Log(::CsString* message) {
