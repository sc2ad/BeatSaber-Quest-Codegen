...
GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24* GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24::New_ctor(int $$1__state) {
  return (OVRSceneLoader::$DelayCanvasPosUpdate$d__24*)THROW_UNLESS(il2cpp_utils::New("", "OVRSceneLoader/<DelayCanvasPosUpdate>d__24", $$1__state));
}
...
::CsObject* GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24::System_Collections_IEnumerator_get_Current() {
