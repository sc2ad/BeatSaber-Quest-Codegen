...
// Completed includes
// Autogenerated method: OVRSceneLoader/<DelayCanvasPosUpdate>d__24..ctor
GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24* GlobalNamespace::OVRSceneLoader::$DelayCanvasPosUpdate$d__24::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<OVRSceneLoader::$DelayCanvasPosUpdate$d__24*>($$1__state));
}
