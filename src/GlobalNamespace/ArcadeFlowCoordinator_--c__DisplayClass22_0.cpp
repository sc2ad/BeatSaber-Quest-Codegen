...
// Autogenerated method: ArcadeFlowCoordinator/<>c__DisplayClass22_0..ctor
GlobalNamespace::ArcadeFlowCoordinator::$$c__DisplayClass22_0* GlobalNamespace::ArcadeFlowCoordinator::$$c__DisplayClass22_0::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<ArcadeFlowCoordinator::$$c__DisplayClass22_0*>());
}
