...
// Completed includes
// Autogenerated method: ResultsViewController/<StartFireworksAfterDelay>d__31..ctor
GlobalNamespace::ResultsViewController::$StartFireworksAfterDelay$d__31* GlobalNamespace::ResultsViewController::$StartFireworksAfterDelay$d__31::New_ctor(int $$1__state) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ResultsViewController::$StartFireworksAfterDelay$d__31*>($$1__state));
}
