...
GlobalNamespace::StateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState_NodePose, GlobalNamespace::PoseSerializable>* GlobalNamespace::MockLocalMultiplayerPoseSyncState::get_stateBuffer() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::StateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState_NodePose, GlobalNamespace::PoseSerializable>*>(), "get_stateBuffer", {}, ::il2cpp_utils::ExtractTypes())));
...
GlobalNamespace::PoseSerializable GlobalNamespace::MockLocalMultiplayerPoseSyncState::GetState(GlobalNamespace::NodePoseSyncState_NodePose type, float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::PoseSerializable>(), "GetState", {}, ::il2cpp_utils::ExtractTypes(type, time)));
