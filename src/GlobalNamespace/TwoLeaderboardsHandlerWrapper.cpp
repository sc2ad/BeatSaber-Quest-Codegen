...
GlobalNamespace::TwoLeaderboardsHandlerWrapper* GlobalNamespace::TwoLeaderboardsHandlerWrapper::New_ctor(GlobalNamespace::PlatformLeaderboardsHandler* mainHandler, GlobalNamespace::PlatformLeaderboardsHandler* shadowHandler) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("TwoLeaderboardsHandlerWrapper").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TwoLeaderboardsHandlerWrapper*>(mainHandler, shadowHandler));
}
...
void GlobalNamespace::TwoLeaderboardsHandlerWrapper::$GetScores$b__5_0(GlobalNamespace::PlatformLeaderboardsModel::GetScoresResult result, ::Array<GlobalNamespace::PlatformLeaderboardsModel::LeaderboardScore*>* scores, int referencePlayerScoreIndex) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "<GetScores>b__5_0", {}, ::il2cpp_utils::ExtractTypes(result, scores, referencePlayerScoreIndex))));
...
void GlobalNamespace::TwoLeaderboardsHandlerWrapper::$UploadScore$b__6_0(GlobalNamespace::PlatformLeaderboardsModel::UploadScoreResult result) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "<UploadScore>b__6_0", {}, ::il2cpp_utils::ExtractTypes(result))));
