...
// Autogenerated method: MultiplayerConnectedPlayerGameNoteController..ctor
GlobalNamespace::MultiplayerConnectedPlayerGameNoteController* GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::New_ctor() {
  return THROW_UNLESS(il2cpp_utils::New<MultiplayerConnectedPlayerGameNoteController*>());
}
