...
void GlobalNamespace::PlayerDataFileManagerSO::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "PlayerDataFileManagerSO/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::PlayerDataFileManagerSO::$$c::$LoadCorrectedSongPackMask$b__19_0(GlobalNamespace::IBeatmapLevelPack* pack) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<LoadCorrectedSongPackMask>b__19_0", {}, ::il2cpp_utils::ExtractTypes(pack))));
