...
GlobalNamespace::StandardLevelFailedController* GlobalNamespace::StandardLevelFailedController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("StandardLevelFailedController").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<StandardLevelFailedController*>());
}
