...
void GlobalNamespace::TestPlatformAdditionalContentModel::BuyLevel(::Il2CppString* levelId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "BuyLevel", {}, ::il2cpp_utils::ExtractTypes(levelId)));
...
GlobalNamespace::TestPlatformAdditionalContentModel* GlobalNamespace::TestPlatformAdditionalContentModel::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<TestPlatformAdditionalContentModel*>());
}
