...
void GlobalNamespace::EnergyMissionObjectiveChecker::HandleEnergyDidChange(float energy) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleEnergyDidChange", {}, ::il2cpp_utils::ExtractTypes(energy)));
...
GlobalNamespace::EnergyMissionObjectiveChecker* GlobalNamespace::EnergyMissionObjectiveChecker::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("EnergyMissionObjectiveChecker").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<EnergyMissionObjectiveChecker*>());
}
