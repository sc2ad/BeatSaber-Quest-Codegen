...
GlobalNamespace::VRControllersRecorderData* GlobalNamespace::VRControllersRecorderData::New_ctor(::Array<GlobalNamespace::VRControllersRecorderData::NodeInfo*>* nodesInfo) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<VRControllersRecorderData*>(nodesInfo));
}
...
void GlobalNamespace::VRControllersRecorderData::AddKeyFrame(::Array<GlobalNamespace::VRControllersRecorderData::PositionAndRotation>* positionsAndRotations, float time) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "AddKeyFrame", {}, ::il2cpp_utils::ExtractTypes(positionsAndRotations, time)));
...
GlobalNamespace::VRControllersRecorderData::PositionAndRotation GlobalNamespace::VRControllersRecorderData::GetPositionAndRotation(int frameIdx, UnityEngine::XR::XRNode nodeType, int nodeIdx) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::VRControllersRecorderData::PositionAndRotation>(), "GetPositionAndRotation", {}, ::il2cpp_utils::ExtractTypes(frameIdx, nodeType, nodeIdx)));
...
GlobalNamespace::VRControllersRecorderData::PositionAndRotation GlobalNamespace::VRControllersRecorderData::GetLerpedPositionAndRotation(int frameIdx, float t, UnityEngine::XR::XRNode nodeType, int nodeIdx) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::VRControllersRecorderData::PositionAndRotation>(), "GetLerpedPositionAndRotation", {}, ::il2cpp_utils::ExtractTypes(frameIdx, t, nodeType, nodeIdx)));
...
float GlobalNamespace::VRControllersRecorderData::GetFrameTime(int frameIdx) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "GetFrameTime", {}, ::il2cpp_utils::ExtractTypes(frameIdx)));
...
int GlobalNamespace::VRControllersRecorderData::get_numberOfKeyframes() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "get_numberOfKeyframes", {}, ::il2cpp_utils::ExtractTypes()));
