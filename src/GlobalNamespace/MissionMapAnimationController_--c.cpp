...
void GlobalNamespace::MissionMapAnimationController::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "MissionMapAnimationController/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
float GlobalNamespace::MissionMapAnimationController::$$c::$UpdateNodesAndConnectionCoroutine$b__15_0(GlobalNamespace::MissionNodeConnection* connection) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "<UpdateNodesAndConnectionCoroutine>b__15_0", {}, ::il2cpp_utils::ExtractTypes(connection))));
...
float GlobalNamespace::MissionMapAnimationController::$$c::$UpdateNodesAndConnectionCoroutine$b__15_1(GlobalNamespace::MissionNodeConnection* connection) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<float>(), "<UpdateNodesAndConnectionCoroutine>b__15_1", {}, ::il2cpp_utils::ExtractTypes(connection))));
  return ::il2cpp_utils::RunMethodThrow<float, false>(this, ___internal__method, connection);
}
