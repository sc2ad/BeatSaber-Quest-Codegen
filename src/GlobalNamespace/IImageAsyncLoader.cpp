...
System::Threading::Tasks::Task_1<UnityEngine::Texture2D*>* GlobalNamespace::IImageAsyncLoader::LoadImageAsync(::Il2CppString* path, System::Threading::CancellationToken cancellationToken) {
