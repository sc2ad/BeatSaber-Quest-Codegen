...
void GlobalNamespace::PerlinNoise::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
float GlobalNamespace::PerlinNoise::OctavePerlin3D(float x, float y, float z, int octaves, float persistence, int repeat) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<float>(), "OctavePerlin3D", {}, ::il2cpp_utils::ExtractTypes(x, y, z, octaves, persistence, repeat)));
...
float GlobalNamespace::PerlinNoise::Perlin3D(float x, float y, float z, int repeat) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<float>(), "Perlin3D", {}, ::il2cpp_utils::ExtractTypes(x, y, z, repeat)));
...
int GlobalNamespace::PerlinNoise::Inc(int num, int repeat) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<int>(), "Inc", {}, ::il2cpp_utils::ExtractTypes(num, repeat)));
...
float GlobalNamespace::PerlinNoise::Grad3D(int hash, float x, float y, float z) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<float>(), "Grad3D", {}, ::il2cpp_utils::ExtractTypes(hash, x, y, z)));
...
float GlobalNamespace::PerlinNoise::Fade(float t) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<float>(), "Fade", {}, ::il2cpp_utils::ExtractTypes(t)));
...
float GlobalNamespace::PerlinNoise::Lerp(float a, float b, float x) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "PerlinNoise", il2cpp_utils::NoArgClass<float>(), "Lerp", {}, ::il2cpp_utils::ExtractTypes(a, b, x)));
