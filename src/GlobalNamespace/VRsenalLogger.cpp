...
void GlobalNamespace::VRsenalLogger::HandlePlayerNameWasEntered(::Il2CppString* playerName) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandlePlayerNameWasEntered", {}, ::il2cpp_utils::ExtractTypes(playerName)));
...
GlobalNamespace::VRsenalLogger* GlobalNamespace::VRsenalLogger::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<VRsenalLogger*>());
}
