...
GlobalNamespace::BadCutsMissionObjectiveChecker* GlobalNamespace::BadCutsMissionObjectiveChecker::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BadCutsMissionObjectiveChecker").WithContext(".ctor");
