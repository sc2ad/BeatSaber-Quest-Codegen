...
GlobalNamespace::OVRPlugin::Posef GlobalNamespace::OVRPlugin::OVRP_0_1_3::ovrp_GetNodeVelocity(GlobalNamespace::OVRPlugin::Node nodeId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_0_1_3", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Posef>(), "ovrp_GetNodeVelocity", {}, ::il2cpp_utils::ExtractTypes(nodeId)));
...
GlobalNamespace::OVRPlugin::Posef GlobalNamespace::OVRPlugin::OVRP_0_1_3::ovrp_GetNodeAcceleration(GlobalNamespace::OVRPlugin::Node nodeId) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_0_1_3", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Posef>(), "ovrp_GetNodeAcceleration", {}, ::il2cpp_utils::ExtractTypes(nodeId)));
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::OVRPlugin::Posef, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, nodeId);
}
...
void GlobalNamespace::OVRPlugin::OVRP_0_1_3::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_0_1_3", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
