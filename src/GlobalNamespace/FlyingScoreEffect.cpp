...
void GlobalNamespace::FlyingScoreEffect::InitAndPresent(GlobalNamespace::NoteCutInfo* noteCutInfo, int multiplier, float duration, UnityEngine::Vector3 targetPos, UnityEngine::Quaternion rotation, UnityEngine::Color color) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "InitAndPresent", {}, ::il2cpp_utils::ExtractTypes(noteCutInfo, multiplier, duration, targetPos, rotation, color)));
...
void GlobalNamespace::FlyingScoreEffect::HandleSaberSwingRatingCounterDidChangeEvent(GlobalNamespace::ISaberSwingRatingCounter* saberSwingRatingCounter, float rating) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleSaberSwingRatingCounterDidChangeEvent", {}, ::il2cpp_utils::ExtractTypes(saberSwingRatingCounter, rating)));
...
::Il2CppString* GlobalNamespace::FlyingScoreEffect::GetScoreText(int score) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetScoreText", {}, ::il2cpp_utils::ExtractTypes(score)));
...
GlobalNamespace::FlyingScoreEffect* GlobalNamespace::FlyingScoreEffect::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<FlyingScoreEffect*>());
}
