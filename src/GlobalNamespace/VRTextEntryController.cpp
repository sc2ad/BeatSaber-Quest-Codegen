...
void GlobalNamespace::VRTextEntryController::add_textDidChangeEvent(System::Action_1<::CsString*>* value) {
...
void GlobalNamespace::VRTextEntryController::remove_textDidChangeEvent(System::Action_1<::CsString*>* value) {
...
::CsString* GlobalNamespace::VRTextEntryController::get_text() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_text"));
}
// Autogenerated method: VRTextEntryController.set_text
void GlobalNamespace::VRTextEntryController::set_text(::CsString* value) {
