...
int GlobalNamespace::ScoreModel::MaxRawScoreForNumberOfNotes(int noteCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ScoreModel", il2cpp_utils::NoArgClass<int>(), "MaxRawScoreForNumberOfNotes", {}, ::il2cpp_utils::ExtractTypes(noteCount)));
...
void GlobalNamespace::ScoreModel::RawScoreWithoutMultiplier(GlobalNamespace::NoteCutInfo* noteCutInfo, int& beforeCutRawScore, int& afterCutRawScore, int& cutDistanceRawScore) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ScoreModel", il2cpp_utils::NoArgClass<void>(), "RawScoreWithoutMultiplier", {}, ::il2cpp_utils::ExtractTypes(noteCutInfo, beforeCutRawScore, afterCutRawScore, cutDistanceRawScore)));
...
int GlobalNamespace::ScoreModel::GetModifiedScoreForGameplayModifiersScoreMultiplier(int rawScore, float gameplayModifiersScoreMultiplier) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "ScoreModel", il2cpp_utils::NoArgClass<int>(), "GetModifiedScoreForGameplayModifiersScoreMultiplier", {}, ::il2cpp_utils::ExtractTypes(rawScore, gameplayModifiersScoreMultiplier)));
...
GlobalNamespace::ScoreModel* GlobalNamespace::ScoreModel::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ScoreModel*>());
}
