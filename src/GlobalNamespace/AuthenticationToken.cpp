...
GlobalNamespace::AuthenticationToken GlobalNamespace::AuthenticationToken::Deserialize(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "AuthenticationToken", "Deserialize", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(reader)));
