...
GlobalNamespace::OVRPlugin::Bool GlobalNamespace::OVRPlugin::OVRP_1_7_0::ovrp_GetAppChromaticCorrection() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_7_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Bool>(), "ovrp_GetAppChromaticCorrection", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::OVRPlugin::Bool GlobalNamespace::OVRPlugin::OVRP_1_7_0::ovrp_SetAppChromaticCorrection(GlobalNamespace::OVRPlugin::Bool value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_7_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Bool>(), "ovrp_SetAppChromaticCorrection", {}, ::il2cpp_utils::ExtractTypes(value)));
...
void GlobalNamespace::OVRPlugin::OVRP_1_7_0::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_7_0", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
