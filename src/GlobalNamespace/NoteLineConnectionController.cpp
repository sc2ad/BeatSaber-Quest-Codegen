...
void GlobalNamespace::NoteLineConnectionController::Setup(GlobalNamespace::NoteController* noteController0, GlobalNamespace::NoteController* noteController1, float fadeOutStartDistance, float fadeOutEndDistance, float noteTime) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Setup", {}, ::il2cpp_utils::ExtractTypes(noteController0, noteController1, fadeOutStartDistance, fadeOutEndDistance, noteTime)));
...
void GlobalNamespace::NoteLineConnectionController::UpdatePositionsAndColors() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "UpdatePositionsAndColors", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
GlobalNamespace::NoteLineConnectionController* GlobalNamespace::NoteLineConnectionController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("NoteLineConnectionController").WithContext(".ctor");
