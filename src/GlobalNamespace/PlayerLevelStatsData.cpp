...
::CsString* GlobalNamespace::PlayerLevelStatsData::get_levelID() {
...
GlobalNamespace::PlayerLevelStatsData* GlobalNamespace::PlayerLevelStatsData::New_ctor(::CsString* levelID, GlobalNamespace::BeatmapDifficulty difficulty, GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic) {
  return (PlayerLevelStatsData*)THROW_UNLESS(il2cpp_utils::New("", "PlayerLevelStatsData", levelID, difficulty, beatmapCharacteristic));
}
// Autogenerated method: PlayerLevelStatsData..ctor
GlobalNamespace::PlayerLevelStatsData* GlobalNamespace::PlayerLevelStatsData::New_ctor(::CsString* levelID, GlobalNamespace::BeatmapDifficulty difficulty, GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic, int highScore, int maxCombo, bool fullCombo, GlobalNamespace::RankModel::Rank maxRank, bool validScore, int playCount) {
