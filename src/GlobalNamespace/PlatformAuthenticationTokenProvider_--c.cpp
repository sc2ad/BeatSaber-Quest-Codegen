...
void GlobalNamespace::PlatformAuthenticationTokenProvider::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "PlatformAuthenticationTokenProvider/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
uint8_t GlobalNamespace::PlatformAuthenticationTokenProvider::$$c::$GetAuthenticationToken$b__8_0(::Il2CppString* s) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<uint8_t>(), "<GetAuthenticationToken>b__8_0", {}, ::il2cpp_utils::ExtractTypes(s))));
