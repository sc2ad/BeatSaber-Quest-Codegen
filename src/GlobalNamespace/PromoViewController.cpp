...
void GlobalNamespace::PromoViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
GlobalNamespace::PromoViewController* GlobalNamespace::PromoViewController::New_ctor() {
  return (PromoViewController*)THROW_UNLESS(il2cpp_utils::New("", "PromoViewController"));
}
