...
GlobalNamespace::PlatformLeaderboardsModel::UploadScoreCompletionHandler* GlobalNamespace::PlatformLeaderboardsModel::UploadScoreCompletionHandler::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("UploadScoreCompletionHandler").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlatformLeaderboardsModel::UploadScoreCompletionHandler*>(object, method));
}
