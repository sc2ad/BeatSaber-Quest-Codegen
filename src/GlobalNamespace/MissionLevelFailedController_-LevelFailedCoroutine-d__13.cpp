...
// Completed includes
// Autogenerated method: MissionLevelFailedController/<LevelFailedCoroutine>d__13..ctor
GlobalNamespace::MissionLevelFailedController::$LevelFailedCoroutine$d__13* GlobalNamespace::MissionLevelFailedController::$LevelFailedCoroutine$d__13::New_ctor(int $$1__state) {
  return (MissionLevelFailedController::$LevelFailedCoroutine$d__13*)THROW_UNLESS(il2cpp_utils::New("", "MissionLevelFailedController/<LevelFailedCoroutine>d__13", $$1__state));
}
...
::CsObject* GlobalNamespace::MissionLevelFailedController::$LevelFailedCoroutine$d__13::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::MissionLevelFailedController::$LevelFailedCoroutine$d__13::System_Collections_IEnumerator_get_Current() {
