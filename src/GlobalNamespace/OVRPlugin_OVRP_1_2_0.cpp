...
GlobalNamespace::OVRPlugin::Bool GlobalNamespace::OVRPlugin::OVRP_1_2_0::ovrp_SetSystemVSyncCount(int vsyncCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_2_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Bool>(), "ovrp_SetSystemVSyncCount", {}, ::il2cpp_utils::ExtractTypes(vsyncCount)));
...
GlobalNamespace::OVRPlugin::Bool GlobalNamespace::OVRPlugin::OVRP_1_2_0::ovrpi_SetTrackingCalibratedOrigin() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_2_0", il2cpp_utils::NoArgClass<GlobalNamespace::OVRPlugin::Bool>(), "ovrpi_SetTrackingCalibratedOrigin", {}, ::il2cpp_utils::ExtractTypes()));
...
void GlobalNamespace::OVRPlugin::OVRP_1_2_0::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "OVRPlugin/OVRP_1_2_0", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
