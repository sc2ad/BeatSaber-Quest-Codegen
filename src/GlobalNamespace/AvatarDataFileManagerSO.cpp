...
void GlobalNamespace::AvatarDataFileManagerSO::Save(GlobalNamespace::AvatarData* avatarData) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Save", {}, ::il2cpp_utils::ExtractTypes(avatarData)));
...
GlobalNamespace::AvatarData* GlobalNamespace::AvatarDataFileManagerSO::Load() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::AvatarData*>(), "Load", {}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::AvatarData* GlobalNamespace::AvatarDataFileManagerSO::LoadFromCurrentVersion(GlobalNamespace::AvatarSaveData* avatarSaveData) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::AvatarData*>(), "LoadFromCurrentVersion", {}, ::il2cpp_utils::ExtractTypes(avatarSaveData)));
