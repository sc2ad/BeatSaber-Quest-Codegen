...
void GlobalNamespace::EnvironmentOverrideSettingsPanelController::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "EnvironmentOverrideSettingsPanelController/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::EnvironmentOverrideSettingsPanelController::$$c::$SetData$b__11_0(GlobalNamespace::EnvironmentInfoSO* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<SetData>b__11_0", {}, ::il2cpp_utils::ExtractTypes(x))));
