...
// Autogenerated method: IBeatmapObjectSpawner.SpawnNoteRibbon
GlobalNamespace::NoteRibbonController* GlobalNamespace::IBeatmapObjectSpawner::SpawnNoteRibbon(GlobalNamespace::NoteData* noteData, GlobalNamespace::BeatmapObjectSpawnMovementData::NoteSpawnData noteSpawnData, GlobalNamespace::NoteController* parentNoteController, float rotation, float cutDirectionAngleOffset) {
