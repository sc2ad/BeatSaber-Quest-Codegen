...
void GlobalNamespace::LobbyPlayersDataModel::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "LobbyPlayersDataModel/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::LobbyPlayersDataModel::$$c::$SetOwnedSongPacks$b__42_0(GlobalNamespace::IBeatmapLevelPack* pack) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<SetOwnedSongPacks>b__42_0", {}, ::il2cpp_utils::ExtractTypes(pack))));
