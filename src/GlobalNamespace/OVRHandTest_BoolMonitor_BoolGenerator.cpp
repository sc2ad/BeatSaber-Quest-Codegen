...
GlobalNamespace::OVRHandTest::BoolMonitor::BoolGenerator* GlobalNamespace::OVRHandTest::BoolMonitor::BoolGenerator::New_ctor(::CsObject* object, System::IntPtr method) {
  return (OVRHandTest::BoolMonitor::BoolGenerator*)THROW_UNLESS(il2cpp_utils::New("", "OVRHandTest/BoolMonitor/BoolGenerator", object, method));
}
...
System::IAsyncResult* GlobalNamespace::OVRHandTest::BoolMonitor::BoolGenerator::BeginInvoke(System::AsyncCallback* callback, ::CsObject* object) {
