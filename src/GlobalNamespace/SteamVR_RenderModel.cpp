...
::CsString* GlobalNamespace::SteamVR_RenderModel::_get_modelOverrideWarning() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "SteamVR_RenderModel", "modelOverrideWarning"));
}
// Autogenerated static field setter
// Set static field: static public System.String modelOverrideWarning
void GlobalNamespace::SteamVR_RenderModel::_set_modelOverrideWarning(::CsString* value) {
...
::CsString* GlobalNamespace::SteamVR_RenderModel::_get_k_localTransformName() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "SteamVR_RenderModel", "k_localTransformName"));
}
// Autogenerated static field setter
// Set static field: static public System.String k_localTransformName
void GlobalNamespace::SteamVR_RenderModel::_set_k_localTransformName(::CsString* value) {
...
::CsString* GlobalNamespace::SteamVR_RenderModel::get_renderModelName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_renderModelName"));
}
// Autogenerated method: SteamVR_RenderModel.set_renderModelName
void GlobalNamespace::SteamVR_RenderModel::set_renderModelName(::CsString* value) {
...
System::Collections::IEnumerator* GlobalNamespace::SteamVR_RenderModel::SetModelAsync(::CsString* renderModelName) {
...
bool GlobalNamespace::SteamVR_RenderModel::SetModel(::CsString* renderModelName) {
...
GlobalNamespace::SteamVR_RenderModel::RenderModel* GlobalNamespace::SteamVR_RenderModel::LoadRenderModel(Valve::VR::CVRRenderModels* renderModels, ::CsString* renderModelName, ::CsString* baseName) {
...
UnityEngine::Transform* GlobalNamespace::SteamVR_RenderModel::FindComponent(::CsString* componentName) {
...
bool GlobalNamespace::SteamVR_RenderModel::LoadComponents(GlobalNamespace::SteamVR_RenderModel::RenderModelInterfaceHolder* holder, ::CsString* renderModelName) {
