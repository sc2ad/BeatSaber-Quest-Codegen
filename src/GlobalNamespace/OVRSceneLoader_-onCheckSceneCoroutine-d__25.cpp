...
GlobalNamespace::OVRSceneLoader::$onCheckSceneCoroutine$d__25* GlobalNamespace::OVRSceneLoader::$onCheckSceneCoroutine$d__25::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$onCheckSceneCoroutine$d__25").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OVRSceneLoader::$onCheckSceneCoroutine$d__25*>($$1__state));
}
