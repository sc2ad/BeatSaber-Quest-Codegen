...
::CsString* GlobalNamespace::SimpleFileLogger::_get_kFilename() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "SimpleFileLogger", "kFilename"));
}
// Autogenerated static field setter
// Set static field: static private System.String kFilename
void GlobalNamespace::SimpleFileLogger::_set_kFilename(::CsString* value) {
...
void GlobalNamespace::SimpleFileLogger::Log(::CsString* text) {
  THROW_UNLESS(il2cpp_utils::RunMethod("", "SimpleFileLogger", "Log", text));
}
// Autogenerated method: SimpleFileLogger.LogVector
void GlobalNamespace::SimpleFileLogger::LogVector(::CsString* description, UnityEngine::Vector3 vec) {
