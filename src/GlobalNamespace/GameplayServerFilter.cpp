...
GlobalNamespace::GameplayServerFilter GlobalNamespace::GameplayServerFilter::get_defaultFilter() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayServerFilter", "get_defaultFilter", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
...
GlobalNamespace::GameplayServerFilter GlobalNamespace::GameplayServerFilter::Deserialize(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayServerFilter", "Deserialize", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(reader)));
...
bool GlobalNamespace::GameplayServerFilter::IncludesServerName(::Il2CppString* lowerInvariantName) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "IncludesServerName", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(lowerInvariantName)));
...
bool GlobalNamespace::GameplayServerFilter::IncludesPassword(::Il2CppString* password) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "IncludesPassword", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(password)));
...
bool GlobalNamespace::GameplayServerFilter::IncludesPlayerCount(int currentPlayerCount, int maxPlayerCount) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "IncludesPlayerCount", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(currentPlayerCount, maxPlayerCount)));
...
bool GlobalNamespace::GameplayServerFilter::IncludesConfiguration(GlobalNamespace::GameplayServerConfiguration configuration) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "IncludesConfiguration", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(configuration)));
