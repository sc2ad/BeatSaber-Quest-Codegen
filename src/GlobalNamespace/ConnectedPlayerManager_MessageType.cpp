...
GlobalNamespace::ConnectedPlayerManager::MessageType GlobalNamespace::ConnectedPlayerManager::MessageType::_get_Party() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MessageType").WithContext("_get_Party");
...
void GlobalNamespace::ConnectedPlayerManager::MessageType::_set_Party(GlobalNamespace::ConnectedPlayerManager::MessageType value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MessageType").WithContext("_set_Party");
...
GlobalNamespace::ConnectedPlayerManager::MessageType GlobalNamespace::ConnectedPlayerManager::MessageType::_get_MultiplayerSession() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MessageType").WithContext("_get_MultiplayerSession");
...
void GlobalNamespace::ConnectedPlayerManager::MessageType::_set_MultiplayerSession(GlobalNamespace::ConnectedPlayerManager::MessageType value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MessageType").WithContext("_set_MultiplayerSession");
