...
void GlobalNamespace::NetEaseManager::$LogoutAsync$d__15::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$LogoutAsync$d__15").WithContext("MoveNext");
...
void GlobalNamespace::NetEaseManager::$LogoutAsync$d__15::SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$LogoutAsync$d__15").WithContext("SetStateMachine");
