...
void GlobalNamespace::HandsMovementMissionObjectiveChecker::HandleTotalDistanceDidChange(float distance) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleTotalDistanceDidChange", {}, ::il2cpp_utils::ExtractTypes(distance)));
...
GlobalNamespace::HandsMovementMissionObjectiveChecker* GlobalNamespace::HandsMovementMissionObjectiveChecker::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<HandsMovementMissionObjectiveChecker*>());
}
