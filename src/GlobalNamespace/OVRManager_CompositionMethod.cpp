...
GlobalNamespace::OVRManager::CompositionMethod GlobalNamespace::OVRManager::CompositionMethod::_get_External() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CompositionMethod").WithContext("_get_External");
...
void GlobalNamespace::OVRManager::CompositionMethod::_set_External(GlobalNamespace::OVRManager::CompositionMethod value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CompositionMethod").WithContext("_set_External");
...
GlobalNamespace::OVRManager::CompositionMethod GlobalNamespace::OVRManager::CompositionMethod::_get_Direct() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CompositionMethod").WithContext("_get_Direct");
...
void GlobalNamespace::OVRManager::CompositionMethod::_set_Direct(GlobalNamespace::OVRManager::CompositionMethod value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CompositionMethod").WithContext("_set_Direct");
