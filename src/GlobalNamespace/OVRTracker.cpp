...
bool GlobalNamespace::OVRTracker::get_isPresent() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_isPresent", {}, ::il2cpp_utils::ExtractTypes()));
...
bool GlobalNamespace::OVRTracker::get_isPositionTracked() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "get_isPositionTracked", {}, ::il2cpp_utils::ExtractTypes()));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method);
}
...
GlobalNamespace::OVRTracker::Frustum GlobalNamespace::OVRTracker::GetFrustum(int tracker) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::OVRTracker::Frustum>(), "GetFrustum", {}, ::il2cpp_utils::ExtractTypes(tracker)));
...
GlobalNamespace::OVRPose GlobalNamespace::OVRTracker::GetPose(int tracker) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::OVRPose>(), "GetPose", {}, ::il2cpp_utils::ExtractTypes(tracker)));
...
bool GlobalNamespace::OVRTracker::GetPoseValid(int tracker) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "GetPoseValid", {}, ::il2cpp_utils::ExtractTypes(tracker)));
...
bool GlobalNamespace::OVRTracker::GetPresent(int tracker) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "GetPresent", {}, ::il2cpp_utils::ExtractTypes(tracker)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, tracker);
}
