...
void GlobalNamespace::SteamVR_TestController::OnDeviceConnected(int index, bool connected) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnDeviceConnected", {}, ::il2cpp_utils::ExtractTypes(index, connected)));
...
void GlobalNamespace::SteamVR_TestController::PrintControllerStatus(int index) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "PrintControllerStatus", {}, ::il2cpp_utils::ExtractTypes(index)));
...
GlobalNamespace::SteamVR_TestController* GlobalNamespace::SteamVR_TestController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SteamVR_TestController").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<SteamVR_TestController*>());
}
