...
void GlobalNamespace::ConnectedPlayerManager::RemoveAllPlayers() {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "RemoveAllPlayers"));
}
// Autogenerated method: ConnectedPlayerManager.RemovePlayer
void GlobalNamespace::ConnectedPlayerManager::RemovePlayer(GlobalNamespace::ConnectedPlayerManager::ConnectedPlayer* player) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "RemovePlayer", player));
}
...
void GlobalNamespace::ConnectedPlayerManager::HandleConnectionDisconnected(GlobalNamespace::IConnection* connection) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "HandleConnectionDisconnected", connection));
}
