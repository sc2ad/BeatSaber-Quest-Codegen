...
// Completed includes
// Autogenerated method: CreditsController/<ScrollCoroutine>d__13..ctor
GlobalNamespace::CreditsController::$ScrollCoroutine$d__13* GlobalNamespace::CreditsController::$ScrollCoroutine$d__13::New_ctor(int $$1__state) {
  return (CreditsController::$ScrollCoroutine$d__13*)THROW_UNLESS(il2cpp_utils::New("", "CreditsController/<ScrollCoroutine>d__13", $$1__state));
}
...
::CsObject* GlobalNamespace::CreditsController::$ScrollCoroutine$d__13::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::CreditsController::$ScrollCoroutine$d__13::System_Collections_IEnumerator_get_Current() {
