...
GlobalNamespace::LeaderboardScoreUploader::UploadScoreCallback* GlobalNamespace::LeaderboardScoreUploader::UploadScoreCallback::New_ctor(::CsObject* object, System::IntPtr method) {
  return (LeaderboardScoreUploader::UploadScoreCallback*)THROW_UNLESS(il2cpp_utils::New("", "LeaderboardScoreUploader/UploadScoreCallback", object, method));
}
...
System::IAsyncResult* GlobalNamespace::LeaderboardScoreUploader::UploadScoreCallback::BeginInvoke(GlobalNamespace::LeaderboardScoreUploader::ScoreData* scoreData, GlobalNamespace::PlatformLeaderboardsModel::UploadScoreCompletionHandler* completionHandler, System::AsyncCallback* callback, ::CsObject* object) {
