...
::CsString* GlobalNamespace::OVRHandTest::_get_prevConnected() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "OVRHandTest", "prevConnected"));
}
// Autogenerated static field setter
// Set static field: static private System.String prevConnected
void GlobalNamespace::OVRHandTest::_set_prevConnected(::CsString* value) {
