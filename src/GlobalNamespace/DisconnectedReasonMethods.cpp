...
::Il2CppString* GlobalNamespace::DisconnectedReasonMethods::LocalizedKey(GlobalNamespace::DisconnectedReason connectionFailedReason) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DisconnectedReasonMethods", il2cpp_utils::NoArgClass<::Il2CppString*>(), "LocalizedKey", {}, ::il2cpp_utils::ExtractTypes(connectionFailedReason)));
...
::Il2CppString* GlobalNamespace::DisconnectedReasonMethods::ErrorCode(GlobalNamespace::DisconnectedReason disconnectedReason) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "DisconnectedReasonMethods", il2cpp_utils::NoArgClass<::Il2CppString*>(), "ErrorCode", {}, ::il2cpp_utils::ExtractTypes(disconnectedReason)));
