...
void GlobalNamespace::LevelPackDetailViewController::ShowContent(GlobalNamespace::LevelPackDetailViewController::ContentType contentType, ::CsString* errorText) {
...
GlobalNamespace::LevelPackDetailViewController* GlobalNamespace::LevelPackDetailViewController::New_ctor() {
  return (LevelPackDetailViewController*)THROW_UNLESS(il2cpp_utils::New("", "LevelPackDetailViewController"));
}
