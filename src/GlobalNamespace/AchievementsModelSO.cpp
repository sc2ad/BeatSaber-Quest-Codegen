...
void GlobalNamespace::AchievementsModelSO::$Initialize$b__3_0(GlobalNamespace::PlatformAchievementsModelSO::GetUnlockedAchievementsResult result, ::Array<::CsString*>* achievementIds) {
