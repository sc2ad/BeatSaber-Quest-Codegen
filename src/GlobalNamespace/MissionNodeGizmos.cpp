...
GlobalNamespace::MissionNodeGizmos* GlobalNamespace::MissionNodeGizmos::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MissionNodeGizmos").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<MissionNodeGizmos*>());
}
