...
GlobalNamespace::PlayerSaveDataV1_0_1* GlobalNamespace::PlayerSaveDataV1_0_1::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PlayerSaveDataV1_0_1").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<PlayerSaveDataV1_0_1*>());
}
