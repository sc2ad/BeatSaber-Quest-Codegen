...
::CsString* GlobalNamespace::PlayerSaveDataV1_0_1::_get_kCurrentVersion() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("", "PlayerSaveDataV1_0_1", "kCurrentVersion"));
}
// Autogenerated static field setter
// Set static field: static public System.String kCurrentVersion
void GlobalNamespace::PlayerSaveDataV1_0_1::_set_kCurrentVersion(::CsString* value) {
