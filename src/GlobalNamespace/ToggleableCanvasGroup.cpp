...
void GlobalNamespace::ToggleableCanvasGroup::HandleToggleValueChanged(bool isOn) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleToggleValueChanged", {}, ::il2cpp_utils::ExtractTypes(isOn)));
...
void GlobalNamespace::ToggleableCanvasGroup::SetCanvasGroupData(bool isOn) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetCanvasGroupData", {}, ::il2cpp_utils::ExtractTypes(isOn)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, isOn);
}
