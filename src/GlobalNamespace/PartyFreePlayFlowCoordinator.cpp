...
bool GlobalNamespace::PartyFreePlayFlowCoordinator::WillScoreGoToLeaderboard(GlobalNamespace::LevelCompletionResults* levelCompletionResults, ::CsString* leaderboardId, bool practice) {
...
bool GlobalNamespace::PartyFreePlayFlowCoordinator::IsNewHighScore(GlobalNamespace::LevelCompletionResults* levelCompletionResults, ::CsString* leaderboardId) {
...
void GlobalNamespace::PartyFreePlayFlowCoordinator::ProcessScore(GlobalNamespace::LevelCompletionResults* levelCompletionResults, ::CsString* leaderboardId, ::CsString* playerName) {
...
GlobalNamespace::PartyFreePlayFlowCoordinator* GlobalNamespace::PartyFreePlayFlowCoordinator::New_ctor() {
  return (PartyFreePlayFlowCoordinator*)THROW_UNLESS(il2cpp_utils::New("", "PartyFreePlayFlowCoordinator"));
}
