...
GlobalNamespace::OVRPlugin::CameraDevice GlobalNamespace::OVRPlugin::CameraDevice::_get_None() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDevice").WithContext("_get_None");
...
void GlobalNamespace::OVRPlugin::CameraDevice::_set_None(GlobalNamespace::OVRPlugin::CameraDevice value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("CameraDevice").WithContext("_set_None");
