...
void GlobalNamespace::BTSCharacterMaterialSwitcher::SwapMaterials(bool alternative) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SwapMaterials", {}, ::il2cpp_utils::ExtractTypes(alternative)));
...
GlobalNamespace::BTSCharacterMaterialSwitcher* GlobalNamespace::BTSCharacterMaterialSwitcher::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BTSCharacterMaterialSwitcher").WithContext(".ctor");
