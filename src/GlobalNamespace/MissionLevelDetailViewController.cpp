...
void GlobalNamespace::MissionLevelDetailViewController::DidActivate(bool firstActivation, HMUI::ViewController::ActivationType activationType) {
...
GlobalNamespace::MissionLevelDetailViewController* GlobalNamespace::MissionLevelDetailViewController::New_ctor() {
  return (MissionLevelDetailViewController*)THROW_UNLESS(il2cpp_utils::New("", "MissionLevelDetailViewController"));
}
