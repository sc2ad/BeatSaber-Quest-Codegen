...
GlobalNamespace::OVRNetwork* GlobalNamespace::OVRNetwork::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("OVRNetwork").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<OVRNetwork*>());
}
