...
GlobalNamespace::CoroutineHelpers::$ExecuteAfterDelayCoroutine$d__0* GlobalNamespace::CoroutineHelpers::$ExecuteAfterDelayCoroutine$d__0::New_ctor(int $$1__state) {
  return (CoroutineHelpers::$ExecuteAfterDelayCoroutine$d__0*)THROW_UNLESS(il2cpp_utils::New("", "CoroutineHelpers/<ExecuteAfterDelayCoroutine>d__0", $$1__state));
}
...
::CsObject* GlobalNamespace::CoroutineHelpers::$ExecuteAfterDelayCoroutine$d__0::System_Collections_Generic_IEnumerator_1_get_Current() {
...
::CsObject* GlobalNamespace::CoroutineHelpers::$ExecuteAfterDelayCoroutine$d__0::System_Collections_IEnumerator_get_Current() {
