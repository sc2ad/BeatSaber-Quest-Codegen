...
void GlobalNamespace::GameServersFilterText::Setup(GlobalNamespace::GameServersFilter* filter) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Setup", {}, ::il2cpp_utils::ExtractTypes(filter)));
...
void GlobalNamespace::GameServersFilterText::Setup(GlobalNamespace::BeatmapDifficultyMask beatmapDifficultyMask, GlobalNamespace::SongPackMask songPackMask) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("GameServersFilterText").WithContext("Setup");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Setup", {}, ::il2cpp_utils::ExtractTypes(beatmapDifficultyMask, songPackMask)));
...
GlobalNamespace::GameServersFilterText* GlobalNamespace::GameServersFilterText::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("GameServersFilterText").WithContext(".ctor");
