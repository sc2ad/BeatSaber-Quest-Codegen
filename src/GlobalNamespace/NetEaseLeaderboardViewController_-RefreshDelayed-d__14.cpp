...
GlobalNamespace::NetEaseLeaderboardViewController::$RefreshDelayed$d__14* GlobalNamespace::NetEaseLeaderboardViewController::$RefreshDelayed$d__14::New_ctor(int $$1__state) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$RefreshDelayed$d__14").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<NetEaseLeaderboardViewController::$RefreshDelayed$d__14*>($$1__state));
}
