...
void GlobalNamespace::LevelListTableCell::RefreshAvailabilityAsync(GlobalNamespace::AdditionalContentModel* contentModel, ::CsString* levelID) {
...
GlobalNamespace::LevelListTableCell* GlobalNamespace::LevelListTableCell::New_ctor() {
  return (LevelListTableCell*)THROW_UNLESS(il2cpp_utils::New("", "LevelListTableCell"));
}
