...
// Completed includes
// Autogenerated method: VRControllersRecorderSaveData..ctor
GlobalNamespace::VRControllersRecorderSaveData* GlobalNamespace::VRControllersRecorderSaveData::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("VRControllersRecorderSaveData").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<VRControllersRecorderSaveData*>());
}
