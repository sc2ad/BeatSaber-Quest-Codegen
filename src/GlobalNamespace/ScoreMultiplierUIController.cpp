...
void GlobalNamespace::ScoreMultiplierUIController::HandleMultiplierDidChange(int multiplier, float progress) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "HandleMultiplierDidChange", {}, ::il2cpp_utils::ExtractTypes(multiplier, progress)));
...
GlobalNamespace::ScoreMultiplierUIController* GlobalNamespace::ScoreMultiplierUIController::New_ctor() {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<ScoreMultiplierUIController*>());
}
