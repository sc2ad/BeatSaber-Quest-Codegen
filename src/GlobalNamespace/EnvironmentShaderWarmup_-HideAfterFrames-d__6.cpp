...
void GlobalNamespace::EnvironmentShaderWarmup::$HideAfterFrames$d__6::System_IDisposable_Dispose() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$HideAfterFrames$d__6").WithContext("System.IDisposable.Dispose");
...
bool GlobalNamespace::EnvironmentShaderWarmup::$HideAfterFrames$d__6::MoveNext() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$HideAfterFrames$d__6").WithContext("MoveNext");
...
::Il2CppObject* GlobalNamespace::EnvironmentShaderWarmup::$HideAfterFrames$d__6::System_Collections_Generic_IEnumerator_1_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$HideAfterFrames$d__6").WithContext("System.Collections.Generic.IEnumerator<System.Object>.get_Current");
...
void GlobalNamespace::EnvironmentShaderWarmup::$HideAfterFrames$d__6::System_Collections_IEnumerator_Reset() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$HideAfterFrames$d__6").WithContext("System.Collections.IEnumerator.Reset");
...
::Il2CppObject* GlobalNamespace::EnvironmentShaderWarmup::$HideAfterFrames$d__6::System_Collections_IEnumerator_get_Current() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$HideAfterFrames$d__6").WithContext("System.Collections.IEnumerator.get_Current");
