...
void GlobalNamespace::MultiplayerIntroCountdownTextController::SetDistances(float distance) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "SetDistances", {}, ::il2cpp_utils::ExtractTypes(distance)));
...
GlobalNamespace::MultiplayerIntroCountdownTextController* GlobalNamespace::MultiplayerIntroCountdownTextController::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerIntroCountdownTextController").WithContext(".ctor");
