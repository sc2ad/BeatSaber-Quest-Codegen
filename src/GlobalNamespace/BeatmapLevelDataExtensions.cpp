...
GlobalNamespace::IDifficultyBeatmap* GlobalNamespace::BeatmapLevelDataExtensions::GetDifficultyBeatmap(GlobalNamespace::IBeatmapLevelData* beatmapLevelData, GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic, GlobalNamespace::BeatmapDifficulty difficulty) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapLevelDataExtensions", il2cpp_utils::NoArgClass<GlobalNamespace::IDifficultyBeatmap*>(), "GetDifficultyBeatmap", {}, ::il2cpp_utils::ExtractTypes(beatmapLevelData, beatmapCharacteristic, difficulty)));
...
GlobalNamespace::IDifficultyBeatmapSet* GlobalNamespace::BeatmapLevelDataExtensions::GetDifficultyBeatmapSet(GlobalNamespace::IBeatmapLevelData* beatmapLevelData, GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapLevelDataExtensions", il2cpp_utils::NoArgClass<GlobalNamespace::IDifficultyBeatmapSet*>(), "GetDifficultyBeatmapSet", {}, ::il2cpp_utils::ExtractTypes(beatmapLevelData, beatmapCharacteristic)));
...
GlobalNamespace::IDifficultyBeatmap* GlobalNamespace::BeatmapLevelDataExtensions::GetDifficultyBeatmap(GlobalNamespace::IBeatmapLevelData* beatmapLevelData, ::Il2CppString* beatmapCharacteristicName, GlobalNamespace::BeatmapDifficulty difficulty) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BeatmapLevelDataExtensions").WithContext("GetDifficultyBeatmap");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapLevelDataExtensions", il2cpp_utils::NoArgClass<GlobalNamespace::IDifficultyBeatmap*>(), "GetDifficultyBeatmap", {}, ::il2cpp_utils::ExtractTypes(beatmapLevelData, beatmapCharacteristicName, difficulty)));
...
GlobalNamespace::IDifficultyBeatmapSet* GlobalNamespace::BeatmapLevelDataExtensions::GetDifficultyBeatmapSet(GlobalNamespace::IBeatmapLevelData* beatmapLevelData, ::Il2CppString* beatmapCharacteristicName) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BeatmapLevelDataExtensions").WithContext("GetDifficultyBeatmapSet");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "BeatmapLevelDataExtensions", il2cpp_utils::NoArgClass<GlobalNamespace::IDifficultyBeatmapSet*>(), "GetDifficultyBeatmapSet", {}, ::il2cpp_utils::ExtractTypes(beatmapLevelData, beatmapCharacteristicName)));
