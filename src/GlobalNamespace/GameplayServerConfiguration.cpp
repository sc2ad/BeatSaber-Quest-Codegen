...
GlobalNamespace::GameplayServerConfiguration GlobalNamespace::GameplayServerConfiguration::Deserialize(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayServerConfiguration", il2cpp_utils::NoArgClass<GlobalNamespace::GameplayServerConfiguration>(), "Deserialize", {}, ::il2cpp_utils::ExtractTypes(reader)));
...
GlobalNamespace::GameplayServerConfiguration GlobalNamespace::GameplayServerConfiguration::CreateFromSerializedData(LiteNetLib::Utils::NetDataReader* reader) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<GlobalNamespace::GameplayServerConfiguration>(), "CreateFromSerializedData", {}, ::il2cpp_utils::ExtractTypes(reader)));
...
bool GlobalNamespace::operator ==(const GlobalNamespace::GameplayServerConfiguration& l, const GlobalNamespace::GameplayServerConfiguration& r) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayServerConfiguration", il2cpp_utils::NoArgClass<bool>(), "op_Equality", {}, ::il2cpp_utils::ExtractTypes(l, r)));
...
bool GlobalNamespace::operator !=(const GlobalNamespace::GameplayServerConfiguration& l, const GlobalNamespace::GameplayServerConfiguration& r) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("", "GameplayServerConfiguration", il2cpp_utils::NoArgClass<bool>(), "op_Inequality", {}, ::il2cpp_utils::ExtractTypes(l, r)));
  return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, l, r);
}
