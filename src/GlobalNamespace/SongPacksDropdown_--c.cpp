...
void GlobalNamespace::SongPacksDropdown::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "SongPacksDropdown/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
::Il2CppString* GlobalNamespace::SongPacksDropdown::$$c::$Start$b__7_0(System::Tuple_2<GlobalNamespace::SongPackMask, ::Il2CppString*>* x) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<::Il2CppString*>(), "<Start>b__7_0", {}, ::il2cpp_utils::ExtractTypes(x))));
