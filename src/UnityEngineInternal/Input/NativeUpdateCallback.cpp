...
UnityEngineInternal::Input::NativeUpdateCallback* UnityEngineInternal::Input::NativeUpdateCallback::New_ctor(::CsObject* object, System::IntPtr method) {
...
System::IAsyncResult* UnityEngineInternal::Input::NativeUpdateCallback::BeginInvoke(UnityEngineInternal::Input::NativeInputUpdateType updateType, UnityEngineInternal::Input::NativeInputEventBuffer* buffer, System::AsyncCallback* callback, ::CsObject* object) {
