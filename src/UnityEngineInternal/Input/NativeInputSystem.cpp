...
System::Action_2<int, ::CsString*>* UnityEngineInternal::Input::NativeInputSystem::_get_s_OnDeviceDiscoveredCallback() {
  return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_2<int, ::CsString*>*>("UnityEngineInternal.Input", "NativeInputSystem", "s_OnDeviceDiscoveredCallback")));
}
// Autogenerated static field setter
// Set static field: static private System.Action`2<System.Int32,System.String> s_OnDeviceDiscoveredCallback
void UnityEngineInternal::Input::NativeInputSystem::_set_s_OnDeviceDiscoveredCallback(System::Action_2<int, ::CsString*>* value) {
...
void UnityEngineInternal::Input::NativeInputSystem::NotifyDeviceDiscovered(int deviceId, ::CsString* deviceDescriptor) {
