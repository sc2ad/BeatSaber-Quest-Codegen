...
void MasterServer::IMasterServer::ReportExceptionForEndPoint(System::Net::IPEndPoint* remoteEndPoint) {
  THROW_UNLESS(il2cpp_utils::RunMethod(this, "ReportExceptionForEndPoint", remoteEndPoint));
}
