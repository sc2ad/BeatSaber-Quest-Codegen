...
GlobalNamespace::PacketPool_1<MasterServer::HandshakeMultipartMessage*>* MasterServer::HandshakeMultipartMessage::get_pool() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("HandshakeMultipartMessage").WithContext("get_pool");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "HandshakeMultipartMessage", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::HandshakeMultipartMessage*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
void MasterServer::HandshakeMultipartMessage::Release() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("HandshakeMultipartMessage").WithContext("Release");
