...
GlobalNamespace::PacketPool_1<MasterServer::UserMessageReceivedAcknowledge*>* MasterServer::UserMessageReceivedAcknowledge::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "UserMessageReceivedAcknowledge", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::UserMessageReceivedAcknowledge*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
