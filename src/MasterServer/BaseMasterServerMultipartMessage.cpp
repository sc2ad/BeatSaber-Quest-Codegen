...
void MasterServer::BaseMasterServerMultipartMessage::set_multipartMessageId(uint value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_multipartMessageId", {}, ::il2cpp_utils::ExtractTypes(value)));
...
void MasterServer::BaseMasterServerMultipartMessage::set_totalLength(int value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_totalLength", {}, ::il2cpp_utils::ExtractTypes(value)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
}
...
MasterServer::BaseMasterServerMultipartMessage* MasterServer::BaseMasterServerMultipartMessage::Init(uint multipartMessageId, ::Array<uint8_t>* data, int offset, int length, int totalLength) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::BaseMasterServerMultipartMessage*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(multipartMessageId, data, offset, length, totalLength)));
