...
GlobalNamespace::PacketPool_1<MasterServer::AuthenticateDedicatedServerResponse*>* MasterServer::AuthenticateDedicatedServerResponse::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "AuthenticateDedicatedServerResponse", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::AuthenticateDedicatedServerResponse*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::AuthenticateDedicatedServerResponse* MasterServer::AuthenticateDedicatedServerResponse::Init(MasterServer::AuthenticateDedicatedServerResponse::Result result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::AuthenticateDedicatedServerResponse*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(result)));
