...
GlobalNamespace::PacketPool_1<MasterServer::ConnectToServerRequest*>* MasterServer::ConnectToServerRequest::get_pool() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext("get_pool");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "ConnectToServerRequest", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::ConnectToServerRequest*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::ConnectToServerRequest* MasterServer::ConnectToServerRequest::Init(::Il2CppString* userId, ::Il2CppString* userName, ::Il2CppString* secret, ::Il2CppString* code, ::Il2CppString* password, bool useRelay) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext("Init");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::ConnectToServerRequest*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(userId, userName, secret, code, password, useRelay)));
...
void MasterServer::ConnectToServerRequest::Serialize(LiteNetLib::Utils::NetDataWriter* writer) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext("Serialize");
...
void MasterServer::ConnectToServerRequest::Deserialize(LiteNetLib::Utils::NetDataReader* reader) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext("Deserialize");
...
void MasterServer::ConnectToServerRequest::Release() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext("Release");
...
MasterServer::ConnectToServerRequest* MasterServer::ConnectToServerRequest::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("ConnectToServerRequest").WithContext(".ctor");
