...
GlobalNamespace::PacketPool_1<MasterServer::HelloVerifyRequest*>* MasterServer::HelloVerifyRequest::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "HelloVerifyRequest", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::HelloVerifyRequest*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::HelloVerifyRequest* MasterServer::HelloVerifyRequest::Init(::Array<uint8_t>* cookie) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::HelloVerifyRequest*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(cookie)));
