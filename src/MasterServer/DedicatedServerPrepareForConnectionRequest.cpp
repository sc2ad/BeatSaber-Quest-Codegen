...
GlobalNamespace::PacketPool_1<MasterServer::DedicatedServerPrepareForConnectionRequest*>* MasterServer::DedicatedServerPrepareForConnectionRequest::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "DedicatedServerPrepareForConnectionRequest", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::DedicatedServerPrepareForConnectionRequest*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::DedicatedServerPrepareForConnectionRequest* MasterServer::DedicatedServerPrepareForConnectionRequest::Init(::Il2CppString* id, ::Il2CppString* userId, ::Il2CppString* userName, System::Net::IPEndPoint* remoteEndPoint, ::Array<uint8_t>* random, ::Array<uint8_t>* publicKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::DedicatedServerPrepareForConnectionRequest*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(id, userId, userName, remoteEndPoint, random, publicKey)));
...
MasterServer::DedicatedServerPrepareForConnectionRequest* MasterServer::DedicatedServerPrepareForConnectionRequest::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("DedicatedServerPrepareForConnectionRequest").WithContext(".ctor");
