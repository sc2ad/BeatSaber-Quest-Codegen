...
GlobalNamespace::PacketPool_1<MasterServer::BroadcastServerHeartbeatResponse*>* MasterServer::BroadcastServerHeartbeatResponse::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "BroadcastServerHeartbeatResponse", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::BroadcastServerHeartbeatResponse*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::BroadcastServerHeartbeatResponse* MasterServer::BroadcastServerHeartbeatResponse::Init(MasterServer::BroadcastServerHeartbeatResponse::Result result) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::BroadcastServerHeartbeatResponse*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(result)));
