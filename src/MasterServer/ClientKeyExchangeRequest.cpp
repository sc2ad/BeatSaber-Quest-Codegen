...
GlobalNamespace::PacketPool_1<MasterServer::ClientKeyExchangeRequest*>* MasterServer::ClientKeyExchangeRequest::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "ClientKeyExchangeRequest", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::ClientKeyExchangeRequest*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::ClientKeyExchangeRequest* MasterServer::ClientKeyExchangeRequest::Init(::Array<uint8_t>* clientPublicKey) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::ClientKeyExchangeRequest*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(clientPublicKey)));
