...
GlobalNamespace::PacketPool_1<MasterServer::GetAvailableMatchmakingServerRequest*>* MasterServer::GetAvailableMatchmakingServerRequest::get_pool() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("MasterServer", "GetAvailableMatchmakingServerRequest", il2cpp_utils::NoArgClass<GlobalNamespace::PacketPool_1<MasterServer::GetAvailableMatchmakingServerRequest*>*>(), "get_pool", {}, ::il2cpp_utils::ExtractTypes()));
...
MasterServer::GetAvailableMatchmakingServerRequest* MasterServer::GetAvailableMatchmakingServerRequest::Init(::Il2CppString* secret, GlobalNamespace::GameplayServerConfiguration configuration) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<MasterServer::GetAvailableMatchmakingServerRequest*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(secret, configuration)));
...
MasterServer::GetAvailableMatchmakingServerRequest* MasterServer::GetAvailableMatchmakingServerRequest::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("GetAvailableMatchmakingServerRequest").WithContext(".ctor");
