...
UnityEngine::Timeline::DiscreteTime::DiscreteTime(double time) {
  ...
  ::il2cpp_utils::RunMethodRethrow<DiscreteTime, false>(this, ___internal__method, time);
}
// Autogenerated method: UnityEngine.Timeline.DiscreteTime..ctor
...
UnityEngine::Timeline::DiscreteTime::DiscreteTime(int frame, double fps) {
  ...
  ::il2cpp_utils::RunMethodRethrow<DiscreteTime, false>(this, ___internal__method, frame, fps);
}
...
UnityEngine::Timeline::MarkerList::MarkerList(int capacity) {
  ...
  ::il2cpp_utils::RunMethodRethrow<MarkerList, false>(this, ___internal__method, capacity);
}
