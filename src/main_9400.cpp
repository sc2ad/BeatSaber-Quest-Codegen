...
System::Collections::Generic::List_1<::StringW>*& UnityEngine::Timeline::TimelineClip::dyn_m_ExposedParameterNames() {
...
::StringW& UnityEngine::Timeline::TimelineClip::dyn_m_DisplayName() {
