...
::ArrayWrapper<uint8_t>& Mono::Unity::UnityTlsContext::dyn_writeBuffer() {
...
::ArrayWrapper<uint8_t>& Mono::Unity::UnityTlsContext::dyn_readBuffer() {
...
System::ValueTuple_2<int, bool> Mono::Unity::UnityTlsContext::Read(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
System::ValueTuple_2<int, bool> Mono::Unity::UnityTlsContext::Write(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
::ArrayWrapper<Mono::Net::CFProxy*> Mono::Net::CFNetwork::GetProxiesForAutoConfigurationScript(System::IntPtr proxyAutoConfigurationScript, Mono::Net::CFUrl* targetURL) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<Mono::Net::CFProxy*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, proxyAutoConfigurationScript, targetURL);
}
// Autogenerated method: Mono.Net.CFNetwork.GetProxiesForAutoConfigurationScript
::ArrayWrapper<Mono::Net::CFProxy*> Mono::Net::CFNetwork::GetProxiesForAutoConfigurationScript(System::IntPtr proxyAutoConfigurationScript, System::Uri* targetUri) {
  static auto ___internal__logger = ::Logger::get().WithContext("Mono::Net::CFNetwork::GetProxiesForAutoConfigurationScript");
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<Mono::Net::CFProxy*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, proxyAutoConfigurationScript, targetUri);
}
// Autogenerated method: Mono.Net.CFNetwork.ExecuteProxyAutoConfigurationURL
::ArrayWrapper<Mono::Net::CFProxy*> Mono::Net::CFNetwork::ExecuteProxyAutoConfigurationURL(System::IntPtr proxyAutoConfigURL, System::Uri* targetURL) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<Mono::Net::CFProxy*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, proxyAutoConfigURL, targetURL);
}
...
::ArrayWrapper<Mono::Net::CFProxy*> Mono::Net::CFNetwork::GetProxiesForURL(Mono::Net::CFUrl* url, Mono::Net::CFProxySettings* proxySettings) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<Mono::Net::CFProxy*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, url, proxySettings);
}
// Autogenerated method: Mono.Net.CFNetwork.GetProxiesForUri
::ArrayWrapper<Mono::Net::CFProxy*> Mono::Net::CFNetwork::GetProxiesForUri(System::Uri* uri, Mono::Net::CFProxySettings* proxySettings) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<Mono::Net::CFProxy*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, uri, proxySettings);
}
...
System::Uri* Mono::Net::CFNetwork::CFWebProxy::SelectProxy(::ArrayWrapper<Mono::Net::CFProxy*> proxies, System::Uri* targetUri, ByRef<System::Net::NetworkCredential*> credentials) {
...
::ArrayWrapper<Mono::Net::CFProxy*>& Mono::Net::CFNetwork::$$c__DisplayClass13_0::dyn_proxies() {
  ...
  return *reinterpret_cast<::ArrayWrapper<Mono::Net::CFProxy*>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
}
// Autogenerated instance field getter
...
::ArrayWrapper<uint8_t>& Mono::Net::Security::BufferOffsetSize::dyn_Buffer() {
...
void Mono::Net::Security::BufferOffsetSize2::AppendData(::ArrayWrapper<uint8_t> buffer, int offset, int size) {
...
int Mono::Net::Security::MobileAuthenticatedStream::InternalRead(::ArrayWrapper<uint8_t> buffer, int offset, int size, ByRef<bool> outWantMore) {
...
// Autogenerated method: Mono.Net.Security.MobileAuthenticatedStream.InternalRead
System::ValueTuple_2<int, bool> Mono::Net::Security::MobileAuthenticatedStream::InternalRead(Mono::Net::Security::AsyncProtocolRequest* asyncRequest, Mono::Net::Security::BufferOffsetSize* internalBuffer, ::ArrayWrapper<uint8_t> buffer, int offset, int size) {
  static auto ___internal__logger = ::Logger::get().WithContext("Mono::Net::Security::MobileAuthenticatedStream::InternalRead");
...
bool Mono::Net::Security::MobileAuthenticatedStream::InternalWrite(::ArrayWrapper<uint8_t> buffer, int offset, int size) {
...
// Autogenerated method: Mono.Net.Security.MobileAuthenticatedStream.InternalWrite
bool Mono::Net::Security::MobileAuthenticatedStream::InternalWrite(Mono::Net::Security::AsyncProtocolRequest* asyncRequest, Mono::Net::Security::BufferOffsetSize2* internalBuffer, ::ArrayWrapper<uint8_t> buffer, int offset, int size) {
  static auto ___internal__logger = ::Logger::get().WithContext("Mono::Net::Security::MobileAuthenticatedStream::InternalWrite");
...
System::IAsyncResult* Mono::Net::Security::MobileAuthenticatedStream::BeginRead(::ArrayWrapper<uint8_t> buffer, int offset, int count, System::AsyncCallback* asyncCallback, ::Il2CppObject* asyncState) {
...
System::IAsyncResult* Mono::Net::Security::MobileAuthenticatedStream::BeginWrite(::ArrayWrapper<uint8_t> buffer, int offset, int count, System::AsyncCallback* asyncCallback, ::Il2CppObject* asyncState) {
...
int Mono::Net::Security::MobileAuthenticatedStream::Read(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
void Mono::Net::Security::MobileAuthenticatedStream::Write(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
System::Threading::Tasks::Task_1<int>* Mono::Net::Security::MobileAuthenticatedStream::ReadAsync(::ArrayWrapper<uint8_t> buffer, int offset, int count, System::Threading::CancellationToken cancellationToken) {
...
System::Threading::Tasks::Task* Mono::Net::Security::MobileAuthenticatedStream::WriteAsync(::ArrayWrapper<uint8_t> buffer, int offset, int count, System::Threading::CancellationToken cancellationToken) {
...
System::ValueTuple_2<int, bool> Mono::Net::Security::MobileTlsContext::Read(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
System::ValueTuple_2<int, bool> Mono::Net::Security::MobileTlsContext::Write(::ArrayWrapper<uint8_t> buffer, int offset, int count) {
...
System::Security::Cryptography::X509Certificates::X509Certificate* Mono::Net::Security::MobileTlsContext::SelectClientCertificate(System::Security::Cryptography::X509Certificates::X509Certificate* serverCertificate, ::ArrayWrapper<::Il2CppString*> acceptableIssuers) {
...
System::IO::Stream* Mono::Net::Security::MonoTlsStream::CreateStream(::ArrayWrapper<uint8_t> buffer) {
