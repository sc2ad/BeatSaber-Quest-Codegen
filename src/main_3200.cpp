...
GlobalNamespace::EnvironmentEffectsFilterPreset GlobalNamespace::PlayerSaveDataConvertor::GetRuntimeData(GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::EnvironmentEffectsFilterPresetSaveData saveData) {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::EnvironmentEffectsFilterPreset, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, saveData);
}
...
GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::EnvironmentEffectsFilterPresetSaveData GlobalNamespace::PlayerSaveDataConvertor::GetSaveData(GlobalNamespace::EnvironmentEffectsFilterPreset data) {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::EnvironmentEffectsFilterPresetSaveData, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, data);
}
// Autogenerated method: PlayerSaveDataConvertor.GetRuntimeData
GlobalNamespace::NoteJumpDurationTypeSettings GlobalNamespace::PlayerSaveDataConvertor::GetRuntimeData(GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::NoteJumpDurationTypeSettingsSaveData saveData) {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PlayerSaveDataConvertor::GetRuntimeData");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "PlayerSaveDataConvertor", "GetRuntimeData", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(saveData)})));
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::NoteJumpDurationTypeSettings, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, saveData);
}
// Autogenerated method: PlayerSaveDataConvertor.GetSaveData
GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::NoteJumpDurationTypeSettingsSaveData GlobalNamespace::PlayerSaveDataConvertor::GetSaveData(GlobalNamespace::NoteJumpDurationTypeSettings data) {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PlayerSaveDataConvertor::GetSaveData");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "PlayerSaveDataConvertor", "GetSaveData", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(data)})));
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::PlayerSaveData::PlayerSpecificSettings::NoteJumpDurationTypeSettingsSaveData, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, data);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
GlobalNamespace::NoteJumpDurationTypeSettings GlobalNamespace::PlayerSpecificSettings::get_noteJumpDurationTypeSettings() {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::NoteJumpDurationTypeSettings, false>(this, ___internal__method);
}
...
GlobalNamespace::PracticeSettings* GlobalNamespace::PracticeSettings::get_defaultPracticeSettings() {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::PracticeSettings*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method);
}
...
GlobalNamespace::RankModel::Rank GlobalNamespace::RankModelHelper::MaxRankForGameplayModifiers(GlobalNamespace::GameplayModifiers* gameplayModifiers, GlobalNamespace::GameplayModifiersModelSO* gameplayModifiersModel, float energy) {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::RankModel::Rank, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, gameplayModifiers, gameplayModifiersModel, energy);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
::ArrayW<GlobalNamespace::RelativeSfxVolumePerLevelSO::RelativeSfxVolumePair*> GlobalNamespace::RelativeSfxVolumePerLevelSO::get_relativeSfxVolumePerLevel() {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<GlobalNamespace::RelativeSfxVolumePerLevelSO::RelativeSfxVolumePair*>, false>(this, ___internal__method);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
int GlobalNamespace::ScoreModel::MaxRawScoreForNumberOfNotes(int noteCount) {
  ...
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, noteCount);
}
...
void GlobalNamespace::ScoreModel::RawScoreWithoutMultiplier(GlobalNamespace::ISaberSwingRatingCounter* saberSwingRatingCounter, float cutDistanceToCenter, ByRef<int> beforeCutRawScore, ByRef<int> afterCutRawScore, ByRef<int> cutDistanceRawScore) {
  ...
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, saberSwingRatingCounter, cutDistanceToCenter, byref(beforeCutRawScore), byref(afterCutRawScore), byref(cutDistanceRawScore));
}
...
int GlobalNamespace::ScoreModel::GetModifiedScoreForGameplayModifiersScoreMultiplier(int rawScore, float gameplayModifiersScoreMultiplier) {
  ...
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, rawScore, gameplayModifiersScoreMultiplier);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
GlobalNamespace::StandardLevelInfoSaveData* GlobalNamespace::StandardLevelLoader::LoadStandardLevelSaveData(::Il2CppString* levelInfoFilenamePath) {
  ...
  return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::StandardLevelInfoSaveData*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, levelInfoFilenamePath);
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
void GlobalNamespace::BasicBeatmapObjectManager::Init(GlobalNamespace::BasicBeatmapObjectManager::InitData* initData, GlobalNamespace::GameNoteController::Pool* gameNotePool, GlobalNamespace::BombNoteController::Pool* bombNotePool, GlobalNamespace::ObstacleController::Pool* obstaclePool) {
  ...
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, initData, gameNotePool, bombNotePool, obstaclePool);
}
...
void GlobalNamespace::BeatmapObjectSpawnControllerHelpers::GetNoteJumpValues(GlobalNamespace::PlayerSpecificSettings* playerSpecificSettings, float defaultNoteJumpStartBeatOffset, ByRef<GlobalNamespace::BeatmapObjectSpawnMovementData::NoteJumpValueType> noteJumpValueType, ByRef<float> noteJumpValue) {
  ...
  ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, playerSpecificSettings, defaultNoteJumpStartBeatOffset, byref(noteJumpValueType), byref(noteJumpValue));
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
...
void GlobalNamespace::BeatmapObjectSpawnMovementData::Init(int noteLinesCount, float startNoteJumpMovementSpeed, float startBpm, GlobalNamespace::BeatmapObjectSpawnMovementData::NoteJumpValueType noteJumpValueType, float noteJumpValue, float jumpOffsetY, UnityEngine::Vector3 rightVec, UnityEngine::Vector3 forwardVec) {
  ...
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, noteLinesCount, startNoteJumpMovementSpeed, startBpm, noteJumpValueType, noteJumpValue, jumpOffsetY, rightVec, forwardVec);
}
...
float GlobalNamespace::BeatmapObjectSpawnMovementData::NoteJumpGravityForLineLayer(GlobalNamespace::NoteLineLayer lineLayer, GlobalNamespace::NoteLineLayer beforeJumpLineLayer) {
  ...
  return ::il2cpp_utils::RunMethodThrow<float, false>(this, ___internal__method, lineLayer, beforeJumpLineLayer);
}
