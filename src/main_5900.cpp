...
::ArrayW<System::Diagnostics::StackFrame*> System::Diagnostics::StackTrace::get_trace(System::Exception* e, int skipFrames, bool fNeedFileInfo) {
  ...
  return ::il2cpp_utils::RunMethodThrow<::ArrayW<System::Diagnostics::StackFrame*>, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, e, skipFrames, fNeedFileInfo);
}
