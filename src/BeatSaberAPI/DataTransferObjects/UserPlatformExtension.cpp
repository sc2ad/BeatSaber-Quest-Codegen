...
BeatSaberAPI::DataTransferObjects::UserPlatform BeatSaberAPI::DataTransferObjects::UserPlatformExtension::GetUserPlatformFromSerializedName(::Il2CppString* name) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<BeatSaberAPI::DataTransferObjects::UserPlatform>("BeatSaberAPI.DataTransferObjects", "UserPlatformExtension", "GetUserPlatformFromSerializedName", name));
}
...
::Il2CppString* BeatSaberAPI::DataTransferObjects::UserPlatformExtension::GetUserPlatformSerializedName(BeatSaberAPI::DataTransferObjects::UserPlatform userPlatform) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>("BeatSaberAPI.DataTransferObjects", "UserPlatformExtension", "GetUserPlatformSerializedName", userPlatform));
}
