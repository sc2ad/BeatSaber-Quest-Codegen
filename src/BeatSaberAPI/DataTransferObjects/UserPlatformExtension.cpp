...
BeatSaberAPI::DataTransferObjects::UserPlatform BeatSaberAPI::DataTransferObjects::UserPlatformExtension::GetUserPlatformFromSerializedName(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("BeatSaberAPI.DataTransferObjects", "UserPlatformExtension", il2cpp_utils::NoArgClass<BeatSaberAPI::DataTransferObjects::UserPlatform>(), "GetUserPlatformFromSerializedName", {}, ::il2cpp_utils::ExtractTypes(name)));
...
::Il2CppString* BeatSaberAPI::DataTransferObjects::UserPlatformExtension::GetUserPlatformSerializedName(BeatSaberAPI::DataTransferObjects::UserPlatform userPlatform) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("BeatSaberAPI.DataTransferObjects", "UserPlatformExtension", il2cpp_utils::NoArgClass<::Il2CppString*>(), "GetUserPlatformSerializedName", {}, ::il2cpp_utils::ExtractTypes(userPlatform)));
