...
TMPro::TMP_InputField::LineType TMPro::TMP_InputField::LineType::_get_SingleLine() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_get_SingleLine");
...
void TMPro::TMP_InputField::LineType::_set_SingleLine(TMPro::TMP_InputField::LineType value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_set_SingleLine");
...
TMPro::TMP_InputField::LineType TMPro::TMP_InputField::LineType::_get_MultiLineSubmit() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_get_MultiLineSubmit");
...
void TMPro::TMP_InputField::LineType::_set_MultiLineSubmit(TMPro::TMP_InputField::LineType value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_set_MultiLineSubmit");
...
TMPro::TMP_InputField::LineType TMPro::TMP_InputField::LineType::_get_MultiLineNewline() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_get_MultiLineNewline");
...
void TMPro::TMP_InputField::LineType::_set_MultiLineNewline(TMPro::TMP_InputField::LineType value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("LineType").WithContext("_set_MultiLineNewline");
