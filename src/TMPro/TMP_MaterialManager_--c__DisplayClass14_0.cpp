...
bool TMPro::TMP_MaterialManager::$$c__DisplayClass14_0::$ReleaseBaseMaterial$b__0(TMPro::TMP_MaterialManager::MaskingMaterial* item) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<bool>(this, "<ReleaseBaseMaterial>b__0", item)));
}
...
TMPro::TMP_MaterialManager::$$c__DisplayClass14_0* TMPro::TMP_MaterialManager::$$c__DisplayClass14_0::New_ctor() {
  return (TMP_MaterialManager::$$c__DisplayClass14_0*)THROW_UNLESS(il2cpp_utils::New("TMPro", "TMP_MaterialManager/<>c__DisplayClass14_0"));
}
