...
TMPro::FontFeatureLookupFlags TMPro::FontFeatureLookupFlags::_get_IgnoreLigatures() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("FontFeatureLookupFlags").WithContext("_get_IgnoreLigatures");
...
void TMPro::FontFeatureLookupFlags::_set_IgnoreLigatures(TMPro::FontFeatureLookupFlags value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("FontFeatureLookupFlags").WithContext("_set_IgnoreLigatures");
...
TMPro::FontFeatureLookupFlags TMPro::FontFeatureLookupFlags::_get_IgnoreSpacingAdjustments() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("FontFeatureLookupFlags").WithContext("_get_IgnoreSpacingAdjustments");
...
void TMPro::FontFeatureLookupFlags::_set_IgnoreSpacingAdjustments(TMPro::FontFeatureLookupFlags value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("FontFeatureLookupFlags").WithContext("_set_IgnoreSpacingAdjustments");
