...
System::Func_2<TMPro::TMP_SpriteGlyph*, uint>* TMPro::TMP_SpriteAsset::$$c::_get_$$9__32_0() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("_get_$$9__32_0");
...
void TMPro::TMP_SpriteAsset::$$c::_set_$$9__32_0(System::Func_2<TMPro::TMP_SpriteGlyph*, uint>* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("_set_$$9__32_0");
...
System::Func_2<TMPro::TMP_SpriteCharacter*, uint>* TMPro::TMP_SpriteAsset::$$c::_get_$$9__33_0() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("_get_$$9__33_0");
...
void TMPro::TMP_SpriteAsset::$$c::_set_$$9__33_0(System::Func_2<TMPro::TMP_SpriteCharacter*, uint>* value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("_set_$$9__33_0");
...
void TMPro::TMP_SpriteAsset::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("TMPro", "TMP_SpriteAsset/<>c", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
...
uint TMPro::TMP_SpriteAsset::$$c::$SortGlyphTable$b__32_0(TMPro::TMP_SpriteGlyph* item) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("<SortGlyphTable>b__32_0");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<uint>(), "<SortGlyphTable>b__32_0", {}, ::il2cpp_utils::ExtractTypes(item))));
...
uint TMPro::TMP_SpriteAsset::$$c::$SortCharacterTable$b__33_0(TMPro::TMP_SpriteCharacter* c) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("$$c").WithContext("<SortCharacterTable>b__33_0");
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<uint>(), "<SortCharacterTable>b__33_0", {}, ::il2cpp_utils::ExtractTypes(c))));
