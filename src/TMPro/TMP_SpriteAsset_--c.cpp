...
void TMPro::TMP_SpriteAsset::$$c::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("TMPro", "TMP_SpriteAsset/<>c", ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
...
uint TMPro::TMP_SpriteAsset::$$c::$SortGlyphTable$b__32_0(TMPro::TMP_SpriteGlyph* item) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<SortGlyphTable>b__32_0", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item))));
...
uint TMPro::TMP_SpriteAsset::$$c::$SortCharacterTable$b__33_0(TMPro::TMP_SpriteCharacter* c) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<SortCharacterTable>b__33_0", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(c))));
