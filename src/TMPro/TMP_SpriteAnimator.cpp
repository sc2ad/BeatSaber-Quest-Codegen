...
void TMPro::TMP_SpriteAnimator::StopAllAnimations() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "StopAllAnimations", {}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
}
...
void TMPro::TMP_SpriteAnimator::DoSpriteAnimation(int currentCharacter, TMPro::TMP_SpriteAsset* spriteAsset, int start, int end, int framerate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "DoSpriteAnimation", {}, ::il2cpp_utils::ExtractTypes(currentCharacter, spriteAsset, start, end, framerate)));
...
System::Collections::IEnumerator* TMPro::TMP_SpriteAnimator::DoSpriteAnimationInternal(int currentCharacter, TMPro::TMP_SpriteAsset* spriteAsset, int start, int end, int framerate) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Collections::IEnumerator*>(), "DoSpriteAnimationInternal", {}, ::il2cpp_utils::ExtractTypes(currentCharacter, spriteAsset, start, end, framerate)));
...
TMPro::TMP_SpriteAnimator* TMPro::TMP_SpriteAnimator::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_SpriteAnimator").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TMP_SpriteAnimator*>());
}
