...
::Il2CppString* TMPro::TMP_Text::GetParsedText() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "GetParsedText"));
}
...
// ABORTED: conflicts with another method. UnityEngine::Transform* TMPro::TMP_Text::get_transform()
