...
TMPro::Compute_DistanceTransform_EventTypes TMPro::Compute_DistanceTransform_EventTypes::_get_Processing() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("Compute_DistanceTransform_EventTypes").WithContext("_get_Processing");
...
void TMPro::Compute_DistanceTransform_EventTypes::_set_Processing(TMPro::Compute_DistanceTransform_EventTypes value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("Compute_DistanceTransform_EventTypes").WithContext("_set_Processing");
...
TMPro::Compute_DistanceTransform_EventTypes TMPro::Compute_DistanceTransform_EventTypes::_get_Completed() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("Compute_DistanceTransform_EventTypes").WithContext("_get_Completed");
...
void TMPro::Compute_DistanceTransform_EventTypes::_set_Completed(TMPro::Compute_DistanceTransform_EventTypes value) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("Compute_DistanceTransform_EventTypes").WithContext("_set_Completed");
