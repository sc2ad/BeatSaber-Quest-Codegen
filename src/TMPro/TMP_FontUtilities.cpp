...
TMPro::TMP_FontAsset* TMPro::TMP_FontUtilities::SearchForCharacter(TMPro::TMP_FontAsset* font, uint unicode, TMPro::TMP_Character*& character) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_FontAsset*>(), "SearchForCharacter", {}, ::il2cpp_utils::ExtractTypes(font, unicode, character)));
...
TMPro::TMP_FontAsset* TMPro::TMP_FontUtilities::SearchForCharacter(System::Collections::Generic::List_1<TMPro::TMP_FontAsset*>* fonts, uint unicode, TMPro::TMP_Character*& character) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_FontUtilities").WithContext("SearchForCharacter");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_FontAsset*>(), "SearchForCharacter", {}, ::il2cpp_utils::ExtractTypes(fonts, unicode, character)));
...
TMPro::TMP_FontAsset* TMPro::TMP_FontUtilities::SearchForCharacterInternal(TMPro::TMP_FontAsset* font, uint unicode, TMPro::TMP_Character*& character) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_FontAsset*>(), "SearchForCharacterInternal", {}, ::il2cpp_utils::ExtractTypes(font, unicode, character)));
  return ::il2cpp_utils::RunMethodThrow<TMPro::TMP_FontAsset*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, font, unicode, character);
}
// Autogenerated method: TMPro.TMP_FontUtilities.SearchForCharacterInternal
TMPro::TMP_FontAsset* TMPro::TMP_FontUtilities::SearchForCharacterInternal(System::Collections::Generic::List_1<TMPro::TMP_FontAsset*>* fonts, uint unicode, TMPro::TMP_Character*& character) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_FontUtilities").WithContext("SearchForCharacterInternal");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_FontAsset*>(), "SearchForCharacterInternal", {}, ::il2cpp_utils::ExtractTypes(fonts, unicode, character)));
  return ::il2cpp_utils::RunMethodThrow<TMPro::TMP_FontAsset*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, fonts, unicode, character);
}
