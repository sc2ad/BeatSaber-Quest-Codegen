...
void TMPro::TMP_FontAssetUtilities::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
TMPro::TMP_FontAssetUtilities* TMPro::TMP_FontAssetUtilities::get_instance() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_FontAssetUtilities*>(), "get_instance", {}, ::il2cpp_utils::ExtractTypes()));
...
TMPro::TMP_Character* TMPro::TMP_FontAssetUtilities::GetCharacterFromFontAsset(uint unicode, TMPro::TMP_FontAsset* sourceFontAsset, bool includeFallbacks, TMPro::FontStyles fontStyle, TMPro::FontWeight fontWeight, bool& isAlternativeTypeface, TMPro::TMP_FontAsset*& fontAsset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_Character*>(), "GetCharacterFromFontAsset", {}, ::il2cpp_utils::ExtractTypes(unicode, sourceFontAsset, includeFallbacks, fontStyle, fontWeight, isAlternativeTypeface, fontAsset)));
...
TMPro::TMP_Character* TMPro::TMP_FontAssetUtilities::GetCharacterFromFontAsset_Internal(uint unicode, TMPro::TMP_FontAsset* sourceFontAsset, bool includeFallbacks, TMPro::FontStyles fontStyle, TMPro::FontWeight fontWeight, bool& isAlternativeTypeface, TMPro::TMP_FontAsset*& fontAsset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_Character*>(), "GetCharacterFromFontAsset_Internal", {}, ::il2cpp_utils::ExtractTypes(unicode, sourceFontAsset, includeFallbacks, fontStyle, fontWeight, isAlternativeTypeface, fontAsset)));
  return ::il2cpp_utils::RunMethodThrow<TMPro::TMP_Character*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, unicode, sourceFontAsset, includeFallbacks, fontStyle, fontWeight, isAlternativeTypeface, fontAsset);
}
...
TMPro::TMP_Character* TMPro::TMP_FontAssetUtilities::GetCharacterFromFontAssets(uint unicode, System::Collections::Generic::List_1<TMPro::TMP_FontAsset*>* fontAssets, bool includeFallbacks, TMPro::FontStyles fontStyle, TMPro::FontWeight fontWeight, bool& isAlternativeTypeface, TMPro::TMP_FontAsset*& fontAsset) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<TMPro::TMP_Character*>(), "GetCharacterFromFontAssets", {}, ::il2cpp_utils::ExtractTypes(unicode, fontAssets, includeFallbacks, fontStyle, fontWeight, isAlternativeTypeface, fontAsset)));
...
bool TMPro::TMP_FontAssetUtilities::TryGetCharacterFromFontFile(uint unicode, TMPro::TMP_FontAsset* fontAsset, TMPro::TMP_Character*& character) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<bool>(), "TryGetCharacterFromFontFile", {}, ::il2cpp_utils::ExtractTypes(unicode, fontAsset, character)));
...
bool TMPro::TMP_FontAssetUtilities::TryGetGlyphFromFontFile(uint glyphIndex, TMPro::TMP_FontAsset* fontAsset, UnityEngine::TextCore::Glyph*& glyph) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_FontAssetUtilities", il2cpp_utils::NoArgClass<bool>(), "TryGetGlyphFromFontFile", {}, ::il2cpp_utils::ExtractTypes(glyphIndex, fontAsset, glyph)));
...
TMPro::TMP_FontAssetUtilities* TMPro::TMP_FontAssetUtilities::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_FontAssetUtilities").WithContext(".ctor");
  return THROW_UNLESS(::il2cpp_utils::New<TMP_FontAssetUtilities*>());
}
