...
::CsString* TMPro::TMPro_ExtensionMethods::ArrayToString(::Array<::Il2CppChar>* chars) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("TMPro", "TMPro_ExtensionMethods", "ArrayToString", chars));
}
// Autogenerated method: TMPro.TMPro_ExtensionMethods.IntToString
::CsString* TMPro::TMPro_ExtensionMethods::IntToString(::Array<int>* unicodes) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("TMPro", "TMPro_ExtensionMethods", "IntToString", unicodes));
}
// Autogenerated method: TMPro.TMPro_ExtensionMethods.IntToString
::CsString* TMPro::TMPro_ExtensionMethods::IntToString(::Array<int>* unicodes, int start, int length) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("TMPro", "TMPro_ExtensionMethods", "IntToString", unicodes, start, length));
}
