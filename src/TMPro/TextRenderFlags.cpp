...
TMPro::TextRenderFlags TMPro::TextRenderFlags::_get_DontRender() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TextRenderFlags").WithContext("_get_DontRender");
...
void TMPro::TextRenderFlags::_set_DontRender(TMPro::TextRenderFlags value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TextRenderFlags").WithContext("_set_DontRender");
...
TMPro::TextRenderFlags TMPro::TextRenderFlags::_get_Render() {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TextRenderFlags").WithContext("_get_Render");
...
void TMPro::TextRenderFlags::_set_Render(TMPro::TextRenderFlags value) {
  static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TextRenderFlags").WithContext("_set_Render");
