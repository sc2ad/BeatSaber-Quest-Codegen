...
bool TMPro::TMP_MaterialManager::$$c__DisplayClass12_0::$AddMaskingMaterial$b__0(TMPro::TMP_MaterialManager::MaskingMaterial* item) {
  return THROW_UNLESS((il2cpp_utils::RunMethod<bool>(this, "<AddMaskingMaterial>b__0", item)));
}
...
TMPro::TMP_MaterialManager::$$c__DisplayClass12_0* TMPro::TMP_MaterialManager::$$c__DisplayClass12_0::New_ctor() {
  return (TMP_MaterialManager::$$c__DisplayClass12_0*)THROW_UNLESS(il2cpp_utils::New("TMPro", "TMP_MaterialManager/<>c__DisplayClass12_0"));
}
