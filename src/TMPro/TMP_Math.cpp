...
bool TMPro::TMP_Math::Approximately(float a, float b) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_Math", il2cpp_utils::NoArgClass<bool>(), "Approximately", {}, ::il2cpp_utils::ExtractTypes(a, b)));
...
void TMPro::TMP_Math::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_Math", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
