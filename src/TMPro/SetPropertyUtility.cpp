...
bool TMPro::SetPropertyUtility::SetColor(UnityEngine::Color& currentValue, UnityEngine::Color newValue) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "SetPropertyUtility", il2cpp_utils::NoArgClass<bool>(), "SetColor", {}, ::il2cpp_utils::ExtractTypes(currentValue, newValue)));
