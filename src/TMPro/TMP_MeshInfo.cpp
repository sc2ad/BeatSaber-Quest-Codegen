...
void TMPro::TMP_MeshInfo::ResizeMeshInfo(int size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "ResizeMeshInfo", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(size)));
...
void TMPro::TMP_MeshInfo::ResizeMeshInfo(int size, bool isVolumetric) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_MeshInfo").WithContext("ResizeMeshInfo");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "ResizeMeshInfo", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(size, isVolumetric)));
...
void TMPro::TMP_MeshInfo::Clear(bool uploadChanges) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_MeshInfo").WithContext("Clear");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "Clear", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(uploadChanges)));
...
void TMPro::TMP_MeshInfo::ClearUnusedVertices() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "ClearUnusedVertices", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
  ::il2cpp_utils::RunMethodThrow<void, false>(*this, ___internal__method);
}
// Autogenerated method: TMPro.TMP_MeshInfo.ClearUnusedVertices
void TMPro::TMP_MeshInfo::ClearUnusedVertices(int startIndex) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_MeshInfo").WithContext("ClearUnusedVertices");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "ClearUnusedVertices", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(startIndex)));
...
void TMPro::TMP_MeshInfo::ClearUnusedVertices(int startIndex, bool updateMesh) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_MeshInfo").WithContext("ClearUnusedVertices");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "ClearUnusedVertices", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(startIndex, updateMesh)));
...
void TMPro::TMP_MeshInfo::SortGeometry(TMPro::VertexSortingOrder order) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "SortGeometry", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(order)));
...
void TMPro::TMP_MeshInfo::SortGeometry(System::Collections::Generic::IList_1<int>* sortingOrder) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("TMPro").WithContext("TMP_MeshInfo").WithContext("SortGeometry");
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "SortGeometry", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(sortingOrder)));
...
void TMPro::TMP_MeshInfo::SwapVertexData(int src, int dst) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "SwapVertexData", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(src, dst)));
...
void TMPro::TMP_MeshInfo::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("TMPro", "TMP_MeshInfo", ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
