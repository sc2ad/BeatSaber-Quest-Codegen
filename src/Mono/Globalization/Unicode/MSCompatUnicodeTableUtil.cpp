...
void Mono::Globalization::Unicode::MSCompatUnicodeTableUtil::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Globalization.Unicode", "MSCompatUnicodeTableUtil", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
