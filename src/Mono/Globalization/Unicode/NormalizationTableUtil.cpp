...
void Mono::Globalization::Unicode::NormalizationTableUtil::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Globalization.Unicode", "NormalizationTableUtil", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
...
int Mono::Globalization::Unicode::NormalizationTableUtil::PropIdx(int cp) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Globalization.Unicode", "NormalizationTableUtil", il2cpp_utils::NoArgClass<int>(), "PropIdx", {}, ::il2cpp_utils::ExtractTypes(cp)));
...
int Mono::Globalization::Unicode::NormalizationTableUtil::MapIdx(int cp) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Globalization.Unicode", "NormalizationTableUtil", il2cpp_utils::NoArgClass<int>(), "MapIdx", {}, ::il2cpp_utils::ExtractTypes(cp)));
  return ::il2cpp_utils::RunMethodThrow<int, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, cp);
}
