...
void Mono::Xml::SmallXmlParser::AttrListImpl::Add(::CsString* name, ::CsString* value) {
...
::CsString* Mono::Xml::SmallXmlParser::AttrListImpl::GetName(int i) {
...
::CsString* Mono::Xml::SmallXmlParser::AttrListImpl::GetValue(int i) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "GetValue", i));
}
// Autogenerated method: Mono.Xml.SmallXmlParser/AttrListImpl.GetValue
::CsString* Mono::Xml::SmallXmlParser::AttrListImpl::GetValue(::CsString* name) {
...
::Array<::CsString*>* Mono::Xml::SmallXmlParser::AttrListImpl::get_Names() {
...
::Array<::CsString*>* Mono::Xml::SmallXmlParser::AttrListImpl::get_Values() {
