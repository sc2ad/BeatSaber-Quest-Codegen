...
void Mono::Xml::SecurityParser::LoadXml(::CsString* xml) {
...
void Mono::Xml::SecurityParser::OnProcessingInstruction(::CsString* name, ::CsString* text) {
...
void Mono::Xml::SecurityParser::OnIgnorableWhitespace(::CsString* s) {
...
void Mono::Xml::SecurityParser::OnStartElement(::CsString* name, Mono::Xml::SmallXmlParser::IAttrList* attrs) {
