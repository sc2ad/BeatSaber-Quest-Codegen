...
void Mono::Xml::SmallXmlParser::IContentHandler::OnChars(::Il2CppString* text) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnChars", {}, ::il2cpp_utils::ExtractTypes(text)));
...
void Mono::Xml::SmallXmlParser::IContentHandler::OnIgnorableWhitespace(::Il2CppString* text) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "OnIgnorableWhitespace", {}, ::il2cpp_utils::ExtractTypes(text)));
  ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, text);
}
