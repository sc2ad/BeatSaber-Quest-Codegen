...
bool Mono::Net::CFNumber::CFNumberGetValue(System::IntPtr handle, System::IntPtr type, int& value) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net", "CFNumber", il2cpp_utils::NoArgClass<bool>(), "CFNumberGetValue", {}, ::il2cpp_utils::ExtractTypes(handle, type, value)));
...
int Mono::Net::CFNumber::AsInt32(System::IntPtr handle) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net", "CFNumber", il2cpp_utils::NoArgClass<int>(), "AsInt32", {}, ::il2cpp_utils::ExtractTypes(handle)));
