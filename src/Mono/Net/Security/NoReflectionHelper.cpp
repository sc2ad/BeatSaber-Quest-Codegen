...
::Il2CppObject* Mono::Net::Security::NoReflectionHelper::GetInternalValidator(::Il2CppObject* provider, ::Il2CppObject* settings) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net.Security", "NoReflectionHelper", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "GetInternalValidator", {}, ::il2cpp_utils::ExtractTypes(provider, settings)));
...
::Il2CppObject* Mono::Net::Security::NoReflectionHelper::GetProvider() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net.Security", "NoReflectionHelper", il2cpp_utils::NoArgClass<::Il2CppObject*>(), "GetProvider", {}, ::il2cpp_utils::ExtractTypes()));
