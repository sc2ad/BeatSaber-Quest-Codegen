...
Mono::Security::Interface::MonoRemoteCertificateValidationCallback* Mono::Net::Security::Private::CallbackHelpers::PublicToMono(System::Net::Security::RemoteCertificateValidationCallback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net.Security.Private", "CallbackHelpers", il2cpp_utils::NoArgClass<Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(), "PublicToMono", {}, ::il2cpp_utils::ExtractTypes(callback)));
...
System::Net::Security::RemoteCertificateValidationCallback* Mono::Net::Security::Private::CallbackHelpers::MonoToPublic(Mono::Security::Interface::MonoRemoteCertificateValidationCallback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net.Security.Private", "CallbackHelpers", il2cpp_utils::NoArgClass<System::Net::Security::RemoteCertificateValidationCallback*>(), "MonoToPublic", {}, ::il2cpp_utils::ExtractTypes(callback)));
...
System::Net::Security::LocalCertSelectionCallback* Mono::Net::Security::Private::CallbackHelpers::MonoToInternal(Mono::Security::Interface::MonoLocalCertificateSelectionCallback* callback) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Net.Security.Private", "CallbackHelpers", il2cpp_utils::NoArgClass<System::Net::Security::LocalCertSelectionCallback*>(), "MonoToInternal", {}, ::il2cpp_utils::ExtractTypes(callback)));
