...
bool Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass5_0::$MonoToPublic$b__0(::Il2CppObject* t, System::Security::Cryptography::X509Certificates::X509Certificate* c, System::Security::Cryptography::X509Certificates::X509Chain* ch, System::Net::Security::SslPolicyErrors e) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<MonoToPublic>b__0", {}, ::il2cpp_utils::ExtractTypes(t, c, ch, e))));
...
Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass5_0* Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass5_0::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Mono::Net::Security::Private").WithContext("$$c__DisplayClass5_0").WithContext(".ctor");
