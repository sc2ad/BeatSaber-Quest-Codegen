...
System::Security::Cryptography::X509Certificates::X509Certificate* Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass8_0::$MonoToInternal$b__0(::Il2CppString* t, System::Security::Cryptography::X509Certificates::X509CertificateCollection* lc, System::Security::Cryptography::X509Certificates::X509Certificate* rc, ::Array<::Il2CppString*>* ai) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Security::Cryptography::X509Certificates::X509Certificate*>(), "<MonoToInternal>b__0", {}, ::il2cpp_utils::ExtractTypes(t, lc, rc, ai))));
...
Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass8_0* Mono::Net::Security::Private::CallbackHelpers::$$c__DisplayClass8_0::New_ctor() {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Mono::Net::Security::Private").WithContext("$$c__DisplayClass8_0").WithContext(".ctor");
