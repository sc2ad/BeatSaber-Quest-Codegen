...
Mono::Unity::UnityTls::unitytls_protocol Mono::Unity::UnityTlsConversions::GetMinProtocol(System::Security::Authentication::SslProtocols protocols) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Unity", "UnityTlsConversions", il2cpp_utils::NoArgClass<Mono::Unity::UnityTls::unitytls_protocol>(), "GetMinProtocol", {}, ::il2cpp_utils::ExtractTypes(protocols)));
...
Mono::Unity::UnityTls::unitytls_protocol Mono::Unity::UnityTlsConversions::GetMaxProtocol(System::Security::Authentication::SslProtocols protocols) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Unity", "UnityTlsConversions", il2cpp_utils::NoArgClass<Mono::Unity::UnityTls::unitytls_protocol>(), "GetMaxProtocol", {}, ::il2cpp_utils::ExtractTypes(protocols)));
  return ::il2cpp_utils::RunMethodThrow<Mono::Unity::UnityTls::unitytls_protocol, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, protocols);
}
...
Mono::Security::Interface::TlsProtocols Mono::Unity::UnityTlsConversions::ConvertProtocolVersion(Mono::Unity::UnityTls::unitytls_protocol protocol) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Unity", "UnityTlsConversions", il2cpp_utils::NoArgClass<Mono::Security::Interface::TlsProtocols>(), "ConvertProtocolVersion", {}, ::il2cpp_utils::ExtractTypes(protocol)));
...
Mono::Security::Interface::AlertDescription Mono::Unity::UnityTlsConversions::VerifyResultToAlertDescription(Mono::Unity::UnityTls::unitytls_x509verify_result verifyResult, Mono::Security::Interface::AlertDescription defaultAlert) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Unity", "UnityTlsConversions", il2cpp_utils::NoArgClass<Mono::Security::Interface::AlertDescription>(), "VerifyResultToAlertDescription", {}, ::il2cpp_utils::ExtractTypes(verifyResult, defaultAlert)));
...
Mono::Security::Interface::MonoSslPolicyErrors Mono::Unity::UnityTlsConversions::VerifyResultToPolicyErrror(Mono::Unity::UnityTls::unitytls_x509verify_result verifyResult) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Unity", "UnityTlsConversions", il2cpp_utils::NoArgClass<Mono::Security::Interface::MonoSslPolicyErrors>(), "VerifyResultToPolicyErrror", {}, ::il2cpp_utils::ExtractTypes(verifyResult)));
