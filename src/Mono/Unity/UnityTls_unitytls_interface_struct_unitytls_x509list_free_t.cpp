...
// Completed includes
// Autogenerated method: Mono.Unity.UnityTls/unitytls_interface_struct/unitytls_x509list_free_t..ctor
Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_x509list_free_t* Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_x509list_free_t::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  ...
  return THROW_UNLESS(::il2cpp_utils::New<UnityTls::unitytls_interface_struct::unitytls_x509list_free_t*>(object, method));
}
...
void Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_x509list_free_t::Invoke(Mono::Unity::UnityTls::unitytls_x509list* list) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(list)));
...
System::IAsyncResult* Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_x509list_free_t::BeginInvoke(Mono::Unity::UnityTls::unitytls_x509list* list, System::AsyncCallback* callback, ::Il2CppObject* object) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::IAsyncResult*>(), "BeginInvoke", {}, ::il2cpp_utils::ExtractTypes(list, callback, object)));
