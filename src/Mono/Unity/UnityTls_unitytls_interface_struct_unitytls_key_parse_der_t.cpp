...
// Completed includes
// Autogenerated method: Mono.Unity.UnityTls/unitytls_interface_struct/unitytls_key_parse_der_t..ctor
Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_key_parse_der_t* Mono::Unity::UnityTls::unitytls_interface_struct::unitytls_key_parse_der_t::New_ctor(::Il2CppObject* object, System::IntPtr method) {
  return THROW_UNLESS(il2cpp_utils::New<UnityTls::unitytls_interface_struct::unitytls_key_parse_der_t*>(object, method));
}
