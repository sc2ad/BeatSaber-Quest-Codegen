...
Mono::Security::Cryptography::RC4* Mono::Security::Cryptography::RC4::Create() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "RC4", il2cpp_utils::NoArgClass<Mono::Security::Cryptography::RC4*>(), "Create", {}, ::il2cpp_utils::ExtractTypes()));
...
void Mono::Security::Cryptography::RC4::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "RC4", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
