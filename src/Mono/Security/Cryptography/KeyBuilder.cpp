...
System::Security::Cryptography::RandomNumberGenerator* Mono::Security::Cryptography::KeyBuilder::get_Rng() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "KeyBuilder", il2cpp_utils::NoArgClass<System::Security::Cryptography::RandomNumberGenerator*>(), "get_Rng", {}, ::il2cpp_utils::ExtractTypes()));
...
::Array<uint8_t>* Mono::Security::Cryptography::KeyBuilder::Key(int size) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "KeyBuilder", il2cpp_utils::NoArgClass<::Array<uint8_t>*>(), "Key", {}, ::il2cpp_utils::ExtractTypes(size)));
