...
::Il2CppString* Mono::Security::Cryptography::PKCS1::HashNameFromOid(::Il2CppString* oid, bool throwOnError) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "PKCS1", il2cpp_utils::NoArgClass<::Il2CppString*>(), "HashNameFromOid", {}, ::il2cpp_utils::ExtractTypes(oid, throwOnError)));
...
System::Security::Cryptography::HashAlgorithm* Mono::Security::Cryptography::PKCS1::CreateFromOid(::Il2CppString* oid) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "PKCS1", il2cpp_utils::NoArgClass<System::Security::Cryptography::HashAlgorithm*>(), "CreateFromOid", {}, ::il2cpp_utils::ExtractTypes(oid)));
...
System::Security::Cryptography::HashAlgorithm* Mono::Security::Cryptography::PKCS1::CreateFromName(::Il2CppString* name) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "PKCS1", il2cpp_utils::NoArgClass<System::Security::Cryptography::HashAlgorithm*>(), "CreateFromName", {}, ::il2cpp_utils::ExtractTypes(name)));
...
void Mono::Security::Cryptography::PKCS1::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Cryptography", "PKCS1", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
