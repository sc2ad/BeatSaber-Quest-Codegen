...
Mono::Security::Protocol::Ntlm::NtlmAuthLevel Mono::Security::Protocol::Ntlm::NtlmSettings::get_DefaultAuthLevel() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Protocol.Ntlm", "NtlmSettings", il2cpp_utils::NoArgClass<Mono::Security::Protocol::Ntlm::NtlmAuthLevel>(), "get_DefaultAuthLevel", {}, ::il2cpp_utils::ExtractTypes()));
...
void Mono::Security::Protocol::Ntlm::NtlmSettings::_cctor() {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Mono.Security.Protocol.Ntlm", "NtlmSettings", il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes()));
