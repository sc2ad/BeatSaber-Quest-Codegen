...
::CsString* Mono::RuntimeMarshal::PtrToUtf8String(System::IntPtr ptr) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Mono", "RuntimeMarshal", "PtrToUtf8String", ptr));
}
// Autogenerated method: Mono.RuntimeMarshal.MarshalString
Mono::SafeStringMarshal Mono::RuntimeMarshal::MarshalString(::CsString* str) {
