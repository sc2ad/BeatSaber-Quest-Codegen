...
Mono::RuntimePropertyHandle* Mono::RuntimePropertyHandle::New_ctor(System::IntPtr v) {
  return (RuntimePropertyHandle*)THROW_UNLESS(il2cpp_utils::New("Mono", "RuntimePropertyHandle", v));
}
...
bool Mono::RuntimePropertyHandle::Equals(::CsObject* obj) {
