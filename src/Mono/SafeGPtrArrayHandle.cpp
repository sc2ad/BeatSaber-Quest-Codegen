...
Mono::SafeGPtrArrayHandle* Mono::SafeGPtrArrayHandle::New_ctor(System::IntPtr ptr) {
  return (SafeGPtrArrayHandle*)THROW_UNLESS(il2cpp_utils::New("Mono", "SafeGPtrArrayHandle", ptr));
}
