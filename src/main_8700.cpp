...
int UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::_get_$UnityEngine.ResourceManagement.AsyncOperations.ICachable.Hash$k__BackingField() {
  static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::_get_$UnityEngine.ResourceManagement.AsyncOperations.ICachable.Hash$k__BackingField");
  static auto ___internal__instance = this;
...
void UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::_set_$UnityEngine.ResourceManagement.AsyncOperations.ICachable.Hash$k__BackingField(int value) {
  static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::_set_$UnityEngine.ResourceManagement.AsyncOperations.ICachable.Hash$k__BackingField");
  static auto ___internal__instance = this;
