...
System::Collections::IEnumerator* Polyglot::GoogleDownload::DownloadSheet(::Il2CppString* docsId, ::Il2CppString* sheetId, System::Action_1<::Il2CppString*>* done, Polyglot::GoogleDriveDownloadFormat format, System::Func_2<float, bool>* progressbar) {
  ...
  static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("Polyglot", "GoogleDownload", il2cpp_utils::NoArgClass<System::Collections::IEnumerator*>(), "DownloadSheet", {}, ::il2cpp_utils::ExtractTypes(docsId, sheetId, done, format, progressbar)));
