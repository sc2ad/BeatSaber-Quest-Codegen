...
::CsString* Polyglot::Localization::_get_KeyNotFound() {
  return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsString*>("Polyglot", "Localization", "KeyNotFound"));
}
// Autogenerated static field setter
// Set static field: static private System.String KeyNotFound
void Polyglot::Localization::_set_KeyNotFound(::CsString* value) {
...
System::Collections::Generic::List_1<::CsString*>* Polyglot::Localization::get_EnglishLanguageNames() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>(this, "get_EnglishLanguageNames"));
}
// Autogenerated method: Polyglot.Localization.get_LocalizedLanguageNames
System::Collections::Generic::List_1<::CsString*>* Polyglot::Localization::get_LocalizedLanguageNames() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>(this, "get_LocalizedLanguageNames"));
}
// Autogenerated method: Polyglot.Localization.get_EnglishLanguageName
::CsString* Polyglot::Localization::get_EnglishLanguageName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_EnglishLanguageName"));
}
// Autogenerated method: Polyglot.Localization.get_LocalizedLanguageName
::CsString* Polyglot::Localization::get_LocalizedLanguageName() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>(this, "get_LocalizedLanguageName"));
}
...
::CsString* Polyglot::Localization::Get(::CsString* key) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Polyglot", "Localization", "Get", key));
}
// Autogenerated method: Polyglot.Localization.Get
::CsString* Polyglot::Localization::Get(::CsString* key, Polyglot::Language language) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Polyglot", "Localization", "Get", key, language));
}
// Autogenerated method: Polyglot.Localization.KeyExist
bool Polyglot::Localization::KeyExist(::CsString* key) {
...
System::Collections::Generic::List_1<::CsString*>* Polyglot::Localization::GetKeys() {
  return THROW_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<::CsString*>*>("Polyglot", "Localization", "GetKeys"));
}
// Autogenerated method: Polyglot.Localization.GetFormat
::CsString* Polyglot::Localization::GetFormat(::CsString* key, ::Array<::CsObject*>* arguments) {
  return THROW_UNLESS(il2cpp_utils::RunMethod<::CsString*>("Polyglot", "Localization", "GetFormat", key, arguments));
}
