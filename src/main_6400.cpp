...
::Array<Oculus::Platform::Matchmaking::CustomQuery::Criterion>*& Oculus::Platform::Matchmaking::CustomQuery::dyn_criteria() {
...
::Array<float>*& Oculus::Platform::VoipAudioSourceHiLevel::FilterReadDelegate::dyn_scratchBuffer() {
