...
float GlobalNamespace::BeatmapDataLoader::$GetBeatmapDataFromBeatmapSaveData$g__ProcessTime_2_4(float bpmTime, ByRef<GlobalNamespace::BeatmapDataLoader::$$c__DisplayClass2_0> param_0001016b) {
  ...
  static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<GetBeatmapDataFromBeatmapSaveData>g__ProcessTime|2_4", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(bpmTime), ::il2cpp_utils::ExtractType(param_0001016b)})));
  auto ___instance_arg = this;
  return ::il2cpp_utils::RunMethodThrow<float, false>(___instance_arg, ___internal__method, bpmTime, byref(param_0001016b));
}
// Autogenerated from CppSourceCreator
// Created by Sc2ad
// =========================================================================
