...
GlobalNamespace::LightmapLightWithIds*& GlobalNamespace::LightBakingPersistentSettingsSO::dyn__lightmapLightWithIds() {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::LightBakingPersistentSettingsSO::dyn__lightmapLightWithIds");
  auto ___internal__instance = this;
