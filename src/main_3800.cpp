...
::Il2CppString* GlobalNamespace::AnnotatedBeatmapLevelCollectionCell::GetInfoText(::Il2CppString* name, int songs, int purchased) {
  ...
  return ::il2cpp_utils::RunMethodRethrow<::Il2CppString*, false>(this, ___internal__method, name, songs, purchased);
}
...
Tweening::EaseType GlobalNamespace::BaseTransitionSO::get_easeType() {
  ...
  return ::il2cpp_utils::RunMethodRethrow<Tweening::EaseType, false>(this, ___internal__method);
}
