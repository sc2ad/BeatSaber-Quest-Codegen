...
::Il2CppString*& GlobalNamespace::InMultiplayerRichPresenceData::dyn_$multiplayerLobbyCode$k__BackingField() {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::InMultiplayerRichPresenceData::dyn_$multiplayerLobbyCode$k__BackingField");
  auto ___internal__instance = this;
...
GlobalNamespace::PlayerDataModel*& GlobalNamespace::RichPresenceManager::dyn__playerDataModel() {
  static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RichPresenceManager::dyn__playerDataModel");
  auto ___internal__instance = this;
