...
Zenject::ISubContainerCreator* Zenject::SubContainerBinder::$$c__DisplayClass15_0::$ByNewGameObjectInstaller$b__0(Zenject::DiContainer* container) {
  static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass15_0").WithContext("<ByNewGameObjectInstaller>b__0");
