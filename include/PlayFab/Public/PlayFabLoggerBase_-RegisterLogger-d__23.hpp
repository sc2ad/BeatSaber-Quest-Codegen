...
namespace PlayFab::Public {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.Public.PlayFabLoggerBase/PlayFab.Public.<RegisterLogger>d__23
  ...
  }; // PlayFab.Public.PlayFabLoggerBase/PlayFab.Public.<RegisterLogger>d__23
  #pragma pack(pop)
