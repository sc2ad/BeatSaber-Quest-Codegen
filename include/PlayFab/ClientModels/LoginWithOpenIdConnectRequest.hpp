...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithOpenIdConnectRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithOpenIdConnectRequest*, "PlayFab.ClientModels", "LoginWithOpenIdConnectRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithOpenIdConnectRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithOpenIdConnectRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithOpenIdConnectRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithOpenIdConnectRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithOpenIdConnectRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithOpenIdConnectRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithOpenIdConnectRequest::New_ctor
// Il2CppName: .ctor
