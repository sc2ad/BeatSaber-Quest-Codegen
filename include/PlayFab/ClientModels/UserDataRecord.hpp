...
NEED_NO_BOX(::PlayFab::ClientModels::UserDataRecord);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::UserDataRecord*, "PlayFab.ClientModels", "UserDataRecord");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.UserDataRecord
  // [TokenAttribute] Offset: FFFFFFFF
  class UserDataRecord : public ::PlayFab::SharedModels::PlayFabBaseModel {
    public:
    public:
    ...
    static UserDataRecord* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::UserDataRecord::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UserDataRecord*, creationType>()));
    }
  }; // PlayFab.ClientModels.UserDataRecord
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::UserDataRecord::New_ctor
// Il2CppName: .ctor
