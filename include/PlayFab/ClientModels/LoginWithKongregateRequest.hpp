...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithKongregateRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithKongregateRequest*, "PlayFab.ClientModels", "LoginWithKongregateRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithKongregateRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithKongregateRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithKongregateRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithKongregateRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithKongregateRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithKongregateRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithKongregateRequest::New_ctor
// Il2CppName: .ctor
