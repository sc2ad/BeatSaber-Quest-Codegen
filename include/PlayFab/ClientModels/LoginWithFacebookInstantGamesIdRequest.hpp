...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithFacebookInstantGamesIdRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithFacebookInstantGamesIdRequest*, "PlayFab.ClientModels", "LoginWithFacebookInstantGamesIdRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithFacebookInstantGamesIdRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithFacebookInstantGamesIdRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithFacebookInstantGamesIdRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithFacebookInstantGamesIdRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithFacebookInstantGamesIdRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithFacebookInstantGamesIdRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithFacebookInstantGamesIdRequest::New_ctor
// Il2CppName: .ctor
