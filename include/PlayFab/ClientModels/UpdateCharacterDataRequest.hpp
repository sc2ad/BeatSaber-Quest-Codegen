...
NEED_NO_BOX(::PlayFab::ClientModels::UpdateCharacterDataRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::UpdateCharacterDataRequest*, "PlayFab.ClientModels", "UpdateCharacterDataRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.UpdateCharacterDataRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class UpdateCharacterDataRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static UpdateCharacterDataRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::UpdateCharacterDataRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UpdateCharacterDataRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.UpdateCharacterDataRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::UpdateCharacterDataRequest::New_ctor
// Il2CppName: .ctor
