...
NEED_NO_BOX(::PlayFab::ClientModels::LoginWithXboxRequest);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ClientModels::LoginWithXboxRequest*, "PlayFab.ClientModels", "LoginWithXboxRequest");
// Type namespace: PlayFab.ClientModels
namespace PlayFab::ClientModels {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.ClientModels.LoginWithXboxRequest
  // [TokenAttribute] Offset: FFFFFFFF
  class LoginWithXboxRequest : public ::PlayFab::SharedModels::PlayFabRequestCommon {
    public:
    public:
    ...
    static LoginWithXboxRequest* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ClientModels::LoginWithXboxRequest::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LoginWithXboxRequest*, creationType>()));
    }
  }; // PlayFab.ClientModels.LoginWithXboxRequest
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ClientModels::LoginWithXboxRequest::New_ctor
// Il2CppName: .ctor
