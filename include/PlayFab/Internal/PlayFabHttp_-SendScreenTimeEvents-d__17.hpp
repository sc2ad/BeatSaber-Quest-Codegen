...
namespace PlayFab::Internal {
  // Size: 0x30
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.Internal.PlayFabHttp/PlayFab.Internal.<SendScreenTimeEvents>d__17
  ...
  }; // PlayFab.Internal.PlayFabHttp/PlayFab.Internal.<SendScreenTimeEvents>d__17
  #pragma pack(pop)
