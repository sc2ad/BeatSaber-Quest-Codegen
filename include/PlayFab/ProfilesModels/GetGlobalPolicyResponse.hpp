...
NEED_NO_BOX(::PlayFab::ProfilesModels::GetGlobalPolicyResponse);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::ProfilesModels::GetGlobalPolicyResponse*, "PlayFab.ProfilesModels", "GetGlobalPolicyResponse");
// Type namespace: PlayFab.ProfilesModels
namespace PlayFab::ProfilesModels {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.ProfilesModels.GetGlobalPolicyResponse
  // [TokenAttribute] Offset: FFFFFFFF
  class GetGlobalPolicyResponse : public ::PlayFab::SharedModels::PlayFabResultCommon {
    public:
    public:
    ...
    static GetGlobalPolicyResponse* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::ProfilesModels::GetGlobalPolicyResponse::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<GetGlobalPolicyResponse*, creationType>()));
    }
  }; // PlayFab.ProfilesModels.GetGlobalPolicyResponse
  #pragma pack(pop)
  static check_size<sizeof(GetGlobalPolicyResponse), 32 + sizeof(::System::Collections::Generic::List_1<::PlayFab::ProfilesModels::EntityPermissionStatement*>*)> __PlayFab_ProfilesModels_GetGlobalPolicyResponseSizeCheck;
  static_assert(sizeof(GetGlobalPolicyResponse) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::ProfilesModels::GetGlobalPolicyResponse::New_ctor
// Il2CppName: .ctor
