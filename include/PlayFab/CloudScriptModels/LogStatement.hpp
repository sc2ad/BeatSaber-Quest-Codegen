...
NEED_NO_BOX(::PlayFab::CloudScriptModels::LogStatement);
DEFINE_IL2CPP_ARG_TYPE(::PlayFab::CloudScriptModels::LogStatement*, "PlayFab.CloudScriptModels", "LogStatement");
// Type namespace: PlayFab.CloudScriptModels
namespace PlayFab::CloudScriptModels {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: PlayFab.CloudScriptModels.LogStatement
  ...
  class LogStatement : public ::PlayFab::SharedModels::PlayFabBaseModel {
    ...
    static LogStatement* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::CloudScriptModels::LogStatement::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LogStatement*, creationType>()));
    }
  }; // PlayFab.CloudScriptModels.LogStatement
  #pragma pack(pop)
  static check_size<sizeof(LogStatement), 32 + sizeof(::StringW)> __PlayFab_CloudScriptModels_LogStatementSizeCheck;
  static_assert(sizeof(LogStatement) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: PlayFab::CloudScriptModels::LogStatement::New_ctor
// Il2CppName: .ctor
