...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::PlayFab::PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1, "PlayFab", "PlayFabClientInstanceAPI/<>c__DisplayClass24_0`1");
// Type namespace: PlayFab
namespace PlayFab {
  // WARNING Size may be invalid!
  // Autogenerated type: PlayFab.PlayFabClientInstanceAPI/PlayFab.<>c__DisplayClass24_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  template<typename TOut>
  class PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_1<::PlayFab::ClientModels::ExecuteCloudScriptResult*>*& dyn_resultCallback() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1::dyn_resultCallback");
    ...
    static PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1<TOut>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1<TOut>*, creationType>()));
    }
    ...
    void $ExecuteCloudScript$b__0(::PlayFab::ClientModels::ExecuteCloudScriptResult* wrappedResult) {
      static auto ___internal__logger = ::Logger::get().WithContext("::PlayFab::PlayFabClientInstanceAPI::$$c__DisplayClass24_0_1::<ExecuteCloudScript>b__0");
  ...
  }; // PlayFab.PlayFabClientInstanceAPI/PlayFab.<>c__DisplayClass24_0`1
  // Could not write size check! Type: PlayFab.PlayFabClientInstanceAPI/PlayFab.<>c__DisplayClass24_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
