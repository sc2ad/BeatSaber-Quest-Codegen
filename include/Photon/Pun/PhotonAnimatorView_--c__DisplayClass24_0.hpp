...
namespace Photon::Pun {
  // Size: 0x14
  #pragma pack(push, 1)
  // Autogenerated type: Photon.Pun.PhotonAnimatorView/Photon.Pun.<>c__DisplayClass24_0
  ...
  class PhotonAnimatorView::$$c__DisplayClass24_0 : public ::Il2CppObject {
    ...
    // System.Boolean <SetLayerSynchronized>b__0(Photon.Pun.PhotonAnimatorView/Photon.Pun.SynchronizedLayer item)
    // Offset: 0x1084404
    bool $SetLayerSynchronized$b__0(::Photon::Pun::PhotonAnimatorView::SynchronizedLayer* item);
  }; // Photon.Pun.PhotonAnimatorView/Photon.Pun.<>c__DisplayClass24_0
  #pragma pack(pop)
