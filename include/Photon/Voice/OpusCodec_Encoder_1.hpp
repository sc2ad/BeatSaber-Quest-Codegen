...
namespace Photon::Voice {
  ...
  // Autogenerated type: Photon.Voice.OpusCodec/Photon.Voice.Encoder`1
  ...
  }; // Photon.Voice.OpusCodec/Photon.Voice.Encoder`1
  // Could not write size check! Type: Photon.Voice.OpusCodec/Photon.Voice.Encoder`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
