...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 Ice::BeatmapFloorLightTilesGrid Ice::BeatmapFloorLightTilesGrid::New_ctor()  {
Ice::BeatmapFloorLightTilesGrid o{THROW_UNLESS(::il2cpp_utils::New<Ice::BeatmapFloorLightTilesGrid>())};
return o;
}
