...
public:
// Declarations
using Pool = ::Ice::____Ice__FloorLightTile__Pool;
...
namespace Ice {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(16000)), TypeDefinitionIndex(TypeDefinitionIndex(10992)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 295 })}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(15999))
// CS Name: Ice.FloorLightTile::Pool
class CORDL_TYPE ____Ice__FloorLightTile__Pool : public ::Zenject::MonoMemoryPool_1<::Ice::FloorLightTile> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____Ice__FloorLightTile__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Ice__FloorLightTile__Pool", modifiers: " const&", def_value: None }]
constexpr ____Ice__FloorLightTile__Pool(____Ice__FloorLightTile__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Ice__FloorLightTile__Pool", modifiers: "&&", def_value: None }]
constexpr ____Ice__FloorLightTile__Pool(____Ice__FloorLightTile__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Ice__FloorLightTile__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::Ice::FloorLightTile>(ptr) {
}


  constexpr ____Ice__FloorLightTile__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Ice__FloorLightTile__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Ice__FloorLightTile__Pool& operator=(____Ice__FloorLightTile__Pool&& o) noexcept = default;
  constexpr ____Ice__FloorLightTile__Pool& operator=(____Ice__FloorLightTile__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Ice__FloorLightTile__Pool() ;
...
NEED_NO_BOX(::Ice::____Ice__FloorLightTile__Pool);
DEFINE_IL2CPP_ARG_TYPE(::Ice::____Ice__FloorLightTile__Pool, "Ice", "FloorLightTile/Pool");
