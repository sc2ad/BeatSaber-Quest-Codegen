...
namespace Ice {
  ...
  class FloorLightTilesGrid : public UnityEngine::MonoBehaviour {
    public:
    // [InjectAttribute] Offset: 0xF65B94
    ...
    // Size: 0x8
    // Offset: 0x28
    ::Array<::Array<Ice::FloorLightTile*>*>* grid;
    // Field size check
    static_assert(sizeof(::Array<::Array<Ice::FloorLightTile*>*>*) == 0x8);
    ...
    // Creating value type constructor for type: FloorLightTilesGrid
    FloorLightTilesGrid(Ice::FloorLightTile::Pool* floorLightTileMemoryPool_ = {}, GlobalNamespace::MemoryPoolContainer_1<Ice::FloorLightTile*>* floorLightTileMemoryPoolContainer_ = {}, ::Array<::Array<Ice::FloorLightTile*>*>* grid_ = {}, float tileWidth_ = {}, float tileHeight_ = {}, UnityEngine::Vector3 anchorPoint_ = {}, int ySize_ = {}) noexcept : floorLightTileMemoryPool{floorLightTileMemoryPool_}, floorLightTileMemoryPoolContainer{floorLightTileMemoryPoolContainer_}, grid{grid_}, tileWidth{tileWidth_}, tileHeight{tileHeight_}, anchorPoint{anchorPoint_}, ySize{ySize_} {}
    ...
    ::Array<::Array<Ice::FloorLightTile*>*>*& dyn__grid();
