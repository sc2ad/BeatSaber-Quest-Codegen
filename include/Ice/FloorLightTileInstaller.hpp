...
namespace Ice {
  ...
  class FloorLightTileInstaller : public Zenject::ScriptableObjectInstaller {
    ...
    // Creating value type constructor for type: FloorLightTileInstaller
    FloorLightTileInstaller(Ice::FloorLightTile* floorLightTilePrefab_ = {}) noexcept : floorLightTilePrefab{floorLightTilePrefab_} {}
