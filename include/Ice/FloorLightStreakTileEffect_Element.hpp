...
namespace Ice {
  ...
  class FloorLightStreakTileEffect::Element : public ::Il2CppObject {
    ...
    Element(System::Action_1<Ice::FloorLightStreakTileEffect::Element*>* didMoveToNextTile_ = {}, int currentTileY_ = {}, int lineIndex_ = {}, float nextTileRemainingTime_ = {}, float stayOnTileDuration_ = {}, UnityEngine::Color color_ = {}) noexcept : didMoveToNextTile{didMoveToNextTile_}, currentTileY{currentTileY_}, lineIndex{lineIndex_}, nextTileRemainingTime{nextTileRemainingTime_}, stayOnTileDuration{stayOnTileDuration_}, color{color_} {}
