...
namespace Ice {
  ...
  class FloorLightTile : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(Tweening::ColorTween*) == 0x8);
    // Creating value type constructor for type: FloorLightTile
    FloorLightTile(GlobalNamespace::MaterialPropertyBlockColorSetter* colorSetter_ = {}, GlobalNamespace::TubeBloomPrePassLight* tubeBloomPrePassLight_ = {}, Tweening::SongTimeTweeningManager* songTimeTweeningManager_ = {}, System::Action_1<Ice::FloorLightTile*>* didFinish_ = {}, Tweening::ColorTween* fadeInTween_ = {}, Tweening::ColorTween* fadeOutTween_ = {}) noexcept : colorSetter{colorSetter_}, tubeBloomPrePassLight{tubeBloomPrePassLight_}, songTimeTweeningManager{songTimeTweeningManager_}, didFinish{didFinish_}, fadeInTween{fadeInTween_}, fadeOutTween{fadeOutTween_} {}
