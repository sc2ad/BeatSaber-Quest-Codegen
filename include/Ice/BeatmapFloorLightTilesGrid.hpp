...
namespace Ice {
  ...
  class BeatmapFloorLightTilesGrid : public UnityEngine::MonoBehaviour {
    ...
    // [InjectAttribute] Offset: 0xF65B14
    ...
    // Creating value type constructor for type: BeatmapFloorLightTilesGrid
    BeatmapFloorLightTilesGrid(int numberOfRows_ = {}, float tileWidth_ = {}, float tileHeight_ = {}, Ice::FloorLightTilesGrid* floorLightTilesGrid_ = {}, GlobalNamespace::IBeatmapObjectSpawnController* beatmapObjectSpawnController_ = {}) noexcept : numberOfRows{numberOfRows_}, tileWidth{tileWidth_}, tileHeight{tileHeight_}, floorLightTilesGrid{floorLightTilesGrid_}, beatmapObjectSpawnController{beatmapObjectSpawnController_} {}
