...
DEFINE_IL2CPP_ARG_TYPE(::BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74, "BGNet.Core.Messages", "UnconnectedMessageHandler/<SendMultipartMessageWithRetryAsync>d__74");
// Type namespace: BGNet.Core.Messages
namespace BGNet::Core::Messages {
  // WARNING Size may be invalid!
  // Autogenerated type: BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<SendMultipartMessageWithRetryAsync>d__74
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  struct UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74/*, public ::System::ValueType, public ::System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    public:
    public:
    ...
    // private BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<>c__DisplayClass74_0 <>8__1
    // Size: 0x8
    // Offset: 0x58
    ::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass74_0* $$8__1;
    // Field size check
    static_assert(sizeof(::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass74_0*) == 0x8);
    ...
    public:
    // Creating value type constructor for type: $SendMultipartMessageWithRetryAsync$d__74
    constexpr $SendMultipartMessageWithRetryAsync$d__74(int $$1__state_ = {}, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder $$t__builder_ = {}, ::BGNet::Core::Messages::UnconnectedMessageHandler* $$4__this_ = {}, uint protocolVersion_ = {}, ::System::Net::IPEndPoint* remoteEndPoint_ = {}, ::System::Threading::CancellationToken cancellationToken_ = {}, ::BGNet::Core::Messages::IUnconnectedReliableRequest* message_ = {}, ::LiteNetLib::Utils::NetDataWriter* data_ = {}, ::System::Func_5<uint, ::System::Net::IPEndPoint*, ::BGNet::Core::Messages::IUnconnectedReliableRequest*, ::System::Threading::CancellationToken, ::System::Threading::Tasks::Task*>* onSendFailed_ = {}, ::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass74_0* $$8__1_ = {}, bool $shouldReleaseMessage$5__2_ = {}, ::Il2CppObject* $$7__wrap2_ = {}, int $$7__wrap3_ = {}, ::System::Runtime::CompilerServices::TaskAwaiter $$u__1_ = {}) noexcept : $$1__state{$$1__state_}, $$t__builder{$$t__builder_}, $$4__this{$$4__this_}, protocolVersion{protocolVersion_}, remoteEndPoint{remoteEndPoint_}, cancellationToken{cancellationToken_}, message{message_}, data{data_}, onSendFailed{onSendFailed_}, $$8__1{$$8__1_}, $shouldReleaseMessage$5__2{$shouldReleaseMessage$5__2_}, $$7__wrap2{$$7__wrap2_}, $$7__wrap3{$$7__wrap3_}, $$u__1{$$u__1_} {}
    ...
    // Get instance field reference: private BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<>c__DisplayClass74_0 <>8__1
    [[deprecated("Use field access instead!")]] ::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass74_0*& dyn_$$8__1();
  ...
  }; // BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<SendMultipartMessageWithRetryAsync>d__74
  // WARNING Not writing size check since size may be invalid!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::MoveNext
// Il2CppName: MoveNext
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::*)()>(&BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::MoveNext)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74), "MoveNext", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::SetStateMachine
// Il2CppName: SetStateMachine
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::*)(::System::Runtime::CompilerServices::IAsyncStateMachine*)>(&BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74::SetStateMachine)> {
  static const MethodInfo* get() {
    static auto* stateMachine = &::il2cpp_utils::GetClassFromName("System.Runtime.CompilerServices", "IAsyncStateMachine")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(BGNet::Core::Messages::UnconnectedMessageHandler::$SendMultipartMessageWithRetryAsync$d__74), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stateMachine});
  }
};
