...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass53_0_1, "BGNet.Core.Messages", "UnconnectedMessageHandler/<>c__DisplayClass53_0`1");
// Type namespace: BGNet.Core.Messages
namespace BGNet::Core::Messages {
  // WARNING Size may be invalid!
  // Autogenerated type: BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<>c__DisplayClass53_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  template<typename T>
  class UnconnectedMessageHandler::$$c__DisplayClass53_0_1 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::BGNet::Core::Messages::UnconnectedMessageHandler*& dyn_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass53_0_1::dyn_$$4__this");
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_2<T, ::BGNet::Core::Messages::UnconnectedMessageHandler::MessageOrigin>*& dyn_customHandler() {
      static auto ___internal__logger = ::Logger::get().WithContext("::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass53_0_1::dyn_customHandler");
      auto ___internal__instance = this;
    ...
    static UnconnectedMessageHandler::$$c__DisplayClass53_0_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass53_0_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UnconnectedMessageHandler::$$c__DisplayClass53_0_1<T>*, creationType>()));
    }
    ...
    void $CustomUnreliableResponseHandler$b__0(T packet, ::BGNet::Core::Messages::UnconnectedMessageHandler::MessageOrigin origin) {
      static auto ___internal__logger = ::Logger::get().WithContext("::BGNet::Core::Messages::UnconnectedMessageHandler::$$c__DisplayClass53_0_1::<CustomUnreliableResponseHandler>b__0");
  ...
  }; // BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<>c__DisplayClass53_0`1
  // Could not write size check! Type: BGNet.Core.Messages.UnconnectedMessageHandler/BGNet.Core.Messages.<>c__DisplayClass53_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
