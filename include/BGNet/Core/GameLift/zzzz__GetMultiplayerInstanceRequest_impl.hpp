...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BGNet::Core::GameLift::GetMultiplayerInstanceRequest::*)(::StringW, ::GlobalNamespace::ServiceEnvironment, ::StringW, ::GlobalNamespace::BeatmapLevelSelectionMask, ::GlobalNamespace::GameplayServerConfiguration, ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, ::StringW, ::StringW, ::StringW, ::StringW, ::System::Collections::Generic::Dictionary_2<::StringW,int64_t>, ::StringW, ::StringW)>(&::BGNet::Core::GameLift::GetMultiplayerInstanceRequest::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::ServiceEnvironment>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapLevelSelectionMask>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::GameplayServerConfiguration>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::Dictionary_2<::StringW,int64_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                        )));
    return ___internal_method;
  }
};
// Ctor Parameters [CppParam { name: "version", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "serviceEnvironment", ty: "::GlobalNamespace::ServiceEnvironment", modifiers: "", def_value: Some("{}") }, CppParam { name: "singleUseAuthToken", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "beatmapLevelSelectionMask", ty: "::GlobalNamespace::BeatmapLevelSelectionMask", modifiers: "", def_value: Some("{}") }, CppParam { name: "gameplayServerConfiguration", ty: "::GlobalNamespace::GameplayServerConfiguration", modifiers: "", def_value: Some("{}") }, CppParam { name: "userId", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "privateGameSecret", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "privateGameCode", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "platform", ty: "::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform", modifiers: "", def_value: Some("{}") }, CppParam { name: "authUserId", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "gameliftRegionLatencies", ty: "::System::Collections::Generic::Dictionary_2<::StringW,int64_t>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "ticketId", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "placementId", ty: "::StringW", modifiers: "", def_value: Some("csnull") }]
constexpr ::BGNet::Core::GameLift::GetMultiplayerInstanceRequest::GetMultiplayerInstanceRequest(::StringW version, ::GlobalNamespace::ServiceEnvironment serviceEnvironment, ::StringW singleUseAuthToken, ::GlobalNamespace::BeatmapLevelSelectionMask beatmapLevelSelectionMask, ::GlobalNamespace::GameplayServerConfiguration gameplayServerConfiguration, ::StringW userId, ::StringW privateGameSecret, ::StringW privateGameCode, ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform platform, ::StringW authUserId, ::System::Collections::Generic::Dictionary_2<::StringW,int64_t> gameliftRegionLatencies, ::StringW ticketId, ::StringW placementId) noexcept : ::bs_hook::ValueTypeWrapper() {this->version = version;
...
constexpr void ::BGNet::Core::GameLift::GetMultiplayerInstanceRequest::__set_platform(::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, 0x60>(this->__instance, std::forward<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform ::BGNet::Core::GameLift::GetMultiplayerInstanceRequest::__get_platform() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, 0x60>(this->__instance);
}
