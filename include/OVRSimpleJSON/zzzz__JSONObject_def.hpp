...
namespace OVRSimpleJSON {
class ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0;
}
namespace OVRSimpleJSON {
class ____OVRSimpleJSON__JSONObject___get_Children_d__23;
}
...
class CORDL_TYPE ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____OVRSimpleJSON__JSONObject____c__DisplayClass21_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVRSimpleJSON__JSONObject____c__DisplayClass21_0", modifiers: " const&", def_value: None }]
constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0(____OVRSimpleJSON__JSONObject____c__DisplayClass21_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVRSimpleJSON__JSONObject____c__DisplayClass21_0", modifiers: "&&", def_value: None }]
constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0(____OVRSimpleJSON__JSONObject____c__DisplayClass21_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0& operator=(____OVRSimpleJSON__JSONObject____c__DisplayClass21_0&& o) noexcept = default;
  constexpr ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0& operator=(____OVRSimpleJSON__JSONObject____c__DisplayClass21_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____OVRSimpleJSON__JSONObject____c__DisplayClass21_0() ;
...
class CORDL_TYPE ____OVRSimpleJSON__JSONObject___get_Children_d__23 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____OVRSimpleJSON__JSONObject___get_Children_d__23() = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVRSimpleJSON__JSONObject___get_Children_d__23", modifiers: " const&", def_value: None }]
constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23(____OVRSimpleJSON__JSONObject___get_Children_d__23 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVRSimpleJSON__JSONObject___get_Children_d__23", modifiers: "&&", def_value: None }]
constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23(____OVRSimpleJSON__JSONObject___get_Children_d__23&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____OVRSimpleJSON__JSONObject___get_Children_d__23(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23& operator=(____OVRSimpleJSON__JSONObject___get_Children_d__23&& o) noexcept = default;
  constexpr ____OVRSimpleJSON__JSONObject___get_Children_d__23& operator=(____OVRSimpleJSON__JSONObject___get_Children_d__23 const& o) noexcept = default;
...
constexpr ::OVRSimpleJSON::JSONObject __get___4__this() const;
 ...
 ::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::OVRSimpleJSON::JSONNode> __declspec(property(get=__get___7__wrap1, put=__set___7__wrap1))  __7__wrap1;

constexpr void __set___7__wrap1(::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::OVRSimpleJSON::JSONNode> value) ;

constexpr ::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::OVRSimpleJSON::JSONNode> __get___7__wrap1() const;
...
explicit ____OVRSimpleJSON__JSONObject___get_Children_d__23(int32_t __1__state) ;
...
public:
// Declarations
using _get_Children_d__23 = ::OVRSimpleJSON::____OVRSimpleJSON__JSONObject___get_Children_d__23;

using __c__DisplayClass21_0 = ::OVRSimpleJSON::____OVRSimpleJSON__JSONObject____c__DisplayClass21_0;
...
NEED_NO_BOX(::OVRSimpleJSON::____OVRSimpleJSON__JSONObject____c__DisplayClass21_0);
DEFINE_IL2CPP_ARG_TYPE(::OVRSimpleJSON::____OVRSimpleJSON__JSONObject____c__DisplayClass21_0, "OVRSimpleJSON", "JSONObject/<>c__DisplayClass21_0");
NEED_NO_BOX(::OVRSimpleJSON::____OVRSimpleJSON__JSONObject___get_Children_d__23);
DEFINE_IL2CPP_ARG_TYPE(::OVRSimpleJSON::____OVRSimpleJSON__JSONObject___get_Children_d__23, "OVRSimpleJSON", "JSONObject/<get_Children>d__23");
