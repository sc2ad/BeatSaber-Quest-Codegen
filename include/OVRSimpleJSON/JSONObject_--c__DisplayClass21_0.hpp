...
namespace OVRSimpleJSON {
  ...
  check_size<sizeof(JSONObject::$$c__DisplayClass21_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __OVRSimpleJSON_JSONObject_$$c__DisplayClass21_0SizeCheck;
}
