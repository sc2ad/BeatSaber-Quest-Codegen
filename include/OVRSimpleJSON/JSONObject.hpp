...
namespace OVRSimpleJSON {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: CE01AC
  class JSONObject : public OVRSimpleJSON::JSONNode {
    ...
    // Offset: 0x1E4EF54
    // Implemented from: OVRSimpleJSON.JSONNode
    // Base method: System.Boolean JSONNode::get_IsObject_NEW()
    bool get_IsObject();
    ...
    // Offset: 0x1E4F560
    // Implemented from: OVRSimpleJSON.JSONNode
    // Base method: OVRSimpleJSON.JSONNode JSONNode::Remove_NEW(System.String aKey)
