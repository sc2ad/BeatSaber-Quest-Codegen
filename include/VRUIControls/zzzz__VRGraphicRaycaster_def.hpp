...
struct CORDL_TYPE VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult(UnityEngine::UI::Graphic graphic, float_t distance, UnityEngine::Vector3 position, UnityEngine::Vector2 insideRootCanvasPosition) noexcept;


                    constexpr VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult(VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult const&) = default;
                    constexpr VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult(VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult&&) = default;
                    constexpr VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult& operator=(VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult& operator=(VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult&& o) noexcept {
...
constexpr explicit VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE VRUIControls__VRGraphicRaycaster____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~VRUIControls__VRGraphicRaycaster____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "VRUIControls__VRGraphicRaycaster____c", modifiers: " const&", def_value: None }]
constexpr VRUIControls__VRGraphicRaycaster____c(VRUIControls__VRGraphicRaycaster____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "VRUIControls__VRGraphicRaycaster____c", modifiers: "&&", def_value: None }]
constexpr VRUIControls__VRGraphicRaycaster____c(VRUIControls__VRGraphicRaycaster____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit VRUIControls__VRGraphicRaycaster____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr VRUIControls__VRGraphicRaycaster____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr VRUIControls__VRGraphicRaycaster____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr VRUIControls__VRGraphicRaycaster____c& operator=(VRUIControls__VRGraphicRaycaster____c&& o) noexcept = default;
  constexpr VRUIControls__VRGraphicRaycaster____c& operator=(VRUIControls__VRGraphicRaycaster____c const& o) noexcept = default;
                


// Fields

static VRUIControls::VRUIControls__VRGraphicRaycaster____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(VRUIControls::VRUIControls__VRGraphicRaycaster____c value) ;

static VRUIControls::VRUIControls__VRGraphicRaycaster____c __get___9() ;

static System::Comparison_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> __declspec(property(get=__get___9__12_0, put=__set___9__12_0))  __9__12_0;

static void __set___9__12_0(System::Comparison_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> value) ;

static System::Comparison_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> __get___9__12_0() ;
...
/// @brief Method <RaycastCanvas>b__12_0 addr 0x2d3caa0 size 0x54 virtual false final false
 int32_t _RaycastCanvas_b__12_0(VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult g1, VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult g2) ;
...
public:
// Declarations
using __c = VRUIControls::VRUIControls__VRGraphicRaycaster____c;

using VRGraphicRaycastResult = VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult;
...
constexpr UnityEngine::Canvas __get__canvas() const;
 ...
 System::Collections::Generic::List_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> __declspec(property(get=__get__raycastResults, put=__set__raycastResults))  _raycastResults;

constexpr void __set__raycastResults(System::Collections::Generic::List_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> value) ;

constexpr System::Collections::Generic::List_1<VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult> __get__raycastResults() const;
...
NEED_NO_BOX(VRUIControls::VRUIControls__VRGraphicRaycaster____c);
DEFINE_IL2CPP_ARG_TYPE(VRUIControls::VRUIControls__VRGraphicRaycaster____c, "VRUIControls", "VRGraphicRaycaster/<>c");
DEFINE_IL2CPP_ARG_TYPE(VRUIControls::VRUIControls__VRGraphicRaycaster__VRGraphicRaycastResult, "VRUIControls", "VRGraphicRaycaster/VRGraphicRaycastResult");
