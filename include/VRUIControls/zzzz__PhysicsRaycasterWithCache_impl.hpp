...
//  Writing Method size for method: ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::*)(bool, ::UnityEngine::Ray, ::UnityEngine::RaycastHit, float_t, int32_t)>(&::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::_ctor)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x2d3b5e8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast>::get(),
                            ".ctor",
...
constexpr ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast(bool wasHit, ::UnityEngine::Ray ray, ::UnityEngine::RaycastHit hitInfo, float_t maxDistance, int32_t layerMask) noexcept : ::bs_hook::ValueTypeWrapper() {this->wasHit = wasHit;
this->ray = ray;
this->hitInfo = hitInfo;
this->maxDistance = maxDistance;
this->layerMask = layerMask;
}
constexpr void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__set_wasHit(bool value)  {
::cordl_internals::setInstanceField<bool, 0x0>(this->__instance, std::forward<bool>(value));
}
constexpr bool ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__get_wasHit() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->__instance);
}
constexpr void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__set_ray(::UnityEngine::Ray value)  {
::cordl_internals::setInstanceField<::UnityEngine::Ray, 0x4>(this->__instance, std::forward<::UnityEngine::Ray>(value));
}
constexpr ::UnityEngine::Ray ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__get_ray() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Ray, 0x4>(this->__instance);
}
constexpr void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__set_hitInfo(::UnityEngine::RaycastHit value)  {
::cordl_internals::setInstanceField<::UnityEngine::RaycastHit, 0x1c>(this->__instance, std::forward<::UnityEngine::RaycastHit>(value));
}
constexpr ::UnityEngine::RaycastHit ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__get_hitInfo() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RaycastHit, 0x1c>(this->__instance);
}
constexpr void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__set_maxDistance(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x48>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__get_maxDistance() const {
return ::cordl_internals::getInstanceField<float_t, 0x48>(this->__instance);
}
constexpr void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__set_layerMask(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x4c>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::__get_layerMask() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4c>(this->__instance);
}
 void ::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast::_ctor(bool wasHit, ::UnityEngine::Ray ray, ::UnityEngine::RaycastHit hitInfo, float_t maxDistance, int32_t layerMask)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::VRUIControls::PhysicsRaycasterWithCache::__set__cachedRaycasts(::System::Collections::Generic::List_1<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast>>(value));
}
constexpr ::System::Collections::Generic::List_1<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast> ::VRUIControls::PhysicsRaycasterWithCache::__get__cachedRaycasts() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::VRUIControls::____VRUIControls__PhysicsRaycasterWithCache__CachedRaycast>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
