...
namespace SFB {
  ...
  class IStandaloneFileBrowser {
    ...
    // Offset: 0xFFFFFFFF
    ::Array<::Il2CppString*>* OpenFilePanel_NEW(::Il2CppString* title, ::Il2CppString* directory, ::Array<SFB::ExtensionFilter>* extensions, bool multiselect);
    // public System.String[] OpenFolderPanel(System.String title, System.String directory, System.Boolean multiselect)
    // Offset: 0xFFFFFFFF
    ::Array<::Il2CppString*>* OpenFolderPanel_NEW(::Il2CppString* title, ::Il2CppString* directory, bool multiselect);
    ...
    // Offset: 0xFFFFFFFF
    ::Il2CppString* SaveFilePanel_NEW(::Il2CppString* title, ::Il2CppString* directory, ::Il2CppString* defaultName, ::Array<SFB::ExtensionFilter>* extensions);
    ...
    // Offset: 0xFFFFFFFF
    void OpenFilePanelAsync_NEW(::Il2CppString* title, ::Il2CppString* directory, ::Array<SFB::ExtensionFilter>* extensions, bool multiselect, System::Action_1<::Array<::Il2CppString*>*>* cb);
    ...
    // Offset: 0xFFFFFFFF
    void OpenFolderPanelAsync_NEW(::Il2CppString* title, ::Il2CppString* directory, bool multiselect, System::Action_1<::Array<::Il2CppString*>*>* cb);
    ...
    // Offset: 0xFFFFFFFF
    void SaveFilePanelAsync_NEW(::Il2CppString* title, ::Il2CppString* directory, ::Il2CppString* defaultName, ::Array<SFB::ExtensionFilter>* extensions, System::Action_1<::Il2CppString*>* cb);
