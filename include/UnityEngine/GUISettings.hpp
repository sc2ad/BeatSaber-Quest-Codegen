...
namespace UnityEngine {
  ...
  check_size<sizeof(GUISettings), 40 + sizeof(UnityEngine::Color) + ((40 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (40 + sizeof(UnityEngine::Color)) % 8) : 0)> __UnityEngine_GUISettingsSizeCheck;
}
