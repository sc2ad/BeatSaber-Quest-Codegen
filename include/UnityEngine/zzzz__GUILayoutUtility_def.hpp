...
class CORDL_TYPE ____UnityEngine__GUILayoutUtility__LayoutCache : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____UnityEngine__GUILayoutUtility__LayoutCache() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUILayoutUtility__LayoutCache", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__GUILayoutUtility__LayoutCache(____UnityEngine__GUILayoutUtility__LayoutCache const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUILayoutUtility__LayoutCache", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__GUILayoutUtility__LayoutCache(____UnityEngine__GUILayoutUtility__LayoutCache&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__GUILayoutUtility__LayoutCache(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__GUILayoutUtility__LayoutCache& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__GUILayoutUtility__LayoutCache& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__GUILayoutUtility__LayoutCache& operator=(____UnityEngine__GUILayoutUtility__LayoutCache&& o) noexcept = default;
  constexpr ____UnityEngine__GUILayoutUtility__LayoutCache& operator=(____UnityEngine__GUILayoutUtility__LayoutCache const& o) noexcept = default;
...
explicit ____UnityEngine__GUILayoutUtility__LayoutCache(int32_t instanceID) ;
...
public:
// Declarations
using LayoutCache = ::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache;
...
static ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> __declspec(property(get=__get_s_StoredLayouts, put=__set_s_StoredLayouts))  s_StoredLayouts;

static void __set_s_StoredLayouts(::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> value) ;

static ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> __get_s_StoredLayouts() ;

static ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> __declspec(property(get=__get_s_StoredWindows, put=__set_s_StoredWindows))  s_StoredWindows;

static void __set_s_StoredWindows(::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> value) ;

static ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache> __get_s_StoredWindows() ;

static ::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache __declspec(property(get=__get_current, put=__set_current))  current;

static void __set_current(::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache value) ;

static ::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache __get_current() ;
...
static ::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache SelectIDList(int32_t instanceID, bool isWindow) ;
...
static void BeginContainer(::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache cache) ;
...
NEED_NO_BOX(::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__GUILayoutUtility__LayoutCache, "UnityEngine", "GUILayoutUtility/LayoutCache");
