...
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::____UnityEngine__Texture2D__EXRFlags(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags  ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::None{0};
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags  ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::OutputAsFloat{1};
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags  ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::CompressZIP{2};
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags  ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::CompressRLE{4};
constexpr ::UnityEngine::____UnityEngine__Texture2D__EXRFlags  ::UnityEngine::____UnityEngine__Texture2D__EXRFlags::CompressPIZ{8};
