...
class CORDL_TYPE UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0", modifiers: " const&", def_value: None }]
constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0(UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0", modifiers: "&&", def_value: None }]
constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0(UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0& operator=(UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0&& o) noexcept = default;
  constexpr UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0& operator=(UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0 const& o) noexcept = default;
...
public:
// Declarations
using __c__DisplayClass3_0 = UnityEngine::TerrainUtils::UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0;
...
NEED_NO_BOX(UnityEngine::TerrainUtils::UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::TerrainUtils::UnityEngine__TerrainUtils__TerrainMap____c__DisplayClass3_0, "UnityEngine.TerrainUtils", "TerrainMap/<>c__DisplayClass3_0");
