...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: CBAE7C
  // [RequiredByNativeCodeAttribute] Offset: CBAE7C
  // [ExtensionOfNativeClassAttribute] Offset: CBAE7C
  // [NativeHeaderAttribute] Offset: CBAE7C
