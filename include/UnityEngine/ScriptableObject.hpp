...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: CA9D40
  // [RequiredByNativeCodeAttribute] Offset: CA9D40
  // [NativeClassAttribute] Offset: CA9D40
  // [ExtensionOfNativeClassAttribute] Offset: CA9D40
