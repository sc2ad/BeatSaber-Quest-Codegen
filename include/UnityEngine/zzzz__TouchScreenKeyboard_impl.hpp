...
constexpr void UnityEngine::UnityEngine__TouchScreenKeyboard__Status::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UnityEngine__TouchScreenKeyboard__Status::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UnityEngine__TouchScreenKeyboard__Status  UnityEngine::UnityEngine__TouchScreenKeyboard__Status::Visible{0};
constexpr UnityEngine::UnityEngine__TouchScreenKeyboard__Status  UnityEngine::UnityEngine__TouchScreenKeyboard__Status::Done{1};
constexpr UnityEngine::UnityEngine__TouchScreenKeyboard__Status  UnityEngine::UnityEngine__TouchScreenKeyboard__Status::Canceled{2};
constexpr UnityEngine::UnityEngine__TouchScreenKeyboard__Status  UnityEngine::UnityEngine__TouchScreenKeyboard__Status::LostFocus{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UnityEngine__TouchScreenKeyboard__Status (UnityEngine::TouchScreenKeyboard::*)()>(&UnityEngine::TouchScreenKeyboard::get_status)> {
  constexpr static std::size_t size = 0x3c;
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 UnityEngine::UnityEngine__TouchScreenKeyboard__Status UnityEngine::TouchScreenKeyboard::get_status()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TouchScreenKeyboard>::get(),
                            "get_status",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::UnityEngine__TouchScreenKeyboard__Status, false>(const_cast<void*>(instance), ___internal_method);
}
