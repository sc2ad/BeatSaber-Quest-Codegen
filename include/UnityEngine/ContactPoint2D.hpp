...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: 104C5DC
  // [RequiredByNativeCodeAttribute] Offset: 104C5DC
  // [NativeHeaderAttribute] Offset: 104C5DC
  struct ContactPoint2D/*, public ::System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x104CAA0
    ...
    // [NativeNameAttribute] Offset: 0x104CAD8
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector2) == 0x8);
    // [NativeNameAttribute] Offset: 0x104CB10
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector2) == 0x8);
    // [NativeNameAttribute] Offset: 0x104CB48
    ...
    // [NativeNameAttribute] Offset: 0x104CB80
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x104CBB8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x104CBF0
    ...
    // [NativeNameAttribute] Offset: 0x104CC28
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0x104CC60
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0x104CC98
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0x104CCD0
