...
return ::cordl_internals::getInstanceField<UnityEngine::Android::AndroidAssetPackError, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 UnityEngine::Android::AndroidAssetPackState UnityEngine::Android::AndroidAssetPackState::New_ctor(::StringW name, UnityEngine::Android::AndroidAssetPackStatus status, UnityEngine::Android::AndroidAssetPackError error)  {
UnityEngine::Android::AndroidAssetPackState o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::Android::AndroidAssetPackState>(name, status, error))};
return o;
}
