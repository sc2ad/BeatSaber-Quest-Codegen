...
namespace UnityEngine::Rendering {
  ...
  check_size<sizeof(BatchRendererCullingOutput), 48 + sizeof(int) + ((48 + sizeof(int)) % 8 != 0 ? (8 - (48 + sizeof(int)) % 8) : 0)> __UnityEngine_Rendering_BatchRendererCullingOutputSizeCheck;
}
