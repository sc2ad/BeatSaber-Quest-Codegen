...
namespace UnityEngine::Rendering {
  ...
  class CommandBuffer : public ::CsObject, public System::IDisposable {
    public:
    // System.IntPtr m_Ptr
    // Offset: 0x10
    System::IntPtr m_Ptr;
    ...
    // Offset: 0x1384F44
    void SetGlobalVector(::CsString* name, UnityEngine::Vector4 value);
    // public System.Void SetGlobalTexture(System.String name, UnityEngine.Rendering.RenderTargetIdentifier value)
    // Offset: 0x138500C
    void SetGlobalTexture(::CsString* name, UnityEngine::Rendering::RenderTargetIdentifier value);
