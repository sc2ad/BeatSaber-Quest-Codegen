...
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes::None{0};
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes::Rotation{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::None{0};
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::IndirectOnly{1};
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::Subtractive{2};
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes  ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes::Shadowmask{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes (::UnityEngine::Rendering::SupportedRenderingFeatures::*)()>(&::UnityEngine::Rendering::SupportedRenderingFeatures::get_defaultMixedLightingModes)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes (::UnityEngine::Rendering::SupportedRenderingFeatures::*)()>(&::UnityEngine::Rendering::SupportedRenderingFeatures::get_mixedLightingModes)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void ::UnityEngine::Rendering::SupportedRenderingFeatures::__set__reflectionProbeModes_k__BackingField(::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes value)  {
::cordl_internals::setInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes>(value));
}
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes ::UnityEngine::Rendering::SupportedRenderingFeatures::__get__reflectionProbeModes_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__ReflectionProbeModes, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::UnityEngine::Rendering::SupportedRenderingFeatures::__set__defaultMixedLightingModes_k__BackingField(::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes value)  {
::cordl_internals::setInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes>(value));
}
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes ::UnityEngine::Rendering::SupportedRenderingFeatures::__get__defaultMixedLightingModes_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::UnityEngine::Rendering::SupportedRenderingFeatures::__set__mixedLightingModes_k__BackingField(::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes value)  {
::cordl_internals::setInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes>(value));
}
constexpr ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes ::UnityEngine::Rendering::SupportedRenderingFeatures::__get__mixedLightingModes_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, value);
 ...
 ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes ::UnityEngine::Rendering::SupportedRenderingFeatures::get_defaultMixedLightingModes()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::SupportedRenderingFeatures>::get(),
                            "get_defaultMixedLightingModes",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes, false>(const_cast<void*>(instance), ___internal_method);
}
 ::UnityEngine::Rendering::____UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes ::UnityEngine::Rendering::SupportedRenderingFeatures::get_mixedLightingModes()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Rendering::SupportedRenderingFeatures>::get(),
                            "get_mixedLightingModes",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 ::UnityEngine::Rendering::SupportedRenderingFeatures::SupportedRenderingFeatures()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<SupportedRenderingFeatures>())) {}
