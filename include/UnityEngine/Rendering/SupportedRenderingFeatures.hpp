...
namespace UnityEngine::Rendering {
  ...
  class SupportedRenderingFeatures : public ::Il2CppObject {
    ...
    check_size<sizeof(SupportedRenderingFeatures::ReflectionProbeModes), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Rendering_SupportedRenderingFeatures_ReflectionProbeModesSizeCheck;
    ...
    check_size<sizeof(SupportedRenderingFeatures::LightmapMixedBakeModes), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Rendering_SupportedRenderingFeatures_LightmapMixedBakeModesSizeCheck;
  ...
  check_size<sizeof(SupportedRenderingFeatures), 48 + sizeof(bool) + ((48 + sizeof(bool)) % 8 != 0 ? (8 - (48 + sizeof(bool)) % 8) : 0)> __UnityEngine_Rendering_SupportedRenderingFeaturesSizeCheck;
}
