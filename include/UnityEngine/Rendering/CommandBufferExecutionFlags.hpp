...
namespace UnityEngine::Rendering {
  ...
  check_size<sizeof(CommandBufferExecutionFlags), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Rendering_CommandBufferExecutionFlagsSizeCheck;
}
