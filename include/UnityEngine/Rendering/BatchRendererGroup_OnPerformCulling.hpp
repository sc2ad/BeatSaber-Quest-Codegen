...
namespace UnityEngine::Rendering {
  ...
  class BatchRendererGroup::OnPerformCulling : public System::MulticastDelegate {
    ...
    // Offset: 0x1978D48
    Unity::Jobs::JobHandle Invoke_NEW(UnityEngine::Rendering::BatchRendererGroup* rendererGroup, UnityEngine::Rendering::BatchCullingContext cullingContext);
    ...
    // Offset: 0x19792E0
    System::IAsyncResult* BeginInvoke_NEW(UnityEngine::Rendering::BatchRendererGroup* rendererGroup, UnityEngine::Rendering::BatchCullingContext cullingContext, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Unity.Jobs.JobHandle EndInvoke(System.IAsyncResult result)
    // Offset: 0x197937C
    Unity::Jobs::JobHandle EndInvoke_NEW(System::IAsyncResult* result);
