...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::PS4::XR::PSVRSettings::*)()>(&UnityEngine::PS4::XR::PSVRSettings::_ctor)> {
 ...
 UnityEngine::PS4::XR::PSVRSettings UnityEngine::PS4::XR::PSVRSettings::New_ctor()  {
UnityEngine::PS4::XR::PSVRSettings o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::PS4::XR::PSVRSettings>())};
return o;
}
