...
class CORDL_TYPE UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction", modifiers: " const&", def_value: None }]
constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction(UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction", modifiers: "&&", def_value: None }]
constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction(UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction& operator=(UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction&& o) noexcept = default;
  constexpr UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction& operator=(UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction const& o) noexcept = default;
...
public:
// Declarations
using UpdateFunction = UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction;

// Ctor Parameters [CppParam { name: "type", ty: "System::Type", modifiers: "", def_value: None }, CppParam { name: "subSystemList", ty: "::ArrayW<UnityEngine::LowLevel::PlayerLoopSystem>", modifiers: "", def_value: None }, CppParam { name: "updateDelegate", ty: "UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction", modifiers: "", def_value: None }, CppParam { name: "updateFunction", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }, CppParam { name: "loopConditionFunction", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
constexpr PlayerLoopSystem(System::Type type, ::ArrayW<UnityEngine::LowLevel::PlayerLoopSystem> subSystemList, UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction updateDelegate, ::cordl_internals::intptr_t updateFunction, ::cordl_internals::intptr_t loopConditionFunction) noexcept;
...
NEED_NO_BOX(UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction, "UnityEngine.LowLevel", "PlayerLoopSystem/UpdateFunction");
