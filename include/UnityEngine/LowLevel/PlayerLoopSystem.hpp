...
namespace UnityEngine::LowLevel {
  ...
  check_size<sizeof(PlayerLoopSystem), 32 + sizeof(System::IntPtr) + ((32 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (32 + sizeof(System::IntPtr)) % 8) : 0)> __UnityEngine_LowLevel_PlayerLoopSystemSizeCheck;
}
