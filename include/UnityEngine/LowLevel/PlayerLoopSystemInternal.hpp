...
namespace UnityEngine::LowLevel {
  ...
  check_size<sizeof(PlayerLoopSystemInternal), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __UnityEngine_LowLevel_PlayerLoopSystemInternalSizeCheck;
}
