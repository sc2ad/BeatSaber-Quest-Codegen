...
constexpr void UnityEngine::LowLevel::PlayerLoopSystemInternal::__set_updateDelegate(UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction value)  {
::cordl_internals::setInstanceField<UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction, 0x8>(this->__instance, std::forward<UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction>(value));
}
constexpr UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction UnityEngine::LowLevel::PlayerLoopSystemInternal::__get_updateDelegate() const {
return ::cordl_internals::getInstanceField<UnityEngine::LowLevel::UnityEngine__LowLevel__PlayerLoopSystem__UpdateFunction, 0x8>(this->__instance);
}
