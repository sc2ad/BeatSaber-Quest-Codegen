...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: E8B32C
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::AnimationClip::*)(::ArrayWrapper<UnityEngine::AnimationEvent*>)>(&UnityEngine::AnimationClip::set_events)> {
  static const MethodInfo* get() {
    static auto* value = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("UnityEngine", "AnimationEvent")), 1)->byval_arg;
