...
namespace UnityEngine {
  ...
  class CullingGroup::StateChanged : public System::MulticastDelegate {
    ...
    // Offset: 0x19C63F8
    void Invoke_NEW(UnityEngine::CullingGroupEvent sphere);
    ...
    // Offset: 0x19C666C
    System::IAsyncResult* BeginInvoke_NEW(UnityEngine::CullingGroupEvent sphere, System::AsyncCallback* callback, ::Il2CppObject* object);
