...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [DebuggerDisplayAttribute] Offset: 11DE088
  // [UsedByNativeCodeAttribute] Offset: 11DE088
  struct GlyphPairAdjustmentRecord/*, public System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x11DED54
    ...
    // [NativeNameAttribute] Offset: 0x11DEDA0
