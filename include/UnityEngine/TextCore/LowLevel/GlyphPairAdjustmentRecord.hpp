...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [DebuggerDisplayAttribute] Offset: 10C9FA0
  // [UsedByNativeCodeAttribute] Offset: 10C9FA0
  struct GlyphPairAdjustmentRecord/*, public ::System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x10CAC6C
    ...
    // [NativeNameAttribute] Offset: 0x10CACB8
