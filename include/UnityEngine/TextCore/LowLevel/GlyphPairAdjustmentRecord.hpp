...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [DebuggerDisplayAttribute] Offset: 10C33B0
  // [UsedByNativeCodeAttribute] Offset: 10C33B0
  struct GlyphPairAdjustmentRecord/*, public ::System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x10C407C
    ...
    // [NativeNameAttribute] Offset: 0x10C40C8
