...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10BA8A0
  struct GlyphValueRecord/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::TextCore::LowLevel::GlyphValueRecord>*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x10BB3C4
    ...
    // [NativeNameAttribute] Offset: 0x10BB410
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x10BB45C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x10BB4A8
