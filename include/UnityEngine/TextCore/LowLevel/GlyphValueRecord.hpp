...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: CE8F2C
  struct GlyphValueRecord/*, public System::ValueType, public System::IEquatable_1<UnityEngine::TextCore::LowLevel::GlyphValueRecord>*/ {
    public:
    // [NativeNameAttribute] Offset: 0xCE9A04
    ...
    // [NativeNameAttribute] Offset: 0xCE9A50
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xCE9A9C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xCE9AE8
