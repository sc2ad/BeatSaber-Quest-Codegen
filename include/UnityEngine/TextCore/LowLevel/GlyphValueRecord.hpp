...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: EA8018
  struct GlyphValueRecord/*, public System::ValueType, public System::IEquatable_1<UnityEngine::TextCore::LowLevel::GlyphValueRecord>*/ {
    ...
    protected:
    #endif
    // [NativeNameAttribute] Offset: 0xEA8B3C
    ...
    // [NativeNameAttribute] Offset: 0xEA8B88
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xEA8BD4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xEA8C20
