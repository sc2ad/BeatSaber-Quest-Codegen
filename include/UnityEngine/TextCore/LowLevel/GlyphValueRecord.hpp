...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [UsedByNativeCodeAttribute] Offset: 105F8AC
  struct GlyphValueRecord/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::TextCore::LowLevel::GlyphValueRecord>*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x10603D0
    ...
    // [NativeNameAttribute] Offset: 0x106041C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x1060468
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x10604B4
