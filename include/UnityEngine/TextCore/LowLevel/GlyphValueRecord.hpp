...
namespace UnityEngine::TextCore::LowLevel {
  ...
  check_size<sizeof(GlyphValueRecord), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __UnityEngine_TextCore_LowLevel_GlyphValueRecordSizeCheck;
}
