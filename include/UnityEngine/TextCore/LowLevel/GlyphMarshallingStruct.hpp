...
namespace UnityEngine::TextCore::LowLevel {
  ...
  check_size<sizeof(GlyphMarshallingStruct), 44 + sizeof(int) + ((44 + sizeof(int)) % 8 != 0 ? (8 - (44 + sizeof(int)) % 8) : 0)> __UnityEngine_TextCore_LowLevel_GlyphMarshallingStructSizeCheck;
}
