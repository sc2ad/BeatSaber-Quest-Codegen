...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CD5A24
  class FontEngine : public ::Il2CppObject {
    ...
    static void SetMarshallingArraySize(::Array<T>*& marshallingArray, int recordCount) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod("UnityEngine.TextCore.LowLevel", "FontEngine", "SetMarshallingArraySize", std::vector<Il2CppClass*>{il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(marshallingArray, recordCount)));
