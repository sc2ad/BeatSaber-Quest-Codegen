...
namespace UnityEngine::TextCore::LowLevel {
  ...
  // [NativeHeaderAttribute] Offset: EA80DC
  class FontEngine : public ::Il2CppObject {
    ...
    static void SetMarshallingArraySize(ByRef<::ArrayW<T>> marshallingArray, int recordCount) {
      ...
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(marshallingArray), recordCount);
    }
