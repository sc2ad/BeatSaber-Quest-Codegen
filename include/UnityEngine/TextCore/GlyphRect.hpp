...
namespace UnityEngine::TextCore {
  ...
  struct GlyphRect/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::TextCore::GlyphRect>*/ {
    ...
    // [NativeNameAttribute] Offset: 0x10A4AFC
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0x10A4B48
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0x10A4B94
