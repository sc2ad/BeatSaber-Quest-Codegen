...
namespace UnityEngine::TextCore {
  ...
  struct GlyphRect/*, public System::ValueType, public System::IEquatable_1<UnityEngine::TextCore::GlyphRect>*/ {
    ...
    // [NativeNameAttribute] Offset: 0xCD605C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0xCD60A8
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [NativeNameAttribute] Offset: 0xCD60F4
    ...
    // Offset: 0xE15E94
    bool Equals_NEW(UnityEngine::TextCore::GlyphRect other);
