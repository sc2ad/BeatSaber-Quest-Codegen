...
constexpr TextProcessingStack_1(::ArrayW<int32_t> itemStack, int32_t index, int32_t m_DefaultItem, int32_t m_Capacity, int32_t m_RolloverSize, int32_t m_Count) noexcept;
