...
//  Writing Method size for method: ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::*)(::UnityEngine::Font, ::UnityEngine::TextCore::Text::FontAsset)>(&::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2bc8d1c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap>::get(),
                            ".ctor",
...
constexpr ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap(::UnityEngine::Font font, ::UnityEngine::TextCore::Text::FontAsset fontAsset) noexcept : ::bs_hook::ValueTypeWrapper() {this->font = font;
this->fontAsset = fontAsset;
}
constexpr void ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::__set_font(::UnityEngine::Font value)  {
::cordl_internals::setInstanceField<::UnityEngine::Font, 0x0>(this->__instance, std::forward<::UnityEngine::Font>(value));
}
constexpr ::UnityEngine::Font ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::__get_font() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Font, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::__set_fontAsset(::UnityEngine::TextCore::Text::FontAsset value)  {
...
constexpr ::UnityEngine::TextCore::Text::FontAsset ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::__get_fontAsset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextCore::Text::FontAsset, 0x8>(this->__instance);
}
 void ::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap::_ctor(::UnityEngine::Font font, ::UnityEngine::TextCore::Text::FontAsset fontAsset)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::UnityEngine::TextCore::Text::TextSettings::__set_m_FontReferences(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap>, 0x98>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap> ::UnityEngine::TextCore::Text::TextSettings::__get_m_FontReferences() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::____UnityEngine__TextCore__Text__TextSettings__FontReferenceMap>, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
