...
//  Writing Method size for method: UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::*)(int32_t, int32_t, int32_t, UnityEngine::TextCore::Text::FontAsset)>(&UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x2bd21b8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef>::get(),
                            ".ctor",
...
constexpr UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef(int32_t nameHashCode, int32_t familyNameHashCode, int32_t styleNameHashCode, int64_t familyNameAndStyleHashCode, UnityEngine::TextCore::Text::FontAsset fontAsset) noexcept : ::bs_hook::ValueTypeWrapper() {this->nameHashCode = nameHashCode;
...
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__set_nameHashCode(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__get_nameHashCode() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__set_familyNameHashCode(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x4>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__get_familyNameHashCode() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__set_styleNameHashCode(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x8>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__get_styleNameHashCode() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__set_familyNameAndStyleHashCode(int64_t value)  {
::cordl_internals::setInstanceField<int64_t, 0x10>(this->__instance, std::forward<int64_t>(value));
}
constexpr int64_t UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__get_familyNameAndStyleHashCode() const {
return ::cordl_internals::getInstanceField<int64_t, 0x10>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__set_fontAsset(UnityEngine::TextCore::Text::FontAsset value)  {
...
constexpr UnityEngine::TextCore::Text::FontAsset UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::__get_fontAsset() const {
return ::cordl_internals::getInstanceField<UnityEngine::TextCore::Text::FontAsset, 0x18>(this->__instance);
}
 void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef::_ctor(int32_t nameHashCode, int32_t familyNameHashCode, int32_t styleNameHashCode, UnityEngine::TextCore::Text::FontAsset fontAsset)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::TextCore::Text::FontAsset)>(&UnityEngine::TextCore::Text::TextResourceManager::AddFontAsset)> {
 ...
 void UnityEngine::TextCore::Text::TextResourceManager::__set_s_FontAssetReferences(System::Collections::Generic::Dictionary_2<int32_t,UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef> value)  {
::cordl_internals::setStaticField<System::Collections::Generic::Dictionary_2<int32_t,UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef>, "s_FontAssetReferences", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::TextResourceManager>::get>(std::forward<System::Collections::Generic::Dictionary_2<int32_t,UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef>>(value));
}
 System::Collections::Generic::Dictionary_2<int32_t,UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef> UnityEngine::TextCore::Text::TextResourceManager::__get_s_FontAssetReferences()  {
return ::cordl_internals::getStaticField<System::Collections::Generic::Dictionary_2<int32_t,UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextResourceManager__FontAssetRef>, "s_FontAssetReferences", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::TextResourceManager>::get>();
}
