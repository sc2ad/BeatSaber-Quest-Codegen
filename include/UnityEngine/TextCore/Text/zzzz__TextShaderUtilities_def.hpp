...
class CORDL_TYPE TextShaderUtilities : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~TextShaderUtilities() = default;

// Ctor Parameters [CppParam { name: "", ty: "TextShaderUtilities", modifiers: " const&", def_value: None }]
constexpr TextShaderUtilities(TextShaderUtilities const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "TextShaderUtilities", modifiers: "&&", def_value: None }]
constexpr TextShaderUtilities(TextShaderUtilities&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit TextShaderUtilities(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr TextShaderUtilities& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr TextShaderUtilities& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr TextShaderUtilities& operator=(TextShaderUtilities&& o) noexcept = default;
  constexpr TextShaderUtilities& operator=(TextShaderUtilities const& o) noexcept = default;
