...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::*)(UnityEngine::TextCore::Text::Character, int32_t)>(&UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::_ctor)> {
  constexpr static std::size_t size = 0xec;
  constexpr static std::size_t addrs = 0x2bca0f8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter>::get(),
                            ".ctor",
...
constexpr UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter(UnityEngine::TextCore::Text::Character character, UnityEngine::TextCore::Text::FontAsset fontAsset, UnityEngine::Material material, int32_t materialIndex) noexcept : ::bs_hook::ValueTypeWrapper() {this->character = character;
this->fontAsset = fontAsset;
this->material = material;
this->materialIndex = materialIndex;
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__set_character(UnityEngine::TextCore::Text::Character value)  {
...
constexpr UnityEngine::TextCore::Text::Character UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__get_character() const {
return ::cordl_internals::getInstanceField<UnityEngine::TextCore::Text::Character, 0x0>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__set_fontAsset(UnityEngine::TextCore::Text::FontAsset value)  {
...
constexpr UnityEngine::TextCore::Text::FontAsset UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__get_fontAsset() const {
return ::cordl_internals::getInstanceField<UnityEngine::TextCore::Text::FontAsset, 0x8>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__set_material(UnityEngine::Material value)  {
::cordl_internals::setInstanceField<UnityEngine::Material, 0x10>(this->__instance, std::forward<UnityEngine::Material>(value));
}
constexpr UnityEngine::Material UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__get_material() const {
return ::cordl_internals::getInstanceField<UnityEngine::Material, 0x10>(this->__instance);
}
constexpr void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__set_materialIndex(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x18>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::__get_materialIndex() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->__instance);
}
 void UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter::_ctor(UnityEngine::TextCore::Text::Character character, int32_t materialIndex)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void UnityEngine::TextCore::Text::TextGenerator::__set_m_Ellipsis(UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter value)  {
::cordl_internals::setInstanceField<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter, 0xa00>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter>(value));
}
constexpr UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter UnityEngine::TextCore::Text::TextGenerator::__get_m_Ellipsis() const {
return ::cordl_internals::getInstanceField<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter, 0xa00>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void UnityEngine::TextCore::Text::TextGenerator::__set_m_Underline(UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter value)  {
::cordl_internals::setInstanceField<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter, 0xa20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter>(value));
}
constexpr UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter UnityEngine::TextCore::Text::TextGenerator::__get_m_Underline() const {
return ::cordl_internals::getInstanceField<UnityEngine::TextCore::Text::UnityEngine__TextCore__Text__TextGenerator__SpecialCharacter, 0xa20>(this->::bs_hook::Il2CppWrapperType::instance);
}
