...
namespace UnityEngine::TestRunner::TestLaunchers {
  ...
  check_size<sizeof(RemoteTestData), 128 + sizeof(void*) + ((128 + sizeof(void*)) % 8 != 0 ? (8 - (128 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestRunner_TestLaunchers_RemoteTestDataSizeCheck;
}
