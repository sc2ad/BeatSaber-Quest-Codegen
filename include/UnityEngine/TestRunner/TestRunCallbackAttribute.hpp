...
namespace UnityEngine::TestRunner {
  ...
  check_size<sizeof(TestRunCallbackAttribute), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestRunner_TestRunCallbackAttributeSizeCheck;
}
