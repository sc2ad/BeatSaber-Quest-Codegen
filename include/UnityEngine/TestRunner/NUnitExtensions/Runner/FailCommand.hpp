...
namespace UnityEngine::TestRunner::NUnitExtensions::Runner {
  ...
  class FailCommand : public UnityEngine::TestRunner::NUnitExtensions::Runner::IEnumerableTestMethodCommand, public NUnit::Framework::Internal::Commands::TestCommand {
    public:
