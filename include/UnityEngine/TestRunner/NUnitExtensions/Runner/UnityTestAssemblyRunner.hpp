...
namespace UnityEngine::TestRunner::NUnitExtensions::Runner {
  ...
  check_size<sizeof(UnityTestAssemblyRunner), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestRunner_NUnitExtensions_Runner_UnityTestAssemblyRunnerSizeCheck;
}
