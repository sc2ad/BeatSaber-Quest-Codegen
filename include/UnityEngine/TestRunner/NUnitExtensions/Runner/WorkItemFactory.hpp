...
namespace UnityEngine::TestRunner::NUnitExtensions::Runner {
  ...
  class WorkItemFactory : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    UnityEngine::TestRunner::NUnitExtensions::Runner::UnityWorkItem* Create_NEW(NUnit::Framework::Internal::TestMethod* method, NUnit::Framework::Interfaces::ITestFilter* filter, NUnit::Framework::Interfaces::ITest* loadedTest);
