...
namespace UnityEngine::TestRunner::Utils {
  ...
  check_size<sizeof(TestRunCallbackListener::$$c__DisplayClass5_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestRunner_Utils_TestRunCallbackListener_$$c__DisplayClass5_0SizeCheck;
}
