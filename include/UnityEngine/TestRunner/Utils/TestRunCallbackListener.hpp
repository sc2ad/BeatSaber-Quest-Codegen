...
namespace UnityEngine::TestRunner::Utils {
  ...
  check_size<sizeof(TestRunCallbackListener), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestRunner_Utils_TestRunCallbackListenerSizeCheck;
}
