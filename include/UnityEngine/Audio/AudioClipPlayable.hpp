...
namespace UnityEngine::Audio {
  ...
  struct AudioClipPlayable : public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Audio::AudioClipPlayable>, public System::ValueType {
    public:
