...
namespace UnityEngine::Audio {
  ...
  class AudioPlayableBinding : public ::CsObject {
    public:
    // static public UnityEngine.Playables.PlayableBinding Create(System.String name, UnityEngine.Object key)
    // Offset: 0x195479C
    static UnityEngine::Playables::PlayableBinding Create(::CsString* name, UnityEngine::Object* key);
    ...
    // Offset: 0x19548BC
    static UnityEngine::Playables::PlayableOutput CreateAudioOutput(UnityEngine::Playables::PlayableGraph graph, ::CsString* name);
