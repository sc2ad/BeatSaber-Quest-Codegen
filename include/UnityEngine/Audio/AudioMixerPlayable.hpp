...
namespace UnityEngine::Audio {
  ...
  // [] Offset: FFFFFFFF
  // [StaticAccessorAttribute] Offset: CCF43C
  // [RequiredByNativeCodeAttribute] Offset: CCF43C
  // [NativeHeaderAttribute] Offset: CCF43C
  // [NativeHeaderAttribute] Offset: CCF43C
  // [NativeHeaderAttribute] Offset: CCF43C
  struct AudioMixerPlayable/*, public System::ValueType, public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Audio::AudioMixerPlayable>*/ {
    ...
    // Offset: 0xE15F68
    bool Equals_NEW(UnityEngine::Audio::AudioMixerPlayable other);
