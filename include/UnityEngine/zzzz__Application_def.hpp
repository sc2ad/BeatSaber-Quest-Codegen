...
namespace UnityEngine {
class ____UnityEngine__Application__LogCallback;
}
namespace UnityEngine {
class ____UnityEngine__Application__LowMemoryCallback;
}
...
class CORDL_TYPE ____UnityEngine__Application__LowMemoryCallback : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__Application__LowMemoryCallback() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Application__LowMemoryCallback", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Application__LowMemoryCallback(____UnityEngine__Application__LowMemoryCallback const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Application__LowMemoryCallback", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Application__LowMemoryCallback(____UnityEngine__Application__LowMemoryCallback&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Application__LowMemoryCallback(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__Application__LowMemoryCallback& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Application__LowMemoryCallback& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Application__LowMemoryCallback& operator=(____UnityEngine__Application__LowMemoryCallback&& o) noexcept = default;
  constexpr ____UnityEngine__Application__LowMemoryCallback& operator=(____UnityEngine__Application__LowMemoryCallback const& o) noexcept = default;
...
explicit ____UnityEngine__Application__LowMemoryCallback(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
class CORDL_TYPE ____UnityEngine__Application__LogCallback : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__Application__LogCallback() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Application__LogCallback", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Application__LogCallback(____UnityEngine__Application__LogCallback const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Application__LogCallback", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Application__LogCallback(____UnityEngine__Application__LogCallback&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Application__LogCallback(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__Application__LogCallback& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Application__LogCallback& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Application__LogCallback& operator=(____UnityEngine__Application__LogCallback&& o) noexcept = default;
  constexpr ____UnityEngine__Application__LogCallback& operator=(____UnityEngine__Application__LogCallback const& o) noexcept = default;
...
// Ctor Parameters [CppParam { name: "object", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "method", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
explicit ____UnityEngine__Application__LogCallback(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using LogCallback = ::UnityEngine::____UnityEngine__Application__LogCallback;

using LowMemoryCallback = ::UnityEngine::____UnityEngine__Application__LowMemoryCallback;
...
static ::UnityEngine::____UnityEngine__Application__LowMemoryCallback __declspec(property(get=__get_lowMemory, put=__set_lowMemory))  lowMemory;

static void __set_lowMemory(::UnityEngine::____UnityEngine__Application__LowMemoryCallback value) ;

static ::UnityEngine::____UnityEngine__Application__LowMemoryCallback __get_lowMemory() ;

static ::UnityEngine::____UnityEngine__Application__LogCallback __declspec(property(get=__get_s_LogCallbackHandler, put=__set_s_LogCallbackHandler))  s_LogCallbackHandler;

static void __set_s_LogCallbackHandler(::UnityEngine::____UnityEngine__Application__LogCallback value) ;

static ::UnityEngine::____UnityEngine__Application__LogCallback __get_s_LogCallbackHandler() ;

static ::UnityEngine::____UnityEngine__Application__LogCallback __declspec(property(get=__get_s_LogCallbackHandlerThreaded, put=__set_s_LogCallbackHandlerThreaded))  s_LogCallbackHandlerThreaded;

static void __set_s_LogCallbackHandlerThreaded(::UnityEngine::____UnityEngine__Application__LogCallback value) ;

static ::UnityEngine::____UnityEngine__Application__LogCallback __get_s_LogCallbackHandlerThreaded() ;
...
static void add_logMessageReceived(::UnityEngine::____UnityEngine__Application__LogCallback value) ;

/// @brief Method remove_logMessageReceived addr 0x2b68cc4 size 0xa8 virtual false final false
static void remove_logMessageReceived(::UnityEngine::____UnityEngine__Application__LogCallback value) ;
...
NEED_NO_BOX(::UnityEngine::____UnityEngine__Application__LogCallback);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__Application__LogCallback, "UnityEngine", "Application/LogCallback");
NEED_NO_BOX(::UnityEngine::____UnityEngine__Application__LowMemoryCallback);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__Application__LowMemoryCallback, "UnityEngine", "Application/LowMemoryCallback");
