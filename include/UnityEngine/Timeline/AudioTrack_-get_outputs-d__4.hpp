...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(AudioTrack::$get_outputs$d__4), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __UnityEngine_Timeline_AudioTrack_$get_outputs$d__4SizeCheck;
}
