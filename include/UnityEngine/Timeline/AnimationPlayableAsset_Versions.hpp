...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(AnimationPlayableAsset::Versions), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Timeline_AnimationPlayableAsset_VersionsSizeCheck;
}
