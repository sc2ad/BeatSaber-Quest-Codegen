...
namespace UnityEngine::Timeline {
  ...
  // [] Offset: FFFFFFFF
  // [TrackClipTypeAttribute] Offset: CE92AC
  // [TrackBindingTypeAttribute] Offset: CE92AC
  // [ExcludeFromPresetAttribute] Offset: CE92AC
  class ActivationTrack : public UnityEngine::Timeline::TrackAsset {
    ...
    // Offset: 0x1660FD8
    // Implemented from: UnityEngine.Timeline.TrackAsset
    // Base method: UnityEngine.Playables.Playable TrackAsset::CreateTrackMixer_NEW(UnityEngine.Playables.PlayableGraph graph, UnityEngine.GameObject go, System.Int32 inputCount)
