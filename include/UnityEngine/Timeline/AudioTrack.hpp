...
namespace UnityEngine::Timeline {
  ...
  // [] Offset: FFFFFFFF
  // [TrackClipTypeAttribute] Offset: CE945C
  // [TrackBindingTypeAttribute] Offset: CE945C
  // [ExcludeFromPresetAttribute] Offset: CE945C
  class AudioTrack : public UnityEngine::Timeline::TrackAsset {
    ...
    // Base method: UnityEngine.Playables.Playable TrackAsset::CompileClips_NEW(UnityEngine.Playables.PlayableGraph graph, UnityEngine.GameObject go, System.Collections.Generic.IList`1<UnityEngine.Timeline.TimelineClip> timelineClips, UnityEngine.Timeline.IntervalTree`1<UnityEngine.Timeline.RuntimeElement> tree)
