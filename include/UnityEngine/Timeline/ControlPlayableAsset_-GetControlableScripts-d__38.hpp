...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(ControlPlayableAsset::$GetControlableScripts$d__38), 64 + sizeof(int) + ((64 + sizeof(int)) % 8 != 0 ? (8 - (64 + sizeof(int)) % 8) : 0)> __UnityEngine_Timeline_ControlPlayableAsset_$GetControlableScripts$d__38SizeCheck;
}
