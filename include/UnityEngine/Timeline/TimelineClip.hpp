...
namespace UnityEngine::Timeline {
  ...
  class TimelineClip : public ::CsObject, public UnityEngine::Timeline::ICurvesOwner, public UnityEngine::ISerializationCallbackReceiver {
    public:
    ...
    // Offset: 0x80
    System::Collections::Generic::List_1<::CsString*>* m_ExposedParameterNames;
    ...
    // Offset: 0x1090FFC
    System::Collections::Generic::List_1<::CsString*>* get_exposedParameters();
