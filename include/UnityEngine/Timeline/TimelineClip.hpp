...
namespace UnityEngine::Timeline {
  ...
  class TimelineClip : public ::Il2CppObject/*, public UnityEngine::Timeline::ICurvesOwner, public UnityEngine::ISerializationCallbackReceiver*/ {
    ...
    check_size<sizeof(TimelineClip::ClipExtrapolation), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_Timeline_TimelineClip_ClipExtrapolationSizeCheck;
    ...
    check_size<sizeof(TimelineClip::BlendCurveMode), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_Timeline_TimelineClip_BlendCurveModeSizeCheck;
  ...
  check_size<sizeof(TimelineClip), 176 + sizeof(void*) + 8 - (176 + sizeof(void*)) % 8> __UnityEngine_Timeline_TimelineClipSizeCheck;
}
