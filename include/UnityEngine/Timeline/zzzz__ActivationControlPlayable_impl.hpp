...
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::Active{0};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::Inactive{1};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState::Revert{2};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::____UnityEngine__Timeline__ActivationControlPlayable__InitialState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::Unset{0};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::Active{1};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState::Inactive{2};
//  Writing Method size for method: ::UnityEngine::Timeline::ActivationControlPlayable.Create
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Playables::ScriptPlayable_1<::UnityEngine::Timeline::ActivationControlPlayable> (*)(::UnityEngine::Playables::PlayableGraph, ::UnityEngine::GameObject, ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState)>(&::UnityEngine::Timeline::ActivationControlPlayable::Create)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Playables::PlayableGraph>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::GameObject>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState>::get()}
                        )));
...
constexpr void ::UnityEngine::Timeline::ActivationControlPlayable::__set_postPlayback(::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState value)  {
::cordl_internals::setInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState>(value));
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState ::UnityEngine::Timeline::ActivationControlPlayable::__get_postPlayback() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::UnityEngine::Timeline::ActivationControlPlayable::__set_m_InitialState(::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState value)  {
::cordl_internals::setInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState>(value));
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState ::UnityEngine::Timeline::ActivationControlPlayable::__get_m_InitialState() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__InitialState, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
 ::UnityEngine::Playables::ScriptPlayable_1<::UnityEngine::Timeline::ActivationControlPlayable> ::UnityEngine::Timeline::ActivationControlPlayable::Create(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject gameObject, ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationControlPlayable__PostPlaybackState postPlaybackState)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::ActivationControlPlayable>::get(),
                            "Create",
                            std::vector<Il2CppClass*>{},
