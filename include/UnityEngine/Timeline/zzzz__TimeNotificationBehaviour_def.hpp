...
struct CORDL_TYPE UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry(double_t time, UnityEngine::Playables::INotification payload, bool notificationFired, UnityEngine::Timeline::NotificationFlags flags) noexcept;


                    constexpr UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry(UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry const&) = default;
                    constexpr UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry(UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry&&) = default;
                    constexpr UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry& operator=(UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry& operator=(UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry&& o) noexcept {
...
constexpr explicit UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE UnityEngine__Timeline__TimeNotificationBehaviour____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__Timeline__TimeNotificationBehaviour____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__Timeline__TimeNotificationBehaviour____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c(UnityEngine__Timeline__TimeNotificationBehaviour____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__Timeline__TimeNotificationBehaviour____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c(UnityEngine__Timeline__TimeNotificationBehaviour____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__Timeline__TimeNotificationBehaviour____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c& operator=(UnityEngine__Timeline__TimeNotificationBehaviour____c&& o) noexcept = default;
  constexpr UnityEngine__Timeline__TimeNotificationBehaviour____c& operator=(UnityEngine__Timeline__TimeNotificationBehaviour____c const& o) noexcept = default;
                


// Fields

static UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c value) ;

static UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c __get___9() ;

static System::Comparison_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> __declspec(property(get=__get___9__12_0, put=__set___9__12_0))  __9__12_0;

static void __set___9__12_0(System::Comparison_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> value) ;

static System::Comparison_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> __get___9__12_0() ;
...
/// @brief Method <SortNotifications>b__12_0 addr 0x2ad5bc8 size 0x10 virtual false final false
 int32_t _SortNotifications_b__12_0(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry x, UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry y) ;
...
public:
// Declarations
using __c = UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c;

using NotificationEntry = UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry;
...
// Fields
 ...
 System::Collections::Generic::List_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> __declspec(property(get=__get_m_Notifications, put=__set_m_Notifications))  m_Notifications;

constexpr void __set_m_Notifications(System::Collections::Generic::List_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> __get_m_Notifications() const;
...
static bool CanRestoreNotification(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry e, UnityEngine::Playables::FrameData info, double_t currentTime, double_t previousTime) ;
...
static void Trigger_internal(UnityEngine::Playables::Playable playable, UnityEngine::Playables::PlayableOutput output, ByRef<UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry> e) ;
...
NEED_NO_BOX(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour____c, "UnityEngine.Timeline", "TimeNotificationBehaviour/<>c");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::Timeline::UnityEngine__Timeline__TimeNotificationBehaviour__NotificationEntry, "UnityEngine.Timeline", "TimeNotificationBehaviour/NotificationEntry");
