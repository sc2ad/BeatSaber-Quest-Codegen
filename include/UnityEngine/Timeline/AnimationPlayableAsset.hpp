...
namespace UnityEngine::Timeline {
  ...
  class AnimationPlayableAsset : public UnityEngine::Timeline::ITimelineClipAsset, public UnityEngine::Timeline::IPropertyPreview, public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::Playables::PlayableAsset {
    public:
