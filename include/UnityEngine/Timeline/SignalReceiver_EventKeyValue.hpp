...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(SignalReceiver::EventKeyValue), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __UnityEngine_Timeline_SignalReceiver_EventKeyValueSizeCheck;
}
