...
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::____UnityEngine__Timeline__IntervalTree_1__Entry(int64_t intervalStart, int64_t intervalEnd, T item) noexcept : ::bs_hook::ValueTypeWrapper() {this->intervalStart = intervalStart;
this->intervalEnd = intervalEnd;
this->item = item;
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__set_intervalStart(int64_t value)  {
::cordl_internals::setInstanceField<int64_t, 0x0>(this->__instance, std::forward<int64_t>(value));
}
constexpr int64_t ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__get_intervalStart() const {
return ::cordl_internals::getInstanceField<int64_t, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__set_intervalEnd(int64_t value)  {
::cordl_internals::setInstanceField<int64_t, 0x8>(this->__instance, std::forward<int64_t>(value));
}
constexpr int64_t ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__get_intervalEnd() const {
return ::cordl_internals::getInstanceField<int64_t, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__set_item(T value)  {
::cordl_internals::setInstanceField<T, 0x10>(this->__instance, std::forward<T>(value));
}
constexpr T ::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry::__get_item() const {
...
constexpr void ::UnityEngine::Timeline::IntervalTree_1::__set_m_Entries(::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry<T>> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry<T>>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry<T>>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry<T>> ::UnityEngine::Timeline::IntervalTree_1::__get_m_Entries() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__IntervalTree_1__Entry<T>>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
