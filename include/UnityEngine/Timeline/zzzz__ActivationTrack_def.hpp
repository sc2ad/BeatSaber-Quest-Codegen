...
struct CORDL_TYPE UnityEngine__Timeline__ActivationTrack__PostPlaybackState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__Timeline__ActivationTrack__PostPlaybackState(int32_t value__) noexcept;


                    constexpr UnityEngine__Timeline__ActivationTrack__PostPlaybackState(UnityEngine__Timeline__ActivationTrack__PostPlaybackState const&) = default;
                    constexpr UnityEngine__Timeline__ActivationTrack__PostPlaybackState(UnityEngine__Timeline__ActivationTrack__PostPlaybackState&&) = default;
                    constexpr UnityEngine__Timeline__ActivationTrack__PostPlaybackState& operator=(UnityEngine__Timeline__ActivationTrack__PostPlaybackState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__Timeline__ActivationTrack__PostPlaybackState& operator=(UnityEngine__Timeline__ActivationTrack__PostPlaybackState&& o) noexcept {
...
constexpr explicit UnityEngine__Timeline__ActivationTrack__PostPlaybackState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__Timeline__ActivationTrack__PostPlaybackState_Unwrapped : int32_t {
__Active = 0,
__Inactive = 1,
__Revert = 2,
__LeaveAsIs = 3,
...
static UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState const Active;

/// @brief Field Inactive offset 0
static UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState const Inactive;

/// @brief Field Revert offset 0
static UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState const Revert;

/// @brief Field LeaveAsIs offset 0
static UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState const LeaveAsIs;
...
public:
// Declarations
using PostPlaybackState = UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState, "UnityEngine.Timeline", "ActivationTrack/PostPlaybackState");
