...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(TrackBindingTypeAttribute), 24 + sizeof(UnityEngine::Timeline::TrackBindingFlags) + ((24 + sizeof(UnityEngine::Timeline::TrackBindingFlags)) % 8 != 0 ? (8 - (24 + sizeof(UnityEngine::Timeline::TrackBindingFlags)) % 8) : 0)> __UnityEngine_Timeline_TrackBindingTypeAttributeSizeCheck;
}
