...
namespace UnityEngine::Timeline {
  ...
  class BasicPlayableBehaviour : public UnityEngine::Playables::IPlayableAsset, public UnityEngine::Playables::IPlayableBehaviour, public UnityEngine::ScriptableObject {
    public:
