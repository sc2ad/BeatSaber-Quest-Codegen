...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(AudioPlayableAsset::$get_outputs$d__16), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __UnityEngine_Timeline_AudioPlayableAsset_$get_outputs$d__16SizeCheck;
}
