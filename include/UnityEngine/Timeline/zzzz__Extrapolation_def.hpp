...
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__Extrapolation____c;
}
// Type: ::<>c
namespace UnityEngine::Timeline {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__Timeline__Extrapolation____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__Timeline__Extrapolation____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__Extrapolation____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__Extrapolation____c(____UnityEngine__Timeline__Extrapolation____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__Extrapolation____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__Extrapolation____c(____UnityEngine__Timeline__Extrapolation____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__Extrapolation____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__Extrapolation____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__Extrapolation____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__Extrapolation____c& operator=(____UnityEngine__Timeline__Extrapolation____c&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__Extrapolation____c& operator=(____UnityEngine__Timeline__Extrapolation____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c value) ;

static ::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__Timeline__Extrapolation____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c;
...
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__Extrapolation____c, "UnityEngine.Timeline", "Extrapolation/<>c");
