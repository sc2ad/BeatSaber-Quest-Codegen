...
namespace UnityEngine::Timeline {
  ...
  class ControlPlayableAsset : public UnityEngine::Timeline::IPropertyPreview, public UnityEngine::Timeline::ITimelineClipAsset, public UnityEngine::Playables::PlayableAsset {
    public:
