...
namespace UnityEngine::Timeline {
  ...
  class TrackAsset : public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::Timeline::IPropertyPreview, public UnityEngine::Timeline::ICurvesOwner, public UnityEngine::Playables::PlayableAsset {
    public:
