...
namespace UnityEngine::Timeline {
struct ____UnityEngine__Timeline__TimelineAsset__DurationMode;
}
namespace UnityEngine::Timeline {
struct ____UnityEngine__Timeline__TimelineAsset__MediaType;
}
namespace UnityEngine::Timeline {
struct ____UnityEngine__Timeline__TimelineAsset__Versions;
}
namespace UnityEngine::Timeline {
class TimelineAsset;
}
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__TimelineAsset__EditorSettings;
}
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade;
}
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27;
}
// Type: ::Versions
namespace UnityEngine::Timeline {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset__Versions : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__Versions(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Timeline__TimelineAsset__Versions(____UnityEngine__Timeline__TimelineAsset__Versions const&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__Versions(____UnityEngine__Timeline__TimelineAsset__Versions&&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__Versions& operator=(____UnityEngine__Timeline__TimelineAsset__Versions const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Timeline__TimelineAsset__Versions& operator=(____UnityEngine__Timeline__TimelineAsset__Versions&& o) noexcept {
...
constexpr explicit ____UnityEngine__Timeline__TimelineAsset__Versions(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Timeline__TimelineAsset__Versions_Unwrapped : int32_t {
__Initial = 0,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__Timeline__TimelineAsset__Versions_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Timeline__TimelineAsset__Versions_Unwrapped>(__instance);
}
...
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__Versions const Initial;
...
class CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade(____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade(____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade& operator=(____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade& operator=(____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade const& o) noexcept = default;
...
struct CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset__MediaType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__MediaType(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Timeline__TimelineAsset__MediaType(____UnityEngine__Timeline__TimelineAsset__MediaType const&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__MediaType(____UnityEngine__Timeline__TimelineAsset__MediaType&&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__MediaType& operator=(____UnityEngine__Timeline__TimelineAsset__MediaType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Timeline__TimelineAsset__MediaType& operator=(____UnityEngine__Timeline__TimelineAsset__MediaType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__TimelineAsset__MediaType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Timeline__TimelineAsset__MediaType_Unwrapped : int32_t {
__Animation = 0,
__Audio = 1,
__Texture = 2,
__Video = 2,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__Timeline__TimelineAsset__MediaType_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Timeline__TimelineAsset__MediaType_Unwrapped>(__instance);
}
...
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Animation;

/// @brief Field Audio offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Audio;

/// @brief Field Texture offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Texture;

/// @brief Field Video offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Video;

/// @brief Field Script offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Script;

/// @brief Field Hybrid offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Hybrid;

/// @brief Field Group offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType const Group;
...
struct CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset__DurationMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__DurationMode(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Timeline__TimelineAsset__DurationMode(____UnityEngine__Timeline__TimelineAsset__DurationMode const&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__DurationMode(____UnityEngine__Timeline__TimelineAsset__DurationMode&&) = default;
                    constexpr ____UnityEngine__Timeline__TimelineAsset__DurationMode& operator=(____UnityEngine__Timeline__TimelineAsset__DurationMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Timeline__TimelineAsset__DurationMode& operator=(____UnityEngine__Timeline__TimelineAsset__DurationMode&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__TimelineAsset__DurationMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Timeline__TimelineAsset__DurationMode_Unwrapped : int32_t {
__BasedOnClips = 0,
__FixedLength = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__Timeline__TimelineAsset__DurationMode_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Timeline__TimelineAsset__DurationMode_Unwrapped>(__instance);
}
...
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode const BasedOnClips;

/// @brief Field FixedLength offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode const FixedLength;
...
class CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset__EditorSettings : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____UnityEngine__Timeline__TimelineAsset__EditorSettings() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset__EditorSettings", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings(____UnityEngine__Timeline__TimelineAsset__EditorSettings const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset__EditorSettings", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings(____UnityEngine__Timeline__TimelineAsset__EditorSettings&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__TimelineAsset__EditorSettings(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings& operator=(____UnityEngine__Timeline__TimelineAsset__EditorSettings&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__TimelineAsset__EditorSettings& operator=(____UnityEngine__Timeline__TimelineAsset__EditorSettings const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__Timeline__TimelineAsset__EditorSettings() ;
...
class CORDL_TYPE ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27(____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27(____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27& operator=(____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27& operator=(____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27 const& o) noexcept = default;
...
explicit ____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27(int32_t __1__state) ;
...
public:
// Declarations
using _get_outputs_d__27 = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27;

using EditorSettings = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings;

using DurationMode = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode;

using MediaType = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType;

using TimelineAssetUpgrade = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade;

using Versions = ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__Versions;
...
constexpr ::ArrayW<::UnityEngine::Timeline::TrackAsset> __get_m_CacheFlattenedTracks() const;
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings __declspec(property(get=__get_m_EditorSettings, put=__set_m_EditorSettings))  m_EditorSettings;

constexpr void __set_m_EditorSettings(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings value) ;

constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings __get_m_EditorSettings() const;

 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode __declspec(property(get=__get_m_DurationMode, put=__set_m_DurationMode))  m_DurationMode;

constexpr void __set_m_DurationMode(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode value) ;

constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode __get_m_DurationMode() const;
...
// Properties
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings __declspec(property(get=get_editorSettings))  editorSettings;
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode __declspec(property(get=get_durationMode, put=set_durationMode))  durationMode;
...
/// @brief Method get_editorSettings addr 0x2abea2c size 0x8 virtual false final false
 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings get_editorSettings() ;
...
/// @brief Method get_durationMode addr 0x2abee0c size 0x8 virtual false final false
 ::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode get_durationMode() ;

/// @brief Method set_durationMode addr 0x2abee14 size 0x8 virtual false final false
 void set_durationMode(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__DurationMode, "UnityEngine.Timeline", "TimelineAsset/DurationMode");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__MediaType, "UnityEngine.Timeline", "TimelineAsset/MediaType");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__Versions, "UnityEngine.Timeline", "TimelineAsset/Versions");
...
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__EditorSettings, "UnityEngine.Timeline", "TimelineAsset/EditorSettings");
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset__TimelineAssetUpgrade, "UnityEngine.Timeline", "TimelineAsset/TimelineAssetUpgrade");
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__TimelineAsset___get_outputs_d__27, "UnityEngine.Timeline", "TimelineAsset/<get_outputs>d__27");
