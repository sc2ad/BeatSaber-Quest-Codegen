...
namespace UnityEngine::Timeline {
  ...
  class TimelineAsset : public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::Timeline::ITimelineClipAsset, public UnityEngine::Timeline::IPropertyPreview, public UnityEngine::Playables::PlayableAsset {
    public:
