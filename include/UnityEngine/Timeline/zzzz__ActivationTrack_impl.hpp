...
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::Active{0};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::Inactive{1};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::Revert{2};
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState  ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState::LeaveAsIs{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState (::UnityEngine::Timeline::ActivationTrack::*)()>(&::UnityEngine::Timeline::ActivationTrack::get_postPlaybackState)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Timeline::ActivationTrack::*)(::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState)>(&::UnityEngine::Timeline::ActivationTrack::set_postPlaybackState)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::UnityEngine::Timeline::ActivationTrack::__set_m_PostPlaybackState(::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState value)  {
::cordl_internals::setInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState>(value));
}
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState ::UnityEngine::Timeline::ActivationTrack::__get_m_PostPlaybackState() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState ::UnityEngine::Timeline::ActivationTrack::get_postPlaybackState()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::ActivationTrack>::get(),
                            "get_postPlaybackState",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::UnityEngine::Timeline::ActivationTrack::set_postPlaybackState(::UnityEngine::Timeline::____UnityEngine__Timeline__ActivationTrack__PostPlaybackState value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::Timeline::ActivationTrack>::get(),
                            "set_postPlaybackState",
                            std::vector<Il2CppClass*>{},
