...
namespace UnityEngine::Timeline {
  ...
  check_size<sizeof(TrackAsset::$get_outputs$d__65), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __UnityEngine_Timeline_TrackAsset_$get_outputs$d__65SizeCheck;
}
