...
constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo(::UnityEngine::Playables::Playable mixer, ::UnityEngine::Playables::Playable parentMixer, int32_t port) noexcept : ::bs_hook::ValueTypeWrapper() {this->mixer = mixer;
this->parentMixer = parentMixer;
this->port = port;
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__set_mixer(::UnityEngine::Playables::Playable value)  {
...
constexpr ::UnityEngine::Playables::Playable ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__get_mixer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Playables::Playable, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__set_parentMixer(::UnityEngine::Playables::Playable value)  {
...
constexpr ::UnityEngine::Playables::Playable ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__get_parentMixer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Playables::Playable, 0x10>(this->__instance);
}
constexpr void ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__set_port(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo::__get_port() const {
...
constexpr void ::UnityEngine::Timeline::AnimationOutputWeightProcessor::__set_m_Mixers(::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo> ::UnityEngine::Timeline::AnimationOutputWeightProcessor::__get_m_Mixers() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationOutputWeightProcessor__WeightInfo>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
