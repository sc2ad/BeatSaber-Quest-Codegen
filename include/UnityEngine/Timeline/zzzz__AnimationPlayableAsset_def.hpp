...
namespace UnityEngine::Timeline {
struct ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode;
}
namespace UnityEngine::Timeline {
struct ____UnityEngine__Timeline__AnimationPlayableAsset__Versions;
}
namespace UnityEngine::Timeline {
class AnimationPlayableAsset;
}
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade;
}
namespace UnityEngine::Timeline {
class ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45;
}
// Type: ::LoopMode
namespace UnityEngine::Timeline {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode(____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode const&) = default;
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode(____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode&&) = default;
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode&& o) noexcept {
...
constexpr explicit ____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Timeline__AnimationPlayableAsset__LoopMode_Unwrapped : int32_t {
__UseSourceAsset = 0,
__On = 1,
__Off = 2,
};
...
constexpr operator ______UnityEngine__Timeline__AnimationPlayableAsset__LoopMode_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Timeline__AnimationPlayableAsset__LoopMode_Unwrapped>(__instance);
}
...
static ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode const UseSourceAsset;

/// @brief Field On offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode const On;

/// @brief Field Off offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode const Off;
...
struct CORDL_TYPE ____UnityEngine__Timeline__AnimationPlayableAsset__Versions : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__Versions(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__Versions(____UnityEngine__Timeline__AnimationPlayableAsset__Versions const&) = default;
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__Versions(____UnityEngine__Timeline__AnimationPlayableAsset__Versions&&) = default;
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__Versions& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__Versions const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__Versions& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__Versions&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__AnimationPlayableAsset__Versions(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Timeline__AnimationPlayableAsset__Versions_Unwrapped : int32_t {
__Initial = 0,
__RotationAsEuler = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__Timeline__AnimationPlayableAsset__Versions_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Timeline__AnimationPlayableAsset__Versions_Unwrapped>(__instance);
}
...
static ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__Versions const Initial;

/// @brief Field RotationAsEuler offset 0
static ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__Versions const RotationAsEuler;
...
class CORDL_TYPE ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade(____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade(____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade& operator=(____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade const& o) noexcept = default;
...
class CORDL_TYPE ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45(____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45(____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45& operator=(____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45&& o) noexcept = default;
  constexpr ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45& operator=(____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45 const& o) noexcept = default;
...
explicit ____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45(int32_t __1__state) ;
...
public:
// Declarations
using _get_outputs_d__45 = ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45;

using AnimationPlayableAssetUpgrade = ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade;

using Versions = ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__Versions;

using LoopMode = ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode;
...
constexpr bool __get_m_ApplyFootIK() const;
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode __declspec(property(get=__get_m_Loop, put=__set_m_Loop))  m_Loop;

constexpr void __set_m_Loop(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode value) ;

constexpr ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode __get_m_Loop() const;
...
// Properties
 ...
 ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode __declspec(property(get=get_loop, put=set_loop))  loop;
...
/// @brief Method get_loop addr 0x2ab7064 size 0x8 virtual false final false
 ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode get_loop() ;

/// @brief Method set_loop addr 0x2ab706c size 0x8 virtual false final false
 void set_loop(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode value) ;
...
static ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::AnimationClip clip, ::UnityEngine::Vector3 positionOffset, ::UnityEngine::Vector3 eulerOffset, bool removeStartOffset, ::UnityEngine::Timeline::AppliedOffsetMode mode, bool applyFootIK, ::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode loop) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__LoopMode, "UnityEngine.Timeline", "AnimationPlayableAsset/LoopMode");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__Versions, "UnityEngine.Timeline", "AnimationPlayableAsset/Versions");
...
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset__AnimationPlayableAssetUpgrade, "UnityEngine.Timeline", "AnimationPlayableAsset/AnimationPlayableAssetUpgrade");
NEED_NO_BOX(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Timeline::____UnityEngine__Timeline__AnimationPlayableAsset___get_outputs_d__45, "UnityEngine.Timeline", "AnimationPlayableAsset/<get_outputs>d__45");
