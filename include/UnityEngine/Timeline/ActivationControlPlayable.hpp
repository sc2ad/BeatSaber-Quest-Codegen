...
namespace UnityEngine::Timeline {
  ...
  class ActivationControlPlayable : public UnityEngine::Playables::PlayableBehaviour {
    ...
    check_size<sizeof(ActivationControlPlayable::PostPlaybackState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Timeline_ActivationControlPlayable_PostPlaybackStateSizeCheck;
    ...
    check_size<sizeof(ActivationControlPlayable::InitialState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_Timeline_ActivationControlPlayable_InitialStateSizeCheck;
  ...
  check_size<sizeof(ActivationControlPlayable), 28 + sizeof(UnityEngine::Timeline::ActivationControlPlayable::InitialState) + ((28 + sizeof(UnityEngine::Timeline::ActivationControlPlayable::InitialState)) % 8 != 0 ? (8 - (28 + sizeof(UnityEngine::Timeline::ActivationControlPlayable::InitialState)) % 8) : 0)> __UnityEngine_Timeline_ActivationControlPlayableSizeCheck;
}
