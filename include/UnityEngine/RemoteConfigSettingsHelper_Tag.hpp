...
namespace UnityEngine {
  ...
  check_size<sizeof(RemoteConfigSettingsHelper::Tag), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_RemoteConfigSettingsHelper_TagSizeCheck;
}
