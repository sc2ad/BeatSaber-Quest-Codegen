...
namespace UnityEngine::Assertions {
  ...
  class Assert : public ::CsObject {
    ...
    // Offset: 0x12E93CC
    static void Fail(::CsString* message, ::CsString* userMessage);
    // static public System.Void AreEqual(T expected, T actual, System.String message)
    // Offset: 0xFFFFFFFF
    template<class T>
    static void AreEqual(T expected, T actual, ::CsString* message) {
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static void AreEqual(T expected, T actual, ::CsString* message, System::Collections::Generic::IEqualityComparer_1<T>* comparer) {
    ...
    // Offset: 0x12E9644
    static void AreEqual(UnityEngine::Object* expected, UnityEngine::Object* actual, ::CsString* message);
