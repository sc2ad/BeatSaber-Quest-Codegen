...
namespace UnityEngine {
  ...
  check_size<sizeof(AdditionalCanvasShaderChannels), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_AdditionalCanvasShaderChannelsSizeCheck;
}
