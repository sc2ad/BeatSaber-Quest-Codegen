...
constexpr void UnityEngine::ComputeBuffer::__set_m_Ptr(::cordl_internals::intptr_t value)  {
...
constexpr ::cordl_internals::intptr_t UnityEngine::ComputeBuffer::__get_m_Ptr() const {
