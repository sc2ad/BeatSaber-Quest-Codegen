...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: EE4758
  class ImageConversion : public ::Il2CppObject {
    ...
    // Offset: 0x26D54CC
    static ::Array<uint8_t>* EncodeToTGA(UnityEngine::Texture2D* tex);
    ...
    // Offset: 0x26D55E0
    static ::Array<uint8_t>* EncodeToEXR(UnityEngine::Texture2D* tex, UnityEngine::Texture2D::EXRFlags flags);
    // static public System.Byte[] EncodeToEXR(UnityEngine.Texture2D tex)
    // Offset: 0x26D5630
    static ::Array<uint8_t>* EncodeToEXR(UnityEngine::Texture2D* tex);
    ...
    // Offset: 0x26D56CC
    static bool LoadImage(UnityEngine::Texture2D* tex, ::Array<uint8_t>* data);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<uint8_t>* (*)(UnityEngine::Texture2D*)>(&UnityEngine::ImageConversion::EncodeToTGA)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<uint8_t>* (*)(UnityEngine::Texture2D*, UnityEngine::Texture2D::EXRFlags)>(&UnityEngine::ImageConversion::EncodeToEXR)> {
  static const MethodInfo* get() {
    static auto* tex = &::il2cpp_utils::GetClassFromName("UnityEngine", "Texture2D")->byval_arg;
...
// Il2CppName: EncodeToEXR
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<uint8_t>* (*)(UnityEngine::Texture2D*)>(&UnityEngine::ImageConversion::EncodeToEXR)> {
  static const MethodInfo* get() {
    static auto* tex = &::il2cpp_utils::GetClassFromName("UnityEngine", "Texture2D")->byval_arg;
...
// Il2CppName: LoadImage
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(UnityEngine::Texture2D*, ::Array<uint8_t>*)>(&UnityEngine::ImageConversion::LoadImage)> {
  static const MethodInfo* get() {
    static auto* tex = &::il2cpp_utils::GetClassFromName("UnityEngine", "Texture2D")->byval_arg;
    static auto* data = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
