...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Collider (UnityEngine::RaycastHit::*)()>(&UnityEngine::RaycastHit::get_collider)> {
  ...
  constexpr static std::size_t addrs = 0x2b9eb3c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (UnityEngine::RaycastHit::*)()>(&UnityEngine::RaycastHit::get_point)> {
  ...
  constexpr static std::size_t addrs = 0x2b9ebe8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (UnityEngine::RaycastHit::*)()>(&UnityEngine::RaycastHit::get_normal)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2b9ec00;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::RaycastHit::*)(UnityEngine::Vector3)>(&UnityEngine::RaycastHit::set_normal)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2b9ec0c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (UnityEngine::RaycastHit::*)()>(&UnityEngine::RaycastHit::get_distance)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2b9ec18;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::RaycastHit::*)(float_t)>(&UnityEngine::RaycastHit::set_distance)> {
  constexpr static std::size_t size = 0x8;
...
constexpr UnityEngine::RaycastHit::RaycastHit(UnityEngine::Vector3 m_Point, UnityEngine::Vector3 m_Normal, uint32_t m_FaceID, float_t m_Distance, UnityEngine::Vector2 m_UV, int32_t m_Collider) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_Point = m_Point;
...
constexpr void UnityEngine::RaycastHit::__set_m_Point(UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector3, 0x0>(this->__instance, std::forward<UnityEngine::Vector3>(value));
}
constexpr UnityEngine::Vector3 UnityEngine::RaycastHit::__get_m_Point() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector3, 0x0>(this->__instance);
}
constexpr void UnityEngine::RaycastHit::__set_m_Normal(UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector3, 0xc>(this->__instance, std::forward<UnityEngine::Vector3>(value));
}
constexpr UnityEngine::Vector3 UnityEngine::RaycastHit::__get_m_Normal() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector3, 0xc>(this->__instance);
}
constexpr void UnityEngine::RaycastHit::__set_m_FaceID(uint32_t value)  {
::cordl_internals::setInstanceField<uint32_t, 0x18>(this->__instance, std::forward<uint32_t>(value));
}
constexpr uint32_t UnityEngine::RaycastHit::__get_m_FaceID() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x18>(this->__instance);
}
constexpr void UnityEngine::RaycastHit::__set_m_Distance(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x1c>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t UnityEngine::RaycastHit::__get_m_Distance() const {
return ::cordl_internals::getInstanceField<float_t, 0x1c>(this->__instance);
}
constexpr void UnityEngine::RaycastHit::__set_m_UV(UnityEngine::Vector2 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector2, 0x20>(this->__instance, std::forward<UnityEngine::Vector2>(value));
}
constexpr UnityEngine::Vector2 UnityEngine::RaycastHit::__get_m_UV() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector2, 0x20>(this->__instance);
}
constexpr void UnityEngine::RaycastHit::__set_m_Collider(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x28>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::RaycastHit::__get_m_Collider() const {
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Collider, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 float_t UnityEngine::RaycastHit::get_distance()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::RaycastHit>::get(),
                            "get_distance",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void UnityEngine::RaycastHit::set_distance(float_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::RaycastHit>::get(),
                            "set_distance",
                            std::vector<Il2CppClass*>{},
