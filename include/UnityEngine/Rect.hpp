...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: EB2EA4
  // [NativeClassAttribute] Offset: EB2EA4
  ...
  struct Rect/*, public System::ValueType, public System::IEquatable_1<UnityEngine::Rect>*/ {
    ...
    // [NativeNameAttribute] Offset: 0xEB7B4C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xEB7B84
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xEB7BBC
