...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: CB8EEC
  // [NativeClassAttribute] Offset: CB8EEC
  // [RequiredByNativeCodeAttribute] Offset: CB8EEC
  struct Rect/*, public System::ValueType, public System::IEquatable_1<UnityEngine::Rect>*/ {
    public:
    // [NativeNameAttribute] Offset: 0xCBD73C
    ...
    // [NativeNameAttribute] Offset: 0xCBD774
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xCBD7AC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xCBD7E4
