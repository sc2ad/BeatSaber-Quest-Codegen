...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [NativeClassAttribute] Offset: CA7B1C
  // [NativeTypeAttribute] Offset: CA7B1C
  // [DefaultMemberAttribute] Offset: CA7B1C
  // [RequiredByNativeCodeAttribute] Offset: CA7B1C
  // [NativeHeaderAttribute] Offset: CA7B1C
  // [NativeHeaderAttribute] Offset: CA7B1C
  struct Vector3/*, public System::ValueType, public System::IEquatable_1<UnityEngine::Vector3>*/ {
    ...
    // Offset: 0xDFBB08
    bool Equals_NEW(UnityEngine::Vector3 other);
