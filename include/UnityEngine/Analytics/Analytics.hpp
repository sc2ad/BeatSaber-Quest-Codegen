...
namespace UnityEngine::Analytics {
  ...
  class Analytics : public ::CsObject {
    public:
    ...
    // Offset: 0x195976C
    static UnityEngine::Analytics::AnalyticsResult SendCustomEventName(::CsString* customEventName);
    ...
    // Offset: 0x19597EC
    static UnityEngine::Analytics::AnalyticsResult CustomEvent(::CsString* customEventName, System::Collections::Generic::IDictionary_2<::CsString*, ::CsObject*>* eventData);
