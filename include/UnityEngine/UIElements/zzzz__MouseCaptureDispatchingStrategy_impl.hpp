...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior  ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::None{0};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior  ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::IsCapturable{1};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior  ::UnityEngine::UIElements::____UnityEngine__UIElements__MouseCaptureDispatchingStrategy__EventBehavior::IsSentExclusivelyToCapturingElement{2};
