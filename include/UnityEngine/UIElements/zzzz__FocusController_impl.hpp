...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement::____UnityEngine__UIElements__FocusController__FocusedElement(::UnityEngine::UIElements::VisualElement m_SubTreeRoot, ::UnityEngine::UIElements::Focusable m_FocusedElement) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_SubTreeRoot = m_SubTreeRoot;
this->m_FocusedElement = m_FocusedElement;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement::__set_m_SubTreeRoot(::UnityEngine::UIElements::VisualElement value)  {
...
constexpr ::UnityEngine::UIElements::VisualElement ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement::__get_m_SubTreeRoot() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::VisualElement, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement::__set_m_FocusedElement(::UnityEngine::UIElements::Focusable value)  {
...
constexpr ::UnityEngine::UIElements::Focusable ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement::__get_m_FocusedElement() const {
...
constexpr void ::UnityEngine::UIElements::FocusController::__set_m_FocusedElements(::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement> ::UnityEngine::UIElements::FocusController::__get_m_FocusedElements() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
