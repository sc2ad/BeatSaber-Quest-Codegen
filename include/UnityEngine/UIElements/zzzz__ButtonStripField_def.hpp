...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7227)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7227), inst: 92 })}
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7228), inst: 92 }), TypeDefinitionIndex(TypeDefinitionIndex(7228))}
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7202)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7089), inst: 5085 }), TypeDefinitionIndex(TypeDefinitionIndex(7089)), TypeDefinitionIndex(TypeDefinitionIndex(7201))}
