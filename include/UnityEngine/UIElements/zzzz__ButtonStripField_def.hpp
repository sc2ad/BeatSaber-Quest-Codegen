...
static UnityEngine::UIElements::UnityEngine__UIElements__ButtonStripField__UxmlTraits New_ctor() ;
...
static UnityEngine::UIElements::ButtonStripField New_ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7089)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7089), inst: 5085 }), TypeDefinitionIndex(TypeDefinitionIndex(7202)), TypeDefinitionIndex(TypeDefinitionIndex(7201))}
...
static UnityEngine::UIElements::UnityEngine__UIElements__ButtonStripField__UxmlFactory New_ctor() ;
