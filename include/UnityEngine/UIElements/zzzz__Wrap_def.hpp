...
struct CORDL_TYPE Wrap : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr Wrap(int32_t value__) noexcept;
                    ...
                    constexpr Wrap(Wrap const&) = default;
                    constexpr Wrap(Wrap&&) = default;
                    constexpr Wrap& operator=(Wrap const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Wrap& operator=(Wrap&& o) noexcept {
...
constexpr explicit Wrap(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Wrap_Unwrapped : int32_t {
__NoWrap = 0,
__Wrap = 1,
__WrapReverse = 2,
};
...
return std::bit_cast<__Wrap_Unwrapped>(__instance);
}
...
static UnityEngine::UIElements::Wrap const Wrap;
