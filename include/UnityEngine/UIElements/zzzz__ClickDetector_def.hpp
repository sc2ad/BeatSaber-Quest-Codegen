...
class CORDL_TYPE UnityEngine__UIElements__ClickDetector__ButtonClickStatus : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~UnityEngine__UIElements__ClickDetector__ButtonClickStatus() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__ClickDetector__ButtonClickStatus", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus(UnityEngine__UIElements__ClickDetector__ButtonClickStatus const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__ClickDetector__ButtonClickStatus", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus(UnityEngine__UIElements__ClickDetector__ButtonClickStatus&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__ClickDetector__ButtonClickStatus(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus& operator=(UnityEngine__UIElements__ClickDetector__ButtonClickStatus&& o) noexcept = default;
  constexpr UnityEngine__UIElements__ClickDetector__ButtonClickStatus& operator=(UnityEngine__UIElements__ClickDetector__ButtonClickStatus const& o) noexcept = default;
...
public:
// Declarations
using ButtonClickStatus = UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus;
...
// Fields
 ...
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus> __declspec(property(get=__get_m_ClickStatus, put=__set_m_ClickStatus))  m_ClickStatus;

constexpr void __set_m_ClickStatus(System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus> __get_m_ClickStatus() const;
...
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__ClickDetector__ButtonClickStatus, "UnityEngine.UIElements", "ClickDetector/ButtonClickStatus");
