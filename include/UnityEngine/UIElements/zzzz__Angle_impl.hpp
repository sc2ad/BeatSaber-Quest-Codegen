...
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::UnityEngine__UIElements__Angle__Unit(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit  UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::Degree{0};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit  UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::Gradian{1};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit  UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::Radian{2};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit  UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::Turn{3};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit  UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit::None{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::Angle::*)(float_t, UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit)>(&UnityEngine::UIElements::Angle::_ctor)> {
  constexpr static std::size_t size = 0xc;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit>::get()}
                        )));
    return ___internal_method;
  }
};
...
//  Writing Method size for method: UnityEngine::UIElements::Angle.op_Implicit_UnityEngine__UIElements__Angle
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UIElements::Angle (*)(float_t)>(&UnityEngine::UIElements::Angle::op_Implicit_UnityEngine__UIElements__Angle)> {
  constexpr static std::size_t size = 0x8;
...
// Ctor Parameters [CppParam { name: "m_Value", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Unit", ty: "UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::UIElements::Angle::Angle(float_t m_Value, UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit m_Unit) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_Value = m_Value;
this->m_Unit = m_Unit;
}
...
constexpr void UnityEngine::UIElements::Angle::__set_m_Unit(UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit value)  {
::cordl_internals::setInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit, 0x4>(this->__instance, std::forward<UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit>(value));
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit UnityEngine::UIElements::Angle::__get_m_Unit() const {
return ::cordl_internals::getInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit, 0x4>(this->__instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value, unit);
 ...
 void UnityEngine::UIElements::Angle::_ctor(float_t value, UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit unit)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::Angle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 UnityEngine::UIElements::Angle UnityEngine::UIElements::Angle::op_Implicit_UnityEngine__UIElements__Angle(float_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::Angle>::get(),
                            "op_Implicit",
                            std::vector<Il2CppClass*>{},
