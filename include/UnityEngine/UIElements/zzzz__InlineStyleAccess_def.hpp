...
namespace UnityEngine::UIElements {
struct ____UnityEngine__UIElements__InlineStyleAccess__InlineRule;
}
// Type: ::InlineRule
namespace UnityEngine::UIElements {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__UIElements__InlineStyleAccess__InlineRule : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__InlineStyleAccess__InlineRule(::UnityEngine::UIElements::StyleSheet sheet, ::UnityEngine::UIElements::StyleRule rule, ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> propertyIds) noexcept;


                    constexpr ____UnityEngine__UIElements__InlineStyleAccess__InlineRule(____UnityEngine__UIElements__InlineStyleAccess__InlineRule const&) = default;
                    constexpr ____UnityEngine__UIElements__InlineStyleAccess__InlineRule(____UnityEngine__UIElements__InlineStyleAccess__InlineRule&&) = default;
                    constexpr ____UnityEngine__UIElements__InlineStyleAccess__InlineRule& operator=(____UnityEngine__UIElements__InlineStyleAccess__InlineRule const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__InlineStyleAccess__InlineRule& operator=(____UnityEngine__UIElements__InlineStyleAccess__InlineRule&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__InlineStyleAccess__InlineRule(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using InlineRule = ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule;
...
constexpr ::UnityEngine::UIElements::StyleScale __get_m_InlineScale() const;
 ...
 ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule __declspec(property(get=__get_m_InlineRule, put=__set_m_InlineRule))  m_InlineRule;

constexpr void __set_m_InlineRule(::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule value) ;

constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule __get_m_InlineRule() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule, "UnityEngine.UIElements", "InlineStyleAccess/InlineRule");
