...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::PointerOutEvent::*)()>(&UnityEngine::UIElements::PointerOutEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2cd9528;
 ...
 UnityEngine::UIElements::PointerOutEvent UnityEngine::UIElements::PointerOutEvent::New_ctor()  {
UnityEngine::UIElements::PointerOutEvent o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::PointerOutEvent>())};
return o;
}
