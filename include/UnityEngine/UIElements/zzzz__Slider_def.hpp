...
namespace UnityEngine::UIElements {
class ____UnityEngine__UIElements__Slider__UxmlFactory;
}
namespace UnityEngine::UIElements {
class ____UnityEngine__UIElements__Slider__UxmlTraits;
}
// Type: ::UxmlTraits
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7229), inst: 886 }), TypeDefinitionIndex(TypeDefinitionIndex(7077)), TypeDefinitionIndex(TypeDefinitionIndex(7229))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(7134))
// CS Name: UnityEngine.UIElements.Slider::UxmlTraits
class CORDL_TYPE ____UnityEngine__UIElements__Slider__UxmlTraits : public ::UnityEngine::UIElements::BaseFieldTraits_2<float_t,::UnityEngine::UIElements::UxmlFloatAttributeDescription> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0xb8};

virtual ~____UnityEngine__UIElements__Slider__UxmlTraits() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__Slider__UxmlTraits", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__Slider__UxmlTraits(____UnityEngine__UIElements__Slider__UxmlTraits const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__Slider__UxmlTraits", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__Slider__UxmlTraits(____UnityEngine__UIElements__Slider__UxmlTraits&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__Slider__UxmlTraits(void* ptr) noexcept : ::UnityEngine::UIElements::BaseFieldTraits_2<float_t,::UnityEngine::UIElements::UxmlFloatAttributeDescription>(ptr) {
}


  constexpr ____UnityEngine__UIElements__Slider__UxmlTraits& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__Slider__UxmlTraits& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__Slider__UxmlTraits& operator=(____UnityEngine__UIElements__Slider__UxmlTraits&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__Slider__UxmlTraits& operator=(____UnityEngine__UIElements__Slider__UxmlTraits const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__Slider__UxmlTraits() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7199)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7199), inst: 374 })}
...
public:
// Declarations
using UxmlTraits = ::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlTraits;

using UxmlFactory = ::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlFactory;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7134)), TypeDefinitionIndex(TypeDefinitionIndex(7089)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7089), inst: 5103 }), TypeDefinitionIndex(TypeDefinitionIndex(7135))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(7133))
// CS Name: UnityEngine.UIElements.Slider::UxmlFactory
class CORDL_TYPE ____UnityEngine__UIElements__Slider__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::Slider,::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlTraits> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____UnityEngine__UIElements__Slider__UxmlFactory() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__Slider__UxmlFactory", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__Slider__UxmlFactory(____UnityEngine__UIElements__Slider__UxmlFactory const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__Slider__UxmlFactory", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__Slider__UxmlFactory(____UnityEngine__UIElements__Slider__UxmlFactory&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__Slider__UxmlFactory(void* ptr) noexcept : ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::Slider,::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlTraits>(ptr) {
}


  constexpr ____UnityEngine__UIElements__Slider__UxmlFactory& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__Slider__UxmlFactory& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__Slider__UxmlFactory& operator=(____UnityEngine__UIElements__Slider__UxmlFactory&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__Slider__UxmlFactory& operator=(____UnityEngine__UIElements__Slider__UxmlFactory const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__Slider__UxmlFactory() ;
...
NEED_NO_BOX(::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlFactory);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlFactory, "UnityEngine.UIElements", "Slider/UxmlFactory");
NEED_NO_BOX(::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__Slider__UxmlTraits, "UnityEngine.UIElements", "Slider/UxmlTraits");
