...
struct CORDL_TYPE ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags(____UnityEngine__UIElements__MeshGenerationContext__MeshFlags const&) = default;
                    constexpr ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags(____UnityEngine__UIElements__MeshGenerationContext__MeshFlags&&) = default;
                    constexpr ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags& operator=(____UnityEngine__UIElements__MeshGenerationContext__MeshFlags const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags& operator=(____UnityEngine__UIElements__MeshGenerationContext__MeshFlags&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__MeshGenerationContext__MeshFlags(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UIElements__MeshGenerationContext__MeshFlags_Unwrapped : int32_t {
__None = 0,
...
constexpr operator ______UnityEngine__UIElements__MeshGenerationContext__MeshFlags_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UIElements__MeshGenerationContext__MeshFlags_Unwrapped>(__instance);
}
...
static ::UnityEngine::UIElements::____UnityEngine__UIElements__MeshGenerationContext__MeshFlags const None;

/// @brief Field UVisDisplacement offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__MeshGenerationContext__MeshFlags const UVisDisplacement;

/// @brief Field SkipDynamicAtlas offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__MeshGenerationContext__MeshFlags const SkipDynamicAtlas;
...
public:
// Declarations
using MeshFlags = ::UnityEngine::UIElements::____UnityEngine__UIElements__MeshGenerationContext__MeshFlags;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__MeshGenerationContext__MeshFlags, "UnityEngine.UIElements", "MeshGenerationContext/MeshFlags");
