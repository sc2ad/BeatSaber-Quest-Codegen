...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State  ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::Waiting{0};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State  ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::TrackingAddOrMove{1};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State  ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State::TrackingRemove{2};
...
constexpr void ::UnityEngine::UIElements::BaseVisualTreeHierarchyTrackerUpdater::__set_m_State(::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State>(value));
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State ::UnityEngine::UIElements::BaseVisualTreeHierarchyTrackerUpdater::__get_m_State() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
