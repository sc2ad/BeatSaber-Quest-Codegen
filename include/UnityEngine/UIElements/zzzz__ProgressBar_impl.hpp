...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::ProgressBar::*)()>(&UnityEngine::UIElements::ProgressBar::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x2cc227c;
...
//  Writing Method size for method: UnityEngine::UIElements::UnityEngine__UIElements__ProgressBar__UxmlFactory._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::UnityEngine__UIElements__ProgressBar__UxmlFactory::*)()>(&UnityEngine::UIElements::UnityEngine__UIElements__ProgressBar__UxmlFactory::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x2cc22d0;
