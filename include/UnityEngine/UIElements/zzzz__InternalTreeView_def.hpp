...
class ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5;
}
namespace UnityEngine::UIElements {
class InternalTreeView;
}
namespace UnityEngine::UIElements {
class ____UnityEngine__UIElements__InternalTreeView__UxmlFactory;
}
namespace UnityEngine::UIElements {
class ____UnityEngine__UIElements__InternalTreeView__UxmlTraits;
}
namespace UnityEngine::UIElements {
class ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64;
}
namespace UnityEngine::UIElements {
...
class CORDL_TYPE ____UnityEngine__UIElements__InternalTreeView__UxmlTraits : public ::UnityEngine::UIElements::____UnityEngine__UIElements__VisualElement__UxmlTraits {
public:
// Declarations
using _get_uxmlChildElementsDescription_d__5 = ::GlobalNamespace::______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x90};

virtual ~____UnityEngine__UIElements__InternalTreeView__UxmlTraits() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView__UxmlTraits", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits(____UnityEngine__UIElements__InternalTreeView__UxmlTraits const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView__UxmlTraits", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits(____UnityEngine__UIElements__InternalTreeView__UxmlTraits&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__InternalTreeView__UxmlTraits(void* ptr) noexcept : ::UnityEngine::UIElements::____UnityEngine__UIElements__VisualElement__UxmlTraits(ptr) {
}


  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits& operator=(____UnityEngine__UIElements__InternalTreeView__UxmlTraits&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlTraits& operator=(____UnityEngine__UIElements__InternalTreeView__UxmlTraits const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__InternalTreeView__UxmlTraits() ;
...
public:
// Declarations
using _GetAllItems_d__64 = ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64;

using TreeViewItemWrapper = ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper;

using UxmlTraits = ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits;

using UxmlFactory = ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlFactory;
...
constexpr ::System::Collections::Generic::List_1<int32_t> __get_m_ExpandedItemIds() const;
 ...
 ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper> __declspec(property(get=__get_m_ItemWrappers, put=__set_m_ItemWrappers))  m_ItemWrappers;

constexpr void __set_m_ItemWrappers(::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper> value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper> __get_m_ItemWrappers() const;
...
/// @brief Method CreateWrappers addr 0x2d0be9c size 0x520 virtual false final false
 void CreateWrappers(::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem> treeViewItems, int32_t depth, ByRef<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper>> wrappers) ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7447)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7089), inst: 5092 }), TypeDefinitionIndex(TypeDefinitionIndex(7089)), TypeDefinitionIndex(TypeDefinitionIndex(7450))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(7445))
// CS Name: UnityEngine.UIElements.InternalTreeView::UxmlFactory
class CORDL_TYPE ____UnityEngine__UIElements__InternalTreeView__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::InternalTreeView,::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____UnityEngine__UIElements__InternalTreeView__UxmlFactory() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView__UxmlFactory", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory(____UnityEngine__UIElements__InternalTreeView__UxmlFactory const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView__UxmlFactory", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory(____UnityEngine__UIElements__InternalTreeView__UxmlFactory&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__InternalTreeView__UxmlFactory(void* ptr) noexcept : ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::InternalTreeView,::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits>(ptr) {
}


  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory& operator=(____UnityEngine__UIElements__InternalTreeView__UxmlFactory&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__InternalTreeView__UxmlFactory& operator=(____UnityEngine__UIElements__InternalTreeView__UxmlFactory const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__InternalTreeView__UxmlFactory() ;
...
class CORDL_TYPE ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5() = default;

// Ctor Parameters [CppParam { name: "", ty: "______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5", modifiers: " const&", def_value: None }]
constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5(______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5", modifiers: "&&", def_value: None }]
constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5(______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5&& o) noexcept = default;
  constexpr ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5 const& o) noexcept = default;
...
constexpr int32_t __get___l__initialThreadId() const;
 ...
 ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits __declspec(property(get=__get___4__this, put=__set___4__this))  __4__this;

constexpr void __set___4__this(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits value) ;

constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits __get___4__this() const;
...
explicit ______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5(int32_t __1__state) ;
...
struct CORDL_TYPE ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper(int32_t depth, ::UnityEngine::UIElements::ITreeViewItem item) noexcept;


                    constexpr ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper(____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper const&) = default;
                    constexpr ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper(____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper&&) = default;
                    constexpr ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper& operator=(____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper& operator=(____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64(____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64(____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64& operator=(____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64& operator=(____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64 const& o) noexcept = default;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }]
explicit ____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64(int32_t __1__state) ;
...
NEED_NO_BOX(::GlobalNamespace::______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______UnityEngine__UIElements__InternalTreeView__UxmlTraits___get_uxmlChildElementsDescription_d__5, "UnityEngine.UIElements", "InternalTreeView/UxmlTraits/<get_uxmlChildElementsDescription>d__5");
...
NEED_NO_BOX(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlFactory);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlFactory, "UnityEngine.UIElements", "InternalTreeView/UxmlFactory");
NEED_NO_BOX(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__UxmlTraits, "UnityEngine.UIElements", "InternalTreeView/UxmlTraits");
NEED_NO_BOX(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView___GetAllItems_d__64, "UnityEngine.UIElements", "InternalTreeView/<GetAllItems>d__64");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__InternalTreeView__TreeViewItemWrapper, "UnityEngine.UIElements", "InternalTreeView/TreeViewItemWrapper");
