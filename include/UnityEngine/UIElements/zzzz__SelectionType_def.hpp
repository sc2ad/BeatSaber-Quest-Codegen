...
struct CORDL_TYPE SelectionType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr SelectionType(int32_t value__) noexcept;
                    ...
                    constexpr SelectionType(SelectionType const&) = default;
                    constexpr SelectionType(SelectionType&&) = default;
                    constexpr SelectionType& operator=(SelectionType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr SelectionType& operator=(SelectionType&& o) noexcept {
...
constexpr explicit SelectionType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __SelectionType_Unwrapped : int32_t {
__None = 0,
__Single = 1,
__Multiple = 2,
};
...
return std::bit_cast<__SelectionType_Unwrapped>(__instance);
}
