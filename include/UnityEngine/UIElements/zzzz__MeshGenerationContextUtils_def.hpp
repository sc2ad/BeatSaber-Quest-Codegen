...
struct CORDL_TYPE UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams(UnityEngine::Rect rect, UnityEngine::Color playmodeTintColor, UnityEngine::Color leftColor, UnityEngine::Color topColor, UnityEngine::Color rightColor, UnityEngine::Color bottomColor, float_t leftWidth, float_t topWidth, float_t rightWidth, float_t bottomWidth, UnityEngine::Vector2 topLeftRadius, UnityEngine::Vector2 topRightRadius, UnityEngine::Vector2 bottomRightRadius, UnityEngine::Vector2 bottomLeftRadius, UnityEngine::Material material, UnityEngine::UIElements::ColorPage leftColorPage, UnityEngine::UIElements::ColorPage topColorPage, UnityEngine::UIElements::ColorPage rightColorPage, UnityEngine::UIElements::ColorPage bottomColorPage) noexcept;


                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams(UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams const&) = default;
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams(UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams&&) = default;
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams& operator=(UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams& operator=(UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams&& o) noexcept {
...
constexpr explicit UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr UnityEngine::UIElements::ColorPage __get_colorPage() const;
 ...
 UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContext__MeshFlags __declspec(property(get=__get_meshFlags, put=__set_meshFlags))  meshFlags;

constexpr void __set_meshFlags(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContext__MeshFlags value) ;

constexpr UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContext__MeshFlags __get_meshFlags() const;
...
static UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams MakeTextured(UnityEngine::Rect rect, UnityEngine::Rect uv, UnityEngine::Texture texture, UnityEngine::ScaleMode scaleMode, UnityEngine::UIElements::ContextType panelContext) ;

/// @brief Method MakeSprite addr 0x2d04068 size 0x6c4 virtual false final false
static UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams MakeSprite(UnityEngine::Rect rect, UnityEngine::Sprite sprite, UnityEngine::ScaleMode scaleMode, UnityEngine::UIElements::ContextType panelContext, bool hasRadius, ByRef<UnityEngine::Vector4> slices) ;

/// @brief Method MakeVectorTextured addr 0x2d0472c size 0x11c virtual false final false
static UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams MakeVectorTextured(UnityEngine::Rect rect, UnityEngine::Rect uv, UnityEngine::UIElements::VectorImage vectorImage, UnityEngine::ScaleMode scaleMode, UnityEngine::UIElements::ContextType panelContext) ;
...
struct CORDL_TYPE UnityEngine__UIElements__MeshGenerationContextUtils__TextParams : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__MeshGenerationContextUtils__TextParams(UnityEngine::Rect rect, ::StringW text, UnityEngine::Font font, UnityEngine::UIElements::FontDefinition fontDefinition, int32_t fontSize, UnityEngine::UIElements::Length letterSpacing, UnityEngine::UIElements::Length wordSpacing, UnityEngine::UIElements::Length paragraphSpacing, UnityEngine::FontStyle fontStyle, UnityEngine::Color fontColor, UnityEngine::TextAnchor anchor, bool wordWrap, float_t wordWrapWidth, bool richText, UnityEngine::Color playmodeTintColor, UnityEngine::UIElements::TextOverflow textOverflow, UnityEngine::UIElements::TextOverflowPosition textOverflowPosition, UnityEngine::UIElements::OverflowInternal overflow, UnityEngine::UIElements::IPanel panel) noexcept;


                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__TextParams(UnityEngine__UIElements__MeshGenerationContextUtils__TextParams const&) = default;
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__TextParams(UnityEngine__UIElements__MeshGenerationContextUtils__TextParams&&) = default;
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__TextParams& operator=(UnityEngine__UIElements__MeshGenerationContextUtils__TextParams const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__MeshGenerationContextUtils__TextParams& operator=(UnityEngine__UIElements__MeshGenerationContextUtils__TextParams&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__MeshGenerationContextUtils__TextParams(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
static UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams MakeStyleBased(UnityEngine::UIElements::VisualElement ve, ::StringW text) ;

/// @brief Method GetTextNativeSettings addr 0x2d05f04 size 0xd4 virtual false final false
static UnityEngine::UIElements::TextNativeSettings GetTextNativeSettings(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams textParams, float_t scaling) ;
...
public:
// Declarations
using TextParams = UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams;

using RectangleParams = UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams;

using BorderParams = UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams;
...
static void Rectangle(UnityEngine::UIElements::MeshGenerationContext mgc, UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams rectParams) ;

/// @brief Method Text addr 0x2d02820 size 0x134 virtual false final false
static void Text(UnityEngine::UIElements::MeshGenerationContext mgc, UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams textParams, UnityEngine::UIElements::ITextHandle handle, float_t pixelsPerPoint) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__BorderParams, "UnityEngine.UIElements", "MeshGenerationContextUtils/BorderParams");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams, "UnityEngine.UIElements", "MeshGenerationContextUtils/RectangleParams");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams, "UnityEngine.UIElements", "MeshGenerationContextUtils/TextParams");
