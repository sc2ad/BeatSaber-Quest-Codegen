...
namespace UnityEngine::UIElements {
template<typename T>
class ____UnityEngine__UIElements__VerticalVirtualizationController_1____c;
}
namespace UnityEngine::UIElements {
...
namespace UnityEngine::UIElements {
template<::cordl_internals::il2cpp_reference_type T>
class ____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T>;
}
// Type: ::<>c
...
class CORDL_TYPE ____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__UIElements__VerticalVirtualizationController_1____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__VerticalVirtualizationController_1____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c(____UnityEngine__UIElements__VerticalVirtualizationController_1____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__VerticalVirtualizationController_1____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c(____UnityEngine__UIElements__VerticalVirtualizationController_1____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__VerticalVirtualizationController_1____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c& operator=(____UnityEngine__UIElements__VerticalVirtualizationController_1____c&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__VerticalVirtualizationController_1____c& operator=(____UnityEngine__UIElements__VerticalVirtualizationController_1____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::UIElements::____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::UIElements::____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T> value) ;

static ::UnityEngine::UIElements::____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T> __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__VerticalVirtualizationController_1____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::UIElements::____UnityEngine__UIElements__VerticalVirtualizationController_1____c<T>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::UIElements::____UnityEngine__UIElements__VerticalVirtualizationController_1____c, "UnityEngine.UIElements", "VerticalVirtualizationController`1/<>c");
