...
return ::cordl_internals::RunMethodRethrow<UnityEngine::UIElements::IDragAndDropData, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::DefaultDragAndDropClient UnityEngine::UIElements::DefaultDragAndDropClient::New_ctor()  {
UnityEngine::UIElements::DefaultDragAndDropClient o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::DefaultDragAndDropClient>())};
return o;
}
