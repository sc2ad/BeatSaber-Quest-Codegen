...
struct CORDL_TYPE ____UnityEngine__UIElements__EventDispatcher__EventRecord : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__EventDispatcher__EventRecord(::UnityEngine::UIElements::EventBase m_Event, ::UnityEngine::UIElements::IPanel m_Panel) noexcept;


                    constexpr ____UnityEngine__UIElements__EventDispatcher__EventRecord(____UnityEngine__UIElements__EventDispatcher__EventRecord const&) = default;
                    constexpr ____UnityEngine__UIElements__EventDispatcher__EventRecord(____UnityEngine__UIElements__EventDispatcher__EventRecord&&) = default;
                    constexpr ____UnityEngine__UIElements__EventDispatcher__EventRecord& operator=(____UnityEngine__UIElements__EventDispatcher__EventRecord const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__EventDispatcher__EventRecord& operator=(____UnityEngine__UIElements__EventDispatcher__EventRecord&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__EventDispatcher__EventRecord(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__UIElements__EventDispatcher__DispatchContext : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_GateCount", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "m_Queue", ty: "::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord>", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UIElements__EventDispatcher__DispatchContext(uint32_t m_GateCount, ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord> m_Queue) noexcept;


                    constexpr ____UnityEngine__UIElements__EventDispatcher__DispatchContext(____UnityEngine__UIElements__EventDispatcher__DispatchContext const&) = default;
                    constexpr ____UnityEngine__UIElements__EventDispatcher__DispatchContext(____UnityEngine__UIElements__EventDispatcher__DispatchContext&&) = default;
                    constexpr ____UnityEngine__UIElements__EventDispatcher__DispatchContext& operator=(____UnityEngine__UIElements__EventDispatcher__DispatchContext const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__EventDispatcher__DispatchContext& operator=(____UnityEngine__UIElements__EventDispatcher__DispatchContext&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__EventDispatcher__DispatchContext(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr uint32_t __get_m_GateCount() const;
 ...
 ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord> __declspec(property(get=__get_m_Queue, put=__set_m_Queue))  m_Queue;

constexpr void __set_m_Queue(::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord> value) ;

constexpr ::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord> __get_m_Queue() const;
...
public:
// Declarations
using DispatchContext = ::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__DispatchContext;

using EventRecord = ::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord;
...
static ::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord>> __declspec(property(get=__get_k_EventQueuePool, put=__set_k_EventQueuePool))  k_EventQueuePool;

static void __set_k_EventQueuePool(::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord>> value) ;

static ::UnityEngine::UIElements::ObjectPool_1<::System::Collections::Generic::Queue_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord>> __get_k_EventQueuePool() ;
...
constexpr uint32_t __get_m_GateCount() const;
 ...
 ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__DispatchContext> __declspec(property(get=__get_m_DispatchContexts, put=__set_m_DispatchContexts))  m_DispatchContexts;

constexpr void __set_m_DispatchContexts(::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__DispatchContext> value) ;

constexpr ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__DispatchContext> __get_m_DispatchContexts() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__DispatchContext, "UnityEngine.UIElements", "EventDispatcher/DispatchContext");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__EventDispatcher__EventRecord, "UnityEngine.UIElements", "EventDispatcher/EventRecord");
