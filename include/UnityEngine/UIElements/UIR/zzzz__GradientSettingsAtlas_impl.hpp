...
//  Writing Method size for method: ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture.WriteRawInt2Packed
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::*)(int32_t, int32_t, int32_t, int32_t)>(&::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::WriteRawInt2Packed)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0x2d14d7c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture>::get(),
                            "WriteRawInt2Packed",
...
//  Writing Method size for method: ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture.WriteRawFloat4Packed
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::*)(float_t, float_t, float_t, float_t, int32_t, int32_t)>(&::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::WriteRawFloat4Packed)> {
...
constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture(::ArrayW<::UnityEngine::Color32> rgba, int32_t width, int32_t height) noexcept : ::bs_hook::ValueTypeWrapper() {this->rgba = rgba;
this->width = width;
this->height = height;
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__set_rgba(::ArrayW<::UnityEngine::Color32> value)  {
...
constexpr ::ArrayW<::UnityEngine::Color32> ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__get_rgba() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Color32>, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__set_width(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x8>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__get_width() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__set_height(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0xc>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::__get_height() const {
return ::cordl_internals::getInstanceField<int32_t, 0xc>(this->__instance);
}
 void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::WriteRawInt2Packed(int32_t v0, int32_t v1, int32_t destX, int32_t destY)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture>::get(),
                            "WriteRawInt2Packed",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, v0, v1, destX, destY);
 ...
 void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture::WriteRawFloat4Packed(float_t f0, float_t f1, float_t f2, float_t f3, int32_t destX, int32_t destY)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture>::get(),
                            "WriteRawFloat4Packed",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::UnityEngine::UIElements::UIR::GradientSettingsAtlas::__set_m_RawAtlas(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture>(value));
}
constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture ::UnityEngine::UIElements::UIR::GradientSettingsAtlas::__get_m_RawAtlas() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
