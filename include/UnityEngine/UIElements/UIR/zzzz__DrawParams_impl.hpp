...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::UIR::DrawParams UnityEngine::UIElements::UIR::DrawParams::New_ctor()  {
UnityEngine::UIElements::UIR::DrawParams o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::UIR::DrawParams>())};
return o;
}
