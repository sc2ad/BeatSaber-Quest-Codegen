...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7499)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7501), inst: 900 }), TypeDefinitionIndex(TypeDefinitionIndex(7501)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7499), inst: 3837 })}
...
static UnityEngine::UIElements::UIR::BasicNode_1<UnityEngine::UIElements::UIR::TextureEntry> New_ctor() ;
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7501)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7499), inst: 3837 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7501), inst: 900 }), TypeDefinitionIndex(TypeDefinitionIndex(7499))}
...
static UnityEngine::UIElements::UIR::BasicNode_1<T> New_ctor() ;
