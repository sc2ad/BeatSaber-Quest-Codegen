...
constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo(::UnityEngine::Texture src, ::UnityEngine::RectInt srcRect, ::UnityEngine::Vector2Int dstPos, int32_t border, ::UnityEngine::Color tint) noexcept : ::bs_hook::ValueTypeWrapper() {this->src = src;
this->srcRect = srcRect;
this->dstPos = dstPos;
this->border = border;
this->tint = tint;
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__set_src(::UnityEngine::Texture value)  {
::cordl_internals::setInstanceField<::UnityEngine::Texture, 0x0>(this->__instance, std::forward<::UnityEngine::Texture>(value));
}
constexpr ::UnityEngine::Texture ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__get_src() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Texture, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__set_srcRect(::UnityEngine::RectInt value)  {
::cordl_internals::setInstanceField<::UnityEngine::RectInt, 0x8>(this->__instance, std::forward<::UnityEngine::RectInt>(value));
}
constexpr ::UnityEngine::RectInt ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__get_srcRect() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectInt, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__set_dstPos(::UnityEngine::Vector2Int value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2Int, 0x18>(this->__instance, std::forward<::UnityEngine::Vector2Int>(value));
}
constexpr ::UnityEngine::Vector2Int ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__get_dstPos() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2Int, 0x18>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__set_border(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__get_border() const {
return ::cordl_internals::getInstanceField<int32_t, 0x20>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__set_tint(::UnityEngine::Color value)  {
::cordl_internals::setInstanceField<::UnityEngine::Color, 0x24>(this->__instance, std::forward<::UnityEngine::Color>(value));
}
constexpr ::UnityEngine::Color ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo::__get_tint() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::TextureBlitter::*)(::System::Collections::Generic::IList_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>, int32_t)>(&::UnityEngine::UIElements::UIR::TextureBlitter::DoBlit)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "DoBlit",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::IList_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::UnityEngine::UIElements::UIR::TextureBlitter::__set_m_SingleBlit(::ArrayW<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>>(value));
}
constexpr ::ArrayW<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo> ::UnityEngine::UIElements::UIR::TextureBlitter::__get_m_SingleBlit() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::UnityEngine::UIElements::UIR::TextureBlitter::__set_m_PendingBlits(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo> ::UnityEngine::UIElements::UIR::TextureBlitter::__get_m_PendingBlits() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, dst);
 ...
 void ::UnityEngine::UIElements::UIR::TextureBlitter::DoBlit(::System::Collections::Generic::IList_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__TextureBlitter__BlitInfo> blitInfos, int32_t startIndex)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UIR::TextureBlitter>::get(),
                            "DoBlit",
                            std::vector<Il2CppClass*>{},
