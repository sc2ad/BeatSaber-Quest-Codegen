...
class UnityEngine__UIElements__UIR__Page__DataSet_1<T>;
}
namespace UnityEngine::UIElements::UIR {
template<>
...
static UnityEngine::UIElements::UIR::Page New_ctor(uint32_t vertexMaxCount, uint32_t indexMaxCount, uint32_t maxQueuedFrameCount, bool mockPage) ;
...
static UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Page__DataSet_1<UnityEngine::UIElements::Vertex> New_ctor(UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Utility__GPUBufferType bufferType, uint32_t totalCount, uint32_t maxQueuedFrameCount, uint32_t updateRangePoolSize, bool mockBuffer) ;
...
// CS Name: UnityEngine.UIElements.UIR.Page::DataSet`1
class CORDL_TYPE UnityEngine__UIElements__UIR__Page__DataSet_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to System::IDisposable
constexpr operator  System::IDisposable() const noexcept;
...
constexpr bool __get__disposed_k__BackingField() const;
 ...
 UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Utility__GPUBuffer_1<T> __declspec(property(get=__get_gpuData, put=__set_gpuData))  gpuData;

constexpr void __set_gpuData(UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Utility__GPUBuffer_1<T> value) ;

constexpr UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Utility__GPUBuffer_1<T> __get_gpuData() const;

 Unity::Collections::NativeArray_1<T> __declspec(property(get=__get_cpuData, put=__set_cpuData))  cpuData;

constexpr void __set_cpuData(Unity::Collections::NativeArray_1<T> value) ;

constexpr Unity::Collections::NativeArray_1<T> __get_cpuData() const;
...
static UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Page__DataSet_1<T> New_ctor(UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Utility__GPUBufferType bufferType, uint32_t totalCount, uint32_t maxQueuedFrameCount, uint32_t updateRangePoolSize, bool mockBuffer) ;
