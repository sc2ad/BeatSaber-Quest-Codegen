...
namespace UnityEngine::UIElements::UIR {
class ____UnityEngine__UIElements__UIR__RenderChain____c;
}
namespace UnityEngine::UIElements::UIR {
struct ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking;
}
namespace UnityEngine::UIElements::UIR {
struct ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator;
}
namespace UnityEngine::UIElements::UIR {
...
struct CORDL_TYPE ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement> heads, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement> tails, ::ArrayW<int32_t> minDepths, ::ArrayW<int32_t> maxDepths, uint32_t dirtyID) noexcept;


                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking(____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking const&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking(____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking&&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking& operator=(____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking& operator=(____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations

                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator(____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator const&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator(____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator&&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator& operator=(____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator& operator=(____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData(::UnityEngine::Material standardMaterial, ::UnityEngine::Material initialMaterial, ::UnityEngine::MaterialPropertyBlock matPropBlock, ::UnityEngine::UIElements::UIR::RenderChainCommand firstCommand, ::UnityEngine::UIElements::UIR::UIRenderDevice device, ::UnityEngine::Texture vectorAtlas, ::UnityEngine::Texture shaderInfoAtlas, float_t dpiScale, ::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::UIR::Transform3x4> transformConstants, ::Unity::Collections::NativeSlice_1<::UnityEngine::Vector4> clipRectConstants) noexcept;


                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData(____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData const&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData(____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData&&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData& operator=(____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData& operator=(____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____UnityEngine__UIElements__UIR__RenderChain____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__UIElements__UIR__RenderChain____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__UIR__RenderChain____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__UIR__RenderChain____c(____UnityEngine__UIElements__UIR__RenderChain____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__UIR__RenderChain____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__UIR__RenderChain____c(____UnityEngine__UIElements__UIR__RenderChain____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__UIR__RenderChain____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UIElements__UIR__RenderChain____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__UIR__RenderChain____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__UIR__RenderChain____c& operator=(____UnityEngine__UIElements__UIR__RenderChain____c&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__UIR__RenderChain____c& operator=(____UnityEngine__UIElements__UIR__RenderChain____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c value) ;

static ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__UIR__RenderChain____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c;

using RenderNodeData = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData;

using RenderChainStaticIndexAllocator = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator;

using DepthOrderedDirtyTracking = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking;
...
constexpr ::UnityEngine::UIElements::UIR::RenderChainCommand __get_m_FirstCommand() const;
 ...
 ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking __declspec(property(get=__get_m_DirtyTracker, put=__set_m_DirtyTracker))  m_DirtyTracker;

constexpr void __set_m_DirtyTracker(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking value) ;

constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking __get_m_DirtyTracker() const;
...
constexpr ::UnityEngine::UIElements::UIR::BasicNodePool_1<::UnityEngine::UIElements::UIR::TextureEntry> __get_m_TexturePool() const;
 ...
 ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData> __declspec(property(get=__get_m_RenderNodesData, put=__set_m_RenderNodesData))  m_RenderNodesData;

constexpr void __set_m_RenderNodesData(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData> value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData> __get_m_RenderNodesData() const;
...
static ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData AccessRenderNodeData(::cordl_internals::intptr_t obj) ;
...
static void OnRegisterIntermediateRendererMat(::UnityEngine::UIElements::BaseRuntimePanel rtp, ::UnityEngine::UIElements::UIR::RenderChain renderChain, ByRef<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData> rnd, ::UnityEngine::Camera camera, int32_t sameDistanceSortPriority) ;
...
NEED_NO_BOX(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain____c, "UnityEngine.UIElements.UIR", "RenderChain/<>c");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__DepthOrderedDirtyTracking, "UnityEngine.UIElements.UIR", "RenderChain/DepthOrderedDirtyTracking");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderChainStaticIndexAllocator, "UnityEngine.UIElements.UIR", "RenderChain/RenderChainStaticIndexAllocator");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__RenderChain__RenderNodeData, "UnityEngine.UIElements.UIR", "RenderChain/RenderNodeData");
