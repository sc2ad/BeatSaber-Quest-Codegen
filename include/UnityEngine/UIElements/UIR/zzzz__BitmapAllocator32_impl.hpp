...
constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page(uint16_t x, uint16_t y, int32_t freeSlots) noexcept : ::bs_hook::ValueTypeWrapper() {this->x = x;
this->y = y;
this->freeSlots = freeSlots;
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__set_x(uint16_t value)  {
::cordl_internals::setInstanceField<uint16_t, 0x0>(this->__instance, std::forward<uint16_t>(value));
}
constexpr uint16_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__get_x() const {
return ::cordl_internals::getInstanceField<uint16_t, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__set_y(uint16_t value)  {
::cordl_internals::setInstanceField<uint16_t, 0x2>(this->__instance, std::forward<uint16_t>(value));
}
constexpr uint16_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__get_y() const {
return ::cordl_internals::getInstanceField<uint16_t, 0x2>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__set_freeSlots(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x4>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page::__get_freeSlots() const {
...
// Ctor Parameters [CppParam { name: "m_PageHeight", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Pages", ty: "::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_AllocMap", ty: "::System::Collections::Generic::List_1<uint32_t>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_EntryWidth", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_EntryHeight", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::UIElements::UIR::BitmapAllocator32::BitmapAllocator32(int32_t m_PageHeight, ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page> m_Pages, ::System::Collections::Generic::List_1<uint32_t> m_AllocMap, int32_t m_EntryWidth, int32_t m_EntryHeight) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_PageHeight = m_PageHeight;
...
constexpr void ::UnityEngine::UIElements::UIR::BitmapAllocator32::__set_m_Pages(::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page>, 0x8>(this->__instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page> ::UnityEngine::UIElements::UIR::BitmapAllocator32::__get_m_Pages() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__BitmapAllocator32__Page>, 0x8>(this->__instance);
}
