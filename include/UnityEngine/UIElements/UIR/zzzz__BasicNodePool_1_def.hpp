...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7500)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7501), inst: 899 }), TypeDefinitionIndex(TypeDefinitionIndex(7501)), TypeDefinitionIndex(TypeDefinitionIndex(7502)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 3841 })}
