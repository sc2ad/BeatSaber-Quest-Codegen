...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7502)), TypeDefinitionIndex(TypeDefinitionIndex(7500)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 3841 }), TypeDefinitionIndex(TypeDefinitionIndex(7501)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7501), inst: 899 })}
...
static UnityEngine::UIElements::UIR::BasicNodePool_1<UnityEngine::UIElements::UIR::TextureEntry> New_ctor() ;
...
static UnityEngine::UIElements::UIR::BasicNodePool_1<T> New_ctor() ;
