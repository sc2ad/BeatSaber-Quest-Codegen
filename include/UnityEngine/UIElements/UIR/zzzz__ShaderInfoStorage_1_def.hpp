...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7480)), TypeDefinitionIndex(TypeDefinitionIndex(7481))}
...
static UnityEngine::UIElements::UIR::ShaderInfoStorage_1<UnityEngine::Color32> New_ctor(UnityEngine::TextureFormat format, System::Func_2<UnityEngine::Color,UnityEngine::Color32> convert, int32_t initialSize, int32_t maxSize) ;
...
static UnityEngine::UIElements::UIR::ShaderInfoStorage_1<UnityEngine::Color> New_ctor(UnityEngine::TextureFormat format, System::Func_2<UnityEngine::Color,UnityEngine::Color> convert, int32_t initialSize, int32_t maxSize) ;
