...
namespace UnityEngine::UIElements::UIR {
class ____UnityEngine__UIElements__UIR__GradientRemapPool____c;
}
// Type: ::<>c
namespace UnityEngine::UIElements::UIR {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__UIElements__UIR__GradientRemapPool____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__UIElements__UIR__GradientRemapPool____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__UIR__GradientRemapPool____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c(____UnityEngine__UIElements__UIR__GradientRemapPool____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__UIR__GradientRemapPool____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c(____UnityEngine__UIElements__UIR__GradientRemapPool____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__UIR__GradientRemapPool____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c& operator=(____UnityEngine__UIElements__UIR__GradientRemapPool____c&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__UIR__GradientRemapPool____c& operator=(____UnityEngine__UIElements__UIR__GradientRemapPool____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c value) ;

static ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__UIElements__UIR__GradientRemapPool____c() ;
...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7522)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 300 }), TypeDefinitionIndex(TypeDefinitionIndex(7500))}
...
public:
// Declarations
using __c = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c;
...
NEED_NO_BOX(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientRemapPool____c, "UnityEngine.UIElements.UIR", "GradientRemapPool/<>c");
