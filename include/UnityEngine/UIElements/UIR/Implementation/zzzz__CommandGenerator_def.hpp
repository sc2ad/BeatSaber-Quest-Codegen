...
static UnityEngine::UIElements::UIR::Implementation::UnityEngine__UIElements__UIR__Implementation__UIRStylePainter__ClosingInfo PaintElement(UnityEngine::UIElements::UIR::RenderChain renderChain, UnityEngine::UIElements::VisualElement ve, ByRef<UnityEngine::UIElements::UIR::ChainBuilderStats> stats) ;
...
static UnityEngine::Material GetBlitMaterial(UnityEngine::UIElements::UnityEngine__UIElements__VisualElement__RenderTargetMode mode) ;

/// @brief Method ClosePaintElement addr 0x2c69c60 size 0x190 virtual false final false
static void ClosePaintElement(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::UIR::Implementation::UnityEngine__UIElements__UIR__Implementation__UIRStylePainter__ClosingInfo closingInfo, UnityEngine::UIElements::UIR::RenderChain renderChain, ByRef<UnityEngine::UIElements::UIR::ChainBuilderStats> stats) ;
