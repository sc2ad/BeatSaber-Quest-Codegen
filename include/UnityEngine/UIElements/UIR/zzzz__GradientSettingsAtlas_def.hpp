...
namespace UnityEngine::UIElements::UIR {
struct ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture;
}
// Type: ::RawTexture
namespace UnityEngine::UIElements::UIR {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture(::ArrayW<::UnityEngine::Color32> rgba, int32_t width, int32_t height) noexcept;


                    constexpr ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture(____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture const&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture(____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture&&) = default;
                    constexpr ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture& operator=(____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture& operator=(____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using RawTexture = ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture;
...
constexpr ::UnityEngine::Texture2D __get_m_Atlas() const;
 ...
 ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture __declspec(property(get=__get_m_RawAtlas, put=__set_m_RawAtlas))  m_RawAtlas;

constexpr void __set_m_RawAtlas(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture value) ;

constexpr ::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture __get_m_RawAtlas() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::UIR::____UnityEngine__UIElements__UIR__GradientSettingsAtlas__RawTexture, "UnityEngine.UIElements.UIR", "GradientSettingsAtlas/RawTexture");
