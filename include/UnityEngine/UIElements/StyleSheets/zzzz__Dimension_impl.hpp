...
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::____UnityEngine__UIElements__StyleSheets__Dimension__Unit(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Unitless{0};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Pixel{1};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Percent{2};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Second{3};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Millisecond{4};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Degree{5};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Gradian{6};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Radian{7};
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit  ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit::Turn{8};
//  Writing Method size for method: ::UnityEngine::UIElements::StyleSheets::Dimension._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::StyleSheets::Dimension::*)(float_t, ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit)>(&::UnityEngine::UIElements::StyleSheets::Dimension::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit>::get()}
                        )));
...
// Ctor Parameters [CppParam { name: "unit", ty: "::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit", modifiers: "", def_value: Some("{}") }, CppParam { name: "value", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::UIElements::StyleSheets::Dimension::Dimension(::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit unit, float_t value) noexcept : ::bs_hook::ValueTypeWrapper() {this->unit = unit;
this->value = value;
}
constexpr void ::UnityEngine::UIElements::StyleSheets::Dimension::__set_unit(::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit, 0x0>(this->__instance, std::forward<::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit>(value));
}
constexpr ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit ::UnityEngine::UIElements::StyleSheets::Dimension::__get_unit() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit, 0x0>(this->__instance);
}
...
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
 ...
 void ::UnityEngine::UIElements::StyleSheets::Dimension::_ctor(float_t value, ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__Dimension__Unit unit)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::StyleSheets::Dimension>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
