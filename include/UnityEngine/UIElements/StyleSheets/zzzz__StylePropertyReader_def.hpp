...
namespace UnityEngine::UIElements::StyleSheets {
class ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction;
}
...
class CORDL_TYPE ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction(____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction(____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction& operator=(____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction&& o) noexcept = default;
  constexpr ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction& operator=(____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction const& o) noexcept = default;
...
explicit ____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using GetCursorIdFunction = ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction;
...
static ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction __declspec(property(get=__get_getCursorIdFunc, put=__set_getCursorIdFunc))  getCursorIdFunc;

static void __set_getCursorIdFunc(::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction value) ;

static ::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction __get_getCursorIdFunc() ;
...
NEED_NO_BOX(::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::StyleSheets::____UnityEngine__UIElements__StyleSheets__StylePropertyReader__GetCursorIdFunction, "UnityEngine.UIElements.StyleSheets", "StylePropertyReader/GetCursorIdFunction");
