...
// Ctor Parameters []
 ::UnityEngine::UIElements::PointerUpEvent::PointerUpEvent()  : ::UnityEngine::UIElements::PointerEventBase_1<::UnityEngine::UIElements::PointerUpEvent>(THROW_UNLESS(::il2cpp_utils::New<PointerUpEvent>())) {}
