...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::____UnityEngine__UIElements__TextureRegistry__TextureInfo(::UnityEngine::Texture texture, bool dynamic, int32_t refCount) noexcept : ::bs_hook::ValueTypeWrapper() {this->texture = texture;
this->dynamic = dynamic;
this->refCount = refCount;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__set_texture(::UnityEngine::Texture value)  {
::cordl_internals::setInstanceField<::UnityEngine::Texture, 0x0>(this->__instance, std::forward<::UnityEngine::Texture>(value));
}
constexpr ::UnityEngine::Texture ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__get_texture() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Texture, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__set_dynamic(bool value)  {
::cordl_internals::setInstanceField<bool, 0x8>(this->__instance, std::forward<bool>(value));
}
constexpr bool ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__get_dynamic() const {
return ::cordl_internals::getInstanceField<bool, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__set_refCount(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0xc>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo::__get_refCount() const {
...
constexpr void ::UnityEngine::UIElements::TextureRegistry::__set_m_Textures(::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo>>(value));
}
constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo> ::UnityEngine::UIElements::TextureRegistry::__get_m_Textures() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__TextureRegistry__TextureInfo>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
