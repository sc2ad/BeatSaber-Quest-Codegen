...
struct CORDL_TYPE UnityEngine__UIElements__StyleSheet__ImportStruct : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__StyleSheet__ImportStruct(UnityEngine::UIElements::StyleSheet styleSheet, ::ArrayW<::StringW> mediaQueries) noexcept;


                    constexpr UnityEngine__UIElements__StyleSheet__ImportStruct(UnityEngine__UIElements__StyleSheet__ImportStruct const&) = default;
                    constexpr UnityEngine__UIElements__StyleSheet__ImportStruct(UnityEngine__UIElements__StyleSheet__ImportStruct&&) = default;
                    constexpr UnityEngine__UIElements__StyleSheet__ImportStruct& operator=(UnityEngine__UIElements__StyleSheet__ImportStruct const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__StyleSheet__ImportStruct& operator=(UnityEngine__UIElements__StyleSheet__ImportStruct&& o) noexcept {
...
constexpr explicit UnityEngine__UIElements__StyleSheet__ImportStruct(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using ImportStruct = UnityEngine::UIElements::UnityEngine__UIElements__StyleSheet__ImportStruct;
...
constexpr ::ArrayW<UnityEngine::Object> __get_assets() const;
 ...
 ::ArrayW<UnityEngine::UIElements::UnityEngine__UIElements__StyleSheet__ImportStruct> __declspec(property(get=__get_imports, put=__set_imports))  imports;

constexpr void __set_imports(::ArrayW<UnityEngine::UIElements::UnityEngine__UIElements__StyleSheet__ImportStruct> value) ;

constexpr ::ArrayW<UnityEngine::UIElements::UnityEngine__UIElements__StyleSheet__ImportStruct> __get_imports() const;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__StyleSheet__ImportStruct, "UnityEngine.UIElements", "StyleSheet/ImportStruct");
