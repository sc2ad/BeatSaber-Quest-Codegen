...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::MouseEnterWindowEvent::*)()>(&UnityEngine::UIElements::MouseEnterWindowEvent::Init)> {
  ...
  constexpr static std::size_t addrs = 0x2cda39c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(UnityEngine::UIElements::MouseEnterWindowEvent),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::MouseEnterWindowEvent>::get(),
                                  12
                                ));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::MouseEnterWindowEvent::*)()>(&UnityEngine::UIElements::MouseEnterWindowEvent::LocalInit)> {
  ...
  constexpr static std::size_t addrs = 0x2cda3f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::MouseEnterWindowEvent::*)()>(&UnityEngine::UIElements::MouseEnterWindowEvent::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x2cda3fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::MouseEnterWindowEvent::*)(UnityEngine::UIElements::IPanel)>(&UnityEngine::UIElements::MouseEnterWindowEvent::PostDispatch)> {
  ...
  constexpr static std::size_t addrs = 0x2cda450;
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::MouseEnterWindowEvent UnityEngine::UIElements::MouseEnterWindowEvent::New_ctor()  {
UnityEngine::UIElements::MouseEnterWindowEvent o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::MouseEnterWindowEvent>())};
return o;
}
 void UnityEngine::UIElements::MouseEnterWindowEvent::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::MouseEnterWindowEvent>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
