...
// Ctor Parameters []
 ::UnityEngine::UIElements::MouseEnterWindowEvent::MouseEnterWindowEvent()  : ::UnityEngine::UIElements::MouseEventBase_1<::UnityEngine::UIElements::MouseEnterWindowEvent>(THROW_UNLESS(::il2cpp_utils::New<MouseEnterWindowEvent>())) {}
