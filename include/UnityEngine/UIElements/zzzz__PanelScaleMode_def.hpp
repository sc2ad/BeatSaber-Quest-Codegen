...
struct CORDL_TYPE PanelScaleMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr PanelScaleMode(int32_t value__) noexcept;
                    ...
                    constexpr PanelScaleMode(PanelScaleMode const&) = default;
                    constexpr PanelScaleMode(PanelScaleMode&&) = default;
                    constexpr PanelScaleMode& operator=(PanelScaleMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr PanelScaleMode& operator=(PanelScaleMode&& o) noexcept {
...
constexpr explicit PanelScaleMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __PanelScaleMode_Unwrapped : int32_t {
__ConstantPixelSize = 0,
__ConstantPhysicalSize = 1,
__ScaleWithScreenSize = 2,
};

/// @brief Conversion into unwrapped enum value
constexpr operator __PanelScaleMode_Unwrapped () const noexcept {
return std::bit_cast<__PanelScaleMode_Unwrapped>(__instance);
}
