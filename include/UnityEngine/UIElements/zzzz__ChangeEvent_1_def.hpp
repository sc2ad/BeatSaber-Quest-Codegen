...
// Fields
 ...
 int32_t __declspec(property(get=__get__previousValue_k__BackingField, put=__set__previousValue_k__BackingField))  _previousValue_k__BackingField;

constexpr void __set__previousValue_k__BackingField(int32_t value) ;

constexpr int32_t __get__previousValue_k__BackingField() const;

 int32_t __declspec(property(get=__get__newValue_k__BackingField, put=__set__newValue_k__BackingField))  _newValue_k__BackingField;

constexpr void __set__newValue_k__BackingField(int32_t value) ;

constexpr int32_t __get__newValue_k__BackingField() const;


// Properties

 int32_t __declspec(property(get=get_previousValue, put=set_previousValue))  previousValue;

 int32_t __declspec(property(get=get_newValue, put=set_newValue))  newValue;


// Methods

/// @brief Method get_previousValue addr 0x0 size 0xffffffffffffffff virtual false final false
 int32_t get_previousValue() ;

/// @brief Method set_previousValue addr 0x0 size 0xffffffffffffffff virtual false final false
 void set_previousValue(int32_t value) ;

/// @brief Method get_newValue addr 0x0 size 0xffffffffffffffff virtual false final false
 int32_t get_newValue() ;

/// @brief Method set_newValue addr 0x0 size 0xffffffffffffffff virtual false final false
 void set_newValue(int32_t value) ;
