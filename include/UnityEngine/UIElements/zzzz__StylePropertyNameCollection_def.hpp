...
namespace UnityEngine::UIElements {
struct ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator;
}
// Type: ::Enumerator
namespace UnityEngine::UIElements {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "m_Enumerator", ty: "::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName>", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator(::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> m_Enumerator) noexcept;


                    constexpr ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator(____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator const&) = default;
                    constexpr ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator(____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator&&) = default;
                    constexpr ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator& operator=(____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator& operator=(____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 ::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> __declspec(property(get=__get_m_Enumerator, put=__set_m_Enumerator))  m_Enumerator;

constexpr void __set_m_Enumerator(::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> value) ;

constexpr ::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> __get_m_Enumerator() const;
...
/// @brief Method .ctor addr 0x2cd7358 size 0xc virtual false final false
 void _ctor(::System::Collections::Generic::____System__Collections__Generic__List_1__Enumerator<::UnityEngine::UIElements::StylePropertyName> enumerator) ;
...
public:
// Declarations
using Enumerator = ::UnityEngine::UIElements::____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator;
...
/// @brief Method GetEnumerator addr 0x2cd72e8 size 0x70 virtual false final false
 ::UnityEngine::UIElements::____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator GetEnumerator() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__StylePropertyNameCollection__Enumerator, "UnityEngine.UIElements", "StylePropertyNameCollection/Enumerator");
