...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::IStylePainter::*)(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams, UnityEngine::UIElements::ITextHandle, float_t)>(&UnityEngine::UIElements::IStylePainter::DrawText)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::IStylePainter::*)(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams)>(&UnityEngine::UIElements::IStylePainter::DrawRectangle)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::IStylePainter::*)(System::Action, bool)>(&UnityEngine::UIElements::IStylePainter::DrawImmediate)> {
 ...
 void UnityEngine::UIElements::IStylePainter::DrawText(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams textParams, UnityEngine::UIElements::ITextHandle handle, float_t pixelsPerPoint)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, textParams, handle, pixelsPerPoint);
 ...
 void UnityEngine::UIElements::IStylePainter::DrawRectangle(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams rectParams)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::IStylePainter>::get(),
                            "DrawRectangle",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__RectangleParams>::get()}
                        )));
