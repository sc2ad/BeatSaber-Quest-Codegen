...
struct CORDL_TYPE UnityEngine__UIElements__TextureRegistry__TextureInfo : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__TextureRegistry__TextureInfo(UnityEngine::Texture texture, bool dynamic, int32_t refCount) noexcept;


                    constexpr UnityEngine__UIElements__TextureRegistry__TextureInfo(UnityEngine__UIElements__TextureRegistry__TextureInfo const&) = default;
                    constexpr UnityEngine__UIElements__TextureRegistry__TextureInfo(UnityEngine__UIElements__TextureRegistry__TextureInfo&&) = default;
                    constexpr UnityEngine__UIElements__TextureRegistry__TextureInfo& operator=(UnityEngine__UIElements__TextureRegistry__TextureInfo const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__TextureRegistry__TextureInfo& operator=(UnityEngine__UIElements__TextureRegistry__TextureInfo&& o) noexcept {
...
constexpr explicit UnityEngine__UIElements__TextureRegistry__TextureInfo(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using TextureInfo = UnityEngine::UIElements::UnityEngine__UIElements__TextureRegistry__TextureInfo;
...
// Fields
 ...
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__TextureRegistry__TextureInfo> __declspec(property(get=__get_m_Textures, put=__set_m_Textures))  m_Textures;

constexpr void __set_m_Textures(System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__TextureRegistry__TextureInfo> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__TextureRegistry__TextureInfo> __get_m_Textures() const;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__TextureRegistry__TextureInfo, "UnityEngine.UIElements", "TextureRegistry/TextureInfo");
