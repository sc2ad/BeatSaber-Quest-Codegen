...
// Ctor Parameters []
 UnityEngine::UIElements::WheelEvent::WheelEvent()  : UnityEngine::UIElements::MouseEventBase_1<UnityEngine::UIElements::WheelEvent>(THROW_UNLESS(::il2cpp_utils::New<WheelEvent>())) {}
