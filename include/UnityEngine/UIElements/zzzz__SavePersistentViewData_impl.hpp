...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::SavePersistentViewData::*)()>(&UnityEngine::UIElements::SavePersistentViewData::Invoke)> {
 ...
 UnityEngine::UIElements::SavePersistentViewData UnityEngine::UIElements::SavePersistentViewData::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
UnityEngine::UIElements::SavePersistentViewData o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::SavePersistentViewData>(object, method))};
return o;
}
