...
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::UnityEngine__UIElements__DragEventsProcessor__DragState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState  UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::None{0};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState  UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::CanStartDrag{1};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState  UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState::Dragging{2};
...
constexpr void UnityEngine::UIElements::DragEventsProcessor::__set_m_DragState(UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState value)  {
::cordl_internals::setInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState>(value));
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState UnityEngine::UIElements::DragEventsProcessor::__get_m_DragState() const {
return ::cordl_internals::getInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__DragEventsProcessor__DragState, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::DragEventsProcessor UnityEngine::UIElements::DragEventsProcessor::New_ctor(UnityEngine::UIElements::VisualElement target)  {
UnityEngine::UIElements::DragEventsProcessor o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::DragEventsProcessor>(target))};
return o;
}
