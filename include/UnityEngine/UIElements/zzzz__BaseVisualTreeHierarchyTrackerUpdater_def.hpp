...
namespace UnityEngine::UIElements {
struct ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State;
}
namespace UnityEngine::UIElements {
...
struct CORDL_TYPE ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State(____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State const&) = default;
                    constexpr ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State(____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State&&) = default;
                    constexpr ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State& operator=(____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State& operator=(____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State_Unwrapped : int32_t {
__Waiting = 0,
...
constexpr operator ______UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State_Unwrapped>(__instance);
}
...
static ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State const Waiting;

/// @brief Field TrackingAddOrMove offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State const TrackingAddOrMove;

/// @brief Field TrackingRemove offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State const TrackingRemove;
...
public:
// Declarations
using State = ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State;
...
// Fields
 ...
 ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State __declspec(property(get=__get_m_State, put=__set_m_State))  m_State;

constexpr void __set_m_State(::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State value) ;

constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State __get_m_State() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__BaseVisualTreeHierarchyTrackerUpdater__State, "UnityEngine.UIElements", "BaseVisualTreeHierarchyTrackerUpdater/State");
