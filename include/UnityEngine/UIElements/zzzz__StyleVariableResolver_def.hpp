...
namespace UnityEngine::UIElements {
struct ____UnityEngine__UIElements__StyleVariableResolver__Result;
}
namespace UnityEngine::UIElements {
...
struct CORDL_TYPE ____UnityEngine__UIElements__StyleVariableResolver__Result : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UIElements__StyleVariableResolver__Result(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__Result(____UnityEngine__UIElements__StyleVariableResolver__Result const&) = default;
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__Result(____UnityEngine__UIElements__StyleVariableResolver__Result&&) = default;
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__Result& operator=(____UnityEngine__UIElements__StyleVariableResolver__Result const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__Result& operator=(____UnityEngine__UIElements__StyleVariableResolver__Result&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__StyleVariableResolver__Result(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UIElements__StyleVariableResolver__Result_Unwrapped : int32_t {
__Valid = 0,
__Invalid = 1,
__NotFound = 2,
};
...
constexpr operator ______UnityEngine__UIElements__StyleVariableResolver__Result_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UIElements__StyleVariableResolver__Result_Unwrapped>(__instance);
}
...
static ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result const Valid;

/// @brief Field Invalid offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result const Invalid;

/// @brief Field NotFound offset 0
static ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result const NotFound;
...
struct CORDL_TYPE ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext(::UnityEngine::UIElements::StyleSheet sheet, ::ArrayW<::UnityEngine::UIElements::StyleValueHandle> handles) noexcept;


                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext(____UnityEngine__UIElements__StyleVariableResolver__ResolveContext const&) = default;
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext(____UnityEngine__UIElements__StyleVariableResolver__ResolveContext&&) = default;
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext& operator=(____UnityEngine__UIElements__StyleVariableResolver__ResolveContext const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext& operator=(____UnityEngine__UIElements__StyleVariableResolver__ResolveContext&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UIElements__StyleVariableResolver__ResolveContext(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using ResolveContext = ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext;

using Result = ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result;
...
constexpr ::UnityEngine::UIElements::StyleProperty __get_m_Property() const;
 ...
 ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext> __declspec(property(get=__get_m_ContextStack, put=__set_m_ContextStack))  m_ContextStack;

constexpr void __set_m_ContextStack(::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext> value) ;

constexpr ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext> __get_m_ContextStack() const;

 ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext __declspec(property(get=__get_m_CurrentContext, put=__set_m_CurrentContext))  m_CurrentContext;

constexpr void __set_m_CurrentContext(::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext value) ;

constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext __get_m_CurrentContext() const;
...
/// @brief Method ResolveVarFunction addr 0x2cf30d4 size 0x15c virtual false final false
 ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result ResolveVarFunction(ByRef<int32_t> index, int32_t argc, ::StringW varName) ;
...
/// @brief Method ResolveVariable addr 0x2cf3230 size 0x278 virtual false final false
 ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result ResolveVariable(::StringW variableName) ;

/// @brief Method ResolveFallback addr 0x2cf34b0 size 0x284 virtual false final false
 ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result ResolveFallback(ByRef<int32_t> index) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__Result, "UnityEngine.UIElements", "StyleVariableResolver/Result");
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__StyleVariableResolver__ResolveContext, "UnityEngine.UIElements", "StyleVariableResolver/ResolveContext");
