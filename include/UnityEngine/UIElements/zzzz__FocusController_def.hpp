...
struct CORDL_TYPE ____UnityEngine__UIElements__FocusController__FocusedElement : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__UIElements__FocusController__FocusedElement(::UnityEngine::UIElements::VisualElement m_SubTreeRoot, ::UnityEngine::UIElements::Focusable m_FocusedElement) noexcept;


                    constexpr ____UnityEngine__UIElements__FocusController__FocusedElement(____UnityEngine__UIElements__FocusController__FocusedElement const&) = default;
                    constexpr ____UnityEngine__UIElements__FocusController__FocusedElement(____UnityEngine__UIElements__FocusController__FocusedElement&&) = default;
                    constexpr ____UnityEngine__UIElements__FocusController__FocusedElement& operator=(____UnityEngine__UIElements__FocusController__FocusedElement const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__FocusController__FocusedElement& operator=(____UnityEngine__UIElements__FocusController__FocusedElement&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__FocusController__FocusedElement(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using FocusedElement = ::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement;
...
constexpr ::UnityEngine::UIElements::IFocusRing __get__focusRing_k__BackingField() const;
 ...
 ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement> __declspec(property(get=__get_m_FocusedElements, put=__set_m_FocusedElements))  m_FocusedElements;

constexpr void __set_m_FocusedElements(::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement> value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement> __get_m_FocusedElements() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__FocusController__FocusedElement, "UnityEngine.UIElements", "FocusController/FocusedElement");
