...
struct CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset__UsingEntry : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntry(::StringW alias, ::StringW path, UnityEngine::UIElements::VisualTreeAsset asset) noexcept;


                    constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntry(UnityEngine__UIElements__VisualTreeAsset__UsingEntry const&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntry(UnityEngine__UIElements__VisualTreeAsset__UsingEntry&&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntry& operator=(UnityEngine__UIElements__VisualTreeAsset__UsingEntry const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntry& operator=(UnityEngine__UIElements__VisualTreeAsset__UsingEntry&& o) noexcept {
...
constexpr explicit UnityEngine__UIElements__VisualTreeAsset__UsingEntry(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
static System::Collections::Generic::IComparer_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __declspec(property(get=__get_comparer, put=__set_comparer))  comparer;

static void __set_comparer(System::Collections::Generic::IComparer_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> value) ;

static System::Collections::Generic::IComparer_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __get_comparer() ;
...
class CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer(UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer(UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer& operator=(UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer&& o) noexcept = default;
  constexpr UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer& operator=(UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer const& o) noexcept = default;
...
struct CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset__SlotDefinition : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__VisualTreeAsset__SlotDefinition(::StringW name, int32_t insertionPointId) noexcept;


                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotDefinition(UnityEngine__UIElements__VisualTreeAsset__SlotDefinition const&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotDefinition(UnityEngine__UIElements__VisualTreeAsset__SlotDefinition&&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotDefinition& operator=(UnityEngine__UIElements__VisualTreeAsset__SlotDefinition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotDefinition& operator=(UnityEngine__UIElements__VisualTreeAsset__SlotDefinition&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset__SlotDefinition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry(::StringW slotName, int32_t assetId) noexcept;


                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry(UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry const&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry(UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry&&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry& operator=(UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry& operator=(UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17(UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17(UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17& operator=(UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17&& o) noexcept = default;
  constexpr UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17& operator=(UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17 const& o) noexcept = default;
...
constexpr System::Collections::Generic::HashSet_1<UnityEngine::UIElements::VisualTreeAsset> __get__sent_5__1() const;
 ...
 System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __declspec(property(get=__get___s__2, put=__set___s__2))  __s__2;

constexpr void __set___s__2(System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __get___s__2() const;

 UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry __declspec(property(get=__get__entry_5__3, put=__set__entry_5__3))  _entry_5__3;

constexpr void __set__entry_5__3(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry value) ;

constexpr UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry __get__entry_5__3() const;
...
class CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21(UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21(UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21& operator=(UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21&& o) noexcept = default;
  constexpr UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21& operator=(UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21 const& o) noexcept = default;
...
constexpr System::Collections::Generic::HashSet_1<UnityEngine::UIElements::StyleSheet> __get__sent_5__1() const;
 ...
 System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::VisualElementAsset> __declspec(property(get=__get___s__2, put=__set___s__2))  __s__2;

constexpr void __set___s__2(System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::VisualElementAsset> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::VisualElementAsset> __get___s__2() const;
...
constexpr UnityEngine::UIElements::VisualElementAsset __get__vea_5__3() const;
 ...
 System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::StyleSheet> __declspec(property(get=__get___s__4, put=__set___s__4))  __s__4;

constexpr void __set___s__4(System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::StyleSheet> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<UnityEngine::UIElements::StyleSheet> __get___s__4() const;
...
constexpr UnityEngine::UIElements::StyleSheet __get__stylesheet_5__5() const;
 ...
 System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<::StringW> __declspec(property(get=__get___s__6, put=__set___s__6))  __s__6;

constexpr void __set___s__6(System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<::StringW> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__List_1__Enumerator<::StringW> __get___s__6() const;
...
class CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0& operator=(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0&& o) noexcept = default;
  constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0& operator=(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0 const& o) noexcept = default;
...
/// @brief Method <CloneSetupRecursively>b__0 addr 0x2c9d860 size 0x24 virtual false final false
 bool _CloneSetupRecursively_b__0(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry u) ;
...
struct CORDL_TYPE UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "asset", ty: "UnityEngine::UIElements::VisualElementAsset", modifiers: "", def_value: None }]
constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0(UnityEngine::UIElements::VisualElementAsset asset) noexcept;


                    constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0 const&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0&&) = default;
                    constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0& operator=(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0& operator=(UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using __c__DisplayClass49_0 = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0;

using __c__DisplayClass45_0 = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0;

using _get_stylesheets_d__21 = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21;

using _get_templateDependencies_d__17 = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17;

using SlotUsageEntry = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry;

using SlotDefinition = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition;

using UsingEntryComparer = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer;

using UsingEntry = UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry;
...
static System::Collections::Generic::Dictionary_2<::StringW,UnityEngine::UIElements::VisualElement> __get_s_TemporarySlotInsertionPoints() ;
 ...
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __declspec(property(get=__get_m_Usings, put=__set_m_Usings))  m_Usings;

constexpr void __set_m_Usings(System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry> __get_m_Usings() const;
...
constexpr System::Collections::Generic::List_1<UnityEngine::UIElements::TemplateAsset> __get_m_TemplateAssets() const;
 ...
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> __declspec(property(get=__get_m_Slots, put=__set_m_Slots))  m_Slots;

constexpr void __set_m_Slots(System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> __get_m_Slots() const;
...
// Properties
 ...
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> __declspec(property(get=get_slots, put=set_slots))  slots;
...
/// @brief Method get_slots addr 0x2c9a6dc size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> get_slots() ;

/// @brief Method set_slots addr 0x2c9a6e4 size 0x8 virtual false final false
 void set_slots(System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition> value) ;
...
/// @brief Method CloneTree addr 0x2c9a87c size 0x680 virtual false final false
 void CloneTree(UnityEngine::UIElements::VisualElement target, System::Collections::Generic::Dictionary_2<::StringW,UnityEngine::UIElements::VisualElement> slotInsertionPoints, System::Collections::Generic::List_1<UnityEngine::UIElements::UnityEngine__UIElements__TemplateAsset__AttributeOverride> attributeOverrides) ;
...
static UnityEngine::UIElements::VisualElement _Create_g__CreateError_49_0(ByRef<UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0> ) ;

static constexpr bool __CORDL_IS_VALUE_TYPE = false;
};
// Non member Declarations
} // namespace end def UnityEngine::UIElements
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntryComparer, "UnityEngine.UIElements", "VisualTreeAsset/UsingEntryComparer");
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass45_0, "UnityEngine.UIElements", "VisualTreeAsset/<>c__DisplayClass45_0");
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_stylesheets_d__21, "UnityEngine.UIElements", "VisualTreeAsset/<get_stylesheets>d__21");
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset___get_templateDependencies_d__17, "UnityEngine.UIElements", "VisualTreeAsset/<get_templateDependencies>d__17");
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotDefinition, "UnityEngine.UIElements", "VisualTreeAsset/SlotDefinition");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__SlotUsageEntry, "UnityEngine.UIElements", "VisualTreeAsset/SlotUsageEntry");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset__UsingEntry, "UnityEngine.UIElements", "VisualTreeAsset/UsingEntry");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__VisualTreeAsset____c__DisplayClass49_0, "UnityEngine.UIElements", "VisualTreeAsset/<>c__DisplayClass49_0");
