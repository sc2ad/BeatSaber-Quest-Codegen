...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::IMGUIEvent UnityEngine::UIElements::IMGUIEvent::New_ctor()  {
UnityEngine::UIElements::IMGUIEvent o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::IMGUIEvent>())};
return o;
}
