...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::UIElements::EventBase UnityEngine::UIElements::EventBase::New_ctor()  {
UnityEngine::UIElements::EventBase o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::EventBase>())};
return o;
}
