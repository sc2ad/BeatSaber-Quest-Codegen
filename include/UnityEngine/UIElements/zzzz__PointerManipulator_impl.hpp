...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, e);
 ...
 UnityEngine::UIElements::PointerManipulator UnityEngine::UIElements::PointerManipulator::New_ctor()  {
UnityEngine::UIElements::PointerManipulator o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::PointerManipulator>())};
return o;
}
