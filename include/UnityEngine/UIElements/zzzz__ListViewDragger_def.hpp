...
struct CORDL_TYPE ____UnityEngine__UIElements__ListViewDragger__DragPosition : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::IEquatable_1<::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition>
constexpr operator  ::System::IEquatable_1<::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition>() const;
...
constexpr ____UnityEngine__UIElements__ListViewDragger__DragPosition(int32_t insertAtIndex, ::UnityEngine::UIElements::ReusableCollectionItem recycledItem, ::UnityEngine::UIElements::DragAndDropPosition dragAndDropPosition) noexcept;


                    constexpr ____UnityEngine__UIElements__ListViewDragger__DragPosition(____UnityEngine__UIElements__ListViewDragger__DragPosition const&) = default;
                    constexpr ____UnityEngine__UIElements__ListViewDragger__DragPosition(____UnityEngine__UIElements__ListViewDragger__DragPosition&&) = default;
                    constexpr ____UnityEngine__UIElements__ListViewDragger__DragPosition& operator=(____UnityEngine__UIElements__ListViewDragger__DragPosition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UIElements__ListViewDragger__DragPosition& operator=(____UnityEngine__UIElements__ListViewDragger__DragPosition&& o) noexcept {
...
constexpr explicit ____UnityEngine__UIElements__ListViewDragger__DragPosition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method Equals addr 0x2c9273c size 0x58 virtual true final true
 bool Equals(::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition other) ;
...
public:
// Declarations
using DragPosition = ::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition;
...
// Fields
 ...
 ::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition __declspec(property(get=__get_m_LastDragPosition, put=__set_m_LastDragPosition))  m_LastDragPosition;

constexpr void __set_m_LastDragPosition(::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition value) ;

constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition __get_m_LastDragPosition() const;
...
/// @brief Method GetVisualMode addr 0x2c91a8c size 0x164 virtual false final false
 ::UnityEngine::UIElements::DragVisualMode GetVisualMode(::UnityEngine::Vector3 pointerPosition, ByRef<::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition> dragPosition) ;
...
/// @brief Method ApplyDragAndDropUI addr 0x2c91bf0 size 0x5e0 virtual false final false
 void ApplyDragAndDropUI(::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition dragPosition) ;
...
/// @brief Method MakeDragAndDropArgs addr 0x2c9240c size 0x150 virtual false final false
 ::UnityEngine::UIElements::ListDragAndDropArgs MakeDragAndDropArgs(::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition dragPosition) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UIElements::____UnityEngine__UIElements__ListViewDragger__DragPosition, "UnityEngine.UIElements", "ListViewDragger/DragPosition");
