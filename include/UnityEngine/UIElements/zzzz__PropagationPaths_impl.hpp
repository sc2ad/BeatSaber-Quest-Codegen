...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::____UnityEngine__UIElements__PropagationPaths__Type(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type  ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::None{0};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type  ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::TrickleDown{1};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type  ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type::BubbleUp{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UIElements::PropagationPaths (*)(::UnityEngine::UIElements::VisualElement, ::UnityEngine::UIElements::EventBase, ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type)>(&::UnityEngine::UIElements::PropagationPaths::Build)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Build",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::VisualElement>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::EventBase>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type>::get()}
                        )));
    return ___internal_method;
  }
};
...
// Ctor Parameters []
 ::UnityEngine::UIElements::PropagationPaths::PropagationPaths()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<PropagationPaths>())) {}
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::UIElements::PropagationPaths, false>(nullptr, ___internal_method, paths);
 ...
 ::UnityEngine::UIElements::PropagationPaths ::UnityEngine::UIElements::PropagationPaths::Build(::UnityEngine::UIElements::VisualElement elem, ::UnityEngine::UIElements::EventBase evt, ::UnityEngine::UIElements::____UnityEngine__UIElements__PropagationPaths__Type pathTypesRequested)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::PropagationPaths>::get(),
                            "Build",
                            std::vector<Il2CppClass*>{},
