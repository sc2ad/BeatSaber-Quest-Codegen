...
namespace UnityEngine::UIElements {
template<::cordl_internals::is_or_is_backed_by<int32_t> TValueType,::cordl_internals::il2cpp_reference_type TValueUxmlAttributeType>
class BaseFieldTraits_2<TValueType,TValueUxmlAttributeType>;
}
namespace UnityEngine::UIElements {
...
static UnityEngine::UIElements::BaseFieldTraits_2<bool,TValueUxmlAttributeType> New_ctor() ;
...
static UnityEngine::UIElements::BaseFieldTraits_2<float_t,TValueUxmlAttributeType> New_ctor() ;
...
template<::cordl_internals::is_or_is_backed_by<int32_t> TValueType,::cordl_internals::il2cpp_reference_type TValueUxmlAttributeType>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7227), inst: 5041 }), TypeDefinitionIndex(TypeDefinitionIndex(7229)), TypeDefinitionIndex(TypeDefinitionIndex(7227))}
...
static UnityEngine::UIElements::BaseFieldTraits_2<TValueType,TValueUxmlAttributeType> New_ctor() ;
