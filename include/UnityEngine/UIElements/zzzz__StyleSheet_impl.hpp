...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct::____UnityEngine__UIElements__StyleSheet__ImportStruct(::UnityEngine::UIElements::StyleSheet styleSheet, ::ArrayW<::StringW> mediaQueries) noexcept : ::bs_hook::ValueTypeWrapper() {this->styleSheet = styleSheet;
this->mediaQueries = mediaQueries;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct::__set_styleSheet(::UnityEngine::UIElements::StyleSheet value)  {
...
constexpr ::UnityEngine::UIElements::StyleSheet ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct::__get_styleSheet() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheet, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct::__set_mediaQueries(::ArrayW<::StringW> value)  {
::cordl_internals::setInstanceField<::ArrayW<::StringW>, 0x8>(this->__instance, std::forward<::ArrayW<::StringW>>(value));
}
constexpr ::ArrayW<::StringW> ::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct::__get_mediaQueries() const {
...
constexpr void ::UnityEngine::UIElements::StyleSheet::__set_imports(::ArrayW<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct>, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct>>(value));
}
constexpr ::ArrayW<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct> ::UnityEngine::UIElements::StyleSheet::__get_imports() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::UIElements::____UnityEngine__UIElements__StyleSheet__ImportStruct>, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
