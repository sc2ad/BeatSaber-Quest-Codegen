...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::ExecuteCommandEvent::*)()>(&UnityEngine::UIElements::ExecuteCommandEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2cdab9c;
 ...
 UnityEngine::UIElements::ExecuteCommandEvent UnityEngine::UIElements::ExecuteCommandEvent::New_ctor()  {
UnityEngine::UIElements::ExecuteCommandEvent o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::ExecuteCommandEvent>())};
return o;
}
