...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UIElements::ISerializableJsonDictionary (UnityEngine::UIElements::GetViewDataDictionary::*)()>(&UnityEngine::UIElements::GetViewDataDictionary::Invoke)> {
 ...
 UnityEngine::UIElements::GetViewDataDictionary UnityEngine::UIElements::GetViewDataDictionary::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
UnityEngine::UIElements::GetViewDataDictionary o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::GetViewDataDictionary>(object, method))};
return o;
}
