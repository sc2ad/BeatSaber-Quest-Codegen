...
constexpr void UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status  UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::None{0};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status  UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::Normal{1};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status  UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::Disabled{2};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status  UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::Checked{4};
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status  UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status::Hidden{8};
//  Writing Method size for method: UnityEngine::UIElements::DropdownMenuAction.set_status
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::DropdownMenuAction::*)(UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status)>(&UnityEngine::UIElements::DropdownMenuAction::set_status)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::DropdownMenuAction::*)(::StringW, System::Action_1<UnityEngine::UIElements::DropdownMenuAction>, System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>, ::bs_hook::Il2CppWrapperType)>(&UnityEngine::UIElements::DropdownMenuAction::_ctor)> {
...
constexpr void UnityEngine::UIElements::DropdownMenuAction::__set__status_k__BackingField(UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status value)  {
::cordl_internals::setInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>(value));
}
constexpr UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status UnityEngine::UIElements::DropdownMenuAction::__get__status_k__BackingField() const {
return ::cordl_internals::getInstanceField<UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void UnityEngine::UIElements::DropdownMenuAction::__set_actionStatusCallback(System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status> value)  {
::cordl_internals::setInstanceField<System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>>(value));
}
constexpr System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status> UnityEngine::UIElements::DropdownMenuAction::__get_actionStatusCallback() const {
return ::cordl_internals::getInstanceField<System::Func_2<UnityEngine::UIElements::DropdownMenuAction,UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void UnityEngine::UIElements::DropdownMenuAction::set_status(UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UIElements::DropdownMenuAction>::get(),
                            "set_status",
                            std::vector<Il2CppClass*>{},
