...
constexpr void UnityEngine::UIElements::UnityEngine__UIElements__PanelRaycaster__FloatIntBits::__set_f(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t UnityEngine::UIElements::UnityEngine__UIElements__PanelRaycaster__FloatIntBits::__get_f() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void UnityEngine::UIElements::UnityEngine__UIElements__PanelRaycaster__FloatIntBits::__set_i(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UIElements::UnityEngine__UIElements__PanelRaycaster__FloatIntBits::__get_i() const {
