...
static UnityEngine::UIElements::Experimental::ValueAnimation_1<UnityEngine::UIElements::Experimental::StyleValues> New_ctor() ;
...
static UnityEngine::UIElements::Experimental::ValueAnimation_1<T> New_ctor() ;
