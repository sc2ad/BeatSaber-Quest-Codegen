...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::____UnityEngine__UIElements__InlineStyleAccess__InlineRule(::UnityEngine::UIElements::StyleSheet sheet, ::UnityEngine::UIElements::StyleRule rule, ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> propertyIds) noexcept : ::bs_hook::ValueTypeWrapper() {this->sheet = sheet;
this->rule = rule;
this->propertyIds = propertyIds;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__set_sheet(::UnityEngine::UIElements::StyleSheet value)  {
...
constexpr ::UnityEngine::UIElements::StyleSheet ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__get_sheet() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheet, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__set_rule(::UnityEngine::UIElements::StyleRule value)  {
...
constexpr ::UnityEngine::UIElements::StyleRule ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__get_rule() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleRule, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__set_propertyIds(::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> value)  {
...
constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId> ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule::__get_propertyIds() const {
...
constexpr void ::UnityEngine::UIElements::InlineStyleAccess::__set_m_InlineRule(::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule, 0xe8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule>(value));
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule ::UnityEngine::UIElements::InlineStyleAccess::__get_m_InlineRule() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__InlineStyleAccess__InlineRule, 0xe8>(this->::bs_hook::Il2CppWrapperType::instance);
}
