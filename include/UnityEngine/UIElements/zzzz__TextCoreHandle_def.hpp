...
/// @brief Method IsDirty addr 0x2cce684 size 0x44 virtual false final false
 bool IsDirty(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams parms) ;
...
/// @brief Method UpdatePreferredValues addr 0x2cce724 size 0x130 virtual false final false
 void UpdatePreferredValues(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams parms) ;

/// @brief Method GetTextOverflowMode addr 0x2cceda4 size 0x3c virtual false final false
static UnityEngine::TextCore::Text::TextOverflowMode GetTextOverflowMode(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams textParams) ;

/// @brief Method UpdateGenerationSettingsCommon addr 0x2cceaf8 size 0x2ac virtual false final false
static void UpdateGenerationSettingsCommon(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams painterParams, UnityEngine::TextCore::Text::TextGenerationSettings settings) ;
