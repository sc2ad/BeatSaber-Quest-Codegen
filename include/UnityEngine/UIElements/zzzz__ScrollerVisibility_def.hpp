...
struct CORDL_TYPE ScrollerVisibility : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr ScrollerVisibility(int32_t value__) noexcept;
                    ...
                    constexpr ScrollerVisibility(ScrollerVisibility const&) = default;
                    constexpr ScrollerVisibility(ScrollerVisibility&&) = default;
                    constexpr ScrollerVisibility& operator=(ScrollerVisibility const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ScrollerVisibility& operator=(ScrollerVisibility&& o) noexcept {
...
constexpr explicit ScrollerVisibility(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __ScrollerVisibility_Unwrapped : int32_t {
__Auto = 0,
__AlwaysVisible = 1,
__Hidden = 2,
};
...
return std::bit_cast<__ScrollerVisibility_Unwrapped>(__instance);
}
