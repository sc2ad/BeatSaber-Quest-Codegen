...
static UnityEngine::UIElements::BaseSlider_1<float_t> New_ctor(::StringW label, float_t start, float_t end, UnityEngine::UIElements::SliderDirection direction, float_t pageSize) ;
...
static UnityEngine::UIElements::BaseSlider_1<TValueType> New_ctor(::StringW label, TValueType start, TValueType end, UnityEngine::UIElements::SliderDirection direction, float_t pageSize) ;
...
template<::cordl_internals::il2cpp_reference_type TValueType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7228)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7228), inst: 888 }), TypeDefinitionIndex(TypeDefinitionIndex(7199))}
