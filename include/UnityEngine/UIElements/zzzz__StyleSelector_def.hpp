...
class CORDL_TYPE UnityEngine__UIElements__StyleSelector____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__UIElements__StyleSelector____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__StyleSelector____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__StyleSelector____c(UnityEngine__UIElements__StyleSelector____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__StyleSelector____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__StyleSelector____c(UnityEngine__UIElements__StyleSelector____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__StyleSelector____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UIElements__StyleSelector____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__StyleSelector____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__StyleSelector____c& operator=(UnityEngine__UIElements__StyleSelector____c&& o) noexcept = default;
  constexpr UnityEngine__UIElements__StyleSelector____c& operator=(UnityEngine__UIElements__StyleSelector____c const& o) noexcept = default;
                


// Fields

static UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c value) ;

static UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c __get___9() ;
...
public:
// Declarations
using __c = UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c;
...
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__StyleSelector____c, "UnityEngine.UIElements", "StyleSelector/<>c");
