...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, evt, panel);
 ...
 UnityEngine::UIElements::CommandEventDispatchingStrategy UnityEngine::UIElements::CommandEventDispatchingStrategy::New_ctor()  {
UnityEngine::UIElements::CommandEventDispatchingStrategy o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::CommandEventDispatchingStrategy>())};
return o;
}
