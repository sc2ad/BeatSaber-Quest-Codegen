...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UIElements::TransitionRunEvent::*)()>(&UnityEngine::UIElements::TransitionRunEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2cd7580;
 ...
 UnityEngine::UIElements::TransitionRunEvent UnityEngine::UIElements::TransitionRunEvent::New_ctor()  {
UnityEngine::UIElements::TransitionRunEvent o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UIElements::TransitionRunEvent>())};
return o;
}
