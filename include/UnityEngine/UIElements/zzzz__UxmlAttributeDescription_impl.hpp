...
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::____UnityEngine__UIElements__UxmlAttributeDescription__Use(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use  ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::None{0};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use  ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::Optional{1};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use  ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::Prohibited{2};
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use  ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use::Required{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UxmlAttributeDescription::*)(::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use)>(&::UnityEngine::UIElements::UxmlAttributeDescription::set_use)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_use",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::UnityEngine::UIElements::UxmlAttributeDescription::__set__use_k__BackingField(::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use>(value));
}
constexpr ::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use ::UnityEngine::UIElements::UxmlAttributeDescription::__get__use_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void ::UnityEngine::UIElements::UxmlAttributeDescription::set_use(::UnityEngine::UIElements::____UnityEngine__UIElements__UxmlAttributeDescription__Use value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::UxmlAttributeDescription>::get(),
                            "set_use",
                            std::vector<Il2CppClass*>{},
