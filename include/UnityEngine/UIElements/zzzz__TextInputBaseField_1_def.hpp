...
namespace UnityEngine::UIElements {
template<::cordl_internals::il2cpp_reference_type TValueType>
class UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType>;
}
namespace UnityEngine::UIElements {
template<::cordl_internals::il2cpp_reference_type TValueType>
class UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits<TValueType>;
}
// Type: ::UxmlTraits
// Type: ::TextInputBase
...
virtual ~UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits(UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits(UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits(void* ptr) noexcept : UnityEngine::UIElements::BaseFieldTraits_2<::StringW,UnityEngine::UIElements::UxmlStringAttributeDescription>(ptr) {
}


  constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits& operator=(UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits&& o) noexcept = default;
  constexpr UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits& operator=(UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits const& o) noexcept = default;
...
virtual ~UnityEngine__UIElements__TextInputBaseField_1__TextInputBase() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__TextInputBaseField_1__TextInputBase", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase(UnityEngine__UIElements__TextInputBaseField_1__TextInputBase const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__TextInputBaseField_1__TextInputBase", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase(UnityEngine__UIElements__TextInputBaseField_1__TextInputBase&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__TextInputBaseField_1__TextInputBase(void* ptr) noexcept : UnityEngine::UIElements::VisualElement(ptr) {
}


  constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase& operator=(UnityEngine__UIElements__TextInputBaseField_1__TextInputBase&& o) noexcept = default;
  constexpr UnityEngine__UIElements__TextInputBaseField_1__TextInputBase& operator=(UnityEngine__UIElements__TextInputBaseField_1__TextInputBase const& o) noexcept = default;
...
/// @brief Method CutActionStatus addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status CutActionStatus(UnityEngine::UIElements::DropdownMenuAction a) ;

/// @brief Method CopyActionStatus addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status CopyActionStatus(UnityEngine::UIElements::DropdownMenuAction a) ;

/// @brief Method PasteActionStatus addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__DropdownMenuAction__Status PasteActionStatus(UnityEngine::UIElements::DropdownMenuAction a) ;
...
static void SyncGUIStyle(UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> textInput, UnityEngine::GUIStyle style) ;
...
public:
// Declarations
using TextInputBase = UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType>;

using UxmlTraits = UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits<TValueType>;
...
constexpr int32_t __get_m_VisualInputTabIndex() const;
 ...
 UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> __declspec(property(get=__get_m_TextInputBase, put=__set_m_TextInputBase))  m_TextInputBase;

constexpr void __set_m_TextInputBase(UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> value) ;

constexpr UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> __get_m_TextInputBase() const;
...
// Properties
 ...
 UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> __declspec(property(get=get_textInputBase))  textInputBase;
...
/// @brief Method get_textInputBase addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase<TValueType> get_textInputBase() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__TextInputBase, "UnityEngine.UIElements", "TextInputBaseField`1/TextInputBase");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(UnityEngine::UIElements::UnityEngine__UIElements__TextInputBaseField_1__UxmlTraits, "UnityEngine.UIElements", "TextInputBaseField`1/UxmlTraits");
