...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 108C45C
  // [NativeClassAttribute] Offset: 108C45C
  // [DefaultMemberAttribute] Offset: 108C45C
  // [RequiredByNativeCodeAttribute] Offset: 108C45C
