...
namespace UnityEngine {
  ...
  // [DefaultMemberAttribute] Offset: 11BFEA0
  // [RequiredByNativeCodeAttribute] Offset: 11BFEA0
  // [NativeHeaderAttribute] Offset: 11BFEA0
  // [NativeClassAttribute] Offset: 11BFEA0
