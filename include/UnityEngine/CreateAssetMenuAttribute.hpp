...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA8340
  class CreateAssetMenuAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCABD94
    // [DebuggerBrowsableAttribute] Offset: 0xCABD94
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCABDD0
    // [DebuggerBrowsableAttribute] Offset: 0xCABDD0
