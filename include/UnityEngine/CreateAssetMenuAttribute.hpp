...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: D8FF20
  class CreateAssetMenuAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD93B6C
    // [DebuggerBrowsableAttribute] Offset: 0xD93B6C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xD93BA8
    // [CompilerGeneratedAttribute] Offset: 0xD93BA8
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::CreateAssetMenuAttribute::*)()>(&UnityEngine::CreateAssetMenuAttribute::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::CreateAssetMenuAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::CreateAssetMenuAttribute::*)()>(&UnityEngine::CreateAssetMenuAttribute::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::CreateAssetMenuAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
