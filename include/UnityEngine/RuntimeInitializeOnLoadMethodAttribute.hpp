...
namespace UnityEngine {
  ...
  check_size<sizeof(RuntimeInitializeOnLoadMethodAttribute), 16 + sizeof(UnityEngine::RuntimeInitializeLoadType) + ((16 + sizeof(UnityEngine::RuntimeInitializeLoadType)) % 8 != 0 ? (8 - (16 + sizeof(UnityEngine::RuntimeInitializeLoadType)) % 8) : 0)> __UnityEngine_RuntimeInitializeOnLoadMethodAttributeSizeCheck;
}
