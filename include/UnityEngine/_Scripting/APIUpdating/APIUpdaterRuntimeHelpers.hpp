...
namespace UnityEngine::_Scripting::APIUpdating {
  ...
  class APIUpdaterRuntimeHelpers : public ::CsObject {
    public:
    ...
    // Offset: 0x1384310
    static bool GetMovedFromAttributeDataForType(System::Type* sourceType, ::CsString*& assembly, ::CsString*& nsp, ::CsString*& klass);
    ...
    // Offset: 0x1384484
    static bool GetObsoleteTypeRedirection(System::Type* sourceType, ::CsString*& assemblyName, ::CsString*& nsp, ::CsString*& className);
