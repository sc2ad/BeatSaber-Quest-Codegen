...
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::____UnityEngine__TerrainData__BoundaryValueType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxHeightmapRes{0};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MinDetailResPerPatch{1};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxDetailResPerPatch{2};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxDetailPatchCount{3};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxDetailsPerRes{4};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MinAlphamapRes{5};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxAlphamapRes{6};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MinBaseMapRes{7};
constexpr ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType  ::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType::MaxBaseMapRes{8};
//  Writing Method size for method: ::UnityEngine::TerrainData.GetBoundaryValue
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)(::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType)>(&::UnityEngine::TerrainData::GetBoundaryValue)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType>::get()}
                        )));
...
return ::cordl_internals::getStaticField<int32_t, "k_MaximumBaseMapResolution", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TerrainData>::get>();
 ...
 int32_t ::UnityEngine::TerrainData::GetBoundaryValue(::UnityEngine::____UnityEngine__TerrainData__BoundaryValueType type)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TerrainData>::get(),
                            "GetBoundaryValue",
                            std::vector<Il2CppClass*>{},
