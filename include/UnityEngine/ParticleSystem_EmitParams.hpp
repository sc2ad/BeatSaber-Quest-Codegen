...
namespace UnityEngine {
  ...
  check_size<sizeof(ParticleSystem::EmitParams), 142 + sizeof(bool) + ((142 + sizeof(bool)) % 8 != 0 ? (8 - (142 + sizeof(bool)) % 8) : 0)> __UnityEngine_ParticleSystem_EmitParamsSizeCheck;
}
