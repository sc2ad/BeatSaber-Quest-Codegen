...
namespace UnityEngine {
  ...
  class GUILayoutOption : public ::Il2CppObject {
    ...
    check_size<sizeof(GUILayoutOption::Type), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_GUILayoutOption_TypeSizeCheck;
  ...
  check_size<sizeof(GUILayoutOption), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __UnityEngine_GUILayoutOptionSizeCheck;
}
