...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ImageEffectAllowedInSceneView::*)()>(&UnityEngine::ImageEffectAllowedInSceneView::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2b40698;
...
UnityEngine::ImageEffectAllowedInSceneView o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::ImageEffectAllowedInSceneView>())};
return o;
}
