...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CBD278
  class ReflectionProbe : public UnityEngine::Behaviour {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xCC1C04
    // [CompilerGeneratedAttribute] Offset: 0xCC1C04
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xCC1C40
    // [CompilerGeneratedAttribute] Offset: 0xCC1C40
