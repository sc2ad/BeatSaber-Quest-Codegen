...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: 11E5C0C
  // [RequireComponent] Offset: 11E5C0C
  // [NativeHeaderAttribute] Offset: 11E5C0C
  // [NativeHeaderAttribute] Offset: 11E5C0C
  class Canvas : public ::UnityEngine::Behaviour {
    public:
    // Nested type: ::UnityEngine::Canvas::WillRenderCanvases
    class WillRenderCanvases;
    // [DebuggerBrowsableAttribute] Offset: 0x11E5D7C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x11E5DB8
