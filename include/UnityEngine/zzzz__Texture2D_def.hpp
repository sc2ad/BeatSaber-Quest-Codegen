...
struct CORDL_TYPE ____UnityEngine__Texture2D__EXRFlags : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Texture2D__EXRFlags(int32_t value__) noexcept;


                    constexpr ____UnityEngine__Texture2D__EXRFlags(____UnityEngine__Texture2D__EXRFlags const&) = default;
                    constexpr ____UnityEngine__Texture2D__EXRFlags(____UnityEngine__Texture2D__EXRFlags&&) = default;
                    constexpr ____UnityEngine__Texture2D__EXRFlags& operator=(____UnityEngine__Texture2D__EXRFlags const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Texture2D__EXRFlags& operator=(____UnityEngine__Texture2D__EXRFlags&& o) noexcept {
...
constexpr explicit ____UnityEngine__Texture2D__EXRFlags(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__Texture2D__EXRFlags_Unwrapped : int32_t {
__None = 0,
__OutputAsFloat = 1,
__CompressZIP = 2,
__CompressRLE = 4,
...
constexpr operator ______UnityEngine__Texture2D__EXRFlags_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__Texture2D__EXRFlags_Unwrapped>(__instance);
}
...
static ::UnityEngine::____UnityEngine__Texture2D__EXRFlags const None;

/// @brief Field OutputAsFloat offset 0
static ::UnityEngine::____UnityEngine__Texture2D__EXRFlags const OutputAsFloat;

/// @brief Field CompressZIP offset 0
static ::UnityEngine::____UnityEngine__Texture2D__EXRFlags const CompressZIP;

/// @brief Field CompressRLE offset 0
static ::UnityEngine::____UnityEngine__Texture2D__EXRFlags const CompressRLE;

/// @brief Field CompressPIZ offset 0
static ::UnityEngine::____UnityEngine__Texture2D__EXRFlags const CompressPIZ;
...
public:
// Declarations
using EXRFlags = ::UnityEngine::____UnityEngine__Texture2D__EXRFlags;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__Texture2D__EXRFlags, "UnityEngine", "Texture2D/EXRFlags");
