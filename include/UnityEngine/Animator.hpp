...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: ECDAFC
  // [NativeHeaderAttribute] Offset: ECDAFC
  // [NativeHeaderAttribute] Offset: ECDAFC
  // [UsedByNativeCodeAttribute] Offset: ECDAFC
  class Animator : public UnityEngine::Behaviour {
    ...
    static ::ArrayW<T> ConvertStateMachineBehaviour(::ArrayW<UnityEngine::ScriptableObject*> rawObjects) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<::ArrayW<T>, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, rawObjects)));
    }
