...
namespace UnityEngine {
  ...
  // [VisibleToOtherModulesAttribute] Offset: E2599C
  // [AttributeUsageAttribute] Offset: E2599C
  class AssetFileNameExtensionAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xE25F98
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xE25FD4
