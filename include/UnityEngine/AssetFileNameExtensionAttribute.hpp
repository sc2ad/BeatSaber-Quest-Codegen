...
namespace UnityEngine {
  ...
  // [VisibleToOtherModulesAttribute] Offset: 1068E7C
  // [AttributeUsageAttribute] Offset: 1068E7C
  class AssetFileNameExtensionAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x106947C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10694B8
