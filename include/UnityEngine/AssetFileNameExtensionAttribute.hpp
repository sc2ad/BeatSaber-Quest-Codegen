...
namespace UnityEngine {
  ...
  // [VisibleToOtherModulesAttribute] Offset: 107FFBC
  // [AttributeUsageAttribute] Offset: 107FFBC
  class AssetFileNameExtensionAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10805BC
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10805F8
