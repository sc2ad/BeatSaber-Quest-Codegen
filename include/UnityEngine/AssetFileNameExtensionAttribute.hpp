...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CBA6EC
  // [VisibleToOtherModulesAttribute] Offset: CBA6EC
  class AssetFileNameExtensionAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCBACAC
    // [DebuggerBrowsableAttribute] Offset: 0xCBACAC
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xCBACE8
    // [CompilerGeneratedAttribute] Offset: 0xCBACE8
