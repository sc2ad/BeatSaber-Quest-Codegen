...
namespace UnityEngine {
  ...
  // [VisibleToOtherModulesAttribute] Offset: 104C4E0
  // [AttributeUsageAttribute] Offset: 104C4E0
  class AssetFileNameExtensionAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x104CAE0
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x104CB1C
