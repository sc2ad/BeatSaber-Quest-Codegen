...
namespace UnityEngine {
  ...
  check_size<sizeof(Bounds), 12 + sizeof(UnityEngine::Vector3) + ((12 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (12 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __UnityEngine_BoundsSizeCheck;
