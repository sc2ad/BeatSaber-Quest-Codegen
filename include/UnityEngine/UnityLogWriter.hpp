...
// Il2CppName: Write
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UnityLogWriter::*)(::ArrayWrapper<::Il2CppChar>, int, int)>(&UnityEngine::UnityLogWriter::Write)> {
  static const MethodInfo* get() {
