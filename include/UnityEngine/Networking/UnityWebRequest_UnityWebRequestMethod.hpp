...
namespace UnityEngine::Networking {
  ...
  check_size<sizeof(UnityWebRequest::UnityWebRequestMethod), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_Networking_UnityWebRequest_UnityWebRequestMethodSizeCheck;
}
