...
namespace UnityEngine::Networking::PlayerConnection {
  ...
  class PlayerEditorConnectionEvents::$$c__DisplayClass8_0 : public ::Il2CppObject {
    ...
    static PlayerEditorConnectionEvents::$$c__DisplayClass8_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Networking::PlayerConnection").WithContext("$$c__DisplayClass8_0").WithContext(".ctor");
