...
namespace UnityEngine::Networking::PlayerConnection {
  ...
  check_size<sizeof(PlayerConnection), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __UnityEngine_Networking_PlayerConnection_PlayerConnectionSizeCheck;
}
