...
namespace UnityEngine::Networking {
  ...
  // [UsedByNativeCodeAttribute] Offset: DDAC74
  // [NativeHeaderAttribute] Offset: DDAC74
  // [NativeHeaderAttribute] Offset: DDAC74
  class UnityWebRequestAsyncOperation : public UnityEngine::AsyncOperation {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xDDAE34
    // [DebuggerBrowsableAttribute] Offset: 0xDDAE34
