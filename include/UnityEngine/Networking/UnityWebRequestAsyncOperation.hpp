...
namespace UnityEngine::Networking {
  ...
  // [] Offset: FFFFFFFF
  // [UsedByNativeCodeAttribute] Offset: CECCAC
  // [NativeHeaderAttribute] Offset: CECCAC
  // [NativeHeaderAttribute] Offset: CECCAC
  class UnityWebRequestAsyncOperation : public UnityEngine::AsyncOperation {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCECE6C
    // [CompilerGeneratedAttribute] Offset: 0xCECE6C
