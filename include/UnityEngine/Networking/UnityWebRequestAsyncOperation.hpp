...
namespace UnityEngine::Networking {
  ...
  // [] Offset: FFFFFFFF
  // [UsedByNativeCodeAttribute] Offset: CED0E8
  // [NativeHeaderAttribute] Offset: CED0E8
  // [NativeHeaderAttribute] Offset: CED0E8
  class UnityWebRequestAsyncOperation : public UnityEngine::AsyncOperation {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCED2A8
    // [CompilerGeneratedAttribute] Offset: 0xCED2A8
