...
namespace UnityEngine::Networking {
  ...
  check_size<sizeof(UnityWebRequestAsyncOperation), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __UnityEngine_Networking_UnityWebRequestAsyncOperationSizeCheck;
}
