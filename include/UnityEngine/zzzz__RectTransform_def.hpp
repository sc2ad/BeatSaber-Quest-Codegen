...
namespace UnityEngine {
class ____UnityEngine__RectTransform__ReapplyDrivenProperties;
}
// Type: ::Axis
namespace UnityEngine {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__RectTransform__Axis : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__RectTransform__Axis(int32_t value__) noexcept;


                    constexpr ____UnityEngine__RectTransform__Axis(____UnityEngine__RectTransform__Axis const&) = default;
                    constexpr ____UnityEngine__RectTransform__Axis(____UnityEngine__RectTransform__Axis&&) = default;
                    constexpr ____UnityEngine__RectTransform__Axis& operator=(____UnityEngine__RectTransform__Axis const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__RectTransform__Axis& operator=(____UnityEngine__RectTransform__Axis&& o) noexcept {
...
constexpr explicit ____UnityEngine__RectTransform__Axis(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__RectTransform__Axis_Unwrapped : int32_t {
__Horizontal = 0,
__Vertical = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__RectTransform__Axis_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__RectTransform__Axis_Unwrapped>(__instance);
}
...
static ::UnityEngine::____UnityEngine__RectTransform__Axis const Horizontal;

/// @brief Field Vertical offset 0
static ::UnityEngine::____UnityEngine__RectTransform__Axis const Vertical;
...
class CORDL_TYPE ____UnityEngine__RectTransform__ReapplyDrivenProperties : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__RectTransform__ReapplyDrivenProperties() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__RectTransform__ReapplyDrivenProperties", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties(____UnityEngine__RectTransform__ReapplyDrivenProperties const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__RectTransform__ReapplyDrivenProperties", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties(____UnityEngine__RectTransform__ReapplyDrivenProperties&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__RectTransform__ReapplyDrivenProperties(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties& operator=(____UnityEngine__RectTransform__ReapplyDrivenProperties&& o) noexcept = default;
  constexpr ____UnityEngine__RectTransform__ReapplyDrivenProperties& operator=(____UnityEngine__RectTransform__ReapplyDrivenProperties const& o) noexcept = default;
...
explicit ____UnityEngine__RectTransform__ReapplyDrivenProperties(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using ReapplyDrivenProperties = ::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties;

using Axis = ::UnityEngine::____UnityEngine__RectTransform__Axis;
...
static ::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties __declspec(property(get=__get_reapplyDrivenProperties, put=__set_reapplyDrivenProperties))  reapplyDrivenProperties;

static void __set_reapplyDrivenProperties(::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties value) ;

static ::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties __get_reapplyDrivenProperties() ;
...
static void add_reapplyDrivenProperties(::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties value) ;

/// @brief Method remove_reapplyDrivenProperties addr 0x2b6c1ec size 0xb8 virtual false final false
static void remove_reapplyDrivenProperties(::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties value) ;
...
/// @brief Method SetSizeWithCurrentAnchors addr 0x2b6ce70 size 0xfc virtual false final false
 void SetSizeWithCurrentAnchors(::UnityEngine::____UnityEngine__RectTransform__Axis axis, float_t size) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__RectTransform__Axis, "UnityEngine", "RectTransform/Axis");
NEED_NO_BOX(::UnityEngine::RectTransform);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::RectTransform, "UnityEngine", "RectTransform");
NEED_NO_BOX(::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__RectTransform__ReapplyDrivenProperties, "UnityEngine", "RectTransform/ReapplyDrivenProperties");
