...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ThreadAndSerializationSafeAttribute::*)()>(&::UnityEngine::ThreadAndSerializationSafeAttribute::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2ba0e88;
