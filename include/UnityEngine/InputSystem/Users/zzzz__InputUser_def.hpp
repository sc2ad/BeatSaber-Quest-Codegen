...
struct CORDL_TYPE UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_UserIndex", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax(int32_t m_UserIndex) noexcept;


                    constexpr UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax(UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax const&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax(UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax&&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax& operator=(UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax& operator=(UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method AndPairRemainingDevices addr 0x293b848 size 0x24 virtual false final false
 UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax AndPairRemainingDevices() ;
...
struct CORDL_TYPE UnityEngine__InputSystem__Users__InputUser__UserFlags : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__Users__InputUser__UserFlags(int32_t value__) noexcept;


                    constexpr UnityEngine__InputSystem__Users__InputUser__UserFlags(UnityEngine__InputSystem__Users__InputUser__UserFlags const&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserFlags(UnityEngine__InputSystem__Users__InputUser__UserFlags&&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserFlags& operator=(UnityEngine__InputSystem__Users__InputUser__UserFlags const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserFlags& operator=(UnityEngine__InputSystem__Users__InputUser__UserFlags&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser__UserFlags(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__InputSystem__Users__InputUser__UserFlags_Unwrapped : int32_t {
...
static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags const BindToAllDevices;

/// @brief Field UserAccountSelectionInProgress offset 0
static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags const UserAccountSelectionInProgress;
...
struct CORDL_TYPE UnityEngine__InputSystem__Users__InputUser__UserData : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "platformUserAccountHandle", ty: "System::Nullable_1<UnityEngine::InputSystem::Users::InputUserAccountHandle>", modifiers: "", def_value: None }, CppParam { name: "platformUserAccountName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "platformUserAccountId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "deviceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "deviceStartIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "actions", ty: "UnityEngine::InputSystem::IInputActionCollection", modifiers: "", def_value: None }, CppParam { name: "controlScheme", ty: "System::Nullable_1<UnityEngine::InputSystem::InputControlScheme>", modifiers: "", def_value: None }, CppParam { name: "controlSchemeMatch", ty: "UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult", modifiers: "", def_value: None }, CppParam { name: "lostDeviceCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lostDeviceStartIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__Users__InputUser__UserData(System::Nullable_1<UnityEngine::InputSystem::Users::InputUserAccountHandle> platformUserAccountHandle, ::StringW platformUserAccountName, ::StringW platformUserAccountId, int32_t deviceCount, int32_t deviceStartIndex, UnityEngine::InputSystem::IInputActionCollection actions, System::Nullable_1<UnityEngine::InputSystem::InputControlScheme> controlScheme, UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult controlSchemeMatch, int32_t lostDeviceCount, int32_t lostDeviceStartIndex, UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags flags) noexcept;


                    constexpr UnityEngine__InputSystem__Users__InputUser__UserData(UnityEngine__InputSystem__Users__InputUser__UserData const&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserData(UnityEngine__InputSystem__Users__InputUser__UserData&&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserData& operator=(UnityEngine__InputSystem__Users__InputUser__UserData const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__Users__InputUser__UserData& operator=(UnityEngine__InputSystem__Users__InputUser__UserData&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser__UserData(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr System::Nullable_1<UnityEngine::InputSystem::InputControlScheme> __get_controlScheme() const;
 ...
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult __declspec(property(get=__get_controlSchemeMatch, put=__set_controlSchemeMatch))  controlSchemeMatch;

constexpr void __set_controlSchemeMatch(UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult value) ;

constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult __get_controlSchemeMatch() const;
...
constexpr int32_t __get_lostDeviceStartIndex() const;
 ...
 UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags __declspec(property(get=__get_flags, put=__set_flags))  flags;

constexpr void __set_flags(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags value) ;

constexpr UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags __get_flags() const;
...
struct CORDL_TYPE UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount(UnityEngine::InputSystem::Users::InputUserAccountHandle platformUserAccountHandle) noexcept;


                    constexpr UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount(UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount const&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount(UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount&&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount& operator=(UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount& operator=(UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection(UnityEngine::InputSystem::InputDevice device, uint32_t userId) noexcept;


                    constexpr UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection(UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection const&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection(UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection&&) = default;
                    constexpr UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection& operator=(UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection& operator=(UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser__GlobalState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::ArrayW<UnityEngine::InputSystem::Users::InputUser> __get_allUsers() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserData> __declspec(property(get=__get_allUserData, put=__set_allUserData))  allUserData;

constexpr void __set_allUserData(::ArrayW<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserData> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserData> __get_allUserData() const;
...
constexpr ::ArrayW<UnityEngine::InputSystem::InputDevice> __get_allLostDevices() const;
 ...
 UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection> __declspec(property(get=__get_ongoingAccountSelections, put=__set_ongoingAccountSelections))  ongoingAccountSelections;

constexpr void __set_ongoingAccountSelections(UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection> value) ;

constexpr UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection> __get_ongoingAccountSelections() const;
...
class CORDL_TYPE UnityEngine__InputSystem__Users__InputUser____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__InputSystem__Users__InputUser____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__Users__InputUser____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__Users__InputUser____c(UnityEngine__InputSystem__Users__InputUser____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__Users__InputUser____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__Users__InputUser____c(UnityEngine__InputSystem__Users__InputUser____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Users__InputUser____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__Users__InputUser____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__Users__InputUser____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__Users__InputUser____c& operator=(UnityEngine__InputSystem__Users__InputUser____c&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__Users__InputUser____c& operator=(UnityEngine__InputSystem__Users__InputUser____c const& o) noexcept = default;
                


// Fields

static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c value) ;

static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c __get___9() ;

static UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState> __declspec(property(get=__get___9__86_0, put=__set___9__86_0))  __9__86_0;

static void __set___9__86_0(UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState> value) ;

static UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState> __get___9__86_0() ;
...
/// @brief Method <SaveAndResetState>b__86_0 addr 0x293b94c size 0x74 virtual false final false
 void _SaveAndResetState_b__86_0(ByRef<UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState> state) ;
...
public:
// Declarations
using __c = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c;

using GlobalState = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState;

using OngoingAccountSelection = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection;

using CompareDevicesByUserAccount = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount;

using UserData = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserData;

using UserFlags = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags;

using ControlSchemeChangeSyntax = UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax;
...
static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState __declspec(property(get=__get_s_GlobalState, put=__set_s_GlobalState))  s_GlobalState;

static void __set_s_GlobalState(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState value) ;

static UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState __get_s_GlobalState() ;
...
// Properties
 ...
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult __declspec(property(get=get_controlSchemeMatch))  controlSchemeMatch;
...
/// @brief Method get_controlSchemeMatch addr 0x2937634 size 0x8c virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__MatchResult get_controlSchemeMatch() ;
...
/// @brief Method ActivateControlScheme addr 0x292e1ec size 0x78 virtual false final false
 UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax ActivateControlScheme(::StringW schemeName) ;
...
/// @brief Method ActivateControlScheme addr 0x292e018 size 0x1d4 virtual false final false
 UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax ActivateControlScheme(UnityEngine::InputSystem::InputControlScheme scheme) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserFlags, "UnityEngine.InputSystem.Users", "InputUser/UserFlags");
NEED_NO_BOX(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser____c, "UnityEngine.InputSystem.Users", "InputUser/<>c");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::InputUser, "UnityEngine.InputSystem.Users", "InputUser");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__CompareDevicesByUserAccount, "UnityEngine.InputSystem.Users", "InputUser/CompareDevicesByUserAccount");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__ControlSchemeChangeSyntax, "UnityEngine.InputSystem.Users", "InputUser/ControlSchemeChangeSyntax");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__GlobalState, "UnityEngine.InputSystem.Users", "InputUser/GlobalState");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__OngoingAccountSelection, "UnityEngine.InputSystem.Users", "InputUser/OngoingAccountSelection");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::Users::UnityEngine__InputSystem__Users__InputUser__UserData, "UnityEngine.InputSystem.Users", "InputUser/UserData");
