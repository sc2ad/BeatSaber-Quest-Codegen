...
constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags::UnityEngine__InputSystem__InputInteractionContext__Flags(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags  UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags::TimerHasExpired{2};
...
// Ctor Parameters [CppParam { name: "m_State", ty: "UnityEngine::InputSystem::InputActionState", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_Flags", ty: "UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_TriggerState", ty: "UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::InputSystem::InputInteractionContext::InputInteractionContext(UnityEngine::InputSystem::InputActionState m_State, UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags m_Flags, UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState m_TriggerState) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_State = m_State;
...
constexpr void UnityEngine::InputSystem::InputInteractionContext::__set_m_Flags(UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags, 0x8>(this->__instance, std::forward<UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags>(value));
}
constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags UnityEngine::InputSystem::InputInteractionContext::__get_m_Flags() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::UnityEngine__InputSystem__InputInteractionContext__Flags, 0x8>(this->__instance);
}
constexpr void UnityEngine::InputSystem::InputInteractionContext::__set_m_TriggerState(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState, 0x10>(this->__instance, std::forward<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState>(value));
}
constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState UnityEngine::InputSystem::InputInteractionContext::__get_m_TriggerState() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState, 0x10>(this->__instance);
}
