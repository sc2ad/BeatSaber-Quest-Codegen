...
struct CORDL_TYPE UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode(int32_t value__) noexcept;


                    constexpr UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode(UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode const&) = default;
                    constexpr UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode(UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode&&) = default;
                    constexpr UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode& operator=(UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode& operator=(UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode_Unwrapped : int32_t {
__SoftwareCursor = 0,
...
static UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode const SoftwareCursor;

/// @brief Field HardwareCursorIfAvailable offset 0
static UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode const HardwareCursorIfAvailable;
...
public:
// Declarations
using CursorMode = UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode;
...
// Fields
 ...
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode __declspec(property(get=__get_m_CursorMode, put=__set_m_CursorMode))  m_CursorMode;

constexpr void __set_m_CursorMode(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode value) ;

constexpr UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode __get_m_CursorMode() const;
...
constexpr System::Action __get_m_AfterInputUpdateDelegate() const;
 ...
 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_ButtonActionTriggeredDelegate, put=__set_m_ButtonActionTriggeredDelegate))  m_ButtonActionTriggeredDelegate;

constexpr void __set_m_ButtonActionTriggeredDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_ButtonActionTriggeredDelegate() const;
...
// Properties
 ...
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode __declspec(property(get=get_cursorMode, put=set_cursorMode))  cursorMode;
...
/// @brief Method get_cursorMode addr 0x2943c64 size 0x8 virtual false final false
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode get_cursorMode() ;

/// @brief Method set_cursorMode addr 0x2943c6c size 0xf8 virtual false final false
 void set_cursorMode(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode value) ;
...
/// @brief Method OnButtonActionTriggered addr 0x2944f4c size 0x1f4 virtual false final false
 void OnButtonActionTriggered(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method SetActionCallback addr 0x2944208 size 0x70 virtual false final false
static void SetActionCallback(UnityEngine::InputSystem::InputActionProperty field, System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> callback, bool install) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode, "UnityEngine.InputSystem.UI", "VirtualMouseInput/CursorMode");
