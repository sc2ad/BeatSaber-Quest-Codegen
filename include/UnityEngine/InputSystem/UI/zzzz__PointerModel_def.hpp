...
struct CORDL_TYPE ____UnityEngine__InputSystem__UI__PointerModel__ButtonState : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_IsPressed", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_FramePressState", ty: "::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerEventData__FramePressState", modifiers: "", def_value: None }, CppParam { name: "m_PressTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_PressRaycast", ty: "::UnityEngine::EventSystems::RaycastResult", modifiers: "", def_value: None }, CppParam { name: "m_PressObject", ty: "::UnityEngine::GameObject", modifiers: "", def_value: None }, CppParam { name: "m_RawPressObject", ty: "::UnityEngine::GameObject", modifiers: "", def_value: None }, CppParam { name: "m_LastPressObject", ty: "::UnityEngine::GameObject", modifiers: "", def_value: None }, CppParam { name: "m_DragObject", ty: "::UnityEngine::GameObject", modifiers: "", def_value: None }, CppParam { name: "m_PressPosition", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "m_ClickTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_ClickCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "m_Dragging", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_ClickedOnSameGameObject", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_IgnoreNextClick", ty: "bool", modifiers: "", def_value: None }]
constexpr ____UnityEngine__InputSystem__UI__PointerModel__ButtonState(bool m_IsPressed, ::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerEventData__FramePressState m_FramePressState, float_t m_PressTime, ::UnityEngine::EventSystems::RaycastResult m_PressRaycast, ::UnityEngine::GameObject m_PressObject, ::UnityEngine::GameObject m_RawPressObject, ::UnityEngine::GameObject m_LastPressObject, ::UnityEngine::GameObject m_DragObject, ::UnityEngine::Vector2 m_PressPosition, float_t m_ClickTime, int32_t m_ClickCount, bool m_Dragging, bool m_ClickedOnSameGameObject, bool m_IgnoreNextClick) noexcept;


                    constexpr ____UnityEngine__InputSystem__UI__PointerModel__ButtonState(____UnityEngine__InputSystem__UI__PointerModel__ButtonState const&) = default;
                    constexpr ____UnityEngine__InputSystem__UI__PointerModel__ButtonState(____UnityEngine__InputSystem__UI__PointerModel__ButtonState&&) = default;
                    constexpr ____UnityEngine__InputSystem__UI__PointerModel__ButtonState& operator=(____UnityEngine__InputSystem__UI__PointerModel__ButtonState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__UI__PointerModel__ButtonState& operator=(____UnityEngine__InputSystem__UI__PointerModel__ButtonState&& o) noexcept {
...
constexpr explicit ____UnityEngine__InputSystem__UI__PointerModel__ButtonState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr bool __get_m_IsPressed() const;
 ...
 ::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerEventData__FramePressState __declspec(property(get=__get_m_FramePressState, put=__set_m_FramePressState))  m_FramePressState;

constexpr void __set_m_FramePressState(::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerEventData__FramePressState value) ;

constexpr ::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerEventData__FramePressState __get_m_FramePressState() const;
...
public:
// Declarations
using ButtonState = ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState;

// Ctor Parameters [CppParam { name: "changedThisFrame", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "leftButton", ty: "::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState", modifiers: "", def_value: None }, CppParam { name: "rightButton", ty: "::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState", modifiers: "", def_value: None }, CppParam { name: "middleButton", ty: "::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState", modifiers: "", def_value: None }, CppParam { name: "eventData", ty: "::UnityEngine::InputSystem::UI::ExtendedPointerEventData", modifiers: "", def_value: None }, CppParam { name: "m_ScreenPosition", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "m_ScrollDelta", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "m_WorldPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "m_WorldOrientation", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }, CppParam { name: "m_Pressure", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_AzimuthAngle", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_AltitudeAngle", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Twist", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "m_Radius", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }]
constexpr PointerModel(bool changedThisFrame, ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState leftButton, ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState rightButton, ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState middleButton, ::UnityEngine::InputSystem::UI::ExtendedPointerEventData eventData, ::UnityEngine::Vector2 m_ScreenPosition, ::UnityEngine::Vector2 m_ScrollDelta, ::UnityEngine::Vector3 m_WorldPosition, ::UnityEngine::Quaternion m_WorldOrientation, float_t m_Pressure, float_t m_AzimuthAngle, float_t m_AltitudeAngle, float_t m_Twist, ::UnityEngine::Vector2 m_Radius) noexcept;
...
constexpr bool __get_changedThisFrame() const;
 ...
 ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __declspec(property(get=__get_leftButton, put=__set_leftButton))  leftButton;

constexpr void __set_leftButton(::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState value) ;

constexpr ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __get_leftButton() const;

 ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __declspec(property(get=__get_rightButton, put=__set_rightButton))  rightButton;

constexpr void __set_rightButton(::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState value) ;

constexpr ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __get_rightButton() const;

 ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __declspec(property(get=__get_middleButton, put=__set_middleButton))  middleButton;

constexpr void __set_middleButton(::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState value) ;

constexpr ::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState __get_middleButton() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::UI::____UnityEngine__InputSystem__UI__PointerModel__ButtonState, "UnityEngine.InputSystem.UI", "PointerModel/ButtonState");
