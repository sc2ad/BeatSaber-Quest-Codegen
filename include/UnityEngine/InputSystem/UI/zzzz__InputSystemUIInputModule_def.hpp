...
struct CORDL_TYPE UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState(int32_t refCount, bool enabledByInputModule) noexcept;


                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState(UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState const&) = default;
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState(UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState&&) = default;
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState& operator=(UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState& operator=(UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior(int32_t value__) noexcept;


                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior(UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior const&) = default;
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior(UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior&&) = default;
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior& operator=(UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior& operator=(UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior_Unwrapped : int32_t {
__OutsideScreen = 0,
__ScreenCenter = 1,
};
...
static UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior const OutsideScreen;

/// @brief Field ScreenCenter offset 0
static UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior const ScreenCenter;
...
public:
// Declarations
using CursorLockBehavior = UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior;

using InputActionReferenceState = UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState;
...
constexpr UnityEngine::InputSystem::UI::UIPointerBehavior __get_m_PointerBehavior() const;
 ...
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior __declspec(property(get=__get_m_CursorLockBehavior, put=__set_m_CursorLockBehavior))  m_CursorLockBehavior;

constexpr void __set_m_CursorLockBehavior(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior value) ;

constexpr UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior __get_m_CursorLockBehavior() const;

static System::Collections::Generic::Dictionary_2<UnityEngine::InputSystem::InputAction,UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState> __declspec(property(get=__get_s_InputActionReferenceCounts, put=__set_s_InputActionReferenceCounts))  s_InputActionReferenceCounts;

static void __set_s_InputActionReferenceCounts(System::Collections::Generic::Dictionary_2<UnityEngine::InputSystem::InputAction,UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState> value) ;

static System::Collections::Generic::Dictionary_2<UnityEngine::InputSystem::InputAction,UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState> __get_s_InputActionReferenceCounts() ;
...
constexpr bool __get_m_NeedToPurgeStalePointers() const;
 ...
 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnPointDelegate, put=__set_m_OnPointDelegate))  m_OnPointDelegate;

constexpr void __set_m_OnPointDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnPointDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnMoveDelegate, put=__set_m_OnMoveDelegate))  m_OnMoveDelegate;

constexpr void __set_m_OnMoveDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnMoveDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnLeftClickDelegate, put=__set_m_OnLeftClickDelegate))  m_OnLeftClickDelegate;

constexpr void __set_m_OnLeftClickDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnLeftClickDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnRightClickDelegate, put=__set_m_OnRightClickDelegate))  m_OnRightClickDelegate;

constexpr void __set_m_OnRightClickDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnRightClickDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnMiddleClickDelegate, put=__set_m_OnMiddleClickDelegate))  m_OnMiddleClickDelegate;

constexpr void __set_m_OnMiddleClickDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnMiddleClickDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnScrollWheelDelegate, put=__set_m_OnScrollWheelDelegate))  m_OnScrollWheelDelegate;

constexpr void __set_m_OnScrollWheelDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnScrollWheelDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnTrackedDevicePositionDelegate, put=__set_m_OnTrackedDevicePositionDelegate))  m_OnTrackedDevicePositionDelegate;

constexpr void __set_m_OnTrackedDevicePositionDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnTrackedDevicePositionDelegate() const;

 System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __declspec(property(get=__get_m_OnTrackedDeviceOrientationDelegate, put=__set_m_OnTrackedDeviceOrientationDelegate))  m_OnTrackedDeviceOrientationDelegate;

constexpr void __set_m_OnTrackedDeviceOrientationDelegate(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

constexpr System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> __get_m_OnTrackedDeviceOrientationDelegate() const;
...
// Properties
 ...
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior __declspec(property(get=get_cursorLockBehavior, put=set_cursorLockBehavior))  cursorLockBehavior;
...
/// @brief Method get_cursorLockBehavior addr 0x293c8bc size 0x8 virtual false final false
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior get_cursorLockBehavior() ;

/// @brief Method set_cursorLockBehavior addr 0x293c8c4 size 0x8 virtual false final false
 void set_cursorLockBehavior(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior value) ;
...
/// @brief Method ProcessPointerButton addr 0x293d9dc size 0x804 virtual false final false
 void ProcessPointerButton(ByRef<UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__PointerModel__ButtonState> button, UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method ProcessPointerButtonDrag addr 0x293e1e0 size 0x2fc virtual false final false
 void ProcessPointerButtonDrag(ByRef<UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__PointerModel__ButtonState> button, UnityEngine::InputSystem::UI::ExtendedPointerEventData eventData) ;
...
/// @brief Method SwapAction addr 0x293f820 size 0x2b4 virtual false final false
 void SwapAction(ByRef<UnityEngine::InputSystem::InputActionReference> property, UnityEngine::InputSystem::InputActionReference newValue, bool actionsHooked, System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> actionCallback) ;
...
/// @brief Method GetPointerStateIndexFor addr 0x2940de4 size 0x60 virtual false final false
 int32_t GetPointerStateIndexFor(ByRef<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> context) ;
...
/// @brief Method OnPointCallback addr 0x2941df4 size 0xe8 virtual false final false
 void OnPointCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method IgnoreNextClick addr 0x2941edc size 0x124 virtual false final false
 bool IgnoreNextClick(ByRef<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> context, bool wasPressed) ;

/// @brief Method OnLeftClickCallback addr 0x2942000 size 0x80 virtual false final false
 void OnLeftClickCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method OnRightClickCallback addr 0x29420d4 size 0x80 virtual false final false
 void OnRightClickCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method OnMiddleClickCallback addr 0x2942154 size 0x80 virtual false final false
 void OnMiddleClickCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method CheckForRemovedDevice addr 0x2940e44 size 0x64 virtual false final false
 bool CheckForRemovedDevice(ByRef<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> context) ;

/// @brief Method OnScrollCallback addr 0x29421d4 size 0xc8 virtual false final false
 void OnScrollCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method OnMoveCallback addr 0x29422dc size 0x60 virtual false final false
 void OnMoveCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method OnTrackedDeviceOrientationCallback addr 0x294233c size 0x84 virtual false final false
 void OnTrackedDeviceOrientationCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method OnTrackedDevicePositionCallback addr 0x2942418 size 0x84 virtual false final false
 void OnTrackedDevicePositionCallback(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;
...
static void SetActionCallback(UnityEngine::InputSystem::InputActionReference actionReference, System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> callback, bool install) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__CursorLockBehavior, "UnityEngine.InputSystem.UI", "InputSystemUIInputModule/CursorLockBehavior");
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__InputSystemUIInputModule__InputActionReferenceState, "UnityEngine.InputSystem.UI", "InputSystemUIInputModule/InputActionReferenceState");
