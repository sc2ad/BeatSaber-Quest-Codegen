...
constexpr void ::UnityEngine::InputSystem::InputValue::__set_m_Context(::System::Nullable_1<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputAction__CallbackContext> value)  {
::cordl_internals::setInstanceField<::System::Nullable_1<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputAction__CallbackContext>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Nullable_1<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputAction__CallbackContext>>(value));
}
constexpr ::System::Nullable_1<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputAction__CallbackContext> ::UnityEngine::InputSystem::InputValue::__get_m_Context() const {
return ::cordl_internals::getInstanceField<::System::Nullable_1<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputAction__CallbackContext>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
