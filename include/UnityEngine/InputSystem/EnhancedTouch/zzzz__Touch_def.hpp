...
struct CORDL_TYPE UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "touchscreens", ty: "UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::Touchscreen>", modifiers: "", def_value: None }, CppParam { name: "historyLengthPerFinger", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "onFingerDown", ty: "UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>>", modifiers: "", def_value: None }, CppParam { name: "onFingerMove", ty: "UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>>", modifiers: "", def_value: None }, CppParam { name: "onFingerUp", ty: "UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>>", modifiers: "", def_value: None }, CppParam { name: "playerState", ty: "UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState(UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::Touchscreen> touchscreens, int32_t historyLengthPerFinger, UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>> onFingerDown, UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>> onFingerMove, UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>> onFingerUp, UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState playerState) noexcept;


                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState(UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState const&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState(UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState&&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr UnityEngine::InputSystem::Utilities::CallbackArray_1<System::Action_1<UnityEngine::InputSystem::EnhancedTouch::Finger>> __get_onFingerUp() const;
 ...
 UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState __declspec(property(get=__get_playerState, put=__set_playerState))  playerState;

constexpr void __set_playerState(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState value) ;

constexpr UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState __get_playerState() const;
...
struct CORDL_TYPE UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState(UnityEngine::InputSystem::LowLevel::InputUpdateType updateMask, ::ArrayW<UnityEngine::InputSystem::EnhancedTouch::Finger> fingers, ::ArrayW<UnityEngine::InputSystem::EnhancedTouch::Finger> activeFingers, ::ArrayW<UnityEngine::InputSystem::EnhancedTouch::Touch> activeTouches, int32_t activeFingerCount, int32_t activeTouchCount, int32_t totalFingerCount, uint32_t lastId, bool haveBuiltActiveTouches, bool haveActiveTouchesNeedingRefreshNextUpdate, UnityEngine::InputSystem::LowLevel::InputStateHistory_1<UnityEngine::InputSystem::LowLevel::TouchState> activeTouchState) noexcept;


                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState(UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState const&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState(UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState&&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState(UnityEngine::Vector2 accumulatedDelta, uint32_t uniqueId) noexcept;


                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState(UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState const&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState(UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState&&) = default;
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE UnityEngine__InputSystem__EnhancedTouch__Touch____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__InputSystem__EnhancedTouch__Touch____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__EnhancedTouch__Touch____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c(UnityEngine__InputSystem__EnhancedTouch__Touch____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__EnhancedTouch__Touch____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c(UnityEngine__InputSystem__EnhancedTouch__Touch____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__EnhancedTouch__Touch____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch____c&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__EnhancedTouch__Touch____c& operator=(UnityEngine__InputSystem__EnhancedTouch__Touch____c const& o) noexcept = default;
                


// Fields

static UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c value) ;

static UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c __get___9() ;

static UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState> __declspec(property(get=__get___9__78_0, put=__set___9__78_0))  __9__78_0;

static void __set___9__78_0(UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState> value) ;

static UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SavedStructState_1__TypedRestore<UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState> __get___9__78_0() ;
...
/// @brief Method <SaveAndResetState>b__78_0 addr 0x2950e24 size 0x84 virtual false final false
 void _SaveAndResetState_b__78_0(ByRef<UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState> state) ;
...
public:
// Declarations
using __c = UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c;

using ExtraDataPerTouchState = UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState;

using FingerAndTouchState = UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState;

using GlobalState = UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState;
...
// Ctor Parameters [CppParam { name: "m_Finger", ty: "UnityEngine::InputSystem::EnhancedTouch::Finger", modifiers: "", def_value: None }, CppParam { name: "m_TouchRecord", ty: "UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState>", modifiers: "", def_value: None }]
constexpr Touch(UnityEngine::InputSystem::EnhancedTouch::Finger m_Finger, UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState> m_TouchRecord) noexcept;
...
constexpr UnityEngine::InputSystem::EnhancedTouch::Finger __get_m_Finger() const;
 ...
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState> __declspec(property(get=__get_m_TouchRecord, put=__set_m_TouchRecord))  m_TouchRecord;

constexpr void __set_m_TouchRecord(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState> value) ;

constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState> __get_m_TouchRecord() const;

static UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState __declspec(property(get=__get_s_GlobalState, put=__set_s_GlobalState))  s_GlobalState;

static void __set_s_GlobalState(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState value) ;

static UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState __get_s_GlobalState() ;
...
// Properties
 ...
 UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState __declspec(property(get=get_extraData))  extraData;
...
/// @brief Method get_extraData addr 0x294f350 size 0x48 virtual false final false
 ByRef<UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState> get_extraData() ;
...
/// @brief Method .ctor addr 0x294e418 size 0xc virtual false final false
 void _ctor(UnityEngine::InputSystem::EnhancedTouch::Finger finger, UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory_1__Record<UnityEngine::InputSystem::LowLevel::TouchState> touchRecord) ;
...
static UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState CreateGlobalState() ;
...
NEED_NO_BOX(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch____c, "UnityEngine.InputSystem.EnhancedTouch", "Touch/<>c");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::EnhancedTouch::Touch, "UnityEngine.InputSystem.EnhancedTouch", "Touch");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__ExtraDataPerTouchState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/ExtraDataPerTouchState");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__FingerAndTouchState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/FingerAndTouchState");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::EnhancedTouch::UnityEngine__InputSystem__EnhancedTouch__Touch__GlobalState, "UnityEngine.InputSystem.EnhancedTouch", "Touch/GlobalState");
