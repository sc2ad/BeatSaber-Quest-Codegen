...
namespace UnityEngine::InputSystem::Layouts {
class ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c;
}
namespace UnityEngine::InputSystem::Layouts {
class ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4;
}
namespace GlobalNamespace {
struct ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability;
}
namespace UnityEngine::InputSystem::Layouts {
...
struct CORDL_TYPE ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability(::StringW path, ::StringW value) noexcept;


                    constexpr ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability(______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability const&) = default;
                    constexpr ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability(______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability&&) = default;
                    constexpr ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability& operator=(______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability& operator=(______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability&& o) noexcept {
...
constexpr explicit ______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
using Capability = ::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability;

// Ctor Parameters [CppParam { name: "interface", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "interfaces", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "deviceClass", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "deviceClasses", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "manufacturer", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "manufacturers", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "product", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "products", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "version", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "versions", ty: "::ArrayW<::StringW>", modifiers: "", def_value: None }, CppParam { name: "capabilities", ty: "::ArrayW<::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability>", modifiers: "", def_value: None }]
constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson(::StringW interface, ::ArrayW<::StringW> interfaces, ::StringW deviceClass, ::ArrayW<::StringW> deviceClasses, ::StringW manufacturer, ::ArrayW<::StringW> manufacturers, ::StringW product, ::ArrayW<::StringW> products, ::StringW version, ::ArrayW<::StringW> versions, ::ArrayW<::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability> capabilities) noexcept;


                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson const&) = default;
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson&&) = default;
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::ArrayW<::StringW> __get_versions() const;
 ...
 ::ArrayW<::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability> __declspec(property(get=__get_capabilities, put=__set_capabilities))  capabilities;

constexpr void __set_capabilities(::ArrayW<::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability> value) ;

constexpr ::ArrayW<::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability> __get_capabilities() const;


// Methods

/// @brief Method FromMatcher addr 0x297655c size 0x334 virtual false final false
static ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson FromMatcher(::UnityEngine::InputSystem::Layouts::InputDeviceMatcher matcher) ;
...
class CORDL_TYPE ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4&& o) noexcept = default;
  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4 const& o) noexcept = default;
...
explicit ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4(int32_t __1__state) ;
...
class CORDL_TYPE ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c&& o) noexcept = default;
  constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c value) ;

static ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c;

using _get_patterns_d__4 = ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4;

using MatcherJson = ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson;
...
NEED_NO_BOX(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher____c, "UnityEngine.InputSystem.Layouts", "InputDeviceMatcher/<>c");
NEED_NO_BOX(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher___get_patterns_d__4, "UnityEngine.InputSystem.Layouts", "InputDeviceMatcher/<get_patterns>d__4");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson__Capability, "UnityEngine.InputSystem.Layouts", "InputDeviceMatcher/MatcherJson/Capability");
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceMatcher__MatcherJson, "UnityEngine.InputSystem.Layouts", "InputDeviceMatcher/MatcherJson");
