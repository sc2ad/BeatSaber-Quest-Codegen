...
namespace UnityEngine::InputSystem::Layouts {
struct ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance;
}
// Type: ::RefInstance
namespace UnityEngine::InputSystem::Layouts {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr operator  ::System::IDisposable() const;
                    ...
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance(____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance const&) = default;
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance(____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance&&) = default;
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance& operator=(____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance&& o) noexcept {
...
constexpr explicit ____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using RefInstance = ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance;

/// @brief Convert operator to ::System::IDisposable
constexpr operator  ::System::IDisposable() const;

// Ctor Parameters [CppParam { name: "m_Device", ty: "::UnityEngine::InputSystem::InputDevice", modifiers: "", def_value: None }, CppParam { name: "m_LayoutCacheRef", ty: "::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__CacheRefInstance", modifiers: "", def_value: None }, CppParam { name: "m_ChildControlOverrides", ty: "::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem>", modifiers: "", def_value: None }, CppParam { name: "m_StateOffsetToControlMap", ty: "::System::Collections::Generic::List_1<uint32_t>", modifiers: "", def_value: None }, CppParam { name: "m_StringBuilder", ty: "::System::Text::StringBuilder", modifiers: "", def_value: None }]
constexpr InputDeviceBuilder(::UnityEngine::InputSystem::InputDevice m_Device, ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__CacheRefInstance m_LayoutCacheRef, ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> m_ChildControlOverrides, ::System::Collections::Generic::List_1<uint32_t> m_StateOffsetToControlMap, ::System::Text::StringBuilder m_StringBuilder) noexcept;
...
constexpr ::UnityEngine::InputSystem::InputDevice __get_m_Device() const;
 ...
 ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__CacheRefInstance __declspec(property(get=__get_m_LayoutCacheRef, put=__set_m_LayoutCacheRef))  m_LayoutCacheRef;

constexpr void __set_m_LayoutCacheRef(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__CacheRefInstance value) ;

constexpr ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__CacheRefInstance __get_m_LayoutCacheRef() const;

 ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> __declspec(property(get=__get_m_ChildControlOverrides, put=__set_m_ChildControlOverrides))  m_ChildControlOverrides;

constexpr void __set_m_ChildControlOverrides(::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> __get_m_ChildControlOverrides() const;
...
/// @brief Method AddChildControl addr 0x29729f0 size 0x728 virtual false final false
 ::UnityEngine::InputSystem::InputControl AddChildControl(::UnityEngine::InputSystem::Layouts::InputControlLayout layout, ::UnityEngine::InputSystem::Utilities::InternedString variants, ::UnityEngine::InputSystem::InputControl parent, ByRef<bool> haveChildrenUsingStateFromOtherControls, ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem controlItem, int32_t childIndex, ::StringW nameOverride) ;

/// @brief Method InsertChildControlOverride addr 0x2972858 size 0x198 virtual false final false
 void InsertChildControlOverride(::UnityEngine::InputSystem::InputControl parent, ByRef<::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> controlItem) ;
...
static void ApplyUseStateFrom(::UnityEngine::InputSystem::InputControl parent, ByRef<::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> controlItem, ::UnityEngine::InputSystem::Layouts::InputControlLayout layout) ;
...
static void AddProcessors(::UnityEngine::InputSystem::InputControl control, ByRef<::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem> controlItem, ::StringW layoutName) ;

/// @brief Method SetFormat addr 0x2973258 size 0x88 virtual false final false
static void SetFormat(::UnityEngine::InputSystem::InputControl control, ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputControlLayout__ControlItem controlItem) ;
...
static ::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance Ref() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::Layouts::____UnityEngine__InputSystem__Layouts__InputDeviceBuilder__RefInstance, "UnityEngine.InputSystem.Layouts", "InputDeviceBuilder/RefInstance");
