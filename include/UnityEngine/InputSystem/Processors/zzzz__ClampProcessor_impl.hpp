...
// Ctor Parameters []
 ::UnityEngine::InputSystem::Processors::ClampProcessor::ClampProcessor()  : ::UnityEngine::InputSystem::InputProcessor_1<float_t>(THROW_UNLESS(::il2cpp_utils::New<ClampProcessor>())) {}
