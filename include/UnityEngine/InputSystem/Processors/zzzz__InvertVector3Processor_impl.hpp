...
// Ctor Parameters []
 ::UnityEngine::InputSystem::Processors::InvertVector3Processor::InvertVector3Processor()  : ::UnityEngine::InputSystem::InputProcessor_1<::UnityEngine::Vector3>(THROW_UNLESS(::il2cpp_utils::New<InvertVector3Processor>())) {}
