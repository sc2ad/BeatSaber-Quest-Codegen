...
struct CORDL_TYPE UnityEngine__InputSystem__InputActionAsset__WriteFileJson : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "maps", ty: "::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__WriteMapJson>", modifiers: "", def_value: None }, CppParam { name: "controlSchemes", ty: "::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson>", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset__WriteFileJson(::StringW name, ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__WriteMapJson> maps, ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson> controlSchemes) noexcept;


                    constexpr UnityEngine__InputSystem__InputActionAsset__WriteFileJson(UnityEngine__InputSystem__InputActionAsset__WriteFileJson const&) = default;
                    constexpr UnityEngine__InputSystem__InputActionAsset__WriteFileJson(UnityEngine__InputSystem__InputActionAsset__WriteFileJson&&) = default;
                    constexpr UnityEngine__InputSystem__InputActionAsset__WriteFileJson& operator=(UnityEngine__InputSystem__InputActionAsset__WriteFileJson const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputActionAsset__WriteFileJson& operator=(UnityEngine__InputSystem__InputActionAsset__WriteFileJson&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__InputActionAsset__WriteFileJson(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::StringW __get_name() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__WriteMapJson> __declspec(property(get=__get_maps, put=__set_maps))  maps;

constexpr void __set_maps(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__WriteMapJson> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__WriteMapJson> __get_maps() const;

 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson> __declspec(property(get=__get_controlSchemes, put=__set_controlSchemes))  controlSchemes;

constexpr void __set_controlSchemes(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson> __get_controlSchemes() const;
...
struct CORDL_TYPE UnityEngine__InputSystem__InputActionAsset__ReadFileJson : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "maps", ty: "::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__ReadMapJson>", modifiers: "", def_value: None }, CppParam { name: "controlSchemes", ty: "::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson>", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset__ReadFileJson(::StringW name, ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__ReadMapJson> maps, ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputControlScheme__SchemeJson> controlSchemes) noexcept;


                    constexpr UnityEngine__InputSystem__InputActionAsset__ReadFileJson(UnityEngine__InputSystem__InputActionAsset__ReadFileJson const&) = default;
                    constexpr UnityEngine__InputSystem__InputActionAsset__ReadFileJson(UnityEngine__InputSystem__InputActionAsset__ReadFileJson&&) = default;
                    constexpr UnityEngine__InputSystem__InputActionAsset__ReadFileJson& operator=(UnityEngine__InputSystem__InputActionAsset__ReadFileJson const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputActionAsset__ReadFileJson& operator=(UnityEngine__InputSystem__InputActionAsset__ReadFileJson&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputActionAsset__ReadFileJson(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::StringW __get_name() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__ReadMapJson> __declspec(property(get=__get_maps, put=__set_maps))  maps;

constexpr void __set_maps(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__ReadMapJson> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__ReadMapJson> __get_maps() const;
...
class CORDL_TYPE UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8(UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8(UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8& operator=(UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8& operator=(UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8 const& o) noexcept = default;
...
class CORDL_TYPE UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31(UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31(UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31& operator=(UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31& operator=(UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31 const& o) noexcept = default;
...
public:
// Declarations
using _GetEnumerator_d__31 = UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31;

using _get_bindings_d__8 = UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8;

using ReadFileJson = UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset__ReadFileJson;

using WriteFileJson = UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset__WriteFileJson;
...
constexpr int32_t __get_m_ParameterOverridesCount() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionRebindingExtensions__ParameterOverride> __declspec(property(get=__get_m_ParameterOverrides, put=__set_m_ParameterOverrides))  m_ParameterOverrides;

constexpr void __set_m_ParameterOverrides(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionRebindingExtensions__ParameterOverride> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionRebindingExtensions__ParameterOverride> __get_m_ParameterOverrides() const;

 UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__DeviceArray __declspec(property(get=__get_m_Devices, put=__set_m_Devices))  m_Devices;

constexpr void __set_m_Devices(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__DeviceArray value) ;

constexpr UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionMap__DeviceArray __get_m_Devices() const;
...
NEED_NO_BOX(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___GetEnumerator_d__31, "UnityEngine.InputSystem", "InputActionAsset/<GetEnumerator>d__31");
NEED_NO_BOX(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset___get_bindings_d__8, "UnityEngine.InputSystem", "InputActionAsset/<get_bindings>d__8");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset__ReadFileJson, "UnityEngine.InputSystem", "InputActionAsset/ReadFileJson");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionAsset__WriteFileJson, "UnityEngine.InputSystem", "InputActionAsset/WriteFileJson");
