...
namespace UnityEngine::InputSystem::Utilities {
template<typename TValue>
class ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where;
}
namespace UnityEngine::InputSystem::Utilities {
...
namespace UnityEngine::InputSystem::Utilities {
template<::cordl_internals::il2cpp_reference_type TValue>
class ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where<TValue>;
}
// Type: ::Where
...
class CORDL_TYPE ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where<TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where(____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where(____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where& operator=(____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where&& o) noexcept = default;
  constexpr ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where& operator=(____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where const& o) noexcept = default;
...
explicit ____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where(::UnityEngine::InputSystem::Utilities::WhereObservable_1<TValue> observable, ::System::IObserver_1<TValue> observer) ;
...
public:
// Declarations
using Where = ::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where<TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__WhereObservable_1__Where, "UnityEngine.InputSystem.Utilities", "WhereObservable`1/Where");
