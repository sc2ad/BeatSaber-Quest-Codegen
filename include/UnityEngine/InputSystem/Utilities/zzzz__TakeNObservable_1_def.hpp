...
namespace UnityEngine::InputSystem::Utilities {
template<typename TValue>
class ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take;
}
namespace UnityEngine::InputSystem::Utilities {
...
namespace UnityEngine::InputSystem::Utilities {
template<::cordl_internals::il2cpp_reference_type TValue>
class ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take<TValue>;
}
// Type: ::Take
...
class CORDL_TYPE ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take<TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take(____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take(____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take& operator=(____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take&& o) noexcept = default;
  constexpr ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take& operator=(____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take const& o) noexcept = default;
...
explicit ____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take(::UnityEngine::InputSystem::Utilities::TakeNObservable_1<TValue> observable, ::System::IObserver_1<TValue> observer) ;
...
public:
// Declarations
using Take = ::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take<TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__TakeNObservable_1__Take, "UnityEngine.InputSystem.Utilities", "TakeNObservable`1/Take");
