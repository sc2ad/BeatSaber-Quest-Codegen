...
namespace UnityEngine::InputSystem::Utilities {
template<::cordl_internals::il2cpp_reference_type TSource,::cordl_internals::il2cpp_reference_type TResult>
class UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select<TSource,TResult>;
}
// Type: ::Select
...
class CORDL_TYPE UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select<TSource,TResult> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select(UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select(UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select& operator=(UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select& operator=(UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select const& o) noexcept = default;
...
public:
// Declarations
using Select = UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select<TSource, TResult>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__SelectManyObservable_2__Select, "UnityEngine.InputSystem.Utilities", "SelectManyObservable`2/Select");
