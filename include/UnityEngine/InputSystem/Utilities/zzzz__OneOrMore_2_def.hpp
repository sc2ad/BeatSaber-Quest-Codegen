...
class ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator;
}
namespace UnityEngine::InputSystem::Utilities {
template<::cordl_internals::il2cpp_reference_type TValue>
class ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue,::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType>>;
}
namespace UnityEngine::InputSystem::Utilities {
template<::cordl_internals::il2cpp_reference_type TValue,::cordl_internals::il2cpp_reference_type TList>
class ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue,TList>;
}
namespace UnityEngine::InputSystem::Utilities {
template<typename TValue,typename TList>
struct OneOrMore_2;
...
class CORDL_TYPE ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue,TList> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator(____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator(____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator& operator=(____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator&& o) noexcept = default;
  constexpr ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator& operator=(____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator() ;
...
// CS Name: UnityEngine.InputSystem.Utilities.OneOrMore`2::Enumerator
class CORDL_TYPE ____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue,::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType>> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to ::System::Collections::Generic::IEnumerator_1<TValue>
constexpr operator  ::System::Collections::Generic::IEnumerator_1<TValue>() const noexcept;
...
public:
// Declarations
using Enumerator = ::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue, TList>;
...
static ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList> op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue,TList_(TValue single) ;

/// @brief Method op_Implicit addr 0x0 size 0xffffffffffffffff virtual false final false
static ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,TList> op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue,TList_(TList multiple) ;
...
public:
// Declarations
using Enumerator = ::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator<TValue, ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType>>;
...
/// @brief Method op_Implicit addr 0x0 size 0xffffffffffffffff virtual false final false
static ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType>> op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue,__UnityEngine__InputSystem__Utilities__ReadOnlyArray_1___bs_hook__Il2CppWrapperType__(TValue single) ;

/// @brief Method op_Implicit addr 0x0 size 0xffffffffffffffff virtual false final false
static ::UnityEngine::InputSystem::Utilities::OneOrMore_2<TValue,::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType>> op_Implicit___UnityEngine__InputSystem__Utilities__OneOrMore_2_TValue,__UnityEngine__InputSystem__Utilities__ReadOnlyArray_1___bs_hook__Il2CppWrapperType__(::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::bs_hook::Il2CppWrapperType> multiple) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::UnityEngine::InputSystem::Utilities::____UnityEngine__InputSystem__Utilities__OneOrMore_2__Enumerator, "UnityEngine.InputSystem.Utilities", "OneOrMore`2/Enumerator");
