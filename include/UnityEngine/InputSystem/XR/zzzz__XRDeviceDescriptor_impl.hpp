...
return ::cordl_internals::RunMethodRethrow<UnityEngine::InputSystem::XR::XRDeviceDescriptor, false>(nullptr, ___internal_method, json);
 ...
 UnityEngine::InputSystem::XR::XRDeviceDescriptor UnityEngine::InputSystem::XR::XRDeviceDescriptor::New_ctor()  {
UnityEngine::InputSystem::XR::XRDeviceDescriptor o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::InputSystem::XR::XRDeviceDescriptor>())};
return o;
}
