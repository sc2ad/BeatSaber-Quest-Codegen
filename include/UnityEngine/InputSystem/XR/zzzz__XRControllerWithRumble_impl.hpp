...
// Ctor Parameters []
 UnityEngine::InputSystem::XR::XRControllerWithRumble::XRControllerWithRumble()  : UnityEngine::InputSystem::XR::XRController(THROW_UNLESS(::il2cpp_utils::New<XRControllerWithRumble>())) {}
