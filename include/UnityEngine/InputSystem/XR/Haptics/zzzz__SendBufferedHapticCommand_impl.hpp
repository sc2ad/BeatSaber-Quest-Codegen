...
constexpr ::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "baseCommand", ty: "::UnityEngine::InputSystem::LowLevel::InputDeviceCommand", modifiers: "", def_value: Some("{}") }, CppParam { name: "channel", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "bufferSize", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "buffer", ty: "::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand::SendBufferedHapticCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand, int32_t channel, int32_t bufferSize, ::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer buffer) noexcept : ::bs_hook::ValueTypeWrapper() {this->baseCommand = baseCommand;
...
constexpr void ::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand::__set_buffer(::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer, 0x10>(this->__instance, std::forward<::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer>(value));
}
constexpr ::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer ::UnityEngine::InputSystem::XR::Haptics::SendBufferedHapticCommand::__get_buffer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::XR::Haptics::____UnityEngine__InputSystem__XR__Haptics__SendBufferedHapticCommand___buffer_e__FixedBuffer, 0x10>(this->__instance);
}
