...
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::Neither{0};
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::Positive{1};
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins::Negative{2};
...
constexpr void ::UnityEngine::InputSystem::Composites::AxisComposite::__set_whichSideWins(::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins>(value));
}
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins ::UnityEngine::InputSystem::Composites::AxisComposite::__get_whichSideWins() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__AxisComposite__WhichSideWins, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
