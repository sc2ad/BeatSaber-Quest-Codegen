...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(instance), ___internal_method, context);
 ...
 UnityEngine::InputSystem::Composites::Vector2Composite UnityEngine::InputSystem::Composites::Vector2Composite::New_ctor()  {
UnityEngine::InputSystem::Composites::Vector2Composite o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::InputSystem::Composites::Vector2Composite>())};
return o;
}
