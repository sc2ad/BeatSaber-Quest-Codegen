...
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::Analog{0};
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::DigitalNormalized{1};
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode  ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode::Digital{2};
...
constexpr void ::UnityEngine::InputSystem::Composites::Vector3Composite::__set_mode(::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode>(value));
}
constexpr ::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode ::UnityEngine::InputSystem::Composites::Vector3Composite::__get_mode() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Composites::____UnityEngine__InputSystem__Composites__Vector3Composite__Mode, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
