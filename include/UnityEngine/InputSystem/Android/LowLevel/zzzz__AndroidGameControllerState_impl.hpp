...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState__Variants::*)()>(&UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState__Variants::_ctor)> {
...
constexpr UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer(uint32_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer::__set_FixedElementField(uint32_t value)  {
::cordl_internals::setInstanceField<uint32_t, 0x0>(this->__instance, std::forward<uint32_t>(value));
}
constexpr uint32_t UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer::__get_FixedElementField() const {
...
constexpr UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer(float_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer::__set_FixedElementField(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "buttons", ty: "UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "axis", ty: "UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::InputSystem::Android::LowLevel::AndroidGameControllerState::AndroidGameControllerState(UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer buttons, UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer axis) noexcept : ::bs_hook::ValueTypeWrapper() {this->buttons = buttons;
this->axis = axis;
}
...
constexpr void UnityEngine::InputSystem::Android::LowLevel::AndroidGameControllerState::__set_buttons(UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer, 0x0>(this->__instance, std::forward<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer>(value));
}
constexpr UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer UnityEngine::InputSystem::Android::LowLevel::AndroidGameControllerState::__get_buttons() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___buttons_e__FixedBuffer, 0x0>(this->__instance);
}
constexpr void UnityEngine::InputSystem::Android::LowLevel::AndroidGameControllerState::__set_axis(UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer, 0x1c>(this->__instance, std::forward<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer>(value));
}
constexpr UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer UnityEngine::InputSystem::Android::LowLevel::AndroidGameControllerState::__get_axis() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::Android::LowLevel::UnityEngine__InputSystem__Android__LowLevel__AndroidGameControllerState___axis_e__FixedBuffer, 0x1c>(this->__instance);
}
