...
constexpr ::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer(float_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer::__set_FixedElementField(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "data", ty: "::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorState::AndroidSensorState(::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer data) noexcept : ::bs_hook::ValueTypeWrapper() {this->data = data;
}
...
constexpr void ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorState::__set_data(::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer, 0x0>(this->__instance, std::forward<::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer>(value));
}
constexpr ::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer ::UnityEngine::InputSystem::Android::LowLevel::AndroidSensorState::__get_data() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Android::LowLevel::____UnityEngine__InputSystem__Android__LowLevel__AndroidSensorState___data_e__FixedBuffer, 0x0>(this->__instance);
}
