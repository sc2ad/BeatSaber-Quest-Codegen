...
class CORDL_TYPE UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber(UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber(UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber& operator=(UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber& operator=(UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber const& o) noexcept = default;
...
public:
// Declarations
using Subscriber = UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber;
...
constexpr UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection __get_m_Connection() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber> __declspec(property(get=__get_m_Subscribers, put=__set_m_Subscribers))  m_Subscribers;

constexpr void __set_m_Subscribers(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber> __get_m_Subscribers() const;
...
/// @brief Method SendToSubscribers addr 0x29149dc size 0x10c virtual false final false
 void SendToSubscribers(UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__MessageType type, UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;
...
NEED_NO_BOX(UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber, "UnityEngine.InputSystem", "RemoteInputPlayerConnection/Subscriber");
