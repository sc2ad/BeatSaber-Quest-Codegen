...
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::____UnityEngine__InputSystem__Controls__AxisControl__Clamp(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp  ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::None{0};
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp  ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::BeforeNormalize{1};
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp  ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::AfterNormalize{2};
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp  ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp::ToConstantBeforeNormalize{3};
...
constexpr void ::UnityEngine::InputSystem::Controls::AxisControl::__set_clamp(::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp, 0xf0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp>(value));
}
constexpr ::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp ::UnityEngine::InputSystem::Controls::AxisControl::__get_clamp() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::____UnityEngine__InputSystem__Controls__AxisControl__Clamp, 0xf0>(this->::bs_hook::Il2CppWrapperType::instance);
}
