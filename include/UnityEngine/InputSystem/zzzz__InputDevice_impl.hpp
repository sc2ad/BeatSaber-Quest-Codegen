...
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::____UnityEngine__InputSystem__InputDevice__DeviceFlags(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::UpdateBeforeRender{1};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::HasStateCallbacks{2};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::HasControlsWithDefaultState{4};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::HasDontResetControls{1024};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::HasEventMerger{8192};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::HasEventPreProcessor{16384};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::Remote{8};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::Native{16};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::DisabledInFrontend{32};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::DisabledInRuntime{128};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::DisabledWhileInBackground{256};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::DisabledStateHasBeenQueriedFromRuntime{64};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::CanRunInBackground{2048};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags::CanRunInBackgroundHasBeenQueried{4096};
...
constexpr void ::UnityEngine::InputSystem::InputDevice::__set_m_DeviceFlags(::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags, 0xd8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags>(value));
}
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags ::UnityEngine::InputSystem::InputDevice::__get_m_DeviceFlags() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputDevice__DeviceFlags, 0xd8>(this->::bs_hook::Il2CppWrapperType::instance);
}
