...
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::____UnityEngine__InputSystem__InputControl__ControlFlags(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::ConfigUpToDate{1};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::IsNoisy{2};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::IsSynthetic{4};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::IsButton{8};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::DontReset{16};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::SetupFinished{32};
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags  ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags::UsesStateFromOtherControl{64};
...
constexpr void ::UnityEngine::InputSystem::InputControl::__set_m_ControlFlags(::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags>(value));
}
constexpr ::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags ::UnityEngine::InputSystem::InputControl::__get_m_ControlFlags() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::____UnityEngine__InputSystem__InputControl__ControlFlags, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance);
}
