...
class UnityEngine__InputSystem__InputManager____c__60_1<TDevice>;
}
namespace UnityEngine::InputSystem {
struct UnityEngine__InputSystem__InputManager__AvailableDevice;
}
...
struct CORDL_TYPE UnityEngine__InputSystem__InputManager__DeviceDisableScope : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager__DeviceDisableScope(int32_t value__) noexcept;


                    constexpr UnityEngine__InputSystem__InputManager__DeviceDisableScope(UnityEngine__InputSystem__InputManager__DeviceDisableScope const&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__DeviceDisableScope(UnityEngine__InputSystem__InputManager__DeviceDisableScope&&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__DeviceDisableScope& operator=(UnityEngine__InputSystem__InputManager__DeviceDisableScope const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputManager__DeviceDisableScope& operator=(UnityEngine__InputSystem__InputManager__DeviceDisableScope&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__InputManager__DeviceDisableScope(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__InputSystem__InputManager__DeviceDisableScope_Unwrapped : int32_t {
__Everywhere = 0,
__InFrontendOnly = 1,
...
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope const Everywhere;

/// @brief Field InFrontendOnly offset 0
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope const InFrontendOnly;

/// @brief Field TemporaryWhilePlayerIsInBackground offset 0
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope const TemporaryWhilePlayerIsInBackground;
...
struct CORDL_TYPE UnityEngine__InputSystem__InputManager__AvailableDevice : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__InputManager__AvailableDevice(UnityEngine::InputSystem::Layouts::InputDeviceDescription description, int32_t deviceId, bool isNative, bool isRemoved) noexcept;


                    constexpr UnityEngine__InputSystem__InputManager__AvailableDevice(UnityEngine__InputSystem__InputManager__AvailableDevice const&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__AvailableDevice(UnityEngine__InputSystem__InputManager__AvailableDevice&&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__AvailableDevice& operator=(UnityEngine__InputSystem__InputManager__AvailableDevice const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputManager__AvailableDevice& operator=(UnityEngine__InputSystem__InputManager__AvailableDevice&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager__AvailableDevice(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout(UnityEngine::InputSystem::InputControl control, double_t time, UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor monitor, int64_t monitorIndex, int32_t timerIndex) noexcept;


                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout(UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout const&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout(UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout&&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__InputManager__StateChangeMonitorListener : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorListener(UnityEngine::InputSystem::InputControl control, UnityEngine::InputSystem::LowLevel::IInputStateChangeMonitor monitor, int64_t monitorIndex, uint32_t groupIndex) noexcept;


                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorListener(UnityEngine__InputSystem__InputManager__StateChangeMonitorListener const&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorListener(UnityEngine__InputSystem__InputManager__StateChangeMonitorListener&&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorListener& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorListener const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorListener& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorListener&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager__StateChangeMonitorListener(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "memoryRegions", ty: "::ArrayW<UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__MemoryHelpers__BitRegion>", modifiers: "", def_value: None }, CppParam { name: "listeners", ty: "::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener>", modifiers: "", def_value: None }, CppParam { name: "signalled", ty: "UnityEngine::InputSystem::DynamicBitfield", modifiers: "", def_value: None }, CppParam { name: "needToUpdateOrderingOfMonitors", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "needToCompactArrays", ty: "bool", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice(::ArrayW<UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__MemoryHelpers__BitRegion> memoryRegions, ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener> listeners, UnityEngine::InputSystem::DynamicBitfield signalled, bool needToUpdateOrderingOfMonitors, bool needToCompactArrays) noexcept;


                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice(UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice const&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice(UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice&&) = default;
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice& operator=(UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 ::ArrayW<UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__MemoryHelpers__BitRegion> __declspec(property(get=__get_memoryRegions, put=__set_memoryRegions))  memoryRegions;

constexpr void __set_memoryRegions(::ArrayW<UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__MemoryHelpers__BitRegion> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__MemoryHelpers__BitRegion> __get_memoryRegions() const;

 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener> __declspec(property(get=__get_listeners, put=__set_listeners))  listeners;

constexpr void __set_listeners(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener> __get_listeners() const;
...
class CORDL_TYPE UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75(UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75(UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75& operator=(UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75& operator=(UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75 const& o) noexcept = default;
...
constexpr UnityEngine::InputSystem::Utilities::InternedString __get__internedBasedOn_5__2() const;
 ...
 System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Type> __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2))  __7__wrap2;

constexpr void __set___7__wrap2(System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Type> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Type> __get___7__wrap2() const;

 System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,::StringW> __declspec(property(get=__get___7__wrap3, put=__set___7__wrap3))  __7__wrap3;

constexpr void __set___7__wrap3(System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,::StringW> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,::StringW> __get___7__wrap3() const;

 System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Func_1<UnityEngine::InputSystem::Layouts::InputControlLayout>> __declspec(property(get=__get___7__wrap4, put=__set___7__wrap4))  __7__wrap4;

constexpr void __set___7__wrap4(System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Func_1<UnityEngine::InputSystem::Layouts::InputControlLayout>> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<UnityEngine::InputSystem::Utilities::InternedString,System::Func_1<UnityEngine::InputSystem::Layouts::InputControlLayout>> __get___7__wrap4() const;
...
class CORDL_TYPE UnityEngine__InputSystem__InputManager____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__InputSystem__InputManager____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager____c(UnityEngine__InputSystem__InputManager____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager____c(UnityEngine__InputSystem__InputManager____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__InputManager____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager____c& operator=(UnityEngine__InputSystem__InputManager____c&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__InputManager____c& operator=(UnityEngine__InputSystem__InputManager____c const& o) noexcept = default;
                


// Fields

static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c value) ;

static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c __get___9() ;
...
public:
// Declarations
using __c = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c;

using _ListControlLayouts_d__75 = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75;

template<typename TDevice>
using __c__60_1 = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c__60_1<TDevice>;

using StateChangeMonitorsForDevice = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice;

using StateChangeMonitorListener = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener;

using StateChangeMonitorTimeout = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout;

using AvailableDevice = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__AvailableDevice;

using DeviceDisableScope = UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope;
...
constexpr float_t __get_m_PollingFrequency() const;
 ...
 UnityEngine::InputSystem::Layouts::UnityEngine__InputSystem__Layouts__InputControlLayout__Collection __declspec(property(get=__get_m_Layouts, put=__set_m_Layouts))  m_Layouts;

constexpr void __set_m_Layouts(UnityEngine::InputSystem::Layouts::UnityEngine__InputSystem__Layouts__InputControlLayout__Collection value) ;

constexpr UnityEngine::InputSystem::Layouts::UnityEngine__InputSystem__Layouts__InputControlLayout__Collection __get_m_Layouts() const;
...
constexpr int32_t __get_m_AvailableDeviceCount() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__AvailableDevice> __declspec(property(get=__get_m_AvailableDevices, put=__set_m_AvailableDevices))  m_AvailableDevices;

constexpr void __set_m_AvailableDevices(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__AvailableDevice> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__AvailableDevice> __get_m_AvailableDevices() const;
...
constexpr UnityEngine::InputSystem::InputSettings __get_m_Settings() const;
 ...
 ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice> __declspec(property(get=__get_m_StateChangeMonitors, put=__set_m_StateChangeMonitors))  m_StateChangeMonitors;

constexpr void __set_m_StateChangeMonitors(::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice> value) ;

constexpr ::ArrayW<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice> __get_m_StateChangeMonitors() const;

 UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout> __declspec(property(get=__get_m_StateChangeMonitorTimeouts, put=__set_m_StateChangeMonitorTimeouts))  m_StateChangeMonitorTimeouts;

constexpr void __set_m_StateChangeMonitorTimeouts(UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout> value) ;

constexpr UnityEngine::InputSystem::Utilities::InlinedArray_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout> __get_m_StateChangeMonitorTimeouts() const;
...
/// @brief Method AddDevice addr 0x291cdb8 size 0x1d8 virtual false final false
 UnityEngine::InputSystem::InputDevice AddDevice(UnityEngine::InputSystem::Layouts::InputDeviceDescription description, bool throwIfNoLayoutFound, ::StringW deviceName, int32_t deviceId, UnityEngine::InputSystem::UnityEngine__InputSystem__InputDevice__DeviceFlags deviceFlags) ;

/// @brief Method AddDevice addr 0x291cf90 size 0xd4 virtual false final false
 UnityEngine::InputSystem::InputDevice AddDevice(UnityEngine::InputSystem::Layouts::InputDeviceDescription description, UnityEngine::InputSystem::Utilities::InternedString layout, ::StringW deviceName, int32_t deviceId, UnityEngine::InputSystem::UnityEngine__InputSystem__InputDevice__DeviceFlags deviceFlags) ;
...
/// @brief Method EnableOrDisableDevice addr 0x291c948 size 0x42c virtual false final false
 void EnableOrDisableDevice(UnityEngine::InputSystem::InputDevice device, bool enable, UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope scope) ;
...
class CORDL_TYPE UnityEngine__InputSystem__InputManager____c__60_1<TDevice> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__InputSystem__InputManager____c__60_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager____c__60_1", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager____c__60_1(UnityEngine__InputSystem__InputManager____c__60_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__InputManager____c__60_1", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__InputManager____c__60_1(UnityEngine__InputSystem__InputManager____c__60_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__InputManager____c__60_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__InputManager____c__60_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager____c__60_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__InputManager____c__60_1& operator=(UnityEngine__InputSystem__InputManager____c__60_1&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__InputManager____c__60_1& operator=(UnityEngine__InputSystem__InputManager____c__60_1 const& o) noexcept = default;
                


// Fields

static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c__60_1<TDevice> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c__60_1<TDevice> value) ;

static UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c__60_1<TDevice> __get___9() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c__60_1, "UnityEngine.InputSystem", "InputManager/<>c__60`1");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__DeviceDisableScope, "UnityEngine.InputSystem", "InputManager/DeviceDisableScope");
...
NEED_NO_BOX(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager___ListControlLayouts_d__75, "UnityEngine.InputSystem", "InputManager/<ListControlLayouts>d__75");
NEED_NO_BOX(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager____c, "UnityEngine.InputSystem", "InputManager/<>c");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__AvailableDevice, "UnityEngine.InputSystem", "InputManager/AvailableDevice");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorListener, "UnityEngine.InputSystem", "InputManager/StateChangeMonitorListener");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorTimeout, "UnityEngine.InputSystem", "InputManager/StateChangeMonitorTimeout");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::UnityEngine__InputSystem__InputManager__StateChangeMonitorsForDevice, "UnityEngine.InputSystem", "InputManager/StateChangeMonitorsForDevice");
