...
struct CORDL_TYPE RequestResetCommand : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr RequestResetCommand(UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand) noexcept;
                    ...
                    constexpr RequestResetCommand(RequestResetCommand const&) = default;
                    constexpr RequestResetCommand(RequestResetCommand&&) = default;
                    constexpr RequestResetCommand& operator=(RequestResetCommand const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr RequestResetCommand& operator=(RequestResetCommand&& o) noexcept {
...
constexpr explicit RequestResetCommand(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method get_Type addr 0x2955944 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic addr 0x2955974 size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method Create addr 0x29559a4 size 0x34 virtual false final false
