...
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "baseEvent", ty: "UnityEngine::InputSystem::LowLevel::InputEvent", modifiers: "", def_value: Some("{}") }, CppParam { name: "stateFormat", ty: "UnityEngine::InputSystem::Utilities::FourCC", modifiers: "", def_value: Some("{}") }, CppParam { name: "stateData", ty: "UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::InputSystem::LowLevel::StateEvent::StateEvent(UnityEngine::InputSystem::LowLevel::InputEvent baseEvent, UnityEngine::InputSystem::Utilities::FourCC stateFormat, UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer stateData) noexcept : ::bs_hook::ValueTypeWrapper() {this->baseEvent = baseEvent;
...
constexpr void UnityEngine::InputSystem::LowLevel::StateEvent::__set_stateData(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer, 0x18>(this->__instance, std::forward<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer>(value));
}
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer UnityEngine::InputSystem::LowLevel::StateEvent::__get_stateData() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__StateEvent___stateData_e__FixedBuffer, 0x18>(this->__instance);
}
