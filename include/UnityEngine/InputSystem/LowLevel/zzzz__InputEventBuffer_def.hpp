...
namespace UnityEngine::InputSystem::LowLevel {
struct ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator;
}
// Type: ::Enumerator
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator(void* m_Buffer, int32_t m_EventCount, void* m_CurrentEvent, int32_t m_CurrentIndex) noexcept;


                    constexpr ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator(____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator const&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator(____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator&&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator& operator=(____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator& operator=(____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator&& o) noexcept {
...
constexpr explicit ____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using Enumerator = ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__InputEventBuffer__Enumerator, "UnityEngine.InputSystem.LowLevel", "InputEventBuffer/Enumerator");
