...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_Type)> {
  ...
  constexpr static std::size_t addrs = 0x2955944;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::RequestResetCommand::*)()>(&UnityEngine::InputSystem::LowLevel::RequestResetCommand::get_typeStatic)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x2955974;
...
constexpr  UnityEngine::InputSystem::LowLevel::RequestResetCommand::operator UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo() const {
...
constexpr UnityEngine::InputSystem::LowLevel::RequestResetCommand::RequestResetCommand(UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand) noexcept : ::bs_hook::ValueTypeWrapper() {this->baseCommand = baseCommand;
}
...
constexpr UnityEngine::InputSystem::LowLevel::InputDeviceCommand UnityEngine::InputSystem::LowLevel::RequestResetCommand::__get_baseCommand() const {
