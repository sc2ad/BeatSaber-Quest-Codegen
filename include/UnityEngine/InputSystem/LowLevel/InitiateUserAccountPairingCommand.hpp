...
namespace UnityEngine::InputSystem::LowLevel {
  // Forward declaring type: InitiateUserAccountPairingCommand
...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  // Autogenerated type: UnityEngine.InputSystem.LowLevel.InitiateUserAccountPairingCommand
  // [TokenAttribute] Offset: FFFFFFFF
  struct InitiateUserAccountPairingCommand/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo*/ {
    public:
    // Nested type: ::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::Result
    struct Result;
    public:
    ...
    public:
    // Creating value type constructor for type: InitiateUserAccountPairingCommand
    constexpr InitiateUserAccountPairingCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand_ = {}) noexcept : baseCommand{baseCommand_} {}
    ...
    // static public UnityEngine.InputSystem.LowLevel.InitiateUserAccountPairingCommand Create()
    // Offset: 0x11A54E0
  ...
  #pragma pack(pop)
  static check_size<sizeof(InitiateUserAccountPairingCommand), 0 + sizeof(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand)> __UnityEngine_InputSystem_LowLevel_InitiateUserAccountPairingCommandSizeCheck;
  static_assert(sizeof(InitiateUserAccountPairingCommand) == 0x8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::get_Type
// Il2CppName: get_Type
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::get_Type)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand), "get_Type", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::get_typeStatic
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::*)()>(&UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::get_typeStatic)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand), "get_typeStatic", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand (*)()>(&UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand::Create)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::InitiateUserAccountPairingCommand), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
