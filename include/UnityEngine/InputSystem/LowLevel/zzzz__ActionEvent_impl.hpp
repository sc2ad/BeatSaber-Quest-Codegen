...
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer::__get_FixedElementField() const {
...
constexpr void ::UnityEngine::InputSystem::LowLevel::ActionEvent::__set_m_ValueData(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer, 0x24>(this->__instance, std::forward<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer>(value));
}
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer ::UnityEngine::InputSystem::LowLevel::ActionEvent::__get_m_ValueData() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer, 0x24>(this->__instance);
}
