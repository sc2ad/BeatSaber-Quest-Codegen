...
namespace UnityEngine::InputSystem::LowLevel {
struct ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer;
}
...
struct CORDL_TYPE ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer(uint8_t FixedElementField) noexcept;


                    constexpr ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer(____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer const&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer(____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer&&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer& operator=(____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer& operator=(____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer&& o) noexcept {
...
constexpr explicit ____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _stateData_e__FixedBuffer = ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer;

/// @brief Convert operator to ::UnityEngine::InputSystem::LowLevel::IInputEventTypeInfo
constexpr operator  ::UnityEngine::InputSystem::LowLevel::IInputEventTypeInfo() const;

// Ctor Parameters [CppParam { name: "baseEvent", ty: "::UnityEngine::InputSystem::LowLevel::InputEvent", modifiers: "", def_value: None }, CppParam { name: "stateFormat", ty: "::UnityEngine::InputSystem::Utilities::FourCC", modifiers: "", def_value: None }, CppParam { name: "stateOffset", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "stateData", ty: "::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr DeltaStateEvent(::UnityEngine::InputSystem::LowLevel::InputEvent baseEvent, ::UnityEngine::InputSystem::Utilities::FourCC stateFormat, uint32_t stateOffset, ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer stateData) noexcept;
...
constexpr uint32_t __get_stateOffset() const;
 ...
 ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer __declspec(property(get=__get_stateData, put=__set_stateData))  stateData;

constexpr void __set_stateData(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer value) ;

constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer __get_stateData() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer, "UnityEngine.InputSystem.LowLevel", "DeltaStateEvent/<stateData>e__FixedBuffer");
