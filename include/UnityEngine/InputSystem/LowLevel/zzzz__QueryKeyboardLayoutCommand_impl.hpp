...
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "baseCommand", ty: "::UnityEngine::InputSystem::LowLevel::InputDeviceCommand", modifiers: "", def_value: Some("{}") }, CppParam { name: "nameBuffer", ty: "::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand::QueryKeyboardLayoutCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand, ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer nameBuffer) noexcept : ::bs_hook::ValueTypeWrapper() {this->baseCommand = baseCommand;
...
constexpr void ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand::__set_nameBuffer(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer, 0x8>(this->__instance, std::forward<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer>(value));
}
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer ::UnityEngine::InputSystem::LowLevel::QueryKeyboardLayoutCommand::__get_nameBuffer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__QueryKeyboardLayoutCommand___nameBuffer_e__FixedBuffer, 0x8>(this->__instance);
}
