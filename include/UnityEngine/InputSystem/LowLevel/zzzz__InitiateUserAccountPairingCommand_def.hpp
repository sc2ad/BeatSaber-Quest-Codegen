...
struct CORDL_TYPE UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result(int32_t value__) noexcept;


                    constexpr UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result(UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result const&) = default;
                    constexpr UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result(UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result&&) = default;
                    constexpr UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result& operator=(UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result& operator=(UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result_Unwrapped : int32_t {
...
static UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result const SuccessfullyInitiated;

/// @brief Field ErrorNotSupported offset 0
static UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result const ErrorNotSupported;

/// @brief Field ErrorAlreadyInProgress offset 0
static UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result const ErrorAlreadyInProgress;
...
public:
// Declarations
using Result = UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InitiateUserAccountPairingCommand__Result, "UnityEngine.InputSystem.LowLevel", "InitiateUserAccountPairingCommand/Result");
