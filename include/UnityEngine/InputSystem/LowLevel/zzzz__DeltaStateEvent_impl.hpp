...
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer::__get_FixedElementField() const {
...
constexpr void UnityEngine::InputSystem::LowLevel::DeltaStateEvent::__set_stateData(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer, 0x1c>(this->__instance, std::forward<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer>(value));
}
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer UnityEngine::InputSystem::LowLevel::DeltaStateEvent::__get_stateData() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__DeltaStateEvent___stateData_e__FixedBuffer, 0x1c>(this->__instance);
}
