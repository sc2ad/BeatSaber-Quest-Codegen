...
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer(uint8_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer::__set_FixedElementField(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer::__get_FixedElementField() const {
...
// Ctor Parameters [CppParam { name: "keys", ty: "::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::InputSystem::LowLevel::KeyboardState::KeyboardState(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer keys) noexcept : ::bs_hook::ValueTypeWrapper() {this->keys = keys;
}
constexpr void ::UnityEngine::InputSystem::LowLevel::KeyboardState::__set_keys(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer, 0x0>(this->__instance, std::forward<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer>(value));
}
constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer ::UnityEngine::InputSystem::LowLevel::KeyboardState::__get_keys() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__KeyboardState___keys_e__FixedBuffer, 0x0>(this->__instance);
}
