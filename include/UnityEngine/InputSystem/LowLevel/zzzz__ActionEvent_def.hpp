...
struct CORDL_TYPE UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer(uint8_t FixedElementField) noexcept;


                    constexpr UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer(UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer const&) = default;
                    constexpr UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer(UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer&&) = default;
                    constexpr UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer& operator=(UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer& operator=(UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer&& o) noexcept {
...
constexpr explicit UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr double_t __get_m_StartTime() const;
 ...
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer __declspec(property(get=__get_m_ValueData, put=__set_m_ValueData))  m_ValueData;

constexpr void __set_m_ValueData(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer value) ;

constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer __get_m_ValueData() const;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__ActionEvent___m_ValueData_e__FixedBuffer, "UnityEngine.InputSystem.LowLevel", "ActionEvent/<m_ValueData>e__FixedBuffer");
