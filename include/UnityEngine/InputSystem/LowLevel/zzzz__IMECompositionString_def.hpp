...
namespace UnityEngine::InputSystem::LowLevel {
struct ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator;
}
namespace UnityEngine::InputSystem::LowLevel {
struct ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer;
}
// Type: ::Enumerator
namespace UnityEngine::InputSystem::LowLevel {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator(::UnityEngine::InputSystem::LowLevel::IMECompositionString m_CompositionString, char16_t m_CurrentCharacter, int32_t m_CurrentIndex) noexcept;


                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator(____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator const&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator(____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator&&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator& operator=(____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator& operator=(____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator&& o) noexcept {
...
constexpr explicit ____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "char16_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer(char16_t FixedElementField) noexcept;


                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer(____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer const&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer(____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer&&) = default;
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer& operator=(____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer& operator=(____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _buffer_e__FixedBuffer = ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer;

using Enumerator = ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator;
...
// Ctor Parameters [CppParam { name: "size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "buffer", ty: "::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer", modifiers: "", def_value: None }]
constexpr IMECompositionString(int32_t size, ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer buffer) noexcept;
...
constexpr int32_t __get_size() const;
 ...
 ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer __declspec(property(get=__get_buffer, put=__set_buffer))  buffer;

constexpr void __set_buffer(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer value) ;

constexpr ::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer __get_buffer() const;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString__Enumerator, "UnityEngine.InputSystem.LowLevel", "IMECompositionString/Enumerator");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::InputSystem::LowLevel::____UnityEngine__InputSystem__LowLevel__IMECompositionString___buffer_e__FixedBuffer, "UnityEngine.InputSystem.LowLevel", "IMECompositionString/<buffer>e__FixedBuffer");
