...
namespace UnityEngine::InputSystem::LowLevel {
  // Forward declaring type: EnableDeviceCommand
...
namespace UnityEngine::InputSystem::LowLevel {
  ...
  // Autogenerated type: UnityEngine.InputSystem.LowLevel.EnableDeviceCommand
  // [TokenAttribute] Offset: FFFFFFFF
  struct EnableDeviceCommand/*, public ::System::ValueType, public ::UnityEngine::InputSystem::LowLevel::IInputDeviceCommandInfo*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: EnableDeviceCommand
    constexpr EnableDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand baseCommand_ = {}) noexcept : baseCommand{baseCommand_} {}
    ...
    // static public UnityEngine.InputSystem.LowLevel.EnableDeviceCommand Create()
    // Offset: 0x11A4D18
    static ::UnityEngine::InputSystem::LowLevel::EnableDeviceCommand Create();
  }; // UnityEngine.InputSystem.LowLevel.EnableDeviceCommand
  #pragma pack(pop)
  static check_size<sizeof(EnableDeviceCommand), 0 + sizeof(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand)> __UnityEngine_InputSystem_LowLevel_EnableDeviceCommandSizeCheck;
  static_assert(sizeof(EnableDeviceCommand) == 0x8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::get_Type
// Il2CppName: get_Type
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::get_Type)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::EnableDeviceCommand), "get_Type", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::get_typeStatic
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::*)()>(&UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::get_typeStatic)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::EnableDeviceCommand), "get_typeStatic", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::EnableDeviceCommand (*)()>(&UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::Create)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::InputSystem::LowLevel::EnableDeviceCommand), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
