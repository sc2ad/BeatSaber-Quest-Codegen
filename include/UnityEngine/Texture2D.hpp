...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: E295EC
  // [UsedByNativeCodeAttribute] Offset: E295EC
  // [NativeHeaderAttribute] Offset: E295EC
  class Texture2D : public UnityEngine::Texture {
    ...
    // Offset: 0x1D9709C
    static void GenerateAtlasImpl(::Array<UnityEngine::Vector2>* sizes, int padding, int atlasSize, ByRef<::Array<UnityEngine::Rect>*> rect);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Array<UnityEngine::Vector2>*, int, int, ByRef<::Array<UnityEngine::Rect>*>)>(&UnityEngine::Texture2D::GenerateAtlasImpl)> {
  static const MethodInfo* get() {
