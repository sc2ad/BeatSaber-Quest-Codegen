...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: EB3CF8
  // [NativeHeaderAttribute] Offset: EB3CF8
  // [NativeHeaderAttribute] Offset: EB3CF8
  class Texture2D : public UnityEngine::Texture {
    ...
    void LoadRawTextureData(Unity::Collections::NativeArray_1<T> data) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___generic__method, data)));
    }
    ...
    void SetPixelData(::ArrayW<T> data, int mipLevel, int sourceDataStartIndex) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___generic__method, data, mipLevel, sourceDataStartIndex)));
    }
    ...
    Unity::Collections::NativeArray_1<T> GetRawTextureData() {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Unity::Collections::NativeArray_1<T>, false>(this, ___generic__method)));
    }
