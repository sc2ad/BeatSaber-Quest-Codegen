...
namespace UnityEngine {
  ...
  class Resources : public ::CsObject {
    public:
    ...
    // Offset: 0x1387D60
    static UnityEngine::Object* Load(::CsString* path, System::Type* systemTypeInstance);
    // static public UnityEngine.Object[] LoadAll(System.String path, System.Type systemTypeInstance)
    // Offset: 0x1387DB0
    static ::Array<UnityEngine::Object*>* LoadAll(::CsString* path, System::Type* systemTypeInstance);
    // static public UnityEngine.Object[] LoadAll(System.String path)
    // Offset: 0x1387E00
    static ::Array<UnityEngine::Object*>* LoadAll(::CsString* path);
    // static public UnityEngine.Object GetBuiltinResource(System.Type type, System.String path)
    // Offset: 0x1387EAC
    static UnityEngine::Object* GetBuiltinResource(System::Type* type, ::CsString* path);
    // static public T GetBuiltinResource(System.String path)
    // Offset: 0xFFFFFFFF
    template<class T>
    static T GetBuiltinResource(::CsString* path) {
      static_assert(std::is_convertible_v<T, UnityEngine::Object*>);
