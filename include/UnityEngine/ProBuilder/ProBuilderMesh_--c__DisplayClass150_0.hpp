...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(ProBuilderMesh::$$c__DisplayClass150_0), 16 + sizeof(int) + 8 - (16 + sizeof(int)) % 8> __UnityEngine_ProBuilder_ProBuilderMesh_$$c__DisplayClass150_0SizeCheck;
}
