...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Bounds, false>(const_cast<void*>(instance), ___internal_method, mesh, size, rotation);
 ...
 UnityEngine::ProBuilder::Shapes::Cube UnityEngine::ProBuilder::Shapes::Cube::New_ctor()  {
UnityEngine::ProBuilder::Shapes::Cube o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::ProBuilder::Shapes::Cube>())};
return o;
}
