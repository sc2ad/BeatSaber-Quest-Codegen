...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Bounds, false>(const_cast<void*>(instance), ___internal_method, mesh, size, rotation);
 ...
 UnityEngine::ProBuilder::Shapes::Prism UnityEngine::ProBuilder::Shapes::Prism::New_ctor()  {
UnityEngine::ProBuilder::Shapes::Prism o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::ProBuilder::Shapes::Prism>())};
return o;
}
