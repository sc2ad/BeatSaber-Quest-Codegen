...
namespace UnityEngine::ProBuilder {
  ...
  // [CompilerGeneratedAttribute] Offset: E3A3AC
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::*)(UnityEngine::ProBuilder::WingedEdge*)>(&UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::$SortCommonIndexesByAdjacency$b__0)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0*), "<SortCommonIndexesByAdjacency>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<UnityEngine::ProBuilder::WingedEdge*>()});
  }
};
// Writing MetadataGetter for method: UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::New_ctor
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::*)()>(&UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::*)()>(&UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ProBuilder::WingedEdge::$$c__DisplayClass32_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
