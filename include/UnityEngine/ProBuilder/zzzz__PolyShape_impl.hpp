...
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::____UnityEngine__ProBuilder__PolyShape__PolyEditMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::None{0};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::Path{1};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::Height{2};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode::Edit{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode (::UnityEngine::ProBuilder::PolyShape::*)()>(&::UnityEngine::ProBuilder::PolyShape::get_polyEditMode)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::PolyShape::*)(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode)>(&::UnityEngine::ProBuilder::PolyShape::set_polyEditMode)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_polyEditMode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::UnityEngine::ProBuilder::PolyShape::__set_m_EditMode(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode value)  {
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode>(value));
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode ::UnityEngine::ProBuilder::PolyShape::__get_m_EditMode() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode ::UnityEngine::ProBuilder::PolyShape::get_polyEditMode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::PolyShape>::get(),
                            "get_polyEditMode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::UnityEngine::ProBuilder::PolyShape::set_polyEditMode(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__PolyShape__PolyEditMode value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::PolyShape>::get(),
                            "set_polyEditMode",
                            std::vector<Il2CppClass*>{},
