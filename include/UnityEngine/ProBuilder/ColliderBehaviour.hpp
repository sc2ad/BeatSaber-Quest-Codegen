...
namespace UnityEngine::ProBuilder {
  ...
  // [] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: DE2A74
  class ColliderBehaviour : public UnityEngine::ProBuilder::EntityBehaviour {
    ...
    static ColliderBehaviour* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::ProBuilder").WithContext("ColliderBehaviour").WithContext(".ctor");
