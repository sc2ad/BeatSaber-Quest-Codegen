...
namespace UnityEngine::ProBuilder {
  ...
  class Log : public ::CsObject {
    ...
    static ::CsString* _get_k_ProBuilderLogFileName();
    // Set static field: static public System.String k_ProBuilderLogFileName
    static void _set_k_ProBuilderLogFileName(::CsString* value);
    ...
    static ::CsString* _get_s_LogFilePath();
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static void NotNull(T obj, ::CsString* message) {
