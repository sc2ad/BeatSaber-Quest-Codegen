...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(ArrayUtility::SearchRange), 4 + sizeof(int) + ((4 + sizeof(int)) % 8 != 0 ? (8 - (4 + sizeof(int)) % 8) : 0)> __UnityEngine_ProBuilder_ArrayUtility_SearchRangeSizeCheck;
}
