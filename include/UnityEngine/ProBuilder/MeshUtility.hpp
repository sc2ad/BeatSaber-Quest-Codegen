...
namespace UnityEngine::ProBuilder {
  ...
  class MeshUtility : public ::CsObject {
    public:
    ...
    // Offset: 0x10175C4
    static ::CsString* Print(UnityEngine::Mesh* mesh);
    ...
    // Offset: 0x1019940
    static ::CsString* SanityCheck(UnityEngine::ProBuilder::ProBuilderMesh* mesh);
    // static System.String SanityCheck(UnityEngine.Mesh mesh)
    // Offset: 0x1019BE4
    static ::CsString* SanityCheck(UnityEngine::Mesh* mesh);
    // static System.String SanityCheck(System.Collections.Generic.IList`1<UnityEngine.ProBuilder.Vertex> vertices)
    // Offset: 0x1019964
    static ::CsString* SanityCheck(System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Vertex*>* vertices);
