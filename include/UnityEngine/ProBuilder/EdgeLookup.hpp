...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(EdgeLookup), 8 + sizeof(UnityEngine::ProBuilder::Edge) + ((8 + sizeof(UnityEngine::ProBuilder::Edge)) % 8 != 0 ? (8 - (8 + sizeof(UnityEngine::ProBuilder::Edge)) % 8) : 0)> __UnityEngine_ProBuilder_EdgeLookupSizeCheck;
