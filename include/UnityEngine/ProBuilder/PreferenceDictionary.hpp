...
namespace UnityEngine::ProBuilder {
  ...
  class PreferenceDictionary : public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::ProBuilder::IHasDefault, public UnityEngine::ScriptableObject {
    public:
