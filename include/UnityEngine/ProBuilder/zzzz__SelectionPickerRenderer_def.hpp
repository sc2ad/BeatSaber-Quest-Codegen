...
class CORDL_TYPE UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer : public ::cordl_internals::InterfaceW {
public:
// Declarations
~UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer() = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
...
class CORDL_TYPE UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer
constexpr operator  UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer() const noexcept;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP const& o) noexcept = default;
...
class CORDL_TYPE UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer
constexpr operator  UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer() const noexcept;
...
virtual ~UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard const& o) noexcept = default;
...
class CORDL_TYPE UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0(UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0(UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0 const& o) noexcept = default;
...
class CORDL_TYPE UnityEngine__ProBuilder__SelectionPickerRenderer____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__ProBuilder__SelectionPickerRenderer____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c(UnityEngine__ProBuilder__SelectionPickerRenderer____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__SelectionPickerRenderer____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c(UnityEngine__ProBuilder__SelectionPickerRenderer____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__SelectionPickerRenderer____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer____c&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__SelectionPickerRenderer____c& operator=(UnityEngine__ProBuilder__SelectionPickerRenderer____c const& o) noexcept = default;
                


// Fields

static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c value) ;

static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c __get___9() ;
...
public:
// Declarations
using __c = UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c;

using __c__DisplayClass19_0 = UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0;

using SelectionPickerRendererStandard = UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard;

using SelectionPickerRendererHDRP = UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP;

using ISelectionPickerRenderer = UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer;
...
static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer __declspec(property(get=__get_s_PickerRenderer, put=__set_s_PickerRenderer))  s_PickerRenderer;

static void __set_s_PickerRenderer(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer value) ;

static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer __get_s_PickerRenderer() ;
...
static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer __declspec(property(get=get_pickerRenderer))  pickerRenderer;
...
static UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer get_pickerRenderer() ;
...
NEED_NO_BOX(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__ISelectionPickerRenderer, "UnityEngine.ProBuilder", "SelectionPickerRenderer/ISelectionPickerRenderer");
NEED_NO_BOX(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererHDRP, "UnityEngine.ProBuilder", "SelectionPickerRenderer/SelectionPickerRendererHDRP");
NEED_NO_BOX(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer__SelectionPickerRendererStandard, "UnityEngine.ProBuilder", "SelectionPickerRenderer/SelectionPickerRendererStandard");
NEED_NO_BOX(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c, "UnityEngine.ProBuilder", "SelectionPickerRenderer/<>c");
NEED_NO_BOX(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::UnityEngine__ProBuilder__SelectionPickerRenderer____c__DisplayClass19_0, "UnityEngine.ProBuilder", "SelectionPickerRenderer/<>c__DisplayClass19_0");
