...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  check_size<sizeof(TriangulationPoint), 40 + sizeof(int) + ((40 + sizeof(int)) % 8 != 0 ? (8 - (40 + sizeof(int)) % 8) : 0)> __UnityEngine_ProBuilder_Poly2Tri_TriangulationPointSizeCheck;
}
