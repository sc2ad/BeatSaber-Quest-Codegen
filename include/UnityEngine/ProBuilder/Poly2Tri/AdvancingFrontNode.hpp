...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  check_size<sizeof(AdvancingFrontNode), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __UnityEngine_ProBuilder_Poly2Tri_AdvancingFrontNodeSizeCheck;
}
