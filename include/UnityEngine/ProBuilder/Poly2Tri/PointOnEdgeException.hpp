...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  check_size<sizeof(PointOnEdgeException), 152 + sizeof(void*) + ((152 + sizeof(void*)) % 8 != 0 ? (8 - (152 + sizeof(void*)) % 8) : 0)> __UnityEngine_ProBuilder_Poly2Tri_PointOnEdgeExceptionSizeCheck;
}
