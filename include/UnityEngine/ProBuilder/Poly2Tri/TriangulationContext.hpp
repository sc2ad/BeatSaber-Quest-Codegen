...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  check_size<sizeof(TriangulationContext), 60 + sizeof(bool) + ((60 + sizeof(bool)) % 8 != 0 ? (8 - (60 + sizeof(bool)) % 8) : 0)> __UnityEngine_ProBuilder_Poly2Tri_TriangulationContextSizeCheck;
}
