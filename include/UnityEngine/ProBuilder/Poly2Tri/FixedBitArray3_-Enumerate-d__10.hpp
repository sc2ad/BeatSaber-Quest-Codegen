...
namespace UnityEngine::ProBuilder::Poly2Tri {
  ...
  check_size<sizeof(FixedBitArray3::$Enumerate$d__10), 36 + sizeof(int) + ((36 + sizeof(int)) % 8 != 0 ? (8 - (36 + sizeof(int)) % 8) : 0)> __UnityEngine_ProBuilder_Poly2Tri_FixedBitArray3_$Enumerate$d__10SizeCheck;
}
