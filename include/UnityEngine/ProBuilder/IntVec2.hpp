...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(IntVec2), 0 + sizeof(UnityEngine::Vector2) + ((0 + sizeof(UnityEngine::Vector2)) % 8 != 0 ? (8 - (0 + sizeof(UnityEngine::Vector2)) % 8) : 0)> __UnityEngine_ProBuilder_IntVec2SizeCheck;
