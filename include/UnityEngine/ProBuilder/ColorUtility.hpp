...
namespace UnityEngine::ProBuilder {
  ...
  class ColorUtility : public ::CsObject {
    public:
    ...
    static System::Collections::Generic::Dictionary_2<::CsString*, UnityEngine::ProBuilder::CIELabColor*>* _get_ColorNameLookup();
    ...
    static void _set_ColorNameLookup(System::Collections::Generic::Dictionary_2<::CsString*, UnityEngine::ProBuilder::CIELabColor*>* value);
    ...
    // Offset: 0x152A400
    static ::CsString* GetColorName(UnityEngine::Color InColor);
