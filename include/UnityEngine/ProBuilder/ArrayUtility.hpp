...
namespace UnityEngine::ProBuilder {
  ...
  class ArrayUtility : public ::CsObject {
    public:
    ...
    static ::CsString* ToString(System::Collections::Generic::Dictionary_2<TKey, TValue>* dict) {
      return THROW_UNLESS((il2cpp_utils::RunGenericMethod<::CsString*>("UnityEngine.ProBuilder", "ArrayUtility", "ToString", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TKey>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TValue>::get()}, dict)));
    }
    // static public System.String ToString(System.Collections.Generic.IEnumerable`1<T> arr, System.String separator)
    // Offset: 0xFFFFFFFF
    template<class T>
    static ::CsString* ToString(System::Collections::Generic::IEnumerable_1<T>* arr, ::CsString* separator) {
      return THROW_UNLESS((il2cpp_utils::RunGenericMethod<::CsString*>("UnityEngine.ProBuilder", "ArrayUtility", "ToString", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, arr, separator)));
    }
