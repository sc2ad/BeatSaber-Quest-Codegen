...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(IntVec3), 0 + sizeof(UnityEngine::Vector3) + ((0 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (0 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __UnityEngine_ProBuilder_IntVec3SizeCheck;
