...
namespace UnityEngine::ProBuilder {
  ...
  struct AutoUnwrapSettings : public System::ValueType {
    ...
    check_size<sizeof(AutoUnwrapSettings::Anchor), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_ProBuilder_AutoUnwrapSettings_AnchorSizeCheck;
    ...
    check_size<sizeof(AutoUnwrapSettings::Fill), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_ProBuilder_AutoUnwrapSettings_FillSizeCheck;
  ...
  check_size<sizeof(AutoUnwrapSettings), 28 + sizeof(UnityEngine::ProBuilder::AutoUnwrapSettings::Anchor) + 8 - (28 + sizeof(UnityEngine::ProBuilder::AutoUnwrapSettings::Anchor)) % 8> __UnityEngine_ProBuilder_AutoUnwrapSettingsSizeCheck;
}
