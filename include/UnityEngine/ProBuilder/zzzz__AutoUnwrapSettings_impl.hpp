...
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::UpperLeft{0};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::UpperCenter{1};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::UpperRight{2};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::MiddleLeft{3};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::MiddleCenter{4};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::MiddleRight{5};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::LowerLeft{6};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::LowerCenter{7};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::LowerRight{8};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor::None{9};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::Fit{0};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::Tile{1};
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill  ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill::Stretch{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill (::UnityEngine::ProBuilder::AutoUnwrapSettings::*)()>(&::UnityEngine::ProBuilder::AutoUnwrapSettings::get_fill)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::AutoUnwrapSettings::*)(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill)>(&::UnityEngine::ProBuilder::AutoUnwrapSettings::set_fill)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_fill",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor (::UnityEngine::ProBuilder::AutoUnwrapSettings::*)()>(&::UnityEngine::ProBuilder::AutoUnwrapSettings::get_anchor)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::AutoUnwrapSettings::*)(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor)>(&::UnityEngine::ProBuilder::AutoUnwrapSettings::set_anchor)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_anchor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor>::get()}
                        )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "m_UseWorldSpace", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_FlipU", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_FlipV", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_SwapUV", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Fill", ty: "::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Scale", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Offset", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Rotation", ty: "float_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_Anchor", ty: "::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::ProBuilder::AutoUnwrapSettings::AutoUnwrapSettings(bool m_UseWorldSpace, bool m_FlipU, bool m_FlipV, bool m_SwapUV, ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill m_Fill, ::UnityEngine::Vector2 m_Scale, ::UnityEngine::Vector2 m_Offset, float_t m_Rotation, ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor m_Anchor) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_UseWorldSpace = m_UseWorldSpace;
...
constexpr void ::UnityEngine::ProBuilder::AutoUnwrapSettings::__set_m_Fill(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill value)  {
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill, 0x4>(this->__instance, std::forward<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill>(value));
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill ::UnityEngine::ProBuilder::AutoUnwrapSettings::__get_m_Fill() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill, 0x4>(this->__instance);
}
...
constexpr void ::UnityEngine::ProBuilder::AutoUnwrapSettings::__set_m_Anchor(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor value)  {
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor, 0x1c>(this->__instance, std::forward<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor>(value));
}
constexpr ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor ::UnityEngine::ProBuilder::AutoUnwrapSettings::__get_m_Anchor() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor, 0x1c>(this->__instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill ::UnityEngine::ProBuilder::AutoUnwrapSettings::get_fill()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::AutoUnwrapSettings>::get(),
                            "get_fill",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
 void ::UnityEngine::ProBuilder::AutoUnwrapSettings::set_fill(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Fill value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::AutoUnwrapSettings>::get(),
                            "set_fill",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 ::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor ::UnityEngine::ProBuilder::AutoUnwrapSettings::get_anchor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::AutoUnwrapSettings>::get(),
                            "get_anchor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
 void ::UnityEngine::ProBuilder::AutoUnwrapSettings::set_anchor(::UnityEngine::ProBuilder::____UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::ProBuilder::AutoUnwrapSettings>::get(),
                            "set_anchor",
                            std::vector<Il2CppClass*>{},
