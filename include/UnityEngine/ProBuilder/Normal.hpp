...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(Normal), 28 + sizeof(UnityEngine::Vector3) + ((28 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (28 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __UnityEngine_ProBuilder_NormalSizeCheck;
