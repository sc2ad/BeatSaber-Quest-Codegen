...
namespace UnityEngine::ProBuilder {
  ...
  #pragma pack(pop)
  // Writing MetadataGetter for method: MeshHandles::$$c::_cctor
  // Il2CppName: .cctor
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&MeshHandles::$$c::_cctor)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MeshHandles::$$c*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  // Writing MetadataGetter for method: MeshHandles::$$c::$CreateFaceMesh$b__9_0
  // Il2CppName: <CreateFaceMesh>b__9_0
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::Generic::IEnumerable_1<int>* (MeshHandles::$$c::*)(UnityEngine::ProBuilder::Face*)>(&MeshHandles::$$c::$CreateFaceMesh$b__9_0)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MeshHandles::$$c*), "<CreateFaceMesh>b__9_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<UnityEngine::ProBuilder::Face*>()});
    }
  };
  // Writing MetadataGetter for method: MeshHandles::$$c::New_ctor
  // Il2CppName: .ctor
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MeshHandles::$$c::*)()>(&MeshHandles::$$c::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MeshHandles::$$c*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MeshHandles::$$c::*)()>(&MeshHandles::$$c::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MeshHandles::$$c*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
