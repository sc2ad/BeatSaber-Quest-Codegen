...
namespace UnityEngine::ProBuilder {
  ...
  class SelectionPickerRenderer : public ::CsObject {
    public:
    ...
    static ::CsString* _get_k_FacePickerOcclusionTintUniform();
    // Set static field: static private System.String k_FacePickerOcclusionTintUniform
    static void _set_k_FacePickerOcclusionTintUniform(::CsString* value);
    ...
    // Offset: 0x103E27C
    static UnityEngine::Texture2D* RenderWithReplacementShader(UnityEngine::Camera* camera, UnityEngine::Shader* shader, ::CsString* tag, int width, int height);
