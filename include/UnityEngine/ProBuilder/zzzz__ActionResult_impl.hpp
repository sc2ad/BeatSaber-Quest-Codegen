...
constexpr void UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status  UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::Success{0};
constexpr UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status  UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::Failure{1};
constexpr UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status  UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::Canceled{2};
constexpr UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status  UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status::NoChange{3};
//  Writing Method size for method: UnityEngine::ProBuilder::ActionResult.get_status
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status (UnityEngine::ProBuilder::ActionResult::*)()>(&UnityEngine::ProBuilder::ActionResult::get_status)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::ActionResult::*)(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status)>(&UnityEngine::ProBuilder::ActionResult::set_status)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_status",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::ActionResult::*)(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status, ::StringW)>(&UnityEngine::ProBuilder::ActionResult::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void UnityEngine::ProBuilder::ActionResult::__set__status_k__BackingField(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status value)  {
::cordl_internals::setInstanceField<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status>(value));
}
constexpr UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status UnityEngine::ProBuilder::ActionResult::__get__status_k__BackingField() const {
return ::cordl_internals::getInstanceField<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status UnityEngine::ProBuilder::ActionResult::get_status()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::ActionResult>::get(),
                            "get_status",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status, false>(const_cast<void*>(instance), ___internal_method);
}
 void UnityEngine::ProBuilder::ActionResult::set_status(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::ActionResult>::get(),
                            "set_status",
                            std::vector<Il2CppClass*>{},
