...
namespace UnityEngine::ProBuilder {
  ...
  // [DefaultMemberAttribute] Offset: F257E8
  class SharedVertex : public ::Il2CppObject/*, public System::Collections::Generic::ICollection_1<int>*/ {
    ...
    ::ArrayWrapper<int>& dyn_m_Vertices();
    // System.Int32[] get_arrayInternal()
    // Offset: 0x24EB230
    ::ArrayWrapper<int> get_arrayInternal();
    ...
    // Offset: 0x24EB688
    void CopyTo(::ArrayWrapper<int> array, int arrayIndex);
    ...
    // Offset: 0x24EBB38
    static ::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> ToSharedVertices(System::Collections::Generic::IEnumerable_1<System::Collections::Generic::KeyValuePair_2<int, int>>* lookup);
    ...
    // Offset: 0x24EBF8C
    static ::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> ToSharedVertices(System::Collections::Generic::List_1<System::Collections::Generic::List_1<int>*>* list);
    ...
    // Offset: 0x24EC0E8
    static ::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> GetSharedVerticesWithPositions(System::Collections::Generic::IList_1<UnityEngine::Vector3>* positions);
    ...
    // Offset: 0x24EC540
    static ::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> RemoveAndShift(System::Collections::Generic::Dictionary_2<int, int>* lookup, System::Collections::Generic::IEnumerable_1<int>* remove);
    ...
    // Offset: 0x24EC5D8
    static ::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> SortedRemoveAndShift(System::Collections::Generic::Dictionary_2<int, int>* lookup, System::Collections::Generic::List_1<int>* remove);
  ...
  #pragma pack(pop)
  static check_size<sizeof(SharedVertex), 16 + sizeof(::ArrayWrapper<int>)> __UnityEngine_ProBuilder_SharedVertexSizeCheck;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<int> (UnityEngine::ProBuilder::SharedVertex::*)()>(&UnityEngine::ProBuilder::SharedVertex::get_arrayInternal)> {
...
// Il2CppName: CopyTo
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::SharedVertex::*)(::ArrayWrapper<int>, int)>(&UnityEngine::ProBuilder::SharedVertex::CopyTo)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> (*)(System::Collections::Generic::IEnumerable_1<System::Collections::Generic::KeyValuePair_2<int, int>>*)>(&UnityEngine::ProBuilder::SharedVertex::ToSharedVertices)> {
  static const MethodInfo* get() {
...
// Il2CppName: ToSharedVertices
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> (*)(System::Collections::Generic::List_1<System::Collections::Generic::List_1<int>*>*)>(&UnityEngine::ProBuilder::SharedVertex::ToSharedVertices)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> (*)(System::Collections::Generic::IList_1<UnityEngine::Vector3>*)>(&UnityEngine::ProBuilder::SharedVertex::GetSharedVerticesWithPositions)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> (*)(System::Collections::Generic::Dictionary_2<int, int>*, System::Collections::Generic::IEnumerable_1<int>*)>(&UnityEngine::ProBuilder::SharedVertex::RemoveAndShift)> {
  static const MethodInfo* get() {
    static auto* lookup = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "Dictionary`2"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Int32"), ::il2cpp_utils::GetClassFromName("System", "Int32")})->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<UnityEngine::ProBuilder::SharedVertex*> (*)(System::Collections::Generic::Dictionary_2<int, int>*, System::Collections::Generic::List_1<int>*)>(&UnityEngine::ProBuilder::SharedVertex::SortedRemoveAndShift)> {
  static const MethodInfo* get() {
    static auto* lookup = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "Dictionary`2"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("System", "Int32"), ::il2cpp_utils::GetClassFromName("System", "Int32")})->byval_arg;
