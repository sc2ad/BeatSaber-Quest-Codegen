...
namespace UnityEngine::ProBuilder {
  ...
  // [CompilerGeneratedAttribute] Offset: E3A2EC
  ...
  // Writing MetadataGetter for method: InternalUtility::$$c__DisplayClass6_0::$TryParseColor$b__0
  // Il2CppName: <TryParseColor>b__0
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (InternalUtility::$$c__DisplayClass6_0::*)(::Il2CppChar)>(&InternalUtility::$$c__DisplayClass6_0::$TryParseColor$b__0)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(InternalUtility::$$c__DisplayClass6_0*), "<TryParseColor>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<::Il2CppChar>()});
    }
  };
  // Writing MetadataGetter for method: InternalUtility::$$c__DisplayClass6_0::New_ctor
  // Il2CppName: .ctor
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (InternalUtility::$$c__DisplayClass6_0::*)()>(&InternalUtility::$$c__DisplayClass6_0::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(InternalUtility::$$c__DisplayClass6_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (InternalUtility::$$c__DisplayClass6_0::*)()>(&InternalUtility::$$c__DisplayClass6_0::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(InternalUtility::$$c__DisplayClass6_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
