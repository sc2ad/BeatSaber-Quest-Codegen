...
namespace UnityEngine::ProBuilder::MeshOperations {
  ...
  check_size<sizeof(UVEditing::$$c__DisplayClass13_0), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __UnityEngine_ProBuilder_MeshOperations_UVEditing_$$c__DisplayClass13_0SizeCheck;
}
