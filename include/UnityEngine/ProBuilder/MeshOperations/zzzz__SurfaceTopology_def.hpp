...
class UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c;
}
...
class CORDL_TYPE UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c(UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c(UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c& operator=(UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c& operator=(UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c const& o) noexcept = default;
                


// Fields

static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c value) ;

static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c __get___9() ;
...
static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c New_ctor() ;
...
public:
// Declarations
using __c = UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c;
...
NEED_NO_BOX(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__SurfaceTopology____c, "UnityEngine.ProBuilder.MeshOperations", "SurfaceTopology/<>c");
