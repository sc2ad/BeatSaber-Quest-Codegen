...
namespace UnityEngine::ProBuilder::MeshOperations {
  ...
  check_size<sizeof(Triangulation::$$c__DisplayClass7_0), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __UnityEngine_ProBuilder_MeshOperations_Triangulation_$$c__DisplayClass7_0SizeCheck;
}
