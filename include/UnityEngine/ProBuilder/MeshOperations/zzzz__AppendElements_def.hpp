...
class UnityEngine__ProBuilder__MeshOperations__AppendElements____c;
}
...
namespace UnityEngine::ProBuilder::MeshOperations {
class UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0;
}
namespace System::Collections::Generic {
template<typename T>
class IList_1;
...
class CORDL_TYPE UnityEngine__ProBuilder__MeshOperations__AppendElements____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__ProBuilder__MeshOperations__AppendElements____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__AppendElements____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c(UnityEngine__ProBuilder__MeshOperations__AppendElements____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__AppendElements____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c(UnityEngine__ProBuilder__MeshOperations__AppendElements____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__MeshOperations__AppendElements____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c& operator=(UnityEngine__ProBuilder__MeshOperations__AppendElements____c&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c& operator=(UnityEngine__ProBuilder__MeshOperations__AppendElements____c const& o) noexcept = default;
                


// Fields

static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c value) ;

static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c __get___9() ;
...
static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c New_ctor() ;
...
class CORDL_TYPE UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0(UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0(UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0& operator=(UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0&& o) noexcept = default;
  constexpr UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0& operator=(UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0 const& o) noexcept = default;
...
static UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0 New_ctor() ;
...
public:
// Declarations
using __c__DisplayClass17_0 = UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0;

using __c = UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c;
...
NEED_NO_BOX(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c, "UnityEngine.ProBuilder.MeshOperations", "AppendElements/<>c");
NEED_NO_BOX(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ProBuilder::MeshOperations::UnityEngine__ProBuilder__MeshOperations__AppendElements____c__DisplayClass17_0, "UnityEngine.ProBuilder.MeshOperations", "AppendElements/<>c__DisplayClass17_0");
