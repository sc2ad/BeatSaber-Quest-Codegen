...
namespace UnityEngine::ProBuilder::MeshOperations {
class ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c;
}
namespace UnityEngine::ProBuilder::MeshOperations {
class ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0;
}
namespace UnityEngine::ProBuilder::MeshOperations {
class ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0;
}
// Type: ::<>c
namespace UnityEngine::ProBuilder::MeshOperations {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c&& o) noexcept = default;
  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c value) ;

static ::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c() ;
...
class CORDL_TYPE ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0&& o) noexcept = default;
  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0() ;
...
class CORDL_TYPE ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0&& o) noexcept = default;
  constexpr ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0& operator=(____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0() ;
...
public:
// Declarations
using __c__DisplayClass3_0 = ::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0;

using __c__DisplayClass2_0 = ::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0;

using __c = ::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c;
...
NEED_NO_BOX(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c, "UnityEngine.ProBuilder.MeshOperations", "ConnectElements/<>c");
NEED_NO_BOX(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass2_0, "UnityEngine.ProBuilder.MeshOperations", "ConnectElements/<>c__DisplayClass2_0");
NEED_NO_BOX(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ProBuilder::MeshOperations::____UnityEngine__ProBuilder__MeshOperations__ConnectElements____c__DisplayClass3_0, "UnityEngine.ProBuilder.MeshOperations", "ConnectElements/<>c__DisplayClass3_0");
