...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(EdgeLookup::$$c__DisplayClass16_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngine_ProBuilder_EdgeLookup_$$c__DisplayClass16_0SizeCheck;
}
