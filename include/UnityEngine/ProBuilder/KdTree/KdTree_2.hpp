...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  class KdTree_2 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>*/ {
    ...
    ::ArrayW<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*> RadialSearch(::ArrayW<TKey> center, TKey radius, int count) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<::ArrayW<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>, false>(___instance_arg, ___internal__method, center, radius, count);
    }
