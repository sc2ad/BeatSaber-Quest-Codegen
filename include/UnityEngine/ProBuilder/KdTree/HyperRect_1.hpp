...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  struct HyperRect_1/*, public System::ValueType*/ {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<T> minPoint;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<T>) == 0x8);
    // private T[] maxPoint
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<T> maxPoint;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<T>) == 0x8);
    // Creating value type constructor for type: HyperRect_1
    constexpr HyperRect_1(::ArrayWrapper<T> minPoint_ = ::ArrayWrapper<T>(nullptr), ::ArrayWrapper<T> maxPoint_ = ::ArrayWrapper<T>(nullptr)) noexcept : minPoint{minPoint_}, maxPoint{maxPoint_} {}
    ...
    // Offset: 0xFFFFFFFF
    void set_MinPoint(::ArrayWrapper<T> value) {
    ...
    // Offset: 0xFFFFFFFF
    void set_MaxPoint(::ArrayWrapper<T> value) {
    ...
    // Offset: 0xFFFFFFFF
    ::ArrayWrapper<T> GetClosestPoint(::ArrayWrapper<T> toPoint, UnityEngine::ProBuilder::KdTree::ITypeMath_1<T>* math) {
      ...
      return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<T>, false>(*this, ___internal__method, toPoint, math);
    }
