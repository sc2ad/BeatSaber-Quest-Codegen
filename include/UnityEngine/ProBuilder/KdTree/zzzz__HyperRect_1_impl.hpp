...
constexpr UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::HyperRect_1(::ArrayW<T> minPoint, ::ArrayW<T> maxPoint) noexcept : ::bs_hook::ValueTypeWrapper() {this->minPoint = minPoint;
this->maxPoint = maxPoint;
}
constexpr void UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::__set_minPoint(::ArrayW<T> value)  {
::cordl_internals::setInstanceField<::ArrayW<T>, 0x0>(this->__instance, std::forward<::ArrayW<T>>(value));
}
constexpr ::ArrayW<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::__get_minPoint() const {
return ::cordl_internals::getInstanceField<::ArrayW<T>, 0x0>(this->__instance);
}
constexpr void UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::__set_maxPoint(::ArrayW<T> value)  {
::cordl_internals::setInstanceField<::ArrayW<T>, 0x8>(this->__instance, std::forward<::ArrayW<T>>(value));
}
constexpr ::ArrayW<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::__get_maxPoint() const {
return ::cordl_internals::getInstanceField<::ArrayW<T>, 0x8>(this->__instance);
}
 ::ArrayW<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::get_MinPoint()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<T>, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::set_MinPoint(::ArrayW<T> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "set_MinPoint",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 ::ArrayW<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::get_MaxPoint()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "get_MaxPoint",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<T>, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::set_MaxPoint(::ArrayW<T> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "set_MaxPoint",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 UnityEngine::ProBuilder::KdTree::HyperRect_1<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::Infinite(int32_t dimensions, UnityEngine::ProBuilder::KdTree::ITypeMath_1<T> math)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "Infinite",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>, false>(nullptr, ___internal_method, dimensions, math);
 ...
 ::ArrayW<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::GetClosestPoint(::ArrayW<T> toPoint, UnityEngine::ProBuilder::KdTree::ITypeMath_1<T> math)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "GetClosestPoint",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<T>, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, toPoint, math);
 ...
 UnityEngine::ProBuilder::KdTree::HyperRect_1<T> UnityEngine::ProBuilder::KdTree::HyperRect_1<T>::Clone()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ProBuilder::KdTree::HyperRect_1<T>>::get(),
                            "Clone",
                            std::vector<Il2CppClass*>{},
