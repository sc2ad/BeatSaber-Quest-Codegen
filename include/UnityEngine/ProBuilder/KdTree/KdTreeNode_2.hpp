...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  class KdTreeNode_2 : public ::Il2CppObject {
    ...
    UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* get_Item(int compare) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*, false>(this, ___internal__method, compare)));
    }
    ...
    void set_Item(int compare, UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* value) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, compare, value)));
    }
