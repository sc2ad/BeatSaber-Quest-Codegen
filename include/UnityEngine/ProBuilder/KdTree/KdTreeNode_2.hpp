...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  // [DefaultMemberAttribute] Offset: EED354
  ...
  class KdTreeNode_2 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<TKey> Point;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<TKey>) == 0x8);
    // public TValue Value
    // Size: 0xFFFFFFFF
    // Offset: 0x0
    TValue Value;
    ...
    ::ArrayWrapper<TKey>& dyn_Point() {
      ...
      return *reinterpret_cast<::ArrayWrapper<TKey>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
    ...
    static KdTreeNode_2<TKey, TValue>* New_ctor(::ArrayWrapper<TKey> point, TValue value) {
