...
class KdTreeNode_2<float_t,TValue>;
}
...
class CORDL_TYPE KdTreeNode_2<float_t,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
constexpr System::Collections::Generic::List_1<TValue> __get_Duplicates() const;
 ...
 UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> __declspec(property(get=__get_LeftChild, put=__set_LeftChild))  LeftChild;

constexpr void __set_LeftChild(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> value) ;

constexpr UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> __get_LeftChild() const;

 UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> __declspec(property(get=__get_RightChild, put=__set_RightChild))  RightChild;

constexpr void __set_RightChild(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> value) ;

constexpr UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> __get_RightChild() const;


// Properties

 UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> __declspec(property(get=get_Item, put=set_Item))  Item;
...
static UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> New_ctor() ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor() ;

static UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> New_ctor(::ArrayW<float_t> point, TValue value) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(::ArrayW<float_t> point, TValue value) ;

/// @brief Method get_Item addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> get_Item(int32_t compare) ;

/// @brief Method set_Item addr 0x0 size 0xffffffffffffffff virtual false final false
 void set_Item(int32_t compare, UnityEngine::ProBuilder::KdTree::KdTreeNode_2<float_t,TValue> value) ;
...
static UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue> New_ctor() ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor() ;

static UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey,TValue> New_ctor(::ArrayW<TKey> point, TValue value) ;
