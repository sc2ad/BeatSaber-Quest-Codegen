...
static UnityEngine::ProBuilder::KdTree::PriorityQueue_2<TItem,float_t> New_ctor(int32_t capacity, UnityEngine::ProBuilder::KdTree::ITypeMath_1<float_t> priorityMath) ;
...
static UnityEngine::ProBuilder::KdTree::PriorityQueue_2<TItem,TPriority> New_ctor(int32_t capacity, UnityEngine::ProBuilder::KdTree::ITypeMath_1<TPriority> priorityMath) ;
