...
static UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,float_t> New_ctor(int32_t maxCapacity, UnityEngine::ProBuilder::KdTree::ITypeMath_1<float_t> distanceMath) ;
...
static UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<TItem,TDistance> New_ctor(int32_t maxCapacity, UnityEngine::ProBuilder::KdTree::ITypeMath_1<TDistance> distanceMath) ;
