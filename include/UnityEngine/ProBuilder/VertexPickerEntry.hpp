...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(VertexPickerEntry), 16 + sizeof(UnityEngine::Vector3) + ((16 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (16 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __UnityEngine_ProBuilder_VertexPickerEntrySizeCheck;
}
