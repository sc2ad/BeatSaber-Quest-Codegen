...
namespace UnityEngine::ProBuilder {
  ...
  check_size<sizeof(IntVec4), 0 + sizeof(UnityEngine::Vector4) + ((0 + sizeof(UnityEngine::Vector4)) % 8 != 0 ? (8 - (0 + sizeof(UnityEngine::Vector4)) % 8) : 0)> __UnityEngine_ProBuilder_IntVec4SizeCheck;
