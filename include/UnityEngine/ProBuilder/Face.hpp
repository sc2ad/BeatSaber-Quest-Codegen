...
namespace UnityEngine::ProBuilder {
  ...
  class Face : public ::Il2CppObject {
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xF2610C
    ...
    char __padding2[0x4] = {};
    // [FormerlySerializedAsAttribute] Offset: 0xF26158
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [FormerlySerializedAsAttribute] Offset: 0xF261B4
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ProBuilder::Face::*)(::ArrayWrapper<int>)>(&UnityEngine::ProBuilder::Face::set_indexesInternal)> {
  static const MethodInfo* get() {
    static auto* value = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "Int32")), 1)->byval_arg;
