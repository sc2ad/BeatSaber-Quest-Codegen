...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CA52D8
  // [AttributeUsageAttribute] Offset: CA52D8
  class NativePropertyAttribute : public UnityEngine::Bindings::NativeMethodAttribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCA58F8
    // [CompilerGeneratedAttribute] Offset: 0xCA58F8
