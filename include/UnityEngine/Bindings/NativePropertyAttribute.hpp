...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CBA9D4
  // [AttributeUsageAttribute] Offset: CBA9D4
  class NativePropertyAttribute : public UnityEngine::Bindings::NativeMethodAttribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCBAFF4
    // [CompilerGeneratedAttribute] Offset: 0xCBAFF4
