...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CA3E88
  // [AttributeUsageAttribute] Offset: CA3E88
  class NativePropertyAttribute : public UnityEngine::Bindings::NativeMethodAttribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCA44A8
    // [CompilerGeneratedAttribute] Offset: 0xCA44A8
