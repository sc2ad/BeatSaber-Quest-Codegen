...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: CB6420
  // [AttributeUsageAttribute] Offset: CB6420
  class NativePropertyAttribute : public UnityEngine::Bindings::NativeMethodAttribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCB6A40
    // [CompilerGeneratedAttribute] Offset: 0xCB6A40
