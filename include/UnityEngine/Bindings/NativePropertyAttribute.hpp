...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: D8B8F4
  // [AttributeUsageAttribute] Offset: D8B8F4
  class NativePropertyAttribute : public UnityEngine::Bindings::NativeMethodAttribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD8BF50
    // [DebuggerBrowsableAttribute] Offset: 0xD8BF50
