...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CBABD4
  // [VisibleToOtherModulesAttribute] Offset: CBABD4
  class IgnoreAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCBB198
    // [CompilerGeneratedAttribute] Offset: 0xCBB198
