...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: D8BB30
  // [AttributeUsageAttribute] Offset: D8BB30
  class IgnoreAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xD8C0F4
    // [CompilerGeneratedAttribute] Offset: 0xD8C0F4
