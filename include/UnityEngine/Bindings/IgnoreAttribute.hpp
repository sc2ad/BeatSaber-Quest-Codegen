...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CA4088
  // [AttributeUsageAttribute] Offset: CA4088
  class IgnoreAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCA464C
    // [DebuggerBrowsableAttribute] Offset: 0xCA464C
