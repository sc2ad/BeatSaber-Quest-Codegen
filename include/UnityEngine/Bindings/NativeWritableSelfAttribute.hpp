...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: D8B86C
  // [VisibleToOtherModulesAttribute] Offset: D8B86C
  class NativeWritableSelfAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD8BDE8
    // [DebuggerBrowsableAttribute] Offset: 0xD8BDE8
