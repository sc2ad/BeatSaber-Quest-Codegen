...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA5250
  // [VisibleToOtherModulesAttribute] Offset: CA5250
  class NativeWritableSelfAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCA5790
    // [CompilerGeneratedAttribute] Offset: 0xCA5790
