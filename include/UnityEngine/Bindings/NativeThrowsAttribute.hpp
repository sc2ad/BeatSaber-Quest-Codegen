...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CBAB98
  // [VisibleToOtherModulesAttribute] Offset: CBAB98
  class NativeThrowsAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCBB15C
    // [DebuggerBrowsableAttribute] Offset: 0xCBB15C
