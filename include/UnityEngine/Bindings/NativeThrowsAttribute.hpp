...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: D8BAF4
  // [AttributeUsageAttribute] Offset: D8BAF4
  class NativeThrowsAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD8C0B8
    // [DebuggerBrowsableAttribute] Offset: 0xD8C0B8
