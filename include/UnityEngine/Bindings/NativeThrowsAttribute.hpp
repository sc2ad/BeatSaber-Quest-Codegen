...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA404C
  // [VisibleToOtherModulesAttribute] Offset: CA404C
  class NativeThrowsAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCA4610
    // [DebuggerBrowsableAttribute] Offset: 0xCA4610
