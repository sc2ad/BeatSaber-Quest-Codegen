...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA3D7C
  // [VisibleToOtherModulesAttribute] Offset: CA3D7C
  class NativeHeaderAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCA42C8
    // [DebuggerBrowsableAttribute] Offset: 0xCA42C8
