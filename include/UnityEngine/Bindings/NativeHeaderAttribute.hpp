...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: CA51CC
  // [VisibleToOtherModulesAttribute] Offset: CA51CC
  class NativeHeaderAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCA5718
    // [DebuggerBrowsableAttribute] Offset: 0xCA5718
