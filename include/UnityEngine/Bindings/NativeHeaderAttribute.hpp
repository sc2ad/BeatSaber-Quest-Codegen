...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CBA8C8
  // [VisibleToOtherModulesAttribute] Offset: CBA8C8
  class NativeHeaderAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCBAE14
    // [DebuggerBrowsableAttribute] Offset: 0xCBAE14
