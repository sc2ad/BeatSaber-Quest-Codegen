...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CBA910
  // [AttributeUsageAttribute] Offset: CBA910
  class NativeNameAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCBAE50
    // [CompilerGeneratedAttribute] Offset: 0xCBAE50
