...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: CB635C
  // [AttributeUsageAttribute] Offset: CB635C
  class NativeNameAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCB689C
    // [CompilerGeneratedAttribute] Offset: 0xCB689C
