...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: D8B830
  // [VisibleToOtherModulesAttribute] Offset: D8B830
  class NativeNameAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD8BDAC
    // [DebuggerBrowsableAttribute] Offset: 0xD8BDAC
