...
namespace UnityEngine::Bindings {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CBA88C
  // [AttributeUsageAttribute] Offset: CBA88C
  class NativeConditionalAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCBAD9C
    // [CompilerGeneratedAttribute] Offset: 0xCBAD9C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCBADD8
    // [DebuggerBrowsableAttribute] Offset: 0xCBADD8
