...
namespace UnityEngine {
  ...
  check_size<sizeof(ParticleSystem::MinMaxCurve), 28 + sizeof(float) + ((28 + sizeof(float)) % 8 != 0 ? (8 - (28 + sizeof(float)) % 8) : 0)> __UnityEngine_ParticleSystem_MinMaxCurveSizeCheck;
}
