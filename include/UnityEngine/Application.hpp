...
namespace UnityEngine {
  ...
  class Application : public ::CsObject {
    public:
    ...
    static System::Action_1<::CsString*>* _get_deepLinkActivated();
    // Set static field: static private System.Action`1<System.String> deepLinkActivated
    static void _set_deepLinkActivated(System::Action_1<::CsString*>* value);
    ...
    // Offset: 0x12FA16C
    static bool CanStreamedLevelBeLoaded(::CsString* levelName);
    ...
    // Offset: 0x12FAA98
    static void CallLogCallback(::CsString* logString, ::CsString* stackTrace, UnityEngine::LogType type, bool invokedOnMainThread);
    ...
    // Offset: 0x12FBC88
    static void InvokeDeepLinkActivated(::CsString* url);
