...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: DB4D44
  // [NativeHeaderAttribute] Offset: DB4D44
  class CanvasRenderer : public UnityEngine::Component {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xDB4FB8
    // [DebuggerBrowsableAttribute] Offset: 0xDB4FB8
