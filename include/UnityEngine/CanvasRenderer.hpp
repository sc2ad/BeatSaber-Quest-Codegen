...
namespace UnityEngine {
  ...
  // [NativeClassAttribute] Offset: CDB244
  // [NativeHeaderAttribute] Offset: CDB244
  class CanvasRenderer : public UnityEngine::Component {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCDB4B8
    // [DebuggerBrowsableAttribute] Offset: 0xCDB4B8
