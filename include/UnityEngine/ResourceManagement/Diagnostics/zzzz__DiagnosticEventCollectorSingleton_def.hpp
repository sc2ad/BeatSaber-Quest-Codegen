...
namespace UnityEngine::ResourceManagement::Diagnostics {
class ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c;
}
// Type: ::<>c
namespace UnityEngine::ResourceManagement::Diagnostics {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c(____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c(____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c& operator=(____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c&& o) noexcept = default;
  constexpr ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c& operator=(____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c value) ;

static ::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c() ;
...
namespace UnityEngine::ResourceManagement::Diagnostics {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14247), inst: 1026 }), TypeDefinitionIndex(TypeDefinitionIndex(14247))}
...
public:
// Declarations
using __c = ::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c;
...
NEED_NO_BOX(::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::Diagnostics::____UnityEngine__ResourceManagement__Diagnostics__DiagnosticEventCollectorSingleton____c, "UnityEngine.ResourceManagement.Diagnostics", "DiagnosticEventCollectorSingleton/<>c");
