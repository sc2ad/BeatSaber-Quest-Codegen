...
namespace UnityEngine::ResourceManagement::ResourceProviders {
class ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp;
}
namespace UnityEngine::ResourceManagement::ResourceProviders {
class ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0;
}
...
class CORDL_TYPE ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp : public ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<bool> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x90};

virtual ~____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp(void* ptr) noexcept : ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<bool>(ptr) {
}


  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp& operator=(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp&& o) noexcept = default;
  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp& operator=(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp() ;
...
class CORDL_TYPE ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0& operator=(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0&& o) noexcept = default;
  constexpr ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0& operator=(____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0() ;
...
public:
// Declarations
using __c__DisplayClass10_0 = ::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0;

using BaseInitAsyncOp = ::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp;
...
NEED_NO_BOX(::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp, "UnityEngine.ResourceManagement.ResourceProviders", "ResourceProviderBase/BaseInitAsyncOp");
NEED_NO_BOX(::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::ResourceProviders::____UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase____c__DisplayClass10_0, "UnityEngine.ResourceManagement.ResourceProviders", "ResourceProviderBase/<>c__DisplayClass10_0");
