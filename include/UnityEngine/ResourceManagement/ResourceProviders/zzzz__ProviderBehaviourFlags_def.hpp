...
struct CORDL_TYPE ProviderBehaviourFlags : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr ProviderBehaviourFlags(int32_t value__) noexcept;
                    ...
                    constexpr ProviderBehaviourFlags(ProviderBehaviourFlags const&) = default;
                    constexpr ProviderBehaviourFlags(ProviderBehaviourFlags&&) = default;
                    constexpr ProviderBehaviourFlags& operator=(ProviderBehaviourFlags const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ProviderBehaviourFlags& operator=(ProviderBehaviourFlags&& o) noexcept {
...
constexpr explicit ProviderBehaviourFlags(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __ProviderBehaviourFlags_Unwrapped : int32_t {
__None = 0,
__CanProvideWithFailedDependencies = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator __ProviderBehaviourFlags_Unwrapped () const noexcept {
return std::bit_cast<__ProviderBehaviourFlags_Unwrapped>(__instance);
}
...
/// @brief Field CanProvideWithFailedDependencies offset 0
