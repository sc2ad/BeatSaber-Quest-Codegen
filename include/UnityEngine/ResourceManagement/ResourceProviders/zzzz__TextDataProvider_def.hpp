...
class CORDL_TYPE UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x48};

virtual ~UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp", modifiers: " const&", def_value: None }]
constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp(UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp", modifiers: "&&", def_value: None }]
constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp(UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp& operator=(UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp&& o) noexcept = default;
  constexpr UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp& operator=(UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp const& o) noexcept = default;
...
public:
// Declarations
using InternalOp = UnityEngine::ResourceManagement::ResourceProviders::UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp;
...
NEED_NO_BOX(UnityEngine::ResourceManagement::ResourceProviders::UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::ResourceManagement::ResourceProviders::UnityEngine__ResourceManagement__ResourceProviders__TextDataProvider__InternalOp, "UnityEngine.ResourceManagement.ResourceProviders", "TextDataProvider/InternalOp");
