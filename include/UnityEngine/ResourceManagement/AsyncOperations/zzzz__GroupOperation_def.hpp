...
namespace UnityEngine::ResourceManagement::AsyncOperations {
struct ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings;
}
namespace UnityEngine::ResourceManagement::AsyncOperations {
...
struct CORDL_TYPE ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings(int32_t value__) noexcept;


                    constexpr ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings(____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings const&) = default;
                    constexpr ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings(____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings&&) = default;
                    constexpr ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings& operator=(____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings& operator=(____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings&& o) noexcept {
...
constexpr explicit ____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings_Unwrapped : int32_t {
__None = 0,
...
constexpr operator ______UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings_Unwrapped>(__instance);
}
...
static ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings const None;

/// @brief Field ReleaseDependenciesOnFailure offset 0
static ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings const ReleaseDependenciesOnFailure;

/// @brief Field AllowFailedDependencies offset 0
static ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings const AllowFailedDependencies;
...
namespace UnityEngine::ResourceManagement::AsyncOperations {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14315)), TypeDefinitionIndex(TypeDefinitionIndex(3820)), TypeDefinitionIndex(TypeDefinitionIndex(14313)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3820), inst: 265 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 767 })}
...
public:
// Declarations
using GroupOperationSettings = ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings;
...
constexpr int32_t __get_m_LoadedCount() const;
 ...
 ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings __declspec(property(get=__get_m_Settings, put=__set_m_Settings))  m_Settings;

constexpr void __set_m_Settings(::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings value) ;

constexpr ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings __get_m_Settings() const;
...
/// @brief Method Init addr 0x2a47374 size 0x98 virtual false final false
 void Init(::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle> operations, ::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings settings) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::ResourceManagement::AsyncOperations::____UnityEngine__ResourceManagement__AsyncOperations__GroupOperation__GroupOperationSettings, "UnityEngine.ResourceManagement.AsyncOperations", "GroupOperation/GroupOperationSettings");
