...
namespace UnityEngine::ResourceManagement::AsyncOperations {
  ...
  struct AsyncOperationHandle_1/*, public System::ValueType, public System::Collections::IEnumerator, public System::IEquatable_1<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*/ {
    ...
    UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject>* _get_m_InternalOp() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_get_m_InternalOp");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject>*>(___internal__instance, "m_InternalOp"));
    }
    // Autogenerated instance field setter
    // Set instance field: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationBase`1<TObject> m_InternalOp
    void _set_m_InternalOp(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_set_m_InternalOp");
      static auto ___internal__instance = *this;
    ...
    int _get_m_Version() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_get_m_Version");
      static auto ___internal__instance = *this;
    ...
    void _set_m_Version(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_set_m_Version");
      static auto ___internal__instance = *this;
    ...
    ::Il2CppString* _get_m_LocationName() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_get_m_LocationName");
      static auto ___internal__instance = *this;
    ...
    void _set_m_LocationName(::Il2CppString* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1::_set_m_LocationName");
      static auto ___internal__instance = *this;
