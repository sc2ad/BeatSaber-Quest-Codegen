...
template<::cordl_internals::il2cpp_reference_type TObject>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 765 }), TypeDefinitionIndex(TypeDefinitionIndex(14321)), TypeDefinitionIndex(TypeDefinitionIndex(14313))}
