...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 2 })
...
virtual ~AsyncOperationBase_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "AsyncOperationBase_1", modifiers: " const&", def_value: None }]
constexpr AsyncOperationBase_1(AsyncOperationBase_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "AsyncOperationBase_1", modifiers: "&&", def_value: None }]
constexpr AsyncOperationBase_1(AsyncOperationBase_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit AsyncOperationBase_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr AsyncOperationBase_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr AsyncOperationBase_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr AsyncOperationBase_1& operator=(AsyncOperationBase_1&& o) noexcept = default;
  constexpr AsyncOperationBase_1& operator=(AsyncOperationBase_1 const& o) noexcept = default;
                


// Fields

 TObject __declspec(property(get=__get__Result_k__BackingField, put=__set__Result_k__BackingField))  _Result_k__BackingField;

constexpr void __set__Result_k__BackingField(TObject value) ;

constexpr TObject __get__Result_k__BackingField() const;
...
constexpr bool __get_HasExecuted() const;
...
// Properties
 ...
 TObject __declspec(property(get=get_Result, put=set_Result))  Result;

 int32_t __declspec(property(get=get_Version))  Version;

 bool __declspec(property(get=get_CompletedEventHasListeners))  CompletedEventHasListeners;
 ...
 int32_t __declspec(property(get=UnityEngine_ResourceManagement_AsyncOperations_IAsyncOperation_get_ReferenceCount))  UnityEngine_ResourceManagement_AsyncOperations_IAsyncOperation_ReferenceCount;
...
/// @brief Method UnityEngine.ResourceManagement.AsyncOperations.IAsyncOperation.get_ReferenceCount addr 0x0 size 0xffffffffffffffff virtual true final true
 int32_t UnityEngine_ResourceManagement_AsyncOperations_IAsyncOperation_get_ReferenceCount() ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14313))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 99 })
// CS Name: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationBase`1
...
// Fields
 ...
 bool __declspec(property(get=__get__Result_k__BackingField, put=__set__Result_k__BackingField))  _Result_k__BackingField;

constexpr void __set__Result_k__BackingField(bool value) ;

constexpr bool __get__Result_k__BackingField() const;
...
// Properties
 ...
 bool __declspec(property(get=get_Result, put=set_Result))  Result;
...
/// @brief Method Complete addr 0x0 size 0xffffffffffffffff virtual false final false
 void Complete(bool result, bool success, ::StringW errorMsg) ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14313))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 830 })
// CS Name: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationBase`1
...
// Fields
 ...
 int64_t __declspec(property(get=__get__Result_k__BackingField, put=__set__Result_k__BackingField))  _Result_k__BackingField;

constexpr void __set__Result_k__BackingField(int64_t value) ;

constexpr int64_t __get__Result_k__BackingField() const;
...
// Properties
 ...
 int64_t __declspec(property(get=get_Result, put=set_Result))  Result;
...
/// @brief Method Complete addr 0x0 size 0xffffffffffffffff virtual false final false
 void Complete(int64_t result, bool success, ::StringW errorMsg) ;
