...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14313)), TypeDefinitionIndex(TypeDefinitionIndex(14230)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 764 })}
...
static UnityEngine::ResourceManagement::ChainOperation_2<UnityEngine::ResourceManagement::ResourceProviders::SceneInstance,UnityEngine::ResourceManagement::ResourceProviders::SceneInstance> New_ctor() ;
...
template<::cordl_internals::il2cpp_reference_type TObject,::cordl_internals::il2cpp_reference_type TObjectDependency>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14230)), TypeDefinitionIndex(TypeDefinitionIndex(14313)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 764 })}
...
static UnityEngine::ResourceManagement::ChainOperation_2<TObject,TObjectDependency> New_ctor() ;
