...
namespace UnityEngine::ResourceManagement::Util {
  ...
  class GlobalLinkedListNodeCache_1 : public ::Il2CppObject {
    ...
    static System::Collections::Generic::LinkedListNode_1<T>* Acquire(T val) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::LinkedListNode_1<T>*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, val)));
    }
