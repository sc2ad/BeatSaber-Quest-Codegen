...
constexpr  UnityEngine::ResourceManagement::Util::IOperationCacheKey::operator System::IEquatable_1<UnityEngine::ResourceManagement::Util::IOperationCacheKey>() const noexcept {
