...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  check_size<sizeof(SpotLight), 85 + sizeof(UnityEngine::Experimental::GlobalIllumination::AngularFalloffType) + 8 - (85 + sizeof(UnityEngine::Experimental::GlobalIllumination::AngularFalloffType)) % 8> __UnityEngine_Experimental_GlobalIllumination_SpotLightSizeCheck;
}
