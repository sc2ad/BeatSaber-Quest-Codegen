...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  check_size<sizeof(AngularFalloffType), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __UnityEngine_Experimental_GlobalIllumination_AngularFalloffTypeSizeCheck;
}
