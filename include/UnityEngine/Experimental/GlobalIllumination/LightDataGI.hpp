...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  check_size<sizeof(LightDataGI), 87 + sizeof(UnityEngine::Experimental::GlobalIllumination::FalloffType) + ((87 + sizeof(UnityEngine::Experimental::GlobalIllumination::FalloffType)) % 8 != 0 ? (8 - (87 + sizeof(UnityEngine::Experimental::GlobalIllumination::FalloffType)) % 8) : 0)> __UnityEngine_Experimental_GlobalIllumination_LightDataGISizeCheck;
}
