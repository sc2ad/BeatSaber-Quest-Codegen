...
namespace UnityEngine::Experimental::GlobalIllumination {
  ...
  check_size<sizeof(LinearColor), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __UnityEngine_Experimental_GlobalIllumination_LinearColorSizeCheck;
}
