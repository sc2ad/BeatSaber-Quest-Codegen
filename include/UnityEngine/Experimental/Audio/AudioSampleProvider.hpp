...
namespace UnityEngine::Experimental::Audio {
  ...
  // [StaticAccessorAttribute] Offset: 10B1FA4
  // [NativeTypeAttribute] Offset: 10B1FA4
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10B2174
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10B21B0
