...
namespace UnityEngine::Experimental::Audio {
  ...
  // [StaticAccessorAttribute] Offset: DDBE4C
  // [NativeTypeAttribute] Offset: DDBE4C
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDDC01C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDDC058
