...
namespace UnityEngine::Experimental::Audio {
  ...
  // [NativeTypeAttribute] Offset: DA9C64
  // [StaticAccessorAttribute] Offset: DA9C64
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDA9E30
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDA9E6C
