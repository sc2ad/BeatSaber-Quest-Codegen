...
namespace UnityEngine::Experimental::Audio {
  ...
  // [StaticAccessorAttribute] Offset: 10BB73C
  // [NativeTypeAttribute] Offset: 10BB73C
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10BB90C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10BB948
