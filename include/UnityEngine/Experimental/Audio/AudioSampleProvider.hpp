...
namespace UnityEngine::Experimental::Audio {
  ...
  // [StaticAccessorAttribute] Offset: 10B9D14
  // [NativeTypeAttribute] Offset: 10B9D14
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10B9EE4
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10B9F20
