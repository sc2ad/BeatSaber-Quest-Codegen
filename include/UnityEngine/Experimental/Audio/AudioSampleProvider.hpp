...
namespace UnityEngine::Experimental::Audio {
  ...
  // [StaticAccessorAttribute] Offset: 10C0904
  // [NativeTypeAttribute] Offset: 10C0904
  class AudioSampleProvider : public ::Il2CppObject {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10C0AD4
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10C0B10
