...
namespace UnityEngine::Experimental::Rendering {
  ...
  check_size<sizeof(ScriptableRuntimeReflectionSystemWrapper), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngine_Experimental_Rendering_ScriptableRuntimeReflectionSystemWrapperSizeCheck;
}
