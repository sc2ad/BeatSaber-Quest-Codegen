...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem (UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::*)()>(&UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::get_implementation)> {
  ...
  constexpr static std::size_t addrs = 0x2b7b45c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::*)(UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem)>(&UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::set_implementation)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2b7b464;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::*)(ByRef<bool>)>(&UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes)> {
  ...
  constexpr static std::size_t addrs = 0x2b7b46c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::*)()>(&UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2b7b454;
...
::cordl_internals::setInstanceField<UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem>(value));
}
constexpr UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::__get__implementation_k__BackingField() const {
return ::cordl_internals::getInstanceField<UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Experimental::Rendering::IScriptableRuntimeReflectionSystem, false>(const_cast<void*>(instance), ___internal_method);
}
