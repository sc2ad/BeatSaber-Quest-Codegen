...
namespace UnityEngine {
class ____UnityEngine__GUISkin__SkinChangedDelegate;
}
...
class CORDL_TYPE ____UnityEngine__GUISkin__SkinChangedDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__GUISkin__SkinChangedDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUISkin__SkinChangedDelegate", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__GUISkin__SkinChangedDelegate(____UnityEngine__GUISkin__SkinChangedDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUISkin__SkinChangedDelegate", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__GUISkin__SkinChangedDelegate(____UnityEngine__GUISkin__SkinChangedDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__GUISkin__SkinChangedDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__GUISkin__SkinChangedDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__GUISkin__SkinChangedDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__GUISkin__SkinChangedDelegate& operator=(____UnityEngine__GUISkin__SkinChangedDelegate&& o) noexcept = default;
  constexpr ____UnityEngine__GUISkin__SkinChangedDelegate& operator=(____UnityEngine__GUISkin__SkinChangedDelegate const& o) noexcept = default;
...
explicit ____UnityEngine__GUISkin__SkinChangedDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using SkinChangedDelegate = ::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate;
...
static ::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate __declspec(property(get=__get_m_SkinChanged, put=__set_m_SkinChanged))  m_SkinChanged;

static void __set_m_SkinChanged(::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate value) ;

static ::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate __get_m_SkinChanged() ;
...
NEED_NO_BOX(::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__GUISkin__SkinChangedDelegate, "UnityEngine", "GUISkin/SkinChangedDelegate");
