...
namespace UnityEngine::UI {
class ____UnityEngine__UI__StencilMaterial__MatEntry;
}
// Type: ::MatEntry
namespace UnityEngine::UI {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__UI__StencilMaterial__MatEntry : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____UnityEngine__UI__StencilMaterial__MatEntry() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__StencilMaterial__MatEntry", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UI__StencilMaterial__MatEntry(____UnityEngine__UI__StencilMaterial__MatEntry const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__StencilMaterial__MatEntry", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UI__StencilMaterial__MatEntry(____UnityEngine__UI__StencilMaterial__MatEntry&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UI__StencilMaterial__MatEntry(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UI__StencilMaterial__MatEntry& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UI__StencilMaterial__MatEntry& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UI__StencilMaterial__MatEntry& operator=(____UnityEngine__UI__StencilMaterial__MatEntry&& o) noexcept = default;
  constexpr ____UnityEngine__UI__StencilMaterial__MatEntry& operator=(____UnityEngine__UI__StencilMaterial__MatEntry const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UI__StencilMaterial__MatEntry() ;
...
public:
// Declarations
using MatEntry = ::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry;
...
static ::System::Collections::Generic::List_1<::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry> __declspec(property(get=__get_m_List, put=__set_m_List))  m_List;

static void __set_m_List(::System::Collections::Generic::List_1<::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry> value) ;

static ::System::Collections::Generic::List_1<::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry> __get_m_List() ;
...
NEED_NO_BOX(::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__StencilMaterial__MatEntry, "UnityEngine.UI", "StencilMaterial/MatEntry");
