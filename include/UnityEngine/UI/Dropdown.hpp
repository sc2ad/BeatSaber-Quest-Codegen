...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CEE830
  // [RequireComponent] Offset: CEE830
  class Dropdown : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::ICancelHandler*/ {
    ...
    // [SpaceAttribute] Offset: 0xCEFD20
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::UI::Image*) == 0x8);
    // [SpaceAttribute] Offset: 0xCEFD68
    ...
    char __padding5[0x4] = {};
    // [SpaceAttribute] Offset: 0xCEFDA0
    ...
    // [SpaceAttribute] Offset: 0xCEFDD8
