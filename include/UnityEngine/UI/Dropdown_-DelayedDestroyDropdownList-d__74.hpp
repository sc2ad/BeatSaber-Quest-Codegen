...
namespace UnityEngine::UI {
  ...
  // [CompilerGeneratedAttribute] Offset: DC5E2C
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::*)(int)>(&UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::*)(int)>(&UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Dropdown::$DelayedDestroyDropdownList$d__74*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
