...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::Graphic (UnityEngine::UI::BaseMeshEffect::*)()>(&UnityEngine::UI::BaseMeshEffect::get_graphic)> {
  ...
  constexpr static std::size_t addrs = 0x2c17360;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::BaseMeshEffect::*)()>(&UnityEngine::UI::BaseMeshEffect::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x2c173f4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(UnityEngine::UI::BaseMeshEffect),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::BaseMeshEffect>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::BaseMeshEffect::*)()>(&UnityEngine::UI::BaseMeshEffect::OnDisable)> {
  ...
  constexpr static std::size_t addrs = 0x2c1749c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::BaseMeshEffect::*)()>(&UnityEngine::UI::BaseMeshEffect::OnDidApplyAnimationProperties)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x2c17538;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::BaseMeshEffect::*)(UnityEngine::Mesh)>(&UnityEngine::UI::BaseMeshEffect::ModifyMesh)> {
  ...
  constexpr static std::size_t addrs = 0x2c175d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::BaseMeshEffect::*)()>(&UnityEngine::UI::BaseMeshEffect::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2c1777c;
...
constexpr  UnityEngine::UI::BaseMeshEffect::operator UnityEngine::UI::IMeshModifier() const noexcept {
return UnityEngine::UI::IMeshModifier(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void UnityEngine::UI::BaseMeshEffect::__set_m_Graphic(UnityEngine::UI::Graphic value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::Graphic, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UI::Graphic>(value));
}
constexpr UnityEngine::UI::Graphic UnityEngine::UI::BaseMeshEffect::__get_m_Graphic() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::Graphic, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
