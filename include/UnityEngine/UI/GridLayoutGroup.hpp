...
namespace UnityEngine::UI {
  ...
  class GridLayoutGroup : public UnityEngine::UI::LayoutGroup {
    ...
    check_size<sizeof(GridLayoutGroup::Corner), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_UI_GridLayoutGroup_CornerSizeCheck;
    ...
    check_size<sizeof(GridLayoutGroup::Axis), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_UI_GridLayoutGroup_AxisSizeCheck;
    ...
    check_size<sizeof(GridLayoutGroup::Constraint), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_UI_GridLayoutGroup_ConstraintSizeCheck;
  ...
  check_size<sizeof(GridLayoutGroup), 116 + sizeof(int) + 8 - (116 + sizeof(int)) % 8> __UnityEngine_UI_GridLayoutGroupSizeCheck;
}
