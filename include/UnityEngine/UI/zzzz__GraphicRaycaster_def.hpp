...
namespace UnityEngine::UI {
struct ____UnityEngine__UI__GraphicRaycaster__BlockingObjects;
}
namespace UnityEngine::UI {
class GraphicRaycaster;
}
namespace UnityEngine::UI {
class ____UnityEngine__UI__GraphicRaycaster____c;
}
...
struct CORDL_TYPE ____UnityEngine__UI__GraphicRaycaster__BlockingObjects : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UI__GraphicRaycaster__BlockingObjects(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UI__GraphicRaycaster__BlockingObjects(____UnityEngine__UI__GraphicRaycaster__BlockingObjects const&) = default;
                    constexpr ____UnityEngine__UI__GraphicRaycaster__BlockingObjects(____UnityEngine__UI__GraphicRaycaster__BlockingObjects&&) = default;
                    constexpr ____UnityEngine__UI__GraphicRaycaster__BlockingObjects& operator=(____UnityEngine__UI__GraphicRaycaster__BlockingObjects const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UI__GraphicRaycaster__BlockingObjects& operator=(____UnityEngine__UI__GraphicRaycaster__BlockingObjects&& o) noexcept {
...
constexpr explicit ____UnityEngine__UI__GraphicRaycaster__BlockingObjects(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UI__GraphicRaycaster__BlockingObjects_Unwrapped : int32_t {
__None = 0,
__TwoD = 1,
__ThreeD = 2,
__All = 3,
...
constexpr operator ______UnityEngine__UI__GraphicRaycaster__BlockingObjects_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UI__GraphicRaycaster__BlockingObjects_Unwrapped>(__instance);
}
...
static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects const None;

/// @brief Field TwoD offset 0
static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects const TwoD;

/// @brief Field ThreeD offset 0
static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects const ThreeD;

/// @brief Field All offset 0
static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects const All;
...
class CORDL_TYPE ____UnityEngine__UI__GraphicRaycaster____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__UI__GraphicRaycaster____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__GraphicRaycaster____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UI__GraphicRaycaster____c(____UnityEngine__UI__GraphicRaycaster____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__GraphicRaycaster____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UI__GraphicRaycaster____c(____UnityEngine__UI__GraphicRaycaster____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UI__GraphicRaycaster____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UI__GraphicRaycaster____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UI__GraphicRaycaster____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UI__GraphicRaycaster____c& operator=(____UnityEngine__UI__GraphicRaycaster____c&& o) noexcept = default;
  constexpr ____UnityEngine__UI__GraphicRaycaster____c& operator=(____UnityEngine__UI__GraphicRaycaster____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c value) ;

static ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__UI__GraphicRaycaster____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c;

using BlockingObjects = ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects;
...
constexpr bool __get_m_IgnoreReversedGraphics() const;
 ...
 ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects __declspec(property(get=__get_m_BlockingObjects, put=__set_m_BlockingObjects))  m_BlockingObjects;

constexpr void __set_m_BlockingObjects(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects value) ;

constexpr ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects __get_m_BlockingObjects() const;
...
// Properties
 ...
 ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects __declspec(property(get=get_blockingObjects, put=set_blockingObjects))  blockingObjects;
...
/// @brief Method get_blockingObjects addr 0x2be6264 size 0x8 virtual false final false
 ::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects get_blockingObjects() ;

/// @brief Method set_blockingObjects addr 0x2be626c size 0x8 virtual false final false
 void set_blockingObjects(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster__BlockingObjects, "UnityEngine.UI", "GraphicRaycaster/BlockingObjects");
...
NEED_NO_BOX(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__GraphicRaycaster____c, "UnityEngine.UI", "GraphicRaycaster/<>c");
