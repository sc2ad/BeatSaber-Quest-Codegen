...
namespace UnityEngine::UI {
  ...
  class ObjectPool_1 : public ::Il2CppObject {
    ...
    System::Collections::Generic::Stack_1<T>* _get_m_Stack() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_get_m_Stack");
    ...
    void _set_m_Stack(System::Collections::Generic::Stack_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_set_m_Stack");
      static auto ___internal__instance = this;
    ...
    UnityEngine::Events::UnityAction_1<T>* _get_m_ActionOnGet() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_get_m_ActionOnGet");
      static auto ___internal__instance = this;
    ...
    void _set_m_ActionOnGet(UnityEngine::Events::UnityAction_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_set_m_ActionOnGet");
      static auto ___internal__instance = this;
    ...
    UnityEngine::Events::UnityAction_1<T>* _get_m_ActionOnRelease() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_get_m_ActionOnRelease");
      static auto ___internal__instance = this;
    ...
    void _set_m_ActionOnRelease(UnityEngine::Events::UnityAction_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_set_m_ActionOnRelease");
      static auto ___internal__instance = this;
    ...
    int _get_$countAll$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_get_$countAll$k__BackingField");
      static auto ___internal__instance = this;
    ...
    void _set_$countAll$k__BackingField(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::UI::ObjectPool_1::_set_$countAll$k__BackingField");
      static auto ___internal__instance = this;
