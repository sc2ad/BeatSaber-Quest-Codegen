...
namespace UnityEngine::UI {
  ...
  class Toggle : public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::UI::ICanvasElement, public UnityEngine::UI::Selectable {
    public:
