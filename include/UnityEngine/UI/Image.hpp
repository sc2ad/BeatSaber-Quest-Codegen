...
namespace UnityEngine::UI {
  ...
  class Image : public UnityEngine::UI::MaskableGraphic/*, public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::UI::ILayoutElement, public UnityEngine::ICanvasRaycastFilter*/ {
    ...
    check_size<sizeof(Image::Type), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_UI_Image_TypeSizeCheck;
    ...
    check_size<sizeof(Image::FillMethod), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __UnityEngine_UI_Image_FillMethodSizeCheck;
  ...
  check_size<sizeof(Image), 244 + sizeof(float) + 8 - (244 + sizeof(float)) % 8> __UnityEngine_UI_ImageSizeCheck;
}
