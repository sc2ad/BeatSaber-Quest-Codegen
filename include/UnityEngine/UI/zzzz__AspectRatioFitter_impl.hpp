...
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::UnityEngine__UI__AspectRatioFitter__AspectMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode  UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::None{0};
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode  UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::WidthControlsHeight{1};
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode  UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::HeightControlsWidth{2};
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode  UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::FitInParent{3};
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode  UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode::EnvelopeParent{4};
//  Writing Method size for method: UnityEngine::UI::AspectRatioFitter.get_aspectMode
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode (UnityEngine::UI::AspectRatioFitter::*)()>(&UnityEngine::UI::AspectRatioFitter::get_aspectMode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::AspectRatioFitter::*)(UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode)>(&UnityEngine::UI::AspectRatioFitter::set_aspectMode)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_aspectMode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void UnityEngine::UI::AspectRatioFitter::__set_m_AspectMode(UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode>(value));
}
constexpr UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode UnityEngine::UI::AspectRatioFitter::__get_m_AspectMode() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<UnityEngine::DrivenRectTransformTracker, 0x2a>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode UnityEngine::UI::AspectRatioFitter::get_aspectMode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::AspectRatioFitter>::get(),
                            "get_aspectMode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode, false>(const_cast<void*>(instance), ___internal_method);
}
 void UnityEngine::UI::AspectRatioFitter::set_aspectMode(UnityEngine::UI::UnityEngine__UI__AspectRatioFitter__AspectMode value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::AspectRatioFitter>::get(),
                            "set_aspectMode",
                            std::vector<Il2CppClass*>{},
...
UnityEngine::UI::AspectRatioFitter o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::UI::AspectRatioFitter>())};
return o;
}
