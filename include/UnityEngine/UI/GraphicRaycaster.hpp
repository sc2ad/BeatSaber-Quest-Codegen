...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 10C744C
  // [RequireComponent] Offset: 10C744C
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x10C8B6C
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x10C8BB8
