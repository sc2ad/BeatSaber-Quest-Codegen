...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 1090F1C
  // [RequireComponent] Offset: 1090F1C
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x109263C
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x1092688
