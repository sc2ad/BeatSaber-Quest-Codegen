...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 10BCF14
  // [RequireComponent] Offset: 10BCF14
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x10BE634
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x10BE680
