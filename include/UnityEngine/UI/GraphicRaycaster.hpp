...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 10BEB94
  // [RequireComponent] Offset: 10BEB94
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x10C12B4
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x10C1300
