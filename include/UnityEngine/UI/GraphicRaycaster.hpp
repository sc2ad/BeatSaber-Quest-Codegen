...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: EAA68C
  // [RequireComponent] Offset: EAA68C
  class GraphicRaycaster : public UnityEngine::EventSystems::BaseRaycaster {
    ...
    // Type namespace: UnityEngine.UI
    namespace UnityEngine::UI {
      // Forward declaring type: BlockingObjects
      struct BlockingObjects;
    }
    #include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
    DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::GraphicRaycaster::BlockingObjects, "UnityEngine.UI", "GraphicRaycaster/BlockingObjects");
    ...
    protected:
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0xEABDAC
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0xEABDF8
