...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CD937C
  // [RequireComponent] Offset: CD937C
  class GraphicRaycaster : public UnityEngine::EventSystems::BaseRaycaster {
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xCDAA9C
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0xCDAAE8
