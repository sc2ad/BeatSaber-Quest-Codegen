...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: D7CB34
  // [RequireComponent] Offset: D7CB34
  class GraphicRaycaster : public UnityEngine::EventSystems::BaseRaycaster {
    ...
    static GraphicRaycaster* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::UI").WithContext("GraphicRaycaster").WithContext(".ctor");
