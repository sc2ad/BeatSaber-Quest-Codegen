...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: 10BDC94
  // [RequireComponent] Offset: 10BDC94
  class GraphicRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x10BF3B4
    ...
    char __padding0[0x3] = {};
    // [FormerlySerializedAsAttribute] Offset: 0x10BF400
