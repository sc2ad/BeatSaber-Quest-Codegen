...
namespace UnityEngine::UI {
  ...
  class Scrollbar : public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IInitializePotentialDragHandler, public UnityEngine::UI::ICanvasElement, public UnityEngine::UI::Selectable {
    public:
