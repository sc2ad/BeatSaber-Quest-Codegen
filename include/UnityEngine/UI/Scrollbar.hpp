...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CD86F4
  // [ExecuteAlways] Offset: CD86F4
  // [RequireComponent] Offset: CD86F4
  class Scrollbar : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IInitializePotentialDragHandler, public UnityEngine::UI::ICanvasElement*/ {
    ...
    // [RangeAttribute] Offset: 0xCDA474
    ...
    // [RangeAttribute] Offset: 0xCDA4B4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xCDA4F4
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SpaceAttribute] Offset: 0xCDA534
