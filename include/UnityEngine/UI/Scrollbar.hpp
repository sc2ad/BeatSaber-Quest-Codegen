...
namespace UnityEngine::UI {
  ...
  class Scrollbar : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IInitializePotentialDragHandler, public UnityEngine::UI::ICanvasElement*/ {
    ...
    check_size<sizeof(Scrollbar::Direction), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_Scrollbar_DirectionSizeCheck;
  ...
  check_size<sizeof(Scrollbar), 305 + sizeof(bool) + ((305 + sizeof(bool)) % 8 != 0 ? (8 - (305 + sizeof(bool)) % 8) : 0)> __UnityEngine_UI_ScrollbarSizeCheck;
}
