...
namespace UnityEngine::UI {
  ...
  class CanvasScaler : public UnityEngine::EventSystems::UIBehaviour {
    ...
    check_size<sizeof(CanvasScaler::ScaleMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_CanvasScaler_ScaleModeSizeCheck;
    ...
    check_size<sizeof(CanvasScaler::ScreenMatchMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_CanvasScaler_ScreenMatchModeSizeCheck;
    ...
    check_size<sizeof(CanvasScaler::Unit), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_CanvasScaler_UnitSizeCheck;
  ...
  check_size<sizeof(CanvasScaler), 84 + sizeof(float) + ((84 + sizeof(float)) % 8 != 0 ? (8 - (84 + sizeof(float)) % 8) : 0)> __UnityEngine_UI_CanvasScalerSizeCheck;
}
