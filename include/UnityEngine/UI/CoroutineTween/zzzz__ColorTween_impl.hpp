...
constexpr void UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode  UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode::All{0};
constexpr UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode  UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode::RGB{1};
constexpr UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode  UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode::Alpha{2};
//  Writing Method size for method: UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback::*)()>(&UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode (UnityEngine::UI::CoroutineTween::ColorTween::*)()>(&UnityEngine::UI::CoroutineTween::ColorTween::get_tweenMode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::CoroutineTween::ColorTween::*)(UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode)>(&UnityEngine::UI::CoroutineTween::ColorTween::set_tweenMode)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_tweenMode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void UnityEngine::UI::CoroutineTween::ColorTween::__set_m_Target(UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback, 0x0>(this->__instance, std::forward<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback>(value));
}
constexpr UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback UnityEngine::UI::CoroutineTween::ColorTween::__get_m_Target() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenCallback, 0x0>(this->__instance);
}
...
constexpr void UnityEngine::UI::CoroutineTween::ColorTween::__set_m_TweenMode(UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode, 0x28>(this->__instance, std::forward<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode>(value));
}
constexpr UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode UnityEngine::UI::CoroutineTween::ColorTween::__get_m_TweenMode() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode, 0x28>(this->__instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, value);
 ...
 UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode UnityEngine::UI::CoroutineTween::ColorTween::get_tweenMode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::CoroutineTween::ColorTween>::get(),
                            "get_tweenMode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
 void UnityEngine::UI::CoroutineTween::ColorTween::set_tweenMode(UnityEngine::UI::CoroutineTween::UnityEngine__UI__CoroutineTween__ColorTween__ColorTweenMode value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::CoroutineTween::ColorTween>::get(),
                            "set_tweenMode",
                            std::vector<Il2CppClass*>{},
