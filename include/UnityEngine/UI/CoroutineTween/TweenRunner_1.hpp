...
namespace UnityEngine::UI::CoroutineTween {
  ...
  class TweenRunner_1 : public ::Il2CppObject {
    ...
    class $Start$d__2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
      public:
    ...
    // Could not write size check! Type: UnityEngine.UI.CoroutineTween.TweenRunner`1/<Start>d__2 is generic!
  ...
  // Could not write size check! Type: UnityEngine.UI.CoroutineTween.TweenRunner`1 is generic!
}
