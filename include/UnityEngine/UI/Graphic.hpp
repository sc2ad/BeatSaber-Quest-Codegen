...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: CEE8BC
  // [RequireComponent] Offset: CEE8BC
  // [RequireComponent] Offset: CEE8BC
  // [ExecuteAlways] Offset: CEE8BC
  class Graphic : public UnityEngine::EventSystems::UIBehaviour/*, public UnityEngine::UI::ICanvasElement*/ {
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xCF000C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCF0078
