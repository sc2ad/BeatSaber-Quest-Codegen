...
namespace UnityEngine::UI {
  ...
  // [DisallowMultipleComponent] Offset: CEB460
  // [RequireComponent] Offset: CEB460
  // [RequireComponent] Offset: CEB460
  // [ExecuteAlways] Offset: CEB460
  class Graphic : public UnityEngine::EventSystems::UIBehaviour/*, public UnityEngine::UI::ICanvasElement*/ {
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xCECBB0
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCECC1C
