...
namespace UnityEngine::UI {
class ____UnityEngine__UI__LayoutUtility____c;
}
// Type: ::<>c
namespace UnityEngine::UI {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__UI__LayoutUtility____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__UI__LayoutUtility____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__LayoutUtility____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UI__LayoutUtility____c(____UnityEngine__UI__LayoutUtility____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__LayoutUtility____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UI__LayoutUtility____c(____UnityEngine__UI__LayoutUtility____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UI__LayoutUtility____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__UI__LayoutUtility____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UI__LayoutUtility____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UI__LayoutUtility____c& operator=(____UnityEngine__UI__LayoutUtility____c&& o) noexcept = default;
  constexpr ____UnityEngine__UI__LayoutUtility____c& operator=(____UnityEngine__UI__LayoutUtility____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c value) ;

static ::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__UI__LayoutUtility____c() ;
...
public:
// Declarations
using __c = ::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c;
...
NEED_NO_BOX(::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__LayoutUtility____c, "UnityEngine.UI", "LayoutUtility/<>c");
