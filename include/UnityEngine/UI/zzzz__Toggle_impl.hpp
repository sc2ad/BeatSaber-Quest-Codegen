...
constexpr void UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition  UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition::None{0};
constexpr UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition  UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition::Fade{1};
//  Writing Method size for method: UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent::*)()>(&UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent::_ctor)> {
...
constexpr void UnityEngine::UI::Toggle::__set_toggleTransition(UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition, 0xf8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition>(value));
}
constexpr UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition UnityEngine::UI::Toggle::__get_toggleTransition() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleTransition, 0xf8>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void UnityEngine::UI::Toggle::__set_onValueChanged(UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent value)  {
::cordl_internals::setInstanceField<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent, 0x110>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent>(value));
}
constexpr UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent UnityEngine::UI::Toggle::__get_onValueChanged() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::UnityEngine__UI__Toggle__ToggleEvent, 0x110>(this->::bs_hook::Il2CppWrapperType::instance);
}
