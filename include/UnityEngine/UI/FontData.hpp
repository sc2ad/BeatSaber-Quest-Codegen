...
namespace UnityEngine::UI {
  ...
  class FontData : public ::Il2CppObject/*, public UnityEngine::ISerializationCallbackReceiver*/ {
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xCEC9C4
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xCECA10
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xCECA5C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [FormerlySerializedAsAttribute] Offset: 0xCECAD8
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [FormerlySerializedAsAttribute] Offset: 0xCECB34
