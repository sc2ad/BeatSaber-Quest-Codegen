...
namespace UnityEngine::UI {
struct ____UnityEngine__UI__Navigation__Mode;
}
namespace UnityEngine::UI {
struct Navigation;
}
...
struct CORDL_TYPE ____UnityEngine__UI__Navigation__Mode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UI__Navigation__Mode(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UI__Navigation__Mode(____UnityEngine__UI__Navigation__Mode const&) = default;
                    constexpr ____UnityEngine__UI__Navigation__Mode(____UnityEngine__UI__Navigation__Mode&&) = default;
                    constexpr ____UnityEngine__UI__Navigation__Mode& operator=(____UnityEngine__UI__Navigation__Mode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UI__Navigation__Mode& operator=(____UnityEngine__UI__Navigation__Mode&& o) noexcept {
...
constexpr explicit ____UnityEngine__UI__Navigation__Mode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UI__Navigation__Mode_Unwrapped : int32_t {
__None = 0,
__Horizontal = 1,
__Vertical = 2,
__Automatic = 3,
...
constexpr operator ______UnityEngine__UI__Navigation__Mode_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UI__Navigation__Mode_Unwrapped>(__instance);
}
...
static ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode const None;

/// @brief Field Horizontal offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode const Horizontal;

/// @brief Field Vertical offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode const Vertical;

/// @brief Field Automatic offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode const Automatic;

/// @brief Field Explicit offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode const Explicit;
...
public:
// Declarations
using Mode = ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode;
...
// Ctor Parameters [CppParam { name: "m_Mode", ty: "::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode", modifiers: "", def_value: None }, CppParam { name: "m_WrapAround", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnUp", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnDown", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnLeft", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnRight", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: None }]
constexpr Navigation(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode m_Mode, bool m_WrapAround, ::UnityEngine::UI::Selectable m_SelectOnUp, ::UnityEngine::UI::Selectable m_SelectOnDown, ::UnityEngine::UI::Selectable m_SelectOnLeft, ::UnityEngine::UI::Selectable m_SelectOnRight) noexcept;
...
// Fields
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode __declspec(property(get=__get_m_Mode, put=__set_m_Mode))  m_Mode;

constexpr void __set_m_Mode(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode value) ;

constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode __get_m_Mode() const;
...
// Properties
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode __declspec(property(get=get_mode, put=set_mode))  mode;
...
/// @brief Method get_mode addr 0x2c04e6c size 0x8 virtual false final false
 ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode get_mode() ;

/// @brief Method set_mode addr 0x2c04e74 size 0x8 virtual false final false
 void set_mode(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode, "UnityEngine.UI", "Navigation/Mode");
