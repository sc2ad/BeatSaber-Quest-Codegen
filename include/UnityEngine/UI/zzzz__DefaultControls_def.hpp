...
class CORDL_TYPE UnityEngine__UI__DefaultControls__IFactoryControls : public ::cordl_internals::InterfaceW {
public:
// Declarations
~UnityEngine__UI__DefaultControls__IFactoryControls() = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UI__DefaultControls__IFactoryControls(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
...
class CORDL_TYPE UnityEngine__UI__DefaultControls__DefaultRuntimeFactory : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls
constexpr operator  UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls() const noexcept;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__UI__DefaultControls__DefaultRuntimeFactory() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__DefaultControls__DefaultRuntimeFactory", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory(UnityEngine__UI__DefaultControls__DefaultRuntimeFactory const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__DefaultControls__DefaultRuntimeFactory", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory(UnityEngine__UI__DefaultControls__DefaultRuntimeFactory&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UI__DefaultControls__DefaultRuntimeFactory(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory& operator=(UnityEngine__UI__DefaultControls__DefaultRuntimeFactory&& o) noexcept = default;
  constexpr UnityEngine__UI__DefaultControls__DefaultRuntimeFactory& operator=(UnityEngine__UI__DefaultControls__DefaultRuntimeFactory const& o) noexcept = default;
                


// Fields

static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls __declspec(property(get=__get_Default, put=__set_Default))  Default;

static void __set_Default(UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls value) ;

static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls __get_Default() ;
...
struct CORDL_TYPE UnityEngine__UI__DefaultControls__Resources : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr UnityEngine__UI__DefaultControls__Resources(UnityEngine::Sprite standard, UnityEngine::Sprite background, UnityEngine::Sprite inputField, UnityEngine::Sprite knob, UnityEngine::Sprite checkmark, UnityEngine::Sprite dropdown, UnityEngine::Sprite mask) noexcept;


                    constexpr UnityEngine__UI__DefaultControls__Resources(UnityEngine__UI__DefaultControls__Resources const&) = default;
                    constexpr UnityEngine__UI__DefaultControls__Resources(UnityEngine__UI__DefaultControls__Resources&&) = default;
                    constexpr UnityEngine__UI__DefaultControls__Resources& operator=(UnityEngine__UI__DefaultControls__Resources const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UI__DefaultControls__Resources& operator=(UnityEngine__UI__DefaultControls__Resources&& o) noexcept {
...
constexpr explicit UnityEngine__UI__DefaultControls__Resources(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using Resources = UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources;

using DefaultRuntimeFactory = UnityEngine::UI::UnityEngine__UI__DefaultControls__DefaultRuntimeFactory;

using IFactoryControls = UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls;
...
static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls __declspec(property(get=__get_m_CurrentFactory, put=__set_m_CurrentFactory))  m_CurrentFactory;

static void __set_m_CurrentFactory(UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls value) ;

static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls __get_m_CurrentFactory() ;
...
static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls __declspec(property(get=get_factory))  factory;


// Methods

/// @brief Method get_factory addr 0x2bda5d0 size 0x58 virtual false final false
static UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls get_factory() ;
...
static UnityEngine::GameObject CreatePanel(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateButton addr 0x2bdb1a4 size 0x3ec virtual false final false
static UnityEngine::GameObject CreateButton(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateText addr 0x2bdb590 size 0x1a0 virtual false final false
static UnityEngine::GameObject CreateText(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateImage addr 0x2bdb730 size 0x13c virtual false final false
static UnityEngine::GameObject CreateImage(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateRawImage addr 0x2bdb86c size 0x13c virtual false final false
static UnityEngine::GameObject CreateRawImage(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateSlider addr 0x2bdb9a8 size 0x6b4 virtual false final false
static UnityEngine::GameObject CreateSlider(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateScrollbar addr 0x2bdc05c size 0x474 virtual false final false
static UnityEngine::GameObject CreateScrollbar(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateToggle addr 0x2bdc4d0 size 0x578 virtual false final false
static UnityEngine::GameObject CreateToggle(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateInputField addr 0x2bdca48 size 0x620 virtual false final false
static UnityEngine::GameObject CreateInputField(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateDropdown addr 0x2bdd068 size 0x1258 virtual false final false
static UnityEngine::GameObject CreateDropdown(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;

/// @brief Method CreateScrollView addr 0x2bde4d8 size 0x8e8 virtual false final false
static UnityEngine::GameObject CreateScrollView(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources resources) ;
...
NEED_NO_BOX(UnityEngine::UI::UnityEngine__UI__DefaultControls__DefaultRuntimeFactory);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__DefaultControls__DefaultRuntimeFactory, "UnityEngine.UI", "DefaultControls/DefaultRuntimeFactory");
NEED_NO_BOX(UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__DefaultControls__IFactoryControls, "UnityEngine.UI", "DefaultControls/IFactoryControls");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__DefaultControls__Resources, "UnityEngine.UI", "DefaultControls/Resources");
