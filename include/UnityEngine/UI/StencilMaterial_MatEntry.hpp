...
namespace UnityEngine::UI {
  ...
  check_size<sizeof(StencilMaterial::MatEntry), 60 + sizeof(UnityEngine::Rendering::ColorWriteMask) + ((60 + sizeof(UnityEngine::Rendering::ColorWriteMask)) % 8 != 0 ? (8 - (60 + sizeof(UnityEngine::Rendering::ColorWriteMask)) % 8) : 0)> __UnityEngine_UI_StencilMaterial_MatEntrySizeCheck;
}
