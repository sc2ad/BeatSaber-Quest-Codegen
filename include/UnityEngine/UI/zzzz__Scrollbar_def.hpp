...
struct CORDL_TYPE UnityEngine__UI__Scrollbar__Direction : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__UI__Scrollbar__Direction(int32_t value__) noexcept;


                    constexpr UnityEngine__UI__Scrollbar__Direction(UnityEngine__UI__Scrollbar__Direction const&) = default;
                    constexpr UnityEngine__UI__Scrollbar__Direction(UnityEngine__UI__Scrollbar__Direction&&) = default;
                    constexpr UnityEngine__UI__Scrollbar__Direction& operator=(UnityEngine__UI__Scrollbar__Direction const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UI__Scrollbar__Direction& operator=(UnityEngine__UI__Scrollbar__Direction&& o) noexcept {
...
constexpr explicit UnityEngine__UI__Scrollbar__Direction(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__UI__Scrollbar__Direction_Unwrapped : int32_t {
__LeftToRight = 0,
__RightToLeft = 1,
__BottomToTop = 2,
__TopToBottom = 3,
...
constexpr operator __UnityEngine__UI__Scrollbar__Direction_Unwrapped () const noexcept {
...
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction const LeftToRight;

/// @brief Field RightToLeft offset 0
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction const RightToLeft;

/// @brief Field BottomToTop offset 0
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction const BottomToTop;

/// @brief Field TopToBottom offset 0
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction const TopToBottom;
...
virtual ~UnityEngine__UI__Scrollbar__ScrollEvent() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__Scrollbar__ScrollEvent", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UI__Scrollbar__ScrollEvent(UnityEngine__UI__Scrollbar__ScrollEvent const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__Scrollbar__ScrollEvent", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UI__Scrollbar__ScrollEvent(UnityEngine__UI__Scrollbar__ScrollEvent&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UI__Scrollbar__ScrollEvent(void* ptr) noexcept : UnityEngine::Events::UnityEvent_1<float_t>(ptr) {
}


  constexpr UnityEngine__UI__Scrollbar__ScrollEvent& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UI__Scrollbar__ScrollEvent& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UI__Scrollbar__ScrollEvent& operator=(UnityEngine__UI__Scrollbar__ScrollEvent&& o) noexcept = default;
  constexpr UnityEngine__UI__Scrollbar__ScrollEvent& operator=(UnityEngine__UI__Scrollbar__ScrollEvent const& o) noexcept = default;
...
struct CORDL_TYPE UnityEngine__UI__Scrollbar__Axis : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__UI__Scrollbar__Axis(int32_t value__) noexcept;


                    constexpr UnityEngine__UI__Scrollbar__Axis(UnityEngine__UI__Scrollbar__Axis const&) = default;
                    constexpr UnityEngine__UI__Scrollbar__Axis(UnityEngine__UI__Scrollbar__Axis&&) = default;
                    constexpr UnityEngine__UI__Scrollbar__Axis& operator=(UnityEngine__UI__Scrollbar__Axis const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__UI__Scrollbar__Axis& operator=(UnityEngine__UI__Scrollbar__Axis&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UI__Scrollbar__Axis(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__UI__Scrollbar__Axis_Unwrapped : int32_t {
__Horizontal = 0,
__Vertical = 1,
};
...
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis const Horizontal;

/// @brief Field Vertical offset 0
static UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis const Vertical;
...
class CORDL_TYPE UnityEngine__UI__Scrollbar___ClickRepeat_d__58 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__UI__Scrollbar___ClickRepeat_d__58() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__Scrollbar___ClickRepeat_d__58", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58(UnityEngine__UI__Scrollbar___ClickRepeat_d__58 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UI__Scrollbar___ClickRepeat_d__58", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58(UnityEngine__UI__Scrollbar___ClickRepeat_d__58&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UI__Scrollbar___ClickRepeat_d__58(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58& operator=(UnityEngine__UI__Scrollbar___ClickRepeat_d__58&& o) noexcept = default;
  constexpr UnityEngine__UI__Scrollbar___ClickRepeat_d__58& operator=(UnityEngine__UI__Scrollbar___ClickRepeat_d__58 const& o) noexcept = default;
...
public:
// Declarations
using _ClickRepeat_d__58 = UnityEngine::UI::UnityEngine__UI__Scrollbar___ClickRepeat_d__58;

using Axis = UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis;

using ScrollEvent = UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent;

using Direction = UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction;
...
constexpr UnityEngine::RectTransform __get_m_HandleRect() const;
 ...
 UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction __declspec(property(get=__get_m_Direction, put=__set_m_Direction))  m_Direction;

constexpr void __set_m_Direction(UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction value) ;

constexpr UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction __get_m_Direction() const;
...
constexpr int32_t __get_m_NumberOfSteps() const;
 ...
 UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent __declspec(property(get=__get_m_OnValueChanged, put=__set_m_OnValueChanged))  m_OnValueChanged;

constexpr void __set_m_OnValueChanged(UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent value) ;

constexpr UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent __get_m_OnValueChanged() const;
...
// Properties
 ...
 UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction __declspec(property(get=get_direction, put=set_direction))  direction;
 ...
 UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent __declspec(property(get=get_onValueChanged, put=set_onValueChanged))  onValueChanged;

 float_t __declspec(property(get=get_stepSize))  stepSize;

 UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis __declspec(property(get=get_axis))  axis;
...
/// @brief Method get_direction addr 0x2c07dac size 0x8 virtual false final false
 UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction get_direction() ;
...
/// @brief Method get_onValueChanged addr 0x2c082f4 size 0x8 virtual false final false
 UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent get_onValueChanged() ;

/// @brief Method set_onValueChanged addr 0x2c082fc size 0x8 virtual false final false
 void set_onValueChanged(UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent value) ;
...
/// @brief Method get_axis addr 0x2c087a8 size 0x10 virtual false final false
 UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis get_axis() ;
...
/// @brief Method SetDirection addr 0x2c09780 size 0x178 virtual false final false
 void SetDirection(UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction direction, bool includeRectLayouts) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__Scrollbar__Axis, "UnityEngine.UI", "Scrollbar/Axis");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__Scrollbar__Direction, "UnityEngine.UI", "Scrollbar/Direction");
NEED_NO_BOX(UnityEngine::UI::Scrollbar);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::Scrollbar, "UnityEngine.UI", "Scrollbar");
NEED_NO_BOX(UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__Scrollbar__ScrollEvent, "UnityEngine.UI", "Scrollbar/ScrollEvent");
NEED_NO_BOX(UnityEngine::UI::UnityEngine__UI__Scrollbar___ClickRepeat_d__58);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UI::UnityEngine__UI__Scrollbar___ClickRepeat_d__58, "UnityEngine.UI", "Scrollbar/<ClickRepeat>d__58");
