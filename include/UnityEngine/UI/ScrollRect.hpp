...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CD8638
  // [SelectionBaseAttribute] Offset: CD8638
  // [ExecuteAlways] Offset: CD8638
  // [DisallowMultipleComponent] Offset: CD8638
  // [RequireComponent] Offset: CD8638
  class ScrollRect : public UnityEngine::EventSystems::UIBehaviour/*, public UnityEngine::EventSystems::IInitializePotentialDragHandler, public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IEndDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IScrollHandler, public UnityEngine::UI::ICanvasElement, public UnityEngine::UI::ILayoutElement, public UnityEngine::UI::ILayoutGroup*/ {
    ...
    // Offset: 0x183B2B0
    void StopMovement_NEW();
    // public System.Void OnScroll(UnityEngine.EventSystems.PointerEventData data)
    // Offset: 0x183B31C
    void OnScroll_NEW(UnityEngine::EventSystems::PointerEventData* data);
    ...
    // Offset: 0x183BAD0
    void SetContentAnchoredPosition_NEW(UnityEngine::Vector2 position);
    ...
    // Offset: 0x183C714
    void SetNormalizedPosition_NEW(float value, int axis);
    ...
    // Offset: 0x183B19C
    // Implemented from: UnityEngine.EventSystems.UIBehaviour
    // Base method: System.Boolean UIBehaviour::IsActive_NEW()
    bool IsActive();
