...
namespace UnityEngine::UI {
  ...
  class ReflectionMethodsCache::Raycast2DCallback : public System::MulticastDelegate {
    ...
    // Offset: 0x1838B88
    UnityEngine::RaycastHit2D Invoke_NEW(UnityEngine::Vector2 p1, UnityEngine::Vector2 p2, float f, int i);
    ...
    // Offset: 0x1838EDC
    System::IAsyncResult* BeginInvoke_NEW(UnityEngine::Vector2 p1, UnityEngine::Vector2 p2, float f, int i, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public UnityEngine.RaycastHit2D EndInvoke(System.IAsyncResult result)
    // Offset: 0x1838FC0
    UnityEngine::RaycastHit2D EndInvoke_NEW(System::IAsyncResult* result);
