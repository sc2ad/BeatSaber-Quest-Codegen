...
namespace UnityEngine::UI {
  ...
  class Dropdown::DropdownItem : public UnityEngine::MonoBehaviour, public UnityEngine::EventSystems::IPointerEnterHandler, public UnityEngine::EventSystems::IEventSystemHandler, public UnityEngine::EventSystems::ICancelHandler {
    public:
