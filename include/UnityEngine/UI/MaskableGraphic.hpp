...
namespace UnityEngine::UI {
  ...
  class MaskableGraphic : public UnityEngine::UI::IClippable, public UnityEngine::UI::IMaskable, public UnityEngine::UI::IMaterialModifier, public UnityEngine::UI::Graphic {
    public:
