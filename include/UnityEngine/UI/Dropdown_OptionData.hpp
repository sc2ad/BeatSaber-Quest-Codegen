...
namespace UnityEngine::UI {
  ...
  class Dropdown::OptionData : public ::CsObject {
    public:
    ...
    // Offset: 0x1152B10
    static Dropdown::OptionData* New_ctor(::CsString* text);
    ...
    // Offset: 0x1152B78
    static Dropdown::OptionData* New_ctor(::CsString* text, UnityEngine::Sprite* image);
