...
namespace UnityEngine::UI {
  ...
  check_size<sizeof(HorizontalOrVerticalLayoutGroup), 97 + sizeof(bool) + ((97 + sizeof(bool)) % 8 != 0 ? (8 - (97 + sizeof(bool)) % 8) : 0)> __UnityEngine_UI_HorizontalOrVerticalLayoutGroupSizeCheck;
}
