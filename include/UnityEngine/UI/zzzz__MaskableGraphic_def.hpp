...
namespace UnityEngine::UI {
class ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent;
}
...
class CORDL_TYPE ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent : public ::UnityEngine::Events::UnityEvent_1<bool> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent(____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent(____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent(void* ptr) noexcept : ::UnityEngine::Events::UnityEvent_1<bool>(ptr) {
}


  constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent& operator=(____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent&& o) noexcept = default;
  constexpr ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent& operator=(____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent() ;
...
public:
// Declarations
using CullStateChangedEvent = ::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent;
...
constexpr bool __get_m_IncludeForMasking() const;
 ...
 ::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent __declspec(property(get=__get_m_OnCullStateChanged, put=__set_m_OnCullStateChanged))  m_OnCullStateChanged;

constexpr void __set_m_OnCullStateChanged(::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent value) ;

constexpr ::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent __get_m_OnCullStateChanged() const;
...
// Properties
 ...
 ::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent __declspec(property(get=get_onCullStateChanged, put=set_onCullStateChanged))  onCullStateChanged;
...
/// @brief Method get_onCullStateChanged addr 0x2c02330 size 0x8 virtual false final false
 ::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent get_onCullStateChanged() ;

/// @brief Method set_onCullStateChanged addr 0x2c02338 size 0x8 virtual false final false
 void set_onCullStateChanged(::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent value) ;
...
NEED_NO_BOX(::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__MaskableGraphic__CullStateChangedEvent, "UnityEngine.UI", "MaskableGraphic/CullStateChangedEvent");
