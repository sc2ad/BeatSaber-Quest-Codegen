...
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::____UnityEngine__UI__Navigation__Mode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode  ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::None{0};
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode  ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::Horizontal{1};
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode  ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::Vertical{2};
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode  ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::Automatic{3};
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode  ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode::Explicit{4};
//  Writing Method size for method: ::UnityEngine::UI::Navigation.get_mode
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode (::UnityEngine::UI::Navigation::*)()>(&::UnityEngine::UI::Navigation::get_mode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UI::Navigation::*)(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode)>(&::UnityEngine::UI::Navigation::set_mode)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_mode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode>::get()}
                        )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "m_Mode", ty: "::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_WrapAround", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "m_SelectOnUp", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_SelectOnDown", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_SelectOnLeft", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_SelectOnRight", ty: "::UnityEngine::UI::Selectable", modifiers: "", def_value: Some("csnull") }]
constexpr ::UnityEngine::UI::Navigation::Navigation(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode m_Mode, bool m_WrapAround, ::UnityEngine::UI::Selectable m_SelectOnUp, ::UnityEngine::UI::Selectable m_SelectOnDown, ::UnityEngine::UI::Selectable m_SelectOnLeft, ::UnityEngine::UI::Selectable m_SelectOnRight) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_Mode = m_Mode;
...
constexpr void ::UnityEngine::UI::Navigation::__set_m_Mode(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode value)  {
::cordl_internals::setInstanceField<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode, 0x0>(this->__instance, std::forward<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode>(value));
}
constexpr ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode ::UnityEngine::UI::Navigation::__get_m_Mode() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode, 0x0>(this->__instance);
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Selectable, 0x20>(this->__instance);
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode ::UnityEngine::UI::Navigation::get_mode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::Navigation>::get(),
                            "get_mode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
 void ::UnityEngine::UI::Navigation::set_mode(::UnityEngine::UI::____UnityEngine__UI__Navigation__Mode value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UI::Navigation>::get(),
                            "set_mode",
                            std::vector<Il2CppClass*>{},
