...
namespace UnityEngine::UI {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CD858C
  // [ExecuteAlways] Offset: CD858C
  // [DisallowMultipleComponent] Offset: CD858C
  // [RequireComponent] Offset: CD858C
