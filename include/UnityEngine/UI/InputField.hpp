...
namespace UnityEngine::UI {
  ...
  class InputField : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IUpdateSelectedHandler, public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IEndDragHandler, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::UI::ICanvasElement, public UnityEngine::UI::ILayoutElement*/ {
    ...
    check_size<sizeof(InputField::ContentType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_InputField_ContentTypeSizeCheck;
    ...
    check_size<sizeof(InputField::InputType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_InputField_InputTypeSizeCheck;
    ...
    check_size<sizeof(InputField::CharacterValidation), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_InputField_CharacterValidationSizeCheck;
    ...
    check_size<sizeof(InputField::LineType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_InputField_LineTypeSizeCheck;
  ...
  check_size<sizeof(InputField), 512 + sizeof(void*) + ((512 + sizeof(void*)) % 8 != 0 ? (8 - (512 + sizeof(void*)) % 8) : 0)> __UnityEngine_UI_InputFieldSizeCheck;
}
