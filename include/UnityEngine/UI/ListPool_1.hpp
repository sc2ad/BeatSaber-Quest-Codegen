...
namespace UnityEngine::UI {
  ...
  class ListPool_1 : public ::Il2CppObject {
    ...
    static void Clear(System::Collections::Generic::List_1<T>* l) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ListPool_1<T>*>::get(), "Clear", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(l))));
    ...
    static System::Collections::Generic::List_1<T>* Get() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ListPool_1<T>*>::get(), "Get", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    static void Release(System::Collections::Generic::List_1<T>* toRelease) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ListPool_1<T>*>::get(), "Release", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(toRelease))));
