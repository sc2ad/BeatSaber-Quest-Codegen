...
namespace UnityEngine::UI {
struct ____UnityEngine__UI__Selectable__Transition;
}
namespace UnityEngine::UI {
class Selectable;
}
...
struct CORDL_TYPE ____UnityEngine__UI__Selectable__Transition : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UI__Selectable__Transition(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UI__Selectable__Transition(____UnityEngine__UI__Selectable__Transition const&) = default;
                    constexpr ____UnityEngine__UI__Selectable__Transition(____UnityEngine__UI__Selectable__Transition&&) = default;
                    constexpr ____UnityEngine__UI__Selectable__Transition& operator=(____UnityEngine__UI__Selectable__Transition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UI__Selectable__Transition& operator=(____UnityEngine__UI__Selectable__Transition&& o) noexcept {
...
constexpr explicit ____UnityEngine__UI__Selectable__Transition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UI__Selectable__Transition_Unwrapped : int32_t {
__None = 0,
__ColorTint = 1,
__SpriteSwap = 2,
__Animation = 3,
...
constexpr operator ______UnityEngine__UI__Selectable__Transition_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UI__Selectable__Transition_Unwrapped>(__instance);
}
...
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition const None;

/// @brief Field ColorTint offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition const ColorTint;

/// @brief Field SpriteSwap offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition const SpriteSwap;

/// @brief Field Animation offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition const Animation;
...
struct CORDL_TYPE ____UnityEngine__UI__Selectable__SelectionState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__UI__Selectable__SelectionState(int32_t value__) noexcept;


                    constexpr ____UnityEngine__UI__Selectable__SelectionState(____UnityEngine__UI__Selectable__SelectionState const&) = default;
                    constexpr ____UnityEngine__UI__Selectable__SelectionState(____UnityEngine__UI__Selectable__SelectionState&&) = default;
                    constexpr ____UnityEngine__UI__Selectable__SelectionState& operator=(____UnityEngine__UI__Selectable__SelectionState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__UI__Selectable__SelectionState& operator=(____UnityEngine__UI__Selectable__SelectionState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__UI__Selectable__SelectionState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______UnityEngine__UI__Selectable__SelectionState_Unwrapped : int32_t {
__Normal = 0,
__Highlighted = 1,
__Pressed = 2,
__Selected = 3,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______UnityEngine__UI__Selectable__SelectionState_Unwrapped () const noexcept {
return std::bit_cast<______UnityEngine__UI__Selectable__SelectionState_Unwrapped>(__instance);
}
...
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState const Normal;

/// @brief Field Highlighted offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState const Highlighted;

/// @brief Field Pressed offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState const Pressed;

/// @brief Field Selected offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState const Selected;

/// @brief Field Disabled offset 0
static ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState const Disabled;
...
public:
// Declarations
using SelectionState = ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState;

using Transition = ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition;
...
constexpr ::UnityEngine::UI::Navigation __get_m_Navigation() const;
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition __declspec(property(get=__get_m_Transition, put=__set_m_Transition))  m_Transition;

constexpr void __set_m_Transition(::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition value) ;

constexpr ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition __get_m_Transition() const;
...
static ::System::Collections::Generic::List_1<::UnityEngine::UI::Selectable> __declspec(property(get=get_allSelectables))  allSelectables;
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition __declspec(property(get=get_transition, put=set_transition))  transition;
 ...
 ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState __declspec(property(get=get_currentSelectionState))  currentSelectionState;
...
/// @brief Method get_transition addr 0x2c0d95c size 0x8 virtual false final false
 ::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition get_transition() ;

/// @brief Method set_transition addr 0x2c0d964 size 0x74 virtual false final false
 void set_transition(::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition value) ;
...
/// @brief Method get_currentSelectionState addr 0x2c0e0f4 size 0x50 virtual false final false
 ::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState get_currentSelectionState() ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__Selectable__SelectionState, "UnityEngine.UI", "Selectable/SelectionState");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::UI::____UnityEngine__UI__Selectable__Transition, "UnityEngine.UI", "Selectable/Transition");
