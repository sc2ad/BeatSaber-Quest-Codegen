...
namespace UnityEngine::UI {
  ...
  class ContentSizeFitter : public UnityEngine::EventSystems::UIBehaviour/*, public UnityEngine::UI::ILayoutSelfController*/ {
    ...
    check_size<sizeof(ContentSizeFitter::FitMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_UI_ContentSizeFitter_FitModeSizeCheck;
  ...
  check_size<sizeof(ContentSizeFitter), 40 + sizeof(UnityEngine::DrivenRectTransformTracker) + ((40 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8 != 0 ? (8 - (40 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8) : 0)> __UnityEngine_UI_ContentSizeFitterSizeCheck;
}
