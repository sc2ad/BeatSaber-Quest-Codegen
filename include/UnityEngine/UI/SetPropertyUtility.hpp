...
namespace UnityEngine::UI {
  ...
  class SetPropertyUtility : public ::Il2CppObject {
    ...
    static bool SetStruct(T& currentValue, T newValue) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.UI", "SetPropertyUtility", il2cpp_utils::NoArgClass<bool>(), "SetStruct", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(currentValue, newValue))));
    ...
    static bool SetClass(T& currentValue, T newValue) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.UI", "SetPropertyUtility", il2cpp_utils::NoArgClass<bool>(), "SetClass", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(currentValue, newValue))));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, currentValue, newValue);
    }
