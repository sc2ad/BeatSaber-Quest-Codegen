...
namespace UnityEngine {
  ...
  class DebugLogHandler : public ::CsObject, public UnityEngine::ILogHandler {
    public:
    ...
    // Offset: 0x12F213C
    static void Internal_Log(UnityEngine::LogType level, UnityEngine::LogOption options, ::CsString* msg, UnityEngine::Object* obj);
