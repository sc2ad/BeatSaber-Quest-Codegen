...
namespace UnityEngine {
struct ____UnityEngine__Mesh__MeshData;
}
namespace UnityEngine {
struct ____UnityEngine__Mesh__MeshDataArray;
}
// Type: ::MeshDataArray
namespace UnityEngine {
// Is value type: true
...
struct CORDL_TYPE ____UnityEngine__Mesh__MeshDataArray : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____UnityEngine__Mesh__MeshDataArray(void* m_Ptrs, int32_t m_Length) noexcept;


                    constexpr ____UnityEngine__Mesh__MeshDataArray(____UnityEngine__Mesh__MeshDataArray const&) = default;
                    constexpr ____UnityEngine__Mesh__MeshDataArray(____UnityEngine__Mesh__MeshDataArray&&) = default;
                    constexpr ____UnityEngine__Mesh__MeshDataArray& operator=(____UnityEngine__Mesh__MeshDataArray const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Mesh__MeshDataArray& operator=(____UnityEngine__Mesh__MeshDataArray&& o) noexcept {
...
constexpr explicit ____UnityEngine__Mesh__MeshDataArray(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____UnityEngine__Mesh__MeshData : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_Ptr", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
constexpr ____UnityEngine__Mesh__MeshData(::cordl_internals::intptr_t m_Ptr) noexcept;


                    constexpr ____UnityEngine__Mesh__MeshData(____UnityEngine__Mesh__MeshData const&) = default;
                    constexpr ____UnityEngine__Mesh__MeshData(____UnityEngine__Mesh__MeshData&&) = default;
                    constexpr ____UnityEngine__Mesh__MeshData& operator=(____UnityEngine__Mesh__MeshData const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____UnityEngine__Mesh__MeshData& operator=(____UnityEngine__Mesh__MeshData&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__Mesh__MeshData(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using MeshData = ::UnityEngine::____UnityEngine__Mesh__MeshData;

using MeshDataArray = ::UnityEngine::____UnityEngine__Mesh__MeshDataArray;
...
// Properties
 ...
 ::UnityEngine::____UnityEngine__GraphicsBuffer__Target __declspec(property(get=get_indexBufferTarget, put=set_indexBufferTarget))  indexBufferTarget;
...
/// @brief Method get_indexBufferTarget addr 0x2b2f618 size 0x3c virtual false final false
 ::UnityEngine::____UnityEngine__GraphicsBuffer__Target get_indexBufferTarget() ;

/// @brief Method set_indexBufferTarget addr 0x2b2f654 size 0x44 virtual false final false
 void set_indexBufferTarget(::UnityEngine::____UnityEngine__GraphicsBuffer__Target value) ;
...
static ::UnityEngine::____UnityEngine__Mesh__MeshDataArray AcquireReadOnlyMeshData(::UnityEngine::Mesh mesh) ;

/// @brief Method AcquireReadOnlyMeshData addr 0x2b331e0 size 0x9c virtual false final false
static ::UnityEngine::____UnityEngine__Mesh__MeshDataArray AcquireReadOnlyMeshData(::ArrayW<::UnityEngine::Mesh> meshes) ;

/// @brief Method AcquireReadOnlyMeshData addr 0x2b335b4 size 0xe0 virtual false final false
static ::UnityEngine::____UnityEngine__Mesh__MeshDataArray AcquireReadOnlyMeshData(::System::Collections::Generic::List_1<::UnityEngine::Mesh> meshes) ;

/// @brief Method AllocateWritableMeshData addr 0x2b33694 size 0x28 virtual false final false
static ::UnityEngine::____UnityEngine__Mesh__MeshDataArray AllocateWritableMeshData(int32_t meshCount) ;

/// @brief Method ApplyAndDisposeWritableMeshData addr 0x2b33824 size 0x188 virtual false final false
static void ApplyAndDisposeWritableMeshData(::UnityEngine::____UnityEngine__Mesh__MeshDataArray data, ::UnityEngine::Mesh mesh, ::UnityEngine::Rendering::MeshUpdateFlags flags) ;

/// @brief Method ApplyAndDisposeWritableMeshData addr 0x2b33ad0 size 0x160 virtual false final false
static void ApplyAndDisposeWritableMeshData(::UnityEngine::____UnityEngine__Mesh__MeshDataArray data, ::ArrayW<::UnityEngine::Mesh> meshes, ::UnityEngine::Rendering::MeshUpdateFlags flags) ;

/// @brief Method ApplyAndDisposeWritableMeshData addr 0x2b33e74 size 0x1bc virtual false final false
static void ApplyAndDisposeWritableMeshData(::UnityEngine::____UnityEngine__Mesh__MeshDataArray data, ::System::Collections::Generic::List_1<::UnityEngine::Mesh> meshes, ::UnityEngine::Rendering::MeshUpdateFlags flags) ;
...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__Mesh__MeshData, "UnityEngine", "Mesh/MeshData");
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__Mesh__MeshDataArray, "UnityEngine", "Mesh/MeshDataArray");
