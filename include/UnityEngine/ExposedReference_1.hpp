...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10440A4
  template<typename T>
  struct ExposedReference_1/*, public ::System::ValueType*/ {
    public:
    public:
    // [SerializeField] Offset: 0x1048E28
    ...
    // [SerializeField] Offset: 0x1048E38
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::PropertyName& dyn_exposedName() {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::Object*& dyn_defaultValue() {
