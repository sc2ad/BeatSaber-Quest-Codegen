...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: E709E4
  // [NativeHeaderAttribute] Offset: E709E4
  class Display : public ::Il2CppObject {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xE7567C
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::ArrayWrapper<System::IntPtr>)>(&UnityEngine::Display::RecreateDisplayList)> {
  static const MethodInfo* get() {
    static auto* nativeDisplay = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "IntPtr")), 1)->byval_arg;
