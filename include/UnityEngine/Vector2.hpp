...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 1057A0C
  // [NativeClassAttribute] Offset: 1057A0C
  // [DefaultMemberAttribute] Offset: 1057A0C
  struct Vector2/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Vector2>*/ {
    ...
    // Creating interface conversion operator: i_Vector2
    inline ::System::IEquatable_1<::UnityEngine::Vector2>* i_Vector2() noexcept {
      return reinterpret_cast<::System::IEquatable_1<::UnityEngine::Vector2>*>(this);
    }
