...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CA6D7C
  struct FrameTiming/*, public System::ValueType*/ {
    public:
    // [NativeNameAttribute] Offset: 0xCAB37C
    ...
    // [NativeNameAttribute] Offset: 0xCAB3B4
    ...
    // [NativeNameAttribute] Offset: 0xCAB3EC
    ...
    // Field size check
    static_assert(sizeof(uint64_t) == 0x8);
    // [NativeNameAttribute] Offset: 0xCAB424
    ...
    // Field size check
    static_assert(sizeof(double) == 0x8);
    // [NativeNameAttribute] Offset: 0xCAB45C
    ...
    // [NativeNameAttribute] Offset: 0xCAB494
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0xCAB4CC
