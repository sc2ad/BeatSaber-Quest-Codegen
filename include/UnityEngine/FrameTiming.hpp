...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 1027A74
  struct FrameTiming/*, public ::System::ValueType*/ {
    public:
    public:
    // [NativeNameAttribute] Offset: 0x102C47C
    ...
    // [NativeNameAttribute] Offset: 0x102C4B4
    ...
    // [NativeNameAttribute] Offset: 0x102C4EC
    ...
    // Field size check
    static_assert(sizeof(uint64_t) == 0x8);
    // [NativeNameAttribute] Offset: 0x102C524
    ...
    // Field size check
    static_assert(sizeof(double) == 0x8);
    // [NativeNameAttribute] Offset: 0x102C55C
    ...
    // [NativeNameAttribute] Offset: 0x102C594
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [NativeNameAttribute] Offset: 0x102C5CC
