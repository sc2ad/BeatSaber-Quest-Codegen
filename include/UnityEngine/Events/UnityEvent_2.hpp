...
namespace UnityEngine::Events {
  ...
  class UnityEvent_2 : public UnityEngine::Events::UnityEventBase {
    ...
    ::Array<::Il2CppObject*>* _get_m_InvokeArray() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::UnityEvent_2::_get_m_InvokeArray");
    ...
    void _set_m_InvokeArray(::Array<::Il2CppObject*>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::UnityEvent_2::_set_m_InvokeArray");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "m_InvokeArray"))->offset;
