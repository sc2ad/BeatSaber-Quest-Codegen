...
namespace UnityEngine::Events {
  ...
  class UnityAction_3 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static UnityAction_3<T0, T1, T2>* New_ctor(::CsObject* object, System::IntPtr method) {
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T0 arg0, T1 arg1, T2 arg2, System::AsyncCallback* callback, ::CsObject* object) {
