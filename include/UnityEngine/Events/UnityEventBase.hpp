...
namespace UnityEngine::Events {
  ...
  class UnityEventBase : public ::CsObject, public UnityEngine::ISerializationCallbackReceiver {
    public:
    ...
    // Offset: 0x13075BC
    System::Reflection::MethodInfo* FindMethod(::CsString* name, ::CsObject* listener, UnityEngine::Events::PersistentListenerMode mode, System::Type* argumentType);
    ...
    // Offset: 0x1307180
    static System::Reflection::MethodInfo* GetValidMethodInfo(::CsObject* obj, ::CsString* functionName, ::Array<System::Type*>* argumentTypes);
