...
namespace UnityEngine::Events {
  ...
  class UnityAction_2 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static UnityAction_2<T0, T1>* New_ctor(::CsObject* object, System::IntPtr method) {
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T0 arg0, T1 arg1, System::AsyncCallback* callback, ::CsObject* object) {
