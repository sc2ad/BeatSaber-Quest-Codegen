...
namespace UnityEngine::Events {
  ...
  class InvokableCall_4 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xE2E6BC
    ...
    UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>* _get_Delegate() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_4::_get_Delegate");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>*>(___internal__instance, "Delegate")));
    }
    // Autogenerated instance field setter
    // Set instance field: private UnityEngine.Events.UnityAction`4<T1,T2,T3,T4> Delegate
    void _set_Delegate(UnityEngine::Events::UnityAction_4<T1, T2, T3, T4>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_4::_set_Delegate");
      static auto ___internal__instance = this;
