...
namespace UnityEngine::Events {
  ...
  class ArgumentCache : public ::CsObject, public UnityEngine::ISerializationCallbackReceiver {
    public:
    ...
    // Offset: 0x18
    ::CsString* m_ObjectArgumentAssemblyTypeName;
    ...
    // Offset: 0x12F2EA0
    ::CsString* get_unityObjectArgumentAssemblyTypeName();
