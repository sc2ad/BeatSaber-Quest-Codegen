...
namespace UnityEngine::Events {
  ...
  class InvokableCall_2 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD51418
    // [DebuggerBrowsableAttribute] Offset: 0xD51418
    ...
    void Invoke(T1 args0, T2 args1) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(args0, args1)));
