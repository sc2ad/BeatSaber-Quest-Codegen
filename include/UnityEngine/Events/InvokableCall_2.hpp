...
namespace UnityEngine::Events {
  ...
  class InvokableCall_2 : public UnityEngine::Events::BaseInvokableCall {
    ...
    UnityEngine::Events::UnityAction_2<T1, T2>* _get_Delegate() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_2::_get_Delegate");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_2<T1, T2>*>(___internal__instance, "Delegate")));
    }
    // Autogenerated instance field setter
    // Set instance field: private UnityEngine.Events.UnityAction`2<T1,T2> Delegate
    void _set_Delegate(UnityEngine::Events::UnityAction_2<T1, T2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_2::_set_Delegate");
      static auto ___internal__instance = this;
