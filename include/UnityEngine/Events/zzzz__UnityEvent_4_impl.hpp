...
constexpr void UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::__set_m_InvokeArray(::ArrayW<::bs_hook::Il2CppWrapperType> value)  {
...
constexpr ::ArrayW<::bs_hook::Il2CppWrapperType> UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::__get_m_InvokeArray() const {
return ::cordl_internals::getInstanceField<::ArrayW<::bs_hook::Il2CppWrapperType>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
 UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3> UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::New_ctor()  {
UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3> o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>>())};
return o;
}
 void UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::_ctor()  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 System::Reflection::MethodInfo UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::FindMethod_Impl(::StringW name, System::Type targetObjType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>>::get(),
                            "FindMethod_Impl",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<System::Reflection::MethodInfo, false>(const_cast<void*>(instance), ___internal_method, name, targetObjType);
 ...
 UnityEngine::Events::BaseInvokableCall UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>::GetDelegate(::bs_hook::Il2CppWrapperType target, System::Reflection::MethodInfo theFunction)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Events::UnityEvent_4<T0,T1,T2,T3>>::get(),
                            "GetDelegate",
                            std::vector<Il2CppClass*>{},
