...
namespace UnityEngine::Events {
  ...
  class CachedInvokableCall_1 : public UnityEngine::Events::InvokableCall_1<T> {
    ...
    T _get_m_Arg1() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::CachedInvokableCall_1::_get_m_Arg1");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<T>(___internal__instance, "m_Arg1"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly T m_Arg1
    void _set_m_Arg1(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::CachedInvokableCall_1::_set_m_Arg1");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "m_Arg1", value));
    }
