...
namespace UnityEngine::Events {
  ...
  class InvokableCall_3 : public UnityEngine::Events::BaseInvokableCall {
    ...
    void add_Delegate(UnityEngine::Events::UnityAction_3<T1, T2, T3>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Events").WithContext("InvokableCall_3").WithContext("add_Delegate");
    ...
    void remove_Delegate(UnityEngine::Events::UnityAction_3<T1, T2, T3>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Events").WithContext("InvokableCall_3").WithContext("remove_Delegate");
    ...
    static InvokableCall_3<T1, T2, T3>* New_ctor(UnityEngine::Events::UnityAction_3<T1, T2, T3>* action) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Events").WithContext("InvokableCall_3").WithContext(".ctor");
    ...
    void Invoke(T1 args0, T2 args1, T3 args2) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Events").WithContext("InvokableCall_3").WithContext("Invoke");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Invoke", {}, ::il2cpp_utils::ExtractTypes(args0, args1, args2)));
    ...
    bool Find(::Il2CppObject* targetObj, System::Reflection::MethodInfo* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Events").WithContext("InvokableCall_3").WithContext("Find");
  ...
  // Could not write size check! Type: UnityEngine.Events.InvokableCall`3 is generic!
}
