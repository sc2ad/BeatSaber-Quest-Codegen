...
namespace UnityEngine::Events {
  ...
  class InvokableCall_3 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xD81A64
    ...
    UnityEngine::Events::UnityAction_3<T1, T2, T3>* _get_Delegate() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_3::_get_Delegate");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_3<T1, T2, T3>*>(___internal__instance, "Delegate")));
    }
    // Autogenerated instance field setter
    // Set instance field: private UnityEngine.Events.UnityAction`3<T1,T2,T3> Delegate
    void _set_Delegate(UnityEngine::Events::UnityAction_3<T1, T2, T3>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_3::_set_Delegate");
      static auto ___internal__instance = this;
