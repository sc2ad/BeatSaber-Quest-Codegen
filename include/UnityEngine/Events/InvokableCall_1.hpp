...
namespace UnityEngine::Events {
  ...
  class InvokableCall_1 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xE2E608
    ...
    UnityEngine::Events::UnityAction_1<T1>* _get_Delegate() {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_1::_get_Delegate");
    ...
    // Set instance field: private UnityEngine.Events.UnityAction`1<T1> Delegate
    void _set_Delegate(UnityEngine::Events::UnityAction_1<T1>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("UnityEngine::Events::InvokableCall_1::_set_Delegate");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "Delegate"))->offset;
      *reinterpret_cast<UnityEngine::Events::UnityAction_1<T1>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
