...
namespace UnityEngine::Events {
  ...
  class InvokableCall_1 : public UnityEngine::Events::BaseInvokableCall {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xD819EC
    ...
    UnityEngine::Events::UnityAction_1<T1>* _get_Delegate() {
      ...
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_1<T1>*>(___internal__instance, "Delegate"));
    }
