...
namespace UnityEngine::TestTools {
  ...
  check_size<sizeof(SetUpTearDownCommand::$InvokeBefore$d__2), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __UnityEngine_TestTools_SetUpTearDownCommand_$InvokeBefore$d__2SizeCheck;
}
