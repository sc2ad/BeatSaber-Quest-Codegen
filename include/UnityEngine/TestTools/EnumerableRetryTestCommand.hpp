...
namespace UnityEngine::TestTools {
  ...
  class EnumerableRetryTestCommand : public UnityEngine::TestRunner::NUnitExtensions::Runner::IEnumerableTestMethodCommand, public NUnit::Framework::Internal::Commands::DelegatingTestCommand {
    public:
