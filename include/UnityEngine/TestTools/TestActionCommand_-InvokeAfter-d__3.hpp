...
namespace UnityEngine::TestTools {
  ...
  check_size<sizeof(TestActionCommand::$InvokeAfter$d__3), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __UnityEngine_TestTools_TestActionCommand_$InvokeAfter$d__3SizeCheck;
}
