...
namespace UnityEngine::TestTools::Utils {
  ...
  class PlayerTestAssemblyProvider : public ::CsObject {
    public:
    ...
    // Offset: 0x18
    System::Collections::Generic::List_1<::CsString*>* m_AssembliesToLoad;
    ...
    // Offset: 0x196E7C4
    static PlayerTestAssemblyProvider* New_ctor(UnityEngine::TestTools::Utils::IAssemblyLoadProxy* assemblyLoadProxy, System::Collections::Generic::List_1<::CsString*>* assembliesToLoad);
