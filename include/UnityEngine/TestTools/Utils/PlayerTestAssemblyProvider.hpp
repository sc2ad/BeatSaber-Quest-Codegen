...
namespace UnityEngine::TestTools::Utils {
  ...
  check_size<sizeof(PlayerTestAssemblyProvider), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestTools_Utils_PlayerTestAssemblyProviderSizeCheck;
}
