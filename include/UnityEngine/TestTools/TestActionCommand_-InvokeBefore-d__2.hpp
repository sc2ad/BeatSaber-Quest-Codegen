...
namespace UnityEngine::TestTools {
  ...
  check_size<sizeof(TestActionCommand::$InvokeBefore$d__2), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __UnityEngine_TestTools_TestActionCommand_$InvokeBefore$d__2SizeCheck;
}
