...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<NUnit::Framework::ITestAction*> (*)(System::Reflection::MethodInfo*)>(&UnityEngine::TestTools::TestActionCommand::GetTestActionsFromMethod)> {
