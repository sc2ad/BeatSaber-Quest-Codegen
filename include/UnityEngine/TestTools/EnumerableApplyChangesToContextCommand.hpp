...
namespace UnityEngine::TestTools {
  ...
  class EnumerableApplyChangesToContextCommand : public UnityEngine::TestRunner::NUnitExtensions::Runner::IEnumerableTestMethodCommand, public NUnit::Framework::Internal::Commands::ApplyChangesToContextCommand {
    public:
