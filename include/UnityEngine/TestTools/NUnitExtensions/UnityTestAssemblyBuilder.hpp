...
namespace UnityEngine::TestTools::NUnitExtensions {
  ...
  class UnityTestAssemblyBuilder : public NUnit::Framework::Api::DefaultTestAssemblyBuilder {
    ...
    // Offset: 0x13510CC
    System::Collections::Generic::IEnumerator_1<NUnit::Framework::Interfaces::ITest*>* BuildAsync_NEW(::Array<System::Reflection::Assembly*>* assemblies, ::Array<UnityEngine::TestTools::TestPlatform>* testPlatforms, System::Collections::Generic::IDictionary_2<::Il2CppString*, ::Il2CppObject*>* options);
