...
namespace UnityEngine::TestTools {
  ...
  class TestEnumerator::$Execute$d__5 : public ::CsObject, public System::Collections::Generic::IEnumerator_1<::CsObject*>, public System::Collections::IEnumerator, public System::IDisposable {
    public:
