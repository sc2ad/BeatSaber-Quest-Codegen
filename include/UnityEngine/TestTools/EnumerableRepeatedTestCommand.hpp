...
namespace UnityEngine::TestTools {
  ...
  class EnumerableRepeatedTestCommand : public UnityEngine::TestRunner::NUnitExtensions::Runner::IEnumerableTestMethodCommand, public NUnit::Framework::Internal::Commands::DelegatingTestCommand {
    public:
