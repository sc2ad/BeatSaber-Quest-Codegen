...
namespace UnityEngine::TestTools::TestRunner::Callbacks {
  ...
  check_size<sizeof(RemoteTestResultSender), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestTools_TestRunner_Callbacks_RemoteTestResultSenderSizeCheck;
}
