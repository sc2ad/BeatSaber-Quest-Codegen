...
namespace UnityEngine::TestTools::TestRunner::GUI {
  ...
  check_size<sizeof(TestRunnerFilter), 52 + sizeof(bool) + ((52 + sizeof(bool)) % 8 != 0 ? (8 - (52 + sizeof(bool)) % 8) : 0)> __UnityEngine_TestTools_TestRunner_GUI_TestRunnerFilterSizeCheck;
}
