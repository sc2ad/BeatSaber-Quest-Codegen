...
namespace UnityEngine::TestTools::TestRunner {
  ...
  check_size<sizeof(TestListenerWrapper), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __UnityEngine_TestTools_TestRunner_TestListenerWrapperSizeCheck;
}
