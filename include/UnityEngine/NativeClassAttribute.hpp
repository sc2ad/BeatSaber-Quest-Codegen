...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [VisibleToOtherModulesAttribute] Offset: CBA7EC
  // [AttributeUsageAttribute] Offset: CBA7EC
  class NativeClassAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCBAD24
    // [CompilerGeneratedAttribute] Offset: 0xCBAD24
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCBAD60
    // [DebuggerBrowsableAttribute] Offset: 0xCBAD60
