...
namespace UnityEngine::Scripting {
  ...
  // [AttributeUsageAttribute] Offset: CA5514
  // [VisibleToOtherModulesAttribute] Offset: CA5514
  class UsedByNativeCodeAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCA5AD8
    // [DebuggerBrowsableAttribute] Offset: 0xCA5AD8
