...
namespace UnityEngine::Scripting {
  ...
  // [AttributeUsageAttribute] Offset: CB665C
  // [VisibleToOtherModulesAttribute] Offset: CB665C
  class UsedByNativeCodeAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCB6C20
    // [DebuggerBrowsableAttribute] Offset: 0xCB6C20
