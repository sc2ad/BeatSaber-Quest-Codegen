...
namespace UnityEngine::Scripting {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CBAC10
  // [VisibleToOtherModulesAttribute] Offset: CBAC10
  class UsedByNativeCodeAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCBB1D4
    // [DebuggerBrowsableAttribute] Offset: 0xCBB1D4
