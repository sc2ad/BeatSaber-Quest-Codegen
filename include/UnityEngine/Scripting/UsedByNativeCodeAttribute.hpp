...
namespace UnityEngine::Scripting {
  ...
  // [VisibleToOtherModulesAttribute] Offset: D8BB6C
  // [AttributeUsageAttribute] Offset: D8BB6C
  class UsedByNativeCodeAttribute : public System::Attribute {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD8C130
    // [DebuggerBrowsableAttribute] Offset: 0xD8C130
