...
constexpr TileData(int32_t m_Sprite, UnityEngine::Color m_Color, UnityEngine::Matrix4x4 m_Transform, int32_t m_GameObject, UnityEngine::Tilemaps::TileFlags m_Flags, UnityEngine::Tilemaps::UnityEngine__Tilemaps__Tile__ColliderType m_ColliderType) noexcept;
...
// Properties
 ...
 UnityEngine::Tilemaps::UnityEngine__Tilemaps__Tile__ColliderType __declspec(property(put=set_colliderType))  colliderType;
