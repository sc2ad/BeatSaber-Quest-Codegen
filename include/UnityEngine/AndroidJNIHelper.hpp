...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10AD13C
  // [NativeHeaderAttribute] Offset: 10AD13C
  // [StaticAccessorAttribute] Offset: 10AD13C
  // [NativeConditionalAttribute] Offset: 10AD13C
