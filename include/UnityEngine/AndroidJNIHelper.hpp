...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10ADEBC
  // [NativeHeaderAttribute] Offset: 10ADEBC
  // [StaticAccessorAttribute] Offset: 10ADEBC
  // [NativeConditionalAttribute] Offset: 10ADEBC
