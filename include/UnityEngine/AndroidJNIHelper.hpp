...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [StaticAccessorAttribute] Offset: CCCADC
  // [NativeHeaderAttribute] Offset: CCCADC
  // [UsedByNativeCodeAttribute] Offset: CCCADC
  // [NativeConditionalAttribute] Offset: CCCADC
