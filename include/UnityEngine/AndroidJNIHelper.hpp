...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [StaticAccessorAttribute] Offset: CCB6A0
  // [NativeHeaderAttribute] Offset: CCB6A0
  // [UsedByNativeCodeAttribute] Offset: CCB6A0
  // [NativeConditionalAttribute] Offset: CCB6A0
