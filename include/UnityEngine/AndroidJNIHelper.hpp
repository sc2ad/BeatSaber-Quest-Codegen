...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10B5C2C
  // [NativeHeaderAttribute] Offset: 10B5C2C
  // [StaticAccessorAttribute] Offset: 10B5C2C
  // [NativeConditionalAttribute] Offset: 10B5C2C
