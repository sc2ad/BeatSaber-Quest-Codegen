...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: CDEC6C
  // [NativeHeaderAttribute] Offset: CDEC6C
  // [UsedByNativeCodeAttribute] Offset: CDEC6C
  // [NativeConditionalAttribute] Offset: CDEC6C
