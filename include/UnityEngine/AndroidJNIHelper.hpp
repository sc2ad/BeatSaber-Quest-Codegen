...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10BC81C
  // [NativeHeaderAttribute] Offset: 10BC81C
  // [StaticAccessorAttribute] Offset: 10BC81C
  // [NativeConditionalAttribute] Offset: 10BC81C
