...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: DA5C0C
  // [NativeHeaderAttribute] Offset: DA5C0C
  // [UsedByNativeCodeAttribute] Offset: DA5C0C
  // [NativeConditionalAttribute] Offset: DA5C0C
