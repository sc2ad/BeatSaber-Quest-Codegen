...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10AEDBC
  // [NativeHeaderAttribute] Offset: 10AEDBC
  // [StaticAccessorAttribute] Offset: 10AEDBC
  // [NativeConditionalAttribute] Offset: 10AEDBC
