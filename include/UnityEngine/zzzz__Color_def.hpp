...
static ::UnityEngine::Vector4 op_Implicit___UnityEngine__Vector4(::UnityEngine::Color c) ;

/// @brief Method op_Implicit addr 0x2b648e4 size 0x4 virtual false final false
static ::UnityEngine::Color op_Implicit___UnityEngine__Color(::UnityEngine::Vector4 v) ;
