...
namespace UnityEngine::Profiling::Memory::Experimental {
  ...
  // [NativeHeaderAttribute] Offset: 1083F34
  class MemoryProfiler : public ::Il2CppObject {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x1086F7C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x1086FB8
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x1086FF4
