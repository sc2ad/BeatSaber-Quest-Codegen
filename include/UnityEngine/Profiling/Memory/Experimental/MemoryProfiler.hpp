...
namespace UnityEngine::Profiling::Memory::Experimental {
  ...
  // [NativeHeaderAttribute] Offset: 11C146C
  class MemoryProfiler : public ::Il2CppObject {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x11C44B4
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x11C44F0
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x11C452C
