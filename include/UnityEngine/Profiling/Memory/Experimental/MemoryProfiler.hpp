...
namespace UnityEngine::Profiling::Memory::Experimental {
  ...
  class MemoryProfiler : public ::CsObject {
    ...
    static System::Action_3<::CsString*, bool, UnityEngine::Profiling::Experimental::DebugScreenCapture>* _get_m_SaveScreenshotToDisk();
    ...
    static void _set_m_SaveScreenshotToDisk(System::Action_3<::CsString*, bool, UnityEngine::Profiling::Experimental::DebugScreenCapture>* value);
    ...
    // Offset: 0x14155DC
    static int WriteStringToByteArray(::Array<uint8_t>* array, int offset, ::CsString* value);
    // static private System.Void FinalizeSnapshot(System.String path, System.Boolean result)
    // Offset: 0x1415684
    static void FinalizeSnapshot(::CsString* path, bool result);
    ...
    // Offset: 0x141571C
    static void SaveScreenshotToDisk(::CsString* path, bool result, System::IntPtr pixelsPtr, int pixelsCount, UnityEngine::TextureFormat format, int width, int height);
