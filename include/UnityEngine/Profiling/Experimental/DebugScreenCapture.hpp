...
namespace UnityEngine::Profiling::Experimental {
  ...
  check_size<sizeof(DebugScreenCapture), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __UnityEngine_Profiling_Experimental_DebugScreenCaptureSizeCheck;
}
