...
namespace UnityEngine {
  ...
  class TouchScreenKeyboard : public ::CsObject {
    public:
    ...
    // Offset: 0x137C664
    static TouchScreenKeyboard* New_ctor(::CsString* text, UnityEngine::TouchScreenKeyboardType keyboardType, bool autocorrection, bool multiline, bool secure, bool alert, ::CsString* textPlaceholder, int characterLimit);
    ...
    // Offset: 0x137C7C8
    static System::IntPtr TouchScreenKeyboard_InternalConstructorHelper(UnityEngine::TouchScreenKeyboard_InternalConstructorHelperArguments& arguments, ::CsString* text, ::CsString* textPlaceholder);
    ...
    // Offset: 0x137C894
    static UnityEngine::TouchScreenKeyboard* Open(::CsString* text, UnityEngine::TouchScreenKeyboardType keyboardType, bool autocorrection, bool multiline, bool secure, bool alert, ::CsString* textPlaceholder, int characterLimit);
    ...
    // Offset: 0x137C954
    static UnityEngine::TouchScreenKeyboard* Open(::CsString* text, UnityEngine::TouchScreenKeyboardType keyboardType, bool autocorrection, bool multiline, bool secure);
