...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: DDB928
  // [RequireComponent] Offset: DDB928
  class AudioSource : public UnityEngine::AudioBehaviour {
    ...
    // Offset: 0x2401100
    static void GetSpectrumDataHelper(UnityEngine::AudioSource* source, ByRef<::Array<float>*> samples, int channel, UnityEngine::FFTWindow window);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::AudioSource*, ByRef<::Array<float>*>, int, UnityEngine::FFTWindow)>(&UnityEngine::AudioSource::GetSpectrumDataHelper)> {
  static const MethodInfo* get() {
    static auto* source = &::il2cpp_utils::GetClassFromName("UnityEngine", "AudioSource")->byval_arg;
