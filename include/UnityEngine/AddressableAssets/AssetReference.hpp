...
namespace UnityEngine::AddressableAssets {
  ...
  class AssetReference : public ::Il2CppObject/*, public UnityEngine::AddressableAssets::IKeyEvaluator*/ {
    ...
    #endif
    #endif
    // [FormerlySerializedAsAttribute] Offset: 0xF2D5CC
    ...
    static UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T> CreateFailedOperation() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<T>, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method)));
    }
    ...
    UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject> LoadAsset() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>, false>(this, ___generic__method)));
    }
