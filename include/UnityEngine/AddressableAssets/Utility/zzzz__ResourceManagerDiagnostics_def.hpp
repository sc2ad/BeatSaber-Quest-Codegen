...
/// @brief Method OnResourceManagerDiagnosticEvent addr 0x2897750 size 0x3c8 virtual false final false
 void OnResourceManagerDiagnosticEvent(::UnityEngine::ResourceManagement::____UnityEngine__ResourceManagement__ResourceManager__DiagnosticEventContext eventContext) ;
