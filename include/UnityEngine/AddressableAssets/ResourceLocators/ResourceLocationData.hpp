...
namespace UnityEngine::AddressableAssets::ResourceLocators {
  ...
  class ResourceLocationData : public ::Il2CppObject {
    public:
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x11162A0
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x11162EC
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x1116338
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [FormerlySerializedAsAttribute] Offset: 0x1116384
