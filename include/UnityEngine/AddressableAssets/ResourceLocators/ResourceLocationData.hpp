...
namespace UnityEngine::AddressableAssets::ResourceLocators {
  ...
  class ResourceLocationData : public ::Il2CppObject {
    public:
    public:
    // [FormerlySerializedAsAttribute] Offset: 0x10C9A74
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x10C9AC0
    ...
    // [FormerlySerializedAsAttribute] Offset: 0x10C9B0C
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [FormerlySerializedAsAttribute] Offset: 0x10C9B58
