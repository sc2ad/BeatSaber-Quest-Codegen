...
namespace UnityEngine::AddressableAssets {
struct ____UnityEngine__AddressableAssets__Addressables__MergeMode;
}
...
constexpr ::System::Type __get__Type_k__BackingField() const;
 ...
 ::System::Nullable_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode> __declspec(property(get=__get__MergeMode_k__BackingField, put=__set__MergeMode_k__BackingField))  _MergeMode_k__BackingField;

constexpr void __set__MergeMode_k__BackingField(::System::Nullable_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode> value) ;

constexpr ::System::Nullable_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode> __get__MergeMode_k__BackingField() const;
...
// Properties
 ...
 ::System::Nullable_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode> __declspec(property(get=get_MergeMode))  MergeMode;
...
/// @brief Method get_MergeMode addr 0x287e764 size 0x8 virtual false final false
 ::System::Nullable_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode> get_MergeMode() ;
...
// Ctor Parameters [CppParam { name: "key", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "type", ty: "::System::Type", modifiers: "", def_value: None }, CppParam { name: "mergeMode", ty: "::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode", modifiers: "", def_value: None }]
explicit InvalidKeyException(::bs_hook::Il2CppWrapperType key, ::System::Type type, ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode mergeMode) ;

/// @brief Method .ctor addr 0x287e8e8 size 0xac virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType key, ::System::Type type, ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode mergeMode) ;

// Ctor Parameters [CppParam { name: "key", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "type", ty: "::System::Type", modifiers: "", def_value: None }, CppParam { name: "mergeMode", ty: "::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode", modifiers: "", def_value: None }, CppParam { name: "addr", ty: "::UnityEngine::AddressableAssets::AddressablesImpl", modifiers: "", def_value: None }]
explicit InvalidKeyException(::bs_hook::Il2CppWrapperType key, ::System::Type type, ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode mergeMode, ::UnityEngine::AddressableAssets::AddressablesImpl addr) ;

/// @brief Method .ctor addr 0x287e994 size 0xb8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType key, ::System::Type type, ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__Addressables__MergeMode mergeMode, ::UnityEngine::AddressableAssets::AddressablesImpl addr) ;
