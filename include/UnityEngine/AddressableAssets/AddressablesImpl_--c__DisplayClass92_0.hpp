...
namespace UnityEngine::AddressableAssets {
  ...
  // Writing MetadataGetter for method: AddressablesImpl::$$c__DisplayClass92_0::$DownloadDependenciesAsyncWithChain$b__0
  // Il2CppName: <DownloadDependenciesAsyncWithChain>b__0
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource*>*> (AddressablesImpl::$$c__DisplayClass92_0::*)(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle)>(&AddressablesImpl::$$c__DisplayClass92_0::$DownloadDependenciesAsyncWithChain$b__0)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(AddressablesImpl::$$c__DisplayClass92_0*), "<DownloadDependenciesAsyncWithChain>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>()});
    }
  };
  // Writing MetadataGetter for method: AddressablesImpl::$$c__DisplayClass92_0::$DownloadDependenciesAsyncWithChain$b__1
  // Il2CppName: <DownloadDependenciesAsyncWithChain>b__1
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (AddressablesImpl::$$c__DisplayClass92_0::*)(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource*>*>)>(&AddressablesImpl::$$c__DisplayClass92_0::$DownloadDependenciesAsyncWithChain$b__1)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(AddressablesImpl::$$c__DisplayClass92_0*), "<DownloadDependenciesAsyncWithChain>b__1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceProviders::IAssetBundleResource*>*>>()});
    }
  };
  // Writing MetadataGetter for method: AddressablesImpl::$$c__DisplayClass92_0::New_ctor
  // Il2CppName: .ctor
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (AddressablesImpl::$$c__DisplayClass92_0::*)()>(&AddressablesImpl::$$c__DisplayClass92_0::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(AddressablesImpl::$$c__DisplayClass92_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (AddressablesImpl::$$c__DisplayClass92_0::*)()>(&AddressablesImpl::$$c__DisplayClass92_0::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(AddressablesImpl::$$c__DisplayClass92_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
