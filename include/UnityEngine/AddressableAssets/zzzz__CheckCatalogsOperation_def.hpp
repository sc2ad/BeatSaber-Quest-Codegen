...
namespace UnityEngine::AddressableAssets {
class ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c;
}
// Type: ::<>c
namespace UnityEngine::AddressableAssets {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____UnityEngine__AddressableAssets__CheckCatalogsOperation____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__AddressableAssets__CheckCatalogsOperation____c", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c(____UnityEngine__AddressableAssets__CheckCatalogsOperation____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__AddressableAssets__CheckCatalogsOperation____c", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c(____UnityEngine__AddressableAssets__CheckCatalogsOperation____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c& operator=(____UnityEngine__AddressableAssets__CheckCatalogsOperation____c&& o) noexcept = default;
  constexpr ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c& operator=(____UnityEngine__AddressableAssets__CheckCatalogsOperation____c const& o) noexcept = default;
                


// Fields

static ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c value) ;

static ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c __get___9() ;
...
// Ctor Parameters []
explicit ____UnityEngine__AddressableAssets__CheckCatalogsOperation____c() ;
...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 380 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14313), inst: 770 }), TypeDefinitionIndex(TypeDefinitionIndex(14313)), TypeDefinitionIndex(TypeDefinitionIndex(3828))}
...
public:
// Declarations
using __c = ::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c;
...
constexpr ::System::Collections::Generic::List_1<::StringW> __get_m_LocalHashes() const;
 ...
 ::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__AddressablesImpl__ResourceLocatorInfo> __declspec(property(get=__get_m_LocatorInfos, put=__set_m_LocatorInfos))  m_LocatorInfos;

constexpr void __set_m_LocatorInfos(::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__AddressablesImpl__ResourceLocatorInfo> value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__AddressablesImpl__ResourceLocatorInfo> __get_m_LocatorInfos() const;
...
/// @brief Method Start addr 0x288f5c0 size 0x5f4 virtual false final false
 ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::List_1<::StringW>> Start(::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__AddressablesImpl__ResourceLocatorInfo> locatorInfos) ;
...
NEED_NO_BOX(::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::AddressableAssets::____UnityEngine__AddressableAssets__CheckCatalogsOperation____c, "UnityEngine.AddressableAssets", "CheckCatalogsOperation/<>c");
