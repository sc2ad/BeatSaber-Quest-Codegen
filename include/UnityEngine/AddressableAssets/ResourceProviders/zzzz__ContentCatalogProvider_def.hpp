...
struct CORDL_TYPE UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex(int32_t value__) noexcept;


                    constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex const&) = default;
                    constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex&&) = default;
                    constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex&& o) noexcept {
...
constexpr explicit UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex_Unwrapped : int32_t {
__Remote = 0,
__Cache = 1,
__Count = 2,
};
...
static UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex const Remote;

/// @brief Field Cache offset 0
static UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex const Cache;

/// @brief Field Count offset 0
static UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex const Count;
...
class CORDL_TYPE UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x60};

virtual ~UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog", modifiers: " const&", def_value: None }]
constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog", modifiers: "&&", def_value: None }]
constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog&& o) noexcept = default;
  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog const& o) noexcept = default;
...
class CORDL_TYPE UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using BundledCatalog = GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x78};

virtual ~UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp", modifiers: " const&", def_value: None }]
constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp", modifiers: "&&", def_value: None }]
constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp&& o) noexcept = default;
  constexpr UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp& operator=(UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp const& o) noexcept = default;
...
constexpr UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData> __get_m_ContentCatalogDataLoadOp() const;
 ...
 GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog __declspec(property(get=__get_m_BundledCatalog, put=__set_m_BundledCatalog))  m_BundledCatalog;

constexpr void __set_m_BundledCatalog(GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog value) ;

constexpr GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog __get_m_BundledCatalog() const;
...
public:
// Declarations
using InternalOp = UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp;

using DependencyHashIndex = UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex;
...
constexpr void __set_m_LocationToCatalogLoadOpMap(System::Collections::Generic::Dictionary_2<UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation,UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp> value) ;

constexpr System::Collections::Generic::Dictionary_2<UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation,UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp> __get_m_LocationToCatalogLoadOpMap() const;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__DependencyHashIndex, "UnityEngine.AddressableAssets.ResourceProviders", "ContentCatalogProvider/DependencyHashIndex");
NEED_NO_BOX(GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp__BundledCatalog, "UnityEngine.AddressableAssets.ResourceProviders", "ContentCatalogProvider/InternalOp/BundledCatalog");
...
NEED_NO_BOX(UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::AddressableAssets::ResourceProviders::UnityEngine__AddressableAssets__ResourceProviders__ContentCatalogProvider__InternalOp, "UnityEngine.AddressableAssets.ResourceProviders", "ContentCatalogProvider/InternalOp");
