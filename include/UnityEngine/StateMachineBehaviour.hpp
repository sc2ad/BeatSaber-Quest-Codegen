...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [RequiredByNativeCodeAttribute] Offset: CBD094
  class StateMachineBehaviour : public UnityEngine::ScriptableObject {
    ...
    // Offset: 0x2144FB8
    void OnStateEnter_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex);
    ...
    // Offset: 0x2144FBC
    void OnStateUpdate_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex);
    ...
    // Offset: 0x2144FC0
    void OnStateExit_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex);
    ...
    // Offset: 0x2144FC4
    void OnStateMove_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex);
    ...
    // Offset: 0x2144FC8
    void OnStateIK_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex);
    // public System.Void OnStateMachineEnter(UnityEngine.Animator animator, System.Int32 stateMachinePathHash)
    // Offset: 0x2144FCC
    void OnStateMachineEnter_NEW(UnityEngine::Animator* animator, int stateMachinePathHash);
    // public System.Void OnStateMachineExit(UnityEngine.Animator animator, System.Int32 stateMachinePathHash)
    // Offset: 0x2144FD0
    void OnStateMachineExit_NEW(UnityEngine::Animator* animator, int stateMachinePathHash);
    ...
    // Offset: 0x2144FD4
    void OnStateEnter_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FD8
    void OnStateUpdate_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FDC
    void OnStateExit_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FE0
    void OnStateMove_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FE4
    void OnStateIK_NEW(UnityEngine::Animator* animator, UnityEngine::AnimatorStateInfo stateInfo, int layerIndex, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FE8
    void OnStateMachineEnter_NEW(UnityEngine::Animator* animator, int stateMachinePathHash, UnityEngine::Animations::AnimatorControllerPlayable controller);
    ...
    // Offset: 0x2144FEC
    void OnStateMachineExit_NEW(UnityEngine::Animator* animator, int stateMachinePathHash, UnityEngine::Animations::AnimatorControllerPlayable controller);
