...
struct CORDL_TYPE Space : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr Space(int32_t value__) noexcept;
                    ...
                    constexpr Space(Space const&) = default;
                    constexpr Space(Space&&) = default;
                    constexpr Space& operator=(Space const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Space& operator=(Space&& o) noexcept {
...
constexpr explicit Space(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Space_Unwrapped : int32_t {
__World = 0,
__Self = 1,
};
...
return std::bit_cast<__Space_Unwrapped>(__instance);
}
