...
static bool TryGetDataFromSource(UnityEngine::SpatialTracking::UnityEngine__SpatialTracking__TrackedPoseDriver__TrackedPose poseSource, ByRef<UnityEngine::Pose> resultPose) ;

/// @brief Method GetDataFromSource addr 0x2ba2464 size 0x270 virtual false final false
static UnityEngine::SpatialTracking::PoseDataFlags GetDataFromSource(UnityEngine::SpatialTracking::UnityEngine__SpatialTracking__TrackedPoseDriver__TrackedPose poseSource, ByRef<UnityEngine::Pose> resultPose) ;
