...
namespace UnityEngine {
  ...
  check_size<sizeof(SkeletonBone), 44 + sizeof(UnityEngine::Vector3) + ((44 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (44 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __UnityEngine_SkeletonBoneSizeCheck;
}
