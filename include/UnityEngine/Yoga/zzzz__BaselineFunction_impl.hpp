...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (UnityEngine::Yoga::BaselineFunction::*)(UnityEngine::Yoga::YogaNode, float_t, float_t)>(&UnityEngine::Yoga::BaselineFunction::Invoke)> {
 ...
 UnityEngine::Yoga::BaselineFunction UnityEngine::Yoga::BaselineFunction::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
UnityEngine::Yoga::BaselineFunction o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::Yoga::BaselineFunction>(object, method))};
return o;
}
