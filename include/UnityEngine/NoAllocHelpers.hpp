...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: EB4FC0
  class NoAllocHelpers : public ::Il2CppObject {
    ...
    static void ResizeList(System::Collections::Generic::List_1<T>* list, int size) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, size)));
    }
    ...
    static void EnsureListElemCount(System::Collections::Generic::List_1<T>* list, int count) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, count)));
    }
    ...
    static int SafeLength(System::Collections::Generic::List_1<T>* values) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, values)));
    }
    ...
    static ::ArrayW<T> ExtractArrayFromListT(System::Collections::Generic::List_1<T>* list) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<::ArrayW<T>, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list)));
    }
