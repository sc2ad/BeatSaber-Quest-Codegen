...
namespace UnityEngine {
class ____UnityEngine__GUI__WindowFunction;
}
// Type: ::WindowFunction
namespace UnityEngine {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__GUI__WindowFunction : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____UnityEngine__GUI__WindowFunction() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUI__WindowFunction", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__GUI__WindowFunction(____UnityEngine__GUI__WindowFunction const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__GUI__WindowFunction", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__GUI__WindowFunction(____UnityEngine__GUI__WindowFunction&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__GUI__WindowFunction(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____UnityEngine__GUI__WindowFunction& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__GUI__WindowFunction& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__GUI__WindowFunction& operator=(____UnityEngine__GUI__WindowFunction&& o) noexcept = default;
  constexpr ____UnityEngine__GUI__WindowFunction& operator=(____UnityEngine__GUI__WindowFunction const& o) noexcept = default;
...
explicit ____UnityEngine__GUI__WindowFunction(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using WindowFunction = ::UnityEngine::____UnityEngine__GUI__WindowFunction;
...
static void CallWindowDelegate(::UnityEngine::____UnityEngine__GUI__WindowFunction func, int32_t id, int32_t instanceID, ::UnityEngine::GUISkin _skin, int32_t forceRect, float_t width, float_t height, ::UnityEngine::GUIStyle style) ;
...
NEED_NO_BOX(::UnityEngine::____UnityEngine__GUI__WindowFunction);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::____UnityEngine__GUI__WindowFunction, "UnityEngine", "GUI/WindowFunction");
