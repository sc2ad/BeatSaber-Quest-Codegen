...
constexpr ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent(::StringW buildGuid, ::StringW buildTarget, ::StringW buildTargetGroup, ::ArrayW<::StringW> assigned_loaders) noexcept : ::bs_hook::ValueTypeWrapper() {this->buildGuid = buildGuid;
this->buildTarget = buildTarget;
this->buildTargetGroup = buildTargetGroup;
this->assigned_loaders = assigned_loaders;
}
constexpr void ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__set_buildGuid(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x0>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__get_buildGuid() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__set_buildTarget(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x8>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__get_buildTarget() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__set_buildTargetGroup(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__get_buildTargetGroup() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->__instance);
}
constexpr void ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__set_assigned_loaders(::ArrayW<::StringW> value)  {
::cordl_internals::setInstanceField<::ArrayW<::StringW>, 0x18>(this->__instance, std::forward<::ArrayW<::StringW>>(value));
}
constexpr ::ArrayW<::StringW> ::UnityEngine::XR::Management::____UnityEngine__XR__Management__XRManagementAnalytics__BuildEvent::__get_assigned_loaders() const {
