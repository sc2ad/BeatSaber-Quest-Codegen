...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10B3D20
  // [RequiredByNativeCodeAttribute] Offset: 10B3D20
  // [NativeConditionalAttribute] Offset: 10B3D20
  // [StaticAccessorAttribute] Offset: 10B3D20
  // [NativeHeaderAttribute] Offset: 10B3D20
  // [NativeHeaderAttribute] Offset: 10B3D20
