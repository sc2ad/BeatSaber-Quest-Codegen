...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10ABFB0
  // [RequiredByNativeCodeAttribute] Offset: 10ABFB0
  // [NativeConditionalAttribute] Offset: 10ABFB0
  // [StaticAccessorAttribute] Offset: 10ABFB0
  // [NativeHeaderAttribute] Offset: 10ABFB0
  // [NativeHeaderAttribute] Offset: 10ABFB0
