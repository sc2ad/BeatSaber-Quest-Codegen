...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10ACEB0
  // [RequiredByNativeCodeAttribute] Offset: 10ACEB0
  // [NativeConditionalAttribute] Offset: 10ACEB0
  // [StaticAccessorAttribute] Offset: 10ACEB0
  // [NativeHeaderAttribute] Offset: 10ACEB0
  // [NativeHeaderAttribute] Offset: 10ACEB0
