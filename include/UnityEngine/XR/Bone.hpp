...
namespace UnityEngine::XR {
  ...
  // [] Offset: FFFFFFFF
  // [StaticAccessorAttribute] Offset: CE04BC
  // [NativeHeaderAttribute] Offset: CE04BC
  // [NativeHeaderAttribute] Offset: CE04BC
  // [NativeHeaderAttribute] Offset: CE04BC
  // [NativeConditionalAttribute] Offset: CE04BC
  // [RequiredByNativeCodeAttribute] Offset: CE04BC
