...
namespace UnityEngine::XR {
  ...
  // [] Offset: FFFFFFFF
  // [RequiredByNativeCodeAttribute] Offset: CCAC14
  // [NativeConditionalAttribute] Offset: CCAC14
  // [NativeHeaderAttribute] Offset: CCAC14
  // [StaticAccessorAttribute] Offset: CCAC14
  // [NativeHeaderAttribute] Offset: CCAC14
  // [NativeHeaderAttribute] Offset: CCAC14
