...
namespace UnityEngine::XR {
  ...
  // [NativeTypeAttribute] Offset: 10AB3A8
  // [NativeHeaderAttribute] Offset: 10AB3A8
  // [NativeConditionalAttribute] Offset: 10AB3A8
  // [UsedByNativeCodeAttribute] Offset: 10AB3A8
