...
namespace UnityEngine::XR {
  ...
  // [NativeTypeAttribute] Offset: 10B591C
  // [NativeHeaderAttribute] Offset: 10B591C
  // [NativeConditionalAttribute] Offset: 10B591C
  // [UsedByNativeCodeAttribute] Offset: 10B591C
