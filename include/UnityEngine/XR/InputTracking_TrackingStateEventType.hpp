...
namespace UnityEngine::XR {
  ...
  check_size<sizeof(InputTracking::TrackingStateEventType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_XR_InputTracking_TrackingStateEventTypeSizeCheck;
}
