...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: EDBB14
  // [NativeTypeAttribute] Offset: EDBB14
  // [UsedByNativeCodeAttribute] Offset: EDBB14
  class XRInputSubsystem : public UnityEngine::IntegratedSubsystem_1<UnityEngine::XR::XRInputSubsystemDescriptor*> {
    ...
    #endif
    #endif
    // [DebuggerBrowsableAttribute] Offset: 0xEDC078
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xEDC0B4
