...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10AB548
  // [NativeTypeAttribute] Offset: 10AB548
  // [UsedByNativeCodeAttribute] Offset: 10AB548
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10ABAAC
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10ABAE8
