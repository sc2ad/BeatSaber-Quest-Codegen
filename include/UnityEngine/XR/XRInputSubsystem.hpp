...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: E50C78
  // [NativeTypeAttribute] Offset: E50C78
  // [UsedByNativeCodeAttribute] Offset: E50C78
  class XRInputSubsystem : public UnityEngine::IntegratedSubsystem_1<UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xE511E0
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xE5121C
