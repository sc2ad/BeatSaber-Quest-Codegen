...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: DA405C
  // [NativeTypeAttribute] Offset: DA405C
  // [UsedByNativeCodeAttribute] Offset: DA405C
  class XRInputSubsystem : public UnityEngine::IntegratedSubsystem_1<UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xDA45C4
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDA4600
