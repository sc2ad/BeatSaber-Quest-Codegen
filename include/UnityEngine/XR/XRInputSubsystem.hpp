...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10AD1C8
  // [NativeTypeAttribute] Offset: 10AD1C8
  // [UsedByNativeCodeAttribute] Offset: 10AD1C8
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10AD72C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10AD768
