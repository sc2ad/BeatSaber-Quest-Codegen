...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10B5ABC
  // [NativeTypeAttribute] Offset: 10B5ABC
  // [UsedByNativeCodeAttribute] Offset: 10B5ABC
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10B6020
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10B605C
