...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10BAC28
  // [NativeTypeAttribute] Offset: 10BAC28
  // [UsedByNativeCodeAttribute] Offset: 10BAC28
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10BB18C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10BB1C8
