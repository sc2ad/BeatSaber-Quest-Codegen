...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10AC2C8
  // [NativeTypeAttribute] Offset: 10AC2C8
  // [UsedByNativeCodeAttribute] Offset: 10AC2C8
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10AC82C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10AC868
