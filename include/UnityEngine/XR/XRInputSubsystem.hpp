...
namespace UnityEngine::XR {
  ...
  // [NativeConditionalAttribute] Offset: 10B4038
  // [NativeTypeAttribute] Offset: 10B4038
  // [UsedByNativeCodeAttribute] Offset: 10B4038
  class XRInputSubsystem : public ::UnityEngine::IntegratedSubsystem_1<::UnityEngine::XR::XRInputSubsystemDescriptor*> {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10B459C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10B45D8
