...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10ACCF0
  // [RequiredByNativeCodeAttribute] Offset: 10ACCF0
  // [NativeConditionalAttribute] Offset: 10ACCF0
  // [NativeHeaderAttribute] Offset: 10ACCF0
  // [NativeHeaderAttribute] Offset: 10ACCF0
  // [StaticAccessorAttribute] Offset: 10ACCF0
