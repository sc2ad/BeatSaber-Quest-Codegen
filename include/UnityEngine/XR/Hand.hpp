...
namespace UnityEngine::XR {
  ...
  // [] Offset: FFFFFFFF
  // [StaticAccessorAttribute] Offset: CE02FC
  // [NativeConditionalAttribute] Offset: CE02FC
  // [RequiredByNativeCodeAttribute] Offset: CE02FC
  // [NativeHeaderAttribute] Offset: CE02FC
  // [NativeHeaderAttribute] Offset: CE02FC
  // [NativeHeaderAttribute] Offset: CE02FC
