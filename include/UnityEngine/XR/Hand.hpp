...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10ABDF0
  // [RequiredByNativeCodeAttribute] Offset: 10ABDF0
  // [NativeConditionalAttribute] Offset: 10ABDF0
  // [NativeHeaderAttribute] Offset: 10ABDF0
  // [NativeHeaderAttribute] Offset: 10ABDF0
  // [StaticAccessorAttribute] Offset: 10ABDF0
