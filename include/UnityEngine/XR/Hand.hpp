...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 107F1A0
  // [RequiredByNativeCodeAttribute] Offset: 107F1A0
  // [NativeConditionalAttribute] Offset: 107F1A0
  // [NativeHeaderAttribute] Offset: 107F1A0
  // [NativeHeaderAttribute] Offset: 107F1A0
  // [StaticAccessorAttribute] Offset: 107F1A0
