...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: DA3B84
  // [StaticAccessorAttribute] Offset: DA3B84
  // [RequiredByNativeCodeAttribute] Offset: DA3B84
  // [NativeHeaderAttribute] Offset: DA3B84
  // [NativeHeaderAttribute] Offset: DA3B84
  // [NativeConditionalAttribute] Offset: DA3B84
