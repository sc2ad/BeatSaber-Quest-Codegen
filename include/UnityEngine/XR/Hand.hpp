...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10B3B60
  // [RequiredByNativeCodeAttribute] Offset: 10B3B60
  // [NativeConditionalAttribute] Offset: 10B3B60
  // [NativeHeaderAttribute] Offset: 10B3B60
  // [NativeHeaderAttribute] Offset: 10B3B60
  // [StaticAccessorAttribute] Offset: 10B3B60
