...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: DD5B24
  // [NativeHeaderAttribute] Offset: DD5B24
  // [StaticAccessorAttribute] Offset: DD5B24
  // [NativeConditionalAttribute] Offset: DD5B24
