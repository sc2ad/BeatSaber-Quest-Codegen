...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: E9B8B8
  // [NativeHeaderAttribute] Offset: E9B8B8
  // [StaticAccessorAttribute] Offset: E9B8B8
  // [NativeConditionalAttribute] Offset: E9B8B8
