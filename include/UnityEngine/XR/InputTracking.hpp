...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: DA3A10
  // [NativeHeaderAttribute] Offset: DA3A10
  // [StaticAccessorAttribute] Offset: DA3A10
  // [NativeConditionalAttribute] Offset: DA3A10
