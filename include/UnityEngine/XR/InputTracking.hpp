...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: EDB4C8
  // [NativeHeaderAttribute] Offset: EDB4C8
  // [StaticAccessorAttribute] Offset: EDB4C8
  // [NativeConditionalAttribute] Offset: EDB4C8
