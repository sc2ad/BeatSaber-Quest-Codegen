...
namespace UnityEngine::XR {
  ...
  // [RequiredByNativeCodeAttribute] Offset: 10B39EC
  // [NativeHeaderAttribute] Offset: 10B39EC
  // [StaticAccessorAttribute] Offset: 10B39EC
  // [NativeConditionalAttribute] Offset: 10B39EC
