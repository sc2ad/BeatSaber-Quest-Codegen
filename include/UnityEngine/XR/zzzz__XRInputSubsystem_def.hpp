...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15849)), TypeDefinitionIndex(TypeDefinitionIndex(15579)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15849), inst: 3779 })}
...
static UnityEngine::XR::XRInputSubsystem New_ctor() ;
