...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15849), inst: 3779 }), TypeDefinitionIndex(TypeDefinitionIndex(15579)), TypeDefinitionIndex(TypeDefinitionIndex(15849))}
