...
namespace UnityEngine::XR {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10B5B2C
  // [NativeConditionalAttribute] Offset: 10B5B2C
  // [NativeHeaderAttribute] Offset: 10B5B2C
  // [NativeTypeAttribute] Offset: 10B5B2C
