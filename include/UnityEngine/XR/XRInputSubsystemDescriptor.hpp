...
namespace UnityEngine::XR {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10AB5B8
  // [NativeConditionalAttribute] Offset: 10AB5B8
  // [NativeHeaderAttribute] Offset: 10AB5B8
  // [NativeTypeAttribute] Offset: 10AB5B8
