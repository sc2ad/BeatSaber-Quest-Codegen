...
namespace UnityEngine::XR {
  ...
  // [UsedByNativeCodeAttribute] Offset: 10BAC98
  // [NativeConditionalAttribute] Offset: 10BAC98
  // [NativeHeaderAttribute] Offset: 10BAC98
  // [NativeTypeAttribute] Offset: 10BAC98
