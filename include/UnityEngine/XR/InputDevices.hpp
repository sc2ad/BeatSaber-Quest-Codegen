...
namespace UnityEngine::XR {
  ...
  // [UsedByNativeCodeAttribute] Offset: CCACF4
  // [NativeHeaderAttribute] Offset: CCACF4
  // [StaticAccessorAttribute] Offset: CCACF4
  // [NativeConditionalAttribute] Offset: CCACF4
