...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10ACF90
  // [UsedByNativeCodeAttribute] Offset: 10ACF90
  // [StaticAccessorAttribute] Offset: 10ACF90
  // [NativeConditionalAttribute] Offset: 10ACF90
  class InputDevices : public ::Il2CppObject {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10AD63C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10AD678
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10AD6B4
