...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: DD5F38
  // [UsedByNativeCodeAttribute] Offset: DD5F38
  // [StaticAccessorAttribute] Offset: DD5F38
  // [NativeConditionalAttribute] Offset: DD5F38
