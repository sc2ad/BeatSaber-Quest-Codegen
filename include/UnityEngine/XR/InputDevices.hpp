...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 11CE2F8
  // [UsedByNativeCodeAttribute] Offset: 11CE2F8
  // [StaticAccessorAttribute] Offset: 11CE2F8
  // [NativeConditionalAttribute] Offset: 11CE2F8
