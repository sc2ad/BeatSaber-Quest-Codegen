...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: E9BCCC
  // [UsedByNativeCodeAttribute] Offset: E9BCCC
  // [StaticAccessorAttribute] Offset: E9BCCC
  // [NativeConditionalAttribute] Offset: E9BCCC
