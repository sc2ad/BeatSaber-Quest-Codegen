...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 10B3E00
  // [UsedByNativeCodeAttribute] Offset: 10B3E00
  // [StaticAccessorAttribute] Offset: 10B3E00
  // [NativeConditionalAttribute] Offset: 10B3E00
