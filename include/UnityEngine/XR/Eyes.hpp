...
namespace UnityEngine::XR {
  ...
  // [NativeHeaderAttribute] Offset: 1094C64
  // [NativeHeaderAttribute] Offset: 1094C64
  // [RequiredByNativeCodeAttribute] Offset: 1094C64
  // [NativeHeaderAttribute] Offset: 1094C64
  // [StaticAccessorAttribute] Offset: 1094C64
  // [NativeConditionalAttribute] Offset: 1094C64
