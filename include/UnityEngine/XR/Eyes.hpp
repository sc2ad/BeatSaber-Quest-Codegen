...
namespace UnityEngine::XR {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CCAB34
  // [NativeHeaderAttribute] Offset: CCAB34
  // [RequiredByNativeCodeAttribute] Offset: CCAB34
  // [NativeHeaderAttribute] Offset: CCAB34
  // [StaticAccessorAttribute] Offset: CCAB34
  // [NativeConditionalAttribute] Offset: CCAB34
