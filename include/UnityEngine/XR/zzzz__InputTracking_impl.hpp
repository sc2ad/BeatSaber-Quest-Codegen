...
constexpr ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::____UnityEngine__XR__InputTracking__TrackingStateEventType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType  ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::NodeAdded{0};
constexpr ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType  ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::NodeRemoved{1};
constexpr ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType  ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::TrackingAcquired{2};
constexpr ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType  ::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType::TrackingLost{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType, ::UnityEngine::XR::XRNode, int64_t, bool)>(&::UnityEngine::XR::InputTracking::InvokeTrackingEvent)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "InvokeTrackingEvent",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::XR::XRNode>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int64_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, value);
 ...
 void ::UnityEngine::XR::InputTracking::InvokeTrackingEvent(::UnityEngine::XR::____UnityEngine__XR__InputTracking__TrackingStateEventType eventType, ::UnityEngine::XR::XRNode nodeType, int64_t uniqueID, bool tracked)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::XR::InputTracking>::get(),
                            "InvokeTrackingEvent",
                            std::vector<Il2CppClass*>{},
