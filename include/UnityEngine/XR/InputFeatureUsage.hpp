...
namespace UnityEngine::XR {
  ...
  check_size<sizeof(InputFeatureUsage), 8 + sizeof(UnityEngine::XR::InputFeatureType) + ((8 + sizeof(UnityEngine::XR::InputFeatureType)) % 8 != 0 ? (8 - (8 + sizeof(UnityEngine::XR::InputFeatureType)) % 8) : 0)> __UnityEngine_XR_InputFeatureUsageSizeCheck;
}
