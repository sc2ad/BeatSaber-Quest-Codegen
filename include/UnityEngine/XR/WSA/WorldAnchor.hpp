...
namespace UnityEngine::XR::WSA {
  ...
  // [RequireComponent] Offset: 10AD340
  // [UsedByNativeCodeAttribute] Offset: 10AD340
  // [MovedFromAttribute] Offset: 10AD340
  // [NativeHeaderAttribute] Offset: 10AD340
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10AD438
