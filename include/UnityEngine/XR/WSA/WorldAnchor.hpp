...
namespace UnityEngine::XR::WSA {
  ...
  // [UsedByNativeCodeAttribute] Offset: DC9FCC
  // [NativeHeaderAttribute] Offset: DC9FCC
  // [RequireComponent] Offset: DC9FCC
  // [MovedFromAttribute] Offset: DC9FCC
  class WorldAnchor : public UnityEngine::Component {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xDCA0C4
    // [CompilerGeneratedAttribute] Offset: 0xDCA0C4
