...
namespace UnityEngine::XR::WSA {
  ...
  // [RequireComponent] Offset: 10C54AC
  // [UsedByNativeCodeAttribute] Offset: 10C54AC
  // [MovedFromAttribute] Offset: 10C54AC
  // [NativeHeaderAttribute] Offset: 10C54AC
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10C55A4
