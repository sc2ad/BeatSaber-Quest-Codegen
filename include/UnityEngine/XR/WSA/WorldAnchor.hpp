...
namespace UnityEngine::XR::WSA {
  ...
  // [RequireComponent] Offset: 10CB31C
  // [UsedByNativeCodeAttribute] Offset: 10CB31C
  // [MovedFromAttribute] Offset: 10CB31C
  // [NativeHeaderAttribute] Offset: 10CB31C
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10CB414
