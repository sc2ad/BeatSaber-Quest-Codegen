...
namespace UnityEngine::XR::WSA {
  ...
  // [RequireComponent] Offset: 10CCD64
  // [UsedByNativeCodeAttribute] Offset: 10CCD64
  // [MovedFromAttribute] Offset: 10CCD64
  // [NativeHeaderAttribute] Offset: 10CCD64
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10CCE5C
