...
namespace UnityEngine::XR::WSA {
  ...
  // [] Offset: FFFFFFFF
  // [UsedByNativeCodeAttribute] Offset: CDCED0
  // [NativeHeaderAttribute] Offset: CDCED0
  // [RequireComponent] Offset: CDCED0
  // [MovedFromAttribute] Offset: CDCED0
  class WorldAnchor : public UnityEngine::Component {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xCDCFC8
    // [CompilerGeneratedAttribute] Offset: 0xCDCFC8
