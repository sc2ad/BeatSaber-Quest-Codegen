...
namespace UnityEngine::XR::WSA {
  ...
  // [RequireComponent] Offset: 10C35AC
  // [UsedByNativeCodeAttribute] Offset: 10C35AC
  // [MovedFromAttribute] Offset: 10C35AC
  // [NativeHeaderAttribute] Offset: 10C35AC
  class WorldAnchor : public ::UnityEngine::Component {
    ...
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10C36A4
