...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 UnityEngine::XR::WindowsMR::Input::WMRHMD UnityEngine::XR::WindowsMR::Input::WMRHMD::New_ctor()  {
UnityEngine::XR::WindowsMR::Input::WMRHMD o{THROW_UNLESS(::il2cpp_utils::New<UnityEngine::XR::WindowsMR::Input::WMRHMD>())};
return o;
}
