...
namespace UnityEngine::XR {
  ...
  check_size<sizeof(MeshGenerationResult), 36 + sizeof(UnityEngine::XR::MeshVertexAttributes) + ((36 + sizeof(UnityEngine::XR::MeshVertexAttributes)) % 8 != 0 ? (8 - (36 + sizeof(UnityEngine::XR::MeshVertexAttributes)) % 8) : 0)> __UnityEngine_XR_MeshGenerationResultSizeCheck;
}
