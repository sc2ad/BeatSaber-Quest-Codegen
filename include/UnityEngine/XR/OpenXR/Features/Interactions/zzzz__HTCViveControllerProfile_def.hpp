...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
class ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController;
}
// Type: ::ViveController
namespace UnityEngine::XR::OpenXR::Features::Interactions {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController : public ::UnityEngine::InputSystem::XR::XRControllerWithRumble {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x208};

virtual ~____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController(____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController(____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController(void* ptr) noexcept : ::UnityEngine::InputSystem::XR::XRControllerWithRumble(ptr) {
}


  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController&& o) noexcept = default;
  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController() ;
...
public:
// Declarations
using ViveController = ::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController;
...
NEED_NO_BOX(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__HTCViveControllerProfile__ViveController, "UnityEngine.XR.OpenXR.Features.Interactions", "HTCViveControllerProfile/ViveController");
