...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
class ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController;
}
...
class CORDL_TYPE ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController : public ::UnityEngine::InputSystem::XR::XRControllerWithRumble {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x1d0};

virtual ~____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController(____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController(____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController(void* ptr) noexcept : ::UnityEngine::InputSystem::XR::XRControllerWithRumble(ptr) {
}


  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController&& o) noexcept = default;
  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController() ;
...
public:
// Declarations
using KHRSimpleController = ::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController;
...
NEED_NO_BOX(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__KHRSimpleControllerProfile__KHRSimpleController, "UnityEngine.XR.OpenXR.Features.Interactions", "KHRSimpleControllerProfile/KHRSimpleController");
