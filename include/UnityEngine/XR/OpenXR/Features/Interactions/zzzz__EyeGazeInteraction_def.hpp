...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
class ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice;
}
// Type: ::EyeGazeDevice
namespace UnityEngine::XR::OpenXR::Features::Interactions {
// Is value type: false
...
class CORDL_TYPE ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice : public ::UnityEngine::XR::OpenXR::Input::OpenXRDevice {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x160};

virtual ~____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice(____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice(____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice(void* ptr) noexcept : ::UnityEngine::XR::OpenXR::Input::OpenXRDevice(ptr) {
}


  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice&& o) noexcept = default;
  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice() ;
...
public:
// Declarations
using EyeGazeDevice = ::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice;
...
NEED_NO_BOX(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice, "UnityEngine.XR.OpenXR.Features.Interactions", "EyeGazeInteraction/EyeGazeDevice");
