...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
class ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController;
}
...
class CORDL_TYPE ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController : public ::UnityEngine::InputSystem::XR::XRControllerWithRumble {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x250};

virtual ~____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController(____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController(____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController(void* ptr) noexcept : ::UnityEngine::InputSystem::XR::XRControllerWithRumble(ptr) {
}


  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController&& o) noexcept = default;
  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController() ;
...
public:
// Declarations
using ValveIndexController = ::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController;
...
NEED_NO_BOX(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__ValveIndexControllerProfile__ValveIndexController, "UnityEngine.XR.OpenXR.Features.Interactions", "ValveIndexControllerProfile/ValveIndexController");
