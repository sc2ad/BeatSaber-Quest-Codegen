...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
class ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController;
}
...
class CORDL_TYPE ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController : public ::UnityEngine::InputSystem::XR::XRControllerWithRumble {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x230};

virtual ~____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController(____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController(____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController(void* ptr) noexcept : ::UnityEngine::InputSystem::XR::XRControllerWithRumble(ptr) {
}


  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController&& o) noexcept = default;
  constexpr ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController& operator=(____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController() ;
...
public:
// Declarations
using OculusTouchController = ::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController;
...
NEED_NO_BOX(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::XR::OpenXR::Features::Interactions::____UnityEngine__XR__OpenXR__Features__Interactions__OculusTouchControllerProfile__OculusTouchController, "UnityEngine.XR.OpenXR.Features.Interactions", "OculusTouchControllerProfile/OculusTouchController");
