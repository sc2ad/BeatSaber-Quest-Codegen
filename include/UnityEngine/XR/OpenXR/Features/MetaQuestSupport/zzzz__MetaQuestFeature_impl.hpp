...
constexpr ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice(::StringW visibleName, ::StringW manifestName, bool enabled, bool active) noexcept : ::bs_hook::ValueTypeWrapper() {this->visibleName = visibleName;
this->manifestName = manifestName;
this->enabled = enabled;
this->active = active;
}
constexpr void ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__set_visibleName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x0>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__get_visibleName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__set_manifestName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x8>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__get_manifestName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->__instance);
}
constexpr void ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__set_enabled(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->__instance, std::forward<bool>(value));
}
constexpr bool ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__get_enabled() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->__instance);
}
constexpr void ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__set_active(bool value)  {
::cordl_internals::setInstanceField<bool, 0x11>(this->__instance, std::forward<bool>(value));
}
constexpr bool ::UnityEngine::XR::OpenXR::Features::MetaQuestSupport::____UnityEngine__XR__OpenXR__Features__MetaQuestSupport__MetaQuestFeature__TargetDevice::__get_active() const {
