...
struct CORDL_TYPE UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode(int32_t value__) noexcept;


                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode(UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode const&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode(UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode&&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode& operator=(UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode& operator=(UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode&& o) noexcept {
...
constexpr explicit UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode_Unwrapped : int32_t {
__MultiPass = 0,
...
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode const MultiPass;

/// @brief Field SinglePassInstanced offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode const SinglePassInstanced;
...
struct CORDL_TYPE UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode(int32_t value__) noexcept;


                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode(UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode const&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode(UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode&&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode& operator=(UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode& operator=(UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode_Unwrapped : int32_t {
__None = 0,
__Depth16Bit = 1,
__Depth24Bit = 2,
};
...
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode const None;

/// @brief Field Depth16Bit offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode const Depth16Bit;

/// @brief Field Depth24Bit offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode const Depth24Bit;
...
public:
// Declarations
using DepthSubmissionMode = UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode;

using RenderMode = UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode;
...
constexpr ::ArrayW<UnityEngine::XR::OpenXR::Features::OpenXRFeature> __get_features() const;
 ...
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode __declspec(property(get=__get_m_renderMode, put=__set_m_renderMode))  m_renderMode;

constexpr void __set_m_renderMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode value) ;

constexpr UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode __get_m_renderMode() const;

 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode __declspec(property(get=__get_m_depthSubmissionMode, put=__set_m_depthSubmissionMode))  m_depthSubmissionMode;

constexpr void __set_m_depthSubmissionMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode value) ;

constexpr UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode __get_m_depthSubmissionMode() const;
...
// Properties
 ...
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode __declspec(property(get=get_renderMode, put=set_renderMode))  renderMode;

 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode __declspec(property(get=get_depthSubmissionMode, put=set_depthSubmissionMode))  depthSubmissionMode;
...
/// @brief Method get_renderMode addr 0x2ae4b2c size 0xd8 virtual false final false
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode get_renderMode() ;

/// @brief Method set_renderMode addr 0x2ae4c6c size 0xec virtual false final false
 void set_renderMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode value) ;

/// @brief Method get_depthSubmissionMode addr 0x2ae4dd4 size 0xd8 virtual false final false
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode get_depthSubmissionMode() ;

/// @brief Method set_depthSubmissionMode addr 0x2ae4f14 size 0xec virtual false final false
 void set_depthSubmissionMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode value) ;
...
static void Internal_SetRenderMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode renderMode) ;

/// @brief Method Internal_GetRenderMode addr 0x2ae4c04 size 0x68 virtual false final false
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode Internal_GetRenderMode() ;

/// @brief Method Internal_SetDepthSubmissionMode addr 0x2ae5000 size 0x7c virtual false final false
static void Internal_SetDepthSubmissionMode(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode depthSubmissionMode) ;

/// @brief Method Internal_GetDepthSubmissionMode addr 0x2ae4eac size 0x68 virtual false final false
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode Internal_GetDepthSubmissionMode() ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__DepthSubmissionMode, "UnityEngine.XR.OpenXR", "OpenXRSettings/DepthSubmissionMode");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRSettings__RenderMode, "UnityEngine.XR.OpenXR", "OpenXRSettings/RenderMode");
