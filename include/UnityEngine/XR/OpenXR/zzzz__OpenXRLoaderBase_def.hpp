...
struct CORDL_TYPE UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState(int32_t value__) noexcept;


                    constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState(UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState(UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState&&) = default;
                    constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState&& o) noexcept {
...
constexpr explicit UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState_Unwrapped : int32_t {
__Uninitialized = 0,
...
constexpr operator __UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState_Unwrapped () const noexcept {
...
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const Uninitialized;

/// @brief Field InitializeAttempted offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const InitializeAttempted;

/// @brief Field Initialized offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const Initialized;

/// @brief Field StartAttempted offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const StartAttempted;

/// @brief Field Started offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const Started;

/// @brief Field StopAttempted offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const StopAttempted;

/// @brief Field Stopped offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const Stopped;

/// @brief Field DeinitializeAttempted offset 0
static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState const DeinitializeAttempted;
...
class CORDL_TYPE UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate", modifiers: " const&", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate(UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate", modifiers: "&&", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate(UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate&& o) noexcept = default;
  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate const& o) noexcept = default;
...
/// @brief Method Invoke addr 0x2aeb12c size 0x14 virtual true final false
 void Invoke(UnityEngine::XR::OpenXR::Features::UnityEngine__XR__OpenXR__Features__OpenXRFeature__NativeEvent e, uint64_t payload) ;

/// @brief Method BeginInvoke addr 0x2aeb140 size 0xb4 virtual true final false
 System::IAsyncResult BeginInvoke(UnityEngine::XR::OpenXR::Features::UnityEngine__XR__OpenXR__Features__OpenXRFeature__NativeEvent e, uint64_t payload, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;
...
class CORDL_TYPE UnityEngine__XR__OpenXR__OpenXRLoaderBase____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__XR__OpenXR__OpenXRLoaderBase____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__XR__OpenXR__OpenXRLoaderBase____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c(UnityEngine__XR__OpenXR__OpenXRLoaderBase____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__XR__OpenXR__OpenXRLoaderBase____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c(UnityEngine__XR__OpenXR__OpenXRLoaderBase____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__XR__OpenXR__OpenXRLoaderBase____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase____c&& o) noexcept = default;
  constexpr UnityEngine__XR__OpenXR__OpenXRLoaderBase____c& operator=(UnityEngine__XR__OpenXR__OpenXRLoaderBase____c const& o) noexcept = default;
                


// Fields

static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c value) ;

static UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c __get___9() ;
...
public:
// Declarations
using __c = UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c;

using ReceiveNativeEventDelegate = UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate;

using LoaderState = UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState;
...
static UnityEngine::XR::OpenXR::OpenXRLoaderBase __get__Instance_k__BackingField() ;
 ...
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState __declspec(property(get=__get__currentLoaderState_k__BackingField, put=__set__currentLoaderState_k__BackingField))  _currentLoaderState_k__BackingField;

constexpr void __set__currentLoaderState_k__BackingField(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState value) ;

constexpr UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState __get__currentLoaderState_k__BackingField() const;

 System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __declspec(property(get=__get_validLoaderInitStates, put=__set_validLoaderInitStates))  validLoaderInitStates;

constexpr void __set_validLoaderInitStates(System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __get_validLoaderInitStates() const;

 System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __declspec(property(get=__get_validLoaderStartStates, put=__set_validLoaderStartStates))  validLoaderStartStates;

constexpr void __set_validLoaderStartStates(System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __get_validLoaderStartStates() const;

 System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __declspec(property(get=__get_validLoaderStopStates, put=__set_validLoaderStopStates))  validLoaderStopStates;

constexpr void __set_validLoaderStopStates(System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __get_validLoaderStopStates() const;

 System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __declspec(property(get=__get_validLoaderDeinitStates, put=__set_validLoaderDeinitStates))  validLoaderDeinitStates;

constexpr void __set_validLoaderDeinitStates(System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __get_validLoaderDeinitStates() const;

 System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __declspec(property(get=__get_runningStates, put=__set_runningStates))  runningStates;

constexpr void __set_runningStates(System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> value) ;

constexpr System::Collections::Generic::List_1<UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState> __get_runningStates() const;

 UnityEngine::XR::OpenXR::Features::UnityEngine__XR__OpenXR__Features__OpenXRFeature__NativeEvent __declspec(property(get=__get_currentOpenXRState, put=__set_currentOpenXRState))  currentOpenXRState;

constexpr void __set_currentOpenXRState(UnityEngine::XR::OpenXR::Features::UnityEngine__XR__OpenXR__Features__OpenXRFeature__NativeEvent value) ;

constexpr UnityEngine::XR::OpenXR::Features::UnityEngine__XR__OpenXR__Features__OpenXRFeature__NativeEvent __get_currentOpenXRState() const;
...
static UnityEngine::XR::OpenXR::OpenXRLoaderBase __declspec(property(get=get_Instance, put=set_Instance))  Instance;
 ...
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState __declspec(property(get=get_currentLoaderState, put=set_currentLoaderState))  currentLoaderState;
...
/// @brief Method get_currentLoaderState addr 0x2ae620c size 0x8 virtual false final false
 UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState get_currentLoaderState() ;

/// @brief Method set_currentLoaderState addr 0x2ae6214 size 0x8 virtual false final false
 void set_currentLoaderState(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState value) ;
...
static void Internal_SetCallbacks(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate callback) ;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__LoaderState, "UnityEngine.XR.OpenXR", "OpenXRLoaderBase/LoaderState");
...
NEED_NO_BOX(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase__ReceiveNativeEventDelegate, "UnityEngine.XR.OpenXR", "OpenXRLoaderBase/ReceiveNativeEventDelegate");
NEED_NO_BOX(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::XR::OpenXR::UnityEngine__XR__OpenXR__OpenXRLoaderBase____c, "UnityEngine.XR.OpenXR", "OpenXRLoaderBase/<>c");
