...
namespace UnityEngine::XR {
  ...
  check_size<sizeof(XRDisplaySubsystem::XRMirrorViewBlitDesc), 12 + sizeof(int) + ((12 + sizeof(int)) % 8 != 0 ? (8 - (12 + sizeof(int)) % 8) : 0)> __UnityEngine_XR_XRDisplaySubsystem_XRMirrorViewBlitDescSizeCheck;
}
