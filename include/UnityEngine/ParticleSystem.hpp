...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 10C106C
  // [NativeHeaderAttribute] Offset: 10C106C
  // [RequireComponent] Offset: 10C106C
  // [UsedByNativeCodeAttribute] Offset: 10C106C
  // [NativeHeaderAttribute] Offset: 10C106C
  // [NativeHeaderAttribute] Offset: 10C106C
  // [NativeHeaderAttribute] Offset: 10C106C
  // [NativeHeaderAttribute] Offset: 10C106C
  ...
  class ParticleSystem : public ::UnityEngine::Component {
    ...
    // [TokenAttribute] Offset: FFFFFFFF
    // [RequiredByNativeCodeAttribute] Offset: 10C1210
