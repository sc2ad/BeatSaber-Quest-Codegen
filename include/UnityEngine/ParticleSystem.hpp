...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 10C6214
  // [NativeHeaderAttribute] Offset: 10C6214
  // [RequireComponent] Offset: 10C6214
  // [UsedByNativeCodeAttribute] Offset: 10C6214
  // [NativeHeaderAttribute] Offset: 10C6214
  // [NativeHeaderAttribute] Offset: 10C6214
  // [NativeHeaderAttribute] Offset: 10C6214
  // [NativeHeaderAttribute] Offset: 10C6214
  ...
  class ParticleSystem : public ::UnityEngine::Component {
    ...
    // [TokenAttribute] Offset: FFFFFFFF
    // [RequiredByNativeCodeAttribute] Offset: 10C63B8
