...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: 10B6B34
  // [NativeHeaderAttribute] Offset: 10B6B34
  // [RequireComponent] Offset: 10B6B34
  // [UsedByNativeCodeAttribute] Offset: 10B6B34
  // [NativeHeaderAttribute] Offset: 10B6B34
  // [NativeHeaderAttribute] Offset: 10B6B34
  // [NativeHeaderAttribute] Offset: 10B6B34
  // [NativeHeaderAttribute] Offset: 10B6B34
  ...
  class ParticleSystem : public ::UnityEngine::Component {
    ...
    // [TokenAttribute] Offset: FFFFFFFF
    // [RequiredByNativeCodeAttribute] Offset: 10B6CD8
