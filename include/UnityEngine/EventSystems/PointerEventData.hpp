...
namespace UnityEngine::EventSystems {
  ...
  class PointerEventData : public UnityEngine::EventSystems::BaseEventData {
    ...
    check_size<sizeof(PointerEventData::InputButton), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_EventSystems_PointerEventData_InputButtonSizeCheck;
  ...
  check_size<sizeof(PointerEventData), 300 + sizeof(UnityEngine::EventSystems::PointerEventData::InputButton) + ((300 + sizeof(UnityEngine::EventSystems::PointerEventData::InputButton)) % 8 != 0 ? (8 - (300 + sizeof(UnityEngine::EventSystems::PointerEventData::InputButton)) % 8) : 0)> __UnityEngine_EventSystems_PointerEventDataSizeCheck;
}
