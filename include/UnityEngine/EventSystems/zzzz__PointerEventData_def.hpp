...
struct CORDL_TYPE UnityEngine__EventSystems__PointerEventData__InputButton : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__EventSystems__PointerEventData__InputButton(int32_t value__) noexcept;


                    constexpr UnityEngine__EventSystems__PointerEventData__InputButton(UnityEngine__EventSystems__PointerEventData__InputButton const&) = default;
                    constexpr UnityEngine__EventSystems__PointerEventData__InputButton(UnityEngine__EventSystems__PointerEventData__InputButton&&) = default;
                    constexpr UnityEngine__EventSystems__PointerEventData__InputButton& operator=(UnityEngine__EventSystems__PointerEventData__InputButton const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__EventSystems__PointerEventData__InputButton& operator=(UnityEngine__EventSystems__PointerEventData__InputButton&& o) noexcept {
...
constexpr explicit UnityEngine__EventSystems__PointerEventData__InputButton(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__EventSystems__PointerEventData__InputButton_Unwrapped : int32_t {
__Left = 0,
__Right = 1,
__Middle = 2,
};
...
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton const Left;

/// @brief Field Right offset 0
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton const Right;

/// @brief Field Middle offset 0
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton const Middle;
...
struct CORDL_TYPE UnityEngine__EventSystems__PointerEventData__FramePressState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr UnityEngine__EventSystems__PointerEventData__FramePressState(int32_t value__) noexcept;


                    constexpr UnityEngine__EventSystems__PointerEventData__FramePressState(UnityEngine__EventSystems__PointerEventData__FramePressState const&) = default;
                    constexpr UnityEngine__EventSystems__PointerEventData__FramePressState(UnityEngine__EventSystems__PointerEventData__FramePressState&&) = default;
                    constexpr UnityEngine__EventSystems__PointerEventData__FramePressState& operator=(UnityEngine__EventSystems__PointerEventData__FramePressState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr UnityEngine__EventSystems__PointerEventData__FramePressState& operator=(UnityEngine__EventSystems__PointerEventData__FramePressState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__EventSystems__PointerEventData__FramePressState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __UnityEngine__EventSystems__PointerEventData__FramePressState_Unwrapped : int32_t {
__Pressed = 0,
__Released = 1,
...
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState const Pressed;

/// @brief Field Released offset 0
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState const Released;

/// @brief Field PressedAndReleased offset 0
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState const PressedAndReleased;

/// @brief Field NotChanged offset 0
static UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState const NotChanged;
...
public:
// Declarations
using FramePressState = UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState;

using InputButton = UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton;
...
constexpr bool __get__dragging_k__BackingField() const;
 ...
 UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton __declspec(property(get=__get__button_k__BackingField, put=__set__button_k__BackingField))  _button_k__BackingField;

constexpr void __set__button_k__BackingField(UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton value) ;

constexpr UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton __get__button_k__BackingField() const;
...
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__FramePressState, "UnityEngine.EventSystems", "PointerEventData/FramePressState");
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton, "UnityEngine.EventSystems", "PointerEventData/InputButton");
