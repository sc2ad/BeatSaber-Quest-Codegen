...
constexpr ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode::____UnityEngine__EventSystems__StandaloneInputModule__InputMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode  ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode::Mouse{0};
constexpr ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode  ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode::Buttons{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode (::UnityEngine::EventSystems::StandaloneInputModule::*)()>(&::UnityEngine::EventSystems::StandaloneInputModule::get_inputMode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::EventSystems::StandaloneInputModule::*)(::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerInputModule__MouseButtonEventData)>(&::UnityEngine::EventSystems::StandaloneInputModule::ProcessMousePress)> {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode ::UnityEngine::EventSystems::StandaloneInputModule::get_inputMode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::EventSystems::StandaloneInputModule>::get(),
                            "get_inputMode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::EventSystems::____UnityEngine__EventSystems__StandaloneInputModule__InputMode, false>(const_cast<void*>(instance), ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::UnityEngine::EventSystems::StandaloneInputModule::ProcessMousePress(::UnityEngine::EventSystems::____UnityEngine__EventSystems__PointerInputModule__MouseButtonEventData data)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::EventSystems::StandaloneInputModule>::get(),
                            "ProcessMousePress",
                            std::vector<Il2CppClass*>{},
