...
class CORDL_TYPE UnityEngine__EventSystems__OVRPhysicsRaycaster____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~UnityEngine__EventSystems__OVRPhysicsRaycaster____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__EventSystems__OVRPhysicsRaycaster____c", modifiers: " const&", def_value: None }]
constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c(UnityEngine__EventSystems__OVRPhysicsRaycaster____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__EventSystems__OVRPhysicsRaycaster____c", modifiers: "&&", def_value: None }]
constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c(UnityEngine__EventSystems__OVRPhysicsRaycaster____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__EventSystems__OVRPhysicsRaycaster____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c& operator=(UnityEngine__EventSystems__OVRPhysicsRaycaster____c&& o) noexcept = default;
  constexpr UnityEngine__EventSystems__OVRPhysicsRaycaster____c& operator=(UnityEngine__EventSystems__OVRPhysicsRaycaster____c const& o) noexcept = default;
                


// Fields

static UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c value) ;

static UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c __get___9() ;
...
public:
// Declarations
using __c = UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c;
...
NEED_NO_BOX(UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::EventSystems::UnityEngine__EventSystems__OVRPhysicsRaycaster____c, "UnityEngine.EventSystems", "OVRPhysicsRaycaster/<>c");
