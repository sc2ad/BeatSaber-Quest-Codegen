...
namespace UnityEngine::EventSystems {
class ____UnityEngine__EventSystems__EventTrigger__Entry;
}
namespace UnityEngine::EventSystems {
class ____UnityEngine__EventSystems__EventTrigger__TriggerEvent;
}
// Type: ::TriggerEvent
namespace UnityEngine::EventSystems {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10401), inst: 5061 }), TypeDefinitionIndex(TypeDefinitionIndex(13104)), TypeDefinitionIndex(TypeDefinitionIndex(10401))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(13131))
// CS Name: UnityEngine.EventSystems.EventTrigger::TriggerEvent
class CORDL_TYPE ____UnityEngine__EventSystems__EventTrigger__TriggerEvent : public ::UnityEngine::Events::UnityEvent_1<::UnityEngine::EventSystems::BaseEventData> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____UnityEngine__EventSystems__EventTrigger__TriggerEvent() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__EventSystems__EventTrigger__TriggerEvent", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent(____UnityEngine__EventSystems__EventTrigger__TriggerEvent const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__EventSystems__EventTrigger__TriggerEvent", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent(____UnityEngine__EventSystems__EventTrigger__TriggerEvent&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__EventSystems__EventTrigger__TriggerEvent(void* ptr) noexcept : ::UnityEngine::Events::UnityEvent_1<::UnityEngine::EventSystems::BaseEventData>(ptr) {
}


  constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent& operator=(____UnityEngine__EventSystems__EventTrigger__TriggerEvent&& o) noexcept = default;
  constexpr ____UnityEngine__EventSystems__EventTrigger__TriggerEvent& operator=(____UnityEngine__EventSystems__EventTrigger__TriggerEvent const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UnityEngine__EventSystems__EventTrigger__TriggerEvent() ;
...
class CORDL_TYPE ____UnityEngine__EventSystems__EventTrigger__Entry : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____UnityEngine__EventSystems__EventTrigger__Entry() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__EventSystems__EventTrigger__Entry", modifiers: " const&", def_value: None }]
constexpr ____UnityEngine__EventSystems__EventTrigger__Entry(____UnityEngine__EventSystems__EventTrigger__Entry const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UnityEngine__EventSystems__EventTrigger__Entry", modifiers: "&&", def_value: None }]
constexpr ____UnityEngine__EventSystems__EventTrigger__Entry(____UnityEngine__EventSystems__EventTrigger__Entry&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UnityEngine__EventSystems__EventTrigger__Entry(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UnityEngine__EventSystems__EventTrigger__Entry& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UnityEngine__EventSystems__EventTrigger__Entry& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UnityEngine__EventSystems__EventTrigger__Entry& operator=(____UnityEngine__EventSystems__EventTrigger__Entry&& o) noexcept = default;
  constexpr ____UnityEngine__EventSystems__EventTrigger__Entry& operator=(____UnityEngine__EventSystems__EventTrigger__Entry const& o) noexcept = default;
...
constexpr ::UnityEngine::EventSystems::EventTriggerType __get_eventID() const;
 ...
 ::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent __declspec(property(get=__get_callback, put=__set_callback))  callback;

constexpr void __set_callback(::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent value) ;

constexpr ::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent __get_callback() const;


// Methods

// Ctor Parameters []
explicit ____UnityEngine__EventSystems__EventTrigger__Entry() ;
...
public:
// Declarations
using Entry = ::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry;

using TriggerEvent = ::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent;
...
// Fields
 ...
 ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> __declspec(property(get=__get_m_Delegates, put=__set_m_Delegates))  m_Delegates;

constexpr void __set_m_Delegates(::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> __get_m_Delegates() const;


// Properties

 ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> __declspec(property(get=get_delegates, put=set_delegates))  delegates;

 ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> __declspec(property(get=get_triggers, put=set_triggers))  triggers;


// Methods

/// @brief Method get_delegates addr 0x2c1f4f0 size 0x4 virtual false final false
 ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> get_delegates() ;

/// @brief Method set_delegates addr 0x2c1f574 size 0x8 virtual false final false
 void set_delegates(::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> value) ;
...
/// @brief Method get_triggers addr 0x2c1f4f4 size 0x80 virtual false final false
 ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> get_triggers() ;

/// @brief Method set_triggers addr 0x2c1f584 size 0x8 virtual false final false
 void set_triggers(::System::Collections::Generic::List_1<::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry> value) ;
...
NEED_NO_BOX(::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__Entry, "UnityEngine.EventSystems", "EventTrigger/Entry");
NEED_NO_BOX(::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent);
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::EventSystems::____UnityEngine__EventSystems__EventTrigger__TriggerEvent, "UnityEngine.EventSystems", "EventTrigger/TriggerEvent");
