...
namespace UnityEngine {
  ...
  // [RequireComponent] Offset: ECF8EC
  // [NativeHeaderAttribute] Offset: ECF8EC
  // [NativeClassAttribute] Offset: ECF8EC
  class Cloth : public UnityEngine::Component {
    ...
    protected:
    #endif
    // [DebuggerBrowsableAttribute] Offset: 0xECF9BC
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xECF9F8
