...
namespace UnityEngine {
  ...
  // [RequireComponent] Offset: 10BD8A8
  // [NativeHeaderAttribute] Offset: 10BD8A8
  // [NativeClassAttribute] Offset: 10BD8A8
  class Cloth : public ::UnityEngine::Component {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10BD978
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10BD9B4
