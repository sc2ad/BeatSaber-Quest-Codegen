...
namespace UnityEngine {
  ...
  // [RequireComponent] Offset: 10A6D9C
  // [NativeHeaderAttribute] Offset: 10A6D9C
  // [NativeClassAttribute] Offset: 10A6D9C
  class Cloth : public ::UnityEngine::Component {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10A6E6C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10A6EA8
