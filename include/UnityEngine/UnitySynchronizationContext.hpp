...
namespace UnityEngine {
  ...
  class UnitySynchronizationContext : public System::Threading::SynchronizationContext {
    ...
    check_size<sizeof(UnitySynchronizationContext::WorkRequest), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngine_UnitySynchronizationContext_WorkRequestSizeCheck;
  ...
  check_size<sizeof(UnitySynchronizationContext), 44 + sizeof(int) + ((44 + sizeof(int)) % 8 != 0 ? (8 - (44 + sizeof(int)) % 8) : 0)> __UnityEngine_UnitySynchronizationContextSizeCheck;
}
