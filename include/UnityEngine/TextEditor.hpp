...
namespace UnityEngine {
  ...
  class TextEditor : public ::Il2CppObject {
    ...
    check_size<sizeof(TextEditor::DblClickSnapping), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __UnityEngine_TextEditor_DblClickSnappingSizeCheck;
    ...
    check_size<sizeof(TextEditor::TextEditOp), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __UnityEngine_TextEditor_TextEditOpSizeCheck;
  ...
  check_size<sizeof(TextEditor), 140 + sizeof(int) + ((140 + sizeof(int)) % 8 != 0 ? (8 - (140 + sizeof(int)) % 8) : 0)> __UnityEngine_TextEditorSizeCheck;
}
