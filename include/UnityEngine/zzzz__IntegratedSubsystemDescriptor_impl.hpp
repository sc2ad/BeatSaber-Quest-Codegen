...
// Ctor Parameters []
 UnityEngine::IntegratedSubsystemDescriptor::IntegratedSubsystemDescriptor()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<IntegratedSubsystemDescriptor>())) {}
