...
namespace UnityEngine {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA8118
  class ColorUsageAttribute : public UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0xCABCB4
    ...
    // [ObsoleteAttribute] Offset: 0xCABCEC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xCABD24
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xCABD5C
