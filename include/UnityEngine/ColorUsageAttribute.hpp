...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 102902C
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x102CDD4
    ...
    // [ObsoleteAttribute] Offset: 0x102CE0C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x102CE44
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x102CE7C
