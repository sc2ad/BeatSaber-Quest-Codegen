...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 10466F0
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x104A4A0
    ...
    // [ObsoleteAttribute] Offset: 0x104A4D8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x104A510
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x104A548
