...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 1057E60
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x105BC10
    ...
    // [ObsoleteAttribute] Offset: 0x105BC48
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x105BC80
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x105BCB8
