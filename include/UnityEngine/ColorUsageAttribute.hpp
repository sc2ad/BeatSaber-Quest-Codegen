...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 1082CB0
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x1086A58
    ...
    // [ObsoleteAttribute] Offset: 0x1086A90
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x1086AC8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x1086B00
