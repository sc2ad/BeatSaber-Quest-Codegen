...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: E74C54
  class ColorUsageAttribute : public UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0xE78A30
    ...
    // [ObsoleteAttribute] Offset: 0xE78A68
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xE78AA0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xE78AD8
