...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: CBA6B0
  class ColorUsageAttribute : public UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0xCBE244
    ...
    // [ObsoleteAttribute] Offset: 0xCBE27C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xCBE2B4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0xCBE2EC
