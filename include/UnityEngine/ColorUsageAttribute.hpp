...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: 108DEC8
  class ColorUsageAttribute : public ::UnityEngine::PropertyAttribute {
    ...
    char __padding1[0x2] = {};
    // [ObsoleteAttribute] Offset: 0x1091C80
    ...
    // [ObsoleteAttribute] Offset: 0x1091CB8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x1091CF0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [ObsoleteAttribute] Offset: 0x1091D28
