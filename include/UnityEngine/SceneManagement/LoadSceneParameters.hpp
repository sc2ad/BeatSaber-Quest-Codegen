...
namespace UnityEngine::SceneManagement {
  ...
  check_size<sizeof(LoadSceneParameters), 4 + sizeof(UnityEngine::SceneManagement::LocalPhysicsMode) + ((4 + sizeof(UnityEngine::SceneManagement::LocalPhysicsMode)) % 8 != 0 ? (8 - (4 + sizeof(UnityEngine::SceneManagement::LocalPhysicsMode)) % 8) : 0)> __UnityEngine_SceneManagement_LoadSceneParametersSizeCheck;
}
