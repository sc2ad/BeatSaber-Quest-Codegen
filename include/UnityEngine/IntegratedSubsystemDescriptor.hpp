...
namespace UnityEngine {
  ...
  check_size<sizeof(IntegratedSubsystemDescriptor), 16 + sizeof(System::IntPtr) + 8 - (16 + sizeof(System::IntPtr)) % 8> __UnityEngine_IntegratedSubsystemDescriptorSizeCheck;
}
