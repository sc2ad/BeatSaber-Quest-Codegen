...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: 10A7DBC
  // [NativeHeaderAttribute] Offset: 10A7DBC
  // [RequiredByNativeCodeAttribute] Offset: 10A7DBC
  struct HumanBone/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [NativeNameAttribute] Offset: 0x10A8E68
