...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: 10ACF28
  // [NativeHeaderAttribute] Offset: 10ACF28
  // [RequiredByNativeCodeAttribute] Offset: 10ACF28
  struct HumanBone/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [NativeNameAttribute] Offset: 0x10ADFD4
