...
constexpr ::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock::____UnityEngine__BeforeRenderHelper__OrderBlock(int32_t order, ::UnityEngine::Events::UnityAction callback) noexcept : ::bs_hook::ValueTypeWrapper() {this->order = order;
this->callback = callback;
}
constexpr void ::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock::__set_order(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock::__get_order() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void ::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock::__set_callback(::UnityEngine::Events::UnityAction value)  {
...
constexpr ::UnityEngine::Events::UnityAction ::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock::__get_callback() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&::UnityEngine::BeforeRenderHelper::Invoke)> {
 ...
 void ::UnityEngine::BeforeRenderHelper::__set_s_OrderBlocks(::System::Collections::Generic::List_1<::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock> value)  {
::cordl_internals::setStaticField<::System::Collections::Generic::List_1<::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock>, "s_OrderBlocks", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::BeforeRenderHelper>::get>(std::forward<::System::Collections::Generic::List_1<::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock>>(value));
}
 ::System::Collections::Generic::List_1<::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock> ::UnityEngine::BeforeRenderHelper::__get_s_OrderBlocks()  {
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::UnityEngine::____UnityEngine__BeforeRenderHelper__OrderBlock>, "s_OrderBlocks", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::BeforeRenderHelper>::get>();
}
