...
namespace UnityEngine::Animations {
  ...
  // [NativeHeaderAttribute] Offset: DA978C
  // [NativeHeaderAttribute] Offset: DA978C
  // [NativeHeaderAttribute] Offset: DA978C
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::Playables::PlayableHandle&, UnityEngine::AnimationClip*)>(&UnityEngine::Animations::AnimationPlayableExtensions::SetAnimatedPropertiesInternal)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Animations::AnimationPlayableExtensions*), "SetAnimatedPropertiesInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<UnityEngine::Playables::PlayableHandle&>(), ::il2cpp_utils::ExtractIndependentType<UnityEngine::AnimationClip*>()});
  }
};
