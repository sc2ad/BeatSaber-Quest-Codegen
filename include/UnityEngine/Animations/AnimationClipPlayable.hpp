...
namespace UnityEngine::Animations {
  ...
  struct AnimationClipPlayable : public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationClipPlayable>, public System::ValueType {
    public:
