...
namespace UnityEngine::Animations {
  ...
  struct AnimationOffsetPlayable : public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationOffsetPlayable>, public System::ValueType {
    public:
