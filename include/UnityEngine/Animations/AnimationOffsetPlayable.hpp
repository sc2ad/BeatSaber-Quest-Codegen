...
namespace UnityEngine::Animations {
  ...
  // [] Offset: FFFFFFFF
  // [RequiredByNativeCodeAttribute] Offset: CBDB34
  // [StaticAccessorAttribute] Offset: CBDB34
  // [NativeHeaderAttribute] Offset: CBDB34
  // [NativeHeaderAttribute] Offset: CBDB34
  // [NativeHeaderAttribute] Offset: CBDB34
  struct AnimationOffsetPlayable/*, public System::ValueType, public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationOffsetPlayable>*/ {
    ...
    // Offset: 0xE14AF0
    bool Equals_NEW(UnityEngine::Animations::AnimationOffsetPlayable other);
