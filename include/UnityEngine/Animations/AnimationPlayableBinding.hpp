...
namespace UnityEngine::Animations {
  ...
  class AnimationPlayableBinding : public ::CsObject {
    public:
    ...
    // Offset: 0x1924C94
    static UnityEngine::Playables::PlayableOutput CreateAnimationOutput(UnityEngine::Playables::PlayableGraph graph, ::CsString* name);
