...
namespace UnityEngine::Animations {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CBDE68
  // [NativeHeaderAttribute] Offset: CBDE68
  // [RequiredByNativeCodeAttribute] Offset: CBDE68
  // [StaticAccessorAttribute] Offset: CBDE68
  // [NativeHeaderAttribute] Offset: CBDE68
  struct AnimationPosePlayable/*, public System::ValueType, public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationPosePlayable>*/ {
    ...
    // Offset: 0xE14BB0
    bool Equals_NEW(UnityEngine::Animations::AnimationPosePlayable other);
