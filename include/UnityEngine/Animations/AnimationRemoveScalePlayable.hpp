...
namespace UnityEngine::Animations {
  ...
  // [] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: CBDF24
  // [NativeHeaderAttribute] Offset: CBDF24
  // [StaticAccessorAttribute] Offset: CBDF24
  // [RequiredByNativeCodeAttribute] Offset: CBDF24
  // [NativeHeaderAttribute] Offset: CBDF24
  struct AnimationRemoveScalePlayable/*, public System::ValueType, public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationRemoveScalePlayable>*/ {
    ...
    // Offset: 0xE14BCC
    bool Equals_NEW(UnityEngine::Animations::AnimationRemoveScalePlayable other);
