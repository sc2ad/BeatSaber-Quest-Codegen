...
namespace UnityEngine::Animations {
  ...
  struct AnimationRemoveScalePlayable : public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Animations::AnimationRemoveScalePlayable>, public System::ValueType {
    public:
