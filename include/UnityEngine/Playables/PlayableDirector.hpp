...
namespace UnityEngine::Playables {
  ...
  // [NativeHeaderAttribute] Offset: 10BB83C
  // [NativeHeaderAttribute] Offset: 10BB83C
  // [RequiredByNativeCodeAttribute] Offset: 10BB83C
  class PlayableDirector : public ::UnityEngine::Behaviour/*, public ::UnityEngine::IExposedPropertyTable*/ {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10BB8AC
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10BB8E8
    ...
    // Field size check
    static_assert(sizeof(::System::Action_1<::UnityEngine::Playables::PlayableDirector*>*) == 0x8);
    // [DebuggerBrowsableAttribute] Offset: 0x10BB924
