...
namespace UnityEngine::Playables {
  ...
  // [NativeHeaderAttribute] Offset: 10B3ACC
  // [NativeHeaderAttribute] Offset: 10B3ACC
  // [RequiredByNativeCodeAttribute] Offset: 10B3ACC
  class PlayableDirector : public ::UnityEngine::Behaviour/*, public ::UnityEngine::IExposedPropertyTable*/ {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x10B3B3C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0x10B3B78
    ...
    // Field size check
    static_assert(sizeof(::System::Action_1<::UnityEngine::Playables::PlayableDirector*>*) == 0x8);
    // [DebuggerBrowsableAttribute] Offset: 0x10B3BB4
