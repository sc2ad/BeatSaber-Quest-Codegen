...
namespace UnityEngine::Playables {
  ...
  struct ScriptPlayable_1 : public System::ValueType/*, public UnityEngine::Playables::IPlayable, public System::IEquatable_1<UnityEngine::Playables::ScriptPlayable_1<T>>*/ {
    ...
    static UnityEngine::Playables::ScriptPlayable_1<T> _get_m_NullPlayable() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("_get_m_NullPlayable");
    ...
    static void _set_m_NullPlayable(UnityEngine::Playables::ScriptPlayable_1<T> value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("_set_m_NullPlayable");
    ...
    static UnityEngine::Playables::ScriptPlayable_1<T> get_Null() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("get_Null");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<UnityEngine::Playables::ScriptPlayable_1<T>>(), "get_Null", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    static UnityEngine::Playables::ScriptPlayable_1<T> Create(UnityEngine::Playables::PlayableGraph graph, int inputCount) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<UnityEngine::Playables::ScriptPlayable_1<T>>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, inputCount))));
    ...
    static UnityEngine::Playables::ScriptPlayable_1<T> Create(UnityEngine::Playables::PlayableGraph graph, T _template, int inputCount) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<UnityEngine::Playables::ScriptPlayable_1<T>>(), "Create", {}, ::il2cpp_utils::ExtractTypes(graph, _template, inputCount))));
    ...
    static UnityEngine::Playables::PlayableHandle CreateHandle(UnityEngine::Playables::PlayableGraph graph, T _template, int inputCount) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("CreateHandle");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<UnityEngine::Playables::PlayableHandle>(), "CreateHandle", {}, ::il2cpp_utils::ExtractTypes(graph, _template, inputCount))));
    ...
    static ::Il2CppObject* CreateScriptInstance() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("CreateScriptInstance");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CreateScriptInstance", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    static ::Il2CppObject* CloneScriptInstance(UnityEngine::Playables::IPlayableBehaviour* source) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("CloneScriptInstance");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CloneScriptInstance", {}, ::il2cpp_utils::ExtractTypes(source))));
    ...
    static ::Il2CppObject* CloneScriptInstanceFromEngineObject(UnityEngine::Object* source) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("CloneScriptInstanceFromEngineObject");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CloneScriptInstanceFromEngineObject", {}, ::il2cpp_utils::ExtractTypes(source))));
      return ::il2cpp_utils::RunMethodThrow<::Il2CppObject*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, source);
    }
    ...
    static ::Il2CppObject* CloneScriptInstanceFromIClonable(System::ICloneable* source) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("CloneScriptInstanceFromIClonable");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<::Il2CppObject*>(), "CloneScriptInstanceFromIClonable", {}, ::il2cpp_utils::ExtractTypes(source))));
      return ::il2cpp_utils::RunMethodThrow<::Il2CppObject*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, source);
    }
    ...
    // Offset: 0xFFFFFFFF
    T GetBehaviour() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("GetBehaviour");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, il2cpp_utils::NoArgClass<T>(), "GetBehaviour", {}, ::il2cpp_utils::ExtractTypes()));
      return ::il2cpp_utils::RunMethodThrow<T, false>(*this, ___internal__method);
    }
    // static private System.Void .cctor()
    // Offset: 0xFFFFFFFF
    static void _cctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext(".cctor");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptPlayable_1<T>>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    UnityEngine::Playables::PlayableHandle GetHandle() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("GetHandle");
    ...
    bool Equals(UnityEngine::Playables::ScriptPlayable_1<T> other) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("UnityEngine::Playables").WithContext("ScriptPlayable_1").WithContext("Equals");
  ...
  // Could not write size check! Type: UnityEngine.Playables.ScriptPlayable`1 is generic!
}
