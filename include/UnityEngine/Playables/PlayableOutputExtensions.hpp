...
namespace UnityEngine::Playables {
  ...
  class PlayableOutputExtensions : public ::CsObject {
    public:
    ...
    // Offset: 0xFFFFFFFF
    template<class U>
    static void PushNotification(U output, UnityEngine::Playables::Playable origin, UnityEngine::Playables::INotification* notification, ::CsObject* context) {
      static_assert(std::is_base_of_v<UnityEngine::Playables::IPlayableOutput, std::remove_pointer_t<U>> && is_value_type_v<U>);
