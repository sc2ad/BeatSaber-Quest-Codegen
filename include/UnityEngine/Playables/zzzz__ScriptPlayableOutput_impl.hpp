...
//  Writing Method size for method: UnityEngine::Playables::ScriptPlayableOutput.op_Implicit_UnityEngine__Playables__PlayableOutput
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Playables::PlayableOutput (*)(UnityEngine::Playables::ScriptPlayableOutput)>(&UnityEngine::Playables::ScriptPlayableOutput::op_Implicit_UnityEngine__Playables__PlayableOutput)> {
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Playables::PlayableOutputHandle, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 UnityEngine::Playables::PlayableOutput UnityEngine::Playables::ScriptPlayableOutput::op_Implicit_UnityEngine__Playables__PlayableOutput(UnityEngine::Playables::ScriptPlayableOutput output)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Playables::ScriptPlayableOutput>::get(),
                            "op_Implicit",
                            std::vector<Il2CppClass*>{},
