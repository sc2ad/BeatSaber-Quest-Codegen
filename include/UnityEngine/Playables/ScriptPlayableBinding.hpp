...
namespace UnityEngine::Playables {
  ...
  class ScriptPlayableBinding : public ::CsObject {
    public:
    // static public UnityEngine.Playables.PlayableBinding Create(System.String name, UnityEngine.Object key, System.Type type)
    // Offset: 0x1403C64
    static UnityEngine::Playables::PlayableBinding Create(::CsString* name, UnityEngine::Object* key, System::Type* type);
    ...
    // Offset: 0x1403D48
    static UnityEngine::Playables::PlayableOutput CreateScriptOutput(UnityEngine::Playables::PlayableGraph graph, ::CsString* name);
