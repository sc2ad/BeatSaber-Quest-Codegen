...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Playables::Playable (*)()>(&UnityEngine::Playables::Playable::get_Null)> {
  ...
  constexpr static std::size_t addrs = 0x2b7c820;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Playables::Playable (*)(UnityEngine::Playables::PlayableGraph, int32_t)>(&UnityEngine::Playables::Playable::Create)> {
  constexpr static std::size_t size = 0x70;
  constexpr static std::size_t addrs = 0x2b7caf0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Playables::Playable::*)(UnityEngine::Playables::PlayableHandle)>(&UnityEngine::Playables::Playable::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2b7cbb4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Playables::PlayableHandle (UnityEngine::Playables::Playable::*)()>(&UnityEngine::Playables::Playable::GetHandle)> {
  ...
  constexpr static std::size_t addrs = 0x2b7cbbc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (UnityEngine::Playables::Playable::*)()>(&UnityEngine::Playables::Playable::GetPlayableType)> {
  ...
  constexpr static std::size_t addrs = 0x2b7cbc8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Playables::Playable::*)(UnityEngine::Playables::Playable)>(&UnityEngine::Playables::Playable::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x2b7cc60;
...
constexpr  UnityEngine::Playables::Playable::operator UnityEngine::Playables::IPlayable() const {
...
constexpr  UnityEngine::Playables::Playable::operator System::IEquatable_1<UnityEngine::Playables::Playable>() const {
return System::IEquatable_1<UnityEngine::Playables::Playable>(::cordl_internals::Box(this).convert());
}
// Ctor Parameters [CppParam { name: "m_Handle", ty: "UnityEngine::Playables::PlayableHandle", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::Playables::Playable::Playable(UnityEngine::Playables::PlayableHandle m_Handle) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_Handle = m_Handle;
}
constexpr void UnityEngine::Playables::Playable::__set_m_Handle(UnityEngine::Playables::PlayableHandle value)  {
...
constexpr UnityEngine::Playables::PlayableHandle UnityEngine::Playables::Playable::__get_m_Handle() const {
return ::cordl_internals::getInstanceField<UnityEngine::Playables::PlayableHandle, 0x0>(this->__instance);
}
 void UnityEngine::Playables::Playable::__set_m_NullPlayable(UnityEngine::Playables::Playable value)  {
::cordl_internals::setStaticField<UnityEngine::Playables::Playable, "m_NullPlayable", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Playables::Playable>::get>(std::forward<UnityEngine::Playables::Playable>(value));
 ...
 UnityEngine::Playables::Playable UnityEngine::Playables::Playable::__get_m_NullPlayable()  {
...
/// @param inputCount: int32_t (default: 0)
 UnityEngine::Playables::Playable UnityEngine::Playables::Playable::Create(UnityEngine::Playables::PlayableGraph graph, int32_t inputCount)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Playables::Playable>::get(),
                            "Create",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Playables::Playable, false>(nullptr, ___internal_method, graph, inputCount);
 ...
 void UnityEngine::Playables::Playable::_ctor(UnityEngine::Playables::PlayableHandle handle)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::Playables::Playable>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
template<typename T>
 bool UnityEngine::Playables::Playable::IsPlayableOfType()  {
