...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (ENet::PacketFreeCallback::*)(System::IAsyncResult)>(&ENet::PacketFreeCallback::EndInvoke)> {
 ...
 ENet::PacketFreeCallback ENet::PacketFreeCallback::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
ENet::PacketFreeCallback o{THROW_UNLESS(::il2cpp_utils::New<ENet::PacketFreeCallback>(object, method))};
return o;
}
