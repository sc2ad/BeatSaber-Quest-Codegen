...
namespace NUnit::Framework {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: DB31C0
  class TestParameters : public ::Il2CppObject {
    ...
    static TestParameters* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("NUnit::Framework").WithContext("TestParameters").WithContext(".ctor");
