...
namespace NUnit::Framework::Internal::Builders {
  ...
  check_size<sizeof(DefaultTestCaseBuilder), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __NUnit_Framework_Internal_Builders_DefaultTestCaseBuilderSizeCheck;
}
