...
namespace NUnit::Framework::Internal::Builders {
  ...
  class DefaultSuiteBuilder : public ::Il2CppObject/*, public NUnit::Framework::Interfaces::ISuiteBuilder*/ {
    ...
    // Offset: 0x19383FC
    ::ArrayWrapper<NUnit::Framework::Interfaces::IFixtureBuilder*> GetFixtureBuilderAttributes(NUnit::Framework::Interfaces::ITypeInfo* typeInfo);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<NUnit::Framework::Interfaces::IFixtureBuilder*> (NUnit::Framework::Internal::Builders::DefaultSuiteBuilder::*)(NUnit::Framework::Interfaces::ITypeInfo*)>(&NUnit::Framework::Internal::Builders::DefaultSuiteBuilder::GetFixtureBuilderAttributes)> {
  static const MethodInfo* get() {
    static auto* typeInfo = &::il2cpp_utils::GetClassFromName("NUnit.Framework.Interfaces", "ITypeInfo")->byval_arg;
