...
namespace NUnit::Framework::Internal::Filters {
  ...
  check_size<sizeof(ValueMatchFilter), 24 + sizeof(bool) + ((24 + sizeof(bool)) % 8 != 0 ? (8 - (24 + sizeof(bool)) % 8) : 0)> __NUnit_Framework_Internal_Filters_ValueMatchFilterSizeCheck;
}
