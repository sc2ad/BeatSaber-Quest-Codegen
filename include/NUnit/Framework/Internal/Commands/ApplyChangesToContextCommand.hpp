...
namespace NUnit::Framework::Internal::Commands {
  ...
  check_size<sizeof(ApplyChangesToContextCommand), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __NUnit_Framework_Internal_Commands_ApplyChangesToContextCommandSizeCheck;
}
