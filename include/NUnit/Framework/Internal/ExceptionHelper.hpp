...
namespace NUnit::Framework::Internal {
  ...
  class ExceptionHelper : public ::CsObject {
    ...
    // Offset: 0x107439C
    static ::CsString* BuildMessage(System::Exception* exception);
    // static public System.String BuildStackTrace(System.Exception exception)
    // Offset: 0x1074890
    static ::CsString* BuildStackTrace(System::Exception* exception);
    // static public System.String GetStackTrace(System.Exception exception)
    // Offset: 0x1074AFC
    static ::CsString* GetStackTrace(System::Exception* exception);
