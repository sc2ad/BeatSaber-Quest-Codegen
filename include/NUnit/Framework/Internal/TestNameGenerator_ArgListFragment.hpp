...
namespace NUnit::Framework::Internal {
  ...
  check_size<sizeof(TestNameGenerator::ArgListFragment), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __NUnit_Framework_Internal_TestNameGenerator_ArgListFragmentSizeCheck;
}
