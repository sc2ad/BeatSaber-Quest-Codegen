...
namespace NUnit::Framework::Internal {
  ...
  class TypeHelper : public ::CsObject {
    public:
    ...
    // Offset: 0x18F07AC
    static ::CsString* GetDisplayName(System::Type* type);
    // static public System.String GetDisplayName(System.Type type, System.Object[] arglist)
    // Offset: 0x18F0B64
    static ::CsString* GetDisplayName(System::Type* type, ::Array<::CsObject*>* arglist);
    ...
    // Offset: 0x18F1774
    static void ConvertArgumentList(::Array<::CsObject*>* arglist, ::Array<NUnit::Framework::Interfaces::IParameterInfo*>* parameters);
    // static public System.Boolean CanDeduceTypeArgsFromArgs(System.Type type, System.Object[] arglist, System.Type[] typeArgsOut)
    // Offset: 0x18F1BA4
    static bool CanDeduceTypeArgsFromArgs(System::Type* type, ::Array<::CsObject*>* arglist, ::Array<System::Type*>*& typeArgsOut);
