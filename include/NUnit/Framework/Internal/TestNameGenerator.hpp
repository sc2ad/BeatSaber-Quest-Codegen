...
namespace NUnit::Framework::Internal {
  ...
  class TestNameGenerator : public ::CsObject {
    public:
    ...
    static ::CsString* _get_DefaultTestNamePattern();
    // Set static field: static public System.String DefaultTestNamePattern
    static void _set_DefaultTestNamePattern(::CsString* value);
    ...
    // Offset: 0x18DA600
    static TestNameGenerator* New_ctor(::CsString* pattern);
    // public System.String GetDisplayName(NUnit.Framework.Internal.TestMethod testMethod, System.Object[] args)
    // Offset: 0x18DA634
    ::CsString* GetDisplayName(NUnit::Framework::Internal::TestMethod* testMethod, ::Array<::CsObject*>* args);
    ...
    // Offset: 0x18DA7DC
    static System::Collections::Generic::List_1<NUnit::Framework::Internal::TestNameGenerator::NameFragment*>* BuildFragmentList(::CsString* pattern);
