...
namespace NUnit::Framework::Internal {
  ...
  class ParameterWrapper : public ::Il2CppObject/*, public NUnit::Framework::Interfaces::IParameterInfo*/ {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xE0513C
    // [CompilerGeneratedAttribute] Offset: 0xE0513C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xE05178
    // [CompilerGeneratedAttribute] Offset: 0xE05178
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (NUnit::Framework::Internal::ParameterWrapper::*)(NUnit::Framework::Interfaces::IMethodInfo*, System::Reflection::ParameterInfo*)>(&NUnit::Framework::Internal::ParameterWrapper::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(NUnit::Framework::Internal::ParameterWrapper*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<NUnit::Framework::Interfaces::IMethodInfo*>(), ::il2cpp_utils::ExtractIndependentType<System::Reflection::ParameterInfo*>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (NUnit::Framework::Internal::ParameterWrapper::*)(NUnit::Framework::Interfaces::IMethodInfo*, System::Reflection::ParameterInfo*)>(&NUnit::Framework::Internal::ParameterWrapper::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(NUnit::Framework::Internal::ParameterWrapper*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<NUnit::Framework::Interfaces::IMethodInfo*>(), ::il2cpp_utils::ExtractIndependentType<System::Reflection::ParameterInfo*>()});
  }
};
