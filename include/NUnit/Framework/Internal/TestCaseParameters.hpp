...
namespace NUnit::Framework::Internal {
  ...
  class TestCaseParameters : public NUnit::Framework::Interfaces::ITestCaseData, public NUnit::Framework::Interfaces::IApplyToTest, public NUnit::Framework::Internal::TestParameters {
    public:
