...
namespace NUnit::Framework::Internal {
  ...
  check_size<sizeof(ParameterizedMethodSuite), 137 + sizeof(bool) + ((137 + sizeof(bool)) % 8 != 0 ? (8 - (137 + sizeof(bool)) % 8) : 0)> __NUnit_Framework_Internal_ParameterizedMethodSuiteSizeCheck;
}
