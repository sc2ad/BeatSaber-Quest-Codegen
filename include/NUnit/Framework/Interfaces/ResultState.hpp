...
namespace NUnit::Framework::Interfaces {
  ...
  check_size<sizeof(ResultState), 32 + sizeof(NUnit::Framework::Interfaces::FailureSite) + ((32 + sizeof(NUnit::Framework::Interfaces::FailureSite)) % 8 != 0 ? (8 - (32 + sizeof(NUnit::Framework::Interfaces::FailureSite)) % 8) : 0)> __NUnit_Framework_Interfaces_ResultStateSizeCheck;
}
