...
namespace NUnit::Framework::Constraints {
  ...
  check_size<sizeof(NUnitEqualityComparer::FailurePoint), 41 + sizeof(bool) + ((41 + sizeof(bool)) % 8 != 0 ? (8 - (41 + sizeof(bool)) % 8) : 0)> __NUnit_Framework_Constraints_NUnitEqualityComparer_FailurePointSizeCheck;
}
