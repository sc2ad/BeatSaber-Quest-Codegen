...
namespace NUnit::Framework::Constraints {
  ...
  class EqualConstraintResult : public ::NUnit::Framework::Constraints::ConstraintResult {
    ...
    [[deprecated("Use field access instead!")]] ::NUnit::Framework::Constraints::Tolerance*& dyn_tolerance();
    ...
    [[deprecated("Use field access instead!")]] bool& dyn_clipStrings();
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::IList_1<::NUnit::Framework::Constraints::NUnitEqualityComparer::FailurePoint*>*& dyn_failurePoints();
