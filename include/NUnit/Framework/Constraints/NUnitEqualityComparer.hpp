...
namespace NUnit::Framework::Constraints {
  ...
  class NUnitEqualityComparer : public ::Il2CppObject {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xF30690
    ...
    static void CheckGameObjectReference(ByRef<T> value) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(value))));
    }
