...
namespace NUnit::Framework::Constraints {
  ...
  check_size<sizeof(ConstraintBuilder::ConstraintStack), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __NUnit_Framework_Constraints_ConstraintBuilder_ConstraintStackSizeCheck;
}
