...
namespace NUnit::Framework::Constraints {
  ...
  class ValueFormatterFactory : public System::MulticastDelegate {
    ...
    // Offset: 0x15A0F64
    NUnit::Framework::Constraints::ValueFormatter* Invoke_NEW(NUnit::Framework::Constraints::ValueFormatter* next);
    ...
    // Offset: 0x15A8238
    System::IAsyncResult* BeginInvoke_NEW(NUnit::Framework::Constraints::ValueFormatter* next, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public NUnit.Framework.Constraints.ValueFormatter EndInvoke(System.IAsyncResult result)
    // Offset: 0x15A825C
    NUnit::Framework::Constraints::ValueFormatter* EndInvoke_NEW(System::IAsyncResult* result);
