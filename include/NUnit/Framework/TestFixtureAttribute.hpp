...
namespace NUnit::Framework {
  ...
  class TestFixtureAttribute : public NUnit::Framework::Interfaces::IFixtureBuilder, public NUnit::Framework::Interfaces::ITestFixtureData, public NUnit::Framework::NUnitAttribute {
    public:
