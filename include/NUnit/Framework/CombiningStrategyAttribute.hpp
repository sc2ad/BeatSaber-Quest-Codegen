...
namespace NUnit::Framework {
  ...
  class CombiningStrategyAttribute : public NUnit::Framework::Interfaces::ITestBuilder, public NUnit::Framework::Interfaces::IApplyToTest, public NUnit::Framework::NUnitAttribute {
    public:
