...
namespace RootMotion::Demos {
  ...
  class Navigator : public ::Il2CppObject {
    ...
    public:
    // [TooltipAttribute] Offset: 0x11031F4
    ...
    char __padding0[0x3] = {};
    // [TooltipAttribute] Offset: 0x110322C
    ...
    // [TooltipAttribute] Offset: 0x1103264
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x110329C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x11032D4
