...
namespace RootMotion::Demos {
  ...
  class Navigator : public ::Il2CppObject {
    ...
    public:
    // [TooltipAttribute] Offset: 0x10FA7E0
    ...
    char __padding0[0x3] = {};
    // [TooltipAttribute] Offset: 0x10FA818
    ...
    // [TooltipAttribute] Offset: 0x10FA850
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10FA888
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10FA8C0
