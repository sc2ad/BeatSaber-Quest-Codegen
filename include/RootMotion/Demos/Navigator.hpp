...
namespace RootMotion::Demos {
  ...
  class Navigator : public ::Il2CppObject {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x10DA38C
    ...
    char __padding0[0x3] = {};
    // [TooltipAttribute] Offset: 0x10DA3C4
    ...
    // [TooltipAttribute] Offset: 0x10DA3FC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10DA434
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10DA46C
