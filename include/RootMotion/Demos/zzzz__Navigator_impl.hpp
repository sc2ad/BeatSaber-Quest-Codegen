...
constexpr ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::____RootMotion__Demos__Navigator__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::RootMotion::Demos::____RootMotion__Demos__Navigator__State  ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::Idle{0};
constexpr ::RootMotion::Demos::____RootMotion__Demos__Navigator__State  ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::Seeking{1};
constexpr ::RootMotion::Demos::____RootMotion__Demos__Navigator__State  ::RootMotion::Demos::____RootMotion__Demos__Navigator__State::OnPath{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::RootMotion::Demos::____RootMotion__Demos__Navigator__State (::RootMotion::Demos::Navigator::*)()>(&::RootMotion::Demos::Navigator::get_state)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::Demos::Navigator::*)(::RootMotion::Demos::____RootMotion__Demos__Navigator__State)>(&::RootMotion::Demos::Navigator::set_state)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_state",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::RootMotion::Demos::____RootMotion__Demos__Navigator__State>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::RootMotion::Demos::Navigator::__set__state_k__BackingField(::RootMotion::Demos::____RootMotion__Demos__Navigator__State value)  {
::cordl_internals::setInstanceField<::RootMotion::Demos::____RootMotion__Demos__Navigator__State, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::RootMotion::Demos::____RootMotion__Demos__Navigator__State>(value));
}
constexpr ::RootMotion::Demos::____RootMotion__Demos__Navigator__State ::RootMotion::Demos::Navigator::__get__state_k__BackingField() const {
return ::cordl_internals::getInstanceField<::RootMotion::Demos::____RootMotion__Demos__Navigator__State, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::RootMotion::Demos::____RootMotion__Demos__Navigator__State ::RootMotion::Demos::Navigator::get_state()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::Demos::Navigator>::get(),
                            "get_state",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::RootMotion::Demos::____RootMotion__Demos__Navigator__State, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::RootMotion::Demos::Navigator::set_state(::RootMotion::Demos::____RootMotion__Demos__Navigator__State value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::Demos::Navigator>::get(),
                            "set_state",
                            std::vector<Il2CppClass*>{},
