...
namespace RootMotion {
  ...
  check_size<sizeof(BipedReferences::AutoDetectParams), 1 + sizeof(bool) + ((1 + sizeof(bool)) % 8 != 0 ? (8 - (1 + sizeof(bool)) % 8) : 0)> __RootMotion_BipedReferences_AutoDetectParamsSizeCheck;
}
