...
constexpr ::RootMotion::____RootMotion__Baker__Mode::____RootMotion__Baker__Mode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::RootMotion::____RootMotion__Baker__Mode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::RootMotion::____RootMotion__Baker__Mode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::RootMotion::____RootMotion__Baker__Mode  ::RootMotion::____RootMotion__Baker__Mode::AnimationClips{0};
constexpr ::RootMotion::____RootMotion__Baker__Mode  ::RootMotion::____RootMotion__Baker__Mode::AnimationStates{1};
constexpr ::RootMotion::____RootMotion__Baker__Mode  ::RootMotion::____RootMotion__Baker__Mode::PlayableDirector{2};
constexpr ::RootMotion::____RootMotion__Baker__Mode  ::RootMotion::____RootMotion__Baker__Mode::Realtime{3};
...
constexpr void ::RootMotion::Baker::__set_mode(::RootMotion::____RootMotion__Baker__Mode value)  {
::cordl_internals::setInstanceField<::RootMotion::____RootMotion__Baker__Mode, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::RootMotion::____RootMotion__Baker__Mode>(value));
}
constexpr ::RootMotion::____RootMotion__Baker__Mode ::RootMotion::Baker::__get_mode() const {
return ::cordl_internals::getInstanceField<::RootMotion::____RootMotion__Baker__Mode, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 ::RootMotion::Baker::Baker()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<Baker>())) {}
