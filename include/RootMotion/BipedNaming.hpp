...
namespace RootMotion {
  ...
  class BipedNaming : public ::Il2CppObject {
    ...
    check_size<sizeof(BipedNaming::BoneType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __RootMotion_BipedNaming_BoneTypeSizeCheck;
    ...
    check_size<sizeof(BipedNaming::BoneSide), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __RootMotion_BipedNaming_BoneSideSizeCheck;
