...
namespace RootMotion {
  ...
  class BakerHumanoidQT : public ::CsObject {
    public:
    ...
    // Offset: 0x1386BB0
    static BakerHumanoidQT* New_ctor(::CsString* name);
    // public System.Void .ctor(UnityEngine.Transform transform, UnityEngine.AvatarIKGoal goal, System.String name)
    // Offset: 0x1386EA8
    static BakerHumanoidQT* New_ctor(UnityEngine::Transform* transform, UnityEngine::AvatarIKGoal goal, ::CsString* name);
