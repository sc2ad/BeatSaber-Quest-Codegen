...
namespace RootMotion {
  ...
  check_size<sizeof(BipedLimbOrientations::LimbOrientation), 40 + sizeof(UnityEngine::Vector3) + ((40 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (40 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_BipedLimbOrientations_LimbOrientationSizeCheck;
}
