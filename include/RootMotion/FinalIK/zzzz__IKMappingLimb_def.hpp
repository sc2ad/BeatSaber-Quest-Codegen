...
struct CORDL_TYPE RootMotion__FinalIK__IKMappingLimb__BoneMapType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr RootMotion__FinalIK__IKMappingLimb__BoneMapType(int32_t value__) noexcept;


                    constexpr RootMotion__FinalIK__IKMappingLimb__BoneMapType(RootMotion__FinalIK__IKMappingLimb__BoneMapType const&) = default;
                    constexpr RootMotion__FinalIK__IKMappingLimb__BoneMapType(RootMotion__FinalIK__IKMappingLimb__BoneMapType&&) = default;
                    constexpr RootMotion__FinalIK__IKMappingLimb__BoneMapType& operator=(RootMotion__FinalIK__IKMappingLimb__BoneMapType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr RootMotion__FinalIK__IKMappingLimb__BoneMapType& operator=(RootMotion__FinalIK__IKMappingLimb__BoneMapType&& o) noexcept {
...
constexpr explicit RootMotion__FinalIK__IKMappingLimb__BoneMapType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __RootMotion__FinalIK__IKMappingLimb__BoneMapType_Unwrapped : int32_t {
__Parent = 0,
__Bone1 = 1,
__Bone2 = 2,
__Bone3 = 3,
...
static RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType const Parent;

/// @brief Field Bone1 offset 0
static RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType const Bone1;

/// @brief Field Bone2 offset 0
static RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType const Bone2;

/// @brief Field Bone3 offset 0
static RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType const Bone3;
...
public:
// Declarations
using BoneMapType = RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType;
...
constexpr bool __get_updatePlaneRotations() const;
 ...
 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_boneMapParent, put=__set_boneMapParent))  boneMapParent;

constexpr void __set_boneMapParent(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __get_boneMapParent() const;

 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_boneMap1, put=__set_boneMap1))  boneMap1;

constexpr void __set_boneMap1(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __get_boneMap1() const;

 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_boneMap2, put=__set_boneMap2))  boneMap2;

constexpr void __set_boneMap2(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __get_boneMap2() const;

 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_boneMap3, put=__set_boneMap3))  boneMap3;

constexpr void __set_boneMap3(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap __get_boneMap3() const;
...
/// @brief Method GetBoneMap addr 0x11d11b8 size 0xc8 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap GetBoneMap(RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType boneMap) ;
...
DEFINE_IL2CPP_ARG_TYPE(RootMotion::FinalIK::RootMotion__FinalIK__IKMappingLimb__BoneMapType, "RootMotion.FinalIK", "IKMappingLimb/BoneMapType");
