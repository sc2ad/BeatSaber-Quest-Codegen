...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__InteractionObject__InteractionEvent;
}
...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate;
}
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate;
}
...
class CORDL_TYPE ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____RootMotion__FinalIK__InteractionSystem__InteractionDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__InteractionSystem__InteractionDelegate", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate(____RootMotion__FinalIK__InteractionSystem__InteractionDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__InteractionSystem__InteractionDelegate", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate(____RootMotion__FinalIK__InteractionSystem__InteractionDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate& operator=(____RootMotion__FinalIK__InteractionSystem__InteractionDelegate&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate& operator=(____RootMotion__FinalIK__InteractionSystem__InteractionDelegate const& o) noexcept = default;
...
explicit ____RootMotion__FinalIK__InteractionSystem__InteractionDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
class CORDL_TYPE ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate(____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate(____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate& operator=(____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate& operator=(____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate const& o) noexcept = default;
...
// Ctor Parameters [CppParam { name: "object", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "method", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
explicit ____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
/// @brief Method Invoke addr 0x11ff1d8 size 0x14 virtual true final false
 void Invoke(::RootMotion::FinalIK::FullBodyBipedEffector effectorType, ::RootMotion::FinalIK::InteractionObject interactionObject, ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionObject__InteractionEvent interactionEvent) ;

/// @brief Method BeginInvoke addr 0x11ff1ec size 0x98 virtual true final false
 ::System::IAsyncResult BeginInvoke(::RootMotion::FinalIK::FullBodyBipedEffector effectorType, ::RootMotion::FinalIK::InteractionObject interactionObject, ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionObject__InteractionEvent interactionEvent, ::System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;
...
public:
// Declarations
using InteractionEventDelegate = ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate;

using InteractionDelegate = ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate;
...
constexpr ::System::Collections::Generic::List_1<int32_t> __get_bestRangeIndexes() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __declspec(property(get=__get_OnInteractionStart, put=__set_OnInteractionStart))  OnInteractionStart;

constexpr void __set_OnInteractionStart(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __get_OnInteractionStart() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __declspec(property(get=__get_OnInteractionPause, put=__set_OnInteractionPause))  OnInteractionPause;

constexpr void __set_OnInteractionPause(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __get_OnInteractionPause() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __declspec(property(get=__get_OnInteractionPickUp, put=__set_OnInteractionPickUp))  OnInteractionPickUp;

constexpr void __set_OnInteractionPickUp(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __get_OnInteractionPickUp() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __declspec(property(get=__get_OnInteractionResume, put=__set_OnInteractionResume))  OnInteractionResume;

constexpr void __set_OnInteractionResume(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __get_OnInteractionResume() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __declspec(property(get=__get_OnInteractionStop, put=__set_OnInteractionStop))  OnInteractionStop;

constexpr void __set_OnInteractionStop(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate __get_OnInteractionStop() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate __declspec(property(get=__get_OnInteractionEvent, put=__set_OnInteractionEvent))  OnInteractionEvent;

constexpr void __set_OnInteractionEvent(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate __get_OnInteractionEvent() const;
...
/// @brief Method GetClosestInteractionRange addr 0x11fc8f8 size 0xe8 virtual false final false
 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionTrigger__Range GetClosestInteractionRange() ;
...
/// @brief Method GetTriggerRange addr 0x11fd178 size 0x120 virtual false final false
 ::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionTrigger__Range GetTriggerRange(int32_t index) ;
...
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionDelegate, "RootMotion.FinalIK", "InteractionSystem/InteractionDelegate");
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__InteractionSystem__InteractionEventDelegate, "RootMotion.FinalIK", "InteractionSystem/InteractionEventDelegate");
