...
constexpr int32_t __get_rootNodeIndex() const;
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap> __declspec(property(get=__get_spine, put=__set_spine))  spine;

constexpr void __set_spine(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap> __get_spine() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_leftUpperArm, put=__set_leftUpperArm))  leftUpperArm;

constexpr void __set_leftUpperArm(::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __get_leftUpperArm() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_rightUpperArm, put=__set_rightUpperArm))  rightUpperArm;

constexpr void __set_rightUpperArm(::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __get_rightUpperArm() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_leftThigh, put=__set_leftThigh))  leftThigh;

constexpr void __set_leftThigh(::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __get_leftThigh() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __declspec(property(get=__get_rightThigh, put=__set_rightThigh))  rightThigh;

constexpr void __set_rightThigh(::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKMapping__BoneMap __get_rightThigh() const;
