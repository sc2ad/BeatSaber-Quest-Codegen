...
namespace RootMotion::FinalIK {
  ...
  class HitReaction::HitPointEffector : public RootMotion::FinalIK::HitReaction::HitPoint {
    ...
    class EffectorLink;
    // [TooltipAttribute] Offset: 0xDBAD44
    ...
    // [TooltipAttribute] Offset: 0xDBAD7C
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::AnimationCurve*) == 0x8);
    // [TooltipAttribute] Offset: 0xDBADB4
    ...
    static HitReaction::HitPointEffector* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("HitPointEffector").WithContext(".ctor");
