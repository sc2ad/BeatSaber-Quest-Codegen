...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(HitReactionVRIK::PositionOffset), 88 + sizeof(void*) + ((88 + sizeof(void*)) % 8 != 0 ? (8 - (88 + sizeof(void*)) % 8) : 0)> __RootMotion_FinalIK_HitReactionVRIK_PositionOffsetSizeCheck;
}
