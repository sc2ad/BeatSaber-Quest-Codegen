...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(IKSolverFABRIKRoot), 120 + sizeof(UnityEngine::Vector3) + ((120 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (120 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverFABRIKRootSizeCheck;
}
