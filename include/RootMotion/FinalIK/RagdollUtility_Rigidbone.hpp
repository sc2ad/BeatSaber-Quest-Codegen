...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(RagdollUtility::Rigidbone), 104 + sizeof(UnityEngine::Quaternion) + ((104 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (104 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __RootMotion_FinalIK_RagdollUtility_RigidboneSizeCheck;
}
