...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(HitReactionVRIK::Offset), 76 + sizeof(float) + ((76 + sizeof(float)) % 8 != 0 ? (8 - (76 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_HitReactionVRIK_OffsetSizeCheck;
}
