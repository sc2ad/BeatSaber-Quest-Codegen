...
//  Writing Method size for method: ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink.Apply
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::*)(::RootMotion::FinalIK::IKSolverFullBodyBiped, float_t, ::UnityEngine::Quaternion)>(&::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::Apply)> {
  constexpr static std::size_t size = 0x250;
  constexpr static std::size_t addrs = 0x120b3f0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>::get(),
                            "Apply",
...
//  Writing Method size for method: ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::*)()>(&::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::_ctor)> {
...
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__set_effector(::RootMotion::FinalIK::FullBodyBipedEffector value)  {
...
constexpr ::RootMotion::FinalIK::FullBodyBipedEffector ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__get_effector() const {
...
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__set_offset(::UnityEngine::Vector3 value)  {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__get_offset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__set_pin(::UnityEngine::Vector3 value)  {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__get_pin() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__set_pinWeight(::UnityEngine::Vector3 value)  {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::__get_pinWeight() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::Apply(::RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight, ::UnityEngine::Quaternion rotation)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>::get(),
                            "Apply",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::____RootMotion__FinalIK__OffsetPose__EffectorLink()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____RootMotion__FinalIK__OffsetPose__EffectorLink>())) {}
 void ::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::RootMotion::FinalIK::OffsetPose::__set_effectorLinks(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink> value)  {
::cordl_internals::setInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>>(value));
}
constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink> ::RootMotion::FinalIK::OffsetPose::__get_effectorLinks() const {
return ::cordl_internals::getInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__OffsetPose__EffectorLink>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
