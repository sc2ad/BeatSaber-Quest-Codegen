...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(Inertia::Body::EffectorLink), 20 + sizeof(float) + ((20 + sizeof(float)) % 8 != 0 ? (8 - (20 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_Inertia_Body_EffectorLinkSizeCheck;
}
