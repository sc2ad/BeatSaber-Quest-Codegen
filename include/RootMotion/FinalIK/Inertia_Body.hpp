...
namespace RootMotion::FinalIK {
  ...
  class Inertia::Body : public ::Il2CppObject {
    ...
    class EffectorLink;
    public:
    // [TooltipAttribute] Offset: 0x1110EB0
    ...
    // [TooltipAttribute] Offset: 0x1110EE8
    ...
    // [TooltipAttribute] Offset: 0x1110F58
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x1110F90
    // [RangeAttribute] Offset: 0x1110F90
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x1110FE4
