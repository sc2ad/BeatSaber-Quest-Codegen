...
constexpr ::UnityEngine::Quaternion __get_IKRotation() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_chest, put=__set_chest))  chest;

constexpr void __set_chest(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_chest() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_shoulder, put=__set_shoulder))  shoulder;

constexpr void __set_shoulder(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_shoulder() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_upperArm, put=__set_upperArm))  upperArm;

constexpr void __set_upperArm(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_upperArm() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_forearm, put=__set_forearm))  forearm;

constexpr void __set_forearm(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_forearm() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_hand, put=__set_hand))  hand;

constexpr void __set_hand(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_hand() const;
...
constexpr bool __get_isLeft() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Arm __declspec(property(get=__get_arm, put=__set_arm))  arm;

constexpr void __set_arm(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Arm value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Arm __get_arm() const;
