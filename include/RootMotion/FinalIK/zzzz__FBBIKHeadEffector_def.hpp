...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone;
}
// Type: ::BendBone
namespace RootMotion::FinalIK {
// Is value type: false
...
class CORDL_TYPE ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____RootMotion__FinalIK__FBBIKHeadEffector__BendBone() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__FBBIKHeadEffector__BendBone", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone(____RootMotion__FinalIK__FBBIKHeadEffector__BendBone const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__FBBIKHeadEffector__BendBone", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone(____RootMotion__FinalIK__FBBIKHeadEffector__BendBone&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone& operator=(____RootMotion__FinalIK__FBBIKHeadEffector__BendBone&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone& operator=(____RootMotion__FinalIK__FBBIKHeadEffector__BendBone const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone() ;
...
explicit ____RootMotion__FinalIK__FBBIKHeadEffector__BendBone(::UnityEngine::Transform transform, float_t weight) ;
...
public:
// Declarations
using BendBone = ::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone;
...
constexpr float_t __get_bendWeight() const;
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone> __declspec(property(get=__get_bendBones, put=__set_bendBones))  bendBones;

constexpr void __set_bendBones(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone> __get_bendBones() const;
...
constexpr ::ArrayW<::UnityEngine::Transform> __get_chestBones() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__UpdateDelegate __declspec(property(get=__get_OnPostHeadEffectorFK, put=__set_OnPostHeadEffectorFK))  OnPostHeadEffectorFK;

constexpr void __set_OnPostHeadEffectorFK(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__UpdateDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__UpdateDelegate __get_OnPostHeadEffectorFK() const;
...
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__FBBIKHeadEffector__BendBone, "RootMotion.FinalIK", "FBBIKHeadEffector/BendBone");
