...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(InteractionObject::AnimatorEvent), 48 + sizeof(bool) + ((48 + sizeof(bool)) % 8 != 0 ? (8 - (48 + sizeof(bool)) % 8) : 0)> __RootMotion_FinalIK_InteractionObject_AnimatorEventSizeCheck;
}
