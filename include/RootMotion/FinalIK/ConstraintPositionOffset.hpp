...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(ConstraintPositionOffset), 64 + sizeof(bool) + ((64 + sizeof(bool)) % 8 != 0 ? (8 - (64 + sizeof(bool)) % 8) : 0)> __RootMotion_FinalIK_ConstraintPositionOffsetSizeCheck;
}
