...
namespace RootMotion::FinalIK {
  ...
  class IKMapping : public ::CsObject {
    public:
    ...
    // Offset: 0x137BB44
    bool BoneIsValid(UnityEngine::Transform* bone, RootMotion::FinalIK::IKSolver* solver, ::CsString*& message, RootMotion::Warning::Logger* logger);
