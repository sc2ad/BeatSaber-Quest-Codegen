...
constexpr void RootMotion::FinalIK::IKMappingSpine::__set_spine(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap> value)  {
::cordl_internals::setInstanceField<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>>(value));
}
constexpr ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap> RootMotion::FinalIK::IKMappingSpine::__get_spine() const {
return ::cordl_internals::getInstanceField<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::IKMappingSpine::__set_leftUpperArm(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value)  {
...
constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap RootMotion::FinalIK::IKMappingSpine::__get_leftUpperArm() const {
...
constexpr void RootMotion::FinalIK::IKMappingSpine::__set_rightUpperArm(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value)  {
...
constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap RootMotion::FinalIK::IKMappingSpine::__get_rightUpperArm() const {
...
constexpr void RootMotion::FinalIK::IKMappingSpine::__set_leftThigh(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value)  {
::cordl_internals::setInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x60>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>(value));
}
constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap RootMotion::FinalIK::IKMappingSpine::__get_leftThigh() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::IKMappingSpine::__set_rightThigh(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value)  {
::cordl_internals::setInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>(value));
}
constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap RootMotion::FinalIK::IKMappingSpine::__get_rightThigh() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
