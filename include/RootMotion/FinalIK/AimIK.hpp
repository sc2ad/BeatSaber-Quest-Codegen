...
namespace RootMotion::FinalIK {
  ...
  // [] Offset: FFFFFFFF
  // [HelpURLAttribute] Offset: DB47F8
  // [AddComponentMenu] Offset: DB47F8
  class AimIK : public RootMotion::FinalIK::IK {
    ...
    static AimIK* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("AimIK").WithContext(".ctor");
