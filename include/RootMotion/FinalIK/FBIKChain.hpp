...
namespace RootMotion::FinalIK {
  ...
  class FBIKChain : public ::Il2CppObject {
    ...
    check_size<sizeof(FBIKChain::Smoothing), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __RootMotion_FinalIK_FBIKChain_SmoothingSizeCheck;
  ...
  check_size<sizeof(FBIKChain), 128 + sizeof(float) + ((128 + sizeof(float)) % 8 != 0 ? (8 - (128 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_FBIKChainSizeCheck;
}
