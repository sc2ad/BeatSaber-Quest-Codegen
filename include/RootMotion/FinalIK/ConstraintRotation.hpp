...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(ConstraintRotation), 28 + sizeof(UnityEngine::Quaternion) + ((28 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (28 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __RootMotion_FinalIK_ConstraintRotationSizeCheck;
}
