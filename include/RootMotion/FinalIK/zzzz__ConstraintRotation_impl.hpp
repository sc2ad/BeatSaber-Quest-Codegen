...
RootMotion::FinalIK::ConstraintRotation o{THROW_UNLESS(::il2cpp_utils::New<RootMotion::FinalIK::ConstraintRotation>())};
return o;
}
...
RootMotion::FinalIK::ConstraintRotation o{THROW_UNLESS(::il2cpp_utils::New<RootMotion::FinalIK::ConstraintRotation>(transform))};
return o;
}
