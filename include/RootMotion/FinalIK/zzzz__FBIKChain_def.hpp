...
class CORDL_TYPE RootMotion__FinalIK__FBIKChain__ChildConstraint : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~RootMotion__FinalIK__FBIKChain__ChildConstraint() = default;

// Ctor Parameters [CppParam { name: "", ty: "RootMotion__FinalIK__FBIKChain__ChildConstraint", modifiers: " const&", def_value: None }]
constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint(RootMotion__FinalIK__FBIKChain__ChildConstraint const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "RootMotion__FinalIK__FBIKChain__ChildConstraint", modifiers: "&&", def_value: None }]
constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint(RootMotion__FinalIK__FBIKChain__ChildConstraint&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit RootMotion__FinalIK__FBIKChain__ChildConstraint(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint& operator=(RootMotion__FinalIK__FBIKChain__ChildConstraint&& o) noexcept = default;
  constexpr RootMotion__FinalIK__FBIKChain__ChildConstraint& operator=(RootMotion__FinalIK__FBIKChain__ChildConstraint const& o) noexcept = default;
...
struct CORDL_TYPE RootMotion__FinalIK__FBIKChain__Smoothing : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr RootMotion__FinalIK__FBIKChain__Smoothing(int32_t value__) noexcept;


                    constexpr RootMotion__FinalIK__FBIKChain__Smoothing(RootMotion__FinalIK__FBIKChain__Smoothing const&) = default;
                    constexpr RootMotion__FinalIK__FBIKChain__Smoothing(RootMotion__FinalIK__FBIKChain__Smoothing&&) = default;
                    constexpr RootMotion__FinalIK__FBIKChain__Smoothing& operator=(RootMotion__FinalIK__FBIKChain__Smoothing const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr RootMotion__FinalIK__FBIKChain__Smoothing& operator=(RootMotion__FinalIK__FBIKChain__Smoothing&& o) noexcept {
...
constexpr explicit RootMotion__FinalIK__FBIKChain__Smoothing(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __RootMotion__FinalIK__FBIKChain__Smoothing_Unwrapped : int32_t {
__None = 0,
__Exponential = 1,
__Cubic = 2,
};
...
static RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing const None;

/// @brief Field Exponential offset 0
static RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing const Exponential;

/// @brief Field Cubic offset 0
static RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing const Cubic;
...
public:
// Declarations
using Smoothing = RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing;

using ChildConstraint = RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint;
...
constexpr float_t __get_reach() const;
 ...
 RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing __declspec(property(get=__get_reachSmoothing, put=__set_reachSmoothing))  reachSmoothing;

constexpr void __set_reachSmoothing(RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing __get_reachSmoothing() const;

 RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing __declspec(property(get=__get_pushSmoothing, put=__set_pushSmoothing))  pushSmoothing;

constexpr void __set_pushSmoothing(RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing __get_pushSmoothing() const;

 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node> __declspec(property(get=__get_nodes, put=__set_nodes))  nodes;

constexpr void __set_nodes(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node> value) ;

constexpr ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node> __get_nodes() const;
...
constexpr ::ArrayW<int32_t> __get_children() const;
 ...
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint> __declspec(property(get=__get_childConstraints, put=__set_childConstraints))  childConstraints;

constexpr void __set_childConstraints(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint> value) ;

constexpr ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint> __get_childConstraints() const;
...
constexpr float_t __get_distance() const;
 ...
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_p, put=__set_p))  p;

constexpr void __set_p(RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point value) ;

constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point __get_p() const;
...
/// @brief Method SolveLinearConstraint addr 0x11cd464 size 0x128 virtual false final false
 void SolveLinearConstraint(RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node node1, RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node node2, float_t crossFade, float_t distance) ;
...
DEFINE_IL2CPP_ARG_TYPE(RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__Smoothing, "RootMotion.FinalIK", "FBIKChain/Smoothing");
NEED_NO_BOX(RootMotion::FinalIK::FBIKChain);
DEFINE_IL2CPP_ARG_TYPE(RootMotion::FinalIK::FBIKChain, "RootMotion.FinalIK", "FBIKChain");
NEED_NO_BOX(RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint);
DEFINE_IL2CPP_ARG_TYPE(RootMotion::FinalIK::RootMotion__FinalIK__FBIKChain__ChildConstraint, "RootMotion.FinalIK", "FBIKChain/ChildConstraint");
