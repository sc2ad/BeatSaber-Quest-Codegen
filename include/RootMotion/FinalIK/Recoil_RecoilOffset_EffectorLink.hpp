...
namespace RootMotion::FinalIK {
  ...
  class Recoil::RecoilOffset::EffectorLink : public ::Il2CppObject {
    public:
    // [TooltipAttribute] Offset: 0xE0E5C8
    ...
    // [TooltipAttribute] Offset: 0xE0E600
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink::*)()>(&RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink::*)()>(&RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::Recoil::RecoilOffset::EffectorLink*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
