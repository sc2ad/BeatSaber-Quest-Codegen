...
namespace RootMotion::FinalIK {
struct ____RootMotion__FinalIK__Recoil__Handedness;
}
namespace GlobalNamespace {
class ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink;
}
namespace RootMotion::FinalIK {
class Recoil;
}
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__Recoil__RecoilOffset;
}
// Type: ::EffectorLink
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink() = default;

// Ctor Parameters [CppParam { name: "", ty: "______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink", modifiers: " const&", def_value: None }]
constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink(______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink", modifiers: "&&", def_value: None }]
constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink(______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink& operator=(______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink&& o) noexcept = default;
  constexpr ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink& operator=(______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink const& o) noexcept = default;
...
// Ctor Parameters []
explicit ______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink() ;
...
class CORDL_TYPE ____RootMotion__FinalIK__Recoil__RecoilOffset : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using EffectorLink = ::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x48};

virtual ~____RootMotion__FinalIK__Recoil__RecoilOffset() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Recoil__RecoilOffset", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset(____RootMotion__FinalIK__Recoil__RecoilOffset const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Recoil__RecoilOffset", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset(____RootMotion__FinalIK__Recoil__RecoilOffset&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__Recoil__RecoilOffset(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset& operator=(____RootMotion__FinalIK__Recoil__RecoilOffset&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__Recoil__RecoilOffset& operator=(____RootMotion__FinalIK__Recoil__RecoilOffset const& o) noexcept = default;
...
constexpr float_t __get_maxAdditiveOffsetMag() const;
 ...
 ::ArrayW<::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink> __declspec(property(get=__get_effectorLinks, put=__set_effectorLinks))  effectorLinks;

constexpr void __set_effectorLinks(::ArrayW<::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink> value) ;

constexpr ::ArrayW<::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink> __get_effectorLinks() const;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__Recoil__RecoilOffset() ;
...
struct CORDL_TYPE ____RootMotion__FinalIK__Recoil__Handedness : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____RootMotion__FinalIK__Recoil__Handedness(int32_t value__) noexcept;


                    constexpr ____RootMotion__FinalIK__Recoil__Handedness(____RootMotion__FinalIK__Recoil__Handedness const&) = default;
                    constexpr ____RootMotion__FinalIK__Recoil__Handedness(____RootMotion__FinalIK__Recoil__Handedness&&) = default;
                    constexpr ____RootMotion__FinalIK__Recoil__Handedness& operator=(____RootMotion__FinalIK__Recoil__Handedness const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____RootMotion__FinalIK__Recoil__Handedness& operator=(____RootMotion__FinalIK__Recoil__Handedness&& o) noexcept {
...
constexpr explicit ____RootMotion__FinalIK__Recoil__Handedness(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______RootMotion__FinalIK__Recoil__Handedness_Unwrapped : int32_t {
__Right = 0,
__Left = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______RootMotion__FinalIK__Recoil__Handedness_Unwrapped () const noexcept {
return std::bit_cast<______RootMotion__FinalIK__Recoil__Handedness_Unwrapped>(__instance);
}
...
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness const Right;

/// @brief Field Left offset 0
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness const Left;
...
public:
// Declarations
using Handedness = ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness;

using RecoilOffset = ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset;
...
constexpr bool __get_aimIKSolvedLast() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness __declspec(property(get=__get_handedness, put=__set_handedness))  handedness;

constexpr void __set_handedness(::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness __get_handedness() const;
...
constexpr float_t __get_blendTime() const;
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset> __declspec(property(get=__get_offsets, put=__set_offsets))  offsets;

constexpr void __set_offsets(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset> __get_offsets() const;
...
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__Handedness, "RootMotion.FinalIK", "Recoil/Handedness");
NEED_NO_BOX(::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______RootMotion__FinalIK__Recoil__RecoilOffset__EffectorLink, "RootMotion.FinalIK", "Recoil/RecoilOffset/EffectorLink");
NEED_NO_BOX(::RootMotion::FinalIK::Recoil);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::Recoil, "RootMotion.FinalIK", "Recoil");
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Recoil__RecoilOffset, "RootMotion.FinalIK", "Recoil/RecoilOffset");
