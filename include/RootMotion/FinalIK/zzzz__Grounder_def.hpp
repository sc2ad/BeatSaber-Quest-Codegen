...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__Grounder__GrounderDelegate;
}
...
class CORDL_TYPE ____RootMotion__FinalIK__Grounder__GrounderDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____RootMotion__FinalIK__Grounder__GrounderDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounder__GrounderDelegate", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate(____RootMotion__FinalIK__Grounder__GrounderDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounder__GrounderDelegate", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate(____RootMotion__FinalIK__Grounder__GrounderDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__Grounder__GrounderDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate& operator=(____RootMotion__FinalIK__Grounder__GrounderDelegate&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__Grounder__GrounderDelegate& operator=(____RootMotion__FinalIK__Grounder__GrounderDelegate const& o) noexcept = default;
...
explicit ____RootMotion__FinalIK__Grounder__GrounderDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using GrounderDelegate = ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate;
...
constexpr ::RootMotion::FinalIK::Grounding __get_solver() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate __declspec(property(get=__get_OnPreGrounder, put=__set_OnPreGrounder))  OnPreGrounder;

constexpr void __set_OnPreGrounder(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate __get_OnPreGrounder() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate __declspec(property(get=__get_OnPostGrounder, put=__set_OnPostGrounder))  OnPostGrounder;

constexpr void __set_OnPostGrounder(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate __get_OnPostGrounder() const;
...
/// @brief Method GetLegSpineBendVector addr 0x11ba130 size 0x1ec virtual false final false
 ::UnityEngine::Vector3 GetLegSpineBendVector(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg leg) ;

/// @brief Method GetLegSpineTangent addr 0x11ba340 size 0x174 virtual false final false
 ::UnityEngine::Vector3 GetLegSpineTangent(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg leg) ;
...
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounder__GrounderDelegate, "RootMotion.FinalIK", "Grounder/GrounderDelegate");
