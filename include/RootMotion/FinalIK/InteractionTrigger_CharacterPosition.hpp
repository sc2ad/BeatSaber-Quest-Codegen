...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(InteractionTrigger::CharacterPosition), 41 + sizeof(bool) + 8 - (41 + sizeof(bool)) % 8> __RootMotion_FinalIK_InteractionTrigger_CharacterPositionSizeCheck;
}
