...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(IKSolverVR), 364 + sizeof(UnityEngine::Vector3) + ((364 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (364 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverVRSizeCheck;
}
