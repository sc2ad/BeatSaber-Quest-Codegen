...
constexpr RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF::RootMotion__FinalIK__Finger__DOF(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF  RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF::One{0};
constexpr RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF  RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF::Three{1};
...
constexpr void RootMotion::FinalIK::Finger::__set_rotationDOF(RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF value)  {
::cordl_internals::setInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF>(value));
}
constexpr RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF RootMotion::FinalIK::Finger::__get_rotationDOF() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__Finger__DOF, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
RootMotion::FinalIK::Finger o{THROW_UNLESS(::il2cpp_utils::New<RootMotion::FinalIK::Finger>())};
return o;
}
