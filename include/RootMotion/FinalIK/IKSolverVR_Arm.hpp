...
namespace RootMotion::FinalIK {
  ...
  class IKSolverVR::Arm : public RootMotion::FinalIK::IKSolverVR::BodyPart {
    ...
    check_size<sizeof(IKSolverVR::Arm::ShoulderRotationMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __RootMotion_FinalIK_IKSolverVR_Arm_ShoulderRotationModeSizeCheck;
  ...
  check_size<sizeof(IKSolverVR::Arm), 316 + sizeof(UnityEngine::Vector3) + ((316 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (316 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverVR_ArmSizeCheck;
}
