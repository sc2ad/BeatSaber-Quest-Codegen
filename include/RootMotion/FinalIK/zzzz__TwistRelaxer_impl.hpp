...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::TwistRelaxer::*)()>(&::RootMotion::FinalIK::TwistRelaxer::Relax)> {
  ...
  constexpr static std::size_t addrs = 0x11f6bc0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::TwistRelaxer::*)()>(&::RootMotion::FinalIK::TwistRelaxer::Start)> {
  ...
  constexpr static std::size_t addrs = 0x11f7004;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::TwistRelaxer::*)()>(&::RootMotion::FinalIK::TwistRelaxer::LateUpdate)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x11f741c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::TwistRelaxer::*)()>(&::RootMotion::FinalIK::TwistRelaxer::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x11f7494;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::TwistRelaxer::*)()>(&::RootMotion::FinalIK::TwistRelaxer::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x11f75ac;
...
constexpr ::RootMotion::FinalIK::IK ::RootMotion::FinalIK::TwistRelaxer::__get_ik() const {
...
constexpr ::UnityEngine::Transform ::RootMotion::FinalIK::TwistRelaxer::__get_parent() const {
...
constexpr ::UnityEngine::Transform ::RootMotion::FinalIK::TwistRelaxer::__get_child() const {
...
constexpr float_t ::RootMotion::FinalIK::TwistRelaxer::__get_weight() const {
...
constexpr float_t ::RootMotion::FinalIK::TwistRelaxer::__get_parentChildCrossfade() const {
...
constexpr float_t ::RootMotion::FinalIK::TwistRelaxer::__get_twistAngleOffset() const {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::TwistRelaxer::__get_twistAxis() const {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::TwistRelaxer::__get_axis() const {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::TwistRelaxer::__get_axisRelativeToParentDefault() const {
...
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::TwistRelaxer::__get_axisRelativeToChildDefault() const {
