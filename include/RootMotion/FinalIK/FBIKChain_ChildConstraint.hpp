...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(FBIKChain::ChildConstraint), 60 + sizeof(int) + ((60 + sizeof(int)) % 8 != 0 ? (8 - (60 + sizeof(int)) % 8) : 0)> __RootMotion_FinalIK_FBIKChain_ChildConstraintSizeCheck;
}
