...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(IKSolverVR::VirtualBone), 80 + sizeof(UnityEngine::Vector3) + ((80 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (80 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverVR_VirtualBoneSizeCheck;
}
