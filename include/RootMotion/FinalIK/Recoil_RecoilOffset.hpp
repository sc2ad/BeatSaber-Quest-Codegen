...
namespace RootMotion::FinalIK {
  ...
  class Recoil::RecoilOffset : public ::Il2CppObject {
    ...
    class EffectorLink;
    // [TooltipAttribute] Offset: 0xDBB5E8
    ...
    // [TooltipAttribute] Offset: 0xDBB620
    // [RangeAttribute] Offset: 0xDBB620
    ...
    // [TooltipAttribute] Offset: 0xDBB674
    ...
    static Recoil::RecoilOffset* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("RecoilOffset").WithContext(".ctor");
