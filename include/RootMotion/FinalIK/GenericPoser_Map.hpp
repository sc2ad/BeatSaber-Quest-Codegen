...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(GenericPoser::Map), 44 + sizeof(UnityEngine::Quaternion) + ((44 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (44 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __RootMotion_FinalIK_GenericPoser_MapSizeCheck;
}
