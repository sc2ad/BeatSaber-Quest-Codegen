...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(IKSolverFullBodyBiped), 240 + sizeof(UnityEngine::Vector3) + ((240 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (240 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverFullBodyBipedSizeCheck;
}
