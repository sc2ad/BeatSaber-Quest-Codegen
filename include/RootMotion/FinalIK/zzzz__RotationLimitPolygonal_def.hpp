...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint;
}
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone;
}
// Type: ::ReachCone
namespace RootMotion::FinalIK {
// Is value type: false
...
class CORDL_TYPE ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone(____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone(____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone& operator=(____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone& operator=(____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone const& o) noexcept = default;
...
explicit ____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone(::UnityEngine::Vector3 _o, ::UnityEngine::Vector3 _a, ::UnityEngine::Vector3 _b, ::UnityEngine::Vector3 _c) ;
...
class CORDL_TYPE ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint(____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint(____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint& operator=(____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint& operator=(____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint() ;
...
public:
// Declarations
using LimitPoint = ::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint;

using ReachCone = ::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone;
...
constexpr int32_t __get_smoothIterations() const;
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint> __declspec(property(get=__get_points, put=__set_points))  points;

constexpr void __set_points(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint> __get_points() const;
...
constexpr ::ArrayW<::UnityEngine::Vector3> __get_P() const;
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone> __declspec(property(get=__get_reachCones, put=__set_reachCones))  reachCones;

constexpr void __set_reachCones(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone> __get_reachCones() const;
...
/// @brief Method SetLimitPoints addr 0x1203d00 size 0x8c virtual false final false
 void SetLimitPoints(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint> points) ;
...
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint, "RootMotion.FinalIK", "RotationLimitPolygonal/LimitPoint");
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__RotationLimitPolygonal__ReachCone, "RootMotion.FinalIK", "RotationLimitPolygonal/ReachCone");
