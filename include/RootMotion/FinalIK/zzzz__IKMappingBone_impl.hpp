...
constexpr void RootMotion::FinalIK::IKMappingBone::__set_boneMap(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap value)  {
::cordl_internals::setInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap>(value));
}
constexpr RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap RootMotion::FinalIK::IKMappingBone::__get_boneMap() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
