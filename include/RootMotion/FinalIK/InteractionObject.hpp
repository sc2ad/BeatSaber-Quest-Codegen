...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: DF0E60
  // [AddComponentMenu] Offset: DF0E60
  class InteractionObject : public UnityEngine::MonoBehaviour {
    ...
    class WeightCurve : public ::Il2CppObject {
      ...
      // [TooltipAttribute] Offset: 0xDF77C4
      ...
      char __padding0[0x4] = {};
      // [TooltipAttribute] Offset: 0xDF77FC
    ...
    // [TooltipAttribute] Offset: 0xDF4660
    ...
    // [TooltipAttribute] Offset: 0xDF4698
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0xDF46D0
