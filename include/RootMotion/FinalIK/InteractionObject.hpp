...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: 10F703C
  // [AddComponentMenu] Offset: 10F703C
  class InteractionObject : public ::UnityEngine::MonoBehaviour {
    ...
    class WeightCurve : public ::Il2CppObject {
      ...
      public:
      // [TooltipAttribute] Offset: 0x10FC9A0
      ...
      char __padding0[0x4] = {};
      // [TooltipAttribute] Offset: 0x10FC9D8
    ...
    public:
    // [TooltipAttribute] Offset: 0x10F983C
    ...
    // [TooltipAttribute] Offset: 0x10F9874
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0x10F98AC
