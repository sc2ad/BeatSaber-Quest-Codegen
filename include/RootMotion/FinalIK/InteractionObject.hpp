...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: E2482C
  // [AddComponentMenu] Offset: E2482C
  class InteractionObject : public UnityEngine::MonoBehaviour {
    ...
    class WeightCurve : public ::Il2CppObject {
      ...
      // [TooltipAttribute] Offset: 0xE2A190
      ...
      char __padding0[0x4] = {};
      // [TooltipAttribute] Offset: 0xE2A1C8
    ...
    // [TooltipAttribute] Offset: 0xE2702C
    ...
    // [TooltipAttribute] Offset: 0xE27064
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0xE2709C
