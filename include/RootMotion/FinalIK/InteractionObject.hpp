...
namespace RootMotion::FinalIK {
  ...
  class InteractionObject : public UnityEngine::MonoBehaviour {
    ...
    class WeightCurve : public ::Il2CppObject {
      ...
      check_size<sizeof(InteractionObject::WeightCurve::Type), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __RootMotion_FinalIK_InteractionObject_WeightCurve_TypeSizeCheck;
    ...
    check_size<sizeof(InteractionObject::WeightCurve), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __RootMotion_FinalIK_InteractionObject_WeightCurveSizeCheck;
  ...
  check_size<sizeof(InteractionObject), 88 + sizeof(void*) + ((88 + sizeof(void*)) % 8 != 0 ? (8 - (88 + sizeof(void*)) % 8) : 0)> __RootMotion_FinalIK_InteractionObjectSizeCheck;
}
