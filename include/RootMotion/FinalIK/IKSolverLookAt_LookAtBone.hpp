...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(IKSolverLookAt::LookAtBone), 116 + sizeof(UnityEngine::Vector3) + ((116 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (116 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_IKSolverLookAt_LookAtBoneSizeCheck;
}
