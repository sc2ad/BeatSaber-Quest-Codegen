...
constexpr ::UnityEngine::Quaternion __get_IKRotation() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_pelvis, put=__set_pelvis))  pelvis;

constexpr void __set_pelvis(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_pelvis() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_thigh, put=__set_thigh))  thigh;

constexpr void __set_thigh(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_thigh() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_calf, put=__set_calf))  calf;

constexpr void __set_calf(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_calf() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_foot, put=__set_foot))  foot;

constexpr void __set_foot(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_foot() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __declspec(property(get=__get_toe, put=__set_toe))  toe;

constexpr void __set_toe(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Point __get_toe() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Leg __declspec(property(get=__get_leg, put=__set_leg))  leg;

constexpr void __set_leg(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Leg value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverVR__Leg __get_leg() const;
