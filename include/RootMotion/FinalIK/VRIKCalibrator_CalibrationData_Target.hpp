...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(VRIKCalibrator::CalibrationData::Target), 32 + sizeof(UnityEngine::Quaternion) + ((32 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (32 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __RootMotion_FinalIK_VRIKCalibrator_CalibrationData_TargetSizeCheck;
}
