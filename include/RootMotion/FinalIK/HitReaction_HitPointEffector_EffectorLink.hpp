...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(HitReaction::HitPointEffector::EffectorLink), 36 + sizeof(UnityEngine::Vector3) + ((36 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (36 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __RootMotion_FinalIK_HitReaction_HitPointEffector_EffectorLinkSizeCheck;
}
