...
namespace RootMotion::FinalIK {
  ...
  class Amplifier::Body::EffectorLink : public ::Il2CppObject {
    public:
    // [TooltipAttribute] Offset: 0xE0E280
    ...
    // [TooltipAttribute] Offset: 0xE0E2B8
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::Amplifier::Body::EffectorLink::*)()>(&RootMotion::FinalIK::Amplifier::Body::EffectorLink::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::Amplifier::Body::EffectorLink*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::Amplifier::Body::EffectorLink::*)()>(&RootMotion::FinalIK::Amplifier::Body::EffectorLink::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::Amplifier::Body::EffectorLink*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
