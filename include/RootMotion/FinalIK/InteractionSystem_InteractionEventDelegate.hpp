...
namespace RootMotion::FinalIK {
  ...
  class InteractionSystem::InteractionEventDelegate : public System::MulticastDelegate {
    ...
    // Offset: 0x1BF5118
    void Invoke_NEW(RootMotion::FinalIK::FullBodyBipedEffector effectorType, RootMotion::FinalIK::InteractionObject* interactionObject, RootMotion::FinalIK::InteractionObject::InteractionEvent* interactionEvent);
    ...
    // Offset: 0x1BFA8AC
    System::IAsyncResult* BeginInvoke_NEW(RootMotion::FinalIK::FullBodyBipedEffector effectorType, RootMotion::FinalIK::InteractionObject* interactionObject, RootMotion::FinalIK::InteractionObject::InteractionEvent* interactionEvent, System::AsyncCallback* callback, ::Il2CppObject* object);
