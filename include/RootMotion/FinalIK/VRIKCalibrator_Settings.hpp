...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(VRIKCalibrator::Settings), 156 + sizeof(float) + ((156 + sizeof(float)) % 8 != 0 ? (8 - (156 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_VRIKCalibrator_SettingsSizeCheck;
}
