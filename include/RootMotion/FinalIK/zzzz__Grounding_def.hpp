...
struct ____RootMotion__FinalIK__Grounding__Quality;
}
namespace RootMotion::FinalIK {
class Grounding;
}
...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__Grounding__Pelvis;
}
// Type: ::Quality
namespace RootMotion::FinalIK {
// Is value type: true
...
struct CORDL_TYPE ____RootMotion__FinalIK__Grounding__Quality : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounding__Quality(int32_t value__) noexcept;


                    constexpr ____RootMotion__FinalIK__Grounding__Quality(____RootMotion__FinalIK__Grounding__Quality const&) = default;
                    constexpr ____RootMotion__FinalIK__Grounding__Quality(____RootMotion__FinalIK__Grounding__Quality&&) = default;
                    constexpr ____RootMotion__FinalIK__Grounding__Quality& operator=(____RootMotion__FinalIK__Grounding__Quality const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____RootMotion__FinalIK__Grounding__Quality& operator=(____RootMotion__FinalIK__Grounding__Quality&& o) noexcept {
...
constexpr explicit ____RootMotion__FinalIK__Grounding__Quality(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______RootMotion__FinalIK__Grounding__Quality_Unwrapped : int32_t {
__Fastest = 0,
__Simple = 1,
__Best = 2,
};
...
constexpr operator ______RootMotion__FinalIK__Grounding__Quality_Unwrapped () const noexcept {
return std::bit_cast<______RootMotion__FinalIK__Grounding__Quality_Unwrapped>(__instance);
}
...
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality const Fastest;

/// @brief Field Simple offset 0
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality const Simple;

/// @brief Field Best offset 0
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality const Best;
...
class CORDL_TYPE ____RootMotion__FinalIK__Grounding__Leg : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x118};

virtual ~____RootMotion__FinalIK__Grounding__Leg() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounding__Leg", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounding__Leg(____RootMotion__FinalIK__Grounding__Leg const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounding__Leg", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounding__Leg(____RootMotion__FinalIK__Grounding__Leg&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__Grounding__Leg(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__Grounding__Leg& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounding__Leg& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounding__Leg& operator=(____RootMotion__FinalIK__Grounding__Leg&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__Grounding__Leg& operator=(____RootMotion__FinalIK__Grounding__Leg const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__Grounding__Leg() ;
...
class CORDL_TYPE ____RootMotion__FinalIK__Grounding__Pelvis : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____RootMotion__FinalIK__Grounding__Pelvis() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounding__Pelvis", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounding__Pelvis(____RootMotion__FinalIK__Grounding__Pelvis const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__Grounding__Pelvis", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__Grounding__Pelvis(____RootMotion__FinalIK__Grounding__Pelvis&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__Grounding__Pelvis(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____RootMotion__FinalIK__Grounding__Pelvis& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounding__Pelvis& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__Grounding__Pelvis& operator=(____RootMotion__FinalIK__Grounding__Pelvis&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__Grounding__Pelvis& operator=(____RootMotion__FinalIK__Grounding__Pelvis const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__Grounding__Pelvis() ;
...
public:
// Declarations
using Pelvis = ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis;

using Leg = ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg;

using Quality = ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality;
...
constexpr bool __get_overstepFallsDown() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality __declspec(property(get=__get_quality, put=__set_quality))  quality;

constexpr void __set_quality(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality __get_quality() const;

 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> __declspec(property(get=__get__legs_k__BackingField, put=__set__legs_k__BackingField))  _legs_k__BackingField;

constexpr void __set__legs_k__BackingField(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> value) ;

constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> __get__legs_k__BackingField() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis __declspec(property(get=__get__pelvis_k__BackingField, put=__set__pelvis_k__BackingField))  _pelvis_k__BackingField;

constexpr void __set__pelvis_k__BackingField(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis __get__pelvis_k__BackingField() const;
...
// Properties
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> __declspec(property(get=get_legs, put=set_legs))  legs;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis __declspec(property(get=get_pelvis, put=set_pelvis))  pelvis;
...
/// @brief Method get_legs addr 0x11c1b50 size 0x8 virtual false final false
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> get_legs() ;

/// @brief Method set_legs addr 0x11c1b58 size 0x8 virtual false final false
 void set_legs(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg> value) ;

/// @brief Method get_pelvis addr 0x11c1b60 size 0x8 virtual false final false
 ::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis get_pelvis() ;

/// @brief Method set_pelvis addr 0x11c1b68 size 0x8 virtual false final false
 void set_pelvis(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Quality, "RootMotion.FinalIK", "Grounding/Quality");
NEED_NO_BOX(::RootMotion::FinalIK::Grounding);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::Grounding, "RootMotion.FinalIK", "Grounding");
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Leg, "RootMotion.FinalIK", "Grounding/Leg");
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Grounding__Pelvis, "RootMotion.FinalIK", "Grounding/Pelvis");
