...
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::____RootMotion__FinalIK__IKSolverLimb__BendModifier(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier  ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::Animation{0};
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier  ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::Target{1};
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier  ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::Parent{2};
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier  ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::Arm{3};
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier  ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier::Goal{4};
//  Writing Method size for method: ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::_ctor)> {
  constexpr static std::size_t size = 0x19c;
  constexpr static std::size_t addrs = 0x11e1b78;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>::get(),
                            ".ctor",
...
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::____RootMotion__FinalIK__IKSolverLimb__AxisDirection(::UnityEngine::Vector3 direction, ::UnityEngine::Vector3 axis, float_t dot) noexcept : ::bs_hook::ValueTypeWrapper() {this->direction = direction;
this->axis = axis;
this->dot = dot;
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__set_direction(::UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector3, 0x0>(this->__instance, std::forward<::UnityEngine::Vector3>(value));
}
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__get_direction() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->__instance);
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__set_axis(::UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector3, 0xc>(this->__instance, std::forward<::UnityEngine::Vector3>(value));
}
constexpr ::UnityEngine::Vector3 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__get_axis() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0xc>(this->__instance);
}
constexpr void ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__set_dot(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x18>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::__get_dot() const {
return ::cordl_internals::getInstanceField<float_t, 0x18>(this->__instance);
}
 void ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection::_ctor(::UnityEngine::Vector3 direction, ::UnityEngine::Vector3 axis)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> (::RootMotion::FinalIK::IKSolverLimb::*)()>(&::RootMotion::FinalIK::IKSolverLimb::get_axisDirections)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::RootMotion::FinalIK::IKSolverLimb::*)(ByRef<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>>)>(&::RootMotion::FinalIK::IKSolverLimb::StoreAxisDirections)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "StoreAxisDirections",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>>>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::RootMotion::FinalIK::IKSolverLimb::__set_bendModifier(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier value)  {
::cordl_internals::setInstanceField<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier, 0xac>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier>(value));
}
constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier ::RootMotion::FinalIK::IKSolverLimb::__get_bendModifier() const {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__BendModifier, 0xac>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::RootMotion::FinalIK::IKSolverLimb::__set_axisDirectionsLeft(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> value)  {
::cordl_internals::setInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>, 0x130>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>>(value));
}
constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> ::RootMotion::FinalIK::IKSolverLimb::__get_axisDirectionsLeft() const {
return ::cordl_internals::getInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>, 0x130>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::RootMotion::FinalIK::IKSolverLimb::__set_axisDirectionsRight(::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> value)  {
::cordl_internals::setInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>, 0x138>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>>(value));
}
constexpr ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> ::RootMotion::FinalIK::IKSolverLimb::__get_axisDirectionsRight() const {
return ::cordl_internals::getInstanceField<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>, 0x138>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, goal);
 ...
 ::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection> ::RootMotion::FinalIK::IKSolverLimb::get_axisDirections()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::IKSolverLimb>::get(),
                            "get_axisDirections",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::RootMotion::FinalIK::IKSolverLimb::StoreAxisDirections(ByRef<::ArrayW<::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverLimb__AxisDirection>> axisDirections)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::FinalIK::IKSolverLimb>::get(),
                            "StoreAxisDirections",
                            std::vector<Il2CppClass*>{},
