...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: 10F6AC4
  // [AddComponentMenu] Offset: 10F6AC4
  class GrounderFBBIK : public ::RootMotion::FinalIK::Grounder {
    ...
    class SpineEffector;
    public:
    // [TooltipAttribute] Offset: 0x10F7E6C
    ...
    // [TooltipAttribute] Offset: 0x10F7EA4
    ...
    // [TooltipAttribute] Offset: 0x10F7EDC
