...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: 113ACB4
  // [AddComponentMenu] Offset: 113ACB4
  class GrounderFBBIK : public ::RootMotion::FinalIK::Grounder {
    ...
    class SpineEffector;
    public:
    // [TooltipAttribute] Offset: 0x113C05C
    ...
    // [TooltipAttribute] Offset: 0x113C094
    ...
    // [TooltipAttribute] Offset: 0x113C0CC
