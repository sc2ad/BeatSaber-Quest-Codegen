...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(GrounderFBBIK::SpineEffector), 24 + sizeof(float) + ((24 + sizeof(float)) % 8 != 0 ? (8 - (24 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_GrounderFBBIK_SpineEffectorSizeCheck;
}
