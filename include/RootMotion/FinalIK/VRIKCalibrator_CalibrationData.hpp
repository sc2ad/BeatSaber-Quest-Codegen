...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(VRIKCalibrator::CalibrationData), 104 + sizeof(float) + ((104 + sizeof(float)) % 8 != 0 ? (8 - (104 + sizeof(float)) % 8) : 0)> __RootMotion_FinalIK_VRIKCalibrator_CalibrationDataSizeCheck;
}
