...
namespace RootMotion::FinalIK {
  ...
  class OffsetModifier::OffsetLimits : public ::Il2CppObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0x113DB48
    ...
    // [TooltipAttribute] Offset: 0x113DB80
    ...
    // [TooltipAttribute] Offset: 0x113DBB8
    ...
    // [TooltipAttribute] Offset: 0x113DBF0
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [TooltipAttribute] Offset: 0x113DC28
    ...
    char __padding4[0x1] = {};
    // [TooltipAttribute] Offset: 0x113DC60
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113DC98
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113DCD0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113DD08
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113DD40
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113DD78
