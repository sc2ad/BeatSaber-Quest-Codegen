...
namespace RootMotion::FinalIK {
class ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone;
}
...
class CORDL_TYPE ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone : public ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Bone {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x90};

virtual ~____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone() = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone", modifiers: " const&", def_value: None }]
constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone(____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone", modifiers: "&&", def_value: None }]
constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone(____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone(void* ptr) noexcept : ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolver__Bone(ptr) {
}


  constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone& operator=(____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone&& o) noexcept = default;
  constexpr ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone& operator=(____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone() ;
...
public:
// Declarations
using TrigonometricBone = ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone;
...
constexpr ::UnityEngine::Vector3 __get_bendNormal() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __declspec(property(get=__get_bone1, put=__set_bone1))  bone1;

constexpr void __set_bone1(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __get_bone1() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __declspec(property(get=__get_bone2, put=__set_bone2))  bone2;

constexpr void __set_bone2(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __get_bone2() const;

 ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __declspec(property(get=__get_bone3, put=__set_bone3))  bone3;

constexpr void __set_bone3(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone __get_bone3() const;
...
NEED_NO_BOX(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone);
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__IKSolverTrigonometric__TrigonometricBone, "RootMotion.FinalIK", "IKSolverTrigonometric/TrigonometricBone");
