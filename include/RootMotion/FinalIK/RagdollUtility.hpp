...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: EF0D5C
  class RagdollUtility : public UnityEngine::MonoBehaviour {
    ...
    protected:
    #endif
    // [TooltipAttribute] Offset: 0xEF39C0
    ...
    // [TooltipAttribute] Offset: 0xEF39F8
    ...
    // [TooltipAttribute] Offset: 0xEF3A30
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0xEF3A68
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xEF3AA0
