...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: 10F71BC
  class RagdollUtility : public ::UnityEngine::MonoBehaviour {
    ...
    public:
    // [TooltipAttribute] Offset: 0x10F9E20
    ...
    // [TooltipAttribute] Offset: 0x10F9E58
    ...
    // [TooltipAttribute] Offset: 0x10F9E90
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0x10F9EC8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10F9F00
