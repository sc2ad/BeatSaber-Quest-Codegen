...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: 11374DC
  class RagdollUtility : public ::UnityEngine::MonoBehaviour {
    ...
    public:
    // [TooltipAttribute] Offset: 0x113A140
    ...
    // [TooltipAttribute] Offset: 0x113A178
    ...
    // [TooltipAttribute] Offset: 0x113A1B0
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0x113A1E8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x113A220
