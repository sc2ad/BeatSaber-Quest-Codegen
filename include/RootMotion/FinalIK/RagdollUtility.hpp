...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: 10FA080
  class RagdollUtility : public ::UnityEngine::MonoBehaviour {
    ...
    public:
    // [TooltipAttribute] Offset: 0x10FCCE4
    ...
    // [TooltipAttribute] Offset: 0x10FCD1C
    ...
    // [TooltipAttribute] Offset: 0x10FCD54
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0x10FCD8C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10FCDC4
