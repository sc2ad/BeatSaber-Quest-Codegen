...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: 10D9C2C
  class RagdollUtility : public ::UnityEngine::MonoBehaviour {
    ...
    #endif
    #endif
    // [TooltipAttribute] Offset: 0x10DC890
    ...
    // [TooltipAttribute] Offset: 0x10DC8C8
    ...
    // [TooltipAttribute] Offset: 0x10DC900
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0x10DC938
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0x10DC970
