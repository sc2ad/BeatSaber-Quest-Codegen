...
namespace RootMotion::FinalIK {
struct ____RootMotion__FinalIK__Finger__DOF;
}
namespace RootMotion::FinalIK {
class Finger;
}
...
struct CORDL_TYPE ____RootMotion__FinalIK__Finger__DOF : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____RootMotion__FinalIK__Finger__DOF(int32_t value__) noexcept;


                    constexpr ____RootMotion__FinalIK__Finger__DOF(____RootMotion__FinalIK__Finger__DOF const&) = default;
                    constexpr ____RootMotion__FinalIK__Finger__DOF(____RootMotion__FinalIK__Finger__DOF&&) = default;
                    constexpr ____RootMotion__FinalIK__Finger__DOF& operator=(____RootMotion__FinalIK__Finger__DOF const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____RootMotion__FinalIK__Finger__DOF& operator=(____RootMotion__FinalIK__Finger__DOF&& o) noexcept {
...
constexpr explicit ____RootMotion__FinalIK__Finger__DOF(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______RootMotion__FinalIK__Finger__DOF_Unwrapped : int32_t {
__One = 0,
__Three = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______RootMotion__FinalIK__Finger__DOF_Unwrapped () const noexcept {
return std::bit_cast<______RootMotion__FinalIK__Finger__DOF_Unwrapped>(__instance);
}
...
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF const One;

/// @brief Field Three offset 0
static ::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF const Three;
...
public:
// Declarations
using DOF = ::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF;
...
constexpr float_t __get_rotationWeight() const;
 ...
 ::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF __declspec(property(get=__get_rotationDOF, put=__set_rotationDOF))  rotationDOF;

constexpr void __set_rotationDOF(::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF value) ;

constexpr ::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF __get_rotationDOF() const;
...
DEFINE_IL2CPP_ARG_TYPE(::RootMotion::FinalIK::____RootMotion__FinalIK__Finger__DOF, "RootMotion.FinalIK", "Finger/DOF");
