...
namespace RootMotion::FinalIK {
  ...
  // [] Offset: FFFFFFFF
  // [HelpURLAttribute] Offset: DB4D10
  // [AddComponentMenu] Offset: DB4D10
  class InteractionTrigger : public UnityEngine::MonoBehaviour {
    ...
    class Range;
    // [TooltipAttribute] Offset: 0xDB7954
    ...
    static InteractionTrigger* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("RootMotion::FinalIK").WithContext("InteractionTrigger").WithContext(".ctor");
