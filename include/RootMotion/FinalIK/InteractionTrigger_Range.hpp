...
namespace RootMotion::FinalIK {
  ...
  check_size<sizeof(InteractionTrigger::Range), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __RootMotion_FinalIK_InteractionTrigger_RangeSizeCheck;
}
