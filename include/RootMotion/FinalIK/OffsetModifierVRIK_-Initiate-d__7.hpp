...
namespace RootMotion::FinalIK {
  ...
  class OffsetModifierVRIK::$Initiate$d__7 : public ::CsObject, public System::Collections::Generic::IEnumerator_1<::CsObject*>, public System::Collections::IEnumerator, public System::IDisposable {
    public:
