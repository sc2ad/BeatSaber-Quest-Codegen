...
namespace RootMotion {
  ...
  check_size<sizeof(DemoGUIMessage), 32 + sizeof(UnityEngine::Color) + ((32 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (32 + sizeof(UnityEngine::Color)) % 8) : 0)> __RootMotion_DemoGUIMessageSizeCheck;
}
