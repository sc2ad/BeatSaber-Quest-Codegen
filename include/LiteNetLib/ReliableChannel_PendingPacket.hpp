...
namespace LiteNetLib {
  ...
  check_size<sizeof(ReliableChannel::PendingPacket), 16 + sizeof(bool) + ((16 + sizeof(bool)) % 8 != 0 ? (8 - (16 + sizeof(bool)) % 8) : 0)> __LiteNetLib_ReliableChannel_PendingPacketSizeCheck;
}
