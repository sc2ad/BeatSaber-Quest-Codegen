...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::*)()>(&LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::ToString)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>::get(),
                                  3
                                ));
    return ___internal_method;
  }
};
//  Writing Method size for method: LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket.Init
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::*)(LiteNetLib::NetPacket)>(&LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::Init)> {
...
//  Writing Method size for method: LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket.TrySend
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::*)(int64_t, LiteNetLib::NetPeer)>(&LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::TrySend)> {
...
//  Writing Method size for method: LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket.Clear
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::*)(LiteNetLib::NetPeer)>(&LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::Clear)> {
...
constexpr LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::LiteNetLib__ReliableChannel__PendingPacket(LiteNetLib::NetPacket _packet, int64_t _timeStamp, bool _isSent) noexcept : ::bs_hook::ValueTypeWrapper() {this->_packet = _packet;
this->_timeStamp = _timeStamp;
this->_isSent = _isSent;
}
constexpr void LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__set__packet(LiteNetLib::NetPacket value)  {
::cordl_internals::setInstanceField<LiteNetLib::NetPacket, 0x0>(this->__instance, std::forward<LiteNetLib::NetPacket>(value));
}
constexpr LiteNetLib::NetPacket LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__get__packet() const {
return ::cordl_internals::getInstanceField<LiteNetLib::NetPacket, 0x0>(this->__instance);
}
constexpr void LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__set__timeStamp(int64_t value)  {
::cordl_internals::setInstanceField<int64_t, 0x8>(this->__instance, std::forward<int64_t>(value));
}
constexpr int64_t LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__get__timeStamp() const {
return ::cordl_internals::getInstanceField<int64_t, 0x8>(this->__instance);
}
constexpr void LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__set__isSent(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->__instance, std::forward<bool>(value));
}
constexpr bool LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::__get__isSent() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->__instance);
}
 ::StringW LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::ToString()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>::get(),
                            "ToString",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::Init(LiteNetLib::NetPacket packet)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>::get(),
                            "Init",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, packet);
 ...
 void LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::TrySend(int64_t currentTime, LiteNetLib::NetPeer peer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>::get(),
                            "TrySend",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, currentTime, peer);
 ...
 bool LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket::Clear(LiteNetLib::NetPeer peer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>::get(),
                            "Clear",
                            std::vector<Il2CppClass*>{},
...
constexpr void LiteNetLib::ReliableChannel::__set__pendingPackets(::ArrayW<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket> value)  {
::cordl_internals::setInstanceField<::ArrayW<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>>(value));
}
constexpr ::ArrayW<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket> LiteNetLib::ReliableChannel::__get__pendingPackets() const {
return ::cordl_internals::getInstanceField<::ArrayW<LiteNetLib::LiteNetLib__ReliableChannel__PendingPacket>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
