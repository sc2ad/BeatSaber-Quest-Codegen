...
namespace LiteNetLib {
  ...
  class EventBasedNetListener::OnNetworkReceiveUnconnected : public System::MulticastDelegate {
    ...
    // Offset: 0x19EA9C0
    void Invoke_NEW(System::Net::IPEndPoint* remoteEndPoint, LiteNetLib::NetPacketReader* reader, LiteNetLib::UnconnectedMessageType messageType);
    ...
    // Offset: 0x19EBC58
    System::IAsyncResult* BeginInvoke_NEW(System::Net::IPEndPoint* remoteEndPoint, LiteNetLib::NetPacketReader* reader, LiteNetLib::UnconnectedMessageType messageType, System::AsyncCallback* callback, ::Il2CppObject* object);
