...
namespace LiteNetLib {
  ...
  class NatPunchModule : public ::Il2CppObject {
    ...
    check_size<sizeof(NatPunchModule::RequestEventData), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __LiteNetLib_NatPunchModule_RequestEventDataSizeCheck;
    ...
    check_size<sizeof(NatPunchModule::SuccessEventData), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __LiteNetLib_NatPunchModule_SuccessEventDataSizeCheck;
    ...
    void Send(T packet, System::Net::IPEndPoint* target) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib").WithContext("NatPunchModule").WithContext("Send");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "Send", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(packet, target))));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, packet, target);
    }
  ...
  check_size<sizeof(NatPunchModule), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __LiteNetLib_NatPunchModuleSizeCheck;
}
