...
namespace LiteNetLib {
  ...
  class NatPunchModule : public ::Il2CppObject {
    ...
    // Get instance field reference: private readonly System.Collections.Generic.Queue`1<LiteNetLib.NatPunchModule/RequestEventData> _requestEvents
    System::Collections::Generic::Queue_1<LiteNetLib::NatPunchModule::RequestEventData>*& dyn__requestEvents();
    // Get instance field reference: private readonly System.Collections.Generic.Queue`1<LiteNetLib.NatPunchModule/SuccessEventData> _successEvents
