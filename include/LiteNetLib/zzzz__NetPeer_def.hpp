...
namespace LiteNetLib {
class ____LiteNetLib__NetPeer__IncomingFragments;
}
...
class CORDL_TYPE ____LiteNetLib__NetPeer__IncomingFragments : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____LiteNetLib__NetPeer__IncomingFragments() = default;

// Ctor Parameters [CppParam { name: "", ty: "____LiteNetLib__NetPeer__IncomingFragments", modifiers: " const&", def_value: None }]
constexpr ____LiteNetLib__NetPeer__IncomingFragments(____LiteNetLib__NetPeer__IncomingFragments const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____LiteNetLib__NetPeer__IncomingFragments", modifiers: "&&", def_value: None }]
constexpr ____LiteNetLib__NetPeer__IncomingFragments(____LiteNetLib__NetPeer__IncomingFragments&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____LiteNetLib__NetPeer__IncomingFragments(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____LiteNetLib__NetPeer__IncomingFragments& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____LiteNetLib__NetPeer__IncomingFragments& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____LiteNetLib__NetPeer__IncomingFragments& operator=(____LiteNetLib__NetPeer__IncomingFragments&& o) noexcept = default;
  constexpr ____LiteNetLib__NetPeer__IncomingFragments& operator=(____LiteNetLib__NetPeer__IncomingFragments const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____LiteNetLib__NetPeer__IncomingFragments() ;
...
public:
// Declarations
using IncomingFragments = ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments;
...
constexpr uint16_t __get__fragmentId() const;
 ...
 ::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments> __declspec(property(get=__get__holdedFragments, put=__set__holdedFragments))  _holdedFragments;

constexpr void __set__holdedFragments(::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments> value) ;

constexpr ::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments> __get__holdedFragments() const;
...
NEED_NO_BOX(::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments);
DEFINE_IL2CPP_ARG_TYPE(::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments, "LiteNetLib", "NetPeer/IncomingFragments");
