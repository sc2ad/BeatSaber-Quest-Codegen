...
namespace LiteNetLib {
class ____LiteNetLib__NetManager__IPEndPointComparer;
}
namespace LiteNetLib {
struct ____LiteNetLib__NetManager__NetPeerEnumerator;
}
...
class CORDL_TYPE ____LiteNetLib__NetManager__IPEndPointComparer : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____LiteNetLib__NetManager__IPEndPointComparer() = default;

// Ctor Parameters [CppParam { name: "", ty: "____LiteNetLib__NetManager__IPEndPointComparer", modifiers: " const&", def_value: None }]
constexpr ____LiteNetLib__NetManager__IPEndPointComparer(____LiteNetLib__NetManager__IPEndPointComparer const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____LiteNetLib__NetManager__IPEndPointComparer", modifiers: "&&", def_value: None }]
constexpr ____LiteNetLib__NetManager__IPEndPointComparer(____LiteNetLib__NetManager__IPEndPointComparer&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____LiteNetLib__NetManager__IPEndPointComparer(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____LiteNetLib__NetManager__IPEndPointComparer& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____LiteNetLib__NetManager__IPEndPointComparer& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____LiteNetLib__NetManager__IPEndPointComparer& operator=(____LiteNetLib__NetManager__IPEndPointComparer&& o) noexcept = default;
  constexpr ____LiteNetLib__NetManager__IPEndPointComparer& operator=(____LiteNetLib__NetManager__IPEndPointComparer const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____LiteNetLib__NetManager__IPEndPointComparer() ;
...
struct CORDL_TYPE ____LiteNetLib__NetManager__NetPeerEnumerator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____LiteNetLib__NetManager__NetPeerEnumerator(::LiteNetLib::NetPeer _initialPeer, ::LiteNetLib::NetPeer _p) noexcept;


                    constexpr ____LiteNetLib__NetManager__NetPeerEnumerator(____LiteNetLib__NetManager__NetPeerEnumerator const&) = default;
                    constexpr ____LiteNetLib__NetManager__NetPeerEnumerator(____LiteNetLib__NetManager__NetPeerEnumerator&&) = default;
                    constexpr ____LiteNetLib__NetManager__NetPeerEnumerator& operator=(____LiteNetLib__NetManager__NetPeerEnumerator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____LiteNetLib__NetManager__NetPeerEnumerator& operator=(____LiteNetLib__NetManager__NetPeerEnumerator&& o) noexcept {
...
constexpr explicit ____LiteNetLib__NetManager__NetPeerEnumerator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using NetPeerEnumerator = ::LiteNetLib::____LiteNetLib__NetManager__NetPeerEnumerator;

using IPEndPointComparer = ::LiteNetLib::____LiteNetLib__NetManager__IPEndPointComparer;
...
/// @brief Method GetEnumerator addr 0x208f1d8 size 0x1c virtual false final false
 ::LiteNetLib::____LiteNetLib__NetManager__NetPeerEnumerator GetEnumerator() ;
...
NEED_NO_BOX(::LiteNetLib::____LiteNetLib__NetManager__IPEndPointComparer);
DEFINE_IL2CPP_ARG_TYPE(::LiteNetLib::____LiteNetLib__NetManager__IPEndPointComparer, "LiteNetLib", "NetManager/IPEndPointComparer");
DEFINE_IL2CPP_ARG_TYPE(::LiteNetLib::____LiteNetLib__NetManager__NetPeerEnumerator, "LiteNetLib", "NetManager/NetPeerEnumerator");
