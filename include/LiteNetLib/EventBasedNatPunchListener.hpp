...
namespace LiteNetLib {
  ...
  class EventBasedNatPunchListener : public ::Il2CppObject/*, public LiteNetLib::INatPunchListener*/ {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCF6B60
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCF6B70
    ...
    // Offset: 0x19E85AC
    void LiteNetLib_INatPunchListener_OnNatIntroductionRequest_NEW(System::Net::IPEndPoint* localEndPoint, System::Net::IPEndPoint* remoteEndPoint, ::Il2CppString* token);
    ...
    // Offset: 0x19E89CC
    void LiteNetLib_INatPunchListener_OnNatIntroductionSuccess_NEW(System::Net::IPEndPoint* targetEndPoint, LiteNetLib::NatAddressType type, ::Il2CppString* token);
