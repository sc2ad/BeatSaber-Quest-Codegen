...
namespace LiteNetLib {
  ...
  class EventBasedNatPunchListener::OnNatIntroductionSuccess : public System::MulticastDelegate {
    ...
    // Offset: 0x19E89DC
    void Invoke_NEW(System::Net::IPEndPoint* targetEndPoint, LiteNetLib::NatAddressType type, ::Il2CppString* token);
    ...
    // Offset: 0x19E8E74
    System::IAsyncResult* BeginInvoke_NEW(System::Net::IPEndPoint* targetEndPoint, LiteNetLib::NatAddressType type, ::Il2CppString* token, System::AsyncCallback* callback, ::Il2CppObject* object);
