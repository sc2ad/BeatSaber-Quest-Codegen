...
//  Writing Method size for method: ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::*)()>(&::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2090dc0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments>::get(),
                            ".ctor",
...
constexpr void ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__set_Fragments(::ArrayW<::LiteNetLib::NetPacket> value)  {
...
constexpr ::ArrayW<::LiteNetLib::NetPacket> ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__get_Fragments() const {
return ::cordl_internals::getInstanceField<::ArrayW<::LiteNetLib::NetPacket>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__set_ReceivedCount(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__get_ReceivedCount() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__set_TotalSize(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__get_TotalSize() const {
return ::cordl_internals::getInstanceField<int32_t, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__set_ChannelId(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::__get_ChannelId() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters []
 ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::____LiteNetLib__NetPeer__IncomingFragments()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____LiteNetLib__NetPeer__IncomingFragments>())) {}
 void ::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::LiteNetLib::NetPeer::__set__holdedFragments(::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments>, 0xb8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments>>(value));
}
constexpr ::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments> ::LiteNetLib::NetPeer::__get__holdedFragments() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::____LiteNetLib__NetPeer__IncomingFragments>, 0xb8>(this->::bs_hook::Il2CppWrapperType::instance);
}
