...
namespace LiteNetLib {
  ...
  check_size<sizeof(NatPunchModule::NatIntroduceResponsePacket), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __LiteNetLib_NatPunchModule_NatIntroduceResponsePacketSizeCheck;
}
