...
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType::____LiteNetLib__NetEvent__EType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::LiteNetLib::____LiteNetLib__NetEvent__EType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::LiteNetLib::____LiteNetLib__NetEvent__EType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::Connect{0};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::Disconnect{1};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::Receive{2};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::ReceiveUnconnected{3};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::Error{4};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::ConnectionLatencyUpdated{5};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::Broadcast{6};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::ConnectionRequest{7};
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType  ::LiteNetLib::____LiteNetLib__NetEvent__EType::MessageDelivered{8};
...
constexpr void ::LiteNetLib::NetEvent::__set_Type(::LiteNetLib::____LiteNetLib__NetEvent__EType value)  {
::cordl_internals::setInstanceField<::LiteNetLib::____LiteNetLib__NetEvent__EType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::LiteNetLib::____LiteNetLib__NetEvent__EType>(value));
}
constexpr ::LiteNetLib::____LiteNetLib__NetEvent__EType ::LiteNetLib::NetEvent::__get_Type() const {
return ::cordl_internals::getInstanceField<::LiteNetLib::____LiteNetLib__NetEvent__EType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
