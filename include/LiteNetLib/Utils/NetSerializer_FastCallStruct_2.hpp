...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::FastCallStruct_2 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<TClass, TProperty> {
    ...
    TProperty _get__p() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::FastCallStruct_2::_get__p");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<TProperty>(___internal__instance, "_p"));
    }
    // Autogenerated instance field setter
    // Set instance field: private TProperty _p
    void _set__p(TProperty value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::FastCallStruct_2::_set__p");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_p", value));
    }
