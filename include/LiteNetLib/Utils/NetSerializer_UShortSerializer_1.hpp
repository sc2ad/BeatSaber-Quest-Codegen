...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::UShortSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint16_t> {
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("UShortSerializer_1").WithContext("Read");
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("UShortSerializer_1").WithContext("Write");
    ...
    void ReadArray(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("UShortSerializer_1").WithContext("ReadArray");
    ...
    void WriteArray(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("UShortSerializer_1").WithContext("WriteArray");
    ...
    static NetSerializer::UShortSerializer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("UShortSerializer_1").WithContext(".ctor");
