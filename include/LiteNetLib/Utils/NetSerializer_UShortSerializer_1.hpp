...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UShortSerializer`1
  ...
  class NetSerializer::UShortSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint16_t> {
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, inf, r)));
    }
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, inf, w)));
    }
  ...
  }; // LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UShortSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.UShortSerializer`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
