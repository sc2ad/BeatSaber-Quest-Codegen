...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::UShortSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint16_t> {
    ...
    static NetSerializer::UShortSerializer_1<T>* New_ctor() {
      ...
      return THROW_UNLESS(::il2cpp_utils::New<NetSerializer::UShortSerializer_1<T>*>());
    }
  }; // LiteNetLib.Utils.NetSerializer/UShortSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/UShortSerializer`1 is generic!
}
