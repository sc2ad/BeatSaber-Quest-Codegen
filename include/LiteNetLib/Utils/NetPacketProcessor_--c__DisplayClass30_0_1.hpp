...
namespace LiteNetLib::Utils {
  ...
  class NetPacketProcessor::$$c__DisplayClass30_0_1 : public ::Il2CppObject {
    ...
    System::Func_1<T>* _get_packetConstructor() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass30_0_1::_get_packetConstructor");
    ...
    void _set_packetConstructor(System::Func_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass30_0_1::_set_packetConstructor");
      static auto ___internal__instance = this;
    ...
    System::Action_1<T>* _get_onReceive() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass30_0_1::_get_onReceive");
      static auto ___internal__instance = this;
    ...
    void _set_onReceive(System::Action_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass30_0_1::_set_onReceive");
      static auto ___internal__instance = this;
