...
namespace LiteNetLib::Utils {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D9B348
  template<typename T>
  class NetPacketProcessor::$$c__DisplayClass30_0_1 : public ::Il2CppObject {
    ...
    void $SubscribeNetSerializable$b__0(LiteNetLib::Utils::NetDataReader* reader, ::Il2CppObject* userData) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("$$c__DisplayClass30_0_1").WithContext("<SubscribeNetSerializable>b__0");
    ...
    static NetPacketProcessor::$$c__DisplayClass30_0_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("$$c__DisplayClass30_0_1").WithContext(".ctor");
  ...
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/<>c__DisplayClass30_0`1 is generic, or has no fields that are valid for size checks!
}
