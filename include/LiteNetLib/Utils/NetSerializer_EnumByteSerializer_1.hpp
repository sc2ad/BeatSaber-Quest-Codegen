...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::EnumByteSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCall_1<T> {
    ...
    System::Reflection::PropertyInfo* _get_Property() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::EnumByteSerializer_1::_get_Property");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<System::Reflection::PropertyInfo*>(___internal__instance, "Property"));
    }
    // Autogenerated instance field setter
    // Set instance field: protected readonly System.Reflection.PropertyInfo Property
    void _set_Property(System::Reflection::PropertyInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::EnumByteSerializer_1::_set_Property");
      static auto ___internal__instance = this;
    ...
    System::Type* _get_PropertyType() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::EnumByteSerializer_1::_get_PropertyType");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<System::Type*>(___internal__instance, "PropertyType"));
    }
    // Autogenerated instance field setter
    // Set instance field: protected readonly System.Type PropertyType
    void _set_PropertyType(System::Type* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::EnumByteSerializer_1::_set_PropertyType");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "PropertyType", value));
    }
