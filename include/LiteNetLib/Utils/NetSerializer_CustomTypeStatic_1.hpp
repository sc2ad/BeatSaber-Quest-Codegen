...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::CustomTypeStatic_1 : public LiteNetLib::Utils::NetSerializer::CustomType {
    ...
    System::Action_2<LiteNetLib::Utils::NetDataWriter*, TProperty>* _get__writer() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::CustomTypeStatic_1::_get__writer");
    ...
    void _set__writer(System::Action_2<LiteNetLib::Utils::NetDataWriter*, TProperty>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::CustomTypeStatic_1::_set__writer");
      static auto ___internal__instance = this;
    ...
    System::Func_2<LiteNetLib::Utils::NetDataReader*, TProperty>* _get__reader() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::CustomTypeStatic_1::_get__reader");
      static auto ___internal__instance = this;
    ...
    void _set__reader(System::Func_2<LiteNetLib::Utils::NetDataReader*, TProperty>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::CustomTypeStatic_1::_set__reader");
      static auto ___internal__instance = this;
