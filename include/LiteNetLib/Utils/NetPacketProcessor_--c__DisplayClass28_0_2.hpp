...
namespace LiteNetLib::Utils {
  ...
  class NetPacketProcessor::$$c__DisplayClass28_0_2 : public ::Il2CppObject {
    ...
    LiteNetLib::Utils::NetPacketProcessor* _get_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_get_$$4__this");
    ...
    void _set_$$4__this(LiteNetLib::Utils::NetPacketProcessor* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_set_$$4__this");
      static auto ___internal__instance = this;
    ...
    T _get_reference() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_get_reference");
      static auto ___internal__instance = this;
    ...
    void _set_reference(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_set_reference");
      static auto ___internal__instance = this;
    ...
    System::Action_2<T, TUserData>* _get_onReceive() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_get_onReceive");
      static auto ___internal__instance = this;
    ...
    void _set_onReceive(System::Action_2<T, TUserData>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetPacketProcessor::$$c__DisplayClass28_0_2::_set_onReceive");
      static auto ___internal__instance = this;
