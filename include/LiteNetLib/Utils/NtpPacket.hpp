...
namespace LiteNetLib::Utils {
  ...
  check_size<sizeof(NtpPacket), 24 + sizeof(System::Nullable_1<System::DateTime>) + ((24 + sizeof(System::Nullable_1<System::DateTime>)) % 8 != 0 ? (8 - (24 + sizeof(System::Nullable_1<System::DateTime>)) % 8) : 0)> __LiteNetLib_Utils_NtpPacketSizeCheck;
}
