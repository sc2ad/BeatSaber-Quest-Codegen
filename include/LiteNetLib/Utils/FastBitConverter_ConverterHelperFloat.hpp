...
namespace LiteNetLib::Utils {
  ...
  check_size<sizeof(FastBitConverter::ConverterHelperFloat), 0 + sizeof(float) + ((0 + sizeof(float)) % 8 != 0 ? (8 - (0 + sizeof(float)) % 8) : 0)> __LiteNetLib_Utils_FastBitConverter_ConverterHelperFloatSizeCheck;
}
