...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/UIntSerializer`1
  // [] Offset: FFFFFFFF
  template<typename T>
  ...
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/UIntSerializer`1 is generic, or has no fields that are valid for size checks!
}
