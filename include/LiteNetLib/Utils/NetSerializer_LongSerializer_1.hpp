...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::LongSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, int64_t> {
    ...
    static NetSerializer::LongSerializer_1<T>* New_ctor() {
      ...
      return THROW_UNLESS(::il2cpp_utils::New<NetSerializer::LongSerializer_1<T>*>());
    }
  }; // LiteNetLib.Utils.NetSerializer/LongSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/LongSerializer`1 is generic!
}
