...
constexpr ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble(uint64_t Along, double_t Adouble) noexcept : ::bs_hook::ValueTypeWrapper() {this->Along = Along;
this->Adouble = Adouble;
}
constexpr void ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble::__set_Along(uint64_t value)  {
::cordl_internals::setInstanceField<uint64_t, 0x0>(this->__instance, std::forward<uint64_t>(value));
}
constexpr uint64_t ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble::__get_Along() const {
return ::cordl_internals::getInstanceField<uint64_t, 0x0>(this->__instance);
}
constexpr void ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble::__set_Adouble(double_t value)  {
::cordl_internals::setInstanceField<double_t, 0x0>(this->__instance, std::forward<double_t>(value));
}
constexpr double_t ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperDouble::__get_Adouble() const {
...
constexpr ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat(int32_t Aint, float_t Afloat) noexcept : ::bs_hook::ValueTypeWrapper() {this->Aint = Aint;
this->Afloat = Afloat;
}
constexpr void ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat::__set_Aint(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat::__get_Aint() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat::__set_Afloat(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::LiteNetLib::Utils::____LiteNetLib__Utils__FastBitConverter__ConverterHelperFloat::__get_Afloat() const {
