...
namespace LiteNetLib::Utils {
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/ULongSerializer`1
  template<typename T>
  class NetSerializer::ULongSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, uint64_t> {
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("ULongSerializer_1").WithContext("Read");
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("ULongSerializer_1").WithContext("Write");
    ...
    void ReadArray(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("ULongSerializer_1").WithContext("ReadArray");
    ...
    void WriteArray(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("ULongSerializer_1").WithContext("WriteArray");
    ...
    static NetSerializer::ULongSerializer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("ULongSerializer_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<NetSerializer::ULongSerializer_1<T>*>());
    }
  }; // LiteNetLib.Utils.NetSerializer/ULongSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/ULongSerializer`1 is generic!
}
