...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::ClassInfo_1 : public ::Il2CppObject {
    ...
    ::Array<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>* _get__serializers() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ClassInfo_1::_get__serializers");
    ...
    // Set instance field: private readonly LiteNetLib.Utils.NetSerializer/LiteNetLib.Utils.FastCall`1<T>[] _serializers
    void _set__serializers(::Array<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ClassInfo_1::_set__serializers");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_serializers"))->offset;
      *reinterpret_cast<::Array<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
    // Get instance field: private readonly System.Int32 _membersCount
    int _get__membersCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ClassInfo_1::_get__membersCount");
      auto ___internal__instance = this;
    ...
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Int32 _membersCount
    void _set__membersCount(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("LiteNetLib::Utils::NetSerializer::ClassInfo_1::_set__membersCount");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_membersCount"))->offset;
