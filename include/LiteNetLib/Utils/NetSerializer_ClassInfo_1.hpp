...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::ClassInfo_1 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*> serializers;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>) == 0x8);
    ...
    ClassInfo_1(::ArrayWrapper<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*> serializers_ = {}, int membersCount_ = {}) noexcept : serializers{serializers_}, membersCount{membersCount_} {}
    ...
    ::ArrayWrapper<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>& dyn__serializers() {
      ...
      return *reinterpret_cast<::ArrayWrapper<LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
