...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::ClassInfo_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<::LiteNetLib::Utils::NetSerializer::FastCall_1<T>*>& dyn__serializers() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn__membersCount() {
    ...
    void Read(T obj, ::LiteNetLib::Utils::NetDataReader* reader) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, obj, reader);
    }
