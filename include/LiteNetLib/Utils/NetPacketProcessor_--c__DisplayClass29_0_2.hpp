...
namespace LiteNetLib::Utils {
  ...
  // Autogenerated type: LiteNetLib.Utils.NetPacketProcessor/<>c__DisplayClass29_0`2
  // [CompilerGeneratedAttribute] Offset: DCD564
  ...
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/<>c__DisplayClass29_0`2 is generic, or has no fields that are valid for size checks!
}
