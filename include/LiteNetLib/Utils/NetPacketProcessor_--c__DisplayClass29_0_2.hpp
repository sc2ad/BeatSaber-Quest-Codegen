...
namespace LiteNetLib::Utils {
  ...
  class NetPacketProcessor::$$c__DisplayClass29_0_2 : public ::Il2CppObject {
    ...
    static NetPacketProcessor::$$c__DisplayClass29_0_2<T, TUserData>* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<NetPacketProcessor::$$c__DisplayClass29_0_2<T, TUserData>*>()));
    }
  }; // LiteNetLib.Utils.NetPacketProcessor/<>c__DisplayClass29_0`2
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/<>c__DisplayClass29_0`2 is generic!
}
