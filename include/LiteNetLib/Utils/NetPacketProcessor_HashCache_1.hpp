...
namespace LiteNetLib::Utils {
  ...
  class NetPacketProcessor::HashCache_1 : public ::Il2CppObject {
    ...
    static bool _get_Initialized() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("HashCache_1").WithContext("_get_Initialized");
    ...
    static void _set_Initialized(bool value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("HashCache_1").WithContext("_set_Initialized");
    ...
    static uint64_t _get_Id() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("HashCache_1").WithContext("_get_Id");
    ...
    static void _set_Id(uint64_t value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("HashCache_1").WithContext("_set_Id");
  ...
  // Could not write size check! Type: LiteNetLib.Utils.NetPacketProcessor/HashCache`1 is generic, or has no fields that are valid for size checks!
}
