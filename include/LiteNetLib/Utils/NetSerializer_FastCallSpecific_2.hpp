...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::FastCallSpecific_2 : public LiteNetLib::Utils::NetSerializer::FastCall_1<TClass> {
    ...
    System::Func_2<TClass, ::ArrayW<TProperty>>*& dyn_GetterArr() {
    ...
    System::Action_2<TClass, ::ArrayW<TProperty>>*& dyn_SetterArr() {
    ...
    ::ArrayW<TProperty> ReadArrayHelper(TClass inf, LiteNetLib::Utils::NetDataReader* r) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<::ArrayW<TProperty>, false>(this, ___internal__method, inf, r)));
    }
    ...
    ::ArrayW<TProperty> WriteArrayHelper(TClass inf, LiteNetLib::Utils::NetDataWriter* w) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<::ArrayW<TProperty>, false>(this, ___internal__method, inf, w)));
    }
