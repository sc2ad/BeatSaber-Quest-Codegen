...
namespace LiteNetLib::Utils {
  ...
  class NetSerializer::FastCallSpecific_2 : public LiteNetLib::Utils::NetSerializer::FastCall_1<TClass> {
    ...
    // Size: 0x8
    // Offset: 0x0
    System::Func_2<TClass, ::ArrayWrapper<TProperty>>* GetterArr;
    // Field size check
    static_assert(sizeof(System::Func_2<TClass, ::ArrayWrapper<TProperty>>*) == 0x8);
    // protected System.Action`2<TClass,TProperty[]> SetterArr
    // Size: 0x8
    // Offset: 0x0
    System::Action_2<TClass, ::ArrayWrapper<TProperty>>* SetterArr;
    // Field size check
    static_assert(sizeof(System::Action_2<TClass, ::ArrayWrapper<TProperty>>*) == 0x8);
    // Creating value type constructor for type: FastCallSpecific_2
    FastCallSpecific_2(System::Func_2<TClass, TProperty>* Getter_ = {}, System::Action_2<TClass, TProperty>* Setter_ = {}, System::Func_2<TClass, ::ArrayWrapper<TProperty>>* GetterArr_ = {}, System::Action_2<TClass, ::ArrayWrapper<TProperty>>* SetterArr_ = {}) noexcept : Getter{Getter_}, Setter{Setter_}, GetterArr{GetterArr_}, SetterArr{SetterArr_} {}
    ...
    System::Func_2<TClass, ::ArrayWrapper<TProperty>>*& dyn_GetterArr() {
      ...
      return *reinterpret_cast<System::Func_2<TClass, ::ArrayWrapper<TProperty>>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
    // Get instance field: protected System.Action`2<TClass,TProperty[]> SetterArr
    System::Action_2<TClass, ::ArrayWrapper<TProperty>>*& dyn_SetterArr() {
      ...
      return *reinterpret_cast<System::Action_2<TClass, ::ArrayWrapper<TProperty>>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // protected TProperty[] ReadArrayHelper(TClass inf, LiteNetLib.Utils.NetDataReader r)
    // Offset: 0xFFFFFFFF
    ::ArrayWrapper<TProperty> ReadArrayHelper(TClass inf, LiteNetLib::Utils::NetDataReader* r) {
      ...
      return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<TProperty>, false>(___instance_arg, ___internal__method, inf, r);
    }
    // protected TProperty[] WriteArrayHelper(TClass inf, LiteNetLib.Utils.NetDataWriter w)
    // Offset: 0xFFFFFFFF
    ::ArrayWrapper<TProperty> WriteArrayHelper(TClass inf, LiteNetLib::Utils::NetDataWriter* w) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<TProperty>, false>(___instance_arg, ___internal__method, inf, w);
    }
