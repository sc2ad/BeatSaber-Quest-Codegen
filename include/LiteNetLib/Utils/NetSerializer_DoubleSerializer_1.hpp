...
namespace LiteNetLib::Utils {
  // Autogenerated type: LiteNetLib.Utils.NetSerializer/DoubleSerializer`1
  template<typename T>
  class NetSerializer::DoubleSerializer_1 : public LiteNetLib::Utils::NetSerializer::FastCallSpecific_2<T, double> {
    ...
    void Read(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("DoubleSerializer_1").WithContext("Read");
    ...
    void Write(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("DoubleSerializer_1").WithContext("Write");
    ...
    void ReadArray(T inf, LiteNetLib::Utils::NetDataReader* r) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("DoubleSerializer_1").WithContext("ReadArray");
    ...
    void WriteArray(T inf, LiteNetLib::Utils::NetDataWriter* w) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("DoubleSerializer_1").WithContext("WriteArray");
    ...
    static NetSerializer::DoubleSerializer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("LiteNetLib::Utils").WithContext("DoubleSerializer_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<NetSerializer::DoubleSerializer_1<T>*>());
    }
  }; // LiteNetLib.Utils.NetSerializer/DoubleSerializer`1
  // Could not write size check! Type: LiteNetLib.Utils.NetSerializer/DoubleSerializer`1 is generic!
}
