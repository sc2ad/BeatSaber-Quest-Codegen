...
namespace LiteNetLib::Utils {
  ...
  class NetPacketProcessor::SubscribeDelegate : public System::MulticastDelegate {
    ...
    // Offset: 0x2176950
    void Invoke_NEW(LiteNetLib::Utils::NetDataReader* reader, ::Il2CppObject* userData);
    ...
    // Offset: 0x2176D48
    System::IAsyncResult* BeginInvoke_NEW(LiteNetLib::Utils::NetDataReader* reader, ::Il2CppObject* userData, System::AsyncCallback* callback, ::Il2CppObject* object);
