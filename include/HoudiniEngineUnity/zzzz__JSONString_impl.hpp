...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<HoudiniEngineUnity::JSONNodeType (HoudiniEngineUnity::JSONString::*)()>(&HoudiniEngineUnity::JSONString::get_Tag)> {
  ...
  constexpr static std::size_t addrs = 0x2068fd0;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(HoudiniEngineUnity::JSONString),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::JSONString::*)()>(&HoudiniEngineUnity::JSONString::get_IsString)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2068fd8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator (HoudiniEngineUnity::JSONString::*)()>(&HoudiniEngineUnity::JSONString::GetEnumerator)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x2068fe0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (HoudiniEngineUnity::JSONString::*)()>(&HoudiniEngineUnity::JSONString::get_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2068ff4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::JSONString::*)(::StringW)>(&HoudiniEngineUnity::JSONString::set_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2068ffc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::JSONString::*)(::StringW)>(&HoudiniEngineUnity::JSONString::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x20630d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::JSONString::*)(System::Text::StringBuilder, int32_t, int32_t, HoudiniEngineUnity::JSONTextMode)>(&HoudiniEngineUnity::JSONString::WriteToStringBuilder)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x2069004;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::JSONString::*)(::bs_hook::Il2CppWrapperType)>(&HoudiniEngineUnity::JSONString::Equals)> {
  constexpr static std::size_t size = 0xec;
  constexpr static std::size_t addrs = 0x2069060;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (HoudiniEngineUnity::JSONString::*)()>(&HoudiniEngineUnity::JSONString::GetHashCode)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x206914c;
...
constexpr void HoudiniEngineUnity::JSONString::__set_m_Data(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW HoudiniEngineUnity::JSONString::__get_m_Data() const {
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator HoudiniEngineUnity::JSONString::GetEnumerator()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::JSONString>::get(),
                            "GetEnumerator",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, aData);
 ...
 void HoudiniEngineUnity::JSONString::WriteToStringBuilder(System::Text::StringBuilder aSB, int32_t aIndent, int32_t aIndentInc, HoudiniEngineUnity::JSONTextMode aMode)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::JSONString>::get(),
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, aSB, aIndent, aIndentInc, aMode);
 ...
 bool HoudiniEngineUnity::JSONString::Equals(::bs_hook::Il2CppWrapperType obj)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::JSONString>::get(),
                            "Equals",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, obj);
 ...
 int32_t HoudiniEngineUnity::JSONString::GetHashCode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::JSONString>::get(),
                            "GetHashCode",
                            std::vector<Il2CppClass*>{},
