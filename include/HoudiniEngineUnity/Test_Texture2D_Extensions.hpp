...
namespace HoudiniEngineUnity {
  ...
  class Test_Texture2D_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Texture2D[] ToTestObject(UnityEngine.Texture2D[] self)
    // Offset: 0x267CB00
    static ::Array<HoudiniEngineUnity::Test_Texture2D*>* ToTestObject(::Array<UnityEngine::Texture2D*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Texture2D*>* (*)(::Array<UnityEngine::Texture2D*>*)>(&HoudiniEngineUnity::Test_Texture2D_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
