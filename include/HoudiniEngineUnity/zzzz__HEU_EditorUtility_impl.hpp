...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::Default{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::ConnectToPrefab{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions::ReplaceNameBased{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::GameObject (*)(::UnityEngine::GameObject, ::UnityEngine::Object, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions)>(&::HoudiniEngineUnity::HEU_EditorUtility::ReplacePrefab)> {
  constexpr static std::size_t size = 0x4c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "ReplacePrefab",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::GameObject>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Object>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method);
 ...
 ::UnityEngine::GameObject ::HoudiniEngineUnity::HEU_EditorUtility::ReplacePrefab(::UnityEngine::GameObject go, ::UnityEngine::Object targetPrefab, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_EditorUtility__HEU_ReplacePrefabOptions heuOptions)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_EditorUtility>::get(),
                            "ReplacePrefab",
                            std::vector<Il2CppClass*>{},
