...
namespace HoudiniEngineUnity {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_PDGSession/EventMessageColor
  ...
  struct HEU_PDGSession::EventMessageColor/*, public System::Enum*/ {
    ...
    // static field const value: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor DEFAULT
    static constexpr const int DEFAULT = 0;
    // Get static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor DEFAULT
    static HoudiniEngineUnity::HEU_PDGSession::EventMessageColor _get_DEFAULT();
    // Set static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor DEFAULT
    static void _set_DEFAULT(HoudiniEngineUnity::HEU_PDGSession::EventMessageColor value);
    // static field const value: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor WARNING
    static constexpr const int WARNING = 1;
    // Get static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor WARNING
    static HoudiniEngineUnity::HEU_PDGSession::EventMessageColor _get_WARNING();
    // Set static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor WARNING
    static void _set_WARNING(HoudiniEngineUnity::HEU_PDGSession::EventMessageColor value);
    // static field const value: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor ERROR
    static constexpr const int ERROR = 2;
    // Get static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor ERROR
    static HoudiniEngineUnity::HEU_PDGSession::EventMessageColor _get_ERROR();
    // Set static field: static public HoudiniEngineUnity.HEU_PDGSession/EventMessageColor ERROR
    static void _set_ERROR(HoudiniEngineUnity::HEU_PDGSession::EventMessageColor value);
    // Get instance field reference: public System.Int32 value__
    int& dyn_value__();
  }; // HoudiniEngineUnity.HEU_PDGSession/EventMessageColor
  #pragma pack(pop)
