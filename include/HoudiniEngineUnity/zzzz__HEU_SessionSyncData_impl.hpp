...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::____HoudiniEngineUnity__HEU_SessionSyncData__Status(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::Stopped{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::Started{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::Connecting{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::Initializing{3};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status::Connected{4};
//  Writing Method size for method: ::HoudiniEngineUnity::HEU_SessionSyncData.get_SyncStatus
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status (::HoudiniEngineUnity::HEU_SessionSyncData::*)()>(&::HoudiniEngineUnity::HEU_SessionSyncData::get_SyncStatus)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::HEU_SessionSyncData::*)(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status)>(&::HoudiniEngineUnity::HEU_SessionSyncData::set_SyncStatus)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_SyncStatus",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_SessionSyncInfo, 0x61>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status ::HoudiniEngineUnity::HEU_SessionSyncData::get_SyncStatus()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_SessionSyncData>::get(),
                            "get_SyncStatus",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::HoudiniEngineUnity::HEU_SessionSyncData::set_SyncStatus(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionSyncData__Status value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_SessionSyncData>::get(),
                            "set_SyncStatus",
                            std::vector<Il2CppClass*>{},
