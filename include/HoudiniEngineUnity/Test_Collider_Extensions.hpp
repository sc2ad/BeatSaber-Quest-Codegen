...
namespace HoudiniEngineUnity {
  ...
  class Test_Collider_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Collider[] ToTestObject(UnityEngine.Collider[] self)
    // Offset: 0x178F39C
    static ::Array<HoudiniEngineUnity::Test_Collider*>* ToTestObject(::Array<UnityEngine::Collider*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Collider*>* (*)(::Array<UnityEngine::Collider*>*)>(&HoudiniEngineUnity::Test_Collider_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
