...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeometryUtility : public ::Il2CppObject {
    ...
    // Offset: 0x1649AE0
    static ::Array<UnityEngine::Vector2>* GeneratePerTriangle(UnityEngine::Mesh* meshSrc);
    ...
    // Offset: 0x164A1A0
    static UnityEngine::Mesh* GenerateCubeMeshFromPoints(::Array<UnityEngine::Vector3>* points, ::Array<UnityEngine::Color>* pointsColor, float size);
    // static public System.String GetInstanceOutputName(System.String partName, System.String[] userPrefix, System.Int32 index)
    // Offset: 0x164AC68
    static ::Il2CppString* GetInstanceOutputName(::Il2CppString* partName, ::Array<::Il2CppString*>* userPrefix, int index);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<UnityEngine::Vector2>* (*)(UnityEngine::Mesh*)>(&HoudiniEngineUnity::HEU_GeometryUtility::GeneratePerTriangle)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Mesh* (*)(::Array<UnityEngine::Vector3>*, ::Array<UnityEngine::Color>*, float)>(&HoudiniEngineUnity::HEU_GeometryUtility::GenerateCubeMeshFromPoints)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppString* (*)(::Il2CppString*, ::Array<::Il2CppString*>*, int)>(&HoudiniEngineUnity::HEU_GeometryUtility::GetInstanceOutputName)> {
  static const MethodInfo* get() {
