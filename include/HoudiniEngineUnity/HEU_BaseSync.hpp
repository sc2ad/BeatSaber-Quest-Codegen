...
namespace HoudiniEngineUnity {
  ...
  // [ExecuteInEditMode] Offset: EFA808
  class HEU_BaseSync : public UnityEngine::MonoBehaviour {
    ...
    System::Text::StringBuilder*& dyn__log();
    // Get instance field reference: public System.Text.StringBuilder _error
    System::Text::StringBuilder*& dyn__error();
    ...
    HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo*& dyn__loadTask();
    ...
    // Offset: 0x14433F4
    void Reset();
    // public System.Void OnLoadComplete(HoudiniEngineUnity.HEU_ThreadedTaskLoadGeo/HEU_LoadData loadData)
    // Offset: 0x143CAEC
    void OnLoadComplete(HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo::HEU_LoadData* loadData);
    // public System.Void GenerateObjects(HoudiniEngineUnity.HEU_ThreadedTaskLoadGeo/HEU_LoadData loadData)
    // Offset: 0x14434B8
    void GenerateObjects(HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo::HEU_LoadData* loadData);
    // public System.Void GenerateGeometry(HoudiniEngineUnity.HEU_ThreadedTaskLoadGeo/HEU_LoadData loadData, System.Int32 objIndex)
    // Offset: 0x144354C
    ...
    // private System.Void GenerateAllInstancers(System.Int32 cookNodeId, System.Collections.Generic.List`1<HoudiniEngineUnity.HEU_LoadBufferInstancer> instancerBuffers, HoudiniEngineUnity.HEU_ThreadedTaskLoadGeo/HEU_LoadData loadData)
    // Offset: 0x144528C
    ...
    // Offset: 0x14467A8
    void CreateNewInstanceFromObject(UnityEngine::GameObject* assetSourceGO, int instanceIndex, UnityEngine::Transform* parentTransform, ByRef<HoudiniEngineUnity::HAPI_Transform> hapiTransform, ::Array<::Il2CppString*>* instancePrefixes, ::Il2CppString* instanceName, UnityEngine::GameObject* collisionSourceGO);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_BaseSync::*)(UnityEngine::GameObject*, int, UnityEngine::Transform*, ByRef<HoudiniEngineUnity::HAPI_Transform>, ::Array<::Il2CppString*>*, ::Il2CppString*, UnityEngine::GameObject*)>(&HoudiniEngineUnity::HEU_BaseSync::CreateNewInstanceFromObject)> {
  static const MethodInfo* get() {
