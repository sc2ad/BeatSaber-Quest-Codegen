...
namespace HoudiniEngineUnity {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_PluginStorage/DataType
  ...
  struct HEU_PluginStorage::DataType/*, public System::Enum*/ {
    ...
    // static field const value: static public HoudiniEngineUnity.HEU_PluginStorage/DataType BOOL
    static constexpr const int BOOL = 0;
    // Get static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType BOOL
    static HoudiniEngineUnity::HEU_PluginStorage::DataType _get_BOOL();
    // Set static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType BOOL
    static void _set_BOOL(HoudiniEngineUnity::HEU_PluginStorage::DataType value);
    // static field const value: static public HoudiniEngineUnity.HEU_PluginStorage/DataType INT
    static constexpr const int INT = 1;
    // Get static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType INT
    static HoudiniEngineUnity::HEU_PluginStorage::DataType _get_INT();
    // Set static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType INT
    static void _set_INT(HoudiniEngineUnity::HEU_PluginStorage::DataType value);
    // static field const value: static public HoudiniEngineUnity.HEU_PluginStorage/DataType LONG
    static constexpr const int LONG = 2;
    // Get static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType LONG
    static HoudiniEngineUnity::HEU_PluginStorage::DataType _get_LONG();
    // Set static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType LONG
    static void _set_LONG(HoudiniEngineUnity::HEU_PluginStorage::DataType value);
    // static field const value: static public HoudiniEngineUnity.HEU_PluginStorage/DataType FLOAT
    static constexpr const int FLOAT = 3;
    // Get static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType FLOAT
    static HoudiniEngineUnity::HEU_PluginStorage::DataType _get_FLOAT();
    // Set static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType FLOAT
    static void _set_FLOAT(HoudiniEngineUnity::HEU_PluginStorage::DataType value);
    // static field const value: static public HoudiniEngineUnity.HEU_PluginStorage/DataType STRING
    static constexpr const int STRING = 4;
    // Get static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType STRING
    static HoudiniEngineUnity::HEU_PluginStorage::DataType _get_STRING();
    // Set static field: static public HoudiniEngineUnity.HEU_PluginStorage/DataType STRING
