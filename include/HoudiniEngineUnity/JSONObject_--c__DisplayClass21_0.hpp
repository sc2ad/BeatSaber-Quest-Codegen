...
namespace HoudiniEngineUnity {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.JSONObject/<>c__DisplayClass21_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: EFABC0
  ...
  }; // HoudiniEngineUnity.JSONObject/<>c__DisplayClass21_0
  #pragma pack(pop)
