...
namespace HoudiniEngineUnity {
struct ____HoudiniEngineUnity__HEU_AssetTask__BuildType;
}
namespace HoudiniEngineUnity {
class HEU_AssetTask;
}
...
struct CORDL_TYPE ____HoudiniEngineUnity__HEU_AssetTask__BuildType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_AssetTask__BuildType(int32_t value__) noexcept;


                    constexpr ____HoudiniEngineUnity__HEU_AssetTask__BuildType(____HoudiniEngineUnity__HEU_AssetTask__BuildType const&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_AssetTask__BuildType(____HoudiniEngineUnity__HEU_AssetTask__BuildType&&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_AssetTask__BuildType& operator=(____HoudiniEngineUnity__HEU_AssetTask__BuildType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HoudiniEngineUnity__HEU_AssetTask__BuildType& operator=(____HoudiniEngineUnity__HEU_AssetTask__BuildType&& o) noexcept {
...
constexpr explicit ____HoudiniEngineUnity__HEU_AssetTask__BuildType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HoudiniEngineUnity__HEU_AssetTask__BuildType_Unwrapped : int32_t {
__NONE = 0,
__LOAD = 1,
__COOK = 2,
__RELOAD = 3,
...
constexpr operator ______HoudiniEngineUnity__HEU_AssetTask__BuildType_Unwrapped () const noexcept {
return std::bit_cast<______HoudiniEngineUnity__HEU_AssetTask__BuildType_Unwrapped>(__instance);
}
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType const NONE;

/// @brief Field LOAD offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType const LOAD;

/// @brief Field COOK offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType const COOK;

/// @brief Field RELOAD offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType const RELOAD;
...
public:
// Declarations
using BuildType = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType;
...
// Fields
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType __declspec(property(get=__get__buildType, put=__set__buildType))  _buildType;

constexpr void __set__buildType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType value) ;

constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType __get__buildType() const;
...
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetTask__BuildType, "HoudiniEngineUnity", "HEU_AssetTask/BuildType");
