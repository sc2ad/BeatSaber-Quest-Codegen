...
struct CORDL_TYPE HoudiniEngineUnity__HEU_Handle__HEU_HandleType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr HoudiniEngineUnity__HEU_Handle__HEU_HandleType(int32_t value__) noexcept;


                    constexpr HoudiniEngineUnity__HEU_Handle__HEU_HandleType(HoudiniEngineUnity__HEU_Handle__HEU_HandleType const&) = default;
                    constexpr HoudiniEngineUnity__HEU_Handle__HEU_HandleType(HoudiniEngineUnity__HEU_Handle__HEU_HandleType&&) = default;
                    constexpr HoudiniEngineUnity__HEU_Handle__HEU_HandleType& operator=(HoudiniEngineUnity__HEU_Handle__HEU_HandleType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr HoudiniEngineUnity__HEU_Handle__HEU_HandleType& operator=(HoudiniEngineUnity__HEU_Handle__HEU_HandleType&& o) noexcept {
...
constexpr explicit HoudiniEngineUnity__HEU_Handle__HEU_HandleType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __HoudiniEngineUnity__HEU_Handle__HEU_HandleType_Unwrapped : int32_t {
__XFORM = 0,
__UNSUPPORTED = 1,
};
...
static HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType const XFORM;

/// @brief Field UNSUPPORTED offset 0
static HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType const UNSUPPORTED;
...
public:
// Declarations
using HEU_HandleType = HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType;
...
constexpr ::StringW __get__handleName() const;
 ...
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType __declspec(property(get=__get__handleType, put=__set__handleType))  _handleType;

constexpr void __set__handleType(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType value) ;

constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType __get__handleType() const;
...
// Properties
 ...
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType __declspec(property(get=get_HandleType))  HandleType;
...
/// @brief Method get_HandleType addr 0x201d604 size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType get_HandleType() ;
...
/// @brief Method SetupHandle addr 0x201d6fc size 0x7cc virtual false final false
 bool SetupHandle(HoudiniEngineUnity::HEU_SessionBase session, int32_t assetID, int32_t handleIndex, ::StringW handleName, HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType handleType, ByRef<HoudiniEngineUnity::HAPI_HandleInfo> handleInfo, HoudiniEngineUnity::HEU_Parameters parameters) ;
...
DEFINE_IL2CPP_ARG_TYPE(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType, "HoudiniEngineUnity", "HEU_Handle/HEU_HandleType");
