...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::REPLACE{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::ADD{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::SUBTRACT{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode::MULTIPLY{3};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::AUTO{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::SHOW{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility::HIDE{2};
...
constexpr void ::HoudiniEngineUnity::HEU_ToolsInfo::__set__paintMergeMode(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode ::HoudiniEngineUnity::HEU_ToolsInfo::__get__paintMergeMode() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::HoudiniEngineUnity::HEU_ToolsInfo::__set__paintMeshVisiblity(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility, 0xa4>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility ::HoudiniEngineUnity::HEU_ToolsInfo::__get__paintMeshVisiblity() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility, 0xa4>(this->::bs_hook::Il2CppWrapperType::instance);
}
