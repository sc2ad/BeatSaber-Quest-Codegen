...
struct CORDL_TYPE ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState(int32_t value__) noexcept;


                    constexpr ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState(____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState(____HoudiniEngineUnity__HEU_TOPNodeData__PDGState&&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState& operator=(____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState& operator=(____HoudiniEngineUnity__HEU_TOPNodeData__PDGState&& o) noexcept {
...
constexpr explicit ____HoudiniEngineUnity__HEU_TOPNodeData__PDGState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HoudiniEngineUnity__HEU_TOPNodeData__PDGState_Unwrapped : int32_t {
__NONE = 0,
__DIRTIED = 1,
__DIRTYING = 2,
__COOKING = 3,
...
constexpr operator ______HoudiniEngineUnity__HEU_TOPNodeData__PDGState_Unwrapped () const noexcept {
return std::bit_cast<______HoudiniEngineUnity__HEU_TOPNodeData__PDGState_Unwrapped>(__instance);
}
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const NONE;

/// @brief Field DIRTIED offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const DIRTIED;

/// @brief Field DIRTYING offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const DIRTYING;

/// @brief Field COOKING offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const COOKING;

/// @brief Field COOK_COMPLETE offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const COOK_COMPLETE;

/// @brief Field COOK_FAILED offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState const COOK_FAILED;
...
public:
// Declarations
using PDGState = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState;
...
constexpr bool __get__showResults() const;
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState __declspec(property(get=__get__pdgState, put=__set__pdgState))  _pdgState;

constexpr void __set__pdgState(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState value) ;

constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState __get__pdgState() const;
...
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState, "HoudiniEngineUnity", "HEU_TOPNodeData/PDGState");
