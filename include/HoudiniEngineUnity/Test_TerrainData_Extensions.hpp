...
namespace HoudiniEngineUnity {
  ...
  class Test_TerrainData_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_TerrainData[] ToTestObject(UnityEngine.TerrainData[] self)
    // Offset: 0x267BB88
    static ::Array<HoudiniEngineUnity::Test_TerrainData*>* ToTestObject(::Array<UnityEngine::TerrainData*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_TerrainData*>* (*)(::Array<UnityEngine::TerrainData*>*)>(&HoudiniEngineUnity::Test_TerrainData_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
