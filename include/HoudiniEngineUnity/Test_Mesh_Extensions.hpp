...
namespace HoudiniEngineUnity {
  ...
  class Test_Mesh_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Mesh[] ToTestObject(UnityEngine.Mesh[] self)
    // Offset: 0x25D1DD8
    static ::Array<HoudiniEngineUnity::Test_Mesh*>* ToTestObject(::Array<UnityEngine::Mesh*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Mesh*>* (*)(::Array<UnityEngine::Mesh*>*)>(&HoudiniEngineUnity::Test_Mesh_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
