...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::____HoudiniEngineUnity__HEU_MaterialData__Source(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::DEFAULT{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::HOUDINI{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::UNITY{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source::SUBSTANCE{3};
...
constexpr void ::HoudiniEngineUnity::HEU_MaterialData::__set__materialSource(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source ::HoudiniEngineUnity::HEU_MaterialData::__get__materialSource() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 ::HoudiniEngineUnity::HEU_MaterialData::HEU_MaterialData()  : ::UnityEngine::ScriptableObject(THROW_UNLESS(::il2cpp_utils::New<HEU_MaterialData>())) {}
