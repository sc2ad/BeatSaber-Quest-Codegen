...
namespace HoudiniEngineUnity {
  ...
  class HEU_AssetDatabase : public ::Il2CppObject {
    ...
    static T LoadUnityAssetFromUniqueAssetPath(::Il2CppString* assetPath) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, assetPath)));
    }
    ...
    static T GetBuiltinExtraResource(::Il2CppString* resourceName) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, resourceName)));
    }
