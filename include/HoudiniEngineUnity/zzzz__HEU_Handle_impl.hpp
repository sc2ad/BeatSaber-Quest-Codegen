...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType::XFORM{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType::UNSUPPORTED{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType (::HoudiniEngineUnity::HEU_Handle::*)()>(&::HoudiniEngineUnity::HEU_Handle::get_HandleType)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::HoudiniEngineUnity::HEU_Handle::*)(::HoudiniEngineUnity::HEU_SessionBase, int32_t, int32_t, ::StringW, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType, ByRef<::HoudiniEngineUnity::HAPI_HandleInfo>, ::HoudiniEngineUnity::HEU_Parameters)>(&::HoudiniEngineUnity::HEU_Handle::SetupHandle)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "SetupHandle",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::HEU_SessionBase>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::HoudiniEngineUnity::HAPI_HandleInfo>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::HEU_Parameters>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::HoudiniEngineUnity::HEU_Handle::__set__handleType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType ::HoudiniEngineUnity::HEU_Handle::__get__handleType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType ::HoudiniEngineUnity::HEU_Handle::get_HandleType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_Handle>::get(),
                            "get_HandleType",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType, false>(const_cast<void*>(instance), ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Vector3, false>(const_cast<void*>(instance), ___internal_method);
 ...
 bool ::HoudiniEngineUnity::HEU_Handle::SetupHandle(::HoudiniEngineUnity::HEU_SessionBase session, int32_t assetID, int32_t handleIndex, ::StringW handleName, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_Handle__HEU_HandleType handleType, ByRef<::HoudiniEngineUnity::HAPI_HandleInfo> handleInfo, ::HoudiniEngineUnity::HEU_Parameters parameters)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_Handle>::get(),
                            "SetupHandle",
                            std::vector<Il2CppClass*>{},
