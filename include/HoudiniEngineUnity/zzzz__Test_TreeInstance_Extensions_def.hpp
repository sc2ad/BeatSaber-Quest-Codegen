...
class CORDL_TYPE HoudiniEngineUnity__Test_TreeInstance_Extensions____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~HoudiniEngineUnity__Test_TreeInstance_Extensions____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "HoudiniEngineUnity__Test_TreeInstance_Extensions____c", modifiers: " const&", def_value: None }]
constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c(HoudiniEngineUnity__Test_TreeInstance_Extensions____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "HoudiniEngineUnity__Test_TreeInstance_Extensions____c", modifiers: "&&", def_value: None }]
constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c(HoudiniEngineUnity__Test_TreeInstance_Extensions____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit HoudiniEngineUnity__Test_TreeInstance_Extensions____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c& operator=(HoudiniEngineUnity__Test_TreeInstance_Extensions____c&& o) noexcept = default;
  constexpr HoudiniEngineUnity__Test_TreeInstance_Extensions____c& operator=(HoudiniEngineUnity__Test_TreeInstance_Extensions____c const& o) noexcept = default;
                


// Fields

static HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c value) ;

static HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c __get___9() ;
...
public:
// Declarations
using __c = HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c;
...
NEED_NO_BOX(HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c);
DEFINE_IL2CPP_ARG_TYPE(HoudiniEngineUnity::HoudiniEngineUnity__Test_TreeInstance_Extensions____c, "HoudiniEngineUnity", "Test_TreeInstance_Extensions/<>c");
