...
namespace HoudiniEngineUnity {
  ...
  class HEU_ParameterModifier : public ::Il2CppObject/*, public HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::HEU_ParameterModifier*>*/ {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction
    // [TokenAttribute] Offset: FFFFFFFF
    struct ModifierAction/*, public System::Enum*/ {
      ...
      // static field const value: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_INSERT
      static constexpr const int MULTIPARM_INSERT = 0;
      // Get static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_INSERT
      static HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction _get_MULTIPARM_INSERT();
      // Set static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_INSERT
      static void _set_MULTIPARM_INSERT(HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction value);
      // static field const value: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_REMOVE
      static constexpr const int MULTIPARM_REMOVE = 1;
      // Get static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_REMOVE
      static HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction _get_MULTIPARM_REMOVE();
      // Set static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_REMOVE
      static void _set_MULTIPARM_REMOVE(HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction value);
      // static field const value: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_CLEAR
      static constexpr const int MULTIPARM_CLEAR = 2;
      // Get static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_CLEAR
      static HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction _get_MULTIPARM_CLEAR();
      // Set static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction MULTIPARM_CLEAR
      static void _set_MULTIPARM_CLEAR(HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction value);
      // static field const value: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_FLOAT
      static constexpr const int SET_FLOAT = 3;
      // Get static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_FLOAT
      static HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction _get_SET_FLOAT();
      // Set static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_FLOAT
      static void _set_SET_FLOAT(HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction value);
      // static field const value: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_INT
      static constexpr const int SET_INT = 4;
      // Get static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_INT
      static HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction _get_SET_INT();
      // Set static field: static public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction SET_INT
      static void _set_SET_INT(HoudiniEngineUnity::HEU_ParameterModifier::ModifierAction value);
      // Get instance field reference: public System.Int32 value__
      int& dyn_value__();
    }; // HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction
    #pragma pack(pop)
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction _action
    // Size: 0x4
    // Offset: 0x14
    ...
    // Get instance field reference: public HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction _action
    ...
    int& dyn__intValue();
    // static public HoudiniEngineUnity.HEU_ParameterModifier GetNewModifier(HoudiniEngineUnity.HEU_ParameterModifier/ModifierAction action, System.Int32 parameterIndex, System.Int32 instanceIndex, System.Int32 modifierValue)
    // Offset: 0x17A4E0C
