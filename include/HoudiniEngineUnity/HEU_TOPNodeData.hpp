...
namespace HoudiniEngineUnity {
  ...
  class HEU_TOPNodeData : public ::Il2CppObject {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: HoudiniEngineUnity.HEU_TOPNodeData/PDGState
    // [TokenAttribute] Offset: FFFFFFFF
    struct PDGState/*, public System::Enum*/ {
      ...
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState NONE
      static constexpr const int NONE = 0;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState NONE
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_NONE();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState NONE
      static void _set_NONE(HoudiniEngineUnity::HEU_TOPNodeData::PDGState value);
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTIED
      static constexpr const int DIRTIED = 1;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTIED
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_DIRTIED();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTIED
      static void _set_DIRTIED(HoudiniEngineUnity::HEU_TOPNodeData::PDGState value);
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTYING
      static constexpr const int DIRTYING = 2;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTYING
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_DIRTYING();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState DIRTYING
      static void _set_DIRTYING(HoudiniEngineUnity::HEU_TOPNodeData::PDGState value);
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOKING
      static constexpr const int COOKING = 3;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOKING
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_COOKING();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOKING
      static void _set_COOKING(HoudiniEngineUnity::HEU_TOPNodeData::PDGState value);
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_COMPLETE
      static constexpr const int COOK_COMPLETE = 4;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_COMPLETE
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_COOK_COMPLETE();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_COMPLETE
      static void _set_COOK_COMPLETE(HoudiniEngineUnity::HEU_TOPNodeData::PDGState value);
      // static field const value: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_FAILED
      static constexpr const int COOK_FAILED = 5;
      // Get static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_FAILED
      static HoudiniEngineUnity::HEU_TOPNodeData::PDGState _get_COOK_FAILED();
      // Set static field: static public HoudiniEngineUnity.HEU_TOPNodeData/PDGState COOK_FAILED
    ...
    char __padding6[0x3] = {};
    // public HoudiniEngineUnity.HEU_TOPNodeData/PDGState _pdgState
    // Size: 0x4
    // Offset: 0x44
    ...
    // Get instance field reference: public HoudiniEngineUnity.HEU_TOPNodeData/PDGState _pdgState
