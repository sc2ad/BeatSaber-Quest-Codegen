...
namespace HoudiniEngineUnity {
  ...
  class Test_MeshRenderer_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_MeshRenderer[] ToTestObject(UnityEngine.MeshRenderer[] self)
    // Offset: 0x267ABC0
    static ::Array<HoudiniEngineUnity::Test_MeshRenderer*>* ToTestObject(::Array<UnityEngine::MeshRenderer*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_MeshRenderer*>* (*)(::Array<UnityEngine::MeshRenderer*>*)>(&HoudiniEngineUnity::Test_MeshRenderer_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
