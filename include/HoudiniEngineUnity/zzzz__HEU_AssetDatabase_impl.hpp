...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::Default{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::ForceUpdate{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::ForceSynchronousImport{8};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::ImportRecursive{256};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::DontDownloadFromCacheServer{8192};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions::ForceUncompressedImport{16384};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::StringW, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions)>(&::HoudiniEngineUnity::HEU_AssetDatabase::ImportAsset)> {
  constexpr static std::size_t size = 0x44;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "ImportAsset",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::UnityEngine::Object>, false>(nullptr, ___internal_method, assetPath);
 ...
 void ::HoudiniEngineUnity::HEU_AssetDatabase::ImportAsset(::StringW assetPath, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AssetDatabase__HEU_ImportAssetOptions heuOptions)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_AssetDatabase>::get(),
                            "ImportAsset",
                            std::vector<Il2CppClass*>{},
