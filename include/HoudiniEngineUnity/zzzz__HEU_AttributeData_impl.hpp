...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::____HoudiniEngineUnity__HEU_AttributeData__AttributeType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::UNDEFINED{-1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::BOOL{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::INT{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::FLOAT{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::STRING{3};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType::MAX{4};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::____HoudiniEngineUnity__HEU_AttributeData__AttributeState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::INVALID{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::SYNCED{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState::LOCAL_DIRTY{2};
...
constexpr void ::HoudiniEngineUnity::HEU_AttributeData::__set__attributeType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType ::HoudiniEngineUnity::HEU_AttributeData::__get__attributeType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::HoudiniEngineUnity::HEU_AttributeData::__set__attributeState(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState, 0x60>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState ::HoudiniEngineUnity::HEU_AttributeData::__get__attributeState() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeState, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
