...
namespace HoudiniEngineUnity {
  ...
  class HEU_VolumeScatterTrees : public ::Il2CppObject/*, public HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::HEU_VolumeScatterTrees*>*/ {
    ...
    // Size: 0x8
    // Offset: 0x48
    ::Array<float>* widthScales;
    // Field size check
    static_assert(sizeof(::Array<float>*) == 0x8);
    // public System.Int32[] _terrainTiles
    // Size: 0x8
    // Offset: 0x50
    ::Array<int>* terrainTiles;
    // Field size check
    static_assert(sizeof(::Array<int>*) == 0x8);
    // Creating value type constructor for type: HEU_VolumeScatterTrees
    HEU_VolumeScatterTrees(System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_TreePrototypeInfo*>* treePrototypInfos_ = {}, ::Array<UnityEngine::Color32>* colors_ = {}, ::Array<float>* heightScales_ = {}, ::Array<UnityEngine::Color32>* lightmapColors_ = {}, ::Array<UnityEngine::Vector3>* positions_ = {}, ::Array<int>* prototypeIndices_ = {}, ::Array<float>* rotations_ = {}, ::Array<float>* widthScales_ = {}, ::Array<int>* terrainTiles_ = {}) noexcept : treePrototypInfos{treePrototypInfos_}, colors{colors_}, heightScales{heightScales_}, lightmapColors{lightmapColors_}, positions{positions_}, prototypeIndices{prototypeIndices_}, rotations{rotations_}, widthScales{widthScales_}, terrainTiles{terrainTiles_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(HEU_VolumeScatterTrees), 80 + sizeof(::Array<int>*)> __HoudiniEngineUnity_HEU_VolumeScatterTreesSizeCheck;
