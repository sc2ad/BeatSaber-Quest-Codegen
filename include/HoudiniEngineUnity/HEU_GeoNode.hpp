...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeoNode : public UnityEngine::ScriptableObject/*, public UnityEngine::ISerializationCallbackReceiver, public HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::HEU_GeoNode*>*/ {
    public:
