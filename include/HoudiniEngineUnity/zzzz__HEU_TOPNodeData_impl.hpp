...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::NONE{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::DIRTIED{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::DIRTYING{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::COOKING{3};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::COOK_COMPLETE{4};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState::COOK_FAILED{5};
...
constexpr void ::HoudiniEngineUnity::HEU_TOPNodeData::__set__pdgState(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState, 0x44>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState ::HoudiniEngineUnity::HEU_TOPNodeData::__get__pdgState() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_TOPNodeData__PDGState, 0x44>(this->::bs_hook::Il2CppWrapperType::instance);
}
