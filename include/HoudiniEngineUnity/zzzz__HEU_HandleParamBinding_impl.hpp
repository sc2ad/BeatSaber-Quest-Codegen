...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::TRANSLATE{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::ROTATE{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType::SCALE{2};
...
constexpr void ::HoudiniEngineUnity::HEU_HandleParamBinding::__set__paramType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType ::HoudiniEngineUnity::HEU_HandleParamBinding::__get__paramType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HandleParamBinding__HEU_HandleParamType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
