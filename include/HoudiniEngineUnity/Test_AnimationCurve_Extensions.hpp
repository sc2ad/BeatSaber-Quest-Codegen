...
namespace HoudiniEngineUnity {
  ...
  class Test_AnimationCurve_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_AnimationCurve[] ToTestObject(UnityEngine.AnimationCurve[] self)
    // Offset: 0x1708700
    static ::Array<HoudiniEngineUnity::Test_AnimationCurve*>* ToTestObject(::Array<UnityEngine::AnimationCurve*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_AnimationCurve*>* (*)(::Array<UnityEngine::AnimationCurve*>*)>(&HoudiniEngineUnity::Test_AnimationCurve_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
