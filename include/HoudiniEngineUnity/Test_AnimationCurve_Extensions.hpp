...
namespace HoudiniEngineUnity {
  ...
  class Test_AnimationCurve_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_AnimationCurve[] ToTestObject(UnityEngine.AnimationCurve[] self)
    // Offset: 0x1708700
    static ::ArrayWrapper<HoudiniEngineUnity::Test_AnimationCurve*> ToTestObject(::ArrayWrapper<UnityEngine::AnimationCurve*> self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<HoudiniEngineUnity::Test_AnimationCurve*> (*)(::ArrayWrapper<UnityEngine::AnimationCurve*>)>(&HoudiniEngineUnity::Test_AnimationCurve_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
    static auto* self = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("UnityEngine", "AnimationCurve")), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(HoudiniEngineUnity::Test_AnimationCurve_Extensions*), "ToTestObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{self});
  }
};
// Writing MetadataGetter for method: HoudiniEngineUnity::Test_AnimationCurve_Extensions::ToTestObject
