...
namespace HoudiniEngineUnity {
  ...
  class HEU_InputInterfaceTerrain : public HoudiniEngineUnity::HEU_InputInterface {
    ...
    // private System.Boolean SetMaskLayer(HoudiniEngineUnity.HEU_SessionBase session, HoudiniEngineUnity.HEU_InputInterfaceTerrain/HEU_InputDataTerrain idt, ref HoudiniEngineUnity.HAPI_VolumeInfo baseVolumeInfo)
    // Offset: 0x1521CAC
    ...
    // public System.Boolean UploadHeightValuesWithTransform(HoudiniEngineUnity.HEU_SessionBase session, HoudiniEngineUnity.HEU_InputInterfaceTerrain/HEU_InputDataTerrain idt, ref HoudiniEngineUnity.HAPI_VolumeInfo volumeInfo)
    // Offset: 0x1521120
    ...
    // public System.Boolean UploadAlphaMaps(HoudiniEngineUnity.HEU_SessionBase session, HoudiniEngineUnity.HEU_InputInterfaceTerrain/HEU_InputDataTerrain idt, ref HoudiniEngineUnity.HAPI_VolumeInfo baseVolumeInfo, out System.Boolean bMaskSet)
    // Offset: 0x1521778
    ...
    // Offset: 0x1521DB0
    bool SetHeightFieldData(HoudiniEngineUnity::HEU_SessionBase* session, int volumeNodeID, int partID, ::Array<float>* heightValues, ::Il2CppString* heightFieldName, ByRef<HoudiniEngineUnity::HAPI_VolumeInfo> baseVolumeInfo);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::HEU_InputInterfaceTerrain::*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, ::Array<float>*, ::Il2CppString*, ByRef<HoudiniEngineUnity::HAPI_VolumeInfo>)>(&HoudiniEngineUnity::HEU_InputInterfaceTerrain::SetHeightFieldData)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
