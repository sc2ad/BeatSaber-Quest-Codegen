...
constexpr void ::HoudiniEngineUnity::HEU_InputPreset::__set__inputObjectType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_InputNode__InputObjectType value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_InputNode__InputObjectType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_InputNode__InputObjectType>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_InputNode__InputObjectType ::HoudiniEngineUnity::HEU_InputPreset::__get__inputObjectType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_InputNode__InputObjectType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
