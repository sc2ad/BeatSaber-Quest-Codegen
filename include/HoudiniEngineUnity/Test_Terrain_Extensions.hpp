...
namespace HoudiniEngineUnity {
  ...
  class Test_Terrain_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Terrain[] ToTestObject(UnityEngine.Terrain[] self)
    // Offset: 0x25D3560
    static ::Array<HoudiniEngineUnity::Test_Terrain*>* ToTestObject(::Array<UnityEngine::Terrain*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Terrain*>* (*)(::Array<UnityEngine::Terrain*>*)>(&HoudiniEngineUnity::Test_Terrain_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
