...
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_InputPreset>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 HoudiniEngineUnity::HEU_RecookPreset HoudiniEngineUnity::HEU_RecookPreset::New_ctor()  {
HoudiniEngineUnity::HEU_RecookPreset o{THROW_UNLESS(::il2cpp_utils::New<HoudiniEngineUnity::HEU_RecookPreset>())};
return o;
}
