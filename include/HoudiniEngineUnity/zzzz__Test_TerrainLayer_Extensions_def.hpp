...
namespace HoudiniEngineUnity {
class ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c;
}
// Type: ::<>c
namespace HoudiniEngineUnity {
// Is value type: false
...
class CORDL_TYPE ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c", modifiers: " const&", def_value: None }]
constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c(____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c", modifiers: "&&", def_value: None }]
constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c(____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c& operator=(____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c&& o) noexcept = default;
  constexpr ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c& operator=(____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c const& o) noexcept = default;
                


// Fields

static ::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c value) ;

static ::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c __get___9() ;
...
// Ctor Parameters []
explicit ____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c() ;
...
public:
// Declarations
using __c = ::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c;
...
NEED_NO_BOX(::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__Test_TerrainLayer_Extensions____c, "HoudiniEngineUnity", "Test_TerrainLayer_Extensions/<>c");
