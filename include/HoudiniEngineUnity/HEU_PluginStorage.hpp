...
namespace HoudiniEngineUnity {
  ...
  class HEU_PluginStorage : public ::Il2CppObject {
    ...
    // private System.Collections.Generic.Dictionary`2<System.String,HoudiniEngineUnity.HEU_PluginStorage/StoreData> _dataMap
    // Size: 0x8
    // Offset: 0x10
    ...
    // Get instance field reference: private System.Collections.Generic.Dictionary`2<System.String,HoudiniEngineUnity.HEU_PluginStorage/StoreData> _dataMap
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    ::Array<T>* GetJSONArray(::Il2CppString* jsonArray) {
      ...
      return ::il2cpp_utils::RunMethodThrow<::Array<T>*, false>(___instance_arg, ___generic__method, jsonArray);
    }
