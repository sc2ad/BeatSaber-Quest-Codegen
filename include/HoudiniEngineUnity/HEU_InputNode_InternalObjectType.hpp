...
namespace HoudiniEngineUnity {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_InputNode/InternalObjectType
  ...
  struct HEU_InputNode::InternalObjectType/*, public System::Enum*/ {
    ...
    // static field const value: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNKNOWN
    static constexpr const int UNKNOWN = 0;
    // Get static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNKNOWN
    static HoudiniEngineUnity::HEU_InputNode::InternalObjectType _get_UNKNOWN();
    // Set static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNKNOWN
    static void _set_UNKNOWN(HoudiniEngineUnity::HEU_InputNode::InternalObjectType value);
    // static field const value: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType HDA
    static constexpr const int HDA = 1;
    // Get static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType HDA
    static HoudiniEngineUnity::HEU_InputNode::InternalObjectType _get_HDA();
    // Set static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType HDA
    static void _set_HDA(HoudiniEngineUnity::HEU_InputNode::InternalObjectType value);
    // static field const value: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNITY_MESH
    static constexpr const int UNITY_MESH = 2;
    // Get static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNITY_MESH
    static HoudiniEngineUnity::HEU_InputNode::InternalObjectType _get_UNITY_MESH();
    // Set static field: static public HoudiniEngineUnity.HEU_InputNode/InternalObjectType UNITY_MESH
    static void _set_UNITY_MESH(HoudiniEngineUnity::HEU_InputNode::InternalObjectType value);
    // Get instance field reference: public System.Int32 value__
    int& dyn_value__();
  }; // HoudiniEngineUnity.HEU_InputNode/InternalObjectType
  #pragma pack(pop)
