...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::Test_Texture2D::*)(UnityEngine::Texture2D)>(&HoudiniEngineUnity::Test_Texture2D::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2075488;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_Texture2D::*)()>(&HoudiniEngineUnity::Test_Texture2D::IsNull)> {
  ...
  constexpr static std::size_t addrs = 0x20754b0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_Texture2D::*)(HoudiniEngineUnity::Test_Texture2D)>(&HoudiniEngineUnity::Test_Texture2D::IsEquivalentTo)> {
  ...
  constexpr static std::size_t addrs = 0x2075510;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "IsEquivalentTo",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HoudiniEngineUnity::Test_Texture2D>::get()}
                        )));
    return ___internal_method;
  }
};
/// @brief Convert operator to HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_Texture2D>
constexpr  HoudiniEngineUnity::Test_Texture2D::operator HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_Texture2D>() const noexcept {
return HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_Texture2D>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_Texture2D>
constexpr  HoudiniEngineUnity::Test_Texture2D::operator HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_Texture2D>() const noexcept {
return HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_Texture2D>(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HoudiniEngineUnity::Test_Texture2D::__set_self(UnityEngine::Texture2D value)  {
::cordl_internals::setInstanceField<UnityEngine::Texture2D, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Texture2D>(value));
}
