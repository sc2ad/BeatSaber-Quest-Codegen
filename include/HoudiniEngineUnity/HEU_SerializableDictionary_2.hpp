...
namespace HoudiniEngineUnity {
  ...
  class HEU_SerializableDictionary_2 : public ::Il2CppObject/*, public System::Collections::Generic::IDictionary_2<TKey, TValue>, public UnityEngine::ISerializationCallbackReceiver*/ {
    ...
    ::ArrayWrapper<TValue>& dyn__values() {
      ...
      return *reinterpret_cast<::ArrayWrapper<TValue>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    ...
    // Offset: 0xFFFFFFFF
    void CopyTo(::ArrayWrapper<System::Collections::Generic::KeyValuePair_2<TKey, TValue>> array, int arrayIndex) {
