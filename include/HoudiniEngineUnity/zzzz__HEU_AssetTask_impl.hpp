...
constexpr void HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType  HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::NONE{0};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType  HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::LOAD{1};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType  HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::COOK{2};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType  HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType::RELOAD{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_AssetTask::*)(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Task__TaskResult)>(&HoudiniEngineUnity::HEU_AssetTask::CompleteTask)> {
  constexpr static std::size_t size = 0x240;
...
constexpr void HoudiniEngineUnity::HEU_AssetTask::__set__buildType(HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType value)  {
::cordl_internals::setInstanceField<HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType>(value));
}
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType HoudiniEngineUnity::HEU_AssetTask::__get__buildType() const {
return ::cordl_internals::getInstanceField<HoudiniEngineUnity::HoudiniEngineUnity__HEU_AssetTask__BuildType, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void HoudiniEngineUnity::HEU_AssetTask::CompleteTask(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Task__TaskResult result)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_AssetTask>::get(),
                            "CompleteTask",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HoudiniEngineUnity::HoudiniEngineUnity__HEU_Task__TaskResult>::get()}
                        )));
