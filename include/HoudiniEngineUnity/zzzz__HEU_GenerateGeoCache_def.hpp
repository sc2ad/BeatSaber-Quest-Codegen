...
struct ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType;
}
namespace HoudiniEngineUnity {
class HEU_GenerateGeoCache;
}
namespace HoudiniEngineUnity {
class ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo;
}
namespace HoudiniEngineUnity {
class ____HoudiniEngineUnity__HEU_GenerateGeoCache____c;
}
// Type: ::ColliderType
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType(int32_t value__) noexcept;


                    constexpr ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType(______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const&) = default;
                    constexpr ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType(______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType&&) = default;
                    constexpr ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType& operator=(______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType& operator=(______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType&& o) noexcept {
...
constexpr explicit ______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ________HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType_Unwrapped : int32_t {
__NONE = 0,
__BOX = 1,
__SPHERE = 2,
__MESH = 3,
...
constexpr operator ________HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType_Unwrapped () const noexcept {
return std::bit_cast<________HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const NONE;

/// @brief Field BOX offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const BOX;

/// @brief Field SPHERE offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const SPHERE;

/// @brief Field MESH offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const MESH;

/// @brief Field SIMPLE_BOX offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const SIMPLE_BOX;

/// @brief Field SIMPLE_SPHERE offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const SIMPLE_SPHERE;

/// @brief Field SIMPLE_CAPSULE offset 0
static ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType const SIMPLE_CAPSULE;
...
class CORDL_TYPE ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using ColliderType = ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x58};

virtual ~____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo", modifiers: " const&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo(____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo", modifiers: "&&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo(____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo& operator=(____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo&& o) noexcept = default;
  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo& operator=(____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo const& o) noexcept = default;
                


// Fields

 ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType __declspec(property(get=__get__colliderType, put=__set__colliderType))  _colliderType;

constexpr void __set__colliderType(::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType value) ;

constexpr ::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType __get__colliderType() const;
...
// Ctor Parameters []
explicit ____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo() ;
...
class CORDL_TYPE ____HoudiniEngineUnity__HEU_GenerateGeoCache____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____HoudiniEngineUnity__HEU_GenerateGeoCache____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_GenerateGeoCache____c", modifiers: " const&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c(____HoudiniEngineUnity__HEU_GenerateGeoCache____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_GenerateGeoCache____c", modifiers: "&&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c(____HoudiniEngineUnity__HEU_GenerateGeoCache____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__HEU_GenerateGeoCache____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c& operator=(____HoudiniEngineUnity__HEU_GenerateGeoCache____c&& o) noexcept = default;
  constexpr ____HoudiniEngineUnity__HEU_GenerateGeoCache____c& operator=(____HoudiniEngineUnity__HEU_GenerateGeoCache____c const& o) noexcept = default;
                


// Fields

static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c value) ;

static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c __get___9() ;
...
// Ctor Parameters []
explicit ____HoudiniEngineUnity__HEU_GenerateGeoCache____c() ;
...
public:
// Declarations
using __c = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c;

using HEU_ColliderInfo = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo;
...
constexpr bool __get__isMeshReadWrite() const;
 ...
 ::System::Collections::Generic::List_1<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo> __declspec(property(get=__get__colliderInfos, put=__set__colliderInfos))  _colliderInfos;

constexpr void __set__colliderInfos(::System::Collections::Generic::List_1<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo> value) ;

constexpr ::System::Collections::Generic::List_1<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo> __get__colliderInfos() const;
...
static void UpdateCollider(::HoudiniEngineUnity::HEU_GenerateGeoCache geoCache, ::HoudiniEngineUnity::HEU_GeneratedOutputData outputData, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo colliderInfo) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo__ColliderType, "HoudiniEngineUnity", "HEU_GenerateGeoCache/HEU_ColliderInfo/ColliderType");
...
NEED_NO_BOX(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache__HEU_ColliderInfo, "HoudiniEngineUnity", "HEU_GenerateGeoCache/HEU_ColliderInfo");
NEED_NO_BOX(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_GenerateGeoCache____c, "HoudiniEngineUnity", "HEU_GenerateGeoCache/<>c");
