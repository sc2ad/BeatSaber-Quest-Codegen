...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeneralUtility : public ::Il2CppObject {
    ...
    // static public System.Boolean GetArray1Arg(System.Int32 arg1, HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1<T> func, out T[] data, System.Int32 start, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool GetArray1Arg(int arg1, HoudiniEngineUnity::HEU_GeneralUtility::GetArray1ArgDel_1<T>* func, ByRef<::Array<T>*> data, int start, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("HoudiniEngineUnity::HEU_GeneralUtility::GetArray1Arg");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("HoudiniEngineUnity", "HEU_GeneralUtility", "GetArray1Arg", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(arg1), ::il2cpp_utils::ExtractType(func), ::il2cpp_utils::ExtractIndependentType<::Array<T>*&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(count)})));
    ...
    // static public System.Boolean GetArray2Arg(System.Int32 arg1, ARG2 arg2, HoudiniEngineUnity.HEU_GeneralUtility/GetArray2ArgDel`2<ARG2,T> func, out T[] data, System.Int32 start, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class ARG2, class T>
    static bool GetArray2Arg(int arg1, ARG2 arg2, HoudiniEngineUnity::HEU_GeneralUtility::GetArray2ArgDel_2<ARG2, T>* func, ByRef<::Array<T>*> data, int start, int count) {
    ...
    // static public System.Boolean SetArray1Arg(System.Int32 arg1, HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1<T> func, out T[] data, System.Int32 start, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool SetArray1Arg(int arg1, HoudiniEngineUnity::HEU_GeneralUtility::GetArray1ArgDel_1<T>* func, ByRef<::Array<T>*> data, int start, int count) {
    ...
    // static public System.Boolean SetArray2Arg(System.Int32 arg1, ARG2 arg2, HoudiniEngineUnity.HEU_GeneralUtility/GetArray2ArgDel`2<ARG2,T> func, out T[] data, System.Int32 start, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class ARG2, class T>
    static bool SetArray2Arg(int arg1, ARG2 arg2, HoudiniEngineUnity::HEU_GeneralUtility::GetArray2ArgDel_2<ARG2, T>* func, ByRef<::Array<T>*> data, int start, int count) {
    ...
    // static public System.Boolean SetArray(System.Int32 arg1, ARG2 arg2, HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1<T> func1, HoudiniEngineUnity.HEU_GeneralUtility/GetArray2ArgDel`2<ARG2,T> func2, out T[] data, System.Int32 start, System.Int32 count, System.Int32 tupleSize)
    // Offset: 0xFFFFFFFF
    template<class ARG2, class T>
    static bool SetArray(int arg1, ARG2 arg2, HoudiniEngineUnity::HEU_GeneralUtility::GetArray1ArgDel_1<T>* func1, HoudiniEngineUnity::HEU_GeneralUtility::GetArray2ArgDel_2<ARG2, T>* func2, ByRef<::Array<T>*> data, int start, int count, int tupleSize) {
      static auto ___internal__logger = ::Logger::get().WithContext("HoudiniEngineUnity::HEU_GeneralUtility::SetArray");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("HoudiniEngineUnity", "HEU_GeneralUtility", "SetArray", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ARG2>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(arg1), ::il2cpp_utils::ExtractType(arg2), ::il2cpp_utils::ExtractType(func1), ::il2cpp_utils::ExtractType(func2), ::il2cpp_utils::ExtractIndependentType<::Array<T>*&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(count), ::il2cpp_utils::ExtractType(tupleSize)})));
      static auto* ___generic__method = THROW_UNLESS((::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ARG2>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()})));
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool DoArrayElementsMatch(::Array<T>* array1, ::Array<T>* array2) {
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool DoArrayElementsMatch(::Array<T>* array1, int startOffset1, ::Array<T>* array2, int startOffset2, int length) {
      static auto ___internal__logger = ::Logger::get().WithContext("HoudiniEngineUnity::HEU_GeneralUtility::DoArrayElementsMatch");
    ...
    // static public System.Boolean GetAttributeArray(System.Int32 geoID, System.Int32 partID, System.String name, ref HoudiniEngineUnity.HAPI_AttributeInfo info, T[] items, HoudiniEngineUnity.HEU_GeneralUtility/GetAttributeArrayInputFunc`1<T> getFunc, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool GetAttributeArray(int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ::Array<T>* items, HoudiniEngineUnity::HEU_GeneralUtility::GetAttributeArrayInputFunc_1<T>* getFunc, int count) {
    ...
    // static public System.Boolean GetAttribute(HoudiniEngineUnity.HEU_SessionBase session, System.Int32 geoID, System.Int32 partID, System.String name, ref HoudiniEngineUnity.HAPI_AttributeInfo info, ref T[] data, HoudiniEngineUnity.HEU_GeneralUtility/GetAttributeArrayInputFunc`1<T> getFunc)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool GetAttribute(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::Array<T>*> data, HoudiniEngineUnity::HEU_GeneralUtility::GetAttributeArrayInputFunc_1<T>* getFunc) {
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool GetAttributeStrict(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, HoudiniEngineUnity::HAPI_AttributeOwner attrOwner, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::Array<T>*> data, HoudiniEngineUnity::HEU_GeneralUtility::GetAttributeArrayInputFunc_1<T>* getFunc) {
    ...
    // Offset: 0x1498FC4
    static void GetAttributeStringDataHelper(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::Array<int>*> data);
    ...
    // Offset: 0x1499184
    static ::Array<::Il2CppString*>* GetAttributeStringData(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo);
    // static public System.Boolean SetAttributeArray(System.Int32 geoID, System.Int32 partID, System.String attrName, ref HoudiniEngineUnity.HAPI_AttributeInfo attrInfo, T[] items, HoudiniEngineUnity.HEU_GeneralUtility/SetAttributeArrayFunc`1<T> setFunc, System.Int32 count)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool SetAttributeArray(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::Array<T>* items, HoudiniEngineUnity::HEU_GeneralUtility::SetAttributeArrayFunc_1<T>* setFunc, int count) {
    ...
    // static public System.Boolean SetAttribute(System.Int32 geoID, System.Int32 partID, System.String attrName, ref HoudiniEngineUnity.HAPI_AttributeInfo attrInfo, T[] items, HoudiniEngineUnity.HEU_GeneralUtility/SetAttributeArrayFunc`1<T> setFunc)
    // Offset: 0xFFFFFFFF
    template<class T>
    static bool SetAttribute(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::Array<T>* items, HoudiniEngineUnity::HEU_GeneralUtility::SetAttributeArrayFunc_1<T>* setFunc) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, ::Il2CppString*, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo>, ByRef<::Array<int>*>)>(&HoudiniEngineUnity::HEU_GeneralUtility::GetAttributeStringDataHelper)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<::Il2CppString*>* (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, ::Il2CppString*, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo>)>(&HoudiniEngineUnity::HEU_GeneralUtility::GetAttributeStringData)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* geoID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* partID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
