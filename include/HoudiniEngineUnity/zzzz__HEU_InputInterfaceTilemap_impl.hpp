...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::*)()>(&HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x205c594;
...
constexpr void HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::__set__tilemap(UnityEngine::Tilemaps::Tilemap value)  {
::cordl_internals::setInstanceField<UnityEngine::Tilemaps::Tilemap, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Tilemaps::Tilemap>(value));
}
constexpr UnityEngine::Tilemaps::Tilemap HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::__get__tilemap() const {
return ::cordl_internals::getInstanceField<UnityEngine::Tilemaps::Tilemap, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::__set__transform(UnityEngine::Transform value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)()>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2059d00;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings)>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::Initialize)> {
  ...
  constexpr static std::size_t addrs = 0x2059d0c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Initialize",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(HoudiniEngineUnity::HEU_SessionBase, int32_t, UnityEngine::GameObject, ByRef<int32_t>)>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::CreateInputNodeWithDataUpload)> {
  constexpr static std::size_t size = 0x198;
  constexpr static std::size_t addrs = 0x2059d7c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(HoudiniEngineUnity::HEU_InputInterfaceTilemap),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_InputInterfaceTilemap>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(UnityEngine::GameObject)>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::IsThisInputObjectSupported)> {
  ...
  constexpr static std::size_t addrs = 0x205b9e8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(HoudiniEngineUnity::HEU_SessionBase, int32_t, HoudiniEngineUnity::HEU_InputData)>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::UploadData)> {
  constexpr static std::size_t size = 0x19fc;
  constexpr static std::size_t addrs = 0x2059fec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap (HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(UnityEngine::GameObject)>(&HoudiniEngineUnity::HEU_InputInterfaceTilemap::GenerateTilemapDataFromGameObject)> {
  constexpr static std::size_t size = 0xd8;
  constexpr static std::size_t addrs = 0x2059f14;
...
::cordl_internals::setInstanceField<HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, settings);
 ...
 bool HoudiniEngineUnity::HEU_InputInterfaceTilemap::CreateInputNodeWithDataUpload(HoudiniEngineUnity::HEU_SessionBase session, int32_t connectNodeID, UnityEngine::GameObject inputObject, ByRef<int32_t> inputNodeID)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_InputInterfaceTilemap>::get(),
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, inputObject);
 ...
 bool HoudiniEngineUnity::HEU_InputInterfaceTilemap::UploadData(HoudiniEngineUnity::HEU_SessionBase session, int32_t inputNodeID, HoudiniEngineUnity::HEU_InputData inputData)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_InputInterfaceTilemap>::get(),
                            "UploadData",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, session, inputNodeID, inputData);
 ...
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap HoudiniEngineUnity::HEU_InputInterfaceTilemap::GenerateTilemapDataFromGameObject(UnityEngine::GameObject inputObject)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_InputInterfaceTilemap>::get(),
                            "GenerateTilemapDataFromGameObject",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputInterfaceTilemap__HEU_InputDataTilemap, false>(const_cast<void*>(instance), ___internal_method, inputObject);
}
