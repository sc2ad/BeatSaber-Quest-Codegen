...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::Test_TerrainData::*)(UnityEngine::TerrainData)>(&HoudiniEngineUnity::Test_TerrainData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2075f88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_TerrainData::*)()>(&HoudiniEngineUnity::Test_TerrainData::IsNull)> {
  ...
  constexpr static std::size_t addrs = 0x2075fb0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_TerrainData::*)(HoudiniEngineUnity::Test_TerrainData)>(&HoudiniEngineUnity::Test_TerrainData::IsEquivalentTo)> {
  ...
  constexpr static std::size_t addrs = 0x2076010;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "IsEquivalentTo",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HoudiniEngineUnity::Test_TerrainData>::get()}
                        )));
    return ___internal_method;
  }
};
/// @brief Convert operator to HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_TerrainData>
constexpr  HoudiniEngineUnity::Test_TerrainData::operator HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_TerrainData>() const noexcept {
return HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_TerrainData>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_TerrainData>
constexpr  HoudiniEngineUnity::Test_TerrainData::operator HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_TerrainData>() const noexcept {
return HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_TerrainData>(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HoudiniEngineUnity::Test_TerrainData::__set_self(UnityEngine::TerrainData value)  {
::cordl_internals::setInstanceField<UnityEngine::TerrainData, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::TerrainData>(value));
}
