...
constexpr void HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction  HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::MULTIPARM_INSERT{0};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction  HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::MULTIPARM_REMOVE{1};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction  HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::MULTIPARM_CLEAR{2};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction  HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::SET_FLOAT{3};
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction  HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction::SET_INT{4};
//  Writing Method size for method: HoudiniEngineUnity::HEU_ParameterModifier.GetNewModifier
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<HoudiniEngineUnity::HEU_ParameterModifier (*)(HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction, int32_t, int32_t, int32_t)>(&HoudiniEngineUnity::HEU_ParameterModifier::GetNewModifier)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
...
constexpr void HoudiniEngineUnity::HEU_ParameterModifier::__set__action(HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction value)  {
::cordl_internals::setInstanceField<HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction>(value));
}
constexpr HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction HoudiniEngineUnity::HEU_ParameterModifier::__get__action() const {
return ::cordl_internals::getInstanceField<HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<int32_t, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 HoudiniEngineUnity::HEU_ParameterModifier HoudiniEngineUnity::HEU_ParameterModifier::GetNewModifier(HoudiniEngineUnity::HoudiniEngineUnity__HEU_ParameterModifier__ModifierAction action, int32_t parameterIndex, int32_t instanceIndex, int32_t modifierValue)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HoudiniEngineUnity::HEU_ParameterModifier>::get(),
                            "GetNewModifier",
                            std::vector<Il2CppClass*>{},
