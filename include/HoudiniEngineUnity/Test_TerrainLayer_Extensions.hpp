...
namespace HoudiniEngineUnity {
  ...
  class Test_TerrainLayer_Extensions : public ::Il2CppObject {
    ...
    class $$c;
    // Creating value type constructor for type: Test_TerrainLayer_Extensions
    Test_TerrainLayer_Extensions() noexcept {}
    ...
    // static public HoudiniEngineUnity.Test_TerrainLayer[] ToTestObject(UnityEngine.TerrainLayer[] self)
    // Offset: 0x267B9B0
    static ::Array<HoudiniEngineUnity::Test_TerrainLayer*>* ToTestObject(::Array<UnityEngine::TerrainLayer*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_TerrainLayer*>* (*)(::Array<UnityEngine::TerrainLayer*>*)>(&HoudiniEngineUnity::Test_TerrainLayer_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
