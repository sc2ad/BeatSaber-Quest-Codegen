...
namespace HoudiniEngineUnity {
  ...
  // Autogenerated type: HoudiniEngineUnity.JSONNode/Enumerator
  ...
  struct JSONNode::Enumerator/*, public System::ValueType*/ {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: HoudiniEngineUnity.JSONNode/Enumerator/Type
    // [TokenAttribute] Offset: FFFFFFFF
    struct Type/*, public System::Enum*/ {
      ...
      // static field const value: static public HoudiniEngineUnity.JSONNode/Enumerator/Type None
      static constexpr const int None = 0;
      // Get static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type None
      static HoudiniEngineUnity::JSONNode::Enumerator::Type _get_None();
      // Set static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type None
      static void _set_None(HoudiniEngineUnity::JSONNode::Enumerator::Type value);
      // static field const value: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Array
      static constexpr const int Array = 1;
      // Get static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Array
      static HoudiniEngineUnity::JSONNode::Enumerator::Type _get_Array();
      // Set static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Array
      static void _set_Array(HoudiniEngineUnity::JSONNode::Enumerator::Type value);
      // static field const value: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Object
      static constexpr const int Object = 2;
      // Get static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Object
      static HoudiniEngineUnity::JSONNode::Enumerator::Type _get_Object();
      // Set static field: static public HoudiniEngineUnity.JSONNode/Enumerator/Type Object
    ...
    // private HoudiniEngineUnity.JSONNode/Enumerator/Type type
    // Size: 0x4
    // Offset: 0x0
    HoudiniEngineUnity::JSONNode::Enumerator::Type type;
    // Field size check
    static_assert(sizeof(HoudiniEngineUnity::JSONNode::Enumerator::Type) == 0x4);
    // private System.Collections.Generic.Dictionary`2/Enumerator<System.String,HoudiniEngineUnity.JSONNode> m_Object
    // Size: 0xFFFFFFFF
    // Offset: 0x8
    typename System::Collections::Generic::Dictionary_2<::Il2CppString*, HoudiniEngineUnity::JSONNode*>::Enumerator m_Object;
    // private System.Collections.Generic.List`1/Enumerator<HoudiniEngineUnity.JSONNode> m_Array
    // Size: 0xFFFFFFFF
    // Offset: 0x30
    ...
    // Get instance field reference: private HoudiniEngineUnity.JSONNode/Enumerator/Type type
    HoudiniEngineUnity::JSONNode::Enumerator::Type& dyn_type();
    // Get instance field reference: private System.Collections.Generic.Dictionary`2/Enumerator<System.String,HoudiniEngineUnity.JSONNode> m_Object
    typename System::Collections::Generic::Dictionary_2<::Il2CppString*, HoudiniEngineUnity::JSONNode*>::Enumerator& dyn_m_Object();
    // Get instance field reference: private System.Collections.Generic.List`1/Enumerator<HoudiniEngineUnity.JSONNode> m_Array
