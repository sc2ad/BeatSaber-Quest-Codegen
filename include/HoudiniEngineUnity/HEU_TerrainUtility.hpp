...
namespace HoudiniEngineUnity {
  ...
  class HEU_TerrainUtility : public ::Il2CppObject {
    ...
    // Offset: 0x17DB438
    static ::Array<float>* GetNormalizedHeightmapFromPartWithMinMax(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, int heightMapWidth, int heightMapHeight, ByRef<float> minHeight, ByRef<float> maxHeight, ByRef<float> heightRange, bool bUseHeightRangeOverride);
    ...
    // Offset: 0x17DBCC0
    static ::Array<int>* GetDetailMapFromPart(HoudiniEngineUnity::HEU_SessionBase* session, int geoID, int partID, ByRef<int> detailResolution);
    ...
    // Offset: 0x17DBAB0
    static bool GetHeightmapFromPart(HoudiniEngineUnity::HEU_SessionBase* session, int xLength, int yLength, int geoID, int partID, ByRef<::Array<float>*> heightValues, ByRef<float> minHeight, ByRef<float> maxHeight);
    ...
    // Offset: 0x17DB888
    static ::Array<float>* ConvertHeightMapHoudiniToUnity(int heightMapWidth, int heightMapHeight, ::Array<float>* heightValues);
    ...
    // Offset: 0x17DBF84
    static ::Array<float>* ConvertHeightFieldToAlphaMap(int heightMapWidth, int heightMapHeight, System::Collections::Generic::List_1<::Array<float>*>* heightFields);
    ...
    // Offset: 0x17DC138
    static ::Array<float>* AppendConvertedHeightFieldToAlphaMap(int heightMapWidth, int heightMapHeight, ::Array<float>* existingAlphaMaps, System::Collections::Generic::List_1<::Array<float>*>* heightFields, ::Array<float>* strengths, System::Collections::Generic::List_1<int>* alphaMapIndices);
    ...
    // Offset: 0x17DE23C
    static int GetTerrainLayerIndexByName(::Il2CppString* layerName, ::Array<UnityEngine::TerrainLayer*>* terrainLayers);
    // static public System.Int32 GetTerrainLayerIndex(UnityEngine.TerrainLayer layer, UnityEngine.TerrainLayer[] terrainLayers)
    // Offset: 0x17DE3C0
    static int GetTerrainLayerIndex(UnityEngine::TerrainLayer* layer, ::Array<UnityEngine::TerrainLayer*>* terrainLayers);
    ...
    // Offset: 0x17DE9BC
    static ::Array<float>* ResampleData(::Array<float>* data, int oldWidth, int oldHeight, int newWidth, int newHeight);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<float>* (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, int, int, ByRef<float>, ByRef<float>, ByRef<float>, bool)>(&HoudiniEngineUnity::HEU_TerrainUtility::GetNormalizedHeightmapFromPartWithMinMax)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* geoID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* partID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<int>* (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, ByRef<int>)>(&HoudiniEngineUnity::HEU_TerrainUtility::GetDetailMapFromPart)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* geoID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* partID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, int, int, ByRef<::Array<float>*>, ByRef<float>, ByRef<float>)>(&HoudiniEngineUnity::HEU_TerrainUtility::GetHeightmapFromPart)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<float>* (*)(int, int, ::Array<float>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::ConvertHeightMapHoudiniToUnity)> {
  static const MethodInfo* get() {
    static auto* heightMapWidth = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* heightMapHeight = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<float>* (*)(int, int, System::Collections::Generic::List_1<::Array<float>*>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::ConvertHeightFieldToAlphaMap)> {
  static const MethodInfo* get() {
    static auto* heightMapWidth = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* heightMapHeight = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<float>* (*)(int, int, ::Array<float>*, System::Collections::Generic::List_1<::Array<float>*>*, ::Array<float>*, System::Collections::Generic::List_1<int>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::AppendConvertedHeightFieldToAlphaMap)> {
  static const MethodInfo* get() {
    static auto* heightMapWidth = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* heightMapHeight = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::Terrain*, UnityEngine::TerrainData*, HoudiniEngineUnity::HEU_DetailProperties*, System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_DetailPrototype*>*, System::Collections::Generic::List_1<::Array<int>*>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::ApplyDetailLayers)> {
  static const MethodInfo* get() {
    static auto* terrain = &::il2cpp_utils::GetClassFromName("UnityEngine", "Terrain")->byval_arg;
    static auto* terrainData = &::il2cpp_utils::GetClassFromName("UnityEngine", "TerrainData")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(::Il2CppString*, ::Array<UnityEngine::TerrainLayer*>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::GetTerrainLayerIndexByName)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(UnityEngine::TerrainLayer*, ::Array<UnityEngine::TerrainLayer*>*)>(&HoudiniEngineUnity::HEU_TerrainUtility::GetTerrainLayerIndex)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<float>* (*)(::Array<float>*, int, int, int, int)>(&HoudiniEngineUnity::HEU_TerrainUtility::ResampleData)> {
  static const MethodInfo* get() {
