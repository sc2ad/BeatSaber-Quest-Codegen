...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_CookedEventData::*)(HoudiniEngineUnity::HEU_HoudiniAsset, bool, System::Collections::Generic::List_1<UnityEngine::GameObject>)>(&HoudiniEngineUnity::HEU_CookedEventData::_ctor)> {
 ...
 HoudiniEngineUnity::HEU_CookedEventData HoudiniEngineUnity::HEU_CookedEventData::New_ctor(HoudiniEngineUnity::HEU_HoudiniAsset asset, bool successful, System::Collections::Generic::List_1<UnityEngine::GameObject> outputObjects)  {
HoudiniEngineUnity::HEU_CookedEventData o{THROW_UNLESS(::il2cpp_utils::New<HoudiniEngineUnity::HEU_CookedEventData>(asset, successful, outputObjects))};
return o;
}
