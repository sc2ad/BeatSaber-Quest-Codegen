...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_BakedDataEvent::*)()>(&HoudiniEngineUnity::HEU_BakedDataEvent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1fdac9c;
 ...
 HoudiniEngineUnity::HEU_BakedDataEvent HoudiniEngineUnity::HEU_BakedDataEvent::New_ctor()  {
HoudiniEngineUnity::HEU_BakedDataEvent o{THROW_UNLESS(::il2cpp_utils::New<HoudiniEngineUnity::HEU_BakedDataEvent>())};
return o;
}
