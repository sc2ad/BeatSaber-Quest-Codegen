...
static ::UnityEngine::GameObject CreateNewAsset(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_HoudiniAsset__HEU_AssetType assetType, ::StringW rootName, ::UnityEngine::Transform parentTransform, ::HoudiniEngineUnity::HEU_SessionBase session, bool bBuildAsync, ::UnityEngine::GameObject rootGO) ;
