...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::Test_LODGroup::*)(UnityEngine::LODGroup)>(&HoudiniEngineUnity::Test_LODGroup::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x20719a8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_LODGroup::*)()>(&HoudiniEngineUnity::Test_LODGroup::IsNull)> {
  ...
  constexpr static std::size_t addrs = 0x20719d0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (HoudiniEngineUnity::Test_LODGroup::*)(HoudiniEngineUnity::Test_LODGroup)>(&HoudiniEngineUnity::Test_LODGroup::IsEquivalentTo)> {
  ...
  constexpr static std::size_t addrs = 0x2071a30;
...
constexpr  HoudiniEngineUnity::Test_LODGroup::operator HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_LODGroup>() const noexcept {
return HoudiniEngineUnity::IEquivableWrapperClass_1<HoudiniEngineUnity::Test_LODGroup>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_LODGroup>
constexpr  HoudiniEngineUnity::Test_LODGroup::operator HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_LODGroup>() const noexcept {
return HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::Test_LODGroup>(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HoudiniEngineUnity::Test_LODGroup::__set_self(UnityEngine::LODGroup value)  {
::cordl_internals::setInstanceField<UnityEngine::LODGroup, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::LODGroup>(value));
}
