...
static ::HoudiniEngineUnity::HEU_MaterialData CreateMaterialInCache(int32_t materialKey, ::StringW materialName, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_MaterialData__Source sourceType, bool bWriteToFile, ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_MaterialData> materialCache, ::StringW assetCacheFolderPath) ;
