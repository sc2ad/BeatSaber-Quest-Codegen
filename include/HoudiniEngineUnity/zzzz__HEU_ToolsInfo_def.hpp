...
namespace HoudiniEngineUnity {
struct ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility;
}
namespace HoudiniEngineUnity {
class HEU_ToolsInfo;
}
...
struct CORDL_TYPE ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode(int32_t value__) noexcept;


                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode&&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode& operator=(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode& operator=(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode&& o) noexcept {
...
constexpr explicit ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode_Unwrapped : int32_t {
__REPLACE = 0,
__ADD = 1,
__SUBTRACT = 2,
__MULTIPLY = 3,
...
constexpr operator ______HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode_Unwrapped () const noexcept {
return std::bit_cast<______HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode_Unwrapped>(__instance);
}
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const REPLACE;

/// @brief Field ADD offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const ADD;

/// @brief Field SUBTRACT offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const SUBTRACT;

/// @brief Field MULTIPLY offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode const MULTIPLY;
...
struct CORDL_TYPE ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility(int32_t value__) noexcept;


                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility const&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility&&) = default;
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility& operator=(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility& operator=(____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility_Unwrapped : int32_t {
__AUTO = 0,
__SHOW = 1,
__HIDE = 2,
};
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility_Unwrapped () const noexcept {
return std::bit_cast<______HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility_Unwrapped>(__instance);
}
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility const AUTO;

/// @brief Field SHOW offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility const SHOW;

/// @brief Field HIDE offset 0
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility const HIDE;
...
public:
// Declarations
using PaintMeshVisibility = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility;

using PaintMergeMode = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode;
...
constexpr bool __get__recacheRequired() const;
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode __declspec(property(get=__get__paintMergeMode, put=__set__paintMergeMode))  _paintMergeMode;

constexpr void __set__paintMergeMode(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode value) ;

constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode __get__paintMergeMode() const;
...
constexpr bool __get__alwaysCookUpstream() const;
 ...
 ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility __declspec(property(get=__get__paintMeshVisiblity, put=__set__paintMeshVisiblity))  _paintMeshVisiblity;

constexpr void __set__paintMeshVisiblity(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility value) ;

constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility __get__paintMeshVisiblity() const;
...
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode, "HoudiniEngineUnity", "HEU_ToolsInfo/PaintMergeMode");
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMeshVisibility, "HoudiniEngineUnity", "HEU_ToolsInfo/PaintMeshVisibility");
