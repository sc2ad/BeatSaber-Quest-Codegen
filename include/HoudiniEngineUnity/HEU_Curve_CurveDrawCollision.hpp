...
namespace HoudiniEngineUnity {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_Curve/CurveDrawCollision
  ...
  struct HEU_Curve::CurveDrawCollision/*, public System::Enum*/ {
    ...
    // static field const value: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision COLLIDERS
    static constexpr const int COLLIDERS = 0;
    // Get static field: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision COLLIDERS
    static HoudiniEngineUnity::HEU_Curve::CurveDrawCollision _get_COLLIDERS();
    // Set static field: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision COLLIDERS
    static void _set_COLLIDERS(HoudiniEngineUnity::HEU_Curve::CurveDrawCollision value);
    // static field const value: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision LAYERMASK
    static constexpr const int LAYERMASK = 1;
    // Get static field: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision LAYERMASK
    static HoudiniEngineUnity::HEU_Curve::CurveDrawCollision _get_LAYERMASK();
    // Set static field: static public HoudiniEngineUnity.HEU_Curve/CurveDrawCollision LAYERMASK
