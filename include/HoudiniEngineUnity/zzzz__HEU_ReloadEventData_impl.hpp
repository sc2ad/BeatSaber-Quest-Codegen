...
// Ctor Parameters [CppParam { name: "asset", ty: "::HoudiniEngineUnity::HEU_HoudiniAsset", modifiers: "", def_value: None }, CppParam { name: "successful", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "outputObjects", ty: "::System::Collections::Generic::List_1<::UnityEngine::GameObject>", modifiers: "", def_value: None }]
 ::HoudiniEngineUnity::HEU_ReloadEventData::HEU_ReloadEventData(::HoudiniEngineUnity::HEU_HoudiniAsset asset, bool successful, ::System::Collections::Generic::List_1<::UnityEngine::GameObject> outputObjects)  : ::HoudiniEngineUnity::HEU_AssetEventData(THROW_UNLESS(::il2cpp_utils::New<HEU_ReloadEventData>(asset, successful, outputObjects))) {}
