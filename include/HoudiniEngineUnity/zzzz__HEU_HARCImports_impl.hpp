...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_HARCImports::*)()>(&HoudiniEngineUnity::HEU_HARCImports::_ctor)> {
 ...
 HoudiniEngineUnity::HEU_HARCImports HoudiniEngineUnity::HEU_HARCImports::New_ctor()  {
HoudiniEngineUnity::HEU_HARCImports o{THROW_UNLESS(::il2cpp_utils::New<HoudiniEngineUnity::HEU_HARCImports>())};
return o;
}
