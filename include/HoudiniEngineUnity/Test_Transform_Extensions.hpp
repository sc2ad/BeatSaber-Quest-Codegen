...
namespace HoudiniEngineUnity {
  ...
  class Test_Transform_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Transform[] ToTestObject(UnityEngine.Transform[] self)
    // Offset: 0x25D3FB8
    static ::Array<HoudiniEngineUnity::Test_Transform*>* ToTestObject(::Array<UnityEngine::Transform*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Transform*>* (*)(::Array<UnityEngine::Transform*>*)>(&HoudiniEngineUnity::Test_Transform_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
