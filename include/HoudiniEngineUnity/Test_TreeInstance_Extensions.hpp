...
namespace HoudiniEngineUnity {
  ...
  class Test_TreeInstance_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_TreeInstance[] ToTestObject(UnityEngine.TreeInstance[] self)
    // Offset: 0x25D29A0
    static ::Array<HoudiniEngineUnity::Test_TreeInstance*>* ToTestObject(::Array<UnityEngine::TreeInstance>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_TreeInstance*>* (*)(::Array<UnityEngine::TreeInstance>*)>(&HoudiniEngineUnity::Test_TreeInstance_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
