...
namespace HoudiniEngineUnity {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_Curve/<>c__DisplayClass38_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: EFAAC0
  ...
  }; // HoudiniEngineUnity.HEU_Curve/<>c__DisplayClass38_0
  #pragma pack(pop)
