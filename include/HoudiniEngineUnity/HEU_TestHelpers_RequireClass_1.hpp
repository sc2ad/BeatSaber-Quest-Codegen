...
namespace HoudiniEngineUnity {
  ...
  // Autogenerated type: HoudiniEngineUnity.HEU_TestHelpers/RequireClass`1
  ...
  }; // HoudiniEngineUnity.HEU_TestHelpers/RequireClass`1
  // Could not write size check! Type: HoudiniEngineUnity.HEU_TestHelpers/RequireClass`1 is generic, or has no fields that are valid for size checks!
}
