...
namespace HoudiniEngineUnity {
  ...
  class HEU_ParameterData : public ::Il2CppObject/*, public HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::HEU_ParameterData*>*/ {
    ...
    // Size: 0x8
    // Offset: 0x80
    ::Array<UnityEngine::GUIContent*>* choiceLabels;
    // Field size check
    static_assert(sizeof(::Array<UnityEngine::GUIContent*>*) == 0x8);
    // public System.String[] _choiceStringValues
    // Size: 0x8
    // Offset: 0x88
    ::Array<::Il2CppString*>* choiceStringValues;
    // Field size check
    static_assert(sizeof(::Array<::Il2CppString*>*) == 0x8);
    // public System.Int32[] _choiceIntValues
    // Size: 0x8
    // Offset: 0x90
    ::Array<int>* choiceIntValues;
    // Field size check
    static_assert(sizeof(::Array<int>*) == 0x8);
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Creating value type constructor for type: HEU_ParameterData
    HEU_ParameterData(int unityIndex_ = {}, ::Il2CppString* name_ = {}, ::Il2CppString* labelName_ = {}, ::Il2CppString* help_ = {}, System::Collections::Generic::List_1<int>* childParameterIDs_ = {}, int choiceValue_ = {}, ::Array<int>* intValues_ = {}, ::Array<float>* floatValues_ = {}, ::Array<::Il2CppString*>* stringValues_ = {}, bool toggle_ = {}, UnityEngine::Color color_ = {}, UnityEngine::Gradient* gradient_ = {}, UnityEngine::AnimationCurve* animCurve_ = {}, ::Array<UnityEngine::GUIContent*>* choiceLabels_ = {}, ::Array<::Il2CppString*>* choiceStringValues_ = {}, ::Array<int>* choiceIntValues_ = {}, HoudiniEngineUnity::HAPI_ParmInfo parmInfo_ = {}, bool showChildren_ = {}, ::Il2CppString* fileTypeInfo_ = {}, int folderListChildrenProcessed_ = {}, int tabSelectedIndex_ = {}, HoudiniEngineUnity::HEU_InputNode* paramInputNode_ = {}, bool hasAssetPathTag_ = {}) noexcept : unityIndex{unityIndex_}, name{name_}, labelName{labelName_}, help{help_}, childParameterIDs{childParameterIDs_}, choiceValue{choiceValue_}, intValues{intValues_}, floatValues{floatValues_}, stringValues{stringValues_}, toggle{toggle_}, color{color_}, gradient{gradient_}, animCurve{animCurve_}, choiceLabels{choiceLabels_}, choiceStringValues{choiceStringValues_}, choiceIntValues{choiceIntValues_}, parmInfo{parmInfo_}, showChildren{showChildren_}, fileTypeInfo{fileTypeInfo_}, folderListChildrenProcessed{folderListChildrenProcessed_}, tabSelectedIndex{tabSelectedIndex_}, paramInputNode{paramInputNode_}, hasAssetPathTag{hasAssetPathTag_} {}
