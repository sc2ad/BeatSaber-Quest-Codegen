...
namespace HoudiniEngineUnity {
  ...
  // Autogenerated type: HoudiniEngineUnity.HEU_GeneralUtility/GetAttributeArrayInputFunc`1
  // [TokenAttribute] Offset: FFFFFFFF
  template<typename T>
  class HEU_GeneralUtility::GetAttributeArrayInputFunc_1 : public System::MulticastDelegate {
    public:
    // Creating value type constructor for type: GetAttributeArrayInputFunc_1
    GetAttributeArrayInputFunc_1() noexcept {}
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::Array<T>*> items, int start, int end) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(geoID), ::il2cpp_utils::ExtractType(partID), ::il2cpp_utils::ExtractType(name), ::il2cpp_utils::ExtractType(info), ::il2cpp_utils::ExtractIndependentType<::Array<T>*&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(end)})));
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, geoID, partID, name, byref(info), byref(items), start, end);
    }
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(int geoID, int partID, ::Il2CppString* name, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::Array<T>*> items, int start, int end, System::AsyncCallback* callback, ::Il2CppObject* object) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "BeginInvoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(geoID), ::il2cpp_utils::ExtractType(partID), ::il2cpp_utils::ExtractType(name), ::il2cpp_utils::ExtractType(info), ::il2cpp_utils::ExtractIndependentType<::Array<T>*&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(end), ::il2cpp_utils::ExtractType(callback), ::il2cpp_utils::ExtractType(object)})));
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<System::IAsyncResult*, false>(___instance_arg, ___internal__method, geoID, partID, name, byref(info), byref(items), start, end, callback, object);
    }
    ...
    bool EndInvoke(ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> info, System::IAsyncResult* result) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, byref(info), result);
    }
  }; // HoudiniEngineUnity.HEU_GeneralUtility/GetAttributeArrayInputFunc`1
  // Could not write size check! Type: HoudiniEngineUnity.HEU_GeneralUtility/GetAttributeArrayInputFunc`1 is generic, or has no fields that are valid for size checks!
}
