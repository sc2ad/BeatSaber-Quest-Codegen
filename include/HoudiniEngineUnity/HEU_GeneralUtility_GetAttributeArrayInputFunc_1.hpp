...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeneralUtility::GetAttributeArrayInputFunc_1 : public ::System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int geoID, int partID, ::StringW name, ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::ArrayW<T>> items, int start, int end) {
    ...
    // Offset: 0xFFFFFFFF
    ::System::IAsyncResult* BeginInvoke(int geoID, int partID, ::StringW name, ByRef<::HoudiniEngineUnity::HAPI_AttributeInfo> info, ByRef<::ArrayW<T>> items, int start, int end, ::System::AsyncCallback* callback, ::Il2CppObject* object) {
