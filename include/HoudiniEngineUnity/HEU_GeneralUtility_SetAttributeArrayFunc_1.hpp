...
namespace HoudiniEngineUnity {
  ...
  // Autogenerated type: HoudiniEngineUnity.HEU_GeneralUtility/SetAttributeArrayFunc`1
  ...
  class HEU_GeneralUtility::SetAttributeArrayFunc_1 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::Array<T>* items, int start, int end) {
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::Array<T>* items, int start, int end, System::AsyncCallback* callback, ::Il2CppObject* object) {
  ...
  }; // HoudiniEngineUnity.HEU_GeneralUtility/SetAttributeArrayFunc`1
  // Could not write size check! Type: HoudiniEngineUnity.HEU_GeneralUtility/SetAttributeArrayFunc`1 is generic, or has no fields that are valid for size checks!
}
