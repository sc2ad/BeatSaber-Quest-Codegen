...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeneralUtility::SetAttributeArrayFunc_1 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::ArrayWrapper<T> items, int start, int end) {
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(int geoID, int partID, ::Il2CppString* attrName, ByRef<HoudiniEngineUnity::HAPI_AttributeInfo> attrInfo, ::ArrayWrapper<T> items, int start, int end, System::AsyncCallback* callback, ::Il2CppObject* object) {
