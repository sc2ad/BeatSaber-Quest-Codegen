...
namespace HoudiniEngineUnity {
  ...
  // Autogenerated type: HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1
  ...
  class HEU_GeneralUtility::GetArray1ArgDel_1 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int arg1, ByRef<::Array<T>*> data, int start, int length) {
      static auto ___internal__logger = ::Logger::get().WithContext("HoudiniEngineUnity::HEU_GeneralUtility::GetArray1ArgDel_1::Invoke");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(arg1), ::il2cpp_utils::ExtractIndependentType<::Array<T>*&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(length)})));
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, arg1, byref(data), start, length);
    }
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(int arg1, ByRef<::Array<T>*> data, int start, int length, System::AsyncCallback* callback, ::Il2CppObject* object) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<System::IAsyncResult*, false>(___instance_arg, ___internal__method, arg1, byref(data), start, length, callback, object);
    }
  ...
  }; // HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1
  // Could not write size check! Type: HoudiniEngineUnity.HEU_GeneralUtility/GetArray1ArgDel`1 is generic, or has no fields that are valid for size checks!
}
