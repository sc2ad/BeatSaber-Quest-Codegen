...
namespace HoudiniEngineUnity {
  ...
  class HEU_GeneralUtility::GetArray1ArgDel_1 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    bool Invoke(int arg1, ByRef<::ArrayWrapper<T>> data, int start, int length) {
      static auto ___internal__logger = ::Logger::get().WithContext("HoudiniEngineUnity::HEU_GeneralUtility::GetArray1ArgDel_1::Invoke");
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Invoke", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(arg1), ::il2cpp_utils::ExtractIndependentType<::ArrayWrapper<T>&>(), ::il2cpp_utils::ExtractType(start), ::il2cpp_utils::ExtractType(length)})));
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(int arg1, ByRef<::ArrayWrapper<T>> data, int start, int length, System::AsyncCallback* callback, ::Il2CppObject* object) {
