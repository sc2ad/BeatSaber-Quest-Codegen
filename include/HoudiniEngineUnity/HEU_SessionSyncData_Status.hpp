...
namespace HoudiniEngineUnity {
  // Size: 0x4
  #pragma pack(push, 1)
  // Autogenerated type: HoudiniEngineUnity.HEU_SessionSyncData/Status
  ...
  struct HEU_SessionSyncData::Status/*, public System::Enum*/ {
    ...
    // static field const value: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Stopped
    static constexpr const int Stopped = 0;
    // Get static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Stopped
    static HoudiniEngineUnity::HEU_SessionSyncData::Status _get_Stopped();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Stopped
    static void _set_Stopped(HoudiniEngineUnity::HEU_SessionSyncData::Status value);
    // static field const value: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Started
    static constexpr const int Started = 1;
    // Get static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Started
    static HoudiniEngineUnity::HEU_SessionSyncData::Status _get_Started();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Started
    static void _set_Started(HoudiniEngineUnity::HEU_SessionSyncData::Status value);
    // static field const value: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connecting
    static constexpr const int Connecting = 2;
    // Get static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connecting
    static HoudiniEngineUnity::HEU_SessionSyncData::Status _get_Connecting();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connecting
    static void _set_Connecting(HoudiniEngineUnity::HEU_SessionSyncData::Status value);
    // static field const value: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Initializing
    static constexpr const int Initializing = 3;
    // Get static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Initializing
    static HoudiniEngineUnity::HEU_SessionSyncData::Status _get_Initializing();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Initializing
    static void _set_Initializing(HoudiniEngineUnity::HEU_SessionSyncData::Status value);
    // static field const value: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connected
    static constexpr const int Connected = 4;
    // Get static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connected
    static HoudiniEngineUnity::HEU_SessionSyncData::Status _get_Connected();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionSyncData/Status Connected
