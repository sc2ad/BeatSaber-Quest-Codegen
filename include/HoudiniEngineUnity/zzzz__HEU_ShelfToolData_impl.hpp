...
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::GENERATOR{0};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::OPERATOR_SINGLE{1};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::OPERATOR_MULTI{2};
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType  ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType::BATCH{3};
...
constexpr void ::HoudiniEngineUnity::HEU_ShelfToolData::__set__toolType(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType>(value));
}
constexpr ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType ::HoudiniEngineUnity::HEU_ShelfToolData::__get__toolType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ShelfToolData__ToolType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
