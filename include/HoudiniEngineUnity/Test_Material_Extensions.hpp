...
namespace HoudiniEngineUnity {
  ...
  class Test_Material_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_Material[] ToTestObject(UnityEngine.Material[] self)
    // Offset: 0x25D0B40
    static ::Array<HoudiniEngineUnity::Test_Material*>* ToTestObject(::Array<UnityEngine::Material*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_Material*>* (*)(::Array<UnityEngine::Material*>*)>(&HoudiniEngineUnity::Test_Material_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
