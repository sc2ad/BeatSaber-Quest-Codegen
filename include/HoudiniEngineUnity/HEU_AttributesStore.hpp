...
namespace HoudiniEngineUnity {
  ...
  class HEU_AttributesStore : public UnityEngine::ScriptableObject/*, public HoudiniEngineUnity::IEquivable_1<HoudiniEngineUnity::HEU_AttributesStore*>*/ {
    ...
    // Size: 0x8
    // Offset: 0x48
    ::Array<UnityEngine::Vector3>* positionAttributeValues;
    // Field size check
    ...
    // Size: 0x8
    // Offset: 0x68
    ::Array<UnityEngine::Material*>* outputMaterials;
    // Field size check
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Creating value type constructor for type: HEU_AttributesStore
    HEU_AttributesStore(int geoID_ = {}, int partID_ = {}, ::Il2CppString* geoName_ = {}, System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_AttributeData*>* attributeDatas_ = {}, bool hasColorAttribute_ = {}, UnityEngine::Material* localMaterial_ = {}, UnityEngine::Transform* outputTransform_ = {}, ::Array<UnityEngine::Vector3>* positionAttributeValues_ = {}, ::Array<int>* vertexIndices_ = {}, UnityEngine::GameObject* outputGameObject_ = {}, UnityEngine::Mesh* outputMesh_ = {}, ::Array<UnityEngine::Material*>* outputMaterials_ = {}, UnityEngine::MeshCollider* outputCollider_ = {}, UnityEngine::Mesh* outputColliderMesh_ = {}, UnityEngine::MeshCollider* outputMeshCollider_ = {}, UnityEngine::MeshCollider* localMeshCollider_ = {}, bool outputMeshRendererInitiallyEnabled_ = {}, bool outputMeshColliderInitiallyEnabled_ = {}) noexcept : geoID{geoID_}, partID{partID_}, geoName{geoName_}, attributeDatas{attributeDatas_}, hasColorAttribute{hasColorAttribute_}, localMaterial{localMaterial_}, outputTransform{outputTransform_}, positionAttributeValues{positionAttributeValues_}, vertexIndices{vertexIndices_}, outputGameObject{outputGameObject_}, outputMesh{outputMesh_}, outputMaterials{outputMaterials_}, outputCollider{outputCollider_}, outputColliderMesh{outputColliderMesh_}, outputMeshCollider{outputMeshCollider_}, localMeshCollider{localMeshCollider_}, outputMeshRendererInitiallyEnabled{outputMeshRendererInitiallyEnabled_}, outputMeshColliderInitiallyEnabled{outputMeshColliderInitiallyEnabled_} {}
    ...
    ::Array<UnityEngine::Vector3>*& dyn__positionAttributeValues();
    // Get instance field reference: private System.Int32[] _vertexIndices
    ::Array<int>*& dyn__vertexIndices();
    ...
    ::Array<UnityEngine::Material*>*& dyn__outputMaterials();
    ...
    // Offset: 0x1441010
    static void SetAttributeEditValueInt(HoudiniEngineUnity::HEU_AttributeData* attributeData, int startIndex, ::Array<int>* values);
    ...
    // Offset: 0x14410A4
    static void SetAttributeEditValueFloat(HoudiniEngineUnity::HEU_AttributeData* attributeData, int startIndex, ::Array<float>* values);
    ...
    // Offset: 0x1441138
    static void SetAttributeEditValueString(HoudiniEngineUnity::HEU_AttributeData* attributeData, int startIndex, ::Array<::Il2CppString*>* values);
    ...
    // Offset: 0x1441F9C
    void GetPositionAttributeValues(ByRef<::Array<UnityEngine::Vector3>*> positionArray);
    // public System.Void GetVertexIndices(out System.Int32[] indices)
    // Offset: 0x1441FA8
    void GetVertexIndices(ByRef<::Array<int>*> indices);
    // static public HoudiniEngineUnity.HEU_AttributesStore/SetAttributeValueFunc GetAttributeSetValueFunction(HoudiniEngineUnity.HEU_AttributeData/AttributeType attrType, HoudiniEngineUnity.HEU_ToolsInfo/PaintMergeMode paintMergeMode)
    // Offset: 0x1441CE4
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_AttributeData*, int, ::Array<int>*)>(&HoudiniEngineUnity::HEU_AttributesStore::SetAttributeEditValueInt)> {
  static const MethodInfo* get() {
    static auto* attributeData = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_AttributeData")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_AttributeData*, int, ::Array<float>*)>(&HoudiniEngineUnity::HEU_AttributesStore::SetAttributeEditValueFloat)> {
  static const MethodInfo* get() {
    static auto* attributeData = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_AttributeData")->byval_arg;
    static auto* startIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_AttributeData*, int, ::Array<::Il2CppString*>*)>(&HoudiniEngineUnity::HEU_AttributesStore::SetAttributeEditValueString)> {
  static const MethodInfo* get() {
    static auto* attributeData = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_AttributeData")->byval_arg;
    static auto* startIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_AttributesStore::*)(ByRef<::Array<UnityEngine::Vector3>*>)>(&HoudiniEngineUnity::HEU_AttributesStore::GetPositionAttributeValues)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HoudiniEngineUnity::HEU_AttributesStore::*)(ByRef<::Array<int>*>)>(&HoudiniEngineUnity::HEU_AttributesStore::GetVertexIndices)> {
  static const MethodInfo* get() {
