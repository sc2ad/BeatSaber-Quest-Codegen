...
namespace HoudiniEngineUnity {
struct ____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode;
}
namespace UnityEngine {
struct Vector3;
}
...
namespace HoudiniEngineUnity {
class ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc;
}
...
class CORDL_TYPE ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc", modifiers: " const&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc(____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc", modifiers: "&&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc(____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc& operator=(____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc&& o) noexcept = default;
  constexpr ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc& operator=(____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc const& o) noexcept = default;
...
explicit ____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using SetAttributeValueFunc = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc;
...
/// @brief Method PaintAttribute addr 0x200e60c size 0x54 virtual false final false
 void PaintAttribute(::HoudiniEngineUnity::HEU_AttributeData attributeData, ::HoudiniEngineUnity::HEU_ToolsInfo sourceTools, int32_t attributeIndex, float_t paintFactor, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc setAttrFunc) ;
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc GetAttributeSetValueFunction(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributeData__AttributeType attrType, ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_ToolsInfo__PaintMergeMode paintMergeMode) ;
...
NEED_NO_BOX(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_AttributesStore__SetAttributeValueFunc, "HoudiniEngineUnity", "HEU_AttributesStore/SetAttributeValueFunc");
