...
namespace HoudiniEngineUnity {
  ...
  class Test_MeshFilter_Extensions : public ::Il2CppObject {
    ...
    // static public HoudiniEngineUnity.Test_MeshFilter[] ToTestObject(UnityEngine.MeshFilter[] self)
    // Offset: 0x25D1590
    static ::Array<HoudiniEngineUnity::Test_MeshFilter*>* ToTestObject(::Array<UnityEngine::MeshFilter*>* self);
...
// Il2CppName: ToTestObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<HoudiniEngineUnity::Test_MeshFilter*>* (*)(::Array<UnityEngine::MeshFilter*>*)>(&HoudiniEngineUnity::Test_MeshFilter_Extensions::ToTestObject)> {
  static const MethodInfo* get() {
