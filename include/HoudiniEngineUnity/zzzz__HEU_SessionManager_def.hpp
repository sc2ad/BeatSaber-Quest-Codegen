...
namespace HoudiniEngineUnity {
class ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate;
}
...
class CORDL_TYPE ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate", modifiers: " const&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate(____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate", modifiers: "&&", def_value: None }]
constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate(____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate& operator=(____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate&& o) noexcept = default;
  constexpr ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate& operator=(____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate const& o) noexcept = default;
...
explicit ____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using CreateSessionFromTypeDelegate = ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate;
...
static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate __declspec(property(get=__get__createSessionFromTypeDelegate, put=__set__createSessionFromTypeDelegate))  _createSessionFromTypeDelegate;

static void __set__createSessionFromTypeDelegate(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate value) ;

static ::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate __get__createSessionFromTypeDelegate() ;
...
NEED_NO_BOX(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate);
DEFINE_IL2CPP_ARG_TYPE(::HoudiniEngineUnity::____HoudiniEngineUnity__HEU_SessionManager__CreateSessionFromTypeDelegate, "HoudiniEngineUnity", "HEU_SessionManager/CreateSessionFromTypeDelegate");
