...
namespace HoudiniEngineUnity {
  ...
  class HEU_SessionManager : public ::Il2CppObject {
    ...
    // Get static field: static public HoudiniEngineUnity.HEU_SessionManager/CreateSessionFromTypeDelegate _createSessionFromTypeDelegate
    static HoudiniEngineUnity::HEU_SessionManager::CreateSessionFromTypeDelegate* _get__createSessionFromTypeDelegate();
    // Set static field: static public HoudiniEngineUnity.HEU_SessionManager/CreateSessionFromTypeDelegate _createSessionFromTypeDelegate
    ...
    // Offset: 0x17D5400
    static ::Array<::Il2CppString*>* GetStringValuesFromStringIndices(::Array<int>* strIndices);
    ...
    // Offset: 0x17D55A8
    static ::Array<::Il2CppString*>* GetGroupNames(HoudiniEngineUnity::HEU_SessionBase* session, int nodeID, int partID, HoudiniEngineUnity::HAPI_GroupType groupType, bool isInstanced);
    ...
    // Offset: 0x17D5804
    static bool GetGroupMembership(HoudiniEngineUnity::HEU_SessionBase* session, int nodeID, int partID, HoudiniEngineUnity::HAPI_GroupType groupType, ::Il2CppString* groupName, ByRef<::Array<int>*> membership, bool isInstanced);
    ...
    // Offset: 0x17D5B44
    static bool GetComposedChildNodeList(HoudiniEngineUnity::HEU_SessionBase* session, int parentNodeID, int nodeTypeFilter, int nodeFlagFilter, bool bRecursive, ByRef<::Array<int>*> childNodeIDs);
    ...
    // Offset: 0x17D5C44
    static bool GetComposedObjectListMemorySafe(HoudiniEngineUnity::HEU_SessionBase* session, int nodeID, ByRef<::Array<HoudiniEngineUnity::HAPI_ObjectInfo>*> objectInfos, int start, int length);
    ...
    // Offset: 0x17D5CFC
    static bool GetComposedObjectTransformsMemorySafe(HoudiniEngineUnity::HEU_SessionBase* session, int nodeID, HoudiniEngineUnity::HAPI_RSTOrder rstOrder, ByRef<::Array<HoudiniEngineUnity::HAPI_Transform>*> transforms, int start, int length);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<::Il2CppString*>* (*)(::Array<int>*)>(&HoudiniEngineUnity::HEU_SessionManager::GetStringValuesFromStringIndices)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<::Il2CppString*>* (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, HoudiniEngineUnity::HAPI_GroupType, bool)>(&HoudiniEngineUnity::HEU_SessionManager::GetGroupNames)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, HoudiniEngineUnity::HAPI_GroupType, ::Il2CppString*, ByRef<::Array<int>*>, bool)>(&HoudiniEngineUnity::HEU_SessionManager::GetGroupMembership)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* nodeID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* partID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(HoudiniEngineUnity::HEU_SessionBase*, int, int, int, bool, ByRef<::Array<int>*>)>(&HoudiniEngineUnity::HEU_SessionManager::GetComposedChildNodeList)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(HoudiniEngineUnity::HEU_SessionBase*, int, ByRef<::Array<HoudiniEngineUnity::HAPI_ObjectInfo>*>, int, int)>(&HoudiniEngineUnity::HEU_SessionManager::GetComposedObjectListMemorySafe)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* nodeID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(HoudiniEngineUnity::HEU_SessionBase*, int, HoudiniEngineUnity::HAPI_RSTOrder, ByRef<::Array<HoudiniEngineUnity::HAPI_Transform>*>, int, int)>(&HoudiniEngineUnity::HEU_SessionManager::GetComposedObjectTransformsMemorySafe)> {
  static const MethodInfo* get() {
    static auto* session = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_SessionBase")->byval_arg;
    static auto* nodeID = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
