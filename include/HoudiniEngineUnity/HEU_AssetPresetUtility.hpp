...
namespace HoudiniEngineUnity {
  ...
  class HEU_AssetPresetUtility : public ::Il2CppObject {
    ...
    static ::Array<::Il2CppChar>* _get_PRESET_IDENTIFIER();
    // Set static field: static public System.Char[] PRESET_IDENTIFIER
    static void _set_PRESET_IDENTIFIER(::Array<::Il2CppChar>* value);
    ...
    // Offset: 0x146503C
    static void SaveAssetPresetToFile(HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::Il2CppString* filePath);
    ...
    // Offset: 0x146560C
    static void LoadPresetFileIntoAssetAndCook(HoudiniEngineUnity::HEU_HoudiniAsset* asset, ::Il2CppString* filePath);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_HoudiniAsset*, ::Il2CppString*)>(&HoudiniEngineUnity::HEU_AssetPresetUtility::SaveAssetPresetToFile)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(HoudiniEngineUnity::HEU_HoudiniAsset*, ::Il2CppString*)>(&HoudiniEngineUnity::HEU_AssetPresetUtility::LoadPresetFileIntoAssetAndCook)> {
  static const MethodInfo* get() {
    static auto* asset = &::il2cpp_utils::GetClassFromName("HoudiniEngineUnity", "HEU_HoudiniAsset")->byval_arg;
    static auto* filePath = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
