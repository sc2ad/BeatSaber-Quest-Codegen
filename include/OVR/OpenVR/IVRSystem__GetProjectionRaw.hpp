...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE04CC
  class IVRSystem::_GetProjectionRaw : public System::MulticastDelegate {
    ...
    // Offset: 0x1EEA1F8
    void Invoke_NEW(OVR::OpenVR::EVREye eEye, float& pfLeft, float& pfRight, float& pfTop, float& pfBottom);
    ...
    // Offset: 0x1EEA4E8
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREye eEye, float& pfLeft, float& pfRight, float& pfTop, float& pfBottom, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1EEA5EC
    void EndInvoke_NEW(float& pfLeft, float& pfRight, float& pfTop, float& pfBottom, System::IAsyncResult* result);
