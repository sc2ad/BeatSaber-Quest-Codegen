...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1228
  class IVROverlay::_GetOverlayErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1D42FDC
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVROverlayError error);
    ...
    // Offset: 0x1D43254
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVROverlayError error, System::AsyncCallback* callback, ::Il2CppObject* object);
