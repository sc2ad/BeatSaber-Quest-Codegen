...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1CDC
  class IVRIOBuffer::_Close : public System::MulticastDelegate {
    ...
    // Offset: 0x1D392F8
    OVR::OpenVR::EIOBufferError Invoke_NEW(uint64_t ulBuffer);
    // public System.IAsyncResult BeginInvoke(System.UInt64 ulBuffer, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1D3955C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulBuffer, System::AsyncCallback* callback, ::Il2CppObject* object);
