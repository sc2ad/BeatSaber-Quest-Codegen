...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE15AC
  class IVROverlay::_SetOverlayNeighbor : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED4D78
    OVR::OpenVR::EVROverlayError Invoke_NEW(OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom, uint64_t ulTo);
    ...
    // Offset: 0x1ED5030
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom, uint64_t ulTo, System::AsyncCallback* callback, ::Il2CppObject* object);
