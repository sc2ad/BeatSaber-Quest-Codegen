...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1BEC
  class IVRInput::_GetPoseActionData : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3CC08
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t action, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, float fPredictedSecondsFromNow, OVR::OpenVR::InputPoseActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice);
    ...
    // Offset: 0x1D3CEFC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t action, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, float fPredictedSecondsFromNow, OVR::OpenVR::InputPoseActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRInputError EndInvoke(ref OVR.OpenVR.InputPoseActionData_t pActionData, System.IAsyncResult result)
    // Offset: 0x1D3D028
    OVR::OpenVR::EVRInputError EndInvoke_NEW(OVR::OpenVR::InputPoseActionData_t& pActionData, System::IAsyncResult* result);
