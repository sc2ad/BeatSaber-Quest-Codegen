...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D84BA0
  class IVRCompositor::_UnlockGLSharedTextureForAccess : public System::MulticastDelegate {
    ...
    static IVRCompositor::_UnlockGLSharedTextureForAccess* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_UnlockGLSharedTextureForAccess").WithContext(".ctor");
