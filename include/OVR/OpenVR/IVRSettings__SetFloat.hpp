...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE19D0
  class IVRSettings::_SetFloat : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE2DE4
    void Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, float flValue, OVR::OpenVR::EVRSettingsError& peError);
    ...
    // Offset: 0x1EE3220
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, float flValue, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
