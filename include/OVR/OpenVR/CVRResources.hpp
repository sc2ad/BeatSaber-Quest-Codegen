...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRResources), 16 + sizeof(OVR::OpenVR::IVRResources) + ((16 + sizeof(OVR::OpenVR::IVRResources)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVRResources)) % 8) : 0)> __OVR_OpenVR_CVRResourcesSizeCheck;
}
