...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0E18
  class IVRCompositor::_SetTrackingSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1D36578
    void Invoke_NEW(OVR::OpenVR::ETrackingUniverseOrigin eOrigin);
    ...
    // Offset: 0x1D367E8
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::ETrackingUniverseOrigin eOrigin, System::AsyncCallback* callback, ::Il2CppObject* object);
