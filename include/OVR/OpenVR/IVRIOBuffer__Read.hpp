...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1CF0
  class IVRIOBuffer::_Read : public System::MulticastDelegate {
    ...
    // Offset: 0x1D39F18
    OVR::OpenVR::EIOBufferError Invoke_NEW(uint64_t ulBuffer, System::IntPtr pDst, uint unBytes, uint& punRead);
    ...
    // Offset: 0x1D3A1D0
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulBuffer, System::IntPtr pDst, uint unBytes, uint& punRead, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EIOBufferError EndInvoke(ref System.UInt32 punRead, System.IAsyncResult result)
    // Offset: 0x1D3A2B8
    OVR::OpenVR::EIOBufferError EndInvoke_NEW(uint& punRead, System::IAsyncResult* result);
