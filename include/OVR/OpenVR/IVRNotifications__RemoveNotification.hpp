...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE196C
  class IVRNotifications::_RemoveNotification : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3F4B4
    OVR::OpenVR::EVRNotificationError Invoke_NEW(uint notificationId);
    // public System.IAsyncResult BeginInvoke(System.UInt32 notificationId, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1D3F71C
    System::IAsyncResult* BeginInvoke_NEW(uint notificationId, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRNotificationError EndInvoke(System.IAsyncResult result)
    // Offset: 0x1D3F7A8
    OVR::OpenVR::EVRNotificationError EndInvoke_NEW(System::IAsyncResult* result);
