...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VROverlayIntersectionMaskPrimitive_Data_t), 0 + sizeof(OVR::OpenVR::IntersectionMaskCircle_t) + ((0 + sizeof(OVR::OpenVR::IntersectionMaskCircle_t)) % 8 != 0 ? (8 - (0 + sizeof(OVR::OpenVR::IntersectionMaskCircle_t)) % 8) : 0)> __OVR_OpenVR_VROverlayIntersectionMaskPrimitive_Data_tSizeCheck;
}
