...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0508
  class IVRSystem::_GetTimeSinceLastVsync : public System::MulticastDelegate {
    ...
    // Offset: 0x1EEBA24
    bool Invoke_NEW(float& pfSecondsSinceLastVsync, uint64_t& pulFrameCounter);
    ...
    // Offset: 0x1EEBC9C
    System::IAsyncResult* BeginInvoke_NEW(float& pfSecondsSinceLastVsync, uint64_t& pulFrameCounter, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1EEBD50
    bool EndInvoke_NEW(float& pfSecondsSinceLastVsync, uint64_t& pulFrameCounter, System::IAsyncResult* result);
