...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE05E4
  class IVRSystem::_GetTrackedDeviceActivityLevel : public System::MulticastDelegate {
    ...
    // Offset: 0x1EEBD98
    OVR::OpenVR::EDeviceActivityLevel Invoke_NEW(uint unDeviceId);
    // public System.IAsyncResult BeginInvoke(System.UInt32 unDeviceId, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1EEC000
    System::IAsyncResult* BeginInvoke_NEW(uint unDeviceId, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EDeviceActivityLevel EndInvoke(System.IAsyncResult result)
    // Offset: 0x1EEC08C
    OVR::OpenVR::EDeviceActivityLevel EndInvoke_NEW(System::IAsyncResult* result);
