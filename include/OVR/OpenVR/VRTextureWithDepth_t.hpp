...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VRTextureWithDepth_t), 0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t) + ((0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t)) % 8 != 0 ? (8 - (0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t)) % 8) : 0)> __OVR_OpenVR_VRTextureWithDepth_tSizeCheck;
}
