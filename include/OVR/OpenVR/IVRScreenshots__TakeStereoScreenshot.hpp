...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1AD4
  class IVRScreenshots::_TakeStereoScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE003C
    OVR::OpenVR::EVRScreenshotError Invoke_NEW(uint& pOutScreenshotHandle, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename);
    ...
    // Offset: 0x1EE02CC
    System::IAsyncResult* BeginInvoke_NEW(uint& pOutScreenshotHandle, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRScreenshotError EndInvoke(ref System.UInt32 pOutScreenshotHandle, System.IAsyncResult result)
    // Offset: 0x1EE0374
    OVR::OpenVR::EVRScreenshotError EndInvoke_NEW(uint& pOutScreenshotHandle, System::IAsyncResult* result);
