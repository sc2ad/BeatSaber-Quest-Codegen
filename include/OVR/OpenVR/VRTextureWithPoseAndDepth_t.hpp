...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VRTextureWithPoseAndDepth_t), 0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t) + ((0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t)) % 8 != 0 ? (8 - (0 + sizeof(OVR::OpenVR::VRTextureDepthInfo_t)) % 8) : 0)> __OVR_OpenVR_VRTextureWithPoseAndDepth_tSizeCheck;
}
