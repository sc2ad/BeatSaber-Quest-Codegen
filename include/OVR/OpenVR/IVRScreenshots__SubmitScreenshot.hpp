...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1AE8
  class IVRScreenshots::_SubmitScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDFC88
    OVR::OpenVR::EVRScreenshotError Invoke_NEW(uint screenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::Il2CppString* pchSourcePreviewFilename, ::Il2CppString* pchSourceVRFilename);
    ...
    // Offset: 0x1EDFF44
    System::IAsyncResult* BeginInvoke_NEW(uint screenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::Il2CppString* pchSourcePreviewFilename, ::Il2CppString* pchSourceVRFilename, System::AsyncCallback* callback, ::Il2CppObject* object);
