...
namespace OVR::OpenVR {
  ...
  class IVRScreenshots::_SubmitScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x169B218
    OVR::OpenVR::EVRScreenshotError Invoke(uint screenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename);
    ...
    // Offset: 0x169B4E0
    System::IAsyncResult* BeginInvoke(uint screenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename, System::AsyncCallback* callback, ::CsObject* object);
