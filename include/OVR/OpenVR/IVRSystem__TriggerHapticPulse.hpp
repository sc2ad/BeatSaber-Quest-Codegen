...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0774
  class IVRSystem::_TriggerHapticPulse : public System::MulticastDelegate {
    ...
    // Offset: 0x1EEEB04
    void Invoke_NEW(uint unControllerDeviceIndex, uint unAxisId, uint16_t usDurationMicroSec);
    ...
    // Offset: 0x1EEED9C
    System::IAsyncResult* BeginInvoke_NEW(uint unControllerDeviceIndex, uint unAxisId, uint16_t usDurationMicroSec, System::AsyncCallback* callback, ::Il2CppObject* object);
