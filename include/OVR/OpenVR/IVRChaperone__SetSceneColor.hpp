...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0C38
  class IVRChaperone::_SetSceneColor : public System::MulticastDelegate {
    ...
    // Offset: 0x13F2540
    void Invoke_NEW(OVR::OpenVR::HmdColor_t color);
    // public System.IAsyncResult BeginInvoke(OVR.OpenVR.HmdColor_t color, System.AsyncCallback callback, System.Object object)
    // Offset: 0x13FCD24
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::HmdColor_t color, System::AsyncCallback* callback, ::Il2CppObject* object);
