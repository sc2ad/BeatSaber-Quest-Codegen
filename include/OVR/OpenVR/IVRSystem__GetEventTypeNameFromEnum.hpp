...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0724
  class IVRSystem::_GetEventTypeNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE8458
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVREventType eType);
    // public System.IAsyncResult BeginInvoke(OVR.OpenVR.EVREventType eType, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1EE86D0
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREventType eType, System::AsyncCallback* callback, ::Il2CppObject* object);
