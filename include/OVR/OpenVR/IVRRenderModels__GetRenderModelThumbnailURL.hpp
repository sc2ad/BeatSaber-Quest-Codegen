...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE191C
  class IVRRenderModels::_GetRenderModelThumbnailURL : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDCAB4
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchThumbnailURL, uint unThumbnailURLLen, OVR::OpenVR::EVRRenderModelError& peError);
    ...
    // Offset: 0x1EDCEF4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchThumbnailURL, uint unThumbnailURLLen, OVR::OpenVR::EVRRenderModelError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref OVR.OpenVR.EVRRenderModelError peError, System.IAsyncResult result)
    // Offset: 0x1EDCFBC
    uint EndInvoke_NEW(OVR::OpenVR::EVRRenderModelError& peError, System::IAsyncResult* result);
