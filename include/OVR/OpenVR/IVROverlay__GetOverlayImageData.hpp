...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1214
  class IVROverlay::_GetOverlayImageData : public System::MulticastDelegate {
    ...
    // Offset: 0x1D43A50
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unBufferSize, uint& punWidth, uint& punHeight);
    ...
    // Offset: 0x1D43D24
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unBufferSize, uint& punWidth, uint& punHeight, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D43E28
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint& punWidth, uint& punHeight, System::IAsyncResult* result);
