...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D84CA4
  class IVROverlay::_GetOverlayImageData : public System::MulticastDelegate {
    ...
    static IVROverlay::_GetOverlayImageData* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetOverlayImageData").WithContext(".ctor");
