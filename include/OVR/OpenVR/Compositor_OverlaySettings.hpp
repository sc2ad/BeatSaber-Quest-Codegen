...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(Compositor_OverlaySettings), 48 + sizeof(OVR::OpenVR::HmdMatrix44_t) + ((48 + sizeof(OVR::OpenVR::HmdMatrix44_t)) % 8 != 0 ? (8 - (48 + sizeof(OVR::OpenVR::HmdMatrix44_t)) % 8) : 0)> __OVR_OpenVR_Compositor_OverlaySettingsSizeCheck;
}
