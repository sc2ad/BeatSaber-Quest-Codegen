...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRRenderModels::GetComponentStateUnion), 0 + sizeof(void*) + ((0 + sizeof(void*)) % 8 != 0 ? (8 - (0 + sizeof(void*)) % 8) : 0)> __OVR_OpenVR_CVRRenderModels_GetComponentStateUnionSizeCheck;
}
