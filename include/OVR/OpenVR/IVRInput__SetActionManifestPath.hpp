...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1B60
  class IVRInput::_SetActionManifestPath : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3DD44
    OVR::OpenVR::EVRInputError Invoke_NEW(::Il2CppString* pchActionManifestPath);
    ...
    // Offset: 0x1D3E0E0
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchActionManifestPath, System::AsyncCallback* callback, ::Il2CppObject* object);
