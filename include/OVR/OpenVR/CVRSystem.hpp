...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRSystem), 16 + sizeof(OVR::OpenVR::IVRSystem) + ((16 + sizeof(OVR::OpenVR::IVRSystem)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVRSystem)) % 8) : 0)> __OVR_OpenVR_CVRSystemSizeCheck;
}
