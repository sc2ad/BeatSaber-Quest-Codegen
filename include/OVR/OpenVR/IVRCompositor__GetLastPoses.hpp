...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<OVR::OpenVR::EVRCompositorError (OVR::OpenVR::IVRCompositor::_GetLastPoses::*)(ByRef<::ArrayWrapper<OVR::OpenVR::TrackedDevicePose_t>>, uint, ByRef<::ArrayWrapper<OVR::OpenVR::TrackedDevicePose_t>>, uint)>(&OVR::OpenVR::IVRCompositor::_GetLastPoses::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRCompositor::_GetLastPoses::*)(ByRef<::ArrayWrapper<OVR::OpenVR::TrackedDevicePose_t>>, uint, ByRef<::ArrayWrapper<OVR::OpenVR::TrackedDevicePose_t>>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRCompositor::_GetLastPoses::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pRenderPoseArray = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "TrackedDevicePose_t")), 1)->this_arg;
    static auto* unRenderPoseArrayCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* pGamePoseArray = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "TrackedDevicePose_t")), 1)->this_arg;
