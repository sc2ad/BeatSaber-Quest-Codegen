...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1A48
  class IVRSettings::_RemoveSection : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE23EC
    void Invoke_NEW(::Il2CppString* pchSection, OVR::OpenVR::EVRSettingsError& peError);
    ...
    // Offset: 0x1EE27D4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref OVR.OpenVR.EVRSettingsError peError, System.IAsyncResult result)
    // Offset: 0x1EE2870
    void EndInvoke_NEW(OVR::OpenVR::EVRSettingsError& peError, System::IAsyncResult* result);
