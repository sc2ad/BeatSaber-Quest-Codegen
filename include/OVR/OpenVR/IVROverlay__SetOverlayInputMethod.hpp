...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_SetOverlayInputMethod : public System::MulticastDelegate {
    ...
    // Offset: 0x169BD74
    static IVROverlay::_SetOverlayInputMethod* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x169C00C
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayInputMethod eInputMethod, System::AsyncCallback* callback, ::CsObject* object);
