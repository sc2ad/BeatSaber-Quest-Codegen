...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1520
  class IVROverlay::_SetOverlayInputMethod : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED3F54
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayInputMethod eInputMethod);
    ...
    // Offset: 0x1ED41D8
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayInputMethod eInputMethod, System::AsyncCallback* callback, ::Il2CppObject* object);
