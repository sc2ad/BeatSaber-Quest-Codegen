...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VREvent_SeatedZeroPoseReset_t), 0 + sizeof(bool) + ((0 + sizeof(bool)) % 8 != 0 ? (8 - (0 + sizeof(bool)) % 8) : 0)> __OVR_OpenVR_VREvent_SeatedZeroPoseReset_tSizeCheck;
}
