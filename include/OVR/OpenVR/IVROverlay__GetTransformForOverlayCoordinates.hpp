...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE14E4
  class IVROverlay::_GetTransformForOverlayCoordinates : public System::MulticastDelegate {
    ...
    // Offset: 0x1D48368
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::ETrackingUniverseOrigin eTrackingOrigin, OVR::OpenVR::HmdVector2_t coordinatesInOverlay, OVR::OpenVR::HmdMatrix34_t& pmatTransform);
    ...
    // Offset: 0x1D4863C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::ETrackingUniverseOrigin eTrackingOrigin, OVR::OpenVR::HmdVector2_t coordinatesInOverlay, OVR::OpenVR::HmdMatrix34_t& pmatTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref OVR.OpenVR.HmdMatrix34_t pmatTransform, System.IAsyncResult result)
    // Offset: 0x1D4872C
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::HmdMatrix34_t& pmatTransform, System::IAsyncResult* result);
