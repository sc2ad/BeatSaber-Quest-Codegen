...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_GetOverlayFlag : public System::MulticastDelegate {
    ...
    // Offset: 0x150AFD4
    static IVROverlay::_GetOverlayFlag* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x150B280
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayFlags eOverlayFlag, bool& pbEnabled, System::AsyncCallback* callback, ::CsObject* object);
