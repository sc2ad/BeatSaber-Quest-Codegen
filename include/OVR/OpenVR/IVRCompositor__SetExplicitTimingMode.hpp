...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE114C
  class IVRCompositor::_SetExplicitTimingMode : public System::MulticastDelegate {
    ...
    // Offset: 0x1D35F10
    void Invoke_NEW(OVR::OpenVR::EVRCompositorTimingMode eTimingMode);
    ...
    // Offset: 0x1D36180
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRCompositorTimingMode eTimingMode, System::AsyncCallback* callback, ::Il2CppObject* object);
