...
namespace OVR::OpenVR {
  ...
  class CVRInput : public ::CsObject {
    public:
    ...
    // Offset: 0xEB848C
    OVR::OpenVR::EVRInputError SetActionManifestPath(::CsString* pchActionManifestPath);
    // public OVR.OpenVR.EVRInputError GetActionSetHandle(System.String pchActionSetName, System.UInt64 pHandle)
    // Offset: 0xEB84A8
    OVR::OpenVR::EVRInputError GetActionSetHandle(::CsString* pchActionSetName, uint64_t& pHandle);
    // public OVR.OpenVR.EVRInputError GetActionHandle(System.String pchActionName, System.UInt64 pHandle)
    // Offset: 0xEB84C8
    OVR::OpenVR::EVRInputError GetActionHandle(::CsString* pchActionName, uint64_t& pHandle);
    // public OVR.OpenVR.EVRInputError GetInputSourceHandle(System.String pchInputSourcePath, System.UInt64 pHandle)
    // Offset: 0xEB84E8
    OVR::OpenVR::EVRInputError GetInputSourceHandle(::CsString* pchInputSourcePath, uint64_t& pHandle);
