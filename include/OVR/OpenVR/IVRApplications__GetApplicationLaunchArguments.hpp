...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0B48
  class IVRApplications::_GetApplicationLaunchArguments : public System::MulticastDelegate {
    ...
    // Offset: 0x13F0280
    uint Invoke_NEW(uint unHandle, System::Text::StringBuilder* pchArgs, uint unArgs);
    ...
    // Offset: 0x13FB7F4
    System::IAsyncResult* BeginInvoke_NEW(uint unHandle, System::Text::StringBuilder* pchArgs, uint unArgs, System::AsyncCallback* callback, ::Il2CppObject* object);
