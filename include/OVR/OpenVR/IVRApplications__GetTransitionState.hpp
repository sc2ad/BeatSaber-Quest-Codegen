...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0B70
  class IVRApplications::_GetTransitionState : public System::MulticastDelegate {
    ...
    // Offset: 0x13F0964
    OVR::OpenVR::EVRApplicationTransitionState Invoke_NEW();
    ...
    // Offset: 0x13FC208
    OVR::OpenVR::EVRApplicationTransitionState EndInvoke_NEW(System::IAsyncResult* result);
