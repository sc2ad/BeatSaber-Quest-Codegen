...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1638
  class IVROverlay::_SetOverlayFromFile : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED3C00
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchFilePath);
    ...
    // Offset: 0x1ED3E84
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchFilePath, System::AsyncCallback* callback, ::Il2CppObject* object);
