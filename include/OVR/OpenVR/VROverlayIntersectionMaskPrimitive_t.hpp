...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VROverlayIntersectionMaskPrimitive_t), 4 + sizeof(OVR::OpenVR::VROverlayIntersectionMaskPrimitive_Data_t) + ((4 + sizeof(OVR::OpenVR::VROverlayIntersectionMaskPrimitive_Data_t)) % 8 != 0 ? (8 - (4 + sizeof(OVR::OpenVR::VROverlayIntersectionMaskPrimitive_Data_t)) % 8) : 0)> __OVR_OpenVR_VROverlayIntersectionMaskPrimitive_tSizeCheck;
}
