...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE08B4
  class IVRTrackedCamera::_GetCameraFrameSize : public System::MulticastDelegate {
    ...
    // Offset: 0x112E8F0
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, uint& pnWidth, uint& pnHeight, uint& pnFrameBufferSize);
    ...
    // Offset: 0x112EBC8
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, uint& pnWidth, uint& pnHeight, uint& pnFrameBufferSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x112ECCC
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(uint& pnWidth, uint& pnHeight, uint& pnFrameBufferSize, System::IAsyncResult* result);
