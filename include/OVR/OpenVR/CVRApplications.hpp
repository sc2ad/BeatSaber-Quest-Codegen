...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRApplications), 16 + sizeof(OVR::OpenVR::IVRApplications) + ((16 + sizeof(OVR::OpenVR::IVRApplications)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVRApplications)) % 8) : 0)> __OVR_OpenVR_CVRApplicationsSizeCheck;
}
