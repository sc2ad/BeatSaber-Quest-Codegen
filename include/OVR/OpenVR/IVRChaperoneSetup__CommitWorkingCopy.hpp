...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0C88
  class IVRChaperoneSetup::_CommitWorkingCopy : public System::MulticastDelegate {
    ...
    // Offset: 0x13F3094
    bool Invoke_NEW(OVR::OpenVR::EChaperoneConfigFile configFile);
    ...
    // Offset: 0x13FCDD0
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EChaperoneConfigFile configFile, System::AsyncCallback* callback, ::Il2CppObject* object);
