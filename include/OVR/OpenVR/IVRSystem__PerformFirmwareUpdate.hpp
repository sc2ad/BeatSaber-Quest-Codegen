...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0814
  class IVRSystem::_PerformFirmwareUpdate : public System::MulticastDelegate {
    ...
    // Offset: 0x1EED5A8
    OVR::OpenVR::EVRFirmwareError Invoke_NEW(uint unDeviceIndex);
    ...
    // Offset: 0x1EED89C
    OVR::OpenVR::EVRFirmwareError EndInvoke_NEW(System::IAsyncResult* result);
