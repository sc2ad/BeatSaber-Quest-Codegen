...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1B74
  class IVRInput::_GetActionSetHandle : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3B340
    OVR::OpenVR::EVRInputError Invoke_NEW(::Il2CppString* pchActionSetName, uint64_t& pHandle);
    ...
    // Offset: 0x1D3B730
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchActionSetName, uint64_t& pHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
