...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1188
  class IVROverlay::_CreateOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1D40668
    OVR::OpenVR::EVROverlayError Invoke_NEW(::Il2CppString* pchOverlayKey, ::Il2CppString* pchOverlayName, uint64_t& pOverlayHandle);
