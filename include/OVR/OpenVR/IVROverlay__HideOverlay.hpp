...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D84F4C
  class IVROverlay::_HideOverlay : public System::MulticastDelegate {
    ...
    static IVROverlay::_HideOverlay* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_HideOverlay").WithContext(".ctor");
