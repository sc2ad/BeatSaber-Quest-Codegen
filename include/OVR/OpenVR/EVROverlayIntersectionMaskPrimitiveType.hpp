...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(EVROverlayIntersectionMaskPrimitiveType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __OVR_OpenVR_EVROverlayIntersectionMaskPrimitiveTypeSizeCheck;
}
