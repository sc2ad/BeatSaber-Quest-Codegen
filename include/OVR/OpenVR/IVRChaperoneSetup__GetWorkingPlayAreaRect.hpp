...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0CC4
  class IVRChaperoneSetup::_GetWorkingPlayAreaRect : public System::MulticastDelegate {
    ...
    // Offset: 0x13F37E4
    bool Invoke_NEW(OVR::OpenVR::HmdQuad_t& rect);
    // public System.IAsyncResult BeginInvoke(ref OVR.OpenVR.HmdQuad_t rect, System.AsyncCallback callback, System.Object object)
    // Offset: 0x13FD3E8
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::HmdQuad_t& rect, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref OVR.OpenVR.HmdQuad_t rect, System.IAsyncResult result)
    // Offset: 0x13FD47C
    bool EndInvoke_NEW(OVR::OpenVR::HmdQuad_t& rect, System::IAsyncResult* result);
