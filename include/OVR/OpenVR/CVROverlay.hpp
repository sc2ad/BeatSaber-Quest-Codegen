...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVROverlay), 16 + sizeof(OVR::OpenVR::IVROverlay) + ((16 + sizeof(OVR::OpenVR::IVROverlay)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVROverlay)) % 8) : 0)> __OVR_OpenVR_CVROverlaySizeCheck;
}
