...
namespace OVR::OpenVR {
  ...
  class CVROverlay : public ::CsObject {
    ...
    // Offset: 0xEB8938
    OVR::OpenVR::EVROverlayError FindOverlay(::CsString* pchOverlayKey, uint64_t& pOverlayHandle);
    ...
    // Offset: 0xEB8958
    OVR::OpenVR::EVROverlayError CreateOverlay(::CsString* pchOverlayKey, ::CsString* pchOverlayName, uint64_t& pOverlayHandle);
    ...
    // Offset: 0xEB8A04
    OVR::OpenVR::EVROverlayError SetOverlayName(uint64_t ulOverlayHandle, ::CsString* pchName);
    ...
    // Offset: 0xEB8A44
    ::CsString* GetOverlayErrorNameFromEnum(OVR::OpenVR::EVROverlayError error);
    ...
    // Offset: 0xEB8D50
    OVR::OpenVR::EVROverlayError SetOverlayRenderModel(uint64_t ulOverlayHandle, ::CsString* pchRenderModel, OVR::OpenVR::HmdColor_t& pColor);
    ...
    // Offset: 0xEB8DFC
    OVR::OpenVR::EVROverlayError SetOverlayTransformTrackedDeviceComponent(uint64_t ulOverlayHandle, uint unDeviceIndex, ::CsString* pchComponentName);
    ...
    // Offset: 0xEB94C8
    OVR::OpenVR::EVROverlayError SetOverlayFromFile(uint64_t ulOverlayHandle, ::CsString* pchFilePath);
    ...
    // Offset: 0xEB9558
    OVR::OpenVR::EVROverlayError CreateDashboardOverlay(::CsString* pchOverlayKey, ::CsString* pchOverlayFriendlyName, uint64_t& pMainHandle, uint64_t& pThumbnailHandle);
    ...
    // Offset: 0xEB9628
    OVR::OpenVR::EVROverlayError ShowKeyboard(int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
    ...
    // Offset: 0xEB964C
    OVR::OpenVR::EVROverlayError ShowKeyboardForOverlay(uint64_t ulOverlayHandle, int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
    ...
    // Offset: 0xEB9720
    OVR::OpenVR::VRMessageOverlayResponse ShowMessageOverlay(::CsString* pchText, ::CsString* pchCaption, ::CsString* pchButton0Text, ::CsString* pchButton1Text, ::CsString* pchButton2Text, ::CsString* pchButton3Text);
