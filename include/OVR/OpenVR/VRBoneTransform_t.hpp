...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VRBoneTransform_t), 16 + sizeof(OVR::OpenVR::HmdQuaternionf_t) + ((16 + sizeof(OVR::OpenVR::HmdQuaternionf_t)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::HmdQuaternionf_t)) % 8) : 0)> __OVR_OpenVR_VRBoneTransform_tSizeCheck;
}
