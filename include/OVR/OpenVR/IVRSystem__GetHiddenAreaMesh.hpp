...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0738
  class IVRSystem::_GetHiddenAreaMesh : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE8EFC
    OVR::OpenVR::HiddenAreaMesh_t Invoke_NEW(OVR::OpenVR::EVREye eEye, OVR::OpenVR::EHiddenAreaMeshType type);
    ...
    // Offset: 0x1EE9198
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREye eEye, OVR::OpenVR::EHiddenAreaMeshType type, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.HiddenAreaMesh_t EndInvoke(System.IAsyncResult result)
    // Offset: 0x1EE9240
    OVR::OpenVR::HiddenAreaMesh_t EndInvoke_NEW(System::IAsyncResult* result);
