...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1368
  class IVROverlay::_GetOverlayAutoCurveDistanceRangeInMeters : public System::MulticastDelegate {
    ...
    // Offset: 0x1D4244C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfMinDistanceInMeters, float& pfMaxDistanceInMeters);
    ...
    // Offset: 0x1D426E8
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, float& pfMinDistanceInMeters, float& pfMaxDistanceInMeters, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D427B4
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(float& pfMinDistanceInMeters, float& pfMaxDistanceInMeters, System::IAsyncResult* result);
