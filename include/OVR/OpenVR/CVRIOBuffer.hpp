...
namespace OVR::OpenVR {
  ...
  class CVRIOBuffer : public ::CsObject {
    public:
    ...
    // Offset: 0xECAD28
    OVR::OpenVR::EIOBufferError Open(::CsString* pchPath, OVR::OpenVR::EIOBufferMode mode, uint unElementSize, uint unElements, uint64_t& pulBuffer);
