...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRIOBuffer), 16 + sizeof(OVR::OpenVR::IVRIOBuffer) + ((16 + sizeof(OVR::OpenVR::IVRIOBuffer)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVRIOBuffer)) % 8) : 0)> __OVR_OpenVR_CVRIOBufferSizeCheck;
}
