...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C78
  class IVRInput::_GetOriginLocalizedName : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3C4C0
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t origin, System::Text::StringBuilder* pchNameArray, uint unNameArraySize);
    ...
    // Offset: 0x1D3C75C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t origin, System::Text::StringBuilder* pchNameArray, uint unNameArraySize, System::AsyncCallback* callback, ::Il2CppObject* object);
