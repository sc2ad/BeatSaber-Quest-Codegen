...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VROverlayIntersectionResults_t), 32 + sizeof(float) + ((32 + sizeof(float)) % 8 != 0 ? (8 - (32 + sizeof(float)) % 8) : 0)> __OVR_OpenVR_VROverlayIntersectionResults_tSizeCheck;
}
