...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE15D4
  class IVROverlay::_SetOverlayDualAnalogTransform : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED346C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlay, OVR::OpenVR::EDualAnalogWhich eWhich, System::IntPtr vCenter, float fRadius);
    ...
    // Offset: 0x1ED372C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlay, OVR::OpenVR::EDualAnalogWhich eWhich, System::IntPtr vCenter, float fRadius, System::AsyncCallback* callback, ::Il2CppObject* object);
