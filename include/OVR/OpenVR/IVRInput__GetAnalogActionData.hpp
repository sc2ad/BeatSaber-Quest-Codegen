...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1BD8
  class IVRInput::_GetAnalogActionData : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3B814
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t action, OVR::OpenVR::InputAnalogActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice);
    ...
    // Offset: 0x1D3BACC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t action, OVR::OpenVR::InputAnalogActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRInputError EndInvoke(ref OVR.OpenVR.InputAnalogActionData_t pActionData, System.IAsyncResult result)
    // Offset: 0x1D3BBB8
    OVR::OpenVR::EVRInputError EndInvoke_NEW(OVR::OpenVR::InputAnalogActionData_t& pActionData, System::IAsyncResult* result);
