...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE15FC
  class IVROverlay::_SetOverlayTexture : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED6314
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::Texture_t& pTexture);
    ...
    // Offset: 0x1ED6598
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::Texture_t& pTexture, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref OVR.OpenVR.Texture_t pTexture, System.IAsyncResult result)
    // Offset: 0x1ED6648
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::Texture_t& pTexture, System::IAsyncResult* result);
