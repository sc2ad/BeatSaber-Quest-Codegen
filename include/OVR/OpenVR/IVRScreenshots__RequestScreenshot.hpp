...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1A70
  class IVRScreenshots::_RequestScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDF8D0
    OVR::OpenVR::EVRScreenshotError Invoke_NEW(uint& pOutScreenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename);
    ...
    // Offset: 0x1EDFB78
    System::IAsyncResult* BeginInvoke_NEW(uint& pOutScreenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename, System::AsyncCallback* callback, ::Il2CppObject* object);
