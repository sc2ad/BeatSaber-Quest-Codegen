...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE17A0
  class IVROverlay::_GetOverlayFlags : public System::MulticastDelegate {
    ...
    // Offset: 0x1D436D4
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& pFlags);
    ...
    // Offset: 0x1D43958
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint& pFlags, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref System.UInt32 pFlags, System.IAsyncResult result)
    // Offset: 0x1D43A08
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint& pFlags, System::IAsyncResult* result);
