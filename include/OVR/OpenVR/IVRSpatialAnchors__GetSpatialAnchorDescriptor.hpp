...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D857F8
  class IVRSpatialAnchors::_GetSpatialAnchorDescriptor : public System::MulticastDelegate {
    ...
    static IVRSpatialAnchors::_GetSpatialAnchorDescriptor* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_GetSpatialAnchorDescriptor").WithContext(".ctor");
