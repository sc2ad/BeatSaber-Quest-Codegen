...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1D68
  class IVRSpatialAnchors::_GetSpatialAnchorDescriptor : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE49D0
    OVR::OpenVR::EVRSpatialAnchorError Invoke_NEW(uint unHandle, System::Text::StringBuilder* pchDescriptorOut, uint& punDescriptorBufferLenInOut);
    ...
    // Offset: 0x1EE4C70
    System::IAsyncResult* BeginInvoke_NEW(uint unHandle, System::Text::StringBuilder* pchDescriptorOut, uint& punDescriptorBufferLenInOut, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1EE4D20
    OVR::OpenVR::EVRSpatialAnchorError EndInvoke_NEW(uint& punDescriptorBufferLenInOut, System::IAsyncResult* result);
