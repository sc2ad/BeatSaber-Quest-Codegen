...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE155C
  class IVROverlay::_ComputeOverlayIntersection : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3FD64
    bool Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayIntersectionParams_t& pParams, OVR::OpenVR::VROverlayIntersectionResults_t& pResults);
    ...
    // Offset: 0x1D40004
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayIntersectionParams_t& pParams, OVR::OpenVR::VROverlayIntersectionResults_t& pResults, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D400D8
    bool EndInvoke_NEW(OVR::OpenVR::VROverlayIntersectionParams_t& pParams, OVR::OpenVR::VROverlayIntersectionResults_t& pResults, System::IAsyncResult* result);
