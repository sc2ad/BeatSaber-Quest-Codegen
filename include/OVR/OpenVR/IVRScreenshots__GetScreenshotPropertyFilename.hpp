...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1AAC
  class IVRScreenshots::_GetScreenshotPropertyFilename : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDEDF4
    uint Invoke_NEW(uint screenshotHandle, OVR::OpenVR::EVRScreenshotPropertyFilenames filenameType, System::Text::StringBuilder* pchFilename, uint cchFilename, OVR::OpenVR::EVRScreenshotError& pError);
    ...
    // Offset: 0x1EDF0CC
    System::IAsyncResult* BeginInvoke_NEW(uint screenshotHandle, OVR::OpenVR::EVRScreenshotPropertyFilenames filenameType, System::Text::StringBuilder* pchFilename, uint cchFilename, OVR::OpenVR::EVRScreenshotError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref OVR.OpenVR.EVRScreenshotError pError, System.IAsyncResult result)
    // Offset: 0x1EDF1B8
    uint EndInvoke_NEW(OVR::OpenVR::EVRScreenshotError& pError, System::IAsyncResult* result);
