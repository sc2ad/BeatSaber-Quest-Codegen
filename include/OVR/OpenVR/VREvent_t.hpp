...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VREvent_t), 16 + sizeof(OVR::OpenVR::VREvent_Data_t) + ((16 + sizeof(OVR::OpenVR::VREvent_Data_t)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::VREvent_Data_t)) % 8) : 0)> __OVR_OpenVR_VREvent_tSizeCheck;
}
