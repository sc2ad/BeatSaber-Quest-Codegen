...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE17B4
  class IVROverlay::_ShowMessageOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED8C94
    OVR::OpenVR::VRMessageOverlayResponse Invoke_NEW(::Il2CppString* pchText, ::Il2CppString* pchCaption, ::Il2CppString* pchButton0Text, ::Il2CppString* pchButton1Text, ::Il2CppString* pchButton2Text, ::Il2CppString* pchButton3Text);
    ...
    // Offset: 0x1ED9174
    OVR::OpenVR::VRMessageOverlayResponse EndInvoke_NEW(System::IAsyncResult* result);
