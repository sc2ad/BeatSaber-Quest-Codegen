...
namespace OVR::OpenVR {
class ____OVR__OpenVR__IVRRenderModels___GetComponentState;
}
...
namespace OVR::OpenVR {
class ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked;
}
namespace OVR::OpenVR {
struct ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion;
}
...
class CORDL_TYPE ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked() = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked", modifiers: " const&", def_value: None }]
constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked(____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked", modifiers: "&&", def_value: None }]
constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked(____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked& operator=(____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked&& o) noexcept = default;
  constexpr ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked& operator=(____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked const& o) noexcept = default;
...
explicit ____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
struct CORDL_TYPE ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "pGetComponentState", ty: "::OVR::OpenVR::____OVR__OpenVR__IVRRenderModels___GetComponentState", modifiers: "", def_value: None }, CppParam { name: "pGetComponentStatePacked", ty: "::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked", modifiers: "", def_value: None }]
constexpr ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion(::OVR::OpenVR::____OVR__OpenVR__IVRRenderModels___GetComponentState pGetComponentState, ::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked pGetComponentStatePacked) noexcept;


                    constexpr ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion(____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion const&) = default;
                    constexpr ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion(____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion&&) = default;
                    constexpr ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion& operator=(____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion& operator=(____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion&& o) noexcept {
...
constexpr explicit ____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 ::OVR::OpenVR::____OVR__OpenVR__IVRRenderModels___GetComponentState __declspec(property(get=__get_pGetComponentState, put=__set_pGetComponentState))  pGetComponentState;

constexpr void __set_pGetComponentState(::OVR::OpenVR::____OVR__OpenVR__IVRRenderModels___GetComponentState value) ;

constexpr ::OVR::OpenVR::____OVR__OpenVR__IVRRenderModels___GetComponentState __get_pGetComponentState() const;

 ::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked __declspec(property(get=__get_pGetComponentStatePacked, put=__set_pGetComponentStatePacked))  pGetComponentStatePacked;

constexpr void __set_pGetComponentStatePacked(::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked value) ;

constexpr ::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked __get_pGetComponentStatePacked() const;
...
public:
// Declarations
using GetComponentStateUnion = ::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion;

using _GetComponentStatePacked = ::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked;
...
NEED_NO_BOX(::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked);
DEFINE_IL2CPP_ARG_TYPE(::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels___GetComponentStatePacked, "OVR.OpenVR", "CVRRenderModels/_GetComponentStatePacked");
DEFINE_IL2CPP_ARG_TYPE(::OVR::OpenVR::____OVR__OpenVR__CVRRenderModels__GetComponentStateUnion, "OVR.OpenVR", "CVRRenderModels/GetComponentStateUnion");
