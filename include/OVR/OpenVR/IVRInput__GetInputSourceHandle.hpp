...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1B9C
  class IVRInput::_GetInputSourceHandle : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3BFEC
    OVR::OpenVR::EVRInputError Invoke_NEW(::Il2CppString* pchInputSourcePath, uint64_t& pHandle);
    ...
    // Offset: 0x1D3C3DC
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchInputSourcePath, uint64_t& pHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
