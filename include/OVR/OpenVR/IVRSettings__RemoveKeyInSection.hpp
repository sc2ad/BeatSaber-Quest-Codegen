...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1A5C
  class IVRSettings::_RemoveKeyInSection : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE1EFC
    void Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, OVR::OpenVR::EVRSettingsError& peError);
