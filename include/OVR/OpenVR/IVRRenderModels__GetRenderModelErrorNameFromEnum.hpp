...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1944
  class IVRRenderModels::_GetRenderModelErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDBE98
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVRRenderModelError error);
    ...
    // Offset: 0x1EDC110
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRRenderModelError error, System::AsyncCallback* callback, ::Il2CppObject* object);
