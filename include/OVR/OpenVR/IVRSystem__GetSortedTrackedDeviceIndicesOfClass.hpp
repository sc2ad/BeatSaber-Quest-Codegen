...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF2B58
  class IVRSystem::_GetSortedTrackedDeviceIndicesOfClass : public System::MulticastDelegate {
    ...
    // Offset: 0x20F97F4
    uint Invoke(OVR::OpenVR::ETrackedDeviceClass eTrackedDeviceClass, ByRef<::Array<uint>*> punTrackedDeviceIndexArray, uint unTrackedDeviceIndexArrayCount, uint unRelativeToTrackedDeviceIndex);
    ...
    // Offset: 0x20F9ACC
    System::IAsyncResult* BeginInvoke(OVR::OpenVR::ETrackedDeviceClass eTrackedDeviceClass, ByRef<::Array<uint>*> punTrackedDeviceIndexArray, uint unTrackedDeviceIndexArrayCount, uint unRelativeToTrackedDeviceIndex, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (OVR::OpenVR::IVRSystem::_GetSortedTrackedDeviceIndicesOfClass::*)(OVR::OpenVR::ETrackedDeviceClass, ByRef<::Array<uint>*>, uint, uint)>(&OVR::OpenVR::IVRSystem::_GetSortedTrackedDeviceIndicesOfClass::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRSystem::_GetSortedTrackedDeviceIndicesOfClass::*)(OVR::OpenVR::ETrackedDeviceClass, ByRef<::Array<uint>*>, uint, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRSystem::_GetSortedTrackedDeviceIndicesOfClass::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* eTrackedDeviceClass = &::il2cpp_utils::GetClassFromName("OVR.OpenVR", "ETrackedDeviceClass")->byval_arg;
    static auto* punTrackedDeviceIndexArray = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "UInt32"), 1)->this_arg;
    static auto* unTrackedDeviceIndexArrayCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
