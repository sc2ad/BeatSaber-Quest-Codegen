...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE15C0
  class IVROverlay::_MoveGamepadFocusToNeighbor : public System::MulticastDelegate {
    ...
    // Offset: 0x1D49904
    OVR::OpenVR::EVROverlayError Invoke_NEW(OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom);
    ...
    // Offset: 0x1D49B9C
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EOverlayDirection eDirection, uint64_t ulFrom, System::AsyncCallback* callback, ::Il2CppObject* object);
