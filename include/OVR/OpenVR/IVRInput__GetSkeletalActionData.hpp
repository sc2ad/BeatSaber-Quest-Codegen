...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C00
  class IVRInput::_GetSkeletalActionData : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3D070
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t action, OVR::OpenVR::InputSkeletalActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice);
    ...
    // Offset: 0x1D3D328
    System::IAsyncResult* BeginInvoke_NEW(uint64_t action, OVR::OpenVR::InputSkeletalActionData_t& pActionData, uint unActionDataSize, uint64_t ulRestrictToDevice, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D3D414
    OVR::OpenVR::EVRInputError EndInvoke_NEW(OVR::OpenVR::InputSkeletalActionData_t& pActionData, System::IAsyncResult* result);
