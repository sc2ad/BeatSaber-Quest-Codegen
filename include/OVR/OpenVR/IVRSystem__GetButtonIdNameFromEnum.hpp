...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0788
  class IVRSystem::_GetButtonIdNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE6948
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVRButtonId eButtonId);
    ...
    // Offset: 0x1EE6BC0
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRButtonId eButtonId, System::AsyncCallback* callback, ::Il2CppObject* object);
