...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE08F0
  class IVRTrackedCamera::_AcquireVideoStreamingService : public System::MulticastDelegate {
    ...
    // Offset: 0x112E230
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, uint64_t& pHandle);
    ...
    // Offset: 0x112E568
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(uint64_t& pHandle, System::IAsyncResult* result);
