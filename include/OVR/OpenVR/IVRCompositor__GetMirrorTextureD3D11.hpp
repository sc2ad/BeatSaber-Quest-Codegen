...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE10AC
  class IVRCompositor::_GetMirrorTextureD3D11 : public System::MulticastDelegate {
    ...
    // Offset: 0x1D33960
    OVR::OpenVR::EVRCompositorError Invoke_NEW(OVR::OpenVR::EVREye eEye, System::IntPtr pD3D11DeviceOrResource, System::IntPtr& ppD3D11ShaderResourceView);
    ...
    // Offset: 0x1D33C18
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREye eEye, System::IntPtr pD3D11DeviceOrResource, System::IntPtr& ppD3D11ShaderResourceView, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRCompositorError EndInvoke(ref System.IntPtr ppD3D11ShaderResourceView, System.IAsyncResult result)
    // Offset: 0x1D33CE0
    OVR::OpenVR::EVRCompositorError EndInvoke_NEW(System::IntPtr& ppD3D11ShaderResourceView, System::IAsyncResult* result);
