...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1480
  class IVROverlay::_GetOverlayTransformOverlayRelative : public System::MulticastDelegate {
    ...
    // Offset: 0x1D47224
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint64_t& ulOverlayHandleParent, OVR::OpenVR::HmdMatrix34_t& pmatParentOverlayToOverlayTransform, System::IAsyncResult* result);
