...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1A84
  class IVRScreenshots::_HookScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDF580
    OVR::OpenVR::EVRScreenshotError Invoke_NEW(::Array<OVR::OpenVR::EVRScreenshotType>*& pSupportedTypes, int numTypes);
    ...
    // Offset: 0x1EDF7F8
    System::IAsyncResult* BeginInvoke_NEW(::Array<OVR::OpenVR::EVRScreenshotType>*& pSupportedTypes, int numTypes, System::AsyncCallback* callback, ::Il2CppObject* object);
