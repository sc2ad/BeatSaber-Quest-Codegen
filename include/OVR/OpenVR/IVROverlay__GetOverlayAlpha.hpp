...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_GetOverlayAlpha : public System::MulticastDelegate {
    ...
    // Offset: 0x1509D8C
    static IVROverlay::_GetOverlayAlpha* New_ctor(::CsObject* object, System::IntPtr method);
    // public OVR.OpenVR.EVROverlayError Invoke(System.UInt64 ulOverlayHandle, System.Single pfAlpha)
    // Offset: 0x1509DA0
    ...
    // Offset: 0x150A024
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, float& pfAlpha, System::AsyncCallback* callback, ::CsObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(System.Single pfAlpha, System.IAsyncResult result)
    // Offset: 0x150A0D4
