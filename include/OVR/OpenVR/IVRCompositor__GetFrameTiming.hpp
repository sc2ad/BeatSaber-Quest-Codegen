...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0EB8
  class IVRCompositor::_GetFrameTiming : public System::MulticastDelegate {
    ...
    // Offset: 0x1D328A0
    bool Invoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, uint unFramesAgo);
    ...
    // Offset: 0x1D32B20
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, uint unFramesAgo, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref OVR.OpenVR.Compositor_FrameTiming pTiming, System.IAsyncResult result)
    // Offset: 0x1D32BD4
    bool EndInvoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, System::IAsyncResult* result);
