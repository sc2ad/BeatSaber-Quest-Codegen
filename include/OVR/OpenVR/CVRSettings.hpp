...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRSettings), 16 + sizeof(OVR::OpenVR::IVRSettings) + ((16 + sizeof(OVR::OpenVR::IVRSettings)) % 8 != 0 ? (8 - (16 + sizeof(OVR::OpenVR::IVRSettings)) % 8) : 0)> __OVR_OpenVR_CVRSettingsSizeCheck;
}
