...
namespace OVR::OpenVR {
  ...
  class CVRScreenshots : public ::CsObject {
    ...
    // Offset: 0xECCF90
    OVR::OpenVR::EVRScreenshotError RequestScreenshot(uint& pOutScreenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::CsString* pchPreviewFilename, ::CsString* pchVRFilename);
    ...
    // Offset: 0xECD02C
    OVR::OpenVR::EVRScreenshotError TakeStereoScreenshot(uint& pOutScreenshotHandle, ::CsString* pchPreviewFilename, ::CsString* pchVRFilename);
    ...
    // Offset: 0xECD04C
    OVR::OpenVR::EVRScreenshotError SubmitScreenshot(uint screenshotHandle, OVR::OpenVR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename);
