...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0AF8
  class IVRApplications::_SetDefaultApplicationForMimeType : public System::MulticastDelegate {
    ...
    // Offset: 0x13EF1E0
    OVR::OpenVR::EVRApplicationError Invoke_NEW(::Il2CppString* pchAppKey, ::Il2CppString* pchMimeType);
    ...
    // Offset: 0x13FC800
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchAppKey, ::Il2CppString* pchMimeType, System::AsyncCallback* callback, ::Il2CppObject* object);
