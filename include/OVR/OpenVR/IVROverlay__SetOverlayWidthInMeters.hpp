...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_SetOverlayWidthInMeters : public System::MulticastDelegate {
    ...
    // Offset: 0x169FA54
    static IVROverlay::_SetOverlayWidthInMeters* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x169FCF0
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, float fWidthInMeters, System::AsyncCallback* callback, ::CsObject* object);
