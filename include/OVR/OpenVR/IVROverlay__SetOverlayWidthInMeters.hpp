...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D84DBC
  class IVROverlay::_SetOverlayWidthInMeters : public System::MulticastDelegate {
    ...
    static IVROverlay::_SetOverlayWidthInMeters* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_SetOverlayWidthInMeters").WithContext(".ctor");
