...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0AA8
  class IVRApplications::_GetApplicationPropertyBool : public System::MulticastDelegate {
    ...
    // Offset: 0x13EE130
    bool Invoke_NEW(::Il2CppString* pchAppKey, OVR::OpenVR::EVRApplicationProperty eProperty, OVR::OpenVR::EVRApplicationError& peError);
    ...
    // Offset: 0x13FB9FC
    bool EndInvoke_NEW(OVR::OpenVR::EVRApplicationError& peError, System::IAsyncResult* result);
