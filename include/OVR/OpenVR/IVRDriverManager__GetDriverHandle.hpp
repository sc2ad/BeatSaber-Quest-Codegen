...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1B4C
  class IVRDriverManager::_GetDriverHandle : public System::MulticastDelegate {
    ...
    // Offset: 0x1D38028
    uint64_t Invoke_NEW(::Il2CppString* pchDriverName);
    // public System.IAsyncResult BeginInvoke(System.String pchDriverName, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1D383C4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchDriverName, System::AsyncCallback* callback, ::Il2CppObject* object);
