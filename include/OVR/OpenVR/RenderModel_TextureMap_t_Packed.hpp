...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(RenderModel_TextureMap_t_Packed), 4 + sizeof(System::IntPtr) + ((4 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (4 + sizeof(System::IntPtr)) % 8) : 0)> __OVR_OpenVR_RenderModel_TextureMap_t_PackedSizeCheck;
}
