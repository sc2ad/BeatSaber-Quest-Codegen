...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0E2C
  class IVRCompositor::_GetTrackingSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1D340F8
    OVR::OpenVR::ETrackingUniverseOrigin Invoke_NEW();
    ...
    // Offset: 0x1D34338
    OVR::OpenVR::ETrackingUniverseOrigin EndInvoke_NEW(System::IAsyncResult* result);
