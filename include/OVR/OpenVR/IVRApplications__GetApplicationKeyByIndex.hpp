...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE09CC
  class IVRApplications::_GetApplicationKeyByIndex : public System::MulticastDelegate {
    ...
    // Offset: 0x13EBA34
    OVR::OpenVR::EVRApplicationError Invoke_NEW(uint unApplicationIndex, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
