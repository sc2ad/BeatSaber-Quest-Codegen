...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0E7C
  class IVRCompositor::_Submit : public System::MulticastDelegate {
    ...
    // Offset: 0x1D36D64
    OVR::OpenVR::EVRCompositorError Invoke_NEW(OVR::OpenVR::EVREye eEye, OVR::OpenVR::Texture_t& pTexture, OVR::OpenVR::VRTextureBounds_t& pBounds, OVR::OpenVR::EVRSubmitFlags nSubmitFlags);
    ...
    // Offset: 0x1D3703C
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREye eEye, OVR::OpenVR::Texture_t& pTexture, OVR::OpenVR::VRTextureBounds_t& pBounds, OVR::OpenVR::EVRSubmitFlags nSubmitFlags, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D3712C
    OVR::OpenVR::EVRCompositorError EndInvoke_NEW(OVR::OpenVR::Texture_t& pTexture, OVR::OpenVR::VRTextureBounds_t& pBounds, System::IAsyncResult* result);
