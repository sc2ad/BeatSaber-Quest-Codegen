...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(RenderModel_ComponentState_t), 96 + sizeof(uint) + ((96 + sizeof(uint)) % 8 != 0 ? (8 - (96 + sizeof(uint)) % 8) : 0)> __OVR_OpenVR_RenderModel_ComponentState_tSizeCheck;
}
