...
namespace OVR::OpenVR {
  ...
  struct Compositor_FrameTiming/*, public System::ValueType*/ {
    ...
    // Get instance field: public OVR.OpenVR.TrackedDevicePose_t m_HmdPose
    OVR::OpenVR::TrackedDevicePose_t _get_m_HmdPose();
    // Set instance field: public OVR.OpenVR.TrackedDevicePose_t m_HmdPose
    void _set_m_HmdPose(OVR::OpenVR::TrackedDevicePose_t value);
