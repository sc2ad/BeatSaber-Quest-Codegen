...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(Compositor_FrameTiming), 96 + sizeof(OVR::OpenVR::TrackedDevicePose_t) + ((96 + sizeof(OVR::OpenVR::TrackedDevicePose_t)) % 8 != 0 ? (8 - (96 + sizeof(OVR::OpenVR::TrackedDevicePose_t)) % 8) : 0)> __OVR_OpenVR_Compositor_FrameTimingSizeCheck;
}
