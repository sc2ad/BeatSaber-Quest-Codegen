...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE16D8
  class IVROverlay::_GetDashboardOverlaySceneProcess : public System::MulticastDelegate {
    ...
    // Offset: 0x1D41370
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& punProcessId);
    ...
    // Offset: 0x1D415F4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint& punProcessId, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref System.UInt32 punProcessId, System.IAsyncResult result)
    // Offset: 0x1D416A4
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint& punProcessId, System::IAsyncResult* result);
