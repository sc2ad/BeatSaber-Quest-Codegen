...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0B98
  class IVRApplications::_GetApplicationsTransitionStateNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x13F0FBC
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVRApplicationTransitionState state);
    ...
    // Offset: 0x13FBEF8
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRApplicationTransitionState state, System::AsyncCallback* callback, ::Il2CppObject* object);
