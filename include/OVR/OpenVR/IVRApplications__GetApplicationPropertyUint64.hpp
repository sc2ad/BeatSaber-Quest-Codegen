...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0ABC
  class IVRApplications::_GetApplicationPropertyUint64 : public System::MulticastDelegate {
    ...
    // Offset: 0x13EE588
    uint64_t Invoke_NEW(::Il2CppString* pchAppKey, OVR::OpenVR::EVRApplicationProperty eProperty, OVR::OpenVR::EVRApplicationError& peError);
    ...
    // Offset: 0x13FBB74
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchAppKey, OVR::OpenVR::EVRApplicationProperty eProperty, OVR::OpenVR::EVRApplicationError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt64 EndInvoke(ref OVR.OpenVR.EVRApplicationError peError, System.IAsyncResult result)
    // Offset: 0x13FBC30
    uint64_t EndInvoke_NEW(OVR::OpenVR::EVRApplicationError& peError, System::IAsyncResult* result);
