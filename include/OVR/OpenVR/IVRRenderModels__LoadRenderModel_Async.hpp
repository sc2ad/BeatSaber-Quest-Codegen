...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE17DC
  class IVRRenderModels::_LoadRenderModel_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDD370
    OVR::OpenVR::EVRRenderModelError Invoke_NEW(::Il2CppString* pchRenderModelName, System::IntPtr& ppRenderModel);
    ...
    // Offset: 0x1EDD7FC
    OVR::OpenVR::EVRRenderModelError EndInvoke_NEW(System::IntPtr& ppRenderModel, System::IAsyncResult* result);
