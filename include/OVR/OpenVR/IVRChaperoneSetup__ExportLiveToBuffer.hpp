...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0DF0
  class IVRChaperoneSetup::_ExportLiveToBuffer : public System::MulticastDelegate {
    ...
    // Offset: 0x13F5FD0
    bool Invoke_NEW(System::Text::StringBuilder* pBuffer, uint& pnBufferLength);
    ...
    // Offset: 0x13FCE98
    System::IAsyncResult* BeginInvoke_NEW(System::Text::StringBuilder* pBuffer, uint& pnBufferLength, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref System.UInt32 pnBufferLength, System.IAsyncResult result)
    // Offset: 0x13FCF34
    bool EndInvoke_NEW(uint& pnBufferLength, System::IAsyncResult* result);
