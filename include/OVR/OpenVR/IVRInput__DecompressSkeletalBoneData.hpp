...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C3C
  class IVRInput::_DecompressSkeletalBoneData : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3A6A4
    OVR::OpenVR::EVRInputError Invoke_NEW(System::IntPtr pvCompressedBuffer, uint unCompressedBufferSize, OVR::OpenVR::EVRSkeletalTransformSpace& peTransformSpace, ::Array<OVR::OpenVR::VRBoneTransform_t>*& pTransformArray, uint unTransformArrayCount);
    ...
    // Offset: 0x1D3A978
    System::IAsyncResult* BeginInvoke_NEW(System::IntPtr pvCompressedBuffer, uint unCompressedBufferSize, OVR::OpenVR::EVRSkeletalTransformSpace& peTransformSpace, ::Array<OVR::OpenVR::VRBoneTransform_t>*& pTransformArray, uint unTransformArrayCount, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D3AA64
    OVR::OpenVR::EVRInputError EndInvoke_NEW(OVR::OpenVR::EVRSkeletalTransformSpace& peTransformSpace, System::IAsyncResult* result);
