...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1D90
  class CVRSystem::_GetControllerStatePacked : public System::MulticastDelegate {
    ...
    // Offset: 0x13FA444
    bool Invoke_NEW(uint unControllerDeviceIndex, OVR::OpenVR::VRControllerState_t_Packed& pControllerState, uint unControllerStateSize);
    ...
    // Offset: 0x13FADC8
    System::IAsyncResult* BeginInvoke_NEW(uint unControllerDeviceIndex, OVR::OpenVR::VRControllerState_t_Packed& pControllerState, uint unControllerStateSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref OVR.OpenVR.VRControllerState_t_Packed pControllerState, System.IAsyncResult result)
    // Offset: 0x13FAE94
    bool EndInvoke_NEW(OVR::OpenVR::VRControllerState_t_Packed& pControllerState, System::IAsyncResult* result);
