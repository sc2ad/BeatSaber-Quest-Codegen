...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0F58
  class IVRCompositor::_SetSkyboxOverride : public System::MulticastDelegate {
    ...
    // Offset: 0x1D36228
    OVR::OpenVR::EVRCompositorError Invoke_NEW(::Array<OVR::OpenVR::Texture_t>*& pTextures, uint unTextureCount);
    ...
    // Offset: 0x1D364A0
    System::IAsyncResult* BeginInvoke_NEW(::Array<OVR::OpenVR::Texture_t>*& pTextures, uint unTextureCount, System::AsyncCallback* callback, ::Il2CppObject* object);
