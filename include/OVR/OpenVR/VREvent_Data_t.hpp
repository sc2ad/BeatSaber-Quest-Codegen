...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VREvent_Data_t), 0 + sizeof(OVR::OpenVR::VREvent_Keyboard_t) + 8 - (0 + sizeof(OVR::OpenVR::VREvent_Keyboard_t)) % 8> __OVR_OpenVR_VREvent_Data_tSizeCheck;
}
