...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0E04
  class IVRChaperoneSetup::_ImportFromBufferToWorking : public System::MulticastDelegate {
    ...
    // Offset: 0x13F63DC
    bool Invoke_NEW(::Il2CppString* pBuffer, uint nImportFlags);
    ...
    // Offset: 0x13FD770
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pBuffer, uint nImportFlags, System::AsyncCallback* callback, ::Il2CppObject* object);
