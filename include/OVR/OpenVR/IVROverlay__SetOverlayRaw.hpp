...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_SetOverlayRaw : public System::MulticastDelegate {
    ...
    // Offset: 0x1690508
    static IVROverlay::_SetOverlayRaw* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x16907E4
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unWidth, uint unHeight, uint unDepth, System::AsyncCallback* callback, ::CsObject* object);
