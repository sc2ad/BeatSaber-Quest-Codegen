...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1624
  class IVROverlay::_SetOverlayRaw : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED512C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unWidth, uint unHeight, uint unDepth);
    ...
    // Offset: 0x1ED5400
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unWidth, uint unHeight, uint unDepth, System::AsyncCallback* callback, ::Il2CppObject* object);
