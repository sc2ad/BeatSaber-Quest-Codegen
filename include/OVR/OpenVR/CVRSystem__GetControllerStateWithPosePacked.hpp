...
namespace OVR::OpenVR {
  ...
  class CVRSystem::_GetControllerStateWithPosePacked : public System::MulticastDelegate {
    ...
    // Offset: 0xECEB20
    static CVRSystem::_GetControllerStateWithPosePacked* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0xECEB34
    System::IAsyncResult* BeginInvoke(OVR::OpenVR::ETrackingUniverseOrigin eOrigin, uint unControllerDeviceIndex, OVR::OpenVR::VRControllerState_t_Packed& pControllerState, uint unControllerStateSize, OVR::OpenVR::TrackedDevicePose_t& pTrackedDevicePose, System::AsyncCallback* callback, ::CsObject* object);
