...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1304
  class IVROverlay::_SetOverlaySortOrder : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED5C38
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint unSortOrder);
    ...
    // Offset: 0x1ED5EBC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint unSortOrder, System::AsyncCallback* callback, ::Il2CppObject* object);
