...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1994
  class IVRSettings::_Sync : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE3D78
    bool Invoke_NEW(bool bForce, OVR::OpenVR::EVRSettingsError& peError);
    ...
    // Offset: 0x1EE4010
    System::IAsyncResult* BeginInvoke_NEW(bool bForce, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
