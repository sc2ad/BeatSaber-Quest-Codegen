...
namespace OVR::OpenVR {
  ...
  class IVRTrackedCamera::_GetVideoStreamTextureGL : public System::MulticastDelegate {
    ...
    // Offset: 0xCC1970
    System::IAsyncResult* BeginInvoke(uint64_t hTrackedCamera, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, uint& pglTextureId, OVR::OpenVR::CameraVideoStreamFrameHeader_t& pFrameHeader, uint nFrameHeaderSize, System::AsyncCallback* callback, ::CsObject* object);
