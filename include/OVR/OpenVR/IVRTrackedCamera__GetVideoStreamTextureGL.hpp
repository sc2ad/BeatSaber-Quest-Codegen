...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0954
  class IVRTrackedCamera::_GetVideoStreamTextureGL : public System::MulticastDelegate {
    ...
    // Offset: 0x112FE00
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint64_t hTrackedCamera, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, uint& pglTextureId, OVR::OpenVR::CameraVideoStreamFrameHeader_t& pFrameHeader, uint nFrameHeaderSize);
    ...
    // Offset: 0x11300D4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t hTrackedCamera, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, uint& pglTextureId, OVR::OpenVR::CameraVideoStreamFrameHeader_t& pFrameHeader, uint nFrameHeaderSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x11301DC
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(uint& pglTextureId, OVR::OpenVR::CameraVideoStreamFrameHeader_t& pFrameHeader, System::IAsyncResult* result);
