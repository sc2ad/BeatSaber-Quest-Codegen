...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_GetOverlayMouseScale : public System::MulticastDelegate {
    ...
    // Offset: 0x150C278
    static IVROverlay::_GetOverlayMouseScale* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x150C510
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::HmdVector2_t& pvecMouseScale, System::AsyncCallback* callback, ::CsObject* object);
