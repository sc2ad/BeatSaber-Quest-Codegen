...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1534
  class IVROverlay::_GetOverlayMouseScale : public System::MulticastDelegate {
    ...
    // Offset: 0x1D445C4
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::HmdVector2_t& pvecMouseScale);
    ...
    // Offset: 0x1D44848
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::HmdVector2_t& pvecMouseScale, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref OVR.OpenVR.HmdVector2_t pvecMouseScale, System.IAsyncResult result)
    // Offset: 0x1D448F8
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::HmdVector2_t& pvecMouseScale, System::IAsyncResult* result);
