...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D844C0
  class IVRApplications::_LaunchDashboardOverlay : public System::MulticastDelegate {
    ...
    static IVRApplications::_LaunchDashboardOverlay* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_LaunchDashboardOverlay").WithContext(".ctor");
