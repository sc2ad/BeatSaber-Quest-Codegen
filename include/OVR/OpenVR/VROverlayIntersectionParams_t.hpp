...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(VROverlayIntersectionParams_t), 24 + sizeof(OVR::OpenVR::ETrackingUniverseOrigin) + ((24 + sizeof(OVR::OpenVR::ETrackingUniverseOrigin)) % 8 != 0 ? (8 - (24 + sizeof(OVR::OpenVR::ETrackingUniverseOrigin)) % 8) : 0)> __OVR_OpenVR_VROverlayIntersectionParams_tSizeCheck;
}
