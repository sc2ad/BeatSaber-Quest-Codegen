...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1B10
  class IVRResources::_GetResourceFullPath : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDE3D4
    uint Invoke_NEW(::Il2CppString* pchResourceName, ::Il2CppString* pchResourceTypeDirectory, System::Text::StringBuilder* pchPathBuffer, uint unBufferLen);
    ...
    // Offset: 0x1EDE814
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchResourceName, ::Il2CppString* pchResourceTypeDirectory, System::Text::StringBuilder* pchPathBuffer, uint unBufferLen, System::AsyncCallback* callback, ::Il2CppObject* object);
