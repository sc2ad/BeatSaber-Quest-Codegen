...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0990
  class IVRApplications::_RemoveApplicationManifest : public System::MulticastDelegate {
    ...
    // Offset: 0x13EB09C
    OVR::OpenVR::EVRApplicationError Invoke_NEW(::Il2CppString* pchApplicationManifestFullPath);
    ...
    // Offset: 0x13FC6C4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchApplicationManifestFullPath, System::AsyncCallback* callback, ::Il2CppObject* object);
