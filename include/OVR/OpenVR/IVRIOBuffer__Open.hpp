...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1CC8
  class IVRIOBuffer::_Open : public System::MulticastDelegate {
    ...
    // Offset: 0x1D39624
    OVR::OpenVR::EIOBufferError Invoke_NEW(::Il2CppString* pchPath, OVR::OpenVR::EIOBufferMode mode, uint unElementSize, uint unElements, uint64_t& pulBuffer);
    ...
    // Offset: 0x1D39AB4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchPath, OVR::OpenVR::EIOBufferMode mode, uint unElementSize, uint unElements, uint64_t& pulBuffer, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EIOBufferError EndInvoke(ref System.UInt64 pulBuffer, System.IAsyncResult result)
    // Offset: 0x1D39BA4
    OVR::OpenVR::EIOBufferError EndInvoke_NEW(uint64_t& pulBuffer, System::IAsyncResult* result);
