...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE128C
  class IVROverlay::_SetOverlayColor : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED3098
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float fRed, float fGreen, float fBlue);
    ...
    // Offset: 0x1ED3358
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, float fRed, float fGreen, float fBlue, System::AsyncCallback* callback, ::Il2CppObject* object);
