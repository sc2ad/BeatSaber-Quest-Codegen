...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE13F4
  class IVROverlay::_GetOverlayTransformType : public System::MulticastDelegate {
    ...
    // Offset: 0x1D479F4
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayTransformType& peTransformType);
    ...
    // Offset: 0x1D47C78
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::VROverlayTransformType& peTransformType, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D47D28
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::VROverlayTransformType& peTransformType, System::IAsyncResult* result);
