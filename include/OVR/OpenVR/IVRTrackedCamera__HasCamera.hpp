...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE08A0
  class IVRTrackedCamera::_HasCamera : public System::MulticastDelegate {
    ...
    // Offset: 0x1130654
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, bool& pHasCamera);
    ...
    // Offset: 0x11308D8
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, bool& pHasCamera, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRTrackedCameraError EndInvoke(ref System.Boolean pHasCamera, System.IAsyncResult result)
    // Offset: 0x113098C
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(bool& pHasCamera, System::IAsyncResult* result);
