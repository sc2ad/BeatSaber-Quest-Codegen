...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0A08
  class IVRApplications::_LaunchTemplateApplication : public System::MulticastDelegate {
    ...
    // Offset: 0x13EC364
    OVR::OpenVR::EVRApplicationError Invoke_NEW(::Il2CppString* pchTemplateAppKey, ::Il2CppString* pchNewAppKey, ::Array<OVR::OpenVR::AppOverrideKeys_t>*& pKeys, uint unKeys);
    ...
    // Offset: 0x13FC578
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchTemplateAppKey, ::Il2CppString* pchNewAppKey, ::Array<OVR::OpenVR::AppOverrideKeys_t>*& pKeys, uint unKeys, System::AsyncCallback* callback, ::Il2CppObject* object);
