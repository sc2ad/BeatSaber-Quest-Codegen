...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1BB0
  class IVRInput::_UpdateActionState : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3EC94
    OVR::OpenVR::EVRInputError Invoke_NEW(::Array<OVR::OpenVR::VRActiveActionSet_t>*& pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount);
    ...
    // Offset: 0x1D3EF28
    System::IAsyncResult* BeginInvoke_NEW(::Array<OVR::OpenVR::VRActiveActionSet_t>*& pSets, uint unSizeOfVRSelectedActionSet_t, uint unSetCount, System::AsyncCallback* callback, ::Il2CppObject* object);
