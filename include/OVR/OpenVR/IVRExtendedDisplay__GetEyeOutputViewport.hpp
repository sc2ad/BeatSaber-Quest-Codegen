...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0864
  class IVRExtendedDisplay::_GetEyeOutputViewport : public System::MulticastDelegate {
    ...
    // Offset: 0x1D38B00
    void Invoke_NEW(OVR::OpenVR::EVREye eEye, uint& pnX, uint& pnY, uint& pnWidth, uint& pnHeight);
    ...
    // Offset: 0x1D38DF0
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVREye eEye, uint& pnX, uint& pnY, uint& pnWidth, uint& pnHeight, System::AsyncCallback* callback, ::Il2CppObject* object);
