...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::CVRChaperone::*)(::cordl_internals::intptr_t)>(&OVR::OpenVR::CVRChaperone::_ctor)> {
  constexpr static std::size_t size = 0x114;
  constexpr static std::size_t addrs = 0x266508c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<OVR::OpenVR::ChaperoneCalibrationState (OVR::OpenVR::CVRChaperone::*)()>(&OVR::OpenVR::CVRChaperone::GetCalibrationState)> {
  ...
  constexpr static std::size_t addrs = 0x26651a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (OVR::OpenVR::CVRChaperone::*)(ByRef<float_t>, ByRef<float_t>)>(&OVR::OpenVR::CVRChaperone::GetPlayAreaSize)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x26651c4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::CVRChaperone::*)()>(&OVR::OpenVR::CVRChaperone::ReloadInfo)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x2665214;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::CVRChaperone::*)(OVR::OpenVR::HmdColor_t)>(&OVR::OpenVR::CVRChaperone::SetSceneColor)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x2665238;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "SetSceneColor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<OVR::OpenVR::HmdColor_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::CVRChaperone::*)(ByRef<OVR::OpenVR::HmdColor_t>, int32_t, float_t, ByRef<OVR::OpenVR::HmdColor_t>)>(&OVR::OpenVR::CVRChaperone::GetBoundsColor)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x266525c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "GetBoundsColor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<OVR::OpenVR::HmdColor_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<OVR::OpenVR::HmdColor_t>>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (OVR::OpenVR::CVRChaperone::*)()>(&OVR::OpenVR::CVRChaperone::AreBoundsVisible)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x2665280;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::CVRChaperone::*)(bool)>(&OVR::OpenVR::CVRChaperone::ForceBoundsVisible)> {
  ...
  constexpr static std::size_t addrs = 0x26652a4;
...
::cordl_internals::setInstanceField<OVR::OpenVR::IVRChaperone, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<OVR::OpenVR::IVRChaperone>(value));
}
constexpr OVR::OpenVR::IVRChaperone OVR::OpenVR::CVRChaperone::__get_FnTable() const {
return ::cordl_internals::getInstanceField<OVR::OpenVR::IVRChaperone, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
 OVR::OpenVR::CVRChaperone OVR::OpenVR::CVRChaperone::New_ctor(::cordl_internals::intptr_t pInterface)  {
OVR::OpenVR::CVRChaperone o{THROW_UNLESS(::il2cpp_utils::New<OVR::OpenVR::CVRChaperone>(pInterface))};
return o;
}
 void OVR::OpenVR::CVRChaperone::_ctor(::cordl_internals::intptr_t pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<OVR::OpenVR::CVRChaperone>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<OVR::OpenVR::ChaperoneCalibrationState, false>(const_cast<void*>(instance), ___internal_method);
}
 bool OVR::OpenVR::CVRChaperone::GetPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<OVR::OpenVR::CVRChaperone>::get(),
                            "GetPlayAreaSize",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, color);
 ...
 void OVR::OpenVR::CVRChaperone::GetBoundsColor(ByRef<OVR::OpenVR::HmdColor_t> pOutputColorArray, int32_t nNumOutputColors, float_t flCollisionBoundsFadeDistance, ByRef<OVR::OpenVR::HmdColor_t> pOutputCameraColor)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<OVR::OpenVR::CVRChaperone>::get(),
                            "GetBoundsColor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, pOutputColorArray, nNumOutputColors, flCollisionBoundsFadeDistance, pOutputCameraColor);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, bForce);
}
