...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0BE8
  class IVRChaperone::_GetCalibrationState : public System::MulticastDelegate {
    ...
    // Offset: 0x13F1BE0
    OVR::OpenVR::ChaperoneCalibrationState Invoke_NEW();
    ...
    // Offset: 0x13FCAD0
    OVR::OpenVR::ChaperoneCalibrationState EndInvoke_NEW(System::IAsyncResult* result);
