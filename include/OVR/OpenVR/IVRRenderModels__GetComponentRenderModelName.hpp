...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE18CC
  class IVRRenderModels::_GetComponentRenderModelName : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDAB94
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, ::Il2CppString* pchComponentName, System::Text::StringBuilder* pchComponentRenderModelName, uint unComponentRenderModelNameLen);
    ...
    // Offset: 0x1EDAFD4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, ::Il2CppString* pchComponentName, System::Text::StringBuilder* pchComponentRenderModelName, uint unComponentRenderModelNameLen, System::AsyncCallback* callback, ::Il2CppObject* object);
