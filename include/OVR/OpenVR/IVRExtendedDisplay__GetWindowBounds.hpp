...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0850
  class IVRExtendedDisplay::_GetWindowBounds : public System::MulticastDelegate {
    ...
    // Offset: 0x1D38F30
    void Invoke_NEW(int& pnX, int& pnY, uint& pnWidth, uint& pnHeight);
    ...
    // Offset: 0x1D391D0
    System::IAsyncResult* BeginInvoke_NEW(int& pnX, int& pnY, uint& pnWidth, uint& pnHeight, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D392BC
    void EndInvoke_NEW(int& pnX, int& pnY, uint& pnWidth, uint& pnHeight, System::IAsyncResult* result);
