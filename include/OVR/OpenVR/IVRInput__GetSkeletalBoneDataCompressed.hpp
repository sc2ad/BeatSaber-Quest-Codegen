...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C28
  class IVRInput::_GetSkeletalBoneDataCompressed : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3D89C
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t action, OVR::OpenVR::EVRSkeletalTransformSpace eTransformSpace, OVR::OpenVR::EVRSkeletalMotionRange eMotionRange, System::IntPtr pvCompressedData, uint unCompressedSize, uint& punRequiredCompressedSize, uint64_t ulRestrictToDevice);
    ...
    // Offset: 0x1D3DBC0
    System::IAsyncResult* BeginInvoke_NEW(uint64_t action, OVR::OpenVR::EVRSkeletalTransformSpace eTransformSpace, OVR::OpenVR::EVRSkeletalMotionRange eMotionRange, System::IntPtr pvCompressedData, uint unCompressedSize, uint& punRequiredCompressedSize, uint64_t ulRestrictToDevice, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRInputError EndInvoke(ref System.UInt32 punRequiredCompressedSize, System.IAsyncResult result)
    // Offset: 0x1D3DCFC
    OVR::OpenVR::EVRInputError EndInvoke_NEW(uint& punRequiredCompressedSize, System::IAsyncResult* result);
