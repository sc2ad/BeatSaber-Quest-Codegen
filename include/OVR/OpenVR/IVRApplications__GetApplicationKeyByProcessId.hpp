...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE09E0
  class IVRApplications::_GetApplicationKeyByProcessId : public System::MulticastDelegate {
    ...
    // Offset: 0x13EBCEC
    OVR::OpenVR::EVRApplicationError Invoke_NEW(uint unProcessId, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
