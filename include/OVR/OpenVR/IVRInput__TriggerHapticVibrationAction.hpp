...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C50
  class IVRInput::_TriggerHapticVibrationAction : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3E854
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t action, float fStartSecondsFromNow, float fDurationSeconds, float fFrequency, float fAmplitude, uint64_t ulRestrictToDevice);
    ...
    // Offset: 0x1D3EB48
    System::IAsyncResult* BeginInvoke_NEW(uint64_t action, float fStartSecondsFromNow, float fDurationSeconds, float fFrequency, float fAmplitude, uint64_t ulRestrictToDevice, System::AsyncCallback* callback, ::Il2CppObject* object);
