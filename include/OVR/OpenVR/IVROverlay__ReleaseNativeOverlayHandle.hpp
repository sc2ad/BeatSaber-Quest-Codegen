...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1660
  class IVROverlay::_ReleaseNativeOverlayHandle : public System::MulticastDelegate {
    ...
    // Offset: 0x1D4A040
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pNativeTextureHandle);
    ...
    // Offset: 0x1D4A2C4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pNativeTextureHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
