...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_ReleaseNativeOverlayHandle : public System::MulticastDelegate {
    ...
    // Offset: 0x1521730
    static IVROverlay::_ReleaseNativeOverlayHandle* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x15219C8
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, System::IntPtr pNativeTextureHandle, System::AsyncCallback* callback, ::CsObject* object);
