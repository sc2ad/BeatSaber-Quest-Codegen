...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1D54
  class IVRSpatialAnchors::_GetSpatialAnchorPose : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE4D68
    OVR::OpenVR::EVRSpatialAnchorError Invoke_NEW(uint unHandle, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, OVR::OpenVR::SpatialAnchorPose_t& pPoseOut);
    ...
    // Offset: 0x1EE5008
    System::IAsyncResult* BeginInvoke_NEW(uint unHandle, OVR::OpenVR::ETrackingUniverseOrigin eOrigin, OVR::OpenVR::SpatialAnchorPose_t& pPoseOut, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRSpatialAnchorError EndInvoke(ref OVR.OpenVR.SpatialAnchorPose_t pPoseOut, System.IAsyncResult result)
    // Offset: 0x1EE50DC
    OVR::OpenVR::EVRSpatialAnchorError EndInvoke_NEW(OVR::OpenVR::SpatialAnchorPose_t& pPoseOut, System::IAsyncResult* result);
