...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1430
  class IVROverlay::_SetOverlayTransformTrackedDeviceRelative : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED786C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint unTrackedDevice, OVR::OpenVR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform);
    ...
    // Offset: 0x1ED7B08
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint unTrackedDevice, OVR::OpenVR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1ED7BDC
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::IAsyncResult* result);
