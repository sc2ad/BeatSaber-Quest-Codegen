...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE088C
  class IVRTrackedCamera::_GetCameraErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x112E5B0
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVRTrackedCameraError eCameraError);
    ...
    // Offset: 0x112E828
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRTrackedCameraError eCameraError, System::AsyncCallback* callback, ::Il2CppObject* object);
