...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(Texture_t), 12 + sizeof(OVR::OpenVR::EColorSpace) + ((12 + sizeof(OVR::OpenVR::EColorSpace)) % 8 != 0 ? (8 - (12 + sizeof(OVR::OpenVR::EColorSpace)) % 8) : 0)> __OVR_OpenVR_Texture_tSizeCheck;
}
