...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D84A38
  class IVRCompositor::_CompositorQuit : public System::MulticastDelegate {
    ...
    static IVRCompositor::_CompositorQuit* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OVR::OpenVR").WithContext("_CompositorQuit").WithContext(".ctor");
