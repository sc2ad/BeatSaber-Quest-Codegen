...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(CVRSystem::GetControllerStateUnion), 0 + sizeof(void*) + ((0 + sizeof(void*)) % 8 != 0 ? (8 - (0 + sizeof(void*)) % 8) : 0)> __OVR_OpenVR_CVRSystem_GetControllerStateUnionSizeCheck;
}
