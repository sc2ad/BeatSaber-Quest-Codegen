...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1980
  class IVRSettings::_GetSettingsErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE1648
    System::IntPtr Invoke_NEW(OVR::OpenVR::EVRSettingsError eError);
    ...
    // Offset: 0x1EE18C0
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::EVRSettingsError eError, System::AsyncCallback* callback, ::Il2CppObject* object);
