...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE13E0
  class IVROverlay::_SetOverlayRenderModel : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED5530
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchRenderModel, OVR::OpenVR::HmdColor_t& pColor);
    ...
    // Offset: 0x1ED57CC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchRenderModel, OVR::OpenVR::HmdColor_t& pColor, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref OVR.OpenVR.HmdColor_t pColor, System.IAsyncResult result)
    // Offset: 0x1ED5884
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::HmdColor_t& pColor, System::IAsyncResult* result);
