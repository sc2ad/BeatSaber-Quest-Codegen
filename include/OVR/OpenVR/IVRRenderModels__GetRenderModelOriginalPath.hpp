...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1930
  class IVRRenderModels::_GetRenderModelOriginalPath : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDC564
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchOriginalPath, uint unOriginalPathLen, OVR::OpenVR::EVRRenderModelError& peError);
    ...
    // Offset: 0x1EDC9A4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchOriginalPath, uint unOriginalPathLen, OVR::OpenVR::EVRRenderModelError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
