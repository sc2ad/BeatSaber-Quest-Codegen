...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1390
  class IVROverlay::_GetOverlayTextureColorSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1D463D8
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace& peTextureColorSpace);
    ...
    // Offset: 0x1D4665C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace& peTextureColorSpace, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref OVR.OpenVR.EColorSpace peTextureColorSpace, System.IAsyncResult result)
    // Offset: 0x1D4670C
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::EColorSpace& peTextureColorSpace, System::IAsyncResult* result);
