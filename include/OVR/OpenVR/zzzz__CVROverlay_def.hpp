...
namespace OVR::OpenVR {
class ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked;
}
namespace OVR::OpenVR {
struct ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion;
}
...
class CORDL_TYPE ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked() = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked", modifiers: " const&", def_value: None }]
constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked(____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked", modifiers: "&&", def_value: None }]
constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked(____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked& operator=(____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked&& o) noexcept = default;
  constexpr ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked& operator=(____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked const& o) noexcept = default;
...
explicit ____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
struct CORDL_TYPE ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "pPollNextOverlayEvent", ty: "::OVR::OpenVR::____OVR__OpenVR__IVROverlay___PollNextOverlayEvent", modifiers: "", def_value: None }, CppParam { name: "pPollNextOverlayEventPacked", ty: "::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked", modifiers: "", def_value: None }]
constexpr ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion(::OVR::OpenVR::____OVR__OpenVR__IVROverlay___PollNextOverlayEvent pPollNextOverlayEvent, ::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked pPollNextOverlayEventPacked) noexcept;


                    constexpr ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion(____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion const&) = default;
                    constexpr ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion(____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion&&) = default;
                    constexpr ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion& operator=(____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion& operator=(____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion&& o) noexcept {
...
constexpr explicit ____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 ::OVR::OpenVR::____OVR__OpenVR__IVROverlay___PollNextOverlayEvent __declspec(property(get=__get_pPollNextOverlayEvent, put=__set_pPollNextOverlayEvent))  pPollNextOverlayEvent;

constexpr void __set_pPollNextOverlayEvent(::OVR::OpenVR::____OVR__OpenVR__IVROverlay___PollNextOverlayEvent value) ;

constexpr ::OVR::OpenVR::____OVR__OpenVR__IVROverlay___PollNextOverlayEvent __get_pPollNextOverlayEvent() const;

 ::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked __declspec(property(get=__get_pPollNextOverlayEventPacked, put=__set_pPollNextOverlayEventPacked))  pPollNextOverlayEventPacked;

constexpr void __set_pPollNextOverlayEventPacked(::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked value) ;

constexpr ::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked __get_pPollNextOverlayEventPacked() const;
...
public:
// Declarations
using PollNextOverlayEventUnion = ::OVR::OpenVR::____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion;

using _PollNextOverlayEventPacked = ::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked;
...
NEED_NO_BOX(::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked);
DEFINE_IL2CPP_ARG_TYPE(::OVR::OpenVR::____OVR__OpenVR__CVROverlay___PollNextOverlayEventPacked, "OVR.OpenVR", "CVROverlay/_PollNextOverlayEventPacked");
DEFINE_IL2CPP_ARG_TYPE(::OVR::OpenVR::____OVR__OpenVR__CVROverlay__PollNextOverlayEventUnion, "OVR.OpenVR", "CVROverlay/PollNextOverlayEventUnion");
