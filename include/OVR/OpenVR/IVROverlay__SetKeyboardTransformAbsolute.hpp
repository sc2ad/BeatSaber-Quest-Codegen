...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1764
  class IVROverlay::_SetKeyboardTransformAbsolute : public System::MulticastDelegate {
    ...
    // Offset: 0x1D4B104
    void Invoke_NEW(OVR::OpenVR::ETrackingUniverseOrigin eTrackingOrigin, OVR::OpenVR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform);
    ...
    // Offset: 0x1D4B394
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::ETrackingUniverseOrigin eTrackingOrigin, OVR::OpenVR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D4B448
    void EndInvoke_NEW(OVR::OpenVR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform, System::IAsyncResult* result);
