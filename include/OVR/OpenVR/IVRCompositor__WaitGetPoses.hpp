...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0E40
  class IVRCompositor::_WaitGetPoses : public System::MulticastDelegate {
    ...
    // Offset: 0x1D37A10
    OVR::OpenVR::EVRCompositorError Invoke_NEW(::Array<OVR::OpenVR::TrackedDevicePose_t>*& pRenderPoseArray, uint unRenderPoseArrayCount, ::Array<OVR::OpenVR::TrackedDevicePose_t>*& pGamePoseArray, uint unGamePoseArrayCount);
    ...
    // Offset: 0x1D37CBC
    System::IAsyncResult* BeginInvoke_NEW(::Array<OVR::OpenVR::TrackedDevicePose_t>*& pRenderPoseArray, uint unRenderPoseArrayCount, ::Array<OVR::OpenVR::TrackedDevicePose_t>*& pGamePoseArray, uint unGamePoseArrayCount, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRCompositorError EndInvoke(System.IAsyncResult result)
    // Offset: 0x1D37D70
    OVR::OpenVR::EVRCompositorError EndInvoke_NEW(System::IAsyncResult* result);
