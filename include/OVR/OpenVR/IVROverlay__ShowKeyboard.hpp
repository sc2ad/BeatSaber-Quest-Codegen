...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1714
  class IVROverlay::_ShowKeyboard : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED8368
    OVR::OpenVR::EVROverlayError Invoke_NEW(int eInputMode, int eLineInputMode, ::Il2CppString* pchDescription, uint unCharMax, ::Il2CppString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
