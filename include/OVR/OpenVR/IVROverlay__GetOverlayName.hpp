...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE11EC
  class IVROverlay::_GetOverlayName : public System::MulticastDelegate {
    ...
    // Offset: 0x1D44940
    uint Invoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, OVR::OpenVR::EVROverlayError& pError);
    ...
    // Offset: 0x1D44BF8
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, OVR::OpenVR::EVROverlayError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref OVR.OpenVR.EVROverlayError pError, System.IAsyncResult result)
    // Offset: 0x1D44CD0
    uint EndInvoke_NEW(OVR::OpenVR::EVROverlayError& pError, System::IAsyncResult* result);
