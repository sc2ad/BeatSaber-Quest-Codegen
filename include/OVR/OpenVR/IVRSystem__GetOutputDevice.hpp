...
namespace OVR::OpenVR {
  ...
  class IVRSystem::_GetOutputDevice : public System::MulticastDelegate {
    ...
    // Offset: 0x16A516C
    static IVRSystem::_GetOutputDevice* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x16A5404
    System::IAsyncResult* BeginInvoke(uint64_t& pnDevice, OVR::OpenVR::ETextureType textureType, System::IntPtr pInstance, System::AsyncCallback* callback, ::CsObject* object);
