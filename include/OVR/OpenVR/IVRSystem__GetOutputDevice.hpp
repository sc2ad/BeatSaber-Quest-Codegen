...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0544
  class IVRSystem::_GetOutputDevice : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE9A48
    void Invoke_NEW(uint64_t& pnDevice, OVR::OpenVR::ETextureType textureType, System::IntPtr pInstance);
    ...
    // Offset: 0x1EE9CD0
    System::IAsyncResult* BeginInvoke_NEW(uint64_t& pnDevice, OVR::OpenVR::ETextureType textureType, System::IntPtr pInstance, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref System.UInt64 pnDevice, System.IAsyncResult result)
    // Offset: 0x1EE9DA0
    void EndInvoke_NEW(uint64_t& pnDevice, System::IAsyncResult* result);
