...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE08C8
  class IVRTrackedCamera::_GetCameraIntrinsics : public System::MulticastDelegate {
    ...
    // Offset: 0x112ED18
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, OVR::OpenVR::HmdVector2_t& pFocalLength, OVR::OpenVR::HmdVector2_t& pCenter);
    ...
    // Offset: 0x112EFD4
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, OVR::OpenVR::EVRTrackedCameraFrameType eFrameType, OVR::OpenVR::HmdVector2_t& pFocalLength, OVR::OpenVR::HmdVector2_t& pCenter, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x112F0BC
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(OVR::OpenVR::HmdVector2_t& pFocalLength, OVR::OpenVR::HmdVector2_t& pCenter, System::IAsyncResult* result);
