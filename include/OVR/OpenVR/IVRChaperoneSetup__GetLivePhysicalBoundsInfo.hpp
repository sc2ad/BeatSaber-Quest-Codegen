...
namespace OVR::OpenVR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF3364
  class IVRChaperoneSetup::_GetLivePhysicalBoundsInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x15C6E9C
    bool Invoke(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer, ByRef<uint> punQuadsCount);
    ...
    // Offset: 0x15CE2A8
    System::IAsyncResult* BeginInvoke(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer, ByRef<uint> punQuadsCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (OVR::OpenVR::IVRChaperoneSetup::_GetLivePhysicalBoundsInfo::*)(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*>, ByRef<uint>)>(&OVR::OpenVR::IVRChaperoneSetup::_GetLivePhysicalBoundsInfo::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRChaperoneSetup::_GetLivePhysicalBoundsInfo::*)(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*>, ByRef<uint>, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRChaperoneSetup::_GetLivePhysicalBoundsInfo::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pQuadsBuffer = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "HmdQuad_t"), 1)->this_arg;
    static auto* punQuadsCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->this_arg;
