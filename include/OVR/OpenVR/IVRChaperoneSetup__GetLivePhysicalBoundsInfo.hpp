...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0DDC
  class IVRChaperoneSetup::_GetLivePhysicalBoundsInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x13F5D38
    bool Invoke_NEW(::Array<OVR::OpenVR::HmdQuad_t>*& pQuadsBuffer, uint& punQuadsCount);
    ...
    // Offset: 0x13FD144
    System::IAsyncResult* BeginInvoke_NEW(::Array<OVR::OpenVR::HmdQuad_t>*& pQuadsBuffer, uint& punQuadsCount, System::AsyncCallback* callback, ::Il2CppObject* object);
