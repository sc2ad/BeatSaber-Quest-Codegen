...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0698
  class IVRSystem::_GetUint64TrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1EEC738
    uint64_t Invoke_NEW(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1EECAAC
    uint64_t EndInvoke_NEW(OVR::OpenVR::ETrackedPropertyError& pError, System::IAsyncResult* result);
