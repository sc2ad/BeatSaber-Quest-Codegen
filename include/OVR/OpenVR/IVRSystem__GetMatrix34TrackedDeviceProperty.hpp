...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE06AC
  class IVRSystem::_GetMatrix34TrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE963C
    OVR::OpenVR::HmdMatrix34_t Invoke_NEW(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1EE99F0
    OVR::OpenVR::HmdMatrix34_t EndInvoke_NEW(OVR::OpenVR::ETrackedPropertyError& pError, System::IAsyncResult* result);
