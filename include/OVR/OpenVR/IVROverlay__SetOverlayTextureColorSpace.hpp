...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE137C
  class IVROverlay::_SetOverlayTextureColorSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1ED6A0C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace eTextureColorSpace);
    ...
    // Offset: 0x1ED6C90
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace eTextureColorSpace, System::AsyncCallback* callback, ::Il2CppObject* object);
