...
namespace OVR::OpenVR {
  ...
  class IVROverlay::_SetOverlayTextureColorSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1691DF4
    static IVROverlay::_SetOverlayTextureColorSpace* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x169208C
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, OVR::OpenVR::EColorSpace eTextureColorSpace, System::AsyncCallback* callback, ::CsObject* object);
