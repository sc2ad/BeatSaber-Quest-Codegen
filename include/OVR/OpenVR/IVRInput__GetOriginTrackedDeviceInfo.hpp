...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1C8C
  class IVRInput::_GetOriginTrackedDeviceInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3C850
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t origin, OVR::OpenVR::InputOriginInfo_t& pOriginInfo, uint unOriginInfoSize);
    ...
    // Offset: 0x1D3CAEC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t origin, OVR::OpenVR::InputOriginInfo_t& pOriginInfo, uint unOriginInfoSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRInputError EndInvoke(ref OVR.OpenVR.InputOriginInfo_t pOriginInfo, System.IAsyncResult result)
    // Offset: 0x1D3CBC0
    OVR::OpenVR::EVRInputError EndInvoke_NEW(OVR::OpenVR::InputOriginInfo_t& pOriginInfo, System::IAsyncResult* result);
