...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE19BC
  class IVRSettings::_SetInt32 : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE3320
    void Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, int nValue, OVR::OpenVR::EVRSettingsError& peError);
    ...
    // Offset: 0x1EE3758
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, int nValue, OVR::OpenVR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
