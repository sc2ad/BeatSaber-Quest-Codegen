...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE065C
  class IVRSystem::_GetBoolTrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE6588
    bool Invoke_NEW(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1EE6900
    bool EndInvoke_NEW(OVR::OpenVR::ETrackedPropertyError& pError, System::IAsyncResult* result);
