...
namespace OVR::OpenVR {
  ...
  struct IVRChaperone/*, public ::System::ValueType*/ {
    ...
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_GetCalibrationState*& dyn_GetCalibrationState();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._GetPlayAreaSize GetPlayAreaSize
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_GetPlayAreaSize*& dyn_GetPlayAreaSize();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._GetPlayAreaRect GetPlayAreaRect
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_GetPlayAreaRect*& dyn_GetPlayAreaRect();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._ReloadInfo ReloadInfo
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_ReloadInfo*& dyn_ReloadInfo();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._SetSceneColor SetSceneColor
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_SetSceneColor*& dyn_SetSceneColor();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._GetBoundsColor GetBoundsColor
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_GetBoundsColor*& dyn_GetBoundsColor();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._AreBoundsVisible AreBoundsVisible
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_AreBoundsVisible*& dyn_AreBoundsVisible();
    // Get instance field reference: OVR.OpenVR.IVRChaperone/OVR.OpenVR._ForceBoundsVisible ForceBoundsVisible
    [[deprecated("Use field access instead!")]] ::OVR::OpenVR::IVRChaperone::_ForceBoundsVisible*& dyn_ForceBoundsVisible();
