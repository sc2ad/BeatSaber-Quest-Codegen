...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0B5C
  class IVRApplications::_GetStartingApplication : public System::MulticastDelegate {
    ...
    // Offset: 0x13F0538
    OVR::OpenVR::EVRApplicationError Invoke_NEW(System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
    ...
    // Offset: 0x13FC104
    System::IAsyncResult* BeginInvoke_NEW(System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen, System::AsyncCallback* callback, ::Il2CppObject* object);
