...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1174
  class IVROverlay::_FindOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1D40E9C
    OVR::OpenVR::EVROverlayError Invoke_NEW(::Il2CppString* pchOverlayKey, uint64_t& pOverlayHandle);
    ...
    // Offset: 0x1D4128C
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchOverlayKey, uint64_t& pOverlayHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref System.UInt64 pOverlayHandle, System.IAsyncResult result)
    // Offset: 0x1D41328
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint64_t& pOverlayHandle, System::IAsyncResult* result);
