...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0670
  class IVRSystem::_GetFloatTrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1EE8B40
    float Invoke_NEW(uint unDeviceIndex, OVR::OpenVR::ETrackedDeviceProperty prop, OVR::OpenVR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1EE8EB4
    float EndInvoke_NEW(OVR::OpenVR::ETrackedPropertyError& pError, System::IAsyncResult* result);
