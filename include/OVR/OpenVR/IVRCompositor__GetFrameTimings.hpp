...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0ECC
  class IVRCompositor::_GetFrameTimings : public System::MulticastDelegate {
    ...
    // Offset: 0x1D32C1C
    uint Invoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, uint nFrames);
    ...
    // Offset: 0x1D32E98
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, uint nFrames, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref OVR.OpenVR.Compositor_FrameTiming pTiming, System.IAsyncResult result)
    // Offset: 0x1D32F4C
    uint EndInvoke_NEW(OVR::OpenVR::Compositor_FrameTiming& pTiming, System::IAsyncResult* result);
