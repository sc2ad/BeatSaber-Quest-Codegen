...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(RenderModel_TextureMap_t), 8 + sizeof(System::IntPtr) + ((8 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (8 + sizeof(System::IntPtr)) % 8) : 0)> __OVR_OpenVR_RenderModel_TextureMap_tSizeCheck;
}
