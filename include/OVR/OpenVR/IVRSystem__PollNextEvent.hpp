...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE06FC
  class IVRSystem::_PollNextEvent : public System::MulticastDelegate {
    ...
    // Offset: 0x1EED8D8
    bool Invoke_NEW(OVR::OpenVR::VREvent_t& pEvent, uint uncbVREvent);
    ...
    // Offset: 0x1EEDB58
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::VREvent_t& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
