...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1840
  class IVRRenderModels::_LoadIntoTextureD3D11_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDD004
    OVR::OpenVR::EVRRenderModelError Invoke_NEW(int textureId, System::IntPtr pDstTexture);
    ...
    // Offset: 0x1EDD334
    OVR::OpenVR::EVRRenderModelError EndInvoke_NEW(System::IAsyncResult* result);
