...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE15E8
  class IVROverlay::_GetOverlayDualAnalogTransform : public System::MulticastDelegate {
    ...
    // Offset: 0x1D42BE8
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlay, OVR::OpenVR::EDualAnalogWhich eWhich, OVR::OpenVR::HmdVector2_t& pvCenter, float& pfRadius);
    ...
    // Offset: 0x1D42EA0
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlay, OVR::OpenVR::EDualAnalogWhich eWhich, OVR::OpenVR::HmdVector2_t& pvCenter, float& pfRadius, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D42F94
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(OVR::OpenVR::HmdVector2_t& pvCenter, float& pfRadius, System::IAsyncResult* result);
