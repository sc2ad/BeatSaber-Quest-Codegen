...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE12F0
  class IVROverlay::_GetOverlayTexelAspect : public System::MulticastDelegate {
    ...
    // Offset: 0x1D457DC
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfTexelAspect);
    ...
    // Offset: 0x1D45A60
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, float& pfTexelAspect, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVROverlayError EndInvoke(ref System.Single pfTexelAspect, System.IAsyncResult result)
    // Offset: 0x1D45B10
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(float& pfTexelAspect, System::IAsyncResult* result);
