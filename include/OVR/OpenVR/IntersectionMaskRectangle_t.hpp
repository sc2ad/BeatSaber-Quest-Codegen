...
namespace OVR::OpenVR {
  ...
  check_size<sizeof(IntersectionMaskRectangle_t), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __OVR_OpenVR_IntersectionMaskRectangle_tSizeCheck;
}
