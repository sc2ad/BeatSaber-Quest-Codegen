...
namespace OVR::OpenVR {
  ...
  class IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x17D9A2C
    void Invoke(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer, uint unQuadsCount);
    ...
    // Offset: 0x17E2B54
    System::IAsyncResult* BeginInvoke(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*> pQuadsBuffer, uint unQuadsCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (OVR::OpenVR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::*)(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*>, uint)>(&OVR::OpenVR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (OVR::OpenVR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::*)(ByRef<::Array<OVR::OpenVR::HmdQuad_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&OVR::OpenVR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pQuadsBuffer = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("OVR.OpenVR", "HmdQuad_t"), 1)->this_arg;
    static auto* unQuadsCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
