...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE146C
  class IVROverlay::_GetOverlayTransformTrackedDeviceComponent : public System::MulticastDelegate {
    ...
    // Offset: 0x1D4726C
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& punDeviceIndex, System::Text::StringBuilder* pchComponentName, uint unComponentNameSize);
    ...
    // Offset: 0x1D475F4
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint& punDeviceIndex, System::IAsyncResult* result);
