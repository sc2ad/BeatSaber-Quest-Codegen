...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1CA0
  class IVRInput::_ShowActionOrigins : public System::MulticastDelegate {
    ...
    // Offset: 0x1D3E140
    OVR::OpenVR::EVRInputError Invoke_NEW(uint64_t actionSetHandle, uint64_t ulActionHandle);
    ...
    // Offset: 0x1D3E3C4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t actionSetHandle, uint64_t ulActionHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
