...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0EF4
  class IVRCompositor::_GetCumulativeStats : public System::MulticastDelegate {
    ...
    // Offset: 0x1D31A78
    void Invoke_NEW(OVR::OpenVR::Compositor_CumulativeStats& pStats, uint nStatsSizeInBytes);
    ...
    // Offset: 0x1D31CEC
    System::IAsyncResult* BeginInvoke_NEW(OVR::OpenVR::Compositor_CumulativeStats& pStats, uint nStatsSizeInBytes, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref OVR.OpenVR.Compositor_CumulativeStats pStats, System.IAsyncResult result)
    // Offset: 0x1D31DA0
    void EndInvoke_NEW(OVR::OpenVR::Compositor_CumulativeStats& pStats, System::IAsyncResult* result);
