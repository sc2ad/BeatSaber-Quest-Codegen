...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE182C
  class IVRRenderModels::_LoadTextureD3D11_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1EDD844
    OVR::OpenVR::EVRRenderModelError Invoke_NEW(int textureId, System::IntPtr pD3D11Device, System::IntPtr& ppD3D11Texture2D);
    ...
    // Offset: 0x1EDDBAC
    OVR::OpenVR::EVRRenderModelError EndInvoke_NEW(System::IntPtr& ppD3D11Texture2D, System::IAsyncResult* result);
