...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE0904
  class IVRTrackedCamera::_ReleaseVideoStreamingService : public System::MulticastDelegate {
    ...
    // Offset: 0x1130D40
    OVR::OpenVR::EVRTrackedCameraError Invoke_NEW(uint64_t hTrackedCamera);
    // public System.IAsyncResult BeginInvoke(System.UInt64 hTrackedCamera, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1130FA4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t hTrackedCamera, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public OVR.OpenVR.EVRTrackedCameraError EndInvoke(System.IAsyncResult result)
    // Offset: 0x1131030
    OVR::OpenVR::EVRTrackedCameraError EndInvoke_NEW(System::IAsyncResult* result);
