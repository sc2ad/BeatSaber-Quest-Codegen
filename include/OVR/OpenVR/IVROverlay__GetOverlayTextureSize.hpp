...
namespace OVR::OpenVR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE1674
  class IVROverlay::_GetOverlayTextureSize : public System::MulticastDelegate {
    ...
    // Offset: 0x1D46754
    OVR::OpenVR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& pWidth, uint& pHeight);
    ...
    // Offset: 0x1D469F0
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint& pWidth, uint& pHeight, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1D46ABC
    OVR::OpenVR::EVROverlayError EndInvoke_NEW(uint& pWidth, uint& pHeight, System::IAsyncResult* result);
