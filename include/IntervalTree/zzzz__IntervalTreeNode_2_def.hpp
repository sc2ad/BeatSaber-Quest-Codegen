...
namespace IntervalTree {
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
class IntervalTree__IntervalTreeNode_2____c<TKey,TValue>;
}
// Type: ::<>c
...
class CORDL_TYPE IntervalTree__IntervalTreeNode_2____c<TKey,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~IntervalTree__IntervalTreeNode_2____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "IntervalTree__IntervalTreeNode_2____c", modifiers: " const&", def_value: None }]
constexpr IntervalTree__IntervalTreeNode_2____c(IntervalTree__IntervalTreeNode_2____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "IntervalTree__IntervalTreeNode_2____c", modifiers: "&&", def_value: None }]
constexpr IntervalTree__IntervalTreeNode_2____c(IntervalTree__IntervalTreeNode_2____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit IntervalTree__IntervalTreeNode_2____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr IntervalTree__IntervalTreeNode_2____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr IntervalTree__IntervalTreeNode_2____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr IntervalTree__IntervalTreeNode_2____c& operator=(IntervalTree__IntervalTreeNode_2____c&& o) noexcept = default;
  constexpr IntervalTree__IntervalTreeNode_2____c& operator=(IntervalTree__IntervalTreeNode_2____c const& o) noexcept = default;
                


// Fields

static IntervalTree::IntervalTree__IntervalTreeNode_2____c<TKey,TValue> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(IntervalTree::IntervalTree__IntervalTreeNode_2____c<TKey,TValue> value) ;

static IntervalTree::IntervalTree__IntervalTreeNode_2____c<TKey,TValue> __get___9() ;
...
public:
// Declarations
using __c = IntervalTree::IntervalTree__IntervalTreeNode_2____c<TKey, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(IntervalTree::IntervalTree__IntervalTreeNode_2____c, "IntervalTree", "IntervalTreeNode`2/<>c");
