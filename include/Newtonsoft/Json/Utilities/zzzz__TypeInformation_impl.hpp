...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (Newtonsoft::Json::Utilities::TypeInformation::*)()>(&Newtonsoft::Json::Utilities::TypeInformation::get_Type)> {
  ...
  constexpr static std::size_t addrs = 0x24e3c38;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Utilities::TypeInformation::*)(System::Type)>(&Newtonsoft::Json::Utilities::TypeInformation::set_Type)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24e3c40;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Newtonsoft::Json::Utilities::PrimitiveTypeCode (Newtonsoft::Json::Utilities::TypeInformation::*)()>(&Newtonsoft::Json::Utilities::TypeInformation::get_TypeCode)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24e3c48;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Utilities::TypeInformation::*)(Newtonsoft::Json::Utilities::PrimitiveTypeCode)>(&Newtonsoft::Json::Utilities::TypeInformation::set_TypeCode)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24e3c50;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Utilities::TypeInformation::*)()>(&Newtonsoft::Json::Utilities::TypeInformation::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24e3c58;
...
constexpr System::Type Newtonsoft::Json::Utilities::TypeInformation::__get__Type_k__BackingField() const {
...
::cordl_internals::setInstanceField<Newtonsoft::Json::Utilities::PrimitiveTypeCode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Newtonsoft::Json::Utilities::PrimitiveTypeCode>(value));
}
constexpr Newtonsoft::Json::Utilities::PrimitiveTypeCode Newtonsoft::Json::Utilities::TypeInformation::__get__TypeCode_k__BackingField() const {
return ::cordl_internals::getInstanceField<Newtonsoft::Json::Utilities::PrimitiveTypeCode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 Newtonsoft::Json::Utilities::TypeInformation Newtonsoft::Json::Utilities::TypeInformation::New_ctor()  {
Newtonsoft::Json::Utilities::TypeInformation o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::Utilities::TypeInformation>())};
return o;
}
 void Newtonsoft::Json::Utilities::TypeInformation::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::Utilities::TypeInformation>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
