...
namespace Newtonsoft::Json::Utilities {
template<typename TKey,typename TValue>
class ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c;
}
namespace Newtonsoft::Json::Utilities {
...
namespace Newtonsoft::Json::Utilities {
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
class ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey,TValue>;
}
namespace Newtonsoft::Json::Utilities {
template<typename TKey,typename TValue,typename TEnumeratorKey,typename TEnumeratorValue>
struct ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2;
}
namespace Newtonsoft::Json::Utilities {
...
struct ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2<TKey,TValue,TEnumeratorKey,TEnumeratorValue>;
}
...
struct CORDL_TYPE ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2<TKey,TValue,TEnumeratorKey,TEnumeratorValue> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2(::System::Collections::Generic::IEnumerator_1<::System::Collections::Generic::KeyValuePair_2<TEnumeratorKey,TEnumeratorValue>> _e) noexcept;


                    constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2(____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2 const&) = default;
                    constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2(____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2&&) = default;
                    constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2& operator=(____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2& operator=(____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2&& o) noexcept {
...
constexpr explicit ____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c(____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c(____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c& operator=(____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c& operator=(____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c const& o) noexcept = default;
                


// Fields

static ::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey,TValue> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey,TValue> value) ;

static ::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey,TValue> __get___9() ;
...
// Ctor Parameters []
explicit ____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c() ;
...
public:
// Declarations
using __c = ::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c<TKey, TValue>;

template<typename TEnumeratorKey,typename TEnumeratorValue>
using DictionaryEnumerator_2 = ::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2<TKey, TValue, TKey, TValue, TEnumeratorKey, TEnumeratorValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2____c, "Newtonsoft.Json.Utilities", "DictionaryWrapper`2/<>c");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__DictionaryWrapper_2__DictionaryEnumerator_2, "Newtonsoft.Json.Utilities", "DictionaryWrapper`2/DictionaryEnumerator`2");
