...
class ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1;
}
namespace Newtonsoft::Json::Utilities {
class StringUtils;
}
...
class ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1<TSource>;
}
...
// Declarations
template<typename TSource>
using __c__DisplayClass15_0_1 = ::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1<TSource>;
...
class CORDL_TYPE ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1<TSource> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1(____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1(____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1& operator=(____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1& operator=(____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Newtonsoft::Json::Utilities::____Newtonsoft__Json__Utilities__StringUtils____c__DisplayClass15_0_1, "Newtonsoft.Json.Utilities", "StringUtils/<>c__DisplayClass15_0`1");
