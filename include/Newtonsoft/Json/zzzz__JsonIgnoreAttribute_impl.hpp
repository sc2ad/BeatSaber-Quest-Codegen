...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::JsonIgnoreAttribute::*)()>(&Newtonsoft::Json::JsonIgnoreAttribute::_ctor)> {
 ...
 Newtonsoft::Json::JsonIgnoreAttribute Newtonsoft::Json::JsonIgnoreAttribute::New_ctor()  {
Newtonsoft::Json::JsonIgnoreAttribute o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::JsonIgnoreAttribute>())};
return o;
}
