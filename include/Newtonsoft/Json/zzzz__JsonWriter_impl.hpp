...
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Newtonsoft__Json__JsonWriter__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Start{0};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Property{1};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::ObjectStart{2};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Object{3};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::ArrayStart{4};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Array{5};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::ConstructorStart{6};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Constructor{7};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Closed{8};
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State  Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State::Error{9};
//  Writing Method size for method: Newtonsoft::Json::JsonWriter.BuildStateArray
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> (*)()>(&Newtonsoft::Json::JsonWriter::BuildStateArray)> {
...
return System::IDisposable(::bs_hook::Il2CppWrapperType::instance);
 ...
 void Newtonsoft::Json::JsonWriter::__set_StateArray(::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> value)  {
::cordl_internals::setStaticField<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>, "StateArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::JsonWriter>::get>(std::forward<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>>(value));
}
 ::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> Newtonsoft::Json::JsonWriter::__get_StateArray()  {
return ::cordl_internals::getStaticField<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>, "StateArray", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::JsonWriter>::get>();
}
 void Newtonsoft::Json::JsonWriter::__set_StateArrayTempate(::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> value)  {
::cordl_internals::setStaticField<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>, "StateArrayTempate", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::JsonWriter>::get>(std::forward<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>>(value));
}
 ::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> Newtonsoft::Json::JsonWriter::__get_StateArrayTempate()  {
return ::cordl_internals::getStaticField<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>, "StateArrayTempate", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::JsonWriter>::get>();
}
...
constexpr void Newtonsoft::Json::JsonWriter::__set__currentState(Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State value)  {
::cordl_internals::setInstanceField<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>(value));
}
constexpr Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State Newtonsoft::Json::JsonWriter::__get__currentState() const {
return ::cordl_internals::getInstanceField<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<System::Globalization::CultureInfo, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 ::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>> Newtonsoft::Json::JsonWriter::BuildStateArray()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::JsonWriter>::get(),
                            "BuildStateArray",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::ArrayW<Newtonsoft::Json::Newtonsoft__Json__JsonWriter__State>>, false>(nullptr, ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 Newtonsoft::Json::JsonWriter Newtonsoft::Json::JsonWriter::New_ctor()  {
Newtonsoft::Json::JsonWriter o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::JsonWriter>())};
return o;
}
