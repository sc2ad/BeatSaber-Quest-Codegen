...
namespace Newtonsoft::Json {
class ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0;
}
...
class CORDL_TYPE ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0(____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0(____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0& operator=(____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0& operator=(____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0() ;
...
public:
// Declarations
using __c__DisplayClass90_0 = ::Newtonsoft::Json::____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0;
...
NEED_NO_BOX(::Newtonsoft::Json::____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::____Newtonsoft__Json__JsonSerializerSettings____c__DisplayClass90_0, "Newtonsoft.Json", "JsonSerializerSettings/<>c__DisplayClass90_0");
