...
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::____Newtonsoft__Json__JsonReader__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Start{0};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Complete{1};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Property{2};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::ObjectStart{3};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Object{4};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::ArrayStart{5};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Array{6};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Closed{7};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::PostValue{8};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::ConstructorStart{9};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Constructor{10};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Error{11};
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State  ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State::Finished{12};
//  Writing Method size for method: ::Newtonsoft::Json::JsonReader.get_CurrentState
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State (::Newtonsoft::Json::JsonReader::*)()>(&::Newtonsoft::Json::JsonReader::get_CurrentState)> {
...
constexpr void ::Newtonsoft::Json::JsonReader::__set__currentState(::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State value)  {
::cordl_internals::setInstanceField<::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State, 0x24>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State>(value));
}
constexpr ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State ::Newtonsoft::Json::JsonReader::__get__currentState() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<bool, 0x71>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 ::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State ::Newtonsoft::Json::JsonReader::get_CurrentState()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::JsonReader>::get(),
                            "get_CurrentState",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::Newtonsoft::Json::____Newtonsoft__Json__JsonReader__State, false>(const_cast<void*>(instance), ___internal_method);
}
