...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, objectType);
 ...
 Newtonsoft::Json::Converters::KeyValuePairConverter Newtonsoft::Json::Converters::KeyValuePairConverter::New_ctor()  {
Newtonsoft::Json::Converters::KeyValuePairConverter o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::Converters::KeyValuePairConverter>())};
return o;
}
