...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, objectType);
 ...
 Newtonsoft::Json::Converters::VersionConverter Newtonsoft::Json::Converters::VersionConverter::New_ctor()  {
Newtonsoft::Json::Converters::VersionConverter o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::Converters::VersionConverter>())};
return o;
}
