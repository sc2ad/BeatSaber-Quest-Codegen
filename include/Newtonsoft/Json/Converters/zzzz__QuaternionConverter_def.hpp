...
namespace Newtonsoft::Json::Converters {
class ____Newtonsoft__Json__Converters__QuaternionConverter____c;
}
// Type: ::<>c
namespace Newtonsoft::Json::Converters {
// Is value type: false
...
class CORDL_TYPE ____Newtonsoft__Json__Converters__QuaternionConverter____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____Newtonsoft__Json__Converters__QuaternionConverter____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Converters__QuaternionConverter____c", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c(____Newtonsoft__Json__Converters__QuaternionConverter____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Converters__QuaternionConverter____c", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c(____Newtonsoft__Json__Converters__QuaternionConverter____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__Converters__QuaternionConverter____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c& operator=(____Newtonsoft__Json__Converters__QuaternionConverter____c&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__Converters__QuaternionConverter____c& operator=(____Newtonsoft__Json__Converters__QuaternionConverter____c const& o) noexcept = default;
                


// Fields

static ::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c value) ;

static ::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c __get___9() ;
...
// Ctor Parameters []
explicit ____Newtonsoft__Json__Converters__QuaternionConverter____c() ;
...
public:
// Declarations
using __c = ::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c;
...
NEED_NO_BOX(::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Converters::____Newtonsoft__Json__Converters__QuaternionConverter____c, "Newtonsoft.Json.Converters", "QuaternionConverter/<>c");
