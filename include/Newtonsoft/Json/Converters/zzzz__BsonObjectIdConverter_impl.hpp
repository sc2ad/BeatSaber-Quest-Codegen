...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Converters::BsonObjectIdConverter::*)(::Newtonsoft::Json::JsonWriter, ::bs_hook::Il2CppWrapperType, ::Newtonsoft::Json::JsonSerializer)>(&::Newtonsoft::Json::Converters::BsonObjectIdConverter::WriteJson)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0x253ca9c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::Newtonsoft::Json::Converters::BsonObjectIdConverter),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::bs_hook::Il2CppWrapperType (::Newtonsoft::Json::Converters::BsonObjectIdConverter::*)(::Newtonsoft::Json::JsonReader, ::System::Type, ::bs_hook::Il2CppWrapperType, ::Newtonsoft::Json::JsonSerializer)>(&::Newtonsoft::Json::Converters::BsonObjectIdConverter::ReadJson)> {
  constexpr static std::size_t size = 0x190;
  constexpr static std::size_t addrs = 0x253cb9c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Newtonsoft::Json::Converters::BsonObjectIdConverter::*)(::System::Type)>(&::Newtonsoft::Json::Converters::BsonObjectIdConverter::CanConvert)> {
  ...
  constexpr static std::size_t addrs = 0x253cd2c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Converters::BsonObjectIdConverter::*)()>(&::Newtonsoft::Json::Converters::BsonObjectIdConverter::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x253cdb0;
 ...
 void ::Newtonsoft::Json::Converters::BsonObjectIdConverter::WriteJson(::Newtonsoft::Json::JsonWriter writer, ::bs_hook::Il2CppWrapperType value, ::Newtonsoft::Json::JsonSerializer serializer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Converters::BsonObjectIdConverter>::get(),
                            "WriteJson",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, writer, value, serializer);
 ...
 ::bs_hook::Il2CppWrapperType ::Newtonsoft::Json::Converters::BsonObjectIdConverter::ReadJson(::Newtonsoft::Json::JsonReader reader, ::System::Type objectType, ::bs_hook::Il2CppWrapperType existingValue, ::Newtonsoft::Json::JsonSerializer serializer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Converters::BsonObjectIdConverter>::get(),
                            "ReadJson",
                            std::vector<Il2CppClass*>{},
