...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Forward declaring type: FieldMultipleFilter
...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Linq.JsonPath.FieldMultipleFilter
  // [TokenAttribute] Offset: FFFFFFFF
  // [PreserveAttribute] Offset: FFFFFFFF
  class FieldMultipleFilter : public ::Newtonsoft::Json::Linq::JsonPath::PathFilter {
    public:
    // Nested type: ::Newtonsoft::Json::Linq::JsonPath::FieldMultipleFilter::$$c
    class $$c;
    // Nested type: ::Newtonsoft::Json::Linq::JsonPath::FieldMultipleFilter::$ExecuteFilter$d__4
    ...
    static FieldMultipleFilter* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Newtonsoft::Json::Linq::JsonPath::FieldMultipleFilter::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<FieldMultipleFilter*, creationType>()));
    }
  }; // Newtonsoft.Json.Linq.JsonPath.FieldMultipleFilter
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Newtonsoft::Json::Linq::JsonPath::FieldMultipleFilter::New_ctor
// Il2CppName: .ctor
