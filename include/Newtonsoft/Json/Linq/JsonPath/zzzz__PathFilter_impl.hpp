...
return ::cordl_internals::RunMethodRethrow<Newtonsoft::Json::Linq::JToken, false>(nullptr, ___internal_method, t, errorWhenNoMatch, index);
 ...
 Newtonsoft::Json::Linq::JsonPath::PathFilter Newtonsoft::Json::Linq::JsonPath::PathFilter::New_ctor()  {
Newtonsoft::Json::Linq::JsonPath::PathFilter o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::Linq::JsonPath::PathFilter>())};
return o;
}
