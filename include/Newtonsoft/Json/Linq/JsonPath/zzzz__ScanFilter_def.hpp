...
namespace Newtonsoft::Json::Linq::JsonPath {
class ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4;
}
...
class CORDL_TYPE ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4(____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4(____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4& operator=(____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4& operator=(____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4 const& o) noexcept = default;
...
explicit ____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4(int32_t __1__state) ;
...
public:
// Declarations
using _ExecuteFilter_d__4 = ::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4;
...
NEED_NO_BOX(::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__ScanFilter___ExecuteFilter_d__4, "Newtonsoft.Json.Linq.JsonPath", "ScanFilter/<ExecuteFilter>d__4");
