...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Forward declaring type: ArrayIndexFilter
...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Linq.JsonPath.ArrayIndexFilter
  // [TokenAttribute] Offset: FFFFFFFF
  // [PreserveAttribute] Offset: FFFFFFFF
  class ArrayIndexFilter : public ::Newtonsoft::Json::Linq::JsonPath::PathFilter {
    public:
    // Nested type: ::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter::$ExecuteFilter$d__4
    ...
    static ArrayIndexFilter* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ArrayIndexFilter*, creationType>()));
    }
  }; // Newtonsoft.Json.Linq.JsonPath.ArrayIndexFilter
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter::New_ctor
// Il2CppName: .ctor
