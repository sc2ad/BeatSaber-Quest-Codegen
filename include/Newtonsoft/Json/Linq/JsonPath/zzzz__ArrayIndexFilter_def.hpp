...
class CORDL_TYPE Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4() = default;

// Ctor Parameters [CppParam { name: "", ty: "Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4", modifiers: " const&", def_value: None }]
constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4(Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4", modifiers: "&&", def_value: None }]
constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4(Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4& operator=(Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4&& o) noexcept = default;
  constexpr Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4& operator=(Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4 const& o) noexcept = default;
...
public:
// Declarations
using _ExecuteFilter_d__4 = Newtonsoft::Json::Linq::JsonPath::Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4;
...
NEED_NO_BOX(Newtonsoft::Json::Linq::JsonPath::Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4);
DEFINE_IL2CPP_ARG_TYPE(Newtonsoft::Json::Linq::JsonPath::Newtonsoft__Json__Linq__JsonPath__ArrayIndexFilter___ExecuteFilter_d__4, "Newtonsoft.Json.Linq.JsonPath", "ArrayIndexFilter/<ExecuteFilter>d__4");
