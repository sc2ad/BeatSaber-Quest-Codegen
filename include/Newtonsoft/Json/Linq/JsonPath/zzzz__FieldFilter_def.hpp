...
namespace Newtonsoft::Json::Linq::JsonPath {
class ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4;
}
...
class CORDL_TYPE ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4", modifiers: " const&", def_value: None }]
constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4(____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4", modifiers: "&&", def_value: None }]
constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4(____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4& operator=(____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4&& o) noexcept = default;
  constexpr ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4& operator=(____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4 const& o) noexcept = default;
...
explicit ____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4(int32_t __1__state) ;

/// @brief Method .ctor addr 0x253558c size 0x44 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x25355d8 size 0xb4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x253568c size 0x648 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x2535d84 size 0xb0 virtual false final false
 void __m__Finally1() ;

/// @brief Method <>m__Finally2 addr 0x2535cd4 size 0xb0 virtual false final false
 void __m__Finally2() ;

/// @brief Method System.Collections.Generic.IEnumerator<Newtonsoft.Json.Linq.JToken>.get_Current addr 0x2535e34 size 0x8 virtual true final true
 ::Newtonsoft::Json::Linq::JToken System_Collections_Generic_IEnumerator_Newtonsoft_Json_Linq_JToken__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2535e3c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2535e7c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<Newtonsoft.Json.Linq.JToken>.GetEnumerator addr 0x2535e84 size 0xb0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2535f34 size 0x4 virtual true final true
...
public:
// Declarations
using _ExecuteFilter_d__4 = ::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4;
...
/// @brief Method get_Name addr 0x2535500 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x2535508 size 0x8 virtual false final false
...
NEED_NO_BOX(::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4);
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Linq::JsonPath::____Newtonsoft__Json__Linq__JsonPath__FieldFilter___ExecuteFilter_d__4, "Newtonsoft.Json.Linq.JsonPath", "FieldFilter/<ExecuteFilter>d__4");
