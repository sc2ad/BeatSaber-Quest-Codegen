...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Forward declaring type: ArrayMultipleIndexFilter
...
namespace Newtonsoft::Json::Linq::JsonPath {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: Newtonsoft.Json.Linq.JsonPath.ArrayMultipleIndexFilter
  // [TokenAttribute] Offset: FFFFFFFF
  // [PreserveAttribute] Offset: FFFFFFFF
  class ArrayMultipleIndexFilter : public ::Newtonsoft::Json::Linq::JsonPath::PathFilter {
    public:
    // Nested type: ::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter::$ExecuteFilter$d__4
    ...
    static ArrayMultipleIndexFilter* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ArrayMultipleIndexFilter*, creationType>()));
    }
  }; // Newtonsoft.Json.Linq.JsonPath.ArrayMultipleIndexFilter
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Newtonsoft::Json::Linq::JsonPath::ArrayMultipleIndexFilter::New_ctor
// Il2CppName: .ctor
