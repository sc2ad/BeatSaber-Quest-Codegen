...
namespace Newtonsoft::Json {
  ...
  // [PreserveAttribute] Offset: 122B1EC
  class JsonSerializer : public ::Il2CppObject {
    ...
    ::System::Runtime::Serialization::Formatters::FormatterAssemblyStyle& dyn__typeNameAssemblyFormat();
    ...
    ::System::Runtime::Serialization::SerializationBinder*& dyn__binder();
