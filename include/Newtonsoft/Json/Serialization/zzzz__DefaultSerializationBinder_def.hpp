...
struct CORDL_TYPE ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey(::StringW AssemblyName, ::StringW TypeName) noexcept;


                    constexpr ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey(____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey const&) = default;
                    constexpr ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey(____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey&&) = default;
                    constexpr ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey& operator=(____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey& operator=(____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey&& o) noexcept {
...
constexpr explicit ____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method Equals addr 0x24ff824 size 0x48 virtual false final false
 bool Equals(::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey other) ;
...
public:
// Declarations
using TypeNameKey = ::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey;
...
static ::Newtonsoft::Json::Serialization::DefaultSerializationBinder __get_Instance() ;
 ...
 ::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey,::System::Type> __declspec(property(get=__get__typeCache, put=__set__typeCache))  _typeCache;

constexpr void __set__typeCache(::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey,::System::Type> value) ;

constexpr ::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey,::System::Type> __get__typeCache() const;


// Methods

/// @brief Method GetTypeFromTypeNameKey addr 0x24ff3a4 size 0x220 virtual false final false
static ::System::Type GetTypeFromTypeNameKey(::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey typeNameKey) ;
...
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Serialization::____Newtonsoft__Json__Serialization__DefaultSerializationBinder__TypeNameKey, "Newtonsoft.Json.Serialization", "DefaultSerializationBinder/TypeNameKey");
