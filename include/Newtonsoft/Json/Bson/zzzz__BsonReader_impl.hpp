...
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::Normal{0};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::ReferenceStart{1};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::ReferenceRef{2};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::ReferenceId{3};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::CodeWScopeStart{4};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::CodeWScopeCode{5};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::CodeWScopeScope{6};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::CodeWScopeScopeObject{7};
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState  ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState::CodeWScopeScopeEnd{8};
//  Writing Method size for method: ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::*)(::Newtonsoft::Json::Bson::BsonType)>(&::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x254f174;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>::get(),
                            ".ctor",
...
constexpr void ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__set_Type(::Newtonsoft::Json::Bson::BsonType value)  {
...
constexpr ::Newtonsoft::Json::Bson::BsonType ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__get_Type() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::BsonType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__set_Length(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__get_Length() const {
return ::cordl_internals::getInstanceField<int32_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__set_Position(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::__get_Position() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "type", ty: "::Newtonsoft::Json::Bson::BsonType", modifiers: "", def_value: None }]
 ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::____Newtonsoft__Json__Bson__BsonReader__ContainerContext(::Newtonsoft::Json::Bson::BsonType type)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____Newtonsoft__Json__Bson__BsonReader__ContainerContext>(type))) {}
 void ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext::_ctor(::Newtonsoft::Json::Bson::BsonType type)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::Bson::BsonReader::*)(::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext)>(&::Newtonsoft::Json::Bson::BsonReader::PushContext)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "PushContext",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::Newtonsoft::Json::Bson::BsonReader::__set__stack(::System::Collections::Generic::List_1<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>, 0x80>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>>(value));
}
constexpr ::System::Collections::Generic::List_1<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext> ::Newtonsoft::Json::Bson::BsonReader::__get__stack() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::Newtonsoft::Json::Bson::BsonReader::__set__bsonReaderState(::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState value)  {
::cordl_internals::setInstanceField<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState>(value));
}
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState ::Newtonsoft::Json::Bson::BsonReader::__get__bsonReaderState() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__BsonReaderState, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Newtonsoft::Json::Bson::BsonReader::__set__currentContext(::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext value)  {
::cordl_internals::setInstanceField<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext>(value));
}
constexpr ::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext ::Newtonsoft::Json::Bson::BsonReader::__get__currentContext() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext, 0xa0>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::Newtonsoft::Json::Bson::BsonReader::PushContext(::Newtonsoft::Json::Bson::____Newtonsoft__Json__Bson__BsonReader__ContainerContext newContext)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Newtonsoft::Json::Bson::BsonReader>::get(),
                            "PushContext",
                            std::vector<Il2CppClass*>{},
