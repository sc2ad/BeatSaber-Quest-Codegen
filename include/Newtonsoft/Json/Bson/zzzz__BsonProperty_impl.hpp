...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Newtonsoft::Json::Bson::BsonString (Newtonsoft::Json::Bson::BsonProperty::*)()>(&Newtonsoft::Json::Bson::BsonProperty::get_Name)> {
  ...
  constexpr static std::size_t addrs = 0x2550514;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Bson::BsonProperty::*)(Newtonsoft::Json::Bson::BsonString)>(&Newtonsoft::Json::Bson::BsonProperty::set_Name)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x255051c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Newtonsoft::Json::Bson::BsonToken (Newtonsoft::Json::Bson::BsonProperty::*)()>(&Newtonsoft::Json::Bson::BsonProperty::get_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2550524;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Newtonsoft::Json::Bson::BsonProperty::*)(Newtonsoft::Json::Bson::BsonToken)>(&Newtonsoft::Json::Bson::BsonProperty::set_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x255052c;
...
::cordl_internals::setInstanceField<Newtonsoft::Json::Bson::BsonString, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Newtonsoft::Json::Bson::BsonString>(value));
}
constexpr Newtonsoft::Json::Bson::BsonString Newtonsoft::Json::Bson::BsonProperty::__get__Name_k__BackingField() const {
return ::cordl_internals::getInstanceField<Newtonsoft::Json::Bson::BsonString, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Newtonsoft::Json::Bson::BsonProperty::__set__Value_k__BackingField(Newtonsoft::Json::Bson::BsonToken value)  {
::cordl_internals::setInstanceField<Newtonsoft::Json::Bson::BsonToken, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Newtonsoft::Json::Bson::BsonToken>(value));
}
constexpr Newtonsoft::Json::Bson::BsonToken Newtonsoft::Json::Bson::BsonProperty::__get__Value_k__BackingField() const {
return ::cordl_internals::getInstanceField<Newtonsoft::Json::Bson::BsonToken, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 Newtonsoft::Json::Bson::BsonProperty Newtonsoft::Json::Bson::BsonProperty::New_ctor()  {
Newtonsoft::Json::Bson::BsonProperty o{THROW_UNLESS(::il2cpp_utils::New<Newtonsoft::Json::Bson::BsonProperty>())};
return o;
}
 void Newtonsoft::Json::Bson::BsonProperty::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Newtonsoft::Json::Bson::BsonProperty>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
