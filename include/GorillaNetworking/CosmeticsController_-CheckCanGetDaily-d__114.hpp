...
namespace GorillaNetworking {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: GorillaNetworking.CosmeticsController/GorillaNetworking.<CheckCanGetDaily>d__114
  ...
  }; // GorillaNetworking.CosmeticsController/GorillaNetworking.<CheckCanGetDaily>d__114
  #pragma pack(pop)
