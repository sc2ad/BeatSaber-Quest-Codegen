...
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType::____Unity__XR__Oculus__Boundary__BoundaryType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType  ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType::OuterBoundary{0};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType  ::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType::PlayArea{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType, ByRef<::UnityEngine::Vector3>)>(&::Unity::XR::Oculus::Boundary::GetBoundaryDimensions)> {
  constexpr static std::size_t size = 0x4;
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method);
 ...
 bool ::Unity::XR::Oculus::Boundary::GetBoundaryDimensions(::Unity::XR::Oculus::____Unity__XR__Oculus__Boundary__BoundaryType boundaryType, ByRef<::UnityEngine::Vector3> dimensions)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::Boundary>::get(),
                            "GetBoundaryDimensions",
                            std::vector<Il2CppClass*>{},
