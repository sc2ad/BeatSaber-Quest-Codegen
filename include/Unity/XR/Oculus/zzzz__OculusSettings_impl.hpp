...
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop::MultiPass{0};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop::SinglePassInstanced{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid::MultiPass{0};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid::Multiview{2};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod::____Unity__XR__Oculus__OculusSettings__FoveationMethod(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod::FixedFoveatedRendering{0};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod::EyeTrackedFoveatedRendering{1};
...
constexpr void ::Unity::XR::Oculus::OculusSettings::__set_m_StereoRenderingModeDesktop(::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop value)  {
::cordl_internals::setInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop>(value));
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop ::Unity::XR::Oculus::OculusSettings::__get_m_StereoRenderingModeDesktop() const {
return ::cordl_internals::getInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeDesktop, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Unity::XR::Oculus::OculusSettings::__set_m_StereoRenderingModeAndroid(::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid value)  {
::cordl_internals::setInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid>(value));
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid ::Unity::XR::Oculus::OculusSettings::__get_m_StereoRenderingModeAndroid() const {
return ::cordl_internals::getInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__StereoRenderingModeAndroid, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::Unity::XR::Oculus::OculusSettings::__set_FoveatedRenderingMethod(::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod value)  {
::cordl_internals::setInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod>(value));
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod ::Unity::XR::Oculus::OculusSettings::__get_FoveatedRenderingMethod() const {
return ::cordl_internals::getInstanceField<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusSettings__FoveationMethod, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
