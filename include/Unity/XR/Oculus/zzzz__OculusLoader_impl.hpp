...
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::Supported{0};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::NotSupported{1};
constexpr ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult  ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult::ExitApplication{2};
//  Writing Method size for method: ::Unity::XR::Oculus::OculusLoader.IsDeviceSupported
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult (*)()>(&::Unity::XR::Oculus::OculusLoader::IsDeviceSupported)> {
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::List_1<::UnityEngine::XR::XRInputSubsystemDescriptor>, "s_InputSubsystemDescriptors", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusLoader>::get>();
 ...
 ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult ::Unity::XR::Oculus::OculusLoader::IsDeviceSupported()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::XR::Oculus::OculusLoader>::get(),
                            "IsDeviceSupported",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult, false>(nullptr, ___internal_method);
}
