...
namespace Unity::XR::Oculus {
struct ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult;
}
namespace Unity::XR::Oculus {
class OculusLoader;
}
...
struct CORDL_TYPE ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult(int32_t value__) noexcept;


                    constexpr ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult(____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult const&) = default;
                    constexpr ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult(____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult&&) = default;
                    constexpr ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult& operator=(____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult& operator=(____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult&& o) noexcept {
...
constexpr explicit ____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______Unity__XR__Oculus__OculusLoader__DeviceSupportedResult_Unwrapped : int32_t {
__Supported = 0,
__NotSupported = 1,
__ExitApplication = 2,
};
...
constexpr operator ______Unity__XR__Oculus__OculusLoader__DeviceSupportedResult_Unwrapped () const noexcept {
return std::bit_cast<______Unity__XR__Oculus__OculusLoader__DeviceSupportedResult_Unwrapped>(__instance);
}
...
static ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult const Supported;

/// @brief Field NotSupported offset 0
static ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult const NotSupported;

/// @brief Field ExitApplication offset 0
static ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult const ExitApplication;
...
public:
// Declarations
using DeviceSupportedResult = ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult;
...
static ::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult IsDeviceSupported() ;
...
DEFINE_IL2CPP_ARG_TYPE(::Unity::XR::Oculus::____Unity__XR__Oculus__OculusLoader__DeviceSupportedResult, "Unity.XR.Oculus", "OculusLoader/DeviceSupportedResult");
