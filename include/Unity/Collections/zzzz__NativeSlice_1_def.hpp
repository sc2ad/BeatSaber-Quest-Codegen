...
namespace Unity::Collections {
template<::cordl_internals::is_or_is_backed_by<uint16_t> T>
struct Unity__Collections__NativeSlice_1__Enumerator<T>;
}
namespace Unity::Collections {
template<>
...
// CS Name: Unity.Collections.NativeSlice`1::Enumerator
struct CORDL_TYPE Unity__Collections__NativeSlice_1__Enumerator<T> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr Unity__Collections__NativeSlice_1__Enumerator(Unity::Collections::NativeSlice_1<T> m_Array, int32_t m_Index) noexcept;
...
// Fields
 ...
 Unity::Collections::NativeSlice_1<T> __declspec(property(get=__get_m_Array, put=__set_m_Array))  m_Array;

constexpr void __set_m_Array(Unity::Collections::NativeSlice_1<T> value) ;

constexpr Unity::Collections::NativeSlice_1<T> __get_m_Array() const;
...
/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(ByRef<Unity::Collections::NativeSlice_1<T>> array) ;
...
// CS Name: Unity.Collections.NativeSlice`1
struct CORDL_TYPE NativeSlice_1<T> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
using Enumerator = Unity::Collections::Unity__Collections__NativeSlice_1__Enumerator<T>;
...
constexpr operator  System::IEquatable_1<Unity::Collections::NativeSlice_1<T>>() const;
...
/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(Unity::Collections::NativeSlice_1<T> slice, int32_t start, int32_t length) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(Unity::Collections::NativeArray_1<T> array) ;

/// @brief Method op_Implicit addr 0x0 size 0xffffffffffffffff virtual false final false
static Unity::Collections::NativeSlice_1<T> op_Implicit_Unity__Collections__NativeSlice_1_T_(Unity::Collections::NativeArray_1<T> array) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(Unity::Collections::NativeArray_1<T> array, int32_t start, int32_t length) ;
...
/// @brief Method GetEnumerator addr 0x0 size 0xffffffffffffffff virtual false final false
 Unity::Collections::Unity__Collections__NativeSlice_1__Enumerator<T> GetEnumerator() ;
...
/// @brief Method op_Inequality addr 0x0 size 0xffffffffffffffff virtual false final false
static bool op_Inequality(Unity::Collections::NativeSlice_1<T> left, Unity::Collections::NativeSlice_1<T> right) ;
