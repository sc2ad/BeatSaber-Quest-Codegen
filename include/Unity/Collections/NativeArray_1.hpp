...
namespace Unity::Collections {
  ...
  // [] Offset: FFFFFFFF
  // [NativeContainerSupportsDeallocateOnJobCompletionAttribute] Offset: CA5D6C
  // [DefaultMemberAttribute] Offset: CA5D6C
  // [NativeContainerSupportsMinMaxWriteRestrictionAttribute] Offset: CA5D6C
  // [NativeContainerAttribute] Offset: CA5D6C
  // [DebuggerTypeProxyAttribute] Offset: CA5D6C
  // [DebuggerDisplayAttribute] Offset: CA5D6C
  // [NativeContainerSupportsDeferredConvertListToArray] Offset: CA5D6C
  template<typename T>
  struct NativeArray_1/*, public System::ValueType, public System::IDisposable, public System::Collections::Generic::IEnumerable_1<T>, public System::IEquatable_1<Unity::Collections::NativeArray_1<T>>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [ExcludeFromDocsAttribute] Offset: CA5E58
    struct Enumerator : public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::ValueType, public System::Collections::Generic::IEnumerator_1<T>*/ {
      ...
      // Offset: 0xFFFFFFFF
      void Dispose_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Enumerator::Dispose_NEW");
      ...
      // Offset: 0xFFFFFFFF
      bool MoveNext_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Enumerator::MoveNext_NEW");
      ...
      // Offset: 0xFFFFFFFF
      void Reset_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Enumerator::Reset_NEW");
      ...
      // Offset: 0xFFFFFFFF
      T get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Enumerator::get_Current_NEW");
      ...
      ::Il2CppObject* System_Collections_IEnumerator_get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Enumerator::System.Collections.IEnumerator.get_Current_NEW");
    ...
    // [NativeDisableUnsafePtrRestrictionAttribute] Offset: 0xCAAB64
    ...
    // Offset: 0xFFFFFFFF
    void Dispose_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Dispose_NEW");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(*this, "Dispose", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
      ::il2cpp_utils::RunMethodThrow<void, false>(*this, ___internal__method);
    }
    ...
    System::Collections::Generic::IEnumerator_1<T>* System_Collections_Generic_IEnumerable$T$_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::System.Collections.Generic.IEnumerable<T>.GetEnumerator_NEW");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::System.Collections.IEnumerable.GetEnumerator_NEW");
    ...
    // Offset: 0xFFFFFFFF
    bool Equals_NEW(Unity::Collections::NativeArray_1<T> other) {
      static auto ___internal__logger = ::Logger::get().WithContext("Unity::Collections::NativeArray_1::Equals_NEW");
