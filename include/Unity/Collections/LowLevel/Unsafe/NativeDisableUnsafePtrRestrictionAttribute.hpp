...
namespace Unity::Collections::LowLevel::Unsafe {
  ...
  // [AttributeUsageAttribute] Offset: D8DAA8
  // [RequiredByNativeCodeAttribute] Offset: D8DAA8
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute::*)()>(&Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute::*)()>(&Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Unity::Collections::LowLevel::Unsafe::NativeDisableUnsafePtrRestrictionAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
