...
static Unity::Collections::LowLevel::Unsafe::NativeContainerSupportsDeferredConvertListToArray New_ctor() ;

/// @brief Method .ctor addr 0x2b28ad8 size 0x8 virtual false final false
 void _ctor() ;
