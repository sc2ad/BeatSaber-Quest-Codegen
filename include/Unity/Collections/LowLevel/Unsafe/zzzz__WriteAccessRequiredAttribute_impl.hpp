...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute::*)()>(&Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2b28ae0;
...
Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute o{THROW_UNLESS(::il2cpp_utils::New<Unity::Collections::LowLevel::Unsafe::WriteAccessRequiredAttribute>())};
return o;
}
