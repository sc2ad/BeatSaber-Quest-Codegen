...
constexpr ::Unity::Collections::LowLevel::Unsafe::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1(uint8_t dummy, T data) noexcept : ::bs_hook::ValueTypeWrapper() {this->dummy = dummy;
this->data = data;
}
constexpr void ::Unity::Collections::LowLevel::Unsafe::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1::__set_dummy(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::Unity::Collections::LowLevel::Unsafe::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1::__get_dummy() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->__instance);
}
constexpr void ::Unity::Collections::LowLevel::Unsafe::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1::__set_data(T value)  {
::cordl_internals::setInstanceField<T, 0x8>(this->__instance, std::forward<T>(value));
}
constexpr T ::Unity::Collections::LowLevel::Unsafe::____Unity__Collections__LowLevel__Unsafe__UnsafeUtility__AlignOfHelper_1::__get_data() const {
