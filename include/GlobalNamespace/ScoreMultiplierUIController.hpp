...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ScoreMultiplierUIController), 64 + sizeof(float) + ((64 + sizeof(float)) % 8 != 0 ? (8 - (64 + sizeof(float)) % 8) : 0)> __GlobalNamespace_ScoreMultiplierUIControllerSizeCheck;
}
