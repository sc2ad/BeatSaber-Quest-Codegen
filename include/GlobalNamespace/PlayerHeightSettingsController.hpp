...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerHeightSettingsController), 72 + sizeof(float) + ((72 + sizeof(float)) % 8 != 0 ? (8 - (72 + sizeof(float)) % 8) : 0)> __GlobalNamespace_PlayerHeightSettingsControllerSizeCheck;
}
