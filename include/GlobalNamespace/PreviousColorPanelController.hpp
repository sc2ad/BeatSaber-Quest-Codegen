...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PreviousColorPanelController), 72 + sizeof(UnityEngine::Color) + ((72 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (72 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_PreviousColorPanelControllerSizeCheck;
}
