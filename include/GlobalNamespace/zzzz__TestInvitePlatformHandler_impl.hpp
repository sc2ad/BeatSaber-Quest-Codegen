...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::TestInvitePlatformHandler GlobalNamespace::TestInvitePlatformHandler::New_ctor()  {
GlobalNamespace::TestInvitePlatformHandler o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::TestInvitePlatformHandler>())};
return o;
}
