...
NEED_NO_BOX(::GlobalNamespace::GameplayRpcManager::SliderSpawnedRpc);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::GameplayRpcManager::SliderSpawnedRpc*, "", "GameplayRpcManager/SliderSpawnedRpc");
// Type namespace: 
namespace GlobalNamespace {
  // WARNING Size may be invalid!
  // Autogenerated type: GameplayRpcManager/SliderSpawnedRpc
  ...
  class GameplayRpcManager::SliderSpawnedRpc : public ::GlobalNamespace::RemoteProcedureCall_2<float, ::GlobalNamespace::SliderSpawnInfoNetSerializable*> {
    ...
    static GameplayRpcManager::SliderSpawnedRpc* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<GameplayRpcManager::SliderSpawnedRpc*, creationType>()));
    }
  }; // GameplayRpcManager/SliderSpawnedRpc
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::GameplayRpcManager::SliderSpawnedRpc::New_ctor
// Il2CppName: .ctor
