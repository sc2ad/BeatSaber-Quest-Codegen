...
namespace GlobalNamespace {
  ...
  class LightmapLightsWithIds : public GlobalNamespace::LightWithIds {
    ...
    // Size: 0x8
    // Offset: 0x28
    ::Array<GlobalNamespace::LightmapLightsWithIds::LightIntensitiesData*>* lightIntensityData;
    // Field size check
    static_assert(sizeof(::Array<GlobalNamespace::LightmapLightsWithIds::LightIntensitiesData*>*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xEDEEA8
    ...
    ::Array<GlobalNamespace::LightmapLightsWithIds::LightIntensitiesData*>*& dyn__lightIntensityData();
