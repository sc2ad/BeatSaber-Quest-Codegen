...
namespace GlobalNamespace {
  ...
  class LevelCollectionViewController::$$c__DisplayClass24_0 : public ::Il2CppObject {
    ...
    $$c__DisplayClass24_0(GlobalNamespace::LevelCollectionViewController* $$4__this_ = {}, GlobalNamespace::IPreviewBeatmapLevel* level_ = {}) noexcept : $$4__this{$$4__this_}, level{level_} {}
