...
class CORDL_TYPE GlobalNamespace__BeatEffectSpawner__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~GlobalNamespace__BeatEffectSpawner__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BeatEffectSpawner__InitData", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BeatEffectSpawner__InitData(GlobalNamespace__BeatEffectSpawner__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BeatEffectSpawner__InitData", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BeatEffectSpawner__InitData(GlobalNamespace__BeatEffectSpawner__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BeatEffectSpawner__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BeatEffectSpawner__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BeatEffectSpawner__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BeatEffectSpawner__InitData& operator=(GlobalNamespace__BeatEffectSpawner__InitData&& o) noexcept = default;
  constexpr GlobalNamespace__BeatEffectSpawner__InitData& operator=(GlobalNamespace__BeatEffectSpawner__InitData const& o) noexcept = default;
...
public:
// Declarations
using InitData = GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData;
...
constexpr GlobalNamespace::AudioTimeSyncController __get__audioTimeSyncController() const;
 ...
 GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData __declspec(property(get=__get__initData, put=__set__initData))  _initData;

constexpr void __set__initData(GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData value) ;

constexpr GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData __get__initData() const;
...
/// @brief Method Init addr 0x2258148 size 0x84 virtual false final false
 void Init(GlobalNamespace::GlobalNamespace__BeatEffect__Pool beatEffectPool) ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BeatEffectSpawner__InitData, "", "BeatEffectSpawner/InitData");
