...
class CORDL_TYPE GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0& operator=(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0&& o) noexcept = default;
  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0& operator=(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0 const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0& operator=(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0&& o) noexcept = default;
  constexpr GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0& operator=(GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0 const& o) noexcept = default;
...
public:
// Declarations
using __c__DisplayClass22_0 = GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0;

using __c__DisplayClass20_0 = GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass20_0, "", "CampaignFlowCoordinator/<>c__DisplayClass20_0");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__CampaignFlowCoordinator____c__DisplayClass22_0, "", "CampaignFlowCoordinator/<>c__DisplayClass22_0");
