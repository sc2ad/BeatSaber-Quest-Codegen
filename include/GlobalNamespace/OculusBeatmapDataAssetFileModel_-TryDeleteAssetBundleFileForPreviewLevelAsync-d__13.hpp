...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusBeatmapDataAssetFileModel::$TryDeleteAssetBundleFileForPreviewLevelAsync$d__13), 72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<bool>) + ((72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<bool>)) % 8 != 0 ? (8 - (72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<bool>)) % 8) : 0)> __GlobalNamespace_OculusBeatmapDataAssetFileModel_$TryDeleteAssetBundleFileForPreviewLevelAsync$d__13SizeCheck;
}
