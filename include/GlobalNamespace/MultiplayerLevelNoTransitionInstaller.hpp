...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLevelNoTransitionInstaller), 88 + sizeof(void*) + 8 - (88 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerLevelNoTransitionInstallerSizeCheck;
}
