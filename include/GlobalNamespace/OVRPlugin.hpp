...
namespace GlobalNamespace {
  ...
  class OVRPlugin : public ::CsObject {
    public:
    ...
    static ::CsString* _get__cachedAudioOutString();
    // Set static field: static private System.String _cachedAudioOutString
    static void _set__cachedAudioOutString(::CsString* value);
    ...
    static ::CsString* _get__cachedAudioInString();
    // Set static field: static private System.String _cachedAudioInString
    static void _set__cachedAudioInString(::CsString* value);
    ...
    static ::CsString* _get_pluginName();
    // Set static field: static private System.String pluginName
    static void _set_pluginName(::CsString* value);
    ...
    // Offset: 0xEF711C
    static ::CsString* get_productName();
    // static public System.String get_latency()
    // Offset: 0xEF717C
    static ::CsString* get_latency();
    ...
    // Offset: 0xEE8AA4
    static bool SetDefaultExternalCamera(::CsString* cameraName, GlobalNamespace::OVRPlugin::CameraIntrinsics& cameraIntrinsics, GlobalNamespace::OVRPlugin::CameraExtrinsics& cameraExtrinsics);
    ...
    // Offset: 0xEFB948
    static bool SendEvent(::CsString* name, ::CsString* param, ::CsString* source);
    ...
    // Offset: 0xEFC3DC
    static bool AddCustomMetadata(::CsString* name, ::CsString* param);
