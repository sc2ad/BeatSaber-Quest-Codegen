...
namespace GlobalNamespace {
  ...
  class OVRPlugin : public ::Il2CppObject {
    ...
    check_size<sizeof(OVRPlugin::Vector3f), 8 + sizeof(float) + ((8 + sizeof(float)) % 8 != 0 ? (8 - (8 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRPlugin_Vector3fSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::Quatf), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRPlugin_QuatfSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::Posef), 16 + sizeof(GlobalNamespace::OVRPlugin::Vector3f) + ((16 + sizeof(GlobalNamespace::OVRPlugin::Vector3f)) % 8 != 0 ? (8 - (16 + sizeof(GlobalNamespace::OVRPlugin::Vector3f)) % 8) : 0)> __GlobalNamespace_OVRPlugin_PosefSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::TrackingConfidence), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlugin_TrackingConfidenceSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::HandStatus), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlugin_HandStatusSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::HandFingerPinch), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlugin_HandFingerPinchSizeCheck;
    ...
    check_size<sizeof(OVRPlugin::HandStateInternal), 504 + sizeof(double) + ((504 + sizeof(double)) % 8 != 0 ? (8 - (504 + sizeof(double)) % 8) : 0)> __GlobalNamespace_OVRPlugin_HandStateInternalSizeCheck;
