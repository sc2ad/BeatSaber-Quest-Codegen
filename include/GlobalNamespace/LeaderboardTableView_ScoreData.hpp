...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LeaderboardTableView::ScoreData), 36 + sizeof(bool) + ((36 + sizeof(bool)) % 8 != 0 ? (8 - (36 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_LeaderboardTableView_ScoreDataSizeCheck;
}
