...
namespace GlobalNamespace {
  ...
  class LeaderboardTableView::ScoreData : public ::Il2CppObject {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xF1614C
    ...
    char __padding0[0x4] = {};
    // [CompilerGeneratedAttribute] Offset: 0xF1615C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xF1616C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xF1617C
