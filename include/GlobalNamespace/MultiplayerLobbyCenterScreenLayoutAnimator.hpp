...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLobbyCenterScreenLayoutAnimator), 56 + sizeof(void*) + 8 - (56 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerLobbyCenterScreenLayoutAnimatorSizeCheck;
}
