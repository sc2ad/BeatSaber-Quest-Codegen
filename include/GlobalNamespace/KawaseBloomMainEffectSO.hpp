...
namespace GlobalNamespace {
  ...
  class KawaseBloomMainEffectSO : public GlobalNamespace::MainEffectSO {
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Shader*) == 0x8);
    // [SpaceAttribute] Offset: 0xD0D33C
    // [RangeAttribute] Offset: 0xD0D33C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD0D3BC
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SpaceAttribute] Offset: 0xD0D3F4
    // [RangeAttribute] Offset: 0xD0D3F4
