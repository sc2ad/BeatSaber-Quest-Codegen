...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::____GlobalNamespace__OVRControllerHelper__ControllerType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType  ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::QuestAndRiftS{1};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType  ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::Rift{2};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType  ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::Quest2{3};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType  ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType::TouchPro{4};
...
constexpr void ::GlobalNamespace::OVRControllerHelper::__set_m_controller(::GlobalNamespace::____GlobalNamespace__OVRInput__Controller value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRInput__Controller, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRInput__Controller>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRInput__Controller ::GlobalNamespace::OVRControllerHelper::__get_m_controller() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRInput__Controller, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::OVRControllerHelper::__set_activeControllerType(::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType, 0x74>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType ::GlobalNamespace::OVRControllerHelper::__get_activeControllerType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType, 0x74>(this->::bs_hook::Il2CppWrapperType::instance);
}
