...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerScoreRingManager::*)(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State)>(&::GlobalNamespace::MultiplayerScoreRingManager::HandleStateChanged)> {
...
constexpr void ::GlobalNamespace::MultiplayerScoreRingManager::__set__scoreRingItemPool(::GlobalNamespace::____GlobalNamespace__MultiplayerScoreRingItem__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreRingItem__Pool, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreRingItem__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreRingItem__Pool ::GlobalNamespace::MultiplayerScoreRingManager::__get__scoreRingItemPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreRingItem__Pool, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::MultiplayerScoreRingManager::HandleStateChanged(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State state)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerScoreRingManager>::get(),
                            "HandleStateChanged",
                            std::vector<Il2CppClass*>{},
