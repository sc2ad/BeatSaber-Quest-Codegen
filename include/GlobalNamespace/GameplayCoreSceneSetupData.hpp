...
namespace GlobalNamespace {
  ...
  class GameplayCoreSceneSetupData : public ::GlobalNamespace::SceneSetupData {
    public:
    // Nested type: ::GlobalNamespace::GameplayCoreSceneSetupData::$LoadTransformedBeatmapDataAsync$d__13
  ...
  #pragma pack(pop)
  static check_size<sizeof(GameplayCoreSceneSetupData), 88 + sizeof(::GlobalNamespace::IReadonlyBeatmapData*)> __GlobalNamespace_GameplayCoreSceneSetupDataSizeCheck;
  static_assert(sizeof(GameplayCoreSceneSetupData) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
