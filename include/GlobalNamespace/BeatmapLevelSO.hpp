...
namespace GlobalNamespace {
  ...
  class BeatmapLevelSO : public GlobalNamespace::PersistentScriptableObject/*, public GlobalNamespace::IBeatmapLevel*/ {
    ...
    struct GetBeatmapLevelDataResult : public System::ValueType {
      ...
      check_size<sizeof(BeatmapLevelSO::GetBeatmapLevelDataResult::Result), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_BeatmapLevelSO_GetBeatmapLevelDataResult_ResultSizeCheck;
    ...
    check_size<sizeof(BeatmapLevelSO::GetBeatmapLevelDataResult), 8 + sizeof(void*) + ((8 + sizeof(void*)) % 8 != 0 ? (8 - (8 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_BeatmapLevelSO_GetBeatmapLevelDataResultSizeCheck;
  ...
  check_size<sizeof(BeatmapLevelSO), 168 + sizeof(GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult) + ((168 + sizeof(GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult)) % 8 != 0 ? (8 - (168 + sizeof(GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult)) % 8) : 0)> __GlobalNamespace_BeatmapLevelSOSizeCheck;
}
