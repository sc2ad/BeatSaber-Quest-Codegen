...
struct CORDL_TYPE GlobalNamespace__SettingsFlowCoordinator__FinishAction : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__SettingsFlowCoordinator__FinishAction(int32_t value__) noexcept;


                    constexpr GlobalNamespace__SettingsFlowCoordinator__FinishAction(GlobalNamespace__SettingsFlowCoordinator__FinishAction const&) = default;
                    constexpr GlobalNamespace__SettingsFlowCoordinator__FinishAction(GlobalNamespace__SettingsFlowCoordinator__FinishAction&&) = default;
                    constexpr GlobalNamespace__SettingsFlowCoordinator__FinishAction& operator=(GlobalNamespace__SettingsFlowCoordinator__FinishAction const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__SettingsFlowCoordinator__FinishAction& operator=(GlobalNamespace__SettingsFlowCoordinator__FinishAction&& o) noexcept {
...
constexpr explicit GlobalNamespace__SettingsFlowCoordinator__FinishAction(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__SettingsFlowCoordinator__FinishAction_Unwrapped : int32_t {
__Cancel = 0,
__Ok = 1,
__Apply = 2,
};
...
static GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction const Cancel;

/// @brief Field Ok offset 0
static GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction const Ok;

/// @brief Field Apply offset 0
static GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction const Apply;
...
public:
// Declarations
using FinishAction = GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction;
...
constexpr GlobalNamespace::ISaveData __get__saveData() const;
 ...
 System::Action_2<GlobalNamespace::SettingsFlowCoordinator,GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction> __declspec(property(get=__get_didFinishEvent, put=__set_didFinishEvent))  didFinishEvent;

constexpr void __set_didFinishEvent(System::Action_2<GlobalNamespace::SettingsFlowCoordinator,GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction> value) ;

constexpr System::Action_2<GlobalNamespace::SettingsFlowCoordinator,GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction> __get_didFinishEvent() const;
...
/// @brief Method add_didFinishEvent addr 0x21449e4 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_2<GlobalNamespace::SettingsFlowCoordinator,GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction> value) ;

/// @brief Method remove_didFinishEvent addr 0x2144a94 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_2<GlobalNamespace::SettingsFlowCoordinator,GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction> value) ;
...
/// @brief Method HandleSettingsNavigationControllerDidFinish addr 0x2145004 size 0x9c virtual false final false
 void HandleSettingsNavigationControllerDidFinish(GlobalNamespace::GlobalNamespace__SettingsNavigationController__FinishAction finishAction) ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__SettingsFlowCoordinator__FinishAction, "", "SettingsFlowCoordinator/FinishAction");
