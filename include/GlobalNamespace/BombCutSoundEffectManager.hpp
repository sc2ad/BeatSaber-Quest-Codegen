...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BombCutSoundEffectManager), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_BombCutSoundEffectManagerSizeCheck;
}
