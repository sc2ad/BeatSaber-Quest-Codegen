...
class CORDL_TYPE ____GlobalNamespace__BloomPrePassRenderDataSO__Data : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0xa8};

virtual ~____GlobalNamespace__BloomPrePassRenderDataSO__Data() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BloomPrePassRenderDataSO__Data", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data(____GlobalNamespace__BloomPrePassRenderDataSO__Data const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BloomPrePassRenderDataSO__Data", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data(____GlobalNamespace__BloomPrePassRenderDataSO__Data&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BloomPrePassRenderDataSO__Data(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data& operator=(____GlobalNamespace__BloomPrePassRenderDataSO__Data&& o) noexcept = default;
  constexpr ____GlobalNamespace__BloomPrePassRenderDataSO__Data& operator=(____GlobalNamespace__BloomPrePassRenderDataSO__Data const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__BloomPrePassRenderDataSO__Data() ;
...
public:
// Declarations
using Data = ::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data;
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data __declspec(property(get=__get_data, put=__set_data))  data;

constexpr void __set_data(::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data __get_data() const;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data, "", "BloomPrePassRenderDataSO/Data");
