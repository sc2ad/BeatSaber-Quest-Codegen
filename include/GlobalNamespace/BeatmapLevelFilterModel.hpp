...
namespace GlobalNamespace {
  ...
  class BeatmapLevelFilterModel : public ::CsObject {
    public:
    ...
    // Offset: 0xB4FD60
    static ::Array<GlobalNamespace::IPreviewBeatmapLevel*>* FilterByLevelIds(GlobalNamespace::IBeatmapLevelPackCollection* beatmapLevelPackCollection, System::Collections::Generic::HashSet_1<::CsString*>* beatmapLevelIds);
