...
class CORDL_TYPE ____GlobalNamespace__CoreGameHUDController__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__CoreGameHUDController__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__CoreGameHUDController__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__CoreGameHUDController__InitData(____GlobalNamespace__CoreGameHUDController__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__CoreGameHUDController__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__CoreGameHUDController__InitData(____GlobalNamespace__CoreGameHUDController__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__CoreGameHUDController__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__CoreGameHUDController__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__CoreGameHUDController__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__CoreGameHUDController__InitData& operator=(____GlobalNamespace__CoreGameHUDController__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__CoreGameHUDController__InitData& operator=(____GlobalNamespace__CoreGameHUDController__InitData const& o) noexcept = default;
...
explicit ____GlobalNamespace__CoreGameHUDController__InitData(bool hide, bool showEnergyPanel, bool advancedHUD) ;
...
public:
// Declarations
using InitData = ::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData;
...
/// @brief Method Initialize addr 0x2274aa0 size 0x90 virtual false final false
 void Initialize(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData initData) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData, "", "CoreGameHUDController/InitData");
