...
namespace GlobalNamespace {
  ...
  class LevelCompletionResults : public ::Il2CppObject/*, public LiteNetLib::Utils::INetImmutableSerializable_1<GlobalNamespace::LevelCompletionResults*>, public System::IComparable*/ {
    ...
    check_size<sizeof(LevelCompletionResults::LevelEndStateType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_LevelCompletionResults_LevelEndStateTypeSizeCheck;
    ...
    check_size<sizeof(LevelCompletionResults::LevelEndAction), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_LevelCompletionResults_LevelEndActionSizeCheck;
  ...
  check_size<sizeof(LevelCompletionResults), 128 + sizeof(float) + 8 - (128 + sizeof(float)) % 8> __GlobalNamespace_LevelCompletionResultsSizeCheck;
}
