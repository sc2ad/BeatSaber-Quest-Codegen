...
struct CORDL_TYPE ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType(____GlobalNamespace__BeatmapEventDataBox__DistributionParamType const&) = default;
                    constexpr ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType(____GlobalNamespace__BeatmapEventDataBox__DistributionParamType&&) = default;
                    constexpr ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType& operator=(____GlobalNamespace__BeatmapEventDataBox__DistributionParamType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType& operator=(____GlobalNamespace__BeatmapEventDataBox__DistributionParamType&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__BeatmapEventDataBox__DistributionParamType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__BeatmapEventDataBox__DistributionParamType_Unwrapped : int32_t {
__Wave = 1,
__Step = 2,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__BeatmapEventDataBox__DistributionParamType_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__BeatmapEventDataBox__DistributionParamType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType const Wave;

/// @brief Field Step offset 0
static ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType const Step;
...
public:
// Declarations
using DistributionParamType = ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType;
...
constexpr float_t __get__beatDistributionParam() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType __declspec(property(get=__get__beatDistributionParamType, put=__set__beatDistributionParamType))  _beatDistributionParamType;

constexpr void __set__beatDistributionParamType(::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType __get__beatDistributionParamType() const;
...
constexpr int32_t __get__eventDistributionCount() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType __declspec(property(get=__get__eventDistributionParamType, put=__set__eventDistributionParamType))  _eventDistributionParamType;

constexpr void __set__eventDistributionParamType(::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType __get__eventDistributionParamType() const;
...
/// @brief Method .ctor addr 0x21da73c size 0x94 virtual false final false
 void _ctor(::GlobalNamespace::IndexFilter indexFilter, ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType beatDistributionParamType, float_t beatDistributionParam, ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType eventDistributionParamType, float_t eventDistributionParam, bool eventDistributionShouldAffectFirstBaseEvent, ::GlobalNamespace::EaseType eventDistributionEaseType) ;
...
static float_t BeatDistributionParamToStep(float_t distributionParam, ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType distributionParamType, int32_t count) ;

/// @brief Method EventDistributionParamToStep addr 0x21da880 size 0x6c virtual false final false
static float_t EventDistributionParamToStep(int32_t index, float_t distributionParam, ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType distributionParamType, int32_t count, ::GlobalNamespace::EaseType easeType) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBox__DistributionParamType, "", "BeatmapEventDataBox/DistributionParamType");
