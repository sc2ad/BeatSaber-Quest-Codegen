...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::*)(float_t, float_t)>(&GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20a4f88;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>::get(),
                            ".ctor",
...
constexpr GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData(float_t songTime, float_t yOffset) noexcept : ::bs_hook::ValueTypeWrapper() {this->songTime = songTime;
this->yOffset = yOffset;
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::__set_songTime(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::__get_songTime() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::__set_yOffset(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::__get_yOffset() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData::_ctor(float_t songTime, float_t yOffset)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__set__yJumpOffsetBuffer(::ArrayW<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData> GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator::__get__yJumpOffsetBuffer() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BeatmapObjectAvoidanceYOffsetEvaluator__BufferData>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
