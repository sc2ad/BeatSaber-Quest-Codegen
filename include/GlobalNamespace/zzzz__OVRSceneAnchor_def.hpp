...
static UnityEngine::Quaternion __get_RotateY180() ;
 ...
 System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Posef> __declspec(property(get=__get__pose, put=__set__pose))  _pose;

constexpr void __set__pose(System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Posef> value) ;

constexpr System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Posef> __get__pose() const;
...
/// @brief Method IsComponentEnabled addr 0x2602920 size 0x8c virtual false final false
 bool IsComponentEnabled(GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceComponentType spaceComponentType) ;

/// @brief Method SyncComponent addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename T>
 void SyncComponent(GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceComponentType spaceComponentType) ;
