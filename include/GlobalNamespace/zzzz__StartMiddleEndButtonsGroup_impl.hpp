...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StartMiddleEndButtonsGroup::*)()>(&GlobalNamespace::StartMiddleEndButtonsGroup::SetLayoutHorizontal)> {
  ...
  constexpr static std::size_t addrs = 0x21273fc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::StartMiddleEndButtonsGroup>::get(),
                            "SetLayoutHorizontal",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StartMiddleEndButtonsGroup::*)()>(&GlobalNamespace::StartMiddleEndButtonsGroup::SetLayoutVertical)> {
  ...
  constexpr static std::size_t addrs = 0x21274e4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StartMiddleEndButtonsGroup::*)()>(&GlobalNamespace::StartMiddleEndButtonsGroup::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21274e8;
...
constexpr  GlobalNamespace::StartMiddleEndButtonsGroup::operator UnityEngine::UI::ILayoutController() const noexcept {
...
GlobalNamespace::StartMiddleEndButtonsGroup o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::StartMiddleEndButtonsGroup>())};
return o;
}
 void GlobalNamespace::StartMiddleEndButtonsGroup::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::StartMiddleEndButtonsGroup>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
