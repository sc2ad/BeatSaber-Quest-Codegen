...
// Ctor Parameters []
 GlobalNamespace::StartMiddleEndButtonsGroup::StartMiddleEndButtonsGroup()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<StartMiddleEndButtonsGroup>())) {}
