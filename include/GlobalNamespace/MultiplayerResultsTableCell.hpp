...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerResultsTableCell), 212 + sizeof(UnityEngine::Color) + ((212 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (212 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_MultiplayerResultsTableCellSizeCheck;
}
