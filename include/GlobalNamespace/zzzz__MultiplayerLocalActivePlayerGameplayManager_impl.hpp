...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::*)(bool)>(&::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x20e801c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::__set_failOn0Energy(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::__get_failOn0Energy() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "failOn0Energy", ty: "bool", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData(bool failOn0Energy)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData>(failOn0Energy))) {}
 void ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData::_ctor(bool failOn0Energy)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::MultiplayerLocalActivePlayerGameplayManager::__set__initData(::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData ::GlobalNamespace::MultiplayerLocalActivePlayerGameplayManager::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerLocalActivePlayerGameplayManager__InitData, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
