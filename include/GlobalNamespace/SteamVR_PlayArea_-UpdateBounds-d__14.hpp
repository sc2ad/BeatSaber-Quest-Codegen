...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_PlayArea::$UpdateBounds$d__14), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_SteamVR_PlayArea_$UpdateBounds$d__14SizeCheck;
}
