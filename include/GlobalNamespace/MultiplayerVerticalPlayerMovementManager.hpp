...
namespace GlobalNamespace {
  ...
  class MultiplayerVerticalPlayerMovementManager : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [TooltipAttribute] Offset: 0x1119568
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0x1119604
    ...
    // [InjectAttribute] Offset: 0x1119614
    ...
    // [InjectAttribute] Offset: 0x1119624
    ...
    // [InjectAttribute] Offset: 0x1119634
