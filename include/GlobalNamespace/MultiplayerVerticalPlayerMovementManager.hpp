...
namespace GlobalNamespace {
  ...
  class MultiplayerVerticalPlayerMovementManager : public UnityEngine::MonoBehaviour {
    public:
    // [TooltipAttribute] Offset: 0xE1ED88
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0xE1EE24
    ...
    // [InjectAttribute] Offset: 0xE1EE34
    ...
    // [InjectAttribute] Offset: 0xE1EE44
    ...
    // [InjectAttribute] Offset: 0xE1EE54
