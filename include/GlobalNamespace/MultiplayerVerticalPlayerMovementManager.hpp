...
namespace GlobalNamespace {
  ...
  class MultiplayerVerticalPlayerMovementManager : public UnityEngine::MonoBehaviour {
    public:
    // [TooltipAttribute] Offset: 0xE1ED64
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0xE1EE00
    ...
    // [InjectAttribute] Offset: 0xE1EE10
    ...
    // [InjectAttribute] Offset: 0xE1EE20
    ...
    // [InjectAttribute] Offset: 0xE1EE30
