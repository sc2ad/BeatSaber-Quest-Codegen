...
namespace GlobalNamespace {
  ...
  class MultiplayerVerticalPlayerMovementManager : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [TooltipAttribute] Offset: 0x11197D8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0x1119874
    ...
    // [InjectAttribute] Offset: 0x1119884
    ...
    // [InjectAttribute] Offset: 0x1119894
    ...
    // [InjectAttribute] Offset: 0x11198A4
