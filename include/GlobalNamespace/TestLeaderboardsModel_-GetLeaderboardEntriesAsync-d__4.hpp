...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TestLeaderboardsModel::$GetLeaderboardEntriesAsync$d__4), 64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __GlobalNamespace_TestLeaderboardsModel_$GetLeaderboardEntriesAsync$d__4SizeCheck;
}
