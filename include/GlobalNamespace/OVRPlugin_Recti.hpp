...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::Recti), 8 + sizeof(GlobalNamespace::OVRPlugin::Sizei) + ((8 + sizeof(GlobalNamespace::OVRPlugin::Sizei)) % 8 != 0 ? (8 - (8 + sizeof(GlobalNamespace::OVRPlugin::Sizei)) % 8) : 0)> __GlobalNamespace_OVRPlugin_RectiSizeCheck;
}
