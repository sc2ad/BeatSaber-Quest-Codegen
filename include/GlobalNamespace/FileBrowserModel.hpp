...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Il2CppString*, ::ArrayWrapper<::Il2CppString*>, System::Action_1<::ArrayWrapper<GlobalNamespace::FileBrowserItem*>>*)>(&GlobalNamespace::FileBrowserModel::GetContentOfDirectory)> {
  static const MethodInfo* get() {
    ...
    static auto* extensions = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "String")), 1)->byval_arg;
    static auto* callback = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System", "Action`1"), ::std::vector<const Il2CppClass*>{il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("", "FileBrowserItem")), 1)})->byval_arg;
