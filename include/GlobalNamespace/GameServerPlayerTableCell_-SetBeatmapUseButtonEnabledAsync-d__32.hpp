...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameServerPlayerTableCell::$SetBeatmapUseButtonEnabledAsync$d__32), 64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>) + ((64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8 != 0 ? (8 - (64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8) : 0)> __GlobalNamespace_GameServerPlayerTableCell_$SetBeatmapUseButtonEnabledAsync$d__32SizeCheck;
}
