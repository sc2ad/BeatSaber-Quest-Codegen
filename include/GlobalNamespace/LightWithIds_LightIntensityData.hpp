...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LightWithIds::LightIntensityData), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_LightWithIds_LightIntensityDataSizeCheck;
}
