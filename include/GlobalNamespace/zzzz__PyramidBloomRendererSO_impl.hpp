...
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::____GlobalNamespace__PyramidBloomRendererSO__Pass(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::Prefilter13{0};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::Prefilter4{1};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::Downsample13{2};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::Downsample4{3};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::DownsampleBilinearGamma{4};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleTent{5};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleBox{6};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleTentGamma{7};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleBoxGamma{8};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::Bilinear{9};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::BilinearGamma{10};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleTentAndReinhardToneMapping{11};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleTentAndACESToneMapping{12};
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass  ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass::UpsampleTentAndACESToneMappingGlobalIntensity{13};
...
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level::____GlobalNamespace__PyramidBloomRendererSO__Level(::UnityEngine::RenderTexture down, ::UnityEngine::RenderTexture up) noexcept : ::bs_hook::ValueTypeWrapper() {this->down = down;
this->up = up;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level::__set_down(::UnityEngine::RenderTexture value)  {
...
constexpr ::UnityEngine::RenderTexture ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level::__get_down() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RenderTexture, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level::__set_up(::UnityEngine::RenderTexture value)  {
...
constexpr ::UnityEngine::RenderTexture ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level::__get_up() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PyramidBloomRendererSO::*)(::UnityEngine::RenderTexture, ::UnityEngine::RenderTexture, float_t, float_t, float_t, float_t, bool, bool, float_t, float_t, float_t, float_t, ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, bool)>(&::GlobalNamespace::PyramidBloomRendererSO::RenderBloom)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "RenderBloom",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::RenderTexture>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::RenderTexture>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::PyramidBloomRendererSO::__set__pyramid(::ArrayW<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level> ::GlobalNamespace::PyramidBloomRendererSO::__get__pyramid() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Level>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
