...
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
struct GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue>;
}
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
struct GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8<TKey,TValue>;
}
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
struct GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7<TKey,TValue>;
}
// Type: ::ScheduledTask
// Type: ::<LoadAsync>d__7
...
constexpr GlobalNamespace__AsyncCachedLoader_2__ScheduledTask(TKey keyId, System::Threading::Tasks::TaskCompletionSource_1<TValue> taskCompletionSource, System::Threading::CancellationToken cancellationToken) noexcept;


                    constexpr GlobalNamespace__AsyncCachedLoader_2__ScheduledTask(GlobalNamespace__AsyncCachedLoader_2__ScheduledTask const&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2__ScheduledTask(GlobalNamespace__AsyncCachedLoader_2__ScheduledTask&&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2__ScheduledTask& operator=(GlobalNamespace__AsyncCachedLoader_2__ScheduledTask const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__AsyncCachedLoader_2__ScheduledTask& operator=(GlobalNamespace__AsyncCachedLoader_2__ScheduledTask&& o) noexcept {
...
constexpr explicit GlobalNamespace__AsyncCachedLoader_2__ScheduledTask(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TValue> __t__builder, TKey keyId, System::Threading::CancellationToken cancellationToken, GlobalNamespace::AsyncCachedLoader_2<TKey,TValue> __4__this, System::Runtime::CompilerServices::TaskAwaiter_1<TValue> __u__1) noexcept;


                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7(GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7 const&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7(GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7&&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7& operator=(GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7& operator=(GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "GlobalNamespace::AsyncCachedLoader_2<TKey,TValue>", modifiers: "", def_value: None }, CppParam { name: "_scheduledTask_5__2", ty: "GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter_1<TValue>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::AsyncCachedLoader_2<TKey,TValue> __4__this, GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue> _scheduledTask_5__2, System::Runtime::CompilerServices::TaskAwaiter_1<TValue> __u__1) noexcept;


                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8(GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8 const&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8(GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8&&) = default;
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8& operator=(GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8& operator=(GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr GlobalNamespace::AsyncCachedLoader_2<TKey,TValue> __get___4__this() const;
 ...
 GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue> __declspec(property(get=__get__scheduledTask_5__2, put=__set__scheduledTask_5__2))  _scheduledTask_5__2;

constexpr void __set__scheduledTask_5__2(GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue> value) ;

constexpr GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue> __get__scheduledTask_5__2() const;
...
public:
// Declarations
using _LoadAllAsync_d__8 = GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8<TKey, TValue>;

using _LoadAsync_d__7 = GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7<TKey, TValue>;

using ScheduledTask = GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey, TValue>;
...
// Fields
 ...
 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue>> __declspec(property(get=__get__scheduledTaskList, put=__set__scheduledTaskList))  _scheduledTaskList;

constexpr void __set__scheduledTaskList(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue>> value) ;

constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask<TKey,TValue>> __get__scheduledTaskList() const;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2__ScheduledTask, "", "AsyncCachedLoader`2/ScheduledTask");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2___LoadAllAsync_d__8, "", "AsyncCachedLoader`2/<LoadAllAsync>d__8");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(GlobalNamespace::GlobalNamespace__AsyncCachedLoader_2___LoadAsync_d__7, "", "AsyncCachedLoader`2/<LoadAsync>d__7");
