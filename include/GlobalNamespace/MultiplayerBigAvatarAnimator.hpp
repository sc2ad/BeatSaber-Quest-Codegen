...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerBigAvatarAnimator), 72 + sizeof(bool) + ((72 + sizeof(bool)) % 8 != 0 ? (8 - (72 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_MultiplayerBigAvatarAnimatorSizeCheck;
}
