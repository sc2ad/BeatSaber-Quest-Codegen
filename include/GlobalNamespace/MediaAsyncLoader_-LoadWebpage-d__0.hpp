...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MediaAsyncLoader::$LoadWebpage$d__0), 64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + 8 - (64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8> __GlobalNamespace_MediaAsyncLoader_$LoadWebpage$d__0SizeCheck;
}
