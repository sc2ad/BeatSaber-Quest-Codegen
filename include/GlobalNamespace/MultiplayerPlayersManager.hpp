...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerPlayersManager), 224 + sizeof(void*) + ((224 + sizeof(void*)) % 8 != 0 ? (8 - (224 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerPlayersManagerSizeCheck;
}
