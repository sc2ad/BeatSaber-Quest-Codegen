...
namespace GlobalNamespace {
  ...
  struct PS4BeatmapDataAssetFileModel::$TryDeleteAssetBundleFileForPreviewLevelAsync$d__4 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
