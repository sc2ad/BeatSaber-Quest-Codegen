...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppString* (GlobalNamespace::EnvironmentOverrideSettingsPanelController::$$c::*)(GlobalNamespace::EnvironmentInfoSO*)>(&GlobalNamespace::EnvironmentOverrideSettingsPanelController::$$c::$SetData$b__11_0)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::EnvironmentOverrideSettingsPanelController::$$c*), "<SetData>b__11_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{x});
  }
};
