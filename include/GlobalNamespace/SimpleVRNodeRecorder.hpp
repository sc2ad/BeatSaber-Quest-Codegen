...
namespace GlobalNamespace {
  ...
  class SimpleVRNodeRecorder : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(SimpleVRNodeRecorder::SavedData), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_SimpleVRNodeRecorder_SavedDataSizeCheck;
    ...
    check_size<sizeof(SimpleVRNodeRecorder::RecordMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_SimpleVRNodeRecorder_RecordModeSizeCheck;
  ...
  check_size<sizeof(SimpleVRNodeRecorder), 96 + sizeof(UnityEngine::Quaternion) + ((96 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (96 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_SimpleVRNodeRecorderSizeCheck;
}
