...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4.MoveNext
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::*)()>(&GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::MoveNext)> {
  constexpr static std::size_t size = 0x474;
  constexpr static std::size_t addrs = 0x2190de8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4>::get(),
                            "MoveNext",
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4.SetStateMachine
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::*)(System::Runtime::CompilerServices::IAsyncStateMachine)>(&GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::SetStateMachine)> {
...
constexpr  GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::operator System::Runtime::CompilerServices::IAsyncStateMachine() const {
...
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set___1__state(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get___1__state() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set___t__builder(System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<GlobalNamespace::IReadonlyBeatmapData> value)  {
...
constexpr System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<GlobalNamespace::IReadonlyBeatmapData> GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get___t__builder() const {
...
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set_difficultyBeatmap(GlobalNamespace::IDifficultyBeatmap value)  {
...
constexpr GlobalNamespace::IDifficultyBeatmap GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get_difficultyBeatmap() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::IDifficultyBeatmap, 0x20>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set___4__this(GlobalNamespace::BeatmapDataCache value)  {
...
constexpr GlobalNamespace::BeatmapDataCache GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get___4__this() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::BeatmapDataCache, 0x28>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set_environmentInfo(GlobalNamespace::EnvironmentInfoSO value)  {
...
constexpr GlobalNamespace::EnvironmentInfoSO GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get_environmentInfo() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::EnvironmentInfoSO, 0x30>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set_playerSpecificSettings(GlobalNamespace::PlayerSpecificSettings value)  {
...
constexpr GlobalNamespace::PlayerSpecificSettings GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get_playerSpecificSettings() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::PlayerSpecificSettings, 0x38>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__set___u__1(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IReadonlyBeatmapData> value)  {
...
constexpr System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IReadonlyBeatmapData> GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::__get___u__1() const {
return ::cordl_internals::getInstanceField<System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IReadonlyBeatmapData>, 0x40>(this->__instance);
 ...
 void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::MoveNext()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4>::get(),
                            "MoveNext",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4::SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__BeatmapDataCache___GetBeatmapData_d__4>::get(),
                            "SetStateMachine",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<System::Threading::Tasks::Task_1<GlobalNamespace::IReadonlyBeatmapData>, false>(const_cast<void*>(instance), ___internal_method, difficultyBeatmap, environmentInfo, playerSpecificSettings);
 ...
 GlobalNamespace::BeatmapDataCache GlobalNamespace::BeatmapDataCache::New_ctor()  {
GlobalNamespace::BeatmapDataCache o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BeatmapDataCache>())};
return o;
}
