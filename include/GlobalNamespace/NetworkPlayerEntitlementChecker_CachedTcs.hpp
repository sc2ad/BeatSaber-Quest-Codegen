...
namespace GlobalNamespace {
  ...
  check_size<sizeof(NetworkPlayerEntitlementChecker::CachedTcs), 32 + sizeof(float) + ((32 + sizeof(float)) % 8 != 0 ? (8 - (32 + sizeof(float)) % 8) : 0)> __GlobalNamespace_NetworkPlayerEntitlementChecker_CachedTcsSizeCheck;
}
