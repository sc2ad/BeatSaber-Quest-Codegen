...
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::____GlobalNamespace__LevelCompletionResults__LevelEndStateType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::Incomplete{0};
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::Cleared{1};
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType::Failed{2};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::____GlobalNamespace__LevelCompletionResults__LevelEndAction(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::Quit{1};
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction  ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction::Restart{2};
...
constexpr void ::GlobalNamespace::LevelCompletionResults::__set_rank(::GlobalNamespace::____GlobalNamespace__RankModel__Rank value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__RankModel__Rank, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__RankModel__Rank>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__RankModel__Rank ::GlobalNamespace::LevelCompletionResults::__get_rank() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__RankModel__Rank, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::LevelCompletionResults::__set_levelEndStateType(::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType ::GlobalNamespace::LevelCompletionResults::__get_levelEndStateType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::LevelCompletionResults::__set_levelEndAction(::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction, 0x3c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction ::GlobalNamespace::LevelCompletionResults::__get_levelEndAction() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndAction, 0x3c>(this->::bs_hook::Il2CppWrapperType::instance);
}
