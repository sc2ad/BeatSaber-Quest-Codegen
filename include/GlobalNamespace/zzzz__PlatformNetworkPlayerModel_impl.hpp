...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig::*)()>(&::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2211768;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig>::get(),
                            ".ctor",
...
constexpr  ::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig::operator ::GlobalNamespace::INetworkPlayerModelPartyConfig_1<::GlobalNamespace::PlatformNetworkPlayerModel>() const noexcept {
...
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig()  : ::GlobalNamespace::____GlobalNamespace__BaseNetworkPlayerModel__PartyConfig(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig>())) {}
 void ::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__PlatformNetworkPlayerModel__CreatePartyConfig>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer> (::GlobalNamespace::PlatformNetworkPlayerModel::*)()>(&::GlobalNamespace::PlatformNetworkPlayerModel::get_friends)> {
  ...
  constexpr static std::size_t addrs = 0x2211758;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlatformNetworkPlayerModel::*)()>(&::GlobalNamespace::PlatformNetworkPlayerModel::DestroyPartyConnection)> {
  ...
  constexpr static std::size_t addrs = 0x220df60;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlatformNetworkPlayerModel::*)()>(&::GlobalNamespace::PlatformNetworkPlayerModel::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x220e530;
