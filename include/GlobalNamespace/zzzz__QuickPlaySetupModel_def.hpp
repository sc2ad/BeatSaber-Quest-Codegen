...
namespace GlobalNamespace {
class ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10;
}
...
class CORDL_TYPE ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB(____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB(____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB& operator=(____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB&& o) noexcept = default;
  constexpr ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB& operator=(____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB() ;
...
struct CORDL_TYPE ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::QuickPlaySetupData> __t__builder, ::GlobalNamespace::QuickPlaySetupModel __4__this, ::System::UriBuilder _uriBuilder_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::StringW> __u__1) noexcept;


                    constexpr ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10(____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10 const&) = default;
                    constexpr ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10(____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10&&) = default;
                    constexpr ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10& operator=(____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10& operator=(____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _GetQuickPlaySetupInternal_d__10 = ::GlobalNamespace::____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10;

using QuickPlaySetupDataFB = ::GlobalNamespace::____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__QuickPlaySetupModel__QuickPlaySetupDataFB, "", "QuickPlaySetupModel/QuickPlaySetupDataFB");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__QuickPlaySetupModel___GetQuickPlaySetupInternal_d__10, "", "QuickPlaySetupModel/<GetQuickPlaySetupInternal>d__10");
