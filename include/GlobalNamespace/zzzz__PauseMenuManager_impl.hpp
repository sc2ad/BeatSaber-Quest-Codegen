...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::*)(::StringW, GlobalNamespace::IPreviewBeatmapLevel, GlobalNamespace::BeatmapDifficulty, GlobalNamespace::BeatmapCharacteristicSO, bool, bool)>(&GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_backButtonText(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__get_backButtonText() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_previewBeatmapLevel(GlobalNamespace::IPreviewBeatmapLevel value)  {
...
constexpr GlobalNamespace::IPreviewBeatmapLevel GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__get_previewBeatmapLevel() const {
...
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_beatmapDifficulty(GlobalNamespace::BeatmapDifficulty value)  {
...
constexpr GlobalNamespace::BeatmapDifficulty GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__get_beatmapDifficulty() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::BeatmapDifficulty, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_beatmapCharacteristic(GlobalNamespace::BeatmapCharacteristicSO value)  {
...
constexpr GlobalNamespace::BeatmapCharacteristicSO GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__get_beatmapCharacteristic() const {
...
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_showRestartButton(bool value)  {
::cordl_internals::setInstanceField<bool, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__get_showRestartButton() const {
return ::cordl_internals::getInstanceField<bool, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData::__set_showLevelBar(bool value)  {
...
constexpr void GlobalNamespace::PauseMenuManager::__set__initData(GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData>(value));
}
constexpr GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData GlobalNamespace::PauseMenuManager::__get__initData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__PauseMenuManager__InitData, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
