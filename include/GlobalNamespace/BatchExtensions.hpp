...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: BatchExtensions
...
namespace GlobalNamespace {
  ...
  class BatchExtensions : public ::Il2CppObject {
    ...
    static System::Collections::Generic::IEnumerable_1<System::Collections::Generic::List_1<T>*>* Batch(System::Collections::Generic::IEnumerable_1<T>* enumerable, int batchSize) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::IEnumerable_1<System::Collections::Generic::List_1<T>*>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, enumerable, batchSize)));
    }
  }; // BatchExtensions
  #pragma pack(pop)
}
