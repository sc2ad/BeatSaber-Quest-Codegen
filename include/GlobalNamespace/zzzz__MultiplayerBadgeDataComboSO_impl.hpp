...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method, result);
 ...
 GlobalNamespace::MultiplayerBadgeDataComboSO GlobalNamespace::MultiplayerBadgeDataComboSO::New_ctor()  {
GlobalNamespace::MultiplayerBadgeDataComboSO o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MultiplayerBadgeDataComboSO>())};
return o;
}
