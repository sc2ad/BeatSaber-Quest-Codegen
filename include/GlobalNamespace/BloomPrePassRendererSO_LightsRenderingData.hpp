...
namespace GlobalNamespace {
  ...
  class BloomPrePassRendererSO::LightsRenderingData : public ::Il2CppObject {
    ...
    // public UnityEngine.Vector3[] uvs
    // Size: 0x8
    // Offset: 0x20
    ::ArrayW<::UnityEngine::Vector3> uvs;
    // Field size check
    static_assert(sizeof(::ArrayW<::UnityEngine::Vector3>) == 0x8);
  ...
  #pragma pack(pop)
  static check_size<sizeof(BloomPrePassRendererSO::LightsRenderingData), 48 + sizeof(::ArrayW<::UnityEngine::Vector4>)> __GlobalNamespace_BloomPrePassRendererSO_LightsRenderingDataSizeCheck;
  static_assert(sizeof(BloomPrePassRendererSO::LightsRenderingData) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
