...
namespace GlobalNamespace {
struct ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType;
}
namespace GlobalNamespace {
class LevelCollectionNavigationController;
}
namespace GlobalNamespace {
class ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0;
}
...
struct CORDL_TYPE ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType(____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType const&) = default;
                    constexpr ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType(____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType&&) = default;
                    constexpr ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType& operator=(____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType& operator=(____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType_Unwrapped : int32_t {
__In = 0,
__Out = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType const In;

/// @brief Field Out offset 0
static ::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType const Out;
...
class CORDL_TYPE ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0(____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0(____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0& operator=(____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0&& o) noexcept = default;
  constexpr ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0& operator=(____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0() ;
...
public:
// Declarations
using __c__DisplayClass54_0 = ::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0;

using AlphaAnimationType = ::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType;
...
constexpr ::Tweening::TimeTweeningManager __get__timeTweeningManager() const;
 ...
 ::System::Action_2<::GlobalNamespace::LevelCollectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> __declspec(property(get=__get_didChangeLevelDetailContentEvent, put=__set_didChangeLevelDetailContentEvent))  didChangeLevelDetailContentEvent;

constexpr void __set_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelCollectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;

constexpr ::System::Action_2<::GlobalNamespace::LevelCollectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> __get_didChangeLevelDetailContentEvent() const;
...
/// @brief Method add_didChangeLevelDetailContentEvent addr 0x2162d24 size 0xb0 virtual false final false
 void add_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelCollectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;

/// @brief Method remove_didChangeLevelDetailContentEvent addr 0x2162dd4 size 0xb0 virtual false final false
 void remove_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelCollectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;
...
/// @brief Method AnimateCanvasGroupAlpha addr 0x21639e4 size 0x1ec virtual false final false
 void AnimateCanvasGroupAlpha(::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType animationType) ;
...
/// @brief Method HandleLevelDetailViewControllerDidPresentContent addr 0x2165f74 size 0x20 virtual false final false
 void HandleLevelDetailViewControllerDidPresentContent(::GlobalNamespace::StandardLevelDetailViewController viewController, ::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType contentType) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController__AlphaAnimationType, "", "LevelCollectionNavigationController/AlphaAnimationType");
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelCollectionNavigationController____c__DisplayClass54_0, "", "LevelCollectionNavigationController/<>c__DisplayClass54_0");
