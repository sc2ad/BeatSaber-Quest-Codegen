...
namespace GlobalNamespace {
  ...
  check_size<sizeof(DeactivateAfterFirstFrame::$Start$d__0), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_DeactivateAfterFirstFrame_$Start$d__0SizeCheck;
}
