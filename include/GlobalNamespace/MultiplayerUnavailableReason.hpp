...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerUnavailableReason), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerUnavailableReasonSizeCheck;
}
