...
namespace GlobalNamespace {
  ...
  class ObservableVariableSO_1 : public GlobalNamespace::PersistentScriptableObject/*, public GlobalNamespace::IValue_1<T>, public GlobalNamespace::IObservableChange*/ {
    ...
    void add_didChangeEvent(System::Action* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ObservableVariableSO_1").WithContext("add_didChangeEvent");
    ...
    void remove_didChangeEvent(System::Action* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ObservableVariableSO_1").WithContext("remove_didChangeEvent");
    ...
    void set_value(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ObservableVariableSO_1").WithContext("set_value");
    ...
    T get_value() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ObservableVariableSO_1").WithContext("get_value");
    ...
    static ObservableVariableSO_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ObservableVariableSO_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<ObservableVariableSO_1<T>*>());
    }
  }; // ObservableVariableSO`1
  // Could not write size check! Type: ObservableVariableSO`1 is generic!
}
