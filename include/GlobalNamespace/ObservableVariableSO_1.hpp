...
namespace GlobalNamespace {
  ...
  template<typename T>
  class ObservableVariableSO_1 : public GlobalNamespace::IValue_1<T>, public GlobalNamespace::IObservableChange, public GlobalNamespace::PersistentScriptableObject {
    public:
