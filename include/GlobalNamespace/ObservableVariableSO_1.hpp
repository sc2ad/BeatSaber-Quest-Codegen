...
namespace GlobalNamespace {
  ...
  class ObservableVariableSO_1 : public GlobalNamespace::PersistentScriptableObject/*, public GlobalNamespace::IValue_1<T>, public GlobalNamespace::IObservableChange*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCF540C
    ...
    // Offset: 0xFFFFFFFF
    void add_didChangeEvent_NEW(System::Action* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariableSO_1::add_didChangeEvent_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void remove_didChangeEvent_NEW(System::Action* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariableSO_1::remove_didChangeEvent_NEW");
    ...
    void set_value_NEW(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariableSO_1::set_value_NEW");
    ...
    // Offset: 0xFFFFFFFF
    T get_value_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariableSO_1::get_value_NEW");
