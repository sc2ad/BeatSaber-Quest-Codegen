...
struct CORDL_TYPE GlobalNamespace__AveragingValueRecorder__AverageValueData : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__AveragingValueRecorder__AverageValueData(float_t _value_k__BackingField, float_t _time_k__BackingField) noexcept;


                    constexpr GlobalNamespace__AveragingValueRecorder__AverageValueData(GlobalNamespace__AveragingValueRecorder__AverageValueData const&) = default;
                    constexpr GlobalNamespace__AveragingValueRecorder__AverageValueData(GlobalNamespace__AveragingValueRecorder__AverageValueData&&) = default;
                    constexpr GlobalNamespace__AveragingValueRecorder__AverageValueData& operator=(GlobalNamespace__AveragingValueRecorder__AverageValueData const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__AveragingValueRecorder__AverageValueData& operator=(GlobalNamespace__AveragingValueRecorder__AverageValueData&& o) noexcept {
...
constexpr explicit GlobalNamespace__AveragingValueRecorder__AverageValueData(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using AverageValueData = GlobalNamespace::GlobalNamespace__AveragingValueRecorder__AverageValueData;
...
constexpr int32_t __get__historyValuesCount() const;
 ...
 System::Collections::Generic::Queue_1<GlobalNamespace::GlobalNamespace__AveragingValueRecorder__AverageValueData> __declspec(property(get=__get__averageWindowValues, put=__set__averageWindowValues))  _averageWindowValues;

constexpr void __set__averageWindowValues(System::Collections::Generic::Queue_1<GlobalNamespace::GlobalNamespace__AveragingValueRecorder__AverageValueData> value) ;

constexpr System::Collections::Generic::Queue_1<GlobalNamespace::GlobalNamespace__AveragingValueRecorder__AverageValueData> __get__averageWindowValues() const;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__AveragingValueRecorder__AverageValueData, "", "AveragingValueRecorder/AverageValueData");
