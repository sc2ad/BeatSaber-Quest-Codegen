...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27, "", "PacketEncryptionLayer/<AddPendingEncryptedEndpointAsync>d__27");
// Type namespace: 
namespace GlobalNamespace {
  // WARNING Size may be invalid!
  // Autogenerated type: PacketEncryptionLayer/<AddPendingEncryptedEndpointAsync>d__27
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  struct PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27/*, public ::System::ValueType, public ::System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: $AddPendingEncryptedEndpointAsync$d__27
    constexpr $AddPendingEncryptedEndpointAsync$d__27(int $$1__state_ = {}, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder $$t__builder_ = {}, ::GlobalNamespace::PacketEncryptionLayer* $$4__this_ = {}, ::ArrayW<uint8_t> preMasterSecret_ = ::ArrayW<uint8_t>(static_cast<void*>(nullptr)), ::ArrayW<uint8_t> serverRandom_ = ::ArrayW<uint8_t>(static_cast<void*>(nullptr)), ::ArrayW<uint8_t> clientRandom_ = ::ArrayW<uint8_t>(static_cast<void*>(nullptr)), bool isClient_ = {}, ::System::Net::IPEndPoint* endPoint_ = {}, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EncryptionUtility::IEncryptionState*> $$u__1_ = {}) noexcept : $$1__state{$$1__state_}, $$t__builder{$$t__builder_}, $$4__this{$$4__this_}, preMasterSecret{preMasterSecret_}, serverRandom{serverRandom_}, clientRandom{clientRandom_}, isClient{isClient_}, endPoint{endPoint_}, $$u__1{$$u__1_} {}
...
// Writing MetadataGetter for method: GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::MoveNext
// Il2CppName: MoveNext
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::*)()>(&GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::MoveNext)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27), "MoveNext", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::SetStateMachine
// Il2CppName: SetStateMachine
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::*)(::System::Runtime::CompilerServices::IAsyncStateMachine*)>(&GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27::SetStateMachine)> {
  static const MethodInfo* get() {
    static auto* stateMachine = &::il2cpp_utils::GetClassFromName("System.Runtime.CompilerServices", "IAsyncStateMachine")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::PacketEncryptionLayer::$AddPendingEncryptedEndpointAsync$d__27), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stateMachine});
  }
};
