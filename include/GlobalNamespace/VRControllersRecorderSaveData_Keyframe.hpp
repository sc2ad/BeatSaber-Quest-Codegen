...
namespace GlobalNamespace {
  ...
  check_size<sizeof(VRControllersRecorderSaveData::Keyframe), 24 + sizeof(float) + 8 - (24 + sizeof(float)) % 8> __GlobalNamespace_VRControllersRecorderSaveData_KeyframeSizeCheck;
}
