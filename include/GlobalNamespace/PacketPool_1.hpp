...
namespace GlobalNamespace {
  ...
  class PacketPool_1 : public ::Il2CppObject/*, public GlobalNamespace::IPacketPool_1<T>*/ {
    ...
    static int _get_kMaxPoolSize() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("_get_kMaxPoolSize");
    ...
    static void _set_kMaxPoolSize(int value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("_set_kMaxPoolSize");
    ...
    // Offset: 0xFFFFFFFF
    void Clear() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("Clear");
    ...
    T Obtain() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("Obtain");
    ...
    void Release(T t) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("Release");
    ...
    void GlobalNamespace_IPacketPool_Release(::Il2CppObject* o) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("IPacketPool.Release");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "IPacketPool.Release", {}, ::il2cpp_utils::ExtractTypes(o)));
    ...
    int GetHashCode() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext("GetHashCode");
    ...
    static PacketPool_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PacketPool_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<PacketPool_1<T>*>());
    }
  }; // PacketPool`1
  // Could not write size check! Type: PacketPool`1 is generic!
}
