...
namespace GlobalNamespace {
  ...
  class PacketPool_1 : public ::Il2CppObject/*, public GlobalNamespace::IPacketPool_1<T>*/ {
    ...
    int _get__clearCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_get__clearCount");
    ...
    void _set__clearCount(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_set__clearCount");
      static auto ___internal__instance = this;
    ...
    int _get__size() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_get__size");
      static auto ___internal__instance = this;
    ...
    void _set__size(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_set__size");
      static auto ___internal__instance = this;
    ...
    ::Array<T>* _get__pool() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_get__pool");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<T>*>(___internal__instance, "_pool"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly T[] _pool
    void _set__pool(::Array<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::PacketPool_1::_set__pool");
      static auto ___internal__instance = this;
