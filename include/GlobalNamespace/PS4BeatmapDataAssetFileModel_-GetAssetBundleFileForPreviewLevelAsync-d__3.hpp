...
namespace GlobalNamespace {
  ...
  struct PS4BeatmapDataAssetFileModel::$GetAssetBundleFileForPreviewLevelAsync$d__3 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
