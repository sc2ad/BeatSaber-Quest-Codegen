...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PS4BeatmapDataAssetFileModel::$GetAssetBundleFileForPreviewLevelAsync$d__3), 32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>) + ((32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>)) % 8 != 0 ? (8 - (32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>)) % 8) : 0)> __GlobalNamespace_PS4BeatmapDataAssetFileModel_$GetAssetBundleFileForPreviewLevelAsync$d__3SizeCheck;
}
