...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ColorSerializable::*)(LiteNetLib::Utils::NetDataWriter)>(&GlobalNamespace::ColorSerializable::Serialize)> {
  ...
  constexpr static std::size_t addrs = 0x121b79c;
...
//  Writing Method size for method: GlobalNamespace::ColorSerializable.op_Implicit_UnityEngine__Color
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (*)(GlobalNamespace::ColorSerializable)>(&GlobalNamespace::ColorSerializable::op_Implicit_UnityEngine__Color)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x121b860;
...
//  Writing Method size for method: GlobalNamespace::ColorSerializable.op_Implicit_GlobalNamespace__ColorSerializable
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::ColorSerializable (*)(UnityEngine::Color)>(&GlobalNamespace::ColorSerializable::op_Implicit_GlobalNamespace__ColorSerializable)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x121b864;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::ColorSerializable::*)(GlobalNamespace::ColorSerializable)>(&GlobalNamespace::ColorSerializable::Equals)> {
  ...
  constexpr static std::size_t addrs = 0x121b868;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::ColorSerializable::*)(::bs_hook::Il2CppWrapperType)>(&GlobalNamespace::ColorSerializable::Equals)> {
  constexpr static std::size_t size = 0x7c;
  constexpr static std::size_t addrs = 0x121b9a4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::ColorSerializable),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                                  0
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::ColorSerializable::*)()>(&GlobalNamespace::ColorSerializable::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x121baa4;
...
constexpr  GlobalNamespace::ColorSerializable::operator LiteNetLib::Utils::INetSerializable() const {
...
constexpr  GlobalNamespace::ColorSerializable::operator System::IEquatable_1<GlobalNamespace::ColorSerializable>() const {
return System::IEquatable_1<GlobalNamespace::ColorSerializable>(::cordl_internals::Box(this).convert());
}
// Ctor Parameters [CppParam { name: "_color", ty: "UnityEngine::Color", modifiers: "", def_value: Some("{}") }]
constexpr GlobalNamespace::ColorSerializable::ColorSerializable(UnityEngine::Color _color) noexcept : ::bs_hook::ValueTypeWrapper() {this->_color = _color;
}
...
constexpr UnityEngine::Color GlobalNamespace::ColorSerializable::__get__color() const {
return ::cordl_internals::getInstanceField<UnityEngine::Color, 0x0>(this->__instance);
}
 void GlobalNamespace::ColorSerializable::_ctor(UnityEngine::Color color)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, reader);
 ...
 UnityEngine::Color GlobalNamespace::ColorSerializable::op_Implicit_UnityEngine__Color(GlobalNamespace::ColorSerializable c)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                            "op_Implicit",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Color, false>(nullptr, ___internal_method, c);
 ...
 GlobalNamespace::ColorSerializable GlobalNamespace::ColorSerializable::op_Implicit_GlobalNamespace__ColorSerializable(UnityEngine::Color c)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                            "op_Implicit",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, other);
 ...
 bool GlobalNamespace::ColorSerializable::Equals(::bs_hook::Il2CppWrapperType obj)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                            "Equals",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, obj);
 ...
 int32_t GlobalNamespace::ColorSerializable::GetHashCode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorSerializable>::get(),
                            "GetHashCode",
                            std::vector<Il2CppClass*>{},
