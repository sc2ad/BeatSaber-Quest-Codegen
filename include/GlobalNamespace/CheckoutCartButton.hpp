...
NEED_NO_BOX(::GlobalNamespace::CheckoutCartButton);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::CheckoutCartButton*, "", "CheckoutCartButton");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0xB8
  #pragma pack(push, 1)
  // Autogenerated type: CheckoutCartButton
  // [TokenAttribute] Offset: FFFFFFFF
  class CheckoutCartButton : public ::GlobalNamespace::GorillaPressableButton {
    public:
    public:
    ...
    static CheckoutCartButton* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::CheckoutCartButton::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CheckoutCartButton*, creationType>()));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(CheckoutCartButton), 176 + sizeof(::UnityEngine::UI::Text*)> __GlobalNamespace_CheckoutCartButtonSizeCheck;
  static_assert(sizeof(CheckoutCartButton) == 0xB8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::CheckoutCartButton::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: GlobalNamespace::CheckoutCartButton::Start
// Il2CppName: Start
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CheckoutCartButton::*)()>(&GlobalNamespace::CheckoutCartButton::Start)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::CheckoutCartButton*), "Start", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::CheckoutCartButton::UpdateColor
// Il2CppName: UpdateColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CheckoutCartButton::*)()>(&GlobalNamespace::CheckoutCartButton::UpdateColor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::CheckoutCartButton*), "UpdateColor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::CheckoutCartButton::ButtonActivationWithHand
// Il2CppName: ButtonActivationWithHand
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CheckoutCartButton::*)(bool)>(&GlobalNamespace::CheckoutCartButton::ButtonActivationWithHand)> {
  static const MethodInfo* get() {
    static auto* isLeftHand = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::CheckoutCartButton*), "ButtonActivationWithHand", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{isLeftHand});
  }
};
