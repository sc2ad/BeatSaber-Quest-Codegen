...
namespace GlobalNamespace {
  ...
  class SimpleValueMissionObjectiveChecker : public GlobalNamespace::MissionObjectiveChecker {
    ...
    static SimpleValueMissionObjectiveChecker* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SimpleValueMissionObjectiveChecker").WithContext(".ctor");
