...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerModeSettings), 24 + sizeof(GlobalNamespace::SongPackMask) + ((24 + sizeof(GlobalNamespace::SongPackMask)) % 8 != 0 ? (8 - (24 + sizeof(GlobalNamespace::SongPackMask)) % 8) : 0)> __GlobalNamespace_MultiplayerModeSettingsSizeCheck;
}
