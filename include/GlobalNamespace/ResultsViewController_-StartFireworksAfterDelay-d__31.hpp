...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ResultsViewController::$StartFireworksAfterDelay$d__31), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_ResultsViewController_$StartFireworksAfterDelay$d__31SizeCheck;
}
