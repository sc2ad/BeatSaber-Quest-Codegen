...
namespace GlobalNamespace {
  ...
  class MissionMapAnimationController::$UpdateNodesAndConnectionCoroutine$d__15 : public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>, public ::Il2CppObject {
    public:
