...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MissionMapAnimationController::$UpdateNodesAndConnectionCoroutine$d__15), 56 + sizeof(int) + ((56 + sizeof(int)) % 8 != 0 ? (8 - (56 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MissionMapAnimationController_$UpdateNodesAndConnectionCoroutine$d__15SizeCheck;
}
