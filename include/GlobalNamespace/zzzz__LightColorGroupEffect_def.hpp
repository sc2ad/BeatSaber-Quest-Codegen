...
class CORDL_TYPE ____GlobalNamespace__LightColorGroupEffect__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____GlobalNamespace__LightColorGroupEffect__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LightColorGroupEffect__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LightColorGroupEffect__InitData(____GlobalNamespace__LightColorGroupEffect__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LightColorGroupEffect__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LightColorGroupEffect__InitData(____GlobalNamespace__LightColorGroupEffect__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LightColorGroupEffect__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LightColorGroupEffect__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LightColorGroupEffect__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LightColorGroupEffect__InitData& operator=(____GlobalNamespace__LightColorGroupEffect__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__LightColorGroupEffect__InitData& operator=(____GlobalNamespace__LightColorGroupEffect__InitData const& o) noexcept = default;
...
explicit ____GlobalNamespace__LightColorGroupEffect__InitData(int32_t groupId, int32_t elementId, int32_t lightId) ;
...
public:
// Declarations
using InitData = ::GlobalNamespace::____GlobalNamespace__LightColorGroupEffect__InitData;
...
explicit LightColorGroupEffect(::GlobalNamespace::____GlobalNamespace__LightColorGroupEffect__InitData initData, ::GlobalNamespace::LightWithIdManager lightManager, ::Tweening::SongTimeTweeningManager tweeningManager, ::GlobalNamespace::ColorManager colorManager, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController, ::GlobalNamespace::IBpmController bpmController) ;

/// @brief Method .ctor addr 0x225cc68 size 0x36c virtual false final false
 void _ctor(::GlobalNamespace::____GlobalNamespace__LightColorGroupEffect__InitData initData, ::GlobalNamespace::LightWithIdManager lightManager, ::Tweening::SongTimeTweeningManager tweeningManager, ::GlobalNamespace::ColorManager colorManager, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController, ::GlobalNamespace::IBpmController bpmController) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LightColorGroupEffect__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LightColorGroupEffect__InitData, "", "LightColorGroupEffect/InitData");
