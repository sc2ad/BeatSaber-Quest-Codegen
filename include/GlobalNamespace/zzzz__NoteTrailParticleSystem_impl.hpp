...
constexpr void ::GlobalNamespace::NoteTrailParticleSystem::__set__emitParams(::UnityEngine::____UnityEngine__ParticleSystem__EmitParams value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__EmitParams ::GlobalNamespace::NoteTrailParticleSystem::__get__emitParams() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
