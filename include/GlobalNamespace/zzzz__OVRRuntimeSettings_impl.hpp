...
constexpr void GlobalNamespace::OVRRuntimeSettings::__set_colorSpace(GlobalNamespace::GlobalNamespace__OVRManager__ColorSpace value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__OVRManager__ColorSpace, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__OVRManager__ColorSpace>(value));
}
constexpr GlobalNamespace::GlobalNamespace__OVRManager__ColorSpace GlobalNamespace::OVRRuntimeSettings::__get_colorSpace() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__OVRManager__ColorSpace, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
