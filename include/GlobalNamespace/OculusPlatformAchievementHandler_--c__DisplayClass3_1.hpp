...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DBF3D4
  class OculusPlatformAchievementHandler::$$c__DisplayClass3_1 : public ::Il2CppObject {
    ...
    static OculusPlatformAchievementHandler::$$c__DisplayClass3_1* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("$$c__DisplayClass3_1").WithContext(".ctor");
