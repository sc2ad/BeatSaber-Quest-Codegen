...
namespace GlobalNamespace {
  ...
  check_size<sizeof(CloudsMeshGenerator::Ring), 24 + sizeof(float) + ((24 + sizeof(float)) % 8 != 0 ? (8 - (24 + sizeof(float)) % 8) : 0)> __GlobalNamespace_CloudsMeshGenerator_RingSizeCheck;
}
