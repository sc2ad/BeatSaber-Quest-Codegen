...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MissionNodeSelectionManager), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MissionNodeSelectionManagerSizeCheck;
}
