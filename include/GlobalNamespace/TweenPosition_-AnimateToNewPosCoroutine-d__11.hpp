...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TweenPosition::$AnimateToNewPosCoroutine$d__11), 52 + sizeof(float) + 8 - (52 + sizeof(float)) % 8> __GlobalNamespace_TweenPosition_$AnimateToNewPosCoroutine$d__11SizeCheck;
}
