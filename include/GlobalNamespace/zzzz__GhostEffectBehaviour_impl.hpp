...
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::____GlobalNamespace__GhostEffectBehaviour__EndBehavior(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior  ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::DisableAll{0};
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior  ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::DisableCopies{1};
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior  ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior::Nothing{2};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType  ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType::TextMeshPro{0};
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType  ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType::Canvas{1};
...
constexpr void ::GlobalNamespace::GhostEffectBehaviour::__set__endBehavior(::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior, 0x6c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior ::GlobalNamespace::GhostEffectBehaviour::__get__endBehavior() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__EndBehavior, 0x6c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::GhostEffectBehaviour::__set__ghostEffectType(::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType, 0x88>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType ::GlobalNamespace::GhostEffectBehaviour::__get__ghostEffectType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__GhostEffectBehaviour__GhostEffectType, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 ::GlobalNamespace::GhostEffectBehaviour::GhostEffectBehaviour()  : ::UnityEngine::Playables::PlayableBehaviour(THROW_UNLESS(::il2cpp_utils::New<GhostEffectBehaviour>())) {}
