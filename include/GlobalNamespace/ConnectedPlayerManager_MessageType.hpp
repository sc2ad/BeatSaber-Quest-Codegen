...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ConnectedPlayerManager::MessageType), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __GlobalNamespace_ConnectedPlayerManager_MessageTypeSizeCheck;
}
