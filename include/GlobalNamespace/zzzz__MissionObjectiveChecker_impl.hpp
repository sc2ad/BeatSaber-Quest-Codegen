...
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::____GlobalNamespace__MissionObjectiveChecker__Status(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status  ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status  ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::NotClearedYet{1};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status  ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::NotFailedYet{2};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status  ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::Cleared{3};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status  ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status::Failed{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status (::GlobalNamespace::MissionObjectiveChecker::*)()>(&::GlobalNamespace::MissionObjectiveChecker::get_status)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectiveChecker::*)(::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status)>(&::GlobalNamespace::MissionObjectiveChecker::set_status)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_status",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::MissionObjectiveChecker::__set__status(::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status ::GlobalNamespace::MissionObjectiveChecker::__get__status() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status ::GlobalNamespace::MissionObjectiveChecker::get_status()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionObjectiveChecker>::get(),
                            "get_status",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::GlobalNamespace::MissionObjectiveChecker::set_status(::GlobalNamespace::____GlobalNamespace__MissionObjectiveChecker__Status value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionObjectiveChecker>::get(),
                            "set_status",
                            std::vector<Il2CppClass*>{},
