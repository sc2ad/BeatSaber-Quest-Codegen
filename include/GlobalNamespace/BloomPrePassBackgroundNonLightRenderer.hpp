...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BloomPrePassBackgroundNonLightRenderer), 56 + sizeof(UnityEngine::Renderer*)> __GlobalNamespace_BloomPrePassBackgroundNonLightRendererSizeCheck;
  static_assert(sizeof(BloomPrePassBackgroundNonLightRenderer) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
