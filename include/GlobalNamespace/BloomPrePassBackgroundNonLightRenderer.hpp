...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BloomPrePassBackgroundNonLightRenderer), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_BloomPrePassBackgroundNonLightRendererSizeCheck;
}
