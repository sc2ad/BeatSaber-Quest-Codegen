...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AdditionalContentModel::$GetPackEntitlementStatusAsync$d__11), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8) : 0)> __GlobalNamespace_AdditionalContentModel_$GetPackEntitlementStatusAsync$d__11SizeCheck;
}
