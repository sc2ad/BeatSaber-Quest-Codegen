...
struct ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection(____GlobalNamespace__LightGroupCircularLayouter__RotationDirection const&) = default;
                    constexpr ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection(____GlobalNamespace__LightGroupCircularLayouter__RotationDirection&&) = default;
                    constexpr ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection& operator=(____GlobalNamespace__LightGroupCircularLayouter__RotationDirection const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection& operator=(____GlobalNamespace__LightGroupCircularLayouter__RotationDirection&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LightGroupCircularLayouter__RotationDirection(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__LightGroupCircularLayouter__RotationDirection_Unwrapped : int32_t {
__Clockwise = 0,
__Counterclockwise = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__LightGroupCircularLayouter__RotationDirection_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__LightGroupCircularLayouter__RotationDirection_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection const Clockwise;

/// @brief Field Counterclockwise offset 0
static ::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection const Counterclockwise;
...
public:
// Declarations
using RotationDirection = ::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection;
...
constexpr float_t __get__startingAngle() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection __declspec(property(get=__get__rotationDirection, put=__set__rotationDirection))  _rotationDirection;

constexpr void __set__rotationDirection(::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection __get__rotationDirection() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LightGroupCircularLayouter__RotationDirection, "", "LightGroupCircularLayouter/RotationDirection");
