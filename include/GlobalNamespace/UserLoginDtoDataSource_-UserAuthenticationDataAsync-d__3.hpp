...
namespace GlobalNamespace {
  ...
  check_size<sizeof(UserLoginDtoDataSource::$UserAuthenticationDataAsync$d__3), 64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<::Il2CppString*>) + ((64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<::Il2CppString*>)) % 8 != 0 ? (8 - (64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<::Il2CppString*>)) % 8) : 0)> __GlobalNamespace_UserLoginDtoDataSource_$UserAuthenticationDataAsync$d__3SizeCheck;
}
