...
namespace GlobalNamespace {
  ...
  // [DefaultExecutionOrder] Offset: 1246C4C
  class PlaybackRenderer : public ::UnityEngine::MonoBehaviour {
    ...
    ::UnityEngine::Shader*& dyn__clearBackgroundShader();
    ...
    ::ArrayW<::GlobalNamespace::PlaybackRenderer::PlaybackScreenshot*>& dyn__screenshots();
