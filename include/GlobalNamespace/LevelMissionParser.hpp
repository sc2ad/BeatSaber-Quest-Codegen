...
namespace GlobalNamespace {
  ...
  class LevelMissionParser : public ::CsObject {
    public:
    ...
    // Offset: 0x10
    System::Collections::Generic::Dictionary_2<::CsString*, GlobalNamespace::LevelMissionParser::ParserFunction*>* functions;
    // public System.Void AddFunction(System.String name, LevelMissionParser/ParserFunction function)
    // Offset: 0xBF1148
    void AddFunction(::CsString* name, GlobalNamespace::LevelMissionParser::ParserFunction* function);
    // public System.Boolean Parse(System.String s)
    // Offset: 0xBF11B8
    bool Parse(::CsString* s);
    // private System.Boolean Parse(System.String s, System.Int32 start, System.Int32 length)
    // Offset: 0xBF11D4
    bool Parse(::CsString* s, int start, int length);
    // private System.Boolean ParseFunction(System.String s, System.Int32 start, System.Int32 length)
    // Offset: 0xBF14B0
    bool ParseFunction(::CsString* s, int start, int length);
