...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)()>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::get_hashedUserId)> {
  ...
  constexpr static std::size_t addrs = 0x227976c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)()>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::get_platform)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x227977c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)(GlobalNamespace::PlatformEnvironment)>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetTokenPlatform)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22798bc;
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::MockPlayerAuthenticationTokenProvider GlobalNamespace::MockPlayerAuthenticationTokenProvider::New_ctor(::StringW userId, ::StringW userName, ::StringW password)  {
GlobalNamespace::MockPlayerAuthenticationTokenProvider o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MockPlayerAuthenticationTokenProvider>(userId, userName, password))};
return o;
}
