...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusConnectionManager::StartServerParams), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OculusConnectionManager_StartServerParamsSizeCheck;
}
