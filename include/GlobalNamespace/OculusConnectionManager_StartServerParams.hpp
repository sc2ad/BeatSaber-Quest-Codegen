...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusConnectionManager::StartServerParams), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __GlobalNamespace_OculusConnectionManager_StartServerParamsSizeCheck;
}
