...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::MissionObjective> (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_missionObjectives)> {
  ...
  constexpr static std::size_t addrs = 0x21f0e00;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionDataSO>::get(),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapLevelSO (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_level)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0e08;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapCharacteristicSO (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_beatmapCharacteristic)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0e10;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapDifficulty (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_beatmapDifficulty)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0e18;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::GameplayModifiers (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_gameplayModifiers)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0e20;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::MissionHelpSO (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::get_missionHelp)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0e28;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::OnValidate)> {
  ...
  constexpr static std::size_t addrs = 0x21f0e30;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionDataSO::*)()>(&::GlobalNamespace::MissionDataSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f0ec4;
...
constexpr void ::GlobalNamespace::MissionDataSO::__set__level(::GlobalNamespace::BeatmapLevelSO value)  {
...
constexpr ::GlobalNamespace::BeatmapLevelSO ::GlobalNamespace::MissionDataSO::__get__level() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapLevelSO, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::MissionDataSO::__set__beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO value)  {
...
constexpr ::GlobalNamespace::BeatmapCharacteristicSO ::GlobalNamespace::MissionDataSO::__get__beatmapCharacteristic() const {
...
constexpr void ::GlobalNamespace::MissionDataSO::__set__beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value)  {
...
constexpr ::GlobalNamespace::BeatmapDifficulty ::GlobalNamespace::MissionDataSO::__get__beatmapDifficulty() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapDifficulty, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::MissionDataSO::__set__missionObjectives(::ArrayW<::GlobalNamespace::MissionObjective> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::MissionObjective>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::MissionObjective>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::MissionObjective> ::GlobalNamespace::MissionDataSO::__get__missionObjectives() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::MissionObjective>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::MissionDataSO::__set__gameplayModifiers(::GlobalNamespace::GameplayModifiers value)  {
...
constexpr ::GlobalNamespace::GameplayModifiers ::GlobalNamespace::MissionDataSO::__get__gameplayModifiers() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiers, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::MissionDataSO::__set__missionHelp(::GlobalNamespace::MissionHelpSO value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::MissionHelpSO, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::MissionHelpSO>(value));
}
constexpr ::GlobalNamespace::MissionHelpSO ::GlobalNamespace::MissionDataSO::__get__missionHelp() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionHelpSO, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::GlobalNamespace::MissionObjective>, false>(const_cast<void*>(instance), ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::MissionHelpSO, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 ::GlobalNamespace::MissionDataSO::MissionDataSO()  : ::GlobalNamespace::PersistentScriptableObject(THROW_UNLESS(::il2cpp_utils::New<MissionDataSO>())) {}
 void ::GlobalNamespace::MissionDataSO::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionDataSO>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
