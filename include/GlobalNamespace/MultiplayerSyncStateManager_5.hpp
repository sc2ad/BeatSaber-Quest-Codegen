...
namespace GlobalNamespace {
  ...
  class MultiplayerSyncStateManager_5 : public UnityEngine::MonoBehaviour {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D1C300
    ...
    // [InjectAttribute] Offset: 0xD21C98
    ...
    TState Smooth(TState a, TState b, float smoooth) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Smooth", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(a, b, smoooth)));
