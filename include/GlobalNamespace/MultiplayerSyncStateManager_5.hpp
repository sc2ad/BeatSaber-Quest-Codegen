...
namespace GlobalNamespace {
  ...
  class MultiplayerSyncStateManager_5 : public UnityEngine::MonoBehaviour {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D1BE94
    class $$c : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename MultiplayerSyncStateManager_5<TStateTable, TType, TState, TSerializable, TDeltaSerializable>::$$c*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
      ...
      int $HandlePlayerConnected$b__37_0(GlobalNamespace::RemoteMultiplayerSyncState_3<TStateTable, TType, TState>* s) {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<HandlePlayerConnected>b__37_0", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(s))));
    ...
    // [InjectAttribute] Offset: 0xD21764
    ...
    GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>* get_localState_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_localState_NEW");
    ...
    int get_connectedPlayerCount_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_connectedPlayerCount_NEW");
    ...
    float get_syncTime_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_syncTime_NEW");
    ...
    float get_deltaUpdateFrequency() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_deltaUpdateFrequency_NEW");
    ...
    float get_fullStateUpdateFrequency() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_fullStateUpdateFrequency_NEW");
    ...
    int get_localBufferSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_localBufferSize_NEW");
    ...
    int get_remoteBufferSize() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_remoteBufferSize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    GlobalNamespace::IPacketPool_1<TSerializable>* get_serializablePool_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_serializablePool_NEW");
    ...
    // Offset: 0xFFFFFFFF
    GlobalNamespace::IPacketPool_1<TDeltaSerializable>* get_deltaSerializablePool_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_deltaSerializablePool_NEW");
      ...
      return ::il2cpp_utils::RunMethodThrow<GlobalNamespace::IPacketPool_1<TDeltaSerializable>*, false>(this, ___internal__method);
    }
    ...
    GlobalNamespace::MultiplayerSessionManager_MessageType get_messageType() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_messageType_NEW");
    ...
    GlobalNamespace::MultiplayerSessionManager_MessageType get_deltaMessageType() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::get_deltaMessageType_NEW");
    ...
    // Offset: 0xFFFFFFFF
    TState Interpolate_NEW(TState a, float timeA, TState b, float timeB, float time) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::Interpolate_NEW");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Interpolate", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(a, timeA, b, timeB, time)));
    ...
    // Offset: 0xFFFFFFFF
    TState Smooth_NEW(TState a, TState b, float smoooth) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::Smooth_NEW");
    ...
    void ClearBufferedStates_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::ClearBufferedStates_NEW");
    ...
    void HandleSyncDeltaPacket(TDeltaSerializable packet, GlobalNamespace::IConnectedPlayer* player) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "HandleSyncDeltaPacket", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(packet, player)));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, packet, player);
    }
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncState_NEW(int i) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::GetSyncState_NEW");
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncStateForPlayer_NEW(GlobalNamespace::IConnectedPlayer* player) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MultiplayerSyncStateManager_5::GetSyncStateForPlayer_NEW");
