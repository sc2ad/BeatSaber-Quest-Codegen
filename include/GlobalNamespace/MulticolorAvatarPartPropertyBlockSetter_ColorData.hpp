...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MulticolorAvatarPartPropertyBlockSetter::ColorData), 36 + sizeof(float) + ((36 + sizeof(float)) % 8 != 0 ? (8 - (36 + sizeof(float)) % 8) : 0)> __GlobalNamespace_MulticolorAvatarPartPropertyBlockSetter_ColorDataSizeCheck;
}
