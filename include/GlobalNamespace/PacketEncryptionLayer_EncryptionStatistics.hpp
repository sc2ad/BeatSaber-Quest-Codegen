...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PacketEncryptionLayer::EncryptionStatistics), 72 + sizeof(int64_t) + ((72 + sizeof(int64_t)) % 8 != 0 ? (8 - (72 + sizeof(int64_t)) % 8) : 0)> __GlobalNamespace_PacketEncryptionLayer_EncryptionStatisticsSizeCheck;
}
