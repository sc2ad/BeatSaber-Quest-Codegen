...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::*)(::GlobalNamespace::ScenesTransitionSetupDataSO)>(&::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x21449bc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::__set_nextScenesTransitionSetupData(::GlobalNamespace::ScenesTransitionSetupDataSO value)  {
...
constexpr ::GlobalNamespace::ScenesTransitionSetupDataSO ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::__get_nextScenesTransitionSetupData() const {
...
// Ctor Parameters [CppParam { name: "nextScenesTransitionSetupData", ty: "::GlobalNamespace::ScenesTransitionSetupDataSO", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData(::GlobalNamespace::ScenesTransitionSetupDataSO nextScenesTransitionSetupData)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData>(nextScenesTransitionSetupData))) {}
 void ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData::_ctor(::GlobalNamespace::ScenesTransitionSetupDataSO nextScenesTransitionSetupData)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::RecordingToolSettingsFlowCoordinator::__set__initData(::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData, 0xc8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData ::GlobalNamespace::RecordingToolSettingsFlowCoordinator::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__RecordingToolSettingsFlowCoordinator__InitData, 0xc8>(this->::bs_hook::Il2CppWrapperType::instance);
}
