...
namespace GlobalNamespace {
  ...
  class ColorSaturationValueSlider : public HMUI::Slider2D, public UnityEngine::EventSystems::IPointerUpHandler, public UnityEngine::EventSystems::IEventSystemHandler {
    public:
