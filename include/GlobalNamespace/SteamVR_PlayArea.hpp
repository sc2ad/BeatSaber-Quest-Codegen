...
namespace GlobalNamespace {
  ...
  class SteamVR_PlayArea : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(SteamVR_PlayArea::Size), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_SteamVR_PlayArea_SizeSizeCheck;
  ...
  check_size<sizeof(SteamVR_PlayArea), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_SteamVR_PlayAreaSizeCheck;
}
