...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::JumpDestinationMarker::*)()>(&GlobalNamespace::JumpDestinationMarker::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1f838c0;
...
GlobalNamespace::JumpDestinationMarker o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::JumpDestinationMarker>())};
return o;
}
