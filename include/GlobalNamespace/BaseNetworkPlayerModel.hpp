...
namespace GlobalNamespace {
  ...
  class BaseNetworkPlayerModel : public ::GlobalNamespace::StandaloneMonobehavior/*, public ::GlobalNamespace::INetworkPlayerModel*/ {
    ...
    [[deprecated("Use field access instead!")]] bool& dyn_$discoveryEnabled$k__BackingField();
    ...
    // protected System.Boolean CreateConnectedPlayerManager(IConnectionInitParams`1<T> initParams)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class T>
