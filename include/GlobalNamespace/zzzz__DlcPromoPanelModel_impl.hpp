...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17.MoveNext
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::*)()>(&GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::MoveNext)> {
  constexpr static std::size_t size = 0x46c;
  constexpr static std::size_t addrs = 0x21be878;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17>::get(),
                            "MoveNext",
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17.SetStateMachine
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::*)(System::Runtime::CompilerServices::IAsyncStateMachine)>(&GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::SetStateMachine)> {
...
constexpr  GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::operator System::Runtime::CompilerServices::IAsyncStateMachine() const {
return System::Runtime::CompilerServices::IAsyncStateMachine(::cordl_internals::Box(this).convert());
}
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: Some("{}") }, CppParam { name: "__4__this", ty: "GlobalNamespace::DlcPromoPanelModel", modifiers: "", def_value: Some("csnull") }, CppParam { name: "_newNotOwnedMusicPackPromoInfos_5__2", ty: "System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "__7__wrap2", ty: "::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "__7__wrap3", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_packData_5__5", ty: "GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo", modifiers: "", def_value: Some("csnull") }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: Some("{}") }]
constexpr GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::DlcPromoPanelModel __4__this, System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> _newNotOwnedMusicPackPromoInfos_5__2, ::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __7__wrap2, int32_t __7__wrap3, GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo _packData_5__5, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept : ::bs_hook::ValueTypeWrapper() {this->__1__state = __1__state;
...
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___1__state(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___1__state() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___t__builder(System::Runtime::CompilerServices::AsyncVoidMethodBuilder value)  {
...
constexpr System::Runtime::CompilerServices::AsyncVoidMethodBuilder GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___t__builder() const {
return ::cordl_internals::getInstanceField<System::Runtime::CompilerServices::AsyncVoidMethodBuilder, 0x8>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___4__this(GlobalNamespace::DlcPromoPanelModel value)  {
...
constexpr GlobalNamespace::DlcPromoPanelModel GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___4__this() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::DlcPromoPanelModel, 0x28>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set__newNotOwnedMusicPackPromoInfos_5__2(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x30>(this->__instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get__newNotOwnedMusicPackPromoInfos_5__2() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x30>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___7__wrap2(::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x38>(this->__instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___7__wrap2() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x38>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___7__wrap3(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x40>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___7__wrap3() const {
return ::cordl_internals::getInstanceField<int32_t, 0x40>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set__packData_5__5(GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo, 0x48>(this->__instance, std::forward<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>(value));
}
constexpr GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get__packData_5__5() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo, 0x48>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__set___u__1(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus> value)  {
::cordl_internals::setInstanceField<System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus>, 0x50>(this->__instance, std::forward<System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus>>(value));
}
constexpr System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus> GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::__get___u__1() const {
return ::cordl_internals::getInstanceField<System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus>, 0x50>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::MoveNext()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17>::get(),
                            "MoveNext",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 void GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17::SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17>::get(),
                            "SetStateMachine",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo (GlobalNamespace::DlcPromoPanelModel::*)(ByRef<bool>)>(&GlobalNamespace::DlcPromoPanelModel::GetPackDataForMainMenuPromoBanner)> {
...
constexpr void GlobalNamespace::DlcPromoPanelModel::__set__notOwnedMusicPackPromoInfos(::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> GlobalNamespace::DlcPromoPanelModel::__get__notOwnedMusicPackPromoInfos() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, force);
 ...
 GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo GlobalNamespace::DlcPromoPanelModel::GetPackDataForMainMenuPromoBanner(ByRef<bool> owned)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::DlcPromoPanelModel>::get(),
                            "GetPackDataForMainMenuPromoBanner",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo, false>(const_cast<void*>(instance), ___internal_method, owned);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::DlcPromoPanelModel GlobalNamespace::DlcPromoPanelModel::New_ctor()  {
GlobalNamespace::DlcPromoPanelModel o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::DlcPromoPanelModel>())};
return o;
}
