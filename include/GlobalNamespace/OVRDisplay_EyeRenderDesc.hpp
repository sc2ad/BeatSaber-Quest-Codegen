...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRDisplay::EyeRenderDesc), 16 + sizeof(GlobalNamespace::OVRDisplay::EyeFov) + ((16 + sizeof(GlobalNamespace::OVRDisplay::EyeFov)) % 8 != 0 ? (8 - (16 + sizeof(GlobalNamespace::OVRDisplay::EyeFov)) % 8) : 0)> __GlobalNamespace_OVRDisplay_EyeRenderDescSizeCheck;
}
