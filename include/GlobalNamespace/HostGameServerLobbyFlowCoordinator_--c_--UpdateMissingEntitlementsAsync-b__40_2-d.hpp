...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HostGameServerLobbyFlowCoordinator::$$c::$$UpdateMissingEntitlementsAsync$b__40_2$d), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::EntitlementsStatus>) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::EntitlementsStatus>)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::EntitlementsStatus>)) % 8) : 0)> __GlobalNamespace_HostGameServerLobbyFlowCoordinator_$$c_$$UpdateMissingEntitlementsAsync$b__40_2$dSizeCheck;
}
