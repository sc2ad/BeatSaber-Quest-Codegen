...
namespace GlobalNamespace {
  ...
  class PyramidBloomMainEffectSO : public ::GlobalNamespace::MainEffectSO {
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Shader*) == 0x8);
    // [SpaceAttribute] Offset: 0x111201C
    // [RangeAttribute] Offset: 0x111201C
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::PyramidBloomRendererSO::Pass) == 0x4);
    // [SpaceAttribute] Offset: 0x11120FC
    ...
    // [SpaceAttribute] Offset: 0x1112134
    // [RangeAttribute] Offset: 0x1112134
