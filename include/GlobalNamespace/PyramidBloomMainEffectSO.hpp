...
namespace GlobalNamespace {
  ...
  class PyramidBloomMainEffectSO : public GlobalNamespace::MainEffectSO {
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Shader*) == 0x8);
    // [SpaceAttribute] Offset: 0xDEB81C
    // [RangeAttribute] Offset: 0xDEB81C
    ...
    // Field size check
    static_assert(sizeof(GlobalNamespace::PyramidBloomRendererSO::Pass) == 0x4);
    // [SpaceAttribute] Offset: 0xDEB8FC
    ...
    // [SpaceAttribute] Offset: 0xDEB934
    // [RangeAttribute] Offset: 0xDEB934
