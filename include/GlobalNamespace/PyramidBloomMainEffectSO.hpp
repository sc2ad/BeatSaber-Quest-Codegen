...
namespace GlobalNamespace {
  ...
  class PyramidBloomMainEffectSO : public GlobalNamespace::MainEffectSO {
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Shader*) == 0x8);
    // [SpaceAttribute] Offset: 0xE99438
    // [RangeAttribute] Offset: 0xE99438
    ...
    // Field size check
    static_assert(sizeof(GlobalNamespace::PyramidBloomRendererSO::Pass) == 0x4);
    // [SpaceAttribute] Offset: 0xE99518
    ...
    // [SpaceAttribute] Offset: 0xE99550
    // [RangeAttribute] Offset: 0xE99550
