...
namespace GlobalNamespace {
  ...
  class PyramidBloomMainEffectSO : public GlobalNamespace::MainEffectSO {
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Shader*) == 0x8);
    // [SpaceAttribute] Offset: 0xD220CC
    // [RangeAttribute] Offset: 0xD220CC
    ...
    // Field size check
    static_assert(sizeof(GlobalNamespace::PyramidBloomRendererSO::Pass) == 0x4);
    // [SpaceAttribute] Offset: 0xD221AC
    ...
    // [SpaceAttribute] Offset: 0xD221E4
    // [RangeAttribute] Offset: 0xD221E4
