...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PyramidBloomMainEffectSO), 112 + sizeof(void*) + ((112 + sizeof(void*)) % 8 != 0 ? (8 - (112 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PyramidBloomMainEffectSOSizeCheck;
}
