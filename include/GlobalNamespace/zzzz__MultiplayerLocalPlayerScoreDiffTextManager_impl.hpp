...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager::*)(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State)>(&::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager::HandleStateChanged)> {
...
constexpr void ::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager::__set__hudInitData(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData ::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager::__get__hudInitData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager::HandleStateChanged(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State newState)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerLocalPlayerScoreDiffTextManager>::get(),
                            "HandleStateChanged",
                            std::vector<Il2CppClass*>{},
