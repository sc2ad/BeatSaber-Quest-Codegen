...
template<typename T>
class ____GlobalNamespace__BatchExtensions___Batch_d__0_1;
}
namespace GlobalNamespace {
...
class ____GlobalNamespace__BatchExtensions___Batch_d__0_1<T>;
}
// Type: ::<Batch>d__0`1
...
// Declarations
template<typename T>
using _Batch_d__0_1 = ::GlobalNamespace::____GlobalNamespace__BatchExtensions___Batch_d__0_1<T>;
...
class CORDL_TYPE ____GlobalNamespace__BatchExtensions___Batch_d__0_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__BatchExtensions___Batch_d__0_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BatchExtensions___Batch_d__0_1", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1(____GlobalNamespace__BatchExtensions___Batch_d__0_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BatchExtensions___Batch_d__0_1", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1(____GlobalNamespace__BatchExtensions___Batch_d__0_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BatchExtensions___Batch_d__0_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1& operator=(____GlobalNamespace__BatchExtensions___Batch_d__0_1&& o) noexcept = default;
  constexpr ____GlobalNamespace__BatchExtensions___Batch_d__0_1& operator=(____GlobalNamespace__BatchExtensions___Batch_d__0_1 const& o) noexcept = default;
...
explicit ____GlobalNamespace__BatchExtensions___Batch_d__0_1(int32_t __1__state) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::____GlobalNamespace__BatchExtensions___Batch_d__0_1, "", "BatchExtensions/<Batch>d__0`1");
