...
constexpr void GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection  GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection::Clockwise{0};
constexpr GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection  GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection::Counterclockwise{1};
...
constexpr void GlobalNamespace::LightGroupCircularLayouter::__set__rotationDirection(GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection>(value));
}
constexpr GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection GlobalNamespace::LightGroupCircularLayouter::__get__rotationDirection() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__LightGroupCircularLayouter__RotationDirection, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
