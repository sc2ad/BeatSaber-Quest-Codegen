...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HostGameServerLobbyFlowCoordinator), 416 + sizeof(void*) + ((416 + sizeof(void*)) % 8 != 0 ? (8 - (416 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_HostGameServerLobbyFlowCoordinatorSizeCheck;
}
