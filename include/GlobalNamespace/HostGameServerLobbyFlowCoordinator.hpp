...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HostGameServerLobbyFlowCoordinator), 416 + sizeof(void*) + 8 - (416 + sizeof(void*)) % 8> __GlobalNamespace_HostGameServerLobbyFlowCoordinatorSizeCheck;
}
