...
namespace GlobalNamespace {
template<typename TBase>
class ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c;
}
namespace GlobalNamespace {
...
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TBase>
class ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase>;
}
// Type: ::<>c
...
class CORDL_TYPE ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c(____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c(____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c& operator=(____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c&& o) noexcept = default;
  constexpr ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c& operator=(____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c const& o) noexcept = default;
                


// Fields

static ::GlobalNamespace::____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::GlobalNamespace::____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase> value) ;

static ::GlobalNamespace::____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase> __get___9() ;
...
// Ctor Parameters []
explicit ____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c() ;
...
public:
// Declarations
using __c = ::GlobalNamespace::____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c<TBase>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::____GlobalNamespace__BeatmapDataSortedListForTypeAndIds_1____c, "", "BeatmapDataSortedListForTypeAndIds`1/<>c");
