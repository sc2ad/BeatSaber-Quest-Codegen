...
namespace GlobalNamespace {
  ...
  class TrackLaneRingsRotationEffectSpawner : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(TrackLaneRingsRotationEffectSpawner::RotationStepType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_TrackLaneRingsRotationEffectSpawner_RotationStepTypeSizeCheck;
  ...
  check_size<sizeof(TrackLaneRingsRotationEffectSpawner), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_TrackLaneRingsRotationEffectSpawnerSizeCheck;
}
