...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::FixedFoveatedRenderingLevel), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRPlugin_FixedFoveatedRenderingLevelSizeCheck;
}
