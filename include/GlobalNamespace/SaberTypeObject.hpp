...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SaberTypeObject), 24 + sizeof(GlobalNamespace::SaberType) + ((24 + sizeof(GlobalNamespace::SaberType)) % 8 != 0 ? (8 - (24 + sizeof(GlobalNamespace::SaberType)) % 8) : 0)> __GlobalNamespace_SaberTypeObjectSizeCheck;
}
