...
namespace GlobalNamespace {
  ...
  class InstancedMaterialLightWithId : public ::GlobalNamespace::LightWithIdMonoBehaviour {
    ...
    char __padding1[0x3] = {};
    // [DrawIfAttribute] Offset: 0x10FD630
    ...
    // [DrawIfAttribute] Offset: 0x10FD6D4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // private System.Boolean _hdr
    // Size: 0x1
    // Offset: 0x44
    bool hdr;
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: hdr and: color
    char __padding4[0x3] = {};
    ...
    // Get instance field reference: private System.Boolean _hdr
    [[deprecated("Use field access instead!")]] bool& dyn__hdr();
  ...
  #pragma pack(pop)
  static check_size<sizeof(InstancedMaterialLightWithId), 88 + sizeof(bool)> __GlobalNamespace_InstancedMaterialLightWithIdSizeCheck;
  static_assert(sizeof(InstancedMaterialLightWithId) == 0x59);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
