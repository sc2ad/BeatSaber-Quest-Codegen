...
namespace GlobalNamespace {
  ...
  class ThreadStaticPacketPool_1 : public ::Il2CppObject {
    ...
    // [ThreadStaticAttribute] Offset: 0xDAA004
    ...
    static GlobalNamespace::PacketPool_1<T>* get_pool() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ThreadStaticPacketPool_1<T>*>::get(), "get_pool", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    static void NoDomainReloadInit() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ThreadStaticPacketPool_1::NoDomainReloadInit");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ThreadStaticPacketPool_1<T>*>::get(), "NoDomainReloadInit", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
