...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_2 : public ::GlobalNamespace::RemoteProcedureCall {
    ...
    ::GlobalNamespace::IRemoteProcedureCall* Init(float syncTime, T0 value0, T1 value1) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<::GlobalNamespace::IRemoteProcedureCall*, false>(this, ___internal__method, syncTime, value0, value1);
    }
    ...
    void Release() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::RemoteProcedureCall_2::Release");
