...
constexpr void ::GlobalNamespace::MissedNoteEffectSpawner::__set__initData(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData value)  {
...
constexpr ::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData ::GlobalNamespace::MissedNoteEffectSpawner::__get__initData() const {
...
// Ctor Parameters []
 ::GlobalNamespace::MissedNoteEffectSpawner::MissedNoteEffectSpawner()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<MissedNoteEffectSpawner>())) {}
