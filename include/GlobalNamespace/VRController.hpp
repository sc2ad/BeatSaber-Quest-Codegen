...
namespace GlobalNamespace {
  ...
  check_size<sizeof(VRController), 56 + sizeof(UnityEngine::Vector3) + ((56 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (56 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __GlobalNamespace_VRControllerSizeCheck;
}
