...
namespace GlobalNamespace {
  ...
  check_size<sizeof(EnterPlayerGuestNameViewController), 152 + sizeof(void*) + 8 - (152 + sizeof(void*)) % 8> __GlobalNamespace_EnterPlayerGuestNameViewControllerSizeCheck;
}
