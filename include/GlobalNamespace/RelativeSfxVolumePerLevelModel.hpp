...
namespace GlobalNamespace {
  ...
  class RelativeSfxVolumePerLevelModel : public ::Il2CppObject {
    ...
    // Creating value type constructor for type: RelativeSfxVolumePerLevelModel
    RelativeSfxVolumePerLevelModel(System::Collections::Generic::Dictionary_2<::Il2CppString*, float>* relativeSfxVolumePerLevelId_ = {}) noexcept : relativeSfxVolumePerLevelId{relativeSfxVolumePerLevelId_} {}
