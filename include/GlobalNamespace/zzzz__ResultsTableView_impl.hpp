...
constexpr  GlobalNamespace::ResultsTableView::operator HMUI::HMUI__TableView__IDataSource() const noexcept {
...
GlobalNamespace::ResultsTableView o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::ResultsTableView>())};
return o;
}
