...
namespace GlobalNamespace {
class ____GlobalNamespace__MovementBeatmapEventEffect__MovementData;
}
// Type: ::MovementData
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__MovementBeatmapEventEffect__MovementData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____GlobalNamespace__MovementBeatmapEventEffect__MovementData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MovementBeatmapEventEffect__MovementData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData(____GlobalNamespace__MovementBeatmapEventEffect__MovementData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MovementBeatmapEventEffect__MovementData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData(____GlobalNamespace__MovementBeatmapEventEffect__MovementData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MovementBeatmapEventEffect__MovementData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData& operator=(____GlobalNamespace__MovementBeatmapEventEffect__MovementData&& o) noexcept = default;
  constexpr ____GlobalNamespace__MovementBeatmapEventEffect__MovementData& operator=(____GlobalNamespace__MovementBeatmapEventEffect__MovementData const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__MovementBeatmapEventEffect__MovementData() ;
...
public:
// Declarations
using MovementData = ::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData;
...
constexpr float_t __get__transitionSpeed() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData> __declspec(property(get=__get__movementData, put=__set__movementData))  _movementData;

constexpr void __set__movementData(::ArrayW<::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData> __get__movementData() const;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MovementBeatmapEventEffect__MovementData, "", "MovementBeatmapEventEffect/MovementData");
