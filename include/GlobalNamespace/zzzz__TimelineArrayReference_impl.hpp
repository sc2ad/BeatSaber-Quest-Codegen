...
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::____GlobalNamespace__TimelineArrayReference__ArrayTypes(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes  ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::TubeLight{0};
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes  ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::Transform{1};
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes  ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::Canvas{2};
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes  ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::TextMeshPro{3};
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes  ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes::DirectionalLight{4};
...
constexpr void ::GlobalNamespace::TimelineArrayReference::__set_arrayType(::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes ::GlobalNamespace::TimelineArrayReference::__get_arrayType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
