...
namespace GlobalNamespace {
  ...
  class AsyncHelper::$$c__DisplayClass0_0_1 : public ::Il2CppObject {
    ...
    struct $$RunSync$b__0$d : public System::Runtime::CompilerServices::IAsyncStateMachine, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::ValueType {
      public:
