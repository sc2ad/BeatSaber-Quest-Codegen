...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: CF47E4
  template<typename T>
  class AsyncHelper::$$c__DisplayClass0_0_1 : public ::Il2CppObject {
    ...
    struct $$RunSync$b__0$d : public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
      ...
      // Offset: 0xFFFFFFFF
      void MoveNext_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::AsyncHelper::$$c__DisplayClass0_0_1::$$RunSync$b__0$d::MoveNext_NEW");
      ...
      void SetStateMachine_NEW(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
        static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::AsyncHelper::$$c__DisplayClass0_0_1::$$RunSync$b__0$d::SetStateMachine_NEW");
