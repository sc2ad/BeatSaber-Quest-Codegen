...
namespace GlobalNamespace {
  ...
  check_size<sizeof(CoreGameHUDController::InitData), 18 + sizeof(bool) + ((18 + sizeof(bool)) % 8 != 0 ? (8 - (18 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_CoreGameHUDController_InitDataSizeCheck;
}
