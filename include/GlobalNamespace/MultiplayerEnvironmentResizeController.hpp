...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerEnvironmentResizeController), 66 + sizeof(bool) + ((66 + sizeof(bool)) % 8 != 0 ? (8 - (66 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_MultiplayerEnvironmentResizeControllerSizeCheck;
}
