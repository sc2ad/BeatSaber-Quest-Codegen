...
namespace GlobalNamespace {
class ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60;
}
namespace GlobalNamespace {
class ____GlobalNamespace__LobbyPlayersDataModel____c;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43;
}
// Type: ::<>c
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__LobbyPlayersDataModel____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____GlobalNamespace__LobbyPlayersDataModel____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LobbyPlayersDataModel____c", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LobbyPlayersDataModel____c(____GlobalNamespace__LobbyPlayersDataModel____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LobbyPlayersDataModel____c", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LobbyPlayersDataModel____c(____GlobalNamespace__LobbyPlayersDataModel____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LobbyPlayersDataModel____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LobbyPlayersDataModel____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LobbyPlayersDataModel____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LobbyPlayersDataModel____c& operator=(____GlobalNamespace__LobbyPlayersDataModel____c&& o) noexcept = default;
  constexpr ____GlobalNamespace__LobbyPlayersDataModel____c& operator=(____GlobalNamespace__LobbyPlayersDataModel____c const& o) noexcept = default;
                


// Fields

static ::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c value) ;

static ::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c __get___9() ;
...
// Ctor Parameters []
explicit ____GlobalNamespace__LobbyPlayersDataModel____c() ;
...
struct CORDL_TYPE ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::LobbyPlayersDataModel", modifiers: "", def_value: None }, CppParam { name: "_songPackMask_5__2", ty: "::GlobalNamespace::SongPackMask", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "::ArrayW<::GlobalNamespace::IBeatmapLevelPack>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap3", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_dlcSongPack_5__5", ty: "::GlobalNamespace::IBeatmapLevelPack", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::LobbyPlayersDataModel __4__this, ::GlobalNamespace::SongPackMask _songPackMask_5__2, ::ArrayW<::GlobalNamespace::IBeatmapLevelPack> __7__wrap2, int32_t __7__wrap3, ::GlobalNamespace::IBeatmapLevelPack _dlcSongPack_5__5, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept;


                    constexpr ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43(____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43 const&) = default;
                    constexpr ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43(____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43&&) = default;
                    constexpr ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43& operator=(____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43& operator=(____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60(____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60(____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60& operator=(____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60&& o) noexcept = default;
  constexpr ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60& operator=(____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60 const& o) noexcept = default;
...
constexpr ::GlobalNamespace::LobbyPlayersDataModel __get___4__this() const;
 ...
 ::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::GlobalNamespace::LobbyPlayerData> __declspec(property(get=__get___7__wrap1, put=__set___7__wrap1))  __7__wrap1;

constexpr void __set___7__wrap1(::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::GlobalNamespace::LobbyPlayerData> value) ;

constexpr ::System::Collections::Generic::____System__Collections__Generic__Dictionary_2__Enumerator<::StringW,::GlobalNamespace::LobbyPlayerData> __get___7__wrap1() const;
...
explicit ____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60(int32_t __1__state) ;
...
public:
// Declarations
using _GetEnumerator_d__60 = ::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60;

using _SetOwnedSongPacks_d__43 = ::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43;

using __c = ::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel___GetEnumerator_d__60, "", "LobbyPlayersDataModel/<GetEnumerator>d__60");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel____c, "", "LobbyPlayersDataModel/<>c");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LobbyPlayersDataModel___SetOwnedSongPacks_d__43, "", "LobbyPlayersDataModel/<SetOwnedSongPacks>d__43");
