...
namespace GlobalNamespace {
  ...
  class UserLoginDtoDataSource : public ::CsObject, public OnlineServices::API::IUserLoginDtoDataSource {
    public:
    ...
    static ::CsString* _get_kVersion();
    // Set static field: static private System.String kVersion
    static void _set_kVersion(::CsString* value);
