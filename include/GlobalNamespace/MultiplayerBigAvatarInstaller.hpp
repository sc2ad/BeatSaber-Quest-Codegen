...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerBigAvatarInstaller), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerBigAvatarInstallerSizeCheck;
}
