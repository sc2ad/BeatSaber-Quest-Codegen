...
namespace GlobalNamespace {
  ...
  class ConnectedPlayerManager::PlayerIdentityPacket : public ::Il2CppObject/*, public LiteNetLib::Utils::INetSerializable, public GlobalNamespace::IPoolablePacket*/ {
    ...
    PlayerIdentityPacket(GlobalNamespace::PlayerStateHash playerState_ = {}, GlobalNamespace::MultiplayerAvatarData playerAvatar_ = {}, GlobalNamespace::ByteArrayNetSerializable* random_ = {}, GlobalNamespace::ByteArrayNetSerializable* publicEncryptionKey_ = {}) noexcept : playerState{playerState_}, playerAvatar{playerAvatar_}, random{random_}, publicEncryptionKey{publicEncryptionKey_} {}
    ...
    // Offset: 0x1563FC4
    GlobalNamespace::ConnectedPlayerManager::PlayerIdentityPacket* Init(GlobalNamespace::PlayerStateHash states, GlobalNamespace::MultiplayerAvatarData avatar, ::Array<uint8_t>* random, ::Array<uint8_t>* publicEncryptionKey);
