...
namespace GlobalNamespace {
  ...
  check_size<sizeof(StandardLevelReturnToMenuController), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_StandardLevelReturnToMenuControllerSizeCheck;
}
