...
// Ctor Parameters []
 ::GlobalNamespace::PresentHiddenSettingsAfterNClicks::PresentHiddenSettingsAfterNClicks()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<PresentHiddenSettingsAfterNClicks>())) {}
