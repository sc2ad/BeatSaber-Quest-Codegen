...
namespace GlobalNamespace {
  ...
  class OVRSkeletonRenderer : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRSkeletonRenderer::ConfidenceBehavior), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRSkeletonRenderer_ConfidenceBehaviorSizeCheck;
    ...
    check_size<sizeof(OVRSkeletonRenderer::SystemGestureBehavior), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRSkeletonRenderer_SystemGestureBehaviorSizeCheck;
  ...
  check_size<sizeof(OVRSkeletonRenderer), 135 + sizeof(bool) + 8 - (135 + sizeof(bool)) % 8> __GlobalNamespace_OVRSkeletonRendererSizeCheck;
}
