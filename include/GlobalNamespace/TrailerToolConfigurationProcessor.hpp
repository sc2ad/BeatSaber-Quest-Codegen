...
namespace GlobalNamespace {
  ...
  class TrailerToolConfigurationProcessor : public ::Il2CppObject {
    ...
    // Nested type: ::GlobalNamespace::TrailerToolConfigurationProcessor::$$c__DisplayClass22_0
    class $$c__DisplayClass22_0;
    public:
    // [InjectAttribute] Offset: 0x10D339C
    ...
    // public ObjectsMovementRecorder/InitData CreateObjectsMovementRecorderInitDataFromConfiguration(TrailerToolConfigurationProcessor/TrailerToolConfiguration trailerToolConfiguration)
    // Offset: 0x142253C
    ::GlobalNamespace::ObjectsMovementRecorder::InitData* CreateObjectsMovementRecorderInitDataFromConfiguration(::GlobalNamespace::TrailerToolConfigurationProcessor::TrailerToolConfiguration* trailerToolConfiguration);
    // public MenuDestination CreateMenuDestinationFromConfiguration(TrailerToolConfigurationProcessor/TrailerToolConfiguration trailerToolConfiguration, System.Collections.Generic.IEnumerable`1<IBeatmapLevelPack> beatmapLevelPacks, BeatmapCharacteristicCollectionSO beatmapCharacteristicCollection)
    // Offset: 0x1422C4C
    ::GlobalNamespace::MenuDestination* CreateMenuDestinationFromConfiguration(::GlobalNamespace::TrailerToolConfigurationProcessor::TrailerToolConfiguration* trailerToolConfiguration, ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::IBeatmapLevelPack*>* beatmapLevelPacks, ::GlobalNamespace::BeatmapCharacteristicCollectionSO* beatmapCharacteristicCollection);
  ...
  #pragma pack(pop)
  static check_size<sizeof(TrailerToolConfigurationProcessor), 16 + sizeof(::GlobalNamespace::IBeatSaberLogger*)> __GlobalNamespace_TrailerToolConfigurationProcessorSizeCheck;
  static_assert(sizeof(TrailerToolConfigurationProcessor) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ObjectsMovementRecorder::InitData* (GlobalNamespace::TrailerToolConfigurationProcessor::*)(::GlobalNamespace::TrailerToolConfigurationProcessor::TrailerToolConfiguration*)>(&GlobalNamespace::TrailerToolConfigurationProcessor::CreateObjectsMovementRecorderInitDataFromConfiguration)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::MenuDestination* (GlobalNamespace::TrailerToolConfigurationProcessor::*)(::GlobalNamespace::TrailerToolConfigurationProcessor::TrailerToolConfiguration*, ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::IBeatmapLevelPack*>*, ::GlobalNamespace::BeatmapCharacteristicCollectionSO*)>(&GlobalNamespace::TrailerToolConfigurationProcessor::CreateMenuDestinationFromConfiguration)> {
  static const MethodInfo* get() {
    static auto* trailerToolConfiguration = &::il2cpp_utils::GetClassFromName("", "TrailerToolConfigurationProcessor/TrailerToolConfiguration")->byval_arg;
