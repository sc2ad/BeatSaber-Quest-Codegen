...
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::LightGroupSO>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 GlobalNamespace::LightGroupEditorPrefabContext GlobalNamespace::LightGroupEditorPrefabContext::New_ctor()  {
GlobalNamespace::LightGroupEditorPrefabContext o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::LightGroupEditorPrefabContext>())};
return o;
}
