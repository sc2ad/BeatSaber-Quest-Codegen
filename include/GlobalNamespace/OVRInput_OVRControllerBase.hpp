...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerBase), 256 + sizeof(bool) + ((256 + sizeof(bool)) % 8 != 0 ? (8 - (256 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerBaseSizeCheck;
}
