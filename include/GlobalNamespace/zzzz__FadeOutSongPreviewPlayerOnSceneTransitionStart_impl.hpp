...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::*)()>(&GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::Start)> {
  ...
  constexpr static std::size_t addrs = 0x20bb874;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart>::get(),
                            "Start",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::*)()>(&GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x20bb900;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::*)(float_t)>(&GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::HandleGameScenesManagerTransitionDidStart)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x20bb9d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::*)()>(&GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20bba0c;
...
constexpr GlobalNamespace::AudioPlayerBase GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::__get__songPreviewPlayer() const {
...
constexpr GlobalNamespace::GameScenesManager GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::__get__gameScenesManager() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::HandleGameScenesManagerTransitionDidStart(float_t duration)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart>::get(),
                            "HandleGameScenesManagerTransitionDidStart",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::FadeOutSongPreviewPlayerOnSceneTransitionStart()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<FadeOutSongPreviewPlayerOnSceneTransitionStart>())) {}
 void GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::FadeOutSongPreviewPlayerOnSceneTransitionStart>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
