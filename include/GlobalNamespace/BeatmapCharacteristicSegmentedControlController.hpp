...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapCharacteristicSegmentedControlController), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __GlobalNamespace_BeatmapCharacteristicSegmentedControlControllerSizeCheck;
}
