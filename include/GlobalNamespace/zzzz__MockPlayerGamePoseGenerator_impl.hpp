...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::LevelCompletionResults (*)(::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType)>(&::GlobalNamespace::MockPlayerGamePoseGenerator::CreateEmptyLevelCompletionResults)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::LevelCompletionResults ::GlobalNamespace::MockPlayerGamePoseGenerator::CreateEmptyLevelCompletionResults(::GlobalNamespace::____GlobalNamespace__LevelCompletionResults__LevelEndStateType levelEndStateType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MockPlayerGamePoseGenerator>::get(),
                            "CreateEmptyLevelCompletionResults",
                            std::vector<Il2CppClass*>{},
