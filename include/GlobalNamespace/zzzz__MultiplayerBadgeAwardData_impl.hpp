...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IConnectedPlayer (::GlobalNamespace::MultiplayerBadgeAwardData::*)()>(&::GlobalNamespace::MultiplayerBadgeAwardData::get_awardedPlayer)> {
  ...
  constexpr static std::size_t addrs = 0x20da304;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::MultiplayerBadgeAwardData::*)()>(&::GlobalNamespace::MultiplayerBadgeAwardData::get_titleLocalizationKey)> {
  ...
  constexpr static std::size_t addrs = 0x20da30c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::MultiplayerBadgeAwardData::*)()>(&::GlobalNamespace::MultiplayerBadgeAwardData::get_title)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20da328;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::MultiplayerBadgeAwardData::*)()>(&::GlobalNamespace::MultiplayerBadgeAwardData::get_subtitle)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20da330;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Sprite (::GlobalNamespace::MultiplayerBadgeAwardData::*)()>(&::GlobalNamespace::MultiplayerBadgeAwardData::get_icon)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20da338;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerBadgeAwardData::*)(::GlobalNamespace::IConnectedPlayer, float_t, ::StringW, ::StringW, ::GlobalNamespace::MultiplayerBadgeDataSO)>(&::GlobalNamespace::MultiplayerBadgeAwardData::_ctor)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x20d85d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::MultiplayerBadgeAwardData::*)(::bs_hook::Il2CppWrapperType)>(&::GlobalNamespace::MultiplayerBadgeAwardData::CompareTo)> {
  constexpr static std::size_t size = 0xf0;
  constexpr static std::size_t addrs = 0x20da340;
...
constexpr  ::GlobalNamespace::MultiplayerBadgeAwardData::operator ::System::IComparable() const noexcept {
...
constexpr ::GlobalNamespace::IConnectedPlayer ::GlobalNamespace::MultiplayerBadgeAwardData::__get__awardedPlayer() const {
...
constexpr float_t ::GlobalNamespace::MultiplayerBadgeAwardData::__get__weight() const {
...
constexpr ::StringW ::GlobalNamespace::MultiplayerBadgeAwardData::__get__title() const {
...
constexpr ::StringW ::GlobalNamespace::MultiplayerBadgeAwardData::__get__subtitle() const {
...
constexpr ::UnityEngine::Sprite ::GlobalNamespace::MultiplayerBadgeAwardData::__get__icon() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::MultiplayerBadgeDataSO, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::MultiplayerBadgeDataSO>(value));
}
constexpr ::GlobalNamespace::MultiplayerBadgeDataSO ::GlobalNamespace::MultiplayerBadgeAwardData::__get__badgeData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerBadgeDataSO, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, awardedPlayer, weight, title, subtitle, badgeData);
}
 int32_t ::GlobalNamespace::MultiplayerBadgeAwardData::CompareTo(::bs_hook::Il2CppWrapperType obj)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerBadgeAwardData>::get(),
                            "CompareTo",
                            std::vector<Il2CppClass*>{},
