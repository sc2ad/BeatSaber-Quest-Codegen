...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_Overlay::IntersectionResults), 32 + sizeof(float) + ((32 + sizeof(float)) % 8 != 0 ? (8 - (32 + sizeof(float)) % 8) : 0)> __GlobalNamespace_SteamVR_Overlay_IntersectionResultsSizeCheck;
}
