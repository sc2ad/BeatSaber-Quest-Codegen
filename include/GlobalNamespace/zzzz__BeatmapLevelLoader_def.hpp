...
namespace GlobalNamespace {
struct ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4;
}
...
struct CORDL_TYPE ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult(bool isError, ::GlobalNamespace::IBeatmapLevel beatmapLevel) noexcept;


                    constexpr ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult(____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult const&) = default;
                    constexpr ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult(____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult&&) = default;
                    constexpr ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult& operator=(____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult& operator=(____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::BeatmapLevelLoader", modifiers: "", def_value: None }, CppParam { name: "previewLevel", ty: "::GlobalNamespace::IPreviewBeatmapLevel", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "_level_5__2", ty: "::GlobalNamespace::IBeatmapLevel", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::GetAssetBundleFileResult>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: None }, CppParam { name: "__u__3", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevel>", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult> __t__builder, ::GlobalNamespace::BeatmapLevelLoader __4__this, ::GlobalNamespace::IPreviewBeatmapLevel previewLevel, ::System::Threading::CancellationToken cancellationToken, ::GlobalNamespace::IBeatmapLevel _level_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::GetAssetBundleFileResult> __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<bool> __u__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevel> __u__3) noexcept;


                    constexpr ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4(____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4 const&) = default;
                    constexpr ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4(____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4&&) = default;
                    constexpr ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4& operator=(____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4& operator=(____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr int32_t __get___1__state() const;
 ...
 ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult> __declspec(property(get=__get___t__builder, put=__set___t__builder))  __t__builder;

constexpr void __set___t__builder(::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult> value) ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult> __get___t__builder() const;
...
public:
// Declarations
using _LoadBeatmapLevelAsync_d__4 = ::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4;

using LoadBeatmapLevelResult = ::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult;
...
/// @brief Method LoadBeatmapLevelAsync addr 0x21e17c0 size 0x114 virtual false final false
 ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult> LoadBeatmapLevelAsync(::GlobalNamespace::IPreviewBeatmapLevel previewLevel, ::System::Threading::CancellationToken cancellationToken) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader__LoadBeatmapLevelResult, "", "BeatmapLevelLoader/LoadBeatmapLevelResult");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, "", "BeatmapLevelLoader/<LoadBeatmapLevelAsync>d__4");
