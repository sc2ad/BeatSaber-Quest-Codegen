...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerActivePlayersTimeOffsetAverage), 28 + sizeof(float) + ((28 + sizeof(float)) % 8 != 0 ? (8 - (28 + sizeof(float)) % 8) : 0)> __GlobalNamespace_MultiplayerActivePlayersTimeOffsetAverageSizeCheck;
}
