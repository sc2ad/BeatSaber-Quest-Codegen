...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AsyncHelper::$$c__DisplayClass1_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_AsyncHelper_$$c__DisplayClass1_0SizeCheck;
}
