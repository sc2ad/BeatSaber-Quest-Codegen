...
namespace GlobalNamespace {
  ...
  class OculusNetworkPlayerModel : public GlobalNamespace::PlatformNetworkPlayerModel {
    ...
    // [InjectAttribute] Offset: 0xDC46DC
    ...
    // Field size check
    static_assert(sizeof(System::Collections::Generic::List_1<GlobalNamespace::OculusNetworkPlayerModel::OculusNetworkPlayer*>*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xDC46EC
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC46FC
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC470C
    ...
    static OculusNetworkPlayerModel* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("OculusNetworkPlayerModel").WithContext(".ctor");
