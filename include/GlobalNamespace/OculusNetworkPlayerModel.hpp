...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusNetworkPlayerModel), 192 + sizeof(void*) + ((192 + sizeof(void*)) % 8 != 0 ? (8 - (192 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OculusNetworkPlayerModelSizeCheck;
}
