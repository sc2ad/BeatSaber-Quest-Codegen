...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRGearVrControllerTest::BoolMonitor), 40 + sizeof(float) + ((40 + sizeof(float)) % 8 != 0 ? (8 - (40 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRGearVrControllerTest_BoolMonitorSizeCheck;
}
