...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRGearVrControllerTest::BoolMonitor), 40 + sizeof(float) + 8 - (40 + sizeof(float)) % 8> __GlobalNamespace_OVRGearVrControllerTest_BoolMonitorSizeCheck;
}
