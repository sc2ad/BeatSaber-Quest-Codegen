...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerConnectedPlayerDuelOutroAnimator), 88 + sizeof(bool) + ((88 + sizeof(bool)) % 8 != 0 ? (8 - (88 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_MultiplayerConnectedPlayerDuelOutroAnimatorSizeCheck;
}
