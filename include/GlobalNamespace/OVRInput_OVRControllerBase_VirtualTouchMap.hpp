...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerBase::VirtualTouchMap), 64 + sizeof(GlobalNamespace::OVRInput::RawTouch) + ((64 + sizeof(GlobalNamespace::OVRInput::RawTouch)) % 8 != 0 ? (8 - (64 + sizeof(GlobalNamespace::OVRInput::RawTouch)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerBase_VirtualTouchMapSizeCheck;
}
