...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LanguageSettingsPresetsSO::Preset), 24 + sizeof(Polyglot::Language) + ((24 + sizeof(Polyglot::Language)) % 8 != 0 ? (8 - (24 + sizeof(Polyglot::Language)) % 8) : 0)> __GlobalNamespace_LanguageSettingsPresetsSO_PresetSizeCheck;
}
