...
namespace GlobalNamespace {
  ...
  class GenericSignal_1 : public GlobalNamespace::Signal {
    ...
    System::Action_1<T>* _get__floatEvent() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::GenericSignal_1::_get__floatEvent");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<System::Action_1<T>*>(___internal__instance, "_floatEvent"));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Action`1<T> _floatEvent
    void _set__floatEvent(System::Action_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::GenericSignal_1::_set__floatEvent");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_floatEvent", value));
    }
