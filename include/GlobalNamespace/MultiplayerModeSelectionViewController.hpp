...
namespace GlobalNamespace {
  ...
  class MultiplayerModeSelectionViewController : public HMUI::ViewController {
    ...
    check_size<sizeof(MultiplayerModeSelectionViewController::MenuButton), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerModeSelectionViewController_MenuButtonSizeCheck;
  ...
  check_size<sizeof(MultiplayerModeSelectionViewController), 168 + sizeof(void*) + ((168 + sizeof(void*)) % 8 != 0 ? (8 - (168 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerModeSelectionViewControllerSizeCheck;
}
