...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_Controller::DeviceRelation), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_SteamVR_Controller_DeviceRelationSizeCheck;
}
