...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLeaderboardPanelItem), 144 + sizeof(int) + ((144 + sizeof(int)) % 8 != 0 ? (8 - (144 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerLeaderboardPanelItemSizeCheck;
}
