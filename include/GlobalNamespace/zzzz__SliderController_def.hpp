...
namespace GlobalNamespace {
class ____GlobalNamespace__SliderController___DissolveCoroutine_d__70;
}
namespace GlobalNamespace {
class ______GlobalNamespace__SliderController__Pool__Long;
}
namespace GlobalNamespace {
class ______GlobalNamespace__SliderController__Pool__Medium;
}
namespace GlobalNamespace {
class ______GlobalNamespace__SliderController__Pool__Short;
}
// Type: ::LengthType
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ____GlobalNamespace__SliderController__LengthType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__SliderController__LengthType(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__SliderController__LengthType(____GlobalNamespace__SliderController__LengthType const&) = default;
                    constexpr ____GlobalNamespace__SliderController__LengthType(____GlobalNamespace__SliderController__LengthType&&) = default;
                    constexpr ____GlobalNamespace__SliderController__LengthType& operator=(____GlobalNamespace__SliderController__LengthType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__SliderController__LengthType& operator=(____GlobalNamespace__SliderController__LengthType&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__SliderController__LengthType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__SliderController__LengthType_Unwrapped : int32_t {
__Short = 0,
__Medium = 1,
__Long = 2,
};
...
constexpr operator ______GlobalNamespace__SliderController__LengthType_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__SliderController__LengthType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType const Short;

/// @brief Field Medium offset 0
static ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType const Medium;

/// @brief Field Long offset 0
static ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType const Long;
...
public:
// Declarations
using _DissolveCoroutine_d__70 = ::GlobalNamespace::____GlobalNamespace__SliderController___DissolveCoroutine_d__70;

using Pool = ::GlobalNamespace::____GlobalNamespace__SliderController__Pool;

using LengthType = ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType;
...
constexpr ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISliderTailDidMovePastCutMarkEvent> __get__sliderTailDidMovePastCutMark() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType __declspec(property(get=__get__lengthType, put=__set__lengthType))  _lengthType;

constexpr void __set__lengthType(::GlobalNamespace::____GlobalNamespace__SliderController__LengthType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType __get__lengthType() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType __declspec(property(get=get_lengthType))  lengthType;
...
/// @brief Method get_lengthType addr 0x22471b0 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType get_lengthType() ;
...
/// @brief Method Init addr 0x224727c size 0x3d0 virtual false final false
 void Init(::GlobalNamespace::____GlobalNamespace__SliderController__LengthType lengthType, ::GlobalNamespace::SliderData sliderData, float_t worldRotation, ::UnityEngine::Vector3 headNoteJumpStartPos, ::UnityEngine::Vector3 tailNoteJumpStartPos, ::UnityEngine::Vector3 headNoteJumpEndPos, ::UnityEngine::Vector3 tailNoteJumpEndPos, float_t jumpDuration, float_t startNoteJumpGravity, float_t endNoteJumpGravity, float_t noteUniformScale) ;
...
class CORDL_TYPE ______GlobalNamespace__SliderController__Pool__Short : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~______GlobalNamespace__SliderController__Pool__Short() = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Short", modifiers: " const&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Short(______GlobalNamespace__SliderController__Pool__Short const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Short", modifiers: "&&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Short(______GlobalNamespace__SliderController__Pool__Short&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______GlobalNamespace__SliderController__Pool__Short(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController>(ptr) {
}


  constexpr ______GlobalNamespace__SliderController__Pool__Short& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Short& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Short& operator=(______GlobalNamespace__SliderController__Pool__Short&& o) noexcept = default;
  constexpr ______GlobalNamespace__SliderController__Pool__Short& operator=(______GlobalNamespace__SliderController__Pool__Short const& o) noexcept = default;
...
// Ctor Parameters []
explicit ______GlobalNamespace__SliderController__Pool__Short() ;
...
class CORDL_TYPE ______GlobalNamespace__SliderController__Pool__Medium : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~______GlobalNamespace__SliderController__Pool__Medium() = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Medium", modifiers: " const&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Medium(______GlobalNamespace__SliderController__Pool__Medium const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Medium", modifiers: "&&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Medium(______GlobalNamespace__SliderController__Pool__Medium&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______GlobalNamespace__SliderController__Pool__Medium(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController>(ptr) {
}


  constexpr ______GlobalNamespace__SliderController__Pool__Medium& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Medium& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Medium& operator=(______GlobalNamespace__SliderController__Pool__Medium&& o) noexcept = default;
  constexpr ______GlobalNamespace__SliderController__Pool__Medium& operator=(______GlobalNamespace__SliderController__Pool__Medium const& o) noexcept = default;
...
// Ctor Parameters []
explicit ______GlobalNamespace__SliderController__Pool__Medium() ;
...
class CORDL_TYPE ______GlobalNamespace__SliderController__Pool__Long : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~______GlobalNamespace__SliderController__Pool__Long() = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Long", modifiers: " const&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Long(______GlobalNamespace__SliderController__Pool__Long const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______GlobalNamespace__SliderController__Pool__Long", modifiers: "&&", def_value: None }]
constexpr ______GlobalNamespace__SliderController__Pool__Long(______GlobalNamespace__SliderController__Pool__Long&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______GlobalNamespace__SliderController__Pool__Long(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController>(ptr) {
}


  constexpr ______GlobalNamespace__SliderController__Pool__Long& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Long& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______GlobalNamespace__SliderController__Pool__Long& operator=(______GlobalNamespace__SliderController__Pool__Long&& o) noexcept = default;
  constexpr ______GlobalNamespace__SliderController__Pool__Long& operator=(______GlobalNamespace__SliderController__Pool__Long const& o) noexcept = default;
...
// Ctor Parameters []
explicit ______GlobalNamespace__SliderController__Pool__Long() ;
...
class CORDL_TYPE ____GlobalNamespace__SliderController__Pool : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using Long = ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long;

using Medium = ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium;

using Short = ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____GlobalNamespace__SliderController__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__SliderController__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__SliderController__Pool(____GlobalNamespace__SliderController__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__SliderController__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__SliderController__Pool(____GlobalNamespace__SliderController__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__SliderController__Pool(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__SliderController__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__SliderController__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__SliderController__Pool& operator=(____GlobalNamespace__SliderController__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__SliderController__Pool& operator=(____GlobalNamespace__SliderController__Pool const& o) noexcept = default;
...
static constexpr float_t  kMinDistanceToUseLong{15};
 ...
 ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short __declspec(property(get=__get__shortPool, put=__set__shortPool))  _shortPool;

constexpr void __set__shortPool(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short value) ;

constexpr ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short __get__shortPool() const;

 ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium __declspec(property(get=__get__mediumPool, put=__set__mediumPool))  _mediumPool;

constexpr void __set__mediumPool(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium value) ;

constexpr ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium __get__mediumPool() const;

 ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long __declspec(property(get=__get__longPool, put=__set__longPool))  _longPool;

constexpr void __set__longPool(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long value) ;

constexpr ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long __get__longPool() const;
...
explicit ____GlobalNamespace__SliderController__Pool(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short shortPool, ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium mediumPool, ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long longPool) ;

/// @brief Method .ctor addr 0x224998c size 0x3c virtual false final false
 void _ctor(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short shortPool, ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium mediumPool, ::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long longPool) ;

/// @brief Method GetPool addr 0x22499c8 size 0xa0 virtual false final false
 ::Zenject::MonoMemoryPool_1<::GlobalNamespace::SliderController> GetPool(::GlobalNamespace::____GlobalNamespace__SliderController__LengthType lengthType) ;

/// @brief Method GetLengthFromSliderData addr 0x2249a68 size 0x58 virtual false final false
static ::GlobalNamespace::____GlobalNamespace__SliderController__LengthType GetLengthFromSliderData(::GlobalNamespace::SliderData sliderNoteData, ::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnMovementData__SliderSpawnData sliderSpawnData) ;
...
class CORDL_TYPE ____GlobalNamespace__SliderController___DissolveCoroutine_d__70 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__SliderController___DissolveCoroutine_d__70() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__SliderController___DissolveCoroutine_d__70", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70(____GlobalNamespace__SliderController___DissolveCoroutine_d__70 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__SliderController___DissolveCoroutine_d__70", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70(____GlobalNamespace__SliderController___DissolveCoroutine_d__70&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__SliderController___DissolveCoroutine_d__70(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70& operator=(____GlobalNamespace__SliderController___DissolveCoroutine_d__70&& o) noexcept = default;
  constexpr ____GlobalNamespace__SliderController___DissolveCoroutine_d__70& operator=(____GlobalNamespace__SliderController___DissolveCoroutine_d__70 const& o) noexcept = default;
...
explicit ____GlobalNamespace__SliderController___DissolveCoroutine_d__70(int32_t __1__state) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__SliderController__LengthType, "", "SliderController/LengthType");
NEED_NO_BOX(::GlobalNamespace::SliderController);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::SliderController, "", "SliderController");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__SliderController__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__SliderController__Pool, "", "SliderController/Pool");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__SliderController___DissolveCoroutine_d__70);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__SliderController___DissolveCoroutine_d__70, "", "SliderController/<DissolveCoroutine>d__70");
NEED_NO_BOX(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Long, "", "SliderController/Pool/Long");
NEED_NO_BOX(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Medium, "", "SliderController/Pool/Medium");
NEED_NO_BOX(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______GlobalNamespace__SliderController__Pool__Short, "", "SliderController/Pool/Short");
