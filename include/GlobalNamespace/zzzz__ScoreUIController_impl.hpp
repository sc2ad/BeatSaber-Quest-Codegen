...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::*)(::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType)>(&::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x20cd8c0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType>::get()}
                        )));
    return ___internal_method;
  }
};
constexpr void ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::__set_scoreDisplayType(::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::__get_scoreDisplayType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "scoreDisplayType", ty: "::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::____GlobalNamespace__ScoreUIController__InitData(::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType scoreDisplayType)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__ScoreUIController__InitData>(scoreDisplayType))) {}
 void ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData::_ctor(::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType scoreDisplayType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType::____GlobalNamespace__ScoreUIController__ScoreDisplayType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType  ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType::MultipliedScore{0};
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType  ::GlobalNamespace::____GlobalNamespace__ScoreUIController__ScoreDisplayType::ModifiedScore{1};
...
constexpr void ::GlobalNamespace::ScoreUIController::__set__initData(::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData ::GlobalNamespace::ScoreUIController::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__ScoreUIController__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
