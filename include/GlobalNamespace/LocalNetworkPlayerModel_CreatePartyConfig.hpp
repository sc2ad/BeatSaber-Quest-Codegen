...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LocalNetworkPlayerModel::CreatePartyConfig), 57 + sizeof(bool) + 8 - (57 + sizeof(bool)) % 8> __GlobalNamespace_LocalNetworkPlayerModel_CreatePartyConfigSizeCheck;
}
