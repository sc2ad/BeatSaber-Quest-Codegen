...
namespace GlobalNamespace {
struct ____GlobalNamespace__OVRCustomSkeleton__RetargetingType;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__OVRCustomSkeleton__RetargetingType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__OVRCustomSkeleton__RetargetingType(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__OVRCustomSkeleton__RetargetingType(____GlobalNamespace__OVRCustomSkeleton__RetargetingType const&) = default;
                    constexpr ____GlobalNamespace__OVRCustomSkeleton__RetargetingType(____GlobalNamespace__OVRCustomSkeleton__RetargetingType&&) = default;
                    constexpr ____GlobalNamespace__OVRCustomSkeleton__RetargetingType& operator=(____GlobalNamespace__OVRCustomSkeleton__RetargetingType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__OVRCustomSkeleton__RetargetingType& operator=(____GlobalNamespace__OVRCustomSkeleton__RetargetingType&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__OVRCustomSkeleton__RetargetingType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__OVRCustomSkeleton__RetargetingType_Unwrapped : int32_t {
__OculusSkeleton = 0,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__OVRCustomSkeleton__RetargetingType_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__OVRCustomSkeleton__RetargetingType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType const OculusSkeleton;
...
public:
// Declarations
using RetargetingType = ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType;
...
constexpr ::System::Collections::Generic::List_1<::UnityEngine::Transform> __get__customBones_V2() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType __declspec(property(get=__get_retargetingType, put=__set_retargetingType))  retargetingType;

constexpr void __set_retargetingType(::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType __get_retargetingType() const;
...
/// @brief Method SetSkeletonType addr 0x261ee5c size 0x88 virtual false final false
 void SetSkeletonType(::GlobalNamespace::____GlobalNamespace__OVRSkeleton__SkeletonType skeletonType) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType, "", "OVRCustomSkeleton/RetargetingType");
