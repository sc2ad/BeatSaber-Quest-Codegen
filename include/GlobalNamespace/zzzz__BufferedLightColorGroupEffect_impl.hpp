...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData::*)(GlobalNamespace::LightGroup, GlobalNamespace::MaterialPropertyBlockController)>(&GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData::__set_lightGroup(GlobalNamespace::LightGroup value)  {
...
constexpr GlobalNamespace::LightGroup GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData::__get_lightGroup() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::LightGroup, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData::__set_materialPropertyBlockController(GlobalNamespace::MaterialPropertyBlockController value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BufferedLightColorGroupEffect::*)(GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData, GlobalNamespace::ColorManager, GlobalNamespace::BeatmapCallbacksController)>(&GlobalNamespace::BufferedLightColorGroupEffect::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__BufferedLightColorGroupEffect__InitData>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::ColorManager>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::BeatmapCallbacksController>::get()}
                        )));
    return ___internal_method;
  }
};
