...
namespace GlobalNamespace {
  ...
  class DlcPromoPanelModel : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x30
    ::Array<GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo*>* notOwnedMusicPackPromoInfos;
    // Field size check
    ...
    // Creating value type constructor for type: DlcPromoPanelModel
    DlcPromoPanelModel(GlobalNamespace::AdditionalContentModel* additionalContentModel_ = {}, GlobalNamespace::IAnalyticsModel* analyticsModel_ = {}, GlobalNamespace::DlcPromoPanelDataSO* dlcPromoPanelData_ = {}, GlobalNamespace::PlayerDataModel* playerDataModel_ = {}, ::Array<GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo*>* notOwnedMusicPackPromoInfos_ = {}, bool updatingNotOwnedPacks_ = {}, bool initialized_ = {}, System::Random* random_ = {}) noexcept : additionalContentModel{additionalContentModel_}, analyticsModel{analyticsModel_}, dlcPromoPanelData{dlcPromoPanelData_}, playerDataModel{playerDataModel_}, notOwnedMusicPackPromoInfos{notOwnedMusicPackPromoInfos_}, updatingNotOwnedPacks{updatingNotOwnedPacks_}, initialized{initialized_}, random{random_} {}
    ...
    ::Array<GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo*>*& dyn__notOwnedMusicPackPromoInfos();
