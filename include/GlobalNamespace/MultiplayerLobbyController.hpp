...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLobbyController), 64 + sizeof(bool) + ((64 + sizeof(bool)) % 8 != 0 ? (8 - (64 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_MultiplayerLobbyControllerSizeCheck;
}
