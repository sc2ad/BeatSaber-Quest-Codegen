...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GorillaScoreCounter), 40 + sizeof(::StringW)> __GlobalNamespace_GorillaScoreCounterSizeCheck;
  static_assert(sizeof(GorillaScoreCounter) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
