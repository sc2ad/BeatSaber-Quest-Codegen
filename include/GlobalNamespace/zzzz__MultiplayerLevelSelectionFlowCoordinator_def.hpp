...
constexpr ::GlobalNamespace::ILobbyGameStateController __get__lobbyGameStateController() const;
 ...
 ::System::Action_1<::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State> __declspec(property(get=__get_didSelectLevelEvent, put=__set_didSelectLevelEvent))  didSelectLevelEvent;

constexpr void __set_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State> value) ;

constexpr ::System::Action_1<::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State> __get_didSelectLevelEvent() const;
...
constexpr ::GlobalNamespace::BeatmapDifficultyMask __get__allowedBeatmapDifficultyMask() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State __declspec(property(get=__get__state, put=__set__state))  _state;

constexpr void __set__state(::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State __get__state() const;
...
/// @brief Method add_didSelectLevelEvent addr 0x2138ac4 size 0xb0 virtual false final false
 void add_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State> value) ;

/// @brief Method remove_didSelectLevelEvent addr 0x213a124 size 0xb0 virtual false final false
 void remove_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State> value) ;
...
/// @brief Method Setup addr 0x213bb18 size 0x1c virtual false final false
 void Setup(::GlobalNamespace::____GlobalNamespace__LevelSelectionFlowCoordinator__State state, ::GlobalNamespace::SongPackMask songPackMask, ::GlobalNamespace::BeatmapDifficultyMask allowedBeatmapDifficultyMask, ::StringW actionText, ::StringW titleText) ;
