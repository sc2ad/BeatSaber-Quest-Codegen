...
namespace GlobalNamespace {
  ...
  check_size<sizeof(IntroTutorialController::$ShowFinishAnimationCoroutine$d__21), 44 + sizeof(float) + ((44 + sizeof(float)) % 8 != 0 ? (8 - (44 + sizeof(float)) % 8) : 0)> __GlobalNamespace_IntroTutorialController_$ShowFinishAnimationCoroutine$d__21SizeCheck;
}
