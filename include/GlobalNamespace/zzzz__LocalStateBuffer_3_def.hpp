...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12925)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12924), inst: 3695 }), TypeDefinitionIndex(TypeDefinitionIndex(12924))}
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable> __declspec(property(get=__get__current, put=__set__current))  _current;

constexpr void __set__current(::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable> value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable> __get__current() const;
...
constexpr int32_t __get__sentDeltaIndex() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> __declspec(property(get=__get__sentStates, put=__set__sentStates))  _sentStates;

constexpr void __set__sentStates(::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> __get__sentStates() const;

 ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> __declspec(property(get=__get__sentDeltas, put=__set__sentDeltas))  _sentDeltas;

constexpr void __set__sentDeltas(::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::NodePoseSyncState,::System::Int32Enum,::GlobalNamespace::PoseSerializable>> __get__sentDeltas() const;
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t> __declspec(property(get=__get__current, put=__set__current))  _current;

constexpr void __set__current(::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t> value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t> __get__current() const;
...
constexpr int32_t __get__sentDeltaIndex() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> __declspec(property(get=__get__sentStates, put=__set__sentStates))  _sentStates;

constexpr void __set__sentStates(::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> __get__sentStates() const;

 ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> __declspec(property(get=__get__sentDeltas, put=__set__sentDeltas))  _sentDeltas;

constexpr void __set__sentDeltas(::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__StateBuffer_3__TimestampedStateTable<::GlobalNamespace::StandardScoreSyncState,::System::Int32Enum,int32_t>> __get__sentDeltas() const;
