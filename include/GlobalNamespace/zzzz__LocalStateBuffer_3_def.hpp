...
class LocalStateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>;
}
...
template<::cordl_internals::is_or_is_backed_by<int32_t> TState>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12924)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12924), inst: 3695 }), TypeDefinitionIndex(TypeDefinitionIndex(12925))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12925), inst: 4982 })
// CS Name: LocalStateBuffer`3
class CORDL_TYPE LocalStateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> : public GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> {
public:
// Declarations
...
constexpr explicit LocalStateBuffer_3(void* ptr) noexcept : GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>(ptr) {
}
...
// Fields
 ...
 GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> __declspec(property(get=__get__current, put=__set__current))  _current;

constexpr void __set__current(GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> value) ;

constexpr GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> __get__current() const;
...
constexpr int32_t __get__sentDeltaIndex() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __declspec(property(get=__get__sentStates, put=__set__sentStates))  _sentStates;

constexpr void __set__sentStates(::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __get__sentStates() const;

 ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __declspec(property(get=__get__sentDeltas, put=__set__sentDeltas))  _sentDeltas;

constexpr void __set__sentDeltas(::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __get__sentDeltas() const;
