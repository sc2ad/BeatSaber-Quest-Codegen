...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRNetwork::OVRNetworkTcpClient::ConnectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRNetwork_OVRNetworkTcpClient_ConnectionStateSizeCheck;
}
