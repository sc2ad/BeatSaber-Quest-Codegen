...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapCharacteristicTableCell), 128 + sizeof(UnityEngine::Color) + ((128 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (128 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_BeatmapCharacteristicTableCellSizeCheck;
}
