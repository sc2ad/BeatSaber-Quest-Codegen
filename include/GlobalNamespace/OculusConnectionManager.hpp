...
namespace GlobalNamespace {
  ...
  class OculusConnectionManager : public ::Il2CppObject/*, public ::GlobalNamespace::IConnectionManager*/ {
    ...
    // Nested type: ::GlobalNamespace::OculusConnectionManager::$HandlePeerConnectionRequest$d__61
    struct $HandlePeerConnectionRequest$d__61;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    // static private Oculus.Platform.SendPolicy DeliveryMethodToSendPolicy(BGNet.Core.DeliveryMethod deliveryMethod)
    // Offset: 0x15902F0
    static ::Oculus::Platform::SendPolicy DeliveryMethodToSendPolicy(::BGNet::Core::DeliveryMethod deliveryMethod);
    // static private BGNet.Core.DeliveryMethod SendPolicyToDeliveryMethod(Oculus.Platform.SendPolicy sendPolicy)
    // Offset: 0x158FBB8
...
// Writing MetadataGetter for method: GlobalNamespace::OculusConnectionManager::DisposeAsync
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task* (GlobalNamespace::OculusConnectionManager::*)()>(&GlobalNamespace::OculusConnectionManager::DisposeAsync)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OculusConnectionManager*), "DisposeAsync", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
