...
constexpr void GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>::__set_getSortIndex(System::Func_2<T,int32_t> value)  {
...
constexpr System::Func_2<T,int32_t> GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>::__get_getSortIndex() const {
return ::cordl_internals::getInstanceField<System::Func_2<T,int32_t>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
 GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T> GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>::New_ctor()  {
GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T> o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>>())};
return o;
}
 void GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>>::get(),
                            ".ctor",
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>::_Sort_b__0(T a, T b)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__SortExtensions____c__DisplayClass1_0_1<T>>::get(),
                            "<Sort>b__0",
                            std::vector<Il2CppClass*>{},
