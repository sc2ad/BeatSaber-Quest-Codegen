...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, nodeToDelete);
 ...
 GlobalNamespace::BasicBeatmapEventDataProcessor GlobalNamespace::BasicBeatmapEventDataProcessor::New_ctor()  {
GlobalNamespace::BasicBeatmapEventDataProcessor o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BasicBeatmapEventDataProcessor>())};
return o;
}
