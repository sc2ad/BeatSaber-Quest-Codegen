...
namespace GlobalNamespace {
  ...
  class CustomPreviewBeatmapLevel : public ::Il2CppObject/*, public GlobalNamespace::IPreviewBeatmapLevel, public GlobalNamespace::IFilePathSongPreviewAudioClipProvider*/ {
    public:
    // Nested type: GlobalNamespace::CustomPreviewBeatmapLevel::$GetCoverImageAsync$d__59
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xF36D38
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xF36D84
  ...
  #pragma pack(pop)
  static check_size<sizeof(CustomPreviewBeatmapLevel), 152 + sizeof(::ArrayW<GlobalNamespace::PreviewDifficultyBeatmapSet*>)> __GlobalNamespace_CustomPreviewBeatmapLevelSizeCheck;
  static_assert(sizeof(CustomPreviewBeatmapLevel) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppString* (GlobalNamespace::CustomPreviewBeatmapLevel::*)()>(&GlobalNamespace::CustomPreviewBeatmapLevel::get_songPreviewAudioClipPath)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::PreviewDifficultyBeatmapSet*> (GlobalNamespace::CustomPreviewBeatmapLevel::*)()>(&GlobalNamespace::CustomPreviewBeatmapLevel::get_previewDifficultyBeatmapSets)> {
  static const MethodInfo* get() {
