...
namespace GlobalNamespace {
  ...
  check_size<sizeof(CustomPreviewBeatmapLevel), 160 + sizeof(void*) + ((160 + sizeof(void*)) % 8 != 0 ? (8 - (160 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_CustomPreviewBeatmapLevelSizeCheck;
}
