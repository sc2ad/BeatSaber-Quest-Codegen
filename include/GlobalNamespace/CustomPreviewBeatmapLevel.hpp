...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(CustomPreviewBeatmapLevel), 152 + sizeof(::Array<GlobalNamespace::PreviewDifficultyBeatmapSet*>*)> __GlobalNamespace_CustomPreviewBeatmapLevelSizeCheck;
