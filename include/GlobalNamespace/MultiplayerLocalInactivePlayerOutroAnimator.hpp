...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLocalInactivePlayerOutroAnimator), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerLocalInactivePlayerOutroAnimatorSizeCheck;
}
