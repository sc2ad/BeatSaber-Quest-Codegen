...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::BeatmapLevelColorSchemeSaveData GlobalNamespace::BeatmapLevelColorSchemeSaveData::New_ctor()  {
GlobalNamespace::BeatmapLevelColorSchemeSaveData o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BeatmapLevelColorSchemeSaveData>())};
return o;
}
