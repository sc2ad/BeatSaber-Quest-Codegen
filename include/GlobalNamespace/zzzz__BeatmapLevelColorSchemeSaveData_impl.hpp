...
constexpr void ::GlobalNamespace::BeatmapLevelColorSchemeSaveData::__set_colorScheme(::GlobalNamespace::____GlobalNamespace__PlayerSaveData__ColorScheme value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__PlayerSaveData__ColorScheme, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__PlayerSaveData__ColorScheme>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__PlayerSaveData__ColorScheme ::GlobalNamespace::BeatmapLevelColorSchemeSaveData::__get_colorScheme() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__PlayerSaveData__ColorScheme, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
