...
namespace GlobalNamespace {
  // Size: 0x30
  #pragma pack(push, 1)
  // Autogenerated type: MissionResultsViewController/<>c__DisplayClass30_0
  // [CompilerGeneratedAttribute] Offset: E128BC
  class MissionResultsViewController::$$c__DisplayClass30_0 : public ::Il2CppObject {
    public:
    ...
    static MissionResultsViewController::$$c__DisplayClass30_0* New_ctor() {
