...
namespace GlobalNamespace {
  ...
  struct BeatmapLevelDataLoaderSO::BeatmapLevelFromPreview::$GetPreviewAudioClipAsync$d__33 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
