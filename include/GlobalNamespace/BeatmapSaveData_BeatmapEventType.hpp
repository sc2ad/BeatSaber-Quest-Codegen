...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapSaveData::BeatmapEventType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_BeatmapSaveData_BeatmapEventTypeSizeCheck;
}
