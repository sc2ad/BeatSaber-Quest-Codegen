...
namespace GlobalNamespace {
  ...
  check_size<sizeof(StartMiddleEndButtonBackgroundController), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __GlobalNamespace_StartMiddleEndButtonBackgroundControllerSizeCheck;
}
