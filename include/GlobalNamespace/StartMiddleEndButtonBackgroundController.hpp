...
namespace GlobalNamespace {
  ...
  class StartMiddleEndButtonBackgroundController : public UnityEngine::MonoBehaviour {
    ...
    static StartMiddleEndButtonBackgroundController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("StartMiddleEndButtonBackgroundController").WithContext(".ctor");
