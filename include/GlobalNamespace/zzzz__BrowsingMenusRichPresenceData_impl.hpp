...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::BrowsingMenusRichPresenceData::*)()>(&GlobalNamespace::BrowsingMenusRichPresenceData::get_apiName)> {
  ...
  constexpr static std::size_t addrs = 0x222a2e4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BrowsingMenusRichPresenceData>::get(),
                            "get_apiName",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::BrowsingMenusRichPresenceData::*)()>(&GlobalNamespace::BrowsingMenusRichPresenceData::get_localizedDescription)> {
  ...
  constexpr static std::size_t addrs = 0x222a324;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BrowsingMenusRichPresenceData::*)(::StringW)>(&GlobalNamespace::BrowsingMenusRichPresenceData::set_localizedDescription)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222a32c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BrowsingMenusRichPresenceData::*)()>(&GlobalNamespace::BrowsingMenusRichPresenceData::_ctor)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x222a334;
...
constexpr  GlobalNamespace::BrowsingMenusRichPresenceData::operator GlobalNamespace::IRichPresenceData() const noexcept {
...
constexpr ::StringW GlobalNamespace::BrowsingMenusRichPresenceData::__get__localizedDescription_k__BackingField() const {
...
// Ctor Parameters []
 GlobalNamespace::BrowsingMenusRichPresenceData::BrowsingMenusRichPresenceData()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<BrowsingMenusRichPresenceData>())) {}
 void GlobalNamespace::BrowsingMenusRichPresenceData::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BrowsingMenusRichPresenceData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
