...
namespace GlobalNamespace {
  ...
  class VersionedThreadStaticPacketPool_2 : public ::Il2CppObject {
    ...
    // [ThreadStaticAttribute] Offset: 0xDEFC3C
    ...
    // static public VersionedPacketPool`2<T,T2> get_pool3()
    // Offset: 0xFFFFFFFF
    static GlobalNamespace::VersionedPacketPool_2<T, T2>* get_pool3() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::VersionedThreadStaticPacketPool_2::get_pool3");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<VersionedThreadStaticPacketPool_2<T, T2>*>::get(), "get_pool3", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
