...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: VersionedThreadStaticPacketPool`2<T, T2>
  template<typename T, typename T2>
  class VersionedThreadStaticPacketPool_2;
}
...
namespace GlobalNamespace {
  ...
  class VersionedThreadStaticPacketPool_2 : public ::Il2CppObject {
    ...
    static GlobalNamespace::VersionedPacketPool_2<T, T2>* get_pool() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<GlobalNamespace::VersionedPacketPool_2<T, T2>*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method)));
    }
