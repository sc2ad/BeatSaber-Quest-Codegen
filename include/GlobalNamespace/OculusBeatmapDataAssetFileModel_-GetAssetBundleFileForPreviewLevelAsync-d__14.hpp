...
namespace GlobalNamespace {
  ...
  struct OculusBeatmapDataAssetFileModel::$GetAssetBundleFileForPreviewLevelAsync$d__14 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
