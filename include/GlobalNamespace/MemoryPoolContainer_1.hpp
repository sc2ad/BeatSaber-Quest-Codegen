...
namespace GlobalNamespace {
  ...
  class MemoryPoolContainer_1 : public ::Il2CppObject {
    ...
    // Creating value type constructor for type: MemoryPoolContainer_1
    MemoryPoolContainer_1(GlobalNamespace::LazyCopyHashSet_1<T>* activeItems_ = {}, Zenject::IMemoryPool_1<T>* memoryPool_ = {}) noexcept : activeItems{activeItems_}, memoryPool{memoryPool_} {}
    // Autogenerated instance field getter
    // Get instance field: private readonly LazyCopyHashSet`1<T> _activeItems
    GlobalNamespace::LazyCopyHashSet_1<T>* _get__activeItems() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_1::_get__activeItems");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<GlobalNamespace::LazyCopyHashSet_1<T>*>(___internal__instance, "_activeItems"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly LazyCopyHashSet`1<T> _activeItems
    void _set__activeItems(GlobalNamespace::LazyCopyHashSet_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_1::_set__activeItems");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_activeItems", value));
    }
    // Autogenerated instance field getter
    // Get instance field: private readonly Zenject.IMemoryPool`1<T> _memoryPool
    Zenject::IMemoryPool_1<T>* _get__memoryPool() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_1::_get__memoryPool");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<Zenject::IMemoryPool_1<T>*>(___internal__instance, "_memoryPool"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly Zenject.IMemoryPool`1<T> _memoryPool
    void _set__memoryPool(Zenject::IMemoryPool_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_1::_set__memoryPool");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_memoryPool", value));
    }
