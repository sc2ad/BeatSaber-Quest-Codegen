...
namespace GlobalNamespace {
  ...
  class MemoryPoolContainer_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::LazyCopyHashSet_1<T>*& dyn__activeItems() {
    ...
    [[deprecated("Use field access instead!")]] ::Zenject::IMemoryPool_1<T>*& dyn__memoryPool() {
