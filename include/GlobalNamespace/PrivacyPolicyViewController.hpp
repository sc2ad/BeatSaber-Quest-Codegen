...
namespace GlobalNamespace {
  ...
  class PrivacyPolicyViewController : public HMUI::ViewController {
    ...
    PrivacyPolicyViewController(UnityEngine::UI::Button* okButton_ = {}, HMUI::TextPageScrollView* textPageScrollView_ = {}, GlobalNamespace::LocalizedTextAsset* privacyPolicyLocalizedTextAsset_ = {}, System::Action_1<GlobalNamespace::PrivacyPolicyViewController::ButtonType>* didFinishEvent_ = {}) noexcept : okButton{okButton_}, textPageScrollView{textPageScrollView_}, privacyPolicyLocalizedTextAsset{privacyPolicyLocalizedTextAsset_}, didFinishEvent{didFinishEvent_} {}
