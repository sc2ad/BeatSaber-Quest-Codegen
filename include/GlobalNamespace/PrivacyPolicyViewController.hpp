...
namespace GlobalNamespace {
  ...
  class PrivacyPolicyViewController : public ::HMUI::ViewController {
    ...
    public:
    // [HeaderAttribute] Offset: 0x110BB44
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::UI::Button*) == 0x8);
    // [HeaderAttribute] Offset: 0x110BBA0
    ...
    // [HeaderAttribute] Offset: 0x110BBFC
    // [LocalizationKeyAttribute] Offset: 0x110BBFC
    ...
    // [LocalizationKeyAttribute] Offset: 0x110BC58
