...
NEED_NO_BOX(::GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0*, "", "MenuTransitionsHelper/<>c__DisplayClass33_0");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: MenuTransitionsHelper/<>c__DisplayClass33_0
  ...
  #pragma pack(pop)
  static check_size<sizeof(MenuTransitionsHelper::$$c__DisplayClass33_0), 32 + sizeof(::GlobalNamespace::TutorialScenesTransitionSetupDataSO*)> __GlobalNamespace_MenuTransitionsHelper_$$c__DisplayClass33_0SizeCheck;
...
// Writing MetadataGetter for method: GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0::$HandleTutorialSceneDidFinish$b__0
// Il2CppName: <HandleTutorialSceneDidFinish>b__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0::*)(::Zenject::DiContainer*)>(&GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0::$HandleTutorialSceneDidFinish$b__0)> {
  static const MethodInfo* get() {
    static auto* container = &::il2cpp_utils::GetClassFromName("Zenject", "DiContainer")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MenuTransitionsHelper::$$c__DisplayClass33_0*), "<HandleTutorialSceneDidFinish>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{container});
  }
};
