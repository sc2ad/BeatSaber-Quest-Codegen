...
constexpr void GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType  GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType::Values{0};
constexpr GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType  GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType::References{1};
