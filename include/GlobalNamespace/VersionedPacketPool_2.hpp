...
namespace GlobalNamespace {
  ...
  class VersionedPacketPool_2 : public ::Il2CppObject/*, public GlobalNamespace::IVersionedPacketPool_1<T>*/ {
    ...
    void _set__basePool(GlobalNamespace::PacketPool_1<T>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_basePool"))->offset;
      *reinterpret_cast<GlobalNamespace::PacketPool_1<T>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
    ...
    void _set__overridePool(GlobalNamespace::PacketPool_1<T2>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_overridePool"))->offset;
      *reinterpret_cast<GlobalNamespace::PacketPool_1<T2>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
