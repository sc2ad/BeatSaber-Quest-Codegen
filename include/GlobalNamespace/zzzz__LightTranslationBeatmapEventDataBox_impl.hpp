...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::LightTranslationBeatmapEventDataBox::*)()>(&GlobalNamespace::LightTranslationBeatmapEventDataBox::get_subtypeIdentifier)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21debf4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::LightTranslationBeatmapEventDataBox),
...
//  Writing Method size for method: GlobalNamespace::LightTranslationBeatmapEventDataBox.get_beatStep
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::LightTranslationBeatmapEventDataBox::*)()>(&GlobalNamespace::LightTranslationBeatmapEventDataBox::get_beatStep)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21debfc;
...
//  Writing Method size for method: GlobalNamespace::LightTranslationBeatmapEventDataBox._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LightTranslationBeatmapEventDataBox::*)(GlobalNamespace::IndexFilter, float_t, GlobalNamespace::GlobalNamespace__BeatmapEventDataBox__DistributionParamType, GlobalNamespace::LightAxis, bool, float_t, GlobalNamespace::GlobalNamespace__BeatmapEventDataBox__DistributionParamType, bool, GlobalNamespace::EaseType, System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData>)>(&GlobalNamespace::LightTranslationBeatmapEventDataBox::_ctor)> {
  constexpr static std::size_t size = 0x22c;
  constexpr static std::size_t addrs = 0x21d8a48;
...
constexpr void GlobalNamespace::LightTranslationBeatmapEventDataBox::__set__lightTranslationBaseDataList(System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData>>(value));
}
constexpr System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData> GlobalNamespace::LightTranslationBeatmapEventDataBox::__get__lightTranslationBaseDataList() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightTranslationBaseData>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr GlobalNamespace::LightAxis GlobalNamespace::LightTranslationBeatmapEventDataBox::__get__axis() const {
...
constexpr float_t GlobalNamespace::LightTranslationBeatmapEventDataBox::__get__translationDirection() const {
...
constexpr float_t GlobalNamespace::LightTranslationBeatmapEventDataBox::__get__beatStep() const {
return ::cordl_internals::getInstanceField<float_t, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
 int32_t GlobalNamespace::LightTranslationBeatmapEventDataBox::get_subtypeIdentifier()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LightTranslationBeatmapEventDataBox>::get(),
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 float_t GlobalNamespace::LightTranslationBeatmapEventDataBox::get_beatStep()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LightTranslationBeatmapEventDataBox>::get(),
                            "get_beatStep",
                            std::vector<Il2CppClass*>{},
