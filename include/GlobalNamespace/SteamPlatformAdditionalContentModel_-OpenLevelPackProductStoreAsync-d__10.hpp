...
namespace GlobalNamespace {
  ...
  struct SteamPlatformAdditionalContentModel::$OpenLevelPackProductStoreAsync$d__10 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
