...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AvatarTweenController), 308 + sizeof(UnityEngine::Vector3) + ((308 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (308 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __GlobalNamespace_AvatarTweenControllerSizeCheck;
}
