...
namespace GlobalNamespace {
class ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance;
}
...
class CORDL_TYPE ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance(____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance(____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance& operator=(____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance&& o) noexcept = default;
  constexpr ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance& operator=(____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance() ;
...
public:
// Declarations
using PlayerCountToDistance = ::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance;
...
// Fields
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance> __declspec(property(get=__get__distances, put=__set__distances))  _distances;

constexpr void __set__distances(::ArrayW<::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance> __get__distances() const;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance, "", "BeatmapObjectSpawnCenter/PlayerCountToDistance");
