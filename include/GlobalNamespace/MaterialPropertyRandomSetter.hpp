...
namespace GlobalNamespace {
  ...
  class MaterialPropertyRandomSetter : public UnityEngine::MonoBehaviour {
    ...
    // Creating value type constructor for type: MaterialPropertyRandomSetter
    MaterialPropertyRandomSetter(GlobalNamespace::MaterialPropertyBlockController* materialPropertyBlockController_ = {}, ::Il2CppString* propertyName_ = {}, float minValue_ = {}, float maxValue_ = {}, int propertyId_ = {}) noexcept : materialPropertyBlockController{materialPropertyBlockController_}, propertyName{propertyName_}, minValue{minValue_}, maxValue{maxValue_}, propertyId{propertyId_} {}
