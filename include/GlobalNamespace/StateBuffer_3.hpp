...
namespace GlobalNamespace {
  ...
  class StateBuffer_3 : public ::Il2CppObject {
    ...
    // Type namespace: 
    namespace GlobalNamespace {
      // Forward declaring type: TimestampedStateTable<TStateTable, TType, TState>
      struct TimestampedStateTable;
    }
    // WARNING Size may be invalid!
    ...
    // Type namespace: 
    namespace GlobalNamespace {
      // Forward declaring type: InterpolationDelegate<TStateTable, TType, TState>
      class InterpolationDelegate;
    }
    // WARNING Size may be invalid!
    ...
    // Type namespace: 
    namespace GlobalNamespace {
      // Forward declaring type: SmoothingDelegate<TStateTable, TType, TState>
      class SmoothingDelegate;
    }
    // WARNING Size may be invalid!
