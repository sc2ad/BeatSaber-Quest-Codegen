...
namespace GlobalNamespace {
  ...
  class StateBuffer_3 : public ::Il2CppObject {
    ...
    struct TimestampedStateTable : public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public ::System::ValueType, public ::GlobalNamespace::IEquatableByReference_1<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>*/ {
      ...
      // Creating interface conversion operator: i_TimestampedStateTable
      inline ::GlobalNamespace::IEquatableByReference_1<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>* i_TimestampedStateTable() noexcept {
        return reinterpret_cast<::GlobalNamespace::IEquatableByReference_1<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>*>(this);
      }
      ...
      [[deprecated("Use field access instead!")]] ::GlobalNamespace::SyncStateId& dyn_id() {
      ...
      [[deprecated("Use field access instead!")]] TStateTable& dyn_state() {
    ...
    class InterpolationDelegate : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::System::MulticastDelegate {
      ...
      TState EndInvoke(::System::IAsyncResult* result) {
        ...
        return ::il2cpp_utils::RunMethodRethrow<TState, false>(this, ___internal__method, result);
      }
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__buffer() {
    ...
    [[deprecated("Use field access instead!")]] typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::InterpolationDelegate*& dyn__interpolator() {
    ...
    [[deprecated("Use field access instead!")]] typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::SmoothingDelegate*& dyn__smoother() {
