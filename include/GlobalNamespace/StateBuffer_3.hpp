...
namespace GlobalNamespace {
  ...
  class StateBuffer_3 : public ::Il2CppObject {
    ...
    struct TimestampedStateTable : public System::ValueType, public GlobalNamespace::IEquatableByReference_1<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
