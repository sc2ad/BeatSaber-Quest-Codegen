...
namespace GlobalNamespace {
  ...
  class StateBuffer_3 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable> buffer;
    // Field size check
    ...
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__buffer() {
