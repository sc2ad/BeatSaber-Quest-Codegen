...
namespace GlobalNamespace {
class ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList;
}
...
class CORDL_TYPE ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList(____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList(____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList& operator=(____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList&& o) noexcept = default;
  constexpr ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList& operator=(____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList() ;
...
public:
// Declarations
using GameObjectValueList = ::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList;
...
constexpr ::GlobalNamespace::BasicBeatmapEventType __get__beatmapEventType() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> __declspec(property(get=__get__gameObjectsValueLists, put=__set__gameObjectsValueLists))  _gameObjectsValueLists;

constexpr void __set__gameObjectsValueLists(::ArrayW<::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> __get__gameObjectsValueLists() const;
...
constexpr ::GlobalNamespace::BeatmapDataCallbackWrapper __get__beatmapDataCallbackWrapper() const;
 ...
 ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> __declspec(property(get=__get__valueToListMap, put=__set__valueToListMap))  _valueToListMap;

constexpr void __set__valueToListMap(::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> value) ;

constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList> __get__valueToListMap() const;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList, "", "GameObjectIntSwitchEventEffect/GameObjectValueList");
