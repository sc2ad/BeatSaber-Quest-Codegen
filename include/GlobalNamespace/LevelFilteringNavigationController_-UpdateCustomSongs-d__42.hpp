...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LevelFilteringNavigationController::$UpdateCustomSongs$d__42), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevelPackCollection*>) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevelPackCollection*>)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevelPackCollection*>)) % 8) : 0)> __GlobalNamespace_LevelFilteringNavigationController_$UpdateCustomSongs$d__42SizeCheck;
}
