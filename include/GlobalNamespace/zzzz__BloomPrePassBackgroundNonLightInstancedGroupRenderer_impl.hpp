...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::*)()>(&::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x1f93714;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__set_propertyType(::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__get_propertyType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__set_propertyName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__get_propertyName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__set_propertyId(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::__get_propertyId() const {
return ::cordl_internals::getInstanceField<int32_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>())) {}
 void ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::Float{0};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::Vector{1};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::Color{2};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__PropertyType::Matrix4x4{3};
...
constexpr void ::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer::__set__supportedProperties(::ArrayW<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty> ::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer::__get__supportedProperties() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__BloomPrePassBackgroundNonLightInstancedGroupRenderer__SupportedProperty>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
