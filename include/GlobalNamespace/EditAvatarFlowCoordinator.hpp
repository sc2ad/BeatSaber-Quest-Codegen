...
namespace GlobalNamespace {
  ...
  class EditAvatarFlowCoordinator : public HMUI::FlowCoordinator {
    ...
    check_size<sizeof(EditAvatarFlowCoordinator::EditAvatarType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_EditAvatarFlowCoordinator_EditAvatarTypeSizeCheck;
  ...
  check_size<sizeof(EditAvatarFlowCoordinator), 232 + sizeof(void*) + ((232 + sizeof(void*)) % 8 != 0 ? (8 - (232 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_EditAvatarFlowCoordinatorSizeCheck;
}
