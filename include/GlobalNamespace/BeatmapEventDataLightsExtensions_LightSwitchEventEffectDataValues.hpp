...
NEED_NO_BOX(::GlobalNamespace::BeatmapEventDataLightsExtensions::LightSwitchEventEffectDataValues);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::BeatmapEventDataLightsExtensions::LightSwitchEventEffectDataValues*, "", "BeatmapEventDataLightsExtensions/LightSwitchEventEffectDataValues");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: BeatmapEventDataLightsExtensions/LightSwitchEventEffectDataValues
  // [TokenAttribute] Offset: FFFFFFFF
  class BeatmapEventDataLightsExtensions::LightSwitchEventEffectDataValues : public ::Il2CppObject {
    public:
    ...
    // static field const value: static public System.Int32 kOnW
    static constexpr const int kOnW = 9;
    // Get static field: static public System.Int32 kOnW
    static int _get_kOnW();
    // Set static field: static public System.Int32 kOnW
    static void _set_kOnW(int value);
    ...
    // static field const value: static public System.Int32 kHighlightW
    static constexpr const int kHighlightW = 10;
    // Get static field: static public System.Int32 kHighlightW
    static int _get_kHighlightW();
    // Set static field: static public System.Int32 kHighlightW
    static void _set_kHighlightW(int value);
    ...
    // static field const value: static public System.Int32 kFlashAndFadeToBlackW
    static constexpr const int kFlashAndFadeToBlackW = 11;
    // Get static field: static public System.Int32 kFlashAndFadeToBlackW
    static int _get_kFlashAndFadeToBlackW();
    // Set static field: static public System.Int32 kFlashAndFadeToBlackW
    static void _set_kFlashAndFadeToBlackW(int value);
    ...
    // static field const value: static public System.Int32 kFadeW
    static constexpr const int kFadeW = 12;
    // Get static field: static public System.Int32 kFadeW
    static int _get_kFadeW();
    // Set static field: static public System.Int32 kFadeW
    static void _set_kFadeW(int value);
