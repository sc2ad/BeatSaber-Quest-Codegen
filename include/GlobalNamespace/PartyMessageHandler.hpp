...
namespace GlobalNamespace {
  ...
  class PartyMessageHandler : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    check_size<sizeof(PartyMessageHandler::MessageType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PartyMessageHandler_MessageTypeSizeCheck;
  ...
  check_size<sizeof(PartyMessageHandler), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PartyMessageHandlerSizeCheck;
}
