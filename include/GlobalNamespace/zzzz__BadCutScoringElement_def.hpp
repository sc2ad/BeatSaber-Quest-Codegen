...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5412)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5412), inst: 2703 }), TypeDefinitionIndex(TypeDefinitionIndex(5417))}
