...
constexpr ::GlobalNamespace::____GlobalNamespace__RemoteProcedureCall__TypeWrapper_1<T1> __get__value1() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__RemoteProcedureCall__TypeWrapper_1<float_t> __declspec(property(get=__get__value2, put=__set__value2))  _value2;

constexpr void __set__value2(::GlobalNamespace::____GlobalNamespace__RemoteProcedureCall__TypeWrapper_1<float_t> value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__RemoteProcedureCall__TypeWrapper_1<float_t> __get__value2() const;
