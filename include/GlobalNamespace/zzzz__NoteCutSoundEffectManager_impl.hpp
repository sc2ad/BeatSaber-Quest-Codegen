...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::*)(bool, bool)>(&::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x20bd200;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::__set_useTestAudioClips(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::__get_useTestAudioClips() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::__set_ignoreBadCuts(bool value)  {
::cordl_internals::setInstanceField<bool, 0x11>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::__get_ignoreBadCuts() const {
...
// Ctor Parameters [CppParam { name: "useTestAudioClips", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "ignoreBadCuts", ty: "bool", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::____GlobalNamespace__NoteCutSoundEffectManager__InitData(bool useTestAudioClips, bool ignoreBadCuts)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__NoteCutSoundEffectManager__InitData>(useTestAudioClips, ignoreBadCuts))) {}
 void ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData::_ctor(bool useTestAudioClips, bool ignoreBadCuts)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::NoteCutSoundEffectManager::__set__initData(::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData ::GlobalNamespace::NoteCutSoundEffectManager::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffectManager__InitData, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::NoteCutSoundEffectManager::__set__noteCutSoundEffectPool(::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffect__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffect__Pool, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffect__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffect__Pool ::GlobalNamespace::NoteCutSoundEffectManager::__get__noteCutSoundEffectPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteCutSoundEffect__Pool, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
