...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRHaptics::OVRHapticsChannel), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OVRHaptics_OVRHapticsChannelSizeCheck;
}
