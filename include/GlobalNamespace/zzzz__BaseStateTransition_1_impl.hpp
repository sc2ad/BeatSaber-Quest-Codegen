...
constexpr T GlobalNamespace::BaseStateTransition_1<T>::__get__component() const {
return ::cordl_internals::getInstanceField<T, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
 GlobalNamespace::BaseStateTransition_1<T> GlobalNamespace::BaseStateTransition_1<T>::New_ctor()  {
GlobalNamespace::BaseStateTransition_1<T> o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BaseStateTransition_1<T>>())};
return o;
}
 void GlobalNamespace::BaseStateTransition_1<T>::_ctor()  {
