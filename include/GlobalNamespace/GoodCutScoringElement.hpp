...
namespace GlobalNamespace {
  ...
  class GoodCutScoringElement : public ::GlobalNamespace::ScoringElement/*, public ::GlobalNamespace::ICutScoreBufferDidFinishReceiver*/ {
    ...
    // Creating conversion operator: operator ::GlobalNamespace::CutScoreBuffer*
    constexpr operator ::GlobalNamespace::CutScoreBuffer*() const noexcept {
  ...
  #pragma pack(pop)
  static check_size<sizeof(GoodCutScoringElement), 40 + sizeof(::GlobalNamespace::CutScoreBuffer*)> __GlobalNamespace_GoodCutScoringElementSizeCheck;
  static_assert(sizeof(GoodCutScoringElement) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
