...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LiteNetLibConnectionManager::LiteNetLibConnectionParamsBase), 48 + sizeof(int) + 8 - (48 + sizeof(int)) % 8> __GlobalNamespace_LiteNetLibConnectionManager_LiteNetLibConnectionParamsBaseSizeCheck;
}
