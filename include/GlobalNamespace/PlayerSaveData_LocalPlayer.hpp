...
namespace GlobalNamespace {
  ...
  class PlayerSaveData::LocalPlayer : public ::CsObject {
    public:
    ...
    // Offset: 0x28
    ::CsString* lastSelectedBeatmapCharacteristicName;
    ...
    // Offset: 0x78
    System::Collections::Generic::List_1<::CsString*>* favoritesLevelIds;
