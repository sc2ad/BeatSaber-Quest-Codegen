...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLocalActivePlayerFacade), 88 + sizeof(void*) + ((88 + sizeof(void*)) % 8 != 0 ? (8 - (88 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerLocalActivePlayerFacadeSizeCheck;
}
