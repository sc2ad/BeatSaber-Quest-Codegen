...
constexpr void GlobalNamespace::ParticleSystemLightWithIds::__set__mainModule(UnityEngine::UnityEngine__ParticleSystem__MainModule value)  {
::cordl_internals::setInstanceField<UnityEngine::UnityEngine__ParticleSystem__MainModule, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UnityEngine__ParticleSystem__MainModule>(value));
}
constexpr UnityEngine::UnityEngine__ParticleSystem__MainModule GlobalNamespace::ParticleSystemLightWithIds::__get__mainModule() const {
return ::cordl_internals::getInstanceField<UnityEngine::UnityEngine__ParticleSystem__MainModule, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ParticleSystemLightWithIds::__set__particles(::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle> value)  {
::cordl_internals::setInstanceField<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>, 0x60>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>>(value));
}
constexpr ::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle> GlobalNamespace::ParticleSystemLightWithIds::__get__particles() const {
return ::cordl_internals::getInstanceField<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, color);
 ...
 GlobalNamespace::ParticleSystemLightWithIds GlobalNamespace::ParticleSystemLightWithIds::New_ctor()  {
GlobalNamespace::ParticleSystemLightWithIds o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::ParticleSystemLightWithIds>())};
return o;
}
