...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PyramidBloomRendererSO::Level), 8 + sizeof(void*) + ((8 + sizeof(void*)) % 8 != 0 ? (8 - (8 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PyramidBloomRendererSO_LevelSizeCheck;
}
