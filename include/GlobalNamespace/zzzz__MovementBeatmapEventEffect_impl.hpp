...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::*)()>(&GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::get_localPositionOffset)> {
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::*)()>(&GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::__set__localPositionOffset(UnityEngine::Vector3 value)  {
...
constexpr UnityEngine::Vector3 GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::__get__localPositionOffset() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector3, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
 UnityEngine::Vector3 GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData::get_localPositionOffset()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData>::get(),
                            "get_localPositionOffset",
                            std::vector<Il2CppClass*>{},
...
constexpr void GlobalNamespace::MovementBeatmapEventEffect::__set__movementData(::ArrayW<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData> GlobalNamespace::MovementBeatmapEventEffect::__get__movementData() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__MovementBeatmapEventEffect__MovementData>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
