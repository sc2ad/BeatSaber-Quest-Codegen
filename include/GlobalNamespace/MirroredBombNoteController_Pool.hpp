...
namespace GlobalNamespace {
  ...
  // Autogenerated type: MirroredBombNoteController/Pool
  class MirroredBombNoteController::Pool : public Zenject::MonoMemoryPool_1<GlobalNamespace::MirroredBombNoteController*> {
    ...
    static MirroredBombNoteController::Pool* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<MirroredBombNoteController::Pool*, creationType>()));
    }
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MirroredBombNoteController::Pool::*)()>(&GlobalNamespace::MirroredBombNoteController::Pool::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MirroredBombNoteController::Pool*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MirroredBombNoteController::Pool::*)()>(&GlobalNamespace::MirroredBombNoteController::Pool::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MirroredBombNoteController::Pool*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
