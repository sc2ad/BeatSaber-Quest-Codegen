...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: E12708
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CentralLeaderboardViewController::$LoadScoresAsync$d__37::*)(System::Runtime::CompilerServices::IAsyncStateMachine*)>(&GlobalNamespace::CentralLeaderboardViewController::$LoadScoresAsync$d__37::SetStateMachine)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::CentralLeaderboardViewController::$LoadScoresAsync$d__37), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::CompilerServices::IAsyncStateMachine*>()});
  }
};
