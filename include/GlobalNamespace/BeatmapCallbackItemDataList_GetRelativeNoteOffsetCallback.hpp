...
namespace GlobalNamespace {
  ...
  class BeatmapCallbackItemDataList::GetRelativeNoteOffsetCallback : public System::MulticastDelegate {
    ...
    // Offset: 0x1976494
    static BeatmapCallbackItemDataList::GetRelativeNoteOffsetCallback* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x19764A8
    System::IAsyncResult* BeginInvoke(int lineIndex, GlobalNamespace::NoteLineLayer noteLineLayer, System::AsyncCallback* callback, ::CsObject* object);
