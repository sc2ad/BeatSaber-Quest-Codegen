...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(GlobalNamespace::MainSettingsModelSO)>(&GlobalNamespace::MainSettingsBestGraphicsValues::ApplyValues)> {
  ...
  constexpr static std::size_t addrs = 0x21ef688;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MainSettingsBestGraphicsValues>::get(),
                            "ApplyValues",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MainSettingsBestGraphicsValues::*)()>(&GlobalNamespace::MainSettingsBestGraphicsValues::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef7dc;
...
// Ctor Parameters []
 GlobalNamespace::MainSettingsBestGraphicsValues::MainSettingsBestGraphicsValues()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<MainSettingsBestGraphicsValues>())) {}
 void GlobalNamespace::MainSettingsBestGraphicsValues::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MainSettingsBestGraphicsValues>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
