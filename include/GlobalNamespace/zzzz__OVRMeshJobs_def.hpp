...
namespace GlobalNamespace {
template<>
struct GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>;
}
namespace GlobalNamespace {
template<>
struct GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>;
}
namespace GlobalNamespace {
template<>
struct GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>;
}
namespace GlobalNamespace {
template<>
...
struct CORDL_TYPE GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to Unity::Jobs::IJobParallelFor
constexpr operator  Unity::Jobs::IJobParallelFor() const;

// Ctor Parameters [CppParam { name: "Vertices", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "Normals", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector3>", modifiers: "", def_value: None }, CppParam { name: "UV", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector2>", modifiers: "", def_value: None }, CppParam { name: "BoneWeights", ty: "Unity::Collections::NativeArray_1<UnityEngine::BoneWeight>", modifiers: "", def_value: None }, CppParam { name: "MeshVerticesPosition", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>", modifiers: "", def_value: None }, CppParam { name: "MeshNormals", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>", modifiers: "", def_value: None }, CppParam { name: "MeshUV", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>", modifiers: "", def_value: None }, CppParam { name: "MeshBoneWeights", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>", modifiers: "", def_value: None }, CppParam { name: "MeshBoneIndices", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob(Unity::Collections::NativeArray_1<UnityEngine::Vector3> Vertices, Unity::Collections::NativeArray_1<UnityEngine::Vector3> Normals, Unity::Collections::NativeArray_1<UnityEngine::Vector2> UV, Unity::Collections::NativeArray_1<UnityEngine::BoneWeight> BoneWeights, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> MeshVerticesPosition, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> MeshNormals, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> MeshUV, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> MeshBoneWeights, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> MeshBoneIndices) noexcept;


                    constexpr GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob(GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob const&) = default;
                    constexpr GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob(GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob&&) = default;
                    constexpr GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob& operator=(GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob& operator=(GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob&& o) noexcept {
...
constexpr explicit GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr Unity::Collections::NativeArray_1<UnityEngine::BoneWeight> __get_BoneWeights() const;
 ...
 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> __declspec(property(get=__get_MeshVerticesPosition, put=__set_MeshVerticesPosition))  MeshVerticesPosition;

constexpr void __set_MeshVerticesPosition(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> __get_MeshVerticesPosition() const;

 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> __declspec(property(get=__get_MeshNormals, put=__set_MeshNormals))  MeshNormals;

constexpr void __set_MeshNormals(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> __get_MeshNormals() const;

 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> __declspec(property(get=__get_MeshUV, put=__set_MeshUV))  MeshUV;

constexpr void __set_MeshUV(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> __get_MeshUV() const;

 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> __declspec(property(get=__get_MeshBoneWeights, put=__set_MeshBoneWeights))  MeshBoneWeights;

constexpr void __set_MeshBoneWeights(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> __get_MeshBoneWeights() const;

 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> __declspec(property(get=__get_MeshBoneIndices, put=__set_MeshBoneIndices))  MeshBoneIndices;

constexpr void __set_MeshBoneIndices(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> __get_MeshBoneIndices() const;
...
struct CORDL_TYPE GlobalNamespace__OVRMeshJobs__TransformTrianglesJob : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to Unity::Jobs::IJobParallelFor
constexpr operator  Unity::Jobs::IJobParallelFor() const;
...
constexpr GlobalNamespace__OVRMeshJobs__TransformTrianglesJob(Unity::Collections::NativeArray_1<uint32_t> Triangles, Unity::Collections::NativeArray_1<int16_t> MeshIndices, int32_t NumIndices) noexcept;


                    constexpr GlobalNamespace__OVRMeshJobs__TransformTrianglesJob(GlobalNamespace__OVRMeshJobs__TransformTrianglesJob const&) = default;
                    constexpr GlobalNamespace__OVRMeshJobs__TransformTrianglesJob(GlobalNamespace__OVRMeshJobs__TransformTrianglesJob&&) = default;
                    constexpr GlobalNamespace__OVRMeshJobs__TransformTrianglesJob& operator=(GlobalNamespace__OVRMeshJobs__TransformTrianglesJob const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRMeshJobs__TransformTrianglesJob& operator=(GlobalNamespace__OVRMeshJobs__TransformTrianglesJob&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRMeshJobs__TransformTrianglesJob(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Declarations
template<typename T>
using NativeArrayHelper_1 = GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<T>;

using TransformTrianglesJob = GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob;

using TransformToUnitySpaceJob = GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob;
...
// CS Name: OVRMeshJobs::NativeArrayHelper`1
struct CORDL_TYPE GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::IDisposable
constexpr operator  System::IDisposable() const;

// Ctor Parameters [CppParam { name: "UnityNativeArray", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>", modifiers: "", def_value: None }, CppParam { name: "_handle", ty: "System::Runtime::InteropServices::GCHandle", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> UnityNativeArray, System::Runtime::InteropServices::GCHandle _handle) noexcept;
...
// Fields
 ...
 Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> __declspec(property(get=__get_UnityNativeArray, put=__set_UnityNativeArray))  UnityNativeArray;

constexpr void __set_UnityNativeArray(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> value) ;

constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> __get_UnityNativeArray() const;
...
/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(::ArrayW<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> ovrArray, int32_t length) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1, "", "OVRMeshJobs/NativeArrayHelper`1");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob, "", "OVRMeshJobs/TransformToUnitySpaceJob");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob, "", "OVRMeshJobs/TransformTrianglesJob");
