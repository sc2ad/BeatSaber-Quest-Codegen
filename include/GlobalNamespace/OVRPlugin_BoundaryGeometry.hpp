...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::BoundaryGeometry), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlugin_BoundaryGeometrySizeCheck;
}
