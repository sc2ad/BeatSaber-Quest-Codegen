...
namespace GlobalNamespace {
  ...
  class SimpleRetailDemoViewController : public HMUI::ViewController {
    ...
    static SimpleRetailDemoViewController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SimpleRetailDemoViewController").WithContext(".ctor");
