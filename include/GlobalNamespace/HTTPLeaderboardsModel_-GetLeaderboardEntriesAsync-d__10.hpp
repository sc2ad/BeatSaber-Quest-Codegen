...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HTTPLeaderboardsModel::$GetLeaderboardEntriesAsync$d__10), 104 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::ApiResponse_1<BeatSaberAPI::DataTransferObjects::LeaderboardEntries*>>) + ((104 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::ApiResponse_1<BeatSaberAPI::DataTransferObjects::LeaderboardEntries*>>)) % 8 != 0 ? (8 - (104 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::ApiResponse_1<BeatSaberAPI::DataTransferObjects::LeaderboardEntries*>>)) % 8) : 0)> __GlobalNamespace_HTTPLeaderboardsModel_$GetLeaderboardEntriesAsync$d__10SizeCheck;
}
