...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::*)(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType, bool, bool, bool)>(&GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__set_energyType(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType value)  {
...
constexpr GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__get_energyType() const {
...
constexpr void GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__set_noFail(bool value)  {
::cordl_internals::setInstanceField<bool, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__get_noFail() const {
return ::cordl_internals::getInstanceField<bool, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__set_instaFail(bool value)  {
::cordl_internals::setInstanceField<bool, 0x15>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__get_instaFail() const {
return ::cordl_internals::getInstanceField<bool, 0x15>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData::__set_failOnSaberClash(bool value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType (GlobalNamespace::GameEnergyCounter::*)()>(&GlobalNamespace::GameEnergyCounter::get_energyType)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GameEnergyCounter::*)(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType)>(&GlobalNamespace::GameEnergyCounter::set_energyType)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_energyType",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void GlobalNamespace::GameEnergyCounter::__set__initData(GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData>(value));
}
constexpr GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData GlobalNamespace::GameEnergyCounter::__get__initData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__GameEnergyCounter__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void GlobalNamespace::GameEnergyCounter::__set__energyType_k__BackingField(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType, 0x5c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType GlobalNamespace::GameEnergyCounter::__get__energyType_k__BackingField() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType, 0x5c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType GlobalNamespace::GameEnergyCounter::get_energyType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GameEnergyCounter>::get(),
                            "get_energyType",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void GlobalNamespace::GameEnergyCounter::set_energyType(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GameEnergyCounter>::get(),
                            "set_energyType",
                            std::vector<Il2CppClass*>{},
