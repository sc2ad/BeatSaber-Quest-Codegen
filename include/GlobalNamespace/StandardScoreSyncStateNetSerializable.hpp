...
namespace GlobalNamespace {
  ...
  check_size<sizeof(StandardScoreSyncStateNetSerializable), 20 + sizeof(GlobalNamespace::StandardScoreSyncState) + ((20 + sizeof(GlobalNamespace::StandardScoreSyncState)) % 8 != 0 ? (8 - (20 + sizeof(GlobalNamespace::StandardScoreSyncState)) % 8) : 0)> __GlobalNamespace_StandardScoreSyncStateNetSerializableSizeCheck;
}
