...
namespace GlobalNamespace {
  ...
  class BeatmapLevelCollection : public ::Il2CppObject/*, public GlobalNamespace::IBeatmapLevelCollection*/ {
    ...
    // Size: 0x8
    // Offset: 0x10
    ::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*> levels;
    // Field size check
    ...
    BeatmapLevelCollection(::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*> levels_ = {}) noexcept : levels{levels_} {}
    ...
    // Creating conversion operator: operator ::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*>
    constexpr operator ::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*>() const noexcept {
      return levels;
    }
    // Get instance field reference: private IPreviewBeatmapLevel[] _levels
    ::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*>& dyn__levels();
    ...
    static BeatmapLevelCollection* New_ctor(::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*> levels) {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatmapLevelCollection), 16 + sizeof(::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*>)> __GlobalNamespace_BeatmapLevelCollectionSizeCheck;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<GlobalNamespace::IPreviewBeatmapLevel*> (GlobalNamespace::BeatmapLevelCollection::*)()>(&GlobalNamespace::BeatmapLevelCollection::get_beatmapLevels)> {
