...
namespace GlobalNamespace {
  ...
  class MainMenuViewController : public HMUI::ViewController {
    ...
    check_size<sizeof(MainMenuViewController::MenuButton), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MainMenuViewController_MenuButtonSizeCheck;
  ...
  check_size<sizeof(MainMenuViewController), 176 + sizeof(void*) + ((176 + sizeof(void*)) % 8 != 0 ? (8 - (176 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MainMenuViewControllerSizeCheck;
}
