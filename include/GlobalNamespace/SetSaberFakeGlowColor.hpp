...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SetSaberFakeGlowColor), 64 + sizeof(GlobalNamespace::SaberType) + ((64 + sizeof(GlobalNamespace::SaberType)) % 8 != 0 ? (8 - (64 + sizeof(GlobalNamespace::SaberType)) % 8) : 0)> __GlobalNamespace_SetSaberFakeGlowColorSizeCheck;
}
