...
namespace GlobalNamespace {
class ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8;
}
...
class CORDL_TYPE ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0(____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0(____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0& operator=(____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0&& o) noexcept = default;
  constexpr ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0& operator=(____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0() ;
...
struct CORDL_TYPE ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "menuDestination", ty: "::GlobalNamespace::MenuDestination", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::MainMenuDestinationRequestController", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::MenuDestination menuDestination, ::GlobalNamespace::MainMenuDestinationRequestController __4__this, ::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 __8__1, ::System::Threading::CancellationToken _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter __u__1) noexcept;


                    constexpr ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8(____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8 const&) = default;
                    constexpr ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8(____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8&&) = default;
                    constexpr ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8& operator=(____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8& operator=(____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::GlobalNamespace::MainMenuDestinationRequestController __get___4__this() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 __declspec(property(get=__get___8__1, put=__set___8__1))  __8__1;

constexpr void __set___8__1(::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0 __get___8__1() const;
...
public:
// Declarations
using _ProcessDestinationRequest_d__8 = ::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8;

using __c__DisplayClass8_0 = ::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController____c__DisplayClass8_0, "", "MainMenuDestinationRequestController/<>c__DisplayClass8_0");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MainMenuDestinationRequestController___ProcessDestinationRequest_d__8, "", "MainMenuDestinationRequestController/<ProcessDestinationRequest>d__8");
