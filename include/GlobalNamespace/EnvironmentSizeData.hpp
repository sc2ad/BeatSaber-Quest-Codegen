...
namespace GlobalNamespace {
  ...
  class EnvironmentSizeData : public ::Il2CppObject {
    ...
    check_size<sizeof(EnvironmentSizeData::FloorType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_EnvironmentSizeData_FloorTypeSizeCheck;
    ...
    check_size<sizeof(EnvironmentSizeData::CeilingType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_EnvironmentSizeData_CeilingTypeSizeCheck;
  ...
  check_size<sizeof(EnvironmentSizeData), 20 + sizeof(GlobalNamespace::EnvironmentSizeData::CeilingType) + 8 - (20 + sizeof(GlobalNamespace::EnvironmentSizeData::CeilingType)) % 8> __GlobalNamespace_EnvironmentSizeDataSizeCheck;
}
