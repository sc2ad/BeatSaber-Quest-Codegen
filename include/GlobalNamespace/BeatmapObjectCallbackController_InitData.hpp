...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapObjectCallbackController::InitData), 24 + sizeof(float) + ((24 + sizeof(float)) % 8 != 0 ? (8 - (24 + sizeof(float)) % 8) : 0)> __GlobalNamespace_BeatmapObjectCallbackController_InitDataSizeCheck;
}
