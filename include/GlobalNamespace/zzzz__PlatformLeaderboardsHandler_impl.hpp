...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::HMAsyncRequest (::GlobalNamespace::PlatformLeaderboardsHandler::*)(::GlobalNamespace::____GlobalNamespace__LeaderboardScoreUploader__ScoreData, ::GlobalNamespace::____GlobalNamespace__PlatformLeaderboardsModel__UploadScoreCompletionHandler)>(&::GlobalNamespace::PlatformLeaderboardsHandler::UploadScore)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlatformLeaderboardsHandler::*)()>(&::GlobalNamespace::PlatformLeaderboardsHandler::_ctor)> {
 ...
 ::GlobalNamespace::HMAsyncRequest ::GlobalNamespace::PlatformLeaderboardsHandler::GetScores(::GlobalNamespace::IDifficultyBeatmap beatmap, int32_t count, int32_t fromRank, ::GlobalNamespace::____GlobalNamespace__PlatformLeaderboardsModel__ScoresScope scope, ::StringW referencePlayerId, ::GlobalNamespace::____GlobalNamespace__PlatformLeaderboardsModel__GetScoresCompletionHandler completionHandler)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PlatformLeaderboardsHandler>::get(),
                            "GetScores",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::HMAsyncRequest, false>(const_cast<void*>(instance), ___internal_method, beatmap, count, fromRank, scope, referencePlayerId, completionHandler);
 ...
 ::GlobalNamespace::HMAsyncRequest ::GlobalNamespace::PlatformLeaderboardsHandler::UploadScore(::GlobalNamespace::____GlobalNamespace__LeaderboardScoreUploader__ScoreData scoreData, ::GlobalNamespace::____GlobalNamespace__PlatformLeaderboardsModel__UploadScoreCompletionHandler completionHandler)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PlatformLeaderboardsHandler>::get(),
                            "UploadScore",
                            std::vector<Il2CppClass*>{},
