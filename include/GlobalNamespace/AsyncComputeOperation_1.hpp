...
namespace GlobalNamespace {
  ...
  class AsyncComputeOperation_1 : public ::GlobalNamespace::AsyncComputeOperation {
    ...
    [[deprecated("Use field access instead!")]] ::System::Threading::Tasks::TaskCompletionSource_1<T>*& dyn__tcs() {
    ...
    void Complete(T computeResult) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, computeResult);
    }
