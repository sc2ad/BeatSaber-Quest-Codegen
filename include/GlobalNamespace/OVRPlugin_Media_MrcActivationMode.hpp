...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::Media::MrcActivationMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlugin_Media_MrcActivationModeSizeCheck;
}
