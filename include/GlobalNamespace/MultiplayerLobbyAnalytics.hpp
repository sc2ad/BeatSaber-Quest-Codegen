...
namespace GlobalNamespace {
  ...
  class MultiplayerLobbyAnalytics : public UnityEngine::MonoBehaviour {
    ...
    // Creating value type constructor for type: MultiplayerLobbyAnalytics
    MultiplayerLobbyAnalytics(GlobalNamespace::GameServerLobbyFlowCoordinator* gameServerLobbyFlowCoordinator_ = {}, GlobalNamespace::IAnalyticsModel* analyticsModel_ = {}) noexcept : gameServerLobbyFlowCoordinator{gameServerLobbyFlowCoordinator_}, analyticsModel{analyticsModel_} {}
