...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset::*)()>(&GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef660;
...
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset::__set_bloomPrePassEffect(GlobalNamespace::BloomPrePassEffectSO value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset> (GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::get_presets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef648;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::NamedPreset> (GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::get_namedPresets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef650;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef658;
...
constexpr void GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::__set__presets(::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset> GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::__get__presets() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
 ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset> GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO::get_presets()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BloomPrePassGraphicsSettingsPresetsSO>::get(),
                            "get_presets",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassGraphicsSettingsPresetsSO__Preset>, false>(const_cast<void*>(instance), ___internal_method);
}
