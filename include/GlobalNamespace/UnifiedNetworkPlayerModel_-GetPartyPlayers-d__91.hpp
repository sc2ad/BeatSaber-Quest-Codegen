...
namespace GlobalNamespace {
  ...
  check_size<sizeof(UnifiedNetworkPlayerModel::$GetPartyPlayers$d__91), 48 + sizeof(int) + 8 - (48 + sizeof(int)) % 8> __GlobalNamespace_UnifiedNetworkPlayerModel_$GetPartyPlayers$d__91SizeCheck;
}
