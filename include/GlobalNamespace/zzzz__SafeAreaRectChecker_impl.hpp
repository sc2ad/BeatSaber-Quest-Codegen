...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData::*)(bool)>(&GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData::__set_checkingEnabled(bool value)  {
...
constexpr void GlobalNamespace::SafeAreaRectChecker::__set__initData(GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData>(value));
}
constexpr GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData GlobalNamespace::SafeAreaRectChecker::__get__initData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__SafeAreaRectChecker__InitData, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
