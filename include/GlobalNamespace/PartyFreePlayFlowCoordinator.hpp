...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PartyFreePlayFlowCoordinator), 320 + sizeof(void*) + ((320 + sizeof(void*)) % 8 != 0 ? (8 - (320 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PartyFreePlayFlowCoordinatorSizeCheck;
}
