...
namespace GlobalNamespace {
  // Size: 0x30
  #pragma pack(push, 1)
  // Autogenerated type: StandardLevelDetailViewController/<>c__DisplayClass46_0
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D1CE90
  class StandardLevelDetailViewController::$$c__DisplayClass46_0 : public ::Il2CppObject {
    public:
    ...
    static StandardLevelDetailViewController::$$c__DisplayClass46_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::StandardLevelDetailViewController::$$c__DisplayClass46_0::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<StandardLevelDetailViewController::$$c__DisplayClass46_0*, creationType>()));
    }
  }; // StandardLevelDetailViewController/<>c__DisplayClass46_0
  #pragma pack(pop)
  static check_size<sizeof(StandardLevelDetailViewController::$$c__DisplayClass46_0), 40 + sizeof(GlobalNamespace::StandardLevelDetailViewController*)> __GlobalNamespace_StandardLevelDetailViewController_$$c__DisplayClass46_0SizeCheck;
  static_assert(sizeof(StandardLevelDetailViewController::$$c__DisplayClass46_0) == 0x30);
}
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::StandardLevelDetailViewController::$$c__DisplayClass46_0*, "", "StandardLevelDetailViewController/<>c__DisplayClass46_0");
