...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MainMenuDestinationRequestControler), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_MainMenuDestinationRequestControlerSizeCheck;
}
