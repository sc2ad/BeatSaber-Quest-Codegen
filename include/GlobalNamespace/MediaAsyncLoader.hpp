...
namespace GlobalNamespace {
  ...
  class MediaAsyncLoader : public ::CsObject {
    public:
    ...
    // Offset: 0x194CEF8
    static System::Threading::Tasks::Task_1<::CsString*>* LoadWebpage(::CsString* uri, System::Threading::CancellationToken cancellationToken);
    ...
    // Offset: 0x194D030
    static System::Threading::Tasks::Task_1<UnityEngine::AudioClip*>* LoadAudioClipAsync(::CsString* path, System::Threading::CancellationToken cancellationToken);
    ...
    // Offset: 0x194D168
    static System::Threading::Tasks::Task_1<UnityEngine::Texture2D*>* LoadImageAsync(::CsString* path, System::Threading::CancellationToken cancellationToken);
