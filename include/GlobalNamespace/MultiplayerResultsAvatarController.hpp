...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerResultsAvatarController), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerResultsAvatarControllerSizeCheck;
}
