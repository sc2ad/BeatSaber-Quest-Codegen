...
namespace GlobalNamespace {
  ...
  class PlatformLeaderboardsModel : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(PlatformLeaderboardsModel::State), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PlatformLeaderboardsModel_StateSizeCheck;
  ...
  check_size<sizeof(PlatformLeaderboardsModel), 72 + sizeof(void*) + ((72 + sizeof(void*)) % 8 != 0 ? (8 - (72 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PlatformLeaderboardsModelSizeCheck;
}
