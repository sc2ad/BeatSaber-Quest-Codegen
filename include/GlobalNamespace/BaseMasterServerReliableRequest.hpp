...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BaseMasterServerReliableRequest), 16 + sizeof(uint) + ((16 + sizeof(uint)) % 8 != 0 ? (8 - (16 + sizeof(uint)) % 8) : 0)> __GlobalNamespace_BaseMasterServerReliableRequestSizeCheck;
}
