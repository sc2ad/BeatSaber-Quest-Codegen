...
struct CORDL_TYPE ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams(::BGNet::Core::ITaskUtility taskUtility, ::GlobalNamespace::IMultiplayerSessionManager multiplayerSessionManager, ::StringW creatorId, ::GlobalNamespace::BeatmapLevelSelectionMask selectionMask, ::GlobalNamespace::GameplayServerConfiguration configuration, ::GlobalNamespace::IServerBeatmapProvider beatmapProvider) noexcept;


                    constexpr ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams(____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams const&) = default;
                    constexpr ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams(____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams&&) = default;
                    constexpr ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams& operator=(____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams& operator=(____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using InitParams = ::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams;
...
explicit GameplayServerFiniteStateMachine(::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams initParams) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams, "", "GameplayServerFiniteStateMachine/InitParams");
