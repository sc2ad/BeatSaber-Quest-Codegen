...
template<typename T>
class GlobalNamespace__ValueDropdownController_1____c;
}
namespace System {
template<typename T1,typename T2>
class Action_2;
...
namespace GlobalNamespace {
template<>
class GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum>;
}
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type T>
class GlobalNamespace__ValueDropdownController_1____c<T>;
}
namespace GlobalNamespace {
template<>
class GlobalNamespace__ValueDropdownController_1____c<float_t>;
}
namespace GlobalNamespace {
template<>
...
class CORDL_TYPE GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~GlobalNamespace__ValueDropdownController_1____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__ValueDropdownController_1____c", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__ValueDropdownController_1____c(GlobalNamespace__ValueDropdownController_1____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__ValueDropdownController_1____c", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__ValueDropdownController_1____c(GlobalNamespace__ValueDropdownController_1____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__ValueDropdownController_1____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__ValueDropdownController_1____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__ValueDropdownController_1____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__ValueDropdownController_1____c& operator=(GlobalNamespace__ValueDropdownController_1____c&& o) noexcept = default;
  constexpr GlobalNamespace__ValueDropdownController_1____c& operator=(GlobalNamespace__ValueDropdownController_1____c const& o) noexcept = default;
                


// Fields

static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum> value) ;

static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum> __get___9() ;
...
static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum> New_ctor() ;
...
// CS Name: ValueDropdownController`1::<>c
class CORDL_TYPE GlobalNamespace__ValueDropdownController_1____c<float_t> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};
...
static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<float_t> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<float_t> value) ;

static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<float_t> __get___9() ;
...
static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<float_t> New_ctor() ;
...
// CS Name: ValueDropdownController`1::<>c
class CORDL_TYPE GlobalNamespace__ValueDropdownController_1____c<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};
...
static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<T> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<T> value) ;

static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<T> __get___9() ;
...
static GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<T> New_ctor() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<System::Int32Enum>;
...
static GlobalNamespace::ValueDropdownController_1<System::Int32Enum> New_ctor() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<float_t>;
...
static GlobalNamespace::ValueDropdownController_1<float_t> New_ctor() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c<T>;
...
static GlobalNamespace::ValueDropdownController_1<T> New_ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__ValueDropdownController_1____c, "", "ValueDropdownController`1/<>c");
