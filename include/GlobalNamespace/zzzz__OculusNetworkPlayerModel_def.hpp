...
class CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer(GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer(GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer& operator=(GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer&& o) noexcept = default;
  constexpr GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer& operator=(GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer const& o) noexcept = default;
...
/// @brief Method SameRoomAs addr 0x220e400 size 0x3c virtual false final false
 bool SameRoomAs(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer other) ;
...
struct CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel___Start_d__42 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OculusNetworkPlayerModel___Start_d__42(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::OculusNetworkPlayerModel __4__this, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::UserInfo> __u__1) noexcept;


                    constexpr GlobalNamespace__OculusNetworkPlayerModel___Start_d__42(GlobalNamespace__OculusNetworkPlayerModel___Start_d__42 const&) = default;
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___Start_d__42(GlobalNamespace__OculusNetworkPlayerModel___Start_d__42&&) = default;
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___Start_d__42& operator=(GlobalNamespace__OculusNetworkPlayerModel___Start_d__42 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___Start_d__42& operator=(GlobalNamespace__OculusNetworkPlayerModel___Start_d__42&& o) noexcept {
...
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel___Start_d__42(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0&& o) noexcept = default;
  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0 const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0&& o) noexcept = default;
  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 const& o) noexcept = default;
                


// Fields

 GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer __declspec(property(get=__get_player, put=__set_player))  player;

constexpr void __set_player(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer value) ;

constexpr GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer __get_player() const;
...
struct CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "GlobalNamespace::OculusNetworkPlayerModel", modifiers: "", def_value: None }, CppParam { name: "message", ty: "Oculus::Platform::Message_1<Oculus::Platform::Models::RoomInviteNotification>", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter_1<::StringW>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::OculusNetworkPlayerModel __4__this, Oculus::Platform::Message_1<Oculus::Platform::Models::RoomInviteNotification> message, GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 __8__1, System::Runtime::CompilerServices::TaskAwaiter_1<::StringW> __u__1) noexcept;


                    constexpr GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51(GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51 const&) = default;
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51(GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51&&) = default;
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51& operator=(GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51& operator=(GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr Oculus::Platform::Message_1<Oculus::Platform::Models::RoomInviteNotification> __get_message() const;
 ...
 GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 __declspec(property(get=__get___8__1, put=__set___8__1))  __8__1;

constexpr void __set___8__1(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 value) ;

constexpr GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0 __get___8__1() const;
...
class CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0&& o) noexcept = default;
  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0 const& o) noexcept = default;
...
constexpr GlobalNamespace::OculusNetworkPlayerModel __get___4__this() const;
 ...
 Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserAndRoomList> __declspec(property(get=__get_onGetFriends, put=__set_onGetFriends))  onGetFriends;

constexpr void __set_onGetFriends(Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserAndRoomList> value) ;

constexpr Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserAndRoomList> __get_onGetFriends() const;

 Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserList> __declspec(property(get=__get_onGetInvitable, put=__set_onGetInvitable))  onGetInvitable;

constexpr void __set_onGetInvitable(Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserList> value) ;

constexpr Oculus::Platform::Oculus__Platform__Message_1__Callback<Oculus::Platform::Models::UserList> __get_onGetInvitable() const;
...
class CORDL_TYPE GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0&& o) noexcept = default;
  constexpr GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0& operator=(GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0 const& o) noexcept = default;
...
public:
// Declarations
using __c__DisplayClass64_0 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0;

using __c__DisplayClass55_0 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0;

using _HandleRoomInviteReceived_d__51 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51;

using __c__DisplayClass51_0 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0;

using __c__DisplayClass50_0 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0;

using _Start_d__42 = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel___Start_d__42;

using OculusNetworkPlayer = GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer;
...
constexpr bool __get__isRefreshing() const;
 ...
 GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer __declspec(property(get=__get__localPlayer, put=__set__localPlayer))  _localPlayer;

constexpr void __set__localPlayer(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer value) ;

constexpr GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer __get__localPlayer() const;
...
constexpr System::Collections::Generic::Dictionary_2<::StringW,::StringW> __get__roomDataStore() const;
 ...
 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> __declspec(property(get=__get__partyPlayers, put=__set__partyPlayers))  _partyPlayers;

constexpr void __set__partyPlayers(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> value) ;

constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> __get__partyPlayers() const;

 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> __declspec(property(get=__get__otherPlayers, put=__set__otherPlayers))  _otherPlayers;

constexpr void __set__otherPlayers(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> value) ;

constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer> __get__otherPlayers() const;
...
/// @brief Method GetPlayer addr 0x220d004 size 0x110 virtual false final false
 GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer GetPlayer(uint64_t id) ;

/// @brief Method GetPlayer addr 0x220d114 size 0x120 virtual false final false
 GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer GetPlayer(::StringW userId) ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel__OculusNetworkPlayer, "", "OculusNetworkPlayerModel/OculusNetworkPlayer");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass50_0, "", "OculusNetworkPlayerModel/<>c__DisplayClass50_0");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass51_0, "", "OculusNetworkPlayerModel/<>c__DisplayClass51_0");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass55_0, "", "OculusNetworkPlayerModel/<>c__DisplayClass55_0");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel____c__DisplayClass64_0, "", "OculusNetworkPlayerModel/<>c__DisplayClass64_0");
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel___HandleRoomInviteReceived_d__51, "", "OculusNetworkPlayerModel/<HandleRoomInviteReceived>d__51");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OculusNetworkPlayerModel___Start_d__42, "", "OculusNetworkPlayerModel/<Start>d__42");
