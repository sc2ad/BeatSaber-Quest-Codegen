...
namespace GlobalNamespace {
  ...
  check_size<sizeof(UnifiedNetworkPlayerModel::UnifiedNetworkPlayer), 50 + sizeof(bool) + ((50 + sizeof(bool)) % 8 != 0 ? (8 - (50 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_UnifiedNetworkPlayerModel_UnifiedNetworkPlayerSizeCheck;
}
