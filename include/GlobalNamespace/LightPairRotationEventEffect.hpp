...
namespace GlobalNamespace {
  ...
  class LightPairRotationEventEffect : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xDC6DEC
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Transform*) == 0x8);
    // [InjectAttribute] Offset: 0xDC6E9C
    ...
    static LightPairRotationEventEffect* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("LightPairRotationEventEffect").WithContext(".ctor");
