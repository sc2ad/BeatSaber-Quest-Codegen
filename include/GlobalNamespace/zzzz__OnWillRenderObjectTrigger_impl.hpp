...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OnWillRenderObjectTrigger::*)()>(&::GlobalNamespace::OnWillRenderObjectTrigger::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x1fa2f34;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OnWillRenderObjectTrigger::*)()>(&::GlobalNamespace::OnWillRenderObjectTrigger::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1fa335c;
...
constexpr ::UnityEngine::Shader ::GlobalNamespace::OnWillRenderObjectTrigger::__get__overrideShader() const {
...
constexpr int32_t ::GlobalNamespace::OnWillRenderObjectTrigger::__get__renderQueue() const {
...
constexpr ::UnityEngine::Material ::GlobalNamespace::OnWillRenderObjectTrigger::__get__material() const {
...
::cordl_internals::setInstanceField<::UnityEngine::Mesh, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::Mesh>(value));
}
constexpr ::UnityEngine::Mesh ::GlobalNamespace::OnWillRenderObjectTrigger::__get__mesh() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Mesh, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::UnityEngine::MeshFilter ::GlobalNamespace::OnWillRenderObjectTrigger::__get__meshFilter() const {
...
constexpr ::UnityEngine::MeshRenderer ::GlobalNamespace::OnWillRenderObjectTrigger::__get__meshRenderer() const {
