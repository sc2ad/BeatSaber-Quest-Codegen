...
constexpr void ::GlobalNamespace::OVRMonoscopic::__set_toggleButton(::GlobalNamespace::____GlobalNamespace__OVRInput__RawButton value)  {
...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRInput__RawButton ::GlobalNamespace::OVRMonoscopic::__get_toggleButton() const {
...
// Ctor Parameters []
 ::GlobalNamespace::OVRMonoscopic::OVRMonoscopic()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<OVRMonoscopic>())) {}
