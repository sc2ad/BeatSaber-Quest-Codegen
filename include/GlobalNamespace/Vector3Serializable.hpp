...
namespace GlobalNamespace {
  ...
  check_size<sizeof(Vector3Serializable), 0 + sizeof(UnityEngine::Vector3) + ((0 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (0 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __GlobalNamespace_Vector3SerializableSizeCheck;
}
