...
namespace GlobalNamespace {
  ...
  check_size<sizeof(EditableModifiersSelectionView), 80 + sizeof(bool) + ((80 + sizeof(bool)) % 8 != 0 ? (8 - (80 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_EditableModifiersSelectionViewSizeCheck;
}
