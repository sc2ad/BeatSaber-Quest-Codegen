...
namespace GlobalNamespace {
  ...
  class EditableModifiersSelectionView : public GlobalNamespace::ModifiersSelectionView {
    ...
    static EditableModifiersSelectionView* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("EditableModifiersSelectionView").WithContext(".ctor");
