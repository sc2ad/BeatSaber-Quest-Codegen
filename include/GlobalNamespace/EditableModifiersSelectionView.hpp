...
namespace GlobalNamespace {
  ...
  class EditableModifiersSelectionView : public GlobalNamespace::ModifiersSelectionView {
    public:
    // [SpaceAttribute] Offset: 0xE43978
    ...
    UnityEngine::CanvasGroup* _get__modifiersListCanvasGroup();
    // Set instance field: private UnityEngine.CanvasGroup _modifiersListCanvasGroup
    void _set__modifiersListCanvasGroup(UnityEngine::CanvasGroup* value);
