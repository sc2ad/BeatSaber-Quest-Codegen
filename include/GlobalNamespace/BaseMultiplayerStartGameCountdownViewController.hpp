...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BaseMultiplayerStartGameCountdownViewController), 144 + sizeof(void*) + 8 - (144 + sizeof(void*)) % 8> __GlobalNamespace_BaseMultiplayerStartGameCountdownViewControllerSizeCheck;
}
