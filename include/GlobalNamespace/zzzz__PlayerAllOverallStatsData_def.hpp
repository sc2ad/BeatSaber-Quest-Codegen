...
class CORDL_TYPE ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x48};

virtual ~____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData(____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData(____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData& operator=(____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData&& o) noexcept = default;
  constexpr ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData& operator=(____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData() ;
...
static ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData op_Addition(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData a, ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData b) ;
...
public:
// Declarations
using PlayerOverallStatsData = ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData;
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=__get__campaignOverallStatsData_k__BackingField, put=__set__campaignOverallStatsData_k__BackingField))  _campaignOverallStatsData_k__BackingField;

constexpr void __set__campaignOverallStatsData_k__BackingField(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __get__campaignOverallStatsData_k__BackingField() const;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=__get__soloFreePlayOverallStatsData_k__BackingField, put=__set__soloFreePlayOverallStatsData_k__BackingField))  _soloFreePlayOverallStatsData_k__BackingField;

constexpr void __set__soloFreePlayOverallStatsData_k__BackingField(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __get__soloFreePlayOverallStatsData_k__BackingField() const;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=__get__partyFreePlayOverallStatsData_k__BackingField, put=__set__partyFreePlayOverallStatsData_k__BackingField))  _partyFreePlayOverallStatsData_k__BackingField;

constexpr void __set__partyFreePlayOverallStatsData_k__BackingField(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __get__partyFreePlayOverallStatsData_k__BackingField() const;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=__get__onlinePlayOverallStatsData_k__BackingField, put=__set__onlinePlayOverallStatsData_k__BackingField))  _onlinePlayOverallStatsData_k__BackingField;

constexpr void __set__onlinePlayOverallStatsData_k__BackingField(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __get__onlinePlayOverallStatsData_k__BackingField() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=get_allOverallStatsData))  allOverallStatsData;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=get_campaignOverallStatsData, put=set_campaignOverallStatsData))  campaignOverallStatsData;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=get_soloFreePlayOverallStatsData, put=set_soloFreePlayOverallStatsData))  soloFreePlayOverallStatsData;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=get_partyFreePlayOverallStatsData, put=set_partyFreePlayOverallStatsData))  partyFreePlayOverallStatsData;

 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData __declspec(property(get=get_onlinePlayOverallStatsData, put=set_onlinePlayOverallStatsData))  onlinePlayOverallStatsData;


// Methods

/// @brief Method get_allOverallStatsData addr 0x222044c size 0x28 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData get_allOverallStatsData() ;

/// @brief Method get_campaignOverallStatsData addr 0x2220594 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData get_campaignOverallStatsData() ;

/// @brief Method set_campaignOverallStatsData addr 0x222059c size 0x8 virtual false final false
 void set_campaignOverallStatsData(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

/// @brief Method get_soloFreePlayOverallStatsData addr 0x22205a4 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData get_soloFreePlayOverallStatsData() ;

/// @brief Method set_soloFreePlayOverallStatsData addr 0x22205ac size 0x8 virtual false final false
 void set_soloFreePlayOverallStatsData(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

/// @brief Method get_partyFreePlayOverallStatsData addr 0x22205b4 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData get_partyFreePlayOverallStatsData() ;

/// @brief Method set_partyFreePlayOverallStatsData addr 0x22205bc size 0x8 virtual false final false
 void set_partyFreePlayOverallStatsData(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;

/// @brief Method get_onlinePlayOverallStatsData addr 0x22205c4 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData get_onlinePlayOverallStatsData() ;

/// @brief Method set_onlinePlayOverallStatsData addr 0x22205cc size 0x8 virtual false final false
 void set_onlinePlayOverallStatsData(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData value) ;
...
/// @brief Method .ctor addr 0x2220abc size 0x40 virtual false final false
 void _ctor(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData campaignOverallStatsData, ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData soloFreePlayOverallStatsData, ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData partyFreePlayOverallStatsData, ::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData onlinePlayOverallStatsData) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData, "", "PlayerAllOverallStatsData/PlayerOverallStatsData");
