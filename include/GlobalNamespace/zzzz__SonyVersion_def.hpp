...
struct ____GlobalNamespace__SonyVersion__VersionFormat;
}
namespace GlobalNamespace {
class SonyVersion;
}
...
struct CORDL_TYPE ____GlobalNamespace__SonyVersion__VersionFormat : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__SonyVersion__VersionFormat(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__SonyVersion__VersionFormat(____GlobalNamespace__SonyVersion__VersionFormat const&) = default;
                    constexpr ____GlobalNamespace__SonyVersion__VersionFormat(____GlobalNamespace__SonyVersion__VersionFormat&&) = default;
                    constexpr ____GlobalNamespace__SonyVersion__VersionFormat& operator=(____GlobalNamespace__SonyVersion__VersionFormat const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__SonyVersion__VersionFormat& operator=(____GlobalNamespace__SonyVersion__VersionFormat&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__SonyVersion__VersionFormat(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__SonyVersion__VersionFormat_Unwrapped : int32_t {
__FullLong = 0,
__Long = 1,
__FullShort = 2,
__Short = 3,
...
constexpr operator ______GlobalNamespace__SonyVersion__VersionFormat_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__SonyVersion__VersionFormat_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat const FullLong;

/// @brief Field Long offset 0
static ::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat const Long;

/// @brief Field FullShort offset 0
static ::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat const FullShort;

/// @brief Field Short offset 0
static ::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat const Short;
...
public:
// Declarations
using VersionFormat = ::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat;
...
explicit SonyVersion(uint32_t majorVersion, uint32_t minorVersion) ;
...
/// @brief Method Get addr 0x221caa4 size 0x200 virtual false final false
 ::StringW Get(::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat format) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__SonyVersion__VersionFormat, "", "SonyVersion/VersionFormat");
