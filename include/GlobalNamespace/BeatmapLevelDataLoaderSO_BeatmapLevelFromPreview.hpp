...
namespace GlobalNamespace {
  ...
  class BeatmapLevelDataLoaderSO::BeatmapLevelFromPreview : public ::Il2CppObject, public GlobalNamespace::IBeatmapLevel, public GlobalNamespace::IPreviewBeatmapLevel {
    public:
