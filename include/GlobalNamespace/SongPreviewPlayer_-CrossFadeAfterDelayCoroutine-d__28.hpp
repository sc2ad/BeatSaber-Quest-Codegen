...
namespace GlobalNamespace {
  ...
  class SongPreviewPlayer::$CrossFadeAfterDelayCoroutine$d__28 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
    ...
    // Creating value type constructor for type: $CrossFadeAfterDelayCoroutine$d__28
    $CrossFadeAfterDelayCoroutine$d__28(int $$1__state_ = {}, ::Il2CppObject* $$2__current_ = {}, float delay_ = {}, GlobalNamespace::SongPreviewPlayer* $$4__this_ = {}) noexcept : $$1__state{$$1__state_}, $$2__current{$$2__current_}, delay{delay_}, $$4__this{$$4__this_} {}
