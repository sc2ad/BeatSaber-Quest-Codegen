...
namespace GlobalNamespace {
  ...
  class HashSetExtensions::HashSetDelegateHolder_1 : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCF197C
    // Autogenerated static field getter
    ...
    static System::Reflection::MethodInfo* get_InitializeMethod() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HashSetExtensions::HashSetDelegateHolder_1<T>*>::get(), "get_InitializeMethod", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HashSetExtensions::HashSetDelegateHolder_1<T>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
