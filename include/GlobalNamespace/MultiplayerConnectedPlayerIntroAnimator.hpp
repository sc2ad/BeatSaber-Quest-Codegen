...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerConnectedPlayerIntroAnimator), 80 + sizeof(void*) + 8 - (80 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerConnectedPlayerIntroAnimatorSizeCheck;
}
