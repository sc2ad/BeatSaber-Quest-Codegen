...
namespace GlobalNamespace {
  ...
  class SteamVR_ExternalCamera : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(SteamVR_ExternalCamera::Config), 72 + sizeof(bool) + ((72 + sizeof(bool)) % 8 != 0 ? (8 - (72 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_SteamVR_ExternalCamera_ConfigSizeCheck;
  ...
  check_size<sizeof(SteamVR_ExternalCamera), 184 + sizeof(float) + ((184 + sizeof(float)) % 8 != 0 ? (8 - (184 + sizeof(float)) % 8) : 0)> __GlobalNamespace_SteamVR_ExternalCameraSizeCheck;
}
