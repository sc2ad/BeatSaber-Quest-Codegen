...
namespace GlobalNamespace {
  ...
  class BeatmapData : public ::Il2CppObject/*, public GlobalNamespace::IReadonlyBeatmapData*/ {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xF01B3C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xF01B4C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xF01B5C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xF01B6C
