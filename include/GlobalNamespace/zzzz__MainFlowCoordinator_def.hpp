...
namespace GlobalNamespace {
class ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41;
}
...
class CORDL_TYPE ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41(____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41(____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41& operator=(____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41&& o) noexcept = default;
  constexpr ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41& operator=(____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41 const& o) noexcept = default;
...
explicit ____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41(int32_t __1__state) ;
...
public:
// Declarations
using _ProcessMenuDestinationRequestAfterFrameCoroutine_d__41 = ::GlobalNamespace::____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41;
...
/// @brief Method HandleMainMenuViewControllerDidFinish addr 0x2135944 size 0x52c virtual false final false
 void HandleMainMenuViewControllerDidFinish(::GlobalNamespace::MainMenuViewController viewController, ::GlobalNamespace::____GlobalNamespace__MainMenuViewController__MenuButton subMenuType) ;

/// @brief Method HandleOptionsViewControllerDidFinish addr 0x2135e70 size 0xd0 virtual false final false
 void HandleOptionsViewControllerDidFinish(::GlobalNamespace::____GlobalNamespace__OptionsViewController__OptionsButton optionsType) ;
...
/// @brief Method HandleEditAvatarFlowCoordinatorDidFinish addr 0x2135fe0 size 0x228 virtual false final false
 void HandleEditAvatarFlowCoordinatorDidFinish(::GlobalNamespace::EditAvatarFlowCoordinator flowCoordinator, ::GlobalNamespace::____GlobalNamespace__EditAvatarFlowCoordinator__EditAvatarType editAvatarType) ;
...
/// @brief Method HandleSettingsFlowCoordinatorDidFinish addr 0x2136230 size 0x94 virtual false final false
 void HandleSettingsFlowCoordinatorDidFinish(::GlobalNamespace::SettingsFlowCoordinator settingsFlowCoordinator, ::GlobalNamespace::____GlobalNamespace__SettingsFlowCoordinator__FinishAction finishAction) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MainFlowCoordinator___ProcessMenuDestinationRequestAfterFrameCoroutine_d__41, "", "MainFlowCoordinator/<ProcessMenuDestinationRequestAfterFrameCoroutine>d__41");
