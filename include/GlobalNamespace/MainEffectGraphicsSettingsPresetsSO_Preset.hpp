...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MainEffectGraphicsSettingsPresetsSO::Preset), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __GlobalNamespace_MainEffectGraphicsSettingsPresetsSO_PresetSizeCheck;
}
