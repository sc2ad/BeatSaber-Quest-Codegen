...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::HierarchyIgnorePrefabOverrides::*)()>(&GlobalNamespace::HierarchyIgnorePrefabOverrides::_ctor)> {
 ...
 GlobalNamespace::HierarchyIgnorePrefabOverrides GlobalNamespace::HierarchyIgnorePrefabOverrides::New_ctor()  {
GlobalNamespace::HierarchyIgnorePrefabOverrides o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::HierarchyIgnorePrefabOverrides>())};
return o;
}
