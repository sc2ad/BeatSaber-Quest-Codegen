...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TestLeaderboardsModel::$SendLevelScoreResultAsync$d__5), 88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __GlobalNamespace_TestLeaderboardsModel_$SendLevelScoreResultAsync$d__5SizeCheck;
}
