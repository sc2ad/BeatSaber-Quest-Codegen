...
namespace GlobalNamespace {
  ...
  class OVRResources::$$c__DisplayClass3_0_1 : public ::Il2CppObject {
    ...
    ::Il2CppString* _get_path() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::OVRResources::$$c__DisplayClass3_0_1::_get_path");
    ...
    void _set_path(::Il2CppString* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::OVRResources::$$c__DisplayClass3_0_1::_set_path");
      static auto ___internal__instance = this;
