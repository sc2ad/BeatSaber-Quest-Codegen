...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerGamepadMac::AxisGPC), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerGamepadMac_AxisGPCSizeCheck;
}
