...
// Declarations
template<typename T1,typename T2>
using _ZipSkipTombstone_d__3_2 = GlobalNamespace::GlobalNamespace__ShuffleExtensions___ZipSkipTombstone_d__3_2<T1, T2>;

template<typename T>
using _TakeWithTombstone_d__2_1 = GlobalNamespace::GlobalNamespace__ShuffleExtensions___TakeWithTombstone_d__2_1<T>;

template<typename T>
using _PickRandomElementsWithTombstone_d__1_1 = GlobalNamespace::GlobalNamespace__ShuffleExtensions___PickRandomElementsWithTombstone_d__1_1<T>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__ShuffleExtensions___PickRandomElementsWithTombstone_d__1_1, "", "ShuffleExtensions/<PickRandomElementsWithTombstone>d__1`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__ShuffleExtensions___TakeWithTombstone_d__2_1, "", "ShuffleExtensions/<TakeWithTombstone>d__2`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__ShuffleExtensions___ZipSkipTombstone_d__3_2, "", "ShuffleExtensions/<ZipSkipTombstone>d__3`2");
