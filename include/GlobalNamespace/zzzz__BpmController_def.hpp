...
namespace GlobalNamespace {
class ____GlobalNamespace__BpmController__InitData;
}
// Type: ::InitData
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__BpmController__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__BpmController__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BpmController__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BpmController__InitData(____GlobalNamespace__BpmController__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BpmController__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BpmController__InitData(____GlobalNamespace__BpmController__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BpmController__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BpmController__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BpmController__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BpmController__InitData& operator=(____GlobalNamespace__BpmController__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__BpmController__InitData& operator=(____GlobalNamespace__BpmController__InitData const& o) noexcept = default;
...
explicit ____GlobalNamespace__BpmController__InitData(float_t startBpm) ;
...
public:
// Declarations
using InitData = ::GlobalNamespace::____GlobalNamespace__BpmController__InitData;
...
// Ctor Parameters [CppParam { name: "initData", ty: "::GlobalNamespace::____GlobalNamespace__BpmController__InitData", modifiers: "", def_value: None }, CppParam { name: "beatmapCallbacksController", ty: "::GlobalNamespace::BeatmapCallbacksController", modifiers: "", def_value: None }]
explicit BpmController(::GlobalNamespace::____GlobalNamespace__BpmController__InitData initData, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController) ;

/// @brief Method .ctor addr 0x224d508 size 0xd0 virtual false final false
 void _ctor(::GlobalNamespace::____GlobalNamespace__BpmController__InitData initData, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__BpmController__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BpmController__InitData, "", "BpmController/InitData");
