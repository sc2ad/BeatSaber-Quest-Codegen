...
/// @brief Method get_Labels addr 0x260c790 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<::StringW> get_Labels() ;

/// @brief Method Contains addr 0x260c798 size 0x160 virtual false final false
 bool Contains(::StringW label) ;

/// @brief Method Awake addr 0x260c8f8 size 0xd0 virtual false final false
 void Awake() ;
