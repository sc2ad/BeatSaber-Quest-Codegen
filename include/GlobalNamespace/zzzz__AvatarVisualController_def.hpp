...
namespace GlobalNamespace {
class ____GlobalNamespace__AvatarVisualController__HighlighterDelegate;
}
...
class CORDL_TYPE ____GlobalNamespace__AvatarVisualController__HighlighterDelegate : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____GlobalNamespace__AvatarVisualController__HighlighterDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__AvatarVisualController__HighlighterDelegate", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate(____GlobalNamespace__AvatarVisualController__HighlighterDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__AvatarVisualController__HighlighterDelegate", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate(____GlobalNamespace__AvatarVisualController__HighlighterDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__AvatarVisualController__HighlighterDelegate(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate& operator=(____GlobalNamespace__AvatarVisualController__HighlighterDelegate&& o) noexcept = default;
  constexpr ____GlobalNamespace__AvatarVisualController__HighlighterDelegate& operator=(____GlobalNamespace__AvatarVisualController__HighlighterDelegate const& o) noexcept = default;
...
explicit ____GlobalNamespace__AvatarVisualController__HighlighterDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using HighlighterDelegate = ::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate;
...
constexpr ::GlobalNamespace::AvatarPartsModel __get__avatarPartsModel() const;
 ...
 ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__EditAvatarViewController__AvatarEditPart,::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate> __declspec(property(get=__get__avatarPartHighlightSetters, put=__set__avatarPartHighlightSetters))  _avatarPartHighlightSetters;

constexpr void __set__avatarPartHighlightSetters(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__EditAvatarViewController__AvatarEditPart,::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate> value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__EditAvatarViewController__AvatarEditPart,::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate> __get__avatarPartHighlightSetters() const;
...
constexpr ::GlobalNamespace::AvatarData __get__avatarData() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate __declspec(property(get=__get__currentHighlighter, put=__set__currentHighlighter))  _currentHighlighter;

constexpr void __set__currentHighlighter(::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate __get__currentHighlighter() const;
...
/// @brief Method HighlightEditedPart addr 0x20c2c88 size 0x9c virtual false final false
 void HighlightEditedPart(::GlobalNamespace::____GlobalNamespace__EditAvatarViewController__AvatarEditPart editPart, int32_t uvSegment) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__AvatarVisualController__HighlighterDelegate, "", "AvatarVisualController/HighlighterDelegate");
