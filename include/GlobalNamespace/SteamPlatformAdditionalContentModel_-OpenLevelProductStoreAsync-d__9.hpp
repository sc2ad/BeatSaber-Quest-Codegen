...
namespace GlobalNamespace {
  ...
  struct SteamPlatformAdditionalContentModel::$OpenLevelProductStoreAsync$d__9 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
