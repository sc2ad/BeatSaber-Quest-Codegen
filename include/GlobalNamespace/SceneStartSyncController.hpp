...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SceneStartSyncController), 80 + sizeof(float) + ((80 + sizeof(float)) % 8 != 0 ? (8 - (80 + sizeof(float)) % 8) : 0)> __GlobalNamespace_SceneStartSyncControllerSizeCheck;
}
