...
namespace GlobalNamespace {
  ...
  class EulaViewController : public HMUI::ViewController {
    ...
    EulaViewController(UnityEngine::UI::Button* agreeButton_ = {}, UnityEngine::UI::Button* doNotAgreeButton_ = {}, UnityEngine::UI::Image* disableButtonsProgress_ = {}, float disabledButtonDelay_ = {}, HMUI::TextPageScrollView* textPageScrollView_ = {}, GlobalNamespace::LocalizedTextAsset* eulaLocalizedTextAsset_ = {}, GlobalNamespace::EulaViewController::InitData* initData_ = {}, System::Action_1<GlobalNamespace::EulaViewController::ButtonType>* didFinishEvent_ = {}, UnityEngine::Coroutine* buttonsCoroutine_ = {}) noexcept : agreeButton{agreeButton_}, doNotAgreeButton{doNotAgreeButton_}, disableButtonsProgress{disableButtonsProgress_}, disabledButtonDelay{disabledButtonDelay_}, textPageScrollView{textPageScrollView_}, eulaLocalizedTextAsset{eulaLocalizedTextAsset_}, initData{initData_}, didFinishEvent{didFinishEvent_}, buttonsCoroutine{buttonsCoroutine_} {}
