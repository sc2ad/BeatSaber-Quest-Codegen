...
namespace GlobalNamespace {
  ...
  class EulaViewController : public ::HMUI::ViewController {
    ...
    public:
    // [HeaderAttribute] Offset: 0x112BC2C
    ...
    char __padding4[0x4] = {};
    // [HeaderAttribute] Offset: 0x112BCB8
    ...
    // [HeaderAttribute] Offset: 0x112BD14
    // [LocalizationKeyAttribute] Offset: 0x112BD14
    ...
    // [LocalizationKeyAttribute] Offset: 0x112BD70
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [InjectAttribute] Offset: 0x112BDA8
