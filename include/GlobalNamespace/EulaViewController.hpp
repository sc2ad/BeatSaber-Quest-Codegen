...
namespace GlobalNamespace {
  ...
  class EulaViewController : public HMUI::ViewController {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDCF6E8
    ...
    // [InjectAttribute] Offset: 0xDCF6F8
    ...
    static EulaViewController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("EulaViewController").WithContext(".ctor");
