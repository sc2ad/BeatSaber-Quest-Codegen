...
namespace GlobalNamespace {
  ...
  check_size<sizeof(CloudsMeshGenerator::RadiusChunk), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __GlobalNamespace_CloudsMeshGenerator_RadiusChunkSizeCheck;
}
