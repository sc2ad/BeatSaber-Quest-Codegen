...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::FriendsViewController::*)()>(&::GlobalNamespace::FriendsViewController::get_myPartyTitle)> {
  ...
  constexpr static std::size_t addrs = 0x215b670;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::GlobalNamespace::FriendsViewController),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::FriendsViewController::*)()>(&::GlobalNamespace::FriendsViewController::get_otherPlayersTitle)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x215b6b0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::INetworkPlayerModel (::GlobalNamespace::FriendsViewController::*)()>(&::GlobalNamespace::FriendsViewController::get_networkPlayerModel)> {
  ...
  constexpr static std::size_t addrs = 0x215b6f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)(bool, bool)>(&::GlobalNamespace::FriendsViewController::NetworkPlayersViewControllerDidActivate)> {
  ...
  constexpr static std::size_t addrs = 0x215b6f8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)(bool, bool)>(&::GlobalNamespace::FriendsViewController::DidDeactivate)> {
  ...
  constexpr static std::size_t addrs = 0x215b984;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)()>(&::GlobalNamespace::FriendsViewController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x215b9c8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)(bool)>(&::GlobalNamespace::FriendsViewController::HandleOpenPartyToggleChanged)> {
  ...
  constexpr static std::size_t addrs = 0x215b9f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)(bool)>(&::GlobalNamespace::FriendsViewController::RefreshParty)> {
  ...
  constexpr static std::size_t addrs = 0x215b804;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FriendsViewController::*)()>(&::GlobalNamespace::FriendsViewController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x215ba00;
...
constexpr ::UnityEngine::UI::Toggle ::GlobalNamespace::FriendsViewController::__get__enableOpenPartyToggle() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::PlatformNetworkPlayerModel, 0x98>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::PlatformNetworkPlayerModel>(value));
}
constexpr ::GlobalNamespace::PlatformNetworkPlayerModel ::GlobalNamespace::FriendsViewController::__get__networkPlayerModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlatformNetworkPlayerModel, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::GlobalNamespace::INetworkConfig ::GlobalNamespace::FriendsViewController::__get__networkConfig() const {
...
::cordl_internals::setInstanceField<::HMUI::ToggleBinder, 0xa8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HMUI::ToggleBinder>(value));
}
constexpr ::HMUI::ToggleBinder ::GlobalNamespace::FriendsViewController::__get__toggleBinder() const {
return ::cordl_internals::getInstanceField<::HMUI::ToggleBinder, 0xa8>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr bool ::GlobalNamespace::FriendsViewController::__get__allowAnyoneToJoin() const {
