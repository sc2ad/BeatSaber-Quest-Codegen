...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::*)(int32_t, int32_t, ::GlobalNamespace::LightAxis, bool, ::UnityEngine::Transform)>(&::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x225ee60;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__set_groupId(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__get_groupId() const {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__set_elementId(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__get_elementId() const {
return ::cordl_internals::getInstanceField<int32_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__set_axis(::GlobalNamespace::LightAxis value)  {
...
constexpr ::GlobalNamespace::LightAxis ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__get_axis() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightAxis, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__set_mirrored(bool value)  {
::cordl_internals::setInstanceField<bool, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__get_mirrored() const {
return ::cordl_internals::getInstanceField<bool, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__set_transform(::UnityEngine::Transform value)  {
...
constexpr ::UnityEngine::Transform ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::__get_transform() const {
...
// Ctor Parameters [CppParam { name: "groupId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "elementId", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "axis", ty: "::GlobalNamespace::LightAxis", modifiers: "", def_value: None }, CppParam { name: "mirrored", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "transform", ty: "::UnityEngine::Transform", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::____GlobalNamespace__LightRotationGroupEffect__InitData(int32_t groupId, int32_t elementId, ::GlobalNamespace::LightAxis axis, bool mirrored, ::UnityEngine::Transform transform)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__LightRotationGroupEffect__InitData>(groupId, elementId, axis, mirrored, transform))) {}
 void ::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData::_ctor(int32_t groupId, int32_t elementId, ::GlobalNamespace::LightAxis axis, bool mirrored, ::UnityEngine::Transform transform)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::LightRotationGroupEffect::*)(::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData, ::Tweening::SongTimeTweeningManager, ::GlobalNamespace::BeatmapCallbacksController)>(&::GlobalNamespace::LightRotationGroupEffect::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Tweening::SongTimeTweeningManager>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapCallbacksController>::get()}
                        )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "initData", ty: "::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData", modifiers: "", def_value: None }, CppParam { name: "tweeningManager", ty: "::Tweening::SongTimeTweeningManager", modifiers: "", def_value: None }, CppParam { name: "beatmapCallbacksController", ty: "::GlobalNamespace::BeatmapCallbacksController", modifiers: "", def_value: None }]
 ::GlobalNamespace::LightRotationGroupEffect::LightRotationGroupEffect(::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData initData, ::Tweening::SongTimeTweeningManager tweeningManager, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<LightRotationGroupEffect>(initData, tweeningManager, beatmapCallbacksController))) {}
 void ::GlobalNamespace::LightRotationGroupEffect::_ctor(::GlobalNamespace::____GlobalNamespace__LightRotationGroupEffect__InitData initData, ::Tweening::SongTimeTweeningManager tweeningManager, ::GlobalNamespace::BeatmapCallbacksController beatmapCallbacksController)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::LightRotationGroupEffect>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
