...
namespace GlobalNamespace {
  ...
  struct SteamPlatformAdditionalContentModel::$GetPackEntitlementStatusInternalAsync$d__7 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
