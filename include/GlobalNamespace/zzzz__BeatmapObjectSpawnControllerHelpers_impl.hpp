...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(GlobalNamespace::PlayerSpecificSettings, float_t, ByRef<GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnMovementData__NoteJumpValueType>, ByRef<float_t>)>(&GlobalNamespace::BeatmapObjectSpawnControllerHelpers::GetNoteJumpValues)> {
