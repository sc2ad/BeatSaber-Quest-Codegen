...
struct CORDL_TYPE ____GlobalNamespace__ObjectsMovementRecorder__Mode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__ObjectsMovementRecorder__Mode(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__Mode(____GlobalNamespace__ObjectsMovementRecorder__Mode const&) = default;
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__Mode(____GlobalNamespace__ObjectsMovementRecorder__Mode&&) = default;
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__Mode& operator=(____GlobalNamespace__ObjectsMovementRecorder__Mode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__Mode& operator=(____GlobalNamespace__ObjectsMovementRecorder__Mode&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__ObjectsMovementRecorder__Mode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__ObjectsMovementRecorder__Mode_Unwrapped : int32_t {
__Record = 0,
__Playback = 1,
__Off = 2,
};
...
constexpr operator ______GlobalNamespace__ObjectsMovementRecorder__Mode_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__ObjectsMovementRecorder__Mode_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode const Record;

/// @brief Field Playback offset 0
static ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode const Playback;

/// @brief Field Off offset 0
static ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode const Off;
...
struct CORDL_TYPE ____GlobalNamespace__ObjectsMovementRecorder__CameraView : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__ObjectsMovementRecorder__CameraView(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__CameraView(____GlobalNamespace__ObjectsMovementRecorder__CameraView const&) = default;
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__CameraView(____GlobalNamespace__ObjectsMovementRecorder__CameraView&&) = default;
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__CameraView& operator=(____GlobalNamespace__ObjectsMovementRecorder__CameraView const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__ObjectsMovementRecorder__CameraView& operator=(____GlobalNamespace__ObjectsMovementRecorder__CameraView&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__ObjectsMovementRecorder__CameraView(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__ObjectsMovementRecorder__CameraView_Unwrapped : int32_t {
__FirstPerson = 0,
__ThirdPerson = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__ObjectsMovementRecorder__CameraView_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__ObjectsMovementRecorder__CameraView_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView const FirstPerson;

/// @brief Field ThirdPerson offset 0
static ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView const ThirdPerson;
...
class CORDL_TYPE ____GlobalNamespace__ObjectsMovementRecorder__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x58};

virtual ~____GlobalNamespace__ObjectsMovementRecorder__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__ObjectsMovementRecorder__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData(____GlobalNamespace__ObjectsMovementRecorder__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__ObjectsMovementRecorder__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData(____GlobalNamespace__ObjectsMovementRecorder__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__ObjectsMovementRecorder__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData& operator=(____GlobalNamespace__ObjectsMovementRecorder__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__ObjectsMovementRecorder__InitData& operator=(____GlobalNamespace__ObjectsMovementRecorder__InitData const& o) noexcept = default;
                


// Fields

 ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode __declspec(property(get=__get_mode, put=__set_mode))  mode;

constexpr void __set_mode(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode __get_mode() const;
...
public:
// Declarations
using InitData = ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData;

using CameraView = ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView;

using Mode = ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode;
...
constexpr ::UnityEngine::Camera __get__hmdCamera() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData __declspec(property(get=__get__initData, put=__set__initData))  _initData;

constexpr void __set__initData(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData __get__initData() const;

 ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode __declspec(property(get=__get__mode, put=__set__mode))  _mode;

constexpr void __set__mode(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode __get__mode() const;
...
constexpr ::StringW __get__recordingPath() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView __declspec(property(get=__get__cameraView, put=__set__cameraView))  _cameraView;

constexpr void __set__cameraView(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView __get__cameraView() const;
...
constexpr ::UnityEngine::Camera __get__externalCamera() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> __declspec(property(get=__get__playbackScreenshots, put=__set__playbackScreenshots))  _playbackScreenshots;

constexpr void __set__playbackScreenshots(::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> __get__playbackScreenshots() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__CameraView, "", "ObjectsMovementRecorder/CameraView");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__Mode, "", "ObjectsMovementRecorder/Mode");
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__ObjectsMovementRecorder__InitData, "", "ObjectsMovementRecorder/InitData");
