...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Event_3 : public UnityEngine::Events::UnityEvent_3<T0, T1, T2> {
    public:
    // Creating value type constructor for type: Event_3
    Event_3() noexcept {}
    ...
    void Send(T0 arg0, T1 arg1, T2 arg2) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Send", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(arg0, arg1, arg2)));
