...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [ExecuteInEditMode] Offset: D987D8
  class Billboard : public UnityEngine::MonoBehaviour {
    ...
    static Billboard* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("Billboard").WithContext(".ctor");
