...
NEED_NO_BOX(::GlobalNamespace::MenuRpcManager::LevelLoadErrorRpc);
...
namespace GlobalNamespace {
  ...
  class MenuRpcManager::LevelLoadErrorRpc : public ::GlobalNamespace::RemoteProcedureCall_1<::StringW> {
    public:
