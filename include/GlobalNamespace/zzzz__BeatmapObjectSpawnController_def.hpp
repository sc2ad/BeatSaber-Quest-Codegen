...
class CORDL_TYPE GlobalNamespace__BeatmapObjectSpawnController__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~GlobalNamespace__BeatmapObjectSpawnController__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BeatmapObjectSpawnController__InitData", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData(GlobalNamespace__BeatmapObjectSpawnController__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BeatmapObjectSpawnController__InitData", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData(GlobalNamespace__BeatmapObjectSpawnController__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BeatmapObjectSpawnController__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData& operator=(GlobalNamespace__BeatmapObjectSpawnController__InitData&& o) noexcept = default;
  constexpr GlobalNamespace__BeatmapObjectSpawnController__InitData& operator=(GlobalNamespace__BeatmapObjectSpawnController__InitData const& o) noexcept = default;
...
constexpr float_t __get_noteJumpMovementSpeed() const;
 ...
 GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnMovementData__NoteJumpValueType __declspec(property(get=__get_noteJumpValueType, put=__set_noteJumpValueType))  noteJumpValueType;

constexpr void __set_noteJumpValueType(GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnMovementData__NoteJumpValueType value) ;

constexpr GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnMovementData__NoteJumpValueType __get_noteJumpValueType() const;
...
public:
// Declarations
using InitData = GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData;
...
constexpr GlobalNamespace::IJumpOffsetYProvider __get__jumpOffsetYProvider() const;
 ...
 GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData __declspec(property(get=__get__initData, put=__set__initData))  _initData;

constexpr void __set__initData(GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData value) ;

constexpr GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData __get__initData() const;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BeatmapObjectSpawnController__InitData, "", "BeatmapObjectSpawnController/InitData");
