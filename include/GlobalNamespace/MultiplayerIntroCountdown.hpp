...
namespace GlobalNamespace {
  ...
  class MultiplayerIntroCountdown : public UnityEngine::MonoBehaviour {
    public:
    // Nested type: GlobalNamespace::MultiplayerIntroCountdown::$CountdownRoutine$d__24
    class $CountdownRoutine$d__24;
    // Nested type: GlobalNamespace::MultiplayerIntroCountdown::$PlayDelayed$d__25
    class $PlayDelayed$d__25;
    // Nested type: GlobalNamespace::MultiplayerIntroCountdown::$$c__DisplayClass26_0
    class $$c__DisplayClass26_0;
    // Nested type: GlobalNamespace::MultiplayerIntroCountdown::$PhaseRoutine$d__26
    class $PhaseRoutine$d__26;
    ...
    // private UnityEngine.ParticleSystem _particlesIn
    // Offset: 0x60
    UnityEngine::ParticleSystem* particlesIn;
