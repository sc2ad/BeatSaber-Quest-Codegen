...
namespace GlobalNamespace {
  ...
  class BeatmapObjectData : public ::Il2CppObject {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xCF3F84
    ...
    // [CompilerGeneratedAttribute] Offset: 0xCF3F94
    ...
    // Offset: 0xFFFFFFFF
    GlobalNamespace::BeatmapObjectType get_beatmapObjectType_NEW();
