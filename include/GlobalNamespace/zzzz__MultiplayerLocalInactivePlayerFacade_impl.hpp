...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__MultiplayerLocalInactivePlayerFacade__Factory._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MultiplayerLocalInactivePlayerFacade__Factory::*)()>(&GlobalNamespace::GlobalNamespace__MultiplayerLocalInactivePlayerFacade__Factory::_ctor)> {
