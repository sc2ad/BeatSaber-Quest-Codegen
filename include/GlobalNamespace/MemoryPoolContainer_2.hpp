...
namespace GlobalNamespace {
  ...
  class MemoryPoolContainer_2 : public ::Il2CppObject {
    ...
    GlobalNamespace::LazyCopyHashSet_1<T1>* _get__activeItems() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_2::_get__activeItems");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<GlobalNamespace::LazyCopyHashSet_1<T1>*>(___internal__instance, "_activeItems"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly LazyCopyHashSet`1<T1> _activeItems
    void _set__activeItems(GlobalNamespace::LazyCopyHashSet_1<T1>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_2::_set__activeItems");
      static auto ___internal__instance = this;
    ...
    Zenject::IMemoryPool_1<T0>* _get__memoryPool() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_2::_get__memoryPool");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<Zenject::IMemoryPool_1<T0>*>(___internal__instance, "_memoryPool"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly Zenject.IMemoryPool`1<T0> _memoryPool
    void _set__memoryPool(Zenject::IMemoryPool_1<T0>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::MemoryPoolContainer_2::_set__memoryPool");
      static auto ___internal__instance = this;
