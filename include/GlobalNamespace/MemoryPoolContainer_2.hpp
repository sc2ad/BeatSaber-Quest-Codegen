...
namespace GlobalNamespace {
  ...
  class MemoryPoolContainer_2 : public ::Il2CppObject {
    ...
    void _set__activeItems(GlobalNamespace::LazyCopyHashSet_1<T1>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_activeItems"))->offset;
      *reinterpret_cast<GlobalNamespace::LazyCopyHashSet_1<T1>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
    ...
    void _set__memoryPool(Zenject::IMemoryPool_1<T0>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_memoryPool"))->offset;
      *reinterpret_cast<Zenject::IMemoryPool_1<T0>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
