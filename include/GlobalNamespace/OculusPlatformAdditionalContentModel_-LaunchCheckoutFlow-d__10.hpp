...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusPlatformAdditionalContentModel::$LaunchCheckoutFlow$d__10), 40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<Oculus::Platform::Message_1<Oculus::Platform::Models::Purchase*>*>) + ((40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<Oculus::Platform::Message_1<Oculus::Platform::Models::Purchase*>*>)) % 8 != 0 ? (8 - (40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<Oculus::Platform::Message_1<Oculus::Platform::Models::Purchase*>*>)) % 8) : 0)> __GlobalNamespace_OculusPlatformAdditionalContentModel_$LaunchCheckoutFlow$d__10SizeCheck;
}
