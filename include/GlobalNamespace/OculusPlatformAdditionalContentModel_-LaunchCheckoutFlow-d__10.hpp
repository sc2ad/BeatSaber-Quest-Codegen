...
namespace GlobalNamespace {
  ...
  struct OculusPlatformAdditionalContentModel::$LaunchCheckoutFlow$d__10 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
