...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::*)(float_t, ::System::Action)>(&::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0xdcc460;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction>::get(),
                            ".ctor",
...
constexpr ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction(float_t time, ::System::Action action) noexcept : ::bs_hook::ValueTypeWrapper() {this->time = time;
this->action = action;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::__set_time(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::__get_time() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::__set_action(::System::Action value)  {
::cordl_internals::setInstanceField<::System::Action, 0x8>(this->__instance, std::forward<::System::Action>(value));
}
constexpr ::System::Action ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::__get_action() const {
return ::cordl_internals::getInstanceField<::System::Action, 0x8>(this->__instance);
}
 void ::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction::_ctor(float_t time, ::System::Action action)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::SynchronizedActionQueue::__set__synchronizedActionQueue(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction>>(value));
}
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction> ::GlobalNamespace::SynchronizedActionQueue::__get__synchronizedActionQueue() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__SynchronizedActionQueue__SynchronizedAction>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
