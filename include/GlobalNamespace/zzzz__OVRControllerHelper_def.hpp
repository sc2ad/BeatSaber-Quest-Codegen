...
namespace GlobalNamespace {
struct ____GlobalNamespace__OVRControllerHelper__ControllerType;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__OVRControllerHelper__ControllerType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__OVRControllerHelper__ControllerType(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__OVRControllerHelper__ControllerType(____GlobalNamespace__OVRControllerHelper__ControllerType const&) = default;
                    constexpr ____GlobalNamespace__OVRControllerHelper__ControllerType(____GlobalNamespace__OVRControllerHelper__ControllerType&&) = default;
                    constexpr ____GlobalNamespace__OVRControllerHelper__ControllerType& operator=(____GlobalNamespace__OVRControllerHelper__ControllerType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__OVRControllerHelper__ControllerType& operator=(____GlobalNamespace__OVRControllerHelper__ControllerType&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__OVRControllerHelper__ControllerType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__OVRControllerHelper__ControllerType_Unwrapped : int32_t {
__QuestAndRiftS = 1,
__Rift = 2,
__Quest2 = 3,
__TouchPro = 4,
...
constexpr operator ______GlobalNamespace__OVRControllerHelper__ControllerType_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__OVRControllerHelper__ControllerType_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType const QuestAndRiftS;

/// @brief Field Rift offset 0
static ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType const Rift;

/// @brief Field Quest2 offset 0
static ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType const Quest2;

/// @brief Field TouchPro offset 0
static ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType const TouchPro;
...
public:
// Declarations
using ControllerType = ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType;
...
constexpr bool __get_m_hasInputFocusPrev() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType __declspec(property(get=__get_activeControllerType, put=__set_activeControllerType))  activeControllerType;

constexpr void __set_activeControllerType(::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType __get_activeControllerType() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__OVRControllerHelper__ControllerType, "", "OVRControllerHelper/ControllerType");
