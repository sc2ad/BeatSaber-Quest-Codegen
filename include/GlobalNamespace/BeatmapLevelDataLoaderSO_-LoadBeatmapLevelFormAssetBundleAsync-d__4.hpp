...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapLevelDataLoaderSO::$LoadBeatmapLevelFormAssetBundleAsync$d__4), 80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevel*>) + ((80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevel*>)) % 8 != 0 ? (8 - (80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapLevel*>)) % 8) : 0)> __GlobalNamespace_BeatmapLevelDataLoaderSO_$LoadBeatmapLevelFormAssetBundleAsync$d__4SizeCheck;
}
