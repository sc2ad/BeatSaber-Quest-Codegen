...
namespace GlobalNamespace {
  ...
  struct BeatmapLevelDataLoaderSO::$LoadBeatmapLevelFormAssetBundleAsync$d__4 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
