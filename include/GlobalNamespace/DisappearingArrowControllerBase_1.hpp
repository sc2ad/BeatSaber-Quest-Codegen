...
namespace GlobalNamespace {
  ...
  class DisappearingArrowControllerBase_1 : public UnityEngine::MonoBehaviour {
    ...
    void HandleCubeNoteControllerDidInit(T gameNoteController) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, gameNoteController)));
    }
    ...
    void SetArrowTransparency(float arrowTransparency) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, arrowTransparency)));
    }
