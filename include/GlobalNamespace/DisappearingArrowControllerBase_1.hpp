...
namespace GlobalNamespace {
  ...
  class DisappearingArrowControllerBase_1 : public UnityEngine::MonoBehaviour {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<GlobalNamespace::MaterialPropertyBlockController*> transparentObjectMaterialPropertyBlocks;
    // Field size check
    ...
    ::ArrayWrapper<GlobalNamespace::MaterialPropertyBlockController*>& dyn__transparentObjectMaterialPropertyBlocks() {
