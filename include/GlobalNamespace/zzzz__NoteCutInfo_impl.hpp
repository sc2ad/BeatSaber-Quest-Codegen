...
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::GlobalNamespace__NoteCutInfo__FailReason(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason  GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::None{0};
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason  GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::TooSoon{1};
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason  GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::WrongColor{2};
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason  GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::CutHarder{3};
constexpr GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason  GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason::WrongDirection{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason (GlobalNamespace::NoteCutInfo::*)()>(&GlobalNamespace::NoteCutInfo::get_failReason)> {
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason GlobalNamespace::NoteCutInfo::get_failReason()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::NoteCutInfo>::get(),
                            "get_failReason",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method);
}
