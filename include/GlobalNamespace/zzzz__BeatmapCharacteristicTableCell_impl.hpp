...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BeatmapCharacteristicTableCell::*)(HMUI::HMUI__SelectableCell__TransitionType)>(&GlobalNamespace::BeatmapCharacteristicTableCell::SelectionDidChange)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BeatmapCharacteristicTableCell::*)(HMUI::HMUI__SelectableCell__TransitionType)>(&GlobalNamespace::BeatmapCharacteristicTableCell::HighlightDidChange)> {
  constexpr static std::size_t size = 0x4;
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, beatmapCharacteristic);
 ...
 void GlobalNamespace::BeatmapCharacteristicTableCell::SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BeatmapCharacteristicTableCell>::get(),
                            "SelectionDidChange",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, transitionType);
 ...
 void GlobalNamespace::BeatmapCharacteristicTableCell::HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BeatmapCharacteristicTableCell>::get(),
                            "HighlightDidChange",
                            std::vector<Il2CppClass*>{},
