...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveData::PlayerAllOverallStatsData), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_PlayerSaveData_PlayerAllOverallStatsDataSizeCheck;
}
