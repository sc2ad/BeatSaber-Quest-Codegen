...
namespace GlobalNamespace {
  ...
  class MultiplayerSessionManager::$$c : public ::Il2CppObject {
    ...
    static System::Func_2<GlobalNamespace::IConnectedPlayer*, int>* _get_$$9__103_0();
...
NEED_NO_BOX(GlobalNamespace::MultiplayerSessionManager::$$c);
...
// Writing MetadataGetter for method: GlobalNamespace::MultiplayerSessionManager::$$c::$TryUpdateConnectedPlayer$b__103_0
// Il2CppName: <TryUpdateConnectedPlayer>b__103_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (GlobalNamespace::MultiplayerSessionManager::$$c::*)(GlobalNamespace::IConnectedPlayer*)>(&GlobalNamespace::MultiplayerSessionManager::$$c::$TryUpdateConnectedPlayer$b__103_0)> {
  static const MethodInfo* get() {
    static auto* p = &::il2cpp_utils::GetClassFromName("", "IConnectedPlayer")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MultiplayerSessionManager::$$c*), "<TryUpdateConnectedPlayer>b__103_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{p});
  }
};
