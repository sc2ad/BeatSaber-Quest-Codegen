...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TestPlatformLeaderboardsHandler::*)()>(&GlobalNamespace::TestPlatformLeaderboardsHandler::_ctor)> {
 ...
 GlobalNamespace::HMAsyncRequest GlobalNamespace::TestPlatformLeaderboardsHandler::GetScores(GlobalNamespace::IDifficultyBeatmap beatmap, int32_t count, int32_t fromRank, GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope scope, ::StringW referencePlayerId, GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__GetScoresCompletionHandler completionHandler)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TestPlatformLeaderboardsHandler>::get(),
                            "GetScores",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::HMAsyncRequest, false>(const_cast<void*>(instance), ___internal_method, beatmap, count, fromRank, scope, referencePlayerId, completionHandler);
 ...
 GlobalNamespace::HMAsyncRequest GlobalNamespace::TestPlatformLeaderboardsHandler::UploadScore(GlobalNamespace::GlobalNamespace__LeaderboardScoreUploader__ScoreData scoreData, GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__UploadScoreCompletionHandler completionHandler)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TestPlatformLeaderboardsHandler>::get(),
                            "UploadScore",
                            std::vector<Il2CppClass*>{},
...
GlobalNamespace::TestPlatformLeaderboardsHandler o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::TestPlatformLeaderboardsHandler>())};
return o;
}
