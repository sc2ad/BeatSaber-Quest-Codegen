...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameplayModifierMask), 0 + sizeof(uint16_t) + ((0 + sizeof(uint16_t)) % 8 != 0 ? (8 - (0 + sizeof(uint16_t)) % 8) : 0)> __GlobalNamespace_GameplayModifierMaskSizeCheck;
}
