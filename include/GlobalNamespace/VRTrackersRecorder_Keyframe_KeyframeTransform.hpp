...
namespace GlobalNamespace {
  ...
  check_size<sizeof(VRTrackersRecorder::Keyframe::KeyframeTransform), 44 + sizeof(bool) + 8 - (44 + sizeof(bool)) % 8> __GlobalNamespace_VRTrackersRecorder_Keyframe_KeyframeTransformSizeCheck;
}
