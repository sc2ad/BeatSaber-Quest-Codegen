...
namespace GlobalNamespace {
  ...
  class TupleListExtensions : public ::Il2CppObject {
    ...
    static void Add(System::Collections::Generic::IList_1<System::Tuple_2<T1, T2>*>* list, T1 item1, T2 item2) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, item1, item2)));
    }
    ...
    static void Add(System::Collections::Generic::IList_1<System::Tuple_3<T1, T2, T3>*>* list, T1 item1, T2 item2, T3 item3) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, item1, item2, item3)));
    }
    ...
    static void Add(System::Collections::Generic::IList_1<System::Tuple_4<T1, T2, T3, T4>*>* list, T1 item1, T2 item2, T3 item3, T4 item4) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, item1, item2, item3, item4)));
    }
  }; // TupleListExtensions
  #pragma pack(pop)
}
