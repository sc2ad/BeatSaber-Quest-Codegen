...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::*)()>(&GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::get_apiName)> {
  ...
  constexpr static std::size_t addrs = 0x222a4e8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::*)(::StringW)>(&GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::set_apiName)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222a4f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::*)()>(&GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::get_localizedDescription)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222a4f8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::*)(::StringW)>(&GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::set_localizedDescription)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222a500;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(GlobalNamespace::IDifficultyBeatmap)>(&GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::GetDestinationLocalizedString)> {
  ...
  constexpr static std::size_t addrs = 0x222a548;
...
constexpr  GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::operator GlobalNamespace::IRichPresenceData() const noexcept {
...
constexpr ::StringW GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::__get__apiName_k__BackingField() const {
...
constexpr ::StringW GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::__get__localizedDescription_k__BackingField() const {
...
// Ctor Parameters [CppParam { name: "difficultyBeatmap", ty: "GlobalNamespace::IDifficultyBeatmap", modifiers: "", def_value: None }]
 GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::PlayingDifficultyBeatmapRichPresenceData(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<PlayingDifficultyBeatmapRichPresenceData>(difficultyBeatmap))) {}
 void GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData::_ctor(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
