...
GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData>(difficultyBeatmap))};
return o;
}
