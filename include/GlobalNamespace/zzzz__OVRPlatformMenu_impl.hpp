...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler::____GlobalNamespace__OVRPlatformMenu__eHandler(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler  ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler::ShowConfirmQuit{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler  ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler::RetreatOneLevel{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction  ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction::NONE{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction  ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction::SHORT_PRESS{1};
//  Writing Method size for method: ::GlobalNamespace::OVRPlatformMenu.HandleBackButtonState
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction (::GlobalNamespace::OVRPlatformMenu::*)()>(&::GlobalNamespace::OVRPlatformMenu::HandleBackButtonState)> {
...
constexpr void ::GlobalNamespace::OVRPlatformMenu::__set_inputCode(::GlobalNamespace::____GlobalNamespace__OVRInput__RawButton value)  {
...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRInput__RawButton ::GlobalNamespace::OVRPlatformMenu::__get_inputCode() const {
...
constexpr void ::GlobalNamespace::OVRPlatformMenu::__set_shortPressHandler(::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler ::GlobalNamespace::OVRPlatformMenu::__get_shortPressHandler() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eHandler, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::Stack_1<::StringW>, "sceneStack", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRPlatformMenu>::get>();
 ...
 ::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction ::GlobalNamespace::OVRPlatformMenu::HandleBackButtonState()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRPlatformMenu>::get(),
                            "HandleBackButtonState",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__OVRPlatformMenu__eBackButtonAction, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 ::GlobalNamespace::OVRPlatformMenu::OVRPlatformMenu()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<OVRPlatformMenu>())) {}
