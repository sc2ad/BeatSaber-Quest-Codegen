...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Action_2 : public GlobalNamespace::SteamVR_Events::Action {
    ...
    void _set__event(GlobalNamespace::SteamVR_Events::Event_2<T0, T1>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_event"))->offset;
      *reinterpret_cast<GlobalNamespace::SteamVR_Events::Event_2<T0, T1>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
    ...
    void _set_action(UnityEngine::Events::UnityAction_2<T0, T1>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "action"))->offset;
      *reinterpret_cast<UnityEngine::Events::UnityAction_2<T0, T1>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
