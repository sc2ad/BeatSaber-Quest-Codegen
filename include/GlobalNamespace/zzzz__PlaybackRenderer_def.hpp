...
struct CORDL_TYPE ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type(int32_t value__) noexcept;


                    constexpr ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type(______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type const&) = default;
                    constexpr ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type(______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type&&) = default;
                    constexpr ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type& operator=(______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type& operator=(______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type&& o) noexcept {
...
constexpr explicit ______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ________GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type_Unwrapped : int32_t {
__Foreground = 1,
__Background = 2,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ________GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type_Unwrapped () const noexcept {
return std::bit_cast<________GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type const Foreground;

/// @brief Field Background offset 0
static ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type const Background;
...
class CORDL_TYPE ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using Type = ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot(____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot(____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot& operator=(____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot&& o) noexcept = default;
  constexpr ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot& operator=(____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot const& o) noexcept = default;
...
constexpr ::UnityEngine::LayerMask __get__layerMask() const;
 ...
 ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type __declspec(property(get=__get__type, put=__set__type))  _type;

constexpr void __set__type(::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type value) ;

constexpr ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type __get__type() const;
...
// Properties
 ...
 ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type __declspec(property(get=get_type))  type;
...
/// @brief Method get_type addr 0x21a5ff4 size 0x8 virtual false final false
 ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type get_type() ;
...
explicit ____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot(::StringW name, ::UnityEngine::LayerMask layerMask, ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type type, ::UnityEngine::Color backgroundColor) ;

/// @brief Method .ctor addr 0x21a6018 size 0x68 virtual false final false
 void _ctor(::StringW name, ::UnityEngine::LayerMask layerMask, ::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type type, ::UnityEngine::Color backgroundColor) ;
...
public:
// Declarations
using PlaybackScreenshot = ::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot;
...
constexpr ::UnityEngine::Camera __get__camera() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__PosesRecordingData__ExternalCameraCalibration __declspec(property(get=__get__cameraCalibration, put=__set__cameraCalibration))  _cameraCalibration;

constexpr void __set__cameraCalibration(::GlobalNamespace::____GlobalNamespace__PosesRecordingData__ExternalCameraCalibration value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__PosesRecordingData__ExternalCameraCalibration __get__cameraCalibration() const;
...
constexpr ::UnityEngine::Material __get__clipMaterial() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> __declspec(property(get=__get__screenshots, put=__set__screenshots))  _screenshots;

constexpr void __set__screenshots(::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> __get__screenshots() const;


// Properties

 ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> __declspec(property(get=get_screenshots))  screenshots;
...
/// @brief Method get_screenshots addr 0x21a53a0 size 0x8 virtual false final false
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> get_screenshots() ;
...
/// @brief Method InitCamera addr 0x21a53a8 size 0x110 virtual false final false
 void InitCamera(::UnityEngine::Camera camera, ::GlobalNamespace::____GlobalNamespace__PosesRecordingData__ExternalCameraCalibration cameraCalibration) ;
...
/// @brief Method RenderForeground addr 0x21a5c1c size 0x1c0 virtual false final false
 void RenderForeground(::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot screenshot) ;

/// @brief Method RenderBackground addr 0x21a5ddc size 0x154 virtual false final false
 void RenderBackground(::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot screenshot) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type, "", "PlaybackRenderer/PlaybackScreenshot/Type");
NEED_NO_BOX(::GlobalNamespace::PlaybackRenderer);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::PlaybackRenderer, "", "PlaybackRenderer");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__PlaybackRenderer__PlaybackScreenshot, "", "PlaybackRenderer/PlaybackScreenshot");
