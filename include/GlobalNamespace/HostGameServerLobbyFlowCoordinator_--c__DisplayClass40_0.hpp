...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D31670
  class HostGameServerLobbyFlowCoordinator::$$c__DisplayClass40_0 : public ::Il2CppObject {
    ...
    static HostGameServerLobbyFlowCoordinator::$$c__DisplayClass40_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass40_0::.ctor");
