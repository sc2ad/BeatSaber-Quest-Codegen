...
namespace GlobalNamespace {
  ...
  class PrivacyPolicyDisplayViewController : public HMUI::ViewController {
    public:
    // [HeaderAttribute] Offset: 0xF4726C
    ...
    // Creating value type constructor for type: PrivacyPolicyDisplayViewController
    PrivacyPolicyDisplayViewController(HMUI::TextPageScrollView* textPageScrollView_ = {}, GlobalNamespace::LocalizedTextAsset* localizedTextAsset_ = {}) noexcept : textPageScrollView{textPageScrollView_}, localizedTextAsset{localizedTextAsset_} {}
