...
namespace GlobalNamespace {
  ...
  class PlayerSaveData::ColorScheme : public ::CsObject {
    public:
    ...
    // Offset: 0xBC6F5C
    static PlayerSaveData::ColorScheme* New_ctor(::CsString* colorSchemeId, UnityEngine::Color saberAColor, UnityEngine::Color saberBColor, UnityEngine::Color environmentColor0, UnityEngine::Color environmentColor1, UnityEngine::Color obstaclesColor);
