...
namespace GlobalNamespace {
  ...
  class BeatmapCallbackItemDataList::SpawnObstacleCallback : public System::MulticastDelegate {
    ...
    // Offset: 0x1066DBC
    void Invoke_NEW(GlobalNamespace::ObstacleData* obstacleData);
    // public System.IAsyncResult BeginInvoke(ObstacleData obstacleData, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1067EBC
    System::IAsyncResult* BeginInvoke_NEW(GlobalNamespace::ObstacleData* obstacleData, System::AsyncCallback* callback, ::Il2CppObject* object);
