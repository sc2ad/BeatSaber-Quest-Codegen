...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusBeatmapDataAssetFileModel), 72 + sizeof(void*) + ((72 + sizeof(void*)) % 8 != 0 ? (8 - (72 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OculusBeatmapDataAssetFileModelSizeCheck;
}
