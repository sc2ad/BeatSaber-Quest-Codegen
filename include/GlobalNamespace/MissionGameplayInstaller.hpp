...
namespace GlobalNamespace {
  ...
  class MissionGameplayInstaller : public Zenject::MonoInstaller {
    public:
    // [InjectAttribute] Offset: 0xDCC1F0
    ...
    static MissionGameplayInstaller* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MissionGameplayInstaller").WithContext(".ctor");
