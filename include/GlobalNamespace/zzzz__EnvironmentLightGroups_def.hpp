...
class CORDL_TYPE GlobalNamespace__EnvironmentLightGroups____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~GlobalNamespace__EnvironmentLightGroups____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentLightGroups____c", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__EnvironmentLightGroups____c(GlobalNamespace__EnvironmentLightGroups____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentLightGroups____c", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__EnvironmentLightGroups____c(GlobalNamespace__EnvironmentLightGroups____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__EnvironmentLightGroups____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__EnvironmentLightGroups____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentLightGroups____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentLightGroups____c& operator=(GlobalNamespace__EnvironmentLightGroups____c&& o) noexcept = default;
  constexpr GlobalNamespace__EnvironmentLightGroups____c& operator=(GlobalNamespace__EnvironmentLightGroups____c const& o) noexcept = default;
                


// Fields

static GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c value) ;

static GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c __get___9() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__EnvironmentLightGroups____c, "", "EnvironmentLightGroups/<>c");
