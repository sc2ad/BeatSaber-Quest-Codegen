...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::____GlobalNamespace__OVRTracker__Frustum(float_t nearZ, float_t farZ, ::UnityEngine::Vector2 fov) noexcept : ::bs_hook::ValueTypeWrapper() {this->nearZ = nearZ;
this->farZ = farZ;
this->fov = fov;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__set_nearZ(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__get_nearZ() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__set_farZ(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__get_farZ() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__set_fov(::UnityEngine::Vector2 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x8>(this->__instance, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2 ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum::__get_fov() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum (::GlobalNamespace::OVRTracker::*)(int32_t)>(&::GlobalNamespace::OVRTracker::GetFrustum)> {
...
/// @param tracker: int32_t (default: 0)
 ::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum ::GlobalNamespace::OVRTracker::GetFrustum(int32_t tracker)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRTracker>::get(),
                            "GetFrustum",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__OVRTracker__Frustum, false>(const_cast<void*>(instance), ___internal_method, tracker);
}
/// @param tracker: int32_t (default: 0)
