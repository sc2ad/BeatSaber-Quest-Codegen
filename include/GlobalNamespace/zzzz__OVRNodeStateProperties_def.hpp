...
struct ____GlobalNamespace__OVRPlugin__Node;
}
namespace UnityEngine::XR {
struct XRNodeState;
}
...
static bool GetNodeStatePropertyVector3(::UnityEngine::XR::XRNode nodeType, ::GlobalNamespace::NodeStatePropertyType propertyType, ::GlobalNamespace::____GlobalNamespace__OVRPlugin__Node ovrpNodeType, ::GlobalNamespace::____GlobalNamespace__OVRPlugin__Step stepType, ByRef<::UnityEngine::Vector3> retVec) ;

/// @brief Method GetNodeStatePropertyQuaternion addr 0x25ab4c8 size 0x160 virtual false final false
static bool GetNodeStatePropertyQuaternion(::UnityEngine::XR::XRNode nodeType, ::GlobalNamespace::NodeStatePropertyType propertyType, ::GlobalNamespace::____GlobalNamespace__OVRPlugin__Node ovrpNodeType, ::GlobalNamespace::____GlobalNamespace__OVRPlugin__Step stepType, ByRef<::UnityEngine::Quaternion> retQuat) ;
