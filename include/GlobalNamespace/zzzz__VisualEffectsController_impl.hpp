...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VisualEffectsController::*)()>(&GlobalNamespace::VisualEffectsController::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x267ad9c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VisualEffectsController::*)()>(&GlobalNamespace::VisualEffectsController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x267aed0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VisualEffectsController::*)()>(&GlobalNamespace::VisualEffectsController::OnPreRender)> {
  ...
  constexpr static std::size_t addrs = 0x267afb8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::VisualEffectsController::*)()>(&GlobalNamespace::VisualEffectsController::HandleDepthTextureEnabledDidChange)> {
  ...
  constexpr static std::size_t addrs = 0x267ae70;
...
constexpr GlobalNamespace::BoolSO GlobalNamespace::VisualEffectsController::__get__depthTextureEnabled() const {
...
constexpr UnityEngine::Camera GlobalNamespace::VisualEffectsController::__get__camera() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, keyword, value);
}
// Ctor Parameters []
 GlobalNamespace::VisualEffectsController::VisualEffectsController()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<VisualEffectsController>())) {}
 void GlobalNamespace::VisualEffectsController::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::VisualEffectsController>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
