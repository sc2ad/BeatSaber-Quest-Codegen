...
namespace GlobalNamespace {
  ...
  class LevelSelectionFlowCoordinator::State : public ::Il2CppObject {
    ...
    // public readonly System.Boolean onlyNotOwned
    // Size: 0x1
    // Offset: 0x30
    bool onlyNotOwned;
    // Field size check
    ...
    // Get instance field reference: public readonly System.Boolean onlyNotOwned
    ...
    // public System.Void .ctor(System.Boolean onlyNotOwned)
    // Offset: 0x15101BC
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static LevelSelectionFlowCoordinator::State* New_ctor(bool onlyNotOwned) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::LevelSelectionFlowCoordinator::State::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LevelSelectionFlowCoordinator::State*, creationType>(onlyNotOwned)));
    }
