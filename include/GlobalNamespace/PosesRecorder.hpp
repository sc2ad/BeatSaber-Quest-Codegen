...
namespace GlobalNamespace {
  ...
  class PosesRecorder : public ::Il2CppObject {
    ...
    // Creating value type constructor for type: PosesRecorder
    PosesRecorder(::Array<UnityEngine::Transform*>* transforms_ = {}, GlobalNamespace::PosesRecordingData* data_ = {}) noexcept : transforms{transforms_}, data{data_} {}
    ...
    // Offset: 0x11ADF2C
    void StartRecording(::Array<GlobalNamespace::PoseObject*>* poseObjects);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PosesRecorder::*)(::Array<GlobalNamespace::PoseObject*>*)>(&GlobalNamespace::PosesRecorder::StartRecording)> {
