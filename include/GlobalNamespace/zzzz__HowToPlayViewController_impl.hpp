...
constexpr ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions  ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions::HowToPlay{0};
constexpr ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions  ::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions::Credits{1};
//  Writing Method size for method: ::GlobalNamespace::HowToPlayViewController.add_didFinishEvent
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HowToPlayViewController::*)(::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>)>(&::GlobalNamespace::HowToPlayViewController::add_didFinishEvent)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HowToPlayViewController::*)(::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>)>(&::GlobalNamespace::HowToPlayViewController::remove_didFinishEvent)> {
  constexpr static std::size_t size = 0xb0;
...
constexpr void ::GlobalNamespace::HowToPlayViewController::__set_didFinishEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions> value)  {
::cordl_internals::setInstanceField<::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>, 0x80>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>>(value));
}
constexpr ::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions> ::GlobalNamespace::HowToPlayViewController::__get_didFinishEvent() const {
return ::cordl_internals::getInstanceField<::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions>, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void ::GlobalNamespace::HowToPlayViewController::add_didFinishEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::HowToPlayViewController>::get(),
                            "add_didFinishEvent",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void ::GlobalNamespace::HowToPlayViewController::remove_didFinishEvent(::System::Action_1<::GlobalNamespace::____GlobalNamespace__HowToPlayViewController__HowToPlayOptions> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::HowToPlayViewController>::get(),
                            "remove_didFinishEvent",
                            std::vector<Il2CppClass*>{},
