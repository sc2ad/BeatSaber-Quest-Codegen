...
class CORDL_TYPE GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13(GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13(GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13& operator=(GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13&& o) noexcept = default;
  constexpr GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13& operator=(GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13 const& o) noexcept = default;
...
public:
// Declarations
using _RemovePlayerAndDestroy_d__13 = GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13;
...
constexpr GlobalNamespace::ILobbyStateDataModel __get__lobbyStateDataModel() const;
 ...
 GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarController__Factory __declspec(property(get=__get__avatarControllerFactory, put=__set__avatarControllerFactory))  _avatarControllerFactory;

constexpr void __set__avatarControllerFactory(GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarController__Factory value) ;

constexpr GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarController__Factory __get__avatarControllerFactory() const;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13, "", "MultiplayerLobbyAvatarManager/<RemovePlayerAndDestroy>d__13");
