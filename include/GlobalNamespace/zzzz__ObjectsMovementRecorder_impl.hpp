...
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode  GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode::Record{0};
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode  GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode::Playback{1};
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode  GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode::Off{2};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView::GlobalNamespace__ObjectsMovementRecorder__CameraView(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView  GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView::FirstPerson{0};
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView  GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView::ThirdPerson{1};
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::*)(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode, ::StringW, GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView, bool, bool, int32_t, int32_t, int32_t, ::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>, bool, GlobalNamespace::IBeatSaberLogger, GlobalNamespace::IPosesSerializer)>(&GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::IBeatSaberLogger>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::IPosesSerializer>::get()}
                        )));
    return ___internal_method;
  }
};
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_mode(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_mode() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_recordingPath(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_recordingPath() const {
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_cameraView(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_cameraView() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_addDateTimeSuffixToRecordingName(bool value)  {
::cordl_internals::setInstanceField<bool, 0x24>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_addDateTimeSuffixToRecordingName() const {
return ::cordl_internals::getInstanceField<bool, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_screenshotRecording(bool value)  {
::cordl_internals::setInstanceField<bool, 0x25>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_screenshotRecording() const {
return ::cordl_internals::getInstanceField<bool, 0x25>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_screenshotWidth(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_screenshotWidth() const {
return ::cordl_internals::getInstanceField<int32_t, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_screenshotHeight(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_screenshotHeight() const {
return ::cordl_internals::getInstanceField<int32_t, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_framerate(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_framerate() const {
return ::cordl_internals::getInstanceField<int32_t, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_playbackScreenshots(::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_playbackScreenshots() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_saveToOldFormat(bool value)  {
::cordl_internals::setInstanceField<bool, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_saveToOldFormat() const {
return ::cordl_internals::getInstanceField<bool, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_posesSerializer(GlobalNamespace::IPosesSerializer value)  {
...
constexpr GlobalNamespace::IPosesSerializer GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__get_posesSerializer() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::IPosesSerializer, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData::__set_logger(GlobalNamespace::IBeatSaberLogger value)  {
...
constexpr void GlobalNamespace::ObjectsMovementRecorder::__set__initData(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData, 0x60>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData GlobalNamespace::ObjectsMovementRecorder::__get__initData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ObjectsMovementRecorder::__set__mode(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode GlobalNamespace::ObjectsMovementRecorder::__get__mode() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__Mode, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void GlobalNamespace::ObjectsMovementRecorder::__set__cameraView(GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView, 0x78>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView GlobalNamespace::ObjectsMovementRecorder::__get__cameraView() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__CameraView, 0x78>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void GlobalNamespace::ObjectsMovementRecorder::__set__playbackScreenshots(::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>, 0x88>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> GlobalNamespace::ObjectsMovementRecorder::__get__playbackScreenshots() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot>, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
