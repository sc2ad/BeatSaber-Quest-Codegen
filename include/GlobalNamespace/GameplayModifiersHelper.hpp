...
namespace GlobalNamespace {
  ...
  class GameplayModifiersHelper : public ::Il2CppObject {
    ...
    // Offset: 0x11E5F08
    static GlobalNamespace::GameplayModifiers* FromDTO(::ArrayWrapper<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers> gameplayModifiersDTOs);
...
// Il2CppName: ToDTO
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers> (*)(GlobalNamespace::GameplayModifiers*)>(&GlobalNamespace::GameplayModifiersHelper::ToDTO)> {
...
// Il2CppName: FromDTO
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GameplayModifiers* (*)(::ArrayWrapper<BeatSaberAPI::DataTransferObjects::LevelScoreResult::GameplayModifiers>)>(&GlobalNamespace::GameplayModifiersHelper::FromDTO)> {
  static const MethodInfo* get() {
    static auto* gameplayModifiersDTOs = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("BeatSaberAPI.DataTransferObjects", "LevelScoreResult/GameplayModifiers")), 1)->byval_arg;
