...
namespace GlobalNamespace {
  ...
  check_size<sizeof(EditColorSchemeController), 80 + sizeof(void*) + ((80 + sizeof(void*)) % 8 != 0 ? (8 - (80 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_EditColorSchemeControllerSizeCheck;
}
