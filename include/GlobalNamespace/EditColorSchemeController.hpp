...
namespace GlobalNamespace {
  ...
  class EditColorSchemeController : public UnityEngine::MonoBehaviour {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDCC7E0
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDCC7F0
    ...
    static EditColorSchemeController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("EditColorSchemeController").WithContext(".ctor");
