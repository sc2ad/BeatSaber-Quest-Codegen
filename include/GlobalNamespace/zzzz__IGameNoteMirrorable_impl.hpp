...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType (::GlobalNamespace::IGameNoteMirrorable::*)()>(&::GlobalNamespace::IGameNoteMirrorable::get_gameplayType)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::NoteVisualModifierType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType ::GlobalNamespace::IGameNoteMirrorable::get_gameplayType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::IGameNoteMirrorable>::get(),
                            "get_gameplayType",
                            std::vector<Il2CppClass*>{},
