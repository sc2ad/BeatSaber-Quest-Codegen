...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method, path);
 ...
 GlobalNamespace::SliderMeshConstructorCrossedStrips GlobalNamespace::SliderMeshConstructorCrossedStrips::New_ctor()  {
GlobalNamespace::SliderMeshConstructorCrossedStrips o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::SliderMeshConstructorCrossedStrips>())};
return o;
}
