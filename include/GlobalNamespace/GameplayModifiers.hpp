...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [PreserveAttribute] Offset: CFF16C
  class GameplayModifiers : public ::Il2CppObject/*, public LiteNetLib::Utils::INetImmutableSerializable_1<GlobalNamespace::GameplayModifiers*>*/ {
    ...
    // Offset: 0x21069DC
    GlobalNamespace::GameplayModifiers* LiteNetLib_Utils_INetImmutableSerializable$GameplayModifiers$_CreateFromSerializedData_NEW(LiteNetLib::Utils::NetDataReader* reader);
