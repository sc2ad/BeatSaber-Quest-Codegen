...
namespace GlobalNamespace {
  ...
  class GameplayModifiers : public ::Il2CppObject/*, public LiteNetLib::Utils::INetImmutableSerializable_1<GlobalNamespace::GameplayModifiers*>*/ {
    ...
    check_size<sizeof(GameplayModifiers::EnabledObstacleType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_GameplayModifiers_EnabledObstacleTypeSizeCheck;
    ...
    check_size<sizeof(GameplayModifiers::EnergyType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_GameplayModifiers_EnergyTypeSizeCheck;
    ...
    check_size<sizeof(GameplayModifiers::SongSpeed), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_GameplayModifiers_SongSpeedSizeCheck;
  ...
  check_size<sizeof(GameplayModifiers), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_GameplayModifiersSizeCheck;
}
