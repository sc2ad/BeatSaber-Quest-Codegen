...
namespace GlobalNamespace {
  ...
  class LightGroupSO : public ::GlobalNamespace::PersistentScriptableObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0x10FB1C8
    ...
    // [TextAreaAttribute] Offset: 0x10FB214
    // [TooltipAttribute] Offset: 0x10FB214
