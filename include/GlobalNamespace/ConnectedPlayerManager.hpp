...
namespace GlobalNamespace {
  ...
  class ConnectedPlayerManager : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    ...
    class PongPacket;
    // Nested type: ::GlobalNamespace::ConnectedPlayerManager::$InitializePlayerEncryption$d__126
    struct $InitializePlayerEncryption$d__126;
    // Size: 0x1
    #pragma pack(push, 1)
  ...
  #pragma pack(pop)
  static check_size<sizeof(ConnectedPlayerManager), 328 + sizeof(::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::ConnectedPlayerManager::InternalMessageType, ::GlobalNamespace::IConnectedPlayer*>*)> __GlobalNamespace_ConnectedPlayerManagerSizeCheck;
  static_assert(sizeof(ConnectedPlayerManager) == 0x150);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ConnectedPlayerManager::*)(::GlobalNamespace::IConnection*, ::LiteNetLib::Utils::NetDataReader*, ::LiteNetLib::DeliveryMethod)>(&GlobalNamespace::ConnectedPlayerManager::HandleNetworkReceive)> {
  static const MethodInfo* get() {
    static auto* connection = &::il2cpp_utils::GetClassFromName("", "IConnection")->byval_arg;
