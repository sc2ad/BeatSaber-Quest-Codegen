...
namespace GlobalNamespace {
  ...
  class ConnectedPlayerManager : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    // Nested type: GlobalNamespace::ConnectedPlayerManager::$InitializePlayerEncryption$d__128
    ...
    // Size: 0x8
    // Offset: 0x128
    ::Array<uint8_t>* encryptionRandom;
    // Field size check
    ...
    ::Array<uint8_t>*& dyn__encryptionRandom();
    ...
    void SendToPlayer(T message, GlobalNamespace::IConnectedPlayer* player) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      auto ___instance_arg = this;
      ::il2cpp_utils::RunMethodThrow<void, false>(___instance_arg, ___generic__method, message, player);
    }
