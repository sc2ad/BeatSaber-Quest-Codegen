...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::AnimationStartParams GlobalNamespace::AnimationStartParams::New_ctor()  {
GlobalNamespace::AnimationStartParams o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::AnimationStartParams>())};
return o;
}
