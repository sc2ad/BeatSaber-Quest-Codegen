...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerIntroAnimationController), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerIntroAnimationControllerSizeCheck;
}
