...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR), 80 + sizeof(Valve::VR::ETextureType) + ((80 + sizeof(Valve::VR::ETextureType)) % 8 != 0 ? (8 - (80 + sizeof(Valve::VR::ETextureType)) % 8) : 0)> __GlobalNamespace_SteamVRSizeCheck;
}
