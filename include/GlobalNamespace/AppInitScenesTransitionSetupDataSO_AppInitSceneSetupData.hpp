...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AppInitScenesTransitionSetupDataSO::AppInitSceneSetupData), 16 + sizeof(GlobalNamespace::AppInitScenesTransitionSetupDataSO::AppInitOverrideStartType) + ((16 + sizeof(GlobalNamespace::AppInitScenesTransitionSetupDataSO::AppInitOverrideStartType)) % 8 != 0 ? (8 - (16 + sizeof(GlobalNamespace::AppInitScenesTransitionSetupDataSO::AppInitOverrideStartType)) % 8) : 0)> __GlobalNamespace_AppInitScenesTransitionSetupDataSO_AppInitSceneSetupDataSizeCheck;
}
