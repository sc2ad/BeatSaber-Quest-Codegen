...
constexpr void ::GlobalNamespace::BombExplosionEffect::__set__emitParams(::UnityEngine::____UnityEngine__ParticleSystem__EmitParams value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__EmitParams ::GlobalNamespace::BombExplosionEffect::__get__emitParams() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::BombExplosionEffect::__set__explosionPSEmitParams(::UnityEngine::____UnityEngine__ParticleSystem__EmitParams value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0xc0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__EmitParams ::GlobalNamespace::BombExplosionEffect::__get__explosionPSEmitParams() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0xc0>(this->::bs_hook::Il2CppWrapperType::instance);
}
