...
namespace GlobalNamespace {
  ...
  class SortExtensions : public ::Il2CppObject {
    ...
    static void InsertSorted(System::Collections::Generic::List_1<T>* list, T item, System::Func_2<T, int>* getSortIndex) {
      ...
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, item, getSortIndex);
    }
    ...
    static void Sort(System::Collections::Generic::List_1<T>* list, System::Func_2<T, int>* getSortIndex) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list, getSortIndex);
    }
  }; // SortExtensions
  #pragma pack(pop)
}
