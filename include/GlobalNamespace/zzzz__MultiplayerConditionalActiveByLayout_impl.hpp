...
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition  ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition::ShowIf{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition  ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition::HideIf{1};
...
constexpr void ::GlobalNamespace::MultiplayerConditionalActiveByLayout::__set__condition(::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition ::GlobalNamespace::MultiplayerConditionalActiveByLayout::__get__condition() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
