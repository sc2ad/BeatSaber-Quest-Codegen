...
static GlobalNamespace::FixedUpdateSmoothValue_1<UnityEngine::Vector3> New_ctor(float_t smooth) ;
...
static GlobalNamespace::FixedUpdateSmoothValue_1<T> New_ctor(float_t smooth) ;
