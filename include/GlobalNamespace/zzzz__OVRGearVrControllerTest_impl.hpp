...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRGearVrControllerTest::*)()>(&GlobalNamespace::OVRGearVrControllerTest::_ctor)> {
