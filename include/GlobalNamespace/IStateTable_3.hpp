...
namespace GlobalNamespace {
  ...
  class IStateTable_3 {
    ...
    TStateTable GetDelta(ByRef<TStateTable> stateTable) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<TStateTable, false>(this, ___internal__method, byref(stateTable))));
    }
    ...
    TStateTable ApplyDelta(ByRef<TStateTable> delta) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<TStateTable, false>(this, ___internal__method, byref(delta))));
    }
