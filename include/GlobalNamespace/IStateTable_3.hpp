...
namespace GlobalNamespace {
  ...
  class IStateTable_3 {
    ...
    TStateTable GetDelta(ByRef<TStateTable> stateTable) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<TStateTable, false>(___instance_arg, ___internal__method, byref(stateTable));
    }
    ...
    TStateTable ApplyDelta(ByRef<TStateTable> delta) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<TStateTable, false>(___instance_arg, ___internal__method, byref(delta));
    }
