...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ConnectedPlayerManager::PlayerLatencyPacket), 16 + sizeof(float) + 8 - (16 + sizeof(float)) % 8> __GlobalNamespace_ConnectedPlayerManager_PlayerLatencyPacketSizeCheck;
}
