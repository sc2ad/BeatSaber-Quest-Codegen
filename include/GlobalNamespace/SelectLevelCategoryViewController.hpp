...
namespace GlobalNamespace {
  ...
  class SelectLevelCategoryViewController : public HMUI::ViewController {
    ...
    check_size<sizeof(SelectLevelCategoryViewController::LevelCategory), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_SelectLevelCategoryViewController_LevelCategorySizeCheck;
  ...
  check_size<sizeof(SelectLevelCategoryViewController), 144 + sizeof(void*) + ((144 + sizeof(void*)) % 8 != 0 ? (8 - (144 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_SelectLevelCategoryViewControllerSizeCheck;
}
