...
namespace GlobalNamespace {
  ...
  struct LeaderboardsModelLegacyWrapper::$SendLevelScoreResutlAsync$d__6 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
