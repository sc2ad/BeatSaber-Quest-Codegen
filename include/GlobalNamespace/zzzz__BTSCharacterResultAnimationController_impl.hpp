...
// Ctor Parameters []
 ::GlobalNamespace::BTSCharacterResultAnimationController::BTSCharacterResultAnimationController()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<BTSCharacterResultAnimationController>())) {}
