...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BlurredCoverImageView::$SetTextureAsync$d__6), 64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<UnityEngine::Sprite*>) + ((64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<UnityEngine::Sprite*>)) % 8 != 0 ? (8 - (64 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<UnityEngine::Sprite*>)) % 8) : 0)> __GlobalNamespace_BlurredCoverImageView_$SetTextureAsync$d__6SizeCheck;
}
