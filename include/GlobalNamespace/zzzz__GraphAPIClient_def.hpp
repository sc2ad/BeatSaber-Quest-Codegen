...
struct ____GlobalNamespace__GraphAPIClient___Post_d__4_2;
}
namespace GlobalNamespace {
template<typename TResponse>
struct ____GlobalNamespace__GraphAPIClient___Post_d__5_1;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__GraphAPIClient__PostOptions;
}
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TRequest,::cordl_internals::il2cpp_reference_type TResponse>
struct ____GlobalNamespace__GraphAPIClient___Post_d__4_2<TRequest,TResponse>;
}
namespace GlobalNamespace {
template<>
struct ____GlobalNamespace__GraphAPIClient___Post_d__4_2<::BGNet::Core::GameLift::GetMultiplayerInstanceRequest,::BGNet::Core::GameLift::GetMultiplayerInstanceResponse>;
}
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type TResponse>
struct ____GlobalNamespace__GraphAPIClient___Post_d__5_1<TResponse>;
}
namespace GlobalNamespace {
template<>
struct ____GlobalNamespace__GraphAPIClient___Post_d__5_1<::BGNet::Core::GameLift::GetMultiplayerInstanceResponse>;
}
// Type: ::PostOptions
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ____GlobalNamespace__GraphAPIClient__PostOptions : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__GraphAPIClient__PostOptions(int32_t MaxRetries, int32_t MinWaitTimeForRetryMs, bool WithExponentialBackoff) noexcept;


                    constexpr ____GlobalNamespace__GraphAPIClient__PostOptions(____GlobalNamespace__GraphAPIClient__PostOptions const&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient__PostOptions(____GlobalNamespace__GraphAPIClient__PostOptions&&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient__PostOptions& operator=(____GlobalNamespace__GraphAPIClient__PostOptions const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__GraphAPIClient__PostOptions& operator=(____GlobalNamespace__GraphAPIClient__PostOptions&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__GraphAPIClient__PostOptions(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Declarations
template<typename TResponse>
using _Post_d__5_1 = ::GlobalNamespace::____GlobalNamespace__GraphAPIClient___Post_d__5_1<TResponse>;

template<typename TRequest,typename TResponse>
using _Post_d__4_2 = ::GlobalNamespace::____GlobalNamespace__GraphAPIClient___Post_d__4_2<TRequest, TResponse>;

using PostOptions = ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions;
...
explicit GraphAPIClient(::GlobalNamespace::INetworkConfig networkConfig) ;
...
template<typename TRequest,typename TResponse>
 ::System::Threading::Tasks::Task_1<TResponse> PostLoggedOut(::StringW path, TRequest request, ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions postOptions, ::System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Post addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename TRequest,typename TResponse>
 ::System::Threading::Tasks::Task_1<TResponse> Post(::StringW path, ::StringW accessToken, TRequest request, ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions postOptions, ::System::Threading::CancellationToken cancellationToken) ;
...
static int32_t CalculateDelayMsBeforeRetry(int32_t numAttempts, ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions postOptions) ;
...
struct CORDL_TYPE ____GlobalNamespace__GraphAPIClient___Post_d__4_2<TRequest,TResponse> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResponse>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::GraphAPIClient", modifiers: "", def_value: None }, CppParam { name: "path", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "request", ty: "TRequest", modifiers: "", def_value: None }, CppParam { name: "accessToken", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "postOptions", ty: "::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions", modifiers: "", def_value: None }, CppParam { name: "_uriBuilder_5__2", ty: "::System::UriBuilder", modifiers: "", def_value: None }, CppParam { name: "_httpContent_5__3", ty: "::System::Net::Http::HttpContent", modifiers: "", def_value: None }, CppParam { name: "_numAttempts_5__4", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<TResponse>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__GraphAPIClient___Post_d__4_2(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResponse> __t__builder, ::GlobalNamespace::GraphAPIClient __4__this, ::StringW path, TRequest request, ::StringW accessToken, ::System::Threading::CancellationToken cancellationToken, ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions postOptions, ::System::UriBuilder _uriBuilder_5__2, ::System::Net::Http::HttpContent _httpContent_5__3, int32_t _numAttempts_5__4, ::System::Runtime::CompilerServices::TaskAwaiter_1<TResponse> __u__1, ::System::Runtime::CompilerServices::TaskAwaiter __u__2) noexcept;


                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__4_2(____GlobalNamespace__GraphAPIClient___Post_d__4_2 const&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__4_2(____GlobalNamespace__GraphAPIClient___Post_d__4_2&&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__4_2& operator=(____GlobalNamespace__GraphAPIClient___Post_d__4_2 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__4_2& operator=(____GlobalNamespace__GraphAPIClient___Post_d__4_2&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GraphAPIClient___Post_d__4_2(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::System::Threading::CancellationToken __get_cancellationToken() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions __declspec(property(get=__get_postOptions, put=__set_postOptions))  postOptions;

constexpr void __set_postOptions(::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions __get_postOptions() const;
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(12712))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12712), inst: 86 })
// CS Name: GraphAPIClient::<Post>d__4`2
struct CORDL_TYPE ____GlobalNamespace__GraphAPIClient___Post_d__4_2<::BGNet::Core::GameLift::GetMultiplayerInstanceRequest,::BGNet::Core::GameLift::GetMultiplayerInstanceResponse> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGNet::Core::GameLift::GetMultiplayerInstanceResponse>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::GraphAPIClient", modifiers: "", def_value: None }, CppParam { name: "path", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "request", ty: "::BGNet::Core::GameLift::GetMultiplayerInstanceRequest", modifiers: "", def_value: None }, CppParam { name: "accessToken", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "postOptions", ty: "::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions", modifiers: "", def_value: None }, CppParam { name: "_uriBuilder_5__2", ty: "::System::UriBuilder", modifiers: "", def_value: None }, CppParam { name: "_httpContent_5__3", ty: "::System::Net::Http::HttpContent", modifiers: "", def_value: None }, CppParam { name: "_numAttempts_5__4", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::BGNet::Core::GameLift::GetMultiplayerInstanceResponse>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
...
struct CORDL_TYPE ____GlobalNamespace__GraphAPIClient___Post_d__5_1<TResponse> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr ____GlobalNamespace__GraphAPIClient___Post_d__5_1(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<TResponse> __t__builder, ::System::Uri uri, ::StringW accessToken, ::System::Net::Http::HttpContent httpContent, ::GlobalNamespace::GraphAPIClient __4__this, ::System::Threading::CancellationToken cancellationToken, ::System::Net::Http::HttpRequestMessage _requestMessage_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Net::Http::HttpResponseMessage> __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::StringW> __u__2) noexcept;


                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__5_1(____GlobalNamespace__GraphAPIClient___Post_d__5_1 const&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__5_1(____GlobalNamespace__GraphAPIClient___Post_d__5_1&&) = default;
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__5_1& operator=(____GlobalNamespace__GraphAPIClient___Post_d__5_1 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__GraphAPIClient___Post_d__5_1& operator=(____GlobalNamespace__GraphAPIClient___Post_d__5_1&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GraphAPIClient___Post_d__5_1(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// CS Name: GraphAPIClient::<Post>d__5`1
struct CORDL_TYPE ____GlobalNamespace__GraphAPIClient___Post_d__5_1<::BGNet::Core::GameLift::GetMultiplayerInstanceResponse> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::GlobalNamespace::____GlobalNamespace__GraphAPIClient___Post_d__4_2, "", "GraphAPIClient/<Post>d__4`2");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::GlobalNamespace::____GlobalNamespace__GraphAPIClient___Post_d__5_1, "", "GraphAPIClient/<Post>d__5`1");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GraphAPIClient__PostOptions, "", "GraphAPIClient/PostOptions");
