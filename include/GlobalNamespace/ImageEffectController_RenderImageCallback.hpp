...
namespace GlobalNamespace {
  ...
  class ImageEffectController::RenderImageCallback : public System::MulticastDelegate {
    ...
    // Offset: 0x1CDD27C
    void Invoke_NEW(UnityEngine::RenderTexture* src, UnityEngine::RenderTexture* dest);
    ...
    // Offset: 0x1CDD67C
    System::IAsyncResult* BeginInvoke_NEW(UnityEngine::RenderTexture* src, UnityEngine::RenderTexture* dest, System::AsyncCallback* callback, ::Il2CppObject* object);
