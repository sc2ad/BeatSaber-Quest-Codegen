...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AnnotatedBeatmapLevelCollectionsTableView), 100 + sizeof(int) + 8 - (100 + sizeof(int)) % 8> __GlobalNamespace_AnnotatedBeatmapLevelCollectionsTableViewSizeCheck;
}
