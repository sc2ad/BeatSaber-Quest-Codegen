...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AnnotatedBeatmapLevelCollectionsTableView), 100 + sizeof(int) + ((100 + sizeof(int)) % 8 != 0 ? (8 - (100 + sizeof(int)) % 8) : 0)> __GlobalNamespace_AnnotatedBeatmapLevelCollectionsTableViewSizeCheck;
}
