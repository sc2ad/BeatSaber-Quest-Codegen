...
namespace GlobalNamespace {
  ...
  class MultiplayerOutroAnimationController : public UnityEngine::MonoBehaviour {
    ...
    static MultiplayerOutroAnimationController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerOutroAnimationController").WithContext(".ctor");
