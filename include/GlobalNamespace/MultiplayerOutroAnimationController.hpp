...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerOutroAnimationController), 72 + sizeof(void*) + ((72 + sizeof(void*)) % 8 != 0 ? (8 - (72 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerOutroAnimationControllerSizeCheck;
}
