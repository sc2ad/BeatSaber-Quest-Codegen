...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionClearedEnvironmentEffect::*)()>(&::GlobalNamespace::MissionClearedEnvironmentEffect::Awake)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionClearedEnvironmentEffect>::get(),
                            "Awake",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionClearedEnvironmentEffect::*)()>(&::GlobalNamespace::MissionClearedEnvironmentEffect::OnDestroy)> {
  constexpr static std::size_t size = 0x8c;
  constexpr static std::size_t addrs = 0x2264644;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionClearedEnvironmentEffect::*)()>(&::GlobalNamespace::MissionClearedEnvironmentEffect::HandleMissionObjectiveCheckersManagerObjectiveWasCleared)> {
  ...
  constexpr static std::size_t addrs = 0x22646d0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionClearedEnvironmentEffect::*)()>(&::GlobalNamespace::MissionClearedEnvironmentEffect::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x226474c;
...
constexpr ::GlobalNamespace::MissionObjectiveCheckersManager ::GlobalNamespace::MissionClearedEnvironmentEffect::__get__missionObjectiveCheckersManager() const {
...
constexpr ::GlobalNamespace::BeatmapCallbacksController ::GlobalNamespace::MissionClearedEnvironmentEffect::__get__beatmapCallbacksController() const {
...
// Ctor Parameters []
 ::GlobalNamespace::MissionClearedEnvironmentEffect::MissionClearedEnvironmentEffect()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<MissionClearedEnvironmentEffect>())) {}
 void ::GlobalNamespace::MissionClearedEnvironmentEffect::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionClearedEnvironmentEffect>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
