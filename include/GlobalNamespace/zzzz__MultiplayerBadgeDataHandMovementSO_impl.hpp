...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(instance), ___internal_method, result);
 ...
 GlobalNamespace::MultiplayerBadgeDataHandMovementSO GlobalNamespace::MultiplayerBadgeDataHandMovementSO::New_ctor()  {
GlobalNamespace::MultiplayerBadgeDataHandMovementSO o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MultiplayerBadgeDataHandMovementSO>())};
return o;
}
