...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OpenVRButton), 0 + sizeof(uint64_t) + ((0 + sizeof(uint64_t)) % 8 != 0 ? (8 - (0 + sizeof(uint64_t)) % 8) : 0)> __GlobalNamespace_OVRInput_OpenVRButtonSizeCheck;
}
