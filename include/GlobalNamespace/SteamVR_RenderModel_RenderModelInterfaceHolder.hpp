...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_RenderModel::RenderModelInterfaceHolder), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __GlobalNamespace_SteamVR_RenderModel_RenderModelInterfaceHolderSizeCheck;
}
