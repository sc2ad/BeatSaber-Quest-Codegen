...
namespace GlobalNamespace {
  ...
  class OVRMeshRenderer : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRMeshRenderer::ConfidenceBehavior), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRMeshRenderer_ConfidenceBehaviorSizeCheck;
    ...
    check_size<sizeof(OVRMeshRenderer::SystemGestureBehavior), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRMeshRenderer_SystemGestureBehaviorSizeCheck;
  ...
  check_size<sizeof(OVRMeshRenderer), 83 + sizeof(bool) + ((83 + sizeof(bool)) % 8 != 0 ? (8 - (83 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRMeshRendererSizeCheck;
}
