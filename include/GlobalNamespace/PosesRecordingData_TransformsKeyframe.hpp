...
namespace GlobalNamespace {
  ...
  class PosesRecordingData::TransformsKeyframe : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x10
    ::Array<GlobalNamespace::PosesRecordingData::Pose>* poses;
    // Field size check
    static_assert(sizeof(::Array<GlobalNamespace::PosesRecordingData::Pose>*) == 0x8);
    ...
    // Creating value type constructor for type: TransformsKeyframe
    TransformsKeyframe(::Array<GlobalNamespace::PosesRecordingData::Pose>* poses_ = {}, float time_ = {}) noexcept : poses{poses_}, time{time_} {}
    // Get instance field reference: public readonly PosesRecordingData/Pose[] poses
    ::Array<GlobalNamespace::PosesRecordingData::Pose>*& dyn_poses();
    ...
    static PosesRecordingData::TransformsKeyframe* New_ctor(::Array<GlobalNamespace::PosesRecordingData::Pose>* poses, float time) {
