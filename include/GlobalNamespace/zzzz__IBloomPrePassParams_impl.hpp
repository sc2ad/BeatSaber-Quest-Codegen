...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::TextureEffectSO (GlobalNamespace::IBloomPrePassParams::*)()>(&GlobalNamespace::IBloomPrePassParams::get_textureEffect)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::IBloomPrePassParams),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::IBloomPrePassParams::*)()>(&GlobalNamespace::IBloomPrePassParams::get_textureWidth)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::IBloomPrePassParams::*)()>(&GlobalNamespace::IBloomPrePassParams::get_textureHeight)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::IBloomPrePassParams::*)()>(&GlobalNamespace::IBloomPrePassParams::get_linesWidth)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::TextureEffectSO, false>(const_cast<void*>(instance), ___internal_method);
}
 int32_t GlobalNamespace::IBloomPrePassParams::get_textureWidth()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::IBloomPrePassParams>::get(),
                            "get_textureWidth",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t GlobalNamespace::IBloomPrePassParams::get_textureHeight()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::IBloomPrePassParams>::get(),
                            "get_textureHeight",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Vector2, false>(const_cast<void*>(instance), ___internal_method);
 ...
 float_t GlobalNamespace::IBloomPrePassParams::get_linesWidth()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::IBloomPrePassParams>::get(),
                            "get_linesWidth",
                            std::vector<Il2CppClass*>{},
