...
namespace GlobalNamespace {
  ...
  class SoloModeSelectionViewController : public HMUI::ViewController {
    ...
    check_size<sizeof(SoloModeSelectionViewController::MenuType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_SoloModeSelectionViewController_MenuTypeSizeCheck;
  ...
  check_size<sizeof(SoloModeSelectionViewController), 144 + sizeof(void*) + ((144 + sizeof(void*)) % 8 != 0 ? (8 - (144 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_SoloModeSelectionViewControllerSizeCheck;
}
