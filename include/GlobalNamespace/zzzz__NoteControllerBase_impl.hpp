...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::INoteControllerDidInitEvent> (GlobalNamespace::NoteControllerBase::*)()>(&GlobalNamespace::NoteControllerBase::get_didInitEvent)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::NoteControllerBase),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::NoteControllerBase::*)()>(&GlobalNamespace::NoteControllerBase::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x223f7a8;
...
// Ctor Parameters []
 GlobalNamespace::NoteControllerBase::NoteControllerBase()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<NoteControllerBase>())) {}
 void GlobalNamespace::NoteControllerBase::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::NoteControllerBase>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
