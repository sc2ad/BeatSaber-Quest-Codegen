...
namespace GlobalNamespace {
  ...
  class TextFadeTransitions : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(TextFadeTransitions::State), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_TextFadeTransitions_StateSizeCheck;
  ...
  check_size<sizeof(TextFadeTransitions), 56 + sizeof(float) + ((56 + sizeof(float)) % 8 != 0 ? (8 - (56 + sizeof(float)) % 8) : 0)> __GlobalNamespace_TextFadeTransitionsSizeCheck;
}
