...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BaseMasterServerReliableResponse), 20 + sizeof(uint) + ((20 + sizeof(uint)) % 8 != 0 ? (8 - (20 + sizeof(uint)) % 8) : 0)> __GlobalNamespace_BaseMasterServerReliableResponseSizeCheck;
}
