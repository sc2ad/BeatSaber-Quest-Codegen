...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::BaseMasterServerReliableResponse::*)()>(&GlobalNamespace::BaseMasterServerReliableResponse::get_resultCodeString)> {
  static const MethodInfo* get() {
