...
namespace GlobalNamespace {
  ...
  class CachedMediaAsyncLoader : public UnityEngine::MonoBehaviour/*, public GlobalNamespace::ISpriteAsyncLoader*/ {
    ...
    CachedMediaAsyncLoader(int maxNumberOfSpriteCachedElements_ = {}, GlobalNamespace::AsyncCachedLoader_2<::Il2CppString*, UnityEngine::Sprite*>* spriteAsyncCachedLoader_ = {}) noexcept : maxNumberOfSpriteCachedElements{maxNumberOfSpriteCachedElements_}, spriteAsyncCachedLoader{spriteAsyncCachedLoader_} {}
