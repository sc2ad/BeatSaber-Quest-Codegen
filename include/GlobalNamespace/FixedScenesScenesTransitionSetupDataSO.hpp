...
namespace GlobalNamespace {
  ...
  check_size<sizeof(FixedScenesScenesTransitionSetupDataSO), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_FixedScenesScenesTransitionSetupDataSOSizeCheck;
}
