...
namespace GlobalNamespace {
  ...
  class PlayerSaveDataV1_0_1::GameplayModifiers : public ::Il2CppObject {
    ...
    check_size<sizeof(PlayerSaveDataV1_0_1::GameplayModifiers::EnabledObstacleType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PlayerSaveDataV1_0_1_GameplayModifiers_EnabledObstacleTypeSizeCheck;
    ...
    check_size<sizeof(PlayerSaveDataV1_0_1::GameplayModifiers::EnergyType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PlayerSaveDataV1_0_1_GameplayModifiers_EnergyTypeSizeCheck;
    ...
    check_size<sizeof(PlayerSaveDataV1_0_1::GameplayModifiers::SongSpeed), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PlayerSaveDataV1_0_1_GameplayModifiers_SongSpeedSizeCheck;
  ...
  check_size<sizeof(PlayerSaveDataV1_0_1::GameplayModifiers), 32 + sizeof(GlobalNamespace::PlayerSaveDataV1_0_1::GameplayModifiers::SongSpeed) + ((32 + sizeof(GlobalNamespace::PlayerSaveDataV1_0_1::GameplayModifiers::SongSpeed)) % 8 != 0 ? (8 - (32 + sizeof(GlobalNamespace::PlayerSaveDataV1_0_1::GameplayModifiers::SongSpeed)) % 8) : 0)> __GlobalNamespace_PlayerSaveDataV1_0_1_GameplayModifiersSizeCheck;
}
