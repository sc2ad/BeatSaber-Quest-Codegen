...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRMeshRenderer::MeshRendererData), 2 + sizeof(bool) + ((2 + sizeof(bool)) % 8 != 0 ? (8 - (2 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRMeshRenderer_MeshRendererDataSizeCheck;
}
