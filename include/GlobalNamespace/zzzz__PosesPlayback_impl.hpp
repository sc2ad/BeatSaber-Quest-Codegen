...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::PosesPlayback GlobalNamespace::PosesPlayback::New_ctor()  {
GlobalNamespace::PosesPlayback o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::PosesPlayback>())};
return o;
}
