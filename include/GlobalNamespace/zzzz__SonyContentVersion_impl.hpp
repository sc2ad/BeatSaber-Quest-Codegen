...
constexpr ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat::____GlobalNamespace__SonyContentVersion__VersionFormat(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat  ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat::Long{0};
constexpr ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat  ::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat::Short{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::SonyContentVersion::*)(::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat)>(&::GlobalNamespace::SonyContentVersion::Get)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Get",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, versionString);
 ...
 ::StringW ::GlobalNamespace::SonyContentVersion::Get(::GlobalNamespace::____GlobalNamespace__SonyContentVersion__VersionFormat versionFormat)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SonyContentVersion>::get(),
                            "Get",
                            std::vector<Il2CppClass*>{},
