...
namespace GlobalNamespace {
  ...
  class BeatmapCallbackItemDataList::SpawnBombNoteCallback : public System::MulticastDelegate {
    ...
    // Offset: 0x1066A28
    void Invoke_NEW(GlobalNamespace::NoteData* noteData);
    // public System.IAsyncResult BeginInvoke(NoteData noteData, System.AsyncCallback callback, System.Object object)
    // Offset: 0x10679C4
    System::IAsyncResult* BeginInvoke_NEW(GlobalNamespace::NoteData* noteData, System::AsyncCallback* callback, ::Il2CppObject* object);
