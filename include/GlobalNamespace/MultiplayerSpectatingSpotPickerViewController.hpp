...
namespace GlobalNamespace {
  ...
  class MultiplayerSpectatingSpotPickerViewController : public UnityEngine::MonoBehaviour {
    ...
    // [InjectAttribute] Offset: 0xDC8268
    ...
    static MultiplayerSpectatingSpotPickerViewController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerSpectatingSpotPickerViewController").WithContext(".ctor");
