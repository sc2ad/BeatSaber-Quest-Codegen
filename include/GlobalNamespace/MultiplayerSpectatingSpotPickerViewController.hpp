...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerSpectatingSpotPickerViewController), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerSpectatingSpotPickerViewControllerSizeCheck;
}
