...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatmapDataSO::$$c__DisplayClass2_0), 40 + sizeof(::GlobalNamespace::EnvironmentInfoSO*)> __GlobalNamespace_BeatmapDataSO_$$c__DisplayClass2_0SizeCheck;
  static_assert(sizeof(BeatmapDataSO::$$c__DisplayClass2_0) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
