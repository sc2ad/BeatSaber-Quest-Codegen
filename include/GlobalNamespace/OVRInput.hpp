...
namespace GlobalNamespace {
  ...
  class OVRInput : public ::CsObject {
    public:
    ...
    // Offset: 0xE5D030
    static ::CsString* GetOpenVRStringProperty(OVR::OpenVR::ETrackedDeviceProperty prop, uint deviceId);
