...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ConditionalImageMaterialSwitcher::*)()>(&GlobalNamespace::ConditionalImageMaterialSwitcher::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2115644;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ConditionalImageMaterialSwitcher>::get(),
                            "Awake",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ConditionalImageMaterialSwitcher::*)()>(&GlobalNamespace::ConditionalImageMaterialSwitcher::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21156c4;
...
constexpr UnityEngine::Material GlobalNamespace::ConditionalImageMaterialSwitcher::__get__material0() const {
...
constexpr UnityEngine::Material GlobalNamespace::ConditionalImageMaterialSwitcher::__get__material1() const {
...
constexpr GlobalNamespace::BoolSO GlobalNamespace::ConditionalImageMaterialSwitcher::__get__value() const {
...
constexpr UnityEngine::UI::Image GlobalNamespace::ConditionalImageMaterialSwitcher::__get__image() const {
...
// Ctor Parameters []
 GlobalNamespace::ConditionalImageMaterialSwitcher::ConditionalImageMaterialSwitcher()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<ConditionalImageMaterialSwitcher>())) {}
 void GlobalNamespace::ConditionalImageMaterialSwitcher::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ConditionalImageMaterialSwitcher>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
