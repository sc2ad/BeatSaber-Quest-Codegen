...
constexpr ::GlobalNamespace::AudioTimeSyncController __get__audioTimeSyncController() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__GoodCutScoringElement__Pool __declspec(property(get=__get__goodCutScoringElementPool, put=__set__goodCutScoringElementPool))  _goodCutScoringElementPool;

constexpr void __set__goodCutScoringElementPool(::GlobalNamespace::____GlobalNamespace__GoodCutScoringElement__Pool value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__GoodCutScoringElement__Pool __get__goodCutScoringElementPool() const;

 ::GlobalNamespace::____GlobalNamespace__BadCutScoringElement__Pool __declspec(property(get=__get__badCutScoringElementPool, put=__set__badCutScoringElementPool))  _badCutScoringElementPool;

constexpr void __set__badCutScoringElementPool(::GlobalNamespace::____GlobalNamespace__BadCutScoringElement__Pool value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__BadCutScoringElement__Pool __get__badCutScoringElementPool() const;

 ::GlobalNamespace::____GlobalNamespace__MissScoringElement__Pool __declspec(property(get=__get__missScoringElementPool, put=__set__missScoringElementPool))  _missScoringElementPool;

constexpr void __set__missScoringElementPool(::GlobalNamespace::____GlobalNamespace__MissScoringElement__Pool value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MissScoringElement__Pool __get__missScoringElementPool() const;
