...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PartyMessageHandler::ConnectToMasterServerMessage), 80 + sizeof(GlobalNamespace::GameplayServerConfiguration) + ((80 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8 != 0 ? (8 - (80 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8) : 0)> __GlobalNamespace_PartyMessageHandler_ConnectToMasterServerMessageSizeCheck;
}
