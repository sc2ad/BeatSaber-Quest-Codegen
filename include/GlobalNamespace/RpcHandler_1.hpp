...
namespace GlobalNamespace {
  ...
  class RpcHandler_1 : public ::Il2CppObject {
    ...
    class $$c__DisplayClass13_0_1 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_convertible_v<T, GlobalNamespace::RemoteProcedureCall*>));
      public:
    ...
    class $$c__DisplayClass14_0_2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_convertible_v<T, GlobalNamespace::RemoteProcedureCall_1<T0>*>));
      public:
      using declaring_type = RpcHandler_1<TType>*;
    ...
    class $$c__DisplayClass15_0_3 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_convertible_v<T, GlobalNamespace::RemoteProcedureCall_2<T0, T1>*>));
      public:
      using declaring_type = RpcHandler_1<TType>*;
    ...
    class $$c__DisplayClass16_0_4 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_convertible_v<T, GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>));
      public:
      using declaring_type = RpcHandler_1<TType>*;
    ...
    class $$c__DisplayClass17_0_5 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_convertible_v<T, GlobalNamespace::RemoteProcedureCall_4<T0, T1, T2, T3>*>));
      public:
      using declaring_type = RpcHandler_1<TType>*;
    ...
    class $$c__DisplayClass23_0_1 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TType>> || std::is_base_of_v<System::IConvertible, std::remove_pointer_t<TType>>) && (!std::is_complete_v<std::remove_pointer_t<TType>> || is_value_type_v<TType>));
      static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_base_of_v<GlobalNamespace::IRemoteProcedureCall, std::remove_pointer_t<T>>));
      public:
      using declaring_type = RpcHandler_1<TType>*;
    ...
    // Offset: 0x0
    GlobalNamespace::MultiplayerSessionManager::MessageType messageType;
    ...
    // Offset: 0xFFFFFFFF
    static RpcHandler_1<TType>* New_ctor(GlobalNamespace::IMultiplayerSessionManager* multiplayerSessionManager, GlobalNamespace::MultiplayerSessionManager::MessageType messageType, bool delayCallTime) {
