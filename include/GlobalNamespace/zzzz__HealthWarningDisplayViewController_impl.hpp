...
// Ctor Parameters []
 ::GlobalNamespace::HealthWarningDisplayViewController::HealthWarningDisplayViewController()  : ::HMUI::ViewController(THROW_UNLESS(::il2cpp_utils::New<HealthWarningDisplayViewController>())) {}
