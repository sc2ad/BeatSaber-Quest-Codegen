...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::*)()>(&::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::StartCountdown)> {
  ...
  constexpr static std::size_t addrs = 0x214bf5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::*)(bool)>(&::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::StopCountdown)> {
  ...
  constexpr static std::size_t addrs = 0x214c11c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t)>(&::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::Move)> {
  constexpr static std::size_t size = 0x13c;
  constexpr static std::size_t addrs = 0x214bfe0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::*)()>(&::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x214c1bc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::*)(::UnityEngine::Vector3)>(&::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::_Move_b__7_0)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x214c1c4;
...
constexpr ::UnityEngine::RectTransform ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::__get__nextLevelTransform() const {
...
constexpr ::UnityEngine::RectTransform ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::__get__nextLevelBasePosition() const {
...
constexpr ::UnityEngine::RectTransform ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::__get__nextLevelCountdownPosition() const {
...
constexpr float_t ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::__get__transitionDuration() const {
...
constexpr ::Tweening::TimeTweeningManager ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::__get__tweeningManager() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, instant);
 ...
 void ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::Move(::UnityEngine::Vector3 from, ::UnityEngine::Vector3 to, float_t duration)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator>::get(),
                            "Move",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator::_Move_b__7_0(::UnityEngine::Vector3 pos)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerLobbyCenterStageLayoutAnimator>::get(),
                            "<Move>b__7_0",
                            std::vector<Il2CppClass*>{},
