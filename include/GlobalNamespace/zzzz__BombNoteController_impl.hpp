...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)(::GlobalNamespace::NoteData, float_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, float_t, float_t)>(&::GlobalNamespace::BombNoteController::Init)> {
  constexpr static std::size_t size = 0xd4;
  constexpr static std::size_t addrs = 0x222edd0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2238d88;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::GlobalNamespace::BombNoteController),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BombNoteController>::get(),
                                  14
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x2238e88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::NoteDidPassMissedMarker)> {
  ...
  constexpr static std::size_t addrs = 0x2238f68;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::HandleDidPassHalfJump)> {
  ...
  constexpr static std::size_t addrs = 0x2238f9c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::NoteDidStartDissolving)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x2239258;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)(bool)>(&::GlobalNamespace::BombNoteController::HiddenStateDidChange)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x223927c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)(bool)>(&::GlobalNamespace::BombNoteController::Pause)> {
  ...
  constexpr static std::size_t addrs = 0x22392a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BombNoteController::*)()>(&::GlobalNamespace::BombNoteController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22392b0;
...
::cordl_internals::setInstanceField<::GlobalNamespace::CuttableBySaber, 0x80>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::CuttableBySaber>(value));
}
constexpr ::GlobalNamespace::CuttableBySaber ::GlobalNamespace::BombNoteController::__get__cuttableBySaber() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CuttableBySaber, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::UnityEngine::GameObject ::GlobalNamespace::BombNoteController::__get__wrapperGO() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void ::GlobalNamespace::BombNoteController::Init(::GlobalNamespace::NoteData noteData, float_t worldRotation, ::UnityEngine::Vector3 moveStartPos, ::UnityEngine::Vector3 moveEndPos, ::UnityEngine::Vector3 jumpEndPos, float_t moveDuration, float_t jumpDuration, float_t jumpGravity)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BombNoteController>::get(),
                            "Init",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool::*)()>(&::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x22392b8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{}
                        )));
...
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool::____GlobalNamespace__BombNoteController__Pool()  : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::BombNoteController>(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__BombNoteController__Pool>())) {}
 void ::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__BombNoteController__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
