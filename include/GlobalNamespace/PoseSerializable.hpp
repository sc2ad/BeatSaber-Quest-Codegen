...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PoseSerializable), 12 + sizeof(GlobalNamespace::QuaternionSerializable) + ((12 + sizeof(GlobalNamespace::QuaternionSerializable)) % 8 != 0 ? (8 - (12 + sizeof(GlobalNamespace::QuaternionSerializable)) % 8) : 0)> __GlobalNamespace_PoseSerializableSizeCheck;
}
