...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MirroredBombNoteController::*)()>(&GlobalNamespace::MirroredBombNoteController::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x223d4b4;
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__MirroredBombNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MirroredBombNoteController__Pool::*)()>(&GlobalNamespace::GlobalNamespace__MirroredBombNoteController__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x223d4fc;
