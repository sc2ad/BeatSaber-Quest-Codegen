...
namespace GlobalNamespace {
  ...
  check_size<sizeof(KawaseBlurRendererSO::BloomKernel), 20 + sizeof(int) + ((20 + sizeof(int)) % 8 != 0 ? (8 - (20 + sizeof(int)) % 8) : 0)> __GlobalNamespace_KawaseBlurRendererSO_BloomKernelSizeCheck;
}
