...
namespace GlobalNamespace {
  ...
  check_size<sizeof(StandardLevelInfoSaveData::DifficultyBeatmap), 44 + sizeof(float) + ((44 + sizeof(float)) % 8 != 0 ? (8 - (44 + sizeof(float)) % 8) : 0)> __GlobalNamespace_StandardLevelInfoSaveData_DifficultyBeatmapSizeCheck;
}
