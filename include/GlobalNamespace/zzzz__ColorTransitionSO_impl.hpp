...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::get_normalColor)> {
  ...
  constexpr static std::size_t addrs = 0x2128384;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::get_highlightedColor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x21285f4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::get_pressedColor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x212862c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::get_disabledColor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2128664;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Color (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::get_selectedColor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x212869c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ColorTransitionSO::*)()>(&GlobalNamespace::ColorTransitionSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2128ee0;
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__normalColor() const {
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__highlightedColor() const {
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__pressedColor() const {
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__disabledColor() const {
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__selectedColor() const {
...
constexpr GlobalNamespace::ColorSO GlobalNamespace::ColorTransitionSO::__get__selectedAndHighlightedColor() const {
...
// Ctor Parameters []
 GlobalNamespace::ColorTransitionSO::ColorTransitionSO()  : GlobalNamespace::BaseTransitionSO(THROW_UNLESS(::il2cpp_utils::New<ColorTransitionSO>())) {}
 void GlobalNamespace::ColorTransitionSO::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ColorTransitionSO>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
