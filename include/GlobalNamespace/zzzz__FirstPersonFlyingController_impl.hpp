...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x21929b0;
...
//  Writing Method size for method: GlobalNamespace::FirstPersonFlyingController.Start
template<>
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::Start)> {
  ...
  constexpr static std::size_t addrs = 0x21929bc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x2192bdc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::OnDisable)> {
  ...
  constexpr static std::size_t addrs = 0x2192c58;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::Update)> {
  ...
  constexpr static std::size_t addrs = 0x2192cb4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)(UnityEngine::Camera, GlobalNamespace::VRCenterAdjust, GlobalNamespace::VRController, GlobalNamespace::VRController, bool)>(&GlobalNamespace::FirstPersonFlyingController::Inject)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x21933b8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Inject",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<UnityEngine::Camera>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::VRCenterAdjust>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::VRController>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::VRController>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FirstPersonFlyingController::*)()>(&GlobalNamespace::FirstPersonFlyingController::_ctor)> {
  constexpr static std::size_t size = 0xa8;
  constexpr static std::size_t addrs = 0x21934e4;
...
constexpr float_t GlobalNamespace::FirstPersonFlyingController::__get__moveSensitivity() const {
...
constexpr UnityEngine::Transform GlobalNamespace::FirstPersonFlyingController::__get__transform() const {
...
constexpr UnityEngine::Camera GlobalNamespace::FirstPersonFlyingController::__get__camera() const {
...
constexpr float_t GlobalNamespace::FirstPersonFlyingController::__get__cameraFov() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::VRCenterAdjust, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::VRCenterAdjust>(value));
}
constexpr GlobalNamespace::VRCenterAdjust GlobalNamespace::FirstPersonFlyingController::__get__centerAdjust() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::VRCenterAdjust, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::FirstPersonFlyingController::__set__controller0(GlobalNamespace::VRController value)  {
::cordl_internals::setInstanceField<GlobalNamespace::VRController, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::VRController>(value));
}
constexpr GlobalNamespace::VRController GlobalNamespace::FirstPersonFlyingController::__get__controller0() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::VRController, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::FirstPersonFlyingController::__set__controller1(GlobalNamespace::VRController value)  {
::cordl_internals::setInstanceField<GlobalNamespace::VRController, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::VRController>(value));
}
constexpr GlobalNamespace::VRController GlobalNamespace::FirstPersonFlyingController::__get__controller1() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::VRController, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::FirstPersonFlyingController::__set__controllerModels(::ArrayW<UnityEngine::GameObject> value)  {
...
constexpr ::ArrayW<UnityEngine::GameObject> GlobalNamespace::FirstPersonFlyingController::__get__controllerModels() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::MouseLook, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::MouseLook>(value));
}
constexpr GlobalNamespace::MouseLook GlobalNamespace::FirstPersonFlyingController::__get__mouseLook() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::MouseLook, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr bool GlobalNamespace::FirstPersonFlyingController::__get__shouldBeEnabled() const {
...
constexpr UnityEngine::Transform GlobalNamespace::FirstPersonFlyingController::__get__cameraTransform() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void GlobalNamespace::FirstPersonFlyingController::Inject(UnityEngine::Camera camera, GlobalNamespace::VRCenterAdjust centerAdjust, GlobalNamespace::VRController controller0, GlobalNamespace::VRController controller1, bool shouldBeEnabled)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::FirstPersonFlyingController>::get(),
                            "Inject",
                            std::vector<Il2CppClass*>{},
