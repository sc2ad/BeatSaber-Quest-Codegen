...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_3 : public GlobalNamespace::RemoteProcedureCall {
    ...
    GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T0> _get__value0() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_get__value0");
    ...
    void _set__value0(GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T0> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_set__value0");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_value0"))->offset;
    ...
    GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T1> _get__value1() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_get__value1");
      auto ___internal__instance = this;
    ...
    void _set__value1(GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T1> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_set__value1");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_value1"))->offset;
    ...
    GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T2> _get__value2() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_get__value2");
      auto ___internal__instance = this;
    ...
    void _set__value2(GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T2> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_3::_set__value2");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_value2"))->offset;
