...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ConnectedPlayerManager::PlayerSortOrderPacket), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __GlobalNamespace_ConnectedPlayerManager_PlayerSortOrderPacketSizeCheck;
}
