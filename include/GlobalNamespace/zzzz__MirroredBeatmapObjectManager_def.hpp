...
/// @brief Method Init addr 0x2237324 size 0x438 virtual false final false
 void Init(GlobalNamespace::BeatmapObjectManager beatmapObjectManager, GlobalNamespace::GlobalNamespace__MirroredGameNoteController__Pool mirroredBasicGameNotePool, GlobalNamespace::GlobalNamespace__MirroredGameNoteController__Pool burstSliderHeadGameNotePool, GlobalNamespace::GlobalNamespace__MirroredGameNoteController__Pool burstSliderGameNotePool, GlobalNamespace::GlobalNamespace__MirroredGameNoteController__Pool burstSliderFillPool, GlobalNamespace::GlobalNamespace__MirroredBombNoteController__Pool mirroredBombNotePool, GlobalNamespace::GlobalNamespace__MirroredObstacleController__Pool mirroredObstaclePool, GlobalNamespace::GlobalNamespace__MirroredSliderController__Pool mirroredSlidersPool) ;
...
static GlobalNamespace::MirroredBeatmapObjectManager New_ctor() ;
