...
namespace GlobalNamespace {
  ...
  class INodePoseSyncStateManager : public ::Il2CppObject/*, public GlobalNamespace::INodePoseSyncStateManager_5<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState_NodePose, GlobalNamespace::PoseSerializable, GlobalNamespace::NodePoseSyncStateNetSerializable*, GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>*/ {
    public:
