...
namespace GlobalNamespace {
  ...
  class BloomPrePassBackgroundParticleSystemRenderer : public GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore {
    ...
    // Base method: UnityEngine.Renderer BloomPrePassBackgroundNonLightRendererCore::get_renderer_NEW()
    UnityEngine::Renderer* get_renderer();
    // protected override System.Void Awake()
    // Offset: 0x1CD9E1C
    // Implemented from: BloomPrePassBackgroundNonLightRendererCore
    // Base method: System.Void BloomPrePassBackgroundNonLightRendererCore::Awake_NEW()
    void Awake();
