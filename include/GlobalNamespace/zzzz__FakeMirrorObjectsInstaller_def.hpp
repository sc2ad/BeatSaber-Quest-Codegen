...
namespace GlobalNamespace {
class ____GlobalNamespace__FakeMirrorObjectsInstaller____c;
}
// Type: ::<>c
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__FakeMirrorObjectsInstaller____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____GlobalNamespace__FakeMirrorObjectsInstaller____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__FakeMirrorObjectsInstaller____c", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c(____GlobalNamespace__FakeMirrorObjectsInstaller____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__FakeMirrorObjectsInstaller____c", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c(____GlobalNamespace__FakeMirrorObjectsInstaller____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__FakeMirrorObjectsInstaller____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c& operator=(____GlobalNamespace__FakeMirrorObjectsInstaller____c&& o) noexcept = default;
  constexpr ____GlobalNamespace__FakeMirrorObjectsInstaller____c& operator=(____GlobalNamespace__FakeMirrorObjectsInstaller____c const& o) noexcept = default;
                


// Fields

static ::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c value) ;

static ::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c __get___9() ;
...
// Ctor Parameters []
explicit ____GlobalNamespace__FakeMirrorObjectsInstaller____c() ;
...
public:
// Declarations
using __c = ::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__FakeMirrorObjectsInstaller____c, "", "FakeMirrorObjectsInstaller/<>c");
