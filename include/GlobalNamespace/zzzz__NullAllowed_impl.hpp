...
constexpr ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context::____GlobalNamespace__NullAllowed__Context(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context  ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context::Everywhere{0};
constexpr ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context  ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context::Prefab{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NullAllowed::*)(::GlobalNamespace::____GlobalNamespace__NullAllowed__Context)>(&::GlobalNamespace::NullAllowed::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__NullAllowed__Context>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::NullAllowed::__set_context(::GlobalNamespace::____GlobalNamespace__NullAllowed__Context value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NullAllowed__Context, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NullAllowed__Context>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NullAllowed__Context ::GlobalNamespace::NullAllowed::__get_context() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NullAllowed__Context, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters [CppParam { name: "context", ty: "::GlobalNamespace::____GlobalNamespace__NullAllowed__Context", modifiers: "", def_value: None }]
 ::GlobalNamespace::NullAllowed::NullAllowed(::GlobalNamespace::____GlobalNamespace__NullAllowed__Context context)  : ::UnityEngine::PropertyAttribute(THROW_UNLESS(::il2cpp_utils::New<NullAllowed>(context))) {}
 void ::GlobalNamespace::NullAllowed::_ctor(::GlobalNamespace::____GlobalNamespace__NullAllowed__Context context)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NullAllowed>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
