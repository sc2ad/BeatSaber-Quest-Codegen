...
constexpr ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType  ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType::Early{1};
constexpr ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType  ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType::Late{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)(float_t, ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType, float_t)>(&::GlobalNamespace::SpawnRotationBeatmapEventData::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::SpawnRotationBeatmapEventData::__set_spawnRotationEventType(::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType ::GlobalNamespace::SpawnRotationBeatmapEventData::__get_spawnRotationEventType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters [CppParam { name: "time", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "spawnRotationEventType", ty: "::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType", modifiers: "", def_value: None }, CppParam { name: "deltaRotation", ty: "float_t", modifiers: "", def_value: None }]
 ::GlobalNamespace::SpawnRotationBeatmapEventData::SpawnRotationBeatmapEventData(float_t time, ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType spawnRotationEventType, float_t deltaRotation)  : ::GlobalNamespace::BeatmapEventData(THROW_UNLESS(::il2cpp_utils::New<SpawnRotationBeatmapEventData>(time, spawnRotationEventType, deltaRotation))) {}
 void ::GlobalNamespace::SpawnRotationBeatmapEventData::_ctor(float_t time, ::GlobalNamespace::____GlobalNamespace__SpawnRotationBeatmapEventData__SpawnRotationEventType spawnRotationEventType, float_t deltaRotation)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SpawnRotationBeatmapEventData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
