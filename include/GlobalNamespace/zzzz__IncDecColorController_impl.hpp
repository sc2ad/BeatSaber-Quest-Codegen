...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)(bool)>(&GlobalNamespace::IncDecColorController::set_enableDec)> {
  ...
  constexpr static std::size_t addrs = 0x2124ea0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)(bool)>(&GlobalNamespace::IncDecColorController::set_enableInc)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2124ec8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)(UnityEngine::Color)>(&GlobalNamespace::IncDecColorController::set_color)> {
  ...
  constexpr static std::size_t addrs = 0x2124ef0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)()>(&GlobalNamespace::IncDecColorController::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2124f1c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::IncDecColorController),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::IncDecColorController>::get(),
                                  4
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)()>(&GlobalNamespace::IncDecColorController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x2124fd4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::IncDecColorController::*)()>(&GlobalNamespace::IncDecColorController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21250d8;
...
constexpr void GlobalNamespace::IncDecColorController::__set__stepValuePicker(GlobalNamespace::ColorStepValuePicker value)  {
::cordl_internals::setInstanceField<GlobalNamespace::ColorStepValuePicker, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::ColorStepValuePicker>(value));
}
constexpr GlobalNamespace::ColorStepValuePicker GlobalNamespace::IncDecColorController::__get__stepValuePicker() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::ColorStepValuePicker, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 GlobalNamespace::IncDecColorController::IncDecColorController()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<IncDecColorController>())) {}
 void GlobalNamespace::IncDecColorController::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::IncDecColorController>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
