...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SliderSpawnInfoNetSerializable (*)()>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::Obtain)> {
  ...
  constexpr static std::size_t addrs = 0x121bee8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SliderSpawnInfoNetSerializable (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)(::GlobalNamespace::ColorType, ::GlobalNamespace::____GlobalNamespace__SliderData__Type, bool, float_t, int32_t, ::GlobalNamespace::NoteLineLayer, ::GlobalNamespace::NoteLineLayer, float_t, ::GlobalNamespace::NoteCutDirection, float_t, bool, float_t, int32_t, ::GlobalNamespace::NoteLineLayer, ::GlobalNamespace::NoteLineLayer, float_t, ::GlobalNamespace::NoteCutDirection, float_t, ::GlobalNamespace::SliderMidAnchorMode, int32_t, float_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, float_t, float_t, float_t)>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::Init)> {
  constexpr static std::size_t size = 0x244;
  constexpr static std::size_t addrs = 0x121bf4c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)()>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x121c190;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataWriter)>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::Serialize)> {
  ...
  constexpr static std::size_t addrs = 0x121c1e8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataReader)>(&::GlobalNamespace::SliderSpawnInfoNetSerializable::Deserialize)> {
  ...
  constexpr static std::size_t addrs = 0x121c420;
...
constexpr void ::GlobalNamespace::SliderSpawnInfoNetSerializable::__set_sliderType(::GlobalNamespace::____GlobalNamespace__SliderData__Type value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__SliderData__Type, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__SliderData__Type>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__SliderData__Type ::GlobalNamespace::SliderSpawnInfoNetSerializable::__get_sliderType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__SliderData__Type, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
