...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::ControllerState4), 95 + sizeof(uint8_t) + ((95 + sizeof(uint8_t)) % 8 != 0 ? (8 - (95 + sizeof(uint8_t)) % 8) : 0)> __GlobalNamespace_OVRPlugin_ControllerState4SizeCheck;
}
