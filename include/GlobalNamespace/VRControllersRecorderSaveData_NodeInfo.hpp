...
namespace GlobalNamespace {
  ...
  check_size<sizeof(VRControllersRecorderSaveData::NodeInfo), 20 + sizeof(int) + ((20 + sizeof(int)) % 8 != 0 ? (8 - (20 + sizeof(int)) % 8) : 0)> __GlobalNamespace_VRControllersRecorderSaveData_NodeInfoSizeCheck;
}
