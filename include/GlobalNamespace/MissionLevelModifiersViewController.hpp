...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MissionLevelModifiersViewController), 144 + sizeof(void*) + 8 - (144 + sizeof(void*)) % 8> __GlobalNamespace_MissionLevelModifiersViewControllerSizeCheck;
}
