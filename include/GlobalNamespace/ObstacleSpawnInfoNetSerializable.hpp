...
namespace GlobalNamespace {
  ...
  class ObstacleSpawnInfoNetSerializable : public ::Il2CppObject/*, public LiteNetLib::Utils::INetSerializable*/ {
    ...
    int& dyn_lineIndex();
    // Get instance field reference: public ObstacleType obstacleType
    ...
    float& dyn_rotation();
    // public System.Void .ctor(System.Single time, System.Int32 lineIndex, ObstacleType obstacleType, System.Single duration, System.Int32 width, UnityEngine.Vector3 moveStartPos, UnityEngine.Vector3 moveEndPos, UnityEngine.Vector3 jumpEndPos, System.Single obstacleHeight, System.Single moveDuration, System.Single jumpDuration, System.Single noteLinesDistance, System.Single rotation)
    // Offset: 0x2975ADC
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static ObstacleSpawnInfoNetSerializable* New_ctor(float time, int lineIndex, GlobalNamespace::ObstacleType obstacleType, float duration, int width, UnityEngine::Vector3 moveStartPos, UnityEngine::Vector3 moveEndPos, UnityEngine::Vector3 jumpEndPos, float obstacleHeight, float moveDuration, float jumpDuration, float noteLinesDistance, float rotation) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObstacleSpawnInfoNetSerializable::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ObstacleSpawnInfoNetSerializable*, creationType>(time, lineIndex, obstacleType, duration, width, moveStartPos, moveEndPos, jumpEndPos, obstacleHeight, moveDuration, jumpDuration, noteLinesDistance, rotation)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(ObstacleSpawnInfoNetSerializable), 88 + sizeof(float)> __GlobalNamespace_ObstacleSpawnInfoNetSerializableSizeCheck;
  static_assert(sizeof(ObstacleSpawnInfoNetSerializable) == 0x5C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
