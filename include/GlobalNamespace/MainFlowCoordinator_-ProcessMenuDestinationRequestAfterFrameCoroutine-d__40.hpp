...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: <ProcessMenuDestinationRequestAfterFrameCoroutine>d__40
  class $ProcessMenuDestinationRequestAfterFrameCoroutine$d__40;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(GlobalNamespace::MainFlowCoordinator::$ProcessMenuDestinationRequestAfterFrameCoroutine$d__40);
