...
namespace GlobalNamespace {
  ...
  class MainFlowCoordinator::$ProcessMenuDestinationRequestAfterFrameCoroutine$d__40 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
    ...
    GlobalNamespace::MainFlowCoordinator* _get_$$4__this();
    // Set instance field: public MainFlowCoordinator <>4__this
    void _set_$$4__this(GlobalNamespace::MainFlowCoordinator* value);
    // Get instance field: public MenuDestination destination
    GlobalNamespace::MenuDestination* _get_destination();
    // Set instance field: public MenuDestination destination
    void _set_destination(GlobalNamespace::MenuDestination* value);
