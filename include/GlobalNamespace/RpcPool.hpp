...
namespace GlobalNamespace {
  ...
  class RpcPool : public ::Il2CppObject {
    ...
    static T Obtain() {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RpcPool").WithContext("Obtain");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("", "RpcPool", il2cpp_utils::NoArgClass<T>(), "Obtain", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes())));
