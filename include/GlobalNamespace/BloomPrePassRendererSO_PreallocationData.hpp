...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BloomPrePassRendererSO::PreallocationData), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __GlobalNamespace_BloomPrePassRendererSO_PreallocationDataSizeCheck;
}
