...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ParticleSystemEventEffect), 176 + sizeof(float) + ((176 + sizeof(float)) % 8 != 0 ? (8 - (176 + sizeof(float)) % 8) : 0)> __GlobalNamespace_ParticleSystemEventEffectSizeCheck;
}
