...
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState  ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::NotLoading{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState  ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::LoadingBeatmap{1};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState  ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState::WaitingForCountdown{2};
...
constexpr void ::GlobalNamespace::MultiplayerLevelLoader::__set__loaderState(::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState ::GlobalNamespace::MultiplayerLevelLoader::__get__loaderState() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerLevelLoader__MultiplayerBeatmapLoaderState, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::MultiplayerLevelLoader::__set__getBeatmapLevelResultTask(::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelsModel__GetBeatmapLevelResult> value)  {
::cordl_internals::setInstanceField<::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelsModel__GetBeatmapLevelResult>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelsModel__GetBeatmapLevelResult>>(value));
}
constexpr ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelsModel__GetBeatmapLevelResult> ::GlobalNamespace::MultiplayerLevelLoader::__get__getBeatmapLevelResultTask() const {
return ::cordl_internals::getInstanceField<::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__BeatmapLevelsModel__GetBeatmapLevelResult>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 ::GlobalNamespace::MultiplayerLevelLoader::MultiplayerLevelLoader()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<MultiplayerLevelLoader>())) {}
