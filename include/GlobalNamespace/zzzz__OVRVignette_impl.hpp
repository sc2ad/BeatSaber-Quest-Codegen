...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::____GlobalNamespace__OVRVignette__MeshComplexityLevel(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel  ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::VerySimple{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel  ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::Simple{1};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel  ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::Normal{2};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel  ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::Detailed{3};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel  ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel::VeryDetailed{4};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType::____GlobalNamespace__OVRVignette__FalloffType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType  ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType::Linear{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType  ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType::Quadratic{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OVRVignette::*)(::UnityEngine::____UnityEngine__Camera__StereoscopicEye, ByRef<float_t>, ByRef<float_t>, ByRef<float_t>, ByRef<float_t>)>(&::GlobalNamespace::OVRVignette::GetTanFovAndOffsetForStereoEye)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::____UnityEngine__Camera__StereoscopicEye>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<float_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<float_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<float_t>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<float_t>>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::OVRVignette::__set_MeshComplexity(::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel ::GlobalNamespace::OVRVignette::__get_MeshComplexity() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRVignette__MeshComplexityLevel, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::OVRVignette::__set_Falloff(::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType, 0x24>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType ::GlobalNamespace::OVRVignette::__get_Falloff() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRVignette__FalloffType, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::OVRVignette::GetTanFovAndOffsetForStereoEye(::UnityEngine::____UnityEngine__Camera__StereoscopicEye eye, ByRef<float_t> tanFovX, ByRef<float_t> tanFovY, ByRef<float_t> offsetX, ByRef<float_t> offsetY)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRVignette>::get(),
                            "GetTanFovAndOffsetForStereoEye",
                            std::vector<Il2CppClass*>{},
