...
namespace GlobalNamespace {
  ...
  class NoteCutSoundEffect : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xD33998
  ...
  #pragma pack(pop)
  static check_size<sizeof(NoteCutSoundEffect), 154 + sizeof(bool)> __GlobalNamespace_NoteCutSoundEffectSizeCheck;
  static_assert(sizeof(NoteCutSoundEffect) == 0x9B);
}
