...
// Ctor Parameters []
 GlobalNamespace::GuestNameButtonsListItemsList::GuestNameButtonsListItemsList()  : HMUI::UIItemsList_1<GlobalNamespace::GuestNameButtonsListItem>(THROW_UNLESS(::il2cpp_utils::New<GuestNameButtonsListItemsList>())) {}
