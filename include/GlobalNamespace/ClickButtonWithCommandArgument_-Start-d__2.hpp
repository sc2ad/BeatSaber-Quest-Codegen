...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ClickButtonWithCommandArgument::$Start$d__2), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_ClickButtonWithCommandArgument_$Start$d__2SizeCheck;
}
