...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSpaceConvertor), 24 + sizeof(UnityEngine::Quaternion) + ((24 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (24 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_PlayerSpaceConvertorSizeCheck;
}
