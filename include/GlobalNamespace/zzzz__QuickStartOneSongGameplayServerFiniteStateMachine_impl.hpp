...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine::*)(::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams)>(&::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine::_ctor)> {
...
// Ctor Parameters [CppParam { name: "initParams", ty: "::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams", modifiers: "", def_value: None }]
 ::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine::QuickStartOneSongGameplayServerFiniteStateMachine(::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams initParams)  : ::GlobalNamespace::GameplayServerFiniteStateMachine(THROW_UNLESS(::il2cpp_utils::New<QuickStartOneSongGameplayServerFiniteStateMachine>(initParams))) {}
 void ::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine::_ctor(::GlobalNamespace::____GlobalNamespace__GameplayServerFiniteStateMachine__InitParams initParams)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
