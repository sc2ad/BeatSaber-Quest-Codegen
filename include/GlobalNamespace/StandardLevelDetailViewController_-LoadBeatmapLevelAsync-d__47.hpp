...
namespace GlobalNamespace {
  ...
  struct StandardLevelDetailViewController::$LoadBeatmapLevelAsync$d__47 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
