...
namespace GlobalNamespace {
  ...
  class CannotStartGameReasonMethods : public ::Il2CppObject {
    public:
    // [LocalizationKeyAttribute] Offset: 0x111B6A8
    ...
    // [LocalizationKeyAttribute] Offset: 0x111B6B8
    ...
    // [LocalizationKeyAttribute] Offset: 0x111B6C8
    ...
    // [LocalizationKeyAttribute] Offset: 0x111B6D8
