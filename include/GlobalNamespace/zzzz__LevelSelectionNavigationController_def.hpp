...
constexpr ::GlobalNamespace::PlayerDataModel __get__playerDataModel() const;
 ...
 ::System::Action_2<::GlobalNamespace::LevelSelectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> __declspec(property(get=__get_didChangeLevelDetailContentEvent, put=__set_didChangeLevelDetailContentEvent))  didChangeLevelDetailContentEvent;

constexpr void __set_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelSelectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;

constexpr ::System::Action_2<::GlobalNamespace::LevelSelectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> __get_didChangeLevelDetailContentEvent() const;
...
/// @brief Method add_didChangeLevelDetailContentEvent addr 0x216fc74 size 0xb0 virtual false final false
 void add_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelSelectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;

/// @brief Method remove_didChangeLevelDetailContentEvent addr 0x216fd24 size 0xb0 virtual false final false
 void remove_didChangeLevelDetailContentEvent(::System::Action_2<::GlobalNamespace::LevelSelectionNavigationController,::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType> value) ;
...
/// @brief Method HandleLevelCollectionNavigationControllerDidChangeLevelDetailContent addr 0x2170d1c size 0x20 virtual false final false
 void HandleLevelCollectionNavigationControllerDidChangeLevelDetailContent(::GlobalNamespace::LevelCollectionNavigationController viewController, ::GlobalNamespace::____GlobalNamespace__StandardLevelDetailViewController__ContentType contentType) ;
