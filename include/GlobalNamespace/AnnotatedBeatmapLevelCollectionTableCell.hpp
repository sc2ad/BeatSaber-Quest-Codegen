...
namespace GlobalNamespace {
  ...
  class AnnotatedBeatmapLevelCollectionTableCell : public HMUI::TableCell {
    ...
    static AnnotatedBeatmapLevelCollectionTableCell* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("AnnotatedBeatmapLevelCollectionTableCell").WithContext(".ctor");
