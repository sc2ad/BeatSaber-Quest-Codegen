...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::*)(bool)>(&::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x222ca88;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::__set_hideBranding(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::__get_hideBranding() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "hideBranding", ty: "bool", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::____GlobalNamespace__EnvironmentBrandingManager__InitData(bool hideBranding)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__EnvironmentBrandingManager__InitData>(hideBranding))) {}
 void ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData::_ctor(bool hideBranding)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::EnvironmentBrandingManager::__set__initData(::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData ::GlobalNamespace::EnvironmentBrandingManager::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__EnvironmentBrandingManager__InitData, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
