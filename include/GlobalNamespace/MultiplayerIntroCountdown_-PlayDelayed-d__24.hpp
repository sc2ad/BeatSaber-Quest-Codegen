...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerIntroCountdown::$PlayDelayed$d__24), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerIntroCountdown_$PlayDelayed$d__24SizeCheck;
}
