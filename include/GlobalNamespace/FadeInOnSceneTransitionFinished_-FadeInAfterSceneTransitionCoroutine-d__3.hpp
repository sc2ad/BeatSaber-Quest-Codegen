...
namespace GlobalNamespace {
  ...
  class FadeInOnSceneTransitionFinished::$FadeInAfterSceneTransitionCoroutine$d__3 : public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>, public ::Il2CppObject {
    public:
