...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TestPlatformAdditionalContentModel::Entitlement), 24 + sizeof(GlobalNamespace::AdditionalContentModel::EntitlementStatus) + ((24 + sizeof(GlobalNamespace::AdditionalContentModel::EntitlementStatus)) % 8 != 0 ? (8 - (24 + sizeof(GlobalNamespace::AdditionalContentModel::EntitlementStatus)) % 8) : 0)> __GlobalNamespace_TestPlatformAdditionalContentModel_EntitlementSizeCheck;
}
