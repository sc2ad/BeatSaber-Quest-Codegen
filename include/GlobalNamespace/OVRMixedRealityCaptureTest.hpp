...
namespace GlobalNamespace {
  ...
  class OVRMixedRealityCaptureTest : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRMixedRealityCaptureTest::CameraMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRMixedRealityCaptureTest_CameraModeSizeCheck;
  ...
  check_size<sizeof(OVRMixedRealityCaptureTest), 40 + sizeof(GlobalNamespace::OVRPlugin::Fovf) + ((40 + sizeof(GlobalNamespace::OVRPlugin::Fovf)) % 8 != 0 ? (8 - (40 + sizeof(GlobalNamespace::OVRPlugin::Fovf)) % 8) : 0)> __GlobalNamespace_OVRMixedRealityCaptureTestSizeCheck;
}
