...
GlobalNamespace::LocalPlayerInGameMenuInitData o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::LocalPlayerInGameMenuInitData>(previewBeatmapLevel, beatmapDifficulty, beatmapCharacteristic, hasSong))};
return o;
}
