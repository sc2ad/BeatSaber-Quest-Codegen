...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_Controller::Device), 245 + sizeof(bool) + ((245 + sizeof(bool)) % 8 != 0 ? (8 - (245 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_SteamVR_Controller_DeviceSizeCheck;
}
