...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData::*)(::ArrayW<GlobalNamespace::MissionObjective>)>(&GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData::__set_missionObjectives(::ArrayW<GlobalNamespace::MissionObjective> value)  {
...
constexpr void GlobalNamespace::MissionObjectiveCheckersManager::__set__initData(GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData>(value));
}
constexpr GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData GlobalNamespace::MissionObjectiveCheckersManager::__get__initData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__MissionObjectiveCheckersManager__InitData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
