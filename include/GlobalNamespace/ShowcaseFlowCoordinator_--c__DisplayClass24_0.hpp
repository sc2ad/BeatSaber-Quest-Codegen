...
namespace GlobalNamespace {
  // Size: 0x29
  #pragma pack(push, 1)
  // Autogenerated type: ShowcaseFlowCoordinator/<>c__DisplayClass24_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  class ShowcaseFlowCoordinator::$$c__DisplayClass24_0 : public ::Il2CppObject {
    public:
    ...
    static ShowcaseFlowCoordinator::$$c__DisplayClass24_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ShowcaseFlowCoordinator::$$c__DisplayClass24_0*, creationType>()));
    }
  }; // ShowcaseFlowCoordinator/<>c__DisplayClass24_0
  #pragma pack(pop)
  static check_size<sizeof(ShowcaseFlowCoordinator::$$c__DisplayClass24_0), 40 + sizeof(bool)> __GlobalNamespace_ShowcaseFlowCoordinator_$$c__DisplayClass24_0SizeCheck;
  static_assert(sizeof(ShowcaseFlowCoordinator::$$c__DisplayClass24_0) == 0x29);
}
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0*, "", "ShowcaseFlowCoordinator/<>c__DisplayClass24_0");
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0::$ProcessLevelCompletionResultsAfterLevelDidFinish$b__0
// Il2CppName: <ProcessLevelCompletionResultsAfterLevelDidFinish>b__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0::*)(GlobalNamespace::EnterPlayerGuestNameViewController*, ::Il2CppString*)>(&GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0::$ProcessLevelCompletionResultsAfterLevelDidFinish$b__0)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0*), "<ProcessLevelCompletionResultsAfterLevelDidFinish>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{viewController, playerName});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::ShowcaseFlowCoordinator::$$c__DisplayClass24_0::New_ctor
// Il2CppName: .ctor
