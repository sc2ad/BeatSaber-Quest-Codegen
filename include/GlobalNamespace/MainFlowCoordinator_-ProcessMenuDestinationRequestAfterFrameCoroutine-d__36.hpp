...
namespace GlobalNamespace {
  ...
  class MainFlowCoordinator::$ProcessMenuDestinationRequestAfterFrameCoroutine$d__36 : public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>, public ::Il2CppObject {
    public:
