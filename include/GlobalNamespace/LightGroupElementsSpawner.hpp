...
namespace GlobalNamespace {
  ...
  class LightGroupElementsSpawner : public ::GlobalNamespace::LightGroupSubsystem {
    public:
    public:
    // [SpaceAttribute] Offset: 0x10D88BC
  ...
  #pragma pack(pop)
  static check_size<sizeof(LightGroupElementsSpawner), 32 + sizeof(::UnityEngine::GameObject*)> __GlobalNamespace_LightGroupElementsSpawnerSizeCheck;
  static_assert(sizeof(LightGroupElementsSpawner) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
