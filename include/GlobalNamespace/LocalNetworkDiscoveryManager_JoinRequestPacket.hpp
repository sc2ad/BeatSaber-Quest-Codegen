...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LocalNetworkDiscoveryManager::JoinRequestPacket), 32 + sizeof(uint8_t) + ((32 + sizeof(uint8_t)) % 8 != 0 ? (8 - (32 + sizeof(uint8_t)) % 8) : 0)> __GlobalNamespace_LocalNetworkDiscoveryManager_JoinRequestPacketSizeCheck;
}
