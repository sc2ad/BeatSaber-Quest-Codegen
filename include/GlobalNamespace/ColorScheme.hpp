...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ColorScheme), 136 + sizeof(UnityEngine::Color) + ((136 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (136 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_ColorSchemeSizeCheck;
}
