...
namespace GlobalNamespace {
  ...
  class AdditionalContentModel : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(AdditionalContentModel::EntitlementStatus), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_AdditionalContentModel_EntitlementStatusSizeCheck;
    ...
    check_size<sizeof(AdditionalContentModel::OpenProductStoreResult), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_AdditionalContentModel_OpenProductStoreResultSizeCheck;
    ...
    check_size<sizeof(AdditionalContentModel::IsPackBetterBuyThanLevelResult), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_AdditionalContentModel_IsPackBetterBuyThanLevelResultSizeCheck;
  ...
  check_size<sizeof(AdditionalContentModel), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_AdditionalContentModelSizeCheck;
}
