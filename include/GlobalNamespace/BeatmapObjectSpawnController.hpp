...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapObjectSpawnController), 104 + sizeof(void*) + ((104 + sizeof(void*)) % 8 != 0 ? (8 - (104 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_BeatmapObjectSpawnControllerSizeCheck;
}
