...
namespace GlobalNamespace {
class ____GlobalNamespace__OVRRaycaster____c;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__OVRRaycaster__RaycastHit : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__OVRRaycaster__RaycastHit(::UnityEngine::UI::Graphic graphic, ::UnityEngine::Vector3 worldPos, bool fromMouse) noexcept;


                    constexpr ____GlobalNamespace__OVRRaycaster__RaycastHit(____GlobalNamespace__OVRRaycaster__RaycastHit const&) = default;
                    constexpr ____GlobalNamespace__OVRRaycaster__RaycastHit(____GlobalNamespace__OVRRaycaster__RaycastHit&&) = default;
                    constexpr ____GlobalNamespace__OVRRaycaster__RaycastHit& operator=(____GlobalNamespace__OVRRaycaster__RaycastHit const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__OVRRaycaster__RaycastHit& operator=(____GlobalNamespace__OVRRaycaster__RaycastHit&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__OVRRaycaster__RaycastHit(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____GlobalNamespace__OVRRaycaster____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____GlobalNamespace__OVRRaycaster____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__OVRRaycaster____c", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__OVRRaycaster____c(____GlobalNamespace__OVRRaycaster____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__OVRRaycaster____c", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__OVRRaycaster____c(____GlobalNamespace__OVRRaycaster____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__OVRRaycaster____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__OVRRaycaster____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__OVRRaycaster____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__OVRRaycaster____c& operator=(____GlobalNamespace__OVRRaycaster____c&& o) noexcept = default;
  constexpr ____GlobalNamespace__OVRRaycaster____c& operator=(____GlobalNamespace__OVRRaycaster____c const& o) noexcept = default;
                


// Fields

static ::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c value) ;

static ::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c __get___9() ;

static ::System::Comparison_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __declspec(property(get=__get___9__16_0, put=__set___9__16_0))  __9__16_0;

static void __set___9__16_0(::System::Comparison_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> value) ;

static ::System::Comparison_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __get___9__16_0() ;


// Methods

// Ctor Parameters []
explicit ____GlobalNamespace__OVRRaycaster____c() ;
...
/// @brief Method <GraphicRaycast>b__16_0 addr 0x262f394 size 0x54 virtual false final false
 int32_t _GraphicRaycast_b__16_0(::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit g1, ::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit g2) ;
...
public:
// Declarations
using __c = ::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c;

using RaycastHit = ::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit;
...
constexpr ::UnityEngine::Canvas __get_m_Canvas() const;
 ...
 ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __declspec(property(get=__get_m_RaycastResults, put=__set_m_RaycastResults))  m_RaycastResults;

constexpr void __set_m_RaycastResults(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> value) ;

constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __get_m_RaycastResults() const;

static ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __declspec(property(get=__get_s_SortedGraphics, put=__set_s_SortedGraphics))  s_SortedGraphics;

static void __set_s_SortedGraphics(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> value) ;

static ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> __get_s_SortedGraphics() ;
...
/// @brief Method GraphicRaycast addr 0x262e4b4 size 0x69c virtual false final false
 void GraphicRaycast(::UnityEngine::Canvas canvas, ::UnityEngine::Ray ray, ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit> results) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__OVRRaycaster____c, "", "OVRRaycaster/<>c");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__OVRRaycaster__RaycastHit, "", "OVRRaycaster/RaycastHit");
