...
namespace GlobalNamespace {
  ...
  class MasterServerConnectionManager : public ::Il2CppObject/*, public GlobalNamespace::IConnectionManager, public MasterServer::MessageHandler::IMessageSender*/ {
    ...
    check_size<sizeof(MasterServerConnectionManager::ConnectionAttempt), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MasterServerConnectionManager_ConnectionAttemptSizeCheck;
    ...
    check_size<sizeof(MasterServerConnectionManager::ConnectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MasterServerConnectionManager_ConnectionStateSizeCheck;
  ...
  check_size<sizeof(MasterServerConnectionManager), 192 + sizeof(void*) + 8 - (192 + sizeof(void*)) % 8> __GlobalNamespace_MasterServerConnectionManagerSizeCheck;
}
