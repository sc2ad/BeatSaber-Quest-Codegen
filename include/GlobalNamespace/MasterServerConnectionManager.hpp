...
namespace GlobalNamespace {
  ...
  class MasterServerConnectionManager : public ::Il2CppObject/*, public GlobalNamespace::IConnectionManager*/ {
    ...
    // Nested type: GlobalNamespace::MasterServerConnectionManager::$ConnectToEndPoint$d__111
    struct $ConnectToEndPoint$d__111;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    // public System.Void SetServerStatus(System.String serverName, System.String serverPassword, BeatmapLevelSelectionMask selectionMask, GameplayServerConfiguration configuration)
    // Offset: 0x21394A8
    void SetServerStatus(::Il2CppString* serverName, ::Il2CppString* serverPassword, GlobalNamespace::BeatmapLevelSelectionMask selectionMask, GlobalNamespace::GameplayServerConfiguration configuration);
    ...
    // private System.Void MasterServerConnectToMatchmaking(System.String userId, System.String userName, BeatmapLevelSelectionMask selectionMask, GameplayServerConfiguration configuration, System.String secret, System.String code)
    // Offset: 0x213A31C
    void MasterServerConnectToMatchmaking(::Il2CppString* userId, ::Il2CppString* userName, GlobalNamespace::BeatmapLevelSelectionMask selectionMask, GlobalNamespace::GameplayServerConfiguration configuration, ::Il2CppString* secret, ::Il2CppString* code);
    ...
    // public System.Void GetPublicServers(System.Action`1<System.Collections.Generic.IReadOnlyList`1<PublicServerInfo>> onSuccess, System.Action`1<ConnectionFailedReason> onFailure, System.Int32 offset, System.Int32 count, UserServerFilter filter)
    // Offset: 0x213A734
    void GetPublicServers(System::Action_1<System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PublicServerInfo>*>* onSuccess, System::Action_1<GlobalNamespace::ConnectionFailedReason>* onFailure, int offset, int count, GlobalNamespace::UserServerFilter filter);
    // private System.Void <StartBroadcastingServer>b__109_0(System.Net.IPEndPoint remoteEndPoint, System.String code)
    // Offset: 0x213A820
    void $StartBroadcastingServer$b__109_0(System::Net::IPEndPoint* remoteEndPoint, ::Il2CppString* code);
    // private System.Void <StartBroadcastingServer>b__109_1(ConnectionFailedReason reason)
    // Offset: 0x213A850
    void $StartBroadcastingServer$b__109_1(GlobalNamespace::ConnectionFailedReason reason);
  ...
  #pragma pack(pop)
  static check_size<sizeof(MasterServerConnectionManager), 216 + sizeof(System::Action_3<GlobalNamespace::IConnection*, LiteNetLib::Utils::NetDataReader*, LiteNetLib::DeliveryMethod>*)> __GlobalNamespace_MasterServerConnectionManagerSizeCheck;
  static_assert(sizeof(MasterServerConnectionManager) == 0xE0);
}
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MasterServerConnectionManager::*)(::Il2CppString*, ::Il2CppString*, GlobalNamespace::BeatmapLevelSelectionMask, GlobalNamespace::GameplayServerConfiguration)>(&GlobalNamespace::MasterServerConnectionManager::SetServerStatus)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MasterServerConnectionManager*), "SetServerStatus", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{serverName, serverPassword, selectionMask, configuration});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MasterServerConnectionManager::*)(::Il2CppString*, ::Il2CppString*, GlobalNamespace::BeatmapLevelSelectionMask, GlobalNamespace::GameplayServerConfiguration, ::Il2CppString*, ::Il2CppString*)>(&GlobalNamespace::MasterServerConnectionManager::MasterServerConnectToMatchmaking)> {
  static const MethodInfo* get() {
    ...
    static auto* secret = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* code = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MasterServerConnectionManager*), "MasterServerConnectToMatchmaking", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{userId, userName, selectionMask, configuration, secret, code});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MasterServerConnectionManager::*)(System::Action_1<System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PublicServerInfo>*>*, System::Action_1<GlobalNamespace::ConnectionFailedReason>*, int, int, GlobalNamespace::UserServerFilter)>(&GlobalNamespace::MasterServerConnectionManager::GetPublicServers)> {
  static const MethodInfo* get() {
...
// Writing MetadataGetter for method: GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__109_0
// Il2CppName: <StartBroadcastingServer>b__109_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MasterServerConnectionManager::*)(System::Net::IPEndPoint*, ::Il2CppString*)>(&GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__109_0)> {
  static const MethodInfo* get() {
    static auto* remoteEndPoint = &::il2cpp_utils::GetClassFromName("System.Net", "IPEndPoint")->byval_arg;
    static auto* code = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MasterServerConnectionManager*), "<StartBroadcastingServer>b__109_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{remoteEndPoint, code});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__109_1
// Il2CppName: <StartBroadcastingServer>b__109_1
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MasterServerConnectionManager::*)(GlobalNamespace::ConnectionFailedReason)>(&GlobalNamespace::MasterServerConnectionManager::$StartBroadcastingServer$b__109_1)> {
  static const MethodInfo* get() {
    static auto* reason = &::il2cpp_utils::GetClassFromName("", "ConnectionFailedReason")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MasterServerConnectionManager*), "<StartBroadcastingServer>b__109_1", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{reason});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::MasterServerConnectionManager::New_ctor
// Il2CppName: .ctor
