...
namespace GlobalNamespace {
  ...
  class MultiplayerLobbyConnectionController : public ::Il2CppObject {
    ...
    check_size<sizeof(MultiplayerLobbyConnectionController::LobbyConnectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MultiplayerLobbyConnectionController_LobbyConnectionStateSizeCheck;
    ...
    check_size<sizeof(MultiplayerLobbyConnectionController::LobbyConnectionType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MultiplayerLobbyConnectionController_LobbyConnectionTypeSizeCheck;
  ...
  check_size<sizeof(MultiplayerLobbyConnectionController), 64 + sizeof(GlobalNamespace::ConnectionFailedReason) + 8 - (64 + sizeof(GlobalNamespace::ConnectionFailedReason)) % 8> __GlobalNamespace_MultiplayerLobbyConnectionControllerSizeCheck;
}
