...
namespace GlobalNamespace {
  ...
  class MultiplayerLobbyConnectionController : public ::Il2CppObject {
    ...
    static MultiplayerLobbyConnectionController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerLobbyConnectionController").WithContext(".ctor");
