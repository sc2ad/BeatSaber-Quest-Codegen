...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BezierCurve), 36 + sizeof(UnityEngine::Vector3) + ((36 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (36 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __GlobalNamespace_BezierCurveSizeCheck;
}
