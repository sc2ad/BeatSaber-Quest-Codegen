...
namespace GlobalNamespace {
  ...
  class OVRPlugin::OVRP_1_44_0 : public ::CsObject {
    public:
    ...
    // Offset: 0xF32AAC
    static GlobalNamespace::OVRPlugin::Result ovrp_SetDefaultExternalCamera(::CsString* cameraName, GlobalNamespace::OVRPlugin::CameraIntrinsics& cameraIntrinsics, GlobalNamespace::OVRPlugin::CameraExtrinsics& cameraExtrinsics);
