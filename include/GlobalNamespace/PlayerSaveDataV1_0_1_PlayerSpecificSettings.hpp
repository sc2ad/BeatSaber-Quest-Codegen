...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveDataV1_0_1::PlayerSpecificSettings), 27 + sizeof(bool) + 8 - (27 + sizeof(bool)) % 8> __GlobalNamespace_PlayerSaveDataV1_0_1_PlayerSpecificSettingsSizeCheck;
}
