...
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::____GlobalNamespace__Billboard__RotationMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode  ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::AllAxis{0};
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode  ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::XAxis{1};
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode  ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::YAxis{2};
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode  ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode::ZAxis{3};
...
constexpr void ::GlobalNamespace::Billboard::__set__rotationMode(::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode ::GlobalNamespace::Billboard::__get__rotationMode() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__Billboard__RotationMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
