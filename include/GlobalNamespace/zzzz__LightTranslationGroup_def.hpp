...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5043)), TypeDefinitionIndex(TypeDefinitionIndex(5037)), TypeDefinitionIndex(TypeDefinitionIndex(5036)), TypeDefinitionIndex(TypeDefinitionIndex(5038)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5043), inst: 3819 })}
