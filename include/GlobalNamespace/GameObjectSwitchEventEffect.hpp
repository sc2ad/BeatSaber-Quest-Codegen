...
namespace GlobalNamespace {
  ...
  class GameObjectSwitchEventEffect : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(::ArrayW<::UnityEngine::GameObject*>) == 0x8);
    // [InjectAttribute] Offset: 0x10B6CA4
  ...
  #pragma pack(pop)
  static check_size<sizeof(GameObjectSwitchEventEffect), 56 + sizeof(::GlobalNamespace::BeatmapDataCallbackWrapper*)> __GlobalNamespace_GameObjectSwitchEventEffectSizeCheck;
  static_assert(sizeof(GameObjectSwitchEventEffect) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GameObjectSwitchEventEffect::*)(::GlobalNamespace::BasicBeatmapEventData*)>(&GlobalNamespace::GameObjectSwitchEventEffect::HandleBeatmapEvent)> {
  static const MethodInfo* get() {
