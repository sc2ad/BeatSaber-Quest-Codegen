...
class CORDL_TYPE ____GlobalNamespace__NamedIntListController__TextValuePair : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____GlobalNamespace__NamedIntListController__TextValuePair() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__NamedIntListController__TextValuePair", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__NamedIntListController__TextValuePair(____GlobalNamespace__NamedIntListController__TextValuePair const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__NamedIntListController__TextValuePair", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__NamedIntListController__TextValuePair(____GlobalNamespace__NamedIntListController__TextValuePair&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__NamedIntListController__TextValuePair(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__NamedIntListController__TextValuePair& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__NamedIntListController__TextValuePair& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__NamedIntListController__TextValuePair& operator=(____GlobalNamespace__NamedIntListController__TextValuePair&& o) noexcept = default;
  constexpr ____GlobalNamespace__NamedIntListController__TextValuePair& operator=(____GlobalNamespace__NamedIntListController__TextValuePair const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__NamedIntListController__TextValuePair() ;
...
public:
// Declarations
using TextValuePair = ::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair;
...
// Fields
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair> __declspec(property(get=__get__textValuePairs, put=__set__textValuePairs))  _textValuePairs;

constexpr void __set__textValuePairs(::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair> __get__textValuePairs() const;
...
/// @brief Method InitValues addr 0x2126eb4 size 0x10 virtual false final false
 void InitValues(::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair> values) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__NamedIntListController__TextValuePair, "", "NamedIntListController/TextValuePair");
