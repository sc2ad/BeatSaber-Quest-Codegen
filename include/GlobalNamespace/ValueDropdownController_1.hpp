...
namespace GlobalNamespace {
  ...
  class ValueDropdownController_1 : public ::UnityEngine::MonoBehaviour {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_2<int, T>*& dyn_didSelectCellWithIdxEvent() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::IReadOnlyList_1<::System::Tuple_2<T, ::StringW>*>*& dyn__namedValues() {
