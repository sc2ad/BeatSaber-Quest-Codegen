...
namespace GlobalNamespace {
class ____GlobalNamespace__TrailerGameplayManager___Start_d__4;
}
// Type: ::<Start>d__4
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__TrailerGameplayManager___Start_d__4 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__TrailerGameplayManager___Start_d__4() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__TrailerGameplayManager___Start_d__4", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4(____GlobalNamespace__TrailerGameplayManager___Start_d__4 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__TrailerGameplayManager___Start_d__4", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4(____GlobalNamespace__TrailerGameplayManager___Start_d__4&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__TrailerGameplayManager___Start_d__4(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4& operator=(____GlobalNamespace__TrailerGameplayManager___Start_d__4&& o) noexcept = default;
  constexpr ____GlobalNamespace__TrailerGameplayManager___Start_d__4& operator=(____GlobalNamespace__TrailerGameplayManager___Start_d__4 const& o) noexcept = default;
...
explicit ____GlobalNamespace__TrailerGameplayManager___Start_d__4(int32_t __1__state) ;
...
public:
// Declarations
using _Start_d__4 = ::GlobalNamespace::____GlobalNamespace__TrailerGameplayManager___Start_d__4;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__TrailerGameplayManager___Start_d__4);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__TrailerGameplayManager___Start_d__4, "", "TrailerGameplayManager/<Start>d__4");
