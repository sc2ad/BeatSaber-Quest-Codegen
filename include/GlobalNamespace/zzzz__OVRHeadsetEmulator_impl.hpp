...
constexpr void GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode  GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode::Off{0};
constexpr GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode  GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode::EditorOnly{1};
constexpr GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode  GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode::AlwaysOn{2};
...
constexpr void GlobalNamespace::OVRHeadsetEmulator::__set_opMode(GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode>(value));
}
constexpr GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode GlobalNamespace::OVRHeadsetEmulator::__get_opMode() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__OVRHeadsetEmulator__OpMode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
