...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerLTrackedRemote), 268 + sizeof(float) + ((268 + sizeof(float)) % 8 != 0 ? (8 - (268 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerLTrackedRemoteSizeCheck;
}
