...
public:
// Declarations
using Pool = ::GlobalNamespace::____GlobalNamespace__FlyingScoreEffect__Pool;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4969)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 2707 }), TypeDefinitionIndex(TypeDefinitionIndex(10992))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4968))
// CS Name: FlyingScoreEffect::Pool
class CORDL_TYPE ____GlobalNamespace__FlyingScoreEffect__Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::FlyingScoreEffect> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__FlyingScoreEffect__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__FlyingScoreEffect__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__FlyingScoreEffect__Pool(____GlobalNamespace__FlyingScoreEffect__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__FlyingScoreEffect__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__FlyingScoreEffect__Pool(____GlobalNamespace__FlyingScoreEffect__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__FlyingScoreEffect__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::FlyingScoreEffect>(ptr) {
}


  constexpr ____GlobalNamespace__FlyingScoreEffect__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__FlyingScoreEffect__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__FlyingScoreEffect__Pool& operator=(____GlobalNamespace__FlyingScoreEffect__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__FlyingScoreEffect__Pool& operator=(____GlobalNamespace__FlyingScoreEffect__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__FlyingScoreEffect__Pool() ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__FlyingScoreEffect__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__FlyingScoreEffect__Pool, "", "FlyingScoreEffect/Pool");
