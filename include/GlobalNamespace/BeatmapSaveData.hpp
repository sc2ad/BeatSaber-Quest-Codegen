...
namespace GlobalNamespace {
  ...
  class BeatmapSaveData : public ::Il2CppObject {
    ...
    struct NoteType;
    // Nested type: GlobalNamespace::BeatmapSaveData::LongNoteType
    struct LongNoteType;
    ...
    class NoteData;
    // Nested type: GlobalNamespace::BeatmapSaveData::LongNoteData
    class LongNoteData;
    ...
    // private System.Collections.Generic.List`1<BeatmapSaveData/LongNoteData> _longNotes
    // Offset: 0x28
    System::Collections::Generic::List_1<GlobalNamespace::BeatmapSaveData::LongNoteData*>* longNotes;
    ...
    // public System.Collections.Generic.List`1<BeatmapSaveData/LongNoteData> get_longNotes()
    // Offset: 0xF187D0
    System::Collections::Generic::List_1<GlobalNamespace::BeatmapSaveData::LongNoteData*>* get_longNotes();
    ...
    // public System.Void .ctor(System.Collections.Generic.List`1<BeatmapSaveData/EventData> events, System.Collections.Generic.List`1<BeatmapSaveData/NoteData> notes, System.Collections.Generic.List`1<BeatmapSaveData/LongNoteData> longNotes, System.Collections.Generic.List`1<BeatmapSaveData/ObstacleData> obstacles)
    // Offset: 0xF187E0
