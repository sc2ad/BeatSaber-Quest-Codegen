...
namespace GlobalNamespace {
  ...
  struct MainMenuDestinationRequestControler::$ProcessDestinationRequest$d__8 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
