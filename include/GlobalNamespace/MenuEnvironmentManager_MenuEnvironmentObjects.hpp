...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MenuEnvironmentManager::MenuEnvironmentObjects), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __GlobalNamespace_MenuEnvironmentManager_MenuEnvironmentObjectsSizeCheck;
}
