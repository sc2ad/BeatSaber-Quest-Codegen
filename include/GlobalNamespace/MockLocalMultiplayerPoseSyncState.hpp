...
namespace GlobalNamespace {
  ...
  class MockLocalMultiplayerPoseSyncState : public GlobalNamespace::LocalMultiplayerSyncState_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState::NodePose, GlobalNamespace::PoseSerializable> {
    public:
    ...
    // Offset: 0x28
    GlobalNamespace::LocalStateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState::NodePose, GlobalNamespace::PoseSerializable>* stateBuffer;
    // protected StateBuffer`3<NodePoseSyncState,NodePoseSyncState/NodePose,PoseSerializable> get_stateBuffer()
    // Offset: 0xFBFD78
    GlobalNamespace::StateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState::NodePose, GlobalNamespace::PoseSerializable>* get_stateBuffer();
    // public PoseSerializable GetState(NodePoseSyncState/NodePose type, System.Single time)
    // Offset: 0xFBFD80
    GlobalNamespace::PoseSerializable GetState(GlobalNamespace::NodePoseSyncState::NodePose type, float time);
    // public System.Void SetState(NodePoseSyncState/NodePose type, PoseSerializable state)
    // Offset: 0xFBFE00
    void SetState(GlobalNamespace::NodePoseSyncState::NodePose type, GlobalNamespace::PoseSerializable state);
    ...
    // Offset: 0xFC0104
    static MockLocalMultiplayerPoseSyncState* New_ctor(GlobalNamespace::IConnectedPlayer* player, float reliableUpdateFrequency, float unreliableUpdateFrequency, int size, typename GlobalNamespace::StateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState::NodePose, GlobalNamespace::PoseSerializable>::InterpolationDelegate* interpolator, typename GlobalNamespace::StateBuffer_3<GlobalNamespace::NodePoseSyncState, GlobalNamespace::NodePoseSyncState::NodePose, GlobalNamespace::PoseSerializable>::SmoothingDelegate* smoother);
