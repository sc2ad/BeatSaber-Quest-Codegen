...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerEnvironmentResizeController::ResizeType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MultiplayerEnvironmentResizeController_ResizeTypeSizeCheck;
}
