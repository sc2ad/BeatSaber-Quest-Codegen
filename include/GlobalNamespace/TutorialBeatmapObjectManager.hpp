...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TutorialBeatmapObjectManager), 96 + sizeof(void*) + ((96 + sizeof(void*)) % 8 != 0 ? (8 - (96 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_TutorialBeatmapObjectManagerSizeCheck;
}
