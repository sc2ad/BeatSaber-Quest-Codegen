...
namespace GlobalNamespace {
  ...
  class TutorialBeatmapObjectManager : public GlobalNamespace::BeatmapObjectManager {
    ...
    // Offset: 0x107A248
    // Implemented from: BeatmapObjectManager
    // Base method: NoteController BeatmapObjectManager::SpawnBombNoteInternal_NEW(NoteData noteData, BeatmapObjectSpawnMovementData/NoteSpawnData noteSpawnData, System.Single rotation)
  ...
  #pragma pack(pop)
  static check_size<sizeof(TutorialBeatmapObjectManager), 104 + sizeof(GlobalNamespace::TutorialBeatmapObjectManager::InitData*)> __GlobalNamespace_TutorialBeatmapObjectManagerSizeCheck;
  static_assert(sizeof(TutorialBeatmapObjectManager) == 0x70);
}
