...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TutorialBeatmapObjectManager), 144 + sizeof(GlobalNamespace::TutorialBeatmapObjectManager::InitData*)> __GlobalNamespace_TutorialBeatmapObjectManagerSizeCheck;
  static_assert(sizeof(TutorialBeatmapObjectManager) == 0x98);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
