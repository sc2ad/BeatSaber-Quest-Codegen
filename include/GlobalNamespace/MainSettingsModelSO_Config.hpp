...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MainSettingsModelSO::Config), 216 + sizeof(::StringW)> __GlobalNamespace_MainSettingsModelSO_ConfigSizeCheck;
  static_assert(sizeof(MainSettingsModelSO::Config) == 0xE0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
