...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MainSettingsModelSO::Config), 208 + sizeof(int)> __GlobalNamespace_MainSettingsModelSO_ConfigSizeCheck;
  static_assert(sizeof(MainSettingsModelSO::Config) == 0xD4);
}
