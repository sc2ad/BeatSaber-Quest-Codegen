...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MainSettingsModelSO::Config), 204 + sizeof(int) + ((204 + sizeof(int)) % 8 != 0 ? (8 - (204 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MainSettingsModelSO_ConfigSizeCheck;
}
