...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BTSStarTextEffectController), 48 + sizeof(float) + ((48 + sizeof(float)) % 8 != 0 ? (8 - (48 + sizeof(float)) % 8) : 0)> __GlobalNamespace_BTSStarTextEffectControllerSizeCheck;
}
