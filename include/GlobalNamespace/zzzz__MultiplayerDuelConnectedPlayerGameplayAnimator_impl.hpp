...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)()>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x20e15b0;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)()>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::TransitionIntoFailedState)> {
  ...
  constexpr static std::size_t addrs = 0x20e168c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)(bool)>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::AnimateNewLeaderSelected)> {
  constexpr static std::size_t size = 0xdc;
  constexpr static std::size_t addrs = 0x20e1760;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)(GlobalNamespace::GlobalNamespace__MultiplayerController__State)>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::HandleStateChanged)> {
  constexpr static std::size_t size = 0x110;
  constexpr static std::size_t addrs = 0x20e183c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)()>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::HandlePlayerDidFail)> {
  ...
  constexpr static std::size_t addrs = 0x20e194c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::*)()>(&GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x20e1950;
...
::cordl_internals::setInstanceField<GlobalNamespace::ScaleAnimator, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::ScaleAnimator>(value));
}
constexpr GlobalNamespace::ScaleAnimator GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::__get__avatarScaleAnimator() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::ScaleAnimator, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::MultiplayerConnectedPlayerLevelFailController, 0x70>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::MultiplayerConnectedPlayerLevelFailController>(value));
}
constexpr GlobalNamespace::MultiplayerConnectedPlayerLevelFailController GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::__get__failController() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::MultiplayerConnectedPlayerLevelFailController, 0x70>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, isLeading);
 ...
 void GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator>::get(),
                            "HandleStateChanged",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::MultiplayerDuelConnectedPlayerGameplayAnimator()  : GlobalNamespace::MultiplayerGameplayAnimator(THROW_UNLESS(::il2cpp_utils::New<MultiplayerDuelConnectedPlayerGameplayAnimator>())) {}
 void GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
