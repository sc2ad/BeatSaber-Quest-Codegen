...
GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MultiplayerDuelConnectedPlayerGameplayAnimator>())};
return o;
}
