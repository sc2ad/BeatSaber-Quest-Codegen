...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [RequireComponent] Offset: CDFF4C
  class OVRGrabber : public UnityEngine::MonoBehaviour {
    ...
    // Offset: 0x1144DD4
    void MoveGrabbedObject_NEW(UnityEngine::Vector3 pos, UnityEngine::Quaternion rot, bool forceTeleport);
    ...
    // Offset: 0x11450A8
    void GrabVolumeEnable_NEW(bool enabled);
    // protected System.Void OffhandGrabbed(OVRGrabbable grabbable)
    // Offset: 0x1145190
    void OffhandGrabbed_NEW(GlobalNamespace::OVRGrabbable* grabbable);
