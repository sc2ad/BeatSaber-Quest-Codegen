...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapLevelSO::DifficultyBeatmapSet), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __GlobalNamespace_BeatmapLevelSO_DifficultyBeatmapSetSizeCheck;
}
