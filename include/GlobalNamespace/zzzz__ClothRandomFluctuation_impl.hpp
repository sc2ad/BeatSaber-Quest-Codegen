...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::*)()>(&::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20af67c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::__set_multiplier(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::__get_multiplier() const {
return ::cordl_internals::getInstanceField<float_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::__set_offset(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::__get_offset() const {
return ::cordl_internals::getInstanceField<float_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::____GlobalNamespace__ClothRandomFluctuation__SineLayer()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__ClothRandomFluctuation__SineLayer>())) {}
 void ::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::ClothRandomFluctuation::__set__compoundSins(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer>>(value));
}
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer> ::GlobalNamespace::ClothRandomFluctuation::__get__compoundSins() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__ClothRandomFluctuation__SineLayer>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
