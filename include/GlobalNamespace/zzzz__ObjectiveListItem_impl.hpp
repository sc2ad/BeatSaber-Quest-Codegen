...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObjectiveListItem::*)(::StringW)>(&GlobalNamespace::ObjectiveListItem::set_title)> {
  ...
  constexpr static std::size_t addrs = 0x218e580;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObjectiveListItem::*)(::StringW)>(&GlobalNamespace::ObjectiveListItem::set_conditionText)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x218e5a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObjectiveListItem::*)(bool)>(&GlobalNamespace::ObjectiveListItem::set_hideCondition)> {
  ...
  constexpr static std::size_t addrs = 0x218e5c8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObjectiveListItem::*)()>(&GlobalNamespace::ObjectiveListItem::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x218e5fc;
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::ObjectiveListItem::__get__titleText() const {
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::ObjectiveListItem::__get__conditionText() const {
...
// Ctor Parameters []
 GlobalNamespace::ObjectiveListItem::ObjectiveListItem()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<ObjectiveListItem>())) {}
 void GlobalNamespace::ObjectiveListItem::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ObjectiveListItem>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
