...
namespace GlobalNamespace {
struct ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition(____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition const&) = default;
                    constexpr ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition(____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition&&) = default;
                    constexpr ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition& operator=(____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition& operator=(____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition_Unwrapped : int32_t {
__ShowIf = 0,
__HideIf = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition const ShowIf;

/// @brief Field HideIf offset 0
static ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition const HideIf;
...
public:
// Declarations
using Condition = ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition;
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition __declspec(property(get=__get__condition, put=__set__condition))  _condition;

constexpr void __set__condition(::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition __get__condition() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MultiplayerConditionalActiveByLayout__Condition, "", "MultiplayerConditionalActiveByLayout/Condition");
