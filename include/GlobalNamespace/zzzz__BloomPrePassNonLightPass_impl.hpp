...
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::BeforeBlur{1};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType  ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType::AfterBlur{2};
//  Writing Method size for method: ::GlobalNamespace::BloomPrePassNonLightPass.get_executionTimeType
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType (::GlobalNamespace::BloomPrePassNonLightPass::*)()>(&::GlobalNamespace::BloomPrePassNonLightPass::get_executionTimeType)> {
...
constexpr void ::GlobalNamespace::BloomPrePassNonLightPass::__set__executionTimeType(::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType ::GlobalNamespace::BloomPrePassNonLightPass::__get__executionTimeType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::BloomPrePassNonLightPass::__set__registeredExecutionTimeType(::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType ::GlobalNamespace::BloomPrePassNonLightPass::__get__registeredExecutionTimeType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
 ::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType ::GlobalNamespace::BloomPrePassNonLightPass::get_executionTimeType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BloomPrePassNonLightPass>::get(),
                            "get_executionTimeType",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType, false>(const_cast<void*>(instance), ___internal_method);
}
