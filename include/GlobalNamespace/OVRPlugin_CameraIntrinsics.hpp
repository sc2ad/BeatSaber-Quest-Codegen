...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::CameraIntrinsics), 40 + sizeof(GlobalNamespace::OVRPlugin::Sizei) + ((40 + sizeof(GlobalNamespace::OVRPlugin::Sizei)) % 8 != 0 ? (8 - (40 + sizeof(GlobalNamespace::OVRPlugin::Sizei)) % 8) : 0)> __GlobalNamespace_OVRPlugin_CameraIntrinsicsSizeCheck;
}
