...
constexpr void GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__set_position(UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector3, 0x0>(this->__instance, std::forward<UnityEngine::Vector3>(value));
}
constexpr UnityEngine::Vector3 GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__get_position() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector3, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__set_tangent(UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector3, 0xc>(this->__instance, std::forward<UnityEngine::Vector3>(value));
}
constexpr UnityEngine::Vector3 GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__get_tangent() const {
return ::cordl_internals::getInstanceField<UnityEngine::Vector3, 0xc>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__set_normal(UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<UnityEngine::Vector3, 0x18>(this->__instance, std::forward<UnityEngine::Vector3>(value));
}
constexpr UnityEngine::Vector3 GlobalNamespace::GlobalNamespace__VertexPath__Vertex::__get_normal() const {
...
constexpr void GlobalNamespace::VertexPath::__set__localVertices(::ArrayW<GlobalNamespace::GlobalNamespace__VertexPath__Vertex> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__VertexPath__Vertex>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__VertexPath__Vertex>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__VertexPath__Vertex> GlobalNamespace::VertexPath::__get__localVertices() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__VertexPath__Vertex>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
