...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BasicBeatmapObjectManager::InitData), 17 + sizeof(bool) + ((17 + sizeof(bool)) % 8 != 0 ? (8 - (17 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_BasicBeatmapObjectManager_InitDataSizeCheck;
}
