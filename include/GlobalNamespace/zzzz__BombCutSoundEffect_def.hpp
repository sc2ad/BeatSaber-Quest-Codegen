...
public:
// Declarations
using Pool = ::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 274 }), TypeDefinitionIndex(TypeDefinitionIndex(4043)), TypeDefinitionIndex(TypeDefinitionIndex(10992))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4042))
// CS Name: BombCutSoundEffect::Pool
class CORDL_TYPE ____GlobalNamespace__BombCutSoundEffect__Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::BombCutSoundEffect> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__BombCutSoundEffect__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BombCutSoundEffect__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BombCutSoundEffect__Pool(____GlobalNamespace__BombCutSoundEffect__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BombCutSoundEffect__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BombCutSoundEffect__Pool(____GlobalNamespace__BombCutSoundEffect__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BombCutSoundEffect__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::BombCutSoundEffect>(ptr) {
}


  constexpr ____GlobalNamespace__BombCutSoundEffect__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BombCutSoundEffect__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BombCutSoundEffect__Pool& operator=(____GlobalNamespace__BombCutSoundEffect__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__BombCutSoundEffect__Pool& operator=(____GlobalNamespace__BombCutSoundEffect__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__BombCutSoundEffect__Pool() ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool, "", "BombCutSoundEffect/Pool");
