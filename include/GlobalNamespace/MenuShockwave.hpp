...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MenuShockwave), 48 + sizeof(UnityEngine::ParticleSystem::EmitParams) + ((48 + sizeof(UnityEngine::ParticleSystem::EmitParams)) % 8 != 0 ? (8 - (48 + sizeof(UnityEngine::ParticleSystem::EmitParams)) % 8) : 0)> __GlobalNamespace_MenuShockwaveSizeCheck;
}
