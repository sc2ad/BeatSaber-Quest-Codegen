...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, basicBeatmapEventData);
 ...
 GlobalNamespace::HydraulicCarJumpEffect GlobalNamespace::HydraulicCarJumpEffect::New_ctor()  {
GlobalNamespace::HydraulicCarJumpEffect o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::HydraulicCarJumpEffect>())};
return o;
}
