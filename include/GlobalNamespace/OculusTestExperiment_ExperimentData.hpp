...
namespace GlobalNamespace {
  ...
  class OculusTestExperiment::ExperimentData : public ::Il2CppObject/*, public GlobalNamespace::IExperimentData*/ {
    ...
    // Creating value type constructor for type: ExperimentData
    ExperimentData(::Il2CppString* experimentPlatformKey_ = {}) noexcept : experimentPlatformKey{experimentPlatformKey_} {}
