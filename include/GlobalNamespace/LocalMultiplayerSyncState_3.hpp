...
namespace GlobalNamespace {
  ...
  // [DefaultMemberAttribute] Offset: DFB84C
  template<typename TStateTable, typename TType, typename TState>
  class LocalMultiplayerSyncState_3 : public GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState> {
    ...
    GlobalNamespace::IConnectedPlayer* _get__player() {
      ...
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<GlobalNamespace::IConnectedPlayer*>(___internal__instance, "_player"));
    }
    ...
    void _set__player(GlobalNamespace::IConnectedPlayer* value) {
      ...
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_player", value));
    }
    // Autogenerated instance field getter
    ...
    GlobalNamespace::LocalStateBuffer_3<TStateTable, TType, TState>* _get__stateBuffer() {
      ...
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<GlobalNamespace::LocalStateBuffer_3<TStateTable, TType, TState>*>(___internal__instance, "_stateBuffer")));
    }
    // Autogenerated instance field setter
    ...
    void _set__stateBuffer(GlobalNamespace::LocalStateBuffer_3<TStateTable, TType, TState>* value) {
      ...
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_stateBuffer", value));
    }
