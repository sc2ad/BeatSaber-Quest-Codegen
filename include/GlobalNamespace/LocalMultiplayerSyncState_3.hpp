...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: D1B80C
  template<typename TStateTable, typename TType, typename TState>
  class LocalMultiplayerSyncState_3 : public GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState> {
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    bool TryGetSerializedState(GlobalNamespace::IPacketPool_1<T>* pool, T& serializable) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryGetSerializedState", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(pool, serializable)));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___generic__method, pool, serializable);
    }
    // public System.Boolean TryGetSerializedStateDelta(IPacketPool`1<T> pool, out T serializable)
    // Offset: 0xFFFFFFFF
    template<class T>
    bool TryGetSerializedStateDelta(GlobalNamespace::IPacketPool_1<T>* pool, T& serializable) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryGetSerializedStateDelta", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(pool, serializable)));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___generic__method, pool, serializable);
    }
    ...
    GlobalNamespace::IConnectedPlayer* get_player() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "get_player", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
