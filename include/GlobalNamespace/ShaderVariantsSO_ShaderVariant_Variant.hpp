...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ShaderVariantsSO::ShaderVariant::Variant), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __GlobalNamespace_ShaderVariantsSO_ShaderVariant_VariantSizeCheck;
}
