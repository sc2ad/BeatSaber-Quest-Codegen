...
namespace GlobalNamespace {
  ...
  struct TestPlatformAdditionalContentModel::$IsPackBetterBuyThanLevelAsync$d__7 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
