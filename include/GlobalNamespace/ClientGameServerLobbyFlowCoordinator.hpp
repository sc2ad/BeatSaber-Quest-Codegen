...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ClientGameServerLobbyFlowCoordinator), 360 + sizeof(void*) + ((360 + sizeof(void*)) % 8 != 0 ? (8 - (360 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_ClientGameServerLobbyFlowCoordinatorSizeCheck;
}
