...
struct CORDL_TYPE ____GlobalNamespace__NodePoseSyncState__NodePose : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__NodePoseSyncState__NodePose(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__NodePoseSyncState__NodePose(____GlobalNamespace__NodePoseSyncState__NodePose const&) = default;
                    constexpr ____GlobalNamespace__NodePoseSyncState__NodePose(____GlobalNamespace__NodePoseSyncState__NodePose&&) = default;
                    constexpr ____GlobalNamespace__NodePoseSyncState__NodePose& operator=(____GlobalNamespace__NodePoseSyncState__NodePose const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__NodePoseSyncState__NodePose& operator=(____GlobalNamespace__NodePoseSyncState__NodePose&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__NodePoseSyncState__NodePose(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__NodePoseSyncState__NodePose_Unwrapped : int32_t {
__Head = 0,
__LeftController = 1,
__RightController = 2,
__Count = 3,
...
constexpr operator ______GlobalNamespace__NodePoseSyncState__NodePose_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__NodePoseSyncState__NodePose_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose const Head;

/// @brief Field LeftController offset 0
static ::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose const LeftController;

/// @brief Field RightController offset 0
static ::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose const RightController;

/// @brief Field Count offset 0
static ::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose const Count;
...
public:
// Declarations
using NodePose = ::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose;
...
constexpr operator  ::GlobalNamespace::IStateTable_3<::GlobalNamespace::NodePoseSyncState,::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose,::GlobalNamespace::PoseSerializable>() const;
...
/// @brief Method SetState addr 0xdcc67c size 0x50 virtual true final true
 void SetState(::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose nodePose, ::GlobalNamespace::PoseSerializable pose) ;

/// @brief Method GetState addr 0xdcc6cc size 0x4c virtual true final true
 ::GlobalNamespace::PoseSerializable GetState(::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose nodePose) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__NodePoseSyncState__NodePose, "", "NodePoseSyncState/NodePose");
