...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData::*)()>(&GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData::__set_lightType(GlobalNamespace::BloomPrePassLightTypeSO value)  {
...
constexpr GlobalNamespace::BloomPrePassLightTypeSO GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData::__get_lightType() const {
...
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData::__set_preallocateCount(int32_t value)  {
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::*)()>(&GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::__set_mesh(UnityEngine::Mesh value)  {
...
constexpr UnityEngine::Mesh GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::__get_mesh() const {
return ::cordl_internals::getInstanceField<UnityEngine::Mesh, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::__set_lightQuads(::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData> GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::__get_lightQuads() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData::__set_subMeshDescriptor(UnityEngine::Rendering::SubMeshDescriptor value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BloomPrePassRendererSO::*)(GlobalNamespace::BloomPrePassLightTypeSO, GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData, int32_t)>(&GlobalNamespace::BloomPrePassRendererSO::PrepareLightsMeshRendering)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::BloomPrePassLightTypeSO>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void GlobalNamespace::BloomPrePassRendererSO::__set__preallocationData(::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData> GlobalNamespace::BloomPrePassRendererSO::__get__preallocationData() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::BloomPrePassRendererSO::__set__lightsRenderingData(System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData>>(value));
}
constexpr System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData> GlobalNamespace::BloomPrePassRendererSO::__get__lightsRenderingData() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, viewMatrix, projectionMatrix, linesWidth);
 ...
 void GlobalNamespace::BloomPrePassRendererSO::PrepareLightsMeshRendering(GlobalNamespace::BloomPrePassLightTypeSO lightType, GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData data, int32_t numberOfLights)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BloomPrePassRendererSO>::get(),
                            "PrepareLightsMeshRendering",
                            std::vector<Il2CppClass*>{},
