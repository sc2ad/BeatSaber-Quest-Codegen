...
constexpr ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType  ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType  ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::BeforeApplyingMinAlpha{1};
constexpr ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType  ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType::AfterApplyingMinAlpha{2};
...
constexpr void ::GlobalNamespace::SpriteLightWithId::__set__multiplyColorByAlpha(::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType ::GlobalNamespace::SpriteLightWithId::__get__multiplyColorByAlpha() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__SpriteLightWithId__MultiplyColorByAlphaType, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance);
}
