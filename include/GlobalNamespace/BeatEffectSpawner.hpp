...
namespace GlobalNamespace {
  ...
  class BeatEffectSpawner : public ::UnityEngine::MonoBehaviour/*, public ::GlobalNamespace::IBeatEffectDidFinishEvent*/ {
    ...
    char __padding1[0x4] = {};
    // [InjectAttribute] Offset: 0x111FE10
    ...
    // [InjectAttribute] Offset: 0x111FE20
    ...
    // [InjectAttribute] Offset: 0x111FE30
    ...
    // [InjectAttribute] Offset: 0x111FE40
    ...
    // [InjectAttribute] Offset: 0x111FE50
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatEffectSpawner), 96 + sizeof(::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*)> __GlobalNamespace_BeatEffectSpawnerSizeCheck;
