...
namespace GlobalNamespace {
  ...
  class BeatmapObjectExecutionRating : public ::Il2CppObject {
    ...
    check_size<sizeof(BeatmapObjectExecutionRating::BeatmapObjectExecutionRatingType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_BeatmapObjectExecutionRating_BeatmapObjectExecutionRatingTypeSizeCheck;
  ...
  check_size<sizeof(BeatmapObjectExecutionRating), 20 + sizeof(float) + ((20 + sizeof(float)) % 8 != 0 ? (8 - (20 + sizeof(float)) % 8) : 0)> __GlobalNamespace_BeatmapObjectExecutionRatingSizeCheck;
}
