...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapLevelDataLoaderSO::$LoadBeatmalLevelDataAsync$d__6), 48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelDataSO*>) + ((48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelDataSO*>)) % 8 != 0 ? (8 - (48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelDataSO*>)) % 8) : 0)> __GlobalNamespace_BeatmapLevelDataLoaderSO_$LoadBeatmalLevelDataAsync$d__6SizeCheck;
}
