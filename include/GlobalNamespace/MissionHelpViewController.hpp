...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MissionHelpViewController), 136 + sizeof(void*) + ((136 + sizeof(void*)) % 8 != 0 ? (8 - (136 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MissionHelpViewControllerSizeCheck;
}
