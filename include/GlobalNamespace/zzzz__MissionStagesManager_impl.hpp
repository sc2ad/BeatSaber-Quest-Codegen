...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::*)()>(&::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x214ae10;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get(),
                            ".ctor",
...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c._InitStages_b__6_0
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::*)(::GlobalNamespace::MissionStage)>(&::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::_InitStages_b__6_0)> {
 ...
 void ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::__set___9(::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c value)  {
::cordl_internals::setStaticField<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get>(std::forward<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>(value));
}
 ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::__get___9()  {
return ::cordl_internals::getStaticField<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get>();
}
 void ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::__set___9__6_0(::System::Func_2<::GlobalNamespace::MissionStage,int32_t> value)  {
::cordl_internals::setStaticField<::System::Func_2<::GlobalNamespace::MissionStage,int32_t>, "<>9__6_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get>(std::forward<::System::Func_2<::GlobalNamespace::MissionStage,int32_t>>(value));
}
 ::System::Func_2<::GlobalNamespace::MissionStage,int32_t> ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::__get___9__6_0()  {
return ::cordl_internals::getStaticField<::System::Func_2<::GlobalNamespace::MissionStage,int32_t>, "<>9__6_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get>();
}
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::____GlobalNamespace__MissionStagesManager____c()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__MissionStagesManager____c>())) {}
 void ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t ::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c::_InitStages_b__6_0(::GlobalNamespace::MissionStage stage)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MissionStagesManager____c>::get(),
                            "<InitStages>b__6_0",
                            std::vector<Il2CppClass*>{},
