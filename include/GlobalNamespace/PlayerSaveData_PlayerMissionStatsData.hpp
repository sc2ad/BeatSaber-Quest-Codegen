...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveData::PlayerMissionStatsData), 24 + sizeof(bool) + ((24 + sizeof(bool)) % 8 != 0 ? (8 - (24 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_PlayerSaveData_PlayerMissionStatsDataSizeCheck;
}
