...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultipliedAndAddedColorSO), 48 + sizeof(UnityEngine::Color) + ((48 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (48 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_MultipliedAndAddedColorSOSizeCheck;
}
