...
struct CORDL_TYPE GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob(GlobalNamespace::OVRSpace Space, Unity::Collections::NativeArray_1<int32_t> Length) noexcept;


                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob(GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob const&) = default;
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob(GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob&&) = default;
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob& operator=(GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob& operator=(GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob&& o) noexcept {
...
constexpr explicit GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE GlobalNamespace__OVRScenePlane__GetBoundaryJob : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to Unity::Jobs::IJob
constexpr operator  Unity::Jobs::IJob() const;
...
constexpr GlobalNamespace__OVRScenePlane__GetBoundaryJob(GlobalNamespace::OVRSpace Space, Unity::Collections::NativeArray_1<UnityEngine::Vector2> Boundary, Unity::Collections::NativeArray_1<UnityEngine::Vector2> PreviousBoundary) noexcept;


                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryJob(GlobalNamespace__OVRScenePlane__GetBoundaryJob const&) = default;
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryJob(GlobalNamespace__OVRScenePlane__GetBoundaryJob&&) = default;
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryJob& operator=(GlobalNamespace__OVRScenePlane__GetBoundaryJob const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRScenePlane__GetBoundaryJob& operator=(GlobalNamespace__OVRScenePlane__GetBoundaryJob&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRScenePlane__GetBoundaryJob(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using GetBoundaryJob = GlobalNamespace::GlobalNamespace__OVRScenePlane__GetBoundaryJob;

using GetBoundaryLengthJob = GlobalNamespace::GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRScenePlane__GetBoundaryJob, "", "OVRScenePlane/GetBoundaryJob");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRScenePlane__GetBoundaryLengthJob, "", "OVRScenePlane/GetBoundaryLengthJob");
