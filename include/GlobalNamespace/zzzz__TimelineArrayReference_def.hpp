...
namespace GlobalNamespace {
struct ____GlobalNamespace__TimelineArrayReference__ArrayTypes;
}
namespace GlobalNamespace {
...
struct CORDL_TYPE ____GlobalNamespace__TimelineArrayReference__ArrayTypes : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__TimelineArrayReference__ArrayTypes(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__TimelineArrayReference__ArrayTypes(____GlobalNamespace__TimelineArrayReference__ArrayTypes const&) = default;
                    constexpr ____GlobalNamespace__TimelineArrayReference__ArrayTypes(____GlobalNamespace__TimelineArrayReference__ArrayTypes&&) = default;
                    constexpr ____GlobalNamespace__TimelineArrayReference__ArrayTypes& operator=(____GlobalNamespace__TimelineArrayReference__ArrayTypes const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__TimelineArrayReference__ArrayTypes& operator=(____GlobalNamespace__TimelineArrayReference__ArrayTypes&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__TimelineArrayReference__ArrayTypes(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__TimelineArrayReference__ArrayTypes_Unwrapped : int32_t {
__TubeLight = 0,
__Transform = 1,
__Canvas = 2,
__TextMeshPro = 3,
...
constexpr operator ______GlobalNamespace__TimelineArrayReference__ArrayTypes_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__TimelineArrayReference__ArrayTypes_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes const TubeLight;

/// @brief Field Transform offset 0
static ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes const Transform;

/// @brief Field Canvas offset 0
static ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes const Canvas;

/// @brief Field TextMeshPro offset 0
static ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes const TextMeshPro;

/// @brief Field DirectionalLight offset 0
static ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes const DirectionalLight;
...
public:
// Declarations
using ArrayTypes = ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes;
...
// Fields
 ...
 ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes __declspec(property(get=__get_arrayType, put=__set_arrayType))  arrayType;

constexpr void __set_arrayType(::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes __get_arrayType() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__TimelineArrayReference__ArrayTypes, "", "TimelineArrayReference/ArrayTypes");
