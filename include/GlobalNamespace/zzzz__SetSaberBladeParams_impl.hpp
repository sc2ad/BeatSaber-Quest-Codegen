...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair::*)()>(&GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x210cbc8;
...
constexpr void GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair::__set_tintColor(UnityEngine::Color value)  {
...
constexpr UnityEngine::Color GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair::__get_tintColor() const {
return ::cordl_internals::getInstanceField<UnityEngine::Color, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair::__set_property(::StringW value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SetSaberBladeParams::*)()>(&GlobalNamespace::SetSaberBladeParams::Start)> {
  ...
  constexpr static std::size_t addrs = 0x210cabc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SetSaberBladeParams::*)()>(&GlobalNamespace::SetSaberBladeParams::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x210cbc0;
...
constexpr GlobalNamespace::SaberTypeObject GlobalNamespace::SetSaberBladeParams::__get__saber() const {
...
constexpr UnityEngine::MeshRenderer GlobalNamespace::SetSaberBladeParams::__get__meshRenderer() const {
return ::cordl_internals::getInstanceField<UnityEngine::MeshRenderer, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::SetSaberBladeParams::__set__propertyTintColorPairs(::ArrayW<GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair> GlobalNamespace::SetSaberBladeParams::__get__propertyTintColorPairs() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__SetSaberBladeParams__PropertyTintColorPair>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr GlobalNamespace::ColorManager GlobalNamespace::SetSaberBladeParams::__get__colorManager() const {
