...
namespace GlobalNamespace {
  ...
  check_size<sizeof(StandardLevelInfoSaveData_V100::DifficultyBeatmap), 44 + sizeof(int) + 8 - (44 + sizeof(int)) % 8> __GlobalNamespace_StandardLevelInfoSaveData_V100_DifficultyBeatmapSizeCheck;
}
