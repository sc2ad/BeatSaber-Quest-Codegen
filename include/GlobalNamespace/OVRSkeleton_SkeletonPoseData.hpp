...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRSkeleton::SkeletonPoseData), 41 + sizeof(bool) + ((41 + sizeof(bool)) % 8 != 0 ? (8 - (41 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRSkeleton_SkeletonPoseDataSizeCheck;
}
