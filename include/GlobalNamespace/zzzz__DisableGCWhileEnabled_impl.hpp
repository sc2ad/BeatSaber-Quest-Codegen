...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::DisableGCWhileEnabled::*)()>(&GlobalNamespace::DisableGCWhileEnabled::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x1f76840;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::DisableGCWhileEnabled>::get(),
                            "OnEnable",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::DisableGCWhileEnabled::*)()>(&GlobalNamespace::DisableGCWhileEnabled::OnDisable)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x1f7684c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::DisableGCWhileEnabled::*)()>(&GlobalNamespace::DisableGCWhileEnabled::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x1f76858;
...
// Ctor Parameters []
 GlobalNamespace::DisableGCWhileEnabled::DisableGCWhileEnabled()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<DisableGCWhileEnabled>())) {}
 void GlobalNamespace::DisableGCWhileEnabled::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::DisableGCWhileEnabled>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
