...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Renderer, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::BloomPrePassBackgroundSpriteRenderer GlobalNamespace::BloomPrePassBackgroundSpriteRenderer::New_ctor()  {
GlobalNamespace::BloomPrePassBackgroundSpriteRenderer o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BloomPrePassBackgroundSpriteRenderer>())};
return o;
}
