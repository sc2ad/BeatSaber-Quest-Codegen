...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4872), inst: 4483 }), TypeDefinitionIndex(TypeDefinitionIndex(4872)), TypeDefinitionIndex(TypeDefinitionIndex(4862))}
...
public:
// Declarations
using Pool = ::GlobalNamespace::____GlobalNamespace__MirroredGameNoteController__Pool;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10992)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 332 }), TypeDefinitionIndex(TypeDefinitionIndex(4871))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4870))
// CS Name: MirroredGameNoteController::Pool
class CORDL_TYPE ____GlobalNamespace__MirroredGameNoteController__Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::MirroredGameNoteController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__MirroredGameNoteController__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MirroredGameNoteController__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MirroredGameNoteController__Pool(____GlobalNamespace__MirroredGameNoteController__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MirroredGameNoteController__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MirroredGameNoteController__Pool(____GlobalNamespace__MirroredGameNoteController__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MirroredGameNoteController__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::MirroredGameNoteController>(ptr) {
}


  constexpr ____GlobalNamespace__MirroredGameNoteController__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MirroredGameNoteController__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MirroredGameNoteController__Pool& operator=(____GlobalNamespace__MirroredGameNoteController__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__MirroredGameNoteController__Pool& operator=(____GlobalNamespace__MirroredGameNoteController__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__MirroredGameNoteController__Pool() ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MirroredGameNoteController__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MirroredGameNoteController__Pool, "", "MirroredGameNoteController/Pool");
