...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveDataV1_0_1::PlayerMissionStatsData), 24 + sizeof(bool) + 8 - (24 + sizeof(bool)) % 8> __GlobalNamespace_PlayerSaveDataV1_0_1_PlayerMissionStatsDataSizeCheck;
}
