...
namespace GlobalNamespace {
  ...
  class EditAvatarAnalytics : public UnityEngine::MonoBehaviour {
    ...
    // Creating value type constructor for type: EditAvatarAnalytics
    EditAvatarAnalytics(GlobalNamespace::EditAvatarFlowCoordinator* editAvatarFlowCoordinator_ = {}, GlobalNamespace::EditAvatarViewController* editAvatarViewController_ = {}, GlobalNamespace::IAnalyticsModel* analyticsModel_ = {}, GlobalNamespace::AvatarDataModel* avatarDataModel_ = {}, GlobalNamespace::EditAvatarFlowCoordinator::EditAvatarType lastEditAvatarType_ = {}) noexcept : editAvatarFlowCoordinator{editAvatarFlowCoordinator_}, editAvatarViewController{editAvatarViewController_}, analyticsModel{analyticsModel_}, avatarDataModel{avatarDataModel_}, lastEditAvatarType{lastEditAvatarType_} {}
