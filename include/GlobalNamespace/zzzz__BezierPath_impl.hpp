...
constexpr void GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__BezierPath__ControlMode  GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::Aligned{0};
constexpr GlobalNamespace::GlobalNamespace__BezierPath__ControlMode  GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::Mirrored{1};
constexpr GlobalNamespace::GlobalNamespace__BezierPath__ControlMode  GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::Free{2};
constexpr GlobalNamespace::GlobalNamespace__BezierPath__ControlMode  GlobalNamespace::GlobalNamespace__BezierPath__ControlMode::Automatic{3};
//  Writing Method size for method: GlobalNamespace::BezierPath.get_controlPointMode
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode (GlobalNamespace::BezierPath::*)()>(&GlobalNamespace::BezierPath::get_controlPointMode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BezierPath::*)(GlobalNamespace::GlobalNamespace__BezierPath__ControlMode)>(&GlobalNamespace::BezierPath::set_controlPointMode)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void GlobalNamespace::BezierPath::__set__controlMode(GlobalNamespace::GlobalNamespace__BezierPath__ControlMode value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode>(value));
}
constexpr GlobalNamespace::GlobalNamespace__BezierPath__ControlMode GlobalNamespace::BezierPath::__get__controlMode() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<::ArrayW<float_t>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 GlobalNamespace::GlobalNamespace__BezierPath__ControlMode GlobalNamespace::BezierPath::get_controlPointMode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BezierPath>::get(),
                            "get_controlPointMode",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::GlobalNamespace__BezierPath__ControlMode, false>(const_cast<void*>(instance), ___internal_method);
}
 void GlobalNamespace::BezierPath::set_controlPointMode(GlobalNamespace::GlobalNamespace__BezierPath__ControlMode value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BezierPath>::get(),
                            "set_controlPointMode",
                            std::vector<Il2CppClass*>{},
