...
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType  ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType  ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::Equal{1};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType  ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::Max{2};
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType  ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType::Min{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType (::GlobalNamespace::MissionObjective::*)()>(&::GlobalNamespace::MissionObjective::get_referenceValueComparisonType)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void ::GlobalNamespace::MissionObjective::__set__referenceValueComparisonType(::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType ::GlobalNamespace::MissionObjective::__get__referenceValueComparisonType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::MissionObjectiveTypeSO, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType ::GlobalNamespace::MissionObjective::get_referenceValueComparisonType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionObjective>::get(),
                            "get_referenceValueComparisonType",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__MissionObjective__ReferenceValueComparisonType, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 ::GlobalNamespace::MissionObjective::MissionObjective()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<MissionObjective>())) {}
