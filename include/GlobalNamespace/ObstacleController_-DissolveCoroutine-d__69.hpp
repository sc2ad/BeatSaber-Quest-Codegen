...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: E12058
  class ObstacleController::$DissolveCoroutine$d__69 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>*/ {
    ...
    // Creating value type constructor for type: $DissolveCoroutine$d__69
    $DissolveCoroutine$d__69(int $$1__state_ = {}, ::Il2CppObject* $$2__current_ = {}, GlobalNamespace::ObstacleController* $$4__this_ = {}, float duration_ = {}) noexcept : $$1__state{$$1__state_}, $$2__current{$$2__current_}, $$4__this{$$4__this_}, duration{duration_} {}
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69::*)(int)>(&GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69::*)(int)>(&GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::ObstacleController::$DissolveCoroutine$d__69*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
