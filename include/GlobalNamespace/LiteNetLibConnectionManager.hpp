...
namespace GlobalNamespace {
  ...
  class LiteNetLibConnectionManager : public ::Il2CppObject/*, public GlobalNamespace::IConnectionManager, public LiteNetLib::INetEventListener*/ {
    ...
    check_size<sizeof(LiteNetLibConnectionManager::NetworkMode), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_LiteNetLibConnectionManager_NetworkModeSizeCheck;
    ...
    check_size<sizeof(LiteNetLibConnectionManager::ConnectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_LiteNetLibConnectionManager_ConnectionStateSizeCheck;
  ...
  check_size<sizeof(LiteNetLibConnectionManager), 200 + sizeof(void*) + 8 - (200 + sizeof(void*)) % 8> __GlobalNamespace_LiteNetLibConnectionManagerSizeCheck;
}
