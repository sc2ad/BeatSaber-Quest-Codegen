...
namespace GlobalNamespace {
  ...
  class IConnection;
  // Skipping declaration: IConnectionManager because it is already included!
...
namespace GlobalNamespace {
  ...
  class LiteNetLibConnectionManager : public ::Il2CppObject/*, public ::GlobalNamespace::INetworkConnectionManager, public ::LiteNetLib::INetEventListener*/ {
    public:
    ...
    public:
    // Creating interface conversion operator: operator ::GlobalNamespace::INetworkConnectionManager
    operator ::GlobalNamespace::INetworkConnectionManager() noexcept {
      return *reinterpret_cast<::GlobalNamespace::INetworkConnectionManager*>(this);
    }
    // Creating interface conversion operator: i_INetworkConnectionManager
    inline ::GlobalNamespace::INetworkConnectionManager* i_INetworkConnectionManager() noexcept {
      return reinterpret_cast<::GlobalNamespace::INetworkConnectionManager*>(this);
    }
    ...
    // Offset: 0x16276CC
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static LiteNetLibConnectionManager* New_ctor(::BGNet::Core::ITimeProvider* timeProvider, ::BGNet::Core::ITaskUtility* taskUtility) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::LiteNetLibConnectionManager::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<LiteNetLibConnectionManager*, creationType>(timeProvider, taskUtility)));
    }
    ...
    // private System.Boolean IsConnectedToUser(System.String userId)
    // Offset: 0x16287A0
    bool IsConnectedToUser(::StringW userId);
    // private System.Boolean HasConnectionToEndPoint(System.Net.IPEndPoint endPoint)
    // Offset: 0x1628854
    ...
    // static private LiteNetLib.DeliveryMethod ToLiteNetDeliveryMethod(BGNet.Core.DeliveryMethod deliveryMethod)
    // Offset: 0x1627918
    static ::LiteNetLib::DeliveryMethod ToLiteNetDeliveryMethod(::BGNet::Core::DeliveryMethod deliveryMethod);
    // static private BGNet.Core.DeliveryMethod FromLiteNetDeliveryMethod(LiteNetLib.DeliveryMethod deliveryMethod)
    // Offset: 0x1629274
    ...
    // private System.Void <DisposeAsync>b__101_0()
    // Offset: 0x1629910
    void $DisposeAsync$b__101_0();
  }; // LiteNetLibConnectionManager
  #pragma pack(pop)
  static check_size<sizeof(LiteNetLibConnectionManager), 224 + sizeof(::GlobalNamespace::NetworkStatisticsState::NetworkStatisticsUpdateDelegate*)> __GlobalNamespace_LiteNetLibConnectionManagerSizeCheck;
  static_assert(sizeof(LiteNetLibConnectionManager) == 0xE8);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::LiteNetLibConnectionManager::ToLiteNetDeliveryMethod
// Il2CppName: ToLiteNetDeliveryMethod
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LiteNetLib::DeliveryMethod (*)(::BGNet::Core::DeliveryMethod)>(&GlobalNamespace::LiteNetLibConnectionManager::ToLiteNetDeliveryMethod)> {
  static const MethodInfo* get() {
    static auto* deliveryMethod = &::il2cpp_utils::GetClassFromName("BGNet.Core", "DeliveryMethod")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LiteNetLibConnectionManager*), "ToLiteNetDeliveryMethod", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{deliveryMethod});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::LiteNetLibConnectionManager::FromLiteNetDeliveryMethod
// Il2CppName: FromLiteNetDeliveryMethod
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BGNet::Core::DeliveryMethod (*)(::LiteNetLib::DeliveryMethod)>(&GlobalNamespace::LiteNetLibConnectionManager::FromLiteNetDeliveryMethod)> {
  static const MethodInfo* get() {
    static auto* deliveryMethod = &::il2cpp_utils::GetClassFromName("LiteNetLib", "DeliveryMethod")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LiteNetLibConnectionManager*), "FromLiteNetDeliveryMethod", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{deliveryMethod});
  }
};
...
// Writing MetadataGetter for method: GlobalNamespace::LiteNetLibConnectionManager::$DisposeAsync$b__101_0
// Il2CppName: <DisposeAsync>b__101_0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LiteNetLibConnectionManager::*)()>(&GlobalNamespace::LiteNetLibConnectionManager::$DisposeAsync$b__101_0)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LiteNetLibConnectionManager*), "<DisposeAsync>b__101_0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
