...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerEnvironmentSpectatingSpot), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerEnvironmentSpectatingSpotSizeCheck;
}
