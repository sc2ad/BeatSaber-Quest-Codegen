...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MenuInstaller), 56 + sizeof(GlobalNamespace::ColorSchemeSO*)> __GlobalNamespace_MenuInstallerSizeCheck;
  static_assert(sizeof(MenuInstaller) == 0x40);
}
