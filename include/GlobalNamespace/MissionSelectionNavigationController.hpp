...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MissionSelectionNavigationController), 168 + sizeof(void*) + 8 - (168 + sizeof(void*)) % 8> __GlobalNamespace_MissionSelectionNavigationControllerSizeCheck;
}
