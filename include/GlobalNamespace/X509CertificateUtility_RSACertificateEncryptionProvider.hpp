...
// Il2CppName: SignData
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (GlobalNamespace::X509CertificateUtility::RSACertificateEncryptionProvider::*)(::ArrayWrapper<uint8_t>, int, int)>(&GlobalNamespace::X509CertificateUtility::RSACertificateEncryptionProvider::SignData)> {
  static const MethodInfo* get() {
