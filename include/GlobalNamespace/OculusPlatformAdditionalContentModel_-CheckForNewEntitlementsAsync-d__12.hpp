...
namespace GlobalNamespace {
  ...
  struct OculusPlatformAdditionalContentModel::$CheckForNewEntitlementsAsync$d__12 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
