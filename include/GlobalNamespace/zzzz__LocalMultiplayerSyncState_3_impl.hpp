...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LocalMultiplayerSyncState_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>::*)(GlobalNamespace::IConnectedPlayer, float_t, float_t, int32_t, GlobalNamespace::GlobalNamespace__StateBuffer_3__InterpolationDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>, GlobalNamespace::GlobalNamespace__StateBuffer_3__SmoothingDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>)>(&GlobalNamespace::LocalMultiplayerSyncState_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>::_ctor)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
// Ctor Parameters [CppParam { name: "player", ty: "GlobalNamespace::IConnectedPlayer", modifiers: "", def_value: None }, CppParam { name: "fullStateUpdateFrequency", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "deltaUpdateFrequency", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "size", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "interpolator", ty: "GlobalNamespace::GlobalNamespace__StateBuffer_3__InterpolationDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>", modifiers: "", def_value: None }, CppParam { name: "smoother", ty: "GlobalNamespace::GlobalNamespace__StateBuffer_3__SmoothingDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>", modifiers: "", def_value: Some("csnull") }]
 GlobalNamespace::LocalMultiplayerSyncState_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>::LocalMultiplayerSyncState_3(GlobalNamespace::IConnectedPlayer player, float_t fullStateUpdateFrequency, float_t deltaUpdateFrequency, int32_t size, GlobalNamespace::GlobalNamespace__StateBuffer_3__InterpolationDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t> interpolator, GlobalNamespace::GlobalNamespace__StateBuffer_3__SmoothingDelegate<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t> smoother)  : GlobalNamespace::MultiplayerSyncState_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,int32_t>(THROW_UNLESS(::il2cpp_utils::New<LocalMultiplayerSyncState_3>(player, fullStateUpdateFrequency, deltaUpdateFrequency, size, interpolator, smoother))) {}
