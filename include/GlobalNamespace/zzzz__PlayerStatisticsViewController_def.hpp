...
struct CORDL_TYPE GlobalNamespace__PlayerStatisticsViewController__StatsScopeData : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "_text_k__BackingField", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "_playerOverallStatsDataFunc_k__BackingField", ty: "System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__PlayerStatisticsViewController__StatsScopeData(::StringW _text_k__BackingField, System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> _playerOverallStatsDataFunc_k__BackingField) noexcept;


                    constexpr GlobalNamespace__PlayerStatisticsViewController__StatsScopeData(GlobalNamespace__PlayerStatisticsViewController__StatsScopeData const&) = default;
                    constexpr GlobalNamespace__PlayerStatisticsViewController__StatsScopeData(GlobalNamespace__PlayerStatisticsViewController__StatsScopeData&&) = default;
                    constexpr GlobalNamespace__PlayerStatisticsViewController__StatsScopeData& operator=(GlobalNamespace__PlayerStatisticsViewController__StatsScopeData const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__PlayerStatisticsViewController__StatsScopeData& operator=(GlobalNamespace__PlayerStatisticsViewController__StatsScopeData&& o) noexcept {
...
constexpr explicit GlobalNamespace__PlayerStatisticsViewController__StatsScopeData(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::StringW __get__text_k__BackingField() const;
 ...
 System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> __declspec(property(get=__get__playerOverallStatsDataFunc_k__BackingField, put=__set__playerOverallStatsDataFunc_k__BackingField))  _playerOverallStatsDataFunc_k__BackingField;

constexpr void __set__playerOverallStatsDataFunc_k__BackingField(System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> value) ;

constexpr System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> __get__playerOverallStatsDataFunc_k__BackingField() const;
...
// Properties
 ...
 System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> __declspec(property(get=get_playerOverallStatsDataFunc, put=set_playerOverallStatsDataFunc))  playerOverallStatsDataFunc;
...
/// @brief Method get_playerOverallStatsDataFunc addr 0x217dd80 size 0x8 virtual false final false
 System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> get_playerOverallStatsDataFunc() ;

/// @brief Method set_playerOverallStatsDataFunc addr 0x217dd88 size 0x8 virtual false final false
 void set_playerOverallStatsDataFunc(System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> value) ;

/// @brief Method .ctor addr 0x217d7ac size 0x8 virtual false final false
 void _ctor(::StringW text, System::Func_1<GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData> playerOverallStatsDataFunc) ;
...
public:
// Declarations
using StatsScopeData = GlobalNamespace::GlobalNamespace__PlayerStatisticsViewController__StatsScopeData;
...
constexpr GlobalNamespace::AppStaticSettingsSO __get__appStaticSettings() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__PlayerStatisticsViewController__StatsScopeData> __declspec(property(get=__get__statsScopeDatas, put=__set__statsScopeDatas))  _statsScopeDatas;

constexpr void __set__statsScopeDatas(::ArrayW<GlobalNamespace::GlobalNamespace__PlayerStatisticsViewController__StatsScopeData> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__PlayerStatisticsViewController__StatsScopeData> __get__statsScopeDatas() const;
...
/// @brief Method UpdateView addr 0x217d7b4 size 0x3e8 virtual false final false
 void UpdateView(GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData playerOverallStatsData) ;
...
/// @brief Method <DidActivate>b__15_1 addr 0x217dc94 size 0x2c virtual false final false
 GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData _DidActivate_b__15_1() ;

/// @brief Method <DidActivate>b__15_2 addr 0x217dcc0 size 0x2c virtual false final false
 GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData _DidActivate_b__15_2() ;

/// @brief Method <DidActivate>b__15_3 addr 0x217dcec size 0x2c virtual false final false
 GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData _DidActivate_b__15_3() ;

/// @brief Method <DidActivate>b__15_4 addr 0x217dd18 size 0x2c virtual false final false
 GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData _DidActivate_b__15_4() ;

/// @brief Method <DidActivate>b__15_0 addr 0x217dd44 size 0x2c virtual false final false
 GlobalNamespace::GlobalNamespace__PlayerAllOverallStatsData__PlayerOverallStatsData _DidActivate_b__15_0() ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__PlayerStatisticsViewController__StatsScopeData, "", "PlayerStatisticsViewController/StatsScopeData");
