...
namespace GlobalNamespace {
  ...
  class MultiplayerLocalPlayerDisconnectHelper : public ::Il2CppObject {
    ...
    static MultiplayerLocalPlayerDisconnectHelper* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MultiplayerLocalPlayerDisconnectHelper").WithContext(".ctor");
