...
static float_t GetMaximumBoundaryDistance(::UnityEngine::Camera camera, ::GlobalNamespace::____GlobalNamespace__OVRBoundary__BoundaryType boundaryType) ;

/// @brief Method BuildBoundaryMesh addr 0x25a5d7c size 0x480 virtual false final false
static ::UnityEngine::Mesh BuildBoundaryMesh(::GlobalNamespace::____GlobalNamespace__OVRBoundary__BoundaryType boundaryType, float_t topY, float_t bottomY) ;
