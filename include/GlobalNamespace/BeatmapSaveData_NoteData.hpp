...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapSaveData::NoteData), 32 + sizeof(GlobalNamespace::NoteCutDirection) + ((32 + sizeof(GlobalNamespace::NoteCutDirection)) % 8 != 0 ? (8 - (32 + sizeof(GlobalNamespace::NoteCutDirection)) % 8) : 0)> __GlobalNamespace_BeatmapSaveData_NoteDataSizeCheck;
}
