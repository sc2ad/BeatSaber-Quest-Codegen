...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: EFD534
  struct PlatformLeaderboardsModel::$Initialize$d__18/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // Get instance field reference: public PlatformLeaderboardsModel <>4__this
    GlobalNamespace::PlatformLeaderboardsModel*& dyn_$$4__this();
