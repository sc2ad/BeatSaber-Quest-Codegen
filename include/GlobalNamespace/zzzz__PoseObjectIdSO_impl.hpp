...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::PoseObjectIdSO GlobalNamespace::PoseObjectIdSO::New_ctor()  {
GlobalNamespace::PoseObjectIdSO o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::PoseObjectIdSO>())};
return o;
}
