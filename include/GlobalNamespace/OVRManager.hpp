...
namespace GlobalNamespace {
  ...
  class OVRManager : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRManager::TrackingOrigin), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_TrackingOriginSizeCheck;
    ...
    check_size<sizeof(OVRManager::XRDevice), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_XRDeviceSizeCheck;
    ...
    check_size<sizeof(OVRManager::CompositionMethod), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_CompositionMethodSizeCheck;
    ...
    check_size<sizeof(OVRManager::CameraDevice), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_CameraDeviceSizeCheck;
    ...
    check_size<sizeof(OVRManager::DepthQuality), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_DepthQualitySizeCheck;
    ...
    check_size<sizeof(OVRManager::VirtualGreenScreenType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_VirtualGreenScreenTypeSizeCheck;
    ...
    check_size<sizeof(OVRManager::MrcActivationMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRManager_MrcActivationModeSizeCheck;
  ...
  check_size<sizeof(OVRManager), 240 + sizeof(void*) + ((240 + sizeof(void*)) % 8 != 0 ? (8 - (240 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OVRManagerSizeCheck;
}
