...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__AlphabetScrollInfo__Data::*)(char16_t, int32_t)>(&GlobalNamespace::GlobalNamespace__AlphabetScrollInfo__Data::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__AlphabetScrollInfo__Data::__set_character(char16_t value)  {
::cordl_internals::setInstanceField<char16_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<char16_t>(value));
}
constexpr char16_t GlobalNamespace::GlobalNamespace__AlphabetScrollInfo__Data::__get_character() const {
return ::cordl_internals::getInstanceField<char16_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__AlphabetScrollInfo__Data::__set_cellIdx(int32_t value)  {
