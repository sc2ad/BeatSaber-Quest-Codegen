...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SpawnRotationChevronManager), 140 + sizeof(float) + ((140 + sizeof(float)) % 8 != 0 ? (8 - (140 + sizeof(float)) % 8) : 0)> __GlobalNamespace_SpawnRotationChevronManagerSizeCheck;
}
