...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BaseNetworkPlayerModel::$GetOtherPlayers$d__56), 32 + sizeof(int) + 8 - (32 + sizeof(int)) % 8> __GlobalNamespace_BaseNetworkPlayerModel_$GetOtherPlayers$d__56SizeCheck;
}
