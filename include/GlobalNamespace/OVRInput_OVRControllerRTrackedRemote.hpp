...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerRTrackedRemote), 268 + sizeof(float) + 8 - (268 + sizeof(float)) % 8> __GlobalNamespace_OVRInput_OVRControllerRTrackedRemoteSizeCheck;
}
