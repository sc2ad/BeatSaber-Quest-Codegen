...
namespace GlobalNamespace {
  ...
  class ServerPasswordEntryViewController : public HMUI::ViewController {
    ...
    static ServerPasswordEntryViewController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ServerPasswordEntryViewController").WithContext(".ctor");
