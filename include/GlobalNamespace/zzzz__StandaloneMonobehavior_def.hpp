...
struct CORDL_TYPE GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::StandaloneMonobehavior __4__this, System::Action action, System::Runtime::CompilerServices::TaskAwaiter_1<bool> __u__1) noexcept;


                    constexpr GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20(GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20 const&) = default;
                    constexpr GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20(GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20&&) = default;
                    constexpr GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20& operator=(GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20& operator=(GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20&& o) noexcept {
...
constexpr explicit GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, GlobalNamespace::StandaloneMonobehavior __4__this, System::Func_1<System::Threading::Tasks::Task> action, System::Runtime::CompilerServices::TaskAwaiter_1<bool> __u__1, System::Runtime::CompilerServices::TaskAwaiter __u__2) noexcept;


                    constexpr GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21(GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21 const&) = default;
                    constexpr GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21(GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21&&) = default;
                    constexpr GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21& operator=(GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21& operator=(GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25(GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25(GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25& operator=(GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25&& o) noexcept = default;
  constexpr GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25& operator=(GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25 const& o) noexcept = default;
...
public:
// Declarations
using _RunAsyncCoroutine_d__25 = GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25;

using _DispatchAsync_d__21 = GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21;

using _Dispatch_d__20 = GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___RunAsyncCoroutine_d__25, "", "StandaloneMonobehavior/<RunAsyncCoroutine>d__25");
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___DispatchAsync_d__21, "", "StandaloneMonobehavior/<DispatchAsync>d__21");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__StandaloneMonobehavior___Dispatch_d__20, "", "StandaloneMonobehavior/<Dispatch>d__20");
