...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::*)(BGNet::Core::ITaskUtility, GlobalNamespace::IMultiplayerSessionManager, ::StringW, GlobalNamespace::BeatmapLevelSelectionMask, GlobalNamespace::GameplayServerConfiguration, GlobalNamespace::IServerBeatmapProvider)>(&GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::_ctor)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0xdaf0d8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams>::get(),
                            ".ctor",
...
constexpr GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams(BGNet::Core::ITaskUtility taskUtility, GlobalNamespace::IMultiplayerSessionManager multiplayerSessionManager, ::StringW creatorId, GlobalNamespace::BeatmapLevelSelectionMask selectionMask, GlobalNamespace::GameplayServerConfiguration configuration, GlobalNamespace::IServerBeatmapProvider beatmapProvider) noexcept : ::bs_hook::ValueTypeWrapper() {this->taskUtility = taskUtility;
...
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_taskUtility(BGNet::Core::ITaskUtility value)  {
::cordl_internals::setInstanceField<BGNet::Core::ITaskUtility, 0x0>(this->__instance, std::forward<BGNet::Core::ITaskUtility>(value));
}
constexpr BGNet::Core::ITaskUtility GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__get_taskUtility() const {
return ::cordl_internals::getInstanceField<BGNet::Core::ITaskUtility, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_multiplayerSessionManager(GlobalNamespace::IMultiplayerSessionManager value)  {
...
constexpr GlobalNamespace::IMultiplayerSessionManager GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__get_multiplayerSessionManager() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::IMultiplayerSessionManager, 0x8>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_creatorId(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__get_creatorId() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_selectionMask(GlobalNamespace::BeatmapLevelSelectionMask value)  {
...
constexpr GlobalNamespace::BeatmapLevelSelectionMask GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__get_selectionMask() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::BeatmapLevelSelectionMask, 0x18>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_configuration(GlobalNamespace::GameplayServerConfiguration value)  {
...
constexpr GlobalNamespace::GameplayServerConfiguration GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__get_configuration() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GameplayServerConfiguration, 0x30>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams::__set_beatmapProvider(GlobalNamespace::IServerBeatmapProvider value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GameplayServerFiniteStateMachine::*)(GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams)>(&GlobalNamespace::GameplayServerFiniteStateMachine::_ctor)> {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 GlobalNamespace::GameplayServerFiniteStateMachine GlobalNamespace::GameplayServerFiniteStateMachine::New_ctor(GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams initParams)  {
GlobalNamespace::GameplayServerFiniteStateMachine o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::GameplayServerFiniteStateMachine>(initParams))};
return o;
}
 void GlobalNamespace::GameplayServerFiniteStateMachine::_ctor(GlobalNamespace::GlobalNamespace__GameplayServerFiniteStateMachine__InitParams initParams)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GameplayServerFiniteStateMachine>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
