...
namespace GlobalNamespace {
  ...
  class HelpMenuViewController : public HMUI::ViewController {
    ...
    // Creating value type constructor for type: HelpMenuViewController
    HelpMenuViewController(HMUI::TextSegmentedControl* helpMenuSegmentedControl_ = {}, System::Action_1<int>* didSelectHelpSubMenuEvent_ = {}, System::Collections::Generic::List_1<System::ValueTuple_2<HMUI::ViewController*, ::Il2CppString*>>* viewControllers_ = {}) noexcept : helpMenuSegmentedControl{helpMenuSegmentedControl_}, didSelectHelpSubMenuEvent{didSelectHelpSubMenuEvent_}, viewControllers{viewControllers_} {}
