...
namespace GlobalNamespace {
  ...
  class LocalNetworkPlayerModel : public GlobalNamespace::BaseNetworkPlayerModel {
    ...
    // [InjectAttribute] Offset: 0xDC453C
    ...
    // [InjectAttribute] Offset: 0xDC454C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC455C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC456C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC457C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDC458C
    ...
    bool CreateParty(GlobalNamespace::INetworkPlayerModelPartyConfig_1<T>* createConfig) {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("LocalNetworkPlayerModel").WithContext("CreateParty");
