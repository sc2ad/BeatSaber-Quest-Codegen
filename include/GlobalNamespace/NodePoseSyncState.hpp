...
namespace GlobalNamespace {
  ...
  check_size<sizeof(NodePoseSyncState), 56 + sizeof(GlobalNamespace::PoseSerializable) + ((56 + sizeof(GlobalNamespace::PoseSerializable)) % 8 != 0 ? (8 - (56 + sizeof(GlobalNamespace::PoseSerializable)) % 8) : 0)> __GlobalNamespace_NodePoseSyncStateSizeCheck;
}
