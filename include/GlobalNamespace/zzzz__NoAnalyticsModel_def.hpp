...
/// @brief Method get_supportsOpenDataPrivacyPage addr 0x20b2e74 size 0x8 virtual true final true
 bool get_supportsOpenDataPrivacyPage() ;

/// @brief Method OpenDataPrivacyPage addr 0x20b2e7c size 0x4 virtual true final true
