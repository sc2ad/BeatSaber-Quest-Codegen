...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusConnectionManager::ConnectToServerParams), 24 + sizeof(uint64_t) + ((24 + sizeof(uint64_t)) % 8 != 0 ? (8 - (24 + sizeof(uint64_t)) % 8) : 0)> __GlobalNamespace_OculusConnectionManager_ConnectToServerParamsSizeCheck;
}
