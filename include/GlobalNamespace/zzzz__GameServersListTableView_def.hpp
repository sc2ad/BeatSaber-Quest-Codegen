...
public:
// Declarations
/// @brief Convert operator to ::GlobalNamespace::____GlobalNamespace__TableViewWithDetailCell__IDataSource
constexpr operator  ::GlobalNamespace::____GlobalNamespace__TableViewWithDetailCell__IDataSource() const noexcept;
