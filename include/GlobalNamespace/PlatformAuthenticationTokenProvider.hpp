...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlatformAuthenticationTokenProvider::*)(GlobalNamespace::IPlatformUserModel*, GlobalNamespace::UserInfo*)>(&GlobalNamespace::PlatformAuthenticationTokenProvider::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::PlatformAuthenticationTokenProvider*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<GlobalNamespace::IPlatformUserModel*>(), ::il2cpp_utils::ExtractIndependentType<GlobalNamespace::UserInfo*>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlatformAuthenticationTokenProvider::*)(GlobalNamespace::IPlatformUserModel*, GlobalNamespace::UserInfo*)>(&GlobalNamespace::PlatformAuthenticationTokenProvider::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::PlatformAuthenticationTokenProvider*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<GlobalNamespace::IPlatformUserModel*>(), ::il2cpp_utils::ExtractIndependentType<GlobalNamespace::UserInfo*>()});
  }
};
