...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameScenesManager::SceneDismissType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_GameScenesManager_SceneDismissTypeSizeCheck;
}
