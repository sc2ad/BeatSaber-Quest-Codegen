...
namespace GlobalNamespace {
  ...
  class ObservableVariable_1 : public ::Il2CppObject/*, public GlobalNamespace::IValue_1<T>, public GlobalNamespace::IObservableChange*/ {
    ...
    System::Action* _get_didChangeEvent() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariable_1::_get_didChangeEvent");
    ...
    void _set_didChangeEvent(System::Action* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariable_1::_set_didChangeEvent");
      static auto ___internal__instance = this;
    ...
    T _get__value() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariable_1::_get__value");
      static auto ___internal__instance = this;
    ...
    void _set__value(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::ObservableVariable_1::_set__value");
      static auto ___internal__instance = this;
