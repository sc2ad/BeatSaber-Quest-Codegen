...
namespace GlobalNamespace {
  ...
  class BloomPrePassBackgroundColor : public GlobalNamespace::BloomPrePassNonLightPass {
    ...
    public:
    // [SpaceAttribute] Offset: 0xDA4574
    ...
    static BloomPrePassBackgroundColor* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BloomPrePassBackgroundColor").WithContext(".ctor");
