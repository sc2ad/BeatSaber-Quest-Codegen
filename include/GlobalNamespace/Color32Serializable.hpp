...
namespace GlobalNamespace {
  ...
  check_size<sizeof(Color32Serializable), 0 + sizeof(UnityEngine::Color32) + ((0 + sizeof(UnityEngine::Color32)) % 8 != 0 ? (8 - (0 + sizeof(UnityEngine::Color32)) % 8) : 0)> __GlobalNamespace_Color32SerializableSizeCheck;
}
