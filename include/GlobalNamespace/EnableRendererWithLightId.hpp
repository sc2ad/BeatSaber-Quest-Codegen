...
namespace GlobalNamespace {
  ...
  check_size<sizeof(EnableRendererWithLightId), 60 + sizeof(float) + ((60 + sizeof(float)) % 8 != 0 ? (8 - (60 + sizeof(float)) % 8) : 0)> __GlobalNamespace_EnableRendererWithLightIdSizeCheck;
}
