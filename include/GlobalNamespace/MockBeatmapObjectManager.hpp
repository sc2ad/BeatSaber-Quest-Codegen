...
namespace GlobalNamespace {
  ...
  class MockBeatmapObjectManager : public GlobalNamespace::BeatmapObjectManager {
    ...
    // Creating value type constructor for type: MockBeatmapObjectManager
    MockBeatmapObjectManager(System::Collections::Generic::List_1<GlobalNamespace::ObstacleController*>* activeObstacleControllers_ = {}) noexcept : activeObstacleControllers{activeObstacleControllers_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(MockBeatmapObjectManager), 104 + sizeof(System::Collections::Generic::List_1<GlobalNamespace::ObstacleController*>*)> __GlobalNamespace_MockBeatmapObjectManagerSizeCheck;
  static_assert(sizeof(MockBeatmapObjectManager) == 0x70);
}
