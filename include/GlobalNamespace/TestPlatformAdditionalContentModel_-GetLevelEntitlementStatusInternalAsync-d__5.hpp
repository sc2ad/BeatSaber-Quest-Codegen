...
namespace GlobalNamespace {
  ...
  struct TestPlatformAdditionalContentModel::$GetLevelEntitlementStatusInternalAsync$d__5 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
