...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HostLobbySetupViewController::CannotStartGameReason), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_HostLobbySetupViewController_CannotStartGameReasonSizeCheck;
}
