...
constexpr void GlobalNamespace::OVRResetOrientation::__set_resetButton(GlobalNamespace::GlobalNamespace__OVRInput__RawButton value)  {
...
constexpr GlobalNamespace::GlobalNamespace__OVRInput__RawButton GlobalNamespace::OVRResetOrientation::__get_resetButton() const {
...
GlobalNamespace::OVRResetOrientation o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::OVRResetOrientation>())};
return o;
}
