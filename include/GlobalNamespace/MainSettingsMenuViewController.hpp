...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MainSettingsMenuViewController), 144 + sizeof(int) + ((144 + sizeof(int)) % 8 != 0 ? (8 - (144 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MainSettingsMenuViewControllerSizeCheck;
}
