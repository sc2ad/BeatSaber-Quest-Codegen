...
namespace GlobalNamespace {
  ...
  struct LeaderboardsModelLegacyWrapper::$GetLeaderboardEntriesAsync$d__5 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
