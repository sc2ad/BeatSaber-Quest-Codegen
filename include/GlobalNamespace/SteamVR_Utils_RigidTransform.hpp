...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_Utils::RigidTransform), 12 + sizeof(UnityEngine::Quaternion) + ((12 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (12 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_SteamVR_Utils_RigidTransformSizeCheck;
