...
namespace GlobalNamespace {
  ...
  class HMCache_2 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_1<V>*& dyn_itemWillBeRemovedFromCacheEvent() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<K, V>*& dyn__cache() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Queue_1<K>*& dyn__addedElements() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn__maxNumberElements() {
