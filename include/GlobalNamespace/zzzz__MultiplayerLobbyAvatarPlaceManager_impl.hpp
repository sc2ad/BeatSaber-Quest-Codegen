...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)(float_t, float_t)>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::Activate)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20c51f4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::Deactivate)> {
  ...
  constexpr static std::size_t addrs = 0x20c5674;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::OnDestroy)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x20c57c4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::SpawnAllPlaces)> {
  ...
  constexpr static std::size_t addrs = 0x20c51fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::DespawnAllPlaces)> {
  ...
  constexpr static std::size_t addrs = 0x20c5678;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::_ctor)> {
  constexpr static std::size_t size = 0x7c;
  constexpr static std::size_t addrs = 0x20c57c8;
...
constexpr GlobalNamespace::ILobbyStateDataModel GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__get__lobbyStateDataModel() const {
...
constexpr void GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__set__avatarPlacesPool(GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool>(value));
}
constexpr GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__get__avatarPlacesPool() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::MultiplayerLobbyAvatarPlace>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::MultiplayerLobbyAvatarPlace>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::MultiplayerLobbyAvatarPlace> GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__get__allPlaces() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::MultiplayerLobbyAvatarPlace>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__get__innerCircleRadius() const {
...
constexpr float_t GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::__get__minOuterCircleRadius() const {
return ::cordl_internals::getInstanceField<float_t, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void GlobalNamespace::MultiplayerLobbyAvatarPlaceManager::Activate(float_t innerCircleRadius, float_t minOuterCircleRadius)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MultiplayerLobbyAvatarPlaceManager>::get(),
                            "Activate",
                            std::vector<Il2CppClass*>{},
