...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameServerBrowserViewController), 160 + sizeof(void*) + ((160 + sizeof(void*)) % 8 != 0 ? (8 - (160 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_GameServerBrowserViewControllerSizeCheck;
}
