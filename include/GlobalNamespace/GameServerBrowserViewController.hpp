...
namespace GlobalNamespace {
  ...
  class GameServerBrowserViewController : public HMUI::ViewController {
    public:
    // [HeaderAttribute] Offset: 0xE25C9C
    ...
    // [HeaderAttribute] Offset: 0xE25D08
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::UI::Button*) == 0x8);
    // [HeaderAttribute] Offset: 0xE25D54
    ...
    // [HeaderAttribute] Offset: 0xE25DA0
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GameServerBrowserViewController::*)()>(&GlobalNamespace::GameServerBrowserViewController::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::GameServerBrowserViewController*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GameServerBrowserViewController::*)()>(&GlobalNamespace::GameServerBrowserViewController::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::GameServerBrowserViewController*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
