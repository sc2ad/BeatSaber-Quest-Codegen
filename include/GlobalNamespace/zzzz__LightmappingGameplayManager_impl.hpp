...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::LightmappingGameplayManager GlobalNamespace::LightmappingGameplayManager::New_ctor()  {
GlobalNamespace::LightmappingGameplayManager o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::LightmappingGameplayManager>())};
return o;
}
