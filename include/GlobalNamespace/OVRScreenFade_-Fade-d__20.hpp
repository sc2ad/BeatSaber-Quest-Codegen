...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRScreenFade::$Fade$d__20), 48 + sizeof(float) + ((48 + sizeof(float)) % 8 != 0 ? (8 - (48 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRScreenFade_$Fade$d__20SizeCheck;
}
