...
namespace GlobalNamespace {
  ...
  class ModifiersSelectionView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xDD20C4
    ...
    static ModifiersSelectionView* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("ModifiersSelectionView").WithContext(".ctor");
