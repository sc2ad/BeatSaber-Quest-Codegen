...
namespace GlobalNamespace {
  ...
  class NetworkPacketSerializer_2 : public ::Il2CppObject/*, public ::GlobalNamespace::INetworkPacketSerializer_1<TData>, public ::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*/ {
    ...
    class $$c__DisplayClass4_0_1 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated("Use field access instead!")]] ::System::Action_1<TPacket>*& dyn_callback() {
      ...
      void $RegisterCallback$b__0(TPacket packet, TData data) {
        ...
        ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, packet, data);
      }
    ...
    class $$c__DisplayClass5_0_1 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated("Use field access instead!")]] ::System::Func_1<TPacket>*& dyn_constructor() {
      ...
      TPacket $RegisterCallback$b__1(TData data) {
        ...
        return ::il2cpp_utils::RunMethodRethrow<TPacket, false>(this, ___internal__method, data);
      }
    ...
    class $$c__DisplayClass8_0_1 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated("Use field access instead!")]] ::System::Func_2<TData, TPacket>*& dyn_constructor() {
      ...
      [[deprecated("Use field access instead!")]] ::System::Action_2<TPacket, TData>*& dyn_callback() {
      ...
      [[deprecated("Use field access instead!")]] ::System::Func_4<::LiteNetLib::Utils::NetDataReader*, int, TData, TPacket>*& dyn_deserialize() {
      ...
      TPacket $RegisterCallback$b__0(::LiteNetLib::Utils::NetDataReader* reader, int size, TData data) {
        ...
        return ::il2cpp_utils::RunMethodRethrow<TPacket, false>(this, ___internal__method, reader, size, data);
      }
      ...
      void $RegisterCallback$b__1(::LiteNetLib::Utils::NetDataReader* reader, int size, TData data) {
        ...
        ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, reader, size, data);
      }
    ...
    class $$c__DisplayClass10_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated("Use field access instead!")]] ::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*& dyn_subSubSerializer() {
    ...
    // Creating interface conversion operator: i_INetworkPacketSerializer_1_TData
    inline ::GlobalNamespace::INetworkPacketSerializer_1<TData>* i_INetworkPacketSerializer_1_TData() noexcept {
      return reinterpret_cast<::GlobalNamespace::INetworkPacketSerializer_1<TData>*>(this);
    }
    ...
    // Creating interface conversion operator: i_INetworkPacketSubSerializer_1_TData
    inline ::GlobalNamespace::INetworkPacketSubSerializer_1<TData>* i_INetworkPacketSubSerializer_1_TData() noexcept {
      return reinterpret_cast<::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*>(this);
    }
    // Autogenerated instance field getter
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<uint8_t, ::System::Action_3<::LiteNetLib::Utils::NetDataReader*, int, TData>*>*& dyn__messsageHandlers() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<::System::Type*, uint8_t>*& dyn__typeRegistry() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*, uint8_t>*& dyn__subSerializerRegistry() {
    ...
    [[deprecated("Use field access instead!")]] ::LiteNetLib::Utils::NetDataWriter*& dyn__internalWriter() {
    ...
    void RegisterCallback(TType packetType, ::System::Action_1<TPacket>* callback) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<TPacket>, ::LiteNetLib::Utils::INetSerializable>);
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___generic__method, packetType, callback);
    }
    ...
    void RegisterCallback(TType packetType, ::System::Action_1<TPacket>* callback, ::System::Func_1<TPacket>* constructor) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TPacket>::get()}));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___generic__method, packetType, callback, constructor);
    }
    ...
    void UnregisterCallback(TType packetType) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TPacket>::get()}));
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___generic__method, packetType);
    }
    ...
    void RegisterSubSerializer(TType packetType, ::GlobalNamespace::INetworkPacketSubSerializer_1<TData>* subSubSerializer) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, packetType, subSubSerializer);
    }
    ...
    void SerializePacketInternal(::LiteNetLib::Utils::NetDataWriter* externalWriter, ::LiteNetLib::Utils::INetSerializable* packet, bool prependLength) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, externalWriter, packet, prependLength);
    }
    ...
    bool ProcessPacket(::LiteNetLib::Utils::NetDataReader* reader, TData data) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<bool, false>(this, ___internal__method, reader, data);
    }
    ...
    bool TryGetPacketType(::System::Type* type, ByRef<uint8_t> packetType, ByRef<::GlobalNamespace::INetworkPacketSubSerializer_1<TData>*> subSerializer) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<bool, false>(this, ___internal__method, type, byref(packetType), byref(subSerializer));
    }
