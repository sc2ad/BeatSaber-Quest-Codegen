...
namespace GlobalNamespace {
  ...
  class NetworkPacketSerializer_2 : public ::Il2CppObject/*, public GlobalNamespace::INetworkPacketSerializer_1<TData>, public GlobalNamespace::INetworkPacketSubSerializer_1<TData>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D058AC
    template<typename TPacket>
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D058BC
    template<typename TPacket>
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D058CC
    template<typename TPacket>
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D058DC
    template<typename TPacket>
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D058EC
    ...
    void SerializePacket(LiteNetLib::Utils::NetDataWriter* writer, LiteNetLib::Utils::INetSerializable* packet) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "SerializePacket", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(writer, packet)));
    ...
    void ProcessAllPackets(LiteNetLib::Utils::NetDataReader* reader, TData data) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "ProcessAllPackets", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(reader, data)));
    ...
    void INetworkPacketSubSerializer$TData$_Serialize(LiteNetLib::Utils::NetDataWriter* writer, LiteNetLib::Utils::INetSerializable* packet) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "INetworkPacketSubSerializer<TData>.Serialize", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(writer, packet))));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, writer, packet);
    }
    ...
    void INetworkPacketSubSerializer$TData$_Deserialize(LiteNetLib::Utils::NetDataReader* reader, int length, TData data) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "INetworkPacketSubSerializer<TData>.Deserialize", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(reader, length, data))));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, reader, length, data);
    }
