...
constexpr  ::GlobalNamespace::IScoreSyncStateManager::operator ::GlobalNamespace::IScoreSyncStateManager_5<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score,int32_t,::GlobalNamespace::StandardScoreSyncStateNetSerializable,::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable>() const noexcept {
