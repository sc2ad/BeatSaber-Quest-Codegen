...
namespace GlobalNamespace {
  ...
  struct StandardLevelDetailViewController::$OpenLevelProductStoreOrShowBuyInfoAsync$d__49 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
