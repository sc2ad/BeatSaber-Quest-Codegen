...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::EnvironmentColorType (*)(GlobalNamespace::BasicBeatmapEventData)>(&GlobalNamespace::BeatmapEventDataLightsExtensions::LightColorTypeFromEventDataValue)> {
  ...
  constexpr static std::size_t addrs = 0xd91894;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::EnvironmentColorType (*)(int32_t)>(&GlobalNamespace::BeatmapEventDataLightsExtensions::GetLightColorTypeFromEventDataValue)> {
  ...
  constexpr static std::size_t addrs = 0xd918ac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(GlobalNamespace::BasicBeatmapEventData)>(&GlobalNamespace::BeatmapEventDataLightsExtensions::HasLightFadeEventDataValue)> {
  ...
  constexpr static std::size_t addrs = 0xd918d8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(GlobalNamespace::BasicBeatmapEventData)>(&GlobalNamespace::BeatmapEventDataLightsExtensions::HasFixedDurationLightSwitchEventDataValue)> {
  ...
  constexpr static std::size_t addrs = 0xd9190c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(int32_t)>(&GlobalNamespace::BeatmapEventDataLightsExtensions::HasFixedDurationLightSwitchEventDataValue)> {
  ...
  constexpr static std::size_t addrs = 0xd91958;
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::EnvironmentColorType, false>(nullptr, ___internal_method, basicBeatmapEventData);
 ...
 GlobalNamespace::EnvironmentColorType GlobalNamespace::BeatmapEventDataLightsExtensions::GetLightColorTypeFromEventDataValue(int32_t beatmapEventValue)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BeatmapEventDataLightsExtensions>::get(),
                            "GetLightColorTypeFromEventDataValue",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, basicBeatmapEventData);
 ...
 bool GlobalNamespace::BeatmapEventDataLightsExtensions::HasFixedDurationLightSwitchEventDataValue(int32_t beatmapEventValue)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BeatmapEventDataLightsExtensions>::get(),
                            "HasFixedDurationLightSwitchEventDataValue",
                            std::vector<Il2CppClass*>{},
