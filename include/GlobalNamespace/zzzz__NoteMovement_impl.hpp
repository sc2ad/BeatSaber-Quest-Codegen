...
constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::____GlobalNamespace__NoteMovement__MovementPhase(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase  ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::None{0};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase  ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::MovingOnTheFloor{1};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase  ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase::Jumping{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase (::GlobalNamespace::NoteMovement::*)()>(&::GlobalNamespace::NoteMovement::get_movementPhase)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteMovement::*)(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase)>(&::GlobalNamespace::NoteMovement::set_movementPhase)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_movementPhase",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::NoteMovement::__set__movementPhase_k__BackingField(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase ::GlobalNamespace::NoteMovement::__get__movementPhase_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase ::GlobalNamespace::NoteMovement::get_movementPhase()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteMovement>::get(),
                            "get_movementPhase",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::GlobalNamespace::NoteMovement::set_movementPhase(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteMovement>::get(),
                            "set_movementPhase",
                            std::vector<Il2CppClass*>{},
