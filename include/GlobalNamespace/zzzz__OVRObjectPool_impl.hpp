...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, queue);
 ...
 void ::GlobalNamespace::____GlobalNamespace__OVRObjectPool__Storage_1::__set_HashSet(::System::Collections::Generic::HashSet_1<T> value)  {
::cordl_internals::setStaticField<::System::Collections::Generic::HashSet_1<T>, "HashSet", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__OVRObjectPool__Storage_1>::get>(std::forward<::System::Collections::Generic::HashSet_1<T>>(value));
}
 ::System::Collections::Generic::HashSet_1<T> ::GlobalNamespace::____GlobalNamespace__OVRObjectPool__Storage_1::__get_HashSet()  {
return ::cordl_internals::getStaticField<::System::Collections::Generic::HashSet_1<T>, "HashSet", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__OVRObjectPool__Storage_1>::get>();
}
