...
namespace GlobalNamespace {
  ...
  struct AsyncHelper::$$c__DisplayClass1_0::$$RunSync$b__0$d : public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine {
    ...
    constexpr $$RunSync$b__0$d(int $$1__state_ = {}, System::Runtime::CompilerServices::AsyncTaskMethodBuilder $$t__builder_ = {}, GlobalNamespace::AsyncHelper::$$c__DisplayClass1_0* $$4__this_ = {}, System::Runtime::CompilerServices::TaskAwaiter $$u__1_ = {}) : $$1__state{$$1__state_}, $$t__builder{$$t__builder_}, $$4__this{$$4__this_}, $$u__1{$$u__1_} {}
