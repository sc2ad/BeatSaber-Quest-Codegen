...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::*)(bool)>(&::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2276e04;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::__set_recordingEnabled(bool value)  {
::cordl_internals::setInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::__get_recordingEnabled() const {
return ::cordl_internals::getInstanceField<bool, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "recordingEnabled", ty: "bool", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::____GlobalNamespace__RecordingUIController__InitData(bool recordingEnabled)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__RecordingUIController__InitData>(recordingEnabled))) {}
 void ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData::_ctor(bool recordingEnabled)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::RecordingUIController::__set__initData(::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData ::GlobalNamespace::RecordingUIController::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__RecordingUIController__InitData, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
