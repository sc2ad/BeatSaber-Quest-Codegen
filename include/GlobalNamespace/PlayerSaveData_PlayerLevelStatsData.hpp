...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveData::PlayerLevelStatsData), 60 + sizeof(int) + ((60 + sizeof(int)) % 8 != 0 ? (8 - (60 + sizeof(int)) % 8) : 0)> __GlobalNamespace_PlayerSaveData_PlayerLevelStatsDataSizeCheck;
}
