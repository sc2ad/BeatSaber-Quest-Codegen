...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D31320
  ...
  #pragma pack(pop)
  static check_size<sizeof(MultiplayerLevelFinishedController::$StartLevelFinished$d__19), 52 + sizeof(float)> __GlobalNamespace_MultiplayerLevelFinishedController_$StartLevelFinished$d__19SizeCheck;
  static_assert(sizeof(MultiplayerLevelFinishedController::$StartLevelFinished$d__19) == 0x38);
}
