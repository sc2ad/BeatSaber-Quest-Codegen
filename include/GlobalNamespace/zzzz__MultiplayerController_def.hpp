...
struct CORDL_TYPE GlobalNamespace__MultiplayerController__State : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__MultiplayerController__State(int32_t value__) noexcept;


                    constexpr GlobalNamespace__MultiplayerController__State(GlobalNamespace__MultiplayerController__State const&) = default;
                    constexpr GlobalNamespace__MultiplayerController__State(GlobalNamespace__MultiplayerController__State&&) = default;
                    constexpr GlobalNamespace__MultiplayerController__State& operator=(GlobalNamespace__MultiplayerController__State const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__MultiplayerController__State& operator=(GlobalNamespace__MultiplayerController__State&& o) noexcept {
...
constexpr explicit GlobalNamespace__MultiplayerController__State(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__MultiplayerController__State_Unwrapped : int32_t {
...
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const CheckingLobbyState;

/// @brief Field WaitingForPlayers offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const WaitingForPlayers;

/// @brief Field SongStartSync offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const SongStartSync;

/// @brief Field Intro offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const Intro;

/// @brief Field Gameplay offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const Gameplay;

/// @brief Field Outro offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const Outro;

/// @brief Field Finished offset 0
static GlobalNamespace::GlobalNamespace__MultiplayerController__State const Finished;
...
class CORDL_TYPE GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37(GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37(GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37& operator=(GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37&& o) noexcept = default;
  constexpr GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37& operator=(GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37 const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__MultiplayerController____c__DisplayClass42_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__MultiplayerController____c__DisplayClass42_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController____c__DisplayClass42_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0(GlobalNamespace__MultiplayerController____c__DisplayClass42_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController____c__DisplayClass42_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0(GlobalNamespace__MultiplayerController____c__DisplayClass42_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__MultiplayerController____c__DisplayClass42_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0& operator=(GlobalNamespace__MultiplayerController____c__DisplayClass42_0&& o) noexcept = default;
  constexpr GlobalNamespace__MultiplayerController____c__DisplayClass42_0& operator=(GlobalNamespace__MultiplayerController____c__DisplayClass42_0 const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__MultiplayerController____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~GlobalNamespace__MultiplayerController____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController____c", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController____c(GlobalNamespace__MultiplayerController____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__MultiplayerController____c", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__MultiplayerController____c(GlobalNamespace__MultiplayerController____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__MultiplayerController____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__MultiplayerController____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__MultiplayerController____c& operator=(GlobalNamespace__MultiplayerController____c&& o) noexcept = default;
  constexpr GlobalNamespace__MultiplayerController____c& operator=(GlobalNamespace__MultiplayerController____c const& o) noexcept = default;
                


// Fields

static GlobalNamespace::GlobalNamespace__MultiplayerController____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__MultiplayerController____c value) ;

static GlobalNamespace::GlobalNamespace__MultiplayerController____c __get___9() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__MultiplayerController____c;

using __c__DisplayClass42_0 = GlobalNamespace::GlobalNamespace__MultiplayerController____c__DisplayClass42_0;

using _PerformSongStartSync_d__37 = GlobalNamespace::GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37;

using State = GlobalNamespace::GlobalNamespace__MultiplayerController__State;
...
constexpr GlobalNamespace::MultiplayerBadgesProvider __get__badgesProvider() const;
 ...
 System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> __declspec(property(get=__get_stateChangedEvent, put=__set_stateChangedEvent))  stateChangedEvent;

constexpr void __set_stateChangedEvent(System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> value) ;

constexpr System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> __get_stateChangedEvent() const;
...
constexpr GlobalNamespace::MultiplayerPlayerStartState __get__localPlayerSyncStartState() const;
 ...
 GlobalNamespace::GlobalNamespace__MultiplayerController__State __declspec(property(get=__get__state, put=__set__state))  _state;

constexpr void __set__state(GlobalNamespace::GlobalNamespace__MultiplayerController__State value) ;

constexpr GlobalNamespace::GlobalNamespace__MultiplayerController__State __get__state() const;
...
// Properties
 ...
 GlobalNamespace::GlobalNamespace__MultiplayerController__State __declspec(property(get=get_state))  state;


// Methods

/// @brief Method get_state addr 0x20f1768 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__MultiplayerController__State get_state() ;

/// @brief Method add_stateChangedEvent addr 0x20f1770 size 0xb0 virtual false final false
 void add_stateChangedEvent(System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> value) ;

/// @brief Method remove_stateChangedEvent addr 0x20f1820 size 0xb0 virtual false final false
 void remove_stateChangedEvent(System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> value) ;
...
/// @brief Method ChangeState addr 0x20f20ac size 0x20 virtual false final false
 void ChangeState(GlobalNamespace::GlobalNamespace__MultiplayerController__State newState) ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__MultiplayerController__State, "", "MultiplayerController/State");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__MultiplayerController___PerformSongStartSync_d__37, "", "MultiplayerController/<PerformSongStartSync>d__37");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__MultiplayerController____c);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__MultiplayerController____c, "", "MultiplayerController/<>c");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__MultiplayerController____c__DisplayClass42_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__MultiplayerController____c__DisplayClass42_0, "", "MultiplayerController/<>c__DisplayClass42_0");
