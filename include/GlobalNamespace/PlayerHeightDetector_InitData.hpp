...
namespace GlobalNamespace {
  ...
  class PlayerHeightDetector::InitData : public ::Il2CppObject {
    ...
    // public readonly System.Single startPlayerHeight
    // Size: 0x4
    // Offset: 0x14
    float startPlayerHeight;
    // Field size check
    static_assert(sizeof(float) == 0x4);
    public:
    ...
    static PlayerHeightDetector::InitData* New_ctor(float headPosToPlayerHeightOffset, float startPlayerHeight) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<PlayerHeightDetector::InitData*, creationType>(headPosToPlayerHeightOffset, startPlayerHeight)));
    }
  }; // PlayerHeightDetector/InitData
  #pragma pack(pop)
  static check_size<sizeof(PlayerHeightDetector::InitData), 20 + sizeof(float)> __GlobalNamespace_PlayerHeightDetector_InitDataSizeCheck;
  static_assert(sizeof(PlayerHeightDetector::InitData) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
