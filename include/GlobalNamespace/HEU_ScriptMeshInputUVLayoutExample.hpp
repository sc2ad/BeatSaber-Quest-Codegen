...
namespace GlobalNamespace {
  ...
  class HEU_ScriptMeshInputUVLayoutExample : public ::Il2CppObject {
    ...
    struct OutputMode;
    // Creating value type constructor for type: HEU_ScriptMeshInputUVLayoutExample
    HEU_ScriptMeshInputUVLayoutExample() noexcept {}
    ...
    // Offset: 0x1461AD0
    static void ApplyUVLayoutTo(::Array<UnityEngine::GameObject*>* gameObjects, GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::OutputMode outputMode, ::Il2CppString* output_name_suffix);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Array<UnityEngine::GameObject*>*, GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::OutputMode, ::Il2CppString*)>(&GlobalNamespace::HEU_ScriptMeshInputUVLayoutExample::ApplyUVLayoutTo)> {
