...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SimpleRetailDemoFlowCoordinator), 304 + sizeof(void*) + ((304 + sizeof(void*)) % 8 != 0 ? (8 - (304 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_SimpleRetailDemoFlowCoordinatorSizeCheck;
}
