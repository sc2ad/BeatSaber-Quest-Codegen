...
namespace GlobalNamespace {
struct ____GlobalNamespace__DynamicBone__FreezeAxis;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__DynamicBone__UpdateMode;
}
namespace GlobalNamespace {
class DynamicBone;
}
namespace GlobalNamespace {
class ____GlobalNamespace__DynamicBone__Particle;
}
// Type: ::UpdateMode
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ____GlobalNamespace__DynamicBone__UpdateMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__DynamicBone__UpdateMode(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__DynamicBone__UpdateMode(____GlobalNamespace__DynamicBone__UpdateMode const&) = default;
                    constexpr ____GlobalNamespace__DynamicBone__UpdateMode(____GlobalNamespace__DynamicBone__UpdateMode&&) = default;
                    constexpr ____GlobalNamespace__DynamicBone__UpdateMode& operator=(____GlobalNamespace__DynamicBone__UpdateMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__DynamicBone__UpdateMode& operator=(____GlobalNamespace__DynamicBone__UpdateMode&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__DynamicBone__UpdateMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__DynamicBone__UpdateMode_Unwrapped : int32_t {
__Normal = 0,
__AnimatePhysics = 1,
__UnscaledTime = 2,
};
...
constexpr operator ______GlobalNamespace__DynamicBone__UpdateMode_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__DynamicBone__UpdateMode_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode const Normal;

/// @brief Field AnimatePhysics offset 0
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode const AnimatePhysics;

/// @brief Field UnscaledTime offset 0
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode const UnscaledTime;
...
struct CORDL_TYPE ____GlobalNamespace__DynamicBone__FreezeAxis : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__DynamicBone__FreezeAxis(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__DynamicBone__FreezeAxis(____GlobalNamespace__DynamicBone__FreezeAxis const&) = default;
                    constexpr ____GlobalNamespace__DynamicBone__FreezeAxis(____GlobalNamespace__DynamicBone__FreezeAxis&&) = default;
                    constexpr ____GlobalNamespace__DynamicBone__FreezeAxis& operator=(____GlobalNamespace__DynamicBone__FreezeAxis const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__DynamicBone__FreezeAxis& operator=(____GlobalNamespace__DynamicBone__FreezeAxis&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__DynamicBone__FreezeAxis(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__DynamicBone__FreezeAxis_Unwrapped : int32_t {
__None = 0,
__X = 1,
__Y = 2,
__Z = 3,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______GlobalNamespace__DynamicBone__FreezeAxis_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__DynamicBone__FreezeAxis_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis const None;

/// @brief Field X offset 0
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis const X;

/// @brief Field Y offset 0
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis const Y;

/// @brief Field Z offset 0
static ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis const Z;
...
class CORDL_TYPE ____GlobalNamespace__DynamicBone__Particle : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x78};

virtual ~____GlobalNamespace__DynamicBone__Particle() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__DynamicBone__Particle", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__DynamicBone__Particle(____GlobalNamespace__DynamicBone__Particle const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__DynamicBone__Particle", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__DynamicBone__Particle(____GlobalNamespace__DynamicBone__Particle&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__DynamicBone__Particle(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__DynamicBone__Particle& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__DynamicBone__Particle& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__DynamicBone__Particle& operator=(____GlobalNamespace__DynamicBone__Particle&& o) noexcept = default;
  constexpr ____GlobalNamespace__DynamicBone__Particle& operator=(____GlobalNamespace__DynamicBone__Particle const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__DynamicBone__Particle() ;
...
public:
// Declarations
using Particle = ::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle;

using FreezeAxis = ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis;

using UpdateMode = ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode;
...
constexpr float_t __get_m_UpdateRate() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode __declspec(property(get=__get_m_UpdateMode, put=__set_m_UpdateMode))  m_UpdateMode;

constexpr void __set_m_UpdateMode(::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode __get_m_UpdateMode() const;
...
constexpr ::System::Collections::Generic::List_1<::UnityEngine::Transform> __get_m_Exclusions() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis __declspec(property(get=__get_m_FreezeAxis, put=__set_m_FreezeAxis))  m_FreezeAxis;

constexpr void __set_m_FreezeAxis(::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis __get_m_FreezeAxis() const;
...
constexpr bool __get_m_DistantDisabled() const;
 ...
 ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle> __declspec(property(get=__get_m_Particles, put=__set_m_Particles))  m_Particles;

constexpr void __set_m_Particles(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle> value) ;

constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle> __get_m_Particles() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__DynamicBone__FreezeAxis, "", "DynamicBone/FreezeAxis");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__DynamicBone__UpdateMode, "", "DynamicBone/UpdateMode");
NEED_NO_BOX(::GlobalNamespace::DynamicBone);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::DynamicBone, "", "DynamicBone");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__DynamicBone__Particle, "", "DynamicBone/Particle");
