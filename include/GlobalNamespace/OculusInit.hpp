...
namespace GlobalNamespace {
  ...
  class OculusInit : public UnityEngine::MonoBehaviour {
    ...
    OculusInit(GlobalNamespace::OculusDeeplinkManager* oculusDeeplinkManager_ = {}, GlobalNamespace::DlcPromoPanelModel* dlcPromoPanelModel_ = {}) noexcept : oculusDeeplinkManager{oculusDeeplinkManager_}, dlcPromoPanelModel{dlcPromoPanelModel_} {}
