...
class CORDL_TYPE ____GlobalNamespace__UnityXRController__Configuration : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____GlobalNamespace__UnityXRController__Configuration() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__UnityXRController__Configuration", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__UnityXRController__Configuration(____GlobalNamespace__UnityXRController__Configuration const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__UnityXRController__Configuration", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__UnityXRController__Configuration(____GlobalNamespace__UnityXRController__Configuration&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__UnityXRController__Configuration(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__UnityXRController__Configuration& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__UnityXRController__Configuration& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__UnityXRController__Configuration& operator=(____GlobalNamespace__UnityXRController__Configuration&& o) noexcept = default;
  constexpr ____GlobalNamespace__UnityXRController__Configuration& operator=(____GlobalNamespace__UnityXRController__Configuration const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__UnityXRController__Configuration() ;
...
public:
// Declarations
using Configuration = ::GlobalNamespace::____GlobalNamespace__UnityXRController__Configuration;
...
constexpr ::UnityEngine::XR::XRNode __get_node() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName __declspec(property(get=__get__manufacturerName_k__BackingField, put=__set__manufacturerName_k__BackingField))  _manufacturerName_k__BackingField;

constexpr void __set__manufacturerName_k__BackingField(::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName __get__manufacturerName_k__BackingField() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName __declspec(property(get=get_manufacturerName, put=set_manufacturerName))  manufacturerName;
...
/// @brief Method get_manufacturerName addr 0x1f8b9cc size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName get_manufacturerName() ;

/// @brief Method set_manufacturerName addr 0x1f8b9d4 size 0x8 virtual false final false
 void set_manufacturerName(::GlobalNamespace::____GlobalNamespace__UnityXRHelper__VRControllerManufacturerName value) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__UnityXRController__Configuration);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__UnityXRController__Configuration, "", "UnityXRController/Configuration");
