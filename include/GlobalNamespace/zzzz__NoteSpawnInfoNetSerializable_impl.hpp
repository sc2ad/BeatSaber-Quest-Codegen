...
constexpr void ::GlobalNamespace::NoteSpawnInfoNetSerializable::__set_gameplayType(::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, 0x24>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType ::GlobalNamespace::NoteSpawnInfoNetSerializable::__get_gameplayType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::NoteSpawnInfoNetSerializable::__set_scoringType(::GlobalNamespace::____GlobalNamespace__NoteData__ScoringType value)  {
...
constexpr ::GlobalNamespace::____GlobalNamespace__NoteData__ScoringType ::GlobalNamespace::NoteSpawnInfoNetSerializable::__get_scoringType() const {
