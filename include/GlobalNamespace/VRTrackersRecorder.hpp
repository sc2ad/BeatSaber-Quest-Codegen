...
namespace GlobalNamespace {
  ...
  class VRTrackersRecorder : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(VRTrackersRecorder::RecordMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_VRTrackersRecorder_RecordModeSizeCheck;
  ...
  check_size<sizeof(VRTrackersRecorder), 100 + sizeof(UnityEngine::Quaternion) + ((100 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (100 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_VRTrackersRecorderSizeCheck;
}
