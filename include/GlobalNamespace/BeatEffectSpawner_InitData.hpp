...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatEffectSpawner::InitData), 16 + sizeof(bool) + ((16 + sizeof(bool)) % 8 != 0 ? (8 - (16 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_BeatEffectSpawner_InitDataSizeCheck;
}
