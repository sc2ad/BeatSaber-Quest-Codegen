...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveDataV1_0_1::PlayerOverallStatsData), 64 + sizeof(int64_t) + 8 - (64 + sizeof(int64_t)) % 8> __GlobalNamespace_PlayerSaveDataV1_0_1_PlayerOverallStatsDataSizeCheck;
}
