...
namespace GlobalNamespace {
  ...
  class MultiplayerConnectedPlayerGameplayAnimator : public ::GlobalNamespace::MultiplayerGameplayAnimator {
    ...
    #endif
    #endif
    // [SpaceAttribute] Offset: 0x10B93B0
    ...
    // [SpaceAttribute] Offset: 0x10B93F8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0x10B9440
    ...
    // [InjectAttribute] Offset: 0x10B9450
    ...
    // [InjectAttribute] Offset: 0x10B9460
