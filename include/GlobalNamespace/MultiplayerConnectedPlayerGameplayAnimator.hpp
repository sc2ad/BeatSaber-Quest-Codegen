...
namespace GlobalNamespace {
  ...
  class MultiplayerConnectedPlayerGameplayAnimator : public GlobalNamespace::MultiplayerGameplayAnimator {
    public:
    // [SpaceAttribute] Offset: 0xD3C3BC
    ...
    // [SpaceAttribute] Offset: 0xD3C404
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0xD3C44C
    ...
    // [InjectAttribute] Offset: 0xD3C45C
    ...
    // [InjectAttribute] Offset: 0xD3C46C
