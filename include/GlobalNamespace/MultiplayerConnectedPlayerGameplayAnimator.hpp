...
namespace GlobalNamespace {
  ...
  class MultiplayerConnectedPlayerGameplayAnimator : public GlobalNamespace::MultiplayerGameplayAnimator {
    public:
    // [SpaceAttribute] Offset: 0xE1CDA0
    ...
    // [SpaceAttribute] Offset: 0xE1CDE8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0xE1CE30
    ...
    // [InjectAttribute] Offset: 0xE1CE40
    ...
    // [InjectAttribute] Offset: 0xE1CE50
