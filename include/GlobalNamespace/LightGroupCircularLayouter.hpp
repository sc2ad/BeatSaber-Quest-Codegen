...
namespace GlobalNamespace {
  ...
  class LightGroupCircularLayouter : public ::GlobalNamespace::LightGroupSubsystem {
    ...
    public:
    // [SpaceAttribute] Offset: 0x10E7FE8
  ...
  #pragma pack(pop)
  static check_size<sizeof(LightGroupCircularLayouter), 36 + sizeof(::GlobalNamespace::LightGroupCircularLayouter::RotationDirection)> __GlobalNamespace_LightGroupCircularLayouterSizeCheck;
  static_assert(sizeof(LightGroupCircularLayouter) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
