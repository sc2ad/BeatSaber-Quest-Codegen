...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LevelPackDetailViewController::$RefreshAvailabilityAsync$d__17), 48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>) + 8 - (48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8> __GlobalNamespace_LevelPackDetailViewController_$RefreshAvailabilityAsync$d__17SizeCheck;
}
