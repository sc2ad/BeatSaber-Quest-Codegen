...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::GameObject, ::UnityEngine::Camera, ::GlobalNamespace::OVRMixedRealityCaptureConfiguration, ::GlobalNamespace::____GlobalNamespace__OVRManager__TrackingOrigin, float_t)>(&::GlobalNamespace::OVRMixedReality::Update)> {
...
return ::cordl_internals::getStaticField<::GlobalNamespace::OVRComposition, "currentComposition", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRMixedReality>::get>();
 ...
 void ::GlobalNamespace::OVRMixedReality::Update(::UnityEngine::GameObject parentObject, ::UnityEngine::Camera mainCamera, ::GlobalNamespace::OVRMixedRealityCaptureConfiguration configuration, ::GlobalNamespace::____GlobalNamespace__OVRManager__TrackingOrigin trackingOrigin, float_t displayFrequency)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRMixedReality>::get(),
                            "Update",
                            std::vector<Il2CppClass*>{},
