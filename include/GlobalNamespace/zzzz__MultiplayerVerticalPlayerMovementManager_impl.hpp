...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerVerticalPlayerMovementManager::*)(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State)>(&::GlobalNamespace::MultiplayerVerticalPlayerMovementManager::HandleStateChanged)> {
...
constexpr void ::GlobalNamespace::MultiplayerVerticalPlayerMovementManager::__set__reusablePlayersList(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreProvider__RankedPlayer> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreProvider__RankedPlayer>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreProvider__RankedPlayer>>(value));
}
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreProvider__RankedPlayer> ::GlobalNamespace::MultiplayerVerticalPlayerMovementManager::__get__reusablePlayersList() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreProvider__RankedPlayer>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::MultiplayerVerticalPlayerMovementManager::HandleStateChanged(::GlobalNamespace::____GlobalNamespace__MultiplayerController__State state)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerVerticalPlayerMovementManager>::get(),
                            "HandleStateChanged",
                            std::vector<Il2CppClass*>{},
