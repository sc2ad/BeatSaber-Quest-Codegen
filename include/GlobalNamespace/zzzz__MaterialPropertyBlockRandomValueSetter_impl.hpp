...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MaterialPropertyBlockRandomValueSetter::*)()>(&GlobalNamespace::MaterialPropertyBlockRandomValueSetter::Start)> {
  ...
  constexpr static std::size_t addrs = 0x1fa279c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MaterialPropertyBlockRandomValueSetter::*)()>(&GlobalNamespace::MaterialPropertyBlockRandomValueSetter::OnValidate)> {
  ...
  constexpr static std::size_t addrs = 0x1fa29a8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MaterialPropertyBlockRandomValueSetter::*)()>(&GlobalNamespace::MaterialPropertyBlockRandomValueSetter::RefreshPropertyId)> {
  ...
  constexpr static std::size_t addrs = 0x1fa29cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MaterialPropertyBlockRandomValueSetter::*)()>(&GlobalNamespace::MaterialPropertyBlockRandomValueSetter::ApplyParams)> {
  ...
  constexpr static std::size_t addrs = 0x1fa27a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MaterialPropertyBlockRandomValueSetter::*)()>(&GlobalNamespace::MaterialPropertyBlockRandomValueSetter::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x1fa29ec;
...
constexpr void GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__set__renderers(::ArrayW<UnityEngine::Renderer> value)  {
...
constexpr ::ArrayW<UnityEngine::Renderer> GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__renderers() const {
...
constexpr ::StringW GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__propertyName() const {
...
constexpr float_t GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__minValue() const {
...
constexpr float_t GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__maxValue() const {
return ::cordl_internals::getInstanceField<float_t, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__set__materialPropertyBlocks(::ArrayW<UnityEngine::MaterialPropertyBlock> value)  {
::cordl_internals::setInstanceField<::ArrayW<UnityEngine::MaterialPropertyBlock>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<UnityEngine::MaterialPropertyBlock>>(value));
}
constexpr ::ArrayW<UnityEngine::MaterialPropertyBlock> GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__materialPropertyBlocks() const {
return ::cordl_internals::getInstanceField<::ArrayW<UnityEngine::MaterialPropertyBlock>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr int32_t GlobalNamespace::MaterialPropertyBlockRandomValueSetter::__get__propertyId() const {
