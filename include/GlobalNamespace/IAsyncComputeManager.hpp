...
namespace GlobalNamespace {
  ...
  class IAsyncComputeManager : public ::Il2CppObject/*, public System::IDisposable*/ {
    public:
    ...
    System::Threading::Tasks::Task_1<T>* BeginOperation(GlobalNamespace::AsyncComputeOperation_1<T>* asyncComputeOperation) {
      ...
      return ::il2cpp_utils::RunMethodThrow<System::Threading::Tasks::Task_1<T>*, false>(this, ___generic__method, asyncComputeOperation);
    }
