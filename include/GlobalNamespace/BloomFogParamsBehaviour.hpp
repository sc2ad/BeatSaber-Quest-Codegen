...
namespace GlobalNamespace {
  ...
  class BloomFogParamsBehaviour : public UnityEngine::Playables::PlayableBehaviour {
    ...
    BloomFogParamsBehaviour(GlobalNamespace::BloomFogEnvironmentParams* bloomFogParams_ = {}, float blend_ = {}, GlobalNamespace::BloomFogSO* bloomFog_ = {}, bool initialized_ = {}) noexcept : bloomFogParams{bloomFogParams_}, blend{blend_}, bloomFog{bloomFog_}, initialized{initialized_} {}
