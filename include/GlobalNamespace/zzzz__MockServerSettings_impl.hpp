...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MockServerSettings::*)()>(&GlobalNamespace::MockServerSettings::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x20efa84;
 ...
 GlobalNamespace::MockServerSettings GlobalNamespace::MockServerSettings::New_ctor()  {
GlobalNamespace::MockServerSettings o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MockServerSettings>())};
return o;
}
