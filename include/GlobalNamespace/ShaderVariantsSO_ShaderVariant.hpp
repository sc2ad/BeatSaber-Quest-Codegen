...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ShaderVariantsSO::ShaderVariant), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_ShaderVariantsSO_ShaderVariantSizeCheck;
}
