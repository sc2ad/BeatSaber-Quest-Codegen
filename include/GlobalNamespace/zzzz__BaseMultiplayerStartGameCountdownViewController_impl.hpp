...
GlobalNamespace::BaseMultiplayerStartGameCountdownViewController o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::BaseMultiplayerStartGameCountdownViewController>())};
return o;
}
