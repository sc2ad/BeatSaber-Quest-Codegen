...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameEnergyCounter::InitData), 22 + sizeof(bool) + ((22 + sizeof(bool)) % 8 != 0 ? (8 - (22 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_GameEnergyCounter_InitDataSizeCheck;
}
