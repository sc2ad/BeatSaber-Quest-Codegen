...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MockScoreSyncStateManager), 72 + sizeof(float) + ((72 + sizeof(float)) % 8 != 0 ? (8 - (72 + sizeof(float)) % 8) : 0)> __GlobalNamespace_MockScoreSyncStateManagerSizeCheck;
}
