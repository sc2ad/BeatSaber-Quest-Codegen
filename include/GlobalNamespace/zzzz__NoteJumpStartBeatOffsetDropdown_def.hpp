...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5694), inst: 374 }), TypeDefinitionIndex(TypeDefinitionIndex(5694))}
...
static GlobalNamespace::NoteJumpStartBeatOffsetDropdown New_ctor() ;
