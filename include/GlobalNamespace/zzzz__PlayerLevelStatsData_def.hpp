...
constexpr bool __get__fullCombo() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__RankModel__Rank __declspec(property(get=__get__maxRank, put=__set__maxRank))  _maxRank;

constexpr void __set__maxRank(::GlobalNamespace::____GlobalNamespace__RankModel__Rank value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__RankModel__Rank __get__maxRank() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__RankModel__Rank __declspec(property(get=get_maxRank))  maxRank;
...
/// @brief Method get_maxRank addr 0x2226e94 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__RankModel__Rank get_maxRank() ;
...
// Ctor Parameters [CppParam { name: "levelID", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "difficulty", ty: "::GlobalNamespace::BeatmapDifficulty", modifiers: "", def_value: None }, CppParam { name: "beatmapCharacteristic", ty: "::GlobalNamespace::BeatmapCharacteristicSO", modifiers: "", def_value: None }, CppParam { name: "highScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxCombo", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fullCombo", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "maxRank", ty: "::GlobalNamespace::____GlobalNamespace__RankModel__Rank", modifiers: "", def_value: None }, CppParam { name: "validScore", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "playCount", ty: "int32_t", modifiers: "", def_value: None }]
explicit PlayerLevelStatsData(::StringW levelID, ::GlobalNamespace::BeatmapDifficulty difficulty, ::GlobalNamespace::BeatmapCharacteristicSO beatmapCharacteristic, int32_t highScore, int32_t maxCombo, bool fullCombo, ::GlobalNamespace::____GlobalNamespace__RankModel__Rank maxRank, bool validScore, int32_t playCount) ;

/// @brief Method .ctor addr 0x2225c24 size 0x88 virtual false final false
 void _ctor(::StringW levelID, ::GlobalNamespace::BeatmapDifficulty difficulty, ::GlobalNamespace::BeatmapCharacteristicSO beatmapCharacteristic, int32_t highScore, int32_t maxCombo, bool fullCombo, ::GlobalNamespace::____GlobalNamespace__RankModel__Rank maxRank, bool validScore, int32_t playCount) ;

/// @brief Method UpdateScoreData addr 0x2226eec size 0x4c virtual false final false
 void UpdateScoreData(int32_t score, int32_t maxCombo, bool fullCombo, ::GlobalNamespace::____GlobalNamespace__RankModel__Rank rank) ;
