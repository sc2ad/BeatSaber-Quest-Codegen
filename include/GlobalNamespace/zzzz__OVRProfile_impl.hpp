...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::____GlobalNamespace__OVRProfile__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRProfile__State  ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::NOT_TRIGGERED{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRProfile__State  ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::LOADING{1};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRProfile__State  ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::READY{2};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRProfile__State  ::GlobalNamespace::____GlobalNamespace__OVRProfile__State::ERROR{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__OVRProfile__State (::GlobalNamespace::OVRProfile::*)()>(&::GlobalNamespace::OVRProfile::get_state)> {
...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__OVRProfile__State ::GlobalNamespace::OVRProfile::get_state()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRProfile>::get(),
                            "get_state",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__OVRProfile__State, false>(const_cast<void*>(instance), ___internal_method);
}
// Ctor Parameters []
 ::GlobalNamespace::OVRProfile::OVRProfile()  : ::UnityEngine::Object(THROW_UNLESS(::il2cpp_utils::New<OVRProfile>())) {}
