...
namespace GlobalNamespace {
class ____GlobalNamespace__GameEnergyCounter__InitData;
}
// Type: ::InitData
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__GameEnergyCounter__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__GameEnergyCounter__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameEnergyCounter__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__GameEnergyCounter__InitData(____GlobalNamespace__GameEnergyCounter__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameEnergyCounter__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__GameEnergyCounter__InitData(____GlobalNamespace__GameEnergyCounter__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GameEnergyCounter__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__GameEnergyCounter__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__GameEnergyCounter__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__GameEnergyCounter__InitData& operator=(____GlobalNamespace__GameEnergyCounter__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__GameEnergyCounter__InitData& operator=(____GlobalNamespace__GameEnergyCounter__InitData const& o) noexcept = default;
                


// Fields

 ::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType __declspec(property(get=__get_energyType, put=__set_energyType))  energyType;

constexpr void __set_energyType(::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType __get_energyType() const;
...
explicit ____GlobalNamespace__GameEnergyCounter__InitData(::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType energyType, bool noFail, bool instaFail, bool failOnSaberClash) ;

/// @brief Method .ctor addr 0x2107e98 size 0x48 virtual false final false
 void _ctor(::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType energyType, bool noFail, bool instaFail, bool failOnSaberClash) ;
...
public:
// Declarations
using InitData = ::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData;
...
constexpr int32_t __get__batteryLives() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData __declspec(property(get=__get__initData, put=__set__initData))  _initData;

constexpr void __set__initData(::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData __get__initData() const;
...
constexpr float_t __get__energy_k__BackingField() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType __declspec(property(get=__get__energyType_k__BackingField, put=__set__energyType_k__BackingField))  _energyType_k__BackingField;

constexpr void __set__energyType_k__BackingField(::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType __get__energyType_k__BackingField() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType __declspec(property(get=get_energyType, put=set_energyType))  energyType;
...
/// @brief Method set_energyType addr 0x21076b0 size 0x8 virtual false final false
 void set_energyType(::GlobalNamespace::____GlobalNamespace__GameplayModifiers__EnergyType value) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameEnergyCounter__InitData, "", "GameEnergyCounter/InitData");
