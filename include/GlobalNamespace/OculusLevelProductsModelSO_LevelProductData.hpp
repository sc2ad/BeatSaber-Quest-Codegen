...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(OculusLevelProductsModelSO::LevelProductData), 24 + sizeof(::StringW)> __GlobalNamespace_OculusLevelProductsModelSO_LevelProductDataSizeCheck;
  static_assert(sizeof(OculusLevelProductsModelSO::LevelProductData) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
