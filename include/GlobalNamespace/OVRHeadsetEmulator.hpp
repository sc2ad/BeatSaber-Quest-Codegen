...
namespace GlobalNamespace {
  ...
  class OVRHeadsetEmulator : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRHeadsetEmulator::OpMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRHeadsetEmulator_OpModeSizeCheck;
  ...
  check_size<sizeof(OVRHeadsetEmulator), 85 + sizeof(bool) + ((85 + sizeof(bool)) % 8 != 0 ? (8 - (85 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRHeadsetEmulatorSizeCheck;
}
