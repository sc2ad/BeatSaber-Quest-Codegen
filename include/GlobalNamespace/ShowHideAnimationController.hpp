...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ShowHideAnimationController), 44 + sizeof(int) + ((44 + sizeof(int)) % 8 != 0 ? (8 - (44 + sizeof(int)) % 8) : 0)> __GlobalNamespace_ShowHideAnimationControllerSizeCheck;
}
