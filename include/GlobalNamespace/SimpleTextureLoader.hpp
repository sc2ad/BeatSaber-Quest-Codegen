...
namespace GlobalNamespace {
  ...
  class SimpleTextureLoader : public ::CsObject {
    public:
    ...
    static GlobalNamespace::HMCache_2<::CsString*, UnityEngine::Texture2D*>* _get__cache();
    // Set static field: static private HMCache`2<System.String,UnityEngine.Texture2D> _cache
    static void _set__cache(GlobalNamespace::HMCache_2<::CsString*, UnityEngine::Texture2D*>* value);
    ...
    // Offset: 0xB95EF4
    static void LoadTexture(::CsString* filePath, bool useCache, System::Action_1<UnityEngine::Texture2D*>* finishedCallback);
    ...
    // Offset: 0xB95FC0
    static System::Collections::IEnumerator* LoadTextureCoroutine(::CsString* filePath, bool useCache, System::Action_1<UnityEngine::Texture2D*>* finishedCallback);
