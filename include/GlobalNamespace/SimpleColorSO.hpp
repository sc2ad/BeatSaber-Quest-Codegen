...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SimpleColorSO), 24 + sizeof(UnityEngine::Color) + ((24 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (24 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_SimpleColorSOSizeCheck;
}
