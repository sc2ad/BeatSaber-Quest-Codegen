...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BloomPrePassBackgroundColorsGradient), 64 + sizeof(::Array<GlobalNamespace::BloomPrePassBackgroundColorsGradient::Element*>*)> __GlobalNamespace_BloomPrePassBackgroundColorsGradientSizeCheck;
