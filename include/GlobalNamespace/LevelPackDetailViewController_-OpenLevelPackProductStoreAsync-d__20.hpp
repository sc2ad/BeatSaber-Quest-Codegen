...
namespace GlobalNamespace {
  ...
  // Autogenerated type: LevelPackDetailViewController/<OpenLevelPackProductStoreAsync>d__20
  // [CompilerGeneratedAttribute] Offset: E127E8
  struct LevelPackDetailViewController::$OpenLevelPackProductStoreAsync$d__20/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    public:
    ...
    // Creating value type constructor for type: $OpenLevelPackProductStoreAsync$d__20
    constexpr $OpenLevelPackProductStoreAsync$d__20(int $$1__state_ = {}, System::Runtime::CompilerServices::AsyncVoidMethodBuilder $$t__builder_ = {}, GlobalNamespace::LevelPackDetailViewController* $$4__this_ = {}, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::OpenProductStoreResult> $$u__1_ = {}) noexcept : $$1__state{$$1__state_}, $$t__builder{$$t__builder_}, $$4__this{$$4__this_}, $$u__1{$$u__1_} {}
  ...
  }; // LevelPackDetailViewController/<OpenLevelPackProductStoreAsync>d__20
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackDetailViewController::$OpenLevelPackProductStoreAsync$d__20::*)(System::Runtime::CompilerServices::IAsyncStateMachine*)>(&GlobalNamespace::LevelPackDetailViewController::$OpenLevelPackProductStoreAsync$d__20::SetStateMachine)> {
  const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LevelPackDetailViewController::$OpenLevelPackProductStoreAsync$d__20), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{stateMachine});
  }
};
