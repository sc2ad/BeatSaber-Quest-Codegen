...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::MultiplayerBadgeAwardData, false>(const_cast<void*>(instance), ___internal_method, resultsData, playerDataModel, difficultyBeatmap, randomMultiplier);
 ...
 GlobalNamespace::MultiplayerBadgeDataFullComboSO GlobalNamespace::MultiplayerBadgeDataFullComboSO::New_ctor()  {
GlobalNamespace::MultiplayerBadgeDataFullComboSO o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MultiplayerBadgeDataFullComboSO>())};
return o;
}
