...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HealthWarningFlowCoordinator), 232 + sizeof(void*) + ((232 + sizeof(void*)) % 8 != 0 ? (8 - (232 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_HealthWarningFlowCoordinatorSizeCheck;
}
