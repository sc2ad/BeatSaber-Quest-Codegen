...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BaseNoteVisuals::*)()>(&GlobalNamespace::BaseNoteVisuals::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x2238a54;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BaseNoteVisuals::*)()>(&GlobalNamespace::BaseNoteVisuals::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x2238b98;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BaseNoteVisuals::*)(GlobalNamespace::NoteControllerBase, float_t)>(&GlobalNamespace::BaseNoteVisuals::HandleNoteControllerNoteDidStartDissolving)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x2238d44;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BaseNoteVisuals::*)(float_t, float_t, float_t)>(&GlobalNamespace::BaseNoteVisuals::AnimateCutout)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x2238d54;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BaseNoteVisuals::*)()>(&GlobalNamespace::BaseNoteVisuals::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2238d80;
...
constexpr  GlobalNamespace::BaseNoteVisuals::operator GlobalNamespace::INoteControllerDidInitEvent() const noexcept {
...
constexpr  GlobalNamespace::BaseNoteVisuals::operator GlobalNamespace::INoteControllerNoteDidStartDissolvingEvent() const noexcept {
...
constexpr GlobalNamespace::NoteControllerBase GlobalNamespace::BaseNoteVisuals::__get__noteController() const {
...
constexpr GlobalNamespace::CutoutAnimateEffect GlobalNamespace::BaseNoteVisuals::__get__cutoutAnimateEffect() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, noteController);
 ...
 void GlobalNamespace::BaseNoteVisuals::HandleNoteControllerNoteDidStartDissolving(GlobalNamespace::NoteControllerBase noteController, float_t duration)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BaseNoteVisuals>::get(),
                            "HandleNoteControllerNoteDidStartDissolving",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, noteController, duration);
 ...
 void GlobalNamespace::BaseNoteVisuals::AnimateCutout(float_t cutoutStart, float_t cutoutEnd, float_t duration)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BaseNoteVisuals>::get(),
                            "AnimateCutout",
                            std::vector<Il2CppClass*>{},
