...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::CustomTimelineTween GlobalNamespace::CustomTimelineTween::New_ctor()  {
GlobalNamespace::CustomTimelineTween o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::CustomTimelineTween>())};
return o;
}
