...
namespace GlobalNamespace {
  ...
  // [AddComponentMenu] Offset: E05B98
  class DynamicBone : public UnityEngine::MonoBehaviour {
    ...
    // [RangeAttribute] Offset: 0xE05C40
    ...
    // [RangeAttribute] Offset: 0xE05C58
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0xE05C70
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0xE05C88
