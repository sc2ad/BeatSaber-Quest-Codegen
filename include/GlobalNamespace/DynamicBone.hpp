...
namespace GlobalNamespace {
  ...
  class DynamicBone : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(DynamicBone::UpdateMode), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_DynamicBone_UpdateModeSizeCheck;
    ...
    check_size<sizeof(DynamicBone::FreezeAxis), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_DynamicBone_FreezeAxisSizeCheck;
  ...
  check_size<sizeof(DynamicBone), 256 + sizeof(void*) + 8 - (256 + sizeof(void*)) % 8> __GlobalNamespace_DynamicBoneSizeCheck;
}
