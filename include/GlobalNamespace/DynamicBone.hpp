...
namespace GlobalNamespace {
  ...
  // [AddComponentMenu] Offset: 113AA20
  class DynamicBone : public ::UnityEngine::MonoBehaviour {
    ...
    // [RangeAttribute] Offset: 0x113AAC8
    ...
    // [RangeAttribute] Offset: 0x113AAE0
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0x113AAF8
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0x113AB10
