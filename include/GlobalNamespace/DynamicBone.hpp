...
namespace GlobalNamespace {
  ...
  // [AddComponentMenu] Offset: 1136B50
  class DynamicBone : public ::UnityEngine::MonoBehaviour {
    ...
    // [RangeAttribute] Offset: 0x1136BF8
    ...
    // [RangeAttribute] Offset: 0x1136C10
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0x1136C28
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0x1136C40
