...
namespace GlobalNamespace {
  ...
  // [AddComponentMenu] Offset: F5BADC
  class DynamicBone : public UnityEngine::MonoBehaviour {
    ...
    // [RangeAttribute] Offset: 0xF5BB84
    ...
    // [RangeAttribute] Offset: 0xF5BB9C
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0xF5BBB4
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::AnimationCurve*) == 0x8);
    // [RangeAttribute] Offset: 0xF5BBCC
