...
namespace GlobalNamespace {
  ...
  class MultiplayerGameplayAnimator : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(::GlobalNamespace::ColorSO*) == 0x8);
    // [SpaceAttribute] Offset: 0x10DC0C4
    ...
    char __padding3[0x4] = {};
    // [SpaceAttribute] Offset: 0x10DC0FC
    ...
    // Field size check
    static_assert(sizeof(::ArrayW<::GlobalNamespace::LightsAnimator*>) == 0x8);
    // [InjectAttribute] Offset: 0x10DC144
    ...
    // [InjectAttribute] Offset: 0x10DC154
    ...
    // [InjectAttribute] Offset: 0x10DC174
