...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: CommandBufferGOCore
...
namespace GlobalNamespace {
  ...
  class CommandBufferGOCore : public ::UnityEngine::MonoBehaviour {
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x1105224
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::Dictionary_2<::UnityEngine::Camera*, ::GlobalNamespace::CommandBufferOwners*>*& dyn__cameras();
