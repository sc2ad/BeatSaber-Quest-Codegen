...
namespace GlobalNamespace {
  ...
  class ShowHideAnimationController::$DeactivateSelfAfterDelayCoroutine$d__9 : public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>, public ::Il2CppObject {
    public:
