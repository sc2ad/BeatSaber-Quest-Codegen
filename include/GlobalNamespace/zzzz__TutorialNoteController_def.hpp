...
public:
// Declarations
using Pool = ::GlobalNamespace::____GlobalNamespace__TutorialNoteController__Pool;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10992)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 2724 }), TypeDefinitionIndex(TypeDefinitionIndex(4903))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4902))
// CS Name: TutorialNoteController::Pool
class CORDL_TYPE ____GlobalNamespace__TutorialNoteController__Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::TutorialNoteController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__TutorialNoteController__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__TutorialNoteController__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__TutorialNoteController__Pool(____GlobalNamespace__TutorialNoteController__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__TutorialNoteController__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__TutorialNoteController__Pool(____GlobalNamespace__TutorialNoteController__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__TutorialNoteController__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::TutorialNoteController>(ptr) {
}


  constexpr ____GlobalNamespace__TutorialNoteController__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__TutorialNoteController__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__TutorialNoteController__Pool& operator=(____GlobalNamespace__TutorialNoteController__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__TutorialNoteController__Pool& operator=(____GlobalNamespace__TutorialNoteController__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__TutorialNoteController__Pool() ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__TutorialNoteController__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__TutorialNoteController__Pool, "", "TutorialNoteController/Pool");
