...
namespace GlobalNamespace {
  ...
  class UnityScenesHelper : public ::Il2CppObject {
    ...
    static System::Collections::Generic::IEnumerable_1<T>* FindComponentsOfTypeInScene(UnityEngine::SceneManagement::Scene activeScene, bool includeInactive) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::IEnumerable_1<T>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, activeScene, includeInactive)));
    }
  }; // UnityScenesHelper
  #pragma pack(pop)
}
