...
namespace GlobalNamespace {
  ...
  class DlcPromoPanelDataSO::MusicPackPromoInfo : public ::Il2CppObject {
    ...
    MusicPackPromoInfo(GlobalNamespace::PreviewBeatmapLevelPackSO* beatmapLevelPack_ = {}, GlobalNamespace::BeatmapLevelSO* beatmapLevel_ = {}, UnityEngine::Sprite* bannerImage_ = {}) noexcept : beatmapLevelPack{beatmapLevelPack_}, beatmapLevel{beatmapLevel_}, bannerImage{bannerImage_} {}
