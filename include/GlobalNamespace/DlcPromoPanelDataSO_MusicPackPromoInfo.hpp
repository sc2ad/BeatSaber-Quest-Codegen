...
namespace GlobalNamespace {
  ...
  class DlcPromoPanelDataSO::MusicPackPromoInfo : public ::Il2CppObject {
    ...
    // private System.String _bannerPromoText
    // Size: 0x8
    // Offset: 0x28
    ::StringW bannerPromoText;
    // Field size check
    ...
    // Get instance field reference: private System.String _bannerPromoText
    [[deprecated("Use field access instead!")]] ::StringW& dyn__bannerPromoText();
    ...
    // public System.String get_bannerPromoText()
    // Offset: 0x1462938
  ...
  #pragma pack(pop)
  static check_size<sizeof(DlcPromoPanelDataSO::MusicPackPromoInfo), 40 + sizeof(::StringW)> __GlobalNamespace_DlcPromoPanelDataSO_MusicPackPromoInfoSizeCheck;
  static_assert(sizeof(DlcPromoPanelDataSO::MusicPackPromoInfo) == 0x30);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo::get_bannerPromoText
// Il2CppName: get_bannerPromoText
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo::*)()>(&GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo::get_bannerPromoText)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::DlcPromoPanelDataSO::MusicPackPromoInfo*), "get_bannerPromoText", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
