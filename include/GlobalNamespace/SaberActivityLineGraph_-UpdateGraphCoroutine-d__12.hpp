...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SaberActivityLineGraph::$UpdateGraphCoroutine$d__12), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __GlobalNamespace_SaberActivityLineGraph_$UpdateGraphCoroutine$d__12SizeCheck;
}
