...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: D1CE30
  class LevelPackDetailViewController::$$c__DisplayClass14_0 : public ::Il2CppObject {
    ...
    static LevelPackDetailViewController::$$c__DisplayClass14_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::LevelPackDetailViewController::$$c__DisplayClass14_0::.ctor");
