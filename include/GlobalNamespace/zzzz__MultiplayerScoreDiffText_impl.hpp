...
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition::Left{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition::Right{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::____GlobalNamespace__MultiplayerScoreDiffText__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::Hidden{0};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::Displayed{1};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::AnimatingDisplay{2};
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State  ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State::AnimatingHide{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerScoreDiffText::*)(::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition)>(&::GlobalNamespace::MultiplayerScoreDiffText::SetHorizontalPositionRelativeToLocalPlayer)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::MultiplayerScoreDiffText::__set__state(::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State, 0x88>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State ::GlobalNamespace::MultiplayerScoreDiffText::__get__state() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__State, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::MultiplayerScoreDiffText::SetHorizontalPositionRelativeToLocalPlayer(::GlobalNamespace::____GlobalNamespace__MultiplayerScoreDiffText__HorizontalPosition relativePosition)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MultiplayerScoreDiffText>::get(),
                            "SetHorizontalPositionRelativeToLocalPlayer",
                            std::vector<Il2CppClass*>{},
