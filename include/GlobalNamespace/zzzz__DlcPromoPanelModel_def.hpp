...
namespace GlobalNamespace {
struct ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17;
}
...
struct CORDL_TYPE ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::DlcPromoPanelModel", modifiers: "", def_value: None }, CppParam { name: "_newNotOwnedMusicPackPromoInfos_5__2", ty: "::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap3", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_packData_5__5", ty: "::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::DlcPromoPanelModel __4__this, ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> _newNotOwnedMusicPackPromoInfos_5__2, ::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __7__wrap2, int32_t __7__wrap3, ::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo _packData_5__5, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept;


                    constexpr ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17(____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17 const&) = default;
                    constexpr ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17(____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17&&) = default;
                    constexpr ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17& operator=(____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17& operator=(____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::GlobalNamespace::DlcPromoPanelModel __get___4__this() const;
 ...
 ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __declspec(property(get=__get__newNotOwnedMusicPackPromoInfos_5__2, put=__set__newNotOwnedMusicPackPromoInfos_5__2))  _newNotOwnedMusicPackPromoInfos_5__2;

constexpr void __set__newNotOwnedMusicPackPromoInfos_5__2(::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value) ;

constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __get__newNotOwnedMusicPackPromoInfos_5__2() const;

 ::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2))  __7__wrap2;

constexpr void __set___7__wrap2(::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __get___7__wrap2() const;
...
constexpr int32_t __get___7__wrap3() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo __declspec(property(get=__get__packData_5__5, put=__set__packData_5__5))  _packData_5__5;

constexpr void __set__packData_5__5(::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo __get__packData_5__5() const;
...
public:
// Declarations
using _UpdateNotOwnedPacksAsync_d__17 = ::GlobalNamespace::____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17;
...
constexpr ::GlobalNamespace::PlayerDataModel __get__playerDataModel() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __declspec(property(get=__get__notOwnedMusicPackPromoInfos, put=__set__notOwnedMusicPackPromoInfos))  _notOwnedMusicPackPromoInfos;

constexpr void __set__notOwnedMusicPackPromoInfos(::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo> __get__notOwnedMusicPackPromoInfos() const;
...
/// @brief Method GetPackDataForMainMenuPromoBanner addr 0x21bdc84 size 0x268 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__DlcPromoPanelDataSO__MusicPackPromoInfo GetPackDataForMainMenuPromoBanner(ByRef<bool> owned) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__DlcPromoPanelModel___UpdateNotOwnedPacksAsync_d__17, "", "DlcPromoPanelModel/<UpdateNotOwnedPacksAsync>d__17");
