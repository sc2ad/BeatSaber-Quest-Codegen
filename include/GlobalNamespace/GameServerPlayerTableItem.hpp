...
namespace GlobalNamespace {
  ...
  check_size<sizeof(GameServerPlayerTableItem), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_GameServerPlayerTableItemSizeCheck;
}
