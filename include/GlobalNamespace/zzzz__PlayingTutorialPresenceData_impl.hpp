...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::PlayingTutorialPresenceData::*)()>(&::GlobalNamespace::PlayingTutorialPresenceData::get_apiName)> {
  ...
  constexpr static std::size_t addrs = 0x222a43c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::PlayingTutorialPresenceData::*)()>(&::GlobalNamespace::PlayingTutorialPresenceData::get_localizedDescription)> {
  ...
  constexpr static std::size_t addrs = 0x222a47c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlayingTutorialPresenceData::*)(::StringW)>(&::GlobalNamespace::PlayingTutorialPresenceData::set_localizedDescription)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222a484;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlayingTutorialPresenceData::*)()>(&::GlobalNamespace::PlayingTutorialPresenceData::_ctor)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x222a48c;
...
constexpr  ::GlobalNamespace::PlayingTutorialPresenceData::operator ::GlobalNamespace::IRichPresenceData() const noexcept {
...
constexpr ::StringW ::GlobalNamespace::PlayingTutorialPresenceData::__get__localizedDescription_k__BackingField() const {
...
// Ctor Parameters []
 ::GlobalNamespace::PlayingTutorialPresenceData::PlayingTutorialPresenceData()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<PlayingTutorialPresenceData>())) {}
 void ::GlobalNamespace::PlayingTutorialPresenceData::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PlayingTutorialPresenceData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
