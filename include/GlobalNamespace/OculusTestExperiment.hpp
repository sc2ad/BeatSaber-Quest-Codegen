...
namespace GlobalNamespace {
  ...
  class OculusTestExperiment : public ::Il2CppObject {
    ...
    struct $Init$d__3;
    // [InjectAttribute] Offset: 0xF365A0
    ...
    // Creating value type constructor for type: OculusTestExperiment
    OculusTestExperiment(GlobalNamespace::IExperimentModel* experimentModel_ = {}) noexcept : experimentModel{experimentModel_} {}
