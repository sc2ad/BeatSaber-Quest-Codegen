...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PublicServerInfo), 32 + sizeof(GlobalNamespace::GameplayServerConfiguration) + ((32 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8 != 0 ? (8 - (32 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8) : 0)> __GlobalNamespace_PublicServerInfoSizeCheck;
}
