...
// Ctor Parameters []
 ::GlobalNamespace::DateConditionalSpriteSwitcher::DateConditionalSpriteSwitcher()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<DateConditionalSpriteSwitcher>())) {}
