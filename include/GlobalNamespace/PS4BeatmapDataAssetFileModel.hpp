...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PS4BeatmapDataAssetFileModel), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_PS4BeatmapDataAssetFileModelSizeCheck;
}
