...
namespace GlobalNamespace {
  ...
  class BloomPrePassBackgroundColorsGradientTintColorWithLightId : public GlobalNamespace::RuntimeLightWithIds {
    ...
    // Creating value type constructor for type: BloomPrePassBackgroundColorsGradientTintColorWithLightId
    BloomPrePassBackgroundColorsGradientTintColorWithLightId(GlobalNamespace::BloomPrePassBackgroundColorsGradient* bloomPrePassBackgroundColorsGradient_ = {}) noexcept : bloomPrePassBackgroundColorsGradient{bloomPrePassBackgroundColorsGradient_} {}
