...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(BloomPrePassBackgroundColorsGradientTintColorWithLightId), 72 + sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradient*)> __GlobalNamespace_BloomPrePassBackgroundColorsGradientTintColorWithLightIdSizeCheck;
  static_assert(sizeof(BloomPrePassBackgroundColorsGradientTintColorWithLightId) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
