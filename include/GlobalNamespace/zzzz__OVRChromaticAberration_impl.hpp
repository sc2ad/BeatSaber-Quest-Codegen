...
constexpr void GlobalNamespace::OVRChromaticAberration::__set_toggleButton(GlobalNamespace::GlobalNamespace__OVRInput__RawButton value)  {
...
constexpr GlobalNamespace::GlobalNamespace__OVRInput__RawButton GlobalNamespace::OVRChromaticAberration::__get_toggleButton() const {
