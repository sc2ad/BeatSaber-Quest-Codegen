...
namespace GlobalNamespace {
  ...
  class MultiplayerSessionManager : public GlobalNamespace::StandaloneMonobehavior/*, public GlobalNamespace::IMultiplayerSessionManager*/ {
    ...
    check_size<sizeof(MultiplayerSessionManager::SessionType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerSessionManager_SessionTypeSizeCheck;
    ...
    check_size<sizeof(MultiplayerSessionManager::ConnectionState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerSessionManager_ConnectionStateSizeCheck;
    ...
    void StartSession(GlobalNamespace::MultiplayerSessionManager::SessionType sessionType, GlobalNamespace::IConnectionInitParams_1<T>* initParams) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "StartSession", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::il2cpp_utils::ExtractTypes(sessionType, initParams))));
  ...
  check_size<sizeof(MultiplayerSessionManager), 160 + sizeof(void*) + ((160 + sizeof(void*)) % 8 != 0 ? (8 - (160 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerSessionManagerSizeCheck;
}
