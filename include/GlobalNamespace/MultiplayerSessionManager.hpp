...
namespace GlobalNamespace {
  ...
  class MultiplayerSessionManager : public GlobalNamespace::StandaloneMonobehavior/*, public GlobalNamespace::IMultiplayerSessionManager*/ {
    ...
    check_size<sizeof(MultiplayerSessionManager::SessionType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MultiplayerSessionManager_SessionTypeSizeCheck;
    ...
    check_size<sizeof(MultiplayerSessionManager::ConnectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_MultiplayerSessionManager_ConnectionStateSizeCheck;
  ...
  check_size<sizeof(MultiplayerSessionManager), 160 + sizeof(void*) + 8 - (160 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerSessionManagerSizeCheck;
}
