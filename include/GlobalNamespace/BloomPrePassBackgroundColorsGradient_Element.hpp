...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BloomPrePassBackgroundColorsGradient::Element), 36 + sizeof(float) + ((36 + sizeof(float)) % 8 != 0 ? (8 - (36 + sizeof(float)) % 8) : 0)> __GlobalNamespace_BloomPrePassBackgroundColorsGradient_ElementSizeCheck;
}
