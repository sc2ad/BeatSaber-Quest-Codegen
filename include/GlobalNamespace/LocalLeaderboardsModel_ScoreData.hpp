...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LocalLeaderboardsModel::ScoreData), 40 + sizeof(int64_t) + ((40 + sizeof(int64_t)) % 8 != 0 ? (8 - (40 + sizeof(int64_t)) % 8) : 0)> __GlobalNamespace_LocalLeaderboardsModel_ScoreDataSizeCheck;
}
