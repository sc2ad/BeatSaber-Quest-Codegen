...
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::____GlobalNamespace__StandardScoreSyncState__Score(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::ModifiedScore{0};
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::MultipliedScore{1};
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::ImmediateMaxPossibleMultipliedScore{2};
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::Combo{3};
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::Multiplier{4};
constexpr ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score  ::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score::Count{5};
//  Writing Method size for method: ::GlobalNamespace::StandardScoreSyncState.SetState
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::StandardScoreSyncState::*)(::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score, int32_t)>(&::GlobalNamespace::StandardScoreSyncState::SetState)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::StandardScoreSyncState::*)(::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score)>(&::GlobalNamespace::StandardScoreSyncState::GetState)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "GetState",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr  ::GlobalNamespace::StandardScoreSyncState::operator ::GlobalNamespace::IStateTable_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score,int32_t>() const {
return ::GlobalNamespace::IStateTable_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score,int32_t>(::cordl_internals::Box(this).convert());
}
...
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->__instance);
 ...
 void ::GlobalNamespace::StandardScoreSyncState::SetState(::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score s, int32_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::StandardScoreSyncState>::get(),
                            "SetState",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::StandardScoreSyncState, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, delta);
 ...
 int32_t ::GlobalNamespace::StandardScoreSyncState::GetState(::GlobalNamespace::____GlobalNamespace__StandardScoreSyncState__Score s)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::StandardScoreSyncState>::get(),
                            "GetState",
                            std::vector<Il2CppClass*>{},
