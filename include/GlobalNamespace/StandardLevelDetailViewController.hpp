...
namespace GlobalNamespace {
  ...
  class StandardLevelDetailViewController : public HMUI::ViewController {
    ...
    // [InjectAttribute] Offset: 0xF45DAC
    ...
    // [InjectAttribute] Offset: 0xF45DBC
    ...
    // [InjectAttribute] Offset: 0xF45DCC
    ...
    // [InjectAttribute] Offset: 0xF45DDC
    ...
    // [InjectAttribute] Offset: 0xF45DEC
    ...
    GlobalNamespace::EventBinder*& dyn__ownedObjectsEventBinder();
    ...
    // Offset: 0x121E1D8
    void SetData(GlobalNamespace::IPreviewBeatmapLevel* previewBeatmapLevel, bool hidePracticeButton, bool hide360DegreeBeatmapCharacteristic, ::Il2CppString* playButtonText, GlobalNamespace::BeatmapDifficultyMask allowedBeatmapDifficultyMask, ::Array<GlobalNamespace::BeatmapCharacteristicSO*>* notAllowedCharacteristics);
...
// Il2CppName: SetData
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StandardLevelDetailViewController::*)(GlobalNamespace::IPreviewBeatmapLevel*, bool, bool, ::Il2CppString*, GlobalNamespace::BeatmapDifficultyMask, ::Array<GlobalNamespace::BeatmapCharacteristicSO*>*)>(&GlobalNamespace::StandardLevelDetailViewController::SetData)> {
  static const MethodInfo* get() {
