...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::Button (GlobalNamespace::StandardLevelBuyInfoView::*)()>(&GlobalNamespace::StandardLevelBuyInfoView::get_buyLevelButton)> {
  ...
  constexpr static std::size_t addrs = 0x218f614;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::Button (GlobalNamespace::StandardLevelBuyInfoView::*)()>(&GlobalNamespace::StandardLevelBuyInfoView::get_openPackButton)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x218f61c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::UI::Button (GlobalNamespace::StandardLevelBuyInfoView::*)()>(&GlobalNamespace::StandardLevelBuyInfoView::get_buyPackButton)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x218f624;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StandardLevelBuyInfoView::*)(::StringW, bool)>(&GlobalNamespace::StandardLevelBuyInfoView::RefreshView)> {
  ...
  constexpr static std::size_t addrs = 0x218f62c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::StandardLevelBuyInfoView::*)()>(&GlobalNamespace::StandardLevelBuyInfoView::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x218f6a4;
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::StandardLevelBuyInfoView::__get__text() const {
...
constexpr UnityEngine::UI::Button GlobalNamespace::StandardLevelBuyInfoView::__get__buyLevelButton() const {
...
constexpr UnityEngine::UI::Button GlobalNamespace::StandardLevelBuyInfoView::__get__openPackButton() const {
...
constexpr UnityEngine::UI::Button GlobalNamespace::StandardLevelBuyInfoView::__get__buyPackButton() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, infoText, canBuyPack);
}
// Ctor Parameters []
 GlobalNamespace::StandardLevelBuyInfoView::StandardLevelBuyInfoView()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<StandardLevelBuyInfoView>())) {}
 void GlobalNamespace::StandardLevelBuyInfoView::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::StandardLevelBuyInfoView>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
