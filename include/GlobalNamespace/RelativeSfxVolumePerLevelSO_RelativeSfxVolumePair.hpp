...
namespace GlobalNamespace {
  ...
  class RelativeSfxVolumePerLevelSO::RelativeSfxVolumePair : public ::Il2CppObject {
    ...
    // Creating value type constructor for type: RelativeSfxVolumePair
    RelativeSfxVolumePair(GlobalNamespace::BeatmapLevelSO* level_ = {}, float relativeSfxVolume_ = {}) noexcept : level{level_}, relativeSfxVolume{relativeSfxVolume_} {}
