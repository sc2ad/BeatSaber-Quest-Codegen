...
namespace GlobalNamespace {
struct ____GlobalNamespace__MissionLevelGameplayManager__GameState;
}
namespace GlobalNamespace {
class MissionLevelGameplayManager;
}
namespace GlobalNamespace {
class ____GlobalNamespace__MissionLevelGameplayManager__InitData;
}
namespace GlobalNamespace {
class ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23;
}
// Type: ::InitData
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__MissionLevelGameplayManager__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__MissionLevelGameplayManager__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MissionLevelGameplayManager__InitData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData(____GlobalNamespace__MissionLevelGameplayManager__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MissionLevelGameplayManager__InitData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData(____GlobalNamespace__MissionLevelGameplayManager__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MissionLevelGameplayManager__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData& operator=(____GlobalNamespace__MissionLevelGameplayManager__InitData&& o) noexcept = default;
  constexpr ____GlobalNamespace__MissionLevelGameplayManager__InitData& operator=(____GlobalNamespace__MissionLevelGameplayManager__InitData const& o) noexcept = default;
...
explicit ____GlobalNamespace__MissionLevelGameplayManager__InitData(bool failOn0Energy) ;
...
struct CORDL_TYPE ____GlobalNamespace__MissionLevelGameplayManager__GameState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__MissionLevelGameplayManager__GameState(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__MissionLevelGameplayManager__GameState(____GlobalNamespace__MissionLevelGameplayManager__GameState const&) = default;
                    constexpr ____GlobalNamespace__MissionLevelGameplayManager__GameState(____GlobalNamespace__MissionLevelGameplayManager__GameState&&) = default;
                    constexpr ____GlobalNamespace__MissionLevelGameplayManager__GameState& operator=(____GlobalNamespace__MissionLevelGameplayManager__GameState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__MissionLevelGameplayManager__GameState& operator=(____GlobalNamespace__MissionLevelGameplayManager__GameState&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__MissionLevelGameplayManager__GameState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__MissionLevelGameplayManager__GameState_Unwrapped : int32_t {
__Intro = 0,
__Playing = 1,
__Paused = 2,
__Finished = 3,
...
constexpr operator ______GlobalNamespace__MissionLevelGameplayManager__GameState_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__MissionLevelGameplayManager__GameState_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState const Intro;

/// @brief Field Playing offset 0
static ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState const Playing;

/// @brief Field Paused offset 0
static ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState const Paused;

/// @brief Field Finished offset 0
static ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState const Finished;

/// @brief Field Failed offset 0
static ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState const Failed;
...
class CORDL_TYPE ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__MissionLevelGameplayManager___Start_d__23() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MissionLevelGameplayManager___Start_d__23", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23(____GlobalNamespace__MissionLevelGameplayManager___Start_d__23 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__MissionLevelGameplayManager___Start_d__23", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23(____GlobalNamespace__MissionLevelGameplayManager___Start_d__23&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23& operator=(____GlobalNamespace__MissionLevelGameplayManager___Start_d__23&& o) noexcept = default;
  constexpr ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23& operator=(____GlobalNamespace__MissionLevelGameplayManager___Start_d__23 const& o) noexcept = default;
...
explicit ____GlobalNamespace__MissionLevelGameplayManager___Start_d__23(int32_t __1__state) ;
...
public:
// Declarations
using _Start_d__23 = ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager___Start_d__23;

using GameState = ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState;

using InitData = ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData;
...
constexpr ::GlobalNamespace::PauseController __get__pauseController() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData __declspec(property(get=__get__initData, put=__set__initData))  _initData;

constexpr void __set__initData(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData __get__initData() const;
...
constexpr ::System::Action __get_levelFinishedEvent() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState __declspec(property(get=__get__gameState, put=__set__gameState))  _gameState;

constexpr void __set__gameState(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState __get__gameState() const;

 ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState __declspec(property(get=__get__prePauseGameState, put=__set__prePauseGameState))  _prePauseGameState;

constexpr void __set__prePauseGameState(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState __get__prePauseGameState() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__GameState, "", "MissionLevelGameplayManager/GameState");
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager__InitData, "", "MissionLevelGameplayManager/InitData");
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager___Start_d__23);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MissionLevelGameplayManager___Start_d__23, "", "MissionLevelGameplayManager/<Start>d__23");
