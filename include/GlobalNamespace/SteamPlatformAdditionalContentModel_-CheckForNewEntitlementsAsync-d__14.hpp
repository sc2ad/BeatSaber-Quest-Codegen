...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamPlatformAdditionalContentModel::$CheckForNewEntitlementsAsync$d__14), 32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>) + ((32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>)) % 8 != 0 ? (8 - (32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>)) % 8) : 0)> __GlobalNamespace_SteamPlatformAdditionalContentModel_$CheckForNewEntitlementsAsync$d__14SizeCheck;
}
