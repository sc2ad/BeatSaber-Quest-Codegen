...
namespace GlobalNamespace {
  ...
  struct SteamPlatformAdditionalContentModel::$CheckForNewEntitlementsAsync$d__14 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
