...
namespace GlobalNamespace {
  ...
  class MultiplayerLocalInactivePlayerInstaller : public Zenject::MonoInstaller {
    ...
    // [InjectAttribute] Offset: 0xF3DEC0
    ...
    // [InjectAttribute] Offset: 0xF3DED0
    ...
    // [InjectAttribute] Offset: 0xF3DEE0
    ...
    MultiplayerLocalInactivePlayerInstaller(GlobalNamespace::AudioManagerSO* audioManager_ = {}, GlobalNamespace::GameplayCoreSceneSetupData* sceneSetupData_ = {}, GlobalNamespace::PerceivedLoudnessPerLevelModel* beatmapLoudnessModel_ = {}, GlobalNamespace::RelativeSfxVolumePerLevelModel* relativeSfxVolumePerLevelModel_ = {}) noexcept : audioManager{audioManager_}, sceneSetupData{sceneSetupData_}, beatmapLoudnessModel{beatmapLoudnessModel_}, relativeSfxVolumePerLevelModel{relativeSfxVolumePerLevelModel_} {}
