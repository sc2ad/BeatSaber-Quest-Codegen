...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HapticFeedbackController::RumbleData), 28 + sizeof(float) + 8 - (28 + sizeof(float)) % 8> __GlobalNamespace_HapticFeedbackController_RumbleDataSizeCheck;
}
