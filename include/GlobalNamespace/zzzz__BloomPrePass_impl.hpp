...
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode::____GlobalNamespace__BloomPrePass__Mode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode  ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode::RenderAndSetData{0};
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode  ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode::SetDataOnly{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePass::*)(::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode)>(&::GlobalNamespace::BloomPrePass::SetMode)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "SetMode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::BloomPrePass::__set__mode(::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode ::GlobalNamespace::BloomPrePass::__get__mode() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::BloomPrePass::__set__renderData(::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data ::GlobalNamespace::BloomPrePass::__get__renderData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BloomPrePassRenderDataSO__Data, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::BloomPrePass::SetMode(::GlobalNamespace::____GlobalNamespace__BloomPrePass__Mode mode)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BloomPrePass>::get(),
                            "SetMode",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 ::GlobalNamespace::BloomPrePass::BloomPrePass()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<BloomPrePass>())) {}
