...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool::*)()>(&::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x22515e4;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{}
                        )));
...
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool::____GlobalNamespace__FlyingTextEffect__Pool()  : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::FlyingTextEffect>(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__FlyingTextEffect__Pool>())) {}
 void ::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
