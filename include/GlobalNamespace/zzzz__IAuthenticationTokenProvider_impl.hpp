...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform (::GlobalNamespace::IAuthenticationTokenProvider::*)(::GlobalNamespace::PlatformEnvironment)>(&::GlobalNamespace::IAuthenticationTokenProvider::GetTokenPlatform)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform (::GlobalNamespace::IAuthenticationTokenProvider::*)()>(&::GlobalNamespace::IAuthenticationTokenProvider::get_platform)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
return ::cordl_internals::RunMethodRethrow<::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform ::GlobalNamespace::IAuthenticationTokenProvider::GetTokenPlatform(::GlobalNamespace::PlatformEnvironment tokenPlatformEnvironment)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::IAuthenticationTokenProvider>::get(),
                            "GetTokenPlatform",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform ::GlobalNamespace::IAuthenticationTokenProvider::get_platform()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::IAuthenticationTokenProvider>::get(),
                            "get_platform",
                            std::vector<Il2CppClass*>{},
