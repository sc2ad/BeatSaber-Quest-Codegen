...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SetSaberGlowColor::PropertyTintColorPair), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_SetSaberGlowColor_PropertyTintColorPairSizeCheck;
}
