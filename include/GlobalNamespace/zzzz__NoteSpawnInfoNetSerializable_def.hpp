...
constexpr ::GlobalNamespace::NoteLineLayer __get_beforeJumpNoteLineLayer() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType __declspec(property(get=__get_gameplayType, put=__set_gameplayType))  gameplayType;

constexpr void __set_gameplayType(::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType __get_gameplayType() const;
