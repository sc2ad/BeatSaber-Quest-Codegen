...
namespace GlobalNamespace {
class ____GlobalNamespace__LightPairRotationEventEffect__RotationData;
}
// Type: ::RotationData
namespace GlobalNamespace {
// Is value type: false
...
class CORDL_TYPE ____GlobalNamespace__LightPairRotationEventEffect__RotationData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~____GlobalNamespace__LightPairRotationEventEffect__RotationData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LightPairRotationEventEffect__RotationData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData(____GlobalNamespace__LightPairRotationEventEffect__RotationData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LightPairRotationEventEffect__RotationData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData(____GlobalNamespace__LightPairRotationEventEffect__RotationData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LightPairRotationEventEffect__RotationData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData& operator=(____GlobalNamespace__LightPairRotationEventEffect__RotationData&& o) noexcept = default;
  constexpr ____GlobalNamespace__LightPairRotationEventEffect__RotationData& operator=(____GlobalNamespace__LightPairRotationEventEffect__RotationData const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__LightPairRotationEventEffect__RotationData() ;
...
public:
// Declarations
using RotationData = ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData;
...
static constexpr float_t  kSpeedMultiplier{20};
 ...
 ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData __declspec(property(get=__get__rotationDataL, put=__set__rotationDataL))  _rotationDataL;

constexpr void __set__rotationDataL(::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData __get__rotationDataL() const;

 ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData __declspec(property(get=__get__rotationDataR, put=__set__rotationDataR))  _rotationDataR;

constexpr void __set__rotationDataR(::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData __get__rotationDataR() const;
...
/// @brief Method UpdateRotationData addr 0x2261940 size 0x21c virtual false final false
 void UpdateRotationData(int32_t beatmapEventDataValue, ::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData rotationData, float_t startRotationOffset, float_t direction) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LightPairRotationEventEffect__RotationData, "", "LightPairRotationEventEffect/RotationData");
