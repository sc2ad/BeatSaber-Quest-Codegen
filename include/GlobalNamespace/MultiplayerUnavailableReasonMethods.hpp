...
namespace GlobalNamespace {
  ...
  class MultiplayerUnavailableReasonMethods : public ::Il2CppObject {
    public:
    // [LocalizationKeyAttribute] Offset: 0x111BC78
    ...
    // [LocalizationKeyAttribute] Offset: 0x111BC88
    ...
    // [LocalizationKeyAttribute] Offset: 0x111BC98
    ...
    // [LocalizationKeyAttribute] Offset: 0x111BCA8
