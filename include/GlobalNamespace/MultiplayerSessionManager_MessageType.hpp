...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerSessionManager_MessageType), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __GlobalNamespace_MultiplayerSessionManager_MessageTypeSizeCheck;
}
