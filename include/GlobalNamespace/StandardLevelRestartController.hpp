...
namespace GlobalNamespace {
  ...
  class StandardLevelRestartController : public UnityEngine::MonoBehaviour/*, public GlobalNamespace::ILevelRestartController*/ {
    ...
    // [InjectAttribute] Offset: 0xDC8690
    ...
    static StandardLevelRestartController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("StandardLevelRestartController").WithContext(".ctor");
