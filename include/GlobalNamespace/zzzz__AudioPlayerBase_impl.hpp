...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::AudioPlayerBase GlobalNamespace::AudioPlayerBase::New_ctor()  {
GlobalNamespace::AudioPlayerBase o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::AudioPlayerBase>())};
return o;
}
