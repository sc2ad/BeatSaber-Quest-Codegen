...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__NoteData__GameplayType (GlobalNamespace::GameNoteController::*)()>(&GlobalNamespace::GameNoteController::get_gameplayType)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void GlobalNamespace::GameNoteController::__set__gameplayType(GlobalNamespace::GlobalNamespace__NoteData__GameplayType value)  {
...
constexpr GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::GameNoteController::__get__gameplayType() const {
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::NoteVisualModifierType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::GameNoteController::get_gameplayType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GameNoteController>::get(),
                            "get_gameplayType",
                            std::vector<Il2CppClass*>{},
...
GlobalNamespace::GameNoteController o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::GameNoteController>())};
return o;
}
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__GameNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__GameNoteController__Pool::*)()>(&GlobalNamespace::GlobalNamespace__GameNoteController__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x223d46c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__GameNoteController__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{}
                        )));
 ...
 GlobalNamespace::GlobalNamespace__GameNoteController__Pool GlobalNamespace::GlobalNamespace__GameNoteController__Pool::New_ctor()  {
GlobalNamespace::GlobalNamespace__GameNoteController__Pool o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::GlobalNamespace__GameNoteController__Pool>())};
return o;
}
 void GlobalNamespace::GlobalNamespace__GameNoteController__Pool::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__GameNoteController__Pool>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
