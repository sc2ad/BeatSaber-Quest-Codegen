...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MainSettingsMenuViewControllersInstaller), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __GlobalNamespace_MainSettingsMenuViewControllersInstallerSizeCheck;
}
