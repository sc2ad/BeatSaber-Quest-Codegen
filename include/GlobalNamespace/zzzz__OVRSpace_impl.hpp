...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation::____GlobalNamespace__OVRSpace__StorageLocation(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation  ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation::Local{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation  ::GlobalNamespace::____GlobalNamespace__OVRSpace__StorageLocation::Cloud{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::OVRSpace (*)(uint64_t)>(&::GlobalNamespace::OVRSpace::op_Implicit___GlobalNamespace__OVRSpace)> {
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, lhs, rhs);
 ...
 ::GlobalNamespace::OVRSpace ::GlobalNamespace::OVRSpace::op_Implicit___GlobalNamespace__OVRSpace(uint64_t handle)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRSpace>::get(),
                            "op_Implicit",
                            std::vector<Il2CppClass*>{},
