...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__NoteData__GameplayType (GlobalNamespace::BurstSliderGameNoteController::*)()>(&GlobalNamespace::BurstSliderGameNoteController::get_gameplayType)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void GlobalNamespace::BurstSliderGameNoteController::__set__gameplayType(GlobalNamespace::GlobalNamespace__NoteData__GameplayType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__NoteData__GameplayType, 0xac>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__NoteData__GameplayType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::BurstSliderGameNoteController::__get__gameplayType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__NoteData__GameplayType, 0xac>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::NoteVisualModifierType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::BurstSliderGameNoteController::get_gameplayType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BurstSliderGameNoteController>::get(),
                            "get_gameplayType",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BurstSliderGameNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BurstSliderGameNoteController__Pool::*)()>(&GlobalNamespace::GlobalNamespace__BurstSliderGameNoteController__Pool::_ctor)> {
