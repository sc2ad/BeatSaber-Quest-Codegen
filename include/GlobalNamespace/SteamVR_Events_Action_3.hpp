...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Action_3 : public GlobalNamespace::SteamVR_Events::Action {
    ...
    GlobalNamespace::SteamVR_Events::Event_3<T0, T1, T2>* _get__event() {
      ...
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<GlobalNamespace::SteamVR_Events::Event_3<T0, T1, T2>*>(___internal__instance, "_event")));
    }
    ...
    UnityEngine::Events::UnityAction_3<T0, T1, T2>* _get_action() {
      ...
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_3<T0, T1, T2>*>(___internal__instance, "action")));
    }
    // Autogenerated instance field setter
