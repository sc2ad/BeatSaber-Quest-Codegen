...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Action_3 : public GlobalNamespace::SteamVR_Events::Action {
    ...
    GlobalNamespace::SteamVR_Events::Event_3<T0, T1, T2>* _get__event() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_3::_get__event");
    ...
    // Set instance field: private SteamVR_Events/Event`3<T0,T1,T2> _event
    void _set__event(GlobalNamespace::SteamVR_Events::Event_3<T0, T1, T2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_3::_set__event");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_event"))->offset;
      *reinterpret_cast<GlobalNamespace::SteamVR_Events::Event_3<T0, T1, T2>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
    // Autogenerated instance field getter
    // Get instance field: private UnityEngine.Events.UnityAction`3<T0,T1,T2> action
    UnityEngine::Events::UnityAction_3<T0, T1, T2>* _get_action() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_3::_get_action");
      auto ___internal__instance = this;
    ...
    // Autogenerated instance field setter
    // Set instance field: private UnityEngine.Events.UnityAction`3<T0,T1,T2> action
    void _set_action(UnityEngine::Events::UnityAction_3<T0, T1, T2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_3::_set_action");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "action"))->offset;
      *reinterpret_cast<UnityEngine::Events::UnityAction_3<T0, T1, T2>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
