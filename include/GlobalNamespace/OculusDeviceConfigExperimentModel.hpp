...
namespace GlobalNamespace {
  ...
  class OculusDeviceConfigExperimentModel : public ::Il2CppObject/*, public GlobalNamespace::IExperimentModel*/ {
    ...
    // Creating value type constructor for type: OculusDeviceConfigExperimentModel
    OculusDeviceConfigExperimentModel(System::Threading::Tasks::Task* initializationTask_ = {}) noexcept : initializationTask{initializationTask_} {}
