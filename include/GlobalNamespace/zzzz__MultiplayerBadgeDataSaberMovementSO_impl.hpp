...
return ::cordl_internals::RunMethodRethrow<float_t, false>(const_cast<void*>(instance), ___internal_method, result);
 ...
 GlobalNamespace::MultiplayerBadgeDataSaberMovementSO GlobalNamespace::MultiplayerBadgeDataSaberMovementSO::New_ctor()  {
GlobalNamespace::MultiplayerBadgeDataSaberMovementSO o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MultiplayerBadgeDataSaberMovementSO>())};
return o;
}
