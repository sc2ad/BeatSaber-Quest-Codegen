...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_RenderModel::$SetModelAsync$d__21), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __GlobalNamespace_SteamVR_RenderModel_$SetModelAsync$d__21SizeCheck;
}
