...
constexpr void GlobalNamespace::FlyingSpriteSpawner::__set__flyingSpriteEffectPool(GlobalNamespace::GlobalNamespace__FlyingSpriteEffect__Pool value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__FlyingSpriteEffect__Pool, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__FlyingSpriteEffect__Pool>(value));
}
constexpr GlobalNamespace::GlobalNamespace__FlyingSpriteEffect__Pool GlobalNamespace::FlyingSpriteSpawner::__get__flyingSpriteEffectPool() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__FlyingSpriteEffect__Pool, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
GlobalNamespace::FlyingSpriteSpawner o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::FlyingSpriteSpawner>())};
return o;
}
