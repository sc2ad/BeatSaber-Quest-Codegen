...
constexpr void GlobalNamespace::OVRGrabber::__set_m_controller(GlobalNamespace::GlobalNamespace__OVRInput__Controller value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__OVRInput__Controller, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__OVRInput__Controller>(value));
}
constexpr GlobalNamespace::GlobalNamespace__OVRInput__Controller GlobalNamespace::OVRGrabber::__get_m_controller() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__OVRInput__Controller, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
