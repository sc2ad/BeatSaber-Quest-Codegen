...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerGamepadMac), 257 + sizeof(bool) + ((257 + sizeof(bool)) % 8 != 0 ? (8 - (257 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerGamepadMacSizeCheck;
}
