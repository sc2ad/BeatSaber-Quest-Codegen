...
namespace GlobalNamespace {
  ...
  class FireworkItemController : public UnityEngine::MonoBehaviour {
    ...
    #endif
    #endif
    // [HeaderAttribute] Offset: 0xF3A664
    // [NullAllowed] Offset: 0xF3A664
    ...
    // [HeaderAttribute] Offset: 0xF3A6C0
    ...
    // [SpaceAttribute] Offset: 0xF3A71C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xF3A774
    ...
    char __padding6[0x3] = {};
    // [DrawIfAttribute] Offset: 0xF3A7C0
    ...
    // [DrawIfAttribute] Offset: 0xF3A864
    ...
    // [SpaceAttribute] Offset: 0xF3A90C
    ...
    char __padding9[0x3] = {};
    // [DrawIfAttribute] Offset: 0xF3A944
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [DrawIfAttribute] Offset: 0xF3A9EC
