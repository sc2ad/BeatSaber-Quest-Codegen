...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::*)()>(&::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x210c76c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData>::get(),
                            ".ctor",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::*)(::UnityEngine::Color)>(&::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::_ctor)> {
...
constexpr void ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::__set_trailTintColor(::UnityEngine::Color value)  {
...
constexpr ::UnityEngine::Color ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::__get_trailTintColor() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::____GlobalNamespace__SaberModelController__InitData()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__SaberModelController__InitData>())) {}
 void ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters [CppParam { name: "trailTintColor", ty: "::UnityEngine::Color", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::____GlobalNamespace__SaberModelController__InitData(::UnityEngine::Color trailTintColor)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__SaberModelController__InitData>(trailTintColor))) {}
 void ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData::_ctor(::UnityEngine::Color trailTintColor)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::SaberModelController::__set__initData(::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData ::GlobalNamespace::SaberModelController::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__SaberModelController__InitData, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
