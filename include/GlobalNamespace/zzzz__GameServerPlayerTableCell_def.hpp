...
namespace GlobalNamespace {
class ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35;
}
...
class CORDL_TYPE ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0(____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0(____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0& operator=(____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0&& o) noexcept = default;
  constexpr ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0& operator=(____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0() ;
...
struct CORDL_TYPE ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::GameServerPlayerTableCell", modifiers: "", def_value: None }, CppParam { name: "getLevelEntitlementTask", ty: "::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::GameServerPlayerTableCell __4__this, ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> getLevelEntitlementTask, ::System::Threading::CancellationToken _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept;


                    constexpr ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35(____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35 const&) = default;
                    constexpr ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35(____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35&&) = default;
                    constexpr ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35& operator=(____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35& operator=(____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::GlobalNamespace::GameServerPlayerTableCell __get___4__this() const;
 ...
 ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __declspec(property(get=__get_getLevelEntitlementTask, put=__set_getLevelEntitlementTask))  getLevelEntitlementTask;

constexpr void __set_getLevelEntitlementTask(::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> value) ;

constexpr ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __get_getLevelEntitlementTask() const;
...
public:
// Declarations
using _SetBeatmapUseButtonEnabledAsync_d__35 = ::GlobalNamespace::____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35;

using __c__DisplayClass29_0 = ::GlobalNamespace::____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0;
...
/// @brief Method SetData addr 0x2123bc4 size 0xb24 virtual false final false
 void SetData(::GlobalNamespace::IConnectedPlayer connectedPlayer, ::GlobalNamespace::ILobbyPlayerData playerData, bool hasKickPermissions, bool allowSelection, ::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> getLevelEntitlementTask) ;
...
/// @brief Method SetBeatmapUseButtonEnabledAsync addr 0x21246f0 size 0xa0 virtual false final false
 void SetBeatmapUseButtonEnabledAsync(::System::Threading::Tasks::Task_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> getLevelEntitlementTask) ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameServerPlayerTableCell____c__DisplayClass29_0, "", "GameServerPlayerTableCell/<>c__DisplayClass29_0");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameServerPlayerTableCell___SetBeatmapUseButtonEnabledAsync_d__35, "", "GameServerPlayerTableCell/<SetBeatmapUseButtonEnabledAsync>d__35");
