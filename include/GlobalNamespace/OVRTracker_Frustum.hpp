...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRTracker::Frustum), 8 + sizeof(UnityEngine::Vector2) + ((8 + sizeof(UnityEngine::Vector2)) % 8 != 0 ? (8 - (8 + sizeof(UnityEngine::Vector2)) % 8) : 0)> __GlobalNamespace_OVRTracker_FrustumSizeCheck;
}
