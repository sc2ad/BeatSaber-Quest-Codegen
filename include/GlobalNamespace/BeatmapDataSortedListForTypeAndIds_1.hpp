...
namespace GlobalNamespace {
  ...
  class BeatmapDataSortedListForTypeAndIds_1 : public ::Il2CppObject {
    ...
    // public System.Collections.Generic.LinkedListNode`1<TBase> GetHeadNode(System.Int32 typeIdentifier)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class T>
    ::System::Collections::Generic::LinkedListNode_1<TBase>* GetHeadNode(int typeIdentifier) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1::GetHeadNode");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "GetHeadNode", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(typeIdentifier)})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodRethrow<::System::Collections::Generic::LinkedListNode_1<TBase>*, false>(this, ___generic__method, typeIdentifier);
    }
