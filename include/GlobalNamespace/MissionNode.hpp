...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [SelectionBaseAttribute] Offset: DBE8AC
  class MissionNode : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xDCE5EC
    ...
    static MissionNode* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("MissionNode").WithContext(".ctor");
