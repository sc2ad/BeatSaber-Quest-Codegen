...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::MaterialPropertyBlockFloatCurve GlobalNamespace::MaterialPropertyBlockFloatCurve::New_ctor()  {
GlobalNamespace::MaterialPropertyBlockFloatCurve o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MaterialPropertyBlockFloatCurve>())};
return o;
}
