...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerResultsTableView), 192 + sizeof(UnityEngine::Quaternion) + ((192 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (192 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_MultiplayerResultsTableViewSizeCheck;
}
