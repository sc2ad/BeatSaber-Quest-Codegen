...
namespace GlobalNamespace {
  ...
  class MirroredNoteController_1 : public ::GlobalNamespace::NoteControllerBase/*, public ::GlobalNamespace::INoteControllerNoteDidStartDissolvingEvent, public ::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent*/ {
    ...
    [[deprecated("Use field access instead!")]] T& dyn_followedNote() {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::Transform*& dyn__followedNoteTransform() {
    ...
    // Offset: 0xFFFFFFFFFFFFFFFF
    void Hide(bool hide) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::MirroredNoteController_1::Hide");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Hide", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(hide)})));
