...
namespace GlobalNamespace {
  ...
  class VRControllersRecorder : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(VRControllersRecorder::Mode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_VRControllersRecorder_ModeSizeCheck;
  ...
  check_size<sizeof(VRControllersRecorder), 152 + sizeof(int) + ((152 + sizeof(int)) % 8 != 0 ? (8 - (152 + sizeof(int)) % 8) : 0)> __GlobalNamespace_VRControllersRecorderSizeCheck;
}
