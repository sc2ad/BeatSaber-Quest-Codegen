...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlatformMenu::eBackButtonAction), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlatformMenu_eBackButtonActionSizeCheck;
}
