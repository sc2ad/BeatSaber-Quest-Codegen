...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LevelFilteringNavigationController), 304 + sizeof(void*) + 8 - (304 + sizeof(void*)) % 8> __GlobalNamespace_LevelFilteringNavigationControllerSizeCheck;
}
