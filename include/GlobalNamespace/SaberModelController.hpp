...
namespace GlobalNamespace {
  ...
  class SaberModelController : public UnityEngine::MonoBehaviour {
    ...
    // [InjectOptionalAttribute] Offset: 0xDCAE34
    ...
    // [InjectAttribute] Offset: 0xDCAE44
    ...
    static SaberModelController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("SaberModelController").WithContext(".ctor");
