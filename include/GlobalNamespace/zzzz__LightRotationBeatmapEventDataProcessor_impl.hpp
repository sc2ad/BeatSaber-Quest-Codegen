...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, nodeToDelete);
 ...
 GlobalNamespace::LightRotationBeatmapEventDataProcessor GlobalNamespace::LightRotationBeatmapEventDataProcessor::New_ctor()  {
GlobalNamespace::LightRotationBeatmapEventDataProcessor o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::LightRotationBeatmapEventDataProcessor>())};
return o;
}
