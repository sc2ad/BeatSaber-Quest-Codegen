...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(NoteSpawnInfoNetSerializable), 108 + sizeof(float)> __GlobalNamespace_NoteSpawnInfoNetSerializableSizeCheck;
  static_assert(sizeof(NoteSpawnInfoNetSerializable) == 0x70);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
