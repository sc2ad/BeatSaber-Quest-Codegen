...
constexpr void ::GlobalNamespace::ShockwaveEffect::__set__shockwavePSEmitParams(::UnityEngine::____UnityEngine__ParticleSystem__EmitParams value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__EmitParams ::GlobalNamespace::ShockwaveEffect::__get__shockwavePSEmitParams() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__EmitParams, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
