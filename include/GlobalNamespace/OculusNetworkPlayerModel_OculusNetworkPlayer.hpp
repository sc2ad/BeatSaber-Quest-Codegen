...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusNetworkPlayerModel::OculusNetworkPlayer), 77 + sizeof(bool) + ((77 + sizeof(bool)) % 8 != 0 ? (8 - (77 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_OculusNetworkPlayerModel_OculusNetworkPlayerSizeCheck;
}
