...
namespace GlobalNamespace {
  ...
  class BeatmapCharacteristicSO : public ::GlobalNamespace::PersistentScriptableObject {
    ...
    // [LocalizationKeyAttribute] Offset: 0x10D0AD0
    ...
    // [LocalizationKeyAttribute] Offset: 0x10D0B08
    ...
    [[deprecated("Use field access instead!")]] ::StringW& dyn__characteristicNameLocalizationKey();
    ...
    [[deprecated("Use field access instead!")]] ::StringW& dyn__compoundIdPartName();
    ...
    [[deprecated("Use field access instead!")]] bool& dyn__containsRotationEvents();
    // Get instance field reference: private System.Boolean _requires360Movement
    [[deprecated("Use field access instead!")]] bool& dyn__requires360Movement();
