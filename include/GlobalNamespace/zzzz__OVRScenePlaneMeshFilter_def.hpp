...
namespace GlobalNamespace {
struct ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList;
}
// Type: ::NList
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList(int32_t _Count_k__BackingField, ::Unity::Collections::NativeArray_1<int32_t> _data) noexcept;


                    constexpr ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList(______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList const&) = default;
                    constexpr ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList(______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList&&) = default;
                    constexpr ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList& operator=(______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList& operator=(______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList&& o) noexcept {
...
constexpr explicit ______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
using NList = ::GlobalNamespace::______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList;
...
constexpr ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob(::Unity::Collections::NativeArray_1<::UnityEngine::Vector2> Boundary, ::Unity::Collections::NativeArray_1<int32_t> Triangles) noexcept;


                    constexpr ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob(____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob const&) = default;
                    constexpr ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob(____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob&&) = default;
                    constexpr ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob& operator=(____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob& operator=(____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using TriangulateBoundaryJob = ::GlobalNamespace::____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob, "", "OVRScenePlaneMeshFilter/TriangulateBoundaryJob");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______GlobalNamespace__OVRScenePlaneMeshFilter__TriangulateBoundaryJob__NList, "", "OVRScenePlaneMeshFilter/TriangulateBoundaryJob/NList");
