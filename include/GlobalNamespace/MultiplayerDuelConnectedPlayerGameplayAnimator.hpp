...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerDuelConnectedPlayerGameplayAnimator), 112 + sizeof(void*) + 8 - (112 + sizeof(void*)) % 8> __GlobalNamespace_MultiplayerDuelConnectedPlayerGameplayAnimatorSizeCheck;
}
