...
namespace GlobalNamespace {
  ...
  class PosesPlayback : public ::Il2CppObject {
    ...
    // Offset: 0x11AD88C
    void StartPlayback(::ArrayW<GlobalNamespace::PoseObject*> poseObjects, GlobalNamespace::PosesRecordingData* data);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PosesPlayback::*)(::ArrayW<GlobalNamespace::PoseObject*>, GlobalNamespace::PosesRecordingData*)>(&GlobalNamespace::PosesPlayback::StartPlayback)> {
