...
namespace GlobalNamespace {
  ...
  class BloomPrePassBackgroundNonLightRendererCore : public GlobalNamespace::BloomPrePassNonLightPass {
    ...
    BloomPrePassBackgroundNonLightRendererCore(bool keepDefaultRendering_ = {}, bool useCustomMaterial_ = {}, UnityEngine::Material* customMaterial_ = {}, UnityEngine::Rendering::CommandBuffer* commandBuffer_ = {}) noexcept : keepDefaultRendering{keepDefaultRendering_}, useCustomMaterial{useCustomMaterial_}, customMaterial{customMaterial_}, commandBuffer{commandBuffer_} {}
