...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::*)(float_t, float_t, float_t)>(&::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x20e0e40;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__set_startSongTime(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__get_startSongTime() const {
return ::cordl_internals::getInstanceField<float_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__set_songTimeOffset(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__get_songTimeOffset() const {
return ::cordl_internals::getInstanceField<float_t, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__set_timeScale(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::__get_timeScale() const {
...
// Ctor Parameters [CppParam { name: "startSongTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "songTimeOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "timeScale", ty: "float_t", modifiers: "", def_value: None }]
 ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData(float_t startSongTime, float_t songTimeOffset, float_t timeScale)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData>(startSongTime, songTimeOffset, timeScale))) {}
 void ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData::_ctor(float_t startSongTime, float_t songTimeOffset, float_t timeScale)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr void ::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController::__set__initData(::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData ::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__MultiplayerConnectedPlayerSongTimeSyncController__InitData, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
