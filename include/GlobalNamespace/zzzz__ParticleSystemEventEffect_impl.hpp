...
constexpr void ::GlobalNamespace::ParticleSystemEventEffect::__set__mainModule(::UnityEngine::____UnityEngine__ParticleSystem__MainModule value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__MainModule, 0x90>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__MainModule>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__MainModule ::GlobalNamespace::ParticleSystemEventEffect::__get__mainModule() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__MainModule, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::ParticleSystemEventEffect::__set__particles(::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>, 0x98>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>>(value));
}
constexpr ::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle> ::GlobalNamespace::ParticleSystemEventEffect::__get__particles() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
