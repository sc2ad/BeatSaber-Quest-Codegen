...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, data, ktxData);
 ...
 GlobalNamespace::OVRKtxTexture GlobalNamespace::OVRKtxTexture::New_ctor()  {
GlobalNamespace::OVRKtxTexture o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::OVRKtxTexture>())};
return o;
}
