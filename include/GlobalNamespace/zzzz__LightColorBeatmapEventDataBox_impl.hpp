...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LightColorBeatmapEventDataBox::*)(GlobalNamespace::IndexFilter, float_t, GlobalNamespace::GlobalNamespace__BeatmapEventDataBox__DistributionParamType, float_t, GlobalNamespace::GlobalNamespace__BeatmapEventDataBox__DistributionParamType, bool, GlobalNamespace::EaseType, System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::LightColorBaseData>)>(&GlobalNamespace::LightColorBeatmapEventDataBox::_ctor)> {
