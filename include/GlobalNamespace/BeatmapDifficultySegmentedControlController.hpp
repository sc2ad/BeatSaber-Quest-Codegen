...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapDifficultySegmentedControlController), 48 + sizeof(GlobalNamespace::BeatmapDifficulty) + ((48 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8 != 0 ? (8 - (48 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8) : 0)> __GlobalNamespace_BeatmapDifficultySegmentedControlControllerSizeCheck;
}
