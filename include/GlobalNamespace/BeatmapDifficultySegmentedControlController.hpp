...
namespace GlobalNamespace {
  ...
  class BeatmapDifficultySegmentedControlController : public UnityEngine::MonoBehaviour {
    ...
    static BeatmapDifficultySegmentedControlController* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BeatmapDifficultySegmentedControlController").WithContext(".ctor");
