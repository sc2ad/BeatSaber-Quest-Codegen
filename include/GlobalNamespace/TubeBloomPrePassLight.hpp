...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TubeBloomPrePassLight), 176 + sizeof(::UnityEngine::Transform*)> __GlobalNamespace_TubeBloomPrePassLightSizeCheck;
  static_assert(sizeof(TubeBloomPrePassLight) == 0xB8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
