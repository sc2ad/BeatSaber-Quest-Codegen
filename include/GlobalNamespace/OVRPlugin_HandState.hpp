...
namespace GlobalNamespace {
  ...
  struct OVRPlugin::HandState/*, public System::ValueType*/ {
    ...
    constexpr HandState(GlobalNamespace::OVRPlugin::HandStatus Status_ = {}, GlobalNamespace::OVRPlugin::Posef RootPose_ = {}, ::ArrayWrapper<GlobalNamespace::OVRPlugin::Quatf> BoneRotations_ = {nullptr}, GlobalNamespace::OVRPlugin::HandFingerPinch Pinches_ = {}, ::ArrayWrapper<float> PinchStrength_ = {nullptr}, GlobalNamespace::OVRPlugin::Posef PointerPose_ = {}, float HandScale_ = {}, GlobalNamespace::OVRPlugin::TrackingConfidence HandConfidence_ = {}, ::ArrayWrapper<GlobalNamespace::OVRPlugin::TrackingConfidence> FingerConfidences_ = {nullptr}, double RequestedTimeStamp_ = {}, double SampleTimeStamp_ = {}) noexcept : Status{Status_}, RootPose{RootPose_}, BoneRotations{BoneRotations_}, Pinches{Pinches_}, PinchStrength{PinchStrength_}, PointerPose{PointerPose_}, HandScale{HandScale_}, HandConfidence{HandConfidence_}, FingerConfidences{FingerConfidences_}, RequestedTimeStamp{RequestedTimeStamp_}, SampleTimeStamp{SampleTimeStamp_} {}
