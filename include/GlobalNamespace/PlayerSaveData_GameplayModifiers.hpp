...
namespace GlobalNamespace {
  ...
  class PlayerSaveData::GameplayModifiers : public ::Il2CppObject {
    ...
    check_size<sizeof(PlayerSaveData::GameplayModifiers::EnabledObstacleType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_PlayerSaveData_GameplayModifiers_EnabledObstacleTypeSizeCheck;
    ...
    check_size<sizeof(PlayerSaveData::GameplayModifiers::EnergyType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_PlayerSaveData_GameplayModifiers_EnergyTypeSizeCheck;
    ...
    check_size<sizeof(PlayerSaveData::GameplayModifiers::SongSpeed), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_PlayerSaveData_GameplayModifiers_SongSpeedSizeCheck;
  ...
  check_size<sizeof(PlayerSaveData::GameplayModifiers), 40 + sizeof(bool) + 8 - (40 + sizeof(bool)) % 8> __GlobalNamespace_PlayerSaveData_GameplayModifiersSizeCheck;
}
