...
namespace GlobalNamespace {
  ...
  class PlayingTutorialPresenceData : public ::Il2CppObject/*, public GlobalNamespace::IRichPresenceData*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xDC512C
    ...
    static PlayingTutorialPresenceData* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("PlayingTutorialPresenceData").WithContext(".ctor");
