...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveData::PlayerOverallStatsData), 64 + sizeof(int64_t) + ((64 + sizeof(int64_t)) % 8 != 0 ? (8 - (64 + sizeof(int64_t)) % 8) : 0)> __GlobalNamespace_PlayerSaveData_PlayerOverallStatsDataSizeCheck;
}
