...
// CS Name: MultiplayerSyncStateManager`5::<>c
class CORDL_TYPE GlobalNamespace__MultiplayerSyncStateManager_5____c<GlobalNamespace::NodePoseSyncState,System::Int32Enum,GlobalNamespace::PoseSerializable,TSerializable,TDeltaSerializable> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};
...
static GlobalNamespace::GlobalNamespace__MultiplayerSyncStateManager_5____c<GlobalNamespace::NodePoseSyncState,System::Int32Enum,GlobalNamespace::PoseSerializable,TSerializable,TDeltaSerializable> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__MultiplayerSyncStateManager_5____c<GlobalNamespace::NodePoseSyncState,System::Int32Enum,GlobalNamespace::PoseSerializable,TSerializable,TDeltaSerializable> value) ;

static GlobalNamespace::GlobalNamespace__MultiplayerSyncStateManager_5____c<GlobalNamespace::NodePoseSyncState,System::Int32Enum,GlobalNamespace::PoseSerializable,TSerializable,TDeltaSerializable> __get___9() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__MultiplayerSyncStateManager_5____c<GlobalNamespace::NodePoseSyncState, System::Int32Enum, GlobalNamespace::PoseSerializable, TSerializable, TDeltaSerializable>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__MultiplayerSyncStateManager_5____c, "", "MultiplayerSyncStateManager`5/<>c");
