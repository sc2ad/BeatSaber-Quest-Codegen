...
namespace GlobalNamespace {
  ...
  class OVRHand : public UnityEngine::MonoBehaviour/*, public GlobalNamespace::OVRSkeleton::IOVRSkeletonDataProvider, public GlobalNamespace::OVRSkeletonRenderer::IOVRSkeletonRendererDataProvider, public GlobalNamespace::OVRMesh::IOVRMeshDataProvider, public GlobalNamespace::OVRMeshRenderer::IOVRMeshRendererDataProvider*/ {
    ...
    check_size<sizeof(OVRHand::Hand), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRHand_HandSizeCheck;
    ...
    check_size<sizeof(OVRHand::TrackingConfidence), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVRHand_TrackingConfidenceSizeCheck;
  ...
  check_size<sizeof(OVRHand), 188 + sizeof(GlobalNamespace::OVRHand::TrackingConfidence) + 8 - (188 + sizeof(GlobalNamespace::OVRHand::TrackingConfidence)) % 8> __GlobalNamespace_OVRHandSizeCheck;
}
