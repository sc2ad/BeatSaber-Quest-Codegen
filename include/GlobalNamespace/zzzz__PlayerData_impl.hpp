...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 GlobalNamespace::PlayerData GlobalNamespace::PlayerData::New_ctor(::StringW playerId, ::StringW playerName, GlobalNamespace::BeatmapCharacteristicSO lastSelectedBeatmapCharacteristic, GlobalNamespace::ColorSchemesSettings colorSchemesSettings, GlobalNamespace::OverrideEnvironmentSettings overrideEnvironmentSettings)  {
GlobalNamespace::PlayerData o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::PlayerData>(playerId, playerName, lastSelectedBeatmapCharacteristic, colorSchemesSettings, overrideEnvironmentSettings))};
return o;
}
