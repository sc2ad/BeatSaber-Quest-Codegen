...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Action_1 : public ::GlobalNamespace::SteamVR_Events::Action {
    ...
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::SteamVR_Events::Event_1<T>*& dyn__event() {
    ...
    [[deprecated("Use field access instead!")]] ::UnityEngine::Events::UnityAction_1<T>*& dyn_action() {
