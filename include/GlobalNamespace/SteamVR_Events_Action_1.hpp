...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Action_1 : public GlobalNamespace::SteamVR_Events::Action {
    ...
    GlobalNamespace::SteamVR_Events::Event_1<T>* _get__event() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_1::_get__event");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<GlobalNamespace::SteamVR_Events::Event_1<T>*>(___internal__instance, "_event"));
    }
    // Autogenerated instance field setter
    // Set instance field: private SteamVR_Events/Event`1<T> _event
    void _set__event(GlobalNamespace::SteamVR_Events::Event_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_1::_set__event");
      static auto ___internal__instance = this;
    ...
    UnityEngine::Events::UnityAction_1<T>* _get_action() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_1::_get_action");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<UnityEngine::Events::UnityAction_1<T>*>(___internal__instance, "action"));
    }
    // Autogenerated instance field setter
    // Set instance field: private UnityEngine.Events.UnityAction`1<T> action
    void _set_action(UnityEngine::Events::UnityAction_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::SteamVR_Events::Action_1::_set_action");
      static auto ___internal__instance = this;
