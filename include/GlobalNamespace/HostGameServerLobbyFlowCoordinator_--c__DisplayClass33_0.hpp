...
namespace GlobalNamespace {
  // Size: 0x28
  #pragma pack(push, 1)
  // Autogenerated type: HostGameServerLobbyFlowCoordinator/<>c__DisplayClass33_0
  // [CompilerGeneratedAttribute] Offset: E124E8
  class HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0 : public ::Il2CppObject {
    public:
    ...
    $$c__DisplayClass33_0(::Il2CppString* userId_ = {}, GlobalNamespace::INetworkPlayer* playerToKick_ = {}, GlobalNamespace::HostGameServerLobbyFlowCoordinator* $$4__this_ = {}) noexcept : userId{userId_}, playerToKick{playerToKick_}, $$4__this{$$4__this_} {}
    ...
    static HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0*, creationType>()));
    }
  }; // HostGameServerLobbyFlowCoordinator/<>c__DisplayClass33_0
  #pragma pack(pop)
  static check_size<sizeof(HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0), 32 + sizeof(GlobalNamespace::HostGameServerLobbyFlowCoordinator*)> __GlobalNamespace_HostGameServerLobbyFlowCoordinator_$$c__DisplayClass33_0SizeCheck;
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0::*)()>(&GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0::*)()>(&GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::HostGameServerLobbyFlowCoordinator::$$c__DisplayClass33_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
