...
namespace GlobalNamespace {
  ...
  class BeatmapObjectSpawnMovementData : public ::Il2CppObject {
    ...
    // [HeaderAttribute] Offset: 0xD22D68
    ...
    // [HeaderAttribute] Offset: 0xD22DC4
    // [TooltipAttribute] Offset: 0xD22DC4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xD22E74
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xD22F00
