...
namespace GlobalNamespace {
  ...
  class BeatmapObjectSpawnMovementData : public ::Il2CppObject {
    ...
    // [HeaderAttribute] Offset: 0xD38700
    ...
    // [HeaderAttribute] Offset: 0xD3875C
    // [TooltipAttribute] Offset: 0xD3875C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xD3880C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xD38898
