...
namespace GlobalNamespace {
  ...
  class BeatmapObjectSpawnMovementData : public ::Il2CppObject {
    ...
    protected:
    #endif
    // [HeaderAttribute] Offset: 0xF041A4
    ...
    // [HeaderAttribute] Offset: 0xF04200
    // [TooltipAttribute] Offset: 0xF04200
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xF042B0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0xF0433C
