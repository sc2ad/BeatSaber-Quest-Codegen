...
namespace GlobalNamespace {
  ...
  check_size<sizeof(PlayerSaveDataV1_0_1), 40 + sizeof(GlobalNamespace::BeatmapDifficulty) + ((40 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8 != 0 ? (8 - (40 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8) : 0)> __GlobalNamespace_PlayerSaveDataV1_0_1SizeCheck;
}
