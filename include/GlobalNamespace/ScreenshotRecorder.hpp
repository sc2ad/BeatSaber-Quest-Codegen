...
namespace GlobalNamespace {
  ...
  class ScreenshotRecorder : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(ScreenshotRecorder::RecordingType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_ScreenshotRecorder_RecordingTypeSizeCheck;
  ...
  check_size<sizeof(ScreenshotRecorder), 112 + sizeof(void*) + ((112 + sizeof(void*)) % 8 != 0 ? (8 - (112 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_ScreenshotRecorderSizeCheck;
}
