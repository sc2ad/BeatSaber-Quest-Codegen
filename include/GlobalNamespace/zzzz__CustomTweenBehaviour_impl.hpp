...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::*)()>(&GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21b272c;
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c._OnBehaviourPlay_b__21_0
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::*)(int32_t)>(&GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::_OnBehaviourPlay_b__21_0)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21b2734;
 ...
 void GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::__set___9(GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c value)  {
::cordl_internals::setStaticField<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c>::get>(std::forward<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c>(value));
}
 GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::__get___9()  {
return ::cordl_internals::getStaticField<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c>::get>();
}
 void GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::__set___9__21_0(System::Func_2<int32_t,float_t> value)  {
::cordl_internals::setStaticField<System::Func_2<int32_t,float_t>, "<>9__21_0", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c>::get>(std::forward<System::Func_2<int32_t,float_t>>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 float_t GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c::_OnBehaviourPlay_b__21_0(int32_t i)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__CustomTweenBehaviour____c>::get(),
                            "<OnBehaviourPlay>b__21_0",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CustomTweenBehaviour::*)(UnityEngine::Playables::Playable)>(&GlobalNamespace::CustomTweenBehaviour::OnGraphStart)> {
  ...
  constexpr static std::size_t addrs = 0x21b1ea4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::CustomTweenBehaviour),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CustomTweenBehaviour::*)(UnityEngine::Playables::Playable, UnityEngine::Playables::FrameData, ::bs_hook::Il2CppWrapperType)>(&GlobalNamespace::CustomTweenBehaviour::ProcessFrame)> {
  constexpr static std::size_t size = 0x3e0;
  constexpr static std::size_t addrs = 0x21b1fe0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CustomTweenBehaviour::*)(UnityEngine::Playables::Playable)>(&GlobalNamespace::CustomTweenBehaviour::OnPlayableDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x21b23c0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::CustomTweenBehaviour::*)()>(&GlobalNamespace::CustomTweenBehaviour::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x21b26b0;
...
constexpr void GlobalNamespace::CustomTweenBehaviour::__set__transforms(::ArrayW<UnityEngine::Transform> value)  {
...
constexpr ::ArrayW<UnityEngine::Transform> GlobalNamespace::CustomTweenBehaviour::__get__transforms() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get_startLocationCurrentPosition() const {
...
constexpr UnityEngine::Vector3 GlobalNamespace::CustomTweenBehaviour::__get_startLocalPos() const {
...
constexpr UnityEngine::Vector3 GlobalNamespace::CustomTweenBehaviour::__get_endLocalPos() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::EaseType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::EaseType>(value));
}
constexpr GlobalNamespace::EaseType GlobalNamespace::CustomTweenBehaviour::__get_easeType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::EaseType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::CustomTweenBehaviour::__set_endXRelativeToSelfRotation(bool value)  {
::cordl_internals::setInstanceField<bool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get_endXRelativeToSelfRotation() const {
...
constexpr float_t GlobalNamespace::CustomTweenBehaviour::__get_elementDelay() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get__lockX() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get__lockY() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get__lockZ() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get__randomizeOrder() const {
...
constexpr float_t GlobalNamespace::CustomTweenBehaviour::__get__randomizedMinDurationMultiplier() const {
...
constexpr float_t GlobalNamespace::CustomTweenBehaviour::__get__duration() const {
...
constexpr float_t GlobalNamespace::CustomTweenBehaviour::__get__perItemDuration() const {
return ::cordl_internals::getInstanceField<float_t, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::CustomTweenBehaviour::__set__originalLocalPos(::ArrayW<UnityEngine::Vector3> value)  {
...
constexpr ::ArrayW<UnityEngine::Vector3> GlobalNamespace::CustomTweenBehaviour::__get__originalLocalPos() const {
...
constexpr bool GlobalNamespace::CustomTweenBehaviour::__get__initialized() const {
return ::cordl_internals::getInstanceField<bool, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::CustomTweenBehaviour::__set__randomizedOrder(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> GlobalNamespace::CustomTweenBehaviour::__get__randomizedOrder() const {
return ::cordl_internals::getInstanceField<::ArrayW<int32_t>, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::CustomTweenBehaviour::__set__randomizedDuration(::ArrayW<float_t> value)  {
...
constexpr ::ArrayW<float_t> GlobalNamespace::CustomTweenBehaviour::__get__randomizedDuration() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, playable);
 ...
 void GlobalNamespace::CustomTweenBehaviour::ProcessFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info, ::bs_hook::Il2CppWrapperType playerData)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::CustomTweenBehaviour>::get(),
                            "ProcessFrame",
                            std::vector<Il2CppClass*>{},
