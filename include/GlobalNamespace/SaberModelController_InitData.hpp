...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SaberModelController::InitData), 16 + sizeof(UnityEngine::Color) + ((16 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (16 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_SaberModelController_InitDataSizeCheck;
}
