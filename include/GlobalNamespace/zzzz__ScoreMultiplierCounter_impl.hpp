...
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType  ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::Positive{0};
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType  ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::Neutral{1};
constexpr ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType  ::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType::Negative{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::ScoreMultiplierCounter::*)(::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType)>(&::GlobalNamespace::ScoreMultiplierCounter::ProcessMultiplierEvent)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 bool ::GlobalNamespace::ScoreMultiplierCounter::ProcessMultiplierEvent(::GlobalNamespace::____GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType multiplierEventType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ScoreMultiplierCounter>::get(),
                            "ProcessMultiplierEvent",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 ::GlobalNamespace::ScoreMultiplierCounter::ScoreMultiplierCounter()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<ScoreMultiplierCounter>())) {}
