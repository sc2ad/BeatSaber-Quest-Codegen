...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapLevelSO::$GetBeatmapLevelDataAsync$d__68), 40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult>) + ((40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult>)) % 8 != 0 ? (8 - (40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::BeatmapLevelSO::GetBeatmapLevelDataResult>)) % 8) : 0)> __GlobalNamespace_BeatmapLevelSO_$GetBeatmapLevelDataAsync$d__68SizeCheck;
}
