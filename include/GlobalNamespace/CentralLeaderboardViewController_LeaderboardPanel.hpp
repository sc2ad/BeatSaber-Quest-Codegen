...
namespace GlobalNamespace {
  ...
  check_size<sizeof(CentralLeaderboardViewController::LeaderboardPanel), 32 + sizeof(bool) + ((32 + sizeof(bool)) % 8 != 0 ? (8 - (32 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_CentralLeaderboardViewController_LeaderboardPanelSizeCheck;
}
