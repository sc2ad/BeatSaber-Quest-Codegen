...
namespace GlobalNamespace {
  ...
  class NetEaseArcadeFlowCoordinator::$$c__DisplayClass27_0 : public ::Il2CppObject {
    ...
    GlobalNamespace::NetEaseArcadeFlowCoordinator* _get_$$4__this();
    // Set instance field: public NetEaseArcadeFlowCoordinator <>4__this
    void _set_$$4__this(GlobalNamespace::NetEaseArcadeFlowCoordinator* value);
