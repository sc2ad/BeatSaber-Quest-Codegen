...
namespace GlobalNamespace {
  ...
  class AsyncCachedLoader_2 : public ::Il2CppObject {
    ...
    struct $LoadAsync$d__7 : public System::Runtime::CompilerServices::IAsyncStateMachine, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::ValueType {
      public:
      using declaring_type = AsyncCachedLoader_2<TKey, TValue>*;
    ...
    struct $LoadAllAsync$d__8 : public System::Runtime::CompilerServices::IAsyncStateMachine, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::ValueType {
      public:
      using declaring_type = AsyncCachedLoader_2<TKey, TValue>*;
      // public System.Int32 <>1__state
      // Offset: 0x0
