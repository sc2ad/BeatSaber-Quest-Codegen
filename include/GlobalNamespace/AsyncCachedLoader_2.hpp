...
namespace GlobalNamespace {
  ...
  class AsyncCachedLoader_2 : public ::Il2CppObject {
    ...
    // Could not write size check! Type: AsyncCachedLoader`2/ScheduledTask is generic!
    ...
    // Could not write size check! Type: AsyncCachedLoader`2/<LoadAsync>d__7 is generic!
    ...
    // Could not write size check! Type: AsyncCachedLoader`2/<LoadAllAsync>d__8 is generic!
    ...
    static AsyncCachedLoader_2<TKey, TValue>* New_ctor(int maxNumberCachedElements, System::Func_3<TKey, System::Threading::CancellationToken, System::Threading::Tasks::Task_1<TValue>*>* resultValueFunc) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<AsyncCachedLoader_2<TKey, TValue>*>(maxNumberCachedElements, resultValueFunc)));
    }
    ...
    System::Threading::Tasks::Task_1<TValue>* LoadAsync(TKey keyId, System::Threading::CancellationToken cancellationToken) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<System::Threading::Tasks::Task_1<TValue>*>(), "LoadAsync", {}, ::il2cpp_utils::ExtractTypes(keyId, cancellationToken)));
    ...
    void LoadAllAsync() {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "LoadAllAsync", {}, ::il2cpp_utils::ExtractTypes()));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method);
    }
  }; // AsyncCachedLoader`2
  // Could not write size check! Type: AsyncCachedLoader`2 is generic!
}
