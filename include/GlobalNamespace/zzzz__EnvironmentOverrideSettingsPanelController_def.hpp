...
class CORDL_TYPE GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements(GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements(GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements& operator=(GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements&& o) noexcept = default;
  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements& operator=(GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__EnvironmentOverrideSettingsPanelController____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~GlobalNamespace__EnvironmentOverrideSettingsPanelController____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentOverrideSettingsPanelController____c", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c(GlobalNamespace__EnvironmentOverrideSettingsPanelController____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__EnvironmentOverrideSettingsPanelController____c", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c(GlobalNamespace__EnvironmentOverrideSettingsPanelController____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__EnvironmentOverrideSettingsPanelController____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c& operator=(GlobalNamespace__EnvironmentOverrideSettingsPanelController____c&& o) noexcept = default;
  constexpr GlobalNamespace__EnvironmentOverrideSettingsPanelController____c& operator=(GlobalNamespace__EnvironmentOverrideSettingsPanelController____c const& o) noexcept = default;
                


// Fields

static GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c value) ;

static GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c __get___9() ;
...
public:
// Declarations
using __c = GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c;

using Elements = GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements;
...
constexpr UnityEngine::GameObject __get__elementsGO() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements> __declspec(property(get=__get__elements, put=__set__elements))  _elements;

constexpr void __set__elements(::ArrayW<GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements> __get__elements() const;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController__Elements, "", "EnvironmentOverrideSettingsPanelController/Elements");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__EnvironmentOverrideSettingsPanelController____c, "", "EnvironmentOverrideSettingsPanelController/<>c");
