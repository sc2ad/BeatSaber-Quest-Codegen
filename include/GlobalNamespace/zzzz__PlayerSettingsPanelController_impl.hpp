...
constexpr ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout  ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::All{0};
constexpr ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout  ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::Singleplayer{1};
constexpr ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout  ::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout::Multiplayer{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::PlayerSettingsPanelController::*)(::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout)>(&::GlobalNamespace::PlayerSettingsPanelController::SetLayout)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "SetLayout",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, playerSpecificSettings);
 ...
 void ::GlobalNamespace::PlayerSettingsPanelController::SetLayout(::GlobalNamespace::____GlobalNamespace__PlayerSettingsPanelController__PlayerSettingsPanelLayout layout)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::PlayerSettingsPanelController>::get(),
                            "SetLayout",
                            std::vector<Il2CppClass*>{},
