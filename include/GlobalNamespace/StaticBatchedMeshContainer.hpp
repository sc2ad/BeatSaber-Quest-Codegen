...
namespace GlobalNamespace {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: StaticBatchedMeshContainer
  ...
  class StaticBatchedMeshContainer : public ::UnityEngine::MonoBehaviour {
    ...
    static StaticBatchedMeshContainer* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<StaticBatchedMeshContainer*, creationType>()));
    }
  }; // StaticBatchedMeshContainer
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::StaticBatchedMeshContainer::New_ctor
// Il2CppName: .ctor
