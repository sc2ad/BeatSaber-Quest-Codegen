...
constexpr void ::GlobalNamespace::BombCutSoundEffectManager::__set__bombCutSoundEffectPool(::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool ::GlobalNamespace::BombCutSoundEffectManager::__get__bombCutSoundEffectPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__BombCutSoundEffect__Pool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
