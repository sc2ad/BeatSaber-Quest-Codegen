...
constexpr void GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType  GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType::Undefined{0};
constexpr GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType  GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType::Menu{1};
constexpr GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType  GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType::Game{2};
...
constexpr void GlobalNamespace::VRRenderingParamsSetup::__set__sceneType(GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType GlobalNamespace::VRRenderingParamsSetup::__get__sceneType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__VRRenderingParamsSetup__SceneType, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
