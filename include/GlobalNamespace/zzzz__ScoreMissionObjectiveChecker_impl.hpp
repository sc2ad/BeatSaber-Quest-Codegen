...
// Ctor Parameters []
 ::GlobalNamespace::ScoreMissionObjectiveChecker::ScoreMissionObjectiveChecker()  : ::GlobalNamespace::SimpleValueMissionObjectiveChecker(THROW_UNLESS(::il2cpp_utils::New<ScoreMissionObjectiveChecker>())) {}
