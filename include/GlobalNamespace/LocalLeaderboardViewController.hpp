...
namespace GlobalNamespace {
  ...
  class LocalLeaderboardViewController : public ::GlobalNamespace::LeaderboardViewController {
    ...
    // [SpaceAttribute] Offset: 0x10F2F6C
    ...
    // [SpaceAttribute] Offset: 0x10F2FD4
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Sprite*) == 0x8);
    // [InjectAttribute] Offset: 0x10F302C
    ...
    static_assert(sizeof(bool) == 0x1);
    public:
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10F303C
