...
namespace GlobalNamespace {
  ...
  class LocalLeaderboardViewController : public ::GlobalNamespace::LeaderboardViewController {
    ...
    // [SpaceAttribute] Offset: 0x112CBF8
    ...
    // [SpaceAttribute] Offset: 0x112CC60
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Sprite*) == 0x8);
    // [InjectAttribute] Offset: 0x112CCB8
    ...
    static_assert(sizeof(bool) == 0x1);
    public:
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x112CCC8
