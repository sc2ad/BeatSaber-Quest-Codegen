...
namespace GlobalNamespace {
  ...
  class LocalLeaderboardViewController : public ::GlobalNamespace::LeaderboardViewController {
    ...
    // [SpaceAttribute] Offset: 0x112AE64
    ...
    // [SpaceAttribute] Offset: 0x112AECC
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Sprite*) == 0x8);
    // [InjectAttribute] Offset: 0x112AF24
    ...
    static_assert(sizeof(bool) == 0x1);
    public:
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x112AF34
