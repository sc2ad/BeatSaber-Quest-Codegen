...
namespace GlobalNamespace {
  ...
  check_size<sizeof(EnvironmentBrandingManager::InitData), 16 + sizeof(bool) + 8 - (16 + sizeof(bool)) % 8> __GlobalNamespace_EnvironmentBrandingManager_InitDataSizeCheck;
}
