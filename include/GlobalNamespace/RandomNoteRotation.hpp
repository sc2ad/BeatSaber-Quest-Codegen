...
namespace GlobalNamespace {
  ...
  class RandomNoteRotation : public UnityEngine::MonoBehaviour/*, public GlobalNamespace::INoteControllerDidInitEvent*/ {
    ...
    // Creating value type constructor for type: RandomNoteRotation
    RandomNoteRotation(GlobalNamespace::NoteControllerBase* noteController_ = {}, UnityEngine::Transform* transform_ = {}) noexcept : noteController{noteController_}, transform{transform_} {}
