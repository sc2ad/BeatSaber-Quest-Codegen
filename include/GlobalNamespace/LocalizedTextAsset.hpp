...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::LocalizedTextAsset::*)()>(&GlobalNamespace::LocalizedTextAsset::get_localizedText)> {
  static const MethodInfo* get() {
