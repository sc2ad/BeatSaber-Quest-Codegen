...
namespace GlobalNamespace {
  ...
  class AnnotatedBeatmapLevelCollectionsGridView : public UnityEngine::MonoBehaviour/*, public UnityEngine::EventSystems::IPointerEnterHandler, public UnityEngine::EventSystems::IPointerExitHandler, public GlobalNamespace::GridView::IDataSource*/ {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xF12140
    ...
    // [CompilerGeneratedAttribute] Offset: 0xF12150
    ...
    // Field size check
    static_assert(sizeof(System::Action*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xF12160
    ...
    // Creating value type constructor for type: AnnotatedBeatmapLevelCollectionsGridView
    AnnotatedBeatmapLevelCollectionsGridView(GlobalNamespace::GridView* gridView_ = {}, GlobalNamespace::PageControl* pageControl_ = {}, GlobalNamespace::AnnotatedBeatmapLevelCollectionsGridViewAnimator* animator_ = {}, GlobalNamespace::AnnotatedBeatmapLevelCollectionCell* cellPrefab_ = {}, float cellWidth_ = {}, float cellHeight_ = {}, ::Array<::Il2CppString*>* promoPackIDStrings_ = {}, GlobalNamespace::AdditionalContentModel* additionalContentModel_ = {}, GlobalNamespace::IVRPlatformHelper* vrPlatformHelper_ = {}, System::Action* didOpenAnnotatedBeatmapLevelCollectionEvent_ = {}, System::Action* didCloseAnnotatedBeatmapLevelCollectionEvent_ = {}, System::Action_1<GlobalNamespace::IAnnotatedBeatmapLevelCollection*>* didSelectAnnotatedBeatmapLevelCollectionEvent_ = {}, bool isInitialized_ = {}, bool isHovering_ = {}, System::Collections::Generic::HashSet_1<::Il2CppString*>* promoPackIDs_ = {}, System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IAnnotatedBeatmapLevelCollection*>* annotatedBeatmapLevelCollections_ = {}, int selectedCellIndex_ = {}) noexcept : gridView{gridView_}, pageControl{pageControl_}, animator{animator_}, cellPrefab{cellPrefab_}, cellWidth{cellWidth_}, cellHeight{cellHeight_}, promoPackIDStrings{promoPackIDStrings_}, additionalContentModel{additionalContentModel_}, vrPlatformHelper{vrPlatformHelper_}, didOpenAnnotatedBeatmapLevelCollectionEvent{didOpenAnnotatedBeatmapLevelCollectionEvent_}, didCloseAnnotatedBeatmapLevelCollectionEvent{didCloseAnnotatedBeatmapLevelCollectionEvent_}, didSelectAnnotatedBeatmapLevelCollectionEvent{didSelectAnnotatedBeatmapLevelCollectionEvent_}, isInitialized{isInitialized_}, isHovering{isHovering_}, promoPackIDs{promoPackIDs_}, annotatedBeatmapLevelCollections{annotatedBeatmapLevelCollections_}, selectedCellIndex{selectedCellIndex_} {}
    ...
    // private System.Void HandleCellSelectionDidChange(HMUI.SelectableCell selectableCell, HMUI.SelectableCell/TransitionType transition, System.Object changeOwner)
    // Offset: 0x1244398
