...
namespace GlobalNamespace {
  ...
  class AnnotatedBeatmapLevelCollectionsGridView : public ::UnityEngine::MonoBehaviour/*, public ::UnityEngine::EventSystems::IPointerEnterHandler, public ::UnityEngine::EventSystems::IPointerExitHandler, public ::GlobalNamespace::GridView::IDataSource*/ {
    ...
    // [SpaceAttribute] Offset: 0x112E5E4
    ...
    // [SpaceAttribute] Offset: 0x112E61C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [InjectAttribute] Offset: 0x112E674
    ...
    // [InjectAttribute] Offset: 0x112E684
    ...
    // [InjectAttribute] Offset: 0x112E694
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: isHovering and: annotatedBeatmapLevelCollections
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnnotatedBeatmapLevelCollectionsGridView), 128 + sizeof(int)> __GlobalNamespace_AnnotatedBeatmapLevelCollectionsGridViewSizeCheck;
  static_assert(sizeof(AnnotatedBeatmapLevelCollectionsGridView) == 0x84);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
