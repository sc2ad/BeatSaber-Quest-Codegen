...
constexpr void GlobalNamespace::BeatLine::__set__highlights(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__BeatLine__HighlightData> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__BeatLine__HighlightData>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__BeatLine__HighlightData>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__BeatLine__HighlightData> GlobalNamespace::BeatLine::__get__highlights() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__BeatLine__HighlightData>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__BeatLine__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__BeatLine__Pool::*)()>(&GlobalNamespace::GlobalNamespace__BeatLine__Pool::_ctor)> {
...
constexpr GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::GlobalNamespace__BeatLine__HighlightData(float_t startTime, float_t arriveDuration, float_t halfJumpDuration) noexcept : ::bs_hook::ValueTypeWrapper() {this->startTime = startTime;
this->arriveDuration = arriveDuration;
this->halfJumpDuration = halfJumpDuration;
}
constexpr void GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__set_startTime(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__get_startTime() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__set_arriveDuration(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__get_arriveDuration() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__set_halfJumpDuration(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x8>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__BeatLine__HighlightData::__get_halfJumpDuration() const {
