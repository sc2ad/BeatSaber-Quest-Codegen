...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::NoteCutInfoNetSerializable (::GlobalNamespace::NoteCutInfoNetSerializable::*)(float_t, bool, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, ::GlobalNamespace::ColorType, ::GlobalNamespace::NoteLineLayer, int32_t, float_t, float_t, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&::GlobalNamespace::NoteCutInfoNetSerializable::Init)> {
...
constexpr void ::GlobalNamespace::NoteCutInfoNetSerializable::__set_gameplayType(::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, 0x64>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType ::GlobalNamespace::NoteCutInfoNetSerializable::__get_gameplayType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, 0x64>(this->::bs_hook::Il2CppWrapperType::instance);
}
