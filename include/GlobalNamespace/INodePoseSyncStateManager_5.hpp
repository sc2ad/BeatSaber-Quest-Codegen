...
namespace GlobalNamespace {
  ...
  class INodePoseSyncStateManager_5 {
    ...
    float get_syncTime_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::get_syncTime_NEW");
    ...
    int get_connectedPlayerCount_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::get_connectedPlayerCount_NEW");
    ...
    GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>* get_localState_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::get_localState_NEW");
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncStateForPlayer_NEW(GlobalNamespace::IConnectedPlayer* player) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::GetSyncStateForPlayer_NEW");
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncState_NEW(int i) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::GetSyncState_NEW");
    ...
    void ClearBufferedStates_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::INodePoseSyncStateManager_5::ClearBufferedStates_NEW");
