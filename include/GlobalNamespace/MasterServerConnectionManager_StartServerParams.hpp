...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MasterServerConnectionManager::StartServerParams), 88 + sizeof(GlobalNamespace::GameplayServerConfiguration) + ((88 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8 != 0 ? (8 - (88 + sizeof(GlobalNamespace::GameplayServerConfiguration)) % 8) : 0)> __GlobalNamespace_MasterServerConnectionManager_StartServerParamsSizeCheck;
}
