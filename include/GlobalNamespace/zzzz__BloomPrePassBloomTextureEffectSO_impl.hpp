...
constexpr void ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__set__prefilterPass(::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__get__prefilterPass() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__set__downsamplePass(::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__get__downsamplePass() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__set__upsamplePass(::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__get__upsamplePass() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__set__finalUpsamplePass(::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x54>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass ::GlobalNamespace::BloomPrePassBloomTextureEffectSO::__get__finalUpsamplePass() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__PyramidBloomRendererSO__Pass, 0x54>(this->::bs_hook::Il2CppWrapperType::instance);
}
