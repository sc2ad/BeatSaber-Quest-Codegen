...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x21d3e10;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x21d3ed4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::StartLevel)> {
  ...
  constexpr static std::size_t addrs = 0x21d3ef0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)(::GlobalNamespace::ScenesTransitionSetupDataSO, ::Zenject::DiContainer)>(&::GlobalNamespace::SimpleLevelStarter::InstallEarlyBindings)> {
  ...
  constexpr static std::size_t addrs = 0x21d41a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::ButtonPressed)> {
  ...
  constexpr static std::size_t addrs = 0x21d42cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ::GlobalNamespace::LevelCompletionResults)>(&::GlobalNamespace::SimpleLevelStarter::HandleLevelDidFinish)> {
  ...
  constexpr static std::size_t addrs = 0x21d42d0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x21d42f8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)(::Zenject::DiContainer)>(&::GlobalNamespace::SimpleLevelStarter::_StartLevel_g__AfterSceneSwitchCallback_15_0)> {
  constexpr static std::size_t size = 0x13c;
  constexpr static std::size_t addrs = 0x21d43d0;
...
constexpr ::GlobalNamespace::BeatmapLevelSO ::GlobalNamespace::SimpleLevelStarter::__get__level() const {
...
constexpr ::GlobalNamespace::BeatmapCharacteristicSO ::GlobalNamespace::SimpleLevelStarter::__get__beatmapCharacteristic() const {
...
constexpr ::GlobalNamespace::BeatmapDifficulty ::GlobalNamespace::SimpleLevelStarter::__get__beatmapDifficulty() const {
...
constexpr bool ::GlobalNamespace::SimpleLevelStarter::__get__useTestNoteCutSoundEffects() const {
...
constexpr bool ::GlobalNamespace::SimpleLevelStarter::__get__overrideStrobeFilterSettingsToAllEffects() const {
...
::cordl_internals::setInstanceField<::UnityEngine::TextAsset, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::TextAsset>(value));
}
constexpr ::UnityEngine::TextAsset ::GlobalNamespace::SimpleLevelStarter::__get__recordingTextAsset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::SimpleLevelStarter::__set__prefabBindings(::ArrayW<::UnityEngine::Component> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::Component>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::Component>>(value));
}
constexpr ::ArrayW<::UnityEngine::Component> ::GlobalNamespace::SimpleLevelStarter::__get__prefabBindings() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Component>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::UnityEngine::UI::Button ::GlobalNamespace::SimpleLevelStarter::__get__button() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::MenuTransitionsHelper, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::MenuTransitionsHelper>(value));
}
constexpr ::GlobalNamespace::MenuTransitionsHelper ::GlobalNamespace::SimpleLevelStarter::__get__menuTransitionsHelper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MenuTransitionsHelper, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::GlobalNamespace::GameScenesManager ::GlobalNamespace::SimpleLevelStarter::__get__gameScenesManager() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::PlayerDataModel, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::PlayerDataModel>(value));
}
constexpr ::GlobalNamespace::PlayerDataModel ::GlobalNamespace::SimpleLevelStarter::__get__playerDataModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlayerDataModel, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::HMUI::ButtonBinder ::GlobalNamespace::SimpleLevelStarter::__get__buttonBinder() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifiers, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::GameplayModifiers>(value));
}
constexpr ::GlobalNamespace::GameplayModifiers ::GlobalNamespace::SimpleLevelStarter::__get__gameplayModifiers() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiers, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, standardLevelSceneSetupData, levelCompletionResults);
}
// Ctor Parameters []
 ::GlobalNamespace::SimpleLevelStarter::SimpleLevelStarter()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<SimpleLevelStarter>())) {}
 void ::GlobalNamespace::SimpleLevelStarter::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SimpleLevelStarter>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::SimpleLevelStarter::_StartLevel_g__AfterSceneSwitchCallback_15_0(::Zenject::DiContainer container)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SimpleLevelStarter>::get(),
                            "<StartLevel>g__AfterSceneSwitchCallback|15_0",
                            std::vector<Il2CppClass*>{},
