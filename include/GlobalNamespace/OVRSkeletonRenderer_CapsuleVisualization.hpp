...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRSkeletonRenderer::CapsuleVisualization), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __GlobalNamespace_OVRSkeletonRenderer_CapsuleVisualizationSizeCheck;
}
