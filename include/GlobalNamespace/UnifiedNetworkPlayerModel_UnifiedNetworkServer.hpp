...
namespace GlobalNamespace {
  ...
  check_size<sizeof(UnifiedNetworkPlayerModel::UnifiedNetworkServer), 72 + sizeof(float) + 8 - (72 + sizeof(float)) % 8> __GlobalNamespace_UnifiedNetworkPlayerModel_UnifiedNetworkServerSizeCheck;
}
