...
namespace GlobalNamespace {
  ...
  check_size<sizeof(UserLoginDtoDataSource::$GetPlatformUserIdAsync$d__2), 40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::UserInfo*>) + ((40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::UserInfo*>)) % 8 != 0 ? (8 - (40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::UserInfo*>)) % 8) : 0)> __GlobalNamespace_UserLoginDtoDataSource_$GetPlatformUserIdAsync$d__2SizeCheck;
}
