...
// Ctor Parameters [CppParam { name: "globalPropertyName", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "materialPropertyNameCouples", ty: "::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple>", modifiers: "", def_value: Some("csnull") }]
constexpr ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple(::StringW globalPropertyName, ::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple> materialPropertyNameCouples) noexcept : ::bs_hook::ValueTypeWrapper() {this->globalPropertyName = globalPropertyName;
this->materialPropertyNameCouples = materialPropertyNameCouples;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple::__set_globalPropertyName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x0>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple::__get_globalPropertyName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple::__set_materialPropertyNameCouples(::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple>, 0x8>(this->__instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple> ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple::__get_materialPropertyNameCouples() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple>, 0x8>(this->__instance);
}
...
constexpr ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple(::StringW texturePropertyName, ::UnityEngine::Material material) noexcept : ::bs_hook::ValueTypeWrapper() {this->texturePropertyName = texturePropertyName;
this->material = material;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple::__set_texturePropertyName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x0>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple::__get_texturePropertyName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple::__set_material(::UnityEngine::Material value)  {
::cordl_internals::setInstanceField<::UnityEngine::Material, 0x8>(this->__instance, std::forward<::UnityEngine::Material>(value));
}
constexpr ::UnityEngine::Material ::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialPropertyNameCouple::__get_material() const {
...
constexpr void ::GlobalNamespace::Noise3DTexturesGenerator::__set__data(::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple> ::GlobalNamespace::Noise3DTexturesGenerator::__get__data() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__Noise3DTexturesGenerator__MaterialTextureParamsCouple>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
