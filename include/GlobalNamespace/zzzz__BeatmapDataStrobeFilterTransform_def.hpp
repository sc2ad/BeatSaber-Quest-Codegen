...
namespace GlobalNamespace {
class ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData;
}
...
class CORDL_TYPE ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData(____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData(____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData& operator=(____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData&& o) noexcept = default;
  constexpr ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData& operator=(____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData() ;
...
public:
// Declarations
using StrobeStreakData = ::GlobalNamespace::____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BeatmapDataStrobeFilterTransform__StrobeStreakData, "", "BeatmapDataStrobeFilterTransform/StrobeStreakData");
