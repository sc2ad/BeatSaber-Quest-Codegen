...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::SaberType (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_saberType)> {
  ...
  constexpr static std::size_t addrs = 0x210b538;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_saberBladeTopPos)> {
  ...
  constexpr static std::size_t addrs = 0x210b554;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_saberBladeBottomPos)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x210b560;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Vector3 (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_handlePos)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x210b56c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Quaternion (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_handleRot)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x210b578;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_bladeSpeed)> {
  constexpr static std::size_t size = 0x1c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::SaberMovementData (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::get_movementData)> {
  ...
  constexpr static std::size_t addrs = 0x210b5a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::ManualUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x210b5a8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::Saber::*)(UnityEngine::Vector3, UnityEngine::Quaternion)>(&GlobalNamespace::Saber::OverridePositionAndRotation)> {
  ...
  constexpr static std::size_t addrs = 0x210b6dc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::Saber::*)()>(&GlobalNamespace::Saber::_ctor)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x210b754;
...
constexpr UnityEngine::Transform GlobalNamespace::Saber::__get__saberBladeTopTransform() const {
...
constexpr UnityEngine::Transform GlobalNamespace::Saber::__get__saberBladeBottomTransform() const {
...
constexpr UnityEngine::Transform GlobalNamespace::Saber::__get__handleTransform() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::SaberTypeObject, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::SaberTypeObject>(value));
}
constexpr GlobalNamespace::SaberTypeObject GlobalNamespace::Saber::__get__saberType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::SaberTypeObject, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::Saber::__set__movementData(GlobalNamespace::SaberMovementData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::SaberMovementData, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::SaberMovementData>(value));
}
constexpr GlobalNamespace::SaberMovementData GlobalNamespace::Saber::__get__movementData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::SaberMovementData, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr UnityEngine::Vector3 GlobalNamespace::Saber::__get__saberBladeTopPos() const {
...
constexpr UnityEngine::Vector3 GlobalNamespace::Saber::__get__saberBladeBottomPos() const {
...
constexpr UnityEngine::Vector3 GlobalNamespace::Saber::__get__handlePos() const {
...
constexpr UnityEngine::Quaternion GlobalNamespace::Saber::__get__handleRot() const {
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Quaternion, false>(const_cast<void*>(instance), ___internal_method);
 ...
 float_t GlobalNamespace::Saber::get_bladeSpeed()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::Saber>::get(),
                            "get_bladeSpeed",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::SaberMovementData, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 GlobalNamespace::Saber::Saber()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<Saber>())) {}
 void GlobalNamespace::Saber::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::Saber>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
