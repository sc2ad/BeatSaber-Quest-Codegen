...
namespace GlobalNamespace {
  ...
  class DynamicBoneColliderBase : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(DynamicBoneColliderBase::Direction), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_DynamicBoneColliderBase_DirectionSizeCheck;
    ...
    check_size<sizeof(DynamicBoneColliderBase::Bound), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_DynamicBoneColliderBase_BoundSizeCheck;
  ...
  check_size<sizeof(DynamicBoneColliderBase), 40 + sizeof(GlobalNamespace::DynamicBoneColliderBase::Bound) + 8 - (40 + sizeof(GlobalNamespace::DynamicBoneColliderBase::Bound)) % 8> __GlobalNamespace_DynamicBoneColliderBaseSizeCheck;
}
