...
namespace GlobalNamespace {
  // Size: 0x80
  #pragma pack(push, 1)
  // Autogenerated type: RecordingToolLoggingViewController
  // [TokenAttribute] Offset: FFFFFFFF
  class RecordingToolLoggingViewController : public ::HMUI::ViewController {
    public:
    public:
    ...
    // [InjectOptionalAttribute] Offset: 0x1124254
  ...
  #pragma pack(pop)
  static check_size<sizeof(RecordingToolLoggingViewController), 120 + sizeof(::GlobalNamespace::RecordingToolManager*)> __GlobalNamespace_RecordingToolLoggingViewControllerSizeCheck;
  static_assert(sizeof(RecordingToolLoggingViewController) == 0x80);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::RecordingToolLoggingViewController::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: GlobalNamespace::RecordingToolLoggingViewController::DidActivate
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::RecordingToolLoggingViewController::*)(bool, bool, bool)>(&GlobalNamespace::RecordingToolLoggingViewController::DidActivate)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::RecordingToolLoggingViewController*), "DidActivate", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{firstActivation, addedToHierarchy, screenSystemEnabling});
  }
};
