...
namespace GlobalNamespace {
struct ____GlobalNamespace__VertexPath__Vertex;
}
// Type: ::Vertex
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ____GlobalNamespace__VertexPath__Vertex : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__VertexPath__Vertex(::UnityEngine::Vector3 position, ::UnityEngine::Vector3 tangent, ::UnityEngine::Vector3 normal) noexcept;


                    constexpr ____GlobalNamespace__VertexPath__Vertex(____GlobalNamespace__VertexPath__Vertex const&) = default;
                    constexpr ____GlobalNamespace__VertexPath__Vertex(____GlobalNamespace__VertexPath__Vertex&&) = default;
                    constexpr ____GlobalNamespace__VertexPath__Vertex& operator=(____GlobalNamespace__VertexPath__Vertex const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__VertexPath__Vertex& operator=(____GlobalNamespace__VertexPath__Vertex&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__VertexPath__Vertex(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using Vertex = ::GlobalNamespace::____GlobalNamespace__VertexPath__Vertex;
...
constexpr int32_t __get_vertexCount() const;
 ...
 ::ArrayW<::GlobalNamespace::____GlobalNamespace__VertexPath__Vertex> __declspec(property(get=__get__localVertices, put=__set__localVertices))  _localVertices;

constexpr void __set__localVertices(::ArrayW<::GlobalNamespace::____GlobalNamespace__VertexPath__Vertex> value) ;

constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__VertexPath__Vertex> __get__localVertices() const;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__VertexPath__Vertex, "", "VertexPath/Vertex");
