...
namespace GlobalNamespace {
  ...
  check_size<sizeof(VRControllersInputManager), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_VRControllersInputManagerSizeCheck;
}
