...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BTSCharacterResultAnimationController), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __GlobalNamespace_BTSCharacterResultAnimationControllerSizeCheck;
}
