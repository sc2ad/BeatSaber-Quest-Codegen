...
namespace GlobalNamespace {
  ...
  class FlyingScoreEffect : public ::GlobalNamespace::FlyingObjectEffect/*, public ::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver, public ::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*/ {
    ...
    // Offset: 0x2AC62DC
    ::StringW GetScoreText(int score);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::FlyingScoreEffect::*)(int)>(&GlobalNamespace::FlyingScoreEffect::GetScoreText)> {
  static const MethodInfo* get() {
