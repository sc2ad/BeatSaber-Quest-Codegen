...
namespace GlobalNamespace {
struct ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51;
}
...
struct CORDL_TYPE ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::MultiplayerModeSelectionFlowCoordinator __4__this, ::GlobalNamespace::MultiplayerStatusData _multiplayerStatusData_5__2, ::System::Exception _exception_5__3, ::System::Runtime::CompilerServices::TaskAwaiter_1<bool> __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::MultiplayerStatusData> __u__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::QuickPlaySetupData> __u__3) noexcept;


                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51 const&) = default;
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51&&) = default;
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51& operator=(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51& operator=(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::MultiplayerModeSelectionFlowCoordinator __4__this, ::System::Runtime::CompilerServices::TaskAwaiter __u__1) noexcept;


                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52 const&) = default;
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52&&) = default;
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52& operator=(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52& operator=(____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _ResolveAndPresentNextFlowCoordinator_d__52 = ::GlobalNamespace::____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52;

using _TryShowModeSelection_d__51 = ::GlobalNamespace::____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51;
...
/// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionFailed addr 0x213faac size 0xc4 virtual false final false
 void HandleMultiplayerLobbyConnectionControllerConnectionFailed(::GlobalNamespace::____GlobalNamespace__MultiplayerLobbyConnectionController__LobbyConnectionType connectionType, ::GlobalNamespace::ConnectionFailedReason reason) ;

/// @brief Method HandleMultiplayerLobbyControllerDidFinish addr 0x213fb70 size 0x5e0 virtual false final false
 void HandleMultiplayerLobbyControllerDidFinish(::GlobalNamespace::MultiplayerModeSelectionViewController viewController, ::GlobalNamespace::____GlobalNamespace__MultiplayerModeSelectionViewController__MenuButton menuButton) ;
...
/// @brief Method PresentConnectionErrorDialog addr 0x213f564 size 0x528 virtual false final false
 void PresentConnectionErrorDialog(::GlobalNamespace::____GlobalNamespace__MultiplayerLobbyConnectionController__LobbyConnectionType connectionType, ::GlobalNamespace::ConnectionFailedReason reason) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___ResolveAndPresentNextFlowCoordinator_d__52, "", "MultiplayerModeSelectionFlowCoordinator/<ResolveAndPresentNextFlowCoordinator>d__52");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__MultiplayerModeSelectionFlowCoordinator___TryShowModeSelection_d__51, "", "MultiplayerModeSelectionFlowCoordinator/<TryShowModeSelection>d__51");
