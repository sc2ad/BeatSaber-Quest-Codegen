...
struct CORDL_TYPE GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType(int32_t value__) noexcept;


                    constexpr GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType(GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType const&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType(GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType&&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType& operator=(GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType& operator=(GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType&& o) noexcept {
...
constexpr explicit GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType_Unwrapped : int32_t {
__Reconstructed = 0,
__UserDefined = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator __GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType_Unwrapped () const noexcept {
...
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType const Reconstructed;

/// @brief Field UserDefined offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType const UserDefined;
...
struct CORDL_TYPE GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType(int32_t value__) noexcept;


                    constexpr GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType(GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType(GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType&&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType& operator=(GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType& operator=(GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType_Unwrapped : int32_t {
__None = 0,
...
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const None;

/// @brief Field GrayscaleToColor offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const GrayscaleToColor;

/// @brief Field Controls offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const Controls;

/// @brief Field Custom offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const Custom;

/// @brief Field Grayscale offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const Grayscale;

/// @brief Field ColorAdjustment offset 0
static GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType const ColorAdjustment;
...
struct CORDL_TYPE GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance(uint64_t meshHandle, uint64_t instanceHandle, bool updateTransform, UnityEngine::Matrix4x4 localToWorld) noexcept;


                    constexpr GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance(GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance const&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance(GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance&&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance& operator=(GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance& operator=(GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry(UnityEngine::MeshFilter meshFilter, bool updateTransform) noexcept;


                    constexpr GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry(GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry const&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry(GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry&&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry& operator=(GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry& operator=(GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition(UnityEngine::GameObject gameObject, bool updateTransform) noexcept;


                    constexpr GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition(GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition const&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition(GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition&&) = default;
                    constexpr GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition& operator=(GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition& operator=(GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0& operator=(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0&& o) noexcept = default;
  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0& operator=(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0 const& o) noexcept = default;
...
/// @brief Method <RemoveSurfaceGeometry>b__0 addr 0x25dbc88 size 0x6c virtual false final false
 bool _RemoveSurfaceGeometry_b__0(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition x) ;
...
class CORDL_TYPE GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0& operator=(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0&& o) noexcept = default;
  constexpr GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0& operator=(GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0 const& o) noexcept = default;
...
/// @brief Method <IsSurfaceGeometry>b__0 addr 0x25dbcf4 size 0x6c virtual false final false
 bool _IsSurfaceGeometry_b__0(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition x) ;
...
public:
// Declarations
using __c__DisplayClass10_0 = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0;

using __c__DisplayClass9_0 = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0;

using DeferredPassthroughMeshAddition = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition;

using SerializedSurfaceGeometry = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry;

using PassthroughMeshInstance = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance;

using ColorMapEditorType = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType;

using ProjectionSurfaceType = GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType;
...
// Fields
 ...
 GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType __declspec(property(get=__get_projectionSurfaceType, put=__set_projectionSurfaceType))  projectionSurfaceType;

constexpr void __set_projectionSurfaceType(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType value) ;

constexpr GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType __get_projectionSurfaceType() const;

 GlobalNamespace::GlobalNamespace__OVROverlay__OverlayType __declspec(property(get=__get_overlayType, put=__set_overlayType))  overlayType;

constexpr void __set_overlayType(GlobalNamespace::GlobalNamespace__OVROverlay__OverlayType value) ;

constexpr GlobalNamespace::GlobalNamespace__OVROverlay__OverlayType __get_overlayType() const;
...
constexpr UnityEngine::Vector4 __get_colorOffset() const;
 ...
 GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType __declspec(property(get=__get_colorMapEditorType_, put=__set_colorMapEditorType_))  colorMapEditorType_;

constexpr void __set_colorMapEditorType_(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType value) ;

constexpr GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType __get_colorMapEditorType_() const;
...
constexpr GlobalNamespace::OVROverlay __get_passthroughOverlay() const;
 ...
 System::Collections::Generic::Dictionary_2<UnityEngine::GameObject,GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance> __declspec(property(get=__get_surfaceGameObjects, put=__set_surfaceGameObjects))  surfaceGameObjects;

constexpr void __set_surfaceGameObjects(System::Collections::Generic::Dictionary_2<UnityEngine::GameObject,GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance> value) ;

constexpr System::Collections::Generic::Dictionary_2<UnityEngine::GameObject,GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance> __get_surfaceGameObjects() const;

 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition> __declspec(property(get=__get_deferredSurfaceGameObjects, put=__set_deferredSurfaceGameObjects))  deferredSurfaceGameObjects;

constexpr void __set_deferredSurfaceGameObjects(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition> value) ;

constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition> __get_deferredSurfaceGameObjects() const;

 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry> __declspec(property(get=__get_serializedSurfaceGeometry, put=__set_serializedSurfaceGeometry))  serializedSurfaceGeometry;

constexpr void __set_serializedSurfaceGeometry(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry> value) ;

constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry> __get_serializedSurfaceGeometry() const;
...
constexpr UnityEngine::Color __get_edgeColor_() const;
 ...
 GlobalNamespace::GlobalNamespace__OVRPlugin__InsightPassthroughColorMapType __declspec(property(get=__get_colorMapType, put=__set_colorMapType))  colorMapType;

constexpr void __set_colorMapType(GlobalNamespace::GlobalNamespace__OVRPlugin__InsightPassthroughColorMapType value) ;

constexpr GlobalNamespace::GlobalNamespace__OVRPlugin__InsightPassthroughColorMapType __get_colorMapType() const;
...
// Properties
 ...
 GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType __declspec(property(get=get_colorMapEditorType, put=set_colorMapEditorType))  colorMapEditorType;

 GlobalNamespace::GlobalNamespace__OVROverlay__OverlayShape __declspec(property(get=get_overlayShape))  overlayShape;
...
/// @brief Method SetColorMapControls addr 0x25d9264 size 0x194 virtual false final false
 void SetColorMapControls(float_t contrast, float_t brightness, float_t posterize, UnityEngine::Gradient gradient, GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType colorMapType) ;
...
/// @brief Method get_colorMapEditorType addr 0x25d9970 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType get_colorMapEditorType() ;

/// @brief Method set_colorMapEditorType addr 0x25d8f68 size 0x84 virtual false final false
 void set_colorMapEditorType(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType value) ;
...
/// @brief Method get_overlayShape addr 0x25db2a4 size 0x14 virtual false final false
 GlobalNamespace::GlobalNamespace__OVROverlay__OverlayShape get_overlayShape() ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ColorMapEditorType, "", "OVRPassthroughLayer/ColorMapEditorType");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__ProjectionSurfaceType, "", "OVRPassthroughLayer/ProjectionSurfaceType");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass10_0, "", "OVRPassthroughLayer/<>c__DisplayClass10_0");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer____c__DisplayClass9_0, "", "OVRPassthroughLayer/<>c__DisplayClass9_0");
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__DeferredPassthroughMeshAddition, "", "OVRPassthroughLayer/DeferredPassthroughMeshAddition");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__PassthroughMeshInstance, "", "OVRPassthroughLayer/PassthroughMeshInstance");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRPassthroughLayer__SerializedSurfaceGeometry, "", "OVRPassthroughLayer/SerializedSurfaceGeometry");
