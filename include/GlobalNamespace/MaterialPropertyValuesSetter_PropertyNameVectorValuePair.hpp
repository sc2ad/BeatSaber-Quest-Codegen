...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MaterialPropertyValuesSetter::PropertyNameVectorValuePair), 28 + sizeof(UnityEngine::Vector4) + ((28 + sizeof(UnityEngine::Vector4)) % 8 != 0 ? (8 - (28 + sizeof(UnityEngine::Vector4)) % 8) : 0)> __GlobalNamespace_MaterialPropertyValuesSetter_PropertyNameVectorValuePairSizeCheck;
}
