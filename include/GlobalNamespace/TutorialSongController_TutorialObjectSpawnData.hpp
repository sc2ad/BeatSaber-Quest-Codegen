...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TutorialSongController::TutorialObjectSpawnData), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __GlobalNamespace_TutorialSongController_TutorialObjectSpawnDataSizeCheck;
}
