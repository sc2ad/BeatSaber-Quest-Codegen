...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::____GlobalNamespace__OVRDisplay__EyeFov(float_t UpFov, float_t DownFov, float_t LeftFov, float_t RightFov) noexcept : ::bs_hook::ValueTypeWrapper() {this->UpFov = UpFov;
this->DownFov = DownFov;
this->LeftFov = LeftFov;
this->RightFov = RightFov;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__set_UpFov(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__get_UpFov() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__set_DownFov(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__get_DownFov() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__set_LeftFov(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x8>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__get_LeftFov() const {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__set_RightFov(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0xc>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov::__get_RightFov() const {
return ::cordl_internals::getInstanceField<float_t, 0xc>(this->__instance);
}
// Ctor Parameters [CppParam { name: "resolution", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}") }, CppParam { name: "fov", ty: "::UnityEngine::Vector2", modifiers: "", def_value: Some("{}") }, CppParam { name: "fullFov", ty: "::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::____GlobalNamespace__OVRDisplay__EyeRenderDesc(::UnityEngine::Vector2 resolution, ::UnityEngine::Vector2 fov, ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov fullFov) noexcept : ::bs_hook::ValueTypeWrapper() {this->resolution = resolution;
this->fov = fov;
this->fullFov = fullFov;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__set_resolution(::UnityEngine::Vector2 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x0>(this->__instance, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2 ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__get_resolution() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__set_fov(::UnityEngine::Vector2 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x8>(this->__instance, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2 ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__get_fov() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x8>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__set_fullFov(::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov, 0x10>(this->__instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc::__get_fullFov() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeFov, 0x10>(this->__instance);
}
...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::____GlobalNamespace__OVRDisplay__LatencyData(float_t render, float_t timeWarp, float_t postPresent, float_t renderError, float_t timeWarpError) noexcept : ::bs_hook::ValueTypeWrapper() {this->render = render;
this->timeWarp = timeWarp;
this->postPresent = postPresent;
this->renderError = renderError;
this->timeWarpError = timeWarpError;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__set_render(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x0>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__get_render() const {
return ::cordl_internals::getInstanceField<float_t, 0x0>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__set_timeWarp(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__get_timeWarp() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__set_postPresent(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x8>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__get_postPresent() const {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__set_renderError(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0xc>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__get_renderError() const {
return ::cordl_internals::getInstanceField<float_t, 0xc>(this->__instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__set_timeWarpError(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x10>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData::__get_timeWarpError() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc (::GlobalNamespace::OVRDisplay::*)(::UnityEngine::XR::XRNode)>(&::GlobalNamespace::OVRDisplay::GetEyeRenderDesc)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData (::GlobalNamespace::OVRDisplay::*)()>(&::GlobalNamespace::OVRDisplay::get_latency)> {
...
constexpr void ::GlobalNamespace::OVRDisplay::__set_eyeDescs(::ArrayW<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc> ::GlobalNamespace::OVRDisplay::__get_eyeDescs() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::UnityEngine::Vector3, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc ::GlobalNamespace::OVRDisplay::GetEyeRenderDesc(::UnityEngine::XR::XRNode eye)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRDisplay>::get(),
                            "GetEyeRenderDesc",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__OVRDisplay__EyeRenderDesc, false>(const_cast<void*>(instance), ___internal_method, eye);
}
 ::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData ::GlobalNamespace::OVRDisplay::get_latency()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRDisplay>::get(),
                            "get_latency",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::____GlobalNamespace__OVRDisplay__LatencyData, false>(const_cast<void*>(instance), ___internal_method);
}
