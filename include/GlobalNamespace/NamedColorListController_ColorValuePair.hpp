...
namespace GlobalNamespace {
  ...
  check_size<sizeof(NamedColorListController::ColorValuePair), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __GlobalNamespace_NamedColorListController_ColorValuePairSizeCheck;
}
