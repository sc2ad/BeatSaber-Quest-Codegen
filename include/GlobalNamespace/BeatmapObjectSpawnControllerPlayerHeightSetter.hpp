...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatmapObjectSpawnControllerPlayerHeightSetter), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_BeatmapObjectSpawnControllerPlayerHeightSetterSizeCheck;
}
