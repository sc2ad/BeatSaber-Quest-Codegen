...
class CORDL_TYPE GlobalNamespace__BTSStarTextEventEffect__StarTextSprite : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~GlobalNamespace__BTSStarTextEventEffect__StarTextSprite() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BTSStarTextEventEffect__StarTextSprite", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite(GlobalNamespace__BTSStarTextEventEffect__StarTextSprite const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BTSStarTextEventEffect__StarTextSprite", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite(GlobalNamespace__BTSStarTextEventEffect__StarTextSprite&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BTSStarTextEventEffect__StarTextSprite(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite& operator=(GlobalNamespace__BTSStarTextEventEffect__StarTextSprite&& o) noexcept = default;
  constexpr GlobalNamespace__BTSStarTextEventEffect__StarTextSprite& operator=(GlobalNamespace__BTSStarTextEventEffect__StarTextSprite const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__BTSStarTextEventEffect__StartTextPosition : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__BTSStarTextEventEffect__StartTextPosition() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BTSStarTextEventEffect__StartTextPosition", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition(GlobalNamespace__BTSStarTextEventEffect__StartTextPosition const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BTSStarTextEventEffect__StartTextPosition", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition(GlobalNamespace__BTSStarTextEventEffect__StartTextPosition&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BTSStarTextEventEffect__StartTextPosition(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition& operator=(GlobalNamespace__BTSStarTextEventEffect__StartTextPosition&& o) noexcept = default;
  constexpr GlobalNamespace__BTSStarTextEventEffect__StartTextPosition& operator=(GlobalNamespace__BTSStarTextEventEffect__StartTextPosition const& o) noexcept = default;
...
public:
// Declarations
using StartTextPosition = GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition;

using StarTextSprite = GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite;
...
// Fields
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> __declspec(property(get=__get__starTextSprites, put=__set__starTextSprites))  _starTextSprites;

constexpr void __set__starTextSprites(::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> __get__starTextSprites() const;

 ::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition> __declspec(property(get=__get__startTextPositions, put=__set__startTextPositions))  _startTextPositions;

constexpr void __set__startTextPositions(::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition> __get__startTextPositions() const;
...
constexpr GlobalNamespace::BeatmapDataCallbackWrapper __get__beatmapDataCallbackWrapper() const;
 ...
 System::Collections::Generic::Dictionary_2<int32_t,GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> __declspec(property(get=__get__idsToStarTextSpriteDictionary, put=__set__idsToStarTextSpriteDictionary))  _idsToStarTextSpriteDictionary;

constexpr void __set__idsToStarTextSpriteDictionary(System::Collections::Generic::Dictionary_2<int32_t,GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> value) ;

constexpr System::Collections::Generic::Dictionary_2<int32_t,GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite> __get__idsToStarTextSpriteDictionary() const;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StarTextSprite, "", "BTSStarTextEventEffect/StarTextSprite");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BTSStarTextEventEffect__StartTextPosition, "", "BTSStarTextEventEffect/StartTextPosition");
