...
namespace GlobalNamespace {
  ...
  struct OculusBeatmapDataAssetFileModel::$ReloadAssetDetailsForAllLevelsAsync$d__15 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
