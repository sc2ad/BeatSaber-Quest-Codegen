...
namespace GlobalNamespace {
  ...
  class PlatformAchievementsModelSO::UnlockAchievementCompletionHandler : public System::MulticastDelegate {
    ...
    // Offset: 0xF5D768
    void Invoke_NEW(GlobalNamespace::PlatformAchievementsModelSO::UnlockAchievementResult result);
    ...
    // Offset: 0xF5DD9C
    System::IAsyncResult* BeginInvoke_NEW(GlobalNamespace::PlatformAchievementsModelSO::UnlockAchievementResult result, System::AsyncCallback* callback, ::Il2CppObject* object);
