...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__NoteData__GameplayType (GlobalNamespace::TutorialNoteController::*)()>(&GlobalNamespace::TutorialNoteController::get_gameplayType)> {
  constexpr static std::size_t size = 0x8;
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::NoteVisualModifierType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::TutorialNoteController::get_gameplayType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TutorialNoteController>::get(),
                            "get_gameplayType",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__TutorialNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__TutorialNoteController__Pool::*)()>(&GlobalNamespace::GlobalNamespace__TutorialNoteController__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
