...
namespace GlobalNamespace {
struct ____GlobalNamespace__NoteMovement__MovementPhase;
}
namespace GlobalNamespace {
class NoteMovement;
}
...
struct CORDL_TYPE ____GlobalNamespace__NoteMovement__MovementPhase : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__NoteMovement__MovementPhase(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__NoteMovement__MovementPhase(____GlobalNamespace__NoteMovement__MovementPhase const&) = default;
                    constexpr ____GlobalNamespace__NoteMovement__MovementPhase(____GlobalNamespace__NoteMovement__MovementPhase&&) = default;
                    constexpr ____GlobalNamespace__NoteMovement__MovementPhase& operator=(____GlobalNamespace__NoteMovement__MovementPhase const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__NoteMovement__MovementPhase& operator=(____GlobalNamespace__NoteMovement__MovementPhase&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__NoteMovement__MovementPhase(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__NoteMovement__MovementPhase_Unwrapped : int32_t {
__None = 0,
...
constexpr operator ______GlobalNamespace__NoteMovement__MovementPhase_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__NoteMovement__MovementPhase_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase const None;

/// @brief Field MovingOnTheFloor offset 0
static ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase const MovingOnTheFloor;

/// @brief Field Jumping offset 0
static ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase const Jumping;
...
public:
// Declarations
using MovementPhase = ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase;
...
constexpr ::System::Action __get_noteDidMoveInJumpPhaseEvent() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase __declspec(property(get=__get__movementPhase_k__BackingField, put=__set__movementPhase_k__BackingField))  _movementPhase_k__BackingField;

constexpr void __set__movementPhase_k__BackingField(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase __get__movementPhase_k__BackingField() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase __declspec(property(get=get_movementPhase, put=set_movementPhase))  movementPhase;
...
/// @brief Method get_movementPhase addr 0x2242e58 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase get_movementPhase() ;

/// @brief Method set_movementPhase addr 0x2242e60 size 0x8 virtual false final false
 void set_movementPhase(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__NoteMovement__MovementPhase, "", "NoteMovement/MovementPhase");
