...
namespace GlobalNamespace {
  ...
  struct OculusPlatformAdditionalContentModel::$OpenLevelProductStoreAsync$d__8 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
