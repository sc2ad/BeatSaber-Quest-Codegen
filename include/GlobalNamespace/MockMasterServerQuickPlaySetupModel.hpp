...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: MockMasterServerQuickPlaySetupModel
  class MockMasterServerQuickPlaySetupModel;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(GlobalNamespace::MockMasterServerQuickPlaySetupModel);
...
namespace GlobalNamespace {
  ...
  class MockMasterServerQuickPlaySetupModel : public ::Il2CppObject/*, public GlobalNamespace::IMasterServerQuickPlaySetupModel*/ {
    ...
    #endif
    #endif
    // [InjectAttribute] Offset: 0xF3DFC8
