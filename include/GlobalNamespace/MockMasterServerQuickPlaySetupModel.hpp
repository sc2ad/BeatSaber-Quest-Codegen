...
namespace GlobalNamespace {
  ...
  class MockMasterServerQuickPlaySetupModel : public ::Il2CppObject/*, public GlobalNamespace::IMasterServerQuickPlaySetupModel*/ {
    public:
    // [InjectAttribute] Offset: 0xD3D160
    ...
    MockMasterServerQuickPlaySetupModel(GlobalNamespace::MultiplayerMockSettings* mockSettings_ = {}) noexcept : mockSettings{mockSettings_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(MockMasterServerQuickPlaySetupModel), 16 + sizeof(GlobalNamespace::MultiplayerMockSettings*)> __GlobalNamespace_MockMasterServerQuickPlaySetupModelSizeCheck;
