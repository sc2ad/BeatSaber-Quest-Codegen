...
//  Writing Method size for method: ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::*)()>(&::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2126d4c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>::get(),
                            ".ctor",
...
constexpr void ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::__set_color(::UnityEngine::Color value)  {
...
constexpr ::UnityEngine::Color ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::__get_color() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::__set_value(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::__get_value() const {
return ::cordl_internals::getInstanceField<int32_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters []
 ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::____GlobalNamespace__NamedColorListController__ColorValuePair()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____GlobalNamespace__NamedColorListController__ColorValuePair>())) {}
 void ::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NamedColorListController::*)(::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>, int32_t)>(&::GlobalNamespace::NamedColorListController::Init)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Init",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::NamedColorListController::__set__textValuePairs(::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair> value)  {
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>>(value));
}
constexpr ::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair> ::GlobalNamespace::NamedColorListController::__get__textValuePairs() const {
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void ::GlobalNamespace::NamedColorListController::Init(::ArrayW<::GlobalNamespace::____GlobalNamespace__NamedColorListController__ColorValuePair> values, int32_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NamedColorListController>::get(),
                            "Init",
                            std::vector<Il2CppClass*>{},
