...
constexpr float_t __get__evenCountOffset() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__MultiplayerResultsPyramidViewAvatar__Factory __declspec(property(get=__get__avatarsFactory, put=__set__avatarsFactory))  _avatarsFactory;

constexpr void __set__avatarsFactory(::GlobalNamespace::____GlobalNamespace__MultiplayerResultsPyramidViewAvatar__Factory value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__MultiplayerResultsPyramidViewAvatar__Factory __get__avatarsFactory() const;
