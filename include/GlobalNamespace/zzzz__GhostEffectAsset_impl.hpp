...
constexpr void GlobalNamespace::GhostEffectAsset::__set__ghostEffectType(GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType GlobalNamespace::GhostEffectAsset::__get__ghostEffectType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
