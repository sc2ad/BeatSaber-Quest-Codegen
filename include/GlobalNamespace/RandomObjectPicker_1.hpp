...
namespace GlobalNamespace {
  ...
  class RandomObjectPicker_1 : public ::Il2CppObject {
    ...
    RandomObjectPicker_1(::ArrayWrapper<T> objects_ = {}, float lastPickTime_ = {}, float minimumPickInterval_ = {}) noexcept : objects{objects_}, lastPickTime{lastPickTime_}, minimumPickInterval{minimumPickInterval_} {}
    // Autogenerated instance field getter
    // Get instance field: private T[] _objects
    ::ArrayWrapper<T>& dyn__objects() {
    ...
    // Offset: 0xFFFFFFFF
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static RandomObjectPicker_1<T>* New_ctor(::ArrayWrapper<T> objects, float minimumPickInterval) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RandomObjectPicker_1::.ctor");
