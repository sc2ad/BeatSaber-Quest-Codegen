...
namespace GlobalNamespace {
  ...
  class RandomObjectPicker_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<T>& dyn__objects() {
    ...
    [[deprecated("Use field access instead!")]] float& dyn__lastPickTime() {
    ...
    [[deprecated("Use field access instead!")]] float& dyn__minimumPickInterval() {
