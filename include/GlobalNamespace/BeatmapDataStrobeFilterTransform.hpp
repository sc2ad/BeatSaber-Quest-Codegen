...
namespace GlobalNamespace {
  ...
  class BeatmapDataStrobeFilterTransform : public ::Il2CppObject {
    ...
    // Offset: 0x127A170
    static void $CreateTransformedData$g__IncreaseAllLaterStrobeStartEndIndexes_2_0(float insertionTime, ByRef<GlobalNamespace::BeatmapDataStrobeFilterTransform::$$c__DisplayClass2_0> param_1);
