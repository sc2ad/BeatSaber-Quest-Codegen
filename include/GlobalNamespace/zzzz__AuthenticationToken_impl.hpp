...
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::____GlobalNamespace__AuthenticationToken__Platform(uint8_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::__set_value__(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::__get_value__() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::Test{0u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::OculusRift{1u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::OculusQuest{2u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::Steam{3u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS4{4u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS4Dev{5u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS4Cert{6u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS5{7u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS5Dev{8u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::PS5Cert{9u};
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform  ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform::Oculus{2u};
//  Writing Method size for method: ::GlobalNamespace::AuthenticationToken._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AuthenticationToken::*)(::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, ::StringW, ::StringW, ::StringW)>(&::GlobalNamespace::AuthenticationToken::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get()}
                        )));
...
// Ctor Parameters [CppParam { name: "platform", ty: "::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform", modifiers: "", def_value: Some("{}") }, CppParam { name: "userId", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "userName", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "sessionToken", ty: "::StringW", modifiers: "", def_value: Some("csnull") }]
constexpr ::GlobalNamespace::AuthenticationToken::AuthenticationToken(::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform platform, ::StringW userId, ::StringW userName, ::StringW sessionToken) noexcept : ::bs_hook::ValueTypeWrapper() {this->platform = platform;
this->userId = userId;
this->userName = userName;
this->sessionToken = sessionToken;
}
constexpr void ::GlobalNamespace::AuthenticationToken::__set_platform(::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, 0x0>(this->__instance, std::forward<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform ::GlobalNamespace::AuthenticationToken::__get_platform() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform, 0x0>(this->__instance);
}
...
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->__instance);
 ...
 void ::GlobalNamespace::AuthenticationToken::_ctor(::GlobalNamespace::____GlobalNamespace__AuthenticationToken__Platform platform, ::StringW userId, ::StringW userName, ::StringW sessionToken)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::AuthenticationToken>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
