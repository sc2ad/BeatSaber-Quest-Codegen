...
namespace GlobalNamespace {
  ...
  class BlocksBlade : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xDCAC0C
    ...
    static BlocksBlade* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("BlocksBlade").WithContext(".ctor");
