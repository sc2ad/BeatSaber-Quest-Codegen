...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::NetworkPlayerTableCell::*)()>(&::GlobalNamespace::NetworkPlayerTableCell::get_showSeparator)> {
  ...
  constexpr static std::size_t addrs = 0x2151f5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(bool)>(&::GlobalNamespace::NetworkPlayerTableCell::set_showSeparator)> {
  ...
  constexpr static std::size_t addrs = 0x2151354;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(::StringW, bool, bool, bool, bool)>(&::GlobalNamespace::NetworkPlayerTableCell::SetData)> {
  ...
  constexpr static std::size_t addrs = 0x21512b8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(::HMUI::____HMUI__SelectableCell__TransitionType)>(&::GlobalNamespace::NetworkPlayerTableCell::SelectionDidChange)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x215218c;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::GlobalNamespace::NetworkPlayerTableCell),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NetworkPlayerTableCell>::get(),
                                  10
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(::HMUI::____HMUI__SelectableCell__TransitionType)>(&::GlobalNamespace::NetworkPlayerTableCell::HighlightDidChange)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x2152190;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)()>(&::GlobalNamespace::NetworkPlayerTableCell::RefreshVisuals)> {
  ...
  constexpr static std::size_t addrs = 0x2151f78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::NetworkPlayerTableCell::*)()>(&::GlobalNamespace::NetworkPlayerTableCell::get_activeColor)> {
  ...
  constexpr static std::size_t addrs = 0x2152194;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)()>(&::GlobalNamespace::NetworkPlayerTableCell::_ctor)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x21521f0;
...
constexpr ::TMPro::TextMeshProUGUI ::GlobalNamespace::NetworkPlayerTableCell::__get__playerNameText() const {
...
constexpr ::UnityEngine::GameObject ::GlobalNamespace::NetworkPlayerTableCell::__get__separator() const {
...
constexpr ::UnityEngine::UI::Image ::GlobalNamespace::NetworkPlayerTableCell::__get__privateIcon() const {
...
constexpr ::UnityEngine::UI::Image ::GlobalNamespace::NetworkPlayerTableCell::__get__spectateIcon() const {
...
constexpr ::UnityEngine::UI::Image ::GlobalNamespace::NetworkPlayerTableCell::__get__partyLeaderIcon() const {
...
constexpr ::UnityEngine::UI::Image ::GlobalNamespace::NetworkPlayerTableCell::__get__bgImage() const {
...
constexpr ::UnityEngine::UI::Image ::GlobalNamespace::NetworkPlayerTableCell::__get__highlightImage() const {
...
constexpr ::UnityEngine::Color ::GlobalNamespace::NetworkPlayerTableCell::__get__textColorNormal() const {
...
constexpr ::UnityEngine::Color ::GlobalNamespace::NetworkPlayerTableCell::__get__textColorMe() const {
...
constexpr ::UnityEngine::Color ::GlobalNamespace::NetworkPlayerTableCell::__get__textColorSelected() const {
...
constexpr bool ::GlobalNamespace::NetworkPlayerTableCell::__get__isMe() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, userName, isOpenParty, wantsToPlayNextLevel, isMyPartyOwner, isMe);
}
 void ::GlobalNamespace::NetworkPlayerTableCell::SelectionDidChange(::HMUI::____HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NetworkPlayerTableCell>::get(),
                            "SelectionDidChange",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, transitionType);
 ...
 void ::GlobalNamespace::NetworkPlayerTableCell::HighlightDidChange(::HMUI::____HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NetworkPlayerTableCell>::get(),
                            "HighlightDidChange",
                            std::vector<Il2CppClass*>{},
