...
namespace GlobalNamespace {
  ...
  class ScoreSyncStateManager : public GlobalNamespace::MultiplayerSyncStateManager_4<GlobalNamespace::StandardScoreSyncState, GlobalNamespace::StandardScoreSyncState::Score, int, GlobalNamespace::StandardScoreSyncStateNetSerializable*>, public GlobalNamespace::IScoreSyncStateManager {
    public:
