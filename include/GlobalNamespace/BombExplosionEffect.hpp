...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BombExplosionEffect), 192 + sizeof(UnityEngine::ParticleSystem::EmitParams) + ((192 + sizeof(UnityEngine::ParticleSystem::EmitParams)) % 8 != 0 ? (8 - (192 + sizeof(UnityEngine::ParticleSystem::EmitParams)) % 8) : 0)> __GlobalNamespace_BombExplosionEffectSizeCheck;
}
