...
class CORDL_TYPE GlobalNamespace__BloomPrePassRendererSO__PreallocationData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__BloomPrePassRendererSO__PreallocationData() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BloomPrePassRendererSO__PreallocationData", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData(GlobalNamespace__BloomPrePassRendererSO__PreallocationData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BloomPrePassRendererSO__PreallocationData", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData(GlobalNamespace__BloomPrePassRendererSO__PreallocationData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BloomPrePassRendererSO__PreallocationData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData& operator=(GlobalNamespace__BloomPrePassRendererSO__PreallocationData&& o) noexcept = default;
  constexpr GlobalNamespace__BloomPrePassRendererSO__PreallocationData& operator=(GlobalNamespace__BloomPrePassRendererSO__PreallocationData const& o) noexcept = default;
...
class CORDL_TYPE GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x50};

virtual ~GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData(GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData(GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData& operator=(GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData&& o) noexcept = default;
  constexpr GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData& operator=(GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData const& o) noexcept = default;
...
constexpr UnityEngine::Mesh __get_mesh() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData> __declspec(property(get=__get_lightQuads, put=__set_lightQuads))  lightQuads;

constexpr void __set_lightQuads(::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassLight__QuadData> __get_lightQuads() const;
...
public:
// Declarations
using LightsRenderingData = GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData;

using PreallocationData = GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData;
...
constexpr GlobalNamespace::BloomFogSO __get__bloomFog() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData> __declspec(property(get=__get__preallocationData, put=__set__preallocationData))  _preallocationData;

constexpr void __set__preallocationData(::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData> __get__preallocationData() const;

 System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData> __declspec(property(get=__get__lightsRenderingData, put=__set__lightsRenderingData))  _lightsRenderingData;

constexpr void __set__lightsRenderingData(System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData> value) ;

constexpr System::Collections::Generic::Dictionary_2<GlobalNamespace::BloomPrePassLightTypeSO,GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData> __get__lightsRenderingData() const;
...
/// @brief Method PrepareLightsMeshRendering addr 0x1f95260 size 0x4fc virtual false final false
 void PrepareLightsMeshRendering(GlobalNamespace::BloomPrePassLightTypeSO lightType, GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData data, int32_t numberOfLights) ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__LightsRenderingData, "", "BloomPrePassRendererSO/LightsRenderingData");
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BloomPrePassRendererSO__PreallocationData, "", "BloomPrePassRendererSO/PreallocationData");
