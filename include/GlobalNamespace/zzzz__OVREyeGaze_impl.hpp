...
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId::____GlobalNamespace__OVREyeGaze__EyeId(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId  ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId::Left{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId  ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId::Right{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::____GlobalNamespace__OVREyeGaze__EyeTrackingMode(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode  ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::HeadSpace{0};
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode  ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::WorldSpace{1};
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode  ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode::TrackingSpace{2};
...
constexpr void ::GlobalNamespace::OVREyeGaze::__set_Eye(::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId ::GlobalNamespace::OVREyeGaze::__get_Eye() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeId, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::OVREyeGaze::__set__currentEyeGazesState(::GlobalNamespace::____GlobalNamespace__OVRPlugin__EyeGazesState value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRPlugin__EyeGazesState, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRPlugin__EyeGazesState>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPlugin__EyeGazesState ::GlobalNamespace::OVREyeGaze::__get__currentEyeGazesState() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRPlugin__EyeGazesState, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void ::GlobalNamespace::OVREyeGaze::__set_TrackingMode(::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode ::GlobalNamespace::OVREyeGaze::__get_TrackingMode() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVREyeGaze__EyeTrackingMode, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRPermissionsRequester__Permission  ::GlobalNamespace::OVREyeGaze::EyeTrackingPermission{2};
