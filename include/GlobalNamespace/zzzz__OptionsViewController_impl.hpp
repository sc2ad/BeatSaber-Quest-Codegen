...
constexpr GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::GlobalNamespace__OptionsViewController__OptionsButton(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton  GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::EditAvatar{0};
constexpr GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton  GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::PlayerOptions{1};
constexpr GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton  GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton::Settings{2};
//  Writing Method size for method: GlobalNamespace::OptionsViewController.add_didFinishEvent
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OptionsViewController::*)(System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>)>(&GlobalNamespace::OptionsViewController::add_didFinishEvent)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OptionsViewController::*)(System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>)>(&GlobalNamespace::OptionsViewController::remove_didFinishEvent)> {
  constexpr static std::size_t size = 0xb0;
...
constexpr void GlobalNamespace::OptionsViewController::__set_didFinishEvent(System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton> value)  {
::cordl_internals::setInstanceField<System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>, 0x90>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>>(value));
}
constexpr System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton> GlobalNamespace::OptionsViewController::__get_didFinishEvent() const {
return ::cordl_internals::getInstanceField<System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton>, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void GlobalNamespace::OptionsViewController::add_didFinishEvent(System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::OptionsViewController>::get(),
                            "add_didFinishEvent",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void GlobalNamespace::OptionsViewController::remove_didFinishEvent(System::Action_1<GlobalNamespace::GlobalNamespace__OptionsViewController__OptionsButton> value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::OptionsViewController>::get(),
                            "remove_didFinishEvent",
                            std::vector<Il2CppClass*>{},
...
GlobalNamespace::OptionsViewController o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::OptionsViewController>())};
return o;
}
