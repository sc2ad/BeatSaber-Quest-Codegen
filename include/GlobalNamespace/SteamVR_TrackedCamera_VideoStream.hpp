...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SteamVR_TrackedCamera::VideoStream), 40 + sizeof(uint64_t) + ((40 + sizeof(uint64_t)) % 8 != 0 ? (8 - (40 + sizeof(uint64_t)) % 8) : 0)> __GlobalNamespace_SteamVR_TrackedCamera_VideoStreamSizeCheck;
}
