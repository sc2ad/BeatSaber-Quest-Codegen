...
namespace GlobalNamespace {
  ...
  // [DefaultMemberAttribute] Offset: 10C4190
  template<typename T>
  class ListWithEvents_1 : public ::Il2CppObject/*, public ::System::Collections::Generic::IList_1<T>*/ {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_1<T>*& dyn_OnElementAdded() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_1<T>*& dyn_OnElementRemoved() {
