...
namespace GlobalNamespace {
  ...
  class TestFlowCoordinator : public HMUI::FlowCoordinator {
    ...
    static TestFlowCoordinator* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("TestFlowCoordinator").WithContext(".ctor");
