...
namespace GlobalNamespace {
  ...
  check_size<sizeof(HMAutoincrementedRequestId), 16 + sizeof(uint64_t) + ((16 + sizeof(uint64_t)) % 8 != 0 ? (8 - (16 + sizeof(uint64_t)) % 8) : 0)> __GlobalNamespace_HMAutoincrementedRequestIdSizeCheck;
}
