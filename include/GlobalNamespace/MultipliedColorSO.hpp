...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultipliedColorSO), 32 + sizeof(UnityEngine::Color) + ((32 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (32 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_MultipliedColorSOSizeCheck;
}
