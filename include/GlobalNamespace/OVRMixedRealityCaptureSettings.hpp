...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRMixedRealityCaptureSettings), 148 + sizeof(float) + ((148 + sizeof(float)) % 8 != 0 ? (8 - (148 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRMixedRealityCaptureSettingsSizeCheck;
}
