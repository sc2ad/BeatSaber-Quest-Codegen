...
namespace GlobalNamespace {
  ...
  class TestBeatmapDataAssetFileModel : public ::CsObject, public GlobalNamespace::IBeatmapDataAssetFileModel {
    public:
    ...
    static ::CsString* _get_kAssetsDir();
    // Set static field: static private System.String kAssetsDir
    static void _set_kAssetsDir(::CsString* value);
