...
// Ctor Parameters []
 ::GlobalNamespace::MissionObjectivesGameUIController::MissionObjectivesGameUIController()  : ::UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<MissionObjectivesGameUIController>())) {}
