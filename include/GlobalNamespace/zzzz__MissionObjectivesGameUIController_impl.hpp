...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MissionObjectivesGameUIController::*)()>(&GlobalNamespace::MissionObjectivesGameUIController::Start)> {
  ...
  constexpr static std::size_t addrs = 0x2275ef4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MissionObjectivesGameUIController::*)()>(&GlobalNamespace::MissionObjectivesGameUIController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x2276328;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MissionObjectivesGameUIController::*)()>(&GlobalNamespace::MissionObjectivesGameUIController::HandleMissionObjectiveCheckersManagerObjectivesListDidChange)> {
  ...
  constexpr static std::size_t addrs = 0x22763fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MissionObjectivesGameUIController::*)()>(&GlobalNamespace::MissionObjectivesGameUIController::CreateUIElements)> {
  ...
  constexpr static std::size_t addrs = 0x2275f88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MissionObjectivesGameUIController::*)()>(&GlobalNamespace::MissionObjectivesGameUIController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2276400;
...
::cordl_internals::setInstanceField<GlobalNamespace::MissionObjectiveGameUIView, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::MissionObjectiveGameUIView>(value));
}
constexpr GlobalNamespace::MissionObjectiveGameUIView GlobalNamespace::MissionObjectivesGameUIController::__get__missionObjectiveGameUIViewPrefab() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::MissionObjectiveGameUIView, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::MissionObjectivesGameUIController::__set__separator(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::MissionObjectivesGameUIController::__get__separator() const {
...
constexpr float_t GlobalNamespace::MissionObjectivesGameUIController::__get__elementWidth() const {
...
constexpr GlobalNamespace::MissionObjectiveCheckersManager GlobalNamespace::MissionObjectivesGameUIController::__get__missionObjectiveCheckersManager() const {
...
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::MissionObjectiveGameUIView>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::MissionObjectiveGameUIView>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::MissionObjectiveGameUIView> GlobalNamespace::MissionObjectivesGameUIController::__get__missionObjectiveGameUIViews() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::MissionObjectiveGameUIView>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
GlobalNamespace::MissionObjectivesGameUIController o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::MissionObjectivesGameUIController>())};
return o;
}
 void GlobalNamespace::MissionObjectivesGameUIController::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MissionObjectivesGameUIController>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
