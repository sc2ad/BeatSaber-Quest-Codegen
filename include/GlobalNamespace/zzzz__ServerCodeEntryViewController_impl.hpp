...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)(System::Action_2<bool,::StringW>)>(&GlobalNamespace::ServerCodeEntryViewController::add_didFinishEvent)> {
  ...
  constexpr static std::size_t addrs = 0x2179204;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::Action_2<bool,::StringW>>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)(System::Action_2<bool,::StringW>)>(&GlobalNamespace::ServerCodeEntryViewController::remove_didFinishEvent)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x21792b4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)(bool, bool, bool)>(&GlobalNamespace::ServerCodeEntryViewController::DidActivate)> {
  ...
  constexpr static std::size_t addrs = 0x2179364;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::ServerCodeEntryViewController),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ServerCodeEntryViewController>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)(bool, bool)>(&GlobalNamespace::ServerCodeEntryViewController::DidDeactivate)> {
  ...
  constexpr static std::size_t addrs = 0x2179514;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)(HMUI::InputFieldView)>(&GlobalNamespace::ServerCodeEntryViewController::HandleInputFieldChanged)> {
  ...
  constexpr static std::size_t addrs = 0x2179544;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)()>(&GlobalNamespace::ServerCodeEntryViewController::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x217957c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)()>(&GlobalNamespace::ServerCodeEntryViewController::HandleJoinButtonPressed)> {
  ...
  constexpr static std::size_t addrs = 0x21795a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ServerCodeEntryViewController::*)()>(&GlobalNamespace::ServerCodeEntryViewController::_ctor)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x2179604;
...
::cordl_internals::setInstanceField<HMUI::UIKeyboard, 0x70>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::UIKeyboard>(value));
}
constexpr HMUI::UIKeyboard GlobalNamespace::ServerCodeEntryViewController::__get__uiKeyboard() const {
return ::cordl_internals::getInstanceField<HMUI::UIKeyboard, 0x70>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ServerCodeEntryViewController::__set__codeInputField(HMUI::InputFieldView value)  {
::cordl_internals::setInstanceField<HMUI::InputFieldView, 0x78>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::InputFieldView>(value));
}
constexpr HMUI::InputFieldView GlobalNamespace::ServerCodeEntryViewController::__get__codeInputField() const {
return ::cordl_internals::getInstanceField<HMUI::InputFieldView, 0x78>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr UnityEngine::UI::Button GlobalNamespace::ServerCodeEntryViewController::__get__joinButton() const {
...
constexpr UnityEngine::UI::Button GlobalNamespace::ServerCodeEntryViewController::__get__cancelButton() const {
...
::cordl_internals::setInstanceField<System::Action_2<bool,::StringW>, 0x90>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Action_2<bool,::StringW>>(value));
}
constexpr System::Action_2<bool,::StringW> GlobalNamespace::ServerCodeEntryViewController::__get_didFinishEvent() const {
return ::cordl_internals::getInstanceField<System::Action_2<bool,::StringW>, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<HMUI::InputFieldViewChangeBinder, 0x98>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::InputFieldViewChangeBinder>(value));
}
constexpr HMUI::InputFieldViewChangeBinder GlobalNamespace::ServerCodeEntryViewController::__get__inputFieldViewChangeBinder() const {
return ::cordl_internals::getInstanceField<HMUI::InputFieldViewChangeBinder, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 GlobalNamespace::ServerCodeEntryViewController::ServerCodeEntryViewController()  : HMUI::ViewController(THROW_UNLESS(::il2cpp_utils::New<ServerCodeEntryViewController>())) {}
 void GlobalNamespace::ServerCodeEntryViewController::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ServerCodeEntryViewController>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
