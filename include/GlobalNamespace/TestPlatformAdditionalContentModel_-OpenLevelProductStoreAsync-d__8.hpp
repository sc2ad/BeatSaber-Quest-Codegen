...
namespace GlobalNamespace {
  ...
  struct TestPlatformAdditionalContentModel::$OpenLevelProductStoreAsync$d__8 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
