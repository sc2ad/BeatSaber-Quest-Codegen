...
constexpr void GlobalNamespace::SaberClashEffect::__set__sparkleParticleSystemEmmisionModule(UnityEngine::UnityEngine__ParticleSystem__EmissionModule value)  {
::cordl_internals::setInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UnityEngine__ParticleSystem__EmissionModule>(value));
}
constexpr UnityEngine::UnityEngine__ParticleSystem__EmissionModule GlobalNamespace::SaberClashEffect::__get__sparkleParticleSystemEmmisionModule() const {
return ::cordl_internals::getInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::SaberClashEffect::__set__glowParticleSystemEmmisionModule(UnityEngine::UnityEngine__ParticleSystem__EmissionModule value)  {
::cordl_internals::setInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UnityEngine__ParticleSystem__EmissionModule>(value));
}
constexpr UnityEngine::UnityEngine__ParticleSystem__EmissionModule GlobalNamespace::SaberClashEffect::__get__glowParticleSystemEmmisionModule() const {
return ::cordl_internals::getInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
