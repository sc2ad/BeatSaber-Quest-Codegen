...
namespace GlobalNamespace {
  ...
  class MissionMapAnimationController::$UpdateClearedNodeStateCoroutine$d__13 : public System::Collections::Generic::IEnumerator_1<::Il2CppObject*>, public ::Il2CppObject {
    public:
