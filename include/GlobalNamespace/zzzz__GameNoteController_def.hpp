...
public:
// Declarations
using Pool = ::GlobalNamespace::____GlobalNamespace__GameNoteController__Pool;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10992)), TypeDefinitionIndex(TypeDefinitionIndex(4860)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10992), inst: 297 })}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4859))
// CS Name: GameNoteController::Pool
class CORDL_TYPE ____GlobalNamespace__GameNoteController__Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::GameNoteController> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~____GlobalNamespace__GameNoteController__Pool() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameNoteController__Pool", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__GameNoteController__Pool(____GlobalNamespace__GameNoteController__Pool const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__GameNoteController__Pool", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__GameNoteController__Pool(____GlobalNamespace__GameNoteController__Pool&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__GameNoteController__Pool(void* ptr) noexcept : ::Zenject::MonoMemoryPool_1<::GlobalNamespace::GameNoteController>(ptr) {
}


  constexpr ____GlobalNamespace__GameNoteController__Pool& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__GameNoteController__Pool& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__GameNoteController__Pool& operator=(____GlobalNamespace__GameNoteController__Pool&& o) noexcept = default;
  constexpr ____GlobalNamespace__GameNoteController__Pool& operator=(____GlobalNamespace__GameNoteController__Pool const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____GlobalNamespace__GameNoteController__Pool() ;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__GameNoteController__Pool);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__GameNoteController__Pool, "", "GameNoteController/Pool");
