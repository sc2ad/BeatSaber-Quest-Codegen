...
namespace GlobalNamespace {
  ...
  check_size<sizeof(NamedIntListSettingsController::TextValuePair), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __GlobalNamespace_NamedIntListSettingsController_TextValuePairSizeCheck;
}
