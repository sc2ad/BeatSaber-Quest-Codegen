...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::Frustumf2), 8 + sizeof(GlobalNamespace::OVRPlugin::Fovf) + ((8 + sizeof(GlobalNamespace::OVRPlugin::Fovf)) % 8 != 0 ? (8 - (8 + sizeof(GlobalNamespace::OVRPlugin::Fovf)) % 8) : 0)> __GlobalNamespace_OVRPlugin_Frustumf2SizeCheck;
}
