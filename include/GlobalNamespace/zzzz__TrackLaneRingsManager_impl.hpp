...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::get_ringPositionStep)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x226c8ec;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TrackLaneRingsManager>::get(),
                            "get_ringPositionStep",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::TrackLaneRing> (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::get_Rings)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x226c8f4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::Start)> {
  ...
  constexpr static std::size_t addrs = 0x226c8fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::FixedUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x226cbac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::LateUpdate)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x226cc48;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::OnDrawGizmosSelected)> {
  ...
  constexpr static std::size_t addrs = 0x226cce4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsManager::*)()>(&GlobalNamespace::TrackLaneRingsManager::_ctor)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x226cf68;
...
::cordl_internals::setInstanceField<GlobalNamespace::TrackLaneRing, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::TrackLaneRing>(value));
}
constexpr GlobalNamespace::TrackLaneRing GlobalNamespace::TrackLaneRingsManager::__get__trackLaneRingPrefab() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::TrackLaneRing, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::TrackLaneRingsManager::__set__ringCount(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::TrackLaneRingsManager::__get__ringCount() const {
...
constexpr float_t GlobalNamespace::TrackLaneRingsManager::__get__ringPositionStep() const {
...
constexpr bool GlobalNamespace::TrackLaneRingsManager::__get__spawnAsChildren() const {
...
constexpr Zenject::DiContainer GlobalNamespace::TrackLaneRingsManager::__get__container() const {
return ::cordl_internals::getInstanceField<Zenject::DiContainer, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::TrackLaneRingsManager::__set__rings(::ArrayW<GlobalNamespace::TrackLaneRing> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::TrackLaneRing>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::TrackLaneRing>>(value));
}
constexpr ::ArrayW<GlobalNamespace::TrackLaneRing> GlobalNamespace::TrackLaneRingsManager::__get__rings() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::TrackLaneRing>, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
 float_t GlobalNamespace::TrackLaneRingsManager::get_ringPositionStep()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TrackLaneRingsManager>::get(),
                            "get_ringPositionStep",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<GlobalNamespace::TrackLaneRing>, false>(const_cast<void*>(instance), ___internal_method);
}
