...
namespace GlobalNamespace {
  ...
  class RuntimeLightWithIds : public ::GlobalNamespace::LightWithIds {
    ...
    // [SpaceAttribute] Offset: 0x109E230
  ...
  #pragma pack(pop)
  static check_size<sizeof(RuntimeLightWithIds), 64 + sizeof(bool)> __GlobalNamespace_RuntimeLightWithIdsSizeCheck;
  static_assert(sizeof(RuntimeLightWithIds) == 0x41);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
