...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TestBeatmapDataAssetFileModel::$GetAssetBundleFileForPreviewLevelAsync$d__4), 80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>) + ((80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>)) % 8 != 0 ? (8 - (80 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GetAssetBundleFileResult>)) % 8) : 0)> __GlobalNamespace_TestBeatmapDataAssetFileModel_$GetAssetBundleFileForPreviewLevelAsync$d__4SizeCheck;
}
