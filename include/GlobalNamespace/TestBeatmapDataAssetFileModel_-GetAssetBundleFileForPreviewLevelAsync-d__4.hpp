...
namespace GlobalNamespace {
  ...
  struct TestBeatmapDataAssetFileModel::$GetAssetBundleFileForPreviewLevelAsync$d__4 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
