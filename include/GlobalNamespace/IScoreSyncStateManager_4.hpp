...
namespace GlobalNamespace {
  ...
  class IScoreSyncStateManager_4 {
    public:
    // Creating value type constructor for type: IScoreSyncStateManager_4
    IScoreSyncStateManager_4() noexcept {}
    // public System.Single get_syncTime()
    // Offset: 0xFFFFFFFF
    float get_syncTime() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::IScoreSyncStateManager_4::get_syncTime");
    ...
    int get_connectedPlayerCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::IScoreSyncStateManager_4::get_connectedPlayerCount");
    ...
    GlobalNamespace::LocalMultiplayerSyncState_3<TStateTable, TType, TState>* get_localState() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::IScoreSyncStateManager_4::get_localState");
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncStateForPlayer(GlobalNamespace::IConnectedPlayer* player) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::IScoreSyncStateManager_4::GetSyncStateForPlayer");
    ...
    GlobalNamespace::MultiplayerSyncState_3<TStateTable, TType, TState>* GetSyncState(int i) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::IScoreSyncStateManager_4::GetSyncState");
  ...
  // Could not write size check! Type: IScoreSyncStateManager`4 is generic, or has no fields that are valid for size checks!
}
