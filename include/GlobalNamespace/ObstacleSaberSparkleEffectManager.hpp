...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ObstacleSaberSparkleEffectManager), 128 + sizeof(void*) + ((128 + sizeof(void*)) % 8 != 0 ? (8 - (128 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_ObstacleSaberSparkleEffectManagerSizeCheck;
}
