...
namespace GlobalNamespace {
  ...
  class UndoRedoBuffer_1 : public ::Il2CppObject {
    ...
    System::Collections::Generic::List_1<T>* _get__data() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_get__data");
    ...
    // Set instance field: private System.Collections.Generic.List`1<T> _data
    void _set__data(System::Collections::Generic::List_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_set__data");
      static auto ___internal__instance = this;
    ...
    int _get__capacity() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_get__capacity");
      static auto ___internal__instance = this;
    ...
    void _set__capacity(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_set__capacity");
      static auto ___internal__instance = this;
    ...
    int _get__cursor() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_get__cursor");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<int>(___internal__instance, "_cursor"));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Int32 _cursor
    void _set__cursor(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::UndoRedoBuffer_1::_set__cursor");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_cursor", value));
    }
