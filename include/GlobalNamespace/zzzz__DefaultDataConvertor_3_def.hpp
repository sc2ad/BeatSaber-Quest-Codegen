...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TIn,::cordl_internals::il2cpp_reference_type TOut>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4315)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4315), inst: 1118 }), TypeDefinitionIndex(TypeDefinitionIndex(4316))}
