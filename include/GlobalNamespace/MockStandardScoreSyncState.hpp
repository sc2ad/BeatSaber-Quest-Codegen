...
namespace GlobalNamespace {
  ...
  class MockStandardScoreSyncState : public GlobalNamespace::LocalMultiplayerSyncState_3<GlobalNamespace::StandardScoreSyncState, GlobalNamespace::StandardScoreSyncState::Score, int> {
    public:
    // private readonly System.Collections.Generic.Dictionary`2<StandardScoreSyncState/Score,System.Int32> _poseDictionary
    // Offset: 0x20
    System::Collections::Generic::Dictionary_2<GlobalNamespace::StandardScoreSyncState::Score, int>* poseDictionary;
    // Creating conversion operator: operator System::Collections::Generic::Dictionary_2<GlobalNamespace::StandardScoreSyncState::Score, int>*
    constexpr operator System::Collections::Generic::Dictionary_2<GlobalNamespace::StandardScoreSyncState::Score, int>*() const noexcept {
      return poseDictionary;
    }
    // public System.Int32 GetState(StandardScoreSyncState/Score type, System.Single time)
    // Offset: 0xFC6EDC
    int GetState(GlobalNamespace::StandardScoreSyncState::Score type, float time);
    // public System.Void SetState(StandardScoreSyncState/Score type, System.Int32 state)
    // Offset: 0xFC6F5C
    void SetState(GlobalNamespace::StandardScoreSyncState::Score type, int state);
    // public System.Void SetMockedState(StandardScoreSyncState/Score type, System.Int32 state)
    // Offset: 0xFC6B3C
    void SetMockedState(GlobalNamespace::StandardScoreSyncState::Score type, int state);
    ...
    // Offset: 0xFC6730
    static MockStandardScoreSyncState* New_ctor(GlobalNamespace::IConnectedPlayer* player, float reliableUpdateFrequency, float unreliableUpdateFrequency, int size, typename GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState, GlobalNamespace::StandardScoreSyncState::Score, int>::InterpolationDelegate* interpolator, typename GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState, GlobalNamespace::StandardScoreSyncState::Score, int>::SmoothingDelegate* smoother);
