...
namespace GlobalNamespace {
  ...
  check_size<sizeof(TrackLaneRingsPositionStepEffectSpawner), 56 + sizeof(bool) + ((56 + sizeof(bool)) % 8 != 0 ? (8 - (56 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_TrackLaneRingsPositionStepEffectSpawnerSizeCheck;
}
