...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_4 : public GlobalNamespace::RemoteProcedureCall {
    ...
    T3 get_value3() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T3, false>(this, ___internal__method)));
    }
    ...
    GlobalNamespace::IRemoteProcedureCall* Init(float syncTime, T0 value0, T1 value1, T2 value2, T3 value3) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<GlobalNamespace::IRemoteProcedureCall*, false>(this, ___internal__method, syncTime, value0, value1, value2, value3)));
    }
