...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_4 : public GlobalNamespace::RemoteProcedureCall {
    ...
    // Offset: 0xFFFFFFFF
    T0 get_value0() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("get_value0");
    ...
    void set_value0(T0 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("set_value0");
    ...
    // Offset: 0xFFFFFFFF
    T1 get_value1() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("get_value1");
    ...
    void set_value1(T1 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("set_value1");
    ...
    // Offset: 0xFFFFFFFF
    T2 get_value2() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("get_value2");
    ...
    void set_value2(T2 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("set_value2");
    ...
    // Offset: 0xFFFFFFFF
    T3 get_value3() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("get_value3");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<T3>(), "get_value3", {}, ::il2cpp_utils::ExtractTypes()));
    ...
    void set_value3(T3 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("set_value3");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "set_value3", {}, ::il2cpp_utils::ExtractTypes(value)));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, value);
    }
    ...
    GlobalNamespace::IRemoteProcedureCall* Init(float syncTime, T0 value0, T1 value1, T2 value2, T3 value3) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("Init");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<GlobalNamespace::IRemoteProcedureCall*>(), "Init", {}, ::il2cpp_utils::ExtractTypes(syncTime, value0, value1, value2, value3)));
    ...
    void SerializeData(LiteNetLib::Utils::NetDataWriter* writer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("SerializeData");
    ...
    void DeserializeData(LiteNetLib::Utils::NetDataReader* reader) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext("DeserializeData");
    ...
    static RemoteProcedureCall_4<T0, T1, T2, T3>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("RemoteProcedureCall_4").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<RemoteProcedureCall_4<T0, T1, T2, T3>*>()));
    }
  }; // RemoteProcedureCall`4
  // Could not write size check! Type: RemoteProcedureCall`4 is generic!
}
