...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_4 : public ::GlobalNamespace::RemoteProcedureCall {
    ...
    // private readonly RemoteProcedureCall/TypeWrapper`1<T3> _value3
    // Size: 0x8
    // Offset: 0x0
    ::GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T3>* value3;
    // Field size check
    static_assert(sizeof(::GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T3>*) == 0x8);
    public:
    ...
    // Autogenerated instance field getter
    // Get instance field: private readonly RemoteProcedureCall/TypeWrapper`1<T3> _value3
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T3>*& dyn__value3() {
    ...
    ::GlobalNamespace::IRemoteProcedureCall* Init(float syncTime, T0 value0, T1 value1, T2 value2, T3 value3) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<::GlobalNamespace::IRemoteProcedureCall*, false>(this, ___internal__method, syncTime, value0, value1, value2, value3);
    }
    ...
    void Release() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::RemoteProcedureCall_4::Release");
