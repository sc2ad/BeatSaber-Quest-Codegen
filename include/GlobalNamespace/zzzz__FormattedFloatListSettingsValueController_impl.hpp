...
constexpr GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType  GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::Normal{0};
constexpr GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType  GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::Normalized{1};
constexpr GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType  GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType::InvertedNormalized{2};
...
constexpr void GlobalNamespace::FormattedFloatListSettingsValueController::__set_valueType(GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType GlobalNamespace::FormattedFloatListSettingsValueController::__get_valueType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__FormattedFloatListSettingsValueController__ValueType, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
GlobalNamespace::FormattedFloatListSettingsValueController o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::FormattedFloatListSettingsValueController>())};
return o;
}
