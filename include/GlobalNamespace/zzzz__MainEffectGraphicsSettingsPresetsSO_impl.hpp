...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset::*)()>(&GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef680;
...
constexpr void GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset::__set_mainEffect(GlobalNamespace::MainEffectSO value)  {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset> (GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::get_presets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef668;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::NamedPreset> (GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::get_namedPresets)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef670;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::MainEffectGraphicsSettingsPresetsSO),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MainEffectGraphicsSettingsPresetsSO>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::*)()>(&GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21ef678;
...
constexpr void GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::__set__presets(::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset>>(value));
}
constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset> GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::__get__presets() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
 ::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset> GlobalNamespace::MainEffectGraphicsSettingsPresetsSO::get_presets()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MainEffectGraphicsSettingsPresetsSO>::get(),
                            "get_presets",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset>, false>(const_cast<void*>(instance), ___internal_method);
}
