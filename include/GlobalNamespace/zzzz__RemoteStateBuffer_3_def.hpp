...
class RemoteStateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>;
}
...
template<::cordl_internals::is_or_is_backed_by<int32_t> TState>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12926)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12924), inst: 3699 }), TypeDefinitionIndex(TypeDefinitionIndex(12924))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12926), inst: 4982 })
// CS Name: RemoteStateBuffer`3
class CORDL_TYPE RemoteStateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> : public GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState> {
public:
// Declarations
...
constexpr explicit RemoteStateBuffer_3(void* ptr) noexcept : GlobalNamespace::StateBuffer_3<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>(ptr) {
}
...
static constexpr int32_t  kMaxDeltaQueueSize{64};
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __declspec(property(get=__get__receivedStates, put=__set__receivedStates))  _receivedStates;

constexpr void __set__receivedStates(::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __get__receivedStates() const;

 ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __declspec(property(get=__get__receivedDeltas, put=__set__receivedDeltas))  _receivedDeltas;

constexpr void __set__receivedDeltas(::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__StateBuffer_3__TimestampedStateTable<GlobalNamespace::StandardScoreSyncState,System::Int32Enum,TState>> __get__receivedDeltas() const;
