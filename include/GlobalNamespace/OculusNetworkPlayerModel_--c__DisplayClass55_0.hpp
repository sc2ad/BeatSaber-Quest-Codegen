...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: EFD7F4
  class OculusNetworkPlayerModel::$$c__DisplayClass55_0 : public ::Il2CppObject {
    ...
    // Get instance field reference: public Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.UserAndRoomList> onGetFriends
    typename Oculus::Platform::Message_1<Oculus::Platform::Models::UserAndRoomList*>::Callback*& dyn_onGetFriends();
    // Get instance field reference: public Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.UserList> onGetInvitable
