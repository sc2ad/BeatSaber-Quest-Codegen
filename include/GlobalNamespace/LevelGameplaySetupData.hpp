...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LevelGameplaySetupData), 40 + sizeof(GlobalNamespace::BeatmapDifficulty) + ((40 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8 != 0 ? (8 - (40 + sizeof(GlobalNamespace::BeatmapDifficulty)) % 8) : 0)> __GlobalNamespace_LevelGameplaySetupDataSizeCheck;
}
