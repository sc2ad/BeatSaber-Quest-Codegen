...
namespace GlobalNamespace {
  ...
  class BeatmapObjectsInTimeRowProcessor::TimeSliceContainer_1 : public ::Il2CppObject {
    ...
    float& dyn_$previousTimeSliceTime$k__BackingField() {
    ...
    ::System::Action_2<::GlobalNamespace::BeatmapObjectsInTimeRowProcessor::TimeSliceContainer_1<T>*, float>*& dyn_didFinishTimeSliceEvent() {
    ...
    ::System::Action_1<::GlobalNamespace::BeatmapObjectsInTimeRowProcessor::TimeSliceContainer_1<T>*>*& dyn_didStartNewTimeSliceEvent() {
    ...
    ::System::Action_2<::GlobalNamespace::BeatmapObjectsInTimeRowProcessor::TimeSliceContainer_1<T>*, T>*& dyn_didAddItemEvent() {
