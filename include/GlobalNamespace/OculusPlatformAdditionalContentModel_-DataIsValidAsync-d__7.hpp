...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OculusPlatformAdditionalContentModel::$DataIsValidAsync$d__7), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::UpdateEntitlementsResult>)) % 8) : 0)> __GlobalNamespace_OculusPlatformAdditionalContentModel_$DataIsValidAsync$d__7SizeCheck;
}
