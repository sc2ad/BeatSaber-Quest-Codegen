...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: 10BD688
  // [RequireComponent] Offset: 10BD688
  ...
  class ParametricBoxController : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x10BE098
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10BE0B0
    // [RangeAttribute] Offset: 0x10BE0B0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x10BE0F0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10BE108
