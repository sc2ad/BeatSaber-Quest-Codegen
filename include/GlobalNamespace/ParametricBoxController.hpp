...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: EDE564
  // [RequireComponent] Offset: EDE564
  ...
  class ParametricBoxController : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xEDEE8C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xEDEEA4
    // [RangeAttribute] Offset: 0xEDEEA4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xEDEEE4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xEDEEFC
