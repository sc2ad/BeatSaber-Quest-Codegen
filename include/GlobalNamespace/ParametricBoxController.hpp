...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: 11060B0
  // [RequireComponent] Offset: 11060B0
  ...
  class ParametricBoxController : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x1106B3C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x1106B54
    // [RangeAttribute] Offset: 0x1106B54
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x1106B94
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x1106BAC
