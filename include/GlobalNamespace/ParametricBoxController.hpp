...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: CFFC24
  // [RequireComponent] Offset: CFFC24
  // [ExecuteInEditMode] Offset: CFFC24
  class ParametricBoxController : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xD004D4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD004EC
    // [RangeAttribute] Offset: 0xD004EC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xD0052C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD00544
