...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: DE0108
  // [RequireComponent] Offset: DE0108
  ...
  class ParametricBoxController : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xDE09F0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xDE0A08
    // [RangeAttribute] Offset: 0xDE0A08
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xDE0A48
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xDE0A60
