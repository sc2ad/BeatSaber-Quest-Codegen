...
namespace GlobalNamespace {
  ...
  class ParametricBoxController : public ::UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x1228DC4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x1228DDC
    // [RangeAttribute] Offset: 0x1228DDC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0x1228E1C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x1228E34
