...
namespace GlobalNamespace {
struct ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19;
}
...
struct CORDL_TYPE ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::LevelListTableCell __4__this, ::GlobalNamespace::IPreviewBeatmapLevel level, bool isFavorite, bool isPromoted, bool isUpdated, ::System::Threading::CancellationToken _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityEngine::Sprite> __u__1) noexcept;


                    constexpr ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19(____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19 const&) = default;
                    constexpr ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19(____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19&&) = default;
                    constexpr ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19& operator=(____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19& operator=(____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::LevelListTableCell", modifiers: "", def_value: None }, CppParam { name: "levelID", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "contentModel", ty: "::GlobalNamespace::AdditionalContentModel", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus>", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::LevelListTableCell __4__this, ::StringW levelID, ::GlobalNamespace::AdditionalContentModel contentModel, ::System::Threading::CancellationToken _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::____GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept;


                    constexpr ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24(____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24 const&) = default;
                    constexpr ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24(____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24&&) = default;
                    constexpr ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24& operator=(____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24& operator=(____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _RefreshAvailabilityAsync_d__24 = ::GlobalNamespace::____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24;

using _SetDataFromLevelAsync_d__19 = ::GlobalNamespace::____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelListTableCell___RefreshAvailabilityAsync_d__24, "", "LevelListTableCell/<RefreshAvailabilityAsync>d__24");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelListTableCell___SetDataFromLevelAsync_d__19, "", "LevelListTableCell/<SetDataFromLevelAsync>d__19");
