...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OpenVRControllerDetails), 88 + sizeof(UnityEngine::Quaternion) + ((88 + sizeof(UnityEngine::Quaternion)) % 8 != 0 ? (8 - (88 + sizeof(UnityEngine::Quaternion)) % 8) : 0)> __GlobalNamespace_OVRInput_OpenVRControllerDetailsSizeCheck;
}
