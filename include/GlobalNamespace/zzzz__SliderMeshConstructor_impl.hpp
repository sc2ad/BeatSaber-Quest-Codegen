...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Mesh (::GlobalNamespace::SliderMeshConstructor::*)()>(&::GlobalNamespace::SliderMeshConstructor::get_mesh)> {
  ...
  constexpr static std::size_t addrs = 0x224b89c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderMeshConstructor::*)()>(&::GlobalNamespace::SliderMeshConstructor::CreateMeshIfNonExisting)> {
  ...
  constexpr static std::size_t addrs = 0x224b8a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderMeshConstructor::*)(::GlobalNamespace::VertexPath)>(&::GlobalNamespace::SliderMeshConstructor::CreateSliderMesh)> {
  ...
  constexpr static std::size_t addrs = 0x224b95c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderMeshConstructor::*)(::GlobalNamespace::VertexPath)>(&::GlobalNamespace::SliderMeshConstructor::CreateSliderMeshInternal)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::GlobalNamespace::SliderMeshConstructor),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SliderMeshConstructor>::get(),
                                  4
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::SliderMeshConstructor::*)(::GlobalNamespace::VertexPath)>(&::GlobalNamespace::SliderMeshConstructor::GetVertexCount)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::SliderMeshConstructor::*)(::GlobalNamespace::VertexPath)>(&::GlobalNamespace::SliderMeshConstructor::GetTrianglesCount)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SliderMeshConstructor::*)()>(&::GlobalNamespace::SliderMeshConstructor::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x224baec;
...
constexpr ::UnityEngine::MeshFilter ::GlobalNamespace::SliderMeshConstructor::__get__meshFilter() const {
return ::cordl_internals::getInstanceField<::UnityEngine::MeshFilter, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::SliderMeshConstructor::__set_reusableVerts(::ArrayW<::UnityEngine::Vector3> value)  {
...
constexpr ::ArrayW<::UnityEngine::Vector3> ::GlobalNamespace::SliderMeshConstructor::__get_reusableVerts() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Vector3>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::SliderMeshConstructor::__set_reusableUvs(::ArrayW<::UnityEngine::Vector2> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::Vector2>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::Vector2>>(value));
}
constexpr ::ArrayW<::UnityEngine::Vector2> ::GlobalNamespace::SliderMeshConstructor::__get_reusableUvs() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Vector2>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::SliderMeshConstructor::__set_reusableNormals(::ArrayW<::UnityEngine::Vector3> value)  {
...
constexpr ::ArrayW<::UnityEngine::Vector3> ::GlobalNamespace::SliderMeshConstructor::__get_reusableNormals() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Vector3>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::SliderMeshConstructor::__set_reusableTriangles(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> ::GlobalNamespace::SliderMeshConstructor::__get_reusableTriangles() const {
...
constexpr ::UnityEngine::Mesh ::GlobalNamespace::SliderMeshConstructor::__get__mesh() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, path);
 ...
 int32_t ::GlobalNamespace::SliderMeshConstructor::GetVertexCount(::GlobalNamespace::VertexPath path)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SliderMeshConstructor>::get(),
                            "GetVertexCount",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method, path);
 ...
 int32_t ::GlobalNamespace::SliderMeshConstructor::GetTrianglesCount(::GlobalNamespace::VertexPath path)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SliderMeshConstructor>::get(),
                            "GetTrianglesCount",
                            std::vector<Il2CppClass*>{},
