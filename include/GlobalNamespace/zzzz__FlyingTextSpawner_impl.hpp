...
constexpr void ::GlobalNamespace::FlyingTextSpawner::__set__flyingTextEffectPool(::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool ::GlobalNamespace::FlyingTextSpawner::__get__flyingTextEffectPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__FlyingTextEffect__Pool, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
