...
constexpr void ::GlobalNamespace::MultiplayerPositionHUDController::__set__initData(::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData ::GlobalNamespace::MultiplayerPositionHUDController::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__CoreGameHUDController__InitData, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
