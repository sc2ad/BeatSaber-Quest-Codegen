...
static UnityEngine::Quaternion op_Implicit_UnityEngine__Quaternion(GlobalNamespace::QuaternionSerializable q) ;

/// @brief Method op_Implicit addr 0x12179ac size 0x2c virtual false final false
static GlobalNamespace::QuaternionSerializable op_Implicit_GlobalNamespace__QuaternionSerializable(UnityEngine::Quaternion q) ;
