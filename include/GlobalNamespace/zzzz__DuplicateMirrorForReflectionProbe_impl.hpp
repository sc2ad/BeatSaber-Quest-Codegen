...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::DuplicateMirrorForReflectionProbe::*)()>(&GlobalNamespace::DuplicateMirrorForReflectionProbe::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x219c42c;
 ...
 GlobalNamespace::DuplicateMirrorForReflectionProbe GlobalNamespace::DuplicateMirrorForReflectionProbe::New_ctor()  {
GlobalNamespace::DuplicateMirrorForReflectionProbe o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::DuplicateMirrorForReflectionProbe>())};
return o;
}
