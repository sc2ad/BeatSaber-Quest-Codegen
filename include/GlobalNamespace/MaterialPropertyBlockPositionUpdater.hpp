...
namespace GlobalNamespace {
  ...
  class MaterialPropertyBlockPositionUpdater : public GlobalNamespace::MaterialPropertyBlockAnimator {
    ...
    // Creating value type constructor for type: MaterialPropertyBlockPositionUpdater
    MaterialPropertyBlockPositionUpdater(UnityEngine::Transform* targetTransform_ = {}) noexcept : targetTransform{targetTransform_} {}
