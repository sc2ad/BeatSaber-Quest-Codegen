...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AppInit::$StartCoroutine$d__7), 40 + sizeof(GlobalNamespace::AppInit::AppStartType) + 8 - (40 + sizeof(GlobalNamespace::AppInit::AppStartType)) % 8> __GlobalNamespace_AppInit_$StartCoroutine$d__7SizeCheck;
}
