...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerPositionHUDController), 80 + sizeof(int) + ((80 + sizeof(int)) % 8 != 0 ? (8 - (80 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MultiplayerPositionHUDControllerSizeCheck;
}
