...
namespace GlobalNamespace {
  ...
  class BeatmapDataLoader::BpmTimeProcessor : public ::Il2CppObject/*, public ::GlobalNamespace::IBeatToTimeConvertor*/ {
    ...
    // Creating conversion operator: operator ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDataLoader::BpmTimeProcessor::BpmChangeData>*
    constexpr operator ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDataLoader::BpmTimeProcessor::BpmChangeData>*() const noexcept {
      return bpmChangeDataList;
    }
    ...
    ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDataLoader::BpmTimeProcessor::BpmChangeData>*& dyn__bpmChangeDataList();
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatmapDataLoader::BpmTimeProcessor), 16 + sizeof(::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDataLoader::BpmTimeProcessor::BpmChangeData>*)> __GlobalNamespace_BeatmapDataLoader_BpmTimeProcessorSizeCheck;
  static_assert(sizeof(BeatmapDataLoader::BpmTimeProcessor) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
