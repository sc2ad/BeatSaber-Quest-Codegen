...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::*)(int32_t, float_t)>(&GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x21082fc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>::get(),
                            ".ctor",
...
constexpr GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue(int32_t multiplier, float_t time) noexcept : ::bs_hook::ValueTypeWrapper() {this->multiplier = multiplier;
this->time = time;
}
constexpr void GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::__set_multiplier(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::__get_multiplier() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::__set_time(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::__get_time() const {
return ::cordl_internals::getInstanceField<float_t, 0x4>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue::_ctor(int32_t multiplier, float_t time)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue> (GlobalNamespace::MultiplierValuesRecorder::*)()>(&GlobalNamespace::MultiplierValuesRecorder::get_multiplierValues)> {
...
constexpr void GlobalNamespace::MultiplierValuesRecorder::__set__multiplierValues(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue> GlobalNamespace::MultiplierValuesRecorder::__get__multiplierValues() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
 System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue> GlobalNamespace::MultiplierValuesRecorder::get_multiplierValues()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MultiplierValuesRecorder>::get(),
                            "get_multiplierValues",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__MultiplierValuesRecorder__MultiplierValue>, false>(const_cast<void*>(instance), ___internal_method);
}
