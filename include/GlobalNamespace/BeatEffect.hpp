...
namespace GlobalNamespace {
  ...
  check_size<sizeof(BeatEffect), 96 + sizeof(UnityEngine::Color) + ((96 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (96 + sizeof(UnityEngine::Color)) % 8) : 0)> __GlobalNamespace_BeatEffectSizeCheck;
}
