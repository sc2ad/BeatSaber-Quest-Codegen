...
namespace GlobalNamespace {
  ...
  struct StandardLevelDetailViewController::$OpenLevelPackProductStoreAsync$d__51 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
