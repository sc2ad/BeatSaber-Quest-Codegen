...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::BoundaryTestResult), 20 + sizeof(GlobalNamespace::OVRPlugin::Vector3f) + ((20 + sizeof(GlobalNamespace::OVRPlugin::Vector3f)) % 8 != 0 ? (8 - (20 + sizeof(GlobalNamespace::OVRPlugin::Vector3f)) % 8) : 0)> __GlobalNamespace_OVRPlugin_BoundaryTestResultSizeCheck;
}
