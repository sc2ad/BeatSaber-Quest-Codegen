...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)(::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType, ByRef<::GlobalNamespace::NoteDebris>, ByRef<::GlobalNamespace::NoteDebris>)>(&::GlobalNamespace::NoteDebrisSpawner::SpawnNoteDebris)> {
...
constexpr void ::GlobalNamespace::NoteDebrisSpawner::__set__normalNotesDebrisPool(::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool ::GlobalNamespace::NoteDebrisSpawner::__get__normalNotesDebrisPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::NoteDebrisSpawner::__set__burstSliderHeadNotesDebrisPool(::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool ::GlobalNamespace::NoteDebrisSpawner::__get__burstSliderHeadNotesDebrisPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::NoteDebrisSpawner::__set__burstSliderElementNotesDebrisPool(::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool ::GlobalNamespace::NoteDebrisSpawner::__get__burstSliderElementNotesDebrisPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::NoteDebrisSpawner::__set__poolForNoteGameplayType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>>(value));
}
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool> ::GlobalNamespace::NoteDebrisSpawner::__get__poolForNoteGameplayType() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::NoteDebrisSpawner::__set__poolForNoteDebris(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>>(value));
}
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool> ::GlobalNamespace::NoteDebrisSpawner::__get__poolForNoteDebris() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris,::GlobalNamespace::____GlobalNamespace__NoteDebris__Pool>, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, noteDebris);
 ...
 void ::GlobalNamespace::NoteDebrisSpawner::SpawnNoteDebris(::GlobalNamespace::____GlobalNamespace__NoteData__GameplayType noteGameplayType, ByRef<::GlobalNamespace::NoteDebris> debris0, ByRef<::GlobalNamespace::NoteDebris> debris1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteDebrisSpawner>::get(),
                            "SpawnNoteDebris",
                            std::vector<Il2CppClass*>{},
