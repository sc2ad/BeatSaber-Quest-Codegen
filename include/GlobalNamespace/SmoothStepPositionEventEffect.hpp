...
namespace GlobalNamespace {
  ...
  class SmoothStepPositionEventEffect : public UnityEngine::MonoBehaviour {
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::Vector3) == 0xC);
    // Creating value type constructor for type: SmoothStepPositionEventEffect
    SmoothStepPositionEventEffect(GlobalNamespace::BeatmapEventType event_ = {}, bool clampValue_ = {}, int eventValueMin_ = {}, int eventValueMax_ = {}, UnityEngine::Vector3 movementVector_ = {}, float stepSize_ = {}, GlobalNamespace::IBeatmapObjectCallbackController* beatmapObjectCallbackController_ = {}, Tweening::SongTimeTweeningManager* tweeningManager_ = {}, Tweening::Vector3Tween* positionTween_ = {}, UnityEngine::Transform* transform_ = {}, UnityEngine::Vector3 startPos_ = {}) noexcept : event{event_}, clampValue{clampValue_}, eventValueMin{eventValueMin_}, eventValueMax{eventValueMax_}, movementVector{movementVector_}, stepSize{stepSize_}, beatmapObjectCallbackController{beatmapObjectCallbackController_}, tweeningManager{tweeningManager_}, positionTween{positionTween_}, transform{transform_}, startPos{startPos_} {}
