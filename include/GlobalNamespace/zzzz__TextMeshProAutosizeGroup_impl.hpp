...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::TextMeshProAutosizeGroup GlobalNamespace::TextMeshProAutosizeGroup::New_ctor()  {
GlobalNamespace::TextMeshProAutosizeGroup o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::TextMeshProAutosizeGroup>())};
return o;
}
