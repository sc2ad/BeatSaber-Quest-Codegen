...
namespace GlobalNamespace {
  ...
  check_size<sizeof(FlyingScoreSpawner::SpawnPosition), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_FlyingScoreSpawner_SpawnPositionSizeCheck;
}
