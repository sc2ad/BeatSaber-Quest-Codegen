...
namespace GlobalNamespace {
  ...
  class LocalLeaderboardsModel : public ::GlobalNamespace::PersistentScriptableObject {
    ...
    // Nested type: ::GlobalNamespace::LocalLeaderboardsModel::$$c
    class $$c;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    // static private System.Void AppendLeaderboardScores(System.Collections.Generic.List`1<LocalLeaderboardsModel/ScoreData> main, System.Collections.Generic.List`1<LocalLeaderboardsModel/ScoreData> tail, System.Int32 maxNumberOfScores)
    // Offset: 0x15264AC
    static void AppendLeaderboardScores(::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::ScoreData*>* main, ::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::ScoreData*>* tail, int maxNumberOfScores);
    // static public System.Void MigrateQuestLeaderboards(System.Collections.Generic.List`1<LocalLeaderboardsModel/LeaderboardData> leaderboardDataList, System.Int32 maxNumberOfScores)
    // Offset: 0x1526600
    static void MigrateQuestLeaderboards(::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::LeaderboardData*>* leaderboardDataList, int maxNumberOfScores);
...
// Writing MetadataGetter for method: GlobalNamespace::LocalLeaderboardsModel::AppendLeaderboardScores
// Il2CppName: AppendLeaderboardScores
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::ScoreData*>*, ::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::ScoreData*>*, int)>(&GlobalNamespace::LocalLeaderboardsModel::AppendLeaderboardScores)> {
  static const MethodInfo* get() {
    static auto* main = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("", "LocalLeaderboardsModel/ScoreData")})->byval_arg;
    static auto* tail = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("", "LocalLeaderboardsModel/ScoreData")})->byval_arg;
    static auto* maxNumberOfScores = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LocalLeaderboardsModel*), "AppendLeaderboardScores", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{main, tail, maxNumberOfScores});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::LocalLeaderboardsModel::MigrateQuestLeaderboards
// Il2CppName: MigrateQuestLeaderboards
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::System::Collections::Generic::List_1<::GlobalNamespace::LocalLeaderboardsModel::LeaderboardData*>*, int)>(&GlobalNamespace::LocalLeaderboardsModel::MigrateQuestLeaderboards)> {
  static const MethodInfo* get() {
    static auto* leaderboardDataList = &::il2cpp_utils::MakeGeneric(::il2cpp_utils::GetClassFromName("System.Collections.Generic", "List`1"), ::std::vector<const Il2CppClass*>{::il2cpp_utils::GetClassFromName("", "LocalLeaderboardsModel/LeaderboardData")})->byval_arg;
    static auto* maxNumberOfScores = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LocalLeaderboardsModel*), "MigrateQuestLeaderboards", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{leaderboardDataList, maxNumberOfScores});
  }
};
