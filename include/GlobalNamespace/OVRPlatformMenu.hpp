...
namespace GlobalNamespace {
  ...
  class OVRPlatformMenu : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVRPlatformMenu::eHandler), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_OVRPlatformMenu_eHandlerSizeCheck;
  ...
  check_size<sizeof(OVRPlatformMenu), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_OVRPlatformMenuSizeCheck;
}
