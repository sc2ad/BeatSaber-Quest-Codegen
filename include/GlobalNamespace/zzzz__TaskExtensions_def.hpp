...
class GlobalNamespace__TaskExtensions____c__DisplayClass0_0_1<T>;
}
namespace GlobalNamespace {
template<>
class GlobalNamespace__TaskExtensions____c__DisplayClass0_0_1<bool>;
}
namespace GlobalNamespace {
...
namespace GlobalNamespace {
template<::cordl_internals::il2cpp_reference_type T>
struct GlobalNamespace__TaskExtensions___WaitForTask_d__1_1<T>;
}
namespace GlobalNamespace {
template<>
struct GlobalNamespace__TaskExtensions___WaitForTask_d__1_1<bool>;
}
...
// Declarations
template<typename T>
using _WaitForTask_d__1_1 = GlobalNamespace::GlobalNamespace__TaskExtensions___WaitForTask_d__1_1<T>;

template<typename T>
using __c__DisplayClass0_0_1 = GlobalNamespace::GlobalNamespace__TaskExtensions____c__DisplayClass0_0_1<T>;
...
// CS Name: TaskExtensions::<>c__DisplayClass0_0`1
class CORDL_TYPE GlobalNamespace__TaskExtensions____c__DisplayClass0_0_1<bool> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(GlobalNamespace::GlobalNamespace__TaskExtensions____c__DisplayClass0_0_1, "", "TaskExtensions/<>c__DisplayClass0_0`1");
NEED_NO_BOX(GlobalNamespace::TaskExtensions);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::TaskExtensions, "", "TaskExtensions");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(GlobalNamespace::GlobalNamespace__TaskExtensions___WaitForTask_d__1_1, "", "TaskExtensions/<WaitForTask>d__1`1");
