...
namespace GlobalNamespace {
  ...
  class BombExecutionRating : public GlobalNamespace::BeatmapObjectExecutionRating {
    ...
    check_size<sizeof(BombExecutionRating::Rating), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_BombExecutionRating_RatingSizeCheck;
  ...
  check_size<sizeof(BombExecutionRating), 24 + sizeof(GlobalNamespace::BombExecutionRating::Rating) + ((24 + sizeof(GlobalNamespace::BombExecutionRating::Rating)) % 8 != 0 ? (8 - (24 + sizeof(GlobalNamespace::BombExecutionRating::Rating)) % 8) : 0)> __GlobalNamespace_BombExecutionRatingSizeCheck;
}
