...
namespace GlobalNamespace {
  ...
  class BombExecutionRating : public ::GlobalNamespace::BeatmapObjectExecutionRating {
    ...
    public:
    // private readonly BombExecutionRating/Rating <rating>k__BackingField
    // Size: 0x4
    // Offset: 0x14
  ...
  #pragma pack(pop)
  static check_size<sizeof(BombExecutionRating), 20 + sizeof(::GlobalNamespace::BombExecutionRating::Rating)> __GlobalNamespace_BombExecutionRatingSizeCheck;
  static_assert(sizeof(BombExecutionRating) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
