...
namespace GlobalNamespace {
  ...
  class EulaDisplayViewController : public HMUI::ViewController {
    ...
    // Creating value type constructor for type: EulaDisplayViewController
    EulaDisplayViewController(HMUI::TextPageScrollView* textPageScrollView_ = {}, GlobalNamespace::LocalizedTextAsset* localizedTextAsset_ = {}) noexcept : textPageScrollView{textPageScrollView_}, localizedTextAsset{localizedTextAsset_} {}
