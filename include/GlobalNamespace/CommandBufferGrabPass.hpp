...
namespace GlobalNamespace {
  ...
  // [] Offset: FFFFFFFF
  // [ExecuteInEditMode] Offset: D0D050
  class CommandBufferGrabPass : public GlobalNamespace::CommandBufferGOCore {
    ...
    // Base method: UnityEngine.Rendering.CommandBuffer CommandBufferGOCore::CreateCommandBuffer_NEW(UnityEngine.Camera camera)
    ...
    // Offset: 0x20F8E5C
    // Implemented from: CommandBufferGOCore
    // Base method: System.Collections.Generic.Dictionary`2<UnityEngine.Camera,CommandBufferOwners> CommandBufferGOCore::CamerasDict_NEW()
    ...
    // Offset: 0x20F8EC4
    // Implemented from: CommandBufferGOCore
    // Base method: UnityEngine.Rendering.CameraEvent CommandBufferGOCore::CommandBufferCameraEvent_NEW()
