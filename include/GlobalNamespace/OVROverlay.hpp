...
namespace GlobalNamespace {
  ...
  class OVROverlay : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(OVROverlay::OverlayShape), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVROverlay_OverlayShapeSizeCheck;
    ...
    check_size<sizeof(OVROverlay::OverlayType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_OVROverlay_OverlayTypeSizeCheck;
  ...
  check_size<sizeof(OVROverlay), 412 + sizeof(bool) + 8 - (412 + sizeof(bool)) % 8> __GlobalNamespace_OVROverlaySizeCheck;
}
