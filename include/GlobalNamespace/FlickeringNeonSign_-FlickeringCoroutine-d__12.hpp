...
namespace GlobalNamespace {
  ...
  check_size<sizeof(FlickeringNeonSign::$FlickeringCoroutine$d__12), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __GlobalNamespace_FlickeringNeonSign_$FlickeringCoroutine$d__12SizeCheck;
}
