...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: OculusPlatformLeaderboardsHandler
...
namespace GlobalNamespace {
  ...
  class OculusPlatformLeaderboardsHandler : public ::GlobalNamespace::PlatformLeaderboardsHandler {
    ...
    class $$c;
    // Nested type: ::GlobalNamespace::OculusPlatformLeaderboardsHandler::$$c__DisplayClass4_0
    class $$c__DisplayClass4_0;
    // Nested type: ::GlobalNamespace::OculusPlatformLeaderboardsHandler::$$c__DisplayClass6_0
    class $$c__DisplayClass6_0;
    // Nested type: ::GlobalNamespace::OculusPlatformLeaderboardsHandler::$$c__DisplayClass7_0
    ...
    // private LeaderboardIdsModelSO _leaderboardIdsModel
    // Size: 0x8
    // Offset: 0x20
    ::GlobalNamespace::LeaderboardIdsModelSO* leaderboardIdsModel;
    // Field size check
    ...
    // Get instance field reference: private LeaderboardIdsModelSO _leaderboardIdsModel
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::LeaderboardIdsModelSO*& dyn__leaderboardIdsModel();
    // public System.Void .ctor(LeaderboardIdsModelSO leaderboardIdsModel)
    // Offset: 0x1345D80
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static OculusPlatformLeaderboardsHandler* New_ctor(::GlobalNamespace::LeaderboardIdsModelSO* leaderboardIdsModel) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::OculusPlatformLeaderboardsHandler::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<OculusPlatformLeaderboardsHandler*, creationType>(leaderboardIdsModel)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(OculusPlatformLeaderboardsHandler), 32 + sizeof(::GlobalNamespace::LeaderboardIdsModelSO*)> __GlobalNamespace_OculusPlatformLeaderboardsHandlerSizeCheck;
  static_assert(sizeof(OculusPlatformLeaderboardsHandler) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::HMAsyncRequest* (GlobalNamespace::OculusPlatformLeaderboardsHandler::*)(::GlobalNamespace::IDifficultyBeatmap*, int, int, ::GlobalNamespace::PlatformLeaderboardsModel::ScoresScope, ::StringW, ::GlobalNamespace::PlatformLeaderboardsModel::GetScoresCompletionHandler*)>(&GlobalNamespace::OculusPlatformLeaderboardsHandler::GetScores)> {
  static const MethodInfo* get() {
