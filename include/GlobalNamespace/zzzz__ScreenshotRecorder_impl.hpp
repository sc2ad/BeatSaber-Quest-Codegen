...
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::GlobalNamespace__ScreenshotRecorder__RecordingType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::Sequence{0};
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::Stereo360Sequence{1};
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::Mono360Sequence{2};
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::F10ForScreenshot{3};
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::Interval{4};
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType  GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType::ScreenshotOnPause{5};
...
constexpr void GlobalNamespace::ScreenshotRecorder::__set__recordingType(GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType GlobalNamespace::ScreenshotRecorder::__get__recordingType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__ScreenshotRecorder__RecordingType, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
