...
// Ctor Parameters [CppParam { name: "maxCenterDistanceCutScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minBeforeCutScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxBeforeCutScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minAfterCutScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "maxAfterCutScore", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fixedCutScore", ty: "int32_t", modifiers: "", def_value: None }]
 GlobalNamespace::GlobalNamespace__ScoreModel__NoteScoreDefinition::GlobalNamespace__ScoreModel__NoteScoreDefinition(int32_t maxCenterDistanceCutScore, int32_t minBeforeCutScore, int32_t maxBeforeCutScore, int32_t minAfterCutScore, int32_t maxAfterCutScore, int32_t fixedCutScore)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace__ScoreModel__NoteScoreDefinition>(maxCenterDistanceCutScore, minBeforeCutScore, maxBeforeCutScore, minAfterCutScore, maxAfterCutScore, fixedCutScore))) {}
...
// Ctor Parameters [CppParam { name: "scoringType", ty: "GlobalNamespace::GlobalNamespace__NoteData__ScoringType", modifiers: "", def_value: None }, CppParam { name: "time", ty: "float_t", modifiers: "", def_value: None }]
 GlobalNamespace::GlobalNamespace__ScoreModel__MaxScoreCounterElement::GlobalNamespace__ScoreModel__MaxScoreCounterElement(GlobalNamespace::GlobalNamespace__NoteData__ScoringType scoringType, float_t time)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace__ScoreModel__MaxScoreCounterElement>(scoringType, time))) {}
