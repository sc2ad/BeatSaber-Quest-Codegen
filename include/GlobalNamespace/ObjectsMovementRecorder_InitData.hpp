...
namespace GlobalNamespace {
  ...
  class ObjectsMovementRecorder::InitData : public ::Il2CppObject {
    ...
    static ObjectsMovementRecorder::InitData* New_ctor(::GlobalNamespace::ObjectsMovementRecorder::Mode mode, ::StringW recordingPath, ::GlobalNamespace::ObjectsMovementRecorder::CameraView cameraView, bool addDateTimeSuffixToRecordingName, bool screenshotRecording, int screenshotWidth, int screenshotHeight, int framerate, ::ArrayW<::GlobalNamespace::PlaybackRenderer::PlaybackScreenshot*> playbackScreenshots) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<ObjectsMovementRecorder::InitData*, creationType>(mode, recordingPath, cameraView, addDateTimeSuffixToRecordingName, screenshotRecording, screenshotWidth, screenshotHeight, framerate, playbackScreenshots)));
    }
  }; // ObjectsMovementRecorder/InitData
  #pragma pack(pop)
  static check_size<sizeof(ObjectsMovementRecorder::InitData), 56 + sizeof(::ArrayW<::GlobalNamespace::PlaybackRenderer::PlaybackScreenshot*>)> __GlobalNamespace_ObjectsMovementRecorder_InitDataSizeCheck;
  static_assert(sizeof(ObjectsMovementRecorder::InitData) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
