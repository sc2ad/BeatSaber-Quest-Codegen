...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ObstacleSpawnInfoNetSerializable (*)()>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::Obtain)> {
  ...
  constexpr static std::size_t addrs = 0x1218148;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ObstacleSpawnInfoNetSerializable (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)(float_t, int32_t, ::GlobalNamespace::NoteLineLayer, float_t, int32_t, int32_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, float_t, float_t, float_t, float_t)>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::Init)> {
  ...
  constexpr static std::size_t addrs = 0x12181ac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)()>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x12182cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataWriter)>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::Serialize)> {
  ...
  constexpr static std::size_t addrs = 0x1218324;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::GlobalNamespace::ObstacleSpawnInfoNetSerializable),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ObstacleSpawnInfoNetSerializable>::get(),
                                  10
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)(::LiteNetLib::Utils::NetDataReader)>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::Deserialize)> {
  ...
  constexpr static std::size_t addrs = 0x1218428;
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_time() const {
...
constexpr int32_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_lineIndex() const {
...
constexpr ::GlobalNamespace::NoteLineLayer ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_lineLayer() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_duration() const {
...
constexpr int32_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_width() const {
...
constexpr int32_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_height() const {
...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3Serializable, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::Vector3Serializable>(value));
}
constexpr ::GlobalNamespace::Vector3Serializable ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_moveStartPos() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3Serializable, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::Vector3Serializable>(value));
}
constexpr ::GlobalNamespace::Vector3Serializable ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_moveEndPos() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::GlobalNamespace::Vector3Serializable ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_jumpEndPos() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_obstacleHeight() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_moveDuration() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_jumpDuration() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_noteLinesDistance() const {
...
constexpr float_t ::GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_rotation() const {
