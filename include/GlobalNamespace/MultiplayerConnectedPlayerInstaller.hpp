...
namespace GlobalNamespace {
  ...
  class MultiplayerConnectedPlayerInstaller : public Zenject::MonoInstaller {
    ...
    // [SpaceAttribute] Offset: 0xD3ACC8
    ...
    // [InjectAttribute] Offset: 0xD3AD20
    ...
    // [InjectAttribute] Offset: 0xD3AD30
    ...
    char __padding6[0x4] = {};
    // [InjectAttribute] Offset: 0xD3AD40
  ...
  #pragma pack(pop)
  static check_size<sizeof(MultiplayerConnectedPlayerInstaller), 88 + sizeof(GlobalNamespace::GameplayCoreSceneSetupData*)> __GlobalNamespace_MultiplayerConnectedPlayerInstallerSizeCheck;
  static_assert(sizeof(MultiplayerConnectedPlayerInstaller) == 0x60);
}
