...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LobbyGameStateController), 204 + sizeof(bool) + ((204 + sizeof(bool)) % 8 != 0 ? (8 - (204 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_LobbyGameStateControllerSizeCheck;
}
