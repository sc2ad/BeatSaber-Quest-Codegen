...
namespace GlobalNamespace {
  ...
  class MissionLevelGameplayManager : public UnityEngine::MonoBehaviour/*, public GlobalNamespace::ILevelEndActions*/ {
    ...
    check_size<sizeof(MissionLevelGameplayManager::GameState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __GlobalNamespace_MissionLevelGameplayManager_GameStateSizeCheck;
  ...
  check_size<sizeof(MissionLevelGameplayManager), 80 + sizeof(GlobalNamespace::MissionLevelGameplayManager::GameState) + ((80 + sizeof(GlobalNamespace::MissionLevelGameplayManager::GameState)) % 8 != 0 ? (8 - (80 + sizeof(GlobalNamespace::MissionLevelGameplayManager::GameState)) % 8) : 0)> __GlobalNamespace_MissionLevelGameplayManagerSizeCheck;
}
