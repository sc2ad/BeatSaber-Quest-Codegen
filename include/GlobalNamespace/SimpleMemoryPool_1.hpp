...
namespace GlobalNamespace {
  ...
  class SimpleMemoryPool_1 : public ::Il2CppObject {
    ...
    // Creating value type constructor for type: SimpleMemoryPool_1
    SimpleMemoryPool_1(GlobalNamespace::LazyCopyHashSet_1<T>* activeElements_ = {}, System::Collections::Generic::List_1<T>* inactiveElements_ = {}, System::Func_1<T>* createNewItemFunc_ = {}) noexcept : activeElements{activeElements_}, inactiveElements{inactiveElements_}, createNewItemFunc{createNewItemFunc_} {}
