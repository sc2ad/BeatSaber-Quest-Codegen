...
namespace GlobalNamespace {
  ...
  class SimpleMemoryPool_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::LazyCopyHashSet_1<T>*& dyn__activeElements() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<T>*& dyn__inactiveElements() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Func_1<T>*& dyn__createNewItemFunc() {
