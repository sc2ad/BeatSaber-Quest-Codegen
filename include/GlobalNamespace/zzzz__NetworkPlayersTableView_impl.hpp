...
constexpr void GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType  GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType::Header{0};
constexpr GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType  GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType::Player{1};
constexpr GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType  GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType::Options{2};
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::*)()>(&GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::_ctor)> {
...
constexpr void GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__set_type(GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__get_type() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo__CellType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__set_headerString(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__get_headerString() const {
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__set_player(GlobalNamespace::INetworkPlayer value)  {
...
constexpr GlobalNamespace::INetworkPlayer GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__get_player() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::INetworkPlayer, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo::__set_lastCellInParty(bool value)  {
...
constexpr  GlobalNamespace::NetworkPlayersTableView::operator HMUI::HMUI__TableView__IDataSource() const noexcept {
...
constexpr void GlobalNamespace::NetworkPlayersTableView::__set__cellInfo(System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo> value)  {
::cordl_internals::setInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo>>(value));
}
constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo> GlobalNamespace::NetworkPlayersTableView::__get__cellInfo() const {
return ::cordl_internals::getInstanceField<System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__NetworkPlayersTableView__CellInfo>, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
