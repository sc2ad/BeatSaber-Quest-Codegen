...
namespace GlobalNamespace {
  ...
  class ParticleSystemEmitterEventEffect : public UnityEngine::MonoBehaviour {
    ...
    // [InjectAttribute] Offset: 0xF3B710
    ...
    ParticleSystemEmitterEventEffect(GlobalNamespace::BeatmapEventType beatmapEvent_ = {}, ::Array<UnityEngine::ParticleSystem*>* particleSystems_ = {}, GlobalNamespace::IBeatmapObjectCallbackController* beatmapObjectCallbackController_ = {}) noexcept : beatmapEvent{beatmapEvent_}, particleSystems{particleSystems_}, beatmapObjectCallbackController{beatmapObjectCallbackController_} {}
