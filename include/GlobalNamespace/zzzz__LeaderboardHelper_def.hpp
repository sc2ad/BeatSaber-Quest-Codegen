...
namespace GlobalNamespace {
struct ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2;
}
...
struct CORDL_TYPE ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::StringW leaderboardID, ::StringW appToken, ::System::Net::Http::HttpClient _httpClient_5__2, ::System::Net::Http::HttpRequestMessage _request_5__3, ::System::Collections::Generic::List_1<::StringW> _contentList_5__4, ::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Net::Http::HttpResponseMessage> __u__1) noexcept;


                    constexpr ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2(____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2 const&) = default;
                    constexpr ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2(____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2&&) = default;
                    constexpr ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2& operator=(____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2& operator=(____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _CreateOculusLeaderboard_d__2 = ::GlobalNamespace::____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LeaderboardHelper___CreateOculusLeaderboard_d__2, "", "LeaderboardHelper/<CreateOculusLeaderboard>d__2");
