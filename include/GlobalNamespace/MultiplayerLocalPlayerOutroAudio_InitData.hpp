...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLocalPlayerOutroAudio::InitData), 28 + sizeof(float) + ((28 + sizeof(float)) % 8 != 0 ? (8 - (28 + sizeof(float)) % 8) : 0)> __GlobalNamespace_MultiplayerLocalPlayerOutroAudio_InitDataSizeCheck;
}
