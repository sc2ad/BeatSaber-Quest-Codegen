...
namespace GlobalNamespace {
  ...
  check_size<sizeof(AnnotatedBeatmapLevelCollectionTableCell::$RefreshAvailabilityAsync$d__18), 88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>) + ((88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8 != 0 ? (8 - (88 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AdditionalContentModel::EntitlementStatus>)) % 8) : 0)> __GlobalNamespace_AnnotatedBeatmapLevelCollectionTableCell_$RefreshAvailabilityAsync$d__18SizeCheck;
}
