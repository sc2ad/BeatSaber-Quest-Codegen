...
namespace GlobalNamespace {
  ...
  class RemoteProcedureCall_1 : public GlobalNamespace::RemoteProcedureCall {
    ...
    GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T0> _get__value0() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_1::_get__value0");
    ...
    void _set__value0(GlobalNamespace::RemoteProcedureCall::TypeWrapper_1<T0> value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::RemoteProcedureCall_1::_set__value0");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_value0"))->offset;
