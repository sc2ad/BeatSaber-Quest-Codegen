...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ConnectedPlayerManager::PlayerConnectedPacket), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __GlobalNamespace_ConnectedPlayerManager_PlayerConnectedPacketSizeCheck;
}
