...
namespace GlobalNamespace {
  ...
  check_size<sizeof(ConnectedPlayerManager::PlayerConnectedPacket), 40 + sizeof(bool) + 8 - (40 + sizeof(bool)) % 8> __GlobalNamespace_ConnectedPlayerManager_PlayerConnectedPacketSizeCheck;
}
