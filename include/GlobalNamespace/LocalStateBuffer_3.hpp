...
namespace GlobalNamespace {
  ...
  class LocalStateBuffer_3 : public ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState> {
    ...
    [[deprecated("Use field access instead!")]] typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable& dyn__current() {
    ...
    [[deprecated("Use field access instead!")]] float& dyn__fullStateUpdateFrequency() {
    ...
    [[deprecated("Use field access instead!")]] float& dyn__deltaUpdateFrequency() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn__sentStateIndex() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn__sentDeltaIndex() {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__sentStates() {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__sentDeltas() {
    ...
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::SyncStateId& dyn__lastSentSyncStateId() {
