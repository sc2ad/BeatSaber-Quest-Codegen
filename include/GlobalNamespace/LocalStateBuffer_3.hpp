...
namespace GlobalNamespace {
  ...
  class LocalStateBuffer_3 : public GlobalNamespace::StateBuffer_3<TStateTable, TType, TState> {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable> sentStates;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>) == 0x8);
    // private readonly StateBuffer`3/TimestampedStateTable<TStateTable,TType,TState>[] _sentDeltas
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable> sentDeltas;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>) == 0x8);
    ...
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__sentStates() {
      ...
      return *reinterpret_cast<::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
    // Get instance field: private readonly StateBuffer`3/TimestampedStateTable<TStateTable,TType,TState>[] _sentDeltas
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__sentDeltas() {
