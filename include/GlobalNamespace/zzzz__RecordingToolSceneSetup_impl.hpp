...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::RecordingToolSceneSetup GlobalNamespace::RecordingToolSceneSetup::New_ctor()  {
GlobalNamespace::RecordingToolSceneSetup o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::RecordingToolSceneSetup>())};
return o;
}
