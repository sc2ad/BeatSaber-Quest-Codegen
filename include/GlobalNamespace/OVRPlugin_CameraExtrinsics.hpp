...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::CameraExtrinsics), 24 + sizeof(GlobalNamespace::OVRPlugin::Posef) + ((24 + sizeof(GlobalNamespace::OVRPlugin::Posef)) % 8 != 0 ? (8 - (24 + sizeof(GlobalNamespace::OVRPlugin::Posef)) % 8) : 0)> __GlobalNamespace_OVRPlugin_CameraExtrinsicsSizeCheck;
}
