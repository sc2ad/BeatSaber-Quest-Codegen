...
namespace GlobalNamespace {
class ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection;
}
namespace GlobalNamespace {
struct ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30;
}
...
class CORDL_TYPE ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection() = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection", modifiers: " const&", def_value: None }]
constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection(____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection", modifiers: "&&", def_value: None }]
constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection(____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection& operator=(____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection&& o) noexcept = default;
  constexpr ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection& operator=(____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection const& o) noexcept = default;
...
explicit ____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection(::GlobalNamespace::IBeatmapLevelCollection beatmapLevelCollection) ;
...
struct CORDL_TYPE ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, ::GlobalNamespace::LevelSearchViewController __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevelCollection> __u__1) noexcept;


                    constexpr ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30(____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30 const&) = default;
                    constexpr ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30(____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30&&) = default;
                    constexpr ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30& operator=(____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30& operator=(____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _UpdateBeatmapLevelPackCollectionAsync_d__30 = ::GlobalNamespace::____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30;

using BeatmapLevelPackCollection = ::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection;
...
constexpr ::System::Action_1<::GlobalNamespace::LevelSearchViewController> __get_didStartLoadingEvent() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection __declspec(property(get=__get__beatmapLevelPackCollection, put=__set__beatmapLevelPackCollection))  _beatmapLevelPackCollection;

constexpr void __set__beatmapLevelPackCollection(::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection __get__beatmapLevelPackCollection() const;
...
NEED_NO_BOX(::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelSearchViewController__BeatmapLevelPackCollection, "", "LevelSearchViewController/BeatmapLevelPackCollection");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__LevelSearchViewController___UpdateBeatmapLevelPackCollectionAsync_d__30, "", "LevelSearchViewController/<UpdateBeatmapLevelPackCollectionAsync>d__30");
