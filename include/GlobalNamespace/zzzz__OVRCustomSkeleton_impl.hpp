...
constexpr ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType::____GlobalNamespace__OVRCustomSkeleton__RetargetingType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType  ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType::OculusSkeleton{0};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Transform (::GlobalNamespace::OVRCustomSkeleton::*)(::GlobalNamespace::____GlobalNamespace__OVRSkeleton__BoneId)>(&::GlobalNamespace::OVRCustomSkeleton::GetBoneTransform)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OVRCustomSkeleton::*)(::GlobalNamespace::____GlobalNamespace__OVRSkeleton__SkeletonType)>(&::GlobalNamespace::OVRCustomSkeleton::SetSkeletonType)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "SetSkeletonType",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__OVRSkeleton__SkeletonType>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::GlobalNamespace::OVRCustomSkeleton::__set_retargetingType(::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType, 0xc0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType ::GlobalNamespace::OVRCustomSkeleton::__get_retargetingType() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__OVRCustomSkeleton__RetargetingType, 0xc0>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::System::Collections::Generic::List_1<::UnityEngine::Transform>, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::UnityEngine::Transform ::GlobalNamespace::OVRCustomSkeleton::GetBoneTransform(::GlobalNamespace::____GlobalNamespace__OVRSkeleton__BoneId boneId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRCustomSkeleton>::get(),
                            "GetBoneTransform",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::GlobalNamespace::OVRCustomSkeleton::SetSkeletonType(::GlobalNamespace::____GlobalNamespace__OVRSkeleton__SkeletonType skeletonType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRCustomSkeleton>::get(),
                            "SetSkeletonType",
                            std::vector<Il2CppClass*>{},
