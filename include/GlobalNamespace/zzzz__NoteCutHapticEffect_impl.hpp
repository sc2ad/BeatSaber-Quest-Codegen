...
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::____GlobalNamespace__NoteCutHapticEffect__Type(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type  ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::Normal{0};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type  ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::ShortNormal{1};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type  ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::ShortWeak{2};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type  ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::Bomb{3};
constexpr ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type  ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type::BadCut{4};
//  Writing Method size for method: ::GlobalNamespace::NoteCutHapticEffect.HitNote
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteCutHapticEffect::*)(::GlobalNamespace::SaberType, ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type)>(&::GlobalNamespace::NoteCutHapticEffect::HitNote)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::SaberType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type>::get()}
                        )));
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::HapticFeedbackManager, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 void ::GlobalNamespace::NoteCutHapticEffect::HitNote(::GlobalNamespace::SaberType saberType, ::GlobalNamespace::____GlobalNamespace__NoteCutHapticEffect__Type type)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteCutHapticEffect>::get(),
                            "HitNote",
                            std::vector<Il2CppClass*>{},
