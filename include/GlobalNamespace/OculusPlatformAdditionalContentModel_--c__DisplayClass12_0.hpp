...
namespace GlobalNamespace {
  ...
  // [CompilerGeneratedAttribute] Offset: EFD384
  class OculusPlatformAdditionalContentModel::$$c__DisplayClass12_0 : public ::Il2CppObject {
    ...
    // Get instance field reference: public Oculus.Platform.Message`1/Callback<Oculus.Platform.Models.PurchaseList> <>9__1
