...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerMockSettings::$get_mockServers$d__21), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_MultiplayerMockSettings_$get_mockServers$d__21SizeCheck;
}
