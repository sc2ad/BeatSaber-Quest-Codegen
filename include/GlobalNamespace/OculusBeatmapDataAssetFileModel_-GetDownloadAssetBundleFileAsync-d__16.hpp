...
namespace GlobalNamespace {
  ...
  struct OculusBeatmapDataAssetFileModel::$GetDownloadAssetBundleFileAsync$d__16 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
