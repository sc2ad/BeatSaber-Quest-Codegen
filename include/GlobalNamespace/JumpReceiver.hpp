...
namespace GlobalNamespace {
  ...
  class JumpReceiver : public UnityEngine::MonoBehaviour/*, public UnityEngine::Playables::INotificationReceiver*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD993F8
    ...
    static JumpReceiver* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("GlobalNamespace").WithContext("JumpReceiver").WithContext(".ctor");
