...
struct ____GlobalNamespace__BezierPath__ControlMode;
}
namespace GlobalNamespace {
class BezierPath;
}
...
struct CORDL_TYPE ____GlobalNamespace__BezierPath__ControlMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____GlobalNamespace__BezierPath__ControlMode(int32_t value__) noexcept;


                    constexpr ____GlobalNamespace__BezierPath__ControlMode(____GlobalNamespace__BezierPath__ControlMode const&) = default;
                    constexpr ____GlobalNamespace__BezierPath__ControlMode(____GlobalNamespace__BezierPath__ControlMode&&) = default;
                    constexpr ____GlobalNamespace__BezierPath__ControlMode& operator=(____GlobalNamespace__BezierPath__ControlMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____GlobalNamespace__BezierPath__ControlMode& operator=(____GlobalNamespace__BezierPath__ControlMode&& o) noexcept {
...
constexpr explicit ____GlobalNamespace__BezierPath__ControlMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______GlobalNamespace__BezierPath__ControlMode_Unwrapped : int32_t {
__Aligned = 0,
__Mirrored = 1,
__Free = 2,
__Automatic = 3,
...
constexpr operator ______GlobalNamespace__BezierPath__ControlMode_Unwrapped () const noexcept {
return std::bit_cast<______GlobalNamespace__BezierPath__ControlMode_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode const Aligned;

/// @brief Field Mirrored offset 0
static ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode const Mirrored;

/// @brief Field Free offset 0
static ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode const Free;

/// @brief Field Automatic offset 0
static ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode const Automatic;
...
public:
// Declarations
using ControlMode = ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode;
...
constexpr ::System::Collections::Generic::List_1<::UnityEngine::Vector3> __get__points() const;
 ...
 ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode __declspec(property(get=__get__controlMode, put=__set__controlMode))  _controlMode;

constexpr void __set__controlMode(::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode value) ;

constexpr ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode __get__controlMode() const;
...
// Properties
 ...
 ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode __declspec(property(get=get_controlPointMode, put=set_controlPointMode))  controlPointMode;
...
/// @brief Method get_controlPointMode addr 0x21ace88 size 0x8 virtual false final false
 ::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode get_controlPointMode() ;

/// @brief Method set_controlPointMode addr 0x21ace90 size 0x4c virtual false final false
 void set_controlPointMode(::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::____GlobalNamespace__BezierPath__ControlMode, "", "BezierPath/ControlMode");
