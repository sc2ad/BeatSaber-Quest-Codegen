...
constexpr void ::GlobalNamespace::ParticleSystemLightWithId::__set__mainModule(::UnityEngine::____UnityEngine__ParticleSystem__MainModule value)  {
::cordl_internals::setInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__MainModule, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::UnityEngine::____UnityEngine__ParticleSystem__MainModule>(value));
}
constexpr ::UnityEngine::____UnityEngine__ParticleSystem__MainModule ::GlobalNamespace::ParticleSystemLightWithId::__get__mainModule() const {
return ::cordl_internals::getInstanceField<::UnityEngine::____UnityEngine__ParticleSystem__MainModule, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::GlobalNamespace::ParticleSystemLightWithId::__set__particles(::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle> value)  {
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>>(value));
}
constexpr ::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle> ::GlobalNamespace::ParticleSystemLightWithId::__get__particles() const {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::____UnityEngine__ParticleSystem__Particle>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
