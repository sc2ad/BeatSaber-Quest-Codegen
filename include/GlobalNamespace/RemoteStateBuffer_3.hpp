...
namespace GlobalNamespace {
  ...
  class RemoteStateBuffer_3 : public GlobalNamespace::StateBuffer_3<TStateTable, TType, TState> {
    ...
    void PushState(GlobalNamespace::SyncStateId id, TStateTable state, float time) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "PushState", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(id, state, time)));
    ...
    void PushDelta(GlobalNamespace::SyncStateId baseId, TStateTable delta, float timeOffset) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "PushDelta", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(baseId, delta, timeOffset)));
    ...
    void ProcessQueue() {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "ProcessQueue", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
