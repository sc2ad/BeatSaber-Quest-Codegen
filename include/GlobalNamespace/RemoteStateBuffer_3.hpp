...
namespace GlobalNamespace {
  ...
  class RemoteStateBuffer_3 : public ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState> {
    ...
    // private System.Int32 _receivedStateCount
    // Size: 0x4
    // Offset: 0x0
    int receivedStateCount;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // private System.Int32 _receivedDeltaCount
    // Size: 0x4
    // Offset: 0x0
    int receivedDeltaCount;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    public:
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__receivedStates() {
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<typename ::GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__receivedDeltas() {
    ...
    [[deprecated("Use field access instead!")]] int& dyn__receivedStateIndex() {
    ...
    // Autogenerated instance field getter
    // Get instance field: private System.Int32 _receivedStateCount
    [[deprecated("Use field access instead!")]] int& dyn__receivedStateCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::RemoteStateBuffer_3::dyn__receivedStateCount");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_receivedStateCount"))->offset;
      return *reinterpret_cast<int*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
    // Get instance field: private System.Int32 _receivedDeltaIndex
    [[deprecated("Use field access instead!")]] int& dyn__receivedDeltaIndex() {
    ...
    // Autogenerated instance field getter
    // Get instance field: private System.Int32 _receivedDeltaCount
    [[deprecated("Use field access instead!")]] int& dyn__receivedDeltaCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::RemoteStateBuffer_3::dyn__receivedDeltaCount");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_receivedDeltaCount"))->offset;
      return *reinterpret_cast<int*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    ...
    void PushState(::GlobalNamespace::SyncStateId id, TStateTable state, float time) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, id, state, time);
    }
    ...
    void PushDelta(::GlobalNamespace::SyncStateId baseId, TStateTable delta, float timeOffset) {
      ...
      ::il2cpp_utils::RunMethodRethrow<void, false>(this, ___internal__method, baseId, delta, timeOffset);
    }
    ...
    void Clear() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::RemoteStateBuffer_3::Clear");
