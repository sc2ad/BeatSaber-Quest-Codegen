...
namespace GlobalNamespace {
  ...
  class RemoteStateBuffer_3 : public GlobalNamespace::StateBuffer_3<TStateTable, TType, TState> {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable> receivedStates;
    // Field size check
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable> receivedDeltas;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>) == 0x8);
    ...
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__receivedStates() {
    ...
    ::ArrayWrapper<typename GlobalNamespace::StateBuffer_3<TStateTable, TType, TState>::TimestampedStateTable>& dyn__receivedDeltas() {
