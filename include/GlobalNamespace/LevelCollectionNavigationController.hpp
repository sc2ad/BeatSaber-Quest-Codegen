...
namespace GlobalNamespace {
  ...
  class LevelCollectionNavigationController : public ::HMUI::NavigationController {
    ...
    // [InjectAttribute] Offset: 0x111F76C
    ...
    // [InjectAttribute] Offset: 0x111F7AC
    ...
    // public System.Void SelectLevel(IPreviewBeatmapLevel beatmapLevel, System.Boolean onlyNotOwned)
    // Offset: 0x13FB9B8
    void SelectLevel(::GlobalNamespace::IPreviewBeatmapLevel* beatmapLevel, bool onlyNotOwned);
  ...
  #pragma pack(pop)
  static check_size<sizeof(LevelCollectionNavigationController), 312 + sizeof(bool)> __GlobalNamespace_LevelCollectionNavigationControllerSizeCheck;
  static_assert(sizeof(LevelCollectionNavigationController) == 0x139);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelCollectionNavigationController::*)(::GlobalNamespace::IPreviewBeatmapLevel*, bool)>(&GlobalNamespace::LevelCollectionNavigationController::SelectLevel)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::LevelCollectionNavigationController*), "SelectLevel", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{beatmapLevel, onlyNotOwned});
  }
};
