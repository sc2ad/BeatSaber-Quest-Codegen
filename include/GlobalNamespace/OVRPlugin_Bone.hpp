...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRPlugin::Bone), 8 + sizeof(GlobalNamespace::OVRPlugin::Posef) + ((8 + sizeof(GlobalNamespace::OVRPlugin::Posef)) % 8 != 0 ? (8 - (8 + sizeof(GlobalNamespace::OVRPlugin::Posef)) % 8) : 0)> __GlobalNamespace_OVRPlugin_BoneSizeCheck;
}
