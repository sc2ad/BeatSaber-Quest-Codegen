...
namespace GlobalNamespace {
  ...
  class BeatmapLevelsModel : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(BeatmapLevelsModel::GetBeatmapLevelResult), 8 + sizeof(void*) + 8 - (8 + sizeof(void*)) % 8> __GlobalNamespace_BeatmapLevelsModel_GetBeatmapLevelResultSizeCheck;
    ...
    struct LevelDownloadingUpdate : public System::ValueType {
      ...
      check_size<sizeof(BeatmapLevelsModel::LevelDownloadingUpdate::DownloadingState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __GlobalNamespace_BeatmapLevelsModel_LevelDownloadingUpdate_DownloadingStateSizeCheck;
    ...
    check_size<sizeof(BeatmapLevelsModel::LevelDownloadingUpdate), 16 + sizeof(GlobalNamespace::BeatmapLevelsModel::LevelDownloadingUpdate::DownloadingState) + 8 - (16 + sizeof(GlobalNamespace::BeatmapLevelsModel::LevelDownloadingUpdate::DownloadingState)) % 8> __GlobalNamespace_BeatmapLevelsModel_LevelDownloadingUpdateSizeCheck;
  ...
  check_size<sizeof(BeatmapLevelsModel), 120 + sizeof(void*) + 8 - (120 + sizeof(void*)) % 8> __GlobalNamespace_BeatmapLevelsModelSizeCheck;
}
