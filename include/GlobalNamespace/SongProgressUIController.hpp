...
namespace GlobalNamespace {
  ...
  check_size<sizeof(SongProgressUIController), 104 + sizeof(UnityEngine::Vector2) + ((104 + sizeof(UnityEngine::Vector2)) % 8 != 0 ? (8 - (104 + sizeof(UnityEngine::Vector2)) % 8) : 0)> __GlobalNamespace_SongProgressUIControllerSizeCheck;
}
