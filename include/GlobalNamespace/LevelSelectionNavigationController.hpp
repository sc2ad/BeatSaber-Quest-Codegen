...
namespace GlobalNamespace {
  ...
  check_size<sizeof(LevelSelectionNavigationController), 240 + sizeof(void*) + ((240 + sizeof(void*)) % 8 != 0 ? (8 - (240 + sizeof(void*)) % 8) : 0)> __GlobalNamespace_LevelSelectionNavigationControllerSizeCheck;
}
