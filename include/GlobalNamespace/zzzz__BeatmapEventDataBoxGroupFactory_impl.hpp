...
constexpr ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0(int32_t numberOfElements) noexcept : ::bs_hook::ValueTypeWrapper() {this->numberOfElements = numberOfElements;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__set_numberOfElements(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__get_numberOfElements() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapEventDataBoxGroup (*)(float_t, int32_t, ::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupEvent)>(&::GlobalNamespace::BeatmapEventDataBoxGroupFactory::CreateSingleLightBeatmapEventDataBoxGroup)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupEvent>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IndexFilter (*)(::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupFiltering, ByRef<::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>)>(&::GlobalNamespace::BeatmapEventDataBoxGroupFactory::_CreateSingleLightBeatmapEventDataBoxGroup_g__CreateIndexFilter_2_0)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupFiltering>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::BeatmapEventDataBoxGroup, false>(nullptr, ___internal_method, beat, numberOfElements);
 ...
 ::GlobalNamespace::BeatmapEventDataBoxGroup ::GlobalNamespace::BeatmapEventDataBoxGroupFactory::CreateSingleLightBeatmapEventDataBoxGroup(float_t beat, int32_t numberOfElements, ::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupEvent lightGroupEvent)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventDataBoxGroupFactory>::get(),
                            "CreateSingleLightBeatmapEventDataBoxGroup",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::BeatmapEventDataBoxGroup, false>(nullptr, ___internal_method, beat, numberOfElements, lightGroupEvent);
 ...
 ::GlobalNamespace::IndexFilter ::GlobalNamespace::BeatmapEventDataBoxGroupFactory::_CreateSingleLightBeatmapEventDataBoxGroup_g__CreateIndexFilter_2_0(::GlobalNamespace::____GlobalNamespace__DefaultEnvironmentEvents__LightGroupFiltering filtering, ByRef<::GlobalNamespace::____GlobalNamespace__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0> )  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventDataBoxGroupFactory>::get(),
                            "<CreateSingleLightBeatmapEventDataBoxGroup>g__CreateIndexFilter|2_0",
                            std::vector<Il2CppClass*>{},
