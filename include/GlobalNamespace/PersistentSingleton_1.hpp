...
namespace GlobalNamespace {
  ...
  class PersistentSingleton_1 : public UnityEngine::MonoBehaviour {
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0xD98F08
    // Autogenerated static field getter
    ...
    static void NoDomainReloadInit() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PersistentSingleton_1<T>*>::get(), "NoDomainReloadInit", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
