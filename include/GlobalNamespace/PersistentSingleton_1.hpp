...
namespace GlobalNamespace {
  ...
  class PersistentSingleton_1 : public UnityEngine::MonoBehaviour {
    ...
    static ::CsObject* _get__lock() {
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::CsObject*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PersistentSingleton_1<T>*>::get(), "_lock"));
    }
    // Autogenerated static field setter
    // Set static field: static private System.Object _lock
    static void _set__lock(::CsObject* value) {
