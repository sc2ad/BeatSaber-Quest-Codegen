...
// Ctor Parameters []
 ::GlobalNamespace::LightTranslationBeatmapEventDataProcessor::LightTranslationBeatmapEventDataProcessor()  : ::GlobalNamespace::BeatmapEventDataProcessor_1<::GlobalNamespace::LightTranslationBeatmapEventData>(THROW_UNLESS(::il2cpp_utils::New<LightTranslationBeatmapEventDataProcessor>())) {}
