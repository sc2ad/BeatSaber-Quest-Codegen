...
namespace GlobalNamespace {
  ...
  check_size<sizeof(MultiplayerLocalActivePlayerGameplayManager), 96 + sizeof(bool) + 8 - (96 + sizeof(bool)) % 8> __GlobalNamespace_MultiplayerLocalActivePlayerGameplayManagerSizeCheck;
}
