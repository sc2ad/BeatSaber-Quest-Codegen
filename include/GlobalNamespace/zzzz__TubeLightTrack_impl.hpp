...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TubeLightTrack::*)()>(&GlobalNamespace::TubeLightTrack::_ctor)> {
 ...
 GlobalNamespace::TubeLightTrack GlobalNamespace::TubeLightTrack::New_ctor()  {
GlobalNamespace::TubeLightTrack o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::TubeLightTrack>())};
return o;
}
