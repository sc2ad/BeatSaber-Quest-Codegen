...
namespace GlobalNamespace {
  ...
  class EnumTableViewDataSource_1 : public UnityEngine::MonoBehaviour/*, public HMUI::TableView::IDataSource*/ {
    ...
    GlobalNamespace::TextOnlyTableCell* _get__cellPrefab() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_get__cellPrefab");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<GlobalNamespace::TextOnlyTableCell*>(___internal__instance, "_cellPrefab"));
    }
    // Autogenerated instance field setter
    // Set instance field: private TextOnlyTableCell _cellPrefab
    void _set__cellPrefab(GlobalNamespace::TextOnlyTableCell* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_set__cellPrefab");
      static auto ___internal__instance = this;
    ...
    float _get__cellHeight() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_get__cellHeight");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<float>(___internal__instance, "_cellHeight"));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Single _cellHeight
    void _set__cellHeight(float value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_set__cellHeight");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_cellHeight", value));
    }
    // Autogenerated instance field getter
    // Get instance field: private readonly T[] _values
    ::Array<T>* _get__values() {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_get__values");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<T>*>(___internal__instance, "_values"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly T[] _values
    void _set__values(::Array<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("GlobalNamespace::EnumTableViewDataSource_1::_set__values");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_values", value));
    }
