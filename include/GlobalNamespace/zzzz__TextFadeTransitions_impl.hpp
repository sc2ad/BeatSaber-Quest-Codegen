...
constexpr ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::____GlobalNamespace__TextFadeTransitions__State(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State  ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::NotInTransition{0};
constexpr ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State  ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::FadingOut{1};
constexpr ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State  ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State::FadingIn{2};
...
constexpr void ::GlobalNamespace::TextFadeTransitions::__set__state(::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State>(value));
}
constexpr ::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State ::GlobalNamespace::TextFadeTransitions::__get__state() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::____GlobalNamespace__TextFadeTransitions__State, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
