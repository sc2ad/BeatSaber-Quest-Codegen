...
namespace GlobalNamespace {
  ...
  class BloomFogSO : public ::GlobalNamespace::PersistentScriptableObject {
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // private System.Single _autoExposureIntensity
    // Size: 0x4
    // Offset: 0x24
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // Padding between fields: noteSpawnIntensity and: defaultFogParams
    char __padding4[0x4] = {};
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10FA3D0
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10FA3E0
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10FA3F0
    ...
    // [DoesNotRequireDomainReloadInitAttribute] Offset: 0x10FA400
    ...
    // Get instance field reference: private System.Single _autoExposureIntensity
    [[deprecated("Use field access instead!")]] float& dyn__autoExposureIntensity();
    ...
    // public System.Single get_autoExposureIntensity()
    // Offset: 0x1CC8140
    float get_autoExposureIntensity();
    ...
    // private System.Void SetParams(System.Single attenuation, System.Single offset, System.Single heightFogStartY, System.Single heightFogHeight, System.Single brightness, System.Single autoExposureIntensity, System.Single noteSpawnIntensity)
    // Offset: 0x1CC8178
    void SetParams(float attenuation, float offset, float heightFogStartY, float heightFogHeight, float brightness, float autoExposureIntensity, float noteSpawnIntensity);
  ...
  #pragma pack(pop)
  static check_size<sizeof(BloomFogSO), 56 + sizeof(::GlobalNamespace::BloomFogEnvironmentParams*)> __GlobalNamespace_BloomFogSOSizeCheck;
  static_assert(sizeof(BloomFogSO) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::BloomFogSO::get_brightness
// Il2CppName: get_brightness
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (GlobalNamespace::BloomFogSO::*)()>(&GlobalNamespace::BloomFogSO::get_brightness)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::BloomFogSO*), "get_brightness", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::BloomFogSO::get_autoExposureIntensity
// Il2CppName: get_autoExposureIntensity
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (GlobalNamespace::BloomFogSO::*)()>(&GlobalNamespace::BloomFogSO::get_autoExposureIntensity)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::BloomFogSO*), "get_autoExposureIntensity", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BloomFogSO::*)(float, float, float, float, float, float, float)>(&GlobalNamespace::BloomFogSO::SetParams)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::BloomFogSO*), "SetParams", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{attenuation, offset, heightFogStartY, heightFogHeight, brightness, autoExposureIntensity, noteSpawnIntensity});
  }
};
