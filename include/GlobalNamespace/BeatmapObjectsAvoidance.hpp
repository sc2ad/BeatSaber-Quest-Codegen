...
namespace GlobalNamespace {
  ...
  class BeatmapObjectsAvoidance : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [HeaderAttribute] Offset: 0x10DF96C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [HeaderAttribute] Offset: 0x10DF9C8
    ...
    // [HeaderAttribute] Offset: 0x10DFA14
    ...
    // [InjectAttribute] Offset: 0x10DFA60
    ...
    // [InjectAttribute] Offset: 0x10DFA70
    ...
    // [InjectAttribute] Offset: 0x10DFA80
    ...
    // [InjectAttribute] Offset: 0x10DFA90
