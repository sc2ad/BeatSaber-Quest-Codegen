...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::*)(int32_t)>(&GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::Execute)> {
  constexpr static std::size_t size = 0x180;
  constexpr static std::size_t addrs = 0x2625d7c;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob>::get(),
                            "Execute",
...
constexpr  GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::operator Unity::Jobs::IJobParallelFor() const {
return Unity::Jobs::IJobParallelFor(::cordl_internals::Box(this).convert());
}
// Ctor Parameters [CppParam { name: "Vertices", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector3>", modifiers: "", def_value: Some("{}") }, CppParam { name: "Normals", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector3>", modifiers: "", def_value: Some("{}") }, CppParam { name: "UV", ty: "Unity::Collections::NativeArray_1<UnityEngine::Vector2>", modifiers: "", def_value: Some("{}") }, CppParam { name: "BoneWeights", ty: "Unity::Collections::NativeArray_1<UnityEngine::BoneWeight>", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeshVerticesPosition", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeshNormals", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeshUV", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeshBoneWeights", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>", modifiers: "", def_value: Some("{}") }, CppParam { name: "MeshBoneIndices", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s>", modifiers: "", def_value: Some("{}") }]
constexpr GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob(Unity::Collections::NativeArray_1<UnityEngine::Vector3> Vertices, Unity::Collections::NativeArray_1<UnityEngine::Vector3> Normals, Unity::Collections::NativeArray_1<UnityEngine::Vector2> UV, Unity::Collections::NativeArray_1<UnityEngine::BoneWeight> BoneWeights, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> MeshVerticesPosition, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> MeshNormals, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> MeshUV, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> MeshBoneWeights, Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> MeshBoneIndices) noexcept : ::bs_hook::ValueTypeWrapper() {this->Vertices = Vertices;
...
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_Vertices(Unity::Collections::NativeArray_1<UnityEngine::Vector3> value)  {
...
constexpr Unity::Collections::NativeArray_1<UnityEngine::Vector3> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_Vertices() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<UnityEngine::Vector3>, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_Normals(Unity::Collections::NativeArray_1<UnityEngine::Vector3> value)  {
...
constexpr Unity::Collections::NativeArray_1<UnityEngine::Vector3> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_Normals() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<UnityEngine::Vector3>, 0x10>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_UV(Unity::Collections::NativeArray_1<UnityEngine::Vector2> value)  {
...
constexpr Unity::Collections::NativeArray_1<UnityEngine::Vector2> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_UV() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<UnityEngine::Vector2>, 0x20>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_BoneWeights(Unity::Collections::NativeArray_1<UnityEngine::BoneWeight> value)  {
...
constexpr Unity::Collections::NativeArray_1<UnityEngine::BoneWeight> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_BoneWeights() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<UnityEngine::BoneWeight>, 0x30>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_MeshVerticesPosition(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>, 0x40>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_MeshVerticesPosition() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>, 0x40>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_MeshNormals(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>, 0x50>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_MeshNormals() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector3f>, 0x50>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_MeshUV(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>, 0x60>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_MeshUV() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector2f>, 0x60>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_MeshBoneWeights(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>, 0x70>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_MeshBoneWeights() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>, 0x70>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__set_MeshBoneIndices(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s>, 0x80>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::__get_MeshBoneIndices() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4s>, 0x80>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob::Execute(int32_t index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformToUnitySpaceJob>::get(),
                            "Execute",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob.Execute
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::*)(int32_t)>(&GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::Execute)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x2625efc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob>::get(),
                            "Execute",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
...
/// @brief Convert operator to Unity::Jobs::IJobParallelFor
constexpr  GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::operator Unity::Jobs::IJobParallelFor() const {
return Unity::Jobs::IJobParallelFor(::cordl_internals::Box(this).convert());
}
...
constexpr GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob(Unity::Collections::NativeArray_1<uint32_t> Triangles, Unity::Collections::NativeArray_1<int16_t> MeshIndices, int32_t NumIndices) noexcept : ::bs_hook::ValueTypeWrapper() {this->Triangles = Triangles;
this->MeshIndices = MeshIndices;
this->NumIndices = NumIndices;
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__set_Triangles(Unity::Collections::NativeArray_1<uint32_t> value)  {
...
constexpr Unity::Collections::NativeArray_1<uint32_t> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__get_Triangles() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<uint32_t>, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__set_MeshIndices(Unity::Collections::NativeArray_1<int16_t> value)  {
...
constexpr Unity::Collections::NativeArray_1<int16_t> GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__get_MeshIndices() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<int16_t>, 0x10>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__set_NumIndices(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x20>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::__get_NumIndices() const {
return ::cordl_internals::getInstanceField<int32_t, 0x20>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob::Execute(int32_t index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__TransformTrianglesJob>::get(),
                            "Execute",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::*)(::ArrayW<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>, int32_t)>(&GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::_ctor)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
    return ___internal_method;
  }
};
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>.Dispose
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::*)()>(&GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::Dispose)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
/// @brief Convert operator to System::IDisposable
constexpr  GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::operator System::IDisposable() const {
return System::IDisposable(::cordl_internals::Box(this).convert());
}
// Ctor Parameters [CppParam { name: "UnityNativeArray", ty: "Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_handle", ty: "System::Runtime::InteropServices::GCHandle", modifiers: "", def_value: Some("{}") }]
constexpr GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> UnityNativeArray, System::Runtime::InteropServices::GCHandle _handle) noexcept : ::bs_hook::ValueTypeWrapper() {this->UnityNativeArray = UnityNativeArray;
this->_handle = _handle;
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::__set_UnityNativeArray(Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> value)  {
::cordl_internals::setInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>, 0x0>(this->__instance, std::forward<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>(value));
}
constexpr Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::__get_UnityNativeArray() const {
return ::cordl_internals::getInstanceField<Unity::Collections::NativeArray_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::__set__handle(System::Runtime::InteropServices::GCHandle value)  {
::cordl_internals::setInstanceField<System::Runtime::InteropServices::GCHandle, 0x8>(this->__instance, std::forward<System::Runtime::InteropServices::GCHandle>(value));
}
constexpr System::Runtime::InteropServices::GCHandle GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::__get__handle() const {
return ::cordl_internals::getInstanceField<System::Runtime::InteropServices::GCHandle, 0x8>(this->__instance);
}
 void GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::_ctor(::ArrayW<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f> ovrArray, int32_t length)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, ovrArray, length);
 ...
 void GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>::Dispose()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::GlobalNamespace__OVRMeshJobs__NativeArrayHelper_1<GlobalNamespace::GlobalNamespace__OVRPlugin__Vector4f>>::get(),
                            "Dispose",
                            std::vector<Il2CppClass*>{},
