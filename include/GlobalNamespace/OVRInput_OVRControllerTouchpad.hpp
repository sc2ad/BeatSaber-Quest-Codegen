...
namespace GlobalNamespace {
  ...
  check_size<sizeof(OVRInput::OVRControllerTouchpad), 272 + sizeof(float) + ((272 + sizeof(float)) % 8 != 0 ? (8 - (272 + sizeof(float)) % 8) : 0)> __GlobalNamespace_OVRInput_OVRControllerTouchpadSizeCheck;
}
