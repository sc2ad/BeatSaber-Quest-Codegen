...
namespace GlobalNamespace {
  ...
  struct OculusPlatformAdditionalContentModel::$OpenLevelPackProductStoreAsync$d__9 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
