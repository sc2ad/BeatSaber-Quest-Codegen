...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::DisableOnNonOculus::*)()>(&GlobalNamespace::DisableOnNonOculus::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2115b14;
 ...
 GlobalNamespace::DisableOnNonOculus GlobalNamespace::DisableOnNonOculus::New_ctor()  {
GlobalNamespace::DisableOnNonOculus o{THROW_UNLESS(::il2cpp_utils::New<GlobalNamespace::DisableOnNonOculus>())};
return o;
}
