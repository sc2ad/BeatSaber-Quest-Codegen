...
namespace NetEase::Docker {
  ...
  struct InitializeData/*, public System::ValueType*/ {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0x1234FB4
    ...
    char __padding0[0x3] = {};
    // [DebuggerBrowsableAttribute] Offset: 0x1234FF0
    ...
    // Get instance field reference: private System.Boolean <InitializeSuccessful>k__BackingField
    bool& dyn_$InitializeSuccessful$k__BackingField();
