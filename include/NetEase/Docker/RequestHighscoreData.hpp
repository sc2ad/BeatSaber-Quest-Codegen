...
namespace NetEase::Docker {
  ...
  struct RequestHighscoreData/*, public System::ValueType*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xE033B8
    // [DebuggerBrowsableAttribute] Offset: 0xE033B8
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xE033F4
    // [CompilerGeneratedAttribute] Offset: 0xE033F4
