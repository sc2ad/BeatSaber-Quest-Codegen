...
namespace HMUI {
  ...
  class ToggleWithCallbacks : public UnityEngine::UI::Toggle {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xEE3920
    ...
    // Get instance field reference: private System.Action`1<HMUI.ToggleWithCallbacks/SelectionState> stateDidChangeEvent
