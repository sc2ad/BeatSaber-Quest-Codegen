...
namespace HMUI {
  ...
  class ToggleWithCallbacks : public UnityEngine::UI::Toggle {
    ...
    check_size<sizeof(ToggleWithCallbacks::SelectionState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_ToggleWithCallbacks_SelectionStateSizeCheck;
  ...
  check_size<sizeof(ToggleWithCallbacks), 280 + sizeof(void*) + ((280 + sizeof(void*)) % 8 != 0 ? (8 - (280 + sizeof(void*)) % 8) : 0)> __HMUI_ToggleWithCallbacksSizeCheck;
}
