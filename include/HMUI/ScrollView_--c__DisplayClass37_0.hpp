...
namespace HMUI {
  ...
  check_size<sizeof(ScrollView::$$c__DisplayClass37_0), 16 + sizeof(float) + ((16 + sizeof(float)) % 8 != 0 ? (8 - (16 + sizeof(float)) % 8) : 0)> __HMUI_ScrollView_$$c__DisplayClass37_0SizeCheck;
}
