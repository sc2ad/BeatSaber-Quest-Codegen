...
namespace HMUI {
  ...
  check_size<sizeof(PanelAnimation::$AnimationCoroutine$d__1), 112 + sizeof(float) + ((112 + sizeof(float)) % 8 != 0 ? (8 - (112 + sizeof(float)) % 8) : 0)> __HMUI_PanelAnimation_$AnimationCoroutine$d__1SizeCheck;
}
