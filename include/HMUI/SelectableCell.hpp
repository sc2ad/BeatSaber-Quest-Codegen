...
namespace HMUI {
  ...
  class SelectableCell : public HMUI::Interactable/*, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::IPointerEnterHandler, public UnityEngine::EventSystems::IPointerExitHandler*/ {
    ...
    check_size<sizeof(SelectableCell::TransitionType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_SelectableCell_TransitionTypeSizeCheck;
  ...
  check_size<sizeof(SelectableCell), 57 + sizeof(bool) + ((57 + sizeof(bool)) % 8 != 0 ? (8 - (57 + sizeof(bool)) % 8) : 0)> __HMUI_SelectableCellSizeCheck;
}
