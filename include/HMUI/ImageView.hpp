...
namespace HMUI {
  ...
  class ImageView : public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::UI::ILayoutElement, public UnityEngine::ICanvasRaycastFilter, public UnityEngine::UI::MaskableGraphic {
    public:
