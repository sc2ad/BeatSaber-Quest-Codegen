...
namespace HMUI {
  ...
  // [DisallowMultipleComponent] Offset: EE1448
  // [ExecuteAlways] Offset: EE1448
  class ImageView : public UnityEngine::UI::Image {
    ...
    // Get instance field reference: private HMUI.ImageView/GradientDirection _gradientDirection
