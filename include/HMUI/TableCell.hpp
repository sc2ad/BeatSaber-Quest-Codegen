...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [RequireComponent] Offset: D01A58
  class TableCell : public HMUI::SelectableCell {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xD03BA0
    ...
    // Offset: 0x1202368
    void TableViewSetup_NEW(HMUI::ITableCellOwner* tableCellOwner, int idx);
