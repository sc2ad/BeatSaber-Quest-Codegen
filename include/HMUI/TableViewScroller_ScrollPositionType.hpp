...
namespace HMUI {
  ...
  static check_size<sizeof(TableViewScroller::ScrollPositionType), 0 + sizeof(int)> __HMUI_TableViewScroller_ScrollPositionTypeSizeCheck;
  static_assert(sizeof(TableViewScroller::ScrollPositionType) == 0x4);
}
#pragma pack(pop)
