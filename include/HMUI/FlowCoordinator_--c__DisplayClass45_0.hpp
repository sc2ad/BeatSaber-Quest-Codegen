...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DA6350
  class FlowCoordinator::$$c__DisplayClass45_0 : public ::Il2CppObject {
    ...
    static FlowCoordinator::$$c__DisplayClass45_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c__DisplayClass45_0").WithContext(".ctor");
