...
struct CORDL_TYPE HMUI__NavigationController__Orientation : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr HMUI__NavigationController__Orientation(int32_t value__) noexcept;


                    constexpr HMUI__NavigationController__Orientation(HMUI__NavigationController__Orientation const&) = default;
                    constexpr HMUI__NavigationController__Orientation(HMUI__NavigationController__Orientation&&) = default;
                    constexpr HMUI__NavigationController__Orientation& operator=(HMUI__NavigationController__Orientation const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr HMUI__NavigationController__Orientation& operator=(HMUI__NavigationController__Orientation&& o) noexcept {
...
constexpr explicit HMUI__NavigationController__Orientation(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __HMUI__NavigationController__Orientation_Unwrapped : int32_t {
__Horizontal = 0,
__Vertical = 1,
};
...
static HMUI::HMUI__NavigationController__Orientation const Horizontal;

/// @brief Field Vertical offset 0
static HMUI::HMUI__NavigationController__Orientation const Vertical;
...
struct CORDL_TYPE HMUI__NavigationController__Alignment : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr HMUI__NavigationController__Alignment(int32_t value__) noexcept;


                    constexpr HMUI__NavigationController__Alignment(HMUI__NavigationController__Alignment const&) = default;
                    constexpr HMUI__NavigationController__Alignment(HMUI__NavigationController__Alignment&&) = default;
                    constexpr HMUI__NavigationController__Alignment& operator=(HMUI__NavigationController__Alignment const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr HMUI__NavigationController__Alignment& operator=(HMUI__NavigationController__Alignment&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit HMUI__NavigationController__Alignment(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __HMUI__NavigationController__Alignment_Unwrapped : int32_t {
__Beginning = 0,
__Middle = 1,
__End = 2,
};
...
static HMUI::HMUI__NavigationController__Alignment const Beginning;

/// @brief Field Middle offset 0
static HMUI::HMUI__NavigationController__Alignment const Middle;

/// @brief Field End offset 0
static HMUI::HMUI__NavigationController__Alignment const End;
...
class CORDL_TYPE HMUI__NavigationController____c__DisplayClass8_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~HMUI__NavigationController____c__DisplayClass8_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "HMUI__NavigationController____c__DisplayClass8_0", modifiers: " const&", def_value: None }]
constexpr HMUI__NavigationController____c__DisplayClass8_0(HMUI__NavigationController____c__DisplayClass8_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "HMUI__NavigationController____c__DisplayClass8_0", modifiers: "&&", def_value: None }]
constexpr HMUI__NavigationController____c__DisplayClass8_0(HMUI__NavigationController____c__DisplayClass8_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit HMUI__NavigationController____c__DisplayClass8_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr HMUI__NavigationController____c__DisplayClass8_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr HMUI__NavigationController____c__DisplayClass8_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr HMUI__NavigationController____c__DisplayClass8_0& operator=(HMUI__NavigationController____c__DisplayClass8_0&& o) noexcept = default;
  constexpr HMUI__NavigationController____c__DisplayClass8_0& operator=(HMUI__NavigationController____c__DisplayClass8_0 const& o) noexcept = default;
...
class CORDL_TYPE HMUI__NavigationController____c__DisplayClass10_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~HMUI__NavigationController____c__DisplayClass10_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "HMUI__NavigationController____c__DisplayClass10_0", modifiers: " const&", def_value: None }]
constexpr HMUI__NavigationController____c__DisplayClass10_0(HMUI__NavigationController____c__DisplayClass10_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "HMUI__NavigationController____c__DisplayClass10_0", modifiers: "&&", def_value: None }]
constexpr HMUI__NavigationController____c__DisplayClass10_0(HMUI__NavigationController____c__DisplayClass10_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit HMUI__NavigationController____c__DisplayClass10_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr HMUI__NavigationController____c__DisplayClass10_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr HMUI__NavigationController____c__DisplayClass10_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr HMUI__NavigationController____c__DisplayClass10_0& operator=(HMUI__NavigationController____c__DisplayClass10_0&& o) noexcept = default;
  constexpr HMUI__NavigationController____c__DisplayClass10_0& operator=(HMUI__NavigationController____c__DisplayClass10_0 const& o) noexcept = default;
...
public:
// Declarations
using __c__DisplayClass10_0 = HMUI::HMUI__NavigationController____c__DisplayClass10_0;

using __c__DisplayClass8_0 = HMUI::HMUI__NavigationController____c__DisplayClass8_0;

using Alignment = HMUI::HMUI__NavigationController__Alignment;

using Orientation = HMUI::HMUI__NavigationController__Orientation;
...
// Fields
 ...
 HMUI::HMUI__NavigationController__Orientation __declspec(property(get=__get__orientation, put=__set__orientation))  _orientation;

constexpr void __set__orientation(HMUI::HMUI__NavigationController__Orientation value) ;

constexpr HMUI::HMUI__NavigationController__Orientation __get__orientation() const;
...
constexpr bool __get__reversedStacking() const;
 ...
 HMUI::HMUI__NavigationController__Alignment __declspec(property(get=__get__alignment, put=__set__alignment))  _alignment;

constexpr void __set__alignment(HMUI::HMUI__NavigationController__Alignment value) ;

constexpr HMUI::HMUI__NavigationController__Alignment __get__alignment() const;
...
DEFINE_IL2CPP_ARG_TYPE(HMUI::HMUI__NavigationController__Alignment, "HMUI", "NavigationController/Alignment");
DEFINE_IL2CPP_ARG_TYPE(HMUI::HMUI__NavigationController__Orientation, "HMUI", "NavigationController/Orientation");
NEED_NO_BOX(HMUI::HMUI__NavigationController____c__DisplayClass10_0);
DEFINE_IL2CPP_ARG_TYPE(HMUI::HMUI__NavigationController____c__DisplayClass10_0, "HMUI", "NavigationController/<>c__DisplayClass10_0");
NEED_NO_BOX(HMUI::HMUI__NavigationController____c__DisplayClass8_0);
DEFINE_IL2CPP_ARG_TYPE(HMUI::HMUI__NavigationController____c__DisplayClass8_0, "HMUI", "NavigationController/<>c__DisplayClass8_0");
