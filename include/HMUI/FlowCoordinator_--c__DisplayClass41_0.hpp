...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DA6330
  class FlowCoordinator::$$c__DisplayClass41_0 : public ::Il2CppObject {
    ...
    static FlowCoordinator::$$c__DisplayClass41_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c__DisplayClass41_0").WithContext(".ctor");
