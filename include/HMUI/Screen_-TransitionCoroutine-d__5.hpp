...
namespace HMUI {
  ...
  check_size<sizeof(Screen::$TransitionCoroutine$d__5), 68 + sizeof(float) + ((68 + sizeof(float)) % 8 != 0 ? (8 - (68 + sizeof(float)) % 8) : 0)> __HMUI_Screen_$TransitionCoroutine$d__5SizeCheck;
}
