...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 109EC1C
  class AlphabetScrollbar : public ::HMUI::Interactable/*, public ::UnityEngine::EventSystems::IPointerDownHandler, public ::UnityEngine::EventSystems::IPointerUpHandler, public ::UnityEngine::EventSystems::IPointerEnterHandler, public ::UnityEngine::EventSystems::IPointerExitHandler*/ {
    ...
    // [SpaceAttribute] Offset: 0x10A07B0
    ...
    char __padding2[0x4] = {};
    // [SpaceAttribute] Offset: 0x10A07F8
    ...
    ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::AlphabetScrollInfo::Data*>*& dyn__characterScrollData();
    ...
    int& dyn__highlightedCharacterIndex();
