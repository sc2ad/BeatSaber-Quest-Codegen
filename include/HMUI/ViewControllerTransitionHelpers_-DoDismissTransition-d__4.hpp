...
namespace HMUI {
  ...
  check_size<sizeof(ViewControllerTransitionHelpers::$DoDismissTransition$d__4), 56 + sizeof(float) + 8 - (56 + sizeof(float)) % 8> __HMUI_ViewControllerTransitionHelpers_$DoDismissTransition$d__4SizeCheck;
}
