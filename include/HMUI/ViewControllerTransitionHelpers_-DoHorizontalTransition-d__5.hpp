...
namespace HMUI {
  ...
  check_size<sizeof(ViewControllerTransitionHelpers::$DoHorizontalTransition$d__5), 56 + sizeof(void*) + 8 - (56 + sizeof(void*)) % 8> __HMUI_ViewControllerTransitionHelpers_$DoHorizontalTransition$d__5SizeCheck;
}
