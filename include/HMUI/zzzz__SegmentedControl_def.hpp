...
class CORDL_TYPE HMUI__SegmentedControl__IDataSource : public ::cordl_internals::InterfaceW {
public:
// Declarations
~HMUI__SegmentedControl__IDataSource() = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit HMUI__SegmentedControl__IDataSource(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
...
public:
// Declarations
using IDataSource = HMUI::HMUI__SegmentedControl__IDataSource;
...
constexpr System::Collections::Generic::List_1<UnityEngine::GameObject> __get__separators() const;
 ...
 HMUI::HMUI__SegmentedControl__IDataSource __declspec(property(get=__get__dataSource, put=__set__dataSource))  _dataSource;

constexpr void __set__dataSource(HMUI::HMUI__SegmentedControl__IDataSource value) ;

constexpr HMUI::HMUI__SegmentedControl__IDataSource __get__dataSource() const;
...
// Properties
 ...
 HMUI::HMUI__SegmentedControl__IDataSource __declspec(property(get=get_dataSource, put=set_dataSource))  dataSource;
...
/// @brief Method get_dataSource addr 0x1fac9e4 size 0x8 virtual false final false
 HMUI::HMUI__SegmentedControl__IDataSource get_dataSource() ;

/// @brief Method set_dataSource addr 0x1fabe78 size 0x8 virtual false final false
 void set_dataSource(HMUI::HMUI__SegmentedControl__IDataSource value) ;
...
NEED_NO_BOX(HMUI::HMUI__SegmentedControl__IDataSource);
DEFINE_IL2CPP_ARG_TYPE(HMUI::HMUI__SegmentedControl__IDataSource, "HMUI", "SegmentedControl/IDataSource");
