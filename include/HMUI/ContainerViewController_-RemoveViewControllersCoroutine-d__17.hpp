...
namespace HMUI {
  ...
  check_size<sizeof(ContainerViewController::$RemoveViewControllersCoroutine$d__17), 92 + sizeof(float) + 8 - (92 + sizeof(float)) % 8> __HMUI_ContainerViewController_$RemoveViewControllersCoroutine$d__17SizeCheck;
}
