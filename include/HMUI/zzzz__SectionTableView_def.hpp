...
namespace HMUI {
class ____HMUI__SectionTableView__IDataSource;
}
namespace HMUI {
struct ____HMUI__SectionTableView__Section;
}
// Type: ::IDataSource
namespace HMUI {
// Is value type: false
...
class CORDL_TYPE ____HMUI__SectionTableView__IDataSource : public ::cordl_internals::InterfaceW {
public:
// Declarations
~____HMUI__SectionTableView__IDataSource() = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HMUI__SectionTableView__IDataSource(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
...
struct CORDL_TYPE ____HMUI__SectionTableView__Section : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____HMUI__SectionTableView__Section(bool unfolded, int32_t startBaseRow, int32_t numberOfBaseRows) noexcept;


                    constexpr ____HMUI__SectionTableView__Section(____HMUI__SectionTableView__Section const&) = default;
                    constexpr ____HMUI__SectionTableView__Section(____HMUI__SectionTableView__Section&&) = default;
                    constexpr ____HMUI__SectionTableView__Section& operator=(____HMUI__SectionTableView__Section const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HMUI__SectionTableView__Section& operator=(____HMUI__SectionTableView__Section&& o) noexcept {
...
constexpr explicit ____HMUI__SectionTableView__Section(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using Section = ::HMUI::____HMUI__SectionTableView__Section;

using IDataSource = ::HMUI::____HMUI__SectionTableView__IDataSource;
...
constexpr ::System::Action_2<::HMUI::SectionTableView,int32_t> __get_didSelectHeaderEvent() const;
 ...
 ::HMUI::____HMUI__SectionTableView__IDataSource __declspec(property(get=__get__dataSource, put=__set__dataSource))  _dataSource;

constexpr void __set__dataSource(::HMUI::____HMUI__SectionTableView__IDataSource value) ;

constexpr ::HMUI::____HMUI__SectionTableView__IDataSource __get__dataSource() const;

 ::ArrayW<::HMUI::____HMUI__SectionTableView__Section> __declspec(property(get=__get__sections, put=__set__sections))  _sections;

constexpr void __set__sections(::ArrayW<::HMUI::____HMUI__SectionTableView__Section> value) ;

constexpr ::ArrayW<::HMUI::____HMUI__SectionTableView__Section> __get__sections() const;


// Properties

 ::HMUI::____HMUI__SectionTableView__IDataSource __declspec(property(get=get_dataSource, put=set_dataSource))  dataSource;
...
/// @brief Method get_dataSource addr 0x1fd3a18 size 0x8 virtual false final false
 ::HMUI::____HMUI__SectionTableView__IDataSource get_dataSource() ;

/// @brief Method set_dataSource addr 0x1fd3a20 size 0x24 virtual false final false
 void set_dataSource(::HMUI::____HMUI__SectionTableView__IDataSource value) ;
...
/// @brief Method ScrollToRow addr 0x1fd4d68 size 0x44 virtual false final false
 void ScrollToRow(int32_t section, int32_t row, ::HMUI::____HMUI__TableView__ScrollPositionType scrollPositionType, bool animated) ;
...
NEED_NO_BOX(::HMUI::____HMUI__SectionTableView__IDataSource);
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__SectionTableView__IDataSource, "HMUI", "SectionTableView/IDataSource");
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__SectionTableView__Section, "HMUI", "SectionTableView/Section");
