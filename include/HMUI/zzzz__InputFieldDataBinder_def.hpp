...
namespace HMUI {
template<typename T>
class ____HMUI__InputFieldDataBinder____c__3_1;
}
namespace HMUI {
template<typename T0,typename T1>
class ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2;
}
namespace HMUI {
...
class ____HMUI__InputFieldDataBinder____c__3_1<T>;
}
namespace HMUI {
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1>
class ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1>;
}
...
// Declarations
template<typename T>
using __c__3_1 = ::HMUI::____HMUI__InputFieldDataBinder____c__3_1<T>;

template<typename T0,typename T1>
using __c__DisplayClass2_0_2 = ::HMUI::____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2<T0, T1>;
...
class CORDL_TYPE ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2<T0,T1> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2", modifiers: " const&", def_value: None }]
constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2(____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2", modifiers: "&&", def_value: None }]
constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2(____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2& operator=(____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2&& o) noexcept = default;
  constexpr ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2& operator=(____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2() ;
...
class CORDL_TYPE ____HMUI__InputFieldDataBinder____c__3_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____HMUI__InputFieldDataBinder____c__3_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__InputFieldDataBinder____c__3_1", modifiers: " const&", def_value: None }]
constexpr ____HMUI__InputFieldDataBinder____c__3_1(____HMUI__InputFieldDataBinder____c__3_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__InputFieldDataBinder____c__3_1", modifiers: "&&", def_value: None }]
constexpr ____HMUI__InputFieldDataBinder____c__3_1(____HMUI__InputFieldDataBinder____c__3_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HMUI__InputFieldDataBinder____c__3_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HMUI__InputFieldDataBinder____c__3_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HMUI__InputFieldDataBinder____c__3_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HMUI__InputFieldDataBinder____c__3_1& operator=(____HMUI__InputFieldDataBinder____c__3_1&& o) noexcept = default;
  constexpr ____HMUI__InputFieldDataBinder____c__3_1& operator=(____HMUI__InputFieldDataBinder____c__3_1 const& o) noexcept = default;
                


// Fields

static ::HMUI::____HMUI__InputFieldDataBinder____c__3_1<T> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::HMUI::____HMUI__InputFieldDataBinder____c__3_1<T> value) ;

static ::HMUI::____HMUI__InputFieldDataBinder____c__3_1<T> __get___9() ;
...
// Ctor Parameters []
explicit ____HMUI__InputFieldDataBinder____c__3_1() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::HMUI::____HMUI__InputFieldDataBinder____c__3_1, "HMUI", "InputFieldDataBinder/<>c__3`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::HMUI::____HMUI__InputFieldDataBinder____c__DisplayClass2_0_2, "HMUI", "InputFieldDataBinder/<>c__DisplayClass2_0`2");
