...
namespace HMUI {
  ...
  check_size<sizeof(HoverHintController::$ShowHintAfterDelay$d__10), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __HMUI_HoverHintController_$ShowHintAfterDelay$d__10SizeCheck;
}
