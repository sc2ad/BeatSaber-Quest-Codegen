...
namespace HMUI {
  ...
  class InputFieldDataBinder::$$c__DisplayClass2_0_2 : public ::Il2CppObject {
    ...
    static InputFieldDataBinder::$$c__DisplayClass2_0_2<T1, T0>* New_ctor() {
      return (InputFieldDataBinder::$$c__DisplayClass2_0_2<T1, T0>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InputFieldDataBinder::$$c__DisplayClass2_0_2<T1, T0>*>::get())));
    }
