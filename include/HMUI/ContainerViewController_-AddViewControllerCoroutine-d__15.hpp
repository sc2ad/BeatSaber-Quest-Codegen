...
namespace HMUI {
  ...
  check_size<sizeof(ContainerViewController::$AddViewControllerCoroutine$d__15), 84 + sizeof(float) + ((84 + sizeof(float)) % 8 != 0 ? (8 - (84 + sizeof(float)) % 8) : 0)> __HMUI_ContainerViewController_$AddViewControllerCoroutine$d__15SizeCheck;
}
