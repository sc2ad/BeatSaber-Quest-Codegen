...
namespace HMUI {
  ...
  check_size<sizeof(ViewControllerTransitionHelpers::$DoPresentTransition$d__3), 56 + sizeof(float) + 8 - (56 + sizeof(float)) % 8> __HMUI_ViewControllerTransitionHelpers_$DoPresentTransition$d__3SizeCheck;
}
