...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 110CDB8
  class ScrollView : public ::UnityEngine::MonoBehaviour {
    ...
    char __padding2[0x4] = {};
    // [SpaceAttribute] Offset: 0x110EAC8
    // [NullAllowed] Offset: 0x110EAC8
    ...
    // [SpaceAttribute] Offset: 0x110EB80
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x110EBD8
    ...
    // [SpaceAttribute] Offset: 0x110EBE8
    // [DrawIfAttribute] Offset: 0x110EBE8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [DrawIfAttribute] Offset: 0x110EC90
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [DrawIfAttribute] Offset: 0x110ED28
    ...
    // [InjectAttribute] Offset: 0x110EDD8
