...
namespace HMUI {
  ...
  class ScrollView : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(ScrollView::ScrollType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __HMUI_ScrollView_ScrollTypeSizeCheck;
    ...
    check_size<sizeof(ScrollView::ScrollDirection), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __HMUI_ScrollView_ScrollDirectionSizeCheck;
  ...
  check_size<sizeof(ScrollView), 140 + sizeof(float) + 8 - (140 + sizeof(float)) % 8> __HMUI_ScrollViewSizeCheck;
}
