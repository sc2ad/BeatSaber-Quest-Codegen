...
namespace HMUI {
  ...
  check_size<sizeof(ViewController::$DismissViewControllerCoroutine$d__62), 56 + sizeof(void*) + 8 - (56 + sizeof(void*)) % 8> __HMUI_ViewController_$DismissViewControllerCoroutine$d__62SizeCheck;
}
