...
namespace HMUI {
  ...
  check_size<sizeof(ViewController::$PresentViewControllerCoroutine$d__58), 56 + sizeof(void*) + 8 - (56 + sizeof(void*)) % 8> __HMUI_ViewController_$PresentViewControllerCoroutine$d__58SizeCheck;
}
