...
constexpr void HMUI::HMUI__NavigationController__Orientation::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t HMUI::HMUI__NavigationController__Orientation::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr HMUI::HMUI__NavigationController__Orientation  HMUI::HMUI__NavigationController__Orientation::Horizontal{0};
constexpr HMUI::HMUI__NavigationController__Orientation  HMUI::HMUI__NavigationController__Orientation::Vertical{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr HMUI::HMUI__NavigationController__Alignment::HMUI__NavigationController__Alignment(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void HMUI::HMUI__NavigationController__Alignment::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t HMUI::HMUI__NavigationController__Alignment::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr HMUI::HMUI__NavigationController__Alignment  HMUI::HMUI__NavigationController__Alignment::Beginning{0};
constexpr HMUI::HMUI__NavigationController__Alignment  HMUI::HMUI__NavigationController__Alignment::Middle{1};
constexpr HMUI::HMUI__NavigationController__Alignment  HMUI::HMUI__NavigationController__Alignment::End{2};
//  Writing Method size for method: HMUI::HMUI__NavigationController____c__DisplayClass8_0._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::HMUI__NavigationController____c__DisplayClass8_0::*)()>(&HMUI::HMUI__NavigationController____c__DisplayClass8_0::_ctor)> {
...
//  Writing Method size for method: HMUI::HMUI__NavigationController____c__DisplayClass8_0._PushViewController_g__AnimationLayouter_0
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::HMUI__NavigationController____c__DisplayClass8_0::*)(float_t, ::ArrayW<HMUI::ViewController>)>(&HMUI::HMUI__NavigationController____c__DisplayClass8_0::_PushViewController_g__AnimationLayouter_0)> {
...
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass8_0::__set_startPositions(::ArrayW<float_t> value)  {
...
constexpr ::ArrayW<float_t> HMUI::HMUI__NavigationController____c__DisplayClass8_0::__get_startPositions() const {
return ::cordl_internals::getInstanceField<::ArrayW<float_t>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass8_0::__set___4__this(HMUI::NavigationController value)  {
...
constexpr HMUI::NavigationController HMUI::HMUI__NavigationController____c__DisplayClass8_0::__get___4__this() const {
return ::cordl_internals::getInstanceField<HMUI::NavigationController, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass8_0::__set_viewController(HMUI::ViewController value)  {
...
constexpr HMUI::ViewController HMUI::HMUI__NavigationController____c__DisplayClass8_0::__get_viewController() const {
return ::cordl_internals::getInstanceField<HMUI::ViewController, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass8_0::__set_endPositions(::ArrayW<float_t> value)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void HMUI::HMUI__NavigationController____c__DisplayClass8_0::_PushViewController_g__AnimationLayouter_0(float_t t, ::ArrayW<HMUI::ViewController> viewControllers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HMUI::HMUI__NavigationController____c__DisplayClass8_0>::get(),
                            "<PushViewController>g__AnimationLayouter|0",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: HMUI::HMUI__NavigationController____c__DisplayClass10_0._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::HMUI__NavigationController____c__DisplayClass10_0::*)()>(&HMUI::HMUI__NavigationController____c__DisplayClass10_0::_ctor)> {
  constexpr static std::size_t size = 0x8;
...
//  Writing Method size for method: HMUI::HMUI__NavigationController____c__DisplayClass10_0._PopViewControllers_g__AnimationLayouter_0
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::HMUI__NavigationController____c__DisplayClass10_0::*)(float_t, ::ArrayW<HMUI::ViewController>, System::Collections::Generic::HashSet_1<HMUI::ViewController>)>(&HMUI::HMUI__NavigationController____c__DisplayClass10_0::_PopViewControllers_g__AnimationLayouter_0)> {
...
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass10_0::__set_startPositions(::ArrayW<float_t> value)  {
::cordl_internals::setInstanceField<::ArrayW<float_t>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<float_t>>(value));
}
constexpr ::ArrayW<float_t> HMUI::HMUI__NavigationController____c__DisplayClass10_0::__get_startPositions() const {
return ::cordl_internals::getInstanceField<::ArrayW<float_t>, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass10_0::__set___4__this(HMUI::NavigationController value)  {
::cordl_internals::setInstanceField<HMUI::NavigationController, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::NavigationController>(value));
}
constexpr HMUI::NavigationController HMUI::HMUI__NavigationController____c__DisplayClass10_0::__get___4__this() const {
return ::cordl_internals::getInstanceField<HMUI::NavigationController, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass10_0::__set_endPositions(::ArrayW<float_t> value)  {
...
constexpr ::ArrayW<float_t> HMUI::HMUI__NavigationController____c__DisplayClass10_0::__get_endPositions() const {
return ::cordl_internals::getInstanceField<::ArrayW<float_t>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void HMUI::HMUI__NavigationController____c__DisplayClass10_0::__set_moveOffset(float_t value)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void HMUI::HMUI__NavigationController____c__DisplayClass10_0::_PopViewControllers_g__AnimationLayouter_0(float_t t, ::ArrayW<HMUI::ViewController> viewControllers, System::Collections::Generic::HashSet_1<HMUI::ViewController> removingViewControllers)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HMUI::HMUI__NavigationController____c__DisplayClass10_0>::get(),
                            "<PopViewControllers>g__AnimationLayouter|0",
                            std::vector<Il2CppClass*>{},
...
constexpr void HMUI::NavigationController::__set__orientation(HMUI::HMUI__NavigationController__Orientation value)  {
::cordl_internals::setInstanceField<HMUI::HMUI__NavigationController__Orientation, 0x80>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::HMUI__NavigationController__Orientation>(value));
}
constexpr HMUI::HMUI__NavigationController__Orientation HMUI::NavigationController::__get__orientation() const {
return ::cordl_internals::getInstanceField<HMUI::HMUI__NavigationController__Orientation, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr void HMUI::NavigationController::__set__alignment(HMUI::HMUI__NavigationController__Alignment value)  {
::cordl_internals::setInstanceField<HMUI::HMUI__NavigationController__Alignment, 0x88>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<HMUI::HMUI__NavigationController__Alignment>(value));
}
constexpr HMUI::HMUI__NavigationController__Alignment HMUI::NavigationController::__get__alignment() const {
return ::cordl_internals::getInstanceField<HMUI::HMUI__NavigationController__Alignment, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
