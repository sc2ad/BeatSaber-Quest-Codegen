...
namespace HMUI {
  ...
  check_size<sizeof(TextSlider), 304 + sizeof(UnityEngine::DrivenRectTransformTracker) + ((304 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8 != 0 ? (8 - (304 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8) : 0)> __HMUI_TextSliderSizeCheck;
}
