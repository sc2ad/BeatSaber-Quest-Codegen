...
namespace HMUI {
  ...
  // [RequireComponent] Offset: EE10A4
  class TableView : public UnityEngine::MonoBehaviour/*, public HMUI::ITableCellOwner*/ {
    ...
    // Type namespace: HMUI
    namespace HMUI {
      // Forward declaring type: TableType
      struct TableType;
    }
    #include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
    DEFINE_IL2CPP_ARG_TYPE(HMUI::TableView::TableType, "HMUI", "TableView/TableType");
    ...
    // [SpaceAttribute] Offset: 0xEE31F8
    ...
    // [SpaceAttribute] Offset: 0xEE3250
    ...
    char __padding5[0x3] = {};
    // [SpaceAttribute] Offset: 0xEE3298
    // [NullAllowed] Offset: 0xEE3298
