...
namespace HMUI {
  ...
  class TableView : public UnityEngine::MonoBehaviour/*, public HMUI::ITableCellOwner*/ {
    ...
    check_size<sizeof(TableView::TableType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_TableView_TableTypeSizeCheck;
  ...
  check_size<sizeof(TableView), 224 + sizeof(void*) + ((224 + sizeof(void*)) % 8 != 0 ? (8 - (224 + sizeof(void*)) % 8) : 0)> __HMUI_TableViewSizeCheck;
}
