...
namespace HMUI {
  ...
  class SwitchView : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(SwitchView::AnimationType), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_SwitchView_AnimationTypeSizeCheck;
  ...
  check_size<sizeof(SwitchView), 96 + sizeof(void*) + ((96 + sizeof(void*)) % 8 != 0 ? (8 - (96 + sizeof(void*)) % 8) : 0)> __HMUI_SwitchViewSizeCheck;
}
