...
static HMUI::ValueChangedBinder_1<T> New_ctor() ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor() ;

static HMUI::ValueChangedBinder_1<T> New_ctor(HMUI::IValueChanger_1<T> valueChanger, System::Action_1<T> action) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(HMUI::IValueChanger_1<T> valueChanger, System::Action_1<T> action) ;

static HMUI::ValueChangedBinder_1<T> New_ctor(System::Collections::Generic::List_1<System::Tuple_2<HMUI::IValueChanger_1<T>,System::Action_1<T>>> bindingData) ;
