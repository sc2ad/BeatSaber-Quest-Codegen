...
class CORDL_TYPE ____HMUI__IconSegmentedControl__DataItem : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____HMUI__IconSegmentedControl__DataItem() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__IconSegmentedControl__DataItem", modifiers: " const&", def_value: None }]
constexpr ____HMUI__IconSegmentedControl__DataItem(____HMUI__IconSegmentedControl__DataItem const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__IconSegmentedControl__DataItem", modifiers: "&&", def_value: None }]
constexpr ____HMUI__IconSegmentedControl__DataItem(____HMUI__IconSegmentedControl__DataItem&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HMUI__IconSegmentedControl__DataItem(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HMUI__IconSegmentedControl__DataItem& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HMUI__IconSegmentedControl__DataItem& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HMUI__IconSegmentedControl__DataItem& operator=(____HMUI__IconSegmentedControl__DataItem&& o) noexcept = default;
  constexpr ____HMUI__IconSegmentedControl__DataItem& operator=(____HMUI__IconSegmentedControl__DataItem const& o) noexcept = default;
...
explicit ____HMUI__IconSegmentedControl__DataItem(::UnityEngine::Sprite icon, ::StringW hintText) ;
...
public:
// Declarations
using DataItem = ::HMUI::____HMUI__IconSegmentedControl__DataItem;
...
constexpr ::Zenject::DiContainer __get__container() const;
 ...
 ::ArrayW<::HMUI::____HMUI__IconSegmentedControl__DataItem> __declspec(property(get=__get__dataItems, put=__set__dataItems))  _dataItems;

constexpr void __set__dataItems(::ArrayW<::HMUI::____HMUI__IconSegmentedControl__DataItem> value) ;

constexpr ::ArrayW<::HMUI::____HMUI__IconSegmentedControl__DataItem> __get__dataItems() const;
...
/// @brief Method SetData addr 0x1fabe80 size 0x40 virtual false final false
 void SetData(::ArrayW<::HMUI::____HMUI__IconSegmentedControl__DataItem> dataItems) ;
...
NEED_NO_BOX(::HMUI::____HMUI__IconSegmentedControl__DataItem);
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__IconSegmentedControl__DataItem, "HMUI", "IconSegmentedControl/DataItem");
