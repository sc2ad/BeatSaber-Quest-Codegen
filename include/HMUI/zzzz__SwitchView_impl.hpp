...
constexpr ::HMUI::____HMUI__SwitchView__AnimationType::____HMUI__SwitchView__AnimationType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HMUI::____HMUI__SwitchView__AnimationType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HMUI::____HMUI__SwitchView__AnimationType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HMUI::____HMUI__SwitchView__AnimationType  ::HMUI::____HMUI__SwitchView__AnimationType::OnOff{0};
constexpr ::HMUI::____HMUI__SwitchView__AnimationType  ::HMUI::____HMUI__SwitchView__AnimationType::SelectedState{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HMUI::SwitchView::*)(::HMUI::____HMUI__ToggleWithCallbacks__SelectionState)>(&::HMUI::SwitchView::HandleStateDidChange)> {
  constexpr static std::size_t size = 0x4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::HMUI::____HMUI__ToggleWithCallbacks__SelectionState>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::HMUI::SwitchView::__set__animationType(::HMUI::____HMUI__SwitchView__AnimationType value)  {
::cordl_internals::setInstanceField<::HMUI::____HMUI__SwitchView__AnimationType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HMUI::____HMUI__SwitchView__AnimationType>(value));
}
constexpr ::HMUI::____HMUI__SwitchView__AnimationType ::HMUI::SwitchView::__get__animationType() const {
return ::cordl_internals::getInstanceField<::HMUI::____HMUI__SwitchView__AnimationType, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void ::HMUI::SwitchView::HandleStateDidChange(::HMUI::____HMUI__ToggleWithCallbacks__SelectionState value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HMUI::SwitchView>::get(),
                            "HandleStateDidChange",
                            std::vector<Il2CppClass*>{},
