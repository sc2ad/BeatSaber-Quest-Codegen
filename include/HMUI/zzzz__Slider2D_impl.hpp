...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::Slider2D::*)(UnityEngine::UI::UnityEngine__UI__Selectable__SelectionState, bool)>(&HMUI::Slider2D::DoStateTransition)> {
  constexpr static std::size_t size = 0xc;
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, eventData);
 ...
 void HMUI::Slider2D::DoStateTransition(UnityEngine::UI::UnityEngine__UI__Selectable__SelectionState state, bool instant)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HMUI::Slider2D>::get(),
                            "DoStateTransition",
                            std::vector<Il2CppClass*>{},
...
HMUI::Slider2D o{THROW_UNLESS(::il2cpp_utils::New<HMUI::Slider2D>())};
return o;
}
