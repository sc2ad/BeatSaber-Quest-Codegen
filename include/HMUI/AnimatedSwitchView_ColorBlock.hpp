...
namespace HMUI {
  ...
  check_size<sizeof(AnimatedSwitchView::ColorBlock), 96 + sizeof(UnityEngine::Color) + ((96 + sizeof(UnityEngine::Color)) % 8 != 0 ? (8 - (96 + sizeof(UnityEngine::Color)) % 8) : 0)> __HMUI_AnimatedSwitchView_ColorBlockSizeCheck;
}
