...
namespace HMUI {
struct ____HMUI__ImageView__GradientDirection;
}
namespace HMUI {
class ImageView;
}
...
struct CORDL_TYPE ____HMUI__ImageView__GradientDirection : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HMUI__ImageView__GradientDirection(int32_t value__) noexcept;


                    constexpr ____HMUI__ImageView__GradientDirection(____HMUI__ImageView__GradientDirection const&) = default;
                    constexpr ____HMUI__ImageView__GradientDirection(____HMUI__ImageView__GradientDirection&&) = default;
                    constexpr ____HMUI__ImageView__GradientDirection& operator=(____HMUI__ImageView__GradientDirection const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HMUI__ImageView__GradientDirection& operator=(____HMUI__ImageView__GradientDirection&& o) noexcept {
...
constexpr explicit ____HMUI__ImageView__GradientDirection(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HMUI__ImageView__GradientDirection_Unwrapped : int32_t {
__Horizontal = 0,
__Vertical = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______HMUI__ImageView__GradientDirection_Unwrapped () const noexcept {
return std::bit_cast<______HMUI__ImageView__GradientDirection_Unwrapped>(__instance);
}
...
static ::HMUI::____HMUI__ImageView__GradientDirection const Horizontal;

/// @brief Field Vertical offset 0
static ::HMUI::____HMUI__ImageView__GradientDirection const Vertical;
...
public:
// Declarations
using GradientDirection = ::HMUI::____HMUI__ImageView__GradientDirection;
...
constexpr ::UnityEngine::Color __get__color1() const;
 ...
 ::HMUI::____HMUI__ImageView__GradientDirection __declspec(property(get=__get__gradientDirection, put=__set__gradientDirection))  _gradientDirection;

constexpr void __set__gradientDirection(::HMUI::____HMUI__ImageView__GradientDirection value) ;

constexpr ::HMUI::____HMUI__ImageView__GradientDirection __get__gradientDirection() const;
...
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__ImageView__GradientDirection, "HMUI", "ImageView/GradientDirection");
