...
namespace HMUI {
  ...
  check_size<sizeof(NavigationController::$$c__DisplayClass10_0), 40 + sizeof(float) + ((40 + sizeof(float)) % 8 != 0 ? (8 - (40 + sizeof(float)) % 8) : 0)> __HMUI_NavigationController_$$c__DisplayClass10_0SizeCheck;
}
