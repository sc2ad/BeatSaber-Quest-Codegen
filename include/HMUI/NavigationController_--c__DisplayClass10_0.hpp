...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DA6380
  class NavigationController::$$c__DisplayClass10_0 : public ::Il2CppObject {
    ...
    static NavigationController::$$c__DisplayClass10_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("HMUI").WithContext("$$c__DisplayClass10_0").WithContext(".ctor");
