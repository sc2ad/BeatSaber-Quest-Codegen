...
namespace HMUI {
  ...
  check_size<sizeof(ViewController::$ReplaceViewControllerCoroutine$d__60), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __HMUI_ViewController_$ReplaceViewControllerCoroutine$d__60SizeCheck;
}
