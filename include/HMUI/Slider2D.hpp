...
namespace HMUI {
  ...
  check_size<sizeof(Slider2D), 280 + sizeof(UnityEngine::DrivenRectTransformTracker) + ((280 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8 != 0 ? (8 - (280 + sizeof(UnityEngine::DrivenRectTransformTracker)) % 8) : 0)> __HMUI_Slider2DSizeCheck;
}
