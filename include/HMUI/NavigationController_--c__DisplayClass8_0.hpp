...
namespace HMUI {
  ...
  class NavigationController::$$c__DisplayClass8_0 : public ::Il2CppObject {
    ...
    // Offset: 0x1413538
    void $PushViewController$g__AnimationLayouter_0(float t, ::ArrayWrapper<HMUI::ViewController*> viewControllers);
  ...
  #pragma pack(pop)
  static check_size<sizeof(NavigationController::$$c__DisplayClass8_0), 40 + sizeof(::ArrayWrapper<float>)> __HMUI_NavigationController_$$c__DisplayClass8_0SizeCheck;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::NavigationController::$$c__DisplayClass8_0::*)(float, ::ArrayWrapper<HMUI::ViewController*>)>(&HMUI::NavigationController::$$c__DisplayClass8_0::$PushViewController$g__AnimationLayouter_0)> {
