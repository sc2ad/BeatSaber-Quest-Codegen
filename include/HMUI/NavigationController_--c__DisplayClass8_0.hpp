...
namespace HMUI {
  ...
  check_size<sizeof(NavigationController::$$c__DisplayClass8_0), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __HMUI_NavigationController_$$c__DisplayClass8_0SizeCheck;
}
