...
namespace HMUI {
class ____HMUI__Screen___TransitionCoroutine_d__5;
}
...
class CORDL_TYPE ____HMUI__Screen___TransitionCoroutine_d__5 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____HMUI__Screen___TransitionCoroutine_d__5() = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__Screen___TransitionCoroutine_d__5", modifiers: " const&", def_value: None }]
constexpr ____HMUI__Screen___TransitionCoroutine_d__5(____HMUI__Screen___TransitionCoroutine_d__5 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____HMUI__Screen___TransitionCoroutine_d__5", modifiers: "&&", def_value: None }]
constexpr ____HMUI__Screen___TransitionCoroutine_d__5(____HMUI__Screen___TransitionCoroutine_d__5&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____HMUI__Screen___TransitionCoroutine_d__5(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____HMUI__Screen___TransitionCoroutine_d__5& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____HMUI__Screen___TransitionCoroutine_d__5& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____HMUI__Screen___TransitionCoroutine_d__5& operator=(____HMUI__Screen___TransitionCoroutine_d__5&& o) noexcept = default;
  constexpr ____HMUI__Screen___TransitionCoroutine_d__5& operator=(____HMUI__Screen___TransitionCoroutine_d__5 const& o) noexcept = default;
...
constexpr ::HMUI::ViewController __get_newRootViewController() const;
 ...
 ::HMUI::____HMUI__ViewController__AnimationType __declspec(property(get=__get_animationType, put=__set_animationType))  animationType;

constexpr void __set_animationType(::HMUI::____HMUI__ViewController__AnimationType value) ;

constexpr ::HMUI::____HMUI__ViewController__AnimationType __get_animationType() const;
...
explicit ____HMUI__Screen___TransitionCoroutine_d__5(int32_t __1__state) ;
...
public:
// Declarations
using _TransitionCoroutine_d__5 = ::HMUI::____HMUI__Screen___TransitionCoroutine_d__5;
...
/// @brief Method SetRootViewController addr 0x1fb81e8 size 0xd0 virtual false final false
 void SetRootViewController(::HMUI::ViewController newRootViewController, ::HMUI::____HMUI__ViewController__AnimationType animationType) ;

/// @brief Method TransitionCoroutine addr 0x1fb82b8 size 0x7c virtual false final false
 ::System::Collections::IEnumerator TransitionCoroutine(::HMUI::ViewController newRootViewController, ::HMUI::____HMUI__ViewController__AnimationType animationType) ;
...
NEED_NO_BOX(::HMUI::____HMUI__Screen___TransitionCoroutine_d__5);
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__Screen___TransitionCoroutine_d__5, "HMUI", "Screen/<TransitionCoroutine>d__5");
