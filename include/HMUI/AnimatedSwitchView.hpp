...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10FC4F8
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x10FD9B0
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x10FDA18
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10FDA70
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x10FDAB8
