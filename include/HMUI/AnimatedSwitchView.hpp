...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 1109828
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x110AD78
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x110ADE0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x110AE38
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x110AE80
