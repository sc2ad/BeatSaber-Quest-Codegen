...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10FF178
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x1100630
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x1100698
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x11006F0
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x1100738
