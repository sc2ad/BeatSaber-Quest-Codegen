...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 122AD88
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x122C200
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x122C268
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x122C2C0
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x122C308
