...
namespace HMUI {
  ...
  // [DisallowMultipleComponent] Offset: DF58DC
  // [RequireComponent] Offset: DF58DC
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xDF6CFC
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xDF6D64
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xDF6DBC
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xDF6E04
