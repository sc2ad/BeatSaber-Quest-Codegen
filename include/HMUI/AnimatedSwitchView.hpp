...
namespace HMUI {
  ...
  // [RequireComponent] Offset: E8FF84
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xE913B4
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xE9141C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xE91474
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xE914BC
