...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10C05FC
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x10C1AB4
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x10C1B1C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10C1B74
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x10C1BBC
