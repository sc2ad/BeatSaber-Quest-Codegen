...
namespace HMUI {
  ...
  // [RequireComponent] Offset: E15D24
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xE17154
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xE171BC
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xE17214
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xE1725C
