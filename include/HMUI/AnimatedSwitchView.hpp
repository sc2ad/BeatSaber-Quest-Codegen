...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10FD278
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x10FE730
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x10FE798
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10FE7F0
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x10FE838
