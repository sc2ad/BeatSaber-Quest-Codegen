...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10A0050
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x10A1508
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x10A1570
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10A15C8
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x10A1610
