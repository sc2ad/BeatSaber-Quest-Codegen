...
namespace HMUI {
  ...
  // [DisallowMultipleComponent] Offset: D162A8
  // [RequireComponent] Offset: D162A8
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xD176B8
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xD17720
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD17778
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xD177C0
