...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 123A00C
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x123B4C4
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x123B52C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x123B584
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x123B5CC
