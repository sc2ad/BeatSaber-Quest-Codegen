...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: D017A8
  // [RequireComponent] Offset: D017A8
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xD02BA8
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xD02C10
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD02C68
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xD02CB0
