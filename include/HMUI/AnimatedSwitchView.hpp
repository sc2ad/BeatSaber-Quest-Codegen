...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: D01C04
  // [RequireComponent] Offset: D01C04
  class AnimatedSwitchView : public UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0xD03004
    ...
    // Field size check
    static_assert(sizeof(TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0xD0306C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0xD030C4
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0xD0310C
