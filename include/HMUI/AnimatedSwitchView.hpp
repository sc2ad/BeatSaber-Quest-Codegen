...
namespace HMUI {
  ...
  // [RequireComponent] Offset: 10CFD7C
  class AnimatedSwitchView : public ::UnityEngine::MonoBehaviour {
    ...
    // [SpaceAttribute] Offset: 0x10D2234
    ...
    // Field size check
    static_assert(sizeof(::TMPro::TextMeshProUGUI*) == 0x8);
    // [SpaceAttribute] Offset: 0x10D229C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [SpaceAttribute] Offset: 0x10D22F4
    ...
    char __padding9[0x4] = {};
    // [SpaceAttribute] Offset: 0x10D233C
