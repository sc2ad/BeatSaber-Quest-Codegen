...
struct CORDL_TYPE ____HMUI__SelectableCell__TransitionType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____HMUI__SelectableCell__TransitionType(int32_t value__) noexcept;


                    constexpr ____HMUI__SelectableCell__TransitionType(____HMUI__SelectableCell__TransitionType const&) = default;
                    constexpr ____HMUI__SelectableCell__TransitionType(____HMUI__SelectableCell__TransitionType&&) = default;
                    constexpr ____HMUI__SelectableCell__TransitionType& operator=(____HMUI__SelectableCell__TransitionType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____HMUI__SelectableCell__TransitionType& operator=(____HMUI__SelectableCell__TransitionType&& o) noexcept {
...
constexpr explicit ____HMUI__SelectableCell__TransitionType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______HMUI__SelectableCell__TransitionType_Unwrapped : int32_t {
__Instant = 0,
__Animated = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______HMUI__SelectableCell__TransitionType_Unwrapped () const noexcept {
return std::bit_cast<______HMUI__SelectableCell__TransitionType_Unwrapped>(__instance);
}
...
static ::HMUI::____HMUI__SelectableCell__TransitionType const Instant;

/// @brief Field Animated offset 0
static ::HMUI::____HMUI__SelectableCell__TransitionType const Animated;
...
public:
// Declarations
using TransitionType = ::HMUI::____HMUI__SelectableCell__TransitionType;
...
constexpr ::GlobalNamespace::Signal __get__wasPressedSignal() const;
 ...
 ::System::Action_3<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType,::bs_hook::Il2CppWrapperType> __declspec(property(get=__get_selectionDidChangeEvent, put=__set_selectionDidChangeEvent))  selectionDidChangeEvent;

constexpr void __set_selectionDidChangeEvent(::System::Action_3<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType,::bs_hook::Il2CppWrapperType> value) ;

constexpr ::System::Action_3<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType,::bs_hook::Il2CppWrapperType> __get_selectionDidChangeEvent() const;

 ::System::Action_2<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType> __declspec(property(get=__get_highlightDidChangeEvent, put=__set_highlightDidChangeEvent))  highlightDidChangeEvent;

constexpr void __set_highlightDidChangeEvent(::System::Action_2<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType> value) ;

constexpr ::System::Action_2<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType> __get_highlightDidChangeEvent() const;
...
/// @brief Method add_selectionDidChangeEvent addr 0x1fd1ffc size 0xb0 virtual false final false
 void add_selectionDidChangeEvent(::System::Action_3<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType,::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method remove_selectionDidChangeEvent addr 0x1fd20ac size 0xb0 virtual false final false
 void remove_selectionDidChangeEvent(::System::Action_3<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType,::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method add_highlightDidChangeEvent addr 0x1fd215c size 0xb0 virtual false final false
 void add_highlightDidChangeEvent(::System::Action_2<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType> value) ;

/// @brief Method remove_highlightDidChangeEvent addr 0x1fd220c size 0xb0 virtual false final false
 void remove_highlightDidChangeEvent(::System::Action_2<::HMUI::SelectableCell,::HMUI::____HMUI__SelectableCell__TransitionType> value) ;
...
/// @brief Method SetSelected addr 0x1fd2314 size 0x80 virtual false final false
 void SetSelected(bool value, ::HMUI::____HMUI__SelectableCell__TransitionType transitionType, ::bs_hook::Il2CppWrapperType changeOwner, bool ignoreCurrentValue) ;

/// @brief Method ClearHighlight addr 0x1fd2394 size 0x10 virtual false final false
 void ClearHighlight(::HMUI::____HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method SetHighlight addr 0x1fd23a4 size 0x78 virtual false final false
 void SetHighlight(bool value, ::HMUI::____HMUI__SelectableCell__TransitionType transitionType, bool ignoreCurrentValue) ;
...
DEFINE_IL2CPP_ARG_TYPE(::HMUI::____HMUI__SelectableCell__TransitionType, "HMUI", "SelectableCell/TransitionType");
