...
namespace HMUI {
  ...
  template<typename T>
  class InputFieldDataBinder::$$c__3_1 : public ::CsObject {
    static_assert((!std::is_complete_v<std::remove_pointer_t<T>> || std::is_base_of_v<GlobalNamespace::IObservableChange, std::remove_pointer_t<T>>) && (!std::is_complete_v<std::remove_pointer_t<T>> || std::is_base_of_v<GlobalNamespace::IValue_1<::CsString*>, std::remove_pointer_t<T>>));
    public:
    ...
    static System::Func_2<::CsString*, ::CsString*>* _get_$$9__3_0() {
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Func_2<::CsString*, ::CsString*>*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InputFieldDataBinder::$$c__3_1<T>*>::get(), "<>9__3_0")));
    }
    // Autogenerated static field setter
    // Set static field: static public System.Func`2<System.String,System.String> <>9__3_0
    static void _set_$$9__3_0(System::Func_2<::CsString*, ::CsString*>* value) {
    ...
    // Offset: 0xFFFFFFFF
    ::CsString* $AddStringBindings$b__3_0(::CsString* value) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<::CsString*>(this, "<AddStringBindings>b__3_0", value)));
    }
