...
namespace HMUI {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DA6270
  template<typename T>
  class InputFieldDataBinder::$$c__3_1 : public ::Il2CppObject {
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InputFieldDataBinder::$$c__3_1<T>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    ::Il2CppString* $AddStringBindings$b__3_0(::Il2CppString* value) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<AddStringBindings>b__3_0", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(value))));
