...
constexpr  ::HMUI::TextSegmentedControl::operator ::HMUI::____HMUI__SegmentedControl__IDataSource() const noexcept {
return ::HMUI::____HMUI__SegmentedControl__IDataSource(::bs_hook::Il2CppWrapperType::instance);
}
