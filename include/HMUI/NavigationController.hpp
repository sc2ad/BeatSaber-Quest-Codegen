...
namespace HMUI {
  ...
  class NavigationController : public HMUI::ContainerViewController {
    ...
    // Get instance field reference: private HMUI.NavigationController/Orientation _orientation
    ...
    // Get instance field reference: private HMUI.NavigationController/Alignment _alignment
