...
namespace HMUI {
  ...
  class NavigationController : public HMUI::ContainerViewController {
    ...
    check_size<sizeof(NavigationController::Orientation), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_NavigationController_OrientationSizeCheck;
    ...
    check_size<sizeof(NavigationController::Alignment), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __HMUI_NavigationController_AlignmentSizeCheck;
  ...
  check_size<sizeof(NavigationController), 144 + sizeof(float) + ((144 + sizeof(float)) % 8 != 0 ? (8 - (144 + sizeof(float)) % 8) : 0)> __HMUI_NavigationControllerSizeCheck;
}
