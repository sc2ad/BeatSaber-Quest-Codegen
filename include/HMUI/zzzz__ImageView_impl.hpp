...
constexpr ::HMUI::____HMUI__ImageView__GradientDirection::____HMUI__ImageView__GradientDirection(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::HMUI::____HMUI__ImageView__GradientDirection::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::HMUI::____HMUI__ImageView__GradientDirection::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::HMUI::____HMUI__ImageView__GradientDirection  ::HMUI::____HMUI__ImageView__GradientDirection::Horizontal{0};
constexpr ::HMUI::____HMUI__ImageView__GradientDirection  ::HMUI::____HMUI__ImageView__GradientDirection::Vertical{1};
...
constexpr void ::HMUI::ImageView::__set__gradientDirection(::HMUI::____HMUI__ImageView__GradientDirection value)  {
::cordl_internals::setInstanceField<::HMUI::____HMUI__ImageView__GradientDirection, 0x150>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::HMUI::____HMUI__ImageView__GradientDirection>(value));
}
constexpr ::HMUI::____HMUI__ImageView__GradientDirection ::HMUI::ImageView::__get__gradientDirection() const {
return ::cordl_internals::getInstanceField<::HMUI::____HMUI__ImageView__GradientDirection, 0x150>(this->::bs_hook::Il2CppWrapperType::instance);
}
