...
// Ctor Parameters []
 HMUI::CustomFormatRangeValuesSlider::CustomFormatRangeValuesSlider()  : HMUI::RangeValuesTextSlider(THROW_UNLESS(::il2cpp_utils::New<CustomFormatRangeValuesSlider>())) {}
