...
namespace Priority_Queue {
  ...
  class GenericPriorityQueueNode_1 : public ::Il2CppObject {
    ...
    TPriority _get_$Priority$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_get_$Priority$k__BackingField");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<TPriority>(___internal__instance, "<Priority>k__BackingField")));
    }
    // Autogenerated instance field setter
    // Set instance field: private TPriority <Priority>k__BackingField
    void _set_$Priority$k__BackingField(TPriority value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_set_$Priority$k__BackingField");
      static auto ___internal__instance = this;
    ...
    int _get_$QueueIndex$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_get_$QueueIndex$k__BackingField");
      static auto ___internal__instance = this;
    ...
    void _set_$QueueIndex$k__BackingField(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_set_$QueueIndex$k__BackingField");
      static auto ___internal__instance = this;
    ...
    int64_t _get_$InsertionIndex$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_get_$InsertionIndex$k__BackingField");
      static auto ___internal__instance = this;
    ...
    void _set_$InsertionIndex$k__BackingField(int64_t value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::GenericPriorityQueueNode_1::_set_$InsertionIndex$k__BackingField");
      static auto ___internal__instance = this;
