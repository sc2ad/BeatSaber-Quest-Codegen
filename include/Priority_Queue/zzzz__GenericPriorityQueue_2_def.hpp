...
static Priority_Queue::Priority_Queue__GenericPriorityQueue_2___GetEnumerator_d__25<TItem,float_t> New_ctor(int32_t __1__state) ;
...
static Priority_Queue::Priority_Queue__GenericPriorityQueue_2___GetEnumerator_d__25<TItem,TPriority> New_ctor(int32_t __1__state) ;
...
static Priority_Queue::GenericPriorityQueue_2<TItem,float_t> New_ctor(int32_t maxNodes) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(int32_t maxNodes) ;

static Priority_Queue::GenericPriorityQueue_2<TItem,float_t> New_ctor(int32_t maxNodes, System::Collections::Generic::IComparer_1<float_t> comparer) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(int32_t maxNodes, System::Collections::Generic::IComparer_1<float_t> comparer) ;

static Priority_Queue::GenericPriorityQueue_2<TItem,float_t> New_ctor(int32_t maxNodes, System::Comparison_1<float_t> comparer) ;
...
static Priority_Queue::GenericPriorityQueue_2<TItem,TPriority> New_ctor(int32_t maxNodes) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(int32_t maxNodes) ;

static Priority_Queue::GenericPriorityQueue_2<TItem,TPriority> New_ctor(int32_t maxNodes, System::Collections::Generic::IComparer_1<TPriority> comparer) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(int32_t maxNodes, System::Collections::Generic::IComparer_1<TPriority> comparer) ;

static Priority_Queue::GenericPriorityQueue_2<TItem,TPriority> New_ctor(int32_t maxNodes, System::Comparison_1<TPriority> comparer) ;
