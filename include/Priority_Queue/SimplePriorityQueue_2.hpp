...
namespace Priority_Queue {
  ...
  class SimplePriorityQueue_2 : public ::Il2CppObject/*, public Priority_Queue::IPriorityQueue_2<TItem, TPriority>*/ {
    ...
    class SimpleNode : public ::il2cpp_utils::il2cpp_type_check::NestedType, public Priority_Queue::GenericPriorityQueueNode_1<TPriority> {
      ...
      // [CompilerGeneratedAttribute] Offset: 0xD32ED0
    ...
    // Could not write size check! Type: Priority_Queue.SimplePriorityQueue`2/SimpleNode is generic, or has no fields that are valid for size checks!
    ...
    typename Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::SimpleNode* GetExistingNode(TItem item) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "GetExistingNode", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item)));
    ...
    void AddToNodeCache(typename Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::SimpleNode* node) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "AddToNodeCache", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(node)));
    ...
    void RemoveFromNodeCache(typename Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::SimpleNode* node) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "RemoveFromNodeCache", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(node)));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, node);
    }
    ...
    typename Priority_Queue::SimplePriorityQueue_2<TItem, TPriority>::SimpleNode* EnqueueNoLockOrCache(TItem item, TPriority priority) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "EnqueueNoLockOrCache", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
    ...
    void Enqueue(TItem item, TPriority priority) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Enqueue", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
    ...
    bool EnqueueWithoutDuplicates(TItem item, TPriority priority) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "EnqueueWithoutDuplicates", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
    ...
    void UpdatePriority(TItem item, TPriority priority) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "UpdatePriority", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
      ::il2cpp_utils::RunMethodThrow<void, false>(this, ___internal__method, item, priority);
    }
    ...
    TPriority GetPriority(TItem item) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "GetPriority", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item)));
    ...
    bool TryFirst(TItem& first) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryFirst", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(first)));
    ...
    bool TryDequeue(TItem& first) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryDequeue", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(first)));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, first);
    }
    ...
    bool TryRemove(TItem item) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryRemove", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item)));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, item);
    }
    ...
    bool TryUpdatePriority(TItem item, TPriority priority) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryUpdatePriority", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, item, priority);
    }
    ...
    bool TryGetPriority(TItem item, TPriority& priority) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "TryGetPriority", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(item, priority)));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, item, priority);
    }
