...
namespace Priority_Queue {
  ...
  class FastPriorityQueue_1 : public ::Il2CppObject/*, public Priority_Queue::IFixedSizePriorityQueue_2<T, float>*/ {
    ...
    void Enqueue(T node, float priority) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, node, priority)));
    }
    ...
    bool HasHigherPriority(T higher, T lower) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<bool, false>(this, ___internal__method, higher, lower)));
    }
