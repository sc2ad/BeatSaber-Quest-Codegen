...
namespace Priority_Queue {
  ...
  class FastPriorityQueue_1 : public ::Il2CppObject/*, public Priority_Queue::IFixedSizePriorityQueue_2<T, float>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D1CD94
    class $GetEnumerator$d__22 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<T>*/ {
      ...
      void System_IDisposable_Dispose_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::$GetEnumerator$d__22::System.IDisposable.Dispose_NEW");
      ...
      // Offset: 0xFFFFFFFF
      bool MoveNext_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::$GetEnumerator$d__22::MoveNext_NEW");
      ...
      T System_Collections_Generic_IEnumerator$T$_get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::$GetEnumerator$d__22::System.Collections.Generic.IEnumerator<T>.get_Current_NEW");
      ...
      void System_Collections_IEnumerator_Reset_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::$GetEnumerator$d__22::System.Collections.IEnumerator.Reset_NEW");
      ...
      ::Il2CppObject* System_Collections_IEnumerator_get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::$GetEnumerator$d__22::System.Collections.IEnumerator.get_Current_NEW");
    ...
    // Offset: 0xFFFFFFFF
    int get_Count_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::get_Count_NEW");
    ...
    // Offset: 0xFFFFFFFF
    int get_MaxSize_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::get_MaxSize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Clear_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Clear_NEW");
    ...
    bool Contains_NEW(T node) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Contains_NEW");
    ...
    void Enqueue_NEW(T node, float priority) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Enqueue_NEW");
    ...
    // Offset: 0xFFFFFFFF
    T Dequeue_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Dequeue_NEW");
    ...
    void Resize_NEW(int maxNodes) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Resize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    T get_First_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::get_First_NEW");
    ...
    void UpdatePriority_NEW(T node, float priority) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::UpdatePriority_NEW");
    ...
    void Remove_NEW(T node) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::Remove_NEW");
    ...
    void ResetNode_NEW(T node) {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::ResetNode_NEW");
    ...
    System::Collections::Generic::IEnumerator_1<T>* GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::GetEnumerator_NEW");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Priority_Queue::FastPriorityQueue_1::System.Collections.IEnumerable.GetEnumerator_NEW");
