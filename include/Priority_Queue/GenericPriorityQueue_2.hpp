...
namespace Priority_Queue {
  ...
  class GenericPriorityQueue_2 : public ::Il2CppObject/*, public ::Priority_Queue::IFixedSizePriorityQueue_2<TItem, TPriority>*/ {
    ...
    class $GetEnumerator$d__25 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public ::System::Collections::Generic::IEnumerator_1<TItem>*/ {
      ...
      // Creating interface conversion operator: i_IEnumerator_1_TItem
      inline ::System::Collections::Generic::IEnumerator_1<TItem>* i_IEnumerator_1_TItem() noexcept {
        return reinterpret_cast<::System::Collections::Generic::IEnumerator_1<TItem>*>(this);
      }
      ...
      [[deprecated("Use field access instead!")]] TItem& dyn_$$2__current() {
      ...
      [[deprecated("Use field access instead!")]] ::Priority_Queue::GenericPriorityQueue_2<TItem, TPriority>*& dyn_$$4__this() {
    ...
    // Creating interface conversion operator: i_IFixedSizePriorityQueue_2_TItem_TPriority
    inline ::Priority_Queue::IFixedSizePriorityQueue_2<TItem, TPriority>* i_IFixedSizePriorityQueue_2_TItem_TPriority() noexcept {
      return reinterpret_cast<::Priority_Queue::IFixedSizePriorityQueue_2<TItem, TPriority>*>(this);
    }
    // Autogenerated instance field getter
    ...
    [[deprecated("Use field access instead!")]] ::ArrayW<TItem>& dyn__nodes() {
    ...
    [[deprecated("Use field access instead!")]] int64_t& dyn__numNodesEverEnqueued() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Comparison_1<TPriority>*& dyn__comparer() {
