...
namespace Priority_Queue {
  ...
  class GenericPriorityQueue_2 : public ::Il2CppObject/*, public Priority_Queue::IFixedSizePriorityQueue_2<TItem, TPriority>*/ {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<TItem> nodes;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<TItem>) == 0x8);
    ...
    ::ArrayWrapper<TItem>& dyn__nodes() {
      ...
      return *reinterpret_cast<::ArrayWrapper<TItem>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
