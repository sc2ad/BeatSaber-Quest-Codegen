...
namespace JetBrains::Annotations {
  ...
  class XamlItemsControlAttribute : public System::Attribute {
    ...
    static XamlItemsControlAttribute* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("JetBrains::Annotations").WithContext("XamlItemsControlAttribute").WithContext(".ctor");
