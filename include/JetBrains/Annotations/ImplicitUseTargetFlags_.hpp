...
namespace JetBrains::Annotations {
  ...
  struct ImplicitUseTargetFlags_;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
DEFINE_IL2CPP_ARG_TYPE(::JetBrains::Annotations::ImplicitUseTargetFlags_, "JetBrains.Annotations", "ImplicitUseTargetFlags");
// Type namespace: JetBrains.Annotations
namespace JetBrains::Annotations {
  // Size: 0x4
  #pragma pack(push, 1)
  ...
  struct ImplicitUseTargetFlags_/*, public ::System::Enum*/ {
    public:
    public:
    ...
    public:
    // Creating value type constructor for type: ImplicitUseTargetFlags_
    constexpr ImplicitUseTargetFlags_(int value_ = {}) noexcept : value{value_} {}
    ...
    static ::JetBrains::Annotations::ImplicitUseTargetFlags_ _get_Default();
    // Set static field: static public JetBrains.Annotations.ImplicitUseTargetFlags Default
    static void _set_Default(::JetBrains::Annotations::ImplicitUseTargetFlags_ value);
    ...
    static ::JetBrains::Annotations::ImplicitUseTargetFlags_ _get_Itself();
    // Set static field: static public JetBrains.Annotations.ImplicitUseTargetFlags Itself
    static void _set_Itself(::JetBrains::Annotations::ImplicitUseTargetFlags_ value);
    ...
    static ::JetBrains::Annotations::ImplicitUseTargetFlags_ _get_Members();
    // Set static field: static public JetBrains.Annotations.ImplicitUseTargetFlags Members
    static void _set_Members(::JetBrains::Annotations::ImplicitUseTargetFlags_ value);
    ...
    static ::JetBrains::Annotations::ImplicitUseTargetFlags_ _get_WithMembers();
    // Set static field: static public JetBrains.Annotations.ImplicitUseTargetFlags WithMembers
    static void _set_WithMembers(::JetBrains::Annotations::ImplicitUseTargetFlags_ value);
    // Get instance field reference: public System.Int32 value__
    [[deprecated("Use field access instead!")]] int& dyn_value__();
  }; // JetBrains.Annotations.ImplicitUseTargetFlags
  #pragma pack(pop)
  static check_size<sizeof(ImplicitUseTargetFlags_), 0 + sizeof(int)> __JetBrains_Annotations_ImplicitUseTargetFlags_SizeCheck;
  static_assert(sizeof(ImplicitUseTargetFlags_) == 0x4);
}
