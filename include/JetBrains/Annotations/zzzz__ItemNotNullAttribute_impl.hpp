...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::ItemNotNullAttribute::*)()>(&JetBrains::Annotations::ItemNotNullAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d40a6c;
...
JetBrains::Annotations::ItemNotNullAttribute o{THROW_UNLESS(::il2cpp_utils::New<JetBrains::Annotations::ItemNotNullAttribute>())};
return o;
}
