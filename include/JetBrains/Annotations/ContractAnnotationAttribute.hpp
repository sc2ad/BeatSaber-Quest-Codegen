...
namespace JetBrains::Annotations {
  ...
  check_size<sizeof(ContractAnnotationAttribute), 24 + sizeof(bool) + ((24 + sizeof(bool)) % 8 != 0 ? (8 - (24 + sizeof(bool)) % 8) : 0)> __JetBrains_Annotations_ContractAnnotationAttributeSizeCheck;
}
