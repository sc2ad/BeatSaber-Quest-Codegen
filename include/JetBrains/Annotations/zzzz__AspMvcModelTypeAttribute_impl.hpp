...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::AspMvcModelTypeAttribute::*)()>(&JetBrains::Annotations::AspMvcModelTypeAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d41118;
...
JetBrains::Annotations::AspMvcModelTypeAttribute o{THROW_UNLESS(::il2cpp_utils::New<JetBrains::Annotations::AspMvcModelTypeAttribute>())};
return o;
}
