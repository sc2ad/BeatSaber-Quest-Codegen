...
namespace JetBrains::Annotations {
  ...
  check_size<sizeof(AspMvcAreaViewLocationFormatAttribute), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __JetBrains_Annotations_AspMvcAreaViewLocationFormatAttributeSizeCheck;
}
