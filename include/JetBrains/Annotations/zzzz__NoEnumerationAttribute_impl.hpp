...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::NoEnumerationAttribute::*)()>(&JetBrains::Annotations::NoEnumerationAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d41270;
...
JetBrains::Annotations::NoEnumerationAttribute o{THROW_UNLESS(::il2cpp_utils::New<JetBrains::Annotations::NoEnumerationAttribute>())};
return o;
}
