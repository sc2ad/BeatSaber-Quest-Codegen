...
static JetBrains::Annotations::AspMvcControllerAttribute New_ctor() ;

/// @brief Method .ctor addr 0x2d410d0 size 0x8 virtual false final false
 void _ctor() ;

static JetBrains::Annotations::AspMvcControllerAttribute New_ctor(::StringW anonymousProperty) ;
