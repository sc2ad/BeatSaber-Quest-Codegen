...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::RazorWriteMethodParameterAttribute::*)()>(&JetBrains::Annotations::RazorWriteMethodParameterAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d414c4;
...
JetBrains::Annotations::RazorWriteMethodParameterAttribute o{THROW_UNLESS(::il2cpp_utils::New<JetBrains::Annotations::RazorWriteMethodParameterAttribute>())};
return o;
}
