...
namespace JetBrains::Annotations {
  ...
  check_size<sizeof(LocalizationRequiredAttribute), 16 + sizeof(bool) + ((16 + sizeof(bool)) % 8 != 0 ? (8 - (16 + sizeof(bool)) % 8) : 0)> __JetBrains_Annotations_LocalizationRequiredAttributeSizeCheck;
}
