...
namespace JetBrains::Annotations {
  ...
  check_size<sizeof(AspMvcAreaMasterLocationFormatAttribute), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __JetBrains_Annotations_AspMvcAreaMasterLocationFormatAttributeSizeCheck;
}
