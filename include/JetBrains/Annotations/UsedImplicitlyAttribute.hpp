...
namespace JetBrains::Annotations {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: CA61BC
  class UsedImplicitlyAttribute : public System::Attribute {
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xCAAB74
    // [CompilerGeneratedAttribute] Offset: 0xCAAB74
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xCAABB0
    // [CompilerGeneratedAttribute] Offset: 0xCAABB0
