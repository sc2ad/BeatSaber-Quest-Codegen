...
namespace JetBrains::Annotations {
  ...
  check_size<sizeof(MeansImplicitUseAttribute), 20 + sizeof(JetBrains::Annotations::ImplicitUseTargetFlags) + ((20 + sizeof(JetBrains::Annotations::ImplicitUseTargetFlags)) % 8 != 0 ? (8 - (20 + sizeof(JetBrains::Annotations::ImplicitUseTargetFlags)) % 8) : 0)> __JetBrains_Annotations_MeansImplicitUseAttributeSizeCheck;
}
