...
namespace DigitalOpus::MB::Core {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB2_TexturePacker/DigitalOpus.MB.Core.ImageWidthComparer
  ...
  }; // DigitalOpus.MB.Core.MB2_TexturePacker/DigitalOpus.MB.Core.ImageWidthComparer
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
