...
namespace DigitalOpus::MB::Core {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerFast/DigitalOpus.MB.Core.<ConvertTexturesToReadableFormats>d__1
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerFast/DigitalOpus.MB.Core.<ConvertTexturesToReadableFormats>d__1
  #pragma pack(pop)
