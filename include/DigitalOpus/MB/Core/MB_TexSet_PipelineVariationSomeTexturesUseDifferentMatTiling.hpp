...
namespace DigitalOpus::MB::Core {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB_TexSet/DigitalOpus.MB.Core.PipelineVariationSomeTexturesUseDifferentMatTiling
  ...
  }; // DigitalOpus.MB.Core.MB_TexSet/DigitalOpus.MB.Core.PipelineVariationSomeTexturesUseDifferentMatTiling
  #pragma pack(pop)
