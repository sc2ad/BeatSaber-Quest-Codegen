...
namespace DigitalOpus::MB::Core {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/DigitalOpus.MB.Core.IPipeline
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPackerMeshBakerHorizontalVertical/DigitalOpus.MB.Core.IPipeline
  #pragma pack(pop)
}
