...
namespace DigitalOpus::MB::Core {
  // Size: 0x2C
  #pragma pack(push, 1)
  // Autogenerated type: DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/DigitalOpus.MB.Core.<CalculateIdealSizesForTexturesInAtlasAndPadding>d__11
  ...
  }; // DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/DigitalOpus.MB.Core.<CalculateIdealSizesForTexturesInAtlasAndPadding>d__11
  #pragma pack(pop)
