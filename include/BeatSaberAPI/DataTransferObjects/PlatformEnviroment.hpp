...
namespace BeatSaberAPI::DataTransferObjects {
  ...
  check_size<sizeof(PlatformEnviroment), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __BeatSaberAPI_DataTransferObjects_PlatformEnviromentSizeCheck;
}
