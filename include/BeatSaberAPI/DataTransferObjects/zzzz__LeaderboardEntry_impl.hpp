...
constexpr void BeatSaberAPI::DataTransferObjects::LeaderboardEntry::__set_gameplayModifiers(::ArrayW<BeatSaberAPI::DataTransferObjects::BeatSaberAPI__DataTransferObjects__LevelScoreResult__GameplayModifiers> value)  {
