...
namespace MasterServer {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: DA9BE4
  template<typename T>
  struct BaseClientMessageHandler::$OnSendFailedAwaitResponse$d__21_1/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    void MoveNext() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("$OnSendFailedAwaitResponse$d__21_1").WithContext("MoveNext");
    ...
    void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("$OnSendFailedAwaitResponse$d__21_1").WithContext("SetStateMachine");
  ...
  // Could not write size check! Type: MasterServer.BaseClientMessageHandler/<OnSendFailedAwaitResponse>d__21`1 is generic, or has no fields that are valid for size checks!
}
