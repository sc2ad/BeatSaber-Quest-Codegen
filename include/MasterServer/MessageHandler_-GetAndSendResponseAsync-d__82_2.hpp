...
namespace MasterServer {
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendResponseAsync>d__82`2
  template<typename TRequest, typename TResponse>
  struct MessageHandler::$GetAndSendResponseAsync$d__82_2 : public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine {
    public:
  ...
  }; // MasterServer.MessageHandler/<GetAndSendResponseAsync>d__82`2
}
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(MasterServer::MessageHandler::$GetAndSendResponseAsync$d__82_2, "MasterServer", "MessageHandler/<GetAndSendResponseAsync>d__82`2");
#pragma pack(pop)
