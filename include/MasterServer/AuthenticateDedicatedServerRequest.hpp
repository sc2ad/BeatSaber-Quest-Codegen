...
namespace MasterServer {
  ...
  check_size<sizeof(AuthenticateDedicatedServerRequest), 48 + sizeof(int64_t) + ((48 + sizeof(int64_t)) % 8 != 0 ? (8 - (48 + sizeof(int64_t)) % 8) : 0)> __MasterServer_AuthenticateDedicatedServerRequestSizeCheck;
}
