...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.BaseClientMessageHandler/<SendAuthenticatedRequestAsync>d__17`1
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D05610
  template<typename T>
  struct BaseClientMessageHandler::$SendAuthenticatedRequestAsync$d__17_1/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    public:
    ...
    // Offset: 0xFFFFFFFF
    void MoveNext_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::BaseClientMessageHandler::$SendAuthenticatedRequestAsync$d__17_1::MoveNext_NEW");
    ...
    void SetStateMachine_NEW(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::BaseClientMessageHandler::$SendAuthenticatedRequestAsync$d__17_1::SetStateMachine_NEW");
  ...
  }; // MasterServer.BaseClientMessageHandler/<SendAuthenticatedRequestAsync>d__17`1
  // Could not write size check! Type: MasterServer.BaseClientMessageHandler/<SendAuthenticatedRequestAsync>d__17`1 is generic, or has no fields that are valid for size checks!
}
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(MasterServer::BaseClientMessageHandler::$SendAuthenticatedRequestAsync$d__17_1, "MasterServer", "BaseClientMessageHandler/<SendAuthenticatedRequestAsync>d__17`1");
