...
namespace MasterServer {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D05700
  ...
  struct MessageHandler::$GetAndSendResponseAsync$d__81_2/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // Offset: 0xFFFFFFFF
    void MoveNext_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$GetAndSendResponseAsync$d__81_2::MoveNext_NEW");
    ...
    void SetStateMachine_NEW(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$GetAndSendResponseAsync$d__81_2::SetStateMachine_NEW");
