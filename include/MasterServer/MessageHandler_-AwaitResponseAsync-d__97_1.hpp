...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<AwaitResponseAsync>d__97`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED95C0
  template<typename T>
  struct MessageHandler::$AwaitResponseAsync$d__97_1/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // Autogenerated instance field getter
    // Get instance field: private MasterServer.MessageHandler/RequestWaiterId <waiterId>5__2
  ...
  }; // MasterServer.MessageHandler/<AwaitResponseAsync>d__97`1
  // Could not write size check! Type: MasterServer.MessageHandler/<AwaitResponseAsync>d__97`1 is generic, or has no fields that are valid for size checks!
}
