...
namespace MasterServer {
  ...
  check_size<sizeof(UserMessageHandler::$$c__DisplayClass34_0::$$StartBroadcastingServer$b__1$d), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<MasterServer::BroadcastServerStatusResponse*>) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<MasterServer::BroadcastServerStatusResponse*>)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<MasterServer::BroadcastServerStatusResponse*>)) % 8) : 0)> __MasterServer_UserMessageHandler_$$c__DisplayClass34_0_$$StartBroadcastingServer$b__1$dSizeCheck;
}
