...
namespace MasterServer {
  ...
  class BaseAnalyticsManager : public ::Il2CppObject/*, public MasterServer::IAnalyticsManager*/ {
    ...
    // Creating interface conversion operator: operator MasterServer::IAnalyticsManager
    operator MasterServer::IAnalyticsManager() noexcept {
      return *reinterpret_cast<MasterServer::IAnalyticsManager*>(this);
    }
