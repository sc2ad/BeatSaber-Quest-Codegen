...
namespace MasterServer {
  ...
  check_size<sizeof(BaseClientMessageHandler::$ReauthenticateWithMasterServer$d__22), 40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __MasterServer_BaseClientMessageHandler_$ReauthenticateWithMasterServer$d__22SizeCheck;
}
