...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendResponse>d__83`2
  // [CompilerGeneratedAttribute] Offset: DF07B0
  ...
  }; // MasterServer.MessageHandler/<GetAndSendResponse>d__83`2
