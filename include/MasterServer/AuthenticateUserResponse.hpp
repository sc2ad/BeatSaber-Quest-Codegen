...
namespace MasterServer {
  ...
  class AuthenticateUserResponse : public GlobalNamespace::BaseMasterServerReliableResponse/*, public MasterServer::IUserServerToClientMessage, public MasterServer::IMasterServerAuthenticateResponse*/ {
    ...
    check_size<sizeof(AuthenticateUserResponse::Result), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __MasterServer_AuthenticateUserResponse_ResultSizeCheck;
  ...
  check_size<sizeof(AuthenticateUserResponse), 24 + sizeof(MasterServer::AuthenticateUserResponse::Result) + ((24 + sizeof(MasterServer::AuthenticateUserResponse::Result)) % 8 != 0 ? (8 - (24 + sizeof(MasterServer::AuthenticateUserResponse::Result)) % 8) : 0)> __MasterServer_AuthenticateUserResponseSizeCheck;
}
