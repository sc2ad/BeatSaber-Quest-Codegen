...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__102`1
  // [CompilerGeneratedAttribute] Offset: DEF8EC
  template<typename T>
  ...
  }; // MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__102`1
  // Could not write size check! Type: MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__102`1 is generic, or has no fields that are valid for size checks!
}
