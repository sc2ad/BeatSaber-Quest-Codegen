...
namespace MasterServer {
  ...
  class BaseMasterServerMultipartMessage : public GlobalNamespace::BaseMasterServerReliableRequest/*, public MasterServer::IMasterServerMultipartMessage*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD1B344
    ...
    // [CompilerGeneratedAttribute] Offset: 0xD1B354
    ...
    // [CompilerGeneratedAttribute] Offset: 0xD1B364
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xD1B374
