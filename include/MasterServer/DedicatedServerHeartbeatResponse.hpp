...
namespace MasterServer {
  ...
  class DedicatedServerHeartbeatResponse : public ::Il2CppObject/*, public MasterServer::IDedicatedServerServerToClientMessage, public MasterServer::IMasterServerUnreliableMessage*/ {
    public:
