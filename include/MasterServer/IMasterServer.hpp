...
namespace MasterServer {
  ...
  class IMasterServer {
    ...
    // Offset: 0xFFFFFFFF
    System::Threading::Tasks::Task_1<bool>* TryAuthenticateUser_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, GlobalNamespace::AuthenticationToken authenticationToken);
    ...
    // Offset: 0xFFFFFFFF
    bool TryAuthenticateDedicatedServer_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* id, ::Array<uint8_t>* nonce, ::Array<uint8_t>* hash, int64_t timestamp);
    ...
    // Offset: 0xFFFFFFFF
    System::Threading::Tasks::Task_1<MasterServer::BroadcastServerHeartbeatResponse*>* TryHeartbeatUserServer_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* userId, ::Il2CppString* userName, ::Il2CppString* secret, int currentPlayerCount);
    ...
    // Offset: 0xFFFFFFFF
    void TryRemoveServer_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* userId, ::Il2CppString* userName, ::Il2CppString* secret);
    ...
    // Offset: 0xFFFFFFFF
    System::Threading::Tasks::Task_1<MasterServer::ConnectToServerResponse*>* TryGetServer_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* userId, ::Il2CppString* userName, ::Il2CppString* secret, ::Il2CppString* code, ::Il2CppString* password, ::Array<uint8_t>* random, ::Array<uint8_t>* publicKey, bool useRelay);
    ...
    // Offset: 0xFFFFFFFF
    System::Threading::Tasks::Task_1<MasterServer::ConnectToServerResponse*>* TryGetMatchmakingServer_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* userId, ::Il2CppString* userName, GlobalNamespace::GameplayServerConfiguration configuration, ::Array<uint8_t>* random, ::Array<uint8_t>* publicKey, ::Il2CppString* secret);
    ...
    // Offset: 0xFFFFFFFF
    System::Threading::Tasks::Task_1<MasterServer::GetPublicServersResponse*>* TryGetPublicServers_NEW(uint protocolVersion, System::Net::IPEndPoint* endPoint, ::Il2CppString* userId, ::Il2CppString* userName, int offset, int count, GlobalNamespace::GameplayServerFilter filter);
    ...
    // Offset: 0xFFFFFFFF
    void HeartbeatDedicatedServer_NEW(uint protocolVersion, ::Il2CppString* dedicatedServerId, int64_t dedicatedServerCreationTime, System::Net::IPEndPoint* endPoint, int cpuUtilization, int occupiedServerSlotCount, int unoccupiedServerSlotCount);
    ...
    // Offset: 0xFFFFFFFF
    void UpdateRelayServerStatus_NEW(uint protocolVersion, ::Il2CppString* dedicatedServerId, int64_t dedicatedServerCreationTime, System::Net::IPEndPoint* endPoint, ::Il2CppString* id, int currentPlayerCount);
    ...
    // Offset: 0xFFFFFFFF
    void UpdateMatchmakingServerStatus_NEW(uint protocolVersion, ::Il2CppString* dedicatedServerId, int64_t dedicatedServerCreationTime, System::Net::IPEndPoint* endPoint, ::Il2CppString* id, GlobalNamespace::GameplayServerFiniteStateMachine::GameStateType gameState, int currentPlayerCount);
    ...
    // Offset: 0xFFFFFFFF
    void SetDedicatedServerNoLongerOccupied_NEW(uint protocolVersion, ::Il2CppString* dedicatedServerId, int64_t dedicatedServerCreationTime, System::Net::IPEndPoint* endPoint, ::Il2CppString* id);
    ...
    // Offset: 0xFFFFFFFF
    void RemoveDedicatedServer_NEW(uint protocolVersion, ::Il2CppString* dedicatedServerId, int64_t dedicatedServerCreationTime, System::Net::IPEndPoint* endPoint);
    // public System.Boolean ShouldHandleMessageFromEndPoint(System.Net.IPEndPoint remoteEndPoint)
    // Offset: 0xFFFFFFFF
    bool ShouldHandleMessageFromEndPoint_NEW(System::Net::IPEndPoint* remoteEndPoint);
    // public System.Void ReportExceptionForEndPoint(System.Net.IPEndPoint remoteEndPoint, System.Exception exception)
    // Offset: 0xFFFFFFFF
    void ReportExceptionForEndPoint_NEW(System::Net::IPEndPoint* remoteEndPoint, System::Exception* exception);
