...
namespace MasterServer {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D05760
  template<typename T>
  struct MessageHandler::$SendMessageWithRetryAwaitResponseAsync$d__99_1/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // Offset: 0xFFFFFFFF
    void MoveNext_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$SendMessageWithRetryAwaitResponseAsync$d__99_1::MoveNext_NEW");
    ...
    void SetStateMachine_NEW(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$SendMessageWithRetryAwaitResponseAsync$d__99_1::SetStateMachine_NEW");
