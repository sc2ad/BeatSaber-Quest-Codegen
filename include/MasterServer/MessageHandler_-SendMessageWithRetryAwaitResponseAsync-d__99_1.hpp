...
namespace MasterServer {
  ...
  struct MessageHandler::$SendMessageWithRetryAwaitResponseAsync$d__99_1 : public System::ValueType/*, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    void MoveNext() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("$SendMessageWithRetryAwaitResponseAsync$d__99_1").WithContext("MoveNext");
    ...
    void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("MasterServer").WithContext("$SendMessageWithRetryAwaitResponseAsync$d__99_1").WithContext("SetStateMachine");
  ...
  // Could not write size check! Type: MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__99`1 is generic!
}
