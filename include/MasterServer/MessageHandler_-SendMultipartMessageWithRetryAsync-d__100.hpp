...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/MasterServer.<SendMultipartMessageWithRetryAsync>d__100
  ...
  struct MessageHandler::$SendMultipartMessageWithRetryAsync$d__100/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // private MasterServer.MessageHandler/MasterServer.<>c__DisplayClass100_0 <>8__1
    // Size: 0x8
    // Offset: 0x58
    ...
    LiteNetLib::Utils::NetDataWriter* _get_data();
    // Set instance field: public LiteNetLib.Utils.NetDataWriter data
    void _set_data(LiteNetLib::Utils::NetDataWriter* value);
  ...
  }; // MasterServer.MessageHandler/MasterServer.<SendMultipartMessageWithRetryAsync>d__100
