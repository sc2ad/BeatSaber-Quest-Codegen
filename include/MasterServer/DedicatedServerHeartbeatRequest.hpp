...
namespace MasterServer {
  ...
  class DedicatedServerHeartbeatRequest : public ::Il2CppObject/*, public MasterServer::IDedicatedServerClientToServerMessage, public MasterServer::IMasterServerUnreliableMessage*/ {
    public:
