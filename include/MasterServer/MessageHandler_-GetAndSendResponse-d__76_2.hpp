...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendResponse>d__76`2
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED9530
  ...
  }; // MasterServer.MessageHandler/<GetAndSendResponse>d__76`2
  // Could not write size check! Type: MasterServer.MessageHandler/<GetAndSendResponse>d__76`2 is generic, or has no fields that are valid for size checks!
}
