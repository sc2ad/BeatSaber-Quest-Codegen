...
namespace MasterServer {
  ...
  check_size<sizeof(UserMessageHandler::$GetAuthenticationRequest$d__28), 40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AuthenticationToken>) + ((40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AuthenticationToken>)) % 8 != 0 ? (8 - (40 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::AuthenticationToken>)) % 8) : 0)> __MasterServer_UserMessageHandler_$GetAuthenticationRequest$d__28SizeCheck;
}
