...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<>c__DisplayClass71_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED9520
  template<typename T>
  class MessageHandler::$$c__DisplayClass71_0_1 : public ::Il2CppObject {
    ...
    MasterServer::MessageHandler*& dyn_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::dyn_$$4__this");
    ...
    System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>*& dyn_customHandler() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::dyn_customHandler");
      auto ___internal__instance = this;
  ...
  }; // MasterServer.MessageHandler/<>c__DisplayClass71_0`1
  // Could not write size check! Type: MasterServer.MessageHandler/<>c__DisplayClass71_0`1 is generic, or has no fields that are valid for size checks!
}
