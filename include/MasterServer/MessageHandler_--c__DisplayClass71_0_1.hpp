...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/MasterServer.<>c__DisplayClass71_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: FFFFFFFF
  template<typename T>
  class MessageHandler::$$c__DisplayClass71_0_1 : public ::Il2CppObject {
    public:
    ...
    // Creating value type constructor for type: $$c__DisplayClass71_0_1
    $$c__DisplayClass71_0_1(MasterServer::MessageHandler* $$4__this_ = {}, System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>* customHandler_ = {}) noexcept : $$4__this{$$4__this_}, customHandler{customHandler_} {}
    // Autogenerated instance field getter
    // Get instance field: public MasterServer.MessageHandler <>4__this
    MasterServer::MessageHandler* _get_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::_get_$$4__this");
    ...
    void _set_$$4__this(MasterServer::MessageHandler* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::_set_$$4__this");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<>4__this"))->offset;
    ...
    System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>* _get_customHandler() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::_get_customHandler");
      auto ___internal__instance = this;
    ...
    void _set_customHandler(System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::_set_customHandler");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "customHandler"))->offset;
    ...
    static MessageHandler::$$c__DisplayClass71_0_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass71_0_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MessageHandler::$$c__DisplayClass71_0_1<T>*, creationType>()));
    }
  }; // MasterServer.MessageHandler/MasterServer.<>c__DisplayClass71_0`1
  // Could not write size check! Type: MasterServer.MessageHandler/MasterServer.<>c__DisplayClass71_0`1 is generic, or has no fields that are valid for size checks!
}
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(MasterServer::MessageHandler::$$c__DisplayClass71_0_1, "MasterServer", "MessageHandler/<>c__DisplayClass71_0`1");
#include "extern/beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
