...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendResponseAsync>d__84`2
  // [CompilerGeneratedAttribute] Offset: DF07C0
  ...
  }; // MasterServer.MessageHandler/<GetAndSendResponseAsync>d__84`2
  // Could not write size check! Type: MasterServer.MessageHandler/<GetAndSendResponseAsync>d__84`2 is generic, or has no fields that are valid for size checks!
}
