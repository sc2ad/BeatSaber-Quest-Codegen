...
namespace MasterServer {
  ...
  struct BaseClientMessageHandler::$SendOrderedAuthenticatedRequest$d__18/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    ::Il2CppString* _get_queue();
    // Set instance field: public System.String queue
    void _set_queue(::Il2CppString* value);
    ...
    System::Threading::Tasks::Task* _get_$task$5__2();
    // Set instance field: private System.Threading.Tasks.Task <task>5__2
    void _set_$task$5__2(System::Threading::Tasks::Task* value);
