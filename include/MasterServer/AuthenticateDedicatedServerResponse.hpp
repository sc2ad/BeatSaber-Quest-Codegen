...
namespace MasterServer {
  ...
  class AuthenticateDedicatedServerResponse : public GlobalNamespace::BaseMasterServerReliableResponse/*, public MasterServer::IDedicatedServerServerToClientMessage, public MasterServer::IMasterServerAuthenticateResponse*/ {
    ...
    check_size<sizeof(AuthenticateDedicatedServerResponse::Result), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __MasterServer_AuthenticateDedicatedServerResponse_ResultSizeCheck;
  ...
  check_size<sizeof(AuthenticateDedicatedServerResponse), 24 + sizeof(MasterServer::AuthenticateDedicatedServerResponse::Result) + ((24 + sizeof(MasterServer::AuthenticateDedicatedServerResponse::Result)) % 8 != 0 ? (8 - (24 + sizeof(MasterServer::AuthenticateDedicatedServerResponse::Result)) % 8) : 0)> __MasterServer_AuthenticateDedicatedServerResponseSizeCheck;
}
