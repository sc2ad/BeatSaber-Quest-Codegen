...
namespace MasterServer {
  ...
  class GetPublicServersResponse : public GlobalNamespace::BaseMasterServerReliableResponse/*, public MasterServer::IUserServerToClientMessage*/ {
    ...
    check_size<sizeof(GetPublicServersResponse::Result), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __MasterServer_GetPublicServersResponse_ResultSizeCheck;
  ...
  check_size<sizeof(GetPublicServersResponse), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __MasterServer_GetPublicServersResponseSizeCheck;
}
