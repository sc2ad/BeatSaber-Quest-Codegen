...
namespace MasterServer {
  ...
  class DedicatedServerShutDownRequest : public ::Il2CppObject/*, public MasterServer::IDedicatedServerClientToServerMessage, public MasterServer::IMasterServerUnreliableMessage*/ {
    public:
