...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__78`2
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED9550
  ...
  }; // MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__78`2
  // Could not write size check! Type: MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__78`2 is generic, or has no fields that are valid for size checks!
}
