...
namespace MasterServer {
  ...
  class MessageHandler : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    check_size<sizeof(MessageHandler::RequestWaiterId), 8 + sizeof(uint) + 8 - (8 + sizeof(uint)) % 8> __MasterServer_MessageHandler_RequestWaiterIdSizeCheck;
    ...
    check_size<sizeof(MessageHandler::MessageOrigin), 8 + sizeof(uint) + 8 - (8 + sizeof(uint)) % 8> __MasterServer_MessageHandler_MessageOriginSizeCheck;
    ...
    check_size<sizeof(MessageHandler::HandshakeMessageType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __MasterServer_MessageHandler_HandshakeMessageTypeSizeCheck;
    ...
    check_size<sizeof(MessageHandler::UserMessageType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __MasterServer_MessageHandler_UserMessageTypeSizeCheck;
    ...
    check_size<sizeof(MessageHandler::DedicatedServerMessageType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __MasterServer_MessageHandler_DedicatedServerMessageTypeSizeCheck;
  ...
  check_size<sizeof(MessageHandler), 120 + sizeof(void*) + 8 - (120 + sizeof(void*)) % 8> __MasterServer_MessageHandlerSizeCheck;
}
