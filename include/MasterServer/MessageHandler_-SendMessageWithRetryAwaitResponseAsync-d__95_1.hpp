...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__95`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED95A0
  template<typename T>
  struct MessageHandler::$SendMessageWithRetryAwaitResponseAsync$d__95_1/*, public System::ValueType, public System::Runtime::CompilerServices::IAsyncStateMachine*/ {
    ...
    // Autogenerated instance field getter
    // Get instance field: private MasterServer.MessageHandler/RequestResponseWaiter <request>5__2
    ...
    // Autogenerated instance field getter
    // Get instance field: private MasterServer.MessageHandler/RequestWaiterId <waiterId>5__3
  ...
  }; // MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__95`1
  // Could not write size check! Type: MasterServer.MessageHandler/<SendMessageWithRetryAwaitResponseAsync>d__95`1 is generic, or has no fields that are valid for size checks!
}
