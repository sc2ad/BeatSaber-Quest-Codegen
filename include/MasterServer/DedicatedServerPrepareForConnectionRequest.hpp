...
namespace MasterServer {
  ...
  check_size<sizeof(DedicatedServerPrepareForConnectionRequest), 64 + sizeof(void*) + 8 - (64 + sizeof(void*)) % 8> __MasterServer_DedicatedServerPrepareForConnectionRequestSizeCheck;
}
