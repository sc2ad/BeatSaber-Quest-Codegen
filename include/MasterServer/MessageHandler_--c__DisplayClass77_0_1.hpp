...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/MasterServer.<>c__DisplayClass77_0`1
  ...
  class MessageHandler::$$c__DisplayClass77_0_1 : public ::Il2CppObject {
    ...
    MasterServer::MessageHandler* _get_$$4__this() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass77_0_1::_get_$$4__this");
    ...
    void _set_$$4__this(MasterServer::MessageHandler* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass77_0_1::_set_$$4__this");
      static auto ___internal__instance = this;
    ...
    System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>* _get_customHandler() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass77_0_1::_get_customHandler");
      static auto ___internal__instance = this;
    ...
    void _set_customHandler(System::Action_2<T, MasterServer::MessageHandler::MessageOrigin>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass77_0_1::_set_customHandler");
      static auto ___internal__instance = this;
  ...
  }; // MasterServer.MessageHandler/MasterServer.<>c__DisplayClass77_0`1
  // Could not write size check! Type: MasterServer.MessageHandler/MasterServer.<>c__DisplayClass77_0`1 is generic, or has no fields that are valid for size checks!
}
