...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__85`2
  // [CompilerGeneratedAttribute] Offset: DF07D0
  ...
  }; // MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__85`2
  // Could not write size check! Type: MasterServer.MessageHandler/<GetAndSendUnreilableResponse>d__85`2 is generic, or has no fields that are valid for size checks!
}
