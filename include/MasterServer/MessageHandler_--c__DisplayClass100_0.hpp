...
namespace MasterServer {
  // Size: 0x30
  #pragma pack(push, 1)
  // Autogenerated type: MasterServer.MessageHandler/<>c__DisplayClass100_0
  // [CompilerGeneratedAttribute] Offset: DF07F0
  ...
  }; // MasterServer.MessageHandler/<>c__DisplayClass100_0
  #pragma pack(pop)
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Threading::Tasks::Task* (MasterServer::MessageHandler::$$c__DisplayClass100_0::*)(MasterServer::IMasterServerReliableRequest*)>(&MasterServer::MessageHandler::$$c__DisplayClass100_0::$SendMultipartMessageWithRetryAsync$b__0)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(MasterServer::MessageHandler::$$c__DisplayClass100_0*), "<SendMultipartMessageWithRetryAsync>b__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<MasterServer::IMasterServerReliableRequest*>()});
  }
};
// Writing MetadataGetter for method: MasterServer::MessageHandler::$$c__DisplayClass100_0::New_ctor
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MasterServer::MessageHandler::$$c__DisplayClass100_0::*)()>(&MasterServer::MessageHandler::$$c__DisplayClass100_0::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(MasterServer::MessageHandler::$$c__DisplayClass100_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MasterServer::MessageHandler::$$c__DisplayClass100_0::*)()>(&MasterServer::MessageHandler::$$c__DisplayClass100_0::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(MasterServer::MessageHandler::$$c__DisplayClass100_0*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
