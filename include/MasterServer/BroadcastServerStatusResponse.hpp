...
namespace MasterServer {
  ...
  class BroadcastServerStatusResponse : public GlobalNamespace::BaseMasterServerReliableResponse/*, public MasterServer::IUserServerToClientMessage*/ {
    ...
    check_size<sizeof(BroadcastServerStatusResponse::Result), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __MasterServer_BroadcastServerStatusResponse_ResultSizeCheck;
  ...
  check_size<sizeof(BroadcastServerStatusResponse), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __MasterServer_BroadcastServerStatusResponseSizeCheck;
}
