...
namespace MasterServer {
  ...
  check_size<sizeof(UserMessageHandler::$WithFailureHandler$d__40), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __MasterServer_UserMessageHandler_$WithFailureHandler$d__40SizeCheck;
}
