...
namespace MasterServer {
  // Size: 0x40
  #pragma pack(push, 1)
  // Autogenerated type: MasterServer.UserMessageHandler/MasterServer.<WithFailureHandler>d__40
  ...
  }; // MasterServer.UserMessageHandler/MasterServer.<WithFailureHandler>d__40
  #pragma pack(pop)
