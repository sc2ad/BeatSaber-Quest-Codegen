...
namespace MasterServer {
  ...
  check_size<sizeof(ServerCertificateRequest::$get_certificateList$d__5), 48 + sizeof(int) + ((48 + sizeof(int)) % 8 != 0 ? (8 - (48 + sizeof(int)) % 8) : 0)> __MasterServer_ServerCertificateRequest_$get_certificateList$d__5SizeCheck;
}
