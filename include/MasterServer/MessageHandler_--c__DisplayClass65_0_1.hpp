...
namespace MasterServer {
  ...
  class MessageHandler::$$c__DisplayClass65_0_1 : public ::Il2CppObject {
    ...
    System::Func_2<uint, T>* _get_obtain() {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass65_0_1::_get_obtain");
    ...
    void _set_obtain(System::Func_2<uint, T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("MasterServer::MessageHandler::$$c__DisplayClass65_0_1::_set_obtain");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "obtain"))->offset;
