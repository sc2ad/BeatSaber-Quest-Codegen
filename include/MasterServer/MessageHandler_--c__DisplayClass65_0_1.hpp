...
namespace MasterServer {
  ...
  // Autogenerated type: MasterServer.MessageHandler/<>c__DisplayClass65_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ED9500
  template<typename T>
  ...
  }; // MasterServer.MessageHandler/<>c__DisplayClass65_0`1
  // Could not write size check! Type: MasterServer.MessageHandler/<>c__DisplayClass65_0`1 is generic, or has no fields that are valid for size checks!
}
