...
namespace MasterServer {
  ...
  check_size<sizeof(BaseClientMessageHandler::$OnSendFailed$d__20), 72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (72 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __MasterServer_BaseClientMessageHandler_$OnSendFailed$d__20SizeCheck;
}
