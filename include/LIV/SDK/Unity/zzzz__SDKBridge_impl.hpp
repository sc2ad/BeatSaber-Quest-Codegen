...
constexpr ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::____LIV__SDK__Unity__SDKBridge__SDKInjection_1(bool active, ::System::Action action, T data) noexcept : ::bs_hook::ValueTypeWrapper() {this->active = active;
this->action = action;
this->data = data;
}
constexpr void ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__set_active(bool value)  {
::cordl_internals::setInstanceField<bool, 0x0>(this->__instance, std::forward<bool>(value));
}
constexpr bool ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__get_active() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->__instance);
}
constexpr void ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__set_action(::System::Action value)  {
::cordl_internals::setInstanceField<::System::Action, 0x8>(this->__instance, std::forward<::System::Action>(value));
}
constexpr ::System::Action ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__get_action() const {
return ::cordl_internals::getInstanceField<::System::Action, 0x8>(this->__instance);
}
constexpr void ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__set_data(T value)  {
::cordl_internals::setInstanceField<T, 0x10>(this->__instance, std::forward<T>(value));
}
constexpr T ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1::__get_data() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<::LIV::SDK::Unity::SDKResolution>)>(&::LIV::SDK::Unity::SDKBridge::GetResolution)> {
 ...
 void ::LIV::SDK::Unity::SDKBridge::__set__injection_SDKInputFrame(::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame> value)  {
::cordl_internals::setStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame>, "_injection_SDKInputFrame", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>(std::forward<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame>>(value));
}
 ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame> ::LIV::SDK::Unity::SDKBridge::__get__injection_SDKInputFrame()  {
return ::cordl_internals::getStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKInputFrame>, "_injection_SDKInputFrame", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>();
}
 void ::LIV::SDK::Unity::SDKBridge::__set__injection_SDKResolution(::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution> value)  {
::cordl_internals::setStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution>, "_injection_SDKResolution", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>(std::forward<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution>>(value));
 ...
 ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution> ::LIV::SDK::Unity::SDKBridge::__get__injection_SDKResolution()  {
return ::cordl_internals::getStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<::LIV::SDK::Unity::SDKResolution>, "_injection_SDKResolution", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>();
}
 void ::LIV::SDK::Unity::SDKBridge::__set__injection_IsActive(::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<bool> value)  {
::cordl_internals::setStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<bool>, "_injection_IsActive", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>(std::forward<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<bool>>(value));
}
 ::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<bool> ::LIV::SDK::Unity::SDKBridge::__get__injection_IsActive()  {
return ::cordl_internals::getStaticField<::LIV::SDK::Unity::____LIV__SDK__Unity__SDKBridge__SDKInjection_1<bool>, "_injection_IsActive", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::LIV::SDK::Unity::SDKBridge>::get>();
}
