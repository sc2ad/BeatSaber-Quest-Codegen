...
namespace LIV::SDK::Unity {
  ...
  check_size<sizeof(LIV), 44 + sizeof(UnityEngine::LayerMask) + ((44 + sizeof(UnityEngine::LayerMask)) % 8 != 0 ? (8 - (44 + sizeof(UnityEngine::LayerMask)) % 8) : 0)> __LIV_SDK_Unity_LIVSizeCheck;
}
