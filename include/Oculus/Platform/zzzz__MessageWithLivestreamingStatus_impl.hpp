...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LivestreamingStatus (Oculus::Platform::MessageWithLivestreamingStatus::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLivestreamingStatus::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLivestreamingStatus Oculus::Platform::MessageWithLivestreamingStatus::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLivestreamingStatus o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLivestreamingStatus>(c_message))};
return o;
}
