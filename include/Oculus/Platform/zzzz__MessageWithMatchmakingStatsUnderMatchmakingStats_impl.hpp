...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::MatchmakingStats (Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats>(c_message))};
return o;
}
