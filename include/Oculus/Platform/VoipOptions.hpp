...
namespace Oculus::Platform {
  ...
  check_size<sizeof(VoipOptions), 16 + sizeof(System::IntPtr) + ((16 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (16 + sizeof(System::IntPtr)) % 8) : 0)> __Oculus_Platform_VoipOptionsSizeCheck;
}
