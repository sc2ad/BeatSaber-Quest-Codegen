...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AchievementDefinitionList (Oculus::Platform::MessageWithAchievementDefinitions::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAchievementDefinitions::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAchievementDefinitions Oculus::Platform::MessageWithAchievementDefinitions::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAchievementDefinitions o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAchievementDefinitions>(c_message))};
return o;
}
