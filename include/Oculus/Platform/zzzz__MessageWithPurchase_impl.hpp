...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Purchase (Oculus::Platform::MessageWithPurchase::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithPurchase::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithPurchase Oculus::Platform::MessageWithPurchase::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithPurchase o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithPurchase>(c_message))};
return o;
}
