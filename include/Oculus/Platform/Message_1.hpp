...
namespace Oculus::Platform {
  ...
  class Message_1 : public Oculus::Platform::Message {
    ...
    T _get_data() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Message_1::_get_data");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<T>(___internal__instance, "data"));
    }
    // Autogenerated instance field setter
    // Set instance field: private T data
    void _set_data(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Message_1::_set_data");
      static auto ___internal__instance = this;
