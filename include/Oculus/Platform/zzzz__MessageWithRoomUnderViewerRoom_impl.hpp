...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Room (Oculus::Platform::MessageWithRoomUnderViewerRoom::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithRoomUnderViewerRoom::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithRoomUnderViewerRoom Oculus::Platform::MessageWithRoomUnderViewerRoom::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithRoomUnderViewerRoom o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithRoomUnderViewerRoom>(c_message))};
return o;
}
