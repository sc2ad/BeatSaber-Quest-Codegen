...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Room (Oculus::Platform::MessageWithMatchmakingNotification::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithMatchmakingNotification::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithMatchmakingNotification Oculus::Platform::MessageWithMatchmakingNotification::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithMatchmakingNotification o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithMatchmakingNotification>(c_message))};
return o;
}
