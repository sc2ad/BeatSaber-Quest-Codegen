...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AssetFileDeleteResult (Oculus::Platform::MessageWithAssetFileDeleteResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAssetFileDeleteResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAssetFileDeleteResult Oculus::Platform::MessageWithAssetFileDeleteResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAssetFileDeleteResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAssetFileDeleteResult>(c_message))};
return o;
}
