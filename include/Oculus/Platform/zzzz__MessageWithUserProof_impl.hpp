...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::UserProof (Oculus::Platform::MessageWithUserProof::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithUserProof::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithUserProof Oculus::Platform::MessageWithUserProof::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithUserProof o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithUserProof>(c_message))};
return o;
}
