...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4465 }), TypeDefinitionIndex(TypeDefinitionIndex(13455)), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
