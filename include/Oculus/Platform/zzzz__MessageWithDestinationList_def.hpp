...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13203)), TypeDefinitionIndex(TypeDefinitionIndex(13412)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4444 })}
