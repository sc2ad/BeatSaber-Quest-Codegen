...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 952 }), TypeDefinitionIndex(TypeDefinitionIndex(13468)), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
