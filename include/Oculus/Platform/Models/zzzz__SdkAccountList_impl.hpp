...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::SdkAccountList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::SdkAccountList::_ctor)> {
 ...
 Oculus::Platform::Models::SdkAccountList Oculus::Platform::Models::SdkAccountList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::SdkAccountList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::SdkAccountList>(a))};
return o;
}
