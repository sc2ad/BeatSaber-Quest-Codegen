...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(LeaderboardEntryList), 40 + sizeof(uint64_t) + ((40 + sizeof(uint64_t)) % 8 != 0 ? (8 - (40 + sizeof(uint64_t)) % 8) : 0)> __Oculus_Platform_Models_LeaderboardEntryListSizeCheck;
}
