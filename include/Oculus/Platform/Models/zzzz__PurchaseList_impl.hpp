...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::PurchaseList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::PurchaseList::_ctor)> {
 ...
 Oculus::Platform::Models::PurchaseList Oculus::Platform::Models::PurchaseList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::PurchaseList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::PurchaseList>(a))};
return o;
}
