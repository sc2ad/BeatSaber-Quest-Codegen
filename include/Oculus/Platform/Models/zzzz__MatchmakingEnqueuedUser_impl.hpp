...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::MatchmakingEnqueuedUser::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::MatchmakingEnqueuedUser::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25a0a44;
...
return ::cordl_internals::getInstanceField<Oculus::Platform::Models::User, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Oculus::Platform::Models::MatchmakingEnqueuedUser Oculus::Platform::Models::MatchmakingEnqueuedUser::New_ctor(::cordl_internals::intptr_t o)  {
Oculus::Platform::Models::MatchmakingEnqueuedUser o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::MatchmakingEnqueuedUser>(o))};
return o;
}
