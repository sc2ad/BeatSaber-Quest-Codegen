...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::CalApplicationProposed::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::CalApplicationProposed::_ctor)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x259d460;
...
constexpr void Oculus::Platform::Models::CalApplicationProposed::__set_ID(uint64_t value)  {
