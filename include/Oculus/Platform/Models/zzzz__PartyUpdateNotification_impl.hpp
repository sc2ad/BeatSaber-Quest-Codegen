...
return ::cordl_internals::getInstanceField<::StringW, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Oculus::Platform::Models::PartyUpdateNotification Oculus::Platform::Models::PartyUpdateNotification::New_ctor(::cordl_internals::intptr_t o)  {
Oculus::Platform::Models::PartyUpdateNotification o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::PartyUpdateNotification>(o))};
return o;
}
