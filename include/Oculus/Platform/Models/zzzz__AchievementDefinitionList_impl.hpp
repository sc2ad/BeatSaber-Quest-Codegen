...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::AchievementDefinitionList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::AchievementDefinitionList::_ctor)> {
 ...
 Oculus::Platform::Models::AchievementDefinitionList Oculus::Platform::Models::AchievementDefinitionList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::AchievementDefinitionList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::AchievementDefinitionList>(a))};
return o;
}
