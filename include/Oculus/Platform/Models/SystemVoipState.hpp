...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(SystemVoipState), 20 + sizeof(Oculus::Platform::SystemVoipStatus) + ((20 + sizeof(Oculus::Platform::SystemVoipStatus)) % 8 != 0 ? (8 - (20 + sizeof(Oculus::Platform::SystemVoipStatus)) % 8) : 0)> __Oculus_Platform_Models_SystemVoipStateSizeCheck;
}
