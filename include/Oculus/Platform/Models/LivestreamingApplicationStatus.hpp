...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(LivestreamingApplicationStatus), 16 + sizeof(bool) + ((16 + sizeof(bool)) % 8 != 0 ? (8 - (16 + sizeof(bool)) % 8) : 0)> __Oculus_Platform_Models_LivestreamingApplicationStatusSizeCheck;
}
