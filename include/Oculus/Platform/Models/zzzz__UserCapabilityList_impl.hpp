...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::UserCapabilityList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::UserCapabilityList::_ctor)> {
 ...
 Oculus::Platform::Models::UserCapabilityList Oculus::Platform::Models::UserCapabilityList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::UserCapabilityList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::UserCapabilityList>(a))};
return o;
}
