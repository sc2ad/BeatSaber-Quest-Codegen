...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(NetSyncSessionsChangedNotification), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Oculus_Platform_Models_NetSyncSessionsChangedNotificationSizeCheck;
}
