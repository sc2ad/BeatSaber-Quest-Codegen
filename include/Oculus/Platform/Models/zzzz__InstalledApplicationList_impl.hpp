...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::InstalledApplicationList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::InstalledApplicationList::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x259eeac;
 ...
 Oculus::Platform::Models::InstalledApplicationList Oculus::Platform::Models::InstalledApplicationList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::InstalledApplicationList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::InstalledApplicationList>(a))};
return o;
}
