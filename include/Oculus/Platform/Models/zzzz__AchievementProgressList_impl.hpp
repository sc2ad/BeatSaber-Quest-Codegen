...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::AchievementProgressList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::AchievementProgressList::_ctor)> {
 ...
 Oculus::Platform::Models::AchievementProgressList Oculus::Platform::Models::AchievementProgressList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::AchievementProgressList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::AchievementProgressList>(a))};
return o;
}
