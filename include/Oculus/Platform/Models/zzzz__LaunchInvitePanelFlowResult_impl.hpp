...
return ::cordl_internals::getInstanceField<Oculus::Platform::Models::UserList, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Oculus::Platform::Models::LaunchInvitePanelFlowResult Oculus::Platform::Models::LaunchInvitePanelFlowResult::New_ctor(::cordl_internals::intptr_t o)  {
Oculus::Platform::Models::LaunchInvitePanelFlowResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::LaunchInvitePanelFlowResult>(o))};
return o;
}
