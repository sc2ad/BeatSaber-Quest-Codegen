...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(LaunchUnblockFlowResult), 17 + sizeof(bool) + ((17 + sizeof(bool)) % 8 != 0 ? (8 - (17 + sizeof(bool)) % 8) : 0)> __Oculus_Platform_Models_LaunchUnblockFlowResultSizeCheck;
}
