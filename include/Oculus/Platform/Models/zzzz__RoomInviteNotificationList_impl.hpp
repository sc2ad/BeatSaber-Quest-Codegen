...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::RoomInviteNotificationList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::RoomInviteNotificationList::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25a2d90;
 ...
 Oculus::Platform::Models::RoomInviteNotificationList Oculus::Platform::Models::RoomInviteNotificationList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::RoomInviteNotificationList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::RoomInviteNotificationList>(a))};
return o;
}
