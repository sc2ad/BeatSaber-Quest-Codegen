...
return ::cordl_internals::getInstanceField<Oculus::Platform::Models::NetSyncSessionList, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Oculus::Platform::Models::NetSyncSessionsChangedNotification Oculus::Platform::Models::NetSyncSessionsChangedNotification::New_ctor(::cordl_internals::intptr_t o)  {
Oculus::Platform::Models::NetSyncSessionsChangedNotification o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::NetSyncSessionsChangedNotification>(o))};
return o;
}
