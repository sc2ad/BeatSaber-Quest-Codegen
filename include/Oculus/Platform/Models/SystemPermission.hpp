...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(SystemPermission), 20 + sizeof(Oculus::Platform::PermissionGrantStatus) + ((20 + sizeof(Oculus::Platform::PermissionGrantStatus)) % 8 != 0 ? (8 - (20 + sizeof(Oculus::Platform::PermissionGrantStatus)) % 8) : 0)> __Oculus_Platform_Models_SystemPermissionSizeCheck;
}
