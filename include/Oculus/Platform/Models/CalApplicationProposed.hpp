...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(CalApplicationProposed), 16 + sizeof(uint64_t) + ((16 + sizeof(uint64_t)) % 8 != 0 ? (8 - (16 + sizeof(uint64_t)) % 8) : 0)> __Oculus_Platform_Models_CalApplicationProposedSizeCheck;
}
