...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(MatchmakingEnqueuedUser), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Oculus_Platform_Models_MatchmakingEnqueuedUserSizeCheck;
}
