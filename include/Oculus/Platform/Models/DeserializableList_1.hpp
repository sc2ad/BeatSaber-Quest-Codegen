...
namespace Oculus::Platform::Models {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: D098C4
  template<typename T>
  class DeserializableList_1 : public ::Il2CppObject/*, public System::Collections::Generic::IList_1<T>*/ {
    ...
    // Offset: 0xFFFFFFFF
    int get_Count_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::get_Count_NEW");
    ...
    bool System_Collections_Generic_ICollection$T$_get_IsReadOnly_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::System.Collections.Generic.ICollection<T>.get_IsReadOnly_NEW");
    ...
    // Offset: 0xFFFFFFFF
    int IndexOf_NEW(T obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::IndexOf_NEW");
    ...
    T get_Item_NEW(int index) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::get_Item_NEW");
    ...
    void set_Item_NEW(int index, T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::set_Item_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Add_NEW(T item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::Add_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Clear_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::Clear_NEW");
    ...
    bool Contains_NEW(T item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::Contains_NEW");
    ...
    void CopyTo_NEW(::Array<T>* array, int arrayIndex) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::CopyTo_NEW");
    ...
    System::Collections::Generic::IEnumerator_1<T>* GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::GetEnumerator_NEW");
    ...
    void Insert_NEW(int index, T item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::Insert_NEW");
    ...
    bool Remove_NEW(T item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::Remove_NEW");
    ...
    void RemoveAt_NEW(int index) {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::RemoveAt_NEW");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Oculus::Platform::Models::DeserializableList_1::System.Collections.IEnumerable.GetEnumerator_NEW");
