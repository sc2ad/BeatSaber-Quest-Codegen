...
namespace Oculus::Platform::Models {
  ...
  class LivestreamingStartResult : public ::Il2CppObject {
    ...
    static LivestreamingStartResult* New_ctor(System::IntPtr o) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Oculus::Platform::Models").WithContext("LivestreamingStartResult").WithContext(".ctor");
