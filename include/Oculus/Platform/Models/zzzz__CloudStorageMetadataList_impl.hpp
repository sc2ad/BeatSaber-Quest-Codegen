...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::CloudStorageMetadataList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::CloudStorageMetadataList::_ctor)> {
 ...
 Oculus::Platform::Models::CloudStorageMetadataList Oculus::Platform::Models::CloudStorageMetadataList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::CloudStorageMetadataList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::CloudStorageMetadataList>(a))};
return o;
}
