...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(PartyUpdateNotification), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __Oculus_Platform_Models_PartyUpdateNotificationSizeCheck;
}
