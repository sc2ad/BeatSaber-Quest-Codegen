...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::NetSyncVoipAttenuationValueList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::NetSyncVoipAttenuationValueList::_ctor)> {
 ...
 Oculus::Platform::Models::NetSyncVoipAttenuationValueList Oculus::Platform::Models::NetSyncVoipAttenuationValueList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::NetSyncVoipAttenuationValueList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::NetSyncVoipAttenuationValueList>(a))};
return o;
}
