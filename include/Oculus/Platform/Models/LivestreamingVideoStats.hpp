...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(LivestreamingVideoStats), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Oculus_Platform_Models_LivestreamingVideoStatsSizeCheck;
}
