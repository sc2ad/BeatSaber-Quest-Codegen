...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::LaunchUnblockFlowResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::LaunchUnblockFlowResult::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x259f510;
...
return ::cordl_internals::getInstanceField<bool, 0x11>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Oculus::Platform::Models::LaunchUnblockFlowResult Oculus::Platform::Models::LaunchUnblockFlowResult::New_ctor(::cordl_internals::intptr_t o)  {
Oculus::Platform::Models::LaunchUnblockFlowResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::LaunchUnblockFlowResult>(o))};
return o;
}
