...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::MatchmakingEnqueuedUserList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::MatchmakingEnqueuedUserList::_ctor)> {
 ...
 Oculus::Platform::Models::MatchmakingEnqueuedUserList Oculus::Platform::Models::MatchmakingEnqueuedUserList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::MatchmakingEnqueuedUserList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::MatchmakingEnqueuedUserList>(a))};
return o;
}
