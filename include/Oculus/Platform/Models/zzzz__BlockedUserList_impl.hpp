...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::BlockedUserList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::BlockedUserList::_ctor)> {
 ...
 Oculus::Platform::Models::BlockedUserList Oculus::Platform::Models::BlockedUserList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::BlockedUserList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::BlockedUserList>(a))};
return o;
}
