...
namespace Oculus::Platform::Models {
  ...
  class Leaderboard : public ::Il2CppObject {
    ...
    Leaderboard(::Il2CppString* ApiName_ = {}) noexcept : ApiName{ApiName_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(Leaderboard), 16 + sizeof(::Il2CppString*)> __Oculus_Platform_Models_LeaderboardSizeCheck;
