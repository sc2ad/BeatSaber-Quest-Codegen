...
namespace Oculus::Platform::Models {
  ...
  check_size<sizeof(MatchmakingEnqueueResult), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __Oculus_Platform_Models_MatchmakingEnqueueResultSizeCheck;
}
