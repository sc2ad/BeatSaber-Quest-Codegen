...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::LinkedAccountList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::LinkedAccountList::_ctor)> {
 ...
 Oculus::Platform::Models::LinkedAccountList Oculus::Platform::Models::LinkedAccountList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::LinkedAccountList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::LinkedAccountList>(a))};
return o;
}
