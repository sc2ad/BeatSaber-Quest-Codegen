...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::PidList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::PidList::_ctor)> {
 ...
 Oculus::Platform::Models::PidList Oculus::Platform::Models::PidList::New_ctor(::cordl_internals::intptr_t a)  {
Oculus::Platform::Models::PidList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Models::PidList>(a))};
return o;
}
