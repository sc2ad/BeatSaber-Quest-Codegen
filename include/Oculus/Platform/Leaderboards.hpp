...
namespace Oculus::Platform {
  ...
  class Leaderboards : public ::CsObject {
    public:
    ...
    // Offset: 0xE83A30
    static Oculus::Platform::Request_1<Oculus::Platform::Models::LeaderboardEntryList*>* GetEntries(::CsString* leaderboardName, int limit, Oculus::Platform::LeaderboardFilterType filter, Oculus::Platform::LeaderboardStartAt startAt);
    ...
    // Offset: 0xE83B6C
    static Oculus::Platform::Request_1<Oculus::Platform::Models::LeaderboardEntryList*>* GetEntriesAfterRank(::CsString* leaderboardName, int limit, uint64_t afterRank);
    ...
    // Offset: 0xE83CA0
    static Oculus::Platform::Request_1<bool>* WriteEntry(::CsString* leaderboardName, int64_t score, ::Array<uint8_t>* extraData, bool forceUpdate);
