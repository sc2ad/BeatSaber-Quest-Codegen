...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4429 }), TypeDefinitionIndex(TypeDefinitionIndex(13389))}
...
static Oculus::Platform::MessageWithAssetDetailsList New_ctor(::cordl_internals::intptr_t c_message) ;
