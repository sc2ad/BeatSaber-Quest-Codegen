...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13421)), TypeDefinitionIndex(TypeDefinitionIndex(13203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4447 })}
...
static Oculus::Platform::MessageWithLaunchBlockFlowResult New_ctor(::cordl_internals::intptr_t c_message) ;
