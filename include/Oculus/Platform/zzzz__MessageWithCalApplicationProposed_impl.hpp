...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::CalApplicationProposed (Oculus::Platform::MessageWithCalApplicationProposed::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithCalApplicationProposed::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithCalApplicationProposed Oculus::Platform::MessageWithCalApplicationProposed::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithCalApplicationProposed o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithCalApplicationProposed>(c_message))};
return o;
}
