...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LinkedAccountList (Oculus::Platform::MessageWithLinkedAccountList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLinkedAccountList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLinkedAccountList Oculus::Platform::MessageWithLinkedAccountList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLinkedAccountList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLinkedAccountList>(c_message))};
return o;
}
