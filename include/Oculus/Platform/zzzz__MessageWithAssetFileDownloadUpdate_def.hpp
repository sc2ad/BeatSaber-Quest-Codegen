...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 939 }), TypeDefinitionIndex(TypeDefinitionIndex(13393)), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
...
static Oculus::Platform::MessageWithAssetFileDownloadUpdate New_ctor(::cordl_internals::intptr_t c_message) ;
