...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::GroupPresenceJoinIntent (Oculus::Platform::MessageWithGroupPresenceJoinIntent::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithGroupPresenceJoinIntent::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithGroupPresenceJoinIntent Oculus::Platform::MessageWithGroupPresenceJoinIntent::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithGroupPresenceJoinIntent o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithGroupPresenceJoinIntent>(c_message))};
return o;
}
