...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AvatarEditorResult (Oculus::Platform::MessageWithAvatarEditorResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAvatarEditorResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAvatarEditorResult Oculus::Platform::MessageWithAvatarEditorResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAvatarEditorResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAvatarEditorResult>(c_message))};
return o;
}
