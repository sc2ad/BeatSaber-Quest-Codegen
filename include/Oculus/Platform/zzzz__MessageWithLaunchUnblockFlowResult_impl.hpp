...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LaunchUnblockFlowResult (Oculus::Platform::MessageWithLaunchUnblockFlowResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLaunchUnblockFlowResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLaunchUnblockFlowResult Oculus::Platform::MessageWithLaunchUnblockFlowResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLaunchUnblockFlowResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLaunchUnblockFlowResult>(c_message))};
return o;
}
