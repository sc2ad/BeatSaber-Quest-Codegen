...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::ApplicationInviteList (Oculus::Platform::MessageWithApplicationInviteList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithApplicationInviteList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithApplicationInviteList Oculus::Platform::MessageWithApplicationInviteList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithApplicationInviteList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithApplicationInviteList>(c_message))};
return o;
}
