...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LivestreamingVideoStats (Oculus::Platform::MessageWithLivestreamingVideoStats::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLivestreamingVideoStats::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLivestreamingVideoStats Oculus::Platform::MessageWithLivestreamingVideoStats::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLivestreamingVideoStats o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLivestreamingVideoStats>(c_message))};
return o;
}
