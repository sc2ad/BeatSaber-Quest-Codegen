...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom (Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithMatchmakingEnqueueResultAndRoom>(c_message))};
return o;
}
