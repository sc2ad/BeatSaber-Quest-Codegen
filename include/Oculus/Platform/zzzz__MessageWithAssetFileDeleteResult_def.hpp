...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13390)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4430 }), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
...
static Oculus::Platform::MessageWithAssetFileDeleteResult New_ctor(::cordl_internals::intptr_t c_message) ;
