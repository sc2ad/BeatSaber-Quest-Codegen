...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::ShareMediaResult (Oculus::Platform::MessageWithShareMediaResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithShareMediaResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithShareMediaResult Oculus::Platform::MessageWithShareMediaResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithShareMediaResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithShareMediaResult>(c_message))};
return o;
}
