...
namespace Oculus::Platform {
  ...
  check_size<sizeof(NetSyncOptions), 16 + sizeof(System::IntPtr) + ((16 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (16 + sizeof(System::IntPtr)) % 8) : 0)> __Oculus_Platform_NetSyncOptionsSizeCheck;
}
