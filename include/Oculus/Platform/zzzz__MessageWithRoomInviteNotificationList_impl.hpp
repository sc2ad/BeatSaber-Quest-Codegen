...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::RoomInviteNotificationList (Oculus::Platform::MessageWithRoomInviteNotificationList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithRoomInviteNotificationList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithRoomInviteNotificationList Oculus::Platform::MessageWithRoomInviteNotificationList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithRoomInviteNotificationList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithRoomInviteNotificationList>(c_message))};
return o;
}
