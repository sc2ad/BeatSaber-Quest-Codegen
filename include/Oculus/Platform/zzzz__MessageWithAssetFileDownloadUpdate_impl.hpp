...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AssetFileDownloadUpdate (Oculus::Platform::MessageWithAssetFileDownloadUpdate::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAssetFileDownloadUpdate::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAssetFileDownloadUpdate Oculus::Platform::MessageWithAssetFileDownloadUpdate::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAssetFileDownloadUpdate o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAssetFileDownloadUpdate>(c_message))};
return o;
}
