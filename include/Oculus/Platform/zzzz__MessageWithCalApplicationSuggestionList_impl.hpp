...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::CalApplicationSuggestionList (Oculus::Platform::MessageWithCalApplicationSuggestionList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithCalApplicationSuggestionList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithCalApplicationSuggestionList Oculus::Platform::MessageWithCalApplicationSuggestionList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithCalApplicationSuggestionList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithCalApplicationSuggestionList>(c_message))};
return o;
}
