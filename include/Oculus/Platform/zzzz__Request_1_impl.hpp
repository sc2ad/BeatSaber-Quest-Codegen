...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Request_1<T> (Oculus::Platform::Request_1::*)(Oculus::Platform::Oculus__Platform__Message_1__Callback<T>)>(&Oculus::Platform::Request_1::OnComplete)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
constexpr void Oculus::Platform::Request_1::__set_callback_(Oculus::Platform::Oculus__Platform__Message_1__Callback<T> value)  {
...
constexpr Oculus::Platform::Oculus__Platform__Message_1__Callback<T> Oculus::Platform::Request_1::__get_callback_() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, requestID);
 ...
 Oculus::Platform::Request_1<T> Oculus::Platform::Request_1::OnComplete(Oculus::Platform::Oculus__Platform__Message_1__Callback<T> callback)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Request_1>::get(),
                            "OnComplete",
                            std::vector<Il2CppClass*>{},
