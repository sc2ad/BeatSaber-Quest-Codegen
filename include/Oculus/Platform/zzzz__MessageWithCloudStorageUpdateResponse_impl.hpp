...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::CloudStorageUpdateResponse (Oculus::Platform::MessageWithCloudStorageUpdateResponse::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithCloudStorageUpdateResponse::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithCloudStorageUpdateResponse Oculus::Platform::MessageWithCloudStorageUpdateResponse::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithCloudStorageUpdateResponse o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithCloudStorageUpdateResponse>(c_message))};
return o;
}
