...
namespace Oculus::Platform {
  ...
  class StandalonePlatform : public ::CsObject {
    public:
    ...
    // Offset: 0xEA8AC0
    Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* AsyncInitialize(uint64_t appID, ::CsString* accessToken);
