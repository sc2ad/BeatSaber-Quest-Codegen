...
struct CORDL_TYPE AbuseReportType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
...
constexpr AbuseReportType(int32_t value__) noexcept;
                    ...
                    constexpr AbuseReportType(AbuseReportType const&) = default;
                    constexpr AbuseReportType(AbuseReportType&&) = default;
                    constexpr AbuseReportType& operator=(AbuseReportType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr AbuseReportType& operator=(AbuseReportType&& o) noexcept {
...
constexpr explicit AbuseReportType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __AbuseReportType_Unwrapped : int32_t {
__Unknown = 0,
__Object = 1,
__User = 2,
};
...
return std::bit_cast<__AbuseReportType_Unwrapped>(__instance);
}
