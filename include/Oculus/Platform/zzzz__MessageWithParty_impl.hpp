...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Party (Oculus::Platform::MessageWithParty::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithParty::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithParty Oculus::Platform::MessageWithParty::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithParty o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithParty>(c_message))};
return o;
}
