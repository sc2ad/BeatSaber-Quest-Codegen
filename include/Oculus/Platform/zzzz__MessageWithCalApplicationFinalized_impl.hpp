...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::CalApplicationFinalized (Oculus::Platform::MessageWithCalApplicationFinalized::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithCalApplicationFinalized::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithCalApplicationFinalized Oculus::Platform::MessageWithCalApplicationFinalized::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithCalApplicationFinalized o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithCalApplicationFinalized>(c_message))};
return o;
}
