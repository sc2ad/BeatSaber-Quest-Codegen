...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AchievementProgressList (Oculus::Platform::MessageWithAchievementProgressList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAchievementProgressList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAchievementProgressList Oculus::Platform::MessageWithAchievementProgressList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAchievementProgressList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAchievementProgressList>(c_message))};
return o;
}
