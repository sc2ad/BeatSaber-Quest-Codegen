...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LeaderboardList (Oculus::Platform::MessageWithLeaderboardList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLeaderboardList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLeaderboardList Oculus::Platform::MessageWithLeaderboardList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLeaderboardList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLeaderboardList>(c_message))};
return o;
}
