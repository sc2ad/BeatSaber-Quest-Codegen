...
namespace Oculus::Platform {
  ...
  check_size<sizeof(RichPresenceOptions), 16 + sizeof(System::IntPtr) + ((16 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (16 + sizeof(System::IntPtr)) % 8) : 0)> __Oculus_Platform_RichPresenceOptionsSizeCheck;
}
