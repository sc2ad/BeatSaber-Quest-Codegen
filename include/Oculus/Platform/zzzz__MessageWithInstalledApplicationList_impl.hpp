...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::InstalledApplicationList (Oculus::Platform::MessageWithInstalledApplicationList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithInstalledApplicationList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithInstalledApplicationList Oculus::Platform::MessageWithInstalledApplicationList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithInstalledApplicationList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithInstalledApplicationList>(c_message))};
return o;
}
