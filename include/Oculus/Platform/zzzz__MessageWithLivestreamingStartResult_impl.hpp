...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::LivestreamingStartResult (Oculus::Platform::MessageWithLivestreamingStartResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithLivestreamingStartResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithLivestreamingStartResult Oculus::Platform::MessageWithLivestreamingStartResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithLivestreamingStartResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithLivestreamingStartResult>(c_message))};
return o;
}
