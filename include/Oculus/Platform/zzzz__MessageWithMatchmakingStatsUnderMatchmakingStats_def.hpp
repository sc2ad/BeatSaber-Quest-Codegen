...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4460 }), TypeDefinitionIndex(TypeDefinitionIndex(13203)), TypeDefinitionIndex(TypeDefinitionIndex(13445))}
...
static Oculus::Platform::MessageWithMatchmakingStatsUnderMatchmakingStats New_ctor(::cordl_internals::intptr_t c_message) ;
