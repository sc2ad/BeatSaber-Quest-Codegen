...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::SdkAccountList (Oculus::Platform::MessageWithSdkAccountList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithSdkAccountList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithSdkAccountList Oculus::Platform::MessageWithSdkAccountList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithSdkAccountList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithSdkAccountList>(c_message))};
return o;
}
