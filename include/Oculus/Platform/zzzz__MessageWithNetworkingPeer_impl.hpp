...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::NetworkingPeer (Oculus::Platform::MessageWithNetworkingPeer::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithNetworkingPeer::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithNetworkingPeer Oculus::Platform::MessageWithNetworkingPeer::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithNetworkingPeer o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithNetworkingPeer>(c_message))};
return o;
}
