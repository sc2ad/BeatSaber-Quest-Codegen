...
namespace Oculus::Platform {
  ...
  class Request_1 : public Oculus::Platform::Request {
    ...
    typename Oculus::Platform::Message_1<T>::Callback* _get_callback_() {
      ...
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<typename Oculus::Platform::Message_1<T>::Callback*>(___internal__instance, "callback_"));
    }
    ...
    void _set_callback_(typename Oculus::Platform::Message_1<T>::Callback* value) {
      ...
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "callback_", value));
    }
