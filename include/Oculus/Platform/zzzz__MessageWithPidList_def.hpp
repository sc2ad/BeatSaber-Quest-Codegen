...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4468 }), TypeDefinitionIndex(TypeDefinitionIndex(13460))}
...
static Oculus::Platform::MessageWithPidList New_ctor(::cordl_internals::intptr_t c_message) ;
