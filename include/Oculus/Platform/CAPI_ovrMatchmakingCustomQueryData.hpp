...
namespace Oculus::Platform {
  ...
  check_size<sizeof(CAPI::ovrMatchmakingCustomQueryData), 24 + sizeof(uint) + ((24 + sizeof(uint)) % 8 != 0 ? (8 - (24 + sizeof(uint)) % 8) : 0)> __Oculus_Platform_CAPI_ovrMatchmakingCustomQueryDataSizeCheck;
}
