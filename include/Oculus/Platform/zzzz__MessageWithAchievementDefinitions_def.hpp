...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13381)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4424 }), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
