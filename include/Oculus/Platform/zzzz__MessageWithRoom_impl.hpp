...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Room (Oculus::Platform::MessageWithRoom::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithRoom::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithRoom Oculus::Platform::MessageWithRoom::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithRoom o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithRoom>(c_message))};
return o;
}
