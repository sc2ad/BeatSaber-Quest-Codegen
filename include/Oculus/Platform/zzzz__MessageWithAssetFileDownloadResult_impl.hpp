...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AssetFileDownloadResult (Oculus::Platform::MessageWithAssetFileDownloadResult::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAssetFileDownloadResult::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAssetFileDownloadResult Oculus::Platform::MessageWithAssetFileDownloadResult::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAssetFileDownloadResult o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAssetFileDownloadResult>(c_message))};
return o;
}
