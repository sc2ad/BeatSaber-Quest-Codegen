...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::NetSyncSessionsChangedNotification (Oculus::Platform::MessageWithNetSyncSessionsChangedNotification::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithNetSyncSessionsChangedNotification::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithNetSyncSessionsChangedNotification Oculus::Platform::MessageWithNetSyncSessionsChangedNotification::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithNetSyncSessionsChangedNotification o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithNetSyncSessionsChangedNotification>(c_message))};
return o;
}
