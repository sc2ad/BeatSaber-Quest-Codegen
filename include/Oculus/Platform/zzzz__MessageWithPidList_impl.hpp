...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::PidList (Oculus::Platform::MessageWithPidList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithPidList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithPidList Oculus::Platform::MessageWithPidList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithPidList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithPidList>(c_message))};
return o;
}
