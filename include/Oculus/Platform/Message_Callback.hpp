...
namespace Oculus::Platform {
  ...
  class Message::Callback : public System::MulticastDelegate {
    ...
    // Offset: 0x1377E5C
    void Invoke_NEW(Oculus::Platform::Message* message);
    ...
    // Offset: 0x1382640
    System::IAsyncResult* BeginInvoke_NEW(Oculus::Platform::Message* message, System::AsyncCallback* callback, ::Il2CppObject* object);
