...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AssetDetailsList (Oculus::Platform::MessageWithAssetDetailsList::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAssetDetailsList::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAssetDetailsList Oculus::Platform::MessageWithAssetDetailsList::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAssetDetailsList o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAssetDetailsList>(c_message))};
return o;
}
