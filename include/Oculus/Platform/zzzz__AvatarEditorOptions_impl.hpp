...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::AvatarEditorOptions::*)()>(&::Oculus::Platform::AvatarEditorOptions::_ctor)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x25537e8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::AvatarEditorOptions::*)(::StringW)>(&::Oculus::Platform::AvatarEditorOptions::SetSourceOverride)> {
  ...
  constexpr static std::size_t addrs = 0x25538b4;
...
//  Writing Method size for method: ::Oculus::Platform::AvatarEditorOptions.op_Explicit___cordl_internals__intptr_t
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::intptr_t (*)(::Oculus::Platform::AvatarEditorOptions)>(&::Oculus::Platform::AvatarEditorOptions::op_Explicit___cordl_internals__intptr_t)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x25539bc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::AvatarEditorOptions::*)()>(&::Oculus::Platform::AvatarEditorOptions::Finalize)> {
  ...
  constexpr static std::size_t addrs = 0x2553a14;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::Oculus::Platform::AvatarEditorOptions),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::AvatarEditorOptions>::get(),
                                  1
                                ));
    return ___internal_method;
...
constexpr void ::Oculus::Platform::AvatarEditorOptions::__set_Handle(::cordl_internals::intptr_t value)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::cordl_internals::intptr_t ::Oculus::Platform::AvatarEditorOptions::op_Explicit___cordl_internals__intptr_t(::Oculus::Platform::AvatarEditorOptions options)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::AvatarEditorOptions>::get(),
                            "op_Explicit",
                            std::vector<Il2CppClass*>{},
