...
namespace Oculus::Platform {
  ...
  class PlatformInternal : public ::CsObject {
    public:
    ...
    // Offset: 0xEA8998
    static Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize*>* InitializeStandaloneAsync(uint64_t appID, ::CsString* accessToken);
