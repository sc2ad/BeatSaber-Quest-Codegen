...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13397)), TypeDefinitionIndex(TypeDefinitionIndex(13203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4435 })}
...
static Oculus::Platform::MessageWithCalApplicationFinalized New_ctor(::cordl_internals::intptr_t c_message) ;
