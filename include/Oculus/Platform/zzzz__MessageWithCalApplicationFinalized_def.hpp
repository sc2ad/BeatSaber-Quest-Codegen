...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13397)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13203), inst: 4435 }), TypeDefinitionIndex(TypeDefinitionIndex(13203))}
