...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::AbuseReportRecording (Oculus::Platform::MessageWithAbuseReportRecording::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithAbuseReportRecording::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithAbuseReportRecording Oculus::Platform::MessageWithAbuseReportRecording::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithAbuseReportRecording o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithAbuseReportRecording>(c_message))};
return o;
}
