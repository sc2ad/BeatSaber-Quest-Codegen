...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::CloudStorageData (Oculus::Platform::MessageWithCloudStorageData::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::MessageWithCloudStorageData::GetDataFromMessage)> {
 ...
 Oculus::Platform::MessageWithCloudStorageData Oculus::Platform::MessageWithCloudStorageData::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::MessageWithCloudStorageData o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::MessageWithCloudStorageData>(c_message))};
return o;
}
