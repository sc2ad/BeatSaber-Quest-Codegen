...
// Ctor Parameters [CppParam { name: "c_message", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
 Oculus::Platform::MessageWithRejoinDialogResult::MessageWithRejoinDialogResult(::cordl_internals::intptr_t c_message)  : Oculus::Platform::Message_1<Oculus::Platform::Models::RejoinDialogResult>(THROW_UNLESS(::il2cpp_utils::New<MessageWithRejoinDialogResult>(c_message))) {}
