...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__Callback._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Oculus__Platform__Message__Callback::*)(::bs_hook::Il2CppWrapperType, ::cordl_internals::intptr_t)>(&Oculus::Platform::Oculus__Platform__Message__Callback::_ctor)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x257f7fc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                            ".ctor",
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__Callback.Invoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Oculus__Platform__Message__Callback::*)(Oculus::Platform::Message)>(&Oculus::Platform::Oculus__Platform__Message__Callback::Invoke)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Oculus::Platform::Oculus__Platform__Message__Callback),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                                  13
                                ));
    return ___internal_method;
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__Callback.BeginInvoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult (Oculus::Platform::Oculus__Platform__Message__Callback::*)(Oculus::Platform::Message, System::AsyncCallback, ::bs_hook::Il2CppWrapperType)>(&Oculus::Platform::Oculus__Platform__Message__Callback::BeginInvoke)> {
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__Callback.EndInvoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Oculus__Platform__Message__Callback::*)(System::IAsyncResult)>(&Oculus::Platform::Oculus__Platform__Message__Callback::EndInvoke)> {
 ...
 Oculus::Platform::Oculus__Platform__Message__Callback Oculus::Platform::Oculus__Platform__Message__Callback::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
Oculus::Platform::Oculus__Platform__Message__Callback o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Oculus__Platform__Message__Callback>(object, method))};
return o;
}
 void Oculus::Platform::Oculus__Platform__Message__Callback::_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, object, method);
 ...
 void Oculus::Platform::Oculus__Platform__Message__Callback::Invoke(Oculus::Platform::Message message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                            "Invoke",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 System::IAsyncResult Oculus::Platform::Oculus__Platform__Message__Callback::BeginInvoke(Oculus::Platform::Message message, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                            "BeginInvoke",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<System::IAsyncResult, false>(const_cast<void*>(instance), ___internal_method, message, callback, object);
 ...
 void Oculus::Platform::Oculus__Platform__Message__Callback::EndInvoke(System::IAsyncResult result)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__Callback>::get(),
                            "EndInvoke",
                            std::vector<Il2CppClass*>{},
...
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType::Oculus__Platform__Message__MessageType(uint32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void Oculus::Platform::Oculus__Platform__Message__MessageType::__set_value__(uint32_t value)  {
::cordl_internals::setInstanceField<uint32_t, 0x0>(this->__instance, std::forward<uint32_t>(value));
}
constexpr uint32_t Oculus::Platform::Oculus__Platform__Message__MessageType::__get_value__() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->__instance);
}
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Unknown{0u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AbuseReport_ReportRequestHandled{1267661958u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_AddCount{65495601u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_AddFields{346693929u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetAllDefinitions{64177549u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetAllProgress{1335877149u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetDefinitionsByName{1653670332u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetNextAchievementDefinitionArrayPage{712888917u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetNextAchievementProgressArrayPage{792913703u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_GetProgressByName{354837425u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Achievements_Unlock{1497156573u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::ApplicationLifecycle_GetRegisteredPIDs{82169698u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::ApplicationLifecycle_GetSessionKey{984570141u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::ApplicationLifecycle_RegisterSessionKey{1303818232u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Application_GetVersion{1751583246u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Application_LaunchOtherApp{1424151032u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_Delete{1834842246u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DeleteById{1525206354u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DeleteByName{1108001231u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_Download{289710021u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DownloadById{755009938u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DownloadByName{1664536314u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DownloadCancel{134927303u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DownloadCancelById{1365611796u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_DownloadCancelByName{1147858170u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_GetList{1258057588u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_Status{47394656u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_StatusById{1570069816u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::AssetFile_StatusByName{1104140880u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Avatar_LaunchAvatarEditor{99737939u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_Create{1750718017u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_DeclineInvite{1452177088u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_Delete{642287050u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_Get{2002276083u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetEntries{303739999u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetEntriesAfterRank{143202943u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetEntriesByIds{828705244u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetList{1126581078u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetNextChallenges{1534894518u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetNextEntries{2135728326u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetPreviousChallenges{246678541u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_GetPreviousEntries{2026439792u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_Join{556040297u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_Leave{694228709u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Challenges_UpdateInfo{292929120u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage2_GetUserDirectoryPath{1990471406u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_Delete{685393261u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_GetNextCloudStorageMetadataArrayPage{1544004335u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_Load{1082420033u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_LoadBucketMetadata{1931977997u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_LoadConflictMetadata{1146770162u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_LoadHandle{845863478u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_LoadMetadata{65446546u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_ResolveKeepLocal{811109637u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_ResolveKeepRemote{1965400838u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::CloudStorage_Save{1270570030u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Entitlement_GetIsViewerEntitled{409688241u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_Clear{1839897795u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_GetInvitableUsers{592167921u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_GetNextApplicationInviteArrayPage{83411186u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_GetSentInvites{136710833u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_LaunchInvitePanel{262066079u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_LaunchMultiplayerErrorDialog{693481252u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_LaunchRejoinDialog{360121199u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_LaunchRosterPanel{896698498u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SendInvites{231461732u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_Set{1734302756u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SetDeeplinkMessageOverride{1377492749u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SetDestination{1281042058u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SetIsJoinable{714018901u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SetLobbySession{1224693182u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::GroupPresence_SetMatchSession{827098296u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_ConsumePurchase{532378329u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_GetNextProductArrayPage{467225263u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_GetNextPurchaseArrayPage{1196886677u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_GetProductsBySKU{2124073717u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_GetViewerPurchases{974095385u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_GetViewerPurchasesDurableCache{1666817579u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::IAP_LaunchCheckoutFlow{1067126029u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::LanguagePack_GetCurrent{529592533u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::LanguagePack_SetCurrent{1531952096u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_Get{1792298744u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetEntries{1572030284u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetEntriesAfterRank{406293487u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetEntriesByIds{962624508u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetNextEntries{1310751961u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetNextLeaderboardArrayPage{905344667u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_GetPreviousEntries{1224858304u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_WriteEntry{293587198u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Leaderboard_WriteEntryWithSupplementaryMetric{1925616378u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Browse{509948616u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Browse2{1715641947u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Cancel{543705519u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Cancel2{285117908u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_CreateAndEnqueueRoom{1615617480u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_CreateAndEnqueueRoom2{693889755u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_CreateRoom{54203178u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_CreateRoom2{1231922052u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Enqueue{1086418033u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_Enqueue2{303174325u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_EnqueueRoom{1888108644u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_EnqueueRoom2{1428741028u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_GetAdminSnapshot{1008820116u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_GetStats{1123849272u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_JoinRoom{1295177725u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_ReportResultInsecure{439800205u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Matchmaking_StartMatch{1154746693u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Media_ShareToFacebook{14912239u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_GetNextRoomInviteNotificationArrayPage{102890359u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_GetRoomInvites{1871801234u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_MarkAsRead{1903319523u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Party_GetCurrent{1200830304u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::RichPresence_Clear{1471632051u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::RichPresence_GetDestinations{1483681044u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::RichPresence_GetNextDestinationArrayPage{1731624773u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::RichPresence_Set{1007973641u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_CreateAndJoinPrivate{1977017207u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_CreateAndJoinPrivate2{1513775683u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_Get{1704628152u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetCurrent{161916164u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetCurrentForUser{234887141u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetInvitableUsers{506615698u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetInvitableUsers2{1330899120u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetModeratedRooms{159645047u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_GetNextRoomArrayPage{1317239238u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_InviteUser{1093266451u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_Join{382373641u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_Join2{1303059522u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_KickUser{1233344310u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_LaunchInvitableUserFlow{843047539u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_Leave{1916281973u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_SetDescription{809796911u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_UpdateDataStore{40779816u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_UpdateMembershipLockStatus{923514796u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_UpdateOwner{850803997u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Room_UpdatePrivateRoomJoinPolicy{289473179u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PrivateDeleteEntryByKey{1552510782u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PrivateGetEntries{1821016616u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PrivateGetEntryByKey{470188825u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PrivateWriteEntry{1104315019u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PublicDeleteEntryByKey{500557307u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PublicGetEntries{377310146u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PublicGetEntryByKey{425486022u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::UserDataStore_PublicWriteEntry{875973130u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_Get{1808768583u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetAccessToken{111696574u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetBlockedUsers{2099254614u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetLoggedInUser{1131361373u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetLoggedInUserFriends{1484532365u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetLoggedInUserFriendsAndRooms{1585908615u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetLoggedInUserRecentlyMetUsersAndRooms{694139440u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetNextBlockedUserArrayPage{2083192267u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetNextUserAndRoomArrayPage{2143146719u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetNextUserArrayPage{645723971u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetNextUserCapabilityArrayPage{587854745u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetOrgScopedID{418426907u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetSdkAccounts{1733454467u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_GetUserProof{578880643u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_LaunchBlockFlow{1876305192u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_LaunchFriendRequestFlow{151303576u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::User_LaunchUnblockFlow{346172055u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Voip_GetMicrophoneAvailability{1951195973u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Voip_SetSystemVoipSuppressed{1161808298u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_AbuseReport_ReportButtonPressed{608644972u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_ApplicationLifecycle_LaunchIntentChanged{78859427u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_AssetFile_DownloadUpdate{803015885u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Cal_FinalizeApplication{1963741337u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Cal_ProposeApplication{779375093u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_GroupPresence_InvitationsSent{1738179766u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_GroupPresence_JoinIntentReceived{2000194038u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_GroupPresence_LeaveIntentReceived{1194846749u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_HTTP_Transfer{2111073839u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Livestreaming_StatusChange{575101294u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Matchmaking_MatchFound{197393623u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_NetSync_ConnectionStatusChanged{120882378u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_NetSync_SessionsChanged{947814198u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Networking_ConnectionStateChange{1577243802u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Networking_PeerConnectRequest{1295114959u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Networking_PingResult{1360343058u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Party_PartyUpdate{487688882u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Room_InviteAccepted{1829794225u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Room_InviteReceived{1783209300u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Room_RoomUpdate{1626094639u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Session_InvitationsSent{133810304u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Voip_ConnectRequest{908343318u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Voip_MicrophoneAvailabilityStateUpdate{1042336599u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Voip_StateChange{888120928u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Voip_SystemVoipState{1490179237u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Vrcamera_GetDataChannelMessageUpdate{1860498236u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Notification_Vrcamera_GetSurfaceUpdate{938610820u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Platform_InitializeWithAccessToken{896085803u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Platform_InitializeStandaloneOculus{1375260172u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Platform_InitializeAndroidAsynchronous{450037684u};
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType  Oculus::Platform::Oculus__Platform__Message__MessageType::Platform_InitializeWindowsAsynchronous{1839708815u};
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::*)(::bs_hook::Il2CppWrapperType, ::cordl_internals::intptr_t)>(&Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::_ctor)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x257f968;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::bs_hook::Il2CppWrapperType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::cordl_internals::intptr_t>::get()}
                        )));
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler.Invoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Message (Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::*)(::cordl_internals::intptr_t, Oculus::Platform::Oculus__Platform__Message__MessageType)>(&Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::Invoke)> {
  constexpr static std::size_t size = 0x14;
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                                  13
                                ));
    return ___internal_method;
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler.BeginInvoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult (Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::*)(::cordl_internals::intptr_t, Oculus::Platform::Oculus__Platform__Message__MessageType, System::AsyncCallback, ::bs_hook::Il2CppWrapperType)>(&Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::BeginInvoke)> {
...
//  Writing Method size for method: Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler.EndInvoke
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Message (Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::*)(System::IAsyncResult)>(&Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::EndInvoke)> {
  constexpr static std::size_t size = 0xc;
 ...
 Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>(object, method))};
return o;
}
 void Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, object, method);
 ...
 Oculus::Platform::Message Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::Invoke(::cordl_internals::intptr_t messageHandle, Oculus::Platform::Oculus__Platform__Message__MessageType message_type)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                            "Invoke",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<Oculus::Platform::Message, false>(const_cast<void*>(instance), ___internal_method, messageHandle, message_type);
 ...
 System::IAsyncResult Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::BeginInvoke(::cordl_internals::intptr_t messageHandle, Oculus::Platform::Oculus__Platform__Message__MessageType message_type, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                            "BeginInvoke",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::cordl_internals::intptr_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Oculus::Platform::Oculus__Platform__Message__MessageType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::AsyncCallback>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::bs_hook::Il2CppWrapperType>::get()}
                        )));
return ::cordl_internals::RunMethodRethrow<System::IAsyncResult, false>(const_cast<void*>(instance), ___internal_method, messageHandle, message_type, callback, object);
 ...
 Oculus::Platform::Message Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler::EndInvoke(System::IAsyncResult result)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get(),
                            "EndInvoke",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Oculus__Platform__Message__MessageType (Oculus::Platform::Message::*)()>(&Oculus::Platform::Message::get_Type)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler)>(&Oculus::Platform::Message::set_HandleExtraMessageTypes)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler (*)()>(&Oculus::Platform::Message::get_HandleExtraMessageTypes)> {
...
constexpr void Oculus::Platform::Message::__set_type(Oculus::Platform::Oculus__Platform__Message__MessageType value)  {
::cordl_internals::setInstanceField<Oculus::Platform::Oculus__Platform__Message__MessageType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Oculus::Platform::Oculus__Platform__Message__MessageType>(value));
}
constexpr Oculus::Platform::Oculus__Platform__Message__MessageType Oculus::Platform::Message::__get_type() const {
return ::cordl_internals::getInstanceField<Oculus::Platform::Oculus__Platform__Message__MessageType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<Oculus::Platform::Models::Error, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 void Oculus::Platform::Message::__set__HandleExtraMessageTypes_k__BackingField(Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler value)  {
::cordl_internals::setStaticField<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler, "<HandleExtraMessageTypes>k__BackingField", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Message>::get>(std::forward<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler>(value));
}
 Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler Oculus::Platform::Message::__get__HandleExtraMessageTypes_k__BackingField()  {
return ::cordl_internals::getStaticField<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler, "<HandleExtraMessageTypes>k__BackingField", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Message>::get>();
}
 Oculus::Platform::Message Oculus::Platform::Message::New_ctor(::cordl_internals::intptr_t c_message)  {
Oculus::Platform::Message o{THROW_UNLESS(::il2cpp_utils::New<Oculus::Platform::Message>(c_message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 Oculus::Platform::Oculus__Platform__Message__MessageType Oculus::Platform::Message::get_Type()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Message>::get(),
                            "get_Type",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<Oculus::Platform::Oculus__Platform__Message__MessageType, false>(const_cast<void*>(instance), ___internal_method);
}
...
return ::cordl_internals::RunMethodRethrow<Oculus::Platform::Message, false>(nullptr, ___internal_method);
 ...
 void Oculus::Platform::Message::set_HandleExtraMessageTypes(Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Message>::get(),
                            "set_HandleExtraMessageTypes",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, value);
 ...
 Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler Oculus::Platform::Message::get_HandleExtraMessageTypes()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Oculus::Platform::Message>::get(),
                            "get_HandleExtraMessageTypes",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<Oculus::Platform::Oculus__Platform__Message__ExtraMessageTypesHandler, false>(nullptr, ___internal_method);
}
