...
namespace UnityEngineInternal {
  ...
  check_size<sizeof(TypeInferenceRuleAttribute), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __UnityEngineInternal_TypeInferenceRuleAttributeSizeCheck;
}
