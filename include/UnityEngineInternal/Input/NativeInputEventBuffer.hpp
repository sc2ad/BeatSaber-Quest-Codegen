...
namespace UnityEngineInternal::Input {
  ...
  check_size<sizeof(NativeInputEventBuffer), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __UnityEngineInternal_Input_NativeInputEventBufferSizeCheck;
}
