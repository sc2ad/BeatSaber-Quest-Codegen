...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngineInternal::Input::NativeUpdateCallback::*)(UnityEngineInternal::Input::NativeInputUpdateType, void*)>(&UnityEngineInternal::Input::NativeUpdateCallback::Invoke)> {
 ...
 UnityEngineInternal::Input::NativeUpdateCallback UnityEngineInternal::Input::NativeUpdateCallback::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
UnityEngineInternal::Input::NativeUpdateCallback o{THROW_UNLESS(::il2cpp_utils::New<UnityEngineInternal::Input::NativeUpdateCallback>(object, method))};
return o;
}
