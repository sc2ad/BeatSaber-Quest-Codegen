...
UnityEngineInternal::TypeInferenceRuleAttribute o{THROW_UNLESS(::il2cpp_utils::New<UnityEngineInternal::TypeInferenceRuleAttribute>(rule))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, rule);
 ...
 UnityEngineInternal::TypeInferenceRuleAttribute UnityEngineInternal::TypeInferenceRuleAttribute::New_ctor(::StringW rule)  {
UnityEngineInternal::TypeInferenceRuleAttribute o{THROW_UNLESS(::il2cpp_utils::New<UnityEngineInternal::TypeInferenceRuleAttribute>(rule))};
return o;
}
