...
namespace Mono::Security {
  ...
  class PKCS7::EncryptedData : public ::Il2CppObject {
    ...
    // Get instance field reference: private Mono.Security.PKCS7/ContentInfo _content
    Mono::Security::PKCS7::ContentInfo*& dyn__content();
    // Get instance field reference: private Mono.Security.PKCS7/ContentInfo _encryptionAlgorithm
