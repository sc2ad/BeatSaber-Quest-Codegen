...
class Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler;
}
namespace Mono::Security::Cryptography {
class RSAManaged;
}
...
class CORDL_TYPE Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler() = default;

// Ctor Parameters [CppParam { name: "", ty: "Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler", modifiers: " const&", def_value: None }]
constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler(Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler", modifiers: "&&", def_value: None }]
constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler(Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler& operator=(Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler&& o) noexcept = default;
  constexpr Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler& operator=(Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler const& o) noexcept = default;
...
explicit Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method .ctor addr 0x229cc84 size 0x130 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x229cdb4 size 0x14 virtual true final false
...
public:
// Declarations
using KeyGeneratedEventHandler = Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler;
...
constexpr Mono::Math::BigInteger __get_e() const;
 ...
 Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler __declspec(property(get=__get_KeyGenerated, put=__set_KeyGenerated))  KeyGenerated;

constexpr void __set_KeyGenerated(Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler value) ;

constexpr Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler __get_KeyGenerated() const;
...
/// @brief Method .ctor addr 0x229aa6c size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "keySize", ty: "int32_t", modifiers: "", def_value: None }]
explicit RSAManaged(int32_t keySize) ;

/// @brief Method .ctor addr 0x229aa74 size 0xf0 virtual false final false
 void _ctor(int32_t keySize) ;

/// @brief Method Finalize addr 0x229ab64 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method GenerateKeyPair addr 0x229ac04 size 0x268 virtual false final false
 void GenerateKeyPair() ;

/// @brief Method get_KeySize addr 0x229b47c size 0xa4 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method get_PublicOnly addr 0x229b520 size 0xa0 virtual false final false
 bool get_PublicOnly() ;

/// @brief Method EncryptValue addr 0x229b670 size 0x10c virtual true final false
 ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t> rgb) ;

/// @brief Method ExportParameters addr 0x229bb30 size 0x334 virtual true final false
 System::Security::Cryptography::RSAParameters ExportParameters(bool includePrivateParameters) ;

/// @brief Method ImportParameters addr 0x229bf90 size 0x46c virtual true final false
 void ImportParameters(System::Security::Cryptography::RSAParameters parameters) ;

/// @brief Method Dispose addr 0x229c3fc size 0x204 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method ToXmlString addr 0x229c600 size 0x684 virtual true final false
 ::StringW ToXmlString(bool includePrivateParameters) ;

/// @brief Method GetPaddedValue addr 0x229ba30 size 0xb0 virtual false final false
...
NEED_NO_BOX(Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler);
DEFINE_IL2CPP_ARG_TYPE(Mono::Security::Cryptography::Mono__Security__Cryptography__RSAManaged__KeyGeneratedEventHandler, "Mono.Security.Cryptography", "RSAManaged/KeyGeneratedEventHandler");
