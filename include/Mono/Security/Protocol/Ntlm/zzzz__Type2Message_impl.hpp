...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Mono::Security::Protocol::Ntlm::Type2Message::*)(::ArrayW<uint8_t>)>(&Mono::Security::Protocol::Ntlm::Type2Message::_ctor)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x22942b0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Mono::Security::Protocol::Ntlm::Type2Message>::get(),
                            ".ctor",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Mono::Security::Protocol::Ntlm::Type2Message::*)()>(&Mono::Security::Protocol::Ntlm::Type2Message::Finalize)> {
  ...
  constexpr static std::size_t addrs = 0x2294354;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Mono::Security::Protocol::Ntlm::Type2Message),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Mono::Security::Protocol::Ntlm::Type2Message>::get(),
                                  1
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::Protocol::Ntlm::Type2Message::*)()>(&Mono::Security::Protocol::Ntlm::Type2Message::get_Nonce)> {
  ...
  constexpr static std::size_t addrs = 0x2293398;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Mono::Security::Protocol::Ntlm::Type2Message::*)()>(&Mono::Security::Protocol::Ntlm::Type2Message::get_TargetName)> {
  ...
  constexpr static std::size_t addrs = 0x22943fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::Protocol::Ntlm::Type2Message::*)()>(&Mono::Security::Protocol::Ntlm::Type2Message::get_TargetInfo)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x2293320;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Mono::Security::Protocol::Ntlm::Type2Message::*)(::ArrayW<uint8_t>)>(&Mono::Security::Protocol::Ntlm::Type2Message::Decode)> {
  ...
  constexpr static std::size_t addrs = 0x2294404;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Mono::Security::Protocol::Ntlm::Type2Message::*)()>(&Mono::Security::Protocol::Ntlm::Type2Message::GetBytes)> {
  ...
  constexpr static std::size_t addrs = 0x2294584;
...
constexpr void Mono::Security::Protocol::Ntlm::Type2Message::__set__nonce(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> Mono::Security::Protocol::Ntlm::Type2Message::__get__nonce() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Mono::Security::Protocol::Ntlm::Type2Message::__set__targetName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW Mono::Security::Protocol::Ntlm::Type2Message::__get__targetName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Mono::Security::Protocol::Ntlm::Type2Message::__set__targetInfo(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> Mono::Security::Protocol::Ntlm::Type2Message::__get__targetInfo() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
 Mono::Security::Protocol::Ntlm::Type2Message Mono::Security::Protocol::Ntlm::Type2Message::New_ctor(::ArrayW<uint8_t> message)  {
Mono::Security::Protocol::Ntlm::Type2Message o{THROW_UNLESS(::il2cpp_utils::New<Mono::Security::Protocol::Ntlm::Type2Message>(message))};
return o;
}
 void Mono::Security::Protocol::Ntlm::Type2Message::_ctor(::ArrayW<uint8_t> message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Mono::Security::Protocol::Ntlm::Type2Message>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
