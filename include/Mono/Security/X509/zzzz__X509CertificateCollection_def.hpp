...
namespace Mono::Security::X509 {
class ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator;
}
...
class CORDL_TYPE ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator", modifiers: " const&", def_value: None }]
constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator(____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator", modifiers: "&&", def_value: None }]
constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator(____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator& operator=(____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator&& o) noexcept = default;
  constexpr ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator& operator=(____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator const& o) noexcept = default;
...
explicit ____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator(::Mono::Security::X509::X509CertificateCollection mappings) ;
...
public:
// Declarations
using X509CertificateEnumerator = ::Mono::Security::X509::____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator;
...
/// @brief Method GetEnumerator addr 0x2285d14 size 0x60 virtual false final false
 ::Mono::Security::X509::____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator GetEnumerator() ;
...
NEED_NO_BOX(::Mono::Security::X509::____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator);
DEFINE_IL2CPP_ARG_TYPE(::Mono::Security::X509::____Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator, "Mono.Security.X509", "X509CertificateCollection/X509CertificateEnumerator");
