...
namespace Mono::Security::X509 {
  ...
  check_size<sizeof(X509ExtensionCollection), 24 + sizeof(bool) + ((24 + sizeof(bool)) % 8 != 0 ? (8 - (24 + sizeof(bool)) % 8) : 0)> __Mono_Security_X509_X509ExtensionCollectionSizeCheck;
}
