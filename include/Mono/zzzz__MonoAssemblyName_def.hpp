...
namespace Mono {
struct ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer;
}
...
struct CORDL_TYPE ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "uint8_t", modifiers: "", def_value: None }]
constexpr ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer(uint8_t FixedElementField) noexcept;


                    constexpr ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer(____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer const&) = default;
                    constexpr ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer(____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer&&) = default;
                    constexpr ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer& operator=(____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer& operator=(____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer&& o) noexcept {
...
constexpr explicit ____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::cordl_internals::intptr_t __get_public_key() const;
 ...
 ::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer __declspec(property(get=__get_public_key_token, put=__set_public_key_token))  public_key_token;

constexpr void __set_public_key_token(::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer value) ;

constexpr ::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer __get_public_key_token() const;
...
DEFINE_IL2CPP_ARG_TYPE(::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer, "Mono", "MonoAssemblyName/<public_key_token>e__FixedBuffer");
