...
namespace Mono::Net {
  ...
  check_size<sizeof(CFStreamClientContext), 32 + sizeof(System::IntPtr) + ((32 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (32 + sizeof(System::IntPtr)) % 8) : 0)> __Mono_Net_CFStreamClientContextSizeCheck;
}
