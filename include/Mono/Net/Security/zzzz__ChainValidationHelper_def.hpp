...
namespace Mono::Net::Security {
class ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0;
}
...
class CORDL_TYPE ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0", modifiers: " const&", def_value: None }]
constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0(____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0", modifiers: "&&", def_value: None }]
constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0(____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0& operator=(____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0&& o) noexcept = default;
  constexpr ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0& operator=(____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0() ;
...
public:
// Declarations
using __c__DisplayClass11_0 = ::Mono::Net::Security::____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0;
...
NEED_NO_BOX(::Mono::Net::Security::____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0);
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__ChainValidationHelper____c__DisplayClass11_0, "Mono.Net.Security", "ChainValidationHelper/<>c__DisplayClass11_0");
