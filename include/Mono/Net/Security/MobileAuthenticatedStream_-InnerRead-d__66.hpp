...
namespace Mono::Net::Security {
  ...
  check_size<sizeof(MobileAuthenticatedStream::$InnerRead$d__66), 56 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter) + ((56 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter)) % 8) : 0)> __Mono_Net_Security_MobileAuthenticatedStream_$InnerRead$d__66SizeCheck;
}
