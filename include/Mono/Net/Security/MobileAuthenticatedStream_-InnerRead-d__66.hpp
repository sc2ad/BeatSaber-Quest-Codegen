...
namespace Mono::Net::Security {
  ...
  // Writing MetadataGetter for method: MobileAuthenticatedStream::$InnerRead$d__66::MoveNext
  // Il2CppName: MoveNext
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MobileAuthenticatedStream::$InnerRead$d__66::*)()>(&MobileAuthenticatedStream::$InnerRead$d__66::MoveNext)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MobileAuthenticatedStream::$InnerRead$d__66), "MoveNext", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  // Writing MetadataGetter for method: MobileAuthenticatedStream::$InnerRead$d__66::SetStateMachine
  // Il2CppName: SetStateMachine
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (MobileAuthenticatedStream::$InnerRead$d__66::*)(System::Runtime::CompilerServices::IAsyncStateMachine*)>(&MobileAuthenticatedStream::$InnerRead$d__66::SetStateMachine)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(MobileAuthenticatedStream::$InnerRead$d__66), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::CompilerServices::IAsyncStateMachine*>()});
    }
  };
}
