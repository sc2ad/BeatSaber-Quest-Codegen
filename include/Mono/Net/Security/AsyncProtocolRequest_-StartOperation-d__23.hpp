...
namespace Mono::Net::Security {
  ...
  check_size<sizeof(AsyncProtocolRequest::$StartOperation$d__23), 48 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter) + ((48 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8 != 0 ? (8 - (48 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8) : 0)> __Mono_Net_Security_AsyncProtocolRequest_$StartOperation$d__23SizeCheck;
}
