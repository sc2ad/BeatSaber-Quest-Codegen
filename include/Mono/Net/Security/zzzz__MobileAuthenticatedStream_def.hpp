...
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream__Operation;
}
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream__OperationType;
}
namespace Mono::Net::Security {
class MobileAuthenticatedStream;
}
namespace Mono::Net::Security {
class ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0;
}
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66;
}
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67;
}
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48;
}
namespace Mono::Net::Security {
struct ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57;
}
// Type: ::Operation
namespace Mono::Net::Security {
// Is value type: true
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream__Operation : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream__Operation(int32_t value__) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__Operation(____Mono__Net__Security__MobileAuthenticatedStream__Operation const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__Operation(____Mono__Net__Security__MobileAuthenticatedStream__Operation&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__Operation& operator=(____Mono__Net__Security__MobileAuthenticatedStream__Operation const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__Operation& operator=(____Mono__Net__Security__MobileAuthenticatedStream__Operation&& o) noexcept {
...
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream__Operation(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______Mono__Net__Security__MobileAuthenticatedStream__Operation_Unwrapped : int32_t {
__None = 0,
__Handshake = 1,
__Authenticated = 2,
__Renegotiate = 3,
...
constexpr operator ______Mono__Net__Security__MobileAuthenticatedStream__Operation_Unwrapped () const noexcept {
return std::bit_cast<______Mono__Net__Security__MobileAuthenticatedStream__Operation_Unwrapped>(__instance);
}
...
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const None;

/// @brief Field Handshake offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Handshake;

/// @brief Field Authenticated offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Authenticated;

/// @brief Field Renegotiate offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Renegotiate;

/// @brief Field Read offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Read;

/// @brief Field Write offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Write;

/// @brief Field Close offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation const Close;
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream__OperationType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream__OperationType(int32_t value__) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__OperationType(____Mono__Net__Security__MobileAuthenticatedStream__OperationType const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__OperationType(____Mono__Net__Security__MobileAuthenticatedStream__OperationType&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__OperationType& operator=(____Mono__Net__Security__MobileAuthenticatedStream__OperationType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream__OperationType& operator=(____Mono__Net__Security__MobileAuthenticatedStream__OperationType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream__OperationType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______Mono__Net__Security__MobileAuthenticatedStream__OperationType_Unwrapped : int32_t {
__Read = 0,
__Write = 1,
__Renegotiate = 2,
__Shutdown = 3,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______Mono__Net__Security__MobileAuthenticatedStream__OperationType_Unwrapped () const noexcept {
return std::bit_cast<______Mono__Net__Security__MobileAuthenticatedStream__OperationType_Unwrapped>(__instance);
}
...
/// @brief Field Read offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType const Read;

/// @brief Field Write offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType const Write;

/// @brief Field Renegotiate offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType const Renegotiate;

/// @brief Field Shutdown offset 0
static ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType const Shutdown;
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "options", ty: "::Mono::Net::Security::MonoSslAuthenticationOptions", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Mono::Net::Security::MobileAuthenticatedStream", modifiers: "", def_value: None }, CppParam { name: "runSynchronously", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult>", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::Mono::Net::Security::MonoSslAuthenticationOptions options, ::Mono::Net::Security::MobileAuthenticatedStream __4__this, bool runSynchronously, ::System::Threading::CancellationToken cancellationToken, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult> __u__1) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48(____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48 const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48(____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48& operator=(____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48& operator=(____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::System::Threading::CancellationToken __get_cancellationToken() const;
 ...
 ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult> __declspec(property(get=__get___u__1, put=__set___u__1))  __u__1;

constexpr void __set___u__1(::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult> value) ;

constexpr ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult> __get___u__1() const;
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Mono::Net::Security::MobileAuthenticatedStream", modifiers: "", def_value: None }, CppParam { name: "type", ty: "::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType", modifiers: "", def_value: None }, CppParam { name: "asyncRequest", ty: "::Mono::Net::Security::AsyncProtocolRequest", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult>", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t> __t__builder, ::Mono::Net::Security::MobileAuthenticatedStream __4__this, ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType type, ::Mono::Net::Security::AsyncProtocolRequest asyncRequest, ::System::Threading::CancellationToken cancellationToken, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::Mono::Net::Security::AsyncProtocolResult> __u__1) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57(____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57 const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57(____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57& operator=(____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57& operator=(____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::Mono::Net::Security::MobileAuthenticatedStream __get___4__this() const;
 ...
 ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType __declspec(property(get=__get_type, put=__set_type))  type;

constexpr void __set_type(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType value) ;

constexpr ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType __get_type() const;
...
class CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0", modifiers: " const&", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0(____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0", modifiers: "&&", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0(____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0& operator=(____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0&& o) noexcept = default;
  constexpr ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0& operator=(____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0() ;
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Mono::Net::Security::MobileAuthenticatedStream", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "requestedSize", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "sync", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t>", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t> __t__builder, ::Mono::Net::Security::MobileAuthenticatedStream __4__this, ::System::Threading::CancellationToken cancellationToken, int32_t requestedSize, bool sync, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t> __u__1) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66(____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66 const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66(____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66& operator=(____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66& operator=(____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::Mono::Net::Security::MobileAuthenticatedStream", modifiers: "", def_value: None }, CppParam { name: "sync", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::System::Threading::CancellationToken cancellationToken, ::Mono::Net::Security::MobileAuthenticatedStream __4__this, bool sync, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1) noexcept;


                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67(____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67 const&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67(____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67&&) = default;
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67& operator=(____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67& operator=(____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _InnerWrite_d__67 = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67;

using _InnerRead_d__66 = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66;

using __c__DisplayClass66_0 = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0;

using _StartOperation_d__57 = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57;

using _ProcessAuthentication_d__48 = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48;

using OperationType = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType;

using Operation = ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation;
...
constexpr bool __get_shutdown() const;
 ...
 ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation __declspec(property(get=__get_operation, put=__set_operation))  operation;

constexpr void __set_operation(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation value) ;

constexpr ::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation __get_operation() const;
...
/// @brief Method StartOperation addr 0x268ff5c size 0x11c virtual false final false
 ::System::Threading::Tasks::Task_1<int32_t> StartOperation(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType type, ::Mono::Net::Security::AsyncProtocolRequest asyncRequest, ::System::Threading::CancellationToken cancellationToken) ;
...
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__Operation, "Mono.Net.Security", "MobileAuthenticatedStream/Operation");
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream__OperationType, "Mono.Net.Security", "MobileAuthenticatedStream/OperationType");
...
NEED_NO_BOX(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0);
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream____c__DisplayClass66_0, "Mono.Net.Security", "MobileAuthenticatedStream/<>c__DisplayClass66_0");
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___InnerRead_d__66, "Mono.Net.Security", "MobileAuthenticatedStream/<InnerRead>d__66");
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___InnerWrite_d__67, "Mono.Net.Security", "MobileAuthenticatedStream/<InnerWrite>d__67");
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___ProcessAuthentication_d__48, "Mono.Net.Security", "MobileAuthenticatedStream/<ProcessAuthentication>d__48");
DEFINE_IL2CPP_ARG_TYPE(::Mono::Net::Security::____Mono__Net__Security__MobileAuthenticatedStream___StartOperation_d__57, "Mono.Net.Security", "MobileAuthenticatedStream/<StartOperation>d__57");
