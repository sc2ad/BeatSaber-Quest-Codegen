...
namespace Mono::Net::Security {
  ...
  check_size<sizeof(MobileAuthenticatedStream), 152 + sizeof(int) + ((152 + sizeof(int)) % 8 != 0 ? (8 - (152 + sizeof(int)) % 8) : 0)> __Mono_Net_Security_MobileAuthenticatedStreamSizeCheck;
}
