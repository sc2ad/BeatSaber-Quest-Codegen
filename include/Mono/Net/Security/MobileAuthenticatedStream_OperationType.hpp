...
namespace Mono::Net::Security {
  ...
  check_size<sizeof(MobileAuthenticatedStream::OperationType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __Mono_Net_Security_MobileAuthenticatedStream_OperationTypeSizeCheck;
}
