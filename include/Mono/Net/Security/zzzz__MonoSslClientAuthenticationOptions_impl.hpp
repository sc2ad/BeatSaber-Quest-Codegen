...
// Ctor Parameters []
 Mono::Net::Security::MonoSslClientAuthenticationOptions::MonoSslClientAuthenticationOptions()  : Mono::Net::Security::MonoSslAuthenticationOptions(THROW_UNLESS(::il2cpp_utils::New<MonoSslClientAuthenticationOptions>())) {}
