...
constexpr void ::Mono::MonoAssemblyName::__set_public_key_token(::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer, 0x20>(this->__instance, std::forward<::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer>(value));
}
constexpr ::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer ::Mono::MonoAssemblyName::__get_public_key_token() const {
return ::cordl_internals::getInstanceField<::Mono::____Mono__MonoAssemblyName___public_key_token_e__FixedBuffer, 0x20>(this->__instance);
}
