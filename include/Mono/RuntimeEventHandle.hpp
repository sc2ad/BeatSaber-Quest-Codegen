...
namespace Mono {
  ...
  check_size<sizeof(RuntimeEventHandle), 0 + sizeof(System::IntPtr) + ((0 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (0 + sizeof(System::IntPtr)) % 8) : 0)> __Mono_RuntimeEventHandleSizeCheck;
}
