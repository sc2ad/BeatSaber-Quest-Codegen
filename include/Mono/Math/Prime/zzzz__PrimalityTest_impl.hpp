...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Mono::Math::Prime::PrimalityTest::*)(Mono::Math::BigInteger, Mono::Math::Prime::ConfidenceFactor)>(&Mono::Math::Prime::PrimalityTest::Invoke)> {
 ...
 Mono::Math::Prime::PrimalityTest Mono::Math::Prime::PrimalityTest::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
Mono::Math::Prime::PrimalityTest o{THROW_UNLESS(::il2cpp_utils::New<Mono::Math::Prime::PrimalityTest>(object, method))};
return o;
}
