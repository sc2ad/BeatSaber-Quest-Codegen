...
namespace Mono {
  ...
  check_size<sizeof(SafeGPtrArrayHandle), 0 + sizeof(Mono::RuntimeGPtrArrayHandle) + ((0 + sizeof(Mono::RuntimeGPtrArrayHandle)) % 8 != 0 ? (8 - (0 + sizeof(Mono::RuntimeGPtrArrayHandle)) % 8) : 0)> __Mono_SafeGPtrArrayHandleSizeCheck;
}
