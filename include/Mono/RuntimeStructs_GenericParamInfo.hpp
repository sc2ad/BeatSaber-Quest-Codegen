...
namespace Mono {
  ...
  check_size<sizeof(RuntimeStructs::GenericParamInfo), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Mono_RuntimeStructs_GenericParamInfoSizeCheck;
}
