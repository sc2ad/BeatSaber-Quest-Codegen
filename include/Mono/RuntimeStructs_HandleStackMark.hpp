...
namespace Mono {
  ...
  check_size<sizeof(RuntimeStructs::HandleStackMark), 8 + sizeof(System::IntPtr) + ((8 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (8 + sizeof(System::IntPtr)) % 8) : 0)> __Mono_RuntimeStructs_HandleStackMarkSizeCheck;
}
