...
namespace Mono::Globalization::Unicode {
  ...
  check_size<sizeof(SimpleCollator::PreviousInfo), 8 + sizeof(void*) + ((8 + sizeof(void*)) % 8 != 0 ? (8 - (8 + sizeof(void*)) % 8) : 0)> __Mono_Globalization_Unicode_SimpleCollator_PreviousInfoSizeCheck;
}
