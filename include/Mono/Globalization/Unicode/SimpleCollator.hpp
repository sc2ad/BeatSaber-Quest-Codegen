...
namespace Mono::Globalization::Unicode {
  ...
  class SimpleCollator : public ::CsObject {
    public:
    ...
    // Offset: 0x109CBAC
    Mono::Globalization::Unicode::Contraction* GetContraction(::CsString* s, int start, int end);
    ...
    // Offset: 0x109CC88
    Mono::Globalization::Unicode::Contraction* GetContraction(::CsString* s, int start, int end, ::Array<Mono::Globalization::Unicode::Contraction*>* clist);
    // private Mono.Globalization.Unicode.Contraction GetTailContraction(System.String s, System.Int32 start, System.Int32 end)
    // Offset: 0x109CDBC
    Mono::Globalization::Unicode::Contraction* GetTailContraction(::CsString* s, int start, int end);
    ...
    // Offset: 0x109CE98
    Mono::Globalization::Unicode::Contraction* GetTailContraction(::CsString* s, int start, int end, ::Array<Mono::Globalization::Unicode::Contraction*>* clist);
    ...
    // Offset: 0x109D62C
    System::Globalization::SortKey* GetSortKey(::CsString* s, System::Globalization::CompareOptions options);
    ...
    // Offset: 0x109D64C
    System::Globalization::SortKey* GetSortKey(::CsString* s, int start, int length, System::Globalization::CompareOptions options);
    ...
    // Offset: 0x109D974
    void GetSortKey(::CsString* s, int start, int end, Mono::Globalization::Unicode::SortKeyBuffer* buf, System::Globalization::CompareOptions opt);
    ...
    // Offset: 0x109E478
    int Compare(::CsString* s1, int idx1, int len1, ::CsString* s2, int idx2, int len2, System::Globalization::CompareOptions options);
    ...
    // Offset: 0x109E538
    int CompareInternal(::CsString* s1, int idx1, int len1, ::CsString* s2, int idx2, int len2, bool& targetConsumed, bool& sourceConsumed, bool skipHeadingExtenders, bool immediateBreakup, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x109F8E4
    bool IsPrefix(::CsString* src, ::CsString* target, System::Globalization::CompareOptions opt);
    ...
    // Offset: 0x109F904
    bool IsPrefix(::CsString* s, ::CsString* target, int start, int length, System::Globalization::CompareOptions opt);
    ...
    // Offset: 0x109F9B8
    bool IsPrefix(::CsString* s, ::CsString* target, int start, int length, bool skipHeadingExtenders, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    // public System.Boolean IsSuffix(System.String src, System.String target, System.Globalization.CompareOptions opt)
    // Offset: 0x109FA24
    bool IsSuffix(::CsString* src, ::CsString* target, System::Globalization::CompareOptions opt);
    ...
    // Offset: 0x109FA44
    bool IsSuffix(::CsString* s, ::CsString* target, int start, int length, System::Globalization::CompareOptions opt);
    ...
    // Offset: 0x109FCBC
    int QuickIndexOf(::CsString* s, ::CsString* target, int start, int length, bool& testWasUnable);
    ...
    // Offset: 0x109FE30
    int IndexOf(::CsString* s, ::CsString* target, int start, int length, System::Globalization::CompareOptions opt);
    // private System.Int32 IndexOfOrdinal(System.String s, System.String target, System.Int32 start, System.Int32 length)
    // Offset: 0x10A04F0
    int IndexOfOrdinal(::CsString* s, ::CsString* target, int start, int length);
    // private System.Int32 IndexOfOrdinal(System.String s, System.Char target, System.Int32 start, System.Int32 length)
    // Offset: 0x10A05CC
    int IndexOfOrdinal(::CsString* s, ::Il2CppChar target, int start, int length);
    ...
    // Offset: 0x10A063C
    int IndexOfSortKey(::CsString* s, int start, int length, uint8_t* sortkey, ::Il2CppChar target, int ti, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A001C
    int IndexOf(::CsString* s, ::CsString* target, int start, int length, uint8_t* targetSortKey, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x109FAE0
    int LastIndexOf(::CsString* s, ::CsString* target, int start, int length, System::Globalization::CompareOptions opt);
    // private System.Int32 LastIndexOfOrdinal(System.String s, System.String target, System.Int32 start, System.Int32 length)
    // Offset: 0x10A089C
    int LastIndexOfOrdinal(::CsString* s, ::CsString* target, int start, int length);
    ...
    // Offset: 0x10A0F18
    int LastIndexOfSortKey(::CsString* s, int start, int orgStart, int length, uint8_t* sortkey, int ti, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A09CC
    int LastIndexOf(::CsString* s, ::CsString* target, int start, int length, uint8_t* targetSortKey, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A06DC
    bool MatchesForward(::CsString* s, int& idx, int end, int ti, uint8_t* sortkey, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A1190
    bool MatchesForwardCore(::CsString* s, int& idx, int end, int ti, uint8_t* sortkey, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::ExtenderType ext, Mono::Globalization::Unicode::Contraction*& ct, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A0FC8
    bool MatchesBackward(::CsString* s, int& idx, int end, int orgStart, int ti, uint8_t* sortkey, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
    ...
    // Offset: 0x10A1764
    bool MatchesBackwardCore(::CsString* s, int& idx, int end, int orgStart, int ti, uint8_t* sortkey, bool noLv4, Mono::Globalization::Unicode::SimpleCollator::ExtenderType ext, Mono::Globalization::Unicode::Contraction*& ct, Mono::Globalization::Unicode::SimpleCollator::Context& ctx);
