...
class ____Mono__Unity__UnityTls__unitytls_tlsctx_read_callback;
}
...
namespace Mono::Unity {
class ____Mono__Unity__UnityTls__unitytls_tlsctx_write_callback;
}
namespace Mono::Net::Security {
...
namespace Mono::Unity {
class ____Mono__Unity__UnityTls__unitytls_tlsctx_x509verify_callback;
}
namespace System {
...
namespace Mono::Unity {
class ____Mono__Unity__UnityTls__unitytls_tlsctx_certificate_callback;
}
namespace System::Security::Cryptography::X509Certificates {
...
constexpr void* __get_requestedClientKey() const;
 ...
 ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_read_callback __declspec(property(get=__get_readCallback, put=__set_readCallback))  readCallback;

constexpr void __set_readCallback(::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_read_callback value) ;

constexpr ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_read_callback __get_readCallback() const;

 ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_write_callback __declspec(property(get=__get_writeCallback, put=__set_writeCallback))  writeCallback;

constexpr void __set_writeCallback(::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_write_callback value) ;

constexpr ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_write_callback __get_writeCallback() const;

 ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_certificate_callback __declspec(property(get=__get_certificateCallback, put=__set_certificateCallback))  certificateCallback;

constexpr void __set_certificateCallback(::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_certificate_callback value) ;

constexpr ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_certificate_callback __get_certificateCallback() const;

 ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_x509verify_callback __declspec(property(get=__get_verifyCallback, put=__set_verifyCallback))  verifyCallback;

constexpr void __set_verifyCallback(::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_x509verify_callback value) ;

constexpr ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_tlsctx_x509verify_callback __get_verifyCallback() const;
...
static ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_x509verify_result VerifyCallback(void* userData, ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_x509list_ref chain, void* errorState) ;

/// @brief Method VerifyCallback addr 0x268a4f4 size 0x408 virtual false final false
 ::Mono::Unity::____Mono__Unity__UnityTls__unitytls_x509verify_result VerifyCallback(::Mono::Unity::____Mono__Unity__UnityTls__unitytls_x509list_ref chain, void* errorState) ;
