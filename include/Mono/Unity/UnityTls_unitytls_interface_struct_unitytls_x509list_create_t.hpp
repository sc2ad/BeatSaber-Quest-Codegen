...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FAE0
  class UnityTls::unitytls_interface_struct::unitytls_x509list_create_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143B928
    Mono::Unity::UnityTls::unitytls_x509list* Invoke_NEW(Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143BB80
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_x509list* EndInvoke(System.IAsyncResult result)
    // Offset: 0x143BBA4
    Mono::Unity::UnityTls::unitytls_x509list* EndInvoke_NEW(System::IAsyncResult* result);
