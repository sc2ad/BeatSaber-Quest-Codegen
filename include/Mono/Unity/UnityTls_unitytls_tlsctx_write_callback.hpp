...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9F9C8
  class UnityTls::unitytls_tlsctx_write_callback : public System::MulticastDelegate {
    ...
    // Offset: 0x143D578
    System::IntPtr Invoke_NEW(void* userData, uint8_t* data, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143D824
    System::IAsyncResult* BeginInvoke_NEW(void* userData, uint8_t* data, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
