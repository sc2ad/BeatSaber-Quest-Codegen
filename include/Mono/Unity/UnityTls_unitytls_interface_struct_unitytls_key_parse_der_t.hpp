...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FA68
  class UnityTls::unitytls_interface_struct::unitytls_key_parse_der_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1437B48
    Mono::Unity::UnityTls::unitytls_key* Invoke_NEW(uint8_t* buffer, System::IntPtr bufferLen, uint8_t* password, System::IntPtr passwordLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x1437E1C
    System::IAsyncResult* BeginInvoke_NEW(uint8_t* buffer, System::IntPtr bufferLen, uint8_t* password, System::IntPtr passwordLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_key* EndInvoke(System.IAsyncResult result)
    // Offset: 0x1437EDC
    Mono::Unity::UnityTls::unitytls_key* EndInvoke_NEW(System::IAsyncResult* result);
