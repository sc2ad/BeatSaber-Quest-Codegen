...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9F9F0
  class UnityTls::unitytls_tlsctx_trace_callback : public System::MulticastDelegate {
    ...
    // Offset: 0x143D20C
    void Invoke_NEW(void* userData, Mono::Unity::UnityTls::unitytls_tlsctx* ctx, uint8_t* traceMessage, System::IntPtr traceMessageLen);
    ...
    // Offset: 0x143D4B0
    System::IAsyncResult* BeginInvoke_NEW(void* userData, Mono::Unity::UnityTls::unitytls_tlsctx* ctx, uint8_t* traceMessage, System::IntPtr traceMessageLen, System::AsyncCallback* callback, ::Il2CppObject* object);
