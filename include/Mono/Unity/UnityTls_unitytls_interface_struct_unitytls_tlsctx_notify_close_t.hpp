...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FC48
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_notify_close_t : public System::MulticastDelegate {
    ...
    // Offset: 0x14397DC
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
