...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FACC
  class UnityTls::unitytls_interface_struct::unitytls_x509list_get_x509_t : public System::MulticastDelegate {
    ...
    // Offset: 0x14368A4
    Mono::Unity::UnityTls::unitytls_x509_ref Invoke_NEW(Mono::Unity::UnityTls::unitytls_x509list_ref list, System::IntPtr index, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143C134
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_x509list_ref list, System::IntPtr index, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_x509_ref EndInvoke(System.IAsyncResult result)
    // Offset: 0x143C1E8
    Mono::Unity::UnityTls::unitytls_x509_ref EndInvoke_NEW(System::IAsyncResult* result);
