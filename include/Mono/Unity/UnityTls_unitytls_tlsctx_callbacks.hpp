...
namespace Mono::Unity {
  ...
  check_size<sizeof(UnityTls::unitytls_tlsctx_callbacks), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Mono_Unity_UnityTls_unitytls_tlsctx_callbacksSizeCheck;
}
