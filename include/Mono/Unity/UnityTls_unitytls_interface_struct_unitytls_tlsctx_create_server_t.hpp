...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FB58
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_create_server_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1438AB4
    Mono::Unity::UnityTls::unitytls_tlsctx* Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx_protocolrange supportedProtocols, Mono::Unity::UnityTls::unitytls_tlsctx_callbacks callbacks, uint64_t certChain, uint64_t leafCertificateKey, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
