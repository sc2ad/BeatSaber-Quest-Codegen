...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FA40
  class UnityTls::unitytls_interface_struct::unitytls_errorstate_raise_error_t : public System::MulticastDelegate {
    ...
    // Offset: 0x14372AC
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_errorstate* errorState, Mono::Unity::UnityTls::unitytls_error_code errorCode);
    ...
    // Offset: 0x143751C
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_errorstate* errorState, Mono::Unity::UnityTls::unitytls_error_code errorCode, System::AsyncCallback* callback, ::Il2CppObject* object);
