...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FB30
  class UnityTls::unitytls_interface_struct::unitytls_x509verify_default_ca_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143C224
    Mono::Unity::UnityTls::unitytls_x509verify_result Invoke_NEW(Mono::Unity::UnityTls::unitytls_x509list_ref chain, uint8_t* cn, System::IntPtr cnLen, Mono::Unity::UnityTls::unitytls_x509verify_callback* cb, void* userData, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143C524
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_x509list_ref chain, uint8_t* cn, System::IntPtr cnLen, Mono::Unity::UnityTls::unitytls_x509verify_callback* cb, void* userData, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
