...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FAF4
  class UnityTls::unitytls_interface_struct::unitytls_x509list_append_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143B5E0
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, Mono::Unity::UnityTls::unitytls_x509_ref cert, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143B86C
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, Mono::Unity::UnityTls::unitytls_x509_ref cert, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
