...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FA90
  class UnityTls::unitytls_interface_struct::unitytls_key_free_t : public System::MulticastDelegate {
    ...
    // Offset: 0x14375D4
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_key* key);
    ...
    // Offset: 0x1437824
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_key* key, System::AsyncCallback* callback, ::Il2CppObject* object);
