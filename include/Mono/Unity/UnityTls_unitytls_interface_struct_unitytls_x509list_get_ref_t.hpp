...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FAB8
  class UnityTls::unitytls_interface_struct::unitytls_x509list_get_ref_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143BE50
    Mono::Unity::UnityTls::unitytls_x509list_ref Invoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143C0C8
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_x509list_ref EndInvoke(System.IAsyncResult result)
    // Offset: 0x143C0F8
    Mono::Unity::UnityTls::unitytls_x509list_ref EndInvoke_NEW(System::IAsyncResult* result);
