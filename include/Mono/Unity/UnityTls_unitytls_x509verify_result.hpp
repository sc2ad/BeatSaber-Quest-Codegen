...
namespace Mono::Unity {
  ...
  check_size<sizeof(UnityTls::unitytls_x509verify_result), 0 + sizeof(uint) + ((0 + sizeof(uint)) % 8 != 0 ? (8 - (0 + sizeof(uint)) % 8) : 0)> __Mono_Unity_UnityTls_unitytls_x509verify_resultSizeCheck;
}
