...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FC0C
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_process_handshake_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1439A98
    Mono::Unity::UnityTls::unitytls_x509verify_result Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
