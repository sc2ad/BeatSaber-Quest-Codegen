...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FBF8
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_get_protocol_t : public System::MulticastDelegate {
    ...
    // Offset: 0x14394F8
    Mono::Unity::UnityTls::unitytls_protocol Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x1439770
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_protocol EndInvoke(System.IAsyncResult result)
    // Offset: 0x14397A0
    Mono::Unity::UnityTls::unitytls_protocol EndInvoke_NEW(System::IAsyncResult* result);
