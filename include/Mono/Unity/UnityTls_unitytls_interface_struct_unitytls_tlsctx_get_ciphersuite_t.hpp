...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FBE4
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_get_ciphersuite_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1439214
    Mono::Unity::UnityTls::unitytls_ciphersuite Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x14394BC
    Mono::Unity::UnityTls::unitytls_ciphersuite EndInvoke_NEW(System::IAsyncResult* result);
