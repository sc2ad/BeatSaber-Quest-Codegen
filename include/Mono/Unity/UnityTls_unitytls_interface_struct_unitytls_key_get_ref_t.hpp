...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FA54
  class UnityTls::unitytls_interface_struct::unitytls_key_get_ref_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1437864
    Mono::Unity::UnityTls::unitytls_key_ref Invoke_NEW(Mono::Unity::UnityTls::unitytls_key* key, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x1437ADC
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_key* key, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Mono.Unity.UnityTls/unitytls_key_ref EndInvoke(System.IAsyncResult result)
    // Offset: 0x1437B0C
    Mono::Unity::UnityTls::unitytls_key_ref EndInvoke_NEW(System::IAsyncResult* result);
