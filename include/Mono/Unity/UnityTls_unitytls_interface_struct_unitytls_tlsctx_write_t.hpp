...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FC34
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_write_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143B098
    System::IntPtr Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, uint8_t* data, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143B344
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, uint8_t* data, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
