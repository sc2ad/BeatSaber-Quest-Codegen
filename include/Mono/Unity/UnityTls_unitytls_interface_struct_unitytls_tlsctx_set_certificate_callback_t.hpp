...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FB94
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_set_certificate_callback_t : public System::MulticastDelegate {
    ...
    // Offset: 0x143A454
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_tlsctx_certificate_callback* cb, void* userData, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143A6F8
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, Mono::Unity::UnityTls::unitytls_tlsctx_certificate_callback* cb, void* userData, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
