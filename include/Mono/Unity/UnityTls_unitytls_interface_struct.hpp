...
namespace Mono::Unity {
  ...
  check_size<sizeof(UnityTls::unitytls_interface_struct), 272 + sizeof(void*) + ((272 + sizeof(void*)) % 8 != 0 ? (8 - (272 + sizeof(void*)) % 8) : 0)> __Mono_Unity_UnityTls_unitytls_interface_structSizeCheck;
}
