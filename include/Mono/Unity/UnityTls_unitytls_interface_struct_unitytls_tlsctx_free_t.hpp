...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FC5C
  class UnityTls::unitytls_interface_struct::unitytls_tlsctx_free_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1438F84
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx);
    ...
    // Offset: 0x14391D4
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_tlsctx* ctx, System::AsyncCallback* callback, ::Il2CppObject* object);
