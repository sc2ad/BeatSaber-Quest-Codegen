...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: C9FB08
  class UnityTls::unitytls_interface_struct::unitytls_x509list_append_der_t : public System::MulticastDelegate {
    ...
    // Offset: 0x1436420
    void Invoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, uint8_t* buffer, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState);
    ...
    // Offset: 0x143B51C
    System::IAsyncResult* BeginInvoke_NEW(Mono::Unity::UnityTls::unitytls_x509list* list, uint8_t* buffer, System::IntPtr bufferLen, Mono::Unity::UnityTls::unitytls_errorstate* errorState, System::AsyncCallback* callback, ::Il2CppObject* object);
