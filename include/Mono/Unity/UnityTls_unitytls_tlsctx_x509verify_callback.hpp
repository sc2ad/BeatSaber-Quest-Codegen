...
namespace Mono::Unity {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D449B0
  class UnityTls::unitytls_tlsctx_x509verify_callback : public System::MulticastDelegate {
    ...
    static UnityTls::unitytls_tlsctx_x509verify_callback* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Mono::Unity").WithContext("unitytls_tlsctx_x509verify_callback").WithContext(".ctor");
