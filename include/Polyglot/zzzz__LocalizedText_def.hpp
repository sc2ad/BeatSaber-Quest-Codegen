...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15541)), TypeDefinitionIndex(TypeDefinitionIndex(13067)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15541), inst: 2506 })}
