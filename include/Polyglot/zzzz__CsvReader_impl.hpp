...
constexpr void Polyglot::Polyglot__CsvReader__ParsingMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t Polyglot::Polyglot__CsvReader__ParsingMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr Polyglot::Polyglot__CsvReader__ParsingMode  Polyglot::Polyglot__CsvReader__ParsingMode::None{0};
constexpr Polyglot::Polyglot__CsvReader__ParsingMode  Polyglot::Polyglot__CsvReader__ParsingMode::OutQuote{1};
constexpr Polyglot::Polyglot__CsvReader__ParsingMode  Polyglot::Polyglot__CsvReader__ParsingMode::InQuote{2};
