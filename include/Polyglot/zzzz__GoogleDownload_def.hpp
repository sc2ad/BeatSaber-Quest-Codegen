...
namespace Polyglot {
class ____Polyglot__GoogleDownload___DownloadSheet_d__0;
}
...
class CORDL_TYPE ____Polyglot__GoogleDownload___DownloadSheet_d__0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Polyglot__GoogleDownload___DownloadSheet_d__0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Polyglot__GoogleDownload___DownloadSheet_d__0", modifiers: " const&", def_value: None }]
constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0(____Polyglot__GoogleDownload___DownloadSheet_d__0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Polyglot__GoogleDownload___DownloadSheet_d__0", modifiers: "&&", def_value: None }]
constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0(____Polyglot__GoogleDownload___DownloadSheet_d__0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Polyglot__GoogleDownload___DownloadSheet_d__0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0& operator=(____Polyglot__GoogleDownload___DownloadSheet_d__0&& o) noexcept = default;
  constexpr ____Polyglot__GoogleDownload___DownloadSheet_d__0& operator=(____Polyglot__GoogleDownload___DownloadSheet_d__0 const& o) noexcept = default;
...
explicit ____Polyglot__GoogleDownload___DownloadSheet_d__0(int32_t __1__state) ;
...
public:
// Declarations
using _DownloadSheet_d__0 = ::Polyglot::____Polyglot__GoogleDownload___DownloadSheet_d__0;
...
NEED_NO_BOX(::Polyglot::____Polyglot__GoogleDownload___DownloadSheet_d__0);
DEFINE_IL2CPP_ARG_TYPE(::Polyglot::____Polyglot__GoogleDownload___DownloadSheet_d__0, "Polyglot", "GoogleDownload/<DownloadSheet>d__0");
