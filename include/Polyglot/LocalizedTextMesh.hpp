...
namespace Polyglot {
  ...
  // [AddComponentMenu] Offset: 10FBC40
  // [RequireComponent] Offset: 10FBC40
  class LocalizedTextMesh : public ::UnityEngine::MonoBehaviour/*, public ::Polyglot::ILocalize*/ {
    public:
    public:
    // [TooltipAttribute] Offset: 0x10FC1A4
    ...
    // [TooltipAttribute] Offset: 0x10FC1F0
    // [LocalizationKeyAttribute] Offset: 0x10FC1F0
