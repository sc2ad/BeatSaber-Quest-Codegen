...
namespace Polyglot {
  ...
  // [AddComponentMenu] Offset: EE487C
  // [RequireComponent] Offset: EE487C
  class LocalizedTextMesh : public UnityEngine::MonoBehaviour/*, public Polyglot::ILocalize*/ {
    ...
    protected:
    #endif
    // [TooltipAttribute] Offset: 0xEE4DE0
    ...
    // [TooltipAttribute] Offset: 0xEE4E2C
    // [LocalizationKeyAttribute] Offset: 0xEE4E2C
