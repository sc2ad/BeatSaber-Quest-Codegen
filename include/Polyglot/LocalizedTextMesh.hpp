...
namespace Polyglot {
  ...
  // [AddComponentMenu] Offset: D0CD00
  // [RequireComponent] Offset: D0CD00
  class LocalizedTextMesh : public UnityEngine::MonoBehaviour/*, public Polyglot::ILocalize*/ {
    public:
    // [TooltipAttribute] Offset: 0xD0D264
    ...
    // [TooltipAttribute] Offset: 0xD0D2B0
    // [LocalizationKeyAttribute] Offset: 0xD0D2B0
