...
namespace Polyglot {
  ...
  // [AddComponentMenu] Offset: 10C3E48
  // [RequireComponent] Offset: 10C3E48
  class LocalizedTextMesh : public ::UnityEngine::MonoBehaviour/*, public ::Polyglot::ILocalize*/ {
    public:
    public:
    // [TooltipAttribute] Offset: 0x10C43AC
    ...
    // [TooltipAttribute] Offset: 0x10C43F8
    // [LocalizationKeyAttribute] Offset: 0x10C43F8
