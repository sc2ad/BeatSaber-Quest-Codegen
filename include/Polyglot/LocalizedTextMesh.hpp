...
namespace Polyglot {
  ...
  // [AddComponentMenu] Offset: 10BCE28
  // [RequireComponent] Offset: 10BCE28
  class LocalizedTextMesh : public ::UnityEngine::MonoBehaviour/*, public ::Polyglot::ILocalize*/ {
    public:
    public:
    // [TooltipAttribute] Offset: 0x10BD38C
    ...
    // [TooltipAttribute] Offset: 0x10BD3D8
    // [LocalizationKeyAttribute] Offset: 0x10BD3D8
