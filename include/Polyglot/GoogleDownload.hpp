...
namespace Polyglot {
  ...
  class GoogleDownload : public ::CsObject {
    public:
    ...
    // Offset: 0x190C1D4
    static System::Collections::IEnumerator* DownloadSheet(::CsString* docsId, ::CsString* sheetId, System::Action_1<::CsString*>* done, Polyglot::GoogleDriveDownloadFormat format, System::Func_2<float, bool>* progressbar);
