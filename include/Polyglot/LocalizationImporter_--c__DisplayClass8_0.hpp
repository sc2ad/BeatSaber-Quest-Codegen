...
namespace Polyglot {
  ...
  check_size<sizeof(LocalizationImporter::$$c__DisplayClass8_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Polyglot_LocalizationImporter_$$c__DisplayClass8_0SizeCheck;
}
