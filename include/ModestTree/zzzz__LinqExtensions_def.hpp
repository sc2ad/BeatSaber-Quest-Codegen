...
template<typename T>
class ____ModestTree__LinqExtensions___Yield_d__0_1;
}
namespace ModestTree {
template<typename T>
class ____ModestTree__LinqExtensions____c__8_1;
}
namespace ModestTree {
template<typename T>
class ____ModestTree__LinqExtensions____c__DisplayClass10_0_1;
}
namespace ModestTree {
...
class ____ModestTree__LinqExtensions___Yield_d__0_1<T>;
}
namespace ModestTree {
template<>
class ____ModestTree__LinqExtensions___Yield_d__0_1<::UnityEngine::SceneManagement::Scene>;
}
namespace ModestTree {
template<::cordl_internals::il2cpp_reference_type T>
class ____ModestTree__LinqExtensions____c__8_1<T>;
}
namespace ModestTree {
template<::cordl_internals::il2cpp_reference_type T>
class ____ModestTree__LinqExtensions____c__DisplayClass10_0_1<T>;
}
// Type: ::<Yield>d__0`1
// Type: ::<>c__8`1
...
// Declarations
template<typename T>
using __c__DisplayClass10_0_1 = ::ModestTree::____ModestTree__LinqExtensions____c__DisplayClass10_0_1<T>;

template<typename T>
using __c__8_1 = ::ModestTree::____ModestTree__LinqExtensions____c__8_1<T>;

template<typename T>
using _Yield_d__0_1 = ::ModestTree::____ModestTree__LinqExtensions___Yield_d__0_1<T>;
...
class CORDL_TYPE ____ModestTree__LinqExtensions___Yield_d__0_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____ModestTree__LinqExtensions___Yield_d__0_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions___Yield_d__0_1", modifiers: " const&", def_value: None }]
constexpr ____ModestTree__LinqExtensions___Yield_d__0_1(____ModestTree__LinqExtensions___Yield_d__0_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions___Yield_d__0_1", modifiers: "&&", def_value: None }]
constexpr ____ModestTree__LinqExtensions___Yield_d__0_1(____ModestTree__LinqExtensions___Yield_d__0_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____ModestTree__LinqExtensions___Yield_d__0_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____ModestTree__LinqExtensions___Yield_d__0_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions___Yield_d__0_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions___Yield_d__0_1& operator=(____ModestTree__LinqExtensions___Yield_d__0_1&& o) noexcept = default;
  constexpr ____ModestTree__LinqExtensions___Yield_d__0_1& operator=(____ModestTree__LinqExtensions___Yield_d__0_1 const& o) noexcept = default;
...
explicit ____ModestTree__LinqExtensions___Yield_d__0_1(int32_t __1__state) ;
...
// CS Name: ModestTree.LinqExtensions::<Yield>d__0`1
class CORDL_TYPE ____ModestTree__LinqExtensions___Yield_d__0_1<::UnityEngine::SceneManagement::Scene> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
class CORDL_TYPE ____ModestTree__LinqExtensions____c__8_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____ModestTree__LinqExtensions____c__8_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions____c__8_1", modifiers: " const&", def_value: None }]
constexpr ____ModestTree__LinqExtensions____c__8_1(____ModestTree__LinqExtensions____c__8_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions____c__8_1", modifiers: "&&", def_value: None }]
constexpr ____ModestTree__LinqExtensions____c__8_1(____ModestTree__LinqExtensions____c__8_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____ModestTree__LinqExtensions____c__8_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____ModestTree__LinqExtensions____c__8_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions____c__8_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions____c__8_1& operator=(____ModestTree__LinqExtensions____c__8_1&& o) noexcept = default;
  constexpr ____ModestTree__LinqExtensions____c__8_1& operator=(____ModestTree__LinqExtensions____c__8_1 const& o) noexcept = default;
                


// Fields

static ::ModestTree::____ModestTree__LinqExtensions____c__8_1<T> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::ModestTree::____ModestTree__LinqExtensions____c__8_1<T> value) ;

static ::ModestTree::____ModestTree__LinqExtensions____c__8_1<T> __get___9() ;
...
// Ctor Parameters []
explicit ____ModestTree__LinqExtensions____c__8_1() ;
...
class CORDL_TYPE ____ModestTree__LinqExtensions____c__DisplayClass10_0_1<T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____ModestTree__LinqExtensions____c__DisplayClass10_0_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions____c__DisplayClass10_0_1", modifiers: " const&", def_value: None }]
constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1(____ModestTree__LinqExtensions____c__DisplayClass10_0_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____ModestTree__LinqExtensions____c__DisplayClass10_0_1", modifiers: "&&", def_value: None }]
constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1(____ModestTree__LinqExtensions____c__DisplayClass10_0_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____ModestTree__LinqExtensions____c__DisplayClass10_0_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1& operator=(____ModestTree__LinqExtensions____c__DisplayClass10_0_1&& o) noexcept = default;
  constexpr ____ModestTree__LinqExtensions____c__DisplayClass10_0_1& operator=(____ModestTree__LinqExtensions____c__DisplayClass10_0_1 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____ModestTree__LinqExtensions____c__DisplayClass10_0_1() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::ModestTree::____ModestTree__LinqExtensions___Yield_d__0_1, "ModestTree", "LinqExtensions/<Yield>d__0`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::ModestTree::____ModestTree__LinqExtensions____c__8_1, "ModestTree", "LinqExtensions/<>c__8`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::ModestTree::____ModestTree__LinqExtensions____c__DisplayClass10_0_1, "ModestTree", "LinqExtensions/<>c__DisplayClass10_0`1");
