...
namespace ModestTree::Util {
  ...
  class ValuePair : public ::Il2CppObject {
    ...
    static ModestTree::Util::ValuePair_2<T1, T2>* New(T1 first, T2 second) {
      ...
      return ::il2cpp_utils::RunMethodThrow<ModestTree::Util::ValuePair_2<T1, T2>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, first, second);
    }
    ...
    static ModestTree::Util::ValuePair_3<T1, T2, T3>* New(T1 first, T2 second, T3 third) {
      ...
      return ::il2cpp_utils::RunMethodThrow<ModestTree::Util::ValuePair_3<T1, T2, T3>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, first, second, third);
    }
    ...
    static ModestTree::Util::ValuePair_4<T1, T2, T3, T4>* New(T1 first, T2 second, T3 third, T4 fourth) {
      ...
      return ::il2cpp_utils::RunMethodThrow<ModestTree::Util::ValuePair_4<T1, T2, T3, T4>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, first, second, third, fourth);
    }
