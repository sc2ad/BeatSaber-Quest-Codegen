...
namespace ModestTree::Util {
  ...
  class ValuePair_3 : public ::Il2CppObject {
    ...
    T1 _get_First() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_get_First");
    ...
    void _set_First(T1 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_set_First");
      static auto ___internal__instance = this;
    ...
    T2 _get_Second() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_get_Second");
      static auto ___internal__instance = this;
    ...
    void _set_Second(T2 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_set_Second");
      static auto ___internal__instance = this;
    ...
    T3 _get_Third() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_get_Third");
      static auto ___internal__instance = this;
    ...
    void _set_Third(T3 value) {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::Util::ValuePair_3::_set_Third");
      static auto ___internal__instance = this;
