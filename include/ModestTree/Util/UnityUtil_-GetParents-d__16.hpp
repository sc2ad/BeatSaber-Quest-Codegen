...
namespace ModestTree::Util {
  ...
  check_size<sizeof(UnityUtil::$GetParents$d__16), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __ModestTree_Util_UnityUtil_$GetParents$d__16SizeCheck;
}
