...
explicit ValuePair_2(T1 first, T2 second) ;
...
// CS Name: ModestTree.Util.ValuePair`2
class CORDL_TYPE ValuePair_2<T1,int32_t> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};
...
explicit ValuePair_2(T1 first, int32_t second) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(T1 first, int32_t second) ;

/// @brief Method Equals addr 0x0 size 0xffffffffffffffff virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x0 size 0xffffffffffffffff virtual false final false
 bool Equals(ModestTree::Util::ValuePair_2<T1,int32_t> that) ;
