...
namespace ModestTree::Util {
  ...
  check_size<sizeof(UnityUtil::$GetParentsAndSelf$d__17), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __ModestTree_Util_UnityUtil_$GetParentsAndSelf$d__17SizeCheck;
}
