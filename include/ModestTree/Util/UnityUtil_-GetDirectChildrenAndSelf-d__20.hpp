...
namespace ModestTree::Util {
  ...
  check_size<sizeof(UnityUtil::$GetDirectChildrenAndSelf$d__20), 56 + sizeof(void*) + 8 - (56 + sizeof(void*)) % 8> __ModestTree_Util_UnityUtil_$GetDirectChildrenAndSelf$d__20SizeCheck;
}
