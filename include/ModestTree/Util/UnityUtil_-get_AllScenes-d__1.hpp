...
namespace ModestTree::Util {
  ...
  check_size<sizeof(UnityUtil::$get_AllScenes$d__1), 28 + sizeof(int) + ((28 + sizeof(int)) % 8 != 0 ? (8 - (28 + sizeof(int)) % 8) : 0)> __ModestTree_Util_UnityUtil_$get_AllScenes$d__1SizeCheck;
}
