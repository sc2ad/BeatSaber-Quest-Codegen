...
namespace ModestTree::Util {
  ...
  check_size<sizeof(UnityUtil::$GetDirectChildren$d__21), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __ModestTree_Util_UnityUtil_$GetDirectChildren$d__21SizeCheck;
}
