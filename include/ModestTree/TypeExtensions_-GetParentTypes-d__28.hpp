...
namespace ModestTree {
  ...
  check_size<sizeof(TypeExtensions::$GetParentTypes$d__28), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __ModestTree_TypeExtensions_$GetParentTypes$d__28SizeCheck;
}
