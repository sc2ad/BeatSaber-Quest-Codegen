...
namespace ModestTree {
  ...
  class Assert : public ::CsObject {
    ...
    // Offset: 0xD5C134
    static void IsNotEmpty(::CsString* str);
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static void IsType(::CsObject* obj) {
    ...
    // Offset: 0xFFFFFFFF
    template<class T>
    static void IsType(::CsObject* obj, ::CsString* message) {
    ...
    // Offset: 0xD5C604
    static void IsEqual(::CsObject* left, ::CsObject* right);
    // static public System.Void IsEqual(System.Object left, System.Object right, System.Func`1<System.String> messageGenerator)
    // Offset: 0xD5C788
    static void IsEqual(::CsObject* left, ::CsObject* right, System::Func_1<::CsString*>* messageGenerator);
    ...
    // Offset: 0xD5CA7C
    static void IsNotEqual(::CsObject* left, ::CsObject* right, ::CsString* message);
    ...
    // Offset: 0xD5D8EC
    static void That(bool condition, ::CsString* message, ::CsObject* p1, ::CsObject* p2, ::CsObject* p3);
    // static public System.Void Warn(System.Boolean condition, System.String message)
    // Offset: 0xD5DA0C
    static void Warn(bool condition, ::CsString* message);
    ...
    // Offset: 0xD5C0D0
    static Zenject::ZenjectException* CreateException(::CsString* message);
    // static public Zenject.ZenjectException CreateException(System.String message, System.Object[] parameters)
    // Offset: 0xD5C398
    static Zenject::ZenjectException* CreateException(::CsString* message, ::Array<::CsObject*>* parameters);
    ...
    // Offset: 0xD5DBD0
    static Zenject::ZenjectException* CreateException(System::Exception* innerException, ::CsString* message, ::Array<::CsObject*>* parameters);
  }; // ModestTree.Assert
}
