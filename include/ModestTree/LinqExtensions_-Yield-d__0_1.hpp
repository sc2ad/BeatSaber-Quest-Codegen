...
namespace ModestTree {
  ...
  template<typename T>
  class LinqExtensions::$Yield$d__0_1 : public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::Generic::IEnumerator_1<T>, public ::Il2CppObject {
    public:
