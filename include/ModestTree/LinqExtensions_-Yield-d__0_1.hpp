...
namespace ModestTree {
  ...
  class LinqExtensions::$Yield$d__0_1 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::Generic::IEnumerator_1<T>*/ {
    ...
    static LinqExtensions::$Yield$d__0_1<T>* New_ctor(int $$1__state) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext(".ctor");
    ...
    void System_IDisposable_Dispose() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.IDisposable.Dispose");
    ...
    bool MoveNext() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("MoveNext");
    ...
    T System_Collections_Generic_IEnumerator_1_get_Current() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.Collections.Generic.IEnumerator<T>.get_Current");
    ...
    void System_Collections_IEnumerator_Reset() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.Collections.IEnumerator.Reset");
    ...
    ::Il2CppObject* System_Collections_IEnumerator_get_Current() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.Collections.IEnumerator.get_Current");
    ...
    System::Collections::Generic::IEnumerator_1<T>* System_Collections_Generic_IEnumerable_1_GetEnumerator() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.Collections.Generic.IEnumerable<T>.GetEnumerator");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("ModestTree").WithContext("$Yield$d__0_1").WithContext("System.Collections.IEnumerable.GetEnumerator");
  ...
  // Could not write size check! Type: ModestTree.LinqExtensions/<Yield>d__0`1 is generic!
}
