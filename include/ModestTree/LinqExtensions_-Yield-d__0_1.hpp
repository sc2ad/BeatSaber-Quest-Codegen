...
namespace ModestTree {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: CEF5E0
  template<typename T>
  class LinqExtensions::$Yield$d__0_1 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::Generic::IEnumerator_1<T>*/ {
    ...
    void System_IDisposable_Dispose_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.IDisposable.Dispose_NEW");
    ...
    // Offset: 0xFFFFFFFF
    bool MoveNext_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::MoveNext_NEW");
    ...
    T System_Collections_Generic_IEnumerator$T$_get_Current_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.Collections.Generic.IEnumerator<T>.get_Current_NEW");
    ...
    void System_Collections_IEnumerator_Reset_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.Collections.IEnumerator.Reset_NEW");
    ...
    ::Il2CppObject* System_Collections_IEnumerator_get_Current_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.Collections.IEnumerator.get_Current_NEW");
    ...
    System::Collections::Generic::IEnumerator_1<T>* System_Collections_Generic_IEnumerable$T$_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.Collections.Generic.IEnumerable<T>.GetEnumerator_NEW");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("ModestTree::LinqExtensions::$Yield$d__0_1::System.Collections.IEnumerable.GetEnumerator_NEW");
