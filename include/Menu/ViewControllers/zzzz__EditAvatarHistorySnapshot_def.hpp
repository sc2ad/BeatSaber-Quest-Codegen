...
// Fields
 ...
 GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart __declspec(property(get=__get__avatarEditPart_k__BackingField, put=__set__avatarEditPart_k__BackingField))  _avatarEditPart_k__BackingField;

constexpr void __set__avatarEditPart_k__BackingField(GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart value) ;

constexpr GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart __get__avatarEditPart_k__BackingField() const;
...
// Properties
 ...
 GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart __declspec(property(get=get_avatarEditPart))  avatarEditPart;
...
/// @brief Method get_avatarEditPart addr 0x21d4b90 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart get_avatarEditPart() ;
