...
// Ctor Parameters [CppParam { name: "avatarData", ty: "GlobalNamespace::AvatarData", modifiers: "", def_value: None }, CppParam { name: "avatarEditPart", ty: "GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart", modifiers: "", def_value: None }]
 Menu::ViewControllers::EditAvatarHistorySnapshot::EditAvatarHistorySnapshot(GlobalNamespace::AvatarData avatarData, GlobalNamespace::GlobalNamespace__EditAvatarViewController__AvatarEditPart avatarEditPart)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<EditAvatarHistorySnapshot>(avatarData, avatarEditPart))) {}
