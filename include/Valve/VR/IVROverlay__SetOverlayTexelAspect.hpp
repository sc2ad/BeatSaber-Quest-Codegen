...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE61E8
  class IVROverlay::_SetOverlayTexelAspect : public System::MulticastDelegate {
    ...
    // Offset: 0x1A85E20
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float fTexelAspect);
    ...
    // Offset: 0x1A860A8
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, float fTexelAspect, System::AsyncCallback* callback, ::Il2CppObject* object);
