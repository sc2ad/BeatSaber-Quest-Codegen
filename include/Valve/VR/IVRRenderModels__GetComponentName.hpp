...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE67B0
  class IVRRenderModels::_GetComponentName : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8A4BC
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, uint unComponentIndex, System::Text::StringBuilder* pchComponentName, uint unComponentNameLen);
    ...
    // Offset: 0x1A8A920
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, uint unComponentIndex, System::Text::StringBuilder* pchComponentName, uint unComponentNameLen, System::AsyncCallback* callback, ::Il2CppObject* object);
