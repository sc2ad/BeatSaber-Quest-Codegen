...
namespace Valve::VR {
  ...
  check_size<sizeof(Texture_t), 12 + sizeof(Valve::VR::EColorSpace) + ((12 + sizeof(Valve::VR::EColorSpace)) % 8 != 0 ? (8 - (12 + sizeof(Valve::VR::EColorSpace)) % 8) : 0)> __Valve_VR_Texture_tSizeCheck;
}
