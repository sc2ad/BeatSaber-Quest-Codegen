...
namespace Valve::VR {
  ...
  check_size<sizeof(RenderModel_TextureMap_t), 8 + sizeof(System::IntPtr) + ((8 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (8 + sizeof(System::IntPtr)) % 8) : 0)> __Valve_VR_RenderModel_TextureMap_tSizeCheck;
}
