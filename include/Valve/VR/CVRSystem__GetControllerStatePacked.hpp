...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6A58
  class CVRSystem::_GetControllerStatePacked : public System::MulticastDelegate {
    ...
    // Offset: 0x15072B4
    bool Invoke_NEW(uint unControllerDeviceIndex, Valve::VR::VRControllerState_t_Packed& pControllerState, uint unControllerStateSize);
    ...
    // Offset: 0x1507C38
    System::IAsyncResult* BeginInvoke_NEW(uint unControllerDeviceIndex, Valve::VR::VRControllerState_t_Packed& pControllerState, uint unControllerStateSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.VRControllerState_t_Packed pControllerState, System.IAsyncResult result)
    // Offset: 0x1507D04
    bool EndInvoke_NEW(Valve::VR::VRControllerState_t_Packed& pControllerState, System::IAsyncResult* result);
