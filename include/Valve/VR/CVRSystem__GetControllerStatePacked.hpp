...
namespace Valve::VR {
  ...
  // Il2CppName: Invoke
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVRSystem::_GetControllerStatePacked::*)(uint, Valve::VR::VRControllerState_t_Packed&, uint)>(&CVRSystem::_GetControllerStatePacked::Invoke)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(CVRSystem::_GetControllerStatePacked*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<uint>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::VRControllerState_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<uint>()});
    }
  };
  // Writing MetadataGetter for method: CVRSystem::_GetControllerStatePacked::BeginInvoke
  // Il2CppName: BeginInvoke
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (CVRSystem::_GetControllerStatePacked::*)(uint, Valve::VR::VRControllerState_t_Packed&, uint, System::AsyncCallback*, ::Il2CppObject*)>(&CVRSystem::_GetControllerStatePacked::BeginInvoke)> {
    const MethodInfo* get() {
  ...
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVRSystem::_GetControllerStatePacked::*)(Valve::VR::VRControllerState_t_Packed&, System::IAsyncResult*)>(&CVRSystem::_GetControllerStatePacked::EndInvoke)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(CVRSystem::_GetControllerStatePacked*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Valve::VR::VRControllerState_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<System::IAsyncResult*>()});
    }
  };
}
