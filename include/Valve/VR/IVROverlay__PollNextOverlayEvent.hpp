...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6404
  class IVROverlay::_PollNextOverlayEvent : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4AB14
    bool Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VREvent_t& pEvent, uint uncbVREvent);
    ...
    // Offset: 0x1E4ADB4
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VREvent_t& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.VREvent_t pEvent, System.IAsyncResult result)
    // Offset: 0x1E4AE88
    bool EndInvoke_NEW(Valve::VR::VREvent_t& pEvent, System::IAsyncResult* result);
