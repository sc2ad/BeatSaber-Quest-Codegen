...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6904
  class IVRSettings::_GetInt32 : public System::MulticastDelegate {
    ...
    // Offset: 0x1A90A14
    int Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A90ED4
    int EndInvoke_NEW(Valve::VR::EVRSettingsError& peError, System::IAsyncResult* result);
