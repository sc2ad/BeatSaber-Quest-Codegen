...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE68C8
  class IVRSettings::_SetFloat : public System::MulticastDelegate {
    ...
    // Offset: 0x1A926B8
    void Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, float flValue, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A92AF4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, float flValue, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
