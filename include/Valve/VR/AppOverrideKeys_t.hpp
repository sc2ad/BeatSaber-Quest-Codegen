...
namespace Valve::VR {
  ...
  check_size<sizeof(AppOverrideKeys_t), 8 + sizeof(System::IntPtr) + ((8 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (8 + sizeof(System::IntPtr)) % 8) : 0)> __Valve_VR_AppOverrideKeys_tSizeCheck;
}
