...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE61AC
  class IVROverlay::_GetOverlayColor : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4368C
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfRed, float& pfGreen, float& pfBlue);
    ...
    // Offset: 0x1E43A2C
    Valve::VR::EVROverlayError EndInvoke_NEW(float& pfRed, float& pfGreen, float& pfBlue, System::IAsyncResult* result);
