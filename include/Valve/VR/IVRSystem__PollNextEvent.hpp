...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5608
  class IVRSystem::_PollNextEvent : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9C198
    bool Invoke_NEW(Valve::VR::VREvent_t& pEvent, uint uncbVREvent);
    ...
    // Offset: 0x1A9C418
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::VREvent_t& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
