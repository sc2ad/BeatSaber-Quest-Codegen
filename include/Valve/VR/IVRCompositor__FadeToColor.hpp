...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5E14
  class IVRCompositor::_FadeToColor : public System::MulticastDelegate {
    ...
    // Offset: 0x1E380A0
    void Invoke_NEW(float fSeconds, float fRed, float fGreen, float fBlue, float fAlpha, bool bBackground);
    ...
    // Offset: 0x1E38390
    System::IAsyncResult* BeginInvoke_NEW(float fSeconds, float fRed, float fGreen, float fBlue, float fAlpha, bool bBackground, System::AsyncCallback* callback, ::Il2CppObject* object);
