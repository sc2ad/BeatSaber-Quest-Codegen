...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE557C
  class IVRSystem::_GetFloatTrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1A97400
    float Invoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1A97774
    float EndInvoke_NEW(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result);
