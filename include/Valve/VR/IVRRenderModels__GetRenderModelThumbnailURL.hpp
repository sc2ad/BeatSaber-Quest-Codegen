...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6814
  class IVRRenderModels::_GetRenderModelThumbnailURL : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8C388
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchThumbnailURL, uint unThumbnailURLLen, Valve::VR::EVRRenderModelError& peError);
    ...
    // Offset: 0x1A8C7C8
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchThumbnailURL, uint unThumbnailURLLen, Valve::VR::EVRRenderModelError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
