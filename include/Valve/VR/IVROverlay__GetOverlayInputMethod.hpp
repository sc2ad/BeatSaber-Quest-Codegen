...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6418
  class IVROverlay::_GetOverlayInputMethod : public System::MulticastDelegate {
    ...
    // Offset: 0x1E44D00
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayInputMethod& peInputMethod);
    ...
    // Offset: 0x1E44F84
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayInputMethod& peInputMethod, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVROverlayError EndInvoke(ref Valve.VR.VROverlayInputMethod peInputMethod, System.IAsyncResult result)
    // Offset: 0x1E45034
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::VROverlayInputMethod& peInputMethod, System::IAsyncResult* result);
