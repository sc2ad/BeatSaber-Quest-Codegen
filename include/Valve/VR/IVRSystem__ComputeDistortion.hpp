...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE53EC
  class IVRSystem::_ComputeDistortion : public System::MulticastDelegate {
    ...
    // Offset: 0x1A94228
    bool Invoke_NEW(Valve::VR::EVREye eEye, float fU, float fV, Valve::VR::DistortionCoordinates_t& pDistortionCoordinates);
    ...
    // Offset: 0x1A94504
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, float fU, float fV, Valve::VR::DistortionCoordinates_t& pDistortionCoordinates, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.DistortionCoordinates_t pDistortionCoordinates, System.IAsyncResult result)
    // Offset: 0x1A945F0
    bool EndInvoke_NEW(Valve::VR::DistortionCoordinates_t& pDistortionCoordinates, System::IAsyncResult* result);
