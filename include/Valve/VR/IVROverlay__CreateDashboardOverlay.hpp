...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6594
  class IVROverlay::_CreateDashboardOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1E40FB0
    Valve::VR::EVROverlayError Invoke_NEW(::Il2CppString* pchOverlayKey, ::Il2CppString* pchOverlayFriendlyName, uint64_t& pMainHandle, uint64_t& pThumbnailHandle);
    ...
    // Offset: 0x1E414B0
    Valve::VR::EVROverlayError EndInvoke_NEW(uint64_t& pMainHandle, uint64_t& pThumbnailHandle, System::IAsyncResult* result);
