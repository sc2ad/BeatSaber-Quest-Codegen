...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE624C
  class IVROverlay::_GetOverlayWidthInMeters : public System::MulticastDelegate {
    ...
    // Offset: 0x1E48C00
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfWidthInMeters);
    ...
    // Offset: 0x1E48F34
    Valve::VR::EVROverlayError EndInvoke_NEW(float& pfWidthInMeters, System::IAsyncResult* result);
