...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D8995C
  class IVROverlay::_DestroyOverlay : public System::MulticastDelegate {
    ...
    static IVROverlay::_DestroyOverlay* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_DestroyOverlay").WithContext(".ctor");
