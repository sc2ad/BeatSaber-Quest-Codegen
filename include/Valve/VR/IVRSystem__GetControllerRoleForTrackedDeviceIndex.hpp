...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE552C
  class IVRSystem::_GetControllerRoleForTrackedDeviceIndex : public System::MulticastDelegate {
    ...
    // Offset: 0x1A95888
    Valve::VR::ETrackedControllerRole Invoke_NEW(uint unDeviceIndex);
    ...
    // Offset: 0x1A95B7C
    Valve::VR::ETrackedControllerRole EndInvoke_NEW(System::IAsyncResult* result);
