...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5450
  class IVRSystem::_GetOutputDevice : public System::MulticastDelegate {
    ...
    // Offset: 0x1A98308
    void Invoke_NEW(uint64_t& pnDevice, Valve::VR::ETextureType textureType, System::IntPtr pInstance);
    ...
    // Offset: 0x1A98590
    System::IAsyncResult* BeginInvoke_NEW(uint64_t& pnDevice, Valve::VR::ETextureType textureType, System::IntPtr pInstance, System::AsyncCallback* callback, ::Il2CppObject* object);
