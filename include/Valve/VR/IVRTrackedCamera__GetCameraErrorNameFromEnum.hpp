...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5798
  class IVRTrackedCamera::_GetCameraErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9DABC
    System::IntPtr Invoke_NEW(Valve::VR::EVRTrackedCameraError eCameraError);
    ...
    // Offset: 0x1A9DD34
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRTrackedCameraError eCameraError, System::AsyncCallback* callback, ::Il2CppObject* object);
