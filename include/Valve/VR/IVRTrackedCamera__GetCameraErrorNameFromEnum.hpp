...
namespace Valve::VR {
  // Forward declaring type: _GetCameraErrorNameFromEnum
  class _GetCameraErrorNameFromEnum;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRTrackedCamera::_GetCameraErrorNameFromEnum);
...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: EB7E54
