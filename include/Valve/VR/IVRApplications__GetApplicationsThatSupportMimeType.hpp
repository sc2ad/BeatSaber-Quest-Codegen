...
namespace Valve::VR {
  // Forward declaring type: _GetApplicationsThatSupportMimeType
...
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRApplications/Valve.VR._GetApplicationsThatSupportMimeType
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: EF6FF4
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::*)(::Il2CppString*, System::Text::StringBuilder*, uint)>(&Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::Invoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pchMimeType, pchAppKeysThatSupportBuffer, unAppKeysThatSupportBuffer});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::*)(::Il2CppString*, System::Text::StringBuilder*, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::BeginInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pchMimeType, pchAppKeysThatSupportBuffer, unAppKeysThatSupportBuffer, callback, object});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::*)(System::IAsyncResult*)>(&Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType::EndInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRApplications::_GetApplicationsThatSupportMimeType*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
