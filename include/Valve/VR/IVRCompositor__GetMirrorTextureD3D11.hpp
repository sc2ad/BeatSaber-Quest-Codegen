...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5FB8
  class IVRCompositor::_GetMirrorTextureD3D11 : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3A90C
    Valve::VR::EVRCompositorError Invoke_NEW(Valve::VR::EVREye eEye, System::IntPtr pD3D11DeviceOrResource, System::IntPtr& ppD3D11ShaderResourceView);
    ...
    // Offset: 0x1E3ABC4
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, System::IntPtr pD3D11DeviceOrResource, System::IntPtr& ppD3D11ShaderResourceView, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRCompositorError EndInvoke(ref System.IntPtr ppD3D11ShaderResourceView, System.IAsyncResult result)
    // Offset: 0x1E3AC8C
    Valve::VR::EVRCompositorError EndInvoke_NEW(System::IntPtr& ppD3D11ShaderResourceView, System::IAsyncResult* result);
