...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5FE0
  class IVRCompositor::_GetMirrorTextureGL : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3ACD4
    Valve::VR::EVRCompositorError Invoke_NEW(Valve::VR::EVREye eEye, uint& pglTextureId, System::IntPtr pglSharedTextureHandle);
    ...
    // Offset: 0x1E3AF8C
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, uint& pglTextureId, System::IntPtr pglSharedTextureHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRCompositorError EndInvoke(ref System.UInt32 pglTextureId, System.IAsyncResult result)
    // Offset: 0x1E3B05C
    Valve::VR::EVRCompositorError EndInvoke_NEW(uint& pglTextureId, System::IAsyncResult* result);
