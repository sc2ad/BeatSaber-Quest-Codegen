...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE697C
  class IVRScreenshots::_HookScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8EE54
    Valve::VR::EVRScreenshotError Invoke_NEW(::Array<Valve::VR::EVRScreenshotType>*& pSupportedTypes, int numTypes);
    ...
    // Offset: 0x1A8F0CC
    System::IAsyncResult* BeginInvoke_NEW(::Array<Valve::VR::EVRScreenshotType>*& pSupportedTypes, int numTypes, System::AsyncCallback* callback, ::Il2CppObject* object);
