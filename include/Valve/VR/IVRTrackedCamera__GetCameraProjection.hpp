...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE57E8
  class IVRTrackedCamera::_GetCameraProjection : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9E610
    Valve::VR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, Valve::VR::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, Valve::VR::HmdMatrix44_t& pProjection);
    ...
    // Offset: 0x1A9E8E8
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, Valve::VR::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, Valve::VR::HmdMatrix44_t& pProjection, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRTrackedCameraError EndInvoke(ref Valve.VR.HmdMatrix44_t pProjection, System.IAsyncResult result)
    // Offset: 0x1A9E9F0
    Valve::VR::EVRTrackedCameraError EndInvoke_NEW(Valve::VR::HmdMatrix44_t& pProjection, System::IAsyncResult* result);
