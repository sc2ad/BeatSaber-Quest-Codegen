...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE58EC
  class IVRApplications::_GetApplicationKeyByProcessId : public System::MulticastDelegate {
    ...
    // Offset: 0x14FB9E0
    Valve::VR::EVRApplicationError Invoke_NEW(uint unProcessId, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
    ...
    // Offset: 0x15084A0
    System::IAsyncResult* BeginInvoke_NEW(uint unProcessId, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen, System::AsyncCallback* callback, ::Il2CppObject* object);
