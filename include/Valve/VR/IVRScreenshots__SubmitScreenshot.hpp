...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE69E0
  class IVRScreenshots::_SubmitScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8F55C
    Valve::VR::EVRScreenshotError Invoke_NEW(uint screenshotHandle, Valve::VR::EVRScreenshotType type, ::Il2CppString* pchSourcePreviewFilename, ::Il2CppString* pchSourceVRFilename);
    ...
    // Offset: 0x1A8F818
    System::IAsyncResult* BeginInvoke_NEW(uint screenshotHandle, Valve::VR::EVRScreenshotType type, ::Il2CppString* pchSourcePreviewFilename, ::Il2CppString* pchSourceVRFilename, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRScreenshotError EndInvoke(System.IAsyncResult result)
    // Offset: 0x1A8F8D4
    Valve::VR::EVRScreenshotError EndInvoke_NEW(System::IAsyncResult* result);
