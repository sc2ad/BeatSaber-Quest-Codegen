...
namespace Valve::VR {
  ...
  class IVRChaperoneSetup::_SetWorkingStandingZeroPoseToRawTrackingPose : public System::MulticastDelegate {
    ...
    // Offset: 0x15E718C
    static IVRChaperoneSetup::_SetWorkingStandingZeroPoseToRawTrackingPose* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x15E73F0
    System::IAsyncResult* BeginInvoke(Valve::VR::HmdMatrix34_t& pMatStandingZeroPoseToRawTrackingPose, System::AsyncCallback* callback, ::CsObject* object);
