...
namespace Valve::VR {
  ...
  check_size<sizeof(VREvent_t_Packed), 12 + sizeof(Valve::VR::VREvent_Data_t) + ((12 + sizeof(Valve::VR::VREvent_Data_t)) % 8 != 0 ? (8 - (12 + sizeof(Valve::VR::VREvent_Data_t)) % 8) : 0)> __Valve_VR_VREvent_t_PackedSizeCheck;
}
