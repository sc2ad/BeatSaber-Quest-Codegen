...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE53B0
  class IVRSystem::_GetRecommendedRenderTargetSize : public System::MulticastDelegate {
    ...
    // Offset: 0x1A994E8
    void Invoke_NEW(uint& pnWidth, uint& pnHeight);
    ...
    // Offset: 0x1A99754
    System::IAsyncResult* BeginInvoke_NEW(uint& pnWidth, uint& pnHeight, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref System.UInt32 pnWidth, ref System.UInt32 pnHeight, System.IAsyncResult result)
    // Offset: 0x1A99800
    void EndInvoke_NEW(uint& pnWidth, uint& pnHeight, System::IAsyncResult* result);
