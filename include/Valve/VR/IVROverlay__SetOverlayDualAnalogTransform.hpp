...
namespace Valve::VR {
  ...
  class IVROverlay::_SetOverlayDualAnalogTransform : public System::MulticastDelegate {
    ...
    // Offset: 0x15FD9B8
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlay, Valve::VR::EDualAnalogWhich eWhich, System::IntPtr vCenter, float fRadius, System::AsyncCallback* callback, ::CsObject* object);
