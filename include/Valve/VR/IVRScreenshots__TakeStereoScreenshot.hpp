...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE69CC
  class IVRScreenshots::_TakeStereoScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8F910
    Valve::VR::EVRScreenshotError Invoke_NEW(uint& pOutScreenshotHandle, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename);
    ...
    // Offset: 0x1A8FC48
    Valve::VR::EVRScreenshotError EndInvoke_NEW(uint& pOutScreenshotHandle, System::IAsyncResult* result);
