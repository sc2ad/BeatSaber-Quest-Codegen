...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6580
  class IVROverlay::_GetOverlayTextureSize : public System::MulticastDelegate {
    ...
    // Offset: 0x1E475E4
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& pWidth, uint& pHeight);
    ...
    // Offset: 0x1E4794C
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& pWidth, uint& pHeight, System::IAsyncResult* result);
