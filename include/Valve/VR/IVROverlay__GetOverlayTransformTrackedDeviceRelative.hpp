...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6350
  class IVROverlay::_GetOverlayTransformTrackedDeviceRelative : public System::MulticastDelegate {
    ...
    // Offset: 0x1E484CC
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& punTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform);
    ...
    // Offset: 0x1E48768
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint& punTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E4883C
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& punTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::IAsyncResult* result);
