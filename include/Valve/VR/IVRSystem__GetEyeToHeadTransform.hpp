...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5400
  class IVRSystem::_GetEyeToHeadTransform : public System::MulticastDelegate {
    ...
    // Offset: 0x1A97058
    Valve::VR::HmdMatrix34_t Invoke_NEW(Valve::VR::EVREye eEye);
    // public System.IAsyncResult BeginInvoke(Valve.VR.EVREye eEye, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1A97320
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, System::AsyncCallback* callback, ::Il2CppObject* object);
