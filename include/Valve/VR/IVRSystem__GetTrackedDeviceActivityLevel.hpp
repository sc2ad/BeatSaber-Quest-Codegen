...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE54F0
  class IVRSystem::_GetTrackedDeviceActivityLevel : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9A658
    Valve::VR::EDeviceActivityLevel Invoke_NEW(uint unDeviceId);
    ...
    // Offset: 0x1A9A94C
    Valve::VR::EDeviceActivityLevel EndInvoke_NEW(System::IAsyncResult* result);
