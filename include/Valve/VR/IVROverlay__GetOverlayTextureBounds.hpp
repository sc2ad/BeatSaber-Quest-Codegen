...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE62C4
  class IVROverlay::_GetOverlayTextureBounds : public System::MulticastDelegate {
    ...
    // Offset: 0x1E46EEC
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VRTextureBounds_t& pOverlayTextureBounds);
    ...
    // Offset: 0x1E47170
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VRTextureBounds_t& pOverlayTextureBounds, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E47220
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::VRTextureBounds_t& pOverlayTextureBounds, System::IAsyncResult* result);
