...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5AA4
  class IVRApplications::_GetApplicationsTransitionStateNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1500CB0
    System::IntPtr Invoke_NEW(Valve::VR::EVRApplicationTransitionState state);
    ...
    // Offset: 0x1508C90
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRApplicationTransitionState state, System::AsyncCallback* callback, ::Il2CppObject* object);
