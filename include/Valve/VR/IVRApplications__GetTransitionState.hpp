...
namespace Valve::VR {
  // Forward declaring type: _GetTransitionState
  class _GetTransitionState;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRApplications::_GetTransitionState);
DEFINE_IL2CPP_ARG_TYPE(Valve::VR::IVRApplications::_GetTransitionState*, "Valve.VR", "IVRApplications/_GetTransitionState");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRApplications/Valve.VR._GetTransitionState
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: EF7030
  ...
  }; // Valve.VR.IVRApplications/Valve.VR._GetTransitionState
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
