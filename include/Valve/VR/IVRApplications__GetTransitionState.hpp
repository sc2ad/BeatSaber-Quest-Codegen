...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5A7C
  class IVRApplications::_GetTransitionState : public System::MulticastDelegate {
    ...
    // Offset: 0x1500658
    Valve::VR::EVRApplicationTransitionState Invoke_NEW();
    ...
    // Offset: 0x1508FA0
    Valve::VR::EVRApplicationTransitionState EndInvoke_NEW(System::IAsyncResult* result);
