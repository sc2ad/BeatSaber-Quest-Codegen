...
namespace Valve::VR {
  ...
  check_size<sizeof(Compositor_FrameTiming), 96 + sizeof(Valve::VR::TrackedDevicePose_t) + 8 - (96 + sizeof(Valve::VR::TrackedDevicePose_t)) % 8> __Valve_VR_Compositor_FrameTimingSizeCheck;
}
