...
namespace Valve::VR {
  ...
  check_size<sizeof(CVRSystem), 16 + sizeof(Valve::VR::IVRSystem) + ((16 + sizeof(Valve::VR::IVRSystem)) % 8 != 0 ? (8 - (16 + sizeof(Valve::VR::IVRSystem)) % 8) : 0)> __Valve_VR_CVRSystemSizeCheck;
}
