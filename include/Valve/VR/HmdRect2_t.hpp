...
namespace Valve::VR {
  ...
  check_size<sizeof(HmdRect2_t), 8 + sizeof(Valve::VR::HmdVector2_t) + ((8 + sizeof(Valve::VR::HmdVector2_t)) % 8 != 0 ? (8 - (8 + sizeof(Valve::VR::HmdVector2_t)) % 8) : 0)> __Valve_VR_HmdRect2_tSizeCheck;
}
