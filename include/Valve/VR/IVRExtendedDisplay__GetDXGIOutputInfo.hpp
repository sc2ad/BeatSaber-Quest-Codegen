...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5784
  class IVRExtendedDisplay::_GetDXGIOutputInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3F360
    void Invoke_NEW(int& pnAdapterIndex, int& pnAdapterOutputIndex);
    ...
    // Offset: 0x1E3F5CC
    System::IAsyncResult* BeginInvoke_NEW(int& pnAdapterIndex, int& pnAdapterOutputIndex, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E3F678
    void EndInvoke_NEW(int& pnAdapterIndex, int& pnAdapterOutputIndex, System::IAsyncResult* result);
