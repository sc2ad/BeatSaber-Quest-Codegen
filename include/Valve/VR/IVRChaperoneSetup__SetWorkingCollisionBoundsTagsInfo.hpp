...
namespace Valve::VR {
  // Forward declaring type: _SetWorkingCollisionBoundsTagsInfo
  class _SetWorkingCollisionBoundsTagsInfo;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo);
...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: EB8368
