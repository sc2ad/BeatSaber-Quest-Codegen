...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5CAC
  class IVRChaperoneSetup::_SetWorkingCollisionBoundsTagsInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x1E35CEC
    void Invoke_NEW(::Array<uint8_t>*& pTagsBuffer, uint unTagCount);
    ...
    // Offset: 0x1E35F5C
    System::IAsyncResult* BeginInvoke_NEW(::Array<uint8_t>*& pTagsBuffer, uint unTagCount, System::AsyncCallback* callback, ::Il2CppObject* object);
