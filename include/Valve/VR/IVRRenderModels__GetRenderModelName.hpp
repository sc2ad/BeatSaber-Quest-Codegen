...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6774
  class IVRRenderModels::_GetRenderModelName : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8BAAC
    uint Invoke_NEW(uint unRenderModelIndex, System::Text::StringBuilder* pchRenderModelName, uint unRenderModelNameLen);
    ...
    // Offset: 0x1A8BD4C
    System::IAsyncResult* BeginInvoke_NEW(uint unRenderModelIndex, System::Text::StringBuilder* pchRenderModelName, uint unRenderModelNameLen, System::AsyncCallback* callback, ::Il2CppObject* object);
