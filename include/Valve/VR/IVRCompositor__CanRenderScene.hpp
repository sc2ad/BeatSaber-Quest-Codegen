...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D897B8
  class IVRCompositor::_CanRenderScene : public System::MulticastDelegate {
    ...
    static IVRCompositor::_CanRenderScene* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_CanRenderScene").WithContext(".ctor");
