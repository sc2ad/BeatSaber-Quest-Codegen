...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6710
  class IVRRenderModels::_LoadTexture_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8D4C8
    Valve::VR::EVRRenderModelError Invoke_NEW(int textureId, System::IntPtr& ppTexture);
    ...
    // Offset: 0x1A8D800
    Valve::VR::EVRRenderModelError EndInvoke_NEW(System::IntPtr& ppTexture, System::IAsyncResult* result);
