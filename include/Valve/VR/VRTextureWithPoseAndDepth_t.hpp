...
namespace Valve::VR {
  ...
  check_size<sizeof(VRTextureWithPoseAndDepth_t), 0 + sizeof(Valve::VR::VRTextureDepthInfo_t) + 8 - (0 + sizeof(Valve::VR::VRTextureDepthInfo_t)) % 8> __Valve_VR_VRTextureWithPoseAndDepth_tSizeCheck;
}
