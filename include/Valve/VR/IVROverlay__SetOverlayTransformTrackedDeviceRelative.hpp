...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE633C
  class IVROverlay::_SetOverlayTransformTrackedDeviceRelative : public System::MulticastDelegate {
    ...
    // Offset: 0x1A876E8
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint unTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform);
    ...
    // Offset: 0x1A87984
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint unTrackedDevice, Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1A87A58
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatTrackedDeviceToOverlayTransform, System::IAsyncResult* result);
