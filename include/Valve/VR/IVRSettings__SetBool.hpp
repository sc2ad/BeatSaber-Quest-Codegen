...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE68A0
  class IVRSettings::_SetBool : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9217C
    void Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, bool bValue, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A925B4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, bool bValue, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
