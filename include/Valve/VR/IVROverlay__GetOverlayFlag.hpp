...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6184
  class IVROverlay::_GetOverlayFlag : public System::MulticastDelegate {
    ...
    // Offset: 0x1E441AC
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayFlags eOverlayFlag, bool& pbEnabled);
    ...
    // Offset: 0x1E44448
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayFlags eOverlayFlag, bool& pbEnabled, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVROverlayError EndInvoke(ref System.Boolean pbEnabled, System.IAsyncResult result)
    // Offset: 0x1E4451C
    Valve::VR::EVROverlayError EndInvoke_NEW(bool& pbEnabled, System::IAsyncResult* result);
