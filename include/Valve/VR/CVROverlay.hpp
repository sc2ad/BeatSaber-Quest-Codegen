...
namespace Valve::VR {
  ...
  check_size<sizeof(CVROverlay), 16 + sizeof(Valve::VR::IVROverlay) + ((16 + sizeof(Valve::VR::IVROverlay)) % 8 != 0 ? (8 - (16 + sizeof(Valve::VR::IVROverlay)) % 8) : 0)> __Valve_VR_CVROverlaySizeCheck;
}
