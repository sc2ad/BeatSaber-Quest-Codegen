...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6288
  class IVROverlay::_SetOverlayTextureColorSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1A86888
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::EColorSpace eTextureColorSpace);
    ...
    // Offset: 0x1A86B0C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::EColorSpace eTextureColorSpace, System::AsyncCallback* callback, ::Il2CppObject* object);
