...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D89DE4
  class IVROverlay::_SetOverlayRaw : public System::MulticastDelegate {
    ...
    static IVROverlay::_SetOverlayRaw* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_SetOverlayRaw").WithContext(".ctor");
