...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6530
  class IVROverlay::_SetOverlayRaw : public System::MulticastDelegate {
    ...
    // Offset: 0x1A84FA8
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unWidth, uint unHeight, uint unDepth);
