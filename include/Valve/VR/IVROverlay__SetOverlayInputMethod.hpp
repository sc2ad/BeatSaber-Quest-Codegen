...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE642C
  class IVROverlay::_SetOverlayInputMethod : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4D8D4
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayInputMethod eInputMethod);
    ...
    // Offset: 0x1E4DB58
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayInputMethod eInputMethod, System::AsyncCallback* callback, ::Il2CppObject* object);
