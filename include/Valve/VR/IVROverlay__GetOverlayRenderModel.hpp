...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE62D8
  class IVROverlay::_GetOverlayRenderModel : public System::MulticastDelegate {
    ...
    // Offset: 0x1E45BA8
    uint Invoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::HmdColor_t& pColor, Valve::VR::EVROverlayError& pError);
    ...
    // Offset: 0x1E45E7C
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::HmdColor_t& pColor, Valve::VR::EVROverlayError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E45F7C
    uint EndInvoke_NEW(Valve::VR::HmdColor_t& pColor, Valve::VR::EVROverlayError& pError, System::IAsyncResult* result);
