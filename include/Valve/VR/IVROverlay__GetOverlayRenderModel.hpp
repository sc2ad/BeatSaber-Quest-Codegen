...
namespace Valve::VR {
  ...
  class IVROverlay::_GetOverlayRenderModel : public System::MulticastDelegate {
    ...
    // Offset: 0x16041C4
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::HmdColor_t& pColor, Valve::VR::EVROverlayError& pError, System::AsyncCallback* callback, ::CsObject* object);
