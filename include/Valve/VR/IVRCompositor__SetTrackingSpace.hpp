...
namespace Valve::VR {
  // Forward declaring type: _SetTrackingSpace
  class _SetTrackingSpace;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRCompositor::_SetTrackingSpace);
DEFINE_IL2CPP_ARG_TYPE(Valve::VR::IVRCompositor::_SetTrackingSpace*, "Valve.VR", "IVRCompositor/_SetTrackingSpace");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRCompositor/Valve.VR._SetTrackingSpace
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: EF72D8
  ...
  }; // Valve.VR.IVRCompositor/Valve.VR._SetTrackingSpace
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
