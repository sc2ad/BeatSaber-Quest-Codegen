...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5928
  class IVRApplications::_LaunchApplicationFromMimeType : public System::MulticastDelegate {
    ...
    // Offset: 0x14FC4B0
    Valve::VR::EVRApplicationError Invoke_NEW(::Il2CppString* pchMimeType, ::Il2CppString* pchArgs);
    ...
    // Offset: 0x15091D8
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchMimeType, ::Il2CppString* pchArgs, System::AsyncCallback* callback, ::Il2CppObject* object);
