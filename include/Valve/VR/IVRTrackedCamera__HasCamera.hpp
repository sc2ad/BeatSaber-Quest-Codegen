...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE57AC
  class IVRTrackedCamera::_HasCamera : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9FB60
    Valve::VR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, bool& pHasCamera);
    ...
    // Offset: 0x1A9FE98
    Valve::VR::EVRTrackedCameraError EndInvoke_NEW(bool& pHasCamera, System::IAsyncResult* result);
