...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5E00
  class IVRCompositor::_GetCumulativeStats : public System::MulticastDelegate {
    ...
    // Offset: 0x1E38A24
    void Invoke_NEW(Valve::VR::Compositor_CumulativeStats& pStats, uint nStatsSizeInBytes);
    ...
    // Offset: 0x1E38C98
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::Compositor_CumulativeStats& pStats, uint nStatsSizeInBytes, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref Valve.VR.Compositor_CumulativeStats pStats, System.IAsyncResult result)
    // Offset: 0x1E38D4C
    void EndInvoke_NEW(Valve::VR::Compositor_CumulativeStats& pStats, System::IAsyncResult* result);
