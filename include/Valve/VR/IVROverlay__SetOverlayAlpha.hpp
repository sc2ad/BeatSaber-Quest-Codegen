...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE61C0
  class IVROverlay::_SetOverlayAlpha : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4C310
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float fAlpha);
    ...
    // Offset: 0x1E4C598
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, float fAlpha, System::AsyncCallback* callback, ::Il2CppObject* object);
