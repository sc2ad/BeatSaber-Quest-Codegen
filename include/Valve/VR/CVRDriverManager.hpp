...
namespace Valve::VR {
  ...
  check_size<sizeof(CVRDriverManager), 16 + sizeof(Valve::VR::IVRDriverManager) + ((16 + sizeof(Valve::VR::IVRDriverManager)) % 8 != 0 ? (8 - (16 + sizeof(Valve::VR::IVRDriverManager)) % 8) : 0)> __Valve_VR_CVRDriverManagerSizeCheck;
}
