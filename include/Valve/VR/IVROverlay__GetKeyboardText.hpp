...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6648
  class IVROverlay::_GetKeyboardText : public System::MulticastDelegate {
    ...
    // Offset: 0x1E42A74
    uint Invoke_NEW(System::Text::StringBuilder* pchText, uint cchText);
    ...
    // Offset: 0x1E42E88
    System::IAsyncResult* BeginInvoke_NEW(System::Text::StringBuilder* pchText, uint cchText, System::AsyncCallback* callback, ::Il2CppObject* object);
