...
namespace Valve::VR {
  ...
  check_size<sizeof(Compositor_OverlaySettings), 48 + sizeof(Valve::VR::HmdMatrix44_t) + 8 - (48 + sizeof(Valve::VR::HmdMatrix44_t)) % 8> __Valve_VR_Compositor_OverlaySettingsSizeCheck;
}
