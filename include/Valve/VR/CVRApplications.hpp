...
namespace Valve::VR {
  ...
  class CVRApplications : public ::CsObject {
    ...
    // Offset: 0xFC403C
    Valve::VR::EVRApplicationError AddApplicationManifest(::CsString* pchApplicationManifestFullPath, bool bTemporary);
    // public Valve.VR.EVRApplicationError RemoveApplicationManifest(System.String pchApplicationManifestFullPath)
    // Offset: 0xFC44A8
    Valve::VR::EVRApplicationError RemoveApplicationManifest(::CsString* pchApplicationManifestFullPath);
    ...
    // Offset: 0xFC5410
    Valve::VR::EVRApplicationError LaunchApplication(::CsString* pchAppKey);
    ...
    // Offset: 0xFC57E8
    Valve::VR::EVRApplicationError LaunchTemplateApplication(::CsString* pchTemplateAppKey, ::CsString* pchNewAppKey, ::Array<Valve::VR::AppOverrideKeys_t>* pKeys);
    // public Valve.VR.EVRApplicationError LaunchApplicationFromMimeType(System.String pchMimeType, System.String pchArgs)
    // Offset: 0xFC5C60
    Valve::VR::EVRApplicationError LaunchApplicationFromMimeType(::CsString* pchMimeType, ::CsString* pchArgs);
    // public Valve.VR.EVRApplicationError LaunchDashboardOverlay(System.String pchAppKey)
    // Offset: 0xFC6084
    Valve::VR::EVRApplicationError LaunchDashboardOverlay(::CsString* pchAppKey);
    ...
    // Offset: 0xFC6838
    Valve::VR::EVRApplicationError IdentifyApplication(uint unProcessId, ::CsString* pchAppKey);
    ...
    // Offset: 0xFC6EB8
    ::CsString* GetApplicationsErrorNameFromEnum(Valve::VR::EVRApplicationError error);
    ...
    // Offset: 0xFC71BC
    uint GetApplicationPropertyString(::CsString* pchAppKey, Valve::VR::EVRApplicationProperty eProperty, System::Text::StringBuilder* pchPropertyValueBuffer, uint unPropertyValueBufferLen, Valve::VR::EVRApplicationError& peError);
    ...
    // Offset: 0xFC7678
    bool GetApplicationPropertyBool(::CsString* pchAppKey, Valve::VR::EVRApplicationProperty eProperty, Valve::VR::EVRApplicationError& peError);
    ...
    // Offset: 0xFC7AEC
    uint64_t GetApplicationPropertyUint64(::CsString* pchAppKey, Valve::VR::EVRApplicationProperty eProperty, Valve::VR::EVRApplicationError& peError);
    // public Valve.VR.EVRApplicationError SetApplicationAutoLaunch(System.String pchAppKey, System.Boolean bAutoLaunch)
    // Offset: 0xFC7F5C
    Valve::VR::EVRApplicationError SetApplicationAutoLaunch(::CsString* pchAppKey, bool bAutoLaunch);
    ...
    // Offset: 0xFC87A4
    Valve::VR::EVRApplicationError SetDefaultApplicationForMimeType(::CsString* pchAppKey, ::CsString* pchMimeType);
    ...
    // Offset: 0xFCA1E4
    Valve::VR::EVRApplicationError PerformApplicationPrelaunchCheck(::CsString* pchAppKey);
    // public System.String GetApplicationsTransitionStateNameFromEnum(Valve.VR.EVRApplicationTransitionState state)
    // Offset: 0xFCA5BC
    ::CsString* GetApplicationsTransitionStateNameFromEnum(Valve::VR::EVRApplicationTransitionState state);
    ...
    // Offset: 0xFCAAF0
    Valve::VR::EVRApplicationError LaunchInternalProcess(::CsString* pchBinaryPath, ::CsString* pchArguments, ::CsString* pchWorkingDirectory);
