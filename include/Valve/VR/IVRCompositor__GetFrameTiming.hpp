...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5DC4
  class IVRCompositor::_GetFrameTiming : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3984C
    bool Invoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, uint unFramesAgo);
    ...
    // Offset: 0x1E39ACC
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, uint unFramesAgo, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.Compositor_FrameTiming pTiming, System.IAsyncResult result)
    // Offset: 0x1E39B80
    bool EndInvoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, System::IAsyncResult* result);
