...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE598C
  class IVRApplications::_GetApplicationsErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x14FD6EC
    System::IntPtr Invoke_NEW(Valve::VR::EVRApplicationError error);
    ...
    // Offset: 0x1508AEC
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRApplicationError error, System::AsyncCallback* callback, ::Il2CppObject* object);
