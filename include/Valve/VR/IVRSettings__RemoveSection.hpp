...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6940
  class IVRSettings::_RemoveSection : public System::MulticastDelegate {
    ...
    // Offset: 0x1A91CC0
    void Invoke_NEW(::Il2CppString* pchSection, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A920A8
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
