...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5644
  class IVRSystem::_GetHiddenAreaMesh : public System::MulticastDelegate {
    ...
    // Offset: 0x1A977BC
    Valve::VR::HiddenAreaMesh_t Invoke_NEW(Valve::VR::EVREye eEye, Valve::VR::EHiddenAreaMeshType type);
    ...
    // Offset: 0x1A97A58
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, Valve::VR::EHiddenAreaMeshType type, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.HiddenAreaMesh_t EndInvoke(System.IAsyncResult result)
    // Offset: 0x1A97B00
    Valve::VR::HiddenAreaMesh_t EndInvoke_NEW(System::IAsyncResult* result);
