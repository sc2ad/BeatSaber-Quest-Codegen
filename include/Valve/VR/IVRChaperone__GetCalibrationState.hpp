...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5AF4
  class IVRChaperone::_GetCalibrationState : public System::MulticastDelegate {
    ...
    // Offset: 0x15018D4
    Valve::VR::ChaperoneCalibrationState Invoke_NEW();
    ...
    // Offset: 0x1509868
    Valve::VR::ChaperoneCalibrationState EndInvoke_NEW(System::IAsyncResult* result);
