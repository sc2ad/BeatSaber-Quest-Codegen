...
namespace Valve::VR {
  // Forward declaring type: _ReleaseVideoStreamTextureGL
  class _ReleaseVideoStreamTextureGL;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRTrackedCamera::_ReleaseVideoStreamTextureGL);
...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: EB7F30
