...
namespace Valve::VR {
  ...
  check_size<sizeof(CVRCompositor), 16 + sizeof(Valve::VR::IVRCompositor) + ((16 + sizeof(Valve::VR::IVRCompositor)) % 8 != 0 ? (8 - (16 + sizeof(Valve::VR::IVRCompositor)) % 8) : 0)> __Valve_VR_CVRCompositorSizeCheck;
}
