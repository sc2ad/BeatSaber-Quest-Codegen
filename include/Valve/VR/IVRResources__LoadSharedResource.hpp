...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE69F4
  class IVRResources::_LoadSharedResource : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8E1D4
    uint Invoke_NEW(::Il2CppString* pchResourceName, ::Il2CppString* pchBuffer, uint unBufferLen);
    ...
    // Offset: 0x1A8E5EC
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchResourceName, ::Il2CppString* pchBuffer, uint unBufferLen, System::AsyncCallback* callback, ::Il2CppObject* object);
