...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE60E4
  class IVROverlay::_GetOverlayKey : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4507C
    uint Invoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::EVROverlayError& pError);
    ...
    // Offset: 0x1E45334
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, System::Text::StringBuilder* pchValue, uint unBufferSize, Valve::VR::EVROverlayError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref Valve.VR.EVROverlayError pError, System.IAsyncResult result)
    // Offset: 0x1E4540C
    uint EndInvoke_NEW(Valve::VR::EVROverlayError& pError, System::IAsyncResult* result);
