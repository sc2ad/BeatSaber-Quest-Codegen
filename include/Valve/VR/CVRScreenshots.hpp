...
namespace Valve::VR {
  ...
  check_size<sizeof(CVRScreenshots), 16 + sizeof(Valve::VR::IVRScreenshots) + ((16 + sizeof(Valve::VR::IVRScreenshots)) % 8 != 0 ? (8 - (16 + sizeof(Valve::VR::IVRScreenshots)) % 8) : 0)> __Valve_VR_CVRScreenshotsSizeCheck;
}
