...
namespace Valve::VR {
  ...
  class CVRScreenshots : public ::CsObject {
    public:
    ...
    // Offset: 0xFE163C
    Valve::VR::EVRScreenshotError RequestScreenshot(uint& pOutScreenshotHandle, Valve::VR::EVRScreenshotType type, ::CsString* pchPreviewFilename, ::CsString* pchVRFilename);
    ...
    // Offset: 0xFE16BC
    Valve::VR::EVRScreenshotError TakeStereoScreenshot(uint& pOutScreenshotHandle, ::CsString* pchPreviewFilename, ::CsString* pchVRFilename);
    ...
    // Offset: 0xFE16DC
    Valve::VR::EVRScreenshotError SubmitScreenshot(uint screenshotHandle, Valve::VR::EVRScreenshotType type, ::CsString* pchSourcePreviewFilename, ::CsString* pchSourceVRFilename);
