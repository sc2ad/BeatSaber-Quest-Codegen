...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE688C
  class IVRSettings::_Sync : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9364C
    bool Invoke_NEW(bool bForce, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A938E4
    System::IAsyncResult* BeginInvoke_NEW(bool bForce, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.EVRSettingsError peError, System.IAsyncResult result)
    // Offset: 0x1A9399C
    bool EndInvoke_NEW(Valve::VR::EVRSettingsError& peError, System::IAsyncResult* result);
