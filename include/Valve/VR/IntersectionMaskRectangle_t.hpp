...
namespace Valve::VR {
  ...
  check_size<sizeof(IntersectionMaskRectangle_t), 12 + sizeof(float) + ((12 + sizeof(float)) % 8 != 0 ? (8 - (12 + sizeof(float)) % 8) : 0)> __Valve_VR_IntersectionMaskRectangle_tSizeCheck;
}
