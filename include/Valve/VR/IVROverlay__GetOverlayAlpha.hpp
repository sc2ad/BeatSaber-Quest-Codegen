...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE61D4
  class IVROverlay::_GetOverlayAlpha : public System::MulticastDelegate {
    ...
    // Offset: 0x1E42F60
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfAlpha);
    ...
    // Offset: 0x1E43294
    Valve::VR::EVROverlayError EndInvoke_NEW(float& pfAlpha, System::IAsyncResult* result);
