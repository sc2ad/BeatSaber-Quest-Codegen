...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5B44
  class IVRChaperone::_SetSceneColor : public System::MulticastDelegate {
    ...
    // Offset: 0x1502234
    void Invoke_NEW(Valve::VR::HmdColor_t color);
    // public System.IAsyncResult BeginInvoke(Valve.VR.HmdColor_t color, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1509ABC
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::HmdColor_t color, System::AsyncCallback* callback, ::Il2CppObject* object);
