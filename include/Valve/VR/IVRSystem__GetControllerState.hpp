...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5658
  class IVRSystem::_GetControllerState : public System::MulticastDelegate {
    ...
    // Offset: 0x1A95BB8
    bool Invoke_NEW(uint unControllerDeviceIndex, Valve::VR::VRControllerState_t& pControllerState, uint unControllerStateSize);
    ...
    // Offset: 0x1A95E5C
    System::IAsyncResult* BeginInvoke_NEW(uint unControllerDeviceIndex, Valve::VR::VRControllerState_t& pControllerState, uint unControllerStateSize, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.VRControllerState_t pControllerState, System.IAsyncResult result)
    // Offset: 0x1A95F28
    bool EndInvoke_NEW(Valve::VR::VRControllerState_t& pControllerState, System::IAsyncResult* result);
