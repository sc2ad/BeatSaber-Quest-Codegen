...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5B94
  class IVRChaperoneSetup::_CommitWorkingCopy : public System::MulticastDelegate {
    ...
    // Offset: 0x1502D88
    bool Invoke_NEW(Valve::VR::EChaperoneConfigFile configFile);
    ...
    // Offset: 0x1509B68
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EChaperoneConfigFile configFile, System::AsyncCallback* callback, ::Il2CppObject* object);
