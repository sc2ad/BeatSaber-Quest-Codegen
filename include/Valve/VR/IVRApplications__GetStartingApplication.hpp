...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5A68
  class IVRApplications::_GetStartingApplication : public System::MulticastDelegate {
    ...
    // Offset: 0x150022C
    Valve::VR::EVRApplicationError Invoke_NEW(System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
