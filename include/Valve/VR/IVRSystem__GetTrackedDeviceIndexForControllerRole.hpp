...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5518
  class IVRSystem::_GetTrackedDeviceIndexForControllerRole : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9ACB8
    uint Invoke_NEW(Valve::VR::ETrackedControllerRole unDeviceType);
    ...
    // Offset: 0x1A9AF30
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::ETrackedControllerRole unDeviceType, System::AsyncCallback* callback, ::Il2CppObject* object);
