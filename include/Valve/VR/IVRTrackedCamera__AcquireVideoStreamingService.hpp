...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE57FC
  class IVRTrackedCamera::_AcquireVideoStreamingService : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9D73C
    Valve::VR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, uint64_t& pHandle);
    ...
    // Offset: 0x1A9D9C0
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, uint64_t& pHandle, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRTrackedCameraError EndInvoke(ref System.UInt64 pHandle, System.IAsyncResult result)
    // Offset: 0x1A9DA74
    Valve::VR::EVRTrackedCameraError EndInvoke_NEW(uint64_t& pHandle, System::IAsyncResult* result);
