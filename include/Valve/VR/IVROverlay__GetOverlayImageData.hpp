...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6120
  class IVROverlay::_GetOverlayImageData : public System::MulticastDelegate {
    ...
    // Offset: 0x1E448E0
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, System::IntPtr pvBuffer, uint unBufferSize, uint& punWidth, uint& punHeight);
    ...
    // Offset: 0x1E44CB8
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& punWidth, uint& punHeight, System::IAsyncResult* result);
