...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5680
  class IVRSystem::_TriggerHapticPulse : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9D3C4
    void Invoke_NEW(uint unControllerDeviceIndex, uint unAxisId, ::Il2CppChar usDurationMicroSec);
    ...
    // Offset: 0x1A9D65C
    System::IAsyncResult* BeginInvoke_NEW(uint unControllerDeviceIndex, uint unAxisId, ::Il2CppChar usDurationMicroSec, System::AsyncCallback* callback, ::Il2CppObject* object);
