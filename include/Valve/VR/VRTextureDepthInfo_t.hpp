...
namespace Valve::VR {
  ...
  check_size<sizeof(VRTextureDepthInfo_t), 72 + sizeof(Valve::VR::HmdVector2_t) + ((72 + sizeof(Valve::VR::HmdVector2_t)) % 8 != 0 ? (8 - (72 + sizeof(Valve::VR::HmdVector2_t)) % 8) : 0)> __Valve_VR_VRTextureDepthInfo_tSizeCheck;
}
