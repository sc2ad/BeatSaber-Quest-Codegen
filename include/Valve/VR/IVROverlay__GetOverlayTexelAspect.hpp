...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE61FC
  class IVROverlay::_GetOverlayTexelAspect : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4666C
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfTexelAspect);
    ...
    // Offset: 0x1E469A0
    Valve::VR::EVROverlayError EndInvoke_NEW(float& pfTexelAspect, System::IAsyncResult* result);
