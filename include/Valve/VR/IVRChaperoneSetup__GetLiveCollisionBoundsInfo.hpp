...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: EB5894
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::IVRChaperoneSetup::_GetLiveCollisionBoundsInfo::*)(ByRef<::ArrayWrapper<Valve::VR::HmdQuad_t>>, ByRef<uint>)>(&Valve::VR::IVRChaperoneSetup::_GetLiveCollisionBoundsInfo::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRChaperoneSetup::_GetLiveCollisionBoundsInfo::*)(ByRef<::ArrayWrapper<Valve::VR::HmdQuad_t>>, ByRef<uint>, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRChaperoneSetup::_GetLiveCollisionBoundsInfo::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pQuadsBuffer = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "HmdQuad_t"), 1)->this_arg;
    static auto* punQuadsCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->this_arg;
