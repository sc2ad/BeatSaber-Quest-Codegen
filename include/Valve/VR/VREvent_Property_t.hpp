...
namespace Valve::VR {
  ...
  check_size<sizeof(VREvent_Property_t), 8 + sizeof(Valve::VR::ETrackedDeviceProperty) + 8 - (8 + sizeof(Valve::VR::ETrackedDeviceProperty)) % 8> __Valve_VR_VREvent_Property_tSizeCheck;
}
