...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE66AC
  class IVROverlay::_GetOverlayFlags : public System::MulticastDelegate {
    ...
    // Offset: 0x1E44564
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& pFlags);
    ...
    // Offset: 0x1E44898
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& pFlags, System::IAsyncResult* result);
