...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE57D4
  class IVRTrackedCamera::_GetCameraIntrinsics : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9E224
    Valve::VR::EVRTrackedCameraError Invoke_NEW(uint nDeviceIndex, Valve::VR::EVRTrackedCameraFrameType eFrameType, Valve::VR::HmdVector2_t& pFocalLength, Valve::VR::HmdVector2_t& pCenter);
    ...
    // Offset: 0x1A9E4E0
    System::IAsyncResult* BeginInvoke_NEW(uint nDeviceIndex, Valve::VR::EVRTrackedCameraFrameType eFrameType, Valve::VR::HmdVector2_t& pFocalLength, Valve::VR::HmdVector2_t& pCenter, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1A9E5C8
    Valve::VR::EVRTrackedCameraError EndInvoke_NEW(Valve::VR::HmdVector2_t& pFocalLength, Valve::VR::HmdVector2_t& pCenter, System::IAsyncResult* result);
