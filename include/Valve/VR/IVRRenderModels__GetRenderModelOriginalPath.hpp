...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6828
  class IVRRenderModels::_GetRenderModelOriginalPath : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8BE38
    uint Invoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchOriginalPath, uint unOriginalPathLen, Valve::VR::EVRRenderModelError& peError);
    ...
    // Offset: 0x1A8C278
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchRenderModelName, System::Text::StringBuilder* pchOriginalPath, uint unOriginalPathLen, Valve::VR::EVRRenderModelError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref Valve.VR.EVRRenderModelError peError, System.IAsyncResult result)
    // Offset: 0x1A8C340
    uint EndInvoke_NEW(Valve::VR::EVRRenderModelError& peError, System::IAsyncResult* result);
