...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6850
  class IVRNotifications::_CreateNotification : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3FEA8
    Valve::VR::EVRNotificationError Invoke_NEW(uint64_t ulOverlayHandle, uint64_t ulUserValue, Valve::VR::EVRNotificationType type, ::Il2CppString* pchText, Valve::VR::EVRNotificationStyle style, Valve::VR::NotificationBitmap_t& pImage, uint& pNotificationId);
    ...
    // Offset: 0x1E401CC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint64_t ulUserValue, Valve::VR::EVRNotificationType type, ::Il2CppString* pchText, Valve::VR::EVRNotificationStyle style, Valve::VR::NotificationBitmap_t& pImage, uint& pNotificationId, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E402FC
    Valve::VR::EVRNotificationError EndInvoke_NEW(Valve::VR::NotificationBitmap_t& pImage, uint& pNotificationId, System::IAsyncResult* result);
