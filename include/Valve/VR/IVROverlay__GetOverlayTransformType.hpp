...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6300
  class IVROverlay::_GetOverlayTransformType : public System::MulticastDelegate {
    ...
    // Offset: 0x1E48884
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayTransformType& peTransformType);
    ...
    // Offset: 0x1E48B08
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayTransformType& peTransformType, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVROverlayError EndInvoke(ref Valve.VR.VROverlayTransformType peTransformType, System.IAsyncResult result)
    // Offset: 0x1E48BB8
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::VROverlayTransformType& peTransformType, System::IAsyncResult* result);
