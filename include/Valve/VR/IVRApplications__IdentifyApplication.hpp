...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5964
  class IVRApplications::_IdentifyApplication : public System::MulticastDelegate {
    ...
    // Offset: 0x14FD024
    Valve::VR::EVRApplicationError Invoke_NEW(uint unProcessId, ::Il2CppString* pchAppKey);
    ...
    // Offset: 0x1508FDC
    System::IAsyncResult* BeginInvoke_NEW(uint unProcessId, ::Il2CppString* pchAppKey, System::AsyncCallback* callback, ::Il2CppObject* object);
