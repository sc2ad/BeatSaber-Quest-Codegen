...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6044
  class IVRCompositor::_GetVulkanDeviceExtensionsRequired : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3B320
    uint Invoke_NEW(System::IntPtr pPhysicalDevice, System::Text::StringBuilder* pchValue, uint unBufferSize);
    ...
    // Offset: 0x1E3B5BC
    System::IAsyncResult* BeginInvoke_NEW(System::IntPtr pPhysicalDevice, System::Text::StringBuilder* pchValue, uint unBufferSize, System::AsyncCallback* callback, ::Il2CppObject* object);
