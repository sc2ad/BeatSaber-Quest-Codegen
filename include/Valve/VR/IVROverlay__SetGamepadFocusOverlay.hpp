...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE64A4
  class IVROverlay::_SetGamepadFocusOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4B5A4
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulNewFocusOverlay);
    ...
    // Offset: 0x1E4B808
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulNewFocusOverlay, System::AsyncCallback* callback, ::Il2CppObject* object);
