...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE65E4
  class IVROverlay::_GetDashboardOverlaySceneProcess : public System::MulticastDelegate {
    ...
    // Offset: 0x1E42200
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& punProcessId);
    ...
    // Offset: 0x1E42534
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& punProcessId, System::IAsyncResult* result);
