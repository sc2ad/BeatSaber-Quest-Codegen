...
namespace Valve::VR {
  ...
  check_size<sizeof(DriverDirectMode_FrameTiming), 16 + sizeof(uint) + ((16 + sizeof(uint)) % 8 != 0 ? (8 - (16 + sizeof(uint)) % 8) : 0)> __Valve_VR_DriverDirectMode_FrameTimingSizeCheck;
}
