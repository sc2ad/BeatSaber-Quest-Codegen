...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE59B4
  class IVRApplications::_GetApplicationPropertyBool : public System::MulticastDelegate {
    ...
    // Offset: 0x14FDE24
    bool Invoke_NEW(::Il2CppString* pchAppKey, Valve::VR::EVRApplicationProperty eProperty, Valve::VR::EVRApplicationError& peError);
    ...
    // Offset: 0x15086D8
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchAppKey, Valve::VR::EVRApplicationProperty eProperty, Valve::VR::EVRApplicationError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.EVRApplicationError peError, System.IAsyncResult result)
    // Offset: 0x1508794
    bool EndInvoke_NEW(Valve::VR::EVRApplicationError& peError, System::IAsyncResult* result);
