...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5590
  class IVRSystem::_GetInt32TrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1A97B40
    int Invoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1A97EB4
    int EndInvoke_NEW(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result);
