...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5568
  class IVRSystem::_GetBoolTrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1A94E48
    bool Invoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1A951C0
    bool EndInvoke_NEW(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result);
