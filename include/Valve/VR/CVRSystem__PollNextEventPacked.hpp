...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6A44
  class CVRSystem::_PollNextEventPacked : public System::MulticastDelegate {
    ...
    // Offset: 0x1506DD8
    bool Invoke_NEW(Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent);
    ...
    // Offset: 0x1507E9C
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
