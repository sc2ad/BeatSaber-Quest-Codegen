...
namespace Valve::VR {
  ...
  check_size<sizeof(VREvent_Data_t), 0 + sizeof(Valve::VR::VREvent_Keyboard_t) + ((0 + sizeof(Valve::VR::VREvent_Keyboard_t)) % 8 != 0 ? (8 - (0 + sizeof(Valve::VR::VREvent_Keyboard_t)) % 8) : 0)> __Valve_VR_VREvent_Data_tSizeCheck;
}
