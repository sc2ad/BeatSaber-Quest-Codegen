...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6468
  class IVROverlay::_ComputeOverlayIntersection : public System::MulticastDelegate {
    ...
    // Offset: 0x1E40BF4
    bool Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayIntersectionParams_t& pParams, Valve::VR::VROverlayIntersectionResults_t& pResults);
    ...
    // Offset: 0x1E40E94
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VROverlayIntersectionParams_t& pParams, Valve::VR::VROverlayIntersectionResults_t& pResults, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E40F68
    bool EndInvoke_NEW(Valve::VR::VROverlayIntersectionParams_t& pParams, Valve::VR::VROverlayIntersectionResults_t& pResults, System::IAsyncResult* result);
