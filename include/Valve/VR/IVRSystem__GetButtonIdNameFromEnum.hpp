...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5694
  class IVRSystem::_GetButtonIdNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A95208
    System::IntPtr Invoke_NEW(Valve::VR::EVRButtonId eButtonId);
    // public System.IAsyncResult BeginInvoke(Valve.VR.EVRButtonId eButtonId, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1A95480
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRButtonId eButtonId, System::AsyncCallback* callback, ::Il2CppObject* object);
