...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE53D8
  class IVRSystem::_GetProjectionRaw : public System::MulticastDelegate {
    ...
    // Offset: 0x1A98AB8
    void Invoke_NEW(Valve::VR::EVREye eEye, float& pfLeft, float& pfRight, float& pfTop, float& pfBottom);
    ...
    // Offset: 0x1A98DA8
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, float& pfLeft, float& pfRight, float& pfTop, float& pfBottom, System::AsyncCallback* callback, ::Il2CppObject* object);
