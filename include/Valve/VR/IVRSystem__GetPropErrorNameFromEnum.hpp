...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE55F4
  class IVRSystem::_GetPropErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A98EE8
    System::IntPtr Invoke_NEW(Valve::VR::ETrackedPropertyError error);
    ...
    // Offset: 0x1A99160
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::ETrackedPropertyError error, System::AsyncCallback* callback, ::Il2CppObject* object);
