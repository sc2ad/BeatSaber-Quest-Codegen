...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5C5C
  class IVRChaperoneSetup::_SetWorkingSeatedZeroPoseToRawTrackingPose : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3669C
    void Invoke_NEW(Valve::VR::HmdMatrix34_t& pMatSeatedZeroPoseToRawTrackingPose);
    ...
    // Offset: 0x1E36984
    void EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pMatSeatedZeroPoseToRawTrackingPose, System::IAsyncResult* result);
