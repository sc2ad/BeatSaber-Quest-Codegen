...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE56A8
  class IVRSystem::_GetControllerAxisTypeNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A95548
    System::IntPtr Invoke_NEW(Valve::VR::EVRControllerAxisType eAxisType);
    ...
    // Offset: 0x1A957C0
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRControllerAxisType eAxisType, System::AsyncCallback* callback, ::Il2CppObject* object);
