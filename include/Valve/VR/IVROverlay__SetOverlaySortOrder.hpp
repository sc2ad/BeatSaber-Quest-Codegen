...
namespace Valve::VR {
  ...
  class IVROverlay::_SetOverlaySortOrder : public System::MulticastDelegate {
    ...
    // Offset: 0x16AAD24
    static IVROverlay::_SetOverlaySortOrder* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0x16AAFBC
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, uint unSortOrder, System::AsyncCallback* callback, ::CsObject* object);
