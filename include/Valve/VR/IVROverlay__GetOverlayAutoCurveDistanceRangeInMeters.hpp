...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6274
  class IVROverlay::_GetOverlayAutoCurveDistanceRangeInMeters : public System::MulticastDelegate {
    ...
    // Offset: 0x1E432DC
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float& pfMinDistanceInMeters, float& pfMaxDistanceInMeters);
    ...
    // Offset: 0x1E43644
    Valve::VR::EVROverlayError EndInvoke_NEW(float& pfMinDistanceInMeters, float& pfMaxDistanceInMeters, System::IAsyncResult* result);
