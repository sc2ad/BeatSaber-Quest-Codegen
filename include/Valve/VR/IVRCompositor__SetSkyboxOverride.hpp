...
namespace Valve::VR {
  ...
  class IVRCompositor::_SetSkyboxOverride : public System::MulticastDelegate {
    ...
    // Offset: 0x21B0350
    Valve::VR::EVRCompositorError Invoke(ByRef<::ArrayWrapper<Valve::VR::Texture_t>> pTextures, uint unTextureCount);
    ...
    // Offset: 0x21B05C8
    System::IAsyncResult* BeginInvoke(ByRef<::ArrayWrapper<Valve::VR::Texture_t>> pTextures, uint unTextureCount, System::AsyncCallback* callback, ::Il2CppObject* object);
