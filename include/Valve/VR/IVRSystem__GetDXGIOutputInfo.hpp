...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE543C
  class IVRSystem::_GetDXGIOutputInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x1A96638
    void Invoke_NEW(int& pnAdapterIndex);
    ...
    // Offset: 0x1A96884
    System::IAsyncResult* BeginInvoke_NEW(int& pnAdapterIndex, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref System.Int32 pnAdapterIndex, System.IAsyncResult result)
    // Offset: 0x1A96918
    void EndInvoke_NEW(int& pnAdapterIndex, System::IAsyncResult* result);
