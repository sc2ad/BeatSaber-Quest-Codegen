...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6670
  class IVROverlay::_SetKeyboardTransformAbsolute : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4BF94
    void Invoke_NEW(Valve::VR::ETrackingUniverseOrigin eTrackingOrigin, Valve::VR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform);
    ...
    // Offset: 0x1E4C224
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::ETrackingUniverseOrigin eTrackingOrigin, Valve::VR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Void EndInvoke(ref Valve.VR.HmdMatrix34_t pmatTrackingOriginToKeyboardTransform, System.IAsyncResult result)
    // Offset: 0x1E4C2D8
    void EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatTrackingOriginToKeyboardTransform, System::IAsyncResult* result);
