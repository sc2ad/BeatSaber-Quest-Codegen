...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6634
  class IVROverlay::_ShowKeyboardForOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8865C
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, int eInputMode, int eLineInputMode, ::Il2CppString* pchDescription, uint unCharMax, ::Il2CppString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
