...
namespace Valve::VR {
  ...
  class IVROverlay::_ShowKeyboardForOverlay : public System::MulticastDelegate {
    ...
    // Offset: 0x16AD930
    Valve::VR::EVROverlayError Invoke(uint64_t ulOverlayHandle, int eInputMode, int eLineInputMode, ::CsString* pchDescription, uint unCharMax, ::CsString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
