...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6990
  class IVRScreenshots::_GetScreenshotPropertyType : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8EAD4
    Valve::VR::EVRScreenshotType Invoke_NEW(uint screenshotHandle, Valve::VR::EVRScreenshotError& pError);
    ...
    // Offset: 0x1A8ED58
    System::IAsyncResult* BeginInvoke_NEW(uint screenshotHandle, Valve::VR::EVRScreenshotError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRScreenshotType EndInvoke(ref Valve.VR.EVRScreenshotError pError, System.IAsyncResult result)
    // Offset: 0x1A8EE0C
    Valve::VR::EVRScreenshotType EndInvoke_NEW(Valve::VR::EVRScreenshotError& pError, System::IAsyncResult* result);
