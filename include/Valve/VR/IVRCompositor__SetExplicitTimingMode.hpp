...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6058
  class IVRCompositor::_SetExplicitTimingMode : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3CEBC
    void Invoke_NEW(Valve::VR::EVRCompositorTimingMode eTimingMode);
    ...
    // Offset: 0x1E3D12C
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRCompositorTimingMode eTimingMode, System::AsyncCallback* callback, ::Il2CppObject* object);
