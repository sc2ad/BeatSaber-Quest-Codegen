...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6738
  class IVRRenderModels::_LoadTextureD3D11_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8D118
    Valve::VR::EVRRenderModelError Invoke_NEW(int textureId, System::IntPtr pD3D11Device, System::IntPtr& ppD3D11Texture2D);
    ...
    // Offset: 0x1A8D3B8
    System::IAsyncResult* BeginInvoke_NEW(int textureId, System::IntPtr pD3D11Device, System::IntPtr& ppD3D11Texture2D, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRRenderModelError EndInvoke(ref System.IntPtr ppD3D11Texture2D, System.IAsyncResult result)
    // Offset: 0x1A8D480
    Valve::VR::EVRRenderModelError EndInvoke_NEW(System::IntPtr& ppD3D11Texture2D, System::IAsyncResult* result);
