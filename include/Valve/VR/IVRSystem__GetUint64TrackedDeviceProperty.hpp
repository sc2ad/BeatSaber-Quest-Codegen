...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE55A4
  class IVRSystem::_GetUint64TrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9AFF8
    uint64_t Invoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1A9B298
    System::IAsyncResult* BeginInvoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, Valve::VR::ETrackedPropertyError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt64 EndInvoke(ref Valve.VR.ETrackedPropertyError pError, System.IAsyncResult result)
    // Offset: 0x1A9B36C
    uint64_t EndInvoke_NEW(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result);
