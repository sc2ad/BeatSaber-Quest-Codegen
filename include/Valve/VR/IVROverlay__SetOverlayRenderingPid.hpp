...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6148
  class IVROverlay::_SetOverlayRenderingPid : public System::MulticastDelegate {
    ...
    // Offset: 0x1A85748
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint unPID);
    ...
    // Offset: 0x1A859CC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, uint unPID, System::AsyncCallback* callback, ::Il2CppObject* object);
