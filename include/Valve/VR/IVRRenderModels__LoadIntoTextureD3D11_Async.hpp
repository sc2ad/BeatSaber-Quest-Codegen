...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE674C
  class IVRRenderModels::_LoadIntoTextureD3D11_Async : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8C8D8
    Valve::VR::EVRRenderModelError Invoke_NEW(int textureId, System::IntPtr pDstTexture);
    ...
    // Offset: 0x1A8CB5C
    System::IAsyncResult* BeginInvoke_NEW(int textureId, System::IntPtr pDstTexture, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVRRenderModelError EndInvoke(System.IAsyncResult result)
    // Offset: 0x1A8CC08
    Valve::VR::EVRRenderModelError EndInvoke_NEW(System::IAsyncResult* result);
