...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5630
  class IVRSystem::_GetEventTypeNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A96D18
    System::IntPtr Invoke_NEW(Valve::VR::EVREventType eType);
    // public System.IAsyncResult BeginInvoke(Valve.VR.EVREventType eType, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1A96F90
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREventType eType, System::AsyncCallback* callback, ::Il2CppObject* object);
