...
namespace Valve::VR {
  ...
  class IVROverlay::_SetOverlayName : public System::MulticastDelegate {
    ...
    // Offset: 0x16B655C
    static IVROverlay::_SetOverlayName* New_ctor(::CsObject* object, System::IntPtr method);
    // public Valve.VR.EVROverlayError Invoke(System.UInt64 ulOverlayHandle, System.String pchName)
    // Offset: 0x16B6570
    Valve::VR::EVROverlayError Invoke(uint64_t ulOverlayHandle, ::CsString* pchName);
    ...
    // Offset: 0x16B67F4
    System::IAsyncResult* BeginInvoke(uint64_t ulOverlayHandle, ::CsString* pchName, System::AsyncCallback* callback, ::CsObject* object);
