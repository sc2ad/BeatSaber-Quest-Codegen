...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE610C
  class IVROverlay::_SetOverlayName : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4E3A4
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchName);
    ...
    // Offset: 0x1E4E628
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, ::Il2CppString* pchName, System::AsyncCallback* callback, ::Il2CppObject* object);
