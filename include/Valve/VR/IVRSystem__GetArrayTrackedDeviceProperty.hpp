...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE55CC
  class IVRSystem::_GetArrayTrackedDeviceProperty : public System::MulticastDelegate {
    ...
    // Offset: 0x1A949E4
    uint Invoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, uint propType, System::IntPtr pBuffer, uint unBufferSize, Valve::VR::ETrackedPropertyError& pError);
    ...
    // Offset: 0x1A94CE0
    System::IAsyncResult* BeginInvoke_NEW(uint unDeviceIndex, Valve::VR::ETrackedDeviceProperty prop, uint propType, System::IntPtr pBuffer, uint unBufferSize, Valve::VR::ETrackedPropertyError& pError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref Valve.VR.ETrackedPropertyError pError, System.IAsyncResult result)
    // Offset: 0x1A94E00
    uint EndInvoke_NEW(Valve::VR::ETrackedPropertyError& pError, System::IAsyncResult* result);
