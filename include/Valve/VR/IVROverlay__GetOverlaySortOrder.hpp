...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6224
  class IVROverlay::_GetOverlaySortOrder : public System::MulticastDelegate {
    ...
    // Offset: 0x1E462F0
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint& punSortOrder);
    ...
    // Offset: 0x1E46624
    Valve::VR::EVROverlayError EndInvoke_NEW(uint& punSortOrder, System::IAsyncResult* result);
