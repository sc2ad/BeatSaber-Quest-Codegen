...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6364
  class IVROverlay::_SetOverlayTransformTrackedDeviceComponent : public System::MulticastDelegate {
    ...
    // Offset: 0x1A87358
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, uint unDeviceIndex, ::Il2CppString* pchComponentName);
