...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE683C
  class IVRRenderModels::_GetRenderModelErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8B76C
    System::IntPtr Invoke_NEW(Valve::VR::EVRRenderModelError error);
    ...
    // Offset: 0x1A8B9E4
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRRenderModelError error, System::AsyncCallback* callback, ::Il2CppObject* object);
