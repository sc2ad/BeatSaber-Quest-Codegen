...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5C34
  class IVRChaperoneSetup::_SetWorkingPlayAreaSize : public System::MulticastDelegate {
    ...
    // Offset: 0x1E36368
    void Invoke_NEW(float sizeX, float sizeZ);
    ...
    // Offset: 0x1E365E0
    System::IAsyncResult* BeginInvoke_NEW(float sizeX, float sizeZ, System::AsyncCallback* callback, ::Il2CppObject* object);
