...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5D38
  class IVRCompositor::_GetTrackingSpace : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3B0A4
    Valve::VR::ETrackingUniverseOrigin Invoke_NEW();
    ...
    // Offset: 0x1E3B2E4
    Valve::VR::ETrackingUniverseOrigin EndInvoke_NEW(System::IAsyncResult* result);
