...
namespace Valve::VR {
  // Forward declaring type: _GetFloat
  class _GetFloat;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRSettings::_GetFloat);
...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: EF7ECC
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (Valve::VR::IVRSettings::_GetFloat::*)(ByRef<Valve::VR::EVRSettingsError>, System::IAsyncResult*)>(&Valve::VR::IVRSettings::_GetFloat::EndInvoke)> {
  static const MethodInfo* get() {
    static auto* peError = &::il2cpp_utils::GetClassFromName("Valve.VR", "EVRSettingsError")->this_arg;
