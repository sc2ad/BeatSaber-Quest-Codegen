...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6918
  class IVRSettings::_GetFloat : public System::MulticastDelegate {
    ...
    // Offset: 0x1A9050C
    float Invoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, Valve::VR::EVRSettingsError& peError);
    ...
    // Offset: 0x1A90924
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppString* pchSection, ::Il2CppString* pchSettingsKey, Valve::VR::EVRSettingsError& peError, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Single EndInvoke(ref Valve.VR.EVRSettingsError peError, System.IAsyncResult result)
    // Offset: 0x1A909CC
    float EndInvoke_NEW(Valve::VR::EVRSettingsError& peError, System::IAsyncResult* result);
