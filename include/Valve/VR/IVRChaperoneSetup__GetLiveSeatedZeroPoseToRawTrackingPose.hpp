...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5C98
  class IVRChaperoneSetup::_GetLiveSeatedZeroPoseToRawTrackingPose : public System::MulticastDelegate {
    ...
    // Offset: 0x1E33BAC
    bool Invoke_NEW(Valve::VR::HmdMatrix34_t& pmatSeatedZeroPoseToRawTrackingPose);
    ...
    // Offset: 0x1E33E0C
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatSeatedZeroPoseToRawTrackingPose, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E33EA0
    bool EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatSeatedZeroPoseToRawTrackingPose, System::IAsyncResult* result);
