...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5DD8
  class IVRCompositor::_GetFrameTimings : public System::MulticastDelegate {
    ...
    // Offset: 0x1E39BC8
    uint Invoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, uint nFrames);
    ...
    // Offset: 0x1E39E44
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, uint nFrames, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.UInt32 EndInvoke(ref Valve.VR.Compositor_FrameTiming pTiming, System.IAsyncResult result)
    // Offset: 0x1E39EF8
    uint EndInvoke_NEW(Valve::VR::Compositor_FrameTiming& pTiming, System::IAsyncResult* result);
