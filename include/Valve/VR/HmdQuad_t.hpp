...
namespace Valve::VR {
  ...
  check_size<sizeof(HmdQuad_t), 36 + sizeof(Valve::VR::HmdVector3_t) + ((36 + sizeof(Valve::VR::HmdVector3_t)) % 8 != 0 ? (8 - (36 + sizeof(Valve::VR::HmdVector3_t)) % 8) : 0)> __Valve_VR_HmdQuad_tSizeCheck;
}
