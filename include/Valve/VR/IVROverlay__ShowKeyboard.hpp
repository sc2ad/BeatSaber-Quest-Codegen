...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6620
  class IVROverlay::_ShowKeyboard : public System::MulticastDelegate {
    ...
    // Offset: 0x1A881E4
    Valve::VR::EVROverlayError Invoke_NEW(int eInputMode, int eLineInputMode, ::Il2CppString* pchDescription, uint unCharMax, ::Il2CppString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
    ...
    // Offset: 0x1A88510
    System::IAsyncResult* BeginInvoke_NEW(int eInputMode, int eLineInputMode, ::Il2CppString* pchDescription, uint unCharMax, ::Il2CppString* pchExistingText, bool bUseMinimalMode, uint64_t uUserValue, System::AsyncCallback* callback, ::Il2CppObject* object);
