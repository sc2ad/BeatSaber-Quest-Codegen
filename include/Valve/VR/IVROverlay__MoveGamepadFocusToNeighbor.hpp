...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE64CC
  class IVROverlay::_MoveGamepadFocusToNeighbor : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4A794
    Valve::VR::EVROverlayError Invoke_NEW(Valve::VR::EOverlayDirection eDirection, uint64_t ulFrom);
    ...
    // Offset: 0x1E4AA2C
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EOverlayDirection eDirection, uint64_t ulFrom, System::AsyncCallback* callback, ::Il2CppObject* object);
