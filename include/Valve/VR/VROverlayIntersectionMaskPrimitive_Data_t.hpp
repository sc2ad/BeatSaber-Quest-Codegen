...
namespace Valve::VR {
  ...
  check_size<sizeof(VROverlayIntersectionMaskPrimitive_Data_t), 0 + sizeof(Valve::VR::IntersectionMaskCircle_t) + ((0 + sizeof(Valve::VR::IntersectionMaskCircle_t)) % 8 != 0 ? (8 - (0 + sizeof(Valve::VR::IntersectionMaskCircle_t)) % 8) : 0)> __Valve_VR_VROverlayIntersectionMaskPrimitive_Data_tSizeCheck;
}
