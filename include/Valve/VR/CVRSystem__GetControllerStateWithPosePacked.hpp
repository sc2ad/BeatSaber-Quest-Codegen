...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVRSystem::_GetControllerStateWithPosePacked::*)(Valve::VR::ETrackingUniverseOrigin, uint, Valve::VR::VRControllerState_t_Packed&, uint, Valve::VR::TrackedDevicePose_t&)>(&CVRSystem::_GetControllerStateWithPosePacked::Invoke)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(CVRSystem::_GetControllerStateWithPosePacked*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Valve::VR::ETrackingUniverseOrigin>(), ::il2cpp_utils::ExtractIndependentType<uint>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::VRControllerState_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<uint>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::TrackedDevicePose_t&>()});
  }
};
// Writing MetadataGetter for method: CVRSystem::_GetControllerStateWithPosePacked::BeginInvoke
// Il2CppName: BeginInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (CVRSystem::_GetControllerStateWithPosePacked::*)(Valve::VR::ETrackingUniverseOrigin, uint, Valve::VR::VRControllerState_t_Packed&, uint, Valve::VR::TrackedDevicePose_t&, System::AsyncCallback*, ::Il2CppObject*)>(&CVRSystem::_GetControllerStateWithPosePacked::BeginInvoke)> {
  const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVRSystem::_GetControllerStateWithPosePacked::*)(Valve::VR::VRControllerState_t_Packed&, Valve::VR::TrackedDevicePose_t&, System::IAsyncResult*)>(&CVRSystem::_GetControllerStateWithPosePacked::EndInvoke)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(CVRSystem::_GetControllerStateWithPosePacked*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Valve::VR::VRControllerState_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::TrackedDevicePose_t&>(), ::il2cpp_utils::ExtractIndependentType<System::IAsyncResult*>()});
  }
};
