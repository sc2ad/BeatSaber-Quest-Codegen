...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6260
  class IVROverlay::_SetOverlayAutoCurveDistanceRangeInMeters : public System::MulticastDelegate {
    ...
    // Offset: 0x1E4C680
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, float fMinDistanceInMeters, float fMaxDistanceInMeters);
