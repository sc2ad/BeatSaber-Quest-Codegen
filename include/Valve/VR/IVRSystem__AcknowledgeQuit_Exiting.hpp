...
namespace Valve::VR {
  // Forward declaring type: _AcknowledgeQuit_Exiting
  class _AcknowledgeQuit_Exiting;
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting);
DEFINE_IL2CPP_ARG_TYPE(Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting*, "Valve.VR", "IVRSystem/_AcknowledgeQuit_Exiting");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x70
  #pragma pack(push, 1)
  // Autogenerated type: Valve.VR.IVRSystem/Valve.VR._AcknowledgeQuit_Exiting
  // [TokenAttribute] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: EB7DF0
  ...
  }; // Valve.VR.IVRSystem/Valve.VR._AcknowledgeQuit_Exiting
  #pragma pack(pop)
}
#include "extern/beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting::*)(System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting::BeginInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{callback, object});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting::*)(System::IAsyncResult*)>(&Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting::EndInvoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRSystem::_AcknowledgeQuit_Exiting*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
