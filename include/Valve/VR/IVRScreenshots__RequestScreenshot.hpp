...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6968
  class IVRScreenshots::_RequestScreenshot : public System::MulticastDelegate {
    ...
    // Offset: 0x1A8F1A4
    Valve::VR::EVRScreenshotError Invoke_NEW(uint& pOutScreenshotHandle, Valve::VR::EVRScreenshotType type, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename);
    ...
    // Offset: 0x1A8F44C
    System::IAsyncResult* BeginInvoke_NEW(uint& pOutScreenshotHandle, Valve::VR::EVRScreenshotType type, ::Il2CppString* pchPreviewFilename, ::Il2CppString* pchVRFilename, System::AsyncCallback* callback, ::Il2CppObject* object);
