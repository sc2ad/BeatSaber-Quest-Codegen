...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE58D8
  class IVRApplications::_GetApplicationKeyByIndex : public System::MulticastDelegate {
    ...
    // Offset: 0x14FB728
    Valve::VR::EVRApplicationError Invoke_NEW(uint unApplicationIndex, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen);
    ...
    // Offset: 0x15083B4
    System::IAsyncResult* BeginInvoke_NEW(uint unApplicationIndex, System::Text::StringBuilder* pchAppKeyBuffer, uint unAppKeyBufferLen, System::AsyncCallback* callback, ::Il2CppObject* object);
