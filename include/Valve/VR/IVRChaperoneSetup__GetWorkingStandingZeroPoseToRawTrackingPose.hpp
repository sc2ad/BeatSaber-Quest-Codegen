...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5C20
  class IVRChaperoneSetup::_GetWorkingStandingZeroPoseToRawTrackingPose : public System::MulticastDelegate {
    ...
    // Offset: 0x1E34C2C
    bool Invoke_NEW(Valve::VR::HmdMatrix34_t& pmatStandingZeroPoseToRawTrackingPose);
    ...
    // Offset: 0x1E34F20
    bool EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatStandingZeroPoseToRawTrackingPose, System::IAsyncResult* result);
