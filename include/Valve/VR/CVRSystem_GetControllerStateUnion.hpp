...
namespace Valve::VR {
  ...
  check_size<sizeof(CVRSystem::GetControllerStateUnion), 0 + sizeof(void*) + ((0 + sizeof(void*)) % 8 != 0 ? (8 - (0 + sizeof(void*)) % 8) : 0)> __Valve_VR_CVRSystem_GetControllerStateUnionSizeCheck;
}
