...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE5D88
  class IVRCompositor::_Submit : public System::MulticastDelegate {
    ...
    // Offset: 0x1E3DD10
    Valve::VR::EVRCompositorError Invoke_NEW(Valve::VR::EVREye eEye, Valve::VR::Texture_t& pTexture, Valve::VR::VRTextureBounds_t& pBounds, Valve::VR::EVRSubmitFlags nSubmitFlags);
    ...
    // Offset: 0x1E3DFE8
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVREye eEye, Valve::VR::Texture_t& pTexture, Valve::VR::VRTextureBounds_t& pBounds, Valve::VR::EVRSubmitFlags nSubmitFlags, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E3E0D8
    Valve::VR::EVRCompositorError EndInvoke_NEW(Valve::VR::Texture_t& pTexture, Valve::VR::VRTextureBounds_t& pBounds, System::IAsyncResult* result);
