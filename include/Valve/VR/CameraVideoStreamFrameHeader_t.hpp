...
namespace Valve::VR {
  ...
  check_size<sizeof(CameraVideoStreamFrameHeader_t), 20 + sizeof(Valve::VR::TrackedDevicePose_t) + 8 - (20 + sizeof(Valve::VR::TrackedDevicePose_t)) % 8> __Valve_VR_CameraVideoStreamFrameHeader_tSizeCheck;
}
