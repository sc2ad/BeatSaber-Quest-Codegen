...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DD48D8
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVROverlay::_PollNextOverlayEventPacked::*)(uint64_t, Valve::VR::VREvent_t_Packed&, uint)>(&CVROverlay::_PollNextOverlayEventPacked::Invoke)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(CVROverlay::_PollNextOverlayEventPacked*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<uint64_t>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::VREvent_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<uint>()});
  }
};
// Writing MetadataGetter for method: CVROverlay::_PollNextOverlayEventPacked::BeginInvoke
// Il2CppName: BeginInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (CVROverlay::_PollNextOverlayEventPacked::*)(uint64_t, Valve::VR::VREvent_t_Packed&, uint, System::AsyncCallback*, ::Il2CppObject*)>(&CVROverlay::_PollNextOverlayEventPacked::BeginInvoke)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(CVROverlay::_PollNextOverlayEventPacked*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<uint64_t>(), ::il2cpp_utils::ExtractIndependentType<Valve::VR::VREvent_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<uint>(), ::il2cpp_utils::ExtractIndependentType<System::AsyncCallback*>(), ::il2cpp_utils::ExtractIndependentType<::Il2CppObject*>()});
  }
};
// Writing MetadataGetter for method: CVROverlay::_PollNextOverlayEventPacked::EndInvoke
// Il2CppName: EndInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (CVROverlay::_PollNextOverlayEventPacked::*)(Valve::VR::VREvent_t_Packed&, System::IAsyncResult*)>(&CVROverlay::_PollNextOverlayEventPacked::EndInvoke)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(CVROverlay::_PollNextOverlayEventPacked*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Valve::VR::VREvent_t_Packed&>(), ::il2cpp_utils::ExtractIndependentType<System::IAsyncResult*>()});
  }
};
