...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6A80
  class CVROverlay::_PollNextOverlayEventPacked : public System::MulticastDelegate {
    ...
    // Offset: 0x1504F6C
    bool Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent);
    ...
    // Offset: 0x1505654
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::VREvent_t_Packed& pEvent, uint uncbVREvent, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Boolean EndInvoke(ref Valve.VR.VREvent_t_Packed pEvent, System.IAsyncResult result)
    // Offset: 0x1505728
    bool EndInvoke_NEW(Valve::VR::VREvent_t_Packed& pEvent, System::IAsyncResult* result);
