...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6878
  class IVRSettings::_GetSettingsErrorNameFromEnum : public System::MulticastDelegate {
    ...
    // Offset: 0x1A90F1C
    System::IntPtr Invoke_NEW(Valve::VR::EVRSettingsError eError);
    ...
    // Offset: 0x1A91194
    System::IAsyncResult* BeginInvoke_NEW(Valve::VR::EVRSettingsError eError, System::AsyncCallback* callback, ::Il2CppObject* object);
