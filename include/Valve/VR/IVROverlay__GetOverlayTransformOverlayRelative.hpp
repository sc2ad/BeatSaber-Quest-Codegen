...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE638C
  class IVROverlay::_GetOverlayTransformOverlayRelative : public System::MulticastDelegate {
    ...
    // Offset: 0x1E480B4
    Valve::VR::EVROverlayError EndInvoke_NEW(uint64_t& ulOverlayHandleParent, Valve::VR::HmdMatrix34_t& pmatParentOverlayToOverlayTransform, System::IAsyncResult* result);
