...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE63F0
  class IVROverlay::_GetTransformForOverlayCoordinates : public System::MulticastDelegate {
    ...
    // Offset: 0x1E491F8
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::ETrackingUniverseOrigin eTrackingOrigin, Valve::VR::HmdVector2_t coordinatesInOverlay, Valve::VR::HmdMatrix34_t& pmatTransform);
    ...
    // Offset: 0x1E494CC
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::ETrackingUniverseOrigin eTrackingOrigin, Valve::VR::HmdVector2_t coordinatesInOverlay, Valve::VR::HmdMatrix34_t& pmatTransform, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVROverlayError EndInvoke(ref Valve.VR.HmdMatrix34_t pmatTransform, System.IAsyncResult result)
    // Offset: 0x1E495BC
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::HmdMatrix34_t& pmatTransform, System::IAsyncResult* result);
