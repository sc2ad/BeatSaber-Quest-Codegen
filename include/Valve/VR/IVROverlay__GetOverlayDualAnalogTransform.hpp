...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE64F4
  class IVROverlay::_GetOverlayDualAnalogTransform : public System::MulticastDelegate {
    ...
    // Offset: 0x1E43A78
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlay, Valve::VR::EDualAnalogWhich eWhich, Valve::VR::HmdVector2_t& pvCenter, float& pfRadius);
    ...
    // Offset: 0x1E43D30
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlay, Valve::VR::EDualAnalogWhich eWhich, Valve::VR::HmdVector2_t& pvCenter, float& pfRadius, System::AsyncCallback* callback, ::Il2CppObject* object);
    ...
    // Offset: 0x1E43E24
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::HmdVector2_t& pvCenter, float& pfRadius, System::IAsyncResult* result);
