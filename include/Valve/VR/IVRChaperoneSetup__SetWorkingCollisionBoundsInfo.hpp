...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: DF3450
  class IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo : public System::MulticastDelegate {
    ...
    // Offset: 0x2053128
    void Invoke(ByRef<::Array<Valve::VR::HmdQuad_t>*> pQuadsBuffer, uint unQuadsCount);
    ...
    // Offset: 0x2053398
    System::IAsyncResult* BeginInvoke(ByRef<::Array<Valve::VR::HmdQuad_t>*> pQuadsBuffer, uint unQuadsCount, System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::*)(ByRef<::Array<Valve::VR::HmdQuad_t>*>, uint)>(&Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::Invoke)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::IAsyncResult* (Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::*)(ByRef<::Array<Valve::VR::HmdQuad_t>*>, uint, System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRChaperoneSetup::_SetWorkingCollisionBoundsInfo::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* pQuadsBuffer = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("Valve.VR", "HmdQuad_t"), 1)->this_arg;
    static auto* unQuadsCount = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
