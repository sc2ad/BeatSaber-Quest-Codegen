...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6508
  class IVROverlay::_SetOverlayTexture : public System::MulticastDelegate {
    ...
    // Offset: 0x1A86190
    Valve::VR::EVROverlayError Invoke_NEW(uint64_t ulOverlayHandle, Valve::VR::Texture_t& pTexture);
    ...
    // Offset: 0x1A86414
    System::IAsyncResult* BeginInvoke_NEW(uint64_t ulOverlayHandle, Valve::VR::Texture_t& pTexture, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Valve.VR.EVROverlayError EndInvoke(ref Valve.VR.Texture_t pTexture, System.IAsyncResult result)
    // Offset: 0x1A864C4
    Valve::VR::EVROverlayError EndInvoke_NEW(Valve::VR::Texture_t& pTexture, System::IAsyncResult* result);
