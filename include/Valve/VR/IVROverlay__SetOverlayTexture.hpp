...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: D89DBC
  class IVROverlay::_SetOverlayTexture : public System::MulticastDelegate {
    ...
    static IVROverlay::_SetOverlayTexture* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Valve::VR").WithContext("_SetOverlayTexture").WithContext(".ctor");
