...
namespace Valve::VR {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CE6864
  class IVRNotifications::_RemoveNotification : public System::MulticastDelegate {
    ...
    // Offset: 0x1E40344
    Valve::VR::EVRNotificationError Invoke_NEW(uint notificationId);
    ...
    // Offset: 0x1E40638
    Valve::VR::EVRNotificationError EndInvoke_NEW(System::IAsyncResult* result);
