...
namespace OnlineServices {
  ...
  check_size<sizeof(LevelScoreUploader::$SendLevelScoreResultAsync$d__13), 128 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((128 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (128 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __OnlineServices_LevelScoreUploader_$SendLevelScoreResultAsync$d__13SizeCheck;
}
