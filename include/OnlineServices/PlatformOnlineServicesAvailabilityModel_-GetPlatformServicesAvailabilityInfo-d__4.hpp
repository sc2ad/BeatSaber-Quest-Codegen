...
namespace OnlineServices {
  ...
  struct PlatformOnlineServicesAvailabilityModel::$GetPlatformServicesAvailabilityInfo$d__4 : public System::Runtime::CompilerServices::IAsyncStateMachine, public System::ValueType {
    public:
