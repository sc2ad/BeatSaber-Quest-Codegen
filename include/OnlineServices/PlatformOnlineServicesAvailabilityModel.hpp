...
namespace OnlineServices {
  ...
  class PlatformOnlineServicesAvailabilityModel : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDD3500
    ...
    static PlatformOnlineServicesAvailabilityModel* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("OnlineServices").WithContext("PlatformOnlineServicesAvailabilityModel").WithContext(".ctor");
