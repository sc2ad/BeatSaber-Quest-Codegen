...
namespace OnlineServices {
  ...
  check_size<sizeof(PlatformOnlineServicesAvailabilityModel), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __OnlineServices_PlatformOnlineServicesAvailabilityModelSizeCheck;
}
