...
namespace OnlineServices::API {
  ...
  class HTTPApiLeaderboardsModel : public ::CsObject, public OnlineServices::API::IApiLeaderboardsModel {
    public:
    ...
    static ::CsString* _get_kSendLevelScoreResultPath();
    // Set static field: static private System.String kSendLevelScoreResultPath
    static void _set_kSendLevelScoreResultPath(::CsString* value);
    ...
    static ::CsString* _get_kGetLeaderboardEntriesPath();
    // Set static field: static private System.String kGetLeaderboardEntriesPath
    static void _set_kGetLeaderboardEntriesPath(::CsString* value);
    ...
    // Offset: 0xC3C91C
    static HTTPApiLeaderboardsModel* New_ctor(::CsString* hostName, OnlineServices::API::IUserLoginDtoDataSource* userLoginDtoDataSource);
