...
namespace OnlineServices::API {
  ...
  check_size<sizeof(HTTPApiLeaderboardsModel::$LogoutAsync$d__3), 48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (48 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __OnlineServices_API_HTTPApiLeaderboardsModel_$LogoutAsync$d__3SizeCheck;
}
