...
namespace OnlineServices::API {
  ...
  // [CompilerGeneratedAttribute] Offset: EFE534
  class HTTPLeaderboardsOathHelper::$$c__DisplayClass10_1 : public ::Il2CppObject {
    ...
    // Get instance field reference: public OnlineServices.API.HTTPLeaderboardsOathHelper/<>c__DisplayClass10_0 CS$<>8__locals1
