...
namespace OnlineServices::API {
  ...
  check_size<sizeof(HTTPLeaderboardsOathHelper::$SendAndWaitAsync$d__11), 56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter) + ((56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8 != 0 ? (8 - (56 + sizeof(System::Runtime::CompilerServices::TaskAwaiter)) % 8) : 0)> __OnlineServices_API_HTTPLeaderboardsOathHelper_$SendAndWaitAsync$d__11SizeCheck;
}
