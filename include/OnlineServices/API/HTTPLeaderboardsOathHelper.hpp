...
namespace OnlineServices::API {
  ...
  class HTTPLeaderboardsOathHelper : public ::CsObject {
    public:
    ...
    static ::CsString* _get_kLoginPath();
    // Set static field: static private System.String kLoginPath
    static void _set_kLoginPath(::CsString* value);
    ...
    static ::CsString* _get_kLogoutPath();
    // Set static field: static private System.String kLogoutPath
    static void _set_kLogoutPath(::CsString* value);
    ...
    // Offset: 0xC2B654
    System::Threading::Tasks::Task_1<::CsString*>* SendWebRequestWithOathAsync(::CsString* path, ::CsString* method, ::CsObject* objectToSendAsJson, System::Threading::CancellationToken cancellationToken);
    ...
    // Offset: 0xC2C05C
    System::Threading::Tasks::Task_1<::CsString*>* SendWebRequestAsync(::CsString* uri, ::CsString* method, ::CsString* bodyData, ::CsString* bearerToken);
