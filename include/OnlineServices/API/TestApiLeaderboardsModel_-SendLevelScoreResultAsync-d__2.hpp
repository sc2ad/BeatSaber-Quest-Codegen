...
namespace OnlineServices::API {
  ...
  check_size<sizeof(TestApiLeaderboardsModel::$SendLevelScoreResultAsync$d__2), 32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::Response>) + ((32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::Response>)) % 8 != 0 ? (8 - (32 + sizeof(System::Runtime::CompilerServices::TaskAwaiter_1<OnlineServices::API::Response>)) % 8) : 0)> __OnlineServices_API_TestApiLeaderboardsModel_$SendLevelScoreResultAsync$d__2SizeCheck;
}
