...
namespace System::Configuration::Assemblies {
  ...
  check_size<sizeof(AssemblyHashAlgorithm), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Configuration_Assemblies_AssemblyHashAlgorithmSizeCheck;
}
