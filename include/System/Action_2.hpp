...
namespace System {
  ...
  class Action_2 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static Action_2<T1, T2>* New_ctor(::CsObject* object, System::IntPtr method) {
      return (Action_2<T1, T2>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Action_2<T1, T2>*>::get(), object, method)));
    }
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T1 arg1, T2 arg2, System::AsyncCallback* callback, ::CsObject* object) {
