...
// Ctor Parameters [CppParam { name: "num", ty: "void*", modifiers: "", def_value: Some("csnull") }, CppParam { name: "numCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "month", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "year", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "dayOfWeek", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "era", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "timeMark", ty: "System::System__DateTimeParse__TM", modifiers: "", def_value: Some("{}") }, CppParam { name: "fraction", ty: "double_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "hasSameDateAndTimeSeparators", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr System::DateTimeRawInfo::DateTimeRawInfo(void* num, int32_t numCount, int32_t month, int32_t year, int32_t dayOfWeek, int32_t era, System::System__DateTimeParse__TM timeMark, double_t fraction, bool hasSameDateAndTimeSeparators) noexcept : ::bs_hook::ValueTypeWrapper() {this->num = num;
...
constexpr void System::DateTimeRawInfo::__set_timeMark(System::System__DateTimeParse__TM value)  {
::cordl_internals::setInstanceField<System::System__DateTimeParse__TM, 0x1c>(this->__instance, std::forward<System::System__DateTimeParse__TM>(value));
}
constexpr System::System__DateTimeParse__TM System::DateTimeRawInfo::__get_timeMark() const {
return ::cordl_internals::getInstanceField<System::System__DateTimeParse__TM, 0x1c>(this->__instance);
}
