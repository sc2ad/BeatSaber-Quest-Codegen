...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C93A7C
  class AssemblyLoadEventHandler : public System::MulticastDelegate {
    ...
    // Offset: 0x1617AFC
    void Invoke_NEW(::Il2CppObject* sender, System::AssemblyLoadEventArgs* args);
    ...
    // Offset: 0x161FC2C
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppObject* sender, System::AssemblyLoadEventArgs* args, System::AsyncCallback* callback, ::Il2CppObject* object);
