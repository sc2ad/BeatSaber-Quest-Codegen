...
namespace System {
  ...
  class Action_5 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static Action_5<T1, T2, T3, T4, T5>* New_ctor(::CsObject* object, System::IntPtr method) {
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, System::AsyncCallback* callback, ::CsObject* object) {
