...
namespace System {
class ____System__MonoCustomAttrs__AttributeInfo;
}
// Type: ::AttributeInfo
namespace System {
// Is value type: false
...
class CORDL_TYPE ____System__MonoCustomAttrs__AttributeInfo : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____System__MonoCustomAttrs__AttributeInfo() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__MonoCustomAttrs__AttributeInfo", modifiers: " const&", def_value: None }]
constexpr ____System__MonoCustomAttrs__AttributeInfo(____System__MonoCustomAttrs__AttributeInfo const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__MonoCustomAttrs__AttributeInfo", modifiers: "&&", def_value: None }]
constexpr ____System__MonoCustomAttrs__AttributeInfo(____System__MonoCustomAttrs__AttributeInfo&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__MonoCustomAttrs__AttributeInfo(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__MonoCustomAttrs__AttributeInfo& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__MonoCustomAttrs__AttributeInfo& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__MonoCustomAttrs__AttributeInfo& operator=(____System__MonoCustomAttrs__AttributeInfo&& o) noexcept = default;
  constexpr ____System__MonoCustomAttrs__AttributeInfo& operator=(____System__MonoCustomAttrs__AttributeInfo const& o) noexcept = default;
...
explicit ____System__MonoCustomAttrs__AttributeInfo(::System::AttributeUsageAttribute usage, int32_t inheritanceLevel) ;
...
public:
// Declarations
using AttributeInfo = ::System::____System__MonoCustomAttrs__AttributeInfo;
...
NEED_NO_BOX(::System::____System__MonoCustomAttrs__AttributeInfo);
DEFINE_IL2CPP_ARG_TYPE(::System::____System__MonoCustomAttrs__AttributeInfo, "System", "MonoCustomAttrs/AttributeInfo");
