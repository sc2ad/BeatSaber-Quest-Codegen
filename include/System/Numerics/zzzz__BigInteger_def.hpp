...
struct ____System__Numerics__BigInteger__GetBytesMode;
}
namespace System::Numerics {
struct BigInteger;
}
...
struct CORDL_TYPE ____System__Numerics__BigInteger__GetBytesMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Numerics__BigInteger__GetBytesMode(int32_t value__) noexcept;


                    constexpr ____System__Numerics__BigInteger__GetBytesMode(____System__Numerics__BigInteger__GetBytesMode const&) = default;
                    constexpr ____System__Numerics__BigInteger__GetBytesMode(____System__Numerics__BigInteger__GetBytesMode&&) = default;
                    constexpr ____System__Numerics__BigInteger__GetBytesMode& operator=(____System__Numerics__BigInteger__GetBytesMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Numerics__BigInteger__GetBytesMode& operator=(____System__Numerics__BigInteger__GetBytesMode&& o) noexcept {
...
constexpr explicit ____System__Numerics__BigInteger__GetBytesMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Numerics__BigInteger__GetBytesMode_Unwrapped : int32_t {
__AllocateArray = 0,
__Count = 1,
__Span = 2,
};
...
constexpr operator ______System__Numerics__BigInteger__GetBytesMode_Unwrapped () const noexcept {
return std::bit_cast<______System__Numerics__BigInteger__GetBytesMode_Unwrapped>(__instance);
}
...
static ::System::Numerics::____System__Numerics__BigInteger__GetBytesMode const AllocateArray;

/// @brief Field Count offset 0
static ::System::Numerics::____System__Numerics__BigInteger__GetBytesMode const Count;

/// @brief Field Span offset 0
static ::System::Numerics::____System__Numerics__BigInteger__GetBytesMode const Span;
...
public:
// Declarations
using GetBytesMode = ::System::Numerics::____System__Numerics__BigInteger__GetBytesMode;
...
/// @brief Method TryGetBytes addr 0x26b3a2c size 0x4ec virtual false final false
 ::ArrayW<uint8_t> TryGetBytes(::System::Numerics::____System__Numerics__BigInteger__GetBytesMode mode, ::System::Span_1<uint8_t> destination, bool isUnsigned, bool isBigEndian, ByRef<int32_t> bytesWritten) ;
...
static ::System::Numerics::BigInteger op_Implicit___System__Numerics__BigInteger(uint8_t value) ;

/// @brief Method op_Implicit addr 0x26b4790 size 0x28 virtual false final false
static ::System::Numerics::BigInteger op_Implicit___System__Numerics__BigInteger(int32_t value) ;

/// @brief Method op_Implicit addr 0x26b41ac size 0x28 virtual false final false
static ::System::Numerics::BigInteger op_Implicit___System__Numerics__BigInteger(int64_t value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Numerics::____System__Numerics__BigInteger__GetBytesMode, "System.Numerics", "BigInteger/GetBytesMode");
