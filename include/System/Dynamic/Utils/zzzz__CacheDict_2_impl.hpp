...
constexpr void ::System::Dynamic::Utils::CacheDict_2::__set__entries(::ArrayW<::System::Dynamic::Utils::____System__Dynamic__Utils__CacheDict_2__Entry<TKey,TValue>> value)  {
::cordl_internals::setInstanceField<::ArrayW<::System::Dynamic::Utils::____System__Dynamic__Utils__CacheDict_2__Entry<TKey,TValue>>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<::System::Dynamic::Utils::____System__Dynamic__Utils__CacheDict_2__Entry<TKey,TValue>>>(value));
}
constexpr ::ArrayW<::System::Dynamic::Utils::____System__Dynamic__Utils__CacheDict_2__Entry<TKey,TValue>> ::System::Dynamic::Utils::CacheDict_2::__get__entries() const {
return ::cordl_internals::getInstanceField<::ArrayW<::System::Dynamic::Utils::____System__Dynamic__Utils__CacheDict_2__Entry<TKey,TValue>>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
