...
namespace System::Text {
  ...
  check_size<sizeof(UnicodeEncoding::Decoder), 52 + sizeof(::Il2CppChar) + ((52 + sizeof(::Il2CppChar)) % 8 != 0 ? (8 - (52 + sizeof(::Il2CppChar)) % 8) : 0)> __System_Text_UnicodeEncoding_DecoderSizeCheck;
}
