...
namespace System::Text {
  ...
  check_size<sizeof(Encoding::EncodingByteBuffer), 88 + sizeof(void*) + ((88 + sizeof(void*)) % 8 != 0 ? (8 - (88 + sizeof(void*)) % 8) : 0)> __System_Text_Encoding_EncodingByteBufferSizeCheck;
}
