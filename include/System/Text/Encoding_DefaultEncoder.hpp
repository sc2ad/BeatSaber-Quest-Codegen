...
namespace System::Text {
  ...
  class Encoding::DefaultEncoder : public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IObjectReference, public System::Text::Encoder {
    public:
