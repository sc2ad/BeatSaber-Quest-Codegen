...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::Il2CppString*, ::ArrayWrapper<::Il2CppObject*>)>(&System::Text::EncodingHelper::InvokeI18N)> {
  static const MethodInfo* get() {
