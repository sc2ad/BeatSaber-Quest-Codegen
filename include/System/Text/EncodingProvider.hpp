...
namespace System::Text {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C93D64
  class EncodingProvider : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    System::Text::Encoding* GetEncoding_NEW(::Il2CppString* name);
    // public System.Text.Encoding GetEncoding(System.Int32 codepage)
    // Offset: 0xFFFFFFFF
    System::Text::Encoding* GetEncoding_NEW(int codepage);
    ...
    // Offset: 0x1B050F8
    System::Text::Encoding* GetEncoding_NEW(int codepage, System::Text::EncoderFallback* encoderFallback, System::Text::DecoderFallback* decoderFallback);
