...
namespace System::Text {
  ...
  class Encoding::DefaultDecoder : public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IObjectReference, public System::Text::Decoder {
    public:
