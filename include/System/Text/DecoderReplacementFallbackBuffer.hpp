...
namespace System::Text {
  ...
  check_size<sizeof(DecoderReplacementFallbackBuffer), 44 + sizeof(int) + ((44 + sizeof(int)) % 8 != 0 ? (8 - (44 + sizeof(int)) % 8) : 0)> __System_Text_DecoderReplacementFallbackBufferSizeCheck;
}
