...
namespace System::Text {
  ...
  check_size<sizeof(InternalDecoderBestFitFallbackBuffer), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __System_Text_InternalDecoderBestFitFallbackBufferSizeCheck;
}
