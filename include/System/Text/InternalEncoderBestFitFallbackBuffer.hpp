...
namespace System::Text {
  ...
  class InternalEncoderBestFitFallbackBuffer : public System::Text::EncoderFallbackBuffer {
    ...
    // Set instance field: private System.Char cBestFit
    void _set_cBestFit(::Il2CppChar value);
    // Get instance field: private System.Text.InternalEncoderBestFitFallback oFallback
    System::Text::InternalEncoderBestFitFallback* _get_oFallback();
    // Set instance field: private System.Text.InternalEncoderBestFitFallback oFallback
    void _set_oFallback(System::Text::InternalEncoderBestFitFallback* value);
