...
class CORDL_TYPE System__Text__RegularExpressions__MatchCollection__Enumerator : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~System__Text__RegularExpressions__MatchCollection__Enumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Text__RegularExpressions__MatchCollection__Enumerator", modifiers: " const&", def_value: None }]
constexpr System__Text__RegularExpressions__MatchCollection__Enumerator(System__Text__RegularExpressions__MatchCollection__Enumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Text__RegularExpressions__MatchCollection__Enumerator", modifiers: "&&", def_value: None }]
constexpr System__Text__RegularExpressions__MatchCollection__Enumerator(System__Text__RegularExpressions__MatchCollection__Enumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Text__RegularExpressions__MatchCollection__Enumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Text__RegularExpressions__MatchCollection__Enumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Text__RegularExpressions__MatchCollection__Enumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Text__RegularExpressions__MatchCollection__Enumerator& operator=(System__Text__RegularExpressions__MatchCollection__Enumerator&& o) noexcept = default;
  constexpr System__Text__RegularExpressions__MatchCollection__Enumerator& operator=(System__Text__RegularExpressions__MatchCollection__Enumerator const& o) noexcept = default;
...
public:
// Declarations
using Enumerator = System::Text::RegularExpressions::System__Text__RegularExpressions__MatchCollection__Enumerator;
...
NEED_NO_BOX(System::Text::RegularExpressions::System__Text__RegularExpressions__MatchCollection__Enumerator);
DEFINE_IL2CPP_ARG_TYPE(System::Text::RegularExpressions::System__Text__RegularExpressions__MatchCollection__Enumerator, "System.Text.RegularExpressions", "MatchCollection/Enumerator");
