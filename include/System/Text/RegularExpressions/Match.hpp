...
namespace System::Text::RegularExpressions {
  ...
  class Match : public System::Text::RegularExpressions::Group {
    ...
    // Offset: 0x12078C8
    static Match* New_ctor(System::Text::RegularExpressions::Regex* regex, int capcount, ::CsString* text, int begpos, int len, int startpos);
    ...
    // Offset: 0x1207A58
    void Reset(System::Text::RegularExpressions::Regex* regex, ::CsString* text, int textbeg, int textend, int textstart);
