...
namespace System::Text::RegularExpressions {
  ...
  class RegexRunner : public ::CsObject {
    public:
    ...
    // Offset: 0x14E6474
    System::Text::RegularExpressions::Match* Scan(System::Text::RegularExpressions::Regex* regex, ::CsString* text, int textbeg, int textend, int textstart, int prevlen, bool quick, System::TimeSpan timeout);
