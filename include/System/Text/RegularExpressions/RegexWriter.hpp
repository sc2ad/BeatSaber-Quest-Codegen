...
namespace System::Text::RegularExpressions {
  ...
  class RegexWriter : public ::CsObject {
    public:
    ...
    // Offset: 0x30
    System::Collections::Generic::Dictionary_2<::CsString*, int>* stringhash;
    // System.Collections.Generic.List`1<System.String> _stringtable
    // Offset: 0x38
    System::Collections::Generic::List_1<::CsString*>* stringtable;
    ...
    // Offset: 0x14E7C30
    int StringCode(::CsString* str);
    // System.ArgumentException MakeException(System.String message)
    // Offset: 0x14E7D3C
    System::ArgumentException* MakeException(::CsString* message);
