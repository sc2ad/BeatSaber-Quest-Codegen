...
namespace System::Text::RegularExpressions {
  ...
  class RegexCode : public ::CsObject {
    public:
    // System.Int32[] _codes
    // Offset: 0x10
    ::Array<int>* codes;
    ...
    // Offset: 0x1212180
    static RegexCode* New_ctor(::Array<int>* codes, System::Collections::Generic::List_1<::CsString*>* stringlist, int trackcount, System::Collections::Hashtable* caps, int capsize, System::Text::RegularExpressions::RegexBoyerMoore* bmPrefix, System::Text::RegularExpressions::RegexPrefix* fcPrefix, int anchors, bool rightToLeft);
