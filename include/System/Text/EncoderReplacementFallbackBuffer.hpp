...
namespace System::Text {
  ...
  check_size<sizeof(EncoderReplacementFallbackBuffer), 60 + sizeof(int) + ((60 + sizeof(int)) % 8 != 0 ? (8 - (60 + sizeof(int)) % 8) : 0)> __System_Text_EncoderReplacementFallbackBufferSizeCheck;
}
