...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C93988
  class UnhandledExceptionEventHandler : public System::MulticastDelegate {
    ...
    // Offset: 0x20D98CC
    void Invoke_NEW(::Il2CppObject* sender, System::UnhandledExceptionEventArgs* e);
    ...
    // Offset: 0x20D9CB4
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppObject* sender, System::UnhandledExceptionEventArgs* e, System::AsyncCallback* callback, ::Il2CppObject* object);
