...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: E5CC74
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::MulticastDelegate::*)(::ArrayWrapper<System::Delegate*>, ::ArrayWrapper<System::Delegate*>)>(&System::MulticastDelegate::LastIndexOf)> {
  static const MethodInfo* get() {
    static auto* haystack = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "Delegate")), 1)->byval_arg;
    static auto* needle = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "Delegate")), 1)->byval_arg;
