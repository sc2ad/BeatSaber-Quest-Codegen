...
namespace System {
  ...
  class Tuple_2 : public ::Il2CppObject/*, public System::Collections::IStructuralEquatable, public System::Collections::IStructuralComparable, public System::IComparable, public System::ITupleInternal*/ {
    ...
    // Offset: 0xFFFFFFFF
    T1 get_Item1() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("get_Item1");
    ...
    // Offset: 0xFFFFFFFF
    T2 get_Item2() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("get_Item2");
    ...
    static Tuple_2<T1, T2>* New_ctor(T1 item1, T2 item2) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext(".ctor");
    ...
    bool Equals(::Il2CppObject* obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("Equals");
    ...
    bool System_Collections_IStructuralEquatable_Equals(::Il2CppObject* other, System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("System.Collections.IStructuralEquatable.Equals");
    ...
    int System_IComparable_CompareTo(::Il2CppObject* obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("System.IComparable.CompareTo");
    ...
    int System_Collections_IStructuralComparable_CompareTo(::Il2CppObject* other, System::Collections::IComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("System.Collections.IStructuralComparable.CompareTo");
    ...
    int GetHashCode() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("GetHashCode");
    ...
    int System_Collections_IStructuralEquatable_GetHashCode(System::Collections::IEqualityComparer* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("System.Collections.IStructuralEquatable.GetHashCode");
    ...
    ::Il2CppString* ToString() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("ToString");
    ...
    ::Il2CppString* System_ITupleInternal_ToString(System::Text::StringBuilder* sb) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("Tuple_2").WithContext("System.ITupleInternal.ToString");
  ...
  // Could not write size check! Type: System.Tuple`2 is generic!
}
