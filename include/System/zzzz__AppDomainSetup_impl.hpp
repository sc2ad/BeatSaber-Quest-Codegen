...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::AppDomainSetup::*)()>(&System::AppDomainSetup::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2487e8c;
...
constexpr ::StringW System::AppDomainSetup::__get_license_file() const {
...
constexpr ::StringW System::AppDomainSetup::__get_private_bin_path() const {
...
constexpr ::StringW System::AppDomainSetup::__get_private_bin_path_probe() const {
...
constexpr ::StringW System::AppDomainSetup::__get_shadow_copy_directories() const {
...
constexpr ::StringW System::AppDomainSetup::__get_shadow_copy_files() const {
...
constexpr bool System::AppDomainSetup::__get_publisher_policy() const {
...
constexpr bool System::AppDomainSetup::__get_path_changed() const {
...
constexpr int32_t System::AppDomainSetup::__get_loader_optimization() const {
...
constexpr bool System::AppDomainSetup::__get_disallow_binding_redirects() const {
...
constexpr bool System::AppDomainSetup::__get_disallow_code_downloads() const {
return ::cordl_internals::getInstanceField<bool, 0x69>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set__activationArguments(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::AppDomainSetup::__get__activationArguments() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x70>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_domain_initializer(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::AppDomainSetup::__get_domain_initializer() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x78>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_application_trust(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::AppDomainSetup::__get_application_trust() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_domain_initializer_args(::ArrayW<::StringW> value)  {
...
constexpr ::ArrayW<::StringW> System::AppDomainSetup::__get_domain_initializer_args() const {
...
constexpr bool System::AppDomainSetup::__get_disallow_appbase_probe() const {
return ::cordl_internals::getInstanceField<bool, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_configuration_bytes(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> System::AppDomainSetup::__get_configuration_bytes() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_serialized_non_primitives(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> System::AppDomainSetup::__get_serialized_non_primitives() const {
...
constexpr ::StringW System::AppDomainSetup::__get_manager_assembly() const {
...
constexpr ::StringW System::AppDomainSetup::__get_manager_type() const {
return ::cordl_internals::getInstanceField<::StringW, 0xb0>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::AppDomainSetup::__set_partial_visible_assemblies(::ArrayW<::StringW> value)  {
...
constexpr ::ArrayW<::StringW> System::AppDomainSetup::__get_partial_visible_assemblies() const {
