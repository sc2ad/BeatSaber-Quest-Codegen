...
struct ______System__Decimal__DecCalc__RoundingMode;
}
namespace GlobalNamespace {
struct ______System__Decimal__DecCalc__Buf24;
}
namespace GlobalNamespace {
struct ______System__Decimal__DecCalc__PowerOvfl;
}
namespace System {
struct Decimal;
}
namespace System {
struct ____System__Decimal__DecCalc;
}
// Type: ::RoundingMode
namespace GlobalNamespace {
// Is value type: true
...
struct CORDL_TYPE ______System__Decimal__DecCalc__RoundingMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ______System__Decimal__DecCalc__RoundingMode(int32_t value__) noexcept;


                    constexpr ______System__Decimal__DecCalc__RoundingMode(______System__Decimal__DecCalc__RoundingMode const&) = default;
                    constexpr ______System__Decimal__DecCalc__RoundingMode(______System__Decimal__DecCalc__RoundingMode&&) = default;
                    constexpr ______System__Decimal__DecCalc__RoundingMode& operator=(______System__Decimal__DecCalc__RoundingMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______System__Decimal__DecCalc__RoundingMode& operator=(______System__Decimal__DecCalc__RoundingMode&& o) noexcept {
...
constexpr explicit ______System__Decimal__DecCalc__RoundingMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ________System__Decimal__DecCalc__RoundingMode_Unwrapped : int32_t {
__ToEven = 0,
__AwayFromZero = 1,
__Truncate = 2,
__Floor = 3,
...
constexpr operator ________System__Decimal__DecCalc__RoundingMode_Unwrapped () const noexcept {
return std::bit_cast<________System__Decimal__DecCalc__RoundingMode_Unwrapped>(__instance);
}
...
static ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode const ToEven;

/// @brief Field AwayFromZero offset 0
static ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode const AwayFromZero;

/// @brief Field Truncate offset 0
static ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode const Truncate;

/// @brief Field Floor offset 0
static ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode const Floor;

/// @brief Field Ceiling offset 0
static ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode const Ceiling;
...
struct CORDL_TYPE ______System__Decimal__DecCalc__PowerOvfl : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ______System__Decimal__DecCalc__PowerOvfl(uint32_t Hi, uint64_t MidLo) noexcept;


                    constexpr ______System__Decimal__DecCalc__PowerOvfl(______System__Decimal__DecCalc__PowerOvfl const&) = default;
                    constexpr ______System__Decimal__DecCalc__PowerOvfl(______System__Decimal__DecCalc__PowerOvfl&&) = default;
                    constexpr ______System__Decimal__DecCalc__PowerOvfl& operator=(______System__Decimal__DecCalc__PowerOvfl const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______System__Decimal__DecCalc__PowerOvfl& operator=(______System__Decimal__DecCalc__PowerOvfl&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ______System__Decimal__DecCalc__PowerOvfl(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ______System__Decimal__DecCalc__Buf24 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ______System__Decimal__DecCalc__Buf24(uint32_t U0, uint32_t U1, uint32_t U2, uint32_t U3, uint32_t U4, uint32_t U5, uint64_t ulo64LE, uint64_t umid64LE, uint64_t uhigh64LE) noexcept;


                    constexpr ______System__Decimal__DecCalc__Buf24(______System__Decimal__DecCalc__Buf24 const&) = default;
                    constexpr ______System__Decimal__DecCalc__Buf24(______System__Decimal__DecCalc__Buf24&&) = default;
                    constexpr ______System__Decimal__DecCalc__Buf24& operator=(______System__Decimal__DecCalc__Buf24 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______System__Decimal__DecCalc__Buf24& operator=(______System__Decimal__DecCalc__Buf24&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ______System__Decimal__DecCalc__Buf24(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____System__Decimal__DecCalc : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
using Buf24 = ::GlobalNamespace::______System__Decimal__DecCalc__Buf24;

using PowerOvfl = ::GlobalNamespace::______System__Decimal__DecCalc__PowerOvfl;

using RoundingMode = ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode;
...
constexpr ____System__Decimal__DecCalc(uint32_t uflags, uint32_t uhi, uint32_t ulo, uint32_t umid, uint64_t ulomidLE) noexcept;


                    constexpr ____System__Decimal__DecCalc(____System__Decimal__DecCalc const&) = default;
                    constexpr ____System__Decimal__DecCalc(____System__Decimal__DecCalc&&) = default;
                    constexpr ____System__Decimal__DecCalc& operator=(____System__Decimal__DecCalc const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Decimal__DecCalc& operator=(____System__Decimal__DecCalc&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Decimal__DecCalc(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
static ::ArrayW<::GlobalNamespace::______System__Decimal__DecCalc__PowerOvfl> __declspec(property(get=__get_PowerOvflValues, put=__set_PowerOvflValues))  PowerOvflValues;

static void __set_PowerOvflValues(::ArrayW<::GlobalNamespace::______System__Decimal__DecCalc__PowerOvfl> value) ;

static ::ArrayW<::GlobalNamespace::______System__Decimal__DecCalc__PowerOvfl> __get_PowerOvflValues() ;
...
static void UInt64x64To128(uint64_t a, uint64_t b, ByRef<::System::____System__Decimal__DecCalc> result) ;
...
static void DecAddSub(ByRef<::System::____System__Decimal__DecCalc> d1, ByRef<::System::____System__Decimal__DecCalc> d2, bool sign) ;
...
static void VarDecMul(ByRef<::System::____System__Decimal__DecCalc> d1, ByRef<::System::____System__Decimal__DecCalc> d2) ;

/// @brief Method VarDecFromR4 addr 0x249c7e0 size 0x404 virtual false final false
static void VarDecFromR4(float_t input, ByRef<::System::____System__Decimal__DecCalc> result) ;

/// @brief Method VarDecFromR8 addr 0x249cc6c size 0x40c virtual false final false
static void VarDecFromR8(double_t input, ByRef<::System::____System__Decimal__DecCalc> result) ;
...
static void InternalRound(ByRef<::System::____System__Decimal__DecCalc> d, uint32_t scale, ::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode mode) ;

/// @brief Method DecDivMod1E9 addr 0x249c688 size 0x68 virtual false final false
static uint32_t DecDivMod1E9(ByRef<::System::____System__Decimal__DecCalc> value) ;
...
public:
// Declarations
using DecCalc = ::System::____System__Decimal__DecCalc;
...
static ByRef<::System::____System__Decimal__DecCalc> AsMutable(ByRef<::System::Decimal> d) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______System__Decimal__DecCalc__RoundingMode, "System", "Decimal/DecCalc/RoundingMode");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______System__Decimal__DecCalc__Buf24, "System", "Decimal/DecCalc/Buf24");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______System__Decimal__DecCalc__PowerOvfl, "System", "Decimal/DecCalc/PowerOvfl");
DEFINE_IL2CPP_ARG_TYPE(::System::Decimal, "System", "Decimal");
DEFINE_IL2CPP_ARG_TYPE(::System::____System__Decimal__DecCalc, "System", "Decimal/DecCalc");
