...
namespace System {
template<::cordl_internals::is_or_is_backed_by<int32_t> T1,::cordl_internals::il2cpp_reference_type T2,::cordl_internals::is_or_is_backed_by<int32_t> T3>
struct ValueTuple_3<T1,T2,T3>;
}
namespace System {
...
namespace System {
template<::cordl_internals::is_or_is_backed_by<int32_t> T1,::cordl_internals::is_or_is_backed_by<int32_t> T2,::cordl_internals::is_or_is_backed_by<int32_t> T3>
struct ValueTuple_3<T1,T2,T3>;
}
namespace System {
