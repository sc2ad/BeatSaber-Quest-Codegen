...
namespace System {
  ...
  class Func_7 : public System::MulticastDelegate {
    ...
    static Func_7<TResult, T1, T2, T3, T4, T5, T6>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (Func_7<TResult, T1, T2, T3, T4, T5, T6>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Func_7<TResult, T1, T2, T3, T4, T5, T6>*>::get(), object, method)));
    }
