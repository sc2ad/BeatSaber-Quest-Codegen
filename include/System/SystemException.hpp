...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D377E8
  class SystemException : public System::Exception {
    ...
    static SystemException* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("SystemException").WithContext(".ctor");
