...
namespace System {
  ...
  class Tuple : public ::Il2CppObject {
    ...
    static System::Tuple_2<T1, T2>* Create(T1 item1, T2 item2) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Tuple_2<T1, T2>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, item1, item2)));
    }
    ...
    static System::Tuple_3<T1, T2, T3>* Create(T1 item1, T2 item2, T3 item3) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Tuple_3<T1, T2, T3>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, item1, item2, item3)));
    }
    ...
    static System::Tuple_4<T1, T2, T3, T4>* Create(T1 item1, T2 item2, T3 item3, T4 item4) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Tuple_4<T1, T2, T3, T4>*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, item1, item2, item3, item4)));
    }
