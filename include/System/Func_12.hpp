...
namespace System {
  ...
  class Func_12 : public System::MulticastDelegate {
    ...
    static Func_12<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (Func_12<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Func_12<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>*>::get(), object, method)));
    }
