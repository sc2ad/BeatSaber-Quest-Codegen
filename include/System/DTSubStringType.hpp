...
namespace System {
  // Forward declaring type: DTSubStringType
...
namespace System {
  ...
  #pragma pack(pop)
  static check_size<sizeof(DTSubStringType), 0 + sizeof(int)> __System_DTSubStringTypeSizeCheck;
  static_assert(sizeof(DTSubStringType) == 0x4);
}
