...
namespace System {
  ...
  check_size<sizeof(CultureAwareComparer), 28 + sizeof(System::Globalization::CompareOptions) + ((28 + sizeof(System::Globalization::CompareOptions)) % 8 != 0 ? (8 - (28 + sizeof(System::Globalization::CompareOptions)) % 8) : 0)> __System_CultureAwareComparerSizeCheck;
}
