...
struct ______System__Number__NumberBuffer__DigitsAndNullTerminator;
}
namespace System {
struct ____System__Number__NumberBuffer;
}
...
struct CORDL_TYPE ______System__Number__NumberBuffer__DigitsAndNullTerminator : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations

                    constexpr ______System__Number__NumberBuffer__DigitsAndNullTerminator(______System__Number__NumberBuffer__DigitsAndNullTerminator const&) = default;
                    constexpr ______System__Number__NumberBuffer__DigitsAndNullTerminator(______System__Number__NumberBuffer__DigitsAndNullTerminator&&) = default;
                    constexpr ______System__Number__NumberBuffer__DigitsAndNullTerminator& operator=(______System__Number__NumberBuffer__DigitsAndNullTerminator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ______System__Number__NumberBuffer__DigitsAndNullTerminator& operator=(______System__Number__NumberBuffer__DigitsAndNullTerminator&& o) noexcept {
...
constexpr explicit ______System__Number__NumberBuffer__DigitsAndNullTerminator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____System__Number__NumberBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
using DigitsAndNullTerminator = ::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator;
...
constexpr ____System__Number__NumberBuffer(int32_t precision, int32_t scale, int32_t _sign, ::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator _digits, void* _allDigits) noexcept;


                    constexpr ____System__Number__NumberBuffer(____System__Number__NumberBuffer const&) = default;
                    constexpr ____System__Number__NumberBuffer(____System__Number__NumberBuffer&&) = default;
                    constexpr ____System__Number__NumberBuffer& operator=(____System__Number__NumberBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Number__NumberBuffer& operator=(____System__Number__NumberBuffer&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Number__NumberBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr int32_t __get__sign() const;
 ...
 ::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator __declspec(property(get=__get__digits, put=__set__digits))  _digits;

constexpr void __set__digits(::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator value) ;

constexpr ::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator __get__digits() const;
...
public:
// Declarations
using NumberBuffer = ::System::____System__Number__NumberBuffer;
...
static void DecimalToNumber(::System::Decimal value, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
static void Int32ToNumber(int32_t value, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
static void UInt32ToNumber(uint32_t value, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
static void Int64ToNumber(int64_t input, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
static void UInt64ToNumber(uint64_t value, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
static void NumberToString(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, char16_t format, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info, bool isDecimal) ;

/// @brief Method NumberToStringFormat addr 0x244380c size 0x1118 virtual false final false
static void NumberToStringFormat(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, ::System::ReadOnlySpan_1<char16_t> format, ::System::Globalization::NumberFormatInfo info) ;

/// @brief Method FormatCurrency addr 0x244857c size 0x268 virtual false final false
static void FormatCurrency(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info) ;

/// @brief Method FormatFixed addr 0x24487e4 size 0x540 virtual false final false
static void FormatFixed(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info, ::ArrayW<int32_t> groupDigits, ::StringW sDecimal, ::StringW sGroup) ;

/// @brief Method FormatNumber addr 0x2448d24 size 0x254 virtual false final false
static void FormatNumber(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info) ;

/// @brief Method FormatScientific addr 0x2448f78 size 0x258 virtual false final false
static void FormatScientific(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info, char16_t expChar) ;
...
static void FormatGeneral(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info, char16_t expChar, bool bSuppressScientific) ;

/// @brief Method FormatPercent addr 0x2449588 size 0x268 virtual false final false
static void FormatPercent(ByRef<::System::Text::ValueStringBuilder> sb, ByRef<::System::____System__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, ::System::Globalization::NumberFormatInfo info) ;

/// @brief Method RoundNumber addr 0x244847c size 0x100 virtual false final false
static void RoundNumber(ByRef<::System::____System__Number__NumberBuffer> number, int32_t pos) ;
...
static bool NumberToInt32(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<int32_t> value) ;

/// @brief Method NumberToInt64 addr 0x2449c88 size 0xb4 virtual false final false
static bool NumberToInt64(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<int64_t> value) ;

/// @brief Method NumberToUInt32 addr 0x2449d3c size 0xb0 virtual false final false
static bool NumberToUInt32(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<uint32_t> value) ;

/// @brief Method NumberToUInt64 addr 0x2449dec size 0xb0 virtual false final false
static bool NumberToUInt64(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<uint64_t> value) ;
...
static bool ParseNumber(ByRef<void*> str, void* strEnd, ::System::Globalization::NumberStyles styles, ByRef<::System::____System__Number__NumberBuffer> number, ::System::Globalization::NumberFormatInfo info, bool parseDecimal) ;
...
static bool NumberBufferToDecimal(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<::System::Decimal> value) ;
...
static void StringToNumber(::System::ReadOnlySpan_1<char16_t> value, ::System::Globalization::NumberStyles styles, ByRef<::System::____System__Number__NumberBuffer> number, ::System::Globalization::NumberFormatInfo info, bool parseDecimal) ;

/// @brief Method TryStringToNumber addr 0x244d0c0 size 0x130 virtual false final false
static bool TryStringToNumber(::System::ReadOnlySpan_1<char16_t> value, ::System::Globalization::NumberStyles styles, ByRef<::System::____System__Number__NumberBuffer> number, ::System::Globalization::NumberFormatInfo info, bool parseDecimal) ;
...
static bool NumberBufferToDouble(ByRef<::System::____System__Number__NumberBuffer> number, ByRef<double_t> value) ;
...
static double_t NumberToDouble(ByRef<::System::____System__Number__NumberBuffer> number) ;

/// @brief Method DoubleToNumber addr 0x2445218 size 0x47c virtual false final false
static void DoubleToNumber(double_t value, int32_t precision, ByRef<::System::____System__Number__NumberBuffer> number) ;
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______System__Number__NumberBuffer__DigitsAndNullTerminator, "System", "Number/NumberBuffer/DigitsAndNullTerminator");
DEFINE_IL2CPP_ARG_TYPE(::System::____System__Number__NumberBuffer, "System", "Number/NumberBuffer");
