...
namespace System {
  ...
  class Action_8 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static Action_8<T1, T2, T3, T4, T5, T6, T7, T8>* New_ctor(::CsObject* object, System::IntPtr method) {
      return (Action_8<T1, T2, T3, T4, T5, T6, T7, T8>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Action_8<T1, T2, T3, T4, T5, T6, T7, T8>*>::get(), object, method)));
    }
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, System::AsyncCallback* callback, ::CsObject* object) {
