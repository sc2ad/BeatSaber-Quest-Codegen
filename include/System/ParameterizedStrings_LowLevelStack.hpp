...
namespace System {
  ...
  check_size<sizeof(ParameterizedStrings::LowLevelStack), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __System_ParameterizedStrings_LowLevelStackSizeCheck;
}
