...
namespace System {
  ...
  class Converter_2 : public System::MulticastDelegate {
    ...
    static Converter_2<TOutput, TInput>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (Converter_2<TOutput, TInput>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Converter_2<TOutput, TInput>*>::get(), object, method)));
    }
