...
namespace System {
  ...
  class DelegateSerializationHolder : public ::CsObject, public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IObjectReference {
    public:
