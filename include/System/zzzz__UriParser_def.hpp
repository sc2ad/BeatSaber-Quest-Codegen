...
namespace System {
struct ____System__UriParser__UriQuirksVersion;
}
namespace System {
class UriParser;
}
namespace System {
class ____System__UriParser__BuiltInUriParser;
}
...
struct CORDL_TYPE ____System__UriParser__UriQuirksVersion : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__UriParser__UriQuirksVersion(int32_t value__) noexcept;


                    constexpr ____System__UriParser__UriQuirksVersion(____System__UriParser__UriQuirksVersion const&) = default;
                    constexpr ____System__UriParser__UriQuirksVersion(____System__UriParser__UriQuirksVersion&&) = default;
                    constexpr ____System__UriParser__UriQuirksVersion& operator=(____System__UriParser__UriQuirksVersion const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__UriParser__UriQuirksVersion& operator=(____System__UriParser__UriQuirksVersion&& o) noexcept {
...
constexpr explicit ____System__UriParser__UriQuirksVersion(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__UriParser__UriQuirksVersion_Unwrapped : int32_t {
__V2 = 2,
__V3 = 3,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______System__UriParser__UriQuirksVersion_Unwrapped () const noexcept {
return std::bit_cast<______System__UriParser__UriQuirksVersion_Unwrapped>(__instance);
}
...
static ::System::____System__UriParser__UriQuirksVersion const V2;

/// @brief Field V3 offset 0
static ::System::____System__UriParser__UriQuirksVersion const V3;
...
public:
// Declarations
using BuiltInUriParser = ::System::____System__UriParser__BuiltInUriParser;

using UriQuirksVersion = ::System::____System__UriParser__UriQuirksVersion;
...
static ::System::____System__UriParser__UriQuirksVersion __declspec(property(get=__get_s_QuirksVersion, put=__set_s_QuirksVersion))  s_QuirksVersion;

static void __set_s_QuirksVersion(::System::____System__UriParser__UriQuirksVersion value) ;

static ::System::____System__UriParser__UriQuirksVersion __get_s_QuirksVersion() ;
...
class CORDL_TYPE ____System__UriParser__BuiltInUriParser : public ::System::UriParser {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____System__UriParser__BuiltInUriParser() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__UriParser__BuiltInUriParser", modifiers: " const&", def_value: None }]
constexpr ____System__UriParser__BuiltInUriParser(____System__UriParser__BuiltInUriParser const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__UriParser__BuiltInUriParser", modifiers: "&&", def_value: None }]
constexpr ____System__UriParser__BuiltInUriParser(____System__UriParser__BuiltInUriParser&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__UriParser__BuiltInUriParser(void* ptr) noexcept : ::System::UriParser(ptr) {
}


  constexpr ____System__UriParser__BuiltInUriParser& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__UriParser__BuiltInUriParser& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__UriParser__BuiltInUriParser& operator=(____System__UriParser__BuiltInUriParser&& o) noexcept = default;
  constexpr ____System__UriParser__BuiltInUriParser& operator=(____System__UriParser__BuiltInUriParser const& o) noexcept = default;
...
explicit ____System__UriParser__BuiltInUriParser(::StringW lwrCaseScheme, int32_t defaultPort, ::System::UriSyntaxFlags syntaxFlags) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::____System__UriParser__UriQuirksVersion, "System", "UriParser/UriQuirksVersion");
NEED_NO_BOX(::System::UriParser);
DEFINE_IL2CPP_ARG_TYPE(::System::UriParser, "System", "UriParser");
NEED_NO_BOX(::System::____System__UriParser__BuiltInUriParser);
DEFINE_IL2CPP_ARG_TYPE(::System::____System__UriParser__BuiltInUriParser, "System", "UriParser/BuiltInUriParser");
