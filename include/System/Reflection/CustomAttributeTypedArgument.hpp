...
namespace System::Reflection {
  ...
  check_size<sizeof(CustomAttributeTypedArgument), 8 + sizeof(void*) + ((8 + sizeof(void*)) % 8 != 0 ? (8 - (8 + sizeof(void*)) % 8) : 0)> __System_Reflection_CustomAttributeTypedArgumentSizeCheck;
}
