...
namespace System::Reflection {
  ...
  class AssemblyName : public ::CsObject, public System::ICloneable, public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IDeserializationCallback, public System::Runtime::InteropServices::_AssemblyName {
    public:
    ...
    // Offset: 0x134CCFC
    static AssemblyName* New_ctor(::CsString* assemblyName);
    ...
    // Offset: 0x134C394
    void FillName(Mono::MonoAssemblyName* native, ::CsString* codeBase, bool addVersion, bool addPublickey, bool defaultToken, bool assemblyRef);
