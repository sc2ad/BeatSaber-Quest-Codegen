...
class CORDL_TYPE ____System__Reflection__Assembly__ResolveEventHolder : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__Reflection__Assembly__ResolveEventHolder() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Reflection__Assembly__ResolveEventHolder", modifiers: " const&", def_value: None }]
constexpr ____System__Reflection__Assembly__ResolveEventHolder(____System__Reflection__Assembly__ResolveEventHolder const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Reflection__Assembly__ResolveEventHolder", modifiers: "&&", def_value: None }]
constexpr ____System__Reflection__Assembly__ResolveEventHolder(____System__Reflection__Assembly__ResolveEventHolder&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Reflection__Assembly__ResolveEventHolder(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Reflection__Assembly__ResolveEventHolder& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Reflection__Assembly__ResolveEventHolder& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Reflection__Assembly__ResolveEventHolder& operator=(____System__Reflection__Assembly__ResolveEventHolder&& o) noexcept = default;
  constexpr ____System__Reflection__Assembly__ResolveEventHolder& operator=(____System__Reflection__Assembly__ResolveEventHolder const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____System__Reflection__Assembly__ResolveEventHolder() ;
...
public:
// Declarations
using ResolveEventHolder = ::System::Reflection::____System__Reflection__Assembly__ResolveEventHolder;
...
NEED_NO_BOX(::System::Reflection::____System__Reflection__Assembly__ResolveEventHolder);
DEFINE_IL2CPP_ARG_TYPE(::System::Reflection::____System__Reflection__Assembly__ResolveEventHolder, "System.Reflection", "Assembly/ResolveEventHolder");
