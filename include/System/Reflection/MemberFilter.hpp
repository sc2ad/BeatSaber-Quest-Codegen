...
namespace System::Reflection {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C944DC
  class MemberFilter : public System::MulticastDelegate {
    ...
    // Offset: 0x1AC509C
    bool Invoke_NEW(System::Reflection::MemberInfo* m, ::Il2CppObject* filterCriteria);
    ...
    // Offset: 0x1AC5490
    System::IAsyncResult* BeginInvoke_NEW(System::Reflection::MemberInfo* m, ::Il2CppObject* filterCriteria, System::AsyncCallback* callback, ::Il2CppObject* object);
