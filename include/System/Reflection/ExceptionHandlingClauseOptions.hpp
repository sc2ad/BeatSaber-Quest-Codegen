...
namespace System::Reflection {
  ...
  check_size<sizeof(ExceptionHandlingClauseOptions), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Reflection_ExceptionHandlingClauseOptionsSizeCheck;
}
