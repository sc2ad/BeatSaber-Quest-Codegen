...
namespace System::Reflection {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D38E24
  class ExceptionHandlingClause : public ::Il2CppObject {
    ...
    static ExceptionHandlingClause* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Reflection").WithContext("ExceptionHandlingClause").WithContext(".ctor");
