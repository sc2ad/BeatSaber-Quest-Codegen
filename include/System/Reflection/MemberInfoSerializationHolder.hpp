...
namespace System::Reflection {
  ...
  class MemberInfoSerializationHolder : public ::CsObject, public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IObjectReference {
    public:
    ...
    // Offset: 0x20
    ::CsString* m_signature;
    // private System.String m_signature2
    // Offset: 0x28
    ::CsString* m_signature2;
    ...
    // Offset: 0x13670D0
    static void GetSerializationInfo(System::Runtime::Serialization::SerializationInfo* info, ::CsString* name, System::RuntimeType* reflectedClass, ::CsString* signature, System::Reflection::MemberTypes type);
    ...
    // Offset: 0x13670E0
    static void GetSerializationInfo(System::Runtime::Serialization::SerializationInfo* info, ::CsString* name, System::RuntimeType* reflectedClass, ::CsString* signature, ::CsString* signature2, System::Reflection::MemberTypes type, ::Array<System::Type*>* genericArguments);
