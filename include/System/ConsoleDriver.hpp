...
namespace System {
  ...
  class ConsoleDriver : public ::CsObject {
    public:
    ...
    // Offset: 0x10BFF98
    static System::IConsoleDriver* CreateTermInfoDriver(::CsString* term);
    ...
    // Offset: 0x10C0004
    static bool TtySetup(::CsString* keypadXmit, ::CsString* teardown, ::Array<uint8_t>*& control_characters, int*& address);
