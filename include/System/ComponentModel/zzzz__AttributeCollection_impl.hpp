...
constexpr void System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry::__set_type(System::Type value)  {
::cordl_internals::setInstanceField<System::Type, 0x0>(this->__instance, std::forward<System::Type>(value));
}
constexpr System::Type System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry::__get_type() const {
return ::cordl_internals::getInstanceField<System::Type, 0x0>(this->__instance);
}
constexpr void System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry::__set_index(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x8>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry::__get_index() const {
...
constexpr void System::ComponentModel::AttributeCollection::__set__foundAttributeTypes(::ArrayW<System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry> value)  {
::cordl_internals::setInstanceField<::ArrayW<System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry>>(value));
}
constexpr ::ArrayW<System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry> System::ComponentModel::AttributeCollection::__get__foundAttributeTypes() const {
return ::cordl_internals::getInstanceField<::ArrayW<System::ComponentModel::System__ComponentModel__AttributeCollection__AttributeEntry>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
