...
return ::cordl_internals::RunMethodRethrow<::bs_hook::Il2CppWrapperType, false>(const_cast<void*>(instance), ___internal_method, context, culture, value, destinationType);
 ...
 System::ComponentModel::GuidConverter System::ComponentModel::GuidConverter::New_ctor()  {
System::ComponentModel::GuidConverter o{THROW_UNLESS(::il2cpp_utils::New<System::ComponentModel::GuidConverter>())};
return o;
}
