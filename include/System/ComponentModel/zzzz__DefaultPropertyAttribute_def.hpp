...
static System::ComponentModel::DefaultPropertyAttribute New_ctor(::StringW name) ;

/// @brief Method .ctor addr 0x277bc10 size 0x28 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_Name addr 0x277bc38 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method Equals addr 0x277bc40 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x277bcc0 size 0x8 virtual true final false
 int32_t GetHashCode() ;
