...
namespace System::ComponentModel {
class ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor;
}
...
class CORDL_TYPE ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor : public ::System::ComponentModel::____System__ComponentModel__TypeConverter__SimplePropertyDescriptor {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0xa0};

virtual ~____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor", modifiers: " const&", def_value: None }]
constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor(____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor", modifiers: "&&", def_value: None }]
constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor(____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor(void* ptr) noexcept : ::System::ComponentModel::____System__ComponentModel__TypeConverter__SimplePropertyDescriptor(ptr) {
}


  constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor& operator=(____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor&& o) noexcept = default;
  constexpr ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor& operator=(____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor const& o) noexcept = default;
...
explicit ____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor(::System::Type arrayType, ::System::Type elementType, int32_t index) ;
...
public:
// Declarations
using ArrayPropertyDescriptor = ::System::ComponentModel::____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor;
...
NEED_NO_BOX(::System::ComponentModel::____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor);
DEFINE_IL2CPP_ARG_TYPE(::System::ComponentModel::____System__ComponentModel__ArrayConverter__ArrayPropertyDescriptor, "System.ComponentModel", "ArrayConverter/ArrayPropertyDescriptor");
