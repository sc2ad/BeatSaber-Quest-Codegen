...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::ComponentModel::AddingNewEventHandler::*)(System::IAsyncResult)>(&System::ComponentModel::AddingNewEventHandler::EndInvoke)> {
 ...
 System::ComponentModel::AddingNewEventHandler System::ComponentModel::AddingNewEventHandler::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
System::ComponentModel::AddingNewEventHandler o{THROW_UNLESS(::il2cpp_utils::New<System::ComponentModel::AddingNewEventHandler>(object, method))};
return o;
}
