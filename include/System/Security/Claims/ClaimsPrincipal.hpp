...
namespace System::Security::Claims {
  ...
  class ClaimsPrincipal : public ::CsObject, public System::Security::Principal::IPrincipal {
    public:
    ...
    // Offset: 0x18
    ::CsString* m_serializedClaimsIdentities;
    ...
    // Offset: 0xDD35C0
    void DeserializeIdentities(::CsString* identities);
    // private System.String SerializeIdentities()
    // Offset: 0xDD2D68
    ::CsString* SerializeIdentities();
