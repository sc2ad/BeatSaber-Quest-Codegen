...
class CORDL_TYPE System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode", modifiers: " const&", def_value: None }]
constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode(System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode", modifiers: "&&", def_value: None }]
constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode(System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode& operator=(System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode&& o) noexcept = default;
  constexpr System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode& operator=(System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode const& o) noexcept = default;
...
public:
// Declarations
using ExceptionFromErrorCode = System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode;
...
// Fields
 ...
 System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode __declspec(property(get=__get_exception_from_error_code, put=__set_exception_from_error_code))  exception_from_error_code;

constexpr void __set_exception_from_error_code(System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode value) ;

constexpr System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode __get_exception_from_error_code() const;
...
NEED_NO_BOX(System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode);
DEFINE_IL2CPP_ARG_TYPE(System::Security::AccessControl::System__Security__AccessControl__NativeObjectSecurity__ExceptionFromErrorCode, "System.Security.AccessControl", "NativeObjectSecurity/ExceptionFromErrorCode");
