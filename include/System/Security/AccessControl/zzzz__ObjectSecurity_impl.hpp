...
// Ctor Parameters [CppParam { name: "securityDescriptor", ty: "::System::Security::AccessControl::CommonSecurityDescriptor", modifiers: "", def_value: None }]
 ::System::Security::AccessControl::ObjectSecurity::ObjectSecurity(::System::Security::AccessControl::CommonSecurityDescriptor securityDescriptor)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<ObjectSecurity>(securityDescriptor))) {}
...
// Ctor Parameters [CppParam { name: "isContainer", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isDS", ty: "bool", modifiers: "", def_value: None }]
 ::System::Security::AccessControl::ObjectSecurity::ObjectSecurity(bool isContainer, bool isDS)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<ObjectSecurity>(isContainer, isDS))) {}
