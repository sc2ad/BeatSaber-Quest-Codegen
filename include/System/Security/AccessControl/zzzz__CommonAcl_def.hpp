...
namespace System::Security::AccessControl {
template<typename T>
class ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1;
}
namespace System::Security::AccessControl {
class CommonAcl;
}
...
class ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1<T>;
}
...
// Declarations
template<typename T>
using RemoveAcesCallback_1 = ::System::Security::AccessControl::____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1<T>;
...
template<typename T>
 void RemoveAces(::System::Security::AccessControl::____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1<T> callback) ;
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3020)), TypeDefinitionIndex(TypeDefinitionIndex(2610))}
...
class CORDL_TYPE ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1<T> : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1", modifiers: " const&", def_value: None }]
constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1(____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1", modifiers: "&&", def_value: None }]
constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1(____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1& operator=(____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1&& o) noexcept = default;
  constexpr ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1& operator=(____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1 const& o) noexcept = default;
...
explicit ____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::System::Security::AccessControl::____System__Security__AccessControl__CommonAcl__RemoveAcesCallback_1, "System.Security.AccessControl", "CommonAcl/RemoveAcesCallback`1");
