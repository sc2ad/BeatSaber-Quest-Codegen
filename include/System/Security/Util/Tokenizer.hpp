...
namespace System::Security::Util {
  ...
  class Tokenizer : public ::Il2CppObject {
    ...
    check_size<sizeof(Tokenizer::TokenSource), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Security_Util_Tokenizer_TokenSourceSizeCheck;
  ...
  check_size<sizeof(Tokenizer), 104 + sizeof(void*) + ((104 + sizeof(void*)) % 8 != 0 ? (8 - (104 + sizeof(void*)) % 8) : 0)> __System_Security_Util_TokenizerSizeCheck;
}
