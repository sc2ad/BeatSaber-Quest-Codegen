...
namespace System::Security::Authentication::ExtendedProtection {
  ...
  check_size<sizeof(PolicyEnforcement), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Security_Authentication_ExtendedProtection_PolicyEnforcementSizeCheck;
}
