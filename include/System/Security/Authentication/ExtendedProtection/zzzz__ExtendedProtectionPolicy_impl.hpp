...
System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy o{THROW_UNLESS(::il2cpp_utils::New<System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy>(policyEnforcement))};
return o;
}
...
System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy o{THROW_UNLESS(::il2cpp_utils::New<System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy>(info, context))};
return o;
}
