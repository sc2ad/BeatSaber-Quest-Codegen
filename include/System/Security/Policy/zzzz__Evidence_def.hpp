...
namespace System::Security::Policy {
class ____System__Security__Policy__Evidence__EvidenceEnumerator;
}
...
class CORDL_TYPE ____System__Security__Policy__Evidence__EvidenceEnumerator : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____System__Security__Policy__Evidence__EvidenceEnumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Security__Policy__Evidence__EvidenceEnumerator", modifiers: " const&", def_value: None }]
constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator(____System__Security__Policy__Evidence__EvidenceEnumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Security__Policy__Evidence__EvidenceEnumerator", modifiers: "&&", def_value: None }]
constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator(____System__Security__Policy__Evidence__EvidenceEnumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Security__Policy__Evidence__EvidenceEnumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator& operator=(____System__Security__Policy__Evidence__EvidenceEnumerator&& o) noexcept = default;
  constexpr ____System__Security__Policy__Evidence__EvidenceEnumerator& operator=(____System__Security__Policy__Evidence__EvidenceEnumerator const& o) noexcept = default;
...
explicit ____System__Security__Policy__Evidence__EvidenceEnumerator(::System::Collections::IEnumerator hostenum, ::System::Collections::IEnumerator assemblyenum) ;
...
public:
// Declarations
using EvidenceEnumerator = ::System::Security::Policy::____System__Security__Policy__Evidence__EvidenceEnumerator;
...
NEED_NO_BOX(::System::Security::Policy::____System__Security__Policy__Evidence__EvidenceEnumerator);
DEFINE_IL2CPP_ARG_TYPE(::System::Security::Policy::____System__Security__Policy__Evidence__EvidenceEnumerator, "System.Security.Policy", "Evidence/EvidenceEnumerator");
