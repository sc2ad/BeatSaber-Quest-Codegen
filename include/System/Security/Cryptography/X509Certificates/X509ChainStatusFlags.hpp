...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ChainStatusFlags), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509ChainStatusFlagsSizeCheck;
}
