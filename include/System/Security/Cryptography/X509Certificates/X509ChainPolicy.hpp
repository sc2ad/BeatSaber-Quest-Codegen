...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ChainPolicy), 72 + sizeof(System::DateTime) + ((72 + sizeof(System::DateTime)) % 8 != 0 ? (8 - (72 + sizeof(System::DateTime)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509ChainPolicySizeCheck;
}
