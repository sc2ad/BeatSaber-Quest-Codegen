...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509CertificateImplMono), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509CertificateImplMonoSizeCheck;
}
