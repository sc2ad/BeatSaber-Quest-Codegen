...
namespace System::Security::Cryptography::X509Certificates {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C9645C
  // [MonoTODOAttribute] Offset: C9645C
  class X509Certificate : public ::Il2CppObject/*, public System::Runtime::Serialization::IDeserializationCallback, public System::Runtime::Serialization::ISerializable, public System::IDisposable*/ {
    ...
    // Offset: 0x1970284
    bool Equals_NEW(System::Security::Cryptography::X509Certificates::X509Certificate* other);
    // public System.Byte[] GetCertHash()
    // Offset: 0x197037C
    ::Array<uint8_t>* GetCertHash_NEW();
    // public System.String GetCertHashString()
    // Offset: 0x19703EC
    ::Il2CppString* GetCertHashString_NEW();
    ...
    // Offset: 0x19705DC
    ::Il2CppString* GetSerialNumberString_NEW();
    // public System.String ToString(System.Boolean fVerbose)
    // Offset: 0x197064C
    ::Il2CppString* ToString_NEW(bool fVerbose);
    ...
    // Offset: 0x1970A78
    void Import_NEW(::Il2CppString* fileName, ::Il2CppString* password, System::Security::Cryptography::X509Certificates::X509KeyStorageFlags keyStorageFlags);
