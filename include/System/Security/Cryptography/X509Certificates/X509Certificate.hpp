...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509Certificate), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509CertificateSizeCheck;
}
