...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509Certificate2), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509Certificate2SizeCheck;
}
