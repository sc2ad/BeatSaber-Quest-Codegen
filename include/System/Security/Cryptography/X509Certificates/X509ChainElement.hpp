...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ChainElement), 40 + sizeof(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags) + ((40 + sizeof(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags)) % 8 != 0 ? (8 - (40 + sizeof(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509ChainElementSizeCheck;
}
