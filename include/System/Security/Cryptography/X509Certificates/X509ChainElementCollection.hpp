...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ChainElementCollection), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __System_Security_Cryptography_X509Certificates_X509ChainElementCollectionSizeCheck;
}
