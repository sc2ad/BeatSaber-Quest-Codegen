...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ExtensionEnumerator), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509ExtensionEnumeratorSizeCheck;
}
