...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X509ChainImplMono), 128 + sizeof(void*) + ((128 + sizeof(void*)) % 8 != 0 ? (8 - (128 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_X509Certificates_X509ChainImplMonoSizeCheck;
}
