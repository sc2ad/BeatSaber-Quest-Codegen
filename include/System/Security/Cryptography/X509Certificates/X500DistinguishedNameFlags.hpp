...
namespace System::Security::Cryptography::X509Certificates {
  ...
  check_size<sizeof(X500DistinguishedNameFlags), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Security_Cryptography_X509Certificates_X500DistinguishedNameFlagsSizeCheck;
}
