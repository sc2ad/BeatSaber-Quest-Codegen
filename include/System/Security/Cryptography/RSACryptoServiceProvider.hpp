...
namespace System::Security::Cryptography {
  ...
  check_size<sizeof(RSACryptoServiceProvider), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_RSACryptoServiceProviderSizeCheck;
}
