...
System::Security::Cryptography::TripleDESCryptoServiceProvider o{THROW_UNLESS(::il2cpp_utils::New<System::Security::Cryptography::TripleDESCryptoServiceProvider>())};
return o;
}
