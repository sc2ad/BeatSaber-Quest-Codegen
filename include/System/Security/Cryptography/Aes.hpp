...
namespace System::Security::Cryptography {
  ...
  // [] Offset: FFFFFFFF
  // [TypeForwardedFromAttribute] Offset: D3A1E4
  class Aes : public System::Security::Cryptography::SymmetricAlgorithm {
    ...
    static Aes* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Security::Cryptography").WithContext("Aes").WithContext(".ctor");
