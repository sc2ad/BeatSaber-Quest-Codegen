...
/// @brief Method Initialize addr 0x22fc344 size 0x44 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x22fc388 size 0x4 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x22fc558 size 0x4 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method InitializeState addr 0x22fc284 size 0xc0 virtual false final false
 void InitializeState() ;

/// @brief Method _HashData addr 0x22fc38c size 0x1cc virtual false final false
 void _HashData(::ArrayW<uint8_t> partIn, int32_t ibStart, int32_t cbSize) ;

/// @brief Method _EndHash addr 0x22fc55c size 0x1a8 virtual false final false
 ::ArrayW<uint8_t> _EndHash() ;

/// @brief Method SHATransform addr 0x22fc704 size 0x56c virtual false final false
static void SHATransform(void* expandedBuffer, void* state, void* block) ;

/// @brief Method RotateRight addr 0x22fcdf4 size 0x8 virtual false final false
static uint32_t RotateRight(uint32_t x, int32_t n) ;

/// @brief Method Ch addr 0x22fcd74 size 0x10 virtual false final false
static uint32_t Ch(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method Maj addr 0x22fcde0 size 0x14 virtual false final false
static uint32_t Maj(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method sigma_0 addr 0x22fcdfc size 0x5c virtual false final false
static uint32_t sigma_0(uint32_t x) ;

/// @brief Method sigma_1 addr 0x22fce58 size 0x5c virtual false final false
static uint32_t sigma_1(uint32_t x) ;

/// @brief Method Sigma_0 addr 0x22fcd84 size 0x5c virtual false final false
static uint32_t Sigma_0(uint32_t x) ;

/// @brief Method Sigma_1 addr 0x22fcd18 size 0x5c virtual false final false
static uint32_t Sigma_1(uint32_t x) ;

/// @brief Method SHA256Expand addr 0x22fcc70 size 0xa8 virtual false final false
