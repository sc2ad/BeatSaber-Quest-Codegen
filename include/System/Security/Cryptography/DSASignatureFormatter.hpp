...
namespace System::Security::Cryptography {
  ...
  check_size<sizeof(DSASignatureFormatter), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_DSASignatureFormatterSizeCheck;
}
