...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Security::Cryptography::RSAPKCS1SHA1SignatureDescription::*)()>(&System::Security::Cryptography::RSAPKCS1SHA1SignatureDescription::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x22feec8;
...
System::Security::Cryptography::RSAPKCS1SHA1SignatureDescription o{THROW_UNLESS(::il2cpp_utils::New<System::Security::Cryptography::RSAPKCS1SHA1SignatureDescription>())};
return o;
}
