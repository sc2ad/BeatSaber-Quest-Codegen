...
namespace System::Security::Cryptography {
  ...
  check_size<sizeof(SHA1CryptoServiceProvider), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_SHA1CryptoServiceProviderSizeCheck;
}
