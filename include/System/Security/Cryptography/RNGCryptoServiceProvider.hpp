...
namespace System::Security::Cryptography {
  ...
  check_size<sizeof(RNGCryptoServiceProvider), 16 + sizeof(System::IntPtr) + 8 - (16 + sizeof(System::IntPtr)) % 8> __System_Security_Cryptography_RNGCryptoServiceProviderSizeCheck;
}
