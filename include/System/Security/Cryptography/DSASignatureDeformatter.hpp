...
namespace System::Security::Cryptography {
  ...
  check_size<sizeof(DSASignatureDeformatter), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Security_Cryptography_DSASignatureDeformatterSizeCheck;
}
