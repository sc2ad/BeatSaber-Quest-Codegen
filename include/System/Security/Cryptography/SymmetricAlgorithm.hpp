...
namespace System::Security::Cryptography {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96398
  class SymmetricAlgorithm : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    // Offset: 0x196D7A8
    int get_BlockSize_NEW();
    // public System.Void set_BlockSize(System.Int32 value)
    // Offset: 0x196D7B0
    void set_BlockSize_NEW(int value);
    ...
    // Offset: 0x196DD40
    ::Array<System::Security::Cryptography::KeySizes*>* get_LegalKeySizes_NEW();
