...
namespace System {
  ...
  class Func_8 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    TResult Invoke_NEW(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_8::Invoke_NEW");
    ...
    System::IAsyncResult* BeginInvoke_NEW(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, System::AsyncCallback* callback, ::Il2CppObject* object) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_8::BeginInvoke_NEW");
    ...
    TResult EndInvoke_NEW(System::IAsyncResult* result) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_8::EndInvoke_NEW");
