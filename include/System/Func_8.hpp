...
namespace System {
  ...
  class Func_8 : public System::MulticastDelegate {
    ...
    static Func_8<TResult, T1, T2, T3, T4, T5, T6, T7>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (Func_8<TResult, T1, T2, T3, T4, T5, T6, T7>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Func_8<TResult, T1, T2, T3, T4, T5, T6, T7>*>::get(), object, method)));
    }
