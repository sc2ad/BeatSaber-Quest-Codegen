...
namespace System {
  ...
  class Lazy_1 : public ::CsObject {
    ...
    class Boxed : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
    ...
    class LazyInternalExceptionHolder : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = Lazy_1<T>*;
    ...
    // Offset: 0xFFFFFFFF
    static ::CsObject* GetObjectFromMode(System::Threading::LazyThreadSafetyMode mode) {
      return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Lazy_1<T>*>::get(), "GetObjectFromMode", mode));
    }
