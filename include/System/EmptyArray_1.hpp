...
namespace System {
  ...
  class EmptyArray_1 : public ::Il2CppObject {
    ...
    static ::ArrayWrapper<T> _get_Value() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::EmptyArray_1::_get_Value");
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::ArrayWrapper<T>>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<EmptyArray_1<T>*>::get(), "Value"));
    }
    // Autogenerated static field setter
    // Set static field: static public readonly T[] Value
    static void _set_Value(::ArrayWrapper<T> value) {
