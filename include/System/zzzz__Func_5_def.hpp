...
namespace System {
template<::cordl_internals::il2cpp_reference_type T1,::cordl_internals::is_or_is_backed_by<int32_t> T2,::cordl_internals::il2cpp_reference_type T3,::cordl_internals::il2cpp_reference_type T4,::cordl_internals::il2cpp_reference_type TResult>
class Func_5<T1,T2,T3,T4,TResult>;
}
// Type: System::Func`5
// Type: System::Func`5
...
static System::Func_5<T1,System::IO::System__IO__Stream__ReadWriteParameters,T3,T4,TResult> New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
static System::Func_5<T1,T2,T3,T4,TResult> New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
