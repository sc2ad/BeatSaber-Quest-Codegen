...
namespace System {
  ...
  class WeakReference : public ::CsObject, public System::Runtime::Serialization::ISerializable {
    public:
    ...
    // Offset: 0x1788454
    void AllocateHandle(::CsObject* target);
    // public System.Void .ctor(System.Object target)
    // Offset: 0x1788490
    static WeakReference* New_ctor(::CsObject* target);
    // public System.Void .ctor(System.Object target, System.Boolean trackResurrection)
    // Offset: 0x17884C4
    static WeakReference* New_ctor(::CsObject* target, bool trackResurrection);
