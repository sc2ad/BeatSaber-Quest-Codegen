...
namespace System {
  ...
  check_size<sizeof(WeakReference), 20 + sizeof(System::Runtime::InteropServices::GCHandle) + ((20 + sizeof(System::Runtime::InteropServices::GCHandle)) % 8 != 0 ? (8 - (20 + sizeof(System::Runtime::InteropServices::GCHandle)) % 8) : 0)> __System_WeakReferenceSizeCheck;
}
