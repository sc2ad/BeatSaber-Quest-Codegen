...
static System::TimeoutException New_ctor() ;

/// @brief Method .ctor addr 0x2458f10 size 0x58 virtual false final false
 void _ctor() ;

static System::TimeoutException New_ctor(::StringW message) ;

/// @brief Method .ctor addr 0x2458f68 size 0x20 virtual false final false
 void _ctor(::StringW message) ;

static System::TimeoutException New_ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;
