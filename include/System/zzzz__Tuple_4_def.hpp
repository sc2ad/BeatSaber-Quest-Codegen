...
static System::Tuple_4<T1,T2,T3,T4> New_ctor(T1 item1, T2 item2, T3 item3, T4 item4) ;
...
// CS Name: System.Tuple`4
class CORDL_TYPE Tuple_4<T1,T2,T3,bool> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to System::Collections::IStructuralEquatable
constexpr operator  System::Collections::IStructuralEquatable() const noexcept;
...
static System::Tuple_4<T1,T2,T3,bool> New_ctor(T1 item1, T2 item2, T3 item3, bool item4) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(T1 item1, T2 item2, T3 item3, bool item4) ;
