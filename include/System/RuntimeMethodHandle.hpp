...
namespace System {
  ...
  check_size<sizeof(RuntimeMethodHandle), 0 + sizeof(System::IntPtr) + ((0 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (0 + sizeof(System::IntPtr)) % 8) : 0)> __System_RuntimeMethodHandleSizeCheck;
}
