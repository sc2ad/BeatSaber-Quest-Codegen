...
// Ctor Parameters [CppParam { name: "calendar", ty: "System::Globalization::Calendar", modifiers: "", def_value: Some("csnull") }, CppParam { name: "dayOfWeek", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "timeMark", ty: "System::System__DateTimeParse__TM", modifiers: "", def_value: Some("{}") }, CppParam { name: "fUseHour12", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "fUseTwoDigitYear", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "fAllowInnerWhite", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "fAllowTrailingWhite", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "fCustomNumberParser", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "parseNumberDelegate", ty: "System::System__DateTimeParse__MatchNumberDelegate", modifiers: "", def_value: Some("csnull") }]
constexpr System::ParsingInfo::ParsingInfo(System::Globalization::Calendar calendar, int32_t dayOfWeek, System::System__DateTimeParse__TM timeMark, bool fUseHour12, bool fUseTwoDigitYear, bool fAllowInnerWhite, bool fAllowTrailingWhite, bool fCustomNumberParser, System::System__DateTimeParse__MatchNumberDelegate parseNumberDelegate) noexcept : ::bs_hook::ValueTypeWrapper() {this->calendar = calendar;
...
constexpr void System::ParsingInfo::__set_timeMark(System::System__DateTimeParse__TM value)  {
::cordl_internals::setInstanceField<System::System__DateTimeParse__TM, 0xc>(this->__instance, std::forward<System::System__DateTimeParse__TM>(value));
}
constexpr System::System__DateTimeParse__TM System::ParsingInfo::__get_timeMark() const {
return ::cordl_internals::getInstanceField<System::System__DateTimeParse__TM, 0xc>(this->__instance);
}
...
constexpr void System::ParsingInfo::__set_parseNumberDelegate(System::System__DateTimeParse__MatchNumberDelegate value)  {
::cordl_internals::setInstanceField<System::System__DateTimeParse__MatchNumberDelegate, 0x18>(this->__instance, std::forward<System::System__DateTimeParse__MatchNumberDelegate>(value));
}
constexpr System::System__DateTimeParse__MatchNumberDelegate System::ParsingInfo::__get_parseNumberDelegate() const {
return ::cordl_internals::getInstanceField<System::System__DateTimeParse__MatchNumberDelegate, 0x18>(this->__instance);
}
