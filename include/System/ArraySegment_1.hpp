...
namespace System {
  ...
  struct ArraySegment_1/*, public System::ValueType, public System::Collections::Generic::IList_1<T>, public System::Collections::Generic::IReadOnlyList_1<T>*/ {
    ...
    constexpr ArraySegment_1(::ArrayWrapper<T> array_ = ::ArrayWrapper<T>(nullptr), int offset_ = {}, int count_ = {}) noexcept : array{array_}, offset{offset_}, count{count_} {}
    ...
    // Offset: 0xFFFFFFFF
    void System_Collections_Generic_ICollection$T$_CopyTo(::ArrayWrapper<T> array, int arrayIndex) {
