...
namespace System::Globalization {
  ...
  check_size<sizeof(GregorianCalendarHelper), 48 + sizeof(System::DateTime) + ((48 + sizeof(System::DateTime)) % 8 != 0 ? (8 - (48 + sizeof(System::DateTime)) % 8) : 0)> __System_Globalization_GregorianCalendarHelperSizeCheck;
}
