...
namespace System::Globalization {
  ...
  class DateTimeFormatInfoScanner : public ::Il2CppObject {
    ...
    check_size<sizeof(DateTimeFormatInfoScanner::FoundDatePattern), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Globalization_DateTimeFormatInfoScanner_FoundDatePatternSizeCheck;
  ...
  check_size<sizeof(DateTimeFormatInfoScanner), 24 + sizeof(System::Globalization::DateTimeFormatInfoScanner::FoundDatePattern) + ((24 + sizeof(System::Globalization::DateTimeFormatInfoScanner::FoundDatePattern)) % 8 != 0 ? (8 - (24 + sizeof(System::Globalization::DateTimeFormatInfoScanner::FoundDatePattern)) % 8) : 0)> __System_Globalization_DateTimeFormatInfoScannerSizeCheck;
}
