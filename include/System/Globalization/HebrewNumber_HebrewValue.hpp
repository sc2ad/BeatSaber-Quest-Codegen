...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Globalization::HebrewNumber::HebrewValue::*)(System::Globalization::HebrewNumber::HebrewToken, int)>(&System::Globalization::HebrewNumber::HebrewValue::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Globalization::HebrewNumber::HebrewValue*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Globalization::HebrewNumber::HebrewToken>(), ::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Globalization::HebrewNumber::HebrewValue::*)(System::Globalization::HebrewNumber::HebrewToken, int)>(&System::Globalization::HebrewNumber::HebrewValue::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Globalization::HebrewNumber::HebrewValue*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Globalization::HebrewNumber::HebrewToken>(), ::il2cpp_utils::ExtractIndependentType<int>()});
  }
};
