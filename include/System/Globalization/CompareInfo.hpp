...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 1189238
  class CompareInfo : public ::Il2CppObject/*, public System::Runtime::Serialization::IDeserializationCallback*/ {
    ...
    #endif
    #endif
    // [OptionalFieldAttribute] Offset: 0x118DF98
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [OptionalFieldAttribute] Offset: 0x118DFD0
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [OptionalFieldAttribute] Offset: 0x118E008
