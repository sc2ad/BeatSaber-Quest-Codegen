...
namespace System::Globalization {
  ...
  // [ComVisibleAttribute] Offset: 11AAAC8
  class CompareInfo : public ::Il2CppObject/*, public ::System::Runtime::Serialization::IDeserializationCallback*/ {
    ...
    #endif
    #endif
    // [OptionalFieldAttribute] Offset: 0x11AF6F8
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // [OptionalFieldAttribute] Offset: 0x11AF730
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [OptionalFieldAttribute] Offset: 0x11AF768
