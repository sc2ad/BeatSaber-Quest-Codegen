...
struct CORDL_TYPE System__Globalization__FormatProvider__Number__NumberBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr System__Globalization__FormatProvider__Number__NumberBuffer(int32_t precision, int32_t scale, bool sign, void* overrideDigits) noexcept;


                    constexpr System__Globalization__FormatProvider__Number__NumberBuffer(System__Globalization__FormatProvider__Number__NumberBuffer const&) = default;
                    constexpr System__Globalization__FormatProvider__Number__NumberBuffer(System__Globalization__FormatProvider__Number__NumberBuffer&&) = default;
                    constexpr System__Globalization__FormatProvider__Number__NumberBuffer& operator=(System__Globalization__FormatProvider__Number__NumberBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Globalization__FormatProvider__Number__NumberBuffer& operator=(System__Globalization__FormatProvider__Number__NumberBuffer&& o) noexcept {
...
constexpr explicit System__Globalization__FormatProvider__Number__NumberBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE System__Globalization__FormatProvider__Number : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using NumberBuffer = GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~System__Globalization__FormatProvider__Number() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Globalization__FormatProvider__Number", modifiers: " const&", def_value: None }]
constexpr System__Globalization__FormatProvider__Number(System__Globalization__FormatProvider__Number const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Globalization__FormatProvider__Number", modifiers: "&&", def_value: None }]
constexpr System__Globalization__FormatProvider__Number(System__Globalization__FormatProvider__Number&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Globalization__FormatProvider__Number(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Globalization__FormatProvider__Number& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Globalization__FormatProvider__Number& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Globalization__FormatProvider__Number& operator=(System__Globalization__FormatProvider__Number&& o) noexcept = default;
  constexpr System__Globalization__FormatProvider__Number& operator=(System__Globalization__FormatProvider__Number const& o) noexcept = default;
...
static void NumberToString(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, char16_t format, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info, bool isDecimal) ;

/// @brief Method FormatCurrency addr 0x26b8248 size 0x260 virtual false final false
static void FormatCurrency(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info) ;
...
static void FormatFixed(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info, ::ArrayW<int32_t> groupDigits, ::StringW sDecimal, ::StringW sGroup) ;

/// @brief Method FormatNumber addr 0x26b89e4 size 0x248 virtual false final false
static void FormatNumber(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info) ;

/// @brief Method FormatScientific addr 0x26b8c2c size 0x23c virtual false final false
static void FormatScientific(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info, char16_t expChar) ;
...
static void FormatGeneral(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info, char16_t expChar, bool bSuppressScientific) ;

/// @brief Method FormatPercent addr 0x26b9204 size 0x260 virtual false final false
static void FormatPercent(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t nMinDigits, int32_t nMaxDigits, System::Globalization::NumberFormatInfo info) ;

/// @brief Method RoundNumber addr 0x26b8174 size 0xd4 virtual false final false
static void RoundNumber(ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, int32_t pos) ;
...
static void NumberToStringFormat(ByRef<System::Text::ValueStringBuilder> sb, ByRef<GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer> number, System::ReadOnlySpan_1<char16_t> format, System::Globalization::NumberFormatInfo info) ;
...
public:
// Declarations
using Number = System::Globalization::System__Globalization__FormatProvider__Number;
...
NEED_NO_BOX(System::Globalization::System__Globalization__FormatProvider__Number);
DEFINE_IL2CPP_ARG_TYPE(System::Globalization::System__Globalization__FormatProvider__Number, "System.Globalization", "FormatProvider/Number");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::System__Globalization__FormatProvider__Number__NumberBuffer, "System.Globalization", "FormatProvider/Number/NumberBuffer");
