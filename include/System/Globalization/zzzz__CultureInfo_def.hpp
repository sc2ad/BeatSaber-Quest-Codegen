...
struct CORDL_TYPE System__Globalization__CultureInfo__Data : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr System__Globalization__CultureInfo__Data(int32_t ansi, int32_t ebcdic, int32_t mac, int32_t oem, bool right_to_left, uint8_t list_sep) noexcept;


                    constexpr System__Globalization__CultureInfo__Data(System__Globalization__CultureInfo__Data const&) = default;
                    constexpr System__Globalization__CultureInfo__Data(System__Globalization__CultureInfo__Data&&) = default;
                    constexpr System__Globalization__CultureInfo__Data& operator=(System__Globalization__CultureInfo__Data const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Globalization__CultureInfo__Data& operator=(System__Globalization__CultureInfo__Data&& o) noexcept {
...
constexpr explicit System__Globalization__CultureInfo__Data(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE System__Globalization__CultureInfo__OnCultureInfoChangedDelegate : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~System__Globalization__CultureInfo__OnCultureInfoChangedDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Globalization__CultureInfo__OnCultureInfoChangedDelegate", modifiers: " const&", def_value: None }]
constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate(System__Globalization__CultureInfo__OnCultureInfoChangedDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Globalization__CultureInfo__OnCultureInfoChangedDelegate", modifiers: "&&", def_value: None }]
constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate(System__Globalization__CultureInfo__OnCultureInfoChangedDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Globalization__CultureInfo__OnCultureInfoChangedDelegate(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate& operator=(System__Globalization__CultureInfo__OnCultureInfoChangedDelegate&& o) noexcept = default;
  constexpr System__Globalization__CultureInfo__OnCultureInfoChangedDelegate& operator=(System__Globalization__CultureInfo__OnCultureInfoChangedDelegate const& o) noexcept = default;
...
public:
// Declarations
using OnCultureInfoChangedDelegate = System::Globalization::System__Globalization__CultureInfo__OnCultureInfoChangedDelegate;

using Data = System::Globalization::System__Globalization__CultureInfo__Data;
...
/// @brief Method GetTextInfoData addr 0x24052b4 size 0x18 virtual false final false
 System::Globalization::System__Globalization__CultureInfo__Data GetTextInfoData() ;
...
static void InitializeUserPreferredCultureInfoInAppX(System::Globalization::System__Globalization__CultureInfo__OnCultureInfoChangedDelegate onCultureInfoChangedInAppX) ;
...
NEED_NO_BOX(System::Globalization::System__Globalization__CultureInfo__OnCultureInfoChangedDelegate);
DEFINE_IL2CPP_ARG_TYPE(System::Globalization::System__Globalization__CultureInfo__OnCultureInfoChangedDelegate, "System.Globalization", "CultureInfo/OnCultureInfoChangedDelegate");
DEFINE_IL2CPP_ARG_TYPE(System::Globalization::System__Globalization__CultureInfo__Data, "System.Globalization", "CultureInfo/Data");
