...
namespace System::Globalization {
  ...
  class TimeSpanFormat : public ::Il2CppObject {
    ...
    check_size<sizeof(TimeSpanFormat::FormatLiterals), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __System_Globalization_TimeSpanFormat_FormatLiteralsSizeCheck;
