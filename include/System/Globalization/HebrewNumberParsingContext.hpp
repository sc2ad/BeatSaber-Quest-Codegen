...
namespace System::Globalization {
  ...
  check_size<sizeof(HebrewNumberParsingContext), 4 + sizeof(int) + ((4 + sizeof(int)) % 8 != 0 ? (8 - (4 + sizeof(int)) % 8) : 0)> __System_Globalization_HebrewNumberParsingContextSizeCheck;
}
