...
// Il2CppName: get_Eras
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<int> (System::Globalization::Calendar::*)()>(&System::Globalization::Calendar::get_Eras)> {
  static const MethodInfo* get() {
