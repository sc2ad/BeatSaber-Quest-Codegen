...
namespace System {
  ...
  struct DTSubString : public System::ValueType {
    ...
    constexpr DTSubString(::Il2CppString* s_ = {}, int index_ = {}, int length_ = {}, System::DTSubStringType type_ = {}, int value_ = {}) : s{s_}, index{index_}, length{length_}, type{type_}, value{value_} {}
