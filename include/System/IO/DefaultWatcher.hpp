...
namespace System::IO {
  ...
  class DefaultWatcher : public ::CsObject, public System::IO::IFileWatcher {
    public:
    ...
    static ::Array<::CsString*>* _get_NoStringsArray();
    // Set static field: static private System.String[] NoStringsArray
    static void _set_NoStringsArray(::Array<::CsString*>* value);
    ...
    // Offset: 0xF603B4
    static void DispatchEvents(System::IO::FileSystemWatcher* fsw, System::IO::FileAction action, ::CsString* filename);
    // private System.Void DoFiles(System.IO.DefaultWatcherData data, System.String directory, System.Boolean dispatch)
    // Offset: 0xF6014C
    void DoFiles(System::IO::DefaultWatcherData* data, ::CsString* directory, bool dispatch);
    ...
    // Offset: 0xF60718
    void IterateAndModifyFilesData(System::IO::DefaultWatcherData* data, ::CsString* directory, bool dispatch, ::Array<::CsString*>* files);
    // static private System.IO.FileData CreateFileData(System.String directory, System.String filename)
    // Offset: 0xF61718
    static System::IO::FileData* CreateFileData(::CsString* directory, ::CsString* filename);
