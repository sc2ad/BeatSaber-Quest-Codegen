...
namespace System::IO::Compression {
  ...
  // [] Offset: FFFFFFFF
  // [UnmanagedFunctionPointerAttribute] Offset: CA0768
  class DeflateStreamNative::UnmanagedReadOrWrite : public System::MulticastDelegate {
    ...
    // Offset: 0x16D023C
    int Invoke_NEW(System::IntPtr buffer, int length, System::IntPtr data);
    ...
    // Offset: 0x16D04D8
    System::IAsyncResult* BeginInvoke_NEW(System::IntPtr buffer, int length, System::IntPtr data, System::AsyncCallback* callback, ::Il2CppObject* object);
