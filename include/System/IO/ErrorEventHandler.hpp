...
namespace System::IO {
  ...
  class ErrorEventHandler : public System::MulticastDelegate {
    ...
    // Offset: 0x16D3624
    void Invoke_NEW(::Il2CppObject* sender, System::IO::ErrorEventArgs* e);
    ...
    // Offset: 0x16D3A0C
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppObject* sender, System::IO::ErrorEventArgs* e, System::AsyncCallback* callback, ::Il2CppObject* object);
