...
namespace System::IO {
  ...
  class SearchResultHandler_1 : public ::Il2CppObject {
    ...
    TSource CreateObject(System::IO::SearchResult* result) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<TSource>(), "CreateObject", {}, ::il2cpp_utils::ExtractTypes(result)));
  ...
  // Could not write size check! Type: System.IO.SearchResultHandler`1 is generic!
}
