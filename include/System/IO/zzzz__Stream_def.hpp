...
class ______System__IO__Stream__SynchronousAsyncResult____c;
}
namespace System::IO {
class Stream;
}
namespace System::IO {
class ____System__IO__Stream__NullStream;
}
namespace System::IO {
class ____System__IO__Stream__ReadWriteTask;
}
namespace System::IO {
class ____System__IO__Stream__SynchronousAsyncResult;
}
namespace System::IO {
class ____System__IO__Stream____c;
}
namespace System::IO {
struct ____System__IO__Stream__ReadWriteParameters;
}
namespace System::IO {
struct ____System__IO__Stream___CopyToAsyncInternal_d__28;
}
namespace System::IO {
struct ____System__IO__Stream___FinishWriteAsync_d__57;
}
namespace System::IO {
struct ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d;
}
...
struct CORDL_TYPE ____System__IO__Stream__ReadWriteParameters : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__IO__Stream__ReadWriteParameters(::ArrayW<uint8_t> Buffer, int32_t Offset, int32_t Count) noexcept;


                    constexpr ____System__IO__Stream__ReadWriteParameters(____System__IO__Stream__ReadWriteParameters const&) = default;
                    constexpr ____System__IO__Stream__ReadWriteParameters(____System__IO__Stream__ReadWriteParameters&&) = default;
                    constexpr ____System__IO__Stream__ReadWriteParameters& operator=(____System__IO__Stream__ReadWriteParameters const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__IO__Stream__ReadWriteParameters& operator=(____System__IO__Stream__ReadWriteParameters&& o) noexcept {
...
constexpr explicit ____System__IO__Stream__ReadWriteParameters(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
namespace System::IO {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2770)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 92 })}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(3596))
// CS Name: System.IO.Stream::ReadWriteTask
class CORDL_TYPE ____System__IO__Stream__ReadWriteTask : public ::System::Threading::Tasks::Task_1<int32_t> {
public:
// Declarations
...
virtual ~____System__IO__Stream__ReadWriteTask() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__ReadWriteTask", modifiers: " const&", def_value: None }]
constexpr ____System__IO__Stream__ReadWriteTask(____System__IO__Stream__ReadWriteTask const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__ReadWriteTask", modifiers: "&&", def_value: None }]
constexpr ____System__IO__Stream__ReadWriteTask(____System__IO__Stream__ReadWriteTask&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream__ReadWriteTask(void* ptr) noexcept : ::System::Threading::Tasks::Task_1<int32_t>(ptr) {
}


  constexpr ____System__IO__Stream__ReadWriteTask& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__IO__Stream__ReadWriteTask& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__IO__Stream__ReadWriteTask& operator=(____System__IO__Stream__ReadWriteTask&& o) noexcept = default;
  constexpr ____System__IO__Stream__ReadWriteTask& operator=(____System__IO__Stream__ReadWriteTask const& o) noexcept = default;
...
explicit ____System__IO__Stream__ReadWriteTask(bool isRead, bool apm, ::System::Func_2<::bs_hook::Il2CppWrapperType,int32_t> function, ::bs_hook::Il2CppWrapperType state, ::System::IO::Stream stream, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, ::System::AsyncCallback callback) ;
...
public:
// Declarations
using __ReadAsync_g__FinishReadAsync_44_0_d = ::System::IO::____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d;

using _FinishWriteAsync_d__57 = ::System::IO::____System__IO__Stream___FinishWriteAsync_d__57;

using _CopyToAsyncInternal_d__28 = ::System::IO::____System__IO__Stream___CopyToAsyncInternal_d__28;

using __c = ::System::IO::____System__IO__Stream____c;

using SynchronousAsyncResult = ::System::IO::____System__IO__Stream__SynchronousAsyncResult;

using NullStream = ::System::IO::____System__IO__Stream__NullStream;

using ReadWriteTask = ::System::IO::____System__IO__Stream__ReadWriteTask;

using ReadWriteParameters = ::System::IO::____System__IO__Stream__ReadWriteParameters;
...
static constexpr int32_t  DefaultCopyBufferSize{81920};
 ...
 ::System::IO::____System__IO__Stream__ReadWriteTask __declspec(property(get=__get__activeReadWriteTask, put=__set__activeReadWriteTask))  _activeReadWriteTask;

constexpr void __set__activeReadWriteTask(::System::IO::____System__IO__Stream__ReadWriteTask value) ;

constexpr ::System::IO::____System__IO__Stream__ReadWriteTask __get__activeReadWriteTask() const;
...
/// @brief Method RunReadWriteTaskWhenReady addr 0x23c40d8 size 0x184 virtual false final false
 void RunReadWriteTaskWhenReady(::System::Threading::Tasks::Task asyncWaiter, ::System::IO::____System__IO__Stream__ReadWriteTask readWriteTask) ;

/// @brief Method RunReadWriteTask addr 0x23c425c size 0xb4 virtual false final false
 void RunReadWriteTask(::System::IO::____System__IO__Stream__ReadWriteTask readWriteTask) ;
...
class CORDL_TYPE ____System__IO__Stream__NullStream : public ::System::IO::Stream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____System__IO__Stream__NullStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__NullStream", modifiers: " const&", def_value: None }]
constexpr ____System__IO__Stream__NullStream(____System__IO__Stream__NullStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__NullStream", modifiers: "&&", def_value: None }]
constexpr ____System__IO__Stream__NullStream(____System__IO__Stream__NullStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream__NullStream(void* ptr) noexcept : ::System::IO::Stream(ptr) {
}


  constexpr ____System__IO__Stream__NullStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__IO__Stream__NullStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__IO__Stream__NullStream& operator=(____System__IO__Stream__NullStream&& o) noexcept = default;
  constexpr ____System__IO__Stream__NullStream& operator=(____System__IO__Stream__NullStream const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____System__IO__Stream__NullStream() ;
...
class CORDL_TYPE ______System__IO__Stream__SynchronousAsyncResult____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~______System__IO__Stream__SynchronousAsyncResult____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "______System__IO__Stream__SynchronousAsyncResult____c", modifiers: " const&", def_value: None }]
constexpr ______System__IO__Stream__SynchronousAsyncResult____c(______System__IO__Stream__SynchronousAsyncResult____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______System__IO__Stream__SynchronousAsyncResult____c", modifiers: "&&", def_value: None }]
constexpr ______System__IO__Stream__SynchronousAsyncResult____c(______System__IO__Stream__SynchronousAsyncResult____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______System__IO__Stream__SynchronousAsyncResult____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ______System__IO__Stream__SynchronousAsyncResult____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______System__IO__Stream__SynchronousAsyncResult____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______System__IO__Stream__SynchronousAsyncResult____c& operator=(______System__IO__Stream__SynchronousAsyncResult____c&& o) noexcept = default;
  constexpr ______System__IO__Stream__SynchronousAsyncResult____c& operator=(______System__IO__Stream__SynchronousAsyncResult____c const& o) noexcept = default;
                


// Fields

static ::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c value) ;

static ::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c __get___9() ;
...
// Ctor Parameters []
explicit ______System__IO__Stream__SynchronousAsyncResult____c() ;
...
class CORDL_TYPE ____System__IO__Stream__SynchronousAsyncResult : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using __c = ::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c;
...
virtual ~____System__IO__Stream__SynchronousAsyncResult() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__SynchronousAsyncResult", modifiers: " const&", def_value: None }]
constexpr ____System__IO__Stream__SynchronousAsyncResult(____System__IO__Stream__SynchronousAsyncResult const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream__SynchronousAsyncResult", modifiers: "&&", def_value: None }]
constexpr ____System__IO__Stream__SynchronousAsyncResult(____System__IO__Stream__SynchronousAsyncResult&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream__SynchronousAsyncResult(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__IO__Stream__SynchronousAsyncResult& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__IO__Stream__SynchronousAsyncResult& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__IO__Stream__SynchronousAsyncResult& operator=(____System__IO__Stream__SynchronousAsyncResult&& o) noexcept = default;
  constexpr ____System__IO__Stream__SynchronousAsyncResult& operator=(____System__IO__Stream__SynchronousAsyncResult const& o) noexcept = default;
...
explicit ____System__IO__Stream__SynchronousAsyncResult(int32_t bytesRead, ::bs_hook::Il2CppWrapperType asyncStateObject) ;
...
explicit ____System__IO__Stream__SynchronousAsyncResult(::bs_hook::Il2CppWrapperType asyncStateObject) ;
...
explicit ____System__IO__Stream__SynchronousAsyncResult(::System::Exception ex, ::bs_hook::Il2CppWrapperType asyncStateObject, bool isWrite) ;
...
class CORDL_TYPE ____System__IO__Stream____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__IO__Stream____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream____c", modifiers: " const&", def_value: None }]
constexpr ____System__IO__Stream____c(____System__IO__Stream____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__IO__Stream____c", modifiers: "&&", def_value: None }]
constexpr ____System__IO__Stream____c(____System__IO__Stream____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__IO__Stream____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__IO__Stream____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__IO__Stream____c& operator=(____System__IO__Stream____c&& o) noexcept = default;
  constexpr ____System__IO__Stream____c& operator=(____System__IO__Stream____c const& o) noexcept = default;
                


// Fields

static ::System::IO::____System__IO__Stream____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::System::IO::____System__IO__Stream____c value) ;

static ::System::IO::____System__IO__Stream____c __get___9() ;
...
static ::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> __declspec(property(get=__get___9__45_0, put=__set___9__45_0))  __9__45_0;

static void __set___9__45_0(::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> value) ;

static ::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> __get___9__45_0() ;
...
static ::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> __declspec(property(get=__get___9__58_0, put=__set___9__58_0))  __9__58_0;

static void __set___9__58_0(::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> value) ;

static ::System::Func_5<::System::IO::Stream,::System::IO::____System__IO__Stream__ReadWriteParameters,::System::AsyncCallback,::bs_hook::Il2CppWrapperType,::System::IAsyncResult> __get___9__58_0() ;
...
// Ctor Parameters []
explicit ____System__IO__Stream____c() ;
...
/// @brief Method <BeginEndReadAsync>b__45_0 addr 0x23c6ed8 size 0x34 virtual false final false
 ::System::IAsyncResult _BeginEndReadAsync_b__45_0(::System::IO::Stream stream, ::System::IO::____System__IO__Stream__ReadWriteParameters args, ::System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;
...
/// @brief Method <BeginEndWriteAsync>b__58_0 addr 0x23c7124 size 0x34 virtual false final false
 ::System::IAsyncResult _BeginEndWriteAsync_b__58_0(::System::IO::Stream stream, ::System::IO::____System__IO__Stream__ReadWriteParameters args, ::System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream___CopyToAsyncInternal_d__28(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::ArrayW<uint8_t> __get__buffer_5__2() const;
 ...
 ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredValueTaskAwaitable_1__ConfiguredValueTaskAwaiter<int32_t> __declspec(property(get=__get___u__1, put=__set___u__1))  __u__1;

constexpr void __set___u__1(::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredValueTaskAwaitable_1__ConfiguredValueTaskAwaiter<int32_t> value) ;

constexpr ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredValueTaskAwaitable_1__ConfiguredValueTaskAwaiter<int32_t> __get___u__1() const;
...
struct CORDL_TYPE ____System__IO__Stream___FinishWriteAsync_d__57 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "writeTask", ty: "::System::Threading::Tasks::Task", modifiers: "", def_value: None }, CppParam { name: "localBuffer", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr ____System__IO__Stream___FinishWriteAsync_d__57(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::System::Threading::Tasks::Task writeTask, ::ArrayW<uint8_t> localBuffer, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1) noexcept;


                    constexpr ____System__IO__Stream___FinishWriteAsync_d__57(____System__IO__Stream___FinishWriteAsync_d__57 const&) = default;
                    constexpr ____System__IO__Stream___FinishWriteAsync_d__57(____System__IO__Stream___FinishWriteAsync_d__57&&) = default;
                    constexpr ____System__IO__Stream___FinishWriteAsync_d__57& operator=(____System__IO__Stream___FinishWriteAsync_d__57 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__IO__Stream___FinishWriteAsync_d__57& operator=(____System__IO__Stream___FinishWriteAsync_d__57&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream___FinishWriteAsync_d__57(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncValueTaskMethodBuilder_1<int32_t> __t__builder, ::System::Threading::Tasks::Task_1<int32_t> readTask, ::ArrayW<uint8_t> localBuffer, ::System::Memory_1<uint8_t> localDestination, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t> __u__1) noexcept;


                    constexpr ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d(____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d const&) = default;
                    constexpr ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d(____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d&&) = default;
                    constexpr ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d& operator=(____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d& operator=(____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
NEED_NO_BOX(::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______System__IO__Stream__SynchronousAsyncResult____c, "System.IO", "Stream/SynchronousAsyncResult/<>c");
NEED_NO_BOX(::System::IO::Stream);
DEFINE_IL2CPP_ARG_TYPE(::System::IO::Stream, "System.IO", "Stream");
NEED_NO_BOX(::System::IO::____System__IO__Stream__NullStream);
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream__NullStream, "System.IO", "Stream/NullStream");
NEED_NO_BOX(::System::IO::____System__IO__Stream__ReadWriteTask);
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream__ReadWriteTask, "System.IO", "Stream/ReadWriteTask");
NEED_NO_BOX(::System::IO::____System__IO__Stream__SynchronousAsyncResult);
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream__SynchronousAsyncResult, "System.IO", "Stream/SynchronousAsyncResult");
NEED_NO_BOX(::System::IO::____System__IO__Stream____c);
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream____c, "System.IO", "Stream/<>c");
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream__ReadWriteParameters, "System.IO", "Stream/ReadWriteParameters");
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream___CopyToAsyncInternal_d__28, "System.IO", "Stream/<CopyToAsyncInternal>d__28");
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream___FinishWriteAsync_d__57, "System.IO", "Stream/<FinishWriteAsync>d__57");
DEFINE_IL2CPP_ARG_TYPE(::System::IO::____System__IO__Stream____ReadAsync_g__FinishReadAsync_44_0_d, "System.IO", "Stream/<<ReadAsync>g__FinishReadAsync|44_0>d");
