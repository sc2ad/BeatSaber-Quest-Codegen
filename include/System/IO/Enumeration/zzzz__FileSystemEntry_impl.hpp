...
constexpr ::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer(char16_t FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper() {this->FixedElementField = FixedElementField;
}
constexpr void ::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer::__set_FixedElementField(char16_t value)  {
::cordl_internals::setInstanceField<char16_t, 0x0>(this->__instance, std::forward<char16_t>(value));
}
constexpr char16_t ::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer::__get_FixedElementField() const {
...
constexpr void ::System::IO::Enumeration::FileSystemEntry::__set__directoryEntry(::GlobalNamespace::______GlobalNamespace__Interop__Sys__DirectoryEntry value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::______GlobalNamespace__Interop__Sys__DirectoryEntry, 0x0>(this->__instance, std::forward<::GlobalNamespace::______GlobalNamespace__Interop__Sys__DirectoryEntry>(value));
}
constexpr ::GlobalNamespace::______GlobalNamespace__Interop__Sys__DirectoryEntry ::System::IO::Enumeration::FileSystemEntry::__get__directoryEntry() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::______GlobalNamespace__Interop__Sys__DirectoryEntry, 0x0>(this->__instance);
}
...
constexpr void ::System::IO::Enumeration::FileSystemEntry::__set__fileNameBuffer(::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer value)  {
::cordl_internals::setInstanceField<::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer, 0xb8>(this->__instance, std::forward<::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer>(value));
}
constexpr ::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer ::System::IO::Enumeration::FileSystemEntry::__get__fileNameBuffer() const {
return ::cordl_internals::getInstanceField<::System::IO::Enumeration::____System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer, 0xb8>(this->__instance);
}
