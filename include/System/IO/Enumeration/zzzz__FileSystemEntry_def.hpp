...
struct CORDL_TYPE System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "char16_t", modifiers: "", def_value: None }]
constexpr System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer(char16_t FixedElementField) noexcept;


                    constexpr System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer(System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer const&) = default;
                    constexpr System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer(System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer&&) = default;
                    constexpr System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer& operator=(System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer& operator=(System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer&& o) noexcept {
...
constexpr explicit System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 GlobalNamespace::GlobalNamespace__Interop__Sys__DirectoryEntry __declspec(property(get=__get__directoryEntry, put=__set__directoryEntry))  _directoryEntry;

constexpr void __set__directoryEntry(GlobalNamespace::GlobalNamespace__Interop__Sys__DirectoryEntry value) ;

constexpr GlobalNamespace::GlobalNamespace__Interop__Sys__DirectoryEntry __get__directoryEntry() const;
...
constexpr System::ReadOnlySpan_1<char16_t> __get__fileName() const;
 ...
 System::IO::Enumeration::System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer __declspec(property(get=__get__fileNameBuffer, put=__set__fileNameBuffer))  _fileNameBuffer;

constexpr void __set__fileNameBuffer(System::IO::Enumeration::System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer value) ;

constexpr System::IO::Enumeration::System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer __get__fileNameBuffer() const;
...
DEFINE_IL2CPP_ARG_TYPE(System::IO::Enumeration::System__IO__Enumeration__FileSystemEntry____fileNameBuffer_e__FixedBuffer, "System.IO.Enumeration", "FileSystemEntry/<_fileNameBuffer>e__FixedBuffer");
