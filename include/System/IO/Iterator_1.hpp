...
namespace System::IO {
  ...
  class Iterator_1 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<TSource>, public System::Collections::Generic::IEnumerable_1<TSource>*/ {
    ...
    int _get_threadId() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_get_threadId");
    ...
    void _set_threadId(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_set_threadId");
      static auto ___internal__instance = this;
    ...
    int _get_state() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_get_state");
      static auto ___internal__instance = this;
    ...
    void _set_state(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_set_state");
      static auto ___internal__instance = this;
    ...
    TSource _get_current() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_get_current");
      static auto ___internal__instance = this;
    ...
    void _set_current(TSource value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::IO::Iterator_1::_set_current");
      static auto ___internal__instance = this;
