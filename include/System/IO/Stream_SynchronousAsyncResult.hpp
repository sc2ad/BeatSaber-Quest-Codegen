...
namespace System::IO {
  ...
  class Stream::SynchronousAsyncResult : public ::CsObject, public System::IAsyncResult {
    public:
    // Nested type: System::IO::Stream::SynchronousAsyncResult::$$c
    class $$c;
    // private readonly System.Object _stateObject
    // Offset: 0x10
    ::CsObject* stateObject;
    ...
    // Offset: 0xFF2824
    static Stream::SynchronousAsyncResult* New_ctor(int bytesRead, ::CsObject* asyncStateObject);
    // System.Void .ctor(System.Object asyncStateObject)
    // Offset: 0xFF2964
    static Stream::SynchronousAsyncResult* New_ctor(::CsObject* asyncStateObject);
    // System.Void .ctor(System.Exception ex, System.Object asyncStateObject, System.Boolean isWrite)
    // Offset: 0xFF2868
    static Stream::SynchronousAsyncResult* New_ctor(System::Exception* ex, ::CsObject* asyncStateObject, bool isWrite);
