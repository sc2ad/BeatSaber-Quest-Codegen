...
namespace System::IO {
  ...
  class FileSystemEnumerableFactory : public ::CsObject {
    public:
    ...
    // Offset: 0x112AF20
    static System::Collections::Generic::IEnumerable_1<::CsString*>* CreateFileNameIterator(::CsString* path, ::CsString* originalUserPath, ::CsString* searchPattern, bool includeFiles, bool includeDirs, System::IO::SearchOption searchOption, bool checkHost);
