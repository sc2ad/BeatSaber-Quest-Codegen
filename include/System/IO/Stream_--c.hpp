...
namespace System::IO {
  ...
  class Stream::$$c : public ::CsObject {
    public:
    ...
    // Offset: 0xFF2BF0
    int $BeginReadInternal$b__39_0(::CsObject* $p0$);
    // System.Int32 <BeginWriteInternal>b__46_0(System.Object $p0$)
    // Offset: 0xFF2D40
    int $BeginWriteInternal$b__46_0(::CsObject* $p0$);
    // System.Void <RunReadWriteTaskWhenReady>b__47_0(System.Threading.Tasks.Task t, System.Object state)
    // Offset: 0xFF2E58
    void $RunReadWriteTaskWhenReady$b__47_0(System::Threading::Tasks::Task* t, ::CsObject* state);
