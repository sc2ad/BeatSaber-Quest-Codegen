...
constexpr System::IO::FileStatus::FileStatus(GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus _fileStatus, int32_t _fileStatusInitialized, bool _InitiallyDirectory_k__BackingField, bool _isDirectory, bool _exists) noexcept : ::bs_hook::ValueTypeWrapper() {this->_fileStatus = _fileStatus;
...
constexpr void System::IO::FileStatus::__set__fileStatus(GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus, 0x0>(this->__instance, std::forward<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus>(value));
}
constexpr GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus System::IO::FileStatus::__get__fileStatus() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus, 0x0>(this->__instance);
}
