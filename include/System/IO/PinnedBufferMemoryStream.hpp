...
namespace System::IO {
  ...
  check_size<sizeof(PinnedBufferMemoryStream), 112 + sizeof(System::Runtime::InteropServices::GCHandle) + ((112 + sizeof(System::Runtime::InteropServices::GCHandle)) % 8 != 0 ? (8 - (112 + sizeof(System::Runtime::InteropServices::GCHandle)) % 8) : 0)> __System_IO_PinnedBufferMemoryStreamSizeCheck;
}
