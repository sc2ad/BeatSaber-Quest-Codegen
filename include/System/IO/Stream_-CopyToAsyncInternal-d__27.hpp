...
namespace System::IO {
  ...
  check_size<sizeof(Stream::$CopyToAsyncInternal$d__27), 96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter) + ((96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter)) % 8 != 0 ? (8 - (96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable_1<int>::ConfiguredTaskAwaiter)) % 8) : 0)> __System_IO_Stream_$CopyToAsyncInternal$d__27SizeCheck;
}
