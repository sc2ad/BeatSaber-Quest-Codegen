...
/// @brief Method Compare addr 0x245791c size 0x18 virtual true final false
 int32_t Compare(::StringW x, ::StringW y) ;

/// @brief Method Equals addr 0x2457934 size 0x18 virtual true final false
 bool Equals(::StringW x, ::StringW y) ;

/// @brief Method GetHashCode addr 0x245794c size 0x64 virtual true final false
 int32_t GetHashCode(::StringW obj) ;

/// @brief Method GetObjectData addr 0x24579b0 size 0xb4 virtual true final true
