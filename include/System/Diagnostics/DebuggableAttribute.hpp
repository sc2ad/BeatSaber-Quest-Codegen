...
namespace System::Diagnostics {
  ...
  class DebuggableAttribute : public System::Attribute {
    ...
    check_size<sizeof(DebuggableAttribute::DebuggingModes), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Diagnostics_DebuggableAttribute_DebuggingModesSizeCheck;
  ...
  check_size<sizeof(DebuggableAttribute), 16 + sizeof(System::Diagnostics::DebuggableAttribute::DebuggingModes) + ((16 + sizeof(System::Diagnostics::DebuggableAttribute::DebuggingModes)) % 8 != 0 ? (8 - (16 + sizeof(System::Diagnostics::DebuggableAttribute::DebuggingModes)) % 8) : 0)> __System_Diagnostics_DebuggableAttributeSizeCheck;
}
