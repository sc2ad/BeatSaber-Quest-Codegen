...
namespace System::Diagnostics {
struct ____System__Diagnostics__StackTrace__TraceFormat;
}
namespace System::Diagnostics {
class StackTrace;
}
...
struct CORDL_TYPE ____System__Diagnostics__StackTrace__TraceFormat : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Diagnostics__StackTrace__TraceFormat(int32_t value__) noexcept;


                    constexpr ____System__Diagnostics__StackTrace__TraceFormat(____System__Diagnostics__StackTrace__TraceFormat const&) = default;
                    constexpr ____System__Diagnostics__StackTrace__TraceFormat(____System__Diagnostics__StackTrace__TraceFormat&&) = default;
                    constexpr ____System__Diagnostics__StackTrace__TraceFormat& operator=(____System__Diagnostics__StackTrace__TraceFormat const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Diagnostics__StackTrace__TraceFormat& operator=(____System__Diagnostics__StackTrace__TraceFormat&& o) noexcept {
...
constexpr explicit ____System__Diagnostics__StackTrace__TraceFormat(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Diagnostics__StackTrace__TraceFormat_Unwrapped : int32_t {
__Normal = 0,
__TrailingNewLine = 1,
...
constexpr operator ______System__Diagnostics__StackTrace__TraceFormat_Unwrapped () const noexcept {
return std::bit_cast<______System__Diagnostics__StackTrace__TraceFormat_Unwrapped>(__instance);
}
...
static ::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat const Normal;

/// @brief Field TrailingNewLine offset 0
static ::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat const TrailingNewLine;

/// @brief Field NoResourceLookup offset 0
static ::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat const NoResourceLookup;
...
public:
// Declarations
using TraceFormat = ::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat;
...
/// @brief Method ToString addr 0x240dbe8 size 0xc virtual false final false
 ::StringW ToString(::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat traceFormat) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Diagnostics::____System__Diagnostics__StackTrace__TraceFormat, "System.Diagnostics", "StackTrace/TraceFormat");
