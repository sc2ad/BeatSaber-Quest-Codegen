...
namespace System::Diagnostics {
  ...
  // [AttributeUsageAttribute] Offset: D80C44
  // [ComVisibleAttribute] Offset: D80C44
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Diagnostics::DebuggerBrowsableAttribute::*)(System::Diagnostics::DebuggerBrowsableState)>(&System::Diagnostics::DebuggerBrowsableAttribute::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Diagnostics::DebuggerBrowsableAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Diagnostics::DebuggerBrowsableState>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Diagnostics::DebuggerBrowsableAttribute::*)(System::Diagnostics::DebuggerBrowsableState)>(&System::Diagnostics::DebuggerBrowsableAttribute::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Diagnostics::DebuggerBrowsableAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Diagnostics::DebuggerBrowsableState>()});
  }
};
