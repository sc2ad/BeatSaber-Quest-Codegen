...
namespace System::Diagnostics {
  ...
  class TraceListenerCollection : public ::CsObject, public System::Collections::IList, public System::Collections::ICollection, public System::Collections::IEnumerable {
    public:
