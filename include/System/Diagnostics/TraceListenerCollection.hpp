...
namespace System::Diagnostics {
  ...
  check_size<sizeof(TraceListenerCollection), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Diagnostics_TraceListenerCollectionSizeCheck;
}
