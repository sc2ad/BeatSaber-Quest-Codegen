...
namespace System::Diagnostics {
  ...
  class Process : public System::ComponentModel::Component {
    ...
    check_size<sizeof(Process::StreamReadMode), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Diagnostics_Process_StreamReadModeSizeCheck;
  ...
  check_size<sizeof(Process), 216 + sizeof(void*) + ((216 + sizeof(void*)) % 8 != 0 ? (8 - (216 + sizeof(void*)) % 8) : 0)> __System_Diagnostics_ProcessSizeCheck;
}
