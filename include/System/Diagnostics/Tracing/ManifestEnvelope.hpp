...
namespace System::Diagnostics::Tracing {
  ...
  struct ManifestEnvelope : public System::ValueType {
    ...
    check_size<sizeof(ManifestEnvelope::ManifestFormats), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __System_Diagnostics_Tracing_ManifestEnvelope_ManifestFormatsSizeCheck;
  ...
  check_size<sizeof(ManifestEnvelope), 6 + sizeof(uint16_t) + ((6 + sizeof(uint16_t)) % 8 != 0 ? (8 - (6 + sizeof(uint16_t)) % 8) : 0)> __System_Diagnostics_Tracing_ManifestEnvelopeSizeCheck;
}
