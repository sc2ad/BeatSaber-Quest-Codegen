...
namespace System::Diagnostics::Tracing {
  ...
  class EnumHelper_1 : public ::CsObject {
    public:
    ...
    class Transformer_1 : public System::MulticastDelegate, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      // Offset: 0xFFFFFFFF
      static typename EnumHelper_1<UnderlyingType>::Transformer_1<ValueType>* New_ctor(::CsObject* object, System::IntPtr method) {
      ...
      // Offset: 0xFFFFFFFF
      System::IAsyncResult* BeginInvoke(ValueType value, System::AsyncCallback* callback, ::CsObject* object) {
    ...
    template<typename ValueType>
    class Caster_1 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = EnumHelper_1<UnderlyingType>*;
