...
namespace System::Diagnostics::Tracing {
  ...
  class PropertyAnalysis : public ::CsObject {
    public:
    ...
    // Offset: 0xD85E9C
    static PropertyAnalysis* New_ctor(::CsString* name, System::Reflection::MethodInfo* getterInfo, System::Diagnostics::Tracing::TraceLoggingTypeInfo* typeInfo, System::Diagnostics::Tracing::EventFieldAttribute* fieldAttribute);
