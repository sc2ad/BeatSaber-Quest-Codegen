...
namespace System::Diagnostics::Tracing {
  ...
  class ConcurrentSetItem_2 : public ::Il2CppObject {
    ...
    static ConcurrentSetItem_2<ItemType, KeyType>* New_ctor() {
      return (ConcurrentSetItem_2<ItemType, KeyType>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ConcurrentSetItem_2<ItemType, KeyType>*>::get())));
    }
