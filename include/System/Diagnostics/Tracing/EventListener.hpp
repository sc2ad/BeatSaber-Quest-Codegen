...
namespace System::Diagnostics::Tracing {
  ...
  class EventListener : public ::CsObject {
    ...
    // Offset: 0xC98CC4
    static void DisposeOnShutdown(::CsObject* sender, System::EventArgs* e);
    // static System.Object get_EventListenersLock()
    // Offset: 0xC98A40
    static ::CsObject* get_EventListenersLock();
