...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(EventFieldAttribute), 32 + sizeof(System::Diagnostics::Tracing::EventFieldFormat) + ((32 + sizeof(System::Diagnostics::Tracing::EventFieldFormat)) % 8 != 0 ? (8 - (32 + sizeof(System::Diagnostics::Tracing::EventFieldFormat)) % 8) : 0)> __System_Diagnostics_Tracing_EventFieldAttributeSizeCheck;
}
