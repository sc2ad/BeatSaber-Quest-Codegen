...
namespace System::Diagnostics::Tracing {
  ...
  class NullTypeInfo_1 : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<DataType> {
    ...
    void WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::Il2CppString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("NullTypeInfo_1").WithContext("WriteMetadata");
    ...
    void WriteData(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, DataType& value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("NullTypeInfo_1").WithContext("WriteData");
    ...
    ::Il2CppObject* GetData(::Il2CppObject* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("NullTypeInfo_1").WithContext("GetData");
    ...
    static NullTypeInfo_1<DataType>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("NullTypeInfo_1").WithContext(".ctor");
