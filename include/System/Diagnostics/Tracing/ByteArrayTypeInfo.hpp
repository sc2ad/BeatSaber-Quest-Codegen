...
namespace System::Diagnostics::Tracing {
  ...
  class ByteArrayTypeInfo : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<::Array<uint8_t>*> {
    public:
    // Creating value type constructor for type: ByteArrayTypeInfo
    ByteArrayTypeInfo() noexcept {}
    ...
    static ByteArrayTypeInfo* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("ByteArrayTypeInfo").WithContext(".ctor");
