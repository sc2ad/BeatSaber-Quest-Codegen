...
namespace System::Diagnostics::Tracing {
  ...
  class EnumSByteTypeInfo_1 : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<EnumType> {
    ...
    void WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::Il2CppString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumSByteTypeInfo_1").WithContext("WriteMetadata");
    ...
    void WriteData(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, EnumType& value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumSByteTypeInfo_1").WithContext("WriteData");
    ...
    ::Il2CppObject* GetData(::Il2CppObject* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumSByteTypeInfo_1").WithContext("GetData");
    ...
    static EnumSByteTypeInfo_1<EnumType>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumSByteTypeInfo_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<EnumSByteTypeInfo_1<EnumType>*>());
    }
  }; // System.Diagnostics.Tracing.EnumSByteTypeInfo`1
  // Could not write size check! Type: System.Diagnostics.Tracing.EnumSByteTypeInfo`1 is generic!
}
