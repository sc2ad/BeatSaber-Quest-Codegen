...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(EventPayload::$GetEnumerator$d__17), 48 + sizeof(int) + ((48 + sizeof(int)) % 8 != 0 ? (8 - (48 + sizeof(int)) % 8) : 0)> __System_Diagnostics_Tracing_EventPayload_$GetEnumerator$d__17SizeCheck;
}
