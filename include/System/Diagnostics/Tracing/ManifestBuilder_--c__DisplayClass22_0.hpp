...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(ManifestBuilder::$$c__DisplayClass22_0), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __System_Diagnostics_Tracing_ManifestBuilder_$$c__DisplayClass22_0SizeCheck;
}
