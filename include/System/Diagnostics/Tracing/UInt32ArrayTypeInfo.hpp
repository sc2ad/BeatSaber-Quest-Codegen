...
namespace System::Diagnostics::Tracing {
  ...
  class UInt32ArrayTypeInfo : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<::Array<uint>*> {
    public:
    // Creating value type constructor for type: UInt32ArrayTypeInfo
    UInt32ArrayTypeInfo() noexcept {}
    ...
    static UInt32ArrayTypeInfo* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("UInt32ArrayTypeInfo").WithContext(".ctor");
