...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(EventSource::EventData), 12 + sizeof(int) + ((12 + sizeof(int)) % 8 != 0 ? (8 - (12 + sizeof(int)) % 8) : 0)> __System_Diagnostics_Tracing_EventSource_EventDataSizeCheck;
}
