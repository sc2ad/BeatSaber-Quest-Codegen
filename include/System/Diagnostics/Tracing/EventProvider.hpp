...
namespace System::Diagnostics::Tracing {
  ...
  class EventProvider : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    check_size<sizeof(EventProvider::SessionInfo), 4 + sizeof(int) + 8 - (4 + sizeof(int)) % 8> __System_Diagnostics_Tracing_EventProvider_SessionInfoSizeCheck;
    ...
    check_size<sizeof(EventProvider::WriteEventErrorCode), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Diagnostics_Tracing_EventProvider_WriteEventErrorCodeSizeCheck;
  ...
  check_size<sizeof(EventProvider), 92 + sizeof(bool) + 8 - (92 + sizeof(bool)) % 8> __System_Diagnostics_Tracing_EventProviderSizeCheck;
}
