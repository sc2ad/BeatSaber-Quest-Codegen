...
namespace System::Diagnostics::Tracing {
  ...
  // [] Offset: FFFFFFFF
  class DoubleArrayTypeInfo : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<::Array<double>*> {
    public:
    // Creating value type constructor for type: DoubleArrayTypeInfo
    DoubleArrayTypeInfo() noexcept {}
    // public System.Void WriteData(System.Diagnostics.Tracing.TraceLoggingDataCollector collector, ref System.Double[] value)
    // Offset: 0x12C5ED0
    void WriteData(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, ::Array<double>*& value);
    ...
    static DoubleArrayTypeInfo* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("DoubleArrayTypeInfo").WithContext(".ctor");
