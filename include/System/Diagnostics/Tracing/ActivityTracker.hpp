...
namespace System::Diagnostics::Tracing {
  ...
  class ActivityTracker : public ::CsObject {
    public:
    ...
    // Offset: 0xC8323C
    void OnStart(::CsString* providerName, ::CsString* activityName, int task, System::Guid& activityId, System::Guid& relatedActivityId, System::Diagnostics::Tracing::EventActivityOptions options);
    // public System.Void OnStop(System.String providerName, System.String activityName, System.Int32 task, System.Guid activityId)
    // Offset: 0xC838A8
    void OnStop(::CsString* providerName, ::CsString* activityName, int task, System::Guid& activityId);
    ...
    // Offset: 0xC8385C
    System::Diagnostics::Tracing::ActivityTracker::ActivityInfo* FindActiveActivity(::CsString* name, System::Diagnostics::Tracing::ActivityTracker::ActivityInfo* startLocation);
    // private System.String NormalizeActivityName(System.String providerName, System.String activityName, System.Int32 task)
    // Offset: 0xC836C4
    ::CsString* NormalizeActivityName(::CsString* providerName, ::CsString* activityName, int task);
