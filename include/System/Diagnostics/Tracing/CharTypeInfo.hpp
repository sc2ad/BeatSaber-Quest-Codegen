...
namespace System::Diagnostics::Tracing {
  ...
  class CharTypeInfo : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<::Il2CppChar> {
    public:
    // Creating value type constructor for type: CharTypeInfo
    CharTypeInfo() noexcept {}
    // public System.Void WriteData(System.Diagnostics.Tracing.TraceLoggingDataCollector collector, ref System.Char value)
    // Offset: 0x12C4FAC
    void WriteData(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, ::Il2CppChar& value);
    ...
    static CharTypeInfo* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("CharTypeInfo").WithContext(".ctor");
