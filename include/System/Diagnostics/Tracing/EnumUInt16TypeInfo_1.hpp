...
namespace System::Diagnostics::Tracing {
  ...
  class EnumUInt16TypeInfo_1 : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<EnumType> {
    ...
    void WriteMetadata(System::Diagnostics::Tracing::TraceLoggingMetadataCollector* collector, ::Il2CppString* name, System::Diagnostics::Tracing::EventFieldFormat format) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumUInt16TypeInfo_1").WithContext("WriteMetadata");
    ...
    void WriteData(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, EnumType& value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumUInt16TypeInfo_1").WithContext("WriteData");
    ...
    ::Il2CppObject* GetData(::Il2CppObject* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumUInt16TypeInfo_1").WithContext("GetData");
    ...
    static EnumUInt16TypeInfo_1<EnumType>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("EnumUInt16TypeInfo_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<EnumUInt16TypeInfo_1<EnumType>*>());
    }
  }; // System.Diagnostics.Tracing.EnumUInt16TypeInfo`1
  // Could not write size check! Type: System.Diagnostics.Tracing.EnumUInt16TypeInfo`1 is generic!
}
