...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(EventSource::Sha1ForNonSecretPurposes), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __System_Diagnostics_Tracing_EventSource_Sha1ForNonSecretPurposesSizeCheck;
}
