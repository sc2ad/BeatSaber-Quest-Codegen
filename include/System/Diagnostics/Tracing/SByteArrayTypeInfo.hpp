...
namespace System::Diagnostics::Tracing {
  ...
  class SByteArrayTypeInfo : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<::Array<int8_t>*> {
    public:
    // Creating value type constructor for type: SByteArrayTypeInfo
    SByteArrayTypeInfo() noexcept {}
    ...
    static SByteArrayTypeInfo* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Diagnostics::Tracing").WithContext("SByteArrayTypeInfo").WithContext(".ctor");
