...
namespace System::Diagnostics::Tracing {
  ...
  class ClassPropertyWriter_2 : public System::Diagnostics::Tracing::PropertyAccessor_1<ContainerType> {
    public:
    // Nested type: System::Diagnostics::Tracing::ClassPropertyWriter_2::Getter<ValueType, ContainerType>
    class Getter;
    ...
    class Getter : public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::MulticastDelegate {
      ...
      // Offset: 0x1612710
      static typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter* New_ctor(::Il2CppObject* object, System::IntPtr method) {
        return (typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter*>::get(), object, method)));
      }
    ...
    // Offset: 0x0
    typename System::Diagnostics::Tracing::ClassPropertyWriter_2<ValueType, ContainerType>::Getter* getter;
