...
namespace System::Diagnostics::Tracing {
  ...
  check_size<sizeof(EventSource::EventMetadata), 56 + sizeof(System::Diagnostics::Tracing::EventActivityOptions) + ((56 + sizeof(System::Diagnostics::Tracing::EventActivityOptions)) % 8 != 0 ? (8 - (56 + sizeof(System::Diagnostics::Tracing::EventActivityOptions)) % 8) : 0)> __System_Diagnostics_Tracing_EventSource_EventMetadataSizeCheck;
}
