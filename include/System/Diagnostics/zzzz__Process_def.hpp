...
namespace System::Diagnostics {
struct ____System__Diagnostics__Process__State;
}
namespace System::Diagnostics {
struct ____System__Diagnostics__Process__StreamReadMode;
}
namespace System::Diagnostics {
class Process;
}
namespace System::Diagnostics {
struct ____System__Diagnostics__Process__ProcInfo;
}
// Type: ::StreamReadMode
namespace System::Diagnostics {
// Is value type: true
...
struct CORDL_TYPE ____System__Diagnostics__Process__StreamReadMode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Diagnostics__Process__StreamReadMode(int32_t value__) noexcept;


                    constexpr ____System__Diagnostics__Process__StreamReadMode(____System__Diagnostics__Process__StreamReadMode const&) = default;
                    constexpr ____System__Diagnostics__Process__StreamReadMode(____System__Diagnostics__Process__StreamReadMode&&) = default;
                    constexpr ____System__Diagnostics__Process__StreamReadMode& operator=(____System__Diagnostics__Process__StreamReadMode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Diagnostics__Process__StreamReadMode& operator=(____System__Diagnostics__Process__StreamReadMode&& o) noexcept {
...
constexpr explicit ____System__Diagnostics__Process__StreamReadMode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Diagnostics__Process__StreamReadMode_Unwrapped : int32_t {
__undefined = 0,
__syncMode = 1,
__asyncMode = 2,
};
...
constexpr operator ______System__Diagnostics__Process__StreamReadMode_Unwrapped () const noexcept {
return std::bit_cast<______System__Diagnostics__Process__StreamReadMode_Unwrapped>(__instance);
}
...
static ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode const undefined;

/// @brief Field syncMode offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode const syncMode;

/// @brief Field asyncMode offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode const asyncMode;
...
struct CORDL_TYPE ____System__Diagnostics__Process__State : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Diagnostics__Process__State(int32_t value__) noexcept;


                    constexpr ____System__Diagnostics__Process__State(____System__Diagnostics__Process__State const&) = default;
                    constexpr ____System__Diagnostics__Process__State(____System__Diagnostics__Process__State&&) = default;
                    constexpr ____System__Diagnostics__Process__State& operator=(____System__Diagnostics__Process__State const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Diagnostics__Process__State& operator=(____System__Diagnostics__Process__State&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Diagnostics__Process__State(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Diagnostics__Process__State_Unwrapped : int32_t {
__HaveId = 1,
__IsLocal = 2,
__IsNt = 4,
__HaveProcessInfo = 8,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Diagnostics__Process__State_Unwrapped () const noexcept {
return std::bit_cast<______System__Diagnostics__Process__State_Unwrapped>(__instance);
}
...
static ::System::Diagnostics::____System__Diagnostics__Process__State const HaveId;

/// @brief Field IsLocal offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const IsLocal;

/// @brief Field IsNt offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const IsNt;

/// @brief Field HaveProcessInfo offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const HaveProcessInfo;

/// @brief Field Exited offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const Exited;

/// @brief Field Associated offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const Associated;

/// @brief Field IsWin2k offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const IsWin2k;

/// @brief Field HaveNtProcessInfo offset 0
static ::System::Diagnostics::____System__Diagnostics__Process__State const HaveNtProcessInfo;
...
struct CORDL_TYPE ____System__Diagnostics__Process__ProcInfo : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__Diagnostics__Process__ProcInfo(::cordl_internals::intptr_t process_handle, int32_t pid, ::ArrayW<::StringW> envVariables, ::StringW UserName, ::StringW Domain, ::cordl_internals::intptr_t Password, bool LoadUserProfile) noexcept;


                    constexpr ____System__Diagnostics__Process__ProcInfo(____System__Diagnostics__Process__ProcInfo const&) = default;
                    constexpr ____System__Diagnostics__Process__ProcInfo(____System__Diagnostics__Process__ProcInfo&&) = default;
                    constexpr ____System__Diagnostics__Process__ProcInfo& operator=(____System__Diagnostics__Process__ProcInfo const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Diagnostics__Process__ProcInfo& operator=(____System__Diagnostics__Process__ProcInfo&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Diagnostics__Process__ProcInfo(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using ProcInfo = ::System::Diagnostics::____System__Diagnostics__Process__ProcInfo;

using State = ::System::Diagnostics::____System__Diagnostics__Process__State;

using StreamReadMode = ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode;
...
constexpr bool __get_disposed() const;
 ...
 ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __declspec(property(get=__get_outputStreamReadMode, put=__set_outputStreamReadMode))  outputStreamReadMode;

constexpr void __set_outputStreamReadMode(::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode value) ;

constexpr ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __get_outputStreamReadMode() const;

 ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __declspec(property(get=__get_errorStreamReadMode, put=__set_errorStreamReadMode))  errorStreamReadMode;

constexpr void __set_errorStreamReadMode(::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode value) ;

constexpr ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __get_errorStreamReadMode() const;

 ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __declspec(property(get=__get_inputStreamReadMode, put=__set_inputStreamReadMode))  inputStreamReadMode;

constexpr void __set_inputStreamReadMode(::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode value) ;

constexpr ::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode __get_inputStreamReadMode() const;
...
/// @brief Method EnsureState addr 0x27dcec8 size 0x138 virtual false final false
 void EnsureState(::System::Diagnostics::____System__Diagnostics__Process__State state) ;
...
static bool ShellExecuteEx_internal(::System::Diagnostics::ProcessStartInfo startInfo, ByRef<::System::Diagnostics::____System__Diagnostics__Process__ProcInfo> procInfo) ;

/// @brief Method CreateProcess_internal addr 0x27e03b0 size 0x4 virtual false final false
static bool CreateProcess_internal(::System::Diagnostics::ProcessStartInfo startInfo, ::cordl_internals::intptr_t stdin, ::cordl_internals::intptr_t stdout, ::cordl_internals::intptr_t stderr, ByRef<::System::Diagnostics::____System__Diagnostics__Process__ProcInfo> procInfo) ;
...
static void FillUserInfo(::System::Diagnostics::ProcessStartInfo startInfo, ByRef<::System::Diagnostics::____System__Diagnostics__Process__ProcInfo> procInfo) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Diagnostics::____System__Diagnostics__Process__State, "System.Diagnostics", "Process/State");
DEFINE_IL2CPP_ARG_TYPE(::System::Diagnostics::____System__Diagnostics__Process__StreamReadMode, "System.Diagnostics", "Process/StreamReadMode");
NEED_NO_BOX(::System::Diagnostics::Process);
DEFINE_IL2CPP_ARG_TYPE(::System::Diagnostics::Process, "System.Diagnostics", "Process");
DEFINE_IL2CPP_ARG_TYPE(::System::Diagnostics::____System__Diagnostics__Process__ProcInfo, "System.Diagnostics", "Process/ProcInfo");
