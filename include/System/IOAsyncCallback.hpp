...
namespace System {
  ...
  class IOAsyncCallback : public System::MulticastDelegate {
    ...
    // Offset: 0xF51EB4
    static IOAsyncCallback* New_ctor(::CsObject* object, System::IntPtr method);
    ...
    // Offset: 0xF52280
    System::IAsyncResult* BeginInvoke(System::IOAsyncResult* ioares, System::AsyncCallback* callback, ::CsObject* object);
