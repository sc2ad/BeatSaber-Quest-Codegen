...
static System::InvalidOperationException New_ctor() ;

/// @brief Method .ctor addr 0x2440704 size 0x5c virtual false final false
 void _ctor() ;

static System::InvalidOperationException New_ctor(::StringW message) ;

/// @brief Method .ctor addr 0x2440760 size 0x24 virtual false final false
 void _ctor(::StringW message) ;

static System::InvalidOperationException New_ctor(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2440784 size 0x24 virtual false final false
 void _ctor(::StringW message, System::Exception innerException) ;

static System::InvalidOperationException New_ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method .ctor addr 0x24407a8 size 0x8 virtual false final false
