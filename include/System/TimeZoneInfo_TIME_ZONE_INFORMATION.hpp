...
namespace System {
  ...
  check_size<sizeof(TimeZoneInfo::TIME_ZONE_INFORMATION), 64 + sizeof(int) + ((64 + sizeof(int)) % 8 != 0 ? (8 - (64 + sizeof(int)) % 8) : 0)> __System_TimeZoneInfo_TIME_ZONE_INFORMATIONSizeCheck;
}
