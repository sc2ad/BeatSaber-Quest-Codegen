...
namespace System::Net {
  ...
  check_size<sizeof(HttpListenerPrefixCollection), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Net_HttpListenerPrefixCollectionSizeCheck;
}
