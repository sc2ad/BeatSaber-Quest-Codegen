...
constexpr ::StringW System::Net::Sockets::SendPacketsElement::__get_m_FilePath() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Net::Sockets::SendPacketsElement::__set_m_Buffer(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> System::Net::Sockets::SendPacketsElement::__get_m_Buffer() const {
...
constexpr int32_t System::Net::Sockets::SendPacketsElement::__get_m_Offset() const {
...
constexpr int32_t System::Net::Sockets::SendPacketsElement::__get_m_Count() const {
...
constexpr bool System::Net::Sockets::SendPacketsElement::__get_m_endOfPacket() const {
