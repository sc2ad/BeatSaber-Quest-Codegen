...
namespace System::Net {
  ...
  check_size<sizeof(WebRequest), 28 + sizeof(System::Security::Principal::TokenImpersonationLevel) + ((28 + sizeof(System::Security::Principal::TokenImpersonationLevel)) % 8 != 0 ? (8 - (28 + sizeof(System::Security::Principal::TokenImpersonationLevel)) % 8) : 0)> __System_Net_WebRequestSizeCheck;
}
