...
namespace System::Net {
  ...
  class HttpWebRequest : public System::Net::WebRequest {
    ...
    check_size<sizeof(HttpWebRequest::NtlmAuthState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_HttpWebRequest_NtlmAuthStateSizeCheck;
    ...
    check_size<sizeof(HttpWebRequest::AuthorizationState), 12 + sizeof(System::Net::HttpWebRequest::NtlmAuthState) + ((12 + sizeof(System::Net::HttpWebRequest::NtlmAuthState)) % 8 != 0 ? (8 - (12 + sizeof(System::Net::HttpWebRequest::NtlmAuthState)) % 8) : 0)> __System_Net_HttpWebRequest_AuthorizationStateSizeCheck;
  ...
  check_size<sizeof(HttpWebRequest), 416 + sizeof(void*) + ((416 + sizeof(void*)) % 8 != 0 ? (8 - (416 + sizeof(void*)) % 8) : 0)> __System_Net_HttpWebRequestSizeCheck;
}
