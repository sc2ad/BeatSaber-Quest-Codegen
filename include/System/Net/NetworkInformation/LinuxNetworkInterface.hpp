...
namespace System::Net::NetworkInformation {
  ...
  check_size<sizeof(LinuxNetworkInterface), 72 + sizeof(void*) + ((72 + sizeof(void*)) % 8 != 0 ? (8 - (72 + sizeof(void*)) % 8) : 0)> __System_Net_NetworkInformation_LinuxNetworkInterfaceSizeCheck;
}
