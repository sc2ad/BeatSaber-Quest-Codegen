...
constexpr ::System::Net::NetworkInformation::in6_addr::in6_addr(::ArrayW<uint8_t> u6_addr8) noexcept : ::bs_hook::ValueTypeWrapper() {this->u6_addr8 = u6_addr8;
}
constexpr void ::System::Net::NetworkInformation::in6_addr::__set_u6_addr8(::ArrayW<uint8_t> value)  {
::cordl_internals::setInstanceField<::ArrayW<uint8_t>, 0x0>(this->__instance, std::forward<::ArrayW<uint8_t>>(value));
}
constexpr ::ArrayW<uint8_t> ::System::Net::NetworkInformation::in6_addr::__get_u6_addr8() const {
