...
namespace System::Net::NetworkInformation {
  ...
  check_size<sizeof(DuplicateAddressDetectionState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Net_NetworkInformation_DuplicateAddressDetectionStateSizeCheck;
}
