...
namespace System::Net::NetworkInformation {
  ...
  check_size<sizeof(ifa_ifu), 0 + sizeof(System::IntPtr) + ((0 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (0 + sizeof(System::IntPtr)) % 8) : 0)> __System_Net_NetworkInformation_ifa_ifuSizeCheck;
}
