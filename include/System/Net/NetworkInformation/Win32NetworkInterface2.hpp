...
namespace System::Net::NetworkInformation {
  ...
  check_size<sizeof(Win32NetworkInterface2), 512 + sizeof(void*) + ((512 + sizeof(void*)) % 8 != 0 ? (8 - (512 + sizeof(void*)) % 8) : 0)> __System_Net_NetworkInformation_Win32NetworkInterface2SizeCheck;
}
