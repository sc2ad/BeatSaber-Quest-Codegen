...
namespace System::Net::NetworkInformation {
  ...
  check_size<sizeof(SystemGatewayIPAddressInformation), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Net_NetworkInformation_SystemGatewayIPAddressInformationSizeCheck;
}
