...
namespace System::Net::Http {
  ...
  // [CompilerGeneratedAttribute] Offset: DE5A00
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Net::Http::HttpClient::$SendAsyncWorker$d__47::*)(System::Runtime::CompilerServices::IAsyncStateMachine*)>(&System::Net::Http::HttpClient::$SendAsyncWorker$d__47::SetStateMachine)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Net::Http::HttpClient::$SendAsyncWorker$d__47), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::CompilerServices::IAsyncStateMachine*>()});
  }
};
