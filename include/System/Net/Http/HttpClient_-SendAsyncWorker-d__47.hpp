...
namespace System::Net::Http {
  ...
  check_size<sizeof(HttpClient::$SendAsyncWorker$d__47), 96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter) + ((96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8 != 0 ? (8 - (96 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8) : 0)> __System_Net_Http_HttpClient_$SendAsyncWorker$d__47SizeCheck;
}
