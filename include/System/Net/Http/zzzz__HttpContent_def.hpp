...
namespace System::Net::Http {
class ____System__Net__Http__HttpContent__FixedMemoryStream;
}
namespace System::Net::Http {
struct ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17;
}
namespace System::Net::Http {
struct ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20;
}
...
class CORDL_TYPE ____System__Net__Http__HttpContent__FixedMemoryStream : public ::System::IO::MemoryStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x58};

virtual ~____System__Net__Http__HttpContent__FixedMemoryStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Http__HttpContent__FixedMemoryStream", modifiers: " const&", def_value: None }]
constexpr ____System__Net__Http__HttpContent__FixedMemoryStream(____System__Net__Http__HttpContent__FixedMemoryStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Http__HttpContent__FixedMemoryStream", modifiers: "&&", def_value: None }]
constexpr ____System__Net__Http__HttpContent__FixedMemoryStream(____System__Net__Http__HttpContent__FixedMemoryStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__Http__HttpContent__FixedMemoryStream(void* ptr) noexcept : ::System::IO::MemoryStream(ptr) {
}


  constexpr ____System__Net__Http__HttpContent__FixedMemoryStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__Http__HttpContent__FixedMemoryStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__Http__HttpContent__FixedMemoryStream& operator=(____System__Net__Http__HttpContent__FixedMemoryStream&& o) noexcept = default;
  constexpr ____System__Net__Http__HttpContent__FixedMemoryStream& operator=(____System__Net__Http__HttpContent__FixedMemoryStream const& o) noexcept = default;
...
explicit ____System__Net__Http__HttpContent__FixedMemoryStream(int64_t maxSize) ;
...
struct CORDL_TYPE ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::Http::HttpContent", modifiers: "", def_value: None }, CppParam { name: "maxBufferSize", ty: "int64_t", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::System::Net::Http::HttpContent __4__this, int64_t maxBufferSize, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1) noexcept;


                    constexpr ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17(____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17 const&) = default;
                    constexpr ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17(____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17&&) = default;
                    constexpr ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17& operator=(____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17& operator=(____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17&& o) noexcept {
...
constexpr explicit ____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::StringW> __t__builder, ::System::Net::Http::HttpContent __4__this, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1) noexcept;


                    constexpr ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20(____System__Net__Http__HttpContent___ReadAsStringAsync_d__20 const&) = default;
                    constexpr ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20(____System__Net__Http__HttpContent___ReadAsStringAsync_d__20&&) = default;
                    constexpr ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20& operator=(____System__Net__Http__HttpContent___ReadAsStringAsync_d__20 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20& operator=(____System__Net__Http__HttpContent___ReadAsStringAsync_d__20&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__Http__HttpContent___ReadAsStringAsync_d__20(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using _ReadAsStringAsync_d__20 = ::System::Net::Http::____System__Net__Http__HttpContent___ReadAsStringAsync_d__20;

using _LoadIntoBufferAsync_d__17 = ::System::Net::Http::____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17;

using FixedMemoryStream = ::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream;
...
// Fields
 ...
 ::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream __declspec(property(get=__get_buffer, put=__set_buffer))  buffer;

constexpr void __set_buffer(::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream value) ;

constexpr ::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream __get_buffer() const;
...
static ::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream CreateFixedMemoryStream(int64_t maxBufferSize) ;
...
NEED_NO_BOX(::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpContent__FixedMemoryStream, "System.Net.Http", "HttpContent/FixedMemoryStream");
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpContent___LoadIntoBufferAsync_d__17, "System.Net.Http", "HttpContent/<LoadIntoBufferAsync>d__17");
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpContent___ReadAsStringAsync_d__20, "System.Net.Http", "HttpContent/<ReadAsStringAsync>d__20");
