...
namespace System::Net::Http::Headers {
  ...
  check_size<sizeof(RangeConditionHeaderValue), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __System_Net_Http_Headers_RangeConditionHeaderValueSizeCheck;
}
