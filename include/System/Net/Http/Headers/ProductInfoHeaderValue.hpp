...
namespace System::Net::Http::Headers {
  ...
  check_size<sizeof(ProductInfoHeaderValue), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Net_Http_Headers_ProductInfoHeaderValueSizeCheck;
}
