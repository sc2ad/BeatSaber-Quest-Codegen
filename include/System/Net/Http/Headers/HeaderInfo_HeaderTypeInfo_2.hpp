...
namespace System::Net::Http::Headers {
  ...
  class HeaderInfo::HeaderTypeInfo_2 : public System::Net::Http::Headers::HeaderInfo {
    ...
    void AddToCollection(::Il2CppObject* collection, ::Il2CppObject* value) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "AddToCollection", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(collection, value)));
    ...
    ::Il2CppObject* CreateCollection(System::Net::Http::Headers::HttpHeaders* headers, System::Net::Http::Headers::HeaderInfo* headerInfo) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "CreateCollection", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(headers, headerInfo)));
    ...
    System::Collections::Generic::List_1<::Il2CppString*>* ToStringCollection(::Il2CppObject* collection) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "ToStringCollection", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(collection)));
