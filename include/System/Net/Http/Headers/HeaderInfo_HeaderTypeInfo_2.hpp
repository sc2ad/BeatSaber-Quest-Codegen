...
namespace System::Net::Http::Headers {
  ...
  class HeaderInfo::HeaderTypeInfo_2 : public System::Net::Http::Headers::HeaderInfo {
    ...
    System::Net::Http::Headers::TryParseDelegate_1<T>* _get_parser() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Net::Http::Headers::HeaderInfo::HeaderTypeInfo_2::_get_parser");
    ...
    // Set instance field: private readonly System.Net.Http.Headers.TryParseDelegate`1<T> parser
    void _set_parser(System::Net::Http::Headers::TryParseDelegate_1<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Net::Http::Headers::HeaderInfo::HeaderTypeInfo_2::_set_parser");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "parser"))->offset;
      *reinterpret_cast<System::Net::Http::Headers::TryParseDelegate_1<T>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
