...
namespace System::Net::Http::Headers {
  ...
  check_size<sizeof(StringWithQualityHeaderValue), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __System_Net_Http_Headers_StringWithQualityHeaderValueSizeCheck;
}
