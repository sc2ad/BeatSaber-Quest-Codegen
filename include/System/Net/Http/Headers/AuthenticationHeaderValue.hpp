...
namespace System::Net::Http::Headers {
  ...
  check_size<sizeof(AuthenticationHeaderValue), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Net_Http_Headers_AuthenticationHeaderValueSizeCheck;
}
