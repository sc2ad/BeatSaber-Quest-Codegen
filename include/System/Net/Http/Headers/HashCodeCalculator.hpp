...
namespace System::Net::Http::Headers {
  // Forward declaring type: HashCodeCalculator
...
namespace System::Net::Http::Headers {
  ...
  class HashCodeCalculator : public ::Il2CppObject {
    ...
    static int Calculate(System::Collections::Generic::ICollection_1<T>* list) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, list)));
    }
