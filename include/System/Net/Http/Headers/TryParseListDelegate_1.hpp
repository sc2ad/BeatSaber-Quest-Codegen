...
namespace System::Net::Http::Headers {
  ...
  class TryParseListDelegate_1 : public System::MulticastDelegate {
    ...
    bool Invoke(::Il2CppString* value, int minimalCount, ByRef<System::Collections::Generic::List_1<T>*> result) {
      ...
      return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, value, minimalCount, byref(result));
    }
    ...
    System::IAsyncResult* BeginInvoke(::Il2CppString* value, int minimalCount, ByRef<System::Collections::Generic::List_1<T>*> result, System::AsyncCallback* callback, ::Il2CppObject* object) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<System::IAsyncResult*, false>(___instance_arg, ___internal__method, value, minimalCount, byref(result), callback, object);
    }
    ...
    bool EndInvoke(ByRef<System::Collections::Generic::List_1<T>*> result, System::IAsyncResult* __result) {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<bool, false>(___instance_arg, ___internal__method, byref(result), __result);
    }
