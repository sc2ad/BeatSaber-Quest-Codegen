...
namespace System::Net::Http::Headers {
  ...
  class TryParseListDelegate_1 : public System::MulticastDelegate {
    ...
    bool Invoke(::Il2CppString* value, int minimalCount, ByRef<System::Collections::Generic::List_1<T>*> result) {
      ...
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, value, minimalCount, byref(result));
    }
    ...
    System::IAsyncResult* BeginInvoke(::Il2CppString* value, int minimalCount, ByRef<System::Collections::Generic::List_1<T>*> result, System::AsyncCallback* callback, ::Il2CppObject* object) {
      ...
      return ::il2cpp_utils::RunMethodThrow<System::IAsyncResult*, false>(this, ___internal__method, value, minimalCount, byref(result), callback, object);
    }
