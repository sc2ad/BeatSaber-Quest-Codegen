...
namespace System::Net::Http::Headers {
  ...
  struct Token : public System::ValueType {
    ...
    check_size<sizeof(Token::Type), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_Http_Headers_Token_TypeSizeCheck;
  ...
  check_size<sizeof(Token), 8 + sizeof(int) + ((8 + sizeof(int)) % 8 != 0 ? (8 - (8 + sizeof(int)) % 8) : 0)> __System_Net_Http_Headers_TokenSizeCheck;
}
