...
namespace System::Net::Http::Headers {
  ...
  class Parser::MD5 : public ::Il2CppObject {
    ...
    // Offset: 0x1754CAC
    static bool TryParse(::Il2CppString* input, ByRef<::ArrayWrapper<uint8_t>> result);
...
// Il2CppName: TryParse
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::Il2CppString*, ByRef<::ArrayWrapper<uint8_t>>)>(&System::Net::Http::Headers::Parser::MD5::TryParse)> {
  static const MethodInfo* get() {
