...
namespace System::Net::Http {
struct ____System__Net__Http__HttpClient___GetStringAsync_d__53;
}
namespace System::Net::Http {
struct ____System__Net__Http__HttpClient___SendAsyncWorker_d__47;
}
...
constexpr explicit ____System__Net__Http__HttpClient___SendAsyncWorker_d__47(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::System::Net::Http::HttpResponseMessage __get__response_5__3() const;
 ...
 ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage> __declspec(property(get=__get___u__1, put=__set___u__1))  __u__1;

constexpr void __set___u__1(::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage> value) ;

constexpr ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage> __get___u__1() const;
...
struct CORDL_TYPE ____System__Net__Http__HttpClient___GetStringAsync_d__53 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::StringW>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Net::Http::HttpClient", modifiers: "", def_value: None }, CppParam { name: "requestUri", ty: "::System::Uri", modifiers: "", def_value: None }, CppParam { name: "_resp_5__2", ty: "::System::Net::Http::HttpResponseMessage", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::StringW>", modifiers: "", def_value: None }]
constexpr ____System__Net__Http__HttpClient___GetStringAsync_d__53(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::StringW> __t__builder, ::System::Net::Http::HttpClient __4__this, ::System::Uri requestUri, ::System::Net::Http::HttpResponseMessage _resp_5__2, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage> __u__1, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::StringW> __u__2) noexcept;


                    constexpr ____System__Net__Http__HttpClient___GetStringAsync_d__53(____System__Net__Http__HttpClient___GetStringAsync_d__53 const&) = default;
                    constexpr ____System__Net__Http__HttpClient___GetStringAsync_d__53(____System__Net__Http__HttpClient___GetStringAsync_d__53&&) = default;
                    constexpr ____System__Net__Http__HttpClient___GetStringAsync_d__53& operator=(____System__Net__Http__HttpClient___GetStringAsync_d__53 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__Http__HttpClient___GetStringAsync_d__53& operator=(____System__Net__Http__HttpClient___GetStringAsync_d__53&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__Http__HttpClient___GetStringAsync_d__53(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Net::Http::HttpResponseMessage> __get___u__1() const;
 ...
 ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::StringW> __declspec(property(get=__get___u__2, put=__set___u__2))  __u__2;

constexpr void __set___u__2(::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::StringW> value) ;

constexpr ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::StringW> __get___u__2() const;
...
public:
// Declarations
using _GetStringAsync_d__53 = ::System::Net::Http::____System__Net__Http__HttpClient___GetStringAsync_d__53;

using _SendAsyncWorker_d__47 = ::System::Net::Http::____System__Net__Http__HttpClient___SendAsyncWorker_d__47;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpClient___GetStringAsync_d__53, "System.Net.Http", "HttpClient/<GetStringAsync>d__53");
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpClient___SendAsyncWorker_d__47, "System.Net.Http", "HttpClient/<SendAsyncWorker>d__47");
