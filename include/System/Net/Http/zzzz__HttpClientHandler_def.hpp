...
namespace System::Net::Http {
class ____System__Net__Http__HttpClientHandler____c;
}
// Type: ::<>c
namespace System::Net::Http {
// Is value type: false
...
class CORDL_TYPE ____System__Net__Http__HttpClientHandler____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__Net__Http__HttpClientHandler____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Http__HttpClientHandler____c", modifiers: " const&", def_value: None }]
constexpr ____System__Net__Http__HttpClientHandler____c(____System__Net__Http__HttpClientHandler____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Http__HttpClientHandler____c", modifiers: "&&", def_value: None }]
constexpr ____System__Net__Http__HttpClientHandler____c(____System__Net__Http__HttpClientHandler____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__Http__HttpClientHandler____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Net__Http__HttpClientHandler____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__Http__HttpClientHandler____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__Http__HttpClientHandler____c& operator=(____System__Net__Http__HttpClientHandler____c&& o) noexcept = default;
  constexpr ____System__Net__Http__HttpClientHandler____c& operator=(____System__Net__Http__HttpClientHandler____c const& o) noexcept = default;
                


// Fields

static ::System::Net::Http::____System__Net__Http__HttpClientHandler____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::System::Net::Http::____System__Net__Http__HttpClientHandler____c value) ;

static ::System::Net::Http::____System__Net__Http__HttpClientHandler____c __get___9() ;
...
// Ctor Parameters []
explicit ____System__Net__Http__HttpClientHandler____c() ;
...
public:
// Declarations
using __c = ::System::Net::Http::____System__Net__Http__HttpClientHandler____c;
...
NEED_NO_BOX(::System::Net::Http::____System__Net__Http__HttpClientHandler____c);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::Http::____System__Net__Http__HttpClientHandler____c, "System.Net.Http", "HttpClientHandler/<>c");
