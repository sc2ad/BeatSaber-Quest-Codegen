...
namespace System::Net {
  ...
  class HttpConnection : public ::Il2CppObject {
    ...
    check_size<sizeof(HttpConnection::InputState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Net_HttpConnection_InputStateSizeCheck;
    ...
    check_size<sizeof(HttpConnection::LineState), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Net_HttpConnection_LineStateSizeCheck;
  ...
  check_size<sizeof(HttpConnection), 184 + sizeof(int) + 8 - (184 + sizeof(int)) % 8> __System_Net_HttpConnectionSizeCheck;
}
