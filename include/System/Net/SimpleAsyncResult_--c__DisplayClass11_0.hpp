...
namespace System::Net {
  ...
  check_size<sizeof(SimpleAsyncResult::$$c__DisplayClass11_0), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __System_Net_SimpleAsyncResult_$$c__DisplayClass11_0SizeCheck;
}
