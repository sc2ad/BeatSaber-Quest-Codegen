...
namespace System::Net {
class ____System__Net__NetEventSource__Keywords;
}
// Type: ::Keywords
namespace System::Net {
// Is value type: false
...
class CORDL_TYPE ____System__Net__NetEventSource__Keywords : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__Net__NetEventSource__Keywords() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__NetEventSource__Keywords", modifiers: " const&", def_value: None }]
constexpr ____System__Net__NetEventSource__Keywords(____System__Net__NetEventSource__Keywords const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__NetEventSource__Keywords", modifiers: "&&", def_value: None }]
constexpr ____System__Net__NetEventSource__Keywords(____System__Net__NetEventSource__Keywords&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__NetEventSource__Keywords(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Net__NetEventSource__Keywords& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__NetEventSource__Keywords& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__NetEventSource__Keywords& operator=(____System__Net__NetEventSource__Keywords&& o) noexcept = default;
  constexpr ____System__Net__NetEventSource__Keywords& operator=(____System__Net__NetEventSource__Keywords const& o) noexcept = default;
...
public:
// Declarations
using Keywords = ::System::Net::____System__Net__NetEventSource__Keywords;
...
NEED_NO_BOX(::System::Net::____System__Net__NetEventSource__Keywords);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__NetEventSource__Keywords, "System.Net", "NetEventSource/Keywords");
