...
struct ____System__Net__HttpListenerRequestUriBuilder__EncodingType;
}
namespace System::Net {
struct ____System__Net__HttpListenerRequestUriBuilder__ParsingResult;
}
namespace System::Net {
...
struct CORDL_TYPE ____System__Net__HttpListenerRequestUriBuilder__ParsingResult : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Net__HttpListenerRequestUriBuilder__ParsingResult(int32_t value__) noexcept;


                    constexpr ____System__Net__HttpListenerRequestUriBuilder__ParsingResult(____System__Net__HttpListenerRequestUriBuilder__ParsingResult const&) = default;
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__ParsingResult(____System__Net__HttpListenerRequestUriBuilder__ParsingResult&&) = default;
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__ParsingResult& operator=(____System__Net__HttpListenerRequestUriBuilder__ParsingResult const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__ParsingResult& operator=(____System__Net__HttpListenerRequestUriBuilder__ParsingResult&& o) noexcept {
...
constexpr explicit ____System__Net__HttpListenerRequestUriBuilder__ParsingResult(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Net__HttpListenerRequestUriBuilder__ParsingResult_Unwrapped : int32_t {
__Success = 0,
__InvalidString = 1,
__EncodingError = 2,
};
...
constexpr operator ______System__Net__HttpListenerRequestUriBuilder__ParsingResult_Unwrapped () const noexcept {
return std::bit_cast<______System__Net__HttpListenerRequestUriBuilder__ParsingResult_Unwrapped>(__instance);
}
...
static ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult const Success;

/// @brief Field InvalidString offset 0
static ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult const InvalidString;

/// @brief Field EncodingError offset 0
static ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult const EncodingError;
...
struct CORDL_TYPE ____System__Net__HttpListenerRequestUriBuilder__EncodingType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Net__HttpListenerRequestUriBuilder__EncodingType(int32_t value__) noexcept;


                    constexpr ____System__Net__HttpListenerRequestUriBuilder__EncodingType(____System__Net__HttpListenerRequestUriBuilder__EncodingType const&) = default;
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__EncodingType(____System__Net__HttpListenerRequestUriBuilder__EncodingType&&) = default;
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__EncodingType& operator=(____System__Net__HttpListenerRequestUriBuilder__EncodingType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__HttpListenerRequestUriBuilder__EncodingType& operator=(____System__Net__HttpListenerRequestUriBuilder__EncodingType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__HttpListenerRequestUriBuilder__EncodingType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Net__HttpListenerRequestUriBuilder__EncodingType_Unwrapped : int32_t {
__Primary = 0,
__Secondary = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Net__HttpListenerRequestUriBuilder__EncodingType_Unwrapped () const noexcept {
return std::bit_cast<______System__Net__HttpListenerRequestUriBuilder__EncodingType_Unwrapped>(__instance);
}
...
static ::System::Net::____System__Net__HttpListenerRequestUriBuilder__EncodingType const Primary;

/// @brief Field Secondary offset 0
static ::System::Net::____System__Net__HttpListenerRequestUriBuilder__EncodingType const Secondary;
...
public:
// Declarations
using EncodingType = ::System::Net::____System__Net__HttpListenerRequestUriBuilder__EncodingType;

using ParsingResult = ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult;
...
static ::System::Text::Encoding GetEncoding(::System::Net::____System__Net__HttpListenerRequestUriBuilder__EncodingType type) ;

/// @brief Method BuildRequestUriUsingRawPath addr 0x280ad28 size 0x250 virtual false final false
 ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult BuildRequestUriUsingRawPath(::System::Text::Encoding encoding) ;

/// @brief Method ParseRawPath addr 0x280af78 size 0x150 virtual false final false
 ::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult ParseRawPath(::System::Text::Encoding encoding) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__HttpListenerRequestUriBuilder__EncodingType, "System.Net", "HttpListenerRequestUriBuilder/EncodingType");
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__HttpListenerRequestUriBuilder__ParsingResult, "System.Net", "HttpListenerRequestUriBuilder/ParsingResult");
