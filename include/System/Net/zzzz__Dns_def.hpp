...
namespace System::Net {
class ____System__Net__Dns__GetHostAddressesCallback;
}
...
class CORDL_TYPE ____System__Net__Dns__GetHostAddressesCallback : public ::System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~____System__Net__Dns__GetHostAddressesCallback() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Dns__GetHostAddressesCallback", modifiers: " const&", def_value: None }]
constexpr ____System__Net__Dns__GetHostAddressesCallback(____System__Net__Dns__GetHostAddressesCallback const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__Dns__GetHostAddressesCallback", modifiers: "&&", def_value: None }]
constexpr ____System__Net__Dns__GetHostAddressesCallback(____System__Net__Dns__GetHostAddressesCallback&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__Dns__GetHostAddressesCallback(void* ptr) noexcept : ::System::MulticastDelegate(ptr) {
}


  constexpr ____System__Net__Dns__GetHostAddressesCallback& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__Dns__GetHostAddressesCallback& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__Dns__GetHostAddressesCallback& operator=(____System__Net__Dns__GetHostAddressesCallback&& o) noexcept = default;
  constexpr ____System__Net__Dns__GetHostAddressesCallback& operator=(____System__Net__Dns__GetHostAddressesCallback const& o) noexcept = default;
...
explicit ____System__Net__Dns__GetHostAddressesCallback(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
...
public:
// Declarations
using GetHostAddressesCallback = ::System::Net::____System__Net__Dns__GetHostAddressesCallback;
...
NEED_NO_BOX(::System::Net::____System__Net__Dns__GetHostAddressesCallback);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__Dns__GetHostAddressesCallback, "System.Net", "Dns/GetHostAddressesCallback");
