...
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar::____System__Net__WebHeaderCollection__RfcChar(uint8_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::System::Net::____System__Net__WebHeaderCollection__RfcChar::__set_value__(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t ::System::Net::____System__Net__WebHeaderCollection__RfcChar::__get_value__() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->__instance);
}
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::High{0u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::Reg{1u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::Ctl{2u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::CR{3u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::LF{4u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::WS{5u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::Colon{6u};
constexpr ::System::Net::____System__Net__WebHeaderCollection__RfcChar  ::System::Net::____System__Net__WebHeaderCollection__RfcChar::Delim{7u};
...
return ::cordl_internals::getStaticField<::ArrayW<char16_t>, "HttpTrimCharacters", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::WebHeaderCollection>::get>();
 ...
 void ::System::Net::WebHeaderCollection::__set_RfcCharMap(::ArrayW<::System::Net::____System__Net__WebHeaderCollection__RfcChar> value)  {
::cordl_internals::setStaticField<::ArrayW<::System::Net::____System__Net__WebHeaderCollection__RfcChar>, "RfcCharMap", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::WebHeaderCollection>::get>(std::forward<::ArrayW<::System::Net::____System__Net__WebHeaderCollection__RfcChar>>(value));
}
 ::ArrayW<::System::Net::____System__Net__WebHeaderCollection__RfcChar> ::System::Net::WebHeaderCollection::__get_RfcCharMap()  {
return ::cordl_internals::getStaticField<::ArrayW<::System::Net::____System__Net__WebHeaderCollection__RfcChar>, "RfcCharMap", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Net::WebHeaderCollection>::get>();
}
