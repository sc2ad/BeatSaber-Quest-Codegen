...
struct CORDL_TYPE System__Net__CookieCollection__Stamp : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr System__Net__CookieCollection__Stamp(int32_t value__) noexcept;


                    constexpr System__Net__CookieCollection__Stamp(System__Net__CookieCollection__Stamp const&) = default;
                    constexpr System__Net__CookieCollection__Stamp(System__Net__CookieCollection__Stamp&&) = default;
                    constexpr System__Net__CookieCollection__Stamp& operator=(System__Net__CookieCollection__Stamp const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Net__CookieCollection__Stamp& operator=(System__Net__CookieCollection__Stamp&& o) noexcept {
...
constexpr explicit System__Net__CookieCollection__Stamp(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __System__Net__CookieCollection__Stamp_Unwrapped : int32_t {
__Check = 0,
__Set = 1,
__SetToUnused = 2,
__SetToMaxUsed = 3,
...
static System::Net::System__Net__CookieCollection__Stamp const Check;

/// @brief Field Set offset 0
static System::Net::System__Net__CookieCollection__Stamp const Set;

/// @brief Field SetToUnused offset 0
static System::Net::System__Net__CookieCollection__Stamp const SetToUnused;

/// @brief Field SetToMaxUsed offset 0
static System::Net::System__Net__CookieCollection__Stamp const SetToMaxUsed;
...
class CORDL_TYPE System__Net__CookieCollection__CookieCollectionEnumerator : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~System__Net__CookieCollection__CookieCollectionEnumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__CookieCollection__CookieCollectionEnumerator", modifiers: " const&", def_value: None }]
constexpr System__Net__CookieCollection__CookieCollectionEnumerator(System__Net__CookieCollection__CookieCollectionEnumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__CookieCollection__CookieCollectionEnumerator", modifiers: "&&", def_value: None }]
constexpr System__Net__CookieCollection__CookieCollectionEnumerator(System__Net__CookieCollection__CookieCollectionEnumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Net__CookieCollection__CookieCollectionEnumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Net__CookieCollection__CookieCollectionEnumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Net__CookieCollection__CookieCollectionEnumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Net__CookieCollection__CookieCollectionEnumerator& operator=(System__Net__CookieCollection__CookieCollectionEnumerator&& o) noexcept = default;
  constexpr System__Net__CookieCollection__CookieCollectionEnumerator& operator=(System__Net__CookieCollection__CookieCollectionEnumerator const& o) noexcept = default;
...
public:
// Declarations
using CookieCollectionEnumerator = System::Net::System__Net__CookieCollection__CookieCollectionEnumerator;

using Stamp = System::Net::System__Net__CookieCollection__Stamp;
...
/// @brief Method TimeStamp addr 0x281cffc size 0xc0 virtual false final false
 System::DateTime TimeStamp(System::Net::System__Net__CookieCollection__Stamp how) ;
...
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__CookieCollection__Stamp, "System.Net", "CookieCollection/Stamp");
NEED_NO_BOX(System::Net::CookieCollection);
DEFINE_IL2CPP_ARG_TYPE(System::Net::CookieCollection, "System.Net", "CookieCollection");
NEED_NO_BOX(System::Net::System__Net__CookieCollection__CookieCollectionEnumerator);
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__CookieCollection__CookieCollectionEnumerator, "System.Net", "CookieCollection/CookieCollectionEnumerator");
