...
namespace System::Net {
  ...
  check_size<sizeof(WebRequest::WebProxyWrapperOpaque), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Net_WebRequest_WebProxyWrapperOpaqueSizeCheck;
}
