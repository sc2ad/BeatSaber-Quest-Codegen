...
namespace System::Net {
  ...
  class AuthenticationSchemeSelector : public System::MulticastDelegate {
    ...
    // Offset: 0x14C23D0
    System::Net::AuthenticationSchemes Invoke_NEW(System::Net::HttpListenerRequest* httpRequest);
    ...
    // Offset: 0x14C276C
    System::IAsyncResult* BeginInvoke_NEW(System::Net::HttpListenerRequest* httpRequest, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Net.AuthenticationSchemes EndInvoke(System.IAsyncResult result)
    // Offset: 0x14C2790
    System::Net::AuthenticationSchemes EndInvoke_NEW(System::IAsyncResult* result);
