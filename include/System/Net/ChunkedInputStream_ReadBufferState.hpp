...
namespace System::Net {
  ...
  check_size<sizeof(ChunkedInputStream::ReadBufferState), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __System_Net_ChunkedInputStream_ReadBufferStateSizeCheck;
}
