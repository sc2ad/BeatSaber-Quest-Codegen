...
namespace System::Net {
  ...
  class WebConnection : public ::Il2CppObject {
    ...
    check_size<sizeof(WebConnection::NtlmAuthState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_WebConnection_NtlmAuthStateSizeCheck;
  ...
  check_size<sizeof(WebConnection), 168 + sizeof(void*) + ((168 + sizeof(void*)) % 8 != 0 ? (8 - (168 + sizeof(void*)) % 8) : 0)> __System_Net_WebConnectionSizeCheck;
}
