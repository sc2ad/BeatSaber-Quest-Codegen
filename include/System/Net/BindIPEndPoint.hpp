...
namespace System::Net {
  ...
  class BindIPEndPoint : public System::MulticastDelegate {
    ...
    // Offset: 0x14C2E38
    System::Net::IPEndPoint* Invoke_NEW(System::Net::ServicePoint* servicePoint, System::Net::IPEndPoint* remoteEndPoint, int retryCount);
    ...
    // Offset: 0x14C3250
    System::IAsyncResult* BeginInvoke_NEW(System::Net::ServicePoint* servicePoint, System::Net::IPEndPoint* remoteEndPoint, int retryCount, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Net.IPEndPoint EndInvoke(System.IAsyncResult result)
    // Offset: 0x14C32F0
    System::Net::IPEndPoint* EndInvoke_NEW(System::IAsyncResult* result);
