...
namespace System::Net::Configuration {
  ...
  class ConnectionManagementSection : public System::Configuration::ConfigurationSection {
    ...
    static ConnectionManagementSection* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net::Configuration").WithContext("ConnectionManagementSection").WithContext(".ctor");
