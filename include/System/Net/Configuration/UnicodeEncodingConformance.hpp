...
namespace System::Net::Configuration {
  ...
  check_size<sizeof(UnicodeEncodingConformance), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_Configuration_UnicodeEncodingConformanceSizeCheck;
}
