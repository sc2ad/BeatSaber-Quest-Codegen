...
namespace System::Net::Configuration {
  ...
  class BypassElementCollection : public System::Configuration::ConfigurationElementCollection {
    ...
    static BypassElementCollection* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Net::Configuration").WithContext("BypassElementCollection").WithContext(".ctor");
