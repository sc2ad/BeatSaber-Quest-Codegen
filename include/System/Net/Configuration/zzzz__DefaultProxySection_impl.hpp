...
// Ctor Parameters []
 System::Net::Configuration::DefaultProxySection::DefaultProxySection()  : System::Configuration::ConfigurationSection(THROW_UNLESS(::il2cpp_utils::New<DefaultProxySection>())) {}
