...
namespace System::Net::Configuration {
  ...
  check_size<sizeof(UnicodeDecodingConformance), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_Configuration_UnicodeDecodingConformanceSizeCheck;
}
