...
namespace System::Net {
class ____System__Net__ServerCertValidationCallback__CallbackContext;
}
...
class CORDL_TYPE ____System__Net__ServerCertValidationCallback__CallbackContext : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~____System__Net__ServerCertValidationCallback__CallbackContext() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__ServerCertValidationCallback__CallbackContext", modifiers: " const&", def_value: None }]
constexpr ____System__Net__ServerCertValidationCallback__CallbackContext(____System__Net__ServerCertValidationCallback__CallbackContext const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__ServerCertValidationCallback__CallbackContext", modifiers: "&&", def_value: None }]
constexpr ____System__Net__ServerCertValidationCallback__CallbackContext(____System__Net__ServerCertValidationCallback__CallbackContext&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__ServerCertValidationCallback__CallbackContext(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Net__ServerCertValidationCallback__CallbackContext& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__ServerCertValidationCallback__CallbackContext& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__ServerCertValidationCallback__CallbackContext& operator=(____System__Net__ServerCertValidationCallback__CallbackContext&& o) noexcept = default;
  constexpr ____System__Net__ServerCertValidationCallback__CallbackContext& operator=(____System__Net__ServerCertValidationCallback__CallbackContext const& o) noexcept = default;
...
explicit ____System__Net__ServerCertValidationCallback__CallbackContext(::bs_hook::Il2CppWrapperType request, ::System::Security::Cryptography::X509Certificates::X509Certificate certificate, ::System::Security::Cryptography::X509Certificates::X509Chain chain, ::System::Net::Security::SslPolicyErrors sslPolicyErrors) ;
...
public:
// Declarations
using CallbackContext = ::System::Net::____System__Net__ServerCertValidationCallback__CallbackContext;
...
NEED_NO_BOX(::System::Net::____System__Net__ServerCertValidationCallback__CallbackContext);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__ServerCertValidationCallback__CallbackContext, "System.Net", "ServerCertValidationCallback/CallbackContext");
