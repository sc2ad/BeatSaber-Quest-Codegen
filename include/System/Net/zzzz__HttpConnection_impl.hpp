...
constexpr void System::Net::System__Net__HttpConnection__InputState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t System::Net::System__Net__HttpConnection__InputState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr System::Net::System__Net__HttpConnection__InputState  System::Net::System__Net__HttpConnection__InputState::RequestLine{0};
constexpr System::Net::System__Net__HttpConnection__InputState  System::Net::System__Net__HttpConnection__InputState::Headers{1};
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr System::Net::System__Net__HttpConnection__LineState::System__Net__HttpConnection__LineState(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void System::Net::System__Net__HttpConnection__LineState::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t System::Net::System__Net__HttpConnection__LineState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr System::Net::System__Net__HttpConnection__LineState  System::Net::System__Net__HttpConnection__LineState::None{0};
constexpr System::Net::System__Net__HttpConnection__LineState  System::Net::System__Net__HttpConnection__LineState::CR{1};
constexpr System::Net::System__Net__HttpConnection__LineState  System::Net::System__Net__HttpConnection__LineState::LF{2};
...
constexpr void System::Net::HttpConnection::__set_input_state(System::Net::System__Net__HttpConnection__InputState value)  {
::cordl_internals::setInstanceField<System::Net::System__Net__HttpConnection__InputState, 0xb0>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Net::System__Net__HttpConnection__InputState>(value));
}
constexpr System::Net::System__Net__HttpConnection__InputState System::Net::HttpConnection::__get_input_state() const {
return ::cordl_internals::getInstanceField<System::Net::System__Net__HttpConnection__InputState, 0xb0>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Net::HttpConnection::__set_line_state(System::Net::System__Net__HttpConnection__LineState value)  {
::cordl_internals::setInstanceField<System::Net::System__Net__HttpConnection__LineState, 0xb4>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Net::System__Net__HttpConnection__LineState>(value));
}
constexpr System::Net::System__Net__HttpConnection__LineState System::Net::HttpConnection::__get_line_state() const {
return ::cordl_internals::getInstanceField<System::Net::System__Net__HttpConnection__LineState, 0xb4>(this->::bs_hook::Il2CppWrapperType::instance);
}
