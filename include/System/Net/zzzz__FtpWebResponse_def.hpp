...
namespace System::Net {
class ____System__Net__FtpWebResponse__EmptyStream;
}
// Type: ::EmptyStream
namespace System::Net {
// Is value type: false
...
class CORDL_TYPE ____System__Net__FtpWebResponse__EmptyStream : public ::System::IO::MemoryStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x50};

virtual ~____System__Net__FtpWebResponse__EmptyStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__FtpWebResponse__EmptyStream", modifiers: " const&", def_value: None }]
constexpr ____System__Net__FtpWebResponse__EmptyStream(____System__Net__FtpWebResponse__EmptyStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Net__FtpWebResponse__EmptyStream", modifiers: "&&", def_value: None }]
constexpr ____System__Net__FtpWebResponse__EmptyStream(____System__Net__FtpWebResponse__EmptyStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__FtpWebResponse__EmptyStream(void* ptr) noexcept : ::System::IO::MemoryStream(ptr) {
}


  constexpr ____System__Net__FtpWebResponse__EmptyStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Net__FtpWebResponse__EmptyStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Net__FtpWebResponse__EmptyStream& operator=(____System__Net__FtpWebResponse__EmptyStream&& o) noexcept = default;
  constexpr ____System__Net__FtpWebResponse__EmptyStream& operator=(____System__Net__FtpWebResponse__EmptyStream const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____System__Net__FtpWebResponse__EmptyStream() ;
...
public:
// Declarations
using EmptyStream = ::System::Net::____System__Net__FtpWebResponse__EmptyStream;
...
NEED_NO_BOX(::System::Net::____System__Net__FtpWebResponse__EmptyStream);
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__FtpWebResponse__EmptyStream, "System.Net", "FtpWebResponse/EmptyStream");
