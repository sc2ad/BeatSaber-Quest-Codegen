...
namespace System::Net {
struct ____System__Net__HttpConnection__InputState;
}
namespace System::Net {
struct ____System__Net__HttpConnection__LineState;
}
namespace System::Net {
...
struct CORDL_TYPE ____System__Net__HttpConnection__InputState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Net__HttpConnection__InputState(int32_t value__) noexcept;


                    constexpr ____System__Net__HttpConnection__InputState(____System__Net__HttpConnection__InputState const&) = default;
                    constexpr ____System__Net__HttpConnection__InputState(____System__Net__HttpConnection__InputState&&) = default;
                    constexpr ____System__Net__HttpConnection__InputState& operator=(____System__Net__HttpConnection__InputState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__HttpConnection__InputState& operator=(____System__Net__HttpConnection__InputState&& o) noexcept {
...
constexpr explicit ____System__Net__HttpConnection__InputState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Net__HttpConnection__InputState_Unwrapped : int32_t {
__RequestLine = 0,
__Headers = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Net__HttpConnection__InputState_Unwrapped () const noexcept {
return std::bit_cast<______System__Net__HttpConnection__InputState_Unwrapped>(__instance);
}
...
static ::System::Net::____System__Net__HttpConnection__InputState const RequestLine;

/// @brief Field Headers offset 0
static ::System::Net::____System__Net__HttpConnection__InputState const Headers;
...
struct CORDL_TYPE ____System__Net__HttpConnection__LineState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Net__HttpConnection__LineState(int32_t value__) noexcept;


                    constexpr ____System__Net__HttpConnection__LineState(____System__Net__HttpConnection__LineState const&) = default;
                    constexpr ____System__Net__HttpConnection__LineState(____System__Net__HttpConnection__LineState&&) = default;
                    constexpr ____System__Net__HttpConnection__LineState& operator=(____System__Net__HttpConnection__LineState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Net__HttpConnection__LineState& operator=(____System__Net__HttpConnection__LineState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Net__HttpConnection__LineState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Net__HttpConnection__LineState_Unwrapped : int32_t {
__None = 0,
__CR = 1,
__LF = 2,
};
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Net__HttpConnection__LineState_Unwrapped () const noexcept {
return std::bit_cast<______System__Net__HttpConnection__LineState_Unwrapped>(__instance);
}
...
static ::System::Net::____System__Net__HttpConnection__LineState const None;

/// @brief Field CR offset 0
static ::System::Net::____System__Net__HttpConnection__LineState const CR;

/// @brief Field LF offset 0
static ::System::Net::____System__Net__HttpConnection__LineState const LF;
...
public:
// Declarations
using LineState = ::System::Net::____System__Net__HttpConnection__LineState;

using InputState = ::System::Net::____System__Net__HttpConnection__InputState;
...
constexpr ::System::Net::Security::SslStream __get_ssl_stream() const;
 ...
 ::System::Net::____System__Net__HttpConnection__InputState __declspec(property(get=__get_input_state, put=__set_input_state))  input_state;

constexpr void __set_input_state(::System::Net::____System__Net__HttpConnection__InputState value) ;

constexpr ::System::Net::____System__Net__HttpConnection__InputState __get_input_state() const;

 ::System::Net::____System__Net__HttpConnection__LineState __declspec(property(get=__get_line_state, put=__set_line_state))  line_state;

constexpr void __set_line_state(::System::Net::____System__Net__HttpConnection__LineState value) ;

constexpr ::System::Net::____System__Net__HttpConnection__LineState __get_line_state() const;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__HttpConnection__InputState, "System.Net", "HttpConnection/InputState");
DEFINE_IL2CPP_ARG_TYPE(::System::Net::____System__Net__HttpConnection__LineState, "System.Net", "HttpConnection/LineState");
