...
namespace System::Net {
  ...
  check_size<sizeof(WebConnectionStream::$$c__DisplayClass75_0), 24 + sizeof(bool) + 8 - (24 + sizeof(bool)) % 8> __System_Net_WebConnectionStream_$$c__DisplayClass75_0SizeCheck;
}
