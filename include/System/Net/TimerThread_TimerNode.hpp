...
namespace System::Net {
  ...
  class TimerThread::TimerNode : public System::Net::TimerThread::Timer {
    ...
    check_size<sizeof(TimerThread::TimerNode::TimerState), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Net_TimerThread_TimerNode_TimerStateSizeCheck;
  ...
  check_size<sizeof(TimerThread::TimerNode), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __System_Net_TimerThread_TimerNodeSizeCheck;
}
