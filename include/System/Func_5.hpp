...
namespace System {
  ...
  class Func_5 : public System::MulticastDelegate {
    ...
    static Func_5<TResult, T1, T2, T3, T4>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (Func_5<TResult, T1, T2, T3, T4>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Func_5<TResult, T1, T2, T3, T4>*>::get(), object, method)));
    }
