...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2338), inst: 5941 })
...
static System::Func_8<T1,T2,T3,T4,T5,T6,T7,TResult> New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;
