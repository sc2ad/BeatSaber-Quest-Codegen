...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D37178
  class FieldAccessException : public System::MemberAccessException {
    ...
    static FieldAccessException* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("FieldAccessException").WithContext(".ctor");
