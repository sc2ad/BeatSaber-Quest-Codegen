...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D3704C
  class EntryPointNotFoundException : public System::TypeLoadException {
    ...
    static EntryPointNotFoundException* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System").WithContext("EntryPointNotFoundException").WithContext(".ctor");
