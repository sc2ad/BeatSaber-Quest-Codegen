...
namespace System {
  ...
  class Array::EmptyInternalEnumerator_1 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerator_1<T>*/ {
    ...
    // Offset: 0xFFFFFFFF
    void Dispose_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Array::EmptyInternalEnumerator_1::Dispose_NEW");
    ...
    // Offset: 0xFFFFFFFF
    bool MoveNext_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Array::EmptyInternalEnumerator_1::MoveNext_NEW");
    ...
    // Offset: 0xFFFFFFFF
    T get_Current_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Array::EmptyInternalEnumerator_1::get_Current_NEW");
    ...
    ::Il2CppObject* System_Collections_IEnumerator_get_Current_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Array::EmptyInternalEnumerator_1::System.Collections.IEnumerator.get_Current_NEW");
    ...
    void System_Collections_IEnumerator_Reset_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Array::EmptyInternalEnumerator_1::System.Collections.IEnumerator.Reset_NEW");
