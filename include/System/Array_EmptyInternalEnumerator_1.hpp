...
namespace System {
  ...
  template<typename T>
  class Array::EmptyInternalEnumerator_1 : public ::CsObject, public System::Collections::Generic::IEnumerator_1<T>, public System::IDisposable, public System::Collections::IEnumerator {
    public:
