...
namespace System::Threading::Tasks {
class ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView;
}
...
class CORDL_TYPE ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView", modifiers: " const&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView(____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView", modifiers: "&&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView(____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView& operator=(____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView&& o) noexcept = default;
  constexpr ____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView& operator=(____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView const& o) noexcept = default;
...
public:
// Declarations
using SystemThreadingTasks_TaskSchedulerDebugView = ::System::Threading::Tasks::____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView;
...
NEED_NO_BOX(::System::Threading::Tasks::____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView);
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::Tasks::____System__Threading__Tasks__TaskScheduler__SystemThreadingTasks_TaskSchedulerDebugView, "System.Threading.Tasks", "TaskScheduler/SystemThreadingTasks_TaskSchedulerDebugView");
