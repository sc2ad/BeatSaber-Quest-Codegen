...
namespace System::Threading::Tasks {
  ...
  class TaskFactory::CompleteOnInvokePromise : public System::Threading::Tasks::ITaskCompletionAction, public System::Threading::Tasks::Task_1<System::Threading::Tasks::Task*> {
    public:
