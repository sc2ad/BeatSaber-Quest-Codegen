...
namespace System::Threading::Tasks {
  ...
  check_size<sizeof(TaskFactory::CompleteOnInvokePromise), 96 + sizeof(int) + ((96 + sizeof(int)) % 8 != 0 ? (8 - (96 + sizeof(int)) % 8) : 0)> __System_Threading_Tasks_TaskFactory_CompleteOnInvokePromiseSizeCheck;
}
