...
namespace System::Threading::Tasks {
  ...
  class TaskExceptionHolder : public ::CsObject {
    public:
    ...
    // Offset: 0xCE33B0
    static void AppDomainUnloadCallback(::CsObject* sender, System::EventArgs* e);
    ...
    // Offset: 0xCDEC38
    void Add(::CsObject* exceptionObject, bool representsCancellation);
    // private System.Void SetCancellationException(System.Object exceptionObject)
    // Offset: 0xCE3C00
    void SetCancellationException(::CsObject* exceptionObject);
    // private System.Void AddFaultException(System.Object exceptionObject)
    // Offset: 0xCE3CC8
    void AddFaultException(::CsObject* exceptionObject);
