...
namespace System::Threading::Tasks {
  ...
  class AsyncCausalityTracer : public ::CsObject {
    public:
    ...
    // Offset: 0xCC7B24
    static void TraceOperationCreation(System::Threading::Tasks::CausalityTraceLevel traceLevel, int taskId, ::CsString* operationName, uint64_t relatedContext);
