...
namespace System::Threading::Tasks {
  ...
  check_size<sizeof(TaskCanceledException), 144 + sizeof(void*) + ((144 + sizeof(void*)) % 8 != 0 ? (8 - (144 + sizeof(void*)) % 8) : 0)> __System_Threading_Tasks_TaskCanceledExceptionSizeCheck;
}
