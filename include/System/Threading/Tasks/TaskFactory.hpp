...
namespace System::Threading::Tasks {
  ...
  check_size<sizeof(TaskFactory), 36 + sizeof(System::Threading::Tasks::TaskContinuationOptions) + ((36 + sizeof(System::Threading::Tasks::TaskContinuationOptions)) % 8 != 0 ? (8 - (36 + sizeof(System::Threading::Tasks::TaskContinuationOptions)) % 8) : 0)> __System_Threading_Tasks_TaskFactorySizeCheck;
}
