...
namespace System::Threading::Tasks {
class ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise;
}
// Type: ::CompleteOnInvokePromise
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2783)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 383 }), TypeDefinitionIndex(TypeDefinitionIndex(2770))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(2805))
// CS Name: System.Threading.Tasks.TaskFactory::CompleteOnInvokePromise
class CORDL_TYPE ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise : public ::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task> {
public:
// Declarations
...
virtual ~____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise", modifiers: " const&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise(____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise", modifiers: "&&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise(____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise(void* ptr) noexcept : ::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task>(ptr) {
}


  constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise& operator=(____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise&& o) noexcept = default;
  constexpr ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise& operator=(____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise const& o) noexcept = default;
...
explicit ____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise(::System::Collections::Generic::IList_1<::System::Threading::Tasks::Task> tasks) ;
...
public:
// Declarations
using CompleteOnInvokePromise = ::System::Threading::Tasks::____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise;
...
NEED_NO_BOX(::System::Threading::Tasks::____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise);
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::Tasks::____System__Threading__Tasks__TaskFactory__CompleteOnInvokePromise, "System.Threading.Tasks", "TaskFactory/CompleteOnInvokePromise");
