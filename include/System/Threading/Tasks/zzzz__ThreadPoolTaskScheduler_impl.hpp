...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::*)()>(&System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24bf8c8;
...
//  Writing Method size for method: System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c.__cctor_b__10_0
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::*)(::bs_hook::Il2CppWrapperType)>(&System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::__cctor_b__10_0)> {
 ...
 void System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::__set___9(System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c value)  {
::cordl_internals::setStaticField<System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c, "<>9", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c>::get>(std::forward<System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c::__cctor_b__10_0(::bs_hook::Il2CppWrapperType s)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Threading::Tasks::System__Threading__Tasks__ThreadPoolTaskScheduler____c>::get(),
                            "<.cctor>b__10_0",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::ThreadPoolTaskScheduler::*)()>(&System::Threading::Tasks::ThreadPoolTaskScheduler::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x24bf47c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::ThreadPoolTaskScheduler::*)(System::Threading::Tasks::Task)>(&System::Threading::Tasks::ThreadPoolTaskScheduler::QueueTask)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(System::Threading::Tasks::ThreadPoolTaskScheduler),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Threading::Tasks::ThreadPoolTaskScheduler>::get(),
                                  4
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Threading::Tasks::ThreadPoolTaskScheduler::*)(System::Threading::Tasks::Task, bool)>(&System::Threading::Tasks::ThreadPoolTaskScheduler::TryExecuteTaskInline)> {
  ...
  constexpr static std::size_t addrs = 0x24bf69c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Threading::Tasks::ThreadPoolTaskScheduler::*)(System::Threading::Tasks::Task)>(&System::Threading::Tasks::ThreadPoolTaskScheduler::TryDequeue)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24bf780;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::Tasks::ThreadPoolTaskScheduler::*)()>(&System::Threading::Tasks::ThreadPoolTaskScheduler::NotifyWorkItemProgress)> {
  ...
  constexpr static std::size_t addrs = 0x24bf788;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Threading::Tasks::ThreadPoolTaskScheduler::*)()>(&System::Threading::Tasks::ThreadPoolTaskScheduler::get_RequiresAtomicStartTransition)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x24bf798;
 ...
 void System::Threading::Tasks::ThreadPoolTaskScheduler::__set_s_longRunningThreadWork(System::Threading::ParameterizedThreadStart value)  {
::cordl_internals::setStaticField<System::Threading::ParameterizedThreadStart, "s_longRunningThreadWork", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Threading::Tasks::ThreadPoolTaskScheduler>::get>(std::forward<System::Threading::ParameterizedThreadStart>(value));
}
