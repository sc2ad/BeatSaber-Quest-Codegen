...
namespace System::Threading::Tasks {
  ...
  check_size<sizeof(Task::ContingentProperties), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __System_Threading_Tasks_Task_ContingentPropertiesSizeCheck;
}
