...
// Ctor Parameters []
explicit System__Threading__Tasks__UnwrapPromise_1____c() ;
...
template<::cordl_internals::il2cpp_reference_type TResult>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2770)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 4944 }), TypeDefinitionIndex(TypeDefinitionIndex(2793))}
