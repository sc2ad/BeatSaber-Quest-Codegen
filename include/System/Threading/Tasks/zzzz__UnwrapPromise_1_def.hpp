...
class System__Threading__Tasks__UnwrapPromise_1____c;
}
...
namespace System::Threading::Tasks {
template<>
class System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult>;
}
namespace System::Threading::Tasks {
template<::cordl_internals::il2cpp_reference_type TResult>
class System__Threading__Tasks__UnwrapPromise_1____c<TResult>;
}
namespace System::Threading::Tasks {
template<>
...
class CORDL_TYPE System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~System__Threading__Tasks__UnwrapPromise_1____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Threading__Tasks__UnwrapPromise_1____c", modifiers: " const&", def_value: None }]
constexpr System__Threading__Tasks__UnwrapPromise_1____c(System__Threading__Tasks__UnwrapPromise_1____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Threading__Tasks__UnwrapPromise_1____c", modifiers: "&&", def_value: None }]
constexpr System__Threading__Tasks__UnwrapPromise_1____c(System__Threading__Tasks__UnwrapPromise_1____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Threading__Tasks__UnwrapPromise_1____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Threading__Tasks__UnwrapPromise_1____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Threading__Tasks__UnwrapPromise_1____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Threading__Tasks__UnwrapPromise_1____c& operator=(System__Threading__Tasks__UnwrapPromise_1____c&& o) noexcept = default;
  constexpr System__Threading__Tasks__UnwrapPromise_1____c& operator=(System__Threading__Tasks__UnwrapPromise_1____c const& o) noexcept = default;
                


// Fields

static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult> value) ;

static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult> __get___9() ;
...
static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult> New_ctor() ;
...
// CS Name: System.Threading.Tasks.UnwrapPromise`1::<>c
class CORDL_TYPE System__Threading__Tasks__UnwrapPromise_1____c<TResult> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};
...
static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<TResult> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<TResult> value) ;

static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<TResult> __get___9() ;
...
static System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<TResult> New_ctor() ;
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 4944 }), TypeDefinitionIndex(TypeDefinitionIndex(2793)), TypeDefinitionIndex(TypeDefinitionIndex(2770))}
...
public:
// Declarations
using __c = System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<System::Threading::Tasks::VoidTaskResult>;
...
static System::Threading::Tasks::UnwrapPromise_1<System::Threading::Tasks::VoidTaskResult> New_ctor(System::Threading::Tasks::Task outerTask, bool lookForOce) ;
...
template<::cordl_internals::il2cpp_reference_type TResult>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2793)), TypeDefinitionIndex(TypeDefinitionIndex(2770)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 4944 })}
...
public:
// Declarations
using __c = System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c<TResult>;
...
static System::Threading::Tasks::UnwrapPromise_1<TResult> New_ctor(System::Threading::Tasks::Task outerTask, bool lookForOce) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(System::Threading::Tasks::System__Threading__Tasks__UnwrapPromise_1____c, "System.Threading.Tasks", "UnwrapPromise`1/<>c");
