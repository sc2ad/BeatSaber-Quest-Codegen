...
namespace System::Threading::Tasks {
class ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c;
}
// Type: ::<>c
namespace System::Threading::Tasks {
// Is value type: false
...
class CORDL_TYPE ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c", modifiers: " const&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c(____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c", modifiers: "&&", def_value: None }]
constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c(____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c& operator=(____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c&& o) noexcept = default;
  constexpr ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c& operator=(____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c const& o) noexcept = default;
                


// Fields

static ::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c value) ;

static ::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c __get___9() ;
...
// Ctor Parameters []
explicit ____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c() ;
...
public:
// Declarations
using __c = ::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c;
...
NEED_NO_BOX(::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c);
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::Tasks::____System__Threading__Tasks__TaskSchedulerAwaitTaskContinuation____c, "System.Threading.Tasks", "TaskSchedulerAwaitTaskContinuation/<>c");
