...
namespace System::Threading::Tasks {
  ...
  check_size<sizeof(CausalitySynchronousWork), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Threading_Tasks_CausalitySynchronousWorkSizeCheck;
}
