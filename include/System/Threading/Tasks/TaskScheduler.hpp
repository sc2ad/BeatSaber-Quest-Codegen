...
namespace System::Threading::Tasks {
  ...
  class TaskScheduler : public ::CsObject {
    public:
    ...
    static System::Runtime::CompilerServices::ConditionalWeakTable_2<System::Threading::Tasks::TaskScheduler*, ::CsObject*>* _get_s_activeTaskSchedulers();
    ...
    static void _set_s_activeTaskSchedulers(System::Runtime::CompilerServices::ConditionalWeakTable_2<System::Threading::Tasks::TaskScheduler*, ::CsObject*>* value);
    ...
    static ::CsObject* _get__unobservedTaskExceptionLockObject();
    // Set static field: static private readonly System.Object _unobservedTaskExceptionLockObject
    static void _set__unobservedTaskExceptionLockObject(::CsObject* value);
    ...
    // Offset: 0xCD108C
    static void PublishUnobservedTaskException(::CsObject* sender, System::Threading::Tasks::UnobservedTaskExceptionEventArgs* ueea);
