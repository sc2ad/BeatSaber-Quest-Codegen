...
namespace System::Threading::Tasks {
  ...
  // [] Offset: FFFFFFFF
  // [DebuggerTypeProxyAttribute] Offset: C95C8C
  // [DebuggerDisplayAttribute] Offset: C95C8C
  class TaskScheduler : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    void QueueTask_NEW(System::Threading::Tasks::Task* task);
    // protected System.Boolean TryExecuteTaskInline(System.Threading.Tasks.Task task, System.Boolean taskWasPreviouslyQueued)
    // Offset: 0xFFFFFFFF
    bool TryExecuteTaskInline_NEW(System::Threading::Tasks::Task* task, bool taskWasPreviouslyQueued);
    ...
    // Offset: 0x16DC47C
    bool TryDequeue_NEW(System::Threading::Tasks::Task* task);
    // System.Void NotifyWorkItemProgress()
    // Offset: 0x16DC484
    void NotifyWorkItemProgress_NEW();
    // System.Boolean get_RequiresAtomicStartTransition()
    // Offset: 0x16DC488
    bool get_RequiresAtomicStartTransition_NEW();
