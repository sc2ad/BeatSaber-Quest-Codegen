...
namespace System::Threading::Tasks {
  ...
  class Task_1 : public System::Threading::Tasks::Task {
    ...
    // Offset: 0xFFFFFFFF
    static Task_1<TResult>* New_ctor(::CsObject* state, System::Threading::Tasks::TaskCreationOptions options) {
    ...
    // Offset: 0xFFFFFFFF
    static Task_1<TResult>* New_ctor(System::Func_2<::CsObject*, TResult>* function, ::CsObject* state, System::Threading::CancellationToken cancellationToken, System::Threading::Tasks::TaskCreationOptions creationOptions) {
    ...
    // Offset: 0xFFFFFFFF
    bool TrySetException(::CsObject* exceptionObject) {
    ...
    // Offset: 0xFFFFFFFF
    bool TrySetCanceled(System::Threading::CancellationToken tokenToRecord, ::CsObject* cancellationException) {
    ...
    static Task_1<TResult>* New_ctor(System::Delegate* valueSelector, ::CsObject* state, System::Threading::Tasks::Task* parent, System::Threading::CancellationToken cancellationToken, System::Threading::Tasks::TaskCreationOptions creationOptions, System::Threading::Tasks::InternalTaskOptions internalOptions, System::Threading::Tasks::TaskScheduler* scheduler) {
