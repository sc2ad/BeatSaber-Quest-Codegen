...
namespace System::Threading {
  ...
  class Volatile : public ::Il2CppObject {
    ...
    static T Read(ByRef<T> location) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(location))));
    }
    ...
    static void Write(ByRef<T> location, T value) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(location), value)));
    }
