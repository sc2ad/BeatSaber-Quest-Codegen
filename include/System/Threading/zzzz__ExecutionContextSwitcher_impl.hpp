...
// Ctor Parameters [CppParam { name: "outerEC", ty: "::System::Threading::____System__Threading__ExecutionContext__Reader", modifiers: "", def_value: Some("{}") }, CppParam { name: "outerECBelongsToScope", ty: "bool", modifiers: "", def_value: Some("{}") }, CppParam { name: "hecsw", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: Some("csnull") }, CppParam { name: "thread", ty: "::System::Threading::Thread", modifiers: "", def_value: Some("csnull") }]
constexpr ::System::Threading::ExecutionContextSwitcher::ExecutionContextSwitcher(::System::Threading::____System__Threading__ExecutionContext__Reader outerEC, bool outerECBelongsToScope, ::bs_hook::Il2CppWrapperType hecsw, ::System::Threading::Thread thread) noexcept : ::bs_hook::ValueTypeWrapper() {this->outerEC = outerEC;
this->outerECBelongsToScope = outerECBelongsToScope;
this->hecsw = hecsw;
this->thread = thread;
}
constexpr void ::System::Threading::ExecutionContextSwitcher::__set_outerEC(::System::Threading::____System__Threading__ExecutionContext__Reader value)  {
::cordl_internals::setInstanceField<::System::Threading::____System__Threading__ExecutionContext__Reader, 0x0>(this->__instance, std::forward<::System::Threading::____System__Threading__ExecutionContext__Reader>(value));
}
constexpr ::System::Threading::____System__Threading__ExecutionContext__Reader ::System::Threading::ExecutionContextSwitcher::__get_outerEC() const {
return ::cordl_internals::getInstanceField<::System::Threading::____System__Threading__ExecutionContext__Reader, 0x0>(this->__instance);
}
