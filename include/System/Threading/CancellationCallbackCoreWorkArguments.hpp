...
namespace System::Threading {
  ...
  check_size<sizeof(CancellationCallbackCoreWorkArguments), 8 + sizeof(int) + ((8 + sizeof(int)) % 8 != 0 ? (8 - (8 + sizeof(int)) % 8) : 0)> __System_Threading_CancellationCallbackCoreWorkArgumentsSizeCheck;
}
