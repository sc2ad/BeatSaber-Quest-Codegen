...
namespace System::Threading {
  ...
  class ThreadPool : public ::CsObject {
    public:
    ...
    // Offset: 0xCE6C30
    static System::Threading::RegisteredWaitHandle* RegisterWaitForSingleObject(System::Threading::WaitHandle* waitObject, System::Threading::WaitOrTimerCallback* callBack, ::CsObject* state, uint millisecondsTimeOutInterval, bool executeOnlyOnce, System::Threading::StackCrawlMark& stackMark, bool compressStack);
    ...
    // Offset: 0xCE6F24
    static System::Threading::RegisteredWaitHandle* RegisterWaitForSingleObject(System::Threading::WaitHandle* waitObject, System::Threading::WaitOrTimerCallback* callBack, ::CsObject* state, System::TimeSpan timeout, bool executeOnlyOnce);
    // static public System.Boolean QueueUserWorkItem(System.Threading.WaitCallback callBack, System.Object state)
    // Offset: 0xCD66EC
    static bool QueueUserWorkItem(System::Threading::WaitCallback* callBack, ::CsObject* state);
    // static public System.Boolean UnsafeQueueUserWorkItem(System.Threading.WaitCallback callBack, System.Object state)
    // Offset: 0xCE6EF4
    static bool UnsafeQueueUserWorkItem(System::Threading::WaitCallback* callBack, ::CsObject* state);
    ...
    // Offset: 0xCE7078
    static bool QueueUserWorkItemHelper(System::Threading::WaitCallback* callBack, ::CsObject* state, System::Threading::StackCrawlMark& stackMark, bool compressStack);
