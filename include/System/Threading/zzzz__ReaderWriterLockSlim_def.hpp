...
namespace System::Threading {
struct ____System__Threading__ReaderWriterLockSlim__TimeoutTracker;
}
// Type: ::TimeoutTracker
namespace System::Threading {
// Is value type: true
...
struct CORDL_TYPE ____System__Threading__ReaderWriterLockSlim__TimeoutTracker : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__Threading__ReaderWriterLockSlim__TimeoutTracker(int32_t m_total, int32_t m_start) noexcept;


                    constexpr ____System__Threading__ReaderWriterLockSlim__TimeoutTracker(____System__Threading__ReaderWriterLockSlim__TimeoutTracker const&) = default;
                    constexpr ____System__Threading__ReaderWriterLockSlim__TimeoutTracker(____System__Threading__ReaderWriterLockSlim__TimeoutTracker&&) = default;
                    constexpr ____System__Threading__ReaderWriterLockSlim__TimeoutTracker& operator=(____System__Threading__ReaderWriterLockSlim__TimeoutTracker const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Threading__ReaderWriterLockSlim__TimeoutTracker& operator=(____System__Threading__ReaderWriterLockSlim__TimeoutTracker&& o) noexcept {
...
constexpr explicit ____System__Threading__ReaderWriterLockSlim__TimeoutTracker(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using TimeoutTracker = ::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker;
...
/// @brief Method TryEnterReadLock addr 0x268292c size 0x4 virtual false final false
 bool TryEnterReadLock(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterReadLockCore addr 0x2682930 size 0x700 virtual false final false
 bool TryEnterReadLockCore(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;
...
/// @brief Method TryEnterWriteLock addr 0x2683354 size 0x4 virtual false final false
 bool TryEnterWriteLock(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterWriteLockCore addr 0x2683358 size 0x668 virtual false final false
 bool TryEnterWriteLockCore(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;
...
/// @brief Method TryEnterUpgradeableReadLock addr 0x2683a20 size 0x4 virtual false final false
 bool TryEnterUpgradeableReadLock(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterUpgradeableReadLockCore addr 0x2683a24 size 0x504 virtual false final false
 bool TryEnterUpgradeableReadLockCore(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;
...
/// @brief Method WaitOnEvent addr 0x26831f8 size 0x128 virtual false final false
 bool WaitOnEvent(::System::Threading::EventWaitHandle waitEvent, ByRef<uint32_t> numWaiters, ::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout, bool isWriteWaiter) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__ReaderWriterLockSlim__TimeoutTracker, "System.Threading", "ReaderWriterLockSlim/TimeoutTracker");
