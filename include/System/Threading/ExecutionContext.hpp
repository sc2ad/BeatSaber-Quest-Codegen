...
namespace System::Threading {
  ...
  class ExecutionContext : public ::Il2CppObject/*, public System::IDisposable, public System::Runtime::Serialization::ISerializable*/ {
    ...
    check_size<sizeof(ExecutionContext::Flags), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Threading_ExecutionContext_FlagsSizeCheck;
  ...
  check_size<sizeof(ExecutionContext), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __System_Threading_ExecutionContextSizeCheck;
}
