...
namespace System::Threading {
  ...
  // [CompilerGeneratedAttribute] Offset: D7CE20
...
// Writing MetadataGetter for method: SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::MoveNext
// Il2CppName: MoveNext
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::*)()>(&SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::MoveNext)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31), "MoveNext", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::SetStateMachine
// Il2CppName: SetStateMachine
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::*)(System::Runtime::CompilerServices::IAsyncStateMachine*)>(&SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31::SetStateMachine)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(SemaphoreSlim::$WaitUntilCountOrTimeoutAsync$d__31), "SetStateMachine", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::CompilerServices::IAsyncStateMachine*>()});
  }
};
