...
namespace System::Threading {
  ...
  class Interlocked : public ::Il2CppObject {
    ...
    static T CompareExchange(ByRef<T> location1, T value, T comparand) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(location1), value, comparand)));
    }
    ...
    static T Exchange(ByRef<T> location1, T value) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(location1), value)));
    }
