...
namespace System::Threading {
  ...
  template<typename T>
  class AsyncLocal_1 : public ::CsObject, public System::Threading::IAsyncLocal {
    public:
    ...
    void System_Threading_IAsyncLocal_OnValueChanged(::CsObject* previousValueObj, ::CsObject* currentValueObj, bool contextChanged) {
