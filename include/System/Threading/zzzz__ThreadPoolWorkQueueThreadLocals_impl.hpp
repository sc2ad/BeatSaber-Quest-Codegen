...
constexpr void ::System::Threading::ThreadPoolWorkQueueThreadLocals::__set_workStealingQueue(::System::Threading::____System__Threading__ThreadPoolWorkQueue__WorkStealingQueue value)  {
::cordl_internals::setInstanceField<::System::Threading::____System__Threading__ThreadPoolWorkQueue__WorkStealingQueue, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Threading::____System__Threading__ThreadPoolWorkQueue__WorkStealingQueue>(value));
}
constexpr ::System::Threading::____System__Threading__ThreadPoolWorkQueue__WorkStealingQueue ::System::Threading::ThreadPoolWorkQueueThreadLocals::__get_workStealingQueue() const {
return ::cordl_internals::getInstanceField<::System::Threading::____System__Threading__ThreadPoolWorkQueue__WorkStealingQueue, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
