...
namespace System::Threading {
  ...
  check_size<sizeof(NativeOverlapped), 24 + sizeof(System::IntPtr) + ((24 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (24 + sizeof(System::IntPtr)) % 8) : 0)> __System_Threading_NativeOverlappedSizeCheck;
}
