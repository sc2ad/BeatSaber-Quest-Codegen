...
namespace System::Threading {
  ...
  check_size<sizeof(SynchronizationContextProperties), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Threading_SynchronizationContextPropertiesSizeCheck;
}
