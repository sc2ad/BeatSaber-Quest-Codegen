...
namespace System::Threading {
  ...
  check_size<sizeof(OSSpecificSynchronizationContext), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Threading_OSSpecificSynchronizationContextSizeCheck;
}
