...
namespace System::Threading {
  ...
  check_size<sizeof(QueueUserWorkItemCallback), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __System_Threading_QueueUserWorkItemCallbackSizeCheck;
}
