...
namespace System::Threading {
  ...
  class ThreadPoolWorkQueue::SparseArray_1 : public ::Il2CppObject {
    ...
    ::Array<T>* _get_m_array() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Threading::ThreadPoolWorkQueue::SparseArray_1::_get_m_array");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<T>*>(___internal__instance, "m_array"));
    }
    // Autogenerated instance field setter
    // Set instance field: private T[] m_array
    void _set_m_array(::Array<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Threading::ThreadPoolWorkQueue::SparseArray_1::_set_m_array");
      static auto ___internal__instance = this;
