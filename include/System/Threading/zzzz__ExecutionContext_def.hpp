...
namespace System::Threading {
struct ____System__Threading__ExecutionContext__CaptureOptions;
}
namespace System::Threading {
struct ____System__Threading__ExecutionContext__Flags;
}
namespace System::Threading {
...
struct CORDL_TYPE ____System__Threading__ExecutionContext__Flags : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Threading__ExecutionContext__Flags(int32_t value__) noexcept;


                    constexpr ____System__Threading__ExecutionContext__Flags(____System__Threading__ExecutionContext__Flags const&) = default;
                    constexpr ____System__Threading__ExecutionContext__Flags(____System__Threading__ExecutionContext__Flags&&) = default;
                    constexpr ____System__Threading__ExecutionContext__Flags& operator=(____System__Threading__ExecutionContext__Flags const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Threading__ExecutionContext__Flags& operator=(____System__Threading__ExecutionContext__Flags&& o) noexcept {
...
constexpr explicit ____System__Threading__ExecutionContext__Flags(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Threading__ExecutionContext__Flags_Unwrapped : int32_t {
__None = 0,
__IsNewCapture = 1,
...
constexpr operator ______System__Threading__ExecutionContext__Flags_Unwrapped () const noexcept {
return std::bit_cast<______System__Threading__ExecutionContext__Flags_Unwrapped>(__instance);
}
...
static ::System::Threading::____System__Threading__ExecutionContext__Flags const None;

/// @brief Field IsNewCapture offset 0
static ::System::Threading::____System__Threading__ExecutionContext__Flags const IsNewCapture;

/// @brief Field IsFlowSuppressed offset 0
static ::System::Threading::____System__Threading__ExecutionContext__Flags const IsFlowSuppressed;

/// @brief Field IsPreAllocatedDefault offset 0
static ::System::Threading::____System__Threading__ExecutionContext__Flags const IsPreAllocatedDefault;
...
struct CORDL_TYPE ____System__Threading__ExecutionContext__Reader : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_ec", ty: "::System::Threading::ExecutionContext", modifiers: "", def_value: None }]
constexpr ____System__Threading__ExecutionContext__Reader(::System::Threading::ExecutionContext m_ec) noexcept;


                    constexpr ____System__Threading__ExecutionContext__Reader(____System__Threading__ExecutionContext__Reader const&) = default;
                    constexpr ____System__Threading__ExecutionContext__Reader(____System__Threading__ExecutionContext__Reader&&) = default;
                    constexpr ____System__Threading__ExecutionContext__Reader& operator=(____System__Threading__ExecutionContext__Reader const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Threading__ExecutionContext__Reader& operator=(____System__Threading__ExecutionContext__Reader&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__ExecutionContext__Reader(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Properties
 ...
 ::System::Runtime::Remoting::Messaging::____System__Runtime__Remoting__Messaging__LogicalCallContext__Reader __declspec(property(get=get_LogicalCallContext))  LogicalCallContext;
...
/// @brief Method get_LogicalCallContext addr 0x24aac50 size 0x18 virtual false final false
 ::System::Runtime::Remoting::Messaging::____System__Runtime__Remoting__Messaging__LogicalCallContext__Reader get_LogicalCallContext() ;
...
struct CORDL_TYPE ____System__Threading__ExecutionContext__CaptureOptions : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Threading__ExecutionContext__CaptureOptions(int32_t value__) noexcept;


                    constexpr ____System__Threading__ExecutionContext__CaptureOptions(____System__Threading__ExecutionContext__CaptureOptions const&) = default;
                    constexpr ____System__Threading__ExecutionContext__CaptureOptions(____System__Threading__ExecutionContext__CaptureOptions&&) = default;
                    constexpr ____System__Threading__ExecutionContext__CaptureOptions& operator=(____System__Threading__ExecutionContext__CaptureOptions const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Threading__ExecutionContext__CaptureOptions& operator=(____System__Threading__ExecutionContext__CaptureOptions&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__ExecutionContext__CaptureOptions(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Threading__ExecutionContext__CaptureOptions_Unwrapped : int32_t {
__None = 0,
__IgnoreSyncCtx = 1,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Threading__ExecutionContext__CaptureOptions_Unwrapped () const noexcept {
return std::bit_cast<______System__Threading__ExecutionContext__CaptureOptions_Unwrapped>(__instance);
}
...
/// @brief Field None offset 0
static ::System::Threading::____System__Threading__ExecutionContext__CaptureOptions const None;

/// @brief Field IgnoreSyncCtx offset 0
static ::System::Threading::____System__Threading__ExecutionContext__CaptureOptions const IgnoreSyncCtx;

/// @brief Field OptimizeDefaultCase offset 0
static ::System::Threading::____System__Threading__ExecutionContext__CaptureOptions const OptimizeDefaultCase;
...
public:
// Declarations
using CaptureOptions = ::System::Threading::____System__Threading__ExecutionContext__CaptureOptions;

using Reader = ::System::Threading::____System__Threading__ExecutionContext__Reader;

using Flags = ::System::Threading::____System__Threading__ExecutionContext__Flags;
...
constexpr ::System::Runtime::Remoting::Messaging::IllogicalCallContext __get__illogicalCallContext() const;
 ...
 ::System::Threading::____System__Threading__ExecutionContext__Flags __declspec(property(get=__get__flags, put=__set__flags))  _flags;

constexpr void __set__flags(::System::Threading::____System__Threading__ExecutionContext__Flags value) ;

constexpr ::System::Threading::____System__Threading__ExecutionContext__Flags __get__flags() const;
...
static ::System::Threading::ExecutionContext Capture(ByRef<::System::Threading::StackCrawlMark> stackMark, ::System::Threading::____System__Threading__ExecutionContext__CaptureOptions options) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__ExecutionContext__CaptureOptions, "System.Threading", "ExecutionContext/CaptureOptions");
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__ExecutionContext__Flags, "System.Threading", "ExecutionContext/Flags");
...
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__ExecutionContext__Reader, "System.Threading", "ExecutionContext/Reader");
