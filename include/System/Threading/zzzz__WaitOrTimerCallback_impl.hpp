...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Threading::WaitOrTimerCallback::*)(::bs_hook::Il2CppWrapperType, bool)>(&System::Threading::WaitOrTimerCallback::Invoke)> {
 ...
 System::Threading::WaitOrTimerCallback System::Threading::WaitOrTimerCallback::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
System::Threading::WaitOrTimerCallback o{THROW_UNLESS(::il2cpp_utils::New<System::Threading::WaitOrTimerCallback>(object, method))};
return o;
}
