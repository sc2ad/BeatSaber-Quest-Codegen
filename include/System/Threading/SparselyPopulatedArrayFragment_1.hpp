...
namespace System::Threading {
  ...
  class SparselyPopulatedArrayFragment_1 : public ::Il2CppObject {
    ...
    SparselyPopulatedArrayFragment_1(::ArrayWrapper<T> m_elements_ = {}, int m_freeCount_ = {}, System::Threading::SparselyPopulatedArrayFragment_1<T>* m_next_ = {}, System::Threading::SparselyPopulatedArrayFragment_1<T>* m_prev_ = {}) noexcept : m_elements{m_elements_}, m_freeCount{m_freeCount_}, m_next{m_next_}, m_prev{m_prev_} {}
    // Autogenerated instance field getter
    // Get instance field: readonly T[] m_elements
    ::ArrayWrapper<T>& dyn_m_elements() {
