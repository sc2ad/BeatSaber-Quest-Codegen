...
namespace System::Threading {
  ...
  check_size<sizeof(ExecutionContextSwitcher), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Threading_ExecutionContextSwitcherSizeCheck;
}
