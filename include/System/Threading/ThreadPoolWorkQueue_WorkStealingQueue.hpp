...
namespace System::Threading {
  ...
  check_size<sizeof(ThreadPoolWorkQueue::WorkStealingQueue), 36 + sizeof(System::Threading::SpinLock) + ((36 + sizeof(System::Threading::SpinLock)) % 8 != 0 ? (8 - (36 + sizeof(System::Threading::SpinLock)) % 8) : 0)> __System_Threading_ThreadPoolWorkQueue_WorkStealingQueueSizeCheck;
}
