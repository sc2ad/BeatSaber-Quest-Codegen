...
namespace System::Threading {
class ____System__Threading__SemaphoreSlim__TaskNode;
}
namespace System::Threading {
struct ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32;
}
// Type: ::TaskNode
namespace System::Threading {
// Is value type: false
...
class CORDL_TYPE ____System__Threading__SemaphoreSlim__TaskNode : public ::System::Threading::Tasks::Task_1<bool> {
public:
// Declarations
...
virtual ~____System__Threading__SemaphoreSlim__TaskNode() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__SemaphoreSlim__TaskNode", modifiers: " const&", def_value: None }]
constexpr ____System__Threading__SemaphoreSlim__TaskNode(____System__Threading__SemaphoreSlim__TaskNode const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Threading__SemaphoreSlim__TaskNode", modifiers: "&&", def_value: None }]
constexpr ____System__Threading__SemaphoreSlim__TaskNode(____System__Threading__SemaphoreSlim__TaskNode&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Threading__SemaphoreSlim__TaskNode(void* ptr) noexcept : ::System::Threading::Tasks::Task_1<bool>(ptr) {
}


  constexpr ____System__Threading__SemaphoreSlim__TaskNode& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Threading__SemaphoreSlim__TaskNode& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Threading__SemaphoreSlim__TaskNode& operator=(____System__Threading__SemaphoreSlim__TaskNode&& o) noexcept = default;
  constexpr ____System__Threading__SemaphoreSlim__TaskNode& operator=(____System__Threading__SemaphoreSlim__TaskNode const& o) noexcept = default;
                


// Fields

 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __declspec(property(get=__get_Prev, put=__set_Prev))  Prev;

constexpr void __set_Prev(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode value) ;

constexpr ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __get_Prev() const;

 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __declspec(property(get=__get_Next, put=__set_Next))  Next;

constexpr void __set_Next(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode value) ;

constexpr ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __get_Next() const;


// Methods

// Ctor Parameters []
explicit ____System__Threading__SemaphoreSlim__TaskNode() ;
...
struct CORDL_TYPE ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to ::System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  ::System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "asyncWaiter", ty: "::System::Threading::____System__Threading__SemaphoreSlim__TaskNode", modifiers: "", def_value: None }, CppParam { name: "millisecondsTimeout", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::System::Threading::SemaphoreSlim", modifiers: "", def_value: None }, CppParam { name: "_cts_5__2", ty: "::System::Threading::CancellationTokenSource", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Threading::Tasks::Task>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool>", modifiers: "", def_value: None }]
constexpr ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool> __t__builder, ::System::Threading::CancellationToken cancellationToken, ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode asyncWaiter, int32_t millisecondsTimeout, ::System::Threading::SemaphoreSlim __4__this, ::System::Threading::CancellationTokenSource _cts_5__2, ::bs_hook::Il2CppWrapperType __7__wrap2, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<::System::Threading::Tasks::Task> __u__1, ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool> __u__2) noexcept;


                    constexpr ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32(____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32 const&) = default;
                    constexpr ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32(____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32&&) = default;
                    constexpr ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32& operator=(____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32& operator=(____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32&& o) noexcept {
...
constexpr explicit ____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr ::System::Threading::CancellationToken __get_cancellationToken() const;
 ...
 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __declspec(property(get=__get_asyncWaiter, put=__set_asyncWaiter))  asyncWaiter;

constexpr void __set_asyncWaiter(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode value) ;

constexpr ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __get_asyncWaiter() const;
...
public:
// Declarations
using _WaitUntilCountOrTimeoutAsync_d__32 = ::System::Threading::____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32;

using TaskNode = ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode;
...
constexpr ::System::Threading::ManualResetEvent __get_m_waitHandle() const;
 ...
 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __declspec(property(get=__get_m_asyncHead, put=__set_m_asyncHead))  m_asyncHead;

constexpr void __set_m_asyncHead(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode value) ;

constexpr ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __get_m_asyncHead() const;

 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __declspec(property(get=__get_m_asyncTail, put=__set_m_asyncTail))  m_asyncTail;

constexpr void __set_m_asyncTail(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode value) ;

constexpr ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode __get_m_asyncTail() const;
...
/// @brief Method CreateAndAddAsyncWaiter addr 0x24a7840 size 0x84 virtual false final false
 ::System::Threading::____System__Threading__SemaphoreSlim__TaskNode CreateAndAddAsyncWaiter() ;

/// @brief Method RemoveAsyncWaiter addr 0x24a7a30 size 0x80 virtual false final false
 bool RemoveAsyncWaiter(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode task) ;

/// @brief Method WaitUntilCountOrTimeoutAsync addr 0x24a78c4 size 0x124 virtual false final false
 ::System::Threading::Tasks::Task_1<bool> WaitUntilCountOrTimeoutAsync(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode asyncWaiter, int32_t millisecondsTimeout, ::System::Threading::CancellationToken cancellationToken) ;
...
static void QueueWaiterTask(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode waiterTask) ;
...
NEED_NO_BOX(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode);
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__SemaphoreSlim__TaskNode, "System.Threading", "SemaphoreSlim/TaskNode");
DEFINE_IL2CPP_ARG_TYPE(::System::Threading::____System__Threading__SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32, "System.Threading", "SemaphoreSlim/<WaitUntilCountOrTimeoutAsync>d__32");
