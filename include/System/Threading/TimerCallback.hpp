...
namespace System::Threading {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D39D2C
  class TimerCallback : public System::MulticastDelegate {
    ...
    static TimerCallback* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Threading").WithContext("TimerCallback").WithContext(".ctor");
