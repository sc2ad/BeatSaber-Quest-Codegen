...
namespace System::Threading {
  ...
  check_size<sizeof(CancellationCallbackInfo), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __System_Threading_CancellationCallbackInfoSizeCheck;
}
