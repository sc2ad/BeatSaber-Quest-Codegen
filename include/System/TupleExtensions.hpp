...
namespace System {
  ...
  // [ExtensionAttribute] Offset: E9CE8C
  class TupleExtensions : public ::Il2CppObject {
    ...
    static void Deconstruct(System::Tuple_2<T1, T2>* value, ByRef<T1> item1, ByRef<T2> item2) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, value, byref(item1), byref(item2))));
    }
