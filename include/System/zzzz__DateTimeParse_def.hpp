...
class CORDL_TYPE System__DateTimeParse__MatchNumberDelegate : public System::MulticastDelegate {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x80};

virtual ~System__DateTimeParse__MatchNumberDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__DateTimeParse__MatchNumberDelegate", modifiers: " const&", def_value: None }]
constexpr System__DateTimeParse__MatchNumberDelegate(System__DateTimeParse__MatchNumberDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__DateTimeParse__MatchNumberDelegate", modifiers: "&&", def_value: None }]
constexpr System__DateTimeParse__MatchNumberDelegate(System__DateTimeParse__MatchNumberDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__DateTimeParse__MatchNumberDelegate(void* ptr) noexcept : System::MulticastDelegate(ptr) {
}


  constexpr System__DateTimeParse__MatchNumberDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__DateTimeParse__MatchNumberDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__DateTimeParse__MatchNumberDelegate& operator=(System__DateTimeParse__MatchNumberDelegate&& o) noexcept = default;
  constexpr System__DateTimeParse__MatchNumberDelegate& operator=(System__DateTimeParse__MatchNumberDelegate const& o) noexcept = default;
...
struct CORDL_TYPE System__DateTimeParse__DTT : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr System__DateTimeParse__DTT(int32_t value__) noexcept;


                    constexpr System__DateTimeParse__DTT(System__DateTimeParse__DTT const&) = default;
                    constexpr System__DateTimeParse__DTT(System__DateTimeParse__DTT&&) = default;
                    constexpr System__DateTimeParse__DTT& operator=(System__DateTimeParse__DTT const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__DateTimeParse__DTT& operator=(System__DateTimeParse__DTT&& o) noexcept {
...
constexpr explicit System__DateTimeParse__DTT(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __System__DateTimeParse__DTT_Unwrapped : int32_t {
__End = 0,
__NumEnd = 1,
__NumAmpm = 2,
__NumSpace = 3,
...
static System::System__DateTimeParse__DTT const End;

/// @brief Field NumEnd offset 0
static System::System__DateTimeParse__DTT const NumEnd;

/// @brief Field NumAmpm offset 0
static System::System__DateTimeParse__DTT const NumAmpm;

/// @brief Field NumSpace offset 0
static System::System__DateTimeParse__DTT const NumSpace;

/// @brief Field NumDatesep offset 0
static System::System__DateTimeParse__DTT const NumDatesep;

/// @brief Field NumTimesep offset 0
static System::System__DateTimeParse__DTT const NumTimesep;

/// @brief Field MonthEnd offset 0
static System::System__DateTimeParse__DTT const MonthEnd;

/// @brief Field MonthSpace offset 0
static System::System__DateTimeParse__DTT const MonthSpace;

/// @brief Field MonthDatesep offset 0
static System::System__DateTimeParse__DTT const MonthDatesep;

/// @brief Field NumDatesuff offset 0
static System::System__DateTimeParse__DTT const NumDatesuff;

/// @brief Field NumTimesuff offset 0
static System::System__DateTimeParse__DTT const NumTimesuff;

/// @brief Field DayOfWeek offset 0
static System::System__DateTimeParse__DTT const DayOfWeek;

/// @brief Field YearSpace offset 0
static System::System__DateTimeParse__DTT const YearSpace;

/// @brief Field YearDateSep offset 0
static System::System__DateTimeParse__DTT const YearDateSep;

/// @brief Field YearEnd offset 0
static System::System__DateTimeParse__DTT const YearEnd;

/// @brief Field TimeZone offset 0
static System::System__DateTimeParse__DTT const TimeZone;

/// @brief Field Era offset 0
static System::System__DateTimeParse__DTT const Era;

/// @brief Field NumUTCTimeMark offset 0
static System::System__DateTimeParse__DTT const NumUTCTimeMark;

/// @brief Field Unk offset 0
static System::System__DateTimeParse__DTT const Unk;

/// @brief Field NumLocalTimeMark offset 0
static System::System__DateTimeParse__DTT const NumLocalTimeMark;

/// @brief Field Max offset 0
static System::System__DateTimeParse__DTT const Max;
...
struct CORDL_TYPE System__DateTimeParse__TM : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr System__DateTimeParse__TM(int32_t value__) noexcept;


                    constexpr System__DateTimeParse__TM(System__DateTimeParse__TM const&) = default;
                    constexpr System__DateTimeParse__TM(System__DateTimeParse__TM&&) = default;
                    constexpr System__DateTimeParse__TM& operator=(System__DateTimeParse__TM const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__DateTimeParse__TM& operator=(System__DateTimeParse__TM&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit System__DateTimeParse__TM(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __System__DateTimeParse__TM_Unwrapped : int32_t {
__NotSet = -1,
__AM = 0,
__PM = 1,
};
...
/// @brief Conversion into unwrapped enum value
constexpr operator __System__DateTimeParse__TM_Unwrapped () const noexcept {
...
static System::System__DateTimeParse__TM const NotSet;

/// @brief Field AM offset 0
static System::System__DateTimeParse__TM const AM;

/// @brief Field PM offset 0
static System::System__DateTimeParse__TM const PM;
...
struct CORDL_TYPE System__DateTimeParse__DS : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr System__DateTimeParse__DS(int32_t value__) noexcept;


                    constexpr System__DateTimeParse__DS(System__DateTimeParse__DS const&) = default;
                    constexpr System__DateTimeParse__DS(System__DateTimeParse__DS&&) = default;
                    constexpr System__DateTimeParse__DS& operator=(System__DateTimeParse__DS const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__DateTimeParse__DS& operator=(System__DateTimeParse__DS&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit System__DateTimeParse__DS(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __System__DateTimeParse__DS_Unwrapped : int32_t {
__BEGIN = 0,
__N = 1,
__NN = 2,
__D_Nd = 3,
...
static System::System__DateTimeParse__DS const BEGIN;

/// @brief Field N offset 0
static System::System__DateTimeParse__DS const N;

/// @brief Field NN offset 0
static System::System__DateTimeParse__DS const NN;

/// @brief Field D_Nd offset 0
static System::System__DateTimeParse__DS const D_Nd;

/// @brief Field D_NN offset 0
static System::System__DateTimeParse__DS const D_NN;

/// @brief Field D_NNd offset 0
static System::System__DateTimeParse__DS const D_NNd;

/// @brief Field D_M offset 0
static System::System__DateTimeParse__DS const D_M;

/// @brief Field D_MN offset 0
static System::System__DateTimeParse__DS const D_MN;

/// @brief Field D_NM offset 0
static System::System__DateTimeParse__DS const D_NM;

/// @brief Field D_MNd offset 0
static System::System__DateTimeParse__DS const D_MNd;

/// @brief Field D_NDS offset 0
static System::System__DateTimeParse__DS const D_NDS;

/// @brief Field D_Y offset 0
static System::System__DateTimeParse__DS const D_Y;

/// @brief Field D_YN offset 0
static System::System__DateTimeParse__DS const D_YN;

/// @brief Field D_YNd offset 0
static System::System__DateTimeParse__DS const D_YNd;

/// @brief Field D_YM offset 0
static System::System__DateTimeParse__DS const D_YM;

/// @brief Field D_YMd offset 0
static System::System__DateTimeParse__DS const D_YMd;

/// @brief Field D_S offset 0
static System::System__DateTimeParse__DS const D_S;

/// @brief Field T_S offset 0
static System::System__DateTimeParse__DS const T_S;

/// @brief Field T_Nt offset 0
static System::System__DateTimeParse__DS const T_Nt;

/// @brief Field T_NNt offset 0
static System::System__DateTimeParse__DS const T_NNt;

/// @brief Field ERROR offset 0
static System::System__DateTimeParse__DS const ERROR;

/// @brief Field DX_NN offset 0
static System::System__DateTimeParse__DS const DX_NN;

/// @brief Field DX_NNN offset 0
static System::System__DateTimeParse__DS const DX_NNN;

/// @brief Field DX_MN offset 0
static System::System__DateTimeParse__DS const DX_MN;

/// @brief Field DX_NM offset 0
static System::System__DateTimeParse__DS const DX_NM;

/// @brief Field DX_MNN offset 0
static System::System__DateTimeParse__DS const DX_MNN;

/// @brief Field DX_DS offset 0
static System::System__DateTimeParse__DS const DX_DS;

/// @brief Field DX_DSN offset 0
static System::System__DateTimeParse__DS const DX_DSN;

/// @brief Field DX_NDS offset 0
static System::System__DateTimeParse__DS const DX_NDS;

/// @brief Field DX_NNDS offset 0
static System::System__DateTimeParse__DS const DX_NNDS;

/// @brief Field DX_YNN offset 0
static System::System__DateTimeParse__DS const DX_YNN;

/// @brief Field DX_YMN offset 0
static System::System__DateTimeParse__DS const DX_YMN;

/// @brief Field DX_YN offset 0
static System::System__DateTimeParse__DS const DX_YN;

/// @brief Field DX_YM offset 0
static System::System__DateTimeParse__DS const DX_YM;

/// @brief Field TX_N offset 0
static System::System__DateTimeParse__DS const TX_N;

/// @brief Field TX_NN offset 0
static System::System__DateTimeParse__DS const TX_NN;

/// @brief Field TX_NNN offset 0
static System::System__DateTimeParse__DS const TX_NNN;

/// @brief Field TX_TS offset 0
static System::System__DateTimeParse__DS const TX_TS;

/// @brief Field DX_NNY offset 0
static System::System__DateTimeParse__DS const DX_NNY;
...
class CORDL_TYPE System__DateTimeParse____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~System__DateTimeParse____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__DateTimeParse____c", modifiers: " const&", def_value: None }]
constexpr System__DateTimeParse____c(System__DateTimeParse____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__DateTimeParse____c", modifiers: "&&", def_value: None }]
constexpr System__DateTimeParse____c(System__DateTimeParse____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__DateTimeParse____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__DateTimeParse____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__DateTimeParse____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__DateTimeParse____c& operator=(System__DateTimeParse____c&& o) noexcept = default;
  constexpr System__DateTimeParse____c& operator=(System__DateTimeParse____c const& o) noexcept = default;
                


// Fields

static System::System__DateTimeParse____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(System::System__DateTimeParse____c value) ;

static System::System__DateTimeParse____c __get___9() ;

static System::Func_1<System::System__DateTimeParse__MatchNumberDelegate> __declspec(property(get=__get___9__98_0, put=__set___9__98_0))  __9__98_0;

static void __set___9__98_0(System::Func_1<System::System__DateTimeParse__MatchNumberDelegate> value) ;

static System::Func_1<System::System__DateTimeParse__MatchNumberDelegate> __get___9__98_0() ;
...
/// @brief Method <DoStrictParse>b__98_0 addr 0x2436fa4 size 0x74 virtual false final false
 System::System__DateTimeParse__MatchNumberDelegate _DoStrictParse_b__98_0() ;
...
public:
// Declarations
using __c = System::System__DateTimeParse____c;

using DS = System::System__DateTimeParse__DS;

using TM = System::System__DateTimeParse__TM;

using DTT = System::System__DateTimeParse__DTT;

using MatchNumberDelegate = System::System__DateTimeParse__MatchNumberDelegate;
...
static System::System__DateTimeParse__MatchNumberDelegate __declspec(property(get=__get_m_hebrewNumberParser, put=__set_m_hebrewNumberParser))  m_hebrewNumberParser;

static void __set_m_hebrewNumberParser(System::System__DateTimeParse__MatchNumberDelegate value) ;

static System::System__DateTimeParse__MatchNumberDelegate __get_m_hebrewNumberParser() ;

static ::ArrayW<::ArrayW<System::System__DateTimeParse__DS>> __declspec(property(get=__get_dateParsingStates, put=__set_dateParsingStates))  dateParsingStates;

static void __set_dateParsingStates(::ArrayW<::ArrayW<System::System__DateTimeParse__DS>> value) ;

static ::ArrayW<::ArrayW<System::System__DateTimeParse__DS>> __get_dateParsingStates() ;
...
static bool Lex(System::System__DateTimeParse__DS dps, ByRef<System::__DTString> str, ByRef<System::DateTimeToken> dtok, ByRef<System::DateTimeRawInfo> raw, ByRef<System::DateTimeResult> result, ByRef<System::Globalization::DateTimeFormatInfo> dtfi, System::Globalization::DateTimeStyles styles) ;
...
static bool AdjustHour(ByRef<int32_t> hour, System::System__DateTimeParse__TM timeMark) ;
...
static bool ProcessHebrewTerminalState(System::System__DateTimeParse__DS dps, ByRef<System::__DTString> str, ByRef<System::DateTimeResult> result, ByRef<System::Globalization::DateTimeStyles> styles, ByRef<System::DateTimeRawInfo> raw, System::Globalization::DateTimeFormatInfo dtfi) ;

/// @brief Method ProcessTerminalState addr 0x242eb80 size 0x304 virtual false final false
static bool ProcessTerminalState(System::System__DateTimeParse__DS dps, ByRef<System::__DTString> str, ByRef<System::DateTimeResult> result, ByRef<System::Globalization::DateTimeStyles> styles, ByRef<System::DateTimeRawInfo> raw, System::Globalization::DateTimeFormatInfo dtfi) ;
...
static bool MatchTimeMark(ByRef<System::__DTString> str, System::Globalization::DateTimeFormatInfo dtfi, ByRef<System::System__DateTimeParse__TM> result) ;

/// @brief Method MatchAbbreviatedTimeMark addr 0x24340b8 size 0xec virtual false final false
static bool MatchAbbreviatedTimeMark(ByRef<System::__DTString> str, System::Globalization::DateTimeFormatInfo dtfi, ByRef<System::System__DateTimeParse__TM> result) ;
...
DEFINE_IL2CPP_ARG_TYPE(System::System__DateTimeParse__DS, "System", "DateTimeParse/DS");
DEFINE_IL2CPP_ARG_TYPE(System::System__DateTimeParse__DTT, "System", "DateTimeParse/DTT");
DEFINE_IL2CPP_ARG_TYPE(System::System__DateTimeParse__TM, "System", "DateTimeParse/TM");
NEED_NO_BOX(System::DateTimeParse);
DEFINE_IL2CPP_ARG_TYPE(System::DateTimeParse, "System", "DateTimeParse");
NEED_NO_BOX(System::System__DateTimeParse__MatchNumberDelegate);
DEFINE_IL2CPP_ARG_TYPE(System::System__DateTimeParse__MatchNumberDelegate, "System", "DateTimeParse/MatchNumberDelegate");
NEED_NO_BOX(System::System__DateTimeParse____c);
DEFINE_IL2CPP_ARG_TYPE(System::System__DateTimeParse____c, "System", "DateTimeParse/<>c");
