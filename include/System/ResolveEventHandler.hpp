...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C93BAC
  class ResolveEventHandler : public System::MulticastDelegate {
    ...
    // Offset: 0x12F6A6C
    System::Reflection::Assembly* Invoke_NEW(::Il2CppObject* sender, System::ResolveEventArgs* args);
    ...
    // Offset: 0x12F6E5C
    System::IAsyncResult* BeginInvoke_NEW(::Il2CppObject* sender, System::ResolveEventArgs* args, System::AsyncCallback* callback, ::Il2CppObject* object);
    // public System.Reflection.Assembly EndInvoke(System.IAsyncResult result)
    // Offset: 0x12F6E8C
    System::Reflection::Assembly* EndInvoke_NEW(System::IAsyncResult* result);
