...
namespace System::Linq {
  ...
  class EmptyEnumerable_1 : public ::Il2CppObject {
    ...
    static ::ArrayWrapper<TElement> _get_Instance() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::EmptyEnumerable_1::_get_Instance");
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::ArrayWrapper<TElement>>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<EmptyEnumerable_1<TElement>*>::get(), "Instance"));
    }
    // Autogenerated static field setter
    // Set static field: static public readonly TElement[] Instance
    static void _set_Instance(::ArrayWrapper<TElement> value) {
