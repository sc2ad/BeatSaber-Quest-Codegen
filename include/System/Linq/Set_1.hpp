...
namespace System::Linq {
  ...
  class Set_1 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename System::Linq::Set_1<TElement>::Slot> slots;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<typename System::Linq::Set_1<TElement>::Slot>) == 0x8);
    ...
    Set_1(::ArrayWrapper<int> buckets_ = {}, ::ArrayWrapper<typename System::Linq::Set_1<TElement>::Slot> slots_ = {}, int count_ = {}, int freeList_ = {}, System::Collections::Generic::IEqualityComparer_1<TElement>* comparer_ = {}) noexcept : buckets{buckets_}, slots{slots_}, count{count_}, freeList{freeList_}, comparer{comparer_} {}
    // Autogenerated instance field getter
    ...
    ::ArrayWrapper<typename System::Linq::Set_1<TElement>::Slot>& dyn_slots() {
      ...
      return *reinterpret_cast<::ArrayWrapper<typename System::Linq::Set_1<TElement>::Slot>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
