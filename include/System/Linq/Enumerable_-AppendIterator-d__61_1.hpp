...
namespace System::Linq {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D47854
  ...
  // Could not write size check! Type: System.Linq.Enumerable/<AppendIterator>d__61`1 is generic, or has no fields that are valid for size checks!
}
