...
namespace System::Linq {
  ...
  class Enumerable::$ExceptIterator$d__77_1 : public System::Collections::Generic::IEnumerable_1<TSource>, public System::Collections::Generic::IEnumerator_1<TSource>, public ::Il2CppObject {
    public:
