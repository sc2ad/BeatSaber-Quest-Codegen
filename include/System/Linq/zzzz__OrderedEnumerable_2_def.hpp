...
namespace System::Linq {
template<>
class OrderedEnumerable_2<Zenject::Zenject__DisposableManager__DisposableInfo,int32_t>;
}
namespace System::Linq {
template<>
class OrderedEnumerable_2<Zenject::Zenject__PoolableManager__PoolableInfo,int32_t>;
}
namespace System::Linq {
template<>
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14573)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14572), inst: 1596 }), TypeDefinitionIndex(TypeDefinitionIndex(14572))}
...
// CS Name: System.Linq.OrderedEnumerable`2
class CORDL_TYPE OrderedEnumerable_2<Zenject::Zenject__DisposableManager__DisposableInfo,int32_t> : public System::Linq::OrderedEnumerable_1<Zenject::Zenject__DisposableManager__DisposableInfo> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};
...
explicit OrderedEnumerable_2(System::Collections::Generic::IEnumerable_1<Zenject::Zenject__DisposableManager__DisposableInfo> source, System::Func_2<Zenject::Zenject__DisposableManager__DisposableInfo,int32_t> keySelector, System::Collections::Generic::IComparer_1<int32_t> comparer, bool descending) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(System::Collections::Generic::IEnumerable_1<Zenject::Zenject__DisposableManager__DisposableInfo> source, System::Func_2<Zenject::Zenject__DisposableManager__DisposableInfo,int32_t> keySelector, System::Collections::Generic::IComparer_1<int32_t> comparer, bool descending) ;
...
// CS Name: System.Linq.OrderedEnumerable`2
class CORDL_TYPE OrderedEnumerable_2<Zenject::Zenject__PoolableManager__PoolableInfo,int32_t> : public System::Linq::OrderedEnumerable_1<Zenject::Zenject__PoolableManager__PoolableInfo> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};
...
explicit OrderedEnumerable_2(System::Collections::Generic::IEnumerable_1<Zenject::Zenject__PoolableManager__PoolableInfo> source, System::Func_2<Zenject::Zenject__PoolableManager__PoolableInfo,int32_t> keySelector, System::Collections::Generic::IComparer_1<int32_t> comparer, bool descending) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(System::Collections::Generic::IEnumerable_1<Zenject::Zenject__PoolableManager__PoolableInfo> source, System::Func_2<Zenject::Zenject__PoolableManager__PoolableInfo,int32_t> keySelector, System::Collections::Generic::IComparer_1<int32_t> comparer, bool descending) ;
