...
namespace System::Linq {
  ...
  class EnumerableSorter_1 : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    void ComputeKeys_NEW(::Array<TElement>* elements, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::EnumerableSorter_1::ComputeKeys_NEW");
    ...
    // Offset: 0xFFFFFFFF
    int CompareKeys_NEW(int index1, int index2) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::EnumerableSorter_1::CompareKeys_NEW");
