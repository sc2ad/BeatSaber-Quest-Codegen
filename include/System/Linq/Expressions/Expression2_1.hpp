...
namespace System::Linq::Expressions {
  // Forward declaring type: Expression2`1<TDelegate>
...
namespace System::Linq::Expressions {
  ...
  // Autogenerated type: System.Linq.Expressions.Expression2`1
  ...
  class Expression2_1 : public System::Linq::Expressions::Expression_1<TDelegate> {
    ...
    ::Il2CppObject*& dyn__par0() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::dyn__par0");
    ...
    System::Linq::Expressions::ParameterExpression*& dyn__par1() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::dyn__par1");
      auto ___internal__instance = this;
    ...
    static Expression2_1<TDelegate>* New_ctor(System::Linq::Expressions::Expression* body, System::Linq::Expressions::ParameterExpression* par0, System::Linq::Expressions::ParameterExpression* par1) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Expression2_1<TDelegate>*, creationType>(body, par0, par1)));
    }
    ...
    int get_ParameterCount() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::get_ParameterCount");
    ...
    System::Linq::Expressions::ParameterExpression* GetParameter(int index) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::GetParameter");
    ...
    System::Linq::Expressions::Expression_1<TDelegate>* Rewrite(System::Linq::Expressions::Expression* body, ::ArrayW<System::Linq::Expressions::ParameterExpression*> parameters) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Expression2_1::Rewrite");
  ...
  }; // System.Linq.Expressions.Expression2`1
  // Could not write size check! Type: System.Linq.Expressions.Expression2`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
