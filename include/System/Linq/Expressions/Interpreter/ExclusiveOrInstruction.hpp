...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: ExclusiveOrInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.ExclusiveOrInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class ExclusiveOrInstruction : public System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrSByte
    class ExclusiveOrSByte;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrInt16
    class ExclusiveOrInt16;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrInt32
    class ExclusiveOrInt32;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrInt64
    class ExclusiveOrInt64;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrByte
    class ExclusiveOrByte;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrUInt16
    class ExclusiveOrUInt16;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrUInt32
    class ExclusiveOrUInt32;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrUInt64
    class ExclusiveOrUInt64;
    // Nested type: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::ExclusiveOrBoolean
    ...
    static ExclusiveOrInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<ExclusiveOrInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.ExclusiveOrInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Linq::Expressions::Interpreter::Instruction* (*)(System::Type*)>(&System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::*)()>(&System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::*)()>(&System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::*)()>(&System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::ExclusiveOrInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::ExclusiveOrInstruction::New_ctor
// Il2CppName: .ctor
