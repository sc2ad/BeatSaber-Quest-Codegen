...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: MulOvfInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.MulOvfInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class MulOvfInstruction : public System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfInt16
    class MulOvfInt16;
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfInt32
    class MulOvfInt32;
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfInt64
    class MulOvfInt64;
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfUInt16
    class MulOvfUInt16;
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfUInt32
    class MulOvfUInt32;
    // Nested type: System::Linq::Expressions::Interpreter::MulOvfInstruction::MulOvfUInt64
    class MulOvfUInt64;
    ...
    static MulOvfInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Interpreter::MulOvfInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MulOvfInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.MulOvfInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulOvfInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Linq::Expressions::Interpreter::Instruction* (*)(System::Type*)>(&System::Linq::Expressions::Interpreter::MulOvfInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulOvfInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulOvfInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::MulOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulOvfInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulOvfInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulOvfInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::MulOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulOvfInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulOvfInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulOvfInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::MulOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::MulOvfInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::MulOvfInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::MulOvfInstruction::New_ctor
// Il2CppName: .ctor
