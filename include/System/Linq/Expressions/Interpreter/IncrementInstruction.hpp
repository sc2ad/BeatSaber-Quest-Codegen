...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: IncrementInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.IncrementInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class IncrementInstruction : public System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementInt16
    class IncrementInt16;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementInt32
    class IncrementInt32;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementInt64
    class IncrementInt64;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementUInt16
    class IncrementUInt16;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementUInt32
    class IncrementUInt32;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementUInt64
    class IncrementUInt64;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementSingle
    class IncrementSingle;
    // Nested type: System::Linq::Expressions::Interpreter::IncrementInstruction::IncrementDouble
    ...
    static IncrementInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Expressions::Interpreter::IncrementInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<IncrementInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.IncrementInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::IncrementInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Linq::Expressions::Interpreter::Instruction* (*)(System::Type*)>(&System::Linq::Expressions::Interpreter::IncrementInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::IncrementInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::IncrementInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::IncrementInstruction::*)()>(&System::Linq::Expressions::Interpreter::IncrementInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::IncrementInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::IncrementInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::IncrementInstruction::*)()>(&System::Linq::Expressions::Interpreter::IncrementInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::IncrementInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::IncrementInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::IncrementInstruction::*)()>(&System::Linq::Expressions::Interpreter::IncrementInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::IncrementInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::IncrementInstruction::New_ctor
// Il2CppName: .ctor
