...
namespace System::Linq::Expressions::Interpreter {
  // Forward declaring type: AddOvfInstruction
...
namespace System::Linq::Expressions::Interpreter {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: System.Linq.Expressions.Interpreter.AddOvfInstruction
  // [TokenAttribute] Offset: FFFFFFFF
  class AddOvfInstruction : public ::System::Linq::Expressions::Interpreter::Instruction {
    public:
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfInt16
    class AddOvfInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfInt32
    class AddOvfInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfInt64
    class AddOvfInt64;
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfUInt16
    class AddOvfUInt16;
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfUInt32
    class AddOvfUInt32;
    // Nested type: ::System::Linq::Expressions::Interpreter::AddOvfInstruction::AddOvfUInt64
    class AddOvfUInt64;
    ...
    static AddOvfInstruction* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Linq::Expressions::Interpreter::AddOvfInstruction::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<AddOvfInstruction*, creationType>()));
    }
  }; // System.Linq.Expressions.Interpreter.AddOvfInstruction
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::AddOvfInstruction::Create
// Il2CppName: Create
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Linq::Expressions::Interpreter::Instruction* (*)(::System::Type*)>(&System::Linq::Expressions::Interpreter::AddOvfInstruction::Create)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::AddOvfInstruction*), "Create", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::AddOvfInstruction::get_ConsumedStack
// Il2CppName: get_ConsumedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::AddOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::AddOvfInstruction::get_ConsumedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::AddOvfInstruction*), "get_ConsumedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::AddOvfInstruction::get_ProducedStack
// Il2CppName: get_ProducedStack
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (System::Linq::Expressions::Interpreter::AddOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::AddOvfInstruction::get_ProducedStack)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::AddOvfInstruction*), "get_ProducedStack", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::AddOvfInstruction::get_InstructionName
// Il2CppName: get_InstructionName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Linq::Expressions::Interpreter::AddOvfInstruction::*)()>(&System::Linq::Expressions::Interpreter::AddOvfInstruction::get_InstructionName)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Linq::Expressions::Interpreter::AddOvfInstruction*), "get_InstructionName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Linq::Expressions::Interpreter::AddOvfInstruction::New_ctor
// Il2CppName: .ctor
