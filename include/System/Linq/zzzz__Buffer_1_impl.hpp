...
constexpr System::Linq::Buffer_1<TElement>::Buffer_1(::ArrayW<TElement> items, int32_t count) noexcept : ::bs_hook::ValueTypeWrapper() {this->items = items;
this->count = count;
}
constexpr void System::Linq::Buffer_1<TElement>::__set_items(::ArrayW<TElement> value)  {
::cordl_internals::setInstanceField<::ArrayW<TElement>, 0x0>(this->__instance, std::forward<::ArrayW<TElement>>(value));
}
constexpr ::ArrayW<TElement> System::Linq::Buffer_1<TElement>::__get_items() const {
...
constexpr int32_t System::Linq::Buffer_1<TElement>::__get_count() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->__instance);
}
 void System::Linq::Buffer_1<TElement>::_ctor(System::Collections::Generic::IEnumerable_1<TElement> source)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, source);
 ...
 ::ArrayW<TElement> System::Linq::Buffer_1<TElement>::ToArray()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Linq::Buffer_1<TElement>>::get(),
                            "ToArray",
                            std::vector<Il2CppClass*>{},
