...
namespace System::Linq {
  ...
  class Enumerable::WhereEnumerableIterator_1 : public System::Linq::Enumerable::Iterator_1<TSource> {
    ...
    static Enumerable::WhereEnumerableIterator_1<TSource>* New_ctor(System::Collections::Generic::IEnumerable_1<TSource>* source, System::Func_2<TSource, bool>* predicate) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<Enumerable::WhereEnumerableIterator_1<TSource>*>(source, predicate));
    }
    ...
    System::Linq::Enumerable::Iterator_1<TSource>* Clone() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext("Clone");
    ...
    void Dispose() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext("Dispose");
    ...
    bool MoveNext() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext("MoveNext");
    ...
    System::Collections::Generic::IEnumerable_1<TResult>* Select(System::Func_2<TSource, TResult>* selector) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext("Select");
    ...
    System::Collections::Generic::IEnumerable_1<TSource>* Where(System::Func_2<TSource, bool>* predicate) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("WhereEnumerableIterator_1").WithContext("Where");
  ...
  // Could not write size check! Type: System.Linq.Enumerable/WhereEnumerableIterator`1 is generic!
}
