...
namespace System::Linq {
  ...
  class Enumerable::$OfTypeIterator$d__97_1 : public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<TResult>, public System::Collections::Generic::IEnumerator_1<TResult>*/ {
    ...
    static Enumerable::$OfTypeIterator$d__97_1<TResult>* New_ctor(int $$1__state) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<Enumerable::$OfTypeIterator$d__97_1<TResult>*>($$1__state));
    }
    // private System.Void <>m__Finally1()
    // Offset: 0xFFFFFFFF
    void $$m__Finally1() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("<>m__Finally1");
    ...
    void System_IDisposable_Dispose() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.IDisposable.Dispose");
    ...
    bool MoveNext() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("MoveNext");
    ...
    TResult System_Collections_Generic_IEnumerator_1_get_Current() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.Collections.Generic.IEnumerator<TResult>.get_Current");
    ...
    void System_Collections_IEnumerator_Reset() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.Collections.IEnumerator.Reset");
    ...
    ::Il2CppObject* System_Collections_IEnumerator_get_Current() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.Collections.IEnumerator.get_Current");
    ...
    System::Collections::Generic::IEnumerator_1<TResult>* System_Collections_Generic_IEnumerable_1_GetEnumerator() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.Collections.Generic.IEnumerable<TResult>.GetEnumerator");
    ...
    System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Linq").WithContext("$OfTypeIterator$d__97_1").WithContext("System.Collections.IEnumerable.GetEnumerator");
  ...
  // Could not write size check! Type: System.Linq.Enumerable/<OfTypeIterator>d__97`1 is generic!
}
