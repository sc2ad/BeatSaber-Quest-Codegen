...
namespace System::Linq {
  ...
  struct Buffer_1/*, public System::ValueType*/ {
    ...
    ::Array<TElement>* _get_items() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Buffer_1::_get_items");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<TElement>*>(___internal__instance, "items"));
    }
    // Autogenerated instance field setter
    // Set instance field: TElement[] items
    void _set_items(::Array<TElement>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Buffer_1::_set_items");
      static auto ___internal__instance = *this;
    ...
    int _get_count() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Buffer_1::_get_count");
      static auto ___internal__instance = *this;
    ...
    void _set_count(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Linq::Buffer_1::_set_count");
      static auto ___internal__instance = *this;
