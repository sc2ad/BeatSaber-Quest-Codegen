...
namespace System::Linq {
  ...
  struct Buffer_1/*, public System::ValueType*/ {
    ...
    ::ArrayWrapper<TElement>& dyn_items() {
    ...
    ::ArrayWrapper<TElement> ToArray() {
      ...
      return ::il2cpp_utils::RunMethodThrow<::ArrayWrapper<TElement>, false>(*this, ___internal__method);
    }
