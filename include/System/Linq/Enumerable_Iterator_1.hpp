...
namespace System::Linq {
  ...
  class Enumerable::Iterator_1 : public System::Collections::Generic::IEnumerable_1<TSource>, public System::Collections::Generic::IEnumerator_1<TSource>, public ::Il2CppObject {
    public:
