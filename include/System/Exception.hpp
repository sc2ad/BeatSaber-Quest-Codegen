...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ClassInterfaceAttribute] Offset: C92E94
  // [ComVisibleAttribute] Offset: C92E94
  // [ComDefaultInterfaceAttribute] Offset: C92E94
  class Exception : public ::Il2CppObject/*, public System::Runtime::Serialization::ISerializable, public System::Runtime::InteropServices::_Exception*/ {
    ...
    // Field size check
    static_assert(sizeof(::Il2CppString*) == 0x8);
    // [OptionalFieldAttribute] Offset: 0xC998D8
    ...
    // Offset: 0x164EBBC
    System::Collections::IDictionary* get_Data_NEW();
    ...
    // Offset: 0x164EC58
    System::Exception* get_InnerException_NEW();
