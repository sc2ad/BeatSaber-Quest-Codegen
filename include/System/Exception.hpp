...
namespace System {
  ...
  // [ClassInterfaceAttribute] Offset: E5C000
  // [ComDefaultInterfaceAttribute] Offset: E5C000
  // [ComVisibleAttribute] Offset: E5C000
  class Exception : public ::Il2CppObject/*, public System::Runtime::Serialization::ISerializable, public System::Runtime::InteropServices::_Exception*/ {
    ...
    // Field size check
    static_assert(sizeof(::Il2CppString*) == 0x8);
    // [OptionalFieldAttribute] Offset: 0xE62A68
    ...
    // [OptionalFieldAttribute] Offset: 0xE62A58
    ...
    ::ArrayWrapper<System::IntPtr>& dyn_native_trace_ips();
  ...
  #pragma pack(pop)
  static check_size<sizeof(Exception), 128 + sizeof(::ArrayWrapper<System::IntPtr>)> __System_ExceptionSizeCheck;
