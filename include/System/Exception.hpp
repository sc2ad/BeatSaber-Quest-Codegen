...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComDefaultInterfaceAttribute] Offset: CA7C50
  // [ClassInterfaceAttribute] Offset: CA7C50
  // [ComVisibleAttribute] Offset: CA7C50
  class Exception : public ::Il2CppObject/*, public System::Runtime::Serialization::ISerializable, public System::Runtime::InteropServices::_Exception*/ {
    ...
    // Field size check
    static_assert(sizeof(::Il2CppString*) == 0x8);
    // [OptionalFieldAttribute] Offset: 0xCAEA28
    ...
    // [OptionalFieldAttribute] Offset: 0xCAEA18
