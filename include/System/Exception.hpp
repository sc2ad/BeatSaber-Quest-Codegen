...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [ComDefaultInterfaceAttribute] Offset: D3709C
  // [ClassInterfaceAttribute] Offset: D3709C
  // [ComVisibleAttribute] Offset: D3709C
  class Exception : public ::Il2CppObject/*, public System::Runtime::Serialization::ISerializable, public System::Runtime::InteropServices::_Exception*/ {
    ...
    // Field size check
    static_assert(sizeof(::Il2CppString*) == 0x8);
    // [OptionalFieldAttribute] Offset: 0xD3DE74
