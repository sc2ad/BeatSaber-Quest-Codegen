...
namespace System::Xml {
  ...
  #pragma pack(pop)
  static check_size<sizeof(XmlEncodedRawTextWriterIndent), 224 + sizeof(System::Xml::ConformanceLevel)> __System_Xml_XmlEncodedRawTextWriterIndentSizeCheck;
  static_assert(sizeof(XmlEncodedRawTextWriterIndent) == 0xE4);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
