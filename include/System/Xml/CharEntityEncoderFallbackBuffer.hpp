...
namespace System::Xml {
  ...
  check_size<sizeof(CharEntityEncoderFallbackBuffer), 64 + sizeof(int) + ((64 + sizeof(int)) % 8 != 0 ? (8 - (64 + sizeof(int)) % 8) : 0)> __System_Xml_CharEntityEncoderFallbackBufferSizeCheck;
}
