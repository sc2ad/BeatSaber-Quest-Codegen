...
namespace System::Xml {
  ...
  check_size<sizeof(XmlWellFormedWriter::AttributeValueCache::BufferChunk), 28 + sizeof(int) + ((28 + sizeof(int)) % 8 != 0 ? (8 - (28 + sizeof(int)) % 8) : 0)> __System_Xml_XmlWellFormedWriter_AttributeValueCache_BufferChunkSizeCheck;
}
