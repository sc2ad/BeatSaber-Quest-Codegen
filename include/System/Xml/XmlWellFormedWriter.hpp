...
namespace System::Xml {
  ...
  class XmlWellFormedWriter : public System::Xml::XmlWriter {
    ...
    check_size<sizeof(XmlWellFormedWriter::State), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Xml_XmlWellFormedWriter_StateSizeCheck;
    ...
    check_size<sizeof(XmlWellFormedWriter::SpecialAttribute), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Xml_XmlWellFormedWriter_SpecialAttributeSizeCheck;
  ...
  check_size<sizeof(XmlWellFormedWriter), 168 + sizeof(void*) + 8 - (168 + sizeof(void*)) % 8> __System_Xml_XmlWellFormedWriterSizeCheck;
}
