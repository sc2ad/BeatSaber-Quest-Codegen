...
static System::Xml::XmlUtf8RawTextWriterIndent New_ctor(System::IO::Stream stream, System::Xml::XmlWriterSettings settings) ;
...
/// @brief Method WriteStartElement addr 0x26e4e68 size 0x6c virtual true final false
 void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method StartElementContent addr 0x26e4ed4 size 0x50 virtual true final false
...
/// @brief Method WriteFullEndElement addr 0x26e4fac size 0x80 virtual true final false
 void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteStartAttribute addr 0x26e502c size 0x3c virtual true final false
 void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteCData addr 0x26e5068 size 0xc virtual true final false
 void WriteCData(::StringW text) ;

/// @brief Method WriteComment addr 0x26e5074 size 0x40 virtual true final false
 void WriteComment(::StringW text) ;

/// @brief Method WriteProcessingInstruction addr 0x26e50b4 size 0x48 virtual true final false
 void WriteProcessingInstruction(::StringW target, ::StringW text) ;

/// @brief Method WriteEntityRef addr 0x26e50fc size 0xc virtual true final false
 void WriteEntityRef(::StringW name) ;

/// @brief Method WriteCharEntity addr 0x26e5108 size 0xc virtual true final false
 void WriteCharEntity(char16_t ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x26e5114 size 0xc virtual true final false
 void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar) ;

/// @brief Method WriteWhitespace addr 0x26e5120 size 0xc virtual true final false
 void WriteWhitespace(::StringW ws) ;

/// @brief Method WriteString addr 0x26e512c size 0xc virtual true final false
 void WriteString(::StringW text) ;

/// @brief Method WriteChars addr 0x26e5138 size 0xc virtual true final false
 void WriteChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x26e5144 size 0xc virtual true final false
 void WriteRaw(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x26e5150 size 0xc virtual true final false
 void WriteRaw(::StringW data) ;

/// @brief Method WriteBase64 addr 0x26e515c size 0x10 virtual true final false
