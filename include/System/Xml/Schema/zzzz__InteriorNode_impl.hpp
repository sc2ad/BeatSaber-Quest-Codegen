...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Xml::Schema::SyntaxTreeNode (System::Xml::Schema::InteriorNode::*)()>(&System::Xml::Schema::InteriorNode::get_LeftChild)> {
  ...
  constexpr static std::size_t addrs = 0x271a840;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::InteriorNode>::get(),
                            "get_LeftChild",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::InteriorNode::*)(System::Xml::Schema::SyntaxTreeNode)>(&System::Xml::Schema::InteriorNode::set_LeftChild)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x271a848;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_LeftChild",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::Xml::Schema::SyntaxTreeNode>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Xml::Schema::SyntaxTreeNode (System::Xml::Schema::InteriorNode::*)()>(&System::Xml::Schema::InteriorNode::get_RightChild)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x271a850;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::InteriorNode::*)(System::Xml::Schema::SyntaxTreeNode)>(&System::Xml::Schema::InteriorNode::set_RightChild)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x271a858;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::InteriorNode::*)(System::Xml::Schema::InteriorNode, System::Xml::Schema::SymbolsDictionary, System::Xml::Schema::Positions)>(&System::Xml::Schema::InteriorNode::ExpandTreeNoRecursive)> {
  ...
  constexpr static std::size_t addrs = 0x271a860;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::InteriorNode::*)(System::Xml::Schema::InteriorNode, System::Xml::Schema::SymbolsDictionary, System::Xml::Schema::Positions)>(&System::Xml::Schema::InteriorNode::ExpandTree)> {
  ...
  constexpr static std::size_t addrs = 0x271aa40;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(System::Xml::Schema::InteriorNode),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::InteriorNode>::get(),
                                  4
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::InteriorNode::*)()>(&System::Xml::Schema::InteriorNode::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x271aaa4;
...
::cordl_internals::setInstanceField<System::Xml::Schema::SyntaxTreeNode, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Xml::Schema::SyntaxTreeNode>(value));
}
constexpr System::Xml::Schema::SyntaxTreeNode System::Xml::Schema::InteriorNode::__get_leftChild() const {
return ::cordl_internals::getInstanceField<System::Xml::Schema::SyntaxTreeNode, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Xml::Schema::InteriorNode::__set_rightChild(System::Xml::Schema::SyntaxTreeNode value)  {
::cordl_internals::setInstanceField<System::Xml::Schema::SyntaxTreeNode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Xml::Schema::SyntaxTreeNode>(value));
}
constexpr System::Xml::Schema::SyntaxTreeNode System::Xml::Schema::InteriorNode::__get_rightChild() const {
return ::cordl_internals::getInstanceField<System::Xml::Schema::SyntaxTreeNode, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::SyntaxTreeNode, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 System::Xml::Schema::InteriorNode::InteriorNode()  : System::Xml::Schema::SyntaxTreeNode(THROW_UNLESS(::il2cpp_utils::New<InteriorNode>())) {}
 void System::Xml::Schema::InteriorNode::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::InteriorNode>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
