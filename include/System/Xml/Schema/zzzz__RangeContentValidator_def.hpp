...
static System::Xml::Schema::RangeContentValidator New_ctor(System::Xml::Schema::BitSet firstpos, ::ArrayW<System::Xml::Schema::BitSet> followpos, System::Xml::Schema::SymbolsDictionary symbols, System::Xml::Schema::Positions positions, int32_t endMarkerPos, System::Xml::Schema::XmlSchemaContentType contentType, bool isEmptiable, System::Xml::Schema::BitSet positionsWithRangeTerminals, int32_t minmaxNodesCount) ;
