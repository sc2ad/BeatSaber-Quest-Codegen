...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::XmlTypeCode, false>(const_cast<void*>(instance), ___internal_method);
 ...
 System::Xml::Schema::Datatype_year System::Xml::Schema::Datatype_year::New_ctor()  {
System::Xml::Schema::Datatype_year o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::Datatype_year>())};
return o;
}
