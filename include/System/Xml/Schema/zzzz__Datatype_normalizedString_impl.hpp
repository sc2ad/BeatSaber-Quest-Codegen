...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Xml::Schema::XmlTypeCode (System::Xml::Schema::Datatype_normalizedString::*)()>(&System::Xml::Schema::Datatype_normalizedString::get_TypeCode)> {
  ...
  constexpr static std::size_t addrs = 0x2727ce4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(System::Xml::Schema::Datatype_normalizedString),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::Datatype_normalizedString>::get(),
                                  8
                                ));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Xml::Schema::XmlSchemaWhiteSpace (System::Xml::Schema::Datatype_normalizedString::*)()>(&System::Xml::Schema::Datatype_normalizedString::get_BuiltInWhitespaceFacet)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2727cec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::Datatype_normalizedString::*)()>(&System::Xml::Schema::Datatype_normalizedString::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x2727cf4;
...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::XmlSchemaWhiteSpace, false>(const_cast<void*>(instance), ___internal_method);
 ...
 System::Xml::Schema::Datatype_normalizedString System::Xml::Schema::Datatype_normalizedString::New_ctor()  {
System::Xml::Schema::Datatype_normalizedString o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::Datatype_normalizedString>())};
return o;
}
 void System::Xml::Schema::Datatype_normalizedString::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::Datatype_normalizedString>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
