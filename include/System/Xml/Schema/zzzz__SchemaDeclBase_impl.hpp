...
constexpr void System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use  System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::Default{0};
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use  System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::Required{1};
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use  System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::Implied{2};
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use  System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::Fixed{3};
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use  System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use::RequiredFixed{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use (System::Xml::Schema::SchemaDeclBase::*)()>(&System::Xml::Schema::SchemaDeclBase::get_Presence)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::SchemaDeclBase::*)(System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use)>(&System::Xml::Schema::SchemaDeclBase::set_Presence)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_Presence",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void System::Xml::Schema::SchemaDeclBase::__set_presence(System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use value)  {
::cordl_internals::setInstanceField<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use, 0x24>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use>(value));
}
constexpr System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use System::Xml::Schema::SchemaDeclBase::__get_presence() const {
return ::cordl_internals::getInstanceField<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use, 0x24>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use System::Xml::Schema::SchemaDeclBase::get_Presence()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::SchemaDeclBase>::get(),
                            "get_Presence",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use, false>(const_cast<void*>(instance), ___internal_method);
}
 void System::Xml::Schema::SchemaDeclBase::set_Presence(System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Xml::Schema::SchemaDeclBase>::get(),
                            "set_Presence",
                            std::vector<Il2CppClass*>{},
