...
struct ____System__Xml__Schema__NamespaceList__ListType;
}
namespace System::Xml::Schema {
class NamespaceList;
}
...
struct CORDL_TYPE ____System__Xml__Schema__NamespaceList__ListType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Xml__Schema__NamespaceList__ListType(int32_t value__) noexcept;


                    constexpr ____System__Xml__Schema__NamespaceList__ListType(____System__Xml__Schema__NamespaceList__ListType const&) = default;
                    constexpr ____System__Xml__Schema__NamespaceList__ListType(____System__Xml__Schema__NamespaceList__ListType&&) = default;
                    constexpr ____System__Xml__Schema__NamespaceList__ListType& operator=(____System__Xml__Schema__NamespaceList__ListType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Xml__Schema__NamespaceList__ListType& operator=(____System__Xml__Schema__NamespaceList__ListType&& o) noexcept {
...
constexpr explicit ____System__Xml__Schema__NamespaceList__ListType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Xml__Schema__NamespaceList__ListType_Unwrapped : int32_t {
__Any = 0,
__Other = 1,
__Set = 2,
};
...
constexpr operator ______System__Xml__Schema__NamespaceList__ListType_Unwrapped () const noexcept {
return std::bit_cast<______System__Xml__Schema__NamespaceList__ListType_Unwrapped>(__instance);
}
...
static ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType const Any;

/// @brief Field Other offset 0
static ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType const Other;

/// @brief Field Set offset 0
static ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType const Set;
...
public:
// Declarations
using ListType = ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType;
...
// Fields
 ...
 ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType __declspec(property(get=__get_type, put=__set_type))  type;

constexpr void __set_type(::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType value) ;

constexpr ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType __get_type() const;
...
// Properties
 ...
 ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType __declspec(property(get=get_Type))  Type;
...
/// @brief Method get_Type addr 0x2730404 size 0x8 virtual false final false
 ::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType get_Type() ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__NamespaceList__ListType, "System.Xml.Schema", "NamespaceList/ListType");
