...
namespace System::Xml::Schema {
class ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName;
}
namespace System::Xml::Schema {
struct ____System__Xml__Schema__XmlAtomicValue__Union;
}
// Type: ::Union
namespace System::Xml::Schema {
// Is value type: true
...
struct CORDL_TYPE ____System__Xml__Schema__XmlAtomicValue__Union : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__Xml__Schema__XmlAtomicValue__Union(bool boolVal, double_t dblVal, int64_t i64Val, int32_t i32Val, ::System::DateTime dtVal) noexcept;


                    constexpr ____System__Xml__Schema__XmlAtomicValue__Union(____System__Xml__Schema__XmlAtomicValue__Union const&) = default;
                    constexpr ____System__Xml__Schema__XmlAtomicValue__Union(____System__Xml__Schema__XmlAtomicValue__Union&&) = default;
                    constexpr ____System__Xml__Schema__XmlAtomicValue__Union& operator=(____System__Xml__Schema__XmlAtomicValue__Union const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Xml__Schema__XmlAtomicValue__Union& operator=(____System__Xml__Schema__XmlAtomicValue__Union&& o) noexcept {
...
constexpr explicit ____System__Xml__Schema__XmlAtomicValue__Union(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName", modifiers: " const&", def_value: None }]
constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName(____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName", modifiers: "&&", def_value: None }]
constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName(____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName& operator=(____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName&& o) noexcept = default;
  constexpr ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName& operator=(____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName const& o) noexcept = default;
...
explicit ____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName(::StringW prefix, ::StringW ns) ;
...
public:
// Declarations
using NamespacePrefixForQName = ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName;

using Union = ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__Union;
...
constexpr ::System::TypeCode __get_clrType() const;
 ...
 ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__Union __declspec(property(get=__get_unionVal, put=__set_unionVal))  unionVal;

constexpr void __set_unionVal(::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__Union value) ;

constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__Union __get_unionVal() const;

 ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName __declspec(property(get=__get_nsPrefix, put=__set_nsPrefix))  nsPrefix;

constexpr void __set_nsPrefix(::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName value) ;

constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName __get_nsPrefix() const;
...
NEED_NO_BOX(::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName);
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__NamespacePrefixForQName, "System.Xml.Schema", "XmlAtomicValue/NamespacePrefixForQName");
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__XmlAtomicValue__Union, "System.Xml.Schema", "XmlAtomicValue/Union");
