...
namespace System::Xml::Schema {
  // Forward declaring type: Datatype_timeTimeZone
...
namespace System::Xml::Schema {
  // Size: 0x3C
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.Datatype_timeTimeZone
  ...
  class Datatype_timeTimeZone : public ::System::Xml::Schema::Datatype_dateTimeBase {
    ...
    static Datatype_timeTimeZone* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Xml::Schema::Datatype_timeTimeZone::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Datatype_timeTimeZone*, creationType>()));
    }
  }; // System.Xml.Schema.Datatype_timeTimeZone
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_timeTimeZone::New_ctor
// Il2CppName: .ctor
