...
constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::____System__Xml__Schema__XmlSchemaParticle__Occurs(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs  ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::None{0};
constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs  ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::Min{1};
constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs  ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs::Max{2};
...
constexpr void ::System::Xml::Schema::XmlSchemaParticle::__set_flags(::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs value)  {
::cordl_internals::setInstanceField<::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs>(value));
}
constexpr ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs ::System::Xml::Schema::XmlSchemaParticle::__get_flags() const {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__Occurs, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
//  Writing Method size for method: ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle::*)()>(&::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x27353e8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{}
                        )));
...
// Ctor Parameters []
 ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle()  : ::System::Xml::Schema::XmlSchemaParticle(THROW_UNLESS(::il2cpp_utils::New<____System__Xml__Schema__XmlSchemaParticle__EmptyParticle>())) {}
 void ::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::System::Xml::Schema::____System__Xml__Schema__XmlSchemaParticle__EmptyParticle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
