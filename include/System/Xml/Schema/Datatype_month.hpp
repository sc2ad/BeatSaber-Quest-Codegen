...
namespace System::Xml::Schema {
  // Forward declaring type: Datatype_month
...
namespace System::Xml::Schema {
  // Size: 0x3C
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.Datatype_month
  ...
  class Datatype_month : public ::System::Xml::Schema::Datatype_dateTimeBase {
    ...
    static Datatype_month* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Xml::Schema::Datatype_month::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Datatype_month*, creationType>()));
    }
  }; // System.Xml.Schema.Datatype_month
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_month::get_TypeCode
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Xml::Schema::XmlTypeCode (System::Xml::Schema::Datatype_month::*)()>(&System::Xml::Schema::Datatype_month::get_TypeCode)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Xml::Schema::Datatype_month*), "get_TypeCode", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_month::New_ctor
// Il2CppName: .ctor
