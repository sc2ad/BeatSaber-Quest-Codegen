...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::XmlTypeCode, false>(const_cast<void*>(instance), ___internal_method);
 ...
 System::Xml::Schema::Datatype_day System::Xml::Schema::Datatype_day::New_ctor()  {
System::Xml::Schema::Datatype_day o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::Datatype_day>())};
return o;
}
