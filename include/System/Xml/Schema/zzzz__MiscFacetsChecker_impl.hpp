...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::MiscFacetsChecker::*)()>(&System::Xml::Schema::MiscFacetsChecker::_ctor)> {
 ...
 System::Xml::Schema::MiscFacetsChecker System::Xml::Schema::MiscFacetsChecker::New_ctor()  {
System::Xml::Schema::MiscFacetsChecker o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::MiscFacetsChecker>())};
return o;
}
