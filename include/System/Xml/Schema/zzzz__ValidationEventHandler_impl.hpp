...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::ValidationEventHandler::*)(::bs_hook::Il2CppWrapperType, System::Xml::Schema::ValidationEventArgs)>(&System::Xml::Schema::ValidationEventHandler::Invoke)> {
 ...
 System::Xml::Schema::ValidationEventHandler System::Xml::Schema::ValidationEventHandler::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
System::Xml::Schema::ValidationEventHandler o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::ValidationEventHandler>(object, method))};
return o;
}
