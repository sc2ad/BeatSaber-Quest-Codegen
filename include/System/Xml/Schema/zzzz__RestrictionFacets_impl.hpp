...
constexpr System::Collections::ArrayList System::Xml::Schema::RestrictionFacets::__get_Patterns() const {
...
constexpr System::Collections::ArrayList System::Xml::Schema::RestrictionFacets::__get_Enumeration() const {
...
::cordl_internals::setInstanceField<System::Xml::Schema::XmlSchemaWhiteSpace, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Xml::Schema::XmlSchemaWhiteSpace>(value));
}
constexpr System::Xml::Schema::XmlSchemaWhiteSpace System::Xml::Schema::RestrictionFacets::__get_WhiteSpace() const {
return ::cordl_internals::getInstanceField<System::Xml::Schema::XmlSchemaWhiteSpace, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Xml::Schema::RestrictionFacets::__set_MaxInclusive(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Xml::Schema::RestrictionFacets::__get_MaxInclusive() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Xml::Schema::RestrictionFacets::__set_MaxExclusive(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Xml::Schema::RestrictionFacets::__get_MaxExclusive() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Xml::Schema::RestrictionFacets::__set_MinInclusive(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Xml::Schema::RestrictionFacets::__get_MinInclusive() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Xml::Schema::RestrictionFacets::__set_MinExclusive(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Xml::Schema::RestrictionFacets::__get_MinExclusive() const {
...
constexpr int32_t System::Xml::Schema::RestrictionFacets::__get_TotalDigits() const {
...
constexpr int32_t System::Xml::Schema::RestrictionFacets::__get_FractionDigits() const {
...
::cordl_internals::setInstanceField<System::Xml::Schema::RestrictionFlags, 0x60>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Xml::Schema::RestrictionFlags>(value));
}
constexpr System::Xml::Schema::RestrictionFlags System::Xml::Schema::RestrictionFacets::__get_Flags() const {
return ::cordl_internals::getInstanceField<System::Xml::Schema::RestrictionFlags, 0x60>(this->::bs_hook::Il2CppWrapperType::instance);
}
