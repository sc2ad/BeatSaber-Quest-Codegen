...
return ::cordl_internals::RunMethodRethrow<System::Xml::Schema::XmlTypeCode, false>(const_cast<void*>(instance), ___internal_method);
 ...
 System::Xml::Schema::Datatype_language System::Xml::Schema::Datatype_language::New_ctor()  {
System::Xml::Schema::Datatype_language o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::Schema::Datatype_language>())};
return o;
}
