...
namespace System::Xml::Schema {
  // Forward declaring type: Datatype_dateTimeTimeZone
...
namespace System::Xml::Schema {
  // Size: 0x3C
  #pragma pack(push, 1)
  // Autogenerated type: System.Xml.Schema.Datatype_dateTimeTimeZone
  ...
  class Datatype_dateTimeTimeZone : public ::System::Xml::Schema::Datatype_dateTimeBase {
    ...
    static Datatype_dateTimeTimeZone* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::System::Xml::Schema::Datatype_dateTimeTimeZone::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Datatype_dateTimeTimeZone*, creationType>()));
    }
  }; // System.Xml.Schema.Datatype_dateTimeTimeZone
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: System::Xml::Schema::Datatype_dateTimeTimeZone::New_ctor
// Il2CppName: .ctor
