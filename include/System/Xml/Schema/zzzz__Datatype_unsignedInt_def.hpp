...
/// @brief Method get_FacetsChecker addr 0x272a07c size 0x58 virtual true final false
 System::Xml::Schema::FacetsChecker get_FacetsChecker() ;

/// @brief Method get_TypeCode addr 0x272a0d4 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method Compare addr 0x272a0dc size 0x94 virtual true final false
 int32_t Compare(::bs_hook::Il2CppWrapperType value1, ::bs_hook::Il2CppWrapperType value2) ;

/// @brief Method get_ValueType addr 0x272a170 size 0x58 virtual true final false
 System::Type get_ValueType() ;

/// @brief Method get_ListValueType addr 0x272a1c8 size 0x58 virtual true final false
 System::Type get_ListValueType() ;

/// @brief Method TryParseValue addr 0x272a220 size 0x140 virtual true final false
...
static System::Xml::Schema::Datatype_unsignedInt New_ctor() ;

/// @brief Method .ctor addr 0x272a360 size 0x54 virtual false final false
 void _ctor() ;
