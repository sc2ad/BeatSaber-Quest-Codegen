...
namespace System::Xml::Schema {
struct ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode;
}
namespace System::Xml::Schema {
struct ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind;
}
namespace System::Xml::Schema {
struct XsdDateTime;
}
namespace System::Xml::Schema {
struct ____System__Xml__Schema__XsdDateTime__Parser;
}
...
struct CORDL_TYPE ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode(int32_t value__) noexcept;


                    constexpr ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode(____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode(____System__Xml__Schema__XsdDateTime__DateTimeTypeCode&&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode& operator=(____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode& operator=(____System__Xml__Schema__XsdDateTime__DateTimeTypeCode&& o) noexcept {
...
constexpr explicit ____System__Xml__Schema__XsdDateTime__DateTimeTypeCode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Xml__Schema__XsdDateTime__DateTimeTypeCode_Unwrapped : int32_t {
__DateTime = 0,
__Time = 1,
__Date = 2,
__GYearMonth = 3,
...
constexpr operator ______System__Xml__Schema__XsdDateTime__DateTimeTypeCode_Unwrapped () const noexcept {
return std::bit_cast<______System__Xml__Schema__XsdDateTime__DateTimeTypeCode_Unwrapped>(__instance);
}
...
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const DateTime;

/// @brief Field Time offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const Time;

/// @brief Field Date offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const Date;

/// @brief Field GYearMonth offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const GYearMonth;

/// @brief Field GYear offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const GYear;

/// @brief Field GMonthDay offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const GMonthDay;

/// @brief Field GDay offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const GDay;

/// @brief Field GMonth offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const GMonth;

/// @brief Field XdrDateTime offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode const XdrDateTime;
...
struct CORDL_TYPE ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind(int32_t value__) noexcept;


                    constexpr ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind(____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind(____System__Xml__Schema__XsdDateTime__XsdDateTimeKind&&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind& operator=(____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind& operator=(____System__Xml__Schema__XsdDateTime__XsdDateTimeKind&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Xml__Schema__XsdDateTime__XsdDateTimeKind(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__Xml__Schema__XsdDateTime__XsdDateTimeKind_Unwrapped : int32_t {
__Unspecified = 0,
__Zulu = 1,
__LocalWestOfZulu = 2,
__LocalEastOfZulu = 3,
...
/// @brief Conversion into unwrapped enum value
constexpr operator ______System__Xml__Schema__XsdDateTime__XsdDateTimeKind_Unwrapped () const noexcept {
return std::bit_cast<______System__Xml__Schema__XsdDateTime__XsdDateTimeKind_Unwrapped>(__instance);
}
...
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const Unspecified;

/// @brief Field Zulu offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const Zulu;

/// @brief Field LocalWestOfZulu offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const LocalWestOfZulu;

/// @brief Field LocalEastOfZulu offset 0
static ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind const LocalEastOfZulu;
...
struct CORDL_TYPE ____System__Xml__Schema__XsdDateTime__Parser : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "typeCode", ty: "::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode", modifiers: "", def_value: None }, CppParam { name: "year", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "month", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "day", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "hour", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "minute", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "second", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "fraction", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "kind", ty: "::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind", modifiers: "", def_value: None }, CppParam { name: "zoneHour", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "zoneMinute", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "text", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "length", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__Xml__Schema__XsdDateTime__Parser(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode typeCode, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second, int32_t fraction, ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind kind, int32_t zoneHour, int32_t zoneMinute, ::StringW text, int32_t length) noexcept;


                    constexpr ____System__Xml__Schema__XsdDateTime__Parser(____System__Xml__Schema__XsdDateTime__Parser const&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__Parser(____System__Xml__Schema__XsdDateTime__Parser&&) = default;
                    constexpr ____System__Xml__Schema__XsdDateTime__Parser& operator=(____System__Xml__Schema__XsdDateTime__Parser const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Xml__Schema__XsdDateTime__Parser& operator=(____System__Xml__Schema__XsdDateTime__Parser&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__Xml__Schema__XsdDateTime__Parser(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
// Fields
 ...
 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode __declspec(property(get=__get_typeCode, put=__set_typeCode))  typeCode;

constexpr void __set_typeCode(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode value) ;

constexpr ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode __get_typeCode() const;
...
constexpr int32_t __get_fraction() const;
 ...
 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind __declspec(property(get=__get_kind, put=__set_kind))  kind;

constexpr void __set_kind(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind value) ;

constexpr ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind __get_kind() const;
...
public:
// Declarations
using Parser = ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__Parser;

using XsdDateTimeKind = ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind;

using DateTimeTypeCode = ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode;
...
// Properties
 ...
 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode __declspec(property(get=get_InternalTypeCode))  InternalTypeCode;

 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind __declspec(property(get=get_InternalKind))  InternalKind;
...
/// @brief Method .ctor addr 0x2753958 size 0x30 virtual false final false
 void _ctor(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__Parser parser) ;

/// @brief Method InitiateXsdDateTime addr 0x27538dc size 0x7c virtual false final false
 void InitiateXsdDateTime(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__Parser parser) ;
...
/// @brief Method get_InternalTypeCode addr 0x2753c74 size 0x8 virtual false final false
 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode get_InternalTypeCode() ;

/// @brief Method get_InternalKind addr 0x2753c7c size 0x8 virtual false final false
 ::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind get_InternalKind() ;
...
static ::System::DateTime op_Implicit___System__DateTime(::System::Xml::Schema::XsdDateTime xdt) ;

/// @brief Method op_Implicit addr 0x27541bc size 0x280 virtual false final false
static ::System::DateTimeOffset op_Implicit___System__DateTimeOffset(::System::Xml::Schema::XsdDateTime xdt) ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__DateTimeTypeCode, "System.Xml.Schema", "XsdDateTime/DateTimeTypeCode");
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__XsdDateTimeKind, "System.Xml.Schema", "XsdDateTime/XsdDateTimeKind");
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::XsdDateTime, "System.Xml.Schema", "XsdDateTime");
DEFINE_IL2CPP_ARG_TYPE(::System::Xml::Schema::____System__Xml__Schema__XsdDateTime__Parser, "System.Xml.Schema", "XsdDateTime/Parser");
