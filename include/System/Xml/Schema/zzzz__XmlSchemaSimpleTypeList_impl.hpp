...
// Ctor Parameters []
 ::System::Xml::Schema::XmlSchemaSimpleTypeList::XmlSchemaSimpleTypeList()  : ::System::Xml::Schema::XmlSchemaSimpleTypeContent(THROW_UNLESS(::il2cpp_utils::New<XmlSchemaSimpleTypeList>())) {}
