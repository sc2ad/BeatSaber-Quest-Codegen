...
namespace System::Xml {
  ...
  check_size<sizeof(HtmlEncodedRawTextWriterIndent), 248 + sizeof(bool) + ((248 + sizeof(bool)) % 8 != 0 ? (8 - (248 + sizeof(bool)) % 8) : 0)> __System_Xml_HtmlEncodedRawTextWriterIndentSizeCheck;
}
