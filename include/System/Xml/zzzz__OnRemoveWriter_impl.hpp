...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::OnRemoveWriter::*)(System::Xml::XmlRawWriter)>(&System::Xml::OnRemoveWriter::Invoke)> {
 ...
 System::Xml::OnRemoveWriter System::Xml::OnRemoveWriter::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
System::Xml::OnRemoveWriter o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::OnRemoveWriter>(object, method))};
return o;
}
