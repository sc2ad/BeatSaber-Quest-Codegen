...
return ::cordl_internals::getInstanceField<System::Uri, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 System::Xml::XmlCachedStream System::Xml::XmlCachedStream::New_ctor(System::Uri uri, System::IO::Stream stream)  {
System::Xml::XmlCachedStream o{THROW_UNLESS(::il2cpp_utils::New<System::Xml::XmlCachedStream>(uri, stream))};
return o;
}
