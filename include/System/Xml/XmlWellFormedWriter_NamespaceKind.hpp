...
namespace System::Xml {
  ...
  check_size<sizeof(XmlWellFormedWriter::NamespaceKind), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Xml_XmlWellFormedWriter_NamespaceKindSizeCheck;
}
