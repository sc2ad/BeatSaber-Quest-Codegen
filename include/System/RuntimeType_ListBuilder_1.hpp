...
namespace System {
  ...
  // [DefaultMemberAttribute] Offset: D68348
  template<typename T>
  struct RuntimeType::ListBuilder_1/*, public System::ValueType*/ {
    ...
    ::Array<T>* _get__items() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_get__items");
    ...
    void _set__items(::Array<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_set__items");
      static auto ___internal__instance = *this;
    ...
    T _get__item() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_get__item");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<T>(___internal__instance, "_item"));
    }
    // Autogenerated instance field setter
    // Set instance field: private T _item
    void _set__item(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_set__item");
      static auto ___internal__instance = *this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_item", value));
    }
    // Autogenerated instance field getter
    // Get instance field: private System.Int32 _count
    int _get__count() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_get__count");
      static auto ___internal__instance = *this;
    ...
    void _set__count(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_set__count");
      static auto ___internal__instance = *this;
    ...
    int _get__capacity() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_get__capacity");
      static auto ___internal__instance = *this;
    ...
    void _set__capacity(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::RuntimeType::ListBuilder_1::_set__capacity");
      static auto ___internal__instance = *this;
