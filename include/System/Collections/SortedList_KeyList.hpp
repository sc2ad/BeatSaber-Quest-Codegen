...
namespace System::Collections {
  ...
  class SortedList::KeyList : public ::Il2CppObject, public System::Collections::IList, public System::Collections::ICollection, public System::Collections::IEnumerable {
    public:
