...
namespace System::Collections {
  ...
  class SortedList::KeyList : public ::CsObject, public System::Collections::IList, public System::Collections::ICollection, public System::Collections::IEnumerable {
    public:
    ...
    int Add(::CsObject* key);
    // Creating proxy method: System_Collections_IList_Add
    // Maps to method: Add
    int System_Collections_IList_Add(::CsObject* key);
    ...
    bool System_Collections_IList_Contains(::CsObject* key);
    ...
    void System_Collections_IList_Remove(::CsObject* key);
