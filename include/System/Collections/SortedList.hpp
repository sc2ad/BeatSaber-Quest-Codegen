...
namespace System::Collections {
  ...
  // [DefaultMemberAttribute] Offset: 11AE1B4
  // [DebuggerDisplayAttribute] Offset: 11AE1B4
  // [ComVisibleAttribute] Offset: 11AE1B4
  // [DebuggerTypeProxyAttribute] Offset: 11AE1B4
