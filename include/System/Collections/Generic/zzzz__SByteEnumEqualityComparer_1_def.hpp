...
template<typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3859), inst: 1590 }), TypeDefinitionIndex(TypeDefinitionIndex(3859))}
...
static System::Collections::Generic::SByteEnumEqualityComparer_1 New_ctor() ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor() ;

static System::Collections::Generic::SByteEnumEqualityComparer_1 New_ctor(System::Runtime::Serialization::SerializationInfo information, System::Runtime::Serialization::StreamingContext context) ;
