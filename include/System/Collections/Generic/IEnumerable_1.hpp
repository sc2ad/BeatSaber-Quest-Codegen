...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [TypeDependencyAttribute] Offset: C990D4
  template<typename T>
  class IEnumerable_1/*, public System::Collections::IEnumerable*/ {
    ...
    System::Collections::Generic::IEnumerator_1<T>* GetEnumerator_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IEnumerable_1::GetEnumerator_NEW");
