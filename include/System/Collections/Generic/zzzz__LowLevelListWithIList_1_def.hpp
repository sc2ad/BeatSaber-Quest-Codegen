...
namespace System::Collections::Generic {
template<typename T>
struct ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator;
}
namespace System::Collections::Generic {
template<::cordl_internals::il2cpp_reference_type T>
struct ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator<T>;
}
// Type: ::Enumerator
...
struct CORDL_TYPE ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator<T> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator(::System::Collections::Generic::LowLevelListWithIList_1<T> _list, int32_t _index, int32_t _version, T _current) noexcept;


                    constexpr ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator(____System__Collections__Generic__LowLevelListWithIList_1__Enumerator const&) = default;
                    constexpr ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator(____System__Collections__Generic__LowLevelListWithIList_1__Enumerator&&) = default;
                    constexpr ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator& operator=(____System__Collections__Generic__LowLevelListWithIList_1__Enumerator const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator& operator=(____System__Collections__Generic__LowLevelListWithIList_1__Enumerator&& o) noexcept {
...
constexpr explicit ____System__Collections__Generic__LowLevelListWithIList_1__Enumerator(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3846)), TypeDefinitionIndex(TypeDefinitionIndex(3844)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3844), inst: 2548 })}
...
public:
// Declarations
using Enumerator = ::System::Collections::Generic::____System__Collections__Generic__LowLevelListWithIList_1__Enumerator<T>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::System::Collections::Generic::____System__Collections__Generic__LowLevelListWithIList_1__Enumerator, "System.Collections.Generic", "LowLevelListWithIList`1/Enumerator");
