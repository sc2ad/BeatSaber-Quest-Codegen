...
constexpr int32_t System::Collections::Generic::BitHelper::__get__length() const {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Collections::Generic::BitHelper::__set__arrayPtr(void* value)  {
::cordl_internals::setInstanceField<void*, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<void*>(value));
}
constexpr void* System::Collections::Generic::BitHelper::__get__arrayPtr() const {
return ::cordl_internals::getInstanceField<void*, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Collections::Generic::BitHelper::__set__array(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> System::Collections::Generic::BitHelper::__get__array() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, bitArray, length);
}
 void System::Collections::Generic::BitHelper::MarkBit(int32_t bitPosition)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Collections::Generic::BitHelper>::get(),
                            "MarkBit",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, bitPosition);
}
 bool System::Collections::Generic::BitHelper::IsMarked(int32_t bitPosition)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Collections::Generic::BitHelper>::get(),
                            "IsMarked",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, bitPosition);
}
 int32_t System::Collections::Generic::BitHelper::ToIntArrayLength(int32_t n)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Collections::Generic::BitHelper>::get(),
                            "ToIntArrayLength",
                            std::vector<Il2CppClass*>{},
