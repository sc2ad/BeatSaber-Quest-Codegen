...
namespace System::Collections::Generic {
  ...
  class EnumEqualityComparer_1 : public System::Collections::Generic::EqualityComparer_1<T>/*, public System::Runtime::Serialization::ISerializable*/ {
    ...
    static EnumEqualityComparer_1<T>* New_ctor(System::Runtime::Serialization::SerializationInfo* information, System::Runtime::Serialization::StreamingContext context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EnumEqualityComparer_1").WithContext(".ctor");
    ...
    bool Equals(T x, T y) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EnumEqualityComparer_1").WithContext("Equals");
    ...
    int GetHashCode(T obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EnumEqualityComparer_1").WithContext("GetHashCode");
    ...
    void GetObjectData(System::Runtime::Serialization::SerializationInfo* info, System::Runtime::Serialization::StreamingContext context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EnumEqualityComparer_1").WithContext("GetObjectData");
  ...
  // Could not write size check! Type: System.Collections.Generic.EnumEqualityComparer`1 is generic!
}
