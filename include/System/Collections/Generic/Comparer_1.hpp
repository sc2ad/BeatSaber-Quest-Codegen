...
namespace System::Collections::Generic {
  ...
  class Comparer_1 : public ::Il2CppObject/*, public System::Collections::IComparer, public System::Collections::Generic::IComparer_1<T>*/ {
    ...
    static System::Collections::Generic::Comparer_1<T>* _get_defaultComparer() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("_get_defaultComparer");
    ...
    static void _set_defaultComparer(System::Collections::Generic::Comparer_1<T>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("_set_defaultComparer");
    ...
    static System::Collections::Generic::Comparer_1<T>* get_Default() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("get_Default");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Comparer_1<T>*>::get(), il2cpp_utils::NoArgClass<System::Collections::Generic::Comparer_1<T>*>(), "get_Default", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    static System::Collections::Generic::Comparer_1<T>* CreateComparer() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("CreateComparer");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Comparer_1<T>*>::get(), il2cpp_utils::NoArgClass<System::Collections::Generic::Comparer_1<T>*>(), "CreateComparer", {}, ::il2cpp_utils::ExtractTypes())));
      return ::il2cpp_utils::RunMethodThrow<System::Collections::Generic::Comparer_1<T>*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
    }
    ...
    int Compare(T x, T y) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("Compare");
    ...
    int System_Collections_IComparer_Compare(::Il2CppObject* x, ::Il2CppObject* y) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext("System.Collections.IComparer.Compare");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "System.Collections.IComparer.Compare", {}, ::il2cpp_utils::ExtractTypes(x, y)));
      return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, x, y);
    }
    ...
    static Comparer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("Comparer_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<Comparer_1<T>*>());
    }
  }; // System.Collections.Generic.Comparer`1
  // Could not write size check! Type: System.Collections.Generic.Comparer`1 is generic!
}
