...
namespace System::Collections::Generic {
  ...
  class ArraySortHelper_2 : public ::Il2CppObject {
    ...
    static System::Collections::Generic::ArraySortHelper_2<TKey, TValue>* get_Default() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::ArraySortHelper_2<TKey, TValue>*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method)));
    }
    ...
    static int PickPivotAndPartition(::ArrayW<TKey> keys, ::ArrayW<TValue> values, int lo, int hi, System::Collections::Generic::IComparer_1<TKey>* comparer) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, values, lo, hi, comparer)));
    }
