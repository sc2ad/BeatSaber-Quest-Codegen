...
namespace System::Collections::Generic {
  ...
  // [DebuggerDisplayAttribute] Offset: EA3A10
  // [DebuggerTypeProxyAttribute] Offset: EA3A10
  // [DefaultMemberAttribute] Offset: EA3A10
  template<typename T>
  class List_1 : public ::Il2CppObject/*, public System::Collections::Generic::IList_1<T>, public System::Collections::Generic::IReadOnlyList_1<T>, public System::Collections::IList*/ {
    ...
    void AddRange(System::Collections::Generic::IEnumerable_1<T>* collection) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, collection)));
    }
    ...
    System::Collections::ObjectModel::ReadOnlyCollection_1<T>* AsReadOnly() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::ObjectModel::ReadOnlyCollection_1<T>*, false>(this, ___internal__method)));
    }
    ...
    int BinarySearch(int index, int count, T item, System::Collections::Generic::IComparer_1<T>* comparer) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(this, ___internal__method, index, count, item, comparer)));
    }
    ...
    System::Collections::Generic::List_1<TOutput>* ConvertAll(System::Converter_2<T, TOutput>* converter) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::List_1<TOutput>*, false>(this, ___generic__method, converter)));
    }
    ...
    void CopyTo(int index, ::ArrayW<T> array, int arrayIndex, int count) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, index, array, arrayIndex, count)));
    }
    ...
    void EnsureCapacity(int min) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, min)));
    }
    ...
    bool Exists(System::Predicate_1<T>* match) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<bool, false>(this, ___internal__method, match)));
    }
    ...
    T Find(System::Predicate_1<T>* match) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<T, false>(this, ___internal__method, match)));
    }
    ...
    int FindIndex(System::Predicate_1<T>* match) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(this, ___internal__method, match)));
    }
    ...
    int FindIndex(int startIndex, int count, System::Predicate_1<T>* match) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<int, false>(this, ___internal__method, startIndex, count, match)));
    }
    ...
    typename System::Collections::Generic::List_1<T>::Enumerator GetEnumerator() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<typename System::Collections::Generic::List_1<T>::Enumerator, false>(this, ___internal__method)));
    }
    ...
    System::Collections::Generic::List_1<T>* GetRange(int index, int count) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<System::Collections::Generic::List_1<T>*, false>(this, ___internal__method, index, count)));
    }
    ...
    void InsertRange(int index, System::Collections::Generic::IEnumerable_1<T>* collection) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, index, collection)));
    }
    ...
    void RemoveRange(int index, int count) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, index, count)));
    }
    ...
    void Sort(System::Collections::Generic::IComparer_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, comparer)));
    }
    ...
    void Sort(int index, int count, System::Collections::Generic::IComparer_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, index, count, comparer)));
    }
    ...
    void Sort(System::Comparison_1<T>* comparison) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, comparison)));
    }
    // public T[] ToArray()
    // Offset: 0xFFFFFFFF
    ::ArrayW<T> ToArray() {
