...
namespace System::Collections::Generic {
  ...
  check_size<sizeof(InsertionBehavior), 0 + sizeof(uint8_t) + ((0 + sizeof(uint8_t)) % 8 != 0 ? (8 - (0 + sizeof(uint8_t)) % 8) : 0)> __System_Collections_Generic_InsertionBehaviorSizeCheck;
}
