...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [TypeDependencyAttribute] Offset: C9916C
  template<typename T>
  class IReadOnlyCollection_1/*, public System::Collections::Generic::IEnumerable_1<T>*/ {
    ...
    // Offset: 0xFFFFFFFF
    int get_Count_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IReadOnlyCollection_1::get_Count_NEW");
