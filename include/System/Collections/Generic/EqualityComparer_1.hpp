...
namespace System::Collections::Generic {
  ...
  class EqualityComparer_1 : public ::Il2CppObject/*, public System::Collections::IEqualityComparer, public System::Collections::Generic::IEqualityComparer_1<T>*/ {
    ...
    static System::Collections::Generic::EqualityComparer_1<T>* _get_defaultComparer() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("_get_defaultComparer");
    ...
    static void _set_defaultComparer(System::Collections::Generic::EqualityComparer_1<T>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("_set_defaultComparer");
    ...
    static System::Collections::Generic::EqualityComparer_1<T>* get_Default() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("get_Default");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<EqualityComparer_1<T>*>::get(), il2cpp_utils::NoArgClass<System::Collections::Generic::EqualityComparer_1<T>*>(), "get_Default", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    static System::Collections::Generic::EqualityComparer_1<T>* CreateComparer() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("CreateComparer");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<EqualityComparer_1<T>*>::get(), il2cpp_utils::NoArgClass<System::Collections::Generic::EqualityComparer_1<T>*>(), "CreateComparer", {}, ::il2cpp_utils::ExtractTypes())));
      return ::il2cpp_utils::RunMethodThrow<System::Collections::Generic::EqualityComparer_1<T>*, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
    }
    ...
    int IndexOf(::Array<T>* array, T value, int startIndex, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("IndexOf");
    ...
    int LastIndexOf(::Array<T>* array, T value, int startIndex, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("LastIndexOf");
    ...
    bool Equals(T x, T y) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("Equals");
    ...
    int GetHashCode(T obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("GetHashCode");
    ...
    int System_Collections_IEqualityComparer_GetHashCode(::Il2CppObject* obj) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("System.Collections.IEqualityComparer.GetHashCode");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<int>(), "System.Collections.IEqualityComparer.GetHashCode", {}, ::il2cpp_utils::ExtractTypes(obj)));
      return ::il2cpp_utils::RunMethodThrow<int, false>(this, ___internal__method, obj);
    }
    ...
    bool System_Collections_IEqualityComparer_Equals(::Il2CppObject* x, ::Il2CppObject* y) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext("System.Collections.IEqualityComparer.Equals");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "System.Collections.IEqualityComparer.Equals", {}, ::il2cpp_utils::ExtractTypes(x, y)));
      return ::il2cpp_utils::RunMethodThrow<bool, false>(this, ___internal__method, x, y);
    }
    ...
    static EqualityComparer_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("EqualityComparer_1").WithContext(".ctor");
      return THROW_UNLESS(::il2cpp_utils::New<EqualityComparer_1<T>*>());
    }
  }; // System.Collections.Generic.EqualityComparer`1
  // Could not write size check! Type: System.Collections.Generic.EqualityComparer`1 is generic!
}
