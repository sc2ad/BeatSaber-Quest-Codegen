...
namespace System::Collections::Generic {
  ...
  class ObjectEqualityComparer : public ::Il2CppObject/*, public System::Collections::IEqualityComparer*/ {
    ...
    static ObjectEqualityComparer* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Generic").WithContext("ObjectEqualityComparer").WithContext(".ctor");
