...
namespace System::Collections::Generic {
  ...
  // [DebuggerDisplayAttribute] Offset: E6A014
  // [DebuggerTypeProxyAttribute] Offset: E6A014
  template<typename T>
  class Queue_1 : public ::Il2CppObject/*, public System::Collections::Generic::IReadOnlyCollection_1<T>, public System::Collections::ICollection*/ {
    ...
    Queue_1(::ArrayWrapper<T> array_ = {}, int head_ = {}, int tail_ = {}, int size_ = {}, int version_ = {}, ::Il2CppObject* syncRoot_ = {}) noexcept : array{array_}, head{head_}, tail{tail_}, size{size_}, version{version_}, syncRoot{syncRoot_} {}
