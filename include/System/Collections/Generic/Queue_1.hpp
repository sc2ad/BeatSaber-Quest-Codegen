...
namespace System::Collections::Generic {
  ...
  template<typename T>
  class Queue_1 : public ::CsObject, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::IEnumerable, public System::Collections::ICollection, public System::Collections::Generic::IReadOnlyCollection_1<T> {
    public:
