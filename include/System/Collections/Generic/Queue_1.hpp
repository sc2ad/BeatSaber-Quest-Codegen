...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [DebuggerDisplayAttribute] Offset: CA2064
  // [DebuggerTypeProxyAttribute] Offset: CA2064
  template<typename T>
  class Queue_1 : public ::Il2CppObject/*, public System::Collections::ICollection, public System::Collections::Generic::IReadOnlyCollection_1<T>*/ {
    ...
    System::Collections::Generic::IEnumerator_1<T>* System_Collections_Generic_IEnumerable$T$_GetEnumerator() {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "System.Collections.Generic.IEnumerable<T>.GetEnumerator", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
