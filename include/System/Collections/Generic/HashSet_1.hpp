...
namespace System::Collections::Generic {
  ...
  class HashSet_1 : public ::Il2CppObject/*, public System::Collections::Generic::ICollection_1<T>, public System::Collections::Generic::IReadOnlyCollection_1<T>, public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IDeserializationCallback*/ {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<typename System::Collections::Generic::HashSet_1<T>::Slot> slots;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<typename System::Collections::Generic::HashSet_1<T>::Slot>) == 0x8);
    ...
    ::ArrayWrapper<typename System::Collections::Generic::HashSet_1<T>::Slot>& dyn__slots() {
      ...
      return *reinterpret_cast<::ArrayWrapper<typename System::Collections::Generic::HashSet_1<T>::Slot>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
    ...
    // Offset: 0xFFFFFFFF
    void CopyTo(::ArrayWrapper<T> array) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::HashSet_1::CopyTo");
    ...
    // Offset: 0xFFFFFFFF
    void CopyTo(::ArrayWrapper<T> array, int arrayIndex, int count) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::HashSet_1::CopyTo");
