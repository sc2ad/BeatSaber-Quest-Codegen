...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: C9909C
  ...
  class IDictionary_2/*, public System::Collections::Generic::ICollection_1<System::Collections::Generic::KeyValuePair_2<TKey, TValue>>*/ {
    ...
    TValue get_Item_NEW(TKey key) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IDictionary_2::get_Item_NEW");
    ...
    bool ContainsKey_NEW(TKey key) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IDictionary_2::ContainsKey_NEW");
    ...
    void Add_NEW(TKey key, TValue value) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IDictionary_2::Add_NEW");
    ...
    bool Remove_NEW(TKey key) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IDictionary_2::Remove_NEW");
