...
namespace System::Collections::Generic {
  ...
  class ArraySortHelper_1 : public ::Il2CppObject {
    ...
    static void Sort(::ArrayW<T> keys, int index, int length, System::Collections::Generic::IComparer_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, index, length, comparer)));
    }
    ...
    static void SwapIfGreater(::ArrayW<T> keys, System::Comparison_1<T>* comparer, int a, int b) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, comparer, a, b)));
    }
    ...
    static void Swap(::ArrayW<T> a, int i, int j) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, a, i, j)));
    }
    ...
    static void IntrospectiveSort(::ArrayW<T> keys, int left, int length, System::Comparison_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, left, length, comparer)));
    }
    ...
    static void IntroSort(::ArrayW<T> keys, int lo, int hi, int depthLimit, System::Comparison_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, lo, hi, depthLimit, comparer)));
    }
    ...
    static void Heapsort(::ArrayW<T> keys, int lo, int hi, System::Comparison_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, lo, hi, comparer)));
    }
    ...
    static void DownHeap(::ArrayW<T> keys, int i, int n, int lo, System::Comparison_1<T>* comparer) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, keys, i, n, lo, comparer)));
    }
