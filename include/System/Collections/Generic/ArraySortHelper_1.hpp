...
namespace System::Collections::Generic {
  ...
  class ArraySortHelper_1 : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    static void Sort(::ArrayWrapper<T> keys, int index, int length, System::Comparison_1<T>* comparer) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::ArraySortHelper_1::Sort");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ArraySortHelper_1<T>*>::get(), "Sort", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(keys), ::il2cpp_utils::ExtractType(index), ::il2cpp_utils::ExtractType(length), ::il2cpp_utils::ExtractType(comparer)})));
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method, keys, index, length, comparer);
    }
    ...
    // Offset: 0xFFFFFFFF
    static int InternalBinarySearch(::ArrayWrapper<T> array, int index, int length, T value, System::Collections::Generic::IComparer_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static void SwapIfGreater(::ArrayWrapper<T> keys, System::Comparison_1<T>* comparer, int a, int b) {
    ...
    // Offset: 0xFFFFFFFF
    static void Swap(::ArrayWrapper<T> a, int i, int j) {
    ...
    // Offset: 0xFFFFFFFF
    static void IntrospectiveSort(::ArrayWrapper<T> keys, int left, int length, System::Comparison_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static void IntroSort(::ArrayWrapper<T> keys, int lo, int hi, int depthLimit, System::Comparison_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static int PickPivotAndPartition(::ArrayWrapper<T> keys, int lo, int hi, System::Comparison_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static void Heapsort(::ArrayWrapper<T> keys, int lo, int hi, System::Comparison_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static void DownHeap(::ArrayWrapper<T> keys, int i, int n, int lo, System::Comparison_1<T>* comparer) {
    ...
    // Offset: 0xFFFFFFFF
    static void InsertionSort(::ArrayWrapper<T> keys, int lo, int hi, System::Comparison_1<T>* comparer) {
