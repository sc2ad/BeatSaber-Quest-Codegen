...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [DefaultMemberAttribute] Offset: C991DC
  // [TypeDependencyAttribute] Offset: C991DC
  template<typename T>
  class IReadOnlyList_1/*, public System::Collections::Generic::IReadOnlyCollection_1<T>*/ {
    ...
    T get_Item_NEW(int index) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Collections::Generic::IReadOnlyList_1::get_Item_NEW");
