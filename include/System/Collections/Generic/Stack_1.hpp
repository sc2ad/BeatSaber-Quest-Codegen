...
namespace System::Collections::Generic {
  ...
  // [] Offset: FFFFFFFF
  // [DebuggerDisplayAttribute] Offset: CA20EC
  // [DebuggerTypeProxyAttribute] Offset: CA20EC
  template<typename T>
  class Stack_1 : public ::Il2CppObject/*, public System::Collections::ICollection, public System::Collections::Generic::IReadOnlyCollection_1<T>*/ {
    ...
    void System_Collections_ICollection_CopyTo(System::Array* array, int arrayIndex) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "System.Collections.ICollection.CopyTo", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(array, arrayIndex)));
