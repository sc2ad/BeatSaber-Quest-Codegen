...
namespace System::Collections::Generic {
  ...
  class Stack_1 : public ::Il2CppObject, public System::Collections::ICollection, public System::Collections::Generic::IReadOnlyCollection_1<T> {
    ...
    struct Enumerator : public System::ValueType, public System::Collections::Generic::IEnumerator_1<T>, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      constexpr Enumerator(System::Collections::Generic::Stack_1<T>* stack_ = {}, int version_ = {}, int index_ = {}, T currentElement_ = {}) : stack{stack_}, version{version_}, index{index_}, currentElement{currentElement_} {}
