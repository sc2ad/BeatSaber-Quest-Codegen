...
namespace System::Collections {
  ...
  // [DebuggerDisplayAttribute] Offset: 118C5DC
  // [DefaultMemberAttribute] Offset: 118C5DC
  // [ComVisibleAttribute] Offset: 118C5DC
  // [DebuggerTypeProxyAttribute] Offset: 118C5DC
