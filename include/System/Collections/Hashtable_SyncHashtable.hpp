...
namespace System::Collections {
  ...
  check_size<sizeof(Hashtable::SyncHashtable), 80 + sizeof(void*) + ((80 + sizeof(void*)) % 8 != 0 ? (8 - (80 + sizeof(void*)) % 8) : 0)> __System_Collections_Hashtable_SyncHashtableSizeCheck;
}
