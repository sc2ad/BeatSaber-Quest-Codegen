...
namespace System::Collections {
  ...
  class SortedList::SortedListEnumerator : public ::CsObject, public System::Collections::IDictionaryEnumerator, public System::Collections::IEnumerator, public System::ICloneable {
    public:
