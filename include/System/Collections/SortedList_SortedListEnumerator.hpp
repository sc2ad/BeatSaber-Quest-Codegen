...
namespace System::Collections {
  ...
  check_size<sizeof(SortedList::SortedListEnumerator), 60 + sizeof(int) + ((60 + sizeof(int)) % 8 != 0 ? (8 - (60 + sizeof(int)) % 8) : 0)> __System_Collections_SortedList_SortedListEnumeratorSizeCheck;
}
