...
namespace System::Collections::ObjectModel {
  ...
  // [DebuggerTypeProxyAttribute] Offset: 1072B0C
  // [DefaultMemberAttribute] Offset: 1072B0C
  // [DebuggerDisplayAttribute] Offset: 1072B0C
  // [ComVisibleAttribute] Offset: 1072B0C
  template<typename TKey, typename TItem>
