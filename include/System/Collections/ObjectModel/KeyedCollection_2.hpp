...
namespace System::Collections::ObjectModel {
  ...
  // [DebuggerTypeProxyAttribute] Offset: 105B8CC
  // [DefaultMemberAttribute] Offset: 105B8CC
  // [DebuggerDisplayAttribute] Offset: 105B8CC
  // [ComVisibleAttribute] Offset: 105B8CC
  template<typename TKey, typename TItem>
