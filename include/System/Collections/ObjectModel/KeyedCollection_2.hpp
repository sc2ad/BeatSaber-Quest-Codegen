...
namespace System::Collections::ObjectModel {
  ...
  // [DebuggerTypeProxyAttribute] Offset: 107BFAC
  // [DefaultMemberAttribute] Offset: 107BFAC
  // [DebuggerDisplayAttribute] Offset: 107BFAC
  // [ComVisibleAttribute] Offset: 107BFAC
  template<typename TKey, typename TItem>
