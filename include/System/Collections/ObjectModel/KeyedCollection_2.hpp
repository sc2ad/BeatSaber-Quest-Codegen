...
namespace System::Collections::ObjectModel {
  ...
  // [DebuggerTypeProxyAttribute] Offset: 1072A0C
  // [DefaultMemberAttribute] Offset: 1072A0C
  // [DebuggerDisplayAttribute] Offset: 1072A0C
  // [ComVisibleAttribute] Offset: 1072A0C
  template<typename TKey, typename TItem>
