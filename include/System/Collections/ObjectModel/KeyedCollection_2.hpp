...
namespace System::Collections::ObjectModel {
  ...
  // [DebuggerTypeProxyAttribute] Offset: 11AE478
  // [DefaultMemberAttribute] Offset: 11AE478
  // [DebuggerDisplayAttribute] Offset: 11AE478
  // [ComVisibleAttribute] Offset: 11AE478
  template<typename TKey, typename TItem>
