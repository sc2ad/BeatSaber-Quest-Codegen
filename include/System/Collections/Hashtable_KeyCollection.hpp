...
namespace System::Collections {
  ...
  check_size<sizeof(Hashtable::KeyCollection), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __System_Collections_Hashtable_KeyCollectionSizeCheck;
}
