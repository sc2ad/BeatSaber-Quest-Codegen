...
static System::Collections::System__Collections__Hashtable__KeyCollection New_ctor(System::Collections::Hashtable hashtable) ;
...
static System::Collections::System__Collections__Hashtable__ValueCollection New_ctor(System::Collections::Hashtable hashtable) ;
...
static System::Collections::System__Collections__Hashtable__HashtableEnumerator New_ctor(System::Collections::Hashtable hashtable, int32_t getObjRetType) ;
...
static System::Collections::Hashtable New_ctor(bool trash) ;

/// @brief Method .ctor addr 0x2419e94 size 0x8 virtual false final false
 void _ctor(bool trash) ;

static System::Collections::Hashtable New_ctor() ;

/// @brief Method .ctor addr 0x2419e9c size 0xc virtual false final false
 void _ctor() ;

static System::Collections::Hashtable New_ctor(int32_t capacity) ;

/// @brief Method .ctor addr 0x241a154 size 0x8 virtual false final false
 void _ctor(int32_t capacity) ;

static System::Collections::Hashtable New_ctor(int32_t capacity, float_t loadFactor) ;

/// @brief Method .ctor addr 0x2419ea8 size 0x2ac virtual false final false
 void _ctor(int32_t capacity, float_t loadFactor) ;

static System::Collections::Hashtable New_ctor(int32_t capacity, float_t loadFactor, System::Collections::IEqualityComparer equalityComparer) ;
...
static System::Collections::Hashtable New_ctor(System::Collections::IEqualityComparer equalityComparer) ;
...
static System::Collections::Hashtable New_ctor(int32_t capacity, System::Collections::IEqualityComparer equalityComparer) ;
...
static System::Collections::Hashtable New_ctor(System::Collections::IDictionary d) ;

/// @brief Method .ctor addr 0x241a1d4 size 0xc virtual false final false
 void _ctor(System::Collections::IDictionary d) ;

static System::Collections::Hashtable New_ctor(System::Collections::IDictionary d, float_t loadFactor) ;
...
static System::Collections::Hashtable New_ctor(System::Collections::IDictionary d, float_t loadFactor, System::Collections::IEqualityComparer equalityComparer) ;
...
static System::Collections::Hashtable New_ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;
