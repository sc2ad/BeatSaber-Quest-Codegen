...
namespace System::Collections::Concurrent {
  ...
  class CDSCollectionETWBCLProvider : public System::Diagnostics::Tracing::EventSource {
    ...
    static CDSCollectionETWBCLProvider* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Collections::Concurrent").WithContext("CDSCollectionETWBCLProvider").WithContext(".ctor");
