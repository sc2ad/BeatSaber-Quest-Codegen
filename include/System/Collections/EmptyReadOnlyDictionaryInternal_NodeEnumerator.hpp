...
namespace System::Collections {
  ...
  class EmptyReadOnlyDictionaryInternal::NodeEnumerator : public ::CsObject, public System::Collections::IDictionaryEnumerator, public System::Collections::IEnumerator {
    public:
