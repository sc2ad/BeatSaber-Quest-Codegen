...
constexpr void System::Collections::SortedList::__set_keyList(System::Collections::System__Collections__SortedList__KeyList value)  {
::cordl_internals::setInstanceField<System::Collections::System__Collections__SortedList__KeyList, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::System__Collections__SortedList__KeyList>(value));
}
constexpr System::Collections::System__Collections__SortedList__KeyList System::Collections::SortedList::__get_keyList() const {
return ::cordl_internals::getInstanceField<System::Collections::System__Collections__SortedList__KeyList, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Collections::SortedList::__set_valueList(System::Collections::System__Collections__SortedList__ValueList value)  {
::cordl_internals::setInstanceField<System::Collections::System__Collections__SortedList__ValueList, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Collections::System__Collections__SortedList__ValueList>(value));
}
constexpr System::Collections::System__Collections__SortedList__ValueList System::Collections::SortedList::__get_valueList() const {
return ::cordl_internals::getInstanceField<System::Collections::System__Collections__SortedList__ValueList, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
