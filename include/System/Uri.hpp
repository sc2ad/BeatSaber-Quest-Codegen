...
namespace System {
  ...
  class Uri : public ::CsObject, public System::Runtime::Serialization::ISerializable {
    public:
    ...
    static ::CsObject* _get_s_initLock();
    // Set static field: static private System.Object s_initLock
    static void _set_s_initLock(::CsObject* value);
