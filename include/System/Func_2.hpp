...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [TypeForwardedFromAttribute] Offset: C9297C
  ...
  class Func_2 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    TResult Invoke_NEW(T arg) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_2::Invoke_NEW");
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke_NEW(T arg, System::AsyncCallback* callback, ::Il2CppObject* object) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_2::BeginInvoke_NEW");
    ...
    TResult EndInvoke_NEW(System::IAsyncResult* result) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_2::EndInvoke_NEW");
