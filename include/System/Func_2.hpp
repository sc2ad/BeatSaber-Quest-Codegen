...
namespace System {
  ...
  class Func_2 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    static Func_2<T, TResult>* New_ctor(::CsObject* object, System::IntPtr method) {
      return (Func_2<T, TResult>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Func_2<T, TResult>*>::get(), object, method)));
    }
    ...
    // Offset: 0xFFFFFFFF
    System::IAsyncResult* BeginInvoke(T arg, System::AsyncCallback* callback, ::CsObject* object) {
