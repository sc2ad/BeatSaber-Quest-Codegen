...
namespace System {
struct ____System__RuntimeType__MemberListType;
}
namespace System {
class RuntimeType;
}
namespace System {
template<typename T>
struct ____System__RuntimeType__ListBuilder_1;
}
namespace System {
template<::cordl_internals::il2cpp_reference_type T>
struct ____System__RuntimeType__ListBuilder_1<T>;
}
// Type: ::MemberListType
namespace System {
// Is value type: true
...
struct CORDL_TYPE ____System__RuntimeType__MemberListType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____System__RuntimeType__MemberListType(int32_t value__) noexcept;


                    constexpr ____System__RuntimeType__MemberListType(____System__RuntimeType__MemberListType const&) = default;
                    constexpr ____System__RuntimeType__MemberListType(____System__RuntimeType__MemberListType&&) = default;
                    constexpr ____System__RuntimeType__MemberListType& operator=(____System__RuntimeType__MemberListType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__RuntimeType__MemberListType& operator=(____System__RuntimeType__MemberListType&& o) noexcept {
...
constexpr explicit ____System__RuntimeType__MemberListType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______System__RuntimeType__MemberListType_Unwrapped : int32_t {
__All = 0,
__CaseSensitive = 1,
__CaseInsensitive = 2,
__HandleToInfo = 3,
...
constexpr operator ______System__RuntimeType__MemberListType_Unwrapped () const noexcept {
return std::bit_cast<______System__RuntimeType__MemberListType_Unwrapped>(__instance);
}
...
static ::System::____System__RuntimeType__MemberListType const All;

/// @brief Field CaseSensitive offset 0
static ::System::____System__RuntimeType__MemberListType const CaseSensitive;

/// @brief Field CaseInsensitive offset 0
static ::System::____System__RuntimeType__MemberListType const CaseInsensitive;

/// @brief Field HandleToInfo offset 0
static ::System::____System__RuntimeType__MemberListType const HandleToInfo;
...
// Declarations
template<typename T>
using ListBuilder_1 = ::System::____System__RuntimeType__ListBuilder_1<T>;

using MemberListType = ::System::____System__RuntimeType__MemberListType;
...
static void FilterHelper(::System::Reflection::BindingFlags bindingFlags, ByRef<::StringW> name, bool allowPrefixLookup, ByRef<bool> prefixLookup, ByRef<bool> ignoreCase, ByRef<::System::____System__RuntimeType__MemberListType> listType) ;

/// @brief Method FilterHelper addr 0x247a1ac size 0x8c virtual false final false
static void FilterHelper(::System::Reflection::BindingFlags bindingFlags, ByRef<::StringW> name, ByRef<bool> ignoreCase, ByRef<::System::____System__RuntimeType__MemberListType> listType) ;
...
/// @brief Method GetMethodCandidates addr 0x247a93c size 0x258 virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::MethodInfo> GetMethodCandidates(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::Reflection::CallingConventions callConv, ::ArrayW<::System::Type> types, int32_t genericParamCount, bool allowPrefixLookup) ;

/// @brief Method GetConstructorCandidates addr 0x247ae80 size 0x27c virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::ConstructorInfo> GetConstructorCandidates(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::Reflection::CallingConventions callConv, ::ArrayW<::System::Type> types, bool allowPrefixLookup) ;

/// @brief Method GetPropertyCandidates addr 0x247b334 size 0x20c virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::PropertyInfo> GetPropertyCandidates(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::ArrayW<::System::Type> types, bool allowPrefixLookup) ;

/// @brief Method GetEventCandidates addr 0x247b82c size 0x1d0 virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::EventInfo> GetEventCandidates(::StringW name, ::System::Reflection::BindingFlags bindingAttr, bool allowPrefixLookup) ;

/// @brief Method GetFieldCandidates addr 0x247bca8 size 0x1d4 virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::FieldInfo> GetFieldCandidates(::StringW name, ::System::Reflection::BindingFlags bindingAttr, bool allowPrefixLookup) ;

/// @brief Method GetNestedTypeCandidates addr 0x247c168 size 0x1bc virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Type> GetNestedTypeCandidates(::StringW fullname, ::System::Reflection::BindingFlags bindingAttr, bool allowPrefixLookup) ;
...
/// @brief Method GetMethodsByName_native addr 0x2482704 size 0x4 virtual false final false
 ::cordl_internals::intptr_t GetMethodsByName_native(::cordl_internals::intptr_t namePtr, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType) ;

/// @brief Method GetMethodsByName addr 0x247ab94 size 0x2ec virtual false final false
 ::ArrayW<::System::Reflection::RuntimeMethodInfo> GetMethodsByName(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType, ::System::RuntimeType reflectedType) ;

/// @brief Method GetPropertiesByName_native addr 0x2482708 size 0x4 virtual false final false
 ::cordl_internals::intptr_t GetPropertiesByName_native(::cordl_internals::intptr_t name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType) ;
...
/// @brief Method GetPropertiesByName addr 0x247b540 size 0x2ec virtual false final false
 ::ArrayW<::System::Reflection::RuntimePropertyInfo> GetPropertiesByName(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType, ::System::RuntimeType reflectedType) ;
...
/// @brief Method GetEvents_native addr 0x2482884 size 0x4 virtual false final false
 ::cordl_internals::intptr_t GetEvents_native(::cordl_internals::intptr_t name, ::System::____System__RuntimeType__MemberListType listType) ;

/// @brief Method GetFields_native addr 0x2482888 size 0x4 virtual false final false
 ::cordl_internals::intptr_t GetFields_native(::cordl_internals::intptr_t name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType) ;

/// @brief Method GetFields_internal addr 0x247be7c size 0x2ec virtual false final false
 ::ArrayW<::System::Reflection::RuntimeFieldInfo> GetFields_internal(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType, ::System::RuntimeType reflectedType) ;

/// @brief Method GetEvents_internal addr 0x247b9fc size 0x2ac virtual false final false
 ::ArrayW<::System::Reflection::RuntimeEventInfo> GetEvents_internal(::StringW name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType, ::System::RuntimeType reflectedType) ;
...
/// @brief Method GetNestedTypes_native addr 0x2482890 size 0x4 virtual false final false
 ::cordl_internals::intptr_t GetNestedTypes_native(::cordl_internals::intptr_t name, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType) ;

/// @brief Method GetNestedTypes_internal addr 0x247c324 size 0x390 virtual false final false
 ::ArrayW<::System::RuntimeType> GetNestedTypes_internal(::StringW displayName, ::System::Reflection::BindingFlags bindingAttr, ::System::____System__RuntimeType__MemberListType listType) ;
...
/// @brief Method GetMethodCandidates addr 0x2482e78 size 0x20c virtual false final false
 ::System::____System__RuntimeType__ListBuilder_1<::System::Reflection::MethodInfo> GetMethodCandidates(::StringW name, int32_t genericParameterCount, ::System::Reflection::BindingFlags bindingAttr, ::System::Reflection::CallingConventions callConv, ::ArrayW<::System::Type> types, bool allowPrefixLookup) ;
...
struct CORDL_TYPE ____System__RuntimeType__ListBuilder_1<T> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____System__RuntimeType__ListBuilder_1(::ArrayW<T> _items, T _item, int32_t _count, int32_t _capacity) noexcept;


                    constexpr ____System__RuntimeType__ListBuilder_1(____System__RuntimeType__ListBuilder_1 const&) = default;
                    constexpr ____System__RuntimeType__ListBuilder_1(____System__RuntimeType__ListBuilder_1&&) = default;
                    constexpr ____System__RuntimeType__ListBuilder_1& operator=(____System__RuntimeType__ListBuilder_1 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__RuntimeType__ListBuilder_1& operator=(____System__RuntimeType__ListBuilder_1&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____System__RuntimeType__ListBuilder_1(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
DEFINE_IL2CPP_ARG_TYPE(::System::____System__RuntimeType__MemberListType, "System", "RuntimeType/MemberListType");
NEED_NO_BOX(::System::RuntimeType);
DEFINE_IL2CPP_ARG_TYPE(::System::RuntimeType, "System", "RuntimeType");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::System::____System__RuntimeType__ListBuilder_1, "System", "RuntimeType/ListBuilder`1");
