...
namespace System {
  ...
  // [] Offset: FFFFFFFF
  // [TypeForwardedFromAttribute] Offset: C92944
  ...
  class Func_1 : public System::MulticastDelegate {
    ...
    // Offset: 0xFFFFFFFF
    TResult Invoke_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_1::Invoke_NEW");
    ...
    System::IAsyncResult* BeginInvoke_NEW(System::AsyncCallback* callback, ::Il2CppObject* object) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_1::BeginInvoke_NEW");
    ...
    TResult EndInvoke_NEW(System::IAsyncResult* result) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Func_1::EndInvoke_NEW");
