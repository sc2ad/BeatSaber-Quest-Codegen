...
namespace System {
  ...
  check_size<sizeof(TimeZoneInfo::AdjustmentRule), 88 + sizeof(System::TimeSpan) + ((88 + sizeof(System::TimeSpan)) % 8 != 0 ? (8 - (88 + sizeof(System::TimeSpan)) % 8) : 0)> __System_TimeZoneInfo_AdjustmentRuleSizeCheck;
}
