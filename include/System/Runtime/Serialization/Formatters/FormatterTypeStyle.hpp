...
namespace System::Runtime::Serialization::Formatters {
  ...
  check_size<sizeof(FormatterTypeStyle), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_Formatters_FormatterTypeStyleSizeCheck;
}
