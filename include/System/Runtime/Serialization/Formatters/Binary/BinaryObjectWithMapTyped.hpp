...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(BinaryObjectWithMapTyped), 72 + sizeof(int) + ((72 + sizeof(int)) % 8 != 0 ? (8 - (72 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_BinaryObjectWithMapTypedSizeCheck;
}
