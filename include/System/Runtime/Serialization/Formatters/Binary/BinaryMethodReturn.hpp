...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class BinaryMethodReturn : public ::Il2CppObject {
    ...
    static BinaryMethodReturn* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("BinaryMethodReturn").WithContext(".ctor");
