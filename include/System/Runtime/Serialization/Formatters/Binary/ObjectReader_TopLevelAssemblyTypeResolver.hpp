...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class ObjectReader::TopLevelAssemblyTypeResolver : public ::CsObject {
    public:
    ...
    // Offset: 0xFE51C8
    System::Type* ResolveType(System::Reflection::Assembly* assembly, ::CsString* simpleTypeName, bool ignoreCase);
