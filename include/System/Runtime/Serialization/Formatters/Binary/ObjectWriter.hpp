...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(ObjectWriter), 184 + sizeof(void*) + ((184 + sizeof(void*)) % 8 != 0 ? (8 - (184 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_ObjectWriterSizeCheck;
}
