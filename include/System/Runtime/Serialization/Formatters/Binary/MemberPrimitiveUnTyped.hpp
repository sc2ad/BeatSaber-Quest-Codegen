...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(MemberPrimitiveUnTyped), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_MemberPrimitiveUnTypedSizeCheck;
}
