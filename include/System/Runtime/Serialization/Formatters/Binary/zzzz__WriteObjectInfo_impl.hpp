...
// Ctor Parameters []
 System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo::WriteObjectInfo()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<WriteObjectInfo>())) {}
