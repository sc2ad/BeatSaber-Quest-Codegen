...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(BinaryCrossAppDomainMap), 16 + sizeof(int) + 8 - (16 + sizeof(int)) % 8> __System_Runtime_Serialization_Formatters_Binary_BinaryCrossAppDomainMapSizeCheck;
}
