...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(WriteObjectInfo), 128 + sizeof(void*) + ((128 + sizeof(void*)) % 8 != 0 ? (8 - (128 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_WriteObjectInfoSizeCheck;
}
