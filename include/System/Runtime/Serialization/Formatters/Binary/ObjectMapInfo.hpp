...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class ObjectMapInfo : public ::CsObject {
    public:
    ...
    // Offset: 0xE26604
    static ObjectMapInfo* New_ctor(int objectId, int numMembers, ::Array<::CsString*>* memberNames, ::Array<System::Type*>* memberTypes);
    // System.Boolean isCompatible(System.Int32 numMembers, System.String[] memberNames, System.Type[] memberTypes)
    // Offset: 0xE26668
    bool isCompatible(int numMembers, ::Array<::CsString*>* memberNames, ::Array<System::Type*>* memberTypes);
