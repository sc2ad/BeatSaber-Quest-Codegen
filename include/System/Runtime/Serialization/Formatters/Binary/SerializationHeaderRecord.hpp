...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(SerializationHeaderRecord), 40 + sizeof(int) + ((40 + sizeof(int)) % 8 != 0 ? (8 - (40 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_SerializationHeaderRecordSizeCheck;
}
