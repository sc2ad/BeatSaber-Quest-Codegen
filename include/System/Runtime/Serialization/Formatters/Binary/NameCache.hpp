...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class NameCache : public ::Il2CppObject {
    ...
    static NameCache* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("NameCache").WithContext(".ctor");
