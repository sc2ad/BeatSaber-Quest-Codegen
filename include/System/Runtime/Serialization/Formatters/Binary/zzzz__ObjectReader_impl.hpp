...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TypeNAssembly::*)()>(&System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TypeNAssembly::_ctor)> {
...
constexpr void System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TypeNAssembly::__set_type(System::Type value)  {
::cordl_internals::setInstanceField<System::Type, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Type>(value));
}
constexpr System::Type System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TypeNAssembly::__get_type() const {
return ::cordl_internals::getInstanceField<System::Type, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TypeNAssembly::__set_assemblyName(::StringW value)  {
...
//  Writing Method size for method: System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::*)(System::Reflection::Assembly)>(&System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::_ctor)> {
...
//  Writing Method size for method: System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver.ResolveType
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::*)(System::Reflection::Assembly, ::StringW, bool)>(&System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::ResolveType)> {
...
constexpr void System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::__set_m_topLevelAssembly(System::Reflection::Assembly value)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, topLevelAssembly);
 ...
 System::Type System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver::ResolveType(System::Reflection::Assembly assembly, ::StringW simpleTypeName, bool ignoreCase)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Serialization::Formatters::Binary::System__Runtime__Serialization__Formatters__Binary__ObjectReader__TopLevelAssemblyTypeResolver>::get(),
                            "ResolveType",
                            std::vector<Il2CppClass*>{},
