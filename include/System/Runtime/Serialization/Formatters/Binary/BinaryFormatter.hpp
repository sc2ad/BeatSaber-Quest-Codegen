...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96854
  class BinaryFormatter : public ::Il2CppObject {
    ...
    // Offset: 0x1459F50
    void set_SurrogateSelector_NEW(System::Runtime::Serialization::ISurrogateSelector* value);
    // public System.Void set_Binder(System.Runtime.Serialization.SerializationBinder value)
    // Offset: 0x1459F58
    void set_Binder_NEW(System::Runtime::Serialization::SerializationBinder* value);
    ...
    // Offset: 0x145A00C
    ::Il2CppObject* Deserialize_NEW(System::IO::Stream* serializationStream);
    ...
    // Offset: 0x145A018
    ::Il2CppObject* Deserialize_NEW(System::IO::Stream* serializationStream, System::Runtime::Remoting::Messaging::HeaderHandler* handler);
    // public System.Void Serialize(System.IO.Stream serializationStream, System.Object graph)
    // Offset: 0x145A794
    void Serialize_NEW(System::IO::Stream* serializationStream, ::Il2CppObject* graph);
    ...
    // Offset: 0x145A7A0
    void Serialize_NEW(System::IO::Stream* serializationStream, ::Il2CppObject* graph, ::Array<System::Runtime::Remoting::Messaging::Header*>* headers);
