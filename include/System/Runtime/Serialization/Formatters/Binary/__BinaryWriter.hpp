...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(__BinaryWriter), 168 + sizeof(void*) + ((168 + sizeof(void*)) % 8 != 0 ? (8 - (168 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary___BinaryWriterSizeCheck;
}
