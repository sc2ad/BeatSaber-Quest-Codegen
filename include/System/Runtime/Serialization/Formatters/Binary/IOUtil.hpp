...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class IOUtil : public ::CsObject {
    ...
    // Offset: 0xE0FED8
    static void WriteStringWithCode(::CsString* value, System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);
    ...
    // Offset: 0xE0FF44
    static void WriteWithCode(System::Type* type, ::CsObject* value, System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);
