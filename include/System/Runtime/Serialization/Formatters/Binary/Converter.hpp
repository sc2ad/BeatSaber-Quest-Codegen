...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class Converter : public ::CsObject {
    public:
    ...
    static ::Array<::CsString*>* _get_valueA();
    // Set static field: static private System.String[] valueA
    static void _set_valueA(::Array<::CsString*>* value);
    ...
    static ::CsString* _get_urtAssemblyString();
    // Set static field: static System.String urtAssemblyString
    static void _set_urtAssemblyString(::CsString* value);
    ...
    // Offset: 0xE0E0F0
    static bool IsPrimitiveArray(System::Type* type, ::CsObject*& typeInformation);
    ...
    // Offset: 0xE0EBD8
    static ::CsString* ToComType(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);
    ...
    // Offset: 0xE1207C
    static ::CsObject* FromString(::CsString* value, System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code);
