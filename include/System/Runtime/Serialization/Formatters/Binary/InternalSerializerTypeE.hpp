...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(InternalSerializerTypeE), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __System_Runtime_Serialization_Formatters_Binary_InternalSerializerTypeESizeCheck;
}
