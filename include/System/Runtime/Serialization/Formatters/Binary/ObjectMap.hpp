...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class ObjectMap : public ::CsObject {
    public:
    ...
    // Offset: 0xE25DDC
    static ObjectMap* New_ctor(::CsString* objectName, System::Type* objectType, ::Array<::CsString*>* memberNames, System::Runtime::Serialization::Formatters::Binary::ObjectReader* objectReader, int objectId, System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* assemblyInfo);
    ...
    // Offset: 0xE2642C
    System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo* CreateObjectInfo(System::Runtime::Serialization::SerializationInfo*& si, ::Array<::CsObject*>*& memberData);
    ...
    // Offset: 0xE264A0
    static System::Runtime::Serialization::Formatters::Binary::ObjectMap* Create(::CsString* name, System::Type* objectType, ::Array<::CsString*>* memberNames, System::Runtime::Serialization::Formatters::Binary::ObjectReader* objectReader, int objectId, System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo* assemblyInfo);
