...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(MemberReference), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_MemberReferenceSizeCheck;
}
