...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class BinaryObject : public ::Il2CppObject {
    ...
    static BinaryObject* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::Serialization::Formatters::Binary").WithContext("BinaryObject").WithContext(".ctor");
