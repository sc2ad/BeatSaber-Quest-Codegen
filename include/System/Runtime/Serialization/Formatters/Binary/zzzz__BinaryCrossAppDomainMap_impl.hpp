...
System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::Serialization::Formatters::Binary::BinaryCrossAppDomainMap>())};
return o;
}
