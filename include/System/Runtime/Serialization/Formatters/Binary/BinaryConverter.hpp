...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  class BinaryConverter : public ::CsObject {
    public:
    ...
    // Offset: 0xE20EB0
    static System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum GetParserBinaryTypeInfo(System::Type* type, ::CsObject*& typeInformation);
    ...
    // Offset: 0xE1FDDC
    static void WriteTypeInfo(System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum binaryTypeEnum, ::CsObject* typeInformation, int assemId, System::Runtime::Serialization::Formatters::Binary::__BinaryWriter* sout);
    ...
    // Offset: 0xE203C0
    static ::CsObject* ReadTypeInfo(System::Runtime::Serialization::Formatters::Binary::BinaryTypeEnum binaryTypeEnum, System::Runtime::Serialization::Formatters::Binary::__BinaryParser* input, int& assemId);
