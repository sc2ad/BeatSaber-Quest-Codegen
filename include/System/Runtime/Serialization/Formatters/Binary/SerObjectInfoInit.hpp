...
namespace System::Runtime::Serialization::Formatters::Binary {
  ...
  check_size<sizeof(SerObjectInfoInit), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_Formatters_Binary_SerObjectInfoInitSizeCheck;
}
