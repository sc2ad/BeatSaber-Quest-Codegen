...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Serialization::OnDeserializedAttribute::*)()>(&System::Runtime::Serialization::OnDeserializedAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2351cac;
...
System::Runtime::Serialization::OnDeserializedAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::Serialization::OnDeserializedAttribute>())};
return o;
}
