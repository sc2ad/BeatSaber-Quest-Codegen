...
namespace System::Runtime::Serialization {
  ...
  check_size<sizeof(MemberHolder), 24 + sizeof(System::Runtime::Serialization::StreamingContext) + ((24 + sizeof(System::Runtime::Serialization::StreamingContext)) % 8 != 0 ? (8 - (24 + sizeof(System::Runtime::Serialization::StreamingContext)) % 8) : 0)> __System_Runtime_Serialization_MemberHolderSizeCheck;
}
