...
namespace System::Runtime::Serialization {
  ...
  check_size<sizeof(StreamingContext), 8 + sizeof(System::Runtime::Serialization::StreamingContextStates) + ((8 + sizeof(System::Runtime::Serialization::StreamingContextStates)) % 8 != 0 ? (8 - (8 + sizeof(System::Runtime::Serialization::StreamingContextStates)) % 8) : 0)> __System_Runtime_Serialization_StreamingContextSizeCheck;
}
