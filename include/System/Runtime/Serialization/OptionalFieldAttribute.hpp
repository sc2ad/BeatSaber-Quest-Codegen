...
namespace System::Runtime::Serialization {
  ...
  check_size<sizeof(OptionalFieldAttribute), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_OptionalFieldAttributeSizeCheck;
}
