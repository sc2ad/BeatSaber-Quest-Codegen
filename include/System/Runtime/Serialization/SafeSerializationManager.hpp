...
namespace System::Runtime::Serialization {
  ...
  class SafeSerializationManager : public System::Runtime::Serialization::IObjectReference, public System::Runtime::Serialization::ISerializable, public ::Il2CppObject {
    public:
