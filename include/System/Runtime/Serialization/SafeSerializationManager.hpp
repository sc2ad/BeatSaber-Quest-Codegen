...
namespace System::Runtime::Serialization {
  ...
  check_size<sizeof(SafeSerializationManager), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __System_Runtime_Serialization_SafeSerializationManagerSizeCheck;
}
