...
namespace System::Runtime::Serialization {
  ...
  class SafeSerializationManager : public ::CsObject, public System::Runtime::Serialization::IObjectReference, public System::Runtime::Serialization::ISerializable {
    public:
    // private System.Collections.Generic.IList`1<System.Object> m_serializedStates
    // Offset: 0x10
    System::Collections::Generic::IList_1<::CsObject*>* m_serializedStates;
    ...
    static ::CsString* _get_RealTypeSerializationName();
    // Set static field: static private System.String RealTypeSerializationName
    static void _set_RealTypeSerializationName(::CsString* value);
    ...
    // Offset: 0xFF8EB4
    void CompleteSerialization(::CsObject* serializedObject, System::Runtime::Serialization::SerializationInfo* info, System::Runtime::Serialization::StreamingContext context);
    // System.Void CompleteDeserialization(System.Object deserializedObject)
    // Offset: 0xFF9278
    void CompleteDeserialization(::CsObject* deserializedObject);
