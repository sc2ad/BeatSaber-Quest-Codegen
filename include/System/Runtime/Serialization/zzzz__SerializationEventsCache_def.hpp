...
class CORDL_TYPE System__Runtime__Serialization__SerializationEventsCache____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~System__Runtime__Serialization__SerializationEventsCache____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Runtime__Serialization__SerializationEventsCache____c", modifiers: " const&", def_value: None }]
constexpr System__Runtime__Serialization__SerializationEventsCache____c(System__Runtime__Serialization__SerializationEventsCache____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Runtime__Serialization__SerializationEventsCache____c", modifiers: "&&", def_value: None }]
constexpr System__Runtime__Serialization__SerializationEventsCache____c(System__Runtime__Serialization__SerializationEventsCache____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Runtime__Serialization__SerializationEventsCache____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Runtime__Serialization__SerializationEventsCache____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Runtime__Serialization__SerializationEventsCache____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Runtime__Serialization__SerializationEventsCache____c& operator=(System__Runtime__Serialization__SerializationEventsCache____c&& o) noexcept = default;
  constexpr System__Runtime__Serialization__SerializationEventsCache____c& operator=(System__Runtime__Serialization__SerializationEventsCache____c const& o) noexcept = default;
                


// Fields

static System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c value) ;

static System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c __get___9() ;
...
public:
// Declarations
using __c = System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c;
...
NEED_NO_BOX(System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c);
DEFINE_IL2CPP_ARG_TYPE(System::Runtime::Serialization::System__Runtime__Serialization__SerializationEventsCache____c, "System.Runtime.Serialization", "SerializationEventsCache/<>c");
