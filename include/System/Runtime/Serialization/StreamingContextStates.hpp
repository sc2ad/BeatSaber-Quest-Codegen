...
namespace System::Runtime::Serialization {
  ...
  check_size<sizeof(StreamingContextStates), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Runtime_Serialization_StreamingContextStatesSizeCheck;
}
