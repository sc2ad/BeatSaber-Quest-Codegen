...
namespace System::Runtime::Serialization {
  ...
  class FormatterServices : public ::CsObject {
    public:
    ...
    // Offset: 0xE0BCEC
    static ::CsObject* GetUninitializedObject(System::Type* type);
    // static private System.Object nativeGetUninitializedObject(System.RuntimeType type)
    // Offset: 0xE0BEA8
    static ::CsObject* nativeGetUninitializedObject(System::RuntimeType* type);
    ...
    // Offset: 0xE0BF80
    static void SerializationSetValue(System::Reflection::MemberInfo* fi, ::CsObject* target, ::CsObject* value);
    ...
    // Offset: 0xE0C158
    static ::CsObject* PopulateObjectMembers(::CsObject* obj, ::Array<System::Reflection::MemberInfo*>* members, ::Array<::CsObject*>* data);
    // static public System.Object[] GetObjectData(System.Object obj, System.Reflection.MemberInfo[] members)
    // Offset: 0xE0C454
    static ::Array<::CsObject*>* GetObjectData(::CsObject* obj, ::Array<System::Reflection::MemberInfo*>* members);
    // static public System.Type GetTypeFromAssembly(System.Reflection.Assembly assem, System.String name)
    // Offset: 0xE0C79C
    static System::Type* GetTypeFromAssembly(System::Reflection::Assembly* assem, ::CsString* name);
    // static System.Reflection.Assembly LoadAssemblyFromString(System.String assemblyName)
    // Offset: 0xE0C85C
    static System::Reflection::Assembly* LoadAssemblyFromString(::CsString* assemblyName);
    // static System.Reflection.Assembly LoadAssemblyFromStringNoThrow(System.String assemblyName)
    // Offset: 0xE0C864
    static System::Reflection::Assembly* LoadAssemblyFromStringNoThrow(::CsString* assemblyName);
    // static System.String GetClrAssemblyName(System.Type type, System.Boolean hasTypeForwardedFrom)
    // Offset: 0xE0C948
    static ::CsString* GetClrAssemblyName(System::Type* type, bool& hasTypeForwardedFrom);
    // static System.String GetClrTypeFullName(System.Type type)
    // Offset: 0xE0CAAC
    static ::CsString* GetClrTypeFullName(System::Type* type);
    // static private System.String GetClrTypeFullNameForArray(System.Type type)
    // Offset: 0xE0CB50
    static ::CsString* GetClrTypeFullNameForArray(System::Type* type);
    // static private System.String GetClrTypeFullNameForNonArrayTypes(System.Type type)
    // Offset: 0xE0CD48
    static ::CsString* GetClrTypeFullNameForNonArrayTypes(System::Type* type);
