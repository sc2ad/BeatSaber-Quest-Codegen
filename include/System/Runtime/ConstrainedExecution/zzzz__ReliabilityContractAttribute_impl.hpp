...
System::Runtime::ConstrainedExecution::ReliabilityContractAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::ConstrainedExecution::ReliabilityContractAttribute>(consistencyGuarantee, cer))};
return o;
}
