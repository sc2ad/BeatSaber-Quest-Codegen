...
namespace System::Runtime::Versioning {
  ...
  check_size<sizeof(TargetFrameworkAttribute), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Runtime_Versioning_TargetFrameworkAttributeSizeCheck;
}
