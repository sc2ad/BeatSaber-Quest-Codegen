...
namespace System::Runtime::InteropServices {
  ...
  check_size<sizeof(FieldOffsetAttribute), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __System_Runtime_InteropServices_FieldOffsetAttributeSizeCheck;
}
