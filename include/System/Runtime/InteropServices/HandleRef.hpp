...
namespace System::Runtime::InteropServices {
  ...
  check_size<sizeof(HandleRef), 8 + sizeof(System::IntPtr) + ((8 + sizeof(System::IntPtr)) % 8 != 0 ? (8 - (8 + sizeof(System::IntPtr)) % 8) : 0)> __System_Runtime_InteropServices_HandleRefSizeCheck;
}
