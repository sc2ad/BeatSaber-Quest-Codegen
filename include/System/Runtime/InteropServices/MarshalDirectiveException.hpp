...
namespace System::Runtime::InteropServices {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: D3BDF8
  class MarshalDirectiveException : public System::SystemException {
    ...
    static MarshalDirectiveException* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("System::Runtime::InteropServices").WithContext("MarshalDirectiveException").WithContext(".ctor");
