...
namespace System::Runtime::InteropServices {
  ...
  // [ComVisibleAttribute] Offset: D7EE8C
  // [AttributeUsageAttribute] Offset: D7EE8C
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::InteropServices::ClassInterfaceAttribute::*)(System::Runtime::InteropServices::ClassInterfaceType)>(&System::Runtime::InteropServices::ClassInterfaceAttribute::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::InteropServices::ClassInterfaceAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::InteropServices::ClassInterfaceType>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::InteropServices::ClassInterfaceAttribute::*)(System::Runtime::InteropServices::ClassInterfaceType)>(&System::Runtime::InteropServices::ClassInterfaceAttribute::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Runtime::InteropServices::ClassInterfaceAttribute*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Runtime::InteropServices::ClassInterfaceType>()});
  }
};
