...
namespace System::Runtime::CompilerServices {
  ...
  check_size<sizeof(AsyncMethodBuilderCore::MoveNextRunner), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Runtime_CompilerServices_AsyncMethodBuilderCore_MoveNextRunnerSizeCheck;
}
