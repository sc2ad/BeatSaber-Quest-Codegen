...
namespace System::Runtime::CompilerServices {
  ...
  struct ConfiguredTaskAwaitable : public System::ValueType {
    ...
    check_size<sizeof(ConfiguredTaskAwaitable::ConfiguredTaskAwaiter), 8 + sizeof(bool) + ((8 + sizeof(bool)) % 8 != 0 ? (8 - (8 + sizeof(bool)) % 8) : 0)> __System_Runtime_CompilerServices_ConfiguredTaskAwaitable_ConfiguredTaskAwaiterSizeCheck;
  ...
  check_size<sizeof(ConfiguredTaskAwaitable), 0 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter) + ((0 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8 != 0 ? (8 - (0 + sizeof(System::Runtime::CompilerServices::ConfiguredTaskAwaitable::ConfiguredTaskAwaiter)) % 8) : 0)> __System_Runtime_CompilerServices_ConfiguredTaskAwaitableSizeCheck;
}
