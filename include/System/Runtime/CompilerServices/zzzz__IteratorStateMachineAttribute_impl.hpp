...
System::Runtime::CompilerServices::IteratorStateMachineAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::CompilerServices::IteratorStateMachineAttribute>(stateMachineType))};
return o;
}
