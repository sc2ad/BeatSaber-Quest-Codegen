...
namespace System::Runtime::CompilerServices {
  ...
  check_size<sizeof(AsyncMethodBuilderCore), 8 + sizeof(void*) + ((8 + sizeof(void*)) % 8 != 0 ? (8 - (8 + sizeof(void*)) % 8) : 0)> __System_Runtime_CompilerServices_AsyncMethodBuilderCoreSizeCheck;
}
