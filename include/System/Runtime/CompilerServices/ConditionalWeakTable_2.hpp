...
namespace System::Runtime::CompilerServices {
  ...
  class ConditionalWeakTable_2 : public ::Il2CppObject {
    ...
    // Size: 0x8
    // Offset: 0x0
    ::ArrayWrapper<System::Runtime::CompilerServices::Ephemeron> data;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<System::Runtime::CompilerServices::Ephemeron>) == 0x8);
    ...
    ConditionalWeakTable_2(::ArrayWrapper<System::Runtime::CompilerServices::Ephemeron> data_ = {}, ::Il2CppObject* lock_ = {}, int size_ = {}) noexcept : data{data_}, lock{lock_}, size{size_} {}
    ...
    ::ArrayWrapper<System::Runtime::CompilerServices::Ephemeron>& dyn_data() {
      ...
      return *reinterpret_cast<::ArrayWrapper<System::Runtime::CompilerServices::Ephemeron>*>(reinterpret_cast<char*>(this) + ___internal__field__offset);
    }
    // Autogenerated instance field getter
