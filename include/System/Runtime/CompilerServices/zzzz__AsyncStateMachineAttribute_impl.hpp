...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::CompilerServices::AsyncStateMachineAttribute::*)(System::Type)>(&System::Runtime::CompilerServices::AsyncStateMachineAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x236d9b4;
...
System::Runtime::CompilerServices::AsyncStateMachineAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::CompilerServices::AsyncStateMachineAttribute>(stateMachineType))};
return o;
}
