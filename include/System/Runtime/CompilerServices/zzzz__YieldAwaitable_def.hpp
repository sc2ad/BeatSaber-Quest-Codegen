...
namespace System::Runtime::CompilerServices {
struct ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter;
}
// Type: ::YieldAwaiter
namespace System::Runtime::CompilerServices {
// Is value type: true
...
struct CORDL_TYPE ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr operator  ::System::Runtime::CompilerServices::ICriticalNotifyCompletion() const;
                    ...
                    constexpr ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter(____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter const&) = default;
                    constexpr ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter(____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter&&) = default;
                    constexpr ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter& operator=(____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter& operator=(____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter&& o) noexcept {
...
constexpr explicit ____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using YieldAwaiter = ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter;
...
/// @brief Method GetAwaiter addr 0x2370588 size 0x8 virtual false final false
 ::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter GetAwaiter() ;
...
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::CompilerServices::____System__Runtime__CompilerServices__YieldAwaitable__YieldAwaiter, "System.Runtime.CompilerServices", "YieldAwaitable/YieldAwaiter");
