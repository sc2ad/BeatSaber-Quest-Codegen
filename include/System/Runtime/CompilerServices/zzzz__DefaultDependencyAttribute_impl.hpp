...
System::Runtime::CompilerServices::DefaultDependencyAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::CompilerServices::DefaultDependencyAttribute>(loadHintArgument))};
return o;
}
