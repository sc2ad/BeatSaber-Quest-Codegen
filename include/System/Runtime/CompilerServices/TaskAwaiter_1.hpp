...
namespace System::Runtime::CompilerServices {
  ...
  struct TaskAwaiter_1/*, public System::ValueType, public System::Runtime::CompilerServices::ICriticalNotifyCompletion*/ {
    ...
    void OnCompleted_NEW(System::Action* continuation) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Runtime::CompilerServices::TaskAwaiter_1::OnCompleted_NEW");
    ...
    void UnsafeOnCompleted_NEW(System::Action* continuation) {
      static auto ___internal__logger = ::Logger::get().WithContext("System::Runtime::CompilerServices::TaskAwaiter_1::UnsafeOnCompleted_NEW");
