...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::CompilerServices::StringFreezingAttribute::*)()>(&System::Runtime::CompilerServices::StringFreezingAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x236e3d0;
...
System::Runtime::CompilerServices::StringFreezingAttribute o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::CompilerServices::StringFreezingAttribute>())};
return o;
}
