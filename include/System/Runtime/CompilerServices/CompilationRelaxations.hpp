...
namespace System::Runtime::CompilerServices {
  ...
  check_size<sizeof(CompilationRelaxations), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __System_Runtime_CompilerServices_CompilationRelaxationsSizeCheck;
}
