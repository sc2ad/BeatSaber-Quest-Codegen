...
namespace System::Runtime::Remoting {
  ...
  class ObjRef : public ::CsObject, public System::Runtime::Serialization::IObjectReference, public System::Runtime::Serialization::ISerializable {
    public:
    ...
    // Offset: 0xE105A0
    static ObjRef* New_ctor(::CsString* uri, System::Runtime::Remoting::IChannelInfo* cinfo);
    ...
    // Offset: 0xE107B8
    static ObjRef* New_ctor(System::Type* type, ::CsString* url, ::CsObject* remoteChannelData);
