...
namespace System::Runtime::Remoting::Contexts {
class ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg;
}
...
class CORDL_TYPE ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg", modifiers: " const&", def_value: None }]
constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg(____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg", modifiers: "&&", def_value: None }]
constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg(____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg& operator=(____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg&& o) noexcept = default;
  constexpr ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg& operator=(____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg() ;
...
public:
// Declarations
using DynamicPropertyReg = ::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg;
...
NEED_NO_BOX(::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__DynamicPropertyCollection__DynamicPropertyReg, "System.Runtime.Remoting.Contexts", "DynamicPropertyCollection/DynamicPropertyReg");
