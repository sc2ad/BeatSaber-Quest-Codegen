...
namespace System::Runtime::Remoting::Contexts {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96B48
  class IContributeEnvoySink {
    ...
    // Offset: 0xFFFFFFFF
    System::Runtime::Remoting::Messaging::IMessageSink* GetEnvoySink_NEW(System::MarshalByRefObject* obj, System::Runtime::Remoting::Messaging::IMessageSink* nextSink);
