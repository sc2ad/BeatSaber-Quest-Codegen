...
namespace System::Runtime::Remoting::Contexts {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96B20
  class IContributeClientContextSink {
    ...
    // Offset: 0xFFFFFFFF
    System::Runtime::Remoting::Messaging::IMessageSink* GetClientContextSink_NEW(System::Runtime::Remoting::Messaging::IMessageSink* nextSink);
