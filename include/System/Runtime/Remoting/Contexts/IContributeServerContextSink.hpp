...
namespace System::Runtime::Remoting::Contexts {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96B70
  class IContributeServerContextSink {
    ...
    // Offset: 0xFFFFFFFF
    System::Runtime::Remoting::Messaging::IMessageSink* GetServerContextSink_NEW(System::Runtime::Remoting::Messaging::IMessageSink* nextSink);
