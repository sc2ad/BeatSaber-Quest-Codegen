...
namespace System::Runtime::Remoting::Contexts {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96B5C
  class IContributeObjectSink {
    ...
    // Offset: 0xFFFFFFFF
    System::Runtime::Remoting::Messaging::IMessageSink* GetObjectSink_NEW(System::MarshalByRefObject* obj, System::Runtime::Remoting::Messaging::IMessageSink* nextSink);
