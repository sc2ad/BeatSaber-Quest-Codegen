...
namespace System::Runtime::Remoting::Contexts {
class ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink;
}
...
class CORDL_TYPE ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink() = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink", modifiers: " const&", def_value: None }]
constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink(____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink", modifiers: "&&", def_value: None }]
constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink(____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink& operator=(____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink&& o) noexcept = default;
  constexpr ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink& operator=(____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink const& o) noexcept = default;
...
explicit ____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink(::System::Runtime::Remoting::Messaging::IMessageSink next, ::System::Runtime::Remoting::Contexts::Context context, ::System::Runtime::Remoting::Messaging::IMessage call) ;
...
public:
// Declarations
using ContextRestoreSink = ::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink;
...
NEED_NO_BOX(::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink);
DEFINE_IL2CPP_ARG_TYPE(::System::Runtime::Remoting::Contexts::____System__Runtime__Remoting__Contexts__CrossContextChannel__ContextRestoreSink, "System.Runtime.Remoting.Contexts", "CrossContextChannel/ContextRestoreSink");
