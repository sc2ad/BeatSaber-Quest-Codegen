...
namespace System::Runtime::Remoting::Contexts {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96AF8
  class IContextAttribute {
    ...
    // Offset: 0xFFFFFFFF
    void GetPropertiesForNewContext_NEW(System::Runtime::Remoting::Activation::IConstructionCallMessage* msg);
    ...
    // Offset: 0xFFFFFFFF
    bool IsContextOK_NEW(System::Runtime::Remoting::Contexts::Context* ctx, System::Runtime::Remoting::Activation::IConstructionCallMessage* msg);
