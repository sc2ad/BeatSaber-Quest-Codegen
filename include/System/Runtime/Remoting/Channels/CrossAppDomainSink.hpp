...
namespace System::Runtime::Remoting::Channels {
  ...
  // [] Offset: FFFFFFFF
  // [MonoTODOAttribute] Offset: C96BC0
  class CrossAppDomainSink : public ::Il2CppObject/*, public System::Runtime::Remoting::Messaging::IMessageSink*/ {
    ...
    // Offset: 0x1309048
    System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage_NEW(System::Runtime::Remoting::Messaging::IMessage* msgRequest);
    ...
    // Offset: 0x130941C
    System::Runtime::Remoting::Messaging::IMessageCtrl* AsyncProcessMessage_NEW(System::Runtime::Remoting::Messaging::IMessage* reqMsg, System::Runtime::Remoting::Messaging::IMessageSink* replySink);
