...
namespace System::Runtime::Remoting::Channels {
  ...
  check_size<sizeof(CrossAppDomainSink), 16 + sizeof(int) + ((16 + sizeof(int)) % 8 != 0 ? (8 - (16 + sizeof(int)) % 8) : 0)> __System_Runtime_Remoting_Channels_CrossAppDomainSinkSizeCheck;
}
