...
namespace System::Runtime::Remoting::Channels {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96C70
  class IChannelSender/*, public System::Runtime::Remoting::Channels::IChannel*/ {
    ...
    // Offset: 0xFFFFFFFF
    System::Runtime::Remoting::Messaging::IMessageSink* CreateMessageSink_NEW(::Il2CppString* url, ::Il2CppObject* remoteChannelData, ::Il2CppString*& objectURI);
