...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(CADMethodCallMessage), 56 + sizeof(void*) + ((56 + sizeof(void*)) % 8 != 0 ? (8 - (56 + sizeof(void*)) % 8) : 0)> __System_Runtime_Remoting_Messaging_CADMethodCallMessageSizeCheck;
}
