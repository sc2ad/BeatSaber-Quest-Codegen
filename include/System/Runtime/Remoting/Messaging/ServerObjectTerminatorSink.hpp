...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(ServerObjectTerminatorSink), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __System_Runtime_Remoting_Messaging_ServerObjectTerminatorSinkSizeCheck;
}
