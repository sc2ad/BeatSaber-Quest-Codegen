...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(ClientContextTerminatorSink), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __System_Runtime_Remoting_Messaging_ClientContextTerminatorSinkSizeCheck;
}
