...
namespace System::Runtime::Remoting::Messaging {
  ...
  class LogicalCallContext : public ::CsObject, public System::Runtime::Serialization::ISerializable, public System::ICloneable {
    public:
    ...
    static ::CsString* _get_s_CorrelationMgrSlotName();
    // Set static field: static private System.String s_CorrelationMgrSlotName
    static void _set_s_CorrelationMgrSlotName(::CsString* value);
    ...
    // Offset: 0x1060C7C
    void SetData(::CsString* name, ::CsObject* data);
