...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(LogicalCallContext), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __System_Runtime_Remoting_Messaging_LogicalCallContextSizeCheck;
}
