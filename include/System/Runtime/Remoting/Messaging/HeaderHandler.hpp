...
namespace System::Runtime::Remoting::Messaging {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96EF4
  class HeaderHandler : public System::MulticastDelegate {
    ...
    // Offset: 0x18ACFB0
    ::Il2CppObject* Invoke_NEW(::Array<System::Runtime::Remoting::Messaging::Header*>* headers);
    ...
    // Offset: 0x18AD34C
    System::IAsyncResult* BeginInvoke_NEW(::Array<System::Runtime::Remoting::Messaging::Header*>* headers, System::AsyncCallback* callback, ::Il2CppObject* object);
