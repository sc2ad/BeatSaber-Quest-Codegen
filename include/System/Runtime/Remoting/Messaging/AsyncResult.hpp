...
namespace System::Runtime::Remoting::Messaging {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C96E4C
  class AsyncResult : public ::Il2CppObject/*, public System::IAsyncResult, public System::Runtime::Remoting::Messaging::IMessageSink, public System::Threading::IThreadPoolWorkItem*/ {
    ...
    // Offset: 0x18A6B30
    ::Il2CppObject* get_AsyncDelegate_NEW();
    // public System.Runtime.Remoting.Messaging.IMessageSink get_NextSink()
    // Offset: 0x18A6B38
    System::Runtime::Remoting::Messaging::IMessageSink* get_NextSink_NEW();
    ...
    // Offset: 0x18A6BA0
    System::Runtime::Remoting::Messaging::IMessage* GetReplyMessage_NEW();
    // public System.Void SetMessageCtrl(System.Runtime.Remoting.Messaging.IMessageCtrl mc)
    // Offset: 0x18A6BA8
    void SetMessageCtrl_NEW(System::Runtime::Remoting::Messaging::IMessageCtrl* mc);
