...
namespace System::Runtime::Remoting::Messaging {
  ...
  class AsyncResult : public System::IAsyncResult, public System::Runtime::Remoting::Messaging::IMessageSink, public System::Threading::IThreadPoolWorkItem, public ::Il2CppObject {
    public:
