...
namespace System::Runtime::Remoting::Messaging {
  ...
  class AsyncResult : public ::CsObject, public System::IAsyncResult, public System::Runtime::Remoting::Messaging::IMessageSink, public System::Threading::IThreadPoolWorkItem {
    public:
    ...
    // Offset: 0x104DAAC
    static AsyncResult* New_ctor(System::Threading::WaitCallback* cb, ::CsObject* state, bool capture_context);
    ...
    // Offset: 0x104E0FC
    void $_ctor$b__17_0(::CsObject* $p0$);
    // System.Void .ctor()
    // Offset: 0x104DAA4
