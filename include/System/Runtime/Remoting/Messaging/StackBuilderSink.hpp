...
namespace System::Runtime::Remoting::Messaging {
  ...
  class StackBuilderSink : public ::CsObject, public System::Runtime::Remoting::Messaging::IMessageSink {
    public:
    ...
    // Offset: 0xDFCF54
    void ExecuteAsyncMessage(::CsObject* ob);
    ...
    // Offset: 0xDFD15C
    void $AsyncProcessMessage$b__4_0(::CsObject* data);
