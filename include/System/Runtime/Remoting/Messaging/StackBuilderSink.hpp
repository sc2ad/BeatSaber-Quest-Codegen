...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(StackBuilderSink), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __System_Runtime_Remoting_Messaging_StackBuilderSinkSizeCheck;
}
