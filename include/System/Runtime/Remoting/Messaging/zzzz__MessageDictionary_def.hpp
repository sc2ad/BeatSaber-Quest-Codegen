...
class CORDL_TYPE System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator", modifiers: " const&", def_value: None }]
constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator(System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator", modifiers: "&&", def_value: None }]
constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator(System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator& operator=(System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator&& o) noexcept = default;
  constexpr System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator& operator=(System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator const& o) noexcept = default;
...
public:
// Declarations
using DictionaryEnumerator = System::Runtime::Remoting::Messaging::System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator;
...
NEED_NO_BOX(System::Runtime::Remoting::Messaging::System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator);
DEFINE_IL2CPP_ARG_TYPE(System::Runtime::Remoting::Messaging::System__Runtime__Remoting__Messaging__MessageDictionary__DictionaryEnumerator, "System.Runtime.Remoting.Messaging", "MessageDictionary/DictionaryEnumerator");
