...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(MethodResponse), 128 + sizeof(void*) + ((128 + sizeof(void*)) % 8 != 0 ? (8 - (128 + sizeof(void*)) % 8) : 0)> __System_Runtime_Remoting_Messaging_MethodResponseSizeCheck;
}
