...
namespace System::Runtime::Remoting::Messaging {
  ...
  // [] Offset: FFFFFFFF
  // [ComVisibleAttribute] Offset: C97078
  class RemotingSurrogateSelector : public ::Il2CppObject/*, public System::Runtime::Serialization::ISurrogateSelector*/ {
    ...
    // Offset: 0x18B38B4
    System::Runtime::Serialization::ISerializationSurrogate* GetSurrogate_NEW(System::Type* type, System::Runtime::Serialization::StreamingContext context, System::Runtime::Serialization::ISurrogateSelector*& ssout);
