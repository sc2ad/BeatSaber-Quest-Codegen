...
namespace System::Runtime::Remoting::Messaging {
  ...
  check_size<sizeof(IllogicalCallContext::Reader), 0 + sizeof(void*) + ((0 + sizeof(void*)) % 8 != 0 ? (8 - (0 + sizeof(void*)) % 8) : 0)> __System_Runtime_Remoting_Messaging_IllogicalCallContext_ReaderSizeCheck;
}
