...
System::Runtime::Remoting::Messaging::ServerObjectTerminatorSink o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::Remoting::Messaging::ServerObjectTerminatorSink>(nextSink))};
return o;
}
