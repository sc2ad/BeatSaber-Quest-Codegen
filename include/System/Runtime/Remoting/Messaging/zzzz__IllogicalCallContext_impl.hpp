...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::Hashtable (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)()>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::get_Datastore)> {
  ...
  constexpr static std::size_t addrs = 0x233a110;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::bs_hook::Il2CppWrapperType (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)()>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::get_HostContext)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x233a17c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)(::bs_hook::Il2CppWrapperType)>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::set_HostContext)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x233a184;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)()>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::get_HasUserData)> {
  ...
  constexpr static std::size_t addrs = 0x233a18c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)(::StringW)>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::FreeNamedDataSlot)> {
  constexpr static std::size_t size = 0x2c;
  constexpr static std::size_t addrs = 0x233a04c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Runtime::Remoting::Messaging::IllogicalCallContext (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)()>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::CreateCopy)> {
  ...
  constexpr static std::size_t addrs = 0x233a1b8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Remoting::Messaging::IllogicalCallContext::*)()>(&System::Runtime::Remoting::Messaging::IllogicalCallContext::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x233a40c;
...
constexpr void System::Runtime::Remoting::Messaging::IllogicalCallContext::__set_m_Datastore(System::Collections::Hashtable value)  {
...
constexpr System::Collections::Hashtable System::Runtime::Remoting::Messaging::IllogicalCallContext::__get_m_Datastore() const {
return ::cordl_internals::getInstanceField<System::Collections::Hashtable, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Runtime::Remoting::Messaging::IllogicalCallContext::__set_m_HostContext(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Runtime::Remoting::Messaging::IllogicalCallContext::__get_m_HostContext() const {
...
return ::cordl_internals::RunMethodRethrow<System::Collections::Hashtable, false>(const_cast<void*>(instance), ___internal_method);
}
 ::bs_hook::Il2CppWrapperType System::Runtime::Remoting::Messaging::IllogicalCallContext::get_HostContext()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Remoting::Messaging::IllogicalCallContext>::get(),
                            "get_HostContext",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::bs_hook::Il2CppWrapperType, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void System::Runtime::Remoting::Messaging::IllogicalCallContext::set_HostContext(::bs_hook::Il2CppWrapperType value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Remoting::Messaging::IllogicalCallContext>::get(),
                            "set_HostContext",
                            std::vector<Il2CppClass*>{},
