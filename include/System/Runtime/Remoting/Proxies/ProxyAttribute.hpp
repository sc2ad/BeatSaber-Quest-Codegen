...
namespace System::Runtime::Remoting::Proxies {
  ...
  // [] Offset: FFFFFFFF
  // [AttributeUsageAttribute] Offset: C96A2C
  // [ComVisibleAttribute] Offset: C96A2C
  class ProxyAttribute : public System::Attribute {
    ...
    // Offset: 0x18B70E4
    System::MarshalByRefObject* CreateInstance_NEW(System::Type* serverType);
    ...
    // Offset: 0x18B7234
    System::Runtime::Remoting::Proxies::RealProxy* CreateProxy_NEW(System::Runtime::Remoting::ObjRef* objRef, System::Type* serverType, ::Il2CppObject* serverObject, System::Runtime::Remoting::Contexts::Context* serverContext);
