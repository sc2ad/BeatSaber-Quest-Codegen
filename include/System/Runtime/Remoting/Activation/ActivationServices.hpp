...
namespace System::Runtime::Remoting::Activation {
  ...
  class ActivationServices : public ::CsObject {
    public:
    ...
    // Offset: 0x104C8DC
    static System::Runtime::Remoting::Messaging::ConstructionCall* CreateConstructionCall(System::Type* type, ::CsString* activationUrl, ::Array<::CsObject*>* activationAttributes);
    ...
    // Offset: 0x104D734
    static ::CsObject* CreateProxyForType(System::Type* type);
    // static public System.Object AllocateUninitializedClassInstance(System.Type type)
    // Offset: 0x104D724
    static ::CsObject* AllocateUninitializedClassInstance(System::Type* type);
