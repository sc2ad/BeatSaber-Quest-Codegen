...
namespace System::Runtime::Remoting::Activation {
  ...
  class AppDomainLevelActivator : public ::CsObject, public System::Runtime::Remoting::Activation::IActivator {
    public:
    // private System.String _activationUrl
    // Offset: 0x10
    ::CsString* activationUrl;
    ...
    // Offset: 0x103D864
    static AppDomainLevelActivator* New_ctor(::CsString* activationUrl, System::Runtime::Remoting::Activation::IActivator* next);
