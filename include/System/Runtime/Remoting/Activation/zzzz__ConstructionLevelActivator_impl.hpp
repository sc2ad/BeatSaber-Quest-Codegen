...
System::Runtime::Remoting::Activation::ConstructionLevelActivator o{THROW_UNLESS(::il2cpp_utils::New<System::Runtime::Remoting::Activation::ConstructionLevelActivator>())};
return o;
}
