...
namespace System {
  ...
  class UnitySerializationHolder : public ::CsObject, public System::Runtime::Serialization::ISerializable, public System::Runtime::Serialization::IObjectReference {
    public:
    ...
    // Offset: 0x17967AC
    static void GetUnitySerializationInfo(System::Runtime::Serialization::SerializationInfo* info, int unityType, ::CsString* data, System::Reflection::RuntimeAssembly* assembly);
    ...
    // Offset: 0x1796C54
    void ThrowInsufficientInformation(::CsString* field);
