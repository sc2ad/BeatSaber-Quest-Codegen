...
static System::FormatException New_ctor() ;

/// @brief Method .ctor addr 0x24293a0 size 0x5c virtual false final false
 void _ctor() ;

static System::FormatException New_ctor(::StringW message) ;

/// @brief Method .ctor addr 0x24293fc size 0x24 virtual false final false
 void _ctor(::StringW message) ;

static System::FormatException New_ctor(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2429420 size 0x24 virtual false final false
 void _ctor(::StringW message, System::Exception innerException) ;

static System::FormatException New_ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;
