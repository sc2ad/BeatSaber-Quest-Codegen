...
namespace Tweening {
  ...
  class Tween_1 : public ::Tweening::Tween {
    ...
    [[deprecated("Use field access instead!")]] T& dyn_fromValue() {
    ...
    [[deprecated("Use field access instead!")]] T& dyn_toValue() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_1<T>*& dyn_onUpdate() {
    ...
    // protected System.Void .ctor(T fromValue, T toValue, System.Action`1<T> onUpdate, System.Single duration, EaseType easeType, System.Single delay)
    ...
    // public System.Void Init(T fromValue, T toValue, System.Action`1<T> onUpdate, System.Single duration, EaseType easeType, System.Single delay)
    // Offset: 0xFFFFFFFFFFFFFFFF
    ...
    T GetValue(float t) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<T, false>(this, ___internal__method, t);
    }
