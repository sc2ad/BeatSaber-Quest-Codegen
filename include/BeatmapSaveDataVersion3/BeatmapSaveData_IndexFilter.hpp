...
namespace BeatmapSaveDataVersion3 {
  ...
  class BeatmapSaveData::IndexFilter : public ::Il2CppObject {
    ...
    ::BeatmapSaveDataVersion3::BeatmapSaveData::IndexFilter::IndexFilterType& dyn_f();
  ...
  #pragma pack(pop)
  static check_size<sizeof(BeatmapSaveData::IndexFilter), 28 + sizeof(int)> __BeatmapSaveDataVersion3_BeatmapSaveData_IndexFilterSizeCheck;
  static_assert(sizeof(BeatmapSaveData::IndexFilter) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
