...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::DerUtf8String, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Crmf::AuthenticatorControl Org::BouncyCastle::Crmf::AuthenticatorControl::New_ctor(Org::BouncyCastle::Asn1::DerUtf8String token)  {
Org::BouncyCastle::Crmf::AuthenticatorControl o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crmf::AuthenticatorControl>(token))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, token);
 ...
 Org::BouncyCastle::Crmf::AuthenticatorControl Org::BouncyCastle::Crmf::AuthenticatorControl::New_ctor(::StringW token)  {
Org::BouncyCastle::Crmf::AuthenticatorControl o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crmf::AuthenticatorControl>(token))};
return o;
}
