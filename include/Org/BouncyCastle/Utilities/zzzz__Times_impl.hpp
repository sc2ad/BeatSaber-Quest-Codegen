...
return ::cordl_internals::RunMethodRethrow<int64_t, false>(nullptr, ___internal_method);
 ...
 Org::BouncyCastle::Utilities::Times Org::BouncyCastle::Utilities::Times::New_ctor()  {
Org::BouncyCastle::Utilities::Times o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Utilities::Times>())};
return o;
}
