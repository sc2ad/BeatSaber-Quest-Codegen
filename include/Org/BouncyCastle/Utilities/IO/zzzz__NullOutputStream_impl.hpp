...
// Ctor Parameters []
 Org::BouncyCastle::Utilities::IO::NullOutputStream::NullOutputStream()  : Org::BouncyCastle::Utilities::IO::BaseOutputStream(THROW_UNLESS(::il2cpp_utils::New<NullOutputStream>())) {}
