...
return ::cordl_internals::getInstanceField<System::IO::Stream, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Utilities::IO::TeeInputStream Org::BouncyCastle::Utilities::IO::TeeInputStream::New_ctor(System::IO::Stream input, System::IO::Stream tee)  {
Org::BouncyCastle::Utilities::IO::TeeInputStream o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Utilities::IO::TeeInputStream>(input, tee))};
return o;
}
