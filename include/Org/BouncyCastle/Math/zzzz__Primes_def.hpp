...
namespace Org::BouncyCastle::Math {
class ____Org__BouncyCastle__Math__Primes__MROutput;
}
namespace Org::BouncyCastle::Math {
class ____Org__BouncyCastle__Math__Primes__STOutput;
}
// Type: ::MROutput
namespace Org::BouncyCastle::Math {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Math__Primes__MROutput : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Org__BouncyCastle__Math__Primes__MROutput() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__Primes__MROutput", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__Primes__MROutput(____Org__BouncyCastle__Math__Primes__MROutput const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__Primes__MROutput", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__Primes__MROutput(____Org__BouncyCastle__Math__Primes__MROutput&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__Primes__MROutput(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__Primes__MROutput& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__Primes__MROutput& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__Primes__MROutput& operator=(____Org__BouncyCastle__Math__Primes__MROutput&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__Primes__MROutput& operator=(____Org__BouncyCastle__Math__Primes__MROutput const& o) noexcept = default;
...
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput ProbablyPrime() ;

/// @brief Method ProvablyCompositeWithFactor addr 0x100f4f4 size 0x6c virtual false final false
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput ProvablyCompositeWithFactor(::Org::BouncyCastle::Math::BigInteger factor) ;

/// @brief Method ProvablyCompositeNotPrimePower addr 0x100f560 size 0x68 virtual false final false
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput ProvablyCompositeNotPrimePower() ;
...
explicit ____Org__BouncyCastle__Math__Primes__MROutput(bool provablyComposite, ::Org::BouncyCastle::Math::BigInteger factor) ;
...
class CORDL_TYPE ____Org__BouncyCastle__Math__Primes__STOutput : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____Org__BouncyCastle__Math__Primes__STOutput() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__Primes__STOutput", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__Primes__STOutput(____Org__BouncyCastle__Math__Primes__STOutput const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__Primes__STOutput", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__Primes__STOutput(____Org__BouncyCastle__Math__Primes__STOutput&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__Primes__STOutput(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__Primes__STOutput& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__Primes__STOutput& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__Primes__STOutput& operator=(____Org__BouncyCastle__Math__Primes__STOutput&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__Primes__STOutput& operator=(____Org__BouncyCastle__Math__Primes__STOutput const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__Primes__STOutput(::Org::BouncyCastle::Math::BigInteger prime, ::ArrayW<uint8_t> primeSeed, int32_t primeGenCounter) ;
...
public:
// Declarations
using STOutput = ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__STOutput;

using MROutput = ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput;
...
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__STOutput GenerateSTRandomPrime(::Org::BouncyCastle::Crypto::IDigest hash, int32_t length, ::ArrayW<uint8_t> inputSeed) ;

/// @brief Method EnhancedMRProbablePrimeTest addr 0x100cae0 size 0x48c virtual false final false
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput EnhancedMRProbablePrimeTest(::Org::BouncyCastle::Math::BigInteger candidate, ::Org::BouncyCastle::Security::SecureRandom random, int32_t iterations) ;
...
static ::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__STOutput ImplSTRandomPrime(::Org::BouncyCastle::Crypto::IDigest d, int32_t length, ::ArrayW<uint8_t> primeSeed) ;
...
NEED_NO_BOX(::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__MROutput, "Org.BouncyCastle.Math", "Primes/MROutput");
NEED_NO_BOX(::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__STOutput);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::____Org__BouncyCastle__Math__Primes__STOutput, "Org.BouncyCastle.Math", "Primes/STOutput");
