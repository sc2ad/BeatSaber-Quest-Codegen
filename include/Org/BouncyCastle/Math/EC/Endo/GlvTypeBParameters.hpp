...
namespace Org::BouncyCastle::Math::EC::Endo {
  ...
  check_size<sizeof(GlvTypeBParameters), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Math_EC_Endo_GlvTypeBParametersSizeCheck;
}
