...
namespace Org::BouncyCastle::Math::EC::Endo {
  ...
  // Writing MetadataGetter for method: GlvTypeBEndomorphism::New_ctor
  // Il2CppName: .ctor
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlvTypeBEndomorphism::*)(Org::BouncyCastle::Math::EC::ECCurve*, Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters*)>(&GlvTypeBEndomorphism::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(GlvTypeBEndomorphism*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Org::BouncyCastle::Math::EC::ECCurve*>(), ::il2cpp_utils::ExtractIndependentType<Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters*>()});
    }
  };
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlvTypeBEndomorphism::*)(Org::BouncyCastle::Math::EC::ECCurve*, Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters*)>(&GlvTypeBEndomorphism::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(GlvTypeBEndomorphism*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Org::BouncyCastle::Math::EC::ECCurve*>(), ::il2cpp_utils::ExtractIndependentType<Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters*>()});
    }
  };
  // Writing MetadataGetter for method: GlvTypeBEndomorphism::DecomposeScalar
  // Il2CppName: DecomposeScalar
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Array<Org::BouncyCastle::Math::BigInteger*>* (GlvTypeBEndomorphism::*)(Org::BouncyCastle::Math::BigInteger*)>(&GlvTypeBEndomorphism::DecomposeScalar)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(GlvTypeBEndomorphism*), "DecomposeScalar", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Org::BouncyCastle::Math::BigInteger*>()});
    }
  };
  // Writing MetadataGetter for method: GlvTypeBEndomorphism::get_PointMap
  // Il2CppName: get_PointMap
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECPointMap* (GlvTypeBEndomorphism::*)()>(&GlvTypeBEndomorphism::get_PointMap)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(GlvTypeBEndomorphism*), "get_PointMap", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
  // Writing MetadataGetter for method: GlvTypeBEndomorphism::get_HasEfficientPointMap
  // Il2CppName: get_HasEfficientPointMap
  template<>
  struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlvTypeBEndomorphism::*)()>(&GlvTypeBEndomorphism::get_HasEfficientPointMap)> {
    const MethodInfo* get() {
      return ::il2cpp_utils::FindMethod(classof(GlvTypeBEndomorphism*), "get_HasEfficientPointMap", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
    }
  };
}
