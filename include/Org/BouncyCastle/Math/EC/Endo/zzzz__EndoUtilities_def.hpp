...
namespace Org::BouncyCastle::Math::EC::Endo {
class ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback(____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback(____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback& operator=(____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback& operator=(____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback(::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism endomorphism, ::Org::BouncyCastle::Math::EC::ECPoint point) ;
...
public:
// Declarations
using MapPointCallback = ::Org::BouncyCastle::Math::EC::Endo::____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback;
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Endo::____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Endo::____Org__BouncyCastle__Math__EC__Endo__EndoUtilities__MapPointCallback, "Org.BouncyCastle.Math.EC.Endo", "EndoUtilities/MapPointCallback");
