...
//  Writing Method size for method: ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::*)(::Org::BouncyCastle::Math::EC::AbstractF2mPoint, int8_t)>(&::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0xfadabc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback>::get(),
                            ".ctor",
...
//  Writing Method size for method: ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback.Precompute
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo (::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::*)(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo)>(&::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::Precompute)> {
...
constexpr  ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::operator ::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback() const noexcept {
return ::Org::BouncyCastle::Math::EC::Multiplier::IPreCompCallback(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::__set_m_p(::Org::BouncyCastle::Math::EC::AbstractF2mPoint value)  {
...
constexpr ::Org::BouncyCastle::Math::EC::AbstractF2mPoint ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::__get_m_p() const {
...
constexpr void ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::__set_m_a(int8_t value)  {
::cordl_internals::setInstanceField<int8_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int8_t>(value));
}
constexpr int8_t ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::__get_m_a() const {
...
// Ctor Parameters [CppParam { name: "p", ty: "::Org::BouncyCastle::Math::EC::AbstractF2mPoint", modifiers: "", def_value: None }, CppParam { name: "a", ty: "int8_t", modifiers: "", def_value: None }]
 ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback(::Org::BouncyCastle::Math::EC::AbstractF2mPoint p, int8_t a)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback>(p, a))) {}
 void ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::_ctor(::Org::BouncyCastle::Math::EC::AbstractF2mPoint p, int8_t a)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, p, a);
 ...
 ::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo ::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback::Precompute(::Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo existing)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::EC::Multiplier::____Org__BouncyCastle__Math__EC__Multiplier__WTauNafMultiplier__WTauNafCallback>::get(),
                            "Precompute",
                            std::vector<Il2CppClass*>{},
