...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint (::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::*)(::Org::BouncyCastle::Math::EC::ECPoint, ::Org::BouncyCastle::Math::BigInteger)>(&::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::MultiplyPositive)> {
  ...
  constexpr static std::size_t addrs = 0xfaa590;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::*)()>(&::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xfaad44;
...
// Ctor Parameters []
 ::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::WNafL2RMultiplier()  : ::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier(THROW_UNLESS(::il2cpp_utils::New<WNafL2RMultiplier>())) {}
 void ::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Math::EC::Multiplier::WNafL2RMultiplier>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
