...
return ::cordl_internals::RunMethodRethrow<Org::BouncyCastle::Math::EC::ECPoint, false>(const_cast<void*>(instance), ___internal_method, p, k);
 ...
 Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier::New_ctor()  {
Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Math::EC::Multiplier::ReferenceMultiplier>())};
return o;
}
