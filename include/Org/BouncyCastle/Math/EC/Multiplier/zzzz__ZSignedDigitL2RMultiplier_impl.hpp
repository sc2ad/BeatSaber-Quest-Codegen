...
// Ctor Parameters []
 Org::BouncyCastle::Math::EC::Multiplier::ZSignedDigitL2RMultiplier::ZSignedDigitL2RMultiplier()  : Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier(THROW_UNLESS(::il2cpp_utils::New<ZSignedDigitL2RMultiplier>())) {}
