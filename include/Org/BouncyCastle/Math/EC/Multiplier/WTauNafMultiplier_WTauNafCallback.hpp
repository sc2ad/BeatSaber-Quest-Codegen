...
namespace Org::BouncyCastle::Math::EC::Multiplier {
  ...
  check_size<sizeof(WTauNafMultiplier::WTauNafCallback), 24 + sizeof(int8_t) + ((24 + sizeof(int8_t)) % 8 != 0 ? (8 - (24 + sizeof(int8_t)) % 8) : 0)> __Org_BouncyCastle_Math_EC_Multiplier_WTauNafMultiplier_WTauNafCallbackSizeCheck;
}
