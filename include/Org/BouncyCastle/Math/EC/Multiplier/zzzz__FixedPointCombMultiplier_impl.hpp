...
Org::BouncyCastle::Math::EC::Multiplier::FixedPointCombMultiplier o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Math::EC::Multiplier::FixedPointCombMultiplier>())};
return o;
}
