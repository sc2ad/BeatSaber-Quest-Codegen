...
namespace Org::BouncyCastle::Math::EC {
class ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable(____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable(____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable(void* ptr) noexcept : ::Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable& operator=(____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable& operator=(____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable(::Org::BouncyCastle::Math::EC::F2mCurve outer, ::ArrayW<int64_t> table, int32_t size) ;
...
public:
// Declarations
using DefaultF2mLookupTable = ::Org::BouncyCastle::Math::EC::____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable;
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::____Org__BouncyCastle__Math__EC__F2mCurve__DefaultF2mLookupTable, "Org.BouncyCastle.Math.EC", "F2mCurve/DefaultF2mLookupTable");
