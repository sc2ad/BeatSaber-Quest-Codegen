...
namespace Org::BouncyCastle::Math::EC {
  ...
  check_size<sizeof(F2mCurve::DefaultF2mLookupTable), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Math_EC_F2mCurve_DefaultF2mLookupTableSizeCheck;
}
