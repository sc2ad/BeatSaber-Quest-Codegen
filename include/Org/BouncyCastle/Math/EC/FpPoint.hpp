...
namespace Org::BouncyCastle::Math::EC {
  ...
  class FpPoint : public Org::BouncyCastle::Math::EC::AbstractFpPoint {
    ...
    // Offset: 0x1F7ED0C
    Org::BouncyCastle::Math::EC::ECFieldElement* Two_NEW(Org::BouncyCastle::Math::EC::ECFieldElement* x);
    // protected Org.BouncyCastle.Math.EC.ECFieldElement Three(Org.BouncyCastle.Math.EC.ECFieldElement x)
    // Offset: 0x1F7ED2C
    Org::BouncyCastle::Math::EC::ECFieldElement* Three_NEW(Org::BouncyCastle::Math::EC::ECFieldElement* x);
    // protected Org.BouncyCastle.Math.EC.ECFieldElement Four(Org.BouncyCastle.Math.EC.ECFieldElement x)
    // Offset: 0x1F7ED6C
    Org::BouncyCastle::Math::EC::ECFieldElement* Four_NEW(Org::BouncyCastle::Math::EC::ECFieldElement* x);
    // protected Org.BouncyCastle.Math.EC.ECFieldElement Eight(Org.BouncyCastle.Math.EC.ECFieldElement x)
    // Offset: 0x1F7EDAC
    Org::BouncyCastle::Math::EC::ECFieldElement* Eight_NEW(Org::BouncyCastle::Math::EC::ECFieldElement* x);
    ...
    // Offset: 0x1F7EF0C
    Org::BouncyCastle::Math::EC::ECFieldElement* CalculateJacobianModifiedW_NEW(Org::BouncyCastle::Math::EC::ECFieldElement* Z, Org::BouncyCastle::Math::EC::ECFieldElement* ZSquared);
    // protected Org.BouncyCastle.Math.EC.ECFieldElement GetJacobianModifiedW()
    // Offset: 0x1F7F05C
    Org::BouncyCastle::Math::EC::ECFieldElement* GetJacobianModifiedW_NEW();
    // protected Org.BouncyCastle.Math.EC.FpPoint TwiceJacobianModified(System.Boolean calculateW)
    // Offset: 0x1F7F0F4
    Org::BouncyCastle::Math::EC::FpPoint* TwiceJacobianModified_NEW(bool calculateW);
    ...
    // Offset: 0x1F7E554
    // Implemented from: Org.BouncyCastle.Math.EC.ECPoint
    // Base method: Org.BouncyCastle.Math.EC.ECPoint ECPoint::TimesPow2_NEW(System.Int32 e)
