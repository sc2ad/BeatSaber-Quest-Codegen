...
static Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement New_ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method .ctor addr 0xf3f434 size 0x118 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

static Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement New_ctor() ;

/// @brief Method .ctor addr 0xf416d8 size 0x24 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement New_ctor(::ArrayW<uint32_t> x) ;
