...
namespace Org::BouncyCastle::Math::EC::Custom::Djb {
  ...
  class Curve25519::Curve25519LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    Curve25519LookupTable(Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519* m_outer_ = {}, ::ArrayWrapper<uint> m_table_ = {}, int m_size_ = {}) noexcept : m_outer{m_outer_}, m_table{m_table_}, m_size{m_size_} {}
