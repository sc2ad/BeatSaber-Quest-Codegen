...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable;
}
...
class CORDL_TYPE Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable(void* ptr) noexcept : Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable&& o) noexcept = default;
  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable const& o) noexcept = default;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
public:
// Declarations
using SecP160R1LookupTable = Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R1Curve New_ctor() ;
...
NEED_NO_BOX(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R1Curve__SecP160R1LookupTable, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP160R1Curve/SecP160R1LookupTable");
