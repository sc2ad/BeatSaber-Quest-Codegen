...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecT131FieldElement New_ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method .ctor addr 0xf7c110 size 0xf4 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecT131FieldElement New_ctor() ;

/// @brief Method .ctor addr 0xf7c204 size 0x24 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecT131FieldElement New_ctor(::ArrayW<uint64_t> x) ;
