...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R2Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R2Curve New_ctor() ;
