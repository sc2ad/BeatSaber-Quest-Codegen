...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP256K1FieldElement : public Org::BouncyCastle::Math::EC::AbstractFpFieldElement {
    ...
    SecP256K1FieldElement(::ArrayWrapper<uint> x_ = {}) noexcept : x{x_} {}
    ...
    // Offset: 0x1FBE774
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static SecP256K1FieldElement* New_ctor(::ArrayWrapper<uint> x) {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Math::EC::Custom::Sec::SecP256K1FieldElement::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SecP256K1FieldElement*, creationType>(x)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(SecP256K1FieldElement), 16 + sizeof(::ArrayWrapper<uint>)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecP256K1FieldElementSizeCheck;
