...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT113R1Curve__SecT113R1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT113R1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
