...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable(____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable(____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable(void* ptr) noexcept : ::Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160K1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;

/// @brief Method .ctor addr 0xf4ce88 size 0x3c virtual false final false
 void _ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP160K1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;

/// @brief Method get_Size addr 0xf4d14c size 0x8 virtual true final false
 int32_t get_Size() ;

/// @brief Method Lookup addr 0xf4d154 size 0x108 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECPoint Lookup(int32_t index) ;

/// @brief Method LookupVar addr 0xf4d33c size 0xc8 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECPoint LookupVar(int32_t index) ;

/// @brief Method CreatePoint addr 0xf4d25c size 0xe0 virtual false final false
...
public:
// Declarations
using SecP160K1LookupTable = ::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable;
...
/// @brief Method .ctor addr 0xf4c808 size 0x19c virtual false final false
 void _ctor() ;

/// @brief Method CloneCurve addr 0xf4c9ac size 0x58 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECCurve CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0xf4ca04 size 0xc virtual true final false
 bool SupportsCoordinateSystem(int32_t coord) ;

/// @brief Method get_Q addr 0xf4ca10 size 0x58 virtual true final false
 ::Org::BouncyCastle::Math::BigInteger get_Q() ;

/// @brief Method get_Infinity addr 0xf4ca68 size 0x8 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECPoint get_Infinity() ;

/// @brief Method get_FieldSize addr 0xf4ca70 size 0x64 virtual true final false
 int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0xf4cad4 size 0x64 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECFieldElement FromBigInteger(::Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method CreateRawPoint addr 0xf4cb38 size 0x88 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECPoint CreateRawPoint(::Org::BouncyCastle::Math::EC::ECFieldElement x, ::Org::BouncyCastle::Math::EC::ECFieldElement y, bool withCompression) ;

/// @brief Method CreateRawPoint addr 0xf4cc48 size 0x90 virtual true final false
...
/// @brief Method CreateCacheSafeLookupTable addr 0xf4cce0 size 0x1a8 virtual true final false
...
/// @brief Method RandomFieldElement addr 0xf4cec4 size 0xa8 virtual true final false
 ::Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method RandomFieldElementMult addr 0xf4cf6c size 0xa8 virtual true final false
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecP160K1Curve__SecP160K1LookupTable, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP160K1Curve/SecP160K1LookupTable");
