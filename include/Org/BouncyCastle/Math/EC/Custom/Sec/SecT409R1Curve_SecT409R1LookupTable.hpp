...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT409R1Curve::SecT409R1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    SecT409R1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve* m_outer_ = {}, ::ArrayWrapper<uint64_t> m_table_ = {}, int m_size_ = {}) noexcept : m_outer{m_outer_}, m_table{m_table_}, m_size{m_size_} {}
    // Get instance field reference: private readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecT409R1Curve m_outer
    Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve*& dyn_m_outer();
    ...
    static SecT409R1Curve::SecT409R1LookupTable* New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve* outer, ::ArrayWrapper<uint64_t> table, int size) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve::SecT409R1LookupTable::*)(::ArrayWrapper<uint64_t>, ::ArrayWrapper<uint64_t>)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT409R1Curve::SecT409R1LookupTable::CreatePoint)> {
