...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  // Forward declaring type: SecP192R1Curve
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP192R1Curve : public ::Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SECP192R1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SECP192R1_AFFINE_ZS
    static void _set_SECP192R1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
    // Get instance field reference: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecP192R1Point m_infinity
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve::*)(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
