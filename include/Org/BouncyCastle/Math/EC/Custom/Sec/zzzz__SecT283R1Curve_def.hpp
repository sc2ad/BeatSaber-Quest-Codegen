...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT283R1Curve__SecT283R1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecT283R1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecT283R1Curve New_ctor() ;
