...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT113FieldElement : public Org::BouncyCastle::Math::EC::AbstractF2mFieldElement {
    ...
    SecT113FieldElement(::ArrayWrapper<uint64_t> x_ = {}) noexcept : x{x_} {}
    ...
    // Offset: 0x2034DA0
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static SecT113FieldElement* New_ctor(::ArrayWrapper<uint64_t> x) {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Math::EC::Custom::Sec::SecT113FieldElement::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SecT113FieldElement*, creationType>(x)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(SecT113FieldElement), 16 + sizeof(::ArrayWrapper<uint64_t>)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecT113FieldElementSizeCheck;
