...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT409FieldElement : public Org::BouncyCastle::Math::EC::AbstractF2mFieldElement {
    ...
    SecT409FieldElement(::ArrayWrapper<uint64_t> x_ = {}) noexcept : x{x_} {}
    ...
    // Offset: 0x20B5904
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static SecT409FieldElement* New_ctor(::ArrayWrapper<uint64_t> x) {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Math::EC::Custom::Sec::SecT409FieldElement::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SecT409FieldElement*, creationType>(x)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(SecT409FieldElement), 16 + sizeof(::ArrayWrapper<uint64_t>)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecT409FieldElementSizeCheck;
