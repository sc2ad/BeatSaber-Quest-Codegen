...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable;
}
namespace Org::BouncyCastle::Math::EC {
class ECCurve;
}
...
class CORDL_TYPE Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable(void* ptr) noexcept : Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable&& o) noexcept = default;
  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable const& o) noexcept = default;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP256K1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
public:
// Declarations
using SecP256K1LookupTable = Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP256K1Curve New_ctor() ;
...
NEED_NO_BOX(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP256K1Curve__SecP256K1LookupTable, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecP256K1Curve/SecP256K1LookupTable");
