...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP256R1FieldElement : public Org::BouncyCastle::Math::EC::AbstractFpFieldElement {
    ...
    static SecP256R1FieldElement* New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP256R1FieldElement").WithContext(".ctor");
