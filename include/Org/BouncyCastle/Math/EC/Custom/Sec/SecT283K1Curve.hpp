...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT283K1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static ::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SECT283K1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SECT283K1_AFFINE_ZS
    static void _set_SECT283K1_AFFINE_ZS(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Curve::*)(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT283K1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
