...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  check_size<sizeof(SecT193R2Curve::SecT193R2LookupTable), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecT193R2Curve_SecT193R2LookupTableSizeCheck;
}
