...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP128R1FieldElement : public Org::BouncyCastle::Math::EC::AbstractFpFieldElement {
    ...
    SecP128R1FieldElement(::ArrayWrapper<uint> x_ = {}) noexcept : x{x_} {}
    ...
    // Offset: 0x1F60160
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static SecP128R1FieldElement* New_ctor(::ArrayWrapper<uint> x) {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Math::EC::Custom::Sec::SecP128R1FieldElement::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SecP128R1FieldElement*, creationType>(x)));
    }
  ...
  #pragma pack(pop)
  static check_size<sizeof(SecP128R1FieldElement), 16 + sizeof(::ArrayWrapper<uint>)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecP128R1FieldElementSizeCheck;
