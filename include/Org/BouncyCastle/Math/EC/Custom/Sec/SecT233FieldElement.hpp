...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT233FieldElement : public Org::BouncyCastle::Math::EC::AbstractF2mFieldElement {
    ...
    static SecT233FieldElement* New_ctor(Org::BouncyCastle::Math::BigInteger* x) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT233FieldElement").WithContext(".ctor");
