...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  // Forward declaring type: SecT571R1Curve
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT571R1Curve : public ::Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SECT571R1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SECT571R1_AFFINE_ZS
    static void _set_SECT571R1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
    ...
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Curve::*)(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT571R1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
