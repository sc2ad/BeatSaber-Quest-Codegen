...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP224K1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static SecP224K1Curve* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP224K1Curve").WithContext(".ctor");
