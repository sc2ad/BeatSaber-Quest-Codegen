...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT193R1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R1Point* _get_m_infinity();
    // Set instance field: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecT193R1Point m_infinity
    void _set_m_infinity(Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R1Point* value);
