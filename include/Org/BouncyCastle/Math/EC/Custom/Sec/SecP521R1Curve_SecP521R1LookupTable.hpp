...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP521R1Curve::SecP521R1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    static SecP521R1Curve::SecP521R1LookupTable* New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP521R1Curve* outer, ::Array<uint>* table, int size) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP521R1LookupTable").WithContext(".ctor");
