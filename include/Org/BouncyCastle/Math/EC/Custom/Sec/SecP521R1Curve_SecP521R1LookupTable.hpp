...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  check_size<sizeof(SecP521R1Curve::SecP521R1LookupTable), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Math_EC_Custom_Sec_SecP521R1Curve_SecP521R1LookupTableSizeCheck;
}
