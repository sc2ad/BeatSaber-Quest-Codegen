...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1FieldElement New_ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method .ctor addr 0xf5a224 size 0x118 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1FieldElement New_ctor() ;

/// @brief Method .ctor addr 0xf5bfcc size 0x24 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1FieldElement New_ctor(::ArrayW<uint32_t> x) ;
