...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable(____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable(____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable(void* ptr) noexcept : ::Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163K1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
...
public:
// Declarations
using SecT163K1LookupTable = ::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable;
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::Sec::____Org__BouncyCastle__Math__EC__Custom__Sec__SecT163K1Curve__SecT163K1LookupTable, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT163K1Curve/SecT163K1LookupTable");
