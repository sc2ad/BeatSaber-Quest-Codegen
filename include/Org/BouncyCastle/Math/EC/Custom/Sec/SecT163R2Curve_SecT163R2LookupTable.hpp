...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  check_size<sizeof(SecT163R2Curve::SecT163R2LookupTable), 32 + sizeof(int) + 8 - (32 + sizeof(int)) % 8> __Org_BouncyCastle_Math_EC_Custom_Sec_SecT163R2Curve_SecT163R2LookupTableSizeCheck;
}
