...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecT113FieldElement New_ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method .ctor addr 0xf74bc0 size 0xb8 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecT113FieldElement New_ctor() ;

/// @brief Method .ctor addr 0xf74c78 size 0x24 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecT113FieldElement New_ctor(::ArrayW<uint64_t> x) ;
