...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT233R1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static SecT233R1Curve* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT233R1Curve").WithContext(".ctor");
