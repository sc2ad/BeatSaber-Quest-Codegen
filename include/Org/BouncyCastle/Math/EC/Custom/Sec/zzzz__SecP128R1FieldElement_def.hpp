...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP128R1FieldElement New_ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method .ctor addr 0xf4920c size 0x118 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecP128R1FieldElement New_ctor() ;

/// @brief Method .ctor addr 0xf4adec size 0x24 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Math::EC::Custom::Sec::SecP128R1FieldElement New_ctor(::ArrayW<uint32_t> x) ;
