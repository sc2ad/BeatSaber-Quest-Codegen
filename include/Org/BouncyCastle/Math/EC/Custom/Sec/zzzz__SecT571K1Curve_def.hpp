...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT571K1Curve__SecT571K1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT571K1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
