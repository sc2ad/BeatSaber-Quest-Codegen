...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP160R2Curve__SecP160R2LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP160R2Curve New_ctor() ;
