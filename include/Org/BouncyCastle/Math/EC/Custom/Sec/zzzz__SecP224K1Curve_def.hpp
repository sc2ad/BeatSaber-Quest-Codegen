...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP224K1Curve__SecP224K1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve New_ctor() ;
