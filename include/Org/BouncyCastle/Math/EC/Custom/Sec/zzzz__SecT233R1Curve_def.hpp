...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT233R1Curve__SecT233R1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
