...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP192K1Curve::SecP192K1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    SecP192K1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve* m_outer_ = {}, ::ArrayWrapper<uint> m_table_ = {}, int m_size_ = {}) noexcept : m_outer{m_outer_}, m_table{m_table_}, m_size{m_size_} {}
    ...
    static SecP192K1Curve::SecP192K1LookupTable* New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve* outer, ::ArrayWrapper<uint> table, int size) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve::SecP192K1LookupTable::*)(::ArrayWrapper<uint>, ::ArrayWrapper<uint>)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve::SecP192K1LookupTable::CreatePoint)> {
