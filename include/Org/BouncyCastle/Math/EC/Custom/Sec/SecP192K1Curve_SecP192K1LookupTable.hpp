...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve::SecP192K1LookupTable);
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP192K1Curve::SecP192K1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve*& dyn_m_outer();
    ...
    static SecP192K1Curve::SecP192K1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve* outer, ::ArrayW<uint> table, int size) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve::SecP192K1LookupTable::*)(::ArrayW<uint>, ::ArrayW<uint>)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve::SecP192K1LookupTable::CreatePoint)> {
