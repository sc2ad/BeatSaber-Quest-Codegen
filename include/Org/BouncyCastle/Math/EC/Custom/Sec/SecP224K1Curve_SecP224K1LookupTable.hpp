...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve::SecP224K1LookupTable);
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP224K1Curve::SecP224K1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve*& dyn_m_outer();
