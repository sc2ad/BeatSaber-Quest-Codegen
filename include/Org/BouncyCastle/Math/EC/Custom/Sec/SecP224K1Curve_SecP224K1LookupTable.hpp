...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP224K1Curve::SecP224K1LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    SecP224K1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecP224K1Curve* m_outer_ = {}, ::ArrayWrapper<uint> m_table_ = {}, int m_size_ = {}) noexcept : m_outer{m_outer_}, m_table{m_table_}, m_size{m_size_} {}
