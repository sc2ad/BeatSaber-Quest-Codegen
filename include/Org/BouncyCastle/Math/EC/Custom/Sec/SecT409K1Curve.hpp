...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  // Forward declaring type: SecT409K1Curve
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT409K1Curve : public ::Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static ::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SECT409K1_AFFINE_ZS();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve::*)(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
