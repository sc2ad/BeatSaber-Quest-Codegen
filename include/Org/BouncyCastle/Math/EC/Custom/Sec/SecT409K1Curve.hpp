...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT409K1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static SecT409K1Curve* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecT409K1Curve").WithContext(".ctor");
