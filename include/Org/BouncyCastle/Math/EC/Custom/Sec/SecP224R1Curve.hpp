...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP224R1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static ::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SECP224R1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SECP224R1_AFFINE_ZS
    static void _set_SECP224R1_AFFINE_ZS(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> value);
    // Get instance field reference: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecP224R1Point m_infinity
    Org::BouncyCastle::Math::EC::Custom::Sec::SecP224R1Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecP224R1Curve::*)(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecP224R1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
