...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP224R1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static SecP224R1Curve* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP224R1Curve").WithContext(".ctor");
