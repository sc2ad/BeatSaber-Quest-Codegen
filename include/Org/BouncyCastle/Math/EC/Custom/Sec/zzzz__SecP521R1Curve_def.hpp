...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecP521R1Curve__SecP521R1LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecP521R1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
