...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT131R2Curve__SecT131R2LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
