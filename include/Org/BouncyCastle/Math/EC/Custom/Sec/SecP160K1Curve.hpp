...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecP160K1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static SecP160K1Curve* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Math::EC::Custom::Sec").WithContext("SecP160K1Curve").WithContext(".ctor");
