...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  check_size<sizeof(SecP384R1Curve::SecP384R1LookupTable), 32 + sizeof(int) + 8 - (32 + sizeof(int)) % 8> __Org_BouncyCastle_Math_EC_Custom_Sec_SecP384R1Curve_SecP384R1LookupTableSizeCheck;
}
