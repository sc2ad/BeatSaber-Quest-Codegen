...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT163R1Curve__SecT163R1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R1Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R1Curve New_ctor() ;
