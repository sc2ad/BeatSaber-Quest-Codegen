...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  // Forward declaring type: SecT233K1Curve
...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT233K1Curve : public ::Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    static void _set_SECT233K1_AFFINE_ZS(::ArrayW<::Org::BouncyCastle::Math::EC::ECFieldElement*> value);
    // Get instance field reference: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecT233K1Point m_infinity
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Point*& dyn_m_infinity();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve::*)(::ArrayW<::Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
