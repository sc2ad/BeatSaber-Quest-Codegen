...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
  ...
  class SecT233K1Curve : public Org::BouncyCastle::Math::EC::AbstractF2mCurve {
    ...
    Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Point* _get_m_infinity();
    // Set instance field: protected readonly Org.BouncyCastle.Math.EC.Custom.Sec.SecT233K1Point m_infinity
    void _set_m_infinity(Org::BouncyCastle::Math::EC::Custom::Sec::SecT233K1Point* value);
