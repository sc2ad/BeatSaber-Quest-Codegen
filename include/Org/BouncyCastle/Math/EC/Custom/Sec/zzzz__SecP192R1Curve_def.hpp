...
static Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecP192R1Curve__SecP192R1LookupTable New_ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
static Org::BouncyCastle::Math::EC::Custom::Sec::SecP192R1Curve New_ctor() ;
