...
namespace Org::BouncyCastle::Math::EC::Custom::GM {
class ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable(____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable(____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable(void* ptr) noexcept : ::Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable& operator=(____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable(::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;
...
public:
// Declarations
using SM2P256V1LookupTable = ::Org::BouncyCastle::Math::EC::Custom::GM::____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable;
...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::GM::____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Math::EC::Custom::GM::____Org__BouncyCastle__Math__EC__Custom__GM__SM2P256V1Curve__SM2P256V1LookupTable, "Org.BouncyCastle.Math.EC.Custom.GM", "SM2P256V1Curve/SM2P256V1LookupTable");
