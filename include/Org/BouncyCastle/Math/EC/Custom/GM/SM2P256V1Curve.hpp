...
namespace Org::BouncyCastle::Math::EC::Custom::GM {
  ...
  class SM2P256V1Curve : public Org::BouncyCastle::Math::EC::AbstractFpCurve {
    ...
    static ::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> _get_SM2P256V1_AFFINE_ZS();
    // Set static field: static private readonly Org.BouncyCastle.Math.EC.ECFieldElement[] SM2P256V1_AFFINE_ZS
    static void _set_SM2P256V1_AFFINE_ZS(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECFieldElement*> value);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::ECLookupTable* (Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::*)(::ArrayWrapper<Org::BouncyCastle::Math::EC::ECPoint*>, int, int)>(&Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::CreateCacheSafeLookupTable)> {
  static const MethodInfo* get() {
