...
NEED_NO_BOX(::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable);
...
namespace Org::BouncyCastle::Math::EC::Custom::GM {
  ...
  class SM2P256V1Curve::SM2P256V1LookupTable : public ::Org::BouncyCastle::Math::EC::AbstractECLookupTable {
    ...
    [[deprecated("Use field access instead!")]] ::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve*& dyn_m_outer();
    ...
    static SM2P256V1Curve::SM2P256V1LookupTable* New_ctor(::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve* outer, ::ArrayW<uint> table, int size) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Math::EC::ECPoint* (Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::*)(::ArrayW<uint>, ::ArrayW<uint>)>(&Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve::SM2P256V1LookupTable::CreatePoint)> {
