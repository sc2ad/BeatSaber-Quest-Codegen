...
namespace Org::BouncyCastle::Math::EC::Custom::GM {
  ...
  check_size<sizeof(SM2P256V1Curve::SM2P256V1LookupTable), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Math_EC_Custom_GM_SM2P256V1Curve_SM2P256V1LookupTableSizeCheck;
}
