...
/// @brief Method Copy64 addr 0x1001628 size 0xdc virtual false final false
static void Copy64(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method Copy64 addr 0x1001704 size 0x164 virtual false final false
static void Copy64(::ArrayW<uint64_t> x, int32_t xOff, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method Create64 addr 0x1001868 size 0x44 virtual false final false
static ::ArrayW<uint64_t> Create64() ;

/// @brief Method CreateExt64 addr 0x10018ac size 0x44 virtual false final false
static ::ArrayW<uint64_t> CreateExt64() ;

/// @brief Method Eq64 addr 0x10018f0 size 0x68 virtual false final false
...
/// @brief Method IsZero64 addr 0x1001a8c size 0x4c virtual false final false
...
static Org::BouncyCastle::Math::Raw::Nat448 New_ctor() ;

/// @brief Method .ctor addr 0x1001bb8 size 0x8 virtual false final false
 void _ctor() ;
