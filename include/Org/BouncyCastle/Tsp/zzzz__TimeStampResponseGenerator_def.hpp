...
namespace Org::BouncyCastle::Tsp {
class ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo;
}
// Type: ::FailInfo
namespace Org::BouncyCastle::Tsp {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo : public ::Org::BouncyCastle::Asn1::DerBitString {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo(____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo(____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo(void* ptr) noexcept : ::Org::BouncyCastle::Asn1::DerBitString(ptr) {
}


  constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo& operator=(____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo& operator=(____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo(int32_t failInfoValue) ;
...
public:
// Declarations
using FailInfo = ::Org::BouncyCastle::Tsp::____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo;
...
NEED_NO_BOX(::Org::BouncyCastle::Tsp::____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Tsp::____Org__BouncyCastle__Tsp__TimeStampResponseGenerator__FailInfo, "Org.BouncyCastle.Tsp", "TimeStampResponseGenerator/FailInfo");
