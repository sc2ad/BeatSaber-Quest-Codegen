...
class CORDL_TYPE Org__BouncyCastle__Tsp__TimeStampToken__CertID : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~Org__BouncyCastle__Tsp__TimeStampToken__CertID() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Tsp__TimeStampToken__CertID", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID(Org__BouncyCastle__Tsp__TimeStampToken__CertID const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Tsp__TimeStampToken__CertID", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID(Org__BouncyCastle__Tsp__TimeStampToken__CertID&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Tsp__TimeStampToken__CertID(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID& operator=(Org__BouncyCastle__Tsp__TimeStampToken__CertID&& o) noexcept = default;
  constexpr Org__BouncyCastle__Tsp__TimeStampToken__CertID& operator=(Org__BouncyCastle__Tsp__TimeStampToken__CertID const& o) noexcept = default;
...
public:
// Declarations
using CertID = Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID;
...
constexpr Org::BouncyCastle::Tsp::TimeStampTokenInfo __get_tstInfo() const;
 ...
 Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID __declspec(property(get=__get_certID, put=__set_certID))  certID;

constexpr void __set_certID(Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID value) ;

constexpr Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID __get_certID() const;
...
NEED_NO_BOX(Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Tsp::Org__BouncyCastle__Tsp__TimeStampToken__CertID, "Org.BouncyCastle.Tsp", "TimeStampToken/CertID");
