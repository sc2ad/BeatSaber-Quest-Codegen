...
namespace Org::BouncyCastle::Cms {
class Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf;
}
namespace Org::BouncyCastle::Cms {
...
class CORDL_TYPE Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x50};

virtual ~Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf(Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf(Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf& operator=(Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf&& o) noexcept = default;
  constexpr Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf& operator=(Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf const& o) noexcept = default;
...
static Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf New_ctor(Org::BouncyCastle::Cms::CmsSignedGenerator outer, Org::BouncyCastle::Crypto::ISignatureFactory sigCalc, Org::BouncyCastle::Asn1::Cms::SignerIdentifier signerIdentifier, Org::BouncyCastle::Cms::CmsAttributeTableGenerator sAttr, Org::BouncyCastle::Cms::CmsAttributeTableGenerator unsAttr, Org::BouncyCastle::Asn1::Cms::AttributeTable baseSignedTable) ;
...
public:
// Declarations
using SignerInf = Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf;
...
static Org::BouncyCastle::Cms::CmsSignedDataGenerator New_ctor() ;

/// @brief Method .ctor addr 0x115e914 size 0x84 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Cms::CmsSignedDataGenerator New_ctor(Org::BouncyCastle::Security::SecureRandom rand) ;
...
NEED_NO_BOX(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataGenerator__SignerInf, "Org.BouncyCastle.Cms", "CmsSignedDataGenerator/SignerInf");
