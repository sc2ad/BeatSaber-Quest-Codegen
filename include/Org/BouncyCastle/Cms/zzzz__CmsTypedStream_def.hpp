...
class CORDL_TYPE Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream : public Org::BouncyCastle::Utilities::IO::FilterStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream(Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream(Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream(void* ptr) noexcept : Org::BouncyCastle::Utilities::IO::FilterStream(ptr) {
}


  constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream& operator=(Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream&& o) noexcept = default;
  constexpr Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream& operator=(Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream const& o) noexcept = default;
...
public:
// Declarations
using FullReaderStream = Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream;
...
NEED_NO_BOX(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsTypedStream__FullReaderStream, "Org.BouncyCastle.Cms", "CmsTypedStream/FullReaderStream");
