...
class CORDL_TYPE Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder&& o) noexcept = default;
  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder const& o) noexcept = default;
...
class CORDL_TYPE Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl&& o) noexcept = default;
  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl const& o) noexcept = default;
...
class CORDL_TYPE Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream : public Org::BouncyCastle::Utilities::IO::BaseOutputStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x60};

virtual ~Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream(void* ptr) noexcept : Org::BouncyCastle::Utilities::IO::BaseOutputStream(ptr) {
}


  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream&& o) noexcept = default;
  constexpr Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream& operator=(Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream const& o) noexcept = default;
...
public:
// Declarations
using CmsSignedDataOutputStream = Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream;

using SignerInfoGeneratorImpl = Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl;

using DigestAndSignerInfoGeneratorHolder = Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder;
...
NEED_NO_BOX(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__CmsSignedDataOutputStream, "Org.BouncyCastle.Cms", "CmsSignedDataStreamGenerator/CmsSignedDataOutputStream");
NEED_NO_BOX(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__DigestAndSignerInfoGeneratorHolder, "Org.BouncyCastle.Cms", "CmsSignedDataStreamGenerator/DigestAndSignerInfoGeneratorHolder");
NEED_NO_BOX(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Cms::Org__BouncyCastle__Cms__CmsSignedDataStreamGenerator__SignerInfoGeneratorImpl, "Org.BouncyCastle.Cms", "CmsSignedDataStreamGenerator/SignerInfoGeneratorImpl");
