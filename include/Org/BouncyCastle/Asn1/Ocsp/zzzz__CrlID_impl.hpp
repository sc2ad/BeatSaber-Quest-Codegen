...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::DerGeneralizedTime, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Asn1::Ocsp::CrlID Org::BouncyCastle::Asn1::Ocsp::CrlID::New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq)  {
Org::BouncyCastle::Asn1::Ocsp::CrlID o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Asn1::Ocsp::CrlID>(seq))};
return o;
}
