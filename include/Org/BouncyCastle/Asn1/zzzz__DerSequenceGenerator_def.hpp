...
static Org::BouncyCastle::Asn1::DerSequenceGenerator New_ctor(System::IO::Stream outStream) ;

/// @brief Method .ctor addr 0x1138b64 size 0x80 virtual false final false
 void _ctor(System::IO::Stream outStream) ;

static Org::BouncyCastle::Asn1::DerSequenceGenerator New_ctor(System::IO::Stream outStream, int32_t tagNo, bool isExplicit) ;
