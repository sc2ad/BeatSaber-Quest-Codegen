...
struct CORDL_TYPE Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice(int32_t value__) noexcept;


                    constexpr Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice(Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice const&) = default;
                    constexpr Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice(Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice&&) = default;
                    constexpr Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice& operator=(Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice& operator=(Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice&& o) noexcept {
...
constexpr explicit Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice_Unwrapped : int32_t {
__Certificate = -1,
...
static Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice const Certificate;

/// @brief Field PublicKeyCertificate offset 0
static Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice const PublicKeyCertificate;

/// @brief Field AttributeCertificate offset 0
static Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice const AttributeCertificate;
...
public:
// Declarations
using Choice = Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice;
...
// Properties
 ...
 Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice __declspec(property(get=get_Type))  Type;
...
/// @brief Method get_Type addr 0xee8410 size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice get_Type() ;
...
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Asn1::IsisMtt::Ocsp::Org__BouncyCastle__Asn1__IsisMtt__Ocsp__RequestedCertificate__Choice, "Org.BouncyCastle.Asn1.IsisMtt.Ocsp", "RequestedCertificate/Choice");
