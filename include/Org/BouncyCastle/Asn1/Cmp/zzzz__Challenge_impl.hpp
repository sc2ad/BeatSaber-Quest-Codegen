...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::Asn1OctetString, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Asn1::Cmp::Challenge Org::BouncyCastle::Asn1::Cmp::Challenge::New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq)  {
Org::BouncyCastle::Asn1::Cmp::Challenge o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Asn1::Cmp::Challenge>(seq))};
return o;
}
