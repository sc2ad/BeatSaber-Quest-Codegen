...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::Asn1Sequence, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent::New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq)  {
Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Asn1::Cmp::PopoDecKeyChallContent>(seq))};
return o;
}
