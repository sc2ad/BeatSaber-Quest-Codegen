...
explicit ElGamalParameter(::Org::BouncyCastle::Math::BigInteger p, ::Org::BouncyCastle::Math::BigInteger g) ;
...
explicit ElGamalParameter(::Org::BouncyCastle::Asn1::Asn1Sequence seq) ;
