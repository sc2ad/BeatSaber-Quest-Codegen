...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::X509::GeneralName, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Asn1::Crmf::SinglePubInfo Org::BouncyCastle::Asn1::Crmf::SinglePubInfo::New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq)  {
Org::BouncyCastle::Asn1::Crmf::SinglePubInfo o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Asn1::Crmf::SinglePubInfo>(seq))};
return o;
}
