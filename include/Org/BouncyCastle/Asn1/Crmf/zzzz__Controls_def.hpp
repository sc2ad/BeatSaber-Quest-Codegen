...
static Org::BouncyCastle::Asn1::Crmf::Controls New_ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;
...
static Org::BouncyCastle::Asn1::Crmf::Controls New_ctor(::ArrayW<Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue> atvs) ;
