...
static Org::BouncyCastle::Asn1::BerSequenceGenerator New_ctor(System::IO::Stream outStream) ;

/// @brief Method .ctor addr 0x11331a8 size 0x34 virtual false final false
 void _ctor(System::IO::Stream outStream) ;

static Org::BouncyCastle::Asn1::BerSequenceGenerator New_ctor(System::IO::Stream outStream, int32_t tagNo, bool isExplicit) ;
