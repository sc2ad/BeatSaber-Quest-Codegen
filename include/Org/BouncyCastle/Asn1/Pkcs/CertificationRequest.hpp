...
namespace Org::BouncyCastle::Asn1::Pkcs {
  ...
  check_size<sizeof(CertificationRequest), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_Pkcs_CertificationRequestSizeCheck;
}
