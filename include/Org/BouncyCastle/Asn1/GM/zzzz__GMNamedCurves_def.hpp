...
/// @brief Method CreateParameters addr 0xe0f188 size 0x1d4 virtual true final false
...
/// @brief Method CreateParameters addr 0xe0f3c8 size 0x1d4 virtual true final false
 Org::BouncyCastle::Asn1::X9::X9ECParameters CreateParameters() ;
...
/// @brief Method ConfigureBasepoint addr 0xe0e750 size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECPoint ConfigureBasepoint(Org::BouncyCastle::Math::EC::ECCurve curve, ::StringW encoding) ;

/// @brief Method ConfigureCurve addr 0xe0e840 size 0x4 virtual false final false
static Org::BouncyCastle::Math::EC::ECCurve ConfigureCurve(Org::BouncyCastle::Math::EC::ECCurve curve) ;

/// @brief Method FromHex addr 0xe0e844 size 0xa0 virtual false final false
static Org::BouncyCastle::Math::BigInteger FromHex(::StringW hex) ;

/// @brief Method DefineCurve addr 0xe0e8e4 size 0x210 virtual false final false
...
/// @brief Method GetByName addr 0xe0ec74 size 0x80 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByName(::StringW name) ;

/// @brief Method GetByOid addr 0xe0ee48 size 0x12c virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetOid addr 0xe0ecf4 size 0x154 virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetOid(::StringW name) ;

/// @brief Method GetName addr 0xe0ef74 size 0x100 virtual false final false
static ::StringW GetName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Names addr 0xe0f074 size 0x10c virtual false final false
