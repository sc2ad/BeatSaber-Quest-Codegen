...
namespace Org::BouncyCastle::Asn1 {
  ...
  check_size<sizeof(ConstructedOctetStream), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_ConstructedOctetStreamSizeCheck;
}
