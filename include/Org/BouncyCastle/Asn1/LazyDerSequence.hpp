...
namespace Org::BouncyCastle::Asn1 {
  ...
  // [DefaultMemberAttribute] Offset: EC7EE8
  class LazyDerSequence : public Org::BouncyCastle::Asn1::DerSequence {
    ...
    static LazyDerSequence* New_ctor(::ArrayWrapper<uint8_t> encoded) {
  ...
  #pragma pack(pop)
  static check_size<sizeof(LazyDerSequence), 24 + sizeof(::ArrayWrapper<uint8_t>)> __Org_BouncyCastle_Asn1_LazyDerSequenceSizeCheck;
