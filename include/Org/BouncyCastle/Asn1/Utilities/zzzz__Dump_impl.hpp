...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::Utilities::Dump::*)()>(&::Org::BouncyCastle::Asn1::Utilities::Dump::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xff14f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::ArrayW<::StringW>)>(&::Org::BouncyCastle::Asn1::Utilities::Dump::Main)> {
  constexpr static std::size_t size = 0x144;
  constexpr static std::size_t addrs = 0xff14f8;
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void ::Org::BouncyCastle::Asn1::Utilities::Dump::Main(::ArrayW<::StringW> args)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Asn1::Utilities::Dump>::get(),
                            "Main",
                            std::vector<Il2CppClass*>{},
