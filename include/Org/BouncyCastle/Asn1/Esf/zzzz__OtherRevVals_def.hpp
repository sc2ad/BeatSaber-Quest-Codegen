...
explicit OtherRevVals(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;
...
explicit OtherRevVals(Org::BouncyCastle::Asn1::DerObjectIdentifier otherRevValType, Org::BouncyCastle::Asn1::Asn1Encodable otherRevVals) ;
