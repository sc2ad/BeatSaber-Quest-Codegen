...
namespace Org::BouncyCastle::Asn1::X9 {
  ...
  check_size<sizeof(X9ECParametersHolder), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X9_X9ECParametersHolderSizeCheck;
}
