...
namespace Org::BouncyCastle::Asn1 {
  ...
  check_size<sizeof(DefiniteLengthInputStream), 64 + sizeof(int) + ((64 + sizeof(int)) % 8 != 0 ? (8 - (64 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Asn1_DefiniteLengthInputStreamSizeCheck;
}
