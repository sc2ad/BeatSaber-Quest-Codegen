...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(AttributeCertificate), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_AttributeCertificateSizeCheck;
}
