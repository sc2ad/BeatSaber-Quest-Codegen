...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(IssuingDistributionPoint), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_IssuingDistributionPointSizeCheck;
}
