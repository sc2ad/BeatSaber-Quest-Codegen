...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(TbsCertificateList::RevokedCertificatesEnumeration), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_TbsCertificateList_RevokedCertificatesEnumerationSizeCheck;
}
