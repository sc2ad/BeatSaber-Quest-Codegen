...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(RsaPublicKeyStructure), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_RsaPublicKeyStructureSizeCheck;
}
