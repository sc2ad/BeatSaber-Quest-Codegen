...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(AttributeCertificateInfo), 80 + sizeof(void*) + ((80 + sizeof(void*)) % 8 != 0 ? (8 - (80 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_AttributeCertificateInfoSizeCheck;
}
