...
namespace Org::BouncyCastle::Asn1::X509 {
  ...
  check_size<sizeof(TbsCertificateStructure), 104 + sizeof(void*) + ((104 + sizeof(void*)) % 8 != 0 ? (8 - (104 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Asn1_X509_TbsCertificateStructureSizeCheck;
}
