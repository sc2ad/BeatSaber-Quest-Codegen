...
struct CORDL_TYPE Org__BouncyCastle__Asn1__X509__Target__Choice : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Org__BouncyCastle__Asn1__X509__Target__Choice(int32_t value__) noexcept;


                    constexpr Org__BouncyCastle__Asn1__X509__Target__Choice(Org__BouncyCastle__Asn1__X509__Target__Choice const&) = default;
                    constexpr Org__BouncyCastle__Asn1__X509__Target__Choice(Org__BouncyCastle__Asn1__X509__Target__Choice&&) = default;
                    constexpr Org__BouncyCastle__Asn1__X509__Target__Choice& operator=(Org__BouncyCastle__Asn1__X509__Target__Choice const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Org__BouncyCastle__Asn1__X509__Target__Choice& operator=(Org__BouncyCastle__Asn1__X509__Target__Choice&& o) noexcept {
...
constexpr explicit Org__BouncyCastle__Asn1__X509__Target__Choice(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Org__BouncyCastle__Asn1__X509__Target__Choice_Unwrapped : int32_t {
__Name = 0,
__Group = 1,
};
...
static Org::BouncyCastle::Asn1::X509::Org__BouncyCastle__Asn1__X509__Target__Choice const Name;

/// @brief Field Group offset 0
static Org::BouncyCastle::Asn1::X509::Org__BouncyCastle__Asn1__X509__Target__Choice const Group;
...
public:
// Declarations
using Choice = Org::BouncyCastle::Asn1::X509::Org__BouncyCastle__Asn1__X509__Target__Choice;
...
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Asn1::X509::Org__BouncyCastle__Asn1__X509__Target__Choice, "Org.BouncyCastle.Asn1.X509", "Target/Choice");
