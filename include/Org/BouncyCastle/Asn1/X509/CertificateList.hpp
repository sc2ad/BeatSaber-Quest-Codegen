...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (Org::BouncyCastle::Asn1::X509::CertificateList::*)()>(&Org::BouncyCastle::Asn1::X509::CertificateList::GetSignatureOctets)> {
  static const MethodInfo* get() {
