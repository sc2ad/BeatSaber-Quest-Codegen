...
namespace Org::BouncyCastle::OpenSsl {
  ...
  check_size<sizeof(PemUtilities::PemBaseAlg), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_OpenSsl_PemUtilities_PemBaseAlgSizeCheck;
}
