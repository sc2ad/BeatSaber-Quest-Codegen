...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::OpenSsl::PemException::*)(::StringW, System::Exception)>(&Org::BouncyCastle::OpenSsl::PemException::_ctor)> {
 ...
 Org::BouncyCastle::OpenSsl::PemException Org::BouncyCastle::OpenSsl::PemException::New_ctor(::StringW message)  {
Org::BouncyCastle::OpenSsl::PemException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::OpenSsl::PemException>(message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 Org::BouncyCastle::OpenSsl::PemException Org::BouncyCastle::OpenSsl::PemException::New_ctor(::StringW message, System::Exception exception)  {
Org::BouncyCastle::OpenSsl::PemException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::OpenSsl::PemException>(message, exception))};
return o;
}
