...
static Org::BouncyCastle::OpenSsl::PemException New_ctor(::StringW message) ;

/// @brief Method .ctor addr 0x10453e8 size 0x8 virtual false final false
 void _ctor(::StringW message) ;

static Org::BouncyCastle::OpenSsl::PemException New_ctor(::StringW message, System::Exception exception) ;
