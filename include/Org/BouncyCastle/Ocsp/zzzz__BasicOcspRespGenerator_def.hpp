...
namespace Org::BouncyCastle::Ocsp {
class ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject;
}
// Type: ::ResponseObject
namespace Org::BouncyCastle::Ocsp {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject(____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject(____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject& operator=(____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject& operator=(____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject(::Org::BouncyCastle::Ocsp::CertificateID certId, ::Org::BouncyCastle::Ocsp::CertificateStatus certStatus, ::System::DateTime thisUpdate, ::Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;
...
explicit ____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject(::Org::BouncyCastle::Ocsp::CertificateID certId, ::Org::BouncyCastle::Ocsp::CertificateStatus certStatus, ::System::DateTime thisUpdate, ::System::DateTime nextUpdate, ::Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;
...
public:
// Declarations
using ResponseObject = ::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject;
...
NEED_NO_BOX(::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__BasicOcspRespGenerator__ResponseObject, "Org.BouncyCastle.Ocsp", "BasicOcspRespGenerator/ResponseObject");
