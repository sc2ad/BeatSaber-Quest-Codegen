...
namespace Org::BouncyCastle::Ocsp {
class ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject;
}
// Type: ::RequestObject
namespace Org::BouncyCastle::Ocsp {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject(____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject(____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject& operator=(____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject& operator=(____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject const& o) noexcept = default;
...
explicit ____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject(::Org::BouncyCastle::Ocsp::CertificateID certId, ::Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;
...
public:
// Declarations
using RequestObject = ::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject;
...
NEED_NO_BOX(::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Ocsp::____Org__BouncyCastle__Ocsp__OcspReqGenerator__RequestObject, "Org.BouncyCastle.Ocsp", "OcspReqGenerator/RequestObject");
