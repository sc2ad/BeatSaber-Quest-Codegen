...
class CORDL_TYPE Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream : public Org::BouncyCastle::Utilities::IO::BaseInputStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream(Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream(Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream(void* ptr) noexcept : Org::BouncyCastle::Utilities::IO::BaseInputStream(ptr) {
}


  constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream& operator=(Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream&& o) noexcept = default;
  constexpr Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream& operator=(Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream const& o) noexcept = default;
...
public:
// Declarations
using PartialInputStream = Org::BouncyCastle::Bcpg::Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream;
...
NEED_NO_BOX(Org::BouncyCastle::Bcpg::Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Bcpg::Org__BouncyCastle__Bcpg__BcpgInputStream__PartialInputStream, "Org.BouncyCastle.Bcpg", "BcpgInputStream/PartialInputStream");
