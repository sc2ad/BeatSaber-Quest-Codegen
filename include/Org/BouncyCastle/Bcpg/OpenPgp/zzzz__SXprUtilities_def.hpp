...
class CORDL_TYPE Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k : public Org::BouncyCastle::Bcpg::S2k {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x30};

virtual ~Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k(Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k(Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k(void* ptr) noexcept : Org::BouncyCastle::Bcpg::S2k(ptr) {
}


  constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k& operator=(Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k&& o) noexcept = default;
  constexpr Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k& operator=(Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k const& o) noexcept = default;
...
public:
// Declarations
using MyS2k = Org::BouncyCastle::Bcpg::OpenPgp::Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k;
...
NEED_NO_BOX(Org::BouncyCastle::Bcpg::OpenPgp::Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Bcpg::OpenPgp::Org__BouncyCastle__Bcpg__OpenPgp__SXprUtilities__MyS2k, "Org.BouncyCastle.Bcpg.OpenPgp", "SXprUtilities/MyS2k");
