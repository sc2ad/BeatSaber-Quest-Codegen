...
static Org::BouncyCastle::Bcpg::OpenPgp::PgpV3SignatureGenerator New_ctor(Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag keyAlgorithm, Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm) ;
