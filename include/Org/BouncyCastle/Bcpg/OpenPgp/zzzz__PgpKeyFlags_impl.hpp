...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyFlags::*)()>(&::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyFlags::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x102165c;
