...
return ::cordl_internals::RunMethodRethrow<::ArrayW<uint8_t>, false>(nullptr, ___internal_method, t);
 ...
 Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime::New_ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data)  {
Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime>(critical, isLongLength, data))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, critical, isLongLength, data);
 ...
 Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime::New_ctor(bool critical, int64_t seconds)  {
Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime>(critical, seconds))};
return o;
}
