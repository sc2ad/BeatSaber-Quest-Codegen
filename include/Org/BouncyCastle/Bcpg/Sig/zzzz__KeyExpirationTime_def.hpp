...
static Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime New_ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data) ;
...
static Org::BouncyCastle::Bcpg::Sig::KeyExpirationTime New_ctor(bool critical, int64_t seconds) ;
