...
return ::cordl_internals::RunMethodRethrow<::ArrayW<uint8_t>, false>(nullptr, ___internal_method, time);
 ...
 Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime::New_ctor(bool critical, bool isLongLength, ::ArrayW<uint8_t> data)  {
Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime>(critical, isLongLength, data))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, critical, isLongLength, data);
 ...
 Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime::New_ctor(bool critical, System::DateTime date)  {
Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Bcpg::Sig::SignatureCreationTime>(critical, date))};
return o;
}
