...
// Ctor Parameters []
 Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator::ElGamalKeyPairGenerator()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<ElGamalKeyPairGenerator>())) {}
