...
namespace Org::BouncyCastle::Crypto::Generators {
  ...
  check_size<sizeof(Pkcs12ParametersGenerator), 52 + sizeof(int) + ((52 + sizeof(int)) % 8 != 0 ? (8 - (52 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Crypto_Generators_Pkcs12ParametersGeneratorSizeCheck;
}
