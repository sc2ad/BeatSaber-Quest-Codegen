...
namespace Org::BouncyCastle::Crypto::Generators {
  ...
  check_size<sizeof(Pkcs5S2ParametersGenerator), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __Org_BouncyCastle_Crypto_Generators_Pkcs5S2ParametersGeneratorSizeCheck;
}
