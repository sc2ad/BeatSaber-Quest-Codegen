...
namespace Org::BouncyCastle::Crypto::Generators {
  ...
  class DHKeyGeneratorHelper : public ::Il2CppObject {
    ...
    static DHKeyGeneratorHelper* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Generators").WithContext("DHKeyGeneratorHelper").WithContext(".ctor");
