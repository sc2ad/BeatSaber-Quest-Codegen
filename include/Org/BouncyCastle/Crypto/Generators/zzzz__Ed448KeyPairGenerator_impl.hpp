...
// Ctor Parameters []
 Org::BouncyCastle::Crypto::Generators::Ed448KeyPairGenerator::Ed448KeyPairGenerator()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<Ed448KeyPairGenerator>())) {}
