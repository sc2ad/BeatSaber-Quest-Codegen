...
return ::cordl_internals::RunMethodRethrow<Org::BouncyCastle::Math::BigInteger, false>(const_cast<void*>(instance), ___internal_method, bitlength, e);
 ...
 Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator::New_ctor()  {
Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator>())};
return o;
}
