...
// Ctor Parameters []
 Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::DHBasicKeyPairGenerator()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<DHBasicKeyPairGenerator>())) {}
