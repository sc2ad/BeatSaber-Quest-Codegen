...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, keyBytes, ivBytes);
 ...
 Org::BouncyCastle::Crypto::Engines::XSalsa20Engine Org::BouncyCastle::Crypto::Engines::XSalsa20Engine::New_ctor()  {
Org::BouncyCastle::Crypto::Engines::XSalsa20Engine o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Engines::XSalsa20Engine>())};
return o;
}
