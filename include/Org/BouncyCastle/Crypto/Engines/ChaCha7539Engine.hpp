...
namespace Org::BouncyCastle::Crypto::Engines {
  ...
  class ChaCha7539Engine : public Org::BouncyCastle::Crypto::Engines::Salsa20Engine {
    ...
    static ChaCha7539Engine* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Engines").WithContext("ChaCha7539Engine").WithContext(".ctor");
