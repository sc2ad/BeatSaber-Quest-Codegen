...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)()>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::get_AlgorithmName)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0xe67ff4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(::Org::BouncyCastle::Crypto::Engines::VmpcEngine),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)(bool, ::Org::BouncyCastle::Crypto::ICipherParameters)>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::Init)> {
  ...
  constexpr static std::size_t addrs = 0xe68034;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)(::ArrayW<uint8_t>, int32_t, int32_t, ::ArrayW<uint8_t>, int32_t)>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::ProcessBytes)> {
  constexpr static std::size_t size = 0x1c0;
  constexpr static std::size_t addrs = 0xe683c8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)()>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::Reset)> {
  ...
  constexpr static std::size_t addrs = 0xe68588;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint8_t (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)(uint8_t)>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::ReturnByte)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0xe68598;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Engines::VmpcEngine::*)()>(&::Org::BouncyCastle::Crypto::Engines::VmpcEngine::_ctor)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0xe6865c;
...
constexpr  ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::operator ::Org::BouncyCastle::Crypto::IStreamCipher() const noexcept {
...
constexpr uint8_t ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__get_n() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__set_P(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__get_P() const {
...
constexpr uint8_t ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__get_s() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__set_workingIV(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__get_workingIV() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__set_workingKey(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::__get_workingKey() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
 ::StringW ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::get_AlgorithmName()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Engines::VmpcEngine>::get(),
                            "get_AlgorithmName",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, keyBytes, ivBytes);
 ...
 void ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Engines::VmpcEngine>::get(),
                            "ProcessBytes",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 uint8_t ::Org::BouncyCastle::Crypto::Engines::VmpcEngine::ReturnByte(uint8_t input)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Org::BouncyCastle::Crypto::Engines::VmpcEngine>::get(),
                            "ReturnByte",
                            std::vector<Il2CppClass*>{},
