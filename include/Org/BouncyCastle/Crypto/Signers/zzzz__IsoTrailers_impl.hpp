...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::IDictionary (*)()>(&Org::BouncyCastle::Crypto::Signers::IsoTrailers::CreateTrailerMap)> {
  ...
  constexpr static std::size_t addrs = 0xec47f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)(Org::BouncyCastle::Crypto::IDigest)>(&Org::BouncyCastle::Crypto::Signers::IsoTrailers::GetTrailer)> {
  constexpr static std::size_t size = 0x184;
  constexpr static std::size_t addrs = 0xec0edc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(Org::BouncyCastle::Crypto::IDigest)>(&Org::BouncyCastle::Crypto::Signers::IsoTrailers::NoTrailerAvailable)> {
  ...
  constexpr static std::size_t addrs = 0xec0d88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Signers::IsoTrailers::*)()>(&Org::BouncyCastle::Crypto::Signers::IsoTrailers::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xec4eb0;
 ...
 void Org::BouncyCastle::Crypto::Signers::IsoTrailers::__set_trailerMap(System::Collections::IDictionary value)  {
::cordl_internals::setStaticField<System::Collections::IDictionary, "trailerMap", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Signers::IsoTrailers>::get>(std::forward<System::Collections::IDictionary>(value));
}
 System::Collections::IDictionary Org::BouncyCastle::Crypto::Signers::IsoTrailers::__get_trailerMap()  {
return ::cordl_internals::getStaticField<System::Collections::IDictionary, "trailerMap", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Signers::IsoTrailers>::get>();
}
...
return ::cordl_internals::RunMethodRethrow<System::Collections::IDictionary, false>(nullptr, ___internal_method);
 ...
 int32_t Org::BouncyCastle::Crypto::Signers::IsoTrailers::GetTrailer(Org::BouncyCastle::Crypto::IDigest digest)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Signers::IsoTrailers>::get(),
                            "GetTrailer",
                            std::vector<Il2CppClass*>{},
