...
namespace Org::BouncyCastle::Crypto::Signers {
  // Forward declaring type: StandardDsaEncoding
...
// Il2CppName: Encode
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding::*)(::Org::BouncyCastle::Math::BigInteger*, ::Org::BouncyCastle::Math::BigInteger*, ::Org::BouncyCastle::Math::BigInteger*)>(&Org::BouncyCastle::Crypto::Signers::StandardDsaEncoding::Encode)> {
  static const MethodInfo* get() {
