...
class CORDL_TYPE Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer : public System::IO::MemoryStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x50};

virtual ~Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer(Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer(Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer(void* ptr) noexcept : System::IO::MemoryStream(ptr) {
}


  constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer& operator=(Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer&& o) noexcept = default;
  constexpr Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer& operator=(Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer const& o) noexcept = default;
...
public:
// Declarations
using Buffer = Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer;
...
// Fields
 ...
 Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer __declspec(property(get=__get_buffer, put=__set_buffer))  buffer;

constexpr void __set_buffer(Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer value) ;

constexpr Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer __get_buffer() const;
...
NEED_NO_BOX(Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Crypto::Signers::Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer, "Org.BouncyCastle.Crypto.Signers", "Ed25519ctxSigner/Buffer");
