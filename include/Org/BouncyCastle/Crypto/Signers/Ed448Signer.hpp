...
namespace Org::BouncyCastle::Crypto::Signers {
  ...
  class Ed448Signer : public ::Il2CppObject/*, public Org::BouncyCastle::Crypto::ISigner*/ {
    ...
    Ed448Signer(Org::BouncyCastle::Crypto::Signers::Ed448Signer::Buffer* buffer_ = {}, ::ArrayWrapper<uint8_t> context_ = {}, bool forSigning_ = {}, Org::BouncyCastle::Crypto::Parameters::Ed448PrivateKeyParameters* privateKey_ = {}, Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters* publicKey_ = {}) noexcept : buffer{buffer_}, context{context_}, forSigning{forSigning_}, privateKey{privateKey_}, publicKey{publicKey_} {}
    ...
    static Ed448Signer* New_ctor(::ArrayWrapper<uint8_t> context) {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Signers::Ed448Signer::*)(::ArrayWrapper<uint8_t>, int, int)>(&Org::BouncyCastle::Crypto::Signers::Ed448Signer::BlockUpdate)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (Org::BouncyCastle::Crypto::Signers::Ed448Signer::*)()>(&Org::BouncyCastle::Crypto::Signers::Ed448Signer::GenerateSignature)> {
  static const MethodInfo* get() {
