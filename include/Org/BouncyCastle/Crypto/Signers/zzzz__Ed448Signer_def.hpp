...
namespace Org::BouncyCastle::Crypto::Signers {
class ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer;
}
// Type: ::Buffer
namespace Org::BouncyCastle::Crypto::Signers {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer : public ::System::IO::MemoryStream {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x50};

virtual ~____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer(____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer(____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer(void* ptr) noexcept : ::System::IO::MemoryStream(ptr) {
}


  constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer& operator=(____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer& operator=(____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer() ;
...
public:
// Declarations
using Buffer = ::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer;
...
// Fields
 ...
 ::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer __declspec(property(get=__get_buffer, put=__set_buffer))  buffer;

constexpr void __set_buffer(::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer value) ;

constexpr ::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer __get_buffer() const;
...
NEED_NO_BOX(::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Signers::____Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer, "Org.BouncyCastle.Crypto.Signers", "Ed448Signer/Buffer");
