...
namespace Org::BouncyCastle::Crypto::EC {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: Org.BouncyCastle.Crypto.EC.CustomNamedCurves/Org.BouncyCastle.Crypto.EC.Curve25519Holder
  // [TokenAttribute] Offset: FFFFFFFF
  class CustomNamedCurves::Curve25519Holder : public Org::BouncyCastle::Asn1::X9::X9ECParametersHolder {
    public:
    // Creating value type constructor for type: Curve25519Holder
    Curve25519Holder() noexcept {}
    ...
    static CustomNamedCurves::Curve25519Holder* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Crypto::EC::CustomNamedCurves::Curve25519Holder::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<CustomNamedCurves::Curve25519Holder*, creationType>()));
    }
  ...
  }; // Org.BouncyCastle.Crypto.EC.CustomNamedCurves/Org.BouncyCastle.Crypto.EC.Curve25519Holder
  #pragma pack(pop)
}
