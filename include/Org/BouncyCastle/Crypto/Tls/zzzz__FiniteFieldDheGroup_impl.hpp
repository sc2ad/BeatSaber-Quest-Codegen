...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, group);
 ...
 Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup::New_ctor()  {
Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Tls::FiniteFieldDheGroup>())};
return o;
}
