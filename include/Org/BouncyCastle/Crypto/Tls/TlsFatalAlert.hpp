...
namespace Org::BouncyCastle::Crypto::Tls {
  ...
  check_size<sizeof(TlsFatalAlert), 144 + sizeof(uint8_t) + ((144 + sizeof(uint8_t)) % 8 != 0 ? (8 - (144 + sizeof(uint8_t)) % 8) : 0)> __Org_BouncyCastle_Crypto_Tls_TlsFatalAlertSizeCheck;
}
