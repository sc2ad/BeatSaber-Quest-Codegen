...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::*)(Org::BouncyCastle::Crypto::Tls::TlsContext, Org::BouncyCastle::Crypto::Tls::Certificate, Org::BouncyCastle::Crypto::AsymmetricKeyParameter, Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm)>(&Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::_ctor)> {
  constexpr static std::size_t size = 0x420;
  constexpr static std::size_t addrs = 0xed68d8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Crypto::Tls::Certificate (Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::*)()>(&Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::get_Certificate)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xed6cf8;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials>::get(),
                                  5
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::*)(::ArrayW<uint8_t>)>(&Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::GenerateCertificateSignature)> {
  constexpr static std::size_t size = 0x238;
  constexpr static std::size_t addrs = 0xed6d00;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm (Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::*)()>(&Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::get_SignatureAndHashAlgorithm)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xed6f38;
...
constexpr void Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__set_mContext(Org::BouncyCastle::Crypto::Tls::TlsContext value)  {
...
constexpr Org::BouncyCastle::Crypto::Tls::TlsContext Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__get_mContext() const {
...
constexpr void Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__set_mCertificate(Org::BouncyCastle::Crypto::Tls::Certificate value)  {
...
constexpr Org::BouncyCastle::Crypto::Tls::Certificate Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__get_mCertificate() const {
...
constexpr void Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__set_mPrivateKey(Org::BouncyCastle::Crypto::AsymmetricKeyParameter value)  {
...
constexpr Org::BouncyCastle::Crypto::AsymmetricKeyParameter Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__get_mPrivateKey() const {
...
constexpr void Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__set_mSignatureAndHashAlgorithm(Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm value)  {
::cordl_internals::setInstanceField<Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm>(value));
}
constexpr Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__get_mSignatureAndHashAlgorithm() const {
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::__set_mSigner(Org::BouncyCastle::Crypto::Tls::TlsSigner value)  {
::cordl_internals::setInstanceField<Org::BouncyCastle::Crypto::Tls::TlsSigner, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Org::BouncyCastle::Crypto::Tls::TlsSigner>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, context, certificate, privateKey, signatureAndHashAlgorithm);
}
 Org::BouncyCastle::Crypto::Tls::Certificate Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::get_Certificate()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials>::get(),
                            "get_Certificate",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<Org::BouncyCastle::Crypto::Tls::Certificate, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::ArrayW<uint8_t> Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::GenerateCertificateSignature(::ArrayW<uint8_t> hash)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials>::get(),
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<uint8_t>, false>(const_cast<void*>(instance), ___internal_method, hash);
 ...
 Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials::get_SignatureAndHashAlgorithm()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Tls::DefaultTlsSignerCredentials>::get(),
