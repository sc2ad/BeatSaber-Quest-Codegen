...
namespace Org::BouncyCastle::Crypto::Tls {
class ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState;
}
...
class CORDL_TYPE ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x88};

virtual ~____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState(____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState(____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState& operator=(____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState& operator=(____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState() ;
...
public:
// Declarations
using ServerHandshakeState = ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState;
...
/// @brief Method AbortServerHandshake addr 0xee273c size 0x50 virtual true final false
 void AbortServerHandshake(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer recordLayer, uint8_t alertDescription) ;

/// @brief Method ServerHandshake addr 0xee278c size 0xe18 virtual true final false
 ::Org::BouncyCastle::Crypto::Tls::DtlsTransport ServerHandshake(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer recordLayer) ;

/// @brief Method InvalidateSession addr 0xee35a4 size 0xc4 virtual true final false
 void InvalidateSession(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state) ;

/// @brief Method GenerateCertificateRequest addr 0xee3668 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GenerateCertificateRequest(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method GenerateCertificateStatus addr 0xee36ec size 0x84 virtual true final false
 ::ArrayW<uint8_t> GenerateCertificateStatus(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::CertificateStatus certificateStatus) ;

/// @brief Method GenerateNewSessionTicket addr 0xee3770 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GenerateNewSessionTicket(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::NewSessionTicket newSessionTicket) ;

/// @brief Method GenerateServerHello addr 0xee37f4 size 0x764 virtual true final false
 ::ArrayW<uint8_t> GenerateServerHello(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state) ;

/// @brief Method NotifyClientCertificate addr 0xee3f58 size 0x2e4 virtual true final false
 void NotifyClientCertificate(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::Org::BouncyCastle::Crypto::Tls::Certificate clientCertificate) ;

/// @brief Method ProcessClientCertificate addr 0xee423c size 0xc8 virtual true final false
 void ProcessClientCertificate(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessCertificateVerify addr 0xee4304 size 0x518 virtual true final false
 void ProcessCertificateVerify(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::ArrayW<uint8_t> body, ::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash prepareFinishHash) ;

/// @brief Method ProcessClientHello addr 0xee481c size 0x6b0 virtual true final false
 void ProcessClientHello(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessClientKeyExchange addr 0xee4ecc size 0xf8 virtual true final false
 void ProcessClientKeyExchange(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessClientSupplementalData addr 0xee4fc4 size 0xfc virtual true final false
 void ProcessClientSupplementalData(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ExpectCertificateVerifyMessage addr 0xee50c0 size 0x1078 virtual true final false
 bool ExpectCertificateVerifyMessage(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState state) ;
...
NEED_NO_BOX(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__DtlsServerProtocol__ServerHandshakeState, "Org.BouncyCastle.Crypto.Tls", "DtlsServerProtocol/ServerHandshakeState");
