...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, certChainType);
 ...
 Org::BouncyCastle::Crypto::Tls::CertChainType Org::BouncyCastle::Crypto::Tls::CertChainType::New_ctor()  {
Org::BouncyCastle::Crypto::Tls::CertChainType o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Tls::CertChainType>())};
return o;
}
