...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, maxFragmentLength);
 ...
 Org::BouncyCastle::Crypto::Tls::MaxFragmentLength Org::BouncyCastle::Crypto::Tls::MaxFragmentLength::New_ctor()  {
Org::BouncyCastle::Crypto::Tls::MaxFragmentLength o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Tls::MaxFragmentLength>())};
return o;
}
