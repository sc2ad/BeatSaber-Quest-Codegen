...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, dhParameters, output);
 ...
 Org::BouncyCastle::Crypto::Tls::TlsDHUtilities Org::BouncyCastle::Crypto::Tls::TlsDHUtilities::New_ctor()  {
Org::BouncyCastle::Crypto::Tls::TlsDHUtilities o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Tls::TlsDHUtilities>())};
return o;
}
