...
class CORDL_TYPE ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x48};

virtual ~____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder(____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder(____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder& operator=(____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder& operator=(____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder() ;
...
/// @brief Method SetCipherSuite addr 0xf09308 size 0x8 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetCipherSuite(int32_t cipherSuite) ;

/// @brief Method SetCompressionAlgorithm addr 0xf09310 size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetCompressionAlgorithm(uint8_t compressionAlgorithm) ;

/// @brief Method SetExtendedMasterSecret addr 0xf0931c size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetExtendedMasterSecret(bool extendedMasterSecret) ;

/// @brief Method SetMasterSecret addr 0xf09328 size 0x8 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetMasterSecret(::ArrayW<uint8_t> masterSecret) ;

/// @brief Method SetPeerCertificate addr 0xf09330 size 0x8 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetPeerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate peerCertificate) ;

/// @brief Method SetPskIdentity addr 0xf09338 size 0x8 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetPskIdentity(::ArrayW<uint8_t> pskIdentity) ;

/// @brief Method SetSrpIdentity addr 0xf09340 size 0x8 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetSrpIdentity(::ArrayW<uint8_t> srpIdentity) ;

/// @brief Method SetServerExtensions addr 0xf09348 size 0x94 virtual false final false
 ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder SetServerExtensions(::System::Collections::IDictionary serverExtensions) ;
...
public:
// Declarations
using Builder = ::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder;
...
NEED_NO_BOX(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Tls::____Org__BouncyCastle__Crypto__Tls__SessionParameters__Builder, "Org.BouncyCastle.Crypto.Tls", "SessionParameters/Builder");
