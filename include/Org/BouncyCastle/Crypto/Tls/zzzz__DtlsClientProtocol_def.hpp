...
class Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState;
}
namespace Org::BouncyCastle::Crypto::Tls {
class Certificate;
}
...
class CORDL_TYPE Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x88};

virtual ~Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState(Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState(Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState& operator=(Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState&& o) noexcept = default;
  constexpr Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState& operator=(Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState const& o) noexcept = default;
...
static Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState New_ctor() ;
...
public:
// Declarations
using ClientHandshakeState = Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState;
...
static Org::BouncyCastle::Crypto::Tls::DtlsClientProtocol New_ctor(Org::BouncyCastle::Security::SecureRandom secureRandom) ;
...
/// @brief Method AbortClientHandshake addr 0xeda590 size 0x50 virtual true final false
 void AbortClientHandshake(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer recordLayer, uint8_t alertDescription) ;

/// @brief Method ClientHandshake addr 0xeda5e0 size 0x1390 virtual true final false
 Org::BouncyCastle::Crypto::Tls::DtlsTransport ClientHandshake(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer recordLayer) ;

/// @brief Method GenerateCertificateVerify addr 0xedc3c0 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GenerateCertificateVerify(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, Org::BouncyCastle::Crypto::Tls::DigitallySigned certificateVerify) ;

/// @brief Method GenerateClientHello addr 0xedc444 size 0x5e0 virtual true final false
 ::ArrayW<uint8_t> GenerateClientHello(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, Org::BouncyCastle::Crypto::Tls::TlsClient client) ;

/// @brief Method GenerateClientKeyExchange addr 0xedca24 size 0xec virtual true final false
 ::ArrayW<uint8_t> GenerateClientKeyExchange(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state) ;

/// @brief Method InvalidateSession addr 0xedcb10 size 0xc4 virtual true final false
 void InvalidateSession(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state) ;

/// @brief Method ProcessCertificateRequest addr 0xedcbd4 size 0x14c virtual true final false
 void ProcessCertificateRequest(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessCertificateStatus addr 0xedcd20 size 0xc8 virtual true final false
 void ProcessCertificateStatus(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessHelloVerifyRequest addr 0xedcde8 size 0x18c virtual true final false
 ::ArrayW<uint8_t> ProcessHelloVerifyRequest(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessNewSessionTicket addr 0xedcf74 size 0x108 virtual true final false
 void ProcessNewSessionTicket(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessServerCertificate addr 0xedd07c size 0x224 virtual true final false
 Org::BouncyCastle::Crypto::Tls::Certificate ProcessServerCertificate(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessServerHello addr 0xedd2a0 size 0xca4 virtual true final false
 void ProcessServerHello(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessServerKeyExchange addr 0xeddf44 size 0xf8 virtual true final false
 void ProcessServerKeyExchange(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ProcessServerSupplementalData addr 0xede03c size 0xfc virtual true final false
 void ProcessServerSupplementalData(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, ::ArrayW<uint8_t> body) ;

/// @brief Method ReportServerVersion addr 0xede138 size 0x144 virtual true final false
 void ReportServerVersion(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState state, Org::BouncyCastle::Crypto::Tls::ProtocolVersion server_version) ;
...
NEED_NO_BOX(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsClientProtocol__ClientHandshakeState, "Org.BouncyCastle.Crypto.Tls", "DtlsClientProtocol/ClientHandshakeState");
