...
return Org::BouncyCastle::Crypto::Tls::TlsContext(::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl::New_ctor(Org::BouncyCastle::Security::SecureRandom secureRandom, Org::BouncyCastle::Crypto::Tls::SecurityParameters securityParameters)  {
Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl>(secureRandom, securityParameters))};
return o;
}
