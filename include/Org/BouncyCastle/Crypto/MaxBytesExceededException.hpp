...
namespace Org::BouncyCastle::Crypto {
  ...
  class MaxBytesExceededException : public Org::BouncyCastle::Crypto::CryptoException {
    ...
    static MaxBytesExceededException* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto").WithContext("MaxBytesExceededException").WithContext(".ctor");
