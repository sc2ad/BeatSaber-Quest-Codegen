...
static Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac New_ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method .ctor addr 0xe7e4ac size 0xd0 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

static Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac New_ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding padding) ;

/// @brief Method .ctor addr 0xe7e724 size 0xdc virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding padding) ;

static Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac New_ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t cfbBitSize, int32_t macSizeInBits) ;

/// @brief Method .ctor addr 0xe7e800 size 0x8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t cfbBitSize, int32_t macSizeInBits) ;

static Org::BouncyCastle::Crypto::Macs::CfbBlockCipherMac New_ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t cfbBitSize, int32_t macSizeInBits, Org::BouncyCastle::Crypto::Paddings::IBlockCipherPadding padding) ;

/// @brief Method .ctor addr 0xe7e57c size 0x1a8 virtual false final false
...
/// @brief Method get_AlgorithmName addr 0xe7e808 size 0x18 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe7e820 size 0x34 virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xe7e88c size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xe7e894 size 0x8c virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe7e920 size 0x144 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe7ea64 size 0x164 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe7e854 size 0x38 virtual true final true
 void Reset() ;
