...
namespace Org::BouncyCastle::Crypto::Digests {
  ...
  check_size<sizeof(GeneralDigest), 32 + sizeof(int64_t) + ((32 + sizeof(int64_t)) % 8 != 0 ? (8 - (32 + sizeof(int64_t)) % 8) : 0)> __Org_BouncyCastle_Crypto_Digests_GeneralDigestSizeCheck;
}
