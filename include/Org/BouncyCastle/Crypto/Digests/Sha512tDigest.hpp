...
namespace Org::BouncyCastle::Crypto::Digests {
  ...
  check_size<sizeof(Sha512tDigest), 192 + sizeof(uint64_t) + ((192 + sizeof(uint64_t)) % 8 != 0 ? (8 - (192 + sizeof(uint64_t)) % 8) : 0)> __Org_BouncyCastle_Crypto_Digests_Sha512tDigestSizeCheck;
}
