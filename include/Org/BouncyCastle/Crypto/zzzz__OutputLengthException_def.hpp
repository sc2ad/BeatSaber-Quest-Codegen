...
static Org::BouncyCastle::Crypto::OutputLengthException New_ctor() ;

/// @brief Method .ctor addr 0xf38804 size 0x4 virtual false final false
 void _ctor() ;

static Org::BouncyCastle::Crypto::OutputLengthException New_ctor(::StringW message) ;

/// @brief Method .ctor addr 0xf386a8 size 0x4 virtual false final false
 void _ctor(::StringW message) ;

static Org::BouncyCastle::Crypto::OutputLengthException New_ctor(::StringW message, System::Exception exception) ;
