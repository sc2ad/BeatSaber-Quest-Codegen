...
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator::New_ctor(Org::BouncyCastle::Crypto::IDigest digest)  {
Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Agreement::Kdf::DHKekGenerator>(digest))};
return o;
}
