...
class CORDL_TYPE ISignatureFactory : public ::cordl_internals::InterfaceW {
public:
// Declarations
~ISignatureFactory() = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ISignatureFactory(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
