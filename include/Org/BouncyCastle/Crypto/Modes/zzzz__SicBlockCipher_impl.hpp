...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)(Org::BouncyCastle::Crypto::IBlockCipher)>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::_ctor)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0xe9a888;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Crypto::IBlockCipher (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)()>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::GetUnderlyingCipher)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe9a988;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Org::BouncyCastle::Crypto::Modes::SicBlockCipher),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Modes::SicBlockCipher>::get(),
                                  10
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)(bool, Org::BouncyCastle::Crypto::ICipherParameters)>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::Init)> {
  ...
  constexpr static std::size_t addrs = 0xe9a990;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)()>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::get_AlgorithmName)> {
  ...
  constexpr static std::size_t addrs = 0xe9ac78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)()>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::get_IsPartialBlockOkay)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe9ad38;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)()>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::GetBlockSize)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0xe9ad40;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)(::ArrayW<uint8_t>, int32_t, ::ArrayW<uint8_t>, int32_t)>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::ProcessBlock)> {
  constexpr static std::size_t size = 0x1bc;
  constexpr static std::size_t addrs = 0xe9ade4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Modes::SicBlockCipher::*)()>(&Org::BouncyCastle::Crypto::Modes::SicBlockCipher::Reset)> {
  ...
  constexpr static std::size_t addrs = 0xe9afa0;
...
constexpr  Org::BouncyCastle::Crypto::Modes::SicBlockCipher::operator Org::BouncyCastle::Crypto::IBlockCipher() const noexcept {
...
constexpr Org::BouncyCastle::Crypto::IBlockCipher Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__get_cipher() const {
...
constexpr int32_t Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__get_blockSize() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__set_counter(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__get_counter() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__set_counterOut(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__get_counterOut() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__set_IV(::ArrayW<uint8_t> value)  {
...
constexpr ::ArrayW<uint8_t> Org::BouncyCastle::Crypto::Modes::SicBlockCipher::__get_IV() const {
...
// Ctor Parameters [CppParam { name: "cipher", ty: "Org::BouncyCastle::Crypto::IBlockCipher", modifiers: "", def_value: None }]
 Org::BouncyCastle::Crypto::Modes::SicBlockCipher::SicBlockCipher(Org::BouncyCastle::Crypto::IBlockCipher cipher)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<SicBlockCipher>(cipher))) {}
 void Org::BouncyCastle::Crypto::Modes::SicBlockCipher::_ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Modes::SicBlockCipher>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t Org::BouncyCastle::Crypto::Modes::SicBlockCipher::GetBlockSize()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Modes::SicBlockCipher>::get(),
                            "GetBlockSize",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t Org::BouncyCastle::Crypto::Modes::SicBlockCipher::ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Modes::SicBlockCipher>::get(),
                            "ProcessBlock",
                            std::vector<Il2CppClass*>{},
