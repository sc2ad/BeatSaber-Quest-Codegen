...
constexpr Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag(uint8_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::__set_value__(uint8_t value)  {
::cordl_internals::setInstanceField<uint8_t, 0x0>(this->__instance, std::forward<uint8_t>(value));
}
constexpr uint8_t Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::__get_value__() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->__instance);
}
constexpr Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag  Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::N{0u};
constexpr Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag  Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::H{1u};
constexpr Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag  Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__EaxBlockCipher__Tag::C{2u};
...
Org::BouncyCastle::Crypto::Modes::EaxBlockCipher o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Modes::EaxBlockCipher>(cipher))};
return o;
}
