...
namespace Org::BouncyCastle::Crypto::Modes {
  ...
  class ChaCha20Poly1305 : public ::Il2CppObject/*, public Org::BouncyCastle::Crypto::Modes::IAeadCipher*/ {
    ...
    check_size<sizeof(ChaCha20Poly1305::State), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Crypto_Modes_ChaCha20Poly1305_StateSizeCheck;
  ...
  check_size<sizeof(ChaCha20Poly1305), 92 + sizeof(int) + ((92 + sizeof(int)) % 8 != 0 ? (8 - (92 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Crypto_Modes_ChaCha20Poly1305SizeCheck;
}
