...
/// @brief Method get_PaddingName addr 0xea2390 size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method Init addr 0xea23d0 size 0x4 virtual true final true
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method AddPadding addr 0xea23d4 size 0x48 virtual true final true
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xea241c size 0x54 virtual true final true
 int32_t PadCount(::ArrayW<uint8_t> input) ;

static Org::BouncyCastle::Crypto::Paddings::ZeroBytePadding New_ctor() ;

/// @brief Method .ctor addr 0xea2470 size 0x8 virtual false final false
 void _ctor() ;
