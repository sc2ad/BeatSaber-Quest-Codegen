...
namespace Org::BouncyCastle::Crypto::Paddings {
  ...
  check_size<sizeof(ISO10126d2Padding), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_Paddings_ISO10126d2PaddingSizeCheck;
}
