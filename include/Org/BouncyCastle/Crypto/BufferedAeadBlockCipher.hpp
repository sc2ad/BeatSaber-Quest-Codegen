...
namespace Org::BouncyCastle::Crypto {
  ...
  check_size<sizeof(BufferedAeadBlockCipher), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_BufferedAeadBlockCipherSizeCheck;
}
