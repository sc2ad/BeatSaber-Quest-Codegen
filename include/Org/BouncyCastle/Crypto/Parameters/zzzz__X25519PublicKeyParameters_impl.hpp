...
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters::New_ctor(::ArrayW<uint8_t> buf, int32_t off)  {
Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters>(buf, off))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, buf, off);
 ...
 Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters::New_ctor(System::IO::Stream input)  {
Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters>(input))};
return o;
}
