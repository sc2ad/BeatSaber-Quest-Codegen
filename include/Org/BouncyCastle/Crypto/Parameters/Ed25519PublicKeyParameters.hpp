...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(Ed25519PublicKeyParameters), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Org_BouncyCastle_Crypto_Parameters_Ed25519PublicKeyParametersSizeCheck;
}
