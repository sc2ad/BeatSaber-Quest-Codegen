...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(ECPrivateKeyParameters), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_ECPrivateKeyParametersSizeCheck;
}
