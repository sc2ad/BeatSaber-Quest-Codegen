...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class ParametersWithSBox : public ::Il2CppObject/*, public Org::BouncyCastle::Crypto::ICipherParameters*/ {
    ...
    static ParametersWithSBox* New_ctor(Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayWrapper<uint8_t> sBox) {
    ...
    // Offset: 0x1397310
    ::ArrayWrapper<uint8_t> GetSBox();
  }; // Org.BouncyCastle.Crypto.Parameters.ParametersWithSBox
  #pragma pack(pop)
  static check_size<sizeof(ParametersWithSBox), 24 + sizeof(::ArrayWrapper<uint8_t>)> __Org_BouncyCastle_Crypto_Parameters_ParametersWithSBoxSizeCheck;
...
// Il2CppName: GetSBox
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox::*)()>(&Org::BouncyCastle::Crypto::Parameters::ParametersWithSBox::GetSBox)> {
  static const MethodInfo* get() {
