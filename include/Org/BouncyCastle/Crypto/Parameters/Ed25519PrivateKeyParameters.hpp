...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class Ed25519PrivateKeyParameters : public Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    ...
    static Ed25519PrivateKeyParameters* New_ctor(::Array<uint8_t>* buf, int off) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Parameters").WithContext("Ed25519PrivateKeyParameters").WithContext(".ctor");
