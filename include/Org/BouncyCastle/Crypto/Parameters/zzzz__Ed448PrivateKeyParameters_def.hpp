...
/// @brief Method Sign addr 0xea7f74 size 0x20 virtual false final false
 void Sign(::Org::BouncyCastle::Math::EC::Rfc8032::____Org__BouncyCastle__Math__EC__Rfc8032__Ed448__Algorithm algorithm, ::Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters publicKey, ::ArrayW<uint8_t> ctx, ::ArrayW<uint8_t> msg, int32_t msgOff, int32_t msgLen, ::ArrayW<uint8_t> sig, int32_t sigOff) ;

/// @brief Method Sign addr 0xea7f94 size 0x22c virtual false final false
 void Sign(::Org::BouncyCastle::Math::EC::Rfc8032::____Org__BouncyCastle__Math__EC__Rfc8032__Ed448__Algorithm algorithm, ::ArrayW<uint8_t> ctx, ::ArrayW<uint8_t> msg, int32_t msgOff, int32_t msgLen, ::ArrayW<uint8_t> sig, int32_t sigOff) ;
