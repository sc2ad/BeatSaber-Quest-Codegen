...
static Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters New_ctor(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method .ctor addr 0xeadbc4 size 0xbc virtual false final false
 void _ctor(::ArrayW<uint8_t> buf, int32_t off) ;

static Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters New_ctor(System::IO::Stream input) ;

/// @brief Method .ctor addr 0xeade44 size 0x108 virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xeadd74 size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xeadf4c size 0x5c virtual false final false
