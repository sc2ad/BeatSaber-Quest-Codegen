...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class Ed448PublicKeyParameters : public Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    ...
    static Ed448PublicKeyParameters* New_ctor(::Array<uint8_t>* buf, int off) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Org::BouncyCastle::Crypto::Parameters").WithContext("Ed448PublicKeyParameters").WithContext(".ctor");
