...
// Ctor Parameters [CppParam { name: "buf", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "off", ty: "int32_t", modifiers: "", def_value: None }]
 Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters::Ed448PublicKeyParameters(::ArrayW<uint8_t> buf, int32_t off)  : Org::BouncyCastle::Crypto::AsymmetricKeyParameter(THROW_UNLESS(::il2cpp_utils::New<Ed448PublicKeyParameters>(buf, off))) {}
...
// Ctor Parameters [CppParam { name: "input", ty: "System::IO::Stream", modifiers: "", def_value: None }]
 Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters::Ed448PublicKeyParameters(System::IO::Stream input)  : Org::BouncyCastle::Crypto::AsymmetricKeyParameter(THROW_UNLESS(::il2cpp_utils::New<Ed448PublicKeyParameters>(input))) {}
