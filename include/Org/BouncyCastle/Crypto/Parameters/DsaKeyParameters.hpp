...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(DsaKeyParameters), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_DsaKeyParametersSizeCheck;
}
