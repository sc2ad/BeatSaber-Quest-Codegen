...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class X448PublicKeyParameters : public Org::BouncyCastle::Crypto::AsymmetricKeyParameter {
    ...
    static X448PublicKeyParameters* New_ctor(::ArrayWrapper<uint8_t> buf, int off) {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X448PublicKeyParameters), 24 + sizeof(::ArrayWrapper<uint8_t>)> __Org_BouncyCastle_Crypto_Parameters_X448PublicKeyParametersSizeCheck;
