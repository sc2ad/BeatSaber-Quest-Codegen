...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class DesEdeParameters : public Org::BouncyCastle::Crypto::Parameters::DesParameters {
    ...
    // Offset: 0x1392DA8
    static bool IsWeakKey(::ArrayWrapper<uint8_t> key, int offset, int length);
    ...
    static DesEdeParameters* New_ctor(::ArrayWrapper<uint8_t> key, int keyOff, int keyLen) {
...
// Il2CppName: FixKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (*)(::ArrayWrapper<uint8_t>, int, int)>(&Org::BouncyCastle::Crypto::Parameters::DesEdeParameters::FixKey)> {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ArrayWrapper<uint8_t>, int, int)>(&Org::BouncyCastle::Crypto::Parameters::DesEdeParameters::IsWeakKey)> {
  static const MethodInfo* get() {
    static auto* key = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "Byte")), 1)->byval_arg;
...
// Il2CppName: IsWeakKey
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ArrayWrapper<uint8_t>)>(&Org::BouncyCastle::Crypto::Parameters::DesEdeParameters::IsWeakKey)> {
  static const MethodInfo* get() {
    static auto* key = &il2cpp_functions::array_class_get(static_cast<Il2CppArray*>(::il2cpp_utils::GetClassFromName("System", "Byte")), 1)->byval_arg;
