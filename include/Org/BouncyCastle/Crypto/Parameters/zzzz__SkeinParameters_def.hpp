...
namespace Org::BouncyCastle::Crypto::Parameters {
class ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder;
}
// Type: ::Builder
namespace Org::BouncyCastle::Crypto::Parameters {
// Is value type: false
...
class CORDL_TYPE ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder", modifiers: " const&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder(____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder", modifiers: "&&", def_value: None }]
constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder(____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder& operator=(____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder&& o) noexcept = default;
  constexpr ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder& operator=(____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder() ;
...
explicit ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder(::System::Collections::IDictionary paramsMap) ;
...
explicit ____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder(::Org::BouncyCastle::Crypto::Parameters::SkeinParameters parameters) ;
...
/// @brief Method Set addr 0xeace48 size 0x178 virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder Set(int32_t type, ::ArrayW<uint8_t> value) ;

/// @brief Method SetKey addr 0xeacfc0 size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method SetPersonalisation addr 0xeacfcc size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetPersonalisation(::ArrayW<uint8_t> personalisation) ;

/// @brief Method SetPersonalisation addr 0xeacfd8 size 0x2ec virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetPersonalisation(::System::DateTime date, ::StringW emailAddress, ::StringW distinguisher) ;

/// @brief Method SetPublicKey addr 0xead2c4 size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetPublicKey(::ArrayW<uint8_t> publicKey) ;

/// @brief Method SetKeyIdentifier addr 0xead2d0 size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetKeyIdentifier(::ArrayW<uint8_t> keyIdentifier) ;

/// @brief Method SetNonce addr 0xead2dc size 0xc virtual false final false
 ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder SetNonce(::ArrayW<uint8_t> nonce) ;
...
public:
// Declarations
using Builder = ::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder;
...
NEED_NO_BOX(::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder);
DEFINE_IL2CPP_ARG_TYPE(::Org::BouncyCastle::Crypto::Parameters::____Org__BouncyCastle__Crypto__Parameters__SkeinParameters__Builder, "Org.BouncyCastle.Crypto.Parameters", "SkeinParameters/Builder");
