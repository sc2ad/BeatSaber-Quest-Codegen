...
static Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters New_ctor(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method .ctor addr 0xea738c size 0xbc virtual false final false
 void _ctor(::ArrayW<uint8_t> buf, int32_t off) ;

static Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters New_ctor(System::IO::Stream input) ;
