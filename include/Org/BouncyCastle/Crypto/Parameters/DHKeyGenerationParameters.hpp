...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(DHKeyGenerationParameters), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_DHKeyGenerationParametersSizeCheck;
}
