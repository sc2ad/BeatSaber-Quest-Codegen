...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(DHPublicKeyParameters), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_DHPublicKeyParametersSizeCheck;
}
