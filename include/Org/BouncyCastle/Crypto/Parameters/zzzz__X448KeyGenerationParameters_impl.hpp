...
// Ctor Parameters [CppParam { name: "random", ty: "Org::BouncyCastle::Security::SecureRandom", modifiers: "", def_value: None }]
 Org::BouncyCastle::Crypto::Parameters::X448KeyGenerationParameters::X448KeyGenerationParameters(Org::BouncyCastle::Security::SecureRandom random)  : Org::BouncyCastle::Crypto::KeyGenerationParameters(THROW_UNLESS(::il2cpp_utils::New<X448KeyGenerationParameters>(random))) {}
