...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  class ParametersWithIV : public ::Il2CppObject/*, public Org::BouncyCastle::Crypto::ICipherParameters*/ {
    ...
    ParametersWithIV(Org::BouncyCastle::Crypto::ICipherParameters* parameters_ = {}, ::ArrayWrapper<uint8_t> iv_ = {}) noexcept : parameters{parameters_}, iv{iv_} {}
    ...
    static ParametersWithIV* New_ctor(Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayWrapper<uint8_t> iv) {
    ...
    // Offset: 0x13971D8
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static ParametersWithIV* New_ctor(Org::BouncyCastle::Crypto::ICipherParameters* parameters, ::ArrayWrapper<uint8_t> iv, int ivOff, int ivLen) {
      static auto ___internal__logger = ::Logger::get().WithContext("Org::BouncyCastle::Crypto::Parameters::ParametersWithIV::.ctor");
  ...
  #pragma pack(pop)
  static check_size<sizeof(ParametersWithIV), 24 + sizeof(::ArrayWrapper<uint8_t>)> __Org_BouncyCastle_Crypto_Parameters_ParametersWithIVSizeCheck;
...
// Il2CppName: GetIV
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayWrapper<uint8_t> (Org::BouncyCastle::Crypto::Parameters::ParametersWithIV::*)()>(&Org::BouncyCastle::Crypto::Parameters::ParametersWithIV::GetIV)> {
  static const MethodInfo* get() {
