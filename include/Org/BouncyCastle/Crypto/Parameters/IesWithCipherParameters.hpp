...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(IesWithCipherParameters), 36 + sizeof(int) + ((36 + sizeof(int)) % 8 != 0 ? (8 - (36 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_IesWithCipherParametersSizeCheck;
}
