...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(X25519PrivateKeyParameters), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Org_BouncyCastle_Crypto_Parameters_X25519PrivateKeyParametersSizeCheck;
}
