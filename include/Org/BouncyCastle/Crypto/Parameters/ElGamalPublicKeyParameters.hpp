...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(ElGamalPublicKeyParameters), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __Org_BouncyCastle_Crypto_Parameters_ElGamalPublicKeyParametersSizeCheck;
}
