...
namespace Org::BouncyCastle::Crypto::Parameters {
  ...
  check_size<sizeof(ElGamalParameters), 32 + sizeof(int) + ((32 + sizeof(int)) % 8 != 0 ? (8 - (32 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Crypto_Parameters_ElGamalParametersSizeCheck;
}
