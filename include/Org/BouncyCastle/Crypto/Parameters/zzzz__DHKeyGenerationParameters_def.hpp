...
static Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters New_ctor(Org::BouncyCastle::Security::SecureRandom random, Org::BouncyCastle::Crypto::Parameters::DHParameters parameters) ;
