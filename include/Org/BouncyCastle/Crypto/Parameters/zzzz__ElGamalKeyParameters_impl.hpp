...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::*)(bool, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters)>(&Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::_ctor)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0xea8510;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Org::BouncyCastle::Crypto::Parameters::ElGamalParameters>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Crypto::Parameters::ElGamalParameters (Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::*)()>(&Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::get_Parameters)> {
  ...
  constexpr static std::size_t addrs = 0xea8540;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::*)(::bs_hook::Il2CppWrapperType)>(&Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::Equals)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0xea8548;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters>::get(),
                                  0
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::*)(Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters)>(&Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::Equals)> {
  ...
  constexpr static std::size_t addrs = 0xea85e4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Equals",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::*)()>(&Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::GetHashCode)> {
  constexpr static std::size_t size = 0x50;
  constexpr static std::size_t addrs = 0xea8634;
...
::cordl_internals::setInstanceField<Org::BouncyCastle::Crypto::Parameters::ElGamalParameters, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Org::BouncyCastle::Crypto::Parameters::ElGamalParameters>(value));
}
...
return ::cordl_internals::RunMethodRethrow<Org::BouncyCastle::Crypto::Parameters::ElGamalParameters, false>(const_cast<void*>(instance), ___internal_method);
 ...
 bool Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::Equals(::bs_hook::Il2CppWrapperType obj)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters>::get(),
                            "Equals",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method, other);
 ...
 int32_t Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters::GetHashCode()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters>::get(),
                            "GetHashCode",
                            std::vector<Il2CppClass*>{},
