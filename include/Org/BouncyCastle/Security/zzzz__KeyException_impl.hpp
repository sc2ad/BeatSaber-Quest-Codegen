...
Org::BouncyCastle::Security::KeyException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::KeyException>())};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 Org::BouncyCastle::Security::KeyException Org::BouncyCastle::Security::KeyException::New_ctor(::StringW message)  {
Org::BouncyCastle::Security::KeyException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::KeyException>(message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 Org::BouncyCastle::Security::KeyException Org::BouncyCastle::Security::KeyException::New_ctor(::StringW message, System::Exception exception)  {
Org::BouncyCastle::Security::KeyException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::KeyException>(message, exception))};
return o;
}
