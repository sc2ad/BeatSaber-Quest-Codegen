...
namespace Org::BouncyCastle::Security {
  ...
  check_size<sizeof(CipherUtilities::CipherAlgorithm), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Org_BouncyCastle_Security_CipherUtilities_CipherAlgorithmSizeCheck;
}
