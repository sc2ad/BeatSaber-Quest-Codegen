...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::GeneralSecurityException::*)()>(&Org::BouncyCastle::Security::GeneralSecurityException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1067cc8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::GeneralSecurityException::*)(::StringW)>(&Org::BouncyCastle::Security::GeneralSecurityException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1067d20;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::GeneralSecurityException::*)(::StringW, System::Exception)>(&Org::BouncyCastle::Security::GeneralSecurityException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1067d88;
...
Org::BouncyCastle::Security::GeneralSecurityException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::GeneralSecurityException>())};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 Org::BouncyCastle::Security::GeneralSecurityException Org::BouncyCastle::Security::GeneralSecurityException::New_ctor(::StringW message)  {
Org::BouncyCastle::Security::GeneralSecurityException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::GeneralSecurityException>(message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 Org::BouncyCastle::Security::GeneralSecurityException Org::BouncyCastle::Security::GeneralSecurityException::New_ctor(::StringW message, System::Exception exception)  {
Org::BouncyCastle::Security::GeneralSecurityException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::GeneralSecurityException>(message, exception))};
return o;
}
