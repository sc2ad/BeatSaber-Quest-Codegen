...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::InvalidParameterException::*)()>(&Org::BouncyCastle::Security::InvalidParameterException::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x10a2cf0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::InvalidParameterException::*)(::StringW)>(&Org::BouncyCastle::Security::InvalidParameterException::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x10a2cf8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Security::InvalidParameterException::*)(::StringW, System::Exception)>(&Org::BouncyCastle::Security::InvalidParameterException::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x10a2d00;
...
Org::BouncyCastle::Security::InvalidParameterException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::InvalidParameterException>())};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 Org::BouncyCastle::Security::InvalidParameterException Org::BouncyCastle::Security::InvalidParameterException::New_ctor(::StringW message)  {
Org::BouncyCastle::Security::InvalidParameterException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::InvalidParameterException>(message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 Org::BouncyCastle::Security::InvalidParameterException Org::BouncyCastle::Security::InvalidParameterException::New_ctor(::StringW message, System::Exception exception)  {
Org::BouncyCastle::Security::InvalidParameterException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Security::InvalidParameterException>(message, exception))};
return o;
}
