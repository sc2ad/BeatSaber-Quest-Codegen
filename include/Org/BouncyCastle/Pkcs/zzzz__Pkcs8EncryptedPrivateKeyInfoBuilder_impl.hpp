...
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder::New_ctor(::ArrayW<uint8_t> privateKeyInfo)  {
Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder>(privateKeyInfo))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, privateKeyInfo);
 ...
 Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder::New_ctor(Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo privateKeyInfo)  {
Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder>(privateKeyInfo))};
return o;
}
