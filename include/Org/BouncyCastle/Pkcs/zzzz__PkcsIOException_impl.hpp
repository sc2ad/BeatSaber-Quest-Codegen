...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Pkcs::PkcsIOException::*)(::StringW, System::Exception)>(&Org::BouncyCastle::Pkcs::PkcsIOException::_ctor)> {
 ...
 Org::BouncyCastle::Pkcs::PkcsIOException Org::BouncyCastle::Pkcs::PkcsIOException::New_ctor(::StringW message)  {
Org::BouncyCastle::Pkcs::PkcsIOException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Pkcs::PkcsIOException>(message))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, message);
 ...
 Org::BouncyCastle::Pkcs::PkcsIOException Org::BouncyCastle::Pkcs::PkcsIOException::New_ctor(::StringW message, System::Exception underlying)  {
Org::BouncyCastle::Pkcs::PkcsIOException o{THROW_UNLESS(::il2cpp_utils::New<Org::BouncyCastle::Pkcs::PkcsIOException>(message, underlying))};
return o;
}
