...
namespace DataModels::PlayerAvatar {
  ...
  check_size<sizeof(RandomizeAvatarColorMap), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __DataModels_PlayerAvatar_RandomizeAvatarColorMapSizeCheck;
}
