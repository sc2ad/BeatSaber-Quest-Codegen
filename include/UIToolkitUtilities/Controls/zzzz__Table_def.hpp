...
class ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5;
}
namespace UIToolkitUtilities::Controls {
class Table;
}
namespace UIToolkitUtilities::Controls {
class ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn;
}
namespace UIToolkitUtilities::Controls {
class ____UIToolkitUtilities__Controls__Table__TableColumn;
}
namespace UIToolkitUtilities::Controls {
class ____UIToolkitUtilities__Controls__Table__UxmlFactory;
}
namespace UIToolkitUtilities::Controls {
class ____UIToolkitUtilities__Controls__Table__UxmlTraits;
}
// Type: ::TableColumn
namespace UIToolkitUtilities::Controls {
// Is value type: false
...
class CORDL_TYPE ____UIToolkitUtilities__Controls__Table__TableColumn : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~____UIToolkitUtilities__Controls__Table__TableColumn() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__TableColumn", modifiers: " const&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__TableColumn(____UIToolkitUtilities__Controls__Table__TableColumn const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__TableColumn", modifiers: "&&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__TableColumn(____UIToolkitUtilities__Controls__Table__TableColumn&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UIToolkitUtilities__Controls__Table__TableColumn(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UIToolkitUtilities__Controls__Table__TableColumn& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__TableColumn& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__TableColumn& operator=(____UIToolkitUtilities__Controls__Table__TableColumn&& o) noexcept = default;
  constexpr ____UIToolkitUtilities__Controls__Table__TableColumn& operator=(____UIToolkitUtilities__Controls__Table__TableColumn const& o) noexcept = default;
...
explicit ____UIToolkitUtilities__Controls__Table__TableColumn(::StringW name, ::bs_hook::EnumTypeWrapper cellType) ;
...
explicit ____UIToolkitUtilities__Controls__Table__TableColumn(::StringW name, ::StringW headerTooltip, ::bs_hook::EnumTypeWrapper cellType, bool visible, int32_t minWidth, int32_t maxWidth) ;
...
class CORDL_TYPE ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____UIToolkitUtilities__Controls__Table__RuntimeTableColumn() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__RuntimeTableColumn", modifiers: " const&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn(____UIToolkitUtilities__Controls__Table__RuntimeTableColumn const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__RuntimeTableColumn", modifiers: "&&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn(____UIToolkitUtilities__Controls__Table__RuntimeTableColumn&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn& operator=(____UIToolkitUtilities__Controls__Table__RuntimeTableColumn&& o) noexcept = default;
  constexpr ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn& operator=(____UIToolkitUtilities__Controls__Table__RuntimeTableColumn const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UIToolkitUtilities__Controls__Table__RuntimeTableColumn() ;
...
class CORDL_TYPE ____UIToolkitUtilities__Controls__Table__UxmlTraits : public ::UnityEngine::UIElements::____UnityEngine__UIElements__VisualElement__UxmlTraits {
public:
// Declarations
using _get_uxmlChildElementsDescription_d__5 = ::GlobalNamespace::______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x90};

virtual ~____UIToolkitUtilities__Controls__Table__UxmlTraits() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__UxmlTraits", modifiers: " const&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits(____UIToolkitUtilities__Controls__Table__UxmlTraits const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__UxmlTraits", modifiers: "&&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits(____UIToolkitUtilities__Controls__Table__UxmlTraits&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UIToolkitUtilities__Controls__Table__UxmlTraits(void* ptr) noexcept : ::UnityEngine::UIElements::____UnityEngine__UIElements__VisualElement__UxmlTraits(ptr) {
}


  constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits& operator=(____UIToolkitUtilities__Controls__Table__UxmlTraits&& o) noexcept = default;
  constexpr ____UIToolkitUtilities__Controls__Table__UxmlTraits& operator=(____UIToolkitUtilities__Controls__Table__UxmlTraits const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UIToolkitUtilities__Controls__Table__UxmlTraits() ;
...
public:
// Declarations
using UxmlTraits = ::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlTraits;

using UxmlFactory = ::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlFactory;

using RuntimeTableColumn = ::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn;

using TableColumn = ::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn;
...
constexpr bool __get__initialized_k__BackingField() const;
 ...
 ::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn> __declspec(property(get=__get_columnSetup, put=__set_columnSetup))  columnSetup;

constexpr void __set_columnSetup(::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn> value) ;

constexpr ::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn> __get_columnSetup() const;

 ::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn> __declspec(property(get=__get_runtimeColumnData, put=__set_runtimeColumnData))  runtimeColumnData;

constexpr void __set_runtimeColumnData(::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn> value) ;

constexpr ::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn> __get_runtimeColumnData() const;
...
/// @brief Method Initialize addr 0x287bc38 size 0x1e8 virtual false final false
 void Initialize(::System::Collections::Generic::List_1<::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn> columnSetup) ;
...
namespace UIToolkitUtilities::Controls {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7089), inst: 5105 }), TypeDefinitionIndex(TypeDefinitionIndex(15946)), TypeDefinitionIndex(TypeDefinitionIndex(15947)), TypeDefinitionIndex(TypeDefinitionIndex(7089))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(15944))
// CS Name: UIToolkitUtilities.Controls.Table::UxmlFactory
class CORDL_TYPE ____UIToolkitUtilities__Controls__Table__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UIToolkitUtilities::Controls::Table,::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlTraits> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____UIToolkitUtilities__Controls__Table__UxmlFactory() = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__UxmlFactory", modifiers: " const&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory(____UIToolkitUtilities__Controls__Table__UxmlFactory const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____UIToolkitUtilities__Controls__Table__UxmlFactory", modifiers: "&&", def_value: None }]
constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory(____UIToolkitUtilities__Controls__Table__UxmlFactory&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____UIToolkitUtilities__Controls__Table__UxmlFactory(void* ptr) noexcept : ::UnityEngine::UIElements::UxmlFactory_2<::UIToolkitUtilities::Controls::Table,::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlTraits>(ptr) {
}


  constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory& operator=(____UIToolkitUtilities__Controls__Table__UxmlFactory&& o) noexcept = default;
  constexpr ____UIToolkitUtilities__Controls__Table__UxmlFactory& operator=(____UIToolkitUtilities__Controls__Table__UxmlFactory const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____UIToolkitUtilities__Controls__Table__UxmlFactory() ;
...
class CORDL_TYPE ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5() = default;

// Ctor Parameters [CppParam { name: "", ty: "______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5", modifiers: " const&", def_value: None }]
constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5(______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5", modifiers: "&&", def_value: None }]
constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5(______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5&& o) noexcept = default;
  constexpr ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5& operator=(______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5 const& o) noexcept = default;
...
explicit ______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5(int32_t __1__state) ;
...
NEED_NO_BOX(::GlobalNamespace::______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::______UIToolkitUtilities__Controls__Table__UxmlTraits___get_uxmlChildElementsDescription_d__5, "UIToolkitUtilities.Controls", "Table/UxmlTraits/<get_uxmlChildElementsDescription>d__5");
...
NEED_NO_BOX(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn);
DEFINE_IL2CPP_ARG_TYPE(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__RuntimeTableColumn, "UIToolkitUtilities.Controls", "Table/RuntimeTableColumn");
NEED_NO_BOX(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn);
DEFINE_IL2CPP_ARG_TYPE(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__TableColumn, "UIToolkitUtilities.Controls", "Table/TableColumn");
NEED_NO_BOX(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlFactory);
DEFINE_IL2CPP_ARG_TYPE(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlFactory, "UIToolkitUtilities.Controls", "Table/UxmlFactory");
NEED_NO_BOX(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlTraits);
DEFINE_IL2CPP_ARG_TYPE(::UIToolkitUtilities::Controls::____UIToolkitUtilities__Controls__Table__UxmlTraits, "UIToolkitUtilities.Controls", "Table/UxmlTraits");
