...
namespace Notepad {
  // Forward declaring type: NotepadComponent
...
namespace Notepad {
  // Size: 0x18
  #pragma pack(push, 1)
  // Autogenerated type: Notepad.NotepadComponent
  ...
  class NotepadComponent : public ::UnityEngine::MonoBehaviour {
    ...
    static NotepadComponent* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<NotepadComponent*, creationType>()));
    }
  }; // Notepad.NotepadComponent
  #pragma pack(pop)
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: Notepad::NotepadComponent::New_ctor
// Il2CppName: .ctor
