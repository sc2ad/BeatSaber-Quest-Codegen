...
namespace Zenject {
  ...
  class MethodProviderWithContainer_3 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    static MethodProviderWithContainer_3<TParam1, TParam2, TValue>* New_ctor(System::Func_4<Zenject::DiContainer*, TParam1, TParam2, TValue>* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_3").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MethodProviderWithContainer_3<TParam1, TParam2, TValue>*>(method)));
    }
    ...
    bool get_IsCached() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_3").WithContext("get_IsCached");
    ...
    bool get_TypeVariesBasedOnMemberType() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_3").WithContext("get_TypeVariesBasedOnMemberType");
    ...
    System::Type* GetInstanceType(Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_3").WithContext("GetInstanceType");
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_3").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.MethodProviderWithContainer`3 is generic!
}
