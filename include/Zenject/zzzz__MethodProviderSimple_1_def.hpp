...
template<::cordl_internals::il2cpp_reference_type TReturn>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11151))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11151), inst: 2 })
...
static Zenject::MethodProviderSimple_1<TReturn> New_ctor(System::Func_1<TReturn> method) ;
