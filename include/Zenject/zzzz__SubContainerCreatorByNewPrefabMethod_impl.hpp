...
Zenject::SubContainerCreatorByNewPrefabMethod o{THROW_UNLESS(::il2cpp_utils::New<Zenject::SubContainerCreatorByNewPrefabMethod>(container, prefabProvider, gameObjectBindInfo, installerMethod))};
return o;
}
