...
namespace Zenject {
  ...
  class InstanceProvider : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xF1B8CC
    static InstanceProvider* New_ctor(System::Type* instanceType, ::CsObject* instance, Zenject::DiContainer* container);
