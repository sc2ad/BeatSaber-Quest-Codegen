...
namespace Zenject {
  ...
  class ConventionFilterTypesBinder : public Zenject::ConventionAssemblySelectionBinder {
    ...
    Zenject::ConventionFilterTypesBinder* DerivingFromOrEqual() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::ConventionFilterTypesBinder*, false>(this, ___generic__method)));
    }
    ...
    Zenject::ConventionFilterTypesBinder* WithAttributeWhere(System::Func_2<T, bool>* predicate) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::ConventionFilterTypesBinder*, false>(this, ___generic__method, predicate)));
    }
