...
struct CORDL_TYPE Zenject__ZenjectBinding__BindTypes : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Zenject__ZenjectBinding__BindTypes(int32_t value__) noexcept;


                    constexpr Zenject__ZenjectBinding__BindTypes(Zenject__ZenjectBinding__BindTypes const&) = default;
                    constexpr Zenject__ZenjectBinding__BindTypes(Zenject__ZenjectBinding__BindTypes&&) = default;
                    constexpr Zenject__ZenjectBinding__BindTypes& operator=(Zenject__ZenjectBinding__BindTypes const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Zenject__ZenjectBinding__BindTypes& operator=(Zenject__ZenjectBinding__BindTypes&& o) noexcept {
...
constexpr explicit Zenject__ZenjectBinding__BindTypes(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Zenject__ZenjectBinding__BindTypes_Unwrapped : int32_t {
__Self = 0,
__AllInterfaces = 1,
...
static Zenject::Zenject__ZenjectBinding__BindTypes const Self;

/// @brief Field AllInterfaces offset 0
static Zenject::Zenject__ZenjectBinding__BindTypes const AllInterfaces;

/// @brief Field AllInterfacesAndSelf offset 0
static Zenject::Zenject__ZenjectBinding__BindTypes const AllInterfacesAndSelf;

/// @brief Field BaseType offset 0
static Zenject::Zenject__ZenjectBinding__BindTypes const BaseType;
...
public:
// Declarations
using BindTypes = Zenject::Zenject__ZenjectBinding__BindTypes;
...
constexpr Zenject::Context __get__context() const;
 ...
 Zenject::Zenject__ZenjectBinding__BindTypes __declspec(property(get=__get__bindType, put=__set__bindType))  _bindType;

constexpr void __set__bindType(Zenject::Zenject__ZenjectBinding__BindTypes value) ;

constexpr Zenject::Zenject__ZenjectBinding__BindTypes __get__bindType() const;
...
// Properties
 ...
 Zenject::Zenject__ZenjectBinding__BindTypes __declspec(property(get=get_BindType))  BindType;
...
/// @brief Method get_BindType addr 0x2d7c718 size 0x8 virtual false final false
 Zenject::Zenject__ZenjectBinding__BindTypes get_BindType() ;
...
DEFINE_IL2CPP_ARG_TYPE(Zenject::Zenject__ZenjectBinding__BindTypes, "Zenject", "ZenjectBinding/BindTypes");
