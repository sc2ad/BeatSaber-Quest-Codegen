...
namespace Zenject {
  ...
  class ScriptableObjectInstaller_4 : public Zenject::ScriptableObjectInstallerBase {
    static_assert((!std::is_complete_v<std::remove_pointer_t<TDerived>> || std::is_convertible_v<TDerived, Zenject::ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>*>));
    public:
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>*>::get(), "InstallFromResource", container, p1, p2, p3)));
    }
    ...
    // Offset: 0xFFFFFFFF
    static TDerived InstallFromResource(::CsString* resourcePath, Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>*>::get(), "InstallFromResource", resourcePath, container, p1, p2, p3)));
    }
    ...
    static ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>* New_ctor() {
      return (ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_4<TParam1, TParam2, TParam3, TDerived>*>::get())));
    }
