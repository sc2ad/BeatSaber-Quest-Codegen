...
namespace Zenject {
  ...
  check_size<sizeof(InjectContext::$get_AllObjectTypes$d__56), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __Zenject_InjectContext_$get_AllObjectTypes$d__56SizeCheck;
}
