...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::bs_hook::Il2CppWrapperType (Zenject::ZenFactoryMethod::*)(System::IAsyncResult)>(&Zenject::ZenFactoryMethod::EndInvoke)> {
 ...
 Zenject::ZenFactoryMethod Zenject::ZenFactoryMethod::New_ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method)  {
Zenject::ZenFactoryMethod o{THROW_UNLESS(::il2cpp_utils::New<Zenject::ZenFactoryMethod>(object, method))};
return o;
}
