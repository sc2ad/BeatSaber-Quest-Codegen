...
namespace Zenject {
  ...
  class FactoryFromBinder1Extensions::$$c__DisplayClass0_0_2 : public ::Il2CppObject {
    ...
    System::Guid _get_factoryId() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder1Extensions::$$c__DisplayClass0_0_2::_get_factoryId");
    ...
    void _set_factoryId(System::Guid value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder1Extensions::$$c__DisplayClass0_0_2::_set_factoryId");
      static auto ___internal__instance = this;
