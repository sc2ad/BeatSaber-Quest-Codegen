...
static Zenject::MethodProviderWithContainer_4<TParam1,TParam2,TParam3,TValue> New_ctor(System::Func_5<Zenject::DiContainer,TParam1,TParam2,TParam3,TValue> method) ;
