...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_3 : public Zenject::PoolableMemoryPoolProviderBase_1<TContract>/*, public Zenject::IValidatable*/ {
    ...
    TMemoryPool _get__pool() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProvider_3::_get__pool");
    ...
    void _set__pool(TMemoryPool value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProvider_3::_set__pool");
      static auto ___internal__instance = this;
