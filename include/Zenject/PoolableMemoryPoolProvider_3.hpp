...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_3 : public Zenject::PoolableMemoryPoolProviderBase_1<TContract>/*, public Zenject::IValidatable*/ {
    ...
    static PoolableMemoryPoolProvider_3<TParam1, TContract, TMemoryPool>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PoolableMemoryPoolProvider_3").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PoolableMemoryPoolProvider_3<TParam1, TContract, TMemoryPool>*>(container, poolId)));
    }
    ...
    void Validate() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PoolableMemoryPoolProvider_3").WithContext("Validate");
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PoolableMemoryPoolProvider_3").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.PoolableMemoryPoolProvider`3 is generic!
}
