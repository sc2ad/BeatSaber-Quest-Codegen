...
namespace Zenject {
  ...
  check_size<sizeof(GetFromGameObjectGetterComponentProvider), 32 + sizeof(bool) + 8 - (32 + sizeof(bool)) % 8> __Zenject_GetFromGameObjectGetterComponentProviderSizeCheck;
}
