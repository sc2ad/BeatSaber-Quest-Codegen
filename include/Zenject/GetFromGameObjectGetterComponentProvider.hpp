...
namespace Zenject {
  ...
  check_size<sizeof(GetFromGameObjectGetterComponentProvider), 32 + sizeof(bool) + ((32 + sizeof(bool)) % 8 != 0 ? (8 - (32 + sizeof(bool)) % 8) : 0)> __Zenject_GetFromGameObjectGetterComponentProviderSizeCheck;
}
