...
namespace Zenject {
  ...
  template<typename T>
  class PrefabResourceFactory_1 : public ::CsObject, public Zenject::IFactory_2<::CsString*, T>, public Zenject::IFactory {
    public:
    ...
    T Create(::CsString* prefabResourceName) {
    ...
    T Zenject_IFactory_2_Create(::CsString* prefabResourceName) {
