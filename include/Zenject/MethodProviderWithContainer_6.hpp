...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEF178
  ...
  class MethodProviderWithContainer_6 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    bool get_IsCached_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::get_IsCached_NEW");
    ...
    bool get_TypeVariesBasedOnMemberType_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::get_TypeVariesBasedOnMemberType_NEW");
    ...
    System::Type* GetInstanceType_NEW(Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::GetInstanceType_NEW");
    ...
    void GetAllInstancesWithInjectSplit_NEW(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::GetAllInstancesWithInjectSplit_NEW");
