...
namespace Zenject {
  ...
  class MethodProviderWithContainer_6 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    System::Func_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* _get__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::_get__method");
    ...
    // Set instance field: private readonly System.Func`7<Zenject.DiContainer,TParam1,TParam2,TParam3,TParam4,TParam5,TValue> _method
    void _set__method(System::Func_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_6::_set__method");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_method"))->offset;
      *reinterpret_cast<System::Func_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TValue>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
