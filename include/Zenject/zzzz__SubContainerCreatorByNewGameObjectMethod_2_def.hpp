...
namespace Zenject {
template<typename TParam1,typename TParam2>
class ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2>
class ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1,TParam2>;
}
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1>
class ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1,::System::Int32Enum>;
}
...
class CORDL_TYPE ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1,TParam2> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0", modifiers: " const&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0", modifiers: "&&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0&& o) noexcept = default;
  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0() ;
...
// CS Name: Zenject.SubContainerCreatorByNewGameObjectMethod`2::<>c__DisplayClass2_0
class CORDL_TYPE ____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1,::System::Int32Enum> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1, TParam2>;
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0<TParam1, ::System::Int32Enum>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__SubContainerCreatorByNewGameObjectMethod_2____c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`2/<>c__DisplayClass2_0");
