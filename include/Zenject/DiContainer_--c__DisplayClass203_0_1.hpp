...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93D78
  ...
  class DiContainer::$$c__DisplayClass203_0_1 : public ::Il2CppObject {
    ...
    Zenject::IProvider* $BindInstance$b__0(Zenject::DiContainer* container, System::Type* type) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "<BindInstance>b__0", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(container, type))));
  ...
  // Could not write size check! Type: Zenject.DiContainer/<>c__DisplayClass203_0`1 is generic, or has no fields that are valid for size checks!
}
