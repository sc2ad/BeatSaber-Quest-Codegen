...
namespace Zenject {
  ...
  class FactoryFromBinder_6 : public Zenject::FactoryFromBinderBase {
    ...
    // Type namespace: Zenject
    namespace Zenject {
      // Forward declaring type: <>c__DisplayClass1_0<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>
      class $$c__DisplayClass1_0;
    }
    // WARNING Size may be invalid!
    ...
    // Type namespace: Zenject
    namespace Zenject {
      // Forward declaring type: <>c__2`1<TParam1, TParam2, TParam3, TParam4, TParam5, TContract, TSubFactory>
      template<typename TSubFactory>
      class $$c__2_1;
    }
    // WARNING Size may be invalid!
