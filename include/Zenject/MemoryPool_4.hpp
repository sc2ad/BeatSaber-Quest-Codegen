...
namespace Zenject {
  ...
  class MemoryPool_4 : public Zenject::IMemoryPool_4<TParam1, TParam2, TParam3, TValue>, public Zenject::IFactory_4<TParam1, TParam2, TParam3, TValue>, public Zenject::MemoryPoolBase_1<TValue> {
    public:
