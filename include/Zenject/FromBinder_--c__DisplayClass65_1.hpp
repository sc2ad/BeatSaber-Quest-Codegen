...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass65_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xF21D8C
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentInHierarchy$b__1(Zenject::InjectContext* ctx);
