...
namespace Zenject {
  ...
  class FactorySubContainerBinderBase_1 : public ::CsObject {
    public:
    ...
    class $$c__DisplayClass23_0 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
    ...
    class $$c__DisplayClass25_0 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = FactorySubContainerBinderBase_1<TContract>*;
      // public Zenject.FactorySubContainerBinderBase`1<TContract> <>4__this
      // Offset: 0x0
    ...
    class $$c__DisplayClass27_0 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = FactorySubContainerBinderBase_1<TContract>*;
      // public Zenject.FactorySubContainerBinderBase`1<TContract> <>4__this
      // Offset: 0x0
    ...
    class $$c__DisplayClass29_0 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = FactorySubContainerBinderBase_1<TContract>*;
      // public Zenject.FactorySubContainerBinderBase`1<TContract> <>4__this
      // Offset: 0x0
    ...
    // Offset: 0xFFFFFFFF
    static FactorySubContainerBinderBase_1<TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, ::CsObject* subIdentifier) {
    ...
    // Offset: 0xFFFFFFFF
    ::CsObject* get_SubIdentifier() {
      return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "get_SubIdentifier"));
    }
    // private System.Void set_SubIdentifier(System.Object value)
    // Offset: 0xFFFFFFFF
    void set_SubIdentifier(::CsObject* value) {
    ...
    // Offset: 0xFFFFFFFF
    template<class TInstaller>
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewPrefabResourceInstaller(::CsString* resourcePath) {
      static_assert(std::is_convertible_v<TInstaller, Zenject::InstallerBase*>);
    ...
    // Offset: 0xFFFFFFFF
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewPrefabResourceInstaller(::CsString* resourcePath, System::Type* installerType) {
