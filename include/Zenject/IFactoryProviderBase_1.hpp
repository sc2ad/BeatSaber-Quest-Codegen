...
namespace Zenject {
  ...
  class IFactoryProviderBase_1 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xD94AF8
    ...
    // [CompilerGeneratedAttribute] Offset: 0xD94B08
    ...
    System::Guid get_FactoryId() {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "get_FactoryId", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
    ...
    void set_FactoryId(System::Guid value) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "set_FactoryId", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(value)));
