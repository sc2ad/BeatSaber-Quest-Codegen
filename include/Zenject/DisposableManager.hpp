...
namespace Zenject {
  ...
  class DisposableManager : public ::Il2CppObject/*, public System::IDisposable*/ {
    ...
    check_size<sizeof(DisposableManager::DisposableInfo), 8 + sizeof(int) + ((8 + sizeof(int)) % 8 != 0 ? (8 - (8 + sizeof(int)) % 8) : 0)> __Zenject_DisposableManager_DisposableInfoSizeCheck;
  ...
  check_size<sizeof(DisposableManager), 33 + sizeof(bool) + ((33 + sizeof(bool)) % 8 != 0 ? (8 - (33 + sizeof(bool)) % 8) : 0)> __Zenject_DisposableManagerSizeCheck;
}
