...
namespace Zenject {
  ...
  class DisposableManager : public System::IDisposable, public ::Il2CppObject {
    public:
    ...
    struct DisposableInfo : public System::ValueType {
      ...
      DisposableInfo(System::IDisposable* Disposable_ = {}, int Priority_ = {}) : Disposable{Disposable_}, Priority{Priority_} {}
