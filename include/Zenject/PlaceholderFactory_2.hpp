...
namespace Zenject {
  ...
  class PlaceholderFactory_2 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_2<TParam1, TValue>*/ {
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`2/<get_ParamTypes>d__2 is generic!
    ...
    TValue Create(TParam1 param) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_2").WithContext("Create");
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_2").WithContext("get_ParamTypes");
    ...
    static PlaceholderFactory_2<TParam1, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_2").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PlaceholderFactory_2<TParam1, TValue>*>()));
    }
  }; // Zenject.PlaceholderFactory`2
  // Could not write size check! Type: Zenject.PlaceholderFactory`2 is generic!
}
