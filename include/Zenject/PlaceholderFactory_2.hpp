...
namespace Zenject {
  ...
  class PlaceholderFactory_2 : public Zenject::IFactory_2<TParam1, TValue>, public Zenject::PlaceholderFactoryBase_1<TValue> {
    public:
    ...
    class $get_ParamTypes$d__2 : public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>, public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      public:
      using declaring_type = PlaceholderFactory_2<TValue, TParam1>*;
      ...
      static typename PlaceholderFactory_2<TParam1, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        return (typename PlaceholderFactory_2<TParam1, TValue>::$get_ParamTypes$d__2*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename PlaceholderFactory_2<TParam1, TValue>::$get_ParamTypes$d__2*>::get(), $$1__state)));
      }
    ...
    // Base method: TValue IFactory`2::Create(TParam1 param)
    ...
    static PlaceholderFactory_2<TValue, TParam1>* New_ctor() {
      return (PlaceholderFactory_2<TValue, TParam1>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PlaceholderFactory_2<TValue, TParam1>*>::get())));
    }
