...
namespace Zenject {
  ...
  class IPoolable_10 {
    ...
    void OnDespawned_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IPoolable_10::OnDespawned_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnSpawned_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TParam7 p7, TParam8 p8, TParam9 p9, TParam10 p10) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IPoolable_10::OnSpawned_NEW");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "OnSpawned", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10)));
