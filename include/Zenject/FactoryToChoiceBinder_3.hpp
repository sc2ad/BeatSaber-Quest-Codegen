...
namespace Zenject {
  // Forward declaring type: FactoryToChoiceBinder`3<TParam1, TParam2, TContract>
...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_3 : public Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract> {
    ...
    Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* ToSelf() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactoryFromBinder_3<TParam1, TParam2, TConcrete>* To() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_3<TParam1, TParam2, TConcrete>*, false>(this, ___generic__method)));
    }
