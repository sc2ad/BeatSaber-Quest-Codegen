...
namespace Zenject {
  ...
  check_size<sizeof(DisposableManager::$$c__DisplayClass9_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_DisposableManager_$$c__DisplayClass9_0SizeCheck;
}
