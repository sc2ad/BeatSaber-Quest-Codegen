...
namespace Zenject {
  ...
  class FactorySubContainerBinder_5 : public Zenject::FactorySubContainerBinderWithParams_1<TContract> {
    ...
    static FactorySubContainerBinder_5<TContract, TParam1, TParam2, TParam3, TParam4>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, ::Il2CppObject* subIdentifier) {
      return THROW_UNLESS((il2cpp_utils::New<FactorySubContainerBinder_5<TContract, TParam1, TParam2, TParam3, TParam4>*>(bindContainer, bindInfo, factoryBindInfo, subIdentifier)));
    }
