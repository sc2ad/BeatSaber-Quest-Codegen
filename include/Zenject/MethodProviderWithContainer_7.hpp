...
namespace Zenject {
  ...
  class MethodProviderWithContainer_7 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    System::Func_8<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* _get__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_7::_get__method");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Func_8<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*>(___internal__instance, "_method")));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Func`8<Zenject.DiContainer,TParam1,TParam2,TParam3,TParam4,TParam5,TParam6,TValue> _method
    void _set__method(System::Func_8<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderWithContainer_7::_set__method");
      static auto ___internal__instance = this;
