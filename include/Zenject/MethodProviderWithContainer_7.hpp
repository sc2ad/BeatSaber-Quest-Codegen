...
namespace Zenject {
  ...
  class MethodProviderWithContainer_7 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    void _set__method(System::Func_8<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_method"))->offset;
      *reinterpret_cast<System::Func_8<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
