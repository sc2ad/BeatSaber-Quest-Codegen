...
namespace Zenject {
  ...
  class ConditionCopyNonLazyBinder::$$c__4_1 : public ::Il2CppObject {
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ConditionCopyNonLazyBinder::$$c__4_1<T>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    bool $WhenInjectedInto$b__4_0(Zenject::InjectContext* r) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<WhenInjectedInto>b__4_0", {}, ::il2cpp_utils::ExtractTypes(r))));
  ...
  // Could not write size check! Type: Zenject.ConditionCopyNonLazyBinder/<>c__4`1 is generic!
}
