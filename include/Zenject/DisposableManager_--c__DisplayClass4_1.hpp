...
namespace Zenject {
  ...
  check_size<sizeof(DisposableManager::$$c__DisplayClass4_1), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_DisposableManager_$$c__DisplayClass4_1SizeCheck;
}
