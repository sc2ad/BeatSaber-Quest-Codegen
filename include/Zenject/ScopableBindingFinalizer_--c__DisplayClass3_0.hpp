...
namespace Zenject {
  ...
  check_size<sizeof(ScopableBindingFinalizer::$$c__DisplayClass3_0), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Zenject_ScopableBindingFinalizer_$$c__DisplayClass3_0SizeCheck;
}
