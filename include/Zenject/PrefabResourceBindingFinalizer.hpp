...
namespace Zenject {
  ...
  check_size<sizeof(PrefabResourceBindingFinalizer), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __Zenject_PrefabResourceBindingFinalizerSizeCheck;
}
