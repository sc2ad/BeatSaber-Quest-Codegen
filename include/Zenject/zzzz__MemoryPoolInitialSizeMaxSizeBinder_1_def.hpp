...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10810)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10809), inst: 1689 }), TypeDefinitionIndex(TypeDefinitionIndex(10809))}
