...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10809), inst: 1689 }), TypeDefinitionIndex(TypeDefinitionIndex(10810)), TypeDefinitionIndex(TypeDefinitionIndex(10809))}
...
static Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo, Zenject::MemoryPoolBindInfo poolBindInfo) ;
