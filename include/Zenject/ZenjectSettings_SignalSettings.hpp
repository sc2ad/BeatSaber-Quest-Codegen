...
namespace Zenject {
  ...
  check_size<sizeof(ZenjectSettings::SignalSettings), 28 + sizeof(int) + ((28 + sizeof(int)) % 8 != 0 ? (8 - (28 + sizeof(int)) % 8) : 0)> __Zenject_ZenjectSettings_SignalSettingsSizeCheck;
}
