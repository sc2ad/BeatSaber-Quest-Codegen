...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass64_0 : public ::CsObject {
    public:
    ...
    // Offset: 0xF3250C
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentsSibling$b__1(Zenject::InjectContext* ctx);
