...
namespace Zenject {
  // Forward declaring type: MethodProviderWithContainer`5<TParam1, TParam2, TParam3, TParam4, TValue>
...
namespace Zenject {
  ...
  class MethodProviderWithContainer_5 : public ::Il2CppObject/*, public ::Zenject::IProvider*/ {
    ...
    [[deprecated("Use field access instead!")]] ::System::Func_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TValue>*& dyn__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::MethodProviderWithContainer_5::dyn__method");
