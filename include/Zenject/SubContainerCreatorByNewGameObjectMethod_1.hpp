...
namespace Zenject {
  ...
  class SubContainerCreatorByNewGameObjectMethod_1 : public Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    class $$c__DisplayClass2_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>* _get_$$4__this() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::$$c__DisplayClass2_0::_get_$$4__this");
        static auto ___internal__instance = this;
        return THROW_UNLESS((il2cpp_utils::GetFieldValue<Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>*>(___internal__instance, "<>4__this")));
      }
      // Autogenerated instance field setter
      // Set instance field: public Zenject.SubContainerCreatorByNewGameObjectMethod`1<TParam1> <>4__this
      void _set_$$4__this(Zenject::SubContainerCreatorByNewGameObjectMethod_1<TParam1>* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::$$c__DisplayClass2_0::_set_$$4__this");
        static auto ___internal__instance = this;
      ...
      System::Collections::Generic::List_1<Zenject::TypeValuePair>* _get_args() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::$$c__DisplayClass2_0::_get_args");
        static auto ___internal__instance = this;
      ...
      void _set_args(System::Collections::Generic::List_1<Zenject::TypeValuePair>* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::$$c__DisplayClass2_0::_set_args");
        static auto ___internal__instance = this;
    ...
    System::Action_2<Zenject::DiContainer*, TParam1>* _get__installerMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::_get__installerMethod");
      static auto ___internal__instance = this;
    ...
    void _set__installerMethod(System::Action_2<Zenject::DiContainer*, TParam1>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewGameObjectMethod_1::_set__installerMethod");
      static auto ___internal__instance = this;
