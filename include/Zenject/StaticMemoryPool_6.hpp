...
namespace Zenject {
  // Forward declaring type: StaticMemoryPool`6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>
...
namespace Zenject {
  ...
  class StaticMemoryPool_6 : public ::Zenject::StaticMemoryPoolBase_1<TValue>/*, public ::Zenject::IMemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*& dyn__onSpawnMethod() {
    ...
    TValue Spawn(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<TValue, false>(this, ___internal__method, p1, p2, p3, p4, p5);
    }
