...
namespace Zenject {
  ...
  class StaticMemoryPool_6 : public Zenject::StaticMemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    // Creating value type constructor for type: StaticMemoryPool_6
    StaticMemoryPool_6(System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* onSpawnMethod_ = {}) noexcept : onSpawnMethod{onSpawnMethod_} {}
    ...
    System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* _get__onSpawnMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_6::_get__onSpawnMethod");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*>(___internal__instance, "_onSpawnMethod")));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Action`6<TParam1,TParam2,TParam3,TParam4,TParam5,TValue> _onSpawnMethod
    void _set__onSpawnMethod(System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_6::_set__onSpawnMethod");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_onSpawnMethod", value));
    }
