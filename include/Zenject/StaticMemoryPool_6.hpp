...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEEE48
  ...
  class StaticMemoryPool_6 : public Zenject::StaticMemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    // Offset: 0xFFFFFFFF
    TValue Spawn_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_6::Spawn_NEW");
