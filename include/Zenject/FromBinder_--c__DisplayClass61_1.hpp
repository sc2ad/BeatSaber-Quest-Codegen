...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass61_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xF21018
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentInParents$b__1(Zenject::InjectContext* ctx);
