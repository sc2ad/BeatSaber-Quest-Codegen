...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByNewGameObjectInstaller), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __Zenject_SubContainerCreatorByNewGameObjectInstallerSizeCheck;
}
