...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByNewGameObjectInstaller), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerCreatorByNewGameObjectInstallerSizeCheck;
}
