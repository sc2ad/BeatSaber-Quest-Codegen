...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92100
  ...
  class FactorySubContainerBinder_3 : public Zenject::FactorySubContainerBinderWithParams_1<TContract> {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D934D8
    ...
    // Could not write size check! Type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass1_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass2_0
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D934E8
    ...
    // Could not write size check! Type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass3_0
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D934F8
    ...
    // Could not write size check! Type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass3_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass4_0
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93508
    ...
    // Could not write size check! Type: Zenject.FactorySubContainerBinder`3/<>c__DisplayClass4_0 is generic, or has no fields that are valid for size checks!
    ...
    Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* ByMethod(System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* installerMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactorySubContainerBinder_3").WithContext("ByMethod");
    ...
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewGameObjectMethod(System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* installerMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactorySubContainerBinder_3").WithContext("ByNewGameObjectMethod");
    ...
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewPrefabMethod(UnityEngine::Object* prefab, System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* installerMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactorySubContainerBinder_3").WithContext("ByNewPrefabMethod");
    ...
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewPrefabResourceMethod(::Il2CppString* resourcePath, System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* installerMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactorySubContainerBinder_3").WithContext("ByNewPrefabResourceMethod");
    ...
    static FactorySubContainerBinder_3<TParam1, TParam2, TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, ::Il2CppObject* subIdentifier) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactorySubContainerBinder_3").WithContext(".ctor");
