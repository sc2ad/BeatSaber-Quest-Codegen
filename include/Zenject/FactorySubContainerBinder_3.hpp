...
namespace Zenject {
  ...
  class FactorySubContainerBinder_3 : public Zenject::FactorySubContainerBinderWithParams_1<TContract> {
    ...
    // Type namespace: Zenject
    namespace Zenject {
      // Forward declaring type: <>c__DisplayClass2_0<TParam1, TParam2, TContract>
      class $$c__DisplayClass2_0;
    }
    // WARNING Size may be invalid!
    ...
    // Type namespace: Zenject
    namespace Zenject {
      // Forward declaring type: <>c__DisplayClass3_0<TParam1, TParam2, TContract>
      class $$c__DisplayClass3_0;
    }
    // WARNING Size may be invalid!
    ...
    // Type namespace: Zenject
    namespace Zenject {
      // Forward declaring type: <>c__DisplayClass4_0<TParam1, TParam2, TContract>
      class $$c__DisplayClass4_0;
    }
    // WARNING Size may be invalid!
