...
namespace Zenject {
  ...
  class StaticMemoryPoolBaseBase_1 : public ::CsObject, public Zenject::IDespawnableMemoryPool_1<TValue>, public Zenject::IMemoryPool, public System::IDisposable {
    public:
    ...
    void Zenject_IMemoryPool_Despawn(::CsObject* item) {
