...
namespace Zenject::Internal {
  ...
  class ReflectionInfoTypeInfoConverter : public ::CsObject {
    public:
    ...
    // Offset: 0xF38DD0
    static Zenject::ZenMemberSetterMethod* GetOnlyPropertySetter(System::Type* parentType, ::CsString* propertyName);
