...
namespace Zenject::Internal {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEF5B0
  ...
  class DecoratorProvider_1 : public ::Il2CppObject/*, public Zenject::Internal::IDecoratorProvider*/ {
    ...
    // Offset: 0xFFFFFFFF
    void GetAllInstances_NEW(Zenject::IProvider* provider, Zenject::InjectContext* context, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::Internal::DecoratorProvider_1::GetAllInstances_NEW");
