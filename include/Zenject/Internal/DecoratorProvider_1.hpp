...
namespace Zenject::Internal {
  ...
  class DecoratorProvider_1 : public ::CsObject, public Zenject::Internal::IDecoratorProvider {
    public:
    ...
    // Offset: 0x0
    System::Collections::Generic::Dictionary_2<Zenject::IProvider*, System::Collections::Generic::List_1<::CsObject*>*>* cachedInstances;
    ...
    // Offset: 0xFFFFFFFF
    void WrapProviderInstances(Zenject::IProvider* provider, Zenject::InjectContext* context, System::Collections::Generic::List_1<::CsObject*>* buffer) {
    ...
    // Offset: 0xFFFFFFFF
    ::CsObject* DecorateInstance(::CsObject* instance, Zenject::InjectContext* context) {
      return THROW_UNLESS(il2cpp_utils::RunMethod<::CsObject*>(this, "DecorateInstance", instance, context));
    }
