...
namespace Zenject::Internal {
  ...
  // [NoReflectionBakingAttribute] Offset: DDE77C
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo::*)(System::Reflection::PropertyInfo*, Zenject::InjectableInfo*)>(&Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Reflection::PropertyInfo*>(), ::il2cpp_utils::ExtractIndependentType<Zenject::InjectableInfo*>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo::*)(System::Reflection::PropertyInfo*, Zenject::InjectableInfo*)>(&Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::Internal::ReflectionTypeInfo::InjectPropertyInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<System::Reflection::PropertyInfo*>(), ::il2cpp_utils::ExtractIndependentType<Zenject::InjectableInfo*>()});
  }
};
