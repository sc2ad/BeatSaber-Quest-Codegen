...
namespace Zenject::Internal {
  ...
  check_size<sizeof(ReflectionTypeInfo::InjectPropertyInfo), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Zenject_Internal_ReflectionTypeInfo_InjectPropertyInfoSizeCheck;
}
