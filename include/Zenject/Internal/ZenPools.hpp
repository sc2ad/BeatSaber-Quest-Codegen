...
namespace Zenject::Internal {
  ...
  class ZenPools : public ::CsObject {
    public:
    ...
    // Offset: 0xF3BB08
    static Zenject::InjectContext* SpawnInjectContext(Zenject::DiContainer* container, Zenject::InjectableInfo* injectableInfo, Zenject::InjectContext* currentContext, ::CsObject* targetInstance, System::Type* targetType, ::CsObject* concreteIdentifier);
