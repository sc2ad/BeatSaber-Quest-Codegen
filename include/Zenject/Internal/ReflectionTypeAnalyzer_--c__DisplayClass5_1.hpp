...
namespace Zenject::Internal {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D94108
  class ReflectionTypeAnalyzer::$$c__DisplayClass5_1 : public ::Il2CppObject {
    ...
    static ReflectionTypeAnalyzer::$$c__DisplayClass5_1* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject::Internal").WithContext("$$c__DisplayClass5_1").WithContext(".ctor");
