...
namespace Zenject {
  ...
  class MemoryPool_6 : public Zenject::IMemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>, public Zenject::IFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>, public Zenject::MemoryPoolBase_1<TValue> {
    public:
