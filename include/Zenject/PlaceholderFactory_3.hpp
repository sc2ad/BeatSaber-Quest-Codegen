  ...
  class PlaceholderFactory_3 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_3<TParam1, TParam2, TValue>*/ {
    ...
    class $get_ParamTypes$d__2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>*/ {
      ...
      static typename PlaceholderFactory_3<TParam1, TParam2, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename PlaceholderFactory_3<TParam1, TParam2, TValue>::$get_ParamTypes$d__2*>($$1__state)));
      }
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`3/<get_ParamTypes>d__2 is generic!
    ...
    // Base method: TValue IFactory_3::Create(TParam1 param1, TParam2 param2)
    TValue Create(TParam1 param1, TParam2 param2) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_3").WithContext("Create");
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_3").WithContext("get_ParamTypes");
    ...
    static PlaceholderFactory_3<TParam1, TParam2, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_3").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PlaceholderFactory_3<TParam1, TParam2, TValue>*>()));
    }
  }; // Zenject.PlaceholderFactory`3
  // Could not write size check! Type: Zenject.PlaceholderFactory`3 is generic!
}
