...
namespace Zenject {
  ...
  class MemoryPoolExpandBinder_1 : public Zenject::FactoryArgumentsToChoiceBinder_1<TContract> {
    ...
    Zenject::MemoryPoolBindInfo* _get_$MemoryPoolBindInfo$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolExpandBinder_1::_get_$MemoryPoolBindInfo$k__BackingField");
    ...
    // Set instance field: private Zenject.MemoryPoolBindInfo <MemoryPoolBindInfo>k__BackingField
    void _set_$MemoryPoolBindInfo$k__BackingField(Zenject::MemoryPoolBindInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolExpandBinder_1::_set_$MemoryPoolBindInfo$k__BackingField");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<MemoryPoolBindInfo>k__BackingField"))->offset;
      *reinterpret_cast<Zenject::MemoryPoolBindInfo**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
