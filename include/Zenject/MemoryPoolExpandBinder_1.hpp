...
namespace Zenject {
  ...
  class MemoryPoolExpandBinder_1 : public Zenject::FactoryArgumentsToChoiceBinder_1<TContract> {
    ...
    Zenject::MemoryPoolBindInfo* _get_$MemoryPoolBindInfo$k__BackingField() {
      ...
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<Zenject::MemoryPoolBindInfo*>(___internal__instance, "<MemoryPoolBindInfo>k__BackingField")));
    }
    ...
    void _set_$MemoryPoolBindInfo$k__BackingField(Zenject::MemoryPoolBindInfo* value) {
      ...
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "<MemoryPoolBindInfo>k__BackingField", value));
    }
