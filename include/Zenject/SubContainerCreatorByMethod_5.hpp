...
namespace Zenject {
  // Forward declaring type: SubContainerCreatorByMethod`5<TParam1, TParam2, TParam3, TParam4, TParam5>
...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_5 : public ::Zenject::SubContainerCreatorByMethodBase {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5>*& dyn__installMethod() {
