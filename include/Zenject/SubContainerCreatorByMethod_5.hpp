...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_5 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    void _set__installMethod(System::Action_6<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5>* value) {
      ...
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_installMethod"))->offset;
      *reinterpret_cast<System::Action_6<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
