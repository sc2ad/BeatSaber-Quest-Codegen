...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_5 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    static SubContainerCreatorByMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>* New_ctor(Zenject::DiContainer* container, Zenject::SubContainerCreatorBindInfo* containerBindInfo, System::Action_6<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5>* installMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByMethod_5").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SubContainerCreatorByMethod_5<TParam1, TParam2, TParam3, TParam4, TParam5>*>(container, containerBindInfo, installMethod)));
    }
    ...
    Zenject::DiContainer* CreateSubContainer(System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByMethod_5").WithContext("CreateSubContainer");
  ...
  // Could not write size check! Type: Zenject.SubContainerCreatorByMethod`5 is generic!
}
