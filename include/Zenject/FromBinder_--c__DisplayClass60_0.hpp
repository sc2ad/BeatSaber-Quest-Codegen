...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93848
  class FromBinder::$$c__DisplayClass60_0 : public ::Il2CppObject {
    ...
    static FromBinder::$$c__DisplayClass60_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass60_0").WithContext(".ctor");
