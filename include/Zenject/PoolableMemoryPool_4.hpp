...
namespace Zenject {
  ...
  class PoolableMemoryPool_4 : public Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    ...
    static PoolableMemoryPool_4<TParam1, TParam2, TParam3, TValue>* New_ctor() {
      return (PoolableMemoryPool_4<TParam1, TParam2, TParam3, TValue>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PoolableMemoryPool_4<TParam1, TParam2, TParam3, TValue>*>::get())));
    }
