...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92D10
  ...
  class SubContainerCreatorByNewPrefabMethod_10 : public Zenject::SubContainerCreatorByNewPrefabDynamicContext {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93ED8
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewPrefabMethod`10/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
