...
namespace Zenject {
  // Forward declaring type: TaskUpdater`1<TTask>
...
namespace Zenject {
  ...
  class TaskUpdater_1 : public ::Il2CppObject {
    ...
    class TaskInfo : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      [[deprecated("Use field access instead!")]] TTask& dyn_Task() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::LinkedList_1<typename ::Zenject::TaskUpdater_1<TTask>::TaskInfo*>*& dyn__tasks() {
    ...
    [[deprecated("Use field access instead!")]] ::System::Collections::Generic::List_1<typename ::Zenject::TaskUpdater_1<TTask>::TaskInfo*>*& dyn__queuedTasks() {
