...
namespace Zenject {
  ...
  class TaskUpdater_1 : public ::Il2CppObject {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF0760
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF0770
    ...
    // Offset: 0xFFFFFFFF
    void UpdateItem_NEW(TTask task) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::TaskUpdater_1::UpdateItem_NEW");
