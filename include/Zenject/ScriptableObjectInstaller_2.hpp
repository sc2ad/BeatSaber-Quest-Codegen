...
namespace Zenject {
  ...
  class ScriptableObjectInstaller_2 : public Zenject::ScriptableObjectInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_2<TDerived, TParam1>*>::get(), "InstallFromResource", container, p1)));
    }
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_2<TDerived, TParam1>*>::get(), "InstallFromResource", resourcePath, container, p1)));
    }
    ...
    static ScriptableObjectInstaller_2<TDerived, TParam1>* New_ctor() {
      return (ScriptableObjectInstaller_2<TDerived, TParam1>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ScriptableObjectInstaller_2<TDerived, TParam1>*>::get())));
    }
