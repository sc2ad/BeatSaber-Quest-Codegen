...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92CD0
  ...
  class SubContainerCreatorByNewPrefabMethod_3 : public Zenject::SubContainerCreatorByNewPrefabDynamicContext {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93E98
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewPrefabMethod`3/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
    ...
    static SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>* New_ctor(Zenject::DiContainer* container, Zenject::IPrefabProvider* prefabProvider, Zenject::GameObjectCreationParameters* gameObjectBindInfo, System::Action_4<Zenject::DiContainer*, TParam1, TParam2, TParam3>* installerMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByNewPrefabMethod_3").WithContext(".ctor");
    ...
    void AddInstallers(System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, Zenject::GameObjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByNewPrefabMethod_3").WithContext("AddInstallers");
