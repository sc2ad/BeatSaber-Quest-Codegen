...
namespace Zenject {
  ...
  check_size<sizeof(PrefabInstantiator::$$c__DisplayClass15_0), 48 + sizeof(bool) + ((48 + sizeof(bool)) % 8 != 0 ? (8 - (48 + sizeof(bool)) % 8) : 0)> __Zenject_PrefabInstantiator_$$c__DisplayClass15_0SizeCheck;
}
