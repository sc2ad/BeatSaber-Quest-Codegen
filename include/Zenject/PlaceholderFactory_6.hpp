...
namespace Zenject {
  ...
  class PlaceholderFactory_6 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF084C
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`6/<get_ParamTypes>d__2 is generic, or has no fields that are valid for size checks!
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(param1, param2, param3, param4, param5)));
