...
namespace Zenject {
  ...
  class PlaceholderFactory_6 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_6").WithContext("Create");
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_6").WithContext("get_ParamTypes");
    ...
    static PlaceholderFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_6").WithContext(".ctor");
