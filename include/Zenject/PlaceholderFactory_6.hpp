...
namespace Zenject {
  ...
  class PlaceholderFactory_6 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*/ {
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`6/<get_ParamTypes>d__2 is generic!
    ...
    static PlaceholderFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<PlaceholderFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*>()));
    }
  }; // Zenject.PlaceholderFactory`6
  // Could not write size check! Type: Zenject.PlaceholderFactory`6 is generic!
}
