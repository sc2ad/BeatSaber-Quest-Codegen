...
namespace Zenject {
  ...
  class ZenAutoInjecter : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(ZenAutoInjecter::ContainerSources), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Zenject_ZenAutoInjecter_ContainerSourcesSizeCheck;
  ...
  check_size<sizeof(ZenAutoInjecter), 28 + sizeof(bool) + ((28 + sizeof(bool)) % 8 != 0 ? (8 - (28 + sizeof(bool)) % 8) : 0)> __Zenject_ZenAutoInjecterSizeCheck;
}
