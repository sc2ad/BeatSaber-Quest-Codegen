...
namespace Zenject {
  ...
  class SubContainerCreatorByNewPrefabMethod_6 : public Zenject::SubContainerCreatorByNewPrefabDynamicContext {
    ...
    class $$c__DisplayClass2_0 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename SubContainerCreatorByNewPrefabMethod_6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>::$$c__DisplayClass2_0* New_ctor() {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename SubContainerCreatorByNewPrefabMethod_6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>::$$c__DisplayClass2_0*>()));
      }
    }; // Zenject.SubContainerCreatorByNewPrefabMethod`6/<>c__DisplayClass2_0
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewPrefabMethod`6/<>c__DisplayClass2_0 is generic!
    ...
    static SubContainerCreatorByNewPrefabMethod_6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* New_ctor(Zenject::DiContainer* container, Zenject::IPrefabProvider* prefabProvider, Zenject::GameObjectCreationParameters* gameObjectBindInfo, System::Action_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* installerMethod) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<SubContainerCreatorByNewPrefabMethod_6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>*>(container, prefabProvider, gameObjectBindInfo, installerMethod)));
    }
  ...
  // Could not write size check! Type: Zenject.SubContainerCreatorByNewPrefabMethod`6 is generic!
}
