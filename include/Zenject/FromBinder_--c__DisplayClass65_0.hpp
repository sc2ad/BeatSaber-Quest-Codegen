...
namespace Zenject {
  ...
  check_size<sizeof(FromBinder::$$c__DisplayClass65_0), 16 + sizeof(bool) + ((16 + sizeof(bool)) % 8 != 0 ? (8 - (16 + sizeof(bool)) % 8) : 0)> __Zenject_FromBinder_$$c__DisplayClass65_0SizeCheck;
}
