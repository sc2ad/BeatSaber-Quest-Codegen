...
namespace Zenject {
  ...
  check_size<sizeof(ConventionAssemblySelectionBinder::$$c__DisplayClass12_0), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __Zenject_ConventionAssemblySelectionBinder_$$c__DisplayClass12_0SizeCheck;
}
