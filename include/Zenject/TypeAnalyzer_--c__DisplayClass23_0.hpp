...
namespace Zenject {
  ...
  check_size<sizeof(TypeAnalyzer::$$c__DisplayClass23_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_TypeAnalyzer_$$c__DisplayClass23_0SizeCheck;
}
