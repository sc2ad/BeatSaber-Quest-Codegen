...
#include "Zenject/zzzz__FactoryArgumentsToChoiceBinder_5_def.hpp"
 Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract> Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract>::New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo)  {
Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract>>(bindContainer, bindInfo, factoryBindInfo))};
return o;
}
 void Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract>::_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, bindContainer, bindInfo, factoryBindInfo);
 ...
 Zenject::FactoryArgumentsToChoiceBinder_5<TParam1,TParam2,TParam3,TParam4,TContract> Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract>::WithId(::bs_hook::Il2CppWrapperType identifier)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::FactoryToChoiceIdBinder_5<TParam1,TParam2,TParam3,TParam4,TContract>>::get(),
                            "WithId",
                            std::vector<Il2CppClass*>{},
