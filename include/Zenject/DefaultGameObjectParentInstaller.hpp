...
namespace Zenject {
  ...
  class DefaultGameObjectParentInstaller : public Zenject::Installer_2<::CsString*, Zenject::DefaultGameObjectParentInstaller*> {
    public:
    ...
    // Offset: 0xD58EFC
    static DefaultGameObjectParentInstaller* New_ctor(::CsString* name);
