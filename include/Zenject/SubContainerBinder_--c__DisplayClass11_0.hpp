...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerBinder::$$c__DisplayClass11_0), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerBinder_$$c__DisplayClass11_0SizeCheck;
}
