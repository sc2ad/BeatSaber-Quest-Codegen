...
namespace Zenject {
  ...
  check_size<sizeof(DiContainer::$$c__DisplayClass86_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_DiContainer_$$c__DisplayClass86_0SizeCheck;
}
