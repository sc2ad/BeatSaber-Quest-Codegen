...
namespace Zenject {
  ...
  class PrefabResourceFactory_3 : public ::Il2CppObject/*, public Zenject::IFactory_4<::Il2CppString*, P1, P2, T>*/ {
    ...
    T Create(::Il2CppString* prefabResourceName, P1 param, P2 param2) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<T>(), "Create", {}, ::il2cpp_utils::ExtractTypes(prefabResourceName, param, param2)));
  ...
  // Could not write size check! Type: Zenject.PrefabResourceFactory`3 is generic!
}
