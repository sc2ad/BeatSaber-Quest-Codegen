...
namespace Zenject {
  ...
  class PrefabResourceFactory_3 : public ::CsObject, public Zenject::IFactory_4<::CsString*, P1, P2, T>, public Zenject::IFactory {
    public:
    ...
    T Create(::CsString* prefabResourceName, P1 param, P2 param2) {
    ...
    T Zenject_IFactory_4_Create(::CsString* prefabResourceName, P1 param, P2 param2) {
