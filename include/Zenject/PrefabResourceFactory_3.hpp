...
namespace Zenject {
  ...
  class PrefabResourceFactory_3 : public ::Il2CppObject/*, public Zenject::IFactory_4<::Il2CppString*, P1, P2, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xD94408
    ...
    Zenject::DiContainer* get_Container() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PrefabResourceFactory_3").WithContext("get_Container");
    ...
    T Create(::Il2CppString* prefabResourceName, P1 param, P2 param2) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PrefabResourceFactory_3").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(prefabResourceName, param, param2)));
    ...
    static PrefabResourceFactory_3<P1, P2, T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PrefabResourceFactory_3").WithContext(".ctor");
