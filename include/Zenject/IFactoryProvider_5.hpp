...
namespace Zenject {
  ...
  class IFactoryProvider_5 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_5<TParam1, TParam2, TParam3, TParam4, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<IFactoryProvider_5<TParam1, TParam2, TParam3, TParam4, TContract>*>(container, factoryId)));
    }
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`5 is generic!
}
