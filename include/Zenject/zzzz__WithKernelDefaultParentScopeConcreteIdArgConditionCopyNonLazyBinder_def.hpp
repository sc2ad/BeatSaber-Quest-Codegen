...
static Zenject::WithKernelDefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder New_ctor(Zenject::SubContainerCreatorBindInfo subContainerBindInfo, Zenject::BindInfo bindInfo) ;
