...
namespace Zenject {
  ...
  check_size<sizeof(FromBinder::$$c__DisplayClass67_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_FromBinder_$$c__DisplayClass67_0SizeCheck;
}
