...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_2 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* _get__installMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_2::_get__installMethod");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_3<Zenject::DiContainer*, TParam1, TParam2>*>(___internal__instance, "_installMethod")));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Action`3<Zenject.DiContainer,TParam1,TParam2> _installMethod
    void _set__installMethod(System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_2::_set__installMethod");
      static auto ___internal__instance = this;
