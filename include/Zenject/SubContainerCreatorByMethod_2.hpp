...
namespace Zenject {
  // Forward declaring type: SubContainerCreatorByMethod`2<TParam1, TParam2>
...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_2 : public ::Zenject::SubContainerCreatorByMethodBase {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_3<::Zenject::DiContainer*, TParam1, TParam2>*& dyn__installMethod() {
