...
namespace Zenject {
  ...
  class PrefabResourceFactory_4 : public ::CsObject, public Zenject::IFactory_5<::CsString*, P1, P2, P3, T>, public Zenject::IFactory {
    public:
    ...
    T Create(::CsString* prefabResourceName, P1 param, P2 param2, P3 param3) {
    ...
    T Zenject_IFactory_5_Create(::CsString* prefabResourceName, P1 param, P2 param2, P3 param3) {
