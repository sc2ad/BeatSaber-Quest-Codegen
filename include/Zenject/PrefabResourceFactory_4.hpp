...
namespace Zenject {
  // Forward declaring type: PrefabResourceFactory`4<P1, P2, P3, T>
...
namespace Zenject {
  ...
  template<typename P1, typename P2, typename P3, typename T>
  class PrefabResourceFactory_4 : public ::Il2CppObject/*, public ::Zenject::IFactory_5<::StringW, P1, P2, P3, T>*/ {
    public:
    public:
    // [InjectAttribute] Offset: 0x10EED38
    ...
    public:
    // Creating interface conversion operator: operator ::Zenject::IFactory_5<::StringW, P1, P2, P3, T>
    ...
    T Create(::StringW prefabResourceName, P1 param, P2 param2, P3 param3) {
      ...
      return ::il2cpp_utils::RunMethodRethrow<T, false>(this, ___internal__method, prefabResourceName, param, param2, param3);
    }
    // static private System.Object __zenCreate(System.Object[] P_0)
    // Offset: 0xFFFFFFFFFFFFFFFF
    static ::Il2CppObject* __zenCreate(::ArrayW<::Il2CppObject*> P_0) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::PrefabResourceFactory_4::__zenCreate");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PrefabResourceFactory_4<P1, P2, P3, T>*>::get(), "__zenCreate", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(P_0)})));
    ...
    static void __zenFieldSetter0(::Il2CppObject* P_0, ::Il2CppObject* P_1) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::PrefabResourceFactory_4::__zenFieldSetter0");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PrefabResourceFactory_4<P1, P2, P3, T>*>::get(), "__zenFieldSetter0", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(P_0), ::il2cpp_utils::ExtractType(P_1)})));
    ...
    static ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::PrefabResourceFactory_4::__zenCreateInjectTypeInfo");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PrefabResourceFactory_4<P1, P2, P3, T>*>::get(), "__zenCreateInjectTypeInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
