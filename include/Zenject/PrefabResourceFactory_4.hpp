...
namespace Zenject {
  ...
  class PrefabResourceFactory_4 : public ::Il2CppObject/*, public Zenject::IFactory_5<::Il2CppString*, P1, P2, P3, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xDCAFEC
    ...
    Zenject::DiContainer* _get__container() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_4::_get__container");
    ...
    void _set__container(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_4::_set__container");
      static auto ___internal__instance = this;
