...
namespace Zenject {
  ...
  class FactoryProviderWrapper_1 : public ::Il2CppObject/*, public Zenject::IFactory_1<TContract>*/ {
    ...
    Zenject::IProvider* _get__provider() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryProviderWrapper_1::_get__provider");
    ...
    // Set instance field: private readonly Zenject.IProvider _provider
    void _set__provider(Zenject::IProvider* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryProviderWrapper_1::_set__provider");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_provider"))->offset;
    ...
    Zenject::InjectContext* _get__injectContext() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryProviderWrapper_1::_get__injectContext");
      auto ___internal__instance = this;
    ...
    // Autogenerated instance field setter
    // Set instance field: private readonly Zenject.InjectContext _injectContext
    void _set__injectContext(Zenject::InjectContext* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryProviderWrapper_1::_set__injectContext");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_injectContext"))->offset;
