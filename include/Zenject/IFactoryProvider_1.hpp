...
namespace Zenject {
  ...
  class IFactoryProvider_1 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_1<TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      return (IFactoryProvider_1<TContract>*)THROW_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IFactoryProvider_1<TContract>*>::get(), container, factoryId));
    }
