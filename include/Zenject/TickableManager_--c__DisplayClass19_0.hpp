...
namespace Zenject {
  ...
  check_size<sizeof(TickableManager::$$c__DisplayClass19_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_TickableManager_$$c__DisplayClass19_0SizeCheck;
}
