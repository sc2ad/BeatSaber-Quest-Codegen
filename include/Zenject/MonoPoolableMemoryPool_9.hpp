...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_9 : public Zenject::MemoryPool_9<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TValue> {
    ...
    // Offset: 0xFFFFFFFF
    // Implemented from: Zenject.MemoryPool`9
    // Base method: System.Void MemoryPool_9::Reinitialize_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TParam7 p7, TParam8 p8, TValue item)
