...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92070
  template<typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TContract>
  class FactoryFromBinder_5 : public Zenject::FactoryFromBinderBase {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D932A8
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`5/<>c__DisplayClass1_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactoryFromBinder`5/<>c__2`1
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D932B8
    template<typename TSubFactory>
    class $$c__2_1 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__2_1<TSubFactory>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`5/<>c__2`1 is generic, or has no fields that are valid for size checks!
