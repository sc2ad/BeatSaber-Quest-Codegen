...
namespace Zenject {
  ...
  class IFactory_5;
  // Forward declaring type: FactorySubContainerBinder`5<TContract, TParam1, TParam2, TParam3, TParam4>
  template<typename TContract, typename TParam1, typename TParam2, typename TParam3, typename TParam4>
  ...
  class FactoryFromBinder_5 : public Zenject::FactoryFromBinderBase {
    ...
    class $$c__DisplayClass1_0 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__DisplayClass1_0* New_ctor() {
        return (typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__DisplayClass1_0*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__DisplayClass1_0*>::get())));
      }
    ...
    class $$c__2_1 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      static_assert((!std::is_complete_v<std::remove_pointer_t<TSubFactory>> || std::is_base_of_v<Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TContract>, std::remove_pointer_t<TSubFactory>>));
      public:
      using declaring_type = FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*;
      ...
      static typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__2_1<TSubFactory>* New_ctor() {
        return (typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__2_1<TSubFactory>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__2_1<TSubFactory>*>::get())));
      }
    ...
    static FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* New_ctor(Zenject::DiContainer* container, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      return (FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*>::get(), container, bindInfo, factoryBindInfo)));
    }
    ...
    // Offset: 0xFFFFFFFF
    Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* FromSubContainerResolve(::CsObject* subIdentifier) {
