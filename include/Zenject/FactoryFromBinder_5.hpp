...
namespace Zenject {
  ...
  class FactoryFromBinder_5 : public Zenject::FactoryFromBinderBase {
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`5/<>c__DisplayClass1_0 is generic!
    ...
    class $$c__2_1 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>::$$c__2_1<TSubFactory>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`5/<>c__2`1 is generic!
    ...
    static FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* New_ctor(Zenject::DiContainer* container, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_5").WithContext(".ctor");
    ...
    Zenject::ConditionCopyNonLazyBinder* FromMethod(System::Func_6<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TContract>* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_5").WithContext("FromMethod");
    ...
    Zenject::ConditionCopyNonLazyBinder* FromFactory() {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_5").WithContext("FromFactory");
    ...
    Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* FromSubContainerResolve() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_5").WithContext("FromSubContainerResolve");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*>(), "FromSubContainerResolve", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* FromSubContainerResolve(::Il2CppObject* subIdentifier) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_5").WithContext("FromSubContainerResolve");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::FactorySubContainerBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*>(), "FromSubContainerResolve", {}, ::il2cpp_utils::ExtractTypes(subIdentifier))));
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder`5 is generic!
}
