...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D939A8
  ...
  // Could not write size check! Type: Zenject.FromBinder/<>c__DisplayClass71_0`2 is generic, or has no fields that are valid for size checks!
}
