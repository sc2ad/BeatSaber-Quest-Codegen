...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_5 : public Zenject::MemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue> {
    ...
    void OnCreated(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_5").WithContext("OnCreated");
    ...
    void OnDestroyed(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_5").WithContext("OnDestroyed");
    ...
    void OnDespawned(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_5").WithContext("OnDespawned");
    ...
    static MonoPoolableMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_5").WithContext(".ctor");
    ...
    void Reinitialize(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_5").WithContext("Reinitialize");
