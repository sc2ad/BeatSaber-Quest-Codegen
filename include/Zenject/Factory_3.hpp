...
namespace Zenject {
  ...
  class Factory_3 : public Zenject::PlaceholderFactory_3<TParam1, TParam2, TValue> {
    ...
    static Factory_3<TParam1, TParam2, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("Factory_3").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<Factory_3<TParam1, TParam2, TValue>*>()));
    }
  }; // Zenject.Factory`3
  // Could not write size check! Type: Zenject.Factory`3 is generic!
}
