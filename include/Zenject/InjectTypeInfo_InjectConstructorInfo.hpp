...
namespace Zenject {
  ...
  class InjectTypeInfo::InjectConstructorInfo : public ::Il2CppObject {
    ...
    ::ArrayWrapper<Zenject::InjectableInfo*>& dyn_Parameters();
    // public System.Void .ctor(Zenject.ZenFactoryMethod factory, Zenject.InjectableInfo[] parameters)
    // Offset: 0x2610E30
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static InjectTypeInfo::InjectConstructorInfo* New_ctor(Zenject::ZenFactoryMethod* factory, ::ArrayWrapper<Zenject::InjectableInfo*> parameters) {
  ...
  #pragma pack(pop)
  static check_size<sizeof(InjectTypeInfo::InjectConstructorInfo), 24 + sizeof(::ArrayWrapper<Zenject::InjectableInfo*>)> __Zenject_InjectTypeInfo_InjectConstructorInfoSizeCheck;
