...
namespace Zenject {
  ...
  class FactorySubContainerBinder_6 : public Zenject::FactorySubContainerBinderWithParams_1<TContract> {
    ...
    static FactorySubContainerBinder_6<TContract, TParam1, TParam2, TParam3, TParam4, TParam5>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, ::Il2CppObject* subIdentifier) {
      return THROW_UNLESS((il2cpp_utils::New<FactorySubContainerBinder_6<TContract, TParam1, TParam2, TParam3, TParam4, TParam5>*>(bindContainer, bindInfo, factoryBindInfo, subIdentifier)));
    }
