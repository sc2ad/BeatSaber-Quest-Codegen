...
namespace Zenject {
  ...
  class MonoInstaller_6 : public Zenject::MonoInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_6").WithContext("InstallFromResource");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived>*>::get(), il2cpp_utils::NoArgClass<TDerived>(), "InstallFromResource", {}, ::il2cpp_utils::ExtractTypes(container, p1, p2, p3, p4, p5))));
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_6").WithContext("InstallFromResource");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived>*>::get(), il2cpp_utils::NoArgClass<TDerived>(), "InstallFromResource", {}, ::il2cpp_utils::ExtractTypes(resourcePath, container, p1, p2, p3, p4, p5))));
    ...
    static MonoInstaller_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_6").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MonoInstaller_6<TParam1, TParam2, TParam3, TParam4, TParam5, TDerived>*>()));
    }
  }; // Zenject.MonoInstaller`6
  // Could not write size check! Type: Zenject.MonoInstaller`6 is generic!
}
