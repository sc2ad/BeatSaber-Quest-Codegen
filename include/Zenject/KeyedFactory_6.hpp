...
namespace Zenject {
  ...
  class KeyedFactory_6 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    // Offset: 0xFFFFFFFF
    TBase Create_NEW(TKey key, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::KeyedFactory_6::Create_NEW");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(key, param1, param2, param3, param4)));
