...
namespace Zenject {
  ...
  class ZenjectBinding : public UnityEngine::MonoBehaviour {
    ...
    check_size<sizeof(ZenjectBinding::BindTypes), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Zenject_ZenjectBinding_BindTypesSizeCheck;
  ...
  check_size<sizeof(ZenjectBinding), 56 + sizeof(Zenject::ZenjectBinding::BindTypes) + ((56 + sizeof(Zenject::ZenjectBinding::BindTypes)) % 8 != 0 ? (8 - (56 + sizeof(Zenject::ZenjectBinding::BindTypes)) % 8) : 0)> __Zenject_ZenjectBindingSizeCheck;
}
