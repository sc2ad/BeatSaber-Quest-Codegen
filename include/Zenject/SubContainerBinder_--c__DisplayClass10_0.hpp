...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerBinder::$$c__DisplayClass10_0), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerBinder_$$c__DisplayClass10_0SizeCheck;
}
