...
namespace Zenject {
  ...
  check_size<sizeof(GuiRenderableManager::$$c__DisplayClass1_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_GuiRenderableManager_$$c__DisplayClass1_0SizeCheck;
}
