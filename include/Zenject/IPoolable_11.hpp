...
namespace Zenject {
  // Forward declaring type: IPoolable`11<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TParam11>
...
namespace Zenject {
  ...
  class IPoolable_11 {
    ...
    void OnSpawned(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TParam7 p7, TParam8 p8, TParam9 p9, TParam10 p10, TParam11 p11) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)));
    }
