...
namespace Zenject {
  ...
  class PlaceholderFactory_1 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_1<TValue>*/ {
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`1/<get_ParamTypes>d__2 is generic!
  ...
  // Could not write size check! Type: Zenject.PlaceholderFactory`1 is generic!
}
