...
namespace Zenject {
  ...
  class PlaceholderFactory_1 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_1<TValue>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF03C0
    class $get_ParamTypes$d__2 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>*/ {
      ...
      void System_IDisposable_Dispose_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.IDisposable.Dispose_NEW");
      ...
      // Offset: 0xFFFFFFFF
      bool MoveNext_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::MoveNext_NEW");
      ...
      System::Type* System_Collections_Generic_IEnumerator$System_Type$_get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.Collections.Generic.IEnumerator<System.Type>.get_Current_NEW");
      ...
      void System_Collections_IEnumerator_Reset_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.Collections.IEnumerator.Reset_NEW");
      ...
      ::Il2CppObject* System_Collections_IEnumerator_get_Current_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.Collections.IEnumerator.get_Current_NEW");
      ...
      System::Collections::Generic::IEnumerator_1<System::Type*>* System_Collections_Generic_IEnumerable$System_Type$_GetEnumerator_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.Collections.Generic.IEnumerable<System.Type>.GetEnumerator_NEW");
      ...
      System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator_NEW() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::$get_ParamTypes$d__2::System.Collections.IEnumerable.GetEnumerator_NEW");
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`1/<get_ParamTypes>d__2 is generic, or has no fields that are valid for size checks!
    ...
    // Offset: 0xFFFFFFFF
    TValue Create_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_1::Create_NEW");
