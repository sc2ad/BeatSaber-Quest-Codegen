...
namespace Zenject {
  ...
  class TransientProvider : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xFD075C
    static TransientProvider* New_ctor(System::Type* concreteType, Zenject::DiContainer* container, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, ::CsString* bindingContext, ::CsObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback);
