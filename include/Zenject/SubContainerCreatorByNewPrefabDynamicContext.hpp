...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEF418
  class SubContainerCreatorByNewPrefabDynamicContext : public Zenject::SubContainerCreatorDynamicContext {
    ...
    // Base method: UnityEngine.GameObject SubContainerCreatorDynamicContext::CreateGameObject_NEW(out System.Boolean shouldMakeActive)
