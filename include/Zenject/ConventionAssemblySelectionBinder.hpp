...
namespace Zenject {
  ...
  check_size<sizeof(ConventionAssemblySelectionBinder), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_ConventionAssemblySelectionBinderSizeCheck;
}
