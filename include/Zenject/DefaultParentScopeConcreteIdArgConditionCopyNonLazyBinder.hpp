...
namespace Zenject {
  ...
  check_size<sizeof(DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __Zenject_DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinderSizeCheck;
}
