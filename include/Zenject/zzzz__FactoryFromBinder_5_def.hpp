...
class Zenject__FactoryFromBinder_5____c__DisplayClass1_0;
}
namespace Zenject {
...
class Zenject__FactoryFromBinder_5____c__2_1;
}
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TContract>
...
class Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory>;
}
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TContract>
class Zenject__FactoryFromBinder_5____c__DisplayClass1_0<TParam1,TParam2,TParam3,TParam4,TContract>;
}
...
class CORDL_TYPE Zenject__FactoryFromBinder_5____c__DisplayClass1_0<TParam1,TParam2,TParam3,TParam4,TContract> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~Zenject__FactoryFromBinder_5____c__DisplayClass1_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__FactoryFromBinder_5____c__DisplayClass1_0", modifiers: " const&", def_value: None }]
constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0(Zenject__FactoryFromBinder_5____c__DisplayClass1_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__FactoryFromBinder_5____c__DisplayClass1_0", modifiers: "&&", def_value: None }]
constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0(Zenject__FactoryFromBinder_5____c__DisplayClass1_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__FactoryFromBinder_5____c__DisplayClass1_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0& operator=(Zenject__FactoryFromBinder_5____c__DisplayClass1_0&& o) noexcept = default;
  constexpr Zenject__FactoryFromBinder_5____c__DisplayClass1_0& operator=(Zenject__FactoryFromBinder_5____c__DisplayClass1_0 const& o) noexcept = default;
...
static Zenject::Zenject__FactoryFromBinder_5____c__DisplayClass1_0<TParam1,TParam2,TParam3,TParam4,TContract> New_ctor() ;
...
class CORDL_TYPE Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~Zenject__FactoryFromBinder_5____c__2_1() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__FactoryFromBinder_5____c__2_1", modifiers: " const&", def_value: None }]
constexpr Zenject__FactoryFromBinder_5____c__2_1(Zenject__FactoryFromBinder_5____c__2_1 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__FactoryFromBinder_5____c__2_1", modifiers: "&&", def_value: None }]
constexpr Zenject__FactoryFromBinder_5____c__2_1(Zenject__FactoryFromBinder_5____c__2_1&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__FactoryFromBinder_5____c__2_1(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__FactoryFromBinder_5____c__2_1& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__FactoryFromBinder_5____c__2_1& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__FactoryFromBinder_5____c__2_1& operator=(Zenject__FactoryFromBinder_5____c__2_1&& o) noexcept = default;
  constexpr Zenject__FactoryFromBinder_5____c__2_1& operator=(Zenject__FactoryFromBinder_5____c__2_1 const& o) noexcept = default;
                


// Fields

static Zenject::Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(Zenject::Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory> value) ;

static Zenject::Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory> __get___9() ;
...
static Zenject::Zenject__FactoryFromBinder_5____c__2_1<TParam1,TParam2,TParam3,TParam4,TContract,TSubFactory> New_ctor() ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10788)), TypeDefinitionIndex(TypeDefinitionIndex(10698))}
...
using __c__2_1 = Zenject::Zenject__FactoryFromBinder_5____c__2_1<TParam1, TParam2, TParam3, TParam4, TContract, TParam1, TParam2, TParam3, TParam4, TContract, TSubFactory>;

using __c__DisplayClass1_0 = Zenject::Zenject__FactoryFromBinder_5____c__DisplayClass1_0<TParam1, TParam2, TParam3, TParam4, TContract>;
...
static Zenject::FactoryFromBinder_5<TParam1,TParam2,TParam3,TParam4,TContract> New_ctor(Zenject::DiContainer container, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__FactoryFromBinder_5____c__2_1, "Zenject", "FactoryFromBinder`5/<>c__2`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__FactoryFromBinder_5____c__DisplayClass1_0, "Zenject", "FactoryFromBinder`5/<>c__DisplayClass1_0");
