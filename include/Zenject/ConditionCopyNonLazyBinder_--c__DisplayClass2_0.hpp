...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::Array<::Il2CppObject*>*)>(&Zenject::ConditionCopyNonLazyBinder::$$c__DisplayClass2_0::__zenCreate)> {
  static const MethodInfo* get() {
