...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D930D8
  ...
  class FactoryFromBinder0Extensions::$$c__DisplayClass0_0_2 : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    Zenject::IProvider* $FromPoolableMemoryPool$b__0(Zenject::DiContainer* container) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass0_0_2").WithContext("<FromPoolableMemoryPool>b__0");
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder0Extensions/<>c__DisplayClass0_0`2 is generic, or has no fields that are valid for size checks!
}
