...
namespace Zenject {
  ...
  class FactoryFromBinder4Extensions::$$c__DisplayClass0_0_5 : public ::Il2CppObject {
    ...
    // Offset: 0xFFFFFFFF
    Zenject::IProvider* $FromIFactory$b__0(Zenject::DiContainer* container) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass0_0_5").WithContext("<FromIFactory>b__0");
    ...
    static FactoryFromBinder4Extensions::$$c__DisplayClass0_0_5<TParam1, TParam2, TParam3, TParam4, TContract>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass0_0_5").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<FactoryFromBinder4Extensions::$$c__DisplayClass0_0_5<TParam1, TParam2, TParam3, TParam4, TContract>*>()));
    }
  }; // Zenject.FactoryFromBinder4Extensions/<>c__DisplayClass0_0`5
  // Could not write size check! Type: Zenject.FactoryFromBinder4Extensions/<>c__DisplayClass0_0`5 is generic!
}
