...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerPrefabBindingFinalizer::$$c__DisplayClass6_0), 24 + sizeof(void*) + 8 - (24 + sizeof(void*)) % 8> __Zenject_SubContainerPrefabBindingFinalizer_$$c__DisplayClass6_0SizeCheck;
}
