...
// CS Name: Zenject.IFactory`8
class CORDL_TYPE IFactory_8 : public ::cordl_internals::InterfaceW {
public:
// Declarations
...
constexpr explicit IFactory_8(void* ptr) noexcept : ::cordl_internals::InterfaceW(ptr) {
}
