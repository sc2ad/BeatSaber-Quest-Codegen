...
namespace Zenject {
  ...
  class FactorySubContainerBinder_7 : public Zenject::FactorySubContainerBinderWithParams_1<TContract> {
    ...
    // Offset: 0xFFFFFFFF
    Zenject::NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder* ByNewPrefabResourceMethod(::CsString* resourcePath, System::Action_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* installerMethod) {
    ...
    static FactorySubContainerBinder_7<TContract, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, ::CsObject* subIdentifier) {
