...
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3>
class ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3>
class ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0<TParam1,TParam2,TParam3>;
}
...
class CORDL_TYPE ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0<TParam1,TParam2,TParam3> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0", modifiers: " const&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0", modifiers: "&&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0&& o) noexcept = default;
  constexpr ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0() ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11197)), TypeDefinitionIndex(TypeDefinitionIndex(11206))}
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0<TParam1, TParam2, TParam3>;
...
// Ctor Parameters [CppParam { name: "container", ty: "::Zenject::DiContainer", modifiers: "", def_value: None }, CppParam { name: "gameObjectBindInfo", ty: "::Zenject::GameObjectCreationParameters", modifiers: "", def_value: None }, CppParam { name: "installerMethod", ty: "::System::Action_4<::Zenject::DiContainer,TParam1,TParam2,TParam3>", modifiers: "", def_value: None }]
explicit SubContainerCreatorByNewGameObjectMethod_3(::Zenject::DiContainer container, ::Zenject::GameObjectCreationParameters gameObjectBindInfo, ::System::Action_4<::Zenject::DiContainer,TParam1,TParam2,TParam3> installerMethod) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__SubContainerCreatorByNewGameObjectMethod_3____c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`3/<>c__DisplayClass2_0");
