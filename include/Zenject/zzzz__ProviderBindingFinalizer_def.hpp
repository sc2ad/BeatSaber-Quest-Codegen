...
namespace Zenject {
class ____Zenject__ProviderBindingFinalizer____c;
}
// Type: ::<>c
namespace Zenject {
// Is value type: false
...
class CORDL_TYPE ____Zenject__ProviderBindingFinalizer____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____Zenject__ProviderBindingFinalizer____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__ProviderBindingFinalizer____c", modifiers: " const&", def_value: None }]
constexpr ____Zenject__ProviderBindingFinalizer____c(____Zenject__ProviderBindingFinalizer____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__ProviderBindingFinalizer____c", modifiers: "&&", def_value: None }]
constexpr ____Zenject__ProviderBindingFinalizer____c(____Zenject__ProviderBindingFinalizer____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__ProviderBindingFinalizer____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__ProviderBindingFinalizer____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__ProviderBindingFinalizer____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__ProviderBindingFinalizer____c& operator=(____Zenject__ProviderBindingFinalizer____c&& o) noexcept = default;
  constexpr ____Zenject__ProviderBindingFinalizer____c& operator=(____Zenject__ProviderBindingFinalizer____c const& o) noexcept = default;
                


// Fields

static ::Zenject::____Zenject__ProviderBindingFinalizer____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::Zenject::____Zenject__ProviderBindingFinalizer____c value) ;

static ::Zenject::____Zenject__ProviderBindingFinalizer____c __get___9() ;
...
// Ctor Parameters []
explicit ____Zenject__ProviderBindingFinalizer____c() ;
...
public:
// Declarations
using __c = ::Zenject::____Zenject__ProviderBindingFinalizer____c;
...
NEED_NO_BOX(::Zenject::____Zenject__ProviderBindingFinalizer____c);
DEFINE_IL2CPP_ARG_TYPE(::Zenject::____Zenject__ProviderBindingFinalizer____c, "Zenject", "ProviderBindingFinalizer/<>c");
