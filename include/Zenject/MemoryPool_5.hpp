...
namespace Zenject {
  ...
  class MemoryPool_5 : public Zenject::MemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>, public Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>*/ {
    ...
    TValue Spawn_NEW(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_5::Spawn_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Reinitialize_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_5::Reinitialize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    TValue Zenject_IFactory$TParam1_TParam2_TParam3_TParam4_TValue$_Create_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_5::Zenject.IFactory<TParam1,TParam2,TParam3,TParam4,TValue>.Create_NEW");
