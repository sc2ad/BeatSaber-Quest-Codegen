...
namespace Zenject {
  ...
  class MemoryPool_5 : public Zenject::MemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_5<TParam1, TParam2, TParam3, TParam4, TValue>, public Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>*/ {
    ...
    TValue Zenject_IFactory$TParam1_TParam2_TParam3_TParam4_TValue$_Create(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      ...
      auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "Zenject.IFactory<TParam1,TParam2,TParam3,TParam4,TValue>.Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(p1, p2, p3, p4))));
