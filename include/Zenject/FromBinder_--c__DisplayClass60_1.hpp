...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass60_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xF20BF8
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentsInChildrenBase$b__1(Zenject::InjectContext* ctx);
