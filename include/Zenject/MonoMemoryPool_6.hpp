...
namespace Zenject {
  ...
  class MonoMemoryPool_6 : public Zenject::MemoryPool_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue> {
    ...
    UnityEngine::Transform* _get__originalParent() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoMemoryPool_6::_get__originalParent");
    ...
    void _set__originalParent(UnityEngine::Transform* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoMemoryPool_6::_set__originalParent");
      static auto ___internal__instance = this;
