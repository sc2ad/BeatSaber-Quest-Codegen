...
namespace Zenject {
  ...
  class ConditionCopyNonLazyBinder::$$c__5_1 : public ::Il2CppObject {
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ConditionCopyNonLazyBinder::$$c__5_1<T>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    bool $WhenNotInjectedInto$b__5_0(Zenject::InjectContext* r) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<bool>(), "<WhenNotInjectedInto>b__5_0", {}, ::il2cpp_utils::ExtractTypes(r))));
    ...
    static ConditionCopyNonLazyBinder::$$c__5_1<T>* New_ctor() {
      ...
      return THROW_UNLESS(::il2cpp_utils::New<ConditionCopyNonLazyBinder::$$c__5_1<T>*>());
    }
  }; // Zenject.ConditionCopyNonLazyBinder/<>c__5`1
  // Could not write size check! Type: Zenject.ConditionCopyNonLazyBinder/<>c__5`1 is generic!
}
