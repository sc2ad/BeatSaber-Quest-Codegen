...
class ____Zenject__FromBinderNonGeneric____c__1_2;
}
namespace Zenject {
...
class ____Zenject__FromBinderNonGeneric____c__1_2<TConcrete,TFactory>;
}
// Type: ::<>c__1`2
...
// Declarations
template<typename TConcrete,typename TFactory>
using __c__1_2 = ::Zenject::____Zenject__FromBinderNonGeneric____c__1_2<TConcrete, TFactory>;
...
class CORDL_TYPE ____Zenject__FromBinderNonGeneric____c__1_2<TConcrete,TFactory> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____Zenject__FromBinderNonGeneric____c__1_2() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__FromBinderNonGeneric____c__1_2", modifiers: " const&", def_value: None }]
constexpr ____Zenject__FromBinderNonGeneric____c__1_2(____Zenject__FromBinderNonGeneric____c__1_2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__FromBinderNonGeneric____c__1_2", modifiers: "&&", def_value: None }]
constexpr ____Zenject__FromBinderNonGeneric____c__1_2(____Zenject__FromBinderNonGeneric____c__1_2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__FromBinderNonGeneric____c__1_2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__FromBinderNonGeneric____c__1_2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__FromBinderNonGeneric____c__1_2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__FromBinderNonGeneric____c__1_2& operator=(____Zenject__FromBinderNonGeneric____c__1_2&& o) noexcept = default;
  constexpr ____Zenject__FromBinderNonGeneric____c__1_2& operator=(____Zenject__FromBinderNonGeneric____c__1_2 const& o) noexcept = default;
                


// Fields

static ::Zenject::____Zenject__FromBinderNonGeneric____c__1_2<TConcrete,TFactory> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::Zenject::____Zenject__FromBinderNonGeneric____c__1_2<TConcrete,TFactory> value) ;

static ::Zenject::____Zenject__FromBinderNonGeneric____c__1_2<TConcrete,TFactory> __get___9() ;
...
// Ctor Parameters []
explicit ____Zenject__FromBinderNonGeneric____c__1_2() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__FromBinderNonGeneric____c__1_2, "Zenject", "FromBinderNonGeneric/<>c__1`2");
