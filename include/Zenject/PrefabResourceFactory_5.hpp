...
namespace Zenject {
  ...
  class PrefabResourceFactory_5 : public ::Il2CppObject/*, public Zenject::IFactory_6<::Il2CppString*, P1, P2, P3, P4, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xCF0BC0
    ...
    // Offset: 0xFFFFFFFF
    T Create_NEW(::Il2CppString* prefabResourceName, P1 param, P2 param2, P3 param3, P4 param4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_5::Create_NEW");
