...
namespace Zenject {
  ...
  class PrefabResourceFactory_5 : public ::CsObject, public Zenject::IFactory_6<::CsString*, P1, P2, P3, P4, T>, public Zenject::IFactory {
    public:
    ...
    T Create(::CsString* prefabResourceName, P1 param, P2 param2, P3 param3, P4 param4) {
    ...
    T Zenject_IFactory_6_Create(::CsString* prefabResourceName, P1 param, P2 param2, P3 param3, P4 param4) {
