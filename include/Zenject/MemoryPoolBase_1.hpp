...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [ZenjectAllowDuringValidationAttribute] Offset: CEEDC8
  ...
  class MemoryPoolBase_1 : public ::Il2CppObject/*, public Zenject::IValidatable, public Zenject::IMemoryPool, public System::IDisposable*/ {
    ...
    int get_NumTotal_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::get_NumTotal_NEW");
    ...
    int get_NumInactive_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::get_NumInactive_NEW");
    ...
    int get_NumActive_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::get_NumActive_NEW");
    ...
    System::Type* get_ItemType_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::get_ItemType_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Dispose_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Dispose_NEW");
    ...
    void Zenject_IMemoryPool_Despawn_NEW(::Il2CppObject* item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Zenject.IMemoryPool.Despawn_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Despawn_NEW(TContract item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Despawn_NEW");
    ...
    void Zenject_IValidatable_Validate_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Zenject.IValidatable.Validate_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Clear_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Clear_NEW");
    ...
    void ShrinkBy_NEW(int numToRemove) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::ShrinkBy_NEW");
    ...
    void ExpandBy_NEW(int numToAdd) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::ExpandBy_NEW");
    ...
    void Resize_NEW(int desiredPoolSize) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::Resize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnDespawned_NEW(TContract item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::OnDespawned_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnSpawned_NEW(TContract item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::OnSpawned_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnCreated_NEW(TContract item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::OnCreated_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnDestroyed_NEW(TContract item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBase_1::OnDestroyed_NEW");
