...
constexpr  Zenject::PrefabFactory_4<P1,P2,P3,T>::operator Zenject::IFactory_5<UnityEngine::Object,P1,P2,P3,T>() const noexcept {
return Zenject::IFactory_5<UnityEngine::Object,P1,P2,P3,T>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to Zenject::IFactory
constexpr  Zenject::PrefabFactory_4<P1,P2,P3,T>::operator Zenject::IFactory() const noexcept {
return Zenject::IFactory(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Zenject::PrefabFactory_4<P1,P2,P3,T>::__set__container(Zenject::DiContainer value)  {
...
constexpr Zenject::DiContainer Zenject::PrefabFactory_4<P1,P2,P3,T>::__get__container() const {
return ::cordl_internals::getInstanceField<Zenject::DiContainer, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
 Zenject::DiContainer Zenject::PrefabFactory_4<P1,P2,P3,T>::get_Container()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
                            "get_Container",
...
return ::cordl_internals::RunMethodRethrow<Zenject::DiContainer, false>(const_cast<void*>(instance), ___internal_method);
 ...
 T Zenject::PrefabFactory_4<P1,P2,P3,T>::Create(UnityEngine::Object prefab, P1 param, P2 param2, P3 param3)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
                            "Create",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<T, false>(const_cast<void*>(instance), ___internal_method, prefab, param, param2, param3);
 ...
 Zenject::PrefabFactory_4<P1,P2,P3,T> Zenject::PrefabFactory_4<P1,P2,P3,T>::New_ctor()  {
Zenject::PrefabFactory_4<P1,P2,P3,T> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::PrefabFactory_4<P1,P2,P3,T>>())};
return o;
}
 void Zenject::PrefabFactory_4<P1,P2,P3,T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::bs_hook::Il2CppWrapperType Zenject::PrefabFactory_4<P1,P2,P3,T>::__zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
                            "__zenCreate",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::bs_hook::Il2CppWrapperType, false>(nullptr, ___internal_method, P_0);
 ...
 void Zenject::PrefabFactory_4<P1,P2,P3,T>::__zenFieldSetter0(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
                            "__zenFieldSetter0",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, P_0, P_1);
 ...
 Zenject::InjectTypeInfo Zenject::PrefabFactory_4<P1,P2,P3,T>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabFactory_4<P1,P2,P3,T>>::get(),
