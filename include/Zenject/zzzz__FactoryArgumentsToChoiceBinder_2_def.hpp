...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10791)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10791), inst: 1825 }), TypeDefinitionIndex(TypeDefinitionIndex(10646))}
