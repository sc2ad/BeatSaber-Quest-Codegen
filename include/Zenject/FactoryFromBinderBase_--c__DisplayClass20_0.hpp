...
namespace Zenject {
  ...
  check_size<sizeof(FactoryFromBinderBase::$$c__DisplayClass20_0), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_FactoryFromBinderBase_$$c__DisplayClass20_0SizeCheck;
}
