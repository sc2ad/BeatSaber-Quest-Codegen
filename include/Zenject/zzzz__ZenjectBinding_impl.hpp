...
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes::____Zenject__ZenjectBinding__BindTypes(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Zenject::____Zenject__ZenjectBinding__BindTypes::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Zenject::____Zenject__ZenjectBinding__BindTypes::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes  ::Zenject::____Zenject__ZenjectBinding__BindTypes::Self{0};
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes  ::Zenject::____Zenject__ZenjectBinding__BindTypes::AllInterfaces{1};
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes  ::Zenject::____Zenject__ZenjectBinding__BindTypes::AllInterfacesAndSelf{2};
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes  ::Zenject::____Zenject__ZenjectBinding__BindTypes::BaseType{3};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::____Zenject__ZenjectBinding__BindTypes (::Zenject::ZenjectBinding::*)()>(&::Zenject::ZenjectBinding::get_BindType)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void ::Zenject::ZenjectBinding::__set__bindType(::Zenject::____Zenject__ZenjectBinding__BindTypes value)  {
::cordl_internals::setInstanceField<::Zenject::____Zenject__ZenjectBinding__BindTypes, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Zenject::____Zenject__ZenjectBinding__BindTypes>(value));
}
constexpr ::Zenject::____Zenject__ZenjectBinding__BindTypes ::Zenject::ZenjectBinding::__get__bindType() const {
return ::cordl_internals::getInstanceField<::Zenject::____Zenject__ZenjectBinding__BindTypes, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::Zenject::____Zenject__ZenjectBinding__BindTypes ::Zenject::ZenjectBinding::get_BindType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ZenjectBinding>::get(),
                            "get_BindType",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::Zenject::____Zenject__ZenjectBinding__BindTypes, false>(const_cast<void*>(instance), ___internal_method);
}
