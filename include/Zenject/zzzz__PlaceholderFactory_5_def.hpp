...
namespace Zenject {
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TValue>
class ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TValue>
class ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2<TParam1,TParam2,TParam3,TParam4,TValue>;
}
...
class CORDL_TYPE ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2<TParam1,TParam2,TParam3,TParam4,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2", modifiers: " const&", def_value: None }]
constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2(____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2(____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2& operator=(____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2&& o) noexcept = default;
  constexpr ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2& operator=(____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2 const& o) noexcept = default;
...
explicit ____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2(int32_t __1__state) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 4671 }), TypeDefinitionIndex(TypeDefinitionIndex(10968)), TypeDefinitionIndex(TypeDefinitionIndex(10956))}
...
public:
// Declarations
using _get_ParamTypes_d__2 = ::Zenject::____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__PlaceholderFactory_5___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`5/<get_ParamTypes>d__2");
