...
namespace Zenject {
  ...
  class IPoolable_4 {
    ...
    void OnDespawned_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IPoolable_4::OnDespawned_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void OnSpawned_NEW(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IPoolable_4::OnSpawned_NEW");
