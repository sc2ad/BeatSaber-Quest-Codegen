...
namespace Zenject {
  ...
  check_size<sizeof(AddToCurrentGameObjectComponentProvider), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __Zenject_AddToCurrentGameObjectComponentProviderSizeCheck;
}
