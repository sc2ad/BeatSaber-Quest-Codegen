...
namespace Zenject {
  ...
  class AddToCurrentGameObjectComponentProvider : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0x30
    System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback;
    ...
    // Offset: 0xD62D34
    static AddToCurrentGameObjectComponentProvider* New_ctor(Zenject::DiContainer* container, System::Type* componentType, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, ::CsObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback);
