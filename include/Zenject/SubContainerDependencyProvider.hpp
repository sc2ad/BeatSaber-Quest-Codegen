...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerDependencyProvider), 40 + sizeof(bool) + ((40 + sizeof(bool)) % 8 != 0 ? (8 - (40 + sizeof(bool)) % 8) : 0)> __Zenject_SubContainerDependencyProviderSizeCheck;
}
