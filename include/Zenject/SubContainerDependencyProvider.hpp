...
namespace Zenject {
  ...
  class SubContainerDependencyProvider : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xFCC394
    static SubContainerDependencyProvider* New_ctor(System::Type* dependencyType, ::CsObject* identifier, Zenject::ISubContainerCreator* subContainerCreator, bool resolveAll);
