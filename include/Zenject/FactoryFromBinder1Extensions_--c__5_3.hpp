...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93178
  ...
  class FactoryFromBinder1Extensions::$$c__5_3 : public ::Il2CppObject {
    public:
    // Creating value type constructor for type: $$c__5_3
    $$c__5_3() noexcept {}
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder1Extensions::$$c__5_3<TParam1, TContract, TMemoryPool>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder1Extensions/<>c__5`3 is generic, or has no fields that are valid for size checks!
}
