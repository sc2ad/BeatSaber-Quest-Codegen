...
namespace Zenject {
  ...
  class MonoMemoryPool_2 : public Zenject::MemoryPool_2<TParam1, TValue> {
    ...
    UnityEngine::Transform* _get__originalParent() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoMemoryPool_2::_get__originalParent");
    ...
    void _set__originalParent(UnityEngine::Transform* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoMemoryPool_2::_set__originalParent");
      static auto ___internal__instance = this;
