...
namespace Zenject {
  ...
  class FactoryFromBinder_4 : public Zenject::FactoryFromBinderBase {
    ...
    class $$c__2_1;
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactoryFromBinder`4/Zenject.<>c__DisplayClass1_0
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    class $$c__DisplayClass1_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      // Get instance field: public System.Func`5<Zenject.DiContainer,TParam1,TParam2,TParam3,TContract> method
      System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TContract>*& dyn_method() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_4::$$c__DisplayClass1_0::dyn_method");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "method"))->offset;
        return *reinterpret_cast<System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TContract>**>(reinterpret_cast<char*>(this) + ___internal__field__offset);
      }
      ...
      static ::Il2CppObject* __zenCreate(::ArrayW<::Il2CppObject*> P_0) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_4::$$c__DisplayClass1_0::__zenCreate");
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__DisplayClass1_0*>::get(), "__zenCreate", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(P_0)})));
      ...
      static Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_4::$$c__DisplayClass1_0::__zenCreateInjectTypeInfo");
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__DisplayClass1_0*>::get(), "__zenCreateInjectTypeInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
    ...
    }; // Zenject.FactoryFromBinder`4/Zenject.<>c__DisplayClass1_0
    // Could not write size check! Type: Zenject.FactoryFromBinder`4/Zenject.<>c__DisplayClass1_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactoryFromBinder`4/Zenject.<>c__2`1
    // [TokenAttribute] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: FFFFFFFF
    template<typename TSubFactory>
    class $$c__2_1 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      // Get static field: static public readonly Zenject.FactoryFromBinder`4/Zenject.<>c__2`1<TParam1,TParam2,TParam3,TContract,TSubFactory> <>9
      ...
      // Set static field: static public readonly Zenject.FactoryFromBinder`4/Zenject.<>c__2`1<TParam1,TParam2,TParam3,TContract,TSubFactory> <>9
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
      ...
      // Offset: 0xFFFFFFFF
      static ::Il2CppObject* __zenCreate(::ArrayW<::Il2CppObject*> P_0) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_4::$$c__2_1::__zenCreate");
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>*>::get(), "__zenCreate", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(P_0)})));
        return THROW_UNLESS((::il2cpp_utils::RunMethod<::Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, P_0)));
      }
      // static private Zenject.InjectTypeInfo __zenCreateInjectTypeInfo()
      // Offset: 0xFFFFFFFF
      static Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_4::$$c__2_1::__zenCreateInjectTypeInfo");
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>*>::get(), "__zenCreateInjectTypeInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
        return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::InjectTypeInfo*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method)));
      }
      // public System.Void .ctor()
      // Offset: 0xFFFFFFFF
    ...
    }; // Zenject.FactoryFromBinder`4/Zenject.<>c__2`1
    // Could not write size check! Type: Zenject.FactoryFromBinder`4/Zenject.<>c__2`1 is generic, or has no fields that are valid for size checks!
    ...
    Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>* FromSubContainerResolve() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>* FromSubContainerResolve(::Il2CppObject* subIdentifier) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>*, false>(this, ___internal__method, subIdentifier)));
    }
