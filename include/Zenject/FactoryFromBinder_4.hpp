...
namespace Zenject {
  ...
  class FactoryFromBinder_4 : public Zenject::FactoryFromBinderBase {
    ...
    class $$c__DisplayClass1_0 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__DisplayClass1_0* New_ctor() {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__DisplayClass1_0*>()));
      }
    }; // Zenject.FactoryFromBinder`4/<>c__DisplayClass1_0
    // Could not write size check! Type: Zenject.FactoryFromBinder`4/<>c__DisplayClass1_0 is generic!
    ...
    class $$c__2_1 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
      ...
      static typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>* New_ctor() {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>::$$c__2_1<TSubFactory>*>()));
      }
    }; // Zenject.FactoryFromBinder`4/<>c__2`1
    // Could not write size check! Type: Zenject.FactoryFromBinder`4/<>c__2`1 is generic!
    ...
    static FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>* New_ctor(Zenject::DiContainer* container, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_4").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<FactoryFromBinder_4<TParam1, TParam2, TParam3, TContract>*>(container, bindInfo, factoryBindInfo)));
    }
    ...
    Zenject::ConditionCopyNonLazyBinder* FromMethod(System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TContract>* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_4").WithContext("FromMethod");
    ...
    Zenject::ConditionCopyNonLazyBinder* FromFactory() {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_4").WithContext("FromFactory");
    ...
    Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>* FromSubContainerResolve() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_4").WithContext("FromSubContainerResolve");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>*>(), "FromSubContainerResolve", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>* FromSubContainerResolve(::Il2CppObject* subIdentifier) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("FactoryFromBinder_4").WithContext("FromSubContainerResolve");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<Zenject::FactorySubContainerBinder_4<TParam1, TParam2, TParam3, TContract>*>(), "FromSubContainerResolve", {}, ::il2cpp_utils::ExtractTypes(subIdentifier))));
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder`4 is generic!
}
