...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10983), inst: 3388 }), TypeDefinitionIndex(TypeDefinitionIndex(10983)), TypeDefinitionIndex(TypeDefinitionIndex(10995))}
...
static Zenject::MonoMemoryPool_4<TParam1,TParam2,float_t,TValue> New_ctor() ;
...
static Zenject::MonoMemoryPool_4<TParam1,TParam2,TParam3,TValue> New_ctor() ;
