...
namespace Zenject {
  ...
  check_size<sizeof(InstantiateOnPrefabComponentProvider), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_InstantiateOnPrefabComponentProviderSizeCheck;
}
