...
namespace Zenject {
class ____Zenject__InjectTypeInfo__InjectMemberInfo;
}
namespace Zenject::Internal {
...
namespace Zenject {
class ____Zenject__TypeAnalyzer____c__DisplayClass23_0;
}
...
class CORDL_TYPE ____Zenject__TypeAnalyzer____c__DisplayClass23_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x18};

virtual ~____Zenject__TypeAnalyzer____c__DisplayClass23_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__TypeAnalyzer____c__DisplayClass23_0", modifiers: " const&", def_value: None }]
constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0(____Zenject__TypeAnalyzer____c__DisplayClass23_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__TypeAnalyzer____c__DisplayClass23_0", modifiers: "&&", def_value: None }]
constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0(____Zenject__TypeAnalyzer____c__DisplayClass23_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__TypeAnalyzer____c__DisplayClass23_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0& operator=(____Zenject__TypeAnalyzer____c__DisplayClass23_0&& o) noexcept = default;
  constexpr ____Zenject__TypeAnalyzer____c__DisplayClass23_0& operator=(____Zenject__TypeAnalyzer____c__DisplayClass23_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Zenject__TypeAnalyzer____c__DisplayClass23_0() ;
...
/// @brief Method <CreateTypeInfoFromReflection>b__0 addr 0x2da5fd0 size 0x8 virtual false final false
 ::Zenject::____Zenject__InjectTypeInfo__InjectMemberInfo _CreateTypeInfoFromReflection_b__0(::Zenject::Internal::____Zenject__Internal__ReflectionTypeInfo__InjectFieldInfo x) ;

/// @brief Method <CreateTypeInfoFromReflection>b__1 addr 0x2da6060 size 0x8 virtual false final false
 ::Zenject::____Zenject__InjectTypeInfo__InjectMemberInfo _CreateTypeInfoFromReflection_b__1(::Zenject::Internal::____Zenject__Internal__ReflectionTypeInfo__InjectPropertyInfo x) ;
...
public:
// Declarations
using __c__DisplayClass23_0 = ::Zenject::____Zenject__TypeAnalyzer____c__DisplayClass23_0;
...
NEED_NO_BOX(::Zenject::____Zenject__TypeAnalyzer____c__DisplayClass23_0);
DEFINE_IL2CPP_ARG_TYPE(::Zenject::____Zenject__TypeAnalyzer____c__DisplayClass23_0, "Zenject", "TypeAnalyzer/<>c__DisplayClass23_0");
