...
namespace Zenject {
  ...
  class MemoryPool_9 : public Zenject::IMemoryPool_9<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TValue>, public Zenject::IFactory_9<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TValue>, public Zenject::MemoryPoolBase_1<TValue> {
    public:
