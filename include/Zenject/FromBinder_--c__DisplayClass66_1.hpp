...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass66_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xF32C98
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentsInHierarchyBase$b__1(Zenject::InjectContext* ctx);
