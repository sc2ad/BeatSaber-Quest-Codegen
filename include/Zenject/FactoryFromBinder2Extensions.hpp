...
namespace Zenject {
  ...
  class FactoryFromBinder2Extensions : public ::Il2CppObject {
    ...
    static ::Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(::Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<TContract>, ::Zenject::IPoolable_3<TParam1, TParam2, ::Zenject::IMemoryPool*>>);
    ...
    static ::Zenject::ArgConditionCopyNonLazyBinder* FromMonoPoolableMemoryPool(::Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder) {
      static_assert(std::is_convertible_v<TContract, ::UnityEngine::Component*> && std::is_convertible_v<std::remove_pointer_t<TContract>, ::Zenject::IPoolable_3<TParam1, TParam2, ::Zenject::IMemoryPool*>>);
    ...
    static ::Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(::Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder) {
      static_assert(std::is_convertible_v<std::remove_pointer_t<TContract>, ::Zenject::IPoolable_3<TParam1, TParam2, ::Zenject::IMemoryPool*>>);
      static_assert(std::is_convertible_v<std::remove_pointer_t<TMemoryPool>, ::Zenject::MemoryPool_4<TParam1, TParam2, ::Zenject::IMemoryPool*, TContract>>);
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::FactoryFromBinder2Extensions::FromPoolableMemoryPool");
