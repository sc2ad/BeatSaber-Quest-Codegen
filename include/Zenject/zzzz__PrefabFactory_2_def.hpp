...
template<::cordl_internals::il2cpp_reference_type P1,::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11043))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11043), inst: 80 })
// CS Name: Zenject.PrefabFactory`2
class CORDL_TYPE PrefabFactory_2<P1,T> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to Zenject::IFactory_3<UnityEngine::Object,P1,T>
constexpr operator  Zenject::IFactory_3<UnityEngine::Object,P1,T>() const noexcept;
...
virtual ~PrefabFactory_2() = default;

// Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_2", modifiers: " const&", def_value: None }]
constexpr PrefabFactory_2(PrefabFactory_2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_2", modifiers: "&&", def_value: None }]
constexpr PrefabFactory_2(PrefabFactory_2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit PrefabFactory_2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr PrefabFactory_2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr PrefabFactory_2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr PrefabFactory_2& operator=(PrefabFactory_2&& o) noexcept = default;
  constexpr PrefabFactory_2& operator=(PrefabFactory_2 const& o) noexcept = default;
...
static Zenject::PrefabFactory_2<P1,T> New_ctor() ;
