...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_3 : public Zenject::MemoryPool_3<TParam1, TParam2, TValue> {
    ...
    UnityEngine::Transform* _get__originalParent() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoPoolableMemoryPool_3::_get__originalParent");
    ...
    void _set__originalParent(UnityEngine::Transform* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoPoolableMemoryPool_3::_set__originalParent");
      static auto ___internal__instance = this;
