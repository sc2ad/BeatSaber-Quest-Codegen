...
namespace Zenject {
  ...
  // [NoReflectionBakingAttribute] Offset: DDC694
  template<typename TContract>
  class FactoryFromBinder_1 : public Zenject::FactoryFromBinderBase {
    ...
    // [CompilerGeneratedAttribute] Offset: DDD73C
    template<typename TObj>
    ...
    // [CompilerGeneratedAttribute] Offset: DDD74C
    ...
    // [CompilerGeneratedAttribute] Offset: DDD75C
    template<typename TSubFactory>
    ...
    // [CompilerGeneratedAttribute] Offset: DDD76C
    ...
    // [CompilerGeneratedAttribute] Offset: DDD77C
