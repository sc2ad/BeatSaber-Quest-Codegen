...
namespace Zenject {
  ...
  class FactoryFromBinder_1 : public Zenject::FactoryFromBinderBase {
    ...
    template<typename TObj>
    class $$c__DisplayClass3_0_1 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
    ...
    template<typename TSubFactory>
    class $$c__5_1 : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
    ...
    class $$c : public ::CsObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      public:
      using declaring_type = FactoryFromBinder_1<TContract>*;
      // Autogenerated static field getter
    ...
    // Offset: 0xFFFFFFFF
    template<class TObj>
    Zenject::ConditionCopyNonLazyBinder* FromResolveGetter(::CsObject* subIdentifier, System::Func_2<TObj, TContract>* method) {
    ...
    // Offset: 0xFFFFFFFF
    template<class TObj>
    Zenject::ConditionCopyNonLazyBinder* FromResolveGetter(::CsObject* subIdentifier, System::Func_2<TObj, TContract>* method, Zenject::InjectSources source) {
    ...
    // Offset: 0xFFFFFFFF
    Zenject::FactorySubContainerBinder_1<TContract>* FromSubContainerResolve(::CsObject* subIdentifier) {
