...
namespace Zenject {
  ...
  class MonoInstaller_5 : public Zenject::MonoInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_5<TDerived, TParam1, TParam2, TParam3, TParam4>*>::get(), "InstallFromResource", container, p1, p2, p3, p4)));
    }
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_5<TDerived, TParam1, TParam2, TParam3, TParam4>*>::get(), "InstallFromResource", resourcePath, container, p1, p2, p3, p4)));
    }
    ...
    static MonoInstaller_5<TDerived, TParam1, TParam2, TParam3, TParam4>* New_ctor() {
      return (MonoInstaller_5<TDerived, TParam1, TParam2, TParam3, TParam4>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_5<TDerived, TParam1, TParam2, TParam3, TParam4>*>::get())));
    }
