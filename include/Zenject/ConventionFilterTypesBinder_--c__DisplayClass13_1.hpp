...
namespace Zenject {
  ...
  check_size<sizeof(ConventionFilterTypesBinder::$$c__DisplayClass13_1), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __Zenject_ConventionFilterTypesBinder_$$c__DisplayClass13_1SizeCheck;
}
