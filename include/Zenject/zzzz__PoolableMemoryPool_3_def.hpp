...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11009)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10982), inst: 3380 }), TypeDefinitionIndex(TypeDefinitionIndex(10982))}
...
static Zenject::PoolableMemoryPool_3<TParam1,TParam2,TValue> New_ctor() ;
