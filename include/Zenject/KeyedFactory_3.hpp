...
namespace Zenject {
  ...
  class KeyedFactory_3 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    TBase Create(TKey key, TParam1 param1) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<TBase>(), "Create", {}, ::il2cpp_utils::ExtractTypes(key, param1)));
  ...
  // Could not write size check! Type: Zenject.KeyedFactory`3 is generic!
}
