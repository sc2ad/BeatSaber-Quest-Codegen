...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93698
  class FactoryFromBinderBase::$$c__DisplayClass21_0 : public ::Il2CppObject {
    ...
    static FactoryFromBinderBase::$$c__DisplayClass21_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass21_0").WithContext(".ctor");
