...
namespace Zenject {
  ...
  class PlaceholderFactory_7 : public Zenject::IFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>, public Zenject::PlaceholderFactoryBase_1<TValue> {
    public:
