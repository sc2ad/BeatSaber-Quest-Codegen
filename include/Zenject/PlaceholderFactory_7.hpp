  ...
  class PlaceholderFactory_7 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*/ {
    ...
    class $get_ParamTypes$d__2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>*/ {
      ...
      static typename PlaceholderFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename PlaceholderFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>::$get_ParamTypes$d__2*>($$1__state)));
      }
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`7/<get_ParamTypes>d__2 is generic!
    ...
    // Base method: TValue IFactory_7::Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6)
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_7").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<TValue>(), "Create", {}, ::il2cpp_utils::ExtractTypes(param1, param2, param3, param4, param5, param6)));
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_7").WithContext("get_ParamTypes");
    ...
    static PlaceholderFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_7").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PlaceholderFactory_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*>()));
    }
  }; // Zenject.PlaceholderFactory`7
  // Could not write size check! Type: Zenject.PlaceholderFactory`7 is generic!
}
