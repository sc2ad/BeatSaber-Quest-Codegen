...
namespace Zenject {
  ...
  class MemoryPool_8 : public Zenject::MemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_8<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>, public Zenject::IFactory_8<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>*/ {
    ...
    TValue Zenject_IFactory_8_Create(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TParam7 p7) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<TValue>(), "Zenject.IFactory<TParam1,TParam2,TParam3,TParam4,TParam5,TParam6,TParam7,TValue>.Create", {}, ::il2cpp_utils::ExtractTypes(p1, p2, p3, p4, p5, p6, p7))));
    ...
    static MemoryPool_8<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>* New_ctor() {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<MemoryPool_8<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>*>()));
    }
  }; // Zenject.MemoryPool`8
  // Could not write size check! Type: Zenject.MemoryPool`8 is generic!
}
