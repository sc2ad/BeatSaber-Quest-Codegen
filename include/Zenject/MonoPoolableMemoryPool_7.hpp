...
namespace Zenject {
  // Forward declaring type: MonoPoolableMemoryPool`7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>
...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_7 : public Zenject::MemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue> {
    ...
    void Reinitialize(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TValue item) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(this, ___internal__method, p1, p2, p3, p4, p5, p6, item)));
    }
