...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_7 : public Zenject::MemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue> {
    ...
    void OnCreated(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_7").WithContext("OnCreated");
    ...
    void OnDestroyed(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_7").WithContext("OnDestroyed");
    ...
    void OnDespawned(TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_7").WithContext("OnDespawned");
    ...
    static MonoPoolableMemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_7").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MonoPoolableMemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*>()));
    }
    ...
    void Reinitialize(TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5, TParam6 p6, TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoPoolableMemoryPool_7").WithContext("Reinitialize");
  ...
  // Could not write size check! Type: Zenject.MonoPoolableMemoryPool`7 is generic!
}
