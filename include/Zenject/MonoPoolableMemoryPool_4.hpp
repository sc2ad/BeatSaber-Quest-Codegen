...
namespace Zenject {
  ...
  class MonoPoolableMemoryPool_4 : public Zenject::MemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    ...
    UnityEngine::Transform* _get__originalParent() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoPoolableMemoryPool_4::_get__originalParent");
    ...
    void _set__originalParent(UnityEngine::Transform* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoPoolableMemoryPool_4::_set__originalParent");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_originalParent"))->offset;
