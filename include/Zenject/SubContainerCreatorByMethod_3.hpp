...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_3 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    System::Action_4<Zenject::DiContainer*, TParam1, TParam2, TParam3>* _get__installMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_3::_get__installMethod");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_4<Zenject::DiContainer*, TParam1, TParam2, TParam3>*>(___internal__instance, "_installMethod")));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Action`4<Zenject.DiContainer,TParam1,TParam2,TParam3> _installMethod
    void _set__installMethod(System::Action_4<Zenject::DiContainer*, TParam1, TParam2, TParam3>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_3::_set__installMethod");
      static auto ___internal__instance = this;
