...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_5 : public Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract> {
    ...
    Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>* ToSelf() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TConcrete>* To() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_5<TParam1, TParam2, TParam3, TParam4, TConcrete>*, false>(this, ___generic__method)));
    }
