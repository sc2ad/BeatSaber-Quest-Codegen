...
static Zenject::ListPool_1<Zenject::Zenject__DisposeBlock__SpawnedObjectPoolPair> New_ctor() ;
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11028)), TypeDefinitionIndex(TypeDefinitionIndex(3828)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 3848 }), TypeDefinitionIndex(TypeDefinitionIndex(11039)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11028), inst: 2700 })}
...
static Zenject::ListPool_1<Zenject::TypeValuePair> New_ctor() ;
...
static Zenject::ListPool_1<T> New_ctor() ;
