...
namespace Zenject {
  ...
  class SubContainerBinder : public ::CsObject {
    public:
    ...
    // Offset: 0xFC9DC4
    static SubContainerBinder* New_ctor(Zenject::BindInfo* bindInfo, Zenject::BindStatement* bindStatement, ::CsObject* subIdentifier, bool resolveAll);
