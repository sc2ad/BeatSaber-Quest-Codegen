...
namespace Zenject {
  ...
  class ArrayPool_1 : public Zenject::StaticMemoryPoolBaseBase_1<::Array<T>*> {
    ...
    int _get__length() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::ArrayPool_1::_get__length");
    ...
    void _set__length(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::ArrayPool_1::_set__length");
      static auto ___internal__instance = this;
