...
namespace Zenject {
  ...
  template<typename T>
  class ArrayPool_1 : public Zenject::StaticMemoryPoolBaseBase_1<::ArrayWrapper<T>> {
    public:
    ...
    // Offset: 0xFFFFFFFF
    static void OnDespawned(::ArrayWrapper<T> arr) {
