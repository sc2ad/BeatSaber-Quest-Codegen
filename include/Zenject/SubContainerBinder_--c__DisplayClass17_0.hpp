...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerBinder::$$c__DisplayClass17_0), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerBinder_$$c__DisplayClass17_0SizeCheck;
}
