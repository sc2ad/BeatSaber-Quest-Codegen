...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10667), inst: 1719 }), TypeDefinitionIndex(TypeDefinitionIndex(10667)), TypeDefinitionIndex(TypeDefinitionIndex(10791))}
...
static Zenject::FactoryToChoiceBinder_2<System::Int32Enum,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10791)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10667), inst: 1719 }), TypeDefinitionIndex(TypeDefinitionIndex(10667))}
...
static Zenject::FactoryToChoiceBinder_2<TParam1,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
