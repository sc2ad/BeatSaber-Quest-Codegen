...
namespace Zenject {
  ...
  check_size<sizeof(FactoryFromBinderBase::$$c__DisplayClass30_0), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Zenject_FactoryFromBinderBase_$$c__DisplayClass30_0SizeCheck;
}
