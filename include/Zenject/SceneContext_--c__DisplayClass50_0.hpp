...
namespace Zenject {
  ...
  check_size<sizeof(SceneContext::$$c__DisplayClass50_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_SceneContext_$$c__DisplayClass50_0SizeCheck;
}
