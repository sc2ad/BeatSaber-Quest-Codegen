...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InjectTypeInfo::InjectMemberInfo::*)(Zenject::ZenMemberSetterMethod*, Zenject::InjectableInfo*)>(&Zenject::InjectTypeInfo::InjectMemberInfo::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::InjectTypeInfo::InjectMemberInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Zenject::ZenMemberSetterMethod*>(), ::il2cpp_utils::ExtractIndependentType<Zenject::InjectableInfo*>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InjectTypeInfo::InjectMemberInfo::*)(Zenject::ZenMemberSetterMethod*, Zenject::InjectableInfo*)>(&Zenject::InjectTypeInfo::InjectMemberInfo::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::InjectTypeInfo::InjectMemberInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Zenject::ZenMemberSetterMethod*>(), ::il2cpp_utils::ExtractIndependentType<Zenject::InjectableInfo*>()});
  }
};
