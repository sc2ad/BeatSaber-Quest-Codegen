...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10799)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10646), inst: 1691 }), TypeDefinitionIndex(TypeDefinitionIndex(10646))}
...
static Zenject::FactoryToChoiceIdBinder_2<System::Int32Enum,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10646)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10646), inst: 1691 }), TypeDefinitionIndex(TypeDefinitionIndex(10799))}
...
static Zenject::FactoryToChoiceIdBinder_2<TParam1,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
