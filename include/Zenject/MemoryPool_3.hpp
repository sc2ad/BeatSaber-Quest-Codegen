...
namespace Zenject {
  ...
  class MemoryPool_3 : public Zenject::MemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_3<TParam1, TParam2, TValue>, public Zenject::IFactory_3<TParam1, TParam2, TValue>*/ {
    ...
    // Offset: 0xFFFFFFFF
    TValue Spawn_NEW(TParam1 param1, TParam2 param2) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_3::Spawn_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Reinitialize_NEW(TParam1 p1, TParam2 p2, TValue item) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_3::Reinitialize_NEW");
    ...
    // Offset: 0xFFFFFFFF
    TValue Zenject_IFactory$TParam1_TParam2_TValue$_Create_NEW(TParam1 p1, TParam2 p2) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPool_3::Zenject.IFactory<TParam1,TParam2,TValue>.Create_NEW");
