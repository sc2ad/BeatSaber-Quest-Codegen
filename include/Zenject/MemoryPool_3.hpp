...
namespace Zenject {
  ...
  class MemoryPool_3 : public Zenject::IMemoryPool_3<TParam1, TParam2, TValue>, public Zenject::IFactory_3<TParam1, TParam2, TValue>, public Zenject::MemoryPoolBase_1<TValue> {
    public:
