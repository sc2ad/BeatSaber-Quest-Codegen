...
namespace Zenject {
  ...
  class PlaceholderFactory_4 : public Zenject::IFactory_4<TParam1, TParam2, TParam3, TValue>, public Zenject::PlaceholderFactoryBase_1<TValue> {
    public:
    ...
    class $get_ParamTypes$d__2 : public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>, public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      static typename PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        return (typename PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>::$get_ParamTypes$d__2*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>::$get_ParamTypes$d__2*>::get(), $$1__state)));
      }
    ...
    // Base method: TValue IFactory`4::Create(TParam1 param1, TParam2 param2, TParam3 param3)
    ...
    static PlaceholderFactory_4<TValue, TParam1, TParam2, TParam3>* New_ctor() {
      return (PlaceholderFactory_4<TValue, TParam1, TParam2, TParam3>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PlaceholderFactory_4<TValue, TParam1, TParam2, TParam3>*>::get())));
    }
