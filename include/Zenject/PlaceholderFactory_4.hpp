  ...
  class PlaceholderFactory_4 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_4<TParam1, TParam2, TParam3, TValue>*/ {
    ...
    class $get_ParamTypes$d__2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType/*, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>*/ {
      ...
      static typename PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        ...
        return THROW_UNLESS((::il2cpp_utils::New<typename PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>::$get_ParamTypes$d__2*>($$1__state)));
      }
    ...
    // Could not write size check! Type: Zenject.PlaceholderFactory`4/<get_ParamTypes>d__2 is generic!
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_4").WithContext("Create");
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_4").WithContext("get_ParamTypes");
    ...
    static PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("PlaceholderFactory_4").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>*>()));
    }
  }; // Zenject.PlaceholderFactory`4
  // Could not write size check! Type: Zenject.PlaceholderFactory`4 is generic!
}
