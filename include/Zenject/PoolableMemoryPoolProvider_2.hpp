...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_2 : public Zenject::IValidatable, public Zenject::PoolableMemoryPoolProviderBase_1<TContract> {
    ...
    static PoolableMemoryPoolProvider_2<TContract, TMemoryPool>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      return (PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*>::get(), container, poolId)));
    }
