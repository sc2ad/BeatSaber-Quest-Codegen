...
namespace Zenject {
template<typename TParam1,typename TValue>
class ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
class ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<TParam1,TValue>;
}
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TValue>
class ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<::System::Int32Enum,TValue>;
}
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10946))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10946), inst: 80 })
// CS Name: Zenject.PlaceholderFactory`2::<get_ParamTypes>d__2
class CORDL_TYPE ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<TParam1,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2", modifiers: " const&", def_value: None }]
constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2(____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2(____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2& operator=(____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2&& o) noexcept = default;
  constexpr ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2& operator=(____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2 const& o) noexcept = default;
...
explicit ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2(int32_t __1__state) ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10946))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10946), inst: 1536 })
// CS Name: Zenject.PlaceholderFactory`2::<get_ParamTypes>d__2
class CORDL_TYPE ____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<::System::Int32Enum,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to ::System::Collections::Generic::IEnumerable_1<::System::Type>
constexpr operator  ::System::Collections::Generic::IEnumerable_1<::System::Type>() const noexcept;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10968)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 4668 }), TypeDefinitionIndex(TypeDefinitionIndex(10947))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10947), inst: 80 })
...
public:
// Declarations
using _get_ParamTypes_d__2 = ::Zenject::____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<TParam1, TValue>;
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10947)), TypeDefinitionIndex(TypeDefinitionIndex(10968)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 4668 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10947), inst: 1536 })
// CS Name: Zenject.PlaceholderFactory`2
class CORDL_TYPE PlaceholderFactory_2<::System::Int32Enum,TValue> : public ::Zenject::PlaceholderFactoryBase_1<TValue> {
public:
// Declarations
using _get_ParamTypes_d__2 = ::Zenject::____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2<::System::Int32Enum, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__PlaceholderFactory_2___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`2/<get_ParamTypes>d__2");
