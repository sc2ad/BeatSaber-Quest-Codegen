...
namespace Zenject {
  ...
  class IFactoryProvider_2 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_2<TParam1, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IFactoryProvider_2").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<IFactoryProvider_2<TParam1, TContract>*>(container, factoryId)));
    }
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IFactoryProvider_2").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`2 is generic!
}
