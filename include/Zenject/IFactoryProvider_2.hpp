...
namespace Zenject {
  ...
  class IFactoryProvider_2 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_2<TContract, TParam1>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      return (IFactoryProvider_2<TContract, TParam1>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IFactoryProvider_2<TContract, TParam1>*>::get(), container, factoryId)));
    }
