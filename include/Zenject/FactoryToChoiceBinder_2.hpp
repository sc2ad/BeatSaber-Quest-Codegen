...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_2 : public Zenject::FactoryFromBinder_2<TParam1, TContract> {
    ...
    Zenject::FactoryFromBinder_2<TParam1, TContract>* ToSelf() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_2<TParam1, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactoryFromBinder_2<TParam1, TConcrete>* To() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_2<TParam1, TConcrete>*, false>(this, ___generic__method)));
    }
