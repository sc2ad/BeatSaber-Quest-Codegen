...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_2 : public Zenject::FactoryFromBinder_2<TParam1, TContract> {
    ...
    Zenject::FactoryFromBinder_2<TParam1, TContract>* ToSelf() {
      ...
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_2<TParam1, TContract>*, false>(___instance_arg, ___internal__method);
    }
    ...
    Zenject::FactoryFromBinder_2<TParam1, TConcrete>* To() {
      ...
      auto ___instance_arg = this;
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_2<TParam1, TConcrete>*, false>(___instance_arg, ___generic__method);
    }
