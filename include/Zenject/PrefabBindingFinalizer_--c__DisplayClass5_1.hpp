...
namespace Zenject {
  ...
  check_size<sizeof(PrefabBindingFinalizer::$$c__DisplayClass5_1), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_PrefabBindingFinalizer_$$c__DisplayClass5_1SizeCheck;
}
