...
namespace Zenject {
  // Forward declaring type: SubContainerCreatorByMethod`6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>
...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_6 : public ::Zenject::SubContainerCreatorByMethodBase {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_7<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>*& dyn__installMethod() {
