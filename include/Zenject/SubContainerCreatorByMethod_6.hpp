...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_6 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    System::Action_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* _get__installMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_6::_get__installMethod");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>*>(___internal__instance, "_installMethod")));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Action`7<Zenject.DiContainer,TParam1,TParam2,TParam3,TParam4,TParam5,TParam6> _installMethod
    void _set__installMethod(System::Action_7<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_6::_set__installMethod");
      static auto ___internal__instance = this;
