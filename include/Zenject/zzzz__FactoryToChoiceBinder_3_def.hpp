...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10680)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10680), inst: 1728 }), TypeDefinitionIndex(TypeDefinitionIndex(10793))}
...
static Zenject::FactoryToChoiceBinder_3<TParam1,System::Int32Enum,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10793)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10680), inst: 1728 }), TypeDefinitionIndex(TypeDefinitionIndex(10680))}
...
static Zenject::FactoryToChoiceBinder_3<TParam1,TParam2,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
