...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10680)), TypeDefinitionIndex(TypeDefinitionIndex(10793)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10680), inst: 1728 })}
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10793)), TypeDefinitionIndex(TypeDefinitionIndex(10680)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10680), inst: 1728 })}
