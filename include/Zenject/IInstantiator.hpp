...
namespace Zenject {
  ...
  class IInstantiator {
    ...
    T InstantiateComponentOnNewGameObject() {
      ...
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IInstantiator").WithContext("InstantiateComponentOnNewGameObject");
