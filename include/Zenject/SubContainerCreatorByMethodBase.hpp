...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByMethodBase), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerCreatorByMethodBaseSizeCheck;
}
