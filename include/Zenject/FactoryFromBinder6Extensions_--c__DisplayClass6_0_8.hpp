...
namespace Zenject {
  ...
  class FactoryFromBinder6Extensions::$$c__DisplayClass6_0_8 : public ::Il2CppObject {
    ...
    System::Guid _get_poolId() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder6Extensions::$$c__DisplayClass6_0_8::_get_poolId");
    ...
    void _set_poolId(System::Guid value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder6Extensions::$$c__DisplayClass6_0_8::_set_poolId");
      static auto ___internal__instance = this;
