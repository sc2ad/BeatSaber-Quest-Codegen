...
class Zenject__PlaceholderFactory_1___get_ParamTypes_d__2;
}
namespace System {
class Type;
}
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TValue>
class Zenject__PlaceholderFactory_1___get_ParamTypes_d__2<TValue>;
}
...
class CORDL_TYPE Zenject__PlaceholderFactory_1___get_ParamTypes_d__2<TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~Zenject__PlaceholderFactory_1___get_ParamTypes_d__2() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_1___get_ParamTypes_d__2", modifiers: " const&", def_value: None }]
constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2(Zenject__PlaceholderFactory_1___get_ParamTypes_d__2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_1___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2(Zenject__PlaceholderFactory_1___get_ParamTypes_d__2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__PlaceholderFactory_1___get_ParamTypes_d__2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_1___get_ParamTypes_d__2&& o) noexcept = default;
  constexpr Zenject__PlaceholderFactory_1___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_1___get_ParamTypes_d__2 const& o) noexcept = default;
...
static Zenject::Zenject__PlaceholderFactory_1___get_ParamTypes_d__2<TValue> New_ctor(int32_t __1__state) ;
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10944)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 3351 }), TypeDefinitionIndex(TypeDefinitionIndex(10968))}
...
public:
// Declarations
using _get_ParamTypes_d__2 = Zenject::Zenject__PlaceholderFactory_1___get_ParamTypes_d__2<TValue>;
...
static Zenject::PlaceholderFactory_1<TValue> New_ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__PlaceholderFactory_1___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`1/<get_ParamTypes>d__2");
