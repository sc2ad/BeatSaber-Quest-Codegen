...
namespace Zenject {
  ...
  class FactoryFromBinder1Extensions::$$c__3_2 : public ::Il2CppObject {
    ...
    static Zenject::FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>* _get_$$9() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext("_get_$$9");
    ...
    static void _set_$$9(Zenject::FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext("_set_$$9");
    ...
    static System::Action_1<Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>* _get_$$9__3_0() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext("_get_$$9__3_0");
    ...
    static void _set_$$9__3_0(System::Action_1<Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext("_set_$$9__3_0");
    ...
    // Offset: 0xFFFFFFFF
    static void _cctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext(".cctor");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    void $FromMonoPoolableMemoryPool$b__3_0(Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>* x) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext("<FromMonoPoolableMemoryPool>b__3_0");
    ...
    static FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_2").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>*>()));
    }
  }; // Zenject.FactoryFromBinder1Extensions/<>c__3`2
  // Could not write size check! Type: Zenject.FactoryFromBinder1Extensions/<>c__3`2 is generic!
}
