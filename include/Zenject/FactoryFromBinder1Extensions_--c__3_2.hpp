...
namespace Zenject {
  ...
  class FactoryFromBinder1Extensions::$$c__3_2 : public ::CsObject {
    static_assert((!std::is_complete_v<std::remove_pointer_t<TContract>> || std::is_convertible_v<TContract, UnityEngine::Component*>) && (!std::is_complete_v<std::remove_pointer_t<TContract>> || std::is_base_of_v<Zenject::IPoolable_2<TParam1, Zenject::IMemoryPool*>, std::remove_pointer_t<TContract>>));
    public:
    ...
    // Offset: 0xFFFFFFFF
    static void _cctor() {
      THROW_UNLESS((il2cpp_utils::RunMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>*>::get(), ".cctor")));
    }
    ...
    static FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>* New_ctor() {
      return (FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder1Extensions::$$c__3_2<TParam1, TContract>*>::get())));
    }
