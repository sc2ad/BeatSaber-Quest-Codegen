...
struct CORDL_TYPE ____Zenject__DisposeBlock__SpawnedObjectPoolPair : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____Zenject__DisposeBlock__SpawnedObjectPoolPair(::Zenject::IMemoryPool Pool, ::bs_hook::Il2CppWrapperType Object) noexcept;


                    constexpr ____Zenject__DisposeBlock__SpawnedObjectPoolPair(____Zenject__DisposeBlock__SpawnedObjectPoolPair const&) = default;
                    constexpr ____Zenject__DisposeBlock__SpawnedObjectPoolPair(____Zenject__DisposeBlock__SpawnedObjectPoolPair&&) = default;
                    constexpr ____Zenject__DisposeBlock__SpawnedObjectPoolPair& operator=(____Zenject__DisposeBlock__SpawnedObjectPoolPair const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Zenject__DisposeBlock__SpawnedObjectPoolPair& operator=(____Zenject__DisposeBlock__SpawnedObjectPoolPair&& o) noexcept {
...
constexpr explicit ____Zenject__DisposeBlock__SpawnedObjectPoolPair(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using SpawnedObjectPoolPair = ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair;
...
constexpr ::System::Collections::Generic::List_1<::System::IDisposable> __get__disposables() const;
 ...
 ::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair> __declspec(property(get=__get__objectPoolPairs, put=__set__objectPoolPairs))  _objectPoolPairs;

constexpr void __set__objectPoolPairs(::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair> value) ;

constexpr ::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair> __get__objectPoolPairs() const;
...
DEFINE_IL2CPP_ARG_TYPE(::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair, "Zenject", "DisposeBlock/SpawnedObjectPoolPair");
