...
namespace Zenject {
  ...
  check_size<sizeof(GuiRenderableManager::RenderableInfo), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __Zenject_GuiRenderableManager_RenderableInfoSizeCheck;
}
