...
constexpr ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair::____Zenject__DisposeBlock__SpawnedObjectPoolPair(::Zenject::IMemoryPool Pool, ::bs_hook::Il2CppWrapperType Object) noexcept : ::bs_hook::ValueTypeWrapper() {this->Pool = Pool;
this->Object = Object;
}
constexpr void ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair::__set_Pool(::Zenject::IMemoryPool value)  {
::cordl_internals::setInstanceField<::Zenject::IMemoryPool, 0x0>(this->__instance, std::forward<::Zenject::IMemoryPool>(value));
}
constexpr ::Zenject::IMemoryPool ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair::__get_Pool() const {
return ::cordl_internals::getInstanceField<::Zenject::IMemoryPool, 0x0>(this->__instance);
}
constexpr void ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair::__set_Object(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType ::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair::__get_Object() const {
...
constexpr void ::Zenject::DisposeBlock::__set__objectPoolPairs(::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair> value)  {
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair>>(value));
}
constexpr ::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair> ::Zenject::DisposeBlock::__get__objectPoolPairs() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::Zenject::____Zenject__DisposeBlock__SpawnedObjectPoolPair>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
