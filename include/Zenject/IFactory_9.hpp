...
namespace Zenject {
  ...
  // Autogenerated type: Zenject.IFactory`9
  // [] Offset: FFFFFFFF
  ...
  class IFactory_9/*, public Zenject::IFactory*/ {
    public:
    // Creating value type constructor for type: IFactory_9
    IFactory_9() noexcept {}
    ...
    // Offset: 0xFFFFFFFF
    TValue Zenject_IFactory_9_Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6, TParam7 param7, TParam8 param8) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IFactory_9").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(param1, param2, param3, param4, param5, param6, param7, param8)));
  ...
  // Could not write size check! Type: Zenject.IFactory`9 is generic, or has no fields that are valid for size checks!
}
