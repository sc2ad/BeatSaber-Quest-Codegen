...
namespace Zenject {
  // Forward declaring type: IFactory`9<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TValue>
...
namespace Zenject {
  ...
  class IFactory_9/*, public Zenject::IFactory*/ {
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TParam6 param6, TParam7 param7, TParam8 param8) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<TValue, false>(this, ___internal__method, param1, param2, param3, param4, param5, param6, param7, param8)));
    }
  }; // Zenject.IFactory`9
