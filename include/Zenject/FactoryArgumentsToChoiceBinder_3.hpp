...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D91F90
  ...
  class FactoryArgumentsToChoiceBinder_3 : public Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract> {
    ...
    static FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>*, creationType>(bindContainer, bindInfo, factoryBindInfo)));
    }
  }; // Zenject.FactoryArgumentsToChoiceBinder`3
  // Could not write size check! Type: Zenject.FactoryArgumentsToChoiceBinder`3 is generic, or has no fields that are valid for size checks!
}
