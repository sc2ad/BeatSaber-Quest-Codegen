...
namespace Zenject {
  ...
  class FactoryArgumentsToChoiceBinder_3 : public Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract> {
    ...
    Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>* WithFactoryArguments(T param) {
      return THROW_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, param)));
    }
    ...
    Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>* WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2) {
      return THROW_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam1>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam2>::get()}, param1, param2)));
    }
    ...
    // Offset: 0xFFFFFFFF
    Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>* WithFactoryArguments(::Array<::CsObject*>* args) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>*>(this, "WithFactoryArguments", args)));
    }
    ...
    Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>* WithFactoryArgumentsExplicit(System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArgs) {
      return THROW_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_3<TParam1, TParam2, TContract>*>(this, "WithFactoryArgumentsExplicit", extraArgs)));
    }
    ...
    static FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      return (FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryArgumentsToChoiceBinder_3<TParam1, TParam2, TContract>*>::get(), bindContainer, bindInfo, factoryBindInfo)));
    }
