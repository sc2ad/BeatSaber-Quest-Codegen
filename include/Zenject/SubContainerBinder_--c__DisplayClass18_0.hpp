...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerBinder::$$c__DisplayClass18_0), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerBinder_$$c__DisplayClass18_0SizeCheck;
}
