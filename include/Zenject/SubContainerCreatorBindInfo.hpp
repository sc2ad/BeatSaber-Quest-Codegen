...
namespace Zenject {
  ...
  // [NoReflectionBakingAttribute] Offset: DDD280
  class SubContainerCreatorBindInfo : public ::Il2CppObject {
    public:
    // [CompilerGeneratedAttribute] Offset: 0xDDF2B8
    ...
    // [CompilerGeneratedAttribute] Offset: 0xDDF2C8
    ...
    char __padding1[0x7] = {};
    // [CompilerGeneratedAttribute] Offset: 0xDDF2D8
