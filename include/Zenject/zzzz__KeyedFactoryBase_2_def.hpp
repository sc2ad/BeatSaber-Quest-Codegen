...
namespace Zenject {
template<typename TBase,typename TKey>
class ____Zenject__KeyedFactoryBase_2____c;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TKey>
class ____Zenject__KeyedFactoryBase_2____c<TBase,TKey>;
}
// Type: ::<>c
...
class CORDL_TYPE ____Zenject__KeyedFactoryBase_2____c<TBase,TKey> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____Zenject__KeyedFactoryBase_2____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__KeyedFactoryBase_2____c", modifiers: " const&", def_value: None }]
constexpr ____Zenject__KeyedFactoryBase_2____c(____Zenject__KeyedFactoryBase_2____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__KeyedFactoryBase_2____c", modifiers: "&&", def_value: None }]
constexpr ____Zenject__KeyedFactoryBase_2____c(____Zenject__KeyedFactoryBase_2____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__KeyedFactoryBase_2____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__KeyedFactoryBase_2____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__KeyedFactoryBase_2____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__KeyedFactoryBase_2____c& operator=(____Zenject__KeyedFactoryBase_2____c&& o) noexcept = default;
  constexpr ____Zenject__KeyedFactoryBase_2____c& operator=(____Zenject__KeyedFactoryBase_2____c const& o) noexcept = default;
                


// Fields

static ::Zenject::____Zenject__KeyedFactoryBase_2____c<TBase,TKey> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::Zenject::____Zenject__KeyedFactoryBase_2____c<TBase,TKey> value) ;

static ::Zenject::____Zenject__KeyedFactoryBase_2____c<TBase,TKey> __get___9() ;
...
// Ctor Parameters []
explicit ____Zenject__KeyedFactoryBase_2____c() ;
...
public:
// Declarations
using __c = ::Zenject::____Zenject__KeyedFactoryBase_2____c<TBase, TKey>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__KeyedFactoryBase_2____c, "Zenject", "KeyedFactoryBase`2/<>c");
