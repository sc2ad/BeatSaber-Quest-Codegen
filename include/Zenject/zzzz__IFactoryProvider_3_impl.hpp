...
#include "Zenject/zzzz__TypeValuePair_def.hpp"
 Zenject::IFactoryProvider_3<TParam1,TParam2,TContract> Zenject::IFactoryProvider_3<TParam1,TParam2,TContract>::New_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
Zenject::IFactoryProvider_3<TParam1,TParam2,TContract> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::IFactoryProvider_3<TParam1,TParam2,TContract>>(container, factoryId))};
return o;
}
 void Zenject::IFactoryProvider_3<TParam1,TParam2,TContract>::_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, container, factoryId);
 ...
 void Zenject::IFactoryProvider_3<TParam1,TParam2,TContract>::GetAllInstancesWithInjectSplit(Zenject::InjectContext context, System::Collections::Generic::List_1<Zenject::TypeValuePair> args, ByRef<System::Action> injectAction, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> buffer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::IFactoryProvider_3<TParam1,TParam2,TContract>>::get(),
