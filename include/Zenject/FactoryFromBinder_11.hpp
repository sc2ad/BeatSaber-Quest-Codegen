...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92020
  template<typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TParam6, typename TParam7, typename TParam8, typename TParam9, typename TParam10, typename TContract>
  class FactoryFromBinder_11 : public Zenject::FactoryFromBinderBase {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93198
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`11/<>c__DisplayClass1_0 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactoryFromBinder`11/<>c__2`1
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D931A8
    template<typename TSubFactory>
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`11/<>c__2`1 is generic, or has no fields that are valid for size checks!
    // WARNING Size may be invalid!
    // Autogenerated type: Zenject.FactoryFromBinder`11/<>c__DisplayClass3_0
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D931B8
    ...
    // Could not write size check! Type: Zenject.FactoryFromBinder`11/<>c__DisplayClass3_0 is generic, or has no fields that are valid for size checks!
