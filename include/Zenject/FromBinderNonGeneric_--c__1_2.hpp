...
namespace Zenject {
  ...
  class FromBinderNonGeneric::$$c__1_2 : public ::Il2CppObject {
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FromBinderNonGeneric::$$c__1_2<TConcrete, TFactory>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
  ...
  // Could not write size check! Type: Zenject.FromBinderNonGeneric/<>c__1`2 is generic!
}
