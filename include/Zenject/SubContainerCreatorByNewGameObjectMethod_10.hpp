...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEF3F8
  ...
  class SubContainerCreatorByNewGameObjectMethod_10 : public Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF05F0
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewGameObjectMethod`10/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
