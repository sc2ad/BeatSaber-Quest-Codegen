...
namespace Zenject {
  ...
  class SubContainerCreatorByNewGameObjectMethod_10 : public Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewGameObjectMethod`10/<>c__DisplayClass2_0 is generic!
  ...
  // Could not write size check! Type: Zenject.SubContainerCreatorByNewGameObjectMethod`10 is generic!
}
