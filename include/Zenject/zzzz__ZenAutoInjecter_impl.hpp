...
constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::____Zenject__ZenAutoInjecter__ContainerSources(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources  ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::SceneContext{0};
constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources  ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::ProjectContext{1};
constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources  ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources::SearchHierarchy{2};
//  Writing Method size for method: ::Zenject::ZenAutoInjecter.get_ContainerSource
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources (::Zenject::ZenAutoInjecter::*)()>(&::Zenject::ZenAutoInjecter::get_ContainerSource)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::ZenAutoInjecter::*)(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources)>(&::Zenject::ZenAutoInjecter::set_ContainerSource)> {
  constexpr static std::size_t size = 0x8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_ContainerSource",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr void ::Zenject::ZenAutoInjecter::__set__containerSource(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources value)  {
::cordl_internals::setInstanceField<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources>(value));
}
constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources ::Zenject::ZenAutoInjecter::__get__containerSource() const {
return ::cordl_internals::getInstanceField<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::getInstanceField<bool, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
 ...
 ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources ::Zenject::ZenAutoInjecter::get_ContainerSource()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ZenAutoInjecter>::get(),
                            "get_ContainerSource",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::Zenject::____Zenject__ZenAutoInjecter__ContainerSources, false>(const_cast<void*>(instance), ___internal_method);
}
 void ::Zenject::ZenAutoInjecter::set_ContainerSource(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ZenAutoInjecter>::get(),
                            "set_ContainerSource",
                            std::vector<Il2CppClass*>{},
