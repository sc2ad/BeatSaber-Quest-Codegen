...
namespace Zenject {
  ...
  class PlaceholderFactory_5 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF083C
    ...
    TValue Create(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4) {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Create", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(param1, param2, param3, param4)));
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ParamTypes() {
      ...
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "get_ParamTypes", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes()));
