...
namespace Zenject {
  ...
  class PlaceholderFactory_5 : public Zenject::PlaceholderFactoryBase_1<TValue>/*, public Zenject::IFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>*/ {
    ...
    class $get_ParamTypes$d__2 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject/*, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::Generic::IEnumerator_1<System::Type*>*/ {
      ...
      int _get_$$1__state() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_get_$$1__state");
      ...
      void _set_$$1__state(int value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_set_$$1__state");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<>1__state"))->offset;
      ...
      System::Type* _get_$$2__current() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_get_$$2__current");
        auto ___internal__instance = this;
      ...
      void _set_$$2__current(System::Type* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_set_$$2__current");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<>2__current"))->offset;
      ...
      int _get_$$l__initialThreadId() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_get_$$l__initialThreadId");
        auto ___internal__instance = this;
      ...
      void _set_$$l__initialThreadId(int value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PlaceholderFactory_5::$get_ParamTypes$d__2::_set_$$l__initialThreadId");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<>l__initialThreadId"))->offset;
        *reinterpret_cast<int*>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
      }
