...
namespace Zenject {
  ...
  class IMemoryPool_5/*, public Zenject::IDespawnableMemoryPool_1<TValue>*/ {
    ...
    // Offset: 0xFFFFFFFF
    TValue Spawn_NEW(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::IMemoryPool_5::Spawn_NEW");
      auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, "Spawn", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes(param1, param2, param3, param4)));
