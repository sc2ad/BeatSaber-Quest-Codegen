...
namespace Zenject {
  ...
  class GetterProvider_2 : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xFFFFFFFF
    static GetterProvider_2<TObj, TResult>* New_ctor(::CsObject* identifier, System::Func_2<TObj, TResult>* method, Zenject::DiContainer* container, Zenject::InjectSources sourceType, bool matchAll) {
