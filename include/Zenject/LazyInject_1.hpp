...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [ZenjectAllowDuringValidationAttribute] Offset: CEEEA8
  // [NoReflectionBakingAttribute] Offset: CEEEA8
  template<typename T>
  class LazyInject_1 : public ::Il2CppObject/*, public Zenject::IValidatable*/ {
    ...
    // Offset: 0xFFFFFFFF
    void Zenject_IValidatable_Validate_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::LazyInject_1::Zenject.IValidatable.Validate_NEW");
