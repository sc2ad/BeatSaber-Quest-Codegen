...
namespace Zenject {
  ...
  class Installer_5 : public Zenject::InstallerBase {
    ...
    static Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>* New_ctor() {
      return (Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>*>::get())));
    }
  }; // Zenject.Installer`5
}
