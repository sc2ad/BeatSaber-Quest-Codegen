...
namespace Zenject {
template<typename TParam1>
class ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1>
class ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<TParam1>;
}
namespace Zenject {
template<>
class ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<::System::Int32Enum>;
}
...
class CORDL_TYPE ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<TParam1> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0", modifiers: " const&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0", modifiers: "&&", def_value: None }]
constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0(____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0&& o) noexcept = default;
  constexpr ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0& operator=(____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0() ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11220))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11220), inst: 4825 })
// CS Name: Zenject.SubContainerCreatorByNewPrefabMethod`1::<>c__DisplayClass2_0
class CORDL_TYPE ____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<::System::Int32Enum> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<TParam1>;
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11216)), TypeDefinitionIndex(TypeDefinitionIndex(11221))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11221), inst: 4825 })
// CS Name: Zenject.SubContainerCreatorByNewPrefabMethod`1
...
public:
// Declarations
using __c__DisplayClass2_0 = ::Zenject::____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0<::System::Int32Enum>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::____Zenject__SubContainerCreatorByNewPrefabMethod_1____c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewPrefabMethod`1/<>c__DisplayClass2_0");
