...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEF4D8
  class SubContainerCreatorDynamicContext : public ::Il2CppObject/*, public Zenject::ISubContainerCreator*/ {
    ...
    // Offset: 0xFFFFFFFF
    void AddInstallers_NEW(System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, Zenject::GameObjectContext* context);
