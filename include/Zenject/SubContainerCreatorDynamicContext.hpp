...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorDynamicContext), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerCreatorDynamicContextSizeCheck;
}
