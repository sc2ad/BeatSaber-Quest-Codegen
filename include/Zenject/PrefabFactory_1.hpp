...
namespace Zenject {
  ...
  class PrefabFactory_1 : public ::Il2CppObject/*, public Zenject::IFactory_2<UnityEngine::Object*, T>*/ {
    ...
    T Create(UnityEngine::Object* prefab) {
      ...
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<T>(), "Create", {}, ::il2cpp_utils::ExtractTypes(prefab)));
    ...
    static PrefabFactory_1<T>* New_ctor() {
      ...
      return THROW_UNLESS(::il2cpp_utils::New<PrefabFactory_1<T>*>());
    }
  }; // Zenject.PrefabFactory`1
  // Could not write size check! Type: Zenject.PrefabFactory`1 is generic!
}
