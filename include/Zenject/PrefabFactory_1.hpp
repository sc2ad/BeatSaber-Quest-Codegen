...
namespace Zenject {
  ...
  class PrefabFactory_1 : public ::Il2CppObject/*, public Zenject::IFactory_2<UnityEngine::Object*, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xE77B88
    ...
    Zenject::DiContainer* _get__container() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabFactory_1::_get__container");
    ...
    void _set__container(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabFactory_1::_set__container");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_container"))->offset;
