...
namespace Zenject {
  ...
  check_size<sizeof(PoolableManager::$$c__DisplayClass2_0), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_PoolableManager_$$c__DisplayClass2_0SizeCheck;
}
