...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11136), inst: 3338 }), TypeDefinitionIndex(TypeDefinitionIndex(11137)), TypeDefinitionIndex(TypeDefinitionIndex(11136))}
...
static Zenject::IFactoryProvider_1<System::Int32Enum> New_ctor(Zenject::DiContainer container, System::Guid factoryId) ;
...
static Zenject::IFactoryProvider_1<float_t> New_ctor(Zenject::DiContainer container, System::Guid factoryId) ;
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11136)), TypeDefinitionIndex(TypeDefinitionIndex(11137)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11136), inst: 3338 })}
...
static Zenject::IFactoryProvider_1<TContract> New_ctor(Zenject::DiContainer container, System::Guid factoryId) ;
