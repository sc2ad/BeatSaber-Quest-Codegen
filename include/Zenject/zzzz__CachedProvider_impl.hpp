...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::CachedProvider::*)()>(&::Zenject::CachedProvider::get_IsCached)> {
  ...
  constexpr static std::size_t addrs = 0x2d8c370;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::CachedProvider::*)()>(&::Zenject::CachedProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2d8c378;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Zenject::CachedProvider::*)()>(&::Zenject::CachedProvider::get_NumInstances)> {
  ...
  constexpr static std::size_t addrs = 0x2d8c108;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::CachedProvider::*)(::Zenject::InjectContext, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>, ByRef<::System::Action>, ::System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType>)>(&::Zenject::CachedProvider::GetAllInstancesWithInjectSplit)> {
  constexpr static std::size_t size = 0x288;
  constexpr static std::size_t addrs = 0x2d8bdc0;
...
constexpr  ::Zenject::CachedProvider::operator ::Zenject::IProvider() const noexcept {
...
constexpr ::Zenject::IProvider ::Zenject::CachedProvider::__get__creator() const {
return ::cordl_internals::getInstanceField<::Zenject::IProvider, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void ::Zenject::CachedProvider::__set__instances(::System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> value)  {
...
constexpr ::System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> ::Zenject::CachedProvider::__get__instances() const {
...
return ::cordl_internals::RunMethodRethrow<bool, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t ::Zenject::CachedProvider::get_NumInstances()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::CachedProvider>::get(),
                            "get_NumInstances",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::System::Type, false>(const_cast<void*>(instance), ___internal_method, context);
 ...
 void ::Zenject::CachedProvider::GetAllInstancesWithInjectSplit(::Zenject::InjectContext context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair> args, ByRef<::System::Action> injectAction, ::System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> buffer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::CachedProvider>::get(),
                            "GetAllInstancesWithInjectSplit",
                            std::vector<Il2CppClass*>{},
