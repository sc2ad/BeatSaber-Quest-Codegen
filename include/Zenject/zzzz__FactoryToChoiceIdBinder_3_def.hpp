...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10648), inst: 1692 }), TypeDefinitionIndex(TypeDefinitionIndex(10801)), TypeDefinitionIndex(TypeDefinitionIndex(10648))}
...
static Zenject::FactoryToChoiceIdBinder_3<TParam1,System::Int32Enum,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10648)), TypeDefinitionIndex(TypeDefinitionIndex(10801)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10648), inst: 1692 })}
...
static Zenject::FactoryToChoiceIdBinder_3<TParam1,TParam2,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
