...
namespace Zenject {
  ...
  check_size<sizeof(FromBinder::$$c__DisplayClass53_0), 32 + sizeof(bool) + ((32 + sizeof(bool)) % 8 != 0 ? (8 - (32 + sizeof(bool)) % 8) : 0)> __Zenject_FromBinder_$$c__DisplayClass53_0SizeCheck;
}
