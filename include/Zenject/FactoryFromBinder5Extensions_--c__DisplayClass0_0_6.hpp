...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93338
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder5Extensions/<>c__DisplayClass0_0`6 is generic, or has no fields that are valid for size checks!
}
