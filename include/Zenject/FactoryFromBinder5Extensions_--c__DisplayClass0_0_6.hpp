...
namespace Zenject {
  ...
  class FactoryFromBinder5Extensions::$$c__DisplayClass0_0_6 : public ::Il2CppObject {
    ...
    System::Guid _get_factoryId() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder5Extensions::$$c__DisplayClass0_0_6::_get_factoryId");
    ...
    void _set_factoryId(System::Guid value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder5Extensions::$$c__DisplayClass0_0_6::_set_factoryId");
      static auto ___internal__instance = this;
