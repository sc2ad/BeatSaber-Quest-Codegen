...
namespace Zenject {
  ...
  check_size<sizeof(DiContainer::$GetDependencyContracts$d__96), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __Zenject_DiContainer_$GetDependencyContracts$d__96SizeCheck;
}
