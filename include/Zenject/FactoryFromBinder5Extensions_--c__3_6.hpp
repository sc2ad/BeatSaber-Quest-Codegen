...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D93358
  ...
  class FactoryFromBinder5Extensions::$$c__3_6 : public ::Il2CppObject {
    ...
    static Zenject::FactoryFromBinder5Extensions::$$c__3_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>* _get_$$9() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext("_get_$$9");
    ...
    static void _set_$$9(Zenject::FactoryFromBinder5Extensions::$$c__3_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext("_set_$$9");
    ...
    static System::Action_1<Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>* _get_$$9__3_0() {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext("_get_$$9__3_0");
    ...
    static void _set_$$9__3_0(System::Action_1<Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>* value) {
      static auto ___internal__logger = Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext("_set_$$9__3_0");
    ...
    // Offset: 0xFFFFFFFF
    static void _cctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext(".cctor");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder5Extensions::$$c__3_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>*>::get(), ".cctor", std::vector<Il2CppClass*>{}, ::il2cpp_utils::ExtractTypes())));
    ...
    void $FromMonoPoolableMemoryPool$b__3_0(Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>* x) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext("<FromMonoPoolableMemoryPool>b__3_0");
    ...
    static FactoryFromBinder5Extensions::$$c__3_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__3_6").WithContext(".ctor");
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder5Extensions/<>c__3`6 is generic, or has no fields that are valid for size checks!
}
