...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D931E8
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder2Extensions/<>c__DisplayClass0_0`3 is generic, or has no fields that are valid for size checks!
}
