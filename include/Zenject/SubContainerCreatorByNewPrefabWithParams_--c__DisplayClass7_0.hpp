...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByNewPrefabWithParams::$$c__DisplayClass7_0), 16 + sizeof(Zenject::TypeValuePair) + ((16 + sizeof(Zenject::TypeValuePair)) % 8 != 0 ? (8 - (16 + sizeof(Zenject::TypeValuePair)) % 8) : 0)> __Zenject_SubContainerCreatorByNewPrefabWithParams_$$c__DisplayClass7_0SizeCheck;
}
