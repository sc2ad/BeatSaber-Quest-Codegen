...
template<typename TInstaller>
 ::StringW Zenject::MonoInstallerUtil::GetDefaultResourcePath()  {
...
template<typename TInstaller>
 TInstaller Zenject::MonoInstallerUtil::CreateInstaller(::StringW resourcePath, Zenject::DiContainer container)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::MonoInstallerUtil>::get(),
                        "CreateInstaller",
                        std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TInstaller>::get()},
