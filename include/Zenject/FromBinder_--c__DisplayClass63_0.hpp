...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass63_0 : public ::CsObject {
    public:
    ...
    // Offset: 0xF2187C
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentSibling$b__1(Zenject::InjectContext* ctx);
