...
namespace Zenject {
  // Forward declaring type: SubContainerCreatorByMethod`1<TParam1>
...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_1 : public ::Zenject::SubContainerCreatorByMethodBase {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_2<::Zenject::DiContainer*, TParam1>*& dyn__installMethod() {
