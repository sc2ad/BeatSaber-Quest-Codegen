...
namespace Zenject {
  ...
  check_size<sizeof(PrefabBindingFinalizer::$$c__DisplayClass5_0), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Zenject_PrefabBindingFinalizer_$$c__DisplayClass5_0SizeCheck;
}
