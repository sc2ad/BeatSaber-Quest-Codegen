...
namespace Zenject {
  // Forward declaring type: PoolableStaticMemoryPool`4<TParam1, TParam2, TParam3, TValue>
...
namespace Zenject {
  ...
  class PoolableStaticMemoryPool_4 : public Zenject::StaticMemoryPool_4<TParam1, TParam2, TParam3, TValue> {
    ...
    static void OnSpawned(TParam1 p1, TParam2 p2, TParam3 p3, TValue value) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<Il2CppObject*, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, p1, p2, p3, value)));
    }
