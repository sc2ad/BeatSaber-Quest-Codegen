...
namespace Zenject {
  ...
  class StaticMemoryPool_7 : public Zenject::IMemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>, public Zenject::StaticMemoryPoolBase_1<TValue> {
    public:
