...
namespace Zenject {
  ...
  class StaticMemoryPool_7 : public Zenject::StaticMemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*/ {
    ...
    System::Action_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* _get__onSpawnMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_7::_get__onSpawnMethod");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>*>(___internal__instance, "_onSpawnMethod")));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Action`7<TParam1,TParam2,TParam3,TParam4,TParam5,TParam6,TValue> _onSpawnMethod
    void _set__onSpawnMethod(System::Action_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_7::_set__onSpawnMethod");
      static auto ___internal__instance = this;
