...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: CEEE18
  ...
  class StaticMemoryPool_3 : public Zenject::StaticMemoryPoolBase_1<TValue>/*, public Zenject::IMemoryPool_3<TParam1, TParam2, TValue>*/ {
    ...
    // Offset: 0xFFFFFFFF
    TValue Spawn_NEW(TParam1 p1, TParam2 p2) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::StaticMemoryPool_3::Spawn_NEW");
