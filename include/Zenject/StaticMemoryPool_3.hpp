...
namespace Zenject {
  // Forward declaring type: StaticMemoryPool`3<TParam1, TParam2, TValue>
...
namespace Zenject {
  ...
  class StaticMemoryPool_3 : public ::Zenject::StaticMemoryPoolBase_1<TValue>/*, public ::Zenject::IMemoryPool_3<TParam1, TParam2, TValue>*/ {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_3<TParam1, TParam2, TValue>*& dyn__onSpawnMethod() {
