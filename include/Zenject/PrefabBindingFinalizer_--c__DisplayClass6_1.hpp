...
namespace Zenject {
  ...
  check_size<sizeof(PrefabBindingFinalizer::$$c__DisplayClass6_1), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __Zenject_PrefabBindingFinalizer_$$c__DisplayClass6_1SizeCheck;
}
