...
namespace Zenject {
  ...
  class FactoryFromBinder0Extensions::$$c__1_1 : public ::Il2CppObject {
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryFromBinder0Extensions::$$c__1_1<TContract>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
  ...
  // Could not write size check! Type: Zenject.FactoryFromBinder0Extensions/<>c__1`1 is generic!
}
