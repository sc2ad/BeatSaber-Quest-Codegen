...
namespace Zenject {
  ...
  class IFactoryProvider_11 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_11<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IFactoryProvider_11").WithContext(".ctor");
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("IFactoryProvider_11").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`11 is generic!
}
