...
namespace Zenject {
  ...
  class PoolableMemoryPoolProviderBase_1 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    System::Guid _get_$PoolId$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProviderBase_1::_get_$PoolId$k__BackingField");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Guid>(___internal__instance, "<PoolId>k__BackingField")));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Guid <PoolId>k__BackingField
    void _set_$PoolId$k__BackingField(System::Guid value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProviderBase_1::_set_$PoolId$k__BackingField");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "<PoolId>k__BackingField", value));
    }
    // Autogenerated instance field getter
    ...
    Zenject::DiContainer* _get_$Container$k__BackingField() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProviderBase_1::_get_$Container$k__BackingField");
      static auto ___internal__instance = this;
    ...
    void _set_$Container$k__BackingField(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolableMemoryPoolProviderBase_1::_set_$Container$k__BackingField");
      static auto ___internal__instance = this;
