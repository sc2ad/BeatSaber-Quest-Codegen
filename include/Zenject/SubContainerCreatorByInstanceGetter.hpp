...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByInstanceGetter), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __Zenject_SubContainerCreatorByInstanceGetterSizeCheck;
}
