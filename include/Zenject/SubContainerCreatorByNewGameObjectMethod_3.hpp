...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92C20
  ...
  class SubContainerCreatorByNewGameObjectMethod_3 : public Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93E18
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewGameObjectMethod`3/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
