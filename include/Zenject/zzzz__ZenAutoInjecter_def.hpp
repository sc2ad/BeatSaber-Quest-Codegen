...
namespace Zenject {
struct ____Zenject__ZenAutoInjecter__ContainerSources;
}
namespace Zenject {
...
struct CORDL_TYPE ____Zenject__ZenAutoInjecter__ContainerSources : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____Zenject__ZenAutoInjecter__ContainerSources(int32_t value__) noexcept;


                    constexpr ____Zenject__ZenAutoInjecter__ContainerSources(____Zenject__ZenAutoInjecter__ContainerSources const&) = default;
                    constexpr ____Zenject__ZenAutoInjecter__ContainerSources(____Zenject__ZenAutoInjecter__ContainerSources&&) = default;
                    constexpr ____Zenject__ZenAutoInjecter__ContainerSources& operator=(____Zenject__ZenAutoInjecter__ContainerSources const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____Zenject__ZenAutoInjecter__ContainerSources& operator=(____Zenject__ZenAutoInjecter__ContainerSources&& o) noexcept {
...
constexpr explicit ____Zenject__ZenAutoInjecter__ContainerSources(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______Zenject__ZenAutoInjecter__ContainerSources_Unwrapped : int32_t {
__SceneContext = 0,
__ProjectContext = 1,
__SearchHierarchy = 2,
};
...
constexpr operator ______Zenject__ZenAutoInjecter__ContainerSources_Unwrapped () const noexcept {
return std::bit_cast<______Zenject__ZenAutoInjecter__ContainerSources_Unwrapped>(__instance);
}
...
static ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources const SceneContext;

/// @brief Field ProjectContext offset 0
static ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources const ProjectContext;

/// @brief Field SearchHierarchy offset 0
static ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources const SearchHierarchy;
...
public:
// Declarations
using ContainerSources = ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources;
...
// Fields
 ...
 ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources __declspec(property(get=__get__containerSource, put=__set__containerSource))  _containerSource;

constexpr void __set__containerSource(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources value) ;

constexpr ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources __get__containerSource() const;
...
// Properties
 ...
 ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources __declspec(property(get=get_ContainerSource, put=set_ContainerSource))  ContainerSource;


// Methods

/// @brief Method get_ContainerSource addr 0x2da6728 size 0x8 virtual false final false
 ::Zenject::____Zenject__ZenAutoInjecter__ContainerSources get_ContainerSource() ;

/// @brief Method set_ContainerSource addr 0x2da6730 size 0x8 virtual false final false
 void set_ContainerSource(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources value) ;
...
DEFINE_IL2CPP_ARG_TYPE(::Zenject::____Zenject__ZenAutoInjecter__ContainerSources, "Zenject", "ZenAutoInjecter/ContainerSources");
