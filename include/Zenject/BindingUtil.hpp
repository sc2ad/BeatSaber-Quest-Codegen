...
namespace Zenject {
  ...
  class BindingUtil : public ::CsObject {
    public:
    ...
    // Offset: 0xD65D40
    static void AssertIsValidResourcePath(::CsString* resourcePath);
    ...
    // Offset: 0xD673B4
    static void AssertInstanceDerivesFromOrEqual(::CsObject* instance, System::Collections::Generic::IEnumerable_1<System::Type*>* parentTypes);
    // static public System.Void AssertInstanceDerivesFromOrEqual(System.Object instance, System.Type baseType)
    // Offset: 0xD6762C
    static void AssertInstanceDerivesFromOrEqual(::CsObject* instance, System::Type* baseType);
