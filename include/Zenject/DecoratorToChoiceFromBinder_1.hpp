...
namespace Zenject {
  ...
  class DecoratorToChoiceFromBinder_1 : public ::Il2CppObject {
    ...
    Zenject::DiContainer* _get__bindContainer() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_get__bindContainer");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<Zenject::DiContainer*>(___internal__instance, "_bindContainer"));
    }
    // Autogenerated instance field setter
    // Set instance field: private Zenject.DiContainer _bindContainer
    void _set__bindContainer(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_set__bindContainer");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_bindContainer", value));
    }
    // Autogenerated instance field getter
    // Get instance field: private Zenject.BindInfo _bindInfo
    Zenject::BindInfo* _get__bindInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_get__bindInfo");
      static auto ___internal__instance = this;
    ...
    void _set__bindInfo(Zenject::BindInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_set__bindInfo");
      static auto ___internal__instance = this;
    ...
    Zenject::FactoryBindInfo* _get__factoryBindInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_get__factoryBindInfo");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<Zenject::FactoryBindInfo*>(___internal__instance, "_factoryBindInfo"));
    }
    // Autogenerated instance field setter
    // Set instance field: private Zenject.FactoryBindInfo _factoryBindInfo
    void _set__factoryBindInfo(Zenject::FactoryBindInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::DecoratorToChoiceFromBinder_1::_set__factoryBindInfo");
      static auto ___internal__instance = this;
