...
namespace Zenject {
  ...
  class DecoratorToChoiceFromBinder_1 : public ::Il2CppObject {
    ...
    [[deprecated("Use field access instead!")]] ::Zenject::DiContainer*& dyn__bindContainer() {
    ...
    [[deprecated("Use field access instead!")]] ::Zenject::FactoryBindInfo*& dyn__factoryBindInfo() {
    ...
    ::Zenject::FactoryFromBinder_2<TContract, TConcrete>* With() {
      ...
      return ::il2cpp_utils::RunMethodRethrow<::Zenject::FactoryFromBinder_2<TContract, TConcrete>*, false>(this, ___generic__method);
    }
