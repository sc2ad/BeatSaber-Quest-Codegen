...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [NoReflectionBakingAttribute] Offset: D92C50
  ...
  class SubContainerCreatorByNewGameObjectMethod_6 : public Zenject::SubContainerCreatorByNewGameObjectDynamicContext {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: D93E48
    ...
    // Could not write size check! Type: Zenject.SubContainerCreatorByNewGameObjectMethod`6/<>c__DisplayClass2_0 is generic, or has no fields that are valid for size checks!
