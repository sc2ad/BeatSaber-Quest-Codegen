...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByNewGameObjectMethod), 32 + sizeof(void*) + 8 - (32 + sizeof(void*)) % 8> __Zenject_SubContainerCreatorByNewGameObjectMethodSizeCheck;
}
