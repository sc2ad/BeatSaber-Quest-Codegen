...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TKey>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10937), inst: 3805 }), TypeDefinitionIndex(TypeDefinitionIndex(10937)), TypeDefinitionIndex(TypeDefinitionIndex(10938))}
