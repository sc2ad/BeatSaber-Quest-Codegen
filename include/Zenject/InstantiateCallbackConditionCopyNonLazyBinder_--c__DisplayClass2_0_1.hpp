...
namespace Zenject {
  ...
  template<typename T>
  class InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xFFFFFFFF
    void $OnInstantiated$b__0(Zenject::InjectContext* ctx, ::CsObject* obj) {
