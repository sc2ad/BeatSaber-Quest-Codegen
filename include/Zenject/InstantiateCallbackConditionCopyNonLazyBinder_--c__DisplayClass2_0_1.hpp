...
namespace Zenject {
  ...
  class InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1 : public ::Il2CppObject {
    ...
    System::Action_2<Zenject::InjectContext*, T>* _get_callback() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1::_get_callback");
      static auto ___internal__instance = this;
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<System::Action_2<Zenject::InjectContext*, T>*>(___internal__instance, "callback")));
    }
    // Autogenerated instance field setter
    // Set instance field: public System.Action`2<Zenject.InjectContext,T> callback
    void _set_callback(System::Action_2<Zenject::InjectContext*, T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1::_set_callback");
      static auto ___internal__instance = this;
