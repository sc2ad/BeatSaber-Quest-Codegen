...
namespace Zenject {
  // Forward declaring type: MonoInstaller`2<TParam1, TDerived>
...
namespace Zenject {
  ...
  class MonoInstaller_2 : public Zenject::MonoInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<TDerived, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, container, p1)));
    }
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<TDerived, false>(static_cast<Il2CppObject*>(nullptr), ___internal__method, resourcePath, container, p1)));
    }
    ...
    static Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MonoInstaller_2::__zenCreateInjectTypeInfo");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TParam1, TDerived>*>::get(), "__zenCreateInjectTypeInfo", std::vector<Il2CppClass*>{}, ::std::vector<const Il2CppType*>{})));
