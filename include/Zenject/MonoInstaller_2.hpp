...
namespace Zenject {
  ...
  class MonoInstaller_2 : public Zenject::MonoInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_2").WithContext("InstallFromResource");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TParam1, TDerived>*>::get(), il2cpp_utils::NoArgClass<TDerived>(), "InstallFromResource", {}, ::il2cpp_utils::ExtractTypes(container, p1))));
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_2").WithContext("InstallFromResource");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TParam1, TDerived>*>::get(), il2cpp_utils::NoArgClass<TDerived>(), "InstallFromResource", {}, ::il2cpp_utils::ExtractTypes(resourcePath, container, p1))));
    ...
    static MonoInstaller_2<TParam1, TDerived>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MonoInstaller_2").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MonoInstaller_2<TParam1, TDerived>*>()));
    }
  }; // Zenject.MonoInstaller`2
  // Could not write size check! Type: Zenject.MonoInstaller`2 is generic!
}
