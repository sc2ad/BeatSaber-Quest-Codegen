...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::Array<::Il2CppObject*>*)>(&Zenject::FactoryFromBinderBase::$$c__DisplayClass24_0::__zenCreate)> {
  static const MethodInfo* get() {
