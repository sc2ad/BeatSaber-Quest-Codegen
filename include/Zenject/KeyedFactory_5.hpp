...
namespace Zenject {
  ...
  class KeyedFactory_5 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    TBase Create(TKey key, TParam1 param1, TParam2 param2, TParam3 param3) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("KeyedFactory_5").WithContext("Create");
      static auto* ___internal__method = THROW_UNLESS(::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<TBase>(), "Create", {}, ::il2cpp_utils::ExtractTypes(key, param1, param2, param3)));
    ...
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ProvidedTypes() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("KeyedFactory_5").WithContext("get_ProvidedTypes");
    ...
    static KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("KeyedFactory_5").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>*>()));
    }
  }; // Zenject.KeyedFactory`5
  // Could not write size check! Type: Zenject.KeyedFactory`5 is generic!
}
