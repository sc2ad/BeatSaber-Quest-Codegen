...
namespace Zenject {
  ...
  check_size<sizeof(ZenjectStateMachineBehaviourAutoInjecter), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __Zenject_ZenjectStateMachineBehaviourAutoInjecterSizeCheck;
}
