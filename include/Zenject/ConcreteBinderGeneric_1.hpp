  ...
  class ConcreteBinderGeneric_1 : public Zenject::FromBinderGeneric_1<TContract> {
    ...
    class $$c__DisplayClass5_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      System::Type* _get_concreteType() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::ConcreteBinderGeneric_1::$$c__DisplayClass5_0::_get_concreteType");
      ...
      void _set_concreteType(System::Type* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::ConcreteBinderGeneric_1::$$c__DisplayClass5_0::_set_concreteType");
        static auto ___internal__instance = this;
