...
constexpr  Zenject::PrefabResourceFactory_2<P1,T>::operator Zenject::IFactory_3<::StringW,P1,T>() const noexcept {
return Zenject::IFactory_3<::StringW,P1,T>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to Zenject::IFactory
constexpr  Zenject::PrefabResourceFactory_2<P1,T>::operator Zenject::IFactory() const noexcept {
return Zenject::IFactory(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Zenject::PrefabResourceFactory_2<P1,T>::__set__container(Zenject::DiContainer value)  {
...
constexpr Zenject::DiContainer Zenject::PrefabResourceFactory_2<P1,T>::__get__container() const {
return ::cordl_internals::getInstanceField<Zenject::DiContainer, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
 Zenject::DiContainer Zenject::PrefabResourceFactory_2<P1,T>::get_Container()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
                            "get_Container",
...
return ::cordl_internals::RunMethodRethrow<Zenject::DiContainer, false>(const_cast<void*>(instance), ___internal_method);
 ...
 T Zenject::PrefabResourceFactory_2<P1,T>::Create(::StringW prefabResourceName, P1 param)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
                            "Create",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<T, false>(const_cast<void*>(instance), ___internal_method, prefabResourceName, param);
 ...
 Zenject::PrefabResourceFactory_2<P1,T> Zenject::PrefabResourceFactory_2<P1,T>::New_ctor()  {
Zenject::PrefabResourceFactory_2<P1,T> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::PrefabResourceFactory_2<P1,T>>())};
return o;
}
 void Zenject::PrefabResourceFactory_2<P1,T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 ::bs_hook::Il2CppWrapperType Zenject::PrefabResourceFactory_2<P1,T>::__zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
                            "__zenCreate",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<::bs_hook::Il2CppWrapperType, false>(nullptr, ___internal_method, P_0);
 ...
 void Zenject::PrefabResourceFactory_2<P1,T>::__zenFieldSetter0(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
                            "__zenFieldSetter0",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(nullptr, ___internal_method, P_0, P_1);
 ...
 Zenject::InjectTypeInfo Zenject::PrefabResourceFactory_2<P1,T>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::PrefabResourceFactory_2<P1,T>>::get(),
