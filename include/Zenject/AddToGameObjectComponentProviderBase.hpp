...
namespace Zenject {
  ...
  check_size<sizeof(AddToGameObjectComponentProviderBase), 48 + sizeof(void*) + ((48 + sizeof(void*)) % 8 != 0 ? (8 - (48 + sizeof(void*)) % 8) : 0)> __Zenject_AddToGameObjectComponentProviderBaseSizeCheck;
}
