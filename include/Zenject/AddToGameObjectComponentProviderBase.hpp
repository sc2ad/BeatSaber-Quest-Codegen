...
namespace Zenject {
  ...
  class AddToGameObjectComponentProviderBase : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xD4FA48
    static AddToGameObjectComponentProviderBase* New_ctor(Zenject::DiContainer* container, System::Type* componentType, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, ::CsObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback);
