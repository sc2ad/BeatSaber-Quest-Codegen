...
namespace Zenject {
  ...
  check_size<sizeof(InitializableManager::InitializableInfo), 24 + sizeof(int) + ((24 + sizeof(int)) % 8 != 0 ? (8 - (24 + sizeof(int)) % 8) : 0)> __Zenject_InitializableManager_InitializableInfoSizeCheck;
}
