...
namespace Zenject {
  ...
  // [CompilerGeneratedAttribute] Offset: DDD798
  template<typename T>
  ...
  // Could not write size check! Type: Zenject.ConventionFilterTypesBinder/<>c__DisplayClass9_0`1 is generic, or has no fields that are valid for size checks!
}
