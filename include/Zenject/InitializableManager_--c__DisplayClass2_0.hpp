...
namespace Zenject {
  ...
  check_size<sizeof(InitializableManager::$$c__DisplayClass2_0), 16 + sizeof(void*) + 8 - (16 + sizeof(void*)) % 8> __Zenject_InitializableManager_$$c__DisplayClass2_0SizeCheck;
}
