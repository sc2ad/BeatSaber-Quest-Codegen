...
namespace Zenject {
  ...
  class IFactoryProvider_3 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_3<TParam1, TParam2, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<IFactoryProvider_3<TParam1, TParam2, TContract>*>(container, factoryId)));
    }
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`3 is generic!
}
