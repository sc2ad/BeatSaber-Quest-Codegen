...
template<::cordl_internals::il2cpp_reference_type P1,::cordl_internals::il2cpp_reference_type P2,::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11044))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11044), inst: 5155 })
...
static Zenject::PrefabFactory_3<P1,P2,T> New_ctor() ;
