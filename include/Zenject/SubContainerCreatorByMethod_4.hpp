...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_4 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    // Get instance field: private readonly System.Action`5<Zenject.DiContainer,TParam1,TParam2,TParam3,TParam4> _installMethod
    System::Action_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4>* _get__installMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_4::_get__installMethod");
    ...
    // Set instance field: private readonly System.Action`5<Zenject.DiContainer,TParam1,TParam2,TParam3,TParam4> _installMethod
    void _set__installMethod(System::Action_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByMethod_4::_set__installMethod");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_installMethod"))->offset;
