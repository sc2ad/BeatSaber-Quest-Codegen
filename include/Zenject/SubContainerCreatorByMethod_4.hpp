...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_4 : public ::Zenject::SubContainerCreatorByMethodBase {
    ...
    [[deprecated("Use field access instead!")]] ::System::Action_5<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4>*& dyn__installMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("::Zenject::SubContainerCreatorByMethod_4::dyn__installMethod");
