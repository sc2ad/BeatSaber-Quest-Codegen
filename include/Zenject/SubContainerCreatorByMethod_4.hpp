...
namespace Zenject {
  ...
  class SubContainerCreatorByMethod_4 : public Zenject::SubContainerCreatorByMethodBase {
    ...
    static SubContainerCreatorByMethod_4<TParam1, TParam2, TParam3, TParam4>* New_ctor(Zenject::DiContainer* container, Zenject::SubContainerCreatorBindInfo* containerBindInfo, System::Action_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4>* installMethod) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByMethod_4").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SubContainerCreatorByMethod_4<TParam1, TParam2, TParam3, TParam4>*>(container, containerBindInfo, installMethod)));
    }
    ...
    Zenject::DiContainer* CreateSubContainer(System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("SubContainerCreatorByMethod_4").WithContext("CreateSubContainer");
  ...
  // Could not write size check! Type: Zenject.SubContainerCreatorByMethod`4 is generic!
}
