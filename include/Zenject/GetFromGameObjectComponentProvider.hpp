...
namespace Zenject {
  ...
  check_size<sizeof(GetFromGameObjectComponentProvider), 32 + sizeof(bool) + ((32 + sizeof(bool)) % 8 != 0 ? (8 - (32 + sizeof(bool)) % 8) : 0)> __Zenject_GetFromGameObjectComponentProviderSizeCheck;
}
