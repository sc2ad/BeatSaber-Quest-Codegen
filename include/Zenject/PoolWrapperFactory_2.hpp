...
namespace Zenject {
  ...
  class PoolWrapperFactory_2 : public ::Il2CppObject/*, public Zenject::IFactory_2<TParam1, TValue>*/ {
    ...
    Zenject::IMemoryPool_2<TParam1, TValue>* _get__pool() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolWrapperFactory_2::_get__pool");
    ...
    // Set instance field: private readonly Zenject.IMemoryPool`2<TParam1,TValue> _pool
    void _set__pool(Zenject::IMemoryPool_2<TParam1, TValue>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PoolWrapperFactory_2::_set__pool");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_pool"))->offset;
      *reinterpret_cast<Zenject::IMemoryPool_2<TParam1, TValue>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
