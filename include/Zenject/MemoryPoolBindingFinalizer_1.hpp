...
namespace Zenject {
  ...
  class MemoryPoolBindingFinalizer_1 : public Zenject::ProviderBindingFinalizer {
    ...
    Zenject::MemoryPoolBindInfo* _get__poolBindInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBindingFinalizer_1::_get__poolBindInfo");
      static auto ___internal__instance = this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<Zenject::MemoryPoolBindInfo*>(___internal__instance, "_poolBindInfo"));
    }
    // Autogenerated instance field setter
    // Set instance field: private readonly Zenject.MemoryPoolBindInfo _poolBindInfo
    void _set__poolBindInfo(Zenject::MemoryPoolBindInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBindingFinalizer_1::_set__poolBindInfo");
      static auto ___internal__instance = this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "_poolBindInfo", value));
    }
    // Autogenerated instance field getter
    ...
    Zenject::FactoryBindInfo* _get__factoryBindInfo() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBindingFinalizer_1::_get__factoryBindInfo");
      static auto ___internal__instance = this;
    ...
    void _set__factoryBindInfo(Zenject::FactoryBindInfo* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MemoryPoolBindingFinalizer_1::_set__factoryBindInfo");
      static auto ___internal__instance = this;
