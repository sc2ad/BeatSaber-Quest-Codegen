...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TParam5,::cordl_internals::il2cpp_reference_type TValue>
class Zenject__PlaceholderFactory_6___get_ParamTypes_d__2<TParam1,TParam2,TParam3,TParam4,TParam5,TValue>;
}
...
class CORDL_TYPE Zenject__PlaceholderFactory_6___get_ParamTypes_d__2<TParam1,TParam2,TParam3,TParam4,TParam5,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~Zenject__PlaceholderFactory_6___get_ParamTypes_d__2() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_6___get_ParamTypes_d__2", modifiers: " const&", def_value: None }]
constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2(Zenject__PlaceholderFactory_6___get_ParamTypes_d__2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_6___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2(Zenject__PlaceholderFactory_6___get_ParamTypes_d__2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__PlaceholderFactory_6___get_ParamTypes_d__2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_6___get_ParamTypes_d__2&& o) noexcept = default;
  constexpr Zenject__PlaceholderFactory_6___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_6___get_ParamTypes_d__2 const& o) noexcept = default;
...
public:
// Declarations
using _get_ParamTypes_d__2 = Zenject::Zenject__PlaceholderFactory_6___get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__PlaceholderFactory_6___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`6/<get_ParamTypes>d__2");
