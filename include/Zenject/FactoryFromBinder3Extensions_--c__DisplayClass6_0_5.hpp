...
namespace Zenject {
  ...
  class FactoryFromBinder3Extensions::$$c__DisplayClass6_0_5 : public ::Il2CppObject {
    ...
    System::Guid _get_poolId() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder3Extensions::$$c__DisplayClass6_0_5::_get_poolId");
    ...
    void _set_poolId(System::Guid value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder3Extensions::$$c__DisplayClass6_0_5::_set_poolId");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "poolId"))->offset;
