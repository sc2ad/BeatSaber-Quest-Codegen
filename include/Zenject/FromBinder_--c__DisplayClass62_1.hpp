...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D938B8
  class FromBinder::$$c__DisplayClass62_1 : public ::Il2CppObject {
    ...
    static FromBinder::$$c__DisplayClass62_1* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass62_1").WithContext(".ctor");
