...
namespace Zenject {
  ...
  class FromBinder::$$c__DisplayClass62_1 : public ::CsObject {
    public:
    ...
    // Offset: 0xF21574
    System::Collections::Generic::IEnumerable_1<::CsObject*>* $FromComponentsInParents$b__1(Zenject::InjectContext* ctx);
