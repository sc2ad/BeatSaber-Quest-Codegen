...
namespace Zenject {
  // Forward declaring type: MethodProviderWithContainer`4<TParam1, TParam2, TParam3, TValue>
...
namespace Zenject {
  ...
  class MethodProviderWithContainer_4 : public ::Il2CppObject/*, public ::Zenject::IProvider*/ {
    ...
    [[deprecated("Use field access instead!")]] ::System::Func_5<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TValue>*& dyn__method() {
