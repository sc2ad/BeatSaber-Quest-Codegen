...
namespace Zenject {
  ...
  class MethodProviderWithContainer_4 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    static MethodProviderWithContainer_4<TParam1, TParam2, TParam3, TValue>* New_ctor(System::Func_5<Zenject::DiContainer*, TParam1, TParam2, TParam3, TValue>* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_4").WithContext(".ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MethodProviderWithContainer_4<TParam1, TParam2, TParam3, TValue>*>(method)));
    }
    ...
    bool get_IsCached() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_4").WithContext("get_IsCached");
    ...
    bool get_TypeVariesBasedOnMemberType() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_4").WithContext("get_TypeVariesBasedOnMemberType");
    ...
    System::Type* GetInstanceType(Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_4").WithContext("GetInstanceType");
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderWithContainer_4").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.MethodProviderWithContainer`4 is generic!
}
