...
NEED_NO_BOX(Zenject::FromBinder::$$c__DisplayClass35_0);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::ArrayW<::Il2CppObject*>)>(&Zenject::FromBinder::$$c__DisplayClass35_0::__zenCreate)> {
  static const MethodInfo* get() {
