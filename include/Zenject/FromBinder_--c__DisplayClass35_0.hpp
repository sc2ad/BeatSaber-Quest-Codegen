...
namespace Zenject {
  ...
  // [] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: D937C8
  class FromBinder::$$c__DisplayClass35_0 : public ::Il2CppObject {
    ...
    static FromBinder::$$c__DisplayClass35_0* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("$$c__DisplayClass35_0").WithContext(".ctor");
