...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Il2CppObject*, ::Array<::Il2CppObject*>*)>(&Zenject::AnimatorMoveHandlerManager::__zenInjectMethod0)> {
  static const MethodInfo* get() {
