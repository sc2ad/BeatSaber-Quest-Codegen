...
namespace Zenject {
  ...
  class FactoryFromBinder_2 : public Zenject::FactoryFromBinderBase {
    ...
    Zenject::FactorySubContainerBinder_2<TParam1, TContract>* FromSubContainerResolve() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactorySubContainerBinder_2<TParam1, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactorySubContainerBinder_2<TParam1, TContract>* FromSubContainerResolve(::Il2CppObject* subIdentifier) {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactorySubContainerBinder_2<TParam1, TContract>*, false>(this, ___internal__method, subIdentifier)));
    }
