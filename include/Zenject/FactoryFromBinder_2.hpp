...
namespace Zenject {
  ...
  class FactoryFromBinder_2 : public Zenject::FactoryFromBinderBase {
    ...
    class $$c__DisplayClass1_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      System::Func_3<Zenject::DiContainer*, TParam1, TContract>* _get_method() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_2::$$c__DisplayClass1_0::_get_method");
      ...
      // Set instance field: public System.Func`3<Zenject.DiContainer,TParam1,TContract> method
      void _set_method(System::Func_3<Zenject::DiContainer*, TParam1, TContract>* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::FactoryFromBinder_2::$$c__DisplayClass1_0::_set_method");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "method"))->offset;
        *reinterpret_cast<System::Func_3<Zenject::DiContainer*, TParam1, TContract>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
      }
