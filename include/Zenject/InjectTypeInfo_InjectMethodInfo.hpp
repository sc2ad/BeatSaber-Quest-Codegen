...
namespace Zenject {
  ...
  // [NoReflectionBakingAttribute] Offset: DCA8E0
...
// Il2CppName: .ctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InjectTypeInfo::InjectMethodInfo::*)(Zenject::ZenInjectMethod*, ::Array<Zenject::InjectableInfo*>*, ::Il2CppString*)>(&Zenject::InjectTypeInfo::InjectMethodInfo::New_ctor<::il2cpp_utils::CreationType::Temporary>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::InjectTypeInfo::InjectMethodInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Zenject::ZenInjectMethod*>(), ::il2cpp_utils::ExtractIndependentType<::Array<Zenject::InjectableInfo*>*>(), ::il2cpp_utils::ExtractIndependentType<::Il2CppString*>()});
  }
};
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InjectTypeInfo::InjectMethodInfo::*)(Zenject::ZenInjectMethod*, ::Array<Zenject::InjectableInfo*>*, ::Il2CppString*)>(&Zenject::InjectTypeInfo::InjectMethodInfo::New_ctor<::il2cpp_utils::CreationType::Manual>)> {
  const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Zenject::InjectTypeInfo::InjectMethodInfo*), ".ctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractIndependentType<Zenject::ZenInjectMethod*>(), ::il2cpp_utils::ExtractIndependentType<::Array<Zenject::InjectableInfo*>*>(), ::il2cpp_utils::ExtractIndependentType<::Il2CppString*>()});
  }
};
