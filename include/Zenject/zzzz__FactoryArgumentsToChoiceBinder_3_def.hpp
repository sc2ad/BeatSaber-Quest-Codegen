...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10793)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10793), inst: 1826 }), TypeDefinitionIndex(TypeDefinitionIndex(10648))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10648), inst: 5954 })
...
static Zenject::FactoryArgumentsToChoiceBinder_3<TParam1,System::Int32Enum,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10793), inst: 1826 }), TypeDefinitionIndex(TypeDefinitionIndex(10793)), TypeDefinitionIndex(TypeDefinitionIndex(10648))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10648), inst: 5155 })
// CS Name: Zenject.FactoryArgumentsToChoiceBinder`3
...
static Zenject::FactoryArgumentsToChoiceBinder_3<TParam1,TParam2,TContract> New_ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::FactoryBindInfo factoryBindInfo) ;
