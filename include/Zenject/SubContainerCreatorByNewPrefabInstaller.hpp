...
namespace Zenject {
  ...
  check_size<sizeof(SubContainerCreatorByNewPrefabInstaller), 48 + sizeof(void*) + 8 - (48 + sizeof(void*)) % 8> __Zenject_SubContainerCreatorByNewPrefabInstallerSizeCheck;
}
