...
namespace Zenject {
  ...
  class MethodProviderSimple_1 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    static MethodProviderSimple_1<TReturn>* New_ctor(System::Func_1<TReturn>* method) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderSimple_1").WithContext(".ctor");
    ...
    bool get_IsCached() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderSimple_1").WithContext("get_IsCached");
    ...
    bool get_TypeVariesBasedOnMemberType() {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderSimple_1").WithContext("get_TypeVariesBasedOnMemberType");
    ...
    System::Type* GetInstanceType(Zenject::InjectContext* context) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderSimple_1").WithContext("GetInstanceType");
    ...
    void GetAllInstancesWithInjectSplit(Zenject::InjectContext* context, System::Collections::Generic::List_1<Zenject::TypeValuePair>* args, System::Action*& injectAction, System::Collections::Generic::List_1<::Il2CppObject*>* buffer) {
      static auto ___internal__logger = ::Logger::get().WithContext("codegen").WithContext("Zenject").WithContext("MethodProviderSimple_1").WithContext("GetAllInstancesWithInjectSplit");
  ...
  // Could not write size check! Type: Zenject.MethodProviderSimple`1 is generic!
}
