...
namespace Zenject {
  ...
  class SubContainerCreatorByNewPrefabMethod_2 : public Zenject::SubContainerCreatorByNewPrefabDynamicContext {
    ...
    class $$c__DisplayClass2_0 : public ::il2cpp_utils::il2cpp_type_check::NestedType, public ::Il2CppObject {
      ...
      Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>* _get_$$4__this() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::$$c__DisplayClass2_0::_get_$$4__this");
      ...
      // Set instance field: public Zenject.SubContainerCreatorByNewPrefabMethod`2<TParam1,TParam2> <>4__this
      void _set_$$4__this(Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::$$c__DisplayClass2_0::_set_$$4__this");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "<>4__this"))->offset;
        *reinterpret_cast<Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
      }
      // Autogenerated instance field getter
      ...
      System::Collections::Generic::List_1<Zenject::TypeValuePair>* _get_args() {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::$$c__DisplayClass2_0::_get_args");
        auto ___internal__instance = this;
      ...
      void _set_args(System::Collections::Generic::List_1<Zenject::TypeValuePair>* value) {
        static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::$$c__DisplayClass2_0::_set_args");
        auto ___internal__instance = this;
        static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "args"))->offset;
    ...
    System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* _get__installerMethod() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::_get__installerMethod");
      auto ___internal__instance = this;
    ...
    void _set__installerMethod(System::Action_3<Zenject::DiContainer*, TParam1, TParam2>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::SubContainerCreatorByNewPrefabMethod_2::_set__installerMethod");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_installerMethod"))->offset;
