...
namespace Zenject {
  ...
  class KeyedFactoryBase_2 : public ::Il2CppObject/*, public Zenject::IValidatable*/ {
    ...
    // [] Offset: FFFFFFFF
    // [CompilerGeneratedAttribute] Offset: CF03B0
    ...
    // [InjectAttribute] Offset: 0xCF0B00
    ...
    // [InjectOptionalAttribute] Offset: 0xCF0B10
    ...
    // [InjectOptionalAttribute] Offset: 0xCF0B20
    ...
    // Offset: 0xFFFFFFFF
    System::Collections::Generic::IEnumerable_1<System::Type*>* get_ProvidedTypes_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::KeyedFactoryBase_2::get_ProvidedTypes_NEW");
    ...
    // Offset: 0xFFFFFFFF
    void Validate_NEW() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::KeyedFactoryBase_2::Validate_NEW");
