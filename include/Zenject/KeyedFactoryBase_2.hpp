...
namespace Zenject {
  ...
  class KeyedFactoryBase_2 : public Zenject::IValidatable, public ::Il2CppObject {
    public:
    ...
    static Zenject::ConditionCopyNonLazyBinder* AddBindingInternal(Zenject::DiContainer* container, TKey key) {
      ...
      return THROW_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::ConditionCopyNonLazyBinder*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KeyedFactoryBase_2<TKey, TBase>*>::get(), "AddBindingInternal", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TDerived>::get()}, container, key)));
    }
    ...
    static KeyedFactoryBase_2<TKey, TBase>* New_ctor() {
      return (KeyedFactoryBase_2<TKey, TBase>*)THROW_UNLESS((il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KeyedFactoryBase_2<TKey, TBase>*>::get())));
    }
