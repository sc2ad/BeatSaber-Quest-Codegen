...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::IFactoryProvider_1<System::Int32Enum>::*)(Zenject::InjectContext, System::Collections::Generic::List_1<Zenject::TypeValuePair>, ByRef<System::Action>, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType>)>(&Zenject::IFactoryProvider_1<System::Int32Enum>::GetAllInstancesWithInjectSplit)> {
 ...
 Zenject::IFactoryProvider_1<System::Int32Enum> Zenject::IFactoryProvider_1<System::Int32Enum>::New_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
Zenject::IFactoryProvider_1<System::Int32Enum> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::IFactoryProvider_1<System::Int32Enum>>(container, factoryId))};
return o;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::IFactoryProvider_1<float_t>::*)(Zenject::InjectContext, System::Collections::Generic::List_1<Zenject::TypeValuePair>, ByRef<System::Action>, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType>)>(&Zenject::IFactoryProvider_1<float_t>::GetAllInstancesWithInjectSplit)> {
 ...
 Zenject::IFactoryProvider_1<float_t> Zenject::IFactoryProvider_1<float_t>::New_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
Zenject::IFactoryProvider_1<float_t> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::IFactoryProvider_1<float_t>>(container, factoryId))};
return o;
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, context, args, injectAction, buffer);
 ...
 Zenject::IFactoryProvider_1<TContract> Zenject::IFactoryProvider_1<TContract>::New_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
Zenject::IFactoryProvider_1<TContract> o{THROW_UNLESS(::il2cpp_utils::New<Zenject::IFactoryProvider_1<TContract>>(container, factoryId))};
return o;
}
 void Zenject::IFactoryProvider_1<TContract>::_ctor(Zenject::DiContainer container, System::Guid factoryId)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, container, factoryId);
 ...
 void Zenject::IFactoryProvider_1<TContract>::GetAllInstancesWithInjectSplit(Zenject::InjectContext context, System::Collections::Generic::List_1<Zenject::TypeValuePair> args, ByRef<System::Action> injectAction, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> buffer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::IFactoryProvider_1<TContract>>::get(),
                            "GetAllInstancesWithInjectSplit",
                            std::vector<Il2CppClass*>{},
