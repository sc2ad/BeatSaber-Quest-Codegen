...
namespace Zenject {
  ...
  class DisposeBlock : public ::CsObject, public System::IDisposable {
    public:
    ...
    struct SpawnedObjectPoolPair : public System::ValueType {
      ...
      SpawnedObjectPoolPair(Zenject::IMemoryPool* Pool_ = {}, ::CsObject* Object_ = {}) : Pool{Pool_}, Object{Object_} {}
