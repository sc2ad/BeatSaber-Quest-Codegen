...
namespace Zenject {
  ...
  class MethodProviderMultiple_1 : public ::Il2CppObject/*, public Zenject::IProvider*/ {
    ...
    Zenject::DiContainer* _get__container() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderMultiple_1::_get__container");
    ...
    void _set__container(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderMultiple_1::_set__container");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_container"))->offset;
    ...
    System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<TReturn>*>* _get__method() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderMultiple_1::_get__method");
      auto ___internal__instance = this;
    ...
    // Autogenerated instance field setter
    // Set instance field: private readonly System.Func`2<Zenject.InjectContext,System.Collections.Generic.IEnumerable`1<TReturn>> _method
    void _set__method(System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<TReturn>*>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::MethodProviderMultiple_1::_set__method");
      auto ___internal__instance = this;
      static auto ___internal__field__offset = THROW_UNLESS(il2cpp_utils::FindField(___internal__instance, "_method"))->offset;
      *reinterpret_cast<System::Func_2<Zenject::InjectContext*, System::Collections::Generic::IEnumerable_1<TReturn>*>**>(reinterpret_cast<char*>(this) + ___internal__field__offset) = value;
    }
