...
namespace Zenject {
  ...
  class ScriptableObjectResourceProvider : public ::CsObject, public Zenject::IProvider {
    public:
    ...
    // Offset: 0xFB6CE8
    static ScriptableObjectResourceProvider* New_ctor(::CsString* resourcePath, System::Type* resourceType, Zenject::DiContainer* container, System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArguments, bool createNew, ::CsObject* concreteIdentifier, System::Action_2<Zenject::InjectContext*, ::CsObject*>* instantiateCallback);
