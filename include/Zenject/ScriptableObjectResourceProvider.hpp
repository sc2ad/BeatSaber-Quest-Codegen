...
namespace Zenject {
  ...
  check_size<sizeof(ScriptableObjectResourceProvider), 64 + sizeof(void*) + ((64 + sizeof(void*)) % 8 != 0 ? (8 - (64 + sizeof(void*)) % 8) : 0)> __Zenject_ScriptableObjectResourceProviderSizeCheck;
}
