...
namespace Zenject {
  ...
  class PrefabResourceFactory_2 : public ::Il2CppObject/*, public Zenject::IFactory_3<::Il2CppString*, P1, T>*/ {
    public:
    // [InjectAttribute] Offset: 0xDCAFCC
    ...
    Zenject::DiContainer* _get__container() {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_2::_get__container");
    ...
    void _set__container(Zenject::DiContainer* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("Zenject::PrefabResourceFactory_2::_set__container");
      static auto ___internal__instance = this;
