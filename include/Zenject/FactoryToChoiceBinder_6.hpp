...
namespace Zenject {
  ...
  // [NoReflectionBakingAttribute] Offset: DDC980
  ...
  class FactoryToChoiceBinder_6 : public Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract> {
    ...
    Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TConcrete>* To() {
      ...
      return ::il2cpp_utils::RunMethodThrow<Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TConcrete>*, false>(this, ___generic__method);
    }
