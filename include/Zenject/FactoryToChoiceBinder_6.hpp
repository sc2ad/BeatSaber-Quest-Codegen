...
namespace Zenject {
  // Forward declaring type: FactoryToChoiceBinder`6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>
...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_6 : public Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract> {
    ...
    Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>* ToSelf() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>*, false>(this, ___internal__method)));
    }
    ...
    Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TConcrete>* To() {
      ...
      return THROW_UNLESS((::il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_6<TParam1, TParam2, TParam3, TParam4, TParam5, TConcrete>*, false>(this, ___generic__method)));
    }
