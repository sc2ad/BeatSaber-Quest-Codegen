...
namespace Zenject {
  ...
  class IFactoryProvider_6 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      ...
      return THROW_UNLESS((::il2cpp_utils::New<IFactoryProvider_6<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>*>(container, factoryId)));
    }
  ...
  // Could not write size check! Type: Zenject.IFactoryProvider`6 is generic!
}
