...
namespace TMPro {
  ...
  check_size<sizeof(Mesh_Extents), 8 + sizeof(UnityEngine::Vector2) + ((8 + sizeof(UnityEngine::Vector2)) % 8 != 0 ? (8 - (8 + sizeof(UnityEngine::Vector2)) % 8) : 0)> __TMPro_Mesh_ExtentsSizeCheck;
}
