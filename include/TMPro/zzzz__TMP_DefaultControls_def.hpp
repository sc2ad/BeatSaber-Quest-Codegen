...
namespace TMPro {
struct ____TMPro__TMP_DefaultControls__Resources;
}
// Type: ::Resources
namespace TMPro {
// Is value type: true
...
struct CORDL_TYPE ____TMPro__TMP_DefaultControls__Resources : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____TMPro__TMP_DefaultControls__Resources(::UnityEngine::Sprite standard, ::UnityEngine::Sprite background, ::UnityEngine::Sprite inputField, ::UnityEngine::Sprite knob, ::UnityEngine::Sprite checkmark, ::UnityEngine::Sprite dropdown, ::UnityEngine::Sprite mask) noexcept;


                    constexpr ____TMPro__TMP_DefaultControls__Resources(____TMPro__TMP_DefaultControls__Resources const&) = default;
                    constexpr ____TMPro__TMP_DefaultControls__Resources(____TMPro__TMP_DefaultControls__Resources&&) = default;
                    constexpr ____TMPro__TMP_DefaultControls__Resources& operator=(____TMPro__TMP_DefaultControls__Resources const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_DefaultControls__Resources& operator=(____TMPro__TMP_DefaultControls__Resources&& o) noexcept {
...
constexpr explicit ____TMPro__TMP_DefaultControls__Resources(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using Resources = ::TMPro::____TMPro__TMP_DefaultControls__Resources;
...
static ::UnityEngine::GameObject CreateScrollbar(::TMPro::____TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateButton addr 0x2a6b1f0 size 0x2c0 virtual false final false
static ::UnityEngine::GameObject CreateButton(::TMPro::____TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateText addr 0x2a6b4b0 size 0xa0 virtual false final false
static ::UnityEngine::GameObject CreateText(::TMPro::____TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateInputField addr 0x2a6b550 size 0x65c virtual false final false
static ::UnityEngine::GameObject CreateInputField(::TMPro::____TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateDropdown addr 0x2a6bd50 size 0xdf4 virtual false final false
static ::UnityEngine::GameObject CreateDropdown(::TMPro::____TMPro__TMP_DefaultControls__Resources resources) ;
...
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_DefaultControls__Resources, "TMPro", "TMP_DefaultControls/Resources");
