...
constexpr TMPro::TMP_PageInfo::TMP_PageInfo(int32_t firstCharacterIndex, int32_t lastCharacterIndex, float_t ascender, float_t baseLine, float_t descender) noexcept : ::bs_hook::ValueTypeWrapper() {this->firstCharacterIndex = firstCharacterIndex;
...
constexpr int32_t TMPro::TMP_PageInfo::__get_firstCharacterIndex() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void TMPro::TMP_PageInfo::__set_lastCharacterIndex(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x4>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t TMPro::TMP_PageInfo::__get_lastCharacterIndex() const {
...
constexpr float_t TMPro::TMP_PageInfo::__get_ascender() const {
...
constexpr float_t TMPro::TMP_PageInfo::__get_baseLine() const {
...
constexpr float_t TMPro::TMP_PageInfo::__get_descender() const {
