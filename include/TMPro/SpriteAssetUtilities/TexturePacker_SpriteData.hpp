...
namespace TMPro::SpriteAssetUtilities {
  ...
  check_size<sizeof(TexturePacker::SpriteData), 52 + sizeof(UnityEngine::Vector2) + ((52 + sizeof(UnityEngine::Vector2)) % 8 != 0 ? (8 - (52 + sizeof(UnityEngine::Vector2)) % 8) : 0)> __TMPro_SpriteAssetUtilities_TexturePacker_SpriteDataSizeCheck;
}
