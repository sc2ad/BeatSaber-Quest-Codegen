...
namespace TMPro::SpriteAssetUtilities {
  ...
  check_size<sizeof(TexturePacker::SpriteSize), 4 + sizeof(float) + ((4 + sizeof(float)) % 8 != 0 ? (8 - (4 + sizeof(float)) % 8) : 0)> __TMPro_SpriteAssetUtilities_TexturePacker_SpriteSizeSizeCheck;
}
