...
namespace TMPro {
  ...
  check_size<sizeof(TMP_TextUtilities::LineSegment), 12 + sizeof(UnityEngine::Vector3) + ((12 + sizeof(UnityEngine::Vector3)) % 8 != 0 ? (8 - (12 + sizeof(UnityEngine::Vector3)) % 8) : 0)> __TMPro_TMP_TextUtilities_LineSegmentSizeCheck;
}
