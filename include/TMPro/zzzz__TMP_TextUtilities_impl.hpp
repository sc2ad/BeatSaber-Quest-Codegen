...
//  Writing Method size for method: ::TMPro::____TMPro__TMP_TextUtilities__LineSegment._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::____TMPro__TMP_TextUtilities__LineSegment::*)(::UnityEngine::Vector3, ::UnityEngine::Vector3)>(&::TMPro::____TMPro__TMP_TextUtilities__LineSegment::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x2ab4494;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::____TMPro__TMP_TextUtilities__LineSegment>::get(),
                            ".ctor",
...
constexpr ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::____TMPro__TMP_TextUtilities__LineSegment(::UnityEngine::Vector3 Point1, ::UnityEngine::Vector3 Point2) noexcept : ::bs_hook::ValueTypeWrapper() {this->Point1 = Point1;
this->Point2 = Point2;
}
constexpr void ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::__set_Point1(::UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector3, 0x0>(this->__instance, std::forward<::UnityEngine::Vector3>(value));
}
constexpr ::UnityEngine::Vector3 ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::__get_Point1() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->__instance);
}
constexpr void ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::__set_Point2(::UnityEngine::Vector3 value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector3, 0xc>(this->__instance, std::forward<::UnityEngine::Vector3>(value));
}
constexpr ::UnityEngine::Vector3 ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::__get_Point2() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0xc>(this->__instance);
}
 void ::TMPro::____TMPro__TMP_TextUtilities__LineSegment::_ctor(::UnityEngine::Vector3 p1, ::UnityEngine::Vector3 p2)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::____TMPro__TMP_TextUtilities__LineSegment>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::TMPro::____TMPro__TMP_TextUtilities__LineSegment, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ByRef<::UnityEngine::Vector3>)>(&::TMPro::TMP_TextUtilities::IntersectLinePlane)> {
...
return ::cordl_internals::RunMethodRethrow<bool, false>(nullptr, ___internal_method, transform, screenPoint, cam, worldPoint);
 ...
 bool ::TMPro::TMP_TextUtilities::IntersectLinePlane(::TMPro::____TMPro__TMP_TextUtilities__LineSegment line, ::UnityEngine::Vector3 point, ::UnityEngine::Vector3 normal, ByRef<::UnityEngine::Vector3> intersectingPoint)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::TMP_TextUtilities>::get(),
                            "IntersectLinePlane",
                            std::vector<Il2CppClass*>{},
