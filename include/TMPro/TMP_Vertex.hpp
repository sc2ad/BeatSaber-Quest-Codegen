...
namespace TMPro {
  ...
  check_size<sizeof(TMP_Vertex), 36 + sizeof(UnityEngine::Color32) + ((36 + sizeof(UnityEngine::Color32)) % 8 != 0 ? (8 - (36 + sizeof(UnityEngine::Color32)) % 8) : 0)> __TMPro_TMP_VertexSizeCheck;
}
