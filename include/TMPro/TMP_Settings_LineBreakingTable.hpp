...
namespace TMPro {
  ...
  check_size<sizeof(TMP_Settings::LineBreakingTable), 24 + sizeof(void*) + ((24 + sizeof(void*)) % 8 != 0 ? (8 - (24 + sizeof(void*)) % 8) : 0)> __TMPro_TMP_Settings_LineBreakingTableSizeCheck;
}
