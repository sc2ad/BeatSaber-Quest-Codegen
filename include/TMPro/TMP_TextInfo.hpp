...
namespace TMPro {
  ...
  class TMP_TextInfo : public ::Il2CppObject {
    ...
    static void Resize(ByRef<::ArrayW<T>> array, int size) {
      ...
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(array), size)));
    }
    ...
    static void Resize(ByRef<::ArrayW<T>> array, int size, bool isBlockAllocated) {
      ...
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      THROW_UNLESS((::il2cpp_utils::RunMethod<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, byref(array), size, isBlockAllocated)));
    }
