...
namespace TMPro {
  ...
  check_size<sizeof(TMP_MaterialManager::MaskingMaterial), 36 + sizeof(int) + ((36 + sizeof(int)) % 8 != 0 ? (8 - (36 + sizeof(int)) % 8) : 0)> __TMPro_TMP_MaterialManager_MaskingMaterialSizeCheck;
}
