...
namespace TMPro {
  ...
  struct TMP_RichTextTagStack_1/*, public System::ValueType*/ {
    ...
    ::Array<T>* _get_m_ItemStack() {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_get_m_ItemStack");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<::Array<T>*>(___internal__instance, "m_ItemStack"));
    }
    // Autogenerated instance field setter
    // Set instance field: public T[] m_ItemStack
    void _set_m_ItemStack(::Array<T>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_set_m_ItemStack");
      static auto ___internal__instance = *this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "m_ItemStack", value));
    }
    // Autogenerated instance field getter
    // Get instance field: public System.Int32 m_Index
    int _get_m_Index() {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_get_m_Index");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<int>(___internal__instance, "m_Index"));
    }
    // Autogenerated instance field setter
    // Set instance field: public System.Int32 m_Index
    void _set_m_Index(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_set_m_Index");
      static auto ___internal__instance = *this;
    ...
    int _get_m_Capacity() {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_get_m_Capacity");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<int>(___internal__instance, "m_Capacity"));
    }
    // Autogenerated instance field setter
    // Set instance field: private System.Int32 m_Capacity
    void _set_m_Capacity(int value) {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_set_m_Capacity");
      static auto ___internal__instance = *this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "m_Capacity", value));
    }
    // Autogenerated instance field getter
    // Get instance field: private T m_DefaultItem
    T _get_m_DefaultItem() {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_get_m_DefaultItem");
      static auto ___internal__instance = *this;
      return THROW_UNLESS(il2cpp_utils::GetFieldValue<T>(___internal__instance, "m_DefaultItem"));
    }
    // Autogenerated instance field setter
    // Set instance field: private T m_DefaultItem
    void _set_m_DefaultItem(T value) {
      static auto ___internal__logger = ::Logger::get().WithContext("TMPro::TMP_RichTextTagStack_1::_set_m_DefaultItem");
      static auto ___internal__instance = *this;
      THROW_UNLESS(il2cpp_utils::SetFieldValue(___internal__instance, "m_DefaultItem", value));
    }
