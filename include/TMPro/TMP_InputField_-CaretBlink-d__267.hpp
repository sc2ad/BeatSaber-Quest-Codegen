...
namespace TMPro {
  ...
  check_size<sizeof(TMP_InputField::$CaretBlink$d__267), 32 + sizeof(void*) + ((32 + sizeof(void*)) % 8 != 0 ? (8 - (32 + sizeof(void*)) % 8) : 0)> __TMPro_TMP_InputField_$CaretBlink$d__267SizeCheck;
}
