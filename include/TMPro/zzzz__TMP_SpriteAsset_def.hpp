...
namespace TMPro {
class ____TMPro__TMP_SpriteAsset____c;
}
// Type: ::<>c
namespace TMPro {
// Is value type: false
...
class CORDL_TYPE ____TMPro__TMP_SpriteAsset____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____TMPro__TMP_SpriteAsset____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_SpriteAsset____c", modifiers: " const&", def_value: None }]
constexpr ____TMPro__TMP_SpriteAsset____c(____TMPro__TMP_SpriteAsset____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_SpriteAsset____c", modifiers: "&&", def_value: None }]
constexpr ____TMPro__TMP_SpriteAsset____c(____TMPro__TMP_SpriteAsset____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_SpriteAsset____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____TMPro__TMP_SpriteAsset____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____TMPro__TMP_SpriteAsset____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____TMPro__TMP_SpriteAsset____c& operator=(____TMPro__TMP_SpriteAsset____c&& o) noexcept = default;
  constexpr ____TMPro__TMP_SpriteAsset____c& operator=(____TMPro__TMP_SpriteAsset____c const& o) noexcept = default;
                


// Fields

static ::TMPro::____TMPro__TMP_SpriteAsset____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::TMPro::____TMPro__TMP_SpriteAsset____c value) ;

static ::TMPro::____TMPro__TMP_SpriteAsset____c __get___9() ;
...
// Ctor Parameters []
explicit ____TMPro__TMP_SpriteAsset____c() ;
...
public:
// Declarations
using __c = ::TMPro::____TMPro__TMP_SpriteAsset____c;
...
NEED_NO_BOX(::TMPro::____TMPro__TMP_SpriteAsset____c);
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_SpriteAsset____c, "TMPro", "TMP_SpriteAsset/<>c");
