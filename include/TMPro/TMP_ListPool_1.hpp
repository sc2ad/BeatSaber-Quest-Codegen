  ...
  class TMP_ListPool_1 : public ::Il2CppObject {
    ...
    class $$c : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static void _cctor() {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename TMP_ListPool_1<T>::$$c*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
      ...
      void $_cctor$b__3_0(System::Collections::Generic::List_1<T>* l) {
        ...
        static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, il2cpp_utils::NoArgClass<void>(), "<.cctor>b__3_0", {}, ::il2cpp_utils::ExtractTypes(l))));
    ...
    // Could not write size check! Type: TMPro.TMP_ListPool`1/<>c is generic!
    // Autogenerated static field getter
    ...
    static System::Collections::Generic::List_1<T>* Get() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TMP_ListPool_1<T>*>::get(), il2cpp_utils::NoArgClass<System::Collections::Generic::List_1<T>*>(), "Get", {}, ::il2cpp_utils::ExtractTypes())));
    ...
    static void Release(System::Collections::Generic::List_1<T>* toRelease) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TMP_ListPool_1<T>*>::get(), il2cpp_utils::NoArgClass<void>(), "Release", {}, ::il2cpp_utils::ExtractTypes(toRelease))));
    ...
    static void _cctor() {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TMP_ListPool_1<T>*>::get(), il2cpp_utils::NoArgClass<void>(), ".cctor", {}, ::il2cpp_utils::ExtractTypes())));
      ::il2cpp_utils::RunMethodThrow<void, false>(static_cast<Il2CppClass*>(nullptr), ___internal__method);
    }
  }; // TMPro.TMP_ListPool`1
  // Could not write size check! Type: TMPro.TMP_ListPool`1 is generic!
}
