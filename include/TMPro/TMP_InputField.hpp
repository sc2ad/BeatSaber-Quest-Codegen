...
namespace TMPro {
  ...
  class TMP_InputField : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IUpdateSelectedHandler, public UnityEngine::EventSystems::IBeginDragHandler, public UnityEngine::EventSystems::IDragHandler, public UnityEngine::EventSystems::IEndDragHandler, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::UI::ICanvasElement, public UnityEngine::UI::ILayoutElement, public UnityEngine::EventSystems::IScrollHandler*/ {
    ...
    check_size<sizeof(TMP_InputField::ContentType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __TMPro_TMP_InputField_ContentTypeSizeCheck;
    ...
    check_size<sizeof(TMP_InputField::InputType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __TMPro_TMP_InputField_InputTypeSizeCheck;
    ...
    check_size<sizeof(TMP_InputField::CharacterValidation), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __TMPro_TMP_InputField_CharacterValidationSizeCheck;
    ...
    check_size<sizeof(TMP_InputField::LineType), 0 + sizeof(int) + 8 - (0 + sizeof(int)) % 8> __TMPro_TMP_InputField_LineTypeSizeCheck;
  ...
  check_size<sizeof(TMP_InputField), 672 + sizeof(void*) + 8 - (672 + sizeof(void*)) % 8> __TMPro_TMP_InputFieldSizeCheck;
}
