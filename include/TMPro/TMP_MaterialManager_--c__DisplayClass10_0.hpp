...
namespace TMPro {
  ...
  check_size<sizeof(TMP_MaterialManager::$$c__DisplayClass10_0), 16 + sizeof(void*) + ((16 + sizeof(void*)) % 8 != 0 ? (8 - (16 + sizeof(void*)) % 8) : 0)> __TMPro_TMP_MaterialManager_$$c__DisplayClass10_0SizeCheck;
}
