...
namespace TMPro {
  ...
  class TMP_Dropdown : public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::ICancelHandler, public UnityEngine::UI::Selectable {
    public:
