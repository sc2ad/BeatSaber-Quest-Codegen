...
namespace TMPro {
  ...
  // [] Offset: FFFFFFFF
  // [AddComponentMenu] Offset: CFCDC4
  // [RequireComponent] Offset: CFCDC4
  class TMP_Dropdown : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::ICancelHandler*/ {
    ...
    // [SpaceAttribute] Offset: 0xCFD2E4
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::UI::Image*) == 0x8);
    // [SpaceAttribute] Offset: 0xCFD32C
    ...
    char __padding5[0x4] = {};
    // [SpaceAttribute] Offset: 0xCFD364
    ...
    // [SpaceAttribute] Offset: 0xCFD39C
