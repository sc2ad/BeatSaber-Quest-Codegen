...
namespace TMPro {
  ...
  // [AddComponentMenu] Offset: CF9CA8
  // [RequireComponent] Offset: CF9CA8
  class TMP_Dropdown : public UnityEngine::UI::Selectable/*, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::ICancelHandler*/ {
    ...
    // [SpaceAttribute] Offset: 0xCFB1C8
    ...
    // Field size check
    static_assert(sizeof(UnityEngine::UI::Image*) == 0x8);
    // [SpaceAttribute] Offset: 0xCFB210
    ...
    char __padding5[0x4] = {};
    // [SpaceAttribute] Offset: 0xCFB248
    ...
    // [SpaceAttribute] Offset: 0xCFB280
