...
namespace TMPro {
  ...
  class TMP_Dropdown::DropdownItem : public UnityEngine::EventSystems::IPointerEnterHandler, public UnityEngine::EventSystems::ICancelHandler, public UnityEngine::MonoBehaviour {
    public:
