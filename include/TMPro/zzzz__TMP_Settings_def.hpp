...
namespace TMPro {
class ____TMPro__TMP_Settings__LineBreakingTable;
}
...
class CORDL_TYPE ____TMPro__TMP_Settings__LineBreakingTable : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~____TMPro__TMP_Settings__LineBreakingTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_Settings__LineBreakingTable", modifiers: " const&", def_value: None }]
constexpr ____TMPro__TMP_Settings__LineBreakingTable(____TMPro__TMP_Settings__LineBreakingTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_Settings__LineBreakingTable", modifiers: "&&", def_value: None }]
constexpr ____TMPro__TMP_Settings__LineBreakingTable(____TMPro__TMP_Settings__LineBreakingTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Settings__LineBreakingTable(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____TMPro__TMP_Settings__LineBreakingTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____TMPro__TMP_Settings__LineBreakingTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____TMPro__TMP_Settings__LineBreakingTable& operator=(____TMPro__TMP_Settings__LineBreakingTable&& o) noexcept = default;
  constexpr ____TMPro__TMP_Settings__LineBreakingTable& operator=(____TMPro__TMP_Settings__LineBreakingTable const& o) noexcept = default;
...
// Ctor Parameters []
explicit ____TMPro__TMP_Settings__LineBreakingTable() ;
...
public:
// Declarations
using LineBreakingTable = ::TMPro::____TMPro__TMP_Settings__LineBreakingTable;
...
constexpr ::UnityEngine::TextAsset __get_m_followingCharacters() const;
 ...
 ::TMPro::____TMPro__TMP_Settings__LineBreakingTable __declspec(property(get=__get_m_linebreakingRules, put=__set_m_linebreakingRules))  m_linebreakingRules;

constexpr void __set_m_linebreakingRules(::TMPro::____TMPro__TMP_Settings__LineBreakingTable value) ;

constexpr ::TMPro::____TMPro__TMP_Settings__LineBreakingTable __get_m_linebreakingRules() const;
...
static ::TMPro::____TMPro__TMP_Settings__LineBreakingTable __declspec(property(get=get_linebreakingRules))  linebreakingRules;
...
static ::TMPro::____TMPro__TMP_Settings__LineBreakingTable get_linebreakingRules() ;
...
NEED_NO_BOX(::TMPro::____TMPro__TMP_Settings__LineBreakingTable);
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Settings__LineBreakingTable, "TMPro", "TMP_Settings/LineBreakingTable");
