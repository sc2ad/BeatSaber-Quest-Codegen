...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<::UnityEngine::Color>, ::UnityEngine::Color)>(&::TMPro::SetPropertyUtility::SetColor)> {
  ...
  constexpr static std::size_t addrs = 0x2aa1d04;
...
template<typename T>
 bool ::TMPro::SetPropertyUtility::SetEquatableStruct(ByRef<T> currentValue, T newValue)  {
...
template<typename T>
 bool ::TMPro::SetPropertyUtility::SetStruct(ByRef<T> currentValue, T newValue)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::SetPropertyUtility>::get(),
                        "SetStruct",
                        std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
...
template<typename T>
 bool ::TMPro::SetPropertyUtility::SetClass(ByRef<T> currentValue, T newValue)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::TMPro::SetPropertyUtility>::get(),
                        "SetClass",
                        std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
