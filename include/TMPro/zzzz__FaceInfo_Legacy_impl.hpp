...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (TMPro::FaceInfo_Legacy::*)()>(&TMPro::FaceInfo_Legacy::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2a7880c;
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_LineHeight() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_Baseline() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_Ascender() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_CapHeight() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_Descender() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_CenterLine() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_SuperscriptOffset() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_SubscriptOffset() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_SubSize() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_Underline() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_UnderlineThickness() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_strikethrough() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_strikethroughThickness() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_TabWidth() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_Padding() const {
...
constexpr float_t TMPro::FaceInfo_Legacy::__get_AtlasWidth() const {
