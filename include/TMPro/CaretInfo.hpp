...
namespace TMPro {
  ...
  check_size<sizeof(CaretInfo), 4 + sizeof(TMPro::CaretPosition) + ((4 + sizeof(TMPro::CaretPosition)) % 8 != 0 ? (8 - (4 + sizeof(TMPro::CaretPosition)) % 8) : 0)> __TMPro_CaretInfoSizeCheck;
}
