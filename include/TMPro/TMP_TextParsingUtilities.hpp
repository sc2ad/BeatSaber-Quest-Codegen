...
namespace TMPro {
  ...
  class TMP_TextParsingUtilities : public ::CsObject {
    public:
    ...
    static ::CsString* _get_k_LookupStringL();
    // Set static field: static private System.String k_LookupStringL
    static void _set_k_LookupStringL(::CsString* value);
    ...
    static ::CsString* _get_k_LookupStringU();
