...
namespace TMPro {
  ...
  check_size<sizeof(TMP_Dropdown::$DelayedDestroyDropdownList$d__72), 40 + sizeof(void*) + ((40 + sizeof(void*)) % 8 != 0 ? (8 - (40 + sizeof(void*)) % 8) : 0)> __TMPro_TMP_Dropdown_$DelayedDestroyDropdownList$d__72SizeCheck;
}
