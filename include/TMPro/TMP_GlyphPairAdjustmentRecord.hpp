...
namespace TMPro {
  ...
  check_size<sizeof(TMP_GlyphPairAdjustmentRecord), 56 + sizeof(TMPro::FontFeatureLookupFlags) + ((56 + sizeof(TMPro::FontFeatureLookupFlags)) % 8 != 0 ? (8 - (56 + sizeof(TMPro::FontFeatureLookupFlags)) % 8) : 0)> __TMPro_TMP_GlyphPairAdjustmentRecordSizeCheck;
}
