...
namespace TMPro {
  ...
  class TMPro_EventManager : public ::CsObject {
    ...
    // Offset: 0xDB15B0
    static void ON_COMPUTE_DT_EVENT(::CsObject* Sender, TMPro::Compute_DT_EventArgs* e);
