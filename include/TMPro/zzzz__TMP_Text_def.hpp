...
namespace TMPro {
struct ____TMPro__TMP_Text__TextInputSources;
}
namespace TMPro {
class TMP_Text;
}
namespace TMPro {
class ____TMPro__TMP_Text____c;
}
namespace TMPro {
struct ____TMPro__TMP_Text__CharacterSubstitution;
}
namespace TMPro {
struct ____TMPro__TMP_Text__SpecialCharacter;
}
namespace TMPro {
struct ____TMPro__TMP_Text__TextBackingContainer;
}
namespace TMPro {
...
struct CORDL_TYPE ____TMPro__TMP_Text__CharacterSubstitution : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____TMPro__TMP_Text__CharacterSubstitution(int32_t index, uint32_t unicode) noexcept;


                    constexpr ____TMPro__TMP_Text__CharacterSubstitution(____TMPro__TMP_Text__CharacterSubstitution const&) = default;
                    constexpr ____TMPro__TMP_Text__CharacterSubstitution(____TMPro__TMP_Text__CharacterSubstitution&&) = default;
                    constexpr ____TMPro__TMP_Text__CharacterSubstitution& operator=(____TMPro__TMP_Text__CharacterSubstitution const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_Text__CharacterSubstitution& operator=(____TMPro__TMP_Text__CharacterSubstitution&& o) noexcept {
...
constexpr explicit ____TMPro__TMP_Text__CharacterSubstitution(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____TMPro__TMP_Text__TextInputSources : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr ____TMPro__TMP_Text__TextInputSources(int32_t value__) noexcept;


                    constexpr ____TMPro__TMP_Text__TextInputSources(____TMPro__TMP_Text__TextInputSources const&) = default;
                    constexpr ____TMPro__TMP_Text__TextInputSources(____TMPro__TMP_Text__TextInputSources&&) = default;
                    constexpr ____TMPro__TMP_Text__TextInputSources& operator=(____TMPro__TMP_Text__TextInputSources const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_Text__TextInputSources& operator=(____TMPro__TMP_Text__TextInputSources&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Text__TextInputSources(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class ______TMPro__TMP_Text__TextInputSources_Unwrapped : int32_t {
__TextInputBox = 0,
__SetText = 1,
__SetTextArray = 2,
__TextString = 3,
...
constexpr operator ______TMPro__TMP_Text__TextInputSources_Unwrapped () const noexcept {
return std::bit_cast<______TMPro__TMP_Text__TextInputSources_Unwrapped>(__instance);
}
...
static ::TMPro::____TMPro__TMP_Text__TextInputSources const TextInputBox;

/// @brief Field SetText offset 0
static ::TMPro::____TMPro__TMP_Text__TextInputSources const SetText;

/// @brief Field SetTextArray offset 0
static ::TMPro::____TMPro__TMP_Text__TextInputSources const SetTextArray;

/// @brief Field TextString offset 0
static ::TMPro::____TMPro__TMP_Text__TextInputSources const TextString;
...
struct CORDL_TYPE ____TMPro__TMP_Text__UnicodeChar : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____TMPro__TMP_Text__UnicodeChar(int32_t unicode, int32_t stringIndex, int32_t length) noexcept;


                    constexpr ____TMPro__TMP_Text__UnicodeChar(____TMPro__TMP_Text__UnicodeChar const&) = default;
                    constexpr ____TMPro__TMP_Text__UnicodeChar(____TMPro__TMP_Text__UnicodeChar&&) = default;
                    constexpr ____TMPro__TMP_Text__UnicodeChar& operator=(____TMPro__TMP_Text__UnicodeChar const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_Text__UnicodeChar& operator=(____TMPro__TMP_Text__UnicodeChar&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Text__UnicodeChar(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____TMPro__TMP_Text__SpecialCharacter : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____TMPro__TMP_Text__SpecialCharacter(::TMPro::TMP_Character character, ::TMPro::TMP_FontAsset fontAsset, ::UnityEngine::Material material, int32_t materialIndex) noexcept;


                    constexpr ____TMPro__TMP_Text__SpecialCharacter(____TMPro__TMP_Text__SpecialCharacter const&) = default;
                    constexpr ____TMPro__TMP_Text__SpecialCharacter(____TMPro__TMP_Text__SpecialCharacter&&) = default;
                    constexpr ____TMPro__TMP_Text__SpecialCharacter& operator=(____TMPro__TMP_Text__SpecialCharacter const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_Text__SpecialCharacter& operator=(____TMPro__TMP_Text__SpecialCharacter&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Text__SpecialCharacter(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
struct CORDL_TYPE ____TMPro__TMP_Text__TextBackingContainer : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr ____TMPro__TMP_Text__TextBackingContainer(::ArrayW<uint32_t> m_Array, int32_t m_Count) noexcept;


                    constexpr ____TMPro__TMP_Text__TextBackingContainer(____TMPro__TMP_Text__TextBackingContainer const&) = default;
                    constexpr ____TMPro__TMP_Text__TextBackingContainer(____TMPro__TMP_Text__TextBackingContainer&&) = default;
                    constexpr ____TMPro__TMP_Text__TextBackingContainer& operator=(____TMPro__TMP_Text__TextBackingContainer const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr ____TMPro__TMP_Text__TextBackingContainer& operator=(____TMPro__TMP_Text__TextBackingContainer&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Text__TextBackingContainer(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
class CORDL_TYPE ____TMPro__TMP_Text____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~____TMPro__TMP_Text____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_Text____c", modifiers: " const&", def_value: None }]
constexpr ____TMPro__TMP_Text____c(____TMPro__TMP_Text____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "____TMPro__TMP_Text____c", modifiers: "&&", def_value: None }]
constexpr ____TMPro__TMP_Text____c(____TMPro__TMP_Text____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit ____TMPro__TMP_Text____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr ____TMPro__TMP_Text____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr ____TMPro__TMP_Text____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr ____TMPro__TMP_Text____c& operator=(____TMPro__TMP_Text____c&& o) noexcept = default;
  constexpr ____TMPro__TMP_Text____c& operator=(____TMPro__TMP_Text____c const& o) noexcept = default;
                


// Fields

static ::TMPro::____TMPro__TMP_Text____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(::TMPro::____TMPro__TMP_Text____c value) ;

static ::TMPro::____TMPro__TMP_Text____c __get___9() ;
...
// Ctor Parameters []
explicit ____TMPro__TMP_Text____c() ;
...
public:
// Declarations
using __c = ::TMPro::____TMPro__TMP_Text____c;

using TextBackingContainer = ::TMPro::____TMPro__TMP_Text__TextBackingContainer;

using SpecialCharacter = ::TMPro::____TMPro__TMP_Text__SpecialCharacter;

using UnicodeChar = ::TMPro::____TMPro__TMP_Text__UnicodeChar;

using TextInputSources = ::TMPro::____TMPro__TMP_Text__TextInputSources;

using CharacterSubstitution = ::TMPro::____TMPro__TMP_Text__CharacterSubstitution;
...
constexpr bool __get_m_isWaitingOnResourceLoad() const;
 ...
 ::TMPro::____TMPro__TMP_Text__TextInputSources __declspec(property(get=__get_m_inputSource, put=__set_m_inputSource))  m_inputSource;

constexpr void __set_m_inputSource(::TMPro::____TMPro__TMP_Text__TextInputSources value) ;

constexpr ::TMPro::____TMPro__TMP_Text__TextInputSources __get_m_inputSource() const;
...
constexpr bool __get_m_isFXMatrixSet() const;
 ...
 ::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar> __declspec(property(get=__get_m_TextProcessingArray, put=__set_m_TextProcessingArray))  m_TextProcessingArray;

constexpr void __set_m_TextProcessingArray(::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar> value) ;

constexpr ::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar> __get_m_TextProcessingArray() const;
...
constexpr ::TMPro::TMP_TextElement __get_m_cached_TextElement() const;
 ...
 ::TMPro::____TMPro__TMP_Text__SpecialCharacter __declspec(property(get=__get_m_Ellipsis, put=__set_m_Ellipsis))  m_Ellipsis;

constexpr void __set_m_Ellipsis(::TMPro::____TMPro__TMP_Text__SpecialCharacter value) ;

constexpr ::TMPro::____TMPro__TMP_Text__SpecialCharacter __get_m_Ellipsis() const;

 ::TMPro::____TMPro__TMP_Text__SpecialCharacter __declspec(property(get=__get_m_Underline, put=__set_m_Underline))  m_Underline;

constexpr void __set_m_Underline(::TMPro::____TMPro__TMP_Text__SpecialCharacter value) ;

constexpr ::TMPro::____TMPro__TMP_Text__SpecialCharacter __get_m_Underline() const;
...
constexpr bool __get_m_ignoreActiveState() const;
 ...
 ::TMPro::____TMPro__TMP_Text__TextBackingContainer __declspec(property(get=__get_m_TextBackingArray, put=__set_m_TextBackingArray))  m_TextBackingArray;

constexpr void __set_m_TextBackingArray(::TMPro::____TMPro__TMP_Text__TextBackingContainer value) ;

constexpr ::TMPro::____TMPro__TMP_Text__TextBackingContainer __get_m_TextBackingArray() const;
...
/// @brief Method ReplaceOpeningStyleTag addr 0x2a8b1dc size 0x420 virtual false final false
 bool ReplaceOpeningStyleTag(ByRef<::TMPro::____TMPro__TMP_Text__TextBackingContainer> sourceText, int32_t srcIndex, ByRef<int32_t> srcOffset, ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;

/// @brief Method ReplaceOpeningStyleTag addr 0x2a8c9dc size 0x420 virtual false final false
 bool ReplaceOpeningStyleTag(ByRef<::ArrayW<int32_t>> sourceText, int32_t srcIndex, ByRef<int32_t> srcOffset, ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;

/// @brief Method ReplaceClosingStyleTag addr 0x2a8b5fc size 0x3f0 virtual false final false
 void ReplaceClosingStyleTag(ByRef<::TMPro::____TMPro__TMP_Text__TextBackingContainer> sourceText, int32_t srcIndex, ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;

/// @brief Method ReplaceClosingStyleTag addr 0x2a8cdfc size 0x3f0 virtual false final false
 void ReplaceClosingStyleTag(ByRef<::ArrayW<int32_t>> sourceText, int32_t srcIndex, ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;

/// @brief Method InsertOpeningStyleTag addr 0x2a8ab20 size 0x3d0 virtual false final false
 bool InsertOpeningStyleTag(::TMPro::TMP_Style style, int32_t srcIndex, ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;

/// @brief Method InsertClosingStyleTag addr 0x2a8b9ec size 0x3c8 virtual false final false
 void InsertClosingStyleTag(ByRef<::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar>> charBuffer, ByRef<int32_t> writeIndex) ;
...
/// @brief Method GetMarkupTagHashCode addr 0x2a8b0d0 size 0x10c virtual false final false
 int32_t GetMarkupTagHashCode(::TMPro::____TMPro__TMP_Text__TextBackingContainer tagDefinition, int32_t readIndex) ;
...
/// @brief Method GetStyleHashCode addr 0x2a8c5d4 size 0x10c virtual false final false
 int32_t GetStyleHashCode(ByRef<::TMPro::____TMPro__TMP_Text__TextBackingContainer> text, int32_t index, ByRef<int32_t> closeIndex) ;
...
/// @brief Method GetUTF16 addr 0x2a8aef0 size 0xa8 virtual false final false
 int32_t GetUTF16(::TMPro::____TMPro__TMP_Text__TextBackingContainer text, int32_t i) ;
...
/// @brief Method GetUTF32 addr 0x2a8af98 size 0x138 virtual false final false
 int32_t GetUTF32(::TMPro::____TMPro__TMP_Text__TextBackingContainer text, int32_t i) ;
...
/// @brief Method ValidateHtmlTag addr 0x2a8fb18 size 0x6080 virtual false final false
 bool ValidateHtmlTag(::ArrayW<::TMPro::____TMPro__TMP_Text__UnicodeChar> chars, int32_t startIndex, ByRef<int32_t> endIndex) ;
...
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text__TextInputSources, "TMPro", "TMP_Text/TextInputSources");
NEED_NO_BOX(::TMPro::TMP_Text);
DEFINE_IL2CPP_ARG_TYPE(::TMPro::TMP_Text, "TMPro", "TMP_Text");
NEED_NO_BOX(::TMPro::____TMPro__TMP_Text____c);
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text____c, "TMPro", "TMP_Text/<>c");
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text__CharacterSubstitution, "TMPro", "TMP_Text/CharacterSubstitution");
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text__SpecialCharacter, "TMPro", "TMP_Text/SpecialCharacter");
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text__TextBackingContainer, "TMPro", "TMP_Text/TextBackingContainer");
DEFINE_IL2CPP_ARG_TYPE(::TMPro::____TMPro__TMP_Text__UnicodeChar, "TMPro", "TMP_Text/UnicodeChar");
