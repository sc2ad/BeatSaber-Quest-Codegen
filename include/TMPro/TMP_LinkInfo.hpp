...
namespace TMPro {
  ...
  struct TMP_LinkInfo/*, public System::ValueType*/ {
    ...
    // Size: 0x8
    // Offset: 0x20
    ::ArrayWrapper<::Il2CppChar> linkID;
    // Field size check
    static_assert(sizeof(::ArrayWrapper<::Il2CppChar>) == 0x8);
    // Creating value type constructor for type: TMP_LinkInfo
    constexpr TMP_LinkInfo(TMPro::TMP_Text* textComponent_ = {}, int hashCode_ = {}, int linkIdFirstCharacterIndex_ = {}, int linkIdLength_ = {}, int linkTextfirstCharacterIndex_ = {}, int linkTextLength_ = {}, ::ArrayWrapper<::Il2CppChar> linkID_ = ::ArrayWrapper<::Il2CppChar>(nullptr)) noexcept : textComponent{textComponent_}, hashCode{hashCode_}, linkIdFirstCharacterIndex{linkIdFirstCharacterIndex_}, linkIdLength{linkIdLength_}, linkTextfirstCharacterIndex{linkTextfirstCharacterIndex_}, linkTextLength{linkTextLength_}, linkID{linkID_} {}
    ...
    ::ArrayWrapper<::Il2CppChar>& dyn_linkID();
    // System.Void SetLinkID(System.Char[] text, System.Int32 startIndex, System.Int32 length)
    // Offset: 0x121DFB8
    void SetLinkID(::ArrayWrapper<::Il2CppChar> text, int startIndex, int length);
  ...
  #pragma pack(pop)
  static check_size<sizeof(TMP_LinkInfo), 32 + sizeof(::ArrayWrapper<::Il2CppChar>)> __TMPro_TMP_LinkInfoSizeCheck;
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (TMPro::TMP_LinkInfo::*)(::ArrayWrapper<::Il2CppChar>, int, int)>(&TMPro::TMP_LinkInfo::SetLinkID)> {
