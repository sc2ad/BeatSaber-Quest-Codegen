...
namespace TMPro {
  ...
  class TMP_ScrollbarEventHandler : public UnityEngine::MonoBehaviour, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::IEventSystemHandler, public UnityEngine::EventSystems::ISelectHandler, public UnityEngine::EventSystems::IDeselectHandler {
    public:
