...
namespace TMPro {
  ...
  check_size<sizeof(TMP_InputField::$MouseDragOutsideRect$d__285), 40 + sizeof(void*) + 8 - (40 + sizeof(void*)) % 8> __TMPro_TMP_InputField_$MouseDragOutsideRect$d__285SizeCheck;
}
