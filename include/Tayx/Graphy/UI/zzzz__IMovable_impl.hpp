...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Tayx::Graphy::UI::IMovable::*)(::Tayx::Graphy::____Tayx__Graphy__GraphyManager__ModulePosition)>(&::Tayx::Graphy::UI::IMovable::SetPosition)> {
 ...
 void ::Tayx::Graphy::UI::IMovable::SetPosition(::Tayx::Graphy::____Tayx__Graphy__GraphyManager__ModulePosition newModulePosition)  {
