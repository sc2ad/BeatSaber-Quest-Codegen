...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__Mode : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__Mode(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__Mode(Tayx__Graphy__GraphyManager__Mode const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__Mode(Tayx__Graphy__GraphyManager__Mode&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__Mode& operator=(Tayx__Graphy__GraphyManager__Mode const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__Mode& operator=(Tayx__Graphy__GraphyManager__Mode&& o) noexcept {
...
constexpr explicit Tayx__Graphy__GraphyManager__Mode(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__Mode_Unwrapped : int32_t {
__FULL = 0,
__LIGHT = 1,
};

/// @brief Conversion into unwrapped enum value
constexpr operator __Tayx__Graphy__GraphyManager__Mode_Unwrapped () const noexcept {
...
static Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode const FULL;

/// @brief Field LIGHT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode const LIGHT;
...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__ModuleType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__ModuleType(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__ModuleType(Tayx__Graphy__GraphyManager__ModuleType const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModuleType(Tayx__Graphy__GraphyManager__ModuleType&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModuleType& operator=(Tayx__Graphy__GraphyManager__ModuleType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__ModuleType& operator=(Tayx__Graphy__GraphyManager__ModuleType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit Tayx__Graphy__GraphyManager__ModuleType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__ModuleType_Unwrapped : int32_t {
__FPS = 0,
__RAM = 1,
__AUDIO = 2,
__ADVANCED = 3,
...
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType const FPS;

/// @brief Field RAM offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType const RAM;

/// @brief Field AUDIO offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType const AUDIO;

/// @brief Field ADVANCED offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType const ADVANCED;
...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__ModuleState : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__ModuleState(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__ModuleState(Tayx__Graphy__GraphyManager__ModuleState const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModuleState(Tayx__Graphy__GraphyManager__ModuleState&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModuleState& operator=(Tayx__Graphy__GraphyManager__ModuleState const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__ModuleState& operator=(Tayx__Graphy__GraphyManager__ModuleState&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit Tayx__Graphy__GraphyManager__ModuleState(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__ModuleState_Unwrapped : int32_t {
__FULL = 0,
__TEXT = 1,
__BASIC = 2,
__BACKGROUND = 3,
...
/// @brief Field FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState const FULL;

/// @brief Field TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState const TEXT;

/// @brief Field BASIC offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState const BASIC;

/// @brief Field BACKGROUND offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState const BACKGROUND;

/// @brief Field OFF offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState const OFF;
...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__ModulePosition : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__ModulePosition(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__ModulePosition(Tayx__Graphy__GraphyManager__ModulePosition const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModulePosition(Tayx__Graphy__GraphyManager__ModulePosition&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModulePosition& operator=(Tayx__Graphy__GraphyManager__ModulePosition const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__ModulePosition& operator=(Tayx__Graphy__GraphyManager__ModulePosition&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit Tayx__Graphy__GraphyManager__ModulePosition(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__ModulePosition_Unwrapped : int32_t {
__TOP_RIGHT = 0,
__TOP_LEFT = 1,
__BOTTOM_RIGHT = 2,
__BOTTOM_LEFT = 3,
...
/// @brief Conversion into unwrapped enum value
constexpr operator __Tayx__Graphy__GraphyManager__ModulePosition_Unwrapped () const noexcept {
...
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition const TOP_RIGHT;

/// @brief Field TOP_LEFT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition const TOP_LEFT;

/// @brief Field BOTTOM_RIGHT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition const BOTTOM_RIGHT;

/// @brief Field BOTTOM_LEFT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition const BOTTOM_LEFT;

/// @brief Field FREE offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition const FREE;
...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__LookForAudioListener : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__LookForAudioListener(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__LookForAudioListener(Tayx__Graphy__GraphyManager__LookForAudioListener const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__LookForAudioListener(Tayx__Graphy__GraphyManager__LookForAudioListener&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__LookForAudioListener& operator=(Tayx__Graphy__GraphyManager__LookForAudioListener const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__LookForAudioListener& operator=(Tayx__Graphy__GraphyManager__LookForAudioListener&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit Tayx__Graphy__GraphyManager__LookForAudioListener(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__LookForAudioListener_Unwrapped : int32_t {
__ALWAYS = 0,
__ON_SCENE_LOAD = 1,
__NEVER = 2,
};
...
static Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener const ALWAYS;

/// @brief Field ON_SCENE_LOAD offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener const ON_SCENE_LOAD;

/// @brief Field NEVER offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener const NEVER;
...
struct CORDL_TYPE Tayx__Graphy__GraphyManager__ModulePreset : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr Tayx__Graphy__GraphyManager__ModulePreset(int32_t value__) noexcept;


                    constexpr Tayx__Graphy__GraphyManager__ModulePreset(Tayx__Graphy__GraphyManager__ModulePreset const&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModulePreset(Tayx__Graphy__GraphyManager__ModulePreset&&) = default;
                    constexpr Tayx__Graphy__GraphyManager__ModulePreset& operator=(Tayx__Graphy__GraphyManager__ModulePreset const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr Tayx__Graphy__GraphyManager__ModulePreset& operator=(Tayx__Graphy__GraphyManager__ModulePreset&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit Tayx__Graphy__GraphyManager__ModulePreset(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __Tayx__Graphy__GraphyManager__ModulePreset_Unwrapped : int32_t {
__FPS_BASIC = 0,
__FPS_TEXT = 1,
__FPS_FULL = 2,
...
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_BASIC;

/// @brief Field FPS_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_TEXT;

/// @brief Field FPS_FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL;

/// @brief Field FPS_TEXT_RAM_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_TEXT_RAM_TEXT;

/// @brief Field FPS_FULL_RAM_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_TEXT;

/// @brief Field FPS_FULL_RAM_FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_FULL;

/// @brief Field FPS_TEXT_RAM_TEXT_AUDIO_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_TEXT_RAM_TEXT_AUDIO_TEXT;

/// @brief Field FPS_FULL_RAM_TEXT_AUDIO_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_TEXT_AUDIO_TEXT;

/// @brief Field FPS_FULL_RAM_FULL_AUDIO_TEXT offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_FULL_AUDIO_TEXT;

/// @brief Field FPS_FULL_RAM_FULL_AUDIO_FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_FULL_AUDIO_FULL;

/// @brief Field FPS_FULL_RAM_FULL_AUDIO_FULL_ADVANCED_FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_FULL_RAM_FULL_AUDIO_FULL_ADVANCED_FULL;

/// @brief Field FPS_BASIC_ADVANCED_FULL offset 0
static Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset const FPS_BASIC_ADVANCED_FULL;
...
public:
// Declarations
using ModulePreset = Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset;

using LookForAudioListener = Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener;

using ModulePosition = Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition;

using ModuleState = Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState;

using ModuleType = Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType;

using Mode = Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode;
...
// Fields
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode __declspec(property(get=__get_m_graphyMode, put=__set_m_graphyMode))  m_graphyMode;

constexpr void __set_m_graphyMode(Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode __get_m_graphyMode() const;
...
constexpr bool __get_m_toggleActiveAlt() const;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __declspec(property(get=__get_m_graphModulePosition, put=__set_m_graphModulePosition))  m_graphModulePosition;

constexpr void __set_m_graphModulePosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __get_m_graphModulePosition() const;

 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=__get_m_fpsModuleState, put=__set_m_fpsModuleState))  m_fpsModuleState;

constexpr void __set_m_fpsModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __get_m_fpsModuleState() const;
...
constexpr int32_t __get_m_fpsTextUpdateRate() const;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=__get_m_ramModuleState, put=__set_m_ramModuleState))  m_ramModuleState;

constexpr void __set_m_ramModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __get_m_ramModuleState() const;
...
constexpr int32_t __get_m_ramTextUpdateRate() const;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=__get_m_audioModuleState, put=__set_m_audioModuleState))  m_audioModuleState;

constexpr void __set_m_audioModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __get_m_audioModuleState() const;
...
constexpr int32_t __get_m_spectrumSize() const;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __declspec(property(get=__get_m_advancedModulePosition, put=__set_m_advancedModulePosition))  m_advancedModulePosition;

constexpr void __set_m_advancedModulePosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __get_m_advancedModulePosition() const;

 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=__get_m_advancedModuleState, put=__set_m_advancedModuleState))  m_advancedModuleState;

constexpr void __set_m_advancedModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __get_m_advancedModuleState() const;
...
constexpr Tayx::Graphy::Audio::G_AudioMonitor __get_m_audioMonitor() const;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset __declspec(property(get=__get_m_modulePresetState, put=__set_m_modulePresetState))  m_modulePresetState;

constexpr void __set_m_modulePresetState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset value) ;

constexpr Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset __get_m_modulePresetState() const;


// Properties

 Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode __declspec(property(get=get_GraphyMode, put=set_GraphyMode))  GraphyMode;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __declspec(property(get=get_GraphModulePosition, put=set_GraphModulePosition))  GraphModulePosition;

 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=get_FpsModuleState, put=set_FpsModuleState))  FpsModuleState;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=get_RamModuleState, put=set_RamModuleState))  RamModuleState;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=get_AudioModuleState, put=set_AudioModuleState))  AudioModuleState;

 UnityEngine::AudioListener __declspec(property(get=get_AudioListener, put=set_AudioListener))  AudioListener;

 Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener __declspec(property(get=get_FindAudioListenerInCameraIfNull, put=set_FindAudioListenerInCameraIfNull))  FindAudioListenerInCameraIfNull;
 ...
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState __declspec(property(get=get_AdvancedModuleState, put=set_AdvancedModuleState))  AdvancedModuleState;

 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition __declspec(property(get=get_AdvancedModulePosition, put=set_AdvancedModulePosition))  AdvancedModulePosition;
...
/// @brief Method get_GraphyMode addr 0x286f11c size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode get_GraphyMode() ;

/// @brief Method set_GraphyMode addr 0x286f124 size 0x8 virtual false final false
 void set_GraphyMode(Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode value) ;
...
/// @brief Method get_GraphModulePosition addr 0x286f1a8 size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition get_GraphModulePosition() ;

/// @brief Method set_GraphModulePosition addr 0x286f1b0 size 0x40 virtual false final false
 void set_GraphModulePosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition value) ;

/// @brief Method get_FpsModuleState addr 0x286fac0 size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState get_FpsModuleState() ;

/// @brief Method set_FpsModuleState addr 0x286fac8 size 0x24 virtual false final false
 void set_FpsModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;
...
/// @brief Method get_RamModuleState addr 0x2870048 size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState get_RamModuleState() ;

/// @brief Method set_RamModuleState addr 0x2870050 size 0x24 virtual false final false
 void set_RamModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;
...
/// @brief Method get_AudioModuleState addr 0x28704a4 size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState get_AudioModuleState() ;

/// @brief Method set_AudioModuleState addr 0x28704ac size 0x24 virtual false final false
 void set_AudioModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;
...
/// @brief Method get_FindAudioListenerInCameraIfNull addr 0x287080c size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener get_FindAudioListenerInCameraIfNull() ;

/// @brief Method set_FindAudioListenerInCameraIfNull addr 0x2870814 size 0x20 virtual false final false
 void set_FindAudioListenerInCameraIfNull(Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener value) ;
...
/// @brief Method get_AdvancedModuleState addr 0x287093c size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState get_AdvancedModuleState() ;

/// @brief Method set_AdvancedModuleState addr 0x2870944 size 0x24 virtual false final false
 void set_AdvancedModuleState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState value) ;

/// @brief Method get_AdvancedModulePosition addr 0x28709e0 size 0x8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition get_AdvancedModulePosition() ;

/// @brief Method set_AdvancedModulePosition addr 0x28709e8 size 0x20 virtual false final false
 void set_AdvancedModulePosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition value) ;
...
/// @brief Method SetModulePosition addr 0x287191c size 0x80 virtual false final false
 void SetModulePosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType moduleType, Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition modulePosition) ;

/// @brief Method SetModuleMode addr 0x287199c size 0x94 virtual false final false
 void SetModuleMode(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType moduleType, Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState moduleState) ;
...
/// @brief Method SetPreset addr 0x2871b18 size 0x294 virtual false final false
 void SetPreset(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset modulePreset) ;
...
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__LookForAudioListener, "Tayx.Graphy", "GraphyManager/LookForAudioListener");
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__Mode, "Tayx.Graphy", "GraphyManager/Mode");
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition, "Tayx.Graphy", "GraphyManager/ModulePosition");
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePreset, "Tayx.Graphy", "GraphyManager/ModulePreset");
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState, "Tayx.Graphy", "GraphyManager/ModuleState");
DEFINE_IL2CPP_ARG_TYPE(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleType, "Tayx.Graphy", "GraphyManager/ModuleType");
