...
namespace GameLift {
  ...
  class AuthenticateGameLiftUserResponse : public ::BGNet::Core::Messages::BaseReliableResponse/*, public ::GameLift::IGameLiftServerToClientMessage, public ::BGNet::Core::Messages::IUnconnectedAuthenticateResponse*/ {
    public:
