...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Microsoft::CodeAnalysis::EmbeddedAttribute::*)()>(&Microsoft::CodeAnalysis::EmbeddedAttribute::_ctor)> {
 ...
 Microsoft::CodeAnalysis::EmbeddedAttribute Microsoft::CodeAnalysis::EmbeddedAttribute::New_ctor()  {
Microsoft::CodeAnalysis::EmbeddedAttribute o{THROW_UNLESS(::il2cpp_utils::New<Microsoft::CodeAnalysis::EmbeddedAttribute>())};
return o;
}
