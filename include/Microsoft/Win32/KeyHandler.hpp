...
namespace Microsoft::Win32 {
  ...
  class KeyHandler : public ::CsObject {
    public:
    ...
    // Offset: 0x10A39CC
    Microsoft::Win32::RegistryKey* Ensure(Microsoft::Win32::RegistryKey* rkey, ::CsString* extra, bool writable, bool is_volatile);
    // public Microsoft.Win32.RegistryKey Probe(Microsoft.Win32.RegistryKey rkey, System.String extra, System.Boolean writable)
    // Offset: 0x10A3D8C
    Microsoft::Win32::RegistryKey* Probe(Microsoft::Win32::RegistryKey* rkey, ::CsString* extra, bool writable);
    // static private System.String CombineName(Microsoft.Win32.RegistryKey rkey, System.String extra)
    // Offset: 0x10A3C8C
    static ::CsString* CombineName(Microsoft::Win32::RegistryKey* rkey, ::CsString* extra);
    ...
    // Offset: 0x10A4654
    static int64_t GetRegisteredBootTime(::CsString* path);
    // static private System.Void SaveRegisteredBootTime(System.String path, System.Int64 btime)
    // Offset: 0x10A4928
    static void SaveRegisteredBootTime(::CsString* path, int64_t btime);
    ...
    // Offset: 0x10A4118
    static bool VolatileKeyExists(::CsString* dir);
    // static public System.String GetVolatileDir(System.String dir)
    // Offset: 0x10A2BE4
    static ::CsString* GetVolatileDir(::CsString* dir);
    ...
    // Offset: 0x10A4DE4
    static ::CsString* GetRootFromDir(::CsString* dir);
    ...
    // Offset: 0x10A5900
    ::CsObject* GetValue(::CsString* name, Microsoft::Win32::RegistryValueOptions options);
    ...
    // Offset: 0x10A6A74
    bool ValueExists(::CsString* name);
    ...
    // Offset: 0x10A4B28
    static ::CsString* get_UserStore();
    // static private System.String get_MachineStore()
    // Offset: 0x10A4C38
    static ::CsString* get_MachineStore();
