...
namespace Microsoft::Win32 {
  ...
  check_size<sizeof(UnsafeNativeMethods::ManifestEtw::EVENT_INFO_CLASS), 0 + sizeof(int) + ((0 + sizeof(int)) % 8 != 0 ? (8 - (0 + sizeof(int)) % 8) : 0)> __Microsoft_Win32_UnsafeNativeMethods_ManifestEtw_EVENT_INFO_CLASSSizeCheck;
}
