...
namespace Microsoft::Win32 {
  ...
  check_size<sizeof(UnsafeNativeMethods::ManifestEtw::TRACE_GUID_INFO), 4 + sizeof(int) + ((4 + sizeof(int)) % 8 != 0 ? (8 - (4 + sizeof(int)) % 8) : 0)> __Microsoft_Win32_UnsafeNativeMethods_ManifestEtw_TRACE_GUID_INFOSizeCheck;
}
